...
TEST_F(CGtoContainerTest, Compress)
{
    ...
    CMemBlock<double> sscreen({0.001, 0.005, 1.000, 3.000, 0.040, 2.000, 0.002, 2.000, 4.000, 0.001, 4.000});
    ...
    vlxtest::compare({9.055994438900e+00,
                      2.450300905100e+00,
                      5.281088472100e-02,
                      1.301070100000e+01,
                      1.962257200000e+00,
    ...
    vlxtest::compare({1.450000000000e+00, 8.200000000000e-02, 0.000000000000e+00, 0.000000000000e+00}, bcont.getExponents(1));

    // check normalization factors

    vlxtest::compare({2.026879611100e-01,
                      4.860657481700e-01,
                      1.000000000000e+00,
                      1.968215800000e-02,
                      1.379652400000e-01,
    ...
    vlxtest::compare({2.586000000000e-01, 1.000000000000e+00, 0.000000000000e+00, 0.000000000000e+00}, bcont.getNormFactors(1));

    // check coordinates X

    vlxtest::compare({0.000000000000e+00,
                      0.000000000000e+00,
                      0.000000000000e+00,
                      0.000000000000e+00,
                      0.000000000000e+00,
    ...
    vlxtest::compare({0.000000000000e+00, 0.000000000000e+00, 0.000000000000e+00, 0.000000000000e+00}, bcont.getCoordinatesX(1));
    ...
    vlxtest::compare({0.000000000000e+00, 0.000000000000e+00, 0.000000000000e+00, 0.000000000000e+00}, bcont.getCoordinatesY(1));
    ...
    vlxtest::compare({0.000000000000e+00, 0.000000000000e+00, 0.000000000000e+00, 0.000000000000e+00}, bcont.getCoordinatesZ(1));
}
...
TEST_F(CGtoContainerTest, GetExponents)
{
    ...
    vlxtest::compare({2.662778551600e+02,
                      4.006978344700e+01,
                      9.055994438900e+00,
                      2.450300905100e+00,
                      7.220957185500e-01,
    ...
    vlxtest::compare({1.450000000000e+00, 3.000000000000e-01, 8.200000000000e-02, 8.000000000000e-01}, acont.getExponents(1));
}
...
TEST_F(CGtoContainerTest, GetNormFactors)
{
    ...
    vlxtest::compare({6.492015032500e-03,
                      4.774786321500e-02,
                      2.026879611100e-01,
                      4.860657481700e-01,
                      4.362697795500e-01,
    ...
    vlxtest::compare({2.586000000000e-01, 1.000000000000e+00, 1.000000000000e+00, 1.000000000000e+00}, acont.getNormFactors(1));
}
...
TEST_F(CGtoContainerTest, GetCoordinatesX)
{
    ...
    vlxtest::compare({0.000000000000e+00, 0.000000000000e+00, 0.000000000000e+00, 0.000000000000e+00}, acont.getCoordinatesX(1));
}
...
TEST_F(CGtoContainerTest, GetCoordinatesY)
{
    ...
    vlxtest::compare({0.000000000000e+00, 0.000000000000e+00, 0.000000000000e+00, 0.000000000000e+00}, acont.getCoordinatesY(1));
}
...
TEST_F(CGtoContainerTest, GetCoordinatesZ)
{
    ...
    vlxtest::compare({0.000000000000e+00, 0.000000000000e+00, 0.000000000000e+00, 1.200000000000e+00}, acont.getCoordinatesZ(1));
}
