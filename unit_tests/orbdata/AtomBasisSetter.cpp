...
CAtomBasis
getMinimalBasisForLi()
{
    CAtomBasis bas;
        
    bas.setIdElemental(3);
    
    CBasisFunction bf_1 ({1.469000000000e+03, 2.205000000000e+02,
                          5.026000000000e+01, 1.424000000000e+01,
                          4.581000000000e+00, 1.580000000000e+00,
                          5.640000000000e-01, 7.345000000000e-02,
                          2.805000000000e-02},
                         {7.660000000000e-04, 5.892000000000e-03,
                          2.967100000000e-02, 1.091800000000e-01,
                          2.827890000000e-01, 4.531230000000e-01,
                          2.747740000000e-01, 9.751000000000e-03,
                         -3.180000000000e-03}, 0);
    bf_1.normalize();
        
    bas.addBasisFunction(bf_1);
    
    CBasisFunction bf_2 ({1.469000000000e+03,  2.205000000000e+02,
                          5.026000000000e+01,  1.424000000000e+01,
                          4.581000000000e+00,  1.580000000000e+00,
                          5.640000000000e-01,  7.345000000000e-02,
                          2.805000000000e-02},
                         {-1.200000000000e-04, -9.230000000000e-04,
                          -4.689000000000e-03, -1.768200000000e-02,
                          -4.890200000000e-02, -9.600900000000e-02,
                          -1.363800000000e-01,  5.751020000000e-01,
                           5.176610000000e-01}, 0);
    bf_2.normalize();
...
getMinimalGenBasisForLi()
{
    ...
    CBasisFunction bf_1 ({1.469000000000e+03,  2.205000000000e+02,
                         ...
                         {7.660000000000e-04,  5.892000000000e-03,
                          ...
                          2.827890000000e-01,  4.531230000000e-01,
                          2.747740000000e-01,  9.751000000000e-03,
                         -3.180000000000e-03, -1.200000000000e-04,
                         -9.230000000000e-04, -4.689000000000e-03,
                         -1.768200000000e-02, -4.890200000000e-02,
                         -9.600900000000e-02, -1.363800000000e-01,
                          5.751020000000e-01,  5.176610000000e-01},
                         2, 0);
    bf_1.normalize();
