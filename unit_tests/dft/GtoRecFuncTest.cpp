...
TEST_F(CGtoRecFuncTest, CompGtoTypeSForLDA)
{
    ...
    CMemBlock2D<double> dist({1.00, 1.20, 0.40, 1.00, 5.60, 0.20, 0.30, 0.80, 1.50, 8.00, 1.20, 0.80, 0.90, 1.90, 2.10}, 5, 3);
    ...
    CMemBlock2D<double> buffb({0.00709423488613152, 0.52152399192015800, 0.87632346843473900, 0.00413610812379884, 0.00000000000000000}, 5, 1);
...
{
    CMemBlock2D<double> dist({1.00, 1.20, 3.00, 4.00, 5.60, 2.00, 3.20, 0.80, 1.50, 8.00, 7.20, 7.80, 0.90, 1.90, 2.10}, 5, 3);
...
TEST_F(CGtoRecFuncTest, CompGtoTypeSForGGA)
{
    ...
    CMemBlock2D<double> buffb({0.00709423488613152,  0.52152399192015800,  0.87632346843473900,  0.00413610812379884,  0.00000000000000000,
                               -0.02057328116978140, -0.37549727418251300, -0.05748681952931890, -0.00661777299807815, 0.00000000000000000,
                               -0.00411465623395628, -0.09387431854562830, -0.11497363905863800, -0.00992665949711722, 0.00000000000000000,
                               -0.02468793740373770, -0.25033151612167600, -0.12934534394096700, -0.01257376869634850, 0.00000000000000000},
                              5,
                              4);
...
TEST_F(CGtoRecFuncTest, CompGtoTypeSForMGGA)
{
    ...
    CMemBlock2D<double> buffb({0.00709423488613152,  0.52152399192015800,  0.87632346843473900,  0.00413610812379884,  0.00000000000000000,
                               ...
                               -0.00411465623395628, -0.09387431854562830, -0.11497363905863800, -0.00992665949711722, 0.00000000000000000,
                               -0.02468793740373770, -0.25033151612167600, -0.12934534394096700, -0.01257376869634850, 0.00000000000000000,
                               0.08624319466372370,  -0.53132864296825600, -0.39320409689858800, 0.05278335743267130,  0.00000000000000000},
                              5,
                              5);
