...
TEST_F(CDiagEriRecForSSSSTest, CompBatchPrimIntsForSSSS)
{
    ...
    const BufferHostX<double> refs11(3, {0.123607744647421e+01,
                                         0.201644152944101e+00,
                                         0.100925300880806e+01});
...
TEST_F(CDiagEriRecForSSSSTest, CompBatchContrIntsForSSSS)
{
    ...
    const BufferHostX<double> refs22(3, {0.162923244046733e+01,
                                         0.379837636124064e-01,
                                         0.177264071094880e+01});
