...
TEST_F(CElectricFieldGradientMatrixTest, DefaultConstructor)
{
    ...
    CElectricFieldGradientMatrix smatb(
        CDenseMatrix(0, 0), CDenseMatrix(0, 0), CDenseMatrix(0, 0), CDenseMatrix(0, 0), CDenseMatrix(0, 0), CDenseMatrix(0, 0));
...
TEST_F(CElectricFieldGradientMatrixTest, XXValues)
{
    ...
    vlxtest::compare({1.0, -1.0, -3.0, -2.0, 5.0, 4.0, 6.0, 4.0, -4.0}, smata.xxvalues());
}
...
TEST_F(CElectricFieldGradientMatrixTest, XYValues)
{
    ...
    vlxtest::compare({1.0, -2.0, -1.0, -6.0, 6.0, 1.0, 3.0, 4.0, -8.0}, smata.xyvalues());
}
...
TEST_F(CElectricFieldGradientMatrixTest, XZValues)
{
    ...
    vlxtest::compare({7.0, -1.0, -2.0, -9.0, 5.0, 8.0, 1.0, 3.0, -2.0}, smata.xzvalues());
}
...
TEST_F(CElectricFieldGradientMatrixTest, YYValues)
{
    ...
    vlxtest::compare({0.0, -1.0, -1.0, -2.0, 5.0, 4.0, 6.0, 4.0, -4.0}, smata.yyvalues());
}
...
TEST_F(CElectricFieldGradientMatrixTest, YZValues)
{
    ...
    vlxtest::compare({1.0, -2.0, -8.0, -6.0, 6.0, 1.0, 3.0, 4.0, -7.0}, smata.yzvalues());
}
...
TEST_F(CElectricFieldGradientMatrixTest, ZZValues)
{
    ...
    vlxtest::compare({7.0, -1.0, -2.0, -3.0, 5.0, 8.0, 1.0, 3.0, -4.0}, smata.zzvalues());
}
