...
class TestScfRestrictedOpenShell:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ('water_triplet.inp', 'slater', 'def2-svp', -74.866028820996),
            ('water_triplet.inp', 'slda', 'def2-svp', -75.693553693373),
            ('water_triplet.inp', 'blyp', 'def2-svp', -76.055256562197),
            ('water_triplet.inp', 'b3lyp', 'def2-svp', -76.074465640003),
            ('water_triplet.inp', 'b3lyp', 'aug-cc-pvdz', -76.176630871552),
            ('water_triplet.inp', 'tpssh', 'aug-cc-pvdz', -76.170886931554),
            ('water_triplet.inp', 'm06', 'aug-cc-pvdz', -76.123073075657),
        ],
        ids=[
