...
class TestQrf:
    ...
    def run_qrf(self, ref_result):
        ...
        qrf_result_xxz = qrf_prop.compute(molecule, ao_basis, scf_tensors,
                                          method_settings)
        ...
        qrf_result_yzy = qrf_prop.compute(molecule, ao_basis, scf_tensors,
                                          method_settings)
        ...
        qrf_result_zzz = qrf_prop.compute(molecule, ao_basis, scf_tensors,
                                          method_settings)
