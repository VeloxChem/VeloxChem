...
class TestExciton(unittest.TestCase):
    ...
    def test_assemble_matrices(self):
        ...
        if (rank == mpi_master()):
            ...
            S_exmod = assemble_overlap_matrices(mol_1, mol_2,
                                                basis, basis,
                                                S11, S22,
                                                S12, S21)
        ...
        if (rank == mpi_master()):
            ...
            T_exmod = assemble_kinetic_energy_matrices(mol_1, mol_2,
                                                       basis, basis,
                                                       T11, T22,
                                                       T12, T21)
        ...
        if (rank == mpi_master()):
            ...
            V_exmod = assemble_nuclear_potential_matrices(mol_1, mol_2,
                                                          basis, basis,
                                                          V11, V22,
                                                          V12, V21)
