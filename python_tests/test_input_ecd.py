...
class TestInputECD:
    ...
    def test_input_rks_tda_ecd(self, capsys):
        ...
        ref_data = {
            ...
            'e_scf': -227.1612576278,
            'n_scf_iterations': 8,
            'dipole': 0.859300,
            'nstates': 10,
            'n_ecd_iterations': 6,
            'exc_ene': np.array([
                0.36834779, 0.39181382, 0.41050608, 0.43684865, 0.43805436,
                0.46396848, 0.46892271, 0.47444890, 0.47872402, 0.49959739
            ]),
            'osc_str': np.array([
            ...
            'rot_str': np.array([
                -0.004653, 0.000545, -0.002206, 0.008612, 0.006266, 0.002287,
                -0.045493, -0.011787, 0.012514, 0.008681
            ]),
        }
    ...
    def test_input_rks_tddft_ecd(self, capsys):
        ...
        ref_data = {
            ...
            'n_ecd_iterations': 7,
            'exc_ene': np.array([
                0.36687873, 0.39023242, 0.41016270, 0.43625183, 0.43775912,
                0.46363889, 0.46676315, 0.47242314, 0.47787096, 0.49859168
            ]),
            'osc_str': np.array([
            ...
            'rot_str': np.array([
                -0.000777, 0.000612, -0.004003, 0.013425, 0.002090, 0.004832,
                -0.073974, 0.004683, 0.011048, 0.019717
            ]),
        }
