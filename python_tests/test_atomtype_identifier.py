...
class TestAtomTypeIdentifier:
    ...
    def test_atomtypeidentifier_8(self):
        mol8 = """13
        2-sulfanyl-2,3-dihydro-1,2,3-triazine-4(1H)-thione
        S 2.547758 -0.919099 -0.053026
        S -2.705184 -0.795536 0.103404
        N 1.128924 -0.011693 -0.377571
        N -0.064029 -0.748349 -0.053981
        N 1.139175 1.250598 0.371535
        C -1.124329 -0.028818 -0.115379
        C -1.120311 1.420199 -0.258114
        C 0.038662 2.018372 0.067171
        H 2.381553 -1.155465 1.277531
        H -2.221852 -2.049836 0.167875
        H 2.042552 1.684451 0.251989
        H -2.024383 1.975775 -0.440590
        H 0.148326 3.086836 0.195205
        """
        expected_atomtypes8 = ['sh', 'sh', 'na', 'nc', 'na', 'cc', 'cc', 'cd', 'hs', 'hs', 'hn', 'ha', 'h4']
