...
class TestRPA:
    ...
    def test_rpa_dft_pe(self):
        ...
        #  -----------------------------------------------------------
        raw_data = """
            1     7.3127     0.0540     0.0568     0.1649     0.8479
            2     9.0051     0.0065     0.0071    -0.0945     0.0751
            3     9.5091     0.0886     0.0946    -0.3706    -1.2063
            4    10.1822     0.0005     0.0003    -0.1341    -0.3188
            5    11.0088     0.0046     0.0025     0.2632    -0.1881
        """
        data_lines = raw_data.splitlines()[1:-1]
