...
class TestLibxcSigmaA:
    ...
    def run_sigma_a_fd(self, xcfun_label, tol):
        ...
        v2sigmalapl_aa = fxc["v2sigmalapl"][0][0]
        v2sigmalapl_ca = fxc["v2sigmalapl"][0][2]
        vlapl_a_plus = vxc_plus["vlapl"][0][0]
        vlapl_a_minus = vxc_minus["vlapl"][0][0]
        v2sigmalapl_aa_fd = (vlapl_a_plus - vlapl_a_minus) / (delta_h * 2)
        self.check_term(tol, "v2sigmalapl_aa",
                        2 * v2sigmalapl_aa * nabla_a + v2sigmalapl_ca * nabla_b,
                        v2sigmalapl_aa_fd)

        v2sigmalapl_ab = fxc["v2sigmalapl"][0][1]
        v2sigmalapl_cb = fxc["v2sigmalapl"][0][3]
        vlapl_b_plus = vxc_plus["vlapl"][0][1]
        vlapl_b_minus = vxc_minus["vlapl"][0][1]
        v2sigmalapl_ab_fd = (vlapl_b_plus - vlapl_b_minus) / (delta_h * 2)
        self.check_term(tol, "v2sigmalapl_ab",
                        2 * v2sigmalapl_ab * nabla_a + v2sigmalapl_cb * nabla_b,
                        v2sigmalapl_ab_fd)
        ...
        v3sigma2lapl_aaa = kxc["v3sigma2lapl"][0][0]
        v3sigma2lapl_aca = kxc["v3sigma2lapl"][0][2]
        v2sigmalapl_aa_plus = fxc_plus["v2sigmalapl"][0][0]
        v2sigmalapl_aa_minus = fxc_minus["v2sigmalapl"][0][0]
        v3sigma2lapl_aaa_fd = (v2sigmalapl_aa_plus -
                               v2sigmalapl_aa_minus) / (delta_h * 2)
        self.check_term(
            tol, "v3sigma2lapl_aaa",
            2 * v3sigma2lapl_aaa * nabla_a + v3sigma2lapl_aca * nabla_b,
            v3sigma2lapl_aaa_fd)

        v3sigma2lapl_aab = kxc["v3sigma2lapl"][0][1]
        v3sigma2lapl_acb = kxc["v3sigma2lapl"][0][3]
        v2sigmalapl_ab_plus = fxc_plus["v2sigmalapl"][0][1]
        v2sigmalapl_ab_minus = fxc_minus["v2sigmalapl"][0][1]
        v3sigma2lapl_aab_fd = (v2sigmalapl_ab_plus -
                               v2sigmalapl_ab_minus) / (delta_h * 2)
        self.check_term(
            tol, "v3sigma2lapl_aab",
            2 * v3sigma2lapl_aab * nabla_a + v3sigma2lapl_acb * nabla_b,
            v3sigma2lapl_aab_fd)

        v3sigma2lapl_aca = kxc["v3sigma2lapl"][0][2]
        v3sigma2lapl_cca = kxc["v3sigma2lapl"][0][6]
        v2sigmalapl_ca_plus = fxc_plus["v2sigmalapl"][0][2]
        v2sigmalapl_ca_minus = fxc_minus["v2sigmalapl"][0][2]
        v3sigma2lapl_aca_fd = (v2sigmalapl_ca_plus -
                               v2sigmalapl_ca_minus) / (delta_h * 2)
        self.check_term(
            tol, "v3sigma2lapl_aca",
            2 * v3sigma2lapl_aca * nabla_a + v3sigma2lapl_cca * nabla_b,
            v3sigma2lapl_aca_fd)

        v3sigma2lapl_acb = kxc["v3sigma2lapl"][0][3]
        v3sigma2lapl_ccb = kxc["v3sigma2lapl"][0][7]
        v2sigmalapl_cb_plus = fxc_plus["v2sigmalapl"][0][3]
        v2sigmalapl_cb_minus = fxc_minus["v2sigmalapl"][0][3]
        v3sigma2lapl_acb_fd = (v2sigmalapl_cb_plus -
                               v2sigmalapl_cb_minus) / (delta_h * 2)
        self.check_term(
            tol, "v3sigma2lapl_acb",
            2 * v3sigma2lapl_acb * nabla_a + v3sigma2lapl_ccb * nabla_b,
            v3sigma2lapl_acb_fd)

        v3sigma2lapl_aba = kxc["v3sigma2lapl"][0][4]
        ...
        v3sigma2lapl_aba_fd = (v2sigmalapl_ba_plus -
                               v2sigmalapl_ba_minus) / (delta_h * 2)
        self.check_term(
            tol, "v3sigma2lapl_aba",
            2 * v3sigma2lapl_aba * nabla_a + v3sigma2lapl_cba * nabla_b,
            v3sigma2lapl_aba_fd)

        v3sigma2lapl_abb = kxc["v3sigma2lapl"][0][5]
        ...
        v3sigma2lapl_abb_fd = (v2sigmalapl_bb_plus -
                               v2sigmalapl_bb_minus) / (delta_h * 2)
        self.check_term(
            tol, "v3sigma2lapl_abb",
            2 * v3sigma2lapl_abb * nabla_a + v3sigma2lapl_cbb * nabla_b,
            v3sigma2lapl_abb_fd)
        ...
        v3sigmalapl2_aaa = kxc["v3sigmalapl2"][0][0]
        v3sigmalapl2_caa = kxc["v3sigmalapl2"][0][3]
        v2lapl2_aa_plus = fxc_plus["v2lapl2"][0][0]
        v2lapl2_aa_minus = fxc_minus["v2lapl2"][0][0]
        v3sigmalapl2_aaa_fd = (v2lapl2_aa_plus - v2lapl2_aa_minus) / (delta_h *
                                                                      2)
        self.check_term(
            tol, "v3sigmalapl2_aaa",
            2 * v3sigmalapl2_aaa * nabla_a + v3sigmalapl2_caa * nabla_b,
            v3sigmalapl2_aaa_fd)

        v3sigmalapl2_aab = kxc["v3sigmalapl2"][0][1]
        v3sigmalapl2_cab = kxc["v3sigmalapl2"][0][4]
        v2lapl2_ab_plus = fxc_plus["v2lapl2"][0][1]
        v2lapl2_ab_minus = fxc_minus["v2lapl2"][0][1]
        v3sigmalapl2_aab_fd = (v2lapl2_ab_plus - v2lapl2_ab_minus) / (delta_h *
                                                                      2)
        self.check_term(
            tol, "v3sigmalapl2_aab",
            2 * v3sigmalapl2_aab * nabla_a + v3sigmalapl2_cab * nabla_b,
            v3sigmalapl2_aab_fd)

        v3sigmalapl2_abb = kxc["v3sigmalapl2"][0][2]
        v3sigmalapl2_cbb = kxc["v3sigmalapl2"][0][5]
        v2lapl2_bb_plus = fxc_plus["v2lapl2"][0][2]
        v2lapl2_bb_minus = fxc_minus["v2lapl2"][0][2]
        v3sigmalapl2_abb_fd = (v2lapl2_bb_plus - v2lapl2_bb_minus) / (delta_h *
                                                                      2)
        self.check_term(
            tol, "v3sigmalapl2_abb",
            2 * v3sigmalapl2_abb * nabla_a + v3sigmalapl2_cbb * nabla_b,
            v3sigmalapl2_abb_fd)

        v3sigmalapltau_aaa = kxc["v3sigmalapltau"][0][0]
        ...
        v3sigmalapltau_aaa_fd = (v2lapltau_aa_plus -
                                 v2lapltau_aa_minus) / (delta_h * 2)
        self.check_term(
            tol, "v3sigmalapltau_aaa",
            2 * v3sigmalapltau_aaa * nabla_a + v3sigmalapltau_caa * nabla_b,
            v3sigmalapltau_aaa_fd)

        v3sigmalapltau_aab = kxc["v3sigmalapltau"][0][1]
        ...
        v3sigmalapltau_aab_fd = (v2lapltau_ab_plus -
                                 v2lapltau_ab_minus) / (delta_h * 2)
        self.check_term(
            tol, "v3sigmalapltau_aab",
            2 * v3sigmalapltau_aab * nabla_a + v3sigmalapltau_cab * nabla_b,
            v3sigmalapltau_aab_fd)

        v3sigmalapltau_aba = kxc["v3sigmalapltau"][0][2]
        ...
        v3sigmalapltau_aba_fd = (v2lapltau_ba_plus -
                                 v2lapltau_ba_minus) / (delta_h * 2)
        self.check_term(
            tol, "v3sigmalapltau_aba",
            2 * v3sigmalapltau_aba * nabla_a + v3sigmalapltau_cba * nabla_b,
            v3sigmalapltau_aba_fd)

        v3sigmalapltau_abb = kxc["v3sigmalapltau"][0][3]
        ...
        v3sigmalapltau_abb_fd = (v2lapltau_bb_plus -
                                 v2lapltau_bb_minus) / (delta_h * 2)
        self.check_term(
            tol, "v3sigmalapltau_abb",
            2 * v3sigmalapltau_abb * nabla_a + v3sigmalapltau_cbb * nabla_b,
            v3sigmalapltau_abb_fd)
        ...
        v4sigma3lapl_aaaa = lxc["v4sigma3lapl"][0][0]
        v4sigma3lapl_aaca = lxc["v4sigma3lapl"][0][2]
        v3sigma2lapl_aaa_plus = kxc_plus["v3sigma2lapl"][0][0]
        v3sigma2lapl_aaa_minus = kxc_minus["v3sigma2lapl"][0][0]
        v4sigma3lapl_aaaa_fd = (v3sigma2lapl_aaa_plus -
                                v3sigma2lapl_aaa_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma3lapl_aaaa",
            2 * v4sigma3lapl_aaaa * nabla_a + v4sigma3lapl_aaca * nabla_b,
            v4sigma3lapl_aaaa_fd)

        v4sigma3lapl_aaab = lxc["v4sigma3lapl"][0][1]
        v4sigma3lapl_aacb = lxc["v4sigma3lapl"][0][3]
        v3sigma2lapl_aab_plus = kxc_plus["v3sigma2lapl"][0][1]
        v3sigma2lapl_aab_minus = kxc_minus["v3sigma2lapl"][0][1]
        v4sigma3lapl_aaab_fd = (v3sigma2lapl_aab_plus -
                                v3sigma2lapl_aab_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma3lapl_aaab",
            2 * v4sigma3lapl_aaab * nabla_a + v4sigma3lapl_aacb * nabla_b,
            v4sigma3lapl_aaab_fd)

        v4sigma3lapl_aaca = lxc["v4sigma3lapl"][0][2]
        v4sigma3lapl_acca = lxc["v4sigma3lapl"][0][6]
        v3sigma2lapl_aca_plus = kxc_plus["v3sigma2lapl"][0][2]
        v3sigma2lapl_aca_minus = kxc_minus["v3sigma2lapl"][0][2]
        v4sigma3lapl_aaca_fd = (v3sigma2lapl_aca_plus -
                                v3sigma2lapl_aca_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma3lapl_aaca",
            2 * v4sigma3lapl_aaca * nabla_a + v4sigma3lapl_acca * nabla_b,
            v4sigma3lapl_aaca_fd)

        v4sigma3lapl_aacb = lxc["v4sigma3lapl"][0][3]
        v4sigma3lapl_accb = lxc["v4sigma3lapl"][0][7]
        v3sigma2lapl_acb_plus = kxc_plus["v3sigma2lapl"][0][3]
        v3sigma2lapl_acb_minus = kxc_minus["v3sigma2lapl"][0][3]
        v4sigma3lapl_aacb_fd = (v3sigma2lapl_acb_plus -
                                v3sigma2lapl_acb_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma3lapl_aacb",
            2 * v4sigma3lapl_aacb * nabla_a + v4sigma3lapl_accb * nabla_b,
            v4sigma3lapl_aacb_fd)

        v4sigma3lapl_aaba = lxc["v4sigma3lapl"][0][4]
        v4sigma3lapl_acba = lxc["v4sigma3lapl"][0][8]
        v3sigma2lapl_aba_plus = kxc_plus["v3sigma2lapl"][0][4]
        v3sigma2lapl_aba_minus = kxc_minus["v3sigma2lapl"][0][4]
        v4sigma3lapl_aaba_fd = (v3sigma2lapl_aba_plus -
                                v3sigma2lapl_aba_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma3lapl_aaba",
            2 * v4sigma3lapl_aaba * nabla_a + v4sigma3lapl_acba * nabla_b,
            v4sigma3lapl_aaba_fd)

        v4sigma3lapl_aabb = lxc["v4sigma3lapl"][0][5]
        v4sigma3lapl_acbb = lxc["v4sigma3lapl"][0][9]
        v3sigma2lapl_abb_plus = kxc_plus["v3sigma2lapl"][0][5]
        v3sigma2lapl_abb_minus = kxc_minus["v3sigma2lapl"][0][5]
        v4sigma3lapl_aabb_fd = (v3sigma2lapl_abb_plus -
                                v3sigma2lapl_abb_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma3lapl_aabb",
            2 * v4sigma3lapl_aabb * nabla_a + v4sigma3lapl_acbb * nabla_b,
            v4sigma3lapl_aabb_fd)

        v4sigma3lapl_acca = lxc["v4sigma3lapl"][0][6]
        v4sigma3lapl_ccca = lxc["v4sigma3lapl"][0][12]
        v3sigma2lapl_cca_plus = kxc_plus["v3sigma2lapl"][0][6]
        v3sigma2lapl_cca_minus = kxc_minus["v3sigma2lapl"][0][6]
        v4sigma3lapl_acca_fd = (v3sigma2lapl_cca_plus -
                                v3sigma2lapl_cca_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma3lapl_acca",
            2 * v4sigma3lapl_acca * nabla_a + v4sigma3lapl_ccca * nabla_b,
            v4sigma3lapl_acca_fd)

        v4sigma3lapl_accb = lxc["v4sigma3lapl"][0][7]
        v4sigma3lapl_cccb = lxc["v4sigma3lapl"][0][13]
        v3sigma2lapl_ccb_plus = kxc_plus["v3sigma2lapl"][0][7]
        v3sigma2lapl_ccb_minus = kxc_minus["v3sigma2lapl"][0][7]
        v4sigma3lapl_accb_fd = (v3sigma2lapl_ccb_plus -
                                v3sigma2lapl_ccb_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma3lapl_accb",
            2 * v4sigma3lapl_accb * nabla_a + v4sigma3lapl_cccb * nabla_b,
            v4sigma3lapl_accb_fd)

        v4sigma3lapl_acba = lxc["v4sigma3lapl"][0][8]
        v4sigma3lapl_ccba = lxc["v4sigma3lapl"][0][14]
        v3sigma2lapl_cba_plus = kxc_plus["v3sigma2lapl"][0][8]
        v3sigma2lapl_cba_minus = kxc_minus["v3sigma2lapl"][0][8]
        v4sigma3lapl_acba_fd = (v3sigma2lapl_cba_plus -
                                v3sigma2lapl_cba_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma3lapl_acba",
            2 * v4sigma3lapl_acba * nabla_a + v4sigma3lapl_ccba * nabla_b,
            v4sigma3lapl_acba_fd)

        v4sigma3lapl_acbb = lxc["v4sigma3lapl"][0][9]
        v4sigma3lapl_ccbb = lxc["v4sigma3lapl"][0][15]
        v3sigma2lapl_cbb_plus = kxc_plus["v3sigma2lapl"][0][9]
        v3sigma2lapl_cbb_minus = kxc_minus["v3sigma2lapl"][0][9]
        v4sigma3lapl_acbb_fd = (v3sigma2lapl_cbb_plus -
                                v3sigma2lapl_cbb_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma3lapl_acbb",
            2 * v4sigma3lapl_acbb * nabla_a + v4sigma3lapl_ccbb * nabla_b,
            v4sigma3lapl_acbb_fd)

        v4sigma3lapl_abba = lxc["v4sigma3lapl"][0][10]
        ...
        v4sigma3lapl_abba_fd = (v3sigma2lapl_bba_plus -
                                v3sigma2lapl_bba_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma3lapl_abba",
            2 * v4sigma3lapl_abba * nabla_a + v4sigma3lapl_cbba * nabla_b,
            v4sigma3lapl_abba_fd)

        v4sigma3lapl_abbb = lxc["v4sigma3lapl"][0][11]
        ...
        v4sigma3lapl_abbb_fd = (v3sigma2lapl_bbb_plus -
                                v3sigma2lapl_bbb_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma3lapl_abbb",
            2 * v4sigma3lapl_abbb * nabla_a + v4sigma3lapl_cbbb * nabla_b,
            v4sigma3lapl_abbb_fd)
        ...
        v4sigma2lapl2_aaaa = lxc["v4sigma2lapl2"][0][0]
        v4sigma2lapl2_acaa = lxc["v4sigma2lapl2"][0][3]
        v3sigmalapl2_aaa_plus = kxc_plus["v3sigmalapl2"][0][0]
        v3sigmalapl2_aaa_minus = kxc_minus["v3sigmalapl2"][0][0]
        v4sigma2lapl2_aaaa_fd = (v3sigmalapl2_aaa_plus -
                                 v3sigmalapl2_aaa_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma2lapl2_aaaa",
            2 * v4sigma2lapl2_aaaa * nabla_a + v4sigma2lapl2_acaa * nabla_b,
            v4sigma2lapl2_aaaa_fd)

        v4sigma2lapl2_aaab = lxc["v4sigma2lapl2"][0][1]
        v4sigma2lapl2_acab = lxc["v4sigma2lapl2"][0][4]
        v3sigmalapl2_aab_plus = kxc_plus["v3sigmalapl2"][0][1]
        v3sigmalapl2_aab_minus = kxc_minus["v3sigmalapl2"][0][1]
        v4sigma2lapl2_aaab_fd = (v3sigmalapl2_aab_plus -
                                 v3sigmalapl2_aab_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma2lapl2_aaab",
            2 * v4sigma2lapl2_aaab * nabla_a + v4sigma2lapl2_acab * nabla_b,
            v4sigma2lapl2_aaab_fd)

        v4sigma2lapl2_aabb = lxc["v4sigma2lapl2"][0][2]
        v4sigma2lapl2_acbb = lxc["v4sigma2lapl2"][0][5]
        v3sigmalapl2_abb_plus = kxc_plus["v3sigmalapl2"][0][2]
        v3sigmalapl2_abb_minus = kxc_minus["v3sigmalapl2"][0][2]
        v4sigma2lapl2_aabb_fd = (v3sigmalapl2_abb_plus -
                                 v3sigmalapl2_abb_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma2lapl2_aabb",
            2 * v4sigma2lapl2_aabb * nabla_a + v4sigma2lapl2_acbb * nabla_b,
            v4sigma2lapl2_aabb_fd)

        v4sigma2lapl2_acaa = lxc["v4sigma2lapl2"][0][3]
        v4sigma2lapl2_ccaa = lxc["v4sigma2lapl2"][0][9]
        v3sigmalapl2_caa_plus = kxc_plus["v3sigmalapl2"][0][3]
        v3sigmalapl2_caa_minus = kxc_minus["v3sigmalapl2"][0][3]
        v4sigma2lapl2_acaa_fd = (v3sigmalapl2_caa_plus -
                                 v3sigmalapl2_caa_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma2lapl2_acaa",
            2 * v4sigma2lapl2_acaa * nabla_a + v4sigma2lapl2_ccaa * nabla_b,
            v4sigma2lapl2_acaa_fd)

        v4sigma2lapl2_acab = lxc["v4sigma2lapl2"][0][4]
        v4sigma2lapl2_ccab = lxc["v4sigma2lapl2"][0][10]
        v3sigmalapl2_cab_plus = kxc_plus["v3sigmalapl2"][0][4]
        v3sigmalapl2_cab_minus = kxc_minus["v3sigmalapl2"][0][4]
        v4sigma2lapl2_acab_fd = (v3sigmalapl2_cab_plus -
                                 v3sigmalapl2_cab_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma2lapl2_acab",
            2 * v4sigma2lapl2_acab * nabla_a + v4sigma2lapl2_ccab * nabla_b,
            v4sigma2lapl2_acab_fd)

        v4sigma2lapl2_acbb = lxc["v4sigma2lapl2"][0][5]
        v4sigma2lapl2_ccbb = lxc["v4sigma2lapl2"][0][11]
        v3sigmalapl2_cbb_plus = kxc_plus["v3sigmalapl2"][0][5]
        v3sigmalapl2_cbb_minus = kxc_minus["v3sigmalapl2"][0][5]
        v4sigma2lapl2_acbb_fd = (v3sigmalapl2_cbb_plus -
                                 v3sigmalapl2_cbb_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma2lapl2_acbb",
            2 * v4sigma2lapl2_acbb * nabla_a + v4sigma2lapl2_ccbb * nabla_b,
            v4sigma2lapl2_acbb_fd)

        v4sigma2lapl2_abaa = lxc["v4sigma2lapl2"][0][6]
        ...
        v4sigma2lapl2_abaa_fd = (v3sigmalapl2_baa_plus -
                                 v3sigmalapl2_baa_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma2lapl2_abaa",
            2 * v4sigma2lapl2_abaa * nabla_a + v4sigma2lapl2_cbaa * nabla_b,
            v4sigma2lapl2_abaa_fd)

        v4sigma2lapl2_abab = lxc["v4sigma2lapl2"][0][7]
        ...
        v4sigma2lapl2_abab_fd = (v3sigmalapl2_bab_plus -
                                 v3sigmalapl2_bab_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma2lapl2_abab",
            2 * v4sigma2lapl2_abab * nabla_a + v4sigma2lapl2_cbab * nabla_b,
            v4sigma2lapl2_abab_fd)

        v4sigma2lapl2_abbb = lxc["v4sigma2lapl2"][0][8]
        ...
        v4sigma2lapl2_abbb_fd = (v3sigmalapl2_bbb_plus -
                                 v3sigmalapl2_bbb_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma2lapl2_abbb",
            2 * v4sigma2lapl2_abbb * nabla_a + v4sigma2lapl2_cbbb * nabla_b,
            v4sigma2lapl2_abbb_fd)

        v4sigma2lapltau_aaaa = lxc["v4sigma2lapltau"][0][0]
        v4sigma2lapltau_acaa = lxc["v4sigma2lapltau"][0][4]
        v3sigmalapltau_aaa_plus = kxc_plus["v3sigmalapltau"][0][0]
        v3sigmalapltau_aaa_minus = kxc_minus["v3sigmalapltau"][0][0]
        v4sigma2lapltau_aaaa_fd = (v3sigmalapltau_aaa_plus -
                                   v3sigmalapltau_aaa_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma2lapltau_aaaa",
            2 * v4sigma2lapltau_aaaa * nabla_a + v4sigma2lapltau_acaa * nabla_b,
            v4sigma2lapltau_aaaa_fd)

        v4sigma2lapltau_aaab = lxc["v4sigma2lapltau"][0][1]
        v4sigma2lapltau_acab = lxc["v4sigma2lapltau"][0][5]
        v3sigmalapltau_aab_plus = kxc_plus["v3sigmalapltau"][0][1]
        v3sigmalapltau_aab_minus = kxc_minus["v3sigmalapltau"][0][1]
        v4sigma2lapltau_aaab_fd = (v3sigmalapltau_aab_plus -
                                   v3sigmalapltau_aab_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma2lapltau_aaab",
            2 * v4sigma2lapltau_aaab * nabla_a + v4sigma2lapltau_acab * nabla_b,
            v4sigma2lapltau_aaab_fd)

        v4sigma2lapltau_aaba = lxc["v4sigma2lapltau"][0][2]
        v4sigma2lapltau_acba = lxc["v4sigma2lapltau"][0][6]
        v3sigmalapltau_aba_plus = kxc_plus["v3sigmalapltau"][0][2]
        v3sigmalapltau_aba_minus = kxc_minus["v3sigmalapltau"][0][2]
        v4sigma2lapltau_aaba_fd = (v3sigmalapltau_aba_plus -
                                   v3sigmalapltau_aba_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma2lapltau_aaba",
            2 * v4sigma2lapltau_aaba * nabla_a + v4sigma2lapltau_acba * nabla_b,
            v4sigma2lapltau_aaba_fd)

        v4sigma2lapltau_aabb = lxc["v4sigma2lapltau"][0][3]
        v4sigma2lapltau_acbb = lxc["v4sigma2lapltau"][0][7]
        v3sigmalapltau_abb_plus = kxc_plus["v3sigmalapltau"][0][3]
        v3sigmalapltau_abb_minus = kxc_minus["v3sigmalapltau"][0][3]
        v4sigma2lapltau_aabb_fd = (v3sigmalapltau_abb_plus -
                                   v3sigmalapltau_abb_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma2lapltau_aabb",
            2 * v4sigma2lapltau_aabb * nabla_a + v4sigma2lapltau_acbb * nabla_b,
            v4sigma2lapltau_aabb_fd)

        v4sigma2lapltau_acaa = lxc["v4sigma2lapltau"][0][4]
        v4sigma2lapltau_ccaa = lxc["v4sigma2lapltau"][0][12]
        v3sigmalapltau_caa_plus = kxc_plus["v3sigmalapltau"][0][4]
        v3sigmalapltau_caa_minus = kxc_minus["v3sigmalapltau"][0][4]
        v4sigma2lapltau_acaa_fd = (v3sigmalapltau_caa_plus -
                                   v3sigmalapltau_caa_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma2lapltau_acaa",
            2 * v4sigma2lapltau_acaa * nabla_a + v4sigma2lapltau_ccaa * nabla_b,
            v4sigma2lapltau_acaa_fd)

        v4sigma2lapltau_acab = lxc["v4sigma2lapltau"][0][5]
        v4sigma2lapltau_ccab = lxc["v4sigma2lapltau"][0][13]
        v3sigmalapltau_cab_plus = kxc_plus["v3sigmalapltau"][0][5]
        v3sigmalapltau_cab_minus = kxc_minus["v3sigmalapltau"][0][5]
        v4sigma2lapltau_acab_fd = (v3sigmalapltau_cab_plus -
                                   v3sigmalapltau_cab_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma2lapltau_acab",
            2 * v4sigma2lapltau_acab * nabla_a + v4sigma2lapltau_ccab * nabla_b,
            v4sigma2lapltau_acab_fd)

        v4sigma2lapltau_acba = lxc["v4sigma2lapltau"][0][6]
        v4sigma2lapltau_ccba = lxc["v4sigma2lapltau"][0][14]
        v3sigmalapltau_cba_plus = kxc_plus["v3sigmalapltau"][0][6]
        v3sigmalapltau_cba_minus = kxc_minus["v3sigmalapltau"][0][6]
        v4sigma2lapltau_acba_fd = (v3sigmalapltau_cba_plus -
                                   v3sigmalapltau_cba_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma2lapltau_acba",
            2 * v4sigma2lapltau_acba * nabla_a + v4sigma2lapltau_ccba * nabla_b,
            v4sigma2lapltau_acba_fd)

        v4sigma2lapltau_acbb = lxc["v4sigma2lapltau"][0][7]
        v4sigma2lapltau_ccbb = lxc["v4sigma2lapltau"][0][15]
        v3sigmalapltau_cbb_plus = kxc_plus["v3sigmalapltau"][0][7]
        v3sigmalapltau_cbb_minus = kxc_minus["v3sigmalapltau"][0][7]
        v4sigma2lapltau_acbb_fd = (v3sigmalapltau_cbb_plus -
                                   v3sigmalapltau_cbb_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma2lapltau_acbb",
            2 * v4sigma2lapltau_acbb * nabla_a + v4sigma2lapltau_ccbb * nabla_b,
            v4sigma2lapltau_acbb_fd)

        v4sigma2lapltau_abaa = lxc["v4sigma2lapltau"][0][8]
        ...
        v4sigma2lapltau_abaa_fd = (v3sigmalapltau_baa_plus -
                                   v3sigmalapltau_baa_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma2lapltau_abaa",
            2 * v4sigma2lapltau_abaa * nabla_a + v4sigma2lapltau_cbaa * nabla_b,
            v4sigma2lapltau_abaa_fd)

        v4sigma2lapltau_abab = lxc["v4sigma2lapltau"][0][9]
        ...
        v4sigma2lapltau_abab_fd = (v3sigmalapltau_bab_plus -
                                   v3sigmalapltau_bab_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma2lapltau_abab",
            2 * v4sigma2lapltau_abab * nabla_a + v4sigma2lapltau_cbab * nabla_b,
            v4sigma2lapltau_abab_fd)

        v4sigma2lapltau_abba = lxc["v4sigma2lapltau"][0][10]
        ...
        v4sigma2lapltau_abba_fd = (v3sigmalapltau_bba_plus -
                                   v3sigmalapltau_bba_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma2lapltau_abba",
            2 * v4sigma2lapltau_abba * nabla_a + v4sigma2lapltau_cbba * nabla_b,
            v4sigma2lapltau_abba_fd)

        v4sigma2lapltau_abbb = lxc["v4sigma2lapltau"][0][11]
        ...
        v4sigma2lapltau_abbb_fd = (v3sigmalapltau_bbb_plus -
                                   v3sigmalapltau_bbb_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigma2lapltau_abbb",
            2 * v4sigma2lapltau_abbb * nabla_a + v4sigma2lapltau_cbbb * nabla_b,
            v4sigma2lapltau_abbb_fd)
        ...
        v4sigmalapl3_aaaa = lxc["v4sigmalapl3"][0][0]
        v4sigmalapl3_caaa = lxc["v4sigmalapl3"][0][4]
        v3lapl3_aaa_plus = kxc_plus["v3lapl3"][0][0]
        v3lapl3_aaa_minus = kxc_minus["v3lapl3"][0][0]
        v4sigmalapl3_aaaa_fd = (v3lapl3_aaa_plus -
                                v3lapl3_aaa_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigmalapl3_aaaa",
            2 * v4sigmalapl3_aaaa * nabla_a + v4sigmalapl3_caaa * nabla_b,
            v4sigmalapl3_aaaa_fd)

        v4sigmalapl3_aaab = lxc["v4sigmalapl3"][0][1]
        v4sigmalapl3_caab = lxc["v4sigmalapl3"][0][5]
        v3lapl3_aab_plus = kxc_plus["v3lapl3"][0][1]
        v3lapl3_aab_minus = kxc_minus["v3lapl3"][0][1]
        v4sigmalapl3_aaab_fd = (v3lapl3_aab_plus -
                                v3lapl3_aab_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigmalapl3_aaab",
            2 * v4sigmalapl3_aaab * nabla_a + v4sigmalapl3_caab * nabla_b,
            v4sigmalapl3_aaab_fd)

        v4sigmalapl3_aabb = lxc["v4sigmalapl3"][0][2]
        v4sigmalapl3_cabb = lxc["v4sigmalapl3"][0][6]
        v3lapl3_abb_plus = kxc_plus["v3lapl3"][0][2]
        v3lapl3_abb_minus = kxc_minus["v3lapl3"][0][2]
        v4sigmalapl3_aabb_fd = (v3lapl3_abb_plus -
                                v3lapl3_abb_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigmalapl3_aabb",
            2 * v4sigmalapl3_aabb * nabla_a + v4sigmalapl3_cabb * nabla_b,
            v4sigmalapl3_aabb_fd)

        v4sigmalapl3_abbb = lxc["v4sigmalapl3"][0][3]
        v4sigmalapl3_cbbb = lxc["v4sigmalapl3"][0][7]
        v3lapl3_bbb_plus = kxc_plus["v3lapl3"][0][3]
        v3lapl3_bbb_minus = kxc_minus["v3lapl3"][0][3]
        v4sigmalapl3_abbb_fd = (v3lapl3_bbb_plus -
                                v3lapl3_bbb_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigmalapl3_abbb",
            2 * v4sigmalapl3_abbb * nabla_a + v4sigmalapl3_cbbb * nabla_b,
            v4sigmalapl3_abbb_fd)

        v4sigmalapl2tau_aaaa = lxc["v4sigmalapl2tau"][0][0]
        ...
        v4sigmalapl2tau_aaaa_fd = (v3lapl2tau_aaa_plus -
                                   v3lapl2tau_aaa_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigmalapl2tau_aaaa",
            2 * v4sigmalapl2tau_aaaa * nabla_a + v4sigmalapl2tau_caaa * nabla_b,
            v4sigmalapl2tau_aaaa_fd)

        v4sigmalapl2tau_aaab = lxc["v4sigmalapl2tau"][0][1]
        ...
        v4sigmalapl2tau_aaab_fd = (v3lapl2tau_aab_plus -
                                   v3lapl2tau_aab_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigmalapl2tau_aaab",
            2 * v4sigmalapl2tau_aaab * nabla_a + v4sigmalapl2tau_caab * nabla_b,
            v4sigmalapl2tau_aaab_fd)

        v4sigmalapl2tau_aaba = lxc["v4sigmalapl2tau"][0][2]
        ...
        v4sigmalapl2tau_aaba_fd = (v3lapl2tau_aba_plus -
                                   v3lapl2tau_aba_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigmalapl2tau_aaba",
            2 * v4sigmalapl2tau_aaba * nabla_a + v4sigmalapl2tau_caba * nabla_b,
            v4sigmalapl2tau_aaba_fd)

        v4sigmalapl2tau_aabb = lxc["v4sigmalapl2tau"][0][3]
        ...
        v4sigmalapl2tau_aabb_fd = (v3lapl2tau_abb_plus -
                                   v3lapl2tau_abb_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigmalapl2tau_aabb",
            2 * v4sigmalapl2tau_aabb * nabla_a + v4sigmalapl2tau_cabb * nabla_b,
            v4sigmalapl2tau_aabb_fd)

        v4sigmalapl2tau_abba = lxc["v4sigmalapl2tau"][0][4]
        ...
        v4sigmalapl2tau_abba_fd = (v3lapl2tau_bba_plus -
                                   v3lapl2tau_bba_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigmalapl2tau_abba",
            2 * v4sigmalapl2tau_abba * nabla_a + v4sigmalapl2tau_cbba * nabla_b,
            v4sigmalapl2tau_abba_fd)

        v4sigmalapl2tau_abbb = lxc["v4sigmalapl2tau"][0][5]
        ...
        v4sigmalapl2tau_abbb_fd = (v3lapl2tau_bbb_plus -
                                   v3lapl2tau_bbb_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigmalapl2tau_abbb",
            2 * v4sigmalapl2tau_abbb * nabla_a + v4sigmalapl2tau_cbbb * nabla_b,
            v4sigmalapl2tau_abbb_fd)

        v4sigmalapltau2_aaaa = lxc["v4sigmalapltau2"][0][0]
        ...
        v4sigmalapltau2_aaaa_fd = (v3lapltau2_aaa_plus -
                                   v3lapltau2_aaa_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigmalapltau2_aaaa",
            2 * v4sigmalapltau2_aaaa * nabla_a + v4sigmalapltau2_caaa * nabla_b,
            v4sigmalapltau2_aaaa_fd)

        v4sigmalapltau2_aaab = lxc["v4sigmalapltau2"][0][1]
        ...
        v4sigmalapltau2_aaab_fd = (v3lapltau2_aab_plus -
                                   v3lapltau2_aab_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigmalapltau2_aaab",
            2 * v4sigmalapltau2_aaab * nabla_a + v4sigmalapltau2_caab * nabla_b,
            v4sigmalapltau2_aaab_fd)

        v4sigmalapltau2_aabb = lxc["v4sigmalapltau2"][0][2]
        ...
        v4sigmalapltau2_aabb_fd = (v3lapltau2_abb_plus -
                                   v3lapltau2_abb_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigmalapltau2_aabb",
            2 * v4sigmalapltau2_aabb * nabla_a + v4sigmalapltau2_cabb * nabla_b,
            v4sigmalapltau2_aabb_fd)

        v4sigmalapltau2_abaa = lxc["v4sigmalapltau2"][0][3]
        ...
        v4sigmalapltau2_abaa_fd = (v3lapltau2_baa_plus -
                                   v3lapltau2_baa_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigmalapltau2_abaa",
            2 * v4sigmalapltau2_abaa * nabla_a + v4sigmalapltau2_cbaa * nabla_b,
            v4sigmalapltau2_abaa_fd)

        v4sigmalapltau2_abab = lxc["v4sigmalapltau2"][0][4]
        ...
        v4sigmalapltau2_abab_fd = (v3lapltau2_bab_plus -
                                   v3lapltau2_bab_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigmalapltau2_abab",
            2 * v4sigmalapltau2_abab * nabla_a + v4sigmalapltau2_cbab * nabla_b,
            v4sigmalapltau2_abab_fd)

        v4sigmalapltau2_abbb = lxc["v4sigmalapltau2"][0][5]
        ...
        v4sigmalapltau2_abbb_fd = (v3lapltau2_bbb_plus -
                                   v3lapltau2_bbb_minus) / (delta_h * 2)
        self.check_term(
            tol, "v4sigmalapltau2_abbb",
            2 * v4sigmalapltau2_abbb * nabla_a + v4sigmalapltau2_cbbb * nabla_b,
            v4sigmalapltau2_abbb_fd)
    ...
    def test_sigma_a_fd_m06(self):
        ...
        self.run_sigma_a_fd('m06', 1.0e-7)
