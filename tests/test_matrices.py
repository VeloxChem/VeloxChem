...
class TestMatrices:
    ...
    def test_get_matrix_number(self):
        ...
        mats = Matrices({0: self.get_matrix(), 2: self.get_matrix()})
        mats.zero()
    ...
    def test_get_matrix_quadruple_of_atomic_labels(self):
        ...
        Tester.compare_matrices(mat_a,
                                mats.get_matrix(0, 'x', 0, 'x', 0, 'x', 0, 'x'))
        Tester.compare_matrices(mat_a,
                                mats.get_matrix(0, 'x', 0, 'x', 1, 'x', 0, 'x'))
        Tester.compare_matrices(mat_a,
                                mats.get_matrix(0, 'x', 0, 'x', 0, 'x', 1, 'x'))
