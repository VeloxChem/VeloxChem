...
class TestFockDriver:
    ...
    def get_data_h2o_dimer_tzvp(self):
    ...
    def test_h2o_dimer_focks_svpd_with_screener(self):
        ...
        # compute Fock matrix
        fock_drv = FockDriver()
        fock_mats = fock_drv._compute_fock_omp(t4c_drv, den_mats, ["j", "k"],
                                               0.0, 0.0, 15)
    ...
    def test_h2o_dimer_fock_gen_2jk_svpd_with_screener(self):
        ...
        # compute Fock matrix
        fock_drv = FockDriver()
        fock_mat = fock_drv._compute_fock_omp(t4c_drv, den_mat, "2jk", 0.0, 0.0,
                                              15)
    ...
    def test_h2o_dimer_fock_gen_2jkx_svpd_with_screener(self):
        ...
        # compute Fock matrix
        fock_drv = FockDriver()
        fock_mat = fock_drv._compute_fock_omp(t4c_drv, den_mat, "2jkx", 0.28,
                                              0.0, 15)
    ...
    def test_h2o_dimer_fock_gen_j_svpd_with_screener(self):
        ...
        # compute Fock matrix
        fock_drv = FockDriver()
        fock_mat = fock_drv._compute_fock_omp(t4c_drv, den_mat, "j", 0.0, 0.0,
                                              15)
    ...
    def test_h2o_dimer_fock_gen_k_svpd_with_screener(self):
        ...
        # compute Fock matrix
        fock_drv = FockDriver()
        fock_mat = fock_drv._compute_fock_omp(t4c_drv, den_mat, "k", 0.0, 0.0,
                                              15)
    ...
    def test_h2o_dimer_fock_gen_kx_svpd_with_screener(self):
        ...
        # compute Fock matrix
        fock_drv = FockDriver()
        fock_mat = fock_drv._compute_fock_omp(t4c_drv, den_mat, "kx", 0.73, 0.0,
                                              15)
    ...
    def test_h2o_dimer_fock_2jk_tzvp_with_screener(self):

        mol_h2o_dimer, bas_tzvp = self.get_data_h2o_dimer_tzvp()
        ...
        # load reference Fock matrix
        here = Path(__file__).parent
        npyfile = str(here / 'data' / 'h2o.dimer.tzvp.j.npy')
        ref_mat = 2.0 * np.load(npyfile)

        # load reference Fock matrix
        here = Path(__file__).parent
        npyfile = str(here / 'data' / 'h2o.dimer.tzvp.k.npy')
        ref_mat -= np.load(npyfile)
    ...
    def test_h2o_dimer_fock_2jkx_tzvp_with_screener(self):
        ...
        # compute Fock matrix
        fock_drv = FockDriver()
        fock_mat = fock_drv._compute_fock_omp(t4c_drv, den_mat, "2jkx", 0.43,
                                              0.0, 15)
    ...
    def test_h2o_dimer_fock_j_tzvp_with_screener(self):
    ...
    def test_h2o_dimer_fock_kx_tzvp_with_screener(self):
        ...
        # compute Fock matrix
        fock_drv = FockDriver()
        fock_mat = fock_drv._compute_fock_omp(t4c_drv, den_mat, "kx", 0.21, 0.0,
                                              15)
    ...
    def test_h2o_dimer_fock_2jkx_svpd_with_screener(self):
        ...
        # compute Fock matrix
        fock_drv = FockDriver()
        fock_mat = fock_drv._compute_fock_omp(t4c_drv, den_mat, "2jkx", 0.38,
                                              0.0, 15)
    ...
    def test_h2o_dimer_fock_kx_svpd_with_screener(self):
        ...
        # compute Fock matrix
        fock_drv = FockDriver()
        fock_mat = fock_drv._compute_fock_omp(t4c_drv, den_mat, "kx", 0.23, 0.0,
                                              15)
    ...
    def test_h2o_dimer_fock_2jk_svpd(self):
        ...
        # compute Fock matrix
        fock_drv = FockDriver()
        fock_mat = fock_drv._compute_fock_omp(bas_svpd, mol_h2o_dimer, den_mat,
                                              "2jk", 0.0, 0.0)
    ...
    def test_h2o_fock_2jk_sto3g(self):
        ...
        # compute Fock matrix
        fock_drv = FockDriver()
        fock_mat = fock_drv._compute_fock_omp(bas_sto3g, mol_h2o, den_mat,
                                              "2jk", 0.0, 0.0)
    ...
    def test_h2o_fock_j_sto3g(self):
        ...
        # compute Fock matrix
        fock_drv = FockDriver()
        fock_mat = fock_drv._compute_fock_omp(bas_sto3g, mol_h2o, den_mat, "j",
                                              0.0, 0.0)
    ...
    def test_h2o_fock_k_sto3g(self):
        ...
        # compute Fock matrix
        fock_drv = FockDriver()
        fock_mat = fock_drv._compute_fock_omp(bas_sto3g, mol_h2o, den_mat, "k",
                                              0.0, 0.0)
    ...
    def test_h2o_fock_kx_sto3g(self):
        ...
        # compute Fock matrix
        fock_drv = FockDriver()
        fock_mat = fock_drv._compute_fock_omp(bas_sto3g, mol_h2o, den_mat, "kx",
                                              0.68, 0.0)
