...
class TestFockGeom1100Driver:
    ...
    def test_h2o_fock_2jk_hess_h2_h2_sto3g(self):
        ...
        # compute Fock matrix
        fock_drv = FockGeom1100Driver()
        fock_mats = fock_drv.compute(bas_sto3g, mol_h2o, den_mat, 1, 1, "2jk",
                                     0.0, 0.0)
    ...
    def test_h2o_fock_2jk_hess_h2_h3_sto3g(self):
        ...
        # compute Fock matrix
        fock_drv = FockGeom1100Driver()
        fock_mats = fock_drv.compute(bas_sto3g, mol_h2o, den_mat, 1, 2, "2jk",
                                     0.0, 0.0)
    ...
    def test_h2o_fock_2jk_hess_o1_h2_sto3g(self):
        ...
        # compute Fock matrix
        fock_drv = FockGeom1100Driver()
        fock_mats = fock_drv.compute(bas_sto3g, mol_h2o, den_mat, 0, 1, "2jk",
                                     0.0, 0.0)
    ...
    def test_h2o_fock_2jkx_hess_h2_h2_sto3g(self):
        ...
        # compute Fock matrix
        fock_drv = FockGeom1100Driver()
        fock_mats = fock_drv.compute(bas_sto3g, mol_h2o, den_mat, 1, 1, "2jkx",
                                     0.21, 0.0)
    ...
    def test_h2o_fock_2jkx_hess_h2_h3_sto3g(self):
        ...
        # compute Fock matrix
        fock_drv = FockGeom1100Driver()
        fock_mats = fock_drv.compute(bas_sto3g, mol_h2o, den_mat, 1, 2, "2jkx",
                                     0.64, 0.0)
    ...
    def test_h2o_fock_j_hess_h2_h2_sto3g(self):
        ...
        # compute Fock matrix
        fock_drv = FockGeom1100Driver()
        fock_mats = fock_drv.compute(bas_sto3g, mol_h2o, den_mat, 1, 1, "j",
                                     0.0, 0.0)
    ...
    def test_h2o_fock_j_hess_h2_h3_sto3g(self):
        ...
        # compute Fock matrix
        fock_drv = FockGeom1100Driver()
        fock_mats = fock_drv.compute(bas_sto3g, mol_h2o, den_mat, 1, 2, "j",
                                     0.0, 0.0)
    ...
    def test_h2o_fock_k_hess_h2_h2_sto3g(self):
        ...
        # compute Fock matrix
        fock_drv = FockGeom1100Driver()
        fock_mats = fock_drv.compute(bas_sto3g, mol_h2o, den_mat, 1, 1, "k",
                                     0.0, 0.0)
    ...
    def test_h2o_fock_k_hess_h2_h3_sto3g(self):
        ...
        # compute Fock matrix
        fock_drv = FockGeom1100Driver()
        fock_mats = fock_drv.compute(bas_sto3g, mol_h2o, den_mat, 1, 2, "k",
                                     0.0, 0.0)
    ...
    def test_h2o_fock_kx_hess_h2_h2_sto3g(self):
        ...
        # compute Fock matrix
        fock_drv = FockGeom1100Driver()
        fock_mats = fock_drv.compute(bas_sto3g, mol_h2o, den_mat, 1, 1, "kx",
                                     0.28, 0.0)
    ...
    def test_h2o_fock_kx_hess_h2_h3_sto3g(self):
        ...
        # compute Fock matrix
        fock_drv = FockGeom1100Driver()
        fock_mats = fock_drv.compute(bas_sto3g, mol_h2o, den_mat, 1, 2, "kx",
                                     0.71, 0.0)
