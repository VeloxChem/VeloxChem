...
class TestChemicalElement:
    ...
    def test_is_chemical_element(self):
        ...
        assert is_chemical_element(102) == True
        

        assert is_chemical_element(-1) == False
        assert is_chemical_element(103) == False
    ...
    def test_chemical_element_name(self):
        ...
        assert chemical_element_name(92) == "U"
    ...
    def test_chemical_element_label(self):
        ...
        assert chemical_element_label(93) == "Np"
    ...
    def test_chemical_element_identifier(self):
        ...
        assert chemical_element_identifier("U") == 92
        assert chemical_element_identifier("NO") == 102
    ...
    def test_chemical_element_mass(self):
        ...
        assert mt.isclose(chemical_element_mass(1),
                          ...
                          rel_tol=tol,
                          abs_tol=tol)
        assert mt.isclose(chemical_element_mass(92),
                          238.050783,
                          rel_tol=tol,
                          abs_tol=tol)
    ...
    def test_chemical_element_max_angular_momentum(self):
        ...
        assert chemical_element_max_angular_momentum(93) == 3

    def test_chemical_element_max_identifier(self):

        assert chemical_element_max_identifier() == 102
