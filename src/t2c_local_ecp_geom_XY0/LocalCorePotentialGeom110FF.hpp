#ifndef LocalCorePotentialGeom110FF_hpp
#define LocalCorePotentialGeom110FF_hpp
...
template <class T>
auto
comp_local_core_potential_geom_110_ff(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(2265, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_110_ff(pbuffer, 1365, 65, 164, 260, 440, 690, 930, 1155, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 1365, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom110FF_hpp */
