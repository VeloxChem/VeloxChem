#ifndef LocalCorePotentialGeom110FS_hpp
#define LocalCorePotentialGeom110FS_hpp
...
template <class T>
auto
comp_local_core_potential_geom_110_fs(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(251, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_110_fs(pbuffer, 161, 4, 22, 40, 95, 140, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 161, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom110FS_hpp */
