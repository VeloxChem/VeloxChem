#ifndef LocalCorePotentialGeom110DD_hpp
#define LocalCorePotentialGeom110DD_hpp
...
template <class T>
auto
comp_local_core_potential_geom_110_dd(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_110_dd(pbuffer, 480, 4, 23, 50, 104, 200, 290, 390, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom110DD_hpp */
