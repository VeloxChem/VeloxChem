#ifndef LocalCorePotentialGeom110GD_hpp
#define LocalCorePotentialGeom110GD_hpp
...
template <class T>
auto
comp_local_core_potential_geom_110_gd(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_ds(pbuffer, 80, 0, 20, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_dp(pbuffer, 86, 1, 20, 23, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_dd(pbuffer, 104, 4, 23, 32, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_df(pbuffer, 140, 10, 32, 50, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_fs(pbuffer, 200, 20, 80, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_fp(pbuffer, 210, 23, 80, 86, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_fd(pbuffer, 240, 32, 86, 104, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_ff(pbuffer, 300, 50, 104, 140, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_gs(pbuffer, 400, 80, 200, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_gp(pbuffer, 415, 86, 200, 210, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_gd(pbuffer, 460, 104, 210, 240, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_gf(pbuffer, 550, 140, 240, 300, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_hp(pbuffer, 700, 210, 400, 415, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_hd(pbuffer, 763, 240, 415, 460, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_hf(pbuffer, 889, 300, 460, 550, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_id(pbuffer, 1099, 460, 700, 763, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_110_gd(pbuffer, 1267, 104, 210, 300, 460, 700, 889, 1099, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom110GD_hpp */
