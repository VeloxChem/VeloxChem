#ifndef LocalCorePotentialGeom110PD_hpp
#define LocalCorePotentialGeom110PD_hpp
...
template <class T>
auto
comp_local_core_potential_geom_110_pd(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_110_pd(pbuffer, 254, 1, 10, 32, 80, 134, 194, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom110PD_hpp */
