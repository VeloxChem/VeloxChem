#ifndef LocalCorePotentialGeom110GF_hpp
#define LocalCorePotentialGeom110GF_hpp
...
template <class T>
auto
comp_local_core_potential_geom_110_gf(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(3491, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_gg(pbuffer, 985, 260, 450, 550, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_hd(pbuffer, 1210, 390, 700, 745, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_hf(pbuffer, 1336, 450, 745, 835, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_hg(pbuffer, 1546, 550, 835, 985, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_if(pbuffer, 1861, 835, 1210, 1336, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_110_gf(pbuffer, 2141, 200, 390, 550, 835, 1210, 1546, 1861, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 2141, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom110GF_hpp */
