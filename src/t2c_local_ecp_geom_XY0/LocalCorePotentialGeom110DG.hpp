#ifndef LocalCorePotentialGeom110DG_hpp
#define LocalCorePotentialGeom110DG_hpp
...
template <class T>
auto
comp_local_core_potential_geom_110_dg(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(2028, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_110_dg(pbuffer, 1218, 20, 83, 158, 317, 533, 783, 993, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom110DG_hpp */
