#ifndef LocalCorePotentialGeom110DF_hpp
#define LocalCorePotentialGeom110DF_hpp
...
template <class T>
auto
comp_local_core_potential_geom_110_df(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(1344, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_110_df(pbuffer, 804, 10, 47, 95, 194, 344, 504, 654, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 804, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom110DF_hpp */
