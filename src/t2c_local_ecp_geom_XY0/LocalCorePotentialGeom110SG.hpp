#ifndef LocalCorePotentialGeom110SG_hpp
#define LocalCorePotentialGeom110SG_hpp
...
template <class T>
auto
comp_local_core_potential_geom_110_sg(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_110_sg(pbuffer, 284, 20, 56, 131, 194, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom110SG_hpp */
