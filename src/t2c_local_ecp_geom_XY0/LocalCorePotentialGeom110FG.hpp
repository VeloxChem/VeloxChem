#ifndef LocalCorePotentialGeom110FG_hpp
#define LocalCorePotentialGeom110FG_hpp
...
template <class T>
auto
comp_local_core_potential_geom_110_fg(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(3429, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_110_fg(pbuffer, 2079, 116, 278, 428, 714, 1074, 1449, 1764, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom110FG_hpp */
