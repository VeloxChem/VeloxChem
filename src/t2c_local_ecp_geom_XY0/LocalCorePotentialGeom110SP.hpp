#ifndef LocalCorePotentialGeom110SP_hpp
#define LocalCorePotentialGeom110SP_hpp
...
template <class T>
auto
comp_local_core_potential_geom_110_sp(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_dp(pbuffer, 40, 1, 10, 13, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_110_sp(pbuffer, 58, 1, 10, 22, 40, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 58, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom110SP_hpp */
