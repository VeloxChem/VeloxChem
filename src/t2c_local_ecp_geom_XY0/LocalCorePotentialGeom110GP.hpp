#ifndef LocalCorePotentialGeom110GP_hpp
#define LocalCorePotentialGeom110GP_hpp
...
template <class T>
auto
comp_local_core_potential_geom_110_gp(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(1049, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_hd(pbuffer, 434, 140, 215, 260, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_ip(pbuffer, 560, 215, 350, 371, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_110_gp(pbuffer, 644, 46, 100, 140, 215, 350, 434, 560, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 644, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom110GP_hpp */
