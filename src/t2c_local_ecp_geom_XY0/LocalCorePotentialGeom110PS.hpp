#ifndef LocalCorePotentialGeom110PS_hpp
#define LocalCorePotentialGeom110PS_hpp
...
template <class T>
auto
comp_local_core_potential_geom_110_ps(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_110_ps(pbuffer, 50, 1, 4, 22, 40, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 50, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom110PS_hpp */
