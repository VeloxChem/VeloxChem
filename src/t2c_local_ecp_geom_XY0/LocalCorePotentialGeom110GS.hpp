#ifndef LocalCorePotentialGeom110GS_hpp
#define LocalCorePotentialGeom110GS_hpp
...
template <class T>
auto
comp_local_core_potential_geom_110_gs(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(387, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_is(pbuffer, 224, 80, 140, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_110_gs(pbuffer, 252, 16, 50, 80, 161, 224, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 252, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom110GS_hpp */
