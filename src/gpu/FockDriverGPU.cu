...
#pragma omp parallel
    ...
    if (pair_inds_count_for_K_pd > 0)
    {
        ...
        gpu::computeExchangeFockPDDD8<<<num_blocks, threads_per_block>>>(
                           d_mat_K,
                           d_pair_inds_i_for_K_pd,
                           d_pair_inds_k_for_K_pd,
                           static_cast<uint32_t>(pair_inds_count_for_K_pd),
        ...
        gpu::computeExchangeFockPDDD9<<<num_blocks, threads_per_block>>>(
                           d_mat_K,
                           d_pair_inds_i_for_K_pd,
                           d_pair_inds_k_for_K_pd,
                           static_cast<uint32_t>(pair_inds_count_for_K_pd),
    ...
    if (pair_inds_count_for_K_dd > 0)
    {
        ...
        gpu::computeExchangeFockDPDD7<<<num_blocks, threads_per_block>>>(
                           d_mat_K,
                           d_pair_inds_i_for_K_dd,
                           d_pair_inds_k_for_K_dd,
                           static_cast<uint32_t>(pair_inds_count_for_K_dd),
        ...
        gpu::computeExchangeFockDPDD8<<<num_blocks, threads_per_block>>>(
                           d_mat_K,
                           d_pair_inds_i_for_K_dd,
                           d_pair_inds_k_for_K_dd,
                           static_cast<uint32_t>(pair_inds_count_for_K_dd),
        ...
        gpu::computeExchangeFockDDDP7<<<num_blocks, threads_per_block>>>(
                           d_mat_K,
                           d_pair_inds_i_for_K_dd,
                           d_pair_inds_k_for_K_dd,
                           static_cast<uint32_t>(pair_inds_count_for_K_dd),
        ...
        gpu::computeExchangeFockDDDP8<<<num_blocks, threads_per_block>>>(
                           d_mat_K,
                           d_pair_inds_i_for_K_dd,
                           d_pair_inds_k_for_K_dd,
                           static_cast<uint32_t>(pair_inds_count_for_K_dd),
