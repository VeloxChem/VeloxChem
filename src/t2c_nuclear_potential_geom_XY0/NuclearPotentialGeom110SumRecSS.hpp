#ifndef NuclearPotentialGeom110SumRecSS_hpp
#define NuclearPotentialGeom110SumRecSS_hpp
...
/// @brief Computes (d^(1)/dA^(1)S|AG(1)|S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_geom_110_ss(T&                               distributor,
                                       ...
                                       const bool                       bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(27, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < coords.size(); l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_10_sx(pbuffer, 18, 9, 3, 1, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 18, dipoles, 3, l, ket_width, ket_npgtos);
                }
            }
...
#endif /* NuclearPotentialGeom110SumRecSS_hpp */
