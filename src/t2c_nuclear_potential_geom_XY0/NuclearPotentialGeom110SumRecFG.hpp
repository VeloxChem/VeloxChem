                                       ...
                                       const bool                       bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(7959, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < coords.size(); l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_10_fx(pbuffer, 6609, 3474, 5934, 3, 15, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 6609, dipoles, 3, l, ket_width, ket_npgtos);
                }
            }
