#ifndef NuclearPotentialGeom110SumRecSD_hpp
#define NuclearPotentialGeom110SumRecSD_hpp
...
/// @brief Computes (d^(1)/dA^(1)S|AG(1)|D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_geom_110_sd(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < coords.size(); l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_10_sx(pbuffer, 146, 92, 3, 6, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 146, dipoles, 3, l, ket_width, ket_npgtos);
                }
            }
...
#endif /* NuclearPotentialGeom110SumRecSD_hpp */
