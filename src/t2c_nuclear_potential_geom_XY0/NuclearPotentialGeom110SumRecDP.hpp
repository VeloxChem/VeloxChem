#ifndef NuclearPotentialGeom110SumRecDP_hpp
#define NuclearPotentialGeom110SumRecDP_hpp
...
/// @brief Computes (d^(1)/dA^(1)D|AG(1)|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_geom_110_dp(T&                               distributor,
                                       ...
                                       const bool                       bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(612, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < coords.size(); l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_10_dx(pbuffer, 450, 117, 360, 3, 3, a_exp);
...
#endif /* NuclearPotentialGeom110SumRecDP_hpp */
