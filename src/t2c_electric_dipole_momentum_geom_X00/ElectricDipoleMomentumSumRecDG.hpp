#ifndef ElectricDipoleMomentumSumRecDG_hpp
#define ElectricDipoleMomentumSumRecDG_hpp
...
template <class T>
auto
comp_sum_electric_dipole_momentum_geom_10_dg(T& distributor,
...
#endif /* ElectricDipoleMomentumSumRecDG_hpp */
