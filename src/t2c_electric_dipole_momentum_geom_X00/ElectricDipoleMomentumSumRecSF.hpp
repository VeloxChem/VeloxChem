#ifndef ElectricDipoleMomentumSumRecSF_hpp
#define ElectricDipoleMomentumSumRecSF_hpp
...
template <class T>
auto
comp_sum_electric_dipole_momentum_geom_10_sf(T& distributor,
...
#endif /* ElectricDipoleMomentumSumRecSF_hpp */
