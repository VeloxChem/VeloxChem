#ifndef ElectricDipoleMomentumGeom110RecDF_hpp
#define ElectricDipoleMomentumGeom110RecDF_hpp
...
/// @brief Computes (d^(1)/dA^(1)D|r|F)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electric_dipole_momentum_geom_10_df(T&                               distributor,
                                         ...
                                         const bool                       bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(1487, ket_npgtos);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cgeom::comp_prim_op_geom_10_dx(pbuffer, 947, 209, 647, 3, 10, a_exp);

                t2cfunc::reduce(cbuffer, pbuffer, 947, ket_width, ket_npgtos);
            }
...
#endif /* ElectricDipoleMomentumGeom110RecDF_hpp */
