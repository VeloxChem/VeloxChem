#ifndef ElectricDipoleMomentumSumRecDD_hpp
#define ElectricDipoleMomentumSumRecDD_hpp
...
template <class T>
auto
comp_sum_electric_dipole_momentum_geom_10_dd(T& distributor,
...
#endif /* ElectricDipoleMomentumSumRecDD_hpp */
