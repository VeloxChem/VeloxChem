#ifndef ElectricDipoleMomentumGeom110RecSD_hpp
#define ElectricDipoleMomentumGeom110RecSD_hpp
...
/// @brief Computes (d^(1)/dA^(1)S|r|D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electric_dipole_momentum_geom_10_sd(T& distributor,
                                         ...
                                         const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(148, ket_npgtos);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                diprec::comp_prim_electric_dipole_momentum_pd(pbuffer, 40, 7, 16, 22, factors, 11, a_exp);

                t2cgeom::comp_prim_op_geom_10_sx(pbuffer, 94, 40, 3, 6, a_exp);
...
#endif /* ElectricDipoleMomentumGeom110RecSD_hpp */
