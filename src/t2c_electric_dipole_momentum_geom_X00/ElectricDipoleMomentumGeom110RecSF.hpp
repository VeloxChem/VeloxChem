#ifndef ElectricDipoleMomentumGeom110RecSF_hpp
#define ElectricDipoleMomentumGeom110RecSF_hpp
...
/// @brief Computes (d^(1)/dA^(1)S|r|F)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electric_dipole_momentum_geom_10_sf(T&                               distributor,
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                diprec::comp_prim_electric_dipole_momentum_pf(pbuffer, 80, 22, 40, 50, factors, 11, a_exp);

                t2cgeom::comp_prim_op_geom_10_sx(pbuffer, 170, 80, 3, 10, a_exp);
...
#endif /* ElectricDipoleMomentumGeom110RecSF_hpp */
