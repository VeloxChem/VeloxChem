#ifndef ElectricDipoleMomentumSumRecSP_hpp
#define ElectricDipoleMomentumSumRecSP_hpp
...
template <class T>
auto
comp_sum_electric_dipole_momentum_geom_10_sp(T& distributor,
...
#endif /* ElectricDipoleMomentumSumRecSP_hpp */
