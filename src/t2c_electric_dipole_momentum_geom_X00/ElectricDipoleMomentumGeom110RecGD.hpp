#ifndef ElectricDipoleMomentumGeom110RecGD_hpp
#define ElectricDipoleMomentumGeom110RecGD_hpp
...
template <class T>
auto
comp_electric_dipole_momentum_geom_10_gd(T& distributor,
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cfunc::reduce(cbuffer, pbuffer, 1663, ket_width, ket_npgtos);
            }
...
#endif /* ElectricDipoleMomentumGeom110RecGD_hpp */
