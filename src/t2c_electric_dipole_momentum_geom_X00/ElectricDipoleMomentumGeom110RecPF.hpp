#ifndef ElectricDipoleMomentumGeom110RecPF_hpp
#define ElectricDipoleMomentumGeom110RecPF_hpp
...
template <class T>
auto
comp_electric_dipole_momentum_geom_10_pf(T&                               distributor,
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cfunc::reduce(cbuffer, pbuffer, 434, ket_width, ket_npgtos);
            }
...
#endif /* ElectricDipoleMomentumGeom110RecPF_hpp */
