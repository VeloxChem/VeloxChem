#ifndef ThreeCenterOverlapGradientSumRecFD_hpp
#define ThreeCenterOverlapGradientSumRecFD_hpp
...
/// @brief Computes (F|GX(r)|D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_gradient_fd(T& distributor,
                             ...
                             const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(371, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3ovlrec::comp_prim_overlap_fp(pbuffer, 101, 14, 41, 47, factors, 11, a_exp, exgtos[l]);

                    t3ovlrec::comp_prim_overlap_fd(pbuffer, 131, 23, 47, 65, factors, 11, a_exp, exgtos[l]);

                    g3ovlrec::comp_prim_overlap_gradient_fd(pbuffer, 191, 65, 101, 131, factors, 20, a_exp, exgtos[l]);

                    t2cfunc::reduce(cbuffer, pbuffer, 191, ket_width, ket_npgtos);
                }
            }
...
#endif /* ThreeCenterOverlapGradientSumRecFD_hpp */
