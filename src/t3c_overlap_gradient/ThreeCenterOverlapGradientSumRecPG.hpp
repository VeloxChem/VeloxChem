#ifndef ThreeCenterOverlapGradientSumRecPG_hpp
#define ThreeCenterOverlapGradientSumRecPG_hpp
...
/// @brief Computes (P|GX(r)|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_gradient_pg(T& distributor,
...
#endif /* ThreeCenterOverlapGradientSumRecPG_hpp */
