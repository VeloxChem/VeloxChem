#ifndef ThreeCenterOverlapGradientSumRecGP_hpp
#define ThreeCenterOverlapGradientSumRecGP_hpp
...
/// @brief Computes (G|GX(r)|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_gradient_gp(T& distributor,
...
#endif /* ThreeCenterOverlapGradientSumRecGP_hpp */
