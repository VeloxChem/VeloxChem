#ifndef ThreeCenterOverlapGradientSumRecDF_hpp
#define ThreeCenterOverlapGradientSumRecDF_hpp
...
/// @brief Computes (D|GX(r)|F)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_gradient_df(T& distributor,
                             ...
                             const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(354, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    g3ovlrec::comp_prim_overlap_gradient_df(pbuffer, 174, 48, 78, 114, factors, 20, a_exp, exgtos[l]);
...
#endif /* ThreeCenterOverlapGradientSumRecDF_hpp */
