#ifndef ThreeCenterOverlapGradientPrimRecPP
#define ThreeCenterOverlapGradientPrimRecPP

#include "SimdArray.hpp"

namespace g3ovlrec { // g3ovlrec namespace

/// @brief Computes primitive [P|GX(r)|P]  integrals for set of data buffers.
...
#endif /* ThreeCenterOverlapGradientPrimRecPP */
