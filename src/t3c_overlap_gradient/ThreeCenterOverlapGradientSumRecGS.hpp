#ifndef ThreeCenterOverlapGradientSumRecGS_hpp
#define ThreeCenterOverlapGradientSumRecGS_hpp
...
/// @brief Computes (G|GX(r)|S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_gradient_gs(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    g3ovlrec::comp_prim_overlap_gradient_gs(pbuffer, 36, 11, 21, factors, 17, a_exp, exgtos[l]);
...
#endif /* ThreeCenterOverlapGradientSumRecGS_hpp */
