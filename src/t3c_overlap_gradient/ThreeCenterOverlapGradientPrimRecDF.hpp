#ifndef ThreeCenterOverlapGradientPrimRecDF
#define ThreeCenterOverlapGradientPrimRecDF

#include "SimdArray.hpp"

namespace g3ovlrec { // g3ovlrec namespace

/// @brief Computes primitive [D|GX(r)|F]  integrals for set of data buffers.
...
#endif /* ThreeCenterOverlapGradientPrimRecDF */
