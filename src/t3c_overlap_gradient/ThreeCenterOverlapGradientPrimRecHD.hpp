#ifndef ThreeCenterOverlapGradientPrimRecHD
#define ThreeCenterOverlapGradientPrimRecHD

#include "SimdArray.hpp"

namespace g3ovlrec { // g3ovlrec namespace

/// @brief Computes primitive [H|GX(r)|D]  integrals for set of data buffers.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_g_hd The index of integral in primitive integrals buffer.
...
#endif /* ThreeCenterOverlapGradientPrimRecHD */
