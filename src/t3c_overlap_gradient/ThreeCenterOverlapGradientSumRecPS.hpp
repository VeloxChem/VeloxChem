#ifndef ThreeCenterOverlapGradientSumRecPS_hpp
#define ThreeCenterOverlapGradientSumRecPS_hpp
...
/// @brief Computes (P|GX(r)|S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_gradient_ps(T& distributor,
...
#endif /* ThreeCenterOverlapGradientSumRecPS_hpp */
