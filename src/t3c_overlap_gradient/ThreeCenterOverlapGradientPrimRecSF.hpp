#ifndef ThreeCenterOverlapGradientPrimRecSF
#define ThreeCenterOverlapGradientPrimRecSF

#include "SimdArray.hpp"

namespace g3ovlrec { // g3ovlrec namespace

/// @brief Computes primitive [S|GX(r)|F]  integrals for set of data buffers.
...
#endif /* ThreeCenterOverlapGradientPrimRecSF */
