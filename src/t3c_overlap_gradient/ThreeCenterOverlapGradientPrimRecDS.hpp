#ifndef ThreeCenterOverlapGradientPrimRecDS
#define ThreeCenterOverlapGradientPrimRecDS

#include "SimdArray.hpp"

namespace g3ovlrec { // g3ovlrec namespace

/// @brief Computes primitive [D|GX(r)|S]  integrals for set of data buffers.
...
#endif /* ThreeCenterOverlapGradientPrimRecDS */
