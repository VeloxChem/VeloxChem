#ifndef ThreeCenterOverlapGradientSumRecDG_hpp
#define ThreeCenterOverlapGradientSumRecDG_hpp
...
/// @brief Computes (D|GX(r)|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_gradient_dg(T& distributor,
                             ...
                             const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(549, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    g3ovlrec::comp_prim_overlap_gradient_dg(pbuffer, 279, 84, 129, 189, factors, 20, a_exp, exgtos[l]);

                    t2cfunc::reduce(cbuffer, pbuffer, 279, ket_width, ket_npgtos);
                }
            }
...
#endif /* ThreeCenterOverlapGradientSumRecDG_hpp */
