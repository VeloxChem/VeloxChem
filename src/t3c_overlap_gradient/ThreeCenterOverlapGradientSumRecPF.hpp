#ifndef ThreeCenterOverlapGradientSumRecPF_hpp
#define ThreeCenterOverlapGradientSumRecPF_hpp
...
/// @brief Computes (P|GX(r)|F)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_gradient_pf(T& distributor,
...
#endif /* ThreeCenterOverlapGradientSumRecPF_hpp */
