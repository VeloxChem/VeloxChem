#ifndef ThreeCenterOverlapGradientPrimRecDP
#define ThreeCenterOverlapGradientPrimRecDP

#include "SimdArray.hpp"

namespace g3ovlrec { // g3ovlrec namespace

/// @brief Computes primitive [D|GX(r)|P]  integrals for set of data buffers.
...
#endif /* ThreeCenterOverlapGradientPrimRecDP */
