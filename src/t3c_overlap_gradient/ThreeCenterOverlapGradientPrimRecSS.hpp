#ifndef ThreeCenterOverlapGradientPrimRecSS
#define ThreeCenterOverlapGradientPrimRecSS

#include "SimdArray.hpp"

namespace g3ovlrec { // g3ovlrec namespace

/// @brief Computes primitive [S|GX(r)|S]  integrals for set of data buffers.
...
#endif /* ThreeCenterOverlapGradientPrimRecSS */
