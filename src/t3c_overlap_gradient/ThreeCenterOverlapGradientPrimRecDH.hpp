#ifndef ThreeCenterOverlapGradientPrimRecDH
#define ThreeCenterOverlapGradientPrimRecDH

#include "SimdArray.hpp"

namespace g3ovlrec { // g3ovlrec namespace

/// @brief Computes primitive [D|GX(r)|H]  integrals for set of data buffers.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_g_dh The index of integral in primitive integrals buffer.
...
#endif /* ThreeCenterOverlapGradientPrimRecDH */
