#ifndef ThreeCenterOverlapGradientSumRecFP_hpp
#define ThreeCenterOverlapGradientSumRecFP_hpp
...
/// @brief Computes (F|GX(r)|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_gradient_fp(T& distributor,
                             ...
                             const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(171, ket_npgtos);
...
#endif /* ThreeCenterOverlapGradientSumRecFP_hpp */
