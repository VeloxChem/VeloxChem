#ifndef ThreeCenterOverlapGradientPrimRecHG
#define ThreeCenterOverlapGradientPrimRecHG

#include "SimdArray.hpp"

namespace g3ovlrec { // g3ovlrec namespace

/// @brief Computes primitive [H|GX(r)|G]  integrals for set of data buffers.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_g_hg The index of integral in primitive integrals buffer.
...
#endif /* ThreeCenterOverlapGradientPrimRecHG */
