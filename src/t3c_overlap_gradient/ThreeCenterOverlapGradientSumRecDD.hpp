#ifndef ThreeCenterOverlapGradientSumRecDD_hpp
#define ThreeCenterOverlapGradientSumRecDD_hpp
...
/// @brief Computes (D|GX(r)|D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_gradient_dd(T& distributor,
                             ...
                             const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(203, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3ovlrec::comp_prim_overlap_dp(pbuffer, 41, 2, 11, 14, factors, 11, a_exp, exgtos[l]);

                    t3ovlrec::comp_prim_overlap_dd(pbuffer, 59, 5, 14, 23, factors, 11, a_exp, exgtos[l]);

                    g3ovlrec::comp_prim_overlap_gradient_dd(pbuffer, 95, 23, 41, 59, factors, 20, a_exp, exgtos[l]);
...
#endif /* ThreeCenterOverlapGradientSumRecDD_hpp */
