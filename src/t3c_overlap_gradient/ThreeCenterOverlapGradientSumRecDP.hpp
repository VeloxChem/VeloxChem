#ifndef ThreeCenterOverlapGradientSumRecDP_hpp
#define ThreeCenterOverlapGradientSumRecDP_hpp
...
/// @brief Computes (D|GX(r)|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_gradient_dp(T& distributor,
...
#endif /* ThreeCenterOverlapGradientSumRecDP_hpp */
