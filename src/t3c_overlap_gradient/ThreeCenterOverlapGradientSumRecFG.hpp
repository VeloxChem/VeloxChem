#ifndef ThreeCenterOverlapGradientSumRecFG_hpp
#define ThreeCenterOverlapGradientSumRecFG_hpp
...
/// @brief Computes (F|GX(r)|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_gradient_fg(T& distributor,
                             ...
                             const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(1024, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    g3ovlrec::comp_prim_overlap_gradient_fg(pbuffer, 574, 234, 324, 424, factors, 20, a_exp, exgtos[l]);
...
#endif /* ThreeCenterOverlapGradientSumRecFG_hpp */
