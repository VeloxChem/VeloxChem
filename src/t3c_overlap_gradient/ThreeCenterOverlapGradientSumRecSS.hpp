#ifndef ThreeCenterOverlapGradientSumRecSS_hpp
#define ThreeCenterOverlapGradientSumRecSS_hpp
...
/// @brief Computes (S|GX(r)|S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_gradient_ss(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    g3ovlrec::comp_prim_overlap_gradient_ss(pbuffer, 2, 1, factors, 14, a_exp, exgtos[l]);
...
#endif /* ThreeCenterOverlapGradientSumRecSS_hpp */
