#ifndef ThreeCenterOverlapGradientPrimRecPD
#define ThreeCenterOverlapGradientPrimRecPD

#include "SimdArray.hpp"

namespace g3ovlrec { // g3ovlrec namespace

/// @brief Computes primitive [P|GX(r)|D]  integrals for set of data buffers.
...
#endif /* ThreeCenterOverlapGradientPrimRecPD */
