...
CLebedevLaikovQuadrature::CLebedevLaikovQuadrature(const int nAngularPoints)
...
auto
CLebedevLaikovQuadrature::generate() const -> CDenseMatrix
{
...
auto
CLebedevLaikovQuadrature::_generateQuadratureWith6Points() const -> CDenseMatrix
{
    CDenseMatrix qpoints(4, _nAngularPoints);
...
auto
CLebedevLaikovQuadrature::_generateQuadratureWith50Points() const -> CDenseMatrix
{
    CDenseMatrix qpoints(4, _nAngularPoints);
...
auto
CLebedevLaikovQuadrature::_generateQuadratureWith110Points() const -> CDenseMatrix
{
    CDenseMatrix qpoints(4, _nAngularPoints);
...
auto
CLebedevLaikovQuadrature::_generateQuadratureWith194Points() const -> CDenseMatrix
{
    CDenseMatrix qpoints(4, _nAngularPoints);
...
auto
CLebedevLaikovQuadrature::_generateQuadratureWith302Points() const -> CDenseMatrix
{
    CDenseMatrix qpoints(4, _nAngularPoints);
...
auto
CLebedevLaikovQuadrature::_generateQuadratureWith434Points() const -> CDenseMatrix
{
    CDenseMatrix qpoints(4, _nAngularPoints);
...
auto
CLebedevLaikovQuadrature::_generateQuadratureWith590Points() const -> CDenseMatrix
{
    CDenseMatrix qpoints(4, _nAngularPoints);
...
auto
CLebedevLaikovQuadrature::_generateQuadratureWith770Points() const -> CDenseMatrix
{
    CDenseMatrix qpoints(4, _nAngularPoints);
...
auto
CLebedevLaikovQuadrature::_generateQuadratureWith974Points() const -> CDenseMatrix
{
    CDenseMatrix qpoints(4, _nAngularPoints);
...
auto
CLebedevLaikovQuadrature::_generateQuadratureWith2030Points() const -> CDenseMatrix
{
    CDenseMatrix qpoints(4, _nAngularPoints);
...
auto
CLebedevLaikovQuadrature::_generateCaseOne(CDenseMatrix& gridPoints, const int offset, const double weight) const -> void
{
    auto x = gridPoints.row(0) + offset;

    auto y = gridPoints.row(1) + offset;

    auto z = gridPoints.row(2) + offset;

    auto w = gridPoints.row(3) + offset;
...
auto
CLebedevLaikovQuadrature::_generateCaseTwo(CDenseMatrix& gridPoints, const int offset, const double weight) const -> void
{
    auto x = gridPoints.row(0) + offset;
...
auto
CLebedevLaikovQuadrature::_generateCaseThree(CDenseMatrix& gridPoints, const int offset, const double weight) const -> void
{
    auto x = gridPoints.row(0) + offset;
...
auto
CLebedevLaikovQuadrature::_generateCaseFour(CDenseMatrix& gridPoints, const int offset, const double factor, const double weight) const -> void
{
    auto x = gridPoints.row(0) + offset;
...
auto
CLebedevLaikovQuadrature::_generateCaseFive(CDenseMatrix& gridPoints, const int offset, const double factor, const double weight) const -> void
{
    auto x = gridPoints.row(0) + offset;
