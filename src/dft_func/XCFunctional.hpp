...
class CXCFunctional
{
   private:
    ...
    std::unordered_map<std::string, std::array<int, 2>> _getIndicesAndCountsOfDerivatives() const;
   ...
   public:
     ...
     * @param[in,out] zk values of the exchange-correlation kernel. Size: np.
     * @param[in,out] vrho values of the first derivative of the
     * exchange-correlation kernel wrt density. Size: 2*np, order: [(0), (1)].
     */
    auto compute_exc_vxc_for_lda(const int np, const double* rho, double* zk, double* vrho) const -> void;
     ...
     * exchange-correlation kernel wrt density. Size: 2*np, order: [(0), (1)].
     */
    auto compute_vxc_for_lda(const int np, const double* rho, double* vrho) const -> void;
     ...
     * [(0, 0), (0, 1), (1, 1)].
     */
    auto compute_fxc_for_lda(const int np, const double* rho, double* v2rho2) const -> void;
     ...
     */
    auto compute_kxc_for_lda(const int np, const double* rho, double* v3rho3) const -> void;
     ...
     */
    auto compute_lxc_for_lda(const int np, const double* rho, double* v4rho4) const -> void;
     ...
     */
    auto compute_exc_vxc_for_gga(const int np, const double* rho, const double* sigma, double* zk, double* vrho, double* vsigma) const -> void;
     ...
     * exchange-correlation kernel wrt contracted gradients. Size: 3*np, order: [(0), (1), (2)].
     */
    auto compute_vxc_for_gga(const int np, const double* rho, const double* sigma, double* vrho, double* vsigma) const -> void;
     ...
     */
    auto compute_fxc_for_gga(const int np, const double* rho, const double* sigma, double* v2rho2, double* v2rhosigma, double* v2sigma2) const
        -> void;
     ...
     */
    auto compute_kxc_for_gga(const int np,
                             const double* rho,
                             const double* sigma,
                             double*       v3rho3,
                             double*       v3rho2sigma,
     ...
     */
    auto compute_lxc_for_gga(const int np,
                             const double* rho,
                             const double* sigma,
                             double*       v4rho4,
                             double*       v4rho3sigma,
     ...
     * @param[in,out] zk values of the exchange-correlation kernel.
     ...
     */
    auto compute_exc_vxc_for_mgga(const int np,
                                  const double* rho,
                                  const double* sigma,
                                  const double* lapl,
                                  const double* tau,
     ...
     * @param[in,out] vtau alues of the first derivative
     */
    auto compute_vxc_for_mgga(const int np,
                              const double* rho,
                              const double* sigma,
                              const double* lapl,
                              const double* tau,
     ...
     */
    auto compute_fxc_for_mgga(const int np,
                              const double* rho,
                              const double* sigma,
                              const double* lapl,
                              const double* tau,
     ...
     */
    auto compute_kxc_for_mgga(const int np,
                              const double* rho,
                              const double* sigma,
                              const double* lapl,
                              const double* tau,
     ...
     */
    auto compute_lxc_for_mgga(const int np,
                              const double* rho,
                              const double* sigma,
                              const double* lapl,
                              const double* tau,
