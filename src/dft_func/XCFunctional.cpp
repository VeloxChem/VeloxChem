...
{
    std::unordered_map<std::string, std::array<int, 2>> indices_and_counts;
    ...
    if (_familyOfFunctional == xcfun::lda)
    {
        ...
        indices_and_counts["zk"] = std::array<int, 2>({n_xc_outputs, dim->zk});
        n_xc_outputs += dim->zk;

        indices_and_counts["vrho"] = std::array<int, 2>({n_xc_outputs, dim->vrho});
        n_xc_outputs += dim->vrho;

        indices_and_counts["v2rho2"] = std::array<int, 2>({n_xc_outputs, dim->v2rho2});
        n_xc_outputs += dim->v2rho2;

        indices_and_counts["v3rho3"] = std::array<int, 2>({n_xc_outputs, dim->v3rho3});
        n_xc_outputs += dim->v3rho3;

        indices_and_counts["v4rho4"] = std::array<int, 2>({n_xc_outputs, dim->v4rho4});
    ...
    else if (_familyOfFunctional == xcfun::gga)
    {
        ...
        indices_and_counts["vrho"] = std::array<int, 2>({n_xc_outputs, dim->vrho});
        n_xc_outputs += dim->vrho;
        indices_and_counts["vsigma"] = std::array<int, 2>({n_xc_outputs, dim->vsigma});
        n_xc_outputs += dim->vsigma;

        indices_and_counts["v2rho2"] = std::array<int, 2>({n_xc_outputs, dim->v2rho2});
        n_xc_outputs += dim->v2rho2;
        indices_and_counts["v2rhosigma"] = std::array<int, 2>({n_xc_outputs, dim->v2rhosigma});
        n_xc_outputs += dim->v2rhosigma;
        indices_and_counts["v2sigma2"] = std::array<int, 2>({n_xc_outputs, dim->v2sigma2});
        n_xc_outputs += dim->v2sigma2;

        indices_and_counts["v3rho3"] = std::array<int, 2>({n_xc_outputs, dim->v3rho3});
        n_xc_outputs += dim->v3rho3;
        indices_and_counts["v3rho2sigma"] = std::array<int, 2>({n_xc_outputs, dim->v3rho2sigma});
        n_xc_outputs += dim->v3rho2sigma;
        indices_and_counts["v3rhosigma2"] = std::array<int, 2>({n_xc_outputs, dim->v3rhosigma2});
        n_xc_outputs += dim->v3rhosigma2;
        indices_and_counts["v3sigma3"] = std::array<int, 2>({n_xc_outputs, dim->v3sigma3});
        n_xc_outputs += dim->v3sigma3;

        indices_and_counts["v4rho4"] = std::array<int, 2>({n_xc_outputs, dim->v4rho4});
        n_xc_outputs += dim->v4rho4;
        indices_and_counts["v4rho3sigma"] = std::array<int, 2>({n_xc_outputs, dim->v4rho3sigma});
        n_xc_outputs += dim->v4rho3sigma;
        indices_and_counts["v4rho2sigma2"] = std::array<int, 2>({n_xc_outputs, dim->v4rho2sigma2});
        n_xc_outputs += dim->v4rho2sigma2;
        indices_and_counts["v4rhosigma3"] = std::array<int, 2>({n_xc_outputs, dim->v4rhosigma3});
        n_xc_outputs += dim->v4rhosigma3;
        indices_and_counts["v4sigma4"] = std::array<int, 2>({n_xc_outputs, dim->v4sigma4});
    ...
    else if (_familyOfFunctional == xcfun::mgga)
    {
        ...
        indices_and_counts["vsigma"] = std::array<int, 2>({n_xc_outputs, dim->vsigma});
        n_xc_outputs += dim->vsigma;
        indices_and_counts["vlapl"] = std::array<int, 2>({n_xc_outputs, dim->vlapl});
        n_xc_outputs += dim->vlapl;
        indices_and_counts["vtau"] = std::array<int, 2>({n_xc_outputs, dim->vtau});
        ...
        indices_and_counts["v2rhosigma"] = std::array<int, 2>({n_xc_outputs, dim->v2rhosigma});
        n_xc_outputs += dim->v2rhosigma;
        indices_and_counts["v2rholapl"] = std::array<int, 2>({n_xc_outputs, dim->v2rholapl});
        n_xc_outputs += dim->v2rholapl;
        indices_and_counts["v2rhotau"] = std::array<int, 2>({n_xc_outputs, dim->v2rhotau});
        n_xc_outputs += dim->v2rhotau;
        indices_and_counts["v2sigma2"] = std::array<int, 2>({n_xc_outputs, dim->v2sigma2});
        n_xc_outputs += dim->v2sigma2;
        indices_and_counts["v2sigmalapl"] = std::array<int, 2>({n_xc_outputs, dim->v2sigmalapl});
        n_xc_outputs += dim->v2sigmalapl;
        indices_and_counts["v2sigmatau"] = std::array<int, 2>({n_xc_outputs, dim->v2sigmatau});
        n_xc_outputs += dim->v2sigmatau;
        indices_and_counts["v2lapl2"] = std::array<int, 2>({n_xc_outputs, dim->v2lapl2});
        n_xc_outputs += dim->v2lapl2;
        indices_and_counts["v2lapltau"] = std::array<int, 2>({n_xc_outputs, dim->v2lapltau});
        n_xc_outputs += dim->v2lapltau;
        indices_and_counts["v2tau2"] = std::array<int, 2>({n_xc_outputs, dim->v2tau2});
        ...
        indices_and_counts["v3rho2sigma"] = std::array<int, 2>({n_xc_outputs, dim->v3rho2sigma});
        n_xc_outputs += dim->v3rho2sigma;
        indices_and_counts["v3rho2lapl"] = std::array<int, 2>({n_xc_outputs, dim->v3rho2lapl});
        n_xc_outputs += dim->v3rho2lapl;
        indices_and_counts["v3rho2tau"] = std::array<int, 2>({n_xc_outputs, dim->v3rho2tau});
        n_xc_outputs += dim->v3rho2tau;
        indices_and_counts["v3rhosigma2"] = std::array<int, 2>({n_xc_outputs, dim->v3rhosigma2});
        n_xc_outputs += dim->v3rhosigma2;
        indices_and_counts["v3rhosigmalapl"] = std::array<int, 2>({n_xc_outputs, dim->v3rhosigmalapl});
        n_xc_outputs += dim->v3rhosigmalapl;
        indices_and_counts["v3rhosigmatau"] = std::array<int, 2>({n_xc_outputs, dim->v3rhosigmatau});
        n_xc_outputs += dim->v3rhosigmatau;
        indices_and_counts["v3rholapl2"] = std::array<int, 2>({n_xc_outputs, dim->v3rholapl2});
        n_xc_outputs += dim->v3rholapl2;
        indices_and_counts["v3rholapltau"] = std::array<int, 2>({n_xc_outputs, dim->v3rholapltau});
        n_xc_outputs += dim->v3rholapltau;
        indices_and_counts["v3rhotau2"] = std::array<int, 2>({n_xc_outputs, dim->v3rhotau2});
        n_xc_outputs += dim->v3rhotau2;
        indices_and_counts["v3sigma3"] = std::array<int, 2>({n_xc_outputs, dim->v3sigma3});
        n_xc_outputs += dim->v3sigma3;
        indices_and_counts["v3sigma2lapl"] = std::array<int, 2>({n_xc_outputs, dim->v3sigma2lapl});
        n_xc_outputs += dim->v3sigma2lapl;
        indices_and_counts["v3sigma2tau"] = std::array<int, 2>({n_xc_outputs, dim->v3sigma2tau});
        n_xc_outputs += dim->v3sigma2tau;
        indices_and_counts["v3sigmalapl2"] = std::array<int, 2>({n_xc_outputs, dim->v3sigmalapl2});
        n_xc_outputs += dim->v3sigmalapl2;
        indices_and_counts["v3sigmalapltau"] = std::array<int, 2>({n_xc_outputs, dim->v3sigmalapltau});
        n_xc_outputs += dim->v3sigmalapltau;
        indices_and_counts["v3sigmatau2"] = std::array<int, 2>({n_xc_outputs, dim->v3sigmatau2});
        n_xc_outputs += dim->v3sigmatau2;
        indices_and_counts["v3lapl3"] = std::array<int, 2>({n_xc_outputs, dim->v3lapl3});
        n_xc_outputs += dim->v3lapl3;
        indices_and_counts["v3lapl2tau"] = std::array<int, 2>({n_xc_outputs, dim->v3lapl2tau});
        n_xc_outputs += dim->v3lapl2tau;
        indices_and_counts["v3lapltau2"] = std::array<int, 2>({n_xc_outputs, dim->v3lapltau2});
        n_xc_outputs += dim->v3lapltau2;
        indices_and_counts["v3tau3"] = std::array<int, 2>({n_xc_outputs, dim->v3tau3});
        ...
        indices_and_counts["v4rho3sigma"] = std::array<int, 2>({n_xc_outputs, dim->v4rho3sigma});
        n_xc_outputs += dim->v4rho3sigma;
        indices_and_counts["v4rho3lapl"] = std::array<int, 2>({n_xc_outputs, dim->v4rho3lapl});
        n_xc_outputs += dim->v4rho3lapl;
        indices_and_counts["v4rho3tau"] = std::array<int, 2>({n_xc_outputs, dim->v4rho3tau});
        n_xc_outputs += dim->v4rho3tau;
        indices_and_counts["v4rho2sigma2"] = std::array<int, 2>({n_xc_outputs, dim->v4rho2sigma2});
        n_xc_outputs += dim->v4rho2sigma2;
        indices_and_counts["v4rho2sigmalapl"] = std::array<int, 2>({n_xc_outputs, dim->v4rho2sigmalapl});
        n_xc_outputs += dim->v4rho2sigmalapl;
        indices_and_counts["v4rho2sigmatau"] = std::array<int, 2>({n_xc_outputs, dim->v4rho2sigmatau});
        n_xc_outputs += dim->v4rho2sigmatau;
        indices_and_counts["v4rho2lapl2"] = std::array<int, 2>({n_xc_outputs, dim->v4rho2lapl2});
        n_xc_outputs += dim->v4rho2lapl2;
        indices_and_counts["v4rho2lapltau"] = std::array<int, 2>({n_xc_outputs, dim->v4rho2lapltau});
        n_xc_outputs += dim->v4rho2lapltau;
        indices_and_counts["v4rho2tau2"] = std::array<int, 2>({n_xc_outputs, dim->v4rho2tau2});
        n_xc_outputs += dim->v4rho2tau2;
        indices_and_counts["v4rhosigma3"] = std::array<int, 2>({n_xc_outputs, dim->v4rhosigma3});
        n_xc_outputs += dim->v4rhosigma3;
        indices_and_counts["v4rhosigma2lapl"] = std::array<int, 2>({n_xc_outputs, dim->v4rhosigma2lapl});
        n_xc_outputs += dim->v4rhosigma2lapl;
        indices_and_counts["v4rhosigma2tau"] = std::array<int, 2>({n_xc_outputs, dim->v4rhosigma2tau});
        n_xc_outputs += dim->v4rhosigma2tau;
        indices_and_counts["v4rhosigmalapl2"] = std::array<int, 2>({n_xc_outputs, dim->v4rhosigmalapl2});
        n_xc_outputs += dim->v4rhosigmalapl2;
        indices_and_counts["v4rhosigmalapltau"] = std::array<int, 2>({n_xc_outputs, dim->v4rhosigmalapltau});
        n_xc_outputs += dim->v4rhosigmalapltau;
        indices_and_counts["v4rhosigmatau2"] = std::array<int, 2>({n_xc_outputs, dim->v4rhosigmatau2});
        n_xc_outputs += dim->v4rhosigmatau2;
        indices_and_counts["v4rholapl3"] = std::array<int, 2>({n_xc_outputs, dim->v4rholapl3});
        n_xc_outputs += dim->v4rholapl3;
        indices_and_counts["v4rholapl2tau"] = std::array<int, 2>({n_xc_outputs, dim->v4rholapl2tau});
        n_xc_outputs += dim->v4rholapl2tau;
        indices_and_counts["v4rholapltau2"] = std::array<int, 2>({n_xc_outputs, dim->v4rholapltau2});
        n_xc_outputs += dim->v4rholapltau2;
        indices_and_counts["v4rhotau3"] = std::array<int, 2>({n_xc_outputs, dim->v4rhotau3});
        n_xc_outputs += dim->v4rhotau3;
        indices_and_counts["v4sigma4"] = std::array<int, 2>({n_xc_outputs, dim->v4sigma4});
        n_xc_outputs += dim->v4sigma4;
        indices_and_counts["v4sigma3lapl"] = std::array<int, 2>({n_xc_outputs, dim->v4sigma3lapl});
        n_xc_outputs += dim->v4sigma3lapl;
        indices_and_counts["v4sigma3tau"] = std::array<int, 2>({n_xc_outputs, dim->v4sigma3tau});
        n_xc_outputs += dim->v4sigma3tau;
        indices_and_counts["v4sigma2lapl2"] = std::array<int, 2>({n_xc_outputs, dim->v4sigma2lapl2});
        n_xc_outputs += dim->v4sigma2lapl2;
        indices_and_counts["v4sigma2lapltau"] = std::array<int, 2>({n_xc_outputs, dim->v4sigma2lapltau});
        n_xc_outputs += dim->v4sigma2lapltau;
        indices_and_counts["v4sigma2tau2"] = std::array<int, 2>({n_xc_outputs, dim->v4sigma2tau2});
        n_xc_outputs += dim->v4sigma2tau2;
        indices_and_counts["v4sigmalapl3"] = std::array<int, 2>({n_xc_outputs, dim->v4sigmalapl3});
        n_xc_outputs += dim->v4sigmalapl3;
        indices_and_counts["v4sigmalapl2tau"] = std::array<int, 2>({n_xc_outputs, dim->v4sigmalapl2tau});
        n_xc_outputs += dim->v4sigmalapl2tau;
        indices_and_counts["v4sigmalapltau2"] = std::array<int, 2>({n_xc_outputs, dim->v4sigmalapltau2});
        n_xc_outputs += dim->v4sigmalapltau2;
        indices_and_counts["v4sigmatau3"] = std::array<int, 2>({n_xc_outputs, dim->v4sigmatau3});
        n_xc_outputs += dim->v4sigmatau3;
        indices_and_counts["v4lapl4"] = std::array<int, 2>({n_xc_outputs, dim->v4lapl4});
        n_xc_outputs += dim->v4lapl4;
        indices_and_counts["v4lapl3tau"] = std::array<int, 2>({n_xc_outputs, dim->v4lapl3tau});
        n_xc_outputs += dim->v4lapl3tau;
        indices_and_counts["v4lapl2tau2"] = std::array<int, 2>({n_xc_outputs, dim->v4lapl2tau2});
        n_xc_outputs += dim->v4lapl2tau2;
        indices_and_counts["v4lapltau3"] = std::array<int, 2>({n_xc_outputs, dim->v4lapltau3});
        n_xc_outputs += dim->v4lapltau3;
        indices_and_counts["v4tau4"] = std::array<int, 2>({n_xc_outputs, dim->v4tau4});
...
{
    return (format::upper_case(_nameOfFunctional) == "UNDEFINED");
}
...
auto
CXCFunctional::compute_exc_vxc_for_lda(const int np, const double* rho, double* zk, double* vrho) const -> void
{
...
auto
CXCFunctional::compute_vxc_for_lda(const int np, const double* rho, double* vrho) const -> void
{
    errors::assertMsgCritical(_maxDerivOrder >= 1,
...
auto
CXCFunctional::compute_fxc_for_lda(const int np, const double* rho, double* v2rho2) const -> void
{
...
auto
CXCFunctional::compute_kxc_for_lda(const int np, const double* rho, double* v3rho3) const -> void
{
...
auto
CXCFunctional::compute_lxc_for_lda(const int np, const double* rho, double* v4rho4) const -> void
{
...
auto
CXCFunctional::compute_exc_vxc_for_gga(const int np, const double* rho, const double* sigma, double* zk, double* vrho, double* vsigma) const
    -> void
{
    errors::assertMsgCritical(_maxDerivOrder >= 1,
                              std::string(__func__) + ": exchange-correlation functional does not provide evaluators for Exc and Vxc on grid");
...
auto
CXCFunctional::compute_vxc_for_gga(const int np, const double* rho, const double* sigma, double* vrho, double* vsigma) const -> void
{
    errors::assertMsgCritical(_maxDerivOrder >= 1,
                              std::string(__func__) + ": exchange-correlation functional does not provide evaluators for Vxc on grid");
...
auto
CXCFunctional::compute_fxc_for_gga(const int np, const double* rho, const double* sigma, double* v2rho2, double* v2rhosigma, double* v2sigma2)
    const -> void
{
    errors::assertMsgCritical(_maxDerivOrder >= 2,
                              std::string(__func__) + ": exchange-correlation functional does not provide evaluators for Fxc on grid");
...
auto
CXCFunctional::compute_kxc_for_gga(const int np,
                                   const double* rho,
                                   const double* sigma,
                                   double*       v3rho3,
                                   double*       v3rho2sigma,
...
auto
CXCFunctional::compute_lxc_for_gga(const int np,
                                   const double* rho,
                                   const double* sigma,
                                   double*       v4rho4,
                                   double*       v4rho3sigma,
...
auto
CXCFunctional::compute_exc_vxc_for_mgga(const int np,
                                        const double* rho,
                                        const double* sigma,
                                        const double* lapl,
                                        const double* tau,
...
auto
CXCFunctional::compute_vxc_for_mgga(const int np,
                                    const double* rho,
                                    const double* sigma,
                                    const double* lapl,
                                    const double* tau,
...
auto
CXCFunctional::compute_fxc_for_mgga(const int np,
                                    const double* rho,
                                    const double* sigma,
                                    const double* lapl,
                                    const double* tau,
...
auto
CXCFunctional::compute_kxc_for_mgga(const int np,
                                    const double* rho,
                                    const double* sigma,
                                    const double* lapl,
                                    const double* tau,
...
auto
CXCFunctional::compute_lxc_for_mgga(const int np,
                                    const double* rho,
                                    const double* sigma,
                                    const double* lapl,
                                    const double* tau,
