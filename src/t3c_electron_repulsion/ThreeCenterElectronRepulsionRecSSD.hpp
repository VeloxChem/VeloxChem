#ifndef ThreeCenterElectronRepulsionRecSSD_hpp
#define ThreeCenterElectronRepulsionRecSSD_hpp
...
/// @brief Computes (S|1/|r-r'||SD)  integrals for basis functions block and basis function pairs block.
...
template <class T>
inline auto
comp_electron_repulsion_ssd(T& distributor,
...
#endif /* ThreeCenterElectronRepulsionRecSSD_hpp */
