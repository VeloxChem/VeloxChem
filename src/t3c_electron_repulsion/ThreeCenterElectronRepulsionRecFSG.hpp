#ifndef ThreeCenterElectronRepulsionRecFSG_hpp
#define ThreeCenterElectronRepulsionRecFSG_hpp
...
/// @brief Computes (F|1/|r-r'||SG)  integrals for basis functions block and basis function pairs block.
...
template <class T>
inline auto
comp_electron_repulsion_fsg(T& distributor,
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_range.first; j < bra_range.second; j++)
        {
            ...
            for (int k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cfunc::reduce(cbuffer, 0, pbuffer, 473, 150, ket_width, ket_npgtos);
...
#endif /* ThreeCenterElectronRepulsionRecFSG_hpp */
