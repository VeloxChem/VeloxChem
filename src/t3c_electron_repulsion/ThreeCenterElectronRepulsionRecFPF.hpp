#ifndef ThreeCenterElectronRepulsionRecFPF_hpp
#define ThreeCenterElectronRepulsionRecFPF_hpp
...
/// @brief Computes (F|1/|r-r'||PF)  integrals for basis functions block and basis function pairs block.
...
template <class T>
inline auto
comp_electron_repulsion_fpf(T& distributor,
                            ...
                            const std::pair<size_t, size_t>& bra_range) -> void
{
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_range.first; j < bra_range.second; j++)
        {
            ...
            t3cfunc::ket_transform<1, 3>(sbuffer, 0, skbuffer, 175, 3);
...
#endif /* ThreeCenterElectronRepulsionRecFPF_hpp */
