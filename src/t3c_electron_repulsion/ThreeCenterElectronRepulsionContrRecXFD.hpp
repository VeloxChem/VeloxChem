#ifndef ThreeCenterElectronRepulsionContrRecXFD_hpp
#define ThreeCenterElectronRepulsionContrRecXFD_hpp
...
/// Computes (X|1/|r-r'||FD)  integrals for set of data buffers.
...
#endif /* ThreeCenterElectronRepulsionContrRecXFD_hpp */
