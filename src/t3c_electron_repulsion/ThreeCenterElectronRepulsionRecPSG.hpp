#ifndef ThreeCenterElectronRepulsionRecPSG_hpp
#define ThreeCenterElectronRepulsionRecPSG_hpp
...
/// @brief Computes (P|1/|r-r'||SG)  integrals for basis functions block and basis function pairs block.
...
template <class T>
inline auto
comp_electron_repulsion_psg(T& distributor,
...
#endif /* ThreeCenterElectronRepulsionRecPSG_hpp */
