#ifndef ThreeCenterElectronRepulsionRecSSF_hpp
#define ThreeCenterElectronRepulsionRecSSF_hpp
...
/// @brief Computes (S|1/|r-r'||SF)  integrals for basis functions block and basis function pairs block.
...
template <class T>
inline auto
comp_electron_repulsion_ssf(T& distributor,
                            ...
                            const std::pair<size_t, size_t>& bra_range) -> void
{
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_range.first; j < bra_range.second; j++)
        {
            ...
            t3cfunc::ket_transform<0, 3>(sbuffer, 0, cbuffer, 0, 0);
...
#endif /* ThreeCenterElectronRepulsionRecSSF_hpp */
