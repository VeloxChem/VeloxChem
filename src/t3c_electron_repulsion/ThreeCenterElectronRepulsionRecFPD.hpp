#ifndef ThreeCenterElectronRepulsionRecFPD_hpp
#define ThreeCenterElectronRepulsionRecFPD_hpp
...
/// @brief Computes (F|1/|r-r'||PD)  integrals for basis functions block and basis function pairs block.
...
template <class T>
inline auto
comp_electron_repulsion_fpd(T& distributor,
                            ...
                            const std::pair<size_t, size_t>& bra_range) -> void
{
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_range.first; j < bra_range.second; j++)
        {
            ...
            t3cfunc::ket_transform<1, 2>(sbuffer, 0, skbuffer, 112, 3);
...
#endif /* ThreeCenterElectronRepulsionRecFPD_hpp */
