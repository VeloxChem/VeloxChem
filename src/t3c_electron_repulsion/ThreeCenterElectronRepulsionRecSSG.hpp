#ifndef ThreeCenterElectronRepulsionRecSSG_hpp
#define ThreeCenterElectronRepulsionRecSSG_hpp
...
/// @brief Computes (S|1/|r-r'||SG)  integrals for basis functions block and basis function pairs block.
...
template <class T>
inline auto
comp_electron_repulsion_ssg(T& distributor,
...
#endif /* ThreeCenterElectronRepulsionRecSSG_hpp */
