#ifndef ThreeCenterElectronRepulsionRecDPG_hpp
#define ThreeCenterElectronRepulsionRecDPG_hpp
...
/// @brief Computes (D|1/|r-r'||PG)  integrals for basis functions block and basis function pairs block.
...
template <class T>
inline auto
comp_electron_repulsion_dpg(T& distributor,
                            ...
                            const std::pair<size_t, size_t>& bra_range) -> void
{
    ...
    CSimdArray<double> skbuffer(405, 1);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_range.first; j < bra_range.second; j++)
        {
            ...
            for (int k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cfunc::reduce(cbuffer, 0, pbuffer, 376, 90, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 90, pbuffer, 466, 126, ket_width, ket_npgtos);
            ...
            t3cfunc::ket_transform<1, 4>(sbuffer, 0, skbuffer, 180, 2);
...
#endif /* ThreeCenterElectronRepulsionRecDPG_hpp */
