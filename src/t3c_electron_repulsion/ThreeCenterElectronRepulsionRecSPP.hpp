#ifndef ThreeCenterElectronRepulsionRecSPP_hpp
#define ThreeCenterElectronRepulsionRecSPP_hpp
...
/// @brief Computes (S|1/|r-r'||PP)  integrals for basis functions block and basis function pairs block.
...
template <class T>
inline auto
comp_electron_repulsion_spp(T& distributor,
                            ...
                            const std::pair<size_t, size_t>& bra_range) -> void
{
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_range.first; j < bra_range.second; j++)
        {
            ...
            t3cfunc::ket_transform<1, 1>(sbuffer, 0, skbuffer, 9, 0);
...
#endif /* ThreeCenterElectronRepulsionRecSPP_hpp */
