#ifndef ThreeCenterElectronRepulsionPrimRecHSP_hpp
#define ThreeCenterElectronRepulsionPrimRecHSP_hpp
...
/// Computes [H|1/|r-r'||SP]  integrals for set of data buffers.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_eri_0_hsp The index of integral in primitive integrals buffer.
/// @param idx_eri_0_fsp The primitive integrals buffer.
...
#endif /* ThreeCenterElectronRepulsionPrimRecHSP_hpp */
