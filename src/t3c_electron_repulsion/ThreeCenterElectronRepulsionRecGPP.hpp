#ifndef ThreeCenterElectronRepulsionRecGPP_hpp
#define ThreeCenterElectronRepulsionRecGPP_hpp
...
/// @brief Computes (G|1/|r-r'||PP)  integrals for basis functions block and basis function pairs block.
...
template <class T>
inline auto
comp_electron_repulsion_gpp(T& distributor,
                            ...
                            const std::pair<size_t, size_t>& bra_range) -> void
{
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_range.first; j < bra_range.second; j++)
        {
            ...
            t3cfunc::ket_transform<1, 1>(sbuffer, 0, skbuffer, 81, 4);
...
#endif /* ThreeCenterElectronRepulsionRecGPP_hpp */
