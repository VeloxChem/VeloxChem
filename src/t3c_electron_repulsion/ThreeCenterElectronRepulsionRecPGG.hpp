#ifndef ThreeCenterElectronRepulsionRecPGG_hpp
#define ThreeCenterElectronRepulsionRecPGG_hpp
...
/// @brief Computes (P|1/|r-r'||GG)  integrals for basis functions block and basis function pairs block.
...
template <class T>
inline auto
comp_electron_repulsion_pgg(T& distributor,
                            ...
                            const std::pair<size_t, size_t>& bra_range) -> void
{
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_range.first; j < bra_range.second; j++)
        {
            ...
            t3cfunc::bra_transform<1>(skbuffer, 300, cbuffer, 300, 0, 8);
            ...
            t3cfunc::ket_transform<4, 4>(sbuffer, 0, skbuffer, 3567, 1);
...
#endif /* ThreeCenterElectronRepulsionRecPGG_hpp */
