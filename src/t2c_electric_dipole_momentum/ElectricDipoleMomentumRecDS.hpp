#ifndef ElectricDipoleMomentumRecDS_hpp
#define ElectricDipoleMomentumRecDS_hpp
...
/// @brief Computes (D|r|S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electric_dipole_momentum_ds(T& distributor,
                                 ...
                                 const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(34, ket_npgtos);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cfunc::reduce(cbuffer, pbuffer, 16, ket_width, ket_npgtos);
            }
...
#endif /* ElectricDipoleMomentumRecDS_hpp */
