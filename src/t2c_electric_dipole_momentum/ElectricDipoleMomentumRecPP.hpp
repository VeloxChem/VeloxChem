#ifndef ElectricDipoleMomentumRecPP_hpp
#define ElectricDipoleMomentumRecPP_hpp
...
/// @brief Computes (P|r|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electric_dipole_momentum_pp(T& distributor,
...
#endif /* ElectricDipoleMomentumRecPP_hpp */
