#ifndef ElectricDipoleMomentumRecFD_hpp
#define ElectricDipoleMomentumRecFD_hpp
...
/// @brief Computes (F|r|D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electric_dipole_momentum_fd(T& distributor,
...
#endif /* ElectricDipoleMomentumRecFD_hpp */
