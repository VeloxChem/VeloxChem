#ifndef ElectricDipoleMomentumRecPD_hpp
#define ElectricDipoleMomentumRecPD_hpp
...
/// @brief Computes (P|r|D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electric_dipole_momentum_pd(T&                               distributor,
                                 ...
                                 const bool                       bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(94, ket_npgtos);
...
#endif /* ElectricDipoleMomentumRecPD_hpp */
