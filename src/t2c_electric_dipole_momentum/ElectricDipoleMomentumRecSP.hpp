#ifndef ElectricDipoleMomentumRecSP_hpp
#define ElectricDipoleMomentumRecSP_hpp
...
/// @brief Computes (S|r|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electric_dipole_momentum_sp(T& distributor,
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                diprec::comp_prim_electric_dipole_momentum_sp(pbuffer, 4, 0, 1, factors, 11, a_exp);
...
#endif /* ElectricDipoleMomentumRecSP_hpp */
