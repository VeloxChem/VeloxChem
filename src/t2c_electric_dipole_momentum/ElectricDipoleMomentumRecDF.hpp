#ifndef ElectricDipoleMomentumRecDF_hpp
#define ElectricDipoleMomentumRecDF_hpp
...
/// @brief Computes (D|r|F)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electric_dipole_momentum_df(T&                               distributor,
                                 ...
                                 const bool                       bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(434, ket_npgtos);
...
#endif /* ElectricDipoleMomentumRecDF_hpp */
