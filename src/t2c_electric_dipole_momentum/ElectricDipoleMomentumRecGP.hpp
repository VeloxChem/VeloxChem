#ifndef ElectricDipoleMomentumRecGP_hpp
#define ElectricDipoleMomentumRecGP_hpp
...
/// @brief Computes (G|r|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electric_dipole_momentum_gp(T& distributor,
                                 ...
                                 const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(445, ket_npgtos);
...
#endif /* ElectricDipoleMomentumRecGP_hpp */
