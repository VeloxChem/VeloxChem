#ifndef ElectricDipoleMomentumRecPF_hpp
#define ElectricDipoleMomentumRecPF_hpp
...
/// @brief Computes (P|r|F)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electric_dipole_momentum_pf(T&                               distributor,
...
#endif /* ElectricDipoleMomentumRecPF_hpp */
