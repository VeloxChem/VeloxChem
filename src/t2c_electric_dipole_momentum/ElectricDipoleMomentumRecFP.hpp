#ifndef ElectricDipoleMomentumRecFP_hpp
#define ElectricDipoleMomentumRecFP_hpp
...
/// @brief Computes (F|r|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electric_dipole_momentum_fp(T&                               distributor,
...
#endif /* ElectricDipoleMomentumRecFP_hpp */
