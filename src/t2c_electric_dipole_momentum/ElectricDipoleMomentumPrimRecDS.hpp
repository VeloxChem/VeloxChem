#ifndef ElectricDipoleMomentumPrimRecDS
#define ElectricDipoleMomentumPrimRecDS

#include "SimdArray.hpp"

namespace diprec {  // diprec namespace

/// @brief Computes primitive [D|r|S]  integrals for set of data buffers.
...
auto comp_prim_electric_dipole_momentum_ds(CSimdArray<double>&       pbuffer,
...
#endif /* ElectricDipoleMomentumPrimRecDS */
