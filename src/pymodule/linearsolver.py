...
class LinearSolver:
    ...
    def write_checkpoint(self, molecule, basis, dft_dict, pe_dict, dist_arrays,
        ...
        if self.rank == mpi_master():
            success = self.write_rsp_hdf5(self.checkpoint_file, [], [],
    ...
    @staticmethod
    def write_rsp_hdf5(fname, arrays, labels, molecule, basis, dft_dict,
                       pe_dict, ostream):
        """
    ...
    @staticmethod
    def read_rsp_hdf5(fname, labels, molecule, basis, dft_dict, pe_dict,
                      ostream):
        """
        ...
        if 'nuclear_repulsion' in hf:
            ...
            if h5_e_nuc > 0.0 and e_nuc > 0.0:
                match_nuclear_repulsion = (abs(1.0 - h5_e_nuc / e_nuc) <
                                           1.0e-13)
            else:
