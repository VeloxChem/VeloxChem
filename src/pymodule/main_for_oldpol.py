...
from .oldpolarizabilitygradient import PolarizabilityGradient
from .oldpolorbitalresponse import PolOrbitalResponse
...
def main():
    ...
    if task_type in ['polarizability_gradient']:
        ...
        # Do only the polarizability orbital response:
        polorbrsp_drv = PolOrbitalResponse(task.mpi_comm, task.ostream)
        polorbrsp_drv.update_settings(orbrsp_dict, method_dict)
        polorbrsp_drv.compute(task.molecule, task.ao_basis,
