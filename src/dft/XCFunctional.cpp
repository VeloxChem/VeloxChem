                                    ...
                                    double*       v4tau4) const -> void
{
    ...
    auto mgga_ptr = getFunctionalPointerToMetaGgaComponent();
    ...
    auto stage_v4rhosigma2lapl   = (alloc) ? mem::malloc<double>(36 * np) : &_stagingBuffer[357 * _ldStaging];  // TODO: use mgga_ptr->dim (36 vs 24);
    auto stage_v4rhosigma2tau    = (alloc) ? mem::malloc<double>(36 * np) : &_stagingBuffer[393 * _ldStaging];  // TODO: use mgga_ptr->dim (36 vs 24);
    ...
    auto stage_v4rhosigmatau2    = (alloc) ? mem::malloc<double>(36 * np) : &_stagingBuffer[471 * _ldStaging];  // TODO: use mgga_ptr->dim (36 vs 18);
    ...
    auto stage_v4sigma3tau       = (alloc) ? mem::malloc<double>(30 * np) : &_stagingBuffer[582 * _ldStaging];  // TODO: use mgga_ptr->dim (30 vs 20);
    ...
    for (const auto& xccomp : _components)
    {
        ...
        else if ((family == XC_FAMILY_MGGA) || (family == XC_FAMILY_HYB_MGGA))
        {
            ...
            for (auto g = 0; g < np; ++g)
            {
                ...
                v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 0] += c * stage_v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 0];
                v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 1] += c * stage_v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 1];
                v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 2] += c * stage_v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 2];
                v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 3] += c * stage_v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 3];
                v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 4] += c * stage_v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 4];
                v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 5] += c * stage_v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 5];
                v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 6] += c * stage_v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 6];
                v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 7] += c * stage_v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 7];
                v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 8] += c * stage_v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 8];
                v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 9] += c * stage_v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 9];
                v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 10] += c * stage_v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 10];
                v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 11] += c * stage_v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 11];
                v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 12] += c * stage_v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 12];
                v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 13] += c * stage_v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 13];
                v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 14] += c * stage_v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 14];
                v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 15] += c * stage_v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 15];
                v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 16] += c * stage_v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 16];
                v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 17] += c * stage_v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 17];
                v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 18] += c * stage_v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 18];
                v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 19] += c * stage_v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 19];
                v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 20] += c * stage_v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 20];
                v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 21] += c * stage_v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 21];
                v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 22] += c * stage_v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 22];
                v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 23] += c * stage_v4rhosigma2lapl[funcptr->dim.v4rhosigma2lapl * g + 23];

                v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 0] += c * stage_v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 0];
                v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 1] += c * stage_v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 1];
                v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 2] += c * stage_v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 2];
                v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 3] += c * stage_v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 3];
                v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 4] += c * stage_v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 4];
                v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 5] += c * stage_v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 5];
                v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 6] += c * stage_v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 6];
                v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 7] += c * stage_v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 7];
                v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 8] += c * stage_v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 8];
                v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 9] += c * stage_v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 9];
                v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 10] += c * stage_v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 10];
                v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 11] += c * stage_v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 11];
                v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 12] += c * stage_v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 12];
                v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 13] += c * stage_v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 13];
                v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 14] += c * stage_v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 14];
                v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 15] += c * stage_v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 15];
                v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 16] += c * stage_v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 16];
                v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 17] += c * stage_v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 17];
                v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 18] += c * stage_v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 18];
                v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 19] += c * stage_v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 19];
                v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 20] += c * stage_v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 20];
                v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 21] += c * stage_v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 21];
                v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 22] += c * stage_v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 22];
                v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 23] += c * stage_v4rhosigma2tau[funcptr->dim.v4rhosigma2tau * g + 23];
                ...
                v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 0] += c * stage_v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 0];
                v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 1] += c * stage_v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 1];
                v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 2] += c * stage_v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 2];
                v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 3] += c * stage_v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 3];
                v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 4] += c * stage_v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 4];
                v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 5] += c * stage_v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 5];
                v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 6] += c * stage_v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 6];
                v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 7] += c * stage_v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 7];
                v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 8] += c * stage_v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 8];
                v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 9] += c * stage_v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 9];
                v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 10] += c * stage_v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 10];
                v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 11] += c * stage_v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 11];
                v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 12] += c * stage_v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 12];
                v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 13] += c * stage_v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 13];
                v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 14] += c * stage_v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 14];
                v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 15] += c * stage_v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 15];
                v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 16] += c * stage_v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 16];
                v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 17] += c * stage_v4rhosigmatau2[funcptr->dim.v4rhosigmatau2 * g + 17];
                ...
                v4sigma3tau[funcptr->dim.v4sigma3tau * g + 0] += c * stage_v4sigma3tau[funcptr->dim.v4sigma3tau * g + 0];
                v4sigma3tau[funcptr->dim.v4sigma3tau * g + 1] += c * stage_v4sigma3tau[funcptr->dim.v4sigma3tau * g + 1];
                v4sigma3tau[funcptr->dim.v4sigma3tau * g + 2] += c * stage_v4sigma3tau[funcptr->dim.v4sigma3tau * g + 2];
                v4sigma3tau[funcptr->dim.v4sigma3tau * g + 3] += c * stage_v4sigma3tau[funcptr->dim.v4sigma3tau * g + 3];
                v4sigma3tau[funcptr->dim.v4sigma3tau * g + 4] += c * stage_v4sigma3tau[funcptr->dim.v4sigma3tau * g + 4];
                v4sigma3tau[funcptr->dim.v4sigma3tau * g + 5] += c * stage_v4sigma3tau[funcptr->dim.v4sigma3tau * g + 5];
                v4sigma3tau[funcptr->dim.v4sigma3tau * g + 6] += c * stage_v4sigma3tau[funcptr->dim.v4sigma3tau * g + 6];
                v4sigma3tau[funcptr->dim.v4sigma3tau * g + 7] += c * stage_v4sigma3tau[funcptr->dim.v4sigma3tau * g + 7];
                v4sigma3tau[funcptr->dim.v4sigma3tau * g + 8] += c * stage_v4sigma3tau[funcptr->dim.v4sigma3tau * g + 8];
                v4sigma3tau[funcptr->dim.v4sigma3tau * g + 9] += c * stage_v4sigma3tau[funcptr->dim.v4sigma3tau * g + 9];
                v4sigma3tau[funcptr->dim.v4sigma3tau * g + 10] += c * stage_v4sigma3tau[funcptr->dim.v4sigma3tau * g + 10];
                v4sigma3tau[funcptr->dim.v4sigma3tau * g + 11] += c * stage_v4sigma3tau[funcptr->dim.v4sigma3tau * g + 11];
                v4sigma3tau[funcptr->dim.v4sigma3tau * g + 12] += c * stage_v4sigma3tau[funcptr->dim.v4sigma3tau * g + 12];
                v4sigma3tau[funcptr->dim.v4sigma3tau * g + 13] += c * stage_v4sigma3tau[funcptr->dim.v4sigma3tau * g + 13];
                v4sigma3tau[funcptr->dim.v4sigma3tau * g + 14] += c * stage_v4sigma3tau[funcptr->dim.v4sigma3tau * g + 14];
                v4sigma3tau[funcptr->dim.v4sigma3tau * g + 15] += c * stage_v4sigma3tau[funcptr->dim.v4sigma3tau * g + 15];
                v4sigma3tau[funcptr->dim.v4sigma3tau * g + 16] += c * stage_v4sigma3tau[funcptr->dim.v4sigma3tau * g + 16];
                v4sigma3tau[funcptr->dim.v4sigma3tau * g + 17] += c * stage_v4sigma3tau[funcptr->dim.v4sigma3tau * g + 17];
                v4sigma3tau[funcptr->dim.v4sigma3tau * g + 18] += c * stage_v4sigma3tau[funcptr->dim.v4sigma3tau * g + 18];
                v4sigma3tau[funcptr->dim.v4sigma3tau * g + 19] += c * stage_v4sigma3tau[funcptr->dim.v4sigma3tau * g + 19];
