...
class CXCGradientGrid
{
   ...
   public:
     ...
     */
    CXCGradientGrid(const CMemBlock2D<double>& xcValues, const dengrid densityGridType, const xcfun xcGridType);
    ...
    /**
     ...
     @param xcGridType the type of echange-correlation gradient grid.
     */
    CXCGradientGrid(const int32_t nGridPoints, const dengrid densityGridType, const xcfun xcGridType);
