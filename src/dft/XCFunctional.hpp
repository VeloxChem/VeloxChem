...
class CXCFunctional
{
   ...
   public:
     ...
     */
    void compute(CXCGradientGrid& xcGradientGrid, const CDensityGrid& densityGrid) const;
    ...
    /**
     ...
     @param densityGrid the density grid object.
     */
    void compute(CXCHessianGrid& xcHessianGrid, const CDensityGrid& densityGrid) const;
    ...
    /**
     ...
     @param densityGrid the density grid object.
     */
    void compute(CXCCubicHessianGrid& xcCubicHessianGrid, const CDensityGrid& densityGrid) const;
