...
CXCCubicHessianGrid::CXCCubicHessianGrid(const CMemBlock2D<double>& xcValues,
...
CXCCubicHessianGrid::CXCCubicHessianGrid(const int32_t nGridPoints,
                                         const dengrid densityGridType,
                                         const xcfun   xcGridType)
{
    _densityGridType = densityGridType;
...
const double*
CXCCubicHessianGrid::xcCubicHessianValues(const xcvars iVariableType,
