                                        ...
                                        const std::string&      cubeMode) const
{
    ...
    if (rwDensityMatrix.isClosedShell() && rw2DensityMatrix.isClosedShell() && rw3DensityMatrix.isClosedShell() && gsDensityMatrix.isClosedShell())
    {
        if (xcfuntype == xcfun::lda)
        {
            _integrateKxcLxcFockForLDA(aoFockMatrix, molecule, basis, rwDensityMatrix, rw2DensityMatrix,rw3DensityMatrix, gsDensityMatrix,

                                       molecularGrid, fvxc, cubeMode);
        }
        else if (xcfuntype == xcfun::gga)
        {
            _integrateKxcLxcFockForGGA(aoFockMatrix, molecule, basis, rwDensityMatrix, rw2DensityMatrix,rw3DensityMatrix, gsDensityMatrix,

                                     molecularGrid, fvxc, cubeMode);
        }
        else if  (xcfuntype == xcfun::mgga)
        {
            _integrateKxcLxcFockForMGGA(aoFockMatrix, molecule, basis, rwDensityMatrix, rw2DensityMatrix,rw3DensityMatrix, gsDensityMatrix,
    ...
    for (int32_t box_id = 0; box_id < counts.size(); box_id++)
    {
        ...
        for (int32_t idensity = 0; idensity < numdens_rw2; idensity++)
        {
            ...
            auto partial_mat_Kxc = _integratePartialKxcFockForMGGA(npoints,local_weights,mat_chi,mat_chi_x,mat_chi_y,
                                                                   mat_chi_z,mat_chi_xx,mat_chi_yy,mat_chi_zz,rhograd,vsigma,
                                          ...
                                          const std::string&      cubeMode) const
{
    ...
    CMemBlock<double> v4rhosigma3_data(20 * molecularGrid.getMaxNumberOfGridPointsPerBox());
    CMemBlock<double> v4rhosigma2lapl_data(24 * molecularGrid.getMaxNumberOfGridPointsPerBox());
    CMemBlock<double> v4rhosigma2tau_data(24 * molecularGrid.getMaxNumberOfGridPointsPerBox());
    ...
    CMemBlock<double> v4rhosigmatau2_data(18 * molecularGrid.getMaxNumberOfGridPointsPerBox());
    ...
    CMemBlock<double> v4sigma3tau_data(20 * molecularGrid.getMaxNumberOfGridPointsPerBox());
    ...
    for (int32_t box_id = 0; box_id < counts.size(); box_id++)
    {
        ...
        for (int32_t idensity = 0; idensity < numdens_rw2; idensity++)
        {
           ...
           auto partial_mat_Kxc = _integratePartialKxcFockForMGGA2(npoints,local_weights,mat_chi,mat_chi_x,mat_chi_y,
                                                                   mat_chi_z,mat_chi_xx,mat_chi_yy,mat_chi_zz,rhograd,vsigma,
                                                                   v2rho2,v2lapl2,v2tau2,v2rholapl,v2rhotau,
                                                                   v2lapltau,v2rhosigma,v2sigmalapl,v2sigmatau,v2sigma2,
                                                                   v3rho3,v3rho2sigma,v3rho2lapl,v3rho2tau,v3rhosigma2,
        ...
        for (int32_t idensity = 0; idensity < numdens_rw3; idensity++)
        {
            ...
            auto partial_mat_Lxc = _integratePartialLxcFockForMGGA(npoints, local_weights, mat_chi,mat_chi_x,mat_chi_y,
                                                                   mat_chi_z,mat_chi_xx,mat_chi_yy,mat_chi_zz, 
    ...
    #pragma omp parallel
    {
        ...
        for (int32_t nu = 0; nu < naos; nu++)
        {
            ...
            #pragma omp simd aligned(weights, rhow, rhograd, rhowgrad, tauw, laplw,\
                                     ...
                                     v2rhosigma, v2sigmalapl, v2sigmatau,v2sigma2, G_val, G_gga_val, G_gga_x_val, G_gga_y_val, G_gga_z_val,\
                                     chi_val, chi_x_val, chi_y_val, chi_z_val, chi_xx_val, chi_yy_val, chi_zz_val :VLX_ALIGN)
            for (int32_t g = grid_batch_offset; g < grid_batch_offset + grid_batch_size; g++)
            {
                                                  ...
                                                  CMultiTimer&               timer) const
{
    ...
    #pragma omp parallel
    {
        ...
        #pragma omp simd aligned(gam,rt_gam,rl_gam,tt_gam,tl_gam,ll_gam,gamx,gamy,gamz,\
                                ...
                                gradw_z ,chi_x_val ,chi_y_val ,chi_z_val ,chi_xx_val,chi_yy_val,chi_zz_val,\
            ...
            for (int32_t g = grid_batch_offset; g < grid_batch_offset + grid_batch_size; g++)
            {
                ...
                auto v4rhosigma2lapl_aaaa = v4rhosigma2lapl[24 * g + 0];
                auto v4rhosigma2lapl_aaab = v4rhosigma2lapl[24 * g + 1];
                auto v4rhosigma2lapl_aaca = v4rhosigma2lapl[24 * g + 2];
                auto v4rhosigma2lapl_aacb = v4rhosigma2lapl[24 * g + 3];
                auto v4rhosigma2lapl_aaba = v4rhosigma2lapl[24 * g + 4];
                auto v4rhosigma2lapl_aabb = v4rhosigma2lapl[24 * g + 5];
                auto v4rhosigma2lapl_acca = v4rhosigma2lapl[24 * g + 6];
                auto v4rhosigma2lapl_accb = v4rhosigma2lapl[24 * g + 7];
                auto v4rhosigma2lapl_acba = v4rhosigma2lapl[24 * g + 8];
                auto v4rhosigma2lapl_acbb = v4rhosigma2lapl[24 * g + 9];
                auto v4rhosigma2lapl_abba = v4rhosigma2lapl[24 * g + 10];
                auto v4rhosigma2lapl_abbb = v4rhosigma2lapl[24 * g + 11];
                auto v4rhosigma2lapl_baaa = v4rhosigma2lapl[24 * g + 12];
                auto v4rhosigma2lapl_baab = v4rhosigma2lapl[24 * g + 13];
                auto v4rhosigma2lapl_baca = v4rhosigma2lapl[24 * g + 14];
                auto v4rhosigma2lapl_bacb = v4rhosigma2lapl[24 * g + 15];
                auto v4rhosigma2lapl_baba = v4rhosigma2lapl[24 * g + 16];
                auto v4rhosigma2lapl_babb = v4rhosigma2lapl[24 * g + 17];
                auto v4rhosigma2lapl_bcca = v4rhosigma2lapl[24 * g + 18];
                auto v4rhosigma2lapl_bccb = v4rhosigma2lapl[24 * g + 19];
                auto v4rhosigma2lapl_bcba = v4rhosigma2lapl[24 * g + 20];
                auto v4rhosigma2lapl_bcbb = v4rhosigma2lapl[24 * g + 21];
                auto v4rhosigma2lapl_bbba = v4rhosigma2lapl[24 * g + 22];
                auto v4rhosigma2lapl_bbbb = v4rhosigma2lapl[24 * g + 23];
                
                auto v4rhosigma2tau_aaaa = v4rhosigma2tau[24 * g + 0];
                auto v4rhosigma2tau_aaab = v4rhosigma2tau[24 * g + 1];
                auto v4rhosigma2tau_aaca = v4rhosigma2tau[24 * g + 2];
                auto v4rhosigma2tau_aacb = v4rhosigma2tau[24 * g + 3];
                auto v4rhosigma2tau_aaba = v4rhosigma2tau[24 * g + 4];
                auto v4rhosigma2tau_aabb = v4rhosigma2tau[24 * g + 5];
                auto v4rhosigma2tau_acca = v4rhosigma2tau[24 * g + 6];
                auto v4rhosigma2tau_accb = v4rhosigma2tau[24 * g + 7];
                auto v4rhosigma2tau_acba = v4rhosigma2tau[24 * g + 8];
                auto v4rhosigma2tau_acbb = v4rhosigma2tau[24 * g + 9];
                auto v4rhosigma2tau_abba = v4rhosigma2tau[24 * g + 10];
                auto v4rhosigma2tau_abbb = v4rhosigma2tau[24 * g + 11];
                auto v4rhosigma2tau_baaa = v4rhosigma2tau[24 * g + 12];
                auto v4rhosigma2tau_baab = v4rhosigma2tau[24 * g + 13];
                auto v4rhosigma2tau_baca = v4rhosigma2tau[24 * g + 14];
                auto v4rhosigma2tau_bacb = v4rhosigma2tau[24 * g + 15];
                auto v4rhosigma2tau_baba = v4rhosigma2tau[24 * g + 16];
                auto v4rhosigma2tau_babb = v4rhosigma2tau[24 * g + 17];
                auto v4rhosigma2tau_bcca = v4rhosigma2tau[24 * g + 18];
                auto v4rhosigma2tau_bccb = v4rhosigma2tau[24 * g + 19];
                auto v4rhosigma2tau_bcba = v4rhosigma2tau[24 * g + 20];
                auto v4rhosigma2tau_bcbb = v4rhosigma2tau[24 * g + 21];
                auto v4rhosigma2tau_bbba = v4rhosigma2tau[24 * g + 22];
                auto v4rhosigma2tau_bbbb = v4rhosigma2tau[24 * g + 23];
                ...
                auto v4rhosigmatau2_aaaa = v4rhosigmatau2[18 * g + 0];
                auto v4rhosigmatau2_aaab = v4rhosigmatau2[18 * g + 1];
                auto v4rhosigmatau2_aabb = v4rhosigmatau2[18 * g + 2];
                auto v4rhosigmatau2_acaa = v4rhosigmatau2[18 * g + 3];
                auto v4rhosigmatau2_acab = v4rhosigmatau2[18 * g + 4];
                auto v4rhosigmatau2_acbb = v4rhosigmatau2[18 * g + 5];
                auto v4rhosigmatau2_abaa = v4rhosigmatau2[18 * g + 6];
                auto v4rhosigmatau2_abab = v4rhosigmatau2[18 * g + 7];
                auto v4rhosigmatau2_abbb = v4rhosigmatau2[18 * g + 8];
                auto v4rhosigmatau2_baaa = v4rhosigmatau2[18 * g + 9];
                auto v4rhosigmatau2_baab = v4rhosigmatau2[18 * g + 10];
                auto v4rhosigmatau2_babb = v4rhosigmatau2[18 * g + 11];
                auto v4rhosigmatau2_bcaa = v4rhosigmatau2[18 * g + 12];
                auto v4rhosigmatau2_bcab = v4rhosigmatau2[18 * g + 13];
                auto v4rhosigmatau2_bcbb = v4rhosigmatau2[18 * g + 14];
                auto v4rhosigmatau2_bbaa = v4rhosigmatau2[18 * g + 15];
                auto v4rhosigmatau2_bbab = v4rhosigmatau2[18 * g + 16];
                auto v4rhosigmatau2_bbbb = v4rhosigmatau2[18 * g + 17];
                ...
                auto v4sigma3tau_aaaa = v4sigma3tau[20 * g + 0];
                auto v4sigma3tau_aaab = v4sigma3tau[20 * g + 1];
                auto v4sigma3tau_aaca = v4sigma3tau[20 * g + 2];
                auto v4sigma3tau_aacb = v4sigma3tau[20 * g + 3];
                auto v4sigma3tau_aaba = v4sigma3tau[20 * g + 4];
                auto v4sigma3tau_aabb = v4sigma3tau[20 * g + 5];
                auto v4sigma3tau_acca = v4sigma3tau[20 * g + 6];
                auto v4sigma3tau_accb = v4sigma3tau[20 * g + 7];
                auto v4sigma3tau_acba = v4sigma3tau[20 * g + 8];
                auto v4sigma3tau_acbb = v4sigma3tau[20 * g + 9];
                auto v4sigma3tau_abba = v4sigma3tau[20 * g + 10];
                auto v4sigma3tau_abbb = v4sigma3tau[20 * g + 11];
                auto v4sigma3tau_ccca = v4sigma3tau[20 * g + 12];
                auto v4sigma3tau_cccb = v4sigma3tau[20 * g + 13];
                auto v4sigma3tau_ccba = v4sigma3tau[20 * g + 14];
                auto v4sigma3tau_ccbb = v4sigma3tau[20 * g + 15];
                auto v4sigma3tau_cbba = v4sigma3tau[20 * g + 16];
                auto v4sigma3tau_cbbb = v4sigma3tau[20 * g + 17];
                auto v4sigma3tau_bbba = v4sigma3tau[20 * g + 18];
                auto v4sigma3tau_bbbb = v4sigma3tau[20 * g + 19];
