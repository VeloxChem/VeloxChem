...
class CDensityGrid
{
     ...
     */
    bool _isValidGridPointForLda(const double alphaDensity, const double betaDensity, const double densityThreshold) const;
    ...
    /**
     ...
     @return true if valid density grid point, false otherwise.
     */
    bool _isValidGridPointForLdaUnrestricted(const double alphaDensity, const double betaDensity, const double densityThreshold) const;
    ...
    /**
      ...
      @return true if valid density grid point, false otherwise.
      */
    bool _isValidGridPointForLdaA(const double alphaDensity, const double betaDensity, const double densityThreshold) const;
    ...
    /**
     ...
     @return true if valid density grid point, false otherwise.
     */
    bool _isValidGridPointForLdaB(const double alphaDensity, const double betaDensity, const double densityThreshold) const;
