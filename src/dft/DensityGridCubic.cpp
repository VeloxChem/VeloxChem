        ...
        if (fstr::upcase(CubeMode) == "CRF")
        {
            for (int32_t j = 0; j < numdens / 2; j++)
            {
                ...
                for (int32_t i = 0; i < npoints; i++)
                {
                    ...
                    pi_r[i] = 6.0 * prod3_r(rhoB_r[i],rhoB_i[i],rhoC_r[i],rhoC_i[i],rhoD_r[i],rhoD_i[i]);
                    pi_i[i] = 6.0 * prod3_i(rhoB_r[i],rhoB_i[i],rhoC_r[i],rhoC_i[i],rhoD_r[i],rhoD_i[i]);

                    gam_r[i] =  3.0 * prod2_r(rhoD_r[i],rhoD_i[i], rhoBC_r[i],rhoBC_i[i]);
                    gam_i[i] =  3.0 * prod2_i(rhoD_r[i],rhoD_i[i], rhoBC_r[i],rhoBC_i[i]);
                    gam_r[i] += 3.0 * prod2_r(rhoB_r[i],rhoB_i[i], rhoCD_r[i],rhoCD_i[i]);
                    gam_i[i] += 3.0 * prod2_i(rhoB_r[i],rhoB_i[i], rhoCD_r[i],rhoCD_i[i]);
                    gam_r[i] += 3.0 * prod2_r(rhoC_r[i],rhoC_i[i], rhoBD_r[i],rhoBD_i[i]);
                    gam_i[i] += 3.0 * prod2_i(rhoC_r[i],rhoC_i[i], rhoBD_r[i],rhoBD_i[i]);
        ...
        if (fstr::upcase(CubeMode) == "CRF")
        {
            for (int32_t j = 0; j < numdens / 2; j++)
            {
                ...
                for (int32_t i = 0; i < npoints; i++)
                {
                    ...
                    pi_XXX_r[i] +=  prod3_r(gradB_x_r[i], gradB_x_i[i], gradC_x_r[i], gradC_x_i[i], gradD_x_r[i], gradD_x_i[i])// Permutation: BCD
                                +  prod3_r(gradB_x_r[i], gradB_x_i[i], gradD_x_r[i], gradD_x_i[i], gradC_x_r[i], gradC_x_i[i])// Permutation: BDC
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], gradB_x_r[i], gradB_x_i[i], gradD_x_r[i], gradD_x_i[i])// Permutation: CBD
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], gradD_x_r[i], gradD_x_i[i], gradB_x_r[i], gradB_x_i[i])// Permutation: CDB
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], gradB_x_r[i], gradB_x_i[i], gradC_x_r[i], gradC_x_i[i])// Permutation: DBC
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], gradC_x_r[i], gradC_x_i[i], gradB_x_r[i], gradB_x_i[i]);// Permutation: DCB

                    pi_XXY_r[i] +=  prod3_r(gradB_x_r[i], gradB_x_i[i], gradC_x_r[i], gradC_x_i[i], gradD_y_r[i], gradD_y_i[i])// Permutation: BCD
                                +  prod3_r(gradB_x_r[i], gradB_x_i[i], gradD_x_r[i], gradD_x_i[i], gradC_y_r[i], gradC_y_i[i])// Permutation: BDC
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], gradB_x_r[i], gradB_x_i[i], gradD_y_r[i], gradD_y_i[i])// Permutation: CBD
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], gradD_x_r[i], gradD_x_i[i], gradB_y_r[i], gradB_y_i[i])// Permutation: CDB
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], gradB_x_r[i], gradB_x_i[i], gradC_y_r[i], gradC_y_i[i])// Permutation: DBC
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], gradC_x_r[i], gradC_x_i[i], gradB_y_r[i], gradB_y_i[i]);// Permutation: DCB

                    pi_XXZ_r[i] +=  prod3_r(gradB_x_r[i], gradB_x_i[i], gradC_x_r[i], gradC_x_i[i], gradD_z_r[i], gradD_z_i[i])// Permutation: BCD
                                +  prod3_r(gradB_x_r[i], gradB_x_i[i], gradD_x_r[i], gradD_x_i[i], gradC_z_r[i], gradC_z_i[i])// Permutation: BDC
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], gradB_x_r[i], gradB_x_i[i], gradD_z_r[i], gradD_z_i[i])// Permutation: CBD
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], gradD_x_r[i], gradD_x_i[i], gradB_z_r[i], gradB_z_i[i])// Permutation: CDB
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], gradB_x_r[i], gradB_x_i[i], gradC_z_r[i], gradC_z_i[i])// Permutation: DBC
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], gradC_x_r[i], gradC_x_i[i], gradB_z_r[i], gradB_z_i[i]);// Permutation: DCB

                    pi_XYX_r[i] +=  prod3_r(gradB_x_r[i], gradB_x_i[i], gradC_y_r[i], gradC_y_i[i], gradD_x_r[i], gradD_x_i[i])// Permutation: BCD
                                +  prod3_r(gradB_x_r[i], gradB_x_i[i], gradD_y_r[i], gradD_y_i[i], gradC_x_r[i], gradC_x_i[i])// Permutation: BDC
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], gradB_y_r[i], gradB_y_i[i], gradD_x_r[i], gradD_x_i[i])// Permutation: CBD
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], gradD_y_r[i], gradD_y_i[i], gradB_x_r[i], gradB_x_i[i])// Permutation: CDB
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], gradB_y_r[i], gradB_y_i[i], gradC_x_r[i], gradC_x_i[i])// Permutation: DBC
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], gradC_y_r[i], gradC_y_i[i], gradB_x_r[i], gradB_x_i[i]);// Permutation: DCB

                    pi_XYY_r[i] +=  prod3_r(gradB_x_r[i], gradB_x_i[i], gradC_y_r[i], gradC_y_i[i], gradD_y_r[i], gradD_y_i[i])// Permutation: BCD
                                +  prod3_r(gradB_x_r[i], gradB_x_i[i], gradD_y_r[i], gradD_y_i[i], gradC_y_r[i], gradC_y_i[i])// Permutation: BDC
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], gradB_y_r[i], gradB_y_i[i], gradD_y_r[i], gradD_y_i[i])// Permutation: CBD
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], gradD_y_r[i], gradD_y_i[i], gradB_y_r[i], gradB_y_i[i])// Permutation: CDB
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], gradB_y_r[i], gradB_y_i[i], gradC_y_r[i], gradC_y_i[i])// Permutation: DBC
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], gradC_y_r[i], gradC_y_i[i], gradB_y_r[i], gradB_y_i[i]);// Permutation: DCB

                    pi_XYZ_r[i] +=  prod3_r(gradB_x_r[i], gradB_x_i[i], gradC_y_r[i], gradC_y_i[i], gradD_z_r[i], gradD_z_i[i])// Permutation: BCD
                                +  prod3_r(gradB_x_r[i], gradB_x_i[i], gradD_y_r[i], gradD_y_i[i], gradC_z_r[i], gradC_z_i[i])// Permutation: BDC
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], gradB_y_r[i], gradB_y_i[i], gradD_z_r[i], gradD_z_i[i])// Permutation: CBD
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], gradD_y_r[i], gradD_y_i[i], gradB_z_r[i], gradB_z_i[i])// Permutation: CDB
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], gradB_y_r[i], gradB_y_i[i], gradC_z_r[i], gradC_z_i[i])// Permutation: DBC
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], gradC_y_r[i], gradC_y_i[i], gradB_z_r[i], gradB_z_i[i]);// Permutation: DCB

                    pi_XZX_r[i] +=  prod3_r(gradB_x_r[i], gradB_x_i[i], gradC_z_r[i], gradC_z_i[i], gradD_x_r[i], gradD_x_i[i])// Permutation: BCD
                                +  prod3_r(gradB_x_r[i], gradB_x_i[i], gradD_z_r[i], gradD_z_i[i], gradC_x_r[i], gradC_x_i[i])// Permutation: BDC
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], gradB_z_r[i], gradB_z_i[i], gradD_x_r[i], gradD_x_i[i])// Permutation: CBD
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], gradD_z_r[i], gradD_z_i[i], gradB_x_r[i], gradB_x_i[i])// Permutation: CDB
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], gradB_z_r[i], gradB_z_i[i], gradC_x_r[i], gradC_x_i[i])// Permutation: DBC
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], gradC_z_r[i], gradC_z_i[i], gradB_x_r[i], gradB_x_i[i]);// Permutation: DCB

                    pi_XZY_r[i] +=  prod3_r(gradB_x_r[i], gradB_x_i[i], gradC_z_r[i], gradC_z_i[i], gradD_y_r[i], gradD_y_i[i])// Permutation: BCD
                                +  prod3_r(gradB_x_r[i], gradB_x_i[i], gradD_z_r[i], gradD_z_i[i], gradC_y_r[i], gradC_y_i[i])// Permutation: BDC
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], gradB_z_r[i], gradB_z_i[i], gradD_y_r[i], gradD_y_i[i])// Permutation: CBD
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], gradD_z_r[i], gradD_z_i[i], gradB_y_r[i], gradB_y_i[i])// Permutation: CDB
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], gradB_z_r[i], gradB_z_i[i], gradC_y_r[i], gradC_y_i[i])// Permutation: DBC
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], gradC_z_r[i], gradC_z_i[i], gradB_y_r[i], gradB_y_i[i]);// Permutation: DCB

                    pi_XZZ_r[i] +=  prod3_r(gradB_x_r[i], gradB_x_i[i], gradC_z_r[i], gradC_z_i[i], gradD_z_r[i], gradD_z_i[i])// Permutation: BCD
                                +  prod3_r(gradB_x_r[i], gradB_x_i[i], gradD_z_r[i], gradD_z_i[i], gradC_z_r[i], gradC_z_i[i])// Permutation: BDC
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], gradB_z_r[i], gradB_z_i[i], gradD_z_r[i], gradD_z_i[i])// Permutation: CBD
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], gradD_z_r[i], gradD_z_i[i], gradB_z_r[i], gradB_z_i[i])// Permutation: CDB
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], gradB_z_r[i], gradB_z_i[i], gradC_z_r[i], gradC_z_i[i])// Permutation: DBC
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], gradC_z_r[i], gradC_z_i[i], gradB_z_r[i], gradB_z_i[i]);// Permutation: DCB

                    pi_YXX_r[i] +=  prod3_r(gradB_y_r[i], gradB_y_i[i], gradC_x_r[i], gradC_x_i[i], gradD_x_r[i], gradD_x_i[i])// Permutation: BCD
                                +  prod3_r(gradB_y_r[i], gradB_y_i[i], gradD_x_r[i], gradD_x_i[i], gradC_x_r[i], gradC_x_i[i])// Permutation: BDC
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], gradB_x_r[i], gradB_x_i[i], gradD_x_r[i], gradD_x_i[i])// Permutation: CBD
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], gradD_x_r[i], gradD_x_i[i], gradB_x_r[i], gradB_x_i[i])// Permutation: CDB
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], gradB_x_r[i], gradB_x_i[i], gradC_x_r[i], gradC_x_i[i])// Permutation: DBC
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], gradC_x_r[i], gradC_x_i[i], gradB_x_r[i], gradB_x_i[i]);// Permutation: DCB

                    pi_YXY_r[i] +=  prod3_r(gradB_y_r[i], gradB_y_i[i], gradC_x_r[i], gradC_x_i[i], gradD_y_r[i], gradD_y_i[i])// Permutation: BCD
                                +  prod3_r(gradB_y_r[i], gradB_y_i[i], gradD_x_r[i], gradD_x_i[i], gradC_y_r[i], gradC_y_i[i])// Permutation: BDC
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], gradB_x_r[i], gradB_x_i[i], gradD_y_r[i], gradD_y_i[i])// Permutation: CBD
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], gradD_x_r[i], gradD_x_i[i], gradB_y_r[i], gradB_y_i[i])// Permutation: CDB
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], gradB_x_r[i], gradB_x_i[i], gradC_y_r[i], gradC_y_i[i])// Permutation: DBC
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], gradC_x_r[i], gradC_x_i[i], gradB_y_r[i], gradB_y_i[i]);// Permutation: DCB

                    pi_YXZ_r[i] +=  prod3_r(gradB_y_r[i], gradB_y_i[i], gradC_x_r[i], gradC_x_i[i], gradD_z_r[i], gradD_z_i[i])// Permutation: BCD
                                +  prod3_r(gradB_y_r[i], gradB_y_i[i], gradD_x_r[i], gradD_x_i[i], gradC_z_r[i], gradC_z_i[i])// Permutation: BDC
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], gradB_x_r[i], gradB_x_i[i], gradD_z_r[i], gradD_z_i[i])// Permutation: CBD
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], gradD_x_r[i], gradD_x_i[i], gradB_z_r[i], gradB_z_i[i])// Permutation: CDB
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], gradB_x_r[i], gradB_x_i[i], gradC_z_r[i], gradC_z_i[i])// Permutation: DBC
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], gradC_x_r[i], gradC_x_i[i], gradB_z_r[i], gradB_z_i[i]);// Permutation: DCB

                    pi_YYX_r[i] +=  prod3_r(gradB_y_r[i], gradB_y_i[i], gradC_y_r[i], gradC_y_i[i], gradD_x_r[i], gradD_x_i[i])// Permutation: BCD
                                +  prod3_r(gradB_y_r[i], gradB_y_i[i], gradD_y_r[i], gradD_y_i[i], gradC_x_r[i], gradC_x_i[i])// Permutation: BDC
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], gradB_y_r[i], gradB_y_i[i], gradD_x_r[i], gradD_x_i[i])// Permutation: CBD
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], gradD_y_r[i], gradD_y_i[i], gradB_x_r[i], gradB_x_i[i])// Permutation: CDB
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], gradB_y_r[i], gradB_y_i[i], gradC_x_r[i], gradC_x_i[i])// Permutation: DBC
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], gradC_y_r[i], gradC_y_i[i], gradB_x_r[i], gradB_x_i[i]);// Permutation: DCB

                    pi_YYY_r[i] +=  prod3_r(gradB_y_r[i], gradB_y_i[i], gradC_y_r[i], gradC_y_i[i], gradD_y_r[i], gradD_y_i[i])// Permutation: BCD
                                +  prod3_r(gradB_y_r[i], gradB_y_i[i], gradD_y_r[i], gradD_y_i[i], gradC_y_r[i], gradC_y_i[i])// Permutation: BDC
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], gradB_y_r[i], gradB_y_i[i], gradD_y_r[i], gradD_y_i[i])// Permutation: CBD
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], gradD_y_r[i], gradD_y_i[i], gradB_y_r[i], gradB_y_i[i])// Permutation: CDB
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], gradB_y_r[i], gradB_y_i[i], gradC_y_r[i], gradC_y_i[i])// Permutation: DBC
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], gradC_y_r[i], gradC_y_i[i], gradB_y_r[i], gradB_y_i[i]);// Permutation: DCB

                    pi_YYZ_r[i] +=  prod3_r(gradB_y_r[i], gradB_y_i[i], gradC_y_r[i], gradC_y_i[i], gradD_z_r[i], gradD_z_i[i])// Permutation: BCD
                                +  prod3_r(gradB_y_r[i], gradB_y_i[i], gradD_y_r[i], gradD_y_i[i], gradC_z_r[i], gradC_z_i[i])// Permutation: BDC
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], gradB_y_r[i], gradB_y_i[i], gradD_z_r[i], gradD_z_i[i])// Permutation: CBD
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], gradD_y_r[i], gradD_y_i[i], gradB_z_r[i], gradB_z_i[i])// Permutation: CDB
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], gradB_y_r[i], gradB_y_i[i], gradC_z_r[i], gradC_z_i[i])// Permutation: DBC
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], gradC_y_r[i], gradC_y_i[i], gradB_z_r[i], gradB_z_i[i]);// Permutation: DCB

                    pi_YZX_r[i] +=  prod3_r(gradB_y_r[i], gradB_y_i[i], gradC_z_r[i], gradC_z_i[i], gradD_x_r[i], gradD_x_i[i])// Permutation: BCD
                                +  prod3_r(gradB_y_r[i], gradB_y_i[i], gradD_z_r[i], gradD_z_i[i], gradC_x_r[i], gradC_x_i[i])// Permutation: BDC
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], gradB_z_r[i], gradB_z_i[i], gradD_x_r[i], gradD_x_i[i])// Permutation: CBD
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], gradD_z_r[i], gradD_z_i[i], gradB_x_r[i], gradB_x_i[i])// Permutation: CDB
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], gradB_z_r[i], gradB_z_i[i], gradC_x_r[i], gradC_x_i[i])// Permutation: DBC
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], gradC_z_r[i], gradC_z_i[i], gradB_x_r[i], gradB_x_i[i]);// Permutation: DCB

                    pi_YZY_r[i] +=  prod3_r(gradB_y_r[i], gradB_y_i[i], gradC_z_r[i], gradC_z_i[i], gradD_y_r[i], gradD_y_i[i])// Permutation: BCD
                                +  prod3_r(gradB_y_r[i], gradB_y_i[i], gradD_z_r[i], gradD_z_i[i], gradC_y_r[i], gradC_y_i[i])// Permutation: BDC
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], gradB_z_r[i], gradB_z_i[i], gradD_y_r[i], gradD_y_i[i])// Permutation: CBD
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], gradD_z_r[i], gradD_z_i[i], gradB_y_r[i], gradB_y_i[i])// Permutation: CDB
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], gradB_z_r[i], gradB_z_i[i], gradC_y_r[i], gradC_y_i[i])// Permutation: DBC
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], gradC_z_r[i], gradC_z_i[i], gradB_y_r[i], gradB_y_i[i]);// Permutation: DCB

                    pi_YZZ_r[i] +=  prod3_r(gradB_y_r[i], gradB_y_i[i], gradC_z_r[i], gradC_z_i[i], gradD_z_r[i], gradD_z_i[i])// Permutation: BCD
                                +  prod3_r(gradB_y_r[i], gradB_y_i[i], gradD_z_r[i], gradD_z_i[i], gradC_z_r[i], gradC_z_i[i])// Permutation: BDC
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], gradB_z_r[i], gradB_z_i[i], gradD_z_r[i], gradD_z_i[i])// Permutation: CBD
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], gradD_z_r[i], gradD_z_i[i], gradB_z_r[i], gradB_z_i[i])// Permutation: CDB
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], gradB_z_r[i], gradB_z_i[i], gradC_z_r[i], gradC_z_i[i])// Permutation: DBC
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], gradC_z_r[i], gradC_z_i[i], gradB_z_r[i], gradB_z_i[i]);// Permutation: DCB

                    pi_ZXX_r[i] +=  prod3_r(gradB_z_r[i], gradB_z_i[i], gradC_x_r[i], gradC_x_i[i], gradD_x_r[i], gradD_x_i[i])// Permutation: BCD
                                +  prod3_r(gradB_z_r[i], gradB_z_i[i], gradD_x_r[i], gradD_x_i[i], gradC_x_r[i], gradC_x_i[i])// Permutation: BDC
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], gradB_x_r[i], gradB_x_i[i], gradD_x_r[i], gradD_x_i[i])// Permutation: CBD
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], gradD_x_r[i], gradD_x_i[i], gradB_x_r[i], gradB_x_i[i])// Permutation: CDB
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], gradB_x_r[i], gradB_x_i[i], gradC_x_r[i], gradC_x_i[i])// Permutation: DBC
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], gradC_x_r[i], gradC_x_i[i], gradB_x_r[i], gradB_x_i[i]);// Permutation: DCB

                    pi_ZXY_r[i] +=  prod3_r(gradB_z_r[i], gradB_z_i[i], gradC_x_r[i], gradC_x_i[i], gradD_y_r[i], gradD_y_i[i])// Permutation: BCD
                                +  prod3_r(gradB_z_r[i], gradB_z_i[i], gradD_x_r[i], gradD_x_i[i], gradC_y_r[i], gradC_y_i[i])// Permutation: BDC
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], gradB_x_r[i], gradB_x_i[i], gradD_y_r[i], gradD_y_i[i])// Permutation: CBD
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], gradD_x_r[i], gradD_x_i[i], gradB_y_r[i], gradB_y_i[i])// Permutation: CDB
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], gradB_x_r[i], gradB_x_i[i], gradC_y_r[i], gradC_y_i[i])// Permutation: DBC
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], gradC_x_r[i], gradC_x_i[i], gradB_y_r[i], gradB_y_i[i]);// Permutation: DCB

                    pi_ZXZ_r[i] +=  prod3_r(gradB_z_r[i], gradB_z_i[i], gradC_x_r[i], gradC_x_i[i], gradD_z_r[i], gradD_z_i[i])// Permutation: BCD
                                +  prod3_r(gradB_z_r[i], gradB_z_i[i], gradD_x_r[i], gradD_x_i[i], gradC_z_r[i], gradC_z_i[i])// Permutation: BDC
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], gradB_x_r[i], gradB_x_i[i], gradD_z_r[i], gradD_z_i[i])// Permutation: CBD
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], gradD_x_r[i], gradD_x_i[i], gradB_z_r[i], gradB_z_i[i])// Permutation: CDB
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], gradB_x_r[i], gradB_x_i[i], gradC_z_r[i], gradC_z_i[i])// Permutation: DBC
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], gradC_x_r[i], gradC_x_i[i], gradB_z_r[i], gradB_z_i[i]);// Permutation: DCB

                    pi_ZYX_r[i] +=  prod3_r(gradB_z_r[i], gradB_z_i[i], gradC_y_r[i], gradC_y_i[i], gradD_x_r[i], gradD_x_i[i])// Permutation: BCD
                                +  prod3_r(gradB_z_r[i], gradB_z_i[i], gradD_y_r[i], gradD_y_i[i], gradC_x_r[i], gradC_x_i[i])// Permutation: BDC
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], gradB_y_r[i], gradB_y_i[i], gradD_x_r[i], gradD_x_i[i])// Permutation: CBD
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], gradD_y_r[i], gradD_y_i[i], gradB_x_r[i], gradB_x_i[i])// Permutation: CDB
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], gradB_y_r[i], gradB_y_i[i], gradC_x_r[i], gradC_x_i[i])// Permutation: DBC
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], gradC_y_r[i], gradC_y_i[i], gradB_x_r[i], gradB_x_i[i]);// Permutation: DCB

                    pi_ZYY_r[i] +=  prod3_r(gradB_z_r[i], gradB_z_i[i], gradC_y_r[i], gradC_y_i[i], gradD_y_r[i], gradD_y_i[i])// Permutation: BCD
                                +  prod3_r(gradB_z_r[i], gradB_z_i[i], gradD_y_r[i], gradD_y_i[i], gradC_y_r[i], gradC_y_i[i])// Permutation: BDC
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], gradB_y_r[i], gradB_y_i[i], gradD_y_r[i], gradD_y_i[i])// Permutation: CBD
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], gradD_y_r[i], gradD_y_i[i], gradB_y_r[i], gradB_y_i[i])// Permutation: CDB
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], gradB_y_r[i], gradB_y_i[i], gradC_y_r[i], gradC_y_i[i])// Permutation: DBC
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], gradC_y_r[i], gradC_y_i[i], gradB_y_r[i], gradB_y_i[i]);// Permutation: DCB

                    pi_ZYZ_r[i] +=  prod3_r(gradB_z_r[i], gradB_z_i[i], gradC_y_r[i], gradC_y_i[i], gradD_z_r[i], gradD_z_i[i])// Permutation: BCD
                                +  prod3_r(gradB_z_r[i], gradB_z_i[i], gradD_y_r[i], gradD_y_i[i], gradC_z_r[i], gradC_z_i[i])// Permutation: BDC
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], gradB_y_r[i], gradB_y_i[i], gradD_z_r[i], gradD_z_i[i])// Permutation: CBD
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], gradD_y_r[i], gradD_y_i[i], gradB_z_r[i], gradB_z_i[i])// Permutation: CDB
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], gradB_y_r[i], gradB_y_i[i], gradC_z_r[i], gradC_z_i[i])// Permutation: DBC
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], gradC_y_r[i], gradC_y_i[i], gradB_z_r[i], gradB_z_i[i]);// Permutation: DCB

                    pi_ZZX_r[i] +=  prod3_r(gradB_z_r[i], gradB_z_i[i], gradC_z_r[i], gradC_z_i[i], gradD_x_r[i], gradD_x_i[i])// Permutation: BCD
                                +  prod3_r(gradB_z_r[i], gradB_z_i[i], gradD_z_r[i], gradD_z_i[i], gradC_x_r[i], gradC_x_i[i])// Permutation: BDC
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], gradB_z_r[i], gradB_z_i[i], gradD_x_r[i], gradD_x_i[i])// Permutation: CBD
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], gradD_z_r[i], gradD_z_i[i], gradB_x_r[i], gradB_x_i[i])// Permutation: CDB
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], gradB_z_r[i], gradB_z_i[i], gradC_x_r[i], gradC_x_i[i])// Permutation: DBC
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], gradC_z_r[i], gradC_z_i[i], gradB_x_r[i], gradB_x_i[i]);// Permutation: DCB

                    pi_ZZY_r[i] +=  prod3_r(gradB_z_r[i], gradB_z_i[i], gradC_z_r[i], gradC_z_i[i], gradD_y_r[i], gradD_y_i[i])// Permutation: BCD
                                +  prod3_r(gradB_z_r[i], gradB_z_i[i], gradD_z_r[i], gradD_z_i[i], gradC_y_r[i], gradC_y_i[i])// Permutation: BDC
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], gradB_z_r[i], gradB_z_i[i], gradD_y_r[i], gradD_y_i[i])// Permutation: CBD
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], gradD_z_r[i], gradD_z_i[i], gradB_y_r[i], gradB_y_i[i])// Permutation: CDB
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], gradB_z_r[i], gradB_z_i[i], gradC_y_r[i], gradC_y_i[i])// Permutation: DBC
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], gradC_z_r[i], gradC_z_i[i], gradB_y_r[i], gradB_y_i[i]);// Permutation: DCB

                    pi_ZZZ_r[i] +=  prod3_r(gradB_z_r[i], gradB_z_i[i], gradC_z_r[i], gradC_z_i[i], gradD_z_r[i], gradD_z_i[i])// Permutation: BCD
                                +  prod3_r(gradB_z_r[i], gradB_z_i[i], gradD_z_r[i], gradD_z_i[i], gradC_z_r[i], gradC_z_i[i])// Permutation: BDC
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], gradB_z_r[i], gradB_z_i[i], gradD_z_r[i], gradD_z_i[i])// Permutation: CBD
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], gradD_z_r[i], gradD_z_i[i], gradB_z_r[i], gradB_z_i[i])// Permutation: CDB
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], gradB_z_r[i], gradB_z_i[i], gradC_z_r[i], gradC_z_i[i])// Permutation: DBC
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], gradC_z_r[i], gradC_z_i[i], gradB_z_r[i], gradB_z_i[i]);// Permutation: DCB


                    pi_X_r[i] +=  prod3_r(gradB_x_r[i], gradB_x_i[i], rhoC_r[i], rhoC_i[i], rhoD_r[i], rhoD_i[i])// Permutation: BCD
                            +  prod3_r(rhoB_r[i], rhoB_i[i], gradC_x_r[i], gradC_x_i[i], rhoD_r[i], rhoD_i[i])
                            +  prod3_r(rhoB_r[i], rhoB_i[i], rhoC_r[i], rhoC_i[i], gradD_x_r[i], gradD_x_i[i])
                            +  prod3_r(gradB_x_r[i], gradB_x_i[i], rhoD_r[i], rhoD_i[i], rhoC_r[i], rhoC_i[i])// Permutation: BDC
                            +  prod3_r(rhoB_r[i], rhoB_i[i], gradD_x_r[i], gradD_x_i[i], rhoC_r[i], rhoC_i[i])
                            +  prod3_r(rhoB_r[i], rhoB_i[i], rhoD_r[i], rhoD_i[i], gradC_x_r[i], gradC_x_i[i])
                            +  prod3_r(gradC_x_r[i], gradC_x_i[i], rhoB_r[i], rhoB_i[i], rhoD_r[i], rhoD_i[i])// Permutation: CBD
                            +  prod3_r(rhoC_r[i], rhoC_i[i], gradB_x_r[i], gradB_x_i[i], rhoD_r[i], rhoD_i[i])
                            +  prod3_r(rhoC_r[i], rhoC_i[i], rhoB_r[i], rhoB_i[i], gradD_x_r[i], gradD_x_i[i])
                            +  prod3_r(gradC_x_r[i], gradC_x_i[i], rhoD_r[i], rhoD_i[i], rhoB_r[i], rhoB_i[i])// Permutation: CDB
                            +  prod3_r(rhoC_r[i], rhoC_i[i], gradD_x_r[i], gradD_x_i[i], rhoB_r[i], rhoB_i[i])
                            +  prod3_r(rhoC_r[i], rhoC_i[i], rhoD_r[i], rhoD_i[i], gradB_x_r[i], gradB_x_i[i])
                            +  prod3_r(gradD_x_r[i], gradD_x_i[i], rhoB_r[i], rhoB_i[i], rhoC_r[i], rhoC_i[i])// Permutation: DBC
                            +  prod3_r(rhoD_r[i], rhoD_i[i], gradB_x_r[i], gradB_x_i[i], rhoC_r[i], rhoC_i[i])
                            +  prod3_r(rhoD_r[i], rhoD_i[i], rhoB_r[i], rhoB_i[i], gradC_x_r[i], gradC_x_i[i])
                            +  prod3_r(gradD_x_r[i], gradD_x_i[i], rhoC_r[i], rhoC_i[i], rhoB_r[i], rhoB_i[i])// Permutation: DCB
                            +  prod3_r(rhoD_r[i], rhoD_i[i], gradC_x_r[i], gradC_x_i[i], rhoB_r[i], rhoB_i[i])
                            +  prod3_r(rhoD_r[i], rhoD_i[i], rhoC_r[i], rhoC_i[i], gradB_x_r[i], gradB_x_i[i]);

                    pi_Y_r[i] +=  prod3_r(gradB_y_r[i], gradB_y_i[i], rhoC_r[i], rhoC_i[i], rhoD_r[i], rhoD_i[i])// Permutation: BCD
                                +  prod3_r(rhoB_r[i], rhoB_i[i], gradC_y_r[i], gradC_y_i[i], rhoD_r[i], rhoD_i[i])
                                +  prod3_r(rhoB_r[i], rhoB_i[i], rhoC_r[i], rhoC_i[i], gradD_y_r[i], gradD_y_i[i])
                                +  prod3_r(gradB_y_r[i], gradB_y_i[i], rhoD_r[i], rhoD_i[i], rhoC_r[i], rhoC_i[i])// Permutation: BDC
                                +  prod3_r(rhoB_r[i], rhoB_i[i], gradD_y_r[i], gradD_y_i[i], rhoC_r[i], rhoC_i[i])
                                +  prod3_r(rhoB_r[i], rhoB_i[i], rhoD_r[i], rhoD_i[i], gradC_y_r[i], gradC_y_i[i])
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], rhoB_r[i], rhoB_i[i], rhoD_r[i], rhoD_i[i])// Permutation: CBD
                                +  prod3_r(rhoC_r[i], rhoC_i[i], gradB_y_r[i], gradB_y_i[i], rhoD_r[i], rhoD_i[i])
                                +  prod3_r(rhoC_r[i], rhoC_i[i], rhoB_r[i], rhoB_i[i], gradD_y_r[i], gradD_y_i[i])
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], rhoD_r[i], rhoD_i[i], rhoB_r[i], rhoB_i[i])// Permutation: CDB
                                +  prod3_r(rhoC_r[i], rhoC_i[i], gradD_y_r[i], gradD_y_i[i], rhoB_r[i], rhoB_i[i])
                                +  prod3_r(rhoC_r[i], rhoC_i[i], rhoD_r[i], rhoD_i[i], gradB_y_r[i], gradB_y_i[i])
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], rhoB_r[i], rhoB_i[i], rhoC_r[i], rhoC_i[i])// Permutation: DBC
                                +  prod3_r(rhoD_r[i], rhoD_i[i], gradB_y_r[i], gradB_y_i[i], rhoC_r[i], rhoC_i[i])
                                +  prod3_r(rhoD_r[i], rhoD_i[i], rhoB_r[i], rhoB_i[i], gradC_y_r[i], gradC_y_i[i])
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], rhoC_r[i], rhoC_i[i], rhoB_r[i], rhoB_i[i])// Permutation: DCB
                                +  prod3_r(rhoD_r[i], rhoD_i[i], gradC_y_r[i], gradC_y_i[i], rhoB_r[i], rhoB_i[i])
                                +  prod3_r(rhoD_r[i], rhoD_i[i], rhoC_r[i], rhoC_i[i], gradB_y_r[i], gradB_y_i[i]);

                    pi_Z_r[i] +=  prod3_r(gradB_z_r[i], gradB_z_i[i], rhoC_r[i], rhoC_i[i], rhoD_r[i], rhoD_i[i])// Permutation: BCD
                                +  prod3_r(rhoB_r[i], rhoB_i[i], gradC_z_r[i], gradC_z_i[i], rhoD_r[i], rhoD_i[i])
                                +  prod3_r(rhoB_r[i], rhoB_i[i], rhoC_r[i], rhoC_i[i], gradD_z_r[i], gradD_z_i[i])
                                +  prod3_r(gradB_z_r[i], gradB_z_i[i], rhoD_r[i], rhoD_i[i], rhoC_r[i], rhoC_i[i])// Permutation: BDC
                                +  prod3_r(rhoB_r[i], rhoB_i[i], gradD_z_r[i], gradD_z_i[i], rhoC_r[i], rhoC_i[i])
                                +  prod3_r(rhoB_r[i], rhoB_i[i], rhoD_r[i], rhoD_i[i], gradC_z_r[i], gradC_z_i[i])
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], rhoB_r[i], rhoB_i[i], rhoD_r[i], rhoD_i[i])// Permutation: CBD
                                +  prod3_r(rhoC_r[i], rhoC_i[i], gradB_z_r[i], gradB_z_i[i], rhoD_r[i], rhoD_i[i])
                                +  prod3_r(rhoC_r[i], rhoC_i[i], rhoB_r[i], rhoB_i[i], gradD_z_r[i], gradD_z_i[i])
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], rhoD_r[i], rhoD_i[i], rhoB_r[i], rhoB_i[i])// Permutation: CDB
                                +  prod3_r(rhoC_r[i], rhoC_i[i], gradD_z_r[i], gradD_z_i[i], rhoB_r[i], rhoB_i[i])
                                +  prod3_r(rhoC_r[i], rhoC_i[i], rhoD_r[i], rhoD_i[i], gradB_z_r[i], gradB_z_i[i])
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], rhoB_r[i], rhoB_i[i], rhoC_r[i], rhoC_i[i])// Permutation: DBC
                                +  prod3_r(rhoD_r[i], rhoD_i[i], gradB_z_r[i], gradB_z_i[i], rhoC_r[i], rhoC_i[i])
                                +  prod3_r(rhoD_r[i], rhoD_i[i], rhoB_r[i], rhoB_i[i], gradC_z_r[i], gradC_z_i[i])
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], rhoC_r[i], rhoC_i[i], rhoB_r[i], rhoB_i[i])// Permutation: DCB
                                +  prod3_r(rhoD_r[i], rhoD_i[i], gradC_z_r[i], gradC_z_i[i], rhoB_r[i], rhoB_i[i])
                                +  prod3_r(rhoD_r[i], rhoD_i[i], rhoC_r[i], rhoC_i[i], gradB_z_r[i], gradB_z_i[i]);


                    pi_XX_r[i] +=  prod3_r(gradB_x_r[i], gradB_x_i[i], gradC_x_r[i], gradC_x_i[i], rhoD_r[i], rhoD_i[i])// Permutation: BCD
                                +  prod3_r(rhoB_r[i], rhoB_i[i], gradC_x_r[i], gradC_x_i[i], gradD_x_r[i], gradD_x_i[i])
                                +  prod3_r(gradB_x_r[i], gradB_x_i[i], rhoC_r[i], rhoC_i[i], gradD_x_r[i], gradD_x_i[i])
                                +  prod3_r(gradB_x_r[i], gradB_x_i[i], gradD_x_r[i], gradD_x_i[i], rhoC_r[i], rhoC_i[i])// Permutation: BDC
                                +  prod3_r(rhoB_r[i], rhoB_i[i], gradD_x_r[i], gradD_x_i[i], gradC_x_r[i], gradC_x_i[i])
                                +  prod3_r(gradB_x_r[i], gradB_x_i[i], rhoD_r[i], rhoD_i[i], gradC_x_r[i], gradC_x_i[i])
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], gradB_x_r[i], gradB_x_i[i], rhoD_r[i], rhoD_i[i])// Permutation: CBD
                                +  prod3_r(rhoC_r[i], rhoC_i[i], gradB_x_r[i], gradB_x_i[i], gradD_x_r[i], gradD_x_i[i])
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], rhoB_r[i], rhoB_i[i], gradD_x_r[i], gradD_x_i[i])
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], gradD_x_r[i], gradD_x_i[i], rhoB_r[i], rhoB_i[i])// Permutation: CDB
                                +  prod3_r(rhoC_r[i], rhoC_i[i], gradD_x_r[i], gradD_x_i[i], gradB_x_r[i], gradB_x_i[i])
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], rhoD_r[i], rhoD_i[i], gradB_x_r[i], gradB_x_i[i])
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], gradB_x_r[i], gradB_x_i[i], rhoC_r[i], rhoC_i[i])// Permutation: DBC
                                +  prod3_r(rhoD_r[i], rhoD_i[i], gradB_x_r[i], gradB_x_i[i], gradC_x_r[i], gradC_x_i[i])
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], rhoB_r[i], rhoB_i[i], gradC_x_r[i], gradC_x_i[i])
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], gradC_x_r[i], gradC_x_i[i], rhoB_r[i], rhoB_i[i])// Permutation: DCB
                                +  prod3_r(rhoD_r[i], rhoD_i[i], gradC_x_r[i], gradC_x_i[i], gradB_x_r[i], gradB_x_i[i])
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], rhoC_r[i], rhoC_i[i], gradB_x_r[i], gradB_x_i[i]);

                    pi_XY_r[i] +=  prod3_r(gradB_x_r[i], gradB_x_i[i], gradC_y_r[i], gradC_y_i[i], rhoD_r[i], rhoD_i[i])// Permutation: BCD
                                +  prod3_r(rhoB_r[i], rhoB_i[i], gradC_x_r[i], gradC_x_i[i], gradD_y_r[i], gradD_y_i[i])
                                +  prod3_r(gradB_x_r[i], gradB_x_i[i], rhoC_r[i], rhoC_i[i], gradD_y_r[i], gradD_y_i[i])
                                +  prod3_r(gradB_x_r[i], gradB_x_i[i], gradD_y_r[i], gradD_y_i[i], rhoC_r[i], rhoC_i[i])// Permutation: BDC
                                +  prod3_r(rhoB_r[i], rhoB_i[i], gradD_x_r[i], gradD_x_i[i], gradC_y_r[i], gradC_y_i[i])
                                +  prod3_r(gradB_x_r[i], gradB_x_i[i], rhoD_r[i], rhoD_i[i], gradC_y_r[i], gradC_y_i[i])
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], gradB_y_r[i], gradB_y_i[i], rhoD_r[i], rhoD_i[i])// Permutation: CBD
                                +  prod3_r(rhoC_r[i], rhoC_i[i], gradB_x_r[i], gradB_x_i[i], gradD_y_r[i], gradD_y_i[i])
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], rhoB_r[i], rhoB_i[i], gradD_y_r[i], gradD_y_i[i])
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], gradD_y_r[i], gradD_y_i[i], rhoB_r[i], rhoB_i[i])// Permutation: CDB
                                +  prod3_r(rhoC_r[i], rhoC_i[i], gradD_x_r[i], gradD_x_i[i], gradB_y_r[i], gradB_y_i[i])
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], rhoD_r[i], rhoD_i[i], gradB_y_r[i], gradB_y_i[i])
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], gradB_y_r[i], gradB_y_i[i], rhoC_r[i], rhoC_i[i])// Permutation: DBC
                                +  prod3_r(rhoD_r[i], rhoD_i[i], gradB_x_r[i], gradB_x_i[i], gradC_y_r[i], gradC_y_i[i])
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], rhoB_r[i], rhoB_i[i], gradC_y_r[i], gradC_y_i[i])
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], gradC_y_r[i], gradC_y_i[i], rhoB_r[i], rhoB_i[i])// Permutation: DCB
                                +  prod3_r(rhoD_r[i], rhoD_i[i], gradC_x_r[i], gradC_x_i[i], gradB_y_r[i], gradB_y_i[i])
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], rhoC_r[i], rhoC_i[i], gradB_y_r[i], gradB_y_i[i]);

                    pi_XZ_r[i] +=  prod3_r(gradB_x_r[i], gradB_x_i[i], gradC_z_r[i], gradC_z_i[i], rhoD_r[i], rhoD_i[i])// Permutation: BCD
                                +  prod3_r(rhoB_r[i], rhoB_i[i], gradC_x_r[i], gradC_x_i[i], gradD_z_r[i], gradD_z_i[i])
                                +  prod3_r(gradB_x_r[i], gradB_x_i[i], rhoC_r[i], rhoC_i[i], gradD_z_r[i], gradD_z_i[i])
                                +  prod3_r(gradB_x_r[i], gradB_x_i[i], gradD_z_r[i], gradD_z_i[i], rhoC_r[i], rhoC_i[i])// Permutation: BDC
                                +  prod3_r(rhoB_r[i], rhoB_i[i], gradD_x_r[i], gradD_x_i[i], gradC_z_r[i], gradC_z_i[i])
                                +  prod3_r(gradB_x_r[i], gradB_x_i[i], rhoD_r[i], rhoD_i[i], gradC_z_r[i], gradC_z_i[i])
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], gradB_z_r[i], gradB_z_i[i], rhoD_r[i], rhoD_i[i])// Permutation: CBD
                                +  prod3_r(rhoC_r[i], rhoC_i[i], gradB_x_r[i], gradB_x_i[i], gradD_z_r[i], gradD_z_i[i])
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], rhoB_r[i], rhoB_i[i], gradD_z_r[i], gradD_z_i[i])
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], gradD_z_r[i], gradD_z_i[i], rhoB_r[i], rhoB_i[i])// Permutation: CDB
                                +  prod3_r(rhoC_r[i], rhoC_i[i], gradD_x_r[i], gradD_x_i[i], gradB_z_r[i], gradB_z_i[i])
                                +  prod3_r(gradC_x_r[i], gradC_x_i[i], rhoD_r[i], rhoD_i[i], gradB_z_r[i], gradB_z_i[i])
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], gradB_z_r[i], gradB_z_i[i], rhoC_r[i], rhoC_i[i])// Permutation: DBC
                                +  prod3_r(rhoD_r[i], rhoD_i[i], gradB_x_r[i], gradB_x_i[i], gradC_z_r[i], gradC_z_i[i])
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], rhoB_r[i], rhoB_i[i], gradC_z_r[i], gradC_z_i[i])
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], gradC_z_r[i], gradC_z_i[i], rhoB_r[i], rhoB_i[i])// Permutation: DCB
                                +  prod3_r(rhoD_r[i], rhoD_i[i], gradC_x_r[i], gradC_x_i[i], gradB_z_r[i], gradB_z_i[i])
                                +  prod3_r(gradD_x_r[i], gradD_x_i[i], rhoC_r[i], rhoC_i[i], gradB_z_r[i], gradB_z_i[i]);

                    pi_YX_r[i] +=  prod3_r(gradB_y_r[i], gradB_y_i[i], gradC_x_r[i], gradC_x_i[i], rhoD_r[i], rhoD_i[i])// Permutation: BCD
                                +  prod3_r(rhoB_r[i], rhoB_i[i], gradC_y_r[i], gradC_y_i[i], gradD_x_r[i], gradD_x_i[i])
                                +  prod3_r(gradB_y_r[i], gradB_y_i[i], rhoC_r[i], rhoC_i[i], gradD_x_r[i], gradD_x_i[i])
                                +  prod3_r(gradB_y_r[i], gradB_y_i[i], gradD_x_r[i], gradD_x_i[i], rhoC_r[i], rhoC_i[i])// Permutation: BDC
                                +  prod3_r(rhoB_r[i], rhoB_i[i], gradD_y_r[i], gradD_y_i[i], gradC_x_r[i], gradC_x_i[i])
                                +  prod3_r(gradB_y_r[i], gradB_y_i[i], rhoD_r[i], rhoD_i[i], gradC_x_r[i], gradC_x_i[i])
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], gradB_x_r[i], gradB_x_i[i], rhoD_r[i], rhoD_i[i])// Permutation: CBD
                                +  prod3_r(rhoC_r[i], rhoC_i[i], gradB_y_r[i], gradB_y_i[i], gradD_x_r[i], gradD_x_i[i])
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], rhoB_r[i], rhoB_i[i], gradD_x_r[i], gradD_x_i[i])
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], gradD_x_r[i], gradD_x_i[i], rhoB_r[i], rhoB_i[i])// Permutation: CDB
                                +  prod3_r(rhoC_r[i], rhoC_i[i], gradD_y_r[i], gradD_y_i[i], gradB_x_r[i], gradB_x_i[i])
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], rhoD_r[i], rhoD_i[i], gradB_x_r[i], gradB_x_i[i])
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], gradB_x_r[i], gradB_x_i[i], rhoC_r[i], rhoC_i[i])// Permutation: DBC
                                +  prod3_r(rhoD_r[i], rhoD_i[i], gradB_y_r[i], gradB_y_i[i], gradC_x_r[i], gradC_x_i[i])
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], rhoB_r[i], rhoB_i[i], gradC_x_r[i], gradC_x_i[i])
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], gradC_x_r[i], gradC_x_i[i], rhoB_r[i], rhoB_i[i])// Permutation: DCB
                                +  prod3_r(rhoD_r[i], rhoD_i[i], gradC_y_r[i], gradC_y_i[i], gradB_x_r[i], gradB_x_i[i])
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], rhoC_r[i], rhoC_i[i], gradB_x_r[i], gradB_x_i[i]);

                    pi_YY_r[i] +=  prod3_r(gradB_y_r[i], gradB_y_i[i], gradC_y_r[i], gradC_y_i[i], rhoD_r[i], rhoD_i[i])// Permutation: BCD
                                +  prod3_r(rhoB_r[i], rhoB_i[i], gradC_y_r[i], gradC_y_i[i], gradD_y_r[i], gradD_y_i[i])
                                +  prod3_r(gradB_y_r[i], gradB_y_i[i], rhoC_r[i], rhoC_i[i], gradD_y_r[i], gradD_y_i[i])
                                +  prod3_r(gradB_y_r[i], gradB_y_i[i], gradD_y_r[i], gradD_y_i[i], rhoC_r[i], rhoC_i[i])// Permutation: BDC
                                +  prod3_r(rhoB_r[i], rhoB_i[i], gradD_y_r[i], gradD_y_i[i], gradC_y_r[i], gradC_y_i[i])
                                +  prod3_r(gradB_y_r[i], gradB_y_i[i], rhoD_r[i], rhoD_i[i], gradC_y_r[i], gradC_y_i[i])
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], gradB_y_r[i], gradB_y_i[i], rhoD_r[i], rhoD_i[i])// Permutation: CBD
                                +  prod3_r(rhoC_r[i], rhoC_i[i], gradB_y_r[i], gradB_y_i[i], gradD_y_r[i], gradD_y_i[i])
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], rhoB_r[i], rhoB_i[i], gradD_y_r[i], gradD_y_i[i])
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], gradD_y_r[i], gradD_y_i[i], rhoB_r[i], rhoB_i[i])// Permutation: CDB
                                +  prod3_r(rhoC_r[i], rhoC_i[i], gradD_y_r[i], gradD_y_i[i], gradB_y_r[i], gradB_y_i[i])
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], rhoD_r[i], rhoD_i[i], gradB_y_r[i], gradB_y_i[i])
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], gradB_y_r[i], gradB_y_i[i], rhoC_r[i], rhoC_i[i])// Permutation: DBC
                                +  prod3_r(rhoD_r[i], rhoD_i[i], gradB_y_r[i], gradB_y_i[i], gradC_y_r[i], gradC_y_i[i])
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], rhoB_r[i], rhoB_i[i], gradC_y_r[i], gradC_y_i[i])
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], gradC_y_r[i], gradC_y_i[i], rhoB_r[i], rhoB_i[i])// Permutation: DCB
                                +  prod3_r(rhoD_r[i], rhoD_i[i], gradC_y_r[i], gradC_y_i[i], gradB_y_r[i], gradB_y_i[i])
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], rhoC_r[i], rhoC_i[i], gradB_y_r[i], gradB_y_i[i]);

                    pi_YZ_r[i] +=  prod3_r(gradB_y_r[i], gradB_y_i[i], gradC_z_r[i], gradC_z_i[i], rhoD_r[i], rhoD_i[i])// Permutation: BCD
                                +  prod3_r(rhoB_r[i], rhoB_i[i], gradC_y_r[i], gradC_y_i[i], gradD_z_r[i], gradD_z_i[i])
                                +  prod3_r(gradB_y_r[i], gradB_y_i[i], rhoC_r[i], rhoC_i[i], gradD_z_r[i], gradD_z_i[i])
                                +  prod3_r(gradB_y_r[i], gradB_y_i[i], gradD_z_r[i], gradD_z_i[i], rhoC_r[i], rhoC_i[i])// Permutation: BDC
                                +  prod3_r(rhoB_r[i], rhoB_i[i], gradD_y_r[i], gradD_y_i[i], gradC_z_r[i], gradC_z_i[i])
                                +  prod3_r(gradB_y_r[i], gradB_y_i[i], rhoD_r[i], rhoD_i[i], gradC_z_r[i], gradC_z_i[i])
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], gradB_z_r[i], gradB_z_i[i], rhoD_r[i], rhoD_i[i])// Permutation: CBD
                                +  prod3_r(rhoC_r[i], rhoC_i[i], gradB_y_r[i], gradB_y_i[i], gradD_z_r[i], gradD_z_i[i])
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], rhoB_r[i], rhoB_i[i], gradD_z_r[i], gradD_z_i[i])
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], gradD_z_r[i], gradD_z_i[i], rhoB_r[i], rhoB_i[i])// Permutation: CDB
                                +  prod3_r(rhoC_r[i], rhoC_i[i], gradD_y_r[i], gradD_y_i[i], gradB_z_r[i], gradB_z_i[i])
                                +  prod3_r(gradC_y_r[i], gradC_y_i[i], rhoD_r[i], rhoD_i[i], gradB_z_r[i], gradB_z_i[i])
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], gradB_z_r[i], gradB_z_i[i], rhoC_r[i], rhoC_i[i])// Permutation: DBC
                                +  prod3_r(rhoD_r[i], rhoD_i[i], gradB_y_r[i], gradB_y_i[i], gradC_z_r[i], gradC_z_i[i])
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], rhoB_r[i], rhoB_i[i], gradC_z_r[i], gradC_z_i[i])
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], gradC_z_r[i], gradC_z_i[i], rhoB_r[i], rhoB_i[i])// Permutation: DCB
                                +  prod3_r(rhoD_r[i], rhoD_i[i], gradC_y_r[i], gradC_y_i[i], gradB_z_r[i], gradB_z_i[i])
                                +  prod3_r(gradD_y_r[i], gradD_y_i[i], rhoC_r[i], rhoC_i[i], gradB_z_r[i], gradB_z_i[i]);

                    pi_ZX_r[i] +=  prod3_r(gradB_z_r[i], gradB_z_i[i], gradC_x_r[i], gradC_x_i[i], rhoD_r[i], rhoD_i[i])// Permutation: BCD
                                +  prod3_r(rhoB_r[i], rhoB_i[i], gradC_z_r[i], gradC_z_i[i], gradD_x_r[i], gradD_x_i[i])
                                +  prod3_r(gradB_z_r[i], gradB_z_i[i], rhoC_r[i], rhoC_i[i], gradD_x_r[i], gradD_x_i[i])
                                +  prod3_r(gradB_z_r[i], gradB_z_i[i], gradD_x_r[i], gradD_x_i[i], rhoC_r[i], rhoC_i[i])// Permutation: BDC
                                +  prod3_r(rhoB_r[i], rhoB_i[i], gradD_z_r[i], gradD_z_i[i], gradC_x_r[i], gradC_x_i[i])
                                +  prod3_r(gradB_z_r[i], gradB_z_i[i], rhoD_r[i], rhoD_i[i], gradC_x_r[i], gradC_x_i[i])
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], gradB_x_r[i], gradB_x_i[i], rhoD_r[i], rhoD_i[i])// Permutation: CBD
                                +  prod3_r(rhoC_r[i], rhoC_i[i], gradB_z_r[i], gradB_z_i[i], gradD_x_r[i], gradD_x_i[i])
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], rhoB_r[i], rhoB_i[i], gradD_x_r[i], gradD_x_i[i])
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], gradD_x_r[i], gradD_x_i[i], rhoB_r[i], rhoB_i[i])// Permutation: CDB
                                +  prod3_r(rhoC_r[i], rhoC_i[i], gradD_z_r[i], gradD_z_i[i], gradB_x_r[i], gradB_x_i[i])
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], rhoD_r[i], rhoD_i[i], gradB_x_r[i], gradB_x_i[i])
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], gradB_x_r[i], gradB_x_i[i], rhoC_r[i], rhoC_i[i])// Permutation: DBC
                                +  prod3_r(rhoD_r[i], rhoD_i[i], gradB_z_r[i], gradB_z_i[i], gradC_x_r[i], gradC_x_i[i])
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], rhoB_r[i], rhoB_i[i], gradC_x_r[i], gradC_x_i[i])
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], gradC_x_r[i], gradC_x_i[i], rhoB_r[i], rhoB_i[i])// Permutation: DCB
                                +  prod3_r(rhoD_r[i], rhoD_i[i], gradC_z_r[i], gradC_z_i[i], gradB_x_r[i], gradB_x_i[i])
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], rhoC_r[i], rhoC_i[i], gradB_x_r[i], gradB_x_i[i]);

                    pi_ZY_r[i] +=  prod3_r(gradB_z_r[i], gradB_z_i[i], gradC_y_r[i], gradC_y_i[i], rhoD_r[i], rhoD_i[i])// Permutation: BCD
                                +  prod3_r(rhoB_r[i], rhoB_i[i], gradC_z_r[i], gradC_z_i[i], gradD_y_r[i], gradD_y_i[i])
                                +  prod3_r(gradB_z_r[i], gradB_z_i[i], rhoC_r[i], rhoC_i[i], gradD_y_r[i], gradD_y_i[i])
                                +  prod3_r(gradB_z_r[i], gradB_z_i[i], gradD_y_r[i], gradD_y_i[i], rhoC_r[i], rhoC_i[i])// Permutation: BDC
                                +  prod3_r(rhoB_r[i], rhoB_i[i], gradD_z_r[i], gradD_z_i[i], gradC_y_r[i], gradC_y_i[i])
                                +  prod3_r(gradB_z_r[i], gradB_z_i[i], rhoD_r[i], rhoD_i[i], gradC_y_r[i], gradC_y_i[i])
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], gradB_y_r[i], gradB_y_i[i], rhoD_r[i], rhoD_i[i])// Permutation: CBD
                                +  prod3_r(rhoC_r[i], rhoC_i[i], gradB_z_r[i], gradB_z_i[i], gradD_y_r[i], gradD_y_i[i])
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], rhoB_r[i], rhoB_i[i], gradD_y_r[i], gradD_y_i[i])
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], gradD_y_r[i], gradD_y_i[i], rhoB_r[i], rhoB_i[i])// Permutation: CDB
                                +  prod3_r(rhoC_r[i], rhoC_i[i], gradD_z_r[i], gradD_z_i[i], gradB_y_r[i], gradB_y_i[i])
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], rhoD_r[i], rhoD_i[i], gradB_y_r[i], gradB_y_i[i])
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], gradB_y_r[i], gradB_y_i[i], rhoC_r[i], rhoC_i[i])// Permutation: DBC
                                +  prod3_r(rhoD_r[i], rhoD_i[i], gradB_z_r[i], gradB_z_i[i], gradC_y_r[i], gradC_y_i[i])
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], rhoB_r[i], rhoB_i[i], gradC_y_r[i], gradC_y_i[i])
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], gradC_y_r[i], gradC_y_i[i], rhoB_r[i], rhoB_i[i])// Permutation: DCB
                                +  prod3_r(rhoD_r[i], rhoD_i[i], gradC_z_r[i], gradC_z_i[i], gradB_y_r[i], gradB_y_i[i])
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], rhoC_r[i], rhoC_i[i], gradB_y_r[i], gradB_y_i[i]);

                    pi_ZZ_r[i] +=  prod3_r(gradB_z_r[i], gradB_z_i[i], gradC_z_r[i], gradC_z_i[i], rhoD_r[i], rhoD_i[i])// Permutation: BCD
                                +  prod3_r(rhoB_r[i], rhoB_i[i], gradC_z_r[i], gradC_z_i[i], gradD_z_r[i], gradD_z_i[i])
                                +  prod3_r(gradB_z_r[i], gradB_z_i[i], rhoC_r[i], rhoC_i[i], gradD_z_r[i], gradD_z_i[i])
                                +  prod3_r(gradB_z_r[i], gradB_z_i[i], gradD_z_r[i], gradD_z_i[i], rhoC_r[i], rhoC_i[i])// Permutation: BDC
                                +  prod3_r(rhoB_r[i], rhoB_i[i], gradD_z_r[i], gradD_z_i[i], gradC_z_r[i], gradC_z_i[i])
                                +  prod3_r(gradB_z_r[i], gradB_z_i[i], rhoD_r[i], rhoD_i[i], gradC_z_r[i], gradC_z_i[i])
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], gradB_z_r[i], gradB_z_i[i], rhoD_r[i], rhoD_i[i])// Permutation: CBD
                                +  prod3_r(rhoC_r[i], rhoC_i[i], gradB_z_r[i], gradB_z_i[i], gradD_z_r[i], gradD_z_i[i])
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], rhoB_r[i], rhoB_i[i], gradD_z_r[i], gradD_z_i[i])
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], gradD_z_r[i], gradD_z_i[i], rhoB_r[i], rhoB_i[i])// Permutation: CDB
                                +  prod3_r(rhoC_r[i], rhoC_i[i], gradD_z_r[i], gradD_z_i[i], gradB_z_r[i], gradB_z_i[i])
                                +  prod3_r(gradC_z_r[i], gradC_z_i[i], rhoD_r[i], rhoD_i[i], gradB_z_r[i], gradB_z_i[i])
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], gradB_z_r[i], gradB_z_i[i], rhoC_r[i], rhoC_i[i])// Permutation: DBC
                                +  prod3_r(rhoD_r[i], rhoD_i[i], gradB_z_r[i], gradB_z_i[i], gradC_z_r[i], gradC_z_i[i])
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], rhoB_r[i], rhoB_i[i], gradC_z_r[i], gradC_z_i[i])
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], gradC_z_r[i], gradC_z_i[i], rhoB_r[i], rhoB_i[i])// Permutation: DCB
                                +  prod3_r(rhoD_r[i], rhoD_i[i], gradC_z_r[i], gradC_z_i[i], gradB_z_r[i], gradB_z_i[i])
                                +  prod3_r(gradD_z_r[i], gradD_z_i[i], rhoC_r[i], rhoC_i[i], gradB_z_r[i], gradB_z_i[i]);
