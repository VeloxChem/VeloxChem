                                ...
                                const std::string&      xcFuncLabel) -> CAOKohnShamMatrix
{
    ...
    if (xcfuntype == xcfun::mgga) return _integrateVxcFockForMGGA(molecule, basis, densityMatrix, molecularGrid, fvxc, flag);
...
#pragma omp parallel
        ...
        {
            auto partial_mat_Vxc =
                _integratePartialVxcFockForMGGA(local_weights, mat_chi, mat_chi_x, mat_chi_y, mat_chi_z, rhograd, vrho, vsigma, vlapl, vtau, timer);
...
CDenseMatrix
CXCIntegrator::_integratePartialVxcFockForMGGA(const double*       weights,
                                               const CDenseMatrix& gtoValues,
                                               const CDenseMatrix& gtoValuesX,
                                               const CDenseMatrix& gtoValuesY,
                                               const CDenseMatrix& gtoValuesZ,
