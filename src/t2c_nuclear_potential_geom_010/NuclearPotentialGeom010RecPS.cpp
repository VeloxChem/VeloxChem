        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PS_X_0(buffer_x,
                                                                            buffer_y,
                                                                            buffer_z,
                                                                            dipole,
                                                                            point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PS_Y_0(buffer_x,
                                                                            buffer_y,
                                                                            buffer_z,
                                                                            dipole,
                                                                            point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PS_Z_0(buffer_x,
                                                                            buffer_y,
                                                                            buffer_z,
                                                                            dipole,
                                                                            point,
