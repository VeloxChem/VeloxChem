...
#pragma omp simd aligned(fints_x, fints_y, fints_z, ket_fe, ket_fn, ket_rx, ket_ry, ket_rz : 64)
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_x[i] += faa_x * b4_vals[i] * (-6.0 * rpa_y * rpa_y * rpc_y * rpc_y * rpc_y);
        ...
        fints_y[i] += dip_y * fss * b1_vals[i] *
                      (6.0 * fe_0 * rpa_y * rpb_y + 9.0 * fe_0 * rpa_y * rpa_y + (15.0 / 4.0) * fe_0 * fe_0 + 4.0 * rpa_y * rpa_y * rpa_y * rpb_y +
                       rpa_y * rpa_y * rpa_y * rpa_y);

        fints_y[i] += dip_y * fss * b2_vals[i] *
                      (-6.0 * fe_0 * rpa_y * rpb_y - 24.0 * fe_0 * rpa_y * rpc_y - 9.0 * fe_0 * rpa_y * rpa_y - 6.0 * fe_0 * rpb_y * rpc_y -
                       (15.0 / 2.0) * fe_0 * fe_0);

        fints_y[i] += dip_y * fss * b2_vals[i] * (-12.0 * rpa_y * rpa_y * rpb_y * rpc_y - 8.0 * rpa_y * rpa_y * rpa_y * rpc_y);

        fints_y[i] += dip_y * fss * b3_vals[i] *
                      (24.0 * fe_0 * rpa_y * rpc_y + 6.0 * fe_0 * rpb_y * rpc_y + 15.0 * fe_0 * rpc_y * rpc_y + (15.0 / 4.0) * fe_0 * fe_0 +
                       12.0 * rpa_y * rpb_y * rpc_y * rpc_y);

        fints_y[i] += dip_y * fss * b3_vals[i] * 18.0 * rpa_y * rpa_y * rpc_y * rpc_y;

        fints_y[i] +=
            dip_y * fss * b4_vals[i] * (-15.0 * fe_0 * rpc_y * rpc_y - 16.0 * rpa_y * rpc_y * rpc_y * rpc_y - 4.0 * rpb_y * rpc_y * rpc_y * rpc_y);
        ...
        fints_y[i] += faa_y * b4_vals[i] * (-6.0 * rpa_y * rpa_y * rpc_y * rpc_y * rpc_y);
        ...
        fints_z[i] += faa_z * b4_vals[i] * (-6.0 * rpa_y * rpa_y * rpc_y * rpc_y * rpc_y);
