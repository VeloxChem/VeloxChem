        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PP_X_X(buffer_x,
                                                                            buffer_y,
                                                                            buffer_z,
                                                                            dipole,
                                                                            point,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PP_X_Y(buffer_x,
                                                                            buffer_y,
                                                                            buffer_z,
                                                                            dipole,
                                                                            point,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PP_X_Z(buffer_x,
                                                                            buffer_y,
                                                                            buffer_z,
                                                                            dipole,
                                                                            point,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PP_Y_X(buffer_x,
                                                                            buffer_y,
                                                                            buffer_z,
                                                                            dipole,
                                                                            point,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PP_Y_Y(buffer_x,
                                                                            buffer_y,
                                                                            buffer_z,
                                                                            dipole,
                                                                            point,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PP_Y_Z(buffer_x,
                                                                            buffer_y,
                                                                            buffer_z,
                                                                            dipole,
                                                                            point,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PP_Z_X(buffer_x,
                                                                            buffer_y,
                                                                            buffer_z,
                                                                            dipole,
                                                                            point,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PP_Z_Y(buffer_x,
                                                                            buffer_y,
                                                                            buffer_z,
                                                                            dipole,
                                                                            point,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PP_Z_Z(buffer_x,
                                                                            buffer_y,
                                                                            buffer_z,
                                                                            dipole,
                                                                            point,
