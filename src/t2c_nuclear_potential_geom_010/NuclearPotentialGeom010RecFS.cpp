...
#include "PrimitiveNuclearPotentialGeom010FS_XXZ_0.hpp"
#include "PrimitiveNuclearPotentialGeom010FS_XYY_0.hpp"
#include "PrimitiveNuclearPotentialGeom010FS_XYZ_0.hpp"
#include "PrimitiveNuclearPotentialGeom010FS_XZZ_0.hpp"
#include "PrimitiveNuclearPotentialGeom010FS_YYY_0.hpp"
#include "PrimitiveNuclearPotentialGeom010FS_YYZ_0.hpp"
#include "PrimitiveNuclearPotentialGeom010FS_YZZ_0.hpp"
#include "PrimitiveNuclearPotentialGeom010FS_ZZZ_0.hpp"
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010FS_XXX_0(buffer_x,
                                                                              buffer_y,
                                                                              buffer_z,
                                                                              dipole,
                                                                              point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010FS_XXY_0(buffer_x,
                                                                              buffer_y,
                                                                              buffer_z,
                                                                              dipole,
                                                                              point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010FS_XXZ_0(buffer_x,
                                                                              buffer_y,
                                                                              buffer_z,
                                                                              dipole,
                                                                              point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010FS_XYY_0(buffer_x,
                                                                              buffer_y,
                                                                              buffer_z,
                                                                              dipole,
                                                                              point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010FS_XYZ_0(buffer_x,
                                                                              buffer_y,
                                                                              buffer_z,
                                                                              dipole,
                                                                              point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010FS_XZZ_0(buffer_x,
                                                                              buffer_y,
                                                                              buffer_z,
                                                                              dipole,
                                                                              point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010FS_YYY_0(buffer_x,
                                                                              buffer_y,
                                                                              buffer_z,
                                                                              dipole,
                                                                              point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010FS_YYZ_0(buffer_x,
                                                                              buffer_y,
                                                                              buffer_z,
                                                                              dipole,
                                                                              point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010FS_YZZ_0(buffer_x,
                                                                              buffer_y,
                                                                              buffer_z,
                                                                              dipole,
                                                                              point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010FS_ZZZ_0(buffer_x,
                                                                              buffer_y,
                                                                              buffer_z,
                                                                              dipole,
                                                                              point,
