...
#pragma omp simd aligned(fints_x, fints_y, fints_z, ket_fe, ket_fn, ket_rx, ket_ry, ket_rz : 64)
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_x[i] += dip_x * fss * b1_vals[i] *
                      (6.0 * fe_0 * rpa_x * rpb_x + 9.0 * fe_0 * rpb_x * rpb_x + (15.0 / 4.0) * fe_0 * fe_0 + 4.0 * rpa_x * rpb_x * rpb_x * rpb_x +
                       rpb_x * rpb_x * rpb_x * rpb_x);

        fints_x[i] += dip_x * fss * b2_vals[i] *
                      (-6.0 * fe_0 * rpa_x * rpb_x - 6.0 * fe_0 * rpa_x * rpc_x - 24.0 * fe_0 * rpb_x * rpc_x - 9.0 * fe_0 * rpb_x * rpb_x -
                       (15.0 / 2.0) * fe_0 * fe_0);

        fints_x[i] += dip_x * fss * b2_vals[i] * (-12.0 * rpa_x * rpb_x * rpb_x * rpc_x - 8.0 * rpb_x * rpb_x * rpb_x * rpc_x);

        fints_x[i] += dip_x * fss * b3_vals[i] *
                      (6.0 * fe_0 * rpa_x * rpc_x + 24.0 * fe_0 * rpb_x * rpc_x + 15.0 * fe_0 * rpc_x * rpc_x + (15.0 / 4.0) * fe_0 * fe_0 +
                       12.0 * rpa_x * rpb_x * rpc_x * rpc_x);

        fints_x[i] += dip_x * fss * b3_vals[i] * 18.0 * rpb_x * rpb_x * rpc_x * rpc_x;

        fints_x[i] +=
            dip_x * fss * b4_vals[i] * (-15.0 * fe_0 * rpc_x * rpc_x - 4.0 * rpa_x * rpc_x * rpc_x * rpc_x - 16.0 * rpb_x * rpc_x * rpc_x * rpc_x);
        ...
        fints_x[i] += faa_x * b4_vals[i] * (-6.0 * rpb_x * rpb_x * rpc_x * rpc_x * rpc_x);
        ...
        fints_y[i] += faa_y * b4_vals[i] * (-6.0 * rpb_x * rpb_x * rpc_x * rpc_x * rpc_x);
        ...
        fints_z[i] += faa_z * b4_vals[i] * (-6.0 * rpb_x * rpb_x * rpc_x * rpc_x * rpc_x);
