...
#pragma omp simd aligned(fints_x, fints_y, fints_z, ket_fe, ket_fn, ket_rx, ket_ry, ket_rz : 64)
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_x[i] += dip_x * fss * b4_vals[i] * (-3.0 * rpa_x * rpa_x * rpc_z * rpc_y * rpc_y - 3.0 * rpb_y * rpb_y * rpc_z * rpc_x * rpc_x);
        ...
        fints_y[i] += dip_y * fss * b1_vals[i] * (3.0 * fe_0 * rpa_z * rpa_x * rpb_y + 2.0 * rpa_z * rpa_x * rpa_x * rpa_x * rpb_y);

        fints_y[i] += dip_y * fss * b2_vals[i] *
                      (-3.0 * fe_0 * rpa_z * rpa_x * rpb_y - 3.0 * fe_0 * rpa_z * rpa_x * rpc_y - 3.0 * fe_0 * rpa_z * rpb_y * rpc_x -
                       3.0 * fe_0 * rpa_x * rpb_y * rpc_z - 6.0 * rpa_z * rpa_x * rpa_x * rpb_y * rpc_x);

        fints_y[i] += dip_y * fss * b2_vals[i] * (-2.0 * rpa_z * rpa_x * rpa_x * rpa_x * rpc_y - 2.0 * rpa_x * rpa_x * rpa_x * rpb_y * rpc_z);
        ...
        fints_y[i] +=
            dip_y * fss * b3_vals[i] *
            (3.0 * fe_0 * rpb_y * rpc_z * rpc_x + 6.0 * rpa_z * rpa_x * rpb_y * rpc_x * rpc_x + 6.0 * rpa_z * rpa_x * rpa_x * rpc_y * rpc_x +
        ...
        fints_y[i] += dip_y * fss * b4_vals[i] *
                      (-3.0 * fe_0 * rpa_z * rpc_y * rpc_x - 3.0 * fe_0 * rpa_x * rpc_z * rpc_y - 3.0 * fe_0 * rpb_y * rpc_z * rpc_x -
                       3.0 * fe_0 * rpc_z * rpc_y * rpc_x - 6.0 * rpa_z * rpa_x * rpc_y * rpc_x * rpc_x);

        fints_y[i] += dip_y * fss * b4_vals[i] *
                      (-2.0 * rpa_z * rpb_y * rpc_x * rpc_x * rpc_x - 6.0 * rpa_x * rpb_y * rpc_z * rpc_x * rpc_x -
        ...
        fints_y[i] += dip_y * fss * b5_vals[i] *
                      (3.0 * fe_0 * rpc_z * rpc_y * rpc_x + 2.0 * rpa_z * rpc_y * rpc_x * rpc_x * rpc_x +
                       6.0 * rpa_x * rpc_z * rpc_y * rpc_x * rpc_x + 2.0 * rpb_y * rpc_z * rpc_x * rpc_x * rpc_x);
