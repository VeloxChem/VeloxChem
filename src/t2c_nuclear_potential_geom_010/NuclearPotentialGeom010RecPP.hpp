...
/**
 Evaluates <P|AG(1)|P>  integrals for given GTOs block.
...
*/
auto compNuclearPotentialGeom010PP(CSubMatrix*      matrix_x,
                                   CSubMatrix*      matrix_y,
                                   CSubMatrix*      matrix_z,
...
/**
 Evaluates <P|AG(1)|P>  integrals for given pair of GTOs blocks.
