...
/**
 Evaluates <D|AG(1)|D>  integrals for given GTOs block.
...
*/
auto compNuclearPotentialGeom010DD(CSubMatrix*      matrix_x,
                                   CSubMatrix*      matrix_y,
                                   CSubMatrix*      matrix_z,
...
/**
 Evaluates <D|AG(1)|D>  integrals for given pair of GTOs blocks.
