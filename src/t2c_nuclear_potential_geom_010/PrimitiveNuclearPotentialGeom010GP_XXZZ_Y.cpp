...
#pragma omp simd aligned(fints_x, fints_y, fints_z, ket_fe, ket_fn, ket_rx, ket_ry, ket_rz : 64)
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_x[i] += faa_x * b2_vals[i] * (-rpa_z * rpa_z * rpa_x * rpa_x * rpc_y);
        ...
        fints_x[i] += faa_x * b4_vals[i] * (-2.0 * rpa_x * rpb_y * rpc_z * rpc_z * rpc_x - rpa_x * rpa_x * rpc_z * rpc_z * rpc_y);
        ...
        fints_y[i] +=
            dip_y * fss * b3_vals[i] * (4.0 * rpa_z * rpa_x * rpc_z * rpc_x + rpa_z * rpa_z * rpc_x * rpc_x + rpa_x * rpa_x * rpc_z * rpc_z);
        ...
        fints_y[i] += faa_y * b2_vals[i] * (-rpa_z * rpa_z * rpa_x * rpa_x * rpc_y);
        ...
        fints_y[i] += faa_y * b4_vals[i] * (-2.0 * rpa_x * rpb_y * rpc_z * rpc_z * rpc_x - rpa_x * rpa_x * rpc_z * rpc_z * rpc_y);
        ...
        fints_z[i] += faa_z * b2_vals[i] * (-rpa_z * rpa_z * rpa_x * rpa_x * rpc_y);
        ...
        fints_z[i] += faa_z * b4_vals[i] * (-2.0 * rpa_x * rpb_y * rpc_z * rpc_z * rpc_x - rpa_x * rpa_x * rpc_z * rpc_z * rpc_y);
