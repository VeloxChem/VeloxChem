        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PD_X_XX(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PD_X_XY(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PD_X_XZ(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PD_X_YY(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PD_X_YZ(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PD_X_ZZ(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PD_Y_XX(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PD_Y_XY(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PD_Y_XZ(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PD_Y_YY(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PD_Y_YZ(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PD_Y_ZZ(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PD_Z_XX(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PD_Z_XY(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PD_Z_XZ(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PD_Z_YY(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PD_Z_YZ(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010PD_Z_ZZ(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
