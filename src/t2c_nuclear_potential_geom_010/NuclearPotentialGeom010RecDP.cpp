        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010DP_XX_X(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010DP_XX_Y(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010DP_XX_Z(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010DP_XY_X(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010DP_XY_Y(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010DP_XY_Z(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010DP_XZ_X(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010DP_XZ_Y(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010DP_XZ_Z(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010DP_YY_X(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010DP_YY_Y(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010DP_YY_Z(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010DP_YZ_X(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010DP_YZ_Y(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010DP_YZ_Z(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010DP_ZZ_X(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010DP_ZZ_Y(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    npotg010rec::compPrimitiveNuclearPotentialGeom010DP_ZZ_Z(buffer_x,
                                                                             buffer_y,
                                                                             buffer_z,
                                                                             dipole,
                                                                             point,
