...
/**
 Evaluates <F|AG(1)|F>  integrals for given GTOs block.
...
*/
auto compNuclearPotentialGeom010FF(CSubMatrix*      matrix_x,
                                   CSubMatrix*      matrix_y,
                                   CSubMatrix*      matrix_z,
...
/**
 Evaluates <F|AG(1)|F>  integrals for given pair of GTOs blocks.
