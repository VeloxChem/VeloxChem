#ifndef OverlapGeom100RecDP_hpp
#define OverlapGeom100RecDP_hpp
...
/**
 Evaluates <d^(1)/dA^(1)D|1|P>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom100DP(CSubMatrix*      matrix_x,
                          CSubMatrix*      matrix_y,
                          CSubMatrix*      matrix_z,
