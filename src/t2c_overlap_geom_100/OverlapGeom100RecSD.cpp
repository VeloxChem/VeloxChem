...
#include "PrimitiveOverlapGeom100SD_0_XX.hpp"
#include "PrimitiveOverlapGeom100SD_0_XY.hpp"
#include "PrimitiveOverlapGeom100SD_0_XZ.hpp"
#include "PrimitiveOverlapGeom100SD_0_YY.hpp"
#include "PrimitiveOverlapGeom100SD_0_YZ.hpp"
#include "PrimitiveOverlapGeom100SD_0_ZZ.hpp"
#include "T2CDistributor.hpp"

namespace ovlrec {  // ovlrec namespace

auto
compOverlapGeom100SD(CSubMatrix*      matrix_x,
                     CSubMatrix*      matrix_y,
                     CSubMatrix*      matrix_z,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100SD_0_XX(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100SD_0_XY(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100SD_0_XZ(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100SD_0_YY(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100SD_0_YZ(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100SD_0_ZZ(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
