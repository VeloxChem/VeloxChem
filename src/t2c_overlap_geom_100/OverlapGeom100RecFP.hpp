#ifndef OverlapGeom100RecFP_hpp
#define OverlapGeom100RecFP_hpp
...
/**
 Evaluates <d^(1)/dA^(1)F|1|P>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom100FP(CSubMatrix*      matrix_x,
                          CSubMatrix*      matrix_y,
                          CSubMatrix*      matrix_z,
