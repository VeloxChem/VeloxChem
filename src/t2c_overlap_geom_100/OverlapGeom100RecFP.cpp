...
#include "PrimitiveOverlapGeom100FP_XXX_X.hpp"
#include "PrimitiveOverlapGeom100FP_XXX_Y.hpp"
#include "PrimitiveOverlapGeom100FP_XXX_Z.hpp"
#include "PrimitiveOverlapGeom100FP_XXY_X.hpp"
#include "PrimitiveOverlapGeom100FP_XXY_Y.hpp"
#include "PrimitiveOverlapGeom100FP_XXY_Z.hpp"
#include "PrimitiveOverlapGeom100FP_XXZ_X.hpp"
#include "PrimitiveOverlapGeom100FP_XXZ_Y.hpp"
#include "PrimitiveOverlapGeom100FP_XXZ_Z.hpp"
#include "PrimitiveOverlapGeom100FP_XYY_X.hpp"
#include "PrimitiveOverlapGeom100FP_XYY_Y.hpp"
#include "PrimitiveOverlapGeom100FP_XYY_Z.hpp"
#include "PrimitiveOverlapGeom100FP_XYZ_X.hpp"
#include "PrimitiveOverlapGeom100FP_XYZ_Y.hpp"
#include "PrimitiveOverlapGeom100FP_XYZ_Z.hpp"
#include "PrimitiveOverlapGeom100FP_XZZ_X.hpp"
#include "PrimitiveOverlapGeom100FP_XZZ_Y.hpp"
#include "PrimitiveOverlapGeom100FP_XZZ_Z.hpp"
#include "PrimitiveOverlapGeom100FP_YYY_X.hpp"
#include "PrimitiveOverlapGeom100FP_YYY_Y.hpp"
#include "PrimitiveOverlapGeom100FP_YYY_Z.hpp"
#include "PrimitiveOverlapGeom100FP_YYZ_X.hpp"
#include "PrimitiveOverlapGeom100FP_YYZ_Y.hpp"
#include "PrimitiveOverlapGeom100FP_YYZ_Z.hpp"
#include "PrimitiveOverlapGeom100FP_YZZ_X.hpp"
#include "PrimitiveOverlapGeom100FP_YZZ_Y.hpp"
#include "PrimitiveOverlapGeom100FP_YZZ_Z.hpp"
#include "PrimitiveOverlapGeom100FP_ZZZ_X.hpp"
#include "PrimitiveOverlapGeom100FP_ZZZ_Y.hpp"
#include "PrimitiveOverlapGeom100FP_ZZZ_Z.hpp"
#include "T2CDistributor.hpp"

namespace ovlrec {  // ovlrec namespace

auto
compOverlapGeom100FP(CSubMatrix*      matrix_x,
                     CSubMatrix*      matrix_y,
                     CSubMatrix*      matrix_z,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_XXX_X(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_XXX_Y(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_XXX_Z(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_XXY_X(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_XXY_Y(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_XXY_Z(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_XXZ_X(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_XXZ_Y(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_XXZ_Z(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_XYY_X(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_XYY_Y(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_XYY_Z(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_XYZ_X(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_XYZ_Y(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_XYZ_Z(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_XZZ_X(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_XZZ_Y(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_XZZ_Z(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_YYY_X(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_YYY_Y(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_YYY_Z(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_YYZ_X(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_YYZ_Y(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_YYZ_Z(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_YZZ_X(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_YZZ_Y(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_YZZ_Z(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_ZZZ_X(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_ZZZ_Y(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FP_ZZZ_Z(buffer_x,
                                                                buffer_y,
                                                                buffer_z,
                                                                bra_exp,
                                                                bra_norm,
