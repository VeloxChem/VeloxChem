...
#include "PrimitiveOverlapGeom100DP_XX_X.hpp"
#include "PrimitiveOverlapGeom100DP_XX_Y.hpp"
#include "PrimitiveOverlapGeom100DP_XX_Z.hpp"
#include "PrimitiveOverlapGeom100DP_XY_X.hpp"
#include "PrimitiveOverlapGeom100DP_XY_Y.hpp"
#include "PrimitiveOverlapGeom100DP_XY_Z.hpp"
#include "PrimitiveOverlapGeom100DP_XZ_X.hpp"
#include "PrimitiveOverlapGeom100DP_XZ_Y.hpp"
#include "PrimitiveOverlapGeom100DP_XZ_Z.hpp"
#include "PrimitiveOverlapGeom100DP_YY_X.hpp"
#include "PrimitiveOverlapGeom100DP_YY_Y.hpp"
#include "PrimitiveOverlapGeom100DP_YY_Z.hpp"
#include "PrimitiveOverlapGeom100DP_YZ_X.hpp"
#include "PrimitiveOverlapGeom100DP_YZ_Y.hpp"
#include "PrimitiveOverlapGeom100DP_YZ_Z.hpp"
#include "PrimitiveOverlapGeom100DP_ZZ_X.hpp"
#include "PrimitiveOverlapGeom100DP_ZZ_Y.hpp"
#include "PrimitiveOverlapGeom100DP_ZZ_Z.hpp"
#include "T2CDistributor.hpp"

namespace ovlrec {  // ovlrec namespace

auto
compOverlapGeom100DP(CSubMatrix*      matrix_x,
                     CSubMatrix*      matrix_y,
                     CSubMatrix*      matrix_z,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100DP_XX_X(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100DP_XX_Y(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100DP_XX_Z(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100DP_XY_X(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100DP_XY_Y(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100DP_XY_Z(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100DP_XZ_X(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100DP_XZ_Y(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100DP_XZ_Z(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100DP_YY_X(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100DP_YY_Y(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100DP_YY_Z(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100DP_YZ_X(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100DP_YZ_Y(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100DP_YZ_Z(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100DP_ZZ_X(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100DP_ZZ_Y(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100DP_ZZ_Z(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
