#ifndef OverlapGeom100RecDD_hpp
#define OverlapGeom100RecDD_hpp
...
/**
 Evaluates <d^(1)/dA^(1)D|1|D>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom100DD(CSubMatrix*      matrix_x,
                          CSubMatrix*      matrix_y,
                          CSubMatrix*      matrix_z,
