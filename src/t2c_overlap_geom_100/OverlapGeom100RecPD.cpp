...
#include "PrimitiveOverlapGeom100PD_X_XX.hpp"
#include "PrimitiveOverlapGeom100PD_X_XY.hpp"
#include "PrimitiveOverlapGeom100PD_X_XZ.hpp"
#include "PrimitiveOverlapGeom100PD_X_YY.hpp"
#include "PrimitiveOverlapGeom100PD_X_YZ.hpp"
#include "PrimitiveOverlapGeom100PD_X_ZZ.hpp"
#include "PrimitiveOverlapGeom100PD_Y_XX.hpp"
#include "PrimitiveOverlapGeom100PD_Y_XY.hpp"
#include "PrimitiveOverlapGeom100PD_Y_XZ.hpp"
#include "PrimitiveOverlapGeom100PD_Y_YY.hpp"
#include "PrimitiveOverlapGeom100PD_Y_YZ.hpp"
#include "PrimitiveOverlapGeom100PD_Y_ZZ.hpp"
#include "PrimitiveOverlapGeom100PD_Z_XX.hpp"
#include "PrimitiveOverlapGeom100PD_Z_XY.hpp"
#include "PrimitiveOverlapGeom100PD_Z_XZ.hpp"
#include "PrimitiveOverlapGeom100PD_Z_YY.hpp"
#include "PrimitiveOverlapGeom100PD_Z_YZ.hpp"
#include "PrimitiveOverlapGeom100PD_Z_ZZ.hpp"
#include "T2CDistributor.hpp"

namespace ovlrec {  // ovlrec namespace

auto
compOverlapGeom100PD(CSubMatrix*      matrix_x,
                     CSubMatrix*      matrix_y,
                     CSubMatrix*      matrix_z,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PD_X_XX(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PD_X_XY(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PD_X_XZ(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PD_X_YY(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PD_X_YZ(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PD_X_ZZ(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PD_Y_XX(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PD_Y_XY(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PD_Y_XZ(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PD_Y_YY(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PD_Y_YZ(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PD_Y_ZZ(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PD_Z_XX(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PD_Z_XY(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PD_Z_XZ(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PD_Z_YY(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PD_Z_YZ(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PD_Z_ZZ(buffer_x,
                                                               buffer_y,
                                                               buffer_z,
                                                               bra_exp,
                                                               bra_norm,
