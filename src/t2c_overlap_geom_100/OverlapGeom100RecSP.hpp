#ifndef OverlapGeom100RecSP_hpp
#define OverlapGeom100RecSP_hpp
...
/**
 Evaluates <d^(1)/dA^(1)S|1|P>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom100SP(CSubMatrix*      matrix_x,
                          CSubMatrix*      matrix_y,
                          CSubMatrix*      matrix_z,
