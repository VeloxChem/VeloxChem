...
#include "PrimitiveOverlapGeom100FD_XXX_XX.hpp"
#include "PrimitiveOverlapGeom100FD_XXX_XY.hpp"
#include "PrimitiveOverlapGeom100FD_XXX_XZ.hpp"
#include "PrimitiveOverlapGeom100FD_XXX_YY.hpp"
#include "PrimitiveOverlapGeom100FD_XXX_YZ.hpp"
#include "PrimitiveOverlapGeom100FD_XXX_ZZ.hpp"
#include "PrimitiveOverlapGeom100FD_XXY_XX.hpp"
#include "PrimitiveOverlapGeom100FD_XXY_XY.hpp"
#include "PrimitiveOverlapGeom100FD_XXY_XZ.hpp"
#include "PrimitiveOverlapGeom100FD_XXY_YY.hpp"
#include "PrimitiveOverlapGeom100FD_XXY_YZ.hpp"
#include "PrimitiveOverlapGeom100FD_XXY_ZZ.hpp"
#include "PrimitiveOverlapGeom100FD_XXZ_XX.hpp"
#include "PrimitiveOverlapGeom100FD_XXZ_XY.hpp"
#include "PrimitiveOverlapGeom100FD_XXZ_XZ.hpp"
#include "PrimitiveOverlapGeom100FD_XXZ_YY.hpp"
#include "PrimitiveOverlapGeom100FD_XXZ_YZ.hpp"
#include "PrimitiveOverlapGeom100FD_XXZ_ZZ.hpp"
#include "PrimitiveOverlapGeom100FD_XYY_XX.hpp"
#include "PrimitiveOverlapGeom100FD_XYY_XY.hpp"
#include "PrimitiveOverlapGeom100FD_XYY_XZ.hpp"
#include "PrimitiveOverlapGeom100FD_XYY_YY.hpp"
#include "PrimitiveOverlapGeom100FD_XYY_YZ.hpp"
#include "PrimitiveOverlapGeom100FD_XYY_ZZ.hpp"
#include "PrimitiveOverlapGeom100FD_XYZ_XX.hpp"
#include "PrimitiveOverlapGeom100FD_XYZ_XY.hpp"
#include "PrimitiveOverlapGeom100FD_XYZ_XZ.hpp"
#include "PrimitiveOverlapGeom100FD_XYZ_YY.hpp"
#include "PrimitiveOverlapGeom100FD_XYZ_YZ.hpp"
#include "PrimitiveOverlapGeom100FD_XYZ_ZZ.hpp"
#include "PrimitiveOverlapGeom100FD_XZZ_XX.hpp"
#include "PrimitiveOverlapGeom100FD_XZZ_XY.hpp"
#include "PrimitiveOverlapGeom100FD_XZZ_XZ.hpp"
#include "PrimitiveOverlapGeom100FD_XZZ_YY.hpp"
#include "PrimitiveOverlapGeom100FD_XZZ_YZ.hpp"
#include "PrimitiveOverlapGeom100FD_XZZ_ZZ.hpp"
#include "PrimitiveOverlapGeom100FD_YYY_XX.hpp"
#include "PrimitiveOverlapGeom100FD_YYY_XY.hpp"
#include "PrimitiveOverlapGeom100FD_YYY_XZ.hpp"
#include "PrimitiveOverlapGeom100FD_YYY_YY.hpp"
#include "PrimitiveOverlapGeom100FD_YYY_YZ.hpp"
#include "PrimitiveOverlapGeom100FD_YYY_ZZ.hpp"
#include "PrimitiveOverlapGeom100FD_YYZ_XX.hpp"
#include "PrimitiveOverlapGeom100FD_YYZ_XY.hpp"
#include "PrimitiveOverlapGeom100FD_YYZ_XZ.hpp"
#include "PrimitiveOverlapGeom100FD_YYZ_YY.hpp"
#include "PrimitiveOverlapGeom100FD_YYZ_YZ.hpp"
#include "PrimitiveOverlapGeom100FD_YYZ_ZZ.hpp"
#include "PrimitiveOverlapGeom100FD_YZZ_XX.hpp"
#include "PrimitiveOverlapGeom100FD_YZZ_XY.hpp"
#include "PrimitiveOverlapGeom100FD_YZZ_XZ.hpp"
#include "PrimitiveOverlapGeom100FD_YZZ_YY.hpp"
#include "PrimitiveOverlapGeom100FD_YZZ_YZ.hpp"
#include "PrimitiveOverlapGeom100FD_YZZ_ZZ.hpp"
#include "PrimitiveOverlapGeom100FD_ZZZ_XX.hpp"
#include "PrimitiveOverlapGeom100FD_ZZZ_XY.hpp"
#include "PrimitiveOverlapGeom100FD_ZZZ_XZ.hpp"
#include "PrimitiveOverlapGeom100FD_ZZZ_YY.hpp"
#include "PrimitiveOverlapGeom100FD_ZZZ_YZ.hpp"
#include "PrimitiveOverlapGeom100FD_ZZZ_ZZ.hpp"
#include "T2CDistributor.hpp"

namespace ovlrec {  // ovlrec namespace

auto
compOverlapGeom100FD(CSubMatrix*      matrix_x,
                     CSubMatrix*      matrix_y,
                     CSubMatrix*      matrix_z,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XXX_XX(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XXX_XY(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XXX_XZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XXX_YY(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XXX_YZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XXX_ZZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XXY_XX(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XXY_XY(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XXY_XZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XXY_YY(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XXY_YZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XXY_ZZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XXZ_XX(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XXZ_XY(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XXZ_XZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XXZ_YY(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XXZ_YZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XXZ_ZZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XYY_XX(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XYY_XY(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XYY_XZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XYY_YY(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XYY_YZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XYY_ZZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XYZ_XX(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XYZ_XY(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XYZ_XZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XYZ_YY(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XYZ_YZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XYZ_ZZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XZZ_XX(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XZZ_XY(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XZZ_XZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XZZ_YY(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XZZ_YZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_XZZ_ZZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_YYY_XX(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_YYY_XY(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_YYY_XZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_YYY_YY(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_YYY_YZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_YYY_ZZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_YYZ_XX(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_YYZ_XY(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_YYZ_XZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_YYZ_YY(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_YYZ_YZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_YYZ_ZZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_YZZ_XX(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_YZZ_XY(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_YZZ_XZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_YZZ_YY(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_YZZ_YZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_YZZ_ZZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_ZZZ_XX(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_ZZZ_XY(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_ZZZ_XZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_ZZZ_YY(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_ZZZ_YZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100FD_ZZZ_ZZ(buffer_x,
                                                                 buffer_y,
                                                                 buffer_z,
                                                                 bra_exp,
                                                                 bra_norm,
