...
#include "PrimitiveOverlapGeom100PS_Y_0.hpp"
#include "PrimitiveOverlapGeom100PS_Z_0.hpp"
#include "T2CDistributor.hpp"

namespace ovlrec {  // ovlrec namespace

auto
compOverlapGeom100PS(CSubMatrix*      matrix_x,
                     CSubMatrix*      matrix_y,
                     CSubMatrix*      matrix_z,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PS_X_0(buffer_x,
                                                              buffer_y,
                                                              buffer_z,
                                                              bra_exp,
                                                              bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PS_Y_0(buffer_x,
                                                              buffer_y,
                                                              buffer_z,
                                                              bra_exp,
                                                              bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PS_Z_0(buffer_x,
                                                              buffer_y,
                                                              buffer_z,
                                                              bra_exp,
                                                              bra_norm,
