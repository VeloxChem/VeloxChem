...
#include "PrimitiveOverlapGeom100PP_Y_Y.hpp"
#include "PrimitiveOverlapGeom100PP_Y_Z.hpp"
#include "PrimitiveOverlapGeom100PP_Z_X.hpp"
#include "PrimitiveOverlapGeom100PP_Z_Y.hpp"
#include "PrimitiveOverlapGeom100PP_Z_Z.hpp"
#include "T2CDistributor.hpp"

namespace ovlrec {  // ovlrec namespace

auto
compOverlapGeom100PP(CSubMatrix*      matrix_x,
                     CSubMatrix*      matrix_y,
                     CSubMatrix*      matrix_z,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PP_X_X(buffer_x,
                                                              buffer_y,
                                                              buffer_z,
                                                              bra_exp,
                                                              bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PP_X_Y(buffer_x,
                                                              buffer_y,
                                                              buffer_z,
                                                              bra_exp,
                                                              bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PP_X_Z(buffer_x,
                                                              buffer_y,
                                                              buffer_z,
                                                              bra_exp,
                                                              bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PP_Y_X(buffer_x,
                                                              buffer_y,
                                                              buffer_z,
                                                              bra_exp,
                                                              bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PP_Y_Y(buffer_x,
                                                              buffer_y,
                                                              buffer_z,
                                                              bra_exp,
                                                              bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PP_Y_Z(buffer_x,
                                                              buffer_y,
                                                              buffer_z,
                                                              bra_exp,
                                                              bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PP_Z_X(buffer_x,
                                                              buffer_y,
                                                              buffer_z,
                                                              bra_exp,
                                                              bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PP_Z_Y(buffer_x,
                                                              buffer_y,
                                                              buffer_z,
                                                              bra_exp,
                                                              bra_norm,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom100PP_Z_Z(buffer_x,
                                                              buffer_y,
                                                              buffer_z,
                                                              bra_exp,
                                                              bra_norm,
