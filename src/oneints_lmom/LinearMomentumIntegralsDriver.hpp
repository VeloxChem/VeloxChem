...
class CLinearMomentumIntegralsDriver
{
     ...
     */
    CLinearMomentumMatrix _compLinearMomentumIntegrals(const CGtoContainer* braGtoContainer, const CGtoContainer* ketGtoContainer) const;
   ...
   public:
    ...
    /**
     ...
     @return the linear momentum matrix object.
     */
    CLinearMomentumMatrix compute(const CMolecule& molecule, const CMolecularBasis& basis) const;
    ...
    /**
     ...
     @return the linear momentum matrix object.
     */
    CLinearMomentumMatrix compute(const CMolecule& molecule, const CMolecularBasis& braBasis, const CMolecularBasis& ketBasis) const;
    ...
    /**
     ...
     @return the linear momentum matrix object.
     */
    CLinearMomentumMatrix compute(const CMolecule& braMolecule, const CMolecule& ketMolecule, const CMolecularBasis& basis) const;
