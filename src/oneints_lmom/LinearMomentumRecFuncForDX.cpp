...
namespace lmomrecfunc { // lmomrecfunc namespace
    ...
    {
        lmomrecfunc::compLinearMomentumForDD_0_36(primBuffer,
                                                  recursionMap,
                                                  osFactors,
                                                  paDistances, 
                                                  braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForDD_36_72(primBuffer,
                                                   recursionMap,
                                                   osFactors,
                                                   paDistances, 
                                                   braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForDD_72_108(primBuffer,
                                                    recursionMap,
                                                    osFactors,
                                                    paDistances, 
                                                    braGtoBlock,
    ...
    compLinearMomentumForDF(      CMemBlock2D<double>& primBuffer,
                            ...
                            const int32_t              iContrGto)
    {
        lmomrecfunc::compLinearMomentumForDF_0_45(primBuffer,
                                                  recursionMap,
                                                  osFactors,
                                                  paDistances, 
                                                  braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForDF_45_90(primBuffer,
                                                   recursionMap,
                                                   osFactors,
                                                   paDistances, 
                                                   braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForDF_90_135(primBuffer,
                                                    recursionMap,
                                                    osFactors,
                                                    paDistances, 
                                                    braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForDF_135_180(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
                                 ...
                                 const int32_t              iContrGto)
    {
        ...
        auto pidx_p_2_3_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Linear Momentum"}, 1, true, 
                                                         {2, -1, -1, -1}, {3, -1, -1, -1}, 
                                                         1, 1, 0));
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpx_xx_xxx_0[j] = pa_x[j] * tpx_x_xxx_0[j] + 0.5 * fl1_fx * tpx_0_xxx_0[j] + 1.5 * fl1_fx * tpx_x_xx_0[j] - fl1_fgb * fl1_fx * ts_x_xxx_0[j];
                ...
                tpx_xx_xyy_0[j] = pa_x[j] * tpx_x_xyy_0[j] + 0.5 * fl1_fx * tpx_0_xyy_0[j] + 0.5 * fl1_fx * tpx_x_yy_0[j] - fl1_fgb * fl1_fx * ts_x_xyy_0[j];
                ...
                tpx_xx_xyz_0[j] = pa_x[j] * tpx_x_xyz_0[j] + 0.5 * fl1_fx * tpx_0_xyz_0[j] + 0.5 * fl1_fx * tpx_x_yz_0[j] - fl1_fgb * fl1_fx * ts_x_xyz_0[j];
                ...
                tpx_xx_xzz_0[j] = pa_x[j] * tpx_x_xzz_0[j] + 0.5 * fl1_fx * tpx_0_xzz_0[j] + 0.5 * fl1_fx * tpx_x_zz_0[j] - fl1_fgb * fl1_fx * ts_x_xzz_0[j];
                                   ...
                                   const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpy_yy_xxy_0[j] = pa_y[j] * tpy_y_xxy_0[j] + 0.5 * fl1_fx * tpy_0_xxy_0[j] + 0.5 * fl1_fx * tpy_y_xx_0[j] - fl1_fgb * fl1_fx * ts_y_xxy_0[j];
                ...
                tpy_yy_xyz_0[j] = pa_y[j] * tpy_y_xyz_0[j] + 0.5 * fl1_fx * tpy_0_xyz_0[j] + 0.5 * fl1_fx * tpy_y_xz_0[j] - fl1_fgb * fl1_fx * ts_y_xyz_0[j];
                ...
                tpy_yy_yyy_0[j] = pa_y[j] * tpy_y_yyy_0[j] + 0.5 * fl1_fx * tpy_0_yyy_0[j] + 1.5 * fl1_fx * tpy_y_yy_0[j] - fl1_fgb * fl1_fx * ts_y_yyy_0[j];
                ...
                tpy_yy_yzz_0[j] = pa_y[j] * tpy_y_yzz_0[j] + 0.5 * fl1_fx * tpy_0_yzz_0[j] + 0.5 * fl1_fx * tpy_y_zz_0[j] - fl1_fgb * fl1_fx * ts_y_yzz_0[j];
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpz_zz_xxz_0[j] = pa_z[j] * tpz_z_xxz_0[j] + 0.5 * fl1_fx * tpz_0_xxz_0[j] + 0.5 * fl1_fx * tpz_z_xx_0[j] - fl1_fgb * fl1_fx * ts_z_xxz_0[j];
                ...
                tpz_zz_xyz_0[j] = pa_z[j] * tpz_z_xyz_0[j] + 0.5 * fl1_fx * tpz_0_xyz_0[j] + 0.5 * fl1_fx * tpz_z_xy_0[j] - fl1_fgb * fl1_fx * ts_z_xyz_0[j];
                ...
                tpz_zz_yyz_0[j] = pa_z[j] * tpz_z_yyz_0[j] + 0.5 * fl1_fx * tpz_0_yyz_0[j] + 0.5 * fl1_fx * tpz_z_yy_0[j] - fl1_fgb * fl1_fx * ts_z_yyz_0[j];
                ...
                tpz_zz_zzz_0[j] = pa_z[j] * tpz_z_zzz_0[j] + 0.5 * fl1_fx * tpz_0_zzz_0[j] + 1.5 * fl1_fx * tpz_z_zz_0[j] - fl1_fgb * fl1_fx * ts_z_zzz_0[j];
            }
    ...
    compLinearMomentumForFD(      CMemBlock2D<double>& primBuffer,
                            ...
                            const int32_t              iContrGto)
    {
        lmomrecfunc::compLinearMomentumForFD_0_45(primBuffer,
                                                  recursionMap,
                                                  osFactors,
                                                  paDistances, 
                                                  braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForFD_45_90(primBuffer,
                                                   recursionMap,
                                                   osFactors,
                                                   paDistances, 
                                                   braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForFD_90_135(primBuffer,
                                                    recursionMap,
                                                    osFactors,
                                                    paDistances, 
                                                    braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForFD_135_180(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
                                 ...
                                 const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpx_xxy_xy_0[j] = pa_x[j] * tpx_xy_xy_0[j] + 0.5 * fl1_fx * tpx_y_xy_0[j] + 0.5 * fl1_fx * tpx_xy_y_0[j] - fl1_fgb * fl1_fx * ts_xy_xy_0[j];
                ...
                tpx_xxy_xz_0[j] = pa_x[j] * tpx_xy_xz_0[j] + 0.5 * fl1_fx * tpx_y_xz_0[j] + 0.5 * fl1_fx * tpx_xy_z_0[j] - fl1_fgb * fl1_fx * ts_xy_xz_0[j];
                ...
                tpx_xxz_xy_0[j] = pa_x[j] * tpx_xz_xy_0[j] + 0.5 * fl1_fx * tpx_z_xy_0[j] + 0.5 * fl1_fx * tpx_xz_y_0[j] - fl1_fgb * fl1_fx * ts_xz_xy_0[j];
                ...
                tpx_xxz_xz_0[j] = pa_x[j] * tpx_xz_xz_0[j] + 0.5 * fl1_fx * tpx_z_xz_0[j] + 0.5 * fl1_fx * tpx_xz_z_0[j] - fl1_fgb * fl1_fx * ts_xz_xz_0[j];
                                   ...
                                   const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpy_yyz_xy_0[j] = pa_y[j] * tpy_yz_xy_0[j] + 0.5 * fl1_fx * tpy_z_xy_0[j] + 0.5 * fl1_fx * tpy_yz_x_0[j] - fl1_fgb * fl1_fx * ts_yz_xy_0[j];
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpy_yyz_yz_0[j] = pa_y[j] * tpy_yz_yz_0[j] + 0.5 * fl1_fx * tpy_z_yz_0[j] + 0.5 * fl1_fx * tpy_yz_z_0[j] - fl1_fgb * fl1_fx * ts_yz_yz_0[j];
    ...
    compLinearMomentumForDG(      CMemBlock2D<double>& primBuffer,
                            ...
                            const int32_t              iContrGto)
    {
        lmomrecfunc::compLinearMomentumForDG_0_45(primBuffer,
                                                  recursionMap,
                                                  osFactors,
                                                  paDistances, 
                                                  braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForDG_45_90(primBuffer,
                                                   recursionMap,
                                                   osFactors,
                                                   paDistances, 
                                                   braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForDG_90_135(primBuffer,
                                                    recursionMap,
                                                    osFactors,
                                                    paDistances, 
                                                    braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForDG_135_180(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForDG_180_225(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForDG_225_270(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
                                 ...
                                 const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpx_xx_xxxx_0[j] = pa_x[j] * tpx_x_xxxx_0[j] + 0.5 * fl1_fx * tpx_0_xxxx_0[j] + 2.0 * fl1_fx * tpx_x_xxx_0[j] - fl1_fgb * fl1_fx * ts_x_xxxx_0[j];
                ...
                tpx_xx_xxxy_0[j] = pa_x[j] * tpx_x_xxxy_0[j] + 0.5 * fl1_fx * tpx_0_xxxy_0[j] + 1.5 * fl1_fx * tpx_x_xxy_0[j] - fl1_fgb * fl1_fx * ts_x_xxxy_0[j];
                ...
                tpx_xx_xxxz_0[j] = pa_x[j] * tpx_x_xxxz_0[j] + 0.5 * fl1_fx * tpx_0_xxxz_0[j] + 1.5 * fl1_fx * tpx_x_xxz_0[j] - fl1_fgb * fl1_fx * ts_x_xxxz_0[j];
                ...
                tpx_xx_xxyy_0[j] = pa_x[j] * tpx_x_xxyy_0[j] + 0.5 * fl1_fx * tpx_0_xxyy_0[j] + fl1_fx * tpx_x_xyy_0[j] - fl1_fgb * fl1_fx * ts_x_xxyy_0[j];
                ...
                tpx_xx_xxyz_0[j] = pa_x[j] * tpx_x_xxyz_0[j] + 0.5 * fl1_fx * tpx_0_xxyz_0[j] + fl1_fx * tpx_x_xyz_0[j] - fl1_fgb * fl1_fx * ts_x_xxyz_0[j];
                ...
                tpx_xx_xxzz_0[j] = pa_x[j] * tpx_x_xxzz_0[j] + 0.5 * fl1_fx * tpx_0_xxzz_0[j] + fl1_fx * tpx_x_xzz_0[j] - fl1_fgb * fl1_fx * ts_x_xxzz_0[j];
                ...
                tpx_xx_xyyy_0[j] = pa_x[j] * tpx_x_xyyy_0[j] + 0.5 * fl1_fx * tpx_0_xyyy_0[j] + 0.5 * fl1_fx * tpx_x_yyy_0[j] - fl1_fgb * fl1_fx * ts_x_xyyy_0[j];
                ...
                tpx_xx_xyyz_0[j] = pa_x[j] * tpx_x_xyyz_0[j] + 0.5 * fl1_fx * tpx_0_xyyz_0[j] + 0.5 * fl1_fx * tpx_x_yyz_0[j] - fl1_fgb * fl1_fx * ts_x_xyyz_0[j];
                ...
                tpx_xx_xyzz_0[j] = pa_x[j] * tpx_x_xyzz_0[j] + 0.5 * fl1_fx * tpx_0_xyzz_0[j] + 0.5 * fl1_fx * tpx_x_yzz_0[j] - fl1_fgb * fl1_fx * ts_x_xyzz_0[j];
                ...
                tpx_xx_xzzz_0[j] = pa_x[j] * tpx_x_xzzz_0[j] + 0.5 * fl1_fx * tpx_0_xzzz_0[j] + 0.5 * fl1_fx * tpx_x_zzz_0[j] - fl1_fgb * fl1_fx * ts_x_xzzz_0[j];
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpy_yy_xxxy_0[j] = pa_y[j] * tpy_y_xxxy_0[j] + 0.5 * fl1_fx * tpy_0_xxxy_0[j] + 0.5 * fl1_fx * tpy_y_xxx_0[j] - fl1_fgb * fl1_fx * ts_y_xxxy_0[j];
                ...
                tpy_yy_xxyy_0[j] = pa_y[j] * tpy_y_xxyy_0[j] + 0.5 * fl1_fx * tpy_0_xxyy_0[j] + fl1_fx * tpy_y_xxy_0[j] - fl1_fgb * fl1_fx * ts_y_xxyy_0[j];
                ...
                tpy_yy_xxyz_0[j] = pa_y[j] * tpy_y_xxyz_0[j] + 0.5 * fl1_fx * tpy_0_xxyz_0[j] + 0.5 * fl1_fx * tpy_y_xxz_0[j] - fl1_fgb * fl1_fx * ts_y_xxyz_0[j];
                ...
                tpy_yy_xyyy_0[j] = pa_y[j] * tpy_y_xyyy_0[j] + 0.5 * fl1_fx * tpy_0_xyyy_0[j] + 1.5 * fl1_fx * tpy_y_xyy_0[j] - fl1_fgb * fl1_fx * ts_y_xyyy_0[j];
                ...
                tpy_yy_xyyz_0[j] = pa_y[j] * tpy_y_xyyz_0[j] + 0.5 * fl1_fx * tpy_0_xyyz_0[j] + fl1_fx * tpy_y_xyz_0[j] - fl1_fgb * fl1_fx * ts_y_xyyz_0[j];
                ...
                tpy_yy_xyzz_0[j] = pa_y[j] * tpy_y_xyzz_0[j] + 0.5 * fl1_fx * tpy_0_xyzz_0[j] + 0.5 * fl1_fx * tpy_y_xzz_0[j] - fl1_fgb * fl1_fx * ts_y_xyzz_0[j];
                ...
                tpy_yy_yyyy_0[j] = pa_y[j] * tpy_y_yyyy_0[j] + 0.5 * fl1_fx * tpy_0_yyyy_0[j] + 2.0 * fl1_fx * tpy_y_yyy_0[j] - fl1_fgb * fl1_fx * ts_y_yyyy_0[j];
                ...
                tpy_yy_yyyz_0[j] = pa_y[j] * tpy_y_yyyz_0[j] + 0.5 * fl1_fx * tpy_0_yyyz_0[j] + 1.5 * fl1_fx * tpy_y_yyz_0[j] - fl1_fgb * fl1_fx * ts_y_yyyz_0[j];
                ...
                tpy_yy_yyzz_0[j] = pa_y[j] * tpy_y_yyzz_0[j] + 0.5 * fl1_fx * tpy_0_yyzz_0[j] + fl1_fx * tpy_y_yzz_0[j] - fl1_fgb * fl1_fx * ts_y_yyzz_0[j];
                ...
                tpy_yy_yzzz_0[j] = pa_y[j] * tpy_y_yzzz_0[j] + 0.5 * fl1_fx * tpy_0_yzzz_0[j] + 0.5 * fl1_fx * tpy_y_zzz_0[j] - fl1_fgb * fl1_fx * ts_y_yzzz_0[j];
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpz_zz_xxxz_0[j] = pa_z[j] * tpz_z_xxxz_0[j] + 0.5 * fl1_fx * tpz_0_xxxz_0[j] + 0.5 * fl1_fx * tpz_z_xxx_0[j] - fl1_fgb * fl1_fx * ts_z_xxxz_0[j];
                ...
                tpz_zz_xxyz_0[j] = pa_z[j] * tpz_z_xxyz_0[j] + 0.5 * fl1_fx * tpz_0_xxyz_0[j] + 0.5 * fl1_fx * tpz_z_xxy_0[j] - fl1_fgb * fl1_fx * ts_z_xxyz_0[j];
                ...
                tpz_zz_xxzz_0[j] = pa_z[j] * tpz_z_xxzz_0[j] + 0.5 * fl1_fx * tpz_0_xxzz_0[j] + fl1_fx * tpz_z_xxz_0[j] - fl1_fgb * fl1_fx * ts_z_xxzz_0[j];
                ...
                tpz_zz_xyyz_0[j] = pa_z[j] * tpz_z_xyyz_0[j] + 0.5 * fl1_fx * tpz_0_xyyz_0[j] + 0.5 * fl1_fx * tpz_z_xyy_0[j] - fl1_fgb * fl1_fx * ts_z_xyyz_0[j];
                ...
                tpz_zz_xyzz_0[j] = pa_z[j] * tpz_z_xyzz_0[j] + 0.5 * fl1_fx * tpz_0_xyzz_0[j] + fl1_fx * tpz_z_xyz_0[j] - fl1_fgb * fl1_fx * ts_z_xyzz_0[j];
                ...
                tpz_zz_xzzz_0[j] = pa_z[j] * tpz_z_xzzz_0[j] + 0.5 * fl1_fx * tpz_0_xzzz_0[j] + 1.5 * fl1_fx * tpz_z_xzz_0[j] - fl1_fgb * fl1_fx * ts_z_xzzz_0[j];
                ...
                tpz_zz_yyyz_0[j] = pa_z[j] * tpz_z_yyyz_0[j] + 0.5 * fl1_fx * tpz_0_yyyz_0[j] + 0.5 * fl1_fx * tpz_z_yyy_0[j] - fl1_fgb * fl1_fx * ts_z_yyyz_0[j];
                ...
                tpz_zz_yyzz_0[j] = pa_z[j] * tpz_z_yyzz_0[j] + 0.5 * fl1_fx * tpz_0_yyzz_0[j] + fl1_fx * tpz_z_yyz_0[j] - fl1_fgb * fl1_fx * ts_z_yyzz_0[j];
                ...
                tpz_zz_yzzz_0[j] = pa_z[j] * tpz_z_yzzz_0[j] + 0.5 * fl1_fx * tpz_0_yzzz_0[j] + 1.5 * fl1_fx * tpz_z_yzz_0[j] - fl1_fgb * fl1_fx * ts_z_yzzz_0[j];
                ...
                tpz_zz_zzzz_0[j] = pa_z[j] * tpz_z_zzzz_0[j] + 0.5 * fl1_fx * tpz_0_zzzz_0[j] + 2.0 * fl1_fx * tpz_z_zzz_0[j] - fl1_fgb * fl1_fx * ts_z_zzzz_0[j];
            }
    ...
    compLinearMomentumForGD(      CMemBlock2D<double>& primBuffer,
                            ...
                            const int32_t              iContrGto)
    {
        lmomrecfunc::compLinearMomentumForGD_0_45(primBuffer,
                                                  recursionMap,
                                                  osFactors,
                                                  paDistances, 
                                                  braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForGD_45_90(primBuffer,
                                                   recursionMap,
                                                   osFactors,
                                                   paDistances, 
                                                   braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForGD_90_135(primBuffer,
                                                    recursionMap,
                                                    osFactors,
                                                    paDistances, 
                                                    braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForGD_135_180(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForGD_180_225(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForGD_225_270(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
                                 ...
                                 const int32_t              iContrGto)
    {
        ...
        auto pidx_p_4_2_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Linear Momentum"}, 1, true, 
                                                         {4, -1, -1, -1}, {2, -1, -1, -1}, 
                                                         1, 1, 0));
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpx_xxxx_xx_0[j] = pa_x[j] * tpx_xxx_xx_0[j] + 1.5 * fl1_fx * tpx_xx_xx_0[j] + fl1_fx * tpx_xxx_x_0[j] - fl1_fgb * fl1_fx * ts_xxx_xx_0[j];
                ...
                tpx_xxxx_xy_0[j] = pa_x[j] * tpx_xxx_xy_0[j] + 1.5 * fl1_fx * tpx_xx_xy_0[j] + 0.5 * fl1_fx * tpx_xxx_y_0[j] - fl1_fgb * fl1_fx * ts_xxx_xy_0[j];
                ...
                tpx_xxxx_xz_0[j] = pa_x[j] * tpx_xxx_xz_0[j] + 1.5 * fl1_fx * tpx_xx_xz_0[j] + 0.5 * fl1_fx * tpx_xxx_z_0[j] - fl1_fgb * fl1_fx * ts_xxx_xz_0[j];
                ...
                tpx_xxxy_xy_0[j] = pa_x[j] * tpx_xxy_xy_0[j] + fl1_fx * tpx_xy_xy_0[j] + 0.5 * fl1_fx * tpx_xxy_y_0[j] - fl1_fgb * fl1_fx * ts_xxy_xy_0[j];
                ...
                tpx_xxxy_xz_0[j] = pa_x[j] * tpx_xxy_xz_0[j] + fl1_fx * tpx_xy_xz_0[j] + 0.5 * fl1_fx * tpx_xxy_z_0[j] - fl1_fgb * fl1_fx * ts_xxy_xz_0[j];
                ...
                tpx_xxxz_xy_0[j] = pa_x[j] * tpx_xxz_xy_0[j] + fl1_fx * tpx_xz_xy_0[j] + 0.5 * fl1_fx * tpx_xxz_y_0[j] - fl1_fgb * fl1_fx * ts_xxz_xy_0[j];
                ...
                tpx_xxxz_xz_0[j] = pa_x[j] * tpx_xxz_xz_0[j] + fl1_fx * tpx_xz_xz_0[j] + 0.5 * fl1_fx * tpx_xxz_z_0[j] - fl1_fgb * fl1_fx * ts_xxz_xz_0[j];
                                  ...
                                  const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpx_xxyy_xx_0[j] = pa_x[j] * tpx_xyy_xx_0[j] + 0.5 * fl1_fx * tpx_yy_xx_0[j] + fl1_fx * tpx_xyy_x_0[j] - fl1_fgb * fl1_fx * ts_xyy_xx_0[j];
                ...
                tpx_xxyy_xy_0[j] = pa_x[j] * tpx_xyy_xy_0[j] + 0.5 * fl1_fx * tpx_yy_xy_0[j] + 0.5 * fl1_fx * tpx_xyy_y_0[j] - fl1_fgb * fl1_fx * ts_xyy_xy_0[j];
                ...
                tpx_xxyy_xz_0[j] = pa_x[j] * tpx_xyy_xz_0[j] + 0.5 * fl1_fx * tpx_yy_xz_0[j] + 0.5 * fl1_fx * tpx_xyy_z_0[j] - fl1_fgb * fl1_fx * ts_xyy_xz_0[j];
                ...
                tpx_xxyz_xx_0[j] = pa_x[j] * tpx_xyz_xx_0[j] + 0.5 * fl1_fx * tpx_yz_xx_0[j] + fl1_fx * tpx_xyz_x_0[j] - fl1_fgb * fl1_fx * ts_xyz_xx_0[j];
                ...
                tpx_xxyz_xy_0[j] = pa_x[j] * tpx_xyz_xy_0[j] + 0.5 * fl1_fx * tpx_yz_xy_0[j] + 0.5 * fl1_fx * tpx_xyz_y_0[j] - fl1_fgb * fl1_fx * ts_xyz_xy_0[j];
                ...
                tpx_xxyz_xz_0[j] = pa_x[j] * tpx_xyz_xz_0[j] + 0.5 * fl1_fx * tpx_yz_xz_0[j] + 0.5 * fl1_fx * tpx_xyz_z_0[j] - fl1_fgb * fl1_fx * ts_xyz_xz_0[j];
                                   ...
                                   const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpx_xxzz_xx_0[j] = pa_x[j] * tpx_xzz_xx_0[j] + 0.5 * fl1_fx * tpx_zz_xx_0[j] + fl1_fx * tpx_xzz_x_0[j] - fl1_fgb * fl1_fx * ts_xzz_xx_0[j];
                ...
                tpx_xxzz_xy_0[j] = pa_x[j] * tpx_xzz_xy_0[j] + 0.5 * fl1_fx * tpx_zz_xy_0[j] + 0.5 * fl1_fx * tpx_xzz_y_0[j] - fl1_fgb * fl1_fx * ts_xzz_xy_0[j];
                ...
                tpx_xxzz_xz_0[j] = pa_x[j] * tpx_xzz_xz_0[j] + 0.5 * fl1_fx * tpx_zz_xz_0[j] + 0.5 * fl1_fx * tpx_xzz_z_0[j] - fl1_fgb * fl1_fx * ts_xzz_xz_0[j];
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpy_yyyy_xy_0[j] = pa_y[j] * tpy_yyy_xy_0[j] + 1.5 * fl1_fx * tpy_yy_xy_0[j] + 0.5 * fl1_fx * tpy_yyy_x_0[j] - fl1_fgb * fl1_fx * ts_yyy_xy_0[j];
                ...
                tpy_yyyy_yy_0[j] = pa_y[j] * tpy_yyy_yy_0[j] + 1.5 * fl1_fx * tpy_yy_yy_0[j] + fl1_fx * tpy_yyy_y_0[j] - fl1_fgb * fl1_fx * ts_yyy_yy_0[j];
                ...
                tpy_yyyy_yz_0[j] = pa_y[j] * tpy_yyy_yz_0[j] + 1.5 * fl1_fx * tpy_yy_yz_0[j] + 0.5 * fl1_fx * tpy_yyy_z_0[j] - fl1_fgb * fl1_fx * ts_yyy_yz_0[j];
                ...
                tpy_yyyz_xy_0[j] = pa_y[j] * tpy_yyz_xy_0[j] + fl1_fx * tpy_yz_xy_0[j] + 0.5 * fl1_fx * tpy_yyz_x_0[j] - fl1_fgb * fl1_fx * ts_yyz_xy_0[j];
                ...
                tpy_yyyz_yz_0[j] = pa_y[j] * tpy_yyz_yz_0[j] + fl1_fx * tpy_yz_yz_0[j] + 0.5 * fl1_fx * tpy_yyz_z_0[j] - fl1_fgb * fl1_fx * ts_yyz_yz_0[j];
                ...
                tpy_yyzz_xy_0[j] = pa_y[j] * tpy_yzz_xy_0[j] + 0.5 * fl1_fx * tpy_zz_xy_0[j] + 0.5 * fl1_fx * tpy_yzz_x_0[j] - fl1_fgb * fl1_fx * ts_yzz_xy_0[j];
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpy_yyzz_yy_0[j] = pa_y[j] * tpy_yzz_yy_0[j] + 0.5 * fl1_fx * tpy_zz_yy_0[j] + fl1_fx * tpy_yzz_y_0[j] - fl1_fgb * fl1_fx * ts_yzz_yy_0[j];
                ...
                tpy_yyzz_yz_0[j] = pa_y[j] * tpy_yzz_yz_0[j] + 0.5 * fl1_fx * tpy_zz_yz_0[j] + 0.5 * fl1_fx * tpy_yzz_z_0[j] - fl1_fgb * fl1_fx * ts_yzz_yz_0[j];
                ...
                tpz_zzzz_xz_0[j] = pa_z[j] * tpz_zzz_xz_0[j] + 1.5 * fl1_fx * tpz_zz_xz_0[j] + 0.5 * fl1_fx * tpz_zzz_x_0[j] - fl1_fgb * fl1_fx * ts_zzz_xz_0[j];
                ...
                tpz_zzzz_yz_0[j] = pa_z[j] * tpz_zzz_yz_0[j] + 1.5 * fl1_fx * tpz_zz_yz_0[j] + 0.5 * fl1_fx * tpz_zzz_y_0[j] - fl1_fgb * fl1_fx * ts_zzz_yz_0[j];
                ...
                tpz_zzzz_zz_0[j] = pa_z[j] * tpz_zzz_zz_0[j] + 1.5 * fl1_fx * tpz_zz_zz_0[j] + fl1_fx * tpz_zzz_z_0[j] - fl1_fgb * fl1_fx * ts_zzz_zz_0[j];
            }
