...
namespace lmomrecfunc { // lmomrecfunc namespace
    ...
    {
        lmomrecfunc::compLinearMomentumForGF_0_50(primBuffer,
                                                  recursionMap,
                                                  osFactors,
                                                  paDistances, 
                                                  braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForGF_50_100(primBuffer,
                                                    recursionMap,
                                                    osFactors,
                                                    paDistances, 
                                                    braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForGF_100_150(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForGF_150_200(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForGF_200_250(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForGF_250_300(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForGF_300_350(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForGF_350_400(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForGF_400_450(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
                                 ...
                                 const int32_t              iContrGto)
    {
        ...
        auto pidx_p_4_3_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Linear Momentum"}, 1, true, 
                                                         {4, -1, -1, -1}, {3, -1, -1, -1}, 
                                                         1, 1, 0));
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpx_xxxx_xxx_0[j] = pa_x[j] * tpx_xxx_xxx_0[j] + 1.5 * fl1_fx * tpx_xx_xxx_0[j] + 1.5 * fl1_fx * tpx_xxx_xx_0[j] - fl1_fgb * fl1_fx * ts_xxx_xxx_0[j];
                ...
                tpx_xxxx_xxy_0[j] = pa_x[j] * tpx_xxx_xxy_0[j] + 1.5 * fl1_fx * tpx_xx_xxy_0[j] + fl1_fx * tpx_xxx_xy_0[j] - fl1_fgb * fl1_fx * ts_xxx_xxy_0[j];
                ...
                tpx_xxxx_xxz_0[j] = pa_x[j] * tpx_xxx_xxz_0[j] + 1.5 * fl1_fx * tpx_xx_xxz_0[j] + fl1_fx * tpx_xxx_xz_0[j] - fl1_fgb * fl1_fx * ts_xxx_xxz_0[j];
                ...
                tpx_xxxx_xyy_0[j] = pa_x[j] * tpx_xxx_xyy_0[j] + 1.5 * fl1_fx * tpx_xx_xyy_0[j] + 0.5 * fl1_fx * tpx_xxx_yy_0[j] - fl1_fgb * fl1_fx * ts_xxx_xyy_0[j];
                ...
                tpx_xxxx_xyz_0[j] = pa_x[j] * tpx_xxx_xyz_0[j] + 1.5 * fl1_fx * tpx_xx_xyz_0[j] + 0.5 * fl1_fx * tpx_xxx_yz_0[j] - fl1_fgb * fl1_fx * ts_xxx_xyz_0[j];
                ...
                tpx_xxxx_xzz_0[j] = pa_x[j] * tpx_xxx_xzz_0[j] + 1.5 * fl1_fx * tpx_xx_xzz_0[j] + 0.5 * fl1_fx * tpx_xxx_zz_0[j] - fl1_fgb * fl1_fx * ts_xxx_xzz_0[j];
                ...
                tpx_xxxy_xxx_0[j] = pa_x[j] * tpx_xxy_xxx_0[j] + fl1_fx * tpx_xy_xxx_0[j] + 1.5 * fl1_fx * tpx_xxy_xx_0[j] - fl1_fgb * fl1_fx * ts_xxy_xxx_0[j];
                ...
                tpx_xxxy_xyy_0[j] = pa_x[j] * tpx_xxy_xyy_0[j] + fl1_fx * tpx_xy_xyy_0[j] + 0.5 * fl1_fx * tpx_xxy_yy_0[j] - fl1_fgb * fl1_fx * ts_xxy_xyy_0[j];
                ...
                tpx_xxxy_xyz_0[j] = pa_x[j] * tpx_xxy_xyz_0[j] + fl1_fx * tpx_xy_xyz_0[j] + 0.5 * fl1_fx * tpx_xxy_yz_0[j] - fl1_fgb * fl1_fx * ts_xxy_xyz_0[j];
                ...
                tpx_xxxy_xzz_0[j] = pa_x[j] * tpx_xxy_xzz_0[j] + fl1_fx * tpx_xy_xzz_0[j] + 0.5 * fl1_fx * tpx_xxy_zz_0[j] - fl1_fgb * fl1_fx * ts_xxy_xzz_0[j];
                                   ...
                                   const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpx_xxxz_xxx_0[j] = pa_x[j] * tpx_xxz_xxx_0[j] + fl1_fx * tpx_xz_xxx_0[j] + 1.5 * fl1_fx * tpx_xxz_xx_0[j] - fl1_fgb * fl1_fx * ts_xxz_xxx_0[j];
                ...
                tpx_xxxz_xyy_0[j] = pa_x[j] * tpx_xxz_xyy_0[j] + fl1_fx * tpx_xz_xyy_0[j] + 0.5 * fl1_fx * tpx_xxz_yy_0[j] - fl1_fgb * fl1_fx * ts_xxz_xyy_0[j];
                ...
                tpx_xxxz_xyz_0[j] = pa_x[j] * tpx_xxz_xyz_0[j] + fl1_fx * tpx_xz_xyz_0[j] + 0.5 * fl1_fx * tpx_xxz_yz_0[j] - fl1_fgb * fl1_fx * ts_xxz_xyz_0[j];
                ...
                tpx_xxxz_xzz_0[j] = pa_x[j] * tpx_xxz_xzz_0[j] + fl1_fx * tpx_xz_xzz_0[j] + 0.5 * fl1_fx * tpx_xxz_zz_0[j] - fl1_fgb * fl1_fx * ts_xxz_xzz_0[j];
                ...
                tpx_xxyy_xxx_0[j] = pa_x[j] * tpx_xyy_xxx_0[j] + 0.5 * fl1_fx * tpx_yy_xxx_0[j] + 1.5 * fl1_fx * tpx_xyy_xx_0[j] - fl1_fgb * fl1_fx * ts_xyy_xxx_0[j];
                ...
                tpx_xxyy_xxy_0[j] = pa_x[j] * tpx_xyy_xxy_0[j] + 0.5 * fl1_fx * tpx_yy_xxy_0[j] + fl1_fx * tpx_xyy_xy_0[j] - fl1_fgb * fl1_fx * ts_xyy_xxy_0[j];
                ...
                tpx_xxyy_xxz_0[j] = pa_x[j] * tpx_xyy_xxz_0[j] + 0.5 * fl1_fx * tpx_yy_xxz_0[j] + fl1_fx * tpx_xyy_xz_0[j] - fl1_fgb * fl1_fx * ts_xyy_xxz_0[j];
                ...
                tpx_xxyy_xyy_0[j] = pa_x[j] * tpx_xyy_xyy_0[j] + 0.5 * fl1_fx * tpx_yy_xyy_0[j] + 0.5 * fl1_fx * tpx_xyy_yy_0[j] - fl1_fgb * fl1_fx * ts_xyy_xyy_0[j];
            }
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpx_xxyy_xyz_0[j] = pa_x[j] * tpx_xyy_xyz_0[j] + 0.5 * fl1_fx * tpx_yy_xyz_0[j] + 0.5 * fl1_fx * tpx_xyy_yz_0[j] - fl1_fgb * fl1_fx * ts_xyy_xyz_0[j];
                ...
                tpx_xxyy_xzz_0[j] = pa_x[j] * tpx_xyy_xzz_0[j] + 0.5 * fl1_fx * tpx_yy_xzz_0[j] + 0.5 * fl1_fx * tpx_xyy_zz_0[j] - fl1_fgb * fl1_fx * ts_xyy_xzz_0[j];
                ...
                tpx_xxyz_xxx_0[j] = pa_x[j] * tpx_xyz_xxx_0[j] + 0.5 * fl1_fx * tpx_yz_xxx_0[j] + 1.5 * fl1_fx * tpx_xyz_xx_0[j] - fl1_fgb * fl1_fx * ts_xyz_xxx_0[j];
                ...
                tpx_xxyz_xxy_0[j] = pa_x[j] * tpx_xyz_xxy_0[j] + 0.5 * fl1_fx * tpx_yz_xxy_0[j] + fl1_fx * tpx_xyz_xy_0[j] - fl1_fgb * fl1_fx * ts_xyz_xxy_0[j];
                ...
                tpx_xxyz_xxz_0[j] = pa_x[j] * tpx_xyz_xxz_0[j] + 0.5 * fl1_fx * tpx_yz_xxz_0[j] + fl1_fx * tpx_xyz_xz_0[j] - fl1_fgb * fl1_fx * ts_xyz_xxz_0[j];
                ...
                tpx_xxyz_xyy_0[j] = pa_x[j] * tpx_xyz_xyy_0[j] + 0.5 * fl1_fx * tpx_yz_xyy_0[j] + 0.5 * fl1_fx * tpx_xyz_yy_0[j] - fl1_fgb * fl1_fx * ts_xyz_xyy_0[j];
                ...
                tpx_xxyz_xyz_0[j] = pa_x[j] * tpx_xyz_xyz_0[j] + 0.5 * fl1_fx * tpx_yz_xyz_0[j] + 0.5 * fl1_fx * tpx_xyz_yz_0[j] - fl1_fgb * fl1_fx * ts_xyz_xyz_0[j];
                ...
                tpx_xxyz_xzz_0[j] = pa_x[j] * tpx_xyz_xzz_0[j] + 0.5 * fl1_fx * tpx_yz_xzz_0[j] + 0.5 * fl1_fx * tpx_xyz_zz_0[j] - fl1_fgb * fl1_fx * ts_xyz_xzz_0[j];
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpx_xxzz_xxx_0[j] = pa_x[j] * tpx_xzz_xxx_0[j] + 0.5 * fl1_fx * tpx_zz_xxx_0[j] + 1.5 * fl1_fx * tpx_xzz_xx_0[j] - fl1_fgb * fl1_fx * ts_xzz_xxx_0[j];
                ...
                tpx_xxzz_xxy_0[j] = pa_x[j] * tpx_xzz_xxy_0[j] + 0.5 * fl1_fx * tpx_zz_xxy_0[j] + fl1_fx * tpx_xzz_xy_0[j] - fl1_fgb * fl1_fx * ts_xzz_xxy_0[j];
                ...
                tpx_xxzz_xxz_0[j] = pa_x[j] * tpx_xzz_xxz_0[j] + 0.5 * fl1_fx * tpx_zz_xxz_0[j] + fl1_fx * tpx_xzz_xz_0[j] - fl1_fgb * fl1_fx * ts_xzz_xxz_0[j];
                ...
                tpx_xxzz_xyy_0[j] = pa_x[j] * tpx_xzz_xyy_0[j] + 0.5 * fl1_fx * tpx_zz_xyy_0[j] + 0.5 * fl1_fx * tpx_xzz_yy_0[j] - fl1_fgb * fl1_fx * ts_xzz_xyy_0[j];
                ...
                tpx_xxzz_xyz_0[j] = pa_x[j] * tpx_xzz_xyz_0[j] + 0.5 * fl1_fx * tpx_zz_xyz_0[j] + 0.5 * fl1_fx * tpx_xzz_yz_0[j] - fl1_fgb * fl1_fx * ts_xzz_xyz_0[j];
                ...
                tpx_xxzz_xzz_0[j] = pa_x[j] * tpx_xzz_xzz_0[j] + 0.5 * fl1_fx * tpx_zz_xzz_0[j] + 0.5 * fl1_fx * tpx_xzz_zz_0[j] - fl1_fgb * fl1_fx * ts_xzz_xzz_0[j];
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpy_yyyy_xxy_0[j] = pa_y[j] * tpy_yyy_xxy_0[j] + 1.5 * fl1_fx * tpy_yy_xxy_0[j] + 0.5 * fl1_fx * tpy_yyy_xx_0[j] - fl1_fgb * fl1_fx * ts_yyy_xxy_0[j];
                ...
                tpy_yyyy_xyy_0[j] = pa_y[j] * tpy_yyy_xyy_0[j] + 1.5 * fl1_fx * tpy_yy_xyy_0[j] + fl1_fx * tpy_yyy_xy_0[j] - fl1_fgb * fl1_fx * ts_yyy_xyy_0[j];
                ...
                tpy_yyyy_xyz_0[j] = pa_y[j] * tpy_yyy_xyz_0[j] + 1.5 * fl1_fx * tpy_yy_xyz_0[j] + 0.5 * fl1_fx * tpy_yyy_xz_0[j] - fl1_fgb * fl1_fx * ts_yyy_xyz_0[j];
                ...
                tpy_yyyy_yyy_0[j] = pa_y[j] * tpy_yyy_yyy_0[j] + 1.5 * fl1_fx * tpy_yy_yyy_0[j] + 1.5 * fl1_fx * tpy_yyy_yy_0[j] - fl1_fgb * fl1_fx * ts_yyy_yyy_0[j];
                ...
                tpy_yyyy_yyz_0[j] = pa_y[j] * tpy_yyy_yyz_0[j] + 1.5 * fl1_fx * tpy_yy_yyz_0[j] + fl1_fx * tpy_yyy_yz_0[j] - fl1_fgb * fl1_fx * ts_yyy_yyz_0[j];
                ...
                tpy_yyyy_yzz_0[j] = pa_y[j] * tpy_yyy_yzz_0[j] + 1.5 * fl1_fx * tpy_yy_yzz_0[j] + 0.5 * fl1_fx * tpy_yyy_zz_0[j] - fl1_fgb * fl1_fx * ts_yyy_yzz_0[j];
                ...
                tpy_yyyz_xxy_0[j] = pa_y[j] * tpy_yyz_xxy_0[j] + fl1_fx * tpy_yz_xxy_0[j] + 0.5 * fl1_fx * tpy_yyz_xx_0[j] - fl1_fgb * fl1_fx * ts_yyz_xxy_0[j];
                ...
                tpy_yyyz_xyz_0[j] = pa_y[j] * tpy_yyz_xyz_0[j] + fl1_fx * tpy_yz_xyz_0[j] + 0.5 * fl1_fx * tpy_yyz_xz_0[j] - fl1_fgb * fl1_fx * ts_yyz_xyz_0[j];
                ...
                tpy_yyyz_yyy_0[j] = pa_y[j] * tpy_yyz_yyy_0[j] + fl1_fx * tpy_yz_yyy_0[j] + 1.5 * fl1_fx * tpy_yyz_yy_0[j] - fl1_fgb * fl1_fx * ts_yyz_yyy_0[j];
            }
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpy_yyyz_yzz_0[j] = pa_y[j] * tpy_yyz_yzz_0[j] + fl1_fx * tpy_yz_yzz_0[j] + 0.5 * fl1_fx * tpy_yyz_zz_0[j] - fl1_fgb * fl1_fx * ts_yyz_yzz_0[j];
                ...
                tpy_yyzz_xxy_0[j] = pa_y[j] * tpy_yzz_xxy_0[j] + 0.5 * fl1_fx * tpy_zz_xxy_0[j] + 0.5 * fl1_fx * tpy_yzz_xx_0[j] - fl1_fgb * fl1_fx * ts_yzz_xxy_0[j];
                ...
                tpy_yyzz_xyy_0[j] = pa_y[j] * tpy_yzz_xyy_0[j] + 0.5 * fl1_fx * tpy_zz_xyy_0[j] + fl1_fx * tpy_yzz_xy_0[j] - fl1_fgb * fl1_fx * ts_yzz_xyy_0[j];
                ...
                tpy_yyzz_xyz_0[j] = pa_y[j] * tpy_yzz_xyz_0[j] + 0.5 * fl1_fx * tpy_zz_xyz_0[j] + 0.5 * fl1_fx * tpy_yzz_xz_0[j] - fl1_fgb * fl1_fx * ts_yzz_xyz_0[j];
                ...
                tpy_yyzz_yyy_0[j] = pa_y[j] * tpy_yzz_yyy_0[j] + 0.5 * fl1_fx * tpy_zz_yyy_0[j] + 1.5 * fl1_fx * tpy_yzz_yy_0[j] - fl1_fgb * fl1_fx * ts_yzz_yyy_0[j];
                ...
                tpy_yyzz_yyz_0[j] = pa_y[j] * tpy_yzz_yyz_0[j] + 0.5 * fl1_fx * tpy_zz_yyz_0[j] + fl1_fx * tpy_yzz_yz_0[j] - fl1_fgb * fl1_fx * ts_yzz_yyz_0[j];
                ...
                tpy_yyzz_yzz_0[j] = pa_y[j] * tpy_yzz_yzz_0[j] + 0.5 * fl1_fx * tpy_zz_yzz_0[j] + 0.5 * fl1_fx * tpy_yzz_zz_0[j] - fl1_fgb * fl1_fx * ts_yzz_yzz_0[j];
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpz_zzzz_xxz_0[j] = pa_z[j] * tpz_zzz_xxz_0[j] + 1.5 * fl1_fx * tpz_zz_xxz_0[j] + 0.5 * fl1_fx * tpz_zzz_xx_0[j] - fl1_fgb * fl1_fx * ts_zzz_xxz_0[j];
                ...
                tpz_zzzz_xyz_0[j] = pa_z[j] * tpz_zzz_xyz_0[j] + 1.5 * fl1_fx * tpz_zz_xyz_0[j] + 0.5 * fl1_fx * tpz_zzz_xy_0[j] - fl1_fgb * fl1_fx * ts_zzz_xyz_0[j];
                ...
                tpz_zzzz_xzz_0[j] = pa_z[j] * tpz_zzz_xzz_0[j] + 1.5 * fl1_fx * tpz_zz_xzz_0[j] + fl1_fx * tpz_zzz_xz_0[j] - fl1_fgb * fl1_fx * ts_zzz_xzz_0[j];
                ...
                tpz_zzzz_yyz_0[j] = pa_z[j] * tpz_zzz_yyz_0[j] + 1.5 * fl1_fx * tpz_zz_yyz_0[j] + 0.5 * fl1_fx * tpz_zzz_yy_0[j] - fl1_fgb * fl1_fx * ts_zzz_yyz_0[j];
                ...
                tpz_zzzz_yzz_0[j] = pa_z[j] * tpz_zzz_yzz_0[j] + 1.5 * fl1_fx * tpz_zz_yzz_0[j] + fl1_fx * tpz_zzz_yz_0[j] - fl1_fgb * fl1_fx * ts_zzz_yzz_0[j];
                ...
                tpz_zzzz_zzz_0[j] = pa_z[j] * tpz_zzz_zzz_0[j] + 1.5 * fl1_fx * tpz_zz_zzz_0[j] + 1.5 * fl1_fx * tpz_zzz_zz_0[j] - fl1_fgb * fl1_fx * ts_zzz_zzz_0[j];
            }
