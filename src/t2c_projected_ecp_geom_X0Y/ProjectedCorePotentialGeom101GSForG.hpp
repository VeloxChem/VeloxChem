#ifndef ProjectedCorePotentialGeom101GSForG_hpp
#define ProjectedCorePotentialGeom101GSForG_hpp
...
template <class T>
auto
comp_projected_core_potential_geom_101_gs_for_g(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2pecp::comp_prim_projected_core_potential_gp_g(pbuffer, 196, 13, 31, 345, 355, 606, 624, 735, 781, 1112, 1122, 1641, 1687, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_hp_g(pbuffer, 241, 31, 196, 385, 400, 624, 654, 781, 841, 1152, 1167, 1687, 1747, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
...
#endif /* ProjectedCorePotentialGeom101GSForG_hpp */
