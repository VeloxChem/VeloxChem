#ifndef ProjectedCorePotentialGeom101GSForP_hpp
#define ProjectedCorePotentialGeom101GSForP_hpp
...
template <class T>
auto
comp_projected_core_potential_geom_101_gs_for_p(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2pecp::comp_prim_projected_core_potential_gp_p(pbuffer, 196, 13, 31, 345, 355, 461, 479, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);

                    t2pecp::comp_prim_projected_core_potential_gp_p(pbuffer, 509, 461, 479, 595, 605, 651, 669, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);

                    t2pecp::comp_prim_projected_core_potential_hp_p(pbuffer, 241, 31, 196, 385, 400, 479, 509, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
...
#endif /* ProjectedCorePotentialGeom101GSForP_hpp */
