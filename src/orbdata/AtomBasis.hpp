...
class CAtomBasis
{
   ...
   public:
     ...
     */
    auto
    setIdentifier(const int64_t identifier) -> void;
     ...
     */
    auto
    setEffectiveCorePotentialLabel(const std::string& label) -> void;
     ...
     */
    auto
    add(const CBasisFunction& function) -> void;
     ...
     */
    auto
    reduceToValenceBasis() const -> CAtomBasis;
     ...
     */
    auto
    getEffectiveCorePotentialLabel() const -> std::string;
     ...
     */
    auto
    needEffectiveCorePotential() const -> bool;
    ...
    */
     ...
     */
    auto
    getContractionString() const -> std::string;
     ...
     */
    auto
    getPrimitivesString() const -> std::string;
};
