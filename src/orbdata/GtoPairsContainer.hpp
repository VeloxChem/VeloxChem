...
class CGtoPairsContainer
{
   ...
   public:
     ...
     */
    CGtoPairsContainer(const CMolecule& molecule, const CMolecularBasis& basis, const double threshold);
    ...
    /**
     ...
     @param source the GTOs pairs container object.
     */
    friend std::ostream& operator<<(std::ostream& output, const CGtoPairsContainer& source);
};
