...
class CMolecularOrbitals
{
   ...
   public:
     ...
     */
    CDenseMatrix alphaOrbitals(const int32_t iMolecularOrbital, const int32_t nMolecularOrbitals) const;
     ...
     */
    CDenseMatrix betaOrbitals(const int32_t iMolecularOrbital, const int32_t nMolecularOrbitals) const;
     ...
     */
    CAODensityMatrix getRestrictedPairDensity(const int32_t iMolecularOrbital, const int32_t jMolecularOrbital) const;
    ...
    /**
     ...
     @return the AO pair density matrix.
     */
    CAODensityMatrix getRestrictedPairDensity(const std::vector<int32_t>& iMolecularOrbitals, const std::vector<int32_t>& jMolecularOrbitals) const;
     ...
     */
    CDenseMatrix transform(const CDenseMatrix& aoMatrix, const szblock spinPair) const;
