...
class CGtoBlock
{
   ...
   public:
     ...
     */
    auto
    getCoordinates() const -> std::vector<TPoint3D>;
     ...
     */
    auto
    getOrbitalIndexes() const -> std::vector<int64_t>;
     ...
     */
    auto
    getNumberOfPrimitives() const -> int64_t;
     ...
     */
    auto
    getNumberOfBasisFunctions() const -> int64_t;
};
