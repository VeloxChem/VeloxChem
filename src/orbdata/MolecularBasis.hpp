...
class CMolecularBasis
{
     ...
     */
    auto
    _getLabelsFrequencyMap() const -> std::unordered_map<std::string, int64_t>;
   ...
   public:
     ...
     */
    CMolecularBasis(const std::vector<CAtomBasis>& basis_sets,
     ...
     */
    auto
    add(const CAtomBasis& basis) -> void;
     ...
     */
    auto
    reduceToValenceBasis() const -> CMolecularBasis;
     ...
     */
    auto
    getBasisSets() const -> std::vector<CAtomBasis>;
     ...
     */
    auto
    getBasisSetsIndexes() const -> std::vector<int64_t>;
     ...
     */
    auto
    getMaxAngularMomentum() const -> int64_t;
     ...
     */
    auto
    getMaxAngularMomentum(const std::vector<int64_t>& atoms) const -> int64_t;
     ...
     */
    auto
    getBasisFunctions() const -> std::vector<CBasisFunction>;
     ...
     */
    auto
    getBasisFunctions(const int64_t angmom) const -> std::vector<CBasisFunction>;
     ...
     */
    auto
    getBasisFunctions(const int64_t angmom,
     ...
     */
    auto
    getBasisFunctions(const std::vector<int64_t>& atoms) const -> std::vector<CBasisFunction>;
     ...
     */
    auto
    getBasisFunctions(const std::vector<int64_t>& atoms,
     ...
     */
    auto
    getAtomicIndexes() const -> std::vector<int64_t>;
     ...
     */
    auto
    getAtomicIndexes(const int64_t angmom) const -> std::vector<int64_t>;
     ...
     */
    auto
    getAtomicIndexes(const int64_t angmom,
     ...
     */
    auto
    getAtomicIndexes(const std::vector<int64_t>& atoms) const -> std::vector<int64_t>;
     ...
     */
    auto
    getAtomicIndexes(const std::vector<int64_t>& atoms,
     ...
     */
    auto
    getNumberOfBasisFunctions(const int64_t angmom) const -> int64_t;
     ...
     */
    auto
    getNumberOfBasisFunctions(const int64_t angmom,
     ...
     */
    auto
    getNumberOfBasisFunctions(const std::vector<int64_t>& atoms,
     ...
     */
    auto
    getNumberOfPrimitiveFunctions(const int64_t angmom) const -> int64_t;
     ...
     */
    auto
    getNumberOfPrimitiveFunctions(const std::vector<int64_t>& atoms,
                                  const int64_t               angmom) const -> int64_t;
    ...
    */
    auto
    getContractionDepths(const int64_t angmom) const -> std::set<int64_t>;
    ...
    */
    auto
    getContractionDepths(const std::vector<int64_t>& atoms,
     ...
     */
    auto
    getDimensionsOfBasis() const -> int64_t;
     ...
     */
    auto
    getDimensionsOfBasis(const int64_t angmom) const -> int64_t;
     ...
     */
    auto
    getDimensionsOfPrimitiveBasis() const -> int64_t;
     ...
     */
    auto
    getIndexMap(const int64_t angmom,
                const int64_t npgtos) const -> std::vector<int64_t>;
     ...
     */
    auto
    getIndexMap(const std::vector<int64_t>& atoms,
                const int64_t               angmom,
                const int64_t               npgtos) const -> std::vector<int64_t>;
     ...
     */
    auto
    printBasis(const std::string& title) const -> std::string;
