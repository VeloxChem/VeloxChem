...
int32_t
to_SphericalComponents(const int32_t angularMomentumA, const int32_t angularMomentumB)
{
...
int32_t
to_CartesianComponents(const int32_t angularMomentumA, const int32_t angularMomentumB)
{
...
std::string
getStringOfAngularMomentum(const int32_t angularMomentum, const int32_t sphericalComponent)

{
    ...
    {
        std::array<std::string, 7> clist({"f-3", "f-2", "f-1", "f0 ", "f+1", "f+2", "f+3"});
    ...
    {
        std::array<std::string, 9> clist({"g-4", "g-3", "g-2", "g-1", "g0 ", "g+1", "g+2", "g+3", "g+4"});
    ...
    {
        std::array<std::string, 11> clist({"h-5", "h-4", "h-3", "h-2", "h-1", "h0 ", "h+1", "h+2", "h+3", "h+4", "h+5"});
    ...
    {
        std::array<std::string, 13> clist({"i-6", "i-5", "i-4", "i-3", "i-2", "i-1", "i0 ", "i+1", "i+2", "i+3", "i+4", "i+5", "i+6"});
