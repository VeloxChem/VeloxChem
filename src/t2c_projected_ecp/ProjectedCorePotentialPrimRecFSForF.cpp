                                        ...
                                        const double c_exp) -> void
{
    ...
    #pragma omp simd aligned(b_exps, rb_x, rb_y, rb_z, tg_x_0_f_0_0_0, tg_x_0_f_1_0_0, tg_xx_0_d_0_0_1, tg_xx_0_f_0_0_0, tg_xx_0_f_1_0_0, tg_xx_0_p_1_0_1, tg_xx_0_s_1_1_1, tg_xxx_0_f_0_0_0, tg_xxy_0_f_0_0_0, tg_xxz_0_f_0_0_0, tg_xyy_0_f_0_0_0, tg_xyz_0_f_0_0_0, tg_xzz_0_f_0_0_0, tg_y_0_f_0_0_0, tg_y_0_f_1_0_0, tg_yy_0_d_0_0_1, tg_yy_0_f_0_0_0, tg_yy_0_f_1_0_0, tg_yy_0_p_1_0_1, tg_yy_0_s_1_1_1, tg_yyy_0_f_0_0_0, tg_yyz_0_f_0_0_0, tg_yz_0_d_0_0_1, tg_yz_0_f_0_0_0, tg_yz_0_f_1_0_0, tg_yz_0_p_1_0_1, tg_yz_0_s_1_1_1, tg_yzz_0_f_0_0_0, tg_z_0_f_0_0_0, tg_z_0_f_1_0_0, tg_zz_0_d_0_0_1, tg_zz_0_f_0_0_0, tg_zz_0_f_1_0_0, tg_zz_0_p_1_0_1, tg_zz_0_s_1_1_1, tg_zzz_0_f_0_0_0  : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        tg_xxx_0_f_0_0_0[i] = 2.0 * tg_x_0_f_0_0_0[i] * fzi_0 + 2.0 * tg_x_0_f_1_0_0[i] * fbzi_0 * fbzi_0 + 7.0 * tg_xx_0_s_1_1_1[i] * f2abz_0 * f2abz_0 * rb_x[i] * fbzi_0 - 7.0 * tg_xx_0_p_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 - 7.0 * tg_xx_0_p_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 7.0 * tg_xx_0_d_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_xx_0_f_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_xx_0_f_0_0_0[i] * a_x * faz_0;
        ...
        tg_yyy_0_f_0_0_0[i] = 2.0 * tg_y_0_f_0_0_0[i] * fzi_0 + 2.0 * tg_y_0_f_1_0_0[i] * fbzi_0 * fbzi_0 + 7.0 * tg_yy_0_s_1_1_1[i] * f2abz_0 * f2abz_0 * rb_y[i] * fbzi_0 - 7.0 * tg_yy_0_p_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 - 7.0 * tg_yy_0_p_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 7.0 * tg_yy_0_d_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_yy_0_f_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_yy_0_f_0_0_0[i] * a_y * faz_0;
        ...
        tg_zzz_0_f_0_0_0[i] = 2.0 * tg_z_0_f_0_0_0[i] * fzi_0 + 2.0 * tg_z_0_f_1_0_0[i] * fbzi_0 * fbzi_0 + 7.0 * tg_zz_0_s_1_1_1[i] * f2abz_0 * f2abz_0 * rb_z[i] * fbzi_0 - 7.0 * tg_zz_0_p_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 - 7.0 * tg_zz_0_p_1_0_1[i] * f2abz_0 * a_z * fbzi_0 + 7.0 * tg_zz_0_d_0_0_1[i] * rb_z[i] * fbzi_0 + 2.0 * tg_zz_0_f_1_0_0[i] * a_z * a_exp * fbzi_0 * fbzi_0 + tg_zz_0_f_0_0_0[i] * a_z * faz_0;
    }
