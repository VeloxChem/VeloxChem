#ifndef ProjectedCorePotentialPrimRecPFForD
#define ProjectedCorePotentialPrimRecPFForD
...
/// @brief Computes primitive [P|U_l|F]_D integrals with D projectors for set of data buffers.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_pf_d_0_0_0 The index of integral in primitive integrals buffer.
...
/// @param idx_sf_d_1_0_0 The index of integral in primitive integrals buffer.
/// @param idx_sf_s_1_0_1 The index of integral in primitive integrals buffer.
...
#endif /* ProjectedCorePotentialPrimRecPFForD */
