#ifndef ProjectedCorePotentialPrimRecSDForF
#define ProjectedCorePotentialPrimRecSDForF
...
/// @brief Computes primitive [S|U_l|D]_F integrals with F projectors for set of data buffers.
...
#endif /* ProjectedCorePotentialPrimRecSDForF */
