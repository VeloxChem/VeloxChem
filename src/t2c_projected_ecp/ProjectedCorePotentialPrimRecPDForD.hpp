#ifndef ProjectedCorePotentialPrimRecPDForD
#define ProjectedCorePotentialPrimRecPDForD
...
/// @brief Computes primitive [P|U_l|D]_D integrals with D projectors for set of data buffers.
...
#endif /* ProjectedCorePotentialPrimRecPDForD */
