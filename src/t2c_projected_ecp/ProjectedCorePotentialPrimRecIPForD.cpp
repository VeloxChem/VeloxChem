                                        ...
                                        const double c_exp) -> void
{
    ...
    auto tg_xxxxy_z_d_1_0_0 = pbuffer.data(idx_hp_d_1_0_0 + 5);

    auto tg_xxxxz_x_d_1_0_0 = pbuffer.data(idx_hp_d_1_0_0 + 6);

    auto tg_xxxxz_y_d_1_0_0 = pbuffer.data(idx_hp_d_1_0_0 + 7);
    ...
    auto tg_xxxyz_x_d_1_0_0 = pbuffer.data(idx_hp_d_1_0_0 + 12);

    auto tg_xxxyz_y_d_1_0_0 = pbuffer.data(idx_hp_d_1_0_0 + 13);

    auto tg_xxxyz_z_d_1_0_0 = pbuffer.data(idx_hp_d_1_0_0 + 14);
    ...
    auto tg_xxyyz_x_d_1_0_0 = pbuffer.data(idx_hp_d_1_0_0 + 21);

    auto tg_xxyyz_y_d_1_0_0 = pbuffer.data(idx_hp_d_1_0_0 + 22);

    auto tg_xxyyz_z_d_1_0_0 = pbuffer.data(idx_hp_d_1_0_0 + 23);

    auto tg_xxyzz_x_d_1_0_0 = pbuffer.data(idx_hp_d_1_0_0 + 24);

    auto tg_xxyzz_y_d_1_0_0 = pbuffer.data(idx_hp_d_1_0_0 + 25);

    auto tg_xxyzz_z_d_1_0_0 = pbuffer.data(idx_hp_d_1_0_0 + 26);
    ...
    auto tg_xyyyz_x_d_1_0_0 = pbuffer.data(idx_hp_d_1_0_0 + 33);

    auto tg_xyyyz_y_d_1_0_0 = pbuffer.data(idx_hp_d_1_0_0 + 34);

    auto tg_xyyyz_z_d_1_0_0 = pbuffer.data(idx_hp_d_1_0_0 + 35);

    auto tg_xyyzz_x_d_1_0_0 = pbuffer.data(idx_hp_d_1_0_0 + 36);

    auto tg_xyyzz_y_d_1_0_0 = pbuffer.data(idx_hp_d_1_0_0 + 37);

    auto tg_xyyzz_z_d_1_0_0 = pbuffer.data(idx_hp_d_1_0_0 + 38);

    auto tg_xyzzz_x_d_1_0_0 = pbuffer.data(idx_hp_d_1_0_0 + 39);

    auto tg_xyzzz_y_d_1_0_0 = pbuffer.data(idx_hp_d_1_0_0 + 40);

    auto tg_xyzzz_z_d_1_0_0 = pbuffer.data(idx_hp_d_1_0_0 + 41);
    ...
    auto tg_yyyyz_x_d_1_0_0 = pbuffer.data(idx_hp_d_1_0_0 + 48);
    ...
    auto tg_xxxxy_z_s_1_0_1 = pbuffer.data(idx_hp_s_1_0_1 + 5);

    auto tg_xxxxz_x_s_1_0_1 = pbuffer.data(idx_hp_s_1_0_1 + 6);

    auto tg_xxxxz_y_s_1_0_1 = pbuffer.data(idx_hp_s_1_0_1 + 7);
    ...
    auto tg_xxxyz_x_s_1_0_1 = pbuffer.data(idx_hp_s_1_0_1 + 12);

    auto tg_xxxyz_y_s_1_0_1 = pbuffer.data(idx_hp_s_1_0_1 + 13);

    auto tg_xxxyz_z_s_1_0_1 = pbuffer.data(idx_hp_s_1_0_1 + 14);
    ...
    auto tg_xxyyz_x_s_1_0_1 = pbuffer.data(idx_hp_s_1_0_1 + 21);

    auto tg_xxyyz_y_s_1_0_1 = pbuffer.data(idx_hp_s_1_0_1 + 22);

    auto tg_xxyyz_z_s_1_0_1 = pbuffer.data(idx_hp_s_1_0_1 + 23);

    auto tg_xxyzz_x_s_1_0_1 = pbuffer.data(idx_hp_s_1_0_1 + 24);

    auto tg_xxyzz_y_s_1_0_1 = pbuffer.data(idx_hp_s_1_0_1 + 25);

    auto tg_xxyzz_z_s_1_0_1 = pbuffer.data(idx_hp_s_1_0_1 + 26);
    ...
    auto tg_xyyyz_x_s_1_0_1 = pbuffer.data(idx_hp_s_1_0_1 + 33);

    auto tg_xyyyz_y_s_1_0_1 = pbuffer.data(idx_hp_s_1_0_1 + 34);

    auto tg_xyyyz_z_s_1_0_1 = pbuffer.data(idx_hp_s_1_0_1 + 35);

    auto tg_xyyzz_x_s_1_0_1 = pbuffer.data(idx_hp_s_1_0_1 + 36);

    auto tg_xyyzz_y_s_1_0_1 = pbuffer.data(idx_hp_s_1_0_1 + 37);

    auto tg_xyyzz_z_s_1_0_1 = pbuffer.data(idx_hp_s_1_0_1 + 38);

    auto tg_xyzzz_x_s_1_0_1 = pbuffer.data(idx_hp_s_1_0_1 + 39);

    auto tg_xyzzz_y_s_1_0_1 = pbuffer.data(idx_hp_s_1_0_1 + 40);

    auto tg_xyzzz_z_s_1_0_1 = pbuffer.data(idx_hp_s_1_0_1 + 41);
    ...
    auto tg_yyyyz_x_s_1_0_1 = pbuffer.data(idx_hp_s_1_0_1 + 48);
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        tg_xxxxxx_x_d_0_0_0[i] = -25.0 / 2.0 * tg_xxxx_x_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 5.0 * tg_xxxx_x_d_0_0_0[i] * fzi_0 + 5.0 * tg_xxxx_x_d_1_0_0[i] * fbzi_0 * fbzi_0 + 5.0 / 2.0 * tg_xxxxx_0_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_xxxxx_x_s_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 5.0 * tg_xxxxx_x_p_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_xxxxx_x_d_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_xxxxx_x_d_0_0_0[i] * a_x * faz_0;

        tg_xxxxxx_y_d_0_0_0[i] = -25.0 / 2.0 * tg_xxxx_y_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 5.0 * tg_xxxx_y_d_0_0_0[i] * fzi_0 + 5.0 * tg_xxxx_y_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_xxxxx_y_s_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 5.0 * tg_xxxxx_y_p_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_xxxxx_y_d_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_xxxxx_y_d_0_0_0[i] * a_x * faz_0;

        tg_xxxxxx_z_d_0_0_0[i] = -25.0 / 2.0 * tg_xxxx_z_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 5.0 * tg_xxxx_z_d_0_0_0[i] * fzi_0 + 5.0 * tg_xxxx_z_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_xxxxx_z_s_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 5.0 * tg_xxxxx_z_p_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_xxxxx_z_d_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_xxxxx_z_d_0_0_0[i] * a_x * faz_0;
        ...
        tg_xxxxyy_x_d_0_0_0[i] = -5.0 / 2.0 * tg_xxxx_x_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + tg_xxxx_x_d_0_0_0[i] * fzi_0 + tg_xxxx_x_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_xxxxy_x_s_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 5.0 * tg_xxxxy_x_p_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_xxxxy_x_d_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_xxxxy_x_d_0_0_0[i] * a_y * faz_0;

        tg_xxxxyy_y_d_0_0_0[i] = -15.0 / 2.0 * tg_xxyy_y_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 3.0 * tg_xxyy_y_d_0_0_0[i] * fzi_0 + 3.0 * tg_xxyy_y_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_xxxyy_y_s_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 5.0 * tg_xxxyy_y_p_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_xxxyy_y_d_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_xxxyy_y_d_0_0_0[i] * a_x * faz_0;

        tg_xxxxyy_z_d_0_0_0[i] = -15.0 / 2.0 * tg_xxyy_z_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 3.0 * tg_xxyy_z_d_0_0_0[i] * fzi_0 + 3.0 * tg_xxyy_z_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_xxxyy_z_s_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 5.0 * tg_xxxyy_z_p_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_xxxyy_z_d_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_xxxyy_z_d_0_0_0[i] * a_x * faz_0;
        ...
        tg_xxxxzz_x_d_0_0_0[i] = -5.0 / 2.0 * tg_xxxx_x_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + tg_xxxx_x_d_0_0_0[i] * fzi_0 + tg_xxxx_x_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_xxxxz_x_s_1_0_1[i] * f2abz_0 * a_z * fbzi_0 + 5.0 * tg_xxxxz_x_p_0_0_1[i] * rb_z[i] * fbzi_0 + 2.0 * tg_xxxxz_x_d_1_0_0[i] * a_z * a_exp * fbzi_0 * fbzi_0 + tg_xxxxz_x_d_0_0_0[i] * a_z * faz_0;

        tg_xxxxzz_y_d_0_0_0[i] = -15.0 / 2.0 * tg_xxzz_y_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 3.0 * tg_xxzz_y_d_0_0_0[i] * fzi_0 + 3.0 * tg_xxzz_y_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_xxxzz_y_s_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 5.0 * tg_xxxzz_y_p_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_xxxzz_y_d_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_xxxzz_y_d_0_0_0[i] * a_x * faz_0;

        tg_xxxxzz_z_d_0_0_0[i] = -15.0 / 2.0 * tg_xxzz_z_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 3.0 * tg_xxzz_z_d_0_0_0[i] * fzi_0 + 3.0 * tg_xxzz_z_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_xxxzz_z_s_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 5.0 * tg_xxxzz_z_p_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_xxxzz_z_d_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_xxxzz_z_d_0_0_0[i] * a_x * faz_0;

        tg_xxxyyy_x_d_0_0_0[i] = -5.0 * tg_xxxy_x_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 2.0 * tg_xxxy_x_d_0_0_0[i] * fzi_0 + 2.0 * tg_xxxy_x_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_xxxyy_x_s_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 5.0 * tg_xxxyy_x_p_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_xxxyy_x_d_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_xxxyy_x_d_0_0_0[i] * a_y * faz_0;

        tg_xxxyyy_y_d_0_0_0[i] = -5.0 * tg_xyyy_y_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 2.0 * tg_xyyy_y_d_0_0_0[i] * fzi_0 + 2.0 * tg_xyyy_y_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_xxyyy_y_s_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 5.0 * tg_xxyyy_y_p_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_xxyyy_y_d_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_xxyyy_y_d_0_0_0[i] * a_x * faz_0;

        tg_xxxyyy_z_d_0_0_0[i] = -5.0 * tg_xyyy_z_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 2.0 * tg_xyyy_z_d_0_0_0[i] * fzi_0 + 2.0 * tg_xyyy_z_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_xxyyy_z_s_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 5.0 * tg_xxyyy_z_p_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_xxyyy_z_d_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_xxyyy_z_d_0_0_0[i] * a_x * faz_0;
        ...
        tg_xxxzzz_x_d_0_0_0[i] = -5.0 * tg_xxxz_x_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 2.0 * tg_xxxz_x_d_0_0_0[i] * fzi_0 + 2.0 * tg_xxxz_x_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_xxxzz_x_s_1_0_1[i] * f2abz_0 * a_z * fbzi_0 + 5.0 * tg_xxxzz_x_p_0_0_1[i] * rb_z[i] * fbzi_0 + 2.0 * tg_xxxzz_x_d_1_0_0[i] * a_z * a_exp * fbzi_0 * fbzi_0 + tg_xxxzz_x_d_0_0_0[i] * a_z * faz_0;

        tg_xxxzzz_y_d_0_0_0[i] = -5.0 * tg_xzzz_y_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 2.0 * tg_xzzz_y_d_0_0_0[i] * fzi_0 + 2.0 * tg_xzzz_y_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_xxzzz_y_s_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 5.0 * tg_xxzzz_y_p_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_xxzzz_y_d_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_xxzzz_y_d_0_0_0[i] * a_x * faz_0;

        tg_xxxzzz_z_d_0_0_0[i] = -5.0 * tg_xzzz_z_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 2.0 * tg_xzzz_z_d_0_0_0[i] * fzi_0 + 2.0 * tg_xzzz_z_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_xxzzz_z_s_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 5.0 * tg_xxzzz_z_p_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_xxzzz_z_d_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_xxzzz_z_d_0_0_0[i] * a_x * faz_0;

        tg_xxyyyy_x_d_0_0_0[i] = -15.0 / 2.0 * tg_xxyy_x_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 3.0 * tg_xxyy_x_d_0_0_0[i] * fzi_0 + 3.0 * tg_xxyy_x_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_xxyyy_x_s_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 5.0 * tg_xxyyy_x_p_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_xxyyy_x_d_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_xxyyy_x_d_0_0_0[i] * a_y * faz_0;

        tg_xxyyyy_y_d_0_0_0[i] = -5.0 / 2.0 * tg_yyyy_y_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + tg_yyyy_y_d_0_0_0[i] * fzi_0 + tg_yyyy_y_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_xyyyy_y_s_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 5.0 * tg_xyyyy_y_p_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_xyyyy_y_d_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_xyyyy_y_d_0_0_0[i] * a_x * faz_0;

        tg_xxyyyy_z_d_0_0_0[i] = -5.0 / 2.0 * tg_yyyy_z_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + tg_yyyy_z_d_0_0_0[i] * fzi_0 + tg_yyyy_z_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_xyyyy_z_s_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 5.0 * tg_xyyyy_z_p_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_xyyyy_z_d_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_xyyyy_z_d_0_0_0[i] * a_x * faz_0;
        ...
        tg_xxyyzz_x_d_0_0_0[i] = -5.0 / 2.0 * tg_xxzz_x_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + tg_xxzz_x_d_0_0_0[i] * fzi_0 + tg_xxzz_x_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_xxyzz_x_s_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 5.0 * tg_xxyzz_x_p_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_xxyzz_x_d_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_xxyzz_x_d_0_0_0[i] * a_y * faz_0;

        tg_xxyyzz_y_d_0_0_0[i] = -5.0 / 2.0 * tg_yyzz_y_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + tg_yyzz_y_d_0_0_0[i] * fzi_0 + tg_yyzz_y_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_xyyzz_y_s_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 5.0 * tg_xyyzz_y_p_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_xyyzz_y_d_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_xyyzz_y_d_0_0_0[i] * a_x * faz_0;

        tg_xxyyzz_z_d_0_0_0[i] = -5.0 / 2.0 * tg_yyzz_z_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + tg_yyzz_z_d_0_0_0[i] * fzi_0 + tg_yyzz_z_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_xyyzz_z_s_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 5.0 * tg_xyyzz_z_p_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_xyyzz_z_d_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_xyyzz_z_d_0_0_0[i] * a_x * faz_0;
        ...
        tg_xxzzzz_x_d_0_0_0[i] = -15.0 / 2.0 * tg_xxzz_x_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 3.0 * tg_xxzz_x_d_0_0_0[i] * fzi_0 + 3.0 * tg_xxzz_x_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_xxzzz_x_s_1_0_1[i] * f2abz_0 * a_z * fbzi_0 + 5.0 * tg_xxzzz_x_p_0_0_1[i] * rb_z[i] * fbzi_0 + 2.0 * tg_xxzzz_x_d_1_0_0[i] * a_z * a_exp * fbzi_0 * fbzi_0 + tg_xxzzz_x_d_0_0_0[i] * a_z * faz_0;

        tg_xxzzzz_y_d_0_0_0[i] = -5.0 / 2.0 * tg_zzzz_y_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + tg_zzzz_y_d_0_0_0[i] * fzi_0 + tg_zzzz_y_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_xzzzz_y_s_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 5.0 * tg_xzzzz_y_p_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_xzzzz_y_d_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_xzzzz_y_d_0_0_0[i] * a_x * faz_0;

        tg_xxzzzz_z_d_0_0_0[i] = -5.0 / 2.0 * tg_zzzz_z_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + tg_zzzz_z_d_0_0_0[i] * fzi_0 + tg_zzzz_z_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_xzzzz_z_s_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 5.0 * tg_xzzzz_z_p_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_xzzzz_z_d_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_xzzzz_z_d_0_0_0[i] * a_x * faz_0;
        ...
        tg_yyyyyy_x_d_0_0_0[i] = -25.0 / 2.0 * tg_yyyy_x_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 5.0 * tg_yyyy_x_d_0_0_0[i] * fzi_0 + 5.0 * tg_yyyy_x_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_yyyyy_x_s_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 5.0 * tg_yyyyy_x_p_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_yyyyy_x_d_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_yyyyy_x_d_0_0_0[i] * a_y * faz_0;

        tg_yyyyyy_y_d_0_0_0[i] = -25.0 / 2.0 * tg_yyyy_y_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 5.0 * tg_yyyy_y_d_0_0_0[i] * fzi_0 + 5.0 * tg_yyyy_y_d_1_0_0[i] * fbzi_0 * fbzi_0 + 5.0 / 2.0 * tg_yyyyy_0_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_yyyyy_y_s_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 5.0 * tg_yyyyy_y_p_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_yyyyy_y_d_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_yyyyy_y_d_0_0_0[i] * a_y * faz_0;

        tg_yyyyyy_z_d_0_0_0[i] = -25.0 / 2.0 * tg_yyyy_z_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 5.0 * tg_yyyy_z_d_0_0_0[i] * fzi_0 + 5.0 * tg_yyyy_z_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_yyyyy_z_s_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 5.0 * tg_yyyyy_z_p_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_yyyyy_z_d_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_yyyyy_z_d_0_0_0[i] * a_y * faz_0;
        ...
        tg_yyyyzz_x_d_0_0_0[i] = -15.0 / 2.0 * tg_yyzz_x_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 3.0 * tg_yyzz_x_d_0_0_0[i] * fzi_0 + 3.0 * tg_yyzz_x_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_yyyzz_x_s_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 5.0 * tg_yyyzz_x_p_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_yyyzz_x_d_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_yyyzz_x_d_0_0_0[i] * a_y * faz_0;

        tg_yyyyzz_y_d_0_0_0[i] = -5.0 / 2.0 * tg_yyyy_y_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + tg_yyyy_y_d_0_0_0[i] * fzi_0 + tg_yyyy_y_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_yyyyz_y_s_1_0_1[i] * f2abz_0 * a_z * fbzi_0 + 5.0 * tg_yyyyz_y_p_0_0_1[i] * rb_z[i] * fbzi_0 + 2.0 * tg_yyyyz_y_d_1_0_0[i] * a_z * a_exp * fbzi_0 * fbzi_0 + tg_yyyyz_y_d_0_0_0[i] * a_z * faz_0;

        tg_yyyyzz_z_d_0_0_0[i] = -15.0 / 2.0 * tg_yyzz_z_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 3.0 * tg_yyzz_z_d_0_0_0[i] * fzi_0 + 3.0 * tg_yyzz_z_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_yyyzz_z_s_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 5.0 * tg_yyyzz_z_p_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_yyyzz_z_d_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_yyyzz_z_d_0_0_0[i] * a_y * faz_0;

        tg_yyyzzz_x_d_0_0_0[i] = -5.0 * tg_yzzz_x_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 2.0 * tg_yzzz_x_d_0_0_0[i] * fzi_0 + 2.0 * tg_yzzz_x_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_yyzzz_x_s_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 5.0 * tg_yyzzz_x_p_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_yyzzz_x_d_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_yyzzz_x_d_0_0_0[i] * a_y * faz_0;

        tg_yyyzzz_y_d_0_0_0[i] = -5.0 * tg_yyyz_y_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 2.0 * tg_yyyz_y_d_0_0_0[i] * fzi_0 + 2.0 * tg_yyyz_y_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_yyyzz_y_s_1_0_1[i] * f2abz_0 * a_z * fbzi_0 + 5.0 * tg_yyyzz_y_p_0_0_1[i] * rb_z[i] * fbzi_0 + 2.0 * tg_yyyzz_y_d_1_0_0[i] * a_z * a_exp * fbzi_0 * fbzi_0 + tg_yyyzz_y_d_0_0_0[i] * a_z * faz_0;

        tg_yyyzzz_z_d_0_0_0[i] = -5.0 * tg_yzzz_z_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 2.0 * tg_yzzz_z_d_0_0_0[i] * fzi_0 + 2.0 * tg_yzzz_z_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_yyzzz_z_s_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 5.0 * tg_yyzzz_z_p_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_yyzzz_z_d_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_yyzzz_z_d_0_0_0[i] * a_y * faz_0;

        tg_yyzzzz_x_d_0_0_0[i] = -5.0 / 2.0 * tg_zzzz_x_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + tg_zzzz_x_d_0_0_0[i] * fzi_0 + tg_zzzz_x_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_yzzzz_x_s_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 5.0 * tg_yzzzz_x_p_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_yzzzz_x_d_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_yzzzz_x_d_0_0_0[i] * a_y * faz_0;

        tg_yyzzzz_y_d_0_0_0[i] = -15.0 / 2.0 * tg_yyzz_y_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 3.0 * tg_yyzz_y_d_0_0_0[i] * fzi_0 + 3.0 * tg_yyzz_y_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_yyzzz_y_s_1_0_1[i] * f2abz_0 * a_z * fbzi_0 + 5.0 * tg_yyzzz_y_p_0_0_1[i] * rb_z[i] * fbzi_0 + 2.0 * tg_yyzzz_y_d_1_0_0[i] * a_z * a_exp * fbzi_0 * fbzi_0 + tg_yyzzz_y_d_0_0_0[i] * a_z * faz_0;

        tg_yyzzzz_z_d_0_0_0[i] = -5.0 / 2.0 * tg_zzzz_z_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + tg_zzzz_z_d_0_0_0[i] * fzi_0 + tg_zzzz_z_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_yzzzz_z_s_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 5.0 * tg_yzzzz_z_p_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_yzzzz_z_d_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_yzzzz_z_d_0_0_0[i] * a_y * faz_0;
        ...
        tg_zzzzzz_x_d_0_0_0[i] = -25.0 / 2.0 * tg_zzzz_x_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 5.0 * tg_zzzz_x_d_0_0_0[i] * fzi_0 + 5.0 * tg_zzzz_x_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_zzzzz_x_s_1_0_1[i] * f2abz_0 * a_z * fbzi_0 + 5.0 * tg_zzzzz_x_p_0_0_1[i] * rb_z[i] * fbzi_0 + 2.0 * tg_zzzzz_x_d_1_0_0[i] * a_z * a_exp * fbzi_0 * fbzi_0 + tg_zzzzz_x_d_0_0_0[i] * a_z * faz_0;

        tg_zzzzzz_y_d_0_0_0[i] = -25.0 / 2.0 * tg_zzzz_y_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 5.0 * tg_zzzz_y_d_0_0_0[i] * fzi_0 + 5.0 * tg_zzzz_y_d_1_0_0[i] * fbzi_0 * fbzi_0 - 5.0 * tg_zzzzz_y_s_1_0_1[i] * f2abz_0 * a_z * fbzi_0 + 5.0 * tg_zzzzz_y_p_0_0_1[i] * rb_z[i] * fbzi_0 + 2.0 * tg_zzzzz_y_d_1_0_0[i] * a_z * a_exp * fbzi_0 * fbzi_0 + tg_zzzzz_y_d_0_0_0[i] * a_z * faz_0;

        tg_zzzzzz_z_d_0_0_0[i] = -25.0 / 2.0 * tg_zzzz_z_s_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 + 5.0 * tg_zzzz_z_d_0_0_0[i] * fzi_0 + 5.0 * tg_zzzz_z_d_1_0_0[i] * fbzi_0 * fbzi_0 + 5.0 / 2.0 * tg_zzzzz_0_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_zzzzz_z_s_1_0_1[i] * f2abz_0 * a_z * fbzi_0 + 5.0 * tg_zzzzz_z_p_0_0_1[i] * rb_z[i] * fbzi_0 + 2.0 * tg_zzzzz_z_d_1_0_0[i] * a_z * a_exp * fbzi_0 * fbzi_0 + tg_zzzzz_z_d_0_0_0[i] * a_z * faz_0;
    }
