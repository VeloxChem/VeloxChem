#ifndef ProjectedCorePotentialPrimRecSFForP
#define ProjectedCorePotentialPrimRecSFForP
...
/// @brief Computes primitive [S|U_l|F]_P integrals with P projectors for set of data buffers.
...
#endif /* ProjectedCorePotentialPrimRecSFForP */
