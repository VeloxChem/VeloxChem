#ifndef ProjectedCorePotentialPrimRecSFForS
#define ProjectedCorePotentialPrimRecSFForS
...
/// @brief Computes primitive [S|U_l|F]_S integrals with S projectors for set of data buffers.
...
#endif /* ProjectedCorePotentialPrimRecSFForS */
