#ifndef ProjectedCorePotentialSSForP_hpp
#define ProjectedCorePotentialSSForP_hpp
...
template <class T>
auto
comp_projected_core_potential_ss_for_p(T& distributor,
...
#endif /* ProjectedCorePotentialSSForP_hpp */
