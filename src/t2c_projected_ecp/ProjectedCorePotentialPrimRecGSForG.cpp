                                        ...
                                        const double c_exp) -> void
{
    ...
    #pragma omp simd aligned(b_exps, rb_x, rb_y, rb_z, tg_xx_0_g_0_0_0, tg_xx_0_g_1_0_0, tg_xxx_0_d_1_0_1, tg_xxx_0_f_0_0_1, tg_xxx_0_g_0_0_0, tg_xxx_0_g_1_0_0, tg_xxx_0_p_1_1_1, tg_xxx_0_s_2_1_1, tg_xxxx_0_g_0_0_0, tg_xxxy_0_g_0_0_0, tg_xxxz_0_g_0_0_0, tg_xxyy_0_g_0_0_0, tg_xxyz_0_g_0_0_0, tg_xxz_0_d_1_0_1, tg_xxz_0_f_0_0_1, tg_xxz_0_g_0_0_0, tg_xxz_0_g_1_0_0, tg_xxz_0_p_1_1_1, tg_xxz_0_s_2_1_1, tg_xxzz_0_g_0_0_0, tg_xyy_0_d_1_0_1, tg_xyy_0_f_0_0_1, tg_xyy_0_g_0_0_0, tg_xyy_0_g_1_0_0, tg_xyy_0_p_1_1_1, tg_xyy_0_s_2_1_1, tg_xyyy_0_g_0_0_0, tg_xyyz_0_g_0_0_0, tg_xyzz_0_g_0_0_0, tg_xzz_0_d_1_0_1, tg_xzz_0_f_0_0_1, tg_xzz_0_g_0_0_0, tg_xzz_0_g_1_0_0, tg_xzz_0_p_1_1_1, tg_xzz_0_s_2_1_1, tg_xzzz_0_g_0_0_0, tg_yy_0_g_0_0_0, tg_yy_0_g_1_0_0, tg_yyy_0_d_1_0_1, tg_yyy_0_f_0_0_1, tg_yyy_0_g_0_0_0, tg_yyy_0_g_1_0_0, tg_yyy_0_p_1_1_1, tg_yyy_0_s_2_1_1, tg_yyyy_0_g_0_0_0, tg_yyyz_0_g_0_0_0, tg_yyz_0_d_1_0_1, tg_yyz_0_f_0_0_1, tg_yyz_0_g_0_0_0, tg_yyz_0_g_1_0_0, tg_yyz_0_p_1_1_1, tg_yyz_0_s_2_1_1, tg_yyzz_0_g_0_0_0, tg_yzz_0_d_1_0_1, tg_yzz_0_f_0_0_1, tg_yzz_0_g_0_0_0, tg_yzz_0_g_1_0_0, tg_yzz_0_p_1_1_1, tg_yzz_0_s_2_1_1, tg_yzzz_0_g_0_0_0, tg_zz_0_g_0_0_0, tg_zz_0_g_1_0_0, tg_zzz_0_d_1_0_1, tg_zzz_0_f_0_0_1, tg_zzz_0_g_0_0_0, tg_zzz_0_g_1_0_0, tg_zzz_0_p_1_1_1, tg_zzz_0_s_2_1_1, tg_zzzz_0_g_0_0_0  : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        tg_xxxx_0_g_0_0_0[i] = 3.0 * tg_xx_0_g_0_0_0[i] * fzi_0 + 3.0 * tg_xx_0_g_1_0_0[i] * fbzi_0 * fbzi_0 - 27.0 / 2.0 * tg_xxx_0_s_2_1_1[i] * fai_0 * f2abz_0 * f2abz_0 * f2abz_0 * fbzi_0 - 9.0 * tg_xxx_0_s_2_1_1[i] * f2abz_0 * f2abz_0 * f2abz_0 * a_x * fbzi_0 + 9.0 * tg_xxx_0_p_1_1_1[i] * f2abz_0 * f2abz_0 * rb_x[i] * fbzi_0 - 27.0 / 2.0 * tg_xxx_0_d_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 - 9.0 * tg_xxx_0_d_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 9.0 * tg_xxx_0_f_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_xxx_0_g_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_xxx_0_g_0_0_0[i] * a_x * faz_0;
        ...
        tg_xxyy_0_g_0_0_0[i] = tg_yy_0_g_0_0_0[i] * fzi_0 + tg_yy_0_g_1_0_0[i] * fbzi_0 * fbzi_0 - 9.0 / 2.0 * tg_xyy_0_s_2_1_1[i] * fai_0 * f2abz_0 * f2abz_0 * f2abz_0 * fbzi_0 - 9.0 * tg_xyy_0_s_2_1_1[i] * f2abz_0 * f2abz_0 * f2abz_0 * a_x * fbzi_0 + 9.0 * tg_xyy_0_p_1_1_1[i] * f2abz_0 * f2abz_0 * rb_x[i] * fbzi_0 - 9.0 / 2.0 * tg_xyy_0_d_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 - 9.0 * tg_xyy_0_d_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 9.0 * tg_xyy_0_f_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_xyy_0_g_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_xyy_0_g_0_0_0[i] * a_x * faz_0;
        ...
        tg_xxzz_0_g_0_0_0[i] = tg_zz_0_g_0_0_0[i] * fzi_0 + tg_zz_0_g_1_0_0[i] * fbzi_0 * fbzi_0 - 9.0 / 2.0 * tg_xzz_0_s_2_1_1[i] * fai_0 * f2abz_0 * f2abz_0 * f2abz_0 * fbzi_0 - 9.0 * tg_xzz_0_s_2_1_1[i] * f2abz_0 * f2abz_0 * f2abz_0 * a_x * fbzi_0 + 9.0 * tg_xzz_0_p_1_1_1[i] * f2abz_0 * f2abz_0 * rb_x[i] * fbzi_0 - 9.0 / 2.0 * tg_xzz_0_d_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 - 9.0 * tg_xzz_0_d_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 9.0 * tg_xzz_0_f_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_xzz_0_g_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_xzz_0_g_0_0_0[i] * a_x * faz_0;
        ...
        tg_yyyy_0_g_0_0_0[i] = 3.0 * tg_yy_0_g_0_0_0[i] * fzi_0 + 3.0 * tg_yy_0_g_1_0_0[i] * fbzi_0 * fbzi_0 - 27.0 / 2.0 * tg_yyy_0_s_2_1_1[i] * fai_0 * f2abz_0 * f2abz_0 * f2abz_0 * fbzi_0 - 9.0 * tg_yyy_0_s_2_1_1[i] * f2abz_0 * f2abz_0 * f2abz_0 * a_y * fbzi_0 + 9.0 * tg_yyy_0_p_1_1_1[i] * f2abz_0 * f2abz_0 * rb_y[i] * fbzi_0 - 27.0 / 2.0 * tg_yyy_0_d_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 - 9.0 * tg_yyy_0_d_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 9.0 * tg_yyy_0_f_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_yyy_0_g_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_yyy_0_g_0_0_0[i] * a_y * faz_0;
        ...
        tg_yyzz_0_g_0_0_0[i] = tg_zz_0_g_0_0_0[i] * fzi_0 + tg_zz_0_g_1_0_0[i] * fbzi_0 * fbzi_0 - 9.0 / 2.0 * tg_yzz_0_s_2_1_1[i] * fai_0 * f2abz_0 * f2abz_0 * f2abz_0 * fbzi_0 - 9.0 * tg_yzz_0_s_2_1_1[i] * f2abz_0 * f2abz_0 * f2abz_0 * a_y * fbzi_0 + 9.0 * tg_yzz_0_p_1_1_1[i] * f2abz_0 * f2abz_0 * rb_y[i] * fbzi_0 - 9.0 / 2.0 * tg_yzz_0_d_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 - 9.0 * tg_yzz_0_d_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 9.0 * tg_yzz_0_f_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_yzz_0_g_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_yzz_0_g_0_0_0[i] * a_y * faz_0;
        ...
        tg_zzzz_0_g_0_0_0[i] = 3.0 * tg_zz_0_g_0_0_0[i] * fzi_0 + 3.0 * tg_zz_0_g_1_0_0[i] * fbzi_0 * fbzi_0 - 27.0 / 2.0 * tg_zzz_0_s_2_1_1[i] * fai_0 * f2abz_0 * f2abz_0 * f2abz_0 * fbzi_0 - 9.0 * tg_zzz_0_s_2_1_1[i] * f2abz_0 * f2abz_0 * f2abz_0 * a_z * fbzi_0 + 9.0 * tg_zzz_0_p_1_1_1[i] * f2abz_0 * f2abz_0 * rb_z[i] * fbzi_0 - 27.0 / 2.0 * tg_zzz_0_d_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 - 9.0 * tg_zzz_0_d_1_0_1[i] * f2abz_0 * a_z * fbzi_0 + 9.0 * tg_zzz_0_f_0_0_1[i] * rb_z[i] * fbzi_0 + 2.0 * tg_zzz_0_g_1_0_0[i] * a_z * a_exp * fbzi_0 * fbzi_0 + tg_zzz_0_g_0_0_0[i] * a_z * faz_0;
    }
