                                        ...
                                        const double c_exp) -> void
{
    ...
    #pragma omp simd aligned(b_exps, rb_x, rb_y, rb_z, tg_0_x_f_0_0_0, tg_0_x_f_1_0_0, tg_0_y_f_0_0_0, tg_0_y_f_1_0_0, tg_0_z_f_0_0_0, tg_0_z_f_1_0_0, tg_x_x_d_0_0_1, tg_x_x_f_0_0_0, tg_x_x_f_1_0_0, tg_x_x_p_1_0_1, tg_x_x_s_1_1_1, tg_x_y_d_0_0_1, tg_x_y_f_0_0_0, tg_x_y_f_1_0_0, tg_x_y_p_1_0_1, tg_x_y_s_1_1_1, tg_x_z_d_0_0_1, tg_x_z_f_0_0_0, tg_x_z_f_1_0_0, tg_x_z_p_1_0_1, tg_x_z_s_1_1_1, tg_xx_x_f_0_0_0, tg_xx_y_f_0_0_0, tg_xx_z_f_0_0_0, tg_xy_x_f_0_0_0, tg_xy_y_f_0_0_0, tg_xy_z_f_0_0_0, tg_xz_x_f_0_0_0, tg_xz_y_f_0_0_0, tg_xz_z_f_0_0_0, tg_y_x_d_0_0_1, tg_y_x_f_0_0_0, tg_y_x_f_1_0_0, tg_y_x_p_1_0_1, tg_y_x_s_1_1_1, tg_y_y_d_0_0_1, tg_y_y_f_0_0_0, tg_y_y_f_1_0_0, tg_y_y_p_1_0_1, tg_y_y_s_1_1_1, tg_y_z_d_0_0_1, tg_y_z_f_0_0_0, tg_y_z_f_1_0_0, tg_y_z_p_1_0_1, tg_y_z_s_1_1_1, tg_yy_x_f_0_0_0, tg_yy_y_f_0_0_0, tg_yy_z_f_0_0_0, tg_yz_x_f_0_0_0, tg_yz_y_f_0_0_0, tg_yz_z_f_0_0_0, tg_z_x_d_0_0_1, tg_z_x_f_0_0_0, tg_z_x_f_1_0_0, tg_z_x_p_1_0_1, tg_z_x_s_1_1_1, tg_z_y_d_0_0_1, tg_z_y_f_0_0_0, tg_z_y_f_1_0_0, tg_z_y_p_1_0_1, tg_z_y_s_1_1_1, tg_z_z_d_0_0_1, tg_z_z_f_0_0_0, tg_z_z_f_1_0_0, tg_z_z_p_1_0_1, tg_z_z_s_1_1_1, tg_zz_x_f_0_0_0, tg_zz_y_f_0_0_0, tg_zz_z_f_0_0_0  : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        tg_xx_x_f_0_0_0[i] = tg_0_x_f_0_0_0[i] * fzi_0 + tg_0_x_f_1_0_0[i] * fbzi_0 * fbzi_0 + 7.0 / 2.0 * tg_x_x_s_1_1_1[i] * fbi_0 * f2abz_0 * f2abz_0 * fbzi_0 + 7.0 * tg_x_x_s_1_1_1[i] * f2abz_0 * f2abz_0 * rb_x[i] * fbzi_0 - 7.0 / 2.0 * tg_x_x_p_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 - 7.0 * tg_x_x_p_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 7.0 / 2.0 * tg_x_x_d_0_0_1[i] * fbi_0 * fbzi_0 + 7.0 * tg_x_x_d_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_x_x_f_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_x_x_f_0_0_0[i] * a_x * faz_0;

        tg_xx_y_f_0_0_0[i] = tg_0_y_f_0_0_0[i] * fzi_0 + tg_0_y_f_1_0_0[i] * fbzi_0 * fbzi_0 + 7.0 * tg_x_y_s_1_1_1[i] * f2abz_0 * f2abz_0 * rb_x[i] * fbzi_0 - 7.0 / 2.0 * tg_x_y_p_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 - 7.0 * tg_x_y_p_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 7.0 * tg_x_y_d_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_x_y_f_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_x_y_f_0_0_0[i] * a_x * faz_0;

        tg_xx_z_f_0_0_0[i] = tg_0_z_f_0_0_0[i] * fzi_0 + tg_0_z_f_1_0_0[i] * fbzi_0 * fbzi_0 + 7.0 * tg_x_z_s_1_1_1[i] * f2abz_0 * f2abz_0 * rb_x[i] * fbzi_0 - 7.0 / 2.0 * tg_x_z_p_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 - 7.0 * tg_x_z_p_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 7.0 * tg_x_z_d_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_x_z_f_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_x_z_f_0_0_0[i] * a_x * faz_0;
        ...
        tg_yy_x_f_0_0_0[i] = tg_0_x_f_0_0_0[i] * fzi_0 + tg_0_x_f_1_0_0[i] * fbzi_0 * fbzi_0 + 7.0 * tg_y_x_s_1_1_1[i] * f2abz_0 * f2abz_0 * rb_y[i] * fbzi_0 - 7.0 / 2.0 * tg_y_x_p_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 - 7.0 * tg_y_x_p_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 7.0 * tg_y_x_d_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_y_x_f_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_y_x_f_0_0_0[i] * a_y * faz_0;

        tg_yy_y_f_0_0_0[i] = tg_0_y_f_0_0_0[i] * fzi_0 + tg_0_y_f_1_0_0[i] * fbzi_0 * fbzi_0 + 7.0 / 2.0 * tg_y_y_s_1_1_1[i] * fbi_0 * f2abz_0 * f2abz_0 * fbzi_0 + 7.0 * tg_y_y_s_1_1_1[i] * f2abz_0 * f2abz_0 * rb_y[i] * fbzi_0 - 7.0 / 2.0 * tg_y_y_p_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 - 7.0 * tg_y_y_p_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 7.0 / 2.0 * tg_y_y_d_0_0_1[i] * fbi_0 * fbzi_0 + 7.0 * tg_y_y_d_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_y_y_f_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_y_y_f_0_0_0[i] * a_y * faz_0;

        tg_yy_z_f_0_0_0[i] = tg_0_z_f_0_0_0[i] * fzi_0 + tg_0_z_f_1_0_0[i] * fbzi_0 * fbzi_0 + 7.0 * tg_y_z_s_1_1_1[i] * f2abz_0 * f2abz_0 * rb_y[i] * fbzi_0 - 7.0 / 2.0 * tg_y_z_p_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 - 7.0 * tg_y_z_p_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 7.0 * tg_y_z_d_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_y_z_f_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_y_z_f_0_0_0[i] * a_y * faz_0;
        ...
        tg_zz_x_f_0_0_0[i] = tg_0_x_f_0_0_0[i] * fzi_0 + tg_0_x_f_1_0_0[i] * fbzi_0 * fbzi_0 + 7.0 * tg_z_x_s_1_1_1[i] * f2abz_0 * f2abz_0 * rb_z[i] * fbzi_0 - 7.0 / 2.0 * tg_z_x_p_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 - 7.0 * tg_z_x_p_1_0_1[i] * f2abz_0 * a_z * fbzi_0 + 7.0 * tg_z_x_d_0_0_1[i] * rb_z[i] * fbzi_0 + 2.0 * tg_z_x_f_1_0_0[i] * a_z * a_exp * fbzi_0 * fbzi_0 + tg_z_x_f_0_0_0[i] * a_z * faz_0;

        tg_zz_y_f_0_0_0[i] = tg_0_y_f_0_0_0[i] * fzi_0 + tg_0_y_f_1_0_0[i] * fbzi_0 * fbzi_0 + 7.0 * tg_z_y_s_1_1_1[i] * f2abz_0 * f2abz_0 * rb_z[i] * fbzi_0 - 7.0 / 2.0 * tg_z_y_p_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 - 7.0 * tg_z_y_p_1_0_1[i] * f2abz_0 * a_z * fbzi_0 + 7.0 * tg_z_y_d_0_0_1[i] * rb_z[i] * fbzi_0 + 2.0 * tg_z_y_f_1_0_0[i] * a_z * a_exp * fbzi_0 * fbzi_0 + tg_z_y_f_0_0_0[i] * a_z * faz_0;

        tg_zz_z_f_0_0_0[i] = tg_0_z_f_0_0_0[i] * fzi_0 + tg_0_z_f_1_0_0[i] * fbzi_0 * fbzi_0 + 7.0 / 2.0 * tg_z_z_s_1_1_1[i] * fbi_0 * f2abz_0 * f2abz_0 * fbzi_0 + 7.0 * tg_z_z_s_1_1_1[i] * f2abz_0 * f2abz_0 * rb_z[i] * fbzi_0 - 7.0 / 2.0 * tg_z_z_p_1_0_1[i] * fai_0 * f2abz_0 * fbzi_0 - 7.0 * tg_z_z_p_1_0_1[i] * f2abz_0 * a_z * fbzi_0 + 7.0 / 2.0 * tg_z_z_d_0_0_1[i] * fbi_0 * fbzi_0 + 7.0 * tg_z_z_d_0_0_1[i] * rb_z[i] * fbzi_0 + 2.0 * tg_z_z_f_1_0_0[i] * a_z * a_exp * fbzi_0 * fbzi_0 + tg_z_z_f_0_0_0[i] * a_z * faz_0;
    }
