                                        ...
                                        const double c_exp) -> void
{
    ...
    #pragma omp simd aligned(b_exps, rb_x, rb_y, rb_z, tg_0_xx_p_0_0_1, tg_0_xxx_d_0_0_0, tg_0_xxx_d_1_0_0, tg_0_xxx_p_0_0_1, tg_0_xxx_s_1_0_1, tg_0_xxy_d_0_0_0, tg_0_xxy_d_1_0_0, tg_0_xxy_p_0_0_1, tg_0_xxy_s_1_0_1, tg_0_xxz_d_0_0_0, tg_0_xxz_d_1_0_0, tg_0_xxz_p_0_0_1, tg_0_xxz_s_1_0_1, tg_0_xy_p_0_0_1, tg_0_xyy_d_0_0_0, tg_0_xyy_d_1_0_0, tg_0_xyy_p_0_0_1, tg_0_xyy_s_1_0_1, tg_0_xyz_d_0_0_0, tg_0_xyz_d_1_0_0, tg_0_xyz_p_0_0_1, tg_0_xyz_s_1_0_1, tg_0_xz_p_0_0_1, tg_0_xzz_d_0_0_0, tg_0_xzz_d_1_0_0, tg_0_xzz_p_0_0_1, tg_0_xzz_s_1_0_1, tg_0_yy_p_0_0_1, tg_0_yyy_d_0_0_0, tg_0_yyy_d_1_0_0, tg_0_yyy_p_0_0_1, tg_0_yyy_s_1_0_1, tg_0_yyz_d_0_0_0, tg_0_yyz_d_1_0_0, tg_0_yyz_p_0_0_1, tg_0_yyz_s_1_0_1, tg_0_yz_p_0_0_1, tg_0_yzz_d_0_0_0, tg_0_yzz_d_1_0_0, tg_0_yzz_p_0_0_1, tg_0_yzz_s_1_0_1, tg_0_zz_p_0_0_1, tg_0_zzz_d_0_0_0, tg_0_zzz_d_1_0_0, tg_0_zzz_p_0_0_1, tg_0_zzz_s_1_0_1, tg_x_xxx_d_0_0_0, tg_x_xxy_d_0_0_0, tg_x_xxz_d_0_0_0, tg_x_xyy_d_0_0_0, tg_x_xyz_d_0_0_0, tg_x_xzz_d_0_0_0, tg_x_yyy_d_0_0_0, tg_x_yyz_d_0_0_0, tg_x_yzz_d_0_0_0, tg_x_zzz_d_0_0_0, tg_y_xxx_d_0_0_0, tg_y_xxy_d_0_0_0, tg_y_xxz_d_0_0_0, tg_y_xyy_d_0_0_0, tg_y_xyz_d_0_0_0, tg_y_xzz_d_0_0_0, tg_y_yyy_d_0_0_0, tg_y_yyz_d_0_0_0, tg_y_yzz_d_0_0_0, tg_y_zzz_d_0_0_0, tg_z_xxx_d_0_0_0, tg_z_xxy_d_0_0_0, tg_z_xxz_d_0_0_0, tg_z_xyy_d_0_0_0, tg_z_xyz_d_0_0_0, tg_z_xzz_d_0_0_0, tg_z_yyy_d_0_0_0, tg_z_yyz_d_0_0_0, tg_z_yzz_d_0_0_0, tg_z_zzz_d_0_0_0  : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        tg_x_xxx_d_0_0_0[i] = 15.0 / 2.0 * tg_0_xx_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_xxx_s_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 5.0 * tg_0_xxx_p_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_0_xxx_d_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_0_xxx_d_0_0_0[i] * a_x * faz_0;

        tg_x_xxy_d_0_0_0[i] = 5.0 * tg_0_xy_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_xxy_s_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 5.0 * tg_0_xxy_p_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_0_xxy_d_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_0_xxy_d_0_0_0[i] * a_x * faz_0;

        tg_x_xxz_d_0_0_0[i] = 5.0 * tg_0_xz_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_xxz_s_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 5.0 * tg_0_xxz_p_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_0_xxz_d_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_0_xxz_d_0_0_0[i] * a_x * faz_0;

        tg_x_xyy_d_0_0_0[i] = 5.0 / 2.0 * tg_0_yy_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_xyy_s_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 5.0 * tg_0_xyy_p_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_0_xyy_d_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_0_xyy_d_0_0_0[i] * a_x * faz_0;

        tg_x_xyz_d_0_0_0[i] = 5.0 / 2.0 * tg_0_yz_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_xyz_s_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 5.0 * tg_0_xyz_p_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_0_xyz_d_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_0_xyz_d_0_0_0[i] * a_x * faz_0;

        tg_x_xzz_d_0_0_0[i] = 5.0 / 2.0 * tg_0_zz_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_xzz_s_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 5.0 * tg_0_xzz_p_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_0_xzz_d_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_0_xzz_d_0_0_0[i] * a_x * faz_0;
        ...
        tg_y_xxy_d_0_0_0[i] = 5.0 / 2.0 * tg_0_xx_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_xxy_s_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 5.0 * tg_0_xxy_p_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_0_xxy_d_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_0_xxy_d_0_0_0[i] * a_y * faz_0;
        ...
        tg_y_xyy_d_0_0_0[i] = 5.0 * tg_0_xy_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_xyy_s_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 5.0 * tg_0_xyy_p_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_0_xyy_d_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_0_xyy_d_0_0_0[i] * a_y * faz_0;

        tg_y_xyz_d_0_0_0[i] = 5.0 / 2.0 * tg_0_xz_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_xyz_s_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 5.0 * tg_0_xyz_p_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_0_xyz_d_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_0_xyz_d_0_0_0[i] * a_y * faz_0;
        ...
        tg_y_yyy_d_0_0_0[i] = 15.0 / 2.0 * tg_0_yy_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_yyy_s_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 5.0 * tg_0_yyy_p_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_0_yyy_d_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_0_yyy_d_0_0_0[i] * a_y * faz_0;

        tg_y_yyz_d_0_0_0[i] = 5.0 * tg_0_yz_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_yyz_s_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 5.0 * tg_0_yyz_p_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_0_yyz_d_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_0_yyz_d_0_0_0[i] * a_y * faz_0;

        tg_y_yzz_d_0_0_0[i] = 5.0 / 2.0 * tg_0_zz_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_yzz_s_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 5.0 * tg_0_yzz_p_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_0_yzz_d_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_0_yzz_d_0_0_0[i] * a_y * faz_0;
        ...
        tg_z_xxz_d_0_0_0[i] = 5.0 / 2.0 * tg_0_xx_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_xxz_s_1_0_1[i] * f2abz_0 * a_z * fbzi_0 + 5.0 * tg_0_xxz_p_0_0_1[i] * rb_z[i] * fbzi_0 + 2.0 * tg_0_xxz_d_1_0_0[i] * a_z * a_exp * fbzi_0 * fbzi_0 + tg_0_xxz_d_0_0_0[i] * a_z * faz_0;
        ...
        tg_z_xyz_d_0_0_0[i] = 5.0 / 2.0 * tg_0_xy_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_xyz_s_1_0_1[i] * f2abz_0 * a_z * fbzi_0 + 5.0 * tg_0_xyz_p_0_0_1[i] * rb_z[i] * fbzi_0 + 2.0 * tg_0_xyz_d_1_0_0[i] * a_z * a_exp * fbzi_0 * fbzi_0 + tg_0_xyz_d_0_0_0[i] * a_z * faz_0;

        tg_z_xzz_d_0_0_0[i] = 5.0 * tg_0_xz_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_xzz_s_1_0_1[i] * f2abz_0 * a_z * fbzi_0 + 5.0 * tg_0_xzz_p_0_0_1[i] * rb_z[i] * fbzi_0 + 2.0 * tg_0_xzz_d_1_0_0[i] * a_z * a_exp * fbzi_0 * fbzi_0 + tg_0_xzz_d_0_0_0[i] * a_z * faz_0;
        ...
        tg_z_yyz_d_0_0_0[i] = 5.0 / 2.0 * tg_0_yy_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_yyz_s_1_0_1[i] * f2abz_0 * a_z * fbzi_0 + 5.0 * tg_0_yyz_p_0_0_1[i] * rb_z[i] * fbzi_0 + 2.0 * tg_0_yyz_d_1_0_0[i] * a_z * a_exp * fbzi_0 * fbzi_0 + tg_0_yyz_d_0_0_0[i] * a_z * faz_0;

        tg_z_yzz_d_0_0_0[i] = 5.0 * tg_0_yz_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_yzz_s_1_0_1[i] * f2abz_0 * a_z * fbzi_0 + 5.0 * tg_0_yzz_p_0_0_1[i] * rb_z[i] * fbzi_0 + 2.0 * tg_0_yzz_d_1_0_0[i] * a_z * a_exp * fbzi_0 * fbzi_0 + tg_0_yzz_d_0_0_0[i] * a_z * faz_0;

        tg_z_zzz_d_0_0_0[i] = 15.0 / 2.0 * tg_0_zz_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_zzz_s_1_0_1[i] * f2abz_0 * a_z * fbzi_0 + 5.0 * tg_0_zzz_p_0_0_1[i] * rb_z[i] * fbzi_0 + 2.0 * tg_0_zzz_d_1_0_0[i] * a_z * a_exp * fbzi_0 * fbzi_0 + tg_0_zzz_d_0_0_0[i] * a_z * faz_0;
    }
