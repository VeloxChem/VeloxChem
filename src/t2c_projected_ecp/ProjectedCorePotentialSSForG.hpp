#ifndef ProjectedCorePotentialSSForG_hpp
#define ProjectedCorePotentialSSForG_hpp
...
/// @brief Computes (S|U_G|S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_projected_core_potential_ss_for_g(T& distributor,
...
#endif /* ProjectedCorePotentialSSForG_hpp */
