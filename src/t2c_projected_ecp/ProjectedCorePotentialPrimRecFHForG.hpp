#ifndef ProjectedCorePotentialPrimRecFHForG
#define ProjectedCorePotentialPrimRecFHForG
...
/// @brief Computes primitive [F|U_l|H]_G integrals with G projectors for set of data buffers.
...
#endif /* ProjectedCorePotentialPrimRecFHForG */
