#ifndef ProjectedCorePotentialPrimRecFGForS
#define ProjectedCorePotentialPrimRecFGForS
...
/// @brief Computes primitive [F|U_l|G]_S integrals with S projectors for set of data buffers.
...
#endif /* ProjectedCorePotentialPrimRecFGForS */
