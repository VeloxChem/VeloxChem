#ifndef ProjectedCorePotentialPrimRecPFForP
#define ProjectedCorePotentialPrimRecPFForP
...
/// @brief Computes primitive [P|U_l|F]_P integrals with P projectors for set of data buffers.
...
#endif /* ProjectedCorePotentialPrimRecPFForP */
