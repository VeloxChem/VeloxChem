                                        ...
                                        const double c_exp) -> void
{
    ...
    #pragma omp simd aligned(b_exps, rb_x, rb_y, rb_z, tg_0_x_p_0_0_1, tg_0_xx_d_0_0_0, tg_0_xx_d_1_0_0, tg_0_xx_p_0_0_1, tg_0_xx_s_1_0_1, tg_0_xy_d_0_0_0, tg_0_xy_d_1_0_0, tg_0_xy_p_0_0_1, tg_0_xy_s_1_0_1, tg_0_xz_d_0_0_0, tg_0_xz_d_1_0_0, tg_0_xz_p_0_0_1, tg_0_xz_s_1_0_1, tg_0_y_p_0_0_1, tg_0_yy_d_0_0_0, tg_0_yy_d_1_0_0, tg_0_yy_p_0_0_1, tg_0_yy_s_1_0_1, tg_0_yz_d_0_0_0, tg_0_yz_d_1_0_0, tg_0_yz_p_0_0_1, tg_0_yz_s_1_0_1, tg_0_z_p_0_0_1, tg_0_zz_d_0_0_0, tg_0_zz_d_1_0_0, tg_0_zz_p_0_0_1, tg_0_zz_s_1_0_1, tg_x_xx_d_0_0_0, tg_x_xy_d_0_0_0, tg_x_xz_d_0_0_0, tg_x_yy_d_0_0_0, tg_x_yz_d_0_0_0, tg_x_zz_d_0_0_0, tg_y_xx_d_0_0_0, tg_y_xy_d_0_0_0, tg_y_xz_d_0_0_0, tg_y_yy_d_0_0_0, tg_y_yz_d_0_0_0, tg_y_zz_d_0_0_0, tg_z_xx_d_0_0_0, tg_z_xy_d_0_0_0, tg_z_xz_d_0_0_0, tg_z_yy_d_0_0_0, tg_z_yz_d_0_0_0, tg_z_zz_d_0_0_0  : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        tg_x_xx_d_0_0_0[i] = 5.0 * tg_0_x_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_xx_s_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 5.0 * tg_0_xx_p_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_0_xx_d_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_0_xx_d_0_0_0[i] * a_x * faz_0;

        tg_x_xy_d_0_0_0[i] = 5.0 / 2.0 * tg_0_y_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_xy_s_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 5.0 * tg_0_xy_p_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_0_xy_d_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_0_xy_d_0_0_0[i] * a_x * faz_0;

        tg_x_xz_d_0_0_0[i] = 5.0 / 2.0 * tg_0_z_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_xz_s_1_0_1[i] * f2abz_0 * a_x * fbzi_0 + 5.0 * tg_0_xz_p_0_0_1[i] * rb_x[i] * fbzi_0 + 2.0 * tg_0_xz_d_1_0_0[i] * a_x * a_exp * fbzi_0 * fbzi_0 + tg_0_xz_d_0_0_0[i] * a_x * faz_0;
        ...
        tg_y_xy_d_0_0_0[i] = 5.0 / 2.0 * tg_0_x_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_xy_s_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 5.0 * tg_0_xy_p_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_0_xy_d_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_0_xy_d_0_0_0[i] * a_y * faz_0;
        ...
        tg_y_yy_d_0_0_0[i] = 5.0 * tg_0_y_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_yy_s_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 5.0 * tg_0_yy_p_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_0_yy_d_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_0_yy_d_0_0_0[i] * a_y * faz_0;

        tg_y_yz_d_0_0_0[i] = 5.0 / 2.0 * tg_0_z_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_yz_s_1_0_1[i] * f2abz_0 * a_y * fbzi_0 + 5.0 * tg_0_yz_p_0_0_1[i] * rb_y[i] * fbzi_0 + 2.0 * tg_0_yz_d_1_0_0[i] * a_y * a_exp * fbzi_0 * fbzi_0 + tg_0_yz_d_0_0_0[i] * a_y * faz_0;
        ...
        tg_z_xz_d_0_0_0[i] = 5.0 / 2.0 * tg_0_x_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_xz_s_1_0_1[i] * f2abz_0 * a_z * fbzi_0 + 5.0 * tg_0_xz_p_0_0_1[i] * rb_z[i] * fbzi_0 + 2.0 * tg_0_xz_d_1_0_0[i] * a_z * a_exp * fbzi_0 * fbzi_0 + tg_0_xz_d_0_0_0[i] * a_z * faz_0;
        ...
        tg_z_yz_d_0_0_0[i] = 5.0 / 2.0 * tg_0_y_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_yz_s_1_0_1[i] * f2abz_0 * a_z * fbzi_0 + 5.0 * tg_0_yz_p_0_0_1[i] * rb_z[i] * fbzi_0 + 2.0 * tg_0_yz_d_1_0_0[i] * a_z * a_exp * fbzi_0 * fbzi_0 + tg_0_yz_d_0_0_0[i] * a_z * faz_0;

        tg_z_zz_d_0_0_0[i] = 5.0 * tg_0_z_p_0_0_1[i] * fbi_0 * fbzi_0 - 5.0 * tg_0_zz_s_1_0_1[i] * f2abz_0 * a_z * fbzi_0 + 5.0 * tg_0_zz_p_0_0_1[i] * rb_z[i] * fbzi_0 + 2.0 * tg_0_zz_d_1_0_0[i] * a_z * a_exp * fbzi_0 * fbzi_0 + tg_0_zz_d_0_0_0[i] * a_z * faz_0;
    }
