                                        ...
                                        const double c_exp) -> void
{
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        tg_0_xxxx_s_0_0_0[i] = 3.0 / 2.0 * tg_0_xx_s_0_0_0[i] * fzi_0 + 3.0 * tg_0_xx_s_0_1_0[i] * fazi_0 * fazi_0 + 2.0 * tg_0_xxx_s_0_1_0[i] * rb_x[i] * fazi_0 * fazi_0 * fb_0 + tg_0_xxx_s_0_0_0[i] * rb_x[i] * fbz_0;
        ...
        tg_0_xxyy_s_0_0_0[i] = 1.0 / 2.0 * tg_0_yy_s_0_0_0[i] * fzi_0 + tg_0_yy_s_0_1_0[i] * fazi_0 * fazi_0 + 2.0 * tg_0_xyy_s_0_1_0[i] * rb_x[i] * fazi_0 * fazi_0 * fb_0 + tg_0_xyy_s_0_0_0[i] * rb_x[i] * fbz_0;

        tg_0_xxyz_s_0_0_0[i] = 2.0 * tg_0_xxz_s_0_1_0[i] * rb_y[i] * fazi_0 * fazi_0 * fb_0 + tg_0_xxz_s_0_0_0[i] * rb_y[i] * fbz_0;

        tg_0_xxzz_s_0_0_0[i] = 1.0 / 2.0 * tg_0_zz_s_0_0_0[i] * fzi_0 + tg_0_zz_s_0_1_0[i] * fazi_0 * fazi_0 + 2.0 * tg_0_xzz_s_0_1_0[i] * rb_x[i] * fazi_0 * fazi_0 * fb_0 + tg_0_xzz_s_0_0_0[i] * rb_x[i] * fbz_0;
        ...
        tg_0_yyyy_s_0_0_0[i] = 3.0 / 2.0 * tg_0_yy_s_0_0_0[i] * fzi_0 + 3.0 * tg_0_yy_s_0_1_0[i] * fazi_0 * fazi_0 + 2.0 * tg_0_yyy_s_0_1_0[i] * rb_y[i] * fazi_0 * fazi_0 * fb_0 + tg_0_yyy_s_0_0_0[i] * rb_y[i] * fbz_0;

        tg_0_yyyz_s_0_0_0[i] = 2.0 * tg_0_yyy_s_0_1_0[i] * rb_z[i] * fazi_0 * fazi_0 * fb_0 + tg_0_yyy_s_0_0_0[i] * rb_z[i] * fbz_0;

        tg_0_yyzz_s_0_0_0[i] = 1.0 / 2.0 * tg_0_zz_s_0_0_0[i] * fzi_0 + tg_0_zz_s_0_1_0[i] * fazi_0 * fazi_0 + 2.0 * tg_0_yzz_s_0_1_0[i] * rb_y[i] * fazi_0 * fazi_0 * fb_0 + tg_0_yzz_s_0_0_0[i] * rb_y[i] * fbz_0;

        tg_0_yzzz_s_0_0_0[i] = 2.0 * tg_0_zzz_s_0_1_0[i] * rb_y[i] * fazi_0 * fazi_0 * fb_0 + tg_0_zzz_s_0_0_0[i] * rb_y[i] * fbz_0;

        tg_0_zzzz_s_0_0_0[i] = 3.0 / 2.0 * tg_0_zz_s_0_0_0[i] * fzi_0 + 3.0 * tg_0_zz_s_0_1_0[i] * fazi_0 * fazi_0 + 2.0 * tg_0_zzz_s_0_1_0[i] * rb_z[i] * fazi_0 * fazi_0 * fb_0 + tg_0_zzz_s_0_0_0[i] * rb_z[i] * fbz_0;
    }
