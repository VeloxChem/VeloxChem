#ifndef ProjectedCorePotentialPrimRecPGForS
#define ProjectedCorePotentialPrimRecPGForS
...
/// @brief Computes primitive [P|U_l|G]_S integrals with S projectors for set of data buffers.
...
#endif /* ProjectedCorePotentialPrimRecPGForS */
