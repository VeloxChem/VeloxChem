#ifndef ThreeCenterOverlapGradientGeom100SumRecSP_hpp
#define ThreeCenterOverlapGradientGeom100SumRecSP_hpp
...
/// @brief Computes (d^(1)/dA^(1)S|GX(r)|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_gradient_geom_10_sp(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    g3ovlrec::comp_prim_overlap_gradient_pp(pbuffer, 17, 2, 5, 8, factors, 20, a_exp, exgtos[l]);

                    t2cgeom::comp_prim_op_geom_10_sx(pbuffer, 44, 17, 3, 3, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 44, ket_width, ket_npgtos);
                }
            }
...
#endif /* ThreeCenterOverlapGradientGeom100SumRecSP_hpp */
