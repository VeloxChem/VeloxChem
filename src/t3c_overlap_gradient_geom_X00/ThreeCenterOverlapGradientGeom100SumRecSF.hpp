#ifndef ThreeCenterOverlapGradientGeom100SumRecSF_hpp
#define ThreeCenterOverlapGradientGeom100SumRecSF_hpp
...
/// @brief Computes (d^(1)/dA^(1)S|GX(r)|F)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_gradient_geom_10_sf(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    g3ovlrec::comp_prim_overlap_gradient_pf(pbuffer, 69, 11, 21, 39, factors, 20, a_exp, exgtos[l]);

                    t2cgeom::comp_prim_op_geom_10_sx(pbuffer, 159, 69, 3, 10, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 159, ket_width, ket_npgtos);
                }
            }
...
#endif /* ThreeCenterOverlapGradientGeom100SumRecSF_hpp */
