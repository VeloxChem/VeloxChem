#ifndef ThreeCenterOverlapGradientGeom100SumRecSG_hpp
#define ThreeCenterOverlapGradientGeom100SumRecSG_hpp
...
/// @brief Computes (d^(1)/dA^(1)S|GX(r)|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_gradient_geom_10_sg(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    g3ovlrec::comp_prim_overlap_gradient_pg(pbuffer, 111, 21, 36, 66, factors, 20, a_exp, exgtos[l]);

                    t2cgeom::comp_prim_op_geom_10_sx(pbuffer, 246, 111, 3, 15, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 246, ket_width, ket_npgtos);
                }
            }
...
#endif /* ThreeCenterOverlapGradientGeom100SumRecSG_hpp */
