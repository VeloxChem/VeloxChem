#ifndef ThreeCenterOverlapGradientGeom100SumRecSD_hpp
#define ThreeCenterOverlapGradientGeom100SumRecSD_hpp
...
/// @brief Computes (d^(1)/dA^(1)S|GX(r)|D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_gradient_geom_10_sd(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_10_sx(pbuffer, 92, 38, 3, 6, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 92, ket_width, ket_npgtos);
                }
            }
...
#endif /* ThreeCenterOverlapGradientGeom100SumRecSD_hpp */
