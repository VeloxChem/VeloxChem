#ifndef ElectronRepulsionGeom1010RecSPPP_hpp
#define ElectronRepulsionGeom1010RecSPPP_hpp
...
/// Computes (SP|1/|r-r'||PP)  integrals for two GTOs pair blocks.
...
template <class T>
auto
comp_electron_repulsion_geom1010_sppp(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1010_sppp(243, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1010_sppp(243, ket_dim);
    ...
    {
        cart_buffer_0_geom1010_sppp.zero();

        spher_buffer_0_geom1010_sppp.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1010_sppp_0(prim_buffer_0_geom1010_sppp, prim_buffer_0_ppsp, prim_buffer_0_ppdp, a_exp, c_exps[0] );

            t2cfunc::reduce(cart_buffer_0_geom1010_sppp, prim_buffer_0_geom1010_sppp, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 1, 1, 1>(spher_buffer_0_geom1010_sppp, cart_spher_buffer_0_geom1010_sppp);

        distributor->distribute(spher_buffer_0_geom1010_sppp, a_indices, b_indices, c_indices, d_indices, 0, 1, 1, 1, 1, 0, 1, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom1010RecSPPP_hpp */
