                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1010_pdsd(972, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1010_pdsd(675, ket_dim);
    ...
    {
        cart_buffer_0_geom1010_pdsd.zero();

        spher_buffer_0_geom1010_pdsd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1010_pdsd_0(prim_buffer_0_geom1010_pdsd, prim_buffer_0_sdpd, prim_buffer_0_ddpd, a_exp, c_exps[0] );

            t2cfunc::reduce(cart_buffer_0_geom1010_pdsd, prim_buffer_0_geom1010_pdsd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 2, 0, 2>(spher_buffer_0_geom1010_pdsd, cart_spher_buffer_0_geom1010_pdsd);

        distributor->distribute(spher_buffer_0_geom1010_pdsd, a_indices, b_indices, c_indices, d_indices, 1, 2, 0, 2, 1, 0, 1, 0, i, ket_indices);
    }
}
