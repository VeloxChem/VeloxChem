                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1010_ppss(81, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1010_ppss(81, ket_dim);
    ...
    {
        cart_buffer_0_geom1010_ppss.zero();

        spher_buffer_0_geom1010_ppss.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1010_ppss_0(prim_buffer_0_geom1010_ppss, prim_buffer_0_spps, prim_buffer_0_dpps, a_exp, c_exps[0] );

            t2cfunc::reduce(cart_buffer_0_geom1010_ppss, prim_buffer_0_geom1010_ppss, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 1, 0, 0>(spher_buffer_0_geom1010_ppss, cart_spher_buffer_0_geom1010_ppss);

        distributor->distribute(spher_buffer_0_geom1010_ppss, a_indices, b_indices, c_indices, d_indices, 1, 1, 0, 0, 1, 0, 1, 0, i, ket_indices);
    }
}
