...
/// Computes (PD|1/|r-r'||SS)  integrals for two GTOs pair blocks.
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1010_pdss(162, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1010_pdss(135, ket_dim);
    ...
    {
        cart_buffer_0_geom1010_pdss.zero();

        spher_buffer_0_geom1010_pdss.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1010_pdss_0(prim_buffer_0_geom1010_pdss, prim_buffer_0_sdps, prim_buffer_0_ddps, a_exp, c_exps[0] );

            t2cfunc::reduce(cart_buffer_0_geom1010_pdss, prim_buffer_0_geom1010_pdss, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 2, 0, 0>(spher_buffer_0_geom1010_pdss, cart_spher_buffer_0_geom1010_pdss);

        distributor->distribute(spher_buffer_0_geom1010_pdss, a_indices, b_indices, c_indices, d_indices, 1, 2, 0, 0, 1, 0, 1, 0, i, ket_indices);
    }
}
