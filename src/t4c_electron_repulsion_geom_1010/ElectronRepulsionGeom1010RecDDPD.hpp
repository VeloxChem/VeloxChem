...
#include "GeomDeriv1010OfScalarForDDPD.hpp"
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1010_ddpd(5832, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1010_ddpd(3375, ket_dim);
    ...
    {
        cart_buffer_0_geom1010_ddpd.zero();

        spher_buffer_0_geom1010_ddpd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1010_ddpd_0(prim_buffer_0_geom1010_ddpd, prim_buffer_0_pdsd, prim_buffer_0_pddd, prim_buffer_0_fdsd, prim_buffer_0_fddd, a_exp, c_exps[0] );

            t2cfunc::reduce(cart_buffer_0_geom1010_ddpd, prim_buffer_0_geom1010_ddpd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<2, 2, 1, 2>(spher_buffer_0_geom1010_ddpd, cart_spher_buffer_0_geom1010_ddpd);

        distributor->distribute(spher_buffer_0_geom1010_ddpd, a_indices, b_indices, c_indices, d_indices, 2, 2, 1, 2, 1, 0, 1, 0, i, ket_indices);
    }
}
