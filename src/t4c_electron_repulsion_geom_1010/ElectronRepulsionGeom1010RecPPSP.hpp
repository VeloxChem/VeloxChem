...
/// Computes (PP|1/|r-r'||SP)  integrals for two GTOs pair blocks.
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1010_ppsp(243, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1010_ppsp(243, ket_dim);
    ...
    {
        cart_buffer_0_geom1010_ppsp.zero();

        spher_buffer_0_geom1010_ppsp.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1010_ppsp_0(prim_buffer_0_geom1010_ppsp, prim_buffer_0_sppp, prim_buffer_0_dppp, a_exp, c_exps[0] );

            t2cfunc::reduce(cart_buffer_0_geom1010_ppsp, prim_buffer_0_geom1010_ppsp, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 1, 0, 1>(spher_buffer_0_geom1010_ppsp, cart_spher_buffer_0_geom1010_ppsp);

        distributor->distribute(spher_buffer_0_geom1010_ppsp, a_indices, b_indices, c_indices, d_indices, 1, 1, 0, 1, 1, 0, 1, 0, i, ket_indices);
    }
}
