#ifndef ElectronRepulsionGeom1010RecSSDD_hpp
#define ElectronRepulsionGeom1010RecSSDD_hpp
...
/// Computes (SS|1/|r-r'||DD)  integrals for two GTOs pair blocks.
...
template <class T>
auto
comp_electron_repulsion_geom1010_ssdd(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1010_ssdd(324, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1010_ssdd(225, ket_dim);
    ...
    {
        cart_buffer_0_geom1010_ssdd.zero();

        spher_buffer_0_geom1010_ssdd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1010_ssdd_0(prim_buffer_0_geom1010_ssdd, prim_buffer_0_pspd, prim_buffer_0_psfd, a_exp, c_exps[0] );

            t2cfunc::reduce(cart_buffer_0_geom1010_ssdd, prim_buffer_0_geom1010_ssdd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 0, 2, 2>(spher_buffer_0_geom1010_ssdd, cart_spher_buffer_0_geom1010_ssdd);

        distributor->distribute(spher_buffer_0_geom1010_ssdd, a_indices, b_indices, c_indices, d_indices, 0, 0, 2, 2, 1, 0, 1, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom1010RecSSDD_hpp */
