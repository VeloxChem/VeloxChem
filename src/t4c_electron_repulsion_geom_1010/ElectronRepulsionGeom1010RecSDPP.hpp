                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1010_sdpp(486, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1010_sdpp(405, ket_dim);
    ...
    {
        cart_buffer_0_geom1010_sdpp.zero();

        spher_buffer_0_geom1010_sdpp.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1010_sdpp_0(prim_buffer_0_geom1010_sdpp, prim_buffer_0_pdsp, prim_buffer_0_pddp, a_exp, c_exps[0] );

            t2cfunc::reduce(cart_buffer_0_geom1010_sdpp, prim_buffer_0_geom1010_sdpp, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 2, 1, 1>(spher_buffer_0_geom1010_sdpp, cart_spher_buffer_0_geom1010_sdpp);

        distributor->distribute(spher_buffer_0_geom1010_sdpp, a_indices, b_indices, c_indices, d_indices, 0, 2, 1, 1, 1, 0, 1, 0, i, ket_indices);
    }
}
