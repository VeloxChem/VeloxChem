                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1010_ddsp(972, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1010_ddsp(675, ket_dim);
    ...
    {
        cart_buffer_0_geom1010_ddsp.zero();

        spher_buffer_0_geom1010_ddsp.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1010_ddsp_0(prim_buffer_0_geom1010_ddsp, prim_buffer_0_pdpp, prim_buffer_0_fdpp, a_exp, c_exps[0] );

            t2cfunc::reduce(cart_buffer_0_geom1010_ddsp, prim_buffer_0_geom1010_ddsp, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<2, 2, 0, 1>(spher_buffer_0_geom1010_ddsp, cart_spher_buffer_0_geom1010_ddsp);

        distributor->distribute(spher_buffer_0_geom1010_ddsp, a_indices, b_indices, c_indices, d_indices, 2, 2, 0, 1, 1, 0, 1, 0, i, ket_indices);
    }
}
