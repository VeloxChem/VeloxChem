#ifndef ElectronRepulsionGeom1010RecSPPD_hpp
#define ElectronRepulsionGeom1010RecSPPD_hpp
...
template <class T>
auto
comp_electron_repulsion_geom1010_sppd(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1010_sppd(486, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1010_sppd(405, ket_dim);
    ...
    {
        cart_buffer_0_geom1010_sppd.zero();

        spher_buffer_0_geom1010_sppd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1010_sppd_0(prim_buffer_0_geom1010_sppd, prim_buffer_0_ppsd, prim_buffer_0_ppdd, a_exp, c_exps[0] );

            t2cfunc::reduce(cart_buffer_0_geom1010_sppd, prim_buffer_0_geom1010_sppd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 1, 1, 2>(spher_buffer_0_geom1010_sppd, cart_spher_buffer_0_geom1010_sppd);

        distributor->distribute(spher_buffer_0_geom1010_sppd, a_indices, b_indices, c_indices, d_indices, 0, 1, 1, 2, 1, 0, 1, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom1010RecSPPD_hpp */
