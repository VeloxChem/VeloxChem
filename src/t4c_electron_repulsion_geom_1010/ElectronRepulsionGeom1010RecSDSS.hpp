#ifndef ElectronRepulsionGeom1010RecSDSS_hpp
#define ElectronRepulsionGeom1010RecSDSS_hpp
...
template <class T>
auto
comp_electron_repulsion_geom1010_sdss(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1010_sdss(54, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1010_sdss(45, ket_dim);
    ...
    {
        cart_buffer_0_geom1010_sdss.zero();

        spher_buffer_0_geom1010_sdss.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1010_sdss_0(prim_buffer_0_geom1010_sdss, prim_buffer_0_pdps, a_exp, c_exps[0] );

            t2cfunc::reduce(cart_buffer_0_geom1010_sdss, prim_buffer_0_geom1010_sdss, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 2, 0, 0>(spher_buffer_0_geom1010_sdss, cart_spher_buffer_0_geom1010_sdss);

        distributor->distribute(spher_buffer_0_geom1010_sdss, a_indices, b_indices, c_indices, d_indices, 0, 2, 0, 0, 1, 0, 1, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom1010RecSDSS_hpp */
