                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1010_sssp(27, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1010_sssp(27, ket_dim);
    ...
    {
        cart_buffer_0_geom1010_sssp.zero();

        spher_buffer_0_geom1010_sssp.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1010_sssp_0(prim_buffer_0_geom1010_sssp, prim_buffer_0_pspp, a_exp, c_exps[0] );

            t2cfunc::reduce(cart_buffer_0_geom1010_sssp, prim_buffer_0_geom1010_sssp, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 0, 0, 1>(spher_buffer_0_geom1010_sssp, cart_spher_buffer_0_geom1010_sssp);

        distributor->distribute(spher_buffer_0_geom1010_sssp, a_indices, b_indices, c_indices, d_indices, 0, 0, 0, 1, 1, 0, 1, 0, i, ket_indices);
    }
}
