...
#include "GeomDeriv1010OfScalarForPDDD.hpp"
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1010_pddd(5832, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1010_pddd(3375, ket_dim);
    ...
    {
        cart_buffer_0_geom1010_pddd.zero();

        spher_buffer_0_geom1010_pddd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1010_pddd_0(prim_buffer_0_geom1010_pddd, prim_buffer_0_sdpd, prim_buffer_0_sdfd, prim_buffer_0_ddpd, prim_buffer_0_ddfd, a_exp, c_exps[0] );

            t2cfunc::reduce(cart_buffer_0_geom1010_pddd, prim_buffer_0_geom1010_pddd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 2, 2, 2>(spher_buffer_0_geom1010_pddd, cart_spher_buffer_0_geom1010_pddd);

        distributor->distribute(spher_buffer_0_geom1010_pddd, a_indices, b_indices, c_indices, d_indices, 1, 2, 2, 2, 1, 0, 1, 0, i, ket_indices);
    }
}
