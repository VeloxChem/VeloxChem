...
/// Computes (SP|1/|r-r'||DD)  integrals for two GTOs pair blocks.
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1010_spdd(972, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1010_spdd(675, ket_dim);
    ...
    {
        cart_buffer_0_geom1010_spdd.zero();

        spher_buffer_0_geom1010_spdd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1010_spdd_0(prim_buffer_0_geom1010_spdd, prim_buffer_0_pppd, prim_buffer_0_ppfd, a_exp, c_exps[0] );

            t2cfunc::reduce(cart_buffer_0_geom1010_spdd, prim_buffer_0_geom1010_spdd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 1, 2, 2>(spher_buffer_0_geom1010_spdd, cart_spher_buffer_0_geom1010_spdd);

        distributor->distribute(spher_buffer_0_geom1010_spdd, a_indices, b_indices, c_indices, d_indices, 0, 1, 2, 2, 1, 0, 1, 0, i, ket_indices);
    }
}
