#ifndef ElectronRepulsionGeom1010RecPDSP_hpp
#define ElectronRepulsionGeom1010RecPDSP_hpp
...
template <class T>
auto
comp_electron_repulsion_geom1010_pdsp(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1010_pdsp(486, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1010_pdsp(405, ket_dim);
    ...
    {
        cart_buffer_0_geom1010_pdsp.zero();

        spher_buffer_0_geom1010_pdsp.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1010_pdsp_0(prim_buffer_0_geom1010_pdsp, prim_buffer_0_sdpp, prim_buffer_0_ddpp, a_exp, c_exps[0] );

            t2cfunc::reduce(cart_buffer_0_geom1010_pdsp, prim_buffer_0_geom1010_pdsp, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 2, 0, 1>(spher_buffer_0_geom1010_pdsp, cart_spher_buffer_0_geom1010_pdsp);

        distributor->distribute(spher_buffer_0_geom1010_pdsp, a_indices, b_indices, c_indices, d_indices, 1, 2, 0, 1, 1, 0, 1, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom1010RecPDSP_hpp */
