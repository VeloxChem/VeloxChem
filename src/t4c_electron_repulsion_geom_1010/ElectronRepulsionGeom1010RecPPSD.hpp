#ifndef ElectronRepulsionGeom1010RecPPSD_hpp
#define ElectronRepulsionGeom1010RecPPSD_hpp
...
template <class T>
auto
comp_electron_repulsion_geom1010_ppsd(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1010_ppsd(486, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1010_ppsd(405, ket_dim);
    ...
    {
        cart_buffer_0_geom1010_ppsd.zero();

        spher_buffer_0_geom1010_ppsd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1010_ppsd_0(prim_buffer_0_geom1010_ppsd, prim_buffer_0_sppd, prim_buffer_0_dppd, a_exp, c_exps[0] );

            t2cfunc::reduce(cart_buffer_0_geom1010_ppsd, prim_buffer_0_geom1010_ppsd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 1, 0, 2>(spher_buffer_0_geom1010_ppsd, cart_spher_buffer_0_geom1010_ppsd);

        distributor->distribute(spher_buffer_0_geom1010_ppsd, a_indices, b_indices, c_indices, d_indices, 1, 1, 0, 2, 1, 0, 1, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom1010RecPPSD_hpp */
