...
/// Computes (SP|1/|r-r'||SS)  integrals for two GTOs pair blocks.
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1010_spss(27, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1010_spss(27, ket_dim);
    ...
    {
        cart_buffer_0_geom1010_spss.zero();

        spher_buffer_0_geom1010_spss.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1010_spss_0(prim_buffer_0_geom1010_spss, prim_buffer_0_ppps, a_exp, c_exps[0] );

            t2cfunc::reduce(cart_buffer_0_geom1010_spss, prim_buffer_0_geom1010_spss, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 1, 0, 0>(spher_buffer_0_geom1010_spss, cart_spher_buffer_0_geom1010_spss);

        distributor->distribute(spher_buffer_0_geom1010_spss, a_indices, b_indices, c_indices, d_indices, 0, 1, 0, 0, 1, 0, 1, 0, i, ket_indices);
    }
}
