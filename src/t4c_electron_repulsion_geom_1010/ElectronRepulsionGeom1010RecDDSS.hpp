...
/// Computes (DD|1/|r-r'||SS)  integrals for two GTOs pair blocks.
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> prim_buffer_0_spps(9, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_0_sdps(18, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_0_psps(9, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_0_ppps(27, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_0_pdps(54, ket_pdim);

    CSimdArray<double> prim_buffer_1_pdps(54, ket_pdim);

    CSimdArray<double> prim_buffer_2_pdps(54, ket_pdim);

    CSimdArray<double> prim_buffer_0_dpps(54, ket_pdim);

    CSimdArray<double> prim_buffer_1_dpps(54, ket_pdim);

    CSimdArray<double> prim_buffer_1_ddss(36, ket_pdim);

    CSimdArray<double> prim_buffer_0_ddps(108, ket_pdim);

    CSimdArray<double> prim_buffer_1_ddps(108, ket_pdim);

    CSimdArray<double> prim_buffer_0_fdps(180, ket_pdim);

    // allocate aligned Cartesian integrals

    CSimdArray<double> cart_buffer_0_geom1010_ddss(324, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1010_ddss(225, ket_dim);
    ...
    {
        cart_buffer_0_geom1010_ddss.zero();

        spher_buffer_0_geom1010_ddss.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            erirec::comp_prim_electron_repulsion_spps(prim_buffer_0_spps, prim_buffer_1_ssss, prim_buffer_0_ssps, prim_buffer_1_ssps, pb_x, pb_y, pb_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_sdps(prim_buffer_0_sdps, prim_buffer_0_ssps, prim_buffer_1_ssps, prim_buffer_1_spss, prim_buffer_0_spps, prim_buffer_1_spps, pb_x, pb_y, pb_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_psps(prim_buffer_0_psps, prim_buffer_1_ssss, prim_buffer_0_ssps, prim_buffer_1_ssps, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_ppps(prim_buffer_0_ppps, prim_buffer_0_ssps, prim_buffer_1_ssps, prim_buffer_1_spss, prim_buffer_0_spps, prim_buffer_1_spps, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_pdps(prim_buffer_0_pdps, prim_buffer_0_spps, prim_buffer_1_spps, prim_buffer_1_sdss, prim_buffer_0_sdps, prim_buffer_1_sdps, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_dpps(prim_buffer_0_dpps, prim_buffer_0_spps, prim_buffer_1_spps, prim_buffer_0_psps, prim_buffer_1_psps, prim_buffer_1_ppss, prim_buffer_0_ppps, prim_buffer_1_ppps, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_ddps(prim_buffer_0_ddps, prim_buffer_0_sdps, prim_buffer_1_sdps, prim_buffer_0_ppps, prim_buffer_1_ppps, prim_buffer_1_pdss, prim_buffer_0_pdps, prim_buffer_1_pdps, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_fdps(prim_buffer_0_fdps, prim_buffer_0_pdps, prim_buffer_1_pdps, prim_buffer_0_dpps, prim_buffer_1_dpps, prim_buffer_1_ddss, prim_buffer_0_ddps, prim_buffer_1_ddps, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);

            t4c_geom::comp_geom1010_ddss_0(prim_buffer_0_geom1010_ddss, prim_buffer_0_pdps, prim_buffer_0_fdps, a_exp, c_exps[0] );

            t2cfunc::reduce(cart_buffer_0_geom1010_ddss, prim_buffer_0_geom1010_ddss, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<2, 2, 0, 0>(spher_buffer_0_geom1010_ddss, cart_spher_buffer_0_geom1010_ddss);

        distributor->distribute(spher_buffer_0_geom1010_ddss, a_indices, b_indices, c_indices, d_indices, 2, 2, 0, 0, 1, 0, 1, 0, i, ket_indices);
    }
}
