                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1010_sdsd(324, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1010_sdsd(225, ket_dim);
    ...
    {
        cart_buffer_0_geom1010_sdsd.zero();

        spher_buffer_0_geom1010_sdsd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1010_sdsd_0(prim_buffer_0_geom1010_sdsd, prim_buffer_0_pdpd, a_exp, c_exps[0] );

            t2cfunc::reduce(cart_buffer_0_geom1010_sdsd, prim_buffer_0_geom1010_sdsd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 2, 0, 2>(spher_buffer_0_geom1010_sdsd, cart_spher_buffer_0_geom1010_sdsd);

        distributor->distribute(spher_buffer_0_geom1010_sdsd, a_indices, b_indices, c_indices, d_indices, 0, 2, 0, 2, 1, 0, 1, 0, i, ket_indices);
    }
}
