#ifndef KineticEnergyGeom101SumRecPF_hpp
#define KineticEnergyGeom101SumRecPF_hpp
...
template <class T>
auto
comp_sum_kinetic_energy_geom_11_pf(T& distributor,
...
#endif /* KineticEnergyGeom101SumRecPF_hpp */
