#ifndef KineticEnergyGeom101RecDD_hpp
#define KineticEnergyGeom101RecDD_hpp
...
template <class T>
auto
comp_kinetic_energy_geom_11_dd(T& distributor,
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                ovlrec::comp_prim_overlap_ff(pbuffer, 460, 100, 208, 280, factors, 8, a_exp);

                kinrec::comp_prim_kinetic_energy_ff(pbuffer, 560, 100, 130, 244, 340, 460, factors, 8, a_exp);

                t2cgeom::comp_prim_op_geom_11_dd(pbuffer, 660, 55, 130, 430, 560, 1, factors, a_exp);

                t2cfunc::reduce(cbuffer, pbuffer, 660, ket_width, ket_npgtos);
            }
...
#endif /* KineticEnergyGeom101RecDD_hpp */
