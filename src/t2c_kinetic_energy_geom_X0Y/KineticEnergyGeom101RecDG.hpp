#ifndef KineticEnergyGeom101RecDG_hpp
#define KineticEnergyGeom101RecDG_hpp
...
template <class T>
auto
comp_kinetic_energy_geom_11_dg(T& distributor,
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cfunc::reduce(cbuffer, pbuffer, 1686, ket_width, ket_npgtos);
            }
...
#endif /* KineticEnergyGeom101RecDG_hpp */
