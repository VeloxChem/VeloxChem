#ifndef KineticEnergyGeom101SumRecGP_hpp
#define KineticEnergyGeom101SumRecGP_hpp
...
template <class T>
auto
comp_sum_kinetic_energy_geom_11_gp(T& distributor,
                                   ...
                                   const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(1399, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < coords.size(); l++)
                {
                    ...
                    ovlrec::comp_prim_overlap_hs(pbuffer, 700, 200, 400, factors, 8, a_exp);

                    kinrec::comp_prim_kinetic_energy_hs(pbuffer, 721, 200, 210, 415, 700, factors, 8, a_exp);

                    ovlrec::comp_prim_overlap_hd(pbuffer, 742, 280, 430, 520, factors, 8, a_exp);

                    kinrec::comp_prim_kinetic_energy_hd(pbuffer, 868, 280, 340, 475, 610, 742, factors, 8, a_exp);

                    t2cgeom::comp_prim_op_geom_11_gp(pbuffer, 994, 210, 340, 721, 868, 1, factors, a_exp);
...
#endif /* KineticEnergyGeom101SumRecGP_hpp */
