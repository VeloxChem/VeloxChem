#ifndef KineticEnergyGeom101RecFD_hpp
#define KineticEnergyGeom101RecFD_hpp
...
template <class T>
auto
comp_kinetic_energy_geom_11_fd(T&                               distributor,
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cfunc::reduce(cbuffer, pbuffer, 1190, ket_width, ket_npgtos);
            }
...
#endif /* KineticEnergyGeom101RecFD_hpp */
