#ifndef KineticEnergyGeom200RecPP_hpp
#define KineticEnergyGeom200RecPP_hpp
...
/// @brief Computes (d^(2)/dA^(2)P|T|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_kinetic_energy_geom_20_pp(T&                               distributor,
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cgeom::comp_prim_op_geom_20_px(pbuffer, 140, 23, 110, 1, 3, a_exp);
...
#endif /* KineticEnergyGeom200RecPP_hpp */
