#ifndef KineticEnergyGeom200RecFD_hpp
#define KineticEnergyGeom200RecFD_hpp
...
/// @brief Computes (d^(2)/dA^(2)F|T|D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_kinetic_energy_geom_20_fd(T& distributor,
                               ...
                               const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(1282, ket_npgtos);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cgeom::comp_prim_op_geom_20_fx(pbuffer, 922, 62, 340, 796, 1, 6, a_exp);
...
#endif /* KineticEnergyGeom200RecFD_hpp */
