#ifndef KineticEnergyGeom200RecSG_hpp
#define KineticEnergyGeom200RecSG_hpp
...
/// @brief Computes (d^(2)/dA^(2)S|T|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_kinetic_energy_geom_20_sg(T& distributor,
                               ...
                               const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(490, ket_npgtos);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cgeom::comp_prim_op_geom_20_sx(pbuffer, 400, 55, 310, 1, 15, a_exp);
...
#endif /* KineticEnergyGeom200RecSG_hpp */
