#ifndef KineticEnergyGeom200RecPD_hpp
#define KineticEnergyGeom200RecPD_hpp
...
/// @brief Computes (d^(2)/dA^(2)P|T|D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_kinetic_energy_geom_20_pd(T& distributor,
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cgeom::comp_prim_op_geom_20_px(pbuffer, 308, 62, 248, 1, 6, a_exp);
...
#endif /* KineticEnergyGeom200RecPD_hpp */
