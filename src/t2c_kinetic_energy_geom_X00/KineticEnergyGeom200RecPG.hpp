#ifndef KineticEnergyGeom200RecPG_hpp
#define KineticEnergyGeom200RecPG_hpp
...
/// @brief Computes (d^(2)/dA^(2)P|T|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_kinetic_energy_geom_20_pg(T& distributor,
                               ...
                               const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(1126, ket_npgtos);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cgeom::comp_prim_op_geom_20_px(pbuffer, 856, 211, 706, 1, 15, a_exp);

                t2cfunc::reduce(cbuffer, pbuffer, 856, ket_width, ket_npgtos);
            }
...
#endif /* KineticEnergyGeom200RecPG_hpp */
