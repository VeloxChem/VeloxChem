#ifndef KineticEnergyGeom100RecGP_hpp
#define KineticEnergyGeom100RecGP_hpp
...
/// @brief Computes (d^(1)/dA^(1)G|T|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_kinetic_energy_geom_10_gp(T& distributor,
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cgeom::comp_prim_op_geom_10_gx(pbuffer, 406, 130, 343, 1, 3, a_exp);
...
#endif /* KineticEnergyGeom100RecGP_hpp */
