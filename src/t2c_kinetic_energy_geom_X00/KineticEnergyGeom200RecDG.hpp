#ifndef KineticEnergyGeom200RecDG_hpp
#define KineticEnergyGeom200RecDG_hpp
...
/// @brief Computes (d^(2)/dA^(2)D|T|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_kinetic_energy_geom_20_dg(T&                               distributor,
                               ...
                               const bool                       bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(2136, ket_npgtos);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cgeom::comp_prim_op_geom_20_dx(pbuffer, 1596, 55, 556, 1371, 1, 15, a_exp);

                t2cfunc::reduce(cbuffer, pbuffer, 1596, ket_width, ket_npgtos);
            }
...
#endif /* KineticEnergyGeom200RecDG_hpp */
