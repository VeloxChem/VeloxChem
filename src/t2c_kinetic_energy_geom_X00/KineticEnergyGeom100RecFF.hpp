#ifndef KineticEnergyGeom100RecFF_hpp
#define KineticEnergyGeom100RecFF_hpp
...
/// @brief Computes (d^(1)/dA^(1)F|T|F)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_kinetic_energy_geom_10_ff(T& distributor,
                               ...
                               const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(1308, ket_npgtos);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cgeom::comp_prim_op_geom_10_fx(pbuffer, 1008, 328, 858, 1, 10, a_exp);

                t2cfunc::reduce(cbuffer, pbuffer, 1008, ket_width, ket_npgtos);
            }
...
#endif /* KineticEnergyGeom100RecFF_hpp */
