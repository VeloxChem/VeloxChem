#ifndef NuclearPotentialGeom020PrimRecSD
#define NuclearPotentialGeom020PrimRecSD

#include "SimdArray.hpp"

namespace npotrec {  // npotrec namespace

/// @brief Computes primitive [S|AG(2)|D]  integrals for set of data buffers.
...
auto comp_prim_nuclear_potential_geom_020_sd(CSimdArray<double>&       pbuffer,
...
#endif /* NuclearPotentialGeom020PrimRecSD */
