#ifndef NuclearPotentialGeom010PrimRecGP
#define NuclearPotentialGeom010PrimRecGP

#include "SimdArray.hpp"

namespace npotrec {  // npotrec namespace

/// @brief Computes primitive [G|AG(1)|P]  integrals for set of data buffers.
...
auto comp_prim_nuclear_potential_geom_010_gp(CSimdArray<double>&       pbuffer,
...
#endif /* NuclearPotentialGeom010PrimRecGP */
