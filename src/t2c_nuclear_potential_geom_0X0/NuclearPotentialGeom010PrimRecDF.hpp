#ifndef NuclearPotentialGeom010PrimRecDF
#define NuclearPotentialGeom010PrimRecDF

#include "SimdArray.hpp"

namespace npotrec {  // npotrec namespace

/// @brief Computes primitive [D|AG(1)|F]  integrals for set of data buffers.
...
auto comp_prim_nuclear_potential_geom_010_df(CSimdArray<double>&       pbuffer,
...
#endif /* NuclearPotentialGeom010PrimRecDF */
