#ifndef NuclearPotentialGeom010SumRecPS_hpp
#define NuclearPotentialGeom010SumRecPS_hpp
...
/// @brief Computes (P|AG(1)|S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_geom_010_ps(T&                               distributor,
...
#endif /* NuclearPotentialGeom010SumRecPS_hpp */
