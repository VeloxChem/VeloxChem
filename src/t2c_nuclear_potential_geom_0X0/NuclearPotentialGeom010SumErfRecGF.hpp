#ifndef NuclearPotentialGeom010SumErfRecGF_hpp
#define NuclearPotentialGeom010SumErfRecGF_hpp
...
/// @brief Computes (G|Erf(AG(1))|F)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_geom_010_gf(T& distributor,
...
#endif /* NuclearPotentialGeom010SumErfRecGF_hpp */
