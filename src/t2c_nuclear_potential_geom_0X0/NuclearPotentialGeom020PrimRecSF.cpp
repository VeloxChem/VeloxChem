                                        ...
                                        const double a_exp) -> void
{
    ...
    #pragma omp simd aligned(pb_x, pb_y, pb_z, pc_x, pc_y, pc_z, ta1_x_0_xx_1, ta1_x_0_yy_1, ta1_x_0_zz_1, ta1_y_0_xx_1, ta1_y_0_yy_1, ta1_y_0_zz_1, ta1_z_0_xx_1, ta1_z_0_yy_1, ta1_z_0_zz_1, ta2_xx_0_x_0, ta2_xx_0_x_1, ta2_xx_0_xx_0, ta2_xx_0_xx_1, ta2_xx_0_xxx_0, ta2_xx_0_xxy_0, ta2_xx_0_xxz_0, ta2_xx_0_xyy_0, ta2_xx_0_xyz_0, ta2_xx_0_xz_0, ta2_xx_0_xz_1, ta2_xx_0_xzz_0, ta2_xx_0_y_0, ta2_xx_0_y_1, ta2_xx_0_yy_0, ta2_xx_0_yy_1, ta2_xx_0_yyy_0, ta2_xx_0_yyz_0, ta2_xx_0_yzz_0, ta2_xx_0_z_0, ta2_xx_0_z_1, ta2_xx_0_zz_0, ta2_xx_0_zz_1, ta2_xx_0_zzz_0, ta2_xy_0_x_0, ta2_xy_0_x_1, ta2_xy_0_xx_0, ta2_xy_0_xx_1, ta2_xy_0_xxx_0, ta2_xy_0_xxy_0, ta2_xy_0_xxz_0, ta2_xy_0_xy_0, ta2_xy_0_xy_1, ta2_xy_0_xyy_0, ta2_xy_0_xyz_0, ta2_xy_0_xzz_0, ta2_xy_0_y_0, ta2_xy_0_y_1, ta2_xy_0_yy_0, ta2_xy_0_yy_1, ta2_xy_0_yyy_0, ta2_xy_0_yyz_0, ta2_xy_0_yzz_0, ta2_xy_0_z_0, ta2_xy_0_z_1, ta2_xy_0_zz_0, ta2_xy_0_zz_1, ta2_xy_0_zzz_0, ta2_xz_0_x_0, ta2_xz_0_x_1, ta2_xz_0_xx_0, ta2_xz_0_xx_1, ta2_xz_0_xxx_0, ta2_xz_0_xxy_0, ta2_xz_0_xxz_0, ta2_xz_0_xyy_0, ta2_xz_0_xyz_0, ta2_xz_0_xz_0, ta2_xz_0_xz_1, ta2_xz_0_xzz_0, ta2_xz_0_y_0, ta2_xz_0_y_1, ta2_xz_0_yy_0, ta2_xz_0_yy_1, ta2_xz_0_yyy_0, ta2_xz_0_yyz_0, ta2_xz_0_yzz_0, ta2_xz_0_z_0, ta2_xz_0_z_1, ta2_xz_0_zz_0, ta2_xz_0_zz_1, ta2_xz_0_zzz_0, ta2_yy_0_x_0, ta2_yy_0_x_1, ta2_yy_0_xx_0, ta2_yy_0_xx_1, ta2_yy_0_xxx_0, ta2_yy_0_xxy_0, ta2_yy_0_xxz_0, ta2_yy_0_xyy_0, ta2_yy_0_xyz_0, ta2_yy_0_xzz_0, ta2_yy_0_y_0, ta2_yy_0_y_1, ta2_yy_0_yy_0, ta2_yy_0_yy_1, ta2_yy_0_yyy_0, ta2_yy_0_yyz_0, ta2_yy_0_yz_0, ta2_yy_0_yz_1, ta2_yy_0_yzz_0, ta2_yy_0_z_0, ta2_yy_0_z_1, ta2_yy_0_zz_0, ta2_yy_0_zz_1, ta2_yy_0_zzz_0, ta2_yz_0_x_0, ta2_yz_0_x_1, ta2_yz_0_xx_0, ta2_yz_0_xx_1, ta2_yz_0_xxx_0, ta2_yz_0_xxy_0, ta2_yz_0_xxz_0, ta2_yz_0_xyy_0, ta2_yz_0_xyz_0, ta2_yz_0_xzz_0, ta2_yz_0_y_0, ta2_yz_0_y_1, ta2_yz_0_yy_0, ta2_yz_0_yy_1, ta2_yz_0_yyy_0, ta2_yz_0_yyz_0, ta2_yz_0_yz_0, ta2_yz_0_yz_1, ta2_yz_0_yzz_0, ta2_yz_0_z_0, ta2_yz_0_z_1, ta2_yz_0_zz_0, ta2_yz_0_zz_1, ta2_yz_0_zzz_0, ta2_zz_0_x_0, ta2_zz_0_x_1, ta2_zz_0_xx_0, ta2_zz_0_xx_1, ta2_zz_0_xxx_0, ta2_zz_0_xxy_0, ta2_zz_0_xxz_0, ta2_zz_0_xyy_0, ta2_zz_0_xyz_0, ta2_zz_0_xzz_0, ta2_zz_0_y_0, ta2_zz_0_y_1, ta2_zz_0_yy_0, ta2_zz_0_yy_1, ta2_zz_0_yyy_0, ta2_zz_0_yyz_0, ta2_zz_0_yz_0, ta2_zz_0_yz_1, ta2_zz_0_yzz_0, ta2_zz_0_z_0, ta2_zz_0_z_1, ta2_zz_0_zz_0, ta2_zz_0_zz_1, ta2_zz_0_zzz_0, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double fe_0 = 0.5 / (a_exp + b_exps[i]);

        ta2_xx_0_xxx_0[i] = 2.0 * ta2_xx_0_x_0[i] * fe_0 - 2.0 * ta2_xx_0_x_1[i] * fe_0 + 2.0 * ta1_x_0_xx_1[i] + ta2_xx_0_xx_0[i] * pb_x[i] - ta2_xx_0_xx_1[i] * pc_x[i];
        ...
        ta2_xy_0_xxx_0[i] = 2.0 * ta2_xy_0_x_0[i] * fe_0 - 2.0 * ta2_xy_0_x_1[i] * fe_0 + ta1_y_0_xx_1[i] + ta2_xy_0_xx_0[i] * pb_x[i] - ta2_xy_0_xx_1[i] * pc_x[i];
        ...
        ta2_xy_0_yyy_0[i] = 2.0 * ta2_xy_0_y_0[i] * fe_0 - 2.0 * ta2_xy_0_y_1[i] * fe_0 + ta1_x_0_yy_1[i] + ta2_xy_0_yy_0[i] * pb_y[i] - ta2_xy_0_yy_1[i] * pc_y[i];
        ...
        ta2_xz_0_xxx_0[i] = 2.0 * ta2_xz_0_x_0[i] * fe_0 - 2.0 * ta2_xz_0_x_1[i] * fe_0 + ta1_z_0_xx_1[i] + ta2_xz_0_xx_0[i] * pb_x[i] - ta2_xz_0_xx_1[i] * pc_x[i];
        ...
        ta2_xz_0_zzz_0[i] = 2.0 * ta2_xz_0_z_0[i] * fe_0 - 2.0 * ta2_xz_0_z_1[i] * fe_0 + ta1_x_0_zz_1[i] + ta2_xz_0_zz_0[i] * pb_z[i] - ta2_xz_0_zz_1[i] * pc_z[i];
        ...
        ta2_yy_0_yyy_0[i] = 2.0 * ta2_yy_0_y_0[i] * fe_0 - 2.0 * ta2_yy_0_y_1[i] * fe_0 + 2.0 * ta1_y_0_yy_1[i] + ta2_yy_0_yy_0[i] * pb_y[i] - ta2_yy_0_yy_1[i] * pc_y[i];
        ...
        ta2_yz_0_yyy_0[i] = 2.0 * ta2_yz_0_y_0[i] * fe_0 - 2.0 * ta2_yz_0_y_1[i] * fe_0 + ta1_z_0_yy_1[i] + ta2_yz_0_yy_0[i] * pb_y[i] - ta2_yz_0_yy_1[i] * pc_y[i];
        ...
        ta2_yz_0_zzz_0[i] = 2.0 * ta2_yz_0_z_0[i] * fe_0 - 2.0 * ta2_yz_0_z_1[i] * fe_0 + ta1_y_0_zz_1[i] + ta2_yz_0_zz_0[i] * pb_z[i] - ta2_yz_0_zz_1[i] * pc_z[i];
        ...
        ta2_zz_0_zzz_0[i] = 2.0 * ta2_zz_0_z_0[i] * fe_0 - 2.0 * ta2_zz_0_z_1[i] * fe_0 + 2.0 * ta1_z_0_zz_1[i] + ta2_zz_0_zz_0[i] * pb_z[i] - ta2_zz_0_zz_1[i] * pc_z[i];
    }
}
