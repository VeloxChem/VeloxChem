#ifndef NuclearPotentialGeom020PrimRecDP
#define NuclearPotentialGeom020PrimRecDP

#include "SimdArray.hpp"

namespace npotrec {  // npotrec namespace

/// @brief Computes primitive [D|AG(2)|P]  integrals for set of data buffers.
...
auto comp_prim_nuclear_potential_geom_020_dp(CSimdArray<double>&       pbuffer,
...
#endif /* NuclearPotentialGeom020PrimRecDP */
