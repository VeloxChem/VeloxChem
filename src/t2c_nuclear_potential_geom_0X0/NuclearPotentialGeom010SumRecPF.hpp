#ifndef NuclearPotentialGeom010SumRecPF_hpp
#define NuclearPotentialGeom010SumRecPF_hpp
...
/// @brief Computes (P|AG(1)|F)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_geom_010_pf(T&                               distributor,
...
#endif /* NuclearPotentialGeom010SumRecPF_hpp */
