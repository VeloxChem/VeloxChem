#ifndef NuclearPotentialGeom010SumErfRecDG_hpp
#define NuclearPotentialGeom010SumErfRecDG_hpp
...
/// @brief Computes (D|Erf(AG(1))|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_geom_010_dg(T& distributor,
...
#endif /* NuclearPotentialGeom010SumErfRecDG_hpp */
