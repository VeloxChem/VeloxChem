#ifndef NuclearPotentialGeom010SumRecFS_hpp
#define NuclearPotentialGeom010SumRecFS_hpp
...
/// @brief Computes (F|AG(1)|S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_geom_010_fs(T&                               distributor,
...
#endif /* NuclearPotentialGeom010SumRecFS_hpp */
