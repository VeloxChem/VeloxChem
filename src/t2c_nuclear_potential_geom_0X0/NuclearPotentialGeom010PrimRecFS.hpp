#ifndef NuclearPotentialGeom010PrimRecFS
#define NuclearPotentialGeom010PrimRecFS

#include "SimdArray.hpp"

namespace npotrec {  // npotrec namespace

/// @brief Computes primitive [F|AG(1)|S]  integrals for set of data buffers.
...
/// @param idx_npot_geom_010_0_ds The index of integral in primitive integrals buffer.
/// @param idx_npot_geom_010_1_ds The index of integral in primitive integrals buffer.
/// @param factors The primitive factors buffer.
/// @param idx_rpa The vector of distances R(PA) = P - A.
/// @param idx_rpc The vector of distances R(PC) = P - C.
/// @param a_exp The primitive basis function exponent on center A.
auto comp_prim_nuclear_potential_geom_010_fs(CSimdArray<double>&       pbuffer,
...
#endif /* NuclearPotentialGeom010PrimRecFS */
