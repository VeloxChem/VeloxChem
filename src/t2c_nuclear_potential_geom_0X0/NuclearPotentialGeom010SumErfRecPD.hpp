#ifndef NuclearPotentialGeom010SumErfRecPD_hpp
#define NuclearPotentialGeom010SumErfRecPD_hpp
...
/// @brief Computes (P|Erf(AG(1))|D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_geom_010_pd(T& distributor,
...
#endif /* NuclearPotentialGeom010SumErfRecPD_hpp */
