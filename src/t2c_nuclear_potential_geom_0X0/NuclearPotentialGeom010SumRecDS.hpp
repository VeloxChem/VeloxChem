#ifndef NuclearPotentialGeom010SumRecDS_hpp
#define NuclearPotentialGeom010SumRecDS_hpp
...
/// @brief Computes (D|AG(1)|S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_geom_010_ds(T&                               distributor,
...
#endif /* NuclearPotentialGeom010SumRecDS_hpp */
