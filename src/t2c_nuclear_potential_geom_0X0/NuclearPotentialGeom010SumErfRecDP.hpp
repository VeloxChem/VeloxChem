#ifndef NuclearPotentialGeom010SumErfRecDP_hpp
#define NuclearPotentialGeom010SumErfRecDP_hpp
...
/// @brief Computes (D|Erf(AG(1))|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_geom_010_dp(T& distributor,
...
#endif /* NuclearPotentialGeom010SumErfRecDP_hpp */
