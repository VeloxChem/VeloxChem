#ifndef NuclearPotentialGeom010PrimRecPH
#define NuclearPotentialGeom010PrimRecPH

#include "SimdArray.hpp"

namespace npotrec {  // npotrec namespace

/// @brief Computes primitive [P|AG(1)|H]  integrals for set of data buffers.
...
auto comp_prim_nuclear_potential_geom_010_ph(CSimdArray<double>&       pbuffer,
...
#endif /* NuclearPotentialGeom010PrimRecPH */
