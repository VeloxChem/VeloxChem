#ifndef NuclearPotentialGeom010PrimRecDS
#define NuclearPotentialGeom010PrimRecDS

#include "SimdArray.hpp"

namespace npotrec {  // npotrec namespace

/// @brief Computes primitive [D|AG(1)|S]  integrals for set of data buffers.
...
auto comp_prim_nuclear_potential_geom_010_ds(CSimdArray<double>&       pbuffer,
...
#endif /* NuclearPotentialGeom010PrimRecDS */
