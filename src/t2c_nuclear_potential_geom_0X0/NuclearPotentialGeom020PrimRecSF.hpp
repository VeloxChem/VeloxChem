#ifndef NuclearPotentialGeom020PrimRecSF
#define NuclearPotentialGeom020PrimRecSF

#include "SimdArray.hpp"

namespace npotrec {  // npotrec namespace

/// @brief Computes primitive [S|AG(2)|F]  integrals for set of data buffers.
...
auto comp_prim_nuclear_potential_geom_020_sf(CSimdArray<double>&       pbuffer,
...
#endif /* NuclearPotentialGeom020PrimRecSF */
