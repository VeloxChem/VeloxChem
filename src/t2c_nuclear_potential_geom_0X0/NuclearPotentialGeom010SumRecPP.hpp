#ifndef NuclearPotentialGeom010SumRecPP_hpp
#define NuclearPotentialGeom010SumRecPP_hpp
...
/// @brief Computes (P|AG(1)|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_geom_010_pp(T&                               distributor,
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < coords.size(); l++)
                {
                    ...
                    npotrec::comp_prim_nuclear_potential_geom_010_pp(
                        pbuffer, 34, 4, 7, 13, 16, 25, factors, 11, 17, a_exp);
...
#endif /* NuclearPotentialGeom010SumRecPP_hpp */
