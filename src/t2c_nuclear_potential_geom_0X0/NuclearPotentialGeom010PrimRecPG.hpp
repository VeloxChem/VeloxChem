#ifndef NuclearPotentialGeom010PrimRecPG
#define NuclearPotentialGeom010PrimRecPG

#include "SimdArray.hpp"

namespace npotrec {  // npotrec namespace

/// @brief Computes primitive [P|AG(1)|G]  integrals for set of data buffers.
...
auto comp_prim_nuclear_potential_geom_010_pg(CSimdArray<double>&       pbuffer,
...
#endif /* NuclearPotentialGeom010PrimRecPG */
