#ifndef NuclearPotentialGeom010PrimRecPI
#define NuclearPotentialGeom010PrimRecPI

#include "SimdArray.hpp"

namespace npotrec {  // npotrec namespace

/// @brief Computes primitive [P|AG(1)|I]  integrals for set of data buffers.
...
auto comp_prim_nuclear_potential_geom_010_pi(CSimdArray<double>&       pbuffer,
...
#endif /* NuclearPotentialGeom010PrimRecPI */
