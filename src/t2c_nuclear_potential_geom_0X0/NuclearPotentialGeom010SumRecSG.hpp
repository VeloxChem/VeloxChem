#ifndef NuclearPotentialGeom010SumRecSG_hpp
#define NuclearPotentialGeom010SumRecSG_hpp
...
/// @brief Computes (S|AG(1)|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_geom_010_sg(T&                               distributor,
...
#endif /* NuclearPotentialGeom010SumRecSG_hpp */
