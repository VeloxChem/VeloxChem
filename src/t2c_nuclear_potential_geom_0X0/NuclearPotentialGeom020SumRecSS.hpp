        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < coords.size(); l++)
                {
                    ...
                    t2cfunc::comp_boys_args(bf_data, 3, factors, 11, a_exp);
                    ...
                    npotrec::comp_prim_nuclear_potential_geom_020_ss(pbuffer, 3, 1, 2, factors, 11, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 3, quadrupoles, 6, l, ket_width, ket_npgtos);
                }
            }
