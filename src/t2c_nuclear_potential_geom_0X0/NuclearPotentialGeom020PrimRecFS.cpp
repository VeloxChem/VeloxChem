                                        ...
                                        const double a_exp) -> void
{
    ...
    #pragma omp simd aligned(pa_x, pa_y, pa_z, pc_x, pc_y, pc_z, ta1_x_xx_0_1, ta1_x_yy_0_1, ta1_x_zz_0_1, ta1_y_xx_0_1, ta1_y_yy_0_1, ta1_y_zz_0_1, ta1_z_xx_0_1, ta1_z_yy_0_1, ta1_z_zz_0_1, ta2_xx_x_0_0, ta2_xx_x_0_1, ta2_xx_xx_0_0, ta2_xx_xx_0_1, ta2_xx_xxx_0_0, ta2_xx_xxy_0_0, ta2_xx_xxz_0_0, ta2_xx_xyy_0_0, ta2_xx_xyz_0_0, ta2_xx_xz_0_0, ta2_xx_xz_0_1, ta2_xx_xzz_0_0, ta2_xx_y_0_0, ta2_xx_y_0_1, ta2_xx_yy_0_0, ta2_xx_yy_0_1, ta2_xx_yyy_0_0, ta2_xx_yyz_0_0, ta2_xx_yzz_0_0, ta2_xx_z_0_0, ta2_xx_z_0_1, ta2_xx_zz_0_0, ta2_xx_zz_0_1, ta2_xx_zzz_0_0, ta2_xy_x_0_0, ta2_xy_x_0_1, ta2_xy_xx_0_0, ta2_xy_xx_0_1, ta2_xy_xxx_0_0, ta2_xy_xxy_0_0, ta2_xy_xxz_0_0, ta2_xy_xy_0_0, ta2_xy_xy_0_1, ta2_xy_xyy_0_0, ta2_xy_xyz_0_0, ta2_xy_xzz_0_0, ta2_xy_y_0_0, ta2_xy_y_0_1, ta2_xy_yy_0_0, ta2_xy_yy_0_1, ta2_xy_yyy_0_0, ta2_xy_yyz_0_0, ta2_xy_yzz_0_0, ta2_xy_z_0_0, ta2_xy_z_0_1, ta2_xy_zz_0_0, ta2_xy_zz_0_1, ta2_xy_zzz_0_0, ta2_xz_x_0_0, ta2_xz_x_0_1, ta2_xz_xx_0_0, ta2_xz_xx_0_1, ta2_xz_xxx_0_0, ta2_xz_xxy_0_0, ta2_xz_xxz_0_0, ta2_xz_xyy_0_0, ta2_xz_xyz_0_0, ta2_xz_xz_0_0, ta2_xz_xz_0_1, ta2_xz_xzz_0_0, ta2_xz_y_0_0, ta2_xz_y_0_1, ta2_xz_yy_0_0, ta2_xz_yy_0_1, ta2_xz_yyy_0_0, ta2_xz_yyz_0_0, ta2_xz_yzz_0_0, ta2_xz_z_0_0, ta2_xz_z_0_1, ta2_xz_zz_0_0, ta2_xz_zz_0_1, ta2_xz_zzz_0_0, ta2_yy_x_0_0, ta2_yy_x_0_1, ta2_yy_xx_0_0, ta2_yy_xx_0_1, ta2_yy_xxx_0_0, ta2_yy_xxy_0_0, ta2_yy_xxz_0_0, ta2_yy_xyy_0_0, ta2_yy_xyz_0_0, ta2_yy_xzz_0_0, ta2_yy_y_0_0, ta2_yy_y_0_1, ta2_yy_yy_0_0, ta2_yy_yy_0_1, ta2_yy_yyy_0_0, ta2_yy_yyz_0_0, ta2_yy_yz_0_0, ta2_yy_yz_0_1, ta2_yy_yzz_0_0, ta2_yy_z_0_0, ta2_yy_z_0_1, ta2_yy_zz_0_0, ta2_yy_zz_0_1, ta2_yy_zzz_0_0, ta2_yz_x_0_0, ta2_yz_x_0_1, ta2_yz_xx_0_0, ta2_yz_xx_0_1, ta2_yz_xxx_0_0, ta2_yz_xxy_0_0, ta2_yz_xxz_0_0, ta2_yz_xyy_0_0, ta2_yz_xyz_0_0, ta2_yz_xzz_0_0, ta2_yz_y_0_0, ta2_yz_y_0_1, ta2_yz_yy_0_0, ta2_yz_yy_0_1, ta2_yz_yyy_0_0, ta2_yz_yyz_0_0, ta2_yz_yz_0_0, ta2_yz_yz_0_1, ta2_yz_yzz_0_0, ta2_yz_z_0_0, ta2_yz_z_0_1, ta2_yz_zz_0_0, ta2_yz_zz_0_1, ta2_yz_zzz_0_0, ta2_zz_x_0_0, ta2_zz_x_0_1, ta2_zz_xx_0_0, ta2_zz_xx_0_1, ta2_zz_xxx_0_0, ta2_zz_xxy_0_0, ta2_zz_xxz_0_0, ta2_zz_xyy_0_0, ta2_zz_xyz_0_0, ta2_zz_xzz_0_0, ta2_zz_y_0_0, ta2_zz_y_0_1, ta2_zz_yy_0_0, ta2_zz_yy_0_1, ta2_zz_yyy_0_0, ta2_zz_yyz_0_0, ta2_zz_yz_0_0, ta2_zz_yz_0_1, ta2_zz_yzz_0_0, ta2_zz_z_0_0, ta2_zz_z_0_1, ta2_zz_zz_0_0, ta2_zz_zz_0_1, ta2_zz_zzz_0_0, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double fe_0 = 0.5 / (a_exp + b_exps[i]);

        ta2_xx_xxx_0_0[i] = 2.0 * ta2_xx_x_0_0[i] * fe_0 - 2.0 * ta2_xx_x_0_1[i] * fe_0 + 2.0 * ta1_x_xx_0_1[i] + ta2_xx_xx_0_0[i] * pa_x[i] - ta2_xx_xx_0_1[i] * pc_x[i];
        ...
        ta2_xy_xxx_0_0[i] = 2.0 * ta2_xy_x_0_0[i] * fe_0 - 2.0 * ta2_xy_x_0_1[i] * fe_0 + ta1_y_xx_0_1[i] + ta2_xy_xx_0_0[i] * pa_x[i] - ta2_xy_xx_0_1[i] * pc_x[i];
        ...
        ta2_xy_yyy_0_0[i] = 2.0 * ta2_xy_y_0_0[i] * fe_0 - 2.0 * ta2_xy_y_0_1[i] * fe_0 + ta1_x_yy_0_1[i] + ta2_xy_yy_0_0[i] * pa_y[i] - ta2_xy_yy_0_1[i] * pc_y[i];
        ...
        ta2_xz_xxx_0_0[i] = 2.0 * ta2_xz_x_0_0[i] * fe_0 - 2.0 * ta2_xz_x_0_1[i] * fe_0 + ta1_z_xx_0_1[i] + ta2_xz_xx_0_0[i] * pa_x[i] - ta2_xz_xx_0_1[i] * pc_x[i];
        ...
        ta2_xz_zzz_0_0[i] = 2.0 * ta2_xz_z_0_0[i] * fe_0 - 2.0 * ta2_xz_z_0_1[i] * fe_0 + ta1_x_zz_0_1[i] + ta2_xz_zz_0_0[i] * pa_z[i] - ta2_xz_zz_0_1[i] * pc_z[i];
        ...
        ta2_yy_yyy_0_0[i] = 2.0 * ta2_yy_y_0_0[i] * fe_0 - 2.0 * ta2_yy_y_0_1[i] * fe_0 + 2.0 * ta1_y_yy_0_1[i] + ta2_yy_yy_0_0[i] * pa_y[i] - ta2_yy_yy_0_1[i] * pc_y[i];
        ...
        ta2_yz_yyy_0_0[i] = 2.0 * ta2_yz_y_0_0[i] * fe_0 - 2.0 * ta2_yz_y_0_1[i] * fe_0 + ta1_z_yy_0_1[i] + ta2_yz_yy_0_0[i] * pa_y[i] - ta2_yz_yy_0_1[i] * pc_y[i];
        ...
        ta2_yz_zzz_0_0[i] = 2.0 * ta2_yz_z_0_0[i] * fe_0 - 2.0 * ta2_yz_z_0_1[i] * fe_0 + ta1_y_zz_0_1[i] + ta2_yz_zz_0_0[i] * pa_z[i] - ta2_yz_zz_0_1[i] * pc_z[i];
        ...
        ta2_zz_zzz_0_0[i] = 2.0 * ta2_zz_z_0_0[i] * fe_0 - 2.0 * ta2_zz_z_0_1[i] * fe_0 + 2.0 * ta1_z_zz_0_1[i] + ta2_zz_zz_0_0[i] * pa_z[i] - ta2_zz_zz_0_1[i] * pc_z[i];
    }
}
