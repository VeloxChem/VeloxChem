#ifndef NuclearPotentialGeom010SumRecPG_hpp
#define NuclearPotentialGeom010SumRecPG_hpp
...
/// @brief Computes (P|AG(1)|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_geom_010_pg(T&                               distributor,
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < coords.size(); l++)
                {
                    ...
                    npotrec::comp_prim_nuclear_potential_geom_010_sg(
                        pbuffer, 297, 100, 118, 172, 192, 222, factors, 14, 17, a_exp);

                    npotrec::comp_prim_nuclear_potential_geom_010_sg(
                        pbuffer, 342, 118, 136, 182, 222, 252, factors, 14, 17, a_exp);

                    npotrec::comp_prim_nuclear_potential_geom_010_pg(
                        pbuffer, 387, 192, 222, 282, 297, 342, factors, 11, 17, a_exp);
...
#endif /* NuclearPotentialGeom010SumRecPG_hpp */
