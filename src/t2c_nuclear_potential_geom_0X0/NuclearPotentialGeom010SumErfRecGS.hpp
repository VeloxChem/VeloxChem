#ifndef NuclearPotentialGeom010SumErfRecGS_hpp
#define NuclearPotentialGeom010SumErfRecGS_hpp
...
/// @brief Computes (G|Erf(AG(1))|S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_geom_010_gs(T& distributor,
...
#endif /* NuclearPotentialGeom010SumErfRecGS_hpp */
