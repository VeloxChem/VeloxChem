#ifndef NuclearPotentialGeom010PrimRecGF
#define NuclearPotentialGeom010PrimRecGF

#include "SimdArray.hpp"

namespace npotrec {  // npotrec namespace

/// @brief Computes primitive [G|AG(1)|F]  integrals for set of data buffers.
...
auto comp_prim_nuclear_potential_geom_010_gf(CSimdArray<double>&       pbuffer,
...
#endif /* NuclearPotentialGeom010PrimRecGF */
