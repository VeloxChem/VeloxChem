#ifndef NuclearPotentialGeom010SumErfRecSD_hpp
#define NuclearPotentialGeom010SumErfRecSD_hpp
...
/// @brief Computes (S|Erf(AG(1))|D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_geom_010_sd(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < coords.size(); l++)
                {
                    ...
                    npotrec::comp_prim_nuclear_potential_sp(pbuffer, 13, 1, 2, factors, 11, 14);

                    npotrec::comp_prim_nuclear_potential_geom_010_sp(pbuffer, 16, 1, 4, 7, factors, 11, 14);
...
#endif /* NuclearPotentialGeom010SumErfRecSD_hpp */
