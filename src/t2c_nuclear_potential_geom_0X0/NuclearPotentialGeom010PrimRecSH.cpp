...
#pragma omp simd aligned(pb_x,                \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        ta1_x_0_xxxxx_0[i] = 4.0 * ta1_x_0_xxx_0[i] * fe_0 - 4.0 * ta1_x_0_xxx_1[i] * fe_0 + ta_0_xxxx_1[i] + ta1_x_0_xxxx_0[i] * pb_x[i] -
        ...
        ta1_x_0_xxyyy_0[i] =
            2.0 * ta1_x_0_xxy_0[i] * fe_0 - 2.0 * ta1_x_0_xxy_1[i] * fe_0 + ta1_x_0_xxyy_0[i] * pb_y[i] - ta1_x_0_xxyy_1[i] * pc_y[i];
        ...
        ta1_x_0_xxzzz_0[i] =
            2.0 * ta1_x_0_xxz_0[i] * fe_0 - 2.0 * ta1_x_0_xxz_1[i] * fe_0 + ta1_x_0_xxzz_0[i] * pb_z[i] - ta1_x_0_xxzz_1[i] * pc_z[i];
        ...
        ta1_x_0_yyyyy_0[i] =
            4.0 * ta1_x_0_yyy_0[i] * fe_0 - 4.0 * ta1_x_0_yyy_1[i] * fe_0 + ta1_x_0_yyyy_0[i] * pb_y[i] - ta1_x_0_yyyy_1[i] * pc_y[i];

        ta1_x_0_yyyyz_0[i] = ta1_x_0_yyyy_0[i] * pb_z[i] - ta1_x_0_yyyy_1[i] * pc_z[i];

        ta1_x_0_yyyzz_0[i] =
            2.0 * ta1_x_0_yzz_0[i] * fe_0 - 2.0 * ta1_x_0_yzz_1[i] * fe_0 + ta1_x_0_yyzz_0[i] * pb_y[i] - ta1_x_0_yyzz_1[i] * pc_y[i];
        ...
        ta1_x_0_zzzzz_0[i] =
            4.0 * ta1_x_0_zzz_0[i] * fe_0 - 4.0 * ta1_x_0_zzz_1[i] * fe_0 + ta1_x_0_zzzz_0[i] * pb_z[i] - ta1_x_0_zzzz_1[i] * pc_z[i];

        ta1_y_0_xxxxx_0[i] =
            4.0 * ta1_y_0_xxx_0[i] * fe_0 - 4.0 * ta1_y_0_xxx_1[i] * fe_0 + ta1_y_0_xxxx_0[i] * pb_x[i] - ta1_y_0_xxxx_1[i] * pc_x[i];
        ...
        ta1_y_0_xxxyy_0[i] =
            2.0 * ta1_y_0_xyy_0[i] * fe_0 - 2.0 * ta1_y_0_xyy_1[i] * fe_0 + ta1_y_0_xxyy_0[i] * pb_x[i] - ta1_y_0_xxyy_1[i] * pc_x[i];

        ta1_y_0_xxxyz_0[i] = ta1_y_0_xxxy_0[i] * pb_z[i] - ta1_y_0_xxxy_1[i] * pc_z[i];

        ta1_y_0_xxxzz_0[i] =
            2.0 * ta1_y_0_xzz_0[i] * fe_0 - 2.0 * ta1_y_0_xzz_1[i] * fe_0 + ta1_y_0_xxzz_0[i] * pb_x[i] - ta1_y_0_xxzz_1[i] * pc_x[i];
        ...
        ta1_y_0_yyyyy_0[i] = 4.0 * ta1_y_0_yyy_0[i] * fe_0 - 4.0 * ta1_y_0_yyy_1[i] * fe_0 + ta_0_yyyy_1[i] + ta1_y_0_yyyy_0[i] * pb_y[i] -
        ...
        ta1_y_0_yyzzz_0[i] =
            2.0 * ta1_y_0_yyz_0[i] * fe_0 - 2.0 * ta1_y_0_yyz_1[i] * fe_0 + ta1_y_0_yyzz_0[i] * pb_z[i] - ta1_y_0_yyzz_1[i] * pc_z[i];

        ta1_y_0_yzzzz_0[i] = ta_0_zzzz_1[i] + ta1_y_0_zzzz_0[i] * pb_y[i] - ta1_y_0_zzzz_1[i] * pc_y[i];

        ta1_y_0_zzzzz_0[i] =
            4.0 * ta1_y_0_zzz_0[i] * fe_0 - 4.0 * ta1_y_0_zzz_1[i] * fe_0 + ta1_y_0_zzzz_0[i] * pb_z[i] - ta1_y_0_zzzz_1[i] * pc_z[i];

        ta1_z_0_xxxxx_0[i] =
            4.0 * ta1_z_0_xxx_0[i] * fe_0 - 4.0 * ta1_z_0_xxx_1[i] * fe_0 + ta1_z_0_xxxx_0[i] * pb_x[i] - ta1_z_0_xxxx_1[i] * pc_x[i];
        ...
        ta1_z_0_xxxyy_0[i] =
            2.0 * ta1_z_0_xyy_0[i] * fe_0 - 2.0 * ta1_z_0_xyy_1[i] * fe_0 + ta1_z_0_xxyy_0[i] * pb_x[i] - ta1_z_0_xxyy_1[i] * pc_x[i];

        ta1_z_0_xxxyz_0[i] = ta1_z_0_xxxz_0[i] * pb_y[i] - ta1_z_0_xxxz_1[i] * pc_y[i];

        ta1_z_0_xxxzz_0[i] =
            2.0 * ta1_z_0_xzz_0[i] * fe_0 - 2.0 * ta1_z_0_xzz_1[i] * fe_0 + ta1_z_0_xxzz_0[i] * pb_x[i] - ta1_z_0_xxzz_1[i] * pc_x[i];
        ...
        ta1_z_0_yyyyy_0[i] =
            4.0 * ta1_z_0_yyy_0[i] * fe_0 - 4.0 * ta1_z_0_yyy_1[i] * fe_0 + ta1_z_0_yyyy_0[i] * pb_y[i] - ta1_z_0_yyyy_1[i] * pc_y[i];

        ta1_z_0_yyyyz_0[i] = ta_0_yyyy_1[i] + ta1_z_0_yyyy_0[i] * pb_z[i] - ta1_z_0_yyyy_1[i] * pc_z[i];

        ta1_z_0_yyyzz_0[i] =
            2.0 * ta1_z_0_yzz_0[i] * fe_0 - 2.0 * ta1_z_0_yzz_1[i] * fe_0 + ta1_z_0_yyzz_0[i] * pb_y[i] - ta1_z_0_yyzz_1[i] * pc_y[i];
        ...
        ta1_z_0_zzzzz_0[i] = 4.0 * ta1_z_0_zzz_0[i] * fe_0 - 4.0 * ta1_z_0_zzz_1[i] * fe_0 + ta_0_zzzz_1[i] + ta1_z_0_zzzz_0[i] * pb_z[i] -
