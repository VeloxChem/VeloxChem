#ifndef NuclearPotentialGeom020PrimRecFG
#define NuclearPotentialGeom020PrimRecFG

#include "SimdArray.hpp"

namespace npotrec {  // npotrec namespace

/// @brief Computes primitive [F|AG(2)|G]  integrals for set of data buffers.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_npot_geom_020_0_fg The index of integral in primitive integrals buffer.
...
/// @param idx_npot_geom_020_1_dg The index of integral in primitive integrals buffer.
/// @param factors The primitive factors buffer.
/// @param idx_rpa The vector of distances R(PA) = P - A.
/// @param idx_rpc The vector of distances R(PC) = P - C.
/// @param a_exp The primitive basis function exponent on center A.
auto comp_prim_nuclear_potential_geom_020_fg(CSimdArray<double>&       pbuffer,
...
#endif /* NuclearPotentialGeom020PrimRecFG */
