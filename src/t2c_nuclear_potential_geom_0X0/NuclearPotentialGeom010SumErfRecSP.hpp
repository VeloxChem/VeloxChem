#ifndef NuclearPotentialGeom010SumErfRecSP_hpp
#define NuclearPotentialGeom010SumErfRecSP_hpp
...
/// @brief Computes (S|Erf(AG(1))|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_geom_010_sp(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < coords.size(); l++)
                {
                    ...
                    npotrec::comp_prim_nuclear_potential_geom_010_sp(pbuffer, 9, 1, 3, 6, factors, 11, 14);
...
#endif /* NuclearPotentialGeom010SumErfRecSP_hpp */
