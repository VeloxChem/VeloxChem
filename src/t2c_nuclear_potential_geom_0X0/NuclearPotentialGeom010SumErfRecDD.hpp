#ifndef NuclearPotentialGeom010SumErfRecDD_hpp
#define NuclearPotentialGeom010SumErfRecDD_hpp
...
/// @brief Computes (D|Erf(AG(1))|D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_geom_010_dd(T& distributor,
...
#endif /* NuclearPotentialGeom010SumErfRecDD_hpp */
