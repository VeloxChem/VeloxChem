                        ...
                        const int32_t              iContrGto)
{
    ...
    auto didx = recursionMap.getIndexOfTerm(CRecursionTerm({"Electric Dipole"}, 1, true, {0, -1, -1, -1}, {0, -1, -1, -1}, 1, 1, 0));
                        ...
                        const int32_t              iContrGto)
{
    ...
    auto pidx_d_4_0_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Electric Dipole"}, 1, true, {4, -1, -1, -1}, {0, -1, -1, -1}, 1, 1, 0));
