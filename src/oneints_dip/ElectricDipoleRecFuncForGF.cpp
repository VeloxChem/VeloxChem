...
{
    ediprecfunc::compElectricDipoleForGF_0_50(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForGF_50_100(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForGF_100_150(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForGF_150_200(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForGF_200_250(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForGF_250_300(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForGF_300_350(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForGF_350_400(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForGF_400_450(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
                             ...
                             const int32_t              iContrGto)
{
    ...
    auto pidx_d_4_3_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Electric Dipole"}, 1, true, {4, -1, -1, -1}, {3, -1, -1, -1}, 1, 1, 0));
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tdx_xxxx_xxx_0[j] =
                pa_x[j] * tdx_xxx_xxx_0[j] + 1.5 * fl1_fx * tdx_xx_xxx_0[j] + 1.5 * fl1_fx * tdx_xxx_xx_0[j] + 0.5 * fl1_fx * ts_xxx_xxx_0[j];
            ...
            tdx_xxxx_xxy_0[j] =
                pa_x[j] * tdx_xxx_xxy_0[j] + 1.5 * fl1_fx * tdx_xx_xxy_0[j] + fl1_fx * tdx_xxx_xy_0[j] + 0.5 * fl1_fx * ts_xxx_xxy_0[j];
            ...
            tdx_xxxx_xxz_0[j] =
                pa_x[j] * tdx_xxx_xxz_0[j] + 1.5 * fl1_fx * tdx_xx_xxz_0[j] + fl1_fx * tdx_xxx_xz_0[j] + 0.5 * fl1_fx * ts_xxx_xxz_0[j];
            ...
            tdx_xxxx_xyy_0[j] =
                pa_x[j] * tdx_xxx_xyy_0[j] + 1.5 * fl1_fx * tdx_xx_xyy_0[j] + 0.5 * fl1_fx * tdx_xxx_yy_0[j] + 0.5 * fl1_fx * ts_xxx_xyy_0[j];
            ...
            tdx_xxxx_xyz_0[j] =
                pa_x[j] * tdx_xxx_xyz_0[j] + 1.5 * fl1_fx * tdx_xx_xyz_0[j] + 0.5 * fl1_fx * tdx_xxx_yz_0[j] + 0.5 * fl1_fx * ts_xxx_xyz_0[j];
            ...
            tdx_xxxx_xzz_0[j] =
                pa_x[j] * tdx_xxx_xzz_0[j] + 1.5 * fl1_fx * tdx_xx_xzz_0[j] + 0.5 * fl1_fx * tdx_xxx_zz_0[j] + 0.5 * fl1_fx * ts_xxx_xzz_0[j];
            ...
            tdx_xxxy_xxx_0[j] =
                pa_x[j] * tdx_xxy_xxx_0[j] + fl1_fx * tdx_xy_xxx_0[j] + 1.5 * fl1_fx * tdx_xxy_xx_0[j] + 0.5 * fl1_fx * ts_xxy_xxx_0[j];
            ...
            tdx_xxxy_xyy_0[j] =
                pa_x[j] * tdx_xxy_xyy_0[j] + fl1_fx * tdx_xy_xyy_0[j] + 0.5 * fl1_fx * tdx_xxy_yy_0[j] + 0.5 * fl1_fx * ts_xxy_xyy_0[j];
            ...
            tdx_xxxy_xyz_0[j] =
                pa_x[j] * tdx_xxy_xyz_0[j] + fl1_fx * tdx_xy_xyz_0[j] + 0.5 * fl1_fx * tdx_xxy_yz_0[j] + 0.5 * fl1_fx * ts_xxy_xyz_0[j];
            ...
            tdx_xxxy_xzz_0[j] =
                pa_x[j] * tdx_xxy_xzz_0[j] + fl1_fx * tdx_xy_xzz_0[j] + 0.5 * fl1_fx * tdx_xxy_zz_0[j] + 0.5 * fl1_fx * ts_xxy_xzz_0[j];
                               ...
                               const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tdx_xxxz_xxx_0[j] =
                pa_x[j] * tdx_xxz_xxx_0[j] + fl1_fx * tdx_xz_xxx_0[j] + 1.5 * fl1_fx * tdx_xxz_xx_0[j] + 0.5 * fl1_fx * ts_xxz_xxx_0[j];
            ...
            tdx_xxxz_xyy_0[j] =
                pa_x[j] * tdx_xxz_xyy_0[j] + fl1_fx * tdx_xz_xyy_0[j] + 0.5 * fl1_fx * tdx_xxz_yy_0[j] + 0.5 * fl1_fx * ts_xxz_xyy_0[j];
            ...
            tdx_xxxz_xyz_0[j] =
                pa_x[j] * tdx_xxz_xyz_0[j] + fl1_fx * tdx_xz_xyz_0[j] + 0.5 * fl1_fx * tdx_xxz_yz_0[j] + 0.5 * fl1_fx * ts_xxz_xyz_0[j];
            ...
            tdx_xxxz_xzz_0[j] =
                pa_x[j] * tdx_xxz_xzz_0[j] + fl1_fx * tdx_xz_xzz_0[j] + 0.5 * fl1_fx * tdx_xxz_zz_0[j] + 0.5 * fl1_fx * ts_xxz_xzz_0[j];
            ...
            tdx_xxyy_xxx_0[j] =
                pa_x[j] * tdx_xyy_xxx_0[j] + 0.5 * fl1_fx * tdx_yy_xxx_0[j] + 1.5 * fl1_fx * tdx_xyy_xx_0[j] + 0.5 * fl1_fx * ts_xyy_xxx_0[j];
            ...
            tdx_xxyy_xxy_0[j] =
                pa_x[j] * tdx_xyy_xxy_0[j] + 0.5 * fl1_fx * tdx_yy_xxy_0[j] + fl1_fx * tdx_xyy_xy_0[j] + 0.5 * fl1_fx * ts_xyy_xxy_0[j];
            ...
            tdx_xxyy_xxz_0[j] =
                pa_x[j] * tdx_xyy_xxz_0[j] + 0.5 * fl1_fx * tdx_yy_xxz_0[j] + fl1_fx * tdx_xyy_xz_0[j] + 0.5 * fl1_fx * ts_xyy_xxz_0[j];
            ...
            tdx_xxyy_xyy_0[j] =
                pa_x[j] * tdx_xyy_xyy_0[j] + 0.5 * fl1_fx * tdx_yy_xyy_0[j] + 0.5 * fl1_fx * tdx_xyy_yy_0[j] + 0.5 * fl1_fx * ts_xyy_xyy_0[j];
        }
                                ...
                                const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tdx_xxyy_xyz_0[j] =
                pa_x[j] * tdx_xyy_xyz_0[j] + 0.5 * fl1_fx * tdx_yy_xyz_0[j] + 0.5 * fl1_fx * tdx_xyy_yz_0[j] + 0.5 * fl1_fx * ts_xyy_xyz_0[j];
            ...
            tdx_xxyy_xzz_0[j] =
                pa_x[j] * tdx_xyy_xzz_0[j] + 0.5 * fl1_fx * tdx_yy_xzz_0[j] + 0.5 * fl1_fx * tdx_xyy_zz_0[j] + 0.5 * fl1_fx * ts_xyy_xzz_0[j];
            ...
            tdx_xxyz_xxx_0[j] =
                pa_x[j] * tdx_xyz_xxx_0[j] + 0.5 * fl1_fx * tdx_yz_xxx_0[j] + 1.5 * fl1_fx * tdx_xyz_xx_0[j] + 0.5 * fl1_fx * ts_xyz_xxx_0[j];
            ...
            tdx_xxyz_xxy_0[j] =
                pa_x[j] * tdx_xyz_xxy_0[j] + 0.5 * fl1_fx * tdx_yz_xxy_0[j] + fl1_fx * tdx_xyz_xy_0[j] + 0.5 * fl1_fx * ts_xyz_xxy_0[j];
            ...
            tdx_xxyz_xxz_0[j] =
                pa_x[j] * tdx_xyz_xxz_0[j] + 0.5 * fl1_fx * tdx_yz_xxz_0[j] + fl1_fx * tdx_xyz_xz_0[j] + 0.5 * fl1_fx * ts_xyz_xxz_0[j];
            ...
            tdx_xxyz_xyy_0[j] =
                pa_x[j] * tdx_xyz_xyy_0[j] + 0.5 * fl1_fx * tdx_yz_xyy_0[j] + 0.5 * fl1_fx * tdx_xyz_yy_0[j] + 0.5 * fl1_fx * ts_xyz_xyy_0[j];
            ...
            tdx_xxyz_xyz_0[j] =
                pa_x[j] * tdx_xyz_xyz_0[j] + 0.5 * fl1_fx * tdx_yz_xyz_0[j] + 0.5 * fl1_fx * tdx_xyz_yz_0[j] + 0.5 * fl1_fx * ts_xyz_xyz_0[j];
            ...
            tdx_xxyz_xzz_0[j] =
                pa_x[j] * tdx_xyz_xzz_0[j] + 0.5 * fl1_fx * tdx_yz_xzz_0[j] + 0.5 * fl1_fx * tdx_xyz_zz_0[j] + 0.5 * fl1_fx * ts_xyz_xzz_0[j];
                                ...
                                const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tdx_xxzz_xxx_0[j] =
                pa_x[j] * tdx_xzz_xxx_0[j] + 0.5 * fl1_fx * tdx_zz_xxx_0[j] + 1.5 * fl1_fx * tdx_xzz_xx_0[j] + 0.5 * fl1_fx * ts_xzz_xxx_0[j];
            ...
            tdx_xxzz_xxy_0[j] =
                pa_x[j] * tdx_xzz_xxy_0[j] + 0.5 * fl1_fx * tdx_zz_xxy_0[j] + fl1_fx * tdx_xzz_xy_0[j] + 0.5 * fl1_fx * ts_xzz_xxy_0[j];
            ...
            tdx_xxzz_xxz_0[j] =
                pa_x[j] * tdx_xzz_xxz_0[j] + 0.5 * fl1_fx * tdx_zz_xxz_0[j] + fl1_fx * tdx_xzz_xz_0[j] + 0.5 * fl1_fx * ts_xzz_xxz_0[j];
            ...
            tdx_xxzz_xyy_0[j] =
                pa_x[j] * tdx_xzz_xyy_0[j] + 0.5 * fl1_fx * tdx_zz_xyy_0[j] + 0.5 * fl1_fx * tdx_xzz_yy_0[j] + 0.5 * fl1_fx * ts_xzz_xyy_0[j];
            ...
            tdx_xxzz_xyz_0[j] =
                pa_x[j] * tdx_xzz_xyz_0[j] + 0.5 * fl1_fx * tdx_zz_xyz_0[j] + 0.5 * fl1_fx * tdx_xzz_yz_0[j] + 0.5 * fl1_fx * ts_xzz_xyz_0[j];
            ...
            tdx_xxzz_xzz_0[j] =
                pa_x[j] * tdx_xzz_xzz_0[j] + 0.5 * fl1_fx * tdx_zz_xzz_0[j] + 0.5 * fl1_fx * tdx_xzz_zz_0[j] + 0.5 * fl1_fx * ts_xzz_xzz_0[j];
                                ...
                                const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tdy_yyyy_xxy_0[j] =
                pa_y[j] * tdy_yyy_xxy_0[j] + 1.5 * fl1_fx * tdy_yy_xxy_0[j] + 0.5 * fl1_fx * tdy_yyy_xx_0[j] + 0.5 * fl1_fx * ts_yyy_xxy_0[j];
            ...
            tdy_yyyy_xyy_0[j] =
                pa_y[j] * tdy_yyy_xyy_0[j] + 1.5 * fl1_fx * tdy_yy_xyy_0[j] + fl1_fx * tdy_yyy_xy_0[j] + 0.5 * fl1_fx * ts_yyy_xyy_0[j];
            ...
            tdy_yyyy_xyz_0[j] =
                pa_y[j] * tdy_yyy_xyz_0[j] + 1.5 * fl1_fx * tdy_yy_xyz_0[j] + 0.5 * fl1_fx * tdy_yyy_xz_0[j] + 0.5 * fl1_fx * ts_yyy_xyz_0[j];
            ...
            tdy_yyyy_yyy_0[j] =
                pa_y[j] * tdy_yyy_yyy_0[j] + 1.5 * fl1_fx * tdy_yy_yyy_0[j] + 1.5 * fl1_fx * tdy_yyy_yy_0[j] + 0.5 * fl1_fx * ts_yyy_yyy_0[j];
            ...
            tdy_yyyy_yyz_0[j] =
                pa_y[j] * tdy_yyy_yyz_0[j] + 1.5 * fl1_fx * tdy_yy_yyz_0[j] + fl1_fx * tdy_yyy_yz_0[j] + 0.5 * fl1_fx * ts_yyy_yyz_0[j];
            ...
            tdy_yyyy_yzz_0[j] =
                pa_y[j] * tdy_yyy_yzz_0[j] + 1.5 * fl1_fx * tdy_yy_yzz_0[j] + 0.5 * fl1_fx * tdy_yyy_zz_0[j] + 0.5 * fl1_fx * ts_yyy_yzz_0[j];
            ...
            tdy_yyyz_xxy_0[j] =
                pa_y[j] * tdy_yyz_xxy_0[j] + fl1_fx * tdy_yz_xxy_0[j] + 0.5 * fl1_fx * tdy_yyz_xx_0[j] + 0.5 * fl1_fx * ts_yyz_xxy_0[j];
            ...
            tdy_yyyz_xyz_0[j] =
                pa_y[j] * tdy_yyz_xyz_0[j] + fl1_fx * tdy_yz_xyz_0[j] + 0.5 * fl1_fx * tdy_yyz_xz_0[j] + 0.5 * fl1_fx * ts_yyz_xyz_0[j];
            ...
            tdy_yyyz_yyy_0[j] =
                pa_y[j] * tdy_yyz_yyy_0[j] + fl1_fx * tdy_yz_yyy_0[j] + 1.5 * fl1_fx * tdy_yyz_yy_0[j] + 0.5 * fl1_fx * ts_yyz_yyy_0[j];
        }
                                ...
                                const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tdy_yyyz_yzz_0[j] =
                pa_y[j] * tdy_yyz_yzz_0[j] + fl1_fx * tdy_yz_yzz_0[j] + 0.5 * fl1_fx * tdy_yyz_zz_0[j] + 0.5 * fl1_fx * ts_yyz_yzz_0[j];
            ...
            tdy_yyzz_xxy_0[j] =
                pa_y[j] * tdy_yzz_xxy_0[j] + 0.5 * fl1_fx * tdy_zz_xxy_0[j] + 0.5 * fl1_fx * tdy_yzz_xx_0[j] + 0.5 * fl1_fx * ts_yzz_xxy_0[j];
            ...
            tdy_yyzz_xyy_0[j] =
                pa_y[j] * tdy_yzz_xyy_0[j] + 0.5 * fl1_fx * tdy_zz_xyy_0[j] + fl1_fx * tdy_yzz_xy_0[j] + 0.5 * fl1_fx * ts_yzz_xyy_0[j];
            ...
            tdy_yyzz_xyz_0[j] =
                pa_y[j] * tdy_yzz_xyz_0[j] + 0.5 * fl1_fx * tdy_zz_xyz_0[j] + 0.5 * fl1_fx * tdy_yzz_xz_0[j] + 0.5 * fl1_fx * ts_yzz_xyz_0[j];
            ...
            tdy_yyzz_yyy_0[j] =
                pa_y[j] * tdy_yzz_yyy_0[j] + 0.5 * fl1_fx * tdy_zz_yyy_0[j] + 1.5 * fl1_fx * tdy_yzz_yy_0[j] + 0.5 * fl1_fx * ts_yzz_yyy_0[j];
            ...
            tdy_yyzz_yyz_0[j] =
                pa_y[j] * tdy_yzz_yyz_0[j] + 0.5 * fl1_fx * tdy_zz_yyz_0[j] + fl1_fx * tdy_yzz_yz_0[j] + 0.5 * fl1_fx * ts_yzz_yyz_0[j];
            ...
            tdy_yyzz_yzz_0[j] =
                pa_y[j] * tdy_yzz_yzz_0[j] + 0.5 * fl1_fx * tdy_zz_yzz_0[j] + 0.5 * fl1_fx * tdy_yzz_zz_0[j] + 0.5 * fl1_fx * ts_yzz_yzz_0[j];
                                ...
                                const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tdz_zzzz_xxz_0[j] =
                pa_z[j] * tdz_zzz_xxz_0[j] + 1.5 * fl1_fx * tdz_zz_xxz_0[j] + 0.5 * fl1_fx * tdz_zzz_xx_0[j] + 0.5 * fl1_fx * ts_zzz_xxz_0[j];
            ...
            tdz_zzzz_xyz_0[j] =
                pa_z[j] * tdz_zzz_xyz_0[j] + 1.5 * fl1_fx * tdz_zz_xyz_0[j] + 0.5 * fl1_fx * tdz_zzz_xy_0[j] + 0.5 * fl1_fx * ts_zzz_xyz_0[j];
            ...
            tdz_zzzz_xzz_0[j] =
                pa_z[j] * tdz_zzz_xzz_0[j] + 1.5 * fl1_fx * tdz_zz_xzz_0[j] + fl1_fx * tdz_zzz_xz_0[j] + 0.5 * fl1_fx * ts_zzz_xzz_0[j];
            ...
            tdz_zzzz_yyz_0[j] =
                pa_z[j] * tdz_zzz_yyz_0[j] + 1.5 * fl1_fx * tdz_zz_yyz_0[j] + 0.5 * fl1_fx * tdz_zzz_yy_0[j] + 0.5 * fl1_fx * ts_zzz_yyz_0[j];
            ...
            tdz_zzzz_yzz_0[j] =
                pa_z[j] * tdz_zzz_yzz_0[j] + 1.5 * fl1_fx * tdz_zz_yzz_0[j] + fl1_fx * tdz_zzz_yz_0[j] + 0.5 * fl1_fx * ts_zzz_yzz_0[j];
            ...
            tdz_zzzz_zzz_0[j] =
                pa_z[j] * tdz_zzz_zzz_0[j] + 1.5 * fl1_fx * tdz_zz_zzz_0[j] + 1.5 * fl1_fx * tdz_zzz_zz_0[j] + 0.5 * fl1_fx * ts_zzz_zzz_0[j];
        }
