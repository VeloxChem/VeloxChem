...
namespace ediprecfunc { // ediprecfunc namespace
    ...
    {
        ediprecfunc::compElectricDipoleForFG_0_50(primBuffer,
                                                  recursionMap,
                                                  osFactors,
                                                  nOSFactors,
                                                  paDistances, 
        ...
        ediprecfunc::compElectricDipoleForFG_50_100(primBuffer,
                                                    recursionMap,
                                                    osFactors,
                                                    nOSFactors,
                                                    paDistances, 
        ...
        ediprecfunc::compElectricDipoleForFG_100_150(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     nOSFactors,
                                                     paDistances, 
        ...
        ediprecfunc::compElectricDipoleForFG_150_200(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     nOSFactors,
                                                     paDistances, 
        ...
        ediprecfunc::compElectricDipoleForFG_200_250(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     nOSFactors,
                                                     paDistances, 
        ...
        ediprecfunc::compElectricDipoleForFG_250_300(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     nOSFactors,
                                                     paDistances, 
        ...
        ediprecfunc::compElectricDipoleForFG_300_350(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     nOSFactors,
                                                     paDistances, 
        ...
        ediprecfunc::compElectricDipoleForFG_350_400(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     nOSFactors,
                                                     paDistances, 
        ...
        ediprecfunc::compElectricDipoleForFG_400_450(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     nOSFactors,
                                                     paDistances, 
                                 ...
                                 const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tdx_xxx_xxxx_0[j] = pa_x[j] * tdx_xx_xxxx_0[j] + fl1_fx * tdx_x_xxxx_0[j] + 2.0 * fl1_fx * tdx_xx_xxx_0[j] + 0.5 * fl1_fx * ts_xx_xxxx_0[j];
                ...
                tdx_xxx_xxxy_0[j] = pa_x[j] * tdx_xx_xxxy_0[j] + fl1_fx * tdx_x_xxxy_0[j] + 1.5 * fl1_fx * tdx_xx_xxy_0[j] + 0.5 * fl1_fx * ts_xx_xxxy_0[j];
                ...
                tdx_xxx_xxxz_0[j] = pa_x[j] * tdx_xx_xxxz_0[j] + fl1_fx * tdx_x_xxxz_0[j] + 1.5 * fl1_fx * tdx_xx_xxz_0[j] + 0.5 * fl1_fx * ts_xx_xxxz_0[j];
                ...
                tdx_xxx_xyyy_0[j] = pa_x[j] * tdx_xx_xyyy_0[j] + fl1_fx * tdx_x_xyyy_0[j] + 0.5 * fl1_fx * tdx_xx_yyy_0[j] + 0.5 * fl1_fx * ts_xx_xyyy_0[j];
                ...
                tdx_xxx_xyyz_0[j] = pa_x[j] * tdx_xx_xyyz_0[j] + fl1_fx * tdx_x_xyyz_0[j] + 0.5 * fl1_fx * tdx_xx_yyz_0[j] + 0.5 * fl1_fx * ts_xx_xyyz_0[j];
                ...
                tdx_xxx_xyzz_0[j] = pa_x[j] * tdx_xx_xyzz_0[j] + fl1_fx * tdx_x_xyzz_0[j] + 0.5 * fl1_fx * tdx_xx_yzz_0[j] + 0.5 * fl1_fx * ts_xx_xyzz_0[j];
                ...
                tdx_xxx_xzzz_0[j] = pa_x[j] * tdx_xx_xzzz_0[j] + fl1_fx * tdx_x_xzzz_0[j] + 0.5 * fl1_fx * tdx_xx_zzz_0[j] + 0.5 * fl1_fx * ts_xx_xzzz_0[j];
                ...
                tdx_xxy_xxxx_0[j] = pa_x[j] * tdx_xy_xxxx_0[j] + 0.5 * fl1_fx * tdx_y_xxxx_0[j] + 2.0 * fl1_fx * tdx_xy_xxx_0[j] + 0.5 * fl1_fx * ts_xy_xxxx_0[j];
                ...
                tdx_xxy_xxxy_0[j] = pa_x[j] * tdx_xy_xxxy_0[j] + 0.5 * fl1_fx * tdx_y_xxxy_0[j] + 1.5 * fl1_fx * tdx_xy_xxy_0[j] + 0.5 * fl1_fx * ts_xy_xxxy_0[j];
                                   ...
                                   const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tdx_xxy_xxxz_0[j] = pa_x[j] * tdx_xy_xxxz_0[j] + 0.5 * fl1_fx * tdx_y_xxxz_0[j] + 1.5 * fl1_fx * tdx_xy_xxz_0[j] + 0.5 * fl1_fx * ts_xy_xxxz_0[j];
                ...
                tdx_xxy_xxyy_0[j] = pa_x[j] * tdx_xy_xxyy_0[j] + 0.5 * fl1_fx * tdx_y_xxyy_0[j] + fl1_fx * tdx_xy_xyy_0[j] + 0.5 * fl1_fx * ts_xy_xxyy_0[j];
                ...
                tdx_xxy_xxyz_0[j] = pa_x[j] * tdx_xy_xxyz_0[j] + 0.5 * fl1_fx * tdx_y_xxyz_0[j] + fl1_fx * tdx_xy_xyz_0[j] + 0.5 * fl1_fx * ts_xy_xxyz_0[j];
                ...
                tdx_xxy_xxzz_0[j] = pa_x[j] * tdx_xy_xxzz_0[j] + 0.5 * fl1_fx * tdx_y_xxzz_0[j] + fl1_fx * tdx_xy_xzz_0[j] + 0.5 * fl1_fx * ts_xy_xxzz_0[j];
                ...
                tdx_xxy_xyyy_0[j] = pa_x[j] * tdx_xy_xyyy_0[j] + 0.5 * fl1_fx * tdx_y_xyyy_0[j] + 0.5 * fl1_fx * tdx_xy_yyy_0[j] + 0.5 * fl1_fx * ts_xy_xyyy_0[j];
                ...
                tdx_xxy_xyyz_0[j] = pa_x[j] * tdx_xy_xyyz_0[j] + 0.5 * fl1_fx * tdx_y_xyyz_0[j] + 0.5 * fl1_fx * tdx_xy_yyz_0[j] + 0.5 * fl1_fx * ts_xy_xyyz_0[j];
                ...
                tdx_xxy_xyzz_0[j] = pa_x[j] * tdx_xy_xyzz_0[j] + 0.5 * fl1_fx * tdx_y_xyzz_0[j] + 0.5 * fl1_fx * tdx_xy_yzz_0[j] + 0.5 * fl1_fx * ts_xy_xyzz_0[j];
                ...
                tdx_xxy_xzzz_0[j] = pa_x[j] * tdx_xy_xzzz_0[j] + 0.5 * fl1_fx * tdx_y_xzzz_0[j] + 0.5 * fl1_fx * tdx_xy_zzz_0[j] + 0.5 * fl1_fx * ts_xy_xzzz_0[j];
                ...
                tdx_xxz_xxxx_0[j] = pa_x[j] * tdx_xz_xxxx_0[j] + 0.5 * fl1_fx * tdx_z_xxxx_0[j] + 2.0 * fl1_fx * tdx_xz_xxx_0[j] + 0.5 * fl1_fx * ts_xz_xxxx_0[j];
                ...
                tdx_xxz_xxxy_0[j] = pa_x[j] * tdx_xz_xxxy_0[j] + 0.5 * fl1_fx * tdx_z_xxxy_0[j] + 1.5 * fl1_fx * tdx_xz_xxy_0[j] + 0.5 * fl1_fx * ts_xz_xxxy_0[j];
                ...
                tdx_xxz_xxxz_0[j] = pa_x[j] * tdx_xz_xxxz_0[j] + 0.5 * fl1_fx * tdx_z_xxxz_0[j] + 1.5 * fl1_fx * tdx_xz_xxz_0[j] + 0.5 * fl1_fx * ts_xz_xxxz_0[j];
                ...
                tdx_xxz_xxyy_0[j] = pa_x[j] * tdx_xz_xxyy_0[j] + 0.5 * fl1_fx * tdx_z_xxyy_0[j] + fl1_fx * tdx_xz_xyy_0[j] + 0.5 * fl1_fx * ts_xz_xxyy_0[j];
            }
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tdx_xxz_xxyz_0[j] = pa_x[j] * tdx_xz_xxyz_0[j] + 0.5 * fl1_fx * tdx_z_xxyz_0[j] + fl1_fx * tdx_xz_xyz_0[j] + 0.5 * fl1_fx * ts_xz_xxyz_0[j];
                ...
                tdx_xxz_xxzz_0[j] = pa_x[j] * tdx_xz_xxzz_0[j] + 0.5 * fl1_fx * tdx_z_xxzz_0[j] + fl1_fx * tdx_xz_xzz_0[j] + 0.5 * fl1_fx * ts_xz_xxzz_0[j];
                ...
                tdx_xxz_xyyy_0[j] = pa_x[j] * tdx_xz_xyyy_0[j] + 0.5 * fl1_fx * tdx_z_xyyy_0[j] + 0.5 * fl1_fx * tdx_xz_yyy_0[j] + 0.5 * fl1_fx * ts_xz_xyyy_0[j];
                ...
                tdx_xxz_xyyz_0[j] = pa_x[j] * tdx_xz_xyyz_0[j] + 0.5 * fl1_fx * tdx_z_xyyz_0[j] + 0.5 * fl1_fx * tdx_xz_yyz_0[j] + 0.5 * fl1_fx * ts_xz_xyyz_0[j];
                ...
                tdx_xxz_xyzz_0[j] = pa_x[j] * tdx_xz_xyzz_0[j] + 0.5 * fl1_fx * tdx_z_xyzz_0[j] + 0.5 * fl1_fx * tdx_xz_yzz_0[j] + 0.5 * fl1_fx * ts_xz_xyzz_0[j];
                ...
                tdx_xxz_xzzz_0[j] = pa_x[j] * tdx_xz_xzzz_0[j] + 0.5 * fl1_fx * tdx_z_xzzz_0[j] + 0.5 * fl1_fx * tdx_xz_zzz_0[j] + 0.5 * fl1_fx * ts_xz_xzzz_0[j];
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tdy_yyy_xxxy_0[j] = pa_y[j] * tdy_yy_xxxy_0[j] + fl1_fx * tdy_y_xxxy_0[j] + 0.5 * fl1_fx * tdy_yy_xxx_0[j] + 0.5 * fl1_fx * ts_yy_xxxy_0[j];
                ...
                tdy_yyy_xxyz_0[j] = pa_y[j] * tdy_yy_xxyz_0[j] + fl1_fx * tdy_y_xxyz_0[j] + 0.5 * fl1_fx * tdy_yy_xxz_0[j] + 0.5 * fl1_fx * ts_yy_xxyz_0[j];
                ...
                tdy_yyy_xyyy_0[j] = pa_y[j] * tdy_yy_xyyy_0[j] + fl1_fx * tdy_y_xyyy_0[j] + 1.5 * fl1_fx * tdy_yy_xyy_0[j] + 0.5 * fl1_fx * ts_yy_xyyy_0[j];
                ...
                tdy_yyy_xyzz_0[j] = pa_y[j] * tdy_yy_xyzz_0[j] + fl1_fx * tdy_y_xyzz_0[j] + 0.5 * fl1_fx * tdy_yy_xzz_0[j] + 0.5 * fl1_fx * ts_yy_xyzz_0[j];
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tdy_yyy_yyyy_0[j] = pa_y[j] * tdy_yy_yyyy_0[j] + fl1_fx * tdy_y_yyyy_0[j] + 2.0 * fl1_fx * tdy_yy_yyy_0[j] + 0.5 * fl1_fx * ts_yy_yyyy_0[j];
                ...
                tdy_yyy_yyyz_0[j] = pa_y[j] * tdy_yy_yyyz_0[j] + fl1_fx * tdy_y_yyyz_0[j] + 1.5 * fl1_fx * tdy_yy_yyz_0[j] + 0.5 * fl1_fx * ts_yy_yyyz_0[j];
                ...
                tdy_yyy_yzzz_0[j] = pa_y[j] * tdy_yy_yzzz_0[j] + fl1_fx * tdy_y_yzzz_0[j] + 0.5 * fl1_fx * tdy_yy_zzz_0[j] + 0.5 * fl1_fx * ts_yy_yzzz_0[j];
                ...
                tdy_yyz_xxxy_0[j] = pa_y[j] * tdy_yz_xxxy_0[j] + 0.5 * fl1_fx * tdy_z_xxxy_0[j] + 0.5 * fl1_fx * tdy_yz_xxx_0[j] + 0.5 * fl1_fx * ts_yz_xxxy_0[j];
                ...
                tdy_yyz_xxyy_0[j] = pa_y[j] * tdy_yz_xxyy_0[j] + 0.5 * fl1_fx * tdy_z_xxyy_0[j] + fl1_fx * tdy_yz_xxy_0[j] + 0.5 * fl1_fx * ts_yz_xxyy_0[j];
                ...
                tdy_yyz_xxyz_0[j] = pa_y[j] * tdy_yz_xxyz_0[j] + 0.5 * fl1_fx * tdy_z_xxyz_0[j] + 0.5 * fl1_fx * tdy_yz_xxz_0[j] + 0.5 * fl1_fx * ts_yz_xxyz_0[j];
                ...
                tdy_yyz_xyyy_0[j] = pa_y[j] * tdy_yz_xyyy_0[j] + 0.5 * fl1_fx * tdy_z_xyyy_0[j] + 1.5 * fl1_fx * tdy_yz_xyy_0[j] + 0.5 * fl1_fx * ts_yz_xyyy_0[j];
                ...
                tdy_yyz_xyyz_0[j] = pa_y[j] * tdy_yz_xyyz_0[j] + 0.5 * fl1_fx * tdy_z_xyyz_0[j] + fl1_fx * tdy_yz_xyz_0[j] + 0.5 * fl1_fx * ts_yz_xyyz_0[j];
                ...
                tdy_yyz_xyzz_0[j] = pa_y[j] * tdy_yz_xyzz_0[j] + 0.5 * fl1_fx * tdy_z_xyzz_0[j] + 0.5 * fl1_fx * tdy_yz_xzz_0[j] + 0.5 * fl1_fx * ts_yz_xyzz_0[j];
                ...
                tdy_yyz_yyyy_0[j] = pa_y[j] * tdy_yz_yyyy_0[j] + 0.5 * fl1_fx * tdy_z_yyyy_0[j] + 2.0 * fl1_fx * tdy_yz_yyy_0[j] + 0.5 * fl1_fx * ts_yz_yyyy_0[j];
                ...
                tdy_yyz_yyyz_0[j] = pa_y[j] * tdy_yz_yyyz_0[j] + 0.5 * fl1_fx * tdy_z_yyyz_0[j] + 1.5 * fl1_fx * tdy_yz_yyz_0[j] + 0.5 * fl1_fx * ts_yz_yyyz_0[j];
            }
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tdy_yyz_yyzz_0[j] = pa_y[j] * tdy_yz_yyzz_0[j] + 0.5 * fl1_fx * tdy_z_yyzz_0[j] + fl1_fx * tdy_yz_yzz_0[j] + 0.5 * fl1_fx * ts_yz_yyzz_0[j];
                ...
                tdy_yyz_yzzz_0[j] = pa_y[j] * tdy_yz_yzzz_0[j] + 0.5 * fl1_fx * tdy_z_yzzz_0[j] + 0.5 * fl1_fx * tdy_yz_zzz_0[j] + 0.5 * fl1_fx * ts_yz_yzzz_0[j];
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tdz_zzz_xxxz_0[j] = pa_z[j] * tdz_zz_xxxz_0[j] + fl1_fx * tdz_z_xxxz_0[j] + 0.5 * fl1_fx * tdz_zz_xxx_0[j] + 0.5 * fl1_fx * ts_zz_xxxz_0[j];
                ...
                tdz_zzz_xxyz_0[j] = pa_z[j] * tdz_zz_xxyz_0[j] + fl1_fx * tdz_z_xxyz_0[j] + 0.5 * fl1_fx * tdz_zz_xxy_0[j] + 0.5 * fl1_fx * ts_zz_xxyz_0[j];
                ...
                tdz_zzz_xyyz_0[j] = pa_z[j] * tdz_zz_xyyz_0[j] + fl1_fx * tdz_z_xyyz_0[j] + 0.5 * fl1_fx * tdz_zz_xyy_0[j] + 0.5 * fl1_fx * ts_zz_xyyz_0[j];
                ...
                tdz_zzz_xzzz_0[j] = pa_z[j] * tdz_zz_xzzz_0[j] + fl1_fx * tdz_z_xzzz_0[j] + 1.5 * fl1_fx * tdz_zz_xzz_0[j] + 0.5 * fl1_fx * ts_zz_xzzz_0[j];
                ...
                tdz_zzz_yyyz_0[j] = pa_z[j] * tdz_zz_yyyz_0[j] + fl1_fx * tdz_z_yyyz_0[j] + 0.5 * fl1_fx * tdz_zz_yyy_0[j] + 0.5 * fl1_fx * ts_zz_yyyz_0[j];
                ...
                tdz_zzz_yzzz_0[j] = pa_z[j] * tdz_zz_yzzz_0[j] + fl1_fx * tdz_z_yzzz_0[j] + 1.5 * fl1_fx * tdz_zz_yzz_0[j] + 0.5 * fl1_fx * ts_zz_yzzz_0[j];
                ...
                tdz_zzz_zzzz_0[j] = pa_z[j] * tdz_zz_zzzz_0[j] + fl1_fx * tdz_z_zzzz_0[j] + 2.0 * fl1_fx * tdz_zz_zzz_0[j] + 0.5 * fl1_fx * ts_zz_zzzz_0[j];
            }
