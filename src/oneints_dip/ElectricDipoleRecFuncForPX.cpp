...
compElectricDipoleForPD(CMemBlock2D<double>&       primBuffer,
                        ...
                        const int32_t              iContrGto)
{
    ediprecfunc::compElectricDipoleForPD_0_27(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForPD_27_54(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
...
compElectricDipoleForDP(CMemBlock2D<double>&       primBuffer,
                        ...
                        const int32_t              iContrGto)
{
    ediprecfunc::compElectricDipoleForDP_0_27(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForDP_27_54(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
...
compElectricDipoleForPF(CMemBlock2D<double>&       primBuffer,
                        ...
                        const int32_t              iContrGto)
{
    ediprecfunc::compElectricDipoleForPF_0_45(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForPF_45_90(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
...
compElectricDipoleForFP(CMemBlock2D<double>&       primBuffer,
                        ...
                        const int32_t              iContrGto)
{
    ediprecfunc::compElectricDipoleForFP_0_45(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForFP_45_90(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
...
compElectricDipoleForPG(CMemBlock2D<double>&       primBuffer,
                        ...
                        const int32_t              iContrGto)
{
    ediprecfunc::compElectricDipoleForPG_0_45(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForPG_45_90(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForPG_90_135(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
...
compElectricDipoleForGP(CMemBlock2D<double>&       primBuffer,
                        ...
                        const int32_t              iContrGto)
{
    ediprecfunc::compElectricDipoleForGP_0_45(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForGP_45_90(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForGP_90_135(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
                             ...
                             const int32_t              iContrGto)
{
    ...
    auto pidx_d_4_1_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Electric Dipole"}, 1, true, {4, -1, -1, -1}, {1, -1, -1, -1}, 1, 1, 0));
