...
{
    ediprecfunc::compElectricDipoleForDD_0_36(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForDD_36_72(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForDD_72_108(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
...
compElectricDipoleForDF(CMemBlock2D<double>&       primBuffer,
                        ...
                        const int32_t              iContrGto)
{
    ediprecfunc::compElectricDipoleForDF_0_45(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForDF_45_90(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForDF_90_135(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForDF_135_180(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
...
compElectricDipoleForFD(CMemBlock2D<double>&       primBuffer,
                        ...
                        const int32_t              iContrGto)
{
    ediprecfunc::compElectricDipoleForFD_0_45(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForFD_45_90(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForFD_90_135(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForFD_135_180(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
...
compElectricDipoleForDG(CMemBlock2D<double>&       primBuffer,
                        ...
                        const int32_t              iContrGto)
{
    ediprecfunc::compElectricDipoleForDG_0_45(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForDG_45_90(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForDG_90_135(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForDG_135_180(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForDG_180_225(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForDG_225_270(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
                             ...
                             const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tdx_xx_xxxx_0[j] =
                pa_x[j] * tdx_x_xxxx_0[j] + 0.5 * fl1_fx * tdx_0_xxxx_0[j] + 2.0 * fl1_fx * tdx_x_xxx_0[j] + 0.5 * fl1_fx * ts_x_xxxx_0[j];
            ...
            tdx_xx_xxxy_0[j] =
                pa_x[j] * tdx_x_xxxy_0[j] + 0.5 * fl1_fx * tdx_0_xxxy_0[j] + 1.5 * fl1_fx * tdx_x_xxy_0[j] + 0.5 * fl1_fx * ts_x_xxxy_0[j];
            ...
            tdx_xx_xxxz_0[j] =
                pa_x[j] * tdx_x_xxxz_0[j] + 0.5 * fl1_fx * tdx_0_xxxz_0[j] + 1.5 * fl1_fx * tdx_x_xxz_0[j] + 0.5 * fl1_fx * ts_x_xxxz_0[j];
            ...
            tdx_xx_xyyy_0[j] =
                pa_x[j] * tdx_x_xyyy_0[j] + 0.5 * fl1_fx * tdx_0_xyyy_0[j] + 0.5 * fl1_fx * tdx_x_yyy_0[j] + 0.5 * fl1_fx * ts_x_xyyy_0[j];
            ...
            tdx_xx_xyyz_0[j] =
                pa_x[j] * tdx_x_xyyz_0[j] + 0.5 * fl1_fx * tdx_0_xyyz_0[j] + 0.5 * fl1_fx * tdx_x_yyz_0[j] + 0.5 * fl1_fx * ts_x_xyyz_0[j];
            ...
            tdx_xx_xyzz_0[j] =
                pa_x[j] * tdx_x_xyzz_0[j] + 0.5 * fl1_fx * tdx_0_xyzz_0[j] + 0.5 * fl1_fx * tdx_x_yzz_0[j] + 0.5 * fl1_fx * ts_x_xyzz_0[j];
            ...
            tdx_xx_xzzz_0[j] =
                pa_x[j] * tdx_x_xzzz_0[j] + 0.5 * fl1_fx * tdx_0_xzzz_0[j] + 0.5 * fl1_fx * tdx_x_zzz_0[j] + 0.5 * fl1_fx * ts_x_xzzz_0[j];
                                ...
                                const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tdy_yy_xxxy_0[j] =
                pa_y[j] * tdy_y_xxxy_0[j] + 0.5 * fl1_fx * tdy_0_xxxy_0[j] + 0.5 * fl1_fx * tdy_y_xxx_0[j] + 0.5 * fl1_fx * ts_y_xxxy_0[j];
            ...
            tdy_yy_xxyz_0[j] =
                pa_y[j] * tdy_y_xxyz_0[j] + 0.5 * fl1_fx * tdy_0_xxyz_0[j] + 0.5 * fl1_fx * tdy_y_xxz_0[j] + 0.5 * fl1_fx * ts_y_xxyz_0[j];
            ...
            tdy_yy_xyyy_0[j] =
                pa_y[j] * tdy_y_xyyy_0[j] + 0.5 * fl1_fx * tdy_0_xyyy_0[j] + 1.5 * fl1_fx * tdy_y_xyy_0[j] + 0.5 * fl1_fx * ts_y_xyyy_0[j];
            ...
            tdy_yy_xyzz_0[j] =
                pa_y[j] * tdy_y_xyzz_0[j] + 0.5 * fl1_fx * tdy_0_xyzz_0[j] + 0.5 * fl1_fx * tdy_y_xzz_0[j] + 0.5 * fl1_fx * ts_y_xyzz_0[j];
            ...
            tdy_yy_yyyy_0[j] =
                pa_y[j] * tdy_y_yyyy_0[j] + 0.5 * fl1_fx * tdy_0_yyyy_0[j] + 2.0 * fl1_fx * tdy_y_yyy_0[j] + 0.5 * fl1_fx * ts_y_yyyy_0[j];
            ...
            tdy_yy_yyyz_0[j] =
                pa_y[j] * tdy_y_yyyz_0[j] + 0.5 * fl1_fx * tdy_0_yyyz_0[j] + 1.5 * fl1_fx * tdy_y_yyz_0[j] + 0.5 * fl1_fx * ts_y_yyyz_0[j];
            ...
            tdy_yy_yzzz_0[j] =
                pa_y[j] * tdy_y_yzzz_0[j] + 0.5 * fl1_fx * tdy_0_yzzz_0[j] + 0.5 * fl1_fx * tdy_y_zzz_0[j] + 0.5 * fl1_fx * ts_y_yzzz_0[j];
                                ...
                                const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tdz_zz_xxxz_0[j] =
                pa_z[j] * tdz_z_xxxz_0[j] + 0.5 * fl1_fx * tdz_0_xxxz_0[j] + 0.5 * fl1_fx * tdz_z_xxx_0[j] + 0.5 * fl1_fx * ts_z_xxxz_0[j];
            ...
            tdz_zz_xxyz_0[j] =
                pa_z[j] * tdz_z_xxyz_0[j] + 0.5 * fl1_fx * tdz_0_xxyz_0[j] + 0.5 * fl1_fx * tdz_z_xxy_0[j] + 0.5 * fl1_fx * ts_z_xxyz_0[j];
            ...
            tdz_zz_xyyz_0[j] =
                pa_z[j] * tdz_z_xyyz_0[j] + 0.5 * fl1_fx * tdz_0_xyyz_0[j] + 0.5 * fl1_fx * tdz_z_xyy_0[j] + 0.5 * fl1_fx * ts_z_xyyz_0[j];
            ...
            tdz_zz_xzzz_0[j] =
                pa_z[j] * tdz_z_xzzz_0[j] + 0.5 * fl1_fx * tdz_0_xzzz_0[j] + 1.5 * fl1_fx * tdz_z_xzz_0[j] + 0.5 * fl1_fx * ts_z_xzzz_0[j];
            ...
            tdz_zz_yyyz_0[j] =
                pa_z[j] * tdz_z_yyyz_0[j] + 0.5 * fl1_fx * tdz_0_yyyz_0[j] + 0.5 * fl1_fx * tdz_z_yyy_0[j] + 0.5 * fl1_fx * ts_z_yyyz_0[j];
            ...
            tdz_zz_yzzz_0[j] =
                pa_z[j] * tdz_z_yzzz_0[j] + 0.5 * fl1_fx * tdz_0_yzzz_0[j] + 1.5 * fl1_fx * tdz_z_yzz_0[j] + 0.5 * fl1_fx * ts_z_yzzz_0[j];
            ...
            tdz_zz_zzzz_0[j] =
                pa_z[j] * tdz_z_zzzz_0[j] + 0.5 * fl1_fx * tdz_0_zzzz_0[j] + 2.0 * fl1_fx * tdz_z_zzz_0[j] + 0.5 * fl1_fx * ts_z_zzzz_0[j];
        }
...
compElectricDipoleForGD(CMemBlock2D<double>&       primBuffer,
                        ...
                        const int32_t              iContrGto)
{
    ediprecfunc::compElectricDipoleForGD_0_45(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForGD_45_90(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForGD_90_135(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForGD_135_180(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForGD_180_225(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ediprecfunc::compElectricDipoleForGD_225_270(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
                             ...
                             const int32_t              iContrGto)
{
    ...
    auto pidx_d_4_2_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Electric Dipole"}, 1, true, {4, -1, -1, -1}, {2, -1, -1, -1}, 1, 1, 0));
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tdx_xxxx_xy_0[j] =
                pa_x[j] * tdx_xxx_xy_0[j] + 1.5 * fl1_fx * tdx_xx_xy_0[j] + 0.5 * fl1_fx * tdx_xxx_y_0[j] + 0.5 * fl1_fx * ts_xxx_xy_0[j];
            ...
            tdx_xxxx_xz_0[j] =
                pa_x[j] * tdx_xxx_xz_0[j] + 1.5 * fl1_fx * tdx_xx_xz_0[j] + 0.5 * fl1_fx * tdx_xxx_z_0[j] + 0.5 * fl1_fx * ts_xxx_xz_0[j];
                              ...
                              const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tdx_xxyy_xy_0[j] =
                pa_x[j] * tdx_xyy_xy_0[j] + 0.5 * fl1_fx * tdx_yy_xy_0[j] + 0.5 * fl1_fx * tdx_xyy_y_0[j] + 0.5 * fl1_fx * ts_xyy_xy_0[j];
            ...
            tdx_xxyy_xz_0[j] =
                pa_x[j] * tdx_xyy_xz_0[j] + 0.5 * fl1_fx * tdx_yy_xz_0[j] + 0.5 * fl1_fx * tdx_xyy_z_0[j] + 0.5 * fl1_fx * ts_xyy_xz_0[j];
            ...
            tdx_xxyz_xy_0[j] =
                pa_x[j] * tdx_xyz_xy_0[j] + 0.5 * fl1_fx * tdx_yz_xy_0[j] + 0.5 * fl1_fx * tdx_xyz_y_0[j] + 0.5 * fl1_fx * ts_xyz_xy_0[j];
            ...
            tdx_xxyz_xz_0[j] =
                pa_x[j] * tdx_xyz_xz_0[j] + 0.5 * fl1_fx * tdx_yz_xz_0[j] + 0.5 * fl1_fx * tdx_xyz_z_0[j] + 0.5 * fl1_fx * ts_xyz_xz_0[j];
                               ...
                               const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tdx_xxzz_xy_0[j] =
                pa_x[j] * tdx_xzz_xy_0[j] + 0.5 * fl1_fx * tdx_zz_xy_0[j] + 0.5 * fl1_fx * tdx_xzz_y_0[j] + 0.5 * fl1_fx * ts_xzz_xy_0[j];
            ...
            tdx_xxzz_xz_0[j] =
                pa_x[j] * tdx_xzz_xz_0[j] + 0.5 * fl1_fx * tdx_zz_xz_0[j] + 0.5 * fl1_fx * tdx_xzz_z_0[j] + 0.5 * fl1_fx * ts_xzz_xz_0[j];
                                ...
                                const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tdy_yyyy_xy_0[j] =
                pa_y[j] * tdy_yyy_xy_0[j] + 1.5 * fl1_fx * tdy_yy_xy_0[j] + 0.5 * fl1_fx * tdy_yyy_x_0[j] + 0.5 * fl1_fx * ts_yyy_xy_0[j];
            ...
            tdy_yyyy_yz_0[j] =
                pa_y[j] * tdy_yyy_yz_0[j] + 1.5 * fl1_fx * tdy_yy_yz_0[j] + 0.5 * fl1_fx * tdy_yyy_z_0[j] + 0.5 * fl1_fx * ts_yyy_yz_0[j];
            ...
            tdy_yyzz_xy_0[j] =
                pa_y[j] * tdy_yzz_xy_0[j] + 0.5 * fl1_fx * tdy_zz_xy_0[j] + 0.5 * fl1_fx * tdy_yzz_x_0[j] + 0.5 * fl1_fx * ts_yzz_xy_0[j];
                                ...
                                const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tdy_yyzz_yz_0[j] =
                pa_y[j] * tdy_yzz_yz_0[j] + 0.5 * fl1_fx * tdy_zz_yz_0[j] + 0.5 * fl1_fx * tdy_yzz_z_0[j] + 0.5 * fl1_fx * ts_yzz_yz_0[j];
            ...
            tdz_zzzz_xz_0[j] =
                pa_z[j] * tdz_zzz_xz_0[j] + 1.5 * fl1_fx * tdz_zz_xz_0[j] + 0.5 * fl1_fx * tdz_zzz_x_0[j] + 0.5 * fl1_fx * ts_zzz_xz_0[j];
            ...
            tdz_zzzz_yz_0[j] =
                pa_z[j] * tdz_zzz_yz_0[j] + 1.5 * fl1_fx * tdz_zz_yz_0[j] + 0.5 * fl1_fx * tdz_zzz_y_0[j] + 0.5 * fl1_fx * ts_zzz_yz_0[j];
