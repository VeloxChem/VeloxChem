                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1100_spdd(972, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1100_spdd(675, ket_dim);
    ...
    {
        cart_buffer_0_geom1100_spdd.zero();

        spher_buffer_0_geom1100_spdd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1100_spdd_0(prim_buffer_0_geom1100_spdd, prim_buffer_0_psdd, prim_buffer_0_pddd, a_exp, b_exp );

            t2cfunc::reduce(cart_buffer_0_geom1100_spdd, prim_buffer_0_geom1100_spdd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 1, 2, 2>(spher_buffer_0_geom1100_spdd, cart_spher_buffer_0_geom1100_spdd);

        distributor->distribute(spher_buffer_0_geom1100_spdd, a_indices, b_indices, c_indices, d_indices, 0, 1, 2, 2, 1, 1, 0, 0, i, ket_indices);
    }
}
