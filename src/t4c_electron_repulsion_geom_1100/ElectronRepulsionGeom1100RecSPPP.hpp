                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1100_sppp(243, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1100_sppp(243, ket_dim);
    ...
    {
        cart_buffer_0_geom1100_sppp.zero();

        spher_buffer_0_geom1100_sppp.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1100_sppp_0(prim_buffer_0_geom1100_sppp, prim_buffer_0_pspp, prim_buffer_0_pdpp, a_exp, b_exp );

            t2cfunc::reduce(cart_buffer_0_geom1100_sppp, prim_buffer_0_geom1100_sppp, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 1, 1, 1>(spher_buffer_0_geom1100_sppp, cart_spher_buffer_0_geom1100_sppp);

        distributor->distribute(spher_buffer_0_geom1100_sppp, a_indices, b_indices, c_indices, d_indices, 0, 1, 1, 1, 1, 1, 0, 0, i, ket_indices);
    }
}
