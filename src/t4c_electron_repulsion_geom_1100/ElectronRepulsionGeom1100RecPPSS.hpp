                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1100_ppss(81, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1100_ppss(81, ket_dim);
    ...
    {
        cart_buffer_0_geom1100_ppss.zero();

        spher_buffer_0_geom1100_ppss.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1100_ppss_0(prim_buffer_0_geom1100_ppss, prim_buffer_0_ssss, prim_buffer_0_sdss, prim_buffer_0_dsss, prim_buffer_0_ddss, a_exp, b_exp );

            t2cfunc::reduce(cart_buffer_0_geom1100_ppss, prim_buffer_0_geom1100_ppss, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 1, 0, 0>(spher_buffer_0_geom1100_ppss, cart_spher_buffer_0_geom1100_ppss);

        distributor->distribute(spher_buffer_0_geom1100_ppss, a_indices, b_indices, c_indices, d_indices, 1, 1, 0, 0, 1, 1, 0, 0, i, ket_indices);
    }
}
