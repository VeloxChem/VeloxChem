                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1100_ppsp(243, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1100_ppsp(243, ket_dim);
    ...
    {
        cart_buffer_0_geom1100_ppsp.zero();

        spher_buffer_0_geom1100_ppsp.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1100_ppsp_0(prim_buffer_0_geom1100_ppsp, prim_buffer_0_sssp, prim_buffer_0_sdsp, prim_buffer_0_dssp, prim_buffer_0_ddsp, a_exp, b_exp );

            t2cfunc::reduce(cart_buffer_0_geom1100_ppsp, prim_buffer_0_geom1100_ppsp, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 1, 0, 1>(spher_buffer_0_geom1100_ppsp, cart_spher_buffer_0_geom1100_ppsp);

        distributor->distribute(spher_buffer_0_geom1100_ppsp, a_indices, b_indices, c_indices, d_indices, 1, 1, 0, 1, 1, 1, 0, 0, i, ket_indices);
    }
}
