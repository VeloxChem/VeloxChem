                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1100_pdss(162, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1100_pdss(135, ket_dim);
    ...
    {
        cart_buffer_0_geom1100_pdss.zero();

        spher_buffer_0_geom1100_pdss.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1100_pdss_0(prim_buffer_0_geom1100_pdss, prim_buffer_0_spss, prim_buffer_0_sfss, prim_buffer_0_dpss, prim_buffer_0_dfss, a_exp, b_exp );

            t2cfunc::reduce(cart_buffer_0_geom1100_pdss, prim_buffer_0_geom1100_pdss, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 2, 0, 0>(spher_buffer_0_geom1100_pdss, cart_spher_buffer_0_geom1100_pdss);

        distributor->distribute(spher_buffer_0_geom1100_pdss, a_indices, b_indices, c_indices, d_indices, 1, 2, 0, 0, 1, 1, 0, 0, i, ket_indices);
    }
}
