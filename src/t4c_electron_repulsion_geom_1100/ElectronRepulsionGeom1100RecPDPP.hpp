                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1100_pdpp(1458, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1100_pdpp(1215, ket_dim);
    ...
    {
        cart_buffer_0_geom1100_pdpp.zero();

        spher_buffer_0_geom1100_pdpp.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1100_pdpp_0(prim_buffer_0_geom1100_pdpp, prim_buffer_0_sppp, prim_buffer_0_sfpp, prim_buffer_0_dppp, prim_buffer_0_dfpp, a_exp, b_exp );

            t2cfunc::reduce(cart_buffer_0_geom1100_pdpp, prim_buffer_0_geom1100_pdpp, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 2, 1, 1>(spher_buffer_0_geom1100_pdpp, cart_spher_buffer_0_geom1100_pdpp);

        distributor->distribute(spher_buffer_0_geom1100_pdpp, a_indices, b_indices, c_indices, d_indices, 1, 2, 1, 1, 1, 1, 0, 0, i, ket_indices);
    }
}
