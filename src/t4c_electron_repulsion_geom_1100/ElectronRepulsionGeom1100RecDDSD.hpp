...
#include "ElectronRepulsionPrimRecFFSD.hpp"
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> prim_buffer_0_ffsd(600, ket_pdim);

    // allocate aligned Cartesian integrals

    CSimdArray<double> cart_buffer_0_geom1100_ddsd(1944, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1100_ddsd(1125, ket_dim);
    ...
    {
        cart_buffer_0_geom1100_ddsd.zero();

        spher_buffer_0_geom1100_ddsd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            erirec::comp_prim_electron_repulsion_ffsd(prim_buffer_0_ffsd, prim_buffer_0_pfsd, prim_buffer_1_pfsd, prim_buffer_0_ddsd, prim_buffer_1_ddsd, prim_buffer_1_dfsp, prim_buffer_0_dfsd, prim_buffer_1_dfsd, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);

            t4c_geom::comp_geom1100_ddsd_0(prim_buffer_0_geom1100_ddsd, prim_buffer_0_ppsd, prim_buffer_0_pfsd, prim_buffer_0_fpsd, prim_buffer_0_ffsd, a_exp, b_exp );

            t2cfunc::reduce(cart_buffer_0_geom1100_ddsd, prim_buffer_0_geom1100_ddsd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<2, 2, 0, 2>(spher_buffer_0_geom1100_ddsd, cart_spher_buffer_0_geom1100_ddsd);

        distributor->distribute(spher_buffer_0_geom1100_ddsd, a_indices, b_indices, c_indices, d_indices, 2, 2, 0, 2, 1, 1, 0, 0, i, ket_indices);
    }
}
