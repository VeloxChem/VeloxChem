                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1100_ssdd(324, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1100_ssdd(225, ket_dim);
    ...
    {
        cart_buffer_0_geom1100_ssdd.zero();

        spher_buffer_0_geom1100_ssdd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1100_ssdd_0(prim_buffer_0_geom1100_ssdd, prim_buffer_0_ppdd, a_exp, b_exp );

            t2cfunc::reduce(cart_buffer_0_geom1100_ssdd, prim_buffer_0_geom1100_ssdd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 0, 2, 2>(spher_buffer_0_geom1100_ssdd, cart_spher_buffer_0_geom1100_ssdd);

        distributor->distribute(spher_buffer_0_geom1100_ssdd, a_indices, b_indices, c_indices, d_indices, 0, 0, 2, 2, 1, 1, 0, 0, i, ket_indices);
    }
}
