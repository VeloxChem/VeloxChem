...
/// Computes (SD|1/|r-r'||SP)  integrals for two GTOs pair blocks.
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1100_sdsp(162, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1100_sdsp(135, ket_dim);
    ...
    {
        cart_buffer_0_geom1100_sdsp.zero();

        spher_buffer_0_geom1100_sdsp.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1100_sdsp_0(prim_buffer_0_geom1100_sdsp, prim_buffer_0_ppsp, prim_buffer_0_pfsp, a_exp, b_exp );

            t2cfunc::reduce(cart_buffer_0_geom1100_sdsp, prim_buffer_0_geom1100_sdsp, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 2, 0, 1>(spher_buffer_0_geom1100_sdsp, cart_spher_buffer_0_geom1100_sdsp);

        distributor->distribute(spher_buffer_0_geom1100_sdsp, a_indices, b_indices, c_indices, d_indices, 0, 2, 0, 1, 1, 1, 0, 0, i, ket_indices);
    }
}
