...
/// Computes (SD|1/|r-r'||PD)  integrals for two GTOs pair blocks.
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1100_sdpd(972, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1100_sdpd(675, ket_dim);
    ...
    {
        cart_buffer_0_geom1100_sdpd.zero();

        spher_buffer_0_geom1100_sdpd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1100_sdpd_0(prim_buffer_0_geom1100_sdpd, prim_buffer_0_pppd, prim_buffer_0_pfpd, a_exp, b_exp );

            t2cfunc::reduce(cart_buffer_0_geom1100_sdpd, prim_buffer_0_geom1100_sdpd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 2, 1, 2>(spher_buffer_0_geom1100_sdpd, cart_spher_buffer_0_geom1100_sdpd);

        distributor->distribute(spher_buffer_0_geom1100_sdpd, a_indices, b_indices, c_indices, d_indices, 0, 2, 1, 2, 1, 1, 0, 0, i, ket_indices);
    }
}
