...
#include "GeomDeriv1100OfScalarForPDDD.hpp"
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1100_pddd(5832, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1100_pddd(3375, ket_dim);
    ...
    {
        cart_buffer_0_geom1100_pddd.zero();

        spher_buffer_0_geom1100_pddd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1100_pddd_0(prim_buffer_0_geom1100_pddd, prim_buffer_0_spdd, prim_buffer_0_sfdd, prim_buffer_0_dpdd, prim_buffer_0_dfdd, a_exp, b_exp );

            t2cfunc::reduce(cart_buffer_0_geom1100_pddd, prim_buffer_0_geom1100_pddd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 2, 2, 2>(spher_buffer_0_geom1100_pddd, cart_spher_buffer_0_geom1100_pddd);

        distributor->distribute(spher_buffer_0_geom1100_pddd, a_indices, b_indices, c_indices, d_indices, 1, 2, 2, 2, 1, 1, 0, 0, i, ket_indices);
    }
}
