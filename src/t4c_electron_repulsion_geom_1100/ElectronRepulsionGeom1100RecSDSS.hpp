...
/// Computes (SD|1/|r-r'||SS)  integrals for two GTOs pair blocks.
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> prim_buffer_0_pfss(30, ket_pdim);

    // allocate aligned Cartesian integrals

    CSimdArray<double> cart_buffer_0_geom1100_sdss(54, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1100_sdss(45, ket_dim);
    ...
    {
        cart_buffer_0_geom1100_sdss.zero();

        spher_buffer_0_geom1100_sdss.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            erirec::comp_prim_electron_repulsion_pfss(prim_buffer_0_pfss, prim_buffer_0_sdss, prim_buffer_1_sdss, prim_buffer_0_sfss, prim_buffer_1_sfss, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);

            t4c_geom::comp_geom1100_sdss_0(prim_buffer_0_geom1100_sdss, prim_buffer_0_ppss, prim_buffer_0_pfss, a_exp, b_exp );

            t2cfunc::reduce(cart_buffer_0_geom1100_sdss, prim_buffer_0_geom1100_sdss, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 2, 0, 0>(spher_buffer_0_geom1100_sdss, cart_spher_buffer_0_geom1100_sdss);

        distributor->distribute(spher_buffer_0_geom1100_sdss, a_indices, b_indices, c_indices, d_indices, 0, 2, 0, 0, 1, 1, 0, 0, i, ket_indices);
    }
}
