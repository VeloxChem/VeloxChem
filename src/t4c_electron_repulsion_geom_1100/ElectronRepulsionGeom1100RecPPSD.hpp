                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1100_ppsd(486, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1100_ppsd(405, ket_dim);
    ...
    {
        cart_buffer_0_geom1100_ppsd.zero();

        spher_buffer_0_geom1100_ppsd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1100_ppsd_0(prim_buffer_0_geom1100_ppsd, prim_buffer_0_sssd, prim_buffer_0_sdsd, prim_buffer_0_dssd, prim_buffer_0_ddsd, a_exp, b_exp );

            t2cfunc::reduce(cart_buffer_0_geom1100_ppsd, prim_buffer_0_geom1100_ppsd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 1, 0, 2>(spher_buffer_0_geom1100_ppsd, cart_spher_buffer_0_geom1100_ppsd);

        distributor->distribute(spher_buffer_0_geom1100_ppsd, a_indices, b_indices, c_indices, d_indices, 1, 1, 0, 2, 1, 1, 0, 0, i, ket_indices);
    }
}
