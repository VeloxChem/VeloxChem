#ifndef ElectronRepulsionGeom1100RecSPSD_hpp
#define ElectronRepulsionGeom1100RecSPSD_hpp
...
/// Computes (SP|1/|r-r'||SD)  integrals for two GTOs pair blocks.
...
template <class T>
auto
comp_electron_repulsion_geom1100_spsd(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1100_spsd(162, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1100_spsd(135, ket_dim);
    ...
    {
        cart_buffer_0_geom1100_spsd.zero();

        spher_buffer_0_geom1100_spsd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1100_spsd_0(prim_buffer_0_geom1100_spsd, prim_buffer_0_pssd, prim_buffer_0_pdsd, a_exp, b_exp );

            t2cfunc::reduce(cart_buffer_0_geom1100_spsd, prim_buffer_0_geom1100_spsd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 1, 0, 2>(spher_buffer_0_geom1100_spsd, cart_spher_buffer_0_geom1100_spsd);

        distributor->distribute(spher_buffer_0_geom1100_spsd, a_indices, b_indices, c_indices, d_indices, 0, 1, 0, 2, 1, 1, 0, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom1100RecSPSD_hpp */
