                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1100_sspp(81, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1100_sspp(81, ket_dim);
    ...
    {
        cart_buffer_0_geom1100_sspp.zero();

        spher_buffer_0_geom1100_sspp.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1100_sspp_0(prim_buffer_0_geom1100_sspp, prim_buffer_0_pppp, a_exp, b_exp );

            t2cfunc::reduce(cart_buffer_0_geom1100_sspp, prim_buffer_0_geom1100_sspp, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 0, 1, 1>(spher_buffer_0_geom1100_sspp, cart_spher_buffer_0_geom1100_sspp);

        distributor->distribute(spher_buffer_0_geom1100_sspp, a_indices, b_indices, c_indices, d_indices, 0, 0, 1, 1, 1, 1, 0, 0, i, ket_indices);
    }
}
