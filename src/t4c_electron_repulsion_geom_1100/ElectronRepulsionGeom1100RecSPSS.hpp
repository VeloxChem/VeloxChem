#ifndef ElectronRepulsionGeom1100RecSPSS_hpp
#define ElectronRepulsionGeom1100RecSPSS_hpp
...
template <class T>
auto
comp_electron_repulsion_geom1100_spss(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1100_spss(27, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1100_spss(27, ket_dim);
    ...
    {
        cart_buffer_0_geom1100_spss.zero();

        spher_buffer_0_geom1100_spss.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1100_spss_0(prim_buffer_0_geom1100_spss, prim_buffer_0_psss, prim_buffer_0_pdss, a_exp, b_exp );

            t2cfunc::reduce(cart_buffer_0_geom1100_spss, prim_buffer_0_geom1100_spss, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 1, 0, 0>(spher_buffer_0_geom1100_spss, cart_spher_buffer_0_geom1100_spss);

        distributor->distribute(spher_buffer_0_geom1100_spss, a_indices, b_indices, c_indices, d_indices, 0, 1, 0, 0, 1, 1, 0, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom1100RecSPSS_hpp */
