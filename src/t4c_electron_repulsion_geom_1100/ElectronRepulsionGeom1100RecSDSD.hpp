#ifndef ElectronRepulsionGeom1100RecSDSD_hpp
#define ElectronRepulsionGeom1100RecSDSD_hpp
...
template <class T>
auto
comp_electron_repulsion_geom1100_sdsd(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1100_sdsd(324, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1100_sdsd(225, ket_dim);
    ...
    {
        cart_buffer_0_geom1100_sdsd.zero();

        spher_buffer_0_geom1100_sdsd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1100_sdsd_0(prim_buffer_0_geom1100_sdsd, prim_buffer_0_ppsd, prim_buffer_0_pfsd, a_exp, b_exp );

            t2cfunc::reduce(cart_buffer_0_geom1100_sdsd, prim_buffer_0_geom1100_sdsd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 2, 0, 2>(spher_buffer_0_geom1100_sdsd, cart_spher_buffer_0_geom1100_sdsd);

        distributor->distribute(spher_buffer_0_geom1100_sdsd, a_indices, b_indices, c_indices, d_indices, 0, 2, 0, 2, 1, 1, 0, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom1100RecSDSD_hpp */
