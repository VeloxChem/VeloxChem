...
#include "ElectronRepulsionPrimRecFFSS.hpp"
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> prim_buffer_0_dfss(60, ket_pdim);

    CSimdArray<double> prim_buffer_1_dfss(60, ket_pdim);

    CSimdArray<double> prim_buffer_0_fpss(30, ket_pdim);

    CSimdArray<double> prim_buffer_0_ffss(100, ket_pdim);

    // allocate aligned Cartesian integrals

    CSimdArray<double> cart_buffer_0_geom1100_ddss(324, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1100_ddss(225, ket_dim);
    ...
    {
        cart_buffer_0_geom1100_ddss.zero();

        spher_buffer_0_geom1100_ddss.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            erirec::comp_prim_electron_repulsion_dfss(prim_buffer_0_dfss, prim_buffer_0_sfss, prim_buffer_1_sfss, prim_buffer_0_pdss, prim_buffer_1_pdss, prim_buffer_0_pfss, prim_buffer_1_pfss, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_ffss(prim_buffer_0_ffss, prim_buffer_0_pfss, prim_buffer_1_pfss, prim_buffer_0_ddss, prim_buffer_1_ddss, prim_buffer_0_dfss, prim_buffer_1_dfss, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);

            t4c_geom::comp_geom1100_ddss_0(prim_buffer_0_geom1100_ddss, prim_buffer_0_ppss, prim_buffer_0_pfss, prim_buffer_0_fpss, prim_buffer_0_ffss, a_exp, b_exp );

            t2cfunc::reduce(cart_buffer_0_geom1100_ddss, prim_buffer_0_geom1100_ddss, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<2, 2, 0, 0>(spher_buffer_0_geom1100_ddss, cart_spher_buffer_0_geom1100_ddss);

        distributor->distribute(spher_buffer_0_geom1100_ddss, a_indices, b_indices, c_indices, d_indices, 2, 2, 0, 0, 1, 1, 0, 0, i, ket_indices);
    }
}
