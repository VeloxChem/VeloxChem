                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1100_pppp(729, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1100_pppp(729, ket_dim);
    ...
    {
        cart_buffer_0_geom1100_pppp.zero();

        spher_buffer_0_geom1100_pppp.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1100_pppp_0(prim_buffer_0_geom1100_pppp, prim_buffer_0_sspp, prim_buffer_0_sdpp, prim_buffer_0_dspp, prim_buffer_0_ddpp, a_exp, b_exp );

            t2cfunc::reduce(cart_buffer_0_geom1100_pppp, prim_buffer_0_geom1100_pppp, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 1, 1, 1>(spher_buffer_0_geom1100_pppp, cart_spher_buffer_0_geom1100_pppp);

        distributor->distribute(spher_buffer_0_geom1100_pppp, a_indices, b_indices, c_indices, d_indices, 1, 1, 1, 1, 1, 1, 0, 0, i, ket_indices);
    }
}
