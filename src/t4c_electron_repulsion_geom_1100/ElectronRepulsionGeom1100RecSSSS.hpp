                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1100_ssss(9, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1100_ssss(9, ket_dim);
    ...
    {
        cart_buffer_0_geom1100_ssss.zero();

        spher_buffer_0_geom1100_ssss.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1100_ssss_0(prim_buffer_0_geom1100_ssss, prim_buffer_0_ppss, a_exp, b_exp );

            t2cfunc::reduce(cart_buffer_0_geom1100_ssss, prim_buffer_0_geom1100_ssss, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 0, 0, 0>(spher_buffer_0_geom1100_ssss, cart_spher_buffer_0_geom1100_ssss);

        distributor->distribute(spher_buffer_0_geom1100_ssss, a_indices, b_indices, c_indices, d_indices, 0, 0, 0, 0, 1, 1, 0, 0, i, ket_indices);
    }
}
