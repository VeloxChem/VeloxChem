                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1100_spsp(81, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1100_spsp(81, ket_dim);
    ...
    {
        cart_buffer_0_geom1100_spsp.zero();

        spher_buffer_0_geom1100_spsp.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1100_spsp_0(prim_buffer_0_geom1100_spsp, prim_buffer_0_pssp, prim_buffer_0_pdsp, a_exp, b_exp );

            t2cfunc::reduce(cart_buffer_0_geom1100_spsp, prim_buffer_0_geom1100_spsp, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 1, 0, 1>(spher_buffer_0_geom1100_spsp, cart_spher_buffer_0_geom1100_spsp);

        distributor->distribute(spher_buffer_0_geom1100_spsp, a_indices, b_indices, c_indices, d_indices, 0, 1, 0, 1, 1, 1, 0, 0, i, ket_indices);
    }
}
