...
/// Computes (PP|1/|r-r'||PD)  integrals for two GTOs pair blocks.
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1100_pppd(1458, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1100_pppd(1215, ket_dim);
    ...
    {
        cart_buffer_0_geom1100_pppd.zero();

        spher_buffer_0_geom1100_pppd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1100_pppd_0(prim_buffer_0_geom1100_pppd, prim_buffer_0_sspd, prim_buffer_0_sdpd, prim_buffer_0_dspd, prim_buffer_0_ddpd, a_exp, b_exp );

            t2cfunc::reduce(cart_buffer_0_geom1100_pppd, prim_buffer_0_geom1100_pppd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 1, 1, 2>(spher_buffer_0_geom1100_pppd, cart_spher_buffer_0_geom1100_pppd);

        distributor->distribute(spher_buffer_0_geom1100_pppd, a_indices, b_indices, c_indices, d_indices, 1, 1, 1, 2, 1, 1, 0, 0, i, ket_indices);
    }
}
