                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> prim_buffer_1_dfss(60, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_0_ffsp(300, ket_pdim);

    // allocate aligned Cartesian integrals

    CSimdArray<double> cart_buffer_0_geom1100_ddsp(972, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1100_ddsp(675, ket_dim);
    ...
    {
        cart_buffer_0_geom1100_ddsp.zero();

        spher_buffer_0_geom1100_ddsp.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            erirec::comp_prim_electron_repulsion_dfss(prim_buffer_1_dfss, prim_buffer_1_sfss, prim_buffer_2_sfss, prim_buffer_1_pdss, prim_buffer_2_pdss, prim_buffer_1_pfss, prim_buffer_2_pfss, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_ffsp(prim_buffer_0_ffsp, prim_buffer_0_pfsp, prim_buffer_1_pfsp, prim_buffer_0_ddsp, prim_buffer_1_ddsp, prim_buffer_1_dfss, prim_buffer_0_dfsp, prim_buffer_1_dfsp, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);

            t4c_geom::comp_geom1100_ddsp_0(prim_buffer_0_geom1100_ddsp, prim_buffer_0_ppsp, prim_buffer_0_pfsp, prim_buffer_0_fpsp, prim_buffer_0_ffsp, a_exp, b_exp );

            t2cfunc::reduce(cart_buffer_0_geom1100_ddsp, prim_buffer_0_geom1100_ddsp, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<2, 2, 0, 1>(spher_buffer_0_geom1100_ddsp, cart_spher_buffer_0_geom1100_ddsp);

        distributor->distribute(spher_buffer_0_geom1100_ddsp, a_indices, b_indices, c_indices, d_indices, 2, 2, 0, 1, 1, 1, 0, 0, i, ket_indices);
    }
}
