#ifndef PrimitiveOverlapGF_XYYY_T
#define PrimitiveOverlapGF_XYYY_T
...
*/
auto compPrimitiveOverlapGF_XYYY_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGF_XYYY_T */
