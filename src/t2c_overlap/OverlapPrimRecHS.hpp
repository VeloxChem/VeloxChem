#ifndef OverlapPrimRecHS
#define OverlapPrimRecHS

#include "SimdArray.hpp"

namespace ovlrec {  // ovlrec namespace

/// @brief Computes primitive [H|S]  integrals for set of data buffers.
...
auto comp_prim_overlap_hs(CSimdArray<double>&       pbuffer,
