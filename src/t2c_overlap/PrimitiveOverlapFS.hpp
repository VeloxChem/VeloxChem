#ifndef PrimitiveOverlapFS
#define PrimitiveOverlapFS
...
/**
 Evaluates block of primitive <F|1|S> integrals.
...
*/
auto compPrimitiveOverlapFS(TDoubleArray&       buffer_xxx,
