                           ...
                           const int64_t       ket_dim) -> void
{
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_x[i] += fss * ((1.0 / 2.0) * fe_0 + rpa_x * rpb_x);

        fints_y[i] += fss * rpa_x * rpb_y;

        fints_z[i] += fss * rpa_x * rpb_z;
    }
}
                           ...
                           const int64_t       ket_dim) -> void
{
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_x[i] += fss * rpa_y * rpb_x;

        fints_y[i] += fss * ((1.0 / 2.0) * fe_0 + rpa_y * rpb_y);

        fints_z[i] += fss * rpa_y * rpb_z;
    }
}
