...
#pragma omp simd aligned(pa_x,             \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        ts_xxxx_xxxx[i] = 3.0 * ts_xx_xxxx[i] * fe_0 + 4.0 * ts_xxx_xxx[i] * fe_0 + ts_xxx_xxxx[i] * pa_x[i];

        ts_xxxx_xxxy[i] = 3.0 * ts_xx_xxxy[i] * fe_0 + 3.0 * ts_xxx_xxy[i] * fe_0 + ts_xxx_xxxy[i] * pa_x[i];

        ts_xxxx_xxxz[i] = 3.0 * ts_xx_xxxz[i] * fe_0 + 3.0 * ts_xxx_xxz[i] * fe_0 + ts_xxx_xxxz[i] * pa_x[i];

        ts_xxxx_xxyy[i] = 3.0 * ts_xx_xxyy[i] * fe_0 + 2.0 * ts_xxx_xyy[i] * fe_0 + ts_xxx_xxyy[i] * pa_x[i];

        ts_xxxx_xxyz[i] = 3.0 * ts_xx_xxyz[i] * fe_0 + 2.0 * ts_xxx_xyz[i] * fe_0 + ts_xxx_xxyz[i] * pa_x[i];

        ts_xxxx_xxzz[i] = 3.0 * ts_xx_xxzz[i] * fe_0 + 2.0 * ts_xxx_xzz[i] * fe_0 + ts_xxx_xxzz[i] * pa_x[i];

        ts_xxxx_xyyy[i] = 3.0 * ts_xx_xyyy[i] * fe_0 + ts_xxx_yyy[i] * fe_0 + ts_xxx_xyyy[i] * pa_x[i];

        ts_xxxx_xyyz[i] = 3.0 * ts_xx_xyyz[i] * fe_0 + ts_xxx_yyz[i] * fe_0 + ts_xxx_xyyz[i] * pa_x[i];

        ts_xxxx_xyzz[i] = 3.0 * ts_xx_xyzz[i] * fe_0 + ts_xxx_yzz[i] * fe_0 + ts_xxx_xyzz[i] * pa_x[i];

        ts_xxxx_xzzz[i] = 3.0 * ts_xx_xzzz[i] * fe_0 + ts_xxx_zzz[i] * fe_0 + ts_xxx_xzzz[i] * pa_x[i];

        ts_xxxx_yyyy[i] = 3.0 * ts_xx_yyyy[i] * fe_0 + ts_xxx_yyyy[i] * pa_x[i];

        ts_xxxx_yyyz[i] = 3.0 * ts_xx_yyyz[i] * fe_0 + ts_xxx_yyyz[i] * pa_x[i];

        ts_xxxx_yyzz[i] = 3.0 * ts_xx_yyzz[i] * fe_0 + ts_xxx_yyzz[i] * pa_x[i];

        ts_xxxx_yzzz[i] = 3.0 * ts_xx_yzzz[i] * fe_0 + ts_xxx_yzzz[i] * pa_x[i];

        ts_xxxx_zzzz[i] = 3.0 * ts_xx_zzzz[i] * fe_0 + ts_xxx_zzzz[i] * pa_x[i];
    }
...
#pragma omp simd aligned(pa_x,             \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        ts_xxxy_xxxx[i] = ts_xxx_xxxx[i] * pa_y[i];

        ts_xxxy_xxxy[i] = ts_xxx_xxx[i] * fe_0 + ts_xxx_xxxy[i] * pa_y[i];

        ts_xxxy_xxxz[i] = ts_xxx_xxxz[i] * pa_y[i];

        ts_xxxy_xxyy[i] = 2.0 * ts_xxx_xxy[i] * fe_0 + ts_xxx_xxyy[i] * pa_y[i];

        ts_xxxy_xxyz[i] = ts_xxx_xxz[i] * fe_0 + ts_xxx_xxyz[i] * pa_y[i];

        ts_xxxy_xxzz[i] = ts_xxx_xxzz[i] * pa_y[i];

        ts_xxxy_xyyy[i] = 3.0 * ts_xxx_xyy[i] * fe_0 + ts_xxx_xyyy[i] * pa_y[i];

        ts_xxxy_xyyz[i] = 2.0 * ts_xxx_xyz[i] * fe_0 + ts_xxx_xyyz[i] * pa_y[i];

        ts_xxxy_xyzz[i] = ts_xxx_xzz[i] * fe_0 + ts_xxx_xyzz[i] * pa_y[i];

        ts_xxxy_xzzz[i] = ts_xxx_xzzz[i] * pa_y[i];

        ts_xxxy_yyyy[i] = 2.0 * ts_xy_yyyy[i] * fe_0 + ts_xxy_yyyy[i] * pa_x[i];

        ts_xxxy_yyyz[i] = 2.0 * ts_xy_yyyz[i] * fe_0 + ts_xxy_yyyz[i] * pa_x[i];

        ts_xxxy_yyzz[i] = 2.0 * ts_xy_yyzz[i] * fe_0 + ts_xxy_yyzz[i] * pa_x[i];

        ts_xxxy_yzzz[i] = 2.0 * ts_xy_yzzz[i] * fe_0 + ts_xxy_yzzz[i] * pa_x[i];

        ts_xxxy_zzzz[i] = ts_xxx_zzzz[i] * pa_y[i];
    }
...
#pragma omp simd aligned(pa_x,             \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        ts_xxxz_xxxx[i] = ts_xxx_xxxx[i] * pa_z[i];

        ts_xxxz_xxxy[i] = ts_xxx_xxxy[i] * pa_z[i];

        ts_xxxz_xxxz[i] = ts_xxx_xxx[i] * fe_0 + ts_xxx_xxxz[i] * pa_z[i];

        ts_xxxz_xxyy[i] = ts_xxx_xxyy[i] * pa_z[i];

        ts_xxxz_xxyz[i] = ts_xxx_xxy[i] * fe_0 + ts_xxx_xxyz[i] * pa_z[i];

        ts_xxxz_xxzz[i] = 2.0 * ts_xxx_xxz[i] * fe_0 + ts_xxx_xxzz[i] * pa_z[i];

        ts_xxxz_xyyy[i] = ts_xxx_xyyy[i] * pa_z[i];

        ts_xxxz_xyyz[i] = ts_xxx_xyy[i] * fe_0 + ts_xxx_xyyz[i] * pa_z[i];

        ts_xxxz_xyzz[i] = 2.0 * ts_xxx_xyz[i] * fe_0 + ts_xxx_xyzz[i] * pa_z[i];

        ts_xxxz_xzzz[i] = 3.0 * ts_xxx_xzz[i] * fe_0 + ts_xxx_xzzz[i] * pa_z[i];

        ts_xxxz_yyyy[i] = ts_xxx_yyyy[i] * pa_z[i];

        ts_xxxz_yyyz[i] = 2.0 * ts_xz_yyyz[i] * fe_0 + ts_xxz_yyyz[i] * pa_x[i];

        ts_xxxz_yyzz[i] = 2.0 * ts_xz_yyzz[i] * fe_0 + ts_xxz_yyzz[i] * pa_x[i];

        ts_xxxz_yzzz[i] = 2.0 * ts_xz_yzzz[i] * fe_0 + ts_xxz_yzzz[i] * pa_x[i];

        ts_xxxz_zzzz[i] = 2.0 * ts_xz_zzzz[i] * fe_0 + ts_xxz_zzzz[i] * pa_x[i];
    }
...
#pragma omp simd aligned(pa_x,             \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        ts_xxyy_xxxx[i] = ts_xx_xxxx[i] * fe_0 + ts_xxy_xxxx[i] * pa_y[i];

        ts_xxyy_xxxy[i] = ts_yy_xxxy[i] * fe_0 + 3.0 * ts_xyy_xxy[i] * fe_0 + ts_xyy_xxxy[i] * pa_x[i];

        ts_xxyy_xxxz[i] = ts_xx_xxxz[i] * fe_0 + ts_xxy_xxxz[i] * pa_y[i];

        ts_xxyy_xxyy[i] = ts_yy_xxyy[i] * fe_0 + 2.0 * ts_xyy_xyy[i] * fe_0 + ts_xyy_xxyy[i] * pa_x[i];

        ts_xxyy_xxyz[i] = ts_yy_xxyz[i] * fe_0 + 2.0 * ts_xyy_xyz[i] * fe_0 + ts_xyy_xxyz[i] * pa_x[i];

        ts_xxyy_xxzz[i] = ts_xx_xxzz[i] * fe_0 + ts_xxy_xxzz[i] * pa_y[i];

        ts_xxyy_xyyy[i] = ts_yy_xyyy[i] * fe_0 + ts_xyy_yyy[i] * fe_0 + ts_xyy_xyyy[i] * pa_x[i];

        ts_xxyy_xyyz[i] = ts_yy_xyyz[i] * fe_0 + ts_xyy_yyz[i] * fe_0 + ts_xyy_xyyz[i] * pa_x[i];

        ts_xxyy_xyzz[i] = ts_yy_xyzz[i] * fe_0 + ts_xyy_yzz[i] * fe_0 + ts_xyy_xyzz[i] * pa_x[i];

        ts_xxyy_xzzz[i] = ts_xx_xzzz[i] * fe_0 + ts_xxy_xzzz[i] * pa_y[i];

        ts_xxyy_yyyy[i] = ts_yy_yyyy[i] * fe_0 + ts_xyy_yyyy[i] * pa_x[i];

        ts_xxyy_yyyz[i] = ts_yy_yyyz[i] * fe_0 + ts_xyy_yyyz[i] * pa_x[i];

        ts_xxyy_yyzz[i] = ts_yy_yyzz[i] * fe_0 + ts_xyy_yyzz[i] * pa_x[i];

        ts_xxyy_yzzz[i] = ts_yy_yzzz[i] * fe_0 + ts_xyy_yzzz[i] * pa_x[i];

        ts_xxyy_zzzz[i] = ts_yy_zzzz[i] * fe_0 + ts_xyy_zzzz[i] * pa_x[i];
    }
...
#pragma omp simd aligned(pa_x,             \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        ts_xxyz_xxxx[i] = ts_xxz_xxxx[i] * pa_y[i];

        ts_xxyz_xxxy[i] = ts_xxy_xxxy[i] * pa_z[i];

        ts_xxyz_xxxz[i] = ts_xxz_xxxz[i] * pa_y[i];

        ts_xxyz_xxyy[i] = ts_xxy_xxyy[i] * pa_z[i];

        ts_xxyz_xxyz[i] = ts_xxz_xxz[i] * fe_0 + ts_xxz_xxyz[i] * pa_y[i];

        ts_xxyz_xxzz[i] = ts_xxz_xxzz[i] * pa_y[i];

        ts_xxyz_xyyy[i] = ts_xxy_xyyy[i] * pa_z[i];

        ts_xxyz_xyyz[i] = 2.0 * ts_xxz_xyz[i] * fe_0 + ts_xxz_xyyz[i] * pa_y[i];

        ts_xxyz_xyzz[i] = ts_xxz_xzz[i] * fe_0 + ts_xxz_xyzz[i] * pa_y[i];

        ts_xxyz_xzzz[i] = ts_xxz_xzzz[i] * pa_y[i];

        ts_xxyz_yyyy[i] = ts_xxy_yyyy[i] * pa_z[i];

        ts_xxyz_yyyz[i] = ts_yz_yyyz[i] * fe_0 + ts_xyz_yyyz[i] * pa_x[i];

        ts_xxyz_yyzz[i] = ts_yz_yyzz[i] * fe_0 + ts_xyz_yyzz[i] * pa_x[i];

        ts_xxyz_yzzz[i] = ts_yz_yzzz[i] * fe_0 + ts_xyz_yzzz[i] * pa_x[i];

        ts_xxyz_zzzz[i] = ts_xxz_zzzz[i] * pa_y[i];
    }
...
#pragma omp simd aligned(pa_x,             \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        ts_xxzz_xxxx[i] = ts_xx_xxxx[i] * fe_0 + ts_xxz_xxxx[i] * pa_z[i];

        ts_xxzz_xxxy[i] = ts_xx_xxxy[i] * fe_0 + ts_xxz_xxxy[i] * pa_z[i];

        ts_xxzz_xxxz[i] = ts_zz_xxxz[i] * fe_0 + 3.0 * ts_xzz_xxz[i] * fe_0 + ts_xzz_xxxz[i] * pa_x[i];

        ts_xxzz_xxyy[i] = ts_xx_xxyy[i] * fe_0 + ts_xxz_xxyy[i] * pa_z[i];

        ts_xxzz_xxyz[i] = ts_zz_xxyz[i] * fe_0 + 2.0 * ts_xzz_xyz[i] * fe_0 + ts_xzz_xxyz[i] * pa_x[i];

        ts_xxzz_xxzz[i] = ts_zz_xxzz[i] * fe_0 + 2.0 * ts_xzz_xzz[i] * fe_0 + ts_xzz_xxzz[i] * pa_x[i];

        ts_xxzz_xyyy[i] = ts_xx_xyyy[i] * fe_0 + ts_xxz_xyyy[i] * pa_z[i];

        ts_xxzz_xyyz[i] = ts_zz_xyyz[i] * fe_0 + ts_xzz_yyz[i] * fe_0 + ts_xzz_xyyz[i] * pa_x[i];

        ts_xxzz_xyzz[i] = ts_zz_xyzz[i] * fe_0 + ts_xzz_yzz[i] * fe_0 + ts_xzz_xyzz[i] * pa_x[i];

        ts_xxzz_xzzz[i] = ts_zz_xzzz[i] * fe_0 + ts_xzz_zzz[i] * fe_0 + ts_xzz_xzzz[i] * pa_x[i];

        ts_xxzz_yyyy[i] = ts_zz_yyyy[i] * fe_0 + ts_xzz_yyyy[i] * pa_x[i];

        ts_xxzz_yyyz[i] = ts_zz_yyyz[i] * fe_0 + ts_xzz_yyyz[i] * pa_x[i];

        ts_xxzz_yyzz[i] = ts_zz_yyzz[i] * fe_0 + ts_xzz_yyzz[i] * pa_x[i];

        ts_xxzz_yzzz[i] = ts_zz_yzzz[i] * fe_0 + ts_xzz_yzzz[i] * pa_x[i];

        ts_xxzz_zzzz[i] = ts_zz_zzzz[i] * fe_0 + ts_xzz_zzzz[i] * pa_x[i];
    }
...
#pragma omp simd aligned(pa_x,             \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        ts_xyyy_xxxx[i] = 4.0 * ts_yyy_xxx[i] * fe_0 + ts_yyy_xxxx[i] * pa_x[i];

        ts_xyyy_xxxy[i] = 3.0 * ts_yyy_xxy[i] * fe_0 + ts_yyy_xxxy[i] * pa_x[i];

        ts_xyyy_xxxz[i] = 3.0 * ts_yyy_xxz[i] * fe_0 + ts_yyy_xxxz[i] * pa_x[i];

        ts_xyyy_xxyy[i] = 2.0 * ts_yyy_xyy[i] * fe_0 + ts_yyy_xxyy[i] * pa_x[i];

        ts_xyyy_xxyz[i] = 2.0 * ts_yyy_xyz[i] * fe_0 + ts_yyy_xxyz[i] * pa_x[i];

        ts_xyyy_xxzz[i] = 2.0 * ts_yyy_xzz[i] * fe_0 + ts_yyy_xxzz[i] * pa_x[i];

        ts_xyyy_xyyy[i] = ts_yyy_yyy[i] * fe_0 + ts_yyy_xyyy[i] * pa_x[i];

        ts_xyyy_xyyz[i] = ts_yyy_yyz[i] * fe_0 + ts_yyy_xyyz[i] * pa_x[i];

        ts_xyyy_xyzz[i] = ts_yyy_yzz[i] * fe_0 + ts_yyy_xyzz[i] * pa_x[i];

        ts_xyyy_xzzz[i] = ts_yyy_zzz[i] * fe_0 + ts_yyy_xzzz[i] * pa_x[i];

        ts_xyyy_yyyy[i] = ts_yyy_yyyy[i] * pa_x[i];

        ts_xyyy_yyyz[i] = ts_yyy_yyyz[i] * pa_x[i];

        ts_xyyy_yyzz[i] = ts_yyy_yyzz[i] * pa_x[i];

        ts_xyyy_yzzz[i] = ts_yyy_yzzz[i] * pa_x[i];

        ts_xyyy_zzzz[i] = ts_yyy_zzzz[i] * pa_x[i];
    }
...
#pragma omp simd aligned(pa_x,             \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        ts_xyyz_xxxx[i] = ts_xyy_xxxx[i] * pa_z[i];

        ts_xyyz_xxxy[i] = ts_xyy_xxxy[i] * pa_z[i];

        ts_xyyz_xxxz[i] = 3.0 * ts_yyz_xxz[i] * fe_0 + ts_yyz_xxxz[i] * pa_x[i];

        ts_xyyz_xxyy[i] = ts_xyy_xxyy[i] * pa_z[i];

        ts_xyyz_xxyz[i] = 2.0 * ts_yyz_xyz[i] * fe_0 + ts_yyz_xxyz[i] * pa_x[i];

        ts_xyyz_xxzz[i] = 2.0 * ts_yyz_xzz[i] * fe_0 + ts_yyz_xxzz[i] * pa_x[i];

        ts_xyyz_xyyy[i] = ts_xyy_xyyy[i] * pa_z[i];

        ts_xyyz_xyyz[i] = ts_yyz_yyz[i] * fe_0 + ts_yyz_xyyz[i] * pa_x[i];

        ts_xyyz_xyzz[i] = ts_yyz_yzz[i] * fe_0 + ts_yyz_xyzz[i] * pa_x[i];

        ts_xyyz_xzzz[i] = ts_yyz_zzz[i] * fe_0 + ts_yyz_xzzz[i] * pa_x[i];

        ts_xyyz_yyyy[i] = ts_yyz_yyyy[i] * pa_x[i];

        ts_xyyz_yyyz[i] = ts_yyz_yyyz[i] * pa_x[i];

        ts_xyyz_yyzz[i] = ts_yyz_yyzz[i] * pa_x[i];

        ts_xyyz_yzzz[i] = ts_yyz_yzzz[i] * pa_x[i];

        ts_xyyz_zzzz[i] = ts_yyz_zzzz[i] * pa_x[i];
    }
...
#pragma omp simd aligned(pa_x,             \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        ts_xyzz_xxxx[i] = ts_xzz_xxxx[i] * pa_y[i];

        ts_xyzz_xxxy[i] = 3.0 * ts_yzz_xxy[i] * fe_0 + ts_yzz_xxxy[i] * pa_x[i];

        ts_xyzz_xxxz[i] = ts_xzz_xxxz[i] * pa_y[i];

        ts_xyzz_xxyy[i] = 2.0 * ts_yzz_xyy[i] * fe_0 + ts_yzz_xxyy[i] * pa_x[i];

        ts_xyzz_xxyz[i] = 2.0 * ts_yzz_xyz[i] * fe_0 + ts_yzz_xxyz[i] * pa_x[i];

        ts_xyzz_xxzz[i] = ts_xzz_xxzz[i] * pa_y[i];

        ts_xyzz_xyyy[i] = ts_yzz_yyy[i] * fe_0 + ts_yzz_xyyy[i] * pa_x[i];

        ts_xyzz_xyyz[i] = ts_yzz_yyz[i] * fe_0 + ts_yzz_xyyz[i] * pa_x[i];

        ts_xyzz_xyzz[i] = ts_yzz_yzz[i] * fe_0 + ts_yzz_xyzz[i] * pa_x[i];

        ts_xyzz_xzzz[i] = ts_xzz_xzzz[i] * pa_y[i];

        ts_xyzz_yyyy[i] = ts_yzz_yyyy[i] * pa_x[i];

        ts_xyzz_yyyz[i] = ts_yzz_yyyz[i] * pa_x[i];

        ts_xyzz_yyzz[i] = ts_yzz_yyzz[i] * pa_x[i];

        ts_xyzz_yzzz[i] = ts_yzz_yzzz[i] * pa_x[i];

        ts_xyzz_zzzz[i] = ts_yzz_zzzz[i] * pa_x[i];
    }
...
#pragma omp simd aligned(pa_x,             \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        ts_xzzz_xxxx[i] = 4.0 * ts_zzz_xxx[i] * fe_0 + ts_zzz_xxxx[i] * pa_x[i];

        ts_xzzz_xxxy[i] = 3.0 * ts_zzz_xxy[i] * fe_0 + ts_zzz_xxxy[i] * pa_x[i];

        ts_xzzz_xxxz[i] = 3.0 * ts_zzz_xxz[i] * fe_0 + ts_zzz_xxxz[i] * pa_x[i];

        ts_xzzz_xxyy[i] = 2.0 * ts_zzz_xyy[i] * fe_0 + ts_zzz_xxyy[i] * pa_x[i];

        ts_xzzz_xxyz[i] = 2.0 * ts_zzz_xyz[i] * fe_0 + ts_zzz_xxyz[i] * pa_x[i];

        ts_xzzz_xxzz[i] = 2.0 * ts_zzz_xzz[i] * fe_0 + ts_zzz_xxzz[i] * pa_x[i];

        ts_xzzz_xyyy[i] = ts_zzz_yyy[i] * fe_0 + ts_zzz_xyyy[i] * pa_x[i];

        ts_xzzz_xyyz[i] = ts_zzz_yyz[i] * fe_0 + ts_zzz_xyyz[i] * pa_x[i];

        ts_xzzz_xyzz[i] = ts_zzz_yzz[i] * fe_0 + ts_zzz_xyzz[i] * pa_x[i];

        ts_xzzz_xzzz[i] = ts_zzz_zzz[i] * fe_0 + ts_zzz_xzzz[i] * pa_x[i];

        ts_xzzz_yyyy[i] = ts_zzz_yyyy[i] * pa_x[i];

        ts_xzzz_yyyz[i] = ts_zzz_yyyz[i] * pa_x[i];

        ts_xzzz_yyzz[i] = ts_zzz_yyzz[i] * pa_x[i];

        ts_xzzz_yzzz[i] = ts_zzz_yzzz[i] * pa_x[i];

        ts_xzzz_zzzz[i] = ts_zzz_zzzz[i] * pa_x[i];
    }
...
#pragma omp simd aligned(pa_y,             \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        ts_yyyy_xxxx[i] = 3.0 * ts_yy_xxxx[i] * fe_0 + ts_yyy_xxxx[i] * pa_y[i];

        ts_yyyy_xxxy[i] = 3.0 * ts_yy_xxxy[i] * fe_0 + ts_yyy_xxx[i] * fe_0 + ts_yyy_xxxy[i] * pa_y[i];

        ts_yyyy_xxxz[i] = 3.0 * ts_yy_xxxz[i] * fe_0 + ts_yyy_xxxz[i] * pa_y[i];

        ts_yyyy_xxyy[i] = 3.0 * ts_yy_xxyy[i] * fe_0 + 2.0 * ts_yyy_xxy[i] * fe_0 + ts_yyy_xxyy[i] * pa_y[i];

        ts_yyyy_xxyz[i] = 3.0 * ts_yy_xxyz[i] * fe_0 + ts_yyy_xxz[i] * fe_0 + ts_yyy_xxyz[i] * pa_y[i];

        ts_yyyy_xxzz[i] = 3.0 * ts_yy_xxzz[i] * fe_0 + ts_yyy_xxzz[i] * pa_y[i];

        ts_yyyy_xyyy[i] = 3.0 * ts_yy_xyyy[i] * fe_0 + 3.0 * ts_yyy_xyy[i] * fe_0 + ts_yyy_xyyy[i] * pa_y[i];

        ts_yyyy_xyyz[i] = 3.0 * ts_yy_xyyz[i] * fe_0 + 2.0 * ts_yyy_xyz[i] * fe_0 + ts_yyy_xyyz[i] * pa_y[i];

        ts_yyyy_xyzz[i] = 3.0 * ts_yy_xyzz[i] * fe_0 + ts_yyy_xzz[i] * fe_0 + ts_yyy_xyzz[i] * pa_y[i];

        ts_yyyy_xzzz[i] = 3.0 * ts_yy_xzzz[i] * fe_0 + ts_yyy_xzzz[i] * pa_y[i];

        ts_yyyy_yyyy[i] = 3.0 * ts_yy_yyyy[i] * fe_0 + 4.0 * ts_yyy_yyy[i] * fe_0 + ts_yyy_yyyy[i] * pa_y[i];

        ts_yyyy_yyyz[i] = 3.0 * ts_yy_yyyz[i] * fe_0 + 3.0 * ts_yyy_yyz[i] * fe_0 + ts_yyy_yyyz[i] * pa_y[i];

        ts_yyyy_yyzz[i] = 3.0 * ts_yy_yyzz[i] * fe_0 + 2.0 * ts_yyy_yzz[i] * fe_0 + ts_yyy_yyzz[i] * pa_y[i];

        ts_yyyy_yzzz[i] = 3.0 * ts_yy_yzzz[i] * fe_0 + ts_yyy_zzz[i] * fe_0 + ts_yyy_yzzz[i] * pa_y[i];

        ts_yyyy_zzzz[i] = 3.0 * ts_yy_zzzz[i] * fe_0 + ts_yyy_zzzz[i] * pa_y[i];
    }
...
#pragma omp simd aligned(pa_y,             \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        ts_yyyz_xxxx[i] = ts_yyy_xxxx[i] * pa_z[i];

        ts_yyyz_xxxy[i] = ts_yyy_xxxy[i] * pa_z[i];

        ts_yyyz_xxxz[i] = 2.0 * ts_yz_xxxz[i] * fe_0 + ts_yyz_xxxz[i] * pa_y[i];

        ts_yyyz_xxyy[i] = ts_yyy_xxyy[i] * pa_z[i];

        ts_yyyz_xxyz[i] = ts_yyy_xxy[i] * fe_0 + ts_yyy_xxyz[i] * pa_z[i];

        ts_yyyz_xxzz[i] = 2.0 * ts_yz_xxzz[i] * fe_0 + ts_yyz_xxzz[i] * pa_y[i];

        ts_yyyz_xyyy[i] = ts_yyy_xyyy[i] * pa_z[i];

        ts_yyyz_xyyz[i] = ts_yyy_xyy[i] * fe_0 + ts_yyy_xyyz[i] * pa_z[i];

        ts_yyyz_xyzz[i] = 2.0 * ts_yyy_xyz[i] * fe_0 + ts_yyy_xyzz[i] * pa_z[i];

        ts_yyyz_xzzz[i] = 2.0 * ts_yz_xzzz[i] * fe_0 + ts_yyz_xzzz[i] * pa_y[i];

        ts_yyyz_yyyy[i] = ts_yyy_yyyy[i] * pa_z[i];

        ts_yyyz_yyyz[i] = ts_yyy_yyy[i] * fe_0 + ts_yyy_yyyz[i] * pa_z[i];

        ts_yyyz_yyzz[i] = 2.0 * ts_yyy_yyz[i] * fe_0 + ts_yyy_yyzz[i] * pa_z[i];

        ts_yyyz_yzzz[i] = 3.0 * ts_yyy_yzz[i] * fe_0 + ts_yyy_yzzz[i] * pa_z[i];

        ts_yyyz_zzzz[i] = 2.0 * ts_yz_zzzz[i] * fe_0 + ts_yyz_zzzz[i] * pa_y[i];
    }
...
#pragma omp simd aligned(pa_y,             \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        ts_yyzz_xxxx[i] = ts_zz_xxxx[i] * fe_0 + ts_yzz_xxxx[i] * pa_y[i];

        ts_yyzz_xxxy[i] = ts_yy_xxxy[i] * fe_0 + ts_yyz_xxxy[i] * pa_z[i];

        ts_yyzz_xxxz[i] = ts_zz_xxxz[i] * fe_0 + ts_yzz_xxxz[i] * pa_y[i];

        ts_yyzz_xxyy[i] = ts_yy_xxyy[i] * fe_0 + ts_yyz_xxyy[i] * pa_z[i];

        ts_yyzz_xxyz[i] = ts_zz_xxyz[i] * fe_0 + ts_yzz_xxz[i] * fe_0 + ts_yzz_xxyz[i] * pa_y[i];

        ts_yyzz_xxzz[i] = ts_zz_xxzz[i] * fe_0 + ts_yzz_xxzz[i] * pa_y[i];

        ts_yyzz_xyyy[i] = ts_yy_xyyy[i] * fe_0 + ts_yyz_xyyy[i] * pa_z[i];

        ts_yyzz_xyyz[i] = ts_zz_xyyz[i] * fe_0 + 2.0 * ts_yzz_xyz[i] * fe_0 + ts_yzz_xyyz[i] * pa_y[i];

        ts_yyzz_xyzz[i] = ts_zz_xyzz[i] * fe_0 + ts_yzz_xzz[i] * fe_0 + ts_yzz_xyzz[i] * pa_y[i];

        ts_yyzz_xzzz[i] = ts_zz_xzzz[i] * fe_0 + ts_yzz_xzzz[i] * pa_y[i];

        ts_yyzz_yyyy[i] = ts_yy_yyyy[i] * fe_0 + ts_yyz_yyyy[i] * pa_z[i];

        ts_yyzz_yyyz[i] = ts_zz_yyyz[i] * fe_0 + 3.0 * ts_yzz_yyz[i] * fe_0 + ts_yzz_yyyz[i] * pa_y[i];

        ts_yyzz_yyzz[i] = ts_zz_yyzz[i] * fe_0 + 2.0 * ts_yzz_yzz[i] * fe_0 + ts_yzz_yyzz[i] * pa_y[i];

        ts_yyzz_yzzz[i] = ts_zz_yzzz[i] * fe_0 + ts_yzz_zzz[i] * fe_0 + ts_yzz_yzzz[i] * pa_y[i];

        ts_yyzz_zzzz[i] = ts_zz_zzzz[i] * fe_0 + ts_yzz_zzzz[i] * pa_y[i];
    }
...
#pragma omp simd aligned(pa_y,             \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        ts_yzzz_xxxx[i] = ts_zzz_xxxx[i] * pa_y[i];

        ts_yzzz_xxxy[i] = ts_zzz_xxx[i] * fe_0 + ts_zzz_xxxy[i] * pa_y[i];

        ts_yzzz_xxxz[i] = ts_zzz_xxxz[i] * pa_y[i];

        ts_yzzz_xxyy[i] = 2.0 * ts_zzz_xxy[i] * fe_0 + ts_zzz_xxyy[i] * pa_y[i];

        ts_yzzz_xxyz[i] = ts_zzz_xxz[i] * fe_0 + ts_zzz_xxyz[i] * pa_y[i];

        ts_yzzz_xxzz[i] = ts_zzz_xxzz[i] * pa_y[i];

        ts_yzzz_xyyy[i] = 3.0 * ts_zzz_xyy[i] * fe_0 + ts_zzz_xyyy[i] * pa_y[i];

        ts_yzzz_xyyz[i] = 2.0 * ts_zzz_xyz[i] * fe_0 + ts_zzz_xyyz[i] * pa_y[i];

        ts_yzzz_xyzz[i] = ts_zzz_xzz[i] * fe_0 + ts_zzz_xyzz[i] * pa_y[i];

        ts_yzzz_xzzz[i] = ts_zzz_xzzz[i] * pa_y[i];

        ts_yzzz_yyyy[i] = 4.0 * ts_zzz_yyy[i] * fe_0 + ts_zzz_yyyy[i] * pa_y[i];

        ts_yzzz_yyyz[i] = 3.0 * ts_zzz_yyz[i] * fe_0 + ts_zzz_yyyz[i] * pa_y[i];

        ts_yzzz_yyzz[i] = 2.0 * ts_zzz_yzz[i] * fe_0 + ts_zzz_yyzz[i] * pa_y[i];

        ts_yzzz_yzzz[i] = ts_zzz_zzz[i] * fe_0 + ts_zzz_yzzz[i] * pa_y[i];

        ts_yzzz_zzzz[i] = ts_zzz_zzzz[i] * pa_y[i];
    }
...
#pragma omp simd aligned(pa_z,             \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        ts_zzzz_xxxx[i] = 3.0 * ts_zz_xxxx[i] * fe_0 + ts_zzz_xxxx[i] * pa_z[i];

        ts_zzzz_xxxy[i] = 3.0 * ts_zz_xxxy[i] * fe_0 + ts_zzz_xxxy[i] * pa_z[i];

        ts_zzzz_xxxz[i] = 3.0 * ts_zz_xxxz[i] * fe_0 + ts_zzz_xxx[i] * fe_0 + ts_zzz_xxxz[i] * pa_z[i];

        ts_zzzz_xxyy[i] = 3.0 * ts_zz_xxyy[i] * fe_0 + ts_zzz_xxyy[i] * pa_z[i];

        ts_zzzz_xxyz[i] = 3.0 * ts_zz_xxyz[i] * fe_0 + ts_zzz_xxy[i] * fe_0 + ts_zzz_xxyz[i] * pa_z[i];

        ts_zzzz_xxzz[i] = 3.0 * ts_zz_xxzz[i] * fe_0 + 2.0 * ts_zzz_xxz[i] * fe_0 + ts_zzz_xxzz[i] * pa_z[i];

        ts_zzzz_xyyy[i] = 3.0 * ts_zz_xyyy[i] * fe_0 + ts_zzz_xyyy[i] * pa_z[i];

        ts_zzzz_xyyz[i] = 3.0 * ts_zz_xyyz[i] * fe_0 + ts_zzz_xyy[i] * fe_0 + ts_zzz_xyyz[i] * pa_z[i];

        ts_zzzz_xyzz[i] = 3.0 * ts_zz_xyzz[i] * fe_0 + 2.0 * ts_zzz_xyz[i] * fe_0 + ts_zzz_xyzz[i] * pa_z[i];

        ts_zzzz_xzzz[i] = 3.0 * ts_zz_xzzz[i] * fe_0 + 3.0 * ts_zzz_xzz[i] * fe_0 + ts_zzz_xzzz[i] * pa_z[i];

        ts_zzzz_yyyy[i] = 3.0 * ts_zz_yyyy[i] * fe_0 + ts_zzz_yyyy[i] * pa_z[i];

        ts_zzzz_yyyz[i] = 3.0 * ts_zz_yyyz[i] * fe_0 + ts_zzz_yyy[i] * fe_0 + ts_zzz_yyyz[i] * pa_z[i];

        ts_zzzz_yyzz[i] = 3.0 * ts_zz_yyzz[i] * fe_0 + 2.0 * ts_zzz_yyz[i] * fe_0 + ts_zzz_yyzz[i] * pa_z[i];

        ts_zzzz_yzzz[i] = 3.0 * ts_zz_yzzz[i] * fe_0 + 3.0 * ts_zzz_yzz[i] * fe_0 + ts_zzz_yzzz[i] * pa_z[i];

        ts_zzzz_zzzz[i] = 3.0 * ts_zz_zzzz[i] * fe_0 + 4.0 * ts_zzz_zzz[i] * fe_0 + ts_zzz_zzzz[i] * pa_z[i];
    }
}
