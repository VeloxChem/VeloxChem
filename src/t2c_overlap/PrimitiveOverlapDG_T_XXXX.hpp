#ifndef PrimitiveOverlapDG_T_XXXX
#define PrimitiveOverlapDG_T_XXXX
...
*/
auto compPrimitiveOverlapDG_T_XXXX(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapDG_T_XXXX */
