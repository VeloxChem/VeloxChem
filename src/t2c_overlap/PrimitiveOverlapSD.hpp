#ifndef PrimitiveOverlapSD
#define PrimitiveOverlapSD
...
/**
 Evaluates block of primitive <S|1|D> integrals.
...
*/
auto compPrimitiveOverlapSD(TDoubleArray&       buffer_xx,
