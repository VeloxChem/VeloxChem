#ifndef PrimitiveOverlapDG_T_XXXY
#define PrimitiveOverlapDG_T_XXXY
...
*/
auto compPrimitiveOverlapDG_T_XXXY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapDG_T_XXXY */
