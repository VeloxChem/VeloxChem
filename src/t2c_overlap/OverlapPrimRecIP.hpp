#ifndef OverlapPrimRecIP
#define OverlapPrimRecIP

#include "SimdArray.hpp"

namespace ovlrec {  // ovlrec namespace

/// @brief Computes primitive [I|P]  integrals for set of data buffers.
...
auto comp_prim_overlap_ip(CSimdArray<double>&       pbuffer,
