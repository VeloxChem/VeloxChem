#ifndef PrimitiveOverlapDG_T_ZZZZ
#define PrimitiveOverlapDG_T_ZZZZ
...
*/
auto compPrimitiveOverlapDG_T_ZZZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapDG_T_ZZZZ */
