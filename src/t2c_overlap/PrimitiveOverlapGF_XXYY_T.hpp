#ifndef PrimitiveOverlapGF_XXYY_T
#define PrimitiveOverlapGF_XXYY_T
...
*/
auto compPrimitiveOverlapGF_XXYY_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGF_XXYY_T */
