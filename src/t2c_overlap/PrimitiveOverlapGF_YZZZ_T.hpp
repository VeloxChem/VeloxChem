#ifndef PrimitiveOverlapGF_YZZZ_T
#define PrimitiveOverlapGF_YZZZ_T
...
*/
auto compPrimitiveOverlapGF_YZZZ_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGF_YZZZ_T */
