...
#pragma omp simd aligned(fints_xxxx,     \
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xxxx[i] +=
            fss * (3.0 * fe_0 * rpa_x * rpa_x * rpb_x * rpb_x * rpb_x * rpb_x + 8.0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_x * rpb_x * rpb_x +
        ...
        fints_xxxx[i] += fss * (12.0 * fe_0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpa_x * rpa_x +
                                (3.0 / 4.0) * fe_0 * fe_0 * rpb_x * rpb_x * rpb_x * rpb_x + 30.0 * fe_0 * fe_0 * fe_0 * rpa_x * rpb_x +
                                (45.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpa_x);

        fints_xxxx[i] += fss * ((45.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpb_x * rpb_x + (105.0 / 16.0) * fe_0 * fe_0 * fe_0 * fe_0 +
                                rpa_x * rpa_x * rpa_x * rpa_x * rpb_x * rpb_x * rpb_x * rpb_x);

        fints_xxxy[i] +=
            fss * (3.0 * fe_0 * rpa_x * rpa_x * rpb_y * rpb_x * rpb_x * rpb_x + 6.0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_y * rpb_x * rpb_x +
        ...
        fints_xxxy[i] += fss * (3.0 * fe_0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 * rpb_y * rpb_x * rpb_x * rpb_x +
                                (15.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_y + (45.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_y * rpb_x +
                                rpa_x * rpa_x * rpa_x * rpa_x * rpb_y * rpb_x * rpb_x * rpb_x);

        fints_xxxz[i] +=
            fss * (3.0 * fe_0 * rpa_x * rpa_x * rpb_z * rpb_x * rpb_x * rpb_x + 6.0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_z * rpb_x * rpb_x +
        ...
        fints_xxxz[i] += fss * (3.0 * fe_0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_z + (3.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_x * rpb_x * rpb_x +
                                (15.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_z + (45.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_x +
                                rpa_x * rpa_x * rpa_x * rpa_x * rpb_z * rpb_x * rpb_x * rpb_x);

        fints_xxyy[i] +=
            fss * (3.0 * fe_0 * rpa_x * rpa_x * rpb_y * rpb_y * rpb_x * rpb_x + 4.0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_y * rpb_y * rpb_x +
        ...
        fints_xxyy[i] +=
            fss * ((9.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_y * rpb_y + (3.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_x * rpb_x +
                   2.0 * fe_0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_x + (1.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpa_x * rpa_x +
                   (3.0 / 4.0) * fe_0 * fe_0 * rpb_y * rpb_y * rpb_x * rpb_x);

        fints_xxyy[i] += fss * (3.0 * fe_0 * fe_0 * fe_0 * rpa_x * rpb_x + (9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpa_x +
        ...
        fints_xxyz[i] +=
            fss * (3.0 * fe_0 * rpa_x * rpa_x * rpb_z * rpb_y * rpb_x * rpb_x + 4.0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_z * rpb_y * rpb_x +
        ...
        fints_xxyz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_y * rpb_x * rpb_x + (15.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_y +
                                rpa_x * rpa_x * rpa_x * rpa_x * rpb_z * rpb_y * rpb_x * rpb_x);

        fints_xxzz[i] +=
            fss * (3.0 * fe_0 * rpa_x * rpa_x * rpb_z * rpb_z * rpb_x * rpb_x + 4.0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_z * rpb_z * rpb_x +
        ...
        fints_xxzz[i] +=
            fss * ((9.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_z * rpb_z + (3.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_x * rpb_x +
                   2.0 * fe_0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_x + (1.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpa_x * rpa_x +
                   (3.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_z * rpb_x * rpb_x);

        fints_xxzz[i] += fss * (3.0 * fe_0 * fe_0 * fe_0 * rpa_x * rpb_x + (9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpa_x +
        ...
        fints_xyyy[i] +=
            fss * (3.0 * fe_0 * rpa_x * rpa_x * rpb_y * rpb_y * rpb_y * rpb_x + 2.0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_y * rpb_y * rpb_y +
        ...
        fints_xyyy[i] += fss * (3.0 * fe_0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 * rpb_y * rpb_y * rpb_y * rpb_x +
                                (9.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_y + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_y * rpb_x +
                                rpa_x * rpa_x * rpa_x * rpa_x * rpb_y * rpb_y * rpb_y * rpb_x);

        fints_xyyz[i] +=
            fss * (3.0 * fe_0 * rpa_x * rpa_x * rpb_z * rpb_y * rpb_y * rpb_x + 2.0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_z * rpb_y * rpb_y +
        ...
        fints_xyyz[i] += fss * (fe_0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_z + (3.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_y * rpb_y * rpb_x +
                                (3.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_z + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_x +
                                rpa_x * rpa_x * rpa_x * rpa_x * rpb_z * rpb_y * rpb_y * rpb_x);

        fints_xyzz[i] +=
            fss * (3.0 * fe_0 * rpa_x * rpa_x * rpb_z * rpb_z * rpb_y * rpb_x + 2.0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_z * rpb_z * rpb_y +
        ...
        fints_xyzz[i] += fss * (fe_0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_z * rpb_y * rpb_x +
                                (3.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_y + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_y * rpb_x +
                                rpa_x * rpa_x * rpa_x * rpa_x * rpb_z * rpb_z * rpb_y * rpb_x);

        fints_xzzz[i] +=
            fss * (3.0 * fe_0 * rpa_x * rpa_x * rpb_z * rpb_z * rpb_z * rpb_x + 2.0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_z * rpb_z * rpb_z +
        ...
        fints_xzzz[i] += fss * (3.0 * fe_0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_z + (3.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_z * rpb_z * rpb_x +
                                (9.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_z + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_x +
                                rpa_x * rpa_x * rpa_x * rpa_x * rpb_z * rpb_z * rpb_z * rpb_x);

        fints_yyyy[i] +=
            fss * (3.0 * fe_0 * rpa_x * rpa_x * rpb_y * rpb_y * rpb_y * rpb_y + 3.0 * fe_0 * rpa_x * rpa_x * rpa_x * rpa_x * rpb_y * rpb_y +
                   9.0 * fe_0 * fe_0 * rpa_x * rpa_x * rpb_y * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpa_x * rpa_x +
                   (3.0 / 4.0) * fe_0 * fe_0 * rpb_y * rpb_y * rpb_y * rpb_y);

        fints_yyyy[i] += fss * ((9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpa_x + (9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpb_y * rpb_y +
                                (9.0 / 16.0) * fe_0 * fe_0 * fe_0 * fe_0 + rpa_x * rpa_x * rpa_x * rpa_x * rpb_y * rpb_y * rpb_y * rpb_y);

        fints_yyyz[i] +=
            fss * (3.0 * fe_0 * rpa_x * rpa_x * rpb_z * rpb_y * rpb_y * rpb_y + (3.0 / 2.0) * fe_0 * rpa_x * rpa_x * rpa_x * rpa_x * rpb_z * rpb_y +
        ...
        fints_yyzz[i] +=
            fss * (3.0 * fe_0 * rpa_x * rpa_x * rpb_z * rpb_z * rpb_y * rpb_y + (1.0 / 2.0) * fe_0 * rpa_x * rpa_x * rpa_x * rpa_x * rpb_z * rpb_z +
        ...
        fints_yyzz[i] += fss * ((1.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpa_x * rpa_x +
        ...
        fints_yzzz[i] +=
            fss * (3.0 * fe_0 * rpa_x * rpa_x * rpb_z * rpb_z * rpb_z * rpb_y + (3.0 / 2.0) * fe_0 * rpa_x * rpa_x * rpa_x * rpa_x * rpb_z * rpb_y +
        ...
        fints_zzzz[i] +=
            fss * (3.0 * fe_0 * rpa_x * rpa_x * rpb_z * rpb_z * rpb_z * rpb_z + 3.0 * fe_0 * rpa_x * rpa_x * rpa_x * rpa_x * rpb_z * rpb_z +
                   9.0 * fe_0 * fe_0 * rpa_x * rpa_x * rpb_z * rpb_z + (3.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpa_x * rpa_x +
                   (3.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_z * rpb_z * rpb_z);

        fints_zzzz[i] += fss * ((9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpa_x + (9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_z +
...
#pragma omp simd aligned(fints_xxxx,     \
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xxxx[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_y * rpa_x * rpb_x * rpb_x * rpb_x * rpb_x + 6.0 * fe_0 * rpa_y * rpa_x * rpa_x * rpb_x * rpb_x * rpb_x +
        ...
        fints_xxxx[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpa_x * rpa_x + 3.0 * fe_0 * fe_0 * rpa_y * rpb_x * rpb_x * rpb_x +
        ...
        fints_xxxy[i] +=
            fss * ((9.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpa_x * rpb_y + (9.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpb_y * rpb_x * rpb_x +
        ...
        fints_xxxy[i] += fss * ((15.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_y + (27.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_x +
        ...
        fints_xxxz[i] += fss * ((9.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpb_z * rpb_x * rpb_x + (15.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_z +
                                rpa_y * rpa_x * rpa_x * rpa_x * rpb_z * rpb_x * rpb_x * rpb_x);

        fints_xxyy[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_y * rpa_x * rpb_y * rpb_y * rpb_x * rpb_x + 3.0 * fe_0 * rpa_y * rpa_x * rpa_x * rpb_y * rpb_y * rpb_x +
        ...
        fints_xxyy[i] +=
            fss * ((9.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpb_y * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpb_x * rpb_x +
        ...
        fints_xxyy[i] += fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpb_y * rpb_x * rpb_x + 3.0 * fe_0 * fe_0 * rpa_x * rpa_x * rpb_y * rpb_x +
                                (1.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_y + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_x +
                                (3.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_x);

        fints_xxyy[i] += fss * ((9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_y + (3.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpb_y * rpb_x +
                                rpa_y * rpa_x * rpa_x * rpa_x * rpb_y * rpb_y * rpb_x * rpb_x);

        fints_xxyz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_y * rpa_x * rpb_z * rpb_y * rpb_x * rpb_x + 3.0 * fe_0 * rpa_y * rpa_x * rpa_x * rpb_z * rpb_y * rpb_x +
        ...
        fints_xxyz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpb_z * rpb_y * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpb_z * rpb_x * rpb_x +
        ...
        fints_xxzz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_y * rpa_x * rpb_z * rpb_z * rpb_x * rpb_x + 3.0 * fe_0 * rpa_y * rpa_x * rpa_x * rpb_z * rpb_z * rpb_x +
        ...
        fints_xxzz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpb_x * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpa_x * rpb_x +
        ...
        fints_xyyy[i] +=
            fss * ((9.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpa_x * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpb_y * rpb_y * rpb_y +
                   (9.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpb_y * rpb_y * rpb_x + (9.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_y * rpb_y +
                   (3.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_x);

        fints_xyyy[i] += fss * ((9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_y + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_x +
        ...
        fints_xyyz[i] += fss * ((3.0 / 2.0) * fe_0 * rpa_y * rpa_x * rpb_z * rpb_y * rpb_y * rpb_x +
        ...
        fints_xyyz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpa_x * rpb_z + (3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpb_z * rpb_y * rpb_y +
        ...
        fints_xyzz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpa_x * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpb_z * rpb_z * rpb_y +
        ...
        fints_xyzz[i] += fss * ((3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_y + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_x +
        ...
        fints_xzzz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpb_z * rpb_z * rpb_z + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_z +
                                rpa_y * rpa_x * rpa_x * rpa_x * rpb_z * rpb_z * rpb_z * rpb_x);

        fints_yyyy[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_y * rpa_x * rpb_y * rpb_y * rpb_y * rpb_y + 3.0 * fe_0 * rpa_y * rpa_x * rpa_x * rpa_x * rpb_y * rpb_y +
        ...
        fints_yyyy[i] += fss * (3.0 * fe_0 * fe_0 * rpa_x * rpb_y * rpb_y * rpb_y + 3.0 * fe_0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_y +
        ...
        fints_yyyz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_z + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_z +
                                rpa_y * rpa_x * rpa_x * rpa_x * rpb_z * rpb_y * rpb_y * rpb_y);

        fints_yyzz[i] += fss * ((3.0 / 2.0) * fe_0 * rpa_y * rpa_x * rpb_z * rpb_z * rpb_y * rpb_y +
                                (1.0 / 2.0) * fe_0 * rpa_y * rpa_x * rpa_x * rpa_x * rpb_z * rpb_z +
                                (1.0 / 2.0) * fe_0 * rpa_y * rpa_x * rpa_x * rpa_x * rpb_y * rpb_y +
                                fe_0 * rpa_x * rpa_x * rpa_x * rpb_z * rpb_z * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpb_z * rpb_z);

        fints_yyzz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpb_y * rpb_y + (1.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpa_x * rpa_x +
        ...
        fints_yzzz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_z + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_z +
                                rpa_y * rpa_x * rpa_x * rpa_x * rpb_z * rpb_z * rpb_z * rpb_y);

        fints_zzzz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_y * rpa_x * rpb_z * rpb_z * rpb_z * rpb_z + 3.0 * fe_0 * rpa_y * rpa_x * rpa_x * rpa_x * rpb_z * rpb_z +
...
#pragma omp simd aligned(fints_xxxx,     \
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xxxx[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_x * rpb_x * rpb_x * rpb_x * rpb_x + 6.0 * fe_0 * rpa_z * rpa_x * rpa_x * rpb_x * rpb_x * rpb_x +
        ...
        fints_xxxx[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpa_x * rpa_x + 3.0 * fe_0 * fe_0 * rpa_z * rpb_x * rpb_x * rpb_x +
        ...
        fints_xxxy[i] += fss * ((9.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpb_y * rpb_x * rpb_x + (15.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_y +
        ...
        fints_xxxz[i] +=
            fss * ((9.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpa_x * rpb_z + (9.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpb_z * rpb_x * rpb_x +
                   (3.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpb_x * rpb_x * rpb_x + (9.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_x * rpb_x +
                   (3.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_x);

        fints_xxxz[i] += fss * ((15.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_z + (27.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_x +
                                (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpa_x + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_x * rpb_x +
                                (15.0 / 16.0) * fe_0 * fe_0 * fe_0 * fe_0);
        ...
        fints_xxyy[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_x * rpb_y * rpb_y * rpb_x * rpb_x + 3.0 * fe_0 * rpa_z * rpa_x * rpa_x * rpb_y * rpb_y * rpb_x +
        ...
        fints_xxyy[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpb_x * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpa_x * rpb_x +
        ...
        fints_xxyz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_x * rpb_z * rpb_y * rpb_x * rpb_x + 3.0 * fe_0 * rpa_z * rpa_x * rpa_x * rpb_z * rpb_y * rpb_x +
        ...
        fints_xxyz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpb_z * rpb_y * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpb_y * rpb_x * rpb_x +
        ...
        fints_xxzz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_x * rpb_z * rpb_z * rpb_x * rpb_x + 3.0 * fe_0 * rpa_z * rpa_x * rpa_x * rpb_z * rpb_z * rpb_x +
        ...
        fints_xxzz[i] +=
            fss * ((9.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpb_z * rpb_z + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpb_x * rpb_x +
        ...
        fints_xxzz[i] += fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpb_z * rpb_x * rpb_x + 3.0 * fe_0 * fe_0 * rpa_x * rpa_x * rpb_z * rpb_x +
                                (1.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_z + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_x +
                                (3.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_x);

        fints_xxzz[i] += fss * ((9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_z + (3.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_x +
        ...
        fints_xyyy[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpb_y * rpb_y * rpb_y + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_y +
        ...
        fints_xyyz[i] += fss * ((3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_z + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_x +
        ...
        fints_xyzz[i] += fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_x * rpb_z * rpb_z * rpb_y * rpb_x +
        ...
        fints_xyzz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpa_x * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpb_z * rpb_z * rpb_y +
                   (3.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpb_z * rpb_y * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_z * rpb_y +
        ...
        fints_xzzz[i] +=
            fss * ((9.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpa_x * rpb_z + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpb_z * rpb_z * rpb_z +
                   (9.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpb_z * rpb_z * rpb_x + (9.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_z * rpb_z +
                   (3.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_x);

        fints_xzzz[i] += fss * ((9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_z + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_x +
        ...
        fints_yyyy[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_x * rpb_y * rpb_y * rpb_y * rpb_y + 3.0 * fe_0 * rpa_z * rpa_x * rpa_x * rpa_x * rpb_y * rpb_y +
        ...
        fints_yyyz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_y + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_y +
                                rpa_z * rpa_x * rpa_x * rpa_x * rpb_z * rpb_y * rpb_y * rpb_y);

        fints_yyzz[i] += fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_x * rpb_z * rpb_z * rpb_y * rpb_y +
                                (1.0 / 2.0) * fe_0 * rpa_z * rpa_x * rpa_x * rpa_x * rpb_z * rpb_z +
                                (1.0 / 2.0) * fe_0 * rpa_z * rpa_x * rpa_x * rpa_x * rpb_y * rpb_y +
                                fe_0 * rpa_x * rpa_x * rpa_x * rpb_z * rpb_y * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpb_z * rpb_z);

        fints_yyzz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpb_y * rpb_y + (1.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpa_x * rpa_x +
        ...
        fints_yzzz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_y + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_y +
                                rpa_z * rpa_x * rpa_x * rpa_x * rpb_z * rpb_z * rpb_z * rpb_y);

        fints_zzzz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_x * rpb_z * rpb_z * rpb_z * rpb_z + 3.0 * fe_0 * rpa_z * rpa_x * rpa_x * rpa_x * rpb_z * rpb_z +
        ...
        fints_zzzz[i] += fss * (3.0 * fe_0 * fe_0 * rpa_x * rpb_z * rpb_z * rpb_z + 3.0 * fe_0 * fe_0 * rpa_x * rpa_x * rpa_x * rpb_z +
...
#pragma omp simd aligned(fints_xxxx,     \
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xxxx[i] +=
            fss * (4.0 * fe_0 * rpa_y * rpa_y * rpa_x * rpb_x * rpb_x * rpb_x + 3.0 * fe_0 * rpa_y * rpa_y * rpa_x * rpa_x * rpb_x * rpb_x +
        ...
        fints_xxxx[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_x * rpa_x + (9.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_x * rpb_x +
                   2.0 * fe_0 * fe_0 * rpa_x * rpb_x * rpb_x * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_x * rpb_x +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpb_x * rpb_x * rpb_x * rpb_x);

        fints_xxxx[i] += fss * ((15.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_y + 3.0 * fe_0 * fe_0 * fe_0 * rpa_x * rpb_x +
        ...
        fints_xxxy[i] += fss * (fe_0 * rpa_y * rpa_x * rpa_x * rpb_x * rpb_x * rpb_x + 3.0 * fe_0 * rpa_y * rpa_y * rpa_x * rpb_y * rpb_x * rpb_x +
        ...
        fints_xxxy[i] +=
            fss * (3.0 * fe_0 * fe_0 * rpa_y * rpa_x * rpb_x * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpa_x * rpb_x +
        ...
        fints_xxxy[i] +=
            fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpb_y * rpb_x * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_y * rpb_x +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpb_y * rpb_x * rpb_x * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_x +
                   (9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_x);

        fints_xxxy[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_y + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_y * rpb_x +
                                rpa_y * rpa_y * rpa_x * rpa_x * rpb_y * rpb_x * rpb_x * rpb_x);

        fints_xxxz[i] +=
            fss * (3.0 * fe_0 * rpa_y * rpa_y * rpa_x * rpb_z * rpb_x * rpb_x + (3.0 / 2.0) * fe_0 * rpa_y * rpa_y * rpa_x * rpa_x * rpb_z * rpb_x +
        ...
        fints_xxxz[i] +=
            fss * ((9.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpb_z * rpb_x * rpb_x +
        ...
        fints_xxyy[i] += fss * ((1.0 / 2.0) * fe_0 * rpa_x * rpa_x * rpb_y * rpb_y * rpb_x * rpb_x +
        ...
        fints_xxyy[i] +=
            fss * ((1.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_x * rpa_x + (3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_y * rpb_y +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_x * rpb_x + fe_0 * fe_0 * rpa_x * rpb_y * rpb_y * rpb_x +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_y * rpb_y);

        fints_xxyy[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_x * rpb_x +
        ...
        fints_xxyy[i] += fss * ((3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpa_x + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_y * rpb_y +
                                (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_x * rpb_x + (9.0 / 16.0) * fe_0 * fe_0 * fe_0 * fe_0 +
                                rpa_y * rpa_y * rpa_x * rpa_x * rpb_y * rpb_y * rpb_x * rpb_x);

        fints_xxyz[i] += fss * (fe_0 * rpa_y * rpa_x * rpa_x * rpb_z * rpb_x * rpb_x + 2.0 * fe_0 * rpa_y * rpa_y * rpa_x * rpb_z * rpb_y * rpb_x +
        ...
        fints_xxyz[i] += fss * (2.0 * fe_0 * fe_0 * rpa_y * rpa_x * rpb_z * rpb_x + (1.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpa_x * rpb_z +
                                (1.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpb_z * rpb_x * rpb_x +
                                (3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_y + fe_0 * fe_0 * rpa_x * rpb_z * rpb_y * rpb_x);

        fints_xxyz[i] += fss * ((1.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_z * rpb_y +
        ...
        fints_xxzz[i] += fss * (fe_0 * fe_0 * rpa_y * rpa_y * rpa_x * rpb_x + (1.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_x * rpa_x +
                                (3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_z +
                                (1.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_x * rpb_x + fe_0 * fe_0 * rpa_x * rpb_z * rpb_z * rpb_x);

        fints_xxzz[i] +=
            fss * ((1.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_z * rpb_z + (1.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_x * rpb_x +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_z * rpb_x * rpb_x + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_y +
                   (1.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_x);

        fints_xxzz[i] += fss * ((1.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpa_x + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_z +
                                (1.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_x * rpb_x + (3.0 / 16.0) * fe_0 * fe_0 * fe_0 * fe_0 +
                                rpa_y * rpa_y * rpa_x * rpa_x * rpb_z * rpb_z * rpb_x * rpb_x);

        fints_xyyy[i] += fss * (3.0 * fe_0 * rpa_y * rpa_x * rpa_x * rpb_y * rpb_y * rpb_x + fe_0 * rpa_y * rpa_y * rpa_x * rpb_y * rpb_y * rpb_y +
                                (3.0 / 2.0) * fe_0 * rpa_y * rpa_y * rpa_x * rpa_x * rpb_y * rpb_x +
                                (1.0 / 2.0) * fe_0 * rpa_y * rpa_y * rpb_y * rpb_y * rpb_y * rpb_x +
                                (1.0 / 2.0) * fe_0 * rpa_x * rpa_x * rpb_y * rpb_y * rpb_y * rpb_x);

        fints_xyyy[i] +=
            fss * (3.0 * fe_0 * fe_0 * rpa_y * rpa_x * rpb_y * rpb_y + (3.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpa_x * rpb_x +
        ...
        fints_xyyy[i] +=
            fss * ((1.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpb_y * rpb_y * rpb_y + (9.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_y * rpb_x +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpb_y * rpb_y * rpb_y * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_x +
                   (3.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_x);

        fints_xyyy[i] += fss * ((9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_y + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_y * rpb_x +
                                rpa_y * rpa_y * rpa_x * rpa_x * rpb_y * rpb_y * rpb_y * rpb_x);

        fints_xyyz[i] += fss * (2.0 * fe_0 * rpa_y * rpa_x * rpa_x * rpb_z * rpb_y * rpb_x + fe_0 * rpa_y * rpa_y * rpa_x * rpb_z * rpb_y * rpb_y +
        ...
        fints_xyyz[i] +=
            fss * (2.0 * fe_0 * fe_0 * rpa_y * rpa_x * rpb_z * rpb_y + fe_0 * fe_0 * rpa_y * rpb_z * rpb_y * rpb_x +
        ...
        fints_xyyz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_z * rpb_x +
        ...
        fints_xyzz[i] += fss * (fe_0 * rpa_y * rpa_x * rpa_x * rpb_z * rpb_z * rpb_x + fe_0 * rpa_y * rpa_y * rpa_x * rpb_z * rpb_z * rpb_y +
        ...
        fints_xyzz[i] +=
            fss * (fe_0 * fe_0 * rpa_y * rpa_x * rpb_z * rpb_z + (1.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpa_x * rpb_x +
        ...
        fints_xyzz[i] +=
            fss * ((1.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpb_z * rpb_z * rpb_y + (1.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_y * rpb_x +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_z * rpb_y * rpb_x + (1.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_x +
                   (1.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_x);

        fints_xyzz[i] += fss * ((1.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_y + (1.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_y * rpb_x +
                                rpa_y * rpa_y * rpa_x * rpa_x * rpb_z * rpb_z * rpb_y * rpb_x);

        fints_xzzz[i] +=
            fss * (fe_0 * rpa_y * rpa_y * rpa_x * rpb_z * rpb_z * rpb_z + (3.0 / 2.0) * fe_0 * rpa_y * rpa_y * rpa_x * rpa_x * rpb_z * rpb_x +
        ...
        fints_xzzz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_x + (1.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpb_z * rpb_z * rpb_z +
        ...
        fints_yyyy[i] +=
            fss * (4.0 * fe_0 * rpa_y * rpa_x * rpa_x * rpb_y * rpb_y * rpb_y + 3.0 * fe_0 * rpa_y * rpa_y * rpa_x * rpa_x * rpb_y * rpb_y +
        ...
        fints_yyyy[i] +=
            fss * (2.0 * fe_0 * fe_0 * rpa_y * rpb_y * rpb_y * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_x * rpa_x +
        ...
        fints_yyyy[i] += fss * (3.0 * fe_0 * fe_0 * fe_0 * rpa_y * rpb_y + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_y +
        ...
        fints_yyyz[i] +=
            fss * (3.0 * fe_0 * rpa_y * rpa_x * rpa_x * rpb_z * rpb_y * rpb_y + (3.0 / 2.0) * fe_0 * rpa_y * rpa_y * rpa_x * rpa_x * rpb_z * rpb_y +
        ...
        fints_yyyz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpb_z * rpb_y * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_y +
        ...
        fints_yyzz[i] +=
            fss * (fe_0 * fe_0 * rpa_y * rpa_x * rpa_x * rpb_y + fe_0 * fe_0 * rpa_y * rpb_z * rpb_z * rpb_y +
        ...
        fints_yyzz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_z * rpb_z + (1.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_y * rpb_y +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_z * rpb_y * rpb_y + (1.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_y +
                   (1.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_y);

        fints_yyzz[i] += fss * ((3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpa_x + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_z +
                                (1.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_y * rpb_y + (3.0 / 16.0) * fe_0 * fe_0 * fe_0 * fe_0 +
                                rpa_y * rpa_y * rpa_x * rpa_x * rpb_z * rpb_z * rpb_y * rpb_y);

        fints_yzzz[i] +=
            fss * (fe_0 * rpa_y * rpa_x * rpa_x * rpb_z * rpb_z * rpb_z + (3.0 / 2.0) * fe_0 * rpa_y * rpa_y * rpa_x * rpa_x * rpb_z * rpb_y +
        ...
        fints_yzzz[i] +=
            fss * ((1.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpb_z * rpb_z * rpb_z + (3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_y +
        ...
        fints_zzzz[i] +=
            fss * (3.0 * fe_0 * rpa_y * rpa_y * rpa_x * rpa_x * rpb_z * rpb_z + (1.0 / 2.0) * fe_0 * rpa_y * rpa_y * rpb_z * rpb_z * rpb_z * rpb_z +
        ...
        fints_zzzz[i] += fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_z * rpb_z +
...
#pragma omp simd aligned(fints_xxxx,     \
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xxxx[i] +=
            fss * (4.0 * fe_0 * rpa_z * rpa_z * rpa_x * rpb_x * rpb_x * rpb_x + 3.0 * fe_0 * rpa_z * rpa_z * rpa_x * rpa_x * rpb_x * rpb_x +
        ...
        fints_xxxx[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_x * rpa_x + (9.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_x * rpb_x +
                   2.0 * fe_0 * fe_0 * rpa_x * rpb_x * rpb_x * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_x * rpb_x +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpb_x * rpb_x * rpb_x * rpb_x);

        fints_xxxx[i] += fss * ((15.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_z + 3.0 * fe_0 * fe_0 * fe_0 * rpa_x * rpb_x +
                                (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpa_x + (9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpb_x * rpb_x +
                                (15.0 / 16.0) * fe_0 * fe_0 * fe_0 * fe_0);
        ...
        fints_xxxy[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_z * rpa_x * rpb_y * rpb_x * rpb_x + (3.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_x * rpa_x * rpb_y * rpb_x +
        ...
        fints_xxxy[i] +=
            fss * ((9.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_y * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpb_y * rpb_x * rpb_x +
        ...
        fints_xxxz[i] += fss * (fe_0 * rpa_z * rpa_x * rpa_x * rpb_x * rpb_x * rpb_x + 3.0 * fe_0 * rpa_z * rpa_z * rpa_x * rpb_z * rpb_x * rpb_x +
        ...
        fints_xxxz[i] +=
            fss * (3.0 * fe_0 * fe_0 * rpa_z * rpa_x * rpb_x * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpa_x * rpb_x +
        ...
        fints_xxxz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpb_z * rpb_x * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_z * rpb_x +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_x * rpb_x * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_x +
                   (9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_x);

        fints_xxxz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_z + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_x +
        ...
        fints_xxyy[i] += fss * (fe_0 * fe_0 * rpa_z * rpa_z * rpa_x * rpb_x + (1.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_x * rpa_x +
                                (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_y * rpb_y +
                                (1.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_x * rpb_x + fe_0 * fe_0 * rpa_x * rpb_y * rpb_y * rpb_x);

        fints_xxyy[i] +=
            fss * ((1.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_y * rpb_y + (1.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_x * rpb_x +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpb_y * rpb_y * rpb_x * rpb_x + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_z +
                   (1.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_x);

        fints_xxyy[i] += fss * ((1.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpa_x + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_y * rpb_y +
                                (1.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_x * rpb_x + (3.0 / 16.0) * fe_0 * fe_0 * fe_0 * fe_0 +
                                rpa_z * rpa_z * rpa_x * rpa_x * rpb_y * rpb_y * rpb_x * rpb_x);

        fints_xxyz[i] += fss * (fe_0 * rpa_z * rpa_x * rpa_x * rpb_y * rpb_x * rpb_x + 2.0 * fe_0 * rpa_z * rpa_z * rpa_x * rpb_z * rpb_y * rpb_x +
                                (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_x * rpa_x * rpb_z * rpb_y +
                                (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpb_z * rpb_y * rpb_x * rpb_x +
                                (1.0 / 2.0) * fe_0 * rpa_x * rpa_x * rpb_z * rpb_y * rpb_x * rpb_x);

        fints_xxyz[i] += fss * (2.0 * fe_0 * fe_0 * rpa_z * rpa_x * rpb_y * rpb_x + (1.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpa_x * rpb_y +
        ...
        fints_xxzz[i] += fss * ((1.0 / 2.0) * fe_0 * rpa_x * rpa_x * rpb_z * rpb_z * rpb_x * rpb_x +
        ...
        fints_xxzz[i] +=
            fss * ((1.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_x * rpa_x + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_z * rpb_z +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_x * rpb_x + fe_0 * fe_0 * rpa_x * rpb_z * rpb_z * rpb_x +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_z * rpb_z);

        fints_xxzz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_x * rpb_x +
        ...
        fints_xxzz[i] += fss * ((3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpa_x + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_z +
                                (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_x * rpb_x + (9.0 / 16.0) * fe_0 * fe_0 * fe_0 * fe_0 +
                                rpa_z * rpa_z * rpa_x * rpa_x * rpb_z * rpb_z * rpb_x * rpb_x);

        fints_xyyy[i] +=
            fss * (fe_0 * rpa_z * rpa_z * rpa_x * rpb_y * rpb_y * rpb_y + (3.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_x * rpa_x * rpb_y * rpb_x +
        ...
        fints_xyyy[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_y * rpb_x + (1.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpb_y * rpb_y * rpb_y +
        ...
        fints_xyyz[i] += fss * (fe_0 * rpa_z * rpa_x * rpa_x * rpb_y * rpb_y * rpb_x + fe_0 * rpa_z * rpa_z * rpa_x * rpb_z * rpb_y * rpb_y +
                                (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_x * rpa_x * rpb_z * rpb_x +
                                (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpb_z * rpb_y * rpb_y * rpb_x +
                                (1.0 / 2.0) * fe_0 * rpa_x * rpa_x * rpb_z * rpb_y * rpb_y * rpb_x);

        fints_xyyz[i] +=
            fss * (fe_0 * fe_0 * rpa_z * rpa_x * rpb_y * rpb_y + (1.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpa_x * rpb_x +
        ...
        fints_xyyz[i] +=
            fss * ((1.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpb_z * rpb_y * rpb_y + (1.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_z * rpb_x +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_y * rpb_y * rpb_x + (1.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_x +
                   (1.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_x);

        fints_xyyz[i] += fss * ((1.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_z + (1.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_x +
                                rpa_z * rpa_z * rpa_x * rpa_x * rpb_z * rpb_y * rpb_y * rpb_x);

        fints_xyzz[i] += fss * (2.0 * fe_0 * rpa_z * rpa_x * rpa_x * rpb_z * rpb_y * rpb_x + fe_0 * rpa_z * rpa_z * rpa_x * rpb_z * rpb_z * rpb_y +
                                (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_x * rpa_x * rpb_y * rpb_x +
                                (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpb_z * rpb_z * rpb_y * rpb_x +
                                (1.0 / 2.0) * fe_0 * rpa_x * rpa_x * rpb_z * rpb_z * rpb_y * rpb_x);

        fints_xyzz[i] +=
            fss * (2.0 * fe_0 * fe_0 * rpa_z * rpa_x * rpb_z * rpb_y + fe_0 * fe_0 * rpa_z * rpb_z * rpb_y * rpb_x +
        ...
        fints_xyzz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_y * rpb_x +
        ...
        fints_xzzz[i] += fss * (3.0 * fe_0 * rpa_z * rpa_x * rpa_x * rpb_z * rpb_z * rpb_x + fe_0 * rpa_z * rpa_z * rpa_x * rpb_z * rpb_z * rpb_z +
                                (3.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_x * rpa_x * rpb_z * rpb_x +
                                (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpb_z * rpb_z * rpb_z * rpb_x +
                                (1.0 / 2.0) * fe_0 * rpa_x * rpa_x * rpb_z * rpb_z * rpb_z * rpb_x);

        fints_xzzz[i] +=
            fss * (3.0 * fe_0 * fe_0 * rpa_z * rpa_x * rpb_z * rpb_z + (3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpa_x * rpb_x +
        ...
        fints_xzzz[i] +=
            fss * ((1.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpb_z * rpb_z * rpb_z + (9.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_z * rpb_x +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_z * rpb_z * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_x +
                   (3.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_x);

        fints_xzzz[i] += fss * ((9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_z + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_x +
                                rpa_z * rpa_z * rpa_x * rpa_x * rpb_z * rpb_z * rpb_z * rpb_x);

        fints_yyyy[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_z * rpa_x * rpa_x * rpb_y * rpb_y + (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpb_y * rpb_y * rpb_y * rpb_y +
        ...
        fints_yyyy[i] += fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_y * rpb_y +
        ...
        fints_yyyz[i] +=
            fss * (fe_0 * rpa_z * rpa_x * rpa_x * rpb_y * rpb_y * rpb_y + (3.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_x * rpa_x * rpb_z * rpb_y +
        ...
        fints_yyyz[i] +=
            fss * ((1.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpb_y * rpb_y * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_z * rpb_y +
        ...
        fints_yyzz[i] +=
            fss * (fe_0 * fe_0 * rpa_z * rpa_x * rpa_x * rpb_z + fe_0 * fe_0 * rpa_z * rpb_z * rpb_y * rpb_y +
        ...
        fints_yyzz[i] +=
            fss * ((1.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_z * rpb_z + (3.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpa_x * rpb_y * rpb_y +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_z * rpb_y * rpb_y + (1.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_z +
                   (1.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_z);

        fints_yyzz[i] += fss * ((3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpa_x + (1.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_z +
                                (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_y * rpb_y + (3.0 / 16.0) * fe_0 * fe_0 * fe_0 * fe_0 +
                                rpa_z * rpa_z * rpa_x * rpa_x * rpb_z * rpb_z * rpb_y * rpb_y);

        fints_yzzz[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_x * rpa_x * rpb_z * rpb_z * rpb_y + (3.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_x * rpa_x * rpb_z * rpb_y +
        ...
        fints_yzzz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpb_z * rpb_z * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_z * rpb_y +
        ...
        fints_zzzz[i] +=
            fss * (4.0 * fe_0 * rpa_z * rpa_x * rpa_x * rpb_z * rpb_z * rpb_z + 3.0 * fe_0 * rpa_z * rpa_z * rpa_x * rpa_x * rpb_z * rpb_z +
        ...
        fints_zzzz[i] +=
            fss * (2.0 * fe_0 * fe_0 * rpa_z * rpb_z * rpb_z * rpb_z + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_x * rpa_x +
        ...
        fints_zzzz[i] += fss * (3.0 * fe_0 * fe_0 * fe_0 * rpa_z * rpb_z + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_z +
...
#pragma omp simd aligned(fints_xxxx,     \
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xxxx[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_y * rpa_x * rpb_x * rpb_x * rpb_x * rpb_x + 3.0 * fe_0 * rpa_y * rpa_y * rpa_y * rpa_x * rpb_x * rpb_x +
        ...
        fints_xxxx[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpa_x + 3.0 * fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_x +
        ...
        fints_xxxy[i] +=
            fss * ((9.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpb_y * rpb_x * rpb_x + (9.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_x * rpb_x +
        ...
        fints_xxxy[i] += fss * ((9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_y + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_y +
        ...
        fints_xxxz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_z + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_z +
                                rpa_y * rpa_y * rpa_y * rpa_x * rpb_z * rpb_x * rpb_x * rpb_x);

        fints_xxyy[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_y * rpa_x * rpb_y * rpb_y * rpb_x * rpb_x + 3.0 * fe_0 * rpa_y * rpa_y * rpa_x * rpb_y * rpb_x * rpb_x +
        ...
        fints_xxyy[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpb_y * rpb_y + (9.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpb_x * rpb_x +
                   (3.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpb_y * rpb_y * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_x * rpb_y +
                   3.0 * fe_0 * fe_0 * rpa_y * rpa_y * rpb_y * rpb_x);

        fints_xxyy[i] +=
            fss * ((1.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpa_x + (1.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_x +
                   (3.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpb_y * rpb_x * rpb_x + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_x +
                   (9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_x);

        fints_xxyy[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_y + (3.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpb_y * rpb_x +
                                rpa_y * rpa_y * rpa_y * rpa_x * rpb_y * rpb_y * rpb_x * rpb_x);

        fints_xxyz[i] += fss * ((3.0 / 2.0) * fe_0 * rpa_y * rpa_x * rpb_z * rpb_y * rpb_x * rpb_x +
        ...
        fints_xxyz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpb_z * rpb_y * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_x * rpb_z +
        ...
        fints_xxzz[i] += fss * ((3.0 / 2.0) * fe_0 * rpa_y * rpa_x * rpb_z * rpb_z * rpb_x * rpb_x +
        ...
        fints_xxzz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpb_x * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpb_z * rpb_z * rpb_x +
        ...
        fints_xyyy[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpb_y * rpb_y * rpb_y + (9.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_x * rpb_x +
        ...
        fints_xyyy[i] += fss * ((27.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_y + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_y +
        ...
        fints_xyyz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_y * rpa_x * rpb_z * rpb_y * rpb_y * rpb_x + 3.0 * fe_0 * rpa_y * rpa_y * rpa_x * rpb_z * rpb_y * rpb_x +
        ...
        fints_xyyz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpb_z * rpb_y * rpb_y + (3.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_y +
        ...
        fints_xyzz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpb_z * rpb_z * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_x * rpb_x +
        ...
        fints_xyzz[i] += fss * ((3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_y + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_y +
        ...
        fints_xzzz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_z + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_z +
                                rpa_y * rpa_y * rpa_y * rpa_x * rpb_z * rpb_z * rpb_z * rpb_x);

        fints_yyyy[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_y * rpa_x * rpb_y * rpb_y * rpb_y * rpb_y + 6.0 * fe_0 * rpa_y * rpa_y * rpa_x * rpb_y * rpb_y * rpb_y +
        ...
        fints_yyyy[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpa_x + 3.0 * fe_0 * fe_0 * rpa_x * rpb_y * rpb_y * rpb_y +
        ...
        fints_yyyz[i] += fss * ((9.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpb_z * rpb_y * rpb_y + (15.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_z +
                                rpa_y * rpa_y * rpa_y * rpa_x * rpb_z * rpb_y * rpb_y * rpb_y);

        fints_yyzz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_y * rpa_x * rpb_z * rpb_z * rpb_y * rpb_y + 3.0 * fe_0 * rpa_y * rpa_y * rpa_x * rpb_z * rpb_z * rpb_y +
                   (1.0 / 2.0) * fe_0 * rpa_y * rpa_y * rpa_y * rpa_x * rpb_z * rpb_z +
                   (1.0 / 2.0) * fe_0 * rpa_y * rpa_y * rpa_y * rpa_x * rpb_y * rpb_y + (9.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpb_z * rpb_z);

        fints_yyzz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpb_y * rpb_y + (3.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_x * rpb_y +
        ...
        fints_yzzz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpb_z * rpb_z * rpb_z + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_z +
                                rpa_y * rpa_y * rpa_y * rpa_x * rpb_z * rpb_z * rpb_z * rpb_y);

        fints_zzzz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_y * rpa_x * rpb_z * rpb_z * rpb_z * rpb_z + 3.0 * fe_0 * rpa_y * rpa_y * rpa_y * rpa_x * rpb_z * rpb_z +
...
#pragma omp simd aligned(fints_xxxx,     \
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xxxx[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_y * rpa_y * rpa_x * rpb_x * rpb_x + 2.0 * fe_0 * rpa_z * rpa_y * rpa_y * rpb_x * rpb_x * rpb_x +
        ...
        fints_xxxx[i] += fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpb_x * rpb_x + fe_0 * fe_0 * rpa_z * rpb_x * rpb_x * rpb_x +
                                (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_x + (3.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_x +
                                rpa_z * rpa_y * rpa_y * rpa_x * rpb_x * rpb_x * rpb_x * rpb_x);

        fints_xxxy[i] +=
            fss * (fe_0 * rpa_z * rpa_y * rpa_x * rpb_x * rpb_x * rpb_x + (3.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpa_y * rpa_x * rpb_y * rpb_x +
        ...
        fints_xxxy[i] +=
            fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpb_x * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpa_y * rpb_y +
        ...
        fints_xxxz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpb_z * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpb_z * rpb_x * rpb_x +
        ...
        fints_xxxz[i] += fss * ((3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_z + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_y +
        ...
        fints_xxyy[i] +=
            fss * (2.0 * fe_0 * rpa_z * rpa_y * rpa_x * rpb_y * rpb_x * rpb_x + (1.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpa_y * rpa_x * rpb_y * rpb_y +
        ...
        fints_xxyy[i] +=
            fss * (fe_0 * fe_0 * rpa_z * rpa_y * rpa_x * rpb_y + 2.0 * fe_0 * fe_0 * rpa_z * rpa_y * rpb_y * rpb_x +
        ...
        fints_xxyy[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpb_x * rpb_x +
        ...
        fints_xxyz[i] +=
            fss * (fe_0 * rpa_z * rpa_y * rpa_x * rpb_z * rpb_x * rpb_x + (1.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpa_y * rpa_x * rpb_z * rpb_y +
        ...
        fints_xxyz[i] +=
            fss * ((1.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpa_x * rpb_z + fe_0 * fe_0 * rpa_z * rpa_y * rpb_z * rpb_x +
        ...
        fints_xxyz[i] +=
            fss * ((1.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_x * rpb_y + (1.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_y * rpb_x +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpb_y * rpb_x * rpb_x + (1.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_x +
                   (1.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_x);

        fints_xxyz[i] += fss * ((1.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_y + (1.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpb_y * rpb_x +
                                rpa_z * rpa_y * rpa_y * rpa_x * rpb_z * rpb_y * rpb_x * rpb_x);

        fints_xxzz[i] +=
            fss * ((1.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpa_y * rpa_x * rpb_z * rpb_z +
        ...
        fints_xxzz[i] +=
            fss * ((1.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpa_y * rpa_x + (1.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpa_y * rpb_x +
        ...
        fints_xxzz[i] += fss * ((1.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_x * rpb_z + fe_0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_x +
                                (1.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpb_z * rpb_x * rpb_x + (1.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_x +
                                (1.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_x);

        fints_xxzz[i] += fss * ((1.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_z + (1.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_x +
                                rpa_z * rpa_y * rpa_y * rpa_x * rpb_z * rpb_z * rpb_x * rpb_x);

        fints_xyyy[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_y * rpa_x * rpb_y * rpb_y * rpb_x + (3.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpa_y * rpa_x * rpb_y * rpb_x +
        ...
        fints_xyyy[i] +=
            fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpb_y * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpa_y * rpb_y +
        ...
        fints_xyyz[i] += fss * (fe_0 * fe_0 * rpa_z * rpa_y * rpb_z * rpb_y + (1.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpa_y * rpb_z +
                                (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpb_z * rpb_x +
                                (1.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpb_z * rpb_y * rpb_y + fe_0 * fe_0 * rpa_y * rpa_x * rpb_y * rpb_x);

        fints_xyyz[i] +=
            fss * ((1.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_x * rpb_x + (1.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_y * rpb_y +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpb_y * rpb_y * rpb_x + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_z +
                   (1.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_y);

        fints_xyyz[i] += fss * ((1.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_y + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_x +
                                (1.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_y * rpb_y + (3.0 / 16.0) * fe_0 * fe_0 * fe_0 * fe_0 +
                                rpa_z * rpa_y * rpa_y * rpa_x * rpb_z * rpb_y * rpb_y * rpb_x);

        fints_xyzz[i] +=
            fss * (fe_0 * rpa_z * rpa_y * rpa_x * rpb_z * rpb_z * rpb_x + (1.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpa_y * rpa_x * rpb_y * rpb_x +
        ...
        fints_xyzz[i] +=
            fss * ((1.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpa_x * rpb_x + (1.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpb_z * rpb_z +
        ...
        fints_xyzz[i] += fss * (fe_0 * fe_0 * rpa_y * rpa_x * rpb_z * rpb_x + (1.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_y +
                                (1.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpb_z * rpb_y * rpb_x + (1.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_y +
                                (1.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_y);

        fints_xyzz[i] += fss * ((1.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_z + (1.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_y +
        ...
        fints_xzzz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpb_z * rpb_x + (1.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpb_z * rpb_z * rpb_z +
                   (3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_x * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_z +
                   (3.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpb_z * rpb_z * rpb_x);

        fints_xzzz[i] += fss * ((3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_z + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_y +
                                (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_x + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_z +
                                (3.0 / 16.0) * fe_0 * fe_0 * fe_0 * fe_0);
        ...
        fints_yyyy[i] +=
            fss * (4.0 * fe_0 * rpa_z * rpa_y * rpa_x * rpb_y * rpb_y * rpb_y + 3.0 * fe_0 * rpa_z * rpa_y * rpa_y * rpa_x * rpb_y * rpb_y +
        ...
        fints_yyyy[i] += fss * ((9.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpb_y * rpb_y + (15.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_x +
                                rpa_z * rpa_y * rpa_y * rpa_x * rpb_y * rpb_y * rpb_y * rpb_y);

        fints_yyyz[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_y * rpa_x * rpb_z * rpb_y * rpb_y + (3.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpa_y * rpa_x * rpb_z * rpb_y +
        ...
        fints_yyyz[i] +=
            fss * ((9.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpb_z * rpb_y + (3.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpb_y * rpb_y +
        ...
        fints_yyzz[i] +=
            fss * (2.0 * fe_0 * rpa_z * rpa_y * rpa_x * rpb_z * rpb_z * rpb_y + (1.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpa_y * rpa_x * rpb_z * rpb_z +
        ...
        fints_yyzz[i] += fss * (fe_0 * fe_0 * rpa_z * rpa_y * rpa_x * rpb_y + (1.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpa_y * rpa_x +
                                (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpb_z * rpb_z +
                                (1.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpb_y * rpb_y + 2.0 * fe_0 * fe_0 * rpa_y * rpa_x * rpb_z * rpb_y);

        fints_yyzz[i] += fss * ((1.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_x * rpb_z +
        ...
        fints_yzzz[i] +=
            fss * (fe_0 * rpa_z * rpa_y * rpa_x * rpb_z * rpb_z * rpb_z + (3.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpa_y * rpa_x * rpb_z * rpb_y +
        ...
        fints_yzzz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpb_z * rpb_y + (3.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpb_z * rpb_z +
        ...
        fints_zzzz[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_y * rpa_y * rpa_x * rpb_z * rpb_z + (1.0 / 2.0) * fe_0 * rpa_z * rpa_x * rpb_z * rpb_z * rpb_z * rpb_z +
        ...
        fints_zzzz[i] += fss * (3.0 * fe_0 * fe_0 * rpa_y * rpa_y * rpa_x * rpb_z + fe_0 * fe_0 * rpa_x * rpb_z * rpb_z * rpb_z +
...
#pragma omp simd aligned(fints_xxxx,     \
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xxxx[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_z * rpa_y * rpa_x * rpb_x * rpb_x + 2.0 * fe_0 * rpa_z * rpa_z * rpa_y * rpb_x * rpb_x * rpb_x +
        ...
        fints_xxxx[i] += fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpb_x * rpb_x + fe_0 * fe_0 * rpa_y * rpb_x * rpb_x * rpb_x +
        ...
        fints_xxxy[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_x * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_x * rpb_x +
                   (3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpb_y * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpb_y * rpb_x * rpb_x +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpb_x * rpb_x * rpb_x);

        fints_xxxy[i] += fss * ((3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_z + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_y +
                                (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_x + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_x * rpb_x +
                                (3.0 / 16.0) * fe_0 * fe_0 * fe_0 * fe_0);
        ...
        fints_xxxz[i] +=
            fss * (fe_0 * rpa_z * rpa_y * rpa_x * rpb_x * rpb_x * rpb_x + (3.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_y * rpa_x * rpb_z * rpb_x +
        ...
        fints_xxxz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpb_x * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_y * rpb_z +
        ...
        fints_xxyy[i] +=
            fss * ((1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_y * rpa_x * rpb_y * rpb_y +
        ...
        fints_xxyy[i] +=
            fss * ((1.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_y * rpa_x + (1.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_y * rpb_x +
                   (1.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_x * rpb_y + fe_0 * fe_0 * rpa_z * rpa_z * rpb_y * rpb_x +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpb_y * rpb_y);

        fints_xxyy[i] +=
            fss * ((1.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpb_x * rpb_x + (1.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpb_y * rpb_y * rpb_x +
                   (1.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpb_y * rpb_x * rpb_x + (1.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_x +
                   (1.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_x);

        fints_xxyy[i] += fss * ((1.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_y + (1.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpb_y * rpb_x +
                                rpa_z * rpa_z * rpa_y * rpa_x * rpb_y * rpb_y * rpb_x * rpb_x);

        fints_xxyz[i] +=
            fss * (fe_0 * rpa_z * rpa_y * rpa_x * rpb_y * rpb_x * rpb_x + (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_y * rpa_x * rpb_z * rpb_y +
        ...
        fints_xxyz[i] +=
            fss * ((1.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpa_x * rpb_y + fe_0 * fe_0 * rpa_z * rpa_y * rpb_y * rpb_x +
        ...
        fints_xxyz[i] +=
            fss * ((1.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpb_z * rpb_y + (1.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpb_z * rpb_y * rpb_x +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpb_z * rpb_x * rpb_x + (1.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_x +
                   (1.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_x);

        fints_xxyz[i] += fss * ((1.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_z + (1.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_x +
                                rpa_z * rpa_z * rpa_y * rpa_x * rpb_z * rpb_y * rpb_x * rpb_x);

        fints_xxzz[i] +=
            fss * (2.0 * fe_0 * rpa_z * rpa_y * rpa_x * rpb_z * rpb_x * rpb_x + (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_y * rpa_x * rpb_z * rpb_z +
        ...
        fints_xxzz[i] +=
            fss * (fe_0 * fe_0 * rpa_z * rpa_y * rpa_x * rpb_z + 2.0 * fe_0 * fe_0 * rpa_z * rpa_y * rpb_z * rpb_x +
        ...
        fints_xxzz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpb_x * rpb_x +
        ...
        fints_xyyy[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_x * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_y * rpb_y +
        ...
        fints_xyyy[i] += fss * ((3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_z + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_y +
        ...
        fints_xyyz[i] +=
            fss * (fe_0 * rpa_z * rpa_y * rpa_x * rpb_y * rpb_y * rpb_x + (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_y * rpa_x * rpb_z * rpb_x +
        ...
        fints_xyyz[i] +=
            fss * ((1.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpa_x * rpb_x + (1.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpb_y * rpb_y +
                   fe_0 * fe_0 * rpa_z * rpa_x * rpb_y * rpb_x + (1.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_y * rpb_z +
                   (1.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_z * rpb_y);

        fints_xyyz[i] +=
            fss * ((1.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpb_z * rpb_x + (1.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpb_z * rpb_y * rpb_y +
                   (1.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpb_z * rpb_y * rpb_x + (1.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_y +
                   (1.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_y);

        fints_xyyz[i] += fss * ((1.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_z + (1.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_y +
        ...
        fints_xyzz[i] +=
            fss * (fe_0 * fe_0 * rpa_z * rpa_y * rpb_z * rpb_y + fe_0 * fe_0 * rpa_z * rpa_x * rpb_z * rpb_x +
        ...
        fints_xyzz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpb_y * rpb_x + (1.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpb_z * rpb_z * rpb_y +
        ...
        fints_xzzz[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_y * rpa_x * rpb_z * rpb_z * rpb_x + (3.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_y * rpa_x * rpb_z * rpb_x +
        ...
        fints_xzzz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpb_z * rpb_z + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_y * rpb_z +
        ...
        fints_yyyy[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_z * rpa_y * rpa_x * rpb_y * rpb_y + 2.0 * fe_0 * rpa_z * rpa_z * rpa_x * rpb_y * rpb_y * rpb_y +
        ...
        fints_yyyy[i] += fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpb_y * rpb_y + fe_0 * fe_0 * rpa_x * rpb_y * rpb_y * rpb_y +
                                (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_x + (3.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_y +
                                rpa_z * rpa_z * rpa_y * rpa_x * rpb_y * rpb_y * rpb_y * rpb_y);

        fints_yyyz[i] +=
            fss * (fe_0 * rpa_z * rpa_y * rpa_x * rpb_y * rpb_y * rpb_y + (3.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_y * rpa_x * rpb_z * rpb_y +
        ...
        fints_yyyz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpb_y * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_x * rpb_z +
        ...
        fints_yyzz[i] +=
            fss * (2.0 * fe_0 * rpa_z * rpa_y * rpa_x * rpb_z * rpb_y * rpb_y + (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_y * rpa_x * rpb_z * rpb_z +
        ...
        fints_yyzz[i] +=
            fss * (fe_0 * fe_0 * rpa_z * rpa_y * rpa_x * rpb_z + 2.0 * fe_0 * fe_0 * rpa_z * rpa_x * rpb_z * rpb_y +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_y * rpa_x + (1.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_x * rpb_y +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpb_z * rpb_z);

        fints_yyzz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpb_y * rpb_y +
        ...
        fints_yzzz[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_y * rpa_x * rpb_z * rpb_z * rpb_y + (3.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_y * rpa_x * rpb_z * rpb_y +
        ...
        fints_yzzz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpb_z * rpb_z + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_x * rpb_z +
        ...
        fints_zzzz[i] +=
            fss * (4.0 * fe_0 * rpa_z * rpa_y * rpa_x * rpb_z * rpb_z * rpb_z + 3.0 * fe_0 * rpa_z * rpa_z * rpa_y * rpa_x * rpb_z * rpb_z +
        ...
        fints_zzzz[i] += fss * ((9.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_x * rpb_z * rpb_z + (15.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_x +
...
#pragma omp simd aligned(fints_xxxx,     \
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xxxx[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_x * rpb_x * rpb_x * rpb_x * rpb_x + 3.0 * fe_0 * rpa_z * rpa_z * rpa_z * rpa_x * rpb_x * rpb_x +
        ...
        fints_xxxx[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpa_x + 3.0 * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_x +
        ...
        fints_xxxy[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_y + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_y +
        ...
        fints_xxxz[i] +=
            fss * ((9.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpb_z * rpb_x * rpb_x + (9.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_x * rpb_x +
                   (9.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_x * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_z +
                   (3.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpb_x * rpb_x * rpb_x);

        fints_xxxz[i] += fss * ((9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_z + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_z +
                                (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_x + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_x * rpb_x +
                                (9.0 / 16.0) * fe_0 * fe_0 * fe_0 * fe_0);

        fints_xxxz[i] += fss * rpa_z * rpa_z * rpa_z * rpa_x * rpb_z * rpb_x * rpb_x * rpb_x;

        fints_xxyy[i] += fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_x * rpb_y * rpb_y * rpb_x * rpb_x +
        ...
        fints_xxyy[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpb_x * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpb_y * rpb_y * rpb_x +
        ...
        fints_xxyz[i] += fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_x * rpb_z * rpb_y * rpb_x * rpb_x +
        ...
        fints_xxyz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpb_z * rpb_y * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_x * rpb_y +
        ...
        fints_xxzz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_x * rpb_z * rpb_z * rpb_x * rpb_x + 3.0 * fe_0 * rpa_z * rpa_z * rpa_x * rpb_z * rpb_x * rpb_x +
        ...
        fints_xxzz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpb_z * rpb_z + (9.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpb_x * rpb_x +
                   (3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpb_z * rpb_z * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_x * rpb_z +
                   3.0 * fe_0 * fe_0 * rpa_z * rpa_z * rpb_z * rpb_x);

        fints_xxzz[i] +=
            fss * ((1.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpa_x + (1.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_x +
                   (3.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpb_z * rpb_x * rpb_x + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_x +
                   (9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_x);

        fints_xxzz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_z + (3.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_x +
        ...
        fints_xyyy[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_y + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_y +
        ...
        fints_xyyz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpb_z * rpb_y * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_x * rpb_x +
                   (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_y * rpb_y + (1.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_z +
                   (3.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpb_y * rpb_y * rpb_x);

        fints_xyyz[i] += fss * ((3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_z + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_z +
                                (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_x + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_y * rpb_y +
                                (3.0 / 16.0) * fe_0 * fe_0 * fe_0 * fe_0);
        ...
        fints_xyzz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_x * rpb_z * rpb_z * rpb_y * rpb_x + 3.0 * fe_0 * rpa_z * rpa_z * rpa_x * rpb_z * rpb_y * rpb_x +
        ...
        fints_xyzz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpb_z * rpb_z * rpb_y + (3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_z * rpb_y +
        ...
        fints_xzzz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpb_z * rpb_z * rpb_z + (9.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_x * rpb_x +
        ...
        fints_xzzz[i] += fss * ((27.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_z + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_z +
        ...
        fints_yyyy[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_x * rpb_y * rpb_y * rpb_y * rpb_y + 3.0 * fe_0 * rpa_z * rpa_z * rpa_z * rpa_x * rpb_y * rpb_y +
        ...
        fints_yyyz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpb_y * rpb_y * rpb_y + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_y +
                                rpa_z * rpa_z * rpa_z * rpa_x * rpb_z * rpb_y * rpb_y * rpb_y);

        fints_yyzz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_x * rpb_z * rpb_z * rpb_y * rpb_y + 3.0 * fe_0 * rpa_z * rpa_z * rpa_x * rpb_z * rpb_y * rpb_y +
                   (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_z * rpa_x * rpb_z * rpb_z +
                   (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_z * rpa_x * rpb_y * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpb_z * rpb_z);

        fints_yyzz[i] +=
            fss * ((9.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_x * rpb_y * rpb_y + (3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_x * rpb_z +
        ...
        fints_yzzz[i] += fss * ((9.0 / 4.0) * fe_0 * fe_0 * rpa_x * rpb_z * rpb_z * rpb_y + (15.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_x * rpb_y +
                                rpa_z * rpa_z * rpa_z * rpa_x * rpb_z * rpb_z * rpb_z * rpb_y);

        fints_zzzz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_x * rpb_z * rpb_z * rpb_z * rpb_z + 6.0 * fe_0 * rpa_z * rpa_z * rpa_x * rpb_z * rpb_z * rpb_z +
        ...
        fints_zzzz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpa_x + 3.0 * fe_0 * fe_0 * rpa_x * rpb_z * rpb_z * rpb_z +
...
#pragma omp simd aligned(fints_xxxx,     \
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xxxx[i] +=
            fss * (3.0 * fe_0 * rpa_y * rpa_y * rpb_x * rpb_x * rpb_x * rpb_x + 3.0 * fe_0 * rpa_y * rpa_y * rpa_y * rpa_y * rpb_x * rpb_x +
                   9.0 * fe_0 * fe_0 * rpa_y * rpa_y * rpb_x * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpa_y +
                   (3.0 / 4.0) * fe_0 * fe_0 * rpb_x * rpb_x * rpb_x * rpb_x);

        fints_xxxx[i] += fss * ((9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_y + (9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpb_x * rpb_x +
                                (9.0 / 16.0) * fe_0 * fe_0 * fe_0 * fe_0 + rpa_y * rpa_y * rpa_y * rpa_y * rpb_x * rpb_x * rpb_x * rpb_x);

        fints_xxxy[i] +=
            fss * (3.0 * fe_0 * rpa_y * rpa_y * rpb_y * rpb_x * rpb_x * rpb_x + 2.0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_x * rpb_x * rpb_x +
        ...
        fints_xxxy[i] += fss * (3.0 * fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpb_y * rpb_x * rpb_x * rpb_x +
                                (9.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_x + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_y * rpb_x +
                                rpa_y * rpa_y * rpa_y * rpa_y * rpb_y * rpb_x * rpb_x * rpb_x);

        fints_xxxz[i] +=
            fss * (3.0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_x * rpb_x * rpb_x + (3.0 / 2.0) * fe_0 * rpa_y * rpa_y * rpa_y * rpa_y * rpb_z * rpb_x +
        ...
        fints_xxyy[i] +=
            fss * (3.0 * fe_0 * rpa_y * rpa_y * rpb_y * rpb_y * rpb_x * rpb_x + 4.0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_y * rpb_x * rpb_x +
        ...
        fints_xxyy[i] +=
            fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_y * rpb_y + (9.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_x * rpb_x +
                   2.0 * fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_y + (1.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpa_y +
                   (3.0 / 4.0) * fe_0 * fe_0 * rpb_y * rpb_y * rpb_x * rpb_x);

        fints_xxyy[i] += fss * (3.0 * fe_0 * fe_0 * fe_0 * rpa_y * rpb_y + (9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_y +
        ...
        fints_xxyz[i] +=
            fss * (3.0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_y * rpb_x * rpb_x + 2.0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_z * rpb_x * rpb_x +
        ...
        fints_xxyz[i] += fss * (fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_z + (3.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_y * rpb_x * rpb_x +
                                (3.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_z + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_y +
                                rpa_y * rpa_y * rpa_y * rpa_y * rpb_z * rpb_y * rpb_x * rpb_x);

        fints_xxzz[i] +=
            fss * (3.0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_z * rpb_x * rpb_x + (1.0 / 2.0) * fe_0 * rpa_y * rpa_y * rpa_y * rpa_y * rpb_z * rpb_z +
        ...
        fints_xxzz[i] += fss * ((1.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpa_y +
        ...
        fints_xyyy[i] +=
            fss * (3.0 * fe_0 * rpa_y * rpa_y * rpb_y * rpb_y * rpb_y * rpb_x + 6.0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_y * rpb_y * rpb_x +
        ...
        fints_xyyy[i] += fss * (3.0 * fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpb_y * rpb_y * rpb_y * rpb_x +
                                (15.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_x + (45.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_y * rpb_x +
                                rpa_y * rpa_y * rpa_y * rpa_y * rpb_y * rpb_y * rpb_y * rpb_x);

        fints_xyyz[i] +=
            fss * (3.0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_y * rpb_y * rpb_x + 4.0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_z * rpb_y * rpb_x +
        ...
        fints_xyyz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_y * rpb_y * rpb_x + (15.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_x +
                                rpa_y * rpa_y * rpa_y * rpa_y * rpb_z * rpb_y * rpb_y * rpb_x);

        fints_xyzz[i] +=
            fss * (3.0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_z * rpb_y * rpb_x + 2.0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_z * rpb_z * rpb_x +
        ...
        fints_xyzz[i] += fss * (fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_z * rpb_y * rpb_x +
                                (3.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_x + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_y * rpb_x +
                                rpa_y * rpa_y * rpa_y * rpa_y * rpb_z * rpb_z * rpb_y * rpb_x);

        fints_xzzz[i] +=
            fss * (3.0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_z * rpb_z * rpb_x + (3.0 / 2.0) * fe_0 * rpa_y * rpa_y * rpa_y * rpa_y * rpb_z * rpb_x +
        ...
        fints_yyyy[i] +=
            fss * (3.0 * fe_0 * rpa_y * rpa_y * rpb_y * rpb_y * rpb_y * rpb_y + 8.0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_y * rpb_y * rpb_y +
        ...
        fints_yyyy[i] += fss * (12.0 * fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpa_y +
                                (3.0 / 4.0) * fe_0 * fe_0 * rpb_y * rpb_y * rpb_y * rpb_y + 30.0 * fe_0 * fe_0 * fe_0 * rpa_y * rpb_y +
                                (45.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_y);

        fints_yyyy[i] += fss * ((45.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpb_y * rpb_y + (105.0 / 16.0) * fe_0 * fe_0 * fe_0 * fe_0 +
                                rpa_y * rpa_y * rpa_y * rpa_y * rpb_y * rpb_y * rpb_y * rpb_y);

        fints_yyyz[i] +=
            fss * (3.0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_y * rpb_y * rpb_y + 6.0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_z * rpb_y * rpb_y +
        ...
        fints_yyyz[i] += fss * (3.0 * fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_z + (3.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_y * rpb_y * rpb_y +
                                (15.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_z + (45.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_y +
                                rpa_y * rpa_y * rpa_y * rpa_y * rpb_z * rpb_y * rpb_y * rpb_y);

        fints_yyzz[i] +=
            fss * (3.0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_z * rpb_y * rpb_y + 4.0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_z * rpb_z * rpb_y +
        ...
        fints_yyzz[i] +=
            fss * ((9.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_z + (3.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_y * rpb_y +
                   2.0 * fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_y + (1.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpa_y +
                   (3.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_z * rpb_y * rpb_y);

        fints_yyzz[i] += fss * (3.0 * fe_0 * fe_0 * fe_0 * rpa_y * rpb_y + (9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_y +
        ...
        fints_yzzz[i] +=
            fss * (3.0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_z * rpb_z * rpb_y + 2.0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_z * rpb_z * rpb_z +
        ...
        fints_yzzz[i] += fss * (3.0 * fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_z + (3.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_z * rpb_z * rpb_y +
                                (9.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_z + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_y +
                                rpa_y * rpa_y * rpa_y * rpa_y * rpb_z * rpb_z * rpb_z * rpb_y);

        fints_zzzz[i] +=
            fss * (3.0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_z * rpb_z * rpb_z + 3.0 * fe_0 * rpa_y * rpa_y * rpa_y * rpa_y * rpb_z * rpb_z +
                   9.0 * fe_0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_z + (3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpa_y +
                   (3.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_z * rpb_z * rpb_z);

        fints_zzzz[i] += fss * ((9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_y + (9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_z +
...
#pragma omp simd aligned(fints_xxxx,     \
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xxxx[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpb_x * rpb_x * rpb_x * rpb_x + 3.0 * fe_0 * rpa_z * rpa_y * rpa_y * rpa_y * rpb_x * rpb_x +
        ...
        fints_xxxy[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpb_x * rpb_x * rpb_x + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_x +
        ...
        fints_xxxz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_x + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_x +
                                rpa_z * rpa_y * rpa_y * rpa_y * rpb_z * rpb_x * rpb_x * rpb_x);

        fints_xxyy[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpb_y * rpb_y * rpb_x * rpb_x + 3.0 * fe_0 * rpa_z * rpa_y * rpa_y * rpb_y * rpb_x * rpb_x +
        ...
        fints_xxyy[i] +=
            fss * ((9.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpb_x * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpa_y * rpb_y +
        ...
        fints_xxyz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpa_y * rpb_z + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpb_z * rpb_x * rpb_x +
        ...
        fints_xxyz[i] += fss * ((3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_z + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_y +
        ...
        fints_xxzz[i] += fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpb_z * rpb_z * rpb_x * rpb_x +
        ...
        fints_xxzz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpb_x * rpb_x + (1.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpa_y * rpa_y +
        ...
        fints_xyyy[i] += fss * ((9.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpb_y * rpb_y * rpb_x + (15.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_x +
                                rpa_z * rpa_y * rpa_y * rpa_y * rpb_y * rpb_y * rpb_y * rpb_x);

        fints_xyyz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpb_z * rpb_y * rpb_y * rpb_x + 3.0 * fe_0 * rpa_z * rpa_y * rpa_y * rpb_z * rpb_y * rpb_x +
        ...
        fints_xyyz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpb_z * rpb_y * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpb_y * rpb_y * rpb_x +
        ...
        fints_xyzz[i] += fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpb_z * rpb_z * rpb_y * rpb_x +
        ...
        fints_xyzz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpa_y * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpb_z * rpb_z * rpb_x +
        ...
        fints_xzzz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_x + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_x +
                                rpa_z * rpa_y * rpa_y * rpa_y * rpb_z * rpb_z * rpb_z * rpb_x);

        fints_yyyy[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpb_y * rpb_y * rpb_y * rpb_y + 6.0 * fe_0 * rpa_z * rpa_y * rpa_y * rpb_y * rpb_y * rpb_y +
        ...
        fints_yyyy[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpa_y * rpa_y + 3.0 * fe_0 * fe_0 * rpa_z * rpb_y * rpb_y * rpb_y +
        ...
        fints_yyyz[i] +=
            fss * ((9.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpa_y * rpb_z + (9.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpb_z * rpb_y * rpb_y +
        ...
        fints_yyyz[i] += fss * ((15.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_z + (27.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_y +
        ...
        fints_yyzz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpb_z * rpb_z * rpb_y * rpb_y + 3.0 * fe_0 * rpa_z * rpa_y * rpa_y * rpb_z * rpb_z * rpb_y +
                   (1.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpa_y * rpa_y * rpb_z * rpb_z +
                   (1.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpa_y * rpa_y * rpb_y * rpb_y + fe_0 * rpa_y * rpa_y * rpa_y * rpb_z * rpb_y * rpb_y);

        fints_yyzz[i] +=
            fss * ((9.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpb_z * rpb_z + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpb_y * rpb_y +
        ...
        fints_yyzz[i] += fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpb_z * rpb_y * rpb_y + 3.0 * fe_0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_y +
                                (1.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_z + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_y +
                                (3.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_y);

        fints_yyzz[i] += fss * ((9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_z + (3.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_y +
        ...
        fints_yzzz[i] +=
            fss * ((9.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpa_y * rpb_z + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpb_z * rpb_z * rpb_z +
                   (9.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpb_z * rpb_z * rpb_y + (9.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_z +
                   (3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_y);

        fints_yzzz[i] += fss * ((9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_z + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_y +
        ...
        fints_zzzz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpb_z * rpb_z * rpb_z * rpb_z + 3.0 * fe_0 * rpa_z * rpa_y * rpa_y * rpa_y * rpb_z * rpb_z +
        ...
        fints_zzzz[i] += fss * (3.0 * fe_0 * fe_0 * rpa_y * rpb_z * rpb_z * rpb_z + 3.0 * fe_0 * fe_0 * rpa_y * rpa_y * rpa_y * rpb_z +
...
#pragma omp simd aligned(fints_xxxx,     \
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xxxx[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_z * rpa_y * rpa_y * rpb_x * rpb_x + (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpb_x * rpb_x * rpb_x * rpb_x +
        ...
        fints_xxxx[i] += fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_x * rpb_x +
        ...
        fints_xxxy[i] +=
            fss * (fe_0 * rpa_z * rpa_z * rpa_y * rpb_x * rpb_x * rpb_x + (3.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_y * rpa_y * rpb_y * rpb_x +
                   (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpb_y * rpb_x * rpb_x * rpb_x +
                   (1.0 / 2.0) * fe_0 * rpa_y * rpa_y * rpb_y * rpb_x * rpb_x * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_y * rpb_x);

        fints_xxxy[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_y * rpb_x + (1.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpb_x * rpb_x * rpb_x +
        ...
        fints_xxxz[i] +=
            fss * (fe_0 * rpa_z * rpa_y * rpa_y * rpb_x * rpb_x * rpb_x + (3.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_y * rpa_y * rpb_z * rpb_x +
                   (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpb_z * rpb_x * rpb_x * rpb_x +
                   (1.0 / 2.0) * fe_0 * rpa_y * rpa_y * rpb_z * rpb_x * rpb_x * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpa_y * rpb_x);

        fints_xxxz[i] +=
            fss * ((1.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpb_x * rpb_x * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_z * rpb_x +
        ...
        fints_xxyy[i] += fss * (fe_0 * fe_0 * rpa_z * rpa_z * rpa_y * rpb_y + (1.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_y * rpa_y +
                                (1.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_y * rpb_y +
                                (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_x * rpb_x + fe_0 * fe_0 * rpa_y * rpb_y * rpb_x * rpb_x);

        fints_xxyy[i] +=
            fss * ((1.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_y * rpb_y + (1.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_x * rpb_x +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpb_y * rpb_y * rpb_x * rpb_x + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_z +
                   (1.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_y);

        fints_xxyy[i] += fss * ((1.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_y + (1.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_y * rpb_y +
                                (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_x * rpb_x + (3.0 / 16.0) * fe_0 * fe_0 * fe_0 * fe_0 +
                                rpa_z * rpa_z * rpa_y * rpa_y * rpb_y * rpb_y * rpb_x * rpb_x);

        fints_xxyz[i] += fss * (fe_0 * rpa_z * rpa_y * rpa_y * rpb_y * rpb_x * rpb_x + fe_0 * rpa_z * rpa_z * rpa_y * rpb_z * rpb_x * rpb_x +
                                (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_y * rpa_y * rpb_z * rpb_y +
                                (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpb_z * rpb_y * rpb_x * rpb_x +
                                (1.0 / 2.0) * fe_0 * rpa_y * rpa_y * rpb_z * rpb_y * rpb_x * rpb_x);

        fints_xxyz[i] +=
            fss * (fe_0 * fe_0 * rpa_z * rpa_y * rpb_x * rpb_x + (1.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpa_y * rpb_y +
        ...
        fints_xxyz[i] +=
            fss * ((1.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpb_z * rpb_x * rpb_x + (1.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_y +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_y * rpb_x * rpb_x + (1.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_y +
                   (1.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_y);

        fints_xxyz[i] += fss * ((1.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_z + (1.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_y +
        ...
        fints_xxzz[i] +=
            fss * (fe_0 * fe_0 * rpa_z * rpa_y * rpa_y * rpb_z + fe_0 * fe_0 * rpa_z * rpb_z * rpb_x * rpb_x +
        ...
        fints_xxzz[i] +=
            fss * ((1.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_z + (3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_x * rpb_x +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_z * rpb_x * rpb_x + (1.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_z +
                   (1.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_z);

        fints_xxzz[i] += fss * ((3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_y + (1.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_z +
                                (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_x * rpb_x + (3.0 / 16.0) * fe_0 * fe_0 * fe_0 * fe_0 +
                                rpa_z * rpa_z * rpa_y * rpa_y * rpb_z * rpb_z * rpb_x * rpb_x);

        fints_xyyy[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_z * rpa_y * rpb_y * rpb_y * rpb_x + (3.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_y * rpa_y * rpb_y * rpb_x +
                   (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpb_y * rpb_y * rpb_y * rpb_x +
                   (1.0 / 2.0) * fe_0 * rpa_y * rpa_y * rpb_y * rpb_y * rpb_y * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_y * rpb_x);

        fints_xyyy[i] +=
            fss * ((9.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_y * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpb_y * rpb_y * rpb_x +
        ...
        fints_xyyz[i] += fss * (fe_0 * rpa_z * rpa_y * rpa_y * rpb_y * rpb_y * rpb_x + 2.0 * fe_0 * rpa_z * rpa_z * rpa_y * rpb_z * rpb_y * rpb_x +
                                (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_y * rpa_y * rpb_z * rpb_x +
                                (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpb_z * rpb_y * rpb_y * rpb_x +
                                (1.0 / 2.0) * fe_0 * rpa_y * rpa_y * rpb_z * rpb_y * rpb_y * rpb_x);

        fints_xyyz[i] += fss * (2.0 * fe_0 * fe_0 * rpa_z * rpa_y * rpb_y * rpb_x + (1.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpa_y * rpb_x +
                                (1.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpb_y * rpb_y * rpb_x +
                                (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_z * rpb_x + fe_0 * fe_0 * rpa_y * rpb_z * rpb_y * rpb_x);

        fints_xyyz[i] += fss * ((1.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_x +
        ...
        fints_xyzz[i] += fss * (2.0 * fe_0 * rpa_z * rpa_y * rpa_y * rpb_z * rpb_y * rpb_x + fe_0 * rpa_z * rpa_z * rpa_y * rpb_z * rpb_z * rpb_x +
                                (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_y * rpa_y * rpb_y * rpb_x +
                                (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpb_z * rpb_z * rpb_y * rpb_x +
                                (1.0 / 2.0) * fe_0 * rpa_y * rpa_y * rpb_z * rpb_z * rpb_y * rpb_x);

        fints_xyzz[i] +=
            fss * (2.0 * fe_0 * fe_0 * rpa_z * rpa_y * rpb_z * rpb_x + fe_0 * fe_0 * rpa_z * rpb_z * rpb_y * rpb_x +
        ...
        fints_xyzz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_y * rpb_x +
        ...
        fints_xzzz[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_y * rpa_y * rpb_z * rpb_z * rpb_x + (3.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_y * rpa_y * rpb_z * rpb_x +
                   (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpb_z * rpb_z * rpb_z * rpb_x +
                   (1.0 / 2.0) * fe_0 * rpa_y * rpa_y * rpb_z * rpb_z * rpb_z * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpa_y * rpb_x);

        fints_xzzz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpb_z * rpb_z * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_z * rpb_x +
        ...
        fints_yyyy[i] +=
            fss * (4.0 * fe_0 * rpa_z * rpa_z * rpa_y * rpb_y * rpb_y * rpb_y + 3.0 * fe_0 * rpa_z * rpa_z * rpa_y * rpa_y * rpb_y * rpb_y +
        ...
        fints_yyyy[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_y * rpa_y + (9.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_y * rpb_y +
                   2.0 * fe_0 * fe_0 * rpa_y * rpb_y * rpb_y * rpb_y + (3.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_y * rpb_y +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpb_y * rpb_y * rpb_y * rpb_y);

        fints_yyyy[i] += fss * ((15.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_z + 3.0 * fe_0 * fe_0 * fe_0 * rpa_y * rpb_y +
        ...
        fints_yyyz[i] += fss * (fe_0 * rpa_z * rpa_y * rpa_y * rpb_y * rpb_y * rpb_y + 3.0 * fe_0 * rpa_z * rpa_z * rpa_y * rpb_z * rpb_y * rpb_y +
                                (3.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_y * rpa_y * rpb_z * rpb_y +
                                (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpb_z * rpb_y * rpb_y * rpb_y +
                                (1.0 / 2.0) * fe_0 * rpa_y * rpa_y * rpb_z * rpb_y * rpb_y * rpb_y);

        fints_yyyz[i] +=
            fss * (3.0 * fe_0 * fe_0 * rpa_z * rpa_y * rpb_y * rpb_y + (3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpa_y * rpb_y +
        ...
        fints_yyyz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_z + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_y +
        ...
        fints_yyzz[i] += fss * ((1.0 / 2.0) * fe_0 * rpa_y * rpa_y * rpb_z * rpb_z * rpb_y * rpb_y +
        ...
        fints_yyzz[i] +=
            fss * ((1.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_y * rpa_y + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_z * rpb_z +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_y * rpb_y + fe_0 * fe_0 * rpa_y * rpb_z * rpb_z * rpb_y +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_z);

        fints_yyzz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_y * rpb_y +
        ...
        fints_yyzz[i] += fss * ((3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpa_y + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_z +
                                (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_y * rpb_y + (9.0 / 16.0) * fe_0 * fe_0 * fe_0 * fe_0 +
                                rpa_z * rpa_z * rpa_y * rpa_y * rpb_z * rpb_z * rpb_y * rpb_y);

        fints_yzzz[i] += fss * (3.0 * fe_0 * rpa_z * rpa_y * rpa_y * rpb_z * rpb_z * rpb_y + fe_0 * rpa_z * rpa_z * rpa_y * rpb_z * rpb_z * rpb_z +
                                (3.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_y * rpa_y * rpb_z * rpb_y +
                                (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpb_z * rpb_z * rpb_z * rpb_y +
                                (1.0 / 2.0) * fe_0 * rpa_y * rpa_y * rpb_z * rpb_z * rpb_z * rpb_y);

        fints_yzzz[i] +=
            fss * (3.0 * fe_0 * fe_0 * rpa_z * rpa_y * rpb_z * rpb_z + (3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpa_y * rpb_y +
        ...
        fints_yzzz[i] +=
            fss * ((1.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpb_z * rpb_z * rpb_z + (9.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpa_y * rpb_z * rpb_y +
                   (1.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_z * rpb_z * rpb_y + (3.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_y +
                   (3.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_y);

        fints_yzzz[i] += fss * ((9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_z + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_y +
                                rpa_z * rpa_z * rpa_y * rpa_y * rpb_z * rpb_z * rpb_z * rpb_y);

        fints_zzzz[i] +=
            fss * (4.0 * fe_0 * rpa_z * rpa_y * rpa_y * rpb_z * rpb_z * rpb_z + 3.0 * fe_0 * rpa_z * rpa_z * rpa_y * rpa_y * rpb_z * rpb_z +
                   (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpb_z * rpb_z * rpb_z * rpb_z +
                   (1.0 / 2.0) * fe_0 * rpa_y * rpa_y * rpb_z * rpb_z * rpb_z * rpb_z + 6.0 * fe_0 * fe_0 * rpa_z * rpa_y * rpa_y * rpb_z);

        fints_zzzz[i] +=
            fss * (2.0 * fe_0 * fe_0 * rpa_z * rpb_z * rpb_z * rpb_z + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_y * rpa_y +
...
#pragma omp simd aligned(fints_xxxx,     \
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xxxx[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpb_x * rpb_x * rpb_x * rpb_x + 3.0 * fe_0 * rpa_z * rpa_z * rpa_z * rpa_y * rpb_x * rpb_x +
        ...
        fints_xxxy[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_x + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_x +
        ...
        fints_xxxz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpb_x * rpb_x * rpb_x + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_x +
                                rpa_z * rpa_z * rpa_z * rpa_y * rpb_z * rpb_x * rpb_x * rpb_x);

        fints_xxyy[i] += fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpb_y * rpb_y * rpb_x * rpb_x +
        ...
        fints_xxyy[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpb_x * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpb_y * rpb_x * rpb_x +
        ...
        fints_xxyz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpb_z * rpb_x * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_y * rpb_y +
        ...
        fints_xxyz[i] += fss * ((3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_z + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_z +
        ...
        fints_xxzz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpb_z * rpb_z * rpb_x * rpb_x + 3.0 * fe_0 * rpa_z * rpa_z * rpa_y * rpb_z * rpb_x * rpb_x +
        ...
        fints_xxzz[i] +=
            fss * ((9.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpb_x * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_y * rpb_z +
        ...
        fints_xyyy[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_x + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_x +
                                rpa_z * rpa_z * rpa_z * rpa_y * rpb_y * rpb_y * rpb_y * rpb_x);

        fints_xyyz[i] += fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpb_z * rpb_y * rpb_y * rpb_x +
        ...
        fints_xyyz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpb_z * rpb_y * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_y * rpb_x +
        ...
        fints_xyzz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpb_z * rpb_z * rpb_y * rpb_x + 3.0 * fe_0 * rpa_z * rpa_z * rpa_y * rpb_z * rpb_y * rpb_x +
        ...
        fints_xyzz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpb_z * rpb_z * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_z * rpb_x +
        ...
        fints_xzzz[i] += fss * ((9.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpb_z * rpb_z * rpb_x + (15.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_x +
                                rpa_z * rpa_z * rpa_z * rpa_y * rpb_z * rpb_z * rpb_z * rpb_x);

        fints_yyyy[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpb_y * rpb_y * rpb_y * rpb_y + 3.0 * fe_0 * rpa_z * rpa_z * rpa_z * rpa_y * rpb_y * rpb_y +
        ...
        fints_yyyy[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpa_y + 3.0 * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_y +
        ...
        fints_yyyz[i] +=
            fss * ((9.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpb_z * rpb_y * rpb_y + (9.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_y * rpb_y +
        ...
        fints_yyyz[i] += fss * ((9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_z + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_z +
        ...
        fints_yyzz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpb_z * rpb_z * rpb_y * rpb_y + 3.0 * fe_0 * rpa_z * rpa_z * rpa_y * rpb_z * rpb_y * rpb_y +
                   (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_z * rpa_y * rpb_z * rpb_z +
                   (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_z * rpa_y * rpb_y * rpb_y + fe_0 * rpa_z * rpa_z * rpa_z * rpb_z * rpb_z * rpb_y);

        fints_yyzz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpb_z * rpb_z + (9.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_y * rpb_y * rpb_y +
                   (3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpb_z * rpb_z * rpb_y + (3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_y * rpb_z +
                   3.0 * fe_0 * fe_0 * rpa_z * rpa_z * rpb_z * rpb_y);

        fints_yyzz[i] +=
            fss * ((1.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpa_y + (1.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_y +
                   (3.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpb_z * rpb_y * rpb_y + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_y +
                   (9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_y);

        fints_yyzz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_y * rpb_z + (3.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_y +
        ...
        fints_yzzz[i] +=
            fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpb_z * rpb_z * rpb_z + (9.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_y * rpb_y +
                   (9.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_z * rpb_z + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_z +
                   (9.0 / 4.0) * fe_0 * fe_0 * rpa_y * rpb_z * rpb_z * rpb_y);

        fints_yzzz[i] += fss * ((27.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_z + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_z +
        ...
        fints_zzzz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * rpa_z * rpa_y * rpb_z * rpb_z * rpb_z * rpb_z + 6.0 * fe_0 * rpa_z * rpa_z * rpa_y * rpb_z * rpb_z * rpb_z +
        ...
        fints_zzzz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpa_y + 3.0 * fe_0 * fe_0 * rpa_y * rpb_z * rpb_z * rpb_z +
...
#pragma omp simd aligned(fints_xxxx,     \
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xxxx[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_z * rpb_x * rpb_x * rpb_x * rpb_x + 3.0 * fe_0 * rpa_z * rpa_z * rpa_z * rpa_z * rpb_x * rpb_x +
                   9.0 * fe_0 * fe_0 * rpa_z * rpa_z * rpb_x * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpa_z +
                   (3.0 / 4.0) * fe_0 * fe_0 * rpb_x * rpb_x * rpb_x * rpb_x);

        fints_xxxx[i] += fss * ((9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_z + (9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpb_x * rpb_x +
                                (9.0 / 16.0) * fe_0 * fe_0 * fe_0 * fe_0 + rpa_z * rpa_z * rpa_z * rpa_z * rpb_x * rpb_x * rpb_x * rpb_x);

        fints_xxxy[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_z * rpb_y * rpb_x * rpb_x * rpb_x + (3.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_z * rpa_z * rpb_y * rpb_x +
        ...
        fints_xxxz[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_z * rpb_z * rpb_x * rpb_x * rpb_x + 2.0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_x * rpb_x * rpb_x +
        ...
        fints_xxxz[i] += fss * (3.0 * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_x * rpb_x * rpb_x +
                                (9.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_x + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_x +
                                rpa_z * rpa_z * rpa_z * rpa_z * rpb_z * rpb_x * rpb_x * rpb_x);

        fints_xxyy[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_z * rpb_y * rpb_y * rpb_x * rpb_x + (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_z * rpa_z * rpb_y * rpb_y +
                   (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_z * rpa_z * rpb_x * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_y * rpb_y +
                   (3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_x * rpb_x);

        fints_xxyy[i] += fss * ((1.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpa_z +
        ...
        fints_xxyz[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_z * rpb_z * rpb_y * rpb_x * rpb_x + 2.0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_y * rpb_x * rpb_x +
        ...
        fints_xxyz[i] += fss * (fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_y * rpb_x * rpb_x +
                                (3.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_y + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_y +
                                rpa_z * rpa_z * rpa_z * rpa_z * rpb_z * rpb_y * rpb_x * rpb_x);

        fints_xxzz[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_z * rpb_z * rpb_z * rpb_x * rpb_x + 4.0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_z * rpb_x * rpb_x +
        ...
        fints_xxzz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_z * rpb_z + (9.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_x * rpb_x +
                   2.0 * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_z + (1.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpa_z +
                   (3.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_z * rpb_x * rpb_x);

        fints_xxzz[i] += fss * (3.0 * fe_0 * fe_0 * fe_0 * rpa_z * rpb_z + (9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_z +
        ...
        fints_xyyy[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_z * rpb_y * rpb_y * rpb_y * rpb_x + (3.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_z * rpa_z * rpb_y * rpb_x +
        ...
        fints_xyyz[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_z * rpb_z * rpb_y * rpb_y * rpb_x + 2.0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_y * rpb_y * rpb_x +
        ...
        fints_xyyz[i] += fss * (fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_y * rpb_y * rpb_x +
                                (3.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_x + (3.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_x +
                                rpa_z * rpa_z * rpa_z * rpa_z * rpb_z * rpb_y * rpb_y * rpb_x);

        fints_xyzz[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_z * rpb_z * rpb_z * rpb_y * rpb_x + 4.0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_z * rpb_y * rpb_x +
        ...
        fints_xyzz[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_z * rpb_y * rpb_x + (15.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_y * rpb_x +
                                rpa_z * rpa_z * rpa_z * rpa_z * rpb_z * rpb_z * rpb_y * rpb_x);

        fints_xzzz[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_z * rpb_z * rpb_z * rpb_z * rpb_x + 6.0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_z * rpb_z * rpb_x +
        ...
        fints_xzzz[i] += fss * (3.0 * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_x + (3.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_z * rpb_z * rpb_x +
                                (15.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_x + (45.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_x +
                                rpa_z * rpa_z * rpa_z * rpa_z * rpb_z * rpb_z * rpb_z * rpb_x);

        fints_yyyy[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_z * rpb_y * rpb_y * rpb_y * rpb_y + 3.0 * fe_0 * rpa_z * rpa_z * rpa_z * rpa_z * rpb_y * rpb_y +
                   9.0 * fe_0 * fe_0 * rpa_z * rpa_z * rpb_y * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpa_z +
                   (3.0 / 4.0) * fe_0 * fe_0 * rpb_y * rpb_y * rpb_y * rpb_y);

        fints_yyyy[i] += fss * ((9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_z + (9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpb_y * rpb_y +
                                (9.0 / 16.0) * fe_0 * fe_0 * fe_0 * fe_0 + rpa_z * rpa_z * rpa_z * rpa_z * rpb_y * rpb_y * rpb_y * rpb_y);

        fints_yyyz[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_z * rpb_z * rpb_y * rpb_y * rpb_y + 2.0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_y * rpb_y * rpb_y +
        ...
        fints_yyyz[i] += fss * (3.0 * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_y * rpb_y * rpb_y +
                                (9.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_y + (9.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_y +
                                rpa_z * rpa_z * rpa_z * rpa_z * rpb_z * rpb_y * rpb_y * rpb_y);

        fints_yyzz[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_z * rpb_z * rpb_z * rpb_y * rpb_y + 4.0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_z * rpb_y * rpb_y +
                   (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_z * rpa_z * rpb_z * rpb_z +
                   (1.0 / 2.0) * fe_0 * rpa_z * rpa_z * rpa_z * rpa_z * rpb_y * rpb_y + 6.0 * fe_0 * fe_0 * rpa_z * rpb_z * rpb_y * rpb_y);

        fints_yyzz[i] +=
            fss * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_z * rpb_z + (9.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpb_y * rpb_y +
                   2.0 * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_z + (1.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpa_z +
                   (3.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_z * rpb_y * rpb_y);

        fints_yyzz[i] += fss * (3.0 * fe_0 * fe_0 * fe_0 * rpa_z * rpb_z + (9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_z +
        ...
        fints_yzzz[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_z * rpb_z * rpb_z * rpb_z * rpb_y + 6.0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_z * rpb_z * rpb_y +
        ...
        fints_yzzz[i] += fss * (3.0 * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_z * rpb_z * rpb_y +
                                (15.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpb_y + (45.0 / 8.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_y +
                                rpa_z * rpa_z * rpa_z * rpa_z * rpb_z * rpb_z * rpb_z * rpb_y);

        fints_zzzz[i] +=
            fss * (3.0 * fe_0 * rpa_z * rpa_z * rpb_z * rpb_z * rpb_z * rpb_z + 8.0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_z * rpb_z * rpb_z +
        ...
        fints_zzzz[i] += fss * (12.0 * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpb_z + (3.0 / 4.0) * fe_0 * fe_0 * rpa_z * rpa_z * rpa_z * rpa_z +
                                (3.0 / 4.0) * fe_0 * fe_0 * rpb_z * rpb_z * rpb_z * rpb_z + 30.0 * fe_0 * fe_0 * fe_0 * rpa_z * rpb_z +
                                (45.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_z * rpa_z);

        fints_zzzz[i] += fss * ((45.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpb_z * rpb_z + (105.0 / 16.0) * fe_0 * fe_0 * fe_0 * fe_0 +
