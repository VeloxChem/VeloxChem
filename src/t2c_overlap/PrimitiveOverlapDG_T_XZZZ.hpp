#ifndef PrimitiveOverlapDG_T_XZZZ
#define PrimitiveOverlapDG_T_XZZZ
...
*/
auto compPrimitiveOverlapDG_T_XZZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapDG_T_XZZZ */
