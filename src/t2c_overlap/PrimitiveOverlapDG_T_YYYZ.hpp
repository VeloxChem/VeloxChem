#ifndef PrimitiveOverlapDG_T_YYYZ
#define PrimitiveOverlapDG_T_YYYZ
...
*/
auto compPrimitiveOverlapDG_T_YYYZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapDG_T_YYYZ */
