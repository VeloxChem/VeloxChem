#ifndef PrimitiveOverlapGF_YYZZ_T
#define PrimitiveOverlapGF_YYZZ_T
...
*/
auto compPrimitiveOverlapGF_YYZZ_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGF_YYZZ_T */
