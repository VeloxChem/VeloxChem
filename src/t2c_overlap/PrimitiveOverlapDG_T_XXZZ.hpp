#ifndef PrimitiveOverlapDG_T_XXZZ
#define PrimitiveOverlapDG_T_XXZZ
...
*/
auto compPrimitiveOverlapDG_T_XXZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapDG_T_XXZZ */
