#ifndef OverlapPrimRecFS
#define OverlapPrimRecFS

#include "SimdArray.hpp"

namespace ovlrec {  // ovlrec namespace

/// @brief Computes primitive [F|S]  integrals for set of data buffers.
...
auto comp_prim_overlap_fs(CSimdArray<double>&       pbuffer,
