#ifndef PrimitiveOverlapGF_YYYY_T
#define PrimitiveOverlapGF_YYYY_T
...
*/
auto compPrimitiveOverlapGF_YYYY_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGF_YYYY_T */
