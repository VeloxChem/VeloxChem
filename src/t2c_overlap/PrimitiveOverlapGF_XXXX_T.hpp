#ifndef PrimitiveOverlapGF_XXXX_T
#define PrimitiveOverlapGF_XXXX_T
...
*/
auto compPrimitiveOverlapGF_XXXX_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGF_XXXX_T */
