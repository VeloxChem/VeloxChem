#ifndef PrimitiveOverlapDG_T_YYZZ
#define PrimitiveOverlapDG_T_YYZZ
...
*/
auto compPrimitiveOverlapDG_T_YYZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapDG_T_YYZZ */
