#ifndef OverlapRecIG_hpp
#define OverlapRecIG_hpp
...
/// @brief Computes (I|G)  integrals for pair of basis functions blocks.
                ...
                const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(2100, ket_npgtos);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                ovlrec::comp_prim_overlap_gf(pbuffer, 780, 200, 380, 440, factors, 8, a_exp);

                ovlrec::comp_prim_overlap_gg(pbuffer, 930, 260, 440, 540, factors, 8, a_exp);

                ovlrec::comp_prim_overlap_hf(pbuffer, 1155, 440, 690, 780, factors, 8, a_exp);

                ovlrec::comp_prim_overlap_hg(pbuffer, 1365, 540, 780, 930, factors, 8, a_exp);

                ovlrec::comp_prim_overlap_ig(pbuffer, 1680, 930, 1155, 1365, factors, 8, a_exp);
