#ifndef PrimitiveOverlapGF_XXZZ_T
#define PrimitiveOverlapGF_XXZZ_T
...
*/
auto compPrimitiveOverlapGF_XXZZ_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGF_XXZZ_T */
