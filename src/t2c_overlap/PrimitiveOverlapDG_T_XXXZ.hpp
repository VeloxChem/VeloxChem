#ifndef PrimitiveOverlapDG_T_XXXZ
#define PrimitiveOverlapDG_T_XXXZ
...
*/
auto compPrimitiveOverlapDG_T_XXXZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapDG_T_XXXZ */
