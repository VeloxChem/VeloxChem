...
#include "PrimitiveOverlapFG_T_XXYY.hpp"
#include "PrimitiveOverlapFG_T_XXYZ.hpp"
#include "PrimitiveOverlapFG_T_XXZZ.hpp"
...
#include "PrimitiveOverlapFG_T_YYYZ.hpp"
#include "PrimitiveOverlapFG_T_YYZZ.hpp"
#include "PrimitiveOverlapFG_T_YZZZ.hpp"
#include "PrimitiveOverlapFG_T_ZZZZ.hpp"
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapFG_T_XXXX(buffer_xxx,
                                                          buffer_xxy,
                                                          buffer_xxz,
                                                          buffer_xyy,
                                                          buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapFG_T_XXXY(buffer_xxx,
                                                          buffer_xxy,
                                                          buffer_xxz,
                                                          buffer_xyy,
                                                          buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapFG_T_XXXZ(buffer_xxx,
                                                          buffer_xxy,
                                                          buffer_xxz,
                                                          buffer_xyy,
                                                          buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapFG_T_XXYY(buffer_xxx,
                                                          buffer_xxy,
                                                          buffer_xxz,
                                                          buffer_xyy,
                                                          buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapFG_T_XXYZ(buffer_xxx,
                                                          buffer_xxy,
                                                          buffer_xxz,
                                                          buffer_xyy,
                                                          buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapFG_T_XXZZ(buffer_xxx,
                                                          buffer_xxy,
                                                          buffer_xxz,
                                                          buffer_xyy,
                                                          buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapFG_T_XYYY(buffer_xxx,
                                                          buffer_xxy,
                                                          buffer_xxz,
                                                          buffer_xyy,
                                                          buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapFG_T_XYYZ(buffer_xxx,
                                                          buffer_xxy,
                                                          buffer_xxz,
                                                          buffer_xyy,
                                                          buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapFG_T_XYZZ(buffer_xxx,
                                                          buffer_xxy,
                                                          buffer_xxz,
                                                          buffer_xyy,
                                                          buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapFG_T_XZZZ(buffer_xxx,
                                                          buffer_xxy,
                                                          buffer_xxz,
                                                          buffer_xyy,
                                                          buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapFG_T_YYYY(buffer_xxx,
                                                          buffer_xxy,
                                                          buffer_xxz,
                                                          buffer_xyy,
                                                          buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapFG_T_YYYZ(buffer_xxx,
                                                          buffer_xxy,
                                                          buffer_xxz,
                                                          buffer_xyy,
                                                          buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapFG_T_YYZZ(buffer_xxx,
                                                          buffer_xxy,
                                                          buffer_xxz,
                                                          buffer_xyy,
                                                          buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapFG_T_YZZZ(buffer_xxx,
                                                          buffer_xxy,
                                                          buffer_xxz,
                                                          buffer_xyy,
                                                          buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapFG_T_ZZZZ(buffer_xxx,
                                                          buffer_xxy,
                                                          buffer_xxz,
                                                          buffer_xyy,
                                                          buffer_xyz,
