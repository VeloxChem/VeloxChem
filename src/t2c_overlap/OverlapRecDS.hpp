#ifndef OverlapRecDS_hpp
#define OverlapRecDS_hpp
...
*/
auto compOverlapDS(CSubMatrix*      matrix,
...
/**
 Evaluates block of primitive <D||S> integrals.
...
*/
auto compPrimitiveOverlapDS(TDoubleArray&       buffer_xx,
