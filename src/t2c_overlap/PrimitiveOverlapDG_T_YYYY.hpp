#ifndef PrimitiveOverlapDG_T_YYYY
#define PrimitiveOverlapDG_T_YYYY
...
*/
auto compPrimitiveOverlapDG_T_YYYY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapDG_T_YYYY */
