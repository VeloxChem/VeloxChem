#ifndef ThreeCenterOverlapSumRecPS_hpp
#define ThreeCenterOverlapSumRecPS_hpp
...
/// @brief Computes (P|G(r)|S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_ps(T& distributor,
...
#endif /* ThreeCenterOverlapSumRecPS_hpp */
