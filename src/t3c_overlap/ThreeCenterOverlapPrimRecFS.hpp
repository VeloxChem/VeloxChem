#ifndef ThreeCenterOverlapPrimRecFS
#define ThreeCenterOverlapPrimRecFS

#include "SimdArray.hpp"

namespace t3ovlrec { // t3ovlrec namespace

/// @brief Computes primitive [F|G(r)|S]  integrals for set of data buffers.
...
#endif /* ThreeCenterOverlapPrimRecFS */
