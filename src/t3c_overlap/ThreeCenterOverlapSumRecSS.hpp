#ifndef ThreeCenterOverlapSumRecSS_hpp
#define ThreeCenterOverlapSumRecSS_hpp
...
/// @brief Computes (S|G(r)|S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_ss(T& distributor,
...
#endif /* ThreeCenterOverlapSumRecSS_hpp */
