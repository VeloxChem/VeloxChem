#ifndef ThreeCenterOverlapSumRecDG_hpp
#define ThreeCenterOverlapSumRecDG_hpp
...
/// @brief Computes (D|G(r)|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_dg(T& distributor,
                    ...
                    const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(201, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t2cfunc::reduce(cbuffer, pbuffer, 111, ket_width, ket_npgtos);
                }
            }
...
#endif /* ThreeCenterOverlapSumRecDG_hpp */
