#ifndef ThreeCenterOverlapSumRecDS_hpp
#define ThreeCenterOverlapSumRecDS_hpp
...
/// @brief Computes (D|G(r)|S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_ds(T& distributor,
...
#endif /* ThreeCenterOverlapSumRecDS_hpp */
