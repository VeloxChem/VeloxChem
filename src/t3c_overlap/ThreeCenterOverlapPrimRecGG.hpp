#ifndef ThreeCenterOverlapPrimRecGG
#define ThreeCenterOverlapPrimRecGG

#include "SimdArray.hpp"

namespace t3ovlrec { // t3ovlrec namespace

/// @brief Computes primitive [G|G(r)|G]  integrals for set of data buffers.
...
#endif /* ThreeCenterOverlapPrimRecGG */
