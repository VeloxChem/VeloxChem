#ifndef ThreeCenterOverlapPrimRecPH
#define ThreeCenterOverlapPrimRecPH

#include "SimdArray.hpp"

namespace t3ovlrec { // t3ovlrec namespace

/// @brief Computes primitive [P|G(r)|H]  integrals for set of data buffers.
...
#endif /* ThreeCenterOverlapPrimRecPH */
