#ifndef ThreeCenterOverlapPrimRecHF
#define ThreeCenterOverlapPrimRecHF

#include "SimdArray.hpp"

namespace t3ovlrec { // t3ovlrec namespace

/// @brief Computes primitive [H|G(r)|F]  integrals for set of data buffers.
...
#endif /* ThreeCenterOverlapPrimRecHF */
