#ifndef ThreeCenterOverlapPrimRecHS
#define ThreeCenterOverlapPrimRecHS

#include "SimdArray.hpp"

namespace t3ovlrec { // t3ovlrec namespace

/// @brief Computes primitive [H|G(r)|S]  integrals for set of data buffers.
...
#endif /* ThreeCenterOverlapPrimRecHS */
