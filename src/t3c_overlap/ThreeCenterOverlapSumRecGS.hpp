#ifndef ThreeCenterOverlapSumRecGS_hpp
#define ThreeCenterOverlapSumRecGS_hpp
...
/// @brief Computes (G|G(r)|S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_gs(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3ovlrec::comp_prim_overlap_gs(pbuffer, 21, 5, 11, factors, 14, a_exp, exgtos[l]);
...
#endif /* ThreeCenterOverlapSumRecGS_hpp */
