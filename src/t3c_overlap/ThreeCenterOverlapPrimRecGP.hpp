#ifndef ThreeCenterOverlapPrimRecGP
#define ThreeCenterOverlapPrimRecGP

#include "SimdArray.hpp"

namespace t3ovlrec { // t3ovlrec namespace

/// @brief Computes primitive [G|G(r)|P]  integrals for set of data buffers.
...
#endif /* ThreeCenterOverlapPrimRecGP */
