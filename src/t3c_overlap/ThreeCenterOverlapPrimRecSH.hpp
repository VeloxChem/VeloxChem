#ifndef ThreeCenterOverlapPrimRecSH
#define ThreeCenterOverlapPrimRecSH

#include "SimdArray.hpp"

namespace t3ovlrec { // t3ovlrec namespace

/// @brief Computes primitive [S|G(r)|H]  integrals for set of data buffers.
...
#endif /* ThreeCenterOverlapPrimRecSH */
