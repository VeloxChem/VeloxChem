#ifndef ThreeCenterOverlapSumRecFP_hpp
#define ThreeCenterOverlapSumRecFP_hpp
...
/// @brief Computes (F|G(r)|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_fp(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3ovlrec::comp_prim_overlap_fp(pbuffer, 41, 8, 17, 23, factors, 14, a_exp, exgtos[l]);

                    t2cfunc::reduce(cbuffer, pbuffer, 41, ket_width, ket_npgtos);
                }
            }
...
#endif /* ThreeCenterOverlapSumRecFP_hpp */
