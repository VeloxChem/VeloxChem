#ifndef ThreeCenterOverlapPrimRecSF
#define ThreeCenterOverlapPrimRecSF

#include "SimdArray.hpp"

namespace t3ovlrec { // t3ovlrec namespace

/// @brief Computes primitive [S|G(r)|F]  integrals for set of data buffers.
...
#endif /* ThreeCenterOverlapPrimRecSF */
