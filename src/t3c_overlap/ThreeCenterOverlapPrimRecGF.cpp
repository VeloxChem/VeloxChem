                     ...
                     const double c_exp) -> void
{
    ...
    #pragma omp simd aligned(ga_x, ts_xx_xxx, ts_xx_xxy, ts_xx_xxz, ts_xx_xyy, ts_xx_xyz, ts_xx_xzz, ts_xx_yyy, ts_xx_yyz, ts_xx_yzz, ts_xx_zzz, ts_xxx_xx, ts_xxx_xxx, ts_xxx_xxy, ts_xxx_xxz, ts_xxx_xy, ts_xxx_xyy, ts_xxx_xyz, ts_xxx_xz, ts_xxx_xzz, ts_xxx_yy, ts_xxx_yyy, ts_xxx_yyz, ts_xxx_yz, ts_xxx_yzz, ts_xxx_zz, ts_xxx_zzz, ts_xxxx_xxx, ts_xxxx_xxy, ts_xxxx_xxz, ts_xxxx_xyy, ts_xxxx_xyz, ts_xxxx_xzz, ts_xxxx_yyy, ts_xxxx_yyz, ts_xxxx_yzz, ts_xxxx_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xxxx_xxx[i] = 3.0 * ts_xx_xxx[i] * gfe_0 + 3.0 * ts_xxx_xx[i] * gfe_0 + ts_xxx_xxx[i] * ga_x[i];

        ts_xxxx_xxy[i] = 3.0 * ts_xx_xxy[i] * gfe_0 + 2.0 * ts_xxx_xy[i] * gfe_0 + ts_xxx_xxy[i] * ga_x[i];

        ts_xxxx_xxz[i] = 3.0 * ts_xx_xxz[i] * gfe_0 + 2.0 * ts_xxx_xz[i] * gfe_0 + ts_xxx_xxz[i] * ga_x[i];

        ts_xxxx_xyy[i] = 3.0 * ts_xx_xyy[i] * gfe_0 + ts_xxx_yy[i] * gfe_0 + ts_xxx_xyy[i] * ga_x[i];

        ts_xxxx_xyz[i] = 3.0 * ts_xx_xyz[i] * gfe_0 + ts_xxx_yz[i] * gfe_0 + ts_xxx_xyz[i] * ga_x[i];

        ts_xxxx_xzz[i] = 3.0 * ts_xx_xzz[i] * gfe_0 + ts_xxx_zz[i] * gfe_0 + ts_xxx_xzz[i] * ga_x[i];

        ts_xxxx_yyy[i] = 3.0 * ts_xx_yyy[i] * gfe_0 + ts_xxx_yyy[i] * ga_x[i];

        ts_xxxx_yyz[i] = 3.0 * ts_xx_yyz[i] * gfe_0 + ts_xxx_yyz[i] * ga_x[i];

        ts_xxxx_yzz[i] = 3.0 * ts_xx_yzz[i] * gfe_0 + ts_xxx_yzz[i] * ga_x[i];

        ts_xxxx_zzz[i] = 3.0 * ts_xx_zzz[i] * gfe_0 + ts_xxx_zzz[i] * ga_x[i];
    }
    ...
    #pragma omp simd aligned(ga_x, ga_y, ts_xxx_xx, ts_xxx_xxx, ts_xxx_xxy, ts_xxx_xxz, ts_xxx_xy, ts_xxx_xyy, ts_xxx_xyz, ts_xxx_xz, ts_xxx_xzz, ts_xxx_zzz, ts_xxxy_xxx, ts_xxxy_xxy, ts_xxxy_xxz, ts_xxxy_xyy, ts_xxxy_xyz, ts_xxxy_xzz, ts_xxxy_yyy, ts_xxxy_yyz, ts_xxxy_yzz, ts_xxxy_zzz, ts_xxy_yyy, ts_xxy_yyz, ts_xxy_yzz, ts_xy_yyy, ts_xy_yyz, ts_xy_yzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xxxy_xxx[i] = ts_xxx_xxx[i] * ga_y[i];

        ts_xxxy_xxy[i] = ts_xxx_xx[i] * gfe_0 + ts_xxx_xxy[i] * ga_y[i];

        ts_xxxy_xxz[i] = ts_xxx_xxz[i] * ga_y[i];

        ts_xxxy_xyy[i] = 2.0 * ts_xxx_xy[i] * gfe_0 + ts_xxx_xyy[i] * ga_y[i];

        ts_xxxy_xyz[i] = ts_xxx_xz[i] * gfe_0 + ts_xxx_xyz[i] * ga_y[i];

        ts_xxxy_xzz[i] = ts_xxx_xzz[i] * ga_y[i];

        ts_xxxy_yyy[i] = 2.0 * ts_xy_yyy[i] * gfe_0 + ts_xxy_yyy[i] * ga_x[i];

        ts_xxxy_yyz[i] = 2.0 * ts_xy_yyz[i] * gfe_0 + ts_xxy_yyz[i] * ga_x[i];

        ts_xxxy_yzz[i] = 2.0 * ts_xy_yzz[i] * gfe_0 + ts_xxy_yzz[i] * ga_x[i];

        ts_xxxy_zzz[i] = ts_xxx_zzz[i] * ga_y[i];
    }
    ...
    #pragma omp simd aligned(ga_x, ga_z, ts_xxx_xx, ts_xxx_xxx, ts_xxx_xxy, ts_xxx_xxz, ts_xxx_xy, ts_xxx_xyy, ts_xxx_xyz, ts_xxx_xz, ts_xxx_xzz, ts_xxx_yyy, ts_xxxz_xxx, ts_xxxz_xxy, ts_xxxz_xxz, ts_xxxz_xyy, ts_xxxz_xyz, ts_xxxz_xzz, ts_xxxz_yyy, ts_xxxz_yyz, ts_xxxz_yzz, ts_xxxz_zzz, ts_xxz_yyz, ts_xxz_yzz, ts_xxz_zzz, ts_xz_yyz, ts_xz_yzz, ts_xz_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xxxz_xxx[i] = ts_xxx_xxx[i] * ga_z[i];

        ts_xxxz_xxy[i] = ts_xxx_xxy[i] * ga_z[i];

        ts_xxxz_xxz[i] = ts_xxx_xx[i] * gfe_0 + ts_xxx_xxz[i] * ga_z[i];

        ts_xxxz_xyy[i] = ts_xxx_xyy[i] * ga_z[i];

        ts_xxxz_xyz[i] = ts_xxx_xy[i] * gfe_0 + ts_xxx_xyz[i] * ga_z[i];

        ts_xxxz_xzz[i] = 2.0 * ts_xxx_xz[i] * gfe_0 + ts_xxx_xzz[i] * ga_z[i];

        ts_xxxz_yyy[i] = ts_xxx_yyy[i] * ga_z[i];

        ts_xxxz_yyz[i] = 2.0 * ts_xz_yyz[i] * gfe_0 + ts_xxz_yyz[i] * ga_x[i];

        ts_xxxz_yzz[i] = 2.0 * ts_xz_yzz[i] * gfe_0 + ts_xxz_yzz[i] * ga_x[i];

        ts_xxxz_zzz[i] = 2.0 * ts_xz_zzz[i] * gfe_0 + ts_xxz_zzz[i] * ga_x[i];
    }
    ...
    #pragma omp simd aligned(ga_x, ga_y, ts_xx_xxx, ts_xx_xxz, ts_xx_xzz, ts_xxy_xxx, ts_xxy_xxz, ts_xxy_xzz, ts_xxyy_xxx, ts_xxyy_xxy, ts_xxyy_xxz, ts_xxyy_xyy, ts_xxyy_xyz, ts_xxyy_xzz, ts_xxyy_yyy, ts_xxyy_yyz, ts_xxyy_yzz, ts_xxyy_zzz, ts_xyy_xxy, ts_xyy_xy, ts_xyy_xyy, ts_xyy_xyz, ts_xyy_yy, ts_xyy_yyy, ts_xyy_yyz, ts_xyy_yz, ts_xyy_yzz, ts_xyy_zzz, ts_yy_xxy, ts_yy_xyy, ts_yy_xyz, ts_yy_yyy, ts_yy_yyz, ts_yy_yzz, ts_yy_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xxyy_xxx[i] = ts_xx_xxx[i] * gfe_0 + ts_xxy_xxx[i] * ga_y[i];

        ts_xxyy_xxy[i] = ts_yy_xxy[i] * gfe_0 + 2.0 * ts_xyy_xy[i] * gfe_0 + ts_xyy_xxy[i] * ga_x[i];

        ts_xxyy_xxz[i] = ts_xx_xxz[i] * gfe_0 + ts_xxy_xxz[i] * ga_y[i];

        ts_xxyy_xyy[i] = ts_yy_xyy[i] * gfe_0 + ts_xyy_yy[i] * gfe_0 + ts_xyy_xyy[i] * ga_x[i];

        ts_xxyy_xyz[i] = ts_yy_xyz[i] * gfe_0 + ts_xyy_yz[i] * gfe_0 + ts_xyy_xyz[i] * ga_x[i];

        ts_xxyy_xzz[i] = ts_xx_xzz[i] * gfe_0 + ts_xxy_xzz[i] * ga_y[i];

        ts_xxyy_yyy[i] = ts_yy_yyy[i] * gfe_0 + ts_xyy_yyy[i] * ga_x[i];

        ts_xxyy_yyz[i] = ts_yy_yyz[i] * gfe_0 + ts_xyy_yyz[i] * ga_x[i];

        ts_xxyy_yzz[i] = ts_yy_yzz[i] * gfe_0 + ts_xyy_yzz[i] * ga_x[i];

        ts_xxyy_zzz[i] = ts_yy_zzz[i] * gfe_0 + ts_xyy_zzz[i] * ga_x[i];
    }
    ...
    #pragma omp simd aligned(ga_x, ga_y, ga_z, ts_xxy_xxy, ts_xxy_xyy, ts_xxy_yyy, ts_xxyz_xxx, ts_xxyz_xxy, ts_xxyz_xxz, ts_xxyz_xyy, ts_xxyz_xyz, ts_xxyz_xzz, ts_xxyz_yyy, ts_xxyz_yyz, ts_xxyz_yzz, ts_xxyz_zzz, ts_xxz_xxx, ts_xxz_xxz, ts_xxz_xyz, ts_xxz_xz, ts_xxz_xzz, ts_xxz_zzz, ts_xyz_yyz, ts_xyz_yzz, ts_yz_yyz, ts_yz_yzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xxyz_xxx[i] = ts_xxz_xxx[i] * ga_y[i];

        ts_xxyz_xxy[i] = ts_xxy_xxy[i] * ga_z[i];

        ts_xxyz_xxz[i] = ts_xxz_xxz[i] * ga_y[i];

        ts_xxyz_xyy[i] = ts_xxy_xyy[i] * ga_z[i];

        ts_xxyz_xyz[i] = ts_xxz_xz[i] * gfe_0 + ts_xxz_xyz[i] * ga_y[i];

        ts_xxyz_xzz[i] = ts_xxz_xzz[i] * ga_y[i];

        ts_xxyz_yyy[i] = ts_xxy_yyy[i] * ga_z[i];

        ts_xxyz_yyz[i] = ts_yz_yyz[i] * gfe_0 + ts_xyz_yyz[i] * ga_x[i];

        ts_xxyz_yzz[i] = ts_yz_yzz[i] * gfe_0 + ts_xyz_yzz[i] * ga_x[i];

        ts_xxyz_zzz[i] = ts_xxz_zzz[i] * ga_y[i];
    }
    ...
    #pragma omp simd aligned(ga_x, ga_z, ts_xx_xxx, ts_xx_xxy, ts_xx_xyy, ts_xxz_xxx, ts_xxz_xxy, ts_xxz_xyy, ts_xxzz_xxx, ts_xxzz_xxy, ts_xxzz_xxz, ts_xxzz_xyy, ts_xxzz_xyz, ts_xxzz_xzz, ts_xxzz_yyy, ts_xxzz_yyz, ts_xxzz_yzz, ts_xxzz_zzz, ts_xzz_xxz, ts_xzz_xyz, ts_xzz_xz, ts_xzz_xzz, ts_xzz_yyy, ts_xzz_yyz, ts_xzz_yz, ts_xzz_yzz, ts_xzz_zz, ts_xzz_zzz, ts_zz_xxz, ts_zz_xyz, ts_zz_xzz, ts_zz_yyy, ts_zz_yyz, ts_zz_yzz, ts_zz_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xxzz_xxx[i] = ts_xx_xxx[i] * gfe_0 + ts_xxz_xxx[i] * ga_z[i];

        ts_xxzz_xxy[i] = ts_xx_xxy[i] * gfe_0 + ts_xxz_xxy[i] * ga_z[i];

        ts_xxzz_xxz[i] = ts_zz_xxz[i] * gfe_0 + 2.0 * ts_xzz_xz[i] * gfe_0 + ts_xzz_xxz[i] * ga_x[i];

        ts_xxzz_xyy[i] = ts_xx_xyy[i] * gfe_0 + ts_xxz_xyy[i] * ga_z[i];

        ts_xxzz_xyz[i] = ts_zz_xyz[i] * gfe_0 + ts_xzz_yz[i] * gfe_0 + ts_xzz_xyz[i] * ga_x[i];

        ts_xxzz_xzz[i] = ts_zz_xzz[i] * gfe_0 + ts_xzz_zz[i] * gfe_0 + ts_xzz_xzz[i] * ga_x[i];

        ts_xxzz_yyy[i] = ts_zz_yyy[i] * gfe_0 + ts_xzz_yyy[i] * ga_x[i];

        ts_xxzz_yyz[i] = ts_zz_yyz[i] * gfe_0 + ts_xzz_yyz[i] * ga_x[i];

        ts_xxzz_yzz[i] = ts_zz_yzz[i] * gfe_0 + ts_xzz_yzz[i] * ga_x[i];

        ts_xxzz_zzz[i] = ts_zz_zzz[i] * gfe_0 + ts_xzz_zzz[i] * ga_x[i];
    }
    ...
    #pragma omp simd aligned(ga_x, ts_xyyy_xxx, ts_xyyy_xxy, ts_xyyy_xxz, ts_xyyy_xyy, ts_xyyy_xyz, ts_xyyy_xzz, ts_xyyy_yyy, ts_xyyy_yyz, ts_xyyy_yzz, ts_xyyy_zzz, ts_yyy_xx, ts_yyy_xxx, ts_yyy_xxy, ts_yyy_xxz, ts_yyy_xy, ts_yyy_xyy, ts_yyy_xyz, ts_yyy_xz, ts_yyy_xzz, ts_yyy_yy, ts_yyy_yyy, ts_yyy_yyz, ts_yyy_yz, ts_yyy_yzz, ts_yyy_zz, ts_yyy_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xyyy_xxx[i] = 3.0 * ts_yyy_xx[i] * gfe_0 + ts_yyy_xxx[i] * ga_x[i];

        ts_xyyy_xxy[i] = 2.0 * ts_yyy_xy[i] * gfe_0 + ts_yyy_xxy[i] * ga_x[i];

        ts_xyyy_xxz[i] = 2.0 * ts_yyy_xz[i] * gfe_0 + ts_yyy_xxz[i] * ga_x[i];

        ts_xyyy_xyy[i] = ts_yyy_yy[i] * gfe_0 + ts_yyy_xyy[i] * ga_x[i];

        ts_xyyy_xyz[i] = ts_yyy_yz[i] * gfe_0 + ts_yyy_xyz[i] * ga_x[i];

        ts_xyyy_xzz[i] = ts_yyy_zz[i] * gfe_0 + ts_yyy_xzz[i] * ga_x[i];

        ts_xyyy_yyy[i] = ts_yyy_yyy[i] * ga_x[i];

        ts_xyyy_yyz[i] = ts_yyy_yyz[i] * ga_x[i];

        ts_xyyy_yzz[i] = ts_yyy_yzz[i] * ga_x[i];

        ts_xyyy_zzz[i] = ts_yyy_zzz[i] * ga_x[i];
    }
    ...
    #pragma omp simd aligned(ga_x, ga_z, ts_xyy_xxx, ts_xyy_xxy, ts_xyy_xyy, ts_xyyz_xxx, ts_xyyz_xxy, ts_xyyz_xxz, ts_xyyz_xyy, ts_xyyz_xyz, ts_xyyz_xzz, ts_xyyz_yyy, ts_xyyz_yyz, ts_xyyz_yzz, ts_xyyz_zzz, ts_yyz_xxz, ts_yyz_xyz, ts_yyz_xz, ts_yyz_xzz, ts_yyz_yyy, ts_yyz_yyz, ts_yyz_yz, ts_yyz_yzz, ts_yyz_zz, ts_yyz_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xyyz_xxx[i] = ts_xyy_xxx[i] * ga_z[i];

        ts_xyyz_xxy[i] = ts_xyy_xxy[i] * ga_z[i];

        ts_xyyz_xxz[i] = 2.0 * ts_yyz_xz[i] * gfe_0 + ts_yyz_xxz[i] * ga_x[i];

        ts_xyyz_xyy[i] = ts_xyy_xyy[i] * ga_z[i];

        ts_xyyz_xyz[i] = ts_yyz_yz[i] * gfe_0 + ts_yyz_xyz[i] * ga_x[i];

        ts_xyyz_xzz[i] = ts_yyz_zz[i] * gfe_0 + ts_yyz_xzz[i] * ga_x[i];

        ts_xyyz_yyy[i] = ts_yyz_yyy[i] * ga_x[i];

        ts_xyyz_yyz[i] = ts_yyz_yyz[i] * ga_x[i];

        ts_xyyz_yzz[i] = ts_yyz_yzz[i] * ga_x[i];

        ts_xyyz_zzz[i] = ts_yyz_zzz[i] * ga_x[i];
    }
    ...
    #pragma omp simd aligned(ga_x, ga_y, ts_xyzz_xxx, ts_xyzz_xxy, ts_xyzz_xxz, ts_xyzz_xyy, ts_xyzz_xyz, ts_xyzz_xzz, ts_xyzz_yyy, ts_xyzz_yyz, ts_xyzz_yzz, ts_xyzz_zzz, ts_xzz_xxx, ts_xzz_xxz, ts_xzz_xzz, ts_yzz_xxy, ts_yzz_xy, ts_yzz_xyy, ts_yzz_xyz, ts_yzz_yy, ts_yzz_yyy, ts_yzz_yyz, ts_yzz_yz, ts_yzz_yzz, ts_yzz_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xyzz_xxx[i] = ts_xzz_xxx[i] * ga_y[i];

        ts_xyzz_xxy[i] = 2.0 * ts_yzz_xy[i] * gfe_0 + ts_yzz_xxy[i] * ga_x[i];

        ts_xyzz_xxz[i] = ts_xzz_xxz[i] * ga_y[i];

        ts_xyzz_xyy[i] = ts_yzz_yy[i] * gfe_0 + ts_yzz_xyy[i] * ga_x[i];

        ts_xyzz_xyz[i] = ts_yzz_yz[i] * gfe_0 + ts_yzz_xyz[i] * ga_x[i];

        ts_xyzz_xzz[i] = ts_xzz_xzz[i] * ga_y[i];

        ts_xyzz_yyy[i] = ts_yzz_yyy[i] * ga_x[i];

        ts_xyzz_yyz[i] = ts_yzz_yyz[i] * ga_x[i];

        ts_xyzz_yzz[i] = ts_yzz_yzz[i] * ga_x[i];

        ts_xyzz_zzz[i] = ts_yzz_zzz[i] * ga_x[i];
    }
    ...
    #pragma omp simd aligned(ga_x, ts_xzzz_xxx, ts_xzzz_xxy, ts_xzzz_xxz, ts_xzzz_xyy, ts_xzzz_xyz, ts_xzzz_xzz, ts_xzzz_yyy, ts_xzzz_yyz, ts_xzzz_yzz, ts_xzzz_zzz, ts_zzz_xx, ts_zzz_xxx, ts_zzz_xxy, ts_zzz_xxz, ts_zzz_xy, ts_zzz_xyy, ts_zzz_xyz, ts_zzz_xz, ts_zzz_xzz, ts_zzz_yy, ts_zzz_yyy, ts_zzz_yyz, ts_zzz_yz, ts_zzz_yzz, ts_zzz_zz, ts_zzz_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xzzz_xxx[i] = 3.0 * ts_zzz_xx[i] * gfe_0 + ts_zzz_xxx[i] * ga_x[i];

        ts_xzzz_xxy[i] = 2.0 * ts_zzz_xy[i] * gfe_0 + ts_zzz_xxy[i] * ga_x[i];

        ts_xzzz_xxz[i] = 2.0 * ts_zzz_xz[i] * gfe_0 + ts_zzz_xxz[i] * ga_x[i];

        ts_xzzz_xyy[i] = ts_zzz_yy[i] * gfe_0 + ts_zzz_xyy[i] * ga_x[i];

        ts_xzzz_xyz[i] = ts_zzz_yz[i] * gfe_0 + ts_zzz_xyz[i] * ga_x[i];

        ts_xzzz_xzz[i] = ts_zzz_zz[i] * gfe_0 + ts_zzz_xzz[i] * ga_x[i];

        ts_xzzz_yyy[i] = ts_zzz_yyy[i] * ga_x[i];

        ts_xzzz_yyz[i] = ts_zzz_yyz[i] * ga_x[i];

        ts_xzzz_yzz[i] = ts_zzz_yzz[i] * ga_x[i];

        ts_xzzz_zzz[i] = ts_zzz_zzz[i] * ga_x[i];
    }
    ...
    #pragma omp simd aligned(ga_y, ts_yy_xxx, ts_yy_xxy, ts_yy_xxz, ts_yy_xyy, ts_yy_xyz, ts_yy_xzz, ts_yy_yyy, ts_yy_yyz, ts_yy_yzz, ts_yy_zzz, ts_yyy_xx, ts_yyy_xxx, ts_yyy_xxy, ts_yyy_xxz, ts_yyy_xy, ts_yyy_xyy, ts_yyy_xyz, ts_yyy_xz, ts_yyy_xzz, ts_yyy_yy, ts_yyy_yyy, ts_yyy_yyz, ts_yyy_yz, ts_yyy_yzz, ts_yyy_zz, ts_yyy_zzz, ts_yyyy_xxx, ts_yyyy_xxy, ts_yyyy_xxz, ts_yyyy_xyy, ts_yyyy_xyz, ts_yyyy_xzz, ts_yyyy_yyy, ts_yyyy_yyz, ts_yyyy_yzz, ts_yyyy_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_yyyy_xxx[i] = 3.0 * ts_yy_xxx[i] * gfe_0 + ts_yyy_xxx[i] * ga_y[i];

        ts_yyyy_xxy[i] = 3.0 * ts_yy_xxy[i] * gfe_0 + ts_yyy_xx[i] * gfe_0 + ts_yyy_xxy[i] * ga_y[i];

        ts_yyyy_xxz[i] = 3.0 * ts_yy_xxz[i] * gfe_0 + ts_yyy_xxz[i] * ga_y[i];

        ts_yyyy_xyy[i] = 3.0 * ts_yy_xyy[i] * gfe_0 + 2.0 * ts_yyy_xy[i] * gfe_0 + ts_yyy_xyy[i] * ga_y[i];

        ts_yyyy_xyz[i] = 3.0 * ts_yy_xyz[i] * gfe_0 + ts_yyy_xz[i] * gfe_0 + ts_yyy_xyz[i] * ga_y[i];

        ts_yyyy_xzz[i] = 3.0 * ts_yy_xzz[i] * gfe_0 + ts_yyy_xzz[i] * ga_y[i];

        ts_yyyy_yyy[i] = 3.0 * ts_yy_yyy[i] * gfe_0 + 3.0 * ts_yyy_yy[i] * gfe_0 + ts_yyy_yyy[i] * ga_y[i];

        ts_yyyy_yyz[i] = 3.0 * ts_yy_yyz[i] * gfe_0 + 2.0 * ts_yyy_yz[i] * gfe_0 + ts_yyy_yyz[i] * ga_y[i];

        ts_yyyy_yzz[i] = 3.0 * ts_yy_yzz[i] * gfe_0 + ts_yyy_zz[i] * gfe_0 + ts_yyy_yzz[i] * ga_y[i];

        ts_yyyy_zzz[i] = 3.0 * ts_yy_zzz[i] * gfe_0 + ts_yyy_zzz[i] * ga_y[i];
    }
    ...
    #pragma omp simd aligned(ga_y, ga_z, ts_yyy_xxx, ts_yyy_xxy, ts_yyy_xy, ts_yyy_xyy, ts_yyy_xyz, ts_yyy_yy, ts_yyy_yyy, ts_yyy_yyz, ts_yyy_yz, ts_yyy_yzz, ts_yyyz_xxx, ts_yyyz_xxy, ts_yyyz_xxz, ts_yyyz_xyy, ts_yyyz_xyz, ts_yyyz_xzz, ts_yyyz_yyy, ts_yyyz_yyz, ts_yyyz_yzz, ts_yyyz_zzz, ts_yyz_xxz, ts_yyz_xzz, ts_yyz_zzz, ts_yz_xxz, ts_yz_xzz, ts_yz_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_yyyz_xxx[i] = ts_yyy_xxx[i] * ga_z[i];

        ts_yyyz_xxy[i] = ts_yyy_xxy[i] * ga_z[i];

        ts_yyyz_xxz[i] = 2.0 * ts_yz_xxz[i] * gfe_0 + ts_yyz_xxz[i] * ga_y[i];

        ts_yyyz_xyy[i] = ts_yyy_xyy[i] * ga_z[i];

        ts_yyyz_xyz[i] = ts_yyy_xy[i] * gfe_0 + ts_yyy_xyz[i] * ga_z[i];

        ts_yyyz_xzz[i] = 2.0 * ts_yz_xzz[i] * gfe_0 + ts_yyz_xzz[i] * ga_y[i];

        ts_yyyz_yyy[i] = ts_yyy_yyy[i] * ga_z[i];

        ts_yyyz_yyz[i] = ts_yyy_yy[i] * gfe_0 + ts_yyy_yyz[i] * ga_z[i];

        ts_yyyz_yzz[i] = 2.0 * ts_yyy_yz[i] * gfe_0 + ts_yyy_yzz[i] * ga_z[i];

        ts_yyyz_zzz[i] = 2.0 * ts_yz_zzz[i] * gfe_0 + ts_yyz_zzz[i] * ga_y[i];
    }
    ...
    #pragma omp simd aligned(ga_y, ga_z, ts_yy_xxy, ts_yy_xyy, ts_yy_yyy, ts_yyz_xxy, ts_yyz_xyy, ts_yyz_yyy, ts_yyzz_xxx, ts_yyzz_xxy, ts_yyzz_xxz, ts_yyzz_xyy, ts_yyzz_xyz, ts_yyzz_xzz, ts_yyzz_yyy, ts_yyzz_yyz, ts_yyzz_yzz, ts_yyzz_zzz, ts_yzz_xxx, ts_yzz_xxz, ts_yzz_xyz, ts_yzz_xz, ts_yzz_xzz, ts_yzz_yyz, ts_yzz_yz, ts_yzz_yzz, ts_yzz_zz, ts_yzz_zzz, ts_zz_xxx, ts_zz_xxz, ts_zz_xyz, ts_zz_xzz, ts_zz_yyz, ts_zz_yzz, ts_zz_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_yyzz_xxx[i] = ts_zz_xxx[i] * gfe_0 + ts_yzz_xxx[i] * ga_y[i];

        ts_yyzz_xxy[i] = ts_yy_xxy[i] * gfe_0 + ts_yyz_xxy[i] * ga_z[i];

        ts_yyzz_xxz[i] = ts_zz_xxz[i] * gfe_0 + ts_yzz_xxz[i] * ga_y[i];

        ts_yyzz_xyy[i] = ts_yy_xyy[i] * gfe_0 + ts_yyz_xyy[i] * ga_z[i];

        ts_yyzz_xyz[i] = ts_zz_xyz[i] * gfe_0 + ts_yzz_xz[i] * gfe_0 + ts_yzz_xyz[i] * ga_y[i];

        ts_yyzz_xzz[i] = ts_zz_xzz[i] * gfe_0 + ts_yzz_xzz[i] * ga_y[i];

        ts_yyzz_yyy[i] = ts_yy_yyy[i] * gfe_0 + ts_yyz_yyy[i] * ga_z[i];

        ts_yyzz_yyz[i] = ts_zz_yyz[i] * gfe_0 + 2.0 * ts_yzz_yz[i] * gfe_0 + ts_yzz_yyz[i] * ga_y[i];

        ts_yyzz_yzz[i] = ts_zz_yzz[i] * gfe_0 + ts_yzz_zz[i] * gfe_0 + ts_yzz_yzz[i] * ga_y[i];

        ts_yyzz_zzz[i] = ts_zz_zzz[i] * gfe_0 + ts_yzz_zzz[i] * ga_y[i];
    }
    ...
    #pragma omp simd aligned(ga_y, ts_yzzz_xxx, ts_yzzz_xxy, ts_yzzz_xxz, ts_yzzz_xyy, ts_yzzz_xyz, ts_yzzz_xzz, ts_yzzz_yyy, ts_yzzz_yyz, ts_yzzz_yzz, ts_yzzz_zzz, ts_zzz_xx, ts_zzz_xxx, ts_zzz_xxy, ts_zzz_xxz, ts_zzz_xy, ts_zzz_xyy, ts_zzz_xyz, ts_zzz_xz, ts_zzz_xzz, ts_zzz_yy, ts_zzz_yyy, ts_zzz_yyz, ts_zzz_yz, ts_zzz_yzz, ts_zzz_zz, ts_zzz_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_yzzz_xxx[i] = ts_zzz_xxx[i] * ga_y[i];

        ts_yzzz_xxy[i] = ts_zzz_xx[i] * gfe_0 + ts_zzz_xxy[i] * ga_y[i];

        ts_yzzz_xxz[i] = ts_zzz_xxz[i] * ga_y[i];

        ts_yzzz_xyy[i] = 2.0 * ts_zzz_xy[i] * gfe_0 + ts_zzz_xyy[i] * ga_y[i];

        ts_yzzz_xyz[i] = ts_zzz_xz[i] * gfe_0 + ts_zzz_xyz[i] * ga_y[i];

        ts_yzzz_xzz[i] = ts_zzz_xzz[i] * ga_y[i];

        ts_yzzz_yyy[i] = 3.0 * ts_zzz_yy[i] * gfe_0 + ts_zzz_yyy[i] * ga_y[i];

        ts_yzzz_yyz[i] = 2.0 * ts_zzz_yz[i] * gfe_0 + ts_zzz_yyz[i] * ga_y[i];

        ts_yzzz_yzz[i] = ts_zzz_zz[i] * gfe_0 + ts_zzz_yzz[i] * ga_y[i];

        ts_yzzz_zzz[i] = ts_zzz_zzz[i] * ga_y[i];
    }
    ...
    #pragma omp simd aligned(ga_z, ts_zz_xxx, ts_zz_xxy, ts_zz_xxz, ts_zz_xyy, ts_zz_xyz, ts_zz_xzz, ts_zz_yyy, ts_zz_yyz, ts_zz_yzz, ts_zz_zzz, ts_zzz_xx, ts_zzz_xxx, ts_zzz_xxy, ts_zzz_xxz, ts_zzz_xy, ts_zzz_xyy, ts_zzz_xyz, ts_zzz_xz, ts_zzz_xzz, ts_zzz_yy, ts_zzz_yyy, ts_zzz_yyz, ts_zzz_yz, ts_zzz_yzz, ts_zzz_zz, ts_zzz_zzz, ts_zzzz_xxx, ts_zzzz_xxy, ts_zzzz_xxz, ts_zzzz_xyy, ts_zzzz_xyz, ts_zzzz_xzz, ts_zzzz_yyy, ts_zzzz_yyz, ts_zzzz_yzz, ts_zzzz_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_zzzz_xxx[i] = 3.0 * ts_zz_xxx[i] * gfe_0 + ts_zzz_xxx[i] * ga_z[i];

        ts_zzzz_xxy[i] = 3.0 * ts_zz_xxy[i] * gfe_0 + ts_zzz_xxy[i] * ga_z[i];

        ts_zzzz_xxz[i] = 3.0 * ts_zz_xxz[i] * gfe_0 + ts_zzz_xx[i] * gfe_0 + ts_zzz_xxz[i] * ga_z[i];

        ts_zzzz_xyy[i] = 3.0 * ts_zz_xyy[i] * gfe_0 + ts_zzz_xyy[i] * ga_z[i];

        ts_zzzz_xyz[i] = 3.0 * ts_zz_xyz[i] * gfe_0 + ts_zzz_xy[i] * gfe_0 + ts_zzz_xyz[i] * ga_z[i];

        ts_zzzz_xzz[i] = 3.0 * ts_zz_xzz[i] * gfe_0 + 2.0 * ts_zzz_xz[i] * gfe_0 + ts_zzz_xzz[i] * ga_z[i];

        ts_zzzz_yyy[i] = 3.0 * ts_zz_yyy[i] * gfe_0 + ts_zzz_yyy[i] * ga_z[i];

        ts_zzzz_yyz[i] = 3.0 * ts_zz_yyz[i] * gfe_0 + ts_zzz_yy[i] * gfe_0 + ts_zzz_yyz[i] * ga_z[i];

        ts_zzzz_yzz[i] = 3.0 * ts_zz_yzz[i] * gfe_0 + 2.0 * ts_zzz_yz[i] * gfe_0 + ts_zzz_yzz[i] * ga_z[i];

        ts_zzzz_zzz[i] = 3.0 * ts_zz_zzz[i] * gfe_0 + 3.0 * ts_zzz_zz[i] * gfe_0 + ts_zzz_zzz[i] * ga_z[i];
    }
