#ifndef ThreeCenterOverlapPrimRecDP
#define ThreeCenterOverlapPrimRecDP

#include "SimdArray.hpp"

namespace t3ovlrec { // t3ovlrec namespace

/// @brief Computes primitive [D|G(r)|P]  integrals for set of data buffers.
...
#endif /* ThreeCenterOverlapPrimRecDP */
