#ifndef ThreeCenterOverlapSumRecFS_hpp
#define ThreeCenterOverlapSumRecFS_hpp
...
/// @brief Computes (F|G(r)|S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_fs(T& distributor,
...
#endif /* ThreeCenterOverlapSumRecFS_hpp */
