                     ...
                     const double c_exp) -> void
{
    ...
    #pragma omp simd aligned(ga_x, ts_xxx_xxx, ts_xxx_xxy, ts_xxx_xxz, ts_xxx_xyy, ts_xxx_xyz, ts_xxx_xzz, ts_xxx_yyy, ts_xxx_yyz, ts_xxx_yzz, ts_xxx_zzz, ts_xxxx_xx, ts_xxxx_xxx, ts_xxxx_xxy, ts_xxxx_xxz, ts_xxxx_xy, ts_xxxx_xyy, ts_xxxx_xyz, ts_xxxx_xz, ts_xxxx_xzz, ts_xxxx_yy, ts_xxxx_yyy, ts_xxxx_yyz, ts_xxxx_yz, ts_xxxx_yzz, ts_xxxx_zz, ts_xxxx_zzz, ts_xxxxx_xxx, ts_xxxxx_xxy, ts_xxxxx_xxz, ts_xxxxx_xyy, ts_xxxxx_xyz, ts_xxxxx_xzz, ts_xxxxx_yyy, ts_xxxxx_yyz, ts_xxxxx_yzz, ts_xxxxx_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xxxxx_xxx[i] = 4.0 * ts_xxx_xxx[i] * gfe_0 + 3.0 * ts_xxxx_xx[i] * gfe_0 + ts_xxxx_xxx[i] * ga_x[i];

        ts_xxxxx_xxy[i] = 4.0 * ts_xxx_xxy[i] * gfe_0 + 2.0 * ts_xxxx_xy[i] * gfe_0 + ts_xxxx_xxy[i] * ga_x[i];

        ts_xxxxx_xxz[i] = 4.0 * ts_xxx_xxz[i] * gfe_0 + 2.0 * ts_xxxx_xz[i] * gfe_0 + ts_xxxx_xxz[i] * ga_x[i];

        ts_xxxxx_xyy[i] = 4.0 * ts_xxx_xyy[i] * gfe_0 + ts_xxxx_yy[i] * gfe_0 + ts_xxxx_xyy[i] * ga_x[i];

        ts_xxxxx_xyz[i] = 4.0 * ts_xxx_xyz[i] * gfe_0 + ts_xxxx_yz[i] * gfe_0 + ts_xxxx_xyz[i] * ga_x[i];

        ts_xxxxx_xzz[i] = 4.0 * ts_xxx_xzz[i] * gfe_0 + ts_xxxx_zz[i] * gfe_0 + ts_xxxx_xzz[i] * ga_x[i];

        ts_xxxxx_yyy[i] = 4.0 * ts_xxx_yyy[i] * gfe_0 + ts_xxxx_yyy[i] * ga_x[i];

        ts_xxxxx_yyz[i] = 4.0 * ts_xxx_yyz[i] * gfe_0 + ts_xxxx_yyz[i] * ga_x[i];

        ts_xxxxx_yzz[i] = 4.0 * ts_xxx_yzz[i] * gfe_0 + ts_xxxx_yzz[i] * ga_x[i];

        ts_xxxxx_zzz[i] = 4.0 * ts_xxx_zzz[i] * gfe_0 + ts_xxxx_zzz[i] * ga_x[i];
    }
    ...
    #pragma omp simd aligned(ga_x, ga_y, ts_xxxx_xx, ts_xxxx_xxx, ts_xxxx_xxy, ts_xxxx_xxz, ts_xxxx_xy, ts_xxxx_xyy, ts_xxxx_xyz, ts_xxxx_xz, ts_xxxx_xzz, ts_xxxx_zzz, ts_xxxxy_xxx, ts_xxxxy_xxy, ts_xxxxy_xxz, ts_xxxxy_xyy, ts_xxxxy_xyz, ts_xxxxy_xzz, ts_xxxxy_yyy, ts_xxxxy_yyz, ts_xxxxy_yzz, ts_xxxxy_zzz, ts_xxxy_yyy, ts_xxxy_yyz, ts_xxxy_yzz, ts_xxy_yyy, ts_xxy_yyz, ts_xxy_yzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xxxxy_xxx[i] = ts_xxxx_xxx[i] * ga_y[i];

        ts_xxxxy_xxy[i] = ts_xxxx_xx[i] * gfe_0 + ts_xxxx_xxy[i] * ga_y[i];

        ts_xxxxy_xxz[i] = ts_xxxx_xxz[i] * ga_y[i];

        ts_xxxxy_xyy[i] = 2.0 * ts_xxxx_xy[i] * gfe_0 + ts_xxxx_xyy[i] * ga_y[i];

        ts_xxxxy_xyz[i] = ts_xxxx_xz[i] * gfe_0 + ts_xxxx_xyz[i] * ga_y[i];

        ts_xxxxy_xzz[i] = ts_xxxx_xzz[i] * ga_y[i];

        ts_xxxxy_yyy[i] = 3.0 * ts_xxy_yyy[i] * gfe_0 + ts_xxxy_yyy[i] * ga_x[i];

        ts_xxxxy_yyz[i] = 3.0 * ts_xxy_yyz[i] * gfe_0 + ts_xxxy_yyz[i] * ga_x[i];

        ts_xxxxy_yzz[i] = 3.0 * ts_xxy_yzz[i] * gfe_0 + ts_xxxy_yzz[i] * ga_x[i];

        ts_xxxxy_zzz[i] = ts_xxxx_zzz[i] * ga_y[i];
    }
    ...
    #pragma omp simd aligned(ga_x, ga_z, ts_xxxx_xx, ts_xxxx_xxx, ts_xxxx_xxy, ts_xxxx_xxz, ts_xxxx_xy, ts_xxxx_xyy, ts_xxxx_xyz, ts_xxxx_xz, ts_xxxx_xzz, ts_xxxx_yyy, ts_xxxxz_xxx, ts_xxxxz_xxy, ts_xxxxz_xxz, ts_xxxxz_xyy, ts_xxxxz_xyz, ts_xxxxz_xzz, ts_xxxxz_yyy, ts_xxxxz_yyz, ts_xxxxz_yzz, ts_xxxxz_zzz, ts_xxxz_yyz, ts_xxxz_yzz, ts_xxxz_zzz, ts_xxz_yyz, ts_xxz_yzz, ts_xxz_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xxxxz_xxx[i] = ts_xxxx_xxx[i] * ga_z[i];

        ts_xxxxz_xxy[i] = ts_xxxx_xxy[i] * ga_z[i];

        ts_xxxxz_xxz[i] = ts_xxxx_xx[i] * gfe_0 + ts_xxxx_xxz[i] * ga_z[i];

        ts_xxxxz_xyy[i] = ts_xxxx_xyy[i] * ga_z[i];

        ts_xxxxz_xyz[i] = ts_xxxx_xy[i] * gfe_0 + ts_xxxx_xyz[i] * ga_z[i];

        ts_xxxxz_xzz[i] = 2.0 * ts_xxxx_xz[i] * gfe_0 + ts_xxxx_xzz[i] * ga_z[i];

        ts_xxxxz_yyy[i] = ts_xxxx_yyy[i] * ga_z[i];

        ts_xxxxz_yyz[i] = 3.0 * ts_xxz_yyz[i] * gfe_0 + ts_xxxz_yyz[i] * ga_x[i];

        ts_xxxxz_yzz[i] = 3.0 * ts_xxz_yzz[i] * gfe_0 + ts_xxxz_yzz[i] * ga_x[i];

        ts_xxxxz_zzz[i] = 3.0 * ts_xxz_zzz[i] * gfe_0 + ts_xxxz_zzz[i] * ga_x[i];
    }
    ...
    #pragma omp simd aligned(ga_x, ga_y, ts_xxx_xxx, ts_xxx_xxz, ts_xxx_xzz, ts_xxxy_xxx, ts_xxxy_xxz, ts_xxxy_xzz, ts_xxxyy_xxx, ts_xxxyy_xxy, ts_xxxyy_xxz, ts_xxxyy_xyy, ts_xxxyy_xyz, ts_xxxyy_xzz, ts_xxxyy_yyy, ts_xxxyy_yyz, ts_xxxyy_yzz, ts_xxxyy_zzz, ts_xxyy_xxy, ts_xxyy_xy, ts_xxyy_xyy, ts_xxyy_xyz, ts_xxyy_yy, ts_xxyy_yyy, ts_xxyy_yyz, ts_xxyy_yz, ts_xxyy_yzz, ts_xxyy_zzz, ts_xyy_xxy, ts_xyy_xyy, ts_xyy_xyz, ts_xyy_yyy, ts_xyy_yyz, ts_xyy_yzz, ts_xyy_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xxxyy_xxx[i] = ts_xxx_xxx[i] * gfe_0 + ts_xxxy_xxx[i] * ga_y[i];

        ts_xxxyy_xxy[i] = 2.0 * ts_xyy_xxy[i] * gfe_0 + 2.0 * ts_xxyy_xy[i] * gfe_0 + ts_xxyy_xxy[i] * ga_x[i];

        ts_xxxyy_xxz[i] = ts_xxx_xxz[i] * gfe_0 + ts_xxxy_xxz[i] * ga_y[i];

        ts_xxxyy_xyy[i] = 2.0 * ts_xyy_xyy[i] * gfe_0 + ts_xxyy_yy[i] * gfe_0 + ts_xxyy_xyy[i] * ga_x[i];

        ts_xxxyy_xyz[i] = 2.0 * ts_xyy_xyz[i] * gfe_0 + ts_xxyy_yz[i] * gfe_0 + ts_xxyy_xyz[i] * ga_x[i];

        ts_xxxyy_xzz[i] = ts_xxx_xzz[i] * gfe_0 + ts_xxxy_xzz[i] * ga_y[i];

        ts_xxxyy_yyy[i] = 2.0 * ts_xyy_yyy[i] * gfe_0 + ts_xxyy_yyy[i] * ga_x[i];

        ts_xxxyy_yyz[i] = 2.0 * ts_xyy_yyz[i] * gfe_0 + ts_xxyy_yyz[i] * ga_x[i];

        ts_xxxyy_yzz[i] = 2.0 * ts_xyy_yzz[i] * gfe_0 + ts_xxyy_yzz[i] * ga_x[i];

        ts_xxxyy_zzz[i] = 2.0 * ts_xyy_zzz[i] * gfe_0 + ts_xxyy_zzz[i] * ga_x[i];
    }
    ...
    #pragma omp simd aligned(ga_x, ga_y, ga_z, ts_xxxy_xxy, ts_xxxy_xyy, ts_xxxy_yyy, ts_xxxyz_xxx, ts_xxxyz_xxy, ts_xxxyz_xxz, ts_xxxyz_xyy, ts_xxxyz_xyz, ts_xxxyz_xzz, ts_xxxyz_yyy, ts_xxxyz_yyz, ts_xxxyz_yzz, ts_xxxyz_zzz, ts_xxxz_xxx, ts_xxxz_xxz, ts_xxxz_xyz, ts_xxxz_xz, ts_xxxz_xzz, ts_xxxz_zzz, ts_xxyz_yyz, ts_xxyz_yzz, ts_xyz_yyz, ts_xyz_yzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xxxyz_xxx[i] = ts_xxxz_xxx[i] * ga_y[i];

        ts_xxxyz_xxy[i] = ts_xxxy_xxy[i] * ga_z[i];

        ts_xxxyz_xxz[i] = ts_xxxz_xxz[i] * ga_y[i];

        ts_xxxyz_xyy[i] = ts_xxxy_xyy[i] * ga_z[i];

        ts_xxxyz_xyz[i] = ts_xxxz_xz[i] * gfe_0 + ts_xxxz_xyz[i] * ga_y[i];

        ts_xxxyz_xzz[i] = ts_xxxz_xzz[i] * ga_y[i];

        ts_xxxyz_yyy[i] = ts_xxxy_yyy[i] * ga_z[i];

        ts_xxxyz_yyz[i] = 2.0 * ts_xyz_yyz[i] * gfe_0 + ts_xxyz_yyz[i] * ga_x[i];

        ts_xxxyz_yzz[i] = 2.0 * ts_xyz_yzz[i] * gfe_0 + ts_xxyz_yzz[i] * ga_x[i];

        ts_xxxyz_zzz[i] = ts_xxxz_zzz[i] * ga_y[i];
    }
    ...
    #pragma omp simd aligned(ga_x, ga_z, ts_xxx_xxx, ts_xxx_xxy, ts_xxx_xyy, ts_xxxz_xxx, ts_xxxz_xxy, ts_xxxz_xyy, ts_xxxzz_xxx, ts_xxxzz_xxy, ts_xxxzz_xxz, ts_xxxzz_xyy, ts_xxxzz_xyz, ts_xxxzz_xzz, ts_xxxzz_yyy, ts_xxxzz_yyz, ts_xxxzz_yzz, ts_xxxzz_zzz, ts_xxzz_xxz, ts_xxzz_xyz, ts_xxzz_xz, ts_xxzz_xzz, ts_xxzz_yyy, ts_xxzz_yyz, ts_xxzz_yz, ts_xxzz_yzz, ts_xxzz_zz, ts_xxzz_zzz, ts_xzz_xxz, ts_xzz_xyz, ts_xzz_xzz, ts_xzz_yyy, ts_xzz_yyz, ts_xzz_yzz, ts_xzz_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xxxzz_xxx[i] = ts_xxx_xxx[i] * gfe_0 + ts_xxxz_xxx[i] * ga_z[i];

        ts_xxxzz_xxy[i] = ts_xxx_xxy[i] * gfe_0 + ts_xxxz_xxy[i] * ga_z[i];

        ts_xxxzz_xxz[i] = 2.0 * ts_xzz_xxz[i] * gfe_0 + 2.0 * ts_xxzz_xz[i] * gfe_0 + ts_xxzz_xxz[i] * ga_x[i];

        ts_xxxzz_xyy[i] = ts_xxx_xyy[i] * gfe_0 + ts_xxxz_xyy[i] * ga_z[i];

        ts_xxxzz_xyz[i] = 2.0 * ts_xzz_xyz[i] * gfe_0 + ts_xxzz_yz[i] * gfe_0 + ts_xxzz_xyz[i] * ga_x[i];

        ts_xxxzz_xzz[i] = 2.0 * ts_xzz_xzz[i] * gfe_0 + ts_xxzz_zz[i] * gfe_0 + ts_xxzz_xzz[i] * ga_x[i];

        ts_xxxzz_yyy[i] = 2.0 * ts_xzz_yyy[i] * gfe_0 + ts_xxzz_yyy[i] * ga_x[i];

        ts_xxxzz_yyz[i] = 2.0 * ts_xzz_yyz[i] * gfe_0 + ts_xxzz_yyz[i] * ga_x[i];

        ts_xxxzz_yzz[i] = 2.0 * ts_xzz_yzz[i] * gfe_0 + ts_xxzz_yzz[i] * ga_x[i];

        ts_xxxzz_zzz[i] = 2.0 * ts_xzz_zzz[i] * gfe_0 + ts_xxzz_zzz[i] * ga_x[i];
    }
    ...
    #pragma omp simd aligned(ga_x, ga_y, ts_xxy_xxx, ts_xxy_xxz, ts_xxy_xzz, ts_xxyy_xxx, ts_xxyy_xxz, ts_xxyy_xzz, ts_xxyyy_xxx, ts_xxyyy_xxy, ts_xxyyy_xxz, ts_xxyyy_xyy, ts_xxyyy_xyz, ts_xxyyy_xzz, ts_xxyyy_yyy, ts_xxyyy_yyz, ts_xxyyy_yzz, ts_xxyyy_zzz, ts_xyyy_xxy, ts_xyyy_xy, ts_xyyy_xyy, ts_xyyy_xyz, ts_xyyy_yy, ts_xyyy_yyy, ts_xyyy_yyz, ts_xyyy_yz, ts_xyyy_yzz, ts_xyyy_zzz, ts_yyy_xxy, ts_yyy_xyy, ts_yyy_xyz, ts_yyy_yyy, ts_yyy_yyz, ts_yyy_yzz, ts_yyy_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xxyyy_xxx[i] = 2.0 * ts_xxy_xxx[i] * gfe_0 + ts_xxyy_xxx[i] * ga_y[i];

        ts_xxyyy_xxy[i] = ts_yyy_xxy[i] * gfe_0 + 2.0 * ts_xyyy_xy[i] * gfe_0 + ts_xyyy_xxy[i] * ga_x[i];

        ts_xxyyy_xxz[i] = 2.0 * ts_xxy_xxz[i] * gfe_0 + ts_xxyy_xxz[i] * ga_y[i];

        ts_xxyyy_xyy[i] = ts_yyy_xyy[i] * gfe_0 + ts_xyyy_yy[i] * gfe_0 + ts_xyyy_xyy[i] * ga_x[i];

        ts_xxyyy_xyz[i] = ts_yyy_xyz[i] * gfe_0 + ts_xyyy_yz[i] * gfe_0 + ts_xyyy_xyz[i] * ga_x[i];

        ts_xxyyy_xzz[i] = 2.0 * ts_xxy_xzz[i] * gfe_0 + ts_xxyy_xzz[i] * ga_y[i];

        ts_xxyyy_yyy[i] = ts_yyy_yyy[i] * gfe_0 + ts_xyyy_yyy[i] * ga_x[i];

        ts_xxyyy_yyz[i] = ts_yyy_yyz[i] * gfe_0 + ts_xyyy_yyz[i] * ga_x[i];

        ts_xxyyy_yzz[i] = ts_yyy_yzz[i] * gfe_0 + ts_xyyy_yzz[i] * ga_x[i];

        ts_xxyyy_zzz[i] = ts_yyy_zzz[i] * gfe_0 + ts_xyyy_zzz[i] * ga_x[i];
    }
    ...
    #pragma omp simd aligned(ga_x, ga_y, ga_z, ts_xxyy_xxx, ts_xxyy_xxy, ts_xxyy_xy, ts_xxyy_xyy, ts_xxyy_xyz, ts_xxyy_yyy, ts_xxyyz_xxx, ts_xxyyz_xxy, ts_xxyyz_xxz, ts_xxyyz_xyy, ts_xxyyz_xyz, ts_xxyyz_xzz, ts_xxyyz_yyy, ts_xxyyz_yyz, ts_xxyyz_yzz, ts_xxyyz_zzz, ts_xxyz_xxz, ts_xxyz_xzz, ts_xxz_xxz, ts_xxz_xzz, ts_xyyz_yyz, ts_xyyz_yzz, ts_xyyz_zzz, ts_yyz_yyz, ts_yyz_yzz, ts_yyz_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xxyyz_xxx[i] = ts_xxyy_xxx[i] * ga_z[i];

        ts_xxyyz_xxy[i] = ts_xxyy_xxy[i] * ga_z[i];

        ts_xxyyz_xxz[i] = ts_xxz_xxz[i] * gfe_0 + ts_xxyz_xxz[i] * ga_y[i];

        ts_xxyyz_xyy[i] = ts_xxyy_xyy[i] * ga_z[i];

        ts_xxyyz_xyz[i] = ts_xxyy_xy[i] * gfe_0 + ts_xxyy_xyz[i] * ga_z[i];

        ts_xxyyz_xzz[i] = ts_xxz_xzz[i] * gfe_0 + ts_xxyz_xzz[i] * ga_y[i];

        ts_xxyyz_yyy[i] = ts_xxyy_yyy[i] * ga_z[i];

        ts_xxyyz_yyz[i] = ts_yyz_yyz[i] * gfe_0 + ts_xyyz_yyz[i] * ga_x[i];

        ts_xxyyz_yzz[i] = ts_yyz_yzz[i] * gfe_0 + ts_xyyz_yzz[i] * ga_x[i];

        ts_xxyyz_zzz[i] = ts_yyz_zzz[i] * gfe_0 + ts_xyyz_zzz[i] * ga_x[i];
    }
    ...
    #pragma omp simd aligned(ga_x, ga_y, ts_xxyzz_xxx, ts_xxyzz_xxy, ts_xxyzz_xxz, ts_xxyzz_xyy, ts_xxyzz_xyz, ts_xxyzz_xzz, ts_xxyzz_yyy, ts_xxyzz_yyz, ts_xxyzz_yzz, ts_xxyzz_zzz, ts_xxzz_xx, ts_xxzz_xxx, ts_xxzz_xxy, ts_xxzz_xxz, ts_xxzz_xy, ts_xxzz_xyy, ts_xxzz_xyz, ts_xxzz_xz, ts_xxzz_xzz, ts_xxzz_zzz, ts_xyzz_yyy, ts_xyzz_yyz, ts_xyzz_yzz, ts_yzz_yyy, ts_yzz_yyz, ts_yzz_yzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xxyzz_xxx[i] = ts_xxzz_xxx[i] * ga_y[i];

        ts_xxyzz_xxy[i] = ts_xxzz_xx[i] * gfe_0 + ts_xxzz_xxy[i] * ga_y[i];

        ts_xxyzz_xxz[i] = ts_xxzz_xxz[i] * ga_y[i];

        ts_xxyzz_xyy[i] = 2.0 * ts_xxzz_xy[i] * gfe_0 + ts_xxzz_xyy[i] * ga_y[i];

        ts_xxyzz_xyz[i] = ts_xxzz_xz[i] * gfe_0 + ts_xxzz_xyz[i] * ga_y[i];

        ts_xxyzz_xzz[i] = ts_xxzz_xzz[i] * ga_y[i];

        ts_xxyzz_yyy[i] = ts_yzz_yyy[i] * gfe_0 + ts_xyzz_yyy[i] * ga_x[i];

        ts_xxyzz_yyz[i] = ts_yzz_yyz[i] * gfe_0 + ts_xyzz_yyz[i] * ga_x[i];

        ts_xxyzz_yzz[i] = ts_yzz_yzz[i] * gfe_0 + ts_xyzz_yzz[i] * ga_x[i];

        ts_xxyzz_zzz[i] = ts_xxzz_zzz[i] * ga_y[i];
    }
    ...
    #pragma omp simd aligned(ga_x, ga_z, ts_xxz_xxx, ts_xxz_xxy, ts_xxz_xyy, ts_xxzz_xxx, ts_xxzz_xxy, ts_xxzz_xyy, ts_xxzzz_xxx, ts_xxzzz_xxy, ts_xxzzz_xxz, ts_xxzzz_xyy, ts_xxzzz_xyz, ts_xxzzz_xzz, ts_xxzzz_yyy, ts_xxzzz_yyz, ts_xxzzz_yzz, ts_xxzzz_zzz, ts_xzzz_xxz, ts_xzzz_xyz, ts_xzzz_xz, ts_xzzz_xzz, ts_xzzz_yyy, ts_xzzz_yyz, ts_xzzz_yz, ts_xzzz_yzz, ts_xzzz_zz, ts_xzzz_zzz, ts_zzz_xxz, ts_zzz_xyz, ts_zzz_xzz, ts_zzz_yyy, ts_zzz_yyz, ts_zzz_yzz, ts_zzz_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xxzzz_xxx[i] = 2.0 * ts_xxz_xxx[i] * gfe_0 + ts_xxzz_xxx[i] * ga_z[i];

        ts_xxzzz_xxy[i] = 2.0 * ts_xxz_xxy[i] * gfe_0 + ts_xxzz_xxy[i] * ga_z[i];

        ts_xxzzz_xxz[i] = ts_zzz_xxz[i] * gfe_0 + 2.0 * ts_xzzz_xz[i] * gfe_0 + ts_xzzz_xxz[i] * ga_x[i];

        ts_xxzzz_xyy[i] = 2.0 * ts_xxz_xyy[i] * gfe_0 + ts_xxzz_xyy[i] * ga_z[i];

        ts_xxzzz_xyz[i] = ts_zzz_xyz[i] * gfe_0 + ts_xzzz_yz[i] * gfe_0 + ts_xzzz_xyz[i] * ga_x[i];

        ts_xxzzz_xzz[i] = ts_zzz_xzz[i] * gfe_0 + ts_xzzz_zz[i] * gfe_0 + ts_xzzz_xzz[i] * ga_x[i];

        ts_xxzzz_yyy[i] = ts_zzz_yyy[i] * gfe_0 + ts_xzzz_yyy[i] * ga_x[i];

        ts_xxzzz_yyz[i] = ts_zzz_yyz[i] * gfe_0 + ts_xzzz_yyz[i] * ga_x[i];

        ts_xxzzz_yzz[i] = ts_zzz_yzz[i] * gfe_0 + ts_xzzz_yzz[i] * ga_x[i];

        ts_xxzzz_zzz[i] = ts_zzz_zzz[i] * gfe_0 + ts_xzzz_zzz[i] * ga_x[i];
    }
    ...
    #pragma omp simd aligned(ga_x, ts_xyyyy_xxx, ts_xyyyy_xxy, ts_xyyyy_xxz, ts_xyyyy_xyy, ts_xyyyy_xyz, ts_xyyyy_xzz, ts_xyyyy_yyy, ts_xyyyy_yyz, ts_xyyyy_yzz, ts_xyyyy_zzz, ts_yyyy_xx, ts_yyyy_xxx, ts_yyyy_xxy, ts_yyyy_xxz, ts_yyyy_xy, ts_yyyy_xyy, ts_yyyy_xyz, ts_yyyy_xz, ts_yyyy_xzz, ts_yyyy_yy, ts_yyyy_yyy, ts_yyyy_yyz, ts_yyyy_yz, ts_yyyy_yzz, ts_yyyy_zz, ts_yyyy_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xyyyy_xxx[i] = 3.0 * ts_yyyy_xx[i] * gfe_0 + ts_yyyy_xxx[i] * ga_x[i];

        ts_xyyyy_xxy[i] = 2.0 * ts_yyyy_xy[i] * gfe_0 + ts_yyyy_xxy[i] * ga_x[i];

        ts_xyyyy_xxz[i] = 2.0 * ts_yyyy_xz[i] * gfe_0 + ts_yyyy_xxz[i] * ga_x[i];

        ts_xyyyy_xyy[i] = ts_yyyy_yy[i] * gfe_0 + ts_yyyy_xyy[i] * ga_x[i];

        ts_xyyyy_xyz[i] = ts_yyyy_yz[i] * gfe_0 + ts_yyyy_xyz[i] * ga_x[i];

        ts_xyyyy_xzz[i] = ts_yyyy_zz[i] * gfe_0 + ts_yyyy_xzz[i] * ga_x[i];

        ts_xyyyy_yyy[i] = ts_yyyy_yyy[i] * ga_x[i];

        ts_xyyyy_yyz[i] = ts_yyyy_yyz[i] * ga_x[i];

        ts_xyyyy_yzz[i] = ts_yyyy_yzz[i] * ga_x[i];

        ts_xyyyy_zzz[i] = ts_yyyy_zzz[i] * ga_x[i];
    }
    ...
    #pragma omp simd aligned(ga_x, ga_z, ts_xyyy_xxx, ts_xyyy_xxy, ts_xyyy_xyy, ts_xyyyz_xxx, ts_xyyyz_xxy, ts_xyyyz_xxz, ts_xyyyz_xyy, ts_xyyyz_xyz, ts_xyyyz_xzz, ts_xyyyz_yyy, ts_xyyyz_yyz, ts_xyyyz_yzz, ts_xyyyz_zzz, ts_yyyz_xxz, ts_yyyz_xyz, ts_yyyz_xz, ts_yyyz_xzz, ts_yyyz_yyy, ts_yyyz_yyz, ts_yyyz_yz, ts_yyyz_yzz, ts_yyyz_zz, ts_yyyz_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xyyyz_xxx[i] = ts_xyyy_xxx[i] * ga_z[i];

        ts_xyyyz_xxy[i] = ts_xyyy_xxy[i] * ga_z[i];

        ts_xyyyz_xxz[i] = 2.0 * ts_yyyz_xz[i] * gfe_0 + ts_yyyz_xxz[i] * ga_x[i];

        ts_xyyyz_xyy[i] = ts_xyyy_xyy[i] * ga_z[i];

        ts_xyyyz_xyz[i] = ts_yyyz_yz[i] * gfe_0 + ts_yyyz_xyz[i] * ga_x[i];

        ts_xyyyz_xzz[i] = ts_yyyz_zz[i] * gfe_0 + ts_yyyz_xzz[i] * ga_x[i];

        ts_xyyyz_yyy[i] = ts_yyyz_yyy[i] * ga_x[i];

        ts_xyyyz_yyz[i] = ts_yyyz_yyz[i] * ga_x[i];

        ts_xyyyz_yzz[i] = ts_yyyz_yzz[i] * ga_x[i];

        ts_xyyyz_zzz[i] = ts_yyyz_zzz[i] * ga_x[i];
    }
    ...
    #pragma omp simd aligned(ga_x, ts_xyyzz_xxx, ts_xyyzz_xxy, ts_xyyzz_xxz, ts_xyyzz_xyy, ts_xyyzz_xyz, ts_xyyzz_xzz, ts_xyyzz_yyy, ts_xyyzz_yyz, ts_xyyzz_yzz, ts_xyyzz_zzz, ts_yyzz_xx, ts_yyzz_xxx, ts_yyzz_xxy, ts_yyzz_xxz, ts_yyzz_xy, ts_yyzz_xyy, ts_yyzz_xyz, ts_yyzz_xz, ts_yyzz_xzz, ts_yyzz_yy, ts_yyzz_yyy, ts_yyzz_yyz, ts_yyzz_yz, ts_yyzz_yzz, ts_yyzz_zz, ts_yyzz_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xyyzz_xxx[i] = 3.0 * ts_yyzz_xx[i] * gfe_0 + ts_yyzz_xxx[i] * ga_x[i];

        ts_xyyzz_xxy[i] = 2.0 * ts_yyzz_xy[i] * gfe_0 + ts_yyzz_xxy[i] * ga_x[i];

        ts_xyyzz_xxz[i] = 2.0 * ts_yyzz_xz[i] * gfe_0 + ts_yyzz_xxz[i] * ga_x[i];

        ts_xyyzz_xyy[i] = ts_yyzz_yy[i] * gfe_0 + ts_yyzz_xyy[i] * ga_x[i];

        ts_xyyzz_xyz[i] = ts_yyzz_yz[i] * gfe_0 + ts_yyzz_xyz[i] * ga_x[i];

        ts_xyyzz_xzz[i] = ts_yyzz_zz[i] * gfe_0 + ts_yyzz_xzz[i] * ga_x[i];

        ts_xyyzz_yyy[i] = ts_yyzz_yyy[i] * ga_x[i];

        ts_xyyzz_yyz[i] = ts_yyzz_yyz[i] * ga_x[i];

        ts_xyyzz_yzz[i] = ts_yyzz_yzz[i] * ga_x[i];

        ts_xyyzz_zzz[i] = ts_yyzz_zzz[i] * ga_x[i];
    }
    ...
    #pragma omp simd aligned(ga_x, ga_y, ts_xyzzz_xxx, ts_xyzzz_xxy, ts_xyzzz_xxz, ts_xyzzz_xyy, ts_xyzzz_xyz, ts_xyzzz_xzz, ts_xyzzz_yyy, ts_xyzzz_yyz, ts_xyzzz_yzz, ts_xyzzz_zzz, ts_xzzz_xxx, ts_xzzz_xxz, ts_xzzz_xzz, ts_yzzz_xxy, ts_yzzz_xy, ts_yzzz_xyy, ts_yzzz_xyz, ts_yzzz_yy, ts_yzzz_yyy, ts_yzzz_yyz, ts_yzzz_yz, ts_yzzz_yzz, ts_yzzz_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xyzzz_xxx[i] = ts_xzzz_xxx[i] * ga_y[i];

        ts_xyzzz_xxy[i] = 2.0 * ts_yzzz_xy[i] * gfe_0 + ts_yzzz_xxy[i] * ga_x[i];

        ts_xyzzz_xxz[i] = ts_xzzz_xxz[i] * ga_y[i];

        ts_xyzzz_xyy[i] = ts_yzzz_yy[i] * gfe_0 + ts_yzzz_xyy[i] * ga_x[i];

        ts_xyzzz_xyz[i] = ts_yzzz_yz[i] * gfe_0 + ts_yzzz_xyz[i] * ga_x[i];

        ts_xyzzz_xzz[i] = ts_xzzz_xzz[i] * ga_y[i];

        ts_xyzzz_yyy[i] = ts_yzzz_yyy[i] * ga_x[i];

        ts_xyzzz_yyz[i] = ts_yzzz_yyz[i] * ga_x[i];

        ts_xyzzz_yzz[i] = ts_yzzz_yzz[i] * ga_x[i];

        ts_xyzzz_zzz[i] = ts_yzzz_zzz[i] * ga_x[i];
    }
    ...
    #pragma omp simd aligned(ga_x, ts_xzzzz_xxx, ts_xzzzz_xxy, ts_xzzzz_xxz, ts_xzzzz_xyy, ts_xzzzz_xyz, ts_xzzzz_xzz, ts_xzzzz_yyy, ts_xzzzz_yyz, ts_xzzzz_yzz, ts_xzzzz_zzz, ts_zzzz_xx, ts_zzzz_xxx, ts_zzzz_xxy, ts_zzzz_xxz, ts_zzzz_xy, ts_zzzz_xyy, ts_zzzz_xyz, ts_zzzz_xz, ts_zzzz_xzz, ts_zzzz_yy, ts_zzzz_yyy, ts_zzzz_yyz, ts_zzzz_yz, ts_zzzz_yzz, ts_zzzz_zz, ts_zzzz_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xzzzz_xxx[i] = 3.0 * ts_zzzz_xx[i] * gfe_0 + ts_zzzz_xxx[i] * ga_x[i];

        ts_xzzzz_xxy[i] = 2.0 * ts_zzzz_xy[i] * gfe_0 + ts_zzzz_xxy[i] * ga_x[i];

        ts_xzzzz_xxz[i] = 2.0 * ts_zzzz_xz[i] * gfe_0 + ts_zzzz_xxz[i] * ga_x[i];

        ts_xzzzz_xyy[i] = ts_zzzz_yy[i] * gfe_0 + ts_zzzz_xyy[i] * ga_x[i];

        ts_xzzzz_xyz[i] = ts_zzzz_yz[i] * gfe_0 + ts_zzzz_xyz[i] * ga_x[i];

        ts_xzzzz_xzz[i] = ts_zzzz_zz[i] * gfe_0 + ts_zzzz_xzz[i] * ga_x[i];

        ts_xzzzz_yyy[i] = ts_zzzz_yyy[i] * ga_x[i];

        ts_xzzzz_yyz[i] = ts_zzzz_yyz[i] * ga_x[i];

        ts_xzzzz_yzz[i] = ts_zzzz_yzz[i] * ga_x[i];

        ts_xzzzz_zzz[i] = ts_zzzz_zzz[i] * ga_x[i];
    }
    ...
    #pragma omp simd aligned(ga_y, ts_yyy_xxx, ts_yyy_xxy, ts_yyy_xxz, ts_yyy_xyy, ts_yyy_xyz, ts_yyy_xzz, ts_yyy_yyy, ts_yyy_yyz, ts_yyy_yzz, ts_yyy_zzz, ts_yyyy_xx, ts_yyyy_xxx, ts_yyyy_xxy, ts_yyyy_xxz, ts_yyyy_xy, ts_yyyy_xyy, ts_yyyy_xyz, ts_yyyy_xz, ts_yyyy_xzz, ts_yyyy_yy, ts_yyyy_yyy, ts_yyyy_yyz, ts_yyyy_yz, ts_yyyy_yzz, ts_yyyy_zz, ts_yyyy_zzz, ts_yyyyy_xxx, ts_yyyyy_xxy, ts_yyyyy_xxz, ts_yyyyy_xyy, ts_yyyyy_xyz, ts_yyyyy_xzz, ts_yyyyy_yyy, ts_yyyyy_yyz, ts_yyyyy_yzz, ts_yyyyy_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_yyyyy_xxx[i] = 4.0 * ts_yyy_xxx[i] * gfe_0 + ts_yyyy_xxx[i] * ga_y[i];

        ts_yyyyy_xxy[i] = 4.0 * ts_yyy_xxy[i] * gfe_0 + ts_yyyy_xx[i] * gfe_0 + ts_yyyy_xxy[i] * ga_y[i];

        ts_yyyyy_xxz[i] = 4.0 * ts_yyy_xxz[i] * gfe_0 + ts_yyyy_xxz[i] * ga_y[i];

        ts_yyyyy_xyy[i] = 4.0 * ts_yyy_xyy[i] * gfe_0 + 2.0 * ts_yyyy_xy[i] * gfe_0 + ts_yyyy_xyy[i] * ga_y[i];

        ts_yyyyy_xyz[i] = 4.0 * ts_yyy_xyz[i] * gfe_0 + ts_yyyy_xz[i] * gfe_0 + ts_yyyy_xyz[i] * ga_y[i];

        ts_yyyyy_xzz[i] = 4.0 * ts_yyy_xzz[i] * gfe_0 + ts_yyyy_xzz[i] * ga_y[i];

        ts_yyyyy_yyy[i] = 4.0 * ts_yyy_yyy[i] * gfe_0 + 3.0 * ts_yyyy_yy[i] * gfe_0 + ts_yyyy_yyy[i] * ga_y[i];

        ts_yyyyy_yyz[i] = 4.0 * ts_yyy_yyz[i] * gfe_0 + 2.0 * ts_yyyy_yz[i] * gfe_0 + ts_yyyy_yyz[i] * ga_y[i];

        ts_yyyyy_yzz[i] = 4.0 * ts_yyy_yzz[i] * gfe_0 + ts_yyyy_zz[i] * gfe_0 + ts_yyyy_yzz[i] * ga_y[i];

        ts_yyyyy_zzz[i] = 4.0 * ts_yyy_zzz[i] * gfe_0 + ts_yyyy_zzz[i] * ga_y[i];
    }
    ...
    #pragma omp simd aligned(ga_y, ga_z, ts_yyyy_xxx, ts_yyyy_xxy, ts_yyyy_xy, ts_yyyy_xyy, ts_yyyy_xyz, ts_yyyy_yy, ts_yyyy_yyy, ts_yyyy_yyz, ts_yyyy_yz, ts_yyyy_yzz, ts_yyyyz_xxx, ts_yyyyz_xxy, ts_yyyyz_xxz, ts_yyyyz_xyy, ts_yyyyz_xyz, ts_yyyyz_xzz, ts_yyyyz_yyy, ts_yyyyz_yyz, ts_yyyyz_yzz, ts_yyyyz_zzz, ts_yyyz_xxz, ts_yyyz_xzz, ts_yyyz_zzz, ts_yyz_xxz, ts_yyz_xzz, ts_yyz_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_yyyyz_xxx[i] = ts_yyyy_xxx[i] * ga_z[i];

        ts_yyyyz_xxy[i] = ts_yyyy_xxy[i] * ga_z[i];

        ts_yyyyz_xxz[i] = 3.0 * ts_yyz_xxz[i] * gfe_0 + ts_yyyz_xxz[i] * ga_y[i];

        ts_yyyyz_xyy[i] = ts_yyyy_xyy[i] * ga_z[i];

        ts_yyyyz_xyz[i] = ts_yyyy_xy[i] * gfe_0 + ts_yyyy_xyz[i] * ga_z[i];

        ts_yyyyz_xzz[i] = 3.0 * ts_yyz_xzz[i] * gfe_0 + ts_yyyz_xzz[i] * ga_y[i];

        ts_yyyyz_yyy[i] = ts_yyyy_yyy[i] * ga_z[i];

        ts_yyyyz_yyz[i] = ts_yyyy_yy[i] * gfe_0 + ts_yyyy_yyz[i] * ga_z[i];

        ts_yyyyz_yzz[i] = 2.0 * ts_yyyy_yz[i] * gfe_0 + ts_yyyy_yzz[i] * ga_z[i];

        ts_yyyyz_zzz[i] = 3.0 * ts_yyz_zzz[i] * gfe_0 + ts_yyyz_zzz[i] * ga_y[i];
    }
    ...
    #pragma omp simd aligned(ga_y, ga_z, ts_yyy_xxy, ts_yyy_xyy, ts_yyy_yyy, ts_yyyz_xxy, ts_yyyz_xyy, ts_yyyz_yyy, ts_yyyzz_xxx, ts_yyyzz_xxy, ts_yyyzz_xxz, ts_yyyzz_xyy, ts_yyyzz_xyz, ts_yyyzz_xzz, ts_yyyzz_yyy, ts_yyyzz_yyz, ts_yyyzz_yzz, ts_yyyzz_zzz, ts_yyzz_xxx, ts_yyzz_xxz, ts_yyzz_xyz, ts_yyzz_xz, ts_yyzz_xzz, ts_yyzz_yyz, ts_yyzz_yz, ts_yyzz_yzz, ts_yyzz_zz, ts_yyzz_zzz, ts_yzz_xxx, ts_yzz_xxz, ts_yzz_xyz, ts_yzz_xzz, ts_yzz_yyz, ts_yzz_yzz, ts_yzz_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_yyyzz_xxx[i] = 2.0 * ts_yzz_xxx[i] * gfe_0 + ts_yyzz_xxx[i] * ga_y[i];

        ts_yyyzz_xxy[i] = ts_yyy_xxy[i] * gfe_0 + ts_yyyz_xxy[i] * ga_z[i];

        ts_yyyzz_xxz[i] = 2.0 * ts_yzz_xxz[i] * gfe_0 + ts_yyzz_xxz[i] * ga_y[i];

        ts_yyyzz_xyy[i] = ts_yyy_xyy[i] * gfe_0 + ts_yyyz_xyy[i] * ga_z[i];

        ts_yyyzz_xyz[i] = 2.0 * ts_yzz_xyz[i] * gfe_0 + ts_yyzz_xz[i] * gfe_0 + ts_yyzz_xyz[i] * ga_y[i];

        ts_yyyzz_xzz[i] = 2.0 * ts_yzz_xzz[i] * gfe_0 + ts_yyzz_xzz[i] * ga_y[i];

        ts_yyyzz_yyy[i] = ts_yyy_yyy[i] * gfe_0 + ts_yyyz_yyy[i] * ga_z[i];

        ts_yyyzz_yyz[i] = 2.0 * ts_yzz_yyz[i] * gfe_0 + 2.0 * ts_yyzz_yz[i] * gfe_0 + ts_yyzz_yyz[i] * ga_y[i];

        ts_yyyzz_yzz[i] = 2.0 * ts_yzz_yzz[i] * gfe_0 + ts_yyzz_zz[i] * gfe_0 + ts_yyzz_yzz[i] * ga_y[i];

        ts_yyyzz_zzz[i] = 2.0 * ts_yzz_zzz[i] * gfe_0 + ts_yyzz_zzz[i] * ga_y[i];
    }
    ...
    #pragma omp simd aligned(ga_y, ga_z, ts_yyz_xxy, ts_yyz_xyy, ts_yyz_yyy, ts_yyzz_xxy, ts_yyzz_xyy, ts_yyzz_yyy, ts_yyzzz_xxx, ts_yyzzz_xxy, ts_yyzzz_xxz, ts_yyzzz_xyy, ts_yyzzz_xyz, ts_yyzzz_xzz, ts_yyzzz_yyy, ts_yyzzz_yyz, ts_yyzzz_yzz, ts_yyzzz_zzz, ts_yzzz_xxx, ts_yzzz_xxz, ts_yzzz_xyz, ts_yzzz_xz, ts_yzzz_xzz, ts_yzzz_yyz, ts_yzzz_yz, ts_yzzz_yzz, ts_yzzz_zz, ts_yzzz_zzz, ts_zzz_xxx, ts_zzz_xxz, ts_zzz_xyz, ts_zzz_xzz, ts_zzz_yyz, ts_zzz_yzz, ts_zzz_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_yyzzz_xxx[i] = ts_zzz_xxx[i] * gfe_0 + ts_yzzz_xxx[i] * ga_y[i];

        ts_yyzzz_xxy[i] = 2.0 * ts_yyz_xxy[i] * gfe_0 + ts_yyzz_xxy[i] * ga_z[i];

        ts_yyzzz_xxz[i] = ts_zzz_xxz[i] * gfe_0 + ts_yzzz_xxz[i] * ga_y[i];

        ts_yyzzz_xyy[i] = 2.0 * ts_yyz_xyy[i] * gfe_0 + ts_yyzz_xyy[i] * ga_z[i];

        ts_yyzzz_xyz[i] = ts_zzz_xyz[i] * gfe_0 + ts_yzzz_xz[i] * gfe_0 + ts_yzzz_xyz[i] * ga_y[i];

        ts_yyzzz_xzz[i] = ts_zzz_xzz[i] * gfe_0 + ts_yzzz_xzz[i] * ga_y[i];

        ts_yyzzz_yyy[i] = 2.0 * ts_yyz_yyy[i] * gfe_0 + ts_yyzz_yyy[i] * ga_z[i];

        ts_yyzzz_yyz[i] = ts_zzz_yyz[i] * gfe_0 + 2.0 * ts_yzzz_yz[i] * gfe_0 + ts_yzzz_yyz[i] * ga_y[i];

        ts_yyzzz_yzz[i] = ts_zzz_yzz[i] * gfe_0 + ts_yzzz_zz[i] * gfe_0 + ts_yzzz_yzz[i] * ga_y[i];

        ts_yyzzz_zzz[i] = ts_zzz_zzz[i] * gfe_0 + ts_yzzz_zzz[i] * ga_y[i];
    }
    ...
    #pragma omp simd aligned(ga_y, ts_yzzzz_xxx, ts_yzzzz_xxy, ts_yzzzz_xxz, ts_yzzzz_xyy, ts_yzzzz_xyz, ts_yzzzz_xzz, ts_yzzzz_yyy, ts_yzzzz_yyz, ts_yzzzz_yzz, ts_yzzzz_zzz, ts_zzzz_xx, ts_zzzz_xxx, ts_zzzz_xxy, ts_zzzz_xxz, ts_zzzz_xy, ts_zzzz_xyy, ts_zzzz_xyz, ts_zzzz_xz, ts_zzzz_xzz, ts_zzzz_yy, ts_zzzz_yyy, ts_zzzz_yyz, ts_zzzz_yz, ts_zzzz_yzz, ts_zzzz_zz, ts_zzzz_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_yzzzz_xxx[i] = ts_zzzz_xxx[i] * ga_y[i];

        ts_yzzzz_xxy[i] = ts_zzzz_xx[i] * gfe_0 + ts_zzzz_xxy[i] * ga_y[i];

        ts_yzzzz_xxz[i] = ts_zzzz_xxz[i] * ga_y[i];

        ts_yzzzz_xyy[i] = 2.0 * ts_zzzz_xy[i] * gfe_0 + ts_zzzz_xyy[i] * ga_y[i];

        ts_yzzzz_xyz[i] = ts_zzzz_xz[i] * gfe_0 + ts_zzzz_xyz[i] * ga_y[i];

        ts_yzzzz_xzz[i] = ts_zzzz_xzz[i] * ga_y[i];

        ts_yzzzz_yyy[i] = 3.0 * ts_zzzz_yy[i] * gfe_0 + ts_zzzz_yyy[i] * ga_y[i];

        ts_yzzzz_yyz[i] = 2.0 * ts_zzzz_yz[i] * gfe_0 + ts_zzzz_yyz[i] * ga_y[i];

        ts_yzzzz_yzz[i] = ts_zzzz_zz[i] * gfe_0 + ts_zzzz_yzz[i] * ga_y[i];

        ts_yzzzz_zzz[i] = ts_zzzz_zzz[i] * ga_y[i];
    }
    ...
    #pragma omp simd aligned(ga_z, ts_zzz_xxx, ts_zzz_xxy, ts_zzz_xxz, ts_zzz_xyy, ts_zzz_xyz, ts_zzz_xzz, ts_zzz_yyy, ts_zzz_yyz, ts_zzz_yzz, ts_zzz_zzz, ts_zzzz_xx, ts_zzzz_xxx, ts_zzzz_xxy, ts_zzzz_xxz, ts_zzzz_xy, ts_zzzz_xyy, ts_zzzz_xyz, ts_zzzz_xz, ts_zzzz_xzz, ts_zzzz_yy, ts_zzzz_yyy, ts_zzzz_yyz, ts_zzzz_yz, ts_zzzz_yzz, ts_zzzz_zz, ts_zzzz_zzz, ts_zzzzz_xxx, ts_zzzzz_xxy, ts_zzzzz_xxz, ts_zzzzz_xyy, ts_zzzzz_xyz, ts_zzzzz_xzz, ts_zzzzz_yyy, ts_zzzzz_yyz, ts_zzzzz_yzz, ts_zzzzz_zzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_zzzzz_xxx[i] = 4.0 * ts_zzz_xxx[i] * gfe_0 + ts_zzzz_xxx[i] * ga_z[i];

        ts_zzzzz_xxy[i] = 4.0 * ts_zzz_xxy[i] * gfe_0 + ts_zzzz_xxy[i] * ga_z[i];

        ts_zzzzz_xxz[i] = 4.0 * ts_zzz_xxz[i] * gfe_0 + ts_zzzz_xx[i] * gfe_0 + ts_zzzz_xxz[i] * ga_z[i];

        ts_zzzzz_xyy[i] = 4.0 * ts_zzz_xyy[i] * gfe_0 + ts_zzzz_xyy[i] * ga_z[i];

        ts_zzzzz_xyz[i] = 4.0 * ts_zzz_xyz[i] * gfe_0 + ts_zzzz_xy[i] * gfe_0 + ts_zzzz_xyz[i] * ga_z[i];

        ts_zzzzz_xzz[i] = 4.0 * ts_zzz_xzz[i] * gfe_0 + 2.0 * ts_zzzz_xz[i] * gfe_0 + ts_zzzz_xzz[i] * ga_z[i];

        ts_zzzzz_yyy[i] = 4.0 * ts_zzz_yyy[i] * gfe_0 + ts_zzzz_yyy[i] * ga_z[i];

        ts_zzzzz_yyz[i] = 4.0 * ts_zzz_yyz[i] * gfe_0 + ts_zzzz_yy[i] * gfe_0 + ts_zzzz_yyz[i] * ga_z[i];

        ts_zzzzz_yzz[i] = 4.0 * ts_zzz_yzz[i] * gfe_0 + 2.0 * ts_zzzz_yz[i] * gfe_0 + ts_zzzz_yzz[i] * ga_z[i];

        ts_zzzzz_zzz[i] = 4.0 * ts_zzz_zzz[i] * gfe_0 + 3.0 * ts_zzzz_zz[i] * gfe_0 + ts_zzzz_zzz[i] * ga_z[i];
    }
