#ifndef ThreeCenterOverlapPrimRecHP
#define ThreeCenterOverlapPrimRecHP

#include "SimdArray.hpp"

namespace t3ovlrec { // t3ovlrec namespace

/// @brief Computes primitive [H|G(r)|P]  integrals for set of data buffers.
...
#endif /* ThreeCenterOverlapPrimRecHP */
