#ifndef ThreeCenterOverlapPrimRecGH
#define ThreeCenterOverlapPrimRecGH

#include "SimdArray.hpp"

namespace t3ovlrec { // t3ovlrec namespace

/// @brief Computes primitive [G|G(r)|H]  integrals for set of data buffers.
...
#endif /* ThreeCenterOverlapPrimRecGH */
