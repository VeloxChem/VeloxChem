#ifndef ThreeCenterOverlapSumRecGF_hpp
#define ThreeCenterOverlapSumRecGF_hpp
...
/// @brief Computes (G|G(r)|F)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_gf(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t2cfunc::reduce(cbuffer, pbuffer, 355, ket_width, ket_npgtos);
                }
            }
...
#endif /* ThreeCenterOverlapSumRecGF_hpp */
