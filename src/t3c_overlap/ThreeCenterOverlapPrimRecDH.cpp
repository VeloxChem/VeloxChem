#include "ThreeCenterOverlapPrimRecDH.hpp"
                     ...
                     const double c_exp) -> void
{
    ...
    #pragma omp simd aligned(ga_x, ts_0_xxxxx, ts_0_xxxxy, ts_0_xxxxz, ts_0_xxxyy, ts_0_xxxyz, ts_0_xxxzz, ts_0_xxyyy, ts_0_xxyyz, ts_0_xxyzz, ts_0_xxzzz, ts_0_xyyyy, ts_0_xyyyz, ts_0_xyyzz, ts_0_xyzzz, ts_0_xzzzz, ts_0_yyyyy, ts_0_yyyyz, ts_0_yyyzz, ts_0_yyzzz, ts_0_yzzzz, ts_0_zzzzz, ts_x_xxxx, ts_x_xxxxx, ts_x_xxxxy, ts_x_xxxxz, ts_x_xxxy, ts_x_xxxyy, ts_x_xxxyz, ts_x_xxxz, ts_x_xxxzz, ts_x_xxyy, ts_x_xxyyy, ts_x_xxyyz, ts_x_xxyz, ts_x_xxyzz, ts_x_xxzz, ts_x_xxzzz, ts_x_xyyy, ts_x_xyyyy, ts_x_xyyyz, ts_x_xyyz, ts_x_xyyzz, ts_x_xyzz, ts_x_xyzzz, ts_x_xzzz, ts_x_xzzzz, ts_x_yyyy, ts_x_yyyyy, ts_x_yyyyz, ts_x_yyyz, ts_x_yyyzz, ts_x_yyzz, ts_x_yyzzz, ts_x_yzzz, ts_x_yzzzz, ts_x_zzzz, ts_x_zzzzz, ts_xx_xxxxx, ts_xx_xxxxy, ts_xx_xxxxz, ts_xx_xxxyy, ts_xx_xxxyz, ts_xx_xxxzz, ts_xx_xxyyy, ts_xx_xxyyz, ts_xx_xxyzz, ts_xx_xxzzz, ts_xx_xyyyy, ts_xx_xyyyz, ts_xx_xyyzz, ts_xx_xyzzz, ts_xx_xzzzz, ts_xx_yyyyy, ts_xx_yyyyz, ts_xx_yyyzz, ts_xx_yyzzz, ts_xx_yzzzz, ts_xx_zzzzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xx_xxxxx[i] = ts_0_xxxxx[i] * gfe_0 + 5.0 * ts_x_xxxx[i] * gfe_0 + ts_x_xxxxx[i] * ga_x[i];

        ts_xx_xxxxy[i] = ts_0_xxxxy[i] * gfe_0 + 4.0 * ts_x_xxxy[i] * gfe_0 + ts_x_xxxxy[i] * ga_x[i];

        ts_xx_xxxxz[i] = ts_0_xxxxz[i] * gfe_0 + 4.0 * ts_x_xxxz[i] * gfe_0 + ts_x_xxxxz[i] * ga_x[i];

        ts_xx_xxxyy[i] = ts_0_xxxyy[i] * gfe_0 + 3.0 * ts_x_xxyy[i] * gfe_0 + ts_x_xxxyy[i] * ga_x[i];

        ts_xx_xxxyz[i] = ts_0_xxxyz[i] * gfe_0 + 3.0 * ts_x_xxyz[i] * gfe_0 + ts_x_xxxyz[i] * ga_x[i];

        ts_xx_xxxzz[i] = ts_0_xxxzz[i] * gfe_0 + 3.0 * ts_x_xxzz[i] * gfe_0 + ts_x_xxxzz[i] * ga_x[i];

        ts_xx_xxyyy[i] = ts_0_xxyyy[i] * gfe_0 + 2.0 * ts_x_xyyy[i] * gfe_0 + ts_x_xxyyy[i] * ga_x[i];

        ts_xx_xxyyz[i] = ts_0_xxyyz[i] * gfe_0 + 2.0 * ts_x_xyyz[i] * gfe_0 + ts_x_xxyyz[i] * ga_x[i];

        ts_xx_xxyzz[i] = ts_0_xxyzz[i] * gfe_0 + 2.0 * ts_x_xyzz[i] * gfe_0 + ts_x_xxyzz[i] * ga_x[i];

        ts_xx_xxzzz[i] = ts_0_xxzzz[i] * gfe_0 + 2.0 * ts_x_xzzz[i] * gfe_0 + ts_x_xxzzz[i] * ga_x[i];

        ts_xx_xyyyy[i] = ts_0_xyyyy[i] * gfe_0 + ts_x_yyyy[i] * gfe_0 + ts_x_xyyyy[i] * ga_x[i];

        ts_xx_xyyyz[i] = ts_0_xyyyz[i] * gfe_0 + ts_x_yyyz[i] * gfe_0 + ts_x_xyyyz[i] * ga_x[i];

        ts_xx_xyyzz[i] = ts_0_xyyzz[i] * gfe_0 + ts_x_yyzz[i] * gfe_0 + ts_x_xyyzz[i] * ga_x[i];

        ts_xx_xyzzz[i] = ts_0_xyzzz[i] * gfe_0 + ts_x_yzzz[i] * gfe_0 + ts_x_xyzzz[i] * ga_x[i];

        ts_xx_xzzzz[i] = ts_0_xzzzz[i] * gfe_0 + ts_x_zzzz[i] * gfe_0 + ts_x_xzzzz[i] * ga_x[i];

        ts_xx_yyyyy[i] = ts_0_yyyyy[i] * gfe_0 + ts_x_yyyyy[i] * ga_x[i];

        ts_xx_yyyyz[i] = ts_0_yyyyz[i] * gfe_0 + ts_x_yyyyz[i] * ga_x[i];

        ts_xx_yyyzz[i] = ts_0_yyyzz[i] * gfe_0 + ts_x_yyyzz[i] * ga_x[i];

        ts_xx_yyzzz[i] = ts_0_yyzzz[i] * gfe_0 + ts_x_yyzzz[i] * ga_x[i];

        ts_xx_yzzzz[i] = ts_0_yzzzz[i] * gfe_0 + ts_x_yzzzz[i] * ga_x[i];

        ts_xx_zzzzz[i] = ts_0_zzzzz[i] * gfe_0 + ts_x_zzzzz[i] * ga_x[i];
    }
    ...
    #pragma omp simd aligned(ga_x, ga_y, ts_x_xxxxx, ts_x_xxxxz, ts_x_xxxzz, ts_x_xxzzz, ts_x_xzzzz, ts_xy_xxxxx, ts_xy_xxxxy, ts_xy_xxxxz, ts_xy_xxxyy, ts_xy_xxxyz, ts_xy_xxxzz, ts_xy_xxyyy, ts_xy_xxyyz, ts_xy_xxyzz, ts_xy_xxzzz, ts_xy_xyyyy, ts_xy_xyyyz, ts_xy_xyyzz, ts_xy_xyzzz, ts_xy_xzzzz, ts_xy_yyyyy, ts_xy_yyyyz, ts_xy_yyyzz, ts_xy_yyzzz, ts_xy_yzzzz, ts_xy_zzzzz, ts_y_xxxxy, ts_y_xxxy, ts_y_xxxyy, ts_y_xxxyz, ts_y_xxyy, ts_y_xxyyy, ts_y_xxyyz, ts_y_xxyz, ts_y_xxyzz, ts_y_xyyy, ts_y_xyyyy, ts_y_xyyyz, ts_y_xyyz, ts_y_xyyzz, ts_y_xyzz, ts_y_xyzzz, ts_y_yyyy, ts_y_yyyyy, ts_y_yyyyz, ts_y_yyyz, ts_y_yyyzz, ts_y_yyzz, ts_y_yyzzz, ts_y_yzzz, ts_y_yzzzz, ts_y_zzzzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xy_xxxxx[i] = ts_x_xxxxx[i] * ga_y[i];

        ts_xy_xxxxy[i] = 4.0 * ts_y_xxxy[i] * gfe_0 + ts_y_xxxxy[i] * ga_x[i];

        ts_xy_xxxxz[i] = ts_x_xxxxz[i] * ga_y[i];

        ts_xy_xxxyy[i] = 3.0 * ts_y_xxyy[i] * gfe_0 + ts_y_xxxyy[i] * ga_x[i];

        ts_xy_xxxyz[i] = 3.0 * ts_y_xxyz[i] * gfe_0 + ts_y_xxxyz[i] * ga_x[i];

        ts_xy_xxxzz[i] = ts_x_xxxzz[i] * ga_y[i];

        ts_xy_xxyyy[i] = 2.0 * ts_y_xyyy[i] * gfe_0 + ts_y_xxyyy[i] * ga_x[i];

        ts_xy_xxyyz[i] = 2.0 * ts_y_xyyz[i] * gfe_0 + ts_y_xxyyz[i] * ga_x[i];

        ts_xy_xxyzz[i] = 2.0 * ts_y_xyzz[i] * gfe_0 + ts_y_xxyzz[i] * ga_x[i];

        ts_xy_xxzzz[i] = ts_x_xxzzz[i] * ga_y[i];

        ts_xy_xyyyy[i] = ts_y_yyyy[i] * gfe_0 + ts_y_xyyyy[i] * ga_x[i];

        ts_xy_xyyyz[i] = ts_y_yyyz[i] * gfe_0 + ts_y_xyyyz[i] * ga_x[i];

        ts_xy_xyyzz[i] = ts_y_yyzz[i] * gfe_0 + ts_y_xyyzz[i] * ga_x[i];

        ts_xy_xyzzz[i] = ts_y_yzzz[i] * gfe_0 + ts_y_xyzzz[i] * ga_x[i];

        ts_xy_xzzzz[i] = ts_x_xzzzz[i] * ga_y[i];

        ts_xy_yyyyy[i] = ts_y_yyyyy[i] * ga_x[i];

        ts_xy_yyyyz[i] = ts_y_yyyyz[i] * ga_x[i];

        ts_xy_yyyzz[i] = ts_y_yyyzz[i] * ga_x[i];

        ts_xy_yyzzz[i] = ts_y_yyzzz[i] * ga_x[i];

        ts_xy_yzzzz[i] = ts_y_yzzzz[i] * ga_x[i];

        ts_xy_zzzzz[i] = ts_y_zzzzz[i] * ga_x[i];
    }
    ...
    #pragma omp simd aligned(ga_x, ga_z, ts_x_xxxxx, ts_x_xxxxy, ts_x_xxxyy, ts_x_xxyyy, ts_x_xyyyy, ts_xz_xxxxx, ts_xz_xxxxy, ts_xz_xxxxz, ts_xz_xxxyy, ts_xz_xxxyz, ts_xz_xxxzz, ts_xz_xxyyy, ts_xz_xxyyz, ts_xz_xxyzz, ts_xz_xxzzz, ts_xz_xyyyy, ts_xz_xyyyz, ts_xz_xyyzz, ts_xz_xyzzz, ts_xz_xzzzz, ts_xz_yyyyy, ts_xz_yyyyz, ts_xz_yyyzz, ts_xz_yyzzz, ts_xz_yzzzz, ts_xz_zzzzz, ts_z_xxxxz, ts_z_xxxyz, ts_z_xxxz, ts_z_xxxzz, ts_z_xxyyz, ts_z_xxyz, ts_z_xxyzz, ts_z_xxzz, ts_z_xxzzz, ts_z_xyyyz, ts_z_xyyz, ts_z_xyyzz, ts_z_xyzz, ts_z_xyzzz, ts_z_xzzz, ts_z_xzzzz, ts_z_yyyyy, ts_z_yyyyz, ts_z_yyyz, ts_z_yyyzz, ts_z_yyzz, ts_z_yyzzz, ts_z_yzzz, ts_z_yzzzz, ts_z_zzzz, ts_z_zzzzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_xz_xxxxx[i] = ts_x_xxxxx[i] * ga_z[i];

        ts_xz_xxxxy[i] = ts_x_xxxxy[i] * ga_z[i];

        ts_xz_xxxxz[i] = 4.0 * ts_z_xxxz[i] * gfe_0 + ts_z_xxxxz[i] * ga_x[i];

        ts_xz_xxxyy[i] = ts_x_xxxyy[i] * ga_z[i];

        ts_xz_xxxyz[i] = 3.0 * ts_z_xxyz[i] * gfe_0 + ts_z_xxxyz[i] * ga_x[i];

        ts_xz_xxxzz[i] = 3.0 * ts_z_xxzz[i] * gfe_0 + ts_z_xxxzz[i] * ga_x[i];

        ts_xz_xxyyy[i] = ts_x_xxyyy[i] * ga_z[i];

        ts_xz_xxyyz[i] = 2.0 * ts_z_xyyz[i] * gfe_0 + ts_z_xxyyz[i] * ga_x[i];

        ts_xz_xxyzz[i] = 2.0 * ts_z_xyzz[i] * gfe_0 + ts_z_xxyzz[i] * ga_x[i];

        ts_xz_xxzzz[i] = 2.0 * ts_z_xzzz[i] * gfe_0 + ts_z_xxzzz[i] * ga_x[i];

        ts_xz_xyyyy[i] = ts_x_xyyyy[i] * ga_z[i];

        ts_xz_xyyyz[i] = ts_z_yyyz[i] * gfe_0 + ts_z_xyyyz[i] * ga_x[i];

        ts_xz_xyyzz[i] = ts_z_yyzz[i] * gfe_0 + ts_z_xyyzz[i] * ga_x[i];

        ts_xz_xyzzz[i] = ts_z_yzzz[i] * gfe_0 + ts_z_xyzzz[i] * ga_x[i];

        ts_xz_xzzzz[i] = ts_z_zzzz[i] * gfe_0 + ts_z_xzzzz[i] * ga_x[i];

        ts_xz_yyyyy[i] = ts_z_yyyyy[i] * ga_x[i];

        ts_xz_yyyyz[i] = ts_z_yyyyz[i] * ga_x[i];

        ts_xz_yyyzz[i] = ts_z_yyyzz[i] * ga_x[i];

        ts_xz_yyzzz[i] = ts_z_yyzzz[i] * ga_x[i];

        ts_xz_yzzzz[i] = ts_z_yzzzz[i] * ga_x[i];

        ts_xz_zzzzz[i] = ts_z_zzzzz[i] * ga_x[i];
    }
    ...
    #pragma omp simd aligned(ga_y, ts_0_xxxxx, ts_0_xxxxy, ts_0_xxxxz, ts_0_xxxyy, ts_0_xxxyz, ts_0_xxxzz, ts_0_xxyyy, ts_0_xxyyz, ts_0_xxyzz, ts_0_xxzzz, ts_0_xyyyy, ts_0_xyyyz, ts_0_xyyzz, ts_0_xyzzz, ts_0_xzzzz, ts_0_yyyyy, ts_0_yyyyz, ts_0_yyyzz, ts_0_yyzzz, ts_0_yzzzz, ts_0_zzzzz, ts_y_xxxx, ts_y_xxxxx, ts_y_xxxxy, ts_y_xxxxz, ts_y_xxxy, ts_y_xxxyy, ts_y_xxxyz, ts_y_xxxz, ts_y_xxxzz, ts_y_xxyy, ts_y_xxyyy, ts_y_xxyyz, ts_y_xxyz, ts_y_xxyzz, ts_y_xxzz, ts_y_xxzzz, ts_y_xyyy, ts_y_xyyyy, ts_y_xyyyz, ts_y_xyyz, ts_y_xyyzz, ts_y_xyzz, ts_y_xyzzz, ts_y_xzzz, ts_y_xzzzz, ts_y_yyyy, ts_y_yyyyy, ts_y_yyyyz, ts_y_yyyz, ts_y_yyyzz, ts_y_yyzz, ts_y_yyzzz, ts_y_yzzz, ts_y_yzzzz, ts_y_zzzz, ts_y_zzzzz, ts_yy_xxxxx, ts_yy_xxxxy, ts_yy_xxxxz, ts_yy_xxxyy, ts_yy_xxxyz, ts_yy_xxxzz, ts_yy_xxyyy, ts_yy_xxyyz, ts_yy_xxyzz, ts_yy_xxzzz, ts_yy_xyyyy, ts_yy_xyyyz, ts_yy_xyyzz, ts_yy_xyzzz, ts_yy_xzzzz, ts_yy_yyyyy, ts_yy_yyyyz, ts_yy_yyyzz, ts_yy_yyzzz, ts_yy_yzzzz, ts_yy_zzzzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_yy_xxxxx[i] = ts_0_xxxxx[i] * gfe_0 + ts_y_xxxxx[i] * ga_y[i];

        ts_yy_xxxxy[i] = ts_0_xxxxy[i] * gfe_0 + ts_y_xxxx[i] * gfe_0 + ts_y_xxxxy[i] * ga_y[i];

        ts_yy_xxxxz[i] = ts_0_xxxxz[i] * gfe_0 + ts_y_xxxxz[i] * ga_y[i];

        ts_yy_xxxyy[i] = ts_0_xxxyy[i] * gfe_0 + 2.0 * ts_y_xxxy[i] * gfe_0 + ts_y_xxxyy[i] * ga_y[i];

        ts_yy_xxxyz[i] = ts_0_xxxyz[i] * gfe_0 + ts_y_xxxz[i] * gfe_0 + ts_y_xxxyz[i] * ga_y[i];

        ts_yy_xxxzz[i] = ts_0_xxxzz[i] * gfe_0 + ts_y_xxxzz[i] * ga_y[i];

        ts_yy_xxyyy[i] = ts_0_xxyyy[i] * gfe_0 + 3.0 * ts_y_xxyy[i] * gfe_0 + ts_y_xxyyy[i] * ga_y[i];

        ts_yy_xxyyz[i] = ts_0_xxyyz[i] * gfe_0 + 2.0 * ts_y_xxyz[i] * gfe_0 + ts_y_xxyyz[i] * ga_y[i];

        ts_yy_xxyzz[i] = ts_0_xxyzz[i] * gfe_0 + ts_y_xxzz[i] * gfe_0 + ts_y_xxyzz[i] * ga_y[i];

        ts_yy_xxzzz[i] = ts_0_xxzzz[i] * gfe_0 + ts_y_xxzzz[i] * ga_y[i];

        ts_yy_xyyyy[i] = ts_0_xyyyy[i] * gfe_0 + 4.0 * ts_y_xyyy[i] * gfe_0 + ts_y_xyyyy[i] * ga_y[i];

        ts_yy_xyyyz[i] = ts_0_xyyyz[i] * gfe_0 + 3.0 * ts_y_xyyz[i] * gfe_0 + ts_y_xyyyz[i] * ga_y[i];

        ts_yy_xyyzz[i] = ts_0_xyyzz[i] * gfe_0 + 2.0 * ts_y_xyzz[i] * gfe_0 + ts_y_xyyzz[i] * ga_y[i];

        ts_yy_xyzzz[i] = ts_0_xyzzz[i] * gfe_0 + ts_y_xzzz[i] * gfe_0 + ts_y_xyzzz[i] * ga_y[i];

        ts_yy_xzzzz[i] = ts_0_xzzzz[i] * gfe_0 + ts_y_xzzzz[i] * ga_y[i];

        ts_yy_yyyyy[i] = ts_0_yyyyy[i] * gfe_0 + 5.0 * ts_y_yyyy[i] * gfe_0 + ts_y_yyyyy[i] * ga_y[i];

        ts_yy_yyyyz[i] = ts_0_yyyyz[i] * gfe_0 + 4.0 * ts_y_yyyz[i] * gfe_0 + ts_y_yyyyz[i] * ga_y[i];

        ts_yy_yyyzz[i] = ts_0_yyyzz[i] * gfe_0 + 3.0 * ts_y_yyzz[i] * gfe_0 + ts_y_yyyzz[i] * ga_y[i];

        ts_yy_yyzzz[i] = ts_0_yyzzz[i] * gfe_0 + 2.0 * ts_y_yzzz[i] * gfe_0 + ts_y_yyzzz[i] * ga_y[i];

        ts_yy_yzzzz[i] = ts_0_yzzzz[i] * gfe_0 + ts_y_zzzz[i] * gfe_0 + ts_y_yzzzz[i] * ga_y[i];

        ts_yy_zzzzz[i] = ts_0_zzzzz[i] * gfe_0 + ts_y_zzzzz[i] * ga_y[i];
    }
    ...
    #pragma omp simd aligned(ga_y, ga_z, ts_y_xxxxy, ts_y_xxxyy, ts_y_xxyyy, ts_y_xyyyy, ts_y_yyyyy, ts_yz_xxxxx, ts_yz_xxxxy, ts_yz_xxxxz, ts_yz_xxxyy, ts_yz_xxxyz, ts_yz_xxxzz, ts_yz_xxyyy, ts_yz_xxyyz, ts_yz_xxyzz, ts_yz_xxzzz, ts_yz_xyyyy, ts_yz_xyyyz, ts_yz_xyyzz, ts_yz_xyzzz, ts_yz_xzzzz, ts_yz_yyyyy, ts_yz_yyyyz, ts_yz_yyyzz, ts_yz_yyzzz, ts_yz_yzzzz, ts_yz_zzzzz, ts_z_xxxxx, ts_z_xxxxz, ts_z_xxxyz, ts_z_xxxz, ts_z_xxxzz, ts_z_xxyyz, ts_z_xxyz, ts_z_xxyzz, ts_z_xxzz, ts_z_xxzzz, ts_z_xyyyz, ts_z_xyyz, ts_z_xyyzz, ts_z_xyzz, ts_z_xyzzz, ts_z_xzzz, ts_z_xzzzz, ts_z_yyyyz, ts_z_yyyz, ts_z_yyyzz, ts_z_yyzz, ts_z_yyzzz, ts_z_yzzz, ts_z_yzzzz, ts_z_zzzz, ts_z_zzzzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_yz_xxxxx[i] = ts_z_xxxxx[i] * ga_y[i];

        ts_yz_xxxxy[i] = ts_y_xxxxy[i] * ga_z[i];

        ts_yz_xxxxz[i] = ts_z_xxxxz[i] * ga_y[i];

        ts_yz_xxxyy[i] = ts_y_xxxyy[i] * ga_z[i];

        ts_yz_xxxyz[i] = ts_z_xxxz[i] * gfe_0 + ts_z_xxxyz[i] * ga_y[i];

        ts_yz_xxxzz[i] = ts_z_xxxzz[i] * ga_y[i];

        ts_yz_xxyyy[i] = ts_y_xxyyy[i] * ga_z[i];

        ts_yz_xxyyz[i] = 2.0 * ts_z_xxyz[i] * gfe_0 + ts_z_xxyyz[i] * ga_y[i];

        ts_yz_xxyzz[i] = ts_z_xxzz[i] * gfe_0 + ts_z_xxyzz[i] * ga_y[i];

        ts_yz_xxzzz[i] = ts_z_xxzzz[i] * ga_y[i];

        ts_yz_xyyyy[i] = ts_y_xyyyy[i] * ga_z[i];

        ts_yz_xyyyz[i] = 3.0 * ts_z_xyyz[i] * gfe_0 + ts_z_xyyyz[i] * ga_y[i];

        ts_yz_xyyzz[i] = 2.0 * ts_z_xyzz[i] * gfe_0 + ts_z_xyyzz[i] * ga_y[i];

        ts_yz_xyzzz[i] = ts_z_xzzz[i] * gfe_0 + ts_z_xyzzz[i] * ga_y[i];

        ts_yz_xzzzz[i] = ts_z_xzzzz[i] * ga_y[i];

        ts_yz_yyyyy[i] = ts_y_yyyyy[i] * ga_z[i];

        ts_yz_yyyyz[i] = 4.0 * ts_z_yyyz[i] * gfe_0 + ts_z_yyyyz[i] * ga_y[i];

        ts_yz_yyyzz[i] = 3.0 * ts_z_yyzz[i] * gfe_0 + ts_z_yyyzz[i] * ga_y[i];

        ts_yz_yyzzz[i] = 2.0 * ts_z_yzzz[i] * gfe_0 + ts_z_yyzzz[i] * ga_y[i];

        ts_yz_yzzzz[i] = ts_z_zzzz[i] * gfe_0 + ts_z_yzzzz[i] * ga_y[i];

        ts_yz_zzzzz[i] = ts_z_zzzzz[i] * ga_y[i];
    }
    ...
    #pragma omp simd aligned(ga_z, ts_0_xxxxx, ts_0_xxxxy, ts_0_xxxxz, ts_0_xxxyy, ts_0_xxxyz, ts_0_xxxzz, ts_0_xxyyy, ts_0_xxyyz, ts_0_xxyzz, ts_0_xxzzz, ts_0_xyyyy, ts_0_xyyyz, ts_0_xyyzz, ts_0_xyzzz, ts_0_xzzzz, ts_0_yyyyy, ts_0_yyyyz, ts_0_yyyzz, ts_0_yyzzz, ts_0_yzzzz, ts_0_zzzzz, ts_z_xxxx, ts_z_xxxxx, ts_z_xxxxy, ts_z_xxxxz, ts_z_xxxy, ts_z_xxxyy, ts_z_xxxyz, ts_z_xxxz, ts_z_xxxzz, ts_z_xxyy, ts_z_xxyyy, ts_z_xxyyz, ts_z_xxyz, ts_z_xxyzz, ts_z_xxzz, ts_z_xxzzz, ts_z_xyyy, ts_z_xyyyy, ts_z_xyyyz, ts_z_xyyz, ts_z_xyyzz, ts_z_xyzz, ts_z_xyzzz, ts_z_xzzz, ts_z_xzzzz, ts_z_yyyy, ts_z_yyyyy, ts_z_yyyyz, ts_z_yyyz, ts_z_yyyzz, ts_z_yyzz, ts_z_yyzzz, ts_z_yzzz, ts_z_yzzzz, ts_z_zzzz, ts_z_zzzzz, ts_zz_xxxxx, ts_zz_xxxxy, ts_zz_xxxxz, ts_zz_xxxyy, ts_zz_xxxyz, ts_zz_xxxzz, ts_zz_xxyyy, ts_zz_xxyyz, ts_zz_xxyzz, ts_zz_xxzzz, ts_zz_xyyyy, ts_zz_xyyyz, ts_zz_xyyzz, ts_zz_xyzzz, ts_zz_xzzzz, ts_zz_yyyyy, ts_zz_yyyyz, ts_zz_yyyzz, ts_zz_yyzzz, ts_zz_yzzzz, ts_zz_zzzzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double gfe_0 = 0.5 / (a_exp + b_exps[i] + c_exp);

        ts_zz_xxxxx[i] = ts_0_xxxxx[i] * gfe_0 + ts_z_xxxxx[i] * ga_z[i];

        ts_zz_xxxxy[i] = ts_0_xxxxy[i] * gfe_0 + ts_z_xxxxy[i] * ga_z[i];

        ts_zz_xxxxz[i] = ts_0_xxxxz[i] * gfe_0 + ts_z_xxxx[i] * gfe_0 + ts_z_xxxxz[i] * ga_z[i];

        ts_zz_xxxyy[i] = ts_0_xxxyy[i] * gfe_0 + ts_z_xxxyy[i] * ga_z[i];

        ts_zz_xxxyz[i] = ts_0_xxxyz[i] * gfe_0 + ts_z_xxxy[i] * gfe_0 + ts_z_xxxyz[i] * ga_z[i];

        ts_zz_xxxzz[i] = ts_0_xxxzz[i] * gfe_0 + 2.0 * ts_z_xxxz[i] * gfe_0 + ts_z_xxxzz[i] * ga_z[i];

        ts_zz_xxyyy[i] = ts_0_xxyyy[i] * gfe_0 + ts_z_xxyyy[i] * ga_z[i];

        ts_zz_xxyyz[i] = ts_0_xxyyz[i] * gfe_0 + ts_z_xxyy[i] * gfe_0 + ts_z_xxyyz[i] * ga_z[i];

        ts_zz_xxyzz[i] = ts_0_xxyzz[i] * gfe_0 + 2.0 * ts_z_xxyz[i] * gfe_0 + ts_z_xxyzz[i] * ga_z[i];

        ts_zz_xxzzz[i] = ts_0_xxzzz[i] * gfe_0 + 3.0 * ts_z_xxzz[i] * gfe_0 + ts_z_xxzzz[i] * ga_z[i];

        ts_zz_xyyyy[i] = ts_0_xyyyy[i] * gfe_0 + ts_z_xyyyy[i] * ga_z[i];

        ts_zz_xyyyz[i] = ts_0_xyyyz[i] * gfe_0 + ts_z_xyyy[i] * gfe_0 + ts_z_xyyyz[i] * ga_z[i];

        ts_zz_xyyzz[i] = ts_0_xyyzz[i] * gfe_0 + 2.0 * ts_z_xyyz[i] * gfe_0 + ts_z_xyyzz[i] * ga_z[i];

        ts_zz_xyzzz[i] = ts_0_xyzzz[i] * gfe_0 + 3.0 * ts_z_xyzz[i] * gfe_0 + ts_z_xyzzz[i] * ga_z[i];

        ts_zz_xzzzz[i] = ts_0_xzzzz[i] * gfe_0 + 4.0 * ts_z_xzzz[i] * gfe_0 + ts_z_xzzzz[i] * ga_z[i];

        ts_zz_yyyyy[i] = ts_0_yyyyy[i] * gfe_0 + ts_z_yyyyy[i] * ga_z[i];

        ts_zz_yyyyz[i] = ts_0_yyyyz[i] * gfe_0 + ts_z_yyyy[i] * gfe_0 + ts_z_yyyyz[i] * ga_z[i];

        ts_zz_yyyzz[i] = ts_0_yyyzz[i] * gfe_0 + 2.0 * ts_z_yyyz[i] * gfe_0 + ts_z_yyyzz[i] * ga_z[i];

        ts_zz_yyzzz[i] = ts_0_yyzzz[i] * gfe_0 + 3.0 * ts_z_yyzz[i] * gfe_0 + ts_z_yyzzz[i] * ga_z[i];

        ts_zz_yzzzz[i] = ts_0_yzzzz[i] * gfe_0 + 4.0 * ts_z_yzzz[i] * gfe_0 + ts_z_yzzzz[i] * ga_z[i];

        ts_zz_zzzzz[i] = ts_0_zzzzz[i] * gfe_0 + 5.0 * ts_z_zzzz[i] * gfe_0 + ts_z_zzzzz[i] * ga_z[i];
    }
