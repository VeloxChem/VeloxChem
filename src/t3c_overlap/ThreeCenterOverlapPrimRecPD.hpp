#ifndef ThreeCenterOverlapPrimRecPD
#define ThreeCenterOverlapPrimRecPD

#include "SimdArray.hpp"

namespace t3ovlrec { // t3ovlrec namespace

/// @brief Computes primitive [P|G(r)|D]  integrals for set of data buffers.
...
#endif /* ThreeCenterOverlapPrimRecPD */
