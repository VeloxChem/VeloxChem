#ifndef ElectronRepulsionGeom1100RecDPSD_hpp
#define ElectronRepulsionGeom1100RecDPSD_hpp
...
/// @brief Computes d^(1)/dA^(1)d^(1)/dB^(1)(DP|1/|r-r'||SD)  integral derivatives.
...
template <class T>
inline auto
comp_electron_repulsion_geom1100_dpsd(T& distributor,
...
#endif /* ElectronRepulsionGeom1100RecDPSD_hpp */
