#ifndef ElectronRepulsionGeom1100RecFDDF_hpp
#define ElectronRepulsionGeom1100RecFDDF_hpp
...
/// @brief Computes d^(1)/dA^(1)d^(1)/dB^(1)(FD|1/|r-r'||DF)  integral derivatives.
...
template <class T>
inline auto
comp_electron_repulsion_geom1100_fddf(T& distributor,
                                      ...
                                      const std::pair<size_t, size_t>& ket_indices) -> void
{
    ...
    CSimdArray<double> cbuffer(10580, 1);

    // allocate aligned contracted integrals

    CSimdArray<double> ckbuffer(51030, 1);

    // allocate aligned half transformed integrals

    CSimdArray<double> skbuffer(136045, 1);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (int k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cfunc::reduce(cbuffer, 0, pbuffer, 683, 30, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 30, pbuffer, 893, 45, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 75, pbuffer, 1208, 63, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 138, pbuffer, 1919, 60, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 198, pbuffer, 2279, 90, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 288, pbuffer, 2819, 126, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 414, pbuffer, 3925, 100, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 514, pbuffer, 4425, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 664, pbuffer, 5175, 210, ket_width, ket_npgtos);

                pbuffer.scale(2.0 * b_exp, {3925, 4025});

                pbuffer.scale(2.0 * b_exp, {4425, 4575});

                pbuffer.scale(2.0 * b_exp, {5175, 5385});
                ...
                t2cfunc::reduce(cbuffer, 874, pbuffer, 3925, 100, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 974, pbuffer, 4425, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1124, pbuffer, 5175, 210, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1334, pbuffer, 6600, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1484, pbuffer, 7200, 225, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1709, pbuffer, 8100, 315, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 2024, pbuffer, 9675, 210, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 2234, pbuffer, 10305, 315, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 2549, pbuffer, 11250, 441, ket_width, ket_npgtos);

                pbuffer.scale(2.0 * a_exp, {683, 713});

                pbuffer.scale(2.0 * a_exp, {893, 938});

                pbuffer.scale(2.0 * a_exp, {1208, 1271});
                ...
                pbuffer.scale(a_exp / b_exp, {3925, 4025});

                pbuffer.scale(a_exp / b_exp, {4425, 4575});

                pbuffer.scale(a_exp / b_exp, {5175, 5385});
                ...
                t2cfunc::reduce(cbuffer, 2990, pbuffer, 683, 30, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 3020, pbuffer, 893, 45, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 3065, pbuffer, 1208, 63, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 3128, pbuffer, 1919, 60, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 3188, pbuffer, 2279, 90, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 3278, pbuffer, 2819, 126, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 3404, pbuffer, 3925, 100, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 3504, pbuffer, 4425, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 3654, pbuffer, 5175, 210, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 3864, pbuffer, 6600, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 4014, pbuffer, 7200, 225, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 4239, pbuffer, 8100, 315, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 4554, pbuffer, 9675, 210, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 4764, pbuffer, 10305, 315, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 5079, pbuffer, 11250, 441, ket_width, ket_npgtos);
                ...
                t2cfunc::reduce(cbuffer, 5520, pbuffer, 3925, 100, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 5620, pbuffer, 4425, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 5770, pbuffer, 5175, 210, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 5980, pbuffer, 6600, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 6130, pbuffer, 7200, 225, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 6355, pbuffer, 8100, 315, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 6670, pbuffer, 9675, 210, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 6880, pbuffer, 10305, 315, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 7195, pbuffer, 11250, 441, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 7636, pbuffer, 12741, 280, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 7916, pbuffer, 13301, 420, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 8336, pbuffer, 14141, 588, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 8924, pbuffer, 15317, 360, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 9284, pbuffer, 15677, 540, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 9824, pbuffer, 16217, 756, ket_width, ket_npgtos);
            ...
            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 2295, cbuffer, 414, 514, cfactors, 6, 0, 3);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 2595, cbuffer, 514, 664, cfactors, 6, 0, 3);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 3045, 2295, 2595, cfactors, 6, 0, 3);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 8145, cbuffer, 874, 974, cfactors, 6, 0, 3);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 8445, cbuffer, 974, 1124, cfactors, 6, 0, 3);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 8895, 8145, 8445, cfactors, 6, 0, 3);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 9495, cbuffer, 1334, 1484, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 9945, cbuffer, 1484, 1709, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 10620, 9495, 9945, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 11520, cbuffer, 2024, 2234, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 12150, cbuffer, 2234, 2549, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 13095, 11520, 12150, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 14355, cbuffer, 2990, 3020, cfactors, 6, 0, 1);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 14445, cbuffer, 3020, 3065, cfactors, 6, 0, 1);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 14580, 14355, 14445, cfactors, 6, 0, 1);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 14760, cbuffer, 3128, 3188, cfactors, 6, 0, 2);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 14940, cbuffer, 3188, 3278, cfactors, 6, 0, 2);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 15210, 14760, 14940, cfactors, 6, 0, 2);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 16650, cbuffer, 3404, 3504, cfactors, 6, 0, 3);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 16950, cbuffer, 3504, 3654, cfactors, 6, 0, 3);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 17400, 16650, 16950, cfactors, 6, 0, 3);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 19800, cbuffer, 3864, 4014, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 20250, cbuffer, 4014, 4239, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 20925, 19800, 20250, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 24525, cbuffer, 4554, 4764, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 25155, cbuffer, 4764, 5079, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 26100, 24525, 25155, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 36180, cbuffer, 5520, 5620, cfactors, 6, 0, 3);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 36480, cbuffer, 5620, 5770, cfactors, 6, 0, 3);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 36930, 36180, 36480, cfactors, 6, 0, 3);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 37530, cbuffer, 5980, 6130, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 37980, cbuffer, 6130, 6355, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 38655, 37530, 37980, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 39555, cbuffer, 6670, 6880, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 40185, cbuffer, 6880, 7195, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 41130, 39555, 40185, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 42390, cbuffer, 7636, 7916, cfactors, 6, 0, 6);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 43230, cbuffer, 7916, 8336, cfactors, 6, 0, 6);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 44490, 42390, 43230, cfactors, 6, 0, 6);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 46170, cbuffer, 8924, 9284, cfactors, 6, 0, 7);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 47250, cbuffer, 9284, 9824, cfactors, 6, 0, 7);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 48870, 46170, 47250, cfactors, 6, 0, 7);

            t4cfunc::ket_transform<2, 3>(skbuffer, 0, ckbuffer, 225, 0, 1);

            t4cfunc::ket_transform<2, 3>(skbuffer, 105, ckbuffer, 855, 0, 2);

            t4cfunc::ket_transform<2, 3>(skbuffer, 2835, ckbuffer, 3045, 0, 3);

            t4cfunc::ket_transform<2, 3>(skbuffer, 117005, ckbuffer, 8895, 0, 3);

            t4cfunc::ket_transform<2, 3>(skbuffer, 117355, ckbuffer, 10620, 0, 4);

            t4cfunc::ket_transform<2, 3>(skbuffer, 117880, ckbuffer, 13095, 0, 5);

            t4cfunc::ket_transform<2, 3>(skbuffer, 118615, ckbuffer, 14580, 0, 1);

            t4cfunc::ket_transform<2, 3>(skbuffer, 118720, ckbuffer, 15210, 0, 2);

            t4cfunc::ket_transform<2, 3>(skbuffer, 119560, ckbuffer, 17400, 0, 3);

            t4cfunc::ket_transform<2, 3>(skbuffer, 120960, ckbuffer, 20925, 0, 4);

            t4cfunc::ket_transform<2, 3>(skbuffer, 123060, ckbuffer, 26100, 0, 5);

            t4cfunc::ket_transform<2, 3>(skbuffer, 132195, ckbuffer, 36930, 0, 3);

            t4cfunc::ket_transform<2, 3>(skbuffer, 132545, ckbuffer, 38655, 0, 4);

            t4cfunc::ket_transform<2, 3>(skbuffer, 133070, ckbuffer, 41130, 0, 5);

            t4cfunc::ket_transform<2, 3>(skbuffer, 133805, ckbuffer, 44490, 0, 6);

            t4cfunc::ket_transform<2, 3>(skbuffer, 134785, ckbuffer, 48870, 0, 7);

            erirec::comp_bra_hrr_electron_repulsion_pdxx(skbuffer, 20300, 105, 2835, r_ab, 2, 3);

            erirec::comp_bra_hrr_electron_repulsion_pdxx(skbuffer, 128940, 118720, 119560, r_ab, 2, 3);

            erirec::comp_bra_hrr_electron_repulsion_pfxx(skbuffer, 129570, 119560, 120960, r_ab, 2, 3);

            erirec::comp_bra_hrr_electron_repulsion_pgxx(skbuffer, 130620, 120960, 123060, r_ab, 2, 3);

            erirec::comp_bra_geom10_hrr_electron_repulsion_pdxx(skbuffer, 22820, 105, 128940, 129570, r_ab, 2, 3);

            erirec::comp_bra_geom10_hrr_electron_repulsion_pfxx(skbuffer, 33530, 2835, 129570, 130620, r_ab, 2, 3);

            erirec::comp_bra_geom10_hrr_electron_repulsion_ddxx(skbuffer, 64085, 20300, 22820, 33530, r_ab, 2, 3);

            erirec::comp_bra_geom01_hrr_electron_repulsion_sdxx(skbuffer, 315, 0, 117005, 2, 3);

            erirec::comp_bra_geom01_hrr_electron_repulsion_sfxx(skbuffer, 3185, 105, 117355, 2, 3);

            erirec::comp_bra_geom01_hrr_electron_repulsion_sgxx(skbuffer, 7385, 2835, 117880, 2, 3);

            erirec::comp_bra_geom01_hrr_electron_repulsion_pdxx(skbuffer, 20930, 105, 315, 3185, r_ab, 2, 3);

            erirec::comp_bra_geom01_hrr_electron_repulsion_pfxx(skbuffer, 30380, 2835, 3185, 7385, r_ab, 2, 3);

            erirec::comp_bra_geom01_hrr_electron_repulsion_ddxx(skbuffer, 60305, 20300, 20930, 30380, r_ab, 2, 3);

            erirec::comp_bra_geom01_hrr_electron_repulsion_sdxx(skbuffer, 118930, 118615, 132195, 2, 3);

            erirec::comp_bra_geom01_hrr_electron_repulsion_sfxx(skbuffer, 119910, 118720, 132545, 2, 3);

            erirec::comp_bra_geom01_hrr_electron_repulsion_sgxx(skbuffer, 121485, 119560, 133070, 2, 3);

            erirec::comp_bra_geom01_hrr_electron_repulsion_shxx(skbuffer, 123795, 120960, 133805, 2, 3);

            erirec::comp_bra_geom01_hrr_electron_repulsion_sixx(skbuffer, 126000, 123060, 134785, 2, 3);

            erirec::comp_bra_geom11_hrr_electron_repulsion_sdxx(skbuffer, 945, 118720, 118930, 119910, r_ab, 2, 3);

            erirec::comp_bra_geom11_hrr_electron_repulsion_sfxx(skbuffer, 4235, 119560, 119910, 121485, r_ab, 2, 3);

            erirec::comp_bra_geom11_hrr_electron_repulsion_sgxx(skbuffer, 8960, 120960, 121485, 123795, r_ab, 2, 3);

            erirec::comp_bra_geom11_hrr_electron_repulsion_shxx(skbuffer, 13685, 123060, 123795, 126000, r_ab, 2, 3);

            erirec::comp_bra_geom11_hrr_electron_repulsion_pdxx(skbuffer, 24710, 315, 128940, 945, 4235, r_ab, 2, 3);

            erirec::comp_bra_geom11_hrr_electron_repulsion_pfxx(skbuffer, 36680, 3185, 129570, 4235, 8960, r_ab, 2, 3);

            erirec::comp_bra_geom11_hrr_electron_repulsion_pgxx(skbuffer, 46130, 7385, 130620, 8960, 13685, r_ab, 2, 3);

            erirec::comp_bra_geom11_hrr_electron_repulsion_ddxx(skbuffer, 67865, 20930, 22820, 24710, 36680, r_ab, 2, 3);

            erirec::comp_bra_geom11_hrr_electron_repulsion_dfxx(skbuffer, 79205, 30380, 33530, 36680, 46130, r_ab, 2, 3);

            erirec::comp_bra_geom11_hrr_electron_repulsion_fdxx(skbuffer, 98105, 60305, 64085, 67865, 79205, r_ab, 2, 3);

            t4cfunc::bra_transform<3, 2>(sbuffer, 0, skbuffer, 98105, 2, 3);

            t4cfunc::bra_transform<3, 2>(sbuffer, 1225, skbuffer, 100205, 2, 3);

            t4cfunc::bra_transform<3, 2>(sbuffer, 2450, skbuffer, 102305, 2, 3);

            t4cfunc::bra_transform<3, 2>(sbuffer, 3675, skbuffer, 104405, 2, 3);

            t4cfunc::bra_transform<3, 2>(sbuffer, 4900, skbuffer, 106505, 2, 3);

            t4cfunc::bra_transform<3, 2>(sbuffer, 6125, skbuffer, 108605, 2, 3);

            t4cfunc::bra_transform<3, 2>(sbuffer, 7350, skbuffer, 110705, 2, 3);

            t4cfunc::bra_transform<3, 2>(sbuffer, 8575, skbuffer, 112805, 2, 3);

            t4cfunc::bra_transform<3, 2>(sbuffer, 9800, skbuffer, 114905, 2, 3);
...
#endif /* ElectronRepulsionGeom1100RecFDDF_hpp */
