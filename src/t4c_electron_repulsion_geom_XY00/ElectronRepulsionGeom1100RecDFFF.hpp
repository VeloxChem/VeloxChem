#ifndef ElectronRepulsionGeom1100RecDFFF_hpp
#define ElectronRepulsionGeom1100RecDFFF_hpp
...
/// @brief Computes d^(1)/dA^(1)d^(1)/dB^(1)(DF|1/|r-r'||FF)  integral derivatives.
...
template <class T>
inline auto
comp_electron_repulsion_geom1100_dfff(T& distributor,
                                      ...
                                      const std::pair<size_t, size_t>& ket_indices) -> void
{
    ...
    CSimdArray<double> cbuffer(15096, 1);

    // allocate aligned contracted integrals

    CSimdArray<double> ckbuffer(108852, 1);

    // allocate aligned half transformed integrals

    CSimdArray<double> skbuffer(116865, 1);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (int k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cfunc::reduce(cbuffer, 0, pbuffer, 2787, 60, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 60, pbuffer, 3147, 90, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 150, pbuffer, 3687, 126, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 276, pbuffer, 4443, 168, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 444, pbuffer, 5801, 100, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 544, pbuffer, 6301, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 694, pbuffer, 7051, 210, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 904, pbuffer, 8101, 280, ket_width, ket_npgtos);
                ...
                t2cfunc::reduce(cbuffer, 1184, pbuffer, 9876, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1334, pbuffer, 10476, 225, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1559, pbuffer, 11376, 315, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1874, pbuffer, 12636, 420, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 2294, pbuffer, 14631, 210, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 2504, pbuffer, 15261, 315, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 2819, pbuffer, 16206, 441, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 3260, pbuffer, 17529, 588, ket_width, ket_npgtos);
                ...
                t2cfunc::reduce(cbuffer, 3848, pbuffer, 2787, 60, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 3908, pbuffer, 3147, 90, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 3998, pbuffer, 3687, 126, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 4124, pbuffer, 4443, 168, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 4292, pbuffer, 5801, 100, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 4392, pbuffer, 6301, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 4542, pbuffer, 7051, 210, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 4752, pbuffer, 8101, 280, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 5032, pbuffer, 9876, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 5182, pbuffer, 10476, 225, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 5407, pbuffer, 11376, 315, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 5722, pbuffer, 12636, 420, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 6142, pbuffer, 14631, 210, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 6352, pbuffer, 15261, 315, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 6667, pbuffer, 16206, 441, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 7108, pbuffer, 17529, 588, ket_width, ket_npgtos);
                ...
                t2cfunc::reduce(cbuffer, 7696, pbuffer, 9876, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 7846, pbuffer, 10476, 225, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 8071, pbuffer, 11376, 315, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 8386, pbuffer, 12636, 420, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 8806, pbuffer, 14631, 210, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 9016, pbuffer, 15261, 315, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 9331, pbuffer, 16206, 441, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 9772, pbuffer, 17529, 588, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 10360, pbuffer, 19461, 280, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 10640, pbuffer, 20021, 420, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 11060, pbuffer, 20861, 588, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 11648, pbuffer, 22037, 784, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 12432, pbuffer, 23605, 360, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 12792, pbuffer, 23965, 540, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 13332, pbuffer, 24505, 756, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 14088, pbuffer, 25261, 1008, ket_width, ket_npgtos);
            ...
            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 13708, cbuffer, 1184, 1334, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 14158, cbuffer, 1334, 1559, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxph(ckbuffer, 14833, cbuffer, 1559, 1874, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 15778, 13708, 14158, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxdg(ckbuffer, 16678, 14158, 14833, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxff(ckbuffer, 18028, 15778, 16678, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 19528, cbuffer, 2294, 2504, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 20158, cbuffer, 2504, 2819, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxph(ckbuffer, 21103, cbuffer, 2819, 3260, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 22426, 19528, 20158, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxdg(ckbuffer, 23686, 20158, 21103, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxff(ckbuffer, 25576, 22426, 23686, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 27676, cbuffer, 3848, 3908, cfactors, 6, 0, 2);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 27856, cbuffer, 3908, 3998, cfactors, 6, 0, 2);

            erirec::comp_ket_hrr_electron_repulsion_xxph(ckbuffer, 28126, cbuffer, 3998, 4124, cfactors, 6, 0, 2);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 28504, 27676, 27856, cfactors, 6, 0, 2);

            erirec::comp_ket_hrr_electron_repulsion_xxdg(ckbuffer, 28864, 27856, 28126, cfactors, 6, 0, 2);

            erirec::comp_ket_hrr_electron_repulsion_xxff(ckbuffer, 29404, 28504, 28864, cfactors, 6, 0, 2);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 30004, cbuffer, 4292, 4392, cfactors, 6, 0, 3);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 30304, cbuffer, 4392, 4542, cfactors, 6, 0, 3);

            erirec::comp_ket_hrr_electron_repulsion_xxph(ckbuffer, 30754, cbuffer, 4542, 4752, cfactors, 6, 0, 3);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 31384, 30004, 30304, cfactors, 6, 0, 3);

            erirec::comp_ket_hrr_electron_repulsion_xxdg(ckbuffer, 31984, 30304, 30754, cfactors, 6, 0, 3);

            erirec::comp_ket_hrr_electron_repulsion_xxff(ckbuffer, 32884, 31384, 31984, cfactors, 6, 0, 3);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 36884, cbuffer, 5032, 5182, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 37334, cbuffer, 5182, 5407, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxph(ckbuffer, 38009, cbuffer, 5407, 5722, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 38954, 36884, 37334, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxdg(ckbuffer, 39854, 37334, 38009, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxff(ckbuffer, 41204, 38954, 39854, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 47204, cbuffer, 6142, 6352, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 47834, cbuffer, 6352, 6667, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxph(ckbuffer, 48779, cbuffer, 6667, 7108, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 50102, 47204, 47834, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxdg(ckbuffer, 51362, 47834, 48779, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxff(ckbuffer, 53252, 50102, 51362, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 70052, cbuffer, 7696, 7846, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 70502, cbuffer, 7846, 8071, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxph(ckbuffer, 71177, cbuffer, 8071, 8386, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 72122, 70052, 70502, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxdg(ckbuffer, 73022, 70502, 71177, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxff(ckbuffer, 74372, 72122, 73022, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 75872, cbuffer, 8806, 9016, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 76502, cbuffer, 9016, 9331, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxph(ckbuffer, 77447, cbuffer, 9331, 9772, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 78770, 75872, 76502, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxdg(ckbuffer, 80030, 76502, 77447, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxff(ckbuffer, 81920, 78770, 80030, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 84020, cbuffer, 10360, 10640, cfactors, 6, 0, 6);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 84860, cbuffer, 10640, 11060, cfactors, 6, 0, 6);

            erirec::comp_ket_hrr_electron_repulsion_xxph(ckbuffer, 86120, cbuffer, 11060, 11648, cfactors, 6, 0, 6);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 87884, 84020, 84860, cfactors, 6, 0, 6);

            erirec::comp_ket_hrr_electron_repulsion_xxdg(ckbuffer, 89564, 84860, 86120, cfactors, 6, 0, 6);

            erirec::comp_ket_hrr_electron_repulsion_xxff(ckbuffer, 92084, 87884, 89564, cfactors, 6, 0, 6);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 94884, cbuffer, 12432, 12792, cfactors, 6, 0, 7);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 95964, cbuffer, 12792, 13332, cfactors, 6, 0, 7);

            erirec::comp_ket_hrr_electron_repulsion_xxph(ckbuffer, 97584, cbuffer, 13332, 14088, cfactors, 6, 0, 7);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 99852, 94884, 95964, cfactors, 6, 0, 7);

            erirec::comp_ket_hrr_electron_repulsion_xxdg(ckbuffer, 102012, 95964, 97584, cfactors, 6, 0, 7);

            erirec::comp_ket_hrr_electron_repulsion_xxff(ckbuffer, 105252, 99852, 102012, cfactors, 6, 0, 7);

            t4cfunc::ket_transform<3, 3>(skbuffer, 0, ckbuffer, 1728, 0, 2);

            t4cfunc::ket_transform<3, 3>(skbuffer, 294, ckbuffer, 5208, 0, 3);

            t4cfunc::ket_transform<3, 3>(skbuffer, 93100, ckbuffer, 18028, 0, 4);

            t4cfunc::ket_transform<3, 3>(skbuffer, 93835, ckbuffer, 25576, 0, 5);

            t4cfunc::ket_transform<3, 3>(skbuffer, 94864, ckbuffer, 29404, 0, 2);

            t4cfunc::ket_transform<3, 3>(skbuffer, 95158, ckbuffer, 32884, 0, 3);

            t4cfunc::ket_transform<3, 3>(skbuffer, 97118, ckbuffer, 41204, 0, 4);

            t4cfunc::ket_transform<3, 3>(skbuffer, 100058, ckbuffer, 53252, 0, 5);

            t4cfunc::ket_transform<3, 3>(skbuffer, 111965, ckbuffer, 74372, 0, 4);

            t4cfunc::ket_transform<3, 3>(skbuffer, 112700, ckbuffer, 81920, 0, 5);

            t4cfunc::ket_transform<3, 3>(skbuffer, 113729, ckbuffer, 92084, 0, 6);

            t4cfunc::ket_transform<3, 3>(skbuffer, 115101, ckbuffer, 105252, 0, 7);

            erirec::comp_bra_hrr_electron_repulsion_pfxx(skbuffer, 108290, 95158, 97118, r_ab, 3, 3);

            erirec::comp_bra_hrr_electron_repulsion_pgxx(skbuffer, 109760, 97118, 100058, r_ab, 3, 3);

            erirec::comp_bra_geom10_hrr_electron_repulsion_pfxx(skbuffer, 29155, 294, 108290, 109760, r_ab, 3, 3);

            erirec::comp_bra_geom01_hrr_electron_repulsion_sfxx(skbuffer, 784, 0, 93100, 3, 3);

            erirec::comp_bra_geom01_hrr_electron_repulsion_sgxx(skbuffer, 6664, 294, 93835, 3, 3);

            erirec::comp_bra_geom01_hrr_electron_repulsion_pfxx(skbuffer, 24745, 294, 784, 6664, r_ab, 3, 3);

            erirec::comp_bra_geom01_hrr_electron_repulsion_sfxx(skbuffer, 95648, 94864, 111965, 3, 3);

            erirec::comp_bra_geom01_hrr_electron_repulsion_sgxx(skbuffer, 97853, 95158, 112700, 3, 3);

            erirec::comp_bra_geom01_hrr_electron_repulsion_shxx(skbuffer, 101087, 97118, 113729, 3, 3);

            erirec::comp_bra_geom01_hrr_electron_repulsion_sixx(skbuffer, 104174, 100058, 115101, 3, 3);

            erirec::comp_bra_geom11_hrr_electron_repulsion_sfxx(skbuffer, 2254, 95158, 95648, 97853, r_ab, 3, 3);

            erirec::comp_bra_geom11_hrr_electron_repulsion_sgxx(skbuffer, 8869, 97118, 97853, 101087, r_ab, 3, 3);

            erirec::comp_bra_geom11_hrr_electron_repulsion_shxx(skbuffer, 15484, 100058, 101087, 104174, r_ab, 3, 3);

            erirec::comp_bra_geom11_hrr_electron_repulsion_pfxx(skbuffer, 33565, 784, 108290, 2254, 8869, r_ab, 3, 3);

            erirec::comp_bra_geom11_hrr_electron_repulsion_pgxx(skbuffer, 46795, 6664, 109760, 8869, 15484, r_ab, 3, 3);

            erirec::comp_bra_geom11_hrr_electron_repulsion_dfxx(skbuffer, 66640, 24745, 29155, 33565, 46795, r_ab, 3, 3);

            t4cfunc::bra_transform<2, 3>(sbuffer, 0, skbuffer, 66640, 3, 3);

            t4cfunc::bra_transform<2, 3>(sbuffer, 1715, skbuffer, 69580, 3, 3);

            t4cfunc::bra_transform<2, 3>(sbuffer, 3430, skbuffer, 72520, 3, 3);

            t4cfunc::bra_transform<2, 3>(sbuffer, 5145, skbuffer, 75460, 3, 3);

            t4cfunc::bra_transform<2, 3>(sbuffer, 6860, skbuffer, 78400, 3, 3);

            t4cfunc::bra_transform<2, 3>(sbuffer, 8575, skbuffer, 81340, 3, 3);

            t4cfunc::bra_transform<2, 3>(sbuffer, 10290, skbuffer, 84280, 3, 3);

            t4cfunc::bra_transform<2, 3>(sbuffer, 12005, skbuffer, 87220, 3, 3);

            t4cfunc::bra_transform<2, 3>(sbuffer, 13720, skbuffer, 90160, 3, 3);
...
#endif /* ElectronRepulsionGeom1100RecDFFF_hpp */
