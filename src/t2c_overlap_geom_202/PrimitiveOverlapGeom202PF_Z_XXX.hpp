#ifndef PrimitiveOverlapGeom202PF_Z_XXX
#define PrimitiveOverlapGeom202PF_Z_XXX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|d^(2)/dB^(2)F_XXX> integrals.
...
*/
auto compPrimitiveOverlapGeom202PF_Z_XXX(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202PF_Z_XXX */
