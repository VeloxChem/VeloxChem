#ifndef PrimitiveOverlapGeom202FP_YYY_Z
#define PrimitiveOverlapGeom202FP_YYY_Z
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_YYY|1|d^(2)/dB^(2)P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom202FP_YYY_Z(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FP_YYY_Z */
