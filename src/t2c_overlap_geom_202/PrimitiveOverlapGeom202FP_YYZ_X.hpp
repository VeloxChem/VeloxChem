#ifndef PrimitiveOverlapGeom202FP_YYZ_X
#define PrimitiveOverlapGeom202FP_YYZ_X
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_YYZ|1|d^(2)/dB^(2)P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom202FP_YYZ_X(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FP_YYZ_X */
