#ifndef PrimitiveOverlapGeom202PD_X_XZ
#define PrimitiveOverlapGeom202PD_X_XZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|d^(2)/dB^(2)D_XZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202PD_X_XZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202PD_X_XZ */
