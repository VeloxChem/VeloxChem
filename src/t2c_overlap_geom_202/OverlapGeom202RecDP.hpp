#ifndef OverlapGeom202RecDP_hpp
#define OverlapGeom202RecDP_hpp
...
/**
 Evaluates <d^(2)/dA^(2)D|1|d^(2)/dB^(2)P>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom202DP(CSubMatrix*      matrix_xx_xx,
