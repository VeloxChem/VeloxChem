#ifndef PrimitiveOverlapGeom202FD_XZZ_XX
#define PrimitiveOverlapGeom202FD_XZZ_XX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XZZ|1|d^(2)/dB^(2)D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom202FD_XZZ_XX(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FD_XZZ_XX */
