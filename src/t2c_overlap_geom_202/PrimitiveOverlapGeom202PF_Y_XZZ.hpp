#ifndef PrimitiveOverlapGeom202PF_Y_XZZ
#define PrimitiveOverlapGeom202PF_Y_XZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Y|1|d^(2)/dB^(2)F_XZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202PF_Y_XZZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202PF_Y_XZZ */
