#ifndef PrimitiveOverlapGeom202PD_Y_YY
#define PrimitiveOverlapGeom202PD_Y_YY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Y|1|d^(2)/dB^(2)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom202PD_Y_YY(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202PD_Y_YY */
