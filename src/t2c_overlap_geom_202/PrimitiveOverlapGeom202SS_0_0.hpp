#ifndef PrimitiveOverlapGeom202SS_0_0
#define PrimitiveOverlapGeom202SS_0_0
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)S_0|1|d^(2)/dB^(2)S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom202SS_0_0(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202SS_0_0 */
