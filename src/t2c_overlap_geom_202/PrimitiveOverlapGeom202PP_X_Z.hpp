#ifndef PrimitiveOverlapGeom202PP_X_Z
#define PrimitiveOverlapGeom202PP_X_Z
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|d^(2)/dB^(2)P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom202PP_X_Z(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202PP_X_Z */
