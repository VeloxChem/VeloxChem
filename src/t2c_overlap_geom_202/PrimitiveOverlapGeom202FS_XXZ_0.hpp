#ifndef PrimitiveOverlapGeom202FS_XXZ_0
#define PrimitiveOverlapGeom202FS_XXZ_0
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XXZ|1|d^(2)/dB^(2)S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom202FS_XXZ_0(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FS_XXZ_0 */
