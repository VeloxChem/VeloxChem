#ifndef PrimitiveOverlapGeom202PD_Y_XY
#define PrimitiveOverlapGeom202PD_Y_XY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Y|1|d^(2)/dB^(2)D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom202PD_Y_XY(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202PD_Y_XY */
