#ifndef OverlapGeom202RecSP_hpp
#define OverlapGeom202RecSP_hpp
...
/**
 Evaluates <d^(2)/dA^(2)S|1|d^(2)/dB^(2)P>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom202SP(CSubMatrix*      matrix_xx_xx,
