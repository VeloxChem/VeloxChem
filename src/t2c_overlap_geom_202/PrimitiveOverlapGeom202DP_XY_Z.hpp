#ifndef PrimitiveOverlapGeom202DP_XY_Z
#define PrimitiveOverlapGeom202DP_XY_Z
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XY|1|d^(2)/dB^(2)P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom202DP_XY_Z(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DP_XY_Z */
