#ifndef PrimitiveOverlapGeom202DD_XX_YZ
#define PrimitiveOverlapGeom202DD_XX_YZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XX|1|d^(2)/dB^(2)D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202DD_XX_YZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DD_XX_YZ */
