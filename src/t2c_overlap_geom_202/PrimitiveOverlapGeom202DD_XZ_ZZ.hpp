#ifndef PrimitiveOverlapGeom202DD_XZ_ZZ
#define PrimitiveOverlapGeom202DD_XZ_ZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XZ|1|d^(2)/dB^(2)D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202DD_XZ_ZZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DD_XZ_ZZ */
