#ifndef PrimitiveOverlapGeom202FD_YYZ_XY
#define PrimitiveOverlapGeom202FD_YYZ_XY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_YYZ|1|d^(2)/dB^(2)D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom202FD_YYZ_XY(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FD_YYZ_XY */
