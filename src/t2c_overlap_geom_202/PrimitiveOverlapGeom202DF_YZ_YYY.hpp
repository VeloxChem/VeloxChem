#ifndef PrimitiveOverlapGeom202DF_YZ_YYY
#define PrimitiveOverlapGeom202DF_YZ_YYY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YZ|1|d^(2)/dB^(2)F_YYY> integrals.
...
*/
auto compPrimitiveOverlapGeom202DF_YZ_YYY(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DF_YZ_YYY */
