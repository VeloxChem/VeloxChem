#ifndef PrimitiveOverlapGeom202FF_XZZ_XYY
#define PrimitiveOverlapGeom202FF_XZZ_XYY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XZZ|1|d^(2)/dB^(2)F_XYY> integrals.
...
*/
auto compPrimitiveOverlapGeom202FF_XZZ_XYY(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FF_XZZ_XYY */
