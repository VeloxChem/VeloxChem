#ifndef PrimitiveOverlapGeom202FP_YZZ_Y
#define PrimitiveOverlapGeom202FP_YZZ_Y
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_YZZ|1|d^(2)/dB^(2)P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom202FP_YZZ_Y(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FP_YZZ_Y */
