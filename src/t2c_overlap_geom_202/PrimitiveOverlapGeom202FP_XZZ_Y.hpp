#ifndef PrimitiveOverlapGeom202FP_XZZ_Y
#define PrimitiveOverlapGeom202FP_XZZ_Y
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XZZ|1|d^(2)/dB^(2)P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom202FP_XZZ_Y(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FP_XZZ_Y */
