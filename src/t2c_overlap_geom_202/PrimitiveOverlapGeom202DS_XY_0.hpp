#ifndef PrimitiveOverlapGeom202DS_XY_0
#define PrimitiveOverlapGeom202DS_XY_0
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XY|1|d^(2)/dB^(2)S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom202DS_XY_0(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DS_XY_0 */
