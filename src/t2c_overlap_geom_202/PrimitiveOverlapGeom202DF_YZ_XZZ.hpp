#ifndef PrimitiveOverlapGeom202DF_YZ_XZZ
#define PrimitiveOverlapGeom202DF_YZ_XZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YZ|1|d^(2)/dB^(2)F_XZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202DF_YZ_XZZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DF_YZ_XZZ */
