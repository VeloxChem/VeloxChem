#ifndef PrimitiveOverlapGeom202DF_YY_XYY
#define PrimitiveOverlapGeom202DF_YY_XYY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YY|1|d^(2)/dB^(2)F_XYY> integrals.
...
*/
auto compPrimitiveOverlapGeom202DF_YY_XYY(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DF_YY_XYY */
