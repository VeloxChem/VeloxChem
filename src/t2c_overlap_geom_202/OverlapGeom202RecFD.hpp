#ifndef OverlapGeom202RecFD_hpp
#define OverlapGeom202RecFD_hpp
...
/**
 Evaluates <d^(2)/dA^(2)F|1|d^(2)/dB^(2)D>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom202FD(CSubMatrix*      matrix_xx_xx,
