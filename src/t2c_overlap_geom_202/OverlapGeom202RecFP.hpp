#ifndef OverlapGeom202RecFP_hpp
#define OverlapGeom202RecFP_hpp
...
/**
 Evaluates <d^(2)/dA^(2)F|1|d^(2)/dB^(2)P>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom202FP(CSubMatrix*      matrix_xx_xx,
