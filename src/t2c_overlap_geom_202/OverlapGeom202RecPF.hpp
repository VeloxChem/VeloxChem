#ifndef OverlapGeom202RecPF_hpp
#define OverlapGeom202RecPF_hpp
...
/**
 Evaluates <d^(2)/dA^(2)P|1|d^(2)/dB^(2)F>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom202PF(CSubMatrix*      matrix_xx_xx,
