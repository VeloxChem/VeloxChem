#ifndef PrimitiveOverlapGeom202FD_YZZ_YY
#define PrimitiveOverlapGeom202FD_YZZ_YY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_YZZ|1|d^(2)/dB^(2)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom202FD_YZZ_YY(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FD_YZZ_YY */
