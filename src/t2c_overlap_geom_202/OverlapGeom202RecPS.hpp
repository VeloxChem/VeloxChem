#ifndef OverlapGeom202RecPS_hpp
#define OverlapGeom202RecPS_hpp
...
/**
 Evaluates <d^(2)/dA^(2)P|1|d^(2)/dB^(2)S>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom202PS(CSubMatrix*      matrix_xx_xx,
