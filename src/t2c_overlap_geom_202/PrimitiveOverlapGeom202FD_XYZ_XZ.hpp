#ifndef PrimitiveOverlapGeom202FD_XYZ_XZ
#define PrimitiveOverlapGeom202FD_XYZ_XZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XYZ|1|d^(2)/dB^(2)D_XZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202FD_XYZ_XZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FD_XYZ_XZ */
