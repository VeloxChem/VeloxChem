#ifndef PrimitiveOverlapGeom202SD_0_XX
#define PrimitiveOverlapGeom202SD_0_XX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)S_0|1|d^(2)/dB^(2)D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom202SD_0_XX(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202SD_0_XX */
