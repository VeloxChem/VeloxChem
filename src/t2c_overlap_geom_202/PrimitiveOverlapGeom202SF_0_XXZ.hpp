#ifndef PrimitiveOverlapGeom202SF_0_XXZ
#define PrimitiveOverlapGeom202SF_0_XXZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)S_0|1|d^(2)/dB^(2)F_XXZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202SF_0_XXZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202SF_0_XXZ */
