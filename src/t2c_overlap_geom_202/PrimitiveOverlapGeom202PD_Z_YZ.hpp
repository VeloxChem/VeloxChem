#ifndef PrimitiveOverlapGeom202PD_Z_YZ
#define PrimitiveOverlapGeom202PD_Z_YZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|d^(2)/dB^(2)D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202PD_Z_YZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202PD_Z_YZ */
