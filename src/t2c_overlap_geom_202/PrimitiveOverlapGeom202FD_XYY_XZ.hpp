#ifndef PrimitiveOverlapGeom202FD_XYY_XZ
#define PrimitiveOverlapGeom202FD_XYY_XZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XYY|1|d^(2)/dB^(2)D_XZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202FD_XYY_XZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FD_XYY_XZ */
