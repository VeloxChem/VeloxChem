#ifndef PrimitiveOverlapGeom202PF_Z_YZZ
#define PrimitiveOverlapGeom202PF_Z_YZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|d^(2)/dB^(2)F_YZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202PF_Z_YZZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202PF_Z_YZZ */
