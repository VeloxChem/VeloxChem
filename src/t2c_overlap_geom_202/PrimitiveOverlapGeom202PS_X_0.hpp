#ifndef PrimitiveOverlapGeom202PS_X_0
#define PrimitiveOverlapGeom202PS_X_0
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|d^(2)/dB^(2)S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom202PS_X_0(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202PS_X_0 */
