#ifndef PrimitiveOverlapGeom202FD_YYY_XY
#define PrimitiveOverlapGeom202FD_YYY_XY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_YYY|1|d^(2)/dB^(2)D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom202FD_YYY_XY(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FD_YYY_XY */
