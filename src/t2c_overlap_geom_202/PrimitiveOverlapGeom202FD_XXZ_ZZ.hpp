#ifndef PrimitiveOverlapGeom202FD_XXZ_ZZ
#define PrimitiveOverlapGeom202FD_XXZ_ZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XXZ|1|d^(2)/dB^(2)D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202FD_XXZ_ZZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FD_XXZ_ZZ */
