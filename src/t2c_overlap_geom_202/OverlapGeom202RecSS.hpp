#ifndef OverlapGeom202RecSS_hpp
#define OverlapGeom202RecSS_hpp
...
/**
 Evaluates <d^(2)/dA^(2)S|1|d^(2)/dB^(2)S>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom202SS(CSubMatrix*      matrix_xx_xx,
