#ifndef OverlapGeom202RecSF_hpp
#define OverlapGeom202RecSF_hpp
...
/**
 Evaluates <d^(2)/dA^(2)S|1|d^(2)/dB^(2)F>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom202SF(CSubMatrix*      matrix_xx_xx,
