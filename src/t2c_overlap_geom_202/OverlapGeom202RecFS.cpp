#include "OverlapGeom202RecFS.hpp"

#include <cmath>

#include "BatchFunc.hpp"
#include "PrimitiveOverlapGeom202FS_XXX_0.hpp"
#include "PrimitiveOverlapGeom202FS_XXY_0.hpp"
#include "PrimitiveOverlapGeom202FS_XXZ_0.hpp"
#include "PrimitiveOverlapGeom202FS_XYY_0.hpp"
#include "PrimitiveOverlapGeom202FS_XYZ_0.hpp"
#include "PrimitiveOverlapGeom202FS_XZZ_0.hpp"
#include "PrimitiveOverlapGeom202FS_YYY_0.hpp"
#include "PrimitiveOverlapGeom202FS_YYZ_0.hpp"
#include "PrimitiveOverlapGeom202FS_YZZ_0.hpp"
#include "PrimitiveOverlapGeom202FS_ZZZ_0.hpp"
#include "T2CDistributor.hpp"

namespace ovlrec {  // ovlrec namespace

auto
compOverlapGeom202FS(CSubMatrix*      matrix_xx_xx,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom202FS_XXX_0(buffer_xx_xx,
                                                                buffer_xx_xy,
                                                                buffer_xx_xz,
                                                                buffer_xx_yy,
                                                                buffer_xx_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom202FS_XXY_0(buffer_xx_xx,
                                                                buffer_xx_xy,
                                                                buffer_xx_xz,
                                                                buffer_xx_yy,
                                                                buffer_xx_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom202FS_XXZ_0(buffer_xx_xx,
                                                                buffer_xx_xy,
                                                                buffer_xx_xz,
                                                                buffer_xx_yy,
                                                                buffer_xx_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom202FS_XYY_0(buffer_xx_xx,
                                                                buffer_xx_xy,
                                                                buffer_xx_xz,
                                                                buffer_xx_yy,
                                                                buffer_xx_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom202FS_XYZ_0(buffer_xx_xx,
                                                                buffer_xx_xy,
                                                                buffer_xx_xz,
                                                                buffer_xx_yy,
                                                                buffer_xx_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom202FS_XZZ_0(buffer_xx_xx,
                                                                buffer_xx_xy,
                                                                buffer_xx_xz,
                                                                buffer_xx_yy,
                                                                buffer_xx_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom202FS_YYY_0(buffer_xx_xx,
                                                                buffer_xx_xy,
                                                                buffer_xx_xz,
                                                                buffer_xx_yy,
                                                                buffer_xx_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom202FS_YYZ_0(buffer_xx_xx,
                                                                buffer_xx_xy,
                                                                buffer_xx_xz,
                                                                buffer_xx_yy,
                                                                buffer_xx_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom202FS_YZZ_0(buffer_xx_xx,
                                                                buffer_xx_xy,
                                                                buffer_xx_xz,
                                                                buffer_xx_yy,
                                                                buffer_xx_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom202FS_ZZZ_0(buffer_xx_xx,
                                                                buffer_xx_xy,
                                                                buffer_xx_xz,
                                                                buffer_xx_yy,
                                                                buffer_xx_yz,
