#ifndef OverlapGeom202RecDD_hpp
#define OverlapGeom202RecDD_hpp
...
/**
 Evaluates <d^(2)/dA^(2)D|1|d^(2)/dB^(2)D>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom202DD(CSubMatrix*      matrix_xx_xx,
