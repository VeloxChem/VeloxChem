#ifndef OverlapGeom202RecDF_hpp
#define OverlapGeom202RecDF_hpp
...
/**
 Evaluates <d^(2)/dA^(2)D|1|d^(2)/dB^(2)F>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom202DF(CSubMatrix*      matrix_xx_xx,
