#ifndef PrimitiveOverlapGeom202DD_XY_XX
#define PrimitiveOverlapGeom202DD_XY_XX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XY|1|d^(2)/dB^(2)D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom202DD_XY_XX(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DD_XY_XX */
