#ifndef PrimitiveOverlapGeom202PD_Z_YY
#define PrimitiveOverlapGeom202PD_Z_YY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|d^(2)/dB^(2)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom202PD_Z_YY(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202PD_Z_YY */
