#ifndef PrimitiveOverlapGeom202SP_0_Y
#define PrimitiveOverlapGeom202SP_0_Y
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)S_0|1|d^(2)/dB^(2)P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom202SP_0_Y(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202SP_0_Y */
