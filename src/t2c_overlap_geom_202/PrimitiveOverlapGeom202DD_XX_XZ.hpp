#ifndef PrimitiveOverlapGeom202DD_XX_XZ
#define PrimitiveOverlapGeom202DD_XX_XZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XX|1|d^(2)/dB^(2)D_XZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202DD_XX_XZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DD_XX_XZ */
