#ifndef OverlapGeom202RecFF_hpp
#define OverlapGeom202RecFF_hpp
...
/**
 Evaluates <d^(2)/dA^(2)F|1|d^(2)/dB^(2)F>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom202FF(CSubMatrix*      matrix_xx_xx,
