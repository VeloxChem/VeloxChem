#ifndef PrimitiveOverlapGeom202DD_YY_XX
#define PrimitiveOverlapGeom202DD_YY_XX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YY|1|d^(2)/dB^(2)D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom202DD_YY_XX(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DD_YY_XX */
