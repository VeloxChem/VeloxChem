#ifndef PrimitiveOverlapGeom202SF_0_YYZ
#define PrimitiveOverlapGeom202SF_0_YYZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)S_0|1|d^(2)/dB^(2)F_YYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202SF_0_YYZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202SF_0_YYZ */
