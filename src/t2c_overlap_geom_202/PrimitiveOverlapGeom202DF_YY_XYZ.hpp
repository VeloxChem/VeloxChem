#ifndef PrimitiveOverlapGeom202DF_YY_XYZ
#define PrimitiveOverlapGeom202DF_YY_XYZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YY|1|d^(2)/dB^(2)F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202DF_YY_XYZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DF_YY_XYZ */
