#ifndef PrimitiveOverlapGeom202DD_ZZ_YZ
#define PrimitiveOverlapGeom202DD_ZZ_YZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_ZZ|1|d^(2)/dB^(2)D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202DD_ZZ_YZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DD_ZZ_YZ */
