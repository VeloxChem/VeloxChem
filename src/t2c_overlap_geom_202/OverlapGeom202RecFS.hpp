#ifndef OverlapGeom202RecFS_hpp
#define OverlapGeom202RecFS_hpp
...
/**
 Evaluates <d^(2)/dA^(2)F|1|d^(2)/dB^(2)S>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom202FS(CSubMatrix*      matrix_xx_xx,
