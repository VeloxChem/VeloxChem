#ifndef PrimitiveOverlapGeom202FF_XZZ_XXY
#define PrimitiveOverlapGeom202FF_XZZ_XXY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XZZ|1|d^(2)/dB^(2)F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom202FF_XZZ_XXY(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FF_XZZ_XXY */
