#ifndef OverlapGeom202RecPD_hpp
#define OverlapGeom202RecPD_hpp
...
/**
 Evaluates <d^(2)/dA^(2)P|1|d^(2)/dB^(2)D>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom202PD(CSubMatrix*      matrix_xx_xx,
