#ifndef PrimitiveOverlapGeom202FF_XXX_YZZ
#define PrimitiveOverlapGeom202FF_XXX_YZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XXX|1|d^(2)/dB^(2)F_YZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202FF_XXX_YZZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FF_XXX_YZZ */
