#ifndef PrimitiveOverlapGeom202FF_YZZ_XYZ
#define PrimitiveOverlapGeom202FF_YZZ_XYZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_YZZ|1|d^(2)/dB^(2)F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202FF_YZZ_XYZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FF_YZZ_XYZ */
