#ifndef PrimitiveOverlapGeom202FF_XXY_XYZ
#define PrimitiveOverlapGeom202FF_XXY_XYZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XXY|1|d^(2)/dB^(2)F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202FF_XXY_XYZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FF_XXY_XYZ */
