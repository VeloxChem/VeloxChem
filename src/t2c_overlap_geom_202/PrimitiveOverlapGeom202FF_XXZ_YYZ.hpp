#ifndef PrimitiveOverlapGeom202FF_XXZ_YYZ
#define PrimitiveOverlapGeom202FF_XXZ_YYZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XXZ|1|d^(2)/dB^(2)F_YYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202FF_XXZ_YYZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FF_XXZ_YYZ */
