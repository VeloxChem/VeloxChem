#ifndef PrimitiveOverlapGeom202SD_0_XZ
#define PrimitiveOverlapGeom202SD_0_XZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)S_0|1|d^(2)/dB^(2)D_XZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202SD_0_XZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202SD_0_XZ */
