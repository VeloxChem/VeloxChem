#ifndef OverlapGeom202RecPP_hpp
#define OverlapGeom202RecPP_hpp
...
/**
 Evaluates <d^(2)/dA^(2)P|1|d^(2)/dB^(2)P>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom202PP(CSubMatrix*      matrix_xx_xx,
