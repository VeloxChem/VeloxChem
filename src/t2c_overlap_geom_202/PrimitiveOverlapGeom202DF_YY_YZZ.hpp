#ifndef PrimitiveOverlapGeom202DF_YY_YZZ
#define PrimitiveOverlapGeom202DF_YY_YZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YY|1|d^(2)/dB^(2)F_YZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202DF_YY_YZZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DF_YY_YZZ */
