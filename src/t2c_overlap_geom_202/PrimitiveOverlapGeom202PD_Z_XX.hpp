#ifndef PrimitiveOverlapGeom202PD_Z_XX
#define PrimitiveOverlapGeom202PD_Z_XX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|d^(2)/dB^(2)D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom202PD_Z_XX(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202PD_Z_XX */
