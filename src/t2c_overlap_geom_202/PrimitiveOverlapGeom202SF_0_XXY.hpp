#ifndef PrimitiveOverlapGeom202SF_0_XXY
#define PrimitiveOverlapGeom202SF_0_XXY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)S_0|1|d^(2)/dB^(2)F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom202SF_0_XXY(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202SF_0_XXY */
