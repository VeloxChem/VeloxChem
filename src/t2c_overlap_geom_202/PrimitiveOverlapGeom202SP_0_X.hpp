#ifndef PrimitiveOverlapGeom202SP_0_X
#define PrimitiveOverlapGeom202SP_0_X
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)S_0|1|d^(2)/dB^(2)P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom202SP_0_X(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202SP_0_X */
