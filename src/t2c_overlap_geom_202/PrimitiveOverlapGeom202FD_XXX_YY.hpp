#ifndef PrimitiveOverlapGeom202FD_XXX_YY
#define PrimitiveOverlapGeom202FD_XXX_YY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XXX|1|d^(2)/dB^(2)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom202FD_XXX_YY(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FD_XXX_YY */
