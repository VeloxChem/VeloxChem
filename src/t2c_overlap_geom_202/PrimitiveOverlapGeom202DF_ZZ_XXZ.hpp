#ifndef PrimitiveOverlapGeom202DF_ZZ_XXZ
#define PrimitiveOverlapGeom202DF_ZZ_XXZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_ZZ|1|d^(2)/dB^(2)F_XXZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202DF_ZZ_XXZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DF_ZZ_XXZ */
