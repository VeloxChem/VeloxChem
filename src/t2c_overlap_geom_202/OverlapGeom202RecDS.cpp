#include "OverlapGeom202RecDS.hpp"
...
auto
compOverlapGeom202DS(CSubMatrix*      matrix_xx_xx,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom202DS_XX_0(buffer_xx_xx,
                                                               buffer_xx_xy,
                                                               buffer_xx_xz,
                                                               buffer_xx_yy,
                                                               buffer_xx_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom202DS_XY_0(buffer_xx_xx,
                                                               buffer_xx_xy,
                                                               buffer_xx_xz,
                                                               buffer_xx_yy,
                                                               buffer_xx_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom202DS_XZ_0(buffer_xx_xx,
                                                               buffer_xx_xy,
                                                               buffer_xx_xz,
                                                               buffer_xx_yy,
                                                               buffer_xx_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom202DS_YY_0(buffer_xx_xx,
                                                               buffer_xx_xy,
                                                               buffer_xx_xz,
                                                               buffer_xx_yy,
                                                               buffer_xx_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom202DS_YZ_0(buffer_xx_xx,
                                                               buffer_xx_xy,
                                                               buffer_xx_xz,
                                                               buffer_xx_yy,
                                                               buffer_xx_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom202DS_ZZ_0(buffer_xx_xx,
                                                               buffer_xx_xy,
                                                               buffer_xx_xz,
                                                               buffer_xx_yy,
                                                               buffer_xx_yz,
