#ifndef PrimitiveOverlapGeom202DF_YY_XXY
#define PrimitiveOverlapGeom202DF_YY_XXY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YY|1|d^(2)/dB^(2)F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom202DF_YY_XXY(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DF_YY_XXY */
