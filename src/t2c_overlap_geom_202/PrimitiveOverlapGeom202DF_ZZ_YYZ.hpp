#ifndef PrimitiveOverlapGeom202DF_ZZ_YYZ
#define PrimitiveOverlapGeom202DF_ZZ_YYZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_ZZ|1|d^(2)/dB^(2)F_YYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202DF_ZZ_YYZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DF_ZZ_YYZ */
