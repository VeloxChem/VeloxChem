#ifndef PrimitiveOverlapGeom202FF_XYY_XXZ
#define PrimitiveOverlapGeom202FF_XYY_XXZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XYY|1|d^(2)/dB^(2)F_XXZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202FF_XYY_XXZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FF_XYY_XXZ */
