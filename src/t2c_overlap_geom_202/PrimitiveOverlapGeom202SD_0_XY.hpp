#ifndef PrimitiveOverlapGeom202SD_0_XY
#define PrimitiveOverlapGeom202SD_0_XY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)S_0|1|d^(2)/dB^(2)D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom202SD_0_XY(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202SD_0_XY */
