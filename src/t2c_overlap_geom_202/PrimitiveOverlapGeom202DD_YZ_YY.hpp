#ifndef PrimitiveOverlapGeom202DD_YZ_YY
#define PrimitiveOverlapGeom202DD_YZ_YY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YZ|1|d^(2)/dB^(2)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom202DD_YZ_YY(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DD_YZ_YY */
