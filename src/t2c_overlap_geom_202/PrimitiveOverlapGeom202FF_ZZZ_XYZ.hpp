#ifndef PrimitiveOverlapGeom202FF_ZZZ_XYZ
#define PrimitiveOverlapGeom202FF_ZZZ_XYZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_ZZZ|1|d^(2)/dB^(2)F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202FF_ZZZ_XYZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FF_ZZZ_XYZ */
