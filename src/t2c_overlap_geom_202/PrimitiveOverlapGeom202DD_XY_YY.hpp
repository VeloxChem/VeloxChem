#ifndef PrimitiveOverlapGeom202DD_XY_YY
#define PrimitiveOverlapGeom202DD_XY_YY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XY|1|d^(2)/dB^(2)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom202DD_XY_YY(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DD_XY_YY */
