#ifndef PrimitiveOverlapGeom202PF_Y_YYY
#define PrimitiveOverlapGeom202PF_Y_YYY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Y|1|d^(2)/dB^(2)F_YYY> integrals.
...
*/
auto compPrimitiveOverlapGeom202PF_Y_YYY(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202PF_Y_YYY */
