#ifndef PrimitiveOverlapGeom202PP_X_X
#define PrimitiveOverlapGeom202PP_X_X
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|d^(2)/dB^(2)P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom202PP_X_X(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202PP_X_X */
