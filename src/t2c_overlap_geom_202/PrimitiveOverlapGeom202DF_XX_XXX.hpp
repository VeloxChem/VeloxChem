#ifndef PrimitiveOverlapGeom202DF_XX_XXX
#define PrimitiveOverlapGeom202DF_XX_XXX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XX|1|d^(2)/dB^(2)F_XXX> integrals.
...
*/
auto compPrimitiveOverlapGeom202DF_XX_XXX(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DF_XX_XXX */
