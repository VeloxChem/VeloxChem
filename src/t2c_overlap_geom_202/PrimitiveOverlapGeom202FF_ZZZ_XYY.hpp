#ifndef PrimitiveOverlapGeom202FF_ZZZ_XYY
#define PrimitiveOverlapGeom202FF_ZZZ_XYY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_ZZZ|1|d^(2)/dB^(2)F_XYY> integrals.
...
*/
auto compPrimitiveOverlapGeom202FF_ZZZ_XYY(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FF_ZZZ_XYY */
