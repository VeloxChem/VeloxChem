#ifndef PrimitiveOverlapGeom202SF_0_XXX
#define PrimitiveOverlapGeom202SF_0_XXX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)S_0|1|d^(2)/dB^(2)F_XXX> integrals.
...
*/
auto compPrimitiveOverlapGeom202SF_0_XXX(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202SF_0_XXX */
