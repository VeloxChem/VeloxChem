#ifndef PrimitiveOverlapGeom202PF_X_YYY
#define PrimitiveOverlapGeom202PF_X_YYY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|d^(2)/dB^(2)F_YYY> integrals.
...
*/
auto compPrimitiveOverlapGeom202PF_X_YYY(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202PF_X_YYY */
