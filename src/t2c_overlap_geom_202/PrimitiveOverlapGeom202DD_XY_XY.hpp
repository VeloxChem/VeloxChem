#ifndef PrimitiveOverlapGeom202DD_XY_XY
#define PrimitiveOverlapGeom202DD_XY_XY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XY|1|d^(2)/dB^(2)D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom202DD_XY_XY(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DD_XY_XY */
