#ifndef PrimitiveOverlapGeom202DP_YY_Y
#define PrimitiveOverlapGeom202DP_YY_Y
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YY|1|d^(2)/dB^(2)P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom202DP_YY_Y(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DP_YY_Y */
