#ifndef PrimitiveOverlapGeom202FF_YYY_XXX
#define PrimitiveOverlapGeom202FF_YYY_XXX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_YYY|1|d^(2)/dB^(2)F_XXX> integrals.
...
*/
auto compPrimitiveOverlapGeom202FF_YYY_XXX(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FF_YYY_XXX */
