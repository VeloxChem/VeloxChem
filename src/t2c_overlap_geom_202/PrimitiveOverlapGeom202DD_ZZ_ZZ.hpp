#ifndef PrimitiveOverlapGeom202DD_ZZ_ZZ
#define PrimitiveOverlapGeom202DD_ZZ_ZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_ZZ|1|d^(2)/dB^(2)D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202DD_ZZ_ZZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DD_ZZ_ZZ */
