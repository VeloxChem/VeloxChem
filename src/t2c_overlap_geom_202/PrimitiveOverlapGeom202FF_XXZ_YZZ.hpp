#ifndef PrimitiveOverlapGeom202FF_XXZ_YZZ
#define PrimitiveOverlapGeom202FF_XXZ_YZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XXZ|1|d^(2)/dB^(2)F_YZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202FF_XXZ_YZZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FF_XXZ_YZZ */
