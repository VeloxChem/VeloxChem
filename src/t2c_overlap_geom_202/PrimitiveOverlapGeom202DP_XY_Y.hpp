#ifndef PrimitiveOverlapGeom202DP_XY_Y
#define PrimitiveOverlapGeom202DP_XY_Y
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XY|1|d^(2)/dB^(2)P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom202DP_XY_Y(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DP_XY_Y */
