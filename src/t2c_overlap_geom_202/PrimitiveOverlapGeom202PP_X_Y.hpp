#ifndef PrimitiveOverlapGeom202PP_X_Y
#define PrimitiveOverlapGeom202PP_X_Y
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|d^(2)/dB^(2)P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom202PP_X_Y(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202PP_X_Y */
