#ifndef PrimitiveOverlapGeom202DD_ZZ_YY
#define PrimitiveOverlapGeom202DD_ZZ_YY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_ZZ|1|d^(2)/dB^(2)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom202DD_ZZ_YY(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DD_ZZ_YY */
