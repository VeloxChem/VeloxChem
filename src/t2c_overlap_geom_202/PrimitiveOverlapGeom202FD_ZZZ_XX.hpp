#ifndef PrimitiveOverlapGeom202FD_ZZZ_XX
#define PrimitiveOverlapGeom202FD_ZZZ_XX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_ZZZ|1|d^(2)/dB^(2)D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom202FD_ZZZ_XX(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FD_ZZZ_XX */
