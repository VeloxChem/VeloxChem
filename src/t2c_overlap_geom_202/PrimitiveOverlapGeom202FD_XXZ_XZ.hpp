#ifndef PrimitiveOverlapGeom202FD_XXZ_XZ
#define PrimitiveOverlapGeom202FD_XXZ_XZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XXZ|1|d^(2)/dB^(2)D_XZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202FD_XXZ_XZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FD_XXZ_XZ */
