#ifndef PrimitiveOverlapGeom202DD_XX_XX
#define PrimitiveOverlapGeom202DD_XX_XX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XX|1|d^(2)/dB^(2)D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom202DD_XX_XX(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DD_XX_XX */
