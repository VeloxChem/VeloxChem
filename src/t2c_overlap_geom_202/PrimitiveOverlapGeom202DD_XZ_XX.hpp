#ifndef PrimitiveOverlapGeom202DD_XZ_XX
#define PrimitiveOverlapGeom202DD_XZ_XX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XZ|1|d^(2)/dB^(2)D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom202DD_XZ_XX(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DD_XZ_XX */
