#ifndef OverlapGeom202RecSD_hpp
#define OverlapGeom202RecSD_hpp
...
/**
 Evaluates <d^(2)/dA^(2)S|1|d^(2)/dB^(2)D>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom202SD(CSubMatrix*      matrix_xx_xx,
