#ifndef PrimitiveOverlapGeom202DF_YZ_XXY
#define PrimitiveOverlapGeom202DF_YZ_XXY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YZ|1|d^(2)/dB^(2)F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom202DF_YZ_XXY(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DF_YZ_XXY */
