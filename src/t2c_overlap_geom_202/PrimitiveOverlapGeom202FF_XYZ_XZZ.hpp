#ifndef PrimitiveOverlapGeom202FF_XYZ_XZZ
#define PrimitiveOverlapGeom202FF_XYZ_XZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XYZ|1|d^(2)/dB^(2)F_XZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202FF_XYZ_XZZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FF_XYZ_XZZ */
