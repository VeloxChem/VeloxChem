#ifndef PrimitiveOverlapGeom202FD_XYZ_ZZ
#define PrimitiveOverlapGeom202FD_XYZ_ZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XYZ|1|d^(2)/dB^(2)D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202FD_XYZ_ZZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202FD_XYZ_ZZ */
