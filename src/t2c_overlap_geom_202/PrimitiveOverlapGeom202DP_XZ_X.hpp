#ifndef PrimitiveOverlapGeom202DP_XZ_X
#define PrimitiveOverlapGeom202DP_XZ_X
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XZ|1|d^(2)/dB^(2)P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom202DP_XZ_X(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DP_XZ_X */
