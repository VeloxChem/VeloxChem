#ifndef PrimitiveOverlapGeom202DD_XY_ZZ
#define PrimitiveOverlapGeom202DD_XY_ZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XY|1|d^(2)/dB^(2)D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom202DD_XY_ZZ(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DD_XY_ZZ */
