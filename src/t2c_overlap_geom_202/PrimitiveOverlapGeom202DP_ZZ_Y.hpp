#ifndef PrimitiveOverlapGeom202DP_ZZ_Y
#define PrimitiveOverlapGeom202DP_ZZ_Y
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_ZZ|1|d^(2)/dB^(2)P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom202DP_ZZ_Y(TDoubleArray&       buffer_xx_xx,
...
#endif /* PrimitiveOverlapGeom202DP_ZZ_Y */
