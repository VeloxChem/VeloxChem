#ifndef ThreeCenterOverlapGeom100SumRecSS_hpp
#define ThreeCenterOverlapGeom100SumRecSS_hpp
...
/// @brief Computes (d^(1)/dA^(1)S|G(r)|S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_geom_10_ss(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_10_sx(pbuffer, 5, 2, 1, 1, a_exp);
...
#endif /* ThreeCenterOverlapGeom100SumRecSS_hpp */
