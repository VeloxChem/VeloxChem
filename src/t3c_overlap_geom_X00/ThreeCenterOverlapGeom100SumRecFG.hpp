#ifndef ThreeCenterOverlapGeom100SumRecFG_hpp
#define ThreeCenterOverlapGeom100SumRecFG_hpp
...
/// @brief Computes (d^(1)/dA^(1)F|G(r)|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_geom_10_fg(T& distributor,
                            ...
                            const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(1249, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_10_fx(pbuffer, 799, 234, 574, 1, 15, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 799, ket_width, ket_npgtos);
                }
            }
...
#endif /* ThreeCenterOverlapGeom100SumRecFG_hpp */
