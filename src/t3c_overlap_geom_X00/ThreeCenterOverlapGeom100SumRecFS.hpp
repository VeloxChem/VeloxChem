#ifndef ThreeCenterOverlapGeom100SumRecFS_hpp
#define ThreeCenterOverlapGeom100SumRecFS_hpp
...
/// @brief Computes (d^(1)/dA^(1)F|G(r)|S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_geom_10_fs(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_10_fx(pbuffer, 36, 5, 21, 1, 1, a_exp);
...
#endif /* ThreeCenterOverlapGeom100SumRecFS_hpp */
