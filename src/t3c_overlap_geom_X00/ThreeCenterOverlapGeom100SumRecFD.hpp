#ifndef ThreeCenterOverlapGeom100SumRecFD_hpp
#define ThreeCenterOverlapGeom100SumRecFD_hpp
...
/// @brief Computes (d^(1)/dA^(1)F|G(r)|D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_geom_10_fd(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3ovlrec::comp_prim_overlap_gd(pbuffer, 191, 65, 101, 131, factors, 11, a_exp, exgtos[l]);

                    t2cgeom::comp_prim_op_geom_10_fx(pbuffer, 281, 65, 191, 1, 6, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 281, ket_width, ket_npgtos);
                }
            }
...
#endif /* ThreeCenterOverlapGeom100SumRecFD_hpp */
