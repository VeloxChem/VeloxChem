#ifndef ThreeCenterOverlapGeom100SumRecPD_hpp
#define ThreeCenterOverlapGeom100SumRecPD_hpp
...
/// @brief Computes (d^(1)/dA^(1)P|G(r)|D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_geom_10_pd(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_10_px(pbuffer, 74, 5, 38, 1, 6, a_exp);
...
#endif /* ThreeCenterOverlapGeom100SumRecPD_hpp */
