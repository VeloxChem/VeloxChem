#ifndef ThreeCenterOverlapGeom100SumRecDP_hpp
#define ThreeCenterOverlapGeom100SumRecDP_hpp
...
/// @brief Computes (d^(1)/dA^(1)D|G(r)|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_geom_10_dp(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3ovlrec::comp_prim_overlap_fp(pbuffer, 41, 8, 17, 23, factors, 11, a_exp, exgtos[l]);

                    t2cgeom::comp_prim_op_geom_10_dx(pbuffer, 71, 8, 41, 1, 3, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 71, ket_width, ket_npgtos);
                }
            }
...
#endif /* ThreeCenterOverlapGeom100SumRecDP_hpp */
