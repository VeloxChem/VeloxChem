#ifndef ThreeCenterOverlapGeom100SumRecPP_hpp
#define ThreeCenterOverlapGeom100SumRecPP_hpp
...
/// @brief Computes (d^(1)/dA^(1)P|G(r)|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_geom_10_pp(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3ovlrec::comp_prim_overlap_dp(pbuffer, 17, 2, 5, 8, factors, 11, a_exp, exgtos[l]);

                    t2cgeom::comp_prim_op_geom_10_px(pbuffer, 35, 2, 17, 1, 3, a_exp);
...
#endif /* ThreeCenterOverlapGeom100SumRecPP_hpp */
