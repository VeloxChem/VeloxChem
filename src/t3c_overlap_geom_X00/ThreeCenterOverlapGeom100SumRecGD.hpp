#ifndef ThreeCenterOverlapGeom100SumRecGD_hpp
#define ThreeCenterOverlapGeom100SumRecGD_hpp
...
/// @brief Computes (d^(1)/dA^(1)G|G(r)|D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_geom_10_gd(T& distributor,
                            ...
                            const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(732, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3ovlrec::comp_prim_overlap_gp(pbuffer, 201, 47, 101, 111, factors, 11, a_exp, exgtos[l]);

                    t3ovlrec::comp_prim_overlap_gd(pbuffer, 246, 65, 111, 141, factors, 11, a_exp, exgtos[l]);

                    t3ovlrec::comp_prim_overlap_hd(pbuffer, 336, 141, 201, 246, factors, 11, a_exp, exgtos[l]);

                    t2cgeom::comp_prim_op_geom_10_gx(pbuffer, 462, 141, 336, 1, 6, a_exp);
...
#endif /* ThreeCenterOverlapGeom100SumRecGD_hpp */
