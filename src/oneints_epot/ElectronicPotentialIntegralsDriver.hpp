...
class CElectronicPotentialIntegralsDriver
{
     ...
     */
    CElectronicPotentialMatrix _compElectronicPotentialIntegrals(const CGtoContainer* braGtoContainer, const CGtoContainer* ketGtoContainer) const;
     ...
     */
    void _compElectronicPotentialForGtoBlocks(COneIntsDistribution* distPattern, const CGtoBlock& braGtoBlock, const CGtoBlock& ketGtoBlock) const;
     ...
     */
    CVecThreeIndexes _getRecursionPattern(const CGtoBlock& braGtoBlock, const CGtoBlock& ketGtoBlock) const;
     ...
     */
    int32_t _getIndexesForRecursionPattern(std::vector<int32_t>& recIndexes, const CVecThreeIndexes& recPattern, const int32_t maxPrimGtos) const;
   ...
   public:
     ...
     */
    CElectronicPotentialMatrix compute(const CMolecule& molecule, const CMolecularBasis& basis) const;
