#ifndef NuclearPotentialGeom101SumRecSS_hpp
#define NuclearPotentialGeom101SumRecSS_hpp
...
/// @brief Computes (d^(1)/dA^(1)S|A|d^(1)/dB^(1)S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_geom_11_ss(T&                               distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < coords.size(); l++)
                {
                    ...
                    t2cfunc::comp_boys_args(bf_data, 1, factors, 17, a_exp);
                    ...
                    t2cgeom::comp_prim_op_geom_11_ss(pbuffer, 19, 10, 1, factors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 19, charges[l], ket_width, ket_npgtos);
                }
            }
...
#endif /* NuclearPotentialGeom101SumRecSS_hpp */
