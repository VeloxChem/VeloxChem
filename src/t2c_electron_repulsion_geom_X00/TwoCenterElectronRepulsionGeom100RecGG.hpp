#ifndef TwoCenterElectronRepulsionGeom100RecGG_hpp
#define TwoCenterElectronRepulsionGeom100RecGG_hpp
...
/// @brief Computes (d^(1)/dA^(1)G|1/|r-r'||G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electron_repulsion_geom_10_gg(T& distributor,
                                   ...
                                   const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(3070, ket_npgtos);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cgeom::comp_prim_op_geom_10_gx(pbuffer, 2395, 1255, 2080, 1, 15, a_exp);

                t2cfunc::reduce(cbuffer, pbuffer, 2395, ket_width, ket_npgtos);
            }
...
#endif /* TwoCenterElectronRepulsionGeom100RecGG_hpp */
