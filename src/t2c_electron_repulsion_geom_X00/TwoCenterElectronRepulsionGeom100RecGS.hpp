#ifndef TwoCenterElectronRepulsionGeom100RecGS_hpp
#define TwoCenterElectronRepulsionGeom100RecGS_hpp
...
/// @brief Computes (d^(1)/dA^(1)G|1/|r-r'||S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electron_repulsion_geom_10_gs(T& distributor,
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cgeom::comp_prim_op_geom_10_gx(pbuffer, 104, 38, 83, 1, 1, a_exp);
...
#endif /* TwoCenterElectronRepulsionGeom100RecGS_hpp */
