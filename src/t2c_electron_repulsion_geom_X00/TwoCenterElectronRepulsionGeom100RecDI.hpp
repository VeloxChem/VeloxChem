#ifndef TwoCenterElectronRepulsionGeom100RecDI_hpp
#define TwoCenterElectronRepulsionGeom100RecDI_hpp
...
/// @brief Computes (d^(1)/dA^(1)D|1/|r-r'||I)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electron_repulsion_geom_10_di(T& distributor,
                                   ...
                                   const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(1816, ket_npgtos);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cgeom::comp_prim_op_geom_10_dx(pbuffer, 1312, 486, 1032, 1, 28, a_exp);

                t2cfunc::reduce(cbuffer, pbuffer, 1312, ket_width, ket_npgtos);
            }
...
#endif /* TwoCenterElectronRepulsionGeom100RecDI_hpp */
