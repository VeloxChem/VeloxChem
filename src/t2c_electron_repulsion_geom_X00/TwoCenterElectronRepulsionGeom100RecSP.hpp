#ifndef TwoCenterElectronRepulsionGeom100RecSP_hpp
#define TwoCenterElectronRepulsionGeom100RecSP_hpp
...
/// @brief Computes (d^(1)/dA^(1)S|1/|r-r'||P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electron_repulsion_geom_10_sp(T& distributor,
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2ceri::comp_prim_electron_repulsion_sp(pbuffer, 2, 1, factors, 11);

                t2ceri::comp_prim_electron_repulsion_pp(pbuffer, 5, 0, 2, factors, 8, a_exp);
...
#endif /* TwoCenterElectronRepulsionGeom100RecSP_hpp */
