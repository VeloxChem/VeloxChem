#ifndef TwoCenterElectronRepulsionGeom100RecGP_hpp
#define TwoCenterElectronRepulsionGeom100RecGP_hpp
...
/// @brief Computes (d^(1)/dA^(1)G|1/|r-r'||P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electron_repulsion_geom_10_gp(T& distributor,
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cgeom::comp_prim_op_geom_10_gx(pbuffer, 370, 157, 307, 1, 3, a_exp);

                t2cfunc::reduce(cbuffer, pbuffer, 370, ket_width, ket_npgtos);
            }
...
#endif /* TwoCenterElectronRepulsionGeom100RecGP_hpp */
