#ifndef TwoCenterElectronRepulsionGeom100RecDG_hpp
#define TwoCenterElectronRepulsionGeom100RecDG_hpp
...
/// @brief Computes (d^(1)/dA^(1)D|1/|r-r'||G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electron_repulsion_geom_10_dg(T& distributor,
                                   ...
                                   const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(893, ket_npgtos);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cgeom::comp_prim_op_geom_10_dx(pbuffer, 623, 188, 473, 1, 15, a_exp);

                t2cfunc::reduce(cbuffer, pbuffer, 623, ket_width, ket_npgtos);
            }
...
#endif /* TwoCenterElectronRepulsionGeom100RecDG_hpp */
