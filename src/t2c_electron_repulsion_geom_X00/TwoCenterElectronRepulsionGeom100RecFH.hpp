#ifndef TwoCenterElectronRepulsionGeom100RecFH_hpp
#define TwoCenterElectronRepulsionGeom100RecFH_hpp
...
/// @brief Computes (d^(1)/dA^(1)F|1/|r-r'||H)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electron_repulsion_geom_10_fh(T& distributor,
                                   ...
                                   const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(2533, ket_npgtos);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cgeom::comp_prim_op_geom_10_fx(pbuffer, 1903, 850, 1588, 1, 21, a_exp);

                t2cfunc::reduce(cbuffer, pbuffer, 1903, ket_width, ket_npgtos);
            }
...
#endif /* TwoCenterElectronRepulsionGeom100RecFH_hpp */
