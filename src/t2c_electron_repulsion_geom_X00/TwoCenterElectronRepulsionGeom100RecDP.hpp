#ifndef TwoCenterElectronRepulsionGeom100RecDP_hpp
#define TwoCenterElectronRepulsionGeom100RecDP_hpp
...
/// @brief Computes (d^(1)/dA^(1)D|1/|r-r'||P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electron_repulsion_geom_10_dp(T& distributor,
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cgeom::comp_prim_op_geom_10_dx(pbuffer, 97, 16, 67, 1, 3, a_exp);

                t2cfunc::reduce(cbuffer, pbuffer, 97, ket_width, ket_npgtos);
            }
...
#endif /* TwoCenterElectronRepulsionGeom100RecDP_hpp */
