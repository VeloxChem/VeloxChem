#ifndef PrimitiveQuadrupolePD_X_XY
#define PrimitiveQuadrupolePD_X_XY
...
/**
 Evaluates block of primitive <P_X|r^2|D_XY> integrals.
...
*/
auto compPrimitiveQuadrupolePD_X_XY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePD_X_XY */
