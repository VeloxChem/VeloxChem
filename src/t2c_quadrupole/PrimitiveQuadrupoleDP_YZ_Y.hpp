#ifndef PrimitiveQuadrupoleDP_YZ_Y
#define PrimitiveQuadrupoleDP_YZ_Y
...
/**
 Evaluates block of primitive <D_YZ|r^2|P_Y> integrals.
...
*/
auto compPrimitiveQuadrupoleDP_YZ_Y(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleDP_YZ_Y */
