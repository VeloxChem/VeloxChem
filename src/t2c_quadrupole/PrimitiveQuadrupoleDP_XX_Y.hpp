#ifndef PrimitiveQuadrupoleDP_XX_Y
#define PrimitiveQuadrupoleDP_XX_Y
...
/**
 Evaluates block of primitive <D_XX|r^2|P_Y> integrals.
...
*/
auto compPrimitiveQuadrupoleDP_XX_Y(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleDP_XX_Y */
