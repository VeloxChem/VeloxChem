#ifndef PrimitiveQuadrupolePP_Y_Y
#define PrimitiveQuadrupolePP_Y_Y
...
/**
 Evaluates block of primitive <P_Y|r^2|P_Y> integrals.
...
*/
auto compPrimitiveQuadrupolePP_Y_Y(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePP_Y_Y */
