#ifndef PrimitiveQuadrupolePD_X_YZ
#define PrimitiveQuadrupolePD_X_YZ
...
/**
 Evaluates block of primitive <P_X|r^2|D_YZ> integrals.
...
*/
auto compPrimitiveQuadrupolePD_X_YZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePD_X_YZ */
