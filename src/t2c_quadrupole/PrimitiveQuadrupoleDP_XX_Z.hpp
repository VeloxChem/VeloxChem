#ifndef PrimitiveQuadrupoleDP_XX_Z
#define PrimitiveQuadrupoleDP_XX_Z
...
/**
 Evaluates block of primitive <D_XX|r^2|P_Z> integrals.
...
*/
auto compPrimitiveQuadrupoleDP_XX_Z(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleDP_XX_Z */
