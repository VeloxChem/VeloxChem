#ifndef QuadrupoleRecGG_hpp
#define QuadrupoleRecGG_hpp
...
/**
 Evaluates <G|r^2|G>  integrals for given GTOs block.
...
*/
auto compQuadrupoleGG(CSubMatrix*      matrix_xx,
...
/**
 Evaluates <G|r^2|G>  integrals for given pair of GTOs blocks.
