#ifndef QuadrupoleRecSG_hpp
#define QuadrupoleRecSG_hpp
...
/**
 Evaluates <S|r^2|G>  integrals for given pair of GTOs blocks.
...
*/
auto compQuadrupoleSG(CSubMatrix*      matrix_xx,
