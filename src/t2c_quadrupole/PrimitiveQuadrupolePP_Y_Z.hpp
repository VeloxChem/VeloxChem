#ifndef PrimitiveQuadrupolePP_Y_Z
#define PrimitiveQuadrupolePP_Y_Z
...
/**
 Evaluates block of primitive <P_Y|r^2|P_Z> integrals.
...
*/
auto compPrimitiveQuadrupolePP_Y_Z(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePP_Y_Z */
