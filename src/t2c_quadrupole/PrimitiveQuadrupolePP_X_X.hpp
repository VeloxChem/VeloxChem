#ifndef PrimitiveQuadrupolePP_X_X
#define PrimitiveQuadrupolePP_X_X
...
/**
 Evaluates block of primitive <P_X|r^2|P_X> integrals.
...
*/
auto compPrimitiveQuadrupolePP_X_X(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePP_X_X */
