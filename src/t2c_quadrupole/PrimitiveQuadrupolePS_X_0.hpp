#ifndef PrimitiveQuadrupolePS_X_0
#define PrimitiveQuadrupolePS_X_0
...
/**
 Evaluates block of primitive <P_X|r^2|S_0> integrals.
...
*/
auto compPrimitiveQuadrupolePS_X_0(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePS_X_0 */
