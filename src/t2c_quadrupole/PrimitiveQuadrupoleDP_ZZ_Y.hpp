#ifndef PrimitiveQuadrupoleDP_ZZ_Y
#define PrimitiveQuadrupoleDP_ZZ_Y
...
/**
 Evaluates block of primitive <D_ZZ|r^2|P_Y> integrals.
...
*/
auto compPrimitiveQuadrupoleDP_ZZ_Y(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleDP_ZZ_Y */
