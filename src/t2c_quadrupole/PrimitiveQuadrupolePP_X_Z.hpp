#ifndef PrimitiveQuadrupolePP_X_Z
#define PrimitiveQuadrupolePP_X_Z
...
/**
 Evaluates block of primitive <P_X|r^2|P_Z> integrals.
...
*/
auto compPrimitiveQuadrupolePP_X_Z(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePP_X_Z */
