#ifndef PrimitiveQuadrupoleDP_ZZ_Z
#define PrimitiveQuadrupoleDP_ZZ_Z
...
/**
 Evaluates block of primitive <D_ZZ|r^2|P_Z> integrals.
...
*/
auto compPrimitiveQuadrupoleDP_ZZ_Z(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleDP_ZZ_Z */
