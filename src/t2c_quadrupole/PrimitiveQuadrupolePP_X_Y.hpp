#ifndef PrimitiveQuadrupolePP_X_Y
#define PrimitiveQuadrupolePP_X_Y
...
/**
 Evaluates block of primitive <P_X|r^2|P_Y> integrals.
...
*/
auto compPrimitiveQuadrupolePP_X_Y(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePP_X_Y */
