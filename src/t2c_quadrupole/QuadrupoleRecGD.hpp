#ifndef QuadrupoleRecGD_hpp
#define QuadrupoleRecGD_hpp
...
/**
 Evaluates <G|r^2|D>  integrals for given pair of GTOs blocks.
...
*/
auto compQuadrupoleGD(CSubMatrix*      matrix_xx,
