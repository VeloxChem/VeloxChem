#ifndef PrimitiveQuadrupolePD_X_ZZ
#define PrimitiveQuadrupolePD_X_ZZ
...
/**
 Evaluates block of primitive <P_X|r^2|D_ZZ> integrals.
...
*/
auto compPrimitiveQuadrupolePD_X_ZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePD_X_ZZ */
