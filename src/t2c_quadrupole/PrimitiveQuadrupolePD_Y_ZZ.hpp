#ifndef PrimitiveQuadrupolePD_Y_ZZ
#define PrimitiveQuadrupolePD_Y_ZZ
...
/**
 Evaluates block of primitive <P_Y|r^2|D_ZZ> integrals.
...
*/
auto compPrimitiveQuadrupolePD_Y_ZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePD_Y_ZZ */
