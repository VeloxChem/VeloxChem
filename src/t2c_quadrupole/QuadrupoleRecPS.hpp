#ifndef QuadrupoleRecPS_hpp
#define QuadrupoleRecPS_hpp
...
/**
 Evaluates <P|r^2|S>  integrals for given pair of GTOs blocks.
...
*/
auto compQuadrupolePS(CSubMatrix*      matrix_xx,
