#ifndef QuadrupoleRecGF_hpp
#define QuadrupoleRecGF_hpp
...
/**
 Evaluates <G|r^2|F>  integrals for given pair of GTOs blocks.
...
*/
auto compQuadrupoleGF(CSubMatrix*      matrix_xx,
