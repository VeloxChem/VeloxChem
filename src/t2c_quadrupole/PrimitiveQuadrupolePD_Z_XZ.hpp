#ifndef PrimitiveQuadrupolePD_Z_XZ
#define PrimitiveQuadrupolePD_Z_XZ
...
/**
 Evaluates block of primitive <P_Z|r^2|D_XZ> integrals.
...
*/
auto compPrimitiveQuadrupolePD_Z_XZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePD_Z_XZ */
