#ifndef QuadrupoleRecSP_hpp
#define QuadrupoleRecSP_hpp
...
/**
 Evaluates <S|r^2|P>  integrals for given pair of GTOs blocks.
...
*/
auto compQuadrupoleSP(CSubMatrix*      matrix_xx,
