#ifndef PrimitiveQuadrupolePD_Z_ZZ
#define PrimitiveQuadrupolePD_Z_ZZ
...
/**
 Evaluates block of primitive <P_Z|r^2|D_ZZ> integrals.
...
*/
auto compPrimitiveQuadrupolePD_Z_ZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePD_Z_ZZ */
