#include "QuadrupoleRecGP.hpp"

#include <cmath>

#include "BatchFunc.hpp"
#include "PrimitiveQuadrupoleGP_XXXX_X.hpp"
#include "PrimitiveQuadrupoleGP_XXXX_Y.hpp"
#include "PrimitiveQuadrupoleGP_XXXX_Z.hpp"
#include "PrimitiveQuadrupoleGP_XXXY_X.hpp"
...
#include "PrimitiveQuadrupoleGP_XXYY_Y.hpp"
#include "PrimitiveQuadrupoleGP_XXYY_Z.hpp"
#include "PrimitiveQuadrupoleGP_XXYZ_X.hpp"
#include "PrimitiveQuadrupoleGP_XXYZ_Y.hpp"
#include "PrimitiveQuadrupoleGP_XXYZ_Z.hpp"
#include "PrimitiveQuadrupoleGP_XXZZ_X.hpp"
#include "PrimitiveQuadrupoleGP_XXZZ_Y.hpp"
#include "PrimitiveQuadrupoleGP_XXZZ_Z.hpp"
#include "PrimitiveQuadrupoleGP_XYYY_X.hpp"
#include "PrimitiveQuadrupoleGP_XYYY_Y.hpp"
#include "PrimitiveQuadrupoleGP_XYYY_Z.hpp"
#include "PrimitiveQuadrupoleGP_XYYZ_X.hpp"
#include "PrimitiveQuadrupoleGP_XYYZ_Y.hpp"
#include "PrimitiveQuadrupoleGP_XYYZ_Z.hpp"
#include "PrimitiveQuadrupoleGP_XYZZ_X.hpp"
#include "PrimitiveQuadrupoleGP_XYZZ_Y.hpp"
#include "PrimitiveQuadrupoleGP_XYZZ_Z.hpp"
#include "PrimitiveQuadrupoleGP_XZZZ_X.hpp"
#include "PrimitiveQuadrupoleGP_XZZZ_Y.hpp"
#include "PrimitiveQuadrupoleGP_XZZZ_Z.hpp"
#include "PrimitiveQuadrupoleGP_YYYY_X.hpp"
#include "PrimitiveQuadrupoleGP_YYYY_Y.hpp"
#include "PrimitiveQuadrupoleGP_YYYY_Z.hpp"
#include "PrimitiveQuadrupoleGP_YYYZ_X.hpp"
#include "PrimitiveQuadrupoleGP_YYYZ_Y.hpp"
#include "PrimitiveQuadrupoleGP_YYYZ_Z.hpp"
#include "PrimitiveQuadrupoleGP_YYZZ_X.hpp"
#include "PrimitiveQuadrupoleGP_YYZZ_Y.hpp"
#include "PrimitiveQuadrupoleGP_YYZZ_Z.hpp"
#include "PrimitiveQuadrupoleGP_YZZZ_X.hpp"
#include "PrimitiveQuadrupoleGP_YZZZ_Y.hpp"
#include "PrimitiveQuadrupoleGP_YZZZ_Z.hpp"
#include "PrimitiveQuadrupoleGP_ZZZZ_X.hpp"
...
auto
compQuadrupoleGP(CSubMatrix*      matrix_xx,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XXXX_X(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XXXX_Y(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XXXX_Z(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            t2cfunc::distribute(matrix_xx, buffer_xx, 3.0, bra_gto_indexes, ket_gto_indexes, 4, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xx, buffer_xx, -0.5 * f4_5, bra_gto_indexes, ket_gto_indexes, 6, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xx, buffer_xx, 0.25 * f4_35, bra_gto_indexes, ket_gto_indexes, 8, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xy, buffer_xy, 3.0, bra_gto_indexes, ket_gto_indexes, 4, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xy, buffer_xy, -0.5 * f4_5, bra_gto_indexes, ket_gto_indexes, 6, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xy, buffer_xy, 0.25 * f4_35, bra_gto_indexes, ket_gto_indexes, 8, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xz, buffer_xz, 3.0, bra_gto_indexes, ket_gto_indexes, 4, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xz, buffer_xz, -0.5 * f4_5, bra_gto_indexes, ket_gto_indexes, 6, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xz, buffer_xz, 0.25 * f4_35, bra_gto_indexes, ket_gto_indexes, 8, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yy, buffer_yy, 3.0, bra_gto_indexes, ket_gto_indexes, 4, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yy, buffer_yy, -0.5 * f4_5, bra_gto_indexes, ket_gto_indexes, 6, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yy, buffer_yy, 0.25 * f4_35, bra_gto_indexes, ket_gto_indexes, 8, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yz, buffer_yz, 3.0, bra_gto_indexes, ket_gto_indexes, 4, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yz, buffer_yz, -0.5 * f4_5, bra_gto_indexes, ket_gto_indexes, 6, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yz, buffer_yz, 0.25 * f4_35, bra_gto_indexes, ket_gto_indexes, 8, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_zz, buffer_zz, 3.0, bra_gto_indexes, ket_gto_indexes, 4, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_zz, buffer_zz, -0.5 * f4_5, bra_gto_indexes, ket_gto_indexes, 6, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_zz, buffer_zz, 0.25 * f4_35, bra_gto_indexes, ket_gto_indexes, 8, 1, j, ket_first, ket_last, ang_order);
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XXXY_X(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XXXY_Y(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XXXY_Z(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            t2cfunc::distribute(matrix_xx, buffer_xx, f4_35, bra_gto_indexes, ket_gto_indexes, 0, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xx, buffer_xx, -f4_5, bra_gto_indexes, ket_gto_indexes, 2, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xy, buffer_xy, f4_35, bra_gto_indexes, ket_gto_indexes, 0, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xy, buffer_xy, -f4_5, bra_gto_indexes, ket_gto_indexes, 2, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xz, buffer_xz, f4_35, bra_gto_indexes, ket_gto_indexes, 0, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xz, buffer_xz, -f4_5, bra_gto_indexes, ket_gto_indexes, 2, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yy, buffer_yy, f4_35, bra_gto_indexes, ket_gto_indexes, 0, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yy, buffer_yy, -f4_5, bra_gto_indexes, ket_gto_indexes, 2, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yz, buffer_yz, f4_35, bra_gto_indexes, ket_gto_indexes, 0, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yz, buffer_yz, -f4_5, bra_gto_indexes, ket_gto_indexes, 2, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_zz, buffer_zz, f4_35, bra_gto_indexes, ket_gto_indexes, 0, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_zz, buffer_zz, -f4_5, bra_gto_indexes, ket_gto_indexes, 2, 1, j, ket_first, ket_last, ang_order);
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XXXZ_X(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XXXZ_Y(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XXXZ_Z(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            t2cfunc::distribute(matrix_xx, buffer_xx, -3.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 5, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xx, buffer_xx, f4_17, bra_gto_indexes, ket_gto_indexes, 7, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xy, buffer_xy, -3.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 5, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xy, buffer_xy, f4_17, bra_gto_indexes, ket_gto_indexes, 7, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xz, buffer_xz, -3.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 5, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xz, buffer_xz, f4_17, bra_gto_indexes, ket_gto_indexes, 7, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yy, buffer_yy, -3.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 5, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yy, buffer_yy, f4_17, bra_gto_indexes, ket_gto_indexes, 7, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yz, buffer_yz, -3.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 5, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yz, buffer_yz, f4_17, bra_gto_indexes, ket_gto_indexes, 7, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_zz, buffer_zz, -3.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 5, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_zz, buffer_zz, f4_17, bra_gto_indexes, ket_gto_indexes, 7, 1, j, ket_first, ket_last, ang_order);
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XXYY_X(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XXYY_Y(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XXYY_Z(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            t2cfunc::distribute(matrix_xx, buffer_xx, 6.0, bra_gto_indexes, ket_gto_indexes, 4, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xx, buffer_xx, -1.50 * f4_35, bra_gto_indexes, ket_gto_indexes, 8, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xy, buffer_xy, 6.0, bra_gto_indexes, ket_gto_indexes, 4, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xy, buffer_xy, -1.50 * f4_35, bra_gto_indexes, ket_gto_indexes, 8, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xz, buffer_xz, 6.0, bra_gto_indexes, ket_gto_indexes, 4, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xz, buffer_xz, -1.50 * f4_35, bra_gto_indexes, ket_gto_indexes, 8, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yy, buffer_yy, 6.0, bra_gto_indexes, ket_gto_indexes, 4, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yy, buffer_yy, -1.50 * f4_35, bra_gto_indexes, ket_gto_indexes, 8, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yz, buffer_yz, 6.0, bra_gto_indexes, ket_gto_indexes, 4, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yz, buffer_yz, -1.50 * f4_35, bra_gto_indexes, ket_gto_indexes, 8, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_zz, buffer_zz, 6.0, bra_gto_indexes, ket_gto_indexes, 4, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_zz, buffer_zz, -1.50 * f4_35, bra_gto_indexes, ket_gto_indexes, 8, 1, j, ket_first, ket_last, ang_order);
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XXYZ_X(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XXYZ_Y(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XXYZ_Z(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            t2cfunc::distribute(matrix_xx, buffer_xx, -3.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 3, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xy, buffer_xy, 3.0 * f4_17, bra_gto_indexes, ket_gto_indexes, 1, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xy, buffer_xy, -3.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 3, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xz, buffer_xz, 3.0 * f4_17, bra_gto_indexes, ket_gto_indexes, 1, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xz, buffer_xz, -3.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 3, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yy, buffer_yy, 3.0 * f4_17, bra_gto_indexes, ket_gto_indexes, 1, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yy, buffer_yy, -3.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 3, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yz, buffer_yz, 3.0 * f4_17, bra_gto_indexes, ket_gto_indexes, 1, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yz, buffer_yz, -3.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 3, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_zz, buffer_zz, 3.0 * f4_17, bra_gto_indexes, ket_gto_indexes, 1, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_zz, buffer_zz, -3.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 3, 1, j, ket_first, ket_last, ang_order);
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XXZZ_X(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XXZZ_Y(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XXZZ_Z(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            t2cfunc::distribute(matrix_xx, buffer_xx, -24.0, bra_gto_indexes, ket_gto_indexes, 4, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xx, buffer_xx, 3.0 * f4_5, bra_gto_indexes, ket_gto_indexes, 6, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xy, buffer_xy, -24.0, bra_gto_indexes, ket_gto_indexes, 4, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xy, buffer_xy, 3.0 * f4_5, bra_gto_indexes, ket_gto_indexes, 6, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xz, buffer_xz, -24.0, bra_gto_indexes, ket_gto_indexes, 4, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xz, buffer_xz, 3.0 * f4_5, bra_gto_indexes, ket_gto_indexes, 6, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yy, buffer_yy, -24.0, bra_gto_indexes, ket_gto_indexes, 4, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yy, buffer_yy, 3.0 * f4_5, bra_gto_indexes, ket_gto_indexes, 6, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yz, buffer_yz, -24.0, bra_gto_indexes, ket_gto_indexes, 4, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yz, buffer_yz, 3.0 * f4_5, bra_gto_indexes, ket_gto_indexes, 6, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_zz, buffer_zz, -24.0, bra_gto_indexes, ket_gto_indexes, 4, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_zz, buffer_zz, 3.0 * f4_5, bra_gto_indexes, ket_gto_indexes, 6, 1, j, ket_first, ket_last, ang_order);
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XYYY_X(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XYYY_Y(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XYYY_Z(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XYYZ_X(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XYYZ_Y(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XYYZ_Z(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            t2cfunc::distribute(matrix_xx, buffer_xx, -3.0 * f4_17, bra_gto_indexes, ket_gto_indexes, 7, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xy, buffer_xy, -3.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 5, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xy, buffer_xy, -3.0 * f4_17, bra_gto_indexes, ket_gto_indexes, 7, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xz, buffer_xz, -3.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 5, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xz, buffer_xz, -3.0 * f4_17, bra_gto_indexes, ket_gto_indexes, 7, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yy, buffer_yy, -3.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 5, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yy, buffer_yy, -3.0 * f4_17, bra_gto_indexes, ket_gto_indexes, 7, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yz, buffer_yz, -3.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 5, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yz, buffer_yz, -3.0 * f4_17, bra_gto_indexes, ket_gto_indexes, 7, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_zz, buffer_zz, -3.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 5, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_zz, buffer_zz, -3.0 * f4_17, bra_gto_indexes, ket_gto_indexes, 7, 1, j, ket_first, ket_last, ang_order);
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XYZZ_X(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XYZZ_Y(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XYZZ_Z(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            t2cfunc::distribute(matrix_xx, buffer_xx, 6.0 * f4_5, bra_gto_indexes, ket_gto_indexes, 2, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xy, buffer_xy, 6.0 * f4_5, bra_gto_indexes, ket_gto_indexes, 2, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xz, buffer_xz, 6.0 * f4_5, bra_gto_indexes, ket_gto_indexes, 2, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yy, buffer_yy, 6.0 * f4_5, bra_gto_indexes, ket_gto_indexes, 2, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yz, buffer_yz, 6.0 * f4_5, bra_gto_indexes, ket_gto_indexes, 2, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_zz, buffer_zz, 6.0 * f4_5, bra_gto_indexes, ket_gto_indexes, 2, 1, j, ket_first, ket_last, ang_order);
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XZZZ_X(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XZZZ_Y(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_XZZZ_Z(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            t2cfunc::distribute(matrix_xx, buffer_xx, 4.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 5, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xy, buffer_xy, 4.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 5, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xz, buffer_xz, 4.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 5, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yy, buffer_yy, 4.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 5, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yz, buffer_yz, 4.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 5, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_zz, buffer_zz, 4.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 5, 1, j, ket_first, ket_last, ang_order);
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_YYYY_X(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_YYYY_Y(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_YYYY_Z(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_YYYZ_X(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_YYYZ_Y(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_YYYZ_Z(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_YYZZ_X(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_YYZZ_Y(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_YYZZ_Z(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_YZZZ_X(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_YZZZ_Y(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_YZZZ_Z(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            t2cfunc::distribute(matrix_xx, buffer_xx, 4.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 3, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xy, buffer_xy, 4.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 3, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xz, buffer_xz, 4.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 3, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yy, buffer_yy, 4.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 3, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yz, buffer_yz, 4.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 3, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_zz, buffer_zz, 4.0 * f4_2, bra_gto_indexes, ket_gto_indexes, 3, 1, j, ket_first, ket_last, ang_order);
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_ZZZZ_X(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_ZZZZ_Y(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveQuadrupoleGP_ZZZZ_Z(buffer_xx,
                                                           buffer_xy,
                                                           buffer_xz,
                                                           buffer_yy,
                                                           buffer_yz,
            ...
            t2cfunc::distribute(matrix_xx, buffer_xx, 8.0, bra_gto_indexes, ket_gto_indexes, 4, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xy, buffer_xy, 8.0, bra_gto_indexes, ket_gto_indexes, 4, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_xz, buffer_xz, 8.0, bra_gto_indexes, ket_gto_indexes, 4, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yy, buffer_yy, 8.0, bra_gto_indexes, ket_gto_indexes, 4, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_yz, buffer_yz, 8.0, bra_gto_indexes, ket_gto_indexes, 4, 1, j, ket_first, ket_last, ang_order);

            t2cfunc::distribute(matrix_zz, buffer_zz, 8.0, bra_gto_indexes, ket_gto_indexes, 4, 1, j, ket_first, ket_last, ang_order);
        }
    }
}
