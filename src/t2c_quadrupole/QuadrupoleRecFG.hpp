#ifndef QuadrupoleRecFG_hpp
#define QuadrupoleRecFG_hpp
...
/**
 Evaluates <F|r^2|G>  integrals for given pair of GTOs blocks.
...
*/
auto compQuadrupoleFG(CSubMatrix*      matrix_xx,
