#ifndef QuadrupoleRecDD_hpp
#define QuadrupoleRecDD_hpp
...
/**
 Evaluates <D|r^2|D>  integrals for given GTOs block.
...
*/
auto compQuadrupoleDD(CSubMatrix*      matrix_xx,
...
/**
 Evaluates <D|r^2|D>  integrals for given pair of GTOs blocks.
