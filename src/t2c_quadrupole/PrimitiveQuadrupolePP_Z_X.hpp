#ifndef PrimitiveQuadrupolePP_Z_X
#define PrimitiveQuadrupolePP_Z_X
...
/**
 Evaluates block of primitive <P_Z|r^2|P_X> integrals.
...
*/
auto compPrimitiveQuadrupolePP_Z_X(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePP_Z_X */
