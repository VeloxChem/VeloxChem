#ifndef PrimitiveQuadrupoleDS_XY_0
#define PrimitiveQuadrupoleDS_XY_0
...
/**
 Evaluates block of primitive <D_XY|r^2|S_0> integrals.
...
*/
auto compPrimitiveQuadrupoleDS_XY_0(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleDS_XY_0 */
