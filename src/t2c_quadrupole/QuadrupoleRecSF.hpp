#ifndef QuadrupoleRecSF_hpp
#define QuadrupoleRecSF_hpp
...
/**
 Evaluates <S|r^2|F>  integrals for given pair of GTOs blocks.
...
*/
auto compQuadrupoleSF(CSubMatrix*      matrix_xx,
