#ifndef PrimitiveQuadrupolePP_Z_Z
#define PrimitiveQuadrupolePP_Z_Z
...
/**
 Evaluates block of primitive <P_Z|r^2|P_Z> integrals.
...
*/
auto compPrimitiveQuadrupolePP_Z_Z(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePP_Z_Z */
