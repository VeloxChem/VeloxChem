#ifndef QuadrupoleRecPP_hpp
#define QuadrupoleRecPP_hpp
...
/**
 Evaluates <P|r^2|P>  integrals for given GTOs block.
...
*/
auto compQuadrupolePP(CSubMatrix*      matrix_xx,
...
/**
 Evaluates <P|r^2|P>  integrals for given pair of GTOs blocks.
