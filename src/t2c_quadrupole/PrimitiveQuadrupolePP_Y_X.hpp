#ifndef PrimitiveQuadrupolePP_Y_X
#define PrimitiveQuadrupolePP_Y_X
...
/**
 Evaluates block of primitive <P_Y|r^2|P_X> integrals.
...
*/
auto compPrimitiveQuadrupolePP_Y_X(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePP_Y_X */
