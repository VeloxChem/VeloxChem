#ifndef QuadrupoleRecGS_hpp
#define QuadrupoleRecGS_hpp
...
/**
 Evaluates <G|r^2|S>  integrals for given pair of GTOs blocks.
...
*/
auto compQuadrupoleGS(CSubMatrix*      matrix_xx,
