#ifndef QuadrupoleRecDG_hpp
#define QuadrupoleRecDG_hpp
...
/**
 Evaluates <D|r^2|G>  integrals for given pair of GTOs blocks.
...
*/
auto compQuadrupoleDG(CSubMatrix*      matrix_xx,
