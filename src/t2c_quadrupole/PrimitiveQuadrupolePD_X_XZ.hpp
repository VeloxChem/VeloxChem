#ifndef PrimitiveQuadrupolePD_X_XZ
#define PrimitiveQuadrupolePD_X_XZ
...
/**
 Evaluates block of primitive <P_X|r^2|D_XZ> integrals.
...
*/
auto compPrimitiveQuadrupolePD_X_XZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePD_X_XZ */
