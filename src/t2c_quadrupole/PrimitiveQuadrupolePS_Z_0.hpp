#ifndef PrimitiveQuadrupolePS_Z_0
#define PrimitiveQuadrupolePS_Z_0
...
/**
 Evaluates block of primitive <P_Z|r^2|S_0> integrals.
...
*/
auto compPrimitiveQuadrupolePS_Z_0(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePS_Z_0 */
