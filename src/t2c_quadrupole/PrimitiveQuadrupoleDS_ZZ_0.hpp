#ifndef PrimitiveQuadrupoleDS_ZZ_0
#define PrimitiveQuadrupoleDS_ZZ_0
...
/**
 Evaluates block of primitive <D_ZZ|r^2|S_0> integrals.
...
*/
auto compPrimitiveQuadrupoleDS_ZZ_0(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleDS_ZZ_0 */
