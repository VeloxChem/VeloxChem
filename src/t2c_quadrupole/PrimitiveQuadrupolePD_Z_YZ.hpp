#ifndef PrimitiveQuadrupolePD_Z_YZ
#define PrimitiveQuadrupolePD_Z_YZ
...
/**
 Evaluates block of primitive <P_Z|r^2|D_YZ> integrals.
...
*/
auto compPrimitiveQuadrupolePD_Z_YZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePD_Z_YZ */
