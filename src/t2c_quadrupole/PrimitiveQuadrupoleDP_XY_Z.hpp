#ifndef PrimitiveQuadrupoleDP_XY_Z
#define PrimitiveQuadrupoleDP_XY_Z
...
/**
 Evaluates block of primitive <D_XY|r^2|P_Z> integrals.
...
*/
auto compPrimitiveQuadrupoleDP_XY_Z(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleDP_XY_Z */
