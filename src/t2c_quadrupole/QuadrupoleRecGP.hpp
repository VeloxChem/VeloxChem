#ifndef QuadrupoleRecGP_hpp
#define QuadrupoleRecGP_hpp
...
/**
 Evaluates <G|r^2|P>  integrals for given pair of GTOs blocks.
...
*/
auto compQuadrupoleGP(CSubMatrix*      matrix_xx,
