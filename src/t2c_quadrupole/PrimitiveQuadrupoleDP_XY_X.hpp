#ifndef PrimitiveQuadrupoleDP_XY_X
#define PrimitiveQuadrupoleDP_XY_X
...
/**
 Evaluates block of primitive <D_XY|r^2|P_X> integrals.
...
*/
auto compPrimitiveQuadrupoleDP_XY_X(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleDP_XY_X */
