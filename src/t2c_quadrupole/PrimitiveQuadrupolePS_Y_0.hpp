#ifndef PrimitiveQuadrupolePS_Y_0
#define PrimitiveQuadrupolePS_Y_0
...
/**
 Evaluates block of primitive <P_Y|r^2|S_0> integrals.
...
*/
auto compPrimitiveQuadrupolePS_Y_0(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePS_Y_0 */
