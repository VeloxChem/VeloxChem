#ifndef PrimitiveQuadrupolePD_Z_XX
#define PrimitiveQuadrupolePD_Z_XX
...
/**
 Evaluates block of primitive <P_Z|r^2|D_XX> integrals.
...
*/
auto compPrimitiveQuadrupolePD_Z_XX(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePD_Z_XX */
