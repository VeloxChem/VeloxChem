#ifndef QuadrupoleRecSD_hpp
#define QuadrupoleRecSD_hpp
...
/**
 Evaluates <S|r^2|D>  integrals for given pair of GTOs blocks.
...
*/
auto compQuadrupoleSD(CSubMatrix*      matrix_xx,
