#ifndef PrimitiveQuadrupoleDP_YY_X
#define PrimitiveQuadrupoleDP_YY_X
...
/**
 Evaluates block of primitive <D_YY|r^2|P_X> integrals.
...
*/
auto compPrimitiveQuadrupoleDP_YY_X(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleDP_YY_X */
