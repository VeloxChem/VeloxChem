#ifndef PrimitiveQuadrupoleDP_ZZ_X
#define PrimitiveQuadrupoleDP_ZZ_X
...
/**
 Evaluates block of primitive <D_ZZ|r^2|P_X> integrals.
...
*/
auto compPrimitiveQuadrupoleDP_ZZ_X(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleDP_ZZ_X */
