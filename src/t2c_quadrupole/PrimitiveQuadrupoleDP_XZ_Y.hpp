#ifndef PrimitiveQuadrupoleDP_XZ_Y
#define PrimitiveQuadrupoleDP_XZ_Y
...
/**
 Evaluates block of primitive <D_XZ|r^2|P_Y> integrals.
...
*/
auto compPrimitiveQuadrupoleDP_XZ_Y(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleDP_XZ_Y */
