#ifndef PrimitiveQuadrupolePP_Z_Y
#define PrimitiveQuadrupolePP_Z_Y
...
/**
 Evaluates block of primitive <P_Z|r^2|P_Y> integrals.
...
*/
auto compPrimitiveQuadrupolePP_Z_Y(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePP_Z_Y */
