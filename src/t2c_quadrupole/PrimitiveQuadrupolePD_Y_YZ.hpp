#ifndef PrimitiveQuadrupolePD_Y_YZ
#define PrimitiveQuadrupolePD_Y_YZ
...
/**
 Evaluates block of primitive <P_Y|r^2|D_YZ> integrals.
...
*/
auto compPrimitiveQuadrupolePD_Y_YZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePD_Y_YZ */
