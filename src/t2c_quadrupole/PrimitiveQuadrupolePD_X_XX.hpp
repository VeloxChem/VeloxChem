#ifndef PrimitiveQuadrupolePD_X_XX
#define PrimitiveQuadrupolePD_X_XX
...
/**
 Evaluates block of primitive <P_X|r^2|D_XX> integrals.
...
*/
auto compPrimitiveQuadrupolePD_X_XX(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePD_X_XX */
