#ifndef PrimitiveQuadrupolePD_Z_YY
#define PrimitiveQuadrupolePD_Z_YY
...
/**
 Evaluates block of primitive <P_Z|r^2|D_YY> integrals.
...
*/
auto compPrimitiveQuadrupolePD_Z_YY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePD_Z_YY */
