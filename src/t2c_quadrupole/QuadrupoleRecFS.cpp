...
#include "PrimitiveQuadrupoleFS_XXY_0.hpp"
#include "PrimitiveQuadrupoleFS_XXZ_0.hpp"
#include "PrimitiveQuadrupoleFS_XYY_0.hpp"
#include "PrimitiveQuadrupoleFS_XYZ_0.hpp"
#include "PrimitiveQuadrupoleFS_XZZ_0.hpp"
#include "PrimitiveQuadrupoleFS_YYY_0.hpp"
#include "PrimitiveQuadrupoleFS_YYZ_0.hpp"
#include "PrimitiveQuadrupoleFS_YZZ_0.hpp"
#include "PrimitiveQuadrupoleFS_ZZZ_0.hpp"
#include "T2CDistributor.hpp"

namespace quadrec {  // quadrec namespace

auto
compQuadrupoleFS(CSubMatrix*      matrix_xx,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFS_XXX_0(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFS_XXY_0(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFS_XXZ_0(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFS_XYY_0(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFS_XYZ_0(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFS_XZZ_0(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFS_YYY_0(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFS_YYZ_0(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFS_YZZ_0(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFS_ZZZ_0(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
