#ifndef QuadrupoleRecDP_hpp
#define QuadrupoleRecDP_hpp
...
/**
 Evaluates <D|r^2|P>  integrals for given pair of GTOs blocks.
...
*/
auto compQuadrupoleDP(CSubMatrix*      matrix_xx,
