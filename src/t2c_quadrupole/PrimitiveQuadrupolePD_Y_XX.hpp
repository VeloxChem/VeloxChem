#ifndef PrimitiveQuadrupolePD_Y_XX
#define PrimitiveQuadrupolePD_Y_XX
...
/**
 Evaluates block of primitive <P_Y|r^2|D_XX> integrals.
...
*/
auto compPrimitiveQuadrupolePD_Y_XX(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePD_Y_XX */
