#ifndef PrimitiveQuadrupolePD_Y_XZ
#define PrimitiveQuadrupolePD_Y_XZ
...
/**
 Evaluates block of primitive <P_Y|r^2|D_XZ> integrals.
...
*/
auto compPrimitiveQuadrupolePD_Y_XZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePD_Y_XZ */
