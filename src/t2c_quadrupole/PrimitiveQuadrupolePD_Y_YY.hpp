#ifndef PrimitiveQuadrupolePD_Y_YY
#define PrimitiveQuadrupolePD_Y_YY
...
/**
 Evaluates block of primitive <P_Y|r^2|D_YY> integrals.
...
*/
auto compPrimitiveQuadrupolePD_Y_YY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePD_Y_YY */
