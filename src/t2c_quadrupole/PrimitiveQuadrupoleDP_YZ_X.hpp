#ifndef PrimitiveQuadrupoleDP_YZ_X
#define PrimitiveQuadrupoleDP_YZ_X
...
/**
 Evaluates block of primitive <D_YZ|r^2|P_X> integrals.
...
*/
auto compPrimitiveQuadrupoleDP_YZ_X(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleDP_YZ_X */
