#ifndef QuadrupoleRecFP_hpp
#define QuadrupoleRecFP_hpp
...
/**
 Evaluates <F|r^2|P>  integrals for given pair of GTOs blocks.
...
*/
auto compQuadrupoleFP(CSubMatrix*      matrix_xx,
