        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_XX_XX(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_XX_XY(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_XX_XZ(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_XX_YY(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_XX_YZ(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_XX_ZZ(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_XY_XX(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_XY_XY(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_XY_XZ(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_XY_YY(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_XY_YZ(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_XY_ZZ(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_XZ_XX(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_XZ_XY(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_XZ_XZ(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_XZ_YY(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_XZ_YZ(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_XZ_ZZ(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_YY_XX(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_YY_XY(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_YY_XZ(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_YY_YY(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_YY_YZ(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_YY_ZZ(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_YZ_XX(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_YZ_XY(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_YZ_XZ(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_YZ_YY(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_YZ_YZ(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_YZ_ZZ(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_ZZ_XX(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_ZZ_XY(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_ZZ_XZ(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_ZZ_YY(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_ZZ_YZ(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleDD_ZZ_ZZ(buffer_xx,
                                                             buffer_xy,
                                                             buffer_xz,
                                                             buffer_yy,
                                                             buffer_yz,
