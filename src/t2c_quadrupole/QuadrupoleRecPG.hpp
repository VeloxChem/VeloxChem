#ifndef QuadrupoleRecPG_hpp
#define QuadrupoleRecPG_hpp
...
/**
 Evaluates <P|r^2|G>  integrals for given pair of GTOs blocks.
...
*/
auto compQuadrupolePG(CSubMatrix*      matrix_xx,
