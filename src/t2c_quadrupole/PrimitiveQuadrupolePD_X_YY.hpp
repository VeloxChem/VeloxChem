#ifndef PrimitiveQuadrupolePD_X_YY
#define PrimitiveQuadrupolePD_X_YY
...
/**
 Evaluates block of primitive <P_X|r^2|D_YY> integrals.
...
*/
auto compPrimitiveQuadrupolePD_X_YY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePD_X_YY */
