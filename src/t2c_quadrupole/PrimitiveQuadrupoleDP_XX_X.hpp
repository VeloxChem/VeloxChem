#ifndef PrimitiveQuadrupoleDP_XX_X
#define PrimitiveQuadrupoleDP_XX_X
...
/**
 Evaluates block of primitive <D_XX|r^2|P_X> integrals.
...
*/
auto compPrimitiveQuadrupoleDP_XX_X(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleDP_XX_X */
