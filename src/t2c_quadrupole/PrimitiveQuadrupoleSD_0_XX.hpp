#ifndef PrimitiveQuadrupoleSD_0_XX
#define PrimitiveQuadrupoleSD_0_XX
...
/**
 Evaluates block of primitive <S_0|r^2|D_XX> integrals.
...
*/
auto compPrimitiveQuadrupoleSD_0_XX(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleSD_0_XX */
