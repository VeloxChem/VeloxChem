#ifndef QuadrupoleRecDF_hpp
#define QuadrupoleRecDF_hpp
...
/**
 Evaluates <D|r^2|F>  integrals for given pair of GTOs blocks.
...
*/
auto compQuadrupoleDF(CSubMatrix*      matrix_xx,
