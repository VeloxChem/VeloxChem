#ifndef PrimitiveQuadrupoleDP_YZ_Z
#define PrimitiveQuadrupoleDP_YZ_Z
...
/**
 Evaluates block of primitive <D_YZ|r^2|P_Z> integrals.
...
*/
auto compPrimitiveQuadrupoleDP_YZ_Z(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleDP_YZ_Z */
