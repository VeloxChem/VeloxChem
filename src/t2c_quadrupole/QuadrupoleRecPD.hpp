#ifndef QuadrupoleRecPD_hpp
#define QuadrupoleRecPD_hpp
...
/**
 Evaluates <P|r^2|D>  integrals for given pair of GTOs blocks.
...
*/
auto compQuadrupolePD(CSubMatrix*      matrix_xx,
