#ifndef PrimitiveQuadrupolePD_Y_XY
#define PrimitiveQuadrupolePD_Y_XY
...
/**
 Evaluates block of primitive <P_Y|r^2|D_XY> integrals.
...
*/
auto compPrimitiveQuadrupolePD_Y_XY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePD_Y_XY */
