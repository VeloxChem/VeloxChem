#ifndef PrimitiveQuadrupoleSP_0_Y
#define PrimitiveQuadrupoleSP_0_Y
...
/**
 Evaluates block of primitive <S_0|r^2|P_Y> integrals.
...
*/
auto compPrimitiveQuadrupoleSP_0_Y(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleSP_0_Y */
