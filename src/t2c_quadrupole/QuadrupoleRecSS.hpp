#ifndef QuadrupoleRecSS_hpp
#define QuadrupoleRecSS_hpp
...
/**
 Evaluates <S|r^2|S>  integrals for given GTOs block.
...
*/
auto compQuadrupoleSS(CSubMatrix*      matrix_xx,
...
/**
 Evaluates <S|r^2|S>  integrals for given pair of GTOs blocks.
