#ifndef PrimitiveQuadrupoleDS_YZ_0
#define PrimitiveQuadrupoleDS_YZ_0
...
/**
 Evaluates block of primitive <D_YZ|r^2|S_0> integrals.
...
*/
auto compPrimitiveQuadrupoleDS_YZ_0(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleDS_YZ_0 */
