#ifndef PrimitiveQuadrupoleDP_YY_Y
#define PrimitiveQuadrupoleDP_YY_Y
...
/**
 Evaluates block of primitive <D_YY|r^2|P_Y> integrals.
...
*/
auto compPrimitiveQuadrupoleDP_YY_Y(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleDP_YY_Y */
