#ifndef PrimitiveQuadrupoleSP_0_X
#define PrimitiveQuadrupoleSP_0_X
...
/**
 Evaluates block of primitive <S_0|r^2|P_X> integrals.
...
*/
auto compPrimitiveQuadrupoleSP_0_X(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleSP_0_X */
