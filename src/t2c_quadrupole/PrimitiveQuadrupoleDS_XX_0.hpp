#ifndef PrimitiveQuadrupoleDS_XX_0
#define PrimitiveQuadrupoleDS_XX_0
...
/**
 Evaluates block of primitive <D_XX|r^2|S_0> integrals.
...
*/
auto compPrimitiveQuadrupoleDS_XX_0(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleDS_XX_0 */
