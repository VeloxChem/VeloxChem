#ifndef PrimitiveQuadrupoleDP_YY_Z
#define PrimitiveQuadrupoleDP_YY_Z
...
/**
 Evaluates block of primitive <D_YY|r^2|P_Z> integrals.
...
*/
auto compPrimitiveQuadrupoleDP_YY_Z(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleDP_YY_Z */
