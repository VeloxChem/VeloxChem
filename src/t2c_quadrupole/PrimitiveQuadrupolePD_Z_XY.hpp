#ifndef PrimitiveQuadrupolePD_Z_XY
#define PrimitiveQuadrupolePD_Z_XY
...
/**
 Evaluates block of primitive <P_Z|r^2|D_XY> integrals.
...
*/
auto compPrimitiveQuadrupolePD_Z_XY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupolePD_Z_XY */
