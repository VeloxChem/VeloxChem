...
#include "PrimitiveQuadrupoleFD_XXX_XZ.hpp"
#include "PrimitiveQuadrupoleFD_XXX_YY.hpp"
#include "PrimitiveQuadrupoleFD_XXX_YZ.hpp"
#include "PrimitiveQuadrupoleFD_XXX_ZZ.hpp"
#include "PrimitiveQuadrupoleFD_XXY_XX.hpp"
#include "PrimitiveQuadrupoleFD_XXY_XY.hpp"
#include "PrimitiveQuadrupoleFD_XXY_XZ.hpp"
#include "PrimitiveQuadrupoleFD_XXY_YY.hpp"
#include "PrimitiveQuadrupoleFD_XXY_YZ.hpp"
#include "PrimitiveQuadrupoleFD_XXY_ZZ.hpp"
#include "PrimitiveQuadrupoleFD_XXZ_XX.hpp"
#include "PrimitiveQuadrupoleFD_XXZ_XY.hpp"
#include "PrimitiveQuadrupoleFD_XXZ_XZ.hpp"
#include "PrimitiveQuadrupoleFD_XXZ_YY.hpp"
#include "PrimitiveQuadrupoleFD_XXZ_YZ.hpp"
#include "PrimitiveQuadrupoleFD_XXZ_ZZ.hpp"
#include "PrimitiveQuadrupoleFD_XYY_XX.hpp"
#include "PrimitiveQuadrupoleFD_XYY_XY.hpp"
#include "PrimitiveQuadrupoleFD_XYY_XZ.hpp"
#include "PrimitiveQuadrupoleFD_XYY_YY.hpp"
#include "PrimitiveQuadrupoleFD_XYY_YZ.hpp"
#include "PrimitiveQuadrupoleFD_XYY_ZZ.hpp"
#include "PrimitiveQuadrupoleFD_XYZ_XX.hpp"
#include "PrimitiveQuadrupoleFD_XYZ_XY.hpp"
#include "PrimitiveQuadrupoleFD_XYZ_XZ.hpp"
#include "PrimitiveQuadrupoleFD_XYZ_YY.hpp"
#include "PrimitiveQuadrupoleFD_XYZ_YZ.hpp"
#include "PrimitiveQuadrupoleFD_XYZ_ZZ.hpp"
#include "PrimitiveQuadrupoleFD_XZZ_XX.hpp"
#include "PrimitiveQuadrupoleFD_XZZ_XY.hpp"
#include "PrimitiveQuadrupoleFD_XZZ_XZ.hpp"
#include "PrimitiveQuadrupoleFD_XZZ_YY.hpp"
#include "PrimitiveQuadrupoleFD_XZZ_YZ.hpp"
...
#include "PrimitiveQuadrupoleFD_YYY_YY.hpp"
#include "PrimitiveQuadrupoleFD_YYY_YZ.hpp"
...
#include "PrimitiveQuadrupoleFD_YYZ_YY.hpp"
...
#include "PrimitiveQuadrupoleFD_YZZ_YY.hpp"
#include "PrimitiveQuadrupoleFD_YZZ_YZ.hpp"
#include "PrimitiveQuadrupoleFD_YZZ_ZZ.hpp"
#include "PrimitiveQuadrupoleFD_ZZZ_XX.hpp"
#include "PrimitiveQuadrupoleFD_ZZZ_XY.hpp"
#include "PrimitiveQuadrupoleFD_ZZZ_XZ.hpp"
#include "PrimitiveQuadrupoleFD_ZZZ_YY.hpp"
...
auto
compQuadrupoleFD(CSubMatrix*      matrix_xx,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XXX_XX(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XXX_XY(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XXX_XZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XXX_YY(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XXX_YZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XXX_ZZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XXY_XX(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XXY_XY(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XXY_XZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XXY_YY(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XXY_YZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XXY_ZZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XXZ_XX(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XXZ_XY(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XXZ_XZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XXZ_YY(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XXZ_YZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XXZ_ZZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XYY_XX(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XYY_XY(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XYY_XZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XYY_YY(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XYY_YZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XYY_ZZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XYZ_XX(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XYZ_XY(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XYZ_XZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XYZ_YY(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XYZ_YZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XYZ_ZZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XZZ_XX(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XZZ_XY(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XZZ_XZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XZZ_YY(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XZZ_YZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_XZZ_ZZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_YYY_XX(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_YYY_XY(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_YYY_XZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_YYY_YY(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_YYY_YZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_YYY_ZZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_YYZ_XX(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_YYZ_XY(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_YYZ_XZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_YYZ_YY(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_YYZ_YZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_YYZ_ZZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_YZZ_XX(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_YZZ_XY(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_YZZ_XZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_YZZ_YY(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_YZZ_YZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_YZZ_ZZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_ZZZ_XX(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_ZZZ_XY(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_ZZZ_XZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_ZZZ_YY(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_ZZZ_YZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    quadrec::compPrimitiveQuadrupoleFD_ZZZ_ZZ(buffer_xx,
                                                              buffer_xy,
                                                              buffer_xz,
                                                              buffer_yy,
                                                              buffer_yz,
