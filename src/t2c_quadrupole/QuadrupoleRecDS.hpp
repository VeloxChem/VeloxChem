#ifndef QuadrupoleRecDS_hpp
#define QuadrupoleRecDS_hpp
...
/**
 Evaluates <D|r^2|S>  integrals for given pair of GTOs blocks.
...
*/
auto compQuadrupoleDS(CSubMatrix*      matrix_xx,
