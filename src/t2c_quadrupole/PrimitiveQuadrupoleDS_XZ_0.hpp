#ifndef PrimitiveQuadrupoleDS_XZ_0
#define PrimitiveQuadrupoleDS_XZ_0
...
/**
 Evaluates block of primitive <D_XZ|r^2|S_0> integrals.
...
*/
auto compPrimitiveQuadrupoleDS_XZ_0(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleDS_XZ_0 */
