#ifndef QuadrupoleRecPF_hpp
#define QuadrupoleRecPF_hpp
...
/**
 Evaluates <P|r^2|F>  integrals for given pair of GTOs blocks.
...
*/
auto compQuadrupolePF(CSubMatrix*      matrix_xx,
