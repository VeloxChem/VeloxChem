#ifndef PrimitiveQuadrupoleDP_XZ_X
#define PrimitiveQuadrupoleDP_XZ_X
...
/**
 Evaluates block of primitive <D_XZ|r^2|P_X> integrals.
...
*/
auto compPrimitiveQuadrupoleDP_XZ_X(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleDP_XZ_X */
