#ifndef QuadrupoleRecFS_hpp
#define QuadrupoleRecFS_hpp
...
/**
 Evaluates <F|r^2|S>  integrals for given pair of GTOs blocks.
...
*/
auto compQuadrupoleFS(CSubMatrix*      matrix_xx,
