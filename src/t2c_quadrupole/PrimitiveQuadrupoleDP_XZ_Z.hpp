#ifndef PrimitiveQuadrupoleDP_XZ_Z
#define PrimitiveQuadrupoleDP_XZ_Z
...
/**
 Evaluates block of primitive <D_XZ|r^2|P_Z> integrals.
...
*/
auto compPrimitiveQuadrupoleDP_XZ_Z(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleDP_XZ_Z */
