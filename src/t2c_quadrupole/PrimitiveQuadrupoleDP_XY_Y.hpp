#ifndef PrimitiveQuadrupoleDP_XY_Y
#define PrimitiveQuadrupoleDP_XY_Y
...
/**
 Evaluates block of primitive <D_XY|r^2|P_Y> integrals.
...
*/
auto compPrimitiveQuadrupoleDP_XY_Y(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleDP_XY_Y */
