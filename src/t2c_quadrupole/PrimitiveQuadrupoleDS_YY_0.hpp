#ifndef PrimitiveQuadrupoleDS_YY_0
#define PrimitiveQuadrupoleDS_YY_0
...
/**
 Evaluates block of primitive <D_YY|r^2|S_0> integrals.
...
*/
auto compPrimitiveQuadrupoleDS_YY_0(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveQuadrupoleDS_YY_0 */
