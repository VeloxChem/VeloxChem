                       ...
                       const int32_t              iContrGto)
{
    ...
    auto tidx = recursionMap.getIndexOfTerm(CRecursionTerm({"Kinetic Energy"}, 0, true, {0, -1, -1, -1}, {0, -1, -1, -1}, 1, 1, 0));
                       ...
                       const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tt_0_xxxx_0[j] =
                pb_x[j] * tt_0_xxx_0[j] + 1.5 * fl1_fx * tt_0_xx_0[j] + 2.0 * fl1_fz * ts_0_xxxx_0[j] - 3.0 * fl1_fz * fl1_fgb * ts_0_xx_0[j];
            ...
            tt_0_yyyy_0[j] =
                pb_y[j] * tt_0_yyy_0[j] + 1.5 * fl1_fx * tt_0_yy_0[j] + 2.0 * fl1_fz * ts_0_yyyy_0[j] - 3.0 * fl1_fz * fl1_fgb * ts_0_yy_0[j];
            ...
            tt_0_zzzz_0[j] =
                pb_z[j] * tt_0_zzz_0[j] + 1.5 * fl1_fx * tt_0_zz_0[j] + 2.0 * fl1_fz * ts_0_zzzz_0[j] - 3.0 * fl1_fz * fl1_fgb * ts_0_zz_0[j];
        }
                       ...
                       const int32_t              iContrGto)
{
    ...
    auto pidx_t_4_0_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Kinetic Energy"}, 0, true, {4, -1, -1, -1}, {0, -1, -1, -1}, 1, 1, 0));
    ...
    auto pidx_s_4_0_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Overlap"}, 0, true, {4, -1, -1, -1}, {0, -1, -1, -1}, 1, 1, 0));
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tt_xxxx_0_0[j] =
                pa_x[j] * tt_xxx_0_0[j] + 1.5 * fl1_fx * tt_xx_0_0[j] + 2.0 * fl1_fz * ts_xxxx_0_0[j] - 3.0 * fl1_fz * fl1_fga * ts_xx_0_0[j];
            ...
            tt_yyyy_0_0[j] =
                pa_y[j] * tt_yyy_0_0[j] + 1.5 * fl1_fx * tt_yy_0_0[j] + 2.0 * fl1_fz * ts_yyyy_0_0[j] - 3.0 * fl1_fz * fl1_fga * ts_yy_0_0[j];
            ...
            tt_zzzz_0_0[j] =
                pa_z[j] * tt_zzz_0_0[j] + 1.5 * fl1_fx * tt_zz_0_0[j] + 2.0 * fl1_fz * ts_zzzz_0_0[j] - 3.0 * fl1_fz * fl1_fga * ts_zz_0_0[j];
        }
