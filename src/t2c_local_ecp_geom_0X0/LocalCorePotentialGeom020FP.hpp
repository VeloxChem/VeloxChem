#ifndef LocalCorePotentialGeom020FP_hpp
#define LocalCorePotentialGeom020FP_hpp
...
template <class T>
auto
comp_local_core_potential_geom_020_fp(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(793, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_hp(pbuffer, 550, 210, 400, 415, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_020_fp(pbuffer, 613, 23, 80, 104, 210, 300, 400, 460, 550, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 613, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom020FP_hpp */
