#ifndef LocalCorePotentialGeom010SP_hpp
#define LocalCorePotentialGeom010SP_hpp
...
template <class T>
auto
comp_local_core_potential_geom_010_sp(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_010_sp(pbuffer, 19, 0, 4, 10, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 19, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom010SP_hpp */
