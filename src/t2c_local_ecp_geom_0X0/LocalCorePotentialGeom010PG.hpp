#ifndef LocalCorePotentialGeom010PG_hpp
#define LocalCorePotentialGeom010PG_hpp
...
template <class T>
auto
comp_local_core_potential_geom_010_pg(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(419, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_pf(pbuffer, 56, 4, 10, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_pg(pbuffer, 86, 10, 20, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_ph(pbuffer, 131, 20, 35, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_dg(pbuffer, 194, 20, 56, 86, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_010_pg(pbuffer, 284, 20, 56, 131, 194, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 284, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom010PG_hpp */
