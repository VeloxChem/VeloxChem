#ifndef LocalCorePotentialGeom020FS_hpp
#define LocalCorePotentialGeom020FS_hpp
...
template <class T>
auto
comp_local_core_potential_geom_020_fs(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(341, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_hs(pbuffer, 260, 100, 200, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_020_fs(pbuffer, 281, 10, 46, 100, 140, 215, 260, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom020FS_hpp */
