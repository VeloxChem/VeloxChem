#ifndef LocalCorePotentialGeom010DG_hpp
#define LocalCorePotentialGeom010DG_hpp
...
template <class T>
auto
comp_local_core_potential_geom_010_dg(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(908, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_010_dg(pbuffer, 638, 104, 212, 362, 488, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom010DG_hpp */
