#ifndef LocalCorePotentialGeom020PS_hpp
#define LocalCorePotentialGeom020PS_hpp
...
template <class T>
auto
comp_local_core_potential_geom_020_ps(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_fs(pbuffer, 64, 10, 40, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_020_ps(pbuffer, 74, 1, 10, 22, 46, 64, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 74, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom020PS_hpp */
