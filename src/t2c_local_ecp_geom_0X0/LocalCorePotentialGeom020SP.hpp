#ifndef LocalCorePotentialGeom020SP_hpp
#define LocalCorePotentialGeom020SP_hpp
...
template <class T>
auto
comp_local_core_potential_geom_020_sp(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_dp(pbuffer, 50, 1, 20, 23, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_020_sp(pbuffer, 68, 1, 10, 20, 32, 50, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom020SP_hpp */
