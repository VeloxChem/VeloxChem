#ifndef LocalCorePotentialGeom010PD_hpp
#define LocalCorePotentialGeom010PD_hpp
...
template <class T>
auto
comp_local_core_potential_geom_010_pd(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(167, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_010_pd(pbuffer, 113, 4, 20, 47, 77, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 113, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom010PD_hpp */
