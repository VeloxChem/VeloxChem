#ifndef LocalCorePotentialGeom010SG_hpp
#define LocalCorePotentialGeom010SG_hpp
...
template <class T>
auto
comp_local_core_potential_geom_010_sg(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_pg(pbuffer, 56, 10, 20, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_010_sg(pbuffer, 101, 10, 35, 56, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 101, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom010SG_hpp */
