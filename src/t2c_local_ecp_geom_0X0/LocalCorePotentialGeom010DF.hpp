#ifndef LocalCorePotentialGeom010DF_hpp
#define LocalCorePotentialGeom010DF_hpp
...
template <class T>
auto
comp_local_core_potential_geom_010_df(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(603, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_010_df(pbuffer, 423, 62, 137, 233, 323, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom010DF_hpp */
