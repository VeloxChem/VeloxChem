#ifndef LocalCorePotentialGeom020PD_hpp
#define LocalCorePotentialGeom020PD_hpp
...
template <class T>
auto
comp_local_core_potential_geom_020_pd(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(422, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_fd(pbuffer, 254, 47, 140, 158, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_020_pd(pbuffer, 314, 1, 10, 35, 47, 95, 140, 194, 254, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 314, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom020PD_hpp */
