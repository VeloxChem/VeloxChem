#ifndef LocalCorePotentialGeom010DS_hpp
#define LocalCorePotentialGeom010DS_hpp
...
template <class T>
auto
comp_local_core_potential_geom_010_ds(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_010_ds(pbuffer, 50, 4, 22, 40, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom010DS_hpp */
