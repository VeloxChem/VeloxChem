#ifndef LocalCorePotentialGeom020FF_hpp
#define LocalCorePotentialGeom020FF_hpp
...
template <class T>
auto
comp_local_core_potential_geom_020_ff(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(2385, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_hf(pbuffer, 1575, 650, 1110, 1200, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_020_ff(pbuffer, 1785, 86, 248, 344, 560, 650, 900, 1110, 1350, 1575, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 1785, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom020FF_hpp */
