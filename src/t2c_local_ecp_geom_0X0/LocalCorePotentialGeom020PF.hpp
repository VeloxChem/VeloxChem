#ifndef LocalCorePotentialGeom020PF_hpp
#define LocalCorePotentialGeom020PF_hpp
...
template <class T>
auto
comp_local_core_potential_geom_020_pf(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(687, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_ff(pbuffer, 407, 83, 221, 257, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_020_pf(pbuffer, 507, 4, 20, 56, 83, 158, 221, 317, 407, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 507, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom020PF_hpp */
