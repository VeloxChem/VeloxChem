#ifndef LocalCorePotentialGeom020DF_hpp
#define LocalCorePotentialGeom020DF_hpp
...
template <class T>
auto
comp_local_core_potential_geom_020_df(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(1374, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_gf(pbuffer, 864, 278, 554, 614, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_020_df(pbuffer, 1014, 10, 68, 116, 224, 278, 428, 554, 714, 864, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 1014, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom020DF_hpp */
