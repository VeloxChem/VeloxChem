#ifndef LocalCorePotentialGeom020PP_hpp
#define LocalCorePotentialGeom020PP_hpp
...
template <class T>
auto
comp_local_core_potential_geom_020_pp(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(224, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_fp(pbuffer, 140, 23, 80, 86, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_020_pp(pbuffer, 170, 0, 4, 23, 50, 80, 104, 140, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 170, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom020PP_hpp */
