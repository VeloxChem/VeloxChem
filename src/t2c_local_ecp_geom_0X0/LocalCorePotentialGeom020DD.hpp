#ifndef LocalCorePotentialGeom020DD_hpp
#define LocalCorePotentialGeom020DD_hpp
...
template <class T>
auto
comp_local_core_potential_geom_020_dd(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(846, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_gd(pbuffer, 540, 164, 350, 380, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_020_dd(pbuffer, 630, 4, 38, 65, 140, 164, 260, 350, 440, 540, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 630, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom020DD_hpp */
