#ifndef LocalCorePotentialGeom010FS_hpp
#define LocalCorePotentialGeom010FS_hpp
...
template <class T>
auto
comp_local_core_potential_geom_010_fs(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_010_fs(pbuffer, 95, 16, 50, 80, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom010FS_hpp */
