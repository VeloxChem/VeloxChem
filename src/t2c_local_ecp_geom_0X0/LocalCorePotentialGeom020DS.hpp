#ifndef LocalCorePotentialGeom020DS_hpp
#define LocalCorePotentialGeom020DS_hpp
...
template <class T>
auto
comp_local_core_potential_geom_020_ds(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(191, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_gs(pbuffer, 140, 40, 100, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_020_ds(pbuffer, 155, 0, 13, 40, 64, 110, 140, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom020DS_hpp */
