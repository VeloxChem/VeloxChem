#ifndef LocalCorePotentialGeom020DP_hpp
#define LocalCorePotentialGeom020DP_hpp
...
template <class T>
auto
comp_local_core_potential_geom_020_dp(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(453, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_gp(pbuffer, 300, 86, 200, 210, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_020_dp(pbuffer, 345, 1, 20, 32, 86, 140, 200, 240, 300, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 345, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom020DP_hpp */
