#ifndef LocalCorePotentialGeom020SD_hpp
#define LocalCorePotentialGeom020SD_hpp
...
template <class T>
auto
comp_local_core_potential_geom_020_sd(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_dd(pbuffer, 92, 4, 35, 44, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_020_sd(pbuffer, 128, 0, 4, 20, 35, 62, 92, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom020SD_hpp */
