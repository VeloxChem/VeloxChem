#ifndef LocalCorePotentialGeom020GP_hpp
#define LocalCorePotentialGeom020GP_hpp
...
template <class T>
auto
comp_local_core_potential_geom_020_gp(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(1264, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_hs(pbuffer, 700, 200, 400, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_hp(pbuffer, 721, 210, 400, 415, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_hd(pbuffer, 784, 240, 415, 460, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_ip(pbuffer, 910, 415, 700, 721, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_020_gp(pbuffer, 994, 86, 200, 240, 415, 550, 700, 784, 910, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom020GP_hpp */
