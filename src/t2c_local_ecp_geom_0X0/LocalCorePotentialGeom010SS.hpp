#ifndef LocalCorePotentialGeom010SS_hpp
#define LocalCorePotentialGeom010SS_hpp
...
template <class T>
auto
comp_local_core_potential_geom_010_ss(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_010_ss(pbuffer, 7, 1, 4, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 7, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom010SS_hpp */
