#ifndef LocalCorePotentialGeom010PS_hpp
#define LocalCorePotentialGeom010PS_hpp
...
template <class T>
auto
comp_local_core_potential_geom_010_ps(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_010_ps(pbuffer, 22, 0, 7, 16, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 22, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom010PS_hpp */
