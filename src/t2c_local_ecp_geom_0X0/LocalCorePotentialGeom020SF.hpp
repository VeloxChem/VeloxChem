#ifndef LocalCorePotentialGeom020SF_hpp
#define LocalCorePotentialGeom020SF_hpp
...
template <class T>
auto
comp_local_core_potential_geom_020_sf(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_df(pbuffer, 149, 10, 56, 74, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_020_sf(pbuffer, 209, 1, 10, 35, 56, 104, 149, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 209, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom020SF_hpp */
