#ifndef LocalCorePotentialGeom020SS_hpp
#define LocalCorePotentialGeom020SS_hpp
...
template <class T>
auto
comp_local_core_potential_geom_020_ss(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_ds(pbuffer, 22, 0, 10, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_020_ss(pbuffer, 28, 0, 4, 13, 22, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 28, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom020SS_hpp */
