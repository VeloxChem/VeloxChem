#ifndef ElectronRepulsionGeom1000RecSDDF_hpp
#define ElectronRepulsionGeom1000RecSDDF_hpp
...
/// @brief Computes (SD|1/|r-r'||DF)  integral derivatives for two basis function pairs blocks.
...
template <class T>
inline auto
comp_electron_repulsion_geom_1000_sddf(T&                               distributor,
                                       ...
                                       const std::pair<size_t, size_t>& ket_indices) -> void
{
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            t4cfunc::bra_transform<0, 2>(sbuffer, 0, skbuffer, 560, 2, 3);
            
            t4cfunc::bra_transform<0, 2>(sbuffer, 175, skbuffer, 770, 2, 3);
            
            t4cfunc::bra_transform<0, 2>(sbuffer, 350, skbuffer, 980, 2, 3);
...
#endif /* ElectronRepulsionGeom1000RecSDDF_hpp */
