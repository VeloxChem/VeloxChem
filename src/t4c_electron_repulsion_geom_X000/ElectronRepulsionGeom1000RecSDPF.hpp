#ifndef ElectronRepulsionGeom1000RecSDPF_hpp
#define ElectronRepulsionGeom1000RecSDPF_hpp
...
/// @brief Computes (SD|1/|r-r'||PF)  integral derivatives for two basis function pairs blocks.
...
template <class T>
inline auto
comp_electron_repulsion_geom_1000_sdpf(T&                               distributor,
                                       ...
                                       const std::pair<size_t, size_t>& ket_indices) -> void
{
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            erirec::comp_bra_hrr_electron_repulsion_pdxx(skbuffer, 336, 0, 126, r_ab, 1, 3);

            t4cfunc::bra_transform<0, 2>(sbuffer, 0, skbuffer, 336, 1, 3);
            
            t4cfunc::bra_transform<0, 2>(sbuffer, 105, skbuffer, 462, 1, 3);
            
            t4cfunc::bra_transform<0, 2>(sbuffer, 210, skbuffer, 588, 1, 3);
...
#endif /* ElectronRepulsionGeom1000RecSDPF_hpp */
