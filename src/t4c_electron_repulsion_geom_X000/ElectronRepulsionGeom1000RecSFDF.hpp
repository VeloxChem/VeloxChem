#ifndef ElectronRepulsionGeom1000RecSFDF_hpp
#define ElectronRepulsionGeom1000RecSFDF_hpp
...
/// @brief Computes (SF|1/|r-r'||DF)  integral derivatives for two basis function pairs blocks.
...
template <class T>
inline auto
comp_electron_repulsion_geom_1000_sfdf(T&                               distributor,
                                       ...
                                       const std::pair<size_t, size_t>& ket_indices) -> void
{
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            t4cfunc::bra_transform<0, 3>(sbuffer, 0, skbuffer, 875, 2, 3);
            
            t4cfunc::bra_transform<0, 3>(sbuffer, 245, skbuffer, 1225, 2, 3);
            
            t4cfunc::bra_transform<0, 3>(sbuffer, 490, skbuffer, 1575, 2, 3);
...
#endif /* ElectronRepulsionGeom1000RecSFDF_hpp */
