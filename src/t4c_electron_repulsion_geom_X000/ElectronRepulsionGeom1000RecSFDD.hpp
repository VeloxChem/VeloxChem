#ifndef ElectronRepulsionGeom1000RecSFDD_hpp
#define ElectronRepulsionGeom1000RecSFDD_hpp
...
/// @brief Computes (SF|1/|r-r'||DD)  integral derivatives for two basis function pairs blocks.
...
template <class T>
inline auto
comp_electron_repulsion_geom_1000_sfdd(T&                               distributor,
                                       ...
                                       const std::pair<size_t, size_t>& ket_indices) -> void
{
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            t4cfunc::bra_transform<0, 3>(sbuffer, 0, skbuffer, 625, 2, 2);
            
            t4cfunc::bra_transform<0, 3>(sbuffer, 175, skbuffer, 875, 2, 2);
            
            t4cfunc::bra_transform<0, 3>(sbuffer, 350, skbuffer, 1125, 2, 2);
...
#endif /* ElectronRepulsionGeom1000RecSFDD_hpp */
