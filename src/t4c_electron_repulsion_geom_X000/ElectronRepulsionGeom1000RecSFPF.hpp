#ifndef ElectronRepulsionGeom1000RecSFPF_hpp
#define ElectronRepulsionGeom1000RecSFPF_hpp
...
/// @brief Computes (SF|1/|r-r'||PF)  integral derivatives for two basis function pairs blocks.
...
template <class T>
inline auto
comp_electron_repulsion_geom_1000_sfpf(T&                               distributor,
                                       ...
                                       const std::pair<size_t, size_t>& ket_indices) -> void
{
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            t4cfunc::bra_transform<0, 3>(sbuffer, 0, skbuffer, 525, 1, 3);
            
            t4cfunc::bra_transform<0, 3>(sbuffer, 147, skbuffer, 735, 1, 3);
            
            t4cfunc::bra_transform<0, 3>(sbuffer, 294, skbuffer, 945, 1, 3);
...
#endif /* ElectronRepulsionGeom1000RecSFPF_hpp */
