#ifndef ElectronRepulsionGeom1000RecSFPD_hpp
#define ElectronRepulsionGeom1000RecSFPD_hpp
...
/// @brief Computes (SF|1/|r-r'||PD)  integral derivatives for two basis function pairs blocks.
...
template <class T>
inline auto
comp_electron_repulsion_geom_1000_sfpd(T&                               distributor,
                                       ...
                                       const std::pair<size_t, size_t>& ket_indices) -> void
{
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            t4cfunc::bra_transform<0, 3>(sbuffer, 0, skbuffer, 375, 1, 2);
            
            t4cfunc::bra_transform<0, 3>(sbuffer, 105, skbuffer, 525, 1, 2);
            
            t4cfunc::bra_transform<0, 3>(sbuffer, 210, skbuffer, 675, 1, 2);
...
#endif /* ElectronRepulsionGeom1000RecSFPD_hpp */
