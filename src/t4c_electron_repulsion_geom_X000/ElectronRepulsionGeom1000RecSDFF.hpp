#ifndef ElectronRepulsionGeom1000RecSDFF_hpp
#define ElectronRepulsionGeom1000RecSDFF_hpp
...
/// @brief Computes (SD|1/|r-r'||FF)  integral derivatives for two basis function pairs blocks.
...
template <class T>
inline auto
comp_electron_repulsion_geom_1000_sdff(T&                               distributor,
                                       ...
                                       const std::pair<size_t, size_t>& ket_indices) -> void
{
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            t4cfunc::bra_transform<0, 2>(sbuffer, 0, skbuffer, 784, 3, 3);
            
            t4cfunc::bra_transform<0, 2>(sbuffer, 245, skbuffer, 1078, 3, 3);
            
            t4cfunc::bra_transform<0, 2>(sbuffer, 490, skbuffer, 1372, 3, 3);
...
#endif /* ElectronRepulsionGeom1000RecSDFF_hpp */
