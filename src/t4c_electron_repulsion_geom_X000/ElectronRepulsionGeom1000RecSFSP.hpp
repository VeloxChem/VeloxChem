#ifndef ElectronRepulsionGeom1000RecSFSP_hpp
#define ElectronRepulsionGeom1000RecSFSP_hpp
...
/// @brief Computes (SF|1/|r-r'||SP)  integral derivatives for two basis function pairs blocks.
...
template <class T>
inline auto
comp_electron_repulsion_geom_1000_sfsp(T&                               distributor,
                                       ...
                                       const std::pair<size_t, size_t>& ket_indices) -> void
{
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            t4cfunc::bra_transform<0, 3>(sbuffer, 0, skbuffer, 75, 0, 1);
            
            t4cfunc::bra_transform<0, 3>(sbuffer, 21, skbuffer, 105, 0, 1);
            
            t4cfunc::bra_transform<0, 3>(sbuffer, 42, skbuffer, 135, 0, 1);
...
#endif /* ElectronRepulsionGeom1000RecSFSP_hpp */
