#ifndef ElectronRepulsionGeom1000RecSPDF_hpp
#define ElectronRepulsionGeom1000RecSPDF_hpp
...
/// @brief Computes (SP|1/|r-r'||DF)  integral derivatives for two basis function pairs blocks.
...
template <class T>
inline auto
comp_electron_repulsion_geom_1000_spdf(T&                               distributor,
                                       ...
                                       const std::pair<size_t, size_t>& ket_indices) -> void
{
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            t4cfunc::bra_transform<0, 1>(sbuffer, 0, skbuffer, 315, 2, 3);
            
            t4cfunc::bra_transform<0, 1>(sbuffer, 105, skbuffer, 420, 2, 3);
            
            t4cfunc::bra_transform<0, 1>(sbuffer, 210, skbuffer, 525, 2, 3);
...
#endif /* ElectronRepulsionGeom1000RecSPDF_hpp */
