#ifndef PrimitiveOverlapGeom200PF_X_XXX
#define PrimitiveOverlapGeom200PF_X_XXX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|F_XXX> integrals.
...
*/
auto compPrimitiveOverlapGeom200PF_X_XXX(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PF_X_XXX */
