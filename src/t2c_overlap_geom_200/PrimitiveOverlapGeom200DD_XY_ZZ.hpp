#ifndef PrimitiveOverlapGeom200DD_XY_ZZ
#define PrimitiveOverlapGeom200DD_XY_ZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XY|1|D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200DD_XY_ZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DD_XY_ZZ */
