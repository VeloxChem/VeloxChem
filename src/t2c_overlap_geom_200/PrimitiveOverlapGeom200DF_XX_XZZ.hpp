#ifndef PrimitiveOverlapGeom200DF_XX_XZZ
#define PrimitiveOverlapGeom200DF_XX_XZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XX|1|F_XZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200DF_XX_XZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DF_XX_XZZ */
