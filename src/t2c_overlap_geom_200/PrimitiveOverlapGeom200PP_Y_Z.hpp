#ifndef PrimitiveOverlapGeom200PP_Y_Z
#define PrimitiveOverlapGeom200PP_Y_Z
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Y|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom200PP_Y_Z(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PP_Y_Z */
