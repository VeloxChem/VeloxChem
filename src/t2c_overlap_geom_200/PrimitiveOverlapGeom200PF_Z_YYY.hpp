#ifndef PrimitiveOverlapGeom200PF_Z_YYY
#define PrimitiveOverlapGeom200PF_Z_YYY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|F_YYY> integrals.
...
*/
auto compPrimitiveOverlapGeom200PF_Z_YYY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PF_Z_YYY */
