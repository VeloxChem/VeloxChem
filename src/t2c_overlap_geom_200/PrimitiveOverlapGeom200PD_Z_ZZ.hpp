#ifndef PrimitiveOverlapGeom200PD_Z_ZZ
#define PrimitiveOverlapGeom200PD_Z_ZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200PD_Z_ZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PD_Z_ZZ */
