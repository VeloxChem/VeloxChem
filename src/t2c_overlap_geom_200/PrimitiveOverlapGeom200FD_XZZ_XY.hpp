#ifndef PrimitiveOverlapGeom200FD_XZZ_XY
#define PrimitiveOverlapGeom200FD_XZZ_XY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XZZ|1|D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom200FD_XZZ_XY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200FD_XZZ_XY */
