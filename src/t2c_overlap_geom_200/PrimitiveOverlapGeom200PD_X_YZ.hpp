#ifndef PrimitiveOverlapGeom200PD_X_YZ
#define PrimitiveOverlapGeom200PD_X_YZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200PD_X_YZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PD_X_YZ */
