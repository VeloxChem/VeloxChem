#ifndef PrimitiveOverlapGeom200FP_XYY_Z
#define PrimitiveOverlapGeom200FP_XYY_Z
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XYY|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom200FP_XYY_Z(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200FP_XYY_Z */
