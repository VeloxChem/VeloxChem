#ifndef PrimitiveOverlapGeom200DD_ZZ_XX
#define PrimitiveOverlapGeom200DD_ZZ_XX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_ZZ|1|D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom200DD_ZZ_XX(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DD_ZZ_XX */
