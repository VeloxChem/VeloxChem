#ifndef PrimitiveOverlapGeom200SP_0_X
#define PrimitiveOverlapGeom200SP_0_X
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)S_0|1|P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom200SP_0_X(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200SP_0_X */
