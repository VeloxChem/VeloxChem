#ifndef OverlapGeom200RecPP_hpp
#define OverlapGeom200RecPP_hpp
...
/**
 Evaluates <d^(2)/dA^(2)P|1|P>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom200PP(CSubMatrix*      matrix_xx,
