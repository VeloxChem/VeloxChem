#ifndef PrimitiveOverlapGeom200SD_0_YZ
#define PrimitiveOverlapGeom200SD_0_YZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)S_0|1|D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200SD_0_YZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200SD_0_YZ */
