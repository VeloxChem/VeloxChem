#ifndef PrimitiveOverlapGeom200DP_YZ_Y
#define PrimitiveOverlapGeom200DP_YZ_Y
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YZ|1|P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom200DP_YZ_Y(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DP_YZ_Y */
