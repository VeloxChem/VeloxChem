#ifndef PrimitiveOverlapGeom200PP_X_Y
#define PrimitiveOverlapGeom200PP_X_Y
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom200PP_X_Y(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PP_X_Y */
