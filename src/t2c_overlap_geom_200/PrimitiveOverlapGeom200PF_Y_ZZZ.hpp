#ifndef PrimitiveOverlapGeom200PF_Y_ZZZ
#define PrimitiveOverlapGeom200PF_Y_ZZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Y|1|F_ZZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200PF_Y_ZZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PF_Y_ZZZ */
