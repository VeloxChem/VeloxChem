#ifndef PrimitiveOverlapGeom200FP_ZZZ_X
#define PrimitiveOverlapGeom200FP_ZZZ_X
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_ZZZ|1|P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom200FP_ZZZ_X(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200FP_ZZZ_X */
