#ifndef PrimitiveOverlapGeom200PF_Y_YZZ
#define PrimitiveOverlapGeom200PF_Y_YZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Y|1|F_YZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200PF_Y_YZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PF_Y_YZZ */
