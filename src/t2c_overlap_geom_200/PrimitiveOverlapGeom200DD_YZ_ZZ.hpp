#ifndef PrimitiveOverlapGeom200DD_YZ_ZZ
#define PrimitiveOverlapGeom200DD_YZ_ZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YZ|1|D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200DD_YZ_ZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DD_YZ_ZZ */
