#ifndef PrimitiveOverlapGeom200DF_XY_XZZ
#define PrimitiveOverlapGeom200DF_XY_XZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XY|1|F_XZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200DF_XY_XZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DF_XY_XZZ */
