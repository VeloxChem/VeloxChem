#ifndef OverlapGeom200RecPS_hpp
#define OverlapGeom200RecPS_hpp
...
/**
 Evaluates <d^(2)/dA^(2)P|1|S>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom200PS(CSubMatrix*      matrix_xx,
