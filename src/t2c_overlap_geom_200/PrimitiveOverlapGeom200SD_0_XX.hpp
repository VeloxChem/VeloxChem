#ifndef PrimitiveOverlapGeom200SD_0_XX
#define PrimitiveOverlapGeom200SD_0_XX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)S_0|1|D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom200SD_0_XX(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200SD_0_XX */
