#ifndef PrimitiveOverlapGeom200PF_Z_XXY
#define PrimitiveOverlapGeom200PF_Z_XXY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom200PF_Z_XXY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PF_Z_XXY */
