#ifndef PrimitiveOverlapGeom200PD_X_XY
#define PrimitiveOverlapGeom200PD_X_XY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom200PD_X_XY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PD_X_XY */
