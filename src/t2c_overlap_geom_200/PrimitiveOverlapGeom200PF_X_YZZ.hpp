#ifndef PrimitiveOverlapGeom200PF_X_YZZ
#define PrimitiveOverlapGeom200PF_X_YZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|F_YZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200PF_X_YZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PF_X_YZZ */
