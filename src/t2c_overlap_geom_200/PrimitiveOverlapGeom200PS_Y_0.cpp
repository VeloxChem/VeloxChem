#include "PrimitiveOverlapGeom200PS_Y_0.hpp"
...
auto
compPrimitiveOverlapGeom200PS_Y_0(TDoubleArray&       buffer_xx,
...
#pragma omp simd aligned(fints_xx, fints_xy, fints_xz, fints_yy, fints_yz, fints_zz, ket_fe, ket_fn, ket_rx, ket_ry, ket_rz : 64)
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xx[i] += fss * (-2.0 * rpa_y * tbe_0 + 2.0 * fe_0 * rpa_y * tbe_0 * tbe_0 + 4.0 * rpa_y * rpa_x * rpa_x * tbe_0 * tbe_0);

        fints_xy[i] += fss * (-2.0 * rpa_x * tbe_0 + 2.0 * fe_0 * rpa_x * tbe_0 * tbe_0 + 4.0 * rpa_y * rpa_y * rpa_x * tbe_0 * tbe_0);

        fints_xz[i] += fss * 4.0 * rpa_z * rpa_y * rpa_x * tbe_0 * tbe_0;

        fints_yy[i] += fss * (-6.0 * rpa_y * tbe_0 + 2.0 * fe_0 * rpa_y * tbe_0 * tbe_0 + 4.0 * fe_0 * rpa_y * tbe_0 * tbe_0 +
                              4.0 * rpa_y * rpa_y * rpa_y * tbe_0 * tbe_0);

        fints_yz[i] += fss * (-2.0 * rpa_z * tbe_0 + 2.0 * fe_0 * rpa_z * tbe_0 * tbe_0 + 4.0 * rpa_z * rpa_y * rpa_y * tbe_0 * tbe_0);

        fints_zz[i] += fss * (-2.0 * rpa_y * tbe_0 + 2.0 * fe_0 * rpa_y * tbe_0 * tbe_0 + 4.0 * rpa_z * rpa_z * rpa_y * tbe_0 * tbe_0);
    }
}
