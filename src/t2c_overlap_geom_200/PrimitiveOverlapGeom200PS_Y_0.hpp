#ifndef PrimitiveOverlapGeom200PS_Y_0
#define PrimitiveOverlapGeom200PS_Y_0
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Y|1|S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom200PS_Y_0(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PS_Y_0 */
