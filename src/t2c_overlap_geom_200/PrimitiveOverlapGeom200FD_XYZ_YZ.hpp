#ifndef PrimitiveOverlapGeom200FD_XYZ_YZ
#define PrimitiveOverlapGeom200FD_XYZ_YZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XYZ|1|D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200FD_XYZ_YZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200FD_XYZ_YZ */
