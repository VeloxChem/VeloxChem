#ifndef PrimitiveOverlapGeom200DP_XY_Z
#define PrimitiveOverlapGeom200DP_XY_Z
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XY|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom200DP_XY_Z(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DP_XY_Z */
