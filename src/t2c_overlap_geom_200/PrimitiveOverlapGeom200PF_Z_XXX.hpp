#ifndef PrimitiveOverlapGeom200PF_Z_XXX
#define PrimitiveOverlapGeom200PF_Z_XXX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|F_XXX> integrals.
...
*/
auto compPrimitiveOverlapGeom200PF_Z_XXX(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PF_Z_XXX */
