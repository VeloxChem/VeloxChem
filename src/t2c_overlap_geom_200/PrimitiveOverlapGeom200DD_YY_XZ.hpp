#ifndef PrimitiveOverlapGeom200DD_YY_XZ
#define PrimitiveOverlapGeom200DD_YY_XZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YY|1|D_XZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200DD_YY_XZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DD_YY_XZ */
