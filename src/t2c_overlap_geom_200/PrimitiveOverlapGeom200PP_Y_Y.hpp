#ifndef PrimitiveOverlapGeom200PP_Y_Y
#define PrimitiveOverlapGeom200PP_Y_Y
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Y|1|P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom200PP_Y_Y(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PP_Y_Y */
