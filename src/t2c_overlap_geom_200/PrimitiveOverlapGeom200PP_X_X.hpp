#ifndef PrimitiveOverlapGeom200PP_X_X
#define PrimitiveOverlapGeom200PP_X_X
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom200PP_X_X(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PP_X_X */
