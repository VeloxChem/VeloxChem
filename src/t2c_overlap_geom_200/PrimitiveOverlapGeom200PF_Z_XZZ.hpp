#ifndef PrimitiveOverlapGeom200PF_Z_XZZ
#define PrimitiveOverlapGeom200PF_Z_XZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|F_XZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200PF_Z_XZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PF_Z_XZZ */
