#ifndef PrimitiveOverlapGeom200DD_ZZ_XY
#define PrimitiveOverlapGeom200DD_ZZ_XY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_ZZ|1|D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom200DD_ZZ_XY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DD_ZZ_XY */
