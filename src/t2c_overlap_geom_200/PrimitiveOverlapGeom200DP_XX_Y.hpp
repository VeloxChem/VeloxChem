#ifndef PrimitiveOverlapGeom200DP_XX_Y
#define PrimitiveOverlapGeom200DP_XX_Y
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XX|1|P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom200DP_XX_Y(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DP_XX_Y */
