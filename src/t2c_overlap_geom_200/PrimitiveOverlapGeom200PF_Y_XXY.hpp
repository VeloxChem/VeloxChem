#ifndef PrimitiveOverlapGeom200PF_Y_XXY
#define PrimitiveOverlapGeom200PF_Y_XXY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Y|1|F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom200PF_Y_XXY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PF_Y_XXY */
