#ifndef PrimitiveOverlapGeom200DF_XZ_XYY
#define PrimitiveOverlapGeom200DF_XZ_XYY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XZ|1|F_XYY> integrals.
...
*/
auto compPrimitiveOverlapGeom200DF_XZ_XYY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DF_XZ_XYY */
