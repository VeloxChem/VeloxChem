#ifndef PrimitiveOverlapGeom200PF_Y_YYY
#define PrimitiveOverlapGeom200PF_Y_YYY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Y|1|F_YYY> integrals.
...
*/
auto compPrimitiveOverlapGeom200PF_Y_YYY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PF_Y_YYY */
