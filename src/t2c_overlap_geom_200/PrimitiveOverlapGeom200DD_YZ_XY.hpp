#ifndef PrimitiveOverlapGeom200DD_YZ_XY
#define PrimitiveOverlapGeom200DD_YZ_XY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YZ|1|D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom200DD_YZ_XY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DD_YZ_XY */
