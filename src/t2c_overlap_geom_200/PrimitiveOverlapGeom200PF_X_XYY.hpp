#ifndef PrimitiveOverlapGeom200PF_X_XYY
#define PrimitiveOverlapGeom200PF_X_XYY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|F_XYY> integrals.
...
*/
auto compPrimitiveOverlapGeom200PF_X_XYY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PF_X_XYY */
