#ifndef PrimitiveOverlapGeom200DF_ZZ_XYY
#define PrimitiveOverlapGeom200DF_ZZ_XYY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_ZZ|1|F_XYY> integrals.
...
*/
auto compPrimitiveOverlapGeom200DF_ZZ_XYY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DF_ZZ_XYY */
