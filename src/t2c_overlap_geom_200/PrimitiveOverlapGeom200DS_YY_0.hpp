#ifndef PrimitiveOverlapGeom200DS_YY_0
#define PrimitiveOverlapGeom200DS_YY_0
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YY|1|S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom200DS_YY_0(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DS_YY_0 */
