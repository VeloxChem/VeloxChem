#ifndef PrimitiveOverlapGeom200DF_XZ_XYZ
#define PrimitiveOverlapGeom200DF_XZ_XYZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XZ|1|F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200DF_XZ_XYZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DF_XZ_XYZ */
