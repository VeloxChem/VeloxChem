#ifndef PrimitiveOverlapGeom200FD_XYY_ZZ
#define PrimitiveOverlapGeom200FD_XYY_ZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XYY|1|D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200FD_XYY_ZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200FD_XYY_ZZ */
