#ifndef PrimitiveOverlapGeom200PF_Z_XXZ
#define PrimitiveOverlapGeom200PF_Z_XXZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|F_XXZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200PF_Z_XXZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PF_Z_XXZ */
