#ifndef PrimitiveOverlapGeom200FD_ZZZ_XX
#define PrimitiveOverlapGeom200FD_ZZZ_XX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_ZZZ|1|D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom200FD_ZZZ_XX(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200FD_ZZZ_XX */
