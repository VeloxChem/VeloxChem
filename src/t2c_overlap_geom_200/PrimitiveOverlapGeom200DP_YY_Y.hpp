#ifndef PrimitiveOverlapGeom200DP_YY_Y
#define PrimitiveOverlapGeom200DP_YY_Y
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YY|1|P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom200DP_YY_Y(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DP_YY_Y */
