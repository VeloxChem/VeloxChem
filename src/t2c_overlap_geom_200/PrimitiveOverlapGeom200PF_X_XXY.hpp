#ifndef PrimitiveOverlapGeom200PF_X_XXY
#define PrimitiveOverlapGeom200PF_X_XXY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom200PF_X_XXY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PF_X_XXY */
