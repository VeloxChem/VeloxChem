#ifndef PrimitiveOverlapGeom200PF_Y_XXX
#define PrimitiveOverlapGeom200PF_Y_XXX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Y|1|F_XXX> integrals.
...
*/
auto compPrimitiveOverlapGeom200PF_Y_XXX(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PF_Y_XXX */
