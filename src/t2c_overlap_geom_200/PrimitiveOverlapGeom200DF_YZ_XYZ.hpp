#ifndef PrimitiveOverlapGeom200DF_YZ_XYZ
#define PrimitiveOverlapGeom200DF_YZ_XYZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YZ|1|F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200DF_YZ_XYZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DF_YZ_XYZ */
