#ifndef PrimitiveOverlapGeom200FP_XXX_X
#define PrimitiveOverlapGeom200FP_XXX_X
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XXX|1|P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom200FP_XXX_X(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200FP_XXX_X */
