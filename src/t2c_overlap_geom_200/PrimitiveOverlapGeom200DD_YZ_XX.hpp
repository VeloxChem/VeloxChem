#ifndef PrimitiveOverlapGeom200DD_YZ_XX
#define PrimitiveOverlapGeom200DD_YZ_XX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YZ|1|D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom200DD_YZ_XX(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DD_YZ_XX */
