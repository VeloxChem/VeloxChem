#ifndef PrimitiveOverlapGeom200PF_X_XZZ
#define PrimitiveOverlapGeom200PF_X_XZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|F_XZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200PF_X_XZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PF_X_XZZ */
