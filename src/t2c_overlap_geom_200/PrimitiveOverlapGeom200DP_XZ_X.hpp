#ifndef PrimitiveOverlapGeom200DP_XZ_X
#define PrimitiveOverlapGeom200DP_XZ_X
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XZ|1|P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom200DP_XZ_X(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DP_XZ_X */
