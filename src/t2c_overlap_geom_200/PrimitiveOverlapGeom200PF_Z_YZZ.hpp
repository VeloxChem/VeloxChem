#ifndef PrimitiveOverlapGeom200PF_Z_YZZ
#define PrimitiveOverlapGeom200PF_Z_YZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|F_YZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200PF_Z_YZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PF_Z_YZZ */
