#ifndef PrimitiveOverlapGeom200FD_XXY_XX
#define PrimitiveOverlapGeom200FD_XXY_XX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XXY|1|D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom200FD_XXY_XX(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200FD_XXY_XX */
