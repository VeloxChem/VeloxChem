#ifndef PrimitiveOverlapGeom200FD_XXZ_XX
#define PrimitiveOverlapGeom200FD_XXZ_XX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XXZ|1|D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom200FD_XXZ_XX(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200FD_XXZ_XX */
