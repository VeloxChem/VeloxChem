#ifndef OverlapGeom200RecSP_hpp
#define OverlapGeom200RecSP_hpp
...
/**
 Evaluates <d^(2)/dA^(2)S|1|P>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom200SP(CSubMatrix*      matrix_xx,
