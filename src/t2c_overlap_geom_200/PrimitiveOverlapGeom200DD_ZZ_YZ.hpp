#ifndef PrimitiveOverlapGeom200DD_ZZ_YZ
#define PrimitiveOverlapGeom200DD_ZZ_YZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_ZZ|1|D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200DD_ZZ_YZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DD_ZZ_YZ */
