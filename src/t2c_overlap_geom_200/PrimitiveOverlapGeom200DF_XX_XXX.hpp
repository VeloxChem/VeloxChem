#ifndef PrimitiveOverlapGeom200DF_XX_XXX
#define PrimitiveOverlapGeom200DF_XX_XXX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XX|1|F_XXX> integrals.
...
*/
auto compPrimitiveOverlapGeom200DF_XX_XXX(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DF_XX_XXX */
