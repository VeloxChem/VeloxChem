#ifndef PrimitiveOverlapGeom200DF_XY_XXY
#define PrimitiveOverlapGeom200DF_XY_XXY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XY|1|F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom200DF_XY_XXY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DF_XY_XXY */
