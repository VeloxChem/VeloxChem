#ifndef PrimitiveOverlapGeom200PD_X_XZ
#define PrimitiveOverlapGeom200PD_X_XZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|D_XZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200PD_X_XZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PD_X_XZ */
