#ifndef PrimitiveOverlapGeom200PD_Y_XY
#define PrimitiveOverlapGeom200PD_Y_XY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Y|1|D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom200PD_Y_XY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PD_Y_XY */
