#ifndef PrimitiveOverlapGeom200DD_XY_YZ
#define PrimitiveOverlapGeom200DD_XY_YZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XY|1|D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200DD_XY_YZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DD_XY_YZ */
