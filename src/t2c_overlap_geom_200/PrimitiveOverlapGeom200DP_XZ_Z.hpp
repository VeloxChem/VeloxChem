#ifndef PrimitiveOverlapGeom200DP_XZ_Z
#define PrimitiveOverlapGeom200DP_XZ_Z
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XZ|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom200DP_XZ_Z(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DP_XZ_Z */
