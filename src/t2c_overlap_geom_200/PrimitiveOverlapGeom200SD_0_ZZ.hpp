#ifndef PrimitiveOverlapGeom200SD_0_ZZ
#define PrimitiveOverlapGeom200SD_0_ZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)S_0|1|D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200SD_0_ZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200SD_0_ZZ */
