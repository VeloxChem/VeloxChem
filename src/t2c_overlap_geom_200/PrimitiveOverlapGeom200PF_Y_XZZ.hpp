#ifndef PrimitiveOverlapGeom200PF_Y_XZZ
#define PrimitiveOverlapGeom200PF_Y_XZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Y|1|F_XZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200PF_Y_XZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PF_Y_XZZ */
