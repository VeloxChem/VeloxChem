#ifndef PrimitiveOverlapGeom200PD_Z_YZ
#define PrimitiveOverlapGeom200PD_Z_YZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200PD_Z_YZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PD_Z_YZ */
