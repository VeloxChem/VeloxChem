#ifndef PrimitiveOverlapGeom200DD_YZ_XZ
#define PrimitiveOverlapGeom200DD_YZ_XZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YZ|1|D_XZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200DD_YZ_XZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DD_YZ_XZ */
