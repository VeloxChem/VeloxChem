#ifndef PrimitiveOverlapGeom200PF_X_XYZ
#define PrimitiveOverlapGeom200PF_X_XYZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200PF_X_XYZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PF_X_XYZ */
