#ifndef PrimitiveOverlapGeom200DD_XY_XX
#define PrimitiveOverlapGeom200DD_XY_XX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XY|1|D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom200DD_XY_XX(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DD_XY_XX */
