#ifndef PrimitiveOverlapGeom200DS_XY_0
#define PrimitiveOverlapGeom200DS_XY_0
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XY|1|S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom200DS_XY_0(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DS_XY_0 */
