#ifndef OverlapGeom200RecDS_hpp
#define OverlapGeom200RecDS_hpp
...
/**
 Evaluates <d^(2)/dA^(2)D|1|S>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom200DS(CSubMatrix*      matrix_xx,
