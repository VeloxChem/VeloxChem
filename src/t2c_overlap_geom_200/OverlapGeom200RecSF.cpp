...
auto
compOverlapGeom200SF(CSubMatrix*      matrix_xx,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom200SF_0_XXX(buffer_xx,
                                                                buffer_xy,
                                                                buffer_xz,
                                                                buffer_yy,
                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom200SF_0_XXY(buffer_xx,
                                                                buffer_xy,
                                                                buffer_xz,
                                                                buffer_yy,
                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom200SF_0_XXZ(buffer_xx,
                                                                buffer_xy,
                                                                buffer_xz,
                                                                buffer_yy,
                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom200SF_0_XYY(buffer_xx,
                                                                buffer_xy,
                                                                buffer_xz,
                                                                buffer_yy,
                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom200SF_0_XYZ(buffer_xx,
                                                                buffer_xy,
                                                                buffer_xz,
                                                                buffer_yy,
                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom200SF_0_XZZ(buffer_xx,
                                                                buffer_xy,
                                                                buffer_xz,
                                                                buffer_yy,
                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom200SF_0_YYY(buffer_xx,
                                                                buffer_xy,
                                                                buffer_xz,
                                                                buffer_yy,
                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom200SF_0_YYZ(buffer_xx,
                                                                buffer_xy,
                                                                buffer_xz,
                                                                buffer_yy,
                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom200SF_0_YZZ(buffer_xx,
                                                                buffer_xy,
                                                                buffer_xz,
                                                                buffer_yy,
                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom200SF_0_ZZZ(buffer_xx,
                                                                buffer_xy,
                                                                buffer_xz,
                                                                buffer_yy,
                                                                buffer_yz,
