#ifndef PrimitiveOverlapGeom200FP_XXY_Z
#define PrimitiveOverlapGeom200FP_XXY_Z
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XXY|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom200FP_XXY_Z(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200FP_XXY_Z */
