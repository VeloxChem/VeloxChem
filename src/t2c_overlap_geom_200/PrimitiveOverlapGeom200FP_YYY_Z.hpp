#ifndef PrimitiveOverlapGeom200FP_YYY_Z
#define PrimitiveOverlapGeom200FP_YYY_Z
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_YYY|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom200FP_YYY_Z(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200FP_YYY_Z */
