#ifndef PrimitiveOverlapGeom200DD_XZ_XY
#define PrimitiveOverlapGeom200DD_XZ_XY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XZ|1|D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom200DD_XZ_XY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DD_XZ_XY */
