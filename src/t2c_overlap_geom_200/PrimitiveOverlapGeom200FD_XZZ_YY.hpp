#ifndef PrimitiveOverlapGeom200FD_XZZ_YY
#define PrimitiveOverlapGeom200FD_XZZ_YY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XZZ|1|D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom200FD_XZZ_YY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200FD_XZZ_YY */
