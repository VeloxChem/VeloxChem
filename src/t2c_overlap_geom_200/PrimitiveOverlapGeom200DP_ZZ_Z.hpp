#ifndef PrimitiveOverlapGeom200DP_ZZ_Z
#define PrimitiveOverlapGeom200DP_ZZ_Z
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_ZZ|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom200DP_ZZ_Z(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DP_ZZ_Z */
