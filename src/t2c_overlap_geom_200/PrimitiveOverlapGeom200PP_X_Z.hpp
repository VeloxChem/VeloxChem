#ifndef PrimitiveOverlapGeom200PP_X_Z
#define PrimitiveOverlapGeom200PP_X_Z
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom200PP_X_Z(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PP_X_Z */
