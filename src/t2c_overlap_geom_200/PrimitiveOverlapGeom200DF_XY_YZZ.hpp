#ifndef PrimitiveOverlapGeom200DF_XY_YZZ
#define PrimitiveOverlapGeom200DF_XY_YZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XY|1|F_YZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200DF_XY_YZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DF_XY_YZZ */
