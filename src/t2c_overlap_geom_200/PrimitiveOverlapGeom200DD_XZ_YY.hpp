#ifndef PrimitiveOverlapGeom200DD_XZ_YY
#define PrimitiveOverlapGeom200DD_XZ_YY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XZ|1|D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom200DD_XZ_YY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DD_XZ_YY */
