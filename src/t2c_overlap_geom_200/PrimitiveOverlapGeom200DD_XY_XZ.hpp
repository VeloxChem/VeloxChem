#ifndef PrimitiveOverlapGeom200DD_XY_XZ
#define PrimitiveOverlapGeom200DD_XY_XZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XY|1|D_XZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200DD_XY_XZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DD_XY_XZ */
