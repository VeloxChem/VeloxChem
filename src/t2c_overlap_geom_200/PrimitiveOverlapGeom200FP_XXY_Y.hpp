#ifndef PrimitiveOverlapGeom200FP_XXY_Y
#define PrimitiveOverlapGeom200FP_XXY_Y
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XXY|1|P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom200FP_XXY_Y(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200FP_XXY_Y */
