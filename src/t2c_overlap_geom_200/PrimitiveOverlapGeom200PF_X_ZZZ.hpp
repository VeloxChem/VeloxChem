#ifndef PrimitiveOverlapGeom200PF_X_ZZZ
#define PrimitiveOverlapGeom200PF_X_ZZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|F_ZZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200PF_X_ZZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PF_X_ZZZ */
