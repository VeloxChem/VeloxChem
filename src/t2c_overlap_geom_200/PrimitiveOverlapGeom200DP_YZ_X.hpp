#ifndef PrimitiveOverlapGeom200DP_YZ_X
#define PrimitiveOverlapGeom200DP_YZ_X
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YZ|1|P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom200DP_YZ_X(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DP_YZ_X */
