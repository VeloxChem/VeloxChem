#ifndef PrimitiveOverlapGeom200PD_Y_XZ
#define PrimitiveOverlapGeom200PD_Y_XZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Y|1|D_XZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200PD_Y_XZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PD_Y_XZ */
