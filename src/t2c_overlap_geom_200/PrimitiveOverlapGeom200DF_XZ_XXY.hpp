#ifndef PrimitiveOverlapGeom200DF_XZ_XXY
#define PrimitiveOverlapGeom200DF_XZ_XXY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XZ|1|F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom200DF_XZ_XXY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DF_XZ_XXY */
