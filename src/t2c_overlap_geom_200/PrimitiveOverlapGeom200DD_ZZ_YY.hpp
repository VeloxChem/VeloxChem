#ifndef PrimitiveOverlapGeom200DD_ZZ_YY
#define PrimitiveOverlapGeom200DD_ZZ_YY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_ZZ|1|D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom200DD_ZZ_YY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DD_ZZ_YY */
