#ifndef PrimitiveOverlapGeom200DP_XY_Y
#define PrimitiveOverlapGeom200DP_XY_Y
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XY|1|P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom200DP_XY_Y(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DP_XY_Y */
