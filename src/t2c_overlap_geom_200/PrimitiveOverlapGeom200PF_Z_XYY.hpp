#ifndef PrimitiveOverlapGeom200PF_Z_XYY
#define PrimitiveOverlapGeom200PF_Z_XYY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|F_XYY> integrals.
...
*/
auto compPrimitiveOverlapGeom200PF_Z_XYY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PF_Z_XYY */
