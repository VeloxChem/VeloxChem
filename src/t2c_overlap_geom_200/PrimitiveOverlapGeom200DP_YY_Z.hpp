#ifndef PrimitiveOverlapGeom200DP_YY_Z
#define PrimitiveOverlapGeom200DP_YY_Z
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YY|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom200DP_YY_Z(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DP_YY_Z */
