#ifndef PrimitiveOverlapGeom200PF_Y_XXZ
#define PrimitiveOverlapGeom200PF_Y_XXZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Y|1|F_XXZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200PF_Y_XXZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PF_Y_XXZ */
