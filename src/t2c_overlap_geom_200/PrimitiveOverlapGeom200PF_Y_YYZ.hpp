#ifndef PrimitiveOverlapGeom200PF_Y_YYZ
#define PrimitiveOverlapGeom200PF_Y_YYZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Y|1|F_YYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200PF_Y_YYZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PF_Y_YYZ */
