#ifndef PrimitiveOverlapGeom200DF_XY_XXZ
#define PrimitiveOverlapGeom200DF_XY_XXZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XY|1|F_XXZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200DF_XY_XXZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DF_XY_XXZ */
