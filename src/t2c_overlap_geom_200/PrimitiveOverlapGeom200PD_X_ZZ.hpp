#ifndef PrimitiveOverlapGeom200PD_X_ZZ
#define PrimitiveOverlapGeom200PD_X_ZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200PD_X_ZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PD_X_ZZ */
