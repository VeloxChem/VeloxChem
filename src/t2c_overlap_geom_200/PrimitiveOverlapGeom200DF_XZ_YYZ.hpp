#ifndef PrimitiveOverlapGeom200DF_XZ_YYZ
#define PrimitiveOverlapGeom200DF_XZ_YYZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XZ|1|F_YYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200DF_XZ_YYZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DF_XZ_YYZ */
