#ifndef PrimitiveOverlapGeom200DF_XZ_XXZ
#define PrimitiveOverlapGeom200DF_XZ_XXZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XZ|1|F_XXZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200DF_XZ_XXZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DF_XZ_XXZ */
