#ifndef PrimitiveOverlapGeom200DD_XX_XY
#define PrimitiveOverlapGeom200DD_XX_XY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XX|1|D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom200DD_XX_XY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DD_XX_XY */
