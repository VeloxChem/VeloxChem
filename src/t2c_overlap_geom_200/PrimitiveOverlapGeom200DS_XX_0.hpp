#ifndef PrimitiveOverlapGeom200DS_XX_0
#define PrimitiveOverlapGeom200DS_XX_0
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XX|1|S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom200DS_XX_0(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DS_XX_0 */
