#ifndef PrimitiveOverlapGeom200DP_XX_Z
#define PrimitiveOverlapGeom200DP_XX_Z
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XX|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom200DP_XX_Z(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DP_XX_Z */
