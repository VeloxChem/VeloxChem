#ifndef PrimitiveOverlapGeom200DF_XX_XXY
#define PrimitiveOverlapGeom200DF_XX_XXY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XX|1|F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom200DF_XX_XXY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DF_XX_XXY */
