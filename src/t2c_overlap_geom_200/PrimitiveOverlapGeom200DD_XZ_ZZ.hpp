#ifndef PrimitiveOverlapGeom200DD_XZ_ZZ
#define PrimitiveOverlapGeom200DD_XZ_ZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XZ|1|D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200DD_XZ_ZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DD_XZ_ZZ */
