#ifndef PrimitiveOverlapGeom200DF_XX_XXZ
#define PrimitiveOverlapGeom200DF_XX_XXZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XX|1|F_XXZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200DF_XX_XXZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DF_XX_XXZ */
