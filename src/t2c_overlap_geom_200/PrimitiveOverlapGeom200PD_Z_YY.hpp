#ifndef PrimitiveOverlapGeom200PD_Z_YY
#define PrimitiveOverlapGeom200PD_Z_YY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom200PD_Z_YY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PD_Z_YY */
