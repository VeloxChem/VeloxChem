#ifndef PrimitiveOverlapGeom200DD_XX_ZZ
#define PrimitiveOverlapGeom200DD_XX_ZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XX|1|D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200DD_XX_ZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DD_XX_ZZ */
