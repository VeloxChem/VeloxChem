#ifndef PrimitiveOverlapGeom200DP_XX_X
#define PrimitiveOverlapGeom200DP_XX_X
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XX|1|P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom200DP_XX_X(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DP_XX_X */
