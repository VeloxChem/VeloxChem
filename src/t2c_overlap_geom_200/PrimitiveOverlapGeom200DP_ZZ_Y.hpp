#ifndef PrimitiveOverlapGeom200DP_ZZ_Y
#define PrimitiveOverlapGeom200DP_ZZ_Y
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_ZZ|1|P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom200DP_ZZ_Y(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DP_ZZ_Y */
