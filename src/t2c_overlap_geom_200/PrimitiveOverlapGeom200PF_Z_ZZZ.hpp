#ifndef PrimitiveOverlapGeom200PF_Z_ZZZ
#define PrimitiveOverlapGeom200PF_Z_ZZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|F_ZZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200PF_Z_ZZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PF_Z_ZZZ */
