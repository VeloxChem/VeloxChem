#ifndef PrimitiveOverlapGeom200DF_XX_XYZ
#define PrimitiveOverlapGeom200DF_XX_XYZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XX|1|F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200DF_XX_XYZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DF_XX_XYZ */
