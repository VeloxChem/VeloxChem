#ifndef PrimitiveOverlapGeom200PF_Z_XYZ
#define PrimitiveOverlapGeom200PF_Z_XYZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200PF_Z_XYZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PF_Z_XYZ */
