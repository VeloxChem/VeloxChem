#ifndef PrimitiveOverlapGeom200PF_Z_YYZ
#define PrimitiveOverlapGeom200PF_Z_YYZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|F_YYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200PF_Z_YYZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PF_Z_YYZ */
