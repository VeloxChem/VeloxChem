#ifndef PrimitiveOverlapGeom200DD_XX_YZ
#define PrimitiveOverlapGeom200DD_XX_YZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XX|1|D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom200DD_XX_YZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200DD_XX_YZ */
