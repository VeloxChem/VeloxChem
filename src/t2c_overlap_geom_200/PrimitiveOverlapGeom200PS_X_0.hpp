#ifndef PrimitiveOverlapGeom200PS_X_0
#define PrimitiveOverlapGeom200PS_X_0
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom200PS_X_0(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PS_X_0 */
