#ifndef PrimitiveOverlapGeom200PD_Z_XX
#define PrimitiveOverlapGeom200PD_Z_XX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom200PD_Z_XX(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveOverlapGeom200PD_Z_XX */
