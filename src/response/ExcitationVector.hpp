...
class CExcitationVector
{
     ...
     */
    int32_t _convertIdentifier(const std::vector<int32_t>& identifiers, const int32_t index) const;
     ...
     */
    CDenseMatrix _getBraOrbitals(const CMolecularOrbitals& molecularOrbitals, const std::vector<int32_t>& identifiers) const;
    ...
    /**
     ...
     @return the dense matrix with selected molecular orbitals
     */
    CDenseMatrix _getKetOrbitals(const CMolecularOrbitals& molecularOrbitals, const std::vector<int32_t>& identifiers) const;
   ...
   public:
     ...
     */
    CExcitationVector(const std::vector<double>& factors, const std::vector<CExcitationVector>& sources);
     ...
     */
    void setCoefficientsZY(const CMemBlock<double>& zCoefficients, const CMemBlock<double>& yCoefficients);
     ...
     */
    void setCoefficientZ(const double zValue, const int32_t iCoefficient);
     ...
     */
    void setCoefficientY(const double yValue, const int32_t iCoefficient);
     ...
     */
    std::vector<int32_t> getSmallEnergyIdentifiers(const CMolecularOrbitals& molecularOrbitals, const int32_t nExcitations) const;
    ...
    /**
     ...
     @param source the excitation vector object.
     */
    friend std::ostream& operator<<(std::ostream& output, const CExcitationVector& source);
};
