#ifndef LocalCorePotentialGeom101GD_hpp
#define LocalCorePotentialGeom101GD_hpp
...
template <class T>
auto
comp_local_core_potential_geom_101_gd(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(1783, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_hf(pbuffer, 763, 300, 460, 550, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_11_gd(pbuffer, 973, 210, 300, 700, 763, 1, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 973, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom101GD_hpp */
