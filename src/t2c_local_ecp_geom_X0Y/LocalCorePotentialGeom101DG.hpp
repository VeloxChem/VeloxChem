#ifndef LocalCorePotentialGeom101DG_hpp
#define LocalCorePotentialGeom101DG_hpp
...
template <class T>
auto
comp_local_core_potential_geom_101_dg(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_fh(pbuffer, 633, 158, 317, 407, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_11_dg(pbuffer, 843, 83, 158, 533, 633, 1, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 843, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom101DG_hpp */
