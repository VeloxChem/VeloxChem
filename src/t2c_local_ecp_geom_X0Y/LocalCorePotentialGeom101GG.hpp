#ifndef LocalCorePotentialGeom101GG_hpp
#define LocalCorePotentialGeom101GG_hpp
...
template <class T>
auto
comp_local_core_potential_geom_101_gg(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_hh(pbuffer, 2100, 900, 1350, 1575, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_11_gg(pbuffer, 2541, 650, 900, 1890, 2100, 1, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 2541, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom101GG_hpp */
