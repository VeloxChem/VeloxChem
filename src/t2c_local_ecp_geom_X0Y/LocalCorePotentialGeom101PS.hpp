#ifndef LocalCorePotentialGeom101PS_hpp
#define LocalCorePotentialGeom101PS_hpp
...
template <class T>
auto
comp_local_core_potential_geom_101_ps(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_11_ps(pbuffer, 34, 1, 16, 1, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom101PS_hpp */
