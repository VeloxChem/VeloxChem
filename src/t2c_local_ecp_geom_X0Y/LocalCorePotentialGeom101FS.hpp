#ifndef LocalCorePotentialGeom101FS_hpp
#define LocalCorePotentialGeom101FS_hpp
...
template <class T>
auto
comp_local_core_potential_geom_101_fs(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_gp(pbuffer, 80, 22, 40, 50, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_11_fs(pbuffer, 125, 22, 80, 1, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom101FS_hpp */
