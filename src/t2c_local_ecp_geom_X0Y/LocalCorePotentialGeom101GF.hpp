#ifndef LocalCorePotentialGeom101GF_hpp
#define LocalCorePotentialGeom101GF_hpp
...
template <class T>
auto
comp_local_core_potential_geom_101_gf(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_hg(pbuffer, 1336, 550, 835, 985, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_11_gf(pbuffer, 1651, 390, 550, 1210, 1336, 1, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom101GF_hpp */
