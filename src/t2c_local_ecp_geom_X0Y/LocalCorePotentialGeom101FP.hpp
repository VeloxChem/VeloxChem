#ifndef LocalCorePotentialGeom101FP_hpp
#define LocalCorePotentialGeom101FP_hpp
...
template <class T>
auto
comp_local_core_potential_geom_101_fp(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_gd(pbuffer, 215, 64, 110, 140, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_11_fp(pbuffer, 305, 40, 64, 200, 215, 1, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom101FP_hpp */
