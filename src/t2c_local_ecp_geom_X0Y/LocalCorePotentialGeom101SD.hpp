#ifndef LocalCorePotentialGeom101SD_hpp
#define LocalCorePotentialGeom101SD_hpp
...
template <class T>
auto
comp_local_core_potential_geom_101_sd(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_pf(pbuffer, 29, 4, 10, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_11_sd(pbuffer, 59, 20, 29, 1, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom101SD_hpp */
