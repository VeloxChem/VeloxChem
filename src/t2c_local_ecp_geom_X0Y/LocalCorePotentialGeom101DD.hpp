#ifndef LocalCorePotentialGeom101DD_hpp
#define LocalCorePotentialGeom101DD_hpp
...
template <class T>
auto
comp_local_core_potential_geom_101_dd(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(654, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_ff(pbuffer, 230, 50, 104, 140, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_11_dd(pbuffer, 330, 23, 50, 200, 230, 1, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom101DD_hpp */
