#ifndef LocalCorePotentialGeom101PG_hpp
#define LocalCorePotentialGeom101PG_hpp
...
template <class T>
auto
comp_local_core_potential_geom_101_pg(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(803, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_dh(pbuffer, 272, 35, 104, 149, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_11_pg(pbuffer, 398, 10, 35, 212, 272, 1, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 398, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom101PG_hpp */
