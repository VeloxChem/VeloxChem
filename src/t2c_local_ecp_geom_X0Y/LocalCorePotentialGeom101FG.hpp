#ifndef LocalCorePotentialGeom101FG_hpp
#define LocalCorePotentialGeom101FG_hpp
...
template <class T>
auto
comp_local_core_potential_geom_101_fg(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_gh(pbuffer, 1224, 428, 714, 864, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_11_fg(pbuffer, 1539, 278, 428, 1074, 1224, 1, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom101FG_hpp */
