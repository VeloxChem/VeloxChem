#ifndef LocalCorePotentialGeom101SF_hpp
#define LocalCorePotentialGeom101SF_hpp
...
template <class T>
auto
comp_local_core_potential_geom_101_sf(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_pg(pbuffer, 53, 10, 20, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_11_sf(pbuffer, 98, 35, 53, 1, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 98, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom101SF_hpp */
