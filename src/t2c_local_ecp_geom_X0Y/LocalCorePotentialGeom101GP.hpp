#ifndef LocalCorePotentialGeom101GP_hpp
#define LocalCorePotentialGeom101GP_hpp
...
template <class T>
auto
comp_local_core_potential_geom_101_gp(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_hd(pbuffer, 371, 140, 215, 260, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_11_gp(pbuffer, 497, 100, 140, 350, 371, 1, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom101GP_hpp */
