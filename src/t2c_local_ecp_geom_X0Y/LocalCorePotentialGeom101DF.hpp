#ifndef LocalCorePotentialGeom101DF_hpp
#define LocalCorePotentialGeom101DF_hpp
...
template <class T>
auto
comp_local_core_potential_geom_101_df(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(1094, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_fg(pbuffer, 404, 95, 194, 254, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_11_df(pbuffer, 554, 47, 95, 344, 404, 1, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 554, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom101DF_hpp */
