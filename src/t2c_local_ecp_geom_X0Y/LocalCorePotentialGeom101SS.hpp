#ifndef LocalCorePotentialGeom101SS_hpp
#define LocalCorePotentialGeom101SS_hpp
...
template <class T>
auto
comp_local_core_potential_geom_101_ss(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_pp(pbuffer, 4, 0, 1, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_11_ss(pbuffer, 13, 4, 1, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom101SS_hpp */
