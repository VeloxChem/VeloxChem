#ifndef LocalCorePotentialGeom101FD_hpp
#define LocalCorePotentialGeom101FD_hpp
...
template <class T>
auto
comp_local_core_potential_geom_101_fd(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(1135, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_gf(pbuffer, 445, 140, 240, 300, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_11_fd(pbuffer, 595, 86, 140, 400, 445, 1, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 595, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom101FD_hpp */
