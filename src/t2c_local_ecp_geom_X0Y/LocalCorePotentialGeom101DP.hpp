#ifndef LocalCorePotentialGeom101DP_hpp
#define LocalCorePotentialGeom101DP_hpp
...
template <class T>
auto
comp_local_core_potential_geom_101_dp(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_fd(pbuffer, 110, 22, 46, 64, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_11_dp(pbuffer, 170, 10, 22, 100, 110, 1, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom101DP_hpp */
