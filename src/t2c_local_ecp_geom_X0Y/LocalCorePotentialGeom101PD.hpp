#ifndef LocalCorePotentialGeom101PD_hpp
#define LocalCorePotentialGeom101PD_hpp
...
template <class T>
auto
comp_local_core_potential_geom_101_pd(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_df(pbuffer, 98, 10, 32, 50, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_11_pd(pbuffer, 158, 1, 10, 80, 98, 1, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 158, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom101PD_hpp */
