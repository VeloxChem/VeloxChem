#ifndef LocalCorePotentialGeom101PF_hpp
#define LocalCorePotentialGeom101PF_hpp
...
template <class T>
auto
comp_local_core_potential_geom_101_pf(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_dg(pbuffer, 173, 20, 62, 92, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_11_pf(pbuffer, 263, 4, 20, 137, 173, 1, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom101PF_hpp */
