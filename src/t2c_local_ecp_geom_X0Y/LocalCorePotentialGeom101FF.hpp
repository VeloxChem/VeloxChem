#ifndef LocalCorePotentialGeom101FF_hpp
#define LocalCorePotentialGeom101FF_hpp
...
template <class T>
auto
comp_local_core_potential_geom_101_ff(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_gg(pbuffer, 780, 260, 440, 540, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_11_ff(pbuffer, 1005, 164, 260, 690, 780, 1, pfactors, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 1005, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom101FF_hpp */
