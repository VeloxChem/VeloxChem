#ifndef LocalCorePotentialGeom101PP_hpp
#define LocalCorePotentialGeom101PP_hpp
...
template <class T>
auto
comp_local_core_potential_geom_101_pp(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_dd(pbuffer, 46, 4, 13, 22, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_11_pp(pbuffer, 82, 0, 4, 40, 46, 1, pfactors, a_exp);
...
#endif /* LocalCorePotentialGeom101PP_hpp */
