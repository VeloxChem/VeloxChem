...
namespace distmaxden { // distmaxden namespace
    ...
    /**
     ...
     and GTOs pair on bra side in case of spin restrictef Fock matrix, 2J + K.
    ...
    /**
     Determines maximum density elements for vector of GTOs pairs on ket side
     and GTOs pair on bra side in case of spin restrictef Fock matrix, J.
    ...
    /**
     Determines maximum density elements for vector of GTOs pairs on ket side
     and GTOs pair on bra side in case of spin restrictef Fock matrix, K.
