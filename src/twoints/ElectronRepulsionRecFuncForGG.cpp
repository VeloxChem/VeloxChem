        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    ...
                    tg_xxxx_xxxx_0[j] = pb_x * tg_xxx_xxxx_0[j] + fr * tg_xxx_xxxx_1[j] + 1.5 * fl1_fx * (tg_xx_xxxx_0[j] - tg_xx_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xxx_xxx_1[j];

                    tg_xxxx_xxxy_0[j] = pb_x * tg_xxx_xxxy_0[j] + fr * tg_xxx_xxxy_1[j] + 1.5 * fl1_fx * (tg_xx_xxxy_0[j] - tg_xx_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxx_xxy_1[j];

                    tg_xxxx_xxxz_0[j] = pb_x * tg_xxx_xxxz_0[j] + fr * tg_xxx_xxxz_1[j] + 1.5 * fl1_fx * (tg_xx_xxxz_0[j] - tg_xx_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxx_xxz_1[j];

                    tg_xxxx_xxyy_0[j] = pb_x * tg_xxx_xxyy_0[j] + fr * tg_xxx_xxyy_1[j] + 1.5 * fl1_fx * (tg_xx_xxyy_0[j] - tg_xx_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xxx_xyy_1[j];

                    tg_xxxx_xxyz_0[j] = pb_x * tg_xxx_xxyz_0[j] + fr * tg_xxx_xxyz_1[j] + 1.5 * fl1_fx * (tg_xx_xxyz_0[j] - tg_xx_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xxx_xyz_1[j];

                    tg_xxxx_xxzz_0[j] = pb_x * tg_xxx_xxzz_0[j] + fr * tg_xxx_xxzz_1[j] + 1.5 * fl1_fx * (tg_xx_xxzz_0[j] - tg_xx_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xxx_xzz_1[j];

                    tg_xxxx_xyyy_0[j] = pb_x * tg_xxx_xyyy_0[j] + fr * tg_xxx_xyyy_1[j] + 1.5 * fl1_fx * (tg_xx_xyyy_0[j] - tg_xx_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxx_yyy_1[j];

                    tg_xxxx_xyyz_0[j] = pb_x * tg_xxx_xyyz_0[j] + fr * tg_xxx_xyyz_1[j] + 1.5 * fl1_fx * (tg_xx_xyyz_0[j] - tg_xx_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxx_yyz_1[j];

                    tg_xxxx_xyzz_0[j] = pb_x * tg_xxx_xyzz_0[j] + fr * tg_xxx_xyzz_1[j] + 1.5 * fl1_fx * (tg_xx_xyzz_0[j] - tg_xx_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxx_yzz_1[j];

                    tg_xxxx_xzzz_0[j] = pb_x * tg_xxx_xzzz_0[j] + fr * tg_xxx_xzzz_1[j] + 1.5 * fl1_fx * (tg_xx_xzzz_0[j] - tg_xx_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxx_zzz_1[j];

                    tg_xxxx_yyyy_0[j] = pb_x * tg_xxx_yyyy_0[j] + fr * tg_xxx_yyyy_1[j] + 1.5 * fl1_fx * (tg_xx_yyyy_0[j] - tg_xx_yyyy_1[j] * fl1_fza);

                    tg_xxxx_yyyz_0[j] = pb_x * tg_xxx_yyyz_0[j] + fr * tg_xxx_yyyz_1[j] + 1.5 * fl1_fx * (tg_xx_yyyz_0[j] - tg_xx_yyyz_1[j] * fl1_fza);

                    tg_xxxx_yyzz_0[j] = pb_x * tg_xxx_yyzz_0[j] + fr * tg_xxx_yyzz_1[j] + 1.5 * fl1_fx * (tg_xx_yyzz_0[j] - tg_xx_yyzz_1[j] * fl1_fza);

                    tg_xxxx_yzzz_0[j] = pb_x * tg_xxx_yzzz_0[j] + fr * tg_xxx_yzzz_1[j] + 1.5 * fl1_fx * (tg_xx_yzzz_0[j] - tg_xx_yzzz_1[j] * fl1_fza);

                    tg_xxxx_zzzz_0[j] = pb_x * tg_xxx_zzzz_0[j] + fr * tg_xxx_zzzz_1[j] + 1.5 * fl1_fx * (tg_xx_zzzz_0[j] - tg_xx_zzzz_1[j] * fl1_fza);

                    tg_xxxy_xxxx_0[j] = pb_x * tg_xxy_xxxx_0[j] + fr * tg_xxy_xxxx_1[j] + fl1_fx * (tg_xy_xxxx_0[j] - tg_xy_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xxy_xxx_1[j];

                    tg_xxxy_xxxy_0[j] = pb_x * tg_xxy_xxxy_0[j] + fr * tg_xxy_xxxy_1[j] + fl1_fx * (tg_xy_xxxy_0[j] - tg_xy_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxy_xxy_1[j];

                    tg_xxxy_xxxz_0[j] = pb_x * tg_xxy_xxxz_0[j] + fr * tg_xxy_xxxz_1[j] + fl1_fx * (tg_xy_xxxz_0[j] - tg_xy_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxy_xxz_1[j];

                    tg_xxxy_xxyy_0[j] = pb_x * tg_xxy_xxyy_0[j] + fr * tg_xxy_xxyy_1[j] + fl1_fx * (tg_xy_xxyy_0[j] - tg_xy_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xxy_xyy_1[j];

                    tg_xxxy_xxyz_0[j] = pb_x * tg_xxy_xxyz_0[j] + fr * tg_xxy_xxyz_1[j] + fl1_fx * (tg_xy_xxyz_0[j] - tg_xy_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xxy_xyz_1[j];

                    tg_xxxy_xxzz_0[j] = pb_x * tg_xxy_xxzz_0[j] + fr * tg_xxy_xxzz_1[j] + fl1_fx * (tg_xy_xxzz_0[j] - tg_xy_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xxy_xzz_1[j];

                    tg_xxxy_xyyy_0[j] = pb_x * tg_xxy_xyyy_0[j] + fr * tg_xxy_xyyy_1[j] + fl1_fx * (tg_xy_xyyy_0[j] - tg_xy_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxy_yyy_1[j];

                    tg_xxxy_xyyz_0[j] = pb_x * tg_xxy_xyyz_0[j] + fr * tg_xxy_xyyz_1[j] + fl1_fx * (tg_xy_xyyz_0[j] - tg_xy_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxy_yyz_1[j];

                    tg_xxxy_xyzz_0[j] = pb_x * tg_xxy_xyzz_0[j] + fr * tg_xxy_xyzz_1[j] + fl1_fx * (tg_xy_xyzz_0[j] - tg_xy_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxy_yzz_1[j];

                    tg_xxxy_xzzz_0[j] = pb_x * tg_xxy_xzzz_0[j] + fr * tg_xxy_xzzz_1[j] + fl1_fx * (tg_xy_xzzz_0[j] - tg_xy_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxy_zzz_1[j];

                    tg_xxxy_yyyy_0[j] = pb_x * tg_xxy_yyyy_0[j] + fr * tg_xxy_yyyy_1[j] + fl1_fx * (tg_xy_yyyy_0[j] - tg_xy_yyyy_1[j] * fl1_fza);

                    tg_xxxy_yyyz_0[j] = pb_x * tg_xxy_yyyz_0[j] + fr * tg_xxy_yyyz_1[j] + fl1_fx * (tg_xy_yyyz_0[j] - tg_xy_yyyz_1[j] * fl1_fza);

                    tg_xxxy_yyzz_0[j] = pb_x * tg_xxy_yyzz_0[j] + fr * tg_xxy_yyzz_1[j] + fl1_fx * (tg_xy_yyzz_0[j] - tg_xy_yyzz_1[j] * fl1_fza);

                    tg_xxxy_yzzz_0[j] = pb_x * tg_xxy_yzzz_0[j] + fr * tg_xxy_yzzz_1[j] + fl1_fx * (tg_xy_yzzz_0[j] - tg_xy_yzzz_1[j] * fl1_fza);

                    tg_xxxy_zzzz_0[j] = pb_x * tg_xxy_zzzz_0[j] + fr * tg_xxy_zzzz_1[j] + fl1_fx * (tg_xy_zzzz_0[j] - tg_xy_zzzz_1[j] * fl1_fza);

                    tg_xxxz_xxxx_0[j] = pb_x * tg_xxz_xxxx_0[j] + fr * tg_xxz_xxxx_1[j] + fl1_fx * (tg_xz_xxxx_0[j] - tg_xz_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xxz_xxx_1[j];

                    tg_xxxz_xxxy_0[j] = pb_x * tg_xxz_xxxy_0[j] + fr * tg_xxz_xxxy_1[j] + fl1_fx * (tg_xz_xxxy_0[j] - tg_xz_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxz_xxy_1[j];

                    tg_xxxz_xxxz_0[j] = pb_x * tg_xxz_xxxz_0[j] + fr * tg_xxz_xxxz_1[j] + fl1_fx * (tg_xz_xxxz_0[j] - tg_xz_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxz_xxz_1[j];

                    tg_xxxz_xxyy_0[j] = pb_x * tg_xxz_xxyy_0[j] + fr * tg_xxz_xxyy_1[j] + fl1_fx * (tg_xz_xxyy_0[j] - tg_xz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xxz_xyy_1[j];

                    tg_xxxz_xxyz_0[j] = pb_x * tg_xxz_xxyz_0[j] + fr * tg_xxz_xxyz_1[j] + fl1_fx * (tg_xz_xxyz_0[j] - tg_xz_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xxz_xyz_1[j];

                    tg_xxxz_xxzz_0[j] = pb_x * tg_xxz_xxzz_0[j] + fr * tg_xxz_xxzz_1[j] + fl1_fx * (tg_xz_xxzz_0[j] - tg_xz_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xxz_xzz_1[j];

                    tg_xxxz_xyyy_0[j] = pb_x * tg_xxz_xyyy_0[j] + fr * tg_xxz_xyyy_1[j] + fl1_fx * (tg_xz_xyyy_0[j] - tg_xz_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxz_yyy_1[j];

                    tg_xxxz_xyyz_0[j] = pb_x * tg_xxz_xyyz_0[j] + fr * tg_xxz_xyyz_1[j] + fl1_fx * (tg_xz_xyyz_0[j] - tg_xz_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxz_yyz_1[j];

                    tg_xxxz_xyzz_0[j] = pb_x * tg_xxz_xyzz_0[j] + fr * tg_xxz_xyzz_1[j] + fl1_fx * (tg_xz_xyzz_0[j] - tg_xz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxz_yzz_1[j];

                    tg_xxxz_xzzz_0[j] = pb_x * tg_xxz_xzzz_0[j] + fr * tg_xxz_xzzz_1[j] + fl1_fx * (tg_xz_xzzz_0[j] - tg_xz_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxz_zzz_1[j];

                    tg_xxxz_yyyy_0[j] = pb_x * tg_xxz_yyyy_0[j] + fr * tg_xxz_yyyy_1[j] + fl1_fx * (tg_xz_yyyy_0[j] - tg_xz_yyyy_1[j] * fl1_fza);

                    tg_xxxz_yyyz_0[j] = pb_x * tg_xxz_yyyz_0[j] + fr * tg_xxz_yyyz_1[j] + fl1_fx * (tg_xz_yyyz_0[j] - tg_xz_yyyz_1[j] * fl1_fza);

                    tg_xxxz_yyzz_0[j] = pb_x * tg_xxz_yyzz_0[j] + fr * tg_xxz_yyzz_1[j] + fl1_fx * (tg_xz_yyzz_0[j] - tg_xz_yyzz_1[j] * fl1_fza);

                    tg_xxxz_yzzz_0[j] = pb_x * tg_xxz_yzzz_0[j] + fr * tg_xxz_yzzz_1[j] + fl1_fx * (tg_xz_yzzz_0[j] - tg_xz_yzzz_1[j] * fl1_fza);

                    tg_xxxz_zzzz_0[j] = pb_x * tg_xxz_zzzz_0[j] + fr * tg_xxz_zzzz_1[j] + fl1_fx * (tg_xz_zzzz_0[j] - tg_xz_zzzz_1[j] * fl1_fza);

                    tg_xxyy_xxxx_0[j] = pb_x * tg_xyy_xxxx_0[j] + fr * tg_xyy_xxxx_1[j] + 0.5 * fl1_fx * (tg_yy_xxxx_0[j] - tg_yy_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xyy_xxx_1[j];

                    tg_xxyy_xxxy_0[j] = pb_x * tg_xyy_xxxy_0[j] + fr * tg_xyy_xxxy_1[j] + 0.5 * fl1_fx * (tg_yy_xxxy_0[j] - tg_yy_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xyy_xxy_1[j];

                    tg_xxyy_xxxz_0[j] = pb_x * tg_xyy_xxxz_0[j] + fr * tg_xyy_xxxz_1[j] + 0.5 * fl1_fx * (tg_yy_xxxz_0[j] - tg_yy_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xyy_xxz_1[j];

                    tg_xxyy_xxyy_0[j] = pb_x * tg_xyy_xxyy_0[j] + fr * tg_xyy_xxyy_1[j] + 0.5 * fl1_fx * (tg_yy_xxyy_0[j] - tg_yy_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xyy_xyy_1[j];

                    tg_xxyy_xxyz_0[j] = pb_x * tg_xyy_xxyz_0[j] + fr * tg_xyy_xxyz_1[j] + 0.5 * fl1_fx * (tg_yy_xxyz_0[j] - tg_yy_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xyy_xyz_1[j];

                    tg_xxyy_xxzz_0[j] = pb_x * tg_xyy_xxzz_0[j] + fr * tg_xyy_xxzz_1[j] + 0.5 * fl1_fx * (tg_yy_xxzz_0[j] - tg_yy_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xyy_xzz_1[j];

                    tg_xxyy_xyyy_0[j] = pb_x * tg_xyy_xyyy_0[j] + fr * tg_xyy_xyyy_1[j] + 0.5 * fl1_fx * (tg_yy_xyyy_0[j] - tg_yy_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyy_yyy_1[j];

                    tg_xxyy_xyyz_0[j] = pb_x * tg_xyy_xyyz_0[j] + fr * tg_xyy_xyyz_1[j] + 0.5 * fl1_fx * (tg_yy_xyyz_0[j] - tg_yy_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyy_yyz_1[j];

                    tg_xxyy_xyzz_0[j] = pb_x * tg_xyy_xyzz_0[j] + fr * tg_xyy_xyzz_1[j] + 0.5 * fl1_fx * (tg_yy_xyzz_0[j] - tg_yy_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyy_yzz_1[j];

                    tg_xxyy_xzzz_0[j] = pb_x * tg_xyy_xzzz_0[j] + fr * tg_xyy_xzzz_1[j] + 0.5 * fl1_fx * (tg_yy_xzzz_0[j] - tg_yy_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyy_zzz_1[j];

                    tg_xxyy_yyyy_0[j] = pb_x * tg_xyy_yyyy_0[j] + fr * tg_xyy_yyyy_1[j] + 0.5 * fl1_fx * (tg_yy_yyyy_0[j] - tg_yy_yyyy_1[j] * fl1_fza);

                    tg_xxyy_yyyz_0[j] = pb_x * tg_xyy_yyyz_0[j] + fr * tg_xyy_yyyz_1[j] + 0.5 * fl1_fx * (tg_yy_yyyz_0[j] - tg_yy_yyyz_1[j] * fl1_fza);

                    tg_xxyy_yyzz_0[j] = pb_x * tg_xyy_yyzz_0[j] + fr * tg_xyy_yyzz_1[j] + 0.5 * fl1_fx * (tg_yy_yyzz_0[j] - tg_yy_yyzz_1[j] * fl1_fza);

                    tg_xxyy_yzzz_0[j] = pb_x * tg_xyy_yzzz_0[j] + fr * tg_xyy_yzzz_1[j] + 0.5 * fl1_fx * (tg_yy_yzzz_0[j] - tg_yy_yzzz_1[j] * fl1_fza);

                    tg_xxyy_zzzz_0[j] = pb_x * tg_xyy_zzzz_0[j] + fr * tg_xyy_zzzz_1[j] + 0.5 * fl1_fx * (tg_yy_zzzz_0[j] - tg_yy_zzzz_1[j] * fl1_fza);

                    tg_xxyz_xxxx_0[j] = pb_x * tg_xyz_xxxx_0[j] + fr * tg_xyz_xxxx_1[j] + 0.5 * fl1_fx * (tg_yz_xxxx_0[j] - tg_yz_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xyz_xxx_1[j];

                    tg_xxyz_xxxy_0[j] = pb_x * tg_xyz_xxxy_0[j] + fr * tg_xyz_xxxy_1[j] + 0.5 * fl1_fx * (tg_yz_xxxy_0[j] - tg_yz_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xyz_xxy_1[j];

                    tg_xxyz_xxxz_0[j] = pb_x * tg_xyz_xxxz_0[j] + fr * tg_xyz_xxxz_1[j] + 0.5 * fl1_fx * (tg_yz_xxxz_0[j] - tg_yz_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xyz_xxz_1[j];

                    tg_xxyz_xxyy_0[j] = pb_x * tg_xyz_xxyy_0[j] + fr * tg_xyz_xxyy_1[j] + 0.5 * fl1_fx * (tg_yz_xxyy_0[j] - tg_yz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xyz_xyy_1[j];

                    tg_xxyz_xxyz_0[j] = pb_x * tg_xyz_xxyz_0[j] + fr * tg_xyz_xxyz_1[j] + 0.5 * fl1_fx * (tg_yz_xxyz_0[j] - tg_yz_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xyz_xyz_1[j];

                    tg_xxyz_xxzz_0[j] = pb_x * tg_xyz_xxzz_0[j] + fr * tg_xyz_xxzz_1[j] + 0.5 * fl1_fx * (tg_yz_xxzz_0[j] - tg_yz_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xyz_xzz_1[j];

                    tg_xxyz_xyyy_0[j] = pb_x * tg_xyz_xyyy_0[j] + fr * tg_xyz_xyyy_1[j] + 0.5 * fl1_fx * (tg_yz_xyyy_0[j] - tg_yz_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyz_yyy_1[j];

                    tg_xxyz_xyyz_0[j] = pb_x * tg_xyz_xyyz_0[j] + fr * tg_xyz_xyyz_1[j] + 0.5 * fl1_fx * (tg_yz_xyyz_0[j] - tg_yz_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyz_yyz_1[j];

                    tg_xxyz_xyzz_0[j] = pb_x * tg_xyz_xyzz_0[j] + fr * tg_xyz_xyzz_1[j] + 0.5 * fl1_fx * (tg_yz_xyzz_0[j] - tg_yz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyz_yzz_1[j];

                    tg_xxyz_xzzz_0[j] = pb_x * tg_xyz_xzzz_0[j] + fr * tg_xyz_xzzz_1[j] + 0.5 * fl1_fx * (tg_yz_xzzz_0[j] - tg_yz_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyz_zzz_1[j];

                    tg_xxyz_yyyy_0[j] = pb_x * tg_xyz_yyyy_0[j] + fr * tg_xyz_yyyy_1[j] + 0.5 * fl1_fx * (tg_yz_yyyy_0[j] - tg_yz_yyyy_1[j] * fl1_fza);

                    tg_xxyz_yyyz_0[j] = pb_x * tg_xyz_yyyz_0[j] + fr * tg_xyz_yyyz_1[j] + 0.5 * fl1_fx * (tg_yz_yyyz_0[j] - tg_yz_yyyz_1[j] * fl1_fza);

                    tg_xxyz_yyzz_0[j] = pb_x * tg_xyz_yyzz_0[j] + fr * tg_xyz_yyzz_1[j] + 0.5 * fl1_fx * (tg_yz_yyzz_0[j] - tg_yz_yyzz_1[j] * fl1_fza);

                    tg_xxyz_yzzz_0[j] = pb_x * tg_xyz_yzzz_0[j] + fr * tg_xyz_yzzz_1[j] + 0.5 * fl1_fx * (tg_yz_yzzz_0[j] - tg_yz_yzzz_1[j] * fl1_fza);

                    tg_xxyz_zzzz_0[j] = pb_x * tg_xyz_zzzz_0[j] + fr * tg_xyz_zzzz_1[j] + 0.5 * fl1_fx * (tg_yz_zzzz_0[j] - tg_yz_zzzz_1[j] * fl1_fza);
                }
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    ...
                    tg_xxzz_xxxx_0[j] = pb_x * tg_xzz_xxxx_0[j] + fr * tg_xzz_xxxx_1[j] + 0.5 * fl1_fx * (tg_zz_xxxx_0[j] - tg_zz_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xzz_xxx_1[j];

                    tg_xxzz_xxxy_0[j] = pb_x * tg_xzz_xxxy_0[j] + fr * tg_xzz_xxxy_1[j] + 0.5 * fl1_fx * (tg_zz_xxxy_0[j] - tg_zz_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xzz_xxy_1[j];

                    tg_xxzz_xxxz_0[j] = pb_x * tg_xzz_xxxz_0[j] + fr * tg_xzz_xxxz_1[j] + 0.5 * fl1_fx * (tg_zz_xxxz_0[j] - tg_zz_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xzz_xxz_1[j];

                    tg_xxzz_xxyy_0[j] = pb_x * tg_xzz_xxyy_0[j] + fr * tg_xzz_xxyy_1[j] + 0.5 * fl1_fx * (tg_zz_xxyy_0[j] - tg_zz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xzz_xyy_1[j];

                    tg_xxzz_xxyz_0[j] = pb_x * tg_xzz_xxyz_0[j] + fr * tg_xzz_xxyz_1[j] + 0.5 * fl1_fx * (tg_zz_xxyz_0[j] - tg_zz_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xzz_xyz_1[j];

                    tg_xxzz_xxzz_0[j] = pb_x * tg_xzz_xxzz_0[j] + fr * tg_xzz_xxzz_1[j] + 0.5 * fl1_fx * (tg_zz_xxzz_0[j] - tg_zz_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xzz_xzz_1[j];

                    tg_xxzz_xyyy_0[j] = pb_x * tg_xzz_xyyy_0[j] + fr * tg_xzz_xyyy_1[j] + 0.5 * fl1_fx * (tg_zz_xyyy_0[j] - tg_zz_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xzz_yyy_1[j];

                    tg_xxzz_xyyz_0[j] = pb_x * tg_xzz_xyyz_0[j] + fr * tg_xzz_xyyz_1[j] + 0.5 * fl1_fx * (tg_zz_xyyz_0[j] - tg_zz_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xzz_yyz_1[j];

                    tg_xxzz_xyzz_0[j] = pb_x * tg_xzz_xyzz_0[j] + fr * tg_xzz_xyzz_1[j] + 0.5 * fl1_fx * (tg_zz_xyzz_0[j] - tg_zz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xzz_yzz_1[j];

                    tg_xxzz_xzzz_0[j] = pb_x * tg_xzz_xzzz_0[j] + fr * tg_xzz_xzzz_1[j] + 0.5 * fl1_fx * (tg_zz_xzzz_0[j] - tg_zz_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xzz_zzz_1[j];

                    tg_xxzz_yyyy_0[j] = pb_x * tg_xzz_yyyy_0[j] + fr * tg_xzz_yyyy_1[j] + 0.5 * fl1_fx * (tg_zz_yyyy_0[j] - tg_zz_yyyy_1[j] * fl1_fza);

                    tg_xxzz_yyyz_0[j] = pb_x * tg_xzz_yyyz_0[j] + fr * tg_xzz_yyyz_1[j] + 0.5 * fl1_fx * (tg_zz_yyyz_0[j] - tg_zz_yyyz_1[j] * fl1_fza);

                    tg_xxzz_yyzz_0[j] = pb_x * tg_xzz_yyzz_0[j] + fr * tg_xzz_yyzz_1[j] + 0.5 * fl1_fx * (tg_zz_yyzz_0[j] - tg_zz_yyzz_1[j] * fl1_fza);

                    tg_xxzz_yzzz_0[j] = pb_x * tg_xzz_yzzz_0[j] + fr * tg_xzz_yzzz_1[j] + 0.5 * fl1_fx * (tg_zz_yzzz_0[j] - tg_zz_yzzz_1[j] * fl1_fza);

                    tg_xxzz_zzzz_0[j] = pb_x * tg_xzz_zzzz_0[j] + fr * tg_xzz_zzzz_1[j] + 0.5 * fl1_fx * (tg_zz_zzzz_0[j] - tg_zz_zzzz_1[j] * fl1_fza);

                    tg_xyyy_xxxx_0[j] = pb_x * tg_yyy_xxxx_0[j] + fr * tg_yyy_xxxx_1[j] + 2.0 * fl1_fxn * tg_yyy_xxx_1[j];

                    tg_xyyy_xxxy_0[j] = pb_x * tg_yyy_xxxy_0[j] + fr * tg_yyy_xxxy_1[j] + 1.5 * fl1_fxn * tg_yyy_xxy_1[j];

                    tg_xyyy_xxxz_0[j] = pb_x * tg_yyy_xxxz_0[j] + fr * tg_yyy_xxxz_1[j] + 1.5 * fl1_fxn * tg_yyy_xxz_1[j];

                    tg_xyyy_xxyy_0[j] = pb_x * tg_yyy_xxyy_0[j] + fr * tg_yyy_xxyy_1[j] + fl1_fxn * tg_yyy_xyy_1[j];

                    tg_xyyy_xxyz_0[j] = pb_x * tg_yyy_xxyz_0[j] + fr * tg_yyy_xxyz_1[j] + fl1_fxn * tg_yyy_xyz_1[j];

                    tg_xyyy_xxzz_0[j] = pb_x * tg_yyy_xxzz_0[j] + fr * tg_yyy_xxzz_1[j] + fl1_fxn * tg_yyy_xzz_1[j];

                    tg_xyyy_xyyy_0[j] = pb_x * tg_yyy_xyyy_0[j] + fr * tg_yyy_xyyy_1[j] + 0.5 * fl1_fxn * tg_yyy_yyy_1[j];

                    tg_xyyy_xyyz_0[j] = pb_x * tg_yyy_xyyz_0[j] + fr * tg_yyy_xyyz_1[j] + 0.5 * fl1_fxn * tg_yyy_yyz_1[j];

                    tg_xyyy_xyzz_0[j] = pb_x * tg_yyy_xyzz_0[j] + fr * tg_yyy_xyzz_1[j] + 0.5 * fl1_fxn * tg_yyy_yzz_1[j];

                    tg_xyyy_xzzz_0[j] = pb_x * tg_yyy_xzzz_0[j] + fr * tg_yyy_xzzz_1[j] + 0.5 * fl1_fxn * tg_yyy_zzz_1[j];

                    tg_xyyy_yyyy_0[j] = pb_x * tg_yyy_yyyy_0[j] + fr * tg_yyy_yyyy_1[j];

                    tg_xyyy_yyyz_0[j] = pb_x * tg_yyy_yyyz_0[j] + fr * tg_yyy_yyyz_1[j];

                    tg_xyyy_yyzz_0[j] = pb_x * tg_yyy_yyzz_0[j] + fr * tg_yyy_yyzz_1[j];

                    tg_xyyy_yzzz_0[j] = pb_x * tg_yyy_yzzz_0[j] + fr * tg_yyy_yzzz_1[j];

                    tg_xyyy_zzzz_0[j] = pb_x * tg_yyy_zzzz_0[j] + fr * tg_yyy_zzzz_1[j];

                    tg_xyyz_xxxx_0[j] = pb_x * tg_yyz_xxxx_0[j] + fr * tg_yyz_xxxx_1[j] + 2.0 * fl1_fxn * tg_yyz_xxx_1[j];

                    tg_xyyz_xxxy_0[j] = pb_x * tg_yyz_xxxy_0[j] + fr * tg_yyz_xxxy_1[j] + 1.5 * fl1_fxn * tg_yyz_xxy_1[j];

                    tg_xyyz_xxxz_0[j] = pb_x * tg_yyz_xxxz_0[j] + fr * tg_yyz_xxxz_1[j] + 1.5 * fl1_fxn * tg_yyz_xxz_1[j];

                    tg_xyyz_xxyy_0[j] = pb_x * tg_yyz_xxyy_0[j] + fr * tg_yyz_xxyy_1[j] + fl1_fxn * tg_yyz_xyy_1[j];

                    tg_xyyz_xxyz_0[j] = pb_x * tg_yyz_xxyz_0[j] + fr * tg_yyz_xxyz_1[j] + fl1_fxn * tg_yyz_xyz_1[j];

                    tg_xyyz_xxzz_0[j] = pb_x * tg_yyz_xxzz_0[j] + fr * tg_yyz_xxzz_1[j] + fl1_fxn * tg_yyz_xzz_1[j];

                    tg_xyyz_xyyy_0[j] = pb_x * tg_yyz_xyyy_0[j] + fr * tg_yyz_xyyy_1[j] + 0.5 * fl1_fxn * tg_yyz_yyy_1[j];

                    tg_xyyz_xyyz_0[j] = pb_x * tg_yyz_xyyz_0[j] + fr * tg_yyz_xyyz_1[j] + 0.5 * fl1_fxn * tg_yyz_yyz_1[j];

                    tg_xyyz_xyzz_0[j] = pb_x * tg_yyz_xyzz_0[j] + fr * tg_yyz_xyzz_1[j] + 0.5 * fl1_fxn * tg_yyz_yzz_1[j];

                    tg_xyyz_xzzz_0[j] = pb_x * tg_yyz_xzzz_0[j] + fr * tg_yyz_xzzz_1[j] + 0.5 * fl1_fxn * tg_yyz_zzz_1[j];

                    tg_xyyz_yyyy_0[j] = pb_x * tg_yyz_yyyy_0[j] + fr * tg_yyz_yyyy_1[j];

                    tg_xyyz_yyyz_0[j] = pb_x * tg_yyz_yyyz_0[j] + fr * tg_yyz_yyyz_1[j];

                    tg_xyyz_yyzz_0[j] = pb_x * tg_yyz_yyzz_0[j] + fr * tg_yyz_yyzz_1[j];

                    tg_xyyz_yzzz_0[j] = pb_x * tg_yyz_yzzz_0[j] + fr * tg_yyz_yzzz_1[j];

                    tg_xyyz_zzzz_0[j] = pb_x * tg_yyz_zzzz_0[j] + fr * tg_yyz_zzzz_1[j];

                    tg_xyzz_xxxx_0[j] = pb_x * tg_yzz_xxxx_0[j] + fr * tg_yzz_xxxx_1[j] + 2.0 * fl1_fxn * tg_yzz_xxx_1[j];

                    tg_xyzz_xxxy_0[j] = pb_x * tg_yzz_xxxy_0[j] + fr * tg_yzz_xxxy_1[j] + 1.5 * fl1_fxn * tg_yzz_xxy_1[j];

                    tg_xyzz_xxxz_0[j] = pb_x * tg_yzz_xxxz_0[j] + fr * tg_yzz_xxxz_1[j] + 1.5 * fl1_fxn * tg_yzz_xxz_1[j];

                    tg_xyzz_xxyy_0[j] = pb_x * tg_yzz_xxyy_0[j] + fr * tg_yzz_xxyy_1[j] + fl1_fxn * tg_yzz_xyy_1[j];

                    tg_xyzz_xxyz_0[j] = pb_x * tg_yzz_xxyz_0[j] + fr * tg_yzz_xxyz_1[j] + fl1_fxn * tg_yzz_xyz_1[j];

                    tg_xyzz_xxzz_0[j] = pb_x * tg_yzz_xxzz_0[j] + fr * tg_yzz_xxzz_1[j] + fl1_fxn * tg_yzz_xzz_1[j];

                    tg_xyzz_xyyy_0[j] = pb_x * tg_yzz_xyyy_0[j] + fr * tg_yzz_xyyy_1[j] + 0.5 * fl1_fxn * tg_yzz_yyy_1[j];

                    tg_xyzz_xyyz_0[j] = pb_x * tg_yzz_xyyz_0[j] + fr * tg_yzz_xyyz_1[j] + 0.5 * fl1_fxn * tg_yzz_yyz_1[j];

                    tg_xyzz_xyzz_0[j] = pb_x * tg_yzz_xyzz_0[j] + fr * tg_yzz_xyzz_1[j] + 0.5 * fl1_fxn * tg_yzz_yzz_1[j];

                    tg_xyzz_xzzz_0[j] = pb_x * tg_yzz_xzzz_0[j] + fr * tg_yzz_xzzz_1[j] + 0.5 * fl1_fxn * tg_yzz_zzz_1[j];

                    tg_xyzz_yyyy_0[j] = pb_x * tg_yzz_yyyy_0[j] + fr * tg_yzz_yyyy_1[j];

                    tg_xyzz_yyyz_0[j] = pb_x * tg_yzz_yyyz_0[j] + fr * tg_yzz_yyyz_1[j];

                    tg_xyzz_yyzz_0[j] = pb_x * tg_yzz_yyzz_0[j] + fr * tg_yzz_yyzz_1[j];

                    tg_xyzz_yzzz_0[j] = pb_x * tg_yzz_yzzz_0[j] + fr * tg_yzz_yzzz_1[j];

                    tg_xyzz_zzzz_0[j] = pb_x * tg_yzz_zzzz_0[j] + fr * tg_yzz_zzzz_1[j];

                    tg_xzzz_xxxx_0[j] = pb_x * tg_zzz_xxxx_0[j] + fr * tg_zzz_xxxx_1[j] + 2.0 * fl1_fxn * tg_zzz_xxx_1[j];

                    tg_xzzz_xxxy_0[j] = pb_x * tg_zzz_xxxy_0[j] + fr * tg_zzz_xxxy_1[j] + 1.5 * fl1_fxn * tg_zzz_xxy_1[j];

                    tg_xzzz_xxxz_0[j] = pb_x * tg_zzz_xxxz_0[j] + fr * tg_zzz_xxxz_1[j] + 1.5 * fl1_fxn * tg_zzz_xxz_1[j];

                    tg_xzzz_xxyy_0[j] = pb_x * tg_zzz_xxyy_0[j] + fr * tg_zzz_xxyy_1[j] + fl1_fxn * tg_zzz_xyy_1[j];

                    tg_xzzz_xxyz_0[j] = pb_x * tg_zzz_xxyz_0[j] + fr * tg_zzz_xxyz_1[j] + fl1_fxn * tg_zzz_xyz_1[j];

                    tg_xzzz_xxzz_0[j] = pb_x * tg_zzz_xxzz_0[j] + fr * tg_zzz_xxzz_1[j] + fl1_fxn * tg_zzz_xzz_1[j];

                    tg_xzzz_xyyy_0[j] = pb_x * tg_zzz_xyyy_0[j] + fr * tg_zzz_xyyy_1[j] + 0.5 * fl1_fxn * tg_zzz_yyy_1[j];

                    tg_xzzz_xyyz_0[j] = pb_x * tg_zzz_xyyz_0[j] + fr * tg_zzz_xyyz_1[j] + 0.5 * fl1_fxn * tg_zzz_yyz_1[j];

                    tg_xzzz_xyzz_0[j] = pb_x * tg_zzz_xyzz_0[j] + fr * tg_zzz_xyzz_1[j] + 0.5 * fl1_fxn * tg_zzz_yzz_1[j];

                    tg_xzzz_xzzz_0[j] = pb_x * tg_zzz_xzzz_0[j] + fr * tg_zzz_xzzz_1[j] + 0.5 * fl1_fxn * tg_zzz_zzz_1[j];

                    tg_xzzz_yyyy_0[j] = pb_x * tg_zzz_yyyy_0[j] + fr * tg_zzz_yyyy_1[j];

                    tg_xzzz_yyyz_0[j] = pb_x * tg_zzz_yyyz_0[j] + fr * tg_zzz_yyyz_1[j];

                    tg_xzzz_yyzz_0[j] = pb_x * tg_zzz_yyzz_0[j] + fr * tg_zzz_yyzz_1[j];

                    tg_xzzz_yzzz_0[j] = pb_x * tg_zzz_yzzz_0[j] + fr * tg_zzz_yzzz_1[j];

                    tg_xzzz_zzzz_0[j] = pb_x * tg_zzz_zzzz_0[j] + fr * tg_zzz_zzzz_1[j];
                }
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    ...
                    tg_yyyy_xxxx_0[j] = pb_y * tg_yyy_xxxx_0[j] + fr * tg_yyy_xxxx_1[j] + 1.5 * fl1_fx * (tg_yy_xxxx_0[j] - tg_yy_xxxx_1[j] * fl1_fza);

                    tg_yyyy_xxxy_0[j] = pb_y * tg_yyy_xxxy_0[j] + fr * tg_yyy_xxxy_1[j] + 1.5 * fl1_fx * (tg_yy_xxxy_0[j] - tg_yy_xxxy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyy_xxx_1[j];

                    tg_yyyy_xxxz_0[j] = pb_y * tg_yyy_xxxz_0[j] + fr * tg_yyy_xxxz_1[j] + 1.5 * fl1_fx * (tg_yy_xxxz_0[j] - tg_yy_xxxz_1[j] * fl1_fza);

                    tg_yyyy_xxyy_0[j] = pb_y * tg_yyy_xxyy_0[j] + fr * tg_yyy_xxyy_1[j] + 1.5 * fl1_fx * (tg_yy_xxyy_0[j] - tg_yy_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_yyy_xxy_1[j];

                    tg_yyyy_xxyz_0[j] = pb_y * tg_yyy_xxyz_0[j] + fr * tg_yyy_xxyz_1[j] + 1.5 * fl1_fx * (tg_yy_xxyz_0[j] - tg_yy_xxyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyy_xxz_1[j];

                    tg_yyyy_xxzz_0[j] = pb_y * tg_yyy_xxzz_0[j] + fr * tg_yyy_xxzz_1[j] + 1.5 * fl1_fx * (tg_yy_xxzz_0[j] - tg_yy_xxzz_1[j] * fl1_fza);

                    tg_yyyy_xyyy_0[j] = pb_y * tg_yyy_xyyy_0[j] + fr * tg_yyy_xyyy_1[j] + 1.5 * fl1_fx * (tg_yy_xyyy_0[j] - tg_yy_xyyy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yyy_xyy_1[j];

                    tg_yyyy_xyyz_0[j] = pb_y * tg_yyy_xyyz_0[j] + fr * tg_yyy_xyyz_1[j] + 1.5 * fl1_fx * (tg_yy_xyyz_0[j] - tg_yy_xyyz_1[j] * fl1_fza) + fl1_fxn * tg_yyy_xyz_1[j];

                    tg_yyyy_xyzz_0[j] = pb_y * tg_yyy_xyzz_0[j] + fr * tg_yyy_xyzz_1[j] + 1.5 * fl1_fx * (tg_yy_xyzz_0[j] - tg_yy_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyy_xzz_1[j];

                    tg_yyyy_xzzz_0[j] = pb_y * tg_yyy_xzzz_0[j] + fr * tg_yyy_xzzz_1[j] + 1.5 * fl1_fx * (tg_yy_xzzz_0[j] - tg_yy_xzzz_1[j] * fl1_fza);

                    tg_yyyy_yyyy_0[j] = pb_y * tg_yyy_yyyy_0[j] + fr * tg_yyy_yyyy_1[j] + 1.5 * fl1_fx * (tg_yy_yyyy_0[j] - tg_yy_yyyy_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_yyy_yyy_1[j];

                    tg_yyyy_yyyz_0[j] = pb_y * tg_yyy_yyyz_0[j] + fr * tg_yyy_yyyz_1[j] + 1.5 * fl1_fx * (tg_yy_yyyz_0[j] - tg_yy_yyyz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yyy_yyz_1[j];

                    tg_yyyy_yyzz_0[j] = pb_y * tg_yyy_yyzz_0[j] + fr * tg_yyy_yyzz_1[j] + 1.5 * fl1_fx * (tg_yy_yyzz_0[j] - tg_yy_yyzz_1[j] * fl1_fza) + fl1_fxn * tg_yyy_yzz_1[j];

                    tg_yyyy_yzzz_0[j] = pb_y * tg_yyy_yzzz_0[j] + fr * tg_yyy_yzzz_1[j] + 1.5 * fl1_fx * (tg_yy_yzzz_0[j] - tg_yy_yzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyy_zzz_1[j];

                    tg_yyyy_zzzz_0[j] = pb_y * tg_yyy_zzzz_0[j] + fr * tg_yyy_zzzz_1[j] + 1.5 * fl1_fx * (tg_yy_zzzz_0[j] - tg_yy_zzzz_1[j] * fl1_fza);

                    tg_yyyz_xxxx_0[j] = pb_y * tg_yyz_xxxx_0[j] + fr * tg_yyz_xxxx_1[j] + fl1_fx * (tg_yz_xxxx_0[j] - tg_yz_xxxx_1[j] * fl1_fza);

                    tg_yyyz_xxxy_0[j] = pb_y * tg_yyz_xxxy_0[j] + fr * tg_yyz_xxxy_1[j] + fl1_fx * (tg_yz_xxxy_0[j] - tg_yz_xxxy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyz_xxx_1[j];

                    tg_yyyz_xxxz_0[j] = pb_y * tg_yyz_xxxz_0[j] + fr * tg_yyz_xxxz_1[j] + fl1_fx * (tg_yz_xxxz_0[j] - tg_yz_xxxz_1[j] * fl1_fza);

                    tg_yyyz_xxyy_0[j] = pb_y * tg_yyz_xxyy_0[j] + fr * tg_yyz_xxyy_1[j] + fl1_fx * (tg_yz_xxyy_0[j] - tg_yz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_yyz_xxy_1[j];

                    tg_yyyz_xxyz_0[j] = pb_y * tg_yyz_xxyz_0[j] + fr * tg_yyz_xxyz_1[j] + fl1_fx * (tg_yz_xxyz_0[j] - tg_yz_xxyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyz_xxz_1[j];

                    tg_yyyz_xxzz_0[j] = pb_y * tg_yyz_xxzz_0[j] + fr * tg_yyz_xxzz_1[j] + fl1_fx * (tg_yz_xxzz_0[j] - tg_yz_xxzz_1[j] * fl1_fza);

                    tg_yyyz_xyyy_0[j] = pb_y * tg_yyz_xyyy_0[j] + fr * tg_yyz_xyyy_1[j] + fl1_fx * (tg_yz_xyyy_0[j] - tg_yz_xyyy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yyz_xyy_1[j];

                    tg_yyyz_xyyz_0[j] = pb_y * tg_yyz_xyyz_0[j] + fr * tg_yyz_xyyz_1[j] + fl1_fx * (tg_yz_xyyz_0[j] - tg_yz_xyyz_1[j] * fl1_fza) + fl1_fxn * tg_yyz_xyz_1[j];

                    tg_yyyz_xyzz_0[j] = pb_y * tg_yyz_xyzz_0[j] + fr * tg_yyz_xyzz_1[j] + fl1_fx * (tg_yz_xyzz_0[j] - tg_yz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyz_xzz_1[j];

                    tg_yyyz_xzzz_0[j] = pb_y * tg_yyz_xzzz_0[j] + fr * tg_yyz_xzzz_1[j] + fl1_fx * (tg_yz_xzzz_0[j] - tg_yz_xzzz_1[j] * fl1_fza);

                    tg_yyyz_yyyy_0[j] = pb_y * tg_yyz_yyyy_0[j] + fr * tg_yyz_yyyy_1[j] + fl1_fx * (tg_yz_yyyy_0[j] - tg_yz_yyyy_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_yyz_yyy_1[j];

                    tg_yyyz_yyyz_0[j] = pb_y * tg_yyz_yyyz_0[j] + fr * tg_yyz_yyyz_1[j] + fl1_fx * (tg_yz_yyyz_0[j] - tg_yz_yyyz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yyz_yyz_1[j];

                    tg_yyyz_yyzz_0[j] = pb_y * tg_yyz_yyzz_0[j] + fr * tg_yyz_yyzz_1[j] + fl1_fx * (tg_yz_yyzz_0[j] - tg_yz_yyzz_1[j] * fl1_fza) + fl1_fxn * tg_yyz_yzz_1[j];

                    tg_yyyz_yzzz_0[j] = pb_y * tg_yyz_yzzz_0[j] + fr * tg_yyz_yzzz_1[j] + fl1_fx * (tg_yz_yzzz_0[j] - tg_yz_yzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyz_zzz_1[j];

                    tg_yyyz_zzzz_0[j] = pb_y * tg_yyz_zzzz_0[j] + fr * tg_yyz_zzzz_1[j] + fl1_fx * (tg_yz_zzzz_0[j] - tg_yz_zzzz_1[j] * fl1_fza);

                    tg_yyzz_xxxx_0[j] = pb_y * tg_yzz_xxxx_0[j] + fr * tg_yzz_xxxx_1[j] + 0.5 * fl1_fx * (tg_zz_xxxx_0[j] - tg_zz_xxxx_1[j] * fl1_fza);

                    tg_yyzz_xxxy_0[j] = pb_y * tg_yzz_xxxy_0[j] + fr * tg_yzz_xxxy_1[j] + 0.5 * fl1_fx * (tg_zz_xxxy_0[j] - tg_zz_xxxy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yzz_xxx_1[j];

                    tg_yyzz_xxxz_0[j] = pb_y * tg_yzz_xxxz_0[j] + fr * tg_yzz_xxxz_1[j] + 0.5 * fl1_fx * (tg_zz_xxxz_0[j] - tg_zz_xxxz_1[j] * fl1_fza);

                    tg_yyzz_xxyy_0[j] = pb_y * tg_yzz_xxyy_0[j] + fr * tg_yzz_xxyy_1[j] + 0.5 * fl1_fx * (tg_zz_xxyy_0[j] - tg_zz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_yzz_xxy_1[j];

                    tg_yyzz_xxyz_0[j] = pb_y * tg_yzz_xxyz_0[j] + fr * tg_yzz_xxyz_1[j] + 0.5 * fl1_fx * (tg_zz_xxyz_0[j] - tg_zz_xxyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yzz_xxz_1[j];

                    tg_yyzz_xxzz_0[j] = pb_y * tg_yzz_xxzz_0[j] + fr * tg_yzz_xxzz_1[j] + 0.5 * fl1_fx * (tg_zz_xxzz_0[j] - tg_zz_xxzz_1[j] * fl1_fza);

                    tg_yyzz_xyyy_0[j] = pb_y * tg_yzz_xyyy_0[j] + fr * tg_yzz_xyyy_1[j] + 0.5 * fl1_fx * (tg_zz_xyyy_0[j] - tg_zz_xyyy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yzz_xyy_1[j];

                    tg_yyzz_xyyz_0[j] = pb_y * tg_yzz_xyyz_0[j] + fr * tg_yzz_xyyz_1[j] + 0.5 * fl1_fx * (tg_zz_xyyz_0[j] - tg_zz_xyyz_1[j] * fl1_fza) + fl1_fxn * tg_yzz_xyz_1[j];

                    tg_yyzz_xyzz_0[j] = pb_y * tg_yzz_xyzz_0[j] + fr * tg_yzz_xyzz_1[j] + 0.5 * fl1_fx * (tg_zz_xyzz_0[j] - tg_zz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yzz_xzz_1[j];

                    tg_yyzz_xzzz_0[j] = pb_y * tg_yzz_xzzz_0[j] + fr * tg_yzz_xzzz_1[j] + 0.5 * fl1_fx * (tg_zz_xzzz_0[j] - tg_zz_xzzz_1[j] * fl1_fza);

                    tg_yyzz_yyyy_0[j] = pb_y * tg_yzz_yyyy_0[j] + fr * tg_yzz_yyyy_1[j] + 0.5 * fl1_fx * (tg_zz_yyyy_0[j] - tg_zz_yyyy_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_yzz_yyy_1[j];

                    tg_yyzz_yyyz_0[j] = pb_y * tg_yzz_yyyz_0[j] + fr * tg_yzz_yyyz_1[j] + 0.5 * fl1_fx * (tg_zz_yyyz_0[j] - tg_zz_yyyz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yzz_yyz_1[j];

                    tg_yyzz_yyzz_0[j] = pb_y * tg_yzz_yyzz_0[j] + fr * tg_yzz_yyzz_1[j] + 0.5 * fl1_fx * (tg_zz_yyzz_0[j] - tg_zz_yyzz_1[j] * fl1_fza) + fl1_fxn * tg_yzz_yzz_1[j];

                    tg_yyzz_yzzz_0[j] = pb_y * tg_yzz_yzzz_0[j] + fr * tg_yzz_yzzz_1[j] + 0.5 * fl1_fx * (tg_zz_yzzz_0[j] - tg_zz_yzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yzz_zzz_1[j];

                    tg_yyzz_zzzz_0[j] = pb_y * tg_yzz_zzzz_0[j] + fr * tg_yzz_zzzz_1[j] + 0.5 * fl1_fx * (tg_zz_zzzz_0[j] - tg_zz_zzzz_1[j] * fl1_fza);

                    tg_yzzz_xxxx_0[j] = pb_y * tg_zzz_xxxx_0[j] + fr * tg_zzz_xxxx_1[j];

                    tg_yzzz_xxxy_0[j] = pb_y * tg_zzz_xxxy_0[j] + fr * tg_zzz_xxxy_1[j] + 0.5 * fl1_fxn * tg_zzz_xxx_1[j];

                    tg_yzzz_xxxz_0[j] = pb_y * tg_zzz_xxxz_0[j] + fr * tg_zzz_xxxz_1[j];

                    tg_yzzz_xxyy_0[j] = pb_y * tg_zzz_xxyy_0[j] + fr * tg_zzz_xxyy_1[j] + fl1_fxn * tg_zzz_xxy_1[j];

                    tg_yzzz_xxyz_0[j] = pb_y * tg_zzz_xxyz_0[j] + fr * tg_zzz_xxyz_1[j] + 0.5 * fl1_fxn * tg_zzz_xxz_1[j];

                    tg_yzzz_xxzz_0[j] = pb_y * tg_zzz_xxzz_0[j] + fr * tg_zzz_xxzz_1[j];

                    tg_yzzz_xyyy_0[j] = pb_y * tg_zzz_xyyy_0[j] + fr * tg_zzz_xyyy_1[j] + 1.5 * fl1_fxn * tg_zzz_xyy_1[j];

                    tg_yzzz_xyyz_0[j] = pb_y * tg_zzz_xyyz_0[j] + fr * tg_zzz_xyyz_1[j] + fl1_fxn * tg_zzz_xyz_1[j];

                    tg_yzzz_xyzz_0[j] = pb_y * tg_zzz_xyzz_0[j] + fr * tg_zzz_xyzz_1[j] + 0.5 * fl1_fxn * tg_zzz_xzz_1[j];

                    tg_yzzz_xzzz_0[j] = pb_y * tg_zzz_xzzz_0[j] + fr * tg_zzz_xzzz_1[j];

                    tg_yzzz_yyyy_0[j] = pb_y * tg_zzz_yyyy_0[j] + fr * tg_zzz_yyyy_1[j] + 2.0 * fl1_fxn * tg_zzz_yyy_1[j];

                    tg_yzzz_yyyz_0[j] = pb_y * tg_zzz_yyyz_0[j] + fr * tg_zzz_yyyz_1[j] + 1.5 * fl1_fxn * tg_zzz_yyz_1[j];

                    tg_yzzz_yyzz_0[j] = pb_y * tg_zzz_yyzz_0[j] + fr * tg_zzz_yyzz_1[j] + fl1_fxn * tg_zzz_yzz_1[j];

                    tg_yzzz_yzzz_0[j] = pb_y * tg_zzz_yzzz_0[j] + fr * tg_zzz_yzzz_1[j] + 0.5 * fl1_fxn * tg_zzz_zzz_1[j];

                    tg_yzzz_zzzz_0[j] = pb_y * tg_zzz_zzzz_0[j] + fr * tg_zzz_zzzz_1[j];

                    fr = wp_z[j]; 

                    tg_zzzz_xxxx_0[j] = pb_z * tg_zzz_xxxx_0[j] + fr * tg_zzz_xxxx_1[j] + 1.5 * fl1_fx * (tg_zz_xxxx_0[j] - tg_zz_xxxx_1[j] * fl1_fza);

                    tg_zzzz_xxxy_0[j] = pb_z * tg_zzz_xxxy_0[j] + fr * tg_zzz_xxxy_1[j] + 1.5 * fl1_fx * (tg_zz_xxxy_0[j] - tg_zz_xxxy_1[j] * fl1_fza);

                    tg_zzzz_xxxz_0[j] = pb_z * tg_zzz_xxxz_0[j] + fr * tg_zzz_xxxz_1[j] + 1.5 * fl1_fx * (tg_zz_xxxz_0[j] - tg_zz_xxxz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_zzz_xxx_1[j];

                    tg_zzzz_xxyy_0[j] = pb_z * tg_zzz_xxyy_0[j] + fr * tg_zzz_xxyy_1[j] + 1.5 * fl1_fx * (tg_zz_xxyy_0[j] - tg_zz_xxyy_1[j] * fl1_fza);

                    tg_zzzz_xxyz_0[j] = pb_z * tg_zzz_xxyz_0[j] + fr * tg_zzz_xxyz_1[j] + 1.5 * fl1_fx * (tg_zz_xxyz_0[j] - tg_zz_xxyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_zzz_xxy_1[j];

                    tg_zzzz_xxzz_0[j] = pb_z * tg_zzz_xxzz_0[j] + fr * tg_zzz_xxzz_1[j] + 1.5 * fl1_fx * (tg_zz_xxzz_0[j] - tg_zz_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_zzz_xxz_1[j];

                    tg_zzzz_xyyy_0[j] = pb_z * tg_zzz_xyyy_0[j] + fr * tg_zzz_xyyy_1[j] + 1.5 * fl1_fx * (tg_zz_xyyy_0[j] - tg_zz_xyyy_1[j] * fl1_fza);

                    tg_zzzz_xyyz_0[j] = pb_z * tg_zzz_xyyz_0[j] + fr * tg_zzz_xyyz_1[j] + 1.5 * fl1_fx * (tg_zz_xyyz_0[j] - tg_zz_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_zzz_xyy_1[j];

                    tg_zzzz_xyzz_0[j] = pb_z * tg_zzz_xyzz_0[j] + fr * tg_zzz_xyzz_1[j] + 1.5 * fl1_fx * (tg_zz_xyzz_0[j] - tg_zz_xyzz_1[j] * fl1_fza) + fl1_fxn * tg_zzz_xyz_1[j];

                    tg_zzzz_xzzz_0[j] = pb_z * tg_zzz_xzzz_0[j] + fr * tg_zzz_xzzz_1[j] + 1.5 * fl1_fx * (tg_zz_xzzz_0[j] - tg_zz_xzzz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_zzz_xzz_1[j];

                    tg_zzzz_yyyy_0[j] = pb_z * tg_zzz_yyyy_0[j] + fr * tg_zzz_yyyy_1[j] + 1.5 * fl1_fx * (tg_zz_yyyy_0[j] - tg_zz_yyyy_1[j] * fl1_fza);

                    tg_zzzz_yyyz_0[j] = pb_z * tg_zzz_yyyz_0[j] + fr * tg_zzz_yyyz_1[j] + 1.5 * fl1_fx * (tg_zz_yyyz_0[j] - tg_zz_yyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_zzz_yyy_1[j];

                    tg_zzzz_yyzz_0[j] = pb_z * tg_zzz_yyzz_0[j] + fr * tg_zzz_yyzz_1[j] + 1.5 * fl1_fx * (tg_zz_yyzz_0[j] - tg_zz_yyzz_1[j] * fl1_fza) + fl1_fxn * tg_zzz_yyz_1[j];

                    tg_zzzz_yzzz_0[j] = pb_z * tg_zzz_yzzz_0[j] + fr * tg_zzz_yzzz_1[j] + 1.5 * fl1_fx * (tg_zz_yzzz_0[j] - tg_zz_yzzz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_zzz_yzz_1[j];

                    tg_zzzz_zzzz_0[j] = pb_z * tg_zzz_zzzz_0[j] + fr * tg_zzz_zzzz_1[j] + 1.5 * fl1_fx * (tg_zz_zzzz_0[j] - tg_zz_zzzz_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_zzz_zzz_1[j];
                }
