...
namespace erirecfunc { // erirecfunc namespace
                                      ...
                                      const int32_t              iContrPair)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            auto pidx_g_1_5_m1 = recursionMap.index(CRecursionTerm({"Electron Repulsion"}, 0, true, 
                                                                   {1, -1, -1, -1}, {5, -1, -1, -1}, 
                                                                   1, 1, iord + 1));
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                auto tg_x_xxxxx_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx); 

                auto tg_x_xxxxy_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 1); 

                auto tg_x_xxxxz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 2); 

                auto tg_x_xxxyy_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 3); 

                auto tg_x_xxxyz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 4); 

                auto tg_x_xxxzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 5); 

                auto tg_x_xxyyy_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 6); 

                auto tg_x_xxyyz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 7); 

                auto tg_x_xxyzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 8); 

                auto tg_x_xxzzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 9); 

                auto tg_x_xyyyy_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 10); 

                auto tg_x_xyyyz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 11); 

                auto tg_x_xyyzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 12); 

                auto tg_x_xyzzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 13); 

                auto tg_x_xzzzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 14); 

                auto tg_x_yyyyy_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 15); 

                auto tg_x_yyyyz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 16); 

                auto tg_x_yyyzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 17); 

                auto tg_x_yyzzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 18); 

                auto tg_x_yzzzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 19); 

                auto tg_x_zzzzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 20); 

                auto tg_y_xxxxx_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 21); 

                auto tg_y_xxxxy_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 22); 

                auto tg_y_xxxxz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 23); 

                auto tg_y_xxxyy_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 24); 

                auto tg_y_xxxyz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 25); 

                auto tg_y_xxxzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 26); 

                auto tg_y_xxyyy_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 27); 

                auto tg_y_xxyyz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 28); 

                auto tg_y_xxyzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 29); 

                auto tg_y_xxzzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 30); 

                auto tg_y_xyyyy_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 31); 

                auto tg_y_xyyyz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 32); 

                auto tg_y_xyyzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 33); 

                auto tg_y_xyzzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 34); 

                auto tg_y_xzzzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 35); 

                auto tg_y_yyyyy_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 36); 

                auto tg_y_yyyyz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 37); 

                auto tg_y_yyyzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 38); 

                auto tg_y_yyzzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 39); 

                auto tg_y_yzzzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 40); 

                auto tg_y_zzzzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 41); 

                auto tg_z_xxxxx_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 42); 

                auto tg_z_xxxxy_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 43); 

                auto tg_z_xxxxz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 44); 

                auto tg_z_xxxyy_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 45); 

                auto tg_z_xxxyz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 46); 

                auto tg_z_xxxzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 47); 

                auto tg_z_xxyyy_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 48); 

                auto tg_z_xxyyz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 49); 

                auto tg_z_xxyzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 50); 

                auto tg_z_xxzzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 51); 

                auto tg_z_xyyyy_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 52); 

                auto tg_z_xyyyz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 53); 

                auto tg_z_xyyzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 54); 

                auto tg_z_xyzzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 55); 

                auto tg_z_xzzzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 56); 

                auto tg_z_yyyyy_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 57); 

                auto tg_z_yyyyz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 58); 

                auto tg_z_yyyzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 59); 

                auto tg_z_yyzzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 60); 

                auto tg_z_yzzzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 61); 

                auto tg_z_zzzzz_1 = primBuffer[pidx_g_1_5_m1].data(63 * idx + 62); 
                ...
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    ...
                    tg_xxx_xxxxx_0[j] = pb_x * tg_xx_xxxxx_0[j] + fr * tg_xx_xxxxx_1[j] + fl1_fx * (tg_x_xxxxx_0[j] - tg_x_xxxxx_1[j] * fl1_fza) + 2.5 * fl1_fxn * tg_xx_xxxx_1[j];

                    tg_xxx_xxxxy_0[j] = pb_x * tg_xx_xxxxy_0[j] + fr * tg_xx_xxxxy_1[j] + fl1_fx * (tg_x_xxxxy_0[j] - tg_x_xxxxy_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xx_xxxy_1[j];

                    tg_xxx_xxxxz_0[j] = pb_x * tg_xx_xxxxz_0[j] + fr * tg_xx_xxxxz_1[j] + fl1_fx * (tg_x_xxxxz_0[j] - tg_x_xxxxz_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xx_xxxz_1[j];

                    tg_xxx_xxxyy_0[j] = pb_x * tg_xx_xxxyy_0[j] + fr * tg_xx_xxxyy_1[j] + fl1_fx * (tg_x_xxxyy_0[j] - tg_x_xxxyy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xx_xxyy_1[j];

                    tg_xxx_xxxyz_0[j] = pb_x * tg_xx_xxxyz_0[j] + fr * tg_xx_xxxyz_1[j] + fl1_fx * (tg_x_xxxyz_0[j] - tg_x_xxxyz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xx_xxyz_1[j];

                    tg_xxx_xxxzz_0[j] = pb_x * tg_xx_xxxzz_0[j] + fr * tg_xx_xxxzz_1[j] + fl1_fx * (tg_x_xxxzz_0[j] - tg_x_xxxzz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xx_xxzz_1[j];

                    tg_xxx_xxyyy_0[j] = pb_x * tg_xx_xxyyy_0[j] + fr * tg_xx_xxyyy_1[j] + fl1_fx * (tg_x_xxyyy_0[j] - tg_x_xxyyy_1[j] * fl1_fza) + fl1_fxn * tg_xx_xyyy_1[j];

                    tg_xxx_xxyyz_0[j] = pb_x * tg_xx_xxyyz_0[j] + fr * tg_xx_xxyyz_1[j] + fl1_fx * (tg_x_xxyyz_0[j] - tg_x_xxyyz_1[j] * fl1_fza) + fl1_fxn * tg_xx_xyyz_1[j];

                    tg_xxx_xxyzz_0[j] = pb_x * tg_xx_xxyzz_0[j] + fr * tg_xx_xxyzz_1[j] + fl1_fx * (tg_x_xxyzz_0[j] - tg_x_xxyzz_1[j] * fl1_fza) + fl1_fxn * tg_xx_xyzz_1[j];

                    tg_xxx_xxzzz_0[j] = pb_x * tg_xx_xxzzz_0[j] + fr * tg_xx_xxzzz_1[j] + fl1_fx * (tg_x_xxzzz_0[j] - tg_x_xxzzz_1[j] * fl1_fza) + fl1_fxn * tg_xx_xzzz_1[j];

                    tg_xxx_xyyyy_0[j] = pb_x * tg_xx_xyyyy_0[j] + fr * tg_xx_xyyyy_1[j] + fl1_fx * (tg_x_xyyyy_0[j] - tg_x_xyyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xx_yyyy_1[j];

                    tg_xxx_xyyyz_0[j] = pb_x * tg_xx_xyyyz_0[j] + fr * tg_xx_xyyyz_1[j] + fl1_fx * (tg_x_xyyyz_0[j] - tg_x_xyyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xx_yyyz_1[j];

                    tg_xxx_xyyzz_0[j] = pb_x * tg_xx_xyyzz_0[j] + fr * tg_xx_xyyzz_1[j] + fl1_fx * (tg_x_xyyzz_0[j] - tg_x_xyyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xx_yyzz_1[j];

                    tg_xxx_xyzzz_0[j] = pb_x * tg_xx_xyzzz_0[j] + fr * tg_xx_xyzzz_1[j] + fl1_fx * (tg_x_xyzzz_0[j] - tg_x_xyzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xx_yzzz_1[j];

                    tg_xxx_xzzzz_0[j] = pb_x * tg_xx_xzzzz_0[j] + fr * tg_xx_xzzzz_1[j] + fl1_fx * (tg_x_xzzzz_0[j] - tg_x_xzzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xx_zzzz_1[j];

                    tg_xxx_yyyyy_0[j] = pb_x * tg_xx_yyyyy_0[j] + fr * tg_xx_yyyyy_1[j] + fl1_fx * (tg_x_yyyyy_0[j] - tg_x_yyyyy_1[j] * fl1_fza);

                    tg_xxx_yyyyz_0[j] = pb_x * tg_xx_yyyyz_0[j] + fr * tg_xx_yyyyz_1[j] + fl1_fx * (tg_x_yyyyz_0[j] - tg_x_yyyyz_1[j] * fl1_fza);

                    tg_xxx_yyyzz_0[j] = pb_x * tg_xx_yyyzz_0[j] + fr * tg_xx_yyyzz_1[j] + fl1_fx * (tg_x_yyyzz_0[j] - tg_x_yyyzz_1[j] * fl1_fza);

                    tg_xxx_yyzzz_0[j] = pb_x * tg_xx_yyzzz_0[j] + fr * tg_xx_yyzzz_1[j] + fl1_fx * (tg_x_yyzzz_0[j] - tg_x_yyzzz_1[j] * fl1_fza);

                    tg_xxx_yzzzz_0[j] = pb_x * tg_xx_yzzzz_0[j] + fr * tg_xx_yzzzz_1[j] + fl1_fx * (tg_x_yzzzz_0[j] - tg_x_yzzzz_1[j] * fl1_fza);

                    tg_xxx_zzzzz_0[j] = pb_x * tg_xx_zzzzz_0[j] + fr * tg_xx_zzzzz_1[j] + fl1_fx * (tg_x_zzzzz_0[j] - tg_x_zzzzz_1[j] * fl1_fza);

                    tg_xxy_xxxxx_0[j] = pb_x * tg_xy_xxxxx_0[j] + fr * tg_xy_xxxxx_1[j] + 0.5 * fl1_fx * (tg_y_xxxxx_0[j] - tg_y_xxxxx_1[j] * fl1_fza) + 2.5 * fl1_fxn * tg_xy_xxxx_1[j];

                    tg_xxy_xxxxy_0[j] = pb_x * tg_xy_xxxxy_0[j] + fr * tg_xy_xxxxy_1[j] + 0.5 * fl1_fx * (tg_y_xxxxy_0[j] - tg_y_xxxxy_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xy_xxxy_1[j];

                    tg_xxy_xxxxz_0[j] = pb_x * tg_xy_xxxxz_0[j] + fr * tg_xy_xxxxz_1[j] + 0.5 * fl1_fx * (tg_y_xxxxz_0[j] - tg_y_xxxxz_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xy_xxxz_1[j];

                    tg_xxy_xxxyy_0[j] = pb_x * tg_xy_xxxyy_0[j] + fr * tg_xy_xxxyy_1[j] + 0.5 * fl1_fx * (tg_y_xxxyy_0[j] - tg_y_xxxyy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xy_xxyy_1[j];

                    tg_xxy_xxxyz_0[j] = pb_x * tg_xy_xxxyz_0[j] + fr * tg_xy_xxxyz_1[j] + 0.5 * fl1_fx * (tg_y_xxxyz_0[j] - tg_y_xxxyz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xy_xxyz_1[j];

                    tg_xxy_xxxzz_0[j] = pb_x * tg_xy_xxxzz_0[j] + fr * tg_xy_xxxzz_1[j] + 0.5 * fl1_fx * (tg_y_xxxzz_0[j] - tg_y_xxxzz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xy_xxzz_1[j];

                    tg_xxy_xxyyy_0[j] = pb_x * tg_xy_xxyyy_0[j] + fr * tg_xy_xxyyy_1[j] + 0.5 * fl1_fx * (tg_y_xxyyy_0[j] - tg_y_xxyyy_1[j] * fl1_fza) + fl1_fxn * tg_xy_xyyy_1[j];

                    tg_xxy_xxyyz_0[j] = pb_x * tg_xy_xxyyz_0[j] + fr * tg_xy_xxyyz_1[j] + 0.5 * fl1_fx * (tg_y_xxyyz_0[j] - tg_y_xxyyz_1[j] * fl1_fza) + fl1_fxn * tg_xy_xyyz_1[j];

                    tg_xxy_xxyzz_0[j] = pb_x * tg_xy_xxyzz_0[j] + fr * tg_xy_xxyzz_1[j] + 0.5 * fl1_fx * (tg_y_xxyzz_0[j] - tg_y_xxyzz_1[j] * fl1_fza) + fl1_fxn * tg_xy_xyzz_1[j];

                    tg_xxy_xxzzz_0[j] = pb_x * tg_xy_xxzzz_0[j] + fr * tg_xy_xxzzz_1[j] + 0.5 * fl1_fx * (tg_y_xxzzz_0[j] - tg_y_xxzzz_1[j] * fl1_fza) + fl1_fxn * tg_xy_xzzz_1[j];

                    tg_xxy_xyyyy_0[j] = pb_x * tg_xy_xyyyy_0[j] + fr * tg_xy_xyyyy_1[j] + 0.5 * fl1_fx * (tg_y_xyyyy_0[j] - tg_y_xyyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xy_yyyy_1[j];

                    tg_xxy_xyyyz_0[j] = pb_x * tg_xy_xyyyz_0[j] + fr * tg_xy_xyyyz_1[j] + 0.5 * fl1_fx * (tg_y_xyyyz_0[j] - tg_y_xyyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xy_yyyz_1[j];

                    tg_xxy_xyyzz_0[j] = pb_x * tg_xy_xyyzz_0[j] + fr * tg_xy_xyyzz_1[j] + 0.5 * fl1_fx * (tg_y_xyyzz_0[j] - tg_y_xyyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xy_yyzz_1[j];

                    tg_xxy_xyzzz_0[j] = pb_x * tg_xy_xyzzz_0[j] + fr * tg_xy_xyzzz_1[j] + 0.5 * fl1_fx * (tg_y_xyzzz_0[j] - tg_y_xyzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xy_yzzz_1[j];

                    tg_xxy_xzzzz_0[j] = pb_x * tg_xy_xzzzz_0[j] + fr * tg_xy_xzzzz_1[j] + 0.5 * fl1_fx * (tg_y_xzzzz_0[j] - tg_y_xzzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xy_zzzz_1[j];

                    tg_xxy_yyyyy_0[j] = pb_x * tg_xy_yyyyy_0[j] + fr * tg_xy_yyyyy_1[j] + 0.5 * fl1_fx * (tg_y_yyyyy_0[j] - tg_y_yyyyy_1[j] * fl1_fza);

                    tg_xxy_yyyyz_0[j] = pb_x * tg_xy_yyyyz_0[j] + fr * tg_xy_yyyyz_1[j] + 0.5 * fl1_fx * (tg_y_yyyyz_0[j] - tg_y_yyyyz_1[j] * fl1_fza);

                    tg_xxy_yyyzz_0[j] = pb_x * tg_xy_yyyzz_0[j] + fr * tg_xy_yyyzz_1[j] + 0.5 * fl1_fx * (tg_y_yyyzz_0[j] - tg_y_yyyzz_1[j] * fl1_fza);

                    tg_xxy_yyzzz_0[j] = pb_x * tg_xy_yyzzz_0[j] + fr * tg_xy_yyzzz_1[j] + 0.5 * fl1_fx * (tg_y_yyzzz_0[j] - tg_y_yyzzz_1[j] * fl1_fza);

                    tg_xxy_yzzzz_0[j] = pb_x * tg_xy_yzzzz_0[j] + fr * tg_xy_yzzzz_1[j] + 0.5 * fl1_fx * (tg_y_yzzzz_0[j] - tg_y_yzzzz_1[j] * fl1_fza);

                    tg_xxy_zzzzz_0[j] = pb_x * tg_xy_zzzzz_0[j] + fr * tg_xy_zzzzz_1[j] + 0.5 * fl1_fx * (tg_y_zzzzz_0[j] - tg_y_zzzzz_1[j] * fl1_fza);

                    tg_xxz_xxxxx_0[j] = pb_x * tg_xz_xxxxx_0[j] + fr * tg_xz_xxxxx_1[j] + 0.5 * fl1_fx * (tg_z_xxxxx_0[j] - tg_z_xxxxx_1[j] * fl1_fza) + 2.5 * fl1_fxn * tg_xz_xxxx_1[j];

                    tg_xxz_xxxxy_0[j] = pb_x * tg_xz_xxxxy_0[j] + fr * tg_xz_xxxxy_1[j] + 0.5 * fl1_fx * (tg_z_xxxxy_0[j] - tg_z_xxxxy_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xz_xxxy_1[j];

                    tg_xxz_xxxxz_0[j] = pb_x * tg_xz_xxxxz_0[j] + fr * tg_xz_xxxxz_1[j] + 0.5 * fl1_fx * (tg_z_xxxxz_0[j] - tg_z_xxxxz_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xz_xxxz_1[j];

                    tg_xxz_xxxyy_0[j] = pb_x * tg_xz_xxxyy_0[j] + fr * tg_xz_xxxyy_1[j] + 0.5 * fl1_fx * (tg_z_xxxyy_0[j] - tg_z_xxxyy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xz_xxyy_1[j];

                    tg_xxz_xxxyz_0[j] = pb_x * tg_xz_xxxyz_0[j] + fr * tg_xz_xxxyz_1[j] + 0.5 * fl1_fx * (tg_z_xxxyz_0[j] - tg_z_xxxyz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xz_xxyz_1[j];

                    tg_xxz_xxxzz_0[j] = pb_x * tg_xz_xxxzz_0[j] + fr * tg_xz_xxxzz_1[j] + 0.5 * fl1_fx * (tg_z_xxxzz_0[j] - tg_z_xxxzz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xz_xxzz_1[j];

                    tg_xxz_xxyyy_0[j] = pb_x * tg_xz_xxyyy_0[j] + fr * tg_xz_xxyyy_1[j] + 0.5 * fl1_fx * (tg_z_xxyyy_0[j] - tg_z_xxyyy_1[j] * fl1_fza) + fl1_fxn * tg_xz_xyyy_1[j];

                    tg_xxz_xxyyz_0[j] = pb_x * tg_xz_xxyyz_0[j] + fr * tg_xz_xxyyz_1[j] + 0.5 * fl1_fx * (tg_z_xxyyz_0[j] - tg_z_xxyyz_1[j] * fl1_fza) + fl1_fxn * tg_xz_xyyz_1[j];

                    tg_xxz_xxyzz_0[j] = pb_x * tg_xz_xxyzz_0[j] + fr * tg_xz_xxyzz_1[j] + 0.5 * fl1_fx * (tg_z_xxyzz_0[j] - tg_z_xxyzz_1[j] * fl1_fza) + fl1_fxn * tg_xz_xyzz_1[j];

                    tg_xxz_xxzzz_0[j] = pb_x * tg_xz_xxzzz_0[j] + fr * tg_xz_xxzzz_1[j] + 0.5 * fl1_fx * (tg_z_xxzzz_0[j] - tg_z_xxzzz_1[j] * fl1_fza) + fl1_fxn * tg_xz_xzzz_1[j];

                    tg_xxz_xyyyy_0[j] = pb_x * tg_xz_xyyyy_0[j] + fr * tg_xz_xyyyy_1[j] + 0.5 * fl1_fx * (tg_z_xyyyy_0[j] - tg_z_xyyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xz_yyyy_1[j];

                    tg_xxz_xyyyz_0[j] = pb_x * tg_xz_xyyyz_0[j] + fr * tg_xz_xyyyz_1[j] + 0.5 * fl1_fx * (tg_z_xyyyz_0[j] - tg_z_xyyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xz_yyyz_1[j];

                    tg_xxz_xyyzz_0[j] = pb_x * tg_xz_xyyzz_0[j] + fr * tg_xz_xyyzz_1[j] + 0.5 * fl1_fx * (tg_z_xyyzz_0[j] - tg_z_xyyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xz_yyzz_1[j];

                    tg_xxz_xyzzz_0[j] = pb_x * tg_xz_xyzzz_0[j] + fr * tg_xz_xyzzz_1[j] + 0.5 * fl1_fx * (tg_z_xyzzz_0[j] - tg_z_xyzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xz_yzzz_1[j];

                    tg_xxz_xzzzz_0[j] = pb_x * tg_xz_xzzzz_0[j] + fr * tg_xz_xzzzz_1[j] + 0.5 * fl1_fx * (tg_z_xzzzz_0[j] - tg_z_xzzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xz_zzzz_1[j];

                    tg_xxz_yyyyy_0[j] = pb_x * tg_xz_yyyyy_0[j] + fr * tg_xz_yyyyy_1[j] + 0.5 * fl1_fx * (tg_z_yyyyy_0[j] - tg_z_yyyyy_1[j] * fl1_fza);

                    tg_xxz_yyyyz_0[j] = pb_x * tg_xz_yyyyz_0[j] + fr * tg_xz_yyyyz_1[j] + 0.5 * fl1_fx * (tg_z_yyyyz_0[j] - tg_z_yyyyz_1[j] * fl1_fza);

                    tg_xxz_yyyzz_0[j] = pb_x * tg_xz_yyyzz_0[j] + fr * tg_xz_yyyzz_1[j] + 0.5 * fl1_fx * (tg_z_yyyzz_0[j] - tg_z_yyyzz_1[j] * fl1_fza);

                    tg_xxz_yyzzz_0[j] = pb_x * tg_xz_yyzzz_0[j] + fr * tg_xz_yyzzz_1[j] + 0.5 * fl1_fx * (tg_z_yyzzz_0[j] - tg_z_yyzzz_1[j] * fl1_fza);

                    tg_xxz_yzzzz_0[j] = pb_x * tg_xz_yzzzz_0[j] + fr * tg_xz_yzzzz_1[j] + 0.5 * fl1_fx * (tg_z_yzzzz_0[j] - tg_z_yzzzz_1[j] * fl1_fza);

                    tg_xxz_zzzzz_0[j] = pb_x * tg_xz_zzzzz_0[j] + fr * tg_xz_zzzzz_1[j] + 0.5 * fl1_fx * (tg_z_zzzzz_0[j] - tg_z_zzzzz_1[j] * fl1_fza);

                    tg_xyy_xxxxx_0[j] = pb_x * tg_yy_xxxxx_0[j] + fr * tg_yy_xxxxx_1[j] + 2.5 * fl1_fxn * tg_yy_xxxx_1[j];

                    tg_xyy_xxxxy_0[j] = pb_x * tg_yy_xxxxy_0[j] + fr * tg_yy_xxxxy_1[j] + 2.0 * fl1_fxn * tg_yy_xxxy_1[j];

                    tg_xyy_xxxxz_0[j] = pb_x * tg_yy_xxxxz_0[j] + fr * tg_yy_xxxxz_1[j] + 2.0 * fl1_fxn * tg_yy_xxxz_1[j];

                    tg_xyy_xxxyy_0[j] = pb_x * tg_yy_xxxyy_0[j] + fr * tg_yy_xxxyy_1[j] + 1.5 * fl1_fxn * tg_yy_xxyy_1[j];

                    tg_xyy_xxxyz_0[j] = pb_x * tg_yy_xxxyz_0[j] + fr * tg_yy_xxxyz_1[j] + 1.5 * fl1_fxn * tg_yy_xxyz_1[j];

                    tg_xyy_xxxzz_0[j] = pb_x * tg_yy_xxxzz_0[j] + fr * tg_yy_xxxzz_1[j] + 1.5 * fl1_fxn * tg_yy_xxzz_1[j];

                    tg_xyy_xxyyy_0[j] = pb_x * tg_yy_xxyyy_0[j] + fr * tg_yy_xxyyy_1[j] + fl1_fxn * tg_yy_xyyy_1[j];
                }
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    ...
                    tg_xyy_xxyyz_0[j] = pb_x * tg_yy_xxyyz_0[j] + fr * tg_yy_xxyyz_1[j] + fl1_fxn * tg_yy_xyyz_1[j];

                    tg_xyy_xxyzz_0[j] = pb_x * tg_yy_xxyzz_0[j] + fr * tg_yy_xxyzz_1[j] + fl1_fxn * tg_yy_xyzz_1[j];

                    tg_xyy_xxzzz_0[j] = pb_x * tg_yy_xxzzz_0[j] + fr * tg_yy_xxzzz_1[j] + fl1_fxn * tg_yy_xzzz_1[j];

                    tg_xyy_xyyyy_0[j] = pb_x * tg_yy_xyyyy_0[j] + fr * tg_yy_xyyyy_1[j] + 0.5 * fl1_fxn * tg_yy_yyyy_1[j];

                    tg_xyy_xyyyz_0[j] = pb_x * tg_yy_xyyyz_0[j] + fr * tg_yy_xyyyz_1[j] + 0.5 * fl1_fxn * tg_yy_yyyz_1[j];

                    tg_xyy_xyyzz_0[j] = pb_x * tg_yy_xyyzz_0[j] + fr * tg_yy_xyyzz_1[j] + 0.5 * fl1_fxn * tg_yy_yyzz_1[j];

                    tg_xyy_xyzzz_0[j] = pb_x * tg_yy_xyzzz_0[j] + fr * tg_yy_xyzzz_1[j] + 0.5 * fl1_fxn * tg_yy_yzzz_1[j];

                    tg_xyy_xzzzz_0[j] = pb_x * tg_yy_xzzzz_0[j] + fr * tg_yy_xzzzz_1[j] + 0.5 * fl1_fxn * tg_yy_zzzz_1[j];

                    tg_xyy_yyyyy_0[j] = pb_x * tg_yy_yyyyy_0[j] + fr * tg_yy_yyyyy_1[j];

                    tg_xyy_yyyyz_0[j] = pb_x * tg_yy_yyyyz_0[j] + fr * tg_yy_yyyyz_1[j];

                    tg_xyy_yyyzz_0[j] = pb_x * tg_yy_yyyzz_0[j] + fr * tg_yy_yyyzz_1[j];

                    tg_xyy_yyzzz_0[j] = pb_x * tg_yy_yyzzz_0[j] + fr * tg_yy_yyzzz_1[j];

                    tg_xyy_yzzzz_0[j] = pb_x * tg_yy_yzzzz_0[j] + fr * tg_yy_yzzzz_1[j];

                    tg_xyy_zzzzz_0[j] = pb_x * tg_yy_zzzzz_0[j] + fr * tg_yy_zzzzz_1[j];

                    tg_xyz_xxxxx_0[j] = pb_x * tg_yz_xxxxx_0[j] + fr * tg_yz_xxxxx_1[j] + 2.5 * fl1_fxn * tg_yz_xxxx_1[j];

                    tg_xyz_xxxxy_0[j] = pb_x * tg_yz_xxxxy_0[j] + fr * tg_yz_xxxxy_1[j] + 2.0 * fl1_fxn * tg_yz_xxxy_1[j];

                    tg_xyz_xxxxz_0[j] = pb_x * tg_yz_xxxxz_0[j] + fr * tg_yz_xxxxz_1[j] + 2.0 * fl1_fxn * tg_yz_xxxz_1[j];

                    tg_xyz_xxxyy_0[j] = pb_x * tg_yz_xxxyy_0[j] + fr * tg_yz_xxxyy_1[j] + 1.5 * fl1_fxn * tg_yz_xxyy_1[j];

                    tg_xyz_xxxyz_0[j] = pb_x * tg_yz_xxxyz_0[j] + fr * tg_yz_xxxyz_1[j] + 1.5 * fl1_fxn * tg_yz_xxyz_1[j];

                    tg_xyz_xxxzz_0[j] = pb_x * tg_yz_xxxzz_0[j] + fr * tg_yz_xxxzz_1[j] + 1.5 * fl1_fxn * tg_yz_xxzz_1[j];

                    tg_xyz_xxyyy_0[j] = pb_x * tg_yz_xxyyy_0[j] + fr * tg_yz_xxyyy_1[j] + fl1_fxn * tg_yz_xyyy_1[j];

                    tg_xyz_xxyyz_0[j] = pb_x * tg_yz_xxyyz_0[j] + fr * tg_yz_xxyyz_1[j] + fl1_fxn * tg_yz_xyyz_1[j];

                    tg_xyz_xxyzz_0[j] = pb_x * tg_yz_xxyzz_0[j] + fr * tg_yz_xxyzz_1[j] + fl1_fxn * tg_yz_xyzz_1[j];

                    tg_xyz_xxzzz_0[j] = pb_x * tg_yz_xxzzz_0[j] + fr * tg_yz_xxzzz_1[j] + fl1_fxn * tg_yz_xzzz_1[j];

                    tg_xyz_xyyyy_0[j] = pb_x * tg_yz_xyyyy_0[j] + fr * tg_yz_xyyyy_1[j] + 0.5 * fl1_fxn * tg_yz_yyyy_1[j];

                    tg_xyz_xyyyz_0[j] = pb_x * tg_yz_xyyyz_0[j] + fr * tg_yz_xyyyz_1[j] + 0.5 * fl1_fxn * tg_yz_yyyz_1[j];

                    tg_xyz_xyyzz_0[j] = pb_x * tg_yz_xyyzz_0[j] + fr * tg_yz_xyyzz_1[j] + 0.5 * fl1_fxn * tg_yz_yyzz_1[j];

                    tg_xyz_xyzzz_0[j] = pb_x * tg_yz_xyzzz_0[j] + fr * tg_yz_xyzzz_1[j] + 0.5 * fl1_fxn * tg_yz_yzzz_1[j];

                    tg_xyz_xzzzz_0[j] = pb_x * tg_yz_xzzzz_0[j] + fr * tg_yz_xzzzz_1[j] + 0.5 * fl1_fxn * tg_yz_zzzz_1[j];

                    tg_xyz_yyyyy_0[j] = pb_x * tg_yz_yyyyy_0[j] + fr * tg_yz_yyyyy_1[j];

                    tg_xyz_yyyyz_0[j] = pb_x * tg_yz_yyyyz_0[j] + fr * tg_yz_yyyyz_1[j];

                    tg_xyz_yyyzz_0[j] = pb_x * tg_yz_yyyzz_0[j] + fr * tg_yz_yyyzz_1[j];

                    tg_xyz_yyzzz_0[j] = pb_x * tg_yz_yyzzz_0[j] + fr * tg_yz_yyzzz_1[j];

                    tg_xyz_yzzzz_0[j] = pb_x * tg_yz_yzzzz_0[j] + fr * tg_yz_yzzzz_1[j];

                    tg_xyz_zzzzz_0[j] = pb_x * tg_yz_zzzzz_0[j] + fr * tg_yz_zzzzz_1[j];

                    tg_xzz_xxxxx_0[j] = pb_x * tg_zz_xxxxx_0[j] + fr * tg_zz_xxxxx_1[j] + 2.5 * fl1_fxn * tg_zz_xxxx_1[j];

                    tg_xzz_xxxxy_0[j] = pb_x * tg_zz_xxxxy_0[j] + fr * tg_zz_xxxxy_1[j] + 2.0 * fl1_fxn * tg_zz_xxxy_1[j];

                    tg_xzz_xxxxz_0[j] = pb_x * tg_zz_xxxxz_0[j] + fr * tg_zz_xxxxz_1[j] + 2.0 * fl1_fxn * tg_zz_xxxz_1[j];

                    tg_xzz_xxxyy_0[j] = pb_x * tg_zz_xxxyy_0[j] + fr * tg_zz_xxxyy_1[j] + 1.5 * fl1_fxn * tg_zz_xxyy_1[j];

                    tg_xzz_xxxyz_0[j] = pb_x * tg_zz_xxxyz_0[j] + fr * tg_zz_xxxyz_1[j] + 1.5 * fl1_fxn * tg_zz_xxyz_1[j];

                    tg_xzz_xxxzz_0[j] = pb_x * tg_zz_xxxzz_0[j] + fr * tg_zz_xxxzz_1[j] + 1.5 * fl1_fxn * tg_zz_xxzz_1[j];

                    tg_xzz_xxyyy_0[j] = pb_x * tg_zz_xxyyy_0[j] + fr * tg_zz_xxyyy_1[j] + fl1_fxn * tg_zz_xyyy_1[j];

                    tg_xzz_xxyyz_0[j] = pb_x * tg_zz_xxyyz_0[j] + fr * tg_zz_xxyyz_1[j] + fl1_fxn * tg_zz_xyyz_1[j];

                    tg_xzz_xxyzz_0[j] = pb_x * tg_zz_xxyzz_0[j] + fr * tg_zz_xxyzz_1[j] + fl1_fxn * tg_zz_xyzz_1[j];

                    tg_xzz_xxzzz_0[j] = pb_x * tg_zz_xxzzz_0[j] + fr * tg_zz_xxzzz_1[j] + fl1_fxn * tg_zz_xzzz_1[j];

                    tg_xzz_xyyyy_0[j] = pb_x * tg_zz_xyyyy_0[j] + fr * tg_zz_xyyyy_1[j] + 0.5 * fl1_fxn * tg_zz_yyyy_1[j];

                    tg_xzz_xyyyz_0[j] = pb_x * tg_zz_xyyyz_0[j] + fr * tg_zz_xyyyz_1[j] + 0.5 * fl1_fxn * tg_zz_yyyz_1[j];

                    tg_xzz_xyyzz_0[j] = pb_x * tg_zz_xyyzz_0[j] + fr * tg_zz_xyyzz_1[j] + 0.5 * fl1_fxn * tg_zz_yyzz_1[j];

                    tg_xzz_xyzzz_0[j] = pb_x * tg_zz_xyzzz_0[j] + fr * tg_zz_xyzzz_1[j] + 0.5 * fl1_fxn * tg_zz_yzzz_1[j];

                    tg_xzz_xzzzz_0[j] = pb_x * tg_zz_xzzzz_0[j] + fr * tg_zz_xzzzz_1[j] + 0.5 * fl1_fxn * tg_zz_zzzz_1[j];

                    tg_xzz_yyyyy_0[j] = pb_x * tg_zz_yyyyy_0[j] + fr * tg_zz_yyyyy_1[j];

                    tg_xzz_yyyyz_0[j] = pb_x * tg_zz_yyyyz_0[j] + fr * tg_zz_yyyyz_1[j];

                    tg_xzz_yyyzz_0[j] = pb_x * tg_zz_yyyzz_0[j] + fr * tg_zz_yyyzz_1[j];

                    tg_xzz_yyzzz_0[j] = pb_x * tg_zz_yyzzz_0[j] + fr * tg_zz_yyzzz_1[j];

                    tg_xzz_yzzzz_0[j] = pb_x * tg_zz_yzzzz_0[j] + fr * tg_zz_yzzzz_1[j];

                    tg_xzz_zzzzz_0[j] = pb_x * tg_zz_zzzzz_0[j] + fr * tg_zz_zzzzz_1[j];

                    fr = wp_y[j]; 

                    tg_yyy_xxxxx_0[j] = pb_y * tg_yy_xxxxx_0[j] + fr * tg_yy_xxxxx_1[j] + fl1_fx * (tg_y_xxxxx_0[j] - tg_y_xxxxx_1[j] * fl1_fza);

                    tg_yyy_xxxxy_0[j] = pb_y * tg_yy_xxxxy_0[j] + fr * tg_yy_xxxxy_1[j] + fl1_fx * (tg_y_xxxxy_0[j] - tg_y_xxxxy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yy_xxxx_1[j];

                    tg_yyy_xxxxz_0[j] = pb_y * tg_yy_xxxxz_0[j] + fr * tg_yy_xxxxz_1[j] + fl1_fx * (tg_y_xxxxz_0[j] - tg_y_xxxxz_1[j] * fl1_fza);

                    tg_yyy_xxxyy_0[j] = pb_y * tg_yy_xxxyy_0[j] + fr * tg_yy_xxxyy_1[j] + fl1_fx * (tg_y_xxxyy_0[j] - tg_y_xxxyy_1[j] * fl1_fza) + fl1_fxn * tg_yy_xxxy_1[j];

                    tg_yyy_xxxyz_0[j] = pb_y * tg_yy_xxxyz_0[j] + fr * tg_yy_xxxyz_1[j] + fl1_fx * (tg_y_xxxyz_0[j] - tg_y_xxxyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yy_xxxz_1[j];

                    tg_yyy_xxxzz_0[j] = pb_y * tg_yy_xxxzz_0[j] + fr * tg_yy_xxxzz_1[j] + fl1_fx * (tg_y_xxxzz_0[j] - tg_y_xxxzz_1[j] * fl1_fza);

                    tg_yyy_xxyyy_0[j] = pb_y * tg_yy_xxyyy_0[j] + fr * tg_yy_xxyyy_1[j] + fl1_fx * (tg_y_xxyyy_0[j] - tg_y_xxyyy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yy_xxyy_1[j];

                    tg_yyy_xxyyz_0[j] = pb_y * tg_yy_xxyyz_0[j] + fr * tg_yy_xxyyz_1[j] + fl1_fx * (tg_y_xxyyz_0[j] - tg_y_xxyyz_1[j] * fl1_fza) + fl1_fxn * tg_yy_xxyz_1[j];

                    tg_yyy_xxyzz_0[j] = pb_y * tg_yy_xxyzz_0[j] + fr * tg_yy_xxyzz_1[j] + fl1_fx * (tg_y_xxyzz_0[j] - tg_y_xxyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yy_xxzz_1[j];

                    tg_yyy_xxzzz_0[j] = pb_y * tg_yy_xxzzz_0[j] + fr * tg_yy_xxzzz_1[j] + fl1_fx * (tg_y_xxzzz_0[j] - tg_y_xxzzz_1[j] * fl1_fza);

                    tg_yyy_xyyyy_0[j] = pb_y * tg_yy_xyyyy_0[j] + fr * tg_yy_xyyyy_1[j] + fl1_fx * (tg_y_xyyyy_0[j] - tg_y_xyyyy_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_yy_xyyy_1[j];

                    tg_yyy_xyyyz_0[j] = pb_y * tg_yy_xyyyz_0[j] + fr * tg_yy_xyyyz_1[j] + fl1_fx * (tg_y_xyyyz_0[j] - tg_y_xyyyz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yy_xyyz_1[j];

                    tg_yyy_xyyzz_0[j] = pb_y * tg_yy_xyyzz_0[j] + fr * tg_yy_xyyzz_1[j] + fl1_fx * (tg_y_xyyzz_0[j] - tg_y_xyyzz_1[j] * fl1_fza) + fl1_fxn * tg_yy_xyzz_1[j];

                    tg_yyy_xyzzz_0[j] = pb_y * tg_yy_xyzzz_0[j] + fr * tg_yy_xyzzz_1[j] + fl1_fx * (tg_y_xyzzz_0[j] - tg_y_xyzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yy_xzzz_1[j];
                }
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    ...
                    tg_yyy_xzzzz_0[j] = pb_y * tg_yy_xzzzz_0[j] + fr * tg_yy_xzzzz_1[j] + fl1_fx * (tg_y_xzzzz_0[j] - tg_y_xzzzz_1[j] * fl1_fza);

                    tg_yyy_yyyyy_0[j] = pb_y * tg_yy_yyyyy_0[j] + fr * tg_yy_yyyyy_1[j] + fl1_fx * (tg_y_yyyyy_0[j] - tg_y_yyyyy_1[j] * fl1_fza) + 2.5 * fl1_fxn * tg_yy_yyyy_1[j];

                    tg_yyy_yyyyz_0[j] = pb_y * tg_yy_yyyyz_0[j] + fr * tg_yy_yyyyz_1[j] + fl1_fx * (tg_y_yyyyz_0[j] - tg_y_yyyyz_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_yy_yyyz_1[j];

                    tg_yyy_yyyzz_0[j] = pb_y * tg_yy_yyyzz_0[j] + fr * tg_yy_yyyzz_1[j] + fl1_fx * (tg_y_yyyzz_0[j] - tg_y_yyyzz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yy_yyzz_1[j];

                    tg_yyy_yyzzz_0[j] = pb_y * tg_yy_yyzzz_0[j] + fr * tg_yy_yyzzz_1[j] + fl1_fx * (tg_y_yyzzz_0[j] - tg_y_yyzzz_1[j] * fl1_fza) + fl1_fxn * tg_yy_yzzz_1[j];

                    tg_yyy_yzzzz_0[j] = pb_y * tg_yy_yzzzz_0[j] + fr * tg_yy_yzzzz_1[j] + fl1_fx * (tg_y_yzzzz_0[j] - tg_y_yzzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yy_zzzz_1[j];

                    tg_yyy_zzzzz_0[j] = pb_y * tg_yy_zzzzz_0[j] + fr * tg_yy_zzzzz_1[j] + fl1_fx * (tg_y_zzzzz_0[j] - tg_y_zzzzz_1[j] * fl1_fza);

                    tg_yyz_xxxxx_0[j] = pb_y * tg_yz_xxxxx_0[j] + fr * tg_yz_xxxxx_1[j] + 0.5 * fl1_fx * (tg_z_xxxxx_0[j] - tg_z_xxxxx_1[j] * fl1_fza);

                    tg_yyz_xxxxy_0[j] = pb_y * tg_yz_xxxxy_0[j] + fr * tg_yz_xxxxy_1[j] + 0.5 * fl1_fx * (tg_z_xxxxy_0[j] - tg_z_xxxxy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yz_xxxx_1[j];

                    tg_yyz_xxxxz_0[j] = pb_y * tg_yz_xxxxz_0[j] + fr * tg_yz_xxxxz_1[j] + 0.5 * fl1_fx * (tg_z_xxxxz_0[j] - tg_z_xxxxz_1[j] * fl1_fza);

                    tg_yyz_xxxyy_0[j] = pb_y * tg_yz_xxxyy_0[j] + fr * tg_yz_xxxyy_1[j] + 0.5 * fl1_fx * (tg_z_xxxyy_0[j] - tg_z_xxxyy_1[j] * fl1_fza) + fl1_fxn * tg_yz_xxxy_1[j];

                    tg_yyz_xxxyz_0[j] = pb_y * tg_yz_xxxyz_0[j] + fr * tg_yz_xxxyz_1[j] + 0.5 * fl1_fx * (tg_z_xxxyz_0[j] - tg_z_xxxyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yz_xxxz_1[j];

                    tg_yyz_xxxzz_0[j] = pb_y * tg_yz_xxxzz_0[j] + fr * tg_yz_xxxzz_1[j] + 0.5 * fl1_fx * (tg_z_xxxzz_0[j] - tg_z_xxxzz_1[j] * fl1_fza);

                    tg_yyz_xxyyy_0[j] = pb_y * tg_yz_xxyyy_0[j] + fr * tg_yz_xxyyy_1[j] + 0.5 * fl1_fx * (tg_z_xxyyy_0[j] - tg_z_xxyyy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yz_xxyy_1[j];

                    tg_yyz_xxyyz_0[j] = pb_y * tg_yz_xxyyz_0[j] + fr * tg_yz_xxyyz_1[j] + 0.5 * fl1_fx * (tg_z_xxyyz_0[j] - tg_z_xxyyz_1[j] * fl1_fza) + fl1_fxn * tg_yz_xxyz_1[j];

                    tg_yyz_xxyzz_0[j] = pb_y * tg_yz_xxyzz_0[j] + fr * tg_yz_xxyzz_1[j] + 0.5 * fl1_fx * (tg_z_xxyzz_0[j] - tg_z_xxyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yz_xxzz_1[j];

                    tg_yyz_xxzzz_0[j] = pb_y * tg_yz_xxzzz_0[j] + fr * tg_yz_xxzzz_1[j] + 0.5 * fl1_fx * (tg_z_xxzzz_0[j] - tg_z_xxzzz_1[j] * fl1_fza);

                    tg_yyz_xyyyy_0[j] = pb_y * tg_yz_xyyyy_0[j] + fr * tg_yz_xyyyy_1[j] + 0.5 * fl1_fx * (tg_z_xyyyy_0[j] - tg_z_xyyyy_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_yz_xyyy_1[j];

                    tg_yyz_xyyyz_0[j] = pb_y * tg_yz_xyyyz_0[j] + fr * tg_yz_xyyyz_1[j] + 0.5 * fl1_fx * (tg_z_xyyyz_0[j] - tg_z_xyyyz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yz_xyyz_1[j];

                    tg_yyz_xyyzz_0[j] = pb_y * tg_yz_xyyzz_0[j] + fr * tg_yz_xyyzz_1[j] + 0.5 * fl1_fx * (tg_z_xyyzz_0[j] - tg_z_xyyzz_1[j] * fl1_fza) + fl1_fxn * tg_yz_xyzz_1[j];

                    tg_yyz_xyzzz_0[j] = pb_y * tg_yz_xyzzz_0[j] + fr * tg_yz_xyzzz_1[j] + 0.5 * fl1_fx * (tg_z_xyzzz_0[j] - tg_z_xyzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yz_xzzz_1[j];

                    tg_yyz_xzzzz_0[j] = pb_y * tg_yz_xzzzz_0[j] + fr * tg_yz_xzzzz_1[j] + 0.5 * fl1_fx * (tg_z_xzzzz_0[j] - tg_z_xzzzz_1[j] * fl1_fza);

                    tg_yyz_yyyyy_0[j] = pb_y * tg_yz_yyyyy_0[j] + fr * tg_yz_yyyyy_1[j] + 0.5 * fl1_fx * (tg_z_yyyyy_0[j] - tg_z_yyyyy_1[j] * fl1_fza) + 2.5 * fl1_fxn * tg_yz_yyyy_1[j];

                    tg_yyz_yyyyz_0[j] = pb_y * tg_yz_yyyyz_0[j] + fr * tg_yz_yyyyz_1[j] + 0.5 * fl1_fx * (tg_z_yyyyz_0[j] - tg_z_yyyyz_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_yz_yyyz_1[j];

                    tg_yyz_yyyzz_0[j] = pb_y * tg_yz_yyyzz_0[j] + fr * tg_yz_yyyzz_1[j] + 0.5 * fl1_fx * (tg_z_yyyzz_0[j] - tg_z_yyyzz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yz_yyzz_1[j];

                    tg_yyz_yyzzz_0[j] = pb_y * tg_yz_yyzzz_0[j] + fr * tg_yz_yyzzz_1[j] + 0.5 * fl1_fx * (tg_z_yyzzz_0[j] - tg_z_yyzzz_1[j] * fl1_fza) + fl1_fxn * tg_yz_yzzz_1[j];

                    tg_yyz_yzzzz_0[j] = pb_y * tg_yz_yzzzz_0[j] + fr * tg_yz_yzzzz_1[j] + 0.5 * fl1_fx * (tg_z_yzzzz_0[j] - tg_z_yzzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yz_zzzz_1[j];

                    tg_yyz_zzzzz_0[j] = pb_y * tg_yz_zzzzz_0[j] + fr * tg_yz_zzzzz_1[j] + 0.5 * fl1_fx * (tg_z_zzzzz_0[j] - tg_z_zzzzz_1[j] * fl1_fza);

                    tg_yzz_xxxxx_0[j] = pb_y * tg_zz_xxxxx_0[j] + fr * tg_zz_xxxxx_1[j];

                    tg_yzz_xxxxy_0[j] = pb_y * tg_zz_xxxxy_0[j] + fr * tg_zz_xxxxy_1[j] + 0.5 * fl1_fxn * tg_zz_xxxx_1[j];

                    tg_yzz_xxxxz_0[j] = pb_y * tg_zz_xxxxz_0[j] + fr * tg_zz_xxxxz_1[j];

                    tg_yzz_xxxyy_0[j] = pb_y * tg_zz_xxxyy_0[j] + fr * tg_zz_xxxyy_1[j] + fl1_fxn * tg_zz_xxxy_1[j];

                    tg_yzz_xxxyz_0[j] = pb_y * tg_zz_xxxyz_0[j] + fr * tg_zz_xxxyz_1[j] + 0.5 * fl1_fxn * tg_zz_xxxz_1[j];

                    tg_yzz_xxxzz_0[j] = pb_y * tg_zz_xxxzz_0[j] + fr * tg_zz_xxxzz_1[j];

                    tg_yzz_xxyyy_0[j] = pb_y * tg_zz_xxyyy_0[j] + fr * tg_zz_xxyyy_1[j] + 1.5 * fl1_fxn * tg_zz_xxyy_1[j];

                    tg_yzz_xxyyz_0[j] = pb_y * tg_zz_xxyyz_0[j] + fr * tg_zz_xxyyz_1[j] + fl1_fxn * tg_zz_xxyz_1[j];

                    tg_yzz_xxyzz_0[j] = pb_y * tg_zz_xxyzz_0[j] + fr * tg_zz_xxyzz_1[j] + 0.5 * fl1_fxn * tg_zz_xxzz_1[j];

                    tg_yzz_xxzzz_0[j] = pb_y * tg_zz_xxzzz_0[j] + fr * tg_zz_xxzzz_1[j];

                    tg_yzz_xyyyy_0[j] = pb_y * tg_zz_xyyyy_0[j] + fr * tg_zz_xyyyy_1[j] + 2.0 * fl1_fxn * tg_zz_xyyy_1[j];

                    tg_yzz_xyyyz_0[j] = pb_y * tg_zz_xyyyz_0[j] + fr * tg_zz_xyyyz_1[j] + 1.5 * fl1_fxn * tg_zz_xyyz_1[j];

                    tg_yzz_xyyzz_0[j] = pb_y * tg_zz_xyyzz_0[j] + fr * tg_zz_xyyzz_1[j] + fl1_fxn * tg_zz_xyzz_1[j];

                    tg_yzz_xyzzz_0[j] = pb_y * tg_zz_xyzzz_0[j] + fr * tg_zz_xyzzz_1[j] + 0.5 * fl1_fxn * tg_zz_xzzz_1[j];

                    tg_yzz_xzzzz_0[j] = pb_y * tg_zz_xzzzz_0[j] + fr * tg_zz_xzzzz_1[j];

                    tg_yzz_yyyyy_0[j] = pb_y * tg_zz_yyyyy_0[j] + fr * tg_zz_yyyyy_1[j] + 2.5 * fl1_fxn * tg_zz_yyyy_1[j];

                    tg_yzz_yyyyz_0[j] = pb_y * tg_zz_yyyyz_0[j] + fr * tg_zz_yyyyz_1[j] + 2.0 * fl1_fxn * tg_zz_yyyz_1[j];

                    tg_yzz_yyyzz_0[j] = pb_y * tg_zz_yyyzz_0[j] + fr * tg_zz_yyyzz_1[j] + 1.5 * fl1_fxn * tg_zz_yyzz_1[j];

                    tg_yzz_yyzzz_0[j] = pb_y * tg_zz_yyzzz_0[j] + fr * tg_zz_yyzzz_1[j] + fl1_fxn * tg_zz_yzzz_1[j];

                    tg_yzz_yzzzz_0[j] = pb_y * tg_zz_yzzzz_0[j] + fr * tg_zz_yzzzz_1[j] + 0.5 * fl1_fxn * tg_zz_zzzz_1[j];

                    tg_yzz_zzzzz_0[j] = pb_y * tg_zz_zzzzz_0[j] + fr * tg_zz_zzzzz_1[j];

                    fr = wp_z[j]; 

                    tg_zzz_xxxxx_0[j] = pb_z * tg_zz_xxxxx_0[j] + fr * tg_zz_xxxxx_1[j] + fl1_fx * (tg_z_xxxxx_0[j] - tg_z_xxxxx_1[j] * fl1_fza);

                    tg_zzz_xxxxy_0[j] = pb_z * tg_zz_xxxxy_0[j] + fr * tg_zz_xxxxy_1[j] + fl1_fx * (tg_z_xxxxy_0[j] - tg_z_xxxxy_1[j] * fl1_fza);

                    tg_zzz_xxxxz_0[j] = pb_z * tg_zz_xxxxz_0[j] + fr * tg_zz_xxxxz_1[j] + fl1_fx * (tg_z_xxxxz_0[j] - tg_z_xxxxz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_zz_xxxx_1[j];

                    tg_zzz_xxxyy_0[j] = pb_z * tg_zz_xxxyy_0[j] + fr * tg_zz_xxxyy_1[j] + fl1_fx * (tg_z_xxxyy_0[j] - tg_z_xxxyy_1[j] * fl1_fza);

                    tg_zzz_xxxyz_0[j] = pb_z * tg_zz_xxxyz_0[j] + fr * tg_zz_xxxyz_1[j] + fl1_fx * (tg_z_xxxyz_0[j] - tg_z_xxxyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_zz_xxxy_1[j];

                    tg_zzz_xxxzz_0[j] = pb_z * tg_zz_xxxzz_0[j] + fr * tg_zz_xxxzz_1[j] + fl1_fx * (tg_z_xxxzz_0[j] - tg_z_xxxzz_1[j] * fl1_fza) + fl1_fxn * tg_zz_xxxz_1[j];

                    tg_zzz_xxyyy_0[j] = pb_z * tg_zz_xxyyy_0[j] + fr * tg_zz_xxyyy_1[j] + fl1_fx * (tg_z_xxyyy_0[j] - tg_z_xxyyy_1[j] * fl1_fza);

                    tg_zzz_xxyyz_0[j] = pb_z * tg_zz_xxyyz_0[j] + fr * tg_zz_xxyyz_1[j] + fl1_fx * (tg_z_xxyyz_0[j] - tg_z_xxyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_zz_xxyy_1[j];

                    tg_zzz_xxyzz_0[j] = pb_z * tg_zz_xxyzz_0[j] + fr * tg_zz_xxyzz_1[j] + fl1_fx * (tg_z_xxyzz_0[j] - tg_z_xxyzz_1[j] * fl1_fza) + fl1_fxn * tg_zz_xxyz_1[j];

                    tg_zzz_xxzzz_0[j] = pb_z * tg_zz_xxzzz_0[j] + fr * tg_zz_xxzzz_1[j] + fl1_fx * (tg_z_xxzzz_0[j] - tg_z_xxzzz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_zz_xxzz_1[j];

                    tg_zzz_xyyyy_0[j] = pb_z * tg_zz_xyyyy_0[j] + fr * tg_zz_xyyyy_1[j] + fl1_fx * (tg_z_xyyyy_0[j] - tg_z_xyyyy_1[j] * fl1_fza);

                    tg_zzz_xyyyz_0[j] = pb_z * tg_zz_xyyyz_0[j] + fr * tg_zz_xyyyz_1[j] + fl1_fx * (tg_z_xyyyz_0[j] - tg_z_xyyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_zz_xyyy_1[j];

                    tg_zzz_xyyzz_0[j] = pb_z * tg_zz_xyyzz_0[j] + fr * tg_zz_xyyzz_1[j] + fl1_fx * (tg_z_xyyzz_0[j] - tg_z_xyyzz_1[j] * fl1_fza) + fl1_fxn * tg_zz_xyyz_1[j];

                    tg_zzz_xyzzz_0[j] = pb_z * tg_zz_xyzzz_0[j] + fr * tg_zz_xyzzz_1[j] + fl1_fx * (tg_z_xyzzz_0[j] - tg_z_xyzzz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_zz_xyzz_1[j];

                    tg_zzz_xzzzz_0[j] = pb_z * tg_zz_xzzzz_0[j] + fr * tg_zz_xzzzz_1[j] + fl1_fx * (tg_z_xzzzz_0[j] - tg_z_xzzzz_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_zz_xzzz_1[j];

                    tg_zzz_yyyyy_0[j] = pb_z * tg_zz_yyyyy_0[j] + fr * tg_zz_yyyyy_1[j] + fl1_fx * (tg_z_yyyyy_0[j] - tg_z_yyyyy_1[j] * fl1_fza);

                    tg_zzz_yyyyz_0[j] = pb_z * tg_zz_yyyyz_0[j] + fr * tg_zz_yyyyz_1[j] + fl1_fx * (tg_z_yyyyz_0[j] - tg_z_yyyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_zz_yyyy_1[j];

                    tg_zzz_yyyzz_0[j] = pb_z * tg_zz_yyyzz_0[j] + fr * tg_zz_yyyzz_1[j] + fl1_fx * (tg_z_yyyzz_0[j] - tg_z_yyyzz_1[j] * fl1_fza) + fl1_fxn * tg_zz_yyyz_1[j];

                    tg_zzz_yyzzz_0[j] = pb_z * tg_zz_yyzzz_0[j] + fr * tg_zz_yyzzz_1[j] + fl1_fx * (tg_z_yyzzz_0[j] - tg_z_yyzzz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_zz_yyzz_1[j];

                    tg_zzz_yzzzz_0[j] = pb_z * tg_zz_yzzzz_0[j] + fr * tg_zz_yzzzz_1[j] + fl1_fx * (tg_z_yzzzz_0[j] - tg_z_yzzzz_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_zz_yzzz_1[j];

                    tg_zzz_zzzzz_0[j] = pb_z * tg_zz_zzzzz_0[j] + fr * tg_zz_zzzzz_1[j] + fl1_fx * (tg_z_zzzzz_0[j] - tg_z_zzzzz_1[j] * fl1_fza) + 2.5 * fl1_fxn * tg_zz_zzzz_1[j];
                }
