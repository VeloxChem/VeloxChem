...
namespace erirecfunc { // erirecfunc namespace
    ...
    compElectronRepulsionForSPSH(      CMemBlock2D<double>& primBuffer,
                                 ...
                                 const int32_t              iContrPair)
    {
        erirecfunc::compElectronRepulsionForSPSH_0_32(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      wpDistances, 
                                                      braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSPSH_32_63(primBuffer,
                                                       recursionMap,
                                                       osFactors,
                                                       wpDistances, 
                                                       braGtoPairsBlock,
    ...
    void
    compElectronRepulsionForSPSH_0_32(      CMemBlock2D<double>& primBuffer,
                                      const CRecursionMap&       recursionMap,
                                      const CMemBlock2D<double>& osFactors,
                                      const CMemBlock2D<double>& wpDistances,
                                      const CGtoPairsBlock&      braGtoPairsBlock,
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, tg_0_xxxx_1, tg_0_xxxxx_0, tg_0_xxxxx_1, tg_0_xxxxy_0, \
                                         ...
                                         tg_y_xyyyy_0, wp_x, wp_y: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fxn = fxn[j];
    ...
    void
    compElectronRepulsionForSPSH_32_63(      CMemBlock2D<double>& primBuffer,
                                       const CRecursionMap&       recursionMap,
                                       const CMemBlock2D<double>& osFactors,
                                       const CMemBlock2D<double>& wpDistances,
                                       const CGtoPairsBlock&      braGtoPairsBlock,
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, tg_0_xxxx_1, tg_0_xxxxx_0, tg_0_xxxxx_1, tg_0_xxxxy_0, \
                                         ...
                                         tg_0_yyyy_1, tg_0_yyyyy_0, tg_0_yyyyy_1, tg_0_yyyyz_0, tg_0_yyyyz_1, tg_0_yyyz_1, \
                                         tg_0_yyyzz_0, tg_0_yyyzz_1, tg_0_yyzz_1, tg_0_yyzzz_0, tg_0_yyzzz_1, tg_0_yzzz_1, \
                                         tg_0_yzzzz_0, tg_0_yzzzz_1, tg_0_zzzz_1, tg_0_zzzzz_0, tg_0_zzzzz_1, tg_y_xyyyz_0, \
                                         tg_y_xyyzz_0, tg_y_xyzzz_0, tg_y_xzzzz_0, tg_y_yyyyy_0, tg_y_yyyyz_0, tg_y_yyyzz_0, \
                                         tg_y_yyzzz_0, tg_y_yzzzz_0, tg_y_zzzzz_0, tg_z_xxxxx_0, tg_z_xxxxy_0, tg_z_xxxxz_0, \
                                         tg_z_xxxyy_0, tg_z_xxxyz_0, tg_z_xxxzz_0, tg_z_xxyyy_0, tg_z_xxyyz_0, tg_z_xxyzz_0, \
                                         tg_z_xxzzz_0, tg_z_xyyyy_0, tg_z_xyyyz_0, tg_z_xyyzz_0, tg_z_xyzzz_0, tg_z_xzzzz_0, \
                                         tg_z_yyyyy_0, tg_z_yyyyz_0, tg_z_yyyzz_0, tg_z_yyzzz_0, tg_z_yzzzz_0, tg_z_zzzzz_0, \
                                         wp_y, wp_z: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fxn = fxn[j];
    ...
    compElectronRepulsionForSHSP(      CMemBlock2D<double>& primBuffer,
                                 ...
                                 const int32_t              iContrPair)
    {
        erirecfunc::compElectronRepulsionForSHSP_0_32(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      wpDistances, 
                                                      braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSHSP_32_63(primBuffer,
                                                       recursionMap,
                                                       osFactors,
                                                       wpDistances, 
                                                       braGtoPairsBlock,
    ...
    void
    compElectronRepulsionForSHSP_0_32(      CMemBlock2D<double>& primBuffer,
                                      const CRecursionMap&       recursionMap,
                                      const CMemBlock2D<double>& osFactors,
                                      const CMemBlock2D<double>& wpDistances,
                                      const CGtoPairsBlock&      braGtoPairsBlock,
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, fza, tg_xxx_x_0, tg_xxx_x_1, tg_xxx_y_0, tg_xxx_y_1, tg_xxx_z_0, \
                                         ...
                                         tg_xyyy_z_1, tg_xyyyy_x_0, tg_xyyyy_y_0, tg_xyyz_0_1, tg_xyyz_x_0, tg_xyyz_x_1, \
                                         tg_xyyz_y_0, tg_xyyz_y_1, tg_xyyz_z_0, tg_xyyz_z_1, tg_xyz_x_0, tg_xyz_x_1, \
                                         tg_xyz_y_0, tg_xyz_y_1, tg_xyz_z_0, tg_xyz_z_1, tg_xyzz_0_1, tg_xyzz_x_0, \
                                         tg_xyzz_x_1, tg_xyzz_y_0, tg_xyzz_y_1, tg_xyzz_z_0, tg_xyzz_z_1, tg_xzz_x_0, \
                                         tg_xzz_x_1, tg_xzz_y_0, tg_xzz_y_1, tg_xzz_z_0, tg_xzz_z_1, tg_xzzz_0_1, \
                                         tg_xzzz_x_0, tg_xzzz_x_1, tg_xzzz_y_0, tg_xzzz_y_1, tg_xzzz_z_0, tg_xzzz_z_1, \
                                         tg_yyy_x_0, tg_yyy_x_1, tg_yyy_y_0, tg_yyy_y_1, tg_yyy_z_0, tg_yyy_z_1, \
                                         tg_yyyy_0_1, tg_yyyy_x_0, tg_yyyy_x_1, tg_yyyy_y_0, tg_yyyy_y_1, tg_yyz_x_0, \
                                         tg_yyz_x_1, tg_yyz_y_0, tg_yyz_y_1, tg_yyz_z_0, tg_yyz_z_1, tg_yzz_x_0, tg_yzz_x_1, \
                                         tg_yzz_y_0, tg_yzz_y_1, tg_yzz_z_0, tg_yzz_z_1, tg_zzz_x_0, tg_zzz_x_1, tg_zzz_y_0, \
                                         tg_zzz_y_1, tg_zzz_z_0, tg_zzz_z_1, wp_x: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fx = fx;
    ...
    void
    compElectronRepulsionForSHSP_32_63(      CMemBlock2D<double>& primBuffer,
                                       const CRecursionMap&       recursionMap,
                                       const CMemBlock2D<double>& osFactors,
                                       const CMemBlock2D<double>& wpDistances,
                                       const CGtoPairsBlock&      braGtoPairsBlock,
                                       ...
                                       const int32_t              iContrPair)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, fza, tg_xyyyy_z_0, tg_xyyyz_x_0, tg_xyyyz_y_0, tg_xyyyz_z_0, \
                                         tg_xyyzz_x_0, tg_xyyzz_y_0, tg_xyyzz_z_0, tg_xyzzz_x_0, tg_xyzzz_y_0, tg_xyzzz_z_0, \
                                         tg_xzzzz_x_0, tg_xzzzz_y_0, tg_xzzzz_z_0, tg_yyy_x_0, tg_yyy_x_1, tg_yyy_y_0, \
                                         tg_yyy_y_1, tg_yyy_z_0, tg_yyy_z_1, tg_yyyy_0_1, tg_yyyy_x_0, tg_yyyy_x_1, \
                                         tg_yyyy_y_0, tg_yyyy_y_1, tg_yyyy_z_0, tg_yyyy_z_1, tg_yyyyy_x_0, tg_yyyyy_y_0, \
                                         tg_yyyyy_z_0, tg_yyyyz_x_0, tg_yyyyz_y_0, tg_yyyyz_z_0, tg_yyyz_0_1, tg_yyyz_x_0, \
                                         tg_yyyz_x_1, tg_yyyz_y_0, tg_yyyz_y_1, tg_yyyz_z_0, tg_yyyz_z_1, tg_yyyzz_x_0, \
                                         tg_yyyzz_y_0, tg_yyyzz_z_0, tg_yyz_x_0, tg_yyz_x_1, tg_yyz_y_0, tg_yyz_y_1, \
                                         tg_yyz_z_0, tg_yyz_z_1, tg_yyzz_0_1, tg_yyzz_x_0, tg_yyzz_x_1, tg_yyzz_y_0, \
                                         tg_yyzz_y_1, tg_yyzz_z_0, tg_yyzz_z_1, tg_yyzzz_x_0, tg_yyzzz_y_0, tg_yyzzz_z_0, \
                                         tg_yzz_x_0, tg_yzz_x_1, tg_yzz_y_0, tg_yzz_y_1, tg_yzz_z_0, tg_yzz_z_1, \
                                         tg_yzzz_0_1, tg_yzzz_x_0, tg_yzzz_x_1, tg_yzzz_y_0, tg_yzzz_y_1, tg_yzzz_z_0, \
                                         tg_yzzz_z_1, tg_yzzzz_x_0, tg_yzzzz_y_0, tg_yzzzz_z_0, tg_zzz_x_0, tg_zzz_x_1, \
                                         tg_zzz_y_0, tg_zzz_y_1, tg_zzz_z_0, tg_zzz_z_1, tg_zzzz_0_1, tg_zzzz_x_0, \
                                         tg_zzzz_x_1, tg_zzzz_y_0, tg_zzzz_y_1, tg_zzzz_z_0, tg_zzzz_z_1, tg_zzzzz_x_0, \
                                         tg_zzzzz_y_0, tg_zzzzz_z_0, wp_x, wp_y, wp_z: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fx = fx;
    ...
    compElectronRepulsionForSPSI(      CMemBlock2D<double>& primBuffer,
                                 ...
                                 const int32_t              iContrPair)
    {
        erirecfunc::compElectronRepulsionForSPSI_0_42(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      wpDistances, 
                                                      braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSPSI_42_84(primBuffer,
                                                       recursionMap,
                                                       osFactors,
                                                       wpDistances, 
                                                       braGtoPairsBlock,
    ...
    void
    compElectronRepulsionForSPSI_0_42(      CMemBlock2D<double>& primBuffer,
                                      const CRecursionMap&       recursionMap,
                                      const CMemBlock2D<double>& osFactors,
                                      const CMemBlock2D<double>& wpDistances,
                                      const CGtoPairsBlock&      braGtoPairsBlock,
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, tg_0_xxxxx_1, tg_0_xxxxxx_0, tg_0_xxxxxx_1, tg_0_xxxxxy_0, \
                                         ...
                                         tg_y_xxxzzz_0, tg_y_xxyyyy_0, tg_y_xxyyyz_0, tg_y_xxyyzz_0, tg_y_xxyzzz_0, wp_x, wp_y: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fxn = fxn[j];
    ...
    void
    compElectronRepulsionForSPSI_42_84(      CMemBlock2D<double>& primBuffer,
                                       const CRecursionMap&       recursionMap,
                                       const CMemBlock2D<double>& osFactors,
                                       const CMemBlock2D<double>& wpDistances,
                                       const CGtoPairsBlock&      braGtoPairsBlock,
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, tg_0_xxxxx_1, tg_0_xxxxxx_0, tg_0_xxxxxx_1, tg_0_xxxxxy_0, \
                                         ...
                                         tg_0_yyyyzz_1, tg_0_yyyzz_1, tg_0_yyyzzz_0, tg_0_yyyzzz_1, tg_0_yyzzz_1, \
                                         tg_0_yyzzzz_0, tg_0_yyzzzz_1, tg_0_yzzzz_1, tg_0_yzzzzz_0, tg_0_yzzzzz_1, \
                                         tg_0_zzzzz_1, tg_0_zzzzzz_0, tg_0_zzzzzz_1, tg_y_xxzzzz_0, tg_y_xyyyyy_0, \
                                         ...
                                         tg_z_yyyyzz_0, tg_z_yyyzzz_0, tg_z_yyzzzz_0, tg_z_yzzzzz_0, tg_z_zzzzzz_0, wp_y, wp_z: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fxn = fxn[j];
    ...
    compElectronRepulsionForSISP(      CMemBlock2D<double>& primBuffer,
                                 ...
                                 const int32_t              iContrPair)
    {
        erirecfunc::compElectronRepulsionForSISP_0_42(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      wpDistances, 
                                                      braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSISP_42_84(primBuffer,
                                                       recursionMap,
                                                       osFactors,
                                                       wpDistances, 
                                                       braGtoPairsBlock,
    ...
    void
    compElectronRepulsionForSISP_0_42(      CMemBlock2D<double>& primBuffer,
                                      const CRecursionMap&       recursionMap,
                                      const CMemBlock2D<double>& osFactors,
                                      const CMemBlock2D<double>& wpDistances,
                                      const CGtoPairsBlock&      braGtoPairsBlock,
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, fza, tg_xxxx_x_0, tg_xxxx_x_1, tg_xxxx_y_0, tg_xxxx_y_1, \
                                         ...
                                         tg_xyyy_x_0, tg_xyyy_x_1, tg_xyyy_y_0, tg_xyyy_y_1, tg_xyyy_z_0, tg_xyyy_z_1, \
                                         tg_xyyyy_0_1, tg_xyyyy_x_0, tg_xyyyy_x_1, tg_xyyyy_y_0, tg_xyyyy_y_1, tg_xyyyy_z_0, \
                                         tg_xyyyy_z_1, tg_xyyyz_0_1, tg_xyyyz_x_0, tg_xyyyz_x_1, tg_xyyyz_y_0, tg_xyyyz_y_1, \
                                         tg_xyyyz_z_0, tg_xyyyz_z_1, tg_xyyz_x_0, tg_xyyz_x_1, tg_xyyz_y_0, tg_xyyz_y_1, \
                                         tg_xyyz_z_0, tg_xyyz_z_1, tg_xyyzz_0_1, tg_xyyzz_x_0, tg_xyyzz_x_1, tg_xyyzz_y_0, \
                                         tg_xyyzz_y_1, tg_xyyzz_z_0, tg_xyyzz_z_1, tg_xyzz_x_0, tg_xyzz_x_1, tg_xyzz_y_0, \
                                         tg_xyzz_y_1, tg_xyzz_z_0, tg_xyzz_z_1, tg_xyzzz_0_1, tg_xyzzz_x_0, tg_xyzzz_x_1, \
                                         tg_xyzzz_y_0, tg_xyzzz_y_1, tg_xyzzz_z_0, tg_xyzzz_z_1, tg_xzzz_x_0, tg_xzzz_x_1, \
                                         tg_xzzz_y_0, tg_xzzz_y_1, tg_xzzz_z_0, tg_xzzz_z_1, tg_yyyy_x_0, tg_yyyy_x_1, \
                                         tg_yyyy_y_0, tg_yyyy_y_1, tg_yyyy_z_0, tg_yyyy_z_1, tg_yyyz_x_0, tg_yyyz_x_1, \
                                         tg_yyyz_y_0, tg_yyyz_y_1, tg_yyyz_z_0, tg_yyyz_z_1, tg_yyzz_x_0, tg_yyzz_x_1, \
                                         tg_yyzz_y_0, tg_yyzz_y_1, tg_yyzz_z_0, tg_yyzz_z_1, tg_yzzz_x_0, tg_yzzz_x_1, \
                                         tg_yzzz_y_0, tg_yzzz_y_1, tg_yzzz_z_0, tg_yzzz_z_1, wp_x: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fx = fx;
    ...
    void
    compElectronRepulsionForSISP_42_84(      CMemBlock2D<double>& primBuffer,
                                       const CRecursionMap&       recursionMap,
                                       const CMemBlock2D<double>& osFactors,
                                       const CMemBlock2D<double>& wpDistances,
                                       const CGtoPairsBlock&      braGtoPairsBlock,
                                       ...
                                       const int32_t              iContrPair)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, fza, tg_xxzzzz_x_0, tg_xxzzzz_y_0, tg_xxzzzz_z_0, tg_xyyyyy_x_0, \
                                         tg_xyyyyy_y_0, tg_xyyyyy_z_0, tg_xyyyyz_x_0, tg_xyyyyz_y_0, tg_xyyyyz_z_0, \
                                         tg_xyyyzz_x_0, tg_xyyyzz_y_0, tg_xyyyzz_z_0, tg_xyyzzz_x_0, tg_xyyzzz_y_0, \
                                         tg_xyyzzz_z_0, tg_xyzzzz_x_0, tg_xyzzzz_y_0, tg_xyzzzz_z_0, tg_xzzzz_0_1, \
                                         tg_xzzzz_x_0, tg_xzzzz_x_1, tg_xzzzz_y_0, tg_xzzzz_y_1, tg_xzzzz_z_0, tg_xzzzz_z_1, \
                                         tg_xzzzzz_x_0, tg_xzzzzz_y_0, tg_xzzzzz_z_0, tg_yyyy_x_0, tg_yyyy_x_1, tg_yyyy_y_0, \
                                         tg_yyyy_y_1, tg_yyyy_z_0, tg_yyyy_z_1, tg_yyyyy_0_1, tg_yyyyy_x_0, tg_yyyyy_x_1, \
                                         tg_yyyyy_y_0, tg_yyyyy_y_1, tg_yyyyy_z_0, tg_yyyyy_z_1, tg_yyyyyy_x_0, \
                                         tg_yyyyyy_y_0, tg_yyyyyy_z_0, tg_yyyyyz_x_0, tg_yyyyyz_y_0, tg_yyyyyz_z_0, \
                                         tg_yyyyz_0_1, tg_yyyyz_x_0, tg_yyyyz_x_1, tg_yyyyz_y_0, tg_yyyyz_y_1, tg_yyyyz_z_0, \
                                         tg_yyyyz_z_1, tg_yyyyzz_x_0, tg_yyyyzz_y_0, tg_yyyyzz_z_0, tg_yyyz_x_0, \
                                         tg_yyyz_x_1, tg_yyyz_y_0, tg_yyyz_y_1, tg_yyyz_z_0, tg_yyyz_z_1, tg_yyyzz_0_1, \
                                         tg_yyyzz_x_0, tg_yyyzz_x_1, tg_yyyzz_y_0, tg_yyyzz_y_1, tg_yyyzz_z_0, tg_yyyzz_z_1, \
                                         tg_yyyzzz_x_0, tg_yyyzzz_y_0, tg_yyyzzz_z_0, tg_yyzz_x_0, tg_yyzz_x_1, tg_yyzz_y_0, \
                                         tg_yyzz_y_1, tg_yyzz_z_0, tg_yyzz_z_1, tg_yyzzz_0_1, tg_yyzzz_x_0, tg_yyzzz_x_1, \
                                         tg_yyzzz_y_0, tg_yyzzz_y_1, tg_yyzzz_z_0, tg_yyzzz_z_1, tg_yyzzzz_x_0, \
                                         tg_yyzzzz_y_0, tg_yyzzzz_z_0, tg_yzzz_x_0, tg_yzzz_x_1, tg_yzzz_y_0, tg_yzzz_y_1, \
                                         tg_yzzz_z_0, tg_yzzz_z_1, tg_yzzzz_0_1, tg_yzzzz_x_0, tg_yzzzz_x_1, tg_yzzzz_y_0, \
                                         tg_yzzzz_y_1, tg_yzzzz_z_0, tg_yzzzz_z_1, tg_yzzzzz_x_0, tg_yzzzzz_y_0, \
                                         tg_yzzzzz_z_0, tg_zzzz_x_0, tg_zzzz_x_1, tg_zzzz_y_0, tg_zzzz_y_1, tg_zzzz_z_0, \
                                         tg_zzzz_z_1, tg_zzzzz_0_1, tg_zzzzz_x_0, tg_zzzzz_x_1, tg_zzzzz_y_0, tg_zzzzz_y_1, \
                                         tg_zzzzz_z_0, tg_zzzzz_z_1, tg_zzzzzz_x_0, tg_zzzzzz_y_0, tg_zzzzzz_z_0, wp_x, wp_y, \
                                         wp_z: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fx = fx;
    ...
    compElectronRepulsionForSPSK(      CMemBlock2D<double>& primBuffer,
                                 ...
                                 const int32_t              iContrPair)
    {
        erirecfunc::compElectronRepulsionForSPSK_0_36(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      wpDistances, 
                                                      braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSPSK_36_72(primBuffer,
                                                       recursionMap,
                                                       osFactors,
                                                       wpDistances, 
                                                       braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSPSK_72_108(primBuffer,
                                                        recursionMap,
                                                        osFactors,
                                                        wpDistances, 
                                                        braGtoPairsBlock,
    ...
    void
    compElectronRepulsionForSPSK_0_36(      CMemBlock2D<double>& primBuffer,
                                      const CRecursionMap&       recursionMap,
                                      const CMemBlock2D<double>& osFactors,
                                      const CMemBlock2D<double>& wpDistances,
                                      const CGtoPairsBlock&      braGtoPairsBlock,
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, tg_0_xxxxxx_1, tg_0_xxxxxxx_0, tg_0_xxxxxxx_1, tg_0_xxxxxxy_0, \
                                         ...
                                         tg_x_yzzzzzz_0, tg_x_zzzzzzz_0, wp_x: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fxn = fxn[j];
    ...
    void
    compElectronRepulsionForSPSK_36_72(      CMemBlock2D<double>& primBuffer,
                                       const CRecursionMap&       recursionMap,
                                       const CMemBlock2D<double>& osFactors,
                                       const CMemBlock2D<double>& wpDistances,
                                       const CGtoPairsBlock&      braGtoPairsBlock,
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, tg_0_xxxxxx_1, tg_0_xxxxxxx_0, tg_0_xxxxxxx_1, tg_0_xxxxxxy_0, \
                                         ...
                                         tg_0_yyyzzzz_0, tg_0_yyyzzzz_1, tg_0_yyzzzz_1, tg_0_yyzzzzz_0, tg_0_yyzzzzz_1, \
                                         tg_0_yzzzzz_1, tg_0_yzzzzzz_0, tg_0_yzzzzzz_1, tg_0_zzzzzz_1, tg_0_zzzzzzz_0, \
                                         tg_0_zzzzzzz_1, tg_y_xxxxxxx_0, tg_y_xxxxxxy_0, tg_y_xxxxxxz_0, tg_y_xxxxxyy_0, \
                                         tg_y_xxxxxyz_0, tg_y_xxxxxzz_0, tg_y_xxxxyyy_0, tg_y_xxxxyyz_0, tg_y_xxxxyzz_0, \
                                         tg_y_xxxxzzz_0, tg_y_xxxyyyy_0, tg_y_xxxyyyz_0, tg_y_xxxyyzz_0, tg_y_xxxyzzz_0, \
                                         tg_y_xxxzzzz_0, tg_y_xxyyyyy_0, tg_y_xxyyyyz_0, tg_y_xxyyyzz_0, tg_y_xxyyzzz_0, \
                                         tg_y_xxyzzzz_0, tg_y_xxzzzzz_0, tg_y_xyyyyyy_0, tg_y_xyyyyyz_0, tg_y_xyyyyzz_0, \
                                         tg_y_xyyyzzz_0, tg_y_xyyzzzz_0, tg_y_xyzzzzz_0, tg_y_xzzzzzz_0, tg_y_yyyyyyy_0, \
                                         tg_y_yyyyyyz_0, tg_y_yyyyyzz_0, tg_y_yyyyzzz_0, tg_y_yyyzzzz_0, tg_y_yyzzzzz_0, \
                                         tg_y_yzzzzzz_0, tg_y_zzzzzzz_0, wp_y: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fxn = fxn[j];
    ...
    void
    compElectronRepulsionForSPSK_72_108(      CMemBlock2D<double>& primBuffer,
                                        const CRecursionMap&       recursionMap,
                                        const CMemBlock2D<double>& osFactors,
                                        const CMemBlock2D<double>& wpDistances,
                                        const CGtoPairsBlock&      braGtoPairsBlock,
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, tg_0_xxxxxx_1, tg_0_xxxxxxx_0, tg_0_xxxxxxx_1, tg_0_xxxxxxy_0, \
                                         ...
                                         tg_0_yyyzzzz_0, tg_0_yyyzzzz_1, tg_0_yyzzzz_1, tg_0_yyzzzzz_0, tg_0_yyzzzzz_1, \
                                         tg_0_yzzzzz_1, tg_0_yzzzzzz_0, tg_0_yzzzzzz_1, tg_0_zzzzzz_1, tg_0_zzzzzzz_0, \
                                         tg_0_zzzzzzz_1, tg_z_xxxxxxx_0, tg_z_xxxxxxy_0, tg_z_xxxxxxz_0, tg_z_xxxxxyy_0, \
                                         tg_z_xxxxxyz_0, tg_z_xxxxxzz_0, tg_z_xxxxyyy_0, tg_z_xxxxyyz_0, tg_z_xxxxyzz_0, \
                                         tg_z_xxxxzzz_0, tg_z_xxxyyyy_0, tg_z_xxxyyyz_0, tg_z_xxxyyzz_0, tg_z_xxxyzzz_0, \
                                         tg_z_xxxzzzz_0, tg_z_xxyyyyy_0, tg_z_xxyyyyz_0, tg_z_xxyyyzz_0, tg_z_xxyyzzz_0, \
                                         tg_z_xxyzzzz_0, tg_z_xxzzzzz_0, tg_z_xyyyyyy_0, tg_z_xyyyyyz_0, tg_z_xyyyyzz_0, \
                                         tg_z_xyyyzzz_0, tg_z_xyyzzzz_0, tg_z_xyzzzzz_0, tg_z_xzzzzzz_0, tg_z_yyyyyyy_0, \
                                         tg_z_yyyyyyz_0, tg_z_yyyyyzz_0, tg_z_yyyyzzz_0, tg_z_yyyzzzz_0, tg_z_yyzzzzz_0, \
                                         tg_z_yzzzzzz_0, tg_z_zzzzzzz_0, wp_z: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fxn = fxn[j];
    ...
    compElectronRepulsionForSKSP(      CMemBlock2D<double>& primBuffer,
                                 ...
                                 const int32_t              iContrPair)
    {
        erirecfunc::compElectronRepulsionForSKSP_0_36(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      wpDistances, 
                                                      braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSKSP_36_72(primBuffer,
                                                       recursionMap,
                                                       osFactors,
                                                       wpDistances, 
                                                       braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSKSP_72_108(primBuffer,
                                                        recursionMap,
                                                        osFactors,
                                                        wpDistances, 
                                                        braGtoPairsBlock,
    ...
    void
    compElectronRepulsionForSKSP_0_36(      CMemBlock2D<double>& primBuffer,
                                      const CRecursionMap&       recursionMap,
                                      const CMemBlock2D<double>& osFactors,
                                      const CMemBlock2D<double>& wpDistances,
                                      const CGtoPairsBlock&      braGtoPairsBlock,
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, fza, tg_xxxxx_x_0, tg_xxxxx_x_1, tg_xxxxx_y_0, tg_xxxxx_y_1, \
                                         ...
                                         tg_xxxyz_x_0, tg_xxxyz_x_1, tg_xxxyz_y_0, tg_xxxyz_y_1, tg_xxxyz_z_0, tg_xxxyz_z_1, \
                                         tg_xxxyzz_0_1, tg_xxxyzz_x_0, tg_xxxyzz_x_1, tg_xxxyzz_y_0, tg_xxxyzz_y_1, \
                                         tg_xxxyzz_z_0, tg_xxxyzz_z_1, tg_xxxzz_x_0, tg_xxxzz_x_1, tg_xxxzz_y_0, \
                                         tg_xxxzz_y_1, tg_xxxzz_z_0, tg_xxxzz_z_1, tg_xxxzzz_0_1, tg_xxxzzz_x_0, \
                                         tg_xxxzzz_x_1, tg_xxxzzz_y_0, tg_xxxzzz_y_1, tg_xxxzzz_z_0, tg_xxxzzz_z_1, \
                                         tg_xxyyy_x_0, tg_xxyyy_x_1, tg_xxyyy_y_0, tg_xxyyy_y_1, tg_xxyyy_z_0, tg_xxyyy_z_1, \
                                         tg_xxyyyy_0_1, tg_xxyyyy_x_0, tg_xxyyyy_x_1, tg_xxyyyy_y_0, tg_xxyyyy_y_1, \
                                         tg_xxyyyy_z_0, tg_xxyyyy_z_1, tg_xxyyyz_0_1, tg_xxyyyz_x_0, tg_xxyyyz_x_1, \
                                         tg_xxyyyz_y_0, tg_xxyyyz_y_1, tg_xxyyyz_z_0, tg_xxyyyz_z_1, tg_xxyyz_x_0, \
                                         tg_xxyyz_x_1, tg_xxyyz_y_0, tg_xxyyz_y_1, tg_xxyyz_z_0, tg_xxyyz_z_1, tg_xxyzz_x_0, \
                                         tg_xxyzz_x_1, tg_xxyzz_y_0, tg_xxyzz_y_1, tg_xxyzz_z_0, tg_xxyzz_z_1, tg_xxzzz_x_0, \
                                         tg_xxzzz_x_1, tg_xxzzz_y_0, tg_xxzzz_y_1, tg_xxzzz_z_0, tg_xxzzz_z_1, tg_xyyyy_x_0, \
                                         tg_xyyyy_x_1, tg_xyyyy_y_0, tg_xyyyy_y_1, tg_xyyyy_z_0, tg_xyyyy_z_1, tg_xyyyz_x_0, \
                                         tg_xyyyz_x_1, tg_xyyyz_y_0, tg_xyyyz_y_1, tg_xyyyz_z_0, tg_xyyyz_z_1, wp_x: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fx = fx;
    ...
    void
    compElectronRepulsionForSKSP_36_72(      CMemBlock2D<double>& primBuffer,
                                       const CRecursionMap&       recursionMap,
                                       const CMemBlock2D<double>& osFactors,
                                       const CMemBlock2D<double>& wpDistances,
                                       const CGtoPairsBlock&      braGtoPairsBlock,
                                       ...
                                       const int32_t              iContrPair)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, fza, tg_xxxyyzz_x_0, tg_xxxyyzz_y_0, tg_xxxyyzz_z_0, \
                                         tg_xxxyzzz_x_0, tg_xxxyzzz_y_0, tg_xxxyzzz_z_0, tg_xxxzzzz_x_0, tg_xxxzzzz_y_0, \
                                         tg_xxxzzzz_z_0, tg_xxyyyyy_x_0, tg_xxyyyyy_y_0, tg_xxyyyyy_z_0, tg_xxyyyyz_x_0, \
                                         tg_xxyyyyz_y_0, tg_xxyyyyz_z_0, tg_xxyyyzz_x_0, tg_xxyyyzz_y_0, tg_xxyyyzz_z_0, \
                                         tg_xxyyzz_0_1, tg_xxyyzz_x_0, tg_xxyyzz_x_1, tg_xxyyzz_y_0, tg_xxyyzz_y_1, \
                                         tg_xxyyzz_z_0, tg_xxyyzz_z_1, tg_xxyyzzz_x_0, tg_xxyyzzz_y_0, tg_xxyyzzz_z_0, \
                                         tg_xxyzzz_0_1, tg_xxyzzz_x_0, tg_xxyzzz_x_1, tg_xxyzzz_y_0, tg_xxyzzz_y_1, \
                                         tg_xxyzzz_z_0, tg_xxyzzz_z_1, tg_xxyzzzz_x_0, tg_xxyzzzz_y_0, tg_xxyzzzz_z_0, \
                                         tg_xxzzzz_0_1, tg_xxzzzz_x_0, tg_xxzzzz_x_1, tg_xxzzzz_y_0, tg_xxzzzz_y_1, \
                                         tg_xxzzzz_z_0, tg_xxzzzz_z_1, tg_xxzzzzz_x_0, tg_xxzzzzz_y_0, tg_xxzzzzz_z_0, \
                                         tg_xyyyyy_0_1, tg_xyyyyy_x_0, tg_xyyyyy_x_1, tg_xyyyyy_y_0, tg_xyyyyy_y_1, \
                                         tg_xyyyyy_z_0, tg_xyyyyy_z_1, tg_xyyyyyy_x_0, tg_xyyyyyy_y_0, tg_xyyyyyy_z_0, \
                                         tg_xyyyyyz_x_0, tg_xyyyyyz_y_0, tg_xyyyyyz_z_0, tg_xyyyyz_0_1, tg_xyyyyz_x_0, \
                                         tg_xyyyyz_x_1, tg_xyyyyz_y_0, tg_xyyyyz_y_1, tg_xyyyyz_z_0, tg_xyyyyz_z_1, \
                                         tg_xyyyyzz_x_0, tg_xyyyyzz_y_0, tg_xyyyyzz_z_0, tg_xyyyzz_0_1, tg_xyyyzz_x_0, \
                                         tg_xyyyzz_x_1, tg_xyyyzz_y_0, tg_xyyyzz_y_1, tg_xyyyzz_z_0, tg_xyyyzz_z_1, \
                                         tg_xyyzz_x_0, tg_xyyzz_x_1, tg_xyyzz_y_0, tg_xyyzz_y_1, tg_xyyzz_z_0, tg_xyyzz_z_1, \
                                         tg_xyyzzz_0_1, tg_xyyzzz_x_0, tg_xyyzzz_x_1, tg_xyyzzz_y_0, tg_xyyzzz_y_1, \
                                         tg_xyyzzz_z_0, tg_xyyzzz_z_1, tg_xyzzz_x_0, tg_xyzzz_x_1, tg_xyzzz_y_0, \
                                         tg_xyzzz_y_1, tg_xyzzz_z_0, tg_xyzzz_z_1, tg_xyzzzz_0_1, tg_xyzzzz_x_0, \
                                         tg_xyzzzz_x_1, tg_xyzzzz_y_0, tg_xyzzzz_y_1, tg_xyzzzz_z_0, tg_xyzzzz_z_1, \
                                         tg_xzzzz_x_0, tg_xzzzz_x_1, tg_xzzzz_y_0, tg_xzzzz_y_1, tg_xzzzz_z_0, tg_xzzzz_z_1, \
                                         tg_xzzzzz_0_1, tg_xzzzzz_x_0, tg_xzzzzz_x_1, tg_xzzzzz_y_0, tg_xzzzzz_y_1, \
                                         tg_xzzzzz_z_0, tg_xzzzzz_z_1, tg_yyyyy_x_0, tg_yyyyy_x_1, tg_yyyyy_y_0, \
                                         tg_yyyyy_y_1, tg_yyyyy_z_0, tg_yyyyy_z_1, tg_yyyyyy_0_1, tg_yyyyyy_x_0, \
                                         tg_yyyyyy_x_1, tg_yyyyyy_y_0, tg_yyyyyy_y_1, tg_yyyyyy_z_0, tg_yyyyyy_z_1, \
                                         tg_yyyyyz_0_1, tg_yyyyyz_x_0, tg_yyyyyz_x_1, tg_yyyyyz_y_0, tg_yyyyyz_y_1, \
                                         tg_yyyyyz_z_0, tg_yyyyyz_z_1, tg_yyyyz_x_0, tg_yyyyz_x_1, tg_yyyyz_y_0, \
                                         ...
                                         tg_yyyzz_x_0, tg_yyyzz_x_1, tg_yyyzz_y_0, tg_yyyzz_y_1, tg_yyyzz_z_0, tg_yyyzz_z_1, \
                                         tg_yyzzz_x_0, tg_yyzzz_x_1, tg_yyzzz_y_0, tg_yyzzz_y_1, tg_yyzzz_z_0, tg_yyzzz_z_1, \
    ...
    void
    compElectronRepulsionForSKSP_72_108(      CMemBlock2D<double>& primBuffer,
                                        const CRecursionMap&       recursionMap,
                                        const CMemBlock2D<double>& osFactors,
                                        const CMemBlock2D<double>& wpDistances,
                                        const CGtoPairsBlock&      braGtoPairsBlock,
                                        ...
                                        const int32_t              iContrPair)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, fza, tg_xyyyzzz_x_0, tg_xyyyzzz_y_0, tg_xyyyzzz_z_0, \
                                         tg_xyyzzzz_x_0, tg_xyyzzzz_y_0, tg_xyyzzzz_z_0, tg_xyzzzzz_x_0, tg_xyzzzzz_y_0, \
                                         tg_xyzzzzz_z_0, tg_xzzzzzz_x_0, tg_xzzzzzz_y_0, tg_xzzzzzz_z_0, tg_yyyyy_x_0, \
                                         tg_yyyyy_x_1, tg_yyyyy_y_0, tg_yyyyy_y_1, tg_yyyyy_z_0, tg_yyyyy_z_1, \
                                         tg_yyyyyy_0_1, tg_yyyyyy_x_0, tg_yyyyyy_x_1, tg_yyyyyy_y_0, tg_yyyyyy_y_1, \
                                         tg_yyyyyy_z_0, tg_yyyyyy_z_1, tg_yyyyyyy_x_0, tg_yyyyyyy_y_0, tg_yyyyyyy_z_0, \
                                         tg_yyyyyyz_x_0, tg_yyyyyyz_y_0, tg_yyyyyyz_z_0, tg_yyyyyz_0_1, tg_yyyyyz_x_0, \
                                         tg_yyyyyz_x_1, tg_yyyyyz_y_0, tg_yyyyyz_y_1, tg_yyyyyz_z_0, tg_yyyyyz_z_1, \
                                         tg_yyyyyzz_x_0, tg_yyyyyzz_y_0, tg_yyyyyzz_z_0, tg_yyyyz_x_0, tg_yyyyz_x_1, \
                                         tg_yyyyz_y_0, tg_yyyyz_y_1, tg_yyyyz_z_0, tg_yyyyz_z_1, tg_yyyyzz_0_1, \
                                         tg_yyyyzz_x_0, tg_yyyyzz_x_1, tg_yyyyzz_y_0, tg_yyyyzz_y_1, tg_yyyyzz_z_0, \
                                         tg_yyyyzz_z_1, tg_yyyyzzz_x_0, tg_yyyyzzz_y_0, tg_yyyyzzz_z_0, tg_yyyzz_x_0, \
                                         tg_yyyzz_x_1, tg_yyyzz_y_0, tg_yyyzz_y_1, tg_yyyzz_z_0, tg_yyyzz_z_1, \
                                         tg_yyyzzz_0_1, tg_yyyzzz_x_0, tg_yyyzzz_x_1, tg_yyyzzz_y_0, tg_yyyzzz_y_1, \
                                         tg_yyyzzz_z_0, tg_yyyzzz_z_1, tg_yyyzzzz_x_0, tg_yyyzzzz_y_0, tg_yyyzzzz_z_0, \
                                         tg_yyzzz_x_0, tg_yyzzz_x_1, tg_yyzzz_y_0, tg_yyzzz_y_1, tg_yyzzz_z_0, tg_yyzzz_z_1, \
    ...
    compElectronRepulsionForSPSL(      CMemBlock2D<double>& primBuffer,
                                 ...
                                 const int32_t              iContrPair)
    {
        erirecfunc::compElectronRepulsionForSPSL_0_45(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      wpDistances, 
                                                      braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSPSL_45_90(primBuffer,
                                                       recursionMap,
                                                       osFactors,
                                                       wpDistances, 
                                                       braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSPSL_90_135(primBuffer,
                                                        recursionMap,
                                                        osFactors,
                                                        wpDistances, 
                                                        braGtoPairsBlock,
    ...
    void
    compElectronRepulsionForSPSL_0_45(      CMemBlock2D<double>& primBuffer,
                                      const CRecursionMap&       recursionMap,
                                      const CMemBlock2D<double>& osFactors,
                                      const CMemBlock2D<double>& wpDistances,
                                      const CGtoPairsBlock&      braGtoPairsBlock,
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, tg_0_xxxxxxx_1, tg_0_xxxxxxxx_0, tg_0_xxxxxxxx_1, \
                                         ...
                                         tg_x_yyzzzzzz_0, tg_x_yzzzzzzz_0, tg_x_zzzzzzzz_0, wp_x: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fxn = fxn[j];
    ...
    void
    compElectronRepulsionForSPSL_45_90(      CMemBlock2D<double>& primBuffer,
                                       const CRecursionMap&       recursionMap,
                                       const CMemBlock2D<double>& osFactors,
                                       const CMemBlock2D<double>& wpDistances,
                                       const CGtoPairsBlock&      braGtoPairsBlock,
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, tg_0_xxxxxxx_1, tg_0_xxxxxxxx_0, tg_0_xxxxxxxx_1, \
                                         ...
                                         tg_0_yyyyzzzz_1, tg_0_yyyzzzz_1, tg_0_yyyzzzzz_0, tg_0_yyyzzzzz_1, tg_0_yyzzzzz_1, \
                                         tg_0_yyzzzzzz_0, tg_0_yyzzzzzz_1, tg_0_yzzzzzz_1, tg_0_yzzzzzzz_0, tg_0_yzzzzzzz_1, \
                                         tg_0_zzzzzzz_1, tg_0_zzzzzzzz_0, tg_0_zzzzzzzz_1, tg_y_xxxxxxxx_0, tg_y_xxxxxxxy_0, \
                                         ...
                                         tg_y_xxyyyyyz_0, tg_y_xxyyyyzz_0, tg_y_xxyyyzzz_0, tg_y_xxyyzzzz_0, tg_y_xxyzzzzz_0, \
                                         tg_y_xxzzzzzz_0, tg_y_xyyyyyyy_0, tg_y_xyyyyyyz_0, tg_y_xyyyyyzz_0, tg_y_xyyyyzzz_0, \
                                         tg_y_xyyyzzzz_0, tg_y_xyyzzzzz_0, tg_y_xyzzzzzz_0, tg_y_xzzzzzzz_0, tg_y_yyyyyyyy_0, \
                                         tg_y_yyyyyyyz_0, tg_y_yyyyyyzz_0, tg_y_yyyyyzzz_0, tg_y_yyyyzzzz_0, tg_y_yyyzzzzz_0, \
                                         tg_y_yyzzzzzz_0, tg_y_yzzzzzzz_0, tg_y_zzzzzzzz_0, wp_y: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fxn = fxn[j];
    ...
    void
    compElectronRepulsionForSPSL_90_135(      CMemBlock2D<double>& primBuffer,
                                        const CRecursionMap&       recursionMap,
                                        const CMemBlock2D<double>& osFactors,
                                        const CMemBlock2D<double>& wpDistances,
                                        const CGtoPairsBlock&      braGtoPairsBlock,
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, tg_0_xxxxxxx_1, tg_0_xxxxxxxx_0, tg_0_xxxxxxxx_1, \
                                         ...
                                         tg_0_yyyyzzzz_1, tg_0_yyyzzzz_1, tg_0_yyyzzzzz_0, tg_0_yyyzzzzz_1, tg_0_yyzzzzz_1, \
                                         tg_0_yyzzzzzz_0, tg_0_yyzzzzzz_1, tg_0_yzzzzzz_1, tg_0_yzzzzzzz_0, tg_0_yzzzzzzz_1, \
                                         tg_0_zzzzzzz_1, tg_0_zzzzzzzz_0, tg_0_zzzzzzzz_1, tg_z_xxxxxxxx_0, tg_z_xxxxxxxy_0, \
                                         tg_z_xxxxxxxz_0, tg_z_xxxxxxyy_0, tg_z_xxxxxxyz_0, tg_z_xxxxxxzz_0, tg_z_xxxxxyyy_0, \
                                         tg_z_xxxxxyyz_0, tg_z_xxxxxyzz_0, tg_z_xxxxxzzz_0, tg_z_xxxxyyyy_0, tg_z_xxxxyyyz_0, \
                                         tg_z_xxxxyyzz_0, tg_z_xxxxyzzz_0, tg_z_xxxxzzzz_0, tg_z_xxxyyyyy_0, tg_z_xxxyyyyz_0, \
                                         tg_z_xxxyyyzz_0, tg_z_xxxyyzzz_0, tg_z_xxxyzzzz_0, tg_z_xxxzzzzz_0, tg_z_xxyyyyyy_0, \
                                         tg_z_xxyyyyyz_0, tg_z_xxyyyyzz_0, tg_z_xxyyyzzz_0, tg_z_xxyyzzzz_0, tg_z_xxyzzzzz_0, \
                                         tg_z_xxzzzzzz_0, tg_z_xyyyyyyy_0, tg_z_xyyyyyyz_0, tg_z_xyyyyyzz_0, tg_z_xyyyyzzz_0, \
                                         tg_z_xyyyzzzz_0, tg_z_xyyzzzzz_0, tg_z_xyzzzzzz_0, tg_z_xzzzzzzz_0, tg_z_yyyyyyyy_0, \
                                         tg_z_yyyyyyyz_0, tg_z_yyyyyyzz_0, tg_z_yyyyyzzz_0, tg_z_yyyyzzzz_0, tg_z_yyyzzzzz_0, \
                                         tg_z_yyzzzzzz_0, tg_z_yzzzzzzz_0, tg_z_zzzzzzzz_0, wp_z: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fxn = fxn[j];
    ...
    compElectronRepulsionForSLSP(      CMemBlock2D<double>& primBuffer,
                                 ...
                                 const int32_t              iContrPair)
    {
        erirecfunc::compElectronRepulsionForSLSP_0_45(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      wpDistances, 
                                                      braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSLSP_45_90(primBuffer,
                                                       recursionMap,
                                                       osFactors,
                                                       wpDistances, 
                                                       braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSLSP_90_135(primBuffer,
                                                        recursionMap,
                                                        osFactors,
                                                        wpDistances, 
                                                        braGtoPairsBlock,
    ...
    void
    compElectronRepulsionForSLSP_0_45(      CMemBlock2D<double>& primBuffer,
                                      const CRecursionMap&       recursionMap,
                                      const CMemBlock2D<double>& osFactors,
                                      const CMemBlock2D<double>& wpDistances,
                                      const CGtoPairsBlock&      braGtoPairsBlock,
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, fza, tg_xxxxxx_x_0, tg_xxxxxx_x_1, tg_xxxxxx_y_0, tg_xxxxxx_y_1, \
                                         ...
                                         tg_xxxyyyz_0_1, tg_xxxyyyz_x_0, tg_xxxyyyz_x_1, tg_xxxyyyz_y_0, tg_xxxyyyz_y_1, \
                                         tg_xxxyyyz_z_0, tg_xxxyyyz_z_1, tg_xxxyyz_x_0, tg_xxxyyz_x_1, tg_xxxyyz_y_0, \
                                         tg_xxxyyz_y_1, tg_xxxyyz_z_0, tg_xxxyyz_z_1, tg_xxxyyzz_0_1, tg_xxxyyzz_x_0, \
                                         tg_xxxyyzz_x_1, tg_xxxyyzz_y_0, tg_xxxyyzz_y_1, tg_xxxyyzz_z_0, tg_xxxyyzz_z_1, \
                                         tg_xxxyzz_x_0, tg_xxxyzz_x_1, tg_xxxyzz_y_0, tg_xxxyzz_y_1, tg_xxxyzz_z_0, \
                                         tg_xxxyzz_z_1, tg_xxxyzzz_0_1, tg_xxxyzzz_x_0, tg_xxxyzzz_x_1, tg_xxxyzzz_y_0, \
                                         tg_xxxyzzz_y_1, tg_xxxyzzz_z_0, tg_xxxyzzz_z_1, tg_xxxzzz_x_0, tg_xxxzzz_x_1, \
                                         ...
                                         tg_xxxzzzz_z_1, tg_xxyyyy_x_0, tg_xxyyyy_x_1, tg_xxyyyy_y_0, tg_xxyyyy_y_1, \
                                         tg_xxyyyy_z_0, tg_xxyyyy_z_1, tg_xxyyyz_x_0, tg_xxyyyz_x_1, tg_xxyyyz_y_0, \
                                         tg_xxyyyz_y_1, tg_xxyyyz_z_0, tg_xxyyyz_z_1, tg_xxyyzz_x_0, tg_xxyyzz_x_1, \
                                         tg_xxyyzz_y_0, tg_xxyyzz_y_1, tg_xxyyzz_z_0, tg_xxyyzz_z_1, tg_xxyzzz_x_0, \
                                         tg_xxyzzz_x_1, tg_xxyzzz_y_0, tg_xxyzzz_y_1, tg_xxyzzz_z_0, tg_xxyzzz_z_1, \
                                         tg_xxzzzz_x_0, tg_xxzzzz_x_1, tg_xxzzzz_y_0, tg_xxzzzz_y_1, tg_xxzzzz_z_0, \
                                         tg_xxzzzz_z_1, wp_x: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fx = fx;
    ...
    void
    compElectronRepulsionForSLSP_45_90(      CMemBlock2D<double>& primBuffer,
                                       const CRecursionMap&       recursionMap,
                                       const CMemBlock2D<double>& osFactors,
                                       const CMemBlock2D<double>& wpDistances,
                                       const CGtoPairsBlock&      braGtoPairsBlock,
                                       ...
                                       const int32_t              iContrPair)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, fza, tg_xxxyyyyy_x_0, tg_xxxyyyyy_y_0, tg_xxxyyyyy_z_0, \
                                         tg_xxxyyyyz_x_0, tg_xxxyyyyz_y_0, tg_xxxyyyyz_z_0, tg_xxxyyyzz_x_0, tg_xxxyyyzz_y_0, \
                                         tg_xxxyyyzz_z_0, tg_xxxyyzzz_x_0, tg_xxxyyzzz_y_0, tg_xxxyyzzz_z_0, tg_xxxyzzzz_x_0, \
                                         tg_xxxyzzzz_y_0, tg_xxxyzzzz_z_0, tg_xxxzzzzz_x_0, tg_xxxzzzzz_y_0, tg_xxxzzzzz_z_0, \
                                         ...
                                         tg_xxyyyyyz_x_0, tg_xxyyyyyz_y_0, tg_xxyyyyyz_z_0, tg_xxyyyyz_0_1, tg_xxyyyyz_x_0, \
                                         tg_xxyyyyz_x_1, tg_xxyyyyz_y_0, tg_xxyyyyz_y_1, tg_xxyyyyz_z_0, tg_xxyyyyz_z_1, \
                                         tg_xxyyyyzz_x_0, tg_xxyyyyzz_y_0, tg_xxyyyyzz_z_0, tg_xxyyyzz_0_1, tg_xxyyyzz_x_0, \
                                         tg_xxyyyzz_x_1, tg_xxyyyzz_y_0, tg_xxyyyzz_y_1, tg_xxyyyzz_z_0, tg_xxyyyzz_z_1, \
                                         tg_xxyyyzzz_x_0, tg_xxyyyzzz_y_0, tg_xxyyyzzz_z_0, tg_xxyyzzz_0_1, tg_xxyyzzz_x_0, \
                                         tg_xxyyzzz_x_1, tg_xxyyzzz_y_0, tg_xxyyzzz_y_1, tg_xxyyzzz_z_0, tg_xxyyzzz_z_1, \
                                         tg_xxyyzzzz_x_0, tg_xxyyzzzz_y_0, tg_xxyyzzzz_z_0, tg_xxyzzzz_0_1, tg_xxyzzzz_x_0, \
                                         tg_xxyzzzz_x_1, tg_xxyzzzz_y_0, tg_xxyzzzz_y_1, tg_xxyzzzz_z_0, tg_xxyzzzz_z_1, \
                                         tg_xxyzzzzz_x_0, tg_xxyzzzzz_y_0, tg_xxyzzzzz_z_0, tg_xxzzzzz_0_1, tg_xxzzzzz_x_0, \
                                         tg_xxzzzzz_x_1, tg_xxzzzzz_y_0, tg_xxzzzzz_y_1, tg_xxzzzzz_z_0, tg_xxzzzzz_z_1, \
                                         tg_xxzzzzzz_x_0, tg_xxzzzzzz_y_0, tg_xxzzzzzz_z_0, tg_xyyyyy_x_0, tg_xyyyyy_x_1, \
                                         tg_xyyyyy_y_0, tg_xyyyyy_y_1, tg_xyyyyy_z_0, tg_xyyyyy_z_1, tg_xyyyyyy_0_1, \
                                         tg_xyyyyyy_x_0, tg_xyyyyyy_x_1, tg_xyyyyyy_y_0, tg_xyyyyyy_y_1, tg_xyyyyyy_z_0, \
                                         tg_xyyyyyy_z_1, tg_xyyyyyyy_x_0, tg_xyyyyyyy_y_0, tg_xyyyyyyy_z_0, tg_xyyyyyyz_x_0, \
                                         tg_xyyyyyyz_y_0, tg_xyyyyyyz_z_0, tg_xyyyyyz_0_1, tg_xyyyyyz_x_0, tg_xyyyyyz_x_1, \
                                         tg_xyyyyyz_y_0, tg_xyyyyyz_y_1, tg_xyyyyyz_z_0, tg_xyyyyyz_z_1, tg_xyyyyz_x_0, \
                                         tg_xyyyyz_x_1, tg_xyyyyz_y_0, tg_xyyyyz_y_1, tg_xyyyyz_z_0, tg_xyyyyz_z_1, \
                                         tg_xyyyyzz_0_1, tg_xyyyyzz_x_0, tg_xyyyyzz_x_1, tg_xyyyyzz_y_0, tg_xyyyyzz_y_1, \
                                         tg_xyyyyzz_z_0, tg_xyyyyzz_z_1, tg_xyyyzz_x_0, tg_xyyyzz_x_1, tg_xyyyzz_y_0, \
                                         tg_xyyyzz_y_1, tg_xyyyzz_z_0, tg_xyyyzz_z_1, tg_xyyyzzz_0_1, tg_xyyyzzz_x_0, \
                                         tg_xyyyzzz_x_1, tg_xyyyzzz_y_0, tg_xyyyzzz_y_1, tg_xyyyzzz_z_0, tg_xyyyzzz_z_1, \
                                         tg_xyyzzz_x_0, tg_xyyzzz_x_1, tg_xyyzzz_y_0, tg_xyyzzz_y_1, tg_xyyzzz_z_0, \
                                         tg_xyyzzz_z_1, tg_xyyzzzz_0_1, tg_xyyzzzz_x_0, tg_xyyzzzz_x_1, tg_xyyzzzz_y_0, \
                                         tg_xyyzzzz_y_1, tg_xyyzzzz_z_0, tg_xyyzzzz_z_1, tg_xyzzzz_x_0, tg_xyzzzz_x_1, \
                                         tg_xyzzzz_y_0, tg_xyzzzz_y_1, tg_xyzzzz_z_0, tg_xyzzzz_z_1, tg_xyzzzzz_0_1, \
                                         tg_xyzzzzz_x_0, tg_xyzzzzz_x_1, tg_xyzzzzz_y_0, tg_xyzzzzz_y_1, tg_xyzzzzz_z_0, \
                                         tg_xyzzzzz_z_1, tg_xzzzzz_x_0, tg_xzzzzz_x_1, tg_xzzzzz_y_0, tg_xzzzzz_y_1, \
                                         tg_xzzzzz_z_0, tg_xzzzzz_z_1, tg_xzzzzzz_0_1, tg_xzzzzzz_x_0, tg_xzzzzzz_x_1, \
                                         tg_xzzzzzz_y_0, tg_xzzzzzz_y_1, tg_xzzzzzz_z_0, tg_xzzzzzz_z_1, tg_yyyyyy_x_0, \
                                         tg_yyyyyy_x_1, tg_yyyyyy_y_0, tg_yyyyyy_y_1, tg_yyyyyy_z_0, tg_yyyyyy_z_1, \
                                         tg_yyyyyyy_0_1, tg_yyyyyyy_x_0, tg_yyyyyyy_x_1, tg_yyyyyyy_y_0, tg_yyyyyyy_y_1, \
                                         tg_yyyyyyy_z_0, tg_yyyyyyy_z_1, tg_yyyyyyz_0_1, tg_yyyyyyz_x_0, tg_yyyyyyz_x_1, \
                                         tg_yyyyyyz_y_0, tg_yyyyyyz_y_1, tg_yyyyyyz_z_0, tg_yyyyyyz_z_1, tg_yyyyyz_x_0, \
                                         tg_yyyyyz_x_1, tg_yyyyyz_y_0, tg_yyyyyz_y_1, tg_yyyyyz_z_0, tg_yyyyyz_z_1, \
                                         tg_yyyyzz_x_0, tg_yyyyzz_x_1, tg_yyyyzz_y_0, tg_yyyyzz_y_1, tg_yyyyzz_z_0, \
                                         tg_yyyyzz_z_1, tg_yyyzzz_x_0, tg_yyyzzz_x_1, tg_yyyzzz_y_0, tg_yyyzzz_y_1, \
                                         tg_yyyzzz_z_0, tg_yyyzzz_z_1, tg_yyzzzz_x_0, tg_yyzzzz_x_1, tg_yyzzzz_y_0, \
                                         tg_yyzzzz_y_1, tg_yyzzzz_z_0, tg_yyzzzz_z_1, tg_yzzzzz_x_0, tg_yzzzzz_x_1, \
                                         tg_yzzzzz_y_0, tg_yzzzzz_y_1, tg_yzzzzz_z_0, tg_yzzzzz_z_1, tg_zzzzzz_x_0, \
                                         tg_zzzzzz_x_1, tg_zzzzzz_y_0, tg_zzzzzz_y_1, tg_zzzzzz_z_0, tg_zzzzzz_z_1, wp_x: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fx = fx;
    ...
    void
    compElectronRepulsionForSLSP_90_135(      CMemBlock2D<double>& primBuffer,
                                        const CRecursionMap&       recursionMap,
                                        const CMemBlock2D<double>& osFactors,
                                        const CMemBlock2D<double>& wpDistances,
                                        const CGtoPairsBlock&      braGtoPairsBlock,
                                        ...
                                        const int32_t              iContrPair)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, fza, tg_xyyyyyzz_x_0, tg_xyyyyyzz_y_0, tg_xyyyyyzz_z_0, \
                                         tg_xyyyyzzz_x_0, tg_xyyyyzzz_y_0, tg_xyyyyzzz_z_0, tg_xyyyzzzz_x_0, tg_xyyyzzzz_y_0, \
                                         tg_xyyyzzzz_z_0, tg_xyyzzzzz_x_0, tg_xyyzzzzz_y_0, tg_xyyzzzzz_z_0, tg_xyzzzzzz_x_0, \
                                         tg_xyzzzzzz_y_0, tg_xyzzzzzz_z_0, tg_xzzzzzzz_x_0, tg_xzzzzzzz_y_0, tg_xzzzzzzz_z_0, \
                                         tg_yyyyyy_x_0, tg_yyyyyy_x_1, tg_yyyyyy_y_0, tg_yyyyyy_y_1, tg_yyyyyy_z_0, \
                                         tg_yyyyyy_z_1, tg_yyyyyyy_0_1, tg_yyyyyyy_x_0, tg_yyyyyyy_x_1, tg_yyyyyyy_y_0, \
                                         tg_yyyyyyy_y_1, tg_yyyyyyy_z_0, tg_yyyyyyy_z_1, tg_yyyyyyyy_x_0, tg_yyyyyyyy_y_0, \
                                         tg_yyyyyyyy_z_0, tg_yyyyyyyz_x_0, tg_yyyyyyyz_y_0, tg_yyyyyyyz_z_0, tg_yyyyyyz_0_1, \
                                         tg_yyyyyyz_x_0, tg_yyyyyyz_x_1, tg_yyyyyyz_y_0, tg_yyyyyyz_y_1, tg_yyyyyyz_z_0, \
                                         tg_yyyyyyz_z_1, tg_yyyyyyzz_x_0, tg_yyyyyyzz_y_0, tg_yyyyyyzz_z_0, tg_yyyyyz_x_0, \
                                         tg_yyyyyz_x_1, tg_yyyyyz_y_0, tg_yyyyyz_y_1, tg_yyyyyz_z_0, tg_yyyyyz_z_1, \
                                         tg_yyyyyzz_0_1, tg_yyyyyzz_x_0, tg_yyyyyzz_x_1, tg_yyyyyzz_y_0, tg_yyyyyzz_y_1, \
                                         tg_yyyyyzz_z_0, tg_yyyyyzz_z_1, tg_yyyyyzzz_x_0, tg_yyyyyzzz_y_0, tg_yyyyyzzz_z_0, \
                                         tg_yyyyzz_x_0, tg_yyyyzz_x_1, tg_yyyyzz_y_0, tg_yyyyzz_y_1, tg_yyyyzz_z_0, \
                                         tg_yyyyzz_z_1, tg_yyyyzzz_0_1, tg_yyyyzzz_x_0, tg_yyyyzzz_x_1, tg_yyyyzzz_y_0, \
                                         tg_yyyyzzz_y_1, tg_yyyyzzz_z_0, tg_yyyyzzz_z_1, tg_yyyyzzzz_x_0, tg_yyyyzzzz_y_0, \
                                         tg_yyyyzzzz_z_0, tg_yyyzzz_x_0, tg_yyyzzz_x_1, tg_yyyzzz_y_0, tg_yyyzzz_y_1, \
                                         tg_yyyzzz_z_0, tg_yyyzzz_z_1, tg_yyyzzzz_0_1, tg_yyyzzzz_x_0, tg_yyyzzzz_x_1, \
                                         tg_yyyzzzz_y_0, tg_yyyzzzz_y_1, tg_yyyzzzz_z_0, tg_yyyzzzz_z_1, tg_yyyzzzzz_x_0, \
                                         tg_yyyzzzzz_y_0, tg_yyyzzzzz_z_0, tg_yyzzzz_x_0, tg_yyzzzz_x_1, tg_yyzzzz_y_0, \
                                         tg_yyzzzz_y_1, tg_yyzzzz_z_0, tg_yyzzzz_z_1, tg_yyzzzzz_0_1, tg_yyzzzzz_x_0, \
                                         tg_yyzzzzz_x_1, tg_yyzzzzz_y_0, tg_yyzzzzz_y_1, tg_yyzzzzz_z_0, tg_yyzzzzz_z_1, \
                                         tg_yyzzzzzz_x_0, tg_yyzzzzzz_y_0, tg_yyzzzzzz_z_0, tg_yzzzzz_x_0, tg_yzzzzz_x_1, \
                                         tg_yzzzzz_y_0, tg_yzzzzz_y_1, tg_yzzzzz_z_0, tg_yzzzzz_z_1, tg_yzzzzzz_0_1, \
                                         tg_yzzzzzz_x_0, tg_yzzzzzz_x_1, tg_yzzzzzz_y_0, tg_yzzzzzz_y_1, tg_yzzzzzz_z_0, \
                                         tg_yzzzzzz_z_1, tg_yzzzzzzz_x_0, tg_yzzzzzzz_y_0, tg_yzzzzzzz_z_0, tg_zzzzzz_x_0, \
                                         tg_zzzzzz_x_1, tg_zzzzzz_y_0, tg_zzzzzz_y_1, tg_zzzzzz_z_0, tg_zzzzzz_z_1, \
                                         tg_zzzzzzz_0_1, tg_zzzzzzz_x_0, tg_zzzzzzz_x_1, tg_zzzzzzz_y_0, tg_zzzzzzz_y_1, \
                                         tg_zzzzzzz_z_0, tg_zzzzzzz_z_1, tg_zzzzzzzz_x_0, tg_zzzzzzzz_y_0, tg_zzzzzzzz_z_0, \
