...
namespace erirecfunc { // erirecfunc namespace
    ...
    {
        erirecfunc::compElectronRepulsionForSFSG_0_50(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      wpDistances, 
                                                      braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSFSG_50_100(primBuffer,
                                                        recursionMap,
                                                        osFactors,
                                                        wpDistances, 
                                                        braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSFSG_100_150(primBuffer,
                                                         recursionMap,
                                                         osFactors,
                                                         wpDistances, 
                                                         braGtoPairsBlock,
    ...
    void
    compElectronRepulsionForSFSG_0_50(      CMemBlock2D<double>& primBuffer,
                                      const CRecursionMap&       recursionMap,
                                      const CMemBlock2D<double>& osFactors,
                                      const CMemBlock2D<double>& wpDistances,
                                      const CGtoPairsBlock&      braGtoPairsBlock,
                                      ...
                                      const int32_t              iContrPair)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            auto pidx_g_1_4_m1 = recursionMap.getIndexOfTerm(CRecursionTerm({"Electron Repulsion"}, 0, true, 
                                                             {1, -1, -1, -1}, {4, -1, -1, -1}, 
                                                             1, 1, iord + 1));
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                auto tg_x_xxxx_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx); 

                auto tg_x_xxxy_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 1); 

                auto tg_x_xxxz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 2); 

                auto tg_x_xxyy_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 3); 

                auto tg_x_xxyz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 4); 

                auto tg_x_xxzz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 5); 

                auto tg_x_xyyy_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 6); 

                auto tg_x_xyyz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 7); 

                auto tg_x_xyzz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 8); 

                auto tg_x_xzzz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 9); 

                auto tg_x_yyyy_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 10); 

                auto tg_x_yyyz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 11); 

                auto tg_x_yyzz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 12); 

                auto tg_x_yzzz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 13); 

                auto tg_x_zzzz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 14); 

                auto tg_y_xxxx_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 15); 

                auto tg_y_xxxy_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 16); 

                auto tg_y_xxxz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 17); 

                auto tg_y_xxyy_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 18); 

                auto tg_y_xxyz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 19); 

                auto tg_y_xxzz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 20); 

                auto tg_y_xyyy_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 21); 

                auto tg_y_xyyz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 22); 

                auto tg_y_xyzz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 23); 

                auto tg_y_xzzz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 24); 

                auto tg_y_yyyy_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 25); 

                auto tg_y_yyyz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 26); 

                auto tg_y_yyzz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 27); 

                auto tg_y_yzzz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 28); 

                auto tg_y_zzzz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 29); 

                auto tg_z_xxxx_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 30); 

                auto tg_z_xxxy_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 31); 

                auto tg_z_xxxz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 32); 

                auto tg_z_xxyy_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 33); 

                auto tg_z_xxyz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 34); 

                auto tg_z_xxzz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 35); 

                auto tg_z_xyyy_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 36); 

                auto tg_z_xyyz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 37); 

                auto tg_z_xyzz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 38); 

                auto tg_z_xzzz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 39); 

                auto tg_z_yyyy_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 40); 

                auto tg_z_yyyz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 41); 

                auto tg_z_yyzz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 42); 

                auto tg_z_yzzz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 43); 

                auto tg_z_zzzz_1 = primBuffer.data(pidx_g_1_4_m1 + 45 * idx + 44); 
                ...
                #pragma omp simd aligned(fxn, fza, tg_x_xxxx_0, tg_x_xxxx_1, tg_x_xxxy_0, tg_x_xxxy_1, \
                                         ...
                                         tg_xyy_xxxy_0, tg_xyy_xxxz_0, tg_xyy_xxyy_0, tg_xyy_xxyz_0, tg_xz_xxx_1, \
                                         ...
                                         tg_yy_xxyy_1, tg_yy_xxyz_0, tg_yy_xxyz_1, tg_yy_xxz_1, tg_yy_xyy_1, tg_yy_xyz_1, \
                                         tg_z_xxxx_0, tg_z_xxxx_1, tg_z_xxxy_0, tg_z_xxxy_1, tg_z_xxxz_0, tg_z_xxxz_1, \
                                         tg_z_xxyy_0, tg_z_xxyy_1, tg_z_xxyz_0, tg_z_xxyz_1, tg_z_xxzz_0, tg_z_xxzz_1, \
                                         tg_z_xyyy_0, tg_z_xyyy_1, tg_z_xyyz_0, tg_z_xyyz_1, tg_z_xyzz_0, tg_z_xyzz_1, \
                                         tg_z_xzzz_0, tg_z_xzzz_1, tg_z_yyyy_0, tg_z_yyyy_1, tg_z_yyyz_0, tg_z_yyyz_1, \
                                         tg_z_yyzz_0, tg_z_yyzz_1, tg_z_yzzz_0, tg_z_yzzz_1, tg_z_zzzz_0, tg_z_zzzz_1, wp_x: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    ...
                    tg_xxx_xxxx_0[j] = pb_x * tg_xx_xxxx_0[j] + wp_x[j] * tg_xx_xxxx_1[j] + fl1_fx * tg_x_xxxx_0[j] - fl1_fx * fl1_fza * tg_x_xxxx_1[j] + 2.0 * fl1_fxn * tg_xx_xxx_1[j];

                    tg_xxx_xxxy_0[j] = pb_x * tg_xx_xxxy_0[j] + wp_x[j] * tg_xx_xxxy_1[j] + fl1_fx * tg_x_xxxy_0[j] - fl1_fx * fl1_fza * tg_x_xxxy_1[j] + 1.5 * fl1_fxn * tg_xx_xxy_1[j];

                    tg_xxx_xxxz_0[j] = pb_x * tg_xx_xxxz_0[j] + wp_x[j] * tg_xx_xxxz_1[j] + fl1_fx * tg_x_xxxz_0[j] - fl1_fx * fl1_fza * tg_x_xxxz_1[j] + 1.5 * fl1_fxn * tg_xx_xxz_1[j];

                    tg_xxx_xxyy_0[j] = pb_x * tg_xx_xxyy_0[j] + wp_x[j] * tg_xx_xxyy_1[j] + fl1_fx * tg_x_xxyy_0[j] - fl1_fx * fl1_fza * tg_x_xxyy_1[j] + fl1_fxn * tg_xx_xyy_1[j];

                    tg_xxx_xxyz_0[j] = pb_x * tg_xx_xxyz_0[j] + wp_x[j] * tg_xx_xxyz_1[j] + fl1_fx * tg_x_xxyz_0[j] - fl1_fx * fl1_fza * tg_x_xxyz_1[j] + fl1_fxn * tg_xx_xyz_1[j];

                    tg_xxx_xxzz_0[j] = pb_x * tg_xx_xxzz_0[j] + wp_x[j] * tg_xx_xxzz_1[j] + fl1_fx * tg_x_xxzz_0[j] - fl1_fx * fl1_fza * tg_x_xxzz_1[j] + fl1_fxn * tg_xx_xzz_1[j];

                    tg_xxx_xyyy_0[j] = pb_x * tg_xx_xyyy_0[j] + wp_x[j] * tg_xx_xyyy_1[j] + fl1_fx * tg_x_xyyy_0[j] - fl1_fx * fl1_fza * tg_x_xyyy_1[j] + 0.5 * fl1_fxn * tg_xx_yyy_1[j];

                    tg_xxx_xyyz_0[j] = pb_x * tg_xx_xyyz_0[j] + wp_x[j] * tg_xx_xyyz_1[j] + fl1_fx * tg_x_xyyz_0[j] - fl1_fx * fl1_fza * tg_x_xyyz_1[j] + 0.5 * fl1_fxn * tg_xx_yyz_1[j];

                    tg_xxx_xyzz_0[j] = pb_x * tg_xx_xyzz_0[j] + wp_x[j] * tg_xx_xyzz_1[j] + fl1_fx * tg_x_xyzz_0[j] - fl1_fx * fl1_fza * tg_x_xyzz_1[j] + 0.5 * fl1_fxn * tg_xx_yzz_1[j];

                    tg_xxx_xzzz_0[j] = pb_x * tg_xx_xzzz_0[j] + wp_x[j] * tg_xx_xzzz_1[j] + fl1_fx * tg_x_xzzz_0[j] - fl1_fx * fl1_fza * tg_x_xzzz_1[j] + 0.5 * fl1_fxn * tg_xx_zzz_1[j];

                    tg_xxx_yyyy_0[j] = pb_x * tg_xx_yyyy_0[j] + wp_x[j] * tg_xx_yyyy_1[j] + fl1_fx * tg_x_yyyy_0[j] - fl1_fx * fl1_fza * tg_x_yyyy_1[j];

                    tg_xxx_yyyz_0[j] = pb_x * tg_xx_yyyz_0[j] + wp_x[j] * tg_xx_yyyz_1[j] + fl1_fx * tg_x_yyyz_0[j] - fl1_fx * fl1_fza * tg_x_yyyz_1[j];

                    tg_xxx_yyzz_0[j] = pb_x * tg_xx_yyzz_0[j] + wp_x[j] * tg_xx_yyzz_1[j] + fl1_fx * tg_x_yyzz_0[j] - fl1_fx * fl1_fza * tg_x_yyzz_1[j];

                    tg_xxx_yzzz_0[j] = pb_x * tg_xx_yzzz_0[j] + wp_x[j] * tg_xx_yzzz_1[j] + fl1_fx * tg_x_yzzz_0[j] - fl1_fx * fl1_fza * tg_x_yzzz_1[j];

                    tg_xxx_zzzz_0[j] = pb_x * tg_xx_zzzz_0[j] + wp_x[j] * tg_xx_zzzz_1[j] + fl1_fx * tg_x_zzzz_0[j] - fl1_fx * fl1_fza * tg_x_zzzz_1[j];

                    tg_xxy_xxxx_0[j] = pb_x * tg_xy_xxxx_0[j] + wp_x[j] * tg_xy_xxxx_1[j] + 0.5 * fl1_fx * tg_y_xxxx_0[j] - 0.5 * fl1_fx * fl1_fza * tg_y_xxxx_1[j] + 2.0 * fl1_fxn * tg_xy_xxx_1[j];

                    tg_xxy_xxxy_0[j] = pb_x * tg_xy_xxxy_0[j] + wp_x[j] * tg_xy_xxxy_1[j] + 0.5 * fl1_fx * tg_y_xxxy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_y_xxxy_1[j] + 1.5 * fl1_fxn * tg_xy_xxy_1[j];

                    tg_xxy_xxxz_0[j] = pb_x * tg_xy_xxxz_0[j] + wp_x[j] * tg_xy_xxxz_1[j] + 0.5 * fl1_fx * tg_y_xxxz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_y_xxxz_1[j] + 1.5 * fl1_fxn * tg_xy_xxz_1[j];

                    tg_xxy_xxyy_0[j] = pb_x * tg_xy_xxyy_0[j] + wp_x[j] * tg_xy_xxyy_1[j] + 0.5 * fl1_fx * tg_y_xxyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_y_xxyy_1[j] + fl1_fxn * tg_xy_xyy_1[j];

                    tg_xxy_xxyz_0[j] = pb_x * tg_xy_xxyz_0[j] + wp_x[j] * tg_xy_xxyz_1[j] + 0.5 * fl1_fx * tg_y_xxyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_y_xxyz_1[j] + fl1_fxn * tg_xy_xyz_1[j];

                    tg_xxy_xxzz_0[j] = pb_x * tg_xy_xxzz_0[j] + wp_x[j] * tg_xy_xxzz_1[j] + 0.5 * fl1_fx * tg_y_xxzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_y_xxzz_1[j] + fl1_fxn * tg_xy_xzz_1[j];

                    tg_xxy_xyyy_0[j] = pb_x * tg_xy_xyyy_0[j] + wp_x[j] * tg_xy_xyyy_1[j] + 0.5 * fl1_fx * tg_y_xyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_y_xyyy_1[j] + 0.5 * fl1_fxn * tg_xy_yyy_1[j];

                    tg_xxy_xyyz_0[j] = pb_x * tg_xy_xyyz_0[j] + wp_x[j] * tg_xy_xyyz_1[j] + 0.5 * fl1_fx * tg_y_xyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_y_xyyz_1[j] + 0.5 * fl1_fxn * tg_xy_yyz_1[j];

                    tg_xxy_xyzz_0[j] = pb_x * tg_xy_xyzz_0[j] + wp_x[j] * tg_xy_xyzz_1[j] + 0.5 * fl1_fx * tg_y_xyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_y_xyzz_1[j] + 0.5 * fl1_fxn * tg_xy_yzz_1[j];

                    tg_xxy_xzzz_0[j] = pb_x * tg_xy_xzzz_0[j] + wp_x[j] * tg_xy_xzzz_1[j] + 0.5 * fl1_fx * tg_y_xzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_y_xzzz_1[j] + 0.5 * fl1_fxn * tg_xy_zzz_1[j];

                    tg_xxy_yyyy_0[j] = pb_x * tg_xy_yyyy_0[j] + wp_x[j] * tg_xy_yyyy_1[j] + 0.5 * fl1_fx * tg_y_yyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_y_yyyy_1[j];

                    tg_xxy_yyyz_0[j] = pb_x * tg_xy_yyyz_0[j] + wp_x[j] * tg_xy_yyyz_1[j] + 0.5 * fl1_fx * tg_y_yyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_y_yyyz_1[j];

                    tg_xxy_yyzz_0[j] = pb_x * tg_xy_yyzz_0[j] + wp_x[j] * tg_xy_yyzz_1[j] + 0.5 * fl1_fx * tg_y_yyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_y_yyzz_1[j];

                    tg_xxy_yzzz_0[j] = pb_x * tg_xy_yzzz_0[j] + wp_x[j] * tg_xy_yzzz_1[j] + 0.5 * fl1_fx * tg_y_yzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_y_yzzz_1[j];

                    tg_xxy_zzzz_0[j] = pb_x * tg_xy_zzzz_0[j] + wp_x[j] * tg_xy_zzzz_1[j] + 0.5 * fl1_fx * tg_y_zzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_y_zzzz_1[j];

                    tg_xxz_xxxx_0[j] = pb_x * tg_xz_xxxx_0[j] + wp_x[j] * tg_xz_xxxx_1[j] + 0.5 * fl1_fx * tg_z_xxxx_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_xxxx_1[j] + 2.0 * fl1_fxn * tg_xz_xxx_1[j];

                    tg_xxz_xxxy_0[j] = pb_x * tg_xz_xxxy_0[j] + wp_x[j] * tg_xz_xxxy_1[j] + 0.5 * fl1_fx * tg_z_xxxy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_xxxy_1[j] + 1.5 * fl1_fxn * tg_xz_xxy_1[j];

                    tg_xxz_xxxz_0[j] = pb_x * tg_xz_xxxz_0[j] + wp_x[j] * tg_xz_xxxz_1[j] + 0.5 * fl1_fx * tg_z_xxxz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_xxxz_1[j] + 1.5 * fl1_fxn * tg_xz_xxz_1[j];

                    tg_xxz_xxyy_0[j] = pb_x * tg_xz_xxyy_0[j] + wp_x[j] * tg_xz_xxyy_1[j] + 0.5 * fl1_fx * tg_z_xxyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_xxyy_1[j] + fl1_fxn * tg_xz_xyy_1[j];

                    tg_xxz_xxyz_0[j] = pb_x * tg_xz_xxyz_0[j] + wp_x[j] * tg_xz_xxyz_1[j] + 0.5 * fl1_fx * tg_z_xxyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_xxyz_1[j] + fl1_fxn * tg_xz_xyz_1[j];

                    tg_xxz_xxzz_0[j] = pb_x * tg_xz_xxzz_0[j] + wp_x[j] * tg_xz_xxzz_1[j] + 0.5 * fl1_fx * tg_z_xxzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_xxzz_1[j] + fl1_fxn * tg_xz_xzz_1[j];

                    tg_xxz_xyyy_0[j] = pb_x * tg_xz_xyyy_0[j] + wp_x[j] * tg_xz_xyyy_1[j] + 0.5 * fl1_fx * tg_z_xyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_xyyy_1[j] + 0.5 * fl1_fxn * tg_xz_yyy_1[j];

                    tg_xxz_xyyz_0[j] = pb_x * tg_xz_xyyz_0[j] + wp_x[j] * tg_xz_xyyz_1[j] + 0.5 * fl1_fx * tg_z_xyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_xyyz_1[j] + 0.5 * fl1_fxn * tg_xz_yyz_1[j];

                    tg_xxz_xyzz_0[j] = pb_x * tg_xz_xyzz_0[j] + wp_x[j] * tg_xz_xyzz_1[j] + 0.5 * fl1_fx * tg_z_xyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_xyzz_1[j] + 0.5 * fl1_fxn * tg_xz_yzz_1[j];

                    tg_xxz_xzzz_0[j] = pb_x * tg_xz_xzzz_0[j] + wp_x[j] * tg_xz_xzzz_1[j] + 0.5 * fl1_fx * tg_z_xzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_xzzz_1[j] + 0.5 * fl1_fxn * tg_xz_zzz_1[j];

                    tg_xxz_yyyy_0[j] = pb_x * tg_xz_yyyy_0[j] + wp_x[j] * tg_xz_yyyy_1[j] + 0.5 * fl1_fx * tg_z_yyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_yyyy_1[j];

                    tg_xxz_yyyz_0[j] = pb_x * tg_xz_yyyz_0[j] + wp_x[j] * tg_xz_yyyz_1[j] + 0.5 * fl1_fx * tg_z_yyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_yyyz_1[j];

                    tg_xxz_yyzz_0[j] = pb_x * tg_xz_yyzz_0[j] + wp_x[j] * tg_xz_yyzz_1[j] + 0.5 * fl1_fx * tg_z_yyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_yyzz_1[j];

                    tg_xxz_yzzz_0[j] = pb_x * tg_xz_yzzz_0[j] + wp_x[j] * tg_xz_yzzz_1[j] + 0.5 * fl1_fx * tg_z_yzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_yzzz_1[j];

                    tg_xxz_zzzz_0[j] = pb_x * tg_xz_zzzz_0[j] + wp_x[j] * tg_xz_zzzz_1[j] + 0.5 * fl1_fx * tg_z_zzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_zzzz_1[j];

                    tg_xyy_xxxx_0[j] = pb_x * tg_yy_xxxx_0[j] + wp_x[j] * tg_yy_xxxx_1[j] + 2.0 * fl1_fxn * tg_yy_xxx_1[j];

                    tg_xyy_xxxy_0[j] = pb_x * tg_yy_xxxy_0[j] + wp_x[j] * tg_yy_xxxy_1[j] + 1.5 * fl1_fxn * tg_yy_xxy_1[j];

                    tg_xyy_xxxz_0[j] = pb_x * tg_yy_xxxz_0[j] + wp_x[j] * tg_yy_xxxz_1[j] + 1.5 * fl1_fxn * tg_yy_xxz_1[j];

                    tg_xyy_xxyy_0[j] = pb_x * tg_yy_xxyy_0[j] + wp_x[j] * tg_yy_xxyy_1[j] + fl1_fxn * tg_yy_xyy_1[j];

                    tg_xyy_xxyz_0[j] = pb_x * tg_yy_xxyz_0[j] + wp_x[j] * tg_yy_xxyz_1[j] + fl1_fxn * tg_yy_xyz_1[j];
                }
    ...
    void
    compElectronRepulsionForSFSG_50_100(      CMemBlock2D<double>& primBuffer,
                                        const CRecursionMap&       recursionMap,
                                        const CMemBlock2D<double>& osFactors,
                                        const CMemBlock2D<double>& wpDistances,
                                        const CGtoPairsBlock&      braGtoPairsBlock,
                                        ...
                                        const int32_t              iContrPair)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, fza, tg_xyy_xxzz_0, tg_xyy_xyyy_0, tg_xyy_xyyz_0, tg_xyy_xyzz_0, \
                                         tg_xyy_xzzz_0, tg_xyy_yyyy_0, tg_xyy_yyyz_0, tg_xyy_yyzz_0, tg_xyy_yzzz_0, \
                                         tg_xyy_zzzz_0, tg_xyz_xxxx_0, tg_xyz_xxxy_0, tg_xyz_xxxz_0, tg_xyz_xxyy_0, \
                                         tg_xyz_xxyz_0, tg_xyz_xxzz_0, tg_xyz_xyyy_0, tg_xyz_xyyz_0, tg_xyz_xyzz_0, \
                                         tg_xyz_xzzz_0, tg_xyz_yyyy_0, tg_xyz_yyyz_0, tg_xyz_yyzz_0, tg_xyz_yzzz_0, \
                                         tg_xyz_zzzz_0, tg_xzz_xxxx_0, tg_xzz_xxxy_0, tg_xzz_xxxz_0, tg_xzz_xxyy_0, \
                                         ...
                                         tg_y_xyzz_1, tg_y_xzzz_0, tg_y_xzzz_1, tg_yy_xxx_1, tg_yy_xxxx_0, tg_yy_xxxx_1, \
                                         tg_yy_xxxy_0, tg_yy_xxxy_1, tg_yy_xxxz_0, tg_yy_xxxz_1, tg_yy_xxy_1, tg_yy_xxyy_0, \
                                         ...
                                         tg_yy_zzzz_1, tg_yyy_xxxx_0, tg_yyy_xxxy_0, tg_yyy_xxxz_0, tg_yyy_xxyy_0, \
                                         tg_yyy_xxyz_0, tg_yyy_xxzz_0, tg_yyy_xyyy_0, tg_yyy_xyyz_0, tg_yyy_xyzz_0, \
                                         tg_yyy_xzzz_0, tg_yz_xxx_1, tg_yz_xxxx_0, tg_yz_xxxx_1, tg_yz_xxxy_0, tg_yz_xxxy_1, \
                                         ...
                                         tg_yz_yzzz_0, tg_yz_yzzz_1, tg_yz_zzz_1, tg_yz_zzzz_0, tg_yz_zzzz_1, tg_zz_xxx_1, \
                                         tg_zz_xxxx_0, tg_zz_xxxx_1, tg_zz_xxxy_0, tg_zz_xxxy_1, tg_zz_xxxz_0, tg_zz_xxxz_1, \
                                         tg_zz_xxy_1, tg_zz_xxyy_0, tg_zz_xxyy_1, tg_zz_xxyz_0, tg_zz_xxyz_1, tg_zz_xxz_1, \
                                         tg_zz_xxzz_0, tg_zz_xxzz_1, tg_zz_xyy_1, tg_zz_xyyy_0, tg_zz_xyyy_1, tg_zz_xyyz_0, \
                                         tg_zz_xyyz_1, tg_zz_xyz_1, tg_zz_xyzz_0, tg_zz_xyzz_1, tg_zz_xzz_1, tg_zz_xzzz_0, \
                                         tg_zz_xzzz_1, tg_zz_yyy_1, tg_zz_yyyy_0, tg_zz_yyyy_1, tg_zz_yyyz_0, tg_zz_yyyz_1, \
                                         tg_zz_yyz_1, tg_zz_yyzz_0, tg_zz_yyzz_1, tg_zz_yzz_1, tg_zz_yzzz_0, tg_zz_yzzz_1, \
                                         tg_zz_zzz_1, tg_zz_zzzz_0, tg_zz_zzzz_1, wp_x, wp_y: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fx = fx;
                    ...
                    tg_xyy_xxzz_0[j] = pb_x * tg_yy_xxzz_0[j] + wp_x[j] * tg_yy_xxzz_1[j] + fl1_fxn * tg_yy_xzz_1[j];

                    tg_xyy_xyyy_0[j] = pb_x * tg_yy_xyyy_0[j] + wp_x[j] * tg_yy_xyyy_1[j] + 0.5 * fl1_fxn * tg_yy_yyy_1[j];

                    tg_xyy_xyyz_0[j] = pb_x * tg_yy_xyyz_0[j] + wp_x[j] * tg_yy_xyyz_1[j] + 0.5 * fl1_fxn * tg_yy_yyz_1[j];

                    tg_xyy_xyzz_0[j] = pb_x * tg_yy_xyzz_0[j] + wp_x[j] * tg_yy_xyzz_1[j] + 0.5 * fl1_fxn * tg_yy_yzz_1[j];

                    tg_xyy_xzzz_0[j] = pb_x * tg_yy_xzzz_0[j] + wp_x[j] * tg_yy_xzzz_1[j] + 0.5 * fl1_fxn * tg_yy_zzz_1[j];

                    tg_xyy_yyyy_0[j] = pb_x * tg_yy_yyyy_0[j] + wp_x[j] * tg_yy_yyyy_1[j];

                    tg_xyy_yyyz_0[j] = pb_x * tg_yy_yyyz_0[j] + wp_x[j] * tg_yy_yyyz_1[j];

                    tg_xyy_yyzz_0[j] = pb_x * tg_yy_yyzz_0[j] + wp_x[j] * tg_yy_yyzz_1[j];

                    tg_xyy_yzzz_0[j] = pb_x * tg_yy_yzzz_0[j] + wp_x[j] * tg_yy_yzzz_1[j];

                    tg_xyy_zzzz_0[j] = pb_x * tg_yy_zzzz_0[j] + wp_x[j] * tg_yy_zzzz_1[j];

                    tg_xyz_xxxx_0[j] = pb_x * tg_yz_xxxx_0[j] + wp_x[j] * tg_yz_xxxx_1[j] + 2.0 * fl1_fxn * tg_yz_xxx_1[j];

                    tg_xyz_xxxy_0[j] = pb_x * tg_yz_xxxy_0[j] + wp_x[j] * tg_yz_xxxy_1[j] + 1.5 * fl1_fxn * tg_yz_xxy_1[j];

                    tg_xyz_xxxz_0[j] = pb_x * tg_yz_xxxz_0[j] + wp_x[j] * tg_yz_xxxz_1[j] + 1.5 * fl1_fxn * tg_yz_xxz_1[j];

                    tg_xyz_xxyy_0[j] = pb_x * tg_yz_xxyy_0[j] + wp_x[j] * tg_yz_xxyy_1[j] + fl1_fxn * tg_yz_xyy_1[j];

                    tg_xyz_xxyz_0[j] = pb_x * tg_yz_xxyz_0[j] + wp_x[j] * tg_yz_xxyz_1[j] + fl1_fxn * tg_yz_xyz_1[j];

                    tg_xyz_xxzz_0[j] = pb_x * tg_yz_xxzz_0[j] + wp_x[j] * tg_yz_xxzz_1[j] + fl1_fxn * tg_yz_xzz_1[j];

                    tg_xyz_xyyy_0[j] = pb_x * tg_yz_xyyy_0[j] + wp_x[j] * tg_yz_xyyy_1[j] + 0.5 * fl1_fxn * tg_yz_yyy_1[j];

                    tg_xyz_xyyz_0[j] = pb_x * tg_yz_xyyz_0[j] + wp_x[j] * tg_yz_xyyz_1[j] + 0.5 * fl1_fxn * tg_yz_yyz_1[j];

                    tg_xyz_xyzz_0[j] = pb_x * tg_yz_xyzz_0[j] + wp_x[j] * tg_yz_xyzz_1[j] + 0.5 * fl1_fxn * tg_yz_yzz_1[j];

                    tg_xyz_xzzz_0[j] = pb_x * tg_yz_xzzz_0[j] + wp_x[j] * tg_yz_xzzz_1[j] + 0.5 * fl1_fxn * tg_yz_zzz_1[j];

                    tg_xyz_yyyy_0[j] = pb_x * tg_yz_yyyy_0[j] + wp_x[j] * tg_yz_yyyy_1[j];

                    tg_xyz_yyyz_0[j] = pb_x * tg_yz_yyyz_0[j] + wp_x[j] * tg_yz_yyyz_1[j];

                    tg_xyz_yyzz_0[j] = pb_x * tg_yz_yyzz_0[j] + wp_x[j] * tg_yz_yyzz_1[j];

                    tg_xyz_yzzz_0[j] = pb_x * tg_yz_yzzz_0[j] + wp_x[j] * tg_yz_yzzz_1[j];

                    tg_xyz_zzzz_0[j] = pb_x * tg_yz_zzzz_0[j] + wp_x[j] * tg_yz_zzzz_1[j];

                    tg_xzz_xxxx_0[j] = pb_x * tg_zz_xxxx_0[j] + wp_x[j] * tg_zz_xxxx_1[j] + 2.0 * fl1_fxn * tg_zz_xxx_1[j];

                    tg_xzz_xxxy_0[j] = pb_x * tg_zz_xxxy_0[j] + wp_x[j] * tg_zz_xxxy_1[j] + 1.5 * fl1_fxn * tg_zz_xxy_1[j];

                    tg_xzz_xxxz_0[j] = pb_x * tg_zz_xxxz_0[j] + wp_x[j] * tg_zz_xxxz_1[j] + 1.5 * fl1_fxn * tg_zz_xxz_1[j];

                    tg_xzz_xxyy_0[j] = pb_x * tg_zz_xxyy_0[j] + wp_x[j] * tg_zz_xxyy_1[j] + fl1_fxn * tg_zz_xyy_1[j];

                    tg_xzz_xxyz_0[j] = pb_x * tg_zz_xxyz_0[j] + wp_x[j] * tg_zz_xxyz_1[j] + fl1_fxn * tg_zz_xyz_1[j];

                    tg_xzz_xxzz_0[j] = pb_x * tg_zz_xxzz_0[j] + wp_x[j] * tg_zz_xxzz_1[j] + fl1_fxn * tg_zz_xzz_1[j];

                    tg_xzz_xyyy_0[j] = pb_x * tg_zz_xyyy_0[j] + wp_x[j] * tg_zz_xyyy_1[j] + 0.5 * fl1_fxn * tg_zz_yyy_1[j];

                    tg_xzz_xyyz_0[j] = pb_x * tg_zz_xyyz_0[j] + wp_x[j] * tg_zz_xyyz_1[j] + 0.5 * fl1_fxn * tg_zz_yyz_1[j];

                    tg_xzz_xyzz_0[j] = pb_x * tg_zz_xyzz_0[j] + wp_x[j] * tg_zz_xyzz_1[j] + 0.5 * fl1_fxn * tg_zz_yzz_1[j];

                    tg_xzz_xzzz_0[j] = pb_x * tg_zz_xzzz_0[j] + wp_x[j] * tg_zz_xzzz_1[j] + 0.5 * fl1_fxn * tg_zz_zzz_1[j];

                    tg_xzz_yyyy_0[j] = pb_x * tg_zz_yyyy_0[j] + wp_x[j] * tg_zz_yyyy_1[j];

                    tg_xzz_yyyz_0[j] = pb_x * tg_zz_yyyz_0[j] + wp_x[j] * tg_zz_yyyz_1[j];

                    tg_xzz_yyzz_0[j] = pb_x * tg_zz_yyzz_0[j] + wp_x[j] * tg_zz_yyzz_1[j];

                    tg_xzz_yzzz_0[j] = pb_x * tg_zz_yzzz_0[j] + wp_x[j] * tg_zz_yzzz_1[j];

                    tg_xzz_zzzz_0[j] = pb_x * tg_zz_zzzz_0[j] + wp_x[j] * tg_zz_zzzz_1[j];

                    tg_yyy_xxxx_0[j] = pb_y * tg_yy_xxxx_0[j] + wp_y[j] * tg_yy_xxxx_1[j] + fl1_fx * tg_y_xxxx_0[j] - fl1_fx * fl1_fza * tg_y_xxxx_1[j];

                    tg_yyy_xxxy_0[j] = pb_y * tg_yy_xxxy_0[j] + wp_y[j] * tg_yy_xxxy_1[j] + fl1_fx * tg_y_xxxy_0[j] - fl1_fx * fl1_fza * tg_y_xxxy_1[j] + 0.5 * fl1_fxn * tg_yy_xxx_1[j];

                    tg_yyy_xxxz_0[j] = pb_y * tg_yy_xxxz_0[j] + wp_y[j] * tg_yy_xxxz_1[j] + fl1_fx * tg_y_xxxz_0[j] - fl1_fx * fl1_fza * tg_y_xxxz_1[j];

                    tg_yyy_xxyy_0[j] = pb_y * tg_yy_xxyy_0[j] + wp_y[j] * tg_yy_xxyy_1[j] + fl1_fx * tg_y_xxyy_0[j] - fl1_fx * fl1_fza * tg_y_xxyy_1[j] + fl1_fxn * tg_yy_xxy_1[j];

                    tg_yyy_xxyz_0[j] = pb_y * tg_yy_xxyz_0[j] + wp_y[j] * tg_yy_xxyz_1[j] + fl1_fx * tg_y_xxyz_0[j] - fl1_fx * fl1_fza * tg_y_xxyz_1[j] + 0.5 * fl1_fxn * tg_yy_xxz_1[j];

                    tg_yyy_xxzz_0[j] = pb_y * tg_yy_xxzz_0[j] + wp_y[j] * tg_yy_xxzz_1[j] + fl1_fx * tg_y_xxzz_0[j] - fl1_fx * fl1_fza * tg_y_xxzz_1[j];

                    tg_yyy_xyyy_0[j] = pb_y * tg_yy_xyyy_0[j] + wp_y[j] * tg_yy_xyyy_1[j] + fl1_fx * tg_y_xyyy_0[j] - fl1_fx * fl1_fza * tg_y_xyyy_1[j] + 1.5 * fl1_fxn * tg_yy_xyy_1[j];

                    tg_yyy_xyyz_0[j] = pb_y * tg_yy_xyyz_0[j] + wp_y[j] * tg_yy_xyyz_1[j] + fl1_fx * tg_y_xyyz_0[j] - fl1_fx * fl1_fza * tg_y_xyyz_1[j] + fl1_fxn * tg_yy_xyz_1[j];

                    tg_yyy_xyzz_0[j] = pb_y * tg_yy_xyzz_0[j] + wp_y[j] * tg_yy_xyzz_1[j] + fl1_fx * tg_y_xyzz_0[j] - fl1_fx * fl1_fza * tg_y_xyzz_1[j] + 0.5 * fl1_fxn * tg_yy_xzz_1[j];

                    tg_yyy_xzzz_0[j] = pb_y * tg_yy_xzzz_0[j] + wp_y[j] * tg_yy_xzzz_1[j] + fl1_fx * tg_y_xzzz_0[j] - fl1_fx * fl1_fza * tg_y_xzzz_1[j];
                }
    ...
    void
    compElectronRepulsionForSFSG_100_150(      CMemBlock2D<double>& primBuffer,
                                         const CRecursionMap&       recursionMap,
                                         const CMemBlock2D<double>& osFactors,
                                         const CMemBlock2D<double>& wpDistances,
                                         const CGtoPairsBlock&      braGtoPairsBlock,
                                         ...
                                         const int32_t              iContrPair)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, fza, tg_y_yyyy_0, tg_y_yyyy_1, tg_y_yyyz_0, tg_y_yyyz_1, \
                                         tg_y_yyzz_0, tg_y_yyzz_1, tg_y_yzzz_0, tg_y_yzzz_1, tg_y_zzzz_0, tg_y_zzzz_1, \
                                         tg_yy_yyy_1, tg_yy_yyyy_0, tg_yy_yyyy_1, tg_yy_yyyz_0, tg_yy_yyyz_1, tg_yy_yyz_1, \
                                         tg_yy_yyzz_0, tg_yy_yyzz_1, tg_yy_yzz_1, tg_yy_yzzz_0, tg_yy_yzzz_1, tg_yy_zzz_1, \
                                         tg_yy_zzzz_0, tg_yy_zzzz_1, tg_yyy_yyyy_0, tg_yyy_yyyz_0, tg_yyy_yyzz_0, \
                                         ...
                                         tg_yyz_yzzz_0, tg_yyz_zzzz_0, tg_yz_xxx_1, tg_yz_xxxx_0, tg_yz_xxxx_1, tg_yz_xxxy_0, \
                                         tg_yz_xxxy_1, tg_yz_xxxz_0, tg_yz_xxxz_1, tg_yz_xxy_1, tg_yz_xxyy_0, tg_yz_xxyy_1, \
                                         tg_yz_xxyz_0, tg_yz_xxyz_1, tg_yz_xxz_1, tg_yz_xxzz_0, tg_yz_xxzz_1, tg_yz_xyy_1, \
                                         tg_yz_xyyy_0, tg_yz_xyyy_1, tg_yz_xyyz_0, tg_yz_xyyz_1, tg_yz_xyz_1, tg_yz_xyzz_0, \
                                         tg_yz_xyzz_1, tg_yz_xzz_1, tg_yz_xzzz_0, tg_yz_xzzz_1, tg_yz_yyy_1, tg_yz_yyyy_0, \
                                         tg_yz_yyyy_1, tg_yz_yyyz_0, tg_yz_yyyz_1, tg_yz_yyz_1, tg_yz_yyzz_0, tg_yz_yyzz_1, \
                                         tg_yz_yzz_1, tg_yz_yzzz_0, tg_yz_yzzz_1, tg_yz_zzz_1, tg_yz_zzzz_0, tg_yz_zzzz_1, \
                                         tg_yzz_xxxx_0, tg_yzz_xxxy_0, tg_yzz_xxxz_0, tg_yzz_xxyy_0, tg_yzz_xxyz_0, \
                                         tg_yzz_xxzz_0, tg_yzz_xyyy_0, tg_yzz_xyyz_0, tg_yzz_xyzz_0, tg_yzz_xzzz_0, \
                                         tg_yzz_yyyy_0, tg_yzz_yyyz_0, tg_yzz_yyzz_0, tg_yzz_yzzz_0, tg_yzz_zzzz_0, \
                                         tg_z_xxxx_0, tg_z_xxxx_1, tg_z_xxxy_0, tg_z_xxxy_1, tg_z_xxxz_0, tg_z_xxxz_1, \
                                         tg_z_xxyy_0, tg_z_xxyy_1, tg_z_xxyz_0, tg_z_xxyz_1, tg_z_xxzz_0, tg_z_xxzz_1, \
                                         tg_z_xyyy_0, tg_z_xyyy_1, tg_z_xyyz_0, tg_z_xyyz_1, tg_z_xyzz_0, tg_z_xyzz_1, \
                                         tg_z_xzzz_0, tg_z_xzzz_1, tg_z_yyyy_0, tg_z_yyyy_1, tg_z_yyyz_0, tg_z_yyyz_1, \
                                         tg_z_yyzz_0, tg_z_yyzz_1, tg_z_yzzz_0, tg_z_yzzz_1, tg_z_zzzz_0, tg_z_zzzz_1, \
                                         tg_zz_xxx_1, tg_zz_xxxx_0, tg_zz_xxxx_1, tg_zz_xxxy_0, tg_zz_xxxy_1, tg_zz_xxxz_0, \
                                         tg_zz_xxxz_1, tg_zz_xxy_1, tg_zz_xxyy_0, tg_zz_xxyy_1, tg_zz_xxyz_0, tg_zz_xxyz_1, \
                                         tg_zz_xxz_1, tg_zz_xxzz_0, tg_zz_xxzz_1, tg_zz_xyy_1, tg_zz_xyyy_0, tg_zz_xyyy_1, \
                                         tg_zz_xyyz_0, tg_zz_xyyz_1, tg_zz_xyz_1, tg_zz_xyzz_0, tg_zz_xyzz_1, tg_zz_xzz_1, \
                                         tg_zz_xzzz_0, tg_zz_xzzz_1, tg_zz_yyy_1, tg_zz_yyyy_0, tg_zz_yyyy_1, tg_zz_yyyz_0, \
                                         tg_zz_yyyz_1, tg_zz_yyz_1, tg_zz_yyzz_0, tg_zz_yyzz_1, tg_zz_yzz_1, tg_zz_yzzz_0, \
                                         tg_zz_yzzz_1, tg_zz_zzz_1, tg_zz_zzzz_0, tg_zz_zzzz_1, tg_zzz_xxxx_0, \
                                         tg_zzz_xxxy_0, tg_zzz_xxxz_0, tg_zzz_xxyy_0, tg_zzz_xxyz_0, tg_zzz_xxzz_0, \
                                         tg_zzz_xyyy_0, tg_zzz_xyyz_0, tg_zzz_xyzz_0, tg_zzz_xzzz_0, tg_zzz_yyyy_0, \
                                         tg_zzz_yyyz_0, tg_zzz_yyzz_0, tg_zzz_yzzz_0, tg_zzz_zzzz_0, wp_y, wp_z: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fx = fx;
                    ...
                    tg_yyy_yyyy_0[j] = pb_y * tg_yy_yyyy_0[j] + wp_y[j] * tg_yy_yyyy_1[j] + fl1_fx * tg_y_yyyy_0[j] - fl1_fx * fl1_fza * tg_y_yyyy_1[j] + 2.0 * fl1_fxn * tg_yy_yyy_1[j];

                    tg_yyy_yyyz_0[j] = pb_y * tg_yy_yyyz_0[j] + wp_y[j] * tg_yy_yyyz_1[j] + fl1_fx * tg_y_yyyz_0[j] - fl1_fx * fl1_fza * tg_y_yyyz_1[j] + 1.5 * fl1_fxn * tg_yy_yyz_1[j];

                    tg_yyy_yyzz_0[j] = pb_y * tg_yy_yyzz_0[j] + wp_y[j] * tg_yy_yyzz_1[j] + fl1_fx * tg_y_yyzz_0[j] - fl1_fx * fl1_fza * tg_y_yyzz_1[j] + fl1_fxn * tg_yy_yzz_1[j];

                    tg_yyy_yzzz_0[j] = pb_y * tg_yy_yzzz_0[j] + wp_y[j] * tg_yy_yzzz_1[j] + fl1_fx * tg_y_yzzz_0[j] - fl1_fx * fl1_fza * tg_y_yzzz_1[j] + 0.5 * fl1_fxn * tg_yy_zzz_1[j];

                    tg_yyy_zzzz_0[j] = pb_y * tg_yy_zzzz_0[j] + wp_y[j] * tg_yy_zzzz_1[j] + fl1_fx * tg_y_zzzz_0[j] - fl1_fx * fl1_fza * tg_y_zzzz_1[j];

                    tg_yyz_xxxx_0[j] = pb_y * tg_yz_xxxx_0[j] + wp_y[j] * tg_yz_xxxx_1[j] + 0.5 * fl1_fx * tg_z_xxxx_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_xxxx_1[j];

                    tg_yyz_xxxy_0[j] = pb_y * tg_yz_xxxy_0[j] + wp_y[j] * tg_yz_xxxy_1[j] + 0.5 * fl1_fx * tg_z_xxxy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_xxxy_1[j] + 0.5 * fl1_fxn * tg_yz_xxx_1[j];

                    tg_yyz_xxxz_0[j] = pb_y * tg_yz_xxxz_0[j] + wp_y[j] * tg_yz_xxxz_1[j] + 0.5 * fl1_fx * tg_z_xxxz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_xxxz_1[j];

                    tg_yyz_xxyy_0[j] = pb_y * tg_yz_xxyy_0[j] + wp_y[j] * tg_yz_xxyy_1[j] + 0.5 * fl1_fx * tg_z_xxyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_xxyy_1[j] + fl1_fxn * tg_yz_xxy_1[j];

                    tg_yyz_xxyz_0[j] = pb_y * tg_yz_xxyz_0[j] + wp_y[j] * tg_yz_xxyz_1[j] + 0.5 * fl1_fx * tg_z_xxyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_xxyz_1[j] + 0.5 * fl1_fxn * tg_yz_xxz_1[j];

                    tg_yyz_xxzz_0[j] = pb_y * tg_yz_xxzz_0[j] + wp_y[j] * tg_yz_xxzz_1[j] + 0.5 * fl1_fx * tg_z_xxzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_xxzz_1[j];

                    tg_yyz_xyyy_0[j] = pb_y * tg_yz_xyyy_0[j] + wp_y[j] * tg_yz_xyyy_1[j] + 0.5 * fl1_fx * tg_z_xyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_xyyy_1[j] + 1.5 * fl1_fxn * tg_yz_xyy_1[j];

                    tg_yyz_xyyz_0[j] = pb_y * tg_yz_xyyz_0[j] + wp_y[j] * tg_yz_xyyz_1[j] + 0.5 * fl1_fx * tg_z_xyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_xyyz_1[j] + fl1_fxn * tg_yz_xyz_1[j];

                    tg_yyz_xyzz_0[j] = pb_y * tg_yz_xyzz_0[j] + wp_y[j] * tg_yz_xyzz_1[j] + 0.5 * fl1_fx * tg_z_xyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_xyzz_1[j] + 0.5 * fl1_fxn * tg_yz_xzz_1[j];

                    tg_yyz_xzzz_0[j] = pb_y * tg_yz_xzzz_0[j] + wp_y[j] * tg_yz_xzzz_1[j] + 0.5 * fl1_fx * tg_z_xzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_xzzz_1[j];

                    tg_yyz_yyyy_0[j] = pb_y * tg_yz_yyyy_0[j] + wp_y[j] * tg_yz_yyyy_1[j] + 0.5 * fl1_fx * tg_z_yyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_yyyy_1[j] + 2.0 * fl1_fxn * tg_yz_yyy_1[j];

                    tg_yyz_yyyz_0[j] = pb_y * tg_yz_yyyz_0[j] + wp_y[j] * tg_yz_yyyz_1[j] + 0.5 * fl1_fx * tg_z_yyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_yyyz_1[j] + 1.5 * fl1_fxn * tg_yz_yyz_1[j];

                    tg_yyz_yyzz_0[j] = pb_y * tg_yz_yyzz_0[j] + wp_y[j] * tg_yz_yyzz_1[j] + 0.5 * fl1_fx * tg_z_yyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_yyzz_1[j] + fl1_fxn * tg_yz_yzz_1[j];

                    tg_yyz_yzzz_0[j] = pb_y * tg_yz_yzzz_0[j] + wp_y[j] * tg_yz_yzzz_1[j] + 0.5 * fl1_fx * tg_z_yzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_yzzz_1[j] + 0.5 * fl1_fxn * tg_yz_zzz_1[j];

                    tg_yyz_zzzz_0[j] = pb_y * tg_yz_zzzz_0[j] + wp_y[j] * tg_yz_zzzz_1[j] + 0.5 * fl1_fx * tg_z_zzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_z_zzzz_1[j];

                    tg_yzz_xxxx_0[j] = pb_y * tg_zz_xxxx_0[j] + wp_y[j] * tg_zz_xxxx_1[j];

                    tg_yzz_xxxy_0[j] = pb_y * tg_zz_xxxy_0[j] + wp_y[j] * tg_zz_xxxy_1[j] + 0.5 * fl1_fxn * tg_zz_xxx_1[j];

                    tg_yzz_xxxz_0[j] = pb_y * tg_zz_xxxz_0[j] + wp_y[j] * tg_zz_xxxz_1[j];

                    tg_yzz_xxyy_0[j] = pb_y * tg_zz_xxyy_0[j] + wp_y[j] * tg_zz_xxyy_1[j] + fl1_fxn * tg_zz_xxy_1[j];

                    tg_yzz_xxyz_0[j] = pb_y * tg_zz_xxyz_0[j] + wp_y[j] * tg_zz_xxyz_1[j] + 0.5 * fl1_fxn * tg_zz_xxz_1[j];

                    tg_yzz_xxzz_0[j] = pb_y * tg_zz_xxzz_0[j] + wp_y[j] * tg_zz_xxzz_1[j];

                    tg_yzz_xyyy_0[j] = pb_y * tg_zz_xyyy_0[j] + wp_y[j] * tg_zz_xyyy_1[j] + 1.5 * fl1_fxn * tg_zz_xyy_1[j];

                    tg_yzz_xyyz_0[j] = pb_y * tg_zz_xyyz_0[j] + wp_y[j] * tg_zz_xyyz_1[j] + fl1_fxn * tg_zz_xyz_1[j];

                    tg_yzz_xyzz_0[j] = pb_y * tg_zz_xyzz_0[j] + wp_y[j] * tg_zz_xyzz_1[j] + 0.5 * fl1_fxn * tg_zz_xzz_1[j];

                    tg_yzz_xzzz_0[j] = pb_y * tg_zz_xzzz_0[j] + wp_y[j] * tg_zz_xzzz_1[j];

                    tg_yzz_yyyy_0[j] = pb_y * tg_zz_yyyy_0[j] + wp_y[j] * tg_zz_yyyy_1[j] + 2.0 * fl1_fxn * tg_zz_yyy_1[j];

                    tg_yzz_yyyz_0[j] = pb_y * tg_zz_yyyz_0[j] + wp_y[j] * tg_zz_yyyz_1[j] + 1.5 * fl1_fxn * tg_zz_yyz_1[j];

                    tg_yzz_yyzz_0[j] = pb_y * tg_zz_yyzz_0[j] + wp_y[j] * tg_zz_yyzz_1[j] + fl1_fxn * tg_zz_yzz_1[j];

                    tg_yzz_yzzz_0[j] = pb_y * tg_zz_yzzz_0[j] + wp_y[j] * tg_zz_yzzz_1[j] + 0.5 * fl1_fxn * tg_zz_zzz_1[j];

                    tg_yzz_zzzz_0[j] = pb_y * tg_zz_zzzz_0[j] + wp_y[j] * tg_zz_zzzz_1[j];

                    tg_zzz_xxxx_0[j] = pb_z * tg_zz_xxxx_0[j] + wp_z[j] * tg_zz_xxxx_1[j] + fl1_fx * tg_z_xxxx_0[j] - fl1_fx * fl1_fza * tg_z_xxxx_1[j];

                    tg_zzz_xxxy_0[j] = pb_z * tg_zz_xxxy_0[j] + wp_z[j] * tg_zz_xxxy_1[j] + fl1_fx * tg_z_xxxy_0[j] - fl1_fx * fl1_fza * tg_z_xxxy_1[j];

                    tg_zzz_xxxz_0[j] = pb_z * tg_zz_xxxz_0[j] + wp_z[j] * tg_zz_xxxz_1[j] + fl1_fx * tg_z_xxxz_0[j] - fl1_fx * fl1_fza * tg_z_xxxz_1[j] + 0.5 * fl1_fxn * tg_zz_xxx_1[j];

                    tg_zzz_xxyy_0[j] = pb_z * tg_zz_xxyy_0[j] + wp_z[j] * tg_zz_xxyy_1[j] + fl1_fx * tg_z_xxyy_0[j] - fl1_fx * fl1_fza * tg_z_xxyy_1[j];

                    tg_zzz_xxyz_0[j] = pb_z * tg_zz_xxyz_0[j] + wp_z[j] * tg_zz_xxyz_1[j] + fl1_fx * tg_z_xxyz_0[j] - fl1_fx * fl1_fza * tg_z_xxyz_1[j] + 0.5 * fl1_fxn * tg_zz_xxy_1[j];

                    tg_zzz_xxzz_0[j] = pb_z * tg_zz_xxzz_0[j] + wp_z[j] * tg_zz_xxzz_1[j] + fl1_fx * tg_z_xxzz_0[j] - fl1_fx * fl1_fza * tg_z_xxzz_1[j] + fl1_fxn * tg_zz_xxz_1[j];

                    tg_zzz_xyyy_0[j] = pb_z * tg_zz_xyyy_0[j] + wp_z[j] * tg_zz_xyyy_1[j] + fl1_fx * tg_z_xyyy_0[j] - fl1_fx * fl1_fza * tg_z_xyyy_1[j];

                    tg_zzz_xyyz_0[j] = pb_z * tg_zz_xyyz_0[j] + wp_z[j] * tg_zz_xyyz_1[j] + fl1_fx * tg_z_xyyz_0[j] - fl1_fx * fl1_fza * tg_z_xyyz_1[j] + 0.5 * fl1_fxn * tg_zz_xyy_1[j];

                    tg_zzz_xyzz_0[j] = pb_z * tg_zz_xyzz_0[j] + wp_z[j] * tg_zz_xyzz_1[j] + fl1_fx * tg_z_xyzz_0[j] - fl1_fx * fl1_fza * tg_z_xyzz_1[j] + fl1_fxn * tg_zz_xyz_1[j];

                    tg_zzz_xzzz_0[j] = pb_z * tg_zz_xzzz_0[j] + wp_z[j] * tg_zz_xzzz_1[j] + fl1_fx * tg_z_xzzz_0[j] - fl1_fx * fl1_fza * tg_z_xzzz_1[j] + 1.5 * fl1_fxn * tg_zz_xzz_1[j];

                    tg_zzz_yyyy_0[j] = pb_z * tg_zz_yyyy_0[j] + wp_z[j] * tg_zz_yyyy_1[j] + fl1_fx * tg_z_yyyy_0[j] - fl1_fx * fl1_fza * tg_z_yyyy_1[j];

                    tg_zzz_yyyz_0[j] = pb_z * tg_zz_yyyz_0[j] + wp_z[j] * tg_zz_yyyz_1[j] + fl1_fx * tg_z_yyyz_0[j] - fl1_fx * fl1_fza * tg_z_yyyz_1[j] + 0.5 * fl1_fxn * tg_zz_yyy_1[j];

                    tg_zzz_yyzz_0[j] = pb_z * tg_zz_yyzz_0[j] + wp_z[j] * tg_zz_yyzz_1[j] + fl1_fx * tg_z_yyzz_0[j] - fl1_fx * fl1_fza * tg_z_yyzz_1[j] + fl1_fxn * tg_zz_yyz_1[j];

                    tg_zzz_yzzz_0[j] = pb_z * tg_zz_yzzz_0[j] + wp_z[j] * tg_zz_yzzz_1[j] + fl1_fx * tg_z_yzzz_0[j] - fl1_fx * fl1_fza * tg_z_yzzz_1[j] + 1.5 * fl1_fxn * tg_zz_yzz_1[j];

                    tg_zzz_zzzz_0[j] = pb_z * tg_zz_zzzz_0[j] + wp_z[j] * tg_zz_zzzz_1[j] + fl1_fx * tg_z_zzzz_0[j] - fl1_fx * fl1_fza * tg_z_zzzz_1[j] + 2.0 * fl1_fxn * tg_zz_zzz_1[j];
                }
