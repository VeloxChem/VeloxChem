        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    ...
                    tg_xxxxx_xxxx_0[j] = pb_x * tg_xxxx_xxxx_0[j] + fr * tg_xxxx_xxxx_1[j] + 2.0 * fl1_fx * (tg_xxx_xxxx_0[j] - tg_xxx_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xxxx_xxx_1[j];

                    tg_xxxxx_xxxy_0[j] = pb_x * tg_xxxx_xxxy_0[j] + fr * tg_xxxx_xxxy_1[j] + 2.0 * fl1_fx * (tg_xxx_xxxy_0[j] - tg_xxx_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxxx_xxy_1[j];

                    tg_xxxxx_xxxz_0[j] = pb_x * tg_xxxx_xxxz_0[j] + fr * tg_xxxx_xxxz_1[j] + 2.0 * fl1_fx * (tg_xxx_xxxz_0[j] - tg_xxx_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxxx_xxz_1[j];

                    tg_xxxxx_xxyy_0[j] = pb_x * tg_xxxx_xxyy_0[j] + fr * tg_xxxx_xxyy_1[j] + 2.0 * fl1_fx * (tg_xxx_xxyy_0[j] - tg_xxx_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xxxx_xyy_1[j];

                    tg_xxxxx_xxyz_0[j] = pb_x * tg_xxxx_xxyz_0[j] + fr * tg_xxxx_xxyz_1[j] + 2.0 * fl1_fx * (tg_xxx_xxyz_0[j] - tg_xxx_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xxxx_xyz_1[j];

                    tg_xxxxx_xxzz_0[j] = pb_x * tg_xxxx_xxzz_0[j] + fr * tg_xxxx_xxzz_1[j] + 2.0 * fl1_fx * (tg_xxx_xxzz_0[j] - tg_xxx_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xxxx_xzz_1[j];

                    tg_xxxxx_xyyy_0[j] = pb_x * tg_xxxx_xyyy_0[j] + fr * tg_xxxx_xyyy_1[j] + 2.0 * fl1_fx * (tg_xxx_xyyy_0[j] - tg_xxx_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxx_yyy_1[j];

                    tg_xxxxx_xyyz_0[j] = pb_x * tg_xxxx_xyyz_0[j] + fr * tg_xxxx_xyyz_1[j] + 2.0 * fl1_fx * (tg_xxx_xyyz_0[j] - tg_xxx_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxx_yyz_1[j];

                    tg_xxxxx_xyzz_0[j] = pb_x * tg_xxxx_xyzz_0[j] + fr * tg_xxxx_xyzz_1[j] + 2.0 * fl1_fx * (tg_xxx_xyzz_0[j] - tg_xxx_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxx_yzz_1[j];

                    tg_xxxxx_xzzz_0[j] = pb_x * tg_xxxx_xzzz_0[j] + fr * tg_xxxx_xzzz_1[j] + 2.0 * fl1_fx * (tg_xxx_xzzz_0[j] - tg_xxx_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxx_zzz_1[j];

                    tg_xxxxx_yyyy_0[j] = pb_x * tg_xxxx_yyyy_0[j] + fr * tg_xxxx_yyyy_1[j] + 2.0 * fl1_fx * (tg_xxx_yyyy_0[j] - tg_xxx_yyyy_1[j] * fl1_fza);

                    tg_xxxxx_yyyz_0[j] = pb_x * tg_xxxx_yyyz_0[j] + fr * tg_xxxx_yyyz_1[j] + 2.0 * fl1_fx * (tg_xxx_yyyz_0[j] - tg_xxx_yyyz_1[j] * fl1_fza);

                    tg_xxxxx_yyzz_0[j] = pb_x * tg_xxxx_yyzz_0[j] + fr * tg_xxxx_yyzz_1[j] + 2.0 * fl1_fx * (tg_xxx_yyzz_0[j] - tg_xxx_yyzz_1[j] * fl1_fza);

                    tg_xxxxx_yzzz_0[j] = pb_x * tg_xxxx_yzzz_0[j] + fr * tg_xxxx_yzzz_1[j] + 2.0 * fl1_fx * (tg_xxx_yzzz_0[j] - tg_xxx_yzzz_1[j] * fl1_fza);

                    tg_xxxxx_zzzz_0[j] = pb_x * tg_xxxx_zzzz_0[j] + fr * tg_xxxx_zzzz_1[j] + 2.0 * fl1_fx * (tg_xxx_zzzz_0[j] - tg_xxx_zzzz_1[j] * fl1_fza);

                    tg_xxxxy_xxxx_0[j] = pb_x * tg_xxxy_xxxx_0[j] + fr * tg_xxxy_xxxx_1[j] + 1.5 * fl1_fx * (tg_xxy_xxxx_0[j] - tg_xxy_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xxxy_xxx_1[j];

                    tg_xxxxy_xxxy_0[j] = pb_x * tg_xxxy_xxxy_0[j] + fr * tg_xxxy_xxxy_1[j] + 1.5 * fl1_fx * (tg_xxy_xxxy_0[j] - tg_xxy_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxxy_xxy_1[j];

                    tg_xxxxy_xxxz_0[j] = pb_x * tg_xxxy_xxxz_0[j] + fr * tg_xxxy_xxxz_1[j] + 1.5 * fl1_fx * (tg_xxy_xxxz_0[j] - tg_xxy_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxxy_xxz_1[j];

                    tg_xxxxy_xxyy_0[j] = pb_x * tg_xxxy_xxyy_0[j] + fr * tg_xxxy_xxyy_1[j] + 1.5 * fl1_fx * (tg_xxy_xxyy_0[j] - tg_xxy_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xxxy_xyy_1[j];

                    tg_xxxxy_xxyz_0[j] = pb_x * tg_xxxy_xxyz_0[j] + fr * tg_xxxy_xxyz_1[j] + 1.5 * fl1_fx * (tg_xxy_xxyz_0[j] - tg_xxy_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xxxy_xyz_1[j];

                    tg_xxxxy_xxzz_0[j] = pb_x * tg_xxxy_xxzz_0[j] + fr * tg_xxxy_xxzz_1[j] + 1.5 * fl1_fx * (tg_xxy_xxzz_0[j] - tg_xxy_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xxxy_xzz_1[j];

                    tg_xxxxy_xyyy_0[j] = pb_x * tg_xxxy_xyyy_0[j] + fr * tg_xxxy_xyyy_1[j] + 1.5 * fl1_fx * (tg_xxy_xyyy_0[j] - tg_xxy_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxy_yyy_1[j];

                    tg_xxxxy_xyyz_0[j] = pb_x * tg_xxxy_xyyz_0[j] + fr * tg_xxxy_xyyz_1[j] + 1.5 * fl1_fx * (tg_xxy_xyyz_0[j] - tg_xxy_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxy_yyz_1[j];

                    tg_xxxxy_xyzz_0[j] = pb_x * tg_xxxy_xyzz_0[j] + fr * tg_xxxy_xyzz_1[j] + 1.5 * fl1_fx * (tg_xxy_xyzz_0[j] - tg_xxy_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxy_yzz_1[j];

                    tg_xxxxy_xzzz_0[j] = pb_x * tg_xxxy_xzzz_0[j] + fr * tg_xxxy_xzzz_1[j] + 1.5 * fl1_fx * (tg_xxy_xzzz_0[j] - tg_xxy_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxy_zzz_1[j];

                    tg_xxxxy_yyyy_0[j] = pb_x * tg_xxxy_yyyy_0[j] + fr * tg_xxxy_yyyy_1[j] + 1.5 * fl1_fx * (tg_xxy_yyyy_0[j] - tg_xxy_yyyy_1[j] * fl1_fza);

                    tg_xxxxy_yyyz_0[j] = pb_x * tg_xxxy_yyyz_0[j] + fr * tg_xxxy_yyyz_1[j] + 1.5 * fl1_fx * (tg_xxy_yyyz_0[j] - tg_xxy_yyyz_1[j] * fl1_fza);

                    tg_xxxxy_yyzz_0[j] = pb_x * tg_xxxy_yyzz_0[j] + fr * tg_xxxy_yyzz_1[j] + 1.5 * fl1_fx * (tg_xxy_yyzz_0[j] - tg_xxy_yyzz_1[j] * fl1_fza);

                    tg_xxxxy_yzzz_0[j] = pb_x * tg_xxxy_yzzz_0[j] + fr * tg_xxxy_yzzz_1[j] + 1.5 * fl1_fx * (tg_xxy_yzzz_0[j] - tg_xxy_yzzz_1[j] * fl1_fza);

                    tg_xxxxy_zzzz_0[j] = pb_x * tg_xxxy_zzzz_0[j] + fr * tg_xxxy_zzzz_1[j] + 1.5 * fl1_fx * (tg_xxy_zzzz_0[j] - tg_xxy_zzzz_1[j] * fl1_fza);

                    tg_xxxxz_xxxx_0[j] = pb_x * tg_xxxz_xxxx_0[j] + fr * tg_xxxz_xxxx_1[j] + 1.5 * fl1_fx * (tg_xxz_xxxx_0[j] - tg_xxz_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xxxz_xxx_1[j];

                    tg_xxxxz_xxxy_0[j] = pb_x * tg_xxxz_xxxy_0[j] + fr * tg_xxxz_xxxy_1[j] + 1.5 * fl1_fx * (tg_xxz_xxxy_0[j] - tg_xxz_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxxz_xxy_1[j];

                    tg_xxxxz_xxxz_0[j] = pb_x * tg_xxxz_xxxz_0[j] + fr * tg_xxxz_xxxz_1[j] + 1.5 * fl1_fx * (tg_xxz_xxxz_0[j] - tg_xxz_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxxz_xxz_1[j];

                    tg_xxxxz_xxyy_0[j] = pb_x * tg_xxxz_xxyy_0[j] + fr * tg_xxxz_xxyy_1[j] + 1.5 * fl1_fx * (tg_xxz_xxyy_0[j] - tg_xxz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xxxz_xyy_1[j];

                    tg_xxxxz_xxyz_0[j] = pb_x * tg_xxxz_xxyz_0[j] + fr * tg_xxxz_xxyz_1[j] + 1.5 * fl1_fx * (tg_xxz_xxyz_0[j] - tg_xxz_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xxxz_xyz_1[j];

                    tg_xxxxz_xxzz_0[j] = pb_x * tg_xxxz_xxzz_0[j] + fr * tg_xxxz_xxzz_1[j] + 1.5 * fl1_fx * (tg_xxz_xxzz_0[j] - tg_xxz_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xxxz_xzz_1[j];

                    tg_xxxxz_xyyy_0[j] = pb_x * tg_xxxz_xyyy_0[j] + fr * tg_xxxz_xyyy_1[j] + 1.5 * fl1_fx * (tg_xxz_xyyy_0[j] - tg_xxz_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxz_yyy_1[j];

                    tg_xxxxz_xyyz_0[j] = pb_x * tg_xxxz_xyyz_0[j] + fr * tg_xxxz_xyyz_1[j] + 1.5 * fl1_fx * (tg_xxz_xyyz_0[j] - tg_xxz_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxz_yyz_1[j];

                    tg_xxxxz_xyzz_0[j] = pb_x * tg_xxxz_xyzz_0[j] + fr * tg_xxxz_xyzz_1[j] + 1.5 * fl1_fx * (tg_xxz_xyzz_0[j] - tg_xxz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxz_yzz_1[j];

                    tg_xxxxz_xzzz_0[j] = pb_x * tg_xxxz_xzzz_0[j] + fr * tg_xxxz_xzzz_1[j] + 1.5 * fl1_fx * (tg_xxz_xzzz_0[j] - tg_xxz_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxz_zzz_1[j];

                    tg_xxxxz_yyyy_0[j] = pb_x * tg_xxxz_yyyy_0[j] + fr * tg_xxxz_yyyy_1[j] + 1.5 * fl1_fx * (tg_xxz_yyyy_0[j] - tg_xxz_yyyy_1[j] * fl1_fza);

                    tg_xxxxz_yyyz_0[j] = pb_x * tg_xxxz_yyyz_0[j] + fr * tg_xxxz_yyyz_1[j] + 1.5 * fl1_fx * (tg_xxz_yyyz_0[j] - tg_xxz_yyyz_1[j] * fl1_fza);

                    tg_xxxxz_yyzz_0[j] = pb_x * tg_xxxz_yyzz_0[j] + fr * tg_xxxz_yyzz_1[j] + 1.5 * fl1_fx * (tg_xxz_yyzz_0[j] - tg_xxz_yyzz_1[j] * fl1_fza);

                    tg_xxxxz_yzzz_0[j] = pb_x * tg_xxxz_yzzz_0[j] + fr * tg_xxxz_yzzz_1[j] + 1.5 * fl1_fx * (tg_xxz_yzzz_0[j] - tg_xxz_yzzz_1[j] * fl1_fza);

                    tg_xxxxz_zzzz_0[j] = pb_x * tg_xxxz_zzzz_0[j] + fr * tg_xxxz_zzzz_1[j] + 1.5 * fl1_fx * (tg_xxz_zzzz_0[j] - tg_xxz_zzzz_1[j] * fl1_fza);

                    tg_xxxyy_xxxx_0[j] = pb_x * tg_xxyy_xxxx_0[j] + fr * tg_xxyy_xxxx_1[j] + fl1_fx * (tg_xyy_xxxx_0[j] - tg_xyy_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xxyy_xxx_1[j];

                    tg_xxxyy_xxxy_0[j] = pb_x * tg_xxyy_xxxy_0[j] + fr * tg_xxyy_xxxy_1[j] + fl1_fx * (tg_xyy_xxxy_0[j] - tg_xyy_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxyy_xxy_1[j];

                    tg_xxxyy_xxxz_0[j] = pb_x * tg_xxyy_xxxz_0[j] + fr * tg_xxyy_xxxz_1[j] + fl1_fx * (tg_xyy_xxxz_0[j] - tg_xyy_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxyy_xxz_1[j];

                    tg_xxxyy_xxyy_0[j] = pb_x * tg_xxyy_xxyy_0[j] + fr * tg_xxyy_xxyy_1[j] + fl1_fx * (tg_xyy_xxyy_0[j] - tg_xyy_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xxyy_xyy_1[j];

                    tg_xxxyy_xxyz_0[j] = pb_x * tg_xxyy_xxyz_0[j] + fr * tg_xxyy_xxyz_1[j] + fl1_fx * (tg_xyy_xxyz_0[j] - tg_xyy_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xxyy_xyz_1[j];

                    tg_xxxyy_xxzz_0[j] = pb_x * tg_xxyy_xxzz_0[j] + fr * tg_xxyy_xxzz_1[j] + fl1_fx * (tg_xyy_xxzz_0[j] - tg_xyy_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xxyy_xzz_1[j];

                    tg_xxxyy_xyyy_0[j] = pb_x * tg_xxyy_xyyy_0[j] + fr * tg_xxyy_xyyy_1[j] + fl1_fx * (tg_xyy_xyyy_0[j] - tg_xyy_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxyy_yyy_1[j];

                    tg_xxxyy_xyyz_0[j] = pb_x * tg_xxyy_xyyz_0[j] + fr * tg_xxyy_xyyz_1[j] + fl1_fx * (tg_xyy_xyyz_0[j] - tg_xyy_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxyy_yyz_1[j];

                    tg_xxxyy_xyzz_0[j] = pb_x * tg_xxyy_xyzz_0[j] + fr * tg_xxyy_xyzz_1[j] + fl1_fx * (tg_xyy_xyzz_0[j] - tg_xyy_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxyy_yzz_1[j];

                    tg_xxxyy_xzzz_0[j] = pb_x * tg_xxyy_xzzz_0[j] + fr * tg_xxyy_xzzz_1[j] + fl1_fx * (tg_xyy_xzzz_0[j] - tg_xyy_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxyy_zzz_1[j];

                    tg_xxxyy_yyyy_0[j] = pb_x * tg_xxyy_yyyy_0[j] + fr * tg_xxyy_yyyy_1[j] + fl1_fx * (tg_xyy_yyyy_0[j] - tg_xyy_yyyy_1[j] * fl1_fza);

                    tg_xxxyy_yyyz_0[j] = pb_x * tg_xxyy_yyyz_0[j] + fr * tg_xxyy_yyyz_1[j] + fl1_fx * (tg_xyy_yyyz_0[j] - tg_xyy_yyyz_1[j] * fl1_fza);

                    tg_xxxyy_yyzz_0[j] = pb_x * tg_xxyy_yyzz_0[j] + fr * tg_xxyy_yyzz_1[j] + fl1_fx * (tg_xyy_yyzz_0[j] - tg_xyy_yyzz_1[j] * fl1_fza);

                    tg_xxxyy_yzzz_0[j] = pb_x * tg_xxyy_yzzz_0[j] + fr * tg_xxyy_yzzz_1[j] + fl1_fx * (tg_xyy_yzzz_0[j] - tg_xyy_yzzz_1[j] * fl1_fza);

                    tg_xxxyy_zzzz_0[j] = pb_x * tg_xxyy_zzzz_0[j] + fr * tg_xxyy_zzzz_1[j] + fl1_fx * (tg_xyy_zzzz_0[j] - tg_xyy_zzzz_1[j] * fl1_fza);

                    tg_xxxyz_xxxx_0[j] = pb_x * tg_xxyz_xxxx_0[j] + fr * tg_xxyz_xxxx_1[j] + fl1_fx * (tg_xyz_xxxx_0[j] - tg_xyz_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xxyz_xxx_1[j];

                    tg_xxxyz_xxxy_0[j] = pb_x * tg_xxyz_xxxy_0[j] + fr * tg_xxyz_xxxy_1[j] + fl1_fx * (tg_xyz_xxxy_0[j] - tg_xyz_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxyz_xxy_1[j];

                    tg_xxxyz_xxxz_0[j] = pb_x * tg_xxyz_xxxz_0[j] + fr * tg_xxyz_xxxz_1[j] + fl1_fx * (tg_xyz_xxxz_0[j] - tg_xyz_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxyz_xxz_1[j];

                    tg_xxxyz_xxyy_0[j] = pb_x * tg_xxyz_xxyy_0[j] + fr * tg_xxyz_xxyy_1[j] + fl1_fx * (tg_xyz_xxyy_0[j] - tg_xyz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xxyz_xyy_1[j];

                    tg_xxxyz_xxyz_0[j] = pb_x * tg_xxyz_xxyz_0[j] + fr * tg_xxyz_xxyz_1[j] + fl1_fx * (tg_xyz_xxyz_0[j] - tg_xyz_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xxyz_xyz_1[j];

                    tg_xxxyz_xxzz_0[j] = pb_x * tg_xxyz_xxzz_0[j] + fr * tg_xxyz_xxzz_1[j] + fl1_fx * (tg_xyz_xxzz_0[j] - tg_xyz_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xxyz_xzz_1[j];

                    tg_xxxyz_xyyy_0[j] = pb_x * tg_xxyz_xyyy_0[j] + fr * tg_xxyz_xyyy_1[j] + fl1_fx * (tg_xyz_xyyy_0[j] - tg_xyz_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxyz_yyy_1[j];

                    tg_xxxyz_xyyz_0[j] = pb_x * tg_xxyz_xyyz_0[j] + fr * tg_xxyz_xyyz_1[j] + fl1_fx * (tg_xyz_xyyz_0[j] - tg_xyz_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxyz_yyz_1[j];

                    tg_xxxyz_xyzz_0[j] = pb_x * tg_xxyz_xyzz_0[j] + fr * tg_xxyz_xyzz_1[j] + fl1_fx * (tg_xyz_xyzz_0[j] - tg_xyz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxyz_yzz_1[j];

                    tg_xxxyz_xzzz_0[j] = pb_x * tg_xxyz_xzzz_0[j] + fr * tg_xxyz_xzzz_1[j] + fl1_fx * (tg_xyz_xzzz_0[j] - tg_xyz_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxyz_zzz_1[j];

                    tg_xxxyz_yyyy_0[j] = pb_x * tg_xxyz_yyyy_0[j] + fr * tg_xxyz_yyyy_1[j] + fl1_fx * (tg_xyz_yyyy_0[j] - tg_xyz_yyyy_1[j] * fl1_fza);

                    tg_xxxyz_yyyz_0[j] = pb_x * tg_xxyz_yyyz_0[j] + fr * tg_xxyz_yyyz_1[j] + fl1_fx * (tg_xyz_yyyz_0[j] - tg_xyz_yyyz_1[j] * fl1_fza);

                    tg_xxxyz_yyzz_0[j] = pb_x * tg_xxyz_yyzz_0[j] + fr * tg_xxyz_yyzz_1[j] + fl1_fx * (tg_xyz_yyzz_0[j] - tg_xyz_yyzz_1[j] * fl1_fza);

                    tg_xxxyz_yzzz_0[j] = pb_x * tg_xxyz_yzzz_0[j] + fr * tg_xxyz_yzzz_1[j] + fl1_fx * (tg_xyz_yzzz_0[j] - tg_xyz_yzzz_1[j] * fl1_fza);

                    tg_xxxyz_zzzz_0[j] = pb_x * tg_xxyz_zzzz_0[j] + fr * tg_xxyz_zzzz_1[j] + fl1_fx * (tg_xyz_zzzz_0[j] - tg_xyz_zzzz_1[j] * fl1_fza);

                    tg_xxxzz_xxxx_0[j] = pb_x * tg_xxzz_xxxx_0[j] + fr * tg_xxzz_xxxx_1[j] + fl1_fx * (tg_xzz_xxxx_0[j] - tg_xzz_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xxzz_xxx_1[j];

                    tg_xxxzz_xxxy_0[j] = pb_x * tg_xxzz_xxxy_0[j] + fr * tg_xxzz_xxxy_1[j] + fl1_fx * (tg_xzz_xxxy_0[j] - tg_xzz_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxzz_xxy_1[j];

                    tg_xxxzz_xxxz_0[j] = pb_x * tg_xxzz_xxxz_0[j] + fr * tg_xxzz_xxxz_1[j] + fl1_fx * (tg_xzz_xxxz_0[j] - tg_xzz_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxzz_xxz_1[j];

                    tg_xxxzz_xxyy_0[j] = pb_x * tg_xxzz_xxyy_0[j] + fr * tg_xxzz_xxyy_1[j] + fl1_fx * (tg_xzz_xxyy_0[j] - tg_xzz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xxzz_xyy_1[j];
                }
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    ...
                    tg_xxxzz_xxyz_0[j] = pb_x * tg_xxzz_xxyz_0[j] + fr * tg_xxzz_xxyz_1[j] + fl1_fx * (tg_xzz_xxyz_0[j] - tg_xzz_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xxzz_xyz_1[j];

                    tg_xxxzz_xxzz_0[j] = pb_x * tg_xxzz_xxzz_0[j] + fr * tg_xxzz_xxzz_1[j] + fl1_fx * (tg_xzz_xxzz_0[j] - tg_xzz_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xxzz_xzz_1[j];

                    tg_xxxzz_xyyy_0[j] = pb_x * tg_xxzz_xyyy_0[j] + fr * tg_xxzz_xyyy_1[j] + fl1_fx * (tg_xzz_xyyy_0[j] - tg_xzz_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxzz_yyy_1[j];

                    tg_xxxzz_xyyz_0[j] = pb_x * tg_xxzz_xyyz_0[j] + fr * tg_xxzz_xyyz_1[j] + fl1_fx * (tg_xzz_xyyz_0[j] - tg_xzz_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxzz_yyz_1[j];

                    tg_xxxzz_xyzz_0[j] = pb_x * tg_xxzz_xyzz_0[j] + fr * tg_xxzz_xyzz_1[j] + fl1_fx * (tg_xzz_xyzz_0[j] - tg_xzz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxzz_yzz_1[j];

                    tg_xxxzz_xzzz_0[j] = pb_x * tg_xxzz_xzzz_0[j] + fr * tg_xxzz_xzzz_1[j] + fl1_fx * (tg_xzz_xzzz_0[j] - tg_xzz_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxzz_zzz_1[j];

                    tg_xxxzz_yyyy_0[j] = pb_x * tg_xxzz_yyyy_0[j] + fr * tg_xxzz_yyyy_1[j] + fl1_fx * (tg_xzz_yyyy_0[j] - tg_xzz_yyyy_1[j] * fl1_fza);

                    tg_xxxzz_yyyz_0[j] = pb_x * tg_xxzz_yyyz_0[j] + fr * tg_xxzz_yyyz_1[j] + fl1_fx * (tg_xzz_yyyz_0[j] - tg_xzz_yyyz_1[j] * fl1_fza);

                    tg_xxxzz_yyzz_0[j] = pb_x * tg_xxzz_yyzz_0[j] + fr * tg_xxzz_yyzz_1[j] + fl1_fx * (tg_xzz_yyzz_0[j] - tg_xzz_yyzz_1[j] * fl1_fza);

                    tg_xxxzz_yzzz_0[j] = pb_x * tg_xxzz_yzzz_0[j] + fr * tg_xxzz_yzzz_1[j] + fl1_fx * (tg_xzz_yzzz_0[j] - tg_xzz_yzzz_1[j] * fl1_fza);

                    tg_xxxzz_zzzz_0[j] = pb_x * tg_xxzz_zzzz_0[j] + fr * tg_xxzz_zzzz_1[j] + fl1_fx * (tg_xzz_zzzz_0[j] - tg_xzz_zzzz_1[j] * fl1_fza);

                    tg_xxyyy_xxxx_0[j] = pb_x * tg_xyyy_xxxx_0[j] + fr * tg_xyyy_xxxx_1[j] + 0.5 * fl1_fx * (tg_yyy_xxxx_0[j] - tg_yyy_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xyyy_xxx_1[j];

                    tg_xxyyy_xxxy_0[j] = pb_x * tg_xyyy_xxxy_0[j] + fr * tg_xyyy_xxxy_1[j] + 0.5 * fl1_fx * (tg_yyy_xxxy_0[j] - tg_yyy_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xyyy_xxy_1[j];

                    tg_xxyyy_xxxz_0[j] = pb_x * tg_xyyy_xxxz_0[j] + fr * tg_xyyy_xxxz_1[j] + 0.5 * fl1_fx * (tg_yyy_xxxz_0[j] - tg_yyy_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xyyy_xxz_1[j];

                    tg_xxyyy_xxyy_0[j] = pb_x * tg_xyyy_xxyy_0[j] + fr * tg_xyyy_xxyy_1[j] + 0.5 * fl1_fx * (tg_yyy_xxyy_0[j] - tg_yyy_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xyyy_xyy_1[j];

                    tg_xxyyy_xxyz_0[j] = pb_x * tg_xyyy_xxyz_0[j] + fr * tg_xyyy_xxyz_1[j] + 0.5 * fl1_fx * (tg_yyy_xxyz_0[j] - tg_yyy_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xyyy_xyz_1[j];

                    tg_xxyyy_xxzz_0[j] = pb_x * tg_xyyy_xxzz_0[j] + fr * tg_xyyy_xxzz_1[j] + 0.5 * fl1_fx * (tg_yyy_xxzz_0[j] - tg_yyy_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xyyy_xzz_1[j];

                    tg_xxyyy_xyyy_0[j] = pb_x * tg_xyyy_xyyy_0[j] + fr * tg_xyyy_xyyy_1[j] + 0.5 * fl1_fx * (tg_yyy_xyyy_0[j] - tg_yyy_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyyy_yyy_1[j];

                    tg_xxyyy_xyyz_0[j] = pb_x * tg_xyyy_xyyz_0[j] + fr * tg_xyyy_xyyz_1[j] + 0.5 * fl1_fx * (tg_yyy_xyyz_0[j] - tg_yyy_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyyy_yyz_1[j];

                    tg_xxyyy_xyzz_0[j] = pb_x * tg_xyyy_xyzz_0[j] + fr * tg_xyyy_xyzz_1[j] + 0.5 * fl1_fx * (tg_yyy_xyzz_0[j] - tg_yyy_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyyy_yzz_1[j];

                    tg_xxyyy_xzzz_0[j] = pb_x * tg_xyyy_xzzz_0[j] + fr * tg_xyyy_xzzz_1[j] + 0.5 * fl1_fx * (tg_yyy_xzzz_0[j] - tg_yyy_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyyy_zzz_1[j];

                    tg_xxyyy_yyyy_0[j] = pb_x * tg_xyyy_yyyy_0[j] + fr * tg_xyyy_yyyy_1[j] + 0.5 * fl1_fx * (tg_yyy_yyyy_0[j] - tg_yyy_yyyy_1[j] * fl1_fza);

                    tg_xxyyy_yyyz_0[j] = pb_x * tg_xyyy_yyyz_0[j] + fr * tg_xyyy_yyyz_1[j] + 0.5 * fl1_fx * (tg_yyy_yyyz_0[j] - tg_yyy_yyyz_1[j] * fl1_fza);

                    tg_xxyyy_yyzz_0[j] = pb_x * tg_xyyy_yyzz_0[j] + fr * tg_xyyy_yyzz_1[j] + 0.5 * fl1_fx * (tg_yyy_yyzz_0[j] - tg_yyy_yyzz_1[j] * fl1_fza);

                    tg_xxyyy_yzzz_0[j] = pb_x * tg_xyyy_yzzz_0[j] + fr * tg_xyyy_yzzz_1[j] + 0.5 * fl1_fx * (tg_yyy_yzzz_0[j] - tg_yyy_yzzz_1[j] * fl1_fza);

                    tg_xxyyy_zzzz_0[j] = pb_x * tg_xyyy_zzzz_0[j] + fr * tg_xyyy_zzzz_1[j] + 0.5 * fl1_fx * (tg_yyy_zzzz_0[j] - tg_yyy_zzzz_1[j] * fl1_fza);

                    tg_xxyyz_xxxx_0[j] = pb_x * tg_xyyz_xxxx_0[j] + fr * tg_xyyz_xxxx_1[j] + 0.5 * fl1_fx * (tg_yyz_xxxx_0[j] - tg_yyz_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xyyz_xxx_1[j];

                    tg_xxyyz_xxxy_0[j] = pb_x * tg_xyyz_xxxy_0[j] + fr * tg_xyyz_xxxy_1[j] + 0.5 * fl1_fx * (tg_yyz_xxxy_0[j] - tg_yyz_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xyyz_xxy_1[j];

                    tg_xxyyz_xxxz_0[j] = pb_x * tg_xyyz_xxxz_0[j] + fr * tg_xyyz_xxxz_1[j] + 0.5 * fl1_fx * (tg_yyz_xxxz_0[j] - tg_yyz_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xyyz_xxz_1[j];

                    tg_xxyyz_xxyy_0[j] = pb_x * tg_xyyz_xxyy_0[j] + fr * tg_xyyz_xxyy_1[j] + 0.5 * fl1_fx * (tg_yyz_xxyy_0[j] - tg_yyz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xyyz_xyy_1[j];

                    tg_xxyyz_xxyz_0[j] = pb_x * tg_xyyz_xxyz_0[j] + fr * tg_xyyz_xxyz_1[j] + 0.5 * fl1_fx * (tg_yyz_xxyz_0[j] - tg_yyz_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xyyz_xyz_1[j];

                    tg_xxyyz_xxzz_0[j] = pb_x * tg_xyyz_xxzz_0[j] + fr * tg_xyyz_xxzz_1[j] + 0.5 * fl1_fx * (tg_yyz_xxzz_0[j] - tg_yyz_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xyyz_xzz_1[j];

                    tg_xxyyz_xyyy_0[j] = pb_x * tg_xyyz_xyyy_0[j] + fr * tg_xyyz_xyyy_1[j] + 0.5 * fl1_fx * (tg_yyz_xyyy_0[j] - tg_yyz_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyyz_yyy_1[j];

                    tg_xxyyz_xyyz_0[j] = pb_x * tg_xyyz_xyyz_0[j] + fr * tg_xyyz_xyyz_1[j] + 0.5 * fl1_fx * (tg_yyz_xyyz_0[j] - tg_yyz_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyyz_yyz_1[j];

                    tg_xxyyz_xyzz_0[j] = pb_x * tg_xyyz_xyzz_0[j] + fr * tg_xyyz_xyzz_1[j] + 0.5 * fl1_fx * (tg_yyz_xyzz_0[j] - tg_yyz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyyz_yzz_1[j];

                    tg_xxyyz_xzzz_0[j] = pb_x * tg_xyyz_xzzz_0[j] + fr * tg_xyyz_xzzz_1[j] + 0.5 * fl1_fx * (tg_yyz_xzzz_0[j] - tg_yyz_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyyz_zzz_1[j];

                    tg_xxyyz_yyyy_0[j] = pb_x * tg_xyyz_yyyy_0[j] + fr * tg_xyyz_yyyy_1[j] + 0.5 * fl1_fx * (tg_yyz_yyyy_0[j] - tg_yyz_yyyy_1[j] * fl1_fza);

                    tg_xxyyz_yyyz_0[j] = pb_x * tg_xyyz_yyyz_0[j] + fr * tg_xyyz_yyyz_1[j] + 0.5 * fl1_fx * (tg_yyz_yyyz_0[j] - tg_yyz_yyyz_1[j] * fl1_fza);

                    tg_xxyyz_yyzz_0[j] = pb_x * tg_xyyz_yyzz_0[j] + fr * tg_xyyz_yyzz_1[j] + 0.5 * fl1_fx * (tg_yyz_yyzz_0[j] - tg_yyz_yyzz_1[j] * fl1_fza);

                    tg_xxyyz_yzzz_0[j] = pb_x * tg_xyyz_yzzz_0[j] + fr * tg_xyyz_yzzz_1[j] + 0.5 * fl1_fx * (tg_yyz_yzzz_0[j] - tg_yyz_yzzz_1[j] * fl1_fza);

                    tg_xxyyz_zzzz_0[j] = pb_x * tg_xyyz_zzzz_0[j] + fr * tg_xyyz_zzzz_1[j] + 0.5 * fl1_fx * (tg_yyz_zzzz_0[j] - tg_yyz_zzzz_1[j] * fl1_fza);

                    tg_xxyzz_xxxx_0[j] = pb_x * tg_xyzz_xxxx_0[j] + fr * tg_xyzz_xxxx_1[j] + 0.5 * fl1_fx * (tg_yzz_xxxx_0[j] - tg_yzz_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xyzz_xxx_1[j];

                    tg_xxyzz_xxxy_0[j] = pb_x * tg_xyzz_xxxy_0[j] + fr * tg_xyzz_xxxy_1[j] + 0.5 * fl1_fx * (tg_yzz_xxxy_0[j] - tg_yzz_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xyzz_xxy_1[j];

                    tg_xxyzz_xxxz_0[j] = pb_x * tg_xyzz_xxxz_0[j] + fr * tg_xyzz_xxxz_1[j] + 0.5 * fl1_fx * (tg_yzz_xxxz_0[j] - tg_yzz_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xyzz_xxz_1[j];

                    tg_xxyzz_xxyy_0[j] = pb_x * tg_xyzz_xxyy_0[j] + fr * tg_xyzz_xxyy_1[j] + 0.5 * fl1_fx * (tg_yzz_xxyy_0[j] - tg_yzz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xyzz_xyy_1[j];

                    tg_xxyzz_xxyz_0[j] = pb_x * tg_xyzz_xxyz_0[j] + fr * tg_xyzz_xxyz_1[j] + 0.5 * fl1_fx * (tg_yzz_xxyz_0[j] - tg_yzz_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xyzz_xyz_1[j];

                    tg_xxyzz_xxzz_0[j] = pb_x * tg_xyzz_xxzz_0[j] + fr * tg_xyzz_xxzz_1[j] + 0.5 * fl1_fx * (tg_yzz_xxzz_0[j] - tg_yzz_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xyzz_xzz_1[j];

                    tg_xxyzz_xyyy_0[j] = pb_x * tg_xyzz_xyyy_0[j] + fr * tg_xyzz_xyyy_1[j] + 0.5 * fl1_fx * (tg_yzz_xyyy_0[j] - tg_yzz_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyzz_yyy_1[j];

                    tg_xxyzz_xyyz_0[j] = pb_x * tg_xyzz_xyyz_0[j] + fr * tg_xyzz_xyyz_1[j] + 0.5 * fl1_fx * (tg_yzz_xyyz_0[j] - tg_yzz_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyzz_yyz_1[j];

                    tg_xxyzz_xyzz_0[j] = pb_x * tg_xyzz_xyzz_0[j] + fr * tg_xyzz_xyzz_1[j] + 0.5 * fl1_fx * (tg_yzz_xyzz_0[j] - tg_yzz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyzz_yzz_1[j];

                    tg_xxyzz_xzzz_0[j] = pb_x * tg_xyzz_xzzz_0[j] + fr * tg_xyzz_xzzz_1[j] + 0.5 * fl1_fx * (tg_yzz_xzzz_0[j] - tg_yzz_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyzz_zzz_1[j];

                    tg_xxyzz_yyyy_0[j] = pb_x * tg_xyzz_yyyy_0[j] + fr * tg_xyzz_yyyy_1[j] + 0.5 * fl1_fx * (tg_yzz_yyyy_0[j] - tg_yzz_yyyy_1[j] * fl1_fza);

                    tg_xxyzz_yyyz_0[j] = pb_x * tg_xyzz_yyyz_0[j] + fr * tg_xyzz_yyyz_1[j] + 0.5 * fl1_fx * (tg_yzz_yyyz_0[j] - tg_yzz_yyyz_1[j] * fl1_fza);

                    tg_xxyzz_yyzz_0[j] = pb_x * tg_xyzz_yyzz_0[j] + fr * tg_xyzz_yyzz_1[j] + 0.5 * fl1_fx * (tg_yzz_yyzz_0[j] - tg_yzz_yyzz_1[j] * fl1_fza);

                    tg_xxyzz_yzzz_0[j] = pb_x * tg_xyzz_yzzz_0[j] + fr * tg_xyzz_yzzz_1[j] + 0.5 * fl1_fx * (tg_yzz_yzzz_0[j] - tg_yzz_yzzz_1[j] * fl1_fza);

                    tg_xxyzz_zzzz_0[j] = pb_x * tg_xyzz_zzzz_0[j] + fr * tg_xyzz_zzzz_1[j] + 0.5 * fl1_fx * (tg_yzz_zzzz_0[j] - tg_yzz_zzzz_1[j] * fl1_fza);

                    tg_xxzzz_xxxx_0[j] = pb_x * tg_xzzz_xxxx_0[j] + fr * tg_xzzz_xxxx_1[j] + 0.5 * fl1_fx * (tg_zzz_xxxx_0[j] - tg_zzz_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xzzz_xxx_1[j];

                    tg_xxzzz_xxxy_0[j] = pb_x * tg_xzzz_xxxy_0[j] + fr * tg_xzzz_xxxy_1[j] + 0.5 * fl1_fx * (tg_zzz_xxxy_0[j] - tg_zzz_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xzzz_xxy_1[j];

                    tg_xxzzz_xxxz_0[j] = pb_x * tg_xzzz_xxxz_0[j] + fr * tg_xzzz_xxxz_1[j] + 0.5 * fl1_fx * (tg_zzz_xxxz_0[j] - tg_zzz_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xzzz_xxz_1[j];

                    tg_xxzzz_xxyy_0[j] = pb_x * tg_xzzz_xxyy_0[j] + fr * tg_xzzz_xxyy_1[j] + 0.5 * fl1_fx * (tg_zzz_xxyy_0[j] - tg_zzz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xzzz_xyy_1[j];

                    tg_xxzzz_xxyz_0[j] = pb_x * tg_xzzz_xxyz_0[j] + fr * tg_xzzz_xxyz_1[j] + 0.5 * fl1_fx * (tg_zzz_xxyz_0[j] - tg_zzz_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xzzz_xyz_1[j];

                    tg_xxzzz_xxzz_0[j] = pb_x * tg_xzzz_xxzz_0[j] + fr * tg_xzzz_xxzz_1[j] + 0.5 * fl1_fx * (tg_zzz_xxzz_0[j] - tg_zzz_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xzzz_xzz_1[j];

                    tg_xxzzz_xyyy_0[j] = pb_x * tg_xzzz_xyyy_0[j] + fr * tg_xzzz_xyyy_1[j] + 0.5 * fl1_fx * (tg_zzz_xyyy_0[j] - tg_zzz_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xzzz_yyy_1[j];

                    tg_xxzzz_xyyz_0[j] = pb_x * tg_xzzz_xyyz_0[j] + fr * tg_xzzz_xyyz_1[j] + 0.5 * fl1_fx * (tg_zzz_xyyz_0[j] - tg_zzz_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xzzz_yyz_1[j];

                    tg_xxzzz_xyzz_0[j] = pb_x * tg_xzzz_xyzz_0[j] + fr * tg_xzzz_xyzz_1[j] + 0.5 * fl1_fx * (tg_zzz_xyzz_0[j] - tg_zzz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xzzz_yzz_1[j];

                    tg_xxzzz_xzzz_0[j] = pb_x * tg_xzzz_xzzz_0[j] + fr * tg_xzzz_xzzz_1[j] + 0.5 * fl1_fx * (tg_zzz_xzzz_0[j] - tg_zzz_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xzzz_zzz_1[j];

                    tg_xxzzz_yyyy_0[j] = pb_x * tg_xzzz_yyyy_0[j] + fr * tg_xzzz_yyyy_1[j] + 0.5 * fl1_fx * (tg_zzz_yyyy_0[j] - tg_zzz_yyyy_1[j] * fl1_fza);

                    tg_xxzzz_yyyz_0[j] = pb_x * tg_xzzz_yyyz_0[j] + fr * tg_xzzz_yyyz_1[j] + 0.5 * fl1_fx * (tg_zzz_yyyz_0[j] - tg_zzz_yyyz_1[j] * fl1_fza);

                    tg_xxzzz_yyzz_0[j] = pb_x * tg_xzzz_yyzz_0[j] + fr * tg_xzzz_yyzz_1[j] + 0.5 * fl1_fx * (tg_zzz_yyzz_0[j] - tg_zzz_yyzz_1[j] * fl1_fza);

                    tg_xxzzz_yzzz_0[j] = pb_x * tg_xzzz_yzzz_0[j] + fr * tg_xzzz_yzzz_1[j] + 0.5 * fl1_fx * (tg_zzz_yzzz_0[j] - tg_zzz_yzzz_1[j] * fl1_fza);

                    tg_xxzzz_zzzz_0[j] = pb_x * tg_xzzz_zzzz_0[j] + fr * tg_xzzz_zzzz_1[j] + 0.5 * fl1_fx * (tg_zzz_zzzz_0[j] - tg_zzz_zzzz_1[j] * fl1_fza);

                    tg_xyyyy_xxxx_0[j] = pb_x * tg_yyyy_xxxx_0[j] + fr * tg_yyyy_xxxx_1[j] + 2.0 * fl1_fxn * tg_yyyy_xxx_1[j];

                    tg_xyyyy_xxxy_0[j] = pb_x * tg_yyyy_xxxy_0[j] + fr * tg_yyyy_xxxy_1[j] + 1.5 * fl1_fxn * tg_yyyy_xxy_1[j];

                    tg_xyyyy_xxxz_0[j] = pb_x * tg_yyyy_xxxz_0[j] + fr * tg_yyyy_xxxz_1[j] + 1.5 * fl1_fxn * tg_yyyy_xxz_1[j];

                    tg_xyyyy_xxyy_0[j] = pb_x * tg_yyyy_xxyy_0[j] + fr * tg_yyyy_xxyy_1[j] + fl1_fxn * tg_yyyy_xyy_1[j];

                    tg_xyyyy_xxyz_0[j] = pb_x * tg_yyyy_xxyz_0[j] + fr * tg_yyyy_xxyz_1[j] + fl1_fxn * tg_yyyy_xyz_1[j];

                    tg_xyyyy_xxzz_0[j] = pb_x * tg_yyyy_xxzz_0[j] + fr * tg_yyyy_xxzz_1[j] + fl1_fxn * tg_yyyy_xzz_1[j];

                    tg_xyyyy_xyyy_0[j] = pb_x * tg_yyyy_xyyy_0[j] + fr * tg_yyyy_xyyy_1[j] + 0.5 * fl1_fxn * tg_yyyy_yyy_1[j];

                    tg_xyyyy_xyyz_0[j] = pb_x * tg_yyyy_xyyz_0[j] + fr * tg_yyyy_xyyz_1[j] + 0.5 * fl1_fxn * tg_yyyy_yyz_1[j];
                }
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    ...
                    tg_xyyyy_xyzz_0[j] = pb_x * tg_yyyy_xyzz_0[j] + fr * tg_yyyy_xyzz_1[j] + 0.5 * fl1_fxn * tg_yyyy_yzz_1[j];

                    tg_xyyyy_xzzz_0[j] = pb_x * tg_yyyy_xzzz_0[j] + fr * tg_yyyy_xzzz_1[j] + 0.5 * fl1_fxn * tg_yyyy_zzz_1[j];

                    tg_xyyyy_yyyy_0[j] = pb_x * tg_yyyy_yyyy_0[j] + fr * tg_yyyy_yyyy_1[j];

                    tg_xyyyy_yyyz_0[j] = pb_x * tg_yyyy_yyyz_0[j] + fr * tg_yyyy_yyyz_1[j];

                    tg_xyyyy_yyzz_0[j] = pb_x * tg_yyyy_yyzz_0[j] + fr * tg_yyyy_yyzz_1[j];

                    tg_xyyyy_yzzz_0[j] = pb_x * tg_yyyy_yzzz_0[j] + fr * tg_yyyy_yzzz_1[j];

                    tg_xyyyy_zzzz_0[j] = pb_x * tg_yyyy_zzzz_0[j] + fr * tg_yyyy_zzzz_1[j];

                    tg_xyyyz_xxxx_0[j] = pb_x * tg_yyyz_xxxx_0[j] + fr * tg_yyyz_xxxx_1[j] + 2.0 * fl1_fxn * tg_yyyz_xxx_1[j];

                    tg_xyyyz_xxxy_0[j] = pb_x * tg_yyyz_xxxy_0[j] + fr * tg_yyyz_xxxy_1[j] + 1.5 * fl1_fxn * tg_yyyz_xxy_1[j];

                    tg_xyyyz_xxxz_0[j] = pb_x * tg_yyyz_xxxz_0[j] + fr * tg_yyyz_xxxz_1[j] + 1.5 * fl1_fxn * tg_yyyz_xxz_1[j];

                    tg_xyyyz_xxyy_0[j] = pb_x * tg_yyyz_xxyy_0[j] + fr * tg_yyyz_xxyy_1[j] + fl1_fxn * tg_yyyz_xyy_1[j];

                    tg_xyyyz_xxyz_0[j] = pb_x * tg_yyyz_xxyz_0[j] + fr * tg_yyyz_xxyz_1[j] + fl1_fxn * tg_yyyz_xyz_1[j];

                    tg_xyyyz_xxzz_0[j] = pb_x * tg_yyyz_xxzz_0[j] + fr * tg_yyyz_xxzz_1[j] + fl1_fxn * tg_yyyz_xzz_1[j];

                    tg_xyyyz_xyyy_0[j] = pb_x * tg_yyyz_xyyy_0[j] + fr * tg_yyyz_xyyy_1[j] + 0.5 * fl1_fxn * tg_yyyz_yyy_1[j];

                    tg_xyyyz_xyyz_0[j] = pb_x * tg_yyyz_xyyz_0[j] + fr * tg_yyyz_xyyz_1[j] + 0.5 * fl1_fxn * tg_yyyz_yyz_1[j];

                    tg_xyyyz_xyzz_0[j] = pb_x * tg_yyyz_xyzz_0[j] + fr * tg_yyyz_xyzz_1[j] + 0.5 * fl1_fxn * tg_yyyz_yzz_1[j];

                    tg_xyyyz_xzzz_0[j] = pb_x * tg_yyyz_xzzz_0[j] + fr * tg_yyyz_xzzz_1[j] + 0.5 * fl1_fxn * tg_yyyz_zzz_1[j];

                    tg_xyyyz_yyyy_0[j] = pb_x * tg_yyyz_yyyy_0[j] + fr * tg_yyyz_yyyy_1[j];

                    tg_xyyyz_yyyz_0[j] = pb_x * tg_yyyz_yyyz_0[j] + fr * tg_yyyz_yyyz_1[j];

                    tg_xyyyz_yyzz_0[j] = pb_x * tg_yyyz_yyzz_0[j] + fr * tg_yyyz_yyzz_1[j];

                    tg_xyyyz_yzzz_0[j] = pb_x * tg_yyyz_yzzz_0[j] + fr * tg_yyyz_yzzz_1[j];

                    tg_xyyyz_zzzz_0[j] = pb_x * tg_yyyz_zzzz_0[j] + fr * tg_yyyz_zzzz_1[j];

                    tg_xyyzz_xxxx_0[j] = pb_x * tg_yyzz_xxxx_0[j] + fr * tg_yyzz_xxxx_1[j] + 2.0 * fl1_fxn * tg_yyzz_xxx_1[j];

                    tg_xyyzz_xxxy_0[j] = pb_x * tg_yyzz_xxxy_0[j] + fr * tg_yyzz_xxxy_1[j] + 1.5 * fl1_fxn * tg_yyzz_xxy_1[j];

                    tg_xyyzz_xxxz_0[j] = pb_x * tg_yyzz_xxxz_0[j] + fr * tg_yyzz_xxxz_1[j] + 1.5 * fl1_fxn * tg_yyzz_xxz_1[j];

                    tg_xyyzz_xxyy_0[j] = pb_x * tg_yyzz_xxyy_0[j] + fr * tg_yyzz_xxyy_1[j] + fl1_fxn * tg_yyzz_xyy_1[j];

                    tg_xyyzz_xxyz_0[j] = pb_x * tg_yyzz_xxyz_0[j] + fr * tg_yyzz_xxyz_1[j] + fl1_fxn * tg_yyzz_xyz_1[j];

                    tg_xyyzz_xxzz_0[j] = pb_x * tg_yyzz_xxzz_0[j] + fr * tg_yyzz_xxzz_1[j] + fl1_fxn * tg_yyzz_xzz_1[j];

                    tg_xyyzz_xyyy_0[j] = pb_x * tg_yyzz_xyyy_0[j] + fr * tg_yyzz_xyyy_1[j] + 0.5 * fl1_fxn * tg_yyzz_yyy_1[j];

                    tg_xyyzz_xyyz_0[j] = pb_x * tg_yyzz_xyyz_0[j] + fr * tg_yyzz_xyyz_1[j] + 0.5 * fl1_fxn * tg_yyzz_yyz_1[j];

                    tg_xyyzz_xyzz_0[j] = pb_x * tg_yyzz_xyzz_0[j] + fr * tg_yyzz_xyzz_1[j] + 0.5 * fl1_fxn * tg_yyzz_yzz_1[j];

                    tg_xyyzz_xzzz_0[j] = pb_x * tg_yyzz_xzzz_0[j] + fr * tg_yyzz_xzzz_1[j] + 0.5 * fl1_fxn * tg_yyzz_zzz_1[j];

                    tg_xyyzz_yyyy_0[j] = pb_x * tg_yyzz_yyyy_0[j] + fr * tg_yyzz_yyyy_1[j];

                    tg_xyyzz_yyyz_0[j] = pb_x * tg_yyzz_yyyz_0[j] + fr * tg_yyzz_yyyz_1[j];

                    tg_xyyzz_yyzz_0[j] = pb_x * tg_yyzz_yyzz_0[j] + fr * tg_yyzz_yyzz_1[j];

                    tg_xyyzz_yzzz_0[j] = pb_x * tg_yyzz_yzzz_0[j] + fr * tg_yyzz_yzzz_1[j];

                    tg_xyyzz_zzzz_0[j] = pb_x * tg_yyzz_zzzz_0[j] + fr * tg_yyzz_zzzz_1[j];

                    tg_xyzzz_xxxx_0[j] = pb_x * tg_yzzz_xxxx_0[j] + fr * tg_yzzz_xxxx_1[j] + 2.0 * fl1_fxn * tg_yzzz_xxx_1[j];

                    tg_xyzzz_xxxy_0[j] = pb_x * tg_yzzz_xxxy_0[j] + fr * tg_yzzz_xxxy_1[j] + 1.5 * fl1_fxn * tg_yzzz_xxy_1[j];

                    tg_xyzzz_xxxz_0[j] = pb_x * tg_yzzz_xxxz_0[j] + fr * tg_yzzz_xxxz_1[j] + 1.5 * fl1_fxn * tg_yzzz_xxz_1[j];

                    tg_xyzzz_xxyy_0[j] = pb_x * tg_yzzz_xxyy_0[j] + fr * tg_yzzz_xxyy_1[j] + fl1_fxn * tg_yzzz_xyy_1[j];

                    tg_xyzzz_xxyz_0[j] = pb_x * tg_yzzz_xxyz_0[j] + fr * tg_yzzz_xxyz_1[j] + fl1_fxn * tg_yzzz_xyz_1[j];

                    tg_xyzzz_xxzz_0[j] = pb_x * tg_yzzz_xxzz_0[j] + fr * tg_yzzz_xxzz_1[j] + fl1_fxn * tg_yzzz_xzz_1[j];

                    tg_xyzzz_xyyy_0[j] = pb_x * tg_yzzz_xyyy_0[j] + fr * tg_yzzz_xyyy_1[j] + 0.5 * fl1_fxn * tg_yzzz_yyy_1[j];

                    tg_xyzzz_xyyz_0[j] = pb_x * tg_yzzz_xyyz_0[j] + fr * tg_yzzz_xyyz_1[j] + 0.5 * fl1_fxn * tg_yzzz_yyz_1[j];

                    tg_xyzzz_xyzz_0[j] = pb_x * tg_yzzz_xyzz_0[j] + fr * tg_yzzz_xyzz_1[j] + 0.5 * fl1_fxn * tg_yzzz_yzz_1[j];

                    tg_xyzzz_xzzz_0[j] = pb_x * tg_yzzz_xzzz_0[j] + fr * tg_yzzz_xzzz_1[j] + 0.5 * fl1_fxn * tg_yzzz_zzz_1[j];

                    tg_xyzzz_yyyy_0[j] = pb_x * tg_yzzz_yyyy_0[j] + fr * tg_yzzz_yyyy_1[j];

                    tg_xyzzz_yyyz_0[j] = pb_x * tg_yzzz_yyyz_0[j] + fr * tg_yzzz_yyyz_1[j];

                    tg_xyzzz_yyzz_0[j] = pb_x * tg_yzzz_yyzz_0[j] + fr * tg_yzzz_yyzz_1[j];

                    tg_xyzzz_yzzz_0[j] = pb_x * tg_yzzz_yzzz_0[j] + fr * tg_yzzz_yzzz_1[j];

                    tg_xyzzz_zzzz_0[j] = pb_x * tg_yzzz_zzzz_0[j] + fr * tg_yzzz_zzzz_1[j];

                    tg_xzzzz_xxxx_0[j] = pb_x * tg_zzzz_xxxx_0[j] + fr * tg_zzzz_xxxx_1[j] + 2.0 * fl1_fxn * tg_zzzz_xxx_1[j];

                    tg_xzzzz_xxxy_0[j] = pb_x * tg_zzzz_xxxy_0[j] + fr * tg_zzzz_xxxy_1[j] + 1.5 * fl1_fxn * tg_zzzz_xxy_1[j];

                    tg_xzzzz_xxxz_0[j] = pb_x * tg_zzzz_xxxz_0[j] + fr * tg_zzzz_xxxz_1[j] + 1.5 * fl1_fxn * tg_zzzz_xxz_1[j];

                    tg_xzzzz_xxyy_0[j] = pb_x * tg_zzzz_xxyy_0[j] + fr * tg_zzzz_xxyy_1[j] + fl1_fxn * tg_zzzz_xyy_1[j];

                    tg_xzzzz_xxyz_0[j] = pb_x * tg_zzzz_xxyz_0[j] + fr * tg_zzzz_xxyz_1[j] + fl1_fxn * tg_zzzz_xyz_1[j];

                    tg_xzzzz_xxzz_0[j] = pb_x * tg_zzzz_xxzz_0[j] + fr * tg_zzzz_xxzz_1[j] + fl1_fxn * tg_zzzz_xzz_1[j];

                    tg_xzzzz_xyyy_0[j] = pb_x * tg_zzzz_xyyy_0[j] + fr * tg_zzzz_xyyy_1[j] + 0.5 * fl1_fxn * tg_zzzz_yyy_1[j];

                    tg_xzzzz_xyyz_0[j] = pb_x * tg_zzzz_xyyz_0[j] + fr * tg_zzzz_xyyz_1[j] + 0.5 * fl1_fxn * tg_zzzz_yyz_1[j];

                    tg_xzzzz_xyzz_0[j] = pb_x * tg_zzzz_xyzz_0[j] + fr * tg_zzzz_xyzz_1[j] + 0.5 * fl1_fxn * tg_zzzz_yzz_1[j];

                    tg_xzzzz_xzzz_0[j] = pb_x * tg_zzzz_xzzz_0[j] + fr * tg_zzzz_xzzz_1[j] + 0.5 * fl1_fxn * tg_zzzz_zzz_1[j];

                    tg_xzzzz_yyyy_0[j] = pb_x * tg_zzzz_yyyy_0[j] + fr * tg_zzzz_yyyy_1[j];

                    tg_xzzzz_yyyz_0[j] = pb_x * tg_zzzz_yyyz_0[j] + fr * tg_zzzz_yyyz_1[j];

                    tg_xzzzz_yyzz_0[j] = pb_x * tg_zzzz_yyzz_0[j] + fr * tg_zzzz_yyzz_1[j];

                    tg_xzzzz_yzzz_0[j] = pb_x * tg_zzzz_yzzz_0[j] + fr * tg_zzzz_yzzz_1[j];

                    tg_xzzzz_zzzz_0[j] = pb_x * tg_zzzz_zzzz_0[j] + fr * tg_zzzz_zzzz_1[j];

                    fr = wp_y[j]; 

                    tg_yyyyy_xxxx_0[j] = pb_y * tg_yyyy_xxxx_0[j] + fr * tg_yyyy_xxxx_1[j] + 2.0 * fl1_fx * (tg_yyy_xxxx_0[j] - tg_yyy_xxxx_1[j] * fl1_fza);

                    tg_yyyyy_xxxy_0[j] = pb_y * tg_yyyy_xxxy_0[j] + fr * tg_yyyy_xxxy_1[j] + 2.0 * fl1_fx * (tg_yyy_xxxy_0[j] - tg_yyy_xxxy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyyy_xxx_1[j];

                    tg_yyyyy_xxxz_0[j] = pb_y * tg_yyyy_xxxz_0[j] + fr * tg_yyyy_xxxz_1[j] + 2.0 * fl1_fx * (tg_yyy_xxxz_0[j] - tg_yyy_xxxz_1[j] * fl1_fza);

                    tg_yyyyy_xxyy_0[j] = pb_y * tg_yyyy_xxyy_0[j] + fr * tg_yyyy_xxyy_1[j] + 2.0 * fl1_fx * (tg_yyy_xxyy_0[j] - tg_yyy_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_yyyy_xxy_1[j];

                    tg_yyyyy_xxyz_0[j] = pb_y * tg_yyyy_xxyz_0[j] + fr * tg_yyyy_xxyz_1[j] + 2.0 * fl1_fx * (tg_yyy_xxyz_0[j] - tg_yyy_xxyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyyy_xxz_1[j];

                    tg_yyyyy_xxzz_0[j] = pb_y * tg_yyyy_xxzz_0[j] + fr * tg_yyyy_xxzz_1[j] + 2.0 * fl1_fx * (tg_yyy_xxzz_0[j] - tg_yyy_xxzz_1[j] * fl1_fza);

                    tg_yyyyy_xyyy_0[j] = pb_y * tg_yyyy_xyyy_0[j] + fr * tg_yyyy_xyyy_1[j] + 2.0 * fl1_fx * (tg_yyy_xyyy_0[j] - tg_yyy_xyyy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yyyy_xyy_1[j];

                    tg_yyyyy_xyyz_0[j] = pb_y * tg_yyyy_xyyz_0[j] + fr * tg_yyyy_xyyz_1[j] + 2.0 * fl1_fx * (tg_yyy_xyyz_0[j] - tg_yyy_xyyz_1[j] * fl1_fza) + fl1_fxn * tg_yyyy_xyz_1[j];

                    tg_yyyyy_xyzz_0[j] = pb_y * tg_yyyy_xyzz_0[j] + fr * tg_yyyy_xyzz_1[j] + 2.0 * fl1_fx * (tg_yyy_xyzz_0[j] - tg_yyy_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyyy_xzz_1[j];

                    tg_yyyyy_xzzz_0[j] = pb_y * tg_yyyy_xzzz_0[j] + fr * tg_yyyy_xzzz_1[j] + 2.0 * fl1_fx * (tg_yyy_xzzz_0[j] - tg_yyy_xzzz_1[j] * fl1_fza);

                    tg_yyyyy_yyyy_0[j] = pb_y * tg_yyyy_yyyy_0[j] + fr * tg_yyyy_yyyy_1[j] + 2.0 * fl1_fx * (tg_yyy_yyyy_0[j] - tg_yyy_yyyy_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_yyyy_yyy_1[j];

                    tg_yyyyy_yyyz_0[j] = pb_y * tg_yyyy_yyyz_0[j] + fr * tg_yyyy_yyyz_1[j] + 2.0 * fl1_fx * (tg_yyy_yyyz_0[j] - tg_yyy_yyyz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yyyy_yyz_1[j];
                }
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    ...
                    tg_yyyyy_yyzz_0[j] = pb_y * tg_yyyy_yyzz_0[j] + fr * tg_yyyy_yyzz_1[j] + 2.0 * fl1_fx * (tg_yyy_yyzz_0[j] - tg_yyy_yyzz_1[j] * fl1_fza) + fl1_fxn * tg_yyyy_yzz_1[j];

                    tg_yyyyy_yzzz_0[j] = pb_y * tg_yyyy_yzzz_0[j] + fr * tg_yyyy_yzzz_1[j] + 2.0 * fl1_fx * (tg_yyy_yzzz_0[j] - tg_yyy_yzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyyy_zzz_1[j];

                    tg_yyyyy_zzzz_0[j] = pb_y * tg_yyyy_zzzz_0[j] + fr * tg_yyyy_zzzz_1[j] + 2.0 * fl1_fx * (tg_yyy_zzzz_0[j] - tg_yyy_zzzz_1[j] * fl1_fza);

                    tg_yyyyz_xxxx_0[j] = pb_y * tg_yyyz_xxxx_0[j] + fr * tg_yyyz_xxxx_1[j] + 1.5 * fl1_fx * (tg_yyz_xxxx_0[j] - tg_yyz_xxxx_1[j] * fl1_fza);

                    tg_yyyyz_xxxy_0[j] = pb_y * tg_yyyz_xxxy_0[j] + fr * tg_yyyz_xxxy_1[j] + 1.5 * fl1_fx * (tg_yyz_xxxy_0[j] - tg_yyz_xxxy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyyz_xxx_1[j];

                    tg_yyyyz_xxxz_0[j] = pb_y * tg_yyyz_xxxz_0[j] + fr * tg_yyyz_xxxz_1[j] + 1.5 * fl1_fx * (tg_yyz_xxxz_0[j] - tg_yyz_xxxz_1[j] * fl1_fza);

                    tg_yyyyz_xxyy_0[j] = pb_y * tg_yyyz_xxyy_0[j] + fr * tg_yyyz_xxyy_1[j] + 1.5 * fl1_fx * (tg_yyz_xxyy_0[j] - tg_yyz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_yyyz_xxy_1[j];

                    tg_yyyyz_xxyz_0[j] = pb_y * tg_yyyz_xxyz_0[j] + fr * tg_yyyz_xxyz_1[j] + 1.5 * fl1_fx * (tg_yyz_xxyz_0[j] - tg_yyz_xxyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyyz_xxz_1[j];

                    tg_yyyyz_xxzz_0[j] = pb_y * tg_yyyz_xxzz_0[j] + fr * tg_yyyz_xxzz_1[j] + 1.5 * fl1_fx * (tg_yyz_xxzz_0[j] - tg_yyz_xxzz_1[j] * fl1_fza);

                    tg_yyyyz_xyyy_0[j] = pb_y * tg_yyyz_xyyy_0[j] + fr * tg_yyyz_xyyy_1[j] + 1.5 * fl1_fx * (tg_yyz_xyyy_0[j] - tg_yyz_xyyy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yyyz_xyy_1[j];

                    tg_yyyyz_xyyz_0[j] = pb_y * tg_yyyz_xyyz_0[j] + fr * tg_yyyz_xyyz_1[j] + 1.5 * fl1_fx * (tg_yyz_xyyz_0[j] - tg_yyz_xyyz_1[j] * fl1_fza) + fl1_fxn * tg_yyyz_xyz_1[j];

                    tg_yyyyz_xyzz_0[j] = pb_y * tg_yyyz_xyzz_0[j] + fr * tg_yyyz_xyzz_1[j] + 1.5 * fl1_fx * (tg_yyz_xyzz_0[j] - tg_yyz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyyz_xzz_1[j];

                    tg_yyyyz_xzzz_0[j] = pb_y * tg_yyyz_xzzz_0[j] + fr * tg_yyyz_xzzz_1[j] + 1.5 * fl1_fx * (tg_yyz_xzzz_0[j] - tg_yyz_xzzz_1[j] * fl1_fza);

                    tg_yyyyz_yyyy_0[j] = pb_y * tg_yyyz_yyyy_0[j] + fr * tg_yyyz_yyyy_1[j] + 1.5 * fl1_fx * (tg_yyz_yyyy_0[j] - tg_yyz_yyyy_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_yyyz_yyy_1[j];

                    tg_yyyyz_yyyz_0[j] = pb_y * tg_yyyz_yyyz_0[j] + fr * tg_yyyz_yyyz_1[j] + 1.5 * fl1_fx * (tg_yyz_yyyz_0[j] - tg_yyz_yyyz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yyyz_yyz_1[j];

                    tg_yyyyz_yyzz_0[j] = pb_y * tg_yyyz_yyzz_0[j] + fr * tg_yyyz_yyzz_1[j] + 1.5 * fl1_fx * (tg_yyz_yyzz_0[j] - tg_yyz_yyzz_1[j] * fl1_fza) + fl1_fxn * tg_yyyz_yzz_1[j];

                    tg_yyyyz_yzzz_0[j] = pb_y * tg_yyyz_yzzz_0[j] + fr * tg_yyyz_yzzz_1[j] + 1.5 * fl1_fx * (tg_yyz_yzzz_0[j] - tg_yyz_yzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyyz_zzz_1[j];

                    tg_yyyyz_zzzz_0[j] = pb_y * tg_yyyz_zzzz_0[j] + fr * tg_yyyz_zzzz_1[j] + 1.5 * fl1_fx * (tg_yyz_zzzz_0[j] - tg_yyz_zzzz_1[j] * fl1_fza);

                    tg_yyyzz_xxxx_0[j] = pb_y * tg_yyzz_xxxx_0[j] + fr * tg_yyzz_xxxx_1[j] + fl1_fx * (tg_yzz_xxxx_0[j] - tg_yzz_xxxx_1[j] * fl1_fza);

                    tg_yyyzz_xxxy_0[j] = pb_y * tg_yyzz_xxxy_0[j] + fr * tg_yyzz_xxxy_1[j] + fl1_fx * (tg_yzz_xxxy_0[j] - tg_yzz_xxxy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyzz_xxx_1[j];

                    tg_yyyzz_xxxz_0[j] = pb_y * tg_yyzz_xxxz_0[j] + fr * tg_yyzz_xxxz_1[j] + fl1_fx * (tg_yzz_xxxz_0[j] - tg_yzz_xxxz_1[j] * fl1_fza);

                    tg_yyyzz_xxyy_0[j] = pb_y * tg_yyzz_xxyy_0[j] + fr * tg_yyzz_xxyy_1[j] + fl1_fx * (tg_yzz_xxyy_0[j] - tg_yzz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_yyzz_xxy_1[j];

                    tg_yyyzz_xxyz_0[j] = pb_y * tg_yyzz_xxyz_0[j] + fr * tg_yyzz_xxyz_1[j] + fl1_fx * (tg_yzz_xxyz_0[j] - tg_yzz_xxyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyzz_xxz_1[j];

                    tg_yyyzz_xxzz_0[j] = pb_y * tg_yyzz_xxzz_0[j] + fr * tg_yyzz_xxzz_1[j] + fl1_fx * (tg_yzz_xxzz_0[j] - tg_yzz_xxzz_1[j] * fl1_fza);

                    tg_yyyzz_xyyy_0[j] = pb_y * tg_yyzz_xyyy_0[j] + fr * tg_yyzz_xyyy_1[j] + fl1_fx * (tg_yzz_xyyy_0[j] - tg_yzz_xyyy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yyzz_xyy_1[j];

                    tg_yyyzz_xyyz_0[j] = pb_y * tg_yyzz_xyyz_0[j] + fr * tg_yyzz_xyyz_1[j] + fl1_fx * (tg_yzz_xyyz_0[j] - tg_yzz_xyyz_1[j] * fl1_fza) + fl1_fxn * tg_yyzz_xyz_1[j];

                    tg_yyyzz_xyzz_0[j] = pb_y * tg_yyzz_xyzz_0[j] + fr * tg_yyzz_xyzz_1[j] + fl1_fx * (tg_yzz_xyzz_0[j] - tg_yzz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyzz_xzz_1[j];

                    tg_yyyzz_xzzz_0[j] = pb_y * tg_yyzz_xzzz_0[j] + fr * tg_yyzz_xzzz_1[j] + fl1_fx * (tg_yzz_xzzz_0[j] - tg_yzz_xzzz_1[j] * fl1_fza);

                    tg_yyyzz_yyyy_0[j] = pb_y * tg_yyzz_yyyy_0[j] + fr * tg_yyzz_yyyy_1[j] + fl1_fx * (tg_yzz_yyyy_0[j] - tg_yzz_yyyy_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_yyzz_yyy_1[j];

                    tg_yyyzz_yyyz_0[j] = pb_y * tg_yyzz_yyyz_0[j] + fr * tg_yyzz_yyyz_1[j] + fl1_fx * (tg_yzz_yyyz_0[j] - tg_yzz_yyyz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yyzz_yyz_1[j];

                    tg_yyyzz_yyzz_0[j] = pb_y * tg_yyzz_yyzz_0[j] + fr * tg_yyzz_yyzz_1[j] + fl1_fx * (tg_yzz_yyzz_0[j] - tg_yzz_yyzz_1[j] * fl1_fza) + fl1_fxn * tg_yyzz_yzz_1[j];

                    tg_yyyzz_yzzz_0[j] = pb_y * tg_yyzz_yzzz_0[j] + fr * tg_yyzz_yzzz_1[j] + fl1_fx * (tg_yzz_yzzz_0[j] - tg_yzz_yzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyzz_zzz_1[j];

                    tg_yyyzz_zzzz_0[j] = pb_y * tg_yyzz_zzzz_0[j] + fr * tg_yyzz_zzzz_1[j] + fl1_fx * (tg_yzz_zzzz_0[j] - tg_yzz_zzzz_1[j] * fl1_fza);

                    tg_yyzzz_xxxx_0[j] = pb_y * tg_yzzz_xxxx_0[j] + fr * tg_yzzz_xxxx_1[j] + 0.5 * fl1_fx * (tg_zzz_xxxx_0[j] - tg_zzz_xxxx_1[j] * fl1_fza);

                    tg_yyzzz_xxxy_0[j] = pb_y * tg_yzzz_xxxy_0[j] + fr * tg_yzzz_xxxy_1[j] + 0.5 * fl1_fx * (tg_zzz_xxxy_0[j] - tg_zzz_xxxy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yzzz_xxx_1[j];

                    tg_yyzzz_xxxz_0[j] = pb_y * tg_yzzz_xxxz_0[j] + fr * tg_yzzz_xxxz_1[j] + 0.5 * fl1_fx * (tg_zzz_xxxz_0[j] - tg_zzz_xxxz_1[j] * fl1_fza);

                    tg_yyzzz_xxyy_0[j] = pb_y * tg_yzzz_xxyy_0[j] + fr * tg_yzzz_xxyy_1[j] + 0.5 * fl1_fx * (tg_zzz_xxyy_0[j] - tg_zzz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_yzzz_xxy_1[j];

                    tg_yyzzz_xxyz_0[j] = pb_y * tg_yzzz_xxyz_0[j] + fr * tg_yzzz_xxyz_1[j] + 0.5 * fl1_fx * (tg_zzz_xxyz_0[j] - tg_zzz_xxyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yzzz_xxz_1[j];

                    tg_yyzzz_xxzz_0[j] = pb_y * tg_yzzz_xxzz_0[j] + fr * tg_yzzz_xxzz_1[j] + 0.5 * fl1_fx * (tg_zzz_xxzz_0[j] - tg_zzz_xxzz_1[j] * fl1_fza);

                    tg_yyzzz_xyyy_0[j] = pb_y * tg_yzzz_xyyy_0[j] + fr * tg_yzzz_xyyy_1[j] + 0.5 * fl1_fx * (tg_zzz_xyyy_0[j] - tg_zzz_xyyy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yzzz_xyy_1[j];

                    tg_yyzzz_xyyz_0[j] = pb_y * tg_yzzz_xyyz_0[j] + fr * tg_yzzz_xyyz_1[j] + 0.5 * fl1_fx * (tg_zzz_xyyz_0[j] - tg_zzz_xyyz_1[j] * fl1_fza) + fl1_fxn * tg_yzzz_xyz_1[j];

                    tg_yyzzz_xyzz_0[j] = pb_y * tg_yzzz_xyzz_0[j] + fr * tg_yzzz_xyzz_1[j] + 0.5 * fl1_fx * (tg_zzz_xyzz_0[j] - tg_zzz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yzzz_xzz_1[j];

                    tg_yyzzz_xzzz_0[j] = pb_y * tg_yzzz_xzzz_0[j] + fr * tg_yzzz_xzzz_1[j] + 0.5 * fl1_fx * (tg_zzz_xzzz_0[j] - tg_zzz_xzzz_1[j] * fl1_fza);

                    tg_yyzzz_yyyy_0[j] = pb_y * tg_yzzz_yyyy_0[j] + fr * tg_yzzz_yyyy_1[j] + 0.5 * fl1_fx * (tg_zzz_yyyy_0[j] - tg_zzz_yyyy_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_yzzz_yyy_1[j];

                    tg_yyzzz_yyyz_0[j] = pb_y * tg_yzzz_yyyz_0[j] + fr * tg_yzzz_yyyz_1[j] + 0.5 * fl1_fx * (tg_zzz_yyyz_0[j] - tg_zzz_yyyz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yzzz_yyz_1[j];

                    tg_yyzzz_yyzz_0[j] = pb_y * tg_yzzz_yyzz_0[j] + fr * tg_yzzz_yyzz_1[j] + 0.5 * fl1_fx * (tg_zzz_yyzz_0[j] - tg_zzz_yyzz_1[j] * fl1_fza) + fl1_fxn * tg_yzzz_yzz_1[j];

                    tg_yyzzz_yzzz_0[j] = pb_y * tg_yzzz_yzzz_0[j] + fr * tg_yzzz_yzzz_1[j] + 0.5 * fl1_fx * (tg_zzz_yzzz_0[j] - tg_zzz_yzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yzzz_zzz_1[j];

                    tg_yyzzz_zzzz_0[j] = pb_y * tg_yzzz_zzzz_0[j] + fr * tg_yzzz_zzzz_1[j] + 0.5 * fl1_fx * (tg_zzz_zzzz_0[j] - tg_zzz_zzzz_1[j] * fl1_fza);

                    tg_yzzzz_xxxx_0[j] = pb_y * tg_zzzz_xxxx_0[j] + fr * tg_zzzz_xxxx_1[j];

                    tg_yzzzz_xxxy_0[j] = pb_y * tg_zzzz_xxxy_0[j] + fr * tg_zzzz_xxxy_1[j] + 0.5 * fl1_fxn * tg_zzzz_xxx_1[j];

                    tg_yzzzz_xxxz_0[j] = pb_y * tg_zzzz_xxxz_0[j] + fr * tg_zzzz_xxxz_1[j];

                    tg_yzzzz_xxyy_0[j] = pb_y * tg_zzzz_xxyy_0[j] + fr * tg_zzzz_xxyy_1[j] + fl1_fxn * tg_zzzz_xxy_1[j];

                    tg_yzzzz_xxyz_0[j] = pb_y * tg_zzzz_xxyz_0[j] + fr * tg_zzzz_xxyz_1[j] + 0.5 * fl1_fxn * tg_zzzz_xxz_1[j];

                    tg_yzzzz_xxzz_0[j] = pb_y * tg_zzzz_xxzz_0[j] + fr * tg_zzzz_xxzz_1[j];

                    tg_yzzzz_xyyy_0[j] = pb_y * tg_zzzz_xyyy_0[j] + fr * tg_zzzz_xyyy_1[j] + 1.5 * fl1_fxn * tg_zzzz_xyy_1[j];

                    tg_yzzzz_xyyz_0[j] = pb_y * tg_zzzz_xyyz_0[j] + fr * tg_zzzz_xyyz_1[j] + fl1_fxn * tg_zzzz_xyz_1[j];

                    tg_yzzzz_xyzz_0[j] = pb_y * tg_zzzz_xyzz_0[j] + fr * tg_zzzz_xyzz_1[j] + 0.5 * fl1_fxn * tg_zzzz_xzz_1[j];

                    tg_yzzzz_xzzz_0[j] = pb_y * tg_zzzz_xzzz_0[j] + fr * tg_zzzz_xzzz_1[j];

                    tg_yzzzz_yyyy_0[j] = pb_y * tg_zzzz_yyyy_0[j] + fr * tg_zzzz_yyyy_1[j] + 2.0 * fl1_fxn * tg_zzzz_yyy_1[j];

                    tg_yzzzz_yyyz_0[j] = pb_y * tg_zzzz_yyyz_0[j] + fr * tg_zzzz_yyyz_1[j] + 1.5 * fl1_fxn * tg_zzzz_yyz_1[j];

                    tg_yzzzz_yyzz_0[j] = pb_y * tg_zzzz_yyzz_0[j] + fr * tg_zzzz_yyzz_1[j] + fl1_fxn * tg_zzzz_yzz_1[j];

                    tg_yzzzz_yzzz_0[j] = pb_y * tg_zzzz_yzzz_0[j] + fr * tg_zzzz_yzzz_1[j] + 0.5 * fl1_fxn * tg_zzzz_zzz_1[j];

                    tg_yzzzz_zzzz_0[j] = pb_y * tg_zzzz_zzzz_0[j] + fr * tg_zzzz_zzzz_1[j];

                    fr = wp_z[j]; 

                    tg_zzzzz_xxxx_0[j] = pb_z * tg_zzzz_xxxx_0[j] + fr * tg_zzzz_xxxx_1[j] + 2.0 * fl1_fx * (tg_zzz_xxxx_0[j] - tg_zzz_xxxx_1[j] * fl1_fza);

                    tg_zzzzz_xxxy_0[j] = pb_z * tg_zzzz_xxxy_0[j] + fr * tg_zzzz_xxxy_1[j] + 2.0 * fl1_fx * (tg_zzz_xxxy_0[j] - tg_zzz_xxxy_1[j] * fl1_fza);

                    tg_zzzzz_xxxz_0[j] = pb_z * tg_zzzz_xxxz_0[j] + fr * tg_zzzz_xxxz_1[j] + 2.0 * fl1_fx * (tg_zzz_xxxz_0[j] - tg_zzz_xxxz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_zzzz_xxx_1[j];

                    tg_zzzzz_xxyy_0[j] = pb_z * tg_zzzz_xxyy_0[j] + fr * tg_zzzz_xxyy_1[j] + 2.0 * fl1_fx * (tg_zzz_xxyy_0[j] - tg_zzz_xxyy_1[j] * fl1_fza);

                    tg_zzzzz_xxyz_0[j] = pb_z * tg_zzzz_xxyz_0[j] + fr * tg_zzzz_xxyz_1[j] + 2.0 * fl1_fx * (tg_zzz_xxyz_0[j] - tg_zzz_xxyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_zzzz_xxy_1[j];

                    tg_zzzzz_xxzz_0[j] = pb_z * tg_zzzz_xxzz_0[j] + fr * tg_zzzz_xxzz_1[j] + 2.0 * fl1_fx * (tg_zzz_xxzz_0[j] - tg_zzz_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_zzzz_xxz_1[j];

                    tg_zzzzz_xyyy_0[j] = pb_z * tg_zzzz_xyyy_0[j] + fr * tg_zzzz_xyyy_1[j] + 2.0 * fl1_fx * (tg_zzz_xyyy_0[j] - tg_zzz_xyyy_1[j] * fl1_fza);

                    tg_zzzzz_xyyz_0[j] = pb_z * tg_zzzz_xyyz_0[j] + fr * tg_zzzz_xyyz_1[j] + 2.0 * fl1_fx * (tg_zzz_xyyz_0[j] - tg_zzz_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_zzzz_xyy_1[j];

                    tg_zzzzz_xyzz_0[j] = pb_z * tg_zzzz_xyzz_0[j] + fr * tg_zzzz_xyzz_1[j] + 2.0 * fl1_fx * (tg_zzz_xyzz_0[j] - tg_zzz_xyzz_1[j] * fl1_fza) + fl1_fxn * tg_zzzz_xyz_1[j];

                    tg_zzzzz_xzzz_0[j] = pb_z * tg_zzzz_xzzz_0[j] + fr * tg_zzzz_xzzz_1[j] + 2.0 * fl1_fx * (tg_zzz_xzzz_0[j] - tg_zzz_xzzz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_zzzz_xzz_1[j];

                    tg_zzzzz_yyyy_0[j] = pb_z * tg_zzzz_yyyy_0[j] + fr * tg_zzzz_yyyy_1[j] + 2.0 * fl1_fx * (tg_zzz_yyyy_0[j] - tg_zzz_yyyy_1[j] * fl1_fza);

                    tg_zzzzz_yyyz_0[j] = pb_z * tg_zzzz_yyyz_0[j] + fr * tg_zzzz_yyyz_1[j] + 2.0 * fl1_fx * (tg_zzz_yyyz_0[j] - tg_zzz_yyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_zzzz_yyy_1[j];

                    tg_zzzzz_yyzz_0[j] = pb_z * tg_zzzz_yyzz_0[j] + fr * tg_zzzz_yyzz_1[j] + 2.0 * fl1_fx * (tg_zzz_yyzz_0[j] - tg_zzz_yyzz_1[j] * fl1_fza) + fl1_fxn * tg_zzzz_yyz_1[j];

                    tg_zzzzz_yzzz_0[j] = pb_z * tg_zzzz_yzzz_0[j] + fr * tg_zzzz_yzzz_1[j] + 2.0 * fl1_fx * (tg_zzz_yzzz_0[j] - tg_zzz_yzzz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_zzzz_yzz_1[j];

                    tg_zzzzz_zzzz_0[j] = pb_z * tg_zzzz_zzzz_0[j] + fr * tg_zzzz_zzzz_1[j] + 2.0 * fl1_fx * (tg_zzz_zzzz_0[j] - tg_zzz_zzzz_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_zzzz_zzz_1[j];
                }
