        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    ...
                    tg_xxxxx_xxxxx_0[j] = pb_x * tg_xxxx_xxxxx_0[j] + wp_x[j] * tg_xxxx_xxxxx_1[j] + 2.0 * fl1_fx * tg_xxx_xxxxx_0[j] - 2.0 * fl1_fx * fl1_fza * tg_xxx_xxxxx_1[j] + 2.5 * fl1_fxn * tg_xxxx_xxxx_1[j];

                    tg_xxxxx_xxxxy_0[j] = pb_x * tg_xxxx_xxxxy_0[j] + wp_x[j] * tg_xxxx_xxxxy_1[j] + 2.0 * fl1_fx * tg_xxx_xxxxy_0[j] - 2.0 * fl1_fx * fl1_fza * tg_xxx_xxxxy_1[j] + 2.0 * fl1_fxn * tg_xxxx_xxxy_1[j];

                    tg_xxxxx_xxxxz_0[j] = pb_x * tg_xxxx_xxxxz_0[j] + wp_x[j] * tg_xxxx_xxxxz_1[j] + 2.0 * fl1_fx * tg_xxx_xxxxz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_xxx_xxxxz_1[j] + 2.0 * fl1_fxn * tg_xxxx_xxxz_1[j];

                    tg_xxxxx_xxxyy_0[j] = pb_x * tg_xxxx_xxxyy_0[j] + wp_x[j] * tg_xxxx_xxxyy_1[j] + 2.0 * fl1_fx * tg_xxx_xxxyy_0[j] - 2.0 * fl1_fx * fl1_fza * tg_xxx_xxxyy_1[j] + 1.5 * fl1_fxn * tg_xxxx_xxyy_1[j];

                    tg_xxxxx_xxxyz_0[j] = pb_x * tg_xxxx_xxxyz_0[j] + wp_x[j] * tg_xxxx_xxxyz_1[j] + 2.0 * fl1_fx * tg_xxx_xxxyz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_xxx_xxxyz_1[j] + 1.5 * fl1_fxn * tg_xxxx_xxyz_1[j];

                    tg_xxxxx_xxxzz_0[j] = pb_x * tg_xxxx_xxxzz_0[j] + wp_x[j] * tg_xxxx_xxxzz_1[j] + 2.0 * fl1_fx * tg_xxx_xxxzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_xxx_xxxzz_1[j] + 1.5 * fl1_fxn * tg_xxxx_xxzz_1[j];

                    tg_xxxxx_xxyyy_0[j] = pb_x * tg_xxxx_xxyyy_0[j] + wp_x[j] * tg_xxxx_xxyyy_1[j] + 2.0 * fl1_fx * tg_xxx_xxyyy_0[j] - 2.0 * fl1_fx * fl1_fza * tg_xxx_xxyyy_1[j] + fl1_fxn * tg_xxxx_xyyy_1[j];

                    tg_xxxxx_xxyyz_0[j] = pb_x * tg_xxxx_xxyyz_0[j] + wp_x[j] * tg_xxxx_xxyyz_1[j] + 2.0 * fl1_fx * tg_xxx_xxyyz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_xxx_xxyyz_1[j] + fl1_fxn * tg_xxxx_xyyz_1[j];

                    tg_xxxxx_xxyzz_0[j] = pb_x * tg_xxxx_xxyzz_0[j] + wp_x[j] * tg_xxxx_xxyzz_1[j] + 2.0 * fl1_fx * tg_xxx_xxyzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_xxx_xxyzz_1[j] + fl1_fxn * tg_xxxx_xyzz_1[j];

                    tg_xxxxx_xxzzz_0[j] = pb_x * tg_xxxx_xxzzz_0[j] + wp_x[j] * tg_xxxx_xxzzz_1[j] + 2.0 * fl1_fx * tg_xxx_xxzzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_xxx_xxzzz_1[j] + fl1_fxn * tg_xxxx_xzzz_1[j];

                    tg_xxxxx_xyyyy_0[j] = pb_x * tg_xxxx_xyyyy_0[j] + wp_x[j] * tg_xxxx_xyyyy_1[j] + 2.0 * fl1_fx * tg_xxx_xyyyy_0[j] - 2.0 * fl1_fx * fl1_fza * tg_xxx_xyyyy_1[j] + 0.5 * fl1_fxn * tg_xxxx_yyyy_1[j];

                    tg_xxxxx_xyyyz_0[j] = pb_x * tg_xxxx_xyyyz_0[j] + wp_x[j] * tg_xxxx_xyyyz_1[j] + 2.0 * fl1_fx * tg_xxx_xyyyz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_xxx_xyyyz_1[j] + 0.5 * fl1_fxn * tg_xxxx_yyyz_1[j];

                    tg_xxxxx_xyyzz_0[j] = pb_x * tg_xxxx_xyyzz_0[j] + wp_x[j] * tg_xxxx_xyyzz_1[j] + 2.0 * fl1_fx * tg_xxx_xyyzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_xxx_xyyzz_1[j] + 0.5 * fl1_fxn * tg_xxxx_yyzz_1[j];

                    tg_xxxxx_xyzzz_0[j] = pb_x * tg_xxxx_xyzzz_0[j] + wp_x[j] * tg_xxxx_xyzzz_1[j] + 2.0 * fl1_fx * tg_xxx_xyzzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_xxx_xyzzz_1[j] + 0.5 * fl1_fxn * tg_xxxx_yzzz_1[j];

                    tg_xxxxx_xzzzz_0[j] = pb_x * tg_xxxx_xzzzz_0[j] + wp_x[j] * tg_xxxx_xzzzz_1[j] + 2.0 * fl1_fx * tg_xxx_xzzzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_xxx_xzzzz_1[j] + 0.5 * fl1_fxn * tg_xxxx_zzzz_1[j];

                    tg_xxxxx_yyyyy_0[j] = pb_x * tg_xxxx_yyyyy_0[j] + wp_x[j] * tg_xxxx_yyyyy_1[j] + 2.0 * fl1_fx * tg_xxx_yyyyy_0[j] - 2.0 * fl1_fx * fl1_fza * tg_xxx_yyyyy_1[j];

                    tg_xxxxx_yyyyz_0[j] = pb_x * tg_xxxx_yyyyz_0[j] + wp_x[j] * tg_xxxx_yyyyz_1[j] + 2.0 * fl1_fx * tg_xxx_yyyyz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_xxx_yyyyz_1[j];

                    tg_xxxxx_yyyzz_0[j] = pb_x * tg_xxxx_yyyzz_0[j] + wp_x[j] * tg_xxxx_yyyzz_1[j] + 2.0 * fl1_fx * tg_xxx_yyyzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_xxx_yyyzz_1[j];

                    tg_xxxxx_yyzzz_0[j] = pb_x * tg_xxxx_yyzzz_0[j] + wp_x[j] * tg_xxxx_yyzzz_1[j] + 2.0 * fl1_fx * tg_xxx_yyzzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_xxx_yyzzz_1[j];

                    tg_xxxxx_yzzzz_0[j] = pb_x * tg_xxxx_yzzzz_0[j] + wp_x[j] * tg_xxxx_yzzzz_1[j] + 2.0 * fl1_fx * tg_xxx_yzzzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_xxx_yzzzz_1[j];

                    tg_xxxxx_zzzzz_0[j] = pb_x * tg_xxxx_zzzzz_0[j] + wp_x[j] * tg_xxxx_zzzzz_1[j] + 2.0 * fl1_fx * tg_xxx_zzzzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_xxx_zzzzz_1[j];

                    tg_xxxxy_xxxxx_0[j] = pb_x * tg_xxxy_xxxxx_0[j] + wp_x[j] * tg_xxxy_xxxxx_1[j] + 1.5 * fl1_fx * tg_xxy_xxxxx_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxy_xxxxx_1[j] + 2.5 * fl1_fxn * tg_xxxy_xxxx_1[j];

                    tg_xxxxy_xxxxy_0[j] = pb_x * tg_xxxy_xxxxy_0[j] + wp_x[j] * tg_xxxy_xxxxy_1[j] + 1.5 * fl1_fx * tg_xxy_xxxxy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxy_xxxxy_1[j] + 2.0 * fl1_fxn * tg_xxxy_xxxy_1[j];

                    tg_xxxxy_xxxxz_0[j] = pb_x * tg_xxxy_xxxxz_0[j] + wp_x[j] * tg_xxxy_xxxxz_1[j] + 1.5 * fl1_fx * tg_xxy_xxxxz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxy_xxxxz_1[j] + 2.0 * fl1_fxn * tg_xxxy_xxxz_1[j];

                    tg_xxxxy_xxxyy_0[j] = pb_x * tg_xxxy_xxxyy_0[j] + wp_x[j] * tg_xxxy_xxxyy_1[j] + 1.5 * fl1_fx * tg_xxy_xxxyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxy_xxxyy_1[j] + 1.5 * fl1_fxn * tg_xxxy_xxyy_1[j];

                    tg_xxxxy_xxxyz_0[j] = pb_x * tg_xxxy_xxxyz_0[j] + wp_x[j] * tg_xxxy_xxxyz_1[j] + 1.5 * fl1_fx * tg_xxy_xxxyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxy_xxxyz_1[j] + 1.5 * fl1_fxn * tg_xxxy_xxyz_1[j];

                    tg_xxxxy_xxxzz_0[j] = pb_x * tg_xxxy_xxxzz_0[j] + wp_x[j] * tg_xxxy_xxxzz_1[j] + 1.5 * fl1_fx * tg_xxy_xxxzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxy_xxxzz_1[j] + 1.5 * fl1_fxn * tg_xxxy_xxzz_1[j];

                    tg_xxxxy_xxyyy_0[j] = pb_x * tg_xxxy_xxyyy_0[j] + wp_x[j] * tg_xxxy_xxyyy_1[j] + 1.5 * fl1_fx * tg_xxy_xxyyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxy_xxyyy_1[j] + fl1_fxn * tg_xxxy_xyyy_1[j];

                    tg_xxxxy_xxyyz_0[j] = pb_x * tg_xxxy_xxyyz_0[j] + wp_x[j] * tg_xxxy_xxyyz_1[j] + 1.5 * fl1_fx * tg_xxy_xxyyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxy_xxyyz_1[j] + fl1_fxn * tg_xxxy_xyyz_1[j];

                    tg_xxxxy_xxyzz_0[j] = pb_x * tg_xxxy_xxyzz_0[j] + wp_x[j] * tg_xxxy_xxyzz_1[j] + 1.5 * fl1_fx * tg_xxy_xxyzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxy_xxyzz_1[j] + fl1_fxn * tg_xxxy_xyzz_1[j];

                    tg_xxxxy_xxzzz_0[j] = pb_x * tg_xxxy_xxzzz_0[j] + wp_x[j] * tg_xxxy_xxzzz_1[j] + 1.5 * fl1_fx * tg_xxy_xxzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxy_xxzzz_1[j] + fl1_fxn * tg_xxxy_xzzz_1[j];

                    tg_xxxxy_xyyyy_0[j] = pb_x * tg_xxxy_xyyyy_0[j] + wp_x[j] * tg_xxxy_xyyyy_1[j] + 1.5 * fl1_fx * tg_xxy_xyyyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxy_xyyyy_1[j] + 0.5 * fl1_fxn * tg_xxxy_yyyy_1[j];

                    tg_xxxxy_xyyyz_0[j] = pb_x * tg_xxxy_xyyyz_0[j] + wp_x[j] * tg_xxxy_xyyyz_1[j] + 1.5 * fl1_fx * tg_xxy_xyyyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxy_xyyyz_1[j] + 0.5 * fl1_fxn * tg_xxxy_yyyz_1[j];

                    tg_xxxxy_xyyzz_0[j] = pb_x * tg_xxxy_xyyzz_0[j] + wp_x[j] * tg_xxxy_xyyzz_1[j] + 1.5 * fl1_fx * tg_xxy_xyyzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxy_xyyzz_1[j] + 0.5 * fl1_fxn * tg_xxxy_yyzz_1[j];

                    tg_xxxxy_xyzzz_0[j] = pb_x * tg_xxxy_xyzzz_0[j] + wp_x[j] * tg_xxxy_xyzzz_1[j] + 1.5 * fl1_fx * tg_xxy_xyzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxy_xyzzz_1[j] + 0.5 * fl1_fxn * tg_xxxy_yzzz_1[j];

                    tg_xxxxy_xzzzz_0[j] = pb_x * tg_xxxy_xzzzz_0[j] + wp_x[j] * tg_xxxy_xzzzz_1[j] + 1.5 * fl1_fx * tg_xxy_xzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxy_xzzzz_1[j] + 0.5 * fl1_fxn * tg_xxxy_zzzz_1[j];

                    tg_xxxxy_yyyyy_0[j] = pb_x * tg_xxxy_yyyyy_0[j] + wp_x[j] * tg_xxxy_yyyyy_1[j] + 1.5 * fl1_fx * tg_xxy_yyyyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxy_yyyyy_1[j];

                    tg_xxxxy_yyyyz_0[j] = pb_x * tg_xxxy_yyyyz_0[j] + wp_x[j] * tg_xxxy_yyyyz_1[j] + 1.5 * fl1_fx * tg_xxy_yyyyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxy_yyyyz_1[j];

                    tg_xxxxy_yyyzz_0[j] = pb_x * tg_xxxy_yyyzz_0[j] + wp_x[j] * tg_xxxy_yyyzz_1[j] + 1.5 * fl1_fx * tg_xxy_yyyzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxy_yyyzz_1[j];

                    tg_xxxxy_yyzzz_0[j] = pb_x * tg_xxxy_yyzzz_0[j] + wp_x[j] * tg_xxxy_yyzzz_1[j] + 1.5 * fl1_fx * tg_xxy_yyzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxy_yyzzz_1[j];

                    tg_xxxxy_yzzzz_0[j] = pb_x * tg_xxxy_yzzzz_0[j] + wp_x[j] * tg_xxxy_yzzzz_1[j] + 1.5 * fl1_fx * tg_xxy_yzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxy_yzzzz_1[j];

                    tg_xxxxy_zzzzz_0[j] = pb_x * tg_xxxy_zzzzz_0[j] + wp_x[j] * tg_xxxy_zzzzz_1[j] + 1.5 * fl1_fx * tg_xxy_zzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxy_zzzzz_1[j];

                    tg_xxxxz_xxxxx_0[j] = pb_x * tg_xxxz_xxxxx_0[j] + wp_x[j] * tg_xxxz_xxxxx_1[j] + 1.5 * fl1_fx * tg_xxz_xxxxx_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxz_xxxxx_1[j] + 2.5 * fl1_fxn * tg_xxxz_xxxx_1[j];

                    tg_xxxxz_xxxxy_0[j] = pb_x * tg_xxxz_xxxxy_0[j] + wp_x[j] * tg_xxxz_xxxxy_1[j] + 1.5 * fl1_fx * tg_xxz_xxxxy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxz_xxxxy_1[j] + 2.0 * fl1_fxn * tg_xxxz_xxxy_1[j];

                    tg_xxxxz_xxxxz_0[j] = pb_x * tg_xxxz_xxxxz_0[j] + wp_x[j] * tg_xxxz_xxxxz_1[j] + 1.5 * fl1_fx * tg_xxz_xxxxz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxz_xxxxz_1[j] + 2.0 * fl1_fxn * tg_xxxz_xxxz_1[j];

                    tg_xxxxz_xxxyy_0[j] = pb_x * tg_xxxz_xxxyy_0[j] + wp_x[j] * tg_xxxz_xxxyy_1[j] + 1.5 * fl1_fx * tg_xxz_xxxyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxz_xxxyy_1[j] + 1.5 * fl1_fxn * tg_xxxz_xxyy_1[j];

                    tg_xxxxz_xxxyz_0[j] = pb_x * tg_xxxz_xxxyz_0[j] + wp_x[j] * tg_xxxz_xxxyz_1[j] + 1.5 * fl1_fx * tg_xxz_xxxyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxz_xxxyz_1[j] + 1.5 * fl1_fxn * tg_xxxz_xxyz_1[j];
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    ...
                    tg_xxxxz_xxyzz_0[j] = pb_x * tg_xxxz_xxyzz_0[j] + wp_x[j] * tg_xxxz_xxyzz_1[j] + 1.5 * fl1_fx * tg_xxz_xxyzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxz_xxyzz_1[j] + fl1_fxn * tg_xxxz_xyzz_1[j];

                    tg_xxxxz_xxzzz_0[j] = pb_x * tg_xxxz_xxzzz_0[j] + wp_x[j] * tg_xxxz_xxzzz_1[j] + 1.5 * fl1_fx * tg_xxz_xxzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxz_xxzzz_1[j] + fl1_fxn * tg_xxxz_xzzz_1[j];

                    tg_xxxxz_xyyyy_0[j] = pb_x * tg_xxxz_xyyyy_0[j] + wp_x[j] * tg_xxxz_xyyyy_1[j] + 1.5 * fl1_fx * tg_xxz_xyyyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxz_xyyyy_1[j] + 0.5 * fl1_fxn * tg_xxxz_yyyy_1[j];

                    tg_xxxxz_xyyyz_0[j] = pb_x * tg_xxxz_xyyyz_0[j] + wp_x[j] * tg_xxxz_xyyyz_1[j] + 1.5 * fl1_fx * tg_xxz_xyyyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxz_xyyyz_1[j] + 0.5 * fl1_fxn * tg_xxxz_yyyz_1[j];

                    tg_xxxxz_xyyzz_0[j] = pb_x * tg_xxxz_xyyzz_0[j] + wp_x[j] * tg_xxxz_xyyzz_1[j] + 1.5 * fl1_fx * tg_xxz_xyyzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxz_xyyzz_1[j] + 0.5 * fl1_fxn * tg_xxxz_yyzz_1[j];

                    tg_xxxxz_xyzzz_0[j] = pb_x * tg_xxxz_xyzzz_0[j] + wp_x[j] * tg_xxxz_xyzzz_1[j] + 1.5 * fl1_fx * tg_xxz_xyzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxz_xyzzz_1[j] + 0.5 * fl1_fxn * tg_xxxz_yzzz_1[j];

                    tg_xxxxz_xzzzz_0[j] = pb_x * tg_xxxz_xzzzz_0[j] + wp_x[j] * tg_xxxz_xzzzz_1[j] + 1.5 * fl1_fx * tg_xxz_xzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxz_xzzzz_1[j] + 0.5 * fl1_fxn * tg_xxxz_zzzz_1[j];

                    tg_xxxxz_yyyyy_0[j] = pb_x * tg_xxxz_yyyyy_0[j] + wp_x[j] * tg_xxxz_yyyyy_1[j] + 1.5 * fl1_fx * tg_xxz_yyyyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxz_yyyyy_1[j];

                    tg_xxxxz_yyyyz_0[j] = pb_x * tg_xxxz_yyyyz_0[j] + wp_x[j] * tg_xxxz_yyyyz_1[j] + 1.5 * fl1_fx * tg_xxz_yyyyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxz_yyyyz_1[j];

                    tg_xxxxz_yyyzz_0[j] = pb_x * tg_xxxz_yyyzz_0[j] + wp_x[j] * tg_xxxz_yyyzz_1[j] + 1.5 * fl1_fx * tg_xxz_yyyzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxz_yyyzz_1[j];

                    tg_xxxxz_yyzzz_0[j] = pb_x * tg_xxxz_yyzzz_0[j] + wp_x[j] * tg_xxxz_yyzzz_1[j] + 1.5 * fl1_fx * tg_xxz_yyzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxz_yyzzz_1[j];

                    tg_xxxxz_yzzzz_0[j] = pb_x * tg_xxxz_yzzzz_0[j] + wp_x[j] * tg_xxxz_yzzzz_1[j] + 1.5 * fl1_fx * tg_xxz_yzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxz_yzzzz_1[j];

                    tg_xxxxz_zzzzz_0[j] = pb_x * tg_xxxz_zzzzz_0[j] + wp_x[j] * tg_xxxz_zzzzz_1[j] + 1.5 * fl1_fx * tg_xxz_zzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xxz_zzzzz_1[j];

                    tg_xxxyy_xxxxx_0[j] = pb_x * tg_xxyy_xxxxx_0[j] + wp_x[j] * tg_xxyy_xxxxx_1[j] + fl1_fx * tg_xyy_xxxxx_0[j] - fl1_fx * fl1_fza * tg_xyy_xxxxx_1[j] + 2.5 * fl1_fxn * tg_xxyy_xxxx_1[j];

                    tg_xxxyy_xxxxy_0[j] = pb_x * tg_xxyy_xxxxy_0[j] + wp_x[j] * tg_xxyy_xxxxy_1[j] + fl1_fx * tg_xyy_xxxxy_0[j] - fl1_fx * fl1_fza * tg_xyy_xxxxy_1[j] + 2.0 * fl1_fxn * tg_xxyy_xxxy_1[j];

                    tg_xxxyy_xxxxz_0[j] = pb_x * tg_xxyy_xxxxz_0[j] + wp_x[j] * tg_xxyy_xxxxz_1[j] + fl1_fx * tg_xyy_xxxxz_0[j] - fl1_fx * fl1_fza * tg_xyy_xxxxz_1[j] + 2.0 * fl1_fxn * tg_xxyy_xxxz_1[j];

                    tg_xxxyy_xxxyy_0[j] = pb_x * tg_xxyy_xxxyy_0[j] + wp_x[j] * tg_xxyy_xxxyy_1[j] + fl1_fx * tg_xyy_xxxyy_0[j] - fl1_fx * fl1_fza * tg_xyy_xxxyy_1[j] + 1.5 * fl1_fxn * tg_xxyy_xxyy_1[j];

                    tg_xxxyy_xxxyz_0[j] = pb_x * tg_xxyy_xxxyz_0[j] + wp_x[j] * tg_xxyy_xxxyz_1[j] + fl1_fx * tg_xyy_xxxyz_0[j] - fl1_fx * fl1_fza * tg_xyy_xxxyz_1[j] + 1.5 * fl1_fxn * tg_xxyy_xxyz_1[j];

                    tg_xxxyy_xxxzz_0[j] = pb_x * tg_xxyy_xxxzz_0[j] + wp_x[j] * tg_xxyy_xxxzz_1[j] + fl1_fx * tg_xyy_xxxzz_0[j] - fl1_fx * fl1_fza * tg_xyy_xxxzz_1[j] + 1.5 * fl1_fxn * tg_xxyy_xxzz_1[j];

                    tg_xxxyy_xxyyy_0[j] = pb_x * tg_xxyy_xxyyy_0[j] + wp_x[j] * tg_xxyy_xxyyy_1[j] + fl1_fx * tg_xyy_xxyyy_0[j] - fl1_fx * fl1_fza * tg_xyy_xxyyy_1[j] + fl1_fxn * tg_xxyy_xyyy_1[j];

                    tg_xxxyy_xxyyz_0[j] = pb_x * tg_xxyy_xxyyz_0[j] + wp_x[j] * tg_xxyy_xxyyz_1[j] + fl1_fx * tg_xyy_xxyyz_0[j] - fl1_fx * fl1_fza * tg_xyy_xxyyz_1[j] + fl1_fxn * tg_xxyy_xyyz_1[j];

                    tg_xxxyy_xxyzz_0[j] = pb_x * tg_xxyy_xxyzz_0[j] + wp_x[j] * tg_xxyy_xxyzz_1[j] + fl1_fx * tg_xyy_xxyzz_0[j] - fl1_fx * fl1_fza * tg_xyy_xxyzz_1[j] + fl1_fxn * tg_xxyy_xyzz_1[j];

                    tg_xxxyy_xxzzz_0[j] = pb_x * tg_xxyy_xxzzz_0[j] + wp_x[j] * tg_xxyy_xxzzz_1[j] + fl1_fx * tg_xyy_xxzzz_0[j] - fl1_fx * fl1_fza * tg_xyy_xxzzz_1[j] + fl1_fxn * tg_xxyy_xzzz_1[j];

                    tg_xxxyy_xyyyy_0[j] = pb_x * tg_xxyy_xyyyy_0[j] + wp_x[j] * tg_xxyy_xyyyy_1[j] + fl1_fx * tg_xyy_xyyyy_0[j] - fl1_fx * fl1_fza * tg_xyy_xyyyy_1[j] + 0.5 * fl1_fxn * tg_xxyy_yyyy_1[j];

                    tg_xxxyy_xyyyz_0[j] = pb_x * tg_xxyy_xyyyz_0[j] + wp_x[j] * tg_xxyy_xyyyz_1[j] + fl1_fx * tg_xyy_xyyyz_0[j] - fl1_fx * fl1_fza * tg_xyy_xyyyz_1[j] + 0.5 * fl1_fxn * tg_xxyy_yyyz_1[j];

                    tg_xxxyy_xyyzz_0[j] = pb_x * tg_xxyy_xyyzz_0[j] + wp_x[j] * tg_xxyy_xyyzz_1[j] + fl1_fx * tg_xyy_xyyzz_0[j] - fl1_fx * fl1_fza * tg_xyy_xyyzz_1[j] + 0.5 * fl1_fxn * tg_xxyy_yyzz_1[j];

                    tg_xxxyy_xyzzz_0[j] = pb_x * tg_xxyy_xyzzz_0[j] + wp_x[j] * tg_xxyy_xyzzz_1[j] + fl1_fx * tg_xyy_xyzzz_0[j] - fl1_fx * fl1_fza * tg_xyy_xyzzz_1[j] + 0.5 * fl1_fxn * tg_xxyy_yzzz_1[j];

                    tg_xxxyy_xzzzz_0[j] = pb_x * tg_xxyy_xzzzz_0[j] + wp_x[j] * tg_xxyy_xzzzz_1[j] + fl1_fx * tg_xyy_xzzzz_0[j] - fl1_fx * fl1_fza * tg_xyy_xzzzz_1[j] + 0.5 * fl1_fxn * tg_xxyy_zzzz_1[j];

                    tg_xxxyy_yyyyy_0[j] = pb_x * tg_xxyy_yyyyy_0[j] + wp_x[j] * tg_xxyy_yyyyy_1[j] + fl1_fx * tg_xyy_yyyyy_0[j] - fl1_fx * fl1_fza * tg_xyy_yyyyy_1[j];

                    tg_xxxyy_yyyyz_0[j] = pb_x * tg_xxyy_yyyyz_0[j] + wp_x[j] * tg_xxyy_yyyyz_1[j] + fl1_fx * tg_xyy_yyyyz_0[j] - fl1_fx * fl1_fza * tg_xyy_yyyyz_1[j];

                    tg_xxxyy_yyyzz_0[j] = pb_x * tg_xxyy_yyyzz_0[j] + wp_x[j] * tg_xxyy_yyyzz_1[j] + fl1_fx * tg_xyy_yyyzz_0[j] - fl1_fx * fl1_fza * tg_xyy_yyyzz_1[j];

                    tg_xxxyy_yyzzz_0[j] = pb_x * tg_xxyy_yyzzz_0[j] + wp_x[j] * tg_xxyy_yyzzz_1[j] + fl1_fx * tg_xyy_yyzzz_0[j] - fl1_fx * fl1_fza * tg_xyy_yyzzz_1[j];

                    tg_xxxyy_yzzzz_0[j] = pb_x * tg_xxyy_yzzzz_0[j] + wp_x[j] * tg_xxyy_yzzzz_1[j] + fl1_fx * tg_xyy_yzzzz_0[j] - fl1_fx * fl1_fza * tg_xyy_yzzzz_1[j];

                    tg_xxxyy_zzzzz_0[j] = pb_x * tg_xxyy_zzzzz_0[j] + wp_x[j] * tg_xxyy_zzzzz_1[j] + fl1_fx * tg_xyy_zzzzz_0[j] - fl1_fx * fl1_fza * tg_xyy_zzzzz_1[j];

                    tg_xxxyz_xxxxx_0[j] = pb_x * tg_xxyz_xxxxx_0[j] + wp_x[j] * tg_xxyz_xxxxx_1[j] + fl1_fx * tg_xyz_xxxxx_0[j] - fl1_fx * fl1_fza * tg_xyz_xxxxx_1[j] + 2.5 * fl1_fxn * tg_xxyz_xxxx_1[j];

                    tg_xxxyz_xxxxy_0[j] = pb_x * tg_xxyz_xxxxy_0[j] + wp_x[j] * tg_xxyz_xxxxy_1[j] + fl1_fx * tg_xyz_xxxxy_0[j] - fl1_fx * fl1_fza * tg_xyz_xxxxy_1[j] + 2.0 * fl1_fxn * tg_xxyz_xxxy_1[j];

                    tg_xxxyz_xxxxz_0[j] = pb_x * tg_xxyz_xxxxz_0[j] + wp_x[j] * tg_xxyz_xxxxz_1[j] + fl1_fx * tg_xyz_xxxxz_0[j] - fl1_fx * fl1_fza * tg_xyz_xxxxz_1[j] + 2.0 * fl1_fxn * tg_xxyz_xxxz_1[j];
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    ...
                    tg_xxxyz_yyyyy_0[j] = pb_x * tg_xxyz_yyyyy_0[j] + wp_x[j] * tg_xxyz_yyyyy_1[j] + fl1_fx * tg_xyz_yyyyy_0[j] - fl1_fx * fl1_fza * tg_xyz_yyyyy_1[j];

                    tg_xxxyz_yyyyz_0[j] = pb_x * tg_xxyz_yyyyz_0[j] + wp_x[j] * tg_xxyz_yyyyz_1[j] + fl1_fx * tg_xyz_yyyyz_0[j] - fl1_fx * fl1_fza * tg_xyz_yyyyz_1[j];

                    tg_xxxyz_yyyzz_0[j] = pb_x * tg_xxyz_yyyzz_0[j] + wp_x[j] * tg_xxyz_yyyzz_1[j] + fl1_fx * tg_xyz_yyyzz_0[j] - fl1_fx * fl1_fza * tg_xyz_yyyzz_1[j];

                    tg_xxxyz_yyzzz_0[j] = pb_x * tg_xxyz_yyzzz_0[j] + wp_x[j] * tg_xxyz_yyzzz_1[j] + fl1_fx * tg_xyz_yyzzz_0[j] - fl1_fx * fl1_fza * tg_xyz_yyzzz_1[j];

                    tg_xxxyz_yzzzz_0[j] = pb_x * tg_xxyz_yzzzz_0[j] + wp_x[j] * tg_xxyz_yzzzz_1[j] + fl1_fx * tg_xyz_yzzzz_0[j] - fl1_fx * fl1_fza * tg_xyz_yzzzz_1[j];

                    tg_xxxyz_zzzzz_0[j] = pb_x * tg_xxyz_zzzzz_0[j] + wp_x[j] * tg_xxyz_zzzzz_1[j] + fl1_fx * tg_xyz_zzzzz_0[j] - fl1_fx * fl1_fza * tg_xyz_zzzzz_1[j];

                    tg_xxxzz_xxxxx_0[j] = pb_x * tg_xxzz_xxxxx_0[j] + wp_x[j] * tg_xxzz_xxxxx_1[j] + fl1_fx * tg_xzz_xxxxx_0[j] - fl1_fx * fl1_fza * tg_xzz_xxxxx_1[j] + 2.5 * fl1_fxn * tg_xxzz_xxxx_1[j];

                    tg_xxxzz_xxxxy_0[j] = pb_x * tg_xxzz_xxxxy_0[j] + wp_x[j] * tg_xxzz_xxxxy_1[j] + fl1_fx * tg_xzz_xxxxy_0[j] - fl1_fx * fl1_fza * tg_xzz_xxxxy_1[j] + 2.0 * fl1_fxn * tg_xxzz_xxxy_1[j];

                    tg_xxxzz_xxxxz_0[j] = pb_x * tg_xxzz_xxxxz_0[j] + wp_x[j] * tg_xxzz_xxxxz_1[j] + fl1_fx * tg_xzz_xxxxz_0[j] - fl1_fx * fl1_fza * tg_xzz_xxxxz_1[j] + 2.0 * fl1_fxn * tg_xxzz_xxxz_1[j];

                    tg_xxxzz_xxxyy_0[j] = pb_x * tg_xxzz_xxxyy_0[j] + wp_x[j] * tg_xxzz_xxxyy_1[j] + fl1_fx * tg_xzz_xxxyy_0[j] - fl1_fx * fl1_fza * tg_xzz_xxxyy_1[j] + 1.5 * fl1_fxn * tg_xxzz_xxyy_1[j];

                    tg_xxxzz_xxxyz_0[j] = pb_x * tg_xxzz_xxxyz_0[j] + wp_x[j] * tg_xxzz_xxxyz_1[j] + fl1_fx * tg_xzz_xxxyz_0[j] - fl1_fx * fl1_fza * tg_xzz_xxxyz_1[j] + 1.5 * fl1_fxn * tg_xxzz_xxyz_1[j];

                    tg_xxxzz_xxxzz_0[j] = pb_x * tg_xxzz_xxxzz_0[j] + wp_x[j] * tg_xxzz_xxxzz_1[j] + fl1_fx * tg_xzz_xxxzz_0[j] - fl1_fx * fl1_fza * tg_xzz_xxxzz_1[j] + 1.5 * fl1_fxn * tg_xxzz_xxzz_1[j];

                    tg_xxxzz_xxyyy_0[j] = pb_x * tg_xxzz_xxyyy_0[j] + wp_x[j] * tg_xxzz_xxyyy_1[j] + fl1_fx * tg_xzz_xxyyy_0[j] - fl1_fx * fl1_fza * tg_xzz_xxyyy_1[j] + fl1_fxn * tg_xxzz_xyyy_1[j];

                    tg_xxxzz_xxyyz_0[j] = pb_x * tg_xxzz_xxyyz_0[j] + wp_x[j] * tg_xxzz_xxyyz_1[j] + fl1_fx * tg_xzz_xxyyz_0[j] - fl1_fx * fl1_fza * tg_xzz_xxyyz_1[j] + fl1_fxn * tg_xxzz_xyyz_1[j];

                    tg_xxxzz_xxyzz_0[j] = pb_x * tg_xxzz_xxyzz_0[j] + wp_x[j] * tg_xxzz_xxyzz_1[j] + fl1_fx * tg_xzz_xxyzz_0[j] - fl1_fx * fl1_fza * tg_xzz_xxyzz_1[j] + fl1_fxn * tg_xxzz_xyzz_1[j];

                    tg_xxxzz_xxzzz_0[j] = pb_x * tg_xxzz_xxzzz_0[j] + wp_x[j] * tg_xxzz_xxzzz_1[j] + fl1_fx * tg_xzz_xxzzz_0[j] - fl1_fx * fl1_fza * tg_xzz_xxzzz_1[j] + fl1_fxn * tg_xxzz_xzzz_1[j];

                    tg_xxxzz_xyyyy_0[j] = pb_x * tg_xxzz_xyyyy_0[j] + wp_x[j] * tg_xxzz_xyyyy_1[j] + fl1_fx * tg_xzz_xyyyy_0[j] - fl1_fx * fl1_fza * tg_xzz_xyyyy_1[j] + 0.5 * fl1_fxn * tg_xxzz_yyyy_1[j];

                    tg_xxxzz_xyyyz_0[j] = pb_x * tg_xxzz_xyyyz_0[j] + wp_x[j] * tg_xxzz_xyyyz_1[j] + fl1_fx * tg_xzz_xyyyz_0[j] - fl1_fx * fl1_fza * tg_xzz_xyyyz_1[j] + 0.5 * fl1_fxn * tg_xxzz_yyyz_1[j];

                    tg_xxxzz_xyyzz_0[j] = pb_x * tg_xxzz_xyyzz_0[j] + wp_x[j] * tg_xxzz_xyyzz_1[j] + fl1_fx * tg_xzz_xyyzz_0[j] - fl1_fx * fl1_fza * tg_xzz_xyyzz_1[j] + 0.5 * fl1_fxn * tg_xxzz_yyzz_1[j];

                    tg_xxxzz_xyzzz_0[j] = pb_x * tg_xxzz_xyzzz_0[j] + wp_x[j] * tg_xxzz_xyzzz_1[j] + fl1_fx * tg_xzz_xyzzz_0[j] - fl1_fx * fl1_fza * tg_xzz_xyzzz_1[j] + 0.5 * fl1_fxn * tg_xxzz_yzzz_1[j];

                    tg_xxxzz_xzzzz_0[j] = pb_x * tg_xxzz_xzzzz_0[j] + wp_x[j] * tg_xxzz_xzzzz_1[j] + fl1_fx * tg_xzz_xzzzz_0[j] - fl1_fx * fl1_fza * tg_xzz_xzzzz_1[j] + 0.5 * fl1_fxn * tg_xxzz_zzzz_1[j];

                    tg_xxxzz_yyyyy_0[j] = pb_x * tg_xxzz_yyyyy_0[j] + wp_x[j] * tg_xxzz_yyyyy_1[j] + fl1_fx * tg_xzz_yyyyy_0[j] - fl1_fx * fl1_fza * tg_xzz_yyyyy_1[j];

                    tg_xxxzz_yyyyz_0[j] = pb_x * tg_xxzz_yyyyz_0[j] + wp_x[j] * tg_xxzz_yyyyz_1[j] + fl1_fx * tg_xzz_yyyyz_0[j] - fl1_fx * fl1_fza * tg_xzz_yyyyz_1[j];

                    tg_xxxzz_yyyzz_0[j] = pb_x * tg_xxzz_yyyzz_0[j] + wp_x[j] * tg_xxzz_yyyzz_1[j] + fl1_fx * tg_xzz_yyyzz_0[j] - fl1_fx * fl1_fza * tg_xzz_yyyzz_1[j];

                    tg_xxxzz_yyzzz_0[j] = pb_x * tg_xxzz_yyzzz_0[j] + wp_x[j] * tg_xxzz_yyzzz_1[j] + fl1_fx * tg_xzz_yyzzz_0[j] - fl1_fx * fl1_fza * tg_xzz_yyzzz_1[j];

                    tg_xxxzz_yzzzz_0[j] = pb_x * tg_xxzz_yzzzz_0[j] + wp_x[j] * tg_xxzz_yzzzz_1[j] + fl1_fx * tg_xzz_yzzzz_0[j] - fl1_fx * fl1_fza * tg_xzz_yzzzz_1[j];

                    tg_xxxzz_zzzzz_0[j] = pb_x * tg_xxzz_zzzzz_0[j] + wp_x[j] * tg_xxzz_zzzzz_1[j] + fl1_fx * tg_xzz_zzzzz_0[j] - fl1_fx * fl1_fza * tg_xzz_zzzzz_1[j];

                    tg_xxyyy_xxxxx_0[j] = pb_x * tg_xyyy_xxxxx_0[j] + wp_x[j] * tg_xyyy_xxxxx_1[j] + 0.5 * fl1_fx * tg_yyy_xxxxx_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyy_xxxxx_1[j] + 2.5 * fl1_fxn * tg_xyyy_xxxx_1[j];

                    tg_xxyyy_xxxxy_0[j] = pb_x * tg_xyyy_xxxxy_0[j] + wp_x[j] * tg_xyyy_xxxxy_1[j] + 0.5 * fl1_fx * tg_yyy_xxxxy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyy_xxxxy_1[j] + 2.0 * fl1_fxn * tg_xyyy_xxxy_1[j];

                    tg_xxyyy_xxxxz_0[j] = pb_x * tg_xyyy_xxxxz_0[j] + wp_x[j] * tg_xyyy_xxxxz_1[j] + 0.5 * fl1_fx * tg_yyy_xxxxz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyy_xxxxz_1[j] + 2.0 * fl1_fxn * tg_xyyy_xxxz_1[j];

                    tg_xxyyy_xxxyy_0[j] = pb_x * tg_xyyy_xxxyy_0[j] + wp_x[j] * tg_xyyy_xxxyy_1[j] + 0.5 * fl1_fx * tg_yyy_xxxyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyy_xxxyy_1[j] + 1.5 * fl1_fxn * tg_xyyy_xxyy_1[j];

                    tg_xxyyy_xxxyz_0[j] = pb_x * tg_xyyy_xxxyz_0[j] + wp_x[j] * tg_xyyy_xxxyz_1[j] + 0.5 * fl1_fx * tg_yyy_xxxyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyy_xxxyz_1[j] + 1.5 * fl1_fxn * tg_xyyy_xxyz_1[j];

                    tg_xxyyy_xxxzz_0[j] = pb_x * tg_xyyy_xxxzz_0[j] + wp_x[j] * tg_xyyy_xxxzz_1[j] + 0.5 * fl1_fx * tg_yyy_xxxzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyy_xxxzz_1[j] + 1.5 * fl1_fxn * tg_xyyy_xxzz_1[j];

                    tg_xxyyy_xxyyy_0[j] = pb_x * tg_xyyy_xxyyy_0[j] + wp_x[j] * tg_xyyy_xxyyy_1[j] + 0.5 * fl1_fx * tg_yyy_xxyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyy_xxyyy_1[j] + fl1_fxn * tg_xyyy_xyyy_1[j];

                    tg_xxyyy_xxyyz_0[j] = pb_x * tg_xyyy_xxyyz_0[j] + wp_x[j] * tg_xyyy_xxyyz_1[j] + 0.5 * fl1_fx * tg_yyy_xxyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyy_xxyyz_1[j] + fl1_fxn * tg_xyyy_xyyz_1[j];

                    tg_xxyyy_xxyzz_0[j] = pb_x * tg_xyyy_xxyzz_0[j] + wp_x[j] * tg_xyyy_xxyzz_1[j] + 0.5 * fl1_fx * tg_yyy_xxyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyy_xxyzz_1[j] + fl1_fxn * tg_xyyy_xyzz_1[j];

                    tg_xxyyy_xxzzz_0[j] = pb_x * tg_xyyy_xxzzz_0[j] + wp_x[j] * tg_xyyy_xxzzz_1[j] + 0.5 * fl1_fx * tg_yyy_xxzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyy_xxzzz_1[j] + fl1_fxn * tg_xyyy_xzzz_1[j];

                    tg_xxyyy_xyyyy_0[j] = pb_x * tg_xyyy_xyyyy_0[j] + wp_x[j] * tg_xyyy_xyyyy_1[j] + 0.5 * fl1_fx * tg_yyy_xyyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyy_xyyyy_1[j] + 0.5 * fl1_fxn * tg_xyyy_yyyy_1[j];

                    tg_xxyyy_xyyyz_0[j] = pb_x * tg_xyyy_xyyyz_0[j] + wp_x[j] * tg_xyyy_xyyyz_1[j] + 0.5 * fl1_fx * tg_yyy_xyyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyy_xyyyz_1[j] + 0.5 * fl1_fxn * tg_xyyy_yyyz_1[j];

                    tg_xxyyy_xyyzz_0[j] = pb_x * tg_xyyy_xyyzz_0[j] + wp_x[j] * tg_xyyy_xyyzz_1[j] + 0.5 * fl1_fx * tg_yyy_xyyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyy_xyyzz_1[j] + 0.5 * fl1_fxn * tg_xyyy_yyzz_1[j];

                    tg_xxyyy_xyzzz_0[j] = pb_x * tg_xyyy_xyzzz_0[j] + wp_x[j] * tg_xyyy_xyzzz_1[j] + 0.5 * fl1_fx * tg_yyy_xyzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyy_xyzzz_1[j] + 0.5 * fl1_fxn * tg_xyyy_yzzz_1[j];

                    tg_xxyyy_xzzzz_0[j] = pb_x * tg_xyyy_xzzzz_0[j] + wp_x[j] * tg_xyyy_xzzzz_1[j] + 0.5 * fl1_fx * tg_yyy_xzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyy_xzzzz_1[j] + 0.5 * fl1_fxn * tg_xyyy_zzzz_1[j];

                    tg_xxyyy_yyyyy_0[j] = pb_x * tg_xyyy_yyyyy_0[j] + wp_x[j] * tg_xyyy_yyyyy_1[j] + 0.5 * fl1_fx * tg_yyy_yyyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyy_yyyyy_1[j];

                    tg_xxyyy_yyyyz_0[j] = pb_x * tg_xyyy_yyyyz_0[j] + wp_x[j] * tg_xyyy_yyyyz_1[j] + 0.5 * fl1_fx * tg_yyy_yyyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyy_yyyyz_1[j];

                    tg_xxyyy_yyyzz_0[j] = pb_x * tg_xyyy_yyyzz_0[j] + wp_x[j] * tg_xyyy_yyyzz_1[j] + 0.5 * fl1_fx * tg_yyy_yyyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyy_yyyzz_1[j];

                    tg_xxyyy_yyzzz_0[j] = pb_x * tg_xyyy_yyzzz_0[j] + wp_x[j] * tg_xyyy_yyzzz_1[j] + 0.5 * fl1_fx * tg_yyy_yyzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyy_yyzzz_1[j];
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    ...
                    tg_xxyyz_xxxxy_0[j] = pb_x * tg_xyyz_xxxxy_0[j] + wp_x[j] * tg_xyyz_xxxxy_1[j] + 0.5 * fl1_fx * tg_yyz_xxxxy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyz_xxxxy_1[j] + 2.0 * fl1_fxn * tg_xyyz_xxxy_1[j];

                    tg_xxyyz_xxxxz_0[j] = pb_x * tg_xyyz_xxxxz_0[j] + wp_x[j] * tg_xyyz_xxxxz_1[j] + 0.5 * fl1_fx * tg_yyz_xxxxz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyz_xxxxz_1[j] + 2.0 * fl1_fxn * tg_xyyz_xxxz_1[j];

                    tg_xxyyz_xxxyy_0[j] = pb_x * tg_xyyz_xxxyy_0[j] + wp_x[j] * tg_xyyz_xxxyy_1[j] + 0.5 * fl1_fx * tg_yyz_xxxyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyz_xxxyy_1[j] + 1.5 * fl1_fxn * tg_xyyz_xxyy_1[j];

                    tg_xxyyz_xxxyz_0[j] = pb_x * tg_xyyz_xxxyz_0[j] + wp_x[j] * tg_xyyz_xxxyz_1[j] + 0.5 * fl1_fx * tg_yyz_xxxyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyz_xxxyz_1[j] + 1.5 * fl1_fxn * tg_xyyz_xxyz_1[j];

                    tg_xxyyz_xxxzz_0[j] = pb_x * tg_xyyz_xxxzz_0[j] + wp_x[j] * tg_xyyz_xxxzz_1[j] + 0.5 * fl1_fx * tg_yyz_xxxzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyz_xxxzz_1[j] + 1.5 * fl1_fxn * tg_xyyz_xxzz_1[j];

                    tg_xxyyz_xxyyy_0[j] = pb_x * tg_xyyz_xxyyy_0[j] + wp_x[j] * tg_xyyz_xxyyy_1[j] + 0.5 * fl1_fx * tg_yyz_xxyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyz_xxyyy_1[j] + fl1_fxn * tg_xyyz_xyyy_1[j];

                    tg_xxyyz_xxyyz_0[j] = pb_x * tg_xyyz_xxyyz_0[j] + wp_x[j] * tg_xyyz_xxyyz_1[j] + 0.5 * fl1_fx * tg_yyz_xxyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyz_xxyyz_1[j] + fl1_fxn * tg_xyyz_xyyz_1[j];

                    tg_xxyyz_xxyzz_0[j] = pb_x * tg_xyyz_xxyzz_0[j] + wp_x[j] * tg_xyyz_xxyzz_1[j] + 0.5 * fl1_fx * tg_yyz_xxyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyz_xxyzz_1[j] + fl1_fxn * tg_xyyz_xyzz_1[j];

                    tg_xxyyz_xxzzz_0[j] = pb_x * tg_xyyz_xxzzz_0[j] + wp_x[j] * tg_xyyz_xxzzz_1[j] + 0.5 * fl1_fx * tg_yyz_xxzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyz_xxzzz_1[j] + fl1_fxn * tg_xyyz_xzzz_1[j];

                    tg_xxyyz_xyyyy_0[j] = pb_x * tg_xyyz_xyyyy_0[j] + wp_x[j] * tg_xyyz_xyyyy_1[j] + 0.5 * fl1_fx * tg_yyz_xyyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyz_xyyyy_1[j] + 0.5 * fl1_fxn * tg_xyyz_yyyy_1[j];

                    tg_xxyyz_xyyyz_0[j] = pb_x * tg_xyyz_xyyyz_0[j] + wp_x[j] * tg_xyyz_xyyyz_1[j] + 0.5 * fl1_fx * tg_yyz_xyyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyz_xyyyz_1[j] + 0.5 * fl1_fxn * tg_xyyz_yyyz_1[j];

                    tg_xxyyz_xyyzz_0[j] = pb_x * tg_xyyz_xyyzz_0[j] + wp_x[j] * tg_xyyz_xyyzz_1[j] + 0.5 * fl1_fx * tg_yyz_xyyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyz_xyyzz_1[j] + 0.5 * fl1_fxn * tg_xyyz_yyzz_1[j];

                    tg_xxyyz_xyzzz_0[j] = pb_x * tg_xyyz_xyzzz_0[j] + wp_x[j] * tg_xyyz_xyzzz_1[j] + 0.5 * fl1_fx * tg_yyz_xyzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyz_xyzzz_1[j] + 0.5 * fl1_fxn * tg_xyyz_yzzz_1[j];

                    tg_xxyyz_xzzzz_0[j] = pb_x * tg_xyyz_xzzzz_0[j] + wp_x[j] * tg_xyyz_xzzzz_1[j] + 0.5 * fl1_fx * tg_yyz_xzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyz_xzzzz_1[j] + 0.5 * fl1_fxn * tg_xyyz_zzzz_1[j];

                    tg_xxyyz_yyyyy_0[j] = pb_x * tg_xyyz_yyyyy_0[j] + wp_x[j] * tg_xyyz_yyyyy_1[j] + 0.5 * fl1_fx * tg_yyz_yyyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyz_yyyyy_1[j];

                    tg_xxyyz_yyyyz_0[j] = pb_x * tg_xyyz_yyyyz_0[j] + wp_x[j] * tg_xyyz_yyyyz_1[j] + 0.5 * fl1_fx * tg_yyz_yyyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyz_yyyyz_1[j];

                    tg_xxyyz_yyyzz_0[j] = pb_x * tg_xyyz_yyyzz_0[j] + wp_x[j] * tg_xyyz_yyyzz_1[j] + 0.5 * fl1_fx * tg_yyz_yyyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyz_yyyzz_1[j];

                    tg_xxyyz_yyzzz_0[j] = pb_x * tg_xyyz_yyzzz_0[j] + wp_x[j] * tg_xyyz_yyzzz_1[j] + 0.5 * fl1_fx * tg_yyz_yyzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyz_yyzzz_1[j];

                    tg_xxyyz_yzzzz_0[j] = pb_x * tg_xyyz_yzzzz_0[j] + wp_x[j] * tg_xyyz_yzzzz_1[j] + 0.5 * fl1_fx * tg_yyz_yzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyz_yzzzz_1[j];

                    tg_xxyyz_zzzzz_0[j] = pb_x * tg_xyyz_zzzzz_0[j] + wp_x[j] * tg_xyyz_zzzzz_1[j] + 0.5 * fl1_fx * tg_yyz_zzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yyz_zzzzz_1[j];

                    tg_xxyzz_xxxxx_0[j] = pb_x * tg_xyzz_xxxxx_0[j] + wp_x[j] * tg_xyzz_xxxxx_1[j] + 0.5 * fl1_fx * tg_yzz_xxxxx_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yzz_xxxxx_1[j] + 2.5 * fl1_fxn * tg_xyzz_xxxx_1[j];

                    tg_xxyzz_xxxxy_0[j] = pb_x * tg_xyzz_xxxxy_0[j] + wp_x[j] * tg_xyzz_xxxxy_1[j] + 0.5 * fl1_fx * tg_yzz_xxxxy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yzz_xxxxy_1[j] + 2.0 * fl1_fxn * tg_xyzz_xxxy_1[j];

                    tg_xxyzz_xxxxz_0[j] = pb_x * tg_xyzz_xxxxz_0[j] + wp_x[j] * tg_xyzz_xxxxz_1[j] + 0.5 * fl1_fx * tg_yzz_xxxxz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yzz_xxxxz_1[j] + 2.0 * fl1_fxn * tg_xyzz_xxxz_1[j];

                    tg_xxyzz_xxxyy_0[j] = pb_x * tg_xyzz_xxxyy_0[j] + wp_x[j] * tg_xyzz_xxxyy_1[j] + 0.5 * fl1_fx * tg_yzz_xxxyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yzz_xxxyy_1[j] + 1.5 * fl1_fxn * tg_xyzz_xxyy_1[j];

                    tg_xxyzz_xxxyz_0[j] = pb_x * tg_xyzz_xxxyz_0[j] + wp_x[j] * tg_xyzz_xxxyz_1[j] + 0.5 * fl1_fx * tg_yzz_xxxyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yzz_xxxyz_1[j] + 1.5 * fl1_fxn * tg_xyzz_xxyz_1[j];

                    tg_xxyzz_xxxzz_0[j] = pb_x * tg_xyzz_xxxzz_0[j] + wp_x[j] * tg_xyzz_xxxzz_1[j] + 0.5 * fl1_fx * tg_yzz_xxxzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yzz_xxxzz_1[j] + 1.5 * fl1_fxn * tg_xyzz_xxzz_1[j];

                    tg_xxyzz_xxyyy_0[j] = pb_x * tg_xyzz_xxyyy_0[j] + wp_x[j] * tg_xyzz_xxyyy_1[j] + 0.5 * fl1_fx * tg_yzz_xxyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yzz_xxyyy_1[j] + fl1_fxn * tg_xyzz_xyyy_1[j];
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    ...
                    tg_xxzzz_xxyzz_0[j] = pb_x * tg_xzzz_xxyzz_0[j] + wp_x[j] * tg_xzzz_xxyzz_1[j] + 0.5 * fl1_fx * tg_zzz_xxyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zzz_xxyzz_1[j] + fl1_fxn * tg_xzzz_xyzz_1[j];

                    tg_xxzzz_xxzzz_0[j] = pb_x * tg_xzzz_xxzzz_0[j] + wp_x[j] * tg_xzzz_xxzzz_1[j] + 0.5 * fl1_fx * tg_zzz_xxzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zzz_xxzzz_1[j] + fl1_fxn * tg_xzzz_xzzz_1[j];

                    tg_xxzzz_xyyyy_0[j] = pb_x * tg_xzzz_xyyyy_0[j] + wp_x[j] * tg_xzzz_xyyyy_1[j] + 0.5 * fl1_fx * tg_zzz_xyyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zzz_xyyyy_1[j] + 0.5 * fl1_fxn * tg_xzzz_yyyy_1[j];

                    tg_xxzzz_xyyyz_0[j] = pb_x * tg_xzzz_xyyyz_0[j] + wp_x[j] * tg_xzzz_xyyyz_1[j] + 0.5 * fl1_fx * tg_zzz_xyyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zzz_xyyyz_1[j] + 0.5 * fl1_fxn * tg_xzzz_yyyz_1[j];

                    tg_xxzzz_xyyzz_0[j] = pb_x * tg_xzzz_xyyzz_0[j] + wp_x[j] * tg_xzzz_xyyzz_1[j] + 0.5 * fl1_fx * tg_zzz_xyyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zzz_xyyzz_1[j] + 0.5 * fl1_fxn * tg_xzzz_yyzz_1[j];

                    tg_xxzzz_xyzzz_0[j] = pb_x * tg_xzzz_xyzzz_0[j] + wp_x[j] * tg_xzzz_xyzzz_1[j] + 0.5 * fl1_fx * tg_zzz_xyzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zzz_xyzzz_1[j] + 0.5 * fl1_fxn * tg_xzzz_yzzz_1[j];

                    tg_xxzzz_xzzzz_0[j] = pb_x * tg_xzzz_xzzzz_0[j] + wp_x[j] * tg_xzzz_xzzzz_1[j] + 0.5 * fl1_fx * tg_zzz_xzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zzz_xzzzz_1[j] + 0.5 * fl1_fxn * tg_xzzz_zzzz_1[j];

                    tg_xxzzz_yyyyy_0[j] = pb_x * tg_xzzz_yyyyy_0[j] + wp_x[j] * tg_xzzz_yyyyy_1[j] + 0.5 * fl1_fx * tg_zzz_yyyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zzz_yyyyy_1[j];

                    tg_xxzzz_yyyyz_0[j] = pb_x * tg_xzzz_yyyyz_0[j] + wp_x[j] * tg_xzzz_yyyyz_1[j] + 0.5 * fl1_fx * tg_zzz_yyyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zzz_yyyyz_1[j];

                    tg_xxzzz_yyyzz_0[j] = pb_x * tg_xzzz_yyyzz_0[j] + wp_x[j] * tg_xzzz_yyyzz_1[j] + 0.5 * fl1_fx * tg_zzz_yyyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zzz_yyyzz_1[j];

                    tg_xxzzz_yyzzz_0[j] = pb_x * tg_xzzz_yyzzz_0[j] + wp_x[j] * tg_xzzz_yyzzz_1[j] + 0.5 * fl1_fx * tg_zzz_yyzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zzz_yyzzz_1[j];

                    tg_xxzzz_yzzzz_0[j] = pb_x * tg_xzzz_yzzzz_0[j] + wp_x[j] * tg_xzzz_yzzzz_1[j] + 0.5 * fl1_fx * tg_zzz_yzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zzz_yzzzz_1[j];

                    tg_xxzzz_zzzzz_0[j] = pb_x * tg_xzzz_zzzzz_0[j] + wp_x[j] * tg_xzzz_zzzzz_1[j] + 0.5 * fl1_fx * tg_zzz_zzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zzz_zzzzz_1[j];

                    tg_xyyyy_xxxxx_0[j] = pb_x * tg_yyyy_xxxxx_0[j] + wp_x[j] * tg_yyyy_xxxxx_1[j] + 2.5 * fl1_fxn * tg_yyyy_xxxx_1[j];

                    tg_xyyyy_xxxxy_0[j] = pb_x * tg_yyyy_xxxxy_0[j] + wp_x[j] * tg_yyyy_xxxxy_1[j] + 2.0 * fl1_fxn * tg_yyyy_xxxy_1[j];

                    tg_xyyyy_xxxxz_0[j] = pb_x * tg_yyyy_xxxxz_0[j] + wp_x[j] * tg_yyyy_xxxxz_1[j] + 2.0 * fl1_fxn * tg_yyyy_xxxz_1[j];

                    tg_xyyyy_xxxyy_0[j] = pb_x * tg_yyyy_xxxyy_0[j] + wp_x[j] * tg_yyyy_xxxyy_1[j] + 1.5 * fl1_fxn * tg_yyyy_xxyy_1[j];

                    tg_xyyyy_xxxyz_0[j] = pb_x * tg_yyyy_xxxyz_0[j] + wp_x[j] * tg_yyyy_xxxyz_1[j] + 1.5 * fl1_fxn * tg_yyyy_xxyz_1[j];

                    tg_xyyyy_xxxzz_0[j] = pb_x * tg_yyyy_xxxzz_0[j] + wp_x[j] * tg_yyyy_xxxzz_1[j] + 1.5 * fl1_fxn * tg_yyyy_xxzz_1[j];

                    tg_xyyyy_xxyyy_0[j] = pb_x * tg_yyyy_xxyyy_0[j] + wp_x[j] * tg_yyyy_xxyyy_1[j] + fl1_fxn * tg_yyyy_xyyy_1[j];

                    tg_xyyyy_xxyyz_0[j] = pb_x * tg_yyyy_xxyyz_0[j] + wp_x[j] * tg_yyyy_xxyyz_1[j] + fl1_fxn * tg_yyyy_xyyz_1[j];

                    tg_xyyyy_xxyzz_0[j] = pb_x * tg_yyyy_xxyzz_0[j] + wp_x[j] * tg_yyyy_xxyzz_1[j] + fl1_fxn * tg_yyyy_xyzz_1[j];

                    tg_xyyyy_xxzzz_0[j] = pb_x * tg_yyyy_xxzzz_0[j] + wp_x[j] * tg_yyyy_xxzzz_1[j] + fl1_fxn * tg_yyyy_xzzz_1[j];

                    tg_xyyyy_xyyyy_0[j] = pb_x * tg_yyyy_xyyyy_0[j] + wp_x[j] * tg_yyyy_xyyyy_1[j] + 0.5 * fl1_fxn * tg_yyyy_yyyy_1[j];

                    tg_xyyyy_xyyyz_0[j] = pb_x * tg_yyyy_xyyyz_0[j] + wp_x[j] * tg_yyyy_xyyyz_1[j] + 0.5 * fl1_fxn * tg_yyyy_yyyz_1[j];

                    tg_xyyyy_xyyzz_0[j] = pb_x * tg_yyyy_xyyzz_0[j] + wp_x[j] * tg_yyyy_xyyzz_1[j] + 0.5 * fl1_fxn * tg_yyyy_yyzz_1[j];

                    tg_xyyyy_xyzzz_0[j] = pb_x * tg_yyyy_xyzzz_0[j] + wp_x[j] * tg_yyyy_xyzzz_1[j] + 0.5 * fl1_fxn * tg_yyyy_yzzz_1[j];

                    tg_xyyyy_xzzzz_0[j] = pb_x * tg_yyyy_xzzzz_0[j] + wp_x[j] * tg_yyyy_xzzzz_1[j] + 0.5 * fl1_fxn * tg_yyyy_zzzz_1[j];

                    tg_xyyyy_yyyyy_0[j] = pb_x * tg_yyyy_yyyyy_0[j] + wp_x[j] * tg_yyyy_yyyyy_1[j];

                    tg_xyyyy_yyyyz_0[j] = pb_x * tg_yyyy_yyyyz_0[j] + wp_x[j] * tg_yyyy_yyyyz_1[j];

                    tg_xyyyy_yyyzz_0[j] = pb_x * tg_yyyy_yyyzz_0[j] + wp_x[j] * tg_yyyy_yyyzz_1[j];

                    tg_xyyyy_yyzzz_0[j] = pb_x * tg_yyyy_yyzzz_0[j] + wp_x[j] * tg_yyyy_yyzzz_1[j];

                    tg_xyyyy_yzzzz_0[j] = pb_x * tg_yyyy_yzzzz_0[j] + wp_x[j] * tg_yyyy_yzzzz_1[j];

                    tg_xyyyy_zzzzz_0[j] = pb_x * tg_yyyy_zzzzz_0[j] + wp_x[j] * tg_yyyy_zzzzz_1[j];

                    tg_xyyyz_xxxxx_0[j] = pb_x * tg_yyyz_xxxxx_0[j] + wp_x[j] * tg_yyyz_xxxxx_1[j] + 2.5 * fl1_fxn * tg_yyyz_xxxx_1[j];

                    tg_xyyyz_xxxxy_0[j] = pb_x * tg_yyyz_xxxxy_0[j] + wp_x[j] * tg_yyyz_xxxxy_1[j] + 2.0 * fl1_fxn * tg_yyyz_xxxy_1[j];

                    tg_xyyyz_xxxxz_0[j] = pb_x * tg_yyyz_xxxxz_0[j] + wp_x[j] * tg_yyyz_xxxxz_1[j] + 2.0 * fl1_fxn * tg_yyyz_xxxz_1[j];

                    tg_xyyyz_xxxyy_0[j] = pb_x * tg_yyyz_xxxyy_0[j] + wp_x[j] * tg_yyyz_xxxyy_1[j] + 1.5 * fl1_fxn * tg_yyyz_xxyy_1[j];

                    tg_xyyyz_xxxyz_0[j] = pb_x * tg_yyyz_xxxyz_0[j] + wp_x[j] * tg_yyyz_xxxyz_1[j] + 1.5 * fl1_fxn * tg_yyyz_xxyz_1[j];

                    tg_xyyyz_xxxzz_0[j] = pb_x * tg_yyyz_xxxzz_0[j] + wp_x[j] * tg_yyyz_xxxzz_1[j] + 1.5 * fl1_fxn * tg_yyyz_xxzz_1[j];

                    tg_xyyyz_xxyyy_0[j] = pb_x * tg_yyyz_xxyyy_0[j] + wp_x[j] * tg_yyyz_xxyyy_1[j] + fl1_fxn * tg_yyyz_xyyy_1[j];

                    tg_xyyyz_xxyyz_0[j] = pb_x * tg_yyyz_xxyyz_0[j] + wp_x[j] * tg_yyyz_xxyyz_1[j] + fl1_fxn * tg_yyyz_xyyz_1[j];

                    tg_xyyyz_xxyzz_0[j] = pb_x * tg_yyyz_xxyzz_0[j] + wp_x[j] * tg_yyyz_xxyzz_1[j] + fl1_fxn * tg_yyyz_xyzz_1[j];

                    tg_xyyyz_xxzzz_0[j] = pb_x * tg_yyyz_xxzzz_0[j] + wp_x[j] * tg_yyyz_xxzzz_1[j] + fl1_fxn * tg_yyyz_xzzz_1[j];

                    tg_xyyyz_xyyyy_0[j] = pb_x * tg_yyyz_xyyyy_0[j] + wp_x[j] * tg_yyyz_xyyyy_1[j] + 0.5 * fl1_fxn * tg_yyyz_yyyy_1[j];

                    tg_xyyyz_xyyyz_0[j] = pb_x * tg_yyyz_xyyyz_0[j] + wp_x[j] * tg_yyyz_xyyyz_1[j] + 0.5 * fl1_fxn * tg_yyyz_yyyz_1[j];
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    ...
                    tg_xyyyz_yyyyy_0[j] = pb_x * tg_yyyz_yyyyy_0[j] + wp_x[j] * tg_yyyz_yyyyy_1[j];

                    tg_xyyyz_yyyyz_0[j] = pb_x * tg_yyyz_yyyyz_0[j] + wp_x[j] * tg_yyyz_yyyyz_1[j];

                    tg_xyyyz_yyyzz_0[j] = pb_x * tg_yyyz_yyyzz_0[j] + wp_x[j] * tg_yyyz_yyyzz_1[j];

                    tg_xyyyz_yyzzz_0[j] = pb_x * tg_yyyz_yyzzz_0[j] + wp_x[j] * tg_yyyz_yyzzz_1[j];

                    tg_xyyyz_yzzzz_0[j] = pb_x * tg_yyyz_yzzzz_0[j] + wp_x[j] * tg_yyyz_yzzzz_1[j];

                    tg_xyyyz_zzzzz_0[j] = pb_x * tg_yyyz_zzzzz_0[j] + wp_x[j] * tg_yyyz_zzzzz_1[j];

                    tg_xyyzz_xxxxx_0[j] = pb_x * tg_yyzz_xxxxx_0[j] + wp_x[j] * tg_yyzz_xxxxx_1[j] + 2.5 * fl1_fxn * tg_yyzz_xxxx_1[j];

                    tg_xyyzz_xxxxy_0[j] = pb_x * tg_yyzz_xxxxy_0[j] + wp_x[j] * tg_yyzz_xxxxy_1[j] + 2.0 * fl1_fxn * tg_yyzz_xxxy_1[j];

                    tg_xyyzz_xxxxz_0[j] = pb_x * tg_yyzz_xxxxz_0[j] + wp_x[j] * tg_yyzz_xxxxz_1[j] + 2.0 * fl1_fxn * tg_yyzz_xxxz_1[j];

                    tg_xyyzz_xxxyy_0[j] = pb_x * tg_yyzz_xxxyy_0[j] + wp_x[j] * tg_yyzz_xxxyy_1[j] + 1.5 * fl1_fxn * tg_yyzz_xxyy_1[j];

                    tg_xyyzz_xxxyz_0[j] = pb_x * tg_yyzz_xxxyz_0[j] + wp_x[j] * tg_yyzz_xxxyz_1[j] + 1.5 * fl1_fxn * tg_yyzz_xxyz_1[j];

                    tg_xyyzz_xxxzz_0[j] = pb_x * tg_yyzz_xxxzz_0[j] + wp_x[j] * tg_yyzz_xxxzz_1[j] + 1.5 * fl1_fxn * tg_yyzz_xxzz_1[j];

                    tg_xyyzz_xxyyy_0[j] = pb_x * tg_yyzz_xxyyy_0[j] + wp_x[j] * tg_yyzz_xxyyy_1[j] + fl1_fxn * tg_yyzz_xyyy_1[j];

                    tg_xyyzz_xxyyz_0[j] = pb_x * tg_yyzz_xxyyz_0[j] + wp_x[j] * tg_yyzz_xxyyz_1[j] + fl1_fxn * tg_yyzz_xyyz_1[j];

                    tg_xyyzz_xxyzz_0[j] = pb_x * tg_yyzz_xxyzz_0[j] + wp_x[j] * tg_yyzz_xxyzz_1[j] + fl1_fxn * tg_yyzz_xyzz_1[j];

                    tg_xyyzz_xxzzz_0[j] = pb_x * tg_yyzz_xxzzz_0[j] + wp_x[j] * tg_yyzz_xxzzz_1[j] + fl1_fxn * tg_yyzz_xzzz_1[j];

                    tg_xyyzz_xyyyy_0[j] = pb_x * tg_yyzz_xyyyy_0[j] + wp_x[j] * tg_yyzz_xyyyy_1[j] + 0.5 * fl1_fxn * tg_yyzz_yyyy_1[j];
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    ...
                    tg_xzzzz_xxxxy_0[j] = pb_x * tg_zzzz_xxxxy_0[j] + wp_x[j] * tg_zzzz_xxxxy_1[j] + 2.0 * fl1_fxn * tg_zzzz_xxxy_1[j];

                    tg_xzzzz_xxxxz_0[j] = pb_x * tg_zzzz_xxxxz_0[j] + wp_x[j] * tg_zzzz_xxxxz_1[j] + 2.0 * fl1_fxn * tg_zzzz_xxxz_1[j];

                    tg_xzzzz_xxxyy_0[j] = pb_x * tg_zzzz_xxxyy_0[j] + wp_x[j] * tg_zzzz_xxxyy_1[j] + 1.5 * fl1_fxn * tg_zzzz_xxyy_1[j];

                    tg_xzzzz_xxxyz_0[j] = pb_x * tg_zzzz_xxxyz_0[j] + wp_x[j] * tg_zzzz_xxxyz_1[j] + 1.5 * fl1_fxn * tg_zzzz_xxyz_1[j];

                    tg_xzzzz_xxxzz_0[j] = pb_x * tg_zzzz_xxxzz_0[j] + wp_x[j] * tg_zzzz_xxxzz_1[j] + 1.5 * fl1_fxn * tg_zzzz_xxzz_1[j];

                    tg_xzzzz_xxyyy_0[j] = pb_x * tg_zzzz_xxyyy_0[j] + wp_x[j] * tg_zzzz_xxyyy_1[j] + fl1_fxn * tg_zzzz_xyyy_1[j];

                    tg_xzzzz_xxyyz_0[j] = pb_x * tg_zzzz_xxyyz_0[j] + wp_x[j] * tg_zzzz_xxyyz_1[j] + fl1_fxn * tg_zzzz_xyyz_1[j];

                    tg_xzzzz_xxyzz_0[j] = pb_x * tg_zzzz_xxyzz_0[j] + wp_x[j] * tg_zzzz_xxyzz_1[j] + fl1_fxn * tg_zzzz_xyzz_1[j];

                    tg_xzzzz_xxzzz_0[j] = pb_x * tg_zzzz_xxzzz_0[j] + wp_x[j] * tg_zzzz_xxzzz_1[j] + fl1_fxn * tg_zzzz_xzzz_1[j];

                    tg_xzzzz_xyyyy_0[j] = pb_x * tg_zzzz_xyyyy_0[j] + wp_x[j] * tg_zzzz_xyyyy_1[j] + 0.5 * fl1_fxn * tg_zzzz_yyyy_1[j];

                    tg_xzzzz_xyyyz_0[j] = pb_x * tg_zzzz_xyyyz_0[j] + wp_x[j] * tg_zzzz_xyyyz_1[j] + 0.5 * fl1_fxn * tg_zzzz_yyyz_1[j];

                    tg_xzzzz_xyyzz_0[j] = pb_x * tg_zzzz_xyyzz_0[j] + wp_x[j] * tg_zzzz_xyyzz_1[j] + 0.5 * fl1_fxn * tg_zzzz_yyzz_1[j];

                    tg_xzzzz_xyzzz_0[j] = pb_x * tg_zzzz_xyzzz_0[j] + wp_x[j] * tg_zzzz_xyzzz_1[j] + 0.5 * fl1_fxn * tg_zzzz_yzzz_1[j];

                    tg_xzzzz_xzzzz_0[j] = pb_x * tg_zzzz_xzzzz_0[j] + wp_x[j] * tg_zzzz_xzzzz_1[j] + 0.5 * fl1_fxn * tg_zzzz_zzzz_1[j];

                    tg_xzzzz_yyyyy_0[j] = pb_x * tg_zzzz_yyyyy_0[j] + wp_x[j] * tg_zzzz_yyyyy_1[j];

                    tg_xzzzz_yyyyz_0[j] = pb_x * tg_zzzz_yyyyz_0[j] + wp_x[j] * tg_zzzz_yyyyz_1[j];

                    tg_xzzzz_yyyzz_0[j] = pb_x * tg_zzzz_yyyzz_0[j] + wp_x[j] * tg_zzzz_yyyzz_1[j];

                    tg_xzzzz_yyzzz_0[j] = pb_x * tg_zzzz_yyzzz_0[j] + wp_x[j] * tg_zzzz_yyzzz_1[j];

                    tg_xzzzz_yzzzz_0[j] = pb_x * tg_zzzz_yzzzz_0[j] + wp_x[j] * tg_zzzz_yzzzz_1[j];

                    tg_xzzzz_zzzzz_0[j] = pb_x * tg_zzzz_zzzzz_0[j] + wp_x[j] * tg_zzzz_zzzzz_1[j];

                    tg_yyyyy_xxxxx_0[j] = pb_y * tg_yyyy_xxxxx_0[j] + wp_y[j] * tg_yyyy_xxxxx_1[j] + 2.0 * fl1_fx * tg_yyy_xxxxx_0[j] - 2.0 * fl1_fx * fl1_fza * tg_yyy_xxxxx_1[j];

                    tg_yyyyy_xxxxy_0[j] = pb_y * tg_yyyy_xxxxy_0[j] + wp_y[j] * tg_yyyy_xxxxy_1[j] + 2.0 * fl1_fx * tg_yyy_xxxxy_0[j] - 2.0 * fl1_fx * fl1_fza * tg_yyy_xxxxy_1[j] + 0.5 * fl1_fxn * tg_yyyy_xxxx_1[j];

                    tg_yyyyy_xxxxz_0[j] = pb_y * tg_yyyy_xxxxz_0[j] + wp_y[j] * tg_yyyy_xxxxz_1[j] + 2.0 * fl1_fx * tg_yyy_xxxxz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_yyy_xxxxz_1[j];

                    tg_yyyyy_xxxyy_0[j] = pb_y * tg_yyyy_xxxyy_0[j] + wp_y[j] * tg_yyyy_xxxyy_1[j] + 2.0 * fl1_fx * tg_yyy_xxxyy_0[j] - 2.0 * fl1_fx * fl1_fza * tg_yyy_xxxyy_1[j] + fl1_fxn * tg_yyyy_xxxy_1[j];

                    tg_yyyyy_xxxyz_0[j] = pb_y * tg_yyyy_xxxyz_0[j] + wp_y[j] * tg_yyyy_xxxyz_1[j] + 2.0 * fl1_fx * tg_yyy_xxxyz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_yyy_xxxyz_1[j] + 0.5 * fl1_fxn * tg_yyyy_xxxz_1[j];

                    tg_yyyyy_xxxzz_0[j] = pb_y * tg_yyyy_xxxzz_0[j] + wp_y[j] * tg_yyyy_xxxzz_1[j] + 2.0 * fl1_fx * tg_yyy_xxxzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_yyy_xxxzz_1[j];

                    tg_yyyyy_xxyyy_0[j] = pb_y * tg_yyyy_xxyyy_0[j] + wp_y[j] * tg_yyyy_xxyyy_1[j] + 2.0 * fl1_fx * tg_yyy_xxyyy_0[j] - 2.0 * fl1_fx * fl1_fza * tg_yyy_xxyyy_1[j] + 1.5 * fl1_fxn * tg_yyyy_xxyy_1[j];

                    tg_yyyyy_xxyyz_0[j] = pb_y * tg_yyyy_xxyyz_0[j] + wp_y[j] * tg_yyyy_xxyyz_1[j] + 2.0 * fl1_fx * tg_yyy_xxyyz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_yyy_xxyyz_1[j] + fl1_fxn * tg_yyyy_xxyz_1[j];

                    tg_yyyyy_xxyzz_0[j] = pb_y * tg_yyyy_xxyzz_0[j] + wp_y[j] * tg_yyyy_xxyzz_1[j] + 2.0 * fl1_fx * tg_yyy_xxyzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_yyy_xxyzz_1[j] + 0.5 * fl1_fxn * tg_yyyy_xxzz_1[j];

                    tg_yyyyy_xxzzz_0[j] = pb_y * tg_yyyy_xxzzz_0[j] + wp_y[j] * tg_yyyy_xxzzz_1[j] + 2.0 * fl1_fx * tg_yyy_xxzzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_yyy_xxzzz_1[j];

                    tg_yyyyy_xyyyy_0[j] = pb_y * tg_yyyy_xyyyy_0[j] + wp_y[j] * tg_yyyy_xyyyy_1[j] + 2.0 * fl1_fx * tg_yyy_xyyyy_0[j] - 2.0 * fl1_fx * fl1_fza * tg_yyy_xyyyy_1[j] + 2.0 * fl1_fxn * tg_yyyy_xyyy_1[j];

                    tg_yyyyy_xyyyz_0[j] = pb_y * tg_yyyy_xyyyz_0[j] + wp_y[j] * tg_yyyy_xyyyz_1[j] + 2.0 * fl1_fx * tg_yyy_xyyyz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_yyy_xyyyz_1[j] + 1.5 * fl1_fxn * tg_yyyy_xyyz_1[j];

                    tg_yyyyy_xyyzz_0[j] = pb_y * tg_yyyy_xyyzz_0[j] + wp_y[j] * tg_yyyy_xyyzz_1[j] + 2.0 * fl1_fx * tg_yyy_xyyzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_yyy_xyyzz_1[j] + fl1_fxn * tg_yyyy_xyzz_1[j];

                    tg_yyyyy_xyzzz_0[j] = pb_y * tg_yyyy_xyzzz_0[j] + wp_y[j] * tg_yyyy_xyzzz_1[j] + 2.0 * fl1_fx * tg_yyy_xyzzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_yyy_xyzzz_1[j] + 0.5 * fl1_fxn * tg_yyyy_xzzz_1[j];

                    tg_yyyyy_xzzzz_0[j] = pb_y * tg_yyyy_xzzzz_0[j] + wp_y[j] * tg_yyyy_xzzzz_1[j] + 2.0 * fl1_fx * tg_yyy_xzzzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_yyy_xzzzz_1[j];

                    tg_yyyyy_yyyyy_0[j] = pb_y * tg_yyyy_yyyyy_0[j] + wp_y[j] * tg_yyyy_yyyyy_1[j] + 2.0 * fl1_fx * tg_yyy_yyyyy_0[j] - 2.0 * fl1_fx * fl1_fza * tg_yyy_yyyyy_1[j] + 2.5 * fl1_fxn * tg_yyyy_yyyy_1[j];

                    tg_yyyyy_yyyyz_0[j] = pb_y * tg_yyyy_yyyyz_0[j] + wp_y[j] * tg_yyyy_yyyyz_1[j] + 2.0 * fl1_fx * tg_yyy_yyyyz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_yyy_yyyyz_1[j] + 2.0 * fl1_fxn * tg_yyyy_yyyz_1[j];

                    tg_yyyyy_yyyzz_0[j] = pb_y * tg_yyyy_yyyzz_0[j] + wp_y[j] * tg_yyyy_yyyzz_1[j] + 2.0 * fl1_fx * tg_yyy_yyyzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_yyy_yyyzz_1[j] + 1.5 * fl1_fxn * tg_yyyy_yyzz_1[j];

                    tg_yyyyy_yyzzz_0[j] = pb_y * tg_yyyy_yyzzz_0[j] + wp_y[j] * tg_yyyy_yyzzz_1[j] + 2.0 * fl1_fx * tg_yyy_yyzzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_yyy_yyzzz_1[j] + fl1_fxn * tg_yyyy_yzzz_1[j];

                    tg_yyyyy_yzzzz_0[j] = pb_y * tg_yyyy_yzzzz_0[j] + wp_y[j] * tg_yyyy_yzzzz_1[j] + 2.0 * fl1_fx * tg_yyy_yzzzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_yyy_yzzzz_1[j] + 0.5 * fl1_fxn * tg_yyyy_zzzz_1[j];

                    tg_yyyyy_zzzzz_0[j] = pb_y * tg_yyyy_zzzzz_0[j] + wp_y[j] * tg_yyyy_zzzzz_1[j] + 2.0 * fl1_fx * tg_yyy_zzzzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_yyy_zzzzz_1[j];

                    tg_yyyyz_xxxxx_0[j] = pb_y * tg_yyyz_xxxxx_0[j] + wp_y[j] * tg_yyyz_xxxxx_1[j] + 1.5 * fl1_fx * tg_yyz_xxxxx_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yyz_xxxxx_1[j];

                    tg_yyyyz_xxxxy_0[j] = pb_y * tg_yyyz_xxxxy_0[j] + wp_y[j] * tg_yyyz_xxxxy_1[j] + 1.5 * fl1_fx * tg_yyz_xxxxy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yyz_xxxxy_1[j] + 0.5 * fl1_fxn * tg_yyyz_xxxx_1[j];

                    tg_yyyyz_xxxxz_0[j] = pb_y * tg_yyyz_xxxxz_0[j] + wp_y[j] * tg_yyyz_xxxxz_1[j] + 1.5 * fl1_fx * tg_yyz_xxxxz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yyz_xxxxz_1[j];

                    tg_yyyyz_xxxyy_0[j] = pb_y * tg_yyyz_xxxyy_0[j] + wp_y[j] * tg_yyyz_xxxyy_1[j] + 1.5 * fl1_fx * tg_yyz_xxxyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yyz_xxxyy_1[j] + fl1_fxn * tg_yyyz_xxxy_1[j];

                    tg_yyyyz_xxxyz_0[j] = pb_y * tg_yyyz_xxxyz_0[j] + wp_y[j] * tg_yyyz_xxxyz_1[j] + 1.5 * fl1_fx * tg_yyz_xxxyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yyz_xxxyz_1[j] + 0.5 * fl1_fxn * tg_yyyz_xxxz_1[j];
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    ...
                    tg_yyyyz_xxyzz_0[j] = pb_y * tg_yyyz_xxyzz_0[j] + wp_y[j] * tg_yyyz_xxyzz_1[j] + 1.5 * fl1_fx * tg_yyz_xxyzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yyz_xxyzz_1[j] + 0.5 * fl1_fxn * tg_yyyz_xxzz_1[j];

                    tg_yyyyz_xxzzz_0[j] = pb_y * tg_yyyz_xxzzz_0[j] + wp_y[j] * tg_yyyz_xxzzz_1[j] + 1.5 * fl1_fx * tg_yyz_xxzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yyz_xxzzz_1[j];

                    tg_yyyyz_xyyyy_0[j] = pb_y * tg_yyyz_xyyyy_0[j] + wp_y[j] * tg_yyyz_xyyyy_1[j] + 1.5 * fl1_fx * tg_yyz_xyyyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yyz_xyyyy_1[j] + 2.0 * fl1_fxn * tg_yyyz_xyyy_1[j];

                    tg_yyyyz_xyyyz_0[j] = pb_y * tg_yyyz_xyyyz_0[j] + wp_y[j] * tg_yyyz_xyyyz_1[j] + 1.5 * fl1_fx * tg_yyz_xyyyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yyz_xyyyz_1[j] + 1.5 * fl1_fxn * tg_yyyz_xyyz_1[j];

                    tg_yyyyz_xyyzz_0[j] = pb_y * tg_yyyz_xyyzz_0[j] + wp_y[j] * tg_yyyz_xyyzz_1[j] + 1.5 * fl1_fx * tg_yyz_xyyzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yyz_xyyzz_1[j] + fl1_fxn * tg_yyyz_xyzz_1[j];

                    tg_yyyyz_xyzzz_0[j] = pb_y * tg_yyyz_xyzzz_0[j] + wp_y[j] * tg_yyyz_xyzzz_1[j] + 1.5 * fl1_fx * tg_yyz_xyzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yyz_xyzzz_1[j] + 0.5 * fl1_fxn * tg_yyyz_xzzz_1[j];

                    tg_yyyyz_xzzzz_0[j] = pb_y * tg_yyyz_xzzzz_0[j] + wp_y[j] * tg_yyyz_xzzzz_1[j] + 1.5 * fl1_fx * tg_yyz_xzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yyz_xzzzz_1[j];
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    ...
                    tg_yyzzz_yyyyy_0[j] = pb_y * tg_yzzz_yyyyy_0[j] + wp_y[j] * tg_yzzz_yyyyy_1[j] + 0.5 * fl1_fx * tg_zzz_yyyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zzz_yyyyy_1[j] + 2.5 * fl1_fxn * tg_yzzz_yyyy_1[j];

                    tg_yyzzz_yyyyz_0[j] = pb_y * tg_yzzz_yyyyz_0[j] + wp_y[j] * tg_yzzz_yyyyz_1[j] + 0.5 * fl1_fx * tg_zzz_yyyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zzz_yyyyz_1[j] + 2.0 * fl1_fxn * tg_yzzz_yyyz_1[j];

                    tg_yyzzz_yyyzz_0[j] = pb_y * tg_yzzz_yyyzz_0[j] + wp_y[j] * tg_yzzz_yyyzz_1[j] + 0.5 * fl1_fx * tg_zzz_yyyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zzz_yyyzz_1[j] + 1.5 * fl1_fxn * tg_yzzz_yyzz_1[j];

                    tg_yyzzz_yyzzz_0[j] = pb_y * tg_yzzz_yyzzz_0[j] + wp_y[j] * tg_yzzz_yyzzz_1[j] + 0.5 * fl1_fx * tg_zzz_yyzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zzz_yyzzz_1[j] + fl1_fxn * tg_yzzz_yzzz_1[j];

                    tg_yyzzz_yzzzz_0[j] = pb_y * tg_yzzz_yzzzz_0[j] + wp_y[j] * tg_yzzz_yzzzz_1[j] + 0.5 * fl1_fx * tg_zzz_yzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zzz_yzzzz_1[j] + 0.5 * fl1_fxn * tg_yzzz_zzzz_1[j];

                    tg_yyzzz_zzzzz_0[j] = pb_y * tg_yzzz_zzzzz_0[j] + wp_y[j] * tg_yzzz_zzzzz_1[j] + 0.5 * fl1_fx * tg_zzz_zzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zzz_zzzzz_1[j];

                    tg_yzzzz_xxxxx_0[j] = pb_y * tg_zzzz_xxxxx_0[j] + wp_y[j] * tg_zzzz_xxxxx_1[j];

                    tg_yzzzz_xxxxy_0[j] = pb_y * tg_zzzz_xxxxy_0[j] + wp_y[j] * tg_zzzz_xxxxy_1[j] + 0.5 * fl1_fxn * tg_zzzz_xxxx_1[j];

                    tg_yzzzz_xxxxz_0[j] = pb_y * tg_zzzz_xxxxz_0[j] + wp_y[j] * tg_zzzz_xxxxz_1[j];

                    tg_yzzzz_xxxyy_0[j] = pb_y * tg_zzzz_xxxyy_0[j] + wp_y[j] * tg_zzzz_xxxyy_1[j] + fl1_fxn * tg_zzzz_xxxy_1[j];

                    tg_yzzzz_xxxyz_0[j] = pb_y * tg_zzzz_xxxyz_0[j] + wp_y[j] * tg_zzzz_xxxyz_1[j] + 0.5 * fl1_fxn * tg_zzzz_xxxz_1[j];

                    tg_yzzzz_xxxzz_0[j] = pb_y * tg_zzzz_xxxzz_0[j] + wp_y[j] * tg_zzzz_xxxzz_1[j];

                    tg_yzzzz_xxyyy_0[j] = pb_y * tg_zzzz_xxyyy_0[j] + wp_y[j] * tg_zzzz_xxyyy_1[j] + 1.5 * fl1_fxn * tg_zzzz_xxyy_1[j];

                    tg_yzzzz_xxyyz_0[j] = pb_y * tg_zzzz_xxyyz_0[j] + wp_y[j] * tg_zzzz_xxyyz_1[j] + fl1_fxn * tg_zzzz_xxyz_1[j];

                    tg_yzzzz_xxyzz_0[j] = pb_y * tg_zzzz_xxyzz_0[j] + wp_y[j] * tg_zzzz_xxyzz_1[j] + 0.5 * fl1_fxn * tg_zzzz_xxzz_1[j];

                    tg_yzzzz_xxzzz_0[j] = pb_y * tg_zzzz_xxzzz_0[j] + wp_y[j] * tg_zzzz_xxzzz_1[j];

                    tg_yzzzz_xyyyy_0[j] = pb_y * tg_zzzz_xyyyy_0[j] + wp_y[j] * tg_zzzz_xyyyy_1[j] + 2.0 * fl1_fxn * tg_zzzz_xyyy_1[j];

                    tg_yzzzz_xyyyz_0[j] = pb_y * tg_zzzz_xyyyz_0[j] + wp_y[j] * tg_zzzz_xyyyz_1[j] + 1.5 * fl1_fxn * tg_zzzz_xyyz_1[j];

                    tg_yzzzz_xyyzz_0[j] = pb_y * tg_zzzz_xyyzz_0[j] + wp_y[j] * tg_zzzz_xyyzz_1[j] + fl1_fxn * tg_zzzz_xyzz_1[j];

                    tg_yzzzz_xyzzz_0[j] = pb_y * tg_zzzz_xyzzz_0[j] + wp_y[j] * tg_zzzz_xyzzz_1[j] + 0.5 * fl1_fxn * tg_zzzz_xzzz_1[j];

                    tg_yzzzz_xzzzz_0[j] = pb_y * tg_zzzz_xzzzz_0[j] + wp_y[j] * tg_zzzz_xzzzz_1[j];

                    tg_yzzzz_yyyyy_0[j] = pb_y * tg_zzzz_yyyyy_0[j] + wp_y[j] * tg_zzzz_yyyyy_1[j] + 2.5 * fl1_fxn * tg_zzzz_yyyy_1[j];

                    tg_yzzzz_yyyyz_0[j] = pb_y * tg_zzzz_yyyyz_0[j] + wp_y[j] * tg_zzzz_yyyyz_1[j] + 2.0 * fl1_fxn * tg_zzzz_yyyz_1[j];

                    tg_yzzzz_yyyzz_0[j] = pb_y * tg_zzzz_yyyzz_0[j] + wp_y[j] * tg_zzzz_yyyzz_1[j] + 1.5 * fl1_fxn * tg_zzzz_yyzz_1[j];

                    tg_yzzzz_yyzzz_0[j] = pb_y * tg_zzzz_yyzzz_0[j] + wp_y[j] * tg_zzzz_yyzzz_1[j] + fl1_fxn * tg_zzzz_yzzz_1[j];

                    tg_yzzzz_yzzzz_0[j] = pb_y * tg_zzzz_yzzzz_0[j] + wp_y[j] * tg_zzzz_yzzzz_1[j] + 0.5 * fl1_fxn * tg_zzzz_zzzz_1[j];

                    tg_yzzzz_zzzzz_0[j] = pb_y * tg_zzzz_zzzzz_0[j] + wp_y[j] * tg_zzzz_zzzzz_1[j];

                    tg_zzzzz_xxxxx_0[j] = pb_z * tg_zzzz_xxxxx_0[j] + wp_z[j] * tg_zzzz_xxxxx_1[j] + 2.0 * fl1_fx * tg_zzz_xxxxx_0[j] - 2.0 * fl1_fx * fl1_fza * tg_zzz_xxxxx_1[j];

                    tg_zzzzz_xxxxy_0[j] = pb_z * tg_zzzz_xxxxy_0[j] + wp_z[j] * tg_zzzz_xxxxy_1[j] + 2.0 * fl1_fx * tg_zzz_xxxxy_0[j] - 2.0 * fl1_fx * fl1_fza * tg_zzz_xxxxy_1[j];

                    tg_zzzzz_xxxxz_0[j] = pb_z * tg_zzzz_xxxxz_0[j] + wp_z[j] * tg_zzzz_xxxxz_1[j] + 2.0 * fl1_fx * tg_zzz_xxxxz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_zzz_xxxxz_1[j] + 0.5 * fl1_fxn * tg_zzzz_xxxx_1[j];

                    tg_zzzzz_xxxyy_0[j] = pb_z * tg_zzzz_xxxyy_0[j] + wp_z[j] * tg_zzzz_xxxyy_1[j] + 2.0 * fl1_fx * tg_zzz_xxxyy_0[j] - 2.0 * fl1_fx * fl1_fza * tg_zzz_xxxyy_1[j];

                    tg_zzzzz_xxxyz_0[j] = pb_z * tg_zzzz_xxxyz_0[j] + wp_z[j] * tg_zzzz_xxxyz_1[j] + 2.0 * fl1_fx * tg_zzz_xxxyz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_zzz_xxxyz_1[j] + 0.5 * fl1_fxn * tg_zzzz_xxxy_1[j];

                    tg_zzzzz_xxxzz_0[j] = pb_z * tg_zzzz_xxxzz_0[j] + wp_z[j] * tg_zzzz_xxxzz_1[j] + 2.0 * fl1_fx * tg_zzz_xxxzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_zzz_xxxzz_1[j] + fl1_fxn * tg_zzzz_xxxz_1[j];

                    tg_zzzzz_xxyyy_0[j] = pb_z * tg_zzzz_xxyyy_0[j] + wp_z[j] * tg_zzzz_xxyyy_1[j] + 2.0 * fl1_fx * tg_zzz_xxyyy_0[j] - 2.0 * fl1_fx * fl1_fza * tg_zzz_xxyyy_1[j];

                    tg_zzzzz_xxyyz_0[j] = pb_z * tg_zzzz_xxyyz_0[j] + wp_z[j] * tg_zzzz_xxyyz_1[j] + 2.0 * fl1_fx * tg_zzz_xxyyz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_zzz_xxyyz_1[j] + 0.5 * fl1_fxn * tg_zzzz_xxyy_1[j];

                    tg_zzzzz_xxyzz_0[j] = pb_z * tg_zzzz_xxyzz_0[j] + wp_z[j] * tg_zzzz_xxyzz_1[j] + 2.0 * fl1_fx * tg_zzz_xxyzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_zzz_xxyzz_1[j] + fl1_fxn * tg_zzzz_xxyz_1[j];

                    tg_zzzzz_xxzzz_0[j] = pb_z * tg_zzzz_xxzzz_0[j] + wp_z[j] * tg_zzzz_xxzzz_1[j] + 2.0 * fl1_fx * tg_zzz_xxzzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_zzz_xxzzz_1[j] + 1.5 * fl1_fxn * tg_zzzz_xxzz_1[j];

                    tg_zzzzz_xyyyy_0[j] = pb_z * tg_zzzz_xyyyy_0[j] + wp_z[j] * tg_zzzz_xyyyy_1[j] + 2.0 * fl1_fx * tg_zzz_xyyyy_0[j] - 2.0 * fl1_fx * fl1_fza * tg_zzz_xyyyy_1[j];

                    tg_zzzzz_xyyyz_0[j] = pb_z * tg_zzzz_xyyyz_0[j] + wp_z[j] * tg_zzzz_xyyyz_1[j] + 2.0 * fl1_fx * tg_zzz_xyyyz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_zzz_xyyyz_1[j] + 0.5 * fl1_fxn * tg_zzzz_xyyy_1[j];

                    tg_zzzzz_xyyzz_0[j] = pb_z * tg_zzzz_xyyzz_0[j] + wp_z[j] * tg_zzzz_xyyzz_1[j] + 2.0 * fl1_fx * tg_zzz_xyyzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_zzz_xyyzz_1[j] + fl1_fxn * tg_zzzz_xyyz_1[j];

                    tg_zzzzz_xyzzz_0[j] = pb_z * tg_zzzz_xyzzz_0[j] + wp_z[j] * tg_zzzz_xyzzz_1[j] + 2.0 * fl1_fx * tg_zzz_xyzzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_zzz_xyzzz_1[j] + 1.5 * fl1_fxn * tg_zzzz_xyzz_1[j];

                    tg_zzzzz_xzzzz_0[j] = pb_z * tg_zzzz_xzzzz_0[j] + wp_z[j] * tg_zzzz_xzzzz_1[j] + 2.0 * fl1_fx * tg_zzz_xzzzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_zzz_xzzzz_1[j] + 2.0 * fl1_fxn * tg_zzzz_xzzz_1[j];

                    tg_zzzzz_yyyyy_0[j] = pb_z * tg_zzzz_yyyyy_0[j] + wp_z[j] * tg_zzzz_yyyyy_1[j] + 2.0 * fl1_fx * tg_zzz_yyyyy_0[j] - 2.0 * fl1_fx * fl1_fza * tg_zzz_yyyyy_1[j];

                    tg_zzzzz_yyyyz_0[j] = pb_z * tg_zzzz_yyyyz_0[j] + wp_z[j] * tg_zzzz_yyyyz_1[j] + 2.0 * fl1_fx * tg_zzz_yyyyz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_zzz_yyyyz_1[j] + 0.5 * fl1_fxn * tg_zzzz_yyyy_1[j];

                    tg_zzzzz_yyyzz_0[j] = pb_z * tg_zzzz_yyyzz_0[j] + wp_z[j] * tg_zzzz_yyyzz_1[j] + 2.0 * fl1_fx * tg_zzz_yyyzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_zzz_yyyzz_1[j] + fl1_fxn * tg_zzzz_yyyz_1[j];

                    tg_zzzzz_yyzzz_0[j] = pb_z * tg_zzzz_yyzzz_0[j] + wp_z[j] * tg_zzzz_yyzzz_1[j] + 2.0 * fl1_fx * tg_zzz_yyzzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_zzz_yyzzz_1[j] + 1.5 * fl1_fxn * tg_zzzz_yyzz_1[j];

                    tg_zzzzz_yzzzz_0[j] = pb_z * tg_zzzz_yzzzz_0[j] + wp_z[j] * tg_zzzz_yzzzz_1[j] + 2.0 * fl1_fx * tg_zzz_yzzzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_zzz_yzzzz_1[j] + 2.0 * fl1_fxn * tg_zzzz_yzzz_1[j];

                    tg_zzzzz_zzzzz_0[j] = pb_z * tg_zzzz_zzzzz_0[j] + wp_z[j] * tg_zzzz_zzzzz_1[j] + 2.0 * fl1_fx * tg_zzz_zzzzz_0[j] - 2.0 * fl1_fx * fl1_fza * tg_zzz_zzzzz_1[j] + 2.5 * fl1_fxn * tg_zzzz_zzzz_1[j];
                }
