...
namespace erirecfunc { // erirecfunc namespace
    ...
    {
        erirecfunc::compElectronRepulsionForSGSK_0_50(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      wpDistances, 
                                                      braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSGSK_50_99(primBuffer,
                                                       recursionMap,
                                                       osFactors,
                                                       wpDistances, 
                                                       braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSGSK_99_148(primBuffer,
                                                        recursionMap,
                                                        osFactors,
                                                        wpDistances, 
                                                        braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSGSK_148_197(primBuffer,
                                                         recursionMap,
                                                         osFactors,
                                                         wpDistances, 
                                                         braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSGSK_197_246(primBuffer,
                                                         recursionMap,
                                                         osFactors,
                                                         wpDistances, 
                                                         braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSGSK_246_295(primBuffer,
                                                         recursionMap,
                                                         osFactors,
                                                         wpDistances, 
                                                         braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSGSK_295_344(primBuffer,
                                                         recursionMap,
                                                         osFactors,
                                                         wpDistances, 
                                                         braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSGSK_344_393(primBuffer,
                                                         recursionMap,
                                                         osFactors,
                                                         wpDistances, 
                                                         braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSGSK_393_442(primBuffer,
                                                         recursionMap,
                                                         osFactors,
                                                         wpDistances, 
                                                         braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSGSK_442_491(primBuffer,
                                                         recursionMap,
                                                         osFactors,
                                                         wpDistances, 
                                                         braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSGSK_491_540(primBuffer,
                                                         recursionMap,
                                                         osFactors,
                                                         wpDistances, 
                                                         braGtoPairsBlock,
    ...
    void
    compElectronRepulsionForSGSK_0_50(      CMemBlock2D<double>& primBuffer,
                                      const CRecursionMap&       recursionMap,
                                      const CMemBlock2D<double>& osFactors,
                                      const CMemBlock2D<double>& wpDistances,
                                      const CGtoPairsBlock&      braGtoPairsBlock,
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, fza, tg_xx_xxxxxxx_0, tg_xx_xxxxxxx_1, tg_xx_xxxxxxy_0, \
                                         ...
                                         tg_xxxy_xxxyzzz_0, tg_xxy_xxxxxx_1, tg_xxy_xxxxxxx_0, tg_xxy_xxxxxxx_1, \
                                         ...
                                         tg_xxy_xxxyzzz_0, tg_xxy_xxxyzzz_1, tg_xxy_xxxzzz_1, tg_xxy_xxyyyy_1, \
                                         tg_xxy_xxyyyz_1, tg_xxy_xxyyzz_1, tg_xxy_xxyzzz_1, tg_xy_xxxxxxx_0, tg_xy_xxxxxxx_1, \
                                         tg_xy_xxxxxxy_0, tg_xy_xxxxxxy_1, tg_xy_xxxxxxz_0, tg_xy_xxxxxxz_1, tg_xy_xxxxxyy_0, \
                                         tg_xy_xxxxxyy_1, tg_xy_xxxxxyz_0, tg_xy_xxxxxyz_1, tg_xy_xxxxxzz_0, tg_xy_xxxxxzz_1, \
                                         tg_xy_xxxxyyy_0, tg_xy_xxxxyyy_1, tg_xy_xxxxyyz_0, tg_xy_xxxxyyz_1, tg_xy_xxxxyzz_0, \
                                         tg_xy_xxxxyzz_1, tg_xy_xxxxzzz_0, tg_xy_xxxxzzz_1, tg_xy_xxxyyyy_0, tg_xy_xxxyyyy_1, \
                                         tg_xy_xxxyyyz_0, tg_xy_xxxyyyz_1, tg_xy_xxxyyzz_0, tg_xy_xxxyyzz_1, tg_xy_xxxyzzz_0, \
                                         tg_xy_xxxyzzz_1, wp_x: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    ...
                    tg_xxxx_xxxxxxx_0[j] = pb_x * tg_xxx_xxxxxxx_0[j] + wp_x[j] * tg_xxx_xxxxxxx_1[j] + 1.5 * fl1_fx * tg_xx_xxxxxxx_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xxxxxxx_1[j] + 3.5 * fl1_fxn * tg_xxx_xxxxxx_1[j];

                    tg_xxxx_xxxxxxy_0[j] = pb_x * tg_xxx_xxxxxxy_0[j] + wp_x[j] * tg_xxx_xxxxxxy_1[j] + 1.5 * fl1_fx * tg_xx_xxxxxxy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xxxxxxy_1[j] + 3.0 * fl1_fxn * tg_xxx_xxxxxy_1[j];

                    tg_xxxx_xxxxxxz_0[j] = pb_x * tg_xxx_xxxxxxz_0[j] + wp_x[j] * tg_xxx_xxxxxxz_1[j] + 1.5 * fl1_fx * tg_xx_xxxxxxz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xxxxxxz_1[j] + 3.0 * fl1_fxn * tg_xxx_xxxxxz_1[j];

                    tg_xxxx_xxxxxyy_0[j] = pb_x * tg_xxx_xxxxxyy_0[j] + wp_x[j] * tg_xxx_xxxxxyy_1[j] + 1.5 * fl1_fx * tg_xx_xxxxxyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xxxxxyy_1[j] + 2.5 * fl1_fxn * tg_xxx_xxxxyy_1[j];

                    tg_xxxx_xxxxxyz_0[j] = pb_x * tg_xxx_xxxxxyz_0[j] + wp_x[j] * tg_xxx_xxxxxyz_1[j] + 1.5 * fl1_fx * tg_xx_xxxxxyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xxxxxyz_1[j] + 2.5 * fl1_fxn * tg_xxx_xxxxyz_1[j];

                    tg_xxxx_xxxxxzz_0[j] = pb_x * tg_xxx_xxxxxzz_0[j] + wp_x[j] * tg_xxx_xxxxxzz_1[j] + 1.5 * fl1_fx * tg_xx_xxxxxzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xxxxxzz_1[j] + 2.5 * fl1_fxn * tg_xxx_xxxxzz_1[j];

                    tg_xxxx_xxxxyyy_0[j] = pb_x * tg_xxx_xxxxyyy_0[j] + wp_x[j] * tg_xxx_xxxxyyy_1[j] + 1.5 * fl1_fx * tg_xx_xxxxyyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xxxxyyy_1[j] + 2.0 * fl1_fxn * tg_xxx_xxxyyy_1[j];

                    tg_xxxx_xxxxyyz_0[j] = pb_x * tg_xxx_xxxxyyz_0[j] + wp_x[j] * tg_xxx_xxxxyyz_1[j] + 1.5 * fl1_fx * tg_xx_xxxxyyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xxxxyyz_1[j] + 2.0 * fl1_fxn * tg_xxx_xxxyyz_1[j];

                    tg_xxxx_xxxxyzz_0[j] = pb_x * tg_xxx_xxxxyzz_0[j] + wp_x[j] * tg_xxx_xxxxyzz_1[j] + 1.5 * fl1_fx * tg_xx_xxxxyzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xxxxyzz_1[j] + 2.0 * fl1_fxn * tg_xxx_xxxyzz_1[j];

                    tg_xxxx_xxxxzzz_0[j] = pb_x * tg_xxx_xxxxzzz_0[j] + wp_x[j] * tg_xxx_xxxxzzz_1[j] + 1.5 * fl1_fx * tg_xx_xxxxzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xxxxzzz_1[j] + 2.0 * fl1_fxn * tg_xxx_xxxzzz_1[j];

                    tg_xxxx_xxxyyyy_0[j] = pb_x * tg_xxx_xxxyyyy_0[j] + wp_x[j] * tg_xxx_xxxyyyy_1[j] + 1.5 * fl1_fx * tg_xx_xxxyyyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xxxyyyy_1[j] + 1.5 * fl1_fxn * tg_xxx_xxyyyy_1[j];

                    tg_xxxx_xxxyyyz_0[j] = pb_x * tg_xxx_xxxyyyz_0[j] + wp_x[j] * tg_xxx_xxxyyyz_1[j] + 1.5 * fl1_fx * tg_xx_xxxyyyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xxxyyyz_1[j] + 1.5 * fl1_fxn * tg_xxx_xxyyyz_1[j];

                    tg_xxxx_xxxyyzz_0[j] = pb_x * tg_xxx_xxxyyzz_0[j] + wp_x[j] * tg_xxx_xxxyyzz_1[j] + 1.5 * fl1_fx * tg_xx_xxxyyzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xxxyyzz_1[j] + 1.5 * fl1_fxn * tg_xxx_xxyyzz_1[j];

                    tg_xxxx_xxxyzzz_0[j] = pb_x * tg_xxx_xxxyzzz_0[j] + wp_x[j] * tg_xxx_xxxyzzz_1[j] + 1.5 * fl1_fx * tg_xx_xxxyzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xxxyzzz_1[j] + 1.5 * fl1_fxn * tg_xxx_xxyzzz_1[j];

                    tg_xxxx_xxxzzzz_0[j] = pb_x * tg_xxx_xxxzzzz_0[j] + wp_x[j] * tg_xxx_xxxzzzz_1[j] + 1.5 * fl1_fx * tg_xx_xxxzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xxxzzzz_1[j] + 1.5 * fl1_fxn * tg_xxx_xxzzzz_1[j];

                    tg_xxxx_xxyyyyy_0[j] = pb_x * tg_xxx_xxyyyyy_0[j] + wp_x[j] * tg_xxx_xxyyyyy_1[j] + 1.5 * fl1_fx * tg_xx_xxyyyyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xxyyyyy_1[j] + fl1_fxn * tg_xxx_xyyyyy_1[j];

                    tg_xxxx_xxyyyyz_0[j] = pb_x * tg_xxx_xxyyyyz_0[j] + wp_x[j] * tg_xxx_xxyyyyz_1[j] + 1.5 * fl1_fx * tg_xx_xxyyyyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xxyyyyz_1[j] + fl1_fxn * tg_xxx_xyyyyz_1[j];

                    tg_xxxx_xxyyyzz_0[j] = pb_x * tg_xxx_xxyyyzz_0[j] + wp_x[j] * tg_xxx_xxyyyzz_1[j] + 1.5 * fl1_fx * tg_xx_xxyyyzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xxyyyzz_1[j] + fl1_fxn * tg_xxx_xyyyzz_1[j];

                    tg_xxxx_xxyyzzz_0[j] = pb_x * tg_xxx_xxyyzzz_0[j] + wp_x[j] * tg_xxx_xxyyzzz_1[j] + 1.5 * fl1_fx * tg_xx_xxyyzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xxyyzzz_1[j] + fl1_fxn * tg_xxx_xyyzzz_1[j];

                    tg_xxxx_xxyzzzz_0[j] = pb_x * tg_xxx_xxyzzzz_0[j] + wp_x[j] * tg_xxx_xxyzzzz_1[j] + 1.5 * fl1_fx * tg_xx_xxyzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xxyzzzz_1[j] + fl1_fxn * tg_xxx_xyzzzz_1[j];

                    tg_xxxx_xxzzzzz_0[j] = pb_x * tg_xxx_xxzzzzz_0[j] + wp_x[j] * tg_xxx_xxzzzzz_1[j] + 1.5 * fl1_fx * tg_xx_xxzzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xxzzzzz_1[j] + fl1_fxn * tg_xxx_xzzzzz_1[j];

                    tg_xxxx_xyyyyyy_0[j] = pb_x * tg_xxx_xyyyyyy_0[j] + wp_x[j] * tg_xxx_xyyyyyy_1[j] + 1.5 * fl1_fx * tg_xx_xyyyyyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xyyyyyy_1[j] + 0.5 * fl1_fxn * tg_xxx_yyyyyy_1[j];

                    tg_xxxx_xyyyyyz_0[j] = pb_x * tg_xxx_xyyyyyz_0[j] + wp_x[j] * tg_xxx_xyyyyyz_1[j] + 1.5 * fl1_fx * tg_xx_xyyyyyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xyyyyyz_1[j] + 0.5 * fl1_fxn * tg_xxx_yyyyyz_1[j];

                    tg_xxxx_xyyyyzz_0[j] = pb_x * tg_xxx_xyyyyzz_0[j] + wp_x[j] * tg_xxx_xyyyyzz_1[j] + 1.5 * fl1_fx * tg_xx_xyyyyzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xyyyyzz_1[j] + 0.5 * fl1_fxn * tg_xxx_yyyyzz_1[j];

                    tg_xxxx_xyyyzzz_0[j] = pb_x * tg_xxx_xyyyzzz_0[j] + wp_x[j] * tg_xxx_xyyyzzz_1[j] + 1.5 * fl1_fx * tg_xx_xyyyzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xyyyzzz_1[j] + 0.5 * fl1_fxn * tg_xxx_yyyzzz_1[j];

                    tg_xxxx_xyyzzzz_0[j] = pb_x * tg_xxx_xyyzzzz_0[j] + wp_x[j] * tg_xxx_xyyzzzz_1[j] + 1.5 * fl1_fx * tg_xx_xyyzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xyyzzzz_1[j] + 0.5 * fl1_fxn * tg_xxx_yyzzzz_1[j];

                    tg_xxxx_xyzzzzz_0[j] = pb_x * tg_xxx_xyzzzzz_0[j] + wp_x[j] * tg_xxx_xyzzzzz_1[j] + 1.5 * fl1_fx * tg_xx_xyzzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xyzzzzz_1[j] + 0.5 * fl1_fxn * tg_xxx_yzzzzz_1[j];

                    tg_xxxx_xzzzzzz_0[j] = pb_x * tg_xxx_xzzzzzz_0[j] + wp_x[j] * tg_xxx_xzzzzzz_1[j] + 1.5 * fl1_fx * tg_xx_xzzzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_xzzzzzz_1[j] + 0.5 * fl1_fxn * tg_xxx_zzzzzz_1[j];

                    tg_xxxx_yyyyyyy_0[j] = pb_x * tg_xxx_yyyyyyy_0[j] + wp_x[j] * tg_xxx_yyyyyyy_1[j] + 1.5 * fl1_fx * tg_xx_yyyyyyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_yyyyyyy_1[j];

                    tg_xxxx_yyyyyyz_0[j] = pb_x * tg_xxx_yyyyyyz_0[j] + wp_x[j] * tg_xxx_yyyyyyz_1[j] + 1.5 * fl1_fx * tg_xx_yyyyyyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_yyyyyyz_1[j];

                    tg_xxxx_yyyyyzz_0[j] = pb_x * tg_xxx_yyyyyzz_0[j] + wp_x[j] * tg_xxx_yyyyyzz_1[j] + 1.5 * fl1_fx * tg_xx_yyyyyzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_yyyyyzz_1[j];

                    tg_xxxx_yyyyzzz_0[j] = pb_x * tg_xxx_yyyyzzz_0[j] + wp_x[j] * tg_xxx_yyyyzzz_1[j] + 1.5 * fl1_fx * tg_xx_yyyyzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_yyyyzzz_1[j];

                    tg_xxxx_yyyzzzz_0[j] = pb_x * tg_xxx_yyyzzzz_0[j] + wp_x[j] * tg_xxx_yyyzzzz_1[j] + 1.5 * fl1_fx * tg_xx_yyyzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_yyyzzzz_1[j];

                    tg_xxxx_yyzzzzz_0[j] = pb_x * tg_xxx_yyzzzzz_0[j] + wp_x[j] * tg_xxx_yyzzzzz_1[j] + 1.5 * fl1_fx * tg_xx_yyzzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_yyzzzzz_1[j];

                    tg_xxxx_yzzzzzz_0[j] = pb_x * tg_xxx_yzzzzzz_0[j] + wp_x[j] * tg_xxx_yzzzzzz_1[j] + 1.5 * fl1_fx * tg_xx_yzzzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_yzzzzzz_1[j];

                    tg_xxxx_zzzzzzz_0[j] = pb_x * tg_xxx_zzzzzzz_0[j] + wp_x[j] * tg_xxx_zzzzzzz_1[j] + 1.5 * fl1_fx * tg_xx_zzzzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_xx_zzzzzzz_1[j];

                    tg_xxxy_xxxxxxx_0[j] = pb_x * tg_xxy_xxxxxxx_0[j] + wp_x[j] * tg_xxy_xxxxxxx_1[j] + fl1_fx * tg_xy_xxxxxxx_0[j] - fl1_fx * fl1_fza * tg_xy_xxxxxxx_1[j] + 3.5 * fl1_fxn * tg_xxy_xxxxxx_1[j];

                    tg_xxxy_xxxxxxy_0[j] = pb_x * tg_xxy_xxxxxxy_0[j] + wp_x[j] * tg_xxy_xxxxxxy_1[j] + fl1_fx * tg_xy_xxxxxxy_0[j] - fl1_fx * fl1_fza * tg_xy_xxxxxxy_1[j] + 3.0 * fl1_fxn * tg_xxy_xxxxxy_1[j];

                    tg_xxxy_xxxxxxz_0[j] = pb_x * tg_xxy_xxxxxxz_0[j] + wp_x[j] * tg_xxy_xxxxxxz_1[j] + fl1_fx * tg_xy_xxxxxxz_0[j] - fl1_fx * fl1_fza * tg_xy_xxxxxxz_1[j] + 3.0 * fl1_fxn * tg_xxy_xxxxxz_1[j];

                    tg_xxxy_xxxxxyy_0[j] = pb_x * tg_xxy_xxxxxyy_0[j] + wp_x[j] * tg_xxy_xxxxxyy_1[j] + fl1_fx * tg_xy_xxxxxyy_0[j] - fl1_fx * fl1_fza * tg_xy_xxxxxyy_1[j] + 2.5 * fl1_fxn * tg_xxy_xxxxyy_1[j];

                    tg_xxxy_xxxxxyz_0[j] = pb_x * tg_xxy_xxxxxyz_0[j] + wp_x[j] * tg_xxy_xxxxxyz_1[j] + fl1_fx * tg_xy_xxxxxyz_0[j] - fl1_fx * fl1_fza * tg_xy_xxxxxyz_1[j] + 2.5 * fl1_fxn * tg_xxy_xxxxyz_1[j];

                    tg_xxxy_xxxxxzz_0[j] = pb_x * tg_xxy_xxxxxzz_0[j] + wp_x[j] * tg_xxy_xxxxxzz_1[j] + fl1_fx * tg_xy_xxxxxzz_0[j] - fl1_fx * fl1_fza * tg_xy_xxxxxzz_1[j] + 2.5 * fl1_fxn * tg_xxy_xxxxzz_1[j];

                    tg_xxxy_xxxxyyy_0[j] = pb_x * tg_xxy_xxxxyyy_0[j] + wp_x[j] * tg_xxy_xxxxyyy_1[j] + fl1_fx * tg_xy_xxxxyyy_0[j] - fl1_fx * fl1_fza * tg_xy_xxxxyyy_1[j] + 2.0 * fl1_fxn * tg_xxy_xxxyyy_1[j];

                    tg_xxxy_xxxxyyz_0[j] = pb_x * tg_xxy_xxxxyyz_0[j] + wp_x[j] * tg_xxy_xxxxyyz_1[j] + fl1_fx * tg_xy_xxxxyyz_0[j] - fl1_fx * fl1_fza * tg_xy_xxxxyyz_1[j] + 2.0 * fl1_fxn * tg_xxy_xxxyyz_1[j];

                    tg_xxxy_xxxxyzz_0[j] = pb_x * tg_xxy_xxxxyzz_0[j] + wp_x[j] * tg_xxy_xxxxyzz_1[j] + fl1_fx * tg_xy_xxxxyzz_0[j] - fl1_fx * fl1_fza * tg_xy_xxxxyzz_1[j] + 2.0 * fl1_fxn * tg_xxy_xxxyzz_1[j];

                    tg_xxxy_xxxxzzz_0[j] = pb_x * tg_xxy_xxxxzzz_0[j] + wp_x[j] * tg_xxy_xxxxzzz_1[j] + fl1_fx * tg_xy_xxxxzzz_0[j] - fl1_fx * fl1_fza * tg_xy_xxxxzzz_1[j] + 2.0 * fl1_fxn * tg_xxy_xxxzzz_1[j];

                    tg_xxxy_xxxyyyy_0[j] = pb_x * tg_xxy_xxxyyyy_0[j] + wp_x[j] * tg_xxy_xxxyyyy_1[j] + fl1_fx * tg_xy_xxxyyyy_0[j] - fl1_fx * fl1_fza * tg_xy_xxxyyyy_1[j] + 1.5 * fl1_fxn * tg_xxy_xxyyyy_1[j];

                    tg_xxxy_xxxyyyz_0[j] = pb_x * tg_xxy_xxxyyyz_0[j] + wp_x[j] * tg_xxy_xxxyyyz_1[j] + fl1_fx * tg_xy_xxxyyyz_0[j] - fl1_fx * fl1_fza * tg_xy_xxxyyyz_1[j] + 1.5 * fl1_fxn * tg_xxy_xxyyyz_1[j];

                    tg_xxxy_xxxyyzz_0[j] = pb_x * tg_xxy_xxxyyzz_0[j] + wp_x[j] * tg_xxy_xxxyyzz_1[j] + fl1_fx * tg_xy_xxxyyzz_0[j] - fl1_fx * fl1_fza * tg_xy_xxxyyzz_1[j] + 1.5 * fl1_fxn * tg_xxy_xxyyzz_1[j];

                    tg_xxxy_xxxyzzz_0[j] = pb_x * tg_xxy_xxxyzzz_0[j] + wp_x[j] * tg_xxy_xxxyzzz_1[j] + fl1_fx * tg_xy_xxxyzzz_0[j] - fl1_fx * fl1_fza * tg_xy_xxxyzzz_1[j] + 1.5 * fl1_fxn * tg_xxy_xxyzzz_1[j];
                }
    ...
    void
    compElectronRepulsionForSGSK_50_99(      CMemBlock2D<double>& primBuffer,
                                       const CRecursionMap&       recursionMap,
                                       const CMemBlock2D<double>& osFactors,
                                       const CMemBlock2D<double>& wpDistances,
                                       const CGtoPairsBlock&      braGtoPairsBlock,
                                       ...
                                       const int32_t              iContrPair)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, fza, tg_xxxy_xxxzzzz_0, tg_xxxy_xxyyyyy_0, tg_xxxy_xxyyyyz_0, \
                                         ...
                                         tg_xxxz_xxyyyzz_0, tg_xxxz_xxyyzzz_0, tg_xxxz_xxyzzzz_0, tg_xxxz_xxzzzzz_0, \
                                         tg_xxxz_xyyyyyy_0, tg_xxxz_xyyyyyz_0, tg_xxxz_xyyyyzz_0, tg_xxxz_xyyyzzz_0, \
                                         tg_xxxz_xyyzzzz_0, tg_xxxz_xyzzzzz_0, tg_xxy_xxxzzzz_0, tg_xxy_xxxzzzz_1, \
                                         tg_xxy_xxyyyyy_0, tg_xxy_xxyyyyy_1, tg_xxy_xxyyyyz_0, tg_xxy_xxyyyyz_1, \
                                         tg_xxy_xxyyyzz_0, tg_xxy_xxyyyzz_1, tg_xxy_xxyyzzz_0, tg_xxy_xxyyzzz_1, \
                                         tg_xxy_xxyzzzz_0, tg_xxy_xxyzzzz_1, tg_xxy_xxzzzz_1, tg_xxy_xxzzzzz_0, \
                                         tg_xxy_xxzzzzz_1, tg_xxy_xyyyyy_1, tg_xxy_xyyyyyy_0, tg_xxy_xyyyyyy_1, \
                                         tg_xxy_xyyyyyz_0, tg_xxy_xyyyyyz_1, tg_xxy_xyyyyz_1, tg_xxy_xyyyyzz_0, \
                                         tg_xxy_xyyyyzz_1, tg_xxy_xyyyzz_1, tg_xxy_xyyyzzz_0, tg_xxy_xyyyzzz_1, \
                                         tg_xxy_xyyzzz_1, tg_xxy_xyyzzzz_0, tg_xxy_xyyzzzz_1, tg_xxy_xyzzzz_1, \
                                         tg_xxy_xyzzzzz_0, tg_xxy_xyzzzzz_1, tg_xxy_xzzzzz_1, tg_xxy_xzzzzzz_0, \
                                         tg_xxy_xzzzzzz_1, tg_xxy_yyyyyy_1, tg_xxy_yyyyyyy_0, tg_xxy_yyyyyyy_1, \
                                         tg_xxy_yyyyyyz_0, tg_xxy_yyyyyyz_1, tg_xxy_yyyyyz_1, tg_xxy_yyyyyzz_0, \
                                         tg_xxy_yyyyyzz_1, tg_xxy_yyyyzz_1, tg_xxy_yyyyzzz_0, tg_xxy_yyyyzzz_1, \
                                         tg_xxy_yyyzzz_1, tg_xxy_yyyzzzz_0, tg_xxy_yyyzzzz_1, tg_xxy_yyzzzz_1, \
                                         tg_xxy_yyzzzzz_0, tg_xxy_yyzzzzz_1, tg_xxy_yzzzzz_1, tg_xxy_yzzzzzz_0, \
                                         tg_xxy_yzzzzzz_1, tg_xxy_zzzzzz_1, tg_xxy_zzzzzzz_0, tg_xxy_zzzzzzz_1, \
                                         tg_xxz_xxxxxx_1, tg_xxz_xxxxxxx_0, tg_xxz_xxxxxxx_1, tg_xxz_xxxxxxy_0, \
                                         tg_xxz_xxxxxxy_1, tg_xxz_xxxxxxz_0, tg_xxz_xxxxxxz_1, tg_xxz_xxxxxy_1, \
                                         tg_xxz_xxxxxyy_0, tg_xxz_xxxxxyy_1, tg_xxz_xxxxxyz_0, tg_xxz_xxxxxyz_1, \
                                         tg_xxz_xxxxxz_1, tg_xxz_xxxxxzz_0, tg_xxz_xxxxxzz_1, tg_xxz_xxxxyy_1, \
                                         tg_xxz_xxxxyyy_0, tg_xxz_xxxxyyy_1, tg_xxz_xxxxyyz_0, tg_xxz_xxxxyyz_1, \
                                         tg_xxz_xxxxyz_1, tg_xxz_xxxxyzz_0, tg_xxz_xxxxyzz_1, tg_xxz_xxxxzz_1, \
                                         tg_xxz_xxxxzzz_0, tg_xxz_xxxxzzz_1, tg_xxz_xxxyyy_1, tg_xxz_xxxyyyy_0, \
                                         tg_xxz_xxxyyyy_1, tg_xxz_xxxyyyz_0, tg_xxz_xxxyyyz_1, tg_xxz_xxxyyz_1, \
                                         tg_xxz_xxxyyzz_0, tg_xxz_xxxyyzz_1, tg_xxz_xxxyzz_1, tg_xxz_xxxyzzz_0, \
                                         tg_xxz_xxxyzzz_1, tg_xxz_xxxzzz_1, tg_xxz_xxxzzzz_0, tg_xxz_xxxzzzz_1, \
                                         tg_xxz_xxyyyy_1, tg_xxz_xxyyyyy_0, tg_xxz_xxyyyyy_1, tg_xxz_xxyyyyz_0, \
                                         tg_xxz_xxyyyyz_1, tg_xxz_xxyyyz_1, tg_xxz_xxyyyzz_0, tg_xxz_xxyyyzz_1, \
                                         tg_xxz_xxyyzz_1, tg_xxz_xxyyzzz_0, tg_xxz_xxyyzzz_1, tg_xxz_xxyzzz_1, \
                                         tg_xxz_xxyzzzz_0, tg_xxz_xxyzzzz_1, tg_xxz_xxzzzz_1, tg_xxz_xxzzzzz_0, \
                                         tg_xxz_xxzzzzz_1, tg_xxz_xyyyyy_1, tg_xxz_xyyyyyy_0, tg_xxz_xyyyyyy_1, \
                                         tg_xxz_xyyyyyz_0, tg_xxz_xyyyyyz_1, tg_xxz_xyyyyz_1, tg_xxz_xyyyyzz_0, \
                                         tg_xxz_xyyyyzz_1, tg_xxz_xyyyzz_1, tg_xxz_xyyyzzz_0, tg_xxz_xyyyzzz_1, \
                                         tg_xxz_xyyzzz_1, tg_xxz_xyyzzzz_0, tg_xxz_xyyzzzz_1, tg_xxz_xyzzzz_1, \
                                         tg_xxz_xyzzzzz_0, tg_xxz_xyzzzzz_1, tg_xxz_xzzzzz_1, tg_xxz_yyyyyy_1, \
                                         tg_xxz_yyyyyz_1, tg_xxz_yyyyzz_1, tg_xxz_yyyzzz_1, tg_xxz_yyzzzz_1, tg_xxz_yzzzzz_1, \
                                         ...
                                         tg_xz_xxyyzzz_0, tg_xz_xxyyzzz_1, tg_xz_xxyzzzz_0, tg_xz_xxyzzzz_1, tg_xz_xxzzzzz_0, \
                                         tg_xz_xxzzzzz_1, tg_xz_xyyyyyy_0, tg_xz_xyyyyyy_1, tg_xz_xyyyyyz_0, tg_xz_xyyyyyz_1, \
                                         tg_xz_xyyyyzz_0, tg_xz_xyyyyzz_1, tg_xz_xyyyzzz_0, tg_xz_xyyyzzz_1, tg_xz_xyyzzzz_0, \
                                         tg_xz_xyyzzzz_1, tg_xz_xyzzzzz_0, tg_xz_xyzzzzz_1, wp_x: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fx = fx;
                    ...
                    tg_xxxy_xxxzzzz_0[j] = pb_x * tg_xxy_xxxzzzz_0[j] + wp_x[j] * tg_xxy_xxxzzzz_1[j] + fl1_fx * tg_xy_xxxzzzz_0[j] - fl1_fx * fl1_fza * tg_xy_xxxzzzz_1[j] + 1.5 * fl1_fxn * tg_xxy_xxzzzz_1[j];

                    tg_xxxy_xxyyyyy_0[j] = pb_x * tg_xxy_xxyyyyy_0[j] + wp_x[j] * tg_xxy_xxyyyyy_1[j] + fl1_fx * tg_xy_xxyyyyy_0[j] - fl1_fx * fl1_fza * tg_xy_xxyyyyy_1[j] + fl1_fxn * tg_xxy_xyyyyy_1[j];

                    tg_xxxy_xxyyyyz_0[j] = pb_x * tg_xxy_xxyyyyz_0[j] + wp_x[j] * tg_xxy_xxyyyyz_1[j] + fl1_fx * tg_xy_xxyyyyz_0[j] - fl1_fx * fl1_fza * tg_xy_xxyyyyz_1[j] + fl1_fxn * tg_xxy_xyyyyz_1[j];

                    tg_xxxy_xxyyyzz_0[j] = pb_x * tg_xxy_xxyyyzz_0[j] + wp_x[j] * tg_xxy_xxyyyzz_1[j] + fl1_fx * tg_xy_xxyyyzz_0[j] - fl1_fx * fl1_fza * tg_xy_xxyyyzz_1[j] + fl1_fxn * tg_xxy_xyyyzz_1[j];

                    tg_xxxy_xxyyzzz_0[j] = pb_x * tg_xxy_xxyyzzz_0[j] + wp_x[j] * tg_xxy_xxyyzzz_1[j] + fl1_fx * tg_xy_xxyyzzz_0[j] - fl1_fx * fl1_fza * tg_xy_xxyyzzz_1[j] + fl1_fxn * tg_xxy_xyyzzz_1[j];

                    tg_xxxy_xxyzzzz_0[j] = pb_x * tg_xxy_xxyzzzz_0[j] + wp_x[j] * tg_xxy_xxyzzzz_1[j] + fl1_fx * tg_xy_xxyzzzz_0[j] - fl1_fx * fl1_fza * tg_xy_xxyzzzz_1[j] + fl1_fxn * tg_xxy_xyzzzz_1[j];

                    tg_xxxy_xxzzzzz_0[j] = pb_x * tg_xxy_xxzzzzz_0[j] + wp_x[j] * tg_xxy_xxzzzzz_1[j] + fl1_fx * tg_xy_xxzzzzz_0[j] - fl1_fx * fl1_fza * tg_xy_xxzzzzz_1[j] + fl1_fxn * tg_xxy_xzzzzz_1[j];

                    tg_xxxy_xyyyyyy_0[j] = pb_x * tg_xxy_xyyyyyy_0[j] + wp_x[j] * tg_xxy_xyyyyyy_1[j] + fl1_fx * tg_xy_xyyyyyy_0[j] - fl1_fx * fl1_fza * tg_xy_xyyyyyy_1[j] + 0.5 * fl1_fxn * tg_xxy_yyyyyy_1[j];

                    tg_xxxy_xyyyyyz_0[j] = pb_x * tg_xxy_xyyyyyz_0[j] + wp_x[j] * tg_xxy_xyyyyyz_1[j] + fl1_fx * tg_xy_xyyyyyz_0[j] - fl1_fx * fl1_fza * tg_xy_xyyyyyz_1[j] + 0.5 * fl1_fxn * tg_xxy_yyyyyz_1[j];

                    tg_xxxy_xyyyyzz_0[j] = pb_x * tg_xxy_xyyyyzz_0[j] + wp_x[j] * tg_xxy_xyyyyzz_1[j] + fl1_fx * tg_xy_xyyyyzz_0[j] - fl1_fx * fl1_fza * tg_xy_xyyyyzz_1[j] + 0.5 * fl1_fxn * tg_xxy_yyyyzz_1[j];

                    tg_xxxy_xyyyzzz_0[j] = pb_x * tg_xxy_xyyyzzz_0[j] + wp_x[j] * tg_xxy_xyyyzzz_1[j] + fl1_fx * tg_xy_xyyyzzz_0[j] - fl1_fx * fl1_fza * tg_xy_xyyyzzz_1[j] + 0.5 * fl1_fxn * tg_xxy_yyyzzz_1[j];

                    tg_xxxy_xyyzzzz_0[j] = pb_x * tg_xxy_xyyzzzz_0[j] + wp_x[j] * tg_xxy_xyyzzzz_1[j] + fl1_fx * tg_xy_xyyzzzz_0[j] - fl1_fx * fl1_fza * tg_xy_xyyzzzz_1[j] + 0.5 * fl1_fxn * tg_xxy_yyzzzz_1[j];

                    tg_xxxy_xyzzzzz_0[j] = pb_x * tg_xxy_xyzzzzz_0[j] + wp_x[j] * tg_xxy_xyzzzzz_1[j] + fl1_fx * tg_xy_xyzzzzz_0[j] - fl1_fx * fl1_fza * tg_xy_xyzzzzz_1[j] + 0.5 * fl1_fxn * tg_xxy_yzzzzz_1[j];

                    tg_xxxy_xzzzzzz_0[j] = pb_x * tg_xxy_xzzzzzz_0[j] + wp_x[j] * tg_xxy_xzzzzzz_1[j] + fl1_fx * tg_xy_xzzzzzz_0[j] - fl1_fx * fl1_fza * tg_xy_xzzzzzz_1[j] + 0.5 * fl1_fxn * tg_xxy_zzzzzz_1[j];

                    tg_xxxy_yyyyyyy_0[j] = pb_x * tg_xxy_yyyyyyy_0[j] + wp_x[j] * tg_xxy_yyyyyyy_1[j] + fl1_fx * tg_xy_yyyyyyy_0[j] - fl1_fx * fl1_fza * tg_xy_yyyyyyy_1[j];

                    tg_xxxy_yyyyyyz_0[j] = pb_x * tg_xxy_yyyyyyz_0[j] + wp_x[j] * tg_xxy_yyyyyyz_1[j] + fl1_fx * tg_xy_yyyyyyz_0[j] - fl1_fx * fl1_fza * tg_xy_yyyyyyz_1[j];

                    tg_xxxy_yyyyyzz_0[j] = pb_x * tg_xxy_yyyyyzz_0[j] + wp_x[j] * tg_xxy_yyyyyzz_1[j] + fl1_fx * tg_xy_yyyyyzz_0[j] - fl1_fx * fl1_fza * tg_xy_yyyyyzz_1[j];

                    tg_xxxy_yyyyzzz_0[j] = pb_x * tg_xxy_yyyyzzz_0[j] + wp_x[j] * tg_xxy_yyyyzzz_1[j] + fl1_fx * tg_xy_yyyyzzz_0[j] - fl1_fx * fl1_fza * tg_xy_yyyyzzz_1[j];

                    tg_xxxy_yyyzzzz_0[j] = pb_x * tg_xxy_yyyzzzz_0[j] + wp_x[j] * tg_xxy_yyyzzzz_1[j] + fl1_fx * tg_xy_yyyzzzz_0[j] - fl1_fx * fl1_fza * tg_xy_yyyzzzz_1[j];

                    tg_xxxy_yyzzzzz_0[j] = pb_x * tg_xxy_yyzzzzz_0[j] + wp_x[j] * tg_xxy_yyzzzzz_1[j] + fl1_fx * tg_xy_yyzzzzz_0[j] - fl1_fx * fl1_fza * tg_xy_yyzzzzz_1[j];

                    tg_xxxy_yzzzzzz_0[j] = pb_x * tg_xxy_yzzzzzz_0[j] + wp_x[j] * tg_xxy_yzzzzzz_1[j] + fl1_fx * tg_xy_yzzzzzz_0[j] - fl1_fx * fl1_fza * tg_xy_yzzzzzz_1[j];

                    tg_xxxy_zzzzzzz_0[j] = pb_x * tg_xxy_zzzzzzz_0[j] + wp_x[j] * tg_xxy_zzzzzzz_1[j] + fl1_fx * tg_xy_zzzzzzz_0[j] - fl1_fx * fl1_fza * tg_xy_zzzzzzz_1[j];

                    tg_xxxz_xxxxxxx_0[j] = pb_x * tg_xxz_xxxxxxx_0[j] + wp_x[j] * tg_xxz_xxxxxxx_1[j] + fl1_fx * tg_xz_xxxxxxx_0[j] - fl1_fx * fl1_fza * tg_xz_xxxxxxx_1[j] + 3.5 * fl1_fxn * tg_xxz_xxxxxx_1[j];

                    tg_xxxz_xxxxxxy_0[j] = pb_x * tg_xxz_xxxxxxy_0[j] + wp_x[j] * tg_xxz_xxxxxxy_1[j] + fl1_fx * tg_xz_xxxxxxy_0[j] - fl1_fx * fl1_fza * tg_xz_xxxxxxy_1[j] + 3.0 * fl1_fxn * tg_xxz_xxxxxy_1[j];

                    tg_xxxz_xxxxxxz_0[j] = pb_x * tg_xxz_xxxxxxz_0[j] + wp_x[j] * tg_xxz_xxxxxxz_1[j] + fl1_fx * tg_xz_xxxxxxz_0[j] - fl1_fx * fl1_fza * tg_xz_xxxxxxz_1[j] + 3.0 * fl1_fxn * tg_xxz_xxxxxz_1[j];

                    tg_xxxz_xxxxxyy_0[j] = pb_x * tg_xxz_xxxxxyy_0[j] + wp_x[j] * tg_xxz_xxxxxyy_1[j] + fl1_fx * tg_xz_xxxxxyy_0[j] - fl1_fx * fl1_fza * tg_xz_xxxxxyy_1[j] + 2.5 * fl1_fxn * tg_xxz_xxxxyy_1[j];

                    tg_xxxz_xxxxxyz_0[j] = pb_x * tg_xxz_xxxxxyz_0[j] + wp_x[j] * tg_xxz_xxxxxyz_1[j] + fl1_fx * tg_xz_xxxxxyz_0[j] - fl1_fx * fl1_fza * tg_xz_xxxxxyz_1[j] + 2.5 * fl1_fxn * tg_xxz_xxxxyz_1[j];

                    tg_xxxz_xxxxxzz_0[j] = pb_x * tg_xxz_xxxxxzz_0[j] + wp_x[j] * tg_xxz_xxxxxzz_1[j] + fl1_fx * tg_xz_xxxxxzz_0[j] - fl1_fx * fl1_fza * tg_xz_xxxxxzz_1[j] + 2.5 * fl1_fxn * tg_xxz_xxxxzz_1[j];

                    tg_xxxz_xxxxyyy_0[j] = pb_x * tg_xxz_xxxxyyy_0[j] + wp_x[j] * tg_xxz_xxxxyyy_1[j] + fl1_fx * tg_xz_xxxxyyy_0[j] - fl1_fx * fl1_fza * tg_xz_xxxxyyy_1[j] + 2.0 * fl1_fxn * tg_xxz_xxxyyy_1[j];

                    tg_xxxz_xxxxyyz_0[j] = pb_x * tg_xxz_xxxxyyz_0[j] + wp_x[j] * tg_xxz_xxxxyyz_1[j] + fl1_fx * tg_xz_xxxxyyz_0[j] - fl1_fx * fl1_fza * tg_xz_xxxxyyz_1[j] + 2.0 * fl1_fxn * tg_xxz_xxxyyz_1[j];

                    tg_xxxz_xxxxyzz_0[j] = pb_x * tg_xxz_xxxxyzz_0[j] + wp_x[j] * tg_xxz_xxxxyzz_1[j] + fl1_fx * tg_xz_xxxxyzz_0[j] - fl1_fx * fl1_fza * tg_xz_xxxxyzz_1[j] + 2.0 * fl1_fxn * tg_xxz_xxxyzz_1[j];

                    tg_xxxz_xxxxzzz_0[j] = pb_x * tg_xxz_xxxxzzz_0[j] + wp_x[j] * tg_xxz_xxxxzzz_1[j] + fl1_fx * tg_xz_xxxxzzz_0[j] - fl1_fx * fl1_fza * tg_xz_xxxxzzz_1[j] + 2.0 * fl1_fxn * tg_xxz_xxxzzz_1[j];

                    tg_xxxz_xxxyyyy_0[j] = pb_x * tg_xxz_xxxyyyy_0[j] + wp_x[j] * tg_xxz_xxxyyyy_1[j] + fl1_fx * tg_xz_xxxyyyy_0[j] - fl1_fx * fl1_fza * tg_xz_xxxyyyy_1[j] + 1.5 * fl1_fxn * tg_xxz_xxyyyy_1[j];

                    tg_xxxz_xxxyyyz_0[j] = pb_x * tg_xxz_xxxyyyz_0[j] + wp_x[j] * tg_xxz_xxxyyyz_1[j] + fl1_fx * tg_xz_xxxyyyz_0[j] - fl1_fx * fl1_fza * tg_xz_xxxyyyz_1[j] + 1.5 * fl1_fxn * tg_xxz_xxyyyz_1[j];

                    tg_xxxz_xxxyyzz_0[j] = pb_x * tg_xxz_xxxyyzz_0[j] + wp_x[j] * tg_xxz_xxxyyzz_1[j] + fl1_fx * tg_xz_xxxyyzz_0[j] - fl1_fx * fl1_fza * tg_xz_xxxyyzz_1[j] + 1.5 * fl1_fxn * tg_xxz_xxyyzz_1[j];

                    tg_xxxz_xxxyzzz_0[j] = pb_x * tg_xxz_xxxyzzz_0[j] + wp_x[j] * tg_xxz_xxxyzzz_1[j] + fl1_fx * tg_xz_xxxyzzz_0[j] - fl1_fx * fl1_fza * tg_xz_xxxyzzz_1[j] + 1.5 * fl1_fxn * tg_xxz_xxyzzz_1[j];

                    tg_xxxz_xxxzzzz_0[j] = pb_x * tg_xxz_xxxzzzz_0[j] + wp_x[j] * tg_xxz_xxxzzzz_1[j] + fl1_fx * tg_xz_xxxzzzz_0[j] - fl1_fx * fl1_fza * tg_xz_xxxzzzz_1[j] + 1.5 * fl1_fxn * tg_xxz_xxzzzz_1[j];

                    tg_xxxz_xxyyyyy_0[j] = pb_x * tg_xxz_xxyyyyy_0[j] + wp_x[j] * tg_xxz_xxyyyyy_1[j] + fl1_fx * tg_xz_xxyyyyy_0[j] - fl1_fx * fl1_fza * tg_xz_xxyyyyy_1[j] + fl1_fxn * tg_xxz_xyyyyy_1[j];

                    tg_xxxz_xxyyyyz_0[j] = pb_x * tg_xxz_xxyyyyz_0[j] + wp_x[j] * tg_xxz_xxyyyyz_1[j] + fl1_fx * tg_xz_xxyyyyz_0[j] - fl1_fx * fl1_fza * tg_xz_xxyyyyz_1[j] + fl1_fxn * tg_xxz_xyyyyz_1[j];

                    tg_xxxz_xxyyyzz_0[j] = pb_x * tg_xxz_xxyyyzz_0[j] + wp_x[j] * tg_xxz_xxyyyzz_1[j] + fl1_fx * tg_xz_xxyyyzz_0[j] - fl1_fx * fl1_fza * tg_xz_xxyyyzz_1[j] + fl1_fxn * tg_xxz_xyyyzz_1[j];

                    tg_xxxz_xxyyzzz_0[j] = pb_x * tg_xxz_xxyyzzz_0[j] + wp_x[j] * tg_xxz_xxyyzzz_1[j] + fl1_fx * tg_xz_xxyyzzz_0[j] - fl1_fx * fl1_fza * tg_xz_xxyyzzz_1[j] + fl1_fxn * tg_xxz_xyyzzz_1[j];

                    tg_xxxz_xxyzzzz_0[j] = pb_x * tg_xxz_xxyzzzz_0[j] + wp_x[j] * tg_xxz_xxyzzzz_1[j] + fl1_fx * tg_xz_xxyzzzz_0[j] - fl1_fx * fl1_fza * tg_xz_xxyzzzz_1[j] + fl1_fxn * tg_xxz_xyzzzz_1[j];

                    tg_xxxz_xxzzzzz_0[j] = pb_x * tg_xxz_xxzzzzz_0[j] + wp_x[j] * tg_xxz_xxzzzzz_1[j] + fl1_fx * tg_xz_xxzzzzz_0[j] - fl1_fx * fl1_fza * tg_xz_xxzzzzz_1[j] + fl1_fxn * tg_xxz_xzzzzz_1[j];

                    tg_xxxz_xyyyyyy_0[j] = pb_x * tg_xxz_xyyyyyy_0[j] + wp_x[j] * tg_xxz_xyyyyyy_1[j] + fl1_fx * tg_xz_xyyyyyy_0[j] - fl1_fx * fl1_fza * tg_xz_xyyyyyy_1[j] + 0.5 * fl1_fxn * tg_xxz_yyyyyy_1[j];

                    tg_xxxz_xyyyyyz_0[j] = pb_x * tg_xxz_xyyyyyz_0[j] + wp_x[j] * tg_xxz_xyyyyyz_1[j] + fl1_fx * tg_xz_xyyyyyz_0[j] - fl1_fx * fl1_fza * tg_xz_xyyyyyz_1[j] + 0.5 * fl1_fxn * tg_xxz_yyyyyz_1[j];

                    tg_xxxz_xyyyyzz_0[j] = pb_x * tg_xxz_xyyyyzz_0[j] + wp_x[j] * tg_xxz_xyyyyzz_1[j] + fl1_fx * tg_xz_xyyyyzz_0[j] - fl1_fx * fl1_fza * tg_xz_xyyyyzz_1[j] + 0.5 * fl1_fxn * tg_xxz_yyyyzz_1[j];

                    tg_xxxz_xyyyzzz_0[j] = pb_x * tg_xxz_xyyyzzz_0[j] + wp_x[j] * tg_xxz_xyyyzzz_1[j] + fl1_fx * tg_xz_xyyyzzz_0[j] - fl1_fx * fl1_fza * tg_xz_xyyyzzz_1[j] + 0.5 * fl1_fxn * tg_xxz_yyyzzz_1[j];

                    tg_xxxz_xyyzzzz_0[j] = pb_x * tg_xxz_xyyzzzz_0[j] + wp_x[j] * tg_xxz_xyyzzzz_1[j] + fl1_fx * tg_xz_xyyzzzz_0[j] - fl1_fx * fl1_fza * tg_xz_xyyzzzz_1[j] + 0.5 * fl1_fxn * tg_xxz_yyzzzz_1[j];

                    tg_xxxz_xyzzzzz_0[j] = pb_x * tg_xxz_xyzzzzz_0[j] + wp_x[j] * tg_xxz_xyzzzzz_1[j] + fl1_fx * tg_xz_xyzzzzz_0[j] - fl1_fx * fl1_fza * tg_xz_xyzzzzz_1[j] + 0.5 * fl1_fxn * tg_xxz_yzzzzz_1[j];
                }
    ...
    void
    compElectronRepulsionForSGSK_99_148(      CMemBlock2D<double>& primBuffer,
                                        const CRecursionMap&       recursionMap,
                                        const CMemBlock2D<double>& osFactors,
                                        const CMemBlock2D<double>& wpDistances,
                                        const CGtoPairsBlock&      braGtoPairsBlock,
                                        ...
                                        const int32_t              iContrPair)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, fza, tg_xxxz_xzzzzzz_0, tg_xxxz_yyyyyyy_0, tg_xxxz_yyyyyyz_0, \
                                         tg_xxxz_yyyyyzz_0, tg_xxxz_yyyyzzz_0, tg_xxxz_yyyzzzz_0, tg_xxxz_yyzzzzz_0, \
                                         tg_xxxz_yzzzzzz_0, tg_xxxz_zzzzzzz_0, tg_xxyy_xxxxxxx_0, tg_xxyy_xxxxxxy_0, \
                                         tg_xxyy_xxxxxxz_0, tg_xxyy_xxxxxyy_0, tg_xxyy_xxxxxyz_0, tg_xxyy_xxxxxzz_0, \
                                         tg_xxyy_xxxxyyy_0, tg_xxyy_xxxxyyz_0, tg_xxyy_xxxxyzz_0, tg_xxyy_xxxxzzz_0, \
                                         tg_xxyy_xxxyyyy_0, tg_xxyy_xxxyyyz_0, tg_xxyy_xxxyyzz_0, tg_xxyy_xxxyzzz_0, \
                                         tg_xxyy_xxxzzzz_0, tg_xxyy_xxyyyyy_0, tg_xxyy_xxyyyyz_0, tg_xxyy_xxyyyzz_0, \
                                         tg_xxyy_xxyyzzz_0, tg_xxyy_xxyzzzz_0, tg_xxyy_xxzzzzz_0, tg_xxyy_xyyyyyy_0, \
                                         tg_xxyy_xyyyyyz_0, tg_xxyy_xyyyyzz_0, tg_xxyy_xyyyzzz_0, tg_xxyy_xyyzzzz_0, \
                                         tg_xxyy_xyzzzzz_0, tg_xxyy_xzzzzzz_0, tg_xxyy_yyyyyyy_0, tg_xxyy_yyyyyyz_0, \
                                         tg_xxyy_yyyyyzz_0, tg_xxyy_yyyyzzz_0, tg_xxyy_yyyzzzz_0, tg_xxyy_yyzzzzz_0, \
                                         tg_xxyy_yzzzzzz_0, tg_xxyy_zzzzzzz_0, tg_xxyz_xxxxxxx_0, tg_xxyz_xxxxxxy_0, \
                                         tg_xxyz_xxxxxxz_0, tg_xxyz_xxxxxyy_0, tg_xxz_xzzzzzz_0, tg_xxz_xzzzzzz_1, \
                                         tg_xxz_yyyyyyy_0, tg_xxz_yyyyyyy_1, tg_xxz_yyyyyyz_0, tg_xxz_yyyyyyz_1, \
                                         tg_xxz_yyyyyzz_0, tg_xxz_yyyyyzz_1, tg_xxz_yyyyzzz_0, tg_xxz_yyyyzzz_1, \
                                         tg_xxz_yyyzzzz_0, tg_xxz_yyyzzzz_1, tg_xxz_yyzzzzz_0, tg_xxz_yyzzzzz_1, \
                                         ...
                                         tg_xyz_xxxxxy_1, tg_xyz_xxxxxyy_0, tg_xyz_xxxxxyy_1, tg_xyz_xxxxxz_1, \
                                         tg_xyz_xxxxyy_1, tg_xz_xzzzzzz_0, tg_xz_xzzzzzz_1, tg_xz_yyyyyyy_0, tg_xz_yyyyyyy_1, \
                                         tg_xz_yyyyyyz_0, tg_xz_yyyyyyz_1, tg_xz_yyyyyzz_0, tg_xz_yyyyyzz_1, tg_xz_yyyyzzz_0, \
                                         tg_xz_yyyyzzz_1, tg_xz_yyyzzzz_0, tg_xz_yyyzzzz_1, tg_xz_yyzzzzz_0, tg_xz_yyzzzzz_1, \
                                         tg_xz_yzzzzzz_0, tg_xz_yzzzzzz_1, tg_xz_zzzzzzz_0, tg_xz_zzzzzzz_1, tg_yy_xxxxxxx_0, \
                                         tg_yy_xxxxxxx_1, tg_yy_xxxxxxy_0, tg_yy_xxxxxxy_1, tg_yy_xxxxxxz_0, tg_yy_xxxxxxz_1, \
                                         tg_yy_xxxxxyy_0, tg_yy_xxxxxyy_1, tg_yy_xxxxxyz_0, tg_yy_xxxxxyz_1, tg_yy_xxxxxzz_0, \
                                         tg_yy_xxxxxzz_1, tg_yy_xxxxyyy_0, tg_yy_xxxxyyy_1, tg_yy_xxxxyyz_0, tg_yy_xxxxyyz_1, \
                                         tg_yy_xxxxyzz_0, tg_yy_xxxxyzz_1, tg_yy_xxxxzzz_0, tg_yy_xxxxzzz_1, tg_yy_xxxyyyy_0, \
                                         tg_yy_xxxyyyy_1, tg_yy_xxxyyyz_0, tg_yy_xxxyyyz_1, tg_yy_xxxyyzz_0, tg_yy_xxxyyzz_1, \
                                         tg_yy_xxxyzzz_0, tg_yy_xxxyzzz_1, tg_yy_xxxzzzz_0, tg_yy_xxxzzzz_1, tg_yy_xxyyyyy_0, \
                                         tg_yy_xxyyyyy_1, tg_yy_xxyyyyz_0, tg_yy_xxyyyyz_1, tg_yy_xxyyyzz_0, tg_yy_xxyyyzz_1, \
                                         tg_yy_xxyyzzz_0, tg_yy_xxyyzzz_1, tg_yy_xxyzzzz_0, tg_yy_xxyzzzz_1, tg_yy_xxzzzzz_0, \
                                         tg_yy_xxzzzzz_1, tg_yy_xyyyyyy_0, tg_yy_xyyyyyy_1, tg_yy_xyyyyyz_0, tg_yy_xyyyyyz_1, \
                                         tg_yy_xyyyyzz_0, tg_yy_xyyyyzz_1, tg_yy_xyyyzzz_0, tg_yy_xyyyzzz_1, tg_yy_xyyzzzz_0, \
                                         tg_yy_xyyzzzz_1, tg_yy_xyzzzzz_0, tg_yy_xyzzzzz_1, tg_yy_xzzzzzz_0, tg_yy_xzzzzzz_1, \
                                         tg_yy_yyyyyyy_0, tg_yy_yyyyyyy_1, tg_yy_yyyyyyz_0, tg_yy_yyyyyyz_1, tg_yy_yyyyyzz_0, \
                                         tg_yy_yyyyyzz_1, tg_yy_yyyyzzz_0, tg_yy_yyyyzzz_1, tg_yy_yyyzzzz_0, tg_yy_yyyzzzz_1, \
                                         tg_yy_yyzzzzz_0, tg_yy_yyzzzzz_1, tg_yy_yzzzzzz_0, tg_yy_yzzzzzz_1, tg_yy_zzzzzzz_0, \
                                         tg_yy_zzzzzzz_1, tg_yz_xxxxxxx_0, tg_yz_xxxxxxx_1, tg_yz_xxxxxxy_0, tg_yz_xxxxxxy_1, \
                                         tg_yz_xxxxxxz_0, tg_yz_xxxxxxz_1, tg_yz_xxxxxyy_0, tg_yz_xxxxxyy_1, wp_x: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fx = fx;
                    ...
                    tg_xxxz_xzzzzzz_0[j] = pb_x * tg_xxz_xzzzzzz_0[j] + wp_x[j] * tg_xxz_xzzzzzz_1[j] + fl1_fx * tg_xz_xzzzzzz_0[j] - fl1_fx * fl1_fza * tg_xz_xzzzzzz_1[j] + 0.5 * fl1_fxn * tg_xxz_zzzzzz_1[j];

                    tg_xxxz_yyyyyyy_0[j] = pb_x * tg_xxz_yyyyyyy_0[j] + wp_x[j] * tg_xxz_yyyyyyy_1[j] + fl1_fx * tg_xz_yyyyyyy_0[j] - fl1_fx * fl1_fza * tg_xz_yyyyyyy_1[j];

                    tg_xxxz_yyyyyyz_0[j] = pb_x * tg_xxz_yyyyyyz_0[j] + wp_x[j] * tg_xxz_yyyyyyz_1[j] + fl1_fx * tg_xz_yyyyyyz_0[j] - fl1_fx * fl1_fza * tg_xz_yyyyyyz_1[j];

                    tg_xxxz_yyyyyzz_0[j] = pb_x * tg_xxz_yyyyyzz_0[j] + wp_x[j] * tg_xxz_yyyyyzz_1[j] + fl1_fx * tg_xz_yyyyyzz_0[j] - fl1_fx * fl1_fza * tg_xz_yyyyyzz_1[j];

                    tg_xxxz_yyyyzzz_0[j] = pb_x * tg_xxz_yyyyzzz_0[j] + wp_x[j] * tg_xxz_yyyyzzz_1[j] + fl1_fx * tg_xz_yyyyzzz_0[j] - fl1_fx * fl1_fza * tg_xz_yyyyzzz_1[j];

                    tg_xxxz_yyyzzzz_0[j] = pb_x * tg_xxz_yyyzzzz_0[j] + wp_x[j] * tg_xxz_yyyzzzz_1[j] + fl1_fx * tg_xz_yyyzzzz_0[j] - fl1_fx * fl1_fza * tg_xz_yyyzzzz_1[j];

                    tg_xxxz_yyzzzzz_0[j] = pb_x * tg_xxz_yyzzzzz_0[j] + wp_x[j] * tg_xxz_yyzzzzz_1[j] + fl1_fx * tg_xz_yyzzzzz_0[j] - fl1_fx * fl1_fza * tg_xz_yyzzzzz_1[j];

                    tg_xxxz_yzzzzzz_0[j] = pb_x * tg_xxz_yzzzzzz_0[j] + wp_x[j] * tg_xxz_yzzzzzz_1[j] + fl1_fx * tg_xz_yzzzzzz_0[j] - fl1_fx * fl1_fza * tg_xz_yzzzzzz_1[j];

                    tg_xxxz_zzzzzzz_0[j] = pb_x * tg_xxz_zzzzzzz_0[j] + wp_x[j] * tg_xxz_zzzzzzz_1[j] + fl1_fx * tg_xz_zzzzzzz_0[j] - fl1_fx * fl1_fza * tg_xz_zzzzzzz_1[j];

                    tg_xxyy_xxxxxxx_0[j] = pb_x * tg_xyy_xxxxxxx_0[j] + wp_x[j] * tg_xyy_xxxxxxx_1[j] + 0.5 * fl1_fx * tg_yy_xxxxxxx_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xxxxxxx_1[j] + 3.5 * fl1_fxn * tg_xyy_xxxxxx_1[j];

                    tg_xxyy_xxxxxxy_0[j] = pb_x * tg_xyy_xxxxxxy_0[j] + wp_x[j] * tg_xyy_xxxxxxy_1[j] + 0.5 * fl1_fx * tg_yy_xxxxxxy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xxxxxxy_1[j] + 3.0 * fl1_fxn * tg_xyy_xxxxxy_1[j];

                    tg_xxyy_xxxxxxz_0[j] = pb_x * tg_xyy_xxxxxxz_0[j] + wp_x[j] * tg_xyy_xxxxxxz_1[j] + 0.5 * fl1_fx * tg_yy_xxxxxxz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xxxxxxz_1[j] + 3.0 * fl1_fxn * tg_xyy_xxxxxz_1[j];

                    tg_xxyy_xxxxxyy_0[j] = pb_x * tg_xyy_xxxxxyy_0[j] + wp_x[j] * tg_xyy_xxxxxyy_1[j] + 0.5 * fl1_fx * tg_yy_xxxxxyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xxxxxyy_1[j] + 2.5 * fl1_fxn * tg_xyy_xxxxyy_1[j];

                    tg_xxyy_xxxxxyz_0[j] = pb_x * tg_xyy_xxxxxyz_0[j] + wp_x[j] * tg_xyy_xxxxxyz_1[j] + 0.5 * fl1_fx * tg_yy_xxxxxyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xxxxxyz_1[j] + 2.5 * fl1_fxn * tg_xyy_xxxxyz_1[j];

                    tg_xxyy_xxxxxzz_0[j] = pb_x * tg_xyy_xxxxxzz_0[j] + wp_x[j] * tg_xyy_xxxxxzz_1[j] + 0.5 * fl1_fx * tg_yy_xxxxxzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xxxxxzz_1[j] + 2.5 * fl1_fxn * tg_xyy_xxxxzz_1[j];

                    tg_xxyy_xxxxyyy_0[j] = pb_x * tg_xyy_xxxxyyy_0[j] + wp_x[j] * tg_xyy_xxxxyyy_1[j] + 0.5 * fl1_fx * tg_yy_xxxxyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xxxxyyy_1[j] + 2.0 * fl1_fxn * tg_xyy_xxxyyy_1[j];

                    tg_xxyy_xxxxyyz_0[j] = pb_x * tg_xyy_xxxxyyz_0[j] + wp_x[j] * tg_xyy_xxxxyyz_1[j] + 0.5 * fl1_fx * tg_yy_xxxxyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xxxxyyz_1[j] + 2.0 * fl1_fxn * tg_xyy_xxxyyz_1[j];

                    tg_xxyy_xxxxyzz_0[j] = pb_x * tg_xyy_xxxxyzz_0[j] + wp_x[j] * tg_xyy_xxxxyzz_1[j] + 0.5 * fl1_fx * tg_yy_xxxxyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xxxxyzz_1[j] + 2.0 * fl1_fxn * tg_xyy_xxxyzz_1[j];

                    tg_xxyy_xxxxzzz_0[j] = pb_x * tg_xyy_xxxxzzz_0[j] + wp_x[j] * tg_xyy_xxxxzzz_1[j] + 0.5 * fl1_fx * tg_yy_xxxxzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xxxxzzz_1[j] + 2.0 * fl1_fxn * tg_xyy_xxxzzz_1[j];

                    tg_xxyy_xxxyyyy_0[j] = pb_x * tg_xyy_xxxyyyy_0[j] + wp_x[j] * tg_xyy_xxxyyyy_1[j] + 0.5 * fl1_fx * tg_yy_xxxyyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xxxyyyy_1[j] + 1.5 * fl1_fxn * tg_xyy_xxyyyy_1[j];

                    tg_xxyy_xxxyyyz_0[j] = pb_x * tg_xyy_xxxyyyz_0[j] + wp_x[j] * tg_xyy_xxxyyyz_1[j] + 0.5 * fl1_fx * tg_yy_xxxyyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xxxyyyz_1[j] + 1.5 * fl1_fxn * tg_xyy_xxyyyz_1[j];

                    tg_xxyy_xxxyyzz_0[j] = pb_x * tg_xyy_xxxyyzz_0[j] + wp_x[j] * tg_xyy_xxxyyzz_1[j] + 0.5 * fl1_fx * tg_yy_xxxyyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xxxyyzz_1[j] + 1.5 * fl1_fxn * tg_xyy_xxyyzz_1[j];

                    tg_xxyy_xxxyzzz_0[j] = pb_x * tg_xyy_xxxyzzz_0[j] + wp_x[j] * tg_xyy_xxxyzzz_1[j] + 0.5 * fl1_fx * tg_yy_xxxyzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xxxyzzz_1[j] + 1.5 * fl1_fxn * tg_xyy_xxyzzz_1[j];

                    tg_xxyy_xxxzzzz_0[j] = pb_x * tg_xyy_xxxzzzz_0[j] + wp_x[j] * tg_xyy_xxxzzzz_1[j] + 0.5 * fl1_fx * tg_yy_xxxzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xxxzzzz_1[j] + 1.5 * fl1_fxn * tg_xyy_xxzzzz_1[j];

                    tg_xxyy_xxyyyyy_0[j] = pb_x * tg_xyy_xxyyyyy_0[j] + wp_x[j] * tg_xyy_xxyyyyy_1[j] + 0.5 * fl1_fx * tg_yy_xxyyyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xxyyyyy_1[j] + fl1_fxn * tg_xyy_xyyyyy_1[j];

                    tg_xxyy_xxyyyyz_0[j] = pb_x * tg_xyy_xxyyyyz_0[j] + wp_x[j] * tg_xyy_xxyyyyz_1[j] + 0.5 * fl1_fx * tg_yy_xxyyyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xxyyyyz_1[j] + fl1_fxn * tg_xyy_xyyyyz_1[j];

                    tg_xxyy_xxyyyzz_0[j] = pb_x * tg_xyy_xxyyyzz_0[j] + wp_x[j] * tg_xyy_xxyyyzz_1[j] + 0.5 * fl1_fx * tg_yy_xxyyyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xxyyyzz_1[j] + fl1_fxn * tg_xyy_xyyyzz_1[j];

                    tg_xxyy_xxyyzzz_0[j] = pb_x * tg_xyy_xxyyzzz_0[j] + wp_x[j] * tg_xyy_xxyyzzz_1[j] + 0.5 * fl1_fx * tg_yy_xxyyzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xxyyzzz_1[j] + fl1_fxn * tg_xyy_xyyzzz_1[j];

                    tg_xxyy_xxyzzzz_0[j] = pb_x * tg_xyy_xxyzzzz_0[j] + wp_x[j] * tg_xyy_xxyzzzz_1[j] + 0.5 * fl1_fx * tg_yy_xxyzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xxyzzzz_1[j] + fl1_fxn * tg_xyy_xyzzzz_1[j];

                    tg_xxyy_xxzzzzz_0[j] = pb_x * tg_xyy_xxzzzzz_0[j] + wp_x[j] * tg_xyy_xxzzzzz_1[j] + 0.5 * fl1_fx * tg_yy_xxzzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xxzzzzz_1[j] + fl1_fxn * tg_xyy_xzzzzz_1[j];

                    tg_xxyy_xyyyyyy_0[j] = pb_x * tg_xyy_xyyyyyy_0[j] + wp_x[j] * tg_xyy_xyyyyyy_1[j] + 0.5 * fl1_fx * tg_yy_xyyyyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xyyyyyy_1[j] + 0.5 * fl1_fxn * tg_xyy_yyyyyy_1[j];

                    tg_xxyy_xyyyyyz_0[j] = pb_x * tg_xyy_xyyyyyz_0[j] + wp_x[j] * tg_xyy_xyyyyyz_1[j] + 0.5 * fl1_fx * tg_yy_xyyyyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xyyyyyz_1[j] + 0.5 * fl1_fxn * tg_xyy_yyyyyz_1[j];

                    tg_xxyy_xyyyyzz_0[j] = pb_x * tg_xyy_xyyyyzz_0[j] + wp_x[j] * tg_xyy_xyyyyzz_1[j] + 0.5 * fl1_fx * tg_yy_xyyyyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xyyyyzz_1[j] + 0.5 * fl1_fxn * tg_xyy_yyyyzz_1[j];

                    tg_xxyy_xyyyzzz_0[j] = pb_x * tg_xyy_xyyyzzz_0[j] + wp_x[j] * tg_xyy_xyyyzzz_1[j] + 0.5 * fl1_fx * tg_yy_xyyyzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xyyyzzz_1[j] + 0.5 * fl1_fxn * tg_xyy_yyyzzz_1[j];

                    tg_xxyy_xyyzzzz_0[j] = pb_x * tg_xyy_xyyzzzz_0[j] + wp_x[j] * tg_xyy_xyyzzzz_1[j] + 0.5 * fl1_fx * tg_yy_xyyzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xyyzzzz_1[j] + 0.5 * fl1_fxn * tg_xyy_yyzzzz_1[j];

                    tg_xxyy_xyzzzzz_0[j] = pb_x * tg_xyy_xyzzzzz_0[j] + wp_x[j] * tg_xyy_xyzzzzz_1[j] + 0.5 * fl1_fx * tg_yy_xyzzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xyzzzzz_1[j] + 0.5 * fl1_fxn * tg_xyy_yzzzzz_1[j];

                    tg_xxyy_xzzzzzz_0[j] = pb_x * tg_xyy_xzzzzzz_0[j] + wp_x[j] * tg_xyy_xzzzzzz_1[j] + 0.5 * fl1_fx * tg_yy_xzzzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_xzzzzzz_1[j] + 0.5 * fl1_fxn * tg_xyy_zzzzzz_1[j];

                    tg_xxyy_yyyyyyy_0[j] = pb_x * tg_xyy_yyyyyyy_0[j] + wp_x[j] * tg_xyy_yyyyyyy_1[j] + 0.5 * fl1_fx * tg_yy_yyyyyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_yyyyyyy_1[j];

                    tg_xxyy_yyyyyyz_0[j] = pb_x * tg_xyy_yyyyyyz_0[j] + wp_x[j] * tg_xyy_yyyyyyz_1[j] + 0.5 * fl1_fx * tg_yy_yyyyyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_yyyyyyz_1[j];

                    tg_xxyy_yyyyyzz_0[j] = pb_x * tg_xyy_yyyyyzz_0[j] + wp_x[j] * tg_xyy_yyyyyzz_1[j] + 0.5 * fl1_fx * tg_yy_yyyyyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_yyyyyzz_1[j];

                    tg_xxyy_yyyyzzz_0[j] = pb_x * tg_xyy_yyyyzzz_0[j] + wp_x[j] * tg_xyy_yyyyzzz_1[j] + 0.5 * fl1_fx * tg_yy_yyyyzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_yyyyzzz_1[j];

                    tg_xxyy_yyyzzzz_0[j] = pb_x * tg_xyy_yyyzzzz_0[j] + wp_x[j] * tg_xyy_yyyzzzz_1[j] + 0.5 * fl1_fx * tg_yy_yyyzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_yyyzzzz_1[j];

                    tg_xxyy_yyzzzzz_0[j] = pb_x * tg_xyy_yyzzzzz_0[j] + wp_x[j] * tg_xyy_yyzzzzz_1[j] + 0.5 * fl1_fx * tg_yy_yyzzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_yyzzzzz_1[j];

                    tg_xxyy_yzzzzzz_0[j] = pb_x * tg_xyy_yzzzzzz_0[j] + wp_x[j] * tg_xyy_yzzzzzz_1[j] + 0.5 * fl1_fx * tg_yy_yzzzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_yzzzzzz_1[j];

                    tg_xxyy_zzzzzzz_0[j] = pb_x * tg_xyy_zzzzzzz_0[j] + wp_x[j] * tg_xyy_zzzzzzz_1[j] + 0.5 * fl1_fx * tg_yy_zzzzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yy_zzzzzzz_1[j];

                    tg_xxyz_xxxxxxx_0[j] = pb_x * tg_xyz_xxxxxxx_0[j] + wp_x[j] * tg_xyz_xxxxxxx_1[j] + 0.5 * fl1_fx * tg_yz_xxxxxxx_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xxxxxxx_1[j] + 3.5 * fl1_fxn * tg_xyz_xxxxxx_1[j];

                    tg_xxyz_xxxxxxy_0[j] = pb_x * tg_xyz_xxxxxxy_0[j] + wp_x[j] * tg_xyz_xxxxxxy_1[j] + 0.5 * fl1_fx * tg_yz_xxxxxxy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xxxxxxy_1[j] + 3.0 * fl1_fxn * tg_xyz_xxxxxy_1[j];

                    tg_xxyz_xxxxxxz_0[j] = pb_x * tg_xyz_xxxxxxz_0[j] + wp_x[j] * tg_xyz_xxxxxxz_1[j] + 0.5 * fl1_fx * tg_yz_xxxxxxz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xxxxxxz_1[j] + 3.0 * fl1_fxn * tg_xyz_xxxxxz_1[j];

                    tg_xxyz_xxxxxyy_0[j] = pb_x * tg_xyz_xxxxxyy_0[j] + wp_x[j] * tg_xyz_xxxxxyy_1[j] + 0.5 * fl1_fx * tg_yz_xxxxxyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xxxxxyy_1[j] + 2.5 * fl1_fxn * tg_xyz_xxxxyy_1[j];
                }
    ...
    void
    compElectronRepulsionForSGSK_148_197(      CMemBlock2D<double>& primBuffer,
                                         const CRecursionMap&       recursionMap,
                                         const CMemBlock2D<double>& osFactors,
                                         const CMemBlock2D<double>& wpDistances,
                                         const CGtoPairsBlock&      braGtoPairsBlock,
                                         ...
                                         const int32_t              iContrPair)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, fza, tg_xxyz_xxxxxyz_0, tg_xxyz_xxxxxzz_0, tg_xxyz_xxxxyyy_0, \
                                         tg_xxyz_xxxxyyz_0, tg_xxyz_xxxxyzz_0, tg_xxyz_xxxxzzz_0, tg_xxyz_xxxyyyy_0, \
                                         tg_xxyz_xxxyyyz_0, tg_xxyz_xxxyyzz_0, tg_xxyz_xxxyzzz_0, tg_xxyz_xxxzzzz_0, \
                                         tg_xxyz_xxyyyyy_0, tg_xxyz_xxyyyyz_0, tg_xxyz_xxyyyzz_0, tg_xxyz_xxyyzzz_0, \
                                         tg_xxyz_xxyzzzz_0, tg_xxyz_xxzzzzz_0, tg_xxyz_xyyyyyy_0, tg_xxyz_xyyyyyz_0, \
                                         tg_xxyz_xyyyyzz_0, tg_xxyz_xyyyzzz_0, tg_xxyz_xyyzzzz_0, tg_xxyz_xyzzzzz_0, \
                                         tg_xxyz_xzzzzzz_0, tg_xxyz_yyyyyyy_0, tg_xxyz_yyyyyyz_0, tg_xxyz_yyyyyzz_0, \
                                         tg_xxyz_yyyyzzz_0, tg_xxyz_yyyzzzz_0, tg_xxyz_yyzzzzz_0, tg_xxyz_yzzzzzz_0, \
                                         tg_xxyz_zzzzzzz_0, tg_xxzz_xxxxxxx_0, tg_xxzz_xxxxxxy_0, tg_xxzz_xxxxxxz_0, \
                                         ...
                                         tg_xxzz_xxyyyyy_0, tg_xxzz_xxyyyyz_0, tg_xyz_xxxxxyz_0, tg_xyz_xxxxxyz_1, \
                                         tg_xyz_xxxxxzz_0, tg_xyz_xxxxxzz_1, tg_xyz_xxxxyyy_0, tg_xyz_xxxxyyy_1, \
                                         tg_xyz_xxxxyyz_0, tg_xyz_xxxxyyz_1, tg_xyz_xxxxyz_1, tg_xyz_xxxxyzz_0, \
                                         tg_xyz_xxxxyzz_1, tg_xyz_xxxxzz_1, tg_xyz_xxxxzzz_0, tg_xyz_xxxxzzz_1, \
                                         tg_xyz_xxxyyy_1, tg_xyz_xxxyyyy_0, tg_xyz_xxxyyyy_1, tg_xyz_xxxyyyz_0, \
                                         tg_xyz_xxxyyyz_1, tg_xyz_xxxyyz_1, tg_xyz_xxxyyzz_0, tg_xyz_xxxyyzz_1, \
                                         tg_xyz_xxxyzz_1, tg_xyz_xxxyzzz_0, tg_xyz_xxxyzzz_1, tg_xyz_xxxzzz_1, \
                                         tg_xyz_xxxzzzz_0, tg_xyz_xxxzzzz_1, tg_xyz_xxyyyy_1, tg_xyz_xxyyyyy_0, \
                                         tg_xyz_xxyyyyy_1, tg_xyz_xxyyyyz_0, tg_xyz_xxyyyyz_1, tg_xyz_xxyyyz_1, \
                                         tg_xyz_xxyyyzz_0, tg_xyz_xxyyyzz_1, tg_xyz_xxyyzz_1, tg_xyz_xxyyzzz_0, \
                                         tg_xyz_xxyyzzz_1, tg_xyz_xxyzzz_1, tg_xyz_xxyzzzz_0, tg_xyz_xxyzzzz_1, \
                                         tg_xyz_xxzzzz_1, tg_xyz_xxzzzzz_0, tg_xyz_xxzzzzz_1, tg_xyz_xyyyyy_1, \
                                         tg_xyz_xyyyyyy_0, tg_xyz_xyyyyyy_1, tg_xyz_xyyyyyz_0, tg_xyz_xyyyyyz_1, \
                                         tg_xyz_xyyyyz_1, tg_xyz_xyyyyzz_0, tg_xyz_xyyyyzz_1, tg_xyz_xyyyzz_1, \
                                         tg_xyz_xyyyzzz_0, tg_xyz_xyyyzzz_1, tg_xyz_xyyzzz_1, tg_xyz_xyyzzzz_0, \
                                         tg_xyz_xyyzzzz_1, tg_xyz_xyzzzz_1, tg_xyz_xyzzzzz_0, tg_xyz_xyzzzzz_1, \
                                         tg_xyz_xzzzzz_1, tg_xyz_xzzzzzz_0, tg_xyz_xzzzzzz_1, tg_xyz_yyyyyy_1, \
                                         tg_xyz_yyyyyyy_0, tg_xyz_yyyyyyy_1, tg_xyz_yyyyyyz_0, tg_xyz_yyyyyyz_1, \
                                         tg_xyz_yyyyyz_1, tg_xyz_yyyyyzz_0, tg_xyz_yyyyyzz_1, tg_xyz_yyyyzz_1, \
                                         tg_xyz_yyyyzzz_0, tg_xyz_yyyyzzz_1, tg_xyz_yyyzzz_1, tg_xyz_yyyzzzz_0, \
                                         tg_xyz_yyyzzzz_1, tg_xyz_yyzzzz_1, tg_xyz_yyzzzzz_0, tg_xyz_yyzzzzz_1, \
                                         tg_xyz_yzzzzz_1, tg_xyz_yzzzzzz_0, tg_xyz_yzzzzzz_1, tg_xyz_zzzzzz_1, \
                                         tg_xyz_zzzzzzz_0, tg_xyz_zzzzzzz_1, tg_xzz_xxxxxx_1, tg_xzz_xxxxxxx_0, \
                                         tg_xzz_xxxxxxx_1, tg_xzz_xxxxxxy_0, tg_xzz_xxxxxxy_1, tg_xzz_xxxxxxz_0, \
                                         tg_xzz_xxxxxxz_1, tg_xzz_xxxxxy_1, tg_xzz_xxxxxyy_0, tg_xzz_xxxxxyy_1, \
                                         tg_xzz_xxxxxyz_0, tg_xzz_xxxxxyz_1, tg_xzz_xxxxxz_1, tg_xzz_xxxxxzz_0, \
                                         tg_xzz_xxxxxzz_1, tg_xzz_xxxxyy_1, tg_xzz_xxxxyyy_0, tg_xzz_xxxxyyy_1, \
                                         tg_xzz_xxxxyyz_0, tg_xzz_xxxxyyz_1, tg_xzz_xxxxyz_1, tg_xzz_xxxxyzz_0, \
                                         tg_xzz_xxxxyzz_1, tg_xzz_xxxxzz_1, tg_xzz_xxxxzzz_0, tg_xzz_xxxxzzz_1, \
                                         tg_xzz_xxxyyy_1, tg_xzz_xxxyyyy_0, tg_xzz_xxxyyyy_1, tg_xzz_xxxyyyz_0, \
                                         tg_xzz_xxxyyyz_1, tg_xzz_xxxyyz_1, tg_xzz_xxxyyzz_0, tg_xzz_xxxyyzz_1, \
                                         tg_xzz_xxxyzz_1, tg_xzz_xxxyzzz_0, tg_xzz_xxxyzzz_1, tg_xzz_xxxzzz_1, \
                                         tg_xzz_xxxzzzz_0, tg_xzz_xxxzzzz_1, tg_xzz_xxyyyy_1, tg_xzz_xxyyyyy_0, \
                                         tg_xzz_xxyyyyy_1, tg_xzz_xxyyyyz_0, tg_xzz_xxyyyyz_1, tg_xzz_xxyyyz_1, \
                                         tg_xzz_xxyyzz_1, tg_xzz_xxyzzz_1, tg_xzz_xxzzzz_1, tg_xzz_xyyyyy_1, tg_xzz_xyyyyz_1, \
                                         tg_yz_xxxxxyz_0, tg_yz_xxxxxyz_1, tg_yz_xxxxxzz_0, tg_yz_xxxxxzz_1, tg_yz_xxxxyyy_0, \
                                         tg_yz_xxxxyyy_1, tg_yz_xxxxyyz_0, tg_yz_xxxxyyz_1, tg_yz_xxxxyzz_0, tg_yz_xxxxyzz_1, \
                                         tg_yz_xxxxzzz_0, tg_yz_xxxxzzz_1, tg_yz_xxxyyyy_0, tg_yz_xxxyyyy_1, tg_yz_xxxyyyz_0, \
                                         tg_yz_xxxyyyz_1, tg_yz_xxxyyzz_0, tg_yz_xxxyyzz_1, tg_yz_xxxyzzz_0, tg_yz_xxxyzzz_1, \
                                         tg_yz_xxxzzzz_0, tg_yz_xxxzzzz_1, tg_yz_xxyyyyy_0, tg_yz_xxyyyyy_1, tg_yz_xxyyyyz_0, \
                                         tg_yz_xxyyyyz_1, tg_yz_xxyyyzz_0, tg_yz_xxyyyzz_1, tg_yz_xxyyzzz_0, tg_yz_xxyyzzz_1, \
                                         tg_yz_xxyzzzz_0, tg_yz_xxyzzzz_1, tg_yz_xxzzzzz_0, tg_yz_xxzzzzz_1, tg_yz_xyyyyyy_0, \
                                         tg_yz_xyyyyyy_1, tg_yz_xyyyyyz_0, tg_yz_xyyyyyz_1, tg_yz_xyyyyzz_0, tg_yz_xyyyyzz_1, \
                                         tg_yz_xyyyzzz_0, tg_yz_xyyyzzz_1, tg_yz_xyyzzzz_0, tg_yz_xyyzzzz_1, tg_yz_xyzzzzz_0, \
                                         tg_yz_xyzzzzz_1, tg_yz_xzzzzzz_0, tg_yz_xzzzzzz_1, tg_yz_yyyyyyy_0, tg_yz_yyyyyyy_1, \
                                         tg_yz_yyyyyyz_0, tg_yz_yyyyyyz_1, tg_yz_yyyyyzz_0, tg_yz_yyyyyzz_1, tg_yz_yyyyzzz_0, \
                                         tg_yz_yyyyzzz_1, tg_yz_yyyzzzz_0, tg_yz_yyyzzzz_1, tg_yz_yyzzzzz_0, tg_yz_yyzzzzz_1, \
                                         tg_yz_yzzzzzz_0, tg_yz_yzzzzzz_1, tg_yz_zzzzzzz_0, tg_yz_zzzzzzz_1, tg_zz_xxxxxxx_0, \
                                         tg_zz_xxxxxxx_1, tg_zz_xxxxxxy_0, tg_zz_xxxxxxy_1, tg_zz_xxxxxxz_0, tg_zz_xxxxxxz_1, \
                                         tg_zz_xxxxxyy_0, tg_zz_xxxxxyy_1, tg_zz_xxxxxyz_0, tg_zz_xxxxxyz_1, tg_zz_xxxxxzz_0, \
                                         tg_zz_xxxxxzz_1, tg_zz_xxxxyyy_0, tg_zz_xxxxyyy_1, tg_zz_xxxxyyz_0, tg_zz_xxxxyyz_1, \
                                         tg_zz_xxxxyzz_0, tg_zz_xxxxyzz_1, tg_zz_xxxxzzz_0, tg_zz_xxxxzzz_1, tg_zz_xxxyyyy_0, \
                                         tg_zz_xxxyyyy_1, tg_zz_xxxyyyz_0, tg_zz_xxxyyyz_1, tg_zz_xxxyyzz_0, tg_zz_xxxyyzz_1, \
                                         tg_zz_xxxyzzz_0, tg_zz_xxxyzzz_1, tg_zz_xxxzzzz_0, tg_zz_xxxzzzz_1, tg_zz_xxyyyyy_0, \
                                         tg_zz_xxyyyyy_1, tg_zz_xxyyyyz_0, tg_zz_xxyyyyz_1, wp_x: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fx = fx;
                    ...
                    tg_xxyz_xxxxxyz_0[j] = pb_x * tg_xyz_xxxxxyz_0[j] + wp_x[j] * tg_xyz_xxxxxyz_1[j] + 0.5 * fl1_fx * tg_yz_xxxxxyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xxxxxyz_1[j] + 2.5 * fl1_fxn * tg_xyz_xxxxyz_1[j];

                    tg_xxyz_xxxxxzz_0[j] = pb_x * tg_xyz_xxxxxzz_0[j] + wp_x[j] * tg_xyz_xxxxxzz_1[j] + 0.5 * fl1_fx * tg_yz_xxxxxzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xxxxxzz_1[j] + 2.5 * fl1_fxn * tg_xyz_xxxxzz_1[j];

                    tg_xxyz_xxxxyyy_0[j] = pb_x * tg_xyz_xxxxyyy_0[j] + wp_x[j] * tg_xyz_xxxxyyy_1[j] + 0.5 * fl1_fx * tg_yz_xxxxyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xxxxyyy_1[j] + 2.0 * fl1_fxn * tg_xyz_xxxyyy_1[j];

                    tg_xxyz_xxxxyyz_0[j] = pb_x * tg_xyz_xxxxyyz_0[j] + wp_x[j] * tg_xyz_xxxxyyz_1[j] + 0.5 * fl1_fx * tg_yz_xxxxyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xxxxyyz_1[j] + 2.0 * fl1_fxn * tg_xyz_xxxyyz_1[j];

                    tg_xxyz_xxxxyzz_0[j] = pb_x * tg_xyz_xxxxyzz_0[j] + wp_x[j] * tg_xyz_xxxxyzz_1[j] + 0.5 * fl1_fx * tg_yz_xxxxyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xxxxyzz_1[j] + 2.0 * fl1_fxn * tg_xyz_xxxyzz_1[j];

                    tg_xxyz_xxxxzzz_0[j] = pb_x * tg_xyz_xxxxzzz_0[j] + wp_x[j] * tg_xyz_xxxxzzz_1[j] + 0.5 * fl1_fx * tg_yz_xxxxzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xxxxzzz_1[j] + 2.0 * fl1_fxn * tg_xyz_xxxzzz_1[j];

                    tg_xxyz_xxxyyyy_0[j] = pb_x * tg_xyz_xxxyyyy_0[j] + wp_x[j] * tg_xyz_xxxyyyy_1[j] + 0.5 * fl1_fx * tg_yz_xxxyyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xxxyyyy_1[j] + 1.5 * fl1_fxn * tg_xyz_xxyyyy_1[j];

                    tg_xxyz_xxxyyyz_0[j] = pb_x * tg_xyz_xxxyyyz_0[j] + wp_x[j] * tg_xyz_xxxyyyz_1[j] + 0.5 * fl1_fx * tg_yz_xxxyyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xxxyyyz_1[j] + 1.5 * fl1_fxn * tg_xyz_xxyyyz_1[j];

                    tg_xxyz_xxxyyzz_0[j] = pb_x * tg_xyz_xxxyyzz_0[j] + wp_x[j] * tg_xyz_xxxyyzz_1[j] + 0.5 * fl1_fx * tg_yz_xxxyyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xxxyyzz_1[j] + 1.5 * fl1_fxn * tg_xyz_xxyyzz_1[j];

                    tg_xxyz_xxxyzzz_0[j] = pb_x * tg_xyz_xxxyzzz_0[j] + wp_x[j] * tg_xyz_xxxyzzz_1[j] + 0.5 * fl1_fx * tg_yz_xxxyzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xxxyzzz_1[j] + 1.5 * fl1_fxn * tg_xyz_xxyzzz_1[j];

                    tg_xxyz_xxxzzzz_0[j] = pb_x * tg_xyz_xxxzzzz_0[j] + wp_x[j] * tg_xyz_xxxzzzz_1[j] + 0.5 * fl1_fx * tg_yz_xxxzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xxxzzzz_1[j] + 1.5 * fl1_fxn * tg_xyz_xxzzzz_1[j];

                    tg_xxyz_xxyyyyy_0[j] = pb_x * tg_xyz_xxyyyyy_0[j] + wp_x[j] * tg_xyz_xxyyyyy_1[j] + 0.5 * fl1_fx * tg_yz_xxyyyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xxyyyyy_1[j] + fl1_fxn * tg_xyz_xyyyyy_1[j];

                    tg_xxyz_xxyyyyz_0[j] = pb_x * tg_xyz_xxyyyyz_0[j] + wp_x[j] * tg_xyz_xxyyyyz_1[j] + 0.5 * fl1_fx * tg_yz_xxyyyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xxyyyyz_1[j] + fl1_fxn * tg_xyz_xyyyyz_1[j];

                    tg_xxyz_xxyyyzz_0[j] = pb_x * tg_xyz_xxyyyzz_0[j] + wp_x[j] * tg_xyz_xxyyyzz_1[j] + 0.5 * fl1_fx * tg_yz_xxyyyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xxyyyzz_1[j] + fl1_fxn * tg_xyz_xyyyzz_1[j];

                    tg_xxyz_xxyyzzz_0[j] = pb_x * tg_xyz_xxyyzzz_0[j] + wp_x[j] * tg_xyz_xxyyzzz_1[j] + 0.5 * fl1_fx * tg_yz_xxyyzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xxyyzzz_1[j] + fl1_fxn * tg_xyz_xyyzzz_1[j];

                    tg_xxyz_xxyzzzz_0[j] = pb_x * tg_xyz_xxyzzzz_0[j] + wp_x[j] * tg_xyz_xxyzzzz_1[j] + 0.5 * fl1_fx * tg_yz_xxyzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xxyzzzz_1[j] + fl1_fxn * tg_xyz_xyzzzz_1[j];

                    tg_xxyz_xxzzzzz_0[j] = pb_x * tg_xyz_xxzzzzz_0[j] + wp_x[j] * tg_xyz_xxzzzzz_1[j] + 0.5 * fl1_fx * tg_yz_xxzzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xxzzzzz_1[j] + fl1_fxn * tg_xyz_xzzzzz_1[j];

                    tg_xxyz_xyyyyyy_0[j] = pb_x * tg_xyz_xyyyyyy_0[j] + wp_x[j] * tg_xyz_xyyyyyy_1[j] + 0.5 * fl1_fx * tg_yz_xyyyyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xyyyyyy_1[j] + 0.5 * fl1_fxn * tg_xyz_yyyyyy_1[j];

                    tg_xxyz_xyyyyyz_0[j] = pb_x * tg_xyz_xyyyyyz_0[j] + wp_x[j] * tg_xyz_xyyyyyz_1[j] + 0.5 * fl1_fx * tg_yz_xyyyyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xyyyyyz_1[j] + 0.5 * fl1_fxn * tg_xyz_yyyyyz_1[j];

                    tg_xxyz_xyyyyzz_0[j] = pb_x * tg_xyz_xyyyyzz_0[j] + wp_x[j] * tg_xyz_xyyyyzz_1[j] + 0.5 * fl1_fx * tg_yz_xyyyyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xyyyyzz_1[j] + 0.5 * fl1_fxn * tg_xyz_yyyyzz_1[j];

                    tg_xxyz_xyyyzzz_0[j] = pb_x * tg_xyz_xyyyzzz_0[j] + wp_x[j] * tg_xyz_xyyyzzz_1[j] + 0.5 * fl1_fx * tg_yz_xyyyzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xyyyzzz_1[j] + 0.5 * fl1_fxn * tg_xyz_yyyzzz_1[j];

                    tg_xxyz_xyyzzzz_0[j] = pb_x * tg_xyz_xyyzzzz_0[j] + wp_x[j] * tg_xyz_xyyzzzz_1[j] + 0.5 * fl1_fx * tg_yz_xyyzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xyyzzzz_1[j] + 0.5 * fl1_fxn * tg_xyz_yyzzzz_1[j];

                    tg_xxyz_xyzzzzz_0[j] = pb_x * tg_xyz_xyzzzzz_0[j] + wp_x[j] * tg_xyz_xyzzzzz_1[j] + 0.5 * fl1_fx * tg_yz_xyzzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xyzzzzz_1[j] + 0.5 * fl1_fxn * tg_xyz_yzzzzz_1[j];

                    tg_xxyz_xzzzzzz_0[j] = pb_x * tg_xyz_xzzzzzz_0[j] + wp_x[j] * tg_xyz_xzzzzzz_1[j] + 0.5 * fl1_fx * tg_yz_xzzzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_xzzzzzz_1[j] + 0.5 * fl1_fxn * tg_xyz_zzzzzz_1[j];

                    tg_xxyz_yyyyyyy_0[j] = pb_x * tg_xyz_yyyyyyy_0[j] + wp_x[j] * tg_xyz_yyyyyyy_1[j] + 0.5 * fl1_fx * tg_yz_yyyyyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_yyyyyyy_1[j];

                    tg_xxyz_yyyyyyz_0[j] = pb_x * tg_xyz_yyyyyyz_0[j] + wp_x[j] * tg_xyz_yyyyyyz_1[j] + 0.5 * fl1_fx * tg_yz_yyyyyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_yyyyyyz_1[j];

                    tg_xxyz_yyyyyzz_0[j] = pb_x * tg_xyz_yyyyyzz_0[j] + wp_x[j] * tg_xyz_yyyyyzz_1[j] + 0.5 * fl1_fx * tg_yz_yyyyyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_yyyyyzz_1[j];

                    tg_xxyz_yyyyzzz_0[j] = pb_x * tg_xyz_yyyyzzz_0[j] + wp_x[j] * tg_xyz_yyyyzzz_1[j] + 0.5 * fl1_fx * tg_yz_yyyyzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_yyyyzzz_1[j];

                    tg_xxyz_yyyzzzz_0[j] = pb_x * tg_xyz_yyyzzzz_0[j] + wp_x[j] * tg_xyz_yyyzzzz_1[j] + 0.5 * fl1_fx * tg_yz_yyyzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_yyyzzzz_1[j];

                    tg_xxyz_yyzzzzz_0[j] = pb_x * tg_xyz_yyzzzzz_0[j] + wp_x[j] * tg_xyz_yyzzzzz_1[j] + 0.5 * fl1_fx * tg_yz_yyzzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_yyzzzzz_1[j];

                    tg_xxyz_yzzzzzz_0[j] = pb_x * tg_xyz_yzzzzzz_0[j] + wp_x[j] * tg_xyz_yzzzzzz_1[j] + 0.5 * fl1_fx * tg_yz_yzzzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_yzzzzzz_1[j];

                    tg_xxyz_zzzzzzz_0[j] = pb_x * tg_xyz_zzzzzzz_0[j] + wp_x[j] * tg_xyz_zzzzzzz_1[j] + 0.5 * fl1_fx * tg_yz_zzzzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_yz_zzzzzzz_1[j];

                    tg_xxzz_xxxxxxx_0[j] = pb_x * tg_xzz_xxxxxxx_0[j] + wp_x[j] * tg_xzz_xxxxxxx_1[j] + 0.5 * fl1_fx * tg_zz_xxxxxxx_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxxxxx_1[j] + 3.5 * fl1_fxn * tg_xzz_xxxxxx_1[j];

                    tg_xxzz_xxxxxxy_0[j] = pb_x * tg_xzz_xxxxxxy_0[j] + wp_x[j] * tg_xzz_xxxxxxy_1[j] + 0.5 * fl1_fx * tg_zz_xxxxxxy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxxxxy_1[j] + 3.0 * fl1_fxn * tg_xzz_xxxxxy_1[j];

                    tg_xxzz_xxxxxxz_0[j] = pb_x * tg_xzz_xxxxxxz_0[j] + wp_x[j] * tg_xzz_xxxxxxz_1[j] + 0.5 * fl1_fx * tg_zz_xxxxxxz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxxxxz_1[j] + 3.0 * fl1_fxn * tg_xzz_xxxxxz_1[j];

                    tg_xxzz_xxxxxyy_0[j] = pb_x * tg_xzz_xxxxxyy_0[j] + wp_x[j] * tg_xzz_xxxxxyy_1[j] + 0.5 * fl1_fx * tg_zz_xxxxxyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxxxyy_1[j] + 2.5 * fl1_fxn * tg_xzz_xxxxyy_1[j];

                    tg_xxzz_xxxxxyz_0[j] = pb_x * tg_xzz_xxxxxyz_0[j] + wp_x[j] * tg_xzz_xxxxxyz_1[j] + 0.5 * fl1_fx * tg_zz_xxxxxyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxxxyz_1[j] + 2.5 * fl1_fxn * tg_xzz_xxxxyz_1[j];

                    tg_xxzz_xxxxxzz_0[j] = pb_x * tg_xzz_xxxxxzz_0[j] + wp_x[j] * tg_xzz_xxxxxzz_1[j] + 0.5 * fl1_fx * tg_zz_xxxxxzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxxxzz_1[j] + 2.5 * fl1_fxn * tg_xzz_xxxxzz_1[j];

                    tg_xxzz_xxxxyyy_0[j] = pb_x * tg_xzz_xxxxyyy_0[j] + wp_x[j] * tg_xzz_xxxxyyy_1[j] + 0.5 * fl1_fx * tg_zz_xxxxyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxxyyy_1[j] + 2.0 * fl1_fxn * tg_xzz_xxxyyy_1[j];

                    tg_xxzz_xxxxyyz_0[j] = pb_x * tg_xzz_xxxxyyz_0[j] + wp_x[j] * tg_xzz_xxxxyyz_1[j] + 0.5 * fl1_fx * tg_zz_xxxxyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxxyyz_1[j] + 2.0 * fl1_fxn * tg_xzz_xxxyyz_1[j];

                    tg_xxzz_xxxxyzz_0[j] = pb_x * tg_xzz_xxxxyzz_0[j] + wp_x[j] * tg_xzz_xxxxyzz_1[j] + 0.5 * fl1_fx * tg_zz_xxxxyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxxyzz_1[j] + 2.0 * fl1_fxn * tg_xzz_xxxyzz_1[j];

                    tg_xxzz_xxxxzzz_0[j] = pb_x * tg_xzz_xxxxzzz_0[j] + wp_x[j] * tg_xzz_xxxxzzz_1[j] + 0.5 * fl1_fx * tg_zz_xxxxzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxxzzz_1[j] + 2.0 * fl1_fxn * tg_xzz_xxxzzz_1[j];

                    tg_xxzz_xxxyyyy_0[j] = pb_x * tg_xzz_xxxyyyy_0[j] + wp_x[j] * tg_xzz_xxxyyyy_1[j] + 0.5 * fl1_fx * tg_zz_xxxyyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxyyyy_1[j] + 1.5 * fl1_fxn * tg_xzz_xxyyyy_1[j];

                    tg_xxzz_xxxyyyz_0[j] = pb_x * tg_xzz_xxxyyyz_0[j] + wp_x[j] * tg_xzz_xxxyyyz_1[j] + 0.5 * fl1_fx * tg_zz_xxxyyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxyyyz_1[j] + 1.5 * fl1_fxn * tg_xzz_xxyyyz_1[j];

                    tg_xxzz_xxxyyzz_0[j] = pb_x * tg_xzz_xxxyyzz_0[j] + wp_x[j] * tg_xzz_xxxyyzz_1[j] + 0.5 * fl1_fx * tg_zz_xxxyyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxyyzz_1[j] + 1.5 * fl1_fxn * tg_xzz_xxyyzz_1[j];

                    tg_xxzz_xxxyzzz_0[j] = pb_x * tg_xzz_xxxyzzz_0[j] + wp_x[j] * tg_xzz_xxxyzzz_1[j] + 0.5 * fl1_fx * tg_zz_xxxyzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxyzzz_1[j] + 1.5 * fl1_fxn * tg_xzz_xxyzzz_1[j];

                    tg_xxzz_xxxzzzz_0[j] = pb_x * tg_xzz_xxxzzzz_0[j] + wp_x[j] * tg_xzz_xxxzzzz_1[j] + 0.5 * fl1_fx * tg_zz_xxxzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxzzzz_1[j] + 1.5 * fl1_fxn * tg_xzz_xxzzzz_1[j];

                    tg_xxzz_xxyyyyy_0[j] = pb_x * tg_xzz_xxyyyyy_0[j] + wp_x[j] * tg_xzz_xxyyyyy_1[j] + 0.5 * fl1_fx * tg_zz_xxyyyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxyyyyy_1[j] + fl1_fxn * tg_xzz_xyyyyy_1[j];

                    tg_xxzz_xxyyyyz_0[j] = pb_x * tg_xzz_xxyyyyz_0[j] + wp_x[j] * tg_xzz_xxyyyyz_1[j] + 0.5 * fl1_fx * tg_zz_xxyyyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxyyyyz_1[j] + fl1_fxn * tg_xzz_xyyyyz_1[j];
                }
    ...
    void
    compElectronRepulsionForSGSK_197_246(      CMemBlock2D<double>& primBuffer,
                                         const CRecursionMap&       recursionMap,
                                         const CMemBlock2D<double>& osFactors,
                                         const CMemBlock2D<double>& wpDistances,
                                         const CGtoPairsBlock&      braGtoPairsBlock,
                                         ...
                                         const int32_t              iContrPair)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, fza, tg_xxzz_xxyyyzz_0, tg_xxzz_xxyyzzz_0, tg_xxzz_xxyzzzz_0, \
                                         tg_xxzz_xxzzzzz_0, tg_xxzz_xyyyyyy_0, tg_xxzz_xyyyyyz_0, tg_xxzz_xyyyyzz_0, \
                                         tg_xxzz_xyyyzzz_0, tg_xxzz_xyyzzzz_0, tg_xxzz_xyzzzzz_0, tg_xxzz_xzzzzzz_0, \
                                         tg_xxzz_yyyyyyy_0, tg_xxzz_yyyyyyz_0, tg_xxzz_yyyyyzz_0, tg_xxzz_yyyyzzz_0, \
                                         tg_xxzz_yyyzzzz_0, tg_xxzz_yyzzzzz_0, tg_xxzz_yzzzzzz_0, tg_xxzz_zzzzzzz_0, \
                                         tg_xyyy_xxxxxxx_0, tg_xyyy_xxxxxxy_0, tg_xyyy_xxxxxxz_0, tg_xyyy_xxxxxyy_0, \
                                         tg_xyyy_xxxxxyz_0, tg_xyyy_xxxxxzz_0, tg_xyyy_xxxxyyy_0, tg_xyyy_xxxxyyz_0, \
                                         tg_xyyy_xxxxyzz_0, tg_xyyy_xxxxzzz_0, tg_xyyy_xxxyyyy_0, tg_xyyy_xxxyyyz_0, \
                                         tg_xyyy_xxxyyzz_0, tg_xyyy_xxxyzzz_0, tg_xyyy_xxxzzzz_0, tg_xyyy_xxyyyyy_0, \
                                         tg_xyyy_xxyyyyz_0, tg_xyyy_xxyyyzz_0, tg_xyyy_xxyyzzz_0, tg_xyyy_xxyzzzz_0, \
                                         tg_xyyy_xxzzzzz_0, tg_xyyy_xyyyyyy_0, tg_xyyy_xyyyyyz_0, tg_xyyy_xyyyyzz_0, \
                                         tg_xyyy_xyyyzzz_0, tg_xyyy_xyyzzzz_0, tg_xyyy_xyzzzzz_0, tg_xyyy_xzzzzzz_0, \
                                         tg_xyyy_yyyyyyy_0, tg_xyyy_yyyyyyz_0, tg_xzz_xxyyyzz_0, tg_xzz_xxyyyzz_1, \
                                         ...
                                         tg_yyy_yyyyyyz_1, tg_yyy_yyyyyz_1, tg_yyy_yyyyzz_1, tg_yyy_yyyzzz_1, tg_yyy_yyzzzz_1, \
                                         tg_yyy_yzzzzz_1, tg_yyy_zzzzzz_1, tg_zz_xxyyyzz_0, tg_zz_xxyyyzz_1, tg_zz_xxyyzzz_0, \
                ...
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    ...
                    tg_xxzz_xxyyyzz_0[j] = pb_x * tg_xzz_xxyyyzz_0[j] + wp_x[j] * tg_xzz_xxyyyzz_1[j] + 0.5 * fl1_fx * tg_zz_xxyyyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxyyyzz_1[j] + fl1_fxn * tg_xzz_xyyyzz_1[j];

                    tg_xxzz_xxyyzzz_0[j] = pb_x * tg_xzz_xxyyzzz_0[j] + wp_x[j] * tg_xzz_xxyyzzz_1[j] + 0.5 * fl1_fx * tg_zz_xxyyzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxyyzzz_1[j] + fl1_fxn * tg_xzz_xyyzzz_1[j];

                    tg_xxzz_xxyzzzz_0[j] = pb_x * tg_xzz_xxyzzzz_0[j] + wp_x[j] * tg_xzz_xxyzzzz_1[j] + 0.5 * fl1_fx * tg_zz_xxyzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxyzzzz_1[j] + fl1_fxn * tg_xzz_xyzzzz_1[j];

                    tg_xxzz_xxzzzzz_0[j] = pb_x * tg_xzz_xxzzzzz_0[j] + wp_x[j] * tg_xzz_xxzzzzz_1[j] + 0.5 * fl1_fx * tg_zz_xxzzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxzzzzz_1[j] + fl1_fxn * tg_xzz_xzzzzz_1[j];

                    tg_xxzz_xyyyyyy_0[j] = pb_x * tg_xzz_xyyyyyy_0[j] + wp_x[j] * tg_xzz_xyyyyyy_1[j] + 0.5 * fl1_fx * tg_zz_xyyyyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xyyyyyy_1[j] + 0.5 * fl1_fxn * tg_xzz_yyyyyy_1[j];

                    tg_xxzz_xyyyyyz_0[j] = pb_x * tg_xzz_xyyyyyz_0[j] + wp_x[j] * tg_xzz_xyyyyyz_1[j] + 0.5 * fl1_fx * tg_zz_xyyyyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xyyyyyz_1[j] + 0.5 * fl1_fxn * tg_xzz_yyyyyz_1[j];

                    tg_xxzz_xyyyyzz_0[j] = pb_x * tg_xzz_xyyyyzz_0[j] + wp_x[j] * tg_xzz_xyyyyzz_1[j] + 0.5 * fl1_fx * tg_zz_xyyyyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xyyyyzz_1[j] + 0.5 * fl1_fxn * tg_xzz_yyyyzz_1[j];

                    tg_xxzz_xyyyzzz_0[j] = pb_x * tg_xzz_xyyyzzz_0[j] + wp_x[j] * tg_xzz_xyyyzzz_1[j] + 0.5 * fl1_fx * tg_zz_xyyyzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xyyyzzz_1[j] + 0.5 * fl1_fxn * tg_xzz_yyyzzz_1[j];

                    tg_xxzz_xyyzzzz_0[j] = pb_x * tg_xzz_xyyzzzz_0[j] + wp_x[j] * tg_xzz_xyyzzzz_1[j] + 0.5 * fl1_fx * tg_zz_xyyzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xyyzzzz_1[j] + 0.5 * fl1_fxn * tg_xzz_yyzzzz_1[j];

                    tg_xxzz_xyzzzzz_0[j] = pb_x * tg_xzz_xyzzzzz_0[j] + wp_x[j] * tg_xzz_xyzzzzz_1[j] + 0.5 * fl1_fx * tg_zz_xyzzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xyzzzzz_1[j] + 0.5 * fl1_fxn * tg_xzz_yzzzzz_1[j];

                    tg_xxzz_xzzzzzz_0[j] = pb_x * tg_xzz_xzzzzzz_0[j] + wp_x[j] * tg_xzz_xzzzzzz_1[j] + 0.5 * fl1_fx * tg_zz_xzzzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xzzzzzz_1[j] + 0.5 * fl1_fxn * tg_xzz_zzzzzz_1[j];

                    tg_xxzz_yyyyyyy_0[j] = pb_x * tg_xzz_yyyyyyy_0[j] + wp_x[j] * tg_xzz_yyyyyyy_1[j] + 0.5 * fl1_fx * tg_zz_yyyyyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_yyyyyyy_1[j];

                    tg_xxzz_yyyyyyz_0[j] = pb_x * tg_xzz_yyyyyyz_0[j] + wp_x[j] * tg_xzz_yyyyyyz_1[j] + 0.5 * fl1_fx * tg_zz_yyyyyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_yyyyyyz_1[j];

                    tg_xxzz_yyyyyzz_0[j] = pb_x * tg_xzz_yyyyyzz_0[j] + wp_x[j] * tg_xzz_yyyyyzz_1[j] + 0.5 * fl1_fx * tg_zz_yyyyyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_yyyyyzz_1[j];

                    tg_xxzz_yyyyzzz_0[j] = pb_x * tg_xzz_yyyyzzz_0[j] + wp_x[j] * tg_xzz_yyyyzzz_1[j] + 0.5 * fl1_fx * tg_zz_yyyyzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_yyyyzzz_1[j];

                    tg_xxzz_yyyzzzz_0[j] = pb_x * tg_xzz_yyyzzzz_0[j] + wp_x[j] * tg_xzz_yyyzzzz_1[j] + 0.5 * fl1_fx * tg_zz_yyyzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_yyyzzzz_1[j];

                    tg_xxzz_yyzzzzz_0[j] = pb_x * tg_xzz_yyzzzzz_0[j] + wp_x[j] * tg_xzz_yyzzzzz_1[j] + 0.5 * fl1_fx * tg_zz_yyzzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_yyzzzzz_1[j];

                    tg_xxzz_yzzzzzz_0[j] = pb_x * tg_xzz_yzzzzzz_0[j] + wp_x[j] * tg_xzz_yzzzzzz_1[j] + 0.5 * fl1_fx * tg_zz_yzzzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_yzzzzzz_1[j];

                    tg_xxzz_zzzzzzz_0[j] = pb_x * tg_xzz_zzzzzzz_0[j] + wp_x[j] * tg_xzz_zzzzzzz_1[j] + 0.5 * fl1_fx * tg_zz_zzzzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_zzzzzzz_1[j];

                    tg_xyyy_xxxxxxx_0[j] = pb_x * tg_yyy_xxxxxxx_0[j] + wp_x[j] * tg_yyy_xxxxxxx_1[j] + 3.5 * fl1_fxn * tg_yyy_xxxxxx_1[j];

                    tg_xyyy_xxxxxxy_0[j] = pb_x * tg_yyy_xxxxxxy_0[j] + wp_x[j] * tg_yyy_xxxxxxy_1[j] + 3.0 * fl1_fxn * tg_yyy_xxxxxy_1[j];

                    tg_xyyy_xxxxxxz_0[j] = pb_x * tg_yyy_xxxxxxz_0[j] + wp_x[j] * tg_yyy_xxxxxxz_1[j] + 3.0 * fl1_fxn * tg_yyy_xxxxxz_1[j];

                    tg_xyyy_xxxxxyy_0[j] = pb_x * tg_yyy_xxxxxyy_0[j] + wp_x[j] * tg_yyy_xxxxxyy_1[j] + 2.5 * fl1_fxn * tg_yyy_xxxxyy_1[j];

                    tg_xyyy_xxxxxyz_0[j] = pb_x * tg_yyy_xxxxxyz_0[j] + wp_x[j] * tg_yyy_xxxxxyz_1[j] + 2.5 * fl1_fxn * tg_yyy_xxxxyz_1[j];

                    tg_xyyy_xxxxxzz_0[j] = pb_x * tg_yyy_xxxxxzz_0[j] + wp_x[j] * tg_yyy_xxxxxzz_1[j] + 2.5 * fl1_fxn * tg_yyy_xxxxzz_1[j];

                    tg_xyyy_xxxxyyy_0[j] = pb_x * tg_yyy_xxxxyyy_0[j] + wp_x[j] * tg_yyy_xxxxyyy_1[j] + 2.0 * fl1_fxn * tg_yyy_xxxyyy_1[j];

                    tg_xyyy_xxxxyyz_0[j] = pb_x * tg_yyy_xxxxyyz_0[j] + wp_x[j] * tg_yyy_xxxxyyz_1[j] + 2.0 * fl1_fxn * tg_yyy_xxxyyz_1[j];

                    tg_xyyy_xxxxyzz_0[j] = pb_x * tg_yyy_xxxxyzz_0[j] + wp_x[j] * tg_yyy_xxxxyzz_1[j] + 2.0 * fl1_fxn * tg_yyy_xxxyzz_1[j];

                    tg_xyyy_xxxxzzz_0[j] = pb_x * tg_yyy_xxxxzzz_0[j] + wp_x[j] * tg_yyy_xxxxzzz_1[j] + 2.0 * fl1_fxn * tg_yyy_xxxzzz_1[j];

                    tg_xyyy_xxxyyyy_0[j] = pb_x * tg_yyy_xxxyyyy_0[j] + wp_x[j] * tg_yyy_xxxyyyy_1[j] + 1.5 * fl1_fxn * tg_yyy_xxyyyy_1[j];

                    tg_xyyy_xxxyyyz_0[j] = pb_x * tg_yyy_xxxyyyz_0[j] + wp_x[j] * tg_yyy_xxxyyyz_1[j] + 1.5 * fl1_fxn * tg_yyy_xxyyyz_1[j];

                    tg_xyyy_xxxyyzz_0[j] = pb_x * tg_yyy_xxxyyzz_0[j] + wp_x[j] * tg_yyy_xxxyyzz_1[j] + 1.5 * fl1_fxn * tg_yyy_xxyyzz_1[j];

                    tg_xyyy_xxxyzzz_0[j] = pb_x * tg_yyy_xxxyzzz_0[j] + wp_x[j] * tg_yyy_xxxyzzz_1[j] + 1.5 * fl1_fxn * tg_yyy_xxyzzz_1[j];

                    tg_xyyy_xxxzzzz_0[j] = pb_x * tg_yyy_xxxzzzz_0[j] + wp_x[j] * tg_yyy_xxxzzzz_1[j] + 1.5 * fl1_fxn * tg_yyy_xxzzzz_1[j];

                    tg_xyyy_xxyyyyy_0[j] = pb_x * tg_yyy_xxyyyyy_0[j] + wp_x[j] * tg_yyy_xxyyyyy_1[j] + fl1_fxn * tg_yyy_xyyyyy_1[j];

                    tg_xyyy_xxyyyyz_0[j] = pb_x * tg_yyy_xxyyyyz_0[j] + wp_x[j] * tg_yyy_xxyyyyz_1[j] + fl1_fxn * tg_yyy_xyyyyz_1[j];

                    tg_xyyy_xxyyyzz_0[j] = pb_x * tg_yyy_xxyyyzz_0[j] + wp_x[j] * tg_yyy_xxyyyzz_1[j] + fl1_fxn * tg_yyy_xyyyzz_1[j];

                    tg_xyyy_xxyyzzz_0[j] = pb_x * tg_yyy_xxyyzzz_0[j] + wp_x[j] * tg_yyy_xxyyzzz_1[j] + fl1_fxn * tg_yyy_xyyzzz_1[j];

                    tg_xyyy_xxyzzzz_0[j] = pb_x * tg_yyy_xxyzzzz_0[j] + wp_x[j] * tg_yyy_xxyzzzz_1[j] + fl1_fxn * tg_yyy_xyzzzz_1[j];

                    tg_xyyy_xxzzzzz_0[j] = pb_x * tg_yyy_xxzzzzz_0[j] + wp_x[j] * tg_yyy_xxzzzzz_1[j] + fl1_fxn * tg_yyy_xzzzzz_1[j];

                    tg_xyyy_xyyyyyy_0[j] = pb_x * tg_yyy_xyyyyyy_0[j] + wp_x[j] * tg_yyy_xyyyyyy_1[j] + 0.5 * fl1_fxn * tg_yyy_yyyyyy_1[j];

                    tg_xyyy_xyyyyyz_0[j] = pb_x * tg_yyy_xyyyyyz_0[j] + wp_x[j] * tg_yyy_xyyyyyz_1[j] + 0.5 * fl1_fxn * tg_yyy_yyyyyz_1[j];

                    tg_xyyy_xyyyyzz_0[j] = pb_x * tg_yyy_xyyyyzz_0[j] + wp_x[j] * tg_yyy_xyyyyzz_1[j] + 0.5 * fl1_fxn * tg_yyy_yyyyzz_1[j];

                    tg_xyyy_xyyyzzz_0[j] = pb_x * tg_yyy_xyyyzzz_0[j] + wp_x[j] * tg_yyy_xyyyzzz_1[j] + 0.5 * fl1_fxn * tg_yyy_yyyzzz_1[j];

                    tg_xyyy_xyyzzzz_0[j] = pb_x * tg_yyy_xyyzzzz_0[j] + wp_x[j] * tg_yyy_xyyzzzz_1[j] + 0.5 * fl1_fxn * tg_yyy_yyzzzz_1[j];

                    tg_xyyy_xyzzzzz_0[j] = pb_x * tg_yyy_xyzzzzz_0[j] + wp_x[j] * tg_yyy_xyzzzzz_1[j] + 0.5 * fl1_fxn * tg_yyy_yzzzzz_1[j];

                    tg_xyyy_xzzzzzz_0[j] = pb_x * tg_yyy_xzzzzzz_0[j] + wp_x[j] * tg_yyy_xzzzzzz_1[j] + 0.5 * fl1_fxn * tg_yyy_zzzzzz_1[j];

                    tg_xyyy_yyyyyyy_0[j] = pb_x * tg_yyy_yyyyyyy_0[j] + wp_x[j] * tg_yyy_yyyyyyy_1[j];

                    tg_xyyy_yyyyyyz_0[j] = pb_x * tg_yyy_yyyyyyz_0[j] + wp_x[j] * tg_yyy_yyyyyyz_1[j];
                }
    ...
    void
    compElectronRepulsionForSGSK_246_295(      CMemBlock2D<double>& primBuffer,
                                         const CRecursionMap&       recursionMap,
                                         const CMemBlock2D<double>& osFactors,
                                         const CMemBlock2D<double>& wpDistances,
                                         const CGtoPairsBlock&      braGtoPairsBlock,
                                         ...
                                         const int32_t              iContrPair)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, tg_xyyy_yyyyyzz_0, tg_xyyy_yyyyzzz_0, tg_xyyy_yyyzzzz_0, \
                                         tg_xyyy_yyzzzzz_0, tg_xyyy_yzzzzzz_0, tg_xyyy_zzzzzzz_0, tg_xyyz_xxxxxxx_0, \
                                         tg_xyyz_xxxxxxy_0, tg_xyyz_xxxxxxz_0, tg_xyyz_xxxxxyy_0, tg_xyyz_xxxxxyz_0, \
                                         tg_xyyz_xxxxxzz_0, tg_xyyz_xxxxyyy_0, tg_xyyz_xxxxyyz_0, tg_xyyz_xxxxyzz_0, \
                                         tg_xyyz_xxxxzzz_0, tg_xyyz_xxxyyyy_0, tg_xyyz_xxxyyyz_0, tg_xyyz_xxxyyzz_0, \
                                         tg_xyyz_xxxyzzz_0, tg_xyyz_xxxzzzz_0, tg_xyyz_xxyyyyy_0, tg_xyyz_xxyyyyz_0, \
                                         tg_xyyz_xxyyyzz_0, tg_xyyz_xxyyzzz_0, tg_xyyz_xxyzzzz_0, tg_xyyz_xxzzzzz_0, \
                                         ...
                                         tg_xyzz_xxxxxzz_0, tg_xyzz_xxxxyyy_0, tg_yyy_yyyyyzz_0, tg_yyy_yyyyyzz_1, \
                                         tg_yyy_yyyyzzz_0, tg_yyy_yyyyzzz_1, tg_yyy_yyyzzzz_0, tg_yyy_yyyzzzz_1, \
                                         tg_yyy_yyzzzzz_0, tg_yyy_yyzzzzz_1, tg_yyy_yzzzzzz_0, tg_yyy_yzzzzzz_1, \
                                         tg_yyy_zzzzzzz_0, tg_yyy_zzzzzzz_1, tg_yyz_xxxxxx_1, tg_yyz_xxxxxxx_0, \
                                         tg_yyz_xxxxxxx_1, tg_yyz_xxxxxxy_0, tg_yyz_xxxxxxy_1, tg_yyz_xxxxxxz_0, \
                                         tg_yyz_xxxxxxz_1, tg_yyz_xxxxxy_1, tg_yyz_xxxxxyy_0, tg_yyz_xxxxxyy_1, \
                                         tg_yyz_xxxxxyz_0, tg_yyz_xxxxxyz_1, tg_yyz_xxxxxz_1, tg_yyz_xxxxxzz_0, \
                                         tg_yyz_xxxxxzz_1, tg_yyz_xxxxyy_1, tg_yyz_xxxxyyy_0, tg_yyz_xxxxyyy_1, \
                                         tg_yyz_xxxxyyz_0, tg_yyz_xxxxyyz_1, tg_yyz_xxxxyz_1, tg_yyz_xxxxyzz_0, \
                                         tg_yyz_xxxxyzz_1, tg_yyz_xxxxzz_1, tg_yyz_xxxxzzz_0, tg_yyz_xxxxzzz_1, \
                                         tg_yyz_xxxyyy_1, tg_yyz_xxxyyyy_0, tg_yyz_xxxyyyy_1, tg_yyz_xxxyyyz_0, \
                                         tg_yyz_xxxyyyz_1, tg_yyz_xxxyyz_1, tg_yyz_xxxyyzz_0, tg_yyz_xxxyyzz_1, \
                                         tg_yyz_xxxyzz_1, tg_yyz_xxxyzzz_0, tg_yyz_xxxyzzz_1, tg_yyz_xxxzzz_1, \
                                         tg_yyz_xxxzzzz_0, tg_yyz_xxxzzzz_1, tg_yyz_xxyyyy_1, tg_yyz_xxyyyyy_0, \
                                         tg_yyz_xxyyyyy_1, tg_yyz_xxyyyyz_0, tg_yyz_xxyyyyz_1, tg_yyz_xxyyyz_1, \
                                         tg_yyz_xxyyyzz_0, tg_yyz_xxyyyzz_1, tg_yyz_xxyyzz_1, tg_yyz_xxyyzzz_0, \
                                         tg_yyz_xxyyzzz_1, tg_yyz_xxyzzz_1, tg_yyz_xxyzzzz_0, tg_yyz_xxyzzzz_1, \
                                         tg_yyz_xxzzzz_1, tg_yyz_xxzzzzz_0, tg_yyz_xxzzzzz_1, tg_yyz_xyyyyy_1, \
                                         tg_yyz_xyyyyyy_0, tg_yyz_xyyyyyy_1, tg_yyz_xyyyyyz_0, tg_yyz_xyyyyyz_1, \
                                         tg_yyz_xyyyyz_1, tg_yyz_xyyyyzz_0, tg_yyz_xyyyyzz_1, tg_yyz_xyyyzz_1, \
                                         tg_yyz_xyyyzzz_0, tg_yyz_xyyyzzz_1, tg_yyz_xyyzzz_1, tg_yyz_xyyzzzz_0, \
                                         tg_yyz_xyyzzzz_1, tg_yyz_xyzzzz_1, tg_yyz_xyzzzzz_0, tg_yyz_xyzzzzz_1, \
                                         tg_yyz_xzzzzz_1, tg_yyz_xzzzzzz_0, tg_yyz_xzzzzzz_1, tg_yyz_yyyyyy_1, \
                                         tg_yyz_yyyyyyy_0, tg_yyz_yyyyyyy_1, tg_yyz_yyyyyyz_0, tg_yyz_yyyyyyz_1, \
                                         tg_yyz_yyyyyz_1, tg_yyz_yyyyyzz_0, tg_yyz_yyyyyzz_1, tg_yyz_yyyyzz_1, \
                                         tg_yyz_yyyyzzz_0, tg_yyz_yyyyzzz_1, tg_yyz_yyyzzz_1, tg_yyz_yyyzzzz_0, \
                                         tg_yyz_yyyzzzz_1, tg_yyz_yyzzzz_1, tg_yyz_yyzzzzz_0, tg_yyz_yyzzzzz_1, \
                                         tg_yyz_yzzzzz_1, tg_yyz_yzzzzzz_0, tg_yyz_yzzzzzz_1, tg_yyz_zzzzzz_1, \
                                         tg_yyz_zzzzzzz_0, tg_yyz_zzzzzzz_1, tg_yzz_xxxxxx_1, tg_yzz_xxxxxxx_0, \
                                         tg_yzz_xxxxxxx_1, tg_yzz_xxxxxxy_0, tg_yzz_xxxxxxy_1, tg_yzz_xxxxxxz_0, \
                                         tg_yzz_xxxxxxz_1, tg_yzz_xxxxxy_1, tg_yzz_xxxxxyy_0, tg_yzz_xxxxxyy_1, \
                                         tg_yzz_xxxxxyz_0, tg_yzz_xxxxxyz_1, tg_yzz_xxxxxz_1, tg_yzz_xxxxxzz_0, \
                                         tg_yzz_xxxxxzz_1, tg_yzz_xxxxyy_1, tg_yzz_xxxxyyy_0, tg_yzz_xxxxyyy_1, \
                                         tg_yzz_xxxxyz_1, tg_yzz_xxxxzz_1, tg_yzz_xxxyyy_1, wp_x: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fxn = fxn[j];

                    tg_xyyy_yyyyyzz_0[j] = pb_x * tg_yyy_yyyyyzz_0[j] + wp_x[j] * tg_yyy_yyyyyzz_1[j];

                    tg_xyyy_yyyyzzz_0[j] = pb_x * tg_yyy_yyyyzzz_0[j] + wp_x[j] * tg_yyy_yyyyzzz_1[j];

                    tg_xyyy_yyyzzzz_0[j] = pb_x * tg_yyy_yyyzzzz_0[j] + wp_x[j] * tg_yyy_yyyzzzz_1[j];

                    tg_xyyy_yyzzzzz_0[j] = pb_x * tg_yyy_yyzzzzz_0[j] + wp_x[j] * tg_yyy_yyzzzzz_1[j];

                    tg_xyyy_yzzzzzz_0[j] = pb_x * tg_yyy_yzzzzzz_0[j] + wp_x[j] * tg_yyy_yzzzzzz_1[j];

                    tg_xyyy_zzzzzzz_0[j] = pb_x * tg_yyy_zzzzzzz_0[j] + wp_x[j] * tg_yyy_zzzzzzz_1[j];

                    tg_xyyz_xxxxxxx_0[j] = pb_x * tg_yyz_xxxxxxx_0[j] + wp_x[j] * tg_yyz_xxxxxxx_1[j] + 3.5 * fl1_fxn * tg_yyz_xxxxxx_1[j];

                    tg_xyyz_xxxxxxy_0[j] = pb_x * tg_yyz_xxxxxxy_0[j] + wp_x[j] * tg_yyz_xxxxxxy_1[j] + 3.0 * fl1_fxn * tg_yyz_xxxxxy_1[j];

                    tg_xyyz_xxxxxxz_0[j] = pb_x * tg_yyz_xxxxxxz_0[j] + wp_x[j] * tg_yyz_xxxxxxz_1[j] + 3.0 * fl1_fxn * tg_yyz_xxxxxz_1[j];

                    tg_xyyz_xxxxxyy_0[j] = pb_x * tg_yyz_xxxxxyy_0[j] + wp_x[j] * tg_yyz_xxxxxyy_1[j] + 2.5 * fl1_fxn * tg_yyz_xxxxyy_1[j];

                    tg_xyyz_xxxxxyz_0[j] = pb_x * tg_yyz_xxxxxyz_0[j] + wp_x[j] * tg_yyz_xxxxxyz_1[j] + 2.5 * fl1_fxn * tg_yyz_xxxxyz_1[j];

                    tg_xyyz_xxxxxzz_0[j] = pb_x * tg_yyz_xxxxxzz_0[j] + wp_x[j] * tg_yyz_xxxxxzz_1[j] + 2.5 * fl1_fxn * tg_yyz_xxxxzz_1[j];

                    tg_xyyz_xxxxyyy_0[j] = pb_x * tg_yyz_xxxxyyy_0[j] + wp_x[j] * tg_yyz_xxxxyyy_1[j] + 2.0 * fl1_fxn * tg_yyz_xxxyyy_1[j];

                    tg_xyyz_xxxxyyz_0[j] = pb_x * tg_yyz_xxxxyyz_0[j] + wp_x[j] * tg_yyz_xxxxyyz_1[j] + 2.0 * fl1_fxn * tg_yyz_xxxyyz_1[j];

                    tg_xyyz_xxxxyzz_0[j] = pb_x * tg_yyz_xxxxyzz_0[j] + wp_x[j] * tg_yyz_xxxxyzz_1[j] + 2.0 * fl1_fxn * tg_yyz_xxxyzz_1[j];

                    tg_xyyz_xxxxzzz_0[j] = pb_x * tg_yyz_xxxxzzz_0[j] + wp_x[j] * tg_yyz_xxxxzzz_1[j] + 2.0 * fl1_fxn * tg_yyz_xxxzzz_1[j];

                    tg_xyyz_xxxyyyy_0[j] = pb_x * tg_yyz_xxxyyyy_0[j] + wp_x[j] * tg_yyz_xxxyyyy_1[j] + 1.5 * fl1_fxn * tg_yyz_xxyyyy_1[j];

                    tg_xyyz_xxxyyyz_0[j] = pb_x * tg_yyz_xxxyyyz_0[j] + wp_x[j] * tg_yyz_xxxyyyz_1[j] + 1.5 * fl1_fxn * tg_yyz_xxyyyz_1[j];

                    tg_xyyz_xxxyyzz_0[j] = pb_x * tg_yyz_xxxyyzz_0[j] + wp_x[j] * tg_yyz_xxxyyzz_1[j] + 1.5 * fl1_fxn * tg_yyz_xxyyzz_1[j];

                    tg_xyyz_xxxyzzz_0[j] = pb_x * tg_yyz_xxxyzzz_0[j] + wp_x[j] * tg_yyz_xxxyzzz_1[j] + 1.5 * fl1_fxn * tg_yyz_xxyzzz_1[j];

                    tg_xyyz_xxxzzzz_0[j] = pb_x * tg_yyz_xxxzzzz_0[j] + wp_x[j] * tg_yyz_xxxzzzz_1[j] + 1.5 * fl1_fxn * tg_yyz_xxzzzz_1[j];

                    tg_xyyz_xxyyyyy_0[j] = pb_x * tg_yyz_xxyyyyy_0[j] + wp_x[j] * tg_yyz_xxyyyyy_1[j] + fl1_fxn * tg_yyz_xyyyyy_1[j];

                    tg_xyyz_xxyyyyz_0[j] = pb_x * tg_yyz_xxyyyyz_0[j] + wp_x[j] * tg_yyz_xxyyyyz_1[j] + fl1_fxn * tg_yyz_xyyyyz_1[j];

                    tg_xyyz_xxyyyzz_0[j] = pb_x * tg_yyz_xxyyyzz_0[j] + wp_x[j] * tg_yyz_xxyyyzz_1[j] + fl1_fxn * tg_yyz_xyyyzz_1[j];

                    tg_xyyz_xxyyzzz_0[j] = pb_x * tg_yyz_xxyyzzz_0[j] + wp_x[j] * tg_yyz_xxyyzzz_1[j] + fl1_fxn * tg_yyz_xyyzzz_1[j];

                    tg_xyyz_xxyzzzz_0[j] = pb_x * tg_yyz_xxyzzzz_0[j] + wp_x[j] * tg_yyz_xxyzzzz_1[j] + fl1_fxn * tg_yyz_xyzzzz_1[j];

                    tg_xyyz_xxzzzzz_0[j] = pb_x * tg_yyz_xxzzzzz_0[j] + wp_x[j] * tg_yyz_xxzzzzz_1[j] + fl1_fxn * tg_yyz_xzzzzz_1[j];

                    tg_xyyz_xyyyyyy_0[j] = pb_x * tg_yyz_xyyyyyy_0[j] + wp_x[j] * tg_yyz_xyyyyyy_1[j] + 0.5 * fl1_fxn * tg_yyz_yyyyyy_1[j];

                    tg_xyyz_xyyyyyz_0[j] = pb_x * tg_yyz_xyyyyyz_0[j] + wp_x[j] * tg_yyz_xyyyyyz_1[j] + 0.5 * fl1_fxn * tg_yyz_yyyyyz_1[j];

                    tg_xyyz_xyyyyzz_0[j] = pb_x * tg_yyz_xyyyyzz_0[j] + wp_x[j] * tg_yyz_xyyyyzz_1[j] + 0.5 * fl1_fxn * tg_yyz_yyyyzz_1[j];

                    tg_xyyz_xyyyzzz_0[j] = pb_x * tg_yyz_xyyyzzz_0[j] + wp_x[j] * tg_yyz_xyyyzzz_1[j] + 0.5 * fl1_fxn * tg_yyz_yyyzzz_1[j];

                    tg_xyyz_xyyzzzz_0[j] = pb_x * tg_yyz_xyyzzzz_0[j] + wp_x[j] * tg_yyz_xyyzzzz_1[j] + 0.5 * fl1_fxn * tg_yyz_yyzzzz_1[j];

                    tg_xyyz_xyzzzzz_0[j] = pb_x * tg_yyz_xyzzzzz_0[j] + wp_x[j] * tg_yyz_xyzzzzz_1[j] + 0.5 * fl1_fxn * tg_yyz_yzzzzz_1[j];

                    tg_xyyz_xzzzzzz_0[j] = pb_x * tg_yyz_xzzzzzz_0[j] + wp_x[j] * tg_yyz_xzzzzzz_1[j] + 0.5 * fl1_fxn * tg_yyz_zzzzzz_1[j];

                    tg_xyyz_yyyyyyy_0[j] = pb_x * tg_yyz_yyyyyyy_0[j] + wp_x[j] * tg_yyz_yyyyyyy_1[j];

                    tg_xyyz_yyyyyyz_0[j] = pb_x * tg_yyz_yyyyyyz_0[j] + wp_x[j] * tg_yyz_yyyyyyz_1[j];

                    tg_xyyz_yyyyyzz_0[j] = pb_x * tg_yyz_yyyyyzz_0[j] + wp_x[j] * tg_yyz_yyyyyzz_1[j];

                    tg_xyyz_yyyyzzz_0[j] = pb_x * tg_yyz_yyyyzzz_0[j] + wp_x[j] * tg_yyz_yyyyzzz_1[j];

                    tg_xyyz_yyyzzzz_0[j] = pb_x * tg_yyz_yyyzzzz_0[j] + wp_x[j] * tg_yyz_yyyzzzz_1[j];

                    tg_xyyz_yyzzzzz_0[j] = pb_x * tg_yyz_yyzzzzz_0[j] + wp_x[j] * tg_yyz_yyzzzzz_1[j];

                    tg_xyyz_yzzzzzz_0[j] = pb_x * tg_yyz_yzzzzzz_0[j] + wp_x[j] * tg_yyz_yzzzzzz_1[j];

                    tg_xyyz_zzzzzzz_0[j] = pb_x * tg_yyz_zzzzzzz_0[j] + wp_x[j] * tg_yyz_zzzzzzz_1[j];

                    tg_xyzz_xxxxxxx_0[j] = pb_x * tg_yzz_xxxxxxx_0[j] + wp_x[j] * tg_yzz_xxxxxxx_1[j] + 3.5 * fl1_fxn * tg_yzz_xxxxxx_1[j];

                    tg_xyzz_xxxxxxy_0[j] = pb_x * tg_yzz_xxxxxxy_0[j] + wp_x[j] * tg_yzz_xxxxxxy_1[j] + 3.0 * fl1_fxn * tg_yzz_xxxxxy_1[j];

                    tg_xyzz_xxxxxxz_0[j] = pb_x * tg_yzz_xxxxxxz_0[j] + wp_x[j] * tg_yzz_xxxxxxz_1[j] + 3.0 * fl1_fxn * tg_yzz_xxxxxz_1[j];

                    tg_xyzz_xxxxxyy_0[j] = pb_x * tg_yzz_xxxxxyy_0[j] + wp_x[j] * tg_yzz_xxxxxyy_1[j] + 2.5 * fl1_fxn * tg_yzz_xxxxyy_1[j];

                    tg_xyzz_xxxxxyz_0[j] = pb_x * tg_yzz_xxxxxyz_0[j] + wp_x[j] * tg_yzz_xxxxxyz_1[j] + 2.5 * fl1_fxn * tg_yzz_xxxxyz_1[j];

                    tg_xyzz_xxxxxzz_0[j] = pb_x * tg_yzz_xxxxxzz_0[j] + wp_x[j] * tg_yzz_xxxxxzz_1[j] + 2.5 * fl1_fxn * tg_yzz_xxxxzz_1[j];

                    tg_xyzz_xxxxyyy_0[j] = pb_x * tg_yzz_xxxxyyy_0[j] + wp_x[j] * tg_yzz_xxxxyyy_1[j] + 2.0 * fl1_fxn * tg_yzz_xxxyyy_1[j];
                }
    ...
    void
    compElectronRepulsionForSGSK_295_344(      CMemBlock2D<double>& primBuffer,
                                         const CRecursionMap&       recursionMap,
                                         const CMemBlock2D<double>& osFactors,
                                         const CMemBlock2D<double>& wpDistances,
                                         const CGtoPairsBlock&      braGtoPairsBlock,
                                         ...
                                         const int32_t              iContrPair)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, tg_xyzz_xxxxyyz_0, tg_xyzz_xxxxyzz_0, tg_xyzz_xxxxzzz_0, \
                                         tg_xyzz_xxxyyyy_0, tg_xyzz_xxxyyyz_0, tg_xyzz_xxxyyzz_0, tg_xyzz_xxxyzzz_0, \
                                         tg_xyzz_xxxzzzz_0, tg_xyzz_xxyyyyy_0, tg_xyzz_xxyyyyz_0, tg_xyzz_xxyyyzz_0, \
                                         tg_xyzz_xxyyzzz_0, tg_xyzz_xxyzzzz_0, tg_xyzz_xxzzzzz_0, tg_xyzz_xyyyyyy_0, \
                                         tg_xyzz_xyyyyyz_0, tg_xyzz_xyyyyzz_0, tg_xyzz_xyyyzzz_0, tg_xyzz_xyyzzzz_0, \
                                         tg_xyzz_xyzzzzz_0, tg_xyzz_xzzzzzz_0, tg_xyzz_yyyyyyy_0, tg_xyzz_yyyyyyz_0, \
                                         tg_xyzz_yyyyyzz_0, tg_xyzz_yyyyzzz_0, tg_xyzz_yyyzzzz_0, tg_xyzz_yyzzzzz_0, \
                                         tg_xyzz_yzzzzzz_0, tg_xyzz_zzzzzzz_0, tg_xzzz_xxxxxxx_0, tg_xzzz_xxxxxxy_0, \
                                         tg_xzzz_xxxxxxz_0, tg_xzzz_xxxxxyy_0, tg_xzzz_xxxxxyz_0, tg_xzzz_xxxxxzz_0, \
                                         tg_xzzz_xxxxyyy_0, tg_xzzz_xxxxyyz_0, tg_xzzz_xxxxyzz_0, tg_xzzz_xxxxzzz_0, \
                                         tg_xzzz_xxxyyyy_0, tg_xzzz_xxxyyyz_0, tg_xzzz_xxxyyzz_0, tg_xzzz_xxxyzzz_0, \
                                         tg_xzzz_xxxzzzz_0, tg_xzzz_xxyyyyy_0, tg_xzzz_xxyyyyz_0, tg_xzzz_xxyyyzz_0, \
                                         tg_xzzz_xxyyzzz_0, tg_xzzz_xxyzzzz_0, tg_yzz_xxxxyyz_0, tg_yzz_xxxxyyz_1, \
                                         ...
                                         tg_zzz_xyyyyy_1, tg_zzz_xyyyyz_1, tg_zzz_xyyyzz_1, tg_zzz_xyyzzz_1, tg_zzz_xyzzzz_1, \
                                         wp_x: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fxn = fxn[j];

                    tg_xyzz_xxxxyyz_0[j] = pb_x * tg_yzz_xxxxyyz_0[j] + wp_x[j] * tg_yzz_xxxxyyz_1[j] + 2.0 * fl1_fxn * tg_yzz_xxxyyz_1[j];

                    tg_xyzz_xxxxyzz_0[j] = pb_x * tg_yzz_xxxxyzz_0[j] + wp_x[j] * tg_yzz_xxxxyzz_1[j] + 2.0 * fl1_fxn * tg_yzz_xxxyzz_1[j];

                    tg_xyzz_xxxxzzz_0[j] = pb_x * tg_yzz_xxxxzzz_0[j] + wp_x[j] * tg_yzz_xxxxzzz_1[j] + 2.0 * fl1_fxn * tg_yzz_xxxzzz_1[j];

                    tg_xyzz_xxxyyyy_0[j] = pb_x * tg_yzz_xxxyyyy_0[j] + wp_x[j] * tg_yzz_xxxyyyy_1[j] + 1.5 * fl1_fxn * tg_yzz_xxyyyy_1[j];

                    tg_xyzz_xxxyyyz_0[j] = pb_x * tg_yzz_xxxyyyz_0[j] + wp_x[j] * tg_yzz_xxxyyyz_1[j] + 1.5 * fl1_fxn * tg_yzz_xxyyyz_1[j];

                    tg_xyzz_xxxyyzz_0[j] = pb_x * tg_yzz_xxxyyzz_0[j] + wp_x[j] * tg_yzz_xxxyyzz_1[j] + 1.5 * fl1_fxn * tg_yzz_xxyyzz_1[j];

                    tg_xyzz_xxxyzzz_0[j] = pb_x * tg_yzz_xxxyzzz_0[j] + wp_x[j] * tg_yzz_xxxyzzz_1[j] + 1.5 * fl1_fxn * tg_yzz_xxyzzz_1[j];

                    tg_xyzz_xxxzzzz_0[j] = pb_x * tg_yzz_xxxzzzz_0[j] + wp_x[j] * tg_yzz_xxxzzzz_1[j] + 1.5 * fl1_fxn * tg_yzz_xxzzzz_1[j];

                    tg_xyzz_xxyyyyy_0[j] = pb_x * tg_yzz_xxyyyyy_0[j] + wp_x[j] * tg_yzz_xxyyyyy_1[j] + fl1_fxn * tg_yzz_xyyyyy_1[j];

                    tg_xyzz_xxyyyyz_0[j] = pb_x * tg_yzz_xxyyyyz_0[j] + wp_x[j] * tg_yzz_xxyyyyz_1[j] + fl1_fxn * tg_yzz_xyyyyz_1[j];

                    tg_xyzz_xxyyyzz_0[j] = pb_x * tg_yzz_xxyyyzz_0[j] + wp_x[j] * tg_yzz_xxyyyzz_1[j] + fl1_fxn * tg_yzz_xyyyzz_1[j];

                    tg_xyzz_xxyyzzz_0[j] = pb_x * tg_yzz_xxyyzzz_0[j] + wp_x[j] * tg_yzz_xxyyzzz_1[j] + fl1_fxn * tg_yzz_xyyzzz_1[j];

                    tg_xyzz_xxyzzzz_0[j] = pb_x * tg_yzz_xxyzzzz_0[j] + wp_x[j] * tg_yzz_xxyzzzz_1[j] + fl1_fxn * tg_yzz_xyzzzz_1[j];

                    tg_xyzz_xxzzzzz_0[j] = pb_x * tg_yzz_xxzzzzz_0[j] + wp_x[j] * tg_yzz_xxzzzzz_1[j] + fl1_fxn * tg_yzz_xzzzzz_1[j];

                    tg_xyzz_xyyyyyy_0[j] = pb_x * tg_yzz_xyyyyyy_0[j] + wp_x[j] * tg_yzz_xyyyyyy_1[j] + 0.5 * fl1_fxn * tg_yzz_yyyyyy_1[j];

                    tg_xyzz_xyyyyyz_0[j] = pb_x * tg_yzz_xyyyyyz_0[j] + wp_x[j] * tg_yzz_xyyyyyz_1[j] + 0.5 * fl1_fxn * tg_yzz_yyyyyz_1[j];

                    tg_xyzz_xyyyyzz_0[j] = pb_x * tg_yzz_xyyyyzz_0[j] + wp_x[j] * tg_yzz_xyyyyzz_1[j] + 0.5 * fl1_fxn * tg_yzz_yyyyzz_1[j];

                    tg_xyzz_xyyyzzz_0[j] = pb_x * tg_yzz_xyyyzzz_0[j] + wp_x[j] * tg_yzz_xyyyzzz_1[j] + 0.5 * fl1_fxn * tg_yzz_yyyzzz_1[j];

                    tg_xyzz_xyyzzzz_0[j] = pb_x * tg_yzz_xyyzzzz_0[j] + wp_x[j] * tg_yzz_xyyzzzz_1[j] + 0.5 * fl1_fxn * tg_yzz_yyzzzz_1[j];

                    tg_xyzz_xyzzzzz_0[j] = pb_x * tg_yzz_xyzzzzz_0[j] + wp_x[j] * tg_yzz_xyzzzzz_1[j] + 0.5 * fl1_fxn * tg_yzz_yzzzzz_1[j];

                    tg_xyzz_xzzzzzz_0[j] = pb_x * tg_yzz_xzzzzzz_0[j] + wp_x[j] * tg_yzz_xzzzzzz_1[j] + 0.5 * fl1_fxn * tg_yzz_zzzzzz_1[j];

                    tg_xyzz_yyyyyyy_0[j] = pb_x * tg_yzz_yyyyyyy_0[j] + wp_x[j] * tg_yzz_yyyyyyy_1[j];

                    tg_xyzz_yyyyyyz_0[j] = pb_x * tg_yzz_yyyyyyz_0[j] + wp_x[j] * tg_yzz_yyyyyyz_1[j];

                    tg_xyzz_yyyyyzz_0[j] = pb_x * tg_yzz_yyyyyzz_0[j] + wp_x[j] * tg_yzz_yyyyyzz_1[j];

                    tg_xyzz_yyyyzzz_0[j] = pb_x * tg_yzz_yyyyzzz_0[j] + wp_x[j] * tg_yzz_yyyyzzz_1[j];

                    tg_xyzz_yyyzzzz_0[j] = pb_x * tg_yzz_yyyzzzz_0[j] + wp_x[j] * tg_yzz_yyyzzzz_1[j];

                    tg_xyzz_yyzzzzz_0[j] = pb_x * tg_yzz_yyzzzzz_0[j] + wp_x[j] * tg_yzz_yyzzzzz_1[j];

                    tg_xyzz_yzzzzzz_0[j] = pb_x * tg_yzz_yzzzzzz_0[j] + wp_x[j] * tg_yzz_yzzzzzz_1[j];

                    tg_xyzz_zzzzzzz_0[j] = pb_x * tg_yzz_zzzzzzz_0[j] + wp_x[j] * tg_yzz_zzzzzzz_1[j];

                    tg_xzzz_xxxxxxx_0[j] = pb_x * tg_zzz_xxxxxxx_0[j] + wp_x[j] * tg_zzz_xxxxxxx_1[j] + 3.5 * fl1_fxn * tg_zzz_xxxxxx_1[j];

                    tg_xzzz_xxxxxxy_0[j] = pb_x * tg_zzz_xxxxxxy_0[j] + wp_x[j] * tg_zzz_xxxxxxy_1[j] + 3.0 * fl1_fxn * tg_zzz_xxxxxy_1[j];

                    tg_xzzz_xxxxxxz_0[j] = pb_x * tg_zzz_xxxxxxz_0[j] + wp_x[j] * tg_zzz_xxxxxxz_1[j] + 3.0 * fl1_fxn * tg_zzz_xxxxxz_1[j];

                    tg_xzzz_xxxxxyy_0[j] = pb_x * tg_zzz_xxxxxyy_0[j] + wp_x[j] * tg_zzz_xxxxxyy_1[j] + 2.5 * fl1_fxn * tg_zzz_xxxxyy_1[j];

                    tg_xzzz_xxxxxyz_0[j] = pb_x * tg_zzz_xxxxxyz_0[j] + wp_x[j] * tg_zzz_xxxxxyz_1[j] + 2.5 * fl1_fxn * tg_zzz_xxxxyz_1[j];

                    tg_xzzz_xxxxxzz_0[j] = pb_x * tg_zzz_xxxxxzz_0[j] + wp_x[j] * tg_zzz_xxxxxzz_1[j] + 2.5 * fl1_fxn * tg_zzz_xxxxzz_1[j];

                    tg_xzzz_xxxxyyy_0[j] = pb_x * tg_zzz_xxxxyyy_0[j] + wp_x[j] * tg_zzz_xxxxyyy_1[j] + 2.0 * fl1_fxn * tg_zzz_xxxyyy_1[j];

                    tg_xzzz_xxxxyyz_0[j] = pb_x * tg_zzz_xxxxyyz_0[j] + wp_x[j] * tg_zzz_xxxxyyz_1[j] + 2.0 * fl1_fxn * tg_zzz_xxxyyz_1[j];

                    tg_xzzz_xxxxyzz_0[j] = pb_x * tg_zzz_xxxxyzz_0[j] + wp_x[j] * tg_zzz_xxxxyzz_1[j] + 2.0 * fl1_fxn * tg_zzz_xxxyzz_1[j];

                    tg_xzzz_xxxxzzz_0[j] = pb_x * tg_zzz_xxxxzzz_0[j] + wp_x[j] * tg_zzz_xxxxzzz_1[j] + 2.0 * fl1_fxn * tg_zzz_xxxzzz_1[j];

                    tg_xzzz_xxxyyyy_0[j] = pb_x * tg_zzz_xxxyyyy_0[j] + wp_x[j] * tg_zzz_xxxyyyy_1[j] + 1.5 * fl1_fxn * tg_zzz_xxyyyy_1[j];

                    tg_xzzz_xxxyyyz_0[j] = pb_x * tg_zzz_xxxyyyz_0[j] + wp_x[j] * tg_zzz_xxxyyyz_1[j] + 1.5 * fl1_fxn * tg_zzz_xxyyyz_1[j];

                    tg_xzzz_xxxyyzz_0[j] = pb_x * tg_zzz_xxxyyzz_0[j] + wp_x[j] * tg_zzz_xxxyyzz_1[j] + 1.5 * fl1_fxn * tg_zzz_xxyyzz_1[j];

                    tg_xzzz_xxxyzzz_0[j] = pb_x * tg_zzz_xxxyzzz_0[j] + wp_x[j] * tg_zzz_xxxyzzz_1[j] + 1.5 * fl1_fxn * tg_zzz_xxyzzz_1[j];

                    tg_xzzz_xxxzzzz_0[j] = pb_x * tg_zzz_xxxzzzz_0[j] + wp_x[j] * tg_zzz_xxxzzzz_1[j] + 1.5 * fl1_fxn * tg_zzz_xxzzzz_1[j];

                    tg_xzzz_xxyyyyy_0[j] = pb_x * tg_zzz_xxyyyyy_0[j] + wp_x[j] * tg_zzz_xxyyyyy_1[j] + fl1_fxn * tg_zzz_xyyyyy_1[j];

                    tg_xzzz_xxyyyyz_0[j] = pb_x * tg_zzz_xxyyyyz_0[j] + wp_x[j] * tg_zzz_xxyyyyz_1[j] + fl1_fxn * tg_zzz_xyyyyz_1[j];

                    tg_xzzz_xxyyyzz_0[j] = pb_x * tg_zzz_xxyyyzz_0[j] + wp_x[j] * tg_zzz_xxyyyzz_1[j] + fl1_fxn * tg_zzz_xyyyzz_1[j];

                    tg_xzzz_xxyyzzz_0[j] = pb_x * tg_zzz_xxyyzzz_0[j] + wp_x[j] * tg_zzz_xxyyzzz_1[j] + fl1_fxn * tg_zzz_xyyzzz_1[j];

                    tg_xzzz_xxyzzzz_0[j] = pb_x * tg_zzz_xxyzzzz_0[j] + wp_x[j] * tg_zzz_xxyzzzz_1[j] + fl1_fxn * tg_zzz_xyzzzz_1[j];
                }
    ...
    void
    compElectronRepulsionForSGSK_344_393(      CMemBlock2D<double>& primBuffer,
                                         const CRecursionMap&       recursionMap,
                                         const CMemBlock2D<double>& osFactors,
                                         const CMemBlock2D<double>& wpDistances,
                                         const CGtoPairsBlock&      braGtoPairsBlock,
                                         ...
                                         const int32_t              iContrPair)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, fza, tg_xzzz_xxzzzzz_0, tg_xzzz_xyyyyyy_0, tg_xzzz_xyyyyyz_0, \
                                         tg_xzzz_xyyyyzz_0, tg_xzzz_xyyyzzz_0, tg_xzzz_xyyzzzz_0, tg_xzzz_xyzzzzz_0, \
                                         tg_xzzz_xzzzzzz_0, tg_xzzz_yyyyyyy_0, tg_xzzz_yyyyyyz_0, tg_xzzz_yyyyyzz_0, \
                                         tg_xzzz_yyyyzzz_0, tg_xzzz_yyyzzzz_0, tg_xzzz_yyzzzzz_0, tg_xzzz_yzzzzzz_0, \
                                         tg_xzzz_zzzzzzz_0, tg_yy_xxxxxxx_0, tg_yy_xxxxxxx_1, tg_yy_xxxxxxy_0, tg_yy_xxxxxxy_1, \
                                         tg_yy_xxxxxxz_0, tg_yy_xxxxxxz_1, tg_yy_xxxxxyy_0, tg_yy_xxxxxyy_1, tg_yy_xxxxxyz_0, \
                                         tg_yy_xxxxxyz_1, tg_yy_xxxxxzz_0, tg_yy_xxxxxzz_1, tg_yy_xxxxyyy_0, tg_yy_xxxxyyy_1, \
                                         tg_yy_xxxxyyz_0, tg_yy_xxxxyyz_1, tg_yy_xxxxyzz_0, tg_yy_xxxxyzz_1, tg_yy_xxxxzzz_0, \
                                         tg_yy_xxxxzzz_1, tg_yy_xxxyyyy_0, tg_yy_xxxyyyy_1, tg_yy_xxxyyyz_0, tg_yy_xxxyyyz_1, \
                                         tg_yy_xxxyyzz_0, tg_yy_xxxyyzz_1, tg_yy_xxxyzzz_0, tg_yy_xxxyzzz_1, tg_yy_xxxzzzz_0, \
                                         tg_yy_xxxzzzz_1, tg_yy_xxyyyyy_0, tg_yy_xxyyyyy_1, tg_yy_xxyyyyz_0, tg_yy_xxyyyyz_1, \
                                         tg_yy_xxyyyzz_0, tg_yy_xxyyyzz_1, tg_yy_xxyyzzz_0, tg_yy_xxyyzzz_1, tg_yy_xxyzzzz_0, \
                                         tg_yy_xxyzzzz_1, tg_yy_xxzzzzz_0, tg_yy_xxzzzzz_1, tg_yy_xyyyyyy_0, tg_yy_xyyyyyy_1, \
                                         tg_yy_xyyyyyz_0, tg_yy_xyyyyyz_1, tg_yy_xyyyyzz_0, tg_yy_xyyyyzz_1, tg_yy_xyyyzzz_0, \
                                         tg_yy_xyyyzzz_1, tg_yy_xyyzzzz_0, tg_yy_xyyzzzz_1, tg_yy_xyzzzzz_0, tg_yy_xyzzzzz_1, \
                                         tg_yy_xzzzzzz_0, tg_yy_xzzzzzz_1, tg_yy_yyyyyyy_0, tg_yy_yyyyyyy_1, tg_yy_yyyyyyz_0, \
                                         tg_yy_yyyyyyz_1, tg_yy_yyyyyzz_0, tg_yy_yyyyyzz_1, tg_yy_yyyyzzz_0, tg_yy_yyyyzzz_1, \
                                         tg_yy_yyyzzzz_0, tg_yy_yyyzzzz_1, tg_yyy_xxxxxx_1, tg_yyy_xxxxxxx_0, \
                                         tg_yyy_xxxxxxx_1, tg_yyy_xxxxxxy_0, tg_yyy_xxxxxxy_1, tg_yyy_xxxxxxz_0, \
                                         tg_yyy_xxxxxxz_1, tg_yyy_xxxxxy_1, tg_yyy_xxxxxyy_0, tg_yyy_xxxxxyy_1, \
                                         tg_yyy_xxxxxyz_0, tg_yyy_xxxxxyz_1, tg_yyy_xxxxxz_1, tg_yyy_xxxxxzz_0, \
                                         tg_yyy_xxxxxzz_1, tg_yyy_xxxxyy_1, tg_yyy_xxxxyyy_0, tg_yyy_xxxxyyy_1, \
                                         tg_yyy_xxxxyyz_0, tg_yyy_xxxxyyz_1, tg_yyy_xxxxyz_1, tg_yyy_xxxxyzz_0, \
                                         tg_yyy_xxxxyzz_1, tg_yyy_xxxxzz_1, tg_yyy_xxxxzzz_0, tg_yyy_xxxxzzz_1, \
                                         tg_yyy_xxxyyy_1, tg_yyy_xxxyyyy_0, tg_yyy_xxxyyyy_1, tg_yyy_xxxyyyz_0, \
                                         tg_yyy_xxxyyyz_1, tg_yyy_xxxyyz_1, tg_yyy_xxxyyzz_0, tg_yyy_xxxyyzz_1, \
                                         tg_yyy_xxxyzz_1, tg_yyy_xxxyzzz_0, tg_yyy_xxxyzzz_1, tg_yyy_xxxzzz_1, \
                                         tg_yyy_xxxzzzz_0, tg_yyy_xxxzzzz_1, tg_yyy_xxyyyy_1, tg_yyy_xxyyyyy_0, \
                                         tg_yyy_xxyyyyy_1, tg_yyy_xxyyyyz_0, tg_yyy_xxyyyyz_1, tg_yyy_xxyyyz_1, \
                                         tg_yyy_xxyyyzz_0, tg_yyy_xxyyyzz_1, tg_yyy_xxyyzz_1, tg_yyy_xxyyzzz_0, \
                                         tg_yyy_xxyyzzz_1, tg_yyy_xxyzzz_1, tg_yyy_xxyzzzz_0, tg_yyy_xxyzzzz_1, \
                                         tg_yyy_xxzzzz_1, tg_yyy_xxzzzzz_0, tg_yyy_xxzzzzz_1, tg_yyy_xyyyyy_1, \
                                         tg_yyy_xyyyyyy_0, tg_yyy_xyyyyyy_1, tg_yyy_xyyyyyz_0, tg_yyy_xyyyyyz_1, \
                                         tg_yyy_xyyyyz_1, tg_yyy_xyyyyzz_0, tg_yyy_xyyyyzz_1, tg_yyy_xyyyzz_1, \
                                         tg_yyy_xyyyzzz_0, tg_yyy_xyyyzzz_1, tg_yyy_xyyzzz_1, tg_yyy_xyyzzzz_0, \
                                         tg_yyy_xyyzzzz_1, tg_yyy_xyzzzz_1, tg_yyy_xyzzzzz_0, tg_yyy_xyzzzzz_1, \
                                         tg_yyy_xzzzzz_1, tg_yyy_xzzzzzz_0, tg_yyy_xzzzzzz_1, tg_yyy_yyyyyy_1, \
                                         tg_yyy_yyyyyyy_0, tg_yyy_yyyyyyy_1, tg_yyy_yyyyyyz_0, tg_yyy_yyyyyyz_1, \
                                         tg_yyy_yyyyyz_1, tg_yyy_yyyyyzz_0, tg_yyy_yyyyyzz_1, tg_yyy_yyyyzz_1, \
                                         tg_yyy_yyyyzzz_0, tg_yyy_yyyyzzz_1, tg_yyy_yyyzzz_1, tg_yyy_yyyzzzz_0, \
                                         tg_yyy_yyyzzzz_1, tg_yyy_yyzzzz_1, tg_yyyy_xxxxxxx_0, tg_yyyy_xxxxxxy_0, \
                                         tg_yyyy_xxxxxxz_0, tg_yyyy_xxxxxyy_0, tg_yyyy_xxxxxyz_0, tg_yyyy_xxxxxzz_0, \
                                         tg_yyyy_xxxxyyy_0, tg_yyyy_xxxxyyz_0, tg_yyyy_xxxxyzz_0, tg_yyyy_xxxxzzz_0, \
                                         tg_yyyy_xxxyyyy_0, tg_yyyy_xxxyyyz_0, tg_yyyy_xxxyyzz_0, tg_yyyy_xxxyzzz_0, \
                                         tg_yyyy_xxxzzzz_0, tg_yyyy_xxyyyyy_0, tg_yyyy_xxyyyyz_0, tg_yyyy_xxyyyzz_0, \
                                         tg_yyyy_xxyyzzz_0, tg_yyyy_xxyzzzz_0, tg_yyyy_xxzzzzz_0, tg_yyyy_xyyyyyy_0, \
                                         tg_yyyy_xyyyyyz_0, tg_yyyy_xyyyyzz_0, tg_yyyy_xyyyzzz_0, tg_yyyy_xyyzzzz_0, \
                                         tg_yyyy_xyzzzzz_0, tg_yyyy_xzzzzzz_0, tg_yyyy_yyyyyyy_0, tg_yyyy_yyyyyyz_0, \
                                         tg_yyyy_yyyyyzz_0, tg_yyyy_yyyyzzz_0, tg_yyyy_yyyzzzz_0, tg_zzz_xxzzzzz_0, \
                                         tg_zzz_xxzzzzz_1, tg_zzz_xyyyyyy_0, tg_zzz_xyyyyyy_1, tg_zzz_xyyyyyz_0, \
                                         tg_zzz_xyyyyyz_1, tg_zzz_xyyyyzz_0, tg_zzz_xyyyyzz_1, tg_zzz_xyyyzzz_0, \
                                         tg_zzz_xyyyzzz_1, tg_zzz_xyyzzzz_0, tg_zzz_xyyzzzz_1, tg_zzz_xyzzzzz_0, \
                                         tg_zzz_xyzzzzz_1, tg_zzz_xzzzzz_1, tg_zzz_xzzzzzz_0, tg_zzz_xzzzzzz_1, \
                                         tg_zzz_yyyyyy_1, tg_zzz_yyyyyyy_0, tg_zzz_yyyyyyy_1, tg_zzz_yyyyyyz_0, \
                                         tg_zzz_yyyyyyz_1, tg_zzz_yyyyyz_1, tg_zzz_yyyyyzz_0, tg_zzz_yyyyyzz_1, \
                                         tg_zzz_yyyyzz_1, tg_zzz_yyyyzzz_0, tg_zzz_yyyyzzz_1, tg_zzz_yyyzzz_1, \
                                         tg_zzz_yyyzzzz_0, tg_zzz_yyyzzzz_1, tg_zzz_yyzzzz_1, tg_zzz_yyzzzzz_0, \
                                         tg_zzz_yyzzzzz_1, tg_zzz_yzzzzz_1, tg_zzz_yzzzzzz_0, tg_zzz_yzzzzzz_1, \
                                         tg_zzz_zzzzzz_1, tg_zzz_zzzzzzz_0, tg_zzz_zzzzzzz_1, wp_x, wp_y: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fx = fx;
                    ...
                    tg_xzzz_xxzzzzz_0[j] = pb_x * tg_zzz_xxzzzzz_0[j] + wp_x[j] * tg_zzz_xxzzzzz_1[j] + fl1_fxn * tg_zzz_xzzzzz_1[j];

                    tg_xzzz_xyyyyyy_0[j] = pb_x * tg_zzz_xyyyyyy_0[j] + wp_x[j] * tg_zzz_xyyyyyy_1[j] + 0.5 * fl1_fxn * tg_zzz_yyyyyy_1[j];

                    tg_xzzz_xyyyyyz_0[j] = pb_x * tg_zzz_xyyyyyz_0[j] + wp_x[j] * tg_zzz_xyyyyyz_1[j] + 0.5 * fl1_fxn * tg_zzz_yyyyyz_1[j];

                    tg_xzzz_xyyyyzz_0[j] = pb_x * tg_zzz_xyyyyzz_0[j] + wp_x[j] * tg_zzz_xyyyyzz_1[j] + 0.5 * fl1_fxn * tg_zzz_yyyyzz_1[j];

                    tg_xzzz_xyyyzzz_0[j] = pb_x * tg_zzz_xyyyzzz_0[j] + wp_x[j] * tg_zzz_xyyyzzz_1[j] + 0.5 * fl1_fxn * tg_zzz_yyyzzz_1[j];

                    tg_xzzz_xyyzzzz_0[j] = pb_x * tg_zzz_xyyzzzz_0[j] + wp_x[j] * tg_zzz_xyyzzzz_1[j] + 0.5 * fl1_fxn * tg_zzz_yyzzzz_1[j];

                    tg_xzzz_xyzzzzz_0[j] = pb_x * tg_zzz_xyzzzzz_0[j] + wp_x[j] * tg_zzz_xyzzzzz_1[j] + 0.5 * fl1_fxn * tg_zzz_yzzzzz_1[j];

                    tg_xzzz_xzzzzzz_0[j] = pb_x * tg_zzz_xzzzzzz_0[j] + wp_x[j] * tg_zzz_xzzzzzz_1[j] + 0.5 * fl1_fxn * tg_zzz_zzzzzz_1[j];

                    tg_xzzz_yyyyyyy_0[j] = pb_x * tg_zzz_yyyyyyy_0[j] + wp_x[j] * tg_zzz_yyyyyyy_1[j];

                    tg_xzzz_yyyyyyz_0[j] = pb_x * tg_zzz_yyyyyyz_0[j] + wp_x[j] * tg_zzz_yyyyyyz_1[j];

                    tg_xzzz_yyyyyzz_0[j] = pb_x * tg_zzz_yyyyyzz_0[j] + wp_x[j] * tg_zzz_yyyyyzz_1[j];

                    tg_xzzz_yyyyzzz_0[j] = pb_x * tg_zzz_yyyyzzz_0[j] + wp_x[j] * tg_zzz_yyyyzzz_1[j];

                    tg_xzzz_yyyzzzz_0[j] = pb_x * tg_zzz_yyyzzzz_0[j] + wp_x[j] * tg_zzz_yyyzzzz_1[j];

                    tg_xzzz_yyzzzzz_0[j] = pb_x * tg_zzz_yyzzzzz_0[j] + wp_x[j] * tg_zzz_yyzzzzz_1[j];

                    tg_xzzz_yzzzzzz_0[j] = pb_x * tg_zzz_yzzzzzz_0[j] + wp_x[j] * tg_zzz_yzzzzzz_1[j];

                    tg_xzzz_zzzzzzz_0[j] = pb_x * tg_zzz_zzzzzzz_0[j] + wp_x[j] * tg_zzz_zzzzzzz_1[j];

                    tg_yyyy_xxxxxxx_0[j] = pb_y * tg_yyy_xxxxxxx_0[j] + wp_y[j] * tg_yyy_xxxxxxx_1[j] + 1.5 * fl1_fx * tg_yy_xxxxxxx_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xxxxxxx_1[j];

                    tg_yyyy_xxxxxxy_0[j] = pb_y * tg_yyy_xxxxxxy_0[j] + wp_y[j] * tg_yyy_xxxxxxy_1[j] + 1.5 * fl1_fx * tg_yy_xxxxxxy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xxxxxxy_1[j] + 0.5 * fl1_fxn * tg_yyy_xxxxxx_1[j];

                    tg_yyyy_xxxxxxz_0[j] = pb_y * tg_yyy_xxxxxxz_0[j] + wp_y[j] * tg_yyy_xxxxxxz_1[j] + 1.5 * fl1_fx * tg_yy_xxxxxxz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xxxxxxz_1[j];

                    tg_yyyy_xxxxxyy_0[j] = pb_y * tg_yyy_xxxxxyy_0[j] + wp_y[j] * tg_yyy_xxxxxyy_1[j] + 1.5 * fl1_fx * tg_yy_xxxxxyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xxxxxyy_1[j] + fl1_fxn * tg_yyy_xxxxxy_1[j];

                    tg_yyyy_xxxxxyz_0[j] = pb_y * tg_yyy_xxxxxyz_0[j] + wp_y[j] * tg_yyy_xxxxxyz_1[j] + 1.5 * fl1_fx * tg_yy_xxxxxyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xxxxxyz_1[j] + 0.5 * fl1_fxn * tg_yyy_xxxxxz_1[j];

                    tg_yyyy_xxxxxzz_0[j] = pb_y * tg_yyy_xxxxxzz_0[j] + wp_y[j] * tg_yyy_xxxxxzz_1[j] + 1.5 * fl1_fx * tg_yy_xxxxxzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xxxxxzz_1[j];

                    tg_yyyy_xxxxyyy_0[j] = pb_y * tg_yyy_xxxxyyy_0[j] + wp_y[j] * tg_yyy_xxxxyyy_1[j] + 1.5 * fl1_fx * tg_yy_xxxxyyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xxxxyyy_1[j] + 1.5 * fl1_fxn * tg_yyy_xxxxyy_1[j];

                    tg_yyyy_xxxxyyz_0[j] = pb_y * tg_yyy_xxxxyyz_0[j] + wp_y[j] * tg_yyy_xxxxyyz_1[j] + 1.5 * fl1_fx * tg_yy_xxxxyyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xxxxyyz_1[j] + fl1_fxn * tg_yyy_xxxxyz_1[j];

                    tg_yyyy_xxxxyzz_0[j] = pb_y * tg_yyy_xxxxyzz_0[j] + wp_y[j] * tg_yyy_xxxxyzz_1[j] + 1.5 * fl1_fx * tg_yy_xxxxyzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xxxxyzz_1[j] + 0.5 * fl1_fxn * tg_yyy_xxxxzz_1[j];

                    tg_yyyy_xxxxzzz_0[j] = pb_y * tg_yyy_xxxxzzz_0[j] + wp_y[j] * tg_yyy_xxxxzzz_1[j] + 1.5 * fl1_fx * tg_yy_xxxxzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xxxxzzz_1[j];

                    tg_yyyy_xxxyyyy_0[j] = pb_y * tg_yyy_xxxyyyy_0[j] + wp_y[j] * tg_yyy_xxxyyyy_1[j] + 1.5 * fl1_fx * tg_yy_xxxyyyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xxxyyyy_1[j] + 2.0 * fl1_fxn * tg_yyy_xxxyyy_1[j];

                    tg_yyyy_xxxyyyz_0[j] = pb_y * tg_yyy_xxxyyyz_0[j] + wp_y[j] * tg_yyy_xxxyyyz_1[j] + 1.5 * fl1_fx * tg_yy_xxxyyyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xxxyyyz_1[j] + 1.5 * fl1_fxn * tg_yyy_xxxyyz_1[j];

                    tg_yyyy_xxxyyzz_0[j] = pb_y * tg_yyy_xxxyyzz_0[j] + wp_y[j] * tg_yyy_xxxyyzz_1[j] + 1.5 * fl1_fx * tg_yy_xxxyyzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xxxyyzz_1[j] + fl1_fxn * tg_yyy_xxxyzz_1[j];

                    tg_yyyy_xxxyzzz_0[j] = pb_y * tg_yyy_xxxyzzz_0[j] + wp_y[j] * tg_yyy_xxxyzzz_1[j] + 1.5 * fl1_fx * tg_yy_xxxyzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xxxyzzz_1[j] + 0.5 * fl1_fxn * tg_yyy_xxxzzz_1[j];

                    tg_yyyy_xxxzzzz_0[j] = pb_y * tg_yyy_xxxzzzz_0[j] + wp_y[j] * tg_yyy_xxxzzzz_1[j] + 1.5 * fl1_fx * tg_yy_xxxzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xxxzzzz_1[j];

                    tg_yyyy_xxyyyyy_0[j] = pb_y * tg_yyy_xxyyyyy_0[j] + wp_y[j] * tg_yyy_xxyyyyy_1[j] + 1.5 * fl1_fx * tg_yy_xxyyyyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xxyyyyy_1[j] + 2.5 * fl1_fxn * tg_yyy_xxyyyy_1[j];

                    tg_yyyy_xxyyyyz_0[j] = pb_y * tg_yyy_xxyyyyz_0[j] + wp_y[j] * tg_yyy_xxyyyyz_1[j] + 1.5 * fl1_fx * tg_yy_xxyyyyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xxyyyyz_1[j] + 2.0 * fl1_fxn * tg_yyy_xxyyyz_1[j];

                    tg_yyyy_xxyyyzz_0[j] = pb_y * tg_yyy_xxyyyzz_0[j] + wp_y[j] * tg_yyy_xxyyyzz_1[j] + 1.5 * fl1_fx * tg_yy_xxyyyzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xxyyyzz_1[j] + 1.5 * fl1_fxn * tg_yyy_xxyyzz_1[j];

                    tg_yyyy_xxyyzzz_0[j] = pb_y * tg_yyy_xxyyzzz_0[j] + wp_y[j] * tg_yyy_xxyyzzz_1[j] + 1.5 * fl1_fx * tg_yy_xxyyzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xxyyzzz_1[j] + fl1_fxn * tg_yyy_xxyzzz_1[j];

                    tg_yyyy_xxyzzzz_0[j] = pb_y * tg_yyy_xxyzzzz_0[j] + wp_y[j] * tg_yyy_xxyzzzz_1[j] + 1.5 * fl1_fx * tg_yy_xxyzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xxyzzzz_1[j] + 0.5 * fl1_fxn * tg_yyy_xxzzzz_1[j];

                    tg_yyyy_xxzzzzz_0[j] = pb_y * tg_yyy_xxzzzzz_0[j] + wp_y[j] * tg_yyy_xxzzzzz_1[j] + 1.5 * fl1_fx * tg_yy_xxzzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xxzzzzz_1[j];

                    tg_yyyy_xyyyyyy_0[j] = pb_y * tg_yyy_xyyyyyy_0[j] + wp_y[j] * tg_yyy_xyyyyyy_1[j] + 1.5 * fl1_fx * tg_yy_xyyyyyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xyyyyyy_1[j] + 3.0 * fl1_fxn * tg_yyy_xyyyyy_1[j];

                    tg_yyyy_xyyyyyz_0[j] = pb_y * tg_yyy_xyyyyyz_0[j] + wp_y[j] * tg_yyy_xyyyyyz_1[j] + 1.5 * fl1_fx * tg_yy_xyyyyyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xyyyyyz_1[j] + 2.5 * fl1_fxn * tg_yyy_xyyyyz_1[j];

                    tg_yyyy_xyyyyzz_0[j] = pb_y * tg_yyy_xyyyyzz_0[j] + wp_y[j] * tg_yyy_xyyyyzz_1[j] + 1.5 * fl1_fx * tg_yy_xyyyyzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xyyyyzz_1[j] + 2.0 * fl1_fxn * tg_yyy_xyyyzz_1[j];

                    tg_yyyy_xyyyzzz_0[j] = pb_y * tg_yyy_xyyyzzz_0[j] + wp_y[j] * tg_yyy_xyyyzzz_1[j] + 1.5 * fl1_fx * tg_yy_xyyyzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xyyyzzz_1[j] + 1.5 * fl1_fxn * tg_yyy_xyyzzz_1[j];

                    tg_yyyy_xyyzzzz_0[j] = pb_y * tg_yyy_xyyzzzz_0[j] + wp_y[j] * tg_yyy_xyyzzzz_1[j] + 1.5 * fl1_fx * tg_yy_xyyzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xyyzzzz_1[j] + fl1_fxn * tg_yyy_xyzzzz_1[j];

                    tg_yyyy_xyzzzzz_0[j] = pb_y * tg_yyy_xyzzzzz_0[j] + wp_y[j] * tg_yyy_xyzzzzz_1[j] + 1.5 * fl1_fx * tg_yy_xyzzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xyzzzzz_1[j] + 0.5 * fl1_fxn * tg_yyy_xzzzzz_1[j];

                    tg_yyyy_xzzzzzz_0[j] = pb_y * tg_yyy_xzzzzzz_0[j] + wp_y[j] * tg_yyy_xzzzzzz_1[j] + 1.5 * fl1_fx * tg_yy_xzzzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_xzzzzzz_1[j];

                    tg_yyyy_yyyyyyy_0[j] = pb_y * tg_yyy_yyyyyyy_0[j] + wp_y[j] * tg_yyy_yyyyyyy_1[j] + 1.5 * fl1_fx * tg_yy_yyyyyyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_yyyyyyy_1[j] + 3.5 * fl1_fxn * tg_yyy_yyyyyy_1[j];

                    tg_yyyy_yyyyyyz_0[j] = pb_y * tg_yyy_yyyyyyz_0[j] + wp_y[j] * tg_yyy_yyyyyyz_1[j] + 1.5 * fl1_fx * tg_yy_yyyyyyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_yyyyyyz_1[j] + 3.0 * fl1_fxn * tg_yyy_yyyyyz_1[j];

                    tg_yyyy_yyyyyzz_0[j] = pb_y * tg_yyy_yyyyyzz_0[j] + wp_y[j] * tg_yyy_yyyyyzz_1[j] + 1.5 * fl1_fx * tg_yy_yyyyyzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_yyyyyzz_1[j] + 2.5 * fl1_fxn * tg_yyy_yyyyzz_1[j];

                    tg_yyyy_yyyyzzz_0[j] = pb_y * tg_yyy_yyyyzzz_0[j] + wp_y[j] * tg_yyy_yyyyzzz_1[j] + 1.5 * fl1_fx * tg_yy_yyyyzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_yyyyzzz_1[j] + 2.0 * fl1_fxn * tg_yyy_yyyzzz_1[j];

                    tg_yyyy_yyyzzzz_0[j] = pb_y * tg_yyy_yyyzzzz_0[j] + wp_y[j] * tg_yyy_yyyzzzz_1[j] + 1.5 * fl1_fx * tg_yy_yyyzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_yyyzzzz_1[j] + 1.5 * fl1_fxn * tg_yyy_yyzzzz_1[j];
                }
    ...
    void
    compElectronRepulsionForSGSK_393_442(      CMemBlock2D<double>& primBuffer,
                                         const CRecursionMap&       recursionMap,
                                         const CMemBlock2D<double>& osFactors,
                                         const CMemBlock2D<double>& wpDistances,
                                         const CGtoPairsBlock&      braGtoPairsBlock,
                                         ...
                                         const int32_t              iContrPair)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, fza, tg_yy_yyzzzzz_0, tg_yy_yyzzzzz_1, tg_yy_yzzzzzz_0, \
                                         tg_yy_yzzzzzz_1, tg_yy_zzzzzzz_0, tg_yy_zzzzzzz_1, tg_yyy_yyzzzzz_0, \
                                         tg_yyy_yyzzzzz_1, tg_yyy_yzzzzz_1, tg_yyy_yzzzzzz_0, tg_yyy_yzzzzzz_1, \
                                         tg_yyy_zzzzzz_1, tg_yyy_zzzzzzz_0, tg_yyy_zzzzzzz_1, tg_yyyy_yyzzzzz_0, \
                                         tg_yyyy_yzzzzzz_0, tg_yyyy_zzzzzzz_0, tg_yyyz_xxxxxxx_0, tg_yyyz_xxxxxxy_0, \
                                         tg_yyyz_xxxxxxz_0, tg_yyyz_xxxxxyy_0, tg_yyyz_xxxxxyz_0, tg_yyyz_xxxxxzz_0, \
                                         tg_yyyz_xxxxyyy_0, tg_yyyz_xxxxyyz_0, tg_yyyz_xxxxyzz_0, tg_yyyz_xxxxzzz_0, \
                                         tg_yyyz_xxxyyyy_0, tg_yyyz_xxxyyyz_0, tg_yyyz_xxxyyzz_0, tg_yyyz_xxxyzzz_0, \
                                         tg_yyyz_xxxzzzz_0, tg_yyyz_xxyyyyy_0, tg_yyyz_xxyyyyz_0, tg_yyyz_xxyyyzz_0, \
                                         tg_yyyz_xxyyzzz_0, tg_yyyz_xxyzzzz_0, tg_yyyz_xxzzzzz_0, tg_yyyz_xyyyyyy_0, \
                                         tg_yyyz_xyyyyyz_0, tg_yyyz_xyyyyzz_0, tg_yyyz_xyyyzzz_0, tg_yyyz_xyyzzzz_0, \
                                         tg_yyyz_xyzzzzz_0, tg_yyyz_xzzzzzz_0, tg_yyyz_yyyyyyy_0, tg_yyyz_yyyyyyz_0, \
                                         tg_yyyz_yyyyyzz_0, tg_yyyz_yyyyzzz_0, tg_yyyz_yyyzzzz_0, tg_yyyz_yyzzzzz_0, \
                                         tg_yyyz_yzzzzzz_0, tg_yyyz_zzzzzzz_0, tg_yyz_xxxxxx_1, tg_yyz_xxxxxxx_0, \
                                         tg_yyz_xxxxxxx_1, tg_yyz_xxxxxxy_0, tg_yyz_xxxxxxy_1, tg_yyz_xxxxxxz_0, \
                                         tg_yyz_xxxxxxz_1, tg_yyz_xxxxxy_1, tg_yyz_xxxxxyy_0, tg_yyz_xxxxxyy_1, \
                                         tg_yyz_xxxxxyz_0, tg_yyz_xxxxxyz_1, tg_yyz_xxxxxz_1, tg_yyz_xxxxxzz_0, \
                                         tg_yyz_xxxxxzz_1, tg_yyz_xxxxyy_1, tg_yyz_xxxxyyy_0, tg_yyz_xxxxyyy_1, \
                                         ...
                                         tg_yyz_yyyzzzz_1, tg_yyz_yyzzzz_1, tg_yyz_yyzzzzz_0, tg_yyz_yyzzzzz_1, \
                                         tg_yyz_yzzzzz_1, tg_yyz_yzzzzzz_0, tg_yyz_yzzzzzz_1, tg_yyz_zzzzzz_1, \
                                         tg_yyz_zzzzzzz_0, tg_yyz_zzzzzzz_1, tg_yyzz_xxxxxxx_0, tg_yyzz_xxxxxxy_0, \
                                         tg_yyzz_xxxxxxz_0, tg_yyzz_xxxxxyy_0, tg_yyzz_xxxxxyz_0, tg_yyzz_xxxxxzz_0, \
                                         tg_yyzz_xxxxyyy_0, tg_yyzz_xxxxyyz_0, tg_yyzz_xxxxyzz_0, tg_yyzz_xxxxzzz_0, \
                                         tg_yz_xxxxxxx_0, tg_yz_xxxxxxx_1, tg_yz_xxxxxxy_0, tg_yz_xxxxxxy_1, tg_yz_xxxxxxz_0, \
                                         tg_yz_xxxxxxz_1, tg_yz_xxxxxyy_0, tg_yz_xxxxxyy_1, tg_yz_xxxxxyz_0, tg_yz_xxxxxyz_1, \
                                         tg_yz_xxxxxzz_0, tg_yz_xxxxxzz_1, tg_yz_xxxxyyy_0, tg_yz_xxxxyyy_1, tg_yz_xxxxyyz_0, \
                                         tg_yz_xxxxyyz_1, tg_yz_xxxxyzz_0, tg_yz_xxxxyzz_1, tg_yz_xxxxzzz_0, tg_yz_xxxxzzz_1, \
                                         tg_yz_xxxyyyy_0, tg_yz_xxxyyyy_1, tg_yz_xxxyyyz_0, tg_yz_xxxyyyz_1, tg_yz_xxxyyzz_0, \
                                         tg_yz_xxxyyzz_1, tg_yz_xxxyzzz_0, tg_yz_xxxyzzz_1, tg_yz_xxxzzzz_0, tg_yz_xxxzzzz_1, \
                                         tg_yz_xxyyyyy_0, tg_yz_xxyyyyy_1, tg_yz_xxyyyyz_0, tg_yz_xxyyyyz_1, tg_yz_xxyyyzz_0, \
                                         tg_yz_xxyyyzz_1, tg_yz_xxyyzzz_0, tg_yz_xxyyzzz_1, tg_yz_xxyzzzz_0, tg_yz_xxyzzzz_1, \
                                         tg_yz_xxzzzzz_0, tg_yz_xxzzzzz_1, tg_yz_xyyyyyy_0, tg_yz_xyyyyyy_1, tg_yz_xyyyyyz_0, \
                                         tg_yz_xyyyyyz_1, tg_yz_xyyyyzz_0, tg_yz_xyyyyzz_1, tg_yz_xyyyzzz_0, tg_yz_xyyyzzz_1, \
                                         tg_yz_xyyzzzz_0, tg_yz_xyyzzzz_1, tg_yz_xyzzzzz_0, tg_yz_xyzzzzz_1, tg_yz_xzzzzzz_0, \
                                         tg_yz_xzzzzzz_1, tg_yz_yyyyyyy_0, tg_yz_yyyyyyy_1, tg_yz_yyyyyyz_0, tg_yz_yyyyyyz_1, \
                                         tg_yz_yyyyyzz_0, tg_yz_yyyyyzz_1, tg_yz_yyyyzzz_0, tg_yz_yyyyzzz_1, tg_yz_yyyzzzz_0, \
                                         tg_yz_yyyzzzz_1, tg_yz_yyzzzzz_0, tg_yz_yyzzzzz_1, tg_yz_yzzzzzz_0, tg_yz_yzzzzzz_1, \
                                         tg_yz_zzzzzzz_0, tg_yz_zzzzzzz_1, tg_yzz_xxxxxx_1, tg_yzz_xxxxxxx_0, \
                                         tg_yzz_xxxxxxx_1, tg_yzz_xxxxxxy_0, tg_yzz_xxxxxxy_1, tg_yzz_xxxxxxz_0, \
                                         tg_yzz_xxxxxxz_1, tg_yzz_xxxxxy_1, tg_yzz_xxxxxyy_0, tg_yzz_xxxxxyy_1, \
                                         tg_yzz_xxxxxyz_0, tg_yzz_xxxxxyz_1, tg_yzz_xxxxxz_1, tg_yzz_xxxxxzz_0, \
                                         tg_yzz_xxxxxzz_1, tg_yzz_xxxxyy_1, tg_yzz_xxxxyyy_0, tg_yzz_xxxxyyy_1, \
                                         tg_yzz_xxxxyyz_0, tg_yzz_xxxxyyz_1, tg_yzz_xxxxyz_1, tg_yzz_xxxxyzz_0, \
                                         tg_yzz_xxxxyzz_1, tg_yzz_xxxxzz_1, tg_yzz_xxxxzzz_0, tg_yzz_xxxxzzz_1, \
                ...
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    ...
                    tg_yyyy_yyzzzzz_0[j] = pb_y * tg_yyy_yyzzzzz_0[j] + wp_y[j] * tg_yyy_yyzzzzz_1[j] + 1.5 * fl1_fx * tg_yy_yyzzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_yyzzzzz_1[j] + fl1_fxn * tg_yyy_yzzzzz_1[j];

                    tg_yyyy_yzzzzzz_0[j] = pb_y * tg_yyy_yzzzzzz_0[j] + wp_y[j] * tg_yyy_yzzzzzz_1[j] + 1.5 * fl1_fx * tg_yy_yzzzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_yzzzzzz_1[j] + 0.5 * fl1_fxn * tg_yyy_zzzzzz_1[j];

                    tg_yyyy_zzzzzzz_0[j] = pb_y * tg_yyy_zzzzzzz_0[j] + wp_y[j] * tg_yyy_zzzzzzz_1[j] + 1.5 * fl1_fx * tg_yy_zzzzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_yy_zzzzzzz_1[j];

                    tg_yyyz_xxxxxxx_0[j] = pb_y * tg_yyz_xxxxxxx_0[j] + wp_y[j] * tg_yyz_xxxxxxx_1[j] + fl1_fx * tg_yz_xxxxxxx_0[j] - fl1_fx * fl1_fza * tg_yz_xxxxxxx_1[j];

                    tg_yyyz_xxxxxxy_0[j] = pb_y * tg_yyz_xxxxxxy_0[j] + wp_y[j] * tg_yyz_xxxxxxy_1[j] + fl1_fx * tg_yz_xxxxxxy_0[j] - fl1_fx * fl1_fza * tg_yz_xxxxxxy_1[j] + 0.5 * fl1_fxn * tg_yyz_xxxxxx_1[j];

                    tg_yyyz_xxxxxxz_0[j] = pb_y * tg_yyz_xxxxxxz_0[j] + wp_y[j] * tg_yyz_xxxxxxz_1[j] + fl1_fx * tg_yz_xxxxxxz_0[j] - fl1_fx * fl1_fza * tg_yz_xxxxxxz_1[j];

                    tg_yyyz_xxxxxyy_0[j] = pb_y * tg_yyz_xxxxxyy_0[j] + wp_y[j] * tg_yyz_xxxxxyy_1[j] + fl1_fx * tg_yz_xxxxxyy_0[j] - fl1_fx * fl1_fza * tg_yz_xxxxxyy_1[j] + fl1_fxn * tg_yyz_xxxxxy_1[j];

                    tg_yyyz_xxxxxyz_0[j] = pb_y * tg_yyz_xxxxxyz_0[j] + wp_y[j] * tg_yyz_xxxxxyz_1[j] + fl1_fx * tg_yz_xxxxxyz_0[j] - fl1_fx * fl1_fza * tg_yz_xxxxxyz_1[j] + 0.5 * fl1_fxn * tg_yyz_xxxxxz_1[j];

                    tg_yyyz_xxxxxzz_0[j] = pb_y * tg_yyz_xxxxxzz_0[j] + wp_y[j] * tg_yyz_xxxxxzz_1[j] + fl1_fx * tg_yz_xxxxxzz_0[j] - fl1_fx * fl1_fza * tg_yz_xxxxxzz_1[j];

                    tg_yyyz_xxxxyyy_0[j] = pb_y * tg_yyz_xxxxyyy_0[j] + wp_y[j] * tg_yyz_xxxxyyy_1[j] + fl1_fx * tg_yz_xxxxyyy_0[j] - fl1_fx * fl1_fza * tg_yz_xxxxyyy_1[j] + 1.5 * fl1_fxn * tg_yyz_xxxxyy_1[j];

                    tg_yyyz_xxxxyyz_0[j] = pb_y * tg_yyz_xxxxyyz_0[j] + wp_y[j] * tg_yyz_xxxxyyz_1[j] + fl1_fx * tg_yz_xxxxyyz_0[j] - fl1_fx * fl1_fza * tg_yz_xxxxyyz_1[j] + fl1_fxn * tg_yyz_xxxxyz_1[j];

                    tg_yyyz_xxxxyzz_0[j] = pb_y * tg_yyz_xxxxyzz_0[j] + wp_y[j] * tg_yyz_xxxxyzz_1[j] + fl1_fx * tg_yz_xxxxyzz_0[j] - fl1_fx * fl1_fza * tg_yz_xxxxyzz_1[j] + 0.5 * fl1_fxn * tg_yyz_xxxxzz_1[j];

                    tg_yyyz_xxxxzzz_0[j] = pb_y * tg_yyz_xxxxzzz_0[j] + wp_y[j] * tg_yyz_xxxxzzz_1[j] + fl1_fx * tg_yz_xxxxzzz_0[j] - fl1_fx * fl1_fza * tg_yz_xxxxzzz_1[j];

                    tg_yyyz_xxxyyyy_0[j] = pb_y * tg_yyz_xxxyyyy_0[j] + wp_y[j] * tg_yyz_xxxyyyy_1[j] + fl1_fx * tg_yz_xxxyyyy_0[j] - fl1_fx * fl1_fza * tg_yz_xxxyyyy_1[j] + 2.0 * fl1_fxn * tg_yyz_xxxyyy_1[j];

                    tg_yyyz_xxxyyyz_0[j] = pb_y * tg_yyz_xxxyyyz_0[j] + wp_y[j] * tg_yyz_xxxyyyz_1[j] + fl1_fx * tg_yz_xxxyyyz_0[j] - fl1_fx * fl1_fza * tg_yz_xxxyyyz_1[j] + 1.5 * fl1_fxn * tg_yyz_xxxyyz_1[j];

                    tg_yyyz_xxxyyzz_0[j] = pb_y * tg_yyz_xxxyyzz_0[j] + wp_y[j] * tg_yyz_xxxyyzz_1[j] + fl1_fx * tg_yz_xxxyyzz_0[j] - fl1_fx * fl1_fza * tg_yz_xxxyyzz_1[j] + fl1_fxn * tg_yyz_xxxyzz_1[j];

                    tg_yyyz_xxxyzzz_0[j] = pb_y * tg_yyz_xxxyzzz_0[j] + wp_y[j] * tg_yyz_xxxyzzz_1[j] + fl1_fx * tg_yz_xxxyzzz_0[j] - fl1_fx * fl1_fza * tg_yz_xxxyzzz_1[j] + 0.5 * fl1_fxn * tg_yyz_xxxzzz_1[j];

                    tg_yyyz_xxxzzzz_0[j] = pb_y * tg_yyz_xxxzzzz_0[j] + wp_y[j] * tg_yyz_xxxzzzz_1[j] + fl1_fx * tg_yz_xxxzzzz_0[j] - fl1_fx * fl1_fza * tg_yz_xxxzzzz_1[j];

                    tg_yyyz_xxyyyyy_0[j] = pb_y * tg_yyz_xxyyyyy_0[j] + wp_y[j] * tg_yyz_xxyyyyy_1[j] + fl1_fx * tg_yz_xxyyyyy_0[j] - fl1_fx * fl1_fza * tg_yz_xxyyyyy_1[j] + 2.5 * fl1_fxn * tg_yyz_xxyyyy_1[j];

                    tg_yyyz_xxyyyyz_0[j] = pb_y * tg_yyz_xxyyyyz_0[j] + wp_y[j] * tg_yyz_xxyyyyz_1[j] + fl1_fx * tg_yz_xxyyyyz_0[j] - fl1_fx * fl1_fza * tg_yz_xxyyyyz_1[j] + 2.0 * fl1_fxn * tg_yyz_xxyyyz_1[j];

                    tg_yyyz_xxyyyzz_0[j] = pb_y * tg_yyz_xxyyyzz_0[j] + wp_y[j] * tg_yyz_xxyyyzz_1[j] + fl1_fx * tg_yz_xxyyyzz_0[j] - fl1_fx * fl1_fza * tg_yz_xxyyyzz_1[j] + 1.5 * fl1_fxn * tg_yyz_xxyyzz_1[j];

                    tg_yyyz_xxyyzzz_0[j] = pb_y * tg_yyz_xxyyzzz_0[j] + wp_y[j] * tg_yyz_xxyyzzz_1[j] + fl1_fx * tg_yz_xxyyzzz_0[j] - fl1_fx * fl1_fza * tg_yz_xxyyzzz_1[j] + fl1_fxn * tg_yyz_xxyzzz_1[j];

                    tg_yyyz_xxyzzzz_0[j] = pb_y * tg_yyz_xxyzzzz_0[j] + wp_y[j] * tg_yyz_xxyzzzz_1[j] + fl1_fx * tg_yz_xxyzzzz_0[j] - fl1_fx * fl1_fza * tg_yz_xxyzzzz_1[j] + 0.5 * fl1_fxn * tg_yyz_xxzzzz_1[j];

                    tg_yyyz_xxzzzzz_0[j] = pb_y * tg_yyz_xxzzzzz_0[j] + wp_y[j] * tg_yyz_xxzzzzz_1[j] + fl1_fx * tg_yz_xxzzzzz_0[j] - fl1_fx * fl1_fza * tg_yz_xxzzzzz_1[j];

                    tg_yyyz_xyyyyyy_0[j] = pb_y * tg_yyz_xyyyyyy_0[j] + wp_y[j] * tg_yyz_xyyyyyy_1[j] + fl1_fx * tg_yz_xyyyyyy_0[j] - fl1_fx * fl1_fza * tg_yz_xyyyyyy_1[j] + 3.0 * fl1_fxn * tg_yyz_xyyyyy_1[j];

                    tg_yyyz_xyyyyyz_0[j] = pb_y * tg_yyz_xyyyyyz_0[j] + wp_y[j] * tg_yyz_xyyyyyz_1[j] + fl1_fx * tg_yz_xyyyyyz_0[j] - fl1_fx * fl1_fza * tg_yz_xyyyyyz_1[j] + 2.5 * fl1_fxn * tg_yyz_xyyyyz_1[j];

                    tg_yyyz_xyyyyzz_0[j] = pb_y * tg_yyz_xyyyyzz_0[j] + wp_y[j] * tg_yyz_xyyyyzz_1[j] + fl1_fx * tg_yz_xyyyyzz_0[j] - fl1_fx * fl1_fza * tg_yz_xyyyyzz_1[j] + 2.0 * fl1_fxn * tg_yyz_xyyyzz_1[j];

                    tg_yyyz_xyyyzzz_0[j] = pb_y * tg_yyz_xyyyzzz_0[j] + wp_y[j] * tg_yyz_xyyyzzz_1[j] + fl1_fx * tg_yz_xyyyzzz_0[j] - fl1_fx * fl1_fza * tg_yz_xyyyzzz_1[j] + 1.5 * fl1_fxn * tg_yyz_xyyzzz_1[j];

                    tg_yyyz_xyyzzzz_0[j] = pb_y * tg_yyz_xyyzzzz_0[j] + wp_y[j] * tg_yyz_xyyzzzz_1[j] + fl1_fx * tg_yz_xyyzzzz_0[j] - fl1_fx * fl1_fza * tg_yz_xyyzzzz_1[j] + fl1_fxn * tg_yyz_xyzzzz_1[j];

                    tg_yyyz_xyzzzzz_0[j] = pb_y * tg_yyz_xyzzzzz_0[j] + wp_y[j] * tg_yyz_xyzzzzz_1[j] + fl1_fx * tg_yz_xyzzzzz_0[j] - fl1_fx * fl1_fza * tg_yz_xyzzzzz_1[j] + 0.5 * fl1_fxn * tg_yyz_xzzzzz_1[j];

                    tg_yyyz_xzzzzzz_0[j] = pb_y * tg_yyz_xzzzzzz_0[j] + wp_y[j] * tg_yyz_xzzzzzz_1[j] + fl1_fx * tg_yz_xzzzzzz_0[j] - fl1_fx * fl1_fza * tg_yz_xzzzzzz_1[j];

                    tg_yyyz_yyyyyyy_0[j] = pb_y * tg_yyz_yyyyyyy_0[j] + wp_y[j] * tg_yyz_yyyyyyy_1[j] + fl1_fx * tg_yz_yyyyyyy_0[j] - fl1_fx * fl1_fza * tg_yz_yyyyyyy_1[j] + 3.5 * fl1_fxn * tg_yyz_yyyyyy_1[j];

                    tg_yyyz_yyyyyyz_0[j] = pb_y * tg_yyz_yyyyyyz_0[j] + wp_y[j] * tg_yyz_yyyyyyz_1[j] + fl1_fx * tg_yz_yyyyyyz_0[j] - fl1_fx * fl1_fza * tg_yz_yyyyyyz_1[j] + 3.0 * fl1_fxn * tg_yyz_yyyyyz_1[j];

                    tg_yyyz_yyyyyzz_0[j] = pb_y * tg_yyz_yyyyyzz_0[j] + wp_y[j] * tg_yyz_yyyyyzz_1[j] + fl1_fx * tg_yz_yyyyyzz_0[j] - fl1_fx * fl1_fza * tg_yz_yyyyyzz_1[j] + 2.5 * fl1_fxn * tg_yyz_yyyyzz_1[j];

                    tg_yyyz_yyyyzzz_0[j] = pb_y * tg_yyz_yyyyzzz_0[j] + wp_y[j] * tg_yyz_yyyyzzz_1[j] + fl1_fx * tg_yz_yyyyzzz_0[j] - fl1_fx * fl1_fza * tg_yz_yyyyzzz_1[j] + 2.0 * fl1_fxn * tg_yyz_yyyzzz_1[j];

                    tg_yyyz_yyyzzzz_0[j] = pb_y * tg_yyz_yyyzzzz_0[j] + wp_y[j] * tg_yyz_yyyzzzz_1[j] + fl1_fx * tg_yz_yyyzzzz_0[j] - fl1_fx * fl1_fza * tg_yz_yyyzzzz_1[j] + 1.5 * fl1_fxn * tg_yyz_yyzzzz_1[j];

                    tg_yyyz_yyzzzzz_0[j] = pb_y * tg_yyz_yyzzzzz_0[j] + wp_y[j] * tg_yyz_yyzzzzz_1[j] + fl1_fx * tg_yz_yyzzzzz_0[j] - fl1_fx * fl1_fza * tg_yz_yyzzzzz_1[j] + fl1_fxn * tg_yyz_yzzzzz_1[j];

                    tg_yyyz_yzzzzzz_0[j] = pb_y * tg_yyz_yzzzzzz_0[j] + wp_y[j] * tg_yyz_yzzzzzz_1[j] + fl1_fx * tg_yz_yzzzzzz_0[j] - fl1_fx * fl1_fza * tg_yz_yzzzzzz_1[j] + 0.5 * fl1_fxn * tg_yyz_zzzzzz_1[j];

                    tg_yyyz_zzzzzzz_0[j] = pb_y * tg_yyz_zzzzzzz_0[j] + wp_y[j] * tg_yyz_zzzzzzz_1[j] + fl1_fx * tg_yz_zzzzzzz_0[j] - fl1_fx * fl1_fza * tg_yz_zzzzzzz_1[j];

                    tg_yyzz_xxxxxxx_0[j] = pb_y * tg_yzz_xxxxxxx_0[j] + wp_y[j] * tg_yzz_xxxxxxx_1[j] + 0.5 * fl1_fx * tg_zz_xxxxxxx_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxxxxx_1[j];

                    tg_yyzz_xxxxxxy_0[j] = pb_y * tg_yzz_xxxxxxy_0[j] + wp_y[j] * tg_yzz_xxxxxxy_1[j] + 0.5 * fl1_fx * tg_zz_xxxxxxy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxxxxy_1[j] + 0.5 * fl1_fxn * tg_yzz_xxxxxx_1[j];

                    tg_yyzz_xxxxxxz_0[j] = pb_y * tg_yzz_xxxxxxz_0[j] + wp_y[j] * tg_yzz_xxxxxxz_1[j] + 0.5 * fl1_fx * tg_zz_xxxxxxz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxxxxz_1[j];

                    tg_yyzz_xxxxxyy_0[j] = pb_y * tg_yzz_xxxxxyy_0[j] + wp_y[j] * tg_yzz_xxxxxyy_1[j] + 0.5 * fl1_fx * tg_zz_xxxxxyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxxxyy_1[j] + fl1_fxn * tg_yzz_xxxxxy_1[j];

                    tg_yyzz_xxxxxyz_0[j] = pb_y * tg_yzz_xxxxxyz_0[j] + wp_y[j] * tg_yzz_xxxxxyz_1[j] + 0.5 * fl1_fx * tg_zz_xxxxxyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxxxyz_1[j] + 0.5 * fl1_fxn * tg_yzz_xxxxxz_1[j];

                    tg_yyzz_xxxxxzz_0[j] = pb_y * tg_yzz_xxxxxzz_0[j] + wp_y[j] * tg_yzz_xxxxxzz_1[j] + 0.5 * fl1_fx * tg_zz_xxxxxzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxxxzz_1[j];

                    tg_yyzz_xxxxyyy_0[j] = pb_y * tg_yzz_xxxxyyy_0[j] + wp_y[j] * tg_yzz_xxxxyyy_1[j] + 0.5 * fl1_fx * tg_zz_xxxxyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxxyyy_1[j] + 1.5 * fl1_fxn * tg_yzz_xxxxyy_1[j];

                    tg_yyzz_xxxxyyz_0[j] = pb_y * tg_yzz_xxxxyyz_0[j] + wp_y[j] * tg_yzz_xxxxyyz_1[j] + 0.5 * fl1_fx * tg_zz_xxxxyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxxyyz_1[j] + fl1_fxn * tg_yzz_xxxxyz_1[j];

                    tg_yyzz_xxxxyzz_0[j] = pb_y * tg_yzz_xxxxyzz_0[j] + wp_y[j] * tg_yzz_xxxxyzz_1[j] + 0.5 * fl1_fx * tg_zz_xxxxyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxxyzz_1[j] + 0.5 * fl1_fxn * tg_yzz_xxxxzz_1[j];

                    tg_yyzz_xxxxzzz_0[j] = pb_y * tg_yzz_xxxxzzz_0[j] + wp_y[j] * tg_yzz_xxxxzzz_1[j] + 0.5 * fl1_fx * tg_zz_xxxxzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxxzzz_1[j];
                }
    ...
    void
    compElectronRepulsionForSGSK_442_491(      CMemBlock2D<double>& primBuffer,
                                         const CRecursionMap&       recursionMap,
                                         const CMemBlock2D<double>& osFactors,
                                         const CMemBlock2D<double>& wpDistances,
                                         const CGtoPairsBlock&      braGtoPairsBlock,
                                         ...
                                         const int32_t              iContrPair)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, fza, tg_yyzz_xxxyyyy_0, tg_yyzz_xxxyyyz_0, tg_yyzz_xxxyyzz_0, \
                                         tg_yyzz_xxxyzzz_0, tg_yyzz_xxxzzzz_0, tg_yyzz_xxyyyyy_0, tg_yyzz_xxyyyyz_0, \
                                         tg_yyzz_xxyyyzz_0, tg_yyzz_xxyyzzz_0, tg_yyzz_xxyzzzz_0, tg_yyzz_xxzzzzz_0, \
                                         ...
                                         tg_yyzz_yyzzzzz_0, tg_yyzz_yzzzzzz_0, tg_yyzz_zzzzzzz_0, tg_yzz_xxxyyy_1, \
                                         tg_yzz_xxxyyyy_0, tg_yzz_xxxyyyy_1, tg_yzz_xxxyyyz_0, tg_yzz_xxxyyyz_1, \
                                         tg_yzz_xxxyyz_1, tg_yzz_xxxyyzz_0, tg_yzz_xxxyyzz_1, tg_yzz_xxxyzz_1, \
                                         tg_yzz_xxxyzzz_0, tg_yzz_xxxyzzz_1, tg_yzz_xxxzzz_1, tg_yzz_xxxzzzz_0, \
                                         tg_yzz_xxxzzzz_1, tg_yzz_xxyyyy_1, tg_yzz_xxyyyyy_0, tg_yzz_xxyyyyy_1, \
                                         ...
                                         tg_yzz_yyzzzz_1, tg_yzz_yyzzzzz_0, tg_yzz_yyzzzzz_1, tg_yzz_yzzzzz_1, \
                                         tg_yzz_yzzzzzz_0, tg_yzz_yzzzzzz_1, tg_yzz_zzzzzz_1, tg_yzz_zzzzzzz_0, \
                                         tg_yzz_zzzzzzz_1, tg_yzzz_xxxxxxx_0, tg_yzzz_xxxxxxy_0, tg_yzzz_xxxxxxz_0, \
                                         tg_yzzz_xxxxxyy_0, tg_yzzz_xxxxxyz_0, tg_yzzz_xxxxxzz_0, tg_yzzz_xxxxyyy_0, \
                                         tg_yzzz_xxxxyyz_0, tg_yzzz_xxxxyzz_0, tg_yzzz_xxxxzzz_0, tg_yzzz_xxxyyyy_0, \
                                         tg_yzzz_xxxyyyz_0, tg_yzzz_xxxyyzz_0, tg_yzzz_xxxyzzz_0, tg_yzzz_xxxzzzz_0, \
                                         tg_yzzz_xxyyyyy_0, tg_yzzz_xxyyyyz_0, tg_yzzz_xxyyyzz_0, tg_yzzz_xxyyzzz_0, \
                                         tg_yzzz_xxyzzzz_0, tg_yzzz_xxzzzzz_0, tg_yzzz_xyyyyyy_0, tg_yzzz_xyyyyyz_0, \
                                         ...
                                         tg_zz_zzzzzzz_0, tg_zz_zzzzzzz_1, tg_zzz_xxxxxx_1, tg_zzz_xxxxxxx_0, \
                                         tg_zzz_xxxxxxx_1, tg_zzz_xxxxxxy_0, tg_zzz_xxxxxxy_1, tg_zzz_xxxxxxz_0, \
                                         tg_zzz_xxxxxxz_1, tg_zzz_xxxxxy_1, tg_zzz_xxxxxyy_0, tg_zzz_xxxxxyy_1, \
                                         tg_zzz_xxxxxyz_0, tg_zzz_xxxxxyz_1, tg_zzz_xxxxxz_1, tg_zzz_xxxxxzz_0, \
                                         tg_zzz_xxxxxzz_1, tg_zzz_xxxxyy_1, tg_zzz_xxxxyyy_0, tg_zzz_xxxxyyy_1, \
                                         tg_zzz_xxxxyyz_0, tg_zzz_xxxxyyz_1, tg_zzz_xxxxyz_1, tg_zzz_xxxxyzz_0, \
                                         tg_zzz_xxxxyzz_1, tg_zzz_xxxxzz_1, tg_zzz_xxxxzzz_0, tg_zzz_xxxxzzz_1, \
                                         tg_zzz_xxxyyy_1, tg_zzz_xxxyyyy_0, tg_zzz_xxxyyyy_1, tg_zzz_xxxyyyz_0, \
                                         tg_zzz_xxxyyyz_1, tg_zzz_xxxyyz_1, tg_zzz_xxxyyzz_0, tg_zzz_xxxyyzz_1, \
                                         tg_zzz_xxxyzz_1, tg_zzz_xxxyzzz_0, tg_zzz_xxxyzzz_1, tg_zzz_xxxzzz_1, \
                                         tg_zzz_xxxzzzz_0, tg_zzz_xxxzzzz_1, tg_zzz_xxyyyy_1, tg_zzz_xxyyyyy_0, \
                                         tg_zzz_xxyyyyy_1, tg_zzz_xxyyyyz_0, tg_zzz_xxyyyyz_1, tg_zzz_xxyyyz_1, \
                                         tg_zzz_xxyyyzz_0, tg_zzz_xxyyyzz_1, tg_zzz_xxyyzz_1, tg_zzz_xxyyzzz_0, \
                                         tg_zzz_xxyyzzz_1, tg_zzz_xxyzzz_1, tg_zzz_xxyzzzz_0, tg_zzz_xxyzzzz_1, \
                                         tg_zzz_xxzzzz_1, tg_zzz_xxzzzzz_0, tg_zzz_xxzzzzz_1, tg_zzz_xyyyyy_1, \
                                         tg_zzz_xyyyyyy_0, tg_zzz_xyyyyyy_1, tg_zzz_xyyyyyz_0, tg_zzz_xyyyyyz_1, \
                                         tg_zzz_xyyyyz_1, wp_y: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fx = fx;
                    ...
                    tg_yyzz_xxxyyyy_0[j] = pb_y * tg_yzz_xxxyyyy_0[j] + wp_y[j] * tg_yzz_xxxyyyy_1[j] + 0.5 * fl1_fx * tg_zz_xxxyyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxyyyy_1[j] + 2.0 * fl1_fxn * tg_yzz_xxxyyy_1[j];

                    tg_yyzz_xxxyyyz_0[j] = pb_y * tg_yzz_xxxyyyz_0[j] + wp_y[j] * tg_yzz_xxxyyyz_1[j] + 0.5 * fl1_fx * tg_zz_xxxyyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxyyyz_1[j] + 1.5 * fl1_fxn * tg_yzz_xxxyyz_1[j];

                    tg_yyzz_xxxyyzz_0[j] = pb_y * tg_yzz_xxxyyzz_0[j] + wp_y[j] * tg_yzz_xxxyyzz_1[j] + 0.5 * fl1_fx * tg_zz_xxxyyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxyyzz_1[j] + fl1_fxn * tg_yzz_xxxyzz_1[j];

                    tg_yyzz_xxxyzzz_0[j] = pb_y * tg_yzz_xxxyzzz_0[j] + wp_y[j] * tg_yzz_xxxyzzz_1[j] + 0.5 * fl1_fx * tg_zz_xxxyzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxyzzz_1[j] + 0.5 * fl1_fxn * tg_yzz_xxxzzz_1[j];

                    tg_yyzz_xxxzzzz_0[j] = pb_y * tg_yzz_xxxzzzz_0[j] + wp_y[j] * tg_yzz_xxxzzzz_1[j] + 0.5 * fl1_fx * tg_zz_xxxzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxxzzzz_1[j];

                    tg_yyzz_xxyyyyy_0[j] = pb_y * tg_yzz_xxyyyyy_0[j] + wp_y[j] * tg_yzz_xxyyyyy_1[j] + 0.5 * fl1_fx * tg_zz_xxyyyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxyyyyy_1[j] + 2.5 * fl1_fxn * tg_yzz_xxyyyy_1[j];

                    tg_yyzz_xxyyyyz_0[j] = pb_y * tg_yzz_xxyyyyz_0[j] + wp_y[j] * tg_yzz_xxyyyyz_1[j] + 0.5 * fl1_fx * tg_zz_xxyyyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxyyyyz_1[j] + 2.0 * fl1_fxn * tg_yzz_xxyyyz_1[j];

                    tg_yyzz_xxyyyzz_0[j] = pb_y * tg_yzz_xxyyyzz_0[j] + wp_y[j] * tg_yzz_xxyyyzz_1[j] + 0.5 * fl1_fx * tg_zz_xxyyyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxyyyzz_1[j] + 1.5 * fl1_fxn * tg_yzz_xxyyzz_1[j];

                    tg_yyzz_xxyyzzz_0[j] = pb_y * tg_yzz_xxyyzzz_0[j] + wp_y[j] * tg_yzz_xxyyzzz_1[j] + 0.5 * fl1_fx * tg_zz_xxyyzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxyyzzz_1[j] + fl1_fxn * tg_yzz_xxyzzz_1[j];

                    tg_yyzz_xxyzzzz_0[j] = pb_y * tg_yzz_xxyzzzz_0[j] + wp_y[j] * tg_yzz_xxyzzzz_1[j] + 0.5 * fl1_fx * tg_zz_xxyzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxyzzzz_1[j] + 0.5 * fl1_fxn * tg_yzz_xxzzzz_1[j];

                    tg_yyzz_xxzzzzz_0[j] = pb_y * tg_yzz_xxzzzzz_0[j] + wp_y[j] * tg_yzz_xxzzzzz_1[j] + 0.5 * fl1_fx * tg_zz_xxzzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xxzzzzz_1[j];

                    tg_yyzz_xyyyyyy_0[j] = pb_y * tg_yzz_xyyyyyy_0[j] + wp_y[j] * tg_yzz_xyyyyyy_1[j] + 0.5 * fl1_fx * tg_zz_xyyyyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xyyyyyy_1[j] + 3.0 * fl1_fxn * tg_yzz_xyyyyy_1[j];

                    tg_yyzz_xyyyyyz_0[j] = pb_y * tg_yzz_xyyyyyz_0[j] + wp_y[j] * tg_yzz_xyyyyyz_1[j] + 0.5 * fl1_fx * tg_zz_xyyyyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xyyyyyz_1[j] + 2.5 * fl1_fxn * tg_yzz_xyyyyz_1[j];

                    tg_yyzz_xyyyyzz_0[j] = pb_y * tg_yzz_xyyyyzz_0[j] + wp_y[j] * tg_yzz_xyyyyzz_1[j] + 0.5 * fl1_fx * tg_zz_xyyyyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xyyyyzz_1[j] + 2.0 * fl1_fxn * tg_yzz_xyyyzz_1[j];

                    tg_yyzz_xyyyzzz_0[j] = pb_y * tg_yzz_xyyyzzz_0[j] + wp_y[j] * tg_yzz_xyyyzzz_1[j] + 0.5 * fl1_fx * tg_zz_xyyyzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xyyyzzz_1[j] + 1.5 * fl1_fxn * tg_yzz_xyyzzz_1[j];

                    tg_yyzz_xyyzzzz_0[j] = pb_y * tg_yzz_xyyzzzz_0[j] + wp_y[j] * tg_yzz_xyyzzzz_1[j] + 0.5 * fl1_fx * tg_zz_xyyzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xyyzzzz_1[j] + fl1_fxn * tg_yzz_xyzzzz_1[j];

                    tg_yyzz_xyzzzzz_0[j] = pb_y * tg_yzz_xyzzzzz_0[j] + wp_y[j] * tg_yzz_xyzzzzz_1[j] + 0.5 * fl1_fx * tg_zz_xyzzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xyzzzzz_1[j] + 0.5 * fl1_fxn * tg_yzz_xzzzzz_1[j];

                    tg_yyzz_xzzzzzz_0[j] = pb_y * tg_yzz_xzzzzzz_0[j] + wp_y[j] * tg_yzz_xzzzzzz_1[j] + 0.5 * fl1_fx * tg_zz_xzzzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_xzzzzzz_1[j];

                    tg_yyzz_yyyyyyy_0[j] = pb_y * tg_yzz_yyyyyyy_0[j] + wp_y[j] * tg_yzz_yyyyyyy_1[j] + 0.5 * fl1_fx * tg_zz_yyyyyyy_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_yyyyyyy_1[j] + 3.5 * fl1_fxn * tg_yzz_yyyyyy_1[j];

                    tg_yyzz_yyyyyyz_0[j] = pb_y * tg_yzz_yyyyyyz_0[j] + wp_y[j] * tg_yzz_yyyyyyz_1[j] + 0.5 * fl1_fx * tg_zz_yyyyyyz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_yyyyyyz_1[j] + 3.0 * fl1_fxn * tg_yzz_yyyyyz_1[j];

                    tg_yyzz_yyyyyzz_0[j] = pb_y * tg_yzz_yyyyyzz_0[j] + wp_y[j] * tg_yzz_yyyyyzz_1[j] + 0.5 * fl1_fx * tg_zz_yyyyyzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_yyyyyzz_1[j] + 2.5 * fl1_fxn * tg_yzz_yyyyzz_1[j];

                    tg_yyzz_yyyyzzz_0[j] = pb_y * tg_yzz_yyyyzzz_0[j] + wp_y[j] * tg_yzz_yyyyzzz_1[j] + 0.5 * fl1_fx * tg_zz_yyyyzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_yyyyzzz_1[j] + 2.0 * fl1_fxn * tg_yzz_yyyzzz_1[j];

                    tg_yyzz_yyyzzzz_0[j] = pb_y * tg_yzz_yyyzzzz_0[j] + wp_y[j] * tg_yzz_yyyzzzz_1[j] + 0.5 * fl1_fx * tg_zz_yyyzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_yyyzzzz_1[j] + 1.5 * fl1_fxn * tg_yzz_yyzzzz_1[j];

                    tg_yyzz_yyzzzzz_0[j] = pb_y * tg_yzz_yyzzzzz_0[j] + wp_y[j] * tg_yzz_yyzzzzz_1[j] + 0.5 * fl1_fx * tg_zz_yyzzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_yyzzzzz_1[j] + fl1_fxn * tg_yzz_yzzzzz_1[j];

                    tg_yyzz_yzzzzzz_0[j] = pb_y * tg_yzz_yzzzzzz_0[j] + wp_y[j] * tg_yzz_yzzzzzz_1[j] + 0.5 * fl1_fx * tg_zz_yzzzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_yzzzzzz_1[j] + 0.5 * fl1_fxn * tg_yzz_zzzzzz_1[j];

                    tg_yyzz_zzzzzzz_0[j] = pb_y * tg_yzz_zzzzzzz_0[j] + wp_y[j] * tg_yzz_zzzzzzz_1[j] + 0.5 * fl1_fx * tg_zz_zzzzzzz_0[j] - 0.5 * fl1_fx * fl1_fza * tg_zz_zzzzzzz_1[j];

                    tg_yzzz_xxxxxxx_0[j] = pb_y * tg_zzz_xxxxxxx_0[j] + wp_y[j] * tg_zzz_xxxxxxx_1[j];

                    tg_yzzz_xxxxxxy_0[j] = pb_y * tg_zzz_xxxxxxy_0[j] + wp_y[j] * tg_zzz_xxxxxxy_1[j] + 0.5 * fl1_fxn * tg_zzz_xxxxxx_1[j];

                    tg_yzzz_xxxxxxz_0[j] = pb_y * tg_zzz_xxxxxxz_0[j] + wp_y[j] * tg_zzz_xxxxxxz_1[j];

                    tg_yzzz_xxxxxyy_0[j] = pb_y * tg_zzz_xxxxxyy_0[j] + wp_y[j] * tg_zzz_xxxxxyy_1[j] + fl1_fxn * tg_zzz_xxxxxy_1[j];

                    tg_yzzz_xxxxxyz_0[j] = pb_y * tg_zzz_xxxxxyz_0[j] + wp_y[j] * tg_zzz_xxxxxyz_1[j] + 0.5 * fl1_fxn * tg_zzz_xxxxxz_1[j];

                    tg_yzzz_xxxxxzz_0[j] = pb_y * tg_zzz_xxxxxzz_0[j] + wp_y[j] * tg_zzz_xxxxxzz_1[j];

                    tg_yzzz_xxxxyyy_0[j] = pb_y * tg_zzz_xxxxyyy_0[j] + wp_y[j] * tg_zzz_xxxxyyy_1[j] + 1.5 * fl1_fxn * tg_zzz_xxxxyy_1[j];

                    tg_yzzz_xxxxyyz_0[j] = pb_y * tg_zzz_xxxxyyz_0[j] + wp_y[j] * tg_zzz_xxxxyyz_1[j] + fl1_fxn * tg_zzz_xxxxyz_1[j];

                    tg_yzzz_xxxxyzz_0[j] = pb_y * tg_zzz_xxxxyzz_0[j] + wp_y[j] * tg_zzz_xxxxyzz_1[j] + 0.5 * fl1_fxn * tg_zzz_xxxxzz_1[j];

                    tg_yzzz_xxxxzzz_0[j] = pb_y * tg_zzz_xxxxzzz_0[j] + wp_y[j] * tg_zzz_xxxxzzz_1[j];

                    tg_yzzz_xxxyyyy_0[j] = pb_y * tg_zzz_xxxyyyy_0[j] + wp_y[j] * tg_zzz_xxxyyyy_1[j] + 2.0 * fl1_fxn * tg_zzz_xxxyyy_1[j];

                    tg_yzzz_xxxyyyz_0[j] = pb_y * tg_zzz_xxxyyyz_0[j] + wp_y[j] * tg_zzz_xxxyyyz_1[j] + 1.5 * fl1_fxn * tg_zzz_xxxyyz_1[j];

                    tg_yzzz_xxxyyzz_0[j] = pb_y * tg_zzz_xxxyyzz_0[j] + wp_y[j] * tg_zzz_xxxyyzz_1[j] + fl1_fxn * tg_zzz_xxxyzz_1[j];

                    tg_yzzz_xxxyzzz_0[j] = pb_y * tg_zzz_xxxyzzz_0[j] + wp_y[j] * tg_zzz_xxxyzzz_1[j] + 0.5 * fl1_fxn * tg_zzz_xxxzzz_1[j];

                    tg_yzzz_xxxzzzz_0[j] = pb_y * tg_zzz_xxxzzzz_0[j] + wp_y[j] * tg_zzz_xxxzzzz_1[j];

                    tg_yzzz_xxyyyyy_0[j] = pb_y * tg_zzz_xxyyyyy_0[j] + wp_y[j] * tg_zzz_xxyyyyy_1[j] + 2.5 * fl1_fxn * tg_zzz_xxyyyy_1[j];

                    tg_yzzz_xxyyyyz_0[j] = pb_y * tg_zzz_xxyyyyz_0[j] + wp_y[j] * tg_zzz_xxyyyyz_1[j] + 2.0 * fl1_fxn * tg_zzz_xxyyyz_1[j];

                    tg_yzzz_xxyyyzz_0[j] = pb_y * tg_zzz_xxyyyzz_0[j] + wp_y[j] * tg_zzz_xxyyyzz_1[j] + 1.5 * fl1_fxn * tg_zzz_xxyyzz_1[j];

                    tg_yzzz_xxyyzzz_0[j] = pb_y * tg_zzz_xxyyzzz_0[j] + wp_y[j] * tg_zzz_xxyyzzz_1[j] + fl1_fxn * tg_zzz_xxyzzz_1[j];

                    tg_yzzz_xxyzzzz_0[j] = pb_y * tg_zzz_xxyzzzz_0[j] + wp_y[j] * tg_zzz_xxyzzzz_1[j] + 0.5 * fl1_fxn * tg_zzz_xxzzzz_1[j];

                    tg_yzzz_xxzzzzz_0[j] = pb_y * tg_zzz_xxzzzzz_0[j] + wp_y[j] * tg_zzz_xxzzzzz_1[j];

                    tg_yzzz_xyyyyyy_0[j] = pb_y * tg_zzz_xyyyyyy_0[j] + wp_y[j] * tg_zzz_xyyyyyy_1[j] + 3.0 * fl1_fxn * tg_zzz_xyyyyy_1[j];

                    tg_yzzz_xyyyyyz_0[j] = pb_y * tg_zzz_xyyyyyz_0[j] + wp_y[j] * tg_zzz_xyyyyyz_1[j] + 2.5 * fl1_fxn * tg_zzz_xyyyyz_1[j];
                }
    ...
    void
    compElectronRepulsionForSGSK_491_540(      CMemBlock2D<double>& primBuffer,
                                         const CRecursionMap&       recursionMap,
                                         const CMemBlock2D<double>& osFactors,
                                         const CMemBlock2D<double>& wpDistances,
                                         const CGtoPairsBlock&      braGtoPairsBlock,
                                         ...
                                         const int32_t              iContrPair)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, fza, tg_yzzz_xyyyyzz_0, tg_yzzz_xyyyzzz_0, tg_yzzz_xyyzzzz_0, \
                ...
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    ...
                    tg_yzzz_xyyyyzz_0[j] = pb_y * tg_zzz_xyyyyzz_0[j] + wp_y[j] * tg_zzz_xyyyyzz_1[j] + 2.0 * fl1_fxn * tg_zzz_xyyyzz_1[j];

                    tg_yzzz_xyyyzzz_0[j] = pb_y * tg_zzz_xyyyzzz_0[j] + wp_y[j] * tg_zzz_xyyyzzz_1[j] + 1.5 * fl1_fxn * tg_zzz_xyyzzz_1[j];

                    tg_yzzz_xyyzzzz_0[j] = pb_y * tg_zzz_xyyzzzz_0[j] + wp_y[j] * tg_zzz_xyyzzzz_1[j] + fl1_fxn * tg_zzz_xyzzzz_1[j];

                    tg_yzzz_xyzzzzz_0[j] = pb_y * tg_zzz_xyzzzzz_0[j] + wp_y[j] * tg_zzz_xyzzzzz_1[j] + 0.5 * fl1_fxn * tg_zzz_xzzzzz_1[j];

                    tg_yzzz_xzzzzzz_0[j] = pb_y * tg_zzz_xzzzzzz_0[j] + wp_y[j] * tg_zzz_xzzzzzz_1[j];

                    tg_yzzz_yyyyyyy_0[j] = pb_y * tg_zzz_yyyyyyy_0[j] + wp_y[j] * tg_zzz_yyyyyyy_1[j] + 3.5 * fl1_fxn * tg_zzz_yyyyyy_1[j];

                    tg_yzzz_yyyyyyz_0[j] = pb_y * tg_zzz_yyyyyyz_0[j] + wp_y[j] * tg_zzz_yyyyyyz_1[j] + 3.0 * fl1_fxn * tg_zzz_yyyyyz_1[j];

                    tg_yzzz_yyyyyzz_0[j] = pb_y * tg_zzz_yyyyyzz_0[j] + wp_y[j] * tg_zzz_yyyyyzz_1[j] + 2.5 * fl1_fxn * tg_zzz_yyyyzz_1[j];

                    tg_yzzz_yyyyzzz_0[j] = pb_y * tg_zzz_yyyyzzz_0[j] + wp_y[j] * tg_zzz_yyyyzzz_1[j] + 2.0 * fl1_fxn * tg_zzz_yyyzzz_1[j];

                    tg_yzzz_yyyzzzz_0[j] = pb_y * tg_zzz_yyyzzzz_0[j] + wp_y[j] * tg_zzz_yyyzzzz_1[j] + 1.5 * fl1_fxn * tg_zzz_yyzzzz_1[j];

                    tg_yzzz_yyzzzzz_0[j] = pb_y * tg_zzz_yyzzzzz_0[j] + wp_y[j] * tg_zzz_yyzzzzz_1[j] + fl1_fxn * tg_zzz_yzzzzz_1[j];

                    tg_yzzz_yzzzzzz_0[j] = pb_y * tg_zzz_yzzzzzz_0[j] + wp_y[j] * tg_zzz_yzzzzzz_1[j] + 0.5 * fl1_fxn * tg_zzz_zzzzzz_1[j];

                    tg_yzzz_zzzzzzz_0[j] = pb_y * tg_zzz_zzzzzzz_0[j] + wp_y[j] * tg_zzz_zzzzzzz_1[j];

                    tg_zzzz_xxxxxxx_0[j] = pb_z * tg_zzz_xxxxxxx_0[j] + wp_z[j] * tg_zzz_xxxxxxx_1[j] + 1.5 * fl1_fx * tg_zz_xxxxxxx_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xxxxxxx_1[j];

                    tg_zzzz_xxxxxxy_0[j] = pb_z * tg_zzz_xxxxxxy_0[j] + wp_z[j] * tg_zzz_xxxxxxy_1[j] + 1.5 * fl1_fx * tg_zz_xxxxxxy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xxxxxxy_1[j];

                    tg_zzzz_xxxxxxz_0[j] = pb_z * tg_zzz_xxxxxxz_0[j] + wp_z[j] * tg_zzz_xxxxxxz_1[j] + 1.5 * fl1_fx * tg_zz_xxxxxxz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xxxxxxz_1[j] + 0.5 * fl1_fxn * tg_zzz_xxxxxx_1[j];

                    tg_zzzz_xxxxxyy_0[j] = pb_z * tg_zzz_xxxxxyy_0[j] + wp_z[j] * tg_zzz_xxxxxyy_1[j] + 1.5 * fl1_fx * tg_zz_xxxxxyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xxxxxyy_1[j];

                    tg_zzzz_xxxxxyz_0[j] = pb_z * tg_zzz_xxxxxyz_0[j] + wp_z[j] * tg_zzz_xxxxxyz_1[j] + 1.5 * fl1_fx * tg_zz_xxxxxyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xxxxxyz_1[j] + 0.5 * fl1_fxn * tg_zzz_xxxxxy_1[j];

                    tg_zzzz_xxxxxzz_0[j] = pb_z * tg_zzz_xxxxxzz_0[j] + wp_z[j] * tg_zzz_xxxxxzz_1[j] + 1.5 * fl1_fx * tg_zz_xxxxxzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xxxxxzz_1[j] + fl1_fxn * tg_zzz_xxxxxz_1[j];

                    tg_zzzz_xxxxyyy_0[j] = pb_z * tg_zzz_xxxxyyy_0[j] + wp_z[j] * tg_zzz_xxxxyyy_1[j] + 1.5 * fl1_fx * tg_zz_xxxxyyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xxxxyyy_1[j];

                    tg_zzzz_xxxxyyz_0[j] = pb_z * tg_zzz_xxxxyyz_0[j] + wp_z[j] * tg_zzz_xxxxyyz_1[j] + 1.5 * fl1_fx * tg_zz_xxxxyyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xxxxyyz_1[j] + 0.5 * fl1_fxn * tg_zzz_xxxxyy_1[j];

                    tg_zzzz_xxxxyzz_0[j] = pb_z * tg_zzz_xxxxyzz_0[j] + wp_z[j] * tg_zzz_xxxxyzz_1[j] + 1.5 * fl1_fx * tg_zz_xxxxyzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xxxxyzz_1[j] + fl1_fxn * tg_zzz_xxxxyz_1[j];

                    tg_zzzz_xxxxzzz_0[j] = pb_z * tg_zzz_xxxxzzz_0[j] + wp_z[j] * tg_zzz_xxxxzzz_1[j] + 1.5 * fl1_fx * tg_zz_xxxxzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xxxxzzz_1[j] + 1.5 * fl1_fxn * tg_zzz_xxxxzz_1[j];

                    tg_zzzz_xxxyyyy_0[j] = pb_z * tg_zzz_xxxyyyy_0[j] + wp_z[j] * tg_zzz_xxxyyyy_1[j] + 1.5 * fl1_fx * tg_zz_xxxyyyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xxxyyyy_1[j];

                    tg_zzzz_xxxyyyz_0[j] = pb_z * tg_zzz_xxxyyyz_0[j] + wp_z[j] * tg_zzz_xxxyyyz_1[j] + 1.5 * fl1_fx * tg_zz_xxxyyyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xxxyyyz_1[j] + 0.5 * fl1_fxn * tg_zzz_xxxyyy_1[j];

                    tg_zzzz_xxxyyzz_0[j] = pb_z * tg_zzz_xxxyyzz_0[j] + wp_z[j] * tg_zzz_xxxyyzz_1[j] + 1.5 * fl1_fx * tg_zz_xxxyyzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xxxyyzz_1[j] + fl1_fxn * tg_zzz_xxxyyz_1[j];

                    tg_zzzz_xxxyzzz_0[j] = pb_z * tg_zzz_xxxyzzz_0[j] + wp_z[j] * tg_zzz_xxxyzzz_1[j] + 1.5 * fl1_fx * tg_zz_xxxyzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xxxyzzz_1[j] + 1.5 * fl1_fxn * tg_zzz_xxxyzz_1[j];

                    tg_zzzz_xxxzzzz_0[j] = pb_z * tg_zzz_xxxzzzz_0[j] + wp_z[j] * tg_zzz_xxxzzzz_1[j] + 1.5 * fl1_fx * tg_zz_xxxzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xxxzzzz_1[j] + 2.0 * fl1_fxn * tg_zzz_xxxzzz_1[j];

                    tg_zzzz_xxyyyyy_0[j] = pb_z * tg_zzz_xxyyyyy_0[j] + wp_z[j] * tg_zzz_xxyyyyy_1[j] + 1.5 * fl1_fx * tg_zz_xxyyyyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xxyyyyy_1[j];

                    tg_zzzz_xxyyyyz_0[j] = pb_z * tg_zzz_xxyyyyz_0[j] + wp_z[j] * tg_zzz_xxyyyyz_1[j] + 1.5 * fl1_fx * tg_zz_xxyyyyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xxyyyyz_1[j] + 0.5 * fl1_fxn * tg_zzz_xxyyyy_1[j];

                    tg_zzzz_xxyyyzz_0[j] = pb_z * tg_zzz_xxyyyzz_0[j] + wp_z[j] * tg_zzz_xxyyyzz_1[j] + 1.5 * fl1_fx * tg_zz_xxyyyzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xxyyyzz_1[j] + fl1_fxn * tg_zzz_xxyyyz_1[j];

                    tg_zzzz_xxyyzzz_0[j] = pb_z * tg_zzz_xxyyzzz_0[j] + wp_z[j] * tg_zzz_xxyyzzz_1[j] + 1.5 * fl1_fx * tg_zz_xxyyzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xxyyzzz_1[j] + 1.5 * fl1_fxn * tg_zzz_xxyyzz_1[j];

                    tg_zzzz_xxyzzzz_0[j] = pb_z * tg_zzz_xxyzzzz_0[j] + wp_z[j] * tg_zzz_xxyzzzz_1[j] + 1.5 * fl1_fx * tg_zz_xxyzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xxyzzzz_1[j] + 2.0 * fl1_fxn * tg_zzz_xxyzzz_1[j];

                    tg_zzzz_xxzzzzz_0[j] = pb_z * tg_zzz_xxzzzzz_0[j] + wp_z[j] * tg_zzz_xxzzzzz_1[j] + 1.5 * fl1_fx * tg_zz_xxzzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xxzzzzz_1[j] + 2.5 * fl1_fxn * tg_zzz_xxzzzz_1[j];

                    tg_zzzz_xyyyyyy_0[j] = pb_z * tg_zzz_xyyyyyy_0[j] + wp_z[j] * tg_zzz_xyyyyyy_1[j] + 1.5 * fl1_fx * tg_zz_xyyyyyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xyyyyyy_1[j];

                    tg_zzzz_xyyyyyz_0[j] = pb_z * tg_zzz_xyyyyyz_0[j] + wp_z[j] * tg_zzz_xyyyyyz_1[j] + 1.5 * fl1_fx * tg_zz_xyyyyyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xyyyyyz_1[j] + 0.5 * fl1_fxn * tg_zzz_xyyyyy_1[j];

                    tg_zzzz_xyyyyzz_0[j] = pb_z * tg_zzz_xyyyyzz_0[j] + wp_z[j] * tg_zzz_xyyyyzz_1[j] + 1.5 * fl1_fx * tg_zz_xyyyyzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xyyyyzz_1[j] + fl1_fxn * tg_zzz_xyyyyz_1[j];

                    tg_zzzz_xyyyzzz_0[j] = pb_z * tg_zzz_xyyyzzz_0[j] + wp_z[j] * tg_zzz_xyyyzzz_1[j] + 1.5 * fl1_fx * tg_zz_xyyyzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xyyyzzz_1[j] + 1.5 * fl1_fxn * tg_zzz_xyyyzz_1[j];

                    tg_zzzz_xyyzzzz_0[j] = pb_z * tg_zzz_xyyzzzz_0[j] + wp_z[j] * tg_zzz_xyyzzzz_1[j] + 1.5 * fl1_fx * tg_zz_xyyzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xyyzzzz_1[j] + 2.0 * fl1_fxn * tg_zzz_xyyzzz_1[j];

                    tg_zzzz_xyzzzzz_0[j] = pb_z * tg_zzz_xyzzzzz_0[j] + wp_z[j] * tg_zzz_xyzzzzz_1[j] + 1.5 * fl1_fx * tg_zz_xyzzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xyzzzzz_1[j] + 2.5 * fl1_fxn * tg_zzz_xyzzzz_1[j];

                    tg_zzzz_xzzzzzz_0[j] = pb_z * tg_zzz_xzzzzzz_0[j] + wp_z[j] * tg_zzz_xzzzzzz_1[j] + 1.5 * fl1_fx * tg_zz_xzzzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_xzzzzzz_1[j] + 3.0 * fl1_fxn * tg_zzz_xzzzzz_1[j];

                    tg_zzzz_yyyyyyy_0[j] = pb_z * tg_zzz_yyyyyyy_0[j] + wp_z[j] * tg_zzz_yyyyyyy_1[j] + 1.5 * fl1_fx * tg_zz_yyyyyyy_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_yyyyyyy_1[j];

                    tg_zzzz_yyyyyyz_0[j] = pb_z * tg_zzz_yyyyyyz_0[j] + wp_z[j] * tg_zzz_yyyyyyz_1[j] + 1.5 * fl1_fx * tg_zz_yyyyyyz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_yyyyyyz_1[j] + 0.5 * fl1_fxn * tg_zzz_yyyyyy_1[j];

                    tg_zzzz_yyyyyzz_0[j] = pb_z * tg_zzz_yyyyyzz_0[j] + wp_z[j] * tg_zzz_yyyyyzz_1[j] + 1.5 * fl1_fx * tg_zz_yyyyyzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_yyyyyzz_1[j] + fl1_fxn * tg_zzz_yyyyyz_1[j];

                    tg_zzzz_yyyyzzz_0[j] = pb_z * tg_zzz_yyyyzzz_0[j] + wp_z[j] * tg_zzz_yyyyzzz_1[j] + 1.5 * fl1_fx * tg_zz_yyyyzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_yyyyzzz_1[j] + 1.5 * fl1_fxn * tg_zzz_yyyyzz_1[j];

                    tg_zzzz_yyyzzzz_0[j] = pb_z * tg_zzz_yyyzzzz_0[j] + wp_z[j] * tg_zzz_yyyzzzz_1[j] + 1.5 * fl1_fx * tg_zz_yyyzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_yyyzzzz_1[j] + 2.0 * fl1_fxn * tg_zzz_yyyzzz_1[j];

                    tg_zzzz_yyzzzzz_0[j] = pb_z * tg_zzz_yyzzzzz_0[j] + wp_z[j] * tg_zzz_yyzzzzz_1[j] + 1.5 * fl1_fx * tg_zz_yyzzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_yyzzzzz_1[j] + 2.5 * fl1_fxn * tg_zzz_yyzzzz_1[j];

                    tg_zzzz_yzzzzzz_0[j] = pb_z * tg_zzz_yzzzzzz_0[j] + wp_z[j] * tg_zzz_yzzzzzz_1[j] + 1.5 * fl1_fx * tg_zz_yzzzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_yzzzzzz_1[j] + 3.0 * fl1_fxn * tg_zzz_yzzzzz_1[j];

                    tg_zzzz_zzzzzzz_0[j] = pb_z * tg_zzz_zzzzzzz_0[j] + wp_z[j] * tg_zzz_zzzzzzz_1[j] + 1.5 * fl1_fx * tg_zz_zzzzzzz_0[j] - 1.5 * fl1_fx * fl1_fza * tg_zz_zzzzzzz_1[j] + 3.5 * fl1_fxn * tg_zzz_zzzzzz_1[j];
                }
