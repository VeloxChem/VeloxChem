...
namespace erirecfunc { // erirecfunc namespace
    ...
    {
        erirecfunc::compElectronRepulsionForSISG_0_84(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      wpDistances, 
                                                      braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSISG_84_168(primBuffer,
                                                        recursionMap,
                                                        osFactors,
                                                        wpDistances, 
                                                        braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSISG_168_252(primBuffer,
                                                         recursionMap,
                                                         osFactors,
                                                         wpDistances, 
                                                         braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSISG_252_336(primBuffer,
                                                         recursionMap,
                                                         osFactors,
                                                         wpDistances, 
                                                         braGtoPairsBlock,
        ...
        erirecfunc::compElectronRepulsionForSISG_336_420(primBuffer,
                                                         recursionMap,
                                                         osFactors,
                                                         wpDistances, 
                                                         braGtoPairsBlock,
    ...
    void
    compElectronRepulsionForSISG_0_84(      CMemBlock2D<double>* primBuffer,
                                      const CRecursionMap&       recursionMap,
                                      const CMemBlock2D<double>& osFactors,
                                      const CMemBlock2D<double>& wpDistances,
                                      const CGtoPairsBlock&      braGtoPairsBlock,
                                      ...
                                      const int32_t              iContrPair)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            auto pidx_g_4_4_m0 = recursionMap.index(CRecursionTerm({"Electron Repulsion"}, 0, true, 
                                                                   {4, -1, -1, -1}, {4, -1, -1, -1}, 
                                                                   1, 1, iord));
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                auto tg_xxxx_xxxx_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx); 

                auto tg_xxxx_xxxy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 1); 

                auto tg_xxxx_xxxz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 2); 

                auto tg_xxxx_xxyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 3); 

                auto tg_xxxx_xxyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 4); 

                auto tg_xxxx_xxzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 5); 

                auto tg_xxxx_xyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 6); 

                auto tg_xxxx_xyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 7); 

                auto tg_xxxx_xyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 8); 

                auto tg_xxxx_xzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 9); 

                auto tg_xxxx_yyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 10); 

                auto tg_xxxx_yyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 11); 

                auto tg_xxxx_yyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 12); 

                auto tg_xxxx_yzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 13); 

                auto tg_xxxx_zzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 14); 

                auto tg_xxxy_xxxx_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 15); 

                auto tg_xxxy_xxxy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 16); 

                auto tg_xxxy_xxxz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 17); 

                auto tg_xxxy_xxyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 18); 

                auto tg_xxxy_xxyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 19); 

                auto tg_xxxy_xxzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 20); 

                auto tg_xxxy_xyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 21); 

                auto tg_xxxy_xyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 22); 

                auto tg_xxxy_xyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 23); 

                auto tg_xxxy_xzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 24); 

                auto tg_xxxy_yyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 25); 

                auto tg_xxxy_yyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 26); 

                auto tg_xxxy_yyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 27); 

                auto tg_xxxy_yzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 28); 

                auto tg_xxxy_zzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 29); 

                auto tg_xxxz_xxxx_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 30); 

                auto tg_xxxz_xxxy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 31); 

                auto tg_xxxz_xxxz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 32); 

                auto tg_xxxz_xxyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 33); 

                auto tg_xxxz_xxyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 34); 

                auto tg_xxxz_xxzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 35); 

                auto tg_xxxz_xyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 36); 

                auto tg_xxxz_xyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 37); 

                auto tg_xxxz_xyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 38); 

                auto tg_xxxz_xzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 39); 

                auto tg_xxxz_yyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 40); 

                auto tg_xxxz_yyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 41); 

                auto tg_xxxz_yyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 42); 

                auto tg_xxxz_yzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 43); 

                auto tg_xxxz_zzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 44); 

                auto tg_xxyy_xxxx_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 45); 

                auto tg_xxyy_xxxy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 46); 

                auto tg_xxyy_xxxz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 47); 

                auto tg_xxyy_xxyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 48); 

                auto tg_xxyy_xxyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 49); 

                auto tg_xxyy_xxzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 50); 

                auto tg_xxyy_xyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 51); 

                auto tg_xxyy_xyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 52); 

                auto tg_xxyy_xyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 53); 

                auto tg_xxyy_xzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 54); 

                auto tg_xxyy_yyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 55); 

                auto tg_xxyy_yyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 56); 

                auto tg_xxyy_yyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 57); 

                auto tg_xxyy_yzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 58); 

                auto tg_xxyy_zzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 59); 

                auto tg_xxyz_xxxx_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 60); 

                auto tg_xxyz_xxxy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 61); 

                auto tg_xxyz_xxxz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 62); 

                auto tg_xxyz_xxyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 63); 

                auto tg_xxyz_xxyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 64); 

                auto tg_xxyz_xxzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 65); 

                auto tg_xxyz_xyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 66); 

                auto tg_xxyz_xyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 67); 

                auto tg_xxyz_xyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 68); 

                auto tg_xxyz_xzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 69); 

                auto tg_xxyz_yyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 70); 

                auto tg_xxyz_yyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 71); 

                auto tg_xxyz_yyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 72); 

                auto tg_xxyz_yzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 73); 

                auto tg_xxyz_zzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 74); 

                auto tg_xxzz_xxxx_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 75); 

                auto tg_xxzz_xxxy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 76); 

                auto tg_xxzz_xxxz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 77); 

                auto tg_xxzz_xxyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 78); 

                auto tg_xxzz_xxyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 79); 

                auto tg_xxzz_xxzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 80); 

                auto tg_xxzz_xyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 81); 

                auto tg_xxzz_xyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 82); 

                auto tg_xxzz_xyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 83); 
                ...
                #pragma omp simd aligned(fxn, fza, tg_xxxx_xxxx_0, tg_xxxx_xxxx_1, tg_xxxx_xxxy_0, \
                                         ...
                                         tg_xxxxyy_xxxy_0, tg_xxxxyy_xxxz_0, tg_xxxxyy_xxyy_0, tg_xxxxyy_xxyz_0, \
                                         ...
                                         tg_xxxxyz_zzzz_0, tg_xxxxz_xxx_1, tg_xxxxz_xxxx_0, tg_xxxxz_xxxx_1, tg_xxxxz_xxxy_0, \
                                         ...
                                         tg_xxxxz_zzzz_1, tg_xxxxzz_xxxx_0, tg_xxxxzz_xxxy_0, tg_xxxxzz_xxxz_0, \
                                         tg_xxxxzz_xxyy_0, tg_xxxxzz_xxyz_0, tg_xxxxzz_xxzz_0, tg_xxxxzz_xyyy_0, \
                                         tg_xxxxzz_xyyz_0, tg_xxxxzz_xyzz_0, tg_xxxy_xxxx_0, tg_xxxy_xxxx_1, tg_xxxy_xxxy_0, \
                                         tg_xxxy_xxxy_1, tg_xxxy_xxxz_0, tg_xxxy_xxxz_1, tg_xxxy_xxyy_0, tg_xxxy_xxyy_1, \
                                         tg_xxxy_xxyz_0, tg_xxxy_xxyz_1, tg_xxxy_xxzz_0, tg_xxxy_xxzz_1, tg_xxxy_xyyy_0, \
                                         tg_xxxy_xyyy_1, tg_xxxy_xyyz_0, tg_xxxy_xyyz_1, tg_xxxy_xyzz_0, tg_xxxy_xyzz_1, \
                                         tg_xxxy_xzzz_0, tg_xxxy_xzzz_1, tg_xxxy_yyyy_0, tg_xxxy_yyyy_1, tg_xxxy_yyyz_0, \
                                         tg_xxxy_yyyz_1, tg_xxxy_yyzz_0, tg_xxxy_yyzz_1, tg_xxxy_yzzz_0, tg_xxxy_yzzz_1, \
                                         tg_xxxy_zzzz_0, tg_xxxy_zzzz_1, tg_xxxyy_xxx_1, tg_xxxyy_xxxx_0, tg_xxxyy_xxxx_1, \
                                         tg_xxxyy_xxxy_0, tg_xxxyy_xxxy_1, tg_xxxyy_xxxz_0, tg_xxxyy_xxxz_1, tg_xxxyy_xxy_1, \
                                         tg_xxxyy_xxyy_0, tg_xxxyy_xxyy_1, tg_xxxyy_xxyz_0, tg_xxxyy_xxyz_1, tg_xxxyy_xxz_1, \
                                         tg_xxxyy_xxzz_0, tg_xxxyy_xxzz_1, tg_xxxyy_xyy_1, tg_xxxyy_xyyy_0, tg_xxxyy_xyyy_1, \
                                         tg_xxxyy_xyyz_0, tg_xxxyy_xyyz_1, tg_xxxyy_xyz_1, tg_xxxyy_xyzz_0, tg_xxxyy_xyzz_1, \
                                         tg_xxxyy_xzz_1, tg_xxxyy_xzzz_0, tg_xxxyy_xzzz_1, tg_xxxyy_yyy_1, tg_xxxyy_yyyy_0, \
                                         tg_xxxyy_yyyy_1, tg_xxxyy_yyyz_0, tg_xxxyy_yyyz_1, tg_xxxyy_yyz_1, tg_xxxyy_yyzz_0, \
                                         tg_xxxyy_yyzz_1, tg_xxxyy_yzz_1, tg_xxxyy_yzzz_0, tg_xxxyy_yzzz_1, tg_xxxyy_zzz_1, \
                                         tg_xxxyy_zzzz_0, tg_xxxyy_zzzz_1, tg_xxxyz_xxx_1, tg_xxxyz_xxxx_0, tg_xxxyz_xxxx_1, \
                                         tg_xxxyz_xxxy_0, tg_xxxyz_xxxy_1, tg_xxxyz_xxxz_0, tg_xxxyz_xxxz_1, tg_xxxyz_xxy_1, \
                                         tg_xxxyz_xxyy_0, tg_xxxyz_xxyy_1, tg_xxxyz_xxyz_0, tg_xxxyz_xxyz_1, tg_xxxyz_xxz_1, \
                                         tg_xxxyz_xxzz_0, tg_xxxyz_xxzz_1, tg_xxxyz_xyy_1, tg_xxxyz_xyyy_0, tg_xxxyz_xyyy_1, \
                                         tg_xxxyz_xyyz_0, tg_xxxyz_xyyz_1, tg_xxxyz_xyz_1, tg_xxxyz_xyzz_0, tg_xxxyz_xyzz_1, \
                                         tg_xxxyz_xzz_1, tg_xxxyz_xzzz_0, tg_xxxyz_xzzz_1, tg_xxxyz_yyy_1, tg_xxxyz_yyyy_0, \
                                         tg_xxxyz_yyyy_1, tg_xxxyz_yyyz_0, tg_xxxyz_yyyz_1, tg_xxxyz_yyz_1, tg_xxxyz_yyzz_0, \
                                         tg_xxxyz_yyzz_1, tg_xxxyz_yzz_1, tg_xxxyz_yzzz_0, tg_xxxyz_yzzz_1, tg_xxxyz_zzz_1, \
                                         tg_xxxyz_zzzz_0, tg_xxxyz_zzzz_1, tg_xxxz_xxxx_0, tg_xxxz_xxxx_1, tg_xxxz_xxxy_0, \
                                         ...
                                         tg_xxxz_zzzz_0, tg_xxxz_zzzz_1, tg_xxxzz_xxx_1, tg_xxxzz_xxxx_0, tg_xxxzz_xxxx_1, \
                                         tg_xxxzz_xxxy_0, tg_xxxzz_xxxy_1, tg_xxxzz_xxxz_0, tg_xxxzz_xxxz_1, tg_xxxzz_xxy_1, \
                                         tg_xxxzz_xxyy_0, tg_xxxzz_xxyy_1, tg_xxxzz_xxyz_0, tg_xxxzz_xxyz_1, tg_xxxzz_xxz_1, \
                                         tg_xxxzz_xxzz_0, tg_xxxzz_xxzz_1, tg_xxxzz_xyy_1, tg_xxxzz_xyyy_0, tg_xxxzz_xyyy_1, \
                                         tg_xxxzz_xyyz_0, tg_xxxzz_xyyz_1, tg_xxxzz_xyz_1, tg_xxxzz_xyzz_0, tg_xxxzz_xyzz_1, \
                                         tg_xxxzz_xzz_1, tg_xxxzz_yyy_1, tg_xxxzz_yyz_1, tg_xxxzz_yzz_1, tg_xxyy_xxxx_0, \
                                         tg_xxyy_xxxx_1, tg_xxyy_xxxy_0, tg_xxyy_xxxy_1, tg_xxyy_xxxz_0, tg_xxyy_xxxz_1, \
                                         tg_xxyy_xxyy_0, tg_xxyy_xxyy_1, tg_xxyy_xxyz_0, tg_xxyy_xxyz_1, tg_xxyy_xxzz_0, \
                                         tg_xxyy_xxzz_1, tg_xxyy_xyyy_0, tg_xxyy_xyyy_1, tg_xxyy_xyyz_0, tg_xxyy_xyyz_1, \
                                         tg_xxyy_xyzz_0, tg_xxyy_xyzz_1, tg_xxyy_xzzz_0, tg_xxyy_xzzz_1, tg_xxyy_yyyy_0, \
                                         tg_xxyy_yyyy_1, tg_xxyy_yyyz_0, tg_xxyy_yyyz_1, tg_xxyy_yyzz_0, tg_xxyy_yyzz_1, \
                                         tg_xxyy_yzzz_0, tg_xxyy_yzzz_1, tg_xxyy_zzzz_0, tg_xxyy_zzzz_1, tg_xxyz_xxxx_0, \
                                         tg_xxyz_xxxx_1, tg_xxyz_xxxy_0, tg_xxyz_xxxy_1, tg_xxyz_xxxz_0, tg_xxyz_xxxz_1, \
                                         tg_xxyz_xxyy_0, tg_xxyz_xxyy_1, tg_xxyz_xxyz_0, tg_xxyz_xxyz_1, tg_xxyz_xxzz_0, \
                                         tg_xxyz_xxzz_1, tg_xxyz_xyyy_0, tg_xxyz_xyyy_1, tg_xxyz_xyyz_0, tg_xxyz_xyyz_1, \
                                         tg_xxyz_xyzz_0, tg_xxyz_xyzz_1, tg_xxyz_xzzz_0, tg_xxyz_xzzz_1, tg_xxyz_yyyy_0, \
                                         tg_xxyz_yyyy_1, tg_xxyz_yyyz_0, tg_xxyz_yyyz_1, tg_xxyz_yyzz_0, tg_xxyz_yyzz_1, \
                                         tg_xxyz_yzzz_0, tg_xxyz_yzzz_1, tg_xxyz_zzzz_0, tg_xxyz_zzzz_1, tg_xxzz_xxxx_0, \
                                         tg_xxzz_xxxx_1, tg_xxzz_xxxy_0, tg_xxzz_xxxy_1, tg_xxzz_xxxz_0, tg_xxzz_xxxz_1, \
                                         tg_xxzz_xxyy_0, tg_xxzz_xxyy_1, tg_xxzz_xxyz_0, tg_xxzz_xxyz_1, tg_xxzz_xxzz_0, \
                                         tg_xxzz_xxzz_1, tg_xxzz_xyyy_0, tg_xxzz_xyyy_1, tg_xxzz_xyyz_0, tg_xxzz_xyyz_1, \
                                         tg_xxzz_xyzz_0, tg_xxzz_xyzz_1, wp_x: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    ...
                    tg_xxxxxx_xxxx_0[j] = pb_x * tg_xxxxx_xxxx_0[j] + fr * tg_xxxxx_xxxx_1[j] + 2.5 * fl1_fx * (tg_xxxx_xxxx_0[j] - tg_xxxx_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xxxxx_xxx_1[j];

                    tg_xxxxxx_xxxy_0[j] = pb_x * tg_xxxxx_xxxy_0[j] + fr * tg_xxxxx_xxxy_1[j] + 2.5 * fl1_fx * (tg_xxxx_xxxy_0[j] - tg_xxxx_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxxxx_xxy_1[j];

                    tg_xxxxxx_xxxz_0[j] = pb_x * tg_xxxxx_xxxz_0[j] + fr * tg_xxxxx_xxxz_1[j] + 2.5 * fl1_fx * (tg_xxxx_xxxz_0[j] - tg_xxxx_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxxxx_xxz_1[j];

                    tg_xxxxxx_xxyy_0[j] = pb_x * tg_xxxxx_xxyy_0[j] + fr * tg_xxxxx_xxyy_1[j] + 2.5 * fl1_fx * (tg_xxxx_xxyy_0[j] - tg_xxxx_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xxxxx_xyy_1[j];

                    tg_xxxxxx_xxyz_0[j] = pb_x * tg_xxxxx_xxyz_0[j] + fr * tg_xxxxx_xxyz_1[j] + 2.5 * fl1_fx * (tg_xxxx_xxyz_0[j] - tg_xxxx_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xxxxx_xyz_1[j];

                    tg_xxxxxx_xxzz_0[j] = pb_x * tg_xxxxx_xxzz_0[j] + fr * tg_xxxxx_xxzz_1[j] + 2.5 * fl1_fx * (tg_xxxx_xxzz_0[j] - tg_xxxx_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xxxxx_xzz_1[j];

                    tg_xxxxxx_xyyy_0[j] = pb_x * tg_xxxxx_xyyy_0[j] + fr * tg_xxxxx_xyyy_1[j] + 2.5 * fl1_fx * (tg_xxxx_xyyy_0[j] - tg_xxxx_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxxx_yyy_1[j];

                    tg_xxxxxx_xyyz_0[j] = pb_x * tg_xxxxx_xyyz_0[j] + fr * tg_xxxxx_xyyz_1[j] + 2.5 * fl1_fx * (tg_xxxx_xyyz_0[j] - tg_xxxx_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxxx_yyz_1[j];

                    tg_xxxxxx_xyzz_0[j] = pb_x * tg_xxxxx_xyzz_0[j] + fr * tg_xxxxx_xyzz_1[j] + 2.5 * fl1_fx * (tg_xxxx_xyzz_0[j] - tg_xxxx_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxxx_yzz_1[j];

                    tg_xxxxxx_xzzz_0[j] = pb_x * tg_xxxxx_xzzz_0[j] + fr * tg_xxxxx_xzzz_1[j] + 2.5 * fl1_fx * (tg_xxxx_xzzz_0[j] - tg_xxxx_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxxx_zzz_1[j];

                    tg_xxxxxx_yyyy_0[j] = pb_x * tg_xxxxx_yyyy_0[j] + fr * tg_xxxxx_yyyy_1[j] + 2.5 * fl1_fx * (tg_xxxx_yyyy_0[j] - tg_xxxx_yyyy_1[j] * fl1_fza);

                    tg_xxxxxx_yyyz_0[j] = pb_x * tg_xxxxx_yyyz_0[j] + fr * tg_xxxxx_yyyz_1[j] + 2.5 * fl1_fx * (tg_xxxx_yyyz_0[j] - tg_xxxx_yyyz_1[j] * fl1_fza);

                    tg_xxxxxx_yyzz_0[j] = pb_x * tg_xxxxx_yyzz_0[j] + fr * tg_xxxxx_yyzz_1[j] + 2.5 * fl1_fx * (tg_xxxx_yyzz_0[j] - tg_xxxx_yyzz_1[j] * fl1_fza);

                    tg_xxxxxx_yzzz_0[j] = pb_x * tg_xxxxx_yzzz_0[j] + fr * tg_xxxxx_yzzz_1[j] + 2.5 * fl1_fx * (tg_xxxx_yzzz_0[j] - tg_xxxx_yzzz_1[j] * fl1_fza);

                    tg_xxxxxx_zzzz_0[j] = pb_x * tg_xxxxx_zzzz_0[j] + fr * tg_xxxxx_zzzz_1[j] + 2.5 * fl1_fx * (tg_xxxx_zzzz_0[j] - tg_xxxx_zzzz_1[j] * fl1_fza);

                    tg_xxxxxy_xxxx_0[j] = pb_x * tg_xxxxy_xxxx_0[j] + fr * tg_xxxxy_xxxx_1[j] + 2.0 * fl1_fx * (tg_xxxy_xxxx_0[j] - tg_xxxy_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xxxxy_xxx_1[j];

                    tg_xxxxxy_xxxy_0[j] = pb_x * tg_xxxxy_xxxy_0[j] + fr * tg_xxxxy_xxxy_1[j] + 2.0 * fl1_fx * (tg_xxxy_xxxy_0[j] - tg_xxxy_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxxxy_xxy_1[j];

                    tg_xxxxxy_xxxz_0[j] = pb_x * tg_xxxxy_xxxz_0[j] + fr * tg_xxxxy_xxxz_1[j] + 2.0 * fl1_fx * (tg_xxxy_xxxz_0[j] - tg_xxxy_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxxxy_xxz_1[j];

                    tg_xxxxxy_xxyy_0[j] = pb_x * tg_xxxxy_xxyy_0[j] + fr * tg_xxxxy_xxyy_1[j] + 2.0 * fl1_fx * (tg_xxxy_xxyy_0[j] - tg_xxxy_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xxxxy_xyy_1[j];

                    tg_xxxxxy_xxyz_0[j] = pb_x * tg_xxxxy_xxyz_0[j] + fr * tg_xxxxy_xxyz_1[j] + 2.0 * fl1_fx * (tg_xxxy_xxyz_0[j] - tg_xxxy_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xxxxy_xyz_1[j];

                    tg_xxxxxy_xxzz_0[j] = pb_x * tg_xxxxy_xxzz_0[j] + fr * tg_xxxxy_xxzz_1[j] + 2.0 * fl1_fx * (tg_xxxy_xxzz_0[j] - tg_xxxy_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xxxxy_xzz_1[j];

                    tg_xxxxxy_xyyy_0[j] = pb_x * tg_xxxxy_xyyy_0[j] + fr * tg_xxxxy_xyyy_1[j] + 2.0 * fl1_fx * (tg_xxxy_xyyy_0[j] - tg_xxxy_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxxy_yyy_1[j];

                    tg_xxxxxy_xyyz_0[j] = pb_x * tg_xxxxy_xyyz_0[j] + fr * tg_xxxxy_xyyz_1[j] + 2.0 * fl1_fx * (tg_xxxy_xyyz_0[j] - tg_xxxy_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxxy_yyz_1[j];

                    tg_xxxxxy_xyzz_0[j] = pb_x * tg_xxxxy_xyzz_0[j] + fr * tg_xxxxy_xyzz_1[j] + 2.0 * fl1_fx * (tg_xxxy_xyzz_0[j] - tg_xxxy_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxxy_yzz_1[j];

                    tg_xxxxxy_xzzz_0[j] = pb_x * tg_xxxxy_xzzz_0[j] + fr * tg_xxxxy_xzzz_1[j] + 2.0 * fl1_fx * (tg_xxxy_xzzz_0[j] - tg_xxxy_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxxy_zzz_1[j];

                    tg_xxxxxy_yyyy_0[j] = pb_x * tg_xxxxy_yyyy_0[j] + fr * tg_xxxxy_yyyy_1[j] + 2.0 * fl1_fx * (tg_xxxy_yyyy_0[j] - tg_xxxy_yyyy_1[j] * fl1_fza);

                    tg_xxxxxy_yyyz_0[j] = pb_x * tg_xxxxy_yyyz_0[j] + fr * tg_xxxxy_yyyz_1[j] + 2.0 * fl1_fx * (tg_xxxy_yyyz_0[j] - tg_xxxy_yyyz_1[j] * fl1_fza);

                    tg_xxxxxy_yyzz_0[j] = pb_x * tg_xxxxy_yyzz_0[j] + fr * tg_xxxxy_yyzz_1[j] + 2.0 * fl1_fx * (tg_xxxy_yyzz_0[j] - tg_xxxy_yyzz_1[j] * fl1_fza);

                    tg_xxxxxy_yzzz_0[j] = pb_x * tg_xxxxy_yzzz_0[j] + fr * tg_xxxxy_yzzz_1[j] + 2.0 * fl1_fx * (tg_xxxy_yzzz_0[j] - tg_xxxy_yzzz_1[j] * fl1_fza);

                    tg_xxxxxy_zzzz_0[j] = pb_x * tg_xxxxy_zzzz_0[j] + fr * tg_xxxxy_zzzz_1[j] + 2.0 * fl1_fx * (tg_xxxy_zzzz_0[j] - tg_xxxy_zzzz_1[j] * fl1_fza);

                    tg_xxxxxz_xxxx_0[j] = pb_x * tg_xxxxz_xxxx_0[j] + fr * tg_xxxxz_xxxx_1[j] + 2.0 * fl1_fx * (tg_xxxz_xxxx_0[j] - tg_xxxz_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xxxxz_xxx_1[j];

                    tg_xxxxxz_xxxy_0[j] = pb_x * tg_xxxxz_xxxy_0[j] + fr * tg_xxxxz_xxxy_1[j] + 2.0 * fl1_fx * (tg_xxxz_xxxy_0[j] - tg_xxxz_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxxxz_xxy_1[j];

                    tg_xxxxxz_xxxz_0[j] = pb_x * tg_xxxxz_xxxz_0[j] + fr * tg_xxxxz_xxxz_1[j] + 2.0 * fl1_fx * (tg_xxxz_xxxz_0[j] - tg_xxxz_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxxxz_xxz_1[j];

                    tg_xxxxxz_xxyy_0[j] = pb_x * tg_xxxxz_xxyy_0[j] + fr * tg_xxxxz_xxyy_1[j] + 2.0 * fl1_fx * (tg_xxxz_xxyy_0[j] - tg_xxxz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xxxxz_xyy_1[j];

                    tg_xxxxxz_xxyz_0[j] = pb_x * tg_xxxxz_xxyz_0[j] + fr * tg_xxxxz_xxyz_1[j] + 2.0 * fl1_fx * (tg_xxxz_xxyz_0[j] - tg_xxxz_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xxxxz_xyz_1[j];

                    tg_xxxxxz_xxzz_0[j] = pb_x * tg_xxxxz_xxzz_0[j] + fr * tg_xxxxz_xxzz_1[j] + 2.0 * fl1_fx * (tg_xxxz_xxzz_0[j] - tg_xxxz_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xxxxz_xzz_1[j];

                    tg_xxxxxz_xyyy_0[j] = pb_x * tg_xxxxz_xyyy_0[j] + fr * tg_xxxxz_xyyy_1[j] + 2.0 * fl1_fx * (tg_xxxz_xyyy_0[j] - tg_xxxz_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxxz_yyy_1[j];

                    tg_xxxxxz_xyyz_0[j] = pb_x * tg_xxxxz_xyyz_0[j] + fr * tg_xxxxz_xyyz_1[j] + 2.0 * fl1_fx * (tg_xxxz_xyyz_0[j] - tg_xxxz_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxxz_yyz_1[j];

                    tg_xxxxxz_xyzz_0[j] = pb_x * tg_xxxxz_xyzz_0[j] + fr * tg_xxxxz_xyzz_1[j] + 2.0 * fl1_fx * (tg_xxxz_xyzz_0[j] - tg_xxxz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxxz_yzz_1[j];

                    tg_xxxxxz_xzzz_0[j] = pb_x * tg_xxxxz_xzzz_0[j] + fr * tg_xxxxz_xzzz_1[j] + 2.0 * fl1_fx * (tg_xxxz_xzzz_0[j] - tg_xxxz_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxxz_zzz_1[j];

                    tg_xxxxxz_yyyy_0[j] = pb_x * tg_xxxxz_yyyy_0[j] + fr * tg_xxxxz_yyyy_1[j] + 2.0 * fl1_fx * (tg_xxxz_yyyy_0[j] - tg_xxxz_yyyy_1[j] * fl1_fza);

                    tg_xxxxxz_yyyz_0[j] = pb_x * tg_xxxxz_yyyz_0[j] + fr * tg_xxxxz_yyyz_1[j] + 2.0 * fl1_fx * (tg_xxxz_yyyz_0[j] - tg_xxxz_yyyz_1[j] * fl1_fza);

                    tg_xxxxxz_yyzz_0[j] = pb_x * tg_xxxxz_yyzz_0[j] + fr * tg_xxxxz_yyzz_1[j] + 2.0 * fl1_fx * (tg_xxxz_yyzz_0[j] - tg_xxxz_yyzz_1[j] * fl1_fza);

                    tg_xxxxxz_yzzz_0[j] = pb_x * tg_xxxxz_yzzz_0[j] + fr * tg_xxxxz_yzzz_1[j] + 2.0 * fl1_fx * (tg_xxxz_yzzz_0[j] - tg_xxxz_yzzz_1[j] * fl1_fza);

                    tg_xxxxxz_zzzz_0[j] = pb_x * tg_xxxxz_zzzz_0[j] + fr * tg_xxxxz_zzzz_1[j] + 2.0 * fl1_fx * (tg_xxxz_zzzz_0[j] - tg_xxxz_zzzz_1[j] * fl1_fza);

                    tg_xxxxyy_xxxx_0[j] = pb_x * tg_xxxyy_xxxx_0[j] + fr * tg_xxxyy_xxxx_1[j] + 1.5 * fl1_fx * (tg_xxyy_xxxx_0[j] - tg_xxyy_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xxxyy_xxx_1[j];

                    tg_xxxxyy_xxxy_0[j] = pb_x * tg_xxxyy_xxxy_0[j] + fr * tg_xxxyy_xxxy_1[j] + 1.5 * fl1_fx * (tg_xxyy_xxxy_0[j] - tg_xxyy_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxxyy_xxy_1[j];

                    tg_xxxxyy_xxxz_0[j] = pb_x * tg_xxxyy_xxxz_0[j] + fr * tg_xxxyy_xxxz_1[j] + 1.5 * fl1_fx * (tg_xxyy_xxxz_0[j] - tg_xxyy_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxxyy_xxz_1[j];

                    tg_xxxxyy_xxyy_0[j] = pb_x * tg_xxxyy_xxyy_0[j] + fr * tg_xxxyy_xxyy_1[j] + 1.5 * fl1_fx * (tg_xxyy_xxyy_0[j] - tg_xxyy_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xxxyy_xyy_1[j];

                    tg_xxxxyy_xxyz_0[j] = pb_x * tg_xxxyy_xxyz_0[j] + fr * tg_xxxyy_xxyz_1[j] + 1.5 * fl1_fx * (tg_xxyy_xxyz_0[j] - tg_xxyy_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xxxyy_xyz_1[j];

                    tg_xxxxyy_xxzz_0[j] = pb_x * tg_xxxyy_xxzz_0[j] + fr * tg_xxxyy_xxzz_1[j] + 1.5 * fl1_fx * (tg_xxyy_xxzz_0[j] - tg_xxyy_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xxxyy_xzz_1[j];

                    tg_xxxxyy_xyyy_0[j] = pb_x * tg_xxxyy_xyyy_0[j] + fr * tg_xxxyy_xyyy_1[j] + 1.5 * fl1_fx * (tg_xxyy_xyyy_0[j] - tg_xxyy_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxyy_yyy_1[j];

                    tg_xxxxyy_xyyz_0[j] = pb_x * tg_xxxyy_xyyz_0[j] + fr * tg_xxxyy_xyyz_1[j] + 1.5 * fl1_fx * (tg_xxyy_xyyz_0[j] - tg_xxyy_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxyy_yyz_1[j];

                    tg_xxxxyy_xyzz_0[j] = pb_x * tg_xxxyy_xyzz_0[j] + fr * tg_xxxyy_xyzz_1[j] + 1.5 * fl1_fx * (tg_xxyy_xyzz_0[j] - tg_xxyy_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxyy_yzz_1[j];

                    tg_xxxxyy_xzzz_0[j] = pb_x * tg_xxxyy_xzzz_0[j] + fr * tg_xxxyy_xzzz_1[j] + 1.5 * fl1_fx * (tg_xxyy_xzzz_0[j] - tg_xxyy_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxyy_zzz_1[j];

                    tg_xxxxyy_yyyy_0[j] = pb_x * tg_xxxyy_yyyy_0[j] + fr * tg_xxxyy_yyyy_1[j] + 1.5 * fl1_fx * (tg_xxyy_yyyy_0[j] - tg_xxyy_yyyy_1[j] * fl1_fza);

                    tg_xxxxyy_yyyz_0[j] = pb_x * tg_xxxyy_yyyz_0[j] + fr * tg_xxxyy_yyyz_1[j] + 1.5 * fl1_fx * (tg_xxyy_yyyz_0[j] - tg_xxyy_yyyz_1[j] * fl1_fza);

                    tg_xxxxyy_yyzz_0[j] = pb_x * tg_xxxyy_yyzz_0[j] + fr * tg_xxxyy_yyzz_1[j] + 1.5 * fl1_fx * (tg_xxyy_yyzz_0[j] - tg_xxyy_yyzz_1[j] * fl1_fza);

                    tg_xxxxyy_yzzz_0[j] = pb_x * tg_xxxyy_yzzz_0[j] + fr * tg_xxxyy_yzzz_1[j] + 1.5 * fl1_fx * (tg_xxyy_yzzz_0[j] - tg_xxyy_yzzz_1[j] * fl1_fza);

                    tg_xxxxyy_zzzz_0[j] = pb_x * tg_xxxyy_zzzz_0[j] + fr * tg_xxxyy_zzzz_1[j] + 1.5 * fl1_fx * (tg_xxyy_zzzz_0[j] - tg_xxyy_zzzz_1[j] * fl1_fza);

                    tg_xxxxyz_xxxx_0[j] = pb_x * tg_xxxyz_xxxx_0[j] + fr * tg_xxxyz_xxxx_1[j] + 1.5 * fl1_fx * (tg_xxyz_xxxx_0[j] - tg_xxyz_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xxxyz_xxx_1[j];

                    tg_xxxxyz_xxxy_0[j] = pb_x * tg_xxxyz_xxxy_0[j] + fr * tg_xxxyz_xxxy_1[j] + 1.5 * fl1_fx * (tg_xxyz_xxxy_0[j] - tg_xxyz_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxxyz_xxy_1[j];

                    tg_xxxxyz_xxxz_0[j] = pb_x * tg_xxxyz_xxxz_0[j] + fr * tg_xxxyz_xxxz_1[j] + 1.5 * fl1_fx * (tg_xxyz_xxxz_0[j] - tg_xxyz_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxxyz_xxz_1[j];

                    tg_xxxxyz_xxyy_0[j] = pb_x * tg_xxxyz_xxyy_0[j] + fr * tg_xxxyz_xxyy_1[j] + 1.5 * fl1_fx * (tg_xxyz_xxyy_0[j] - tg_xxyz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xxxyz_xyy_1[j];

                    tg_xxxxyz_xxyz_0[j] = pb_x * tg_xxxyz_xxyz_0[j] + fr * tg_xxxyz_xxyz_1[j] + 1.5 * fl1_fx * (tg_xxyz_xxyz_0[j] - tg_xxyz_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xxxyz_xyz_1[j];

                    tg_xxxxyz_xxzz_0[j] = pb_x * tg_xxxyz_xxzz_0[j] + fr * tg_xxxyz_xxzz_1[j] + 1.5 * fl1_fx * (tg_xxyz_xxzz_0[j] - tg_xxyz_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xxxyz_xzz_1[j];

                    tg_xxxxyz_xyyy_0[j] = pb_x * tg_xxxyz_xyyy_0[j] + fr * tg_xxxyz_xyyy_1[j] + 1.5 * fl1_fx * (tg_xxyz_xyyy_0[j] - tg_xxyz_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxyz_yyy_1[j];

                    tg_xxxxyz_xyyz_0[j] = pb_x * tg_xxxyz_xyyz_0[j] + fr * tg_xxxyz_xyyz_1[j] + 1.5 * fl1_fx * (tg_xxyz_xyyz_0[j] - tg_xxyz_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxyz_yyz_1[j];

                    tg_xxxxyz_xyzz_0[j] = pb_x * tg_xxxyz_xyzz_0[j] + fr * tg_xxxyz_xyzz_1[j] + 1.5 * fl1_fx * (tg_xxyz_xyzz_0[j] - tg_xxyz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxyz_yzz_1[j];

                    tg_xxxxyz_xzzz_0[j] = pb_x * tg_xxxyz_xzzz_0[j] + fr * tg_xxxyz_xzzz_1[j] + 1.5 * fl1_fx * (tg_xxyz_xzzz_0[j] - tg_xxyz_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxyz_zzz_1[j];

                    tg_xxxxyz_yyyy_0[j] = pb_x * tg_xxxyz_yyyy_0[j] + fr * tg_xxxyz_yyyy_1[j] + 1.5 * fl1_fx * (tg_xxyz_yyyy_0[j] - tg_xxyz_yyyy_1[j] * fl1_fza);

                    tg_xxxxyz_yyyz_0[j] = pb_x * tg_xxxyz_yyyz_0[j] + fr * tg_xxxyz_yyyz_1[j] + 1.5 * fl1_fx * (tg_xxyz_yyyz_0[j] - tg_xxyz_yyyz_1[j] * fl1_fza);

                    tg_xxxxyz_yyzz_0[j] = pb_x * tg_xxxyz_yyzz_0[j] + fr * tg_xxxyz_yyzz_1[j] + 1.5 * fl1_fx * (tg_xxyz_yyzz_0[j] - tg_xxyz_yyzz_1[j] * fl1_fza);

                    tg_xxxxyz_yzzz_0[j] = pb_x * tg_xxxyz_yzzz_0[j] + fr * tg_xxxyz_yzzz_1[j] + 1.5 * fl1_fx * (tg_xxyz_yzzz_0[j] - tg_xxyz_yzzz_1[j] * fl1_fza);

                    tg_xxxxyz_zzzz_0[j] = pb_x * tg_xxxyz_zzzz_0[j] + fr * tg_xxxyz_zzzz_1[j] + 1.5 * fl1_fx * (tg_xxyz_zzzz_0[j] - tg_xxyz_zzzz_1[j] * fl1_fza);

                    tg_xxxxzz_xxxx_0[j] = pb_x * tg_xxxzz_xxxx_0[j] + fr * tg_xxxzz_xxxx_1[j] + 1.5 * fl1_fx * (tg_xxzz_xxxx_0[j] - tg_xxzz_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xxxzz_xxx_1[j];

                    tg_xxxxzz_xxxy_0[j] = pb_x * tg_xxxzz_xxxy_0[j] + fr * tg_xxxzz_xxxy_1[j] + 1.5 * fl1_fx * (tg_xxzz_xxxy_0[j] - tg_xxzz_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxxzz_xxy_1[j];

                    tg_xxxxzz_xxxz_0[j] = pb_x * tg_xxxzz_xxxz_0[j] + fr * tg_xxxzz_xxxz_1[j] + 1.5 * fl1_fx * (tg_xxzz_xxxz_0[j] - tg_xxzz_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxxzz_xxz_1[j];

                    tg_xxxxzz_xxyy_0[j] = pb_x * tg_xxxzz_xxyy_0[j] + fr * tg_xxxzz_xxyy_1[j] + 1.5 * fl1_fx * (tg_xxzz_xxyy_0[j] - tg_xxzz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xxxzz_xyy_1[j];

                    tg_xxxxzz_xxyz_0[j] = pb_x * tg_xxxzz_xxyz_0[j] + fr * tg_xxxzz_xxyz_1[j] + 1.5 * fl1_fx * (tg_xxzz_xxyz_0[j] - tg_xxzz_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xxxzz_xyz_1[j];

                    tg_xxxxzz_xxzz_0[j] = pb_x * tg_xxxzz_xxzz_0[j] + fr * tg_xxxzz_xxzz_1[j] + 1.5 * fl1_fx * (tg_xxzz_xxzz_0[j] - tg_xxzz_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xxxzz_xzz_1[j];

                    tg_xxxxzz_xyyy_0[j] = pb_x * tg_xxxzz_xyyy_0[j] + fr * tg_xxxzz_xyyy_1[j] + 1.5 * fl1_fx * (tg_xxzz_xyyy_0[j] - tg_xxzz_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxzz_yyy_1[j];

                    tg_xxxxzz_xyyz_0[j] = pb_x * tg_xxxzz_xyyz_0[j] + fr * tg_xxxzz_xyyz_1[j] + 1.5 * fl1_fx * (tg_xxzz_xyyz_0[j] - tg_xxzz_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxzz_yyz_1[j];

                    tg_xxxxzz_xyzz_0[j] = pb_x * tg_xxxzz_xyzz_0[j] + fr * tg_xxxzz_xyzz_1[j] + 1.5 * fl1_fx * (tg_xxzz_xyzz_0[j] - tg_xxzz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxzz_yzz_1[j];
                }
    ...
    void
    compElectronRepulsionForSISG_84_168(      CMemBlock2D<double>* primBuffer,
                                        const CRecursionMap&       recursionMap,
                                        const CMemBlock2D<double>& osFactors,
                                        const CMemBlock2D<double>& wpDistances,
                                        const CGtoPairsBlock&      braGtoPairsBlock,
                                        ...
                                        const int32_t              iContrPair)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                auto tg_xxzz_xzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 84); 

                auto tg_xxzz_yyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 85); 

                auto tg_xxzz_yyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 86); 

                auto tg_xxzz_yyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 87); 

                auto tg_xxzz_yzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 88); 

                auto tg_xxzz_zzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 89); 

                auto tg_xyyy_xxxx_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 90); 

                auto tg_xyyy_xxxy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 91); 

                auto tg_xyyy_xxxz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 92); 

                auto tg_xyyy_xxyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 93); 

                auto tg_xyyy_xxyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 94); 

                auto tg_xyyy_xxzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 95); 

                auto tg_xyyy_xyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 96); 

                auto tg_xyyy_xyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 97); 

                auto tg_xyyy_xyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 98); 

                auto tg_xyyy_xzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 99); 

                auto tg_xyyy_yyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 100); 

                auto tg_xyyy_yyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 101); 

                auto tg_xyyy_yyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 102); 

                auto tg_xyyy_yzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 103); 

                auto tg_xyyy_zzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 104); 

                auto tg_xyyz_xxxx_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 105); 

                auto tg_xyyz_xxxy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 106); 

                auto tg_xyyz_xxxz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 107); 

                auto tg_xyyz_xxyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 108); 

                auto tg_xyyz_xxyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 109); 

                auto tg_xyyz_xxzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 110); 

                auto tg_xyyz_xyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 111); 

                auto tg_xyyz_xyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 112); 

                auto tg_xyyz_xyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 113); 

                auto tg_xyyz_xzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 114); 

                auto tg_xyyz_yyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 115); 

                auto tg_xyyz_yyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 116); 

                auto tg_xyyz_yyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 117); 

                auto tg_xyyz_yzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 118); 

                auto tg_xyyz_zzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 119); 

                auto tg_xyzz_xxxx_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 120); 

                auto tg_xyzz_xxxy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 121); 

                auto tg_xyzz_xxxz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 122); 

                auto tg_xyzz_xxyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 123); 

                auto tg_xyzz_xxyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 124); 

                auto tg_xyzz_xxzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 125); 

                auto tg_xyzz_xyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 126); 

                auto tg_xyzz_xyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 127); 

                auto tg_xyzz_xyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 128); 

                auto tg_xyzz_xzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 129); 

                auto tg_xyzz_yyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 130); 

                auto tg_xyzz_yyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 131); 

                auto tg_xyzz_yyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 132); 

                auto tg_xyzz_yzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 133); 

                auto tg_xyzz_zzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 134); 

                auto tg_xzzz_xxxx_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 135); 

                auto tg_xzzz_xxxy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 136); 

                auto tg_xzzz_xxxz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 137); 

                auto tg_xzzz_xxyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 138); 

                auto tg_xzzz_xxyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 139); 

                auto tg_xzzz_xxzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 140); 

                auto tg_xzzz_xyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 141); 

                auto tg_xzzz_xyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 142); 

                auto tg_xzzz_xyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 143); 

                auto tg_xzzz_xzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 144); 

                auto tg_xzzz_yyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 145); 

                auto tg_xzzz_yyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 146); 

                auto tg_xzzz_yyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 147); 

                auto tg_xzzz_yzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 148); 

                auto tg_xzzz_zzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 149); 

                auto tg_yyyy_xxxx_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 150); 

                auto tg_yyyy_xxxy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 151); 

                auto tg_yyyy_xxxz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 152); 

                auto tg_yyyy_xxyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 153); 

                auto tg_yyyy_xxyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 154); 

                auto tg_yyyy_xxzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 155); 

                auto tg_yyyy_xyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 156); 

                auto tg_yyyy_xyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 157); 

                auto tg_yyyy_xyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 158); 

                auto tg_yyyy_xzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 159); 

                auto tg_yyyy_yyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 160); 

                auto tg_yyyy_yyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 161); 

                auto tg_yyyy_yyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 162); 

                auto tg_yyyy_yzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 163); 

                auto tg_yyyy_zzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 164); 

                auto tg_yyyz_xxxx_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 165); 

                auto tg_yyyz_xxxy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 166); 

                auto tg_yyyz_xxxz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 167); 
                ...
                #pragma omp simd aligned(fxn, fza, tg_xxxxzz_xzzz_0, tg_xxxxzz_yyyy_0, tg_xxxxzz_yyyz_0, \
                                         tg_xxxxzz_yyzz_0, tg_xxxxzz_yzzz_0, tg_xxxxzz_zzzz_0, tg_xxxyyy_xxxx_0, \
                                         tg_xxxyyy_xxxy_0, tg_xxxyyy_xxxz_0, tg_xxxyyy_xxyy_0, tg_xxxyyy_xxyz_0, \
                                         tg_xxxyyy_xxzz_0, tg_xxxyyy_xyyy_0, tg_xxxyyy_xyyz_0, tg_xxxyyy_xyzz_0, \
                                         tg_xxxyyy_xzzz_0, tg_xxxyyy_yyyy_0, tg_xxxyyy_yyyz_0, tg_xxxyyy_yyzz_0, \
                                         tg_xxxyyy_yzzz_0, tg_xxxyyy_zzzz_0, tg_xxxyyz_xxxx_0, tg_xxxyyz_xxxy_0, \
                                         tg_xxxyyz_xxxz_0, tg_xxxyyz_xxyy_0, tg_xxxyyz_xxyz_0, tg_xxxyyz_xxzz_0, \
                                         tg_xxxyyz_xyyy_0, tg_xxxyyz_xyyz_0, tg_xxxyyz_xyzz_0, tg_xxxyyz_xzzz_0, \
                                         tg_xxxyyz_yyyy_0, tg_xxxyyz_yyyz_0, tg_xxxyyz_yyzz_0, tg_xxxyyz_yzzz_0, \
                                         tg_xxxyyz_zzzz_0, tg_xxxyzz_xxxx_0, tg_xxxyzz_xxxy_0, tg_xxxyzz_xxxz_0, \
                                         tg_xxxyzz_xxyy_0, tg_xxxyzz_xxyz_0, tg_xxxyzz_xxzz_0, tg_xxxyzz_xyyy_0, \
                                         tg_xxxyzz_xyyz_0, tg_xxxyzz_xyzz_0, tg_xxxyzz_xzzz_0, tg_xxxyzz_yyyy_0, \
                                         tg_xxxyzz_yyyz_0, tg_xxxyzz_yyzz_0, tg_xxxyzz_yzzz_0, tg_xxxyzz_zzzz_0, \
                                         tg_xxxzz_xzzz_0, tg_xxxzz_xzzz_1, tg_xxxzz_yyyy_0, tg_xxxzz_yyyy_1, tg_xxxzz_yyyz_0, \
                                         tg_xxxzz_yyyz_1, tg_xxxzz_yyzz_0, tg_xxxzz_yyzz_1, tg_xxxzz_yzzz_0, tg_xxxzz_yzzz_1, \
                                         tg_xxxzz_zzz_1, tg_xxxzz_zzzz_0, tg_xxxzz_zzzz_1, tg_xxxzzz_xxxx_0, \
                                         tg_xxxzzz_xxxy_0, tg_xxxzzz_xxxz_0, tg_xxxzzz_xxyy_0, tg_xxxzzz_xxyz_0, \
                                         tg_xxxzzz_xxzz_0, tg_xxxzzz_xyyy_0, tg_xxxzzz_xyyz_0, tg_xxxzzz_xyzz_0, \
                                         tg_xxxzzz_xzzz_0, tg_xxxzzz_yyyy_0, tg_xxxzzz_yyyz_0, tg_xxxzzz_yyzz_0, \
                                         tg_xxxzzz_yzzz_0, tg_xxxzzz_zzzz_0, tg_xxyyy_xxx_1, tg_xxyyy_xxxx_0, tg_xxyyy_xxxx_1, \
                                         tg_xxyyy_xxxy_0, tg_xxyyy_xxxy_1, tg_xxyyy_xxxz_0, tg_xxyyy_xxxz_1, tg_xxyyy_xxy_1, \
                                         tg_xxyyy_xxyy_0, tg_xxyyy_xxyy_1, tg_xxyyy_xxyz_0, tg_xxyyy_xxyz_1, tg_xxyyy_xxz_1, \
                                         tg_xxyyy_xxzz_0, tg_xxyyy_xxzz_1, tg_xxyyy_xyy_1, tg_xxyyy_xyyy_0, tg_xxyyy_xyyy_1, \
                                         tg_xxyyy_xyyz_0, tg_xxyyy_xyyz_1, tg_xxyyy_xyz_1, tg_xxyyy_xyzz_0, tg_xxyyy_xyzz_1, \
                                         tg_xxyyy_xzz_1, tg_xxyyy_xzzz_0, tg_xxyyy_xzzz_1, tg_xxyyy_yyy_1, tg_xxyyy_yyyy_0, \
                                         tg_xxyyy_yyyy_1, tg_xxyyy_yyyz_0, tg_xxyyy_yyyz_1, tg_xxyyy_yyz_1, tg_xxyyy_yyzz_0, \
                                         tg_xxyyy_yyzz_1, tg_xxyyy_yzz_1, tg_xxyyy_yzzz_0, tg_xxyyy_yzzz_1, tg_xxyyy_zzz_1, \
                                         tg_xxyyy_zzzz_0, tg_xxyyy_zzzz_1, tg_xxyyyy_xxxx_0, tg_xxyyyy_xxxy_0, \
                                         ...
                                         tg_xxyyz_xxx_1, tg_xxyyz_xxxx_0, tg_xxyyz_xxxx_1, tg_xxyyz_xxxy_0, tg_xxyyz_xxxy_1, \
                                         tg_xxyyz_xxxz_0, tg_xxyyz_xxxz_1, tg_xxyyz_xxy_1, tg_xxyyz_xxyy_0, tg_xxyyz_xxyy_1, \
                                         tg_xxyyz_xxyz_0, tg_xxyyz_xxyz_1, tg_xxyyz_xxz_1, tg_xxyyz_xxzz_0, tg_xxyyz_xxzz_1, \
                                         tg_xxyyz_xyy_1, tg_xxyyz_xyyy_0, tg_xxyyz_xyyy_1, tg_xxyyz_xyyz_0, tg_xxyyz_xyyz_1, \
                                         tg_xxyyz_xyz_1, tg_xxyyz_xyzz_0, tg_xxyyz_xyzz_1, tg_xxyyz_xzz_1, tg_xxyyz_xzzz_0, \
                                         tg_xxyyz_xzzz_1, tg_xxyyz_yyy_1, tg_xxyyz_yyyy_0, tg_xxyyz_yyyy_1, tg_xxyyz_yyyz_0, \
                                         tg_xxyyz_yyyz_1, tg_xxyyz_yyz_1, tg_xxyyz_yyzz_0, tg_xxyyz_yyzz_1, tg_xxyyz_yzz_1, \
                                         tg_xxyyz_yzzz_0, tg_xxyyz_yzzz_1, tg_xxyyz_zzz_1, tg_xxyyz_zzzz_0, tg_xxyyz_zzzz_1, \
                                         tg_xxyzz_xxx_1, tg_xxyzz_xxxx_0, tg_xxyzz_xxxx_1, tg_xxyzz_xxxy_0, tg_xxyzz_xxxy_1, \
                                         tg_xxyzz_xxxz_0, tg_xxyzz_xxxz_1, tg_xxyzz_xxy_1, tg_xxyzz_xxyy_0, tg_xxyzz_xxyy_1, \
                                         tg_xxyzz_xxyz_0, tg_xxyzz_xxyz_1, tg_xxyzz_xxz_1, tg_xxyzz_xxzz_0, tg_xxyzz_xxzz_1, \
                                         tg_xxyzz_xyy_1, tg_xxyzz_xyyy_0, tg_xxyzz_xyyy_1, tg_xxyzz_xyyz_0, tg_xxyzz_xyyz_1, \
                                         tg_xxyzz_xyz_1, tg_xxyzz_xyzz_0, tg_xxyzz_xyzz_1, tg_xxyzz_xzz_1, tg_xxyzz_xzzz_0, \
                                         tg_xxyzz_xzzz_1, tg_xxyzz_yyy_1, tg_xxyzz_yyyy_0, tg_xxyzz_yyyy_1, tg_xxyzz_yyyz_0, \
                                         tg_xxyzz_yyyz_1, tg_xxyzz_yyz_1, tg_xxyzz_yyzz_0, tg_xxyzz_yyzz_1, tg_xxyzz_yzz_1, \
                                         tg_xxyzz_yzzz_0, tg_xxyzz_yzzz_1, tg_xxyzz_zzz_1, tg_xxyzz_zzzz_0, tg_xxyzz_zzzz_1, \
                                         ...
                                         tg_xxzz_zzzz_0, tg_xxzz_zzzz_1, tg_xxzzz_xxx_1, tg_xxzzz_xxxx_0, tg_xxzzz_xxxx_1, \
                                         tg_xxzzz_xxxy_0, tg_xxzzz_xxxy_1, tg_xxzzz_xxxz_0, tg_xxzzz_xxxz_1, tg_xxzzz_xxy_1, \
                                         tg_xxzzz_xxyy_0, tg_xxzzz_xxyy_1, tg_xxzzz_xxyz_0, tg_xxzzz_xxyz_1, tg_xxzzz_xxz_1, \
                                         tg_xxzzz_xxzz_0, tg_xxzzz_xxzz_1, tg_xxzzz_xyy_1, tg_xxzzz_xyyy_0, tg_xxzzz_xyyy_1, \
                                         tg_xxzzz_xyyz_0, tg_xxzzz_xyyz_1, tg_xxzzz_xyz_1, tg_xxzzz_xyzz_0, tg_xxzzz_xyzz_1, \
                                         tg_xxzzz_xzz_1, tg_xxzzz_xzzz_0, tg_xxzzz_xzzz_1, tg_xxzzz_yyy_1, tg_xxzzz_yyyy_0, \
                                         ...
                                         tg_xxzzz_zzzz_0, tg_xxzzz_zzzz_1, tg_xyyy_xxxx_0, tg_xyyy_xxxx_1, tg_xyyy_xxxy_0, \
                                         tg_xyyy_xxxy_1, tg_xyyy_xxxz_0, tg_xyyy_xxxz_1, tg_xyyy_xxyy_0, tg_xyyy_xxyy_1, \
                                         tg_xyyy_xxyz_0, tg_xyyy_xxyz_1, tg_xyyy_xxzz_0, tg_xyyy_xxzz_1, tg_xyyy_xyyy_0, \
                                         tg_xyyy_xyyy_1, tg_xyyy_xyyz_0, tg_xyyy_xyyz_1, tg_xyyy_xyzz_0, tg_xyyy_xyzz_1, \
                                         tg_xyyy_xzzz_0, tg_xyyy_xzzz_1, tg_xyyy_yyyy_0, tg_xyyy_yyyy_1, tg_xyyy_yyyz_0, \
                                         tg_xyyy_yyyz_1, tg_xyyy_yyzz_0, tg_xyyy_yyzz_1, tg_xyyy_yzzz_0, tg_xyyy_yzzz_1, \
                                         tg_xyyy_zzzz_0, tg_xyyy_zzzz_1, tg_xyyyy_xxx_1, tg_xyyyy_xxxx_0, tg_xyyyy_xxxx_1, \
                                         ...
                                         tg_xyyyz_xxz_1, tg_xyyz_xxxx_0, tg_xyyz_xxxx_1, tg_xyyz_xxxy_0, tg_xyyz_xxxy_1, \
                                         tg_xyyz_xxxz_0, tg_xyyz_xxxz_1, tg_xyyz_xxyy_0, tg_xyyz_xxyy_1, tg_xyyz_xxyz_0, \
                                         tg_xyyz_xxyz_1, tg_xyyz_xxzz_0, tg_xyyz_xxzz_1, tg_xyyz_xyyy_0, tg_xyyz_xyyy_1, \
                                         tg_xyyz_xyyz_0, tg_xyyz_xyyz_1, tg_xyyz_xyzz_0, tg_xyyz_xyzz_1, tg_xyyz_xzzz_0, \
                                         tg_xyyz_xzzz_1, tg_xyyz_yyyy_0, tg_xyyz_yyyy_1, tg_xyyz_yyyz_0, tg_xyyz_yyyz_1, \
                                         tg_xyyz_yyzz_0, tg_xyyz_yyzz_1, tg_xyyz_yzzz_0, tg_xyyz_yzzz_1, tg_xyyz_zzzz_0, \
                                         tg_xyyz_zzzz_1, tg_xyzz_xxxx_0, tg_xyzz_xxxx_1, tg_xyzz_xxxy_0, tg_xyzz_xxxy_1, \
                                         tg_xyzz_xxxz_0, tg_xyzz_xxxz_1, tg_xyzz_xxyy_0, tg_xyzz_xxyy_1, tg_xyzz_xxyz_0, \
                                         tg_xyzz_xxyz_1, tg_xyzz_xxzz_0, tg_xyzz_xxzz_1, tg_xyzz_xyyy_0, tg_xyzz_xyyy_1, \
                                         tg_xyzz_xyyz_0, tg_xyzz_xyyz_1, tg_xyzz_xyzz_0, tg_xyzz_xyzz_1, tg_xyzz_xzzz_0, \
                                         tg_xyzz_xzzz_1, tg_xyzz_yyyy_0, tg_xyzz_yyyy_1, tg_xyzz_yyyz_0, tg_xyzz_yyyz_1, \
                                         tg_xyzz_yyzz_0, tg_xyzz_yyzz_1, tg_xyzz_yzzz_0, tg_xyzz_yzzz_1, tg_xyzz_zzzz_0, \
                                         tg_xyzz_zzzz_1, tg_xzzz_xxxx_0, tg_xzzz_xxxx_1, tg_xzzz_xxxy_0, tg_xzzz_xxxy_1, \
                                         tg_xzzz_xxxz_0, tg_xzzz_xxxz_1, tg_xzzz_xxyy_0, tg_xzzz_xxyy_1, tg_xzzz_xxyz_0, \
                                         tg_xzzz_xxyz_1, tg_xzzz_xxzz_0, tg_xzzz_xxzz_1, tg_xzzz_xyyy_0, tg_xzzz_xyyy_1, \
                                         tg_xzzz_xyyz_0, tg_xzzz_xyyz_1, tg_xzzz_xyzz_0, tg_xzzz_xyzz_1, tg_xzzz_xzzz_0, \
                                         tg_xzzz_xzzz_1, tg_xzzz_yyyy_0, tg_xzzz_yyyy_1, tg_xzzz_yyyz_0, tg_xzzz_yyyz_1, \
                                         tg_xzzz_yyzz_0, tg_xzzz_yyzz_1, tg_xzzz_yzzz_0, tg_xzzz_yzzz_1, tg_xzzz_zzzz_0, \
                                         tg_xzzz_zzzz_1, tg_yyyy_xxxx_0, tg_yyyy_xxxx_1, tg_yyyy_xxxy_0, tg_yyyy_xxxy_1, \
                                         tg_yyyy_xxxz_0, tg_yyyy_xxxz_1, tg_yyyy_xxyy_0, tg_yyyy_xxyy_1, tg_yyyy_xxyz_0, \
                                         tg_yyyy_xxyz_1, tg_yyyy_xxzz_0, tg_yyyy_xxzz_1, tg_yyyy_xyyy_0, tg_yyyy_xyyy_1, \
                                         tg_yyyy_xyyz_0, tg_yyyy_xyyz_1, tg_yyyy_xyzz_0, tg_yyyy_xyzz_1, tg_yyyy_xzzz_0, \
                                         tg_yyyy_xzzz_1, tg_yyyy_yyyy_0, tg_yyyy_yyyy_1, tg_yyyy_yyyz_0, tg_yyyy_yyyz_1, \
                                         tg_yyyy_yyzz_0, tg_yyyy_yyzz_1, tg_yyyy_yzzz_0, tg_yyyy_yzzz_1, tg_yyyy_zzzz_0, \
                                         tg_yyyy_zzzz_1, tg_yyyz_xxxx_0, tg_yyyz_xxxx_1, tg_yyyz_xxxy_0, tg_yyyz_xxxy_1, \
                                         tg_yyyz_xxxz_0, tg_yyyz_xxxz_1, wp_x: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fx = fx;
                    ...
                    tg_xxxxzz_xzzz_0[j] = pb_x * tg_xxxzz_xzzz_0[j] + fr * tg_xxxzz_xzzz_1[j] + 1.5 * fl1_fx * (tg_xxzz_xzzz_0[j] - tg_xxzz_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxxzz_zzz_1[j];

                    tg_xxxxzz_yyyy_0[j] = pb_x * tg_xxxzz_yyyy_0[j] + fr * tg_xxxzz_yyyy_1[j] + 1.5 * fl1_fx * (tg_xxzz_yyyy_0[j] - tg_xxzz_yyyy_1[j] * fl1_fza);

                    tg_xxxxzz_yyyz_0[j] = pb_x * tg_xxxzz_yyyz_0[j] + fr * tg_xxxzz_yyyz_1[j] + 1.5 * fl1_fx * (tg_xxzz_yyyz_0[j] - tg_xxzz_yyyz_1[j] * fl1_fza);

                    tg_xxxxzz_yyzz_0[j] = pb_x * tg_xxxzz_yyzz_0[j] + fr * tg_xxxzz_yyzz_1[j] + 1.5 * fl1_fx * (tg_xxzz_yyzz_0[j] - tg_xxzz_yyzz_1[j] * fl1_fza);

                    tg_xxxxzz_yzzz_0[j] = pb_x * tg_xxxzz_yzzz_0[j] + fr * tg_xxxzz_yzzz_1[j] + 1.5 * fl1_fx * (tg_xxzz_yzzz_0[j] - tg_xxzz_yzzz_1[j] * fl1_fza);

                    tg_xxxxzz_zzzz_0[j] = pb_x * tg_xxxzz_zzzz_0[j] + fr * tg_xxxzz_zzzz_1[j] + 1.5 * fl1_fx * (tg_xxzz_zzzz_0[j] - tg_xxzz_zzzz_1[j] * fl1_fza);

                    tg_xxxyyy_xxxx_0[j] = pb_x * tg_xxyyy_xxxx_0[j] + fr * tg_xxyyy_xxxx_1[j] + fl1_fx * (tg_xyyy_xxxx_0[j] - tg_xyyy_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xxyyy_xxx_1[j];

                    tg_xxxyyy_xxxy_0[j] = pb_x * tg_xxyyy_xxxy_0[j] + fr * tg_xxyyy_xxxy_1[j] + fl1_fx * (tg_xyyy_xxxy_0[j] - tg_xyyy_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxyyy_xxy_1[j];

                    tg_xxxyyy_xxxz_0[j] = pb_x * tg_xxyyy_xxxz_0[j] + fr * tg_xxyyy_xxxz_1[j] + fl1_fx * (tg_xyyy_xxxz_0[j] - tg_xyyy_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxyyy_xxz_1[j];

                    tg_xxxyyy_xxyy_0[j] = pb_x * tg_xxyyy_xxyy_0[j] + fr * tg_xxyyy_xxyy_1[j] + fl1_fx * (tg_xyyy_xxyy_0[j] - tg_xyyy_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xxyyy_xyy_1[j];

                    tg_xxxyyy_xxyz_0[j] = pb_x * tg_xxyyy_xxyz_0[j] + fr * tg_xxyyy_xxyz_1[j] + fl1_fx * (tg_xyyy_xxyz_0[j] - tg_xyyy_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xxyyy_xyz_1[j];

                    tg_xxxyyy_xxzz_0[j] = pb_x * tg_xxyyy_xxzz_0[j] + fr * tg_xxyyy_xxzz_1[j] + fl1_fx * (tg_xyyy_xxzz_0[j] - tg_xyyy_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xxyyy_xzz_1[j];

                    tg_xxxyyy_xyyy_0[j] = pb_x * tg_xxyyy_xyyy_0[j] + fr * tg_xxyyy_xyyy_1[j] + fl1_fx * (tg_xyyy_xyyy_0[j] - tg_xyyy_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxyyy_yyy_1[j];

                    tg_xxxyyy_xyyz_0[j] = pb_x * tg_xxyyy_xyyz_0[j] + fr * tg_xxyyy_xyyz_1[j] + fl1_fx * (tg_xyyy_xyyz_0[j] - tg_xyyy_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxyyy_yyz_1[j];

                    tg_xxxyyy_xyzz_0[j] = pb_x * tg_xxyyy_xyzz_0[j] + fr * tg_xxyyy_xyzz_1[j] + fl1_fx * (tg_xyyy_xyzz_0[j] - tg_xyyy_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxyyy_yzz_1[j];

                    tg_xxxyyy_xzzz_0[j] = pb_x * tg_xxyyy_xzzz_0[j] + fr * tg_xxyyy_xzzz_1[j] + fl1_fx * (tg_xyyy_xzzz_0[j] - tg_xyyy_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxyyy_zzz_1[j];

                    tg_xxxyyy_yyyy_0[j] = pb_x * tg_xxyyy_yyyy_0[j] + fr * tg_xxyyy_yyyy_1[j] + fl1_fx * (tg_xyyy_yyyy_0[j] - tg_xyyy_yyyy_1[j] * fl1_fza);

                    tg_xxxyyy_yyyz_0[j] = pb_x * tg_xxyyy_yyyz_0[j] + fr * tg_xxyyy_yyyz_1[j] + fl1_fx * (tg_xyyy_yyyz_0[j] - tg_xyyy_yyyz_1[j] * fl1_fza);

                    tg_xxxyyy_yyzz_0[j] = pb_x * tg_xxyyy_yyzz_0[j] + fr * tg_xxyyy_yyzz_1[j] + fl1_fx * (tg_xyyy_yyzz_0[j] - tg_xyyy_yyzz_1[j] * fl1_fza);

                    tg_xxxyyy_yzzz_0[j] = pb_x * tg_xxyyy_yzzz_0[j] + fr * tg_xxyyy_yzzz_1[j] + fl1_fx * (tg_xyyy_yzzz_0[j] - tg_xyyy_yzzz_1[j] * fl1_fza);

                    tg_xxxyyy_zzzz_0[j] = pb_x * tg_xxyyy_zzzz_0[j] + fr * tg_xxyyy_zzzz_1[j] + fl1_fx * (tg_xyyy_zzzz_0[j] - tg_xyyy_zzzz_1[j] * fl1_fza);

                    tg_xxxyyz_xxxx_0[j] = pb_x * tg_xxyyz_xxxx_0[j] + fr * tg_xxyyz_xxxx_1[j] + fl1_fx * (tg_xyyz_xxxx_0[j] - tg_xyyz_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xxyyz_xxx_1[j];

                    tg_xxxyyz_xxxy_0[j] = pb_x * tg_xxyyz_xxxy_0[j] + fr * tg_xxyyz_xxxy_1[j] + fl1_fx * (tg_xyyz_xxxy_0[j] - tg_xyyz_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxyyz_xxy_1[j];

                    tg_xxxyyz_xxxz_0[j] = pb_x * tg_xxyyz_xxxz_0[j] + fr * tg_xxyyz_xxxz_1[j] + fl1_fx * (tg_xyyz_xxxz_0[j] - tg_xyyz_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxyyz_xxz_1[j];

                    tg_xxxyyz_xxyy_0[j] = pb_x * tg_xxyyz_xxyy_0[j] + fr * tg_xxyyz_xxyy_1[j] + fl1_fx * (tg_xyyz_xxyy_0[j] - tg_xyyz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xxyyz_xyy_1[j];

                    tg_xxxyyz_xxyz_0[j] = pb_x * tg_xxyyz_xxyz_0[j] + fr * tg_xxyyz_xxyz_1[j] + fl1_fx * (tg_xyyz_xxyz_0[j] - tg_xyyz_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xxyyz_xyz_1[j];

                    tg_xxxyyz_xxzz_0[j] = pb_x * tg_xxyyz_xxzz_0[j] + fr * tg_xxyyz_xxzz_1[j] + fl1_fx * (tg_xyyz_xxzz_0[j] - tg_xyyz_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xxyyz_xzz_1[j];

                    tg_xxxyyz_xyyy_0[j] = pb_x * tg_xxyyz_xyyy_0[j] + fr * tg_xxyyz_xyyy_1[j] + fl1_fx * (tg_xyyz_xyyy_0[j] - tg_xyyz_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxyyz_yyy_1[j];

                    tg_xxxyyz_xyyz_0[j] = pb_x * tg_xxyyz_xyyz_0[j] + fr * tg_xxyyz_xyyz_1[j] + fl1_fx * (tg_xyyz_xyyz_0[j] - tg_xyyz_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxyyz_yyz_1[j];

                    tg_xxxyyz_xyzz_0[j] = pb_x * tg_xxyyz_xyzz_0[j] + fr * tg_xxyyz_xyzz_1[j] + fl1_fx * (tg_xyyz_xyzz_0[j] - tg_xyyz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxyyz_yzz_1[j];

                    tg_xxxyyz_xzzz_0[j] = pb_x * tg_xxyyz_xzzz_0[j] + fr * tg_xxyyz_xzzz_1[j] + fl1_fx * (tg_xyyz_xzzz_0[j] - tg_xyyz_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxyyz_zzz_1[j];

                    tg_xxxyyz_yyyy_0[j] = pb_x * tg_xxyyz_yyyy_0[j] + fr * tg_xxyyz_yyyy_1[j] + fl1_fx * (tg_xyyz_yyyy_0[j] - tg_xyyz_yyyy_1[j] * fl1_fza);

                    tg_xxxyyz_yyyz_0[j] = pb_x * tg_xxyyz_yyyz_0[j] + fr * tg_xxyyz_yyyz_1[j] + fl1_fx * (tg_xyyz_yyyz_0[j] - tg_xyyz_yyyz_1[j] * fl1_fza);

                    tg_xxxyyz_yyzz_0[j] = pb_x * tg_xxyyz_yyzz_0[j] + fr * tg_xxyyz_yyzz_1[j] + fl1_fx * (tg_xyyz_yyzz_0[j] - tg_xyyz_yyzz_1[j] * fl1_fza);

                    tg_xxxyyz_yzzz_0[j] = pb_x * tg_xxyyz_yzzz_0[j] + fr * tg_xxyyz_yzzz_1[j] + fl1_fx * (tg_xyyz_yzzz_0[j] - tg_xyyz_yzzz_1[j] * fl1_fza);

                    tg_xxxyyz_zzzz_0[j] = pb_x * tg_xxyyz_zzzz_0[j] + fr * tg_xxyyz_zzzz_1[j] + fl1_fx * (tg_xyyz_zzzz_0[j] - tg_xyyz_zzzz_1[j] * fl1_fza);

                    tg_xxxyzz_xxxx_0[j] = pb_x * tg_xxyzz_xxxx_0[j] + fr * tg_xxyzz_xxxx_1[j] + fl1_fx * (tg_xyzz_xxxx_0[j] - tg_xyzz_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xxyzz_xxx_1[j];

                    tg_xxxyzz_xxxy_0[j] = pb_x * tg_xxyzz_xxxy_0[j] + fr * tg_xxyzz_xxxy_1[j] + fl1_fx * (tg_xyzz_xxxy_0[j] - tg_xyzz_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxyzz_xxy_1[j];

                    tg_xxxyzz_xxxz_0[j] = pb_x * tg_xxyzz_xxxz_0[j] + fr * tg_xxyzz_xxxz_1[j] + fl1_fx * (tg_xyzz_xxxz_0[j] - tg_xyzz_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxyzz_xxz_1[j];

                    tg_xxxyzz_xxyy_0[j] = pb_x * tg_xxyzz_xxyy_0[j] + fr * tg_xxyzz_xxyy_1[j] + fl1_fx * (tg_xyzz_xxyy_0[j] - tg_xyzz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xxyzz_xyy_1[j];

                    tg_xxxyzz_xxyz_0[j] = pb_x * tg_xxyzz_xxyz_0[j] + fr * tg_xxyzz_xxyz_1[j] + fl1_fx * (tg_xyzz_xxyz_0[j] - tg_xyzz_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xxyzz_xyz_1[j];

                    tg_xxxyzz_xxzz_0[j] = pb_x * tg_xxyzz_xxzz_0[j] + fr * tg_xxyzz_xxzz_1[j] + fl1_fx * (tg_xyzz_xxzz_0[j] - tg_xyzz_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xxyzz_xzz_1[j];

                    tg_xxxyzz_xyyy_0[j] = pb_x * tg_xxyzz_xyyy_0[j] + fr * tg_xxyzz_xyyy_1[j] + fl1_fx * (tg_xyzz_xyyy_0[j] - tg_xyzz_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxyzz_yyy_1[j];

                    tg_xxxyzz_xyyz_0[j] = pb_x * tg_xxyzz_xyyz_0[j] + fr * tg_xxyzz_xyyz_1[j] + fl1_fx * (tg_xyzz_xyyz_0[j] - tg_xyzz_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxyzz_yyz_1[j];

                    tg_xxxyzz_xyzz_0[j] = pb_x * tg_xxyzz_xyzz_0[j] + fr * tg_xxyzz_xyzz_1[j] + fl1_fx * (tg_xyzz_xyzz_0[j] - tg_xyzz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxyzz_yzz_1[j];

                    tg_xxxyzz_xzzz_0[j] = pb_x * tg_xxyzz_xzzz_0[j] + fr * tg_xxyzz_xzzz_1[j] + fl1_fx * (tg_xyzz_xzzz_0[j] - tg_xyzz_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxyzz_zzz_1[j];

                    tg_xxxyzz_yyyy_0[j] = pb_x * tg_xxyzz_yyyy_0[j] + fr * tg_xxyzz_yyyy_1[j] + fl1_fx * (tg_xyzz_yyyy_0[j] - tg_xyzz_yyyy_1[j] * fl1_fza);

                    tg_xxxyzz_yyyz_0[j] = pb_x * tg_xxyzz_yyyz_0[j] + fr * tg_xxyzz_yyyz_1[j] + fl1_fx * (tg_xyzz_yyyz_0[j] - tg_xyzz_yyyz_1[j] * fl1_fza);

                    tg_xxxyzz_yyzz_0[j] = pb_x * tg_xxyzz_yyzz_0[j] + fr * tg_xxyzz_yyzz_1[j] + fl1_fx * (tg_xyzz_yyzz_0[j] - tg_xyzz_yyzz_1[j] * fl1_fza);

                    tg_xxxyzz_yzzz_0[j] = pb_x * tg_xxyzz_yzzz_0[j] + fr * tg_xxyzz_yzzz_1[j] + fl1_fx * (tg_xyzz_yzzz_0[j] - tg_xyzz_yzzz_1[j] * fl1_fza);

                    tg_xxxyzz_zzzz_0[j] = pb_x * tg_xxyzz_zzzz_0[j] + fr * tg_xxyzz_zzzz_1[j] + fl1_fx * (tg_xyzz_zzzz_0[j] - tg_xyzz_zzzz_1[j] * fl1_fza);

                    tg_xxxzzz_xxxx_0[j] = pb_x * tg_xxzzz_xxxx_0[j] + fr * tg_xxzzz_xxxx_1[j] + fl1_fx * (tg_xzzz_xxxx_0[j] - tg_xzzz_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xxzzz_xxx_1[j];

                    tg_xxxzzz_xxxy_0[j] = pb_x * tg_xxzzz_xxxy_0[j] + fr * tg_xxzzz_xxxy_1[j] + fl1_fx * (tg_xzzz_xxxy_0[j] - tg_xzzz_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxzzz_xxy_1[j];

                    tg_xxxzzz_xxxz_0[j] = pb_x * tg_xxzzz_xxxz_0[j] + fr * tg_xxzzz_xxxz_1[j] + fl1_fx * (tg_xzzz_xxxz_0[j] - tg_xzzz_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xxzzz_xxz_1[j];

                    tg_xxxzzz_xxyy_0[j] = pb_x * tg_xxzzz_xxyy_0[j] + fr * tg_xxzzz_xxyy_1[j] + fl1_fx * (tg_xzzz_xxyy_0[j] - tg_xzzz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xxzzz_xyy_1[j];

                    tg_xxxzzz_xxyz_0[j] = pb_x * tg_xxzzz_xxyz_0[j] + fr * tg_xxzzz_xxyz_1[j] + fl1_fx * (tg_xzzz_xxyz_0[j] - tg_xzzz_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xxzzz_xyz_1[j];

                    tg_xxxzzz_xxzz_0[j] = pb_x * tg_xxzzz_xxzz_0[j] + fr * tg_xxzzz_xxzz_1[j] + fl1_fx * (tg_xzzz_xxzz_0[j] - tg_xzzz_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xxzzz_xzz_1[j];

                    tg_xxxzzz_xyyy_0[j] = pb_x * tg_xxzzz_xyyy_0[j] + fr * tg_xxzzz_xyyy_1[j] + fl1_fx * (tg_xzzz_xyyy_0[j] - tg_xzzz_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxzzz_yyy_1[j];

                    tg_xxxzzz_xyyz_0[j] = pb_x * tg_xxzzz_xyyz_0[j] + fr * tg_xxzzz_xyyz_1[j] + fl1_fx * (tg_xzzz_xyyz_0[j] - tg_xzzz_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxzzz_yyz_1[j];

                    tg_xxxzzz_xyzz_0[j] = pb_x * tg_xxzzz_xyzz_0[j] + fr * tg_xxzzz_xyzz_1[j] + fl1_fx * (tg_xzzz_xyzz_0[j] - tg_xzzz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxzzz_yzz_1[j];

                    tg_xxxzzz_xzzz_0[j] = pb_x * tg_xxzzz_xzzz_0[j] + fr * tg_xxzzz_xzzz_1[j] + fl1_fx * (tg_xzzz_xzzz_0[j] - tg_xzzz_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xxzzz_zzz_1[j];

                    tg_xxxzzz_yyyy_0[j] = pb_x * tg_xxzzz_yyyy_0[j] + fr * tg_xxzzz_yyyy_1[j] + fl1_fx * (tg_xzzz_yyyy_0[j] - tg_xzzz_yyyy_1[j] * fl1_fza);

                    tg_xxxzzz_yyyz_0[j] = pb_x * tg_xxzzz_yyyz_0[j] + fr * tg_xxzzz_yyyz_1[j] + fl1_fx * (tg_xzzz_yyyz_0[j] - tg_xzzz_yyyz_1[j] * fl1_fza);

                    tg_xxxzzz_yyzz_0[j] = pb_x * tg_xxzzz_yyzz_0[j] + fr * tg_xxzzz_yyzz_1[j] + fl1_fx * (tg_xzzz_yyzz_0[j] - tg_xzzz_yyzz_1[j] * fl1_fza);

                    tg_xxxzzz_yzzz_0[j] = pb_x * tg_xxzzz_yzzz_0[j] + fr * tg_xxzzz_yzzz_1[j] + fl1_fx * (tg_xzzz_yzzz_0[j] - tg_xzzz_yzzz_1[j] * fl1_fza);

                    tg_xxxzzz_zzzz_0[j] = pb_x * tg_xxzzz_zzzz_0[j] + fr * tg_xxzzz_zzzz_1[j] + fl1_fx * (tg_xzzz_zzzz_0[j] - tg_xzzz_zzzz_1[j] * fl1_fza);

                    tg_xxyyyy_xxxx_0[j] = pb_x * tg_xyyyy_xxxx_0[j] + fr * tg_xyyyy_xxxx_1[j] + 0.5 * fl1_fx * (tg_yyyy_xxxx_0[j] - tg_yyyy_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xyyyy_xxx_1[j];

                    tg_xxyyyy_xxxy_0[j] = pb_x * tg_xyyyy_xxxy_0[j] + fr * tg_xyyyy_xxxy_1[j] + 0.5 * fl1_fx * (tg_yyyy_xxxy_0[j] - tg_yyyy_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xyyyy_xxy_1[j];

                    tg_xxyyyy_xxxz_0[j] = pb_x * tg_xyyyy_xxxz_0[j] + fr * tg_xyyyy_xxxz_1[j] + 0.5 * fl1_fx * (tg_yyyy_xxxz_0[j] - tg_yyyy_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xyyyy_xxz_1[j];

                    tg_xxyyyy_xxyy_0[j] = pb_x * tg_xyyyy_xxyy_0[j] + fr * tg_xyyyy_xxyy_1[j] + 0.5 * fl1_fx * (tg_yyyy_xxyy_0[j] - tg_yyyy_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xyyyy_xyy_1[j];

                    tg_xxyyyy_xxyz_0[j] = pb_x * tg_xyyyy_xxyz_0[j] + fr * tg_xyyyy_xxyz_1[j] + 0.5 * fl1_fx * (tg_yyyy_xxyz_0[j] - tg_yyyy_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xyyyy_xyz_1[j];

                    tg_xxyyyy_xxzz_0[j] = pb_x * tg_xyyyy_xxzz_0[j] + fr * tg_xyyyy_xxzz_1[j] + 0.5 * fl1_fx * (tg_yyyy_xxzz_0[j] - tg_yyyy_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xyyyy_xzz_1[j];

                    tg_xxyyyy_xyyy_0[j] = pb_x * tg_xyyyy_xyyy_0[j] + fr * tg_xyyyy_xyyy_1[j] + 0.5 * fl1_fx * (tg_yyyy_xyyy_0[j] - tg_yyyy_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyyyy_yyy_1[j];

                    tg_xxyyyy_xyyz_0[j] = pb_x * tg_xyyyy_xyyz_0[j] + fr * tg_xyyyy_xyyz_1[j] + 0.5 * fl1_fx * (tg_yyyy_xyyz_0[j] - tg_yyyy_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyyyy_yyz_1[j];

                    tg_xxyyyy_xyzz_0[j] = pb_x * tg_xyyyy_xyzz_0[j] + fr * tg_xyyyy_xyzz_1[j] + 0.5 * fl1_fx * (tg_yyyy_xyzz_0[j] - tg_yyyy_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyyyy_yzz_1[j];

                    tg_xxyyyy_xzzz_0[j] = pb_x * tg_xyyyy_xzzz_0[j] + fr * tg_xyyyy_xzzz_1[j] + 0.5 * fl1_fx * (tg_yyyy_xzzz_0[j] - tg_yyyy_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyyyy_zzz_1[j];

                    tg_xxyyyy_yyyy_0[j] = pb_x * tg_xyyyy_yyyy_0[j] + fr * tg_xyyyy_yyyy_1[j] + 0.5 * fl1_fx * (tg_yyyy_yyyy_0[j] - tg_yyyy_yyyy_1[j] * fl1_fza);

                    tg_xxyyyy_yyyz_0[j] = pb_x * tg_xyyyy_yyyz_0[j] + fr * tg_xyyyy_yyyz_1[j] + 0.5 * fl1_fx * (tg_yyyy_yyyz_0[j] - tg_yyyy_yyyz_1[j] * fl1_fza);

                    tg_xxyyyy_yyzz_0[j] = pb_x * tg_xyyyy_yyzz_0[j] + fr * tg_xyyyy_yyzz_1[j] + 0.5 * fl1_fx * (tg_yyyy_yyzz_0[j] - tg_yyyy_yyzz_1[j] * fl1_fza);

                    tg_xxyyyy_yzzz_0[j] = pb_x * tg_xyyyy_yzzz_0[j] + fr * tg_xyyyy_yzzz_1[j] + 0.5 * fl1_fx * (tg_yyyy_yzzz_0[j] - tg_yyyy_yzzz_1[j] * fl1_fza);

                    tg_xxyyyy_zzzz_0[j] = pb_x * tg_xyyyy_zzzz_0[j] + fr * tg_xyyyy_zzzz_1[j] + 0.5 * fl1_fx * (tg_yyyy_zzzz_0[j] - tg_yyyy_zzzz_1[j] * fl1_fza);

                    tg_xxyyyz_xxxx_0[j] = pb_x * tg_xyyyz_xxxx_0[j] + fr * tg_xyyyz_xxxx_1[j] + 0.5 * fl1_fx * (tg_yyyz_xxxx_0[j] - tg_yyyz_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xyyyz_xxx_1[j];

                    tg_xxyyyz_xxxy_0[j] = pb_x * tg_xyyyz_xxxy_0[j] + fr * tg_xyyyz_xxxy_1[j] + 0.5 * fl1_fx * (tg_yyyz_xxxy_0[j] - tg_yyyz_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xyyyz_xxy_1[j];

                    tg_xxyyyz_xxxz_0[j] = pb_x * tg_xyyyz_xxxz_0[j] + fr * tg_xyyyz_xxxz_1[j] + 0.5 * fl1_fx * (tg_yyyz_xxxz_0[j] - tg_yyyz_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xyyyz_xxz_1[j];
                }
    ...
    void
    compElectronRepulsionForSISG_168_252(      CMemBlock2D<double>* primBuffer,
                                         const CRecursionMap&       recursionMap,
                                         const CMemBlock2D<double>& osFactors,
                                         const CMemBlock2D<double>& wpDistances,
                                         const CGtoPairsBlock&      braGtoPairsBlock,
                                         ...
                                         const int32_t              iContrPair)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                auto tg_yyyz_xxyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 168); 

                auto tg_yyyz_xxyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 169); 

                auto tg_yyyz_xxzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 170); 

                auto tg_yyyz_xyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 171); 

                auto tg_yyyz_xyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 172); 

                auto tg_yyyz_xyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 173); 

                auto tg_yyyz_xzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 174); 

                auto tg_yyyz_yyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 175); 

                auto tg_yyyz_yyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 176); 

                auto tg_yyyz_yyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 177); 

                auto tg_yyyz_yzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 178); 

                auto tg_yyyz_zzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 179); 

                auto tg_yyzz_xxxx_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 180); 

                auto tg_yyzz_xxxy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 181); 

                auto tg_yyzz_xxxz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 182); 

                auto tg_yyzz_xxyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 183); 

                auto tg_yyzz_xxyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 184); 

                auto tg_yyzz_xxzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 185); 

                auto tg_yyzz_xyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 186); 

                auto tg_yyzz_xyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 187); 

                auto tg_yyzz_xyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 188); 

                auto tg_yyzz_xzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 189); 

                auto tg_yyzz_yyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 190); 

                auto tg_yyzz_yyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 191); 

                auto tg_yyzz_yyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 192); 

                auto tg_yyzz_yzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 193); 

                auto tg_yyzz_zzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 194); 

                auto tg_yzzz_xxxx_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 195); 

                auto tg_yzzz_xxxy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 196); 

                auto tg_yzzz_xxxz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 197); 

                auto tg_yzzz_xxyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 198); 

                auto tg_yzzz_xxyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 199); 

                auto tg_yzzz_xxzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 200); 

                auto tg_yzzz_xyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 201); 

                auto tg_yzzz_xyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 202); 

                auto tg_yzzz_xyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 203); 

                auto tg_yzzz_xzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 204); 

                auto tg_yzzz_yyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 205); 

                auto tg_yzzz_yyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 206); 

                auto tg_yzzz_yyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 207); 

                auto tg_yzzz_yzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 208); 

                auto tg_yzzz_zzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 209); 

                auto tg_zzzz_xxxx_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 210); 

                auto tg_zzzz_xxxy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 211); 

                auto tg_zzzz_xxxz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 212); 

                auto tg_zzzz_xxyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 213); 

                auto tg_zzzz_xxyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 214); 

                auto tg_zzzz_xxzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 215); 

                auto tg_zzzz_xyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 216); 

                auto tg_zzzz_xyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 217); 

                auto tg_zzzz_xyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 218); 

                auto tg_zzzz_xzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 219); 

                auto tg_zzzz_yyyy_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 220); 

                auto tg_zzzz_yyyz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 221); 

                auto tg_zzzz_yyzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 222); 

                auto tg_zzzz_yzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 223); 

                auto tg_zzzz_zzzz_0 = primBuffer[pidx_g_4_4_m0].data(225 * idx + 224); 
                ...
                #pragma omp simd aligned(fxn, fza, tg_xxyyyz_xxyy_0, tg_xxyyyz_xxyz_0, tg_xxyyyz_xxzz_0, \
                                         tg_xxyyyz_xyyy_0, tg_xxyyyz_xyyz_0, tg_xxyyyz_xyzz_0, tg_xxyyyz_xzzz_0, \
                                         tg_xxyyyz_yyyy_0, tg_xxyyyz_yyyz_0, tg_xxyyyz_yyzz_0, tg_xxyyyz_yzzz_0, \
                                         tg_xxyyyz_zzzz_0, tg_xxyyzz_xxxx_0, tg_xxyyzz_xxxy_0, tg_xxyyzz_xxxz_0, \
                                         tg_xxyyzz_xxyy_0, tg_xxyyzz_xxyz_0, tg_xxyyzz_xxzz_0, tg_xxyyzz_xyyy_0, \
                                         tg_xxyyzz_xyyz_0, tg_xxyyzz_xyzz_0, tg_xxyyzz_xzzz_0, tg_xxyyzz_yyyy_0, \
                                         ...
                                         tg_xyyyyy_yyyy_0, tg_xyyyyy_yyyz_0, tg_xyyyyy_yyzz_0, tg_xyyyyy_yzzz_0, \
                                         tg_xyyyyy_zzzz_0, tg_xyyyyz_xxxx_0, tg_xyyyyz_xxxy_0, tg_xyyyyz_xxxz_0, \
                                         tg_xyyyyz_xxyy_0, tg_xyyyyz_xxyz_0, tg_xyyyyz_xxzz_0, tg_xyyyyz_xyyy_0, \
                                         tg_xyyyyz_xyyz_0, tg_xyyyyz_xyzz_0, tg_xyyyyz_xzzz_0, tg_xyyyyz_yyyy_0, \
                                         tg_xyyyyz_yyyz_0, tg_xyyyz_xxyy_0, tg_xyyyz_xxyy_1, tg_xyyyz_xxyz_0, tg_xyyyz_xxyz_1, \
                                         ...
                                         tg_xyyzz_xyyz_0, tg_xyyzz_xyyz_1, tg_xyyzz_xyz_1, tg_xyyzz_xyzz_0, tg_xyyzz_xyzz_1, \
                                         tg_xyyzz_xzz_1, tg_xyyzz_xzzz_0, tg_xyyzz_xzzz_1, tg_xyyzz_yyy_1, tg_xyyzz_yyyy_0, \
                                         tg_xyyzz_yyyy_1, tg_xyyzz_yyyz_0, tg_xyyzz_yyyz_1, tg_xyyzz_yyz_1, tg_xyyzz_yyzz_0, \
                                         tg_xyyzz_yyzz_1, tg_xyyzz_yzz_1, tg_xyyzz_yzzz_0, tg_xyyzz_yzzz_1, tg_xyyzz_zzz_1, \
                                         tg_xyyzz_zzzz_0, tg_xyyzz_zzzz_1, tg_xyzzz_xxx_1, tg_xyzzz_xxxx_0, tg_xyzzz_xxxx_1, \
                                         tg_xyzzz_xxxy_0, tg_xyzzz_xxxy_1, tg_xyzzz_xxxz_0, tg_xyzzz_xxxz_1, tg_xyzzz_xxy_1, \
                                         tg_xyzzz_xxyy_0, tg_xyzzz_xxyy_1, tg_xyzzz_xxyz_0, tg_xyzzz_xxyz_1, tg_xyzzz_xxz_1, \
                                         tg_xyzzz_xxzz_0, tg_xyzzz_xxzz_1, tg_xyzzz_xyy_1, tg_xyzzz_xyyy_0, tg_xyzzz_xyyy_1, \
                                         tg_xyzzz_xyyz_0, tg_xyzzz_xyyz_1, tg_xyzzz_xyz_1, tg_xyzzz_xyzz_0, tg_xyzzz_xyzz_1, \
                                         tg_xyzzz_xzz_1, tg_xyzzz_xzzz_0, tg_xyzzz_xzzz_1, tg_xyzzz_yyy_1, tg_xyzzz_yyyy_0, \
                                         tg_xyzzz_yyyy_1, tg_xyzzz_yyyz_0, tg_xyzzz_yyyz_1, tg_xyzzz_yyz_1, tg_xyzzz_yyzz_0, \
                                         tg_xyzzz_yyzz_1, tg_xyzzz_yzz_1, tg_xyzzz_yzzz_0, tg_xyzzz_yzzz_1, tg_xyzzz_zzz_1, \
                                         tg_xyzzz_zzzz_0, tg_xyzzz_zzzz_1, tg_xzzzz_xxx_1, tg_xzzzz_xxxx_0, tg_xzzzz_xxxx_1, \
                                         tg_xzzzz_xxxy_0, tg_xzzzz_xxxy_1, tg_xzzzz_xxxz_0, tg_xzzzz_xxxz_1, tg_xzzzz_xxy_1, \
                                         tg_xzzzz_xxyy_0, tg_xzzzz_xxyy_1, tg_xzzzz_xxyz_0, tg_xzzzz_xxyz_1, tg_xzzzz_xxz_1, \
                                         tg_xzzzz_xxzz_0, tg_xzzzz_xxzz_1, tg_xzzzz_xyy_1, tg_xzzzz_xyyy_0, tg_xzzzz_xyyy_1, \
                                         tg_xzzzz_xyyz_0, tg_xzzzz_xyyz_1, tg_xzzzz_xyz_1, tg_xzzzz_xyzz_0, tg_xzzzz_xyzz_1, \
                                         tg_xzzzz_xzz_1, tg_xzzzz_xzzz_0, tg_xzzzz_xzzz_1, tg_xzzzz_yyy_1, tg_xzzzz_yyyy_0, \
                                         tg_xzzzz_yyyy_1, tg_xzzzz_yyyz_0, tg_xzzzz_yyyz_1, tg_xzzzz_yyz_1, tg_xzzzz_yyzz_0, \
                                         tg_xzzzz_yyzz_1, tg_xzzzz_yzz_1, tg_xzzzz_yzzz_0, tg_xzzzz_yzzz_1, tg_xzzzz_zzz_1, \
                                         tg_xzzzz_zzzz_0, tg_xzzzz_zzzz_1, tg_yyyyy_xxx_1, tg_yyyyy_xxxx_0, tg_yyyyy_xxxx_1, \
                                         tg_yyyyy_xxxy_0, tg_yyyyy_xxxy_1, tg_yyyyy_xxxz_0, tg_yyyyy_xxxz_1, tg_yyyyy_xxy_1, \
                                         tg_yyyyy_xxyy_0, tg_yyyyy_xxyy_1, tg_yyyyy_xxyz_0, tg_yyyyy_xxyz_1, tg_yyyyy_xxz_1, \
                                         tg_yyyyy_xxzz_0, tg_yyyyy_xxzz_1, tg_yyyyy_xyy_1, tg_yyyyy_xyyy_0, tg_yyyyy_xyyy_1, \
                                         tg_yyyyy_xyyz_0, tg_yyyyy_xyyz_1, tg_yyyyy_xyz_1, tg_yyyyy_xyzz_0, tg_yyyyy_xyzz_1, \
                                         tg_yyyyy_xzz_1, tg_yyyyy_xzzz_0, tg_yyyyy_xzzz_1, tg_yyyyy_yyy_1, tg_yyyyy_yyyy_0, \
                                         tg_yyyyy_yyyy_1, tg_yyyyy_yyyz_0, tg_yyyyy_yyyz_1, tg_yyyyy_yyz_1, tg_yyyyy_yyzz_0, \
                                         tg_yyyyy_yyzz_1, tg_yyyyy_yzz_1, tg_yyyyy_yzzz_0, tg_yyyyy_yzzz_1, tg_yyyyy_zzz_1, \
                                         tg_yyyyy_zzzz_0, tg_yyyyy_zzzz_1, tg_yyyyz_xxx_1, tg_yyyyz_xxxx_0, tg_yyyyz_xxxx_1, \
                                         ...
                                         tg_yyyyz_yyyy_1, tg_yyyyz_yyyz_0, tg_yyyyz_yyyz_1, tg_yyyyz_yyz_1, tg_yyyyz_yzz_1, \
                                         tg_yyyyz_zzz_1, tg_yyyz_xxyy_0, tg_yyyz_xxyy_1, tg_yyyz_xxyz_0, tg_yyyz_xxyz_1, \
                                         tg_yyyz_xxzz_0, tg_yyyz_xxzz_1, tg_yyyz_xyyy_0, tg_yyyz_xyyy_1, tg_yyyz_xyyz_0, \
                                         tg_yyyz_xyyz_1, tg_yyyz_xyzz_0, tg_yyyz_xyzz_1, tg_yyyz_xzzz_0, tg_yyyz_xzzz_1, \
                                         tg_yyyz_yyyy_0, tg_yyyz_yyyy_1, tg_yyyz_yyyz_0, tg_yyyz_yyyz_1, tg_yyyz_yyzz_0, \
                                         tg_yyyz_yyzz_1, tg_yyyz_yzzz_0, tg_yyyz_yzzz_1, tg_yyyz_zzzz_0, tg_yyyz_zzzz_1, \
                                         tg_yyzz_xxxx_0, tg_yyzz_xxxx_1, tg_yyzz_xxxy_0, tg_yyzz_xxxy_1, tg_yyzz_xxxz_0, \
                                         tg_yyzz_xxxz_1, tg_yyzz_xxyy_0, tg_yyzz_xxyy_1, tg_yyzz_xxyz_0, tg_yyzz_xxyz_1, \
                                         tg_yyzz_xxzz_0, tg_yyzz_xxzz_1, tg_yyzz_xyyy_0, tg_yyzz_xyyy_1, tg_yyzz_xyyz_0, \
                                         tg_yyzz_xyyz_1, tg_yyzz_xyzz_0, tg_yyzz_xyzz_1, tg_yyzz_xzzz_0, tg_yyzz_xzzz_1, \
                ...
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    ...
                    tg_xxyyyz_xxyy_0[j] = pb_x * tg_xyyyz_xxyy_0[j] + fr * tg_xyyyz_xxyy_1[j] + 0.5 * fl1_fx * (tg_yyyz_xxyy_0[j] - tg_yyyz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xyyyz_xyy_1[j];

                    tg_xxyyyz_xxyz_0[j] = pb_x * tg_xyyyz_xxyz_0[j] + fr * tg_xyyyz_xxyz_1[j] + 0.5 * fl1_fx * (tg_yyyz_xxyz_0[j] - tg_yyyz_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xyyyz_xyz_1[j];

                    tg_xxyyyz_xxzz_0[j] = pb_x * tg_xyyyz_xxzz_0[j] + fr * tg_xyyyz_xxzz_1[j] + 0.5 * fl1_fx * (tg_yyyz_xxzz_0[j] - tg_yyyz_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xyyyz_xzz_1[j];

                    tg_xxyyyz_xyyy_0[j] = pb_x * tg_xyyyz_xyyy_0[j] + fr * tg_xyyyz_xyyy_1[j] + 0.5 * fl1_fx * (tg_yyyz_xyyy_0[j] - tg_yyyz_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyyyz_yyy_1[j];

                    tg_xxyyyz_xyyz_0[j] = pb_x * tg_xyyyz_xyyz_0[j] + fr * tg_xyyyz_xyyz_1[j] + 0.5 * fl1_fx * (tg_yyyz_xyyz_0[j] - tg_yyyz_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyyyz_yyz_1[j];

                    tg_xxyyyz_xyzz_0[j] = pb_x * tg_xyyyz_xyzz_0[j] + fr * tg_xyyyz_xyzz_1[j] + 0.5 * fl1_fx * (tg_yyyz_xyzz_0[j] - tg_yyyz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyyyz_yzz_1[j];

                    tg_xxyyyz_xzzz_0[j] = pb_x * tg_xyyyz_xzzz_0[j] + fr * tg_xyyyz_xzzz_1[j] + 0.5 * fl1_fx * (tg_yyyz_xzzz_0[j] - tg_yyyz_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyyyz_zzz_1[j];

                    tg_xxyyyz_yyyy_0[j] = pb_x * tg_xyyyz_yyyy_0[j] + fr * tg_xyyyz_yyyy_1[j] + 0.5 * fl1_fx * (tg_yyyz_yyyy_0[j] - tg_yyyz_yyyy_1[j] * fl1_fza);

                    tg_xxyyyz_yyyz_0[j] = pb_x * tg_xyyyz_yyyz_0[j] + fr * tg_xyyyz_yyyz_1[j] + 0.5 * fl1_fx * (tg_yyyz_yyyz_0[j] - tg_yyyz_yyyz_1[j] * fl1_fza);

                    tg_xxyyyz_yyzz_0[j] = pb_x * tg_xyyyz_yyzz_0[j] + fr * tg_xyyyz_yyzz_1[j] + 0.5 * fl1_fx * (tg_yyyz_yyzz_0[j] - tg_yyyz_yyzz_1[j] * fl1_fza);

                    tg_xxyyyz_yzzz_0[j] = pb_x * tg_xyyyz_yzzz_0[j] + fr * tg_xyyyz_yzzz_1[j] + 0.5 * fl1_fx * (tg_yyyz_yzzz_0[j] - tg_yyyz_yzzz_1[j] * fl1_fza);

                    tg_xxyyyz_zzzz_0[j] = pb_x * tg_xyyyz_zzzz_0[j] + fr * tg_xyyyz_zzzz_1[j] + 0.5 * fl1_fx * (tg_yyyz_zzzz_0[j] - tg_yyyz_zzzz_1[j] * fl1_fza);

                    tg_xxyyzz_xxxx_0[j] = pb_x * tg_xyyzz_xxxx_0[j] + fr * tg_xyyzz_xxxx_1[j] + 0.5 * fl1_fx * (tg_yyzz_xxxx_0[j] - tg_yyzz_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xyyzz_xxx_1[j];

                    tg_xxyyzz_xxxy_0[j] = pb_x * tg_xyyzz_xxxy_0[j] + fr * tg_xyyzz_xxxy_1[j] + 0.5 * fl1_fx * (tg_yyzz_xxxy_0[j] - tg_yyzz_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xyyzz_xxy_1[j];

                    tg_xxyyzz_xxxz_0[j] = pb_x * tg_xyyzz_xxxz_0[j] + fr * tg_xyyzz_xxxz_1[j] + 0.5 * fl1_fx * (tg_yyzz_xxxz_0[j] - tg_yyzz_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xyyzz_xxz_1[j];

                    tg_xxyyzz_xxyy_0[j] = pb_x * tg_xyyzz_xxyy_0[j] + fr * tg_xyyzz_xxyy_1[j] + 0.5 * fl1_fx * (tg_yyzz_xxyy_0[j] - tg_yyzz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xyyzz_xyy_1[j];

                    tg_xxyyzz_xxyz_0[j] = pb_x * tg_xyyzz_xxyz_0[j] + fr * tg_xyyzz_xxyz_1[j] + 0.5 * fl1_fx * (tg_yyzz_xxyz_0[j] - tg_yyzz_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xyyzz_xyz_1[j];

                    tg_xxyyzz_xxzz_0[j] = pb_x * tg_xyyzz_xxzz_0[j] + fr * tg_xyyzz_xxzz_1[j] + 0.5 * fl1_fx * (tg_yyzz_xxzz_0[j] - tg_yyzz_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xyyzz_xzz_1[j];

                    tg_xxyyzz_xyyy_0[j] = pb_x * tg_xyyzz_xyyy_0[j] + fr * tg_xyyzz_xyyy_1[j] + 0.5 * fl1_fx * (tg_yyzz_xyyy_0[j] - tg_yyzz_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyyzz_yyy_1[j];

                    tg_xxyyzz_xyyz_0[j] = pb_x * tg_xyyzz_xyyz_0[j] + fr * tg_xyyzz_xyyz_1[j] + 0.5 * fl1_fx * (tg_yyzz_xyyz_0[j] - tg_yyzz_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyyzz_yyz_1[j];

                    tg_xxyyzz_xyzz_0[j] = pb_x * tg_xyyzz_xyzz_0[j] + fr * tg_xyyzz_xyzz_1[j] + 0.5 * fl1_fx * (tg_yyzz_xyzz_0[j] - tg_yyzz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyyzz_yzz_1[j];

                    tg_xxyyzz_xzzz_0[j] = pb_x * tg_xyyzz_xzzz_0[j] + fr * tg_xyyzz_xzzz_1[j] + 0.5 * fl1_fx * (tg_yyzz_xzzz_0[j] - tg_yyzz_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyyzz_zzz_1[j];

                    tg_xxyyzz_yyyy_0[j] = pb_x * tg_xyyzz_yyyy_0[j] + fr * tg_xyyzz_yyyy_1[j] + 0.5 * fl1_fx * (tg_yyzz_yyyy_0[j] - tg_yyzz_yyyy_1[j] * fl1_fza);

                    tg_xxyyzz_yyyz_0[j] = pb_x * tg_xyyzz_yyyz_0[j] + fr * tg_xyyzz_yyyz_1[j] + 0.5 * fl1_fx * (tg_yyzz_yyyz_0[j] - tg_yyzz_yyyz_1[j] * fl1_fza);

                    tg_xxyyzz_yyzz_0[j] = pb_x * tg_xyyzz_yyzz_0[j] + fr * tg_xyyzz_yyzz_1[j] + 0.5 * fl1_fx * (tg_yyzz_yyzz_0[j] - tg_yyzz_yyzz_1[j] * fl1_fza);

                    tg_xxyyzz_yzzz_0[j] = pb_x * tg_xyyzz_yzzz_0[j] + fr * tg_xyyzz_yzzz_1[j] + 0.5 * fl1_fx * (tg_yyzz_yzzz_0[j] - tg_yyzz_yzzz_1[j] * fl1_fza);

                    tg_xxyyzz_zzzz_0[j] = pb_x * tg_xyyzz_zzzz_0[j] + fr * tg_xyyzz_zzzz_1[j] + 0.5 * fl1_fx * (tg_yyzz_zzzz_0[j] - tg_yyzz_zzzz_1[j] * fl1_fza);

                    tg_xxyzzz_xxxx_0[j] = pb_x * tg_xyzzz_xxxx_0[j] + fr * tg_xyzzz_xxxx_1[j] + 0.5 * fl1_fx * (tg_yzzz_xxxx_0[j] - tg_yzzz_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xyzzz_xxx_1[j];

                    tg_xxyzzz_xxxy_0[j] = pb_x * tg_xyzzz_xxxy_0[j] + fr * tg_xyzzz_xxxy_1[j] + 0.5 * fl1_fx * (tg_yzzz_xxxy_0[j] - tg_yzzz_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xyzzz_xxy_1[j];

                    tg_xxyzzz_xxxz_0[j] = pb_x * tg_xyzzz_xxxz_0[j] + fr * tg_xyzzz_xxxz_1[j] + 0.5 * fl1_fx * (tg_yzzz_xxxz_0[j] - tg_yzzz_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xyzzz_xxz_1[j];

                    tg_xxyzzz_xxyy_0[j] = pb_x * tg_xyzzz_xxyy_0[j] + fr * tg_xyzzz_xxyy_1[j] + 0.5 * fl1_fx * (tg_yzzz_xxyy_0[j] - tg_yzzz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xyzzz_xyy_1[j];

                    tg_xxyzzz_xxyz_0[j] = pb_x * tg_xyzzz_xxyz_0[j] + fr * tg_xyzzz_xxyz_1[j] + 0.5 * fl1_fx * (tg_yzzz_xxyz_0[j] - tg_yzzz_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xyzzz_xyz_1[j];

                    tg_xxyzzz_xxzz_0[j] = pb_x * tg_xyzzz_xxzz_0[j] + fr * tg_xyzzz_xxzz_1[j] + 0.5 * fl1_fx * (tg_yzzz_xxzz_0[j] - tg_yzzz_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xyzzz_xzz_1[j];

                    tg_xxyzzz_xyyy_0[j] = pb_x * tg_xyzzz_xyyy_0[j] + fr * tg_xyzzz_xyyy_1[j] + 0.5 * fl1_fx * (tg_yzzz_xyyy_0[j] - tg_yzzz_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyzzz_yyy_1[j];

                    tg_xxyzzz_xyyz_0[j] = pb_x * tg_xyzzz_xyyz_0[j] + fr * tg_xyzzz_xyyz_1[j] + 0.5 * fl1_fx * (tg_yzzz_xyyz_0[j] - tg_yzzz_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyzzz_yyz_1[j];

                    tg_xxyzzz_xyzz_0[j] = pb_x * tg_xyzzz_xyzz_0[j] + fr * tg_xyzzz_xyzz_1[j] + 0.5 * fl1_fx * (tg_yzzz_xyzz_0[j] - tg_yzzz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyzzz_yzz_1[j];

                    tg_xxyzzz_xzzz_0[j] = pb_x * tg_xyzzz_xzzz_0[j] + fr * tg_xyzzz_xzzz_1[j] + 0.5 * fl1_fx * (tg_yzzz_xzzz_0[j] - tg_yzzz_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xyzzz_zzz_1[j];

                    tg_xxyzzz_yyyy_0[j] = pb_x * tg_xyzzz_yyyy_0[j] + fr * tg_xyzzz_yyyy_1[j] + 0.5 * fl1_fx * (tg_yzzz_yyyy_0[j] - tg_yzzz_yyyy_1[j] * fl1_fza);

                    tg_xxyzzz_yyyz_0[j] = pb_x * tg_xyzzz_yyyz_0[j] + fr * tg_xyzzz_yyyz_1[j] + 0.5 * fl1_fx * (tg_yzzz_yyyz_0[j] - tg_yzzz_yyyz_1[j] * fl1_fza);

                    tg_xxyzzz_yyzz_0[j] = pb_x * tg_xyzzz_yyzz_0[j] + fr * tg_xyzzz_yyzz_1[j] + 0.5 * fl1_fx * (tg_yzzz_yyzz_0[j] - tg_yzzz_yyzz_1[j] * fl1_fza);

                    tg_xxyzzz_yzzz_0[j] = pb_x * tg_xyzzz_yzzz_0[j] + fr * tg_xyzzz_yzzz_1[j] + 0.5 * fl1_fx * (tg_yzzz_yzzz_0[j] - tg_yzzz_yzzz_1[j] * fl1_fza);

                    tg_xxyzzz_zzzz_0[j] = pb_x * tg_xyzzz_zzzz_0[j] + fr * tg_xyzzz_zzzz_1[j] + 0.5 * fl1_fx * (tg_yzzz_zzzz_0[j] - tg_yzzz_zzzz_1[j] * fl1_fza);

                    tg_xxzzzz_xxxx_0[j] = pb_x * tg_xzzzz_xxxx_0[j] + fr * tg_xzzzz_xxxx_1[j] + 0.5 * fl1_fx * (tg_zzzz_xxxx_0[j] - tg_zzzz_xxxx_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_xzzzz_xxx_1[j];

                    tg_xxzzzz_xxxy_0[j] = pb_x * tg_xzzzz_xxxy_0[j] + fr * tg_xzzzz_xxxy_1[j] + 0.5 * fl1_fx * (tg_zzzz_xxxy_0[j] - tg_zzzz_xxxy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xzzzz_xxy_1[j];

                    tg_xxzzzz_xxxz_0[j] = pb_x * tg_xzzzz_xxxz_0[j] + fr * tg_xzzzz_xxxz_1[j] + 0.5 * fl1_fx * (tg_zzzz_xxxz_0[j] - tg_zzzz_xxxz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_xzzzz_xxz_1[j];

                    tg_xxzzzz_xxyy_0[j] = pb_x * tg_xzzzz_xxyy_0[j] + fr * tg_xzzzz_xxyy_1[j] + 0.5 * fl1_fx * (tg_zzzz_xxyy_0[j] - tg_zzzz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_xzzzz_xyy_1[j];

                    tg_xxzzzz_xxyz_0[j] = pb_x * tg_xzzzz_xxyz_0[j] + fr * tg_xzzzz_xxyz_1[j] + 0.5 * fl1_fx * (tg_zzzz_xxyz_0[j] - tg_zzzz_xxyz_1[j] * fl1_fza) + fl1_fxn * tg_xzzzz_xyz_1[j];

                    tg_xxzzzz_xxzz_0[j] = pb_x * tg_xzzzz_xxzz_0[j] + fr * tg_xzzzz_xxzz_1[j] + 0.5 * fl1_fx * (tg_zzzz_xxzz_0[j] - tg_zzzz_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_xzzzz_xzz_1[j];

                    tg_xxzzzz_xyyy_0[j] = pb_x * tg_xzzzz_xyyy_0[j] + fr * tg_xzzzz_xyyy_1[j] + 0.5 * fl1_fx * (tg_zzzz_xyyy_0[j] - tg_zzzz_xyyy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xzzzz_yyy_1[j];

                    tg_xxzzzz_xyyz_0[j] = pb_x * tg_xzzzz_xyyz_0[j] + fr * tg_xzzzz_xyyz_1[j] + 0.5 * fl1_fx * (tg_zzzz_xyyz_0[j] - tg_zzzz_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xzzzz_yyz_1[j];

                    tg_xxzzzz_xyzz_0[j] = pb_x * tg_xzzzz_xyzz_0[j] + fr * tg_xzzzz_xyzz_1[j] + 0.5 * fl1_fx * (tg_zzzz_xyzz_0[j] - tg_zzzz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xzzzz_yzz_1[j];

                    tg_xxzzzz_xzzz_0[j] = pb_x * tg_xzzzz_xzzz_0[j] + fr * tg_xzzzz_xzzz_1[j] + 0.5 * fl1_fx * (tg_zzzz_xzzz_0[j] - tg_zzzz_xzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_xzzzz_zzz_1[j];

                    tg_xxzzzz_yyyy_0[j] = pb_x * tg_xzzzz_yyyy_0[j] + fr * tg_xzzzz_yyyy_1[j] + 0.5 * fl1_fx * (tg_zzzz_yyyy_0[j] - tg_zzzz_yyyy_1[j] * fl1_fza);

                    tg_xxzzzz_yyyz_0[j] = pb_x * tg_xzzzz_yyyz_0[j] + fr * tg_xzzzz_yyyz_1[j] + 0.5 * fl1_fx * (tg_zzzz_yyyz_0[j] - tg_zzzz_yyyz_1[j] * fl1_fza);

                    tg_xxzzzz_yyzz_0[j] = pb_x * tg_xzzzz_yyzz_0[j] + fr * tg_xzzzz_yyzz_1[j] + 0.5 * fl1_fx * (tg_zzzz_yyzz_0[j] - tg_zzzz_yyzz_1[j] * fl1_fza);

                    tg_xxzzzz_yzzz_0[j] = pb_x * tg_xzzzz_yzzz_0[j] + fr * tg_xzzzz_yzzz_1[j] + 0.5 * fl1_fx * (tg_zzzz_yzzz_0[j] - tg_zzzz_yzzz_1[j] * fl1_fza);

                    tg_xxzzzz_zzzz_0[j] = pb_x * tg_xzzzz_zzzz_0[j] + fr * tg_xzzzz_zzzz_1[j] + 0.5 * fl1_fx * (tg_zzzz_zzzz_0[j] - tg_zzzz_zzzz_1[j] * fl1_fza);

                    tg_xyyyyy_xxxx_0[j] = pb_x * tg_yyyyy_xxxx_0[j] + fr * tg_yyyyy_xxxx_1[j] + 2.0 * fl1_fxn * tg_yyyyy_xxx_1[j];

                    tg_xyyyyy_xxxy_0[j] = pb_x * tg_yyyyy_xxxy_0[j] + fr * tg_yyyyy_xxxy_1[j] + 1.5 * fl1_fxn * tg_yyyyy_xxy_1[j];

                    tg_xyyyyy_xxxz_0[j] = pb_x * tg_yyyyy_xxxz_0[j] + fr * tg_yyyyy_xxxz_1[j] + 1.5 * fl1_fxn * tg_yyyyy_xxz_1[j];

                    tg_xyyyyy_xxyy_0[j] = pb_x * tg_yyyyy_xxyy_0[j] + fr * tg_yyyyy_xxyy_1[j] + fl1_fxn * tg_yyyyy_xyy_1[j];

                    tg_xyyyyy_xxyz_0[j] = pb_x * tg_yyyyy_xxyz_0[j] + fr * tg_yyyyy_xxyz_1[j] + fl1_fxn * tg_yyyyy_xyz_1[j];

                    tg_xyyyyy_xxzz_0[j] = pb_x * tg_yyyyy_xxzz_0[j] + fr * tg_yyyyy_xxzz_1[j] + fl1_fxn * tg_yyyyy_xzz_1[j];

                    tg_xyyyyy_xyyy_0[j] = pb_x * tg_yyyyy_xyyy_0[j] + fr * tg_yyyyy_xyyy_1[j] + 0.5 * fl1_fxn * tg_yyyyy_yyy_1[j];

                    tg_xyyyyy_xyyz_0[j] = pb_x * tg_yyyyy_xyyz_0[j] + fr * tg_yyyyy_xyyz_1[j] + 0.5 * fl1_fxn * tg_yyyyy_yyz_1[j];

                    tg_xyyyyy_xyzz_0[j] = pb_x * tg_yyyyy_xyzz_0[j] + fr * tg_yyyyy_xyzz_1[j] + 0.5 * fl1_fxn * tg_yyyyy_yzz_1[j];

                    tg_xyyyyy_xzzz_0[j] = pb_x * tg_yyyyy_xzzz_0[j] + fr * tg_yyyyy_xzzz_1[j] + 0.5 * fl1_fxn * tg_yyyyy_zzz_1[j];

                    tg_xyyyyy_yyyy_0[j] = pb_x * tg_yyyyy_yyyy_0[j] + fr * tg_yyyyy_yyyy_1[j];

                    tg_xyyyyy_yyyz_0[j] = pb_x * tg_yyyyy_yyyz_0[j] + fr * tg_yyyyy_yyyz_1[j];

                    tg_xyyyyy_yyzz_0[j] = pb_x * tg_yyyyy_yyzz_0[j] + fr * tg_yyyyy_yyzz_1[j];

                    tg_xyyyyy_yzzz_0[j] = pb_x * tg_yyyyy_yzzz_0[j] + fr * tg_yyyyy_yzzz_1[j];

                    tg_xyyyyy_zzzz_0[j] = pb_x * tg_yyyyy_zzzz_0[j] + fr * tg_yyyyy_zzzz_1[j];

                    tg_xyyyyz_xxxx_0[j] = pb_x * tg_yyyyz_xxxx_0[j] + fr * tg_yyyyz_xxxx_1[j] + 2.0 * fl1_fxn * tg_yyyyz_xxx_1[j];

                    tg_xyyyyz_xxxy_0[j] = pb_x * tg_yyyyz_xxxy_0[j] + fr * tg_yyyyz_xxxy_1[j] + 1.5 * fl1_fxn * tg_yyyyz_xxy_1[j];

                    tg_xyyyyz_xxxz_0[j] = pb_x * tg_yyyyz_xxxz_0[j] + fr * tg_yyyyz_xxxz_1[j] + 1.5 * fl1_fxn * tg_yyyyz_xxz_1[j];

                    tg_xyyyyz_xxyy_0[j] = pb_x * tg_yyyyz_xxyy_0[j] + fr * tg_yyyyz_xxyy_1[j] + fl1_fxn * tg_yyyyz_xyy_1[j];

                    tg_xyyyyz_xxyz_0[j] = pb_x * tg_yyyyz_xxyz_0[j] + fr * tg_yyyyz_xxyz_1[j] + fl1_fxn * tg_yyyyz_xyz_1[j];

                    tg_xyyyyz_xxzz_0[j] = pb_x * tg_yyyyz_xxzz_0[j] + fr * tg_yyyyz_xxzz_1[j] + fl1_fxn * tg_yyyyz_xzz_1[j];

                    tg_xyyyyz_xyyy_0[j] = pb_x * tg_yyyyz_xyyy_0[j] + fr * tg_yyyyz_xyyy_1[j] + 0.5 * fl1_fxn * tg_yyyyz_yyy_1[j];

                    tg_xyyyyz_xyyz_0[j] = pb_x * tg_yyyyz_xyyz_0[j] + fr * tg_yyyyz_xyyz_1[j] + 0.5 * fl1_fxn * tg_yyyyz_yyz_1[j];

                    tg_xyyyyz_xyzz_0[j] = pb_x * tg_yyyyz_xyzz_0[j] + fr * tg_yyyyz_xyzz_1[j] + 0.5 * fl1_fxn * tg_yyyyz_yzz_1[j];

                    tg_xyyyyz_xzzz_0[j] = pb_x * tg_yyyyz_xzzz_0[j] + fr * tg_yyyyz_xzzz_1[j] + 0.5 * fl1_fxn * tg_yyyyz_zzz_1[j];

                    tg_xyyyyz_yyyy_0[j] = pb_x * tg_yyyyz_yyyy_0[j] + fr * tg_yyyyz_yyyy_1[j];

                    tg_xyyyyz_yyyz_0[j] = pb_x * tg_yyyyz_yyyz_0[j] + fr * tg_yyyyz_yyyz_1[j];
                }
    ...
    void
    compElectronRepulsionForSISG_252_336(      CMemBlock2D<double>* primBuffer,
                                         const CRecursionMap&       recursionMap,
                                         const CMemBlock2D<double>& osFactors,
                                         const CMemBlock2D<double>& wpDistances,
                                         const CGtoPairsBlock&      braGtoPairsBlock,
                                         ...
                                         const int32_t              iContrPair)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, fza, tg_xyyyyz_yyzz_0, tg_xyyyyz_yzzz_0, tg_xyyyyz_zzzz_0, \
                                         tg_xyyyzz_xxxx_0, tg_xyyyzz_xxxy_0, tg_xyyyzz_xxxz_0, tg_xyyyzz_xxyy_0, \
                                         tg_xyyyzz_xxyz_0, tg_xyyyzz_xxzz_0, tg_xyyyzz_xyyy_0, tg_xyyyzz_xyyz_0, \
                                         tg_xyyyzz_xyzz_0, tg_xyyyzz_xzzz_0, tg_xyyyzz_yyyy_0, tg_xyyyzz_yyyz_0, \
                                         tg_xyyyzz_yyzz_0, tg_xyyyzz_yzzz_0, tg_xyyyzz_zzzz_0, tg_xyyzzz_xxxx_0, \
                                         tg_xyyzzz_xxxy_0, tg_xyyzzz_xxxz_0, tg_xyyzzz_xxyy_0, tg_xyyzzz_xxyz_0, \
                                         tg_xyyzzz_xxzz_0, tg_xyyzzz_xyyy_0, tg_xyyzzz_xyyz_0, tg_xyyzzz_xyzz_0, \
                                         tg_xyyzzz_xzzz_0, tg_xyyzzz_yyyy_0, tg_xyyzzz_yyyz_0, tg_xyyzzz_yyzz_0, \
                                         tg_xyyzzz_yzzz_0, tg_xyyzzz_zzzz_0, tg_xyzzzz_xxxx_0, tg_xyzzzz_xxxy_0, \
                                         tg_xyzzzz_xxxz_0, tg_xyzzzz_xxyy_0, tg_xyzzzz_xxyz_0, tg_xyzzzz_xxzz_0, \
                                         tg_xyzzzz_xyyy_0, tg_xyzzzz_xyyz_0, tg_xyzzzz_xyzz_0, tg_xyzzzz_xzzz_0, \
                                         tg_xyzzzz_yyyy_0, tg_xyzzzz_yyyz_0, tg_xyzzzz_yyzz_0, tg_xyzzzz_yzzz_0, \
                                         tg_xyzzzz_zzzz_0, tg_xzzzzz_xxxx_0, tg_xzzzzz_xxxy_0, tg_xzzzzz_xxxz_0, \
                                         tg_xzzzzz_xxyy_0, tg_xzzzzz_xxyz_0, tg_xzzzzz_xxzz_0, tg_xzzzzz_xyyy_0, \
                                         tg_xzzzzz_xyyz_0, tg_xzzzzz_xyzz_0, tg_xzzzzz_xzzz_0, tg_xzzzzz_yyyy_0, \
                                         tg_xzzzzz_yyyz_0, tg_xzzzzz_yyzz_0, tg_xzzzzz_yzzz_0, tg_xzzzzz_zzzz_0, \
                                         tg_yyyy_xxxx_0, tg_yyyy_xxxx_1, tg_yyyy_xxxy_0, tg_yyyy_xxxy_1, tg_yyyy_xxxz_0, \
                                         tg_yyyy_xxxz_1, tg_yyyy_xxyy_0, tg_yyyy_xxyy_1, tg_yyyy_xxyz_0, tg_yyyy_xxyz_1, \
                                         tg_yyyy_xxzz_0, tg_yyyy_xxzz_1, tg_yyyy_xyyy_0, tg_yyyy_xyyy_1, tg_yyyy_xyyz_0, \
                                         tg_yyyy_xyyz_1, tg_yyyy_xyzz_0, tg_yyyy_xyzz_1, tg_yyyy_xzzz_0, tg_yyyy_xzzz_1, \
                                         tg_yyyy_yyyy_0, tg_yyyy_yyyy_1, tg_yyyy_yyyz_0, tg_yyyy_yyyz_1, tg_yyyy_yyzz_0, \
                                         tg_yyyy_yyzz_1, tg_yyyy_yzzz_0, tg_yyyy_yzzz_1, tg_yyyy_zzzz_0, tg_yyyy_zzzz_1, \
                                         tg_yyyyy_xxx_1, tg_yyyyy_xxxx_0, tg_yyyyy_xxxx_1, tg_yyyyy_xxxy_0, tg_yyyyy_xxxy_1, \
                                         tg_yyyyy_xxxz_0, tg_yyyyy_xxxz_1, tg_yyyyy_xxy_1, tg_yyyyy_xxyy_0, tg_yyyyy_xxyy_1, \
                                         tg_yyyyy_xxyz_0, tg_yyyyy_xxyz_1, tg_yyyyy_xxz_1, tg_yyyyy_xxzz_0, tg_yyyyy_xxzz_1, \
                                         tg_yyyyy_xyy_1, tg_yyyyy_xyyy_0, tg_yyyyy_xyyy_1, tg_yyyyy_xyyz_0, tg_yyyyy_xyyz_1, \
                                         tg_yyyyy_xyz_1, tg_yyyyy_xyzz_0, tg_yyyyy_xyzz_1, tg_yyyyy_xzz_1, tg_yyyyy_xzzz_0, \
                                         tg_yyyyy_xzzz_1, tg_yyyyy_yyy_1, tg_yyyyy_yyyy_0, tg_yyyyy_yyyy_1, tg_yyyyy_yyyz_0, \
                                         tg_yyyyy_yyyz_1, tg_yyyyy_yyz_1, tg_yyyyy_yyzz_0, tg_yyyyy_yyzz_1, tg_yyyyy_yzz_1, \
                                         tg_yyyyy_yzzz_0, tg_yyyyy_yzzz_1, tg_yyyyy_zzz_1, tg_yyyyy_zzzz_0, tg_yyyyy_zzzz_1, \
                                         tg_yyyyyy_xxxx_0, tg_yyyyyy_xxxy_0, tg_yyyyyy_xxxz_0, tg_yyyyyy_xxyy_0, \
                                         tg_yyyyyy_xxyz_0, tg_yyyyyy_xxzz_0, tg_yyyyyy_xyyy_0, tg_yyyyyy_xyyz_0, \
                                         tg_yyyyyy_xyzz_0, tg_yyyyyy_xzzz_0, tg_yyyyyy_yyyy_0, tg_yyyyyy_yyyz_0, \
                                         tg_yyyyyy_yyzz_0, tg_yyyyyy_yzzz_0, tg_yyyyyy_zzzz_0, tg_yyyyyz_xxxx_0, \
                                         tg_yyyyyz_xxxy_0, tg_yyyyyz_xxxz_0, tg_yyyyyz_xxyy_0, tg_yyyyyz_xxyz_0, \
                                         tg_yyyyyz_xxzz_0, tg_yyyyz_xxx_1, tg_yyyyz_xxxx_0, tg_yyyyz_xxxx_1, tg_yyyyz_xxxy_0, \
                                         tg_yyyyz_xxxy_1, tg_yyyyz_xxxz_0, tg_yyyyz_xxxz_1, tg_yyyyz_xxy_1, tg_yyyyz_xxyy_0, \
                                         tg_yyyyz_xxyy_1, tg_yyyyz_xxyz_0, tg_yyyyz_xxyz_1, tg_yyyyz_xxz_1, tg_yyyyz_xxzz_0, \
                                         tg_yyyyz_xxzz_1, tg_yyyyz_yyzz_0, tg_yyyyz_yyzz_1, tg_yyyyz_yzzz_0, tg_yyyyz_yzzz_1, \
                                         tg_yyyyz_zzzz_0, tg_yyyyz_zzzz_1, tg_yyyz_xxxx_0, tg_yyyz_xxxx_1, tg_yyyz_xxxy_0, \
                                         tg_yyyz_xxxy_1, tg_yyyz_xxxz_0, tg_yyyz_xxxz_1, tg_yyyz_xxyy_0, tg_yyyz_xxyy_1, \
                                         tg_yyyz_xxyz_0, tg_yyyz_xxyz_1, tg_yyyz_xxzz_0, tg_yyyz_xxzz_1, tg_yyyzz_xxx_1, \
                                         tg_yyyzz_xxxx_0, tg_yyyzz_xxxx_1, tg_yyyzz_xxxy_0, tg_yyyzz_xxxy_1, tg_yyyzz_xxxz_0, \
                                         tg_yyyzz_xxxz_1, tg_yyyzz_xxy_1, tg_yyyzz_xxyy_0, tg_yyyzz_xxyy_1, tg_yyyzz_xxyz_0, \
                                         tg_yyyzz_xxyz_1, tg_yyyzz_xxz_1, tg_yyyzz_xxzz_0, tg_yyyzz_xxzz_1, tg_yyyzz_xyy_1, \
                                         tg_yyyzz_xyyy_0, tg_yyyzz_xyyy_1, tg_yyyzz_xyyz_0, tg_yyyzz_xyyz_1, tg_yyyzz_xyz_1, \
                                         tg_yyyzz_xyzz_0, tg_yyyzz_xyzz_1, tg_yyyzz_xzz_1, tg_yyyzz_xzzz_0, tg_yyyzz_xzzz_1, \
                                         tg_yyyzz_yyy_1, tg_yyyzz_yyyy_0, tg_yyyzz_yyyy_1, tg_yyyzz_yyyz_0, tg_yyyzz_yyyz_1, \
                                         tg_yyyzz_yyz_1, tg_yyyzz_yyzz_0, tg_yyyzz_yyzz_1, tg_yyyzz_yzz_1, tg_yyyzz_yzzz_0, \
                                         tg_yyyzz_yzzz_1, tg_yyyzz_zzz_1, tg_yyyzz_zzzz_0, tg_yyyzz_zzzz_1, tg_yyzzz_xxx_1, \
                                         tg_yyzzz_xxxx_0, tg_yyzzz_xxxx_1, tg_yyzzz_xxxy_0, tg_yyzzz_xxxy_1, tg_yyzzz_xxxz_0, \
                                         tg_yyzzz_xxxz_1, tg_yyzzz_xxy_1, tg_yyzzz_xxyy_0, tg_yyzzz_xxyy_1, tg_yyzzz_xxyz_0, \
                                         tg_yyzzz_xxyz_1, tg_yyzzz_xxz_1, tg_yyzzz_xxzz_0, tg_yyzzz_xxzz_1, tg_yyzzz_xyy_1, \
                                         tg_yyzzz_xyyy_0, tg_yyzzz_xyyy_1, tg_yyzzz_xyyz_0, tg_yyzzz_xyyz_1, tg_yyzzz_xyz_1, \
                                         tg_yyzzz_xyzz_0, tg_yyzzz_xyzz_1, tg_yyzzz_xzz_1, tg_yyzzz_xzzz_0, tg_yyzzz_xzzz_1, \
                                         tg_yyzzz_yyy_1, tg_yyzzz_yyyy_0, tg_yyzzz_yyyy_1, tg_yyzzz_yyyz_0, tg_yyzzz_yyyz_1, \
                                         tg_yyzzz_yyz_1, tg_yyzzz_yyzz_0, tg_yyzzz_yyzz_1, tg_yyzzz_yzz_1, tg_yyzzz_yzzz_0, \
                                         tg_yyzzz_yzzz_1, tg_yyzzz_zzz_1, tg_yyzzz_zzzz_0, tg_yyzzz_zzzz_1, tg_yzzzz_xxx_1, \
                                         tg_yzzzz_xxxx_0, tg_yzzzz_xxxx_1, tg_yzzzz_xxxy_0, tg_yzzzz_xxxy_1, tg_yzzzz_xxxz_0, \
                                         tg_yzzzz_xxxz_1, tg_yzzzz_xxy_1, tg_yzzzz_xxyy_0, tg_yzzzz_xxyy_1, tg_yzzzz_xxyz_0, \
                                         tg_yzzzz_xxyz_1, tg_yzzzz_xxz_1, tg_yzzzz_xxzz_0, tg_yzzzz_xxzz_1, tg_yzzzz_xyy_1, \
                                         tg_yzzzz_xyyy_0, tg_yzzzz_xyyy_1, tg_yzzzz_xyyz_0, tg_yzzzz_xyyz_1, tg_yzzzz_xyz_1, \
                                         tg_yzzzz_xyzz_0, tg_yzzzz_xyzz_1, tg_yzzzz_xzz_1, tg_yzzzz_xzzz_0, tg_yzzzz_xzzz_1, \
                                         tg_yzzzz_yyy_1, tg_yzzzz_yyyy_0, tg_yzzzz_yyyy_1, tg_yzzzz_yyyz_0, tg_yzzzz_yyyz_1, \
                                         tg_yzzzz_yyz_1, tg_yzzzz_yyzz_0, tg_yzzzz_yyzz_1, tg_yzzzz_yzz_1, tg_yzzzz_yzzz_0, \
                                         tg_yzzzz_yzzz_1, tg_yzzzz_zzz_1, tg_yzzzz_zzzz_0, tg_yzzzz_zzzz_1, tg_zzzzz_xxx_1, \
                                         tg_zzzzz_xxxx_0, tg_zzzzz_xxxx_1, tg_zzzzz_xxxy_0, tg_zzzzz_xxxy_1, tg_zzzzz_xxxz_0, \
                                         tg_zzzzz_xxxz_1, tg_zzzzz_xxy_1, tg_zzzzz_xxyy_0, tg_zzzzz_xxyy_1, tg_zzzzz_xxyz_0, \
                                         tg_zzzzz_xxyz_1, tg_zzzzz_xxz_1, tg_zzzzz_xxzz_0, tg_zzzzz_xxzz_1, tg_zzzzz_xyy_1, \
                                         tg_zzzzz_xyyy_0, tg_zzzzz_xyyy_1, tg_zzzzz_xyyz_0, tg_zzzzz_xyyz_1, tg_zzzzz_xyz_1, \
                                         tg_zzzzz_xyzz_0, tg_zzzzz_xyzz_1, tg_zzzzz_xzz_1, tg_zzzzz_xzzz_0, tg_zzzzz_xzzz_1, \
                                         tg_zzzzz_yyy_1, tg_zzzzz_yyyy_0, tg_zzzzz_yyyy_1, tg_zzzzz_yyyz_0, tg_zzzzz_yyyz_1, \
                                         tg_zzzzz_yyz_1, tg_zzzzz_yyzz_0, tg_zzzzz_yyzz_1, tg_zzzzz_yzz_1, tg_zzzzz_yzzz_0, \
                                         tg_zzzzz_yzzz_1, tg_zzzzz_zzz_1, tg_zzzzz_zzzz_0, tg_zzzzz_zzzz_1, wp_x, wp_y: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fx = fx;
                    ...
                    tg_xyyyyz_yyzz_0[j] = pb_x * tg_yyyyz_yyzz_0[j] + fr * tg_yyyyz_yyzz_1[j];

                    tg_xyyyyz_yzzz_0[j] = pb_x * tg_yyyyz_yzzz_0[j] + fr * tg_yyyyz_yzzz_1[j];

                    tg_xyyyyz_zzzz_0[j] = pb_x * tg_yyyyz_zzzz_0[j] + fr * tg_yyyyz_zzzz_1[j];

                    tg_xyyyzz_xxxx_0[j] = pb_x * tg_yyyzz_xxxx_0[j] + fr * tg_yyyzz_xxxx_1[j] + 2.0 * fl1_fxn * tg_yyyzz_xxx_1[j];

                    tg_xyyyzz_xxxy_0[j] = pb_x * tg_yyyzz_xxxy_0[j] + fr * tg_yyyzz_xxxy_1[j] + 1.5 * fl1_fxn * tg_yyyzz_xxy_1[j];

                    tg_xyyyzz_xxxz_0[j] = pb_x * tg_yyyzz_xxxz_0[j] + fr * tg_yyyzz_xxxz_1[j] + 1.5 * fl1_fxn * tg_yyyzz_xxz_1[j];

                    tg_xyyyzz_xxyy_0[j] = pb_x * tg_yyyzz_xxyy_0[j] + fr * tg_yyyzz_xxyy_1[j] + fl1_fxn * tg_yyyzz_xyy_1[j];

                    tg_xyyyzz_xxyz_0[j] = pb_x * tg_yyyzz_xxyz_0[j] + fr * tg_yyyzz_xxyz_1[j] + fl1_fxn * tg_yyyzz_xyz_1[j];

                    tg_xyyyzz_xxzz_0[j] = pb_x * tg_yyyzz_xxzz_0[j] + fr * tg_yyyzz_xxzz_1[j] + fl1_fxn * tg_yyyzz_xzz_1[j];

                    tg_xyyyzz_xyyy_0[j] = pb_x * tg_yyyzz_xyyy_0[j] + fr * tg_yyyzz_xyyy_1[j] + 0.5 * fl1_fxn * tg_yyyzz_yyy_1[j];

                    tg_xyyyzz_xyyz_0[j] = pb_x * tg_yyyzz_xyyz_0[j] + fr * tg_yyyzz_xyyz_1[j] + 0.5 * fl1_fxn * tg_yyyzz_yyz_1[j];

                    tg_xyyyzz_xyzz_0[j] = pb_x * tg_yyyzz_xyzz_0[j] + fr * tg_yyyzz_xyzz_1[j] + 0.5 * fl1_fxn * tg_yyyzz_yzz_1[j];

                    tg_xyyyzz_xzzz_0[j] = pb_x * tg_yyyzz_xzzz_0[j] + fr * tg_yyyzz_xzzz_1[j] + 0.5 * fl1_fxn * tg_yyyzz_zzz_1[j];

                    tg_xyyyzz_yyyy_0[j] = pb_x * tg_yyyzz_yyyy_0[j] + fr * tg_yyyzz_yyyy_1[j];

                    tg_xyyyzz_yyyz_0[j] = pb_x * tg_yyyzz_yyyz_0[j] + fr * tg_yyyzz_yyyz_1[j];

                    tg_xyyyzz_yyzz_0[j] = pb_x * tg_yyyzz_yyzz_0[j] + fr * tg_yyyzz_yyzz_1[j];

                    tg_xyyyzz_yzzz_0[j] = pb_x * tg_yyyzz_yzzz_0[j] + fr * tg_yyyzz_yzzz_1[j];

                    tg_xyyyzz_zzzz_0[j] = pb_x * tg_yyyzz_zzzz_0[j] + fr * tg_yyyzz_zzzz_1[j];

                    tg_xyyzzz_xxxx_0[j] = pb_x * tg_yyzzz_xxxx_0[j] + fr * tg_yyzzz_xxxx_1[j] + 2.0 * fl1_fxn * tg_yyzzz_xxx_1[j];

                    tg_xyyzzz_xxxy_0[j] = pb_x * tg_yyzzz_xxxy_0[j] + fr * tg_yyzzz_xxxy_1[j] + 1.5 * fl1_fxn * tg_yyzzz_xxy_1[j];

                    tg_xyyzzz_xxxz_0[j] = pb_x * tg_yyzzz_xxxz_0[j] + fr * tg_yyzzz_xxxz_1[j] + 1.5 * fl1_fxn * tg_yyzzz_xxz_1[j];

                    tg_xyyzzz_xxyy_0[j] = pb_x * tg_yyzzz_xxyy_0[j] + fr * tg_yyzzz_xxyy_1[j] + fl1_fxn * tg_yyzzz_xyy_1[j];

                    tg_xyyzzz_xxyz_0[j] = pb_x * tg_yyzzz_xxyz_0[j] + fr * tg_yyzzz_xxyz_1[j] + fl1_fxn * tg_yyzzz_xyz_1[j];

                    tg_xyyzzz_xxzz_0[j] = pb_x * tg_yyzzz_xxzz_0[j] + fr * tg_yyzzz_xxzz_1[j] + fl1_fxn * tg_yyzzz_xzz_1[j];

                    tg_xyyzzz_xyyy_0[j] = pb_x * tg_yyzzz_xyyy_0[j] + fr * tg_yyzzz_xyyy_1[j] + 0.5 * fl1_fxn * tg_yyzzz_yyy_1[j];

                    tg_xyyzzz_xyyz_0[j] = pb_x * tg_yyzzz_xyyz_0[j] + fr * tg_yyzzz_xyyz_1[j] + 0.5 * fl1_fxn * tg_yyzzz_yyz_1[j];

                    tg_xyyzzz_xyzz_0[j] = pb_x * tg_yyzzz_xyzz_0[j] + fr * tg_yyzzz_xyzz_1[j] + 0.5 * fl1_fxn * tg_yyzzz_yzz_1[j];

                    tg_xyyzzz_xzzz_0[j] = pb_x * tg_yyzzz_xzzz_0[j] + fr * tg_yyzzz_xzzz_1[j] + 0.5 * fl1_fxn * tg_yyzzz_zzz_1[j];

                    tg_xyyzzz_yyyy_0[j] = pb_x * tg_yyzzz_yyyy_0[j] + fr * tg_yyzzz_yyyy_1[j];

                    tg_xyyzzz_yyyz_0[j] = pb_x * tg_yyzzz_yyyz_0[j] + fr * tg_yyzzz_yyyz_1[j];

                    tg_xyyzzz_yyzz_0[j] = pb_x * tg_yyzzz_yyzz_0[j] + fr * tg_yyzzz_yyzz_1[j];

                    tg_xyyzzz_yzzz_0[j] = pb_x * tg_yyzzz_yzzz_0[j] + fr * tg_yyzzz_yzzz_1[j];

                    tg_xyyzzz_zzzz_0[j] = pb_x * tg_yyzzz_zzzz_0[j] + fr * tg_yyzzz_zzzz_1[j];

                    tg_xyzzzz_xxxx_0[j] = pb_x * tg_yzzzz_xxxx_0[j] + fr * tg_yzzzz_xxxx_1[j] + 2.0 * fl1_fxn * tg_yzzzz_xxx_1[j];

                    tg_xyzzzz_xxxy_0[j] = pb_x * tg_yzzzz_xxxy_0[j] + fr * tg_yzzzz_xxxy_1[j] + 1.5 * fl1_fxn * tg_yzzzz_xxy_1[j];

                    tg_xyzzzz_xxxz_0[j] = pb_x * tg_yzzzz_xxxz_0[j] + fr * tg_yzzzz_xxxz_1[j] + 1.5 * fl1_fxn * tg_yzzzz_xxz_1[j];

                    tg_xyzzzz_xxyy_0[j] = pb_x * tg_yzzzz_xxyy_0[j] + fr * tg_yzzzz_xxyy_1[j] + fl1_fxn * tg_yzzzz_xyy_1[j];

                    tg_xyzzzz_xxyz_0[j] = pb_x * tg_yzzzz_xxyz_0[j] + fr * tg_yzzzz_xxyz_1[j] + fl1_fxn * tg_yzzzz_xyz_1[j];

                    tg_xyzzzz_xxzz_0[j] = pb_x * tg_yzzzz_xxzz_0[j] + fr * tg_yzzzz_xxzz_1[j] + fl1_fxn * tg_yzzzz_xzz_1[j];

                    tg_xyzzzz_xyyy_0[j] = pb_x * tg_yzzzz_xyyy_0[j] + fr * tg_yzzzz_xyyy_1[j] + 0.5 * fl1_fxn * tg_yzzzz_yyy_1[j];

                    tg_xyzzzz_xyyz_0[j] = pb_x * tg_yzzzz_xyyz_0[j] + fr * tg_yzzzz_xyyz_1[j] + 0.5 * fl1_fxn * tg_yzzzz_yyz_1[j];

                    tg_xyzzzz_xyzz_0[j] = pb_x * tg_yzzzz_xyzz_0[j] + fr * tg_yzzzz_xyzz_1[j] + 0.5 * fl1_fxn * tg_yzzzz_yzz_1[j];

                    tg_xyzzzz_xzzz_0[j] = pb_x * tg_yzzzz_xzzz_0[j] + fr * tg_yzzzz_xzzz_1[j] + 0.5 * fl1_fxn * tg_yzzzz_zzz_1[j];

                    tg_xyzzzz_yyyy_0[j] = pb_x * tg_yzzzz_yyyy_0[j] + fr * tg_yzzzz_yyyy_1[j];

                    tg_xyzzzz_yyyz_0[j] = pb_x * tg_yzzzz_yyyz_0[j] + fr * tg_yzzzz_yyyz_1[j];

                    tg_xyzzzz_yyzz_0[j] = pb_x * tg_yzzzz_yyzz_0[j] + fr * tg_yzzzz_yyzz_1[j];

                    tg_xyzzzz_yzzz_0[j] = pb_x * tg_yzzzz_yzzz_0[j] + fr * tg_yzzzz_yzzz_1[j];

                    tg_xyzzzz_zzzz_0[j] = pb_x * tg_yzzzz_zzzz_0[j] + fr * tg_yzzzz_zzzz_1[j];

                    tg_xzzzzz_xxxx_0[j] = pb_x * tg_zzzzz_xxxx_0[j] + fr * tg_zzzzz_xxxx_1[j] + 2.0 * fl1_fxn * tg_zzzzz_xxx_1[j];

                    tg_xzzzzz_xxxy_0[j] = pb_x * tg_zzzzz_xxxy_0[j] + fr * tg_zzzzz_xxxy_1[j] + 1.5 * fl1_fxn * tg_zzzzz_xxy_1[j];

                    tg_xzzzzz_xxxz_0[j] = pb_x * tg_zzzzz_xxxz_0[j] + fr * tg_zzzzz_xxxz_1[j] + 1.5 * fl1_fxn * tg_zzzzz_xxz_1[j];

                    tg_xzzzzz_xxyy_0[j] = pb_x * tg_zzzzz_xxyy_0[j] + fr * tg_zzzzz_xxyy_1[j] + fl1_fxn * tg_zzzzz_xyy_1[j];

                    tg_xzzzzz_xxyz_0[j] = pb_x * tg_zzzzz_xxyz_0[j] + fr * tg_zzzzz_xxyz_1[j] + fl1_fxn * tg_zzzzz_xyz_1[j];

                    tg_xzzzzz_xxzz_0[j] = pb_x * tg_zzzzz_xxzz_0[j] + fr * tg_zzzzz_xxzz_1[j] + fl1_fxn * tg_zzzzz_xzz_1[j];

                    tg_xzzzzz_xyyy_0[j] = pb_x * tg_zzzzz_xyyy_0[j] + fr * tg_zzzzz_xyyy_1[j] + 0.5 * fl1_fxn * tg_zzzzz_yyy_1[j];

                    tg_xzzzzz_xyyz_0[j] = pb_x * tg_zzzzz_xyyz_0[j] + fr * tg_zzzzz_xyyz_1[j] + 0.5 * fl1_fxn * tg_zzzzz_yyz_1[j];

                    tg_xzzzzz_xyzz_0[j] = pb_x * tg_zzzzz_xyzz_0[j] + fr * tg_zzzzz_xyzz_1[j] + 0.5 * fl1_fxn * tg_zzzzz_yzz_1[j];

                    tg_xzzzzz_xzzz_0[j] = pb_x * tg_zzzzz_xzzz_0[j] + fr * tg_zzzzz_xzzz_1[j] + 0.5 * fl1_fxn * tg_zzzzz_zzz_1[j];

                    tg_xzzzzz_yyyy_0[j] = pb_x * tg_zzzzz_yyyy_0[j] + fr * tg_zzzzz_yyyy_1[j];

                    tg_xzzzzz_yyyz_0[j] = pb_x * tg_zzzzz_yyyz_0[j] + fr * tg_zzzzz_yyyz_1[j];

                    tg_xzzzzz_yyzz_0[j] = pb_x * tg_zzzzz_yyzz_0[j] + fr * tg_zzzzz_yyzz_1[j];

                    tg_xzzzzz_yzzz_0[j] = pb_x * tg_zzzzz_yzzz_0[j] + fr * tg_zzzzz_yzzz_1[j];

                    tg_xzzzzz_zzzz_0[j] = pb_x * tg_zzzzz_zzzz_0[j] + fr * tg_zzzzz_zzzz_1[j];

                    fr = wp_y[j]; 

                    tg_yyyyyy_xxxx_0[j] = pb_y * tg_yyyyy_xxxx_0[j] + fr * tg_yyyyy_xxxx_1[j] + 2.5 * fl1_fx * (tg_yyyy_xxxx_0[j] - tg_yyyy_xxxx_1[j] * fl1_fza);

                    tg_yyyyyy_xxxy_0[j] = pb_y * tg_yyyyy_xxxy_0[j] + fr * tg_yyyyy_xxxy_1[j] + 2.5 * fl1_fx * (tg_yyyy_xxxy_0[j] - tg_yyyy_xxxy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyyyy_xxx_1[j];

                    tg_yyyyyy_xxxz_0[j] = pb_y * tg_yyyyy_xxxz_0[j] + fr * tg_yyyyy_xxxz_1[j] + 2.5 * fl1_fx * (tg_yyyy_xxxz_0[j] - tg_yyyy_xxxz_1[j] * fl1_fza);

                    tg_yyyyyy_xxyy_0[j] = pb_y * tg_yyyyy_xxyy_0[j] + fr * tg_yyyyy_xxyy_1[j] + 2.5 * fl1_fx * (tg_yyyy_xxyy_0[j] - tg_yyyy_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_yyyyy_xxy_1[j];

                    tg_yyyyyy_xxyz_0[j] = pb_y * tg_yyyyy_xxyz_0[j] + fr * tg_yyyyy_xxyz_1[j] + 2.5 * fl1_fx * (tg_yyyy_xxyz_0[j] - tg_yyyy_xxyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyyyy_xxz_1[j];

                    tg_yyyyyy_xxzz_0[j] = pb_y * tg_yyyyy_xxzz_0[j] + fr * tg_yyyyy_xxzz_1[j] + 2.5 * fl1_fx * (tg_yyyy_xxzz_0[j] - tg_yyyy_xxzz_1[j] * fl1_fza);

                    tg_yyyyyy_xyyy_0[j] = pb_y * tg_yyyyy_xyyy_0[j] + fr * tg_yyyyy_xyyy_1[j] + 2.5 * fl1_fx * (tg_yyyy_xyyy_0[j] - tg_yyyy_xyyy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yyyyy_xyy_1[j];

                    tg_yyyyyy_xyyz_0[j] = pb_y * tg_yyyyy_xyyz_0[j] + fr * tg_yyyyy_xyyz_1[j] + 2.5 * fl1_fx * (tg_yyyy_xyyz_0[j] - tg_yyyy_xyyz_1[j] * fl1_fza) + fl1_fxn * tg_yyyyy_xyz_1[j];

                    tg_yyyyyy_xyzz_0[j] = pb_y * tg_yyyyy_xyzz_0[j] + fr * tg_yyyyy_xyzz_1[j] + 2.5 * fl1_fx * (tg_yyyy_xyzz_0[j] - tg_yyyy_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyyyy_xzz_1[j];

                    tg_yyyyyy_xzzz_0[j] = pb_y * tg_yyyyy_xzzz_0[j] + fr * tg_yyyyy_xzzz_1[j] + 2.5 * fl1_fx * (tg_yyyy_xzzz_0[j] - tg_yyyy_xzzz_1[j] * fl1_fza);

                    tg_yyyyyy_yyyy_0[j] = pb_y * tg_yyyyy_yyyy_0[j] + fr * tg_yyyyy_yyyy_1[j] + 2.5 * fl1_fx * (tg_yyyy_yyyy_0[j] - tg_yyyy_yyyy_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_yyyyy_yyy_1[j];

                    tg_yyyyyy_yyyz_0[j] = pb_y * tg_yyyyy_yyyz_0[j] + fr * tg_yyyyy_yyyz_1[j] + 2.5 * fl1_fx * (tg_yyyy_yyyz_0[j] - tg_yyyy_yyyz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yyyyy_yyz_1[j];

                    tg_yyyyyy_yyzz_0[j] = pb_y * tg_yyyyy_yyzz_0[j] + fr * tg_yyyyy_yyzz_1[j] + 2.5 * fl1_fx * (tg_yyyy_yyzz_0[j] - tg_yyyy_yyzz_1[j] * fl1_fza) + fl1_fxn * tg_yyyyy_yzz_1[j];

                    tg_yyyyyy_yzzz_0[j] = pb_y * tg_yyyyy_yzzz_0[j] + fr * tg_yyyyy_yzzz_1[j] + 2.5 * fl1_fx * (tg_yyyy_yzzz_0[j] - tg_yyyy_yzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyyyy_zzz_1[j];

                    tg_yyyyyy_zzzz_0[j] = pb_y * tg_yyyyy_zzzz_0[j] + fr * tg_yyyyy_zzzz_1[j] + 2.5 * fl1_fx * (tg_yyyy_zzzz_0[j] - tg_yyyy_zzzz_1[j] * fl1_fza);

                    tg_yyyyyz_xxxx_0[j] = pb_y * tg_yyyyz_xxxx_0[j] + fr * tg_yyyyz_xxxx_1[j] + 2.0 * fl1_fx * (tg_yyyz_xxxx_0[j] - tg_yyyz_xxxx_1[j] * fl1_fza);

                    tg_yyyyyz_xxxy_0[j] = pb_y * tg_yyyyz_xxxy_0[j] + fr * tg_yyyyz_xxxy_1[j] + 2.0 * fl1_fx * (tg_yyyz_xxxy_0[j] - tg_yyyz_xxxy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyyyz_xxx_1[j];

                    tg_yyyyyz_xxxz_0[j] = pb_y * tg_yyyyz_xxxz_0[j] + fr * tg_yyyyz_xxxz_1[j] + 2.0 * fl1_fx * (tg_yyyz_xxxz_0[j] - tg_yyyz_xxxz_1[j] * fl1_fza);

                    tg_yyyyyz_xxyy_0[j] = pb_y * tg_yyyyz_xxyy_0[j] + fr * tg_yyyyz_xxyy_1[j] + 2.0 * fl1_fx * (tg_yyyz_xxyy_0[j] - tg_yyyz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_yyyyz_xxy_1[j];

                    tg_yyyyyz_xxyz_0[j] = pb_y * tg_yyyyz_xxyz_0[j] + fr * tg_yyyyz_xxyz_1[j] + 2.0 * fl1_fx * (tg_yyyz_xxyz_0[j] - tg_yyyz_xxyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyyyz_xxz_1[j];

                    tg_yyyyyz_xxzz_0[j] = pb_y * tg_yyyyz_xxzz_0[j] + fr * tg_yyyyz_xxzz_1[j] + 2.0 * fl1_fx * (tg_yyyz_xxzz_0[j] - tg_yyyz_xxzz_1[j] * fl1_fza);
                }
    ...
    void
    compElectronRepulsionForSISG_336_420(      CMemBlock2D<double>* primBuffer,
                                         const CRecursionMap&       recursionMap,
                                         const CMemBlock2D<double>& osFactors,
                                         const CMemBlock2D<double>& wpDistances,
                                         const CGtoPairsBlock&      braGtoPairsBlock,
                                         ...
                                         const int32_t              iContrPair)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrPair]; i < epos[iContrPair]; i++)
            {
                ...
                #pragma omp simd aligned(fxn, fza, tg_yyyyyz_xyyy_0, tg_yyyyyz_xyyz_0, tg_yyyyyz_xyzz_0, \
                                         tg_yyyyyz_xzzz_0, tg_yyyyyz_yyyy_0, tg_yyyyyz_yyyz_0, tg_yyyyyz_yyzz_0, \
                                         tg_yyyyyz_yzzz_0, tg_yyyyyz_zzzz_0, tg_yyyyz_xyy_1, tg_yyyyz_xyyy_0, tg_yyyyz_xyyy_1, \
                                         tg_yyyyz_xyyz_0, tg_yyyyz_xyyz_1, tg_yyyyz_xyz_1, tg_yyyyz_xyzz_0, tg_yyyyz_xyzz_1, \
                                         tg_yyyyz_xzz_1, tg_yyyyz_xzzz_0, tg_yyyyz_xzzz_1, tg_yyyyz_yyy_1, tg_yyyyz_yyyy_0, \
                                         ...
                                         tg_yyyyzz_zzzz_0, tg_yyyz_xyyy_0, tg_yyyz_xyyy_1, tg_yyyz_xyyz_0, tg_yyyz_xyyz_1, \
                                         ...
                                         tg_yyyz_yzzz_0, tg_yyyz_yzzz_1, tg_yyyz_zzzz_0, tg_yyyz_zzzz_1, tg_yyyzz_xxx_1, \
                                         tg_yyyzz_xxxx_0, tg_yyyzz_xxxx_1, tg_yyyzz_xxxy_0, tg_yyyzz_xxxy_1, tg_yyyzz_xxxz_0, \
                                         tg_yyyzz_xxxz_1, tg_yyyzz_xxy_1, tg_yyyzz_xxyy_0, tg_yyyzz_xxyy_1, tg_yyyzz_xxyz_0, \
                                         tg_yyyzz_xxyz_1, tg_yyyzz_xxz_1, tg_yyyzz_xxzz_0, tg_yyyzz_xxzz_1, tg_yyyzz_xyy_1, \
                                         tg_yyyzz_xyyy_0, tg_yyyzz_xyyy_1, tg_yyyzz_xyyz_0, tg_yyyzz_xyyz_1, tg_yyyzz_xyz_1, \
                                         ...
                                         tg_yyyzz_yyy_1, tg_yyyzz_yyyy_0, tg_yyyzz_yyyy_1, tg_yyyzz_yyyz_0, tg_yyyzz_yyyz_1, \
                                         tg_yyyzz_yyz_1, tg_yyyzz_yyzz_0, tg_yyyzz_yyzz_1, tg_yyyzz_yzz_1, tg_yyyzz_yzzz_0, \
                                         tg_yyyzz_yzzz_1, tg_yyyzz_zzz_1, tg_yyyzz_zzzz_0, tg_yyyzz_zzzz_1, tg_yyyzzz_xxxx_0, \
                                         tg_yyyzzz_xxxy_0, tg_yyyzzz_xxxz_0, tg_yyyzzz_xxyy_0, tg_yyyzzz_xxyz_0, \
                                         tg_yyyzzz_xxzz_0, tg_yyyzzz_xyyy_0, tg_yyyzzz_xyyz_0, tg_yyyzzz_xyzz_0, \
                                         tg_yyyzzz_xzzz_0, tg_yyyzzz_yyyy_0, tg_yyyzzz_yyyz_0, tg_yyyzzz_yyzz_0, \
                                         tg_yyyzzz_yzzz_0, tg_yyyzzz_zzzz_0, tg_yyzz_xxxx_0, tg_yyzz_xxxx_1, tg_yyzz_xxxy_0, \
                                         tg_yyzz_xxxy_1, tg_yyzz_xxxz_0, tg_yyzz_xxxz_1, tg_yyzz_xxyy_0, tg_yyzz_xxyy_1, \
                                         tg_yyzz_xxyz_0, tg_yyzz_xxyz_1, tg_yyzz_xxzz_0, tg_yyzz_xxzz_1, tg_yyzz_xyyy_0, \
                                         tg_yyzz_xyyy_1, tg_yyzz_xyyz_0, tg_yyzz_xyyz_1, tg_yyzz_xyzz_0, tg_yyzz_xyzz_1, \
                                         tg_yyzz_xzzz_0, tg_yyzz_xzzz_1, tg_yyzz_yyyy_0, tg_yyzz_yyyy_1, tg_yyzz_yyyz_0, \
                                         tg_yyzz_yyyz_1, tg_yyzz_yyzz_0, tg_yyzz_yyzz_1, tg_yyzz_yzzz_0, tg_yyzz_yzzz_1, \
                                         tg_yyzz_zzzz_0, tg_yyzz_zzzz_1, tg_yyzzz_xxx_1, tg_yyzzz_xxxx_0, tg_yyzzz_xxxx_1, \
                                         tg_yyzzz_xxxy_0, tg_yyzzz_xxxy_1, tg_yyzzz_xxxz_0, tg_yyzzz_xxxz_1, tg_yyzzz_xxy_1, \
                                         tg_yyzzz_xxyy_0, tg_yyzzz_xxyy_1, tg_yyzzz_xxyz_0, tg_yyzzz_xxyz_1, tg_yyzzz_xxz_1, \
                                         tg_yyzzz_xxzz_0, tg_yyzzz_xxzz_1, tg_yyzzz_xyy_1, tg_yyzzz_xyyy_0, tg_yyzzz_xyyy_1, \
                                         tg_yyzzz_xyyz_0, tg_yyzzz_xyyz_1, tg_yyzzz_xyz_1, tg_yyzzz_xyzz_0, tg_yyzzz_xyzz_1, \
                                         tg_yyzzz_xzz_1, tg_yyzzz_xzzz_0, tg_yyzzz_xzzz_1, tg_yyzzz_yyy_1, tg_yyzzz_yyyy_0, \
                                         tg_yyzzz_yyyy_1, tg_yyzzz_yyyz_0, tg_yyzzz_yyyz_1, tg_yyzzz_yyz_1, tg_yyzzz_yyzz_0, \
                                         tg_yyzzz_yyzz_1, tg_yyzzz_yzz_1, tg_yyzzz_yzzz_0, tg_yyzzz_yzzz_1, tg_yyzzz_zzz_1, \
                                         tg_yyzzz_zzzz_0, tg_yyzzz_zzzz_1, tg_yyzzzz_xxxx_0, tg_yyzzzz_xxxy_0, \
                                         tg_yyzzzz_xxxz_0, tg_yyzzzz_xxyy_0, tg_yyzzzz_xxyz_0, tg_yyzzzz_xxzz_0, \
                                         tg_yyzzzz_xyyy_0, tg_yyzzzz_xyyz_0, tg_yyzzzz_xyzz_0, tg_yyzzzz_xzzz_0, \
                                         tg_yyzzzz_yyyy_0, tg_yyzzzz_yyyz_0, tg_yyzzzz_yyzz_0, tg_yyzzzz_yzzz_0, \
                                         tg_yyzzzz_zzzz_0, tg_yzzz_xxxx_0, tg_yzzz_xxxx_1, tg_yzzz_xxxy_0, tg_yzzz_xxxy_1, \
                                         ...
                                         tg_yzzz_yyzz_0, tg_yzzz_yyzz_1, tg_yzzz_yzzz_0, tg_yzzz_yzzz_1, tg_yzzz_zzzz_0, \
                                         tg_yzzz_zzzz_1, tg_yzzzz_xxx_1, tg_yzzzz_xxxx_0, tg_yzzzz_xxxx_1, tg_yzzzz_xxxy_0, \
                                         ...
                                         tg_yzzzz_zzzz_1, tg_yzzzzz_xxxx_0, tg_yzzzzz_xxxy_0, tg_yzzzzz_xxxz_0, \
                                         tg_yzzzzz_xxyy_0, tg_yzzzzz_xxyz_0, tg_yzzzzz_xxzz_0, tg_yzzzzz_xyyy_0, \
                                         tg_yzzzzz_xyyz_0, tg_yzzzzz_xyzz_0, tg_yzzzzz_xzzz_0, tg_yzzzzz_yyyy_0, \
                                         tg_yzzzzz_yyyz_0, tg_yzzzzz_yyzz_0, tg_yzzzzz_yzzz_0, tg_yzzzzz_zzzz_0, \
                                         tg_zzzz_xxxx_0, tg_zzzz_xxxx_1, tg_zzzz_xxxy_0, tg_zzzz_xxxy_1, tg_zzzz_xxxz_0, \
                                         tg_zzzz_xxxz_1, tg_zzzz_xxyy_0, tg_zzzz_xxyy_1, tg_zzzz_xxyz_0, tg_zzzz_xxyz_1, \
                                         tg_zzzz_xxzz_0, tg_zzzz_xxzz_1, tg_zzzz_xyyy_0, tg_zzzz_xyyy_1, tg_zzzz_xyyz_0, \
                                         tg_zzzz_xyyz_1, tg_zzzz_xyzz_0, tg_zzzz_xyzz_1, tg_zzzz_xzzz_0, tg_zzzz_xzzz_1, \
                                         tg_zzzz_yyyy_0, tg_zzzz_yyyy_1, tg_zzzz_yyyz_0, tg_zzzz_yyyz_1, tg_zzzz_yyzz_0, \
                                         tg_zzzz_yyzz_1, tg_zzzz_yzzz_0, tg_zzzz_yzzz_1, tg_zzzz_zzzz_0, tg_zzzz_zzzz_1, \
                                         tg_zzzzz_xxx_1, tg_zzzzz_xxxx_0, tg_zzzzz_xxxx_1, tg_zzzzz_xxxy_0, tg_zzzzz_xxxy_1, \
                                         tg_zzzzz_xxxz_0, tg_zzzzz_xxxz_1, tg_zzzzz_xxy_1, tg_zzzzz_xxyy_0, tg_zzzzz_xxyy_1, \
                                         tg_zzzzz_xxyz_0, tg_zzzzz_xxyz_1, tg_zzzzz_xxz_1, tg_zzzzz_xxzz_0, tg_zzzzz_xxzz_1, \
                                         tg_zzzzz_xyy_1, tg_zzzzz_xyyy_0, tg_zzzzz_xyyy_1, tg_zzzzz_xyyz_0, tg_zzzzz_xyyz_1, \
                                         tg_zzzzz_xyz_1, tg_zzzzz_xyzz_0, tg_zzzzz_xyzz_1, tg_zzzzz_xzz_1, tg_zzzzz_xzzz_0, \
                                         tg_zzzzz_xzzz_1, tg_zzzzz_yyy_1, tg_zzzzz_yyyy_0, tg_zzzzz_yyyy_1, tg_zzzzz_yyyz_0, \
                                         tg_zzzzz_yyyz_1, tg_zzzzz_yyz_1, tg_zzzzz_yyzz_0, tg_zzzzz_yyzz_1, tg_zzzzz_yzz_1, \
                                         tg_zzzzz_yzzz_0, tg_zzzzz_yzzz_1, tg_zzzzz_zzz_1, tg_zzzzz_zzzz_0, tg_zzzzz_zzzz_1, \
                                         tg_zzzzzz_xxxx_0, tg_zzzzzz_xxxy_0, tg_zzzzzz_xxxz_0, tg_zzzzzz_xxyy_0, \
                                         tg_zzzzzz_xxyz_0, tg_zzzzzz_xxzz_0, tg_zzzzzz_xyyy_0, tg_zzzzzz_xyyz_0, \
                                         tg_zzzzzz_xyzz_0, tg_zzzzzz_xzzz_0, tg_zzzzzz_yyyy_0, tg_zzzzzz_yyyz_0, \
                                         tg_zzzzzz_yyzz_0, tg_zzzzzz_yzzz_0, tg_zzzzzz_zzzz_0, wp_y, wp_z: VLX_ALIGN)
                for (int32_t j = 0; j < nKetPrimPairs; j++)
                {
                    double fl1_fx = fx;
                    ...
                    tg_yyyyyz_xyyy_0[j] = pb_y * tg_yyyyz_xyyy_0[j] + fr * tg_yyyyz_xyyy_1[j] + 2.0 * fl1_fx * (tg_yyyz_xyyy_0[j] - tg_yyyz_xyyy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yyyyz_xyy_1[j];

                    tg_yyyyyz_xyyz_0[j] = pb_y * tg_yyyyz_xyyz_0[j] + fr * tg_yyyyz_xyyz_1[j] + 2.0 * fl1_fx * (tg_yyyz_xyyz_0[j] - tg_yyyz_xyyz_1[j] * fl1_fza) + fl1_fxn * tg_yyyyz_xyz_1[j];

                    tg_yyyyyz_xyzz_0[j] = pb_y * tg_yyyyz_xyzz_0[j] + fr * tg_yyyyz_xyzz_1[j] + 2.0 * fl1_fx * (tg_yyyz_xyzz_0[j] - tg_yyyz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyyyz_xzz_1[j];

                    tg_yyyyyz_xzzz_0[j] = pb_y * tg_yyyyz_xzzz_0[j] + fr * tg_yyyyz_xzzz_1[j] + 2.0 * fl1_fx * (tg_yyyz_xzzz_0[j] - tg_yyyz_xzzz_1[j] * fl1_fza);

                    tg_yyyyyz_yyyy_0[j] = pb_y * tg_yyyyz_yyyy_0[j] + fr * tg_yyyyz_yyyy_1[j] + 2.0 * fl1_fx * (tg_yyyz_yyyy_0[j] - tg_yyyz_yyyy_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_yyyyz_yyy_1[j];

                    tg_yyyyyz_yyyz_0[j] = pb_y * tg_yyyyz_yyyz_0[j] + fr * tg_yyyyz_yyyz_1[j] + 2.0 * fl1_fx * (tg_yyyz_yyyz_0[j] - tg_yyyz_yyyz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yyyyz_yyz_1[j];

                    tg_yyyyyz_yyzz_0[j] = pb_y * tg_yyyyz_yyzz_0[j] + fr * tg_yyyyz_yyzz_1[j] + 2.0 * fl1_fx * (tg_yyyz_yyzz_0[j] - tg_yyyz_yyzz_1[j] * fl1_fza) + fl1_fxn * tg_yyyyz_yzz_1[j];

                    tg_yyyyyz_yzzz_0[j] = pb_y * tg_yyyyz_yzzz_0[j] + fr * tg_yyyyz_yzzz_1[j] + 2.0 * fl1_fx * (tg_yyyz_yzzz_0[j] - tg_yyyz_yzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyyyz_zzz_1[j];

                    tg_yyyyyz_zzzz_0[j] = pb_y * tg_yyyyz_zzzz_0[j] + fr * tg_yyyyz_zzzz_1[j] + 2.0 * fl1_fx * (tg_yyyz_zzzz_0[j] - tg_yyyz_zzzz_1[j] * fl1_fza);

                    tg_yyyyzz_xxxx_0[j] = pb_y * tg_yyyzz_xxxx_0[j] + fr * tg_yyyzz_xxxx_1[j] + 1.5 * fl1_fx * (tg_yyzz_xxxx_0[j] - tg_yyzz_xxxx_1[j] * fl1_fza);

                    tg_yyyyzz_xxxy_0[j] = pb_y * tg_yyyzz_xxxy_0[j] + fr * tg_yyyzz_xxxy_1[j] + 1.5 * fl1_fx * (tg_yyzz_xxxy_0[j] - tg_yyzz_xxxy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyyzz_xxx_1[j];

                    tg_yyyyzz_xxxz_0[j] = pb_y * tg_yyyzz_xxxz_0[j] + fr * tg_yyyzz_xxxz_1[j] + 1.5 * fl1_fx * (tg_yyzz_xxxz_0[j] - tg_yyzz_xxxz_1[j] * fl1_fza);

                    tg_yyyyzz_xxyy_0[j] = pb_y * tg_yyyzz_xxyy_0[j] + fr * tg_yyyzz_xxyy_1[j] + 1.5 * fl1_fx * (tg_yyzz_xxyy_0[j] - tg_yyzz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_yyyzz_xxy_1[j];

                    tg_yyyyzz_xxyz_0[j] = pb_y * tg_yyyzz_xxyz_0[j] + fr * tg_yyyzz_xxyz_1[j] + 1.5 * fl1_fx * (tg_yyzz_xxyz_0[j] - tg_yyzz_xxyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyyzz_xxz_1[j];

                    tg_yyyyzz_xxzz_0[j] = pb_y * tg_yyyzz_xxzz_0[j] + fr * tg_yyyzz_xxzz_1[j] + 1.5 * fl1_fx * (tg_yyzz_xxzz_0[j] - tg_yyzz_xxzz_1[j] * fl1_fza);

                    tg_yyyyzz_xyyy_0[j] = pb_y * tg_yyyzz_xyyy_0[j] + fr * tg_yyyzz_xyyy_1[j] + 1.5 * fl1_fx * (tg_yyzz_xyyy_0[j] - tg_yyzz_xyyy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yyyzz_xyy_1[j];

                    tg_yyyyzz_xyyz_0[j] = pb_y * tg_yyyzz_xyyz_0[j] + fr * tg_yyyzz_xyyz_1[j] + 1.5 * fl1_fx * (tg_yyzz_xyyz_0[j] - tg_yyzz_xyyz_1[j] * fl1_fza) + fl1_fxn * tg_yyyzz_xyz_1[j];

                    tg_yyyyzz_xyzz_0[j] = pb_y * tg_yyyzz_xyzz_0[j] + fr * tg_yyyzz_xyzz_1[j] + 1.5 * fl1_fx * (tg_yyzz_xyzz_0[j] - tg_yyzz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyyzz_xzz_1[j];

                    tg_yyyyzz_xzzz_0[j] = pb_y * tg_yyyzz_xzzz_0[j] + fr * tg_yyyzz_xzzz_1[j] + 1.5 * fl1_fx * (tg_yyzz_xzzz_0[j] - tg_yyzz_xzzz_1[j] * fl1_fza);

                    tg_yyyyzz_yyyy_0[j] = pb_y * tg_yyyzz_yyyy_0[j] + fr * tg_yyyzz_yyyy_1[j] + 1.5 * fl1_fx * (tg_yyzz_yyyy_0[j] - tg_yyzz_yyyy_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_yyyzz_yyy_1[j];

                    tg_yyyyzz_yyyz_0[j] = pb_y * tg_yyyzz_yyyz_0[j] + fr * tg_yyyzz_yyyz_1[j] + 1.5 * fl1_fx * (tg_yyzz_yyyz_0[j] - tg_yyzz_yyyz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yyyzz_yyz_1[j];

                    tg_yyyyzz_yyzz_0[j] = pb_y * tg_yyyzz_yyzz_0[j] + fr * tg_yyyzz_yyzz_1[j] + 1.5 * fl1_fx * (tg_yyzz_yyzz_0[j] - tg_yyzz_yyzz_1[j] * fl1_fza) + fl1_fxn * tg_yyyzz_yzz_1[j];

                    tg_yyyyzz_yzzz_0[j] = pb_y * tg_yyyzz_yzzz_0[j] + fr * tg_yyyzz_yzzz_1[j] + 1.5 * fl1_fx * (tg_yyzz_yzzz_0[j] - tg_yyzz_yzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyyzz_zzz_1[j];

                    tg_yyyyzz_zzzz_0[j] = pb_y * tg_yyyzz_zzzz_0[j] + fr * tg_yyyzz_zzzz_1[j] + 1.5 * fl1_fx * (tg_yyzz_zzzz_0[j] - tg_yyzz_zzzz_1[j] * fl1_fza);

                    tg_yyyzzz_xxxx_0[j] = pb_y * tg_yyzzz_xxxx_0[j] + fr * tg_yyzzz_xxxx_1[j] + fl1_fx * (tg_yzzz_xxxx_0[j] - tg_yzzz_xxxx_1[j] * fl1_fza);

                    tg_yyyzzz_xxxy_0[j] = pb_y * tg_yyzzz_xxxy_0[j] + fr * tg_yyzzz_xxxy_1[j] + fl1_fx * (tg_yzzz_xxxy_0[j] - tg_yzzz_xxxy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyzzz_xxx_1[j];

                    tg_yyyzzz_xxxz_0[j] = pb_y * tg_yyzzz_xxxz_0[j] + fr * tg_yyzzz_xxxz_1[j] + fl1_fx * (tg_yzzz_xxxz_0[j] - tg_yzzz_xxxz_1[j] * fl1_fza);

                    tg_yyyzzz_xxyy_0[j] = pb_y * tg_yyzzz_xxyy_0[j] + fr * tg_yyzzz_xxyy_1[j] + fl1_fx * (tg_yzzz_xxyy_0[j] - tg_yzzz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_yyzzz_xxy_1[j];

                    tg_yyyzzz_xxyz_0[j] = pb_y * tg_yyzzz_xxyz_0[j] + fr * tg_yyzzz_xxyz_1[j] + fl1_fx * (tg_yzzz_xxyz_0[j] - tg_yzzz_xxyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyzzz_xxz_1[j];

                    tg_yyyzzz_xxzz_0[j] = pb_y * tg_yyzzz_xxzz_0[j] + fr * tg_yyzzz_xxzz_1[j] + fl1_fx * (tg_yzzz_xxzz_0[j] - tg_yzzz_xxzz_1[j] * fl1_fza);

                    tg_yyyzzz_xyyy_0[j] = pb_y * tg_yyzzz_xyyy_0[j] + fr * tg_yyzzz_xyyy_1[j] + fl1_fx * (tg_yzzz_xyyy_0[j] - tg_yzzz_xyyy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yyzzz_xyy_1[j];

                    tg_yyyzzz_xyyz_0[j] = pb_y * tg_yyzzz_xyyz_0[j] + fr * tg_yyzzz_xyyz_1[j] + fl1_fx * (tg_yzzz_xyyz_0[j] - tg_yzzz_xyyz_1[j] * fl1_fza) + fl1_fxn * tg_yyzzz_xyz_1[j];

                    tg_yyyzzz_xyzz_0[j] = pb_y * tg_yyzzz_xyzz_0[j] + fr * tg_yyzzz_xyzz_1[j] + fl1_fx * (tg_yzzz_xyzz_0[j] - tg_yzzz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyzzz_xzz_1[j];

                    tg_yyyzzz_xzzz_0[j] = pb_y * tg_yyzzz_xzzz_0[j] + fr * tg_yyzzz_xzzz_1[j] + fl1_fx * (tg_yzzz_xzzz_0[j] - tg_yzzz_xzzz_1[j] * fl1_fza);

                    tg_yyyzzz_yyyy_0[j] = pb_y * tg_yyzzz_yyyy_0[j] + fr * tg_yyzzz_yyyy_1[j] + fl1_fx * (tg_yzzz_yyyy_0[j] - tg_yzzz_yyyy_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_yyzzz_yyy_1[j];

                    tg_yyyzzz_yyyz_0[j] = pb_y * tg_yyzzz_yyyz_0[j] + fr * tg_yyzzz_yyyz_1[j] + fl1_fx * (tg_yzzz_yyyz_0[j] - tg_yzzz_yyyz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yyzzz_yyz_1[j];

                    tg_yyyzzz_yyzz_0[j] = pb_y * tg_yyzzz_yyzz_0[j] + fr * tg_yyzzz_yyzz_1[j] + fl1_fx * (tg_yzzz_yyzz_0[j] - tg_yzzz_yyzz_1[j] * fl1_fza) + fl1_fxn * tg_yyzzz_yzz_1[j];

                    tg_yyyzzz_yzzz_0[j] = pb_y * tg_yyzzz_yzzz_0[j] + fr * tg_yyzzz_yzzz_1[j] + fl1_fx * (tg_yzzz_yzzz_0[j] - tg_yzzz_yzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yyzzz_zzz_1[j];

                    tg_yyyzzz_zzzz_0[j] = pb_y * tg_yyzzz_zzzz_0[j] + fr * tg_yyzzz_zzzz_1[j] + fl1_fx * (tg_yzzz_zzzz_0[j] - tg_yzzz_zzzz_1[j] * fl1_fza);

                    tg_yyzzzz_xxxx_0[j] = pb_y * tg_yzzzz_xxxx_0[j] + fr * tg_yzzzz_xxxx_1[j] + 0.5 * fl1_fx * (tg_zzzz_xxxx_0[j] - tg_zzzz_xxxx_1[j] * fl1_fza);

                    tg_yyzzzz_xxxy_0[j] = pb_y * tg_yzzzz_xxxy_0[j] + fr * tg_yzzzz_xxxy_1[j] + 0.5 * fl1_fx * (tg_zzzz_xxxy_0[j] - tg_zzzz_xxxy_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yzzzz_xxx_1[j];

                    tg_yyzzzz_xxxz_0[j] = pb_y * tg_yzzzz_xxxz_0[j] + fr * tg_yzzzz_xxxz_1[j] + 0.5 * fl1_fx * (tg_zzzz_xxxz_0[j] - tg_zzzz_xxxz_1[j] * fl1_fza);

                    tg_yyzzzz_xxyy_0[j] = pb_y * tg_yzzzz_xxyy_0[j] + fr * tg_yzzzz_xxyy_1[j] + 0.5 * fl1_fx * (tg_zzzz_xxyy_0[j] - tg_zzzz_xxyy_1[j] * fl1_fza) + fl1_fxn * tg_yzzzz_xxy_1[j];

                    tg_yyzzzz_xxyz_0[j] = pb_y * tg_yzzzz_xxyz_0[j] + fr * tg_yzzzz_xxyz_1[j] + 0.5 * fl1_fx * (tg_zzzz_xxyz_0[j] - tg_zzzz_xxyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yzzzz_xxz_1[j];

                    tg_yyzzzz_xxzz_0[j] = pb_y * tg_yzzzz_xxzz_0[j] + fr * tg_yzzzz_xxzz_1[j] + 0.5 * fl1_fx * (tg_zzzz_xxzz_0[j] - tg_zzzz_xxzz_1[j] * fl1_fza);

                    tg_yyzzzz_xyyy_0[j] = pb_y * tg_yzzzz_xyyy_0[j] + fr * tg_yzzzz_xyyy_1[j] + 0.5 * fl1_fx * (tg_zzzz_xyyy_0[j] - tg_zzzz_xyyy_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yzzzz_xyy_1[j];

                    tg_yyzzzz_xyyz_0[j] = pb_y * tg_yzzzz_xyyz_0[j] + fr * tg_yzzzz_xyyz_1[j] + 0.5 * fl1_fx * (tg_zzzz_xyyz_0[j] - tg_zzzz_xyyz_1[j] * fl1_fza) + fl1_fxn * tg_yzzzz_xyz_1[j];

                    tg_yyzzzz_xyzz_0[j] = pb_y * tg_yzzzz_xyzz_0[j] + fr * tg_yzzzz_xyzz_1[j] + 0.5 * fl1_fx * (tg_zzzz_xyzz_0[j] - tg_zzzz_xyzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yzzzz_xzz_1[j];

                    tg_yyzzzz_xzzz_0[j] = pb_y * tg_yzzzz_xzzz_0[j] + fr * tg_yzzzz_xzzz_1[j] + 0.5 * fl1_fx * (tg_zzzz_xzzz_0[j] - tg_zzzz_xzzz_1[j] * fl1_fza);

                    tg_yyzzzz_yyyy_0[j] = pb_y * tg_yzzzz_yyyy_0[j] + fr * tg_yzzzz_yyyy_1[j] + 0.5 * fl1_fx * (tg_zzzz_yyyy_0[j] - tg_zzzz_yyyy_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_yzzzz_yyy_1[j];

                    tg_yyzzzz_yyyz_0[j] = pb_y * tg_yzzzz_yyyz_0[j] + fr * tg_yzzzz_yyyz_1[j] + 0.5 * fl1_fx * (tg_zzzz_yyyz_0[j] - tg_zzzz_yyyz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_yzzzz_yyz_1[j];

                    tg_yyzzzz_yyzz_0[j] = pb_y * tg_yzzzz_yyzz_0[j] + fr * tg_yzzzz_yyzz_1[j] + 0.5 * fl1_fx * (tg_zzzz_yyzz_0[j] - tg_zzzz_yyzz_1[j] * fl1_fza) + fl1_fxn * tg_yzzzz_yzz_1[j];

                    tg_yyzzzz_yzzz_0[j] = pb_y * tg_yzzzz_yzzz_0[j] + fr * tg_yzzzz_yzzz_1[j] + 0.5 * fl1_fx * (tg_zzzz_yzzz_0[j] - tg_zzzz_yzzz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_yzzzz_zzz_1[j];

                    tg_yyzzzz_zzzz_0[j] = pb_y * tg_yzzzz_zzzz_0[j] + fr * tg_yzzzz_zzzz_1[j] + 0.5 * fl1_fx * (tg_zzzz_zzzz_0[j] - tg_zzzz_zzzz_1[j] * fl1_fza);

                    tg_yzzzzz_xxxx_0[j] = pb_y * tg_zzzzz_xxxx_0[j] + fr * tg_zzzzz_xxxx_1[j];

                    tg_yzzzzz_xxxy_0[j] = pb_y * tg_zzzzz_xxxy_0[j] + fr * tg_zzzzz_xxxy_1[j] + 0.5 * fl1_fxn * tg_zzzzz_xxx_1[j];

                    tg_yzzzzz_xxxz_0[j] = pb_y * tg_zzzzz_xxxz_0[j] + fr * tg_zzzzz_xxxz_1[j];

                    tg_yzzzzz_xxyy_0[j] = pb_y * tg_zzzzz_xxyy_0[j] + fr * tg_zzzzz_xxyy_1[j] + fl1_fxn * tg_zzzzz_xxy_1[j];

                    tg_yzzzzz_xxyz_0[j] = pb_y * tg_zzzzz_xxyz_0[j] + fr * tg_zzzzz_xxyz_1[j] + 0.5 * fl1_fxn * tg_zzzzz_xxz_1[j];

                    tg_yzzzzz_xxzz_0[j] = pb_y * tg_zzzzz_xxzz_0[j] + fr * tg_zzzzz_xxzz_1[j];

                    tg_yzzzzz_xyyy_0[j] = pb_y * tg_zzzzz_xyyy_0[j] + fr * tg_zzzzz_xyyy_1[j] + 1.5 * fl1_fxn * tg_zzzzz_xyy_1[j];

                    tg_yzzzzz_xyyz_0[j] = pb_y * tg_zzzzz_xyyz_0[j] + fr * tg_zzzzz_xyyz_1[j] + fl1_fxn * tg_zzzzz_xyz_1[j];

                    tg_yzzzzz_xyzz_0[j] = pb_y * tg_zzzzz_xyzz_0[j] + fr * tg_zzzzz_xyzz_1[j] + 0.5 * fl1_fxn * tg_zzzzz_xzz_1[j];

                    tg_yzzzzz_xzzz_0[j] = pb_y * tg_zzzzz_xzzz_0[j] + fr * tg_zzzzz_xzzz_1[j];

                    tg_yzzzzz_yyyy_0[j] = pb_y * tg_zzzzz_yyyy_0[j] + fr * tg_zzzzz_yyyy_1[j] + 2.0 * fl1_fxn * tg_zzzzz_yyy_1[j];

                    tg_yzzzzz_yyyz_0[j] = pb_y * tg_zzzzz_yyyz_0[j] + fr * tg_zzzzz_yyyz_1[j] + 1.5 * fl1_fxn * tg_zzzzz_yyz_1[j];

                    tg_yzzzzz_yyzz_0[j] = pb_y * tg_zzzzz_yyzz_0[j] + fr * tg_zzzzz_yyzz_1[j] + fl1_fxn * tg_zzzzz_yzz_1[j];

                    tg_yzzzzz_yzzz_0[j] = pb_y * tg_zzzzz_yzzz_0[j] + fr * tg_zzzzz_yzzz_1[j] + 0.5 * fl1_fxn * tg_zzzzz_zzz_1[j];

                    tg_yzzzzz_zzzz_0[j] = pb_y * tg_zzzzz_zzzz_0[j] + fr * tg_zzzzz_zzzz_1[j];

                    fr = wp_z[j]; 

                    tg_zzzzzz_xxxx_0[j] = pb_z * tg_zzzzz_xxxx_0[j] + fr * tg_zzzzz_xxxx_1[j] + 2.5 * fl1_fx * (tg_zzzz_xxxx_0[j] - tg_zzzz_xxxx_1[j] * fl1_fza);

                    tg_zzzzzz_xxxy_0[j] = pb_z * tg_zzzzz_xxxy_0[j] + fr * tg_zzzzz_xxxy_1[j] + 2.5 * fl1_fx * (tg_zzzz_xxxy_0[j] - tg_zzzz_xxxy_1[j] * fl1_fza);

                    tg_zzzzzz_xxxz_0[j] = pb_z * tg_zzzzz_xxxz_0[j] + fr * tg_zzzzz_xxxz_1[j] + 2.5 * fl1_fx * (tg_zzzz_xxxz_0[j] - tg_zzzz_xxxz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_zzzzz_xxx_1[j];

                    tg_zzzzzz_xxyy_0[j] = pb_z * tg_zzzzz_xxyy_0[j] + fr * tg_zzzzz_xxyy_1[j] + 2.5 * fl1_fx * (tg_zzzz_xxyy_0[j] - tg_zzzz_xxyy_1[j] * fl1_fza);

                    tg_zzzzzz_xxyz_0[j] = pb_z * tg_zzzzz_xxyz_0[j] + fr * tg_zzzzz_xxyz_1[j] + 2.5 * fl1_fx * (tg_zzzz_xxyz_0[j] - tg_zzzz_xxyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_zzzzz_xxy_1[j];

                    tg_zzzzzz_xxzz_0[j] = pb_z * tg_zzzzz_xxzz_0[j] + fr * tg_zzzzz_xxzz_1[j] + 2.5 * fl1_fx * (tg_zzzz_xxzz_0[j] - tg_zzzz_xxzz_1[j] * fl1_fza) + fl1_fxn * tg_zzzzz_xxz_1[j];

                    tg_zzzzzz_xyyy_0[j] = pb_z * tg_zzzzz_xyyy_0[j] + fr * tg_zzzzz_xyyy_1[j] + 2.5 * fl1_fx * (tg_zzzz_xyyy_0[j] - tg_zzzz_xyyy_1[j] * fl1_fza);

                    tg_zzzzzz_xyyz_0[j] = pb_z * tg_zzzzz_xyyz_0[j] + fr * tg_zzzzz_xyyz_1[j] + 2.5 * fl1_fx * (tg_zzzz_xyyz_0[j] - tg_zzzz_xyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_zzzzz_xyy_1[j];

                    tg_zzzzzz_xyzz_0[j] = pb_z * tg_zzzzz_xyzz_0[j] + fr * tg_zzzzz_xyzz_1[j] + 2.5 * fl1_fx * (tg_zzzz_xyzz_0[j] - tg_zzzz_xyzz_1[j] * fl1_fza) + fl1_fxn * tg_zzzzz_xyz_1[j];

                    tg_zzzzzz_xzzz_0[j] = pb_z * tg_zzzzz_xzzz_0[j] + fr * tg_zzzzz_xzzz_1[j] + 2.5 * fl1_fx * (tg_zzzz_xzzz_0[j] - tg_zzzz_xzzz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_zzzzz_xzz_1[j];

                    tg_zzzzzz_yyyy_0[j] = pb_z * tg_zzzzz_yyyy_0[j] + fr * tg_zzzzz_yyyy_1[j] + 2.5 * fl1_fx * (tg_zzzz_yyyy_0[j] - tg_zzzz_yyyy_1[j] * fl1_fza);

                    tg_zzzzzz_yyyz_0[j] = pb_z * tg_zzzzz_yyyz_0[j] + fr * tg_zzzzz_yyyz_1[j] + 2.5 * fl1_fx * (tg_zzzz_yyyz_0[j] - tg_zzzz_yyyz_1[j] * fl1_fza) + 0.5 * fl1_fxn * tg_zzzzz_yyy_1[j];

                    tg_zzzzzz_yyzz_0[j] = pb_z * tg_zzzzz_yyzz_0[j] + fr * tg_zzzzz_yyzz_1[j] + 2.5 * fl1_fx * (tg_zzzz_yyzz_0[j] - tg_zzzz_yyzz_1[j] * fl1_fza) + fl1_fxn * tg_zzzzz_yyz_1[j];

                    tg_zzzzzz_yzzz_0[j] = pb_z * tg_zzzzz_yzzz_0[j] + fr * tg_zzzzz_yzzz_1[j] + 2.5 * fl1_fx * (tg_zzzz_yzzz_0[j] - tg_zzzz_yzzz_1[j] * fl1_fza) + 1.5 * fl1_fxn * tg_zzzzz_yzz_1[j];

                    tg_zzzzzz_zzzz_0[j] = pb_z * tg_zzzzz_zzzz_0[j] + fr * tg_zzzzz_zzzz_1[j] + 2.5 * fl1_fx * (tg_zzzz_zzzz_0[j] - tg_zzzz_zzzz_1[j] * fl1_fza) + 2.0 * fl1_fxn * tg_zzzzz_zzz_1[j];
                }
