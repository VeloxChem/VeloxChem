...
namespace npotrecfunc { // npotrecfunc namespace
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
            {
                ...
                for (int32_t j = 0; j < nprim; j++)
                {
                    ...
                    ta_xx_x_0[j] = pa_x[j] * ta_x_x_0[j] - pc_x[j] * ta_x_x_1[j] + 0.5 * fl1_fx * ta_0_x_0[j] - 0.5 * fl1_fx * ta_0_x_1[j] + 0.5 * fl1_fx * ta_x_0_0[j] - 0.5 * fl1_fx * ta_x_0_1[j];
                    ...
                    ta_yy_y_0[j] = pa_y[j] * ta_y_y_0[j] - pc_y[j] * ta_y_y_1[j] + 0.5 * fl1_fx * ta_0_y_0[j] - 0.5 * fl1_fx * ta_0_y_1[j] + 0.5 * fl1_fx * ta_y_0_0[j] - 0.5 * fl1_fx * ta_y_0_1[j];
                    ...
                    ta_zz_z_0[j] = pa_z[j] * ta_z_z_0[j] - pc_z[j] * ta_z_z_1[j] + 0.5 * fl1_fx * ta_0_z_0[j] - 0.5 * fl1_fx * ta_0_z_1[j] + 0.5 * fl1_fx * ta_z_0_0[j] - 0.5 * fl1_fx * ta_z_0_1[j];
                }
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
            {
                ...
                for (int32_t j = 0; j < nprim; j++)
                {
                    ...
                    ta_xxx_x_0[j] = pa_x[j] * ta_xx_x_0[j] - pc_x[j] * ta_xx_x_1[j] + fl1_fx * ta_x_x_0[j] - fl1_fx * ta_x_x_1[j] + 0.5 * fl1_fx * ta_xx_0_0[j] - 0.5 * fl1_fx * ta_xx_0_1[j];
                    ...
                    ta_xxy_x_0[j] = pa_x[j] * ta_xy_x_0[j] - pc_x[j] * ta_xy_x_1[j] + 0.5 * fl1_fx * ta_y_x_0[j] - 0.5 * fl1_fx * ta_y_x_1[j] + 0.5 * fl1_fx * ta_xy_0_0[j] - 0.5 * fl1_fx * ta_xy_0_1[j];
                    ...
                    ta_xxz_x_0[j] = pa_x[j] * ta_xz_x_0[j] - pc_x[j] * ta_xz_x_1[j] + 0.5 * fl1_fx * ta_z_x_0[j] - 0.5 * fl1_fx * ta_z_x_1[j] + 0.5 * fl1_fx * ta_xz_0_0[j] - 0.5 * fl1_fx * ta_xz_0_1[j];
                    ...
                    ta_yyy_y_0[j] = pa_y[j] * ta_yy_y_0[j] - pc_y[j] * ta_yy_y_1[j] + fl1_fx * ta_y_y_0[j] - fl1_fx * ta_y_y_1[j] + 0.5 * fl1_fx * ta_yy_0_0[j] - 0.5 * fl1_fx * ta_yy_0_1[j];
                    ...
                    ta_yyz_y_0[j] = pa_y[j] * ta_yz_y_0[j] - pc_y[j] * ta_yz_y_1[j] + 0.5 * fl1_fx * ta_z_y_0[j] - 0.5 * fl1_fx * ta_z_y_1[j] + 0.5 * fl1_fx * ta_yz_0_0[j] - 0.5 * fl1_fx * ta_yz_0_1[j];
                    ...
                    ta_zzz_z_0[j] = pa_z[j] * ta_zz_z_0[j] - pc_z[j] * ta_zz_z_1[j] + fl1_fx * ta_z_z_0[j] - fl1_fx * ta_z_z_1[j] + 0.5 * fl1_fx * ta_zz_0_0[j] - 0.5 * fl1_fx * ta_zz_0_1[j];
                }
                              ...
                              const int32_t              iContrGto)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            auto pidx_a_4_1_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Nuclear Potential"}, 0, true, 
                                                             {4, -1, -1, -1}, {1, -1, -1, -1}, 
                                                             1, 1, iord));
            ...
            for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
            {
                ...
                for (int32_t j = 0; j < nprim; j++)
                {
                    ...
                    ta_xxxx_x_0[j] = pa_x[j] * ta_xxx_x_0[j] - pc_x[j] * ta_xxx_x_1[j] + 1.5 * fl1_fx * ta_xx_x_0[j] - 1.5 * fl1_fx * ta_xx_x_1[j] + 0.5 * fl1_fx * ta_xxx_0_0[j] - 0.5 * fl1_fx * ta_xxx_0_1[j];
                    ...
                    ta_xxxy_x_0[j] = pa_x[j] * ta_xxy_x_0[j] - pc_x[j] * ta_xxy_x_1[j] + fl1_fx * ta_xy_x_0[j] - fl1_fx * ta_xy_x_1[j] + 0.5 * fl1_fx * ta_xxy_0_0[j] - 0.5 * fl1_fx * ta_xxy_0_1[j];
                    ...
                    ta_xxxz_x_0[j] = pa_x[j] * ta_xxz_x_0[j] - pc_x[j] * ta_xxz_x_1[j] + fl1_fx * ta_xz_x_0[j] - fl1_fx * ta_xz_x_1[j] + 0.5 * fl1_fx * ta_xxz_0_0[j] - 0.5 * fl1_fx * ta_xxz_0_1[j];
                    ...
                    ta_xxyy_x_0[j] = pa_x[j] * ta_xyy_x_0[j] - pc_x[j] * ta_xyy_x_1[j] + 0.5 * fl1_fx * ta_yy_x_0[j] - 0.5 * fl1_fx * ta_yy_x_1[j] + 0.5 * fl1_fx * ta_xyy_0_0[j] - 0.5 * fl1_fx * ta_xyy_0_1[j];
                    ...
                    ta_xxyz_x_0[j] = pa_x[j] * ta_xyz_x_0[j] - pc_x[j] * ta_xyz_x_1[j] + 0.5 * fl1_fx * ta_yz_x_0[j] - 0.5 * fl1_fx * ta_yz_x_1[j] + 0.5 * fl1_fx * ta_xyz_0_0[j] - 0.5 * fl1_fx * ta_xyz_0_1[j];
                    ...
                    ta_xxzz_x_0[j] = pa_x[j] * ta_xzz_x_0[j] - pc_x[j] * ta_xzz_x_1[j] + 0.5 * fl1_fx * ta_zz_x_0[j] - 0.5 * fl1_fx * ta_zz_x_1[j] + 0.5 * fl1_fx * ta_xzz_0_0[j] - 0.5 * fl1_fx * ta_xzz_0_1[j];
                    ...
                    ta_yyyy_y_0[j] = pa_y[j] * ta_yyy_y_0[j] - pc_y[j] * ta_yyy_y_1[j] + 1.5 * fl1_fx * ta_yy_y_0[j] - 1.5 * fl1_fx * ta_yy_y_1[j] + 0.5 * fl1_fx * ta_yyy_0_0[j] - 0.5 * fl1_fx * ta_yyy_0_1[j];
                    ...
                    ta_yyyz_y_0[j] = pa_y[j] * ta_yyz_y_0[j] - pc_y[j] * ta_yyz_y_1[j] + fl1_fx * ta_yz_y_0[j] - fl1_fx * ta_yz_y_1[j] + 0.5 * fl1_fx * ta_yyz_0_0[j] - 0.5 * fl1_fx * ta_yyz_0_1[j];
                    ...
                    ta_yyzz_y_0[j] = pa_y[j] * ta_yzz_y_0[j] - pc_y[j] * ta_yzz_y_1[j] + 0.5 * fl1_fx * ta_zz_y_0[j] - 0.5 * fl1_fx * ta_zz_y_1[j] + 0.5 * fl1_fx * ta_yzz_0_0[j] - 0.5 * fl1_fx * ta_yzz_0_1[j];
                    ...
                    ta_zzzz_z_0[j] = pa_z[j] * ta_zzz_z_0[j] - pc_z[j] * ta_zzz_z_1[j] + 1.5 * fl1_fx * ta_zz_z_0[j] - 1.5 * fl1_fx * ta_zz_z_1[j] + 0.5 * fl1_fx * ta_zzz_0_0[j] - 0.5 * fl1_fx * ta_zzz_0_1[j];
                }
