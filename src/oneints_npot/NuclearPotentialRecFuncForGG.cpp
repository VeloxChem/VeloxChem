...
namespace npotrecfunc { // npotrecfunc namespace
    ...
    {
        npotrecfunc::compNuclearPotentialForGG_0_45(primBuffer,
                                                    recursionMap,
                                                    osFactors,
                                                    paDistances, 
                                                    pcDistances, 
        ...
        npotrecfunc::compNuclearPotentialForGG_45_90(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     pcDistances, 
        ...
        npotrecfunc::compNuclearPotentialForGG_90_135(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      paDistances, 
                                                      pcDistances, 
        ...
        npotrecfunc::compNuclearPotentialForGG_135_180(primBuffer,
                                                       recursionMap,
                                                       osFactors,
                                                       paDistances, 
                                                       pcDistances, 
        ...
        npotrecfunc::compNuclearPotentialForGG_180_225(primBuffer,
                                                       recursionMap,
                                                       osFactors,
                                                       paDistances, 
                                                       pcDistances, 
                                   ...
                                   const int32_t              iContrGto)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            auto pidx_a_4_4_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Nuclear Potential"}, 0, true, 
                                                             {4, -1, -1, -1}, {4, -1, -1, -1}, 
                                                             1, 1, iord));
            ...
            auto pidx_a_3_4_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Nuclear Potential"}, 0, true, 
                                                             {3, -1, -1, -1}, {4, -1, -1, -1}, 
                                                             1, 1, iord));
            ...
            auto pidx_a_2_4_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Nuclear Potential"}, 0, true, 
                                                             {2, -1, -1, -1}, {4, -1, -1, -1}, 
                                                             1, 1, iord));
            ...
            for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
            {
                ...
                for (int32_t j = 0; j < nprim; j++)
                {
                    ...
                    ta_xxxx_xxxx_0[j] = pa_x[j] * ta_xxx_xxxx_0[j] - pc_x[j] * ta_xxx_xxxx_1[j] + 1.5 * fl1_fx * ta_xx_xxxx_0[j] - 1.5 * fl1_fx * ta_xx_xxxx_1[j] + 2.0 * fl1_fx * ta_xxx_xxx_0[j] - 2.0 * fl1_fx * ta_xxx_xxx_1[j];

                    ta_xxxx_xxxy_0[j] = pa_x[j] * ta_xxx_xxxy_0[j] - pc_x[j] * ta_xxx_xxxy_1[j] + 1.5 * fl1_fx * ta_xx_xxxy_0[j] - 1.5 * fl1_fx * ta_xx_xxxy_1[j] + 1.5 * fl1_fx * ta_xxx_xxy_0[j] - 1.5 * fl1_fx * ta_xxx_xxy_1[j];

                    ta_xxxx_xxxz_0[j] = pa_x[j] * ta_xxx_xxxz_0[j] - pc_x[j] * ta_xxx_xxxz_1[j] + 1.5 * fl1_fx * ta_xx_xxxz_0[j] - 1.5 * fl1_fx * ta_xx_xxxz_1[j] + 1.5 * fl1_fx * ta_xxx_xxz_0[j] - 1.5 * fl1_fx * ta_xxx_xxz_1[j];

                    ta_xxxx_xxyy_0[j] = pa_x[j] * ta_xxx_xxyy_0[j] - pc_x[j] * ta_xxx_xxyy_1[j] + 1.5 * fl1_fx * ta_xx_xxyy_0[j] - 1.5 * fl1_fx * ta_xx_xxyy_1[j] + fl1_fx * ta_xxx_xyy_0[j] - fl1_fx * ta_xxx_xyy_1[j];

                    ta_xxxx_xxyz_0[j] = pa_x[j] * ta_xxx_xxyz_0[j] - pc_x[j] * ta_xxx_xxyz_1[j] + 1.5 * fl1_fx * ta_xx_xxyz_0[j] - 1.5 * fl1_fx * ta_xx_xxyz_1[j] + fl1_fx * ta_xxx_xyz_0[j] - fl1_fx * ta_xxx_xyz_1[j];

                    ta_xxxx_xxzz_0[j] = pa_x[j] * ta_xxx_xxzz_0[j] - pc_x[j] * ta_xxx_xxzz_1[j] + 1.5 * fl1_fx * ta_xx_xxzz_0[j] - 1.5 * fl1_fx * ta_xx_xxzz_1[j] + fl1_fx * ta_xxx_xzz_0[j] - fl1_fx * ta_xxx_xzz_1[j];

                    ta_xxxx_xyyy_0[j] = pa_x[j] * ta_xxx_xyyy_0[j] - pc_x[j] * ta_xxx_xyyy_1[j] + 1.5 * fl1_fx * ta_xx_xyyy_0[j] - 1.5 * fl1_fx * ta_xx_xyyy_1[j] + 0.5 * fl1_fx * ta_xxx_yyy_0[j] - 0.5 * fl1_fx * ta_xxx_yyy_1[j];

                    ta_xxxx_xyyz_0[j] = pa_x[j] * ta_xxx_xyyz_0[j] - pc_x[j] * ta_xxx_xyyz_1[j] + 1.5 * fl1_fx * ta_xx_xyyz_0[j] - 1.5 * fl1_fx * ta_xx_xyyz_1[j] + 0.5 * fl1_fx * ta_xxx_yyz_0[j] - 0.5 * fl1_fx * ta_xxx_yyz_1[j];

                    ta_xxxx_xyzz_0[j] = pa_x[j] * ta_xxx_xyzz_0[j] - pc_x[j] * ta_xxx_xyzz_1[j] + 1.5 * fl1_fx * ta_xx_xyzz_0[j] - 1.5 * fl1_fx * ta_xx_xyzz_1[j] + 0.5 * fl1_fx * ta_xxx_yzz_0[j] - 0.5 * fl1_fx * ta_xxx_yzz_1[j];

                    ta_xxxx_xzzz_0[j] = pa_x[j] * ta_xxx_xzzz_0[j] - pc_x[j] * ta_xxx_xzzz_1[j] + 1.5 * fl1_fx * ta_xx_xzzz_0[j] - 1.5 * fl1_fx * ta_xx_xzzz_1[j] + 0.5 * fl1_fx * ta_xxx_zzz_0[j] - 0.5 * fl1_fx * ta_xxx_zzz_1[j];

                    ta_xxxx_yyyy_0[j] = pa_x[j] * ta_xxx_yyyy_0[j] - pc_x[j] * ta_xxx_yyyy_1[j] + 1.5 * fl1_fx * ta_xx_yyyy_0[j] - 1.5 * fl1_fx * ta_xx_yyyy_1[j];

                    ta_xxxx_yyyz_0[j] = pa_x[j] * ta_xxx_yyyz_0[j] - pc_x[j] * ta_xxx_yyyz_1[j] + 1.5 * fl1_fx * ta_xx_yyyz_0[j] - 1.5 * fl1_fx * ta_xx_yyyz_1[j];

                    ta_xxxx_yyzz_0[j] = pa_x[j] * ta_xxx_yyzz_0[j] - pc_x[j] * ta_xxx_yyzz_1[j] + 1.5 * fl1_fx * ta_xx_yyzz_0[j] - 1.5 * fl1_fx * ta_xx_yyzz_1[j];

                    ta_xxxx_yzzz_0[j] = pa_x[j] * ta_xxx_yzzz_0[j] - pc_x[j] * ta_xxx_yzzz_1[j] + 1.5 * fl1_fx * ta_xx_yzzz_0[j] - 1.5 * fl1_fx * ta_xx_yzzz_1[j];

                    ta_xxxx_zzzz_0[j] = pa_x[j] * ta_xxx_zzzz_0[j] - pc_x[j] * ta_xxx_zzzz_1[j] + 1.5 * fl1_fx * ta_xx_zzzz_0[j] - 1.5 * fl1_fx * ta_xx_zzzz_1[j];

                    ta_xxxy_xxxx_0[j] = pa_x[j] * ta_xxy_xxxx_0[j] - pc_x[j] * ta_xxy_xxxx_1[j] + fl1_fx * ta_xy_xxxx_0[j] - fl1_fx * ta_xy_xxxx_1[j] + 2.0 * fl1_fx * ta_xxy_xxx_0[j] - 2.0 * fl1_fx * ta_xxy_xxx_1[j];

                    ta_xxxy_xxxy_0[j] = pa_x[j] * ta_xxy_xxxy_0[j] - pc_x[j] * ta_xxy_xxxy_1[j] + fl1_fx * ta_xy_xxxy_0[j] - fl1_fx * ta_xy_xxxy_1[j] + 1.5 * fl1_fx * ta_xxy_xxy_0[j] - 1.5 * fl1_fx * ta_xxy_xxy_1[j];

                    ta_xxxy_xxxz_0[j] = pa_x[j] * ta_xxy_xxxz_0[j] - pc_x[j] * ta_xxy_xxxz_1[j] + fl1_fx * ta_xy_xxxz_0[j] - fl1_fx * ta_xy_xxxz_1[j] + 1.5 * fl1_fx * ta_xxy_xxz_0[j] - 1.5 * fl1_fx * ta_xxy_xxz_1[j];

                    ta_xxxy_xxyy_0[j] = pa_x[j] * ta_xxy_xxyy_0[j] - pc_x[j] * ta_xxy_xxyy_1[j] + fl1_fx * ta_xy_xxyy_0[j] - fl1_fx * ta_xy_xxyy_1[j] + fl1_fx * ta_xxy_xyy_0[j] - fl1_fx * ta_xxy_xyy_1[j];

                    ta_xxxy_xxyz_0[j] = pa_x[j] * ta_xxy_xxyz_0[j] - pc_x[j] * ta_xxy_xxyz_1[j] + fl1_fx * ta_xy_xxyz_0[j] - fl1_fx * ta_xy_xxyz_1[j] + fl1_fx * ta_xxy_xyz_0[j] - fl1_fx * ta_xxy_xyz_1[j];

                    ta_xxxy_xxzz_0[j] = pa_x[j] * ta_xxy_xxzz_0[j] - pc_x[j] * ta_xxy_xxzz_1[j] + fl1_fx * ta_xy_xxzz_0[j] - fl1_fx * ta_xy_xxzz_1[j] + fl1_fx * ta_xxy_xzz_0[j] - fl1_fx * ta_xxy_xzz_1[j];

                    ta_xxxy_xyyy_0[j] = pa_x[j] * ta_xxy_xyyy_0[j] - pc_x[j] * ta_xxy_xyyy_1[j] + fl1_fx * ta_xy_xyyy_0[j] - fl1_fx * ta_xy_xyyy_1[j] + 0.5 * fl1_fx * ta_xxy_yyy_0[j] - 0.5 * fl1_fx * ta_xxy_yyy_1[j];

                    ta_xxxy_xyyz_0[j] = pa_x[j] * ta_xxy_xyyz_0[j] - pc_x[j] * ta_xxy_xyyz_1[j] + fl1_fx * ta_xy_xyyz_0[j] - fl1_fx * ta_xy_xyyz_1[j] + 0.5 * fl1_fx * ta_xxy_yyz_0[j] - 0.5 * fl1_fx * ta_xxy_yyz_1[j];

                    ta_xxxy_xyzz_0[j] = pa_x[j] * ta_xxy_xyzz_0[j] - pc_x[j] * ta_xxy_xyzz_1[j] + fl1_fx * ta_xy_xyzz_0[j] - fl1_fx * ta_xy_xyzz_1[j] + 0.5 * fl1_fx * ta_xxy_yzz_0[j] - 0.5 * fl1_fx * ta_xxy_yzz_1[j];

                    ta_xxxy_xzzz_0[j] = pa_x[j] * ta_xxy_xzzz_0[j] - pc_x[j] * ta_xxy_xzzz_1[j] + fl1_fx * ta_xy_xzzz_0[j] - fl1_fx * ta_xy_xzzz_1[j] + 0.5 * fl1_fx * ta_xxy_zzz_0[j] - 0.5 * fl1_fx * ta_xxy_zzz_1[j];
                    ...
                    ta_xxxz_xxxx_0[j] = pa_x[j] * ta_xxz_xxxx_0[j] - pc_x[j] * ta_xxz_xxxx_1[j] + fl1_fx * ta_xz_xxxx_0[j] - fl1_fx * ta_xz_xxxx_1[j] + 2.0 * fl1_fx * ta_xxz_xxx_0[j] - 2.0 * fl1_fx * ta_xxz_xxx_1[j];

                    ta_xxxz_xxxy_0[j] = pa_x[j] * ta_xxz_xxxy_0[j] - pc_x[j] * ta_xxz_xxxy_1[j] + fl1_fx * ta_xz_xxxy_0[j] - fl1_fx * ta_xz_xxxy_1[j] + 1.5 * fl1_fx * ta_xxz_xxy_0[j] - 1.5 * fl1_fx * ta_xxz_xxy_1[j];

                    ta_xxxz_xxxz_0[j] = pa_x[j] * ta_xxz_xxxz_0[j] - pc_x[j] * ta_xxz_xxxz_1[j] + fl1_fx * ta_xz_xxxz_0[j] - fl1_fx * ta_xz_xxxz_1[j] + 1.5 * fl1_fx * ta_xxz_xxz_0[j] - 1.5 * fl1_fx * ta_xxz_xxz_1[j];

                    ta_xxxz_xxyy_0[j] = pa_x[j] * ta_xxz_xxyy_0[j] - pc_x[j] * ta_xxz_xxyy_1[j] + fl1_fx * ta_xz_xxyy_0[j] - fl1_fx * ta_xz_xxyy_1[j] + fl1_fx * ta_xxz_xyy_0[j] - fl1_fx * ta_xxz_xyy_1[j];

                    ta_xxxz_xxyz_0[j] = pa_x[j] * ta_xxz_xxyz_0[j] - pc_x[j] * ta_xxz_xxyz_1[j] + fl1_fx * ta_xz_xxyz_0[j] - fl1_fx * ta_xz_xxyz_1[j] + fl1_fx * ta_xxz_xyz_0[j] - fl1_fx * ta_xxz_xyz_1[j];

                    ta_xxxz_xxzz_0[j] = pa_x[j] * ta_xxz_xxzz_0[j] - pc_x[j] * ta_xxz_xxzz_1[j] + fl1_fx * ta_xz_xxzz_0[j] - fl1_fx * ta_xz_xxzz_1[j] + fl1_fx * ta_xxz_xzz_0[j] - fl1_fx * ta_xxz_xzz_1[j];

                    ta_xxxz_xyyy_0[j] = pa_x[j] * ta_xxz_xyyy_0[j] - pc_x[j] * ta_xxz_xyyy_1[j] + fl1_fx * ta_xz_xyyy_0[j] - fl1_fx * ta_xz_xyyy_1[j] + 0.5 * fl1_fx * ta_xxz_yyy_0[j] - 0.5 * fl1_fx * ta_xxz_yyy_1[j];

                    ta_xxxz_xyyz_0[j] = pa_x[j] * ta_xxz_xyyz_0[j] - pc_x[j] * ta_xxz_xyyz_1[j] + fl1_fx * ta_xz_xyyz_0[j] - fl1_fx * ta_xz_xyyz_1[j] + 0.5 * fl1_fx * ta_xxz_yyz_0[j] - 0.5 * fl1_fx * ta_xxz_yyz_1[j];

                    ta_xxxz_xyzz_0[j] = pa_x[j] * ta_xxz_xyzz_0[j] - pc_x[j] * ta_xxz_xyzz_1[j] + fl1_fx * ta_xz_xyzz_0[j] - fl1_fx * ta_xz_xyzz_1[j] + 0.5 * fl1_fx * ta_xxz_yzz_0[j] - 0.5 * fl1_fx * ta_xxz_yzz_1[j];

                    ta_xxxz_xzzz_0[j] = pa_x[j] * ta_xxz_xzzz_0[j] - pc_x[j] * ta_xxz_xzzz_1[j] + fl1_fx * ta_xz_xzzz_0[j] - fl1_fx * ta_xz_xzzz_1[j] + 0.5 * fl1_fx * ta_xxz_zzz_0[j] - 0.5 * fl1_fx * ta_xxz_zzz_1[j];
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
            {
                ...
                for (int32_t j = 0; j < nprim; j++)
                {
                    ...
                    ta_xxyy_xxxx_0[j] = pa_x[j] * ta_xyy_xxxx_0[j] - pc_x[j] * ta_xyy_xxxx_1[j] + 0.5 * fl1_fx * ta_yy_xxxx_0[j] - 0.5 * fl1_fx * ta_yy_xxxx_1[j] + 2.0 * fl1_fx * ta_xyy_xxx_0[j] - 2.0 * fl1_fx * ta_xyy_xxx_1[j];

                    ta_xxyy_xxxy_0[j] = pa_x[j] * ta_xyy_xxxy_0[j] - pc_x[j] * ta_xyy_xxxy_1[j] + 0.5 * fl1_fx * ta_yy_xxxy_0[j] - 0.5 * fl1_fx * ta_yy_xxxy_1[j] + 1.5 * fl1_fx * ta_xyy_xxy_0[j] - 1.5 * fl1_fx * ta_xyy_xxy_1[j];

                    ta_xxyy_xxxz_0[j] = pa_x[j] * ta_xyy_xxxz_0[j] - pc_x[j] * ta_xyy_xxxz_1[j] + 0.5 * fl1_fx * ta_yy_xxxz_0[j] - 0.5 * fl1_fx * ta_yy_xxxz_1[j] + 1.5 * fl1_fx * ta_xyy_xxz_0[j] - 1.5 * fl1_fx * ta_xyy_xxz_1[j];

                    ta_xxyy_xxyy_0[j] = pa_x[j] * ta_xyy_xxyy_0[j] - pc_x[j] * ta_xyy_xxyy_1[j] + 0.5 * fl1_fx * ta_yy_xxyy_0[j] - 0.5 * fl1_fx * ta_yy_xxyy_1[j] + fl1_fx * ta_xyy_xyy_0[j] - fl1_fx * ta_xyy_xyy_1[j];

                    ta_xxyy_xxyz_0[j] = pa_x[j] * ta_xyy_xxyz_0[j] - pc_x[j] * ta_xyy_xxyz_1[j] + 0.5 * fl1_fx * ta_yy_xxyz_0[j] - 0.5 * fl1_fx * ta_yy_xxyz_1[j] + fl1_fx * ta_xyy_xyz_0[j] - fl1_fx * ta_xyy_xyz_1[j];

                    ta_xxyy_xxzz_0[j] = pa_x[j] * ta_xyy_xxzz_0[j] - pc_x[j] * ta_xyy_xxzz_1[j] + 0.5 * fl1_fx * ta_yy_xxzz_0[j] - 0.5 * fl1_fx * ta_yy_xxzz_1[j] + fl1_fx * ta_xyy_xzz_0[j] - fl1_fx * ta_xyy_xzz_1[j];

                    ta_xxyy_xyyy_0[j] = pa_x[j] * ta_xyy_xyyy_0[j] - pc_x[j] * ta_xyy_xyyy_1[j] + 0.5 * fl1_fx * ta_yy_xyyy_0[j] - 0.5 * fl1_fx * ta_yy_xyyy_1[j] + 0.5 * fl1_fx * ta_xyy_yyy_0[j] - 0.5 * fl1_fx * ta_xyy_yyy_1[j];

                    ta_xxyy_xyyz_0[j] = pa_x[j] * ta_xyy_xyyz_0[j] - pc_x[j] * ta_xyy_xyyz_1[j] + 0.5 * fl1_fx * ta_yy_xyyz_0[j] - 0.5 * fl1_fx * ta_yy_xyyz_1[j] + 0.5 * fl1_fx * ta_xyy_yyz_0[j] - 0.5 * fl1_fx * ta_xyy_yyz_1[j];

                    ta_xxyy_xyzz_0[j] = pa_x[j] * ta_xyy_xyzz_0[j] - pc_x[j] * ta_xyy_xyzz_1[j] + 0.5 * fl1_fx * ta_yy_xyzz_0[j] - 0.5 * fl1_fx * ta_yy_xyzz_1[j] + 0.5 * fl1_fx * ta_xyy_yzz_0[j] - 0.5 * fl1_fx * ta_xyy_yzz_1[j];

                    ta_xxyy_xzzz_0[j] = pa_x[j] * ta_xyy_xzzz_0[j] - pc_x[j] * ta_xyy_xzzz_1[j] + 0.5 * fl1_fx * ta_yy_xzzz_0[j] - 0.5 * fl1_fx * ta_yy_xzzz_1[j] + 0.5 * fl1_fx * ta_xyy_zzz_0[j] - 0.5 * fl1_fx * ta_xyy_zzz_1[j];

                    ta_xxyy_yyyy_0[j] = pa_x[j] * ta_xyy_yyyy_0[j] - pc_x[j] * ta_xyy_yyyy_1[j] + 0.5 * fl1_fx * ta_yy_yyyy_0[j] - 0.5 * fl1_fx * ta_yy_yyyy_1[j];

                    ta_xxyy_yyyz_0[j] = pa_x[j] * ta_xyy_yyyz_0[j] - pc_x[j] * ta_xyy_yyyz_1[j] + 0.5 * fl1_fx * ta_yy_yyyz_0[j] - 0.5 * fl1_fx * ta_yy_yyyz_1[j];

                    ta_xxyy_yyzz_0[j] = pa_x[j] * ta_xyy_yyzz_0[j] - pc_x[j] * ta_xyy_yyzz_1[j] + 0.5 * fl1_fx * ta_yy_yyzz_0[j] - 0.5 * fl1_fx * ta_yy_yyzz_1[j];

                    ta_xxyy_yzzz_0[j] = pa_x[j] * ta_xyy_yzzz_0[j] - pc_x[j] * ta_xyy_yzzz_1[j] + 0.5 * fl1_fx * ta_yy_yzzz_0[j] - 0.5 * fl1_fx * ta_yy_yzzz_1[j];

                    ta_xxyy_zzzz_0[j] = pa_x[j] * ta_xyy_zzzz_0[j] - pc_x[j] * ta_xyy_zzzz_1[j] + 0.5 * fl1_fx * ta_yy_zzzz_0[j] - 0.5 * fl1_fx * ta_yy_zzzz_1[j];

                    ta_xxyz_xxxx_0[j] = pa_x[j] * ta_xyz_xxxx_0[j] - pc_x[j] * ta_xyz_xxxx_1[j] + 0.5 * fl1_fx * ta_yz_xxxx_0[j] - 0.5 * fl1_fx * ta_yz_xxxx_1[j] + 2.0 * fl1_fx * ta_xyz_xxx_0[j] - 2.0 * fl1_fx * ta_xyz_xxx_1[j];

                    ta_xxyz_xxxy_0[j] = pa_x[j] * ta_xyz_xxxy_0[j] - pc_x[j] * ta_xyz_xxxy_1[j] + 0.5 * fl1_fx * ta_yz_xxxy_0[j] - 0.5 * fl1_fx * ta_yz_xxxy_1[j] + 1.5 * fl1_fx * ta_xyz_xxy_0[j] - 1.5 * fl1_fx * ta_xyz_xxy_1[j];

                    ta_xxyz_xxxz_0[j] = pa_x[j] * ta_xyz_xxxz_0[j] - pc_x[j] * ta_xyz_xxxz_1[j] + 0.5 * fl1_fx * ta_yz_xxxz_0[j] - 0.5 * fl1_fx * ta_yz_xxxz_1[j] + 1.5 * fl1_fx * ta_xyz_xxz_0[j] - 1.5 * fl1_fx * ta_xyz_xxz_1[j];

                    ta_xxyz_xxyy_0[j] = pa_x[j] * ta_xyz_xxyy_0[j] - pc_x[j] * ta_xyz_xxyy_1[j] + 0.5 * fl1_fx * ta_yz_xxyy_0[j] - 0.5 * fl1_fx * ta_yz_xxyy_1[j] + fl1_fx * ta_xyz_xyy_0[j] - fl1_fx * ta_xyz_xyy_1[j];

                    ta_xxyz_xxyz_0[j] = pa_x[j] * ta_xyz_xxyz_0[j] - pc_x[j] * ta_xyz_xxyz_1[j] + 0.5 * fl1_fx * ta_yz_xxyz_0[j] - 0.5 * fl1_fx * ta_yz_xxyz_1[j] + fl1_fx * ta_xyz_xyz_0[j] - fl1_fx * ta_xyz_xyz_1[j];

                    ta_xxyz_xxzz_0[j] = pa_x[j] * ta_xyz_xxzz_0[j] - pc_x[j] * ta_xyz_xxzz_1[j] + 0.5 * fl1_fx * ta_yz_xxzz_0[j] - 0.5 * fl1_fx * ta_yz_xxzz_1[j] + fl1_fx * ta_xyz_xzz_0[j] - fl1_fx * ta_xyz_xzz_1[j];

                    ta_xxyz_xyyy_0[j] = pa_x[j] * ta_xyz_xyyy_0[j] - pc_x[j] * ta_xyz_xyyy_1[j] + 0.5 * fl1_fx * ta_yz_xyyy_0[j] - 0.5 * fl1_fx * ta_yz_xyyy_1[j] + 0.5 * fl1_fx * ta_xyz_yyy_0[j] - 0.5 * fl1_fx * ta_xyz_yyy_1[j];

                    ta_xxyz_xyyz_0[j] = pa_x[j] * ta_xyz_xyyz_0[j] - pc_x[j] * ta_xyz_xyyz_1[j] + 0.5 * fl1_fx * ta_yz_xyyz_0[j] - 0.5 * fl1_fx * ta_yz_xyyz_1[j] + 0.5 * fl1_fx * ta_xyz_yyz_0[j] - 0.5 * fl1_fx * ta_xyz_yyz_1[j];

                    ta_xxyz_xyzz_0[j] = pa_x[j] * ta_xyz_xyzz_0[j] - pc_x[j] * ta_xyz_xyzz_1[j] + 0.5 * fl1_fx * ta_yz_xyzz_0[j] - 0.5 * fl1_fx * ta_yz_xyzz_1[j] + 0.5 * fl1_fx * ta_xyz_yzz_0[j] - 0.5 * fl1_fx * ta_xyz_yzz_1[j];

                    ta_xxyz_xzzz_0[j] = pa_x[j] * ta_xyz_xzzz_0[j] - pc_x[j] * ta_xyz_xzzz_1[j] + 0.5 * fl1_fx * ta_yz_xzzz_0[j] - 0.5 * fl1_fx * ta_yz_xzzz_1[j] + 0.5 * fl1_fx * ta_xyz_zzz_0[j] - 0.5 * fl1_fx * ta_xyz_zzz_1[j];

                    ta_xxyz_yyyy_0[j] = pa_x[j] * ta_xyz_yyyy_0[j] - pc_x[j] * ta_xyz_yyyy_1[j] + 0.5 * fl1_fx * ta_yz_yyyy_0[j] - 0.5 * fl1_fx * ta_yz_yyyy_1[j];

                    ta_xxyz_yyyz_0[j] = pa_x[j] * ta_xyz_yyyz_0[j] - pc_x[j] * ta_xyz_yyyz_1[j] + 0.5 * fl1_fx * ta_yz_yyyz_0[j] - 0.5 * fl1_fx * ta_yz_yyyz_1[j];

                    ta_xxyz_yyzz_0[j] = pa_x[j] * ta_xyz_yyzz_0[j] - pc_x[j] * ta_xyz_yyzz_1[j] + 0.5 * fl1_fx * ta_yz_yyzz_0[j] - 0.5 * fl1_fx * ta_yz_yyzz_1[j];

                    ta_xxyz_yzzz_0[j] = pa_x[j] * ta_xyz_yzzz_0[j] - pc_x[j] * ta_xyz_yzzz_1[j] + 0.5 * fl1_fx * ta_yz_yzzz_0[j] - 0.5 * fl1_fx * ta_yz_yzzz_1[j];

                    ta_xxyz_zzzz_0[j] = pa_x[j] * ta_xyz_zzzz_0[j] - pc_x[j] * ta_xyz_zzzz_1[j] + 0.5 * fl1_fx * ta_yz_zzzz_0[j] - 0.5 * fl1_fx * ta_yz_zzzz_1[j];

                    ta_xxzz_xxxx_0[j] = pa_x[j] * ta_xzz_xxxx_0[j] - pc_x[j] * ta_xzz_xxxx_1[j] + 0.5 * fl1_fx * ta_zz_xxxx_0[j] - 0.5 * fl1_fx * ta_zz_xxxx_1[j] + 2.0 * fl1_fx * ta_xzz_xxx_0[j] - 2.0 * fl1_fx * ta_xzz_xxx_1[j];

                    ta_xxzz_xxxy_0[j] = pa_x[j] * ta_xzz_xxxy_0[j] - pc_x[j] * ta_xzz_xxxy_1[j] + 0.5 * fl1_fx * ta_zz_xxxy_0[j] - 0.5 * fl1_fx * ta_zz_xxxy_1[j] + 1.5 * fl1_fx * ta_xzz_xxy_0[j] - 1.5 * fl1_fx * ta_xzz_xxy_1[j];

                    ta_xxzz_xxxz_0[j] = pa_x[j] * ta_xzz_xxxz_0[j] - pc_x[j] * ta_xzz_xxxz_1[j] + 0.5 * fl1_fx * ta_zz_xxxz_0[j] - 0.5 * fl1_fx * ta_zz_xxxz_1[j] + 1.5 * fl1_fx * ta_xzz_xxz_0[j] - 1.5 * fl1_fx * ta_xzz_xxz_1[j];

                    ta_xxzz_xxyy_0[j] = pa_x[j] * ta_xzz_xxyy_0[j] - pc_x[j] * ta_xzz_xxyy_1[j] + 0.5 * fl1_fx * ta_zz_xxyy_0[j] - 0.5 * fl1_fx * ta_zz_xxyy_1[j] + fl1_fx * ta_xzz_xyy_0[j] - fl1_fx * ta_xzz_xyy_1[j];

                    ta_xxzz_xxyz_0[j] = pa_x[j] * ta_xzz_xxyz_0[j] - pc_x[j] * ta_xzz_xxyz_1[j] + 0.5 * fl1_fx * ta_zz_xxyz_0[j] - 0.5 * fl1_fx * ta_zz_xxyz_1[j] + fl1_fx * ta_xzz_xyz_0[j] - fl1_fx * ta_xzz_xyz_1[j];

                    ta_xxzz_xxzz_0[j] = pa_x[j] * ta_xzz_xxzz_0[j] - pc_x[j] * ta_xzz_xxzz_1[j] + 0.5 * fl1_fx * ta_zz_xxzz_0[j] - 0.5 * fl1_fx * ta_zz_xxzz_1[j] + fl1_fx * ta_xzz_xzz_0[j] - fl1_fx * ta_xzz_xzz_1[j];

                    ta_xxzz_xyyy_0[j] = pa_x[j] * ta_xzz_xyyy_0[j] - pc_x[j] * ta_xzz_xyyy_1[j] + 0.5 * fl1_fx * ta_zz_xyyy_0[j] - 0.5 * fl1_fx * ta_zz_xyyy_1[j] + 0.5 * fl1_fx * ta_xzz_yyy_0[j] - 0.5 * fl1_fx * ta_xzz_yyy_1[j];

                    ta_xxzz_xyyz_0[j] = pa_x[j] * ta_xzz_xyyz_0[j] - pc_x[j] * ta_xzz_xyyz_1[j] + 0.5 * fl1_fx * ta_zz_xyyz_0[j] - 0.5 * fl1_fx * ta_zz_xyyz_1[j] + 0.5 * fl1_fx * ta_xzz_yyz_0[j] - 0.5 * fl1_fx * ta_xzz_yyz_1[j];

                    ta_xxzz_xyzz_0[j] = pa_x[j] * ta_xzz_xyzz_0[j] - pc_x[j] * ta_xzz_xyzz_1[j] + 0.5 * fl1_fx * ta_zz_xyzz_0[j] - 0.5 * fl1_fx * ta_zz_xyzz_1[j] + 0.5 * fl1_fx * ta_xzz_yzz_0[j] - 0.5 * fl1_fx * ta_xzz_yzz_1[j];

                    ta_xxzz_xzzz_0[j] = pa_x[j] * ta_xzz_xzzz_0[j] - pc_x[j] * ta_xzz_xzzz_1[j] + 0.5 * fl1_fx * ta_zz_xzzz_0[j] - 0.5 * fl1_fx * ta_zz_xzzz_1[j] + 0.5 * fl1_fx * ta_xzz_zzz_0[j] - 0.5 * fl1_fx * ta_xzz_zzz_1[j];

                    ta_xxzz_yyyy_0[j] = pa_x[j] * ta_xzz_yyyy_0[j] - pc_x[j] * ta_xzz_yyyy_1[j] + 0.5 * fl1_fx * ta_zz_yyyy_0[j] - 0.5 * fl1_fx * ta_zz_yyyy_1[j];

                    ta_xxzz_yyyz_0[j] = pa_x[j] * ta_xzz_yyyz_0[j] - pc_x[j] * ta_xzz_yyyz_1[j] + 0.5 * fl1_fx * ta_zz_yyyz_0[j] - 0.5 * fl1_fx * ta_zz_yyyz_1[j];

                    ta_xxzz_yyzz_0[j] = pa_x[j] * ta_xzz_yyzz_0[j] - pc_x[j] * ta_xzz_yyzz_1[j] + 0.5 * fl1_fx * ta_zz_yyzz_0[j] - 0.5 * fl1_fx * ta_zz_yyzz_1[j];

                    ta_xxzz_yzzz_0[j] = pa_x[j] * ta_xzz_yzzz_0[j] - pc_x[j] * ta_xzz_yzzz_1[j] + 0.5 * fl1_fx * ta_zz_yzzz_0[j] - 0.5 * fl1_fx * ta_zz_yzzz_1[j];

                    ta_xxzz_zzzz_0[j] = pa_x[j] * ta_xzz_zzzz_0[j] - pc_x[j] * ta_xzz_zzzz_1[j] + 0.5 * fl1_fx * ta_zz_zzzz_0[j] - 0.5 * fl1_fx * ta_zz_zzzz_1[j];
                }
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
            {
                ...
                for (int32_t j = 0; j < nprim; j++)
                {
                    ...
                    ta_xyyy_xxxx_0[j] = pa_x[j] * ta_yyy_xxxx_0[j] - pc_x[j] * ta_yyy_xxxx_1[j] + 2.0 * fl1_fx * ta_yyy_xxx_0[j] - 2.0 * fl1_fx * ta_yyy_xxx_1[j];

                    ta_xyyy_xxxy_0[j] = pa_x[j] * ta_yyy_xxxy_0[j] - pc_x[j] * ta_yyy_xxxy_1[j] + 1.5 * fl1_fx * ta_yyy_xxy_0[j] - 1.5 * fl1_fx * ta_yyy_xxy_1[j];

                    ta_xyyy_xxxz_0[j] = pa_x[j] * ta_yyy_xxxz_0[j] - pc_x[j] * ta_yyy_xxxz_1[j] + 1.5 * fl1_fx * ta_yyy_xxz_0[j] - 1.5 * fl1_fx * ta_yyy_xxz_1[j];
                    ...
                    ta_xyyy_xyyy_0[j] = pa_x[j] * ta_yyy_xyyy_0[j] - pc_x[j] * ta_yyy_xyyy_1[j] + 0.5 * fl1_fx * ta_yyy_yyy_0[j] - 0.5 * fl1_fx * ta_yyy_yyy_1[j];

                    ta_xyyy_xyyz_0[j] = pa_x[j] * ta_yyy_xyyz_0[j] - pc_x[j] * ta_yyy_xyyz_1[j] + 0.5 * fl1_fx * ta_yyy_yyz_0[j] - 0.5 * fl1_fx * ta_yyy_yyz_1[j];

                    ta_xyyy_xyzz_0[j] = pa_x[j] * ta_yyy_xyzz_0[j] - pc_x[j] * ta_yyy_xyzz_1[j] + 0.5 * fl1_fx * ta_yyy_yzz_0[j] - 0.5 * fl1_fx * ta_yyy_yzz_1[j];

                    ta_xyyy_xzzz_0[j] = pa_x[j] * ta_yyy_xzzz_0[j] - pc_x[j] * ta_yyy_xzzz_1[j] + 0.5 * fl1_fx * ta_yyy_zzz_0[j] - 0.5 * fl1_fx * ta_yyy_zzz_1[j];
                    ...
                    ta_xyyz_xxxx_0[j] = pa_x[j] * ta_yyz_xxxx_0[j] - pc_x[j] * ta_yyz_xxxx_1[j] + 2.0 * fl1_fx * ta_yyz_xxx_0[j] - 2.0 * fl1_fx * ta_yyz_xxx_1[j];

                    ta_xyyz_xxxy_0[j] = pa_x[j] * ta_yyz_xxxy_0[j] - pc_x[j] * ta_yyz_xxxy_1[j] + 1.5 * fl1_fx * ta_yyz_xxy_0[j] - 1.5 * fl1_fx * ta_yyz_xxy_1[j];

                    ta_xyyz_xxxz_0[j] = pa_x[j] * ta_yyz_xxxz_0[j] - pc_x[j] * ta_yyz_xxxz_1[j] + 1.5 * fl1_fx * ta_yyz_xxz_0[j] - 1.5 * fl1_fx * ta_yyz_xxz_1[j];
                    ...
                    ta_xyyz_xyyy_0[j] = pa_x[j] * ta_yyz_xyyy_0[j] - pc_x[j] * ta_yyz_xyyy_1[j] + 0.5 * fl1_fx * ta_yyz_yyy_0[j] - 0.5 * fl1_fx * ta_yyz_yyy_1[j];

                    ta_xyyz_xyyz_0[j] = pa_x[j] * ta_yyz_xyyz_0[j] - pc_x[j] * ta_yyz_xyyz_1[j] + 0.5 * fl1_fx * ta_yyz_yyz_0[j] - 0.5 * fl1_fx * ta_yyz_yyz_1[j];

                    ta_xyyz_xyzz_0[j] = pa_x[j] * ta_yyz_xyzz_0[j] - pc_x[j] * ta_yyz_xyzz_1[j] + 0.5 * fl1_fx * ta_yyz_yzz_0[j] - 0.5 * fl1_fx * ta_yyz_yzz_1[j];

                    ta_xyyz_xzzz_0[j] = pa_x[j] * ta_yyz_xzzz_0[j] - pc_x[j] * ta_yyz_xzzz_1[j] + 0.5 * fl1_fx * ta_yyz_zzz_0[j] - 0.5 * fl1_fx * ta_yyz_zzz_1[j];
                    ...
                    ta_xyzz_xxxx_0[j] = pa_x[j] * ta_yzz_xxxx_0[j] - pc_x[j] * ta_yzz_xxxx_1[j] + 2.0 * fl1_fx * ta_yzz_xxx_0[j] - 2.0 * fl1_fx * ta_yzz_xxx_1[j];

                    ta_xyzz_xxxy_0[j] = pa_x[j] * ta_yzz_xxxy_0[j] - pc_x[j] * ta_yzz_xxxy_1[j] + 1.5 * fl1_fx * ta_yzz_xxy_0[j] - 1.5 * fl1_fx * ta_yzz_xxy_1[j];

                    ta_xyzz_xxxz_0[j] = pa_x[j] * ta_yzz_xxxz_0[j] - pc_x[j] * ta_yzz_xxxz_1[j] + 1.5 * fl1_fx * ta_yzz_xxz_0[j] - 1.5 * fl1_fx * ta_yzz_xxz_1[j];
                    ...
                    ta_xyzz_xyyy_0[j] = pa_x[j] * ta_yzz_xyyy_0[j] - pc_x[j] * ta_yzz_xyyy_1[j] + 0.5 * fl1_fx * ta_yzz_yyy_0[j] - 0.5 * fl1_fx * ta_yzz_yyy_1[j];

                    ta_xyzz_xyyz_0[j] = pa_x[j] * ta_yzz_xyyz_0[j] - pc_x[j] * ta_yzz_xyyz_1[j] + 0.5 * fl1_fx * ta_yzz_yyz_0[j] - 0.5 * fl1_fx * ta_yzz_yyz_1[j];

                    ta_xyzz_xyzz_0[j] = pa_x[j] * ta_yzz_xyzz_0[j] - pc_x[j] * ta_yzz_xyzz_1[j] + 0.5 * fl1_fx * ta_yzz_yzz_0[j] - 0.5 * fl1_fx * ta_yzz_yzz_1[j];

                    ta_xyzz_xzzz_0[j] = pa_x[j] * ta_yzz_xzzz_0[j] - pc_x[j] * ta_yzz_xzzz_1[j] + 0.5 * fl1_fx * ta_yzz_zzz_0[j] - 0.5 * fl1_fx * ta_yzz_zzz_1[j];
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
            {
                ...
                for (int32_t j = 0; j < nprim; j++)
                {
                    ...
                    ta_xzzz_xxxx_0[j] = pa_x[j] * ta_zzz_xxxx_0[j] - pc_x[j] * ta_zzz_xxxx_1[j] + 2.0 * fl1_fx * ta_zzz_xxx_0[j] - 2.0 * fl1_fx * ta_zzz_xxx_1[j];

                    ta_xzzz_xxxy_0[j] = pa_x[j] * ta_zzz_xxxy_0[j] - pc_x[j] * ta_zzz_xxxy_1[j] + 1.5 * fl1_fx * ta_zzz_xxy_0[j] - 1.5 * fl1_fx * ta_zzz_xxy_1[j];

                    ta_xzzz_xxxz_0[j] = pa_x[j] * ta_zzz_xxxz_0[j] - pc_x[j] * ta_zzz_xxxz_1[j] + 1.5 * fl1_fx * ta_zzz_xxz_0[j] - 1.5 * fl1_fx * ta_zzz_xxz_1[j];
                    ...
                    ta_xzzz_xyyy_0[j] = pa_x[j] * ta_zzz_xyyy_0[j] - pc_x[j] * ta_zzz_xyyy_1[j] + 0.5 * fl1_fx * ta_zzz_yyy_0[j] - 0.5 * fl1_fx * ta_zzz_yyy_1[j];

                    ta_xzzz_xyyz_0[j] = pa_x[j] * ta_zzz_xyyz_0[j] - pc_x[j] * ta_zzz_xyyz_1[j] + 0.5 * fl1_fx * ta_zzz_yyz_0[j] - 0.5 * fl1_fx * ta_zzz_yyz_1[j];

                    ta_xzzz_xyzz_0[j] = pa_x[j] * ta_zzz_xyzz_0[j] - pc_x[j] * ta_zzz_xyzz_1[j] + 0.5 * fl1_fx * ta_zzz_yzz_0[j] - 0.5 * fl1_fx * ta_zzz_yzz_1[j];

                    ta_xzzz_xzzz_0[j] = pa_x[j] * ta_zzz_xzzz_0[j] - pc_x[j] * ta_zzz_xzzz_1[j] + 0.5 * fl1_fx * ta_zzz_zzz_0[j] - 0.5 * fl1_fx * ta_zzz_zzz_1[j];
                    ...
                    ta_yyyy_xxxx_0[j] = pa_y[j] * ta_yyy_xxxx_0[j] - pc_y[j] * ta_yyy_xxxx_1[j] + 1.5 * fl1_fx * ta_yy_xxxx_0[j] - 1.5 * fl1_fx * ta_yy_xxxx_1[j];

                    ta_yyyy_xxxy_0[j] = pa_y[j] * ta_yyy_xxxy_0[j] - pc_y[j] * ta_yyy_xxxy_1[j] + 1.5 * fl1_fx * ta_yy_xxxy_0[j] - 1.5 * fl1_fx * ta_yy_xxxy_1[j] + 0.5 * fl1_fx * ta_yyy_xxx_0[j] - 0.5 * fl1_fx * ta_yyy_xxx_1[j];

                    ta_yyyy_xxxz_0[j] = pa_y[j] * ta_yyy_xxxz_0[j] - pc_y[j] * ta_yyy_xxxz_1[j] + 1.5 * fl1_fx * ta_yy_xxxz_0[j] - 1.5 * fl1_fx * ta_yy_xxxz_1[j];

                    ta_yyyy_xxyy_0[j] = pa_y[j] * ta_yyy_xxyy_0[j] - pc_y[j] * ta_yyy_xxyy_1[j] + 1.5 * fl1_fx * ta_yy_xxyy_0[j] - 1.5 * fl1_fx * ta_yy_xxyy_1[j] + fl1_fx * ta_yyy_xxy_0[j] - fl1_fx * ta_yyy_xxy_1[j];

                    ta_yyyy_xxyz_0[j] = pa_y[j] * ta_yyy_xxyz_0[j] - pc_y[j] * ta_yyy_xxyz_1[j] + 1.5 * fl1_fx * ta_yy_xxyz_0[j] - 1.5 * fl1_fx * ta_yy_xxyz_1[j] + 0.5 * fl1_fx * ta_yyy_xxz_0[j] - 0.5 * fl1_fx * ta_yyy_xxz_1[j];

                    ta_yyyy_xxzz_0[j] = pa_y[j] * ta_yyy_xxzz_0[j] - pc_y[j] * ta_yyy_xxzz_1[j] + 1.5 * fl1_fx * ta_yy_xxzz_0[j] - 1.5 * fl1_fx * ta_yy_xxzz_1[j];

                    ta_yyyy_xyyy_0[j] = pa_y[j] * ta_yyy_xyyy_0[j] - pc_y[j] * ta_yyy_xyyy_1[j] + 1.5 * fl1_fx * ta_yy_xyyy_0[j] - 1.5 * fl1_fx * ta_yy_xyyy_1[j] + 1.5 * fl1_fx * ta_yyy_xyy_0[j] - 1.5 * fl1_fx * ta_yyy_xyy_1[j];

                    ta_yyyy_xyyz_0[j] = pa_y[j] * ta_yyy_xyyz_0[j] - pc_y[j] * ta_yyy_xyyz_1[j] + 1.5 * fl1_fx * ta_yy_xyyz_0[j] - 1.5 * fl1_fx * ta_yy_xyyz_1[j] + fl1_fx * ta_yyy_xyz_0[j] - fl1_fx * ta_yyy_xyz_1[j];

                    ta_yyyy_xyzz_0[j] = pa_y[j] * ta_yyy_xyzz_0[j] - pc_y[j] * ta_yyy_xyzz_1[j] + 1.5 * fl1_fx * ta_yy_xyzz_0[j] - 1.5 * fl1_fx * ta_yy_xyzz_1[j] + 0.5 * fl1_fx * ta_yyy_xzz_0[j] - 0.5 * fl1_fx * ta_yyy_xzz_1[j];

                    ta_yyyy_xzzz_0[j] = pa_y[j] * ta_yyy_xzzz_0[j] - pc_y[j] * ta_yyy_xzzz_1[j] + 1.5 * fl1_fx * ta_yy_xzzz_0[j] - 1.5 * fl1_fx * ta_yy_xzzz_1[j];

                    ta_yyyy_yyyy_0[j] = pa_y[j] * ta_yyy_yyyy_0[j] - pc_y[j] * ta_yyy_yyyy_1[j] + 1.5 * fl1_fx * ta_yy_yyyy_0[j] - 1.5 * fl1_fx * ta_yy_yyyy_1[j] + 2.0 * fl1_fx * ta_yyy_yyy_0[j] - 2.0 * fl1_fx * ta_yyy_yyy_1[j];

                    ta_yyyy_yyyz_0[j] = pa_y[j] * ta_yyy_yyyz_0[j] - pc_y[j] * ta_yyy_yyyz_1[j] + 1.5 * fl1_fx * ta_yy_yyyz_0[j] - 1.5 * fl1_fx * ta_yy_yyyz_1[j] + 1.5 * fl1_fx * ta_yyy_yyz_0[j] - 1.5 * fl1_fx * ta_yyy_yyz_1[j];

                    ta_yyyy_yyzz_0[j] = pa_y[j] * ta_yyy_yyzz_0[j] - pc_y[j] * ta_yyy_yyzz_1[j] + 1.5 * fl1_fx * ta_yy_yyzz_0[j] - 1.5 * fl1_fx * ta_yy_yyzz_1[j] + fl1_fx * ta_yyy_yzz_0[j] - fl1_fx * ta_yyy_yzz_1[j];

                    ta_yyyy_yzzz_0[j] = pa_y[j] * ta_yyy_yzzz_0[j] - pc_y[j] * ta_yyy_yzzz_1[j] + 1.5 * fl1_fx * ta_yy_yzzz_0[j] - 1.5 * fl1_fx * ta_yy_yzzz_1[j] + 0.5 * fl1_fx * ta_yyy_zzz_0[j] - 0.5 * fl1_fx * ta_yyy_zzz_1[j];

                    ta_yyyy_zzzz_0[j] = pa_y[j] * ta_yyy_zzzz_0[j] - pc_y[j] * ta_yyy_zzzz_1[j] + 1.5 * fl1_fx * ta_yy_zzzz_0[j] - 1.5 * fl1_fx * ta_yy_zzzz_1[j];

                    ta_yyyz_xxxx_0[j] = pa_y[j] * ta_yyz_xxxx_0[j] - pc_y[j] * ta_yyz_xxxx_1[j] + fl1_fx * ta_yz_xxxx_0[j] - fl1_fx * ta_yz_xxxx_1[j];

                    ta_yyyz_xxxy_0[j] = pa_y[j] * ta_yyz_xxxy_0[j] - pc_y[j] * ta_yyz_xxxy_1[j] + fl1_fx * ta_yz_xxxy_0[j] - fl1_fx * ta_yz_xxxy_1[j] + 0.5 * fl1_fx * ta_yyz_xxx_0[j] - 0.5 * fl1_fx * ta_yyz_xxx_1[j];

                    ta_yyyz_xxxz_0[j] = pa_y[j] * ta_yyz_xxxz_0[j] - pc_y[j] * ta_yyz_xxxz_1[j] + fl1_fx * ta_yz_xxxz_0[j] - fl1_fx * ta_yz_xxxz_1[j];

                    ta_yyyz_xxyy_0[j] = pa_y[j] * ta_yyz_xxyy_0[j] - pc_y[j] * ta_yyz_xxyy_1[j] + fl1_fx * ta_yz_xxyy_0[j] - fl1_fx * ta_yz_xxyy_1[j] + fl1_fx * ta_yyz_xxy_0[j] - fl1_fx * ta_yyz_xxy_1[j];

                    ta_yyyz_xxyz_0[j] = pa_y[j] * ta_yyz_xxyz_0[j] - pc_y[j] * ta_yyz_xxyz_1[j] + fl1_fx * ta_yz_xxyz_0[j] - fl1_fx * ta_yz_xxyz_1[j] + 0.5 * fl1_fx * ta_yyz_xxz_0[j] - 0.5 * fl1_fx * ta_yyz_xxz_1[j];

                    ta_yyyz_xxzz_0[j] = pa_y[j] * ta_yyz_xxzz_0[j] - pc_y[j] * ta_yyz_xxzz_1[j] + fl1_fx * ta_yz_xxzz_0[j] - fl1_fx * ta_yz_xxzz_1[j];

                    ta_yyyz_xyyy_0[j] = pa_y[j] * ta_yyz_xyyy_0[j] - pc_y[j] * ta_yyz_xyyy_1[j] + fl1_fx * ta_yz_xyyy_0[j] - fl1_fx * ta_yz_xyyy_1[j] + 1.5 * fl1_fx * ta_yyz_xyy_0[j] - 1.5 * fl1_fx * ta_yyz_xyy_1[j];

                    ta_yyyz_xyyz_0[j] = pa_y[j] * ta_yyz_xyyz_0[j] - pc_y[j] * ta_yyz_xyyz_1[j] + fl1_fx * ta_yz_xyyz_0[j] - fl1_fx * ta_yz_xyyz_1[j] + fl1_fx * ta_yyz_xyz_0[j] - fl1_fx * ta_yyz_xyz_1[j];

                    ta_yyyz_xyzz_0[j] = pa_y[j] * ta_yyz_xyzz_0[j] - pc_y[j] * ta_yyz_xyzz_1[j] + fl1_fx * ta_yz_xyzz_0[j] - fl1_fx * ta_yz_xyzz_1[j] + 0.5 * fl1_fx * ta_yyz_xzz_0[j] - 0.5 * fl1_fx * ta_yyz_xzz_1[j];

                    ta_yyyz_xzzz_0[j] = pa_y[j] * ta_yyz_xzzz_0[j] - pc_y[j] * ta_yyz_xzzz_1[j] + fl1_fx * ta_yz_xzzz_0[j] - fl1_fx * ta_yz_xzzz_1[j];

                    ta_yyyz_yyyy_0[j] = pa_y[j] * ta_yyz_yyyy_0[j] - pc_y[j] * ta_yyz_yyyy_1[j] + fl1_fx * ta_yz_yyyy_0[j] - fl1_fx * ta_yz_yyyy_1[j] + 2.0 * fl1_fx * ta_yyz_yyy_0[j] - 2.0 * fl1_fx * ta_yyz_yyy_1[j];

                    ta_yyyz_yyyz_0[j] = pa_y[j] * ta_yyz_yyyz_0[j] - pc_y[j] * ta_yyz_yyyz_1[j] + fl1_fx * ta_yz_yyyz_0[j] - fl1_fx * ta_yz_yyyz_1[j] + 1.5 * fl1_fx * ta_yyz_yyz_0[j] - 1.5 * fl1_fx * ta_yyz_yyz_1[j];

                    ta_yyyz_yyzz_0[j] = pa_y[j] * ta_yyz_yyzz_0[j] - pc_y[j] * ta_yyz_yyzz_1[j] + fl1_fx * ta_yz_yyzz_0[j] - fl1_fx * ta_yz_yyzz_1[j] + fl1_fx * ta_yyz_yzz_0[j] - fl1_fx * ta_yyz_yzz_1[j];

                    ta_yyyz_yzzz_0[j] = pa_y[j] * ta_yyz_yzzz_0[j] - pc_y[j] * ta_yyz_yzzz_1[j] + fl1_fx * ta_yz_yzzz_0[j] - fl1_fx * ta_yz_yzzz_1[j] + 0.5 * fl1_fx * ta_yyz_zzz_0[j] - 0.5 * fl1_fx * ta_yyz_zzz_1[j];
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
            {
                ...
                for (int32_t j = 0; j < nprim; j++)
                {
                    ...
                    ta_yyzz_xxxx_0[j] = pa_y[j] * ta_yzz_xxxx_0[j] - pc_y[j] * ta_yzz_xxxx_1[j] + 0.5 * fl1_fx * ta_zz_xxxx_0[j] - 0.5 * fl1_fx * ta_zz_xxxx_1[j];

                    ta_yyzz_xxxy_0[j] = pa_y[j] * ta_yzz_xxxy_0[j] - pc_y[j] * ta_yzz_xxxy_1[j] + 0.5 * fl1_fx * ta_zz_xxxy_0[j] - 0.5 * fl1_fx * ta_zz_xxxy_1[j] + 0.5 * fl1_fx * ta_yzz_xxx_0[j] - 0.5 * fl1_fx * ta_yzz_xxx_1[j];

                    ta_yyzz_xxxz_0[j] = pa_y[j] * ta_yzz_xxxz_0[j] - pc_y[j] * ta_yzz_xxxz_1[j] + 0.5 * fl1_fx * ta_zz_xxxz_0[j] - 0.5 * fl1_fx * ta_zz_xxxz_1[j];

                    ta_yyzz_xxyy_0[j] = pa_y[j] * ta_yzz_xxyy_0[j] - pc_y[j] * ta_yzz_xxyy_1[j] + 0.5 * fl1_fx * ta_zz_xxyy_0[j] - 0.5 * fl1_fx * ta_zz_xxyy_1[j] + fl1_fx * ta_yzz_xxy_0[j] - fl1_fx * ta_yzz_xxy_1[j];

                    ta_yyzz_xxyz_0[j] = pa_y[j] * ta_yzz_xxyz_0[j] - pc_y[j] * ta_yzz_xxyz_1[j] + 0.5 * fl1_fx * ta_zz_xxyz_0[j] - 0.5 * fl1_fx * ta_zz_xxyz_1[j] + 0.5 * fl1_fx * ta_yzz_xxz_0[j] - 0.5 * fl1_fx * ta_yzz_xxz_1[j];

                    ta_yyzz_xxzz_0[j] = pa_y[j] * ta_yzz_xxzz_0[j] - pc_y[j] * ta_yzz_xxzz_1[j] + 0.5 * fl1_fx * ta_zz_xxzz_0[j] - 0.5 * fl1_fx * ta_zz_xxzz_1[j];

                    ta_yyzz_xyyy_0[j] = pa_y[j] * ta_yzz_xyyy_0[j] - pc_y[j] * ta_yzz_xyyy_1[j] + 0.5 * fl1_fx * ta_zz_xyyy_0[j] - 0.5 * fl1_fx * ta_zz_xyyy_1[j] + 1.5 * fl1_fx * ta_yzz_xyy_0[j] - 1.5 * fl1_fx * ta_yzz_xyy_1[j];

                    ta_yyzz_xyyz_0[j] = pa_y[j] * ta_yzz_xyyz_0[j] - pc_y[j] * ta_yzz_xyyz_1[j] + 0.5 * fl1_fx * ta_zz_xyyz_0[j] - 0.5 * fl1_fx * ta_zz_xyyz_1[j] + fl1_fx * ta_yzz_xyz_0[j] - fl1_fx * ta_yzz_xyz_1[j];

                    ta_yyzz_xyzz_0[j] = pa_y[j] * ta_yzz_xyzz_0[j] - pc_y[j] * ta_yzz_xyzz_1[j] + 0.5 * fl1_fx * ta_zz_xyzz_0[j] - 0.5 * fl1_fx * ta_zz_xyzz_1[j] + 0.5 * fl1_fx * ta_yzz_xzz_0[j] - 0.5 * fl1_fx * ta_yzz_xzz_1[j];

                    ta_yyzz_xzzz_0[j] = pa_y[j] * ta_yzz_xzzz_0[j] - pc_y[j] * ta_yzz_xzzz_1[j] + 0.5 * fl1_fx * ta_zz_xzzz_0[j] - 0.5 * fl1_fx * ta_zz_xzzz_1[j];

                    ta_yyzz_yyyy_0[j] = pa_y[j] * ta_yzz_yyyy_0[j] - pc_y[j] * ta_yzz_yyyy_1[j] + 0.5 * fl1_fx * ta_zz_yyyy_0[j] - 0.5 * fl1_fx * ta_zz_yyyy_1[j] + 2.0 * fl1_fx * ta_yzz_yyy_0[j] - 2.0 * fl1_fx * ta_yzz_yyy_1[j];

                    ta_yyzz_yyyz_0[j] = pa_y[j] * ta_yzz_yyyz_0[j] - pc_y[j] * ta_yzz_yyyz_1[j] + 0.5 * fl1_fx * ta_zz_yyyz_0[j] - 0.5 * fl1_fx * ta_zz_yyyz_1[j] + 1.5 * fl1_fx * ta_yzz_yyz_0[j] - 1.5 * fl1_fx * ta_yzz_yyz_1[j];

                    ta_yyzz_yyzz_0[j] = pa_y[j] * ta_yzz_yyzz_0[j] - pc_y[j] * ta_yzz_yyzz_1[j] + 0.5 * fl1_fx * ta_zz_yyzz_0[j] - 0.5 * fl1_fx * ta_zz_yyzz_1[j] + fl1_fx * ta_yzz_yzz_0[j] - fl1_fx * ta_yzz_yzz_1[j];

                    ta_yyzz_yzzz_0[j] = pa_y[j] * ta_yzz_yzzz_0[j] - pc_y[j] * ta_yzz_yzzz_1[j] + 0.5 * fl1_fx * ta_zz_yzzz_0[j] - 0.5 * fl1_fx * ta_zz_yzzz_1[j] + 0.5 * fl1_fx * ta_yzz_zzz_0[j] - 0.5 * fl1_fx * ta_yzz_zzz_1[j];

                    ta_yyzz_zzzz_0[j] = pa_y[j] * ta_yzz_zzzz_0[j] - pc_y[j] * ta_yzz_zzzz_1[j] + 0.5 * fl1_fx * ta_zz_zzzz_0[j] - 0.5 * fl1_fx * ta_zz_zzzz_1[j];

                    ta_yzzz_xxxx_0[j] = pa_y[j] * ta_zzz_xxxx_0[j] - pc_y[j] * ta_zzz_xxxx_1[j];

                    ta_yzzz_xxxy_0[j] = pa_y[j] * ta_zzz_xxxy_0[j] - pc_y[j] * ta_zzz_xxxy_1[j] + 0.5 * fl1_fx * ta_zzz_xxx_0[j] - 0.5 * fl1_fx * ta_zzz_xxx_1[j];
                    ...
                    ta_yzzz_xxyz_0[j] = pa_y[j] * ta_zzz_xxyz_0[j] - pc_y[j] * ta_zzz_xxyz_1[j] + 0.5 * fl1_fx * ta_zzz_xxz_0[j] - 0.5 * fl1_fx * ta_zzz_xxz_1[j];

                    ta_yzzz_xxzz_0[j] = pa_y[j] * ta_zzz_xxzz_0[j] - pc_y[j] * ta_zzz_xxzz_1[j];

                    ta_yzzz_xyyy_0[j] = pa_y[j] * ta_zzz_xyyy_0[j] - pc_y[j] * ta_zzz_xyyy_1[j] + 1.5 * fl1_fx * ta_zzz_xyy_0[j] - 1.5 * fl1_fx * ta_zzz_xyy_1[j];

                    ta_yzzz_xyyz_0[j] = pa_y[j] * ta_zzz_xyyz_0[j] - pc_y[j] * ta_zzz_xyyz_1[j] + fl1_fx * ta_zzz_xyz_0[j] - fl1_fx * ta_zzz_xyz_1[j];

                    ta_yzzz_xyzz_0[j] = pa_y[j] * ta_zzz_xyzz_0[j] - pc_y[j] * ta_zzz_xyzz_1[j] + 0.5 * fl1_fx * ta_zzz_xzz_0[j] - 0.5 * fl1_fx * ta_zzz_xzz_1[j];

                    ta_yzzz_xzzz_0[j] = pa_y[j] * ta_zzz_xzzz_0[j] - pc_y[j] * ta_zzz_xzzz_1[j];

                    ta_yzzz_yyyy_0[j] = pa_y[j] * ta_zzz_yyyy_0[j] - pc_y[j] * ta_zzz_yyyy_1[j] + 2.0 * fl1_fx * ta_zzz_yyy_0[j] - 2.0 * fl1_fx * ta_zzz_yyy_1[j];

                    ta_yzzz_yyyz_0[j] = pa_y[j] * ta_zzz_yyyz_0[j] - pc_y[j] * ta_zzz_yyyz_1[j] + 1.5 * fl1_fx * ta_zzz_yyz_0[j] - 1.5 * fl1_fx * ta_zzz_yyz_1[j];

                    ta_yzzz_yyzz_0[j] = pa_y[j] * ta_zzz_yyzz_0[j] - pc_y[j] * ta_zzz_yyzz_1[j] + fl1_fx * ta_zzz_yzz_0[j] - fl1_fx * ta_zzz_yzz_1[j];

                    ta_yzzz_yzzz_0[j] = pa_y[j] * ta_zzz_yzzz_0[j] - pc_y[j] * ta_zzz_yzzz_1[j] + 0.5 * fl1_fx * ta_zzz_zzz_0[j] - 0.5 * fl1_fx * ta_zzz_zzz_1[j];

                    ta_yzzz_zzzz_0[j] = pa_y[j] * ta_zzz_zzzz_0[j] - pc_y[j] * ta_zzz_zzzz_1[j];

                    ta_zzzz_xxxx_0[j] = pa_z[j] * ta_zzz_xxxx_0[j] - pc_z[j] * ta_zzz_xxxx_1[j] + 1.5 * fl1_fx * ta_zz_xxxx_0[j] - 1.5 * fl1_fx * ta_zz_xxxx_1[j];

                    ta_zzzz_xxxy_0[j] = pa_z[j] * ta_zzz_xxxy_0[j] - pc_z[j] * ta_zzz_xxxy_1[j] + 1.5 * fl1_fx * ta_zz_xxxy_0[j] - 1.5 * fl1_fx * ta_zz_xxxy_1[j];

                    ta_zzzz_xxxz_0[j] = pa_z[j] * ta_zzz_xxxz_0[j] - pc_z[j] * ta_zzz_xxxz_1[j] + 1.5 * fl1_fx * ta_zz_xxxz_0[j] - 1.5 * fl1_fx * ta_zz_xxxz_1[j] + 0.5 * fl1_fx * ta_zzz_xxx_0[j] - 0.5 * fl1_fx * ta_zzz_xxx_1[j];

                    ta_zzzz_xxyy_0[j] = pa_z[j] * ta_zzz_xxyy_0[j] - pc_z[j] * ta_zzz_xxyy_1[j] + 1.5 * fl1_fx * ta_zz_xxyy_0[j] - 1.5 * fl1_fx * ta_zz_xxyy_1[j];

                    ta_zzzz_xxyz_0[j] = pa_z[j] * ta_zzz_xxyz_0[j] - pc_z[j] * ta_zzz_xxyz_1[j] + 1.5 * fl1_fx * ta_zz_xxyz_0[j] - 1.5 * fl1_fx * ta_zz_xxyz_1[j] + 0.5 * fl1_fx * ta_zzz_xxy_0[j] - 0.5 * fl1_fx * ta_zzz_xxy_1[j];

                    ta_zzzz_xxzz_0[j] = pa_z[j] * ta_zzz_xxzz_0[j] - pc_z[j] * ta_zzz_xxzz_1[j] + 1.5 * fl1_fx * ta_zz_xxzz_0[j] - 1.5 * fl1_fx * ta_zz_xxzz_1[j] + fl1_fx * ta_zzz_xxz_0[j] - fl1_fx * ta_zzz_xxz_1[j];

                    ta_zzzz_xyyy_0[j] = pa_z[j] * ta_zzz_xyyy_0[j] - pc_z[j] * ta_zzz_xyyy_1[j] + 1.5 * fl1_fx * ta_zz_xyyy_0[j] - 1.5 * fl1_fx * ta_zz_xyyy_1[j];

                    ta_zzzz_xyyz_0[j] = pa_z[j] * ta_zzz_xyyz_0[j] - pc_z[j] * ta_zzz_xyyz_1[j] + 1.5 * fl1_fx * ta_zz_xyyz_0[j] - 1.5 * fl1_fx * ta_zz_xyyz_1[j] + 0.5 * fl1_fx * ta_zzz_xyy_0[j] - 0.5 * fl1_fx * ta_zzz_xyy_1[j];

                    ta_zzzz_xyzz_0[j] = pa_z[j] * ta_zzz_xyzz_0[j] - pc_z[j] * ta_zzz_xyzz_1[j] + 1.5 * fl1_fx * ta_zz_xyzz_0[j] - 1.5 * fl1_fx * ta_zz_xyzz_1[j] + fl1_fx * ta_zzz_xyz_0[j] - fl1_fx * ta_zzz_xyz_1[j];

                    ta_zzzz_xzzz_0[j] = pa_z[j] * ta_zzz_xzzz_0[j] - pc_z[j] * ta_zzz_xzzz_1[j] + 1.5 * fl1_fx * ta_zz_xzzz_0[j] - 1.5 * fl1_fx * ta_zz_xzzz_1[j] + 1.5 * fl1_fx * ta_zzz_xzz_0[j] - 1.5 * fl1_fx * ta_zzz_xzz_1[j];

                    ta_zzzz_yyyy_0[j] = pa_z[j] * ta_zzz_yyyy_0[j] - pc_z[j] * ta_zzz_yyyy_1[j] + 1.5 * fl1_fx * ta_zz_yyyy_0[j] - 1.5 * fl1_fx * ta_zz_yyyy_1[j];

                    ta_zzzz_yyyz_0[j] = pa_z[j] * ta_zzz_yyyz_0[j] - pc_z[j] * ta_zzz_yyyz_1[j] + 1.5 * fl1_fx * ta_zz_yyyz_0[j] - 1.5 * fl1_fx * ta_zz_yyyz_1[j] + 0.5 * fl1_fx * ta_zzz_yyy_0[j] - 0.5 * fl1_fx * ta_zzz_yyy_1[j];

                    ta_zzzz_yyzz_0[j] = pa_z[j] * ta_zzz_yyzz_0[j] - pc_z[j] * ta_zzz_yyzz_1[j] + 1.5 * fl1_fx * ta_zz_yyzz_0[j] - 1.5 * fl1_fx * ta_zz_yyzz_1[j] + fl1_fx * ta_zzz_yyz_0[j] - fl1_fx * ta_zzz_yyz_1[j];

                    ta_zzzz_yzzz_0[j] = pa_z[j] * ta_zzz_yzzz_0[j] - pc_z[j] * ta_zzz_yzzz_1[j] + 1.5 * fl1_fx * ta_zz_yzzz_0[j] - 1.5 * fl1_fx * ta_zz_yzzz_1[j] + 1.5 * fl1_fx * ta_zzz_yzz_0[j] - 1.5 * fl1_fx * ta_zzz_yzz_1[j];

                    ta_zzzz_zzzz_0[j] = pa_z[j] * ta_zzz_zzzz_0[j] - pc_z[j] * ta_zzz_zzzz_1[j] + 1.5 * fl1_fx * ta_zz_zzzz_0[j] - 1.5 * fl1_fx * ta_zz_zzzz_1[j] + 2.0 * fl1_fx * ta_zzz_zzz_0[j] - 2.0 * fl1_fx * ta_zzz_zzz_1[j];
                }
