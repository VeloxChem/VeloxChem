...
namespace npotrecfunc { // npotrecfunc namespace
    ...
    {
        npotrecfunc::compNuclearPotentialForFF_0_50(primBuffer,
                                                    recursionMap,
                                                    osFactors,
                                                    paDistances, 
                                                    pcDistances, 
        ...
        npotrecfunc::compNuclearPotentialForFF_50_100(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      paDistances, 
                                                      pcDistances, 
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
            {
                ...
                for (int32_t j = 0; j < nprim; j++)
                {
                    ...
                    ta_xxx_xxx_0[j] = pa_x[j] * ta_xx_xxx_0[j] - pc_x[j] * ta_xx_xxx_1[j] + fl1_fx * ta_x_xxx_0[j] - fl1_fx * ta_x_xxx_1[j] + 1.5 * fl1_fx * ta_xx_xx_0[j] - 1.5 * fl1_fx * ta_xx_xx_1[j];

                    ta_xxx_xxy_0[j] = pa_x[j] * ta_xx_xxy_0[j] - pc_x[j] * ta_xx_xxy_1[j] + fl1_fx * ta_x_xxy_0[j] - fl1_fx * ta_x_xxy_1[j] + fl1_fx * ta_xx_xy_0[j] - fl1_fx * ta_xx_xy_1[j];

                    ta_xxx_xxz_0[j] = pa_x[j] * ta_xx_xxz_0[j] - pc_x[j] * ta_xx_xxz_1[j] + fl1_fx * ta_x_xxz_0[j] - fl1_fx * ta_x_xxz_1[j] + fl1_fx * ta_xx_xz_0[j] - fl1_fx * ta_xx_xz_1[j];

                    ta_xxx_xyy_0[j] = pa_x[j] * ta_xx_xyy_0[j] - pc_x[j] * ta_xx_xyy_1[j] + fl1_fx * ta_x_xyy_0[j] - fl1_fx * ta_x_xyy_1[j] + 0.5 * fl1_fx * ta_xx_yy_0[j] - 0.5 * fl1_fx * ta_xx_yy_1[j];

                    ta_xxx_xyz_0[j] = pa_x[j] * ta_xx_xyz_0[j] - pc_x[j] * ta_xx_xyz_1[j] + fl1_fx * ta_x_xyz_0[j] - fl1_fx * ta_x_xyz_1[j] + 0.5 * fl1_fx * ta_xx_yz_0[j] - 0.5 * fl1_fx * ta_xx_yz_1[j];

                    ta_xxx_xzz_0[j] = pa_x[j] * ta_xx_xzz_0[j] - pc_x[j] * ta_xx_xzz_1[j] + fl1_fx * ta_x_xzz_0[j] - fl1_fx * ta_x_xzz_1[j] + 0.5 * fl1_fx * ta_xx_zz_0[j] - 0.5 * fl1_fx * ta_xx_zz_1[j];
                    ...
                    ta_xxy_xxx_0[j] = pa_x[j] * ta_xy_xxx_0[j] - pc_x[j] * ta_xy_xxx_1[j] + 0.5 * fl1_fx * ta_y_xxx_0[j] - 0.5 * fl1_fx * ta_y_xxx_1[j] + 1.5 * fl1_fx * ta_xy_xx_0[j] - 1.5 * fl1_fx * ta_xy_xx_1[j];

                    ta_xxy_xxy_0[j] = pa_x[j] * ta_xy_xxy_0[j] - pc_x[j] * ta_xy_xxy_1[j] + 0.5 * fl1_fx * ta_y_xxy_0[j] - 0.5 * fl1_fx * ta_y_xxy_1[j] + fl1_fx * ta_xy_xy_0[j] - fl1_fx * ta_xy_xy_1[j];

                    ta_xxy_xxz_0[j] = pa_x[j] * ta_xy_xxz_0[j] - pc_x[j] * ta_xy_xxz_1[j] + 0.5 * fl1_fx * ta_y_xxz_0[j] - 0.5 * fl1_fx * ta_y_xxz_1[j] + fl1_fx * ta_xy_xz_0[j] - fl1_fx * ta_xy_xz_1[j];

                    ta_xxy_xyy_0[j] = pa_x[j] * ta_xy_xyy_0[j] - pc_x[j] * ta_xy_xyy_1[j] + 0.5 * fl1_fx * ta_y_xyy_0[j] - 0.5 * fl1_fx * ta_y_xyy_1[j] + 0.5 * fl1_fx * ta_xy_yy_0[j] - 0.5 * fl1_fx * ta_xy_yy_1[j];

                    ta_xxy_xyz_0[j] = pa_x[j] * ta_xy_xyz_0[j] - pc_x[j] * ta_xy_xyz_1[j] + 0.5 * fl1_fx * ta_y_xyz_0[j] - 0.5 * fl1_fx * ta_y_xyz_1[j] + 0.5 * fl1_fx * ta_xy_yz_0[j] - 0.5 * fl1_fx * ta_xy_yz_1[j];

                    ta_xxy_xzz_0[j] = pa_x[j] * ta_xy_xzz_0[j] - pc_x[j] * ta_xy_xzz_1[j] + 0.5 * fl1_fx * ta_y_xzz_0[j] - 0.5 * fl1_fx * ta_y_xzz_1[j] + 0.5 * fl1_fx * ta_xy_zz_0[j] - 0.5 * fl1_fx * ta_xy_zz_1[j];
                    ...
                    ta_xxz_xxx_0[j] = pa_x[j] * ta_xz_xxx_0[j] - pc_x[j] * ta_xz_xxx_1[j] + 0.5 * fl1_fx * ta_z_xxx_0[j] - 0.5 * fl1_fx * ta_z_xxx_1[j] + 1.5 * fl1_fx * ta_xz_xx_0[j] - 1.5 * fl1_fx * ta_xz_xx_1[j];

                    ta_xxz_xxy_0[j] = pa_x[j] * ta_xz_xxy_0[j] - pc_x[j] * ta_xz_xxy_1[j] + 0.5 * fl1_fx * ta_z_xxy_0[j] - 0.5 * fl1_fx * ta_z_xxy_1[j] + fl1_fx * ta_xz_xy_0[j] - fl1_fx * ta_xz_xy_1[j];

                    ta_xxz_xxz_0[j] = pa_x[j] * ta_xz_xxz_0[j] - pc_x[j] * ta_xz_xxz_1[j] + 0.5 * fl1_fx * ta_z_xxz_0[j] - 0.5 * fl1_fx * ta_z_xxz_1[j] + fl1_fx * ta_xz_xz_0[j] - fl1_fx * ta_xz_xz_1[j];

                    ta_xxz_xyy_0[j] = pa_x[j] * ta_xz_xyy_0[j] - pc_x[j] * ta_xz_xyy_1[j] + 0.5 * fl1_fx * ta_z_xyy_0[j] - 0.5 * fl1_fx * ta_z_xyy_1[j] + 0.5 * fl1_fx * ta_xz_yy_0[j] - 0.5 * fl1_fx * ta_xz_yy_1[j];

                    ta_xxz_xyz_0[j] = pa_x[j] * ta_xz_xyz_0[j] - pc_x[j] * ta_xz_xyz_1[j] + 0.5 * fl1_fx * ta_z_xyz_0[j] - 0.5 * fl1_fx * ta_z_xyz_1[j] + 0.5 * fl1_fx * ta_xz_yz_0[j] - 0.5 * fl1_fx * ta_xz_yz_1[j];

                    ta_xxz_xzz_0[j] = pa_x[j] * ta_xz_xzz_0[j] - pc_x[j] * ta_xz_xzz_1[j] + 0.5 * fl1_fx * ta_z_xzz_0[j] - 0.5 * fl1_fx * ta_z_xzz_1[j] + 0.5 * fl1_fx * ta_xz_zz_0[j] - 0.5 * fl1_fx * ta_xz_zz_1[j];
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
            {
                ...
                for (int32_t j = 0; j < nprim; j++)
                {
                    ...
                    ta_yyy_xxy_0[j] = pa_y[j] * ta_yy_xxy_0[j] - pc_y[j] * ta_yy_xxy_1[j] + fl1_fx * ta_y_xxy_0[j] - fl1_fx * ta_y_xxy_1[j] + 0.5 * fl1_fx * ta_yy_xx_0[j] - 0.5 * fl1_fx * ta_yy_xx_1[j];

                    ta_yyy_xxz_0[j] = pa_y[j] * ta_yy_xxz_0[j] - pc_y[j] * ta_yy_xxz_1[j] + fl1_fx * ta_y_xxz_0[j] - fl1_fx * ta_y_xxz_1[j];

                    ta_yyy_xyy_0[j] = pa_y[j] * ta_yy_xyy_0[j] - pc_y[j] * ta_yy_xyy_1[j] + fl1_fx * ta_y_xyy_0[j] - fl1_fx * ta_y_xyy_1[j] + fl1_fx * ta_yy_xy_0[j] - fl1_fx * ta_yy_xy_1[j];

                    ta_yyy_xyz_0[j] = pa_y[j] * ta_yy_xyz_0[j] - pc_y[j] * ta_yy_xyz_1[j] + fl1_fx * ta_y_xyz_0[j] - fl1_fx * ta_y_xyz_1[j] + 0.5 * fl1_fx * ta_yy_xz_0[j] - 0.5 * fl1_fx * ta_yy_xz_1[j];

                    ta_yyy_xzz_0[j] = pa_y[j] * ta_yy_xzz_0[j] - pc_y[j] * ta_yy_xzz_1[j] + fl1_fx * ta_y_xzz_0[j] - fl1_fx * ta_y_xzz_1[j];

                    ta_yyy_yyy_0[j] = pa_y[j] * ta_yy_yyy_0[j] - pc_y[j] * ta_yy_yyy_1[j] + fl1_fx * ta_y_yyy_0[j] - fl1_fx * ta_y_yyy_1[j] + 1.5 * fl1_fx * ta_yy_yy_0[j] - 1.5 * fl1_fx * ta_yy_yy_1[j];

                    ta_yyy_yyz_0[j] = pa_y[j] * ta_yy_yyz_0[j] - pc_y[j] * ta_yy_yyz_1[j] + fl1_fx * ta_y_yyz_0[j] - fl1_fx * ta_y_yyz_1[j] + fl1_fx * ta_yy_yz_0[j] - fl1_fx * ta_yy_yz_1[j];

                    ta_yyy_yzz_0[j] = pa_y[j] * ta_yy_yzz_0[j] - pc_y[j] * ta_yy_yzz_1[j] + fl1_fx * ta_y_yzz_0[j] - fl1_fx * ta_y_yzz_1[j] + 0.5 * fl1_fx * ta_yy_zz_0[j] - 0.5 * fl1_fx * ta_yy_zz_1[j];
                    ...
                    ta_yyz_xxy_0[j] = pa_y[j] * ta_yz_xxy_0[j] - pc_y[j] * ta_yz_xxy_1[j] + 0.5 * fl1_fx * ta_z_xxy_0[j] - 0.5 * fl1_fx * ta_z_xxy_1[j] + 0.5 * fl1_fx * ta_yz_xx_0[j] - 0.5 * fl1_fx * ta_yz_xx_1[j];

                    ta_yyz_xxz_0[j] = pa_y[j] * ta_yz_xxz_0[j] - pc_y[j] * ta_yz_xxz_1[j] + 0.5 * fl1_fx * ta_z_xxz_0[j] - 0.5 * fl1_fx * ta_z_xxz_1[j];

                    ta_yyz_xyy_0[j] = pa_y[j] * ta_yz_xyy_0[j] - pc_y[j] * ta_yz_xyy_1[j] + 0.5 * fl1_fx * ta_z_xyy_0[j] - 0.5 * fl1_fx * ta_z_xyy_1[j] + fl1_fx * ta_yz_xy_0[j] - fl1_fx * ta_yz_xy_1[j];

                    ta_yyz_xyz_0[j] = pa_y[j] * ta_yz_xyz_0[j] - pc_y[j] * ta_yz_xyz_1[j] + 0.5 * fl1_fx * ta_z_xyz_0[j] - 0.5 * fl1_fx * ta_z_xyz_1[j] + 0.5 * fl1_fx * ta_yz_xz_0[j] - 0.5 * fl1_fx * ta_yz_xz_1[j];

                    ta_yyz_xzz_0[j] = pa_y[j] * ta_yz_xzz_0[j] - pc_y[j] * ta_yz_xzz_1[j] + 0.5 * fl1_fx * ta_z_xzz_0[j] - 0.5 * fl1_fx * ta_z_xzz_1[j];

                    ta_yyz_yyy_0[j] = pa_y[j] * ta_yz_yyy_0[j] - pc_y[j] * ta_yz_yyy_1[j] + 0.5 * fl1_fx * ta_z_yyy_0[j] - 0.5 * fl1_fx * ta_z_yyy_1[j] + 1.5 * fl1_fx * ta_yz_yy_0[j] - 1.5 * fl1_fx * ta_yz_yy_1[j];

                    ta_yyz_yyz_0[j] = pa_y[j] * ta_yz_yyz_0[j] - pc_y[j] * ta_yz_yyz_1[j] + 0.5 * fl1_fx * ta_z_yyz_0[j] - 0.5 * fl1_fx * ta_z_yyz_1[j] + fl1_fx * ta_yz_yz_0[j] - fl1_fx * ta_yz_yz_1[j];

                    ta_yyz_yzz_0[j] = pa_y[j] * ta_yz_yzz_0[j] - pc_y[j] * ta_yz_yzz_1[j] + 0.5 * fl1_fx * ta_z_yzz_0[j] - 0.5 * fl1_fx * ta_z_yzz_1[j] + 0.5 * fl1_fx * ta_yz_zz_0[j] - 0.5 * fl1_fx * ta_yz_zz_1[j];
                    ...
                    ta_zzz_xxz_0[j] = pa_z[j] * ta_zz_xxz_0[j] - pc_z[j] * ta_zz_xxz_1[j] + fl1_fx * ta_z_xxz_0[j] - fl1_fx * ta_z_xxz_1[j] + 0.5 * fl1_fx * ta_zz_xx_0[j] - 0.5 * fl1_fx * ta_zz_xx_1[j];

                    ta_zzz_xyy_0[j] = pa_z[j] * ta_zz_xyy_0[j] - pc_z[j] * ta_zz_xyy_1[j] + fl1_fx * ta_z_xyy_0[j] - fl1_fx * ta_z_xyy_1[j];

                    ta_zzz_xyz_0[j] = pa_z[j] * ta_zz_xyz_0[j] - pc_z[j] * ta_zz_xyz_1[j] + fl1_fx * ta_z_xyz_0[j] - fl1_fx * ta_z_xyz_1[j] + 0.5 * fl1_fx * ta_zz_xy_0[j] - 0.5 * fl1_fx * ta_zz_xy_1[j];

                    ta_zzz_xzz_0[j] = pa_z[j] * ta_zz_xzz_0[j] - pc_z[j] * ta_zz_xzz_1[j] + fl1_fx * ta_z_xzz_0[j] - fl1_fx * ta_z_xzz_1[j] + fl1_fx * ta_zz_xz_0[j] - fl1_fx * ta_zz_xz_1[j];

                    ta_zzz_yyy_0[j] = pa_z[j] * ta_zz_yyy_0[j] - pc_z[j] * ta_zz_yyy_1[j] + fl1_fx * ta_z_yyy_0[j] - fl1_fx * ta_z_yyy_1[j];

                    ta_zzz_yyz_0[j] = pa_z[j] * ta_zz_yyz_0[j] - pc_z[j] * ta_zz_yyz_1[j] + fl1_fx * ta_z_yyz_0[j] - fl1_fx * ta_z_yyz_1[j] + 0.5 * fl1_fx * ta_zz_yy_0[j] - 0.5 * fl1_fx * ta_zz_yy_1[j];

                    ta_zzz_yzz_0[j] = pa_z[j] * ta_zz_yzz_0[j] - pc_z[j] * ta_zz_yzz_1[j] + fl1_fx * ta_z_yzz_0[j] - fl1_fx * ta_z_yzz_1[j] + fl1_fx * ta_zz_yz_0[j] - fl1_fx * ta_zz_yz_1[j];

                    ta_zzz_zzz_0[j] = pa_z[j] * ta_zz_zzz_0[j] - pc_z[j] * ta_zz_zzz_1[j] + fl1_fx * ta_z_zzz_0[j] - fl1_fx * ta_z_zzz_1[j] + 1.5 * fl1_fx * ta_zz_zz_0[j] - 1.5 * fl1_fx * ta_zz_zz_1[j];
                }
