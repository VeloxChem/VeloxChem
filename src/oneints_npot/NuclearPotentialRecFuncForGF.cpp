...
{
    npotrecfunc::compNuclearPotentialForGF_0_50(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    npotrecfunc::compNuclearPotentialForGF_50_100(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    npotrecfunc::compNuclearPotentialForGF_100_150(
                               ...
                               const int32_t              iContrGto)
{
    ...
    auto mord = recursionMap.getMaxOrder({"Nuclear Potential"}, {4, -1, -1, -1}, {3, -1, -1, -1}, 1, 1);
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        auto pidx_a_4_3_m0 =
            recursionMap.getIndexOfTerm(CRecursionTerm({"Nuclear Potential"}, 0, true, {4, -1, -1, -1}, {3, -1, -1, -1}, 1, 1, iord));
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                ta_xxxx_xxx_0[j] = pa_x[j] * ta_xxx_xxx_0[j] - pc_x[j] * ta_xxx_xxx_1[j] + 1.5 * fl1_fx * ta_xx_xxx_0[j] -
                                   1.5 * fl1_fx * ta_xx_xxx_1[j] + 1.5 * fl1_fx * ta_xxx_xx_0[j] - 1.5 * fl1_fx * ta_xxx_xx_1[j];

                ta_xxxx_xxy_0[j] = pa_x[j] * ta_xxx_xxy_0[j] - pc_x[j] * ta_xxx_xxy_1[j] + 1.5 * fl1_fx * ta_xx_xxy_0[j] -
                                   1.5 * fl1_fx * ta_xx_xxy_1[j] + fl1_fx * ta_xxx_xy_0[j] - fl1_fx * ta_xxx_xy_1[j];

                ta_xxxx_xxz_0[j] = pa_x[j] * ta_xxx_xxz_0[j] - pc_x[j] * ta_xxx_xxz_1[j] + 1.5 * fl1_fx * ta_xx_xxz_0[j] -
                                   1.5 * fl1_fx * ta_xx_xxz_1[j] + fl1_fx * ta_xxx_xz_0[j] - fl1_fx * ta_xxx_xz_1[j];

                ta_xxxx_xyy_0[j] = pa_x[j] * ta_xxx_xyy_0[j] - pc_x[j] * ta_xxx_xyy_1[j] + 1.5 * fl1_fx * ta_xx_xyy_0[j] -
                                   1.5 * fl1_fx * ta_xx_xyy_1[j] + 0.5 * fl1_fx * ta_xxx_yy_0[j] - 0.5 * fl1_fx * ta_xxx_yy_1[j];

                ta_xxxx_xyz_0[j] = pa_x[j] * ta_xxx_xyz_0[j] - pc_x[j] * ta_xxx_xyz_1[j] + 1.5 * fl1_fx * ta_xx_xyz_0[j] -
                                   1.5 * fl1_fx * ta_xx_xyz_1[j] + 0.5 * fl1_fx * ta_xxx_yz_0[j] - 0.5 * fl1_fx * ta_xxx_yz_1[j];

                ta_xxxx_xzz_0[j] = pa_x[j] * ta_xxx_xzz_0[j] - pc_x[j] * ta_xxx_xzz_1[j] + 1.5 * fl1_fx * ta_xx_xzz_0[j] -
                                   1.5 * fl1_fx * ta_xx_xzz_1[j] + 0.5 * fl1_fx * ta_xxx_zz_0[j] - 0.5 * fl1_fx * ta_xxx_zz_1[j];

                ta_xxxx_yyy_0[j] =
                    pa_x[j] * ta_xxx_yyy_0[j] - pc_x[j] * ta_xxx_yyy_1[j] + 1.5 * fl1_fx * ta_xx_yyy_0[j] - 1.5 * fl1_fx * ta_xx_yyy_1[j];

                ta_xxxx_yyz_0[j] =
                    pa_x[j] * ta_xxx_yyz_0[j] - pc_x[j] * ta_xxx_yyz_1[j] + 1.5 * fl1_fx * ta_xx_yyz_0[j] - 1.5 * fl1_fx * ta_xx_yyz_1[j];

                ta_xxxx_yzz_0[j] =
                    pa_x[j] * ta_xxx_yzz_0[j] - pc_x[j] * ta_xxx_yzz_1[j] + 1.5 * fl1_fx * ta_xx_yzz_0[j] - 1.5 * fl1_fx * ta_xx_yzz_1[j];

                ta_xxxx_zzz_0[j] =
                    pa_x[j] * ta_xxx_zzz_0[j] - pc_x[j] * ta_xxx_zzz_1[j] + 1.5 * fl1_fx * ta_xx_zzz_0[j] - 1.5 * fl1_fx * ta_xx_zzz_1[j];

                ta_xxxy_xxx_0[j] = pa_x[j] * ta_xxy_xxx_0[j] - pc_x[j] * ta_xxy_xxx_1[j] + fl1_fx * ta_xy_xxx_0[j] - fl1_fx * ta_xy_xxx_1[j] +
                                   1.5 * fl1_fx * ta_xxy_xx_0[j] - 1.5 * fl1_fx * ta_xxy_xx_1[j];

                ta_xxxy_xxy_0[j] = pa_x[j] * ta_xxy_xxy_0[j] - pc_x[j] * ta_xxy_xxy_1[j] + fl1_fx * ta_xy_xxy_0[j] - fl1_fx * ta_xy_xxy_1[j] +
                                   fl1_fx * ta_xxy_xy_0[j] - fl1_fx * ta_xxy_xy_1[j];

                ta_xxxy_xxz_0[j] = pa_x[j] * ta_xxy_xxz_0[j] - pc_x[j] * ta_xxy_xxz_1[j] + fl1_fx * ta_xy_xxz_0[j] - fl1_fx * ta_xy_xxz_1[j] +
                                   fl1_fx * ta_xxy_xz_0[j] - fl1_fx * ta_xxy_xz_1[j];

                ta_xxxy_xyy_0[j] = pa_x[j] * ta_xxy_xyy_0[j] - pc_x[j] * ta_xxy_xyy_1[j] + fl1_fx * ta_xy_xyy_0[j] - fl1_fx * ta_xy_xyy_1[j] +
                                   0.5 * fl1_fx * ta_xxy_yy_0[j] - 0.5 * fl1_fx * ta_xxy_yy_1[j];

                ta_xxxy_xyz_0[j] = pa_x[j] * ta_xxy_xyz_0[j] - pc_x[j] * ta_xxy_xyz_1[j] + fl1_fx * ta_xy_xyz_0[j] - fl1_fx * ta_xy_xyz_1[j] +
                                   0.5 * fl1_fx * ta_xxy_yz_0[j] - 0.5 * fl1_fx * ta_xxy_yz_1[j];

                ta_xxxy_xzz_0[j] = pa_x[j] * ta_xxy_xzz_0[j] - pc_x[j] * ta_xxy_xzz_1[j] + fl1_fx * ta_xy_xzz_0[j] - fl1_fx * ta_xy_xzz_1[j] +
                                   0.5 * fl1_fx * ta_xxy_zz_0[j] - 0.5 * fl1_fx * ta_xxy_zz_1[j];
                ...
                ta_xxxz_xxx_0[j] = pa_x[j] * ta_xxz_xxx_0[j] - pc_x[j] * ta_xxz_xxx_1[j] + fl1_fx * ta_xz_xxx_0[j] - fl1_fx * ta_xz_xxx_1[j] +
                                   1.5 * fl1_fx * ta_xxz_xx_0[j] - 1.5 * fl1_fx * ta_xxz_xx_1[j];

                ta_xxxz_xxy_0[j] = pa_x[j] * ta_xxz_xxy_0[j] - pc_x[j] * ta_xxz_xxy_1[j] + fl1_fx * ta_xz_xxy_0[j] - fl1_fx * ta_xz_xxy_1[j] +
                                   fl1_fx * ta_xxz_xy_0[j] - fl1_fx * ta_xxz_xy_1[j];

                ta_xxxz_xxz_0[j] = pa_x[j] * ta_xxz_xxz_0[j] - pc_x[j] * ta_xxz_xxz_1[j] + fl1_fx * ta_xz_xxz_0[j] - fl1_fx * ta_xz_xxz_1[j] +
                                   fl1_fx * ta_xxz_xz_0[j] - fl1_fx * ta_xxz_xz_1[j];

                ta_xxxz_xyy_0[j] = pa_x[j] * ta_xxz_xyy_0[j] - pc_x[j] * ta_xxz_xyy_1[j] + fl1_fx * ta_xz_xyy_0[j] - fl1_fx * ta_xz_xyy_1[j] +
                                   0.5 * fl1_fx * ta_xxz_yy_0[j] - 0.5 * fl1_fx * ta_xxz_yy_1[j];

                ta_xxxz_xyz_0[j] = pa_x[j] * ta_xxz_xyz_0[j] - pc_x[j] * ta_xxz_xyz_1[j] + fl1_fx * ta_xz_xyz_0[j] - fl1_fx * ta_xz_xyz_1[j] +
                                   0.5 * fl1_fx * ta_xxz_yz_0[j] - 0.5 * fl1_fx * ta_xxz_yz_1[j];

                ta_xxxz_xzz_0[j] = pa_x[j] * ta_xxz_xzz_0[j] - pc_x[j] * ta_xxz_xzz_1[j] + fl1_fx * ta_xz_xzz_0[j] - fl1_fx * ta_xz_xzz_1[j] +
                                   0.5 * fl1_fx * ta_xxz_zz_0[j] - 0.5 * fl1_fx * ta_xxz_zz_1[j];
                ...
                ta_xxyy_xxx_0[j] = pa_x[j] * ta_xyy_xxx_0[j] - pc_x[j] * ta_xyy_xxx_1[j] + 0.5 * fl1_fx * ta_yy_xxx_0[j] -
                                   0.5 * fl1_fx * ta_yy_xxx_1[j] + 1.5 * fl1_fx * ta_xyy_xx_0[j] - 1.5 * fl1_fx * ta_xyy_xx_1[j];

                ta_xxyy_xxy_0[j] = pa_x[j] * ta_xyy_xxy_0[j] - pc_x[j] * ta_xyy_xxy_1[j] + 0.5 * fl1_fx * ta_yy_xxy_0[j] -
                                   0.5 * fl1_fx * ta_yy_xxy_1[j] + fl1_fx * ta_xyy_xy_0[j] - fl1_fx * ta_xyy_xy_1[j];

                ta_xxyy_xxz_0[j] = pa_x[j] * ta_xyy_xxz_0[j] - pc_x[j] * ta_xyy_xxz_1[j] + 0.5 * fl1_fx * ta_yy_xxz_0[j] -
                                   0.5 * fl1_fx * ta_yy_xxz_1[j] + fl1_fx * ta_xyy_xz_0[j] - fl1_fx * ta_xyy_xz_1[j];

                ta_xxyy_xyy_0[j] = pa_x[j] * ta_xyy_xyy_0[j] - pc_x[j] * ta_xyy_xyy_1[j] + 0.5 * fl1_fx * ta_yy_xyy_0[j] -
                                   0.5 * fl1_fx * ta_yy_xyy_1[j] + 0.5 * fl1_fx * ta_xyy_yy_0[j] - 0.5 * fl1_fx * ta_xyy_yy_1[j];

                ta_xxyy_xyz_0[j] = pa_x[j] * ta_xyy_xyz_0[j] - pc_x[j] * ta_xyy_xyz_1[j] + 0.5 * fl1_fx * ta_yy_xyz_0[j] -
                                   0.5 * fl1_fx * ta_yy_xyz_1[j] + 0.5 * fl1_fx * ta_xyy_yz_0[j] - 0.5 * fl1_fx * ta_xyy_yz_1[j];

                ta_xxyy_xzz_0[j] = pa_x[j] * ta_xyy_xzz_0[j] - pc_x[j] * ta_xyy_xzz_1[j] + 0.5 * fl1_fx * ta_yy_xzz_0[j] -
                                   0.5 * fl1_fx * ta_yy_xzz_1[j] + 0.5 * fl1_fx * ta_xyy_zz_0[j] - 0.5 * fl1_fx * ta_xyy_zz_1[j];

                ta_xxyy_yyy_0[j] =
                    pa_x[j] * ta_xyy_yyy_0[j] - pc_x[j] * ta_xyy_yyy_1[j] + 0.5 * fl1_fx * ta_yy_yyy_0[j] - 0.5 * fl1_fx * ta_yy_yyy_1[j];

                ta_xxyy_yyz_0[j] =
                    pa_x[j] * ta_xyy_yyz_0[j] - pc_x[j] * ta_xyy_yyz_1[j] + 0.5 * fl1_fx * ta_yy_yyz_0[j] - 0.5 * fl1_fx * ta_yy_yyz_1[j];

                ta_xxyy_yzz_0[j] =
                    pa_x[j] * ta_xyy_yzz_0[j] - pc_x[j] * ta_xyy_yzz_1[j] + 0.5 * fl1_fx * ta_yy_yzz_0[j] - 0.5 * fl1_fx * ta_yy_yzz_1[j];

                ta_xxyy_zzz_0[j] =
                    pa_x[j] * ta_xyy_zzz_0[j] - pc_x[j] * ta_xyy_zzz_1[j] + 0.5 * fl1_fx * ta_yy_zzz_0[j] - 0.5 * fl1_fx * ta_yy_zzz_1[j];

                ta_xxyz_xxx_0[j] = pa_x[j] * ta_xyz_xxx_0[j] - pc_x[j] * ta_xyz_xxx_1[j] + 0.5 * fl1_fx * ta_yz_xxx_0[j] -
                                   0.5 * fl1_fx * ta_yz_xxx_1[j] + 1.5 * fl1_fx * ta_xyz_xx_0[j] - 1.5 * fl1_fx * ta_xyz_xx_1[j];

                ta_xxyz_xxy_0[j] = pa_x[j] * ta_xyz_xxy_0[j] - pc_x[j] * ta_xyz_xxy_1[j] + 0.5 * fl1_fx * ta_yz_xxy_0[j] -
                                   0.5 * fl1_fx * ta_yz_xxy_1[j] + fl1_fx * ta_xyz_xy_0[j] - fl1_fx * ta_xyz_xy_1[j];

                ta_xxyz_xxz_0[j] = pa_x[j] * ta_xyz_xxz_0[j] - pc_x[j] * ta_xyz_xxz_1[j] + 0.5 * fl1_fx * ta_yz_xxz_0[j] -
                                   0.5 * fl1_fx * ta_yz_xxz_1[j] + fl1_fx * ta_xyz_xz_0[j] - fl1_fx * ta_xyz_xz_1[j];

                ta_xxyz_xyy_0[j] = pa_x[j] * ta_xyz_xyy_0[j] - pc_x[j] * ta_xyz_xyy_1[j] + 0.5 * fl1_fx * ta_yz_xyy_0[j] -
                                   0.5 * fl1_fx * ta_yz_xyy_1[j] + 0.5 * fl1_fx * ta_xyz_yy_0[j] - 0.5 * fl1_fx * ta_xyz_yy_1[j];

                ta_xxyz_xyz_0[j] = pa_x[j] * ta_xyz_xyz_0[j] - pc_x[j] * ta_xyz_xyz_1[j] + 0.5 * fl1_fx * ta_yz_xyz_0[j] -
                                   0.5 * fl1_fx * ta_yz_xyz_1[j] + 0.5 * fl1_fx * ta_xyz_yz_0[j] - 0.5 * fl1_fx * ta_xyz_yz_1[j];

                ta_xxyz_xzz_0[j] = pa_x[j] * ta_xyz_xzz_0[j] - pc_x[j] * ta_xyz_xzz_1[j] + 0.5 * fl1_fx * ta_yz_xzz_0[j] -
                                   0.5 * fl1_fx * ta_yz_xzz_1[j] + 0.5 * fl1_fx * ta_xyz_zz_0[j] - 0.5 * fl1_fx * ta_xyz_zz_1[j];

                ta_xxyz_yyy_0[j] =
                    pa_x[j] * ta_xyz_yyy_0[j] - pc_x[j] * ta_xyz_yyy_1[j] + 0.5 * fl1_fx * ta_yz_yyy_0[j] - 0.5 * fl1_fx * ta_yz_yyy_1[j];

                ta_xxyz_yyz_0[j] =
                    pa_x[j] * ta_xyz_yyz_0[j] - pc_x[j] * ta_xyz_yyz_1[j] + 0.5 * fl1_fx * ta_yz_yyz_0[j] - 0.5 * fl1_fx * ta_yz_yyz_1[j];

                ta_xxyz_yzz_0[j] =
                    pa_x[j] * ta_xyz_yzz_0[j] - pc_x[j] * ta_xyz_yzz_1[j] + 0.5 * fl1_fx * ta_yz_yzz_0[j] - 0.5 * fl1_fx * ta_yz_yzz_1[j];

                ta_xxyz_zzz_0[j] =
                    pa_x[j] * ta_xyz_zzz_0[j] - pc_x[j] * ta_xyz_zzz_1[j] + 0.5 * fl1_fx * ta_yz_zzz_0[j] - 0.5 * fl1_fx * ta_yz_zzz_1[j];
            }
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                ta_xxzz_xxx_0[j] = pa_x[j] * ta_xzz_xxx_0[j] - pc_x[j] * ta_xzz_xxx_1[j] + 0.5 * fl1_fx * ta_zz_xxx_0[j] -
                                   0.5 * fl1_fx * ta_zz_xxx_1[j] + 1.5 * fl1_fx * ta_xzz_xx_0[j] - 1.5 * fl1_fx * ta_xzz_xx_1[j];

                ta_xxzz_xxy_0[j] = pa_x[j] * ta_xzz_xxy_0[j] - pc_x[j] * ta_xzz_xxy_1[j] + 0.5 * fl1_fx * ta_zz_xxy_0[j] -
                                   0.5 * fl1_fx * ta_zz_xxy_1[j] + fl1_fx * ta_xzz_xy_0[j] - fl1_fx * ta_xzz_xy_1[j];

                ta_xxzz_xxz_0[j] = pa_x[j] * ta_xzz_xxz_0[j] - pc_x[j] * ta_xzz_xxz_1[j] + 0.5 * fl1_fx * ta_zz_xxz_0[j] -
                                   0.5 * fl1_fx * ta_zz_xxz_1[j] + fl1_fx * ta_xzz_xz_0[j] - fl1_fx * ta_xzz_xz_1[j];

                ta_xxzz_xyy_0[j] = pa_x[j] * ta_xzz_xyy_0[j] - pc_x[j] * ta_xzz_xyy_1[j] + 0.5 * fl1_fx * ta_zz_xyy_0[j] -
                                   0.5 * fl1_fx * ta_zz_xyy_1[j] + 0.5 * fl1_fx * ta_xzz_yy_0[j] - 0.5 * fl1_fx * ta_xzz_yy_1[j];

                ta_xxzz_xyz_0[j] = pa_x[j] * ta_xzz_xyz_0[j] - pc_x[j] * ta_xzz_xyz_1[j] + 0.5 * fl1_fx * ta_zz_xyz_0[j] -
                                   0.5 * fl1_fx * ta_zz_xyz_1[j] + 0.5 * fl1_fx * ta_xzz_yz_0[j] - 0.5 * fl1_fx * ta_xzz_yz_1[j];

                ta_xxzz_xzz_0[j] = pa_x[j] * ta_xzz_xzz_0[j] - pc_x[j] * ta_xzz_xzz_1[j] + 0.5 * fl1_fx * ta_zz_xzz_0[j] -
                                   0.5 * fl1_fx * ta_zz_xzz_1[j] + 0.5 * fl1_fx * ta_xzz_zz_0[j] - 0.5 * fl1_fx * ta_xzz_zz_1[j];

                ta_xxzz_yyy_0[j] =
                    pa_x[j] * ta_xzz_yyy_0[j] - pc_x[j] * ta_xzz_yyy_1[j] + 0.5 * fl1_fx * ta_zz_yyy_0[j] - 0.5 * fl1_fx * ta_zz_yyy_1[j];

                ta_xxzz_yyz_0[j] =
                    pa_x[j] * ta_xzz_yyz_0[j] - pc_x[j] * ta_xzz_yyz_1[j] + 0.5 * fl1_fx * ta_zz_yyz_0[j] - 0.5 * fl1_fx * ta_zz_yyz_1[j];

                ta_xxzz_yzz_0[j] =
                    pa_x[j] * ta_xzz_yzz_0[j] - pc_x[j] * ta_xzz_yzz_1[j] + 0.5 * fl1_fx * ta_zz_yzz_0[j] - 0.5 * fl1_fx * ta_zz_yzz_1[j];

                ta_xxzz_zzz_0[j] =
                    pa_x[j] * ta_xzz_zzz_0[j] - pc_x[j] * ta_xzz_zzz_1[j] + 0.5 * fl1_fx * ta_zz_zzz_0[j] - 0.5 * fl1_fx * ta_zz_zzz_1[j];

                ta_xyyy_xxx_0[j] =
                    pa_x[j] * ta_yyy_xxx_0[j] - pc_x[j] * ta_yyy_xxx_1[j] + 1.5 * fl1_fx * ta_yyy_xx_0[j] - 1.5 * fl1_fx * ta_yyy_xx_1[j];
                ...
                ta_xyyy_xyy_0[j] =
                    pa_x[j] * ta_yyy_xyy_0[j] - pc_x[j] * ta_yyy_xyy_1[j] + 0.5 * fl1_fx * ta_yyy_yy_0[j] - 0.5 * fl1_fx * ta_yyy_yy_1[j];

                ta_xyyy_xyz_0[j] =
                    pa_x[j] * ta_yyy_xyz_0[j] - pc_x[j] * ta_yyy_xyz_1[j] + 0.5 * fl1_fx * ta_yyy_yz_0[j] - 0.5 * fl1_fx * ta_yyy_yz_1[j];

                ta_xyyy_xzz_0[j] =
                    pa_x[j] * ta_yyy_xzz_0[j] - pc_x[j] * ta_yyy_xzz_1[j] + 0.5 * fl1_fx * ta_yyy_zz_0[j] - 0.5 * fl1_fx * ta_yyy_zz_1[j];
                ...
                ta_xyyz_xxx_0[j] =
                    pa_x[j] * ta_yyz_xxx_0[j] - pc_x[j] * ta_yyz_xxx_1[j] + 1.5 * fl1_fx * ta_yyz_xx_0[j] - 1.5 * fl1_fx * ta_yyz_xx_1[j];
                ...
                ta_xyyz_xyy_0[j] =
                    pa_x[j] * ta_yyz_xyy_0[j] - pc_x[j] * ta_yyz_xyy_1[j] + 0.5 * fl1_fx * ta_yyz_yy_0[j] - 0.5 * fl1_fx * ta_yyz_yy_1[j];

                ta_xyyz_xyz_0[j] =
                    pa_x[j] * ta_yyz_xyz_0[j] - pc_x[j] * ta_yyz_xyz_1[j] + 0.5 * fl1_fx * ta_yyz_yz_0[j] - 0.5 * fl1_fx * ta_yyz_yz_1[j];

                ta_xyyz_xzz_0[j] =
                    pa_x[j] * ta_yyz_xzz_0[j] - pc_x[j] * ta_yyz_xzz_1[j] + 0.5 * fl1_fx * ta_yyz_zz_0[j] - 0.5 * fl1_fx * ta_yyz_zz_1[j];
                ...
                ta_xyzz_xxx_0[j] =
                    pa_x[j] * ta_yzz_xxx_0[j] - pc_x[j] * ta_yzz_xxx_1[j] + 1.5 * fl1_fx * ta_yzz_xx_0[j] - 1.5 * fl1_fx * ta_yzz_xx_1[j];
                ...
                ta_xyzz_xyy_0[j] =
                    pa_x[j] * ta_yzz_xyy_0[j] - pc_x[j] * ta_yzz_xyy_1[j] + 0.5 * fl1_fx * ta_yzz_yy_0[j] - 0.5 * fl1_fx * ta_yzz_yy_1[j];

                ta_xyzz_xyz_0[j] =
                    pa_x[j] * ta_yzz_xyz_0[j] - pc_x[j] * ta_yzz_xyz_1[j] + 0.5 * fl1_fx * ta_yzz_yz_0[j] - 0.5 * fl1_fx * ta_yzz_yz_1[j];

                ta_xyzz_xzz_0[j] =
                    pa_x[j] * ta_yzz_xzz_0[j] - pc_x[j] * ta_yzz_xzz_1[j] + 0.5 * fl1_fx * ta_yzz_zz_0[j] - 0.5 * fl1_fx * ta_yzz_zz_1[j];
                ...
                ta_xzzz_xxx_0[j] =
                    pa_x[j] * ta_zzz_xxx_0[j] - pc_x[j] * ta_zzz_xxx_1[j] + 1.5 * fl1_fx * ta_zzz_xx_0[j] - 1.5 * fl1_fx * ta_zzz_xx_1[j];
                ...
                ta_xzzz_xyy_0[j] =
                    pa_x[j] * ta_zzz_xyy_0[j] - pc_x[j] * ta_zzz_xyy_1[j] + 0.5 * fl1_fx * ta_zzz_yy_0[j] - 0.5 * fl1_fx * ta_zzz_yy_1[j];

                ta_xzzz_xyz_0[j] =
                    pa_x[j] * ta_zzz_xyz_0[j] - pc_x[j] * ta_zzz_xyz_1[j] + 0.5 * fl1_fx * ta_zzz_yz_0[j] - 0.5 * fl1_fx * ta_zzz_yz_1[j];

                ta_xzzz_xzz_0[j] =
                    pa_x[j] * ta_zzz_xzz_0[j] - pc_x[j] * ta_zzz_xzz_1[j] + 0.5 * fl1_fx * ta_zzz_zz_0[j] - 0.5 * fl1_fx * ta_zzz_zz_1[j];
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                ta_yyyy_xxx_0[j] =
                    pa_y[j] * ta_yyy_xxx_0[j] - pc_y[j] * ta_yyy_xxx_1[j] + 1.5 * fl1_fx * ta_yy_xxx_0[j] - 1.5 * fl1_fx * ta_yy_xxx_1[j];

                ta_yyyy_xxy_0[j] = pa_y[j] * ta_yyy_xxy_0[j] - pc_y[j] * ta_yyy_xxy_1[j] + 1.5 * fl1_fx * ta_yy_xxy_0[j] -
                                   1.5 * fl1_fx * ta_yy_xxy_1[j] + 0.5 * fl1_fx * ta_yyy_xx_0[j] - 0.5 * fl1_fx * ta_yyy_xx_1[j];

                ta_yyyy_xxz_0[j] =
                    pa_y[j] * ta_yyy_xxz_0[j] - pc_y[j] * ta_yyy_xxz_1[j] + 1.5 * fl1_fx * ta_yy_xxz_0[j] - 1.5 * fl1_fx * ta_yy_xxz_1[j];

                ta_yyyy_xyy_0[j] = pa_y[j] * ta_yyy_xyy_0[j] - pc_y[j] * ta_yyy_xyy_1[j] + 1.5 * fl1_fx * ta_yy_xyy_0[j] -
                                   1.5 * fl1_fx * ta_yy_xyy_1[j] + fl1_fx * ta_yyy_xy_0[j] - fl1_fx * ta_yyy_xy_1[j];

                ta_yyyy_xyz_0[j] = pa_y[j] * ta_yyy_xyz_0[j] - pc_y[j] * ta_yyy_xyz_1[j] + 1.5 * fl1_fx * ta_yy_xyz_0[j] -
                                   1.5 * fl1_fx * ta_yy_xyz_1[j] + 0.5 * fl1_fx * ta_yyy_xz_0[j] - 0.5 * fl1_fx * ta_yyy_xz_1[j];

                ta_yyyy_xzz_0[j] =
                    pa_y[j] * ta_yyy_xzz_0[j] - pc_y[j] * ta_yyy_xzz_1[j] + 1.5 * fl1_fx * ta_yy_xzz_0[j] - 1.5 * fl1_fx * ta_yy_xzz_1[j];

                ta_yyyy_yyy_0[j] = pa_y[j] * ta_yyy_yyy_0[j] - pc_y[j] * ta_yyy_yyy_1[j] + 1.5 * fl1_fx * ta_yy_yyy_0[j] -
                                   1.5 * fl1_fx * ta_yy_yyy_1[j] + 1.5 * fl1_fx * ta_yyy_yy_0[j] - 1.5 * fl1_fx * ta_yyy_yy_1[j];

                ta_yyyy_yyz_0[j] = pa_y[j] * ta_yyy_yyz_0[j] - pc_y[j] * ta_yyy_yyz_1[j] + 1.5 * fl1_fx * ta_yy_yyz_0[j] -
                                   1.5 * fl1_fx * ta_yy_yyz_1[j] + fl1_fx * ta_yyy_yz_0[j] - fl1_fx * ta_yyy_yz_1[j];

                ta_yyyy_yzz_0[j] = pa_y[j] * ta_yyy_yzz_0[j] - pc_y[j] * ta_yyy_yzz_1[j] + 1.5 * fl1_fx * ta_yy_yzz_0[j] -
                                   1.5 * fl1_fx * ta_yy_yzz_1[j] + 0.5 * fl1_fx * ta_yyy_zz_0[j] - 0.5 * fl1_fx * ta_yyy_zz_1[j];

                ta_yyyy_zzz_0[j] =
                    pa_y[j] * ta_yyy_zzz_0[j] - pc_y[j] * ta_yyy_zzz_1[j] + 1.5 * fl1_fx * ta_yy_zzz_0[j] - 1.5 * fl1_fx * ta_yy_zzz_1[j];

                ta_yyyz_xxx_0[j] = pa_y[j] * ta_yyz_xxx_0[j] - pc_y[j] * ta_yyz_xxx_1[j] + fl1_fx * ta_yz_xxx_0[j] - fl1_fx * ta_yz_xxx_1[j];

                ta_yyyz_xxy_0[j] = pa_y[j] * ta_yyz_xxy_0[j] - pc_y[j] * ta_yyz_xxy_1[j] + fl1_fx * ta_yz_xxy_0[j] - fl1_fx * ta_yz_xxy_1[j] +
                                   0.5 * fl1_fx * ta_yyz_xx_0[j] - 0.5 * fl1_fx * ta_yyz_xx_1[j];

                ta_yyyz_xxz_0[j] = pa_y[j] * ta_yyz_xxz_0[j] - pc_y[j] * ta_yyz_xxz_1[j] + fl1_fx * ta_yz_xxz_0[j] - fl1_fx * ta_yz_xxz_1[j];

                ta_yyyz_xyy_0[j] = pa_y[j] * ta_yyz_xyy_0[j] - pc_y[j] * ta_yyz_xyy_1[j] + fl1_fx * ta_yz_xyy_0[j] - fl1_fx * ta_yz_xyy_1[j] +
                                   fl1_fx * ta_yyz_xy_0[j] - fl1_fx * ta_yyz_xy_1[j];

                ta_yyyz_xyz_0[j] = pa_y[j] * ta_yyz_xyz_0[j] - pc_y[j] * ta_yyz_xyz_1[j] + fl1_fx * ta_yz_xyz_0[j] - fl1_fx * ta_yz_xyz_1[j] +
                                   0.5 * fl1_fx * ta_yyz_xz_0[j] - 0.5 * fl1_fx * ta_yyz_xz_1[j];

                ta_yyyz_xzz_0[j] = pa_y[j] * ta_yyz_xzz_0[j] - pc_y[j] * ta_yyz_xzz_1[j] + fl1_fx * ta_yz_xzz_0[j] - fl1_fx * ta_yz_xzz_1[j];

                ta_yyyz_yyy_0[j] = pa_y[j] * ta_yyz_yyy_0[j] - pc_y[j] * ta_yyz_yyy_1[j] + fl1_fx * ta_yz_yyy_0[j] - fl1_fx * ta_yz_yyy_1[j] +
                                   1.5 * fl1_fx * ta_yyz_yy_0[j] - 1.5 * fl1_fx * ta_yyz_yy_1[j];

                ta_yyyz_yyz_0[j] = pa_y[j] * ta_yyz_yyz_0[j] - pc_y[j] * ta_yyz_yyz_1[j] + fl1_fx * ta_yz_yyz_0[j] - fl1_fx * ta_yz_yyz_1[j] +
                                   fl1_fx * ta_yyz_yz_0[j] - fl1_fx * ta_yyz_yz_1[j];

                ta_yyyz_yzz_0[j] = pa_y[j] * ta_yyz_yzz_0[j] - pc_y[j] * ta_yyz_yzz_1[j] + fl1_fx * ta_yz_yzz_0[j] - fl1_fx * ta_yz_yzz_1[j] +
                                   0.5 * fl1_fx * ta_yyz_zz_0[j] - 0.5 * fl1_fx * ta_yyz_zz_1[j];

                ta_yyyz_zzz_0[j] = pa_y[j] * ta_yyz_zzz_0[j] - pc_y[j] * ta_yyz_zzz_1[j] + fl1_fx * ta_yz_zzz_0[j] - fl1_fx * ta_yz_zzz_1[j];

                ta_yyzz_xxx_0[j] =
                    pa_y[j] * ta_yzz_xxx_0[j] - pc_y[j] * ta_yzz_xxx_1[j] + 0.5 * fl1_fx * ta_zz_xxx_0[j] - 0.5 * fl1_fx * ta_zz_xxx_1[j];

                ta_yyzz_xxy_0[j] = pa_y[j] * ta_yzz_xxy_0[j] - pc_y[j] * ta_yzz_xxy_1[j] + 0.5 * fl1_fx * ta_zz_xxy_0[j] -
                                   0.5 * fl1_fx * ta_zz_xxy_1[j] + 0.5 * fl1_fx * ta_yzz_xx_0[j] - 0.5 * fl1_fx * ta_yzz_xx_1[j];

                ta_yyzz_xxz_0[j] =
                    pa_y[j] * ta_yzz_xxz_0[j] - pc_y[j] * ta_yzz_xxz_1[j] + 0.5 * fl1_fx * ta_zz_xxz_0[j] - 0.5 * fl1_fx * ta_zz_xxz_1[j];

                ta_yyzz_xyy_0[j] = pa_y[j] * ta_yzz_xyy_0[j] - pc_y[j] * ta_yzz_xyy_1[j] + 0.5 * fl1_fx * ta_zz_xyy_0[j] -
                                   0.5 * fl1_fx * ta_zz_xyy_1[j] + fl1_fx * ta_yzz_xy_0[j] - fl1_fx * ta_yzz_xy_1[j];

                ta_yyzz_xyz_0[j] = pa_y[j] * ta_yzz_xyz_0[j] - pc_y[j] * ta_yzz_xyz_1[j] + 0.5 * fl1_fx * ta_zz_xyz_0[j] -
                                   0.5 * fl1_fx * ta_zz_xyz_1[j] + 0.5 * fl1_fx * ta_yzz_xz_0[j] - 0.5 * fl1_fx * ta_yzz_xz_1[j];

                ta_yyzz_xzz_0[j] =
                    pa_y[j] * ta_yzz_xzz_0[j] - pc_y[j] * ta_yzz_xzz_1[j] + 0.5 * fl1_fx * ta_zz_xzz_0[j] - 0.5 * fl1_fx * ta_zz_xzz_1[j];

                ta_yyzz_yyy_0[j] = pa_y[j] * ta_yzz_yyy_0[j] - pc_y[j] * ta_yzz_yyy_1[j] + 0.5 * fl1_fx * ta_zz_yyy_0[j] -
                                   0.5 * fl1_fx * ta_zz_yyy_1[j] + 1.5 * fl1_fx * ta_yzz_yy_0[j] - 1.5 * fl1_fx * ta_yzz_yy_1[j];

                ta_yyzz_yyz_0[j] = pa_y[j] * ta_yzz_yyz_0[j] - pc_y[j] * ta_yzz_yyz_1[j] + 0.5 * fl1_fx * ta_zz_yyz_0[j] -
                                   0.5 * fl1_fx * ta_zz_yyz_1[j] + fl1_fx * ta_yzz_yz_0[j] - fl1_fx * ta_yzz_yz_1[j];

                ta_yyzz_yzz_0[j] = pa_y[j] * ta_yzz_yzz_0[j] - pc_y[j] * ta_yzz_yzz_1[j] + 0.5 * fl1_fx * ta_zz_yzz_0[j] -
                                   0.5 * fl1_fx * ta_zz_yzz_1[j] + 0.5 * fl1_fx * ta_yzz_zz_0[j] - 0.5 * fl1_fx * ta_yzz_zz_1[j];

                ta_yyzz_zzz_0[j] =
                    pa_y[j] * ta_yzz_zzz_0[j] - pc_y[j] * ta_yzz_zzz_1[j] + 0.5 * fl1_fx * ta_zz_zzz_0[j] - 0.5 * fl1_fx * ta_zz_zzz_1[j];

                ta_yzzz_xxx_0[j] = pa_y[j] * ta_zzz_xxx_0[j] - pc_y[j] * ta_zzz_xxx_1[j];

                ta_yzzz_xxy_0[j] =
                    pa_y[j] * ta_zzz_xxy_0[j] - pc_y[j] * ta_zzz_xxy_1[j] + 0.5 * fl1_fx * ta_zzz_xx_0[j] - 0.5 * fl1_fx * ta_zzz_xx_1[j];
                ...
                ta_yzzz_xyz_0[j] =
                    pa_y[j] * ta_zzz_xyz_0[j] - pc_y[j] * ta_zzz_xyz_1[j] + 0.5 * fl1_fx * ta_zzz_xz_0[j] - 0.5 * fl1_fx * ta_zzz_xz_1[j];

                ta_yzzz_xzz_0[j] = pa_y[j] * ta_zzz_xzz_0[j] - pc_y[j] * ta_zzz_xzz_1[j];

                ta_yzzz_yyy_0[j] =
                    pa_y[j] * ta_zzz_yyy_0[j] - pc_y[j] * ta_zzz_yyy_1[j] + 1.5 * fl1_fx * ta_zzz_yy_0[j] - 1.5 * fl1_fx * ta_zzz_yy_1[j];

                ta_yzzz_yyz_0[j] = pa_y[j] * ta_zzz_yyz_0[j] - pc_y[j] * ta_zzz_yyz_1[j] + fl1_fx * ta_zzz_yz_0[j] - fl1_fx * ta_zzz_yz_1[j];

                ta_yzzz_yzz_0[j] =
                    pa_y[j] * ta_zzz_yzz_0[j] - pc_y[j] * ta_zzz_yzz_1[j] + 0.5 * fl1_fx * ta_zzz_zz_0[j] - 0.5 * fl1_fx * ta_zzz_zz_1[j];

                ta_yzzz_zzz_0[j] = pa_y[j] * ta_zzz_zzz_0[j] - pc_y[j] * ta_zzz_zzz_1[j];

                ta_zzzz_xxx_0[j] =
                    pa_z[j] * ta_zzz_xxx_0[j] - pc_z[j] * ta_zzz_xxx_1[j] + 1.5 * fl1_fx * ta_zz_xxx_0[j] - 1.5 * fl1_fx * ta_zz_xxx_1[j];

                ta_zzzz_xxy_0[j] =
                    pa_z[j] * ta_zzz_xxy_0[j] - pc_z[j] * ta_zzz_xxy_1[j] + 1.5 * fl1_fx * ta_zz_xxy_0[j] - 1.5 * fl1_fx * ta_zz_xxy_1[j];

                ta_zzzz_xxz_0[j] = pa_z[j] * ta_zzz_xxz_0[j] - pc_z[j] * ta_zzz_xxz_1[j] + 1.5 * fl1_fx * ta_zz_xxz_0[j] -
                                   1.5 * fl1_fx * ta_zz_xxz_1[j] + 0.5 * fl1_fx * ta_zzz_xx_0[j] - 0.5 * fl1_fx * ta_zzz_xx_1[j];

                ta_zzzz_xyy_0[j] =
                    pa_z[j] * ta_zzz_xyy_0[j] - pc_z[j] * ta_zzz_xyy_1[j] + 1.5 * fl1_fx * ta_zz_xyy_0[j] - 1.5 * fl1_fx * ta_zz_xyy_1[j];

                ta_zzzz_xyz_0[j] = pa_z[j] * ta_zzz_xyz_0[j] - pc_z[j] * ta_zzz_xyz_1[j] + 1.5 * fl1_fx * ta_zz_xyz_0[j] -
                                   1.5 * fl1_fx * ta_zz_xyz_1[j] + 0.5 * fl1_fx * ta_zzz_xy_0[j] - 0.5 * fl1_fx * ta_zzz_xy_1[j];

                ta_zzzz_xzz_0[j] = pa_z[j] * ta_zzz_xzz_0[j] - pc_z[j] * ta_zzz_xzz_1[j] + 1.5 * fl1_fx * ta_zz_xzz_0[j] -
                                   1.5 * fl1_fx * ta_zz_xzz_1[j] + fl1_fx * ta_zzz_xz_0[j] - fl1_fx * ta_zzz_xz_1[j];

                ta_zzzz_yyy_0[j] =
                    pa_z[j] * ta_zzz_yyy_0[j] - pc_z[j] * ta_zzz_yyy_1[j] + 1.5 * fl1_fx * ta_zz_yyy_0[j] - 1.5 * fl1_fx * ta_zz_yyy_1[j];

                ta_zzzz_yyz_0[j] = pa_z[j] * ta_zzz_yyz_0[j] - pc_z[j] * ta_zzz_yyz_1[j] + 1.5 * fl1_fx * ta_zz_yyz_0[j] -
                                   1.5 * fl1_fx * ta_zz_yyz_1[j] + 0.5 * fl1_fx * ta_zzz_yy_0[j] - 0.5 * fl1_fx * ta_zzz_yy_1[j];

                ta_zzzz_yzz_0[j] = pa_z[j] * ta_zzz_yzz_0[j] - pc_z[j] * ta_zzz_yzz_1[j] + 1.5 * fl1_fx * ta_zz_yzz_0[j] -
                                   1.5 * fl1_fx * ta_zz_yzz_1[j] + fl1_fx * ta_zzz_yz_0[j] - fl1_fx * ta_zzz_yz_1[j];

                ta_zzzz_zzz_0[j] = pa_z[j] * ta_zzz_zzz_0[j] - pc_z[j] * ta_zzz_zzz_1[j] + 1.5 * fl1_fx * ta_zz_zzz_0[j] -
                                   1.5 * fl1_fx * ta_zz_zzz_1[j] + 1.5 * fl1_fx * ta_zzz_zz_0[j] - 1.5 * fl1_fx * ta_zzz_zz_1[j];
            }
