...
{
    efieldrecfunc::compElectricFieldForDD_0_36(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    efieldrecfunc::compElectricFieldForDD_36_72(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    efieldrecfunc::compElectricFieldForDD_72_108(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
                            ...
                            const int32_t              iContrGto)
{
    ...
    auto mord = recursionMap.getMaxOrder({"Electric Field"}, {2, -1, -1, -1}, {2, -1, -1, -1}, 1, 1);

    for (int32_t iord = 0; iord <= mord; iord++)
    {
        // set up index of integral

        auto pidx_e_2_2_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Electric Field"}, 1, true, {2, -1, -1, -1}, {2, -1, -1, -1}, 1, 1, iord));
        ...
        auto pidx_e_1_2_m1 =
            recursionMap.getIndexOfTerm(CRecursionTerm({"Electric Field"}, 1, true, {1, -1, -1, -1}, {2, -1, -1, -1}, 1, 1, iord + 1));
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tex_xx_xx_0[j] = pa_x[j] * tex_x_xx_0[j] - pc_x[j] * tex_x_xx_1[j] + 0.5 * fl1_fx * tex_0_xx_0[j] - 0.5 * fl1_fx * tex_0_xx_1[j] +
                                 fl1_fx * tex_x_x_0[j] - fl1_fx * tex_x_x_1[j] + ta_x_xx_1[j];

                tey_xx_xx_0[j] = pa_x[j] * tey_x_xx_0[j] - pc_x[j] * tey_x_xx_1[j] + 0.5 * fl1_fx * tey_0_xx_0[j] - 0.5 * fl1_fx * tey_0_xx_1[j] +
                                 fl1_fx * tey_x_x_0[j] - fl1_fx * tey_x_x_1[j];

                tez_xx_xx_0[j] = pa_x[j] * tez_x_xx_0[j] - pc_x[j] * tez_x_xx_1[j] + 0.5 * fl1_fx * tez_0_xx_0[j] - 0.5 * fl1_fx * tez_0_xx_1[j] +
                                 fl1_fx * tez_x_x_0[j] - fl1_fx * tez_x_x_1[j];

                tex_xx_xy_0[j] = pa_x[j] * tex_x_xy_0[j] - pc_x[j] * tex_x_xy_1[j] + 0.5 * fl1_fx * tex_0_xy_0[j] - 0.5 * fl1_fx * tex_0_xy_1[j] +
                                 0.5 * fl1_fx * tex_x_y_0[j] - 0.5 * fl1_fx * tex_x_y_1[j] + ta_x_xy_1[j];

                tey_xx_xy_0[j] = pa_x[j] * tey_x_xy_0[j] - pc_x[j] * tey_x_xy_1[j] + 0.5 * fl1_fx * tey_0_xy_0[j] - 0.5 * fl1_fx * tey_0_xy_1[j] +
                                 0.5 * fl1_fx * tey_x_y_0[j] - 0.5 * fl1_fx * tey_x_y_1[j];

                tez_xx_xy_0[j] = pa_x[j] * tez_x_xy_0[j] - pc_x[j] * tez_x_xy_1[j] + 0.5 * fl1_fx * tez_0_xy_0[j] - 0.5 * fl1_fx * tez_0_xy_1[j] +
                                 0.5 * fl1_fx * tez_x_y_0[j] - 0.5 * fl1_fx * tez_x_y_1[j];

                tex_xx_xz_0[j] = pa_x[j] * tex_x_xz_0[j] - pc_x[j] * tex_x_xz_1[j] + 0.5 * fl1_fx * tex_0_xz_0[j] - 0.5 * fl1_fx * tex_0_xz_1[j] +
                                 0.5 * fl1_fx * tex_x_z_0[j] - 0.5 * fl1_fx * tex_x_z_1[j] + ta_x_xz_1[j];

                tey_xx_xz_0[j] = pa_x[j] * tey_x_xz_0[j] - pc_x[j] * tey_x_xz_1[j] + 0.5 * fl1_fx * tey_0_xz_0[j] - 0.5 * fl1_fx * tey_0_xz_1[j] +
                                 0.5 * fl1_fx * tey_x_z_0[j] - 0.5 * fl1_fx * tey_x_z_1[j];

                tez_xx_xz_0[j] = pa_x[j] * tez_x_xz_0[j] - pc_x[j] * tez_x_xz_1[j] + 0.5 * fl1_fx * tez_0_xz_0[j] - 0.5 * fl1_fx * tez_0_xz_1[j] +
                                 0.5 * fl1_fx * tez_x_z_0[j] - 0.5 * fl1_fx * tez_x_z_1[j];

                tex_xx_yy_0[j] =
                    pa_x[j] * tex_x_yy_0[j] - pc_x[j] * tex_x_yy_1[j] + 0.5 * fl1_fx * tex_0_yy_0[j] - 0.5 * fl1_fx * tex_0_yy_1[j] + ta_x_yy_1[j];
                ...
                tex_xx_yz_0[j] =
                    pa_x[j] * tex_x_yz_0[j] - pc_x[j] * tex_x_yz_1[j] + 0.5 * fl1_fx * tex_0_yz_0[j] - 0.5 * fl1_fx * tex_0_yz_1[j] + ta_x_yz_1[j];
                ...
                tex_xx_zz_0[j] =
                    pa_x[j] * tex_x_zz_0[j] - pc_x[j] * tex_x_zz_1[j] + 0.5 * fl1_fx * tex_0_zz_0[j] - 0.5 * fl1_fx * tex_0_zz_1[j] + ta_x_zz_1[j];
                ...
                tex_xy_xy_0[j] =
                    pa_x[j] * tex_y_xy_0[j] - pc_x[j] * tex_y_xy_1[j] + 0.5 * fl1_fx * tex_y_y_0[j] - 0.5 * fl1_fx * tex_y_y_1[j] + ta_y_xy_1[j];
                ...
                tex_xy_xz_0[j] =
                    pa_x[j] * tex_y_xz_0[j] - pc_x[j] * tex_y_xz_1[j] + 0.5 * fl1_fx * tex_y_z_0[j] - 0.5 * fl1_fx * tex_y_z_1[j] + ta_y_xz_1[j];
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tex_xz_xy_0[j] =
                    pa_x[j] * tex_z_xy_0[j] - pc_x[j] * tex_z_xy_1[j] + 0.5 * fl1_fx * tex_z_y_0[j] - 0.5 * fl1_fx * tex_z_y_1[j] + ta_z_xy_1[j];
                ...
                tex_xz_xz_0[j] =
                    pa_x[j] * tex_z_xz_0[j] - pc_x[j] * tex_z_xz_1[j] + 0.5 * fl1_fx * tex_z_z_0[j] - 0.5 * fl1_fx * tex_z_z_1[j] + ta_z_xz_1[j];
                ...
                tey_yy_xx_0[j] =
                    pa_y[j] * tey_y_xx_0[j] - pc_y[j] * tey_y_xx_1[j] + 0.5 * fl1_fx * tey_0_xx_0[j] - 0.5 * fl1_fx * tey_0_xx_1[j] + ta_y_xx_1[j];

                tez_yy_xx_0[j] = pa_y[j] * tez_y_xx_0[j] - pc_y[j] * tez_y_xx_1[j] + 0.5 * fl1_fx * tez_0_xx_0[j] - 0.5 * fl1_fx * tez_0_xx_1[j];

                tex_yy_xy_0[j] = pa_y[j] * tex_y_xy_0[j] - pc_y[j] * tex_y_xy_1[j] + 0.5 * fl1_fx * tex_0_xy_0[j] - 0.5 * fl1_fx * tex_0_xy_1[j] +
                                 0.5 * fl1_fx * tex_y_x_0[j] - 0.5 * fl1_fx * tex_y_x_1[j];

                tey_yy_xy_0[j] = pa_y[j] * tey_y_xy_0[j] - pc_y[j] * tey_y_xy_1[j] + 0.5 * fl1_fx * tey_0_xy_0[j] - 0.5 * fl1_fx * tey_0_xy_1[j] +
                                 0.5 * fl1_fx * tey_y_x_0[j] - 0.5 * fl1_fx * tey_y_x_1[j] + ta_y_xy_1[j];

                tez_yy_xy_0[j] = pa_y[j] * tez_y_xy_0[j] - pc_y[j] * tez_y_xy_1[j] + 0.5 * fl1_fx * tez_0_xy_0[j] - 0.5 * fl1_fx * tez_0_xy_1[j] +
                                 0.5 * fl1_fx * tez_y_x_0[j] - 0.5 * fl1_fx * tez_y_x_1[j];

                tex_yy_xz_0[j] = pa_y[j] * tex_y_xz_0[j] - pc_y[j] * tex_y_xz_1[j] + 0.5 * fl1_fx * tex_0_xz_0[j] - 0.5 * fl1_fx * tex_0_xz_1[j];

                tey_yy_xz_0[j] =
                    pa_y[j] * tey_y_xz_0[j] - pc_y[j] * tey_y_xz_1[j] + 0.5 * fl1_fx * tey_0_xz_0[j] - 0.5 * fl1_fx * tey_0_xz_1[j] + ta_y_xz_1[j];

                tez_yy_xz_0[j] = pa_y[j] * tez_y_xz_0[j] - pc_y[j] * tez_y_xz_1[j] + 0.5 * fl1_fx * tez_0_xz_0[j] - 0.5 * fl1_fx * tez_0_xz_1[j];

                tex_yy_yy_0[j] = pa_y[j] * tex_y_yy_0[j] - pc_y[j] * tex_y_yy_1[j] + 0.5 * fl1_fx * tex_0_yy_0[j] - 0.5 * fl1_fx * tex_0_yy_1[j] +
                                 fl1_fx * tex_y_y_0[j] - fl1_fx * tex_y_y_1[j];

                tey_yy_yy_0[j] = pa_y[j] * tey_y_yy_0[j] - pc_y[j] * tey_y_yy_1[j] + 0.5 * fl1_fx * tey_0_yy_0[j] - 0.5 * fl1_fx * tey_0_yy_1[j] +
                                 fl1_fx * tey_y_y_0[j] - fl1_fx * tey_y_y_1[j] + ta_y_yy_1[j];

                tez_yy_yy_0[j] = pa_y[j] * tez_y_yy_0[j] - pc_y[j] * tez_y_yy_1[j] + 0.5 * fl1_fx * tez_0_yy_0[j] - 0.5 * fl1_fx * tez_0_yy_1[j] +
                                 fl1_fx * tez_y_y_0[j] - fl1_fx * tez_y_y_1[j];

                tex_yy_yz_0[j] = pa_y[j] * tex_y_yz_0[j] - pc_y[j] * tex_y_yz_1[j] + 0.5 * fl1_fx * tex_0_yz_0[j] - 0.5 * fl1_fx * tex_0_yz_1[j] +
                                 0.5 * fl1_fx * tex_y_z_0[j] - 0.5 * fl1_fx * tex_y_z_1[j];

                tey_yy_yz_0[j] = pa_y[j] * tey_y_yz_0[j] - pc_y[j] * tey_y_yz_1[j] + 0.5 * fl1_fx * tey_0_yz_0[j] - 0.5 * fl1_fx * tey_0_yz_1[j] +
                                 0.5 * fl1_fx * tey_y_z_0[j] - 0.5 * fl1_fx * tey_y_z_1[j] + ta_y_yz_1[j];

                tez_yy_yz_0[j] = pa_y[j] * tez_y_yz_0[j] - pc_y[j] * tez_y_yz_1[j] + 0.5 * fl1_fx * tez_0_yz_0[j] - 0.5 * fl1_fx * tez_0_yz_1[j] +
                                 0.5 * fl1_fx * tez_y_z_0[j] - 0.5 * fl1_fx * tez_y_z_1[j];

                tex_yy_zz_0[j] = pa_y[j] * tex_y_zz_0[j] - pc_y[j] * tex_y_zz_1[j] + 0.5 * fl1_fx * tex_0_zz_0[j] - 0.5 * fl1_fx * tex_0_zz_1[j];

                tey_yy_zz_0[j] =
                    pa_y[j] * tey_y_zz_0[j] - pc_y[j] * tey_y_zz_1[j] + 0.5 * fl1_fx * tey_0_zz_0[j] - 0.5 * fl1_fx * tey_0_zz_1[j] + ta_y_zz_1[j];
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tey_yz_xy_0[j] =
                    pa_y[j] * tey_z_xy_0[j] - pc_y[j] * tey_z_xy_1[j] + 0.5 * fl1_fx * tey_z_x_0[j] - 0.5 * fl1_fx * tey_z_x_1[j] + ta_z_xy_1[j];
                ...
                tey_yz_yz_0[j] =
                    pa_y[j] * tey_z_yz_0[j] - pc_y[j] * tey_z_yz_1[j] + 0.5 * fl1_fx * tey_z_z_0[j] - 0.5 * fl1_fx * tey_z_z_1[j] + ta_z_yz_1[j];
                ...
                tez_zz_xx_0[j] =
                    pa_z[j] * tez_z_xx_0[j] - pc_z[j] * tez_z_xx_1[j] + 0.5 * fl1_fx * tez_0_xx_0[j] - 0.5 * fl1_fx * tez_0_xx_1[j] + ta_z_xx_1[j];
                ...
                tez_zz_xy_0[j] =
                    pa_z[j] * tez_z_xy_0[j] - pc_z[j] * tez_z_xy_1[j] + 0.5 * fl1_fx * tez_0_xy_0[j] - 0.5 * fl1_fx * tez_0_xy_1[j] + ta_z_xy_1[j];

                tex_zz_xz_0[j] = pa_z[j] * tex_z_xz_0[j] - pc_z[j] * tex_z_xz_1[j] + 0.5 * fl1_fx * tex_0_xz_0[j] - 0.5 * fl1_fx * tex_0_xz_1[j] +
                                 0.5 * fl1_fx * tex_z_x_0[j] - 0.5 * fl1_fx * tex_z_x_1[j];

                tey_zz_xz_0[j] = pa_z[j] * tey_z_xz_0[j] - pc_z[j] * tey_z_xz_1[j] + 0.5 * fl1_fx * tey_0_xz_0[j] - 0.5 * fl1_fx * tey_0_xz_1[j] +
                                 0.5 * fl1_fx * tey_z_x_0[j] - 0.5 * fl1_fx * tey_z_x_1[j];

                tez_zz_xz_0[j] = pa_z[j] * tez_z_xz_0[j] - pc_z[j] * tez_z_xz_1[j] + 0.5 * fl1_fx * tez_0_xz_0[j] - 0.5 * fl1_fx * tez_0_xz_1[j] +
                                 0.5 * fl1_fx * tez_z_x_0[j] - 0.5 * fl1_fx * tez_z_x_1[j] + ta_z_xz_1[j];
                ...
                tez_zz_yy_0[j] =
                    pa_z[j] * tez_z_yy_0[j] - pc_z[j] * tez_z_yy_1[j] + 0.5 * fl1_fx * tez_0_yy_0[j] - 0.5 * fl1_fx * tez_0_yy_1[j] + ta_z_yy_1[j];

                tex_zz_yz_0[j] = pa_z[j] * tex_z_yz_0[j] - pc_z[j] * tex_z_yz_1[j] + 0.5 * fl1_fx * tex_0_yz_0[j] - 0.5 * fl1_fx * tex_0_yz_1[j] +
                                 0.5 * fl1_fx * tex_z_y_0[j] - 0.5 * fl1_fx * tex_z_y_1[j];

                tey_zz_yz_0[j] = pa_z[j] * tey_z_yz_0[j] - pc_z[j] * tey_z_yz_1[j] + 0.5 * fl1_fx * tey_0_yz_0[j] - 0.5 * fl1_fx * tey_0_yz_1[j] +
                                 0.5 * fl1_fx * tey_z_y_0[j] - 0.5 * fl1_fx * tey_z_y_1[j];

                tez_zz_yz_0[j] = pa_z[j] * tez_z_yz_0[j] - pc_z[j] * tez_z_yz_1[j] + 0.5 * fl1_fx * tez_0_yz_0[j] - 0.5 * fl1_fx * tez_0_yz_1[j] +
                                 0.5 * fl1_fx * tez_z_y_0[j] - 0.5 * fl1_fx * tez_z_y_1[j] + ta_z_yz_1[j];

                tex_zz_zz_0[j] = pa_z[j] * tex_z_zz_0[j] - pc_z[j] * tex_z_zz_1[j] + 0.5 * fl1_fx * tex_0_zz_0[j] - 0.5 * fl1_fx * tex_0_zz_1[j] +
                                 fl1_fx * tex_z_z_0[j] - fl1_fx * tex_z_z_1[j];

                tey_zz_zz_0[j] = pa_z[j] * tey_z_zz_0[j] - pc_z[j] * tey_z_zz_1[j] + 0.5 * fl1_fx * tey_0_zz_0[j] - 0.5 * fl1_fx * tey_0_zz_1[j] +
                                 fl1_fx * tey_z_z_0[j] - fl1_fx * tey_z_z_1[j];

                tez_zz_zz_0[j] = pa_z[j] * tez_z_zz_0[j] - pc_z[j] * tez_z_zz_1[j] + 0.5 * fl1_fx * tez_0_zz_0[j] - 0.5 * fl1_fx * tez_0_zz_1[j] +
                                 fl1_fx * tez_z_z_0[j] - fl1_fx * tez_z_z_1[j] + ta_z_zz_1[j];
            }
...
compElectricFieldForDF(CMemBlock2D<double>&       primBuffer,
                       ...
                       const int32_t              iContrGto)
{
    efieldrecfunc::compElectricFieldForDF_0_45(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    efieldrecfunc::compElectricFieldForDF_45_90(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    efieldrecfunc::compElectricFieldForDF_90_135(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    efieldrecfunc::compElectricFieldForDF_135_180(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
                            ...
                            const int32_t              iContrGto)
{
    ...
    auto mord = recursionMap.getMaxOrder({"Electric Field"}, {2, -1, -1, -1}, {3, -1, -1, -1}, 1, 1);
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        auto pidx_e_1_3_m1 =
            recursionMap.getIndexOfTerm(CRecursionTerm({"Electric Field"}, 1, true, {1, -1, -1, -1}, {3, -1, -1, -1}, 1, 1, iord + 1));
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tex_xx_xxx_0[j] = pa_x[j] * tex_x_xxx_0[j] - pc_x[j] * tex_x_xxx_1[j] + 0.5 * fl1_fx * tex_0_xxx_0[j] -
                                  0.5 * fl1_fx * tex_0_xxx_1[j] + 1.5 * fl1_fx * tex_x_xx_0[j] - 1.5 * fl1_fx * tex_x_xx_1[j] + ta_x_xxx_1[j];

                tey_xx_xxx_0[j] = pa_x[j] * tey_x_xxx_0[j] - pc_x[j] * tey_x_xxx_1[j] + 0.5 * fl1_fx * tey_0_xxx_0[j] -
                                  0.5 * fl1_fx * tey_0_xxx_1[j] + 1.5 * fl1_fx * tey_x_xx_0[j] - 1.5 * fl1_fx * tey_x_xx_1[j];

                tez_xx_xxx_0[j] = pa_x[j] * tez_x_xxx_0[j] - pc_x[j] * tez_x_xxx_1[j] + 0.5 * fl1_fx * tez_0_xxx_0[j] -
                                  0.5 * fl1_fx * tez_0_xxx_1[j] + 1.5 * fl1_fx * tez_x_xx_0[j] - 1.5 * fl1_fx * tez_x_xx_1[j];

                tex_xx_xxy_0[j] = pa_x[j] * tex_x_xxy_0[j] - pc_x[j] * tex_x_xxy_1[j] + 0.5 * fl1_fx * tex_0_xxy_0[j] -
                                  0.5 * fl1_fx * tex_0_xxy_1[j] + fl1_fx * tex_x_xy_0[j] - fl1_fx * tex_x_xy_1[j] + ta_x_xxy_1[j];

                tey_xx_xxy_0[j] = pa_x[j] * tey_x_xxy_0[j] - pc_x[j] * tey_x_xxy_1[j] + 0.5 * fl1_fx * tey_0_xxy_0[j] -
                                  0.5 * fl1_fx * tey_0_xxy_1[j] + fl1_fx * tey_x_xy_0[j] - fl1_fx * tey_x_xy_1[j];

                tez_xx_xxy_0[j] = pa_x[j] * tez_x_xxy_0[j] - pc_x[j] * tez_x_xxy_1[j] + 0.5 * fl1_fx * tez_0_xxy_0[j] -
                                  0.5 * fl1_fx * tez_0_xxy_1[j] + fl1_fx * tez_x_xy_0[j] - fl1_fx * tez_x_xy_1[j];

                tex_xx_xxz_0[j] = pa_x[j] * tex_x_xxz_0[j] - pc_x[j] * tex_x_xxz_1[j] + 0.5 * fl1_fx * tex_0_xxz_0[j] -
                                  0.5 * fl1_fx * tex_0_xxz_1[j] + fl1_fx * tex_x_xz_0[j] - fl1_fx * tex_x_xz_1[j] + ta_x_xxz_1[j];

                tey_xx_xxz_0[j] = pa_x[j] * tey_x_xxz_0[j] - pc_x[j] * tey_x_xxz_1[j] + 0.5 * fl1_fx * tey_0_xxz_0[j] -
                                  0.5 * fl1_fx * tey_0_xxz_1[j] + fl1_fx * tey_x_xz_0[j] - fl1_fx * tey_x_xz_1[j];

                tez_xx_xxz_0[j] = pa_x[j] * tez_x_xxz_0[j] - pc_x[j] * tez_x_xxz_1[j] + 0.5 * fl1_fx * tez_0_xxz_0[j] -
                                  0.5 * fl1_fx * tez_0_xxz_1[j] + fl1_fx * tez_x_xz_0[j] - fl1_fx * tez_x_xz_1[j];

                tex_xx_xyy_0[j] = pa_x[j] * tex_x_xyy_0[j] - pc_x[j] * tex_x_xyy_1[j] + 0.5 * fl1_fx * tex_0_xyy_0[j] -
                                  0.5 * fl1_fx * tex_0_xyy_1[j] + 0.5 * fl1_fx * tex_x_yy_0[j] - 0.5 * fl1_fx * tex_x_yy_1[j] + ta_x_xyy_1[j];

                tey_xx_xyy_0[j] = pa_x[j] * tey_x_xyy_0[j] - pc_x[j] * tey_x_xyy_1[j] + 0.5 * fl1_fx * tey_0_xyy_0[j] -
                                  0.5 * fl1_fx * tey_0_xyy_1[j] + 0.5 * fl1_fx * tey_x_yy_0[j] - 0.5 * fl1_fx * tey_x_yy_1[j];

                tez_xx_xyy_0[j] = pa_x[j] * tez_x_xyy_0[j] - pc_x[j] * tez_x_xyy_1[j] + 0.5 * fl1_fx * tez_0_xyy_0[j] -
                                  0.5 * fl1_fx * tez_0_xyy_1[j] + 0.5 * fl1_fx * tez_x_yy_0[j] - 0.5 * fl1_fx * tez_x_yy_1[j];

                tex_xx_xyz_0[j] = pa_x[j] * tex_x_xyz_0[j] - pc_x[j] * tex_x_xyz_1[j] + 0.5 * fl1_fx * tex_0_xyz_0[j] -
                                  0.5 * fl1_fx * tex_0_xyz_1[j] + 0.5 * fl1_fx * tex_x_yz_0[j] - 0.5 * fl1_fx * tex_x_yz_1[j] + ta_x_xyz_1[j];

                tey_xx_xyz_0[j] = pa_x[j] * tey_x_xyz_0[j] - pc_x[j] * tey_x_xyz_1[j] + 0.5 * fl1_fx * tey_0_xyz_0[j] -
                                  0.5 * fl1_fx * tey_0_xyz_1[j] + 0.5 * fl1_fx * tey_x_yz_0[j] - 0.5 * fl1_fx * tey_x_yz_1[j];

                tez_xx_xyz_0[j] = pa_x[j] * tez_x_xyz_0[j] - pc_x[j] * tez_x_xyz_1[j] + 0.5 * fl1_fx * tez_0_xyz_0[j] -
                                  0.5 * fl1_fx * tez_0_xyz_1[j] + 0.5 * fl1_fx * tez_x_yz_0[j] - 0.5 * fl1_fx * tez_x_yz_1[j];

                tex_xx_xzz_0[j] = pa_x[j] * tex_x_xzz_0[j] - pc_x[j] * tex_x_xzz_1[j] + 0.5 * fl1_fx * tex_0_xzz_0[j] -
                                  0.5 * fl1_fx * tex_0_xzz_1[j] + 0.5 * fl1_fx * tex_x_zz_0[j] - 0.5 * fl1_fx * tex_x_zz_1[j] + ta_x_xzz_1[j];

                tey_xx_xzz_0[j] = pa_x[j] * tey_x_xzz_0[j] - pc_x[j] * tey_x_xzz_1[j] + 0.5 * fl1_fx * tey_0_xzz_0[j] -
                                  0.5 * fl1_fx * tey_0_xzz_1[j] + 0.5 * fl1_fx * tey_x_zz_0[j] - 0.5 * fl1_fx * tey_x_zz_1[j];

                tez_xx_xzz_0[j] = pa_x[j] * tez_x_xzz_0[j] - pc_x[j] * tez_x_xzz_1[j] + 0.5 * fl1_fx * tez_0_xzz_0[j] -
                                  0.5 * fl1_fx * tez_0_xzz_1[j] + 0.5 * fl1_fx * tez_x_zz_0[j] - 0.5 * fl1_fx * tez_x_zz_1[j];

                tex_xx_yyy_0[j] = pa_x[j] * tex_x_yyy_0[j] - pc_x[j] * tex_x_yyy_1[j] + 0.5 * fl1_fx * tex_0_yyy_0[j] -
                                  0.5 * fl1_fx * tex_0_yyy_1[j] + ta_x_yyy_1[j];
                ...
                tex_xx_yyz_0[j] = pa_x[j] * tex_x_yyz_0[j] - pc_x[j] * tex_x_yyz_1[j] + 0.5 * fl1_fx * tex_0_yyz_0[j] -
                                  0.5 * fl1_fx * tex_0_yyz_1[j] + ta_x_yyz_1[j];
                ...
                tex_xx_yzz_0[j] = pa_x[j] * tex_x_yzz_0[j] - pc_x[j] * tex_x_yzz_1[j] + 0.5 * fl1_fx * tex_0_yzz_0[j] -
                                  0.5 * fl1_fx * tex_0_yzz_1[j] + ta_x_yzz_1[j];
                ...
                tex_xx_zzz_0[j] = pa_x[j] * tex_x_zzz_0[j] - pc_x[j] * tex_x_zzz_1[j] + 0.5 * fl1_fx * tex_0_zzz_0[j] -
                                  0.5 * fl1_fx * tex_0_zzz_1[j] + ta_x_zzz_1[j];
                ...
                tex_xy_xxx_0[j] =
                    pa_x[j] * tex_y_xxx_0[j] - pc_x[j] * tex_y_xxx_1[j] + 1.5 * fl1_fx * tex_y_xx_0[j] - 1.5 * fl1_fx * tex_y_xx_1[j] + ta_y_xxx_1[j];
                ...
                tex_xy_xxy_0[j] =
                    pa_x[j] * tex_y_xxy_0[j] - pc_x[j] * tex_y_xxy_1[j] + fl1_fx * tex_y_xy_0[j] - fl1_fx * tex_y_xy_1[j] + ta_y_xxy_1[j];
                ...
                tex_xy_xxz_0[j] =
                    pa_x[j] * tex_y_xxz_0[j] - pc_x[j] * tex_y_xxz_1[j] + fl1_fx * tex_y_xz_0[j] - fl1_fx * tex_y_xz_1[j] + ta_y_xxz_1[j];
                ...
                tex_xy_xyy_0[j] =
                    pa_x[j] * tex_y_xyy_0[j] - pc_x[j] * tex_y_xyy_1[j] + 0.5 * fl1_fx * tex_y_yy_0[j] - 0.5 * fl1_fx * tex_y_yy_1[j] + ta_y_xyy_1[j];
                ...
                tex_xy_xyz_0[j] =
                    pa_x[j] * tex_y_xyz_0[j] - pc_x[j] * tex_y_xyz_1[j] + 0.5 * fl1_fx * tex_y_yz_0[j] - 0.5 * fl1_fx * tex_y_yz_1[j] + ta_y_xyz_1[j];
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tex_xy_xzz_0[j] =
                    pa_x[j] * tex_y_xzz_0[j] - pc_x[j] * tex_y_xzz_1[j] + 0.5 * fl1_fx * tex_y_zz_0[j] - 0.5 * fl1_fx * tex_y_zz_1[j] + ta_y_xzz_1[j];
                ...
                tex_xz_xxx_0[j] =
                    pa_x[j] * tex_z_xxx_0[j] - pc_x[j] * tex_z_xxx_1[j] + 1.5 * fl1_fx * tex_z_xx_0[j] - 1.5 * fl1_fx * tex_z_xx_1[j] + ta_z_xxx_1[j];
                ...
                tex_xz_xxy_0[j] =
                    pa_x[j] * tex_z_xxy_0[j] - pc_x[j] * tex_z_xxy_1[j] + fl1_fx * tex_z_xy_0[j] - fl1_fx * tex_z_xy_1[j] + ta_z_xxy_1[j];
                ...
                tex_xz_xxz_0[j] =
                    pa_x[j] * tex_z_xxz_0[j] - pc_x[j] * tex_z_xxz_1[j] + fl1_fx * tex_z_xz_0[j] - fl1_fx * tex_z_xz_1[j] + ta_z_xxz_1[j];
                ...
                tex_xz_xyy_0[j] =
                    pa_x[j] * tex_z_xyy_0[j] - pc_x[j] * tex_z_xyy_1[j] + 0.5 * fl1_fx * tex_z_yy_0[j] - 0.5 * fl1_fx * tex_z_yy_1[j] + ta_z_xyy_1[j];
                ...
                tex_xz_xyz_0[j] =
                    pa_x[j] * tex_z_xyz_0[j] - pc_x[j] * tex_z_xyz_1[j] + 0.5 * fl1_fx * tex_z_yz_0[j] - 0.5 * fl1_fx * tex_z_yz_1[j] + ta_z_xyz_1[j];
                ...
                tex_xz_xzz_0[j] =
                    pa_x[j] * tex_z_xzz_0[j] - pc_x[j] * tex_z_xzz_1[j] + 0.5 * fl1_fx * tex_z_zz_0[j] - 0.5 * fl1_fx * tex_z_zz_1[j] + ta_z_xzz_1[j];
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tey_yy_xxx_0[j] = pa_y[j] * tey_y_xxx_0[j] - pc_y[j] * tey_y_xxx_1[j] + 0.5 * fl1_fx * tey_0_xxx_0[j] -
                                  0.5 * fl1_fx * tey_0_xxx_1[j] + ta_y_xxx_1[j];

                tez_yy_xxx_0[j] = pa_y[j] * tez_y_xxx_0[j] - pc_y[j] * tez_y_xxx_1[j] + 0.5 * fl1_fx * tez_0_xxx_0[j] - 0.5 * fl1_fx * tez_0_xxx_1[j];

                tex_yy_xxy_0[j] = pa_y[j] * tex_y_xxy_0[j] - pc_y[j] * tex_y_xxy_1[j] + 0.5 * fl1_fx * tex_0_xxy_0[j] -
                                  0.5 * fl1_fx * tex_0_xxy_1[j] + 0.5 * fl1_fx * tex_y_xx_0[j] - 0.5 * fl1_fx * tex_y_xx_1[j];

                tey_yy_xxy_0[j] = pa_y[j] * tey_y_xxy_0[j] - pc_y[j] * tey_y_xxy_1[j] + 0.5 * fl1_fx * tey_0_xxy_0[j] -
                                  0.5 * fl1_fx * tey_0_xxy_1[j] + 0.5 * fl1_fx * tey_y_xx_0[j] - 0.5 * fl1_fx * tey_y_xx_1[j] + ta_y_xxy_1[j];

                tez_yy_xxy_0[j] = pa_y[j] * tez_y_xxy_0[j] - pc_y[j] * tez_y_xxy_1[j] + 0.5 * fl1_fx * tez_0_xxy_0[j] -
                                  0.5 * fl1_fx * tez_0_xxy_1[j] + 0.5 * fl1_fx * tez_y_xx_0[j] - 0.5 * fl1_fx * tez_y_xx_1[j];

                tex_yy_xxz_0[j] = pa_y[j] * tex_y_xxz_0[j] - pc_y[j] * tex_y_xxz_1[j] + 0.5 * fl1_fx * tex_0_xxz_0[j] - 0.5 * fl1_fx * tex_0_xxz_1[j];

                tey_yy_xxz_0[j] = pa_y[j] * tey_y_xxz_0[j] - pc_y[j] * tey_y_xxz_1[j] + 0.5 * fl1_fx * tey_0_xxz_0[j] -
                                  0.5 * fl1_fx * tey_0_xxz_1[j] + ta_y_xxz_1[j];

                tez_yy_xxz_0[j] = pa_y[j] * tez_y_xxz_0[j] - pc_y[j] * tez_y_xxz_1[j] + 0.5 * fl1_fx * tez_0_xxz_0[j] - 0.5 * fl1_fx * tez_0_xxz_1[j];

                tex_yy_xyy_0[j] = pa_y[j] * tex_y_xyy_0[j] - pc_y[j] * tex_y_xyy_1[j] + 0.5 * fl1_fx * tex_0_xyy_0[j] -
                                  0.5 * fl1_fx * tex_0_xyy_1[j] + fl1_fx * tex_y_xy_0[j] - fl1_fx * tex_y_xy_1[j];

                tey_yy_xyy_0[j] = pa_y[j] * tey_y_xyy_0[j] - pc_y[j] * tey_y_xyy_1[j] + 0.5 * fl1_fx * tey_0_xyy_0[j] -
                                  0.5 * fl1_fx * tey_0_xyy_1[j] + fl1_fx * tey_y_xy_0[j] - fl1_fx * tey_y_xy_1[j] + ta_y_xyy_1[j];

                tez_yy_xyy_0[j] = pa_y[j] * tez_y_xyy_0[j] - pc_y[j] * tez_y_xyy_1[j] + 0.5 * fl1_fx * tez_0_xyy_0[j] -
                                  0.5 * fl1_fx * tez_0_xyy_1[j] + fl1_fx * tez_y_xy_0[j] - fl1_fx * tez_y_xy_1[j];

                tex_yy_xyz_0[j] = pa_y[j] * tex_y_xyz_0[j] - pc_y[j] * tex_y_xyz_1[j] + 0.5 * fl1_fx * tex_0_xyz_0[j] -
                                  0.5 * fl1_fx * tex_0_xyz_1[j] + 0.5 * fl1_fx * tex_y_xz_0[j] - 0.5 * fl1_fx * tex_y_xz_1[j];

                tey_yy_xyz_0[j] = pa_y[j] * tey_y_xyz_0[j] - pc_y[j] * tey_y_xyz_1[j] + 0.5 * fl1_fx * tey_0_xyz_0[j] -
                                  0.5 * fl1_fx * tey_0_xyz_1[j] + 0.5 * fl1_fx * tey_y_xz_0[j] - 0.5 * fl1_fx * tey_y_xz_1[j] + ta_y_xyz_1[j];

                tez_yy_xyz_0[j] = pa_y[j] * tez_y_xyz_0[j] - pc_y[j] * tez_y_xyz_1[j] + 0.5 * fl1_fx * tez_0_xyz_0[j] -
                                  0.5 * fl1_fx * tez_0_xyz_1[j] + 0.5 * fl1_fx * tez_y_xz_0[j] - 0.5 * fl1_fx * tez_y_xz_1[j];

                tex_yy_xzz_0[j] = pa_y[j] * tex_y_xzz_0[j] - pc_y[j] * tex_y_xzz_1[j] + 0.5 * fl1_fx * tex_0_xzz_0[j] - 0.5 * fl1_fx * tex_0_xzz_1[j];

                tey_yy_xzz_0[j] = pa_y[j] * tey_y_xzz_0[j] - pc_y[j] * tey_y_xzz_1[j] + 0.5 * fl1_fx * tey_0_xzz_0[j] -
                                  0.5 * fl1_fx * tey_0_xzz_1[j] + ta_y_xzz_1[j];

                tez_yy_xzz_0[j] = pa_y[j] * tez_y_xzz_0[j] - pc_y[j] * tez_y_xzz_1[j] + 0.5 * fl1_fx * tez_0_xzz_0[j] - 0.5 * fl1_fx * tez_0_xzz_1[j];

                tex_yy_yyy_0[j] = pa_y[j] * tex_y_yyy_0[j] - pc_y[j] * tex_y_yyy_1[j] + 0.5 * fl1_fx * tex_0_yyy_0[j] -
                                  0.5 * fl1_fx * tex_0_yyy_1[j] + 1.5 * fl1_fx * tex_y_yy_0[j] - 1.5 * fl1_fx * tex_y_yy_1[j];

                tey_yy_yyy_0[j] = pa_y[j] * tey_y_yyy_0[j] - pc_y[j] * tey_y_yyy_1[j] + 0.5 * fl1_fx * tey_0_yyy_0[j] -
                                  0.5 * fl1_fx * tey_0_yyy_1[j] + 1.5 * fl1_fx * tey_y_yy_0[j] - 1.5 * fl1_fx * tey_y_yy_1[j] + ta_y_yyy_1[j];

                tez_yy_yyy_0[j] = pa_y[j] * tez_y_yyy_0[j] - pc_y[j] * tez_y_yyy_1[j] + 0.5 * fl1_fx * tez_0_yyy_0[j] -
                                  0.5 * fl1_fx * tez_0_yyy_1[j] + 1.5 * fl1_fx * tez_y_yy_0[j] - 1.5 * fl1_fx * tez_y_yy_1[j];

                tex_yy_yyz_0[j] = pa_y[j] * tex_y_yyz_0[j] - pc_y[j] * tex_y_yyz_1[j] + 0.5 * fl1_fx * tex_0_yyz_0[j] -
                                  0.5 * fl1_fx * tex_0_yyz_1[j] + fl1_fx * tex_y_yz_0[j] - fl1_fx * tex_y_yz_1[j];

                tey_yy_yyz_0[j] = pa_y[j] * tey_y_yyz_0[j] - pc_y[j] * tey_y_yyz_1[j] + 0.5 * fl1_fx * tey_0_yyz_0[j] -
                                  0.5 * fl1_fx * tey_0_yyz_1[j] + fl1_fx * tey_y_yz_0[j] - fl1_fx * tey_y_yz_1[j] + ta_y_yyz_1[j];

                tez_yy_yyz_0[j] = pa_y[j] * tez_y_yyz_0[j] - pc_y[j] * tez_y_yyz_1[j] + 0.5 * fl1_fx * tez_0_yyz_0[j] -
                                  0.5 * fl1_fx * tez_0_yyz_1[j] + fl1_fx * tez_y_yz_0[j] - fl1_fx * tez_y_yz_1[j];

                tex_yy_yzz_0[j] = pa_y[j] * tex_y_yzz_0[j] - pc_y[j] * tex_y_yzz_1[j] + 0.5 * fl1_fx * tex_0_yzz_0[j] -
                                  0.5 * fl1_fx * tex_0_yzz_1[j] + 0.5 * fl1_fx * tex_y_zz_0[j] - 0.5 * fl1_fx * tex_y_zz_1[j];

                tey_yy_yzz_0[j] = pa_y[j] * tey_y_yzz_0[j] - pc_y[j] * tey_y_yzz_1[j] + 0.5 * fl1_fx * tey_0_yzz_0[j] -
                                  0.5 * fl1_fx * tey_0_yzz_1[j] + 0.5 * fl1_fx * tey_y_zz_0[j] - 0.5 * fl1_fx * tey_y_zz_1[j] + ta_y_yzz_1[j];

                tez_yy_yzz_0[j] = pa_y[j] * tez_y_yzz_0[j] - pc_y[j] * tez_y_yzz_1[j] + 0.5 * fl1_fx * tez_0_yzz_0[j] -
                                  0.5 * fl1_fx * tez_0_yzz_1[j] + 0.5 * fl1_fx * tez_y_zz_0[j] - 0.5 * fl1_fx * tez_y_zz_1[j];

                tex_yy_zzz_0[j] = pa_y[j] * tex_y_zzz_0[j] - pc_y[j] * tex_y_zzz_1[j] + 0.5 * fl1_fx * tex_0_zzz_0[j] - 0.5 * fl1_fx * tex_0_zzz_1[j];

                tey_yy_zzz_0[j] = pa_y[j] * tey_y_zzz_0[j] - pc_y[j] * tey_y_zzz_1[j] + 0.5 * fl1_fx * tey_0_zzz_0[j] -
                                  0.5 * fl1_fx * tey_0_zzz_1[j] + ta_y_zzz_1[j];
                ...
                tey_yz_xxy_0[j] =
                    pa_y[j] * tey_z_xxy_0[j] - pc_y[j] * tey_z_xxy_1[j] + 0.5 * fl1_fx * tey_z_xx_0[j] - 0.5 * fl1_fx * tey_z_xx_1[j] + ta_z_xxy_1[j];
                ...
                tey_yz_xyy_0[j] =
                    pa_y[j] * tey_z_xyy_0[j] - pc_y[j] * tey_z_xyy_1[j] + fl1_fx * tey_z_xy_0[j] - fl1_fx * tey_z_xy_1[j] + ta_z_xyy_1[j];
                ...
                tey_yz_xyz_0[j] =
                    pa_y[j] * tey_z_xyz_0[j] - pc_y[j] * tey_z_xyz_1[j] + 0.5 * fl1_fx * tey_z_xz_0[j] - 0.5 * fl1_fx * tey_z_xz_1[j] + ta_z_xyz_1[j];
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tey_yz_yyy_0[j] =
                    pa_y[j] * tey_z_yyy_0[j] - pc_y[j] * tey_z_yyy_1[j] + 1.5 * fl1_fx * tey_z_yy_0[j] - 1.5 * fl1_fx * tey_z_yy_1[j] + ta_z_yyy_1[j];
                ...
                tey_yz_yyz_0[j] =
                    pa_y[j] * tey_z_yyz_0[j] - pc_y[j] * tey_z_yyz_1[j] + fl1_fx * tey_z_yz_0[j] - fl1_fx * tey_z_yz_1[j] + ta_z_yyz_1[j];
                ...
                tey_yz_yzz_0[j] =
                    pa_y[j] * tey_z_yzz_0[j] - pc_y[j] * tey_z_yzz_1[j] + 0.5 * fl1_fx * tey_z_zz_0[j] - 0.5 * fl1_fx * tey_z_zz_1[j] + ta_z_yzz_1[j];
                ...
                tez_zz_xxx_0[j] = pa_z[j] * tez_z_xxx_0[j] - pc_z[j] * tez_z_xxx_1[j] + 0.5 * fl1_fx * tez_0_xxx_0[j] -
                                  0.5 * fl1_fx * tez_0_xxx_1[j] + ta_z_xxx_1[j];
                ...
                tez_zz_xxy_0[j] = pa_z[j] * tez_z_xxy_0[j] - pc_z[j] * tez_z_xxy_1[j] + 0.5 * fl1_fx * tez_0_xxy_0[j] -
                                  0.5 * fl1_fx * tez_0_xxy_1[j] + ta_z_xxy_1[j];

                tex_zz_xxz_0[j] = pa_z[j] * tex_z_xxz_0[j] - pc_z[j] * tex_z_xxz_1[j] + 0.5 * fl1_fx * tex_0_xxz_0[j] -
                                  0.5 * fl1_fx * tex_0_xxz_1[j] + 0.5 * fl1_fx * tex_z_xx_0[j] - 0.5 * fl1_fx * tex_z_xx_1[j];

                tey_zz_xxz_0[j] = pa_z[j] * tey_z_xxz_0[j] - pc_z[j] * tey_z_xxz_1[j] + 0.5 * fl1_fx * tey_0_xxz_0[j] -
                                  0.5 * fl1_fx * tey_0_xxz_1[j] + 0.5 * fl1_fx * tey_z_xx_0[j] - 0.5 * fl1_fx * tey_z_xx_1[j];

                tez_zz_xxz_0[j] = pa_z[j] * tez_z_xxz_0[j] - pc_z[j] * tez_z_xxz_1[j] + 0.5 * fl1_fx * tez_0_xxz_0[j] -
                                  0.5 * fl1_fx * tez_0_xxz_1[j] + 0.5 * fl1_fx * tez_z_xx_0[j] - 0.5 * fl1_fx * tez_z_xx_1[j] + ta_z_xxz_1[j];
                ...
                tez_zz_xyy_0[j] = pa_z[j] * tez_z_xyy_0[j] - pc_z[j] * tez_z_xyy_1[j] + 0.5 * fl1_fx * tez_0_xyy_0[j] -
                                  0.5 * fl1_fx * tez_0_xyy_1[j] + ta_z_xyy_1[j];

                tex_zz_xyz_0[j] = pa_z[j] * tex_z_xyz_0[j] - pc_z[j] * tex_z_xyz_1[j] + 0.5 * fl1_fx * tex_0_xyz_0[j] -
                                  0.5 * fl1_fx * tex_0_xyz_1[j] + 0.5 * fl1_fx * tex_z_xy_0[j] - 0.5 * fl1_fx * tex_z_xy_1[j];

                tey_zz_xyz_0[j] = pa_z[j] * tey_z_xyz_0[j] - pc_z[j] * tey_z_xyz_1[j] + 0.5 * fl1_fx * tey_0_xyz_0[j] -
                                  0.5 * fl1_fx * tey_0_xyz_1[j] + 0.5 * fl1_fx * tey_z_xy_0[j] - 0.5 * fl1_fx * tey_z_xy_1[j];

                tez_zz_xyz_0[j] = pa_z[j] * tez_z_xyz_0[j] - pc_z[j] * tez_z_xyz_1[j] + 0.5 * fl1_fx * tez_0_xyz_0[j] -
                                  0.5 * fl1_fx * tez_0_xyz_1[j] + 0.5 * fl1_fx * tez_z_xy_0[j] - 0.5 * fl1_fx * tez_z_xy_1[j] + ta_z_xyz_1[j];

                tex_zz_xzz_0[j] = pa_z[j] * tex_z_xzz_0[j] - pc_z[j] * tex_z_xzz_1[j] + 0.5 * fl1_fx * tex_0_xzz_0[j] -
                                  0.5 * fl1_fx * tex_0_xzz_1[j] + fl1_fx * tex_z_xz_0[j] - fl1_fx * tex_z_xz_1[j];

                tey_zz_xzz_0[j] = pa_z[j] * tey_z_xzz_0[j] - pc_z[j] * tey_z_xzz_1[j] + 0.5 * fl1_fx * tey_0_xzz_0[j] -
                                  0.5 * fl1_fx * tey_0_xzz_1[j] + fl1_fx * tey_z_xz_0[j] - fl1_fx * tey_z_xz_1[j];

                tez_zz_xzz_0[j] = pa_z[j] * tez_z_xzz_0[j] - pc_z[j] * tez_z_xzz_1[j] + 0.5 * fl1_fx * tez_0_xzz_0[j] -
                                  0.5 * fl1_fx * tez_0_xzz_1[j] + fl1_fx * tez_z_xz_0[j] - fl1_fx * tez_z_xz_1[j] + ta_z_xzz_1[j];
                ...
                tez_zz_yyy_0[j] = pa_z[j] * tez_z_yyy_0[j] - pc_z[j] * tez_z_yyy_1[j] + 0.5 * fl1_fx * tez_0_yyy_0[j] -
                                  0.5 * fl1_fx * tez_0_yyy_1[j] + ta_z_yyy_1[j];

                tex_zz_yyz_0[j] = pa_z[j] * tex_z_yyz_0[j] - pc_z[j] * tex_z_yyz_1[j] + 0.5 * fl1_fx * tex_0_yyz_0[j] -
                                  0.5 * fl1_fx * tex_0_yyz_1[j] + 0.5 * fl1_fx * tex_z_yy_0[j] - 0.5 * fl1_fx * tex_z_yy_1[j];

                tey_zz_yyz_0[j] = pa_z[j] * tey_z_yyz_0[j] - pc_z[j] * tey_z_yyz_1[j] + 0.5 * fl1_fx * tey_0_yyz_0[j] -
                                  0.5 * fl1_fx * tey_0_yyz_1[j] + 0.5 * fl1_fx * tey_z_yy_0[j] - 0.5 * fl1_fx * tey_z_yy_1[j];

                tez_zz_yyz_0[j] = pa_z[j] * tez_z_yyz_0[j] - pc_z[j] * tez_z_yyz_1[j] + 0.5 * fl1_fx * tez_0_yyz_0[j] -
                                  0.5 * fl1_fx * tez_0_yyz_1[j] + 0.5 * fl1_fx * tez_z_yy_0[j] - 0.5 * fl1_fx * tez_z_yy_1[j] + ta_z_yyz_1[j];

                tex_zz_yzz_0[j] = pa_z[j] * tex_z_yzz_0[j] - pc_z[j] * tex_z_yzz_1[j] + 0.5 * fl1_fx * tex_0_yzz_0[j] -
                                  0.5 * fl1_fx * tex_0_yzz_1[j] + fl1_fx * tex_z_yz_0[j] - fl1_fx * tex_z_yz_1[j];

                tey_zz_yzz_0[j] = pa_z[j] * tey_z_yzz_0[j] - pc_z[j] * tey_z_yzz_1[j] + 0.5 * fl1_fx * tey_0_yzz_0[j] -
                                  0.5 * fl1_fx * tey_0_yzz_1[j] + fl1_fx * tey_z_yz_0[j] - fl1_fx * tey_z_yz_1[j];

                tez_zz_yzz_0[j] = pa_z[j] * tez_z_yzz_0[j] - pc_z[j] * tez_z_yzz_1[j] + 0.5 * fl1_fx * tez_0_yzz_0[j] -
                                  0.5 * fl1_fx * tez_0_yzz_1[j] + fl1_fx * tez_z_yz_0[j] - fl1_fx * tez_z_yz_1[j] + ta_z_yzz_1[j];

                tex_zz_zzz_0[j] = pa_z[j] * tex_z_zzz_0[j] - pc_z[j] * tex_z_zzz_1[j] + 0.5 * fl1_fx * tex_0_zzz_0[j] -
                                  0.5 * fl1_fx * tex_0_zzz_1[j] + 1.5 * fl1_fx * tex_z_zz_0[j] - 1.5 * fl1_fx * tex_z_zz_1[j];

                tey_zz_zzz_0[j] = pa_z[j] * tey_z_zzz_0[j] - pc_z[j] * tey_z_zzz_1[j] + 0.5 * fl1_fx * tey_0_zzz_0[j] -
                                  0.5 * fl1_fx * tey_0_zzz_1[j] + 1.5 * fl1_fx * tey_z_zz_0[j] - 1.5 * fl1_fx * tey_z_zz_1[j];

                tez_zz_zzz_0[j] = pa_z[j] * tez_z_zzz_0[j] - pc_z[j] * tez_z_zzz_1[j] + 0.5 * fl1_fx * tez_0_zzz_0[j] -
                                  0.5 * fl1_fx * tez_0_zzz_1[j] + 1.5 * fl1_fx * tez_z_zz_0[j] - 1.5 * fl1_fx * tez_z_zz_1[j] + ta_z_zzz_1[j];
            }
...
compElectricFieldForFD(CMemBlock2D<double>&       primBuffer,
                       ...
                       const int32_t              iContrGto)
{
    efieldrecfunc::compElectricFieldForFD_0_45(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    efieldrecfunc::compElectricFieldForFD_45_90(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    efieldrecfunc::compElectricFieldForFD_90_135(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    efieldrecfunc::compElectricFieldForFD_135_180(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
                            ...
                            const int32_t              iContrGto)
{
    ...
    auto mord = recursionMap.getMaxOrder({"Electric Field"}, {3, -1, -1, -1}, {2, -1, -1, -1}, 1, 1);
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        auto pidx_e_2_2_m1 =
            recursionMap.getIndexOfTerm(CRecursionTerm({"Electric Field"}, 1, true, {2, -1, -1, -1}, {2, -1, -1, -1}, 1, 1, iord + 1));
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tex_xxx_xx_0[j] = pa_x[j] * tex_xx_xx_0[j] - pc_x[j] * tex_xx_xx_1[j] + fl1_fx * tex_x_xx_0[j] - fl1_fx * tex_x_xx_1[j] +
                                  fl1_fx * tex_xx_x_0[j] - fl1_fx * tex_xx_x_1[j] + ta_xx_xx_1[j];

                tey_xxx_xx_0[j] = pa_x[j] * tey_xx_xx_0[j] - pc_x[j] * tey_xx_xx_1[j] + fl1_fx * tey_x_xx_0[j] - fl1_fx * tey_x_xx_1[j] +
                                  fl1_fx * tey_xx_x_0[j] - fl1_fx * tey_xx_x_1[j];

                tez_xxx_xx_0[j] = pa_x[j] * tez_xx_xx_0[j] - pc_x[j] * tez_xx_xx_1[j] + fl1_fx * tez_x_xx_0[j] - fl1_fx * tez_x_xx_1[j] +
                                  fl1_fx * tez_xx_x_0[j] - fl1_fx * tez_xx_x_1[j];

                tex_xxx_xy_0[j] = pa_x[j] * tex_xx_xy_0[j] - pc_x[j] * tex_xx_xy_1[j] + fl1_fx * tex_x_xy_0[j] - fl1_fx * tex_x_xy_1[j] +
                                  0.5 * fl1_fx * tex_xx_y_0[j] - 0.5 * fl1_fx * tex_xx_y_1[j] + ta_xx_xy_1[j];

                tey_xxx_xy_0[j] = pa_x[j] * tey_xx_xy_0[j] - pc_x[j] * tey_xx_xy_1[j] + fl1_fx * tey_x_xy_0[j] - fl1_fx * tey_x_xy_1[j] +
                                  0.5 * fl1_fx * tey_xx_y_0[j] - 0.5 * fl1_fx * tey_xx_y_1[j];

                tez_xxx_xy_0[j] = pa_x[j] * tez_xx_xy_0[j] - pc_x[j] * tez_xx_xy_1[j] + fl1_fx * tez_x_xy_0[j] - fl1_fx * tez_x_xy_1[j] +
                                  0.5 * fl1_fx * tez_xx_y_0[j] - 0.5 * fl1_fx * tez_xx_y_1[j];

                tex_xxx_xz_0[j] = pa_x[j] * tex_xx_xz_0[j] - pc_x[j] * tex_xx_xz_1[j] + fl1_fx * tex_x_xz_0[j] - fl1_fx * tex_x_xz_1[j] +
                                  0.5 * fl1_fx * tex_xx_z_0[j] - 0.5 * fl1_fx * tex_xx_z_1[j] + ta_xx_xz_1[j];

                tey_xxx_xz_0[j] = pa_x[j] * tey_xx_xz_0[j] - pc_x[j] * tey_xx_xz_1[j] + fl1_fx * tey_x_xz_0[j] - fl1_fx * tey_x_xz_1[j] +
                                  0.5 * fl1_fx * tey_xx_z_0[j] - 0.5 * fl1_fx * tey_xx_z_1[j];

                tez_xxx_xz_0[j] = pa_x[j] * tez_xx_xz_0[j] - pc_x[j] * tez_xx_xz_1[j] + fl1_fx * tez_x_xz_0[j] - fl1_fx * tez_x_xz_1[j] +
                                  0.5 * fl1_fx * tez_xx_z_0[j] - 0.5 * fl1_fx * tez_xx_z_1[j];

                tex_xxx_yy_0[j] =
                    pa_x[j] * tex_xx_yy_0[j] - pc_x[j] * tex_xx_yy_1[j] + fl1_fx * tex_x_yy_0[j] - fl1_fx * tex_x_yy_1[j] + ta_xx_yy_1[j];
                ...
                tex_xxx_yz_0[j] =
                    pa_x[j] * tex_xx_yz_0[j] - pc_x[j] * tex_xx_yz_1[j] + fl1_fx * tex_x_yz_0[j] - fl1_fx * tex_x_yz_1[j] + ta_xx_yz_1[j];
                ...
                tex_xxx_zz_0[j] =
                    pa_x[j] * tex_xx_zz_0[j] - pc_x[j] * tex_xx_zz_1[j] + fl1_fx * tex_x_zz_0[j] - fl1_fx * tex_x_zz_1[j] + ta_xx_zz_1[j];
                ...
                tex_xxy_xx_0[j] = pa_x[j] * tex_xy_xx_0[j] - pc_x[j] * tex_xy_xx_1[j] + 0.5 * fl1_fx * tex_y_xx_0[j] - 0.5 * fl1_fx * tex_y_xx_1[j] +
                                  fl1_fx * tex_xy_x_0[j] - fl1_fx * tex_xy_x_1[j] + ta_xy_xx_1[j];

                tey_xxy_xx_0[j] = pa_x[j] * tey_xy_xx_0[j] - pc_x[j] * tey_xy_xx_1[j] + 0.5 * fl1_fx * tey_y_xx_0[j] - 0.5 * fl1_fx * tey_y_xx_1[j] +
                                  fl1_fx * tey_xy_x_0[j] - fl1_fx * tey_xy_x_1[j];

                tez_xxy_xx_0[j] = pa_x[j] * tez_xy_xx_0[j] - pc_x[j] * tez_xy_xx_1[j] + 0.5 * fl1_fx * tez_y_xx_0[j] - 0.5 * fl1_fx * tez_y_xx_1[j] +
                                  fl1_fx * tez_xy_x_0[j] - fl1_fx * tez_xy_x_1[j];

                tex_xxy_xy_0[j] = pa_x[j] * tex_xy_xy_0[j] - pc_x[j] * tex_xy_xy_1[j] + 0.5 * fl1_fx * tex_y_xy_0[j] - 0.5 * fl1_fx * tex_y_xy_1[j] +
                                  0.5 * fl1_fx * tex_xy_y_0[j] - 0.5 * fl1_fx * tex_xy_y_1[j] + ta_xy_xy_1[j];

                tey_xxy_xy_0[j] = pa_x[j] * tey_xy_xy_0[j] - pc_x[j] * tey_xy_xy_1[j] + 0.5 * fl1_fx * tey_y_xy_0[j] - 0.5 * fl1_fx * tey_y_xy_1[j] +
                                  0.5 * fl1_fx * tey_xy_y_0[j] - 0.5 * fl1_fx * tey_xy_y_1[j];

                tez_xxy_xy_0[j] = pa_x[j] * tez_xy_xy_0[j] - pc_x[j] * tez_xy_xy_1[j] + 0.5 * fl1_fx * tez_y_xy_0[j] - 0.5 * fl1_fx * tez_y_xy_1[j] +
                                  0.5 * fl1_fx * tez_xy_y_0[j] - 0.5 * fl1_fx * tez_xy_y_1[j];

                tex_xxy_xz_0[j] = pa_x[j] * tex_xy_xz_0[j] - pc_x[j] * tex_xy_xz_1[j] + 0.5 * fl1_fx * tex_y_xz_0[j] - 0.5 * fl1_fx * tex_y_xz_1[j] +
                                  0.5 * fl1_fx * tex_xy_z_0[j] - 0.5 * fl1_fx * tex_xy_z_1[j] + ta_xy_xz_1[j];

                tey_xxy_xz_0[j] = pa_x[j] * tey_xy_xz_0[j] - pc_x[j] * tey_xy_xz_1[j] + 0.5 * fl1_fx * tey_y_xz_0[j] - 0.5 * fl1_fx * tey_y_xz_1[j] +
                                  0.5 * fl1_fx * tey_xy_z_0[j] - 0.5 * fl1_fx * tey_xy_z_1[j];

                tez_xxy_xz_0[j] = pa_x[j] * tez_xy_xz_0[j] - pc_x[j] * tez_xy_xz_1[j] + 0.5 * fl1_fx * tez_y_xz_0[j] - 0.5 * fl1_fx * tez_y_xz_1[j] +
                                  0.5 * fl1_fx * tez_xy_z_0[j] - 0.5 * fl1_fx * tez_xy_z_1[j];

                tex_xxy_yy_0[j] =
                    pa_x[j] * tex_xy_yy_0[j] - pc_x[j] * tex_xy_yy_1[j] + 0.5 * fl1_fx * tex_y_yy_0[j] - 0.5 * fl1_fx * tex_y_yy_1[j] + ta_xy_yy_1[j];
                ...
                tex_xxy_yz_0[j] =
                    pa_x[j] * tex_xy_yz_0[j] - pc_x[j] * tex_xy_yz_1[j] + 0.5 * fl1_fx * tex_y_yz_0[j] - 0.5 * fl1_fx * tex_y_yz_1[j] + ta_xy_yz_1[j];
                ...
                tex_xxy_zz_0[j] =
                    pa_x[j] * tex_xy_zz_0[j] - pc_x[j] * tex_xy_zz_1[j] + 0.5 * fl1_fx * tex_y_zz_0[j] - 0.5 * fl1_fx * tex_y_zz_1[j] + ta_xy_zz_1[j];
                ...
                tex_xxz_xx_0[j] = pa_x[j] * tex_xz_xx_0[j] - pc_x[j] * tex_xz_xx_1[j] + 0.5 * fl1_fx * tex_z_xx_0[j] - 0.5 * fl1_fx * tex_z_xx_1[j] +
                                  fl1_fx * tex_xz_x_0[j] - fl1_fx * tex_xz_x_1[j] + ta_xz_xx_1[j];

                tey_xxz_xx_0[j] = pa_x[j] * tey_xz_xx_0[j] - pc_x[j] * tey_xz_xx_1[j] + 0.5 * fl1_fx * tey_z_xx_0[j] - 0.5 * fl1_fx * tey_z_xx_1[j] +
                                  fl1_fx * tey_xz_x_0[j] - fl1_fx * tey_xz_x_1[j];

                tez_xxz_xx_0[j] = pa_x[j] * tez_xz_xx_0[j] - pc_x[j] * tez_xz_xx_1[j] + 0.5 * fl1_fx * tez_z_xx_0[j] - 0.5 * fl1_fx * tez_z_xx_1[j] +
                                  fl1_fx * tez_xz_x_0[j] - fl1_fx * tez_xz_x_1[j];

                tex_xxz_xy_0[j] = pa_x[j] * tex_xz_xy_0[j] - pc_x[j] * tex_xz_xy_1[j] + 0.5 * fl1_fx * tex_z_xy_0[j] - 0.5 * fl1_fx * tex_z_xy_1[j] +
                                  0.5 * fl1_fx * tex_xz_y_0[j] - 0.5 * fl1_fx * tex_xz_y_1[j] + ta_xz_xy_1[j];

                tey_xxz_xy_0[j] = pa_x[j] * tey_xz_xy_0[j] - pc_x[j] * tey_xz_xy_1[j] + 0.5 * fl1_fx * tey_z_xy_0[j] - 0.5 * fl1_fx * tey_z_xy_1[j] +
                                  0.5 * fl1_fx * tey_xz_y_0[j] - 0.5 * fl1_fx * tey_xz_y_1[j];

                tez_xxz_xy_0[j] = pa_x[j] * tez_xz_xy_0[j] - pc_x[j] * tez_xz_xy_1[j] + 0.5 * fl1_fx * tez_z_xy_0[j] - 0.5 * fl1_fx * tez_z_xy_1[j] +
                                  0.5 * fl1_fx * tez_xz_y_0[j] - 0.5 * fl1_fx * tez_xz_y_1[j];

                tex_xxz_xz_0[j] = pa_x[j] * tex_xz_xz_0[j] - pc_x[j] * tex_xz_xz_1[j] + 0.5 * fl1_fx * tex_z_xz_0[j] - 0.5 * fl1_fx * tex_z_xz_1[j] +
                                  0.5 * fl1_fx * tex_xz_z_0[j] - 0.5 * fl1_fx * tex_xz_z_1[j] + ta_xz_xz_1[j];

                tey_xxz_xz_0[j] = pa_x[j] * tey_xz_xz_0[j] - pc_x[j] * tey_xz_xz_1[j] + 0.5 * fl1_fx * tey_z_xz_0[j] - 0.5 * fl1_fx * tey_z_xz_1[j] +
                                  0.5 * fl1_fx * tey_xz_z_0[j] - 0.5 * fl1_fx * tey_xz_z_1[j];

                tez_xxz_xz_0[j] = pa_x[j] * tez_xz_xz_0[j] - pc_x[j] * tez_xz_xz_1[j] + 0.5 * fl1_fx * tez_z_xz_0[j] - 0.5 * fl1_fx * tez_z_xz_1[j] +
                                  0.5 * fl1_fx * tez_xz_z_0[j] - 0.5 * fl1_fx * tez_xz_z_1[j];
            }
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tex_xxz_yy_0[j] =
                    pa_x[j] * tex_xz_yy_0[j] - pc_x[j] * tex_xz_yy_1[j] + 0.5 * fl1_fx * tex_z_yy_0[j] - 0.5 * fl1_fx * tex_z_yy_1[j] + ta_xz_yy_1[j];
                ...
                tex_xxz_yz_0[j] =
                    pa_x[j] * tex_xz_yz_0[j] - pc_x[j] * tex_xz_yz_1[j] + 0.5 * fl1_fx * tex_z_yz_0[j] - 0.5 * fl1_fx * tex_z_yz_1[j] + ta_xz_yz_1[j];
                ...
                tex_xxz_zz_0[j] =
                    pa_x[j] * tex_xz_zz_0[j] - pc_x[j] * tex_xz_zz_1[j] + 0.5 * fl1_fx * tex_z_zz_0[j] - 0.5 * fl1_fx * tex_z_zz_1[j] + ta_xz_zz_1[j];
                ...
                tex_xyy_xx_0[j] =
                    pa_x[j] * tex_yy_xx_0[j] - pc_x[j] * tex_yy_xx_1[j] + fl1_fx * tex_yy_x_0[j] - fl1_fx * tex_yy_x_1[j] + ta_yy_xx_1[j];
                ...
                tex_xyy_xy_0[j] =
                    pa_x[j] * tex_yy_xy_0[j] - pc_x[j] * tex_yy_xy_1[j] + 0.5 * fl1_fx * tex_yy_y_0[j] - 0.5 * fl1_fx * tex_yy_y_1[j] + ta_yy_xy_1[j];
                ...
                tex_xyy_xz_0[j] =
                    pa_x[j] * tex_yy_xz_0[j] - pc_x[j] * tex_yy_xz_1[j] + 0.5 * fl1_fx * tex_yy_z_0[j] - 0.5 * fl1_fx * tex_yy_z_1[j] + ta_yy_xz_1[j];
                ...
                tex_xyz_xx_0[j] =
                    pa_x[j] * tex_yz_xx_0[j] - pc_x[j] * tex_yz_xx_1[j] + fl1_fx * tex_yz_x_0[j] - fl1_fx * tex_yz_x_1[j] + ta_yz_xx_1[j];
                ...
                tex_xyz_xy_0[j] =
                    pa_x[j] * tex_yz_xy_0[j] - pc_x[j] * tex_yz_xy_1[j] + 0.5 * fl1_fx * tex_yz_y_0[j] - 0.5 * fl1_fx * tex_yz_y_1[j] + ta_yz_xy_1[j];
                ...
                tex_xyz_xz_0[j] =
                    pa_x[j] * tex_yz_xz_0[j] - pc_x[j] * tex_yz_xz_1[j] + 0.5 * fl1_fx * tex_yz_z_0[j] - 0.5 * fl1_fx * tex_yz_z_1[j] + ta_yz_xz_1[j];
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tex_xzz_xx_0[j] =
                    pa_x[j] * tex_zz_xx_0[j] - pc_x[j] * tex_zz_xx_1[j] + fl1_fx * tex_zz_x_0[j] - fl1_fx * tex_zz_x_1[j] + ta_zz_xx_1[j];
                ...
                tex_xzz_xy_0[j] =
                    pa_x[j] * tex_zz_xy_0[j] - pc_x[j] * tex_zz_xy_1[j] + 0.5 * fl1_fx * tex_zz_y_0[j] - 0.5 * fl1_fx * tex_zz_y_1[j] + ta_zz_xy_1[j];
                ...
                tex_xzz_xz_0[j] =
                    pa_x[j] * tex_zz_xz_0[j] - pc_x[j] * tex_zz_xz_1[j] + 0.5 * fl1_fx * tex_zz_z_0[j] - 0.5 * fl1_fx * tex_zz_z_1[j] + ta_zz_xz_1[j];
                ...
                tey_yyy_xx_0[j] =
                    pa_y[j] * tey_yy_xx_0[j] - pc_y[j] * tey_yy_xx_1[j] + fl1_fx * tey_y_xx_0[j] - fl1_fx * tey_y_xx_1[j] + ta_yy_xx_1[j];

                tez_yyy_xx_0[j] = pa_y[j] * tez_yy_xx_0[j] - pc_y[j] * tez_yy_xx_1[j] + fl1_fx * tez_y_xx_0[j] - fl1_fx * tez_y_xx_1[j];

                tex_yyy_xy_0[j] = pa_y[j] * tex_yy_xy_0[j] - pc_y[j] * tex_yy_xy_1[j] + fl1_fx * tex_y_xy_0[j] - fl1_fx * tex_y_xy_1[j] +
                                  0.5 * fl1_fx * tex_yy_x_0[j] - 0.5 * fl1_fx * tex_yy_x_1[j];

                tey_yyy_xy_0[j] = pa_y[j] * tey_yy_xy_0[j] - pc_y[j] * tey_yy_xy_1[j] + fl1_fx * tey_y_xy_0[j] - fl1_fx * tey_y_xy_1[j] +
                                  0.5 * fl1_fx * tey_yy_x_0[j] - 0.5 * fl1_fx * tey_yy_x_1[j] + ta_yy_xy_1[j];

                tez_yyy_xy_0[j] = pa_y[j] * tez_yy_xy_0[j] - pc_y[j] * tez_yy_xy_1[j] + fl1_fx * tez_y_xy_0[j] - fl1_fx * tez_y_xy_1[j] +
                                  0.5 * fl1_fx * tez_yy_x_0[j] - 0.5 * fl1_fx * tez_yy_x_1[j];

                tex_yyy_xz_0[j] = pa_y[j] * tex_yy_xz_0[j] - pc_y[j] * tex_yy_xz_1[j] + fl1_fx * tex_y_xz_0[j] - fl1_fx * tex_y_xz_1[j];

                tey_yyy_xz_0[j] =
                    pa_y[j] * tey_yy_xz_0[j] - pc_y[j] * tey_yy_xz_1[j] + fl1_fx * tey_y_xz_0[j] - fl1_fx * tey_y_xz_1[j] + ta_yy_xz_1[j];

                tez_yyy_xz_0[j] = pa_y[j] * tez_yy_xz_0[j] - pc_y[j] * tez_yy_xz_1[j] + fl1_fx * tez_y_xz_0[j] - fl1_fx * tez_y_xz_1[j];

                tex_yyy_yy_0[j] = pa_y[j] * tex_yy_yy_0[j] - pc_y[j] * tex_yy_yy_1[j] + fl1_fx * tex_y_yy_0[j] - fl1_fx * tex_y_yy_1[j] +
                                  fl1_fx * tex_yy_y_0[j] - fl1_fx * tex_yy_y_1[j];

                tey_yyy_yy_0[j] = pa_y[j] * tey_yy_yy_0[j] - pc_y[j] * tey_yy_yy_1[j] + fl1_fx * tey_y_yy_0[j] - fl1_fx * tey_y_yy_1[j] +
                                  fl1_fx * tey_yy_y_0[j] - fl1_fx * tey_yy_y_1[j] + ta_yy_yy_1[j];

                tez_yyy_yy_0[j] = pa_y[j] * tez_yy_yy_0[j] - pc_y[j] * tez_yy_yy_1[j] + fl1_fx * tez_y_yy_0[j] - fl1_fx * tez_y_yy_1[j] +
                                  fl1_fx * tez_yy_y_0[j] - fl1_fx * tez_yy_y_1[j];

                tex_yyy_yz_0[j] = pa_y[j] * tex_yy_yz_0[j] - pc_y[j] * tex_yy_yz_1[j] + fl1_fx * tex_y_yz_0[j] - fl1_fx * tex_y_yz_1[j] +
                                  0.5 * fl1_fx * tex_yy_z_0[j] - 0.5 * fl1_fx * tex_yy_z_1[j];

                tey_yyy_yz_0[j] = pa_y[j] * tey_yy_yz_0[j] - pc_y[j] * tey_yy_yz_1[j] + fl1_fx * tey_y_yz_0[j] - fl1_fx * tey_y_yz_1[j] +
                                  0.5 * fl1_fx * tey_yy_z_0[j] - 0.5 * fl1_fx * tey_yy_z_1[j] + ta_yy_yz_1[j];

                tez_yyy_yz_0[j] = pa_y[j] * tez_yy_yz_0[j] - pc_y[j] * tez_yy_yz_1[j] + fl1_fx * tez_y_yz_0[j] - fl1_fx * tez_y_yz_1[j] +
                                  0.5 * fl1_fx * tez_yy_z_0[j] - 0.5 * fl1_fx * tez_yy_z_1[j];

                tex_yyy_zz_0[j] = pa_y[j] * tex_yy_zz_0[j] - pc_y[j] * tex_yy_zz_1[j] + fl1_fx * tex_y_zz_0[j] - fl1_fx * tex_y_zz_1[j];

                tey_yyy_zz_0[j] =
                    pa_y[j] * tey_yy_zz_0[j] - pc_y[j] * tey_yy_zz_1[j] + fl1_fx * tey_y_zz_0[j] - fl1_fx * tey_y_zz_1[j] + ta_yy_zz_1[j];
                ...
                tey_yyz_xx_0[j] =
                    pa_y[j] * tey_yz_xx_0[j] - pc_y[j] * tey_yz_xx_1[j] + 0.5 * fl1_fx * tey_z_xx_0[j] - 0.5 * fl1_fx * tey_z_xx_1[j] + ta_yz_xx_1[j];

                tez_yyz_xx_0[j] = pa_y[j] * tez_yz_xx_0[j] - pc_y[j] * tez_yz_xx_1[j] + 0.5 * fl1_fx * tez_z_xx_0[j] - 0.5 * fl1_fx * tez_z_xx_1[j];

                tex_yyz_xy_0[j] = pa_y[j] * tex_yz_xy_0[j] - pc_y[j] * tex_yz_xy_1[j] + 0.5 * fl1_fx * tex_z_xy_0[j] - 0.5 * fl1_fx * tex_z_xy_1[j] +
                                  0.5 * fl1_fx * tex_yz_x_0[j] - 0.5 * fl1_fx * tex_yz_x_1[j];

                tey_yyz_xy_0[j] = pa_y[j] * tey_yz_xy_0[j] - pc_y[j] * tey_yz_xy_1[j] + 0.5 * fl1_fx * tey_z_xy_0[j] - 0.5 * fl1_fx * tey_z_xy_1[j] +
                                  0.5 * fl1_fx * tey_yz_x_0[j] - 0.5 * fl1_fx * tey_yz_x_1[j] + ta_yz_xy_1[j];

                tez_yyz_xy_0[j] = pa_y[j] * tez_yz_xy_0[j] - pc_y[j] * tez_yz_xy_1[j] + 0.5 * fl1_fx * tez_z_xy_0[j] - 0.5 * fl1_fx * tez_z_xy_1[j] +
                                  0.5 * fl1_fx * tez_yz_x_0[j] - 0.5 * fl1_fx * tez_yz_x_1[j];

                tex_yyz_xz_0[j] = pa_y[j] * tex_yz_xz_0[j] - pc_y[j] * tex_yz_xz_1[j] + 0.5 * fl1_fx * tex_z_xz_0[j] - 0.5 * fl1_fx * tex_z_xz_1[j];

                tey_yyz_xz_0[j] =
                    pa_y[j] * tey_yz_xz_0[j] - pc_y[j] * tey_yz_xz_1[j] + 0.5 * fl1_fx * tey_z_xz_0[j] - 0.5 * fl1_fx * tey_z_xz_1[j] + ta_yz_xz_1[j];
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tex_yyz_yy_0[j] = pa_y[j] * tex_yz_yy_0[j] - pc_y[j] * tex_yz_yy_1[j] + 0.5 * fl1_fx * tex_z_yy_0[j] - 0.5 * fl1_fx * tex_z_yy_1[j] +
                                  fl1_fx * tex_yz_y_0[j] - fl1_fx * tex_yz_y_1[j];

                tey_yyz_yy_0[j] = pa_y[j] * tey_yz_yy_0[j] - pc_y[j] * tey_yz_yy_1[j] + 0.5 * fl1_fx * tey_z_yy_0[j] - 0.5 * fl1_fx * tey_z_yy_1[j] +
                                  fl1_fx * tey_yz_y_0[j] - fl1_fx * tey_yz_y_1[j] + ta_yz_yy_1[j];

                tez_yyz_yy_0[j] = pa_y[j] * tez_yz_yy_0[j] - pc_y[j] * tez_yz_yy_1[j] + 0.5 * fl1_fx * tez_z_yy_0[j] - 0.5 * fl1_fx * tez_z_yy_1[j] +
                                  fl1_fx * tez_yz_y_0[j] - fl1_fx * tez_yz_y_1[j];

                tex_yyz_yz_0[j] = pa_y[j] * tex_yz_yz_0[j] - pc_y[j] * tex_yz_yz_1[j] + 0.5 * fl1_fx * tex_z_yz_0[j] - 0.5 * fl1_fx * tex_z_yz_1[j] +
                                  0.5 * fl1_fx * tex_yz_z_0[j] - 0.5 * fl1_fx * tex_yz_z_1[j];

                tey_yyz_yz_0[j] = pa_y[j] * tey_yz_yz_0[j] - pc_y[j] * tey_yz_yz_1[j] + 0.5 * fl1_fx * tey_z_yz_0[j] - 0.5 * fl1_fx * tey_z_yz_1[j] +
                                  0.5 * fl1_fx * tey_yz_z_0[j] - 0.5 * fl1_fx * tey_yz_z_1[j] + ta_yz_yz_1[j];

                tez_yyz_yz_0[j] = pa_y[j] * tez_yz_yz_0[j] - pc_y[j] * tez_yz_yz_1[j] + 0.5 * fl1_fx * tez_z_yz_0[j] - 0.5 * fl1_fx * tez_z_yz_1[j] +
                                  0.5 * fl1_fx * tez_yz_z_0[j] - 0.5 * fl1_fx * tez_yz_z_1[j];

                tex_yyz_zz_0[j] = pa_y[j] * tex_yz_zz_0[j] - pc_y[j] * tex_yz_zz_1[j] + 0.5 * fl1_fx * tex_z_zz_0[j] - 0.5 * fl1_fx * tex_z_zz_1[j];

                tey_yyz_zz_0[j] =
                    pa_y[j] * tey_yz_zz_0[j] - pc_y[j] * tey_yz_zz_1[j] + 0.5 * fl1_fx * tey_z_zz_0[j] - 0.5 * fl1_fx * tey_z_zz_1[j] + ta_yz_zz_1[j];
                ...
                tey_yzz_xy_0[j] =
                    pa_y[j] * tey_zz_xy_0[j] - pc_y[j] * tey_zz_xy_1[j] + 0.5 * fl1_fx * tey_zz_x_0[j] - 0.5 * fl1_fx * tey_zz_x_1[j] + ta_zz_xy_1[j];
                ...
                tey_yzz_yy_0[j] =
                    pa_y[j] * tey_zz_yy_0[j] - pc_y[j] * tey_zz_yy_1[j] + fl1_fx * tey_zz_y_0[j] - fl1_fx * tey_zz_y_1[j] + ta_zz_yy_1[j];
                ...
                tey_yzz_yz_0[j] =
                    pa_y[j] * tey_zz_yz_0[j] - pc_y[j] * tey_zz_yz_1[j] + 0.5 * fl1_fx * tey_zz_z_0[j] - 0.5 * fl1_fx * tey_zz_z_1[j] + ta_zz_yz_1[j];
                ...
                tez_zzz_xx_0[j] =
                    pa_z[j] * tez_zz_xx_0[j] - pc_z[j] * tez_zz_xx_1[j] + fl1_fx * tez_z_xx_0[j] - fl1_fx * tez_z_xx_1[j] + ta_zz_xx_1[j];
                ...
                tez_zzz_xy_0[j] =
                    pa_z[j] * tez_zz_xy_0[j] - pc_z[j] * tez_zz_xy_1[j] + fl1_fx * tez_z_xy_0[j] - fl1_fx * tez_z_xy_1[j] + ta_zz_xy_1[j];

                tex_zzz_xz_0[j] = pa_z[j] * tex_zz_xz_0[j] - pc_z[j] * tex_zz_xz_1[j] + fl1_fx * tex_z_xz_0[j] - fl1_fx * tex_z_xz_1[j] +
                                  0.5 * fl1_fx * tex_zz_x_0[j] - 0.5 * fl1_fx * tex_zz_x_1[j];

                tey_zzz_xz_0[j] = pa_z[j] * tey_zz_xz_0[j] - pc_z[j] * tey_zz_xz_1[j] + fl1_fx * tey_z_xz_0[j] - fl1_fx * tey_z_xz_1[j] +
                                  0.5 * fl1_fx * tey_zz_x_0[j] - 0.5 * fl1_fx * tey_zz_x_1[j];

                tez_zzz_xz_0[j] = pa_z[j] * tez_zz_xz_0[j] - pc_z[j] * tez_zz_xz_1[j] + fl1_fx * tez_z_xz_0[j] - fl1_fx * tez_z_xz_1[j] +
                                  0.5 * fl1_fx * tez_zz_x_0[j] - 0.5 * fl1_fx * tez_zz_x_1[j] + ta_zz_xz_1[j];
                ...
                tez_zzz_yy_0[j] =
                    pa_z[j] * tez_zz_yy_0[j] - pc_z[j] * tez_zz_yy_1[j] + fl1_fx * tez_z_yy_0[j] - fl1_fx * tez_z_yy_1[j] + ta_zz_yy_1[j];

                tex_zzz_yz_0[j] = pa_z[j] * tex_zz_yz_0[j] - pc_z[j] * tex_zz_yz_1[j] + fl1_fx * tex_z_yz_0[j] - fl1_fx * tex_z_yz_1[j] +
                                  0.5 * fl1_fx * tex_zz_y_0[j] - 0.5 * fl1_fx * tex_zz_y_1[j];

                tey_zzz_yz_0[j] = pa_z[j] * tey_zz_yz_0[j] - pc_z[j] * tey_zz_yz_1[j] + fl1_fx * tey_z_yz_0[j] - fl1_fx * tey_z_yz_1[j] +
                                  0.5 * fl1_fx * tey_zz_y_0[j] - 0.5 * fl1_fx * tey_zz_y_1[j];

                tez_zzz_yz_0[j] = pa_z[j] * tez_zz_yz_0[j] - pc_z[j] * tez_zz_yz_1[j] + fl1_fx * tez_z_yz_0[j] - fl1_fx * tez_z_yz_1[j] +
                                  0.5 * fl1_fx * tez_zz_y_0[j] - 0.5 * fl1_fx * tez_zz_y_1[j] + ta_zz_yz_1[j];

                tex_zzz_zz_0[j] = pa_z[j] * tex_zz_zz_0[j] - pc_z[j] * tex_zz_zz_1[j] + fl1_fx * tex_z_zz_0[j] - fl1_fx * tex_z_zz_1[j] +
                                  fl1_fx * tex_zz_z_0[j] - fl1_fx * tex_zz_z_1[j];

                tey_zzz_zz_0[j] = pa_z[j] * tey_zz_zz_0[j] - pc_z[j] * tey_zz_zz_1[j] + fl1_fx * tey_z_zz_0[j] - fl1_fx * tey_z_zz_1[j] +
                                  fl1_fx * tey_zz_z_0[j] - fl1_fx * tey_zz_z_1[j];

                tez_zzz_zz_0[j] = pa_z[j] * tez_zz_zz_0[j] - pc_z[j] * tez_zz_zz_1[j] + fl1_fx * tez_z_zz_0[j] - fl1_fx * tez_z_zz_1[j] +
                                  fl1_fx * tez_zz_z_0[j] - fl1_fx * tez_zz_z_1[j] + ta_zz_zz_1[j];
            }
...
compElectricFieldForDG(CMemBlock2D<double>&       primBuffer,
                       ...
                       const int32_t              iContrGto)
{
    efieldrecfunc::compElectricFieldForDG_0_45(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    efieldrecfunc::compElectricFieldForDG_45_90(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    efieldrecfunc::compElectricFieldForDG_90_135(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    efieldrecfunc::compElectricFieldForDG_135_180(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    efieldrecfunc::compElectricFieldForDG_180_225(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    efieldrecfunc::compElectricFieldForDG_225_270(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
                            ...
                            const int32_t              iContrGto)
{
    ...
    auto mord = recursionMap.getMaxOrder({"Electric Field"}, {2, -1, -1, -1}, {4, -1, -1, -1}, 1, 1);
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        auto pidx_e_1_4_m1 =
            recursionMap.getIndexOfTerm(CRecursionTerm({"Electric Field"}, 1, true, {1, -1, -1, -1}, {4, -1, -1, -1}, 1, 1, iord + 1));
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tex_xx_xxxx_0[j] = pa_x[j] * tex_x_xxxx_0[j] - pc_x[j] * tex_x_xxxx_1[j] + 0.5 * fl1_fx * tex_0_xxxx_0[j] -
                                   0.5 * fl1_fx * tex_0_xxxx_1[j] + 2.0 * fl1_fx * tex_x_xxx_0[j] - 2.0 * fl1_fx * tex_x_xxx_1[j] + ta_x_xxxx_1[j];

                tey_xx_xxxx_0[j] = pa_x[j] * tey_x_xxxx_0[j] - pc_x[j] * tey_x_xxxx_1[j] + 0.5 * fl1_fx * tey_0_xxxx_0[j] -
                                   0.5 * fl1_fx * tey_0_xxxx_1[j] + 2.0 * fl1_fx * tey_x_xxx_0[j] - 2.0 * fl1_fx * tey_x_xxx_1[j];

                tez_xx_xxxx_0[j] = pa_x[j] * tez_x_xxxx_0[j] - pc_x[j] * tez_x_xxxx_1[j] + 0.5 * fl1_fx * tez_0_xxxx_0[j] -
                                   0.5 * fl1_fx * tez_0_xxxx_1[j] + 2.0 * fl1_fx * tez_x_xxx_0[j] - 2.0 * fl1_fx * tez_x_xxx_1[j];

                tex_xx_xxxy_0[j] = pa_x[j] * tex_x_xxxy_0[j] - pc_x[j] * tex_x_xxxy_1[j] + 0.5 * fl1_fx * tex_0_xxxy_0[j] -
                                   0.5 * fl1_fx * tex_0_xxxy_1[j] + 1.5 * fl1_fx * tex_x_xxy_0[j] - 1.5 * fl1_fx * tex_x_xxy_1[j] + ta_x_xxxy_1[j];

                tey_xx_xxxy_0[j] = pa_x[j] * tey_x_xxxy_0[j] - pc_x[j] * tey_x_xxxy_1[j] + 0.5 * fl1_fx * tey_0_xxxy_0[j] -
                                   0.5 * fl1_fx * tey_0_xxxy_1[j] + 1.5 * fl1_fx * tey_x_xxy_0[j] - 1.5 * fl1_fx * tey_x_xxy_1[j];

                tez_xx_xxxy_0[j] = pa_x[j] * tez_x_xxxy_0[j] - pc_x[j] * tez_x_xxxy_1[j] + 0.5 * fl1_fx * tez_0_xxxy_0[j] -
                                   0.5 * fl1_fx * tez_0_xxxy_1[j] + 1.5 * fl1_fx * tez_x_xxy_0[j] - 1.5 * fl1_fx * tez_x_xxy_1[j];

                tex_xx_xxxz_0[j] = pa_x[j] * tex_x_xxxz_0[j] - pc_x[j] * tex_x_xxxz_1[j] + 0.5 * fl1_fx * tex_0_xxxz_0[j] -
                                   0.5 * fl1_fx * tex_0_xxxz_1[j] + 1.5 * fl1_fx * tex_x_xxz_0[j] - 1.5 * fl1_fx * tex_x_xxz_1[j] + ta_x_xxxz_1[j];

                tey_xx_xxxz_0[j] = pa_x[j] * tey_x_xxxz_0[j] - pc_x[j] * tey_x_xxxz_1[j] + 0.5 * fl1_fx * tey_0_xxxz_0[j] -
                                   0.5 * fl1_fx * tey_0_xxxz_1[j] + 1.5 * fl1_fx * tey_x_xxz_0[j] - 1.5 * fl1_fx * tey_x_xxz_1[j];

                tez_xx_xxxz_0[j] = pa_x[j] * tez_x_xxxz_0[j] - pc_x[j] * tez_x_xxxz_1[j] + 0.5 * fl1_fx * tez_0_xxxz_0[j] -
                                   0.5 * fl1_fx * tez_0_xxxz_1[j] + 1.5 * fl1_fx * tez_x_xxz_0[j] - 1.5 * fl1_fx * tez_x_xxz_1[j];

                tex_xx_xxyy_0[j] = pa_x[j] * tex_x_xxyy_0[j] - pc_x[j] * tex_x_xxyy_1[j] + 0.5 * fl1_fx * tex_0_xxyy_0[j] -
                                   0.5 * fl1_fx * tex_0_xxyy_1[j] + fl1_fx * tex_x_xyy_0[j] - fl1_fx * tex_x_xyy_1[j] + ta_x_xxyy_1[j];

                tey_xx_xxyy_0[j] = pa_x[j] * tey_x_xxyy_0[j] - pc_x[j] * tey_x_xxyy_1[j] + 0.5 * fl1_fx * tey_0_xxyy_0[j] -
                                   0.5 * fl1_fx * tey_0_xxyy_1[j] + fl1_fx * tey_x_xyy_0[j] - fl1_fx * tey_x_xyy_1[j];

                tez_xx_xxyy_0[j] = pa_x[j] * tez_x_xxyy_0[j] - pc_x[j] * tez_x_xxyy_1[j] + 0.5 * fl1_fx * tez_0_xxyy_0[j] -
                                   0.5 * fl1_fx * tez_0_xxyy_1[j] + fl1_fx * tez_x_xyy_0[j] - fl1_fx * tez_x_xyy_1[j];

                tex_xx_xxyz_0[j] = pa_x[j] * tex_x_xxyz_0[j] - pc_x[j] * tex_x_xxyz_1[j] + 0.5 * fl1_fx * tex_0_xxyz_0[j] -
                                   0.5 * fl1_fx * tex_0_xxyz_1[j] + fl1_fx * tex_x_xyz_0[j] - fl1_fx * tex_x_xyz_1[j] + ta_x_xxyz_1[j];

                tey_xx_xxyz_0[j] = pa_x[j] * tey_x_xxyz_0[j] - pc_x[j] * tey_x_xxyz_1[j] + 0.5 * fl1_fx * tey_0_xxyz_0[j] -
                                   0.5 * fl1_fx * tey_0_xxyz_1[j] + fl1_fx * tey_x_xyz_0[j] - fl1_fx * tey_x_xyz_1[j];

                tez_xx_xxyz_0[j] = pa_x[j] * tez_x_xxyz_0[j] - pc_x[j] * tez_x_xxyz_1[j] + 0.5 * fl1_fx * tez_0_xxyz_0[j] -
                                   0.5 * fl1_fx * tez_0_xxyz_1[j] + fl1_fx * tez_x_xyz_0[j] - fl1_fx * tez_x_xyz_1[j];

                tex_xx_xxzz_0[j] = pa_x[j] * tex_x_xxzz_0[j] - pc_x[j] * tex_x_xxzz_1[j] + 0.5 * fl1_fx * tex_0_xxzz_0[j] -
                                   0.5 * fl1_fx * tex_0_xxzz_1[j] + fl1_fx * tex_x_xzz_0[j] - fl1_fx * tex_x_xzz_1[j] + ta_x_xxzz_1[j];

                tey_xx_xxzz_0[j] = pa_x[j] * tey_x_xxzz_0[j] - pc_x[j] * tey_x_xxzz_1[j] + 0.5 * fl1_fx * tey_0_xxzz_0[j] -
                                   0.5 * fl1_fx * tey_0_xxzz_1[j] + fl1_fx * tey_x_xzz_0[j] - fl1_fx * tey_x_xzz_1[j];

                tez_xx_xxzz_0[j] = pa_x[j] * tez_x_xxzz_0[j] - pc_x[j] * tez_x_xxzz_1[j] + 0.5 * fl1_fx * tez_0_xxzz_0[j] -
                                   0.5 * fl1_fx * tez_0_xxzz_1[j] + fl1_fx * tez_x_xzz_0[j] - fl1_fx * tez_x_xzz_1[j];

                tex_xx_xyyy_0[j] = pa_x[j] * tex_x_xyyy_0[j] - pc_x[j] * tex_x_xyyy_1[j] + 0.5 * fl1_fx * tex_0_xyyy_0[j] -
                                   0.5 * fl1_fx * tex_0_xyyy_1[j] + 0.5 * fl1_fx * tex_x_yyy_0[j] - 0.5 * fl1_fx * tex_x_yyy_1[j] + ta_x_xyyy_1[j];

                tey_xx_xyyy_0[j] = pa_x[j] * tey_x_xyyy_0[j] - pc_x[j] * tey_x_xyyy_1[j] + 0.5 * fl1_fx * tey_0_xyyy_0[j] -
                                   0.5 * fl1_fx * tey_0_xyyy_1[j] + 0.5 * fl1_fx * tey_x_yyy_0[j] - 0.5 * fl1_fx * tey_x_yyy_1[j];

                tez_xx_xyyy_0[j] = pa_x[j] * tez_x_xyyy_0[j] - pc_x[j] * tez_x_xyyy_1[j] + 0.5 * fl1_fx * tez_0_xyyy_0[j] -
                                   0.5 * fl1_fx * tez_0_xyyy_1[j] + 0.5 * fl1_fx * tez_x_yyy_0[j] - 0.5 * fl1_fx * tez_x_yyy_1[j];

                tex_xx_xyyz_0[j] = pa_x[j] * tex_x_xyyz_0[j] - pc_x[j] * tex_x_xyyz_1[j] + 0.5 * fl1_fx * tex_0_xyyz_0[j] -
                                   0.5 * fl1_fx * tex_0_xyyz_1[j] + 0.5 * fl1_fx * tex_x_yyz_0[j] - 0.5 * fl1_fx * tex_x_yyz_1[j] + ta_x_xyyz_1[j];

                tey_xx_xyyz_0[j] = pa_x[j] * tey_x_xyyz_0[j] - pc_x[j] * tey_x_xyyz_1[j] + 0.5 * fl1_fx * tey_0_xyyz_0[j] -
                                   0.5 * fl1_fx * tey_0_xyyz_1[j] + 0.5 * fl1_fx * tey_x_yyz_0[j] - 0.5 * fl1_fx * tey_x_yyz_1[j];

                tez_xx_xyyz_0[j] = pa_x[j] * tez_x_xyyz_0[j] - pc_x[j] * tez_x_xyyz_1[j] + 0.5 * fl1_fx * tez_0_xyyz_0[j] -
                                   0.5 * fl1_fx * tez_0_xyyz_1[j] + 0.5 * fl1_fx * tez_x_yyz_0[j] - 0.5 * fl1_fx * tez_x_yyz_1[j];

                tex_xx_xyzz_0[j] = pa_x[j] * tex_x_xyzz_0[j] - pc_x[j] * tex_x_xyzz_1[j] + 0.5 * fl1_fx * tex_0_xyzz_0[j] -
                                   0.5 * fl1_fx * tex_0_xyzz_1[j] + 0.5 * fl1_fx * tex_x_yzz_0[j] - 0.5 * fl1_fx * tex_x_yzz_1[j] + ta_x_xyzz_1[j];

                tey_xx_xyzz_0[j] = pa_x[j] * tey_x_xyzz_0[j] - pc_x[j] * tey_x_xyzz_1[j] + 0.5 * fl1_fx * tey_0_xyzz_0[j] -
                                   0.5 * fl1_fx * tey_0_xyzz_1[j] + 0.5 * fl1_fx * tey_x_yzz_0[j] - 0.5 * fl1_fx * tey_x_yzz_1[j];

                tez_xx_xyzz_0[j] = pa_x[j] * tez_x_xyzz_0[j] - pc_x[j] * tez_x_xyzz_1[j] + 0.5 * fl1_fx * tez_0_xyzz_0[j] -
                                   0.5 * fl1_fx * tez_0_xyzz_1[j] + 0.5 * fl1_fx * tez_x_yzz_0[j] - 0.5 * fl1_fx * tez_x_yzz_1[j];

                tex_xx_xzzz_0[j] = pa_x[j] * tex_x_xzzz_0[j] - pc_x[j] * tex_x_xzzz_1[j] + 0.5 * fl1_fx * tex_0_xzzz_0[j] -
                                   0.5 * fl1_fx * tex_0_xzzz_1[j] + 0.5 * fl1_fx * tex_x_zzz_0[j] - 0.5 * fl1_fx * tex_x_zzz_1[j] + ta_x_xzzz_1[j];

                tey_xx_xzzz_0[j] = pa_x[j] * tey_x_xzzz_0[j] - pc_x[j] * tey_x_xzzz_1[j] + 0.5 * fl1_fx * tey_0_xzzz_0[j] -
                                   0.5 * fl1_fx * tey_0_xzzz_1[j] + 0.5 * fl1_fx * tey_x_zzz_0[j] - 0.5 * fl1_fx * tey_x_zzz_1[j];

                tez_xx_xzzz_0[j] = pa_x[j] * tez_x_xzzz_0[j] - pc_x[j] * tez_x_xzzz_1[j] + 0.5 * fl1_fx * tez_0_xzzz_0[j] -
                                   0.5 * fl1_fx * tez_0_xzzz_1[j] + 0.5 * fl1_fx * tez_x_zzz_0[j] - 0.5 * fl1_fx * tez_x_zzz_1[j];

                tex_xx_yyyy_0[j] = pa_x[j] * tex_x_yyyy_0[j] - pc_x[j] * tex_x_yyyy_1[j] + 0.5 * fl1_fx * tex_0_yyyy_0[j] -
                                   0.5 * fl1_fx * tex_0_yyyy_1[j] + ta_x_yyyy_1[j];

                tey_xx_yyyy_0[j] =
                    pa_x[j] * tey_x_yyyy_0[j] - pc_x[j] * tey_x_yyyy_1[j] + 0.5 * fl1_fx * tey_0_yyyy_0[j] - 0.5 * fl1_fx * tey_0_yyyy_1[j];

                tez_xx_yyyy_0[j] =
                    pa_x[j] * tez_x_yyyy_0[j] - pc_x[j] * tez_x_yyyy_1[j] + 0.5 * fl1_fx * tez_0_yyyy_0[j] - 0.5 * fl1_fx * tez_0_yyyy_1[j];

                tex_xx_yyyz_0[j] = pa_x[j] * tex_x_yyyz_0[j] - pc_x[j] * tex_x_yyyz_1[j] + 0.5 * fl1_fx * tex_0_yyyz_0[j] -
                                   0.5 * fl1_fx * tex_0_yyyz_1[j] + ta_x_yyyz_1[j];

                tey_xx_yyyz_0[j] =
                    pa_x[j] * tey_x_yyyz_0[j] - pc_x[j] * tey_x_yyyz_1[j] + 0.5 * fl1_fx * tey_0_yyyz_0[j] - 0.5 * fl1_fx * tey_0_yyyz_1[j];

                tez_xx_yyyz_0[j] =
                    pa_x[j] * tez_x_yyyz_0[j] - pc_x[j] * tez_x_yyyz_1[j] + 0.5 * fl1_fx * tez_0_yyyz_0[j] - 0.5 * fl1_fx * tez_0_yyyz_1[j];

                tex_xx_yyzz_0[j] = pa_x[j] * tex_x_yyzz_0[j] - pc_x[j] * tex_x_yyzz_1[j] + 0.5 * fl1_fx * tex_0_yyzz_0[j] -
                                   0.5 * fl1_fx * tex_0_yyzz_1[j] + ta_x_yyzz_1[j];

                tey_xx_yyzz_0[j] =
                    pa_x[j] * tey_x_yyzz_0[j] - pc_x[j] * tey_x_yyzz_1[j] + 0.5 * fl1_fx * tey_0_yyzz_0[j] - 0.5 * fl1_fx * tey_0_yyzz_1[j];

                tez_xx_yyzz_0[j] =
                    pa_x[j] * tez_x_yyzz_0[j] - pc_x[j] * tez_x_yyzz_1[j] + 0.5 * fl1_fx * tez_0_yyzz_0[j] - 0.5 * fl1_fx * tez_0_yyzz_1[j];

                tex_xx_yzzz_0[j] = pa_x[j] * tex_x_yzzz_0[j] - pc_x[j] * tex_x_yzzz_1[j] + 0.5 * fl1_fx * tex_0_yzzz_0[j] -
                                   0.5 * fl1_fx * tex_0_yzzz_1[j] + ta_x_yzzz_1[j];

                tey_xx_yzzz_0[j] =
                    pa_x[j] * tey_x_yzzz_0[j] - pc_x[j] * tey_x_yzzz_1[j] + 0.5 * fl1_fx * tey_0_yzzz_0[j] - 0.5 * fl1_fx * tey_0_yzzz_1[j];

                tez_xx_yzzz_0[j] =
                    pa_x[j] * tez_x_yzzz_0[j] - pc_x[j] * tez_x_yzzz_1[j] + 0.5 * fl1_fx * tez_0_yzzz_0[j] - 0.5 * fl1_fx * tez_0_yzzz_1[j];

                tex_xx_zzzz_0[j] = pa_x[j] * tex_x_zzzz_0[j] - pc_x[j] * tex_x_zzzz_1[j] + 0.5 * fl1_fx * tex_0_zzzz_0[j] -
                                   0.5 * fl1_fx * tex_0_zzzz_1[j] + ta_x_zzzz_1[j];

                tey_xx_zzzz_0[j] =
                    pa_x[j] * tey_x_zzzz_0[j] - pc_x[j] * tey_x_zzzz_1[j] + 0.5 * fl1_fx * tey_0_zzzz_0[j] - 0.5 * fl1_fx * tey_0_zzzz_1[j];

                tez_xx_zzzz_0[j] =
                    pa_x[j] * tez_x_zzzz_0[j] - pc_x[j] * tez_x_zzzz_1[j] + 0.5 * fl1_fx * tez_0_zzzz_0[j] - 0.5 * fl1_fx * tez_0_zzzz_1[j];
            }
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tex_xy_xxxx_0[j] = pa_x[j] * tex_y_xxxx_0[j] - pc_x[j] * tex_y_xxxx_1[j] + 2.0 * fl1_fx * tex_y_xxx_0[j] -
                                   2.0 * fl1_fx * tex_y_xxx_1[j] + ta_y_xxxx_1[j];

                tey_xy_xxxx_0[j] =
                    pa_x[j] * tey_y_xxxx_0[j] - pc_x[j] * tey_y_xxxx_1[j] + 2.0 * fl1_fx * tey_y_xxx_0[j] - 2.0 * fl1_fx * tey_y_xxx_1[j];

                tez_xy_xxxx_0[j] =
                    pa_x[j] * tez_y_xxxx_0[j] - pc_x[j] * tez_y_xxxx_1[j] + 2.0 * fl1_fx * tez_y_xxx_0[j] - 2.0 * fl1_fx * tez_y_xxx_1[j];

                tex_xy_xxxy_0[j] = pa_x[j] * tex_y_xxxy_0[j] - pc_x[j] * tex_y_xxxy_1[j] + 1.5 * fl1_fx * tex_y_xxy_0[j] -
                                   1.5 * fl1_fx * tex_y_xxy_1[j] + ta_y_xxxy_1[j];

                tey_xy_xxxy_0[j] =
                    pa_x[j] * tey_y_xxxy_0[j] - pc_x[j] * tey_y_xxxy_1[j] + 1.5 * fl1_fx * tey_y_xxy_0[j] - 1.5 * fl1_fx * tey_y_xxy_1[j];

                tez_xy_xxxy_0[j] =
                    pa_x[j] * tez_y_xxxy_0[j] - pc_x[j] * tez_y_xxxy_1[j] + 1.5 * fl1_fx * tez_y_xxy_0[j] - 1.5 * fl1_fx * tez_y_xxy_1[j];

                tex_xy_xxxz_0[j] = pa_x[j] * tex_y_xxxz_0[j] - pc_x[j] * tex_y_xxxz_1[j] + 1.5 * fl1_fx * tex_y_xxz_0[j] -
                                   1.5 * fl1_fx * tex_y_xxz_1[j] + ta_y_xxxz_1[j];

                tey_xy_xxxz_0[j] =
                    pa_x[j] * tey_y_xxxz_0[j] - pc_x[j] * tey_y_xxxz_1[j] + 1.5 * fl1_fx * tey_y_xxz_0[j] - 1.5 * fl1_fx * tey_y_xxz_1[j];

                tez_xy_xxxz_0[j] =
                    pa_x[j] * tez_y_xxxz_0[j] - pc_x[j] * tez_y_xxxz_1[j] + 1.5 * fl1_fx * tez_y_xxz_0[j] - 1.5 * fl1_fx * tez_y_xxz_1[j];

                tex_xy_xxyy_0[j] =
                    pa_x[j] * tex_y_xxyy_0[j] - pc_x[j] * tex_y_xxyy_1[j] + fl1_fx * tex_y_xyy_0[j] - fl1_fx * tex_y_xyy_1[j] + ta_y_xxyy_1[j];
                ...
                tex_xy_xxyz_0[j] =
                    pa_x[j] * tex_y_xxyz_0[j] - pc_x[j] * tex_y_xxyz_1[j] + fl1_fx * tex_y_xyz_0[j] - fl1_fx * tex_y_xyz_1[j] + ta_y_xxyz_1[j];
                ...
                tex_xy_xxzz_0[j] =
                    pa_x[j] * tex_y_xxzz_0[j] - pc_x[j] * tex_y_xxzz_1[j] + fl1_fx * tex_y_xzz_0[j] - fl1_fx * tex_y_xzz_1[j] + ta_y_xxzz_1[j];
                ...
                tex_xy_xyyy_0[j] = pa_x[j] * tex_y_xyyy_0[j] - pc_x[j] * tex_y_xyyy_1[j] + 0.5 * fl1_fx * tex_y_yyy_0[j] -
                                   0.5 * fl1_fx * tex_y_yyy_1[j] + ta_y_xyyy_1[j];

                tey_xy_xyyy_0[j] =
                    pa_x[j] * tey_y_xyyy_0[j] - pc_x[j] * tey_y_xyyy_1[j] + 0.5 * fl1_fx * tey_y_yyy_0[j] - 0.5 * fl1_fx * tey_y_yyy_1[j];

                tez_xy_xyyy_0[j] =
                    pa_x[j] * tez_y_xyyy_0[j] - pc_x[j] * tez_y_xyyy_1[j] + 0.5 * fl1_fx * tez_y_yyy_0[j] - 0.5 * fl1_fx * tez_y_yyy_1[j];

                tex_xy_xyyz_0[j] = pa_x[j] * tex_y_xyyz_0[j] - pc_x[j] * tex_y_xyyz_1[j] + 0.5 * fl1_fx * tex_y_yyz_0[j] -
                                   0.5 * fl1_fx * tex_y_yyz_1[j] + ta_y_xyyz_1[j];

                tey_xy_xyyz_0[j] =
                    pa_x[j] * tey_y_xyyz_0[j] - pc_x[j] * tey_y_xyyz_1[j] + 0.5 * fl1_fx * tey_y_yyz_0[j] - 0.5 * fl1_fx * tey_y_yyz_1[j];

                tez_xy_xyyz_0[j] =
                    pa_x[j] * tez_y_xyyz_0[j] - pc_x[j] * tez_y_xyyz_1[j] + 0.5 * fl1_fx * tez_y_yyz_0[j] - 0.5 * fl1_fx * tez_y_yyz_1[j];

                tex_xy_xyzz_0[j] = pa_x[j] * tex_y_xyzz_0[j] - pc_x[j] * tex_y_xyzz_1[j] + 0.5 * fl1_fx * tex_y_yzz_0[j] -
                                   0.5 * fl1_fx * tex_y_yzz_1[j] + ta_y_xyzz_1[j];

                tey_xy_xyzz_0[j] =
                    pa_x[j] * tey_y_xyzz_0[j] - pc_x[j] * tey_y_xyzz_1[j] + 0.5 * fl1_fx * tey_y_yzz_0[j] - 0.5 * fl1_fx * tey_y_yzz_1[j];

                tez_xy_xyzz_0[j] =
                    pa_x[j] * tez_y_xyzz_0[j] - pc_x[j] * tez_y_xyzz_1[j] + 0.5 * fl1_fx * tez_y_yzz_0[j] - 0.5 * fl1_fx * tez_y_yzz_1[j];

                tex_xy_xzzz_0[j] = pa_x[j] * tex_y_xzzz_0[j] - pc_x[j] * tex_y_xzzz_1[j] + 0.5 * fl1_fx * tex_y_zzz_0[j] -
                                   0.5 * fl1_fx * tex_y_zzz_1[j] + ta_y_xzzz_1[j];

                tey_xy_xzzz_0[j] =
                    pa_x[j] * tey_y_xzzz_0[j] - pc_x[j] * tey_y_xzzz_1[j] + 0.5 * fl1_fx * tey_y_zzz_0[j] - 0.5 * fl1_fx * tey_y_zzz_1[j];

                tez_xy_xzzz_0[j] =
                    pa_x[j] * tez_y_xzzz_0[j] - pc_x[j] * tez_y_xzzz_1[j] + 0.5 * fl1_fx * tez_y_zzz_0[j] - 0.5 * fl1_fx * tez_y_zzz_1[j];
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tex_xz_xxxx_0[j] = pa_x[j] * tex_z_xxxx_0[j] - pc_x[j] * tex_z_xxxx_1[j] + 2.0 * fl1_fx * tex_z_xxx_0[j] -
                                   2.0 * fl1_fx * tex_z_xxx_1[j] + ta_z_xxxx_1[j];

                tey_xz_xxxx_0[j] =
                    pa_x[j] * tey_z_xxxx_0[j] - pc_x[j] * tey_z_xxxx_1[j] + 2.0 * fl1_fx * tey_z_xxx_0[j] - 2.0 * fl1_fx * tey_z_xxx_1[j];

                tez_xz_xxxx_0[j] =
                    pa_x[j] * tez_z_xxxx_0[j] - pc_x[j] * tez_z_xxxx_1[j] + 2.0 * fl1_fx * tez_z_xxx_0[j] - 2.0 * fl1_fx * tez_z_xxx_1[j];

                tex_xz_xxxy_0[j] = pa_x[j] * tex_z_xxxy_0[j] - pc_x[j] * tex_z_xxxy_1[j] + 1.5 * fl1_fx * tex_z_xxy_0[j] -
                                   1.5 * fl1_fx * tex_z_xxy_1[j] + ta_z_xxxy_1[j];

                tey_xz_xxxy_0[j] =
                    pa_x[j] * tey_z_xxxy_0[j] - pc_x[j] * tey_z_xxxy_1[j] + 1.5 * fl1_fx * tey_z_xxy_0[j] - 1.5 * fl1_fx * tey_z_xxy_1[j];

                tez_xz_xxxy_0[j] =
                    pa_x[j] * tez_z_xxxy_0[j] - pc_x[j] * tez_z_xxxy_1[j] + 1.5 * fl1_fx * tez_z_xxy_0[j] - 1.5 * fl1_fx * tez_z_xxy_1[j];

                tex_xz_xxxz_0[j] = pa_x[j] * tex_z_xxxz_0[j] - pc_x[j] * tex_z_xxxz_1[j] + 1.5 * fl1_fx * tex_z_xxz_0[j] -
                                   1.5 * fl1_fx * tex_z_xxz_1[j] + ta_z_xxxz_1[j];

                tey_xz_xxxz_0[j] =
                    pa_x[j] * tey_z_xxxz_0[j] - pc_x[j] * tey_z_xxxz_1[j] + 1.5 * fl1_fx * tey_z_xxz_0[j] - 1.5 * fl1_fx * tey_z_xxz_1[j];

                tez_xz_xxxz_0[j] =
                    pa_x[j] * tez_z_xxxz_0[j] - pc_x[j] * tez_z_xxxz_1[j] + 1.5 * fl1_fx * tez_z_xxz_0[j] - 1.5 * fl1_fx * tez_z_xxz_1[j];

                tex_xz_xxyy_0[j] =
                    pa_x[j] * tex_z_xxyy_0[j] - pc_x[j] * tex_z_xxyy_1[j] + fl1_fx * tex_z_xyy_0[j] - fl1_fx * tex_z_xyy_1[j] + ta_z_xxyy_1[j];
                ...
                tex_xz_xxyz_0[j] =
                    pa_x[j] * tex_z_xxyz_0[j] - pc_x[j] * tex_z_xxyz_1[j] + fl1_fx * tex_z_xyz_0[j] - fl1_fx * tex_z_xyz_1[j] + ta_z_xxyz_1[j];
                ...
                tex_xz_xxzz_0[j] =
                    pa_x[j] * tex_z_xxzz_0[j] - pc_x[j] * tex_z_xxzz_1[j] + fl1_fx * tex_z_xzz_0[j] - fl1_fx * tex_z_xzz_1[j] + ta_z_xxzz_1[j];
                ...
                tex_xz_xyyy_0[j] = pa_x[j] * tex_z_xyyy_0[j] - pc_x[j] * tex_z_xyyy_1[j] + 0.5 * fl1_fx * tex_z_yyy_0[j] -
                                   0.5 * fl1_fx * tex_z_yyy_1[j] + ta_z_xyyy_1[j];

                tey_xz_xyyy_0[j] =
                    pa_x[j] * tey_z_xyyy_0[j] - pc_x[j] * tey_z_xyyy_1[j] + 0.5 * fl1_fx * tey_z_yyy_0[j] - 0.5 * fl1_fx * tey_z_yyy_1[j];

                tez_xz_xyyy_0[j] =
                    pa_x[j] * tez_z_xyyy_0[j] - pc_x[j] * tez_z_xyyy_1[j] + 0.5 * fl1_fx * tez_z_yyy_0[j] - 0.5 * fl1_fx * tez_z_yyy_1[j];

                tex_xz_xyyz_0[j] = pa_x[j] * tex_z_xyyz_0[j] - pc_x[j] * tex_z_xyyz_1[j] + 0.5 * fl1_fx * tex_z_yyz_0[j] -
                                   0.5 * fl1_fx * tex_z_yyz_1[j] + ta_z_xyyz_1[j];

                tey_xz_xyyz_0[j] =
                    pa_x[j] * tey_z_xyyz_0[j] - pc_x[j] * tey_z_xyyz_1[j] + 0.5 * fl1_fx * tey_z_yyz_0[j] - 0.5 * fl1_fx * tey_z_yyz_1[j];

                tez_xz_xyyz_0[j] =
                    pa_x[j] * tez_z_xyyz_0[j] - pc_x[j] * tez_z_xyyz_1[j] + 0.5 * fl1_fx * tez_z_yyz_0[j] - 0.5 * fl1_fx * tez_z_yyz_1[j];

                tex_xz_xyzz_0[j] = pa_x[j] * tex_z_xyzz_0[j] - pc_x[j] * tex_z_xyzz_1[j] + 0.5 * fl1_fx * tex_z_yzz_0[j] -
                                   0.5 * fl1_fx * tex_z_yzz_1[j] + ta_z_xyzz_1[j];

                tey_xz_xyzz_0[j] =
                    pa_x[j] * tey_z_xyzz_0[j] - pc_x[j] * tey_z_xyzz_1[j] + 0.5 * fl1_fx * tey_z_yzz_0[j] - 0.5 * fl1_fx * tey_z_yzz_1[j];

                tez_xz_xyzz_0[j] =
                    pa_x[j] * tez_z_xyzz_0[j] - pc_x[j] * tez_z_xyzz_1[j] + 0.5 * fl1_fx * tez_z_yzz_0[j] - 0.5 * fl1_fx * tez_z_yzz_1[j];

                tex_xz_xzzz_0[j] = pa_x[j] * tex_z_xzzz_0[j] - pc_x[j] * tex_z_xzzz_1[j] + 0.5 * fl1_fx * tex_z_zzz_0[j] -
                                   0.5 * fl1_fx * tex_z_zzz_1[j] + ta_z_xzzz_1[j];

                tey_xz_xzzz_0[j] =
                    pa_x[j] * tey_z_xzzz_0[j] - pc_x[j] * tey_z_xzzz_1[j] + 0.5 * fl1_fx * tey_z_zzz_0[j] - 0.5 * fl1_fx * tey_z_zzz_1[j];

                tez_xz_xzzz_0[j] =
                    pa_x[j] * tez_z_xzzz_0[j] - pc_x[j] * tez_z_xzzz_1[j] + 0.5 * fl1_fx * tez_z_zzz_0[j] - 0.5 * fl1_fx * tez_z_zzz_1[j];
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tex_yy_xxxx_0[j] =
                    pa_y[j] * tex_y_xxxx_0[j] - pc_y[j] * tex_y_xxxx_1[j] + 0.5 * fl1_fx * tex_0_xxxx_0[j] - 0.5 * fl1_fx * tex_0_xxxx_1[j];

                tey_yy_xxxx_0[j] = pa_y[j] * tey_y_xxxx_0[j] - pc_y[j] * tey_y_xxxx_1[j] + 0.5 * fl1_fx * tey_0_xxxx_0[j] -
                                   0.5 * fl1_fx * tey_0_xxxx_1[j] + ta_y_xxxx_1[j];

                tez_yy_xxxx_0[j] =
                    pa_y[j] * tez_y_xxxx_0[j] - pc_y[j] * tez_y_xxxx_1[j] + 0.5 * fl1_fx * tez_0_xxxx_0[j] - 0.5 * fl1_fx * tez_0_xxxx_1[j];

                tex_yy_xxxy_0[j] = pa_y[j] * tex_y_xxxy_0[j] - pc_y[j] * tex_y_xxxy_1[j] + 0.5 * fl1_fx * tex_0_xxxy_0[j] -
                                   0.5 * fl1_fx * tex_0_xxxy_1[j] + 0.5 * fl1_fx * tex_y_xxx_0[j] - 0.5 * fl1_fx * tex_y_xxx_1[j];

                tey_yy_xxxy_0[j] = pa_y[j] * tey_y_xxxy_0[j] - pc_y[j] * tey_y_xxxy_1[j] + 0.5 * fl1_fx * tey_0_xxxy_0[j] -
                                   0.5 * fl1_fx * tey_0_xxxy_1[j] + 0.5 * fl1_fx * tey_y_xxx_0[j] - 0.5 * fl1_fx * tey_y_xxx_1[j] + ta_y_xxxy_1[j];

                tez_yy_xxxy_0[j] = pa_y[j] * tez_y_xxxy_0[j] - pc_y[j] * tez_y_xxxy_1[j] + 0.5 * fl1_fx * tez_0_xxxy_0[j] -
                                   0.5 * fl1_fx * tez_0_xxxy_1[j] + 0.5 * fl1_fx * tez_y_xxx_0[j] - 0.5 * fl1_fx * tez_y_xxx_1[j];

                tex_yy_xxxz_0[j] =
                    pa_y[j] * tex_y_xxxz_0[j] - pc_y[j] * tex_y_xxxz_1[j] + 0.5 * fl1_fx * tex_0_xxxz_0[j] - 0.5 * fl1_fx * tex_0_xxxz_1[j];

                tey_yy_xxxz_0[j] = pa_y[j] * tey_y_xxxz_0[j] - pc_y[j] * tey_y_xxxz_1[j] + 0.5 * fl1_fx * tey_0_xxxz_0[j] -
                                   0.5 * fl1_fx * tey_0_xxxz_1[j] + ta_y_xxxz_1[j];

                tez_yy_xxxz_0[j] =
                    pa_y[j] * tez_y_xxxz_0[j] - pc_y[j] * tez_y_xxxz_1[j] + 0.5 * fl1_fx * tez_0_xxxz_0[j] - 0.5 * fl1_fx * tez_0_xxxz_1[j];

                tex_yy_xxyy_0[j] = pa_y[j] * tex_y_xxyy_0[j] - pc_y[j] * tex_y_xxyy_1[j] + 0.5 * fl1_fx * tex_0_xxyy_0[j] -
                                   0.5 * fl1_fx * tex_0_xxyy_1[j] + fl1_fx * tex_y_xxy_0[j] - fl1_fx * tex_y_xxy_1[j];

                tey_yy_xxyy_0[j] = pa_y[j] * tey_y_xxyy_0[j] - pc_y[j] * tey_y_xxyy_1[j] + 0.5 * fl1_fx * tey_0_xxyy_0[j] -
                                   0.5 * fl1_fx * tey_0_xxyy_1[j] + fl1_fx * tey_y_xxy_0[j] - fl1_fx * tey_y_xxy_1[j] + ta_y_xxyy_1[j];

                tez_yy_xxyy_0[j] = pa_y[j] * tez_y_xxyy_0[j] - pc_y[j] * tez_y_xxyy_1[j] + 0.5 * fl1_fx * tez_0_xxyy_0[j] -
                                   0.5 * fl1_fx * tez_0_xxyy_1[j] + fl1_fx * tez_y_xxy_0[j] - fl1_fx * tez_y_xxy_1[j];

                tex_yy_xxyz_0[j] = pa_y[j] * tex_y_xxyz_0[j] - pc_y[j] * tex_y_xxyz_1[j] + 0.5 * fl1_fx * tex_0_xxyz_0[j] -
                                   0.5 * fl1_fx * tex_0_xxyz_1[j] + 0.5 * fl1_fx * tex_y_xxz_0[j] - 0.5 * fl1_fx * tex_y_xxz_1[j];

                tey_yy_xxyz_0[j] = pa_y[j] * tey_y_xxyz_0[j] - pc_y[j] * tey_y_xxyz_1[j] + 0.5 * fl1_fx * tey_0_xxyz_0[j] -
                                   0.5 * fl1_fx * tey_0_xxyz_1[j] + 0.5 * fl1_fx * tey_y_xxz_0[j] - 0.5 * fl1_fx * tey_y_xxz_1[j] + ta_y_xxyz_1[j];

                tez_yy_xxyz_0[j] = pa_y[j] * tez_y_xxyz_0[j] - pc_y[j] * tez_y_xxyz_1[j] + 0.5 * fl1_fx * tez_0_xxyz_0[j] -
                                   0.5 * fl1_fx * tez_0_xxyz_1[j] + 0.5 * fl1_fx * tez_y_xxz_0[j] - 0.5 * fl1_fx * tez_y_xxz_1[j];

                tex_yy_xxzz_0[j] =
                    pa_y[j] * tex_y_xxzz_0[j] - pc_y[j] * tex_y_xxzz_1[j] + 0.5 * fl1_fx * tex_0_xxzz_0[j] - 0.5 * fl1_fx * tex_0_xxzz_1[j];

                tey_yy_xxzz_0[j] = pa_y[j] * tey_y_xxzz_0[j] - pc_y[j] * tey_y_xxzz_1[j] + 0.5 * fl1_fx * tey_0_xxzz_0[j] -
                                   0.5 * fl1_fx * tey_0_xxzz_1[j] + ta_y_xxzz_1[j];

                tez_yy_xxzz_0[j] =
                    pa_y[j] * tez_y_xxzz_0[j] - pc_y[j] * tez_y_xxzz_1[j] + 0.5 * fl1_fx * tez_0_xxzz_0[j] - 0.5 * fl1_fx * tez_0_xxzz_1[j];

                tex_yy_xyyy_0[j] = pa_y[j] * tex_y_xyyy_0[j] - pc_y[j] * tex_y_xyyy_1[j] + 0.5 * fl1_fx * tex_0_xyyy_0[j] -
                                   0.5 * fl1_fx * tex_0_xyyy_1[j] + 1.5 * fl1_fx * tex_y_xyy_0[j] - 1.5 * fl1_fx * tex_y_xyy_1[j];

                tey_yy_xyyy_0[j] = pa_y[j] * tey_y_xyyy_0[j] - pc_y[j] * tey_y_xyyy_1[j] + 0.5 * fl1_fx * tey_0_xyyy_0[j] -
                                   0.5 * fl1_fx * tey_0_xyyy_1[j] + 1.5 * fl1_fx * tey_y_xyy_0[j] - 1.5 * fl1_fx * tey_y_xyy_1[j] + ta_y_xyyy_1[j];

                tez_yy_xyyy_0[j] = pa_y[j] * tez_y_xyyy_0[j] - pc_y[j] * tez_y_xyyy_1[j] + 0.5 * fl1_fx * tez_0_xyyy_0[j] -
                                   0.5 * fl1_fx * tez_0_xyyy_1[j] + 1.5 * fl1_fx * tez_y_xyy_0[j] - 1.5 * fl1_fx * tez_y_xyy_1[j];

                tex_yy_xyyz_0[j] = pa_y[j] * tex_y_xyyz_0[j] - pc_y[j] * tex_y_xyyz_1[j] + 0.5 * fl1_fx * tex_0_xyyz_0[j] -
                                   0.5 * fl1_fx * tex_0_xyyz_1[j] + fl1_fx * tex_y_xyz_0[j] - fl1_fx * tex_y_xyz_1[j];

                tey_yy_xyyz_0[j] = pa_y[j] * tey_y_xyyz_0[j] - pc_y[j] * tey_y_xyyz_1[j] + 0.5 * fl1_fx * tey_0_xyyz_0[j] -
                                   0.5 * fl1_fx * tey_0_xyyz_1[j] + fl1_fx * tey_y_xyz_0[j] - fl1_fx * tey_y_xyz_1[j] + ta_y_xyyz_1[j];

                tez_yy_xyyz_0[j] = pa_y[j] * tez_y_xyyz_0[j] - pc_y[j] * tez_y_xyyz_1[j] + 0.5 * fl1_fx * tez_0_xyyz_0[j] -
                                   0.5 * fl1_fx * tez_0_xyyz_1[j] + fl1_fx * tez_y_xyz_0[j] - fl1_fx * tez_y_xyz_1[j];

                tex_yy_xyzz_0[j] = pa_y[j] * tex_y_xyzz_0[j] - pc_y[j] * tex_y_xyzz_1[j] + 0.5 * fl1_fx * tex_0_xyzz_0[j] -
                                   0.5 * fl1_fx * tex_0_xyzz_1[j] + 0.5 * fl1_fx * tex_y_xzz_0[j] - 0.5 * fl1_fx * tex_y_xzz_1[j];

                tey_yy_xyzz_0[j] = pa_y[j] * tey_y_xyzz_0[j] - pc_y[j] * tey_y_xyzz_1[j] + 0.5 * fl1_fx * tey_0_xyzz_0[j] -
                                   0.5 * fl1_fx * tey_0_xyzz_1[j] + 0.5 * fl1_fx * tey_y_xzz_0[j] - 0.5 * fl1_fx * tey_y_xzz_1[j] + ta_y_xyzz_1[j];

                tez_yy_xyzz_0[j] = pa_y[j] * tez_y_xyzz_0[j] - pc_y[j] * tez_y_xyzz_1[j] + 0.5 * fl1_fx * tez_0_xyzz_0[j] -
                                   0.5 * fl1_fx * tez_0_xyzz_1[j] + 0.5 * fl1_fx * tez_y_xzz_0[j] - 0.5 * fl1_fx * tez_y_xzz_1[j];

                tex_yy_xzzz_0[j] =
                    pa_y[j] * tex_y_xzzz_0[j] - pc_y[j] * tex_y_xzzz_1[j] + 0.5 * fl1_fx * tex_0_xzzz_0[j] - 0.5 * fl1_fx * tex_0_xzzz_1[j];

                tey_yy_xzzz_0[j] = pa_y[j] * tey_y_xzzz_0[j] - pc_y[j] * tey_y_xzzz_1[j] + 0.5 * fl1_fx * tey_0_xzzz_0[j] -
                                   0.5 * fl1_fx * tey_0_xzzz_1[j] + ta_y_xzzz_1[j];

                tez_yy_xzzz_0[j] =
                    pa_y[j] * tez_y_xzzz_0[j] - pc_y[j] * tez_y_xzzz_1[j] + 0.5 * fl1_fx * tez_0_xzzz_0[j] - 0.5 * fl1_fx * tez_0_xzzz_1[j];

                tex_yy_yyyy_0[j] = pa_y[j] * tex_y_yyyy_0[j] - pc_y[j] * tex_y_yyyy_1[j] + 0.5 * fl1_fx * tex_0_yyyy_0[j] -
                                   0.5 * fl1_fx * tex_0_yyyy_1[j] + 2.0 * fl1_fx * tex_y_yyy_0[j] - 2.0 * fl1_fx * tex_y_yyy_1[j];

                tey_yy_yyyy_0[j] = pa_y[j] * tey_y_yyyy_0[j] - pc_y[j] * tey_y_yyyy_1[j] + 0.5 * fl1_fx * tey_0_yyyy_0[j] -
                                   0.5 * fl1_fx * tey_0_yyyy_1[j] + 2.0 * fl1_fx * tey_y_yyy_0[j] - 2.0 * fl1_fx * tey_y_yyy_1[j] + ta_y_yyyy_1[j];

                tez_yy_yyyy_0[j] = pa_y[j] * tez_y_yyyy_0[j] - pc_y[j] * tez_y_yyyy_1[j] + 0.5 * fl1_fx * tez_0_yyyy_0[j] -
                                   0.5 * fl1_fx * tez_0_yyyy_1[j] + 2.0 * fl1_fx * tez_y_yyy_0[j] - 2.0 * fl1_fx * tez_y_yyy_1[j];

                tex_yy_yyyz_0[j] = pa_y[j] * tex_y_yyyz_0[j] - pc_y[j] * tex_y_yyyz_1[j] + 0.5 * fl1_fx * tex_0_yyyz_0[j] -
                                   0.5 * fl1_fx * tex_0_yyyz_1[j] + 1.5 * fl1_fx * tex_y_yyz_0[j] - 1.5 * fl1_fx * tex_y_yyz_1[j];

                tey_yy_yyyz_0[j] = pa_y[j] * tey_y_yyyz_0[j] - pc_y[j] * tey_y_yyyz_1[j] + 0.5 * fl1_fx * tey_0_yyyz_0[j] -
                                   0.5 * fl1_fx * tey_0_yyyz_1[j] + 1.5 * fl1_fx * tey_y_yyz_0[j] - 1.5 * fl1_fx * tey_y_yyz_1[j] + ta_y_yyyz_1[j];

                tez_yy_yyyz_0[j] = pa_y[j] * tez_y_yyyz_0[j] - pc_y[j] * tez_y_yyyz_1[j] + 0.5 * fl1_fx * tez_0_yyyz_0[j] -
                                   0.5 * fl1_fx * tez_0_yyyz_1[j] + 1.5 * fl1_fx * tez_y_yyz_0[j] - 1.5 * fl1_fx * tez_y_yyz_1[j];

                tex_yy_yyzz_0[j] = pa_y[j] * tex_y_yyzz_0[j] - pc_y[j] * tex_y_yyzz_1[j] + 0.5 * fl1_fx * tex_0_yyzz_0[j] -
                                   0.5 * fl1_fx * tex_0_yyzz_1[j] + fl1_fx * tex_y_yzz_0[j] - fl1_fx * tex_y_yzz_1[j];

                tey_yy_yyzz_0[j] = pa_y[j] * tey_y_yyzz_0[j] - pc_y[j] * tey_y_yyzz_1[j] + 0.5 * fl1_fx * tey_0_yyzz_0[j] -
                                   0.5 * fl1_fx * tey_0_yyzz_1[j] + fl1_fx * tey_y_yzz_0[j] - fl1_fx * tey_y_yzz_1[j] + ta_y_yyzz_1[j];

                tez_yy_yyzz_0[j] = pa_y[j] * tez_y_yyzz_0[j] - pc_y[j] * tez_y_yyzz_1[j] + 0.5 * fl1_fx * tez_0_yyzz_0[j] -
                                   0.5 * fl1_fx * tez_0_yyzz_1[j] + fl1_fx * tez_y_yzz_0[j] - fl1_fx * tez_y_yzz_1[j];

                tex_yy_yzzz_0[j] = pa_y[j] * tex_y_yzzz_0[j] - pc_y[j] * tex_y_yzzz_1[j] + 0.5 * fl1_fx * tex_0_yzzz_0[j] -
                                   0.5 * fl1_fx * tex_0_yzzz_1[j] + 0.5 * fl1_fx * tex_y_zzz_0[j] - 0.5 * fl1_fx * tex_y_zzz_1[j];

                tey_yy_yzzz_0[j] = pa_y[j] * tey_y_yzzz_0[j] - pc_y[j] * tey_y_yzzz_1[j] + 0.5 * fl1_fx * tey_0_yzzz_0[j] -
                                   0.5 * fl1_fx * tey_0_yzzz_1[j] + 0.5 * fl1_fx * tey_y_zzz_0[j] - 0.5 * fl1_fx * tey_y_zzz_1[j] + ta_y_yzzz_1[j];

                tez_yy_yzzz_0[j] = pa_y[j] * tez_y_yzzz_0[j] - pc_y[j] * tez_y_yzzz_1[j] + 0.5 * fl1_fx * tez_0_yzzz_0[j] -
                                   0.5 * fl1_fx * tez_0_yzzz_1[j] + 0.5 * fl1_fx * tez_y_zzz_0[j] - 0.5 * fl1_fx * tez_y_zzz_1[j];

                tex_yy_zzzz_0[j] =
                    pa_y[j] * tex_y_zzzz_0[j] - pc_y[j] * tex_y_zzzz_1[j] + 0.5 * fl1_fx * tex_0_zzzz_0[j] - 0.5 * fl1_fx * tex_0_zzzz_1[j];

                tey_yy_zzzz_0[j] = pa_y[j] * tey_y_zzzz_0[j] - pc_y[j] * tey_y_zzzz_1[j] + 0.5 * fl1_fx * tey_0_zzzz_0[j] -
                                   0.5 * fl1_fx * tey_0_zzzz_1[j] + ta_y_zzzz_1[j];

                tez_yy_zzzz_0[j] =
                    pa_y[j] * tez_y_zzzz_0[j] - pc_y[j] * tez_y_zzzz_1[j] + 0.5 * fl1_fx * tez_0_zzzz_0[j] - 0.5 * fl1_fx * tez_0_zzzz_1[j];
            }
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tex_yz_xxxy_0[j] =
                    pa_y[j] * tex_z_xxxy_0[j] - pc_y[j] * tex_z_xxxy_1[j] + 0.5 * fl1_fx * tex_z_xxx_0[j] - 0.5 * fl1_fx * tex_z_xxx_1[j];

                tey_yz_xxxy_0[j] = pa_y[j] * tey_z_xxxy_0[j] - pc_y[j] * tey_z_xxxy_1[j] + 0.5 * fl1_fx * tey_z_xxx_0[j] -
                                   0.5 * fl1_fx * tey_z_xxx_1[j] + ta_z_xxxy_1[j];

                tez_yz_xxxy_0[j] =
                    pa_y[j] * tez_z_xxxy_0[j] - pc_y[j] * tez_z_xxxy_1[j] + 0.5 * fl1_fx * tez_z_xxx_0[j] - 0.5 * fl1_fx * tez_z_xxx_1[j];
                ...
                tey_yz_xxyy_0[j] =
                    pa_y[j] * tey_z_xxyy_0[j] - pc_y[j] * tey_z_xxyy_1[j] + fl1_fx * tey_z_xxy_0[j] - fl1_fx * tey_z_xxy_1[j] + ta_z_xxyy_1[j];

                tez_yz_xxyy_0[j] = pa_y[j] * tez_z_xxyy_0[j] - pc_y[j] * tez_z_xxyy_1[j] + fl1_fx * tez_z_xxy_0[j] - fl1_fx * tez_z_xxy_1[j];

                tex_yz_xxyz_0[j] =
                    pa_y[j] * tex_z_xxyz_0[j] - pc_y[j] * tex_z_xxyz_1[j] + 0.5 * fl1_fx * tex_z_xxz_0[j] - 0.5 * fl1_fx * tex_z_xxz_1[j];

                tey_yz_xxyz_0[j] = pa_y[j] * tey_z_xxyz_0[j] - pc_y[j] * tey_z_xxyz_1[j] + 0.5 * fl1_fx * tey_z_xxz_0[j] -
                                   0.5 * fl1_fx * tey_z_xxz_1[j] + ta_z_xxyz_1[j];

                tez_yz_xxyz_0[j] =
                    pa_y[j] * tez_z_xxyz_0[j] - pc_y[j] * tez_z_xxyz_1[j] + 0.5 * fl1_fx * tez_z_xxz_0[j] - 0.5 * fl1_fx * tez_z_xxz_1[j];
                ...
                tex_yz_xyyy_0[j] =
                    pa_y[j] * tex_z_xyyy_0[j] - pc_y[j] * tex_z_xyyy_1[j] + 1.5 * fl1_fx * tex_z_xyy_0[j] - 1.5 * fl1_fx * tex_z_xyy_1[j];

                tey_yz_xyyy_0[j] = pa_y[j] * tey_z_xyyy_0[j] - pc_y[j] * tey_z_xyyy_1[j] + 1.5 * fl1_fx * tey_z_xyy_0[j] -
                                   1.5 * fl1_fx * tey_z_xyy_1[j] + ta_z_xyyy_1[j];

                tez_yz_xyyy_0[j] =
                    pa_y[j] * tez_z_xyyy_0[j] - pc_y[j] * tez_z_xyyy_1[j] + 1.5 * fl1_fx * tez_z_xyy_0[j] - 1.5 * fl1_fx * tez_z_xyy_1[j];

                tex_yz_xyyz_0[j] = pa_y[j] * tex_z_xyyz_0[j] - pc_y[j] * tex_z_xyyz_1[j] + fl1_fx * tex_z_xyz_0[j] - fl1_fx * tex_z_xyz_1[j];

                tey_yz_xyyz_0[j] =
                    pa_y[j] * tey_z_xyyz_0[j] - pc_y[j] * tey_z_xyyz_1[j] + fl1_fx * tey_z_xyz_0[j] - fl1_fx * tey_z_xyz_1[j] + ta_z_xyyz_1[j];

                tez_yz_xyyz_0[j] = pa_y[j] * tez_z_xyyz_0[j] - pc_y[j] * tez_z_xyyz_1[j] + fl1_fx * tez_z_xyz_0[j] - fl1_fx * tez_z_xyz_1[j];

                tex_yz_xyzz_0[j] =
                    pa_y[j] * tex_z_xyzz_0[j] - pc_y[j] * tex_z_xyzz_1[j] + 0.5 * fl1_fx * tex_z_xzz_0[j] - 0.5 * fl1_fx * tex_z_xzz_1[j];

                tey_yz_xyzz_0[j] = pa_y[j] * tey_z_xyzz_0[j] - pc_y[j] * tey_z_xyzz_1[j] + 0.5 * fl1_fx * tey_z_xzz_0[j] -
                                   0.5 * fl1_fx * tey_z_xzz_1[j] + ta_z_xyzz_1[j];

                tez_yz_xyzz_0[j] =
                    pa_y[j] * tez_z_xyzz_0[j] - pc_y[j] * tez_z_xyzz_1[j] + 0.5 * fl1_fx * tez_z_xzz_0[j] - 0.5 * fl1_fx * tez_z_xzz_1[j];
                ...
                tex_yz_yyyy_0[j] =
                    pa_y[j] * tex_z_yyyy_0[j] - pc_y[j] * tex_z_yyyy_1[j] + 2.0 * fl1_fx * tex_z_yyy_0[j] - 2.0 * fl1_fx * tex_z_yyy_1[j];

                tey_yz_yyyy_0[j] = pa_y[j] * tey_z_yyyy_0[j] - pc_y[j] * tey_z_yyyy_1[j] + 2.0 * fl1_fx * tey_z_yyy_0[j] -
                                   2.0 * fl1_fx * tey_z_yyy_1[j] + ta_z_yyyy_1[j];

                tez_yz_yyyy_0[j] =
                    pa_y[j] * tez_z_yyyy_0[j] - pc_y[j] * tez_z_yyyy_1[j] + 2.0 * fl1_fx * tez_z_yyy_0[j] - 2.0 * fl1_fx * tez_z_yyy_1[j];

                tex_yz_yyyz_0[j] =
                    pa_y[j] * tex_z_yyyz_0[j] - pc_y[j] * tex_z_yyyz_1[j] + 1.5 * fl1_fx * tex_z_yyz_0[j] - 1.5 * fl1_fx * tex_z_yyz_1[j];

                tey_yz_yyyz_0[j] = pa_y[j] * tey_z_yyyz_0[j] - pc_y[j] * tey_z_yyyz_1[j] + 1.5 * fl1_fx * tey_z_yyz_0[j] -
                                   1.5 * fl1_fx * tey_z_yyz_1[j] + ta_z_yyyz_1[j];

                tez_yz_yyyz_0[j] =
                    pa_y[j] * tez_z_yyyz_0[j] - pc_y[j] * tez_z_yyyz_1[j] + 1.5 * fl1_fx * tez_z_yyz_0[j] - 1.5 * fl1_fx * tez_z_yyz_1[j];

                tex_yz_yyzz_0[j] = pa_y[j] * tex_z_yyzz_0[j] - pc_y[j] * tex_z_yyzz_1[j] + fl1_fx * tex_z_yzz_0[j] - fl1_fx * tex_z_yzz_1[j];

                tey_yz_yyzz_0[j] =
                    pa_y[j] * tey_z_yyzz_0[j] - pc_y[j] * tey_z_yyzz_1[j] + fl1_fx * tey_z_yzz_0[j] - fl1_fx * tey_z_yzz_1[j] + ta_z_yyzz_1[j];

                tez_yz_yyzz_0[j] = pa_y[j] * tez_z_yyzz_0[j] - pc_y[j] * tez_z_yyzz_1[j] + fl1_fx * tez_z_yzz_0[j] - fl1_fx * tez_z_yzz_1[j];

                tex_yz_yzzz_0[j] =
                    pa_y[j] * tex_z_yzzz_0[j] - pc_y[j] * tex_z_yzzz_1[j] + 0.5 * fl1_fx * tex_z_zzz_0[j] - 0.5 * fl1_fx * tex_z_zzz_1[j];

                tey_yz_yzzz_0[j] = pa_y[j] * tey_z_yzzz_0[j] - pc_y[j] * tey_z_yzzz_1[j] + 0.5 * fl1_fx * tey_z_zzz_0[j] -
                                   0.5 * fl1_fx * tey_z_zzz_1[j] + ta_z_yzzz_1[j];

                tez_yz_yzzz_0[j] =
                    pa_y[j] * tez_z_yzzz_0[j] - pc_y[j] * tez_z_yzzz_1[j] + 0.5 * fl1_fx * tez_z_zzz_0[j] - 0.5 * fl1_fx * tez_z_zzz_1[j];
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tex_zz_xxxx_0[j] =
                    pa_z[j] * tex_z_xxxx_0[j] - pc_z[j] * tex_z_xxxx_1[j] + 0.5 * fl1_fx * tex_0_xxxx_0[j] - 0.5 * fl1_fx * tex_0_xxxx_1[j];

                tey_zz_xxxx_0[j] =
                    pa_z[j] * tey_z_xxxx_0[j] - pc_z[j] * tey_z_xxxx_1[j] + 0.5 * fl1_fx * tey_0_xxxx_0[j] - 0.5 * fl1_fx * tey_0_xxxx_1[j];

                tez_zz_xxxx_0[j] = pa_z[j] * tez_z_xxxx_0[j] - pc_z[j] * tez_z_xxxx_1[j] + 0.5 * fl1_fx * tez_0_xxxx_0[j] -
                                   0.5 * fl1_fx * tez_0_xxxx_1[j] + ta_z_xxxx_1[j];

                tex_zz_xxxy_0[j] =
                    pa_z[j] * tex_z_xxxy_0[j] - pc_z[j] * tex_z_xxxy_1[j] + 0.5 * fl1_fx * tex_0_xxxy_0[j] - 0.5 * fl1_fx * tex_0_xxxy_1[j];

                tey_zz_xxxy_0[j] =
                    pa_z[j] * tey_z_xxxy_0[j] - pc_z[j] * tey_z_xxxy_1[j] + 0.5 * fl1_fx * tey_0_xxxy_0[j] - 0.5 * fl1_fx * tey_0_xxxy_1[j];

                tez_zz_xxxy_0[j] = pa_z[j] * tez_z_xxxy_0[j] - pc_z[j] * tez_z_xxxy_1[j] + 0.5 * fl1_fx * tez_0_xxxy_0[j] -
                                   0.5 * fl1_fx * tez_0_xxxy_1[j] + ta_z_xxxy_1[j];

                tex_zz_xxxz_0[j] = pa_z[j] * tex_z_xxxz_0[j] - pc_z[j] * tex_z_xxxz_1[j] + 0.5 * fl1_fx * tex_0_xxxz_0[j] -
                                   0.5 * fl1_fx * tex_0_xxxz_1[j] + 0.5 * fl1_fx * tex_z_xxx_0[j] - 0.5 * fl1_fx * tex_z_xxx_1[j];

                tey_zz_xxxz_0[j] = pa_z[j] * tey_z_xxxz_0[j] - pc_z[j] * tey_z_xxxz_1[j] + 0.5 * fl1_fx * tey_0_xxxz_0[j] -
                                   0.5 * fl1_fx * tey_0_xxxz_1[j] + 0.5 * fl1_fx * tey_z_xxx_0[j] - 0.5 * fl1_fx * tey_z_xxx_1[j];

                tez_zz_xxxz_0[j] = pa_z[j] * tez_z_xxxz_0[j] - pc_z[j] * tez_z_xxxz_1[j] + 0.5 * fl1_fx * tez_0_xxxz_0[j] -
                                   0.5 * fl1_fx * tez_0_xxxz_1[j] + 0.5 * fl1_fx * tez_z_xxx_0[j] - 0.5 * fl1_fx * tez_z_xxx_1[j] + ta_z_xxxz_1[j];

                tex_zz_xxyy_0[j] =
                    pa_z[j] * tex_z_xxyy_0[j] - pc_z[j] * tex_z_xxyy_1[j] + 0.5 * fl1_fx * tex_0_xxyy_0[j] - 0.5 * fl1_fx * tex_0_xxyy_1[j];

                tey_zz_xxyy_0[j] =
                    pa_z[j] * tey_z_xxyy_0[j] - pc_z[j] * tey_z_xxyy_1[j] + 0.5 * fl1_fx * tey_0_xxyy_0[j] - 0.5 * fl1_fx * tey_0_xxyy_1[j];

                tez_zz_xxyy_0[j] = pa_z[j] * tez_z_xxyy_0[j] - pc_z[j] * tez_z_xxyy_1[j] + 0.5 * fl1_fx * tez_0_xxyy_0[j] -
                                   0.5 * fl1_fx * tez_0_xxyy_1[j] + ta_z_xxyy_1[j];

                tex_zz_xxyz_0[j] = pa_z[j] * tex_z_xxyz_0[j] - pc_z[j] * tex_z_xxyz_1[j] + 0.5 * fl1_fx * tex_0_xxyz_0[j] -
                                   0.5 * fl1_fx * tex_0_xxyz_1[j] + 0.5 * fl1_fx * tex_z_xxy_0[j] - 0.5 * fl1_fx * tex_z_xxy_1[j];

                tey_zz_xxyz_0[j] = pa_z[j] * tey_z_xxyz_0[j] - pc_z[j] * tey_z_xxyz_1[j] + 0.5 * fl1_fx * tey_0_xxyz_0[j] -
                                   0.5 * fl1_fx * tey_0_xxyz_1[j] + 0.5 * fl1_fx * tey_z_xxy_0[j] - 0.5 * fl1_fx * tey_z_xxy_1[j];

                tez_zz_xxyz_0[j] = pa_z[j] * tez_z_xxyz_0[j] - pc_z[j] * tez_z_xxyz_1[j] + 0.5 * fl1_fx * tez_0_xxyz_0[j] -
                                   0.5 * fl1_fx * tez_0_xxyz_1[j] + 0.5 * fl1_fx * tez_z_xxy_0[j] - 0.5 * fl1_fx * tez_z_xxy_1[j] + ta_z_xxyz_1[j];

                tex_zz_xxzz_0[j] = pa_z[j] * tex_z_xxzz_0[j] - pc_z[j] * tex_z_xxzz_1[j] + 0.5 * fl1_fx * tex_0_xxzz_0[j] -
                                   0.5 * fl1_fx * tex_0_xxzz_1[j] + fl1_fx * tex_z_xxz_0[j] - fl1_fx * tex_z_xxz_1[j];

                tey_zz_xxzz_0[j] = pa_z[j] * tey_z_xxzz_0[j] - pc_z[j] * tey_z_xxzz_1[j] + 0.5 * fl1_fx * tey_0_xxzz_0[j] -
                                   0.5 * fl1_fx * tey_0_xxzz_1[j] + fl1_fx * tey_z_xxz_0[j] - fl1_fx * tey_z_xxz_1[j];

                tez_zz_xxzz_0[j] = pa_z[j] * tez_z_xxzz_0[j] - pc_z[j] * tez_z_xxzz_1[j] + 0.5 * fl1_fx * tez_0_xxzz_0[j] -
                                   0.5 * fl1_fx * tez_0_xxzz_1[j] + fl1_fx * tez_z_xxz_0[j] - fl1_fx * tez_z_xxz_1[j] + ta_z_xxzz_1[j];

                tex_zz_xyyy_0[j] =
                    pa_z[j] * tex_z_xyyy_0[j] - pc_z[j] * tex_z_xyyy_1[j] + 0.5 * fl1_fx * tex_0_xyyy_0[j] - 0.5 * fl1_fx * tex_0_xyyy_1[j];

                tey_zz_xyyy_0[j] =
                    pa_z[j] * tey_z_xyyy_0[j] - pc_z[j] * tey_z_xyyy_1[j] + 0.5 * fl1_fx * tey_0_xyyy_0[j] - 0.5 * fl1_fx * tey_0_xyyy_1[j];

                tez_zz_xyyy_0[j] = pa_z[j] * tez_z_xyyy_0[j] - pc_z[j] * tez_z_xyyy_1[j] + 0.5 * fl1_fx * tez_0_xyyy_0[j] -
                                   0.5 * fl1_fx * tez_0_xyyy_1[j] + ta_z_xyyy_1[j];

                tex_zz_xyyz_0[j] = pa_z[j] * tex_z_xyyz_0[j] - pc_z[j] * tex_z_xyyz_1[j] + 0.5 * fl1_fx * tex_0_xyyz_0[j] -
                                   0.5 * fl1_fx * tex_0_xyyz_1[j] + 0.5 * fl1_fx * tex_z_xyy_0[j] - 0.5 * fl1_fx * tex_z_xyy_1[j];

                tey_zz_xyyz_0[j] = pa_z[j] * tey_z_xyyz_0[j] - pc_z[j] * tey_z_xyyz_1[j] + 0.5 * fl1_fx * tey_0_xyyz_0[j] -
                                   0.5 * fl1_fx * tey_0_xyyz_1[j] + 0.5 * fl1_fx * tey_z_xyy_0[j] - 0.5 * fl1_fx * tey_z_xyy_1[j];

                tez_zz_xyyz_0[j] = pa_z[j] * tez_z_xyyz_0[j] - pc_z[j] * tez_z_xyyz_1[j] + 0.5 * fl1_fx * tez_0_xyyz_0[j] -
                                   0.5 * fl1_fx * tez_0_xyyz_1[j] + 0.5 * fl1_fx * tez_z_xyy_0[j] - 0.5 * fl1_fx * tez_z_xyy_1[j] + ta_z_xyyz_1[j];

                tex_zz_xyzz_0[j] = pa_z[j] * tex_z_xyzz_0[j] - pc_z[j] * tex_z_xyzz_1[j] + 0.5 * fl1_fx * tex_0_xyzz_0[j] -
                                   0.5 * fl1_fx * tex_0_xyzz_1[j] + fl1_fx * tex_z_xyz_0[j] - fl1_fx * tex_z_xyz_1[j];

                tey_zz_xyzz_0[j] = pa_z[j] * tey_z_xyzz_0[j] - pc_z[j] * tey_z_xyzz_1[j] + 0.5 * fl1_fx * tey_0_xyzz_0[j] -
                                   0.5 * fl1_fx * tey_0_xyzz_1[j] + fl1_fx * tey_z_xyz_0[j] - fl1_fx * tey_z_xyz_1[j];

                tez_zz_xyzz_0[j] = pa_z[j] * tez_z_xyzz_0[j] - pc_z[j] * tez_z_xyzz_1[j] + 0.5 * fl1_fx * tez_0_xyzz_0[j] -
                                   0.5 * fl1_fx * tez_0_xyzz_1[j] + fl1_fx * tez_z_xyz_0[j] - fl1_fx * tez_z_xyz_1[j] + ta_z_xyzz_1[j];

                tex_zz_xzzz_0[j] = pa_z[j] * tex_z_xzzz_0[j] - pc_z[j] * tex_z_xzzz_1[j] + 0.5 * fl1_fx * tex_0_xzzz_0[j] -
                                   0.5 * fl1_fx * tex_0_xzzz_1[j] + 1.5 * fl1_fx * tex_z_xzz_0[j] - 1.5 * fl1_fx * tex_z_xzz_1[j];

                tey_zz_xzzz_0[j] = pa_z[j] * tey_z_xzzz_0[j] - pc_z[j] * tey_z_xzzz_1[j] + 0.5 * fl1_fx * tey_0_xzzz_0[j] -
                                   0.5 * fl1_fx * tey_0_xzzz_1[j] + 1.5 * fl1_fx * tey_z_xzz_0[j] - 1.5 * fl1_fx * tey_z_xzz_1[j];

                tez_zz_xzzz_0[j] = pa_z[j] * tez_z_xzzz_0[j] - pc_z[j] * tez_z_xzzz_1[j] + 0.5 * fl1_fx * tez_0_xzzz_0[j] -
                                   0.5 * fl1_fx * tez_0_xzzz_1[j] + 1.5 * fl1_fx * tez_z_xzz_0[j] - 1.5 * fl1_fx * tez_z_xzz_1[j] + ta_z_xzzz_1[j];

                tex_zz_yyyy_0[j] =
                    pa_z[j] * tex_z_yyyy_0[j] - pc_z[j] * tex_z_yyyy_1[j] + 0.5 * fl1_fx * tex_0_yyyy_0[j] - 0.5 * fl1_fx * tex_0_yyyy_1[j];

                tey_zz_yyyy_0[j] =
                    pa_z[j] * tey_z_yyyy_0[j] - pc_z[j] * tey_z_yyyy_1[j] + 0.5 * fl1_fx * tey_0_yyyy_0[j] - 0.5 * fl1_fx * tey_0_yyyy_1[j];

                tez_zz_yyyy_0[j] = pa_z[j] * tez_z_yyyy_0[j] - pc_z[j] * tez_z_yyyy_1[j] + 0.5 * fl1_fx * tez_0_yyyy_0[j] -
                                   0.5 * fl1_fx * tez_0_yyyy_1[j] + ta_z_yyyy_1[j];

                tex_zz_yyyz_0[j] = pa_z[j] * tex_z_yyyz_0[j] - pc_z[j] * tex_z_yyyz_1[j] + 0.5 * fl1_fx * tex_0_yyyz_0[j] -
                                   0.5 * fl1_fx * tex_0_yyyz_1[j] + 0.5 * fl1_fx * tex_z_yyy_0[j] - 0.5 * fl1_fx * tex_z_yyy_1[j];

                tey_zz_yyyz_0[j] = pa_z[j] * tey_z_yyyz_0[j] - pc_z[j] * tey_z_yyyz_1[j] + 0.5 * fl1_fx * tey_0_yyyz_0[j] -
                                   0.5 * fl1_fx * tey_0_yyyz_1[j] + 0.5 * fl1_fx * tey_z_yyy_0[j] - 0.5 * fl1_fx * tey_z_yyy_1[j];

                tez_zz_yyyz_0[j] = pa_z[j] * tez_z_yyyz_0[j] - pc_z[j] * tez_z_yyyz_1[j] + 0.5 * fl1_fx * tez_0_yyyz_0[j] -
                                   0.5 * fl1_fx * tez_0_yyyz_1[j] + 0.5 * fl1_fx * tez_z_yyy_0[j] - 0.5 * fl1_fx * tez_z_yyy_1[j] + ta_z_yyyz_1[j];

                tex_zz_yyzz_0[j] = pa_z[j] * tex_z_yyzz_0[j] - pc_z[j] * tex_z_yyzz_1[j] + 0.5 * fl1_fx * tex_0_yyzz_0[j] -
                                   0.5 * fl1_fx * tex_0_yyzz_1[j] + fl1_fx * tex_z_yyz_0[j] - fl1_fx * tex_z_yyz_1[j];

                tey_zz_yyzz_0[j] = pa_z[j] * tey_z_yyzz_0[j] - pc_z[j] * tey_z_yyzz_1[j] + 0.5 * fl1_fx * tey_0_yyzz_0[j] -
                                   0.5 * fl1_fx * tey_0_yyzz_1[j] + fl1_fx * tey_z_yyz_0[j] - fl1_fx * tey_z_yyz_1[j];

                tez_zz_yyzz_0[j] = pa_z[j] * tez_z_yyzz_0[j] - pc_z[j] * tez_z_yyzz_1[j] + 0.5 * fl1_fx * tez_0_yyzz_0[j] -
                                   0.5 * fl1_fx * tez_0_yyzz_1[j] + fl1_fx * tez_z_yyz_0[j] - fl1_fx * tez_z_yyz_1[j] + ta_z_yyzz_1[j];

                tex_zz_yzzz_0[j] = pa_z[j] * tex_z_yzzz_0[j] - pc_z[j] * tex_z_yzzz_1[j] + 0.5 * fl1_fx * tex_0_yzzz_0[j] -
                                   0.5 * fl1_fx * tex_0_yzzz_1[j] + 1.5 * fl1_fx * tex_z_yzz_0[j] - 1.5 * fl1_fx * tex_z_yzz_1[j];

                tey_zz_yzzz_0[j] = pa_z[j] * tey_z_yzzz_0[j] - pc_z[j] * tey_z_yzzz_1[j] + 0.5 * fl1_fx * tey_0_yzzz_0[j] -
                                   0.5 * fl1_fx * tey_0_yzzz_1[j] + 1.5 * fl1_fx * tey_z_yzz_0[j] - 1.5 * fl1_fx * tey_z_yzz_1[j];

                tez_zz_yzzz_0[j] = pa_z[j] * tez_z_yzzz_0[j] - pc_z[j] * tez_z_yzzz_1[j] + 0.5 * fl1_fx * tez_0_yzzz_0[j] -
                                   0.5 * fl1_fx * tez_0_yzzz_1[j] + 1.5 * fl1_fx * tez_z_yzz_0[j] - 1.5 * fl1_fx * tez_z_yzz_1[j] + ta_z_yzzz_1[j];

                tex_zz_zzzz_0[j] = pa_z[j] * tex_z_zzzz_0[j] - pc_z[j] * tex_z_zzzz_1[j] + 0.5 * fl1_fx * tex_0_zzzz_0[j] -
                                   0.5 * fl1_fx * tex_0_zzzz_1[j] + 2.0 * fl1_fx * tex_z_zzz_0[j] - 2.0 * fl1_fx * tex_z_zzz_1[j];

                tey_zz_zzzz_0[j] = pa_z[j] * tey_z_zzzz_0[j] - pc_z[j] * tey_z_zzzz_1[j] + 0.5 * fl1_fx * tey_0_zzzz_0[j] -
                                   0.5 * fl1_fx * tey_0_zzzz_1[j] + 2.0 * fl1_fx * tey_z_zzz_0[j] - 2.0 * fl1_fx * tey_z_zzz_1[j];

                tez_zz_zzzz_0[j] = pa_z[j] * tez_z_zzzz_0[j] - pc_z[j] * tez_z_zzzz_1[j] + 0.5 * fl1_fx * tez_0_zzzz_0[j] -
                                   0.5 * fl1_fx * tez_0_zzzz_1[j] + 2.0 * fl1_fx * tez_z_zzz_0[j] - 2.0 * fl1_fx * tez_z_zzz_1[j] + ta_z_zzzz_1[j];
            }
...
compElectricFieldForGD(CMemBlock2D<double>&       primBuffer,
                       ...
                       const int32_t              iContrGto)
{
    efieldrecfunc::compElectricFieldForGD_0_45(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    efieldrecfunc::compElectricFieldForGD_45_90(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    efieldrecfunc::compElectricFieldForGD_90_135(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    efieldrecfunc::compElectricFieldForGD_135_180(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    efieldrecfunc::compElectricFieldForGD_180_225(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    efieldrecfunc::compElectricFieldForGD_225_270(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
                            ...
                            const int32_t              iContrGto)
{
    ...
    auto mord = recursionMap.getMaxOrder({"Electric Field"}, {4, -1, -1, -1}, {2, -1, -1, -1}, 1, 1);

    for (int32_t iord = 0; iord <= mord; iord++)
    {
        // set up index of integral

        auto pidx_e_4_2_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Electric Field"}, 1, true, {4, -1, -1, -1}, {2, -1, -1, -1}, 1, 1, iord));
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tex_xxxx_xx_0[j] = pa_x[j] * tex_xxx_xx_0[j] - pc_x[j] * tex_xxx_xx_1[j] + 1.5 * fl1_fx * tex_xx_xx_0[j] -
                                   1.5 * fl1_fx * tex_xx_xx_1[j] + fl1_fx * tex_xxx_x_0[j] - fl1_fx * tex_xxx_x_1[j] + ta_xxx_xx_1[j];

                tey_xxxx_xx_0[j] = pa_x[j] * tey_xxx_xx_0[j] - pc_x[j] * tey_xxx_xx_1[j] + 1.5 * fl1_fx * tey_xx_xx_0[j] -
                                   1.5 * fl1_fx * tey_xx_xx_1[j] + fl1_fx * tey_xxx_x_0[j] - fl1_fx * tey_xxx_x_1[j];

                tez_xxxx_xx_0[j] = pa_x[j] * tez_xxx_xx_0[j] - pc_x[j] * tez_xxx_xx_1[j] + 1.5 * fl1_fx * tez_xx_xx_0[j] -
                                   1.5 * fl1_fx * tez_xx_xx_1[j] + fl1_fx * tez_xxx_x_0[j] - fl1_fx * tez_xxx_x_1[j];

                tex_xxxx_xy_0[j] = pa_x[j] * tex_xxx_xy_0[j] - pc_x[j] * tex_xxx_xy_1[j] + 1.5 * fl1_fx * tex_xx_xy_0[j] -
                                   1.5 * fl1_fx * tex_xx_xy_1[j] + 0.5 * fl1_fx * tex_xxx_y_0[j] - 0.5 * fl1_fx * tex_xxx_y_1[j] + ta_xxx_xy_1[j];

                tey_xxxx_xy_0[j] = pa_x[j] * tey_xxx_xy_0[j] - pc_x[j] * tey_xxx_xy_1[j] + 1.5 * fl1_fx * tey_xx_xy_0[j] -
                                   1.5 * fl1_fx * tey_xx_xy_1[j] + 0.5 * fl1_fx * tey_xxx_y_0[j] - 0.5 * fl1_fx * tey_xxx_y_1[j];

                tez_xxxx_xy_0[j] = pa_x[j] * tez_xxx_xy_0[j] - pc_x[j] * tez_xxx_xy_1[j] + 1.5 * fl1_fx * tez_xx_xy_0[j] -
                                   1.5 * fl1_fx * tez_xx_xy_1[j] + 0.5 * fl1_fx * tez_xxx_y_0[j] - 0.5 * fl1_fx * tez_xxx_y_1[j];

                tex_xxxx_xz_0[j] = pa_x[j] * tex_xxx_xz_0[j] - pc_x[j] * tex_xxx_xz_1[j] + 1.5 * fl1_fx * tex_xx_xz_0[j] -
                                   1.5 * fl1_fx * tex_xx_xz_1[j] + 0.5 * fl1_fx * tex_xxx_z_0[j] - 0.5 * fl1_fx * tex_xxx_z_1[j] + ta_xxx_xz_1[j];

                tey_xxxx_xz_0[j] = pa_x[j] * tey_xxx_xz_0[j] - pc_x[j] * tey_xxx_xz_1[j] + 1.5 * fl1_fx * tey_xx_xz_0[j] -
                                   1.5 * fl1_fx * tey_xx_xz_1[j] + 0.5 * fl1_fx * tey_xxx_z_0[j] - 0.5 * fl1_fx * tey_xxx_z_1[j];

                tez_xxxx_xz_0[j] = pa_x[j] * tez_xxx_xz_0[j] - pc_x[j] * tez_xxx_xz_1[j] + 1.5 * fl1_fx * tez_xx_xz_0[j] -
                                   1.5 * fl1_fx * tez_xx_xz_1[j] + 0.5 * fl1_fx * tez_xxx_z_0[j] - 0.5 * fl1_fx * tez_xxx_z_1[j];

                tex_xxxx_yy_0[j] = pa_x[j] * tex_xxx_yy_0[j] - pc_x[j] * tex_xxx_yy_1[j] + 1.5 * fl1_fx * tex_xx_yy_0[j] -
                                   1.5 * fl1_fx * tex_xx_yy_1[j] + ta_xxx_yy_1[j];

                tey_xxxx_yy_0[j] =
                    pa_x[j] * tey_xxx_yy_0[j] - pc_x[j] * tey_xxx_yy_1[j] + 1.5 * fl1_fx * tey_xx_yy_0[j] - 1.5 * fl1_fx * tey_xx_yy_1[j];

                tez_xxxx_yy_0[j] =
                    pa_x[j] * tez_xxx_yy_0[j] - pc_x[j] * tez_xxx_yy_1[j] + 1.5 * fl1_fx * tez_xx_yy_0[j] - 1.5 * fl1_fx * tez_xx_yy_1[j];

                tex_xxxx_yz_0[j] = pa_x[j] * tex_xxx_yz_0[j] - pc_x[j] * tex_xxx_yz_1[j] + 1.5 * fl1_fx * tex_xx_yz_0[j] -
                                   1.5 * fl1_fx * tex_xx_yz_1[j] + ta_xxx_yz_1[j];

                tey_xxxx_yz_0[j] =
                    pa_x[j] * tey_xxx_yz_0[j] - pc_x[j] * tey_xxx_yz_1[j] + 1.5 * fl1_fx * tey_xx_yz_0[j] - 1.5 * fl1_fx * tey_xx_yz_1[j];

                tez_xxxx_yz_0[j] =
                    pa_x[j] * tez_xxx_yz_0[j] - pc_x[j] * tez_xxx_yz_1[j] + 1.5 * fl1_fx * tez_xx_yz_0[j] - 1.5 * fl1_fx * tez_xx_yz_1[j];

                tex_xxxx_zz_0[j] = pa_x[j] * tex_xxx_zz_0[j] - pc_x[j] * tex_xxx_zz_1[j] + 1.5 * fl1_fx * tex_xx_zz_0[j] -
                                   1.5 * fl1_fx * tex_xx_zz_1[j] + ta_xxx_zz_1[j];

                tey_xxxx_zz_0[j] =
                    pa_x[j] * tey_xxx_zz_0[j] - pc_x[j] * tey_xxx_zz_1[j] + 1.5 * fl1_fx * tey_xx_zz_0[j] - 1.5 * fl1_fx * tey_xx_zz_1[j];

                tez_xxxx_zz_0[j] =
                    pa_x[j] * tez_xxx_zz_0[j] - pc_x[j] * tez_xxx_zz_1[j] + 1.5 * fl1_fx * tez_xx_zz_0[j] - 1.5 * fl1_fx * tez_xx_zz_1[j];

                tex_xxxy_xx_0[j] = pa_x[j] * tex_xxy_xx_0[j] - pc_x[j] * tex_xxy_xx_1[j] + fl1_fx * tex_xy_xx_0[j] - fl1_fx * tex_xy_xx_1[j] +
                                   fl1_fx * tex_xxy_x_0[j] - fl1_fx * tex_xxy_x_1[j] + ta_xxy_xx_1[j];

                tey_xxxy_xx_0[j] = pa_x[j] * tey_xxy_xx_0[j] - pc_x[j] * tey_xxy_xx_1[j] + fl1_fx * tey_xy_xx_0[j] - fl1_fx * tey_xy_xx_1[j] +
                                   fl1_fx * tey_xxy_x_0[j] - fl1_fx * tey_xxy_x_1[j];

                tez_xxxy_xx_0[j] = pa_x[j] * tez_xxy_xx_0[j] - pc_x[j] * tez_xxy_xx_1[j] + fl1_fx * tez_xy_xx_0[j] - fl1_fx * tez_xy_xx_1[j] +
                                   fl1_fx * tez_xxy_x_0[j] - fl1_fx * tez_xxy_x_1[j];

                tex_xxxy_xy_0[j] = pa_x[j] * tex_xxy_xy_0[j] - pc_x[j] * tex_xxy_xy_1[j] + fl1_fx * tex_xy_xy_0[j] - fl1_fx * tex_xy_xy_1[j] +
                                   0.5 * fl1_fx * tex_xxy_y_0[j] - 0.5 * fl1_fx * tex_xxy_y_1[j] + ta_xxy_xy_1[j];

                tey_xxxy_xy_0[j] = pa_x[j] * tey_xxy_xy_0[j] - pc_x[j] * tey_xxy_xy_1[j] + fl1_fx * tey_xy_xy_0[j] - fl1_fx * tey_xy_xy_1[j] +
                                   0.5 * fl1_fx * tey_xxy_y_0[j] - 0.5 * fl1_fx * tey_xxy_y_1[j];

                tez_xxxy_xy_0[j] = pa_x[j] * tez_xxy_xy_0[j] - pc_x[j] * tez_xxy_xy_1[j] + fl1_fx * tez_xy_xy_0[j] - fl1_fx * tez_xy_xy_1[j] +
                                   0.5 * fl1_fx * tez_xxy_y_0[j] - 0.5 * fl1_fx * tez_xxy_y_1[j];

                tex_xxxy_xz_0[j] = pa_x[j] * tex_xxy_xz_0[j] - pc_x[j] * tex_xxy_xz_1[j] + fl1_fx * tex_xy_xz_0[j] - fl1_fx * tex_xy_xz_1[j] +
                                   0.5 * fl1_fx * tex_xxy_z_0[j] - 0.5 * fl1_fx * tex_xxy_z_1[j] + ta_xxy_xz_1[j];

                tey_xxxy_xz_0[j] = pa_x[j] * tey_xxy_xz_0[j] - pc_x[j] * tey_xxy_xz_1[j] + fl1_fx * tey_xy_xz_0[j] - fl1_fx * tey_xy_xz_1[j] +
                                   0.5 * fl1_fx * tey_xxy_z_0[j] - 0.5 * fl1_fx * tey_xxy_z_1[j];

                tez_xxxy_xz_0[j] = pa_x[j] * tez_xxy_xz_0[j] - pc_x[j] * tez_xxy_xz_1[j] + fl1_fx * tez_xy_xz_0[j] - fl1_fx * tez_xy_xz_1[j] +
                                   0.5 * fl1_fx * tez_xxy_z_0[j] - 0.5 * fl1_fx * tez_xxy_z_1[j];

                tex_xxxy_yy_0[j] =
                    pa_x[j] * tex_xxy_yy_0[j] - pc_x[j] * tex_xxy_yy_1[j] + fl1_fx * tex_xy_yy_0[j] - fl1_fx * tex_xy_yy_1[j] + ta_xxy_yy_1[j];
                ...
                tex_xxxy_yz_0[j] =
                    pa_x[j] * tex_xxy_yz_0[j] - pc_x[j] * tex_xxy_yz_1[j] + fl1_fx * tex_xy_yz_0[j] - fl1_fx * tex_xy_yz_1[j] + ta_xxy_yz_1[j];
                ...
                tex_xxxy_zz_0[j] =
                    pa_x[j] * tex_xxy_zz_0[j] - pc_x[j] * tex_xxy_zz_1[j] + fl1_fx * tex_xy_zz_0[j] - fl1_fx * tex_xy_zz_1[j] + ta_xxy_zz_1[j];
                ...
                tex_xxxz_xx_0[j] = pa_x[j] * tex_xxz_xx_0[j] - pc_x[j] * tex_xxz_xx_1[j] + fl1_fx * tex_xz_xx_0[j] - fl1_fx * tex_xz_xx_1[j] +
                                   fl1_fx * tex_xxz_x_0[j] - fl1_fx * tex_xxz_x_1[j] + ta_xxz_xx_1[j];

                tey_xxxz_xx_0[j] = pa_x[j] * tey_xxz_xx_0[j] - pc_x[j] * tey_xxz_xx_1[j] + fl1_fx * tey_xz_xx_0[j] - fl1_fx * tey_xz_xx_1[j] +
                                   fl1_fx * tey_xxz_x_0[j] - fl1_fx * tey_xxz_x_1[j];

                tez_xxxz_xx_0[j] = pa_x[j] * tez_xxz_xx_0[j] - pc_x[j] * tez_xxz_xx_1[j] + fl1_fx * tez_xz_xx_0[j] - fl1_fx * tez_xz_xx_1[j] +
                                   fl1_fx * tez_xxz_x_0[j] - fl1_fx * tez_xxz_x_1[j];

                tex_xxxz_xy_0[j] = pa_x[j] * tex_xxz_xy_0[j] - pc_x[j] * tex_xxz_xy_1[j] + fl1_fx * tex_xz_xy_0[j] - fl1_fx * tex_xz_xy_1[j] +
                                   0.5 * fl1_fx * tex_xxz_y_0[j] - 0.5 * fl1_fx * tex_xxz_y_1[j] + ta_xxz_xy_1[j];

                tey_xxxz_xy_0[j] = pa_x[j] * tey_xxz_xy_0[j] - pc_x[j] * tey_xxz_xy_1[j] + fl1_fx * tey_xz_xy_0[j] - fl1_fx * tey_xz_xy_1[j] +
                                   0.5 * fl1_fx * tey_xxz_y_0[j] - 0.5 * fl1_fx * tey_xxz_y_1[j];

                tez_xxxz_xy_0[j] = pa_x[j] * tez_xxz_xy_0[j] - pc_x[j] * tez_xxz_xy_1[j] + fl1_fx * tez_xz_xy_0[j] - fl1_fx * tez_xz_xy_1[j] +
                                   0.5 * fl1_fx * tez_xxz_y_0[j] - 0.5 * fl1_fx * tez_xxz_y_1[j];

                tex_xxxz_xz_0[j] = pa_x[j] * tex_xxz_xz_0[j] - pc_x[j] * tex_xxz_xz_1[j] + fl1_fx * tex_xz_xz_0[j] - fl1_fx * tex_xz_xz_1[j] +
                                   0.5 * fl1_fx * tex_xxz_z_0[j] - 0.5 * fl1_fx * tex_xxz_z_1[j] + ta_xxz_xz_1[j];

                tey_xxxz_xz_0[j] = pa_x[j] * tey_xxz_xz_0[j] - pc_x[j] * tey_xxz_xz_1[j] + fl1_fx * tey_xz_xz_0[j] - fl1_fx * tey_xz_xz_1[j] +
                                   0.5 * fl1_fx * tey_xxz_z_0[j] - 0.5 * fl1_fx * tey_xxz_z_1[j];

                tez_xxxz_xz_0[j] = pa_x[j] * tez_xxz_xz_0[j] - pc_x[j] * tez_xxz_xz_1[j] + fl1_fx * tez_xz_xz_0[j] - fl1_fx * tez_xz_xz_1[j] +
                                   0.5 * fl1_fx * tez_xxz_z_0[j] - 0.5 * fl1_fx * tez_xxz_z_1[j];
            }
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tex_xxxz_yy_0[j] =
                    pa_x[j] * tex_xxz_yy_0[j] - pc_x[j] * tex_xxz_yy_1[j] + fl1_fx * tex_xz_yy_0[j] - fl1_fx * tex_xz_yy_1[j] + ta_xxz_yy_1[j];
                ...
                tex_xxxz_yz_0[j] =
                    pa_x[j] * tex_xxz_yz_0[j] - pc_x[j] * tex_xxz_yz_1[j] + fl1_fx * tex_xz_yz_0[j] - fl1_fx * tex_xz_yz_1[j] + ta_xxz_yz_1[j];
                ...
                tex_xxxz_zz_0[j] =
                    pa_x[j] * tex_xxz_zz_0[j] - pc_x[j] * tex_xxz_zz_1[j] + fl1_fx * tex_xz_zz_0[j] - fl1_fx * tex_xz_zz_1[j] + ta_xxz_zz_1[j];
                ...
                tex_xxyy_xx_0[j] = pa_x[j] * tex_xyy_xx_0[j] - pc_x[j] * tex_xyy_xx_1[j] + 0.5 * fl1_fx * tex_yy_xx_0[j] -
                                   0.5 * fl1_fx * tex_yy_xx_1[j] + fl1_fx * tex_xyy_x_0[j] - fl1_fx * tex_xyy_x_1[j] + ta_xyy_xx_1[j];

                tey_xxyy_xx_0[j] = pa_x[j] * tey_xyy_xx_0[j] - pc_x[j] * tey_xyy_xx_1[j] + 0.5 * fl1_fx * tey_yy_xx_0[j] -
                                   0.5 * fl1_fx * tey_yy_xx_1[j] + fl1_fx * tey_xyy_x_0[j] - fl1_fx * tey_xyy_x_1[j];

                tez_xxyy_xx_0[j] = pa_x[j] * tez_xyy_xx_0[j] - pc_x[j] * tez_xyy_xx_1[j] + 0.5 * fl1_fx * tez_yy_xx_0[j] -
                                   0.5 * fl1_fx * tez_yy_xx_1[j] + fl1_fx * tez_xyy_x_0[j] - fl1_fx * tez_xyy_x_1[j];

                tex_xxyy_xy_0[j] = pa_x[j] * tex_xyy_xy_0[j] - pc_x[j] * tex_xyy_xy_1[j] + 0.5 * fl1_fx * tex_yy_xy_0[j] -
                                   0.5 * fl1_fx * tex_yy_xy_1[j] + 0.5 * fl1_fx * tex_xyy_y_0[j] - 0.5 * fl1_fx * tex_xyy_y_1[j] + ta_xyy_xy_1[j];

                tey_xxyy_xy_0[j] = pa_x[j] * tey_xyy_xy_0[j] - pc_x[j] * tey_xyy_xy_1[j] + 0.5 * fl1_fx * tey_yy_xy_0[j] -
                                   0.5 * fl1_fx * tey_yy_xy_1[j] + 0.5 * fl1_fx * tey_xyy_y_0[j] - 0.5 * fl1_fx * tey_xyy_y_1[j];

                tez_xxyy_xy_0[j] = pa_x[j] * tez_xyy_xy_0[j] - pc_x[j] * tez_xyy_xy_1[j] + 0.5 * fl1_fx * tez_yy_xy_0[j] -
                                   0.5 * fl1_fx * tez_yy_xy_1[j] + 0.5 * fl1_fx * tez_xyy_y_0[j] - 0.5 * fl1_fx * tez_xyy_y_1[j];

                tex_xxyy_xz_0[j] = pa_x[j] * tex_xyy_xz_0[j] - pc_x[j] * tex_xyy_xz_1[j] + 0.5 * fl1_fx * tex_yy_xz_0[j] -
                                   0.5 * fl1_fx * tex_yy_xz_1[j] + 0.5 * fl1_fx * tex_xyy_z_0[j] - 0.5 * fl1_fx * tex_xyy_z_1[j] + ta_xyy_xz_1[j];

                tey_xxyy_xz_0[j] = pa_x[j] * tey_xyy_xz_0[j] - pc_x[j] * tey_xyy_xz_1[j] + 0.5 * fl1_fx * tey_yy_xz_0[j] -
                                   0.5 * fl1_fx * tey_yy_xz_1[j] + 0.5 * fl1_fx * tey_xyy_z_0[j] - 0.5 * fl1_fx * tey_xyy_z_1[j];

                tez_xxyy_xz_0[j] = pa_x[j] * tez_xyy_xz_0[j] - pc_x[j] * tez_xyy_xz_1[j] + 0.5 * fl1_fx * tez_yy_xz_0[j] -
                                   0.5 * fl1_fx * tez_yy_xz_1[j] + 0.5 * fl1_fx * tez_xyy_z_0[j] - 0.5 * fl1_fx * tez_xyy_z_1[j];

                tex_xxyy_yy_0[j] = pa_x[j] * tex_xyy_yy_0[j] - pc_x[j] * tex_xyy_yy_1[j] + 0.5 * fl1_fx * tex_yy_yy_0[j] -
                                   0.5 * fl1_fx * tex_yy_yy_1[j] + ta_xyy_yy_1[j];

                tey_xxyy_yy_0[j] =
                    pa_x[j] * tey_xyy_yy_0[j] - pc_x[j] * tey_xyy_yy_1[j] + 0.5 * fl1_fx * tey_yy_yy_0[j] - 0.5 * fl1_fx * tey_yy_yy_1[j];

                tez_xxyy_yy_0[j] =
                    pa_x[j] * tez_xyy_yy_0[j] - pc_x[j] * tez_xyy_yy_1[j] + 0.5 * fl1_fx * tez_yy_yy_0[j] - 0.5 * fl1_fx * tez_yy_yy_1[j];

                tex_xxyy_yz_0[j] = pa_x[j] * tex_xyy_yz_0[j] - pc_x[j] * tex_xyy_yz_1[j] + 0.5 * fl1_fx * tex_yy_yz_0[j] -
                                   0.5 * fl1_fx * tex_yy_yz_1[j] + ta_xyy_yz_1[j];

                tey_xxyy_yz_0[j] =
                    pa_x[j] * tey_xyy_yz_0[j] - pc_x[j] * tey_xyy_yz_1[j] + 0.5 * fl1_fx * tey_yy_yz_0[j] - 0.5 * fl1_fx * tey_yy_yz_1[j];

                tez_xxyy_yz_0[j] =
                    pa_x[j] * tez_xyy_yz_0[j] - pc_x[j] * tez_xyy_yz_1[j] + 0.5 * fl1_fx * tez_yy_yz_0[j] - 0.5 * fl1_fx * tez_yy_yz_1[j];

                tex_xxyy_zz_0[j] = pa_x[j] * tex_xyy_zz_0[j] - pc_x[j] * tex_xyy_zz_1[j] + 0.5 * fl1_fx * tex_yy_zz_0[j] -
                                   0.5 * fl1_fx * tex_yy_zz_1[j] + ta_xyy_zz_1[j];

                tey_xxyy_zz_0[j] =
                    pa_x[j] * tey_xyy_zz_0[j] - pc_x[j] * tey_xyy_zz_1[j] + 0.5 * fl1_fx * tey_yy_zz_0[j] - 0.5 * fl1_fx * tey_yy_zz_1[j];

                tez_xxyy_zz_0[j] =
                    pa_x[j] * tez_xyy_zz_0[j] - pc_x[j] * tez_xyy_zz_1[j] + 0.5 * fl1_fx * tez_yy_zz_0[j] - 0.5 * fl1_fx * tez_yy_zz_1[j];

                tex_xxyz_xx_0[j] = pa_x[j] * tex_xyz_xx_0[j] - pc_x[j] * tex_xyz_xx_1[j] + 0.5 * fl1_fx * tex_yz_xx_0[j] -
                                   0.5 * fl1_fx * tex_yz_xx_1[j] + fl1_fx * tex_xyz_x_0[j] - fl1_fx * tex_xyz_x_1[j] + ta_xyz_xx_1[j];

                tey_xxyz_xx_0[j] = pa_x[j] * tey_xyz_xx_0[j] - pc_x[j] * tey_xyz_xx_1[j] + 0.5 * fl1_fx * tey_yz_xx_0[j] -
                                   0.5 * fl1_fx * tey_yz_xx_1[j] + fl1_fx * tey_xyz_x_0[j] - fl1_fx * tey_xyz_x_1[j];

                tez_xxyz_xx_0[j] = pa_x[j] * tez_xyz_xx_0[j] - pc_x[j] * tez_xyz_xx_1[j] + 0.5 * fl1_fx * tez_yz_xx_0[j] -
                                   0.5 * fl1_fx * tez_yz_xx_1[j] + fl1_fx * tez_xyz_x_0[j] - fl1_fx * tez_xyz_x_1[j];

                tex_xxyz_xy_0[j] = pa_x[j] * tex_xyz_xy_0[j] - pc_x[j] * tex_xyz_xy_1[j] + 0.5 * fl1_fx * tex_yz_xy_0[j] -
                                   0.5 * fl1_fx * tex_yz_xy_1[j] + 0.5 * fl1_fx * tex_xyz_y_0[j] - 0.5 * fl1_fx * tex_xyz_y_1[j] + ta_xyz_xy_1[j];

                tey_xxyz_xy_0[j] = pa_x[j] * tey_xyz_xy_0[j] - pc_x[j] * tey_xyz_xy_1[j] + 0.5 * fl1_fx * tey_yz_xy_0[j] -
                                   0.5 * fl1_fx * tey_yz_xy_1[j] + 0.5 * fl1_fx * tey_xyz_y_0[j] - 0.5 * fl1_fx * tey_xyz_y_1[j];

                tez_xxyz_xy_0[j] = pa_x[j] * tez_xyz_xy_0[j] - pc_x[j] * tez_xyz_xy_1[j] + 0.5 * fl1_fx * tez_yz_xy_0[j] -
                                   0.5 * fl1_fx * tez_yz_xy_1[j] + 0.5 * fl1_fx * tez_xyz_y_0[j] - 0.5 * fl1_fx * tez_xyz_y_1[j];

                tex_xxyz_xz_0[j] = pa_x[j] * tex_xyz_xz_0[j] - pc_x[j] * tex_xyz_xz_1[j] + 0.5 * fl1_fx * tex_yz_xz_0[j] -
                                   0.5 * fl1_fx * tex_yz_xz_1[j] + 0.5 * fl1_fx * tex_xyz_z_0[j] - 0.5 * fl1_fx * tex_xyz_z_1[j] + ta_xyz_xz_1[j];

                tey_xxyz_xz_0[j] = pa_x[j] * tey_xyz_xz_0[j] - pc_x[j] * tey_xyz_xz_1[j] + 0.5 * fl1_fx * tey_yz_xz_0[j] -
                                   0.5 * fl1_fx * tey_yz_xz_1[j] + 0.5 * fl1_fx * tey_xyz_z_0[j] - 0.5 * fl1_fx * tey_xyz_z_1[j];

                tez_xxyz_xz_0[j] = pa_x[j] * tez_xyz_xz_0[j] - pc_x[j] * tez_xyz_xz_1[j] + 0.5 * fl1_fx * tez_yz_xz_0[j] -
                                   0.5 * fl1_fx * tez_yz_xz_1[j] + 0.5 * fl1_fx * tez_xyz_z_0[j] - 0.5 * fl1_fx * tez_xyz_z_1[j];

                tex_xxyz_yy_0[j] = pa_x[j] * tex_xyz_yy_0[j] - pc_x[j] * tex_xyz_yy_1[j] + 0.5 * fl1_fx * tex_yz_yy_0[j] -
                                   0.5 * fl1_fx * tex_yz_yy_1[j] + ta_xyz_yy_1[j];

                tey_xxyz_yy_0[j] =
                    pa_x[j] * tey_xyz_yy_0[j] - pc_x[j] * tey_xyz_yy_1[j] + 0.5 * fl1_fx * tey_yz_yy_0[j] - 0.5 * fl1_fx * tey_yz_yy_1[j];

                tez_xxyz_yy_0[j] =
                    pa_x[j] * tez_xyz_yy_0[j] - pc_x[j] * tez_xyz_yy_1[j] + 0.5 * fl1_fx * tez_yz_yy_0[j] - 0.5 * fl1_fx * tez_yz_yy_1[j];

                tex_xxyz_yz_0[j] = pa_x[j] * tex_xyz_yz_0[j] - pc_x[j] * tex_xyz_yz_1[j] + 0.5 * fl1_fx * tex_yz_yz_0[j] -
                                   0.5 * fl1_fx * tex_yz_yz_1[j] + ta_xyz_yz_1[j];

                tey_xxyz_yz_0[j] =
                    pa_x[j] * tey_xyz_yz_0[j] - pc_x[j] * tey_xyz_yz_1[j] + 0.5 * fl1_fx * tey_yz_yz_0[j] - 0.5 * fl1_fx * tey_yz_yz_1[j];

                tez_xxyz_yz_0[j] =
                    pa_x[j] * tez_xyz_yz_0[j] - pc_x[j] * tez_xyz_yz_1[j] + 0.5 * fl1_fx * tez_yz_yz_0[j] - 0.5 * fl1_fx * tez_yz_yz_1[j];

                tex_xxyz_zz_0[j] = pa_x[j] * tex_xyz_zz_0[j] - pc_x[j] * tex_xyz_zz_1[j] + 0.5 * fl1_fx * tex_yz_zz_0[j] -
                                   0.5 * fl1_fx * tex_yz_zz_1[j] + ta_xyz_zz_1[j];

                tey_xxyz_zz_0[j] =
                    pa_x[j] * tey_xyz_zz_0[j] - pc_x[j] * tey_xyz_zz_1[j] + 0.5 * fl1_fx * tey_yz_zz_0[j] - 0.5 * fl1_fx * tey_yz_zz_1[j];

                tez_xxyz_zz_0[j] =
                    pa_x[j] * tez_xyz_zz_0[j] - pc_x[j] * tez_xyz_zz_1[j] + 0.5 * fl1_fx * tez_yz_zz_0[j] - 0.5 * fl1_fx * tez_yz_zz_1[j];
            }
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tex_xxzz_xx_0[j] = pa_x[j] * tex_xzz_xx_0[j] - pc_x[j] * tex_xzz_xx_1[j] + 0.5 * fl1_fx * tex_zz_xx_0[j] -
                                   0.5 * fl1_fx * tex_zz_xx_1[j] + fl1_fx * tex_xzz_x_0[j] - fl1_fx * tex_xzz_x_1[j] + ta_xzz_xx_1[j];

                tey_xxzz_xx_0[j] = pa_x[j] * tey_xzz_xx_0[j] - pc_x[j] * tey_xzz_xx_1[j] + 0.5 * fl1_fx * tey_zz_xx_0[j] -
                                   0.5 * fl1_fx * tey_zz_xx_1[j] + fl1_fx * tey_xzz_x_0[j] - fl1_fx * tey_xzz_x_1[j];

                tez_xxzz_xx_0[j] = pa_x[j] * tez_xzz_xx_0[j] - pc_x[j] * tez_xzz_xx_1[j] + 0.5 * fl1_fx * tez_zz_xx_0[j] -
                                   0.5 * fl1_fx * tez_zz_xx_1[j] + fl1_fx * tez_xzz_x_0[j] - fl1_fx * tez_xzz_x_1[j];

                tex_xxzz_xy_0[j] = pa_x[j] * tex_xzz_xy_0[j] - pc_x[j] * tex_xzz_xy_1[j] + 0.5 * fl1_fx * tex_zz_xy_0[j] -
                                   0.5 * fl1_fx * tex_zz_xy_1[j] + 0.5 * fl1_fx * tex_xzz_y_0[j] - 0.5 * fl1_fx * tex_xzz_y_1[j] + ta_xzz_xy_1[j];

                tey_xxzz_xy_0[j] = pa_x[j] * tey_xzz_xy_0[j] - pc_x[j] * tey_xzz_xy_1[j] + 0.5 * fl1_fx * tey_zz_xy_0[j] -
                                   0.5 * fl1_fx * tey_zz_xy_1[j] + 0.5 * fl1_fx * tey_xzz_y_0[j] - 0.5 * fl1_fx * tey_xzz_y_1[j];

                tez_xxzz_xy_0[j] = pa_x[j] * tez_xzz_xy_0[j] - pc_x[j] * tez_xzz_xy_1[j] + 0.5 * fl1_fx * tez_zz_xy_0[j] -
                                   0.5 * fl1_fx * tez_zz_xy_1[j] + 0.5 * fl1_fx * tez_xzz_y_0[j] - 0.5 * fl1_fx * tez_xzz_y_1[j];

                tex_xxzz_xz_0[j] = pa_x[j] * tex_xzz_xz_0[j] - pc_x[j] * tex_xzz_xz_1[j] + 0.5 * fl1_fx * tex_zz_xz_0[j] -
                                   0.5 * fl1_fx * tex_zz_xz_1[j] + 0.5 * fl1_fx * tex_xzz_z_0[j] - 0.5 * fl1_fx * tex_xzz_z_1[j] + ta_xzz_xz_1[j];

                tey_xxzz_xz_0[j] = pa_x[j] * tey_xzz_xz_0[j] - pc_x[j] * tey_xzz_xz_1[j] + 0.5 * fl1_fx * tey_zz_xz_0[j] -
                                   0.5 * fl1_fx * tey_zz_xz_1[j] + 0.5 * fl1_fx * tey_xzz_z_0[j] - 0.5 * fl1_fx * tey_xzz_z_1[j];

                tez_xxzz_xz_0[j] = pa_x[j] * tez_xzz_xz_0[j] - pc_x[j] * tez_xzz_xz_1[j] + 0.5 * fl1_fx * tez_zz_xz_0[j] -
                                   0.5 * fl1_fx * tez_zz_xz_1[j] + 0.5 * fl1_fx * tez_xzz_z_0[j] - 0.5 * fl1_fx * tez_xzz_z_1[j];

                tex_xxzz_yy_0[j] = pa_x[j] * tex_xzz_yy_0[j] - pc_x[j] * tex_xzz_yy_1[j] + 0.5 * fl1_fx * tex_zz_yy_0[j] -
                                   0.5 * fl1_fx * tex_zz_yy_1[j] + ta_xzz_yy_1[j];

                tey_xxzz_yy_0[j] =
                    pa_x[j] * tey_xzz_yy_0[j] - pc_x[j] * tey_xzz_yy_1[j] + 0.5 * fl1_fx * tey_zz_yy_0[j] - 0.5 * fl1_fx * tey_zz_yy_1[j];

                tez_xxzz_yy_0[j] =
                    pa_x[j] * tez_xzz_yy_0[j] - pc_x[j] * tez_xzz_yy_1[j] + 0.5 * fl1_fx * tez_zz_yy_0[j] - 0.5 * fl1_fx * tez_zz_yy_1[j];

                tex_xxzz_yz_0[j] = pa_x[j] * tex_xzz_yz_0[j] - pc_x[j] * tex_xzz_yz_1[j] + 0.5 * fl1_fx * tex_zz_yz_0[j] -
                                   0.5 * fl1_fx * tex_zz_yz_1[j] + ta_xzz_yz_1[j];

                tey_xxzz_yz_0[j] =
                    pa_x[j] * tey_xzz_yz_0[j] - pc_x[j] * tey_xzz_yz_1[j] + 0.5 * fl1_fx * tey_zz_yz_0[j] - 0.5 * fl1_fx * tey_zz_yz_1[j];

                tez_xxzz_yz_0[j] =
                    pa_x[j] * tez_xzz_yz_0[j] - pc_x[j] * tez_xzz_yz_1[j] + 0.5 * fl1_fx * tez_zz_yz_0[j] - 0.5 * fl1_fx * tez_zz_yz_1[j];

                tex_xxzz_zz_0[j] = pa_x[j] * tex_xzz_zz_0[j] - pc_x[j] * tex_xzz_zz_1[j] + 0.5 * fl1_fx * tex_zz_zz_0[j] -
                                   0.5 * fl1_fx * tex_zz_zz_1[j] + ta_xzz_zz_1[j];

                tey_xxzz_zz_0[j] =
                    pa_x[j] * tey_xzz_zz_0[j] - pc_x[j] * tey_xzz_zz_1[j] + 0.5 * fl1_fx * tey_zz_zz_0[j] - 0.5 * fl1_fx * tey_zz_zz_1[j];

                tez_xxzz_zz_0[j] =
                    pa_x[j] * tez_xzz_zz_0[j] - pc_x[j] * tez_xzz_zz_1[j] + 0.5 * fl1_fx * tez_zz_zz_0[j] - 0.5 * fl1_fx * tez_zz_zz_1[j];

                tex_xyyy_xx_0[j] =
                    pa_x[j] * tex_yyy_xx_0[j] - pc_x[j] * tex_yyy_xx_1[j] + fl1_fx * tex_yyy_x_0[j] - fl1_fx * tex_yyy_x_1[j] + ta_yyy_xx_1[j];
                ...
                tex_xyyy_xy_0[j] = pa_x[j] * tex_yyy_xy_0[j] - pc_x[j] * tex_yyy_xy_1[j] + 0.5 * fl1_fx * tex_yyy_y_0[j] -
                                   0.5 * fl1_fx * tex_yyy_y_1[j] + ta_yyy_xy_1[j];

                tey_xyyy_xy_0[j] =
                    pa_x[j] * tey_yyy_xy_0[j] - pc_x[j] * tey_yyy_xy_1[j] + 0.5 * fl1_fx * tey_yyy_y_0[j] - 0.5 * fl1_fx * tey_yyy_y_1[j];

                tez_xyyy_xy_0[j] =
                    pa_x[j] * tez_yyy_xy_0[j] - pc_x[j] * tez_yyy_xy_1[j] + 0.5 * fl1_fx * tez_yyy_y_0[j] - 0.5 * fl1_fx * tez_yyy_y_1[j];

                tex_xyyy_xz_0[j] = pa_x[j] * tex_yyy_xz_0[j] - pc_x[j] * tex_yyy_xz_1[j] + 0.5 * fl1_fx * tex_yyy_z_0[j] -
                                   0.5 * fl1_fx * tex_yyy_z_1[j] + ta_yyy_xz_1[j];

                tey_xyyy_xz_0[j] =
                    pa_x[j] * tey_yyy_xz_0[j] - pc_x[j] * tey_yyy_xz_1[j] + 0.5 * fl1_fx * tey_yyy_z_0[j] - 0.5 * fl1_fx * tey_yyy_z_1[j];

                tez_xyyy_xz_0[j] =
                    pa_x[j] * tez_yyy_xz_0[j] - pc_x[j] * tez_yyy_xz_1[j] + 0.5 * fl1_fx * tez_yyy_z_0[j] - 0.5 * fl1_fx * tez_yyy_z_1[j];
                ...
                tex_xyyz_xx_0[j] =
                    pa_x[j] * tex_yyz_xx_0[j] - pc_x[j] * tex_yyz_xx_1[j] + fl1_fx * tex_yyz_x_0[j] - fl1_fx * tex_yyz_x_1[j] + ta_yyz_xx_1[j];
                ...
                tex_xyyz_xy_0[j] = pa_x[j] * tex_yyz_xy_0[j] - pc_x[j] * tex_yyz_xy_1[j] + 0.5 * fl1_fx * tex_yyz_y_0[j] -
                                   0.5 * fl1_fx * tex_yyz_y_1[j] + ta_yyz_xy_1[j];

                tey_xyyz_xy_0[j] =
                    pa_x[j] * tey_yyz_xy_0[j] - pc_x[j] * tey_yyz_xy_1[j] + 0.5 * fl1_fx * tey_yyz_y_0[j] - 0.5 * fl1_fx * tey_yyz_y_1[j];

                tez_xyyz_xy_0[j] =
                    pa_x[j] * tez_yyz_xy_0[j] - pc_x[j] * tez_yyz_xy_1[j] + 0.5 * fl1_fx * tez_yyz_y_0[j] - 0.5 * fl1_fx * tez_yyz_y_1[j];

                tex_xyyz_xz_0[j] = pa_x[j] * tex_yyz_xz_0[j] - pc_x[j] * tex_yyz_xz_1[j] + 0.5 * fl1_fx * tex_yyz_z_0[j] -
                                   0.5 * fl1_fx * tex_yyz_z_1[j] + ta_yyz_xz_1[j];

                tey_xyyz_xz_0[j] =
                    pa_x[j] * tey_yyz_xz_0[j] - pc_x[j] * tey_yyz_xz_1[j] + 0.5 * fl1_fx * tey_yyz_z_0[j] - 0.5 * fl1_fx * tey_yyz_z_1[j];

                tez_xyyz_xz_0[j] =
                    pa_x[j] * tez_yyz_xz_0[j] - pc_x[j] * tez_yyz_xz_1[j] + 0.5 * fl1_fx * tez_yyz_z_0[j] - 0.5 * fl1_fx * tez_yyz_z_1[j];
            }
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tex_xyzz_xx_0[j] =
                    pa_x[j] * tex_yzz_xx_0[j] - pc_x[j] * tex_yzz_xx_1[j] + fl1_fx * tex_yzz_x_0[j] - fl1_fx * tex_yzz_x_1[j] + ta_yzz_xx_1[j];
                ...
                tex_xyzz_xy_0[j] = pa_x[j] * tex_yzz_xy_0[j] - pc_x[j] * tex_yzz_xy_1[j] + 0.5 * fl1_fx * tex_yzz_y_0[j] -
                                   0.5 * fl1_fx * tex_yzz_y_1[j] + ta_yzz_xy_1[j];

                tey_xyzz_xy_0[j] =
                    pa_x[j] * tey_yzz_xy_0[j] - pc_x[j] * tey_yzz_xy_1[j] + 0.5 * fl1_fx * tey_yzz_y_0[j] - 0.5 * fl1_fx * tey_yzz_y_1[j];

                tez_xyzz_xy_0[j] =
                    pa_x[j] * tez_yzz_xy_0[j] - pc_x[j] * tez_yzz_xy_1[j] + 0.5 * fl1_fx * tez_yzz_y_0[j] - 0.5 * fl1_fx * tez_yzz_y_1[j];

                tex_xyzz_xz_0[j] = pa_x[j] * tex_yzz_xz_0[j] - pc_x[j] * tex_yzz_xz_1[j] + 0.5 * fl1_fx * tex_yzz_z_0[j] -
                                   0.5 * fl1_fx * tex_yzz_z_1[j] + ta_yzz_xz_1[j];

                tey_xyzz_xz_0[j] =
                    pa_x[j] * tey_yzz_xz_0[j] - pc_x[j] * tey_yzz_xz_1[j] + 0.5 * fl1_fx * tey_yzz_z_0[j] - 0.5 * fl1_fx * tey_yzz_z_1[j];

                tez_xyzz_xz_0[j] =
                    pa_x[j] * tez_yzz_xz_0[j] - pc_x[j] * tez_yzz_xz_1[j] + 0.5 * fl1_fx * tez_yzz_z_0[j] - 0.5 * fl1_fx * tez_yzz_z_1[j];
                ...
                tex_xzzz_xx_0[j] =
                    pa_x[j] * tex_zzz_xx_0[j] - pc_x[j] * tex_zzz_xx_1[j] + fl1_fx * tex_zzz_x_0[j] - fl1_fx * tex_zzz_x_1[j] + ta_zzz_xx_1[j];
                ...
                tex_xzzz_xy_0[j] = pa_x[j] * tex_zzz_xy_0[j] - pc_x[j] * tex_zzz_xy_1[j] + 0.5 * fl1_fx * tex_zzz_y_0[j] -
                                   0.5 * fl1_fx * tex_zzz_y_1[j] + ta_zzz_xy_1[j];

                tey_xzzz_xy_0[j] =
                    pa_x[j] * tey_zzz_xy_0[j] - pc_x[j] * tey_zzz_xy_1[j] + 0.5 * fl1_fx * tey_zzz_y_0[j] - 0.5 * fl1_fx * tey_zzz_y_1[j];

                tez_xzzz_xy_0[j] =
                    pa_x[j] * tez_zzz_xy_0[j] - pc_x[j] * tez_zzz_xy_1[j] + 0.5 * fl1_fx * tez_zzz_y_0[j] - 0.5 * fl1_fx * tez_zzz_y_1[j];

                tex_xzzz_xz_0[j] = pa_x[j] * tex_zzz_xz_0[j] - pc_x[j] * tex_zzz_xz_1[j] + 0.5 * fl1_fx * tex_zzz_z_0[j] -
                                   0.5 * fl1_fx * tex_zzz_z_1[j] + ta_zzz_xz_1[j];

                tey_xzzz_xz_0[j] =
                    pa_x[j] * tey_zzz_xz_0[j] - pc_x[j] * tey_zzz_xz_1[j] + 0.5 * fl1_fx * tey_zzz_z_0[j] - 0.5 * fl1_fx * tey_zzz_z_1[j];

                tez_xzzz_xz_0[j] =
                    pa_x[j] * tez_zzz_xz_0[j] - pc_x[j] * tez_zzz_xz_1[j] + 0.5 * fl1_fx * tez_zzz_z_0[j] - 0.5 * fl1_fx * tez_zzz_z_1[j];
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tex_yyyy_xx_0[j] =
                    pa_y[j] * tex_yyy_xx_0[j] - pc_y[j] * tex_yyy_xx_1[j] + 1.5 * fl1_fx * tex_yy_xx_0[j] - 1.5 * fl1_fx * tex_yy_xx_1[j];

                tey_yyyy_xx_0[j] = pa_y[j] * tey_yyy_xx_0[j] - pc_y[j] * tey_yyy_xx_1[j] + 1.5 * fl1_fx * tey_yy_xx_0[j] -
                                   1.5 * fl1_fx * tey_yy_xx_1[j] + ta_yyy_xx_1[j];

                tez_yyyy_xx_0[j] =
                    pa_y[j] * tez_yyy_xx_0[j] - pc_y[j] * tez_yyy_xx_1[j] + 1.5 * fl1_fx * tez_yy_xx_0[j] - 1.5 * fl1_fx * tez_yy_xx_1[j];

                tex_yyyy_xy_0[j] = pa_y[j] * tex_yyy_xy_0[j] - pc_y[j] * tex_yyy_xy_1[j] + 1.5 * fl1_fx * tex_yy_xy_0[j] -
                                   1.5 * fl1_fx * tex_yy_xy_1[j] + 0.5 * fl1_fx * tex_yyy_x_0[j] - 0.5 * fl1_fx * tex_yyy_x_1[j];

                tey_yyyy_xy_0[j] = pa_y[j] * tey_yyy_xy_0[j] - pc_y[j] * tey_yyy_xy_1[j] + 1.5 * fl1_fx * tey_yy_xy_0[j] -
                                   1.5 * fl1_fx * tey_yy_xy_1[j] + 0.5 * fl1_fx * tey_yyy_x_0[j] - 0.5 * fl1_fx * tey_yyy_x_1[j] + ta_yyy_xy_1[j];

                tez_yyyy_xy_0[j] = pa_y[j] * tez_yyy_xy_0[j] - pc_y[j] * tez_yyy_xy_1[j] + 1.5 * fl1_fx * tez_yy_xy_0[j] -
                                   1.5 * fl1_fx * tez_yy_xy_1[j] + 0.5 * fl1_fx * tez_yyy_x_0[j] - 0.5 * fl1_fx * tez_yyy_x_1[j];

                tex_yyyy_xz_0[j] =
                    pa_y[j] * tex_yyy_xz_0[j] - pc_y[j] * tex_yyy_xz_1[j] + 1.5 * fl1_fx * tex_yy_xz_0[j] - 1.5 * fl1_fx * tex_yy_xz_1[j];

                tey_yyyy_xz_0[j] = pa_y[j] * tey_yyy_xz_0[j] - pc_y[j] * tey_yyy_xz_1[j] + 1.5 * fl1_fx * tey_yy_xz_0[j] -
                                   1.5 * fl1_fx * tey_yy_xz_1[j] + ta_yyy_xz_1[j];

                tez_yyyy_xz_0[j] =
                    pa_y[j] * tez_yyy_xz_0[j] - pc_y[j] * tez_yyy_xz_1[j] + 1.5 * fl1_fx * tez_yy_xz_0[j] - 1.5 * fl1_fx * tez_yy_xz_1[j];

                tex_yyyy_yy_0[j] = pa_y[j] * tex_yyy_yy_0[j] - pc_y[j] * tex_yyy_yy_1[j] + 1.5 * fl1_fx * tex_yy_yy_0[j] -
                                   1.5 * fl1_fx * tex_yy_yy_1[j] + fl1_fx * tex_yyy_y_0[j] - fl1_fx * tex_yyy_y_1[j];

                tey_yyyy_yy_0[j] = pa_y[j] * tey_yyy_yy_0[j] - pc_y[j] * tey_yyy_yy_1[j] + 1.5 * fl1_fx * tey_yy_yy_0[j] -
                                   1.5 * fl1_fx * tey_yy_yy_1[j] + fl1_fx * tey_yyy_y_0[j] - fl1_fx * tey_yyy_y_1[j] + ta_yyy_yy_1[j];

                tez_yyyy_yy_0[j] = pa_y[j] * tez_yyy_yy_0[j] - pc_y[j] * tez_yyy_yy_1[j] + 1.5 * fl1_fx * tez_yy_yy_0[j] -
                                   1.5 * fl1_fx * tez_yy_yy_1[j] + fl1_fx * tez_yyy_y_0[j] - fl1_fx * tez_yyy_y_1[j];

                tex_yyyy_yz_0[j] = pa_y[j] * tex_yyy_yz_0[j] - pc_y[j] * tex_yyy_yz_1[j] + 1.5 * fl1_fx * tex_yy_yz_0[j] -
                                   1.5 * fl1_fx * tex_yy_yz_1[j] + 0.5 * fl1_fx * tex_yyy_z_0[j] - 0.5 * fl1_fx * tex_yyy_z_1[j];

                tey_yyyy_yz_0[j] = pa_y[j] * tey_yyy_yz_0[j] - pc_y[j] * tey_yyy_yz_1[j] + 1.5 * fl1_fx * tey_yy_yz_0[j] -
                                   1.5 * fl1_fx * tey_yy_yz_1[j] + 0.5 * fl1_fx * tey_yyy_z_0[j] - 0.5 * fl1_fx * tey_yyy_z_1[j] + ta_yyy_yz_1[j];

                tez_yyyy_yz_0[j] = pa_y[j] * tez_yyy_yz_0[j] - pc_y[j] * tez_yyy_yz_1[j] + 1.5 * fl1_fx * tez_yy_yz_0[j] -
                                   1.5 * fl1_fx * tez_yy_yz_1[j] + 0.5 * fl1_fx * tez_yyy_z_0[j] - 0.5 * fl1_fx * tez_yyy_z_1[j];

                tex_yyyy_zz_0[j] =
                    pa_y[j] * tex_yyy_zz_0[j] - pc_y[j] * tex_yyy_zz_1[j] + 1.5 * fl1_fx * tex_yy_zz_0[j] - 1.5 * fl1_fx * tex_yy_zz_1[j];

                tey_yyyy_zz_0[j] = pa_y[j] * tey_yyy_zz_0[j] - pc_y[j] * tey_yyy_zz_1[j] + 1.5 * fl1_fx * tey_yy_zz_0[j] -
                                   1.5 * fl1_fx * tey_yy_zz_1[j] + ta_yyy_zz_1[j];

                tez_yyyy_zz_0[j] =
                    pa_y[j] * tez_yyy_zz_0[j] - pc_y[j] * tez_yyy_zz_1[j] + 1.5 * fl1_fx * tez_yy_zz_0[j] - 1.5 * fl1_fx * tez_yy_zz_1[j];

                tex_yyyz_xx_0[j] = pa_y[j] * tex_yyz_xx_0[j] - pc_y[j] * tex_yyz_xx_1[j] + fl1_fx * tex_yz_xx_0[j] - fl1_fx * tex_yz_xx_1[j];

                tey_yyyz_xx_0[j] =
                    pa_y[j] * tey_yyz_xx_0[j] - pc_y[j] * tey_yyz_xx_1[j] + fl1_fx * tey_yz_xx_0[j] - fl1_fx * tey_yz_xx_1[j] + ta_yyz_xx_1[j];

                tez_yyyz_xx_0[j] = pa_y[j] * tez_yyz_xx_0[j] - pc_y[j] * tez_yyz_xx_1[j] + fl1_fx * tez_yz_xx_0[j] - fl1_fx * tez_yz_xx_1[j];

                tex_yyyz_xy_0[j] = pa_y[j] * tex_yyz_xy_0[j] - pc_y[j] * tex_yyz_xy_1[j] + fl1_fx * tex_yz_xy_0[j] - fl1_fx * tex_yz_xy_1[j] +
                                   0.5 * fl1_fx * tex_yyz_x_0[j] - 0.5 * fl1_fx * tex_yyz_x_1[j];

                tey_yyyz_xy_0[j] = pa_y[j] * tey_yyz_xy_0[j] - pc_y[j] * tey_yyz_xy_1[j] + fl1_fx * tey_yz_xy_0[j] - fl1_fx * tey_yz_xy_1[j] +
                                   0.5 * fl1_fx * tey_yyz_x_0[j] - 0.5 * fl1_fx * tey_yyz_x_1[j] + ta_yyz_xy_1[j];

                tez_yyyz_xy_0[j] = pa_y[j] * tez_yyz_xy_0[j] - pc_y[j] * tez_yyz_xy_1[j] + fl1_fx * tez_yz_xy_0[j] - fl1_fx * tez_yz_xy_1[j] +
                                   0.5 * fl1_fx * tez_yyz_x_0[j] - 0.5 * fl1_fx * tez_yyz_x_1[j];

                tex_yyyz_xz_0[j] = pa_y[j] * tex_yyz_xz_0[j] - pc_y[j] * tex_yyz_xz_1[j] + fl1_fx * tex_yz_xz_0[j] - fl1_fx * tex_yz_xz_1[j];

                tey_yyyz_xz_0[j] =
                    pa_y[j] * tey_yyz_xz_0[j] - pc_y[j] * tey_yyz_xz_1[j] + fl1_fx * tey_yz_xz_0[j] - fl1_fx * tey_yz_xz_1[j] + ta_yyz_xz_1[j];

                tez_yyyz_xz_0[j] = pa_y[j] * tez_yyz_xz_0[j] - pc_y[j] * tez_yyz_xz_1[j] + fl1_fx * tez_yz_xz_0[j] - fl1_fx * tez_yz_xz_1[j];

                tex_yyyz_yy_0[j] = pa_y[j] * tex_yyz_yy_0[j] - pc_y[j] * tex_yyz_yy_1[j] + fl1_fx * tex_yz_yy_0[j] - fl1_fx * tex_yz_yy_1[j] +
                                   fl1_fx * tex_yyz_y_0[j] - fl1_fx * tex_yyz_y_1[j];

                tey_yyyz_yy_0[j] = pa_y[j] * tey_yyz_yy_0[j] - pc_y[j] * tey_yyz_yy_1[j] + fl1_fx * tey_yz_yy_0[j] - fl1_fx * tey_yz_yy_1[j] +
                                   fl1_fx * tey_yyz_y_0[j] - fl1_fx * tey_yyz_y_1[j] + ta_yyz_yy_1[j];

                tez_yyyz_yy_0[j] = pa_y[j] * tez_yyz_yy_0[j] - pc_y[j] * tez_yyz_yy_1[j] + fl1_fx * tez_yz_yy_0[j] - fl1_fx * tez_yz_yy_1[j] +
                                   fl1_fx * tez_yyz_y_0[j] - fl1_fx * tez_yyz_y_1[j];

                tex_yyyz_yz_0[j] = pa_y[j] * tex_yyz_yz_0[j] - pc_y[j] * tex_yyz_yz_1[j] + fl1_fx * tex_yz_yz_0[j] - fl1_fx * tex_yz_yz_1[j] +
                                   0.5 * fl1_fx * tex_yyz_z_0[j] - 0.5 * fl1_fx * tex_yyz_z_1[j];

                tey_yyyz_yz_0[j] = pa_y[j] * tey_yyz_yz_0[j] - pc_y[j] * tey_yyz_yz_1[j] + fl1_fx * tey_yz_yz_0[j] - fl1_fx * tey_yz_yz_1[j] +
                                   0.5 * fl1_fx * tey_yyz_z_0[j] - 0.5 * fl1_fx * tey_yyz_z_1[j] + ta_yyz_yz_1[j];

                tez_yyyz_yz_0[j] = pa_y[j] * tez_yyz_yz_0[j] - pc_y[j] * tez_yyz_yz_1[j] + fl1_fx * tez_yz_yz_0[j] - fl1_fx * tez_yz_yz_1[j] +
                                   0.5 * fl1_fx * tez_yyz_z_0[j] - 0.5 * fl1_fx * tez_yyz_z_1[j];

                tex_yyyz_zz_0[j] = pa_y[j] * tex_yyz_zz_0[j] - pc_y[j] * tex_yyz_zz_1[j] + fl1_fx * tex_yz_zz_0[j] - fl1_fx * tex_yz_zz_1[j];

                tey_yyyz_zz_0[j] =
                    pa_y[j] * tey_yyz_zz_0[j] - pc_y[j] * tey_yyz_zz_1[j] + fl1_fx * tey_yz_zz_0[j] - fl1_fx * tey_yz_zz_1[j] + ta_yyz_zz_1[j];

                tez_yyyz_zz_0[j] = pa_y[j] * tez_yyz_zz_0[j] - pc_y[j] * tez_yyz_zz_1[j] + fl1_fx * tez_yz_zz_0[j] - fl1_fx * tez_yz_zz_1[j];

                tex_yyzz_xx_0[j] =
                    pa_y[j] * tex_yzz_xx_0[j] - pc_y[j] * tex_yzz_xx_1[j] + 0.5 * fl1_fx * tex_zz_xx_0[j] - 0.5 * fl1_fx * tex_zz_xx_1[j];

                tey_yyzz_xx_0[j] = pa_y[j] * tey_yzz_xx_0[j] - pc_y[j] * tey_yzz_xx_1[j] + 0.5 * fl1_fx * tey_zz_xx_0[j] -
                                   0.5 * fl1_fx * tey_zz_xx_1[j] + ta_yzz_xx_1[j];

                tez_yyzz_xx_0[j] =
                    pa_y[j] * tez_yzz_xx_0[j] - pc_y[j] * tez_yzz_xx_1[j] + 0.5 * fl1_fx * tez_zz_xx_0[j] - 0.5 * fl1_fx * tez_zz_xx_1[j];

                tex_yyzz_xy_0[j] = pa_y[j] * tex_yzz_xy_0[j] - pc_y[j] * tex_yzz_xy_1[j] + 0.5 * fl1_fx * tex_zz_xy_0[j] -
                                   0.5 * fl1_fx * tex_zz_xy_1[j] + 0.5 * fl1_fx * tex_yzz_x_0[j] - 0.5 * fl1_fx * tex_yzz_x_1[j];

                tey_yyzz_xy_0[j] = pa_y[j] * tey_yzz_xy_0[j] - pc_y[j] * tey_yzz_xy_1[j] + 0.5 * fl1_fx * tey_zz_xy_0[j] -
                                   0.5 * fl1_fx * tey_zz_xy_1[j] + 0.5 * fl1_fx * tey_yzz_x_0[j] - 0.5 * fl1_fx * tey_yzz_x_1[j] + ta_yzz_xy_1[j];

                tez_yyzz_xy_0[j] = pa_y[j] * tez_yzz_xy_0[j] - pc_y[j] * tez_yzz_xy_1[j] + 0.5 * fl1_fx * tez_zz_xy_0[j] -
                                   0.5 * fl1_fx * tez_zz_xy_1[j] + 0.5 * fl1_fx * tez_yzz_x_0[j] - 0.5 * fl1_fx * tez_yzz_x_1[j];

                tex_yyzz_xz_0[j] =
                    pa_y[j] * tex_yzz_xz_0[j] - pc_y[j] * tex_yzz_xz_1[j] + 0.5 * fl1_fx * tex_zz_xz_0[j] - 0.5 * fl1_fx * tex_zz_xz_1[j];

                tey_yyzz_xz_0[j] = pa_y[j] * tey_yzz_xz_0[j] - pc_y[j] * tey_yzz_xz_1[j] + 0.5 * fl1_fx * tey_zz_xz_0[j] -
                                   0.5 * fl1_fx * tey_zz_xz_1[j] + ta_yzz_xz_1[j];

                tez_yyzz_xz_0[j] =
                    pa_y[j] * tez_yzz_xz_0[j] - pc_y[j] * tez_yzz_xz_1[j] + 0.5 * fl1_fx * tez_zz_xz_0[j] - 0.5 * fl1_fx * tez_zz_xz_1[j];
            }
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tex_yyzz_yy_0[j] = pa_y[j] * tex_yzz_yy_0[j] - pc_y[j] * tex_yzz_yy_1[j] + 0.5 * fl1_fx * tex_zz_yy_0[j] -
                                   0.5 * fl1_fx * tex_zz_yy_1[j] + fl1_fx * tex_yzz_y_0[j] - fl1_fx * tex_yzz_y_1[j];

                tey_yyzz_yy_0[j] = pa_y[j] * tey_yzz_yy_0[j] - pc_y[j] * tey_yzz_yy_1[j] + 0.5 * fl1_fx * tey_zz_yy_0[j] -
                                   0.5 * fl1_fx * tey_zz_yy_1[j] + fl1_fx * tey_yzz_y_0[j] - fl1_fx * tey_yzz_y_1[j] + ta_yzz_yy_1[j];

                tez_yyzz_yy_0[j] = pa_y[j] * tez_yzz_yy_0[j] - pc_y[j] * tez_yzz_yy_1[j] + 0.5 * fl1_fx * tez_zz_yy_0[j] -
                                   0.5 * fl1_fx * tez_zz_yy_1[j] + fl1_fx * tez_yzz_y_0[j] - fl1_fx * tez_yzz_y_1[j];

                tex_yyzz_yz_0[j] = pa_y[j] * tex_yzz_yz_0[j] - pc_y[j] * tex_yzz_yz_1[j] + 0.5 * fl1_fx * tex_zz_yz_0[j] -
                                   0.5 * fl1_fx * tex_zz_yz_1[j] + 0.5 * fl1_fx * tex_yzz_z_0[j] - 0.5 * fl1_fx * tex_yzz_z_1[j];

                tey_yyzz_yz_0[j] = pa_y[j] * tey_yzz_yz_0[j] - pc_y[j] * tey_yzz_yz_1[j] + 0.5 * fl1_fx * tey_zz_yz_0[j] -
                                   0.5 * fl1_fx * tey_zz_yz_1[j] + 0.5 * fl1_fx * tey_yzz_z_0[j] - 0.5 * fl1_fx * tey_yzz_z_1[j] + ta_yzz_yz_1[j];

                tez_yyzz_yz_0[j] = pa_y[j] * tez_yzz_yz_0[j] - pc_y[j] * tez_yzz_yz_1[j] + 0.5 * fl1_fx * tez_zz_yz_0[j] -
                                   0.5 * fl1_fx * tez_zz_yz_1[j] + 0.5 * fl1_fx * tez_yzz_z_0[j] - 0.5 * fl1_fx * tez_yzz_z_1[j];

                tex_yyzz_zz_0[j] =
                    pa_y[j] * tex_yzz_zz_0[j] - pc_y[j] * tex_yzz_zz_1[j] + 0.5 * fl1_fx * tex_zz_zz_0[j] - 0.5 * fl1_fx * tex_zz_zz_1[j];

                tey_yyzz_zz_0[j] = pa_y[j] * tey_yzz_zz_0[j] - pc_y[j] * tey_yzz_zz_1[j] + 0.5 * fl1_fx * tey_zz_zz_0[j] -
                                   0.5 * fl1_fx * tey_zz_zz_1[j] + ta_yzz_zz_1[j];

                tez_yyzz_zz_0[j] =
                    pa_y[j] * tez_yzz_zz_0[j] - pc_y[j] * tez_yzz_zz_1[j] + 0.5 * fl1_fx * tez_zz_zz_0[j] - 0.5 * fl1_fx * tez_zz_zz_1[j];
                ...
                tex_yzzz_xy_0[j] =
                    pa_y[j] * tex_zzz_xy_0[j] - pc_y[j] * tex_zzz_xy_1[j] + 0.5 * fl1_fx * tex_zzz_x_0[j] - 0.5 * fl1_fx * tex_zzz_x_1[j];

                tey_yzzz_xy_0[j] = pa_y[j] * tey_zzz_xy_0[j] - pc_y[j] * tey_zzz_xy_1[j] + 0.5 * fl1_fx * tey_zzz_x_0[j] -
                                   0.5 * fl1_fx * tey_zzz_x_1[j] + ta_zzz_xy_1[j];

                tez_yzzz_xy_0[j] =
                    pa_y[j] * tez_zzz_xy_0[j] - pc_y[j] * tez_zzz_xy_1[j] + 0.5 * fl1_fx * tez_zzz_x_0[j] - 0.5 * fl1_fx * tez_zzz_x_1[j];
                ...
                tey_yzzz_yy_0[j] =
                    pa_y[j] * tey_zzz_yy_0[j] - pc_y[j] * tey_zzz_yy_1[j] + fl1_fx * tey_zzz_y_0[j] - fl1_fx * tey_zzz_y_1[j] + ta_zzz_yy_1[j];

                tez_yzzz_yy_0[j] = pa_y[j] * tez_zzz_yy_0[j] - pc_y[j] * tez_zzz_yy_1[j] + fl1_fx * tez_zzz_y_0[j] - fl1_fx * tez_zzz_y_1[j];

                tex_yzzz_yz_0[j] =
                    pa_y[j] * tex_zzz_yz_0[j] - pc_y[j] * tex_zzz_yz_1[j] + 0.5 * fl1_fx * tex_zzz_z_0[j] - 0.5 * fl1_fx * tex_zzz_z_1[j];

                tey_yzzz_yz_0[j] = pa_y[j] * tey_zzz_yz_0[j] - pc_y[j] * tey_zzz_yz_1[j] + 0.5 * fl1_fx * tey_zzz_z_0[j] -
                                   0.5 * fl1_fx * tey_zzz_z_1[j] + ta_zzz_yz_1[j];

                tez_yzzz_yz_0[j] =
                    pa_y[j] * tez_zzz_yz_0[j] - pc_y[j] * tez_zzz_yz_1[j] + 0.5 * fl1_fx * tez_zzz_z_0[j] - 0.5 * fl1_fx * tez_zzz_z_1[j];
                ...
                tex_zzzz_xx_0[j] =
                    pa_z[j] * tex_zzz_xx_0[j] - pc_z[j] * tex_zzz_xx_1[j] + 1.5 * fl1_fx * tex_zz_xx_0[j] - 1.5 * fl1_fx * tex_zz_xx_1[j];

                tey_zzzz_xx_0[j] =
                    pa_z[j] * tey_zzz_xx_0[j] - pc_z[j] * tey_zzz_xx_1[j] + 1.5 * fl1_fx * tey_zz_xx_0[j] - 1.5 * fl1_fx * tey_zz_xx_1[j];

                tez_zzzz_xx_0[j] = pa_z[j] * tez_zzz_xx_0[j] - pc_z[j] * tez_zzz_xx_1[j] + 1.5 * fl1_fx * tez_zz_xx_0[j] -
                                   1.5 * fl1_fx * tez_zz_xx_1[j] + ta_zzz_xx_1[j];

                tex_zzzz_xy_0[j] =
                    pa_z[j] * tex_zzz_xy_0[j] - pc_z[j] * tex_zzz_xy_1[j] + 1.5 * fl1_fx * tex_zz_xy_0[j] - 1.5 * fl1_fx * tex_zz_xy_1[j];

                tey_zzzz_xy_0[j] =
                    pa_z[j] * tey_zzz_xy_0[j] - pc_z[j] * tey_zzz_xy_1[j] + 1.5 * fl1_fx * tey_zz_xy_0[j] - 1.5 * fl1_fx * tey_zz_xy_1[j];

                tez_zzzz_xy_0[j] = pa_z[j] * tez_zzz_xy_0[j] - pc_z[j] * tez_zzz_xy_1[j] + 1.5 * fl1_fx * tez_zz_xy_0[j] -
                                   1.5 * fl1_fx * tez_zz_xy_1[j] + ta_zzz_xy_1[j];

                tex_zzzz_xz_0[j] = pa_z[j] * tex_zzz_xz_0[j] - pc_z[j] * tex_zzz_xz_1[j] + 1.5 * fl1_fx * tex_zz_xz_0[j] -
                                   1.5 * fl1_fx * tex_zz_xz_1[j] + 0.5 * fl1_fx * tex_zzz_x_0[j] - 0.5 * fl1_fx * tex_zzz_x_1[j];

                tey_zzzz_xz_0[j] = pa_z[j] * tey_zzz_xz_0[j] - pc_z[j] * tey_zzz_xz_1[j] + 1.5 * fl1_fx * tey_zz_xz_0[j] -
                                   1.5 * fl1_fx * tey_zz_xz_1[j] + 0.5 * fl1_fx * tey_zzz_x_0[j] - 0.5 * fl1_fx * tey_zzz_x_1[j];

                tez_zzzz_xz_0[j] = pa_z[j] * tez_zzz_xz_0[j] - pc_z[j] * tez_zzz_xz_1[j] + 1.5 * fl1_fx * tez_zz_xz_0[j] -
                                   1.5 * fl1_fx * tez_zz_xz_1[j] + 0.5 * fl1_fx * tez_zzz_x_0[j] - 0.5 * fl1_fx * tez_zzz_x_1[j] + ta_zzz_xz_1[j];

                tex_zzzz_yy_0[j] =
                    pa_z[j] * tex_zzz_yy_0[j] - pc_z[j] * tex_zzz_yy_1[j] + 1.5 * fl1_fx * tex_zz_yy_0[j] - 1.5 * fl1_fx * tex_zz_yy_1[j];

                tey_zzzz_yy_0[j] =
                    pa_z[j] * tey_zzz_yy_0[j] - pc_z[j] * tey_zzz_yy_1[j] + 1.5 * fl1_fx * tey_zz_yy_0[j] - 1.5 * fl1_fx * tey_zz_yy_1[j];

                tez_zzzz_yy_0[j] = pa_z[j] * tez_zzz_yy_0[j] - pc_z[j] * tez_zzz_yy_1[j] + 1.5 * fl1_fx * tez_zz_yy_0[j] -
                                   1.5 * fl1_fx * tez_zz_yy_1[j] + ta_zzz_yy_1[j];

                tex_zzzz_yz_0[j] = pa_z[j] * tex_zzz_yz_0[j] - pc_z[j] * tex_zzz_yz_1[j] + 1.5 * fl1_fx * tex_zz_yz_0[j] -
                                   1.5 * fl1_fx * tex_zz_yz_1[j] + 0.5 * fl1_fx * tex_zzz_y_0[j] - 0.5 * fl1_fx * tex_zzz_y_1[j];

                tey_zzzz_yz_0[j] = pa_z[j] * tey_zzz_yz_0[j] - pc_z[j] * tey_zzz_yz_1[j] + 1.5 * fl1_fx * tey_zz_yz_0[j] -
                                   1.5 * fl1_fx * tey_zz_yz_1[j] + 0.5 * fl1_fx * tey_zzz_y_0[j] - 0.5 * fl1_fx * tey_zzz_y_1[j];

                tez_zzzz_yz_0[j] = pa_z[j] * tez_zzz_yz_0[j] - pc_z[j] * tez_zzz_yz_1[j] + 1.5 * fl1_fx * tez_zz_yz_0[j] -
                                   1.5 * fl1_fx * tez_zz_yz_1[j] + 0.5 * fl1_fx * tez_zzz_y_0[j] - 0.5 * fl1_fx * tez_zzz_y_1[j] + ta_zzz_yz_1[j];

                tex_zzzz_zz_0[j] = pa_z[j] * tex_zzz_zz_0[j] - pc_z[j] * tex_zzz_zz_1[j] + 1.5 * fl1_fx * tex_zz_zz_0[j] -
                                   1.5 * fl1_fx * tex_zz_zz_1[j] + fl1_fx * tex_zzz_z_0[j] - fl1_fx * tex_zzz_z_1[j];

                tey_zzzz_zz_0[j] = pa_z[j] * tey_zzz_zz_0[j] - pc_z[j] * tey_zzz_zz_1[j] + 1.5 * fl1_fx * tey_zz_zz_0[j] -
                                   1.5 * fl1_fx * tey_zz_zz_1[j] + fl1_fx * tey_zzz_z_0[j] - fl1_fx * tey_zzz_z_1[j];

                tez_zzzz_zz_0[j] = pa_z[j] * tez_zzz_zz_0[j] - pc_z[j] * tez_zzz_zz_1[j] + 1.5 * fl1_fx * tez_zz_zz_0[j] -
                                   1.5 * fl1_fx * tez_zz_zz_1[j] + fl1_fx * tez_zzz_z_0[j] - fl1_fx * tez_zzz_z_1[j] + ta_zzz_zz_1[j];
            }
