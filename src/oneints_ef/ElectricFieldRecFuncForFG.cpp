...
{
    efieldrecfunc::compElectricFieldForFG_0_50(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    efieldrecfunc::compElectricFieldForFG_50_100(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    efieldrecfunc::compElectricFieldForFG_100_150(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    efieldrecfunc::compElectricFieldForFG_150_200(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    efieldrecfunc::compElectricFieldForFG_200_250(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    efieldrecfunc::compElectricFieldForFG_250_300(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    efieldrecfunc::compElectricFieldForFG_300_350(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    efieldrecfunc::compElectricFieldForFG_350_400(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);

    efieldrecfunc::compElectricFieldForFG_400_450(primBuffer, recursionMap, osFactors, paDistances, pcDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
                            ...
                            const int32_t              iContrGto)
{
    ...
    auto mord = recursionMap.getMaxOrder({"Electric Field"}, {3, -1, -1, -1}, {4, -1, -1, -1}, 1, 1);
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tex_xxx_xxxx_0[j] = pa_x[j] * tex_xx_xxxx_0[j] - pc_x[j] * tex_xx_xxxx_1[j] + fl1_fx * tex_x_xxxx_0[j] - fl1_fx * tex_x_xxxx_1[j] +
                                    2.0 * fl1_fx * tex_xx_xxx_0[j] - 2.0 * fl1_fx * tex_xx_xxx_1[j] + ta_xx_xxxx_1[j];

                tey_xxx_xxxx_0[j] = pa_x[j] * tey_xx_xxxx_0[j] - pc_x[j] * tey_xx_xxxx_1[j] + fl1_fx * tey_x_xxxx_0[j] - fl1_fx * tey_x_xxxx_1[j] +
                                    2.0 * fl1_fx * tey_xx_xxx_0[j] - 2.0 * fl1_fx * tey_xx_xxx_1[j];

                tez_xxx_xxxx_0[j] = pa_x[j] * tez_xx_xxxx_0[j] - pc_x[j] * tez_xx_xxxx_1[j] + fl1_fx * tez_x_xxxx_0[j] - fl1_fx * tez_x_xxxx_1[j] +
                                    2.0 * fl1_fx * tez_xx_xxx_0[j] - 2.0 * fl1_fx * tez_xx_xxx_1[j];

                tex_xxx_xxxy_0[j] = pa_x[j] * tex_xx_xxxy_0[j] - pc_x[j] * tex_xx_xxxy_1[j] + fl1_fx * tex_x_xxxy_0[j] - fl1_fx * tex_x_xxxy_1[j] +
                                    1.5 * fl1_fx * tex_xx_xxy_0[j] - 1.5 * fl1_fx * tex_xx_xxy_1[j] + ta_xx_xxxy_1[j];

                tey_xxx_xxxy_0[j] = pa_x[j] * tey_xx_xxxy_0[j] - pc_x[j] * tey_xx_xxxy_1[j] + fl1_fx * tey_x_xxxy_0[j] - fl1_fx * tey_x_xxxy_1[j] +
                                    1.5 * fl1_fx * tey_xx_xxy_0[j] - 1.5 * fl1_fx * tey_xx_xxy_1[j];

                tez_xxx_xxxy_0[j] = pa_x[j] * tez_xx_xxxy_0[j] - pc_x[j] * tez_xx_xxxy_1[j] + fl1_fx * tez_x_xxxy_0[j] - fl1_fx * tez_x_xxxy_1[j] +
                                    1.5 * fl1_fx * tez_xx_xxy_0[j] - 1.5 * fl1_fx * tez_xx_xxy_1[j];

                tex_xxx_xxxz_0[j] = pa_x[j] * tex_xx_xxxz_0[j] - pc_x[j] * tex_xx_xxxz_1[j] + fl1_fx * tex_x_xxxz_0[j] - fl1_fx * tex_x_xxxz_1[j] +
                                    1.5 * fl1_fx * tex_xx_xxz_0[j] - 1.5 * fl1_fx * tex_xx_xxz_1[j] + ta_xx_xxxz_1[j];

                tey_xxx_xxxz_0[j] = pa_x[j] * tey_xx_xxxz_0[j] - pc_x[j] * tey_xx_xxxz_1[j] + fl1_fx * tey_x_xxxz_0[j] - fl1_fx * tey_x_xxxz_1[j] +
                                    1.5 * fl1_fx * tey_xx_xxz_0[j] - 1.5 * fl1_fx * tey_xx_xxz_1[j];

                tez_xxx_xxxz_0[j] = pa_x[j] * tez_xx_xxxz_0[j] - pc_x[j] * tez_xx_xxxz_1[j] + fl1_fx * tez_x_xxxz_0[j] - fl1_fx * tez_x_xxxz_1[j] +
                                    1.5 * fl1_fx * tez_xx_xxz_0[j] - 1.5 * fl1_fx * tez_xx_xxz_1[j];

                tex_xxx_xxyy_0[j] = pa_x[j] * tex_xx_xxyy_0[j] - pc_x[j] * tex_xx_xxyy_1[j] + fl1_fx * tex_x_xxyy_0[j] - fl1_fx * tex_x_xxyy_1[j] +
                                    fl1_fx * tex_xx_xyy_0[j] - fl1_fx * tex_xx_xyy_1[j] + ta_xx_xxyy_1[j];

                tey_xxx_xxyy_0[j] = pa_x[j] * tey_xx_xxyy_0[j] - pc_x[j] * tey_xx_xxyy_1[j] + fl1_fx * tey_x_xxyy_0[j] - fl1_fx * tey_x_xxyy_1[j] +
                                    fl1_fx * tey_xx_xyy_0[j] - fl1_fx * tey_xx_xyy_1[j];

                tez_xxx_xxyy_0[j] = pa_x[j] * tez_xx_xxyy_0[j] - pc_x[j] * tez_xx_xxyy_1[j] + fl1_fx * tez_x_xxyy_0[j] - fl1_fx * tez_x_xxyy_1[j] +
                                    fl1_fx * tez_xx_xyy_0[j] - fl1_fx * tez_xx_xyy_1[j];

                tex_xxx_xxyz_0[j] = pa_x[j] * tex_xx_xxyz_0[j] - pc_x[j] * tex_xx_xxyz_1[j] + fl1_fx * tex_x_xxyz_0[j] - fl1_fx * tex_x_xxyz_1[j] +
                                    fl1_fx * tex_xx_xyz_0[j] - fl1_fx * tex_xx_xyz_1[j] + ta_xx_xxyz_1[j];

                tey_xxx_xxyz_0[j] = pa_x[j] * tey_xx_xxyz_0[j] - pc_x[j] * tey_xx_xxyz_1[j] + fl1_fx * tey_x_xxyz_0[j] - fl1_fx * tey_x_xxyz_1[j] +
                                    fl1_fx * tey_xx_xyz_0[j] - fl1_fx * tey_xx_xyz_1[j];

                tez_xxx_xxyz_0[j] = pa_x[j] * tez_xx_xxyz_0[j] - pc_x[j] * tez_xx_xxyz_1[j] + fl1_fx * tez_x_xxyz_0[j] - fl1_fx * tez_x_xxyz_1[j] +
                                    fl1_fx * tez_xx_xyz_0[j] - fl1_fx * tez_xx_xyz_1[j];

                tex_xxx_xxzz_0[j] = pa_x[j] * tex_xx_xxzz_0[j] - pc_x[j] * tex_xx_xxzz_1[j] + fl1_fx * tex_x_xxzz_0[j] - fl1_fx * tex_x_xxzz_1[j] +
                                    fl1_fx * tex_xx_xzz_0[j] - fl1_fx * tex_xx_xzz_1[j] + ta_xx_xxzz_1[j];

                tey_xxx_xxzz_0[j] = pa_x[j] * tey_xx_xxzz_0[j] - pc_x[j] * tey_xx_xxzz_1[j] + fl1_fx * tey_x_xxzz_0[j] - fl1_fx * tey_x_xxzz_1[j] +
                                    fl1_fx * tey_xx_xzz_0[j] - fl1_fx * tey_xx_xzz_1[j];

                tez_xxx_xxzz_0[j] = pa_x[j] * tez_xx_xxzz_0[j] - pc_x[j] * tez_xx_xxzz_1[j] + fl1_fx * tez_x_xxzz_0[j] - fl1_fx * tez_x_xxzz_1[j] +
                                    fl1_fx * tez_xx_xzz_0[j] - fl1_fx * tez_xx_xzz_1[j];

                tex_xxx_xyyy_0[j] = pa_x[j] * tex_xx_xyyy_0[j] - pc_x[j] * tex_xx_xyyy_1[j] + fl1_fx * tex_x_xyyy_0[j] - fl1_fx * tex_x_xyyy_1[j] +
                                    0.5 * fl1_fx * tex_xx_yyy_0[j] - 0.5 * fl1_fx * tex_xx_yyy_1[j] + ta_xx_xyyy_1[j];

                tey_xxx_xyyy_0[j] = pa_x[j] * tey_xx_xyyy_0[j] - pc_x[j] * tey_xx_xyyy_1[j] + fl1_fx * tey_x_xyyy_0[j] - fl1_fx * tey_x_xyyy_1[j] +
                                    0.5 * fl1_fx * tey_xx_yyy_0[j] - 0.5 * fl1_fx * tey_xx_yyy_1[j];

                tez_xxx_xyyy_0[j] = pa_x[j] * tez_xx_xyyy_0[j] - pc_x[j] * tez_xx_xyyy_1[j] + fl1_fx * tez_x_xyyy_0[j] - fl1_fx * tez_x_xyyy_1[j] +
                                    0.5 * fl1_fx * tez_xx_yyy_0[j] - 0.5 * fl1_fx * tez_xx_yyy_1[j];

                tex_xxx_xyyz_0[j] = pa_x[j] * tex_xx_xyyz_0[j] - pc_x[j] * tex_xx_xyyz_1[j] + fl1_fx * tex_x_xyyz_0[j] - fl1_fx * tex_x_xyyz_1[j] +
                                    0.5 * fl1_fx * tex_xx_yyz_0[j] - 0.5 * fl1_fx * tex_xx_yyz_1[j] + ta_xx_xyyz_1[j];

                tey_xxx_xyyz_0[j] = pa_x[j] * tey_xx_xyyz_0[j] - pc_x[j] * tey_xx_xyyz_1[j] + fl1_fx * tey_x_xyyz_0[j] - fl1_fx * tey_x_xyyz_1[j] +
                                    0.5 * fl1_fx * tey_xx_yyz_0[j] - 0.5 * fl1_fx * tey_xx_yyz_1[j];

                tez_xxx_xyyz_0[j] = pa_x[j] * tez_xx_xyyz_0[j] - pc_x[j] * tez_xx_xyyz_1[j] + fl1_fx * tez_x_xyyz_0[j] - fl1_fx * tez_x_xyyz_1[j] +
                                    0.5 * fl1_fx * tez_xx_yyz_0[j] - 0.5 * fl1_fx * tez_xx_yyz_1[j];

                tex_xxx_xyzz_0[j] = pa_x[j] * tex_xx_xyzz_0[j] - pc_x[j] * tex_xx_xyzz_1[j] + fl1_fx * tex_x_xyzz_0[j] - fl1_fx * tex_x_xyzz_1[j] +
                                    0.5 * fl1_fx * tex_xx_yzz_0[j] - 0.5 * fl1_fx * tex_xx_yzz_1[j] + ta_xx_xyzz_1[j];

                tey_xxx_xyzz_0[j] = pa_x[j] * tey_xx_xyzz_0[j] - pc_x[j] * tey_xx_xyzz_1[j] + fl1_fx * tey_x_xyzz_0[j] - fl1_fx * tey_x_xyzz_1[j] +
                                    0.5 * fl1_fx * tey_xx_yzz_0[j] - 0.5 * fl1_fx * tey_xx_yzz_1[j];

                tez_xxx_xyzz_0[j] = pa_x[j] * tez_xx_xyzz_0[j] - pc_x[j] * tez_xx_xyzz_1[j] + fl1_fx * tez_x_xyzz_0[j] - fl1_fx * tez_x_xyzz_1[j] +
                                    0.5 * fl1_fx * tez_xx_yzz_0[j] - 0.5 * fl1_fx * tez_xx_yzz_1[j];

                tex_xxx_xzzz_0[j] = pa_x[j] * tex_xx_xzzz_0[j] - pc_x[j] * tex_xx_xzzz_1[j] + fl1_fx * tex_x_xzzz_0[j] - fl1_fx * tex_x_xzzz_1[j] +
                                    0.5 * fl1_fx * tex_xx_zzz_0[j] - 0.5 * fl1_fx * tex_xx_zzz_1[j] + ta_xx_xzzz_1[j];

                tey_xxx_xzzz_0[j] = pa_x[j] * tey_xx_xzzz_0[j] - pc_x[j] * tey_xx_xzzz_1[j] + fl1_fx * tey_x_xzzz_0[j] - fl1_fx * tey_x_xzzz_1[j] +
                                    0.5 * fl1_fx * tey_xx_zzz_0[j] - 0.5 * fl1_fx * tey_xx_zzz_1[j];

                tez_xxx_xzzz_0[j] = pa_x[j] * tez_xx_xzzz_0[j] - pc_x[j] * tez_xx_xzzz_1[j] + fl1_fx * tez_x_xzzz_0[j] - fl1_fx * tez_x_xzzz_1[j] +
                                    0.5 * fl1_fx * tez_xx_zzz_0[j] - 0.5 * fl1_fx * tez_xx_zzz_1[j];

                tex_xxx_yyyy_0[j] =
                    pa_x[j] * tex_xx_yyyy_0[j] - pc_x[j] * tex_xx_yyyy_1[j] + fl1_fx * tex_x_yyyy_0[j] - fl1_fx * tex_x_yyyy_1[j] + ta_xx_yyyy_1[j];
                ...
                tex_xxx_yyyz_0[j] =
                    pa_x[j] * tex_xx_yyyz_0[j] - pc_x[j] * tex_xx_yyyz_1[j] + fl1_fx * tex_x_yyyz_0[j] - fl1_fx * tex_x_yyyz_1[j] + ta_xx_yyyz_1[j];
                ...
                tex_xxx_yyzz_0[j] =
                    pa_x[j] * tex_xx_yyzz_0[j] - pc_x[j] * tex_xx_yyzz_1[j] + fl1_fx * tex_x_yyzz_0[j] - fl1_fx * tex_x_yyzz_1[j] + ta_xx_yyzz_1[j];
                ...
                tex_xxx_yzzz_0[j] =
                    pa_x[j] * tex_xx_yzzz_0[j] - pc_x[j] * tex_xx_yzzz_1[j] + fl1_fx * tex_x_yzzz_0[j] - fl1_fx * tex_x_yzzz_1[j] + ta_xx_yzzz_1[j];
                ...
                tex_xxx_zzzz_0[j] =
                    pa_x[j] * tex_xx_zzzz_0[j] - pc_x[j] * tex_xx_zzzz_1[j] + fl1_fx * tex_x_zzzz_0[j] - fl1_fx * tex_x_zzzz_1[j] + ta_xx_zzzz_1[j];
                ...
                tex_xxy_xxxx_0[j] = pa_x[j] * tex_xy_xxxx_0[j] - pc_x[j] * tex_xy_xxxx_1[j] + 0.5 * fl1_fx * tex_y_xxxx_0[j] -
                                    0.5 * fl1_fx * tex_y_xxxx_1[j] + 2.0 * fl1_fx * tex_xy_xxx_0[j] - 2.0 * fl1_fx * tex_xy_xxx_1[j] +
                                    ta_xy_xxxx_1[j];

                tey_xxy_xxxx_0[j] = pa_x[j] * tey_xy_xxxx_0[j] - pc_x[j] * tey_xy_xxxx_1[j] + 0.5 * fl1_fx * tey_y_xxxx_0[j] -
                                    0.5 * fl1_fx * tey_y_xxxx_1[j] + 2.0 * fl1_fx * tey_xy_xxx_0[j] - 2.0 * fl1_fx * tey_xy_xxx_1[j];

                tez_xxy_xxxx_0[j] = pa_x[j] * tez_xy_xxxx_0[j] - pc_x[j] * tez_xy_xxxx_1[j] + 0.5 * fl1_fx * tez_y_xxxx_0[j] -
                                    0.5 * fl1_fx * tez_y_xxxx_1[j] + 2.0 * fl1_fx * tez_xy_xxx_0[j] - 2.0 * fl1_fx * tez_xy_xxx_1[j];

                tex_xxy_xxxy_0[j] = pa_x[j] * tex_xy_xxxy_0[j] - pc_x[j] * tex_xy_xxxy_1[j] + 0.5 * fl1_fx * tex_y_xxxy_0[j] -
                                    0.5 * fl1_fx * tex_y_xxxy_1[j] + 1.5 * fl1_fx * tex_xy_xxy_0[j] - 1.5 * fl1_fx * tex_xy_xxy_1[j] +
                                    ta_xy_xxxy_1[j];

                tey_xxy_xxxy_0[j] = pa_x[j] * tey_xy_xxxy_0[j] - pc_x[j] * tey_xy_xxxy_1[j] + 0.5 * fl1_fx * tey_y_xxxy_0[j] -
                                    0.5 * fl1_fx * tey_y_xxxy_1[j] + 1.5 * fl1_fx * tey_xy_xxy_0[j] - 1.5 * fl1_fx * tey_xy_xxy_1[j];
            }
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tez_xxy_xxxy_0[j] = pa_x[j] * tez_xy_xxxy_0[j] - pc_x[j] * tez_xy_xxxy_1[j] + 0.5 * fl1_fx * tez_y_xxxy_0[j] -
                                    0.5 * fl1_fx * tez_y_xxxy_1[j] + 1.5 * fl1_fx * tez_xy_xxy_0[j] - 1.5 * fl1_fx * tez_xy_xxy_1[j];

                tex_xxy_xxxz_0[j] = pa_x[j] * tex_xy_xxxz_0[j] - pc_x[j] * tex_xy_xxxz_1[j] + 0.5 * fl1_fx * tex_y_xxxz_0[j] -
                                    0.5 * fl1_fx * tex_y_xxxz_1[j] + 1.5 * fl1_fx * tex_xy_xxz_0[j] - 1.5 * fl1_fx * tex_xy_xxz_1[j] +
                                    ta_xy_xxxz_1[j];

                tey_xxy_xxxz_0[j] = pa_x[j] * tey_xy_xxxz_0[j] - pc_x[j] * tey_xy_xxxz_1[j] + 0.5 * fl1_fx * tey_y_xxxz_0[j] -
                                    0.5 * fl1_fx * tey_y_xxxz_1[j] + 1.5 * fl1_fx * tey_xy_xxz_0[j] - 1.5 * fl1_fx * tey_xy_xxz_1[j];

                tez_xxy_xxxz_0[j] = pa_x[j] * tez_xy_xxxz_0[j] - pc_x[j] * tez_xy_xxxz_1[j] + 0.5 * fl1_fx * tez_y_xxxz_0[j] -
                                    0.5 * fl1_fx * tez_y_xxxz_1[j] + 1.5 * fl1_fx * tez_xy_xxz_0[j] - 1.5 * fl1_fx * tez_xy_xxz_1[j];

                tex_xxy_xxyy_0[j] = pa_x[j] * tex_xy_xxyy_0[j] - pc_x[j] * tex_xy_xxyy_1[j] + 0.5 * fl1_fx * tex_y_xxyy_0[j] -
                                    0.5 * fl1_fx * tex_y_xxyy_1[j] + fl1_fx * tex_xy_xyy_0[j] - fl1_fx * tex_xy_xyy_1[j] + ta_xy_xxyy_1[j];

                tey_xxy_xxyy_0[j] = pa_x[j] * tey_xy_xxyy_0[j] - pc_x[j] * tey_xy_xxyy_1[j] + 0.5 * fl1_fx * tey_y_xxyy_0[j] -
                                    0.5 * fl1_fx * tey_y_xxyy_1[j] + fl1_fx * tey_xy_xyy_0[j] - fl1_fx * tey_xy_xyy_1[j];

                tez_xxy_xxyy_0[j] = pa_x[j] * tez_xy_xxyy_0[j] - pc_x[j] * tez_xy_xxyy_1[j] + 0.5 * fl1_fx * tez_y_xxyy_0[j] -
                                    0.5 * fl1_fx * tez_y_xxyy_1[j] + fl1_fx * tez_xy_xyy_0[j] - fl1_fx * tez_xy_xyy_1[j];

                tex_xxy_xxyz_0[j] = pa_x[j] * tex_xy_xxyz_0[j] - pc_x[j] * tex_xy_xxyz_1[j] + 0.5 * fl1_fx * tex_y_xxyz_0[j] -
                                    0.5 * fl1_fx * tex_y_xxyz_1[j] + fl1_fx * tex_xy_xyz_0[j] - fl1_fx * tex_xy_xyz_1[j] + ta_xy_xxyz_1[j];

                tey_xxy_xxyz_0[j] = pa_x[j] * tey_xy_xxyz_0[j] - pc_x[j] * tey_xy_xxyz_1[j] + 0.5 * fl1_fx * tey_y_xxyz_0[j] -
                                    0.5 * fl1_fx * tey_y_xxyz_1[j] + fl1_fx * tey_xy_xyz_0[j] - fl1_fx * tey_xy_xyz_1[j];

                tez_xxy_xxyz_0[j] = pa_x[j] * tez_xy_xxyz_0[j] - pc_x[j] * tez_xy_xxyz_1[j] + 0.5 * fl1_fx * tez_y_xxyz_0[j] -
                                    0.5 * fl1_fx * tez_y_xxyz_1[j] + fl1_fx * tez_xy_xyz_0[j] - fl1_fx * tez_xy_xyz_1[j];

                tex_xxy_xxzz_0[j] = pa_x[j] * tex_xy_xxzz_0[j] - pc_x[j] * tex_xy_xxzz_1[j] + 0.5 * fl1_fx * tex_y_xxzz_0[j] -
                                    0.5 * fl1_fx * tex_y_xxzz_1[j] + fl1_fx * tex_xy_xzz_0[j] - fl1_fx * tex_xy_xzz_1[j] + ta_xy_xxzz_1[j];

                tey_xxy_xxzz_0[j] = pa_x[j] * tey_xy_xxzz_0[j] - pc_x[j] * tey_xy_xxzz_1[j] + 0.5 * fl1_fx * tey_y_xxzz_0[j] -
                                    0.5 * fl1_fx * tey_y_xxzz_1[j] + fl1_fx * tey_xy_xzz_0[j] - fl1_fx * tey_xy_xzz_1[j];

                tez_xxy_xxzz_0[j] = pa_x[j] * tez_xy_xxzz_0[j] - pc_x[j] * tez_xy_xxzz_1[j] + 0.5 * fl1_fx * tez_y_xxzz_0[j] -
                                    0.5 * fl1_fx * tez_y_xxzz_1[j] + fl1_fx * tez_xy_xzz_0[j] - fl1_fx * tez_xy_xzz_1[j];

                tex_xxy_xyyy_0[j] = pa_x[j] * tex_xy_xyyy_0[j] - pc_x[j] * tex_xy_xyyy_1[j] + 0.5 * fl1_fx * tex_y_xyyy_0[j] -
                                    0.5 * fl1_fx * tex_y_xyyy_1[j] + 0.5 * fl1_fx * tex_xy_yyy_0[j] - 0.5 * fl1_fx * tex_xy_yyy_1[j] +
                                    ta_xy_xyyy_1[j];

                tey_xxy_xyyy_0[j] = pa_x[j] * tey_xy_xyyy_0[j] - pc_x[j] * tey_xy_xyyy_1[j] + 0.5 * fl1_fx * tey_y_xyyy_0[j] -
                                    0.5 * fl1_fx * tey_y_xyyy_1[j] + 0.5 * fl1_fx * tey_xy_yyy_0[j] - 0.5 * fl1_fx * tey_xy_yyy_1[j];

                tez_xxy_xyyy_0[j] = pa_x[j] * tez_xy_xyyy_0[j] - pc_x[j] * tez_xy_xyyy_1[j] + 0.5 * fl1_fx * tez_y_xyyy_0[j] -
                                    0.5 * fl1_fx * tez_y_xyyy_1[j] + 0.5 * fl1_fx * tez_xy_yyy_0[j] - 0.5 * fl1_fx * tez_xy_yyy_1[j];

                tex_xxy_xyyz_0[j] = pa_x[j] * tex_xy_xyyz_0[j] - pc_x[j] * tex_xy_xyyz_1[j] + 0.5 * fl1_fx * tex_y_xyyz_0[j] -
                                    0.5 * fl1_fx * tex_y_xyyz_1[j] + 0.5 * fl1_fx * tex_xy_yyz_0[j] - 0.5 * fl1_fx * tex_xy_yyz_1[j] +
                                    ta_xy_xyyz_1[j];

                tey_xxy_xyyz_0[j] = pa_x[j] * tey_xy_xyyz_0[j] - pc_x[j] * tey_xy_xyyz_1[j] + 0.5 * fl1_fx * tey_y_xyyz_0[j] -
                                    0.5 * fl1_fx * tey_y_xyyz_1[j] + 0.5 * fl1_fx * tey_xy_yyz_0[j] - 0.5 * fl1_fx * tey_xy_yyz_1[j];

                tez_xxy_xyyz_0[j] = pa_x[j] * tez_xy_xyyz_0[j] - pc_x[j] * tez_xy_xyyz_1[j] + 0.5 * fl1_fx * tez_y_xyyz_0[j] -
                                    0.5 * fl1_fx * tez_y_xyyz_1[j] + 0.5 * fl1_fx * tez_xy_yyz_0[j] - 0.5 * fl1_fx * tez_xy_yyz_1[j];

                tex_xxy_xyzz_0[j] = pa_x[j] * tex_xy_xyzz_0[j] - pc_x[j] * tex_xy_xyzz_1[j] + 0.5 * fl1_fx * tex_y_xyzz_0[j] -
                                    0.5 * fl1_fx * tex_y_xyzz_1[j] + 0.5 * fl1_fx * tex_xy_yzz_0[j] - 0.5 * fl1_fx * tex_xy_yzz_1[j] +
                                    ta_xy_xyzz_1[j];

                tey_xxy_xyzz_0[j] = pa_x[j] * tey_xy_xyzz_0[j] - pc_x[j] * tey_xy_xyzz_1[j] + 0.5 * fl1_fx * tey_y_xyzz_0[j] -
                                    0.5 * fl1_fx * tey_y_xyzz_1[j] + 0.5 * fl1_fx * tey_xy_yzz_0[j] - 0.5 * fl1_fx * tey_xy_yzz_1[j];

                tez_xxy_xyzz_0[j] = pa_x[j] * tez_xy_xyzz_0[j] - pc_x[j] * tez_xy_xyzz_1[j] + 0.5 * fl1_fx * tez_y_xyzz_0[j] -
                                    0.5 * fl1_fx * tez_y_xyzz_1[j] + 0.5 * fl1_fx * tez_xy_yzz_0[j] - 0.5 * fl1_fx * tez_xy_yzz_1[j];

                tex_xxy_xzzz_0[j] = pa_x[j] * tex_xy_xzzz_0[j] - pc_x[j] * tex_xy_xzzz_1[j] + 0.5 * fl1_fx * tex_y_xzzz_0[j] -
                                    0.5 * fl1_fx * tex_y_xzzz_1[j] + 0.5 * fl1_fx * tex_xy_zzz_0[j] - 0.5 * fl1_fx * tex_xy_zzz_1[j] +
                                    ta_xy_xzzz_1[j];

                tey_xxy_xzzz_0[j] = pa_x[j] * tey_xy_xzzz_0[j] - pc_x[j] * tey_xy_xzzz_1[j] + 0.5 * fl1_fx * tey_y_xzzz_0[j] -
                                    0.5 * fl1_fx * tey_y_xzzz_1[j] + 0.5 * fl1_fx * tey_xy_zzz_0[j] - 0.5 * fl1_fx * tey_xy_zzz_1[j];

                tez_xxy_xzzz_0[j] = pa_x[j] * tez_xy_xzzz_0[j] - pc_x[j] * tez_xy_xzzz_1[j] + 0.5 * fl1_fx * tez_y_xzzz_0[j] -
                                    0.5 * fl1_fx * tez_y_xzzz_1[j] + 0.5 * fl1_fx * tez_xy_zzz_0[j] - 0.5 * fl1_fx * tez_xy_zzz_1[j];

                tex_xxy_yyyy_0[j] = pa_x[j] * tex_xy_yyyy_0[j] - pc_x[j] * tex_xy_yyyy_1[j] + 0.5 * fl1_fx * tex_y_yyyy_0[j] -
                                    0.5 * fl1_fx * tex_y_yyyy_1[j] + ta_xy_yyyy_1[j];

                tey_xxy_yyyy_0[j] =
                    pa_x[j] * tey_xy_yyyy_0[j] - pc_x[j] * tey_xy_yyyy_1[j] + 0.5 * fl1_fx * tey_y_yyyy_0[j] - 0.5 * fl1_fx * tey_y_yyyy_1[j];

                tez_xxy_yyyy_0[j] =
                    pa_x[j] * tez_xy_yyyy_0[j] - pc_x[j] * tez_xy_yyyy_1[j] + 0.5 * fl1_fx * tez_y_yyyy_0[j] - 0.5 * fl1_fx * tez_y_yyyy_1[j];

                tex_xxy_yyyz_0[j] = pa_x[j] * tex_xy_yyyz_0[j] - pc_x[j] * tex_xy_yyyz_1[j] + 0.5 * fl1_fx * tex_y_yyyz_0[j] -
                                    0.5 * fl1_fx * tex_y_yyyz_1[j] + ta_xy_yyyz_1[j];

                tey_xxy_yyyz_0[j] =
                    pa_x[j] * tey_xy_yyyz_0[j] - pc_x[j] * tey_xy_yyyz_1[j] + 0.5 * fl1_fx * tey_y_yyyz_0[j] - 0.5 * fl1_fx * tey_y_yyyz_1[j];

                tez_xxy_yyyz_0[j] =
                    pa_x[j] * tez_xy_yyyz_0[j] - pc_x[j] * tez_xy_yyyz_1[j] + 0.5 * fl1_fx * tez_y_yyyz_0[j] - 0.5 * fl1_fx * tez_y_yyyz_1[j];

                tex_xxy_yyzz_0[j] = pa_x[j] * tex_xy_yyzz_0[j] - pc_x[j] * tex_xy_yyzz_1[j] + 0.5 * fl1_fx * tex_y_yyzz_0[j] -
                                    0.5 * fl1_fx * tex_y_yyzz_1[j] + ta_xy_yyzz_1[j];

                tey_xxy_yyzz_0[j] =
                    pa_x[j] * tey_xy_yyzz_0[j] - pc_x[j] * tey_xy_yyzz_1[j] + 0.5 * fl1_fx * tey_y_yyzz_0[j] - 0.5 * fl1_fx * tey_y_yyzz_1[j];

                tez_xxy_yyzz_0[j] =
                    pa_x[j] * tez_xy_yyzz_0[j] - pc_x[j] * tez_xy_yyzz_1[j] + 0.5 * fl1_fx * tez_y_yyzz_0[j] - 0.5 * fl1_fx * tez_y_yyzz_1[j];

                tex_xxy_yzzz_0[j] = pa_x[j] * tex_xy_yzzz_0[j] - pc_x[j] * tex_xy_yzzz_1[j] + 0.5 * fl1_fx * tex_y_yzzz_0[j] -
                                    0.5 * fl1_fx * tex_y_yzzz_1[j] + ta_xy_yzzz_1[j];

                tey_xxy_yzzz_0[j] =
                    pa_x[j] * tey_xy_yzzz_0[j] - pc_x[j] * tey_xy_yzzz_1[j] + 0.5 * fl1_fx * tey_y_yzzz_0[j] - 0.5 * fl1_fx * tey_y_yzzz_1[j];

                tez_xxy_yzzz_0[j] =
                    pa_x[j] * tez_xy_yzzz_0[j] - pc_x[j] * tez_xy_yzzz_1[j] + 0.5 * fl1_fx * tez_y_yzzz_0[j] - 0.5 * fl1_fx * tez_y_yzzz_1[j];

                tex_xxy_zzzz_0[j] = pa_x[j] * tex_xy_zzzz_0[j] - pc_x[j] * tex_xy_zzzz_1[j] + 0.5 * fl1_fx * tex_y_zzzz_0[j] -
                                    0.5 * fl1_fx * tex_y_zzzz_1[j] + ta_xy_zzzz_1[j];

                tey_xxy_zzzz_0[j] =
                    pa_x[j] * tey_xy_zzzz_0[j] - pc_x[j] * tey_xy_zzzz_1[j] + 0.5 * fl1_fx * tey_y_zzzz_0[j] - 0.5 * fl1_fx * tey_y_zzzz_1[j];

                tez_xxy_zzzz_0[j] =
                    pa_x[j] * tez_xy_zzzz_0[j] - pc_x[j] * tez_xy_zzzz_1[j] + 0.5 * fl1_fx * tez_y_zzzz_0[j] - 0.5 * fl1_fx * tez_y_zzzz_1[j];

                tex_xxz_xxxx_0[j] = pa_x[j] * tex_xz_xxxx_0[j] - pc_x[j] * tex_xz_xxxx_1[j] + 0.5 * fl1_fx * tex_z_xxxx_0[j] -
                                    0.5 * fl1_fx * tex_z_xxxx_1[j] + 2.0 * fl1_fx * tex_xz_xxx_0[j] - 2.0 * fl1_fx * tex_xz_xxx_1[j] +
                                    ta_xz_xxxx_1[j];

                tey_xxz_xxxx_0[j] = pa_x[j] * tey_xz_xxxx_0[j] - pc_x[j] * tey_xz_xxxx_1[j] + 0.5 * fl1_fx * tey_z_xxxx_0[j] -
                                    0.5 * fl1_fx * tey_z_xxxx_1[j] + 2.0 * fl1_fx * tey_xz_xxx_0[j] - 2.0 * fl1_fx * tey_xz_xxx_1[j];

                tez_xxz_xxxx_0[j] = pa_x[j] * tez_xz_xxxx_0[j] - pc_x[j] * tez_xz_xxxx_1[j] + 0.5 * fl1_fx * tez_z_xxxx_0[j] -
                                    0.5 * fl1_fx * tez_z_xxxx_1[j] + 2.0 * fl1_fx * tez_xz_xxx_0[j] - 2.0 * fl1_fx * tez_xz_xxx_1[j];

                tex_xxz_xxxy_0[j] = pa_x[j] * tex_xz_xxxy_0[j] - pc_x[j] * tex_xz_xxxy_1[j] + 0.5 * fl1_fx * tex_z_xxxy_0[j] -
                                    0.5 * fl1_fx * tex_z_xxxy_1[j] + 1.5 * fl1_fx * tex_xz_xxy_0[j] - 1.5 * fl1_fx * tex_xz_xxy_1[j] +
                                    ta_xz_xxxy_1[j];

                tey_xxz_xxxy_0[j] = pa_x[j] * tey_xz_xxxy_0[j] - pc_x[j] * tey_xz_xxxy_1[j] + 0.5 * fl1_fx * tey_z_xxxy_0[j] -
                                    0.5 * fl1_fx * tey_z_xxxy_1[j] + 1.5 * fl1_fx * tey_xz_xxy_0[j] - 1.5 * fl1_fx * tey_xz_xxy_1[j];

                tez_xxz_xxxy_0[j] = pa_x[j] * tez_xz_xxxy_0[j] - pc_x[j] * tez_xz_xxxy_1[j] + 0.5 * fl1_fx * tez_z_xxxy_0[j] -
                                    0.5 * fl1_fx * tez_z_xxxy_1[j] + 1.5 * fl1_fx * tez_xz_xxy_0[j] - 1.5 * fl1_fx * tez_xz_xxy_1[j];

                tex_xxz_xxxz_0[j] = pa_x[j] * tex_xz_xxxz_0[j] - pc_x[j] * tex_xz_xxxz_1[j] + 0.5 * fl1_fx * tex_z_xxxz_0[j] -
                                    0.5 * fl1_fx * tex_z_xxxz_1[j] + 1.5 * fl1_fx * tex_xz_xxz_0[j] - 1.5 * fl1_fx * tex_xz_xxz_1[j] +
                                    ta_xz_xxxz_1[j];

                tey_xxz_xxxz_0[j] = pa_x[j] * tey_xz_xxxz_0[j] - pc_x[j] * tey_xz_xxxz_1[j] + 0.5 * fl1_fx * tey_z_xxxz_0[j] -
                                    0.5 * fl1_fx * tey_z_xxxz_1[j] + 1.5 * fl1_fx * tey_xz_xxz_0[j] - 1.5 * fl1_fx * tey_xz_xxz_1[j];

                tez_xxz_xxxz_0[j] = pa_x[j] * tez_xz_xxxz_0[j] - pc_x[j] * tez_xz_xxxz_1[j] + 0.5 * fl1_fx * tez_z_xxxz_0[j] -
                                    0.5 * fl1_fx * tez_z_xxxz_1[j] + 1.5 * fl1_fx * tez_xz_xxz_0[j] - 1.5 * fl1_fx * tez_xz_xxz_1[j];

                tex_xxz_xxyy_0[j] = pa_x[j] * tex_xz_xxyy_0[j] - pc_x[j] * tex_xz_xxyy_1[j] + 0.5 * fl1_fx * tex_z_xxyy_0[j] -
                                    0.5 * fl1_fx * tex_z_xxyy_1[j] + fl1_fx * tex_xz_xyy_0[j] - fl1_fx * tex_xz_xyy_1[j] + ta_xz_xxyy_1[j];
            }
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tey_xxz_xxyy_0[j] = pa_x[j] * tey_xz_xxyy_0[j] - pc_x[j] * tey_xz_xxyy_1[j] + 0.5 * fl1_fx * tey_z_xxyy_0[j] -
                                    0.5 * fl1_fx * tey_z_xxyy_1[j] + fl1_fx * tey_xz_xyy_0[j] - fl1_fx * tey_xz_xyy_1[j];

                tez_xxz_xxyy_0[j] = pa_x[j] * tez_xz_xxyy_0[j] - pc_x[j] * tez_xz_xxyy_1[j] + 0.5 * fl1_fx * tez_z_xxyy_0[j] -
                                    0.5 * fl1_fx * tez_z_xxyy_1[j] + fl1_fx * tez_xz_xyy_0[j] - fl1_fx * tez_xz_xyy_1[j];

                tex_xxz_xxyz_0[j] = pa_x[j] * tex_xz_xxyz_0[j] - pc_x[j] * tex_xz_xxyz_1[j] + 0.5 * fl1_fx * tex_z_xxyz_0[j] -
                                    0.5 * fl1_fx * tex_z_xxyz_1[j] + fl1_fx * tex_xz_xyz_0[j] - fl1_fx * tex_xz_xyz_1[j] + ta_xz_xxyz_1[j];

                tey_xxz_xxyz_0[j] = pa_x[j] * tey_xz_xxyz_0[j] - pc_x[j] * tey_xz_xxyz_1[j] + 0.5 * fl1_fx * tey_z_xxyz_0[j] -
                                    0.5 * fl1_fx * tey_z_xxyz_1[j] + fl1_fx * tey_xz_xyz_0[j] - fl1_fx * tey_xz_xyz_1[j];

                tez_xxz_xxyz_0[j] = pa_x[j] * tez_xz_xxyz_0[j] - pc_x[j] * tez_xz_xxyz_1[j] + 0.5 * fl1_fx * tez_z_xxyz_0[j] -
                                    0.5 * fl1_fx * tez_z_xxyz_1[j] + fl1_fx * tez_xz_xyz_0[j] - fl1_fx * tez_xz_xyz_1[j];

                tex_xxz_xxzz_0[j] = pa_x[j] * tex_xz_xxzz_0[j] - pc_x[j] * tex_xz_xxzz_1[j] + 0.5 * fl1_fx * tex_z_xxzz_0[j] -
                                    0.5 * fl1_fx * tex_z_xxzz_1[j] + fl1_fx * tex_xz_xzz_0[j] - fl1_fx * tex_xz_xzz_1[j] + ta_xz_xxzz_1[j];

                tey_xxz_xxzz_0[j] = pa_x[j] * tey_xz_xxzz_0[j] - pc_x[j] * tey_xz_xxzz_1[j] + 0.5 * fl1_fx * tey_z_xxzz_0[j] -
                                    0.5 * fl1_fx * tey_z_xxzz_1[j] + fl1_fx * tey_xz_xzz_0[j] - fl1_fx * tey_xz_xzz_1[j];

                tez_xxz_xxzz_0[j] = pa_x[j] * tez_xz_xxzz_0[j] - pc_x[j] * tez_xz_xxzz_1[j] + 0.5 * fl1_fx * tez_z_xxzz_0[j] -
                                    0.5 * fl1_fx * tez_z_xxzz_1[j] + fl1_fx * tez_xz_xzz_0[j] - fl1_fx * tez_xz_xzz_1[j];

                tex_xxz_xyyy_0[j] = pa_x[j] * tex_xz_xyyy_0[j] - pc_x[j] * tex_xz_xyyy_1[j] + 0.5 * fl1_fx * tex_z_xyyy_0[j] -
                                    0.5 * fl1_fx * tex_z_xyyy_1[j] + 0.5 * fl1_fx * tex_xz_yyy_0[j] - 0.5 * fl1_fx * tex_xz_yyy_1[j] +
                                    ta_xz_xyyy_1[j];

                tey_xxz_xyyy_0[j] = pa_x[j] * tey_xz_xyyy_0[j] - pc_x[j] * tey_xz_xyyy_1[j] + 0.5 * fl1_fx * tey_z_xyyy_0[j] -
                                    0.5 * fl1_fx * tey_z_xyyy_1[j] + 0.5 * fl1_fx * tey_xz_yyy_0[j] - 0.5 * fl1_fx * tey_xz_yyy_1[j];

                tez_xxz_xyyy_0[j] = pa_x[j] * tez_xz_xyyy_0[j] - pc_x[j] * tez_xz_xyyy_1[j] + 0.5 * fl1_fx * tez_z_xyyy_0[j] -
                                    0.5 * fl1_fx * tez_z_xyyy_1[j] + 0.5 * fl1_fx * tez_xz_yyy_0[j] - 0.5 * fl1_fx * tez_xz_yyy_1[j];

                tex_xxz_xyyz_0[j] = pa_x[j] * tex_xz_xyyz_0[j] - pc_x[j] * tex_xz_xyyz_1[j] + 0.5 * fl1_fx * tex_z_xyyz_0[j] -
                                    0.5 * fl1_fx * tex_z_xyyz_1[j] + 0.5 * fl1_fx * tex_xz_yyz_0[j] - 0.5 * fl1_fx * tex_xz_yyz_1[j] +
                                    ta_xz_xyyz_1[j];

                tey_xxz_xyyz_0[j] = pa_x[j] * tey_xz_xyyz_0[j] - pc_x[j] * tey_xz_xyyz_1[j] + 0.5 * fl1_fx * tey_z_xyyz_0[j] -
                                    0.5 * fl1_fx * tey_z_xyyz_1[j] + 0.5 * fl1_fx * tey_xz_yyz_0[j] - 0.5 * fl1_fx * tey_xz_yyz_1[j];

                tez_xxz_xyyz_0[j] = pa_x[j] * tez_xz_xyyz_0[j] - pc_x[j] * tez_xz_xyyz_1[j] + 0.5 * fl1_fx * tez_z_xyyz_0[j] -
                                    0.5 * fl1_fx * tez_z_xyyz_1[j] + 0.5 * fl1_fx * tez_xz_yyz_0[j] - 0.5 * fl1_fx * tez_xz_yyz_1[j];

                tex_xxz_xyzz_0[j] = pa_x[j] * tex_xz_xyzz_0[j] - pc_x[j] * tex_xz_xyzz_1[j] + 0.5 * fl1_fx * tex_z_xyzz_0[j] -
                                    0.5 * fl1_fx * tex_z_xyzz_1[j] + 0.5 * fl1_fx * tex_xz_yzz_0[j] - 0.5 * fl1_fx * tex_xz_yzz_1[j] +
                                    ta_xz_xyzz_1[j];

                tey_xxz_xyzz_0[j] = pa_x[j] * tey_xz_xyzz_0[j] - pc_x[j] * tey_xz_xyzz_1[j] + 0.5 * fl1_fx * tey_z_xyzz_0[j] -
                                    0.5 * fl1_fx * tey_z_xyzz_1[j] + 0.5 * fl1_fx * tey_xz_yzz_0[j] - 0.5 * fl1_fx * tey_xz_yzz_1[j];

                tez_xxz_xyzz_0[j] = pa_x[j] * tez_xz_xyzz_0[j] - pc_x[j] * tez_xz_xyzz_1[j] + 0.5 * fl1_fx * tez_z_xyzz_0[j] -
                                    0.5 * fl1_fx * tez_z_xyzz_1[j] + 0.5 * fl1_fx * tez_xz_yzz_0[j] - 0.5 * fl1_fx * tez_xz_yzz_1[j];

                tex_xxz_xzzz_0[j] = pa_x[j] * tex_xz_xzzz_0[j] - pc_x[j] * tex_xz_xzzz_1[j] + 0.5 * fl1_fx * tex_z_xzzz_0[j] -
                                    0.5 * fl1_fx * tex_z_xzzz_1[j] + 0.5 * fl1_fx * tex_xz_zzz_0[j] - 0.5 * fl1_fx * tex_xz_zzz_1[j] +
                                    ta_xz_xzzz_1[j];

                tey_xxz_xzzz_0[j] = pa_x[j] * tey_xz_xzzz_0[j] - pc_x[j] * tey_xz_xzzz_1[j] + 0.5 * fl1_fx * tey_z_xzzz_0[j] -
                                    0.5 * fl1_fx * tey_z_xzzz_1[j] + 0.5 * fl1_fx * tey_xz_zzz_0[j] - 0.5 * fl1_fx * tey_xz_zzz_1[j];

                tez_xxz_xzzz_0[j] = pa_x[j] * tez_xz_xzzz_0[j] - pc_x[j] * tez_xz_xzzz_1[j] + 0.5 * fl1_fx * tez_z_xzzz_0[j] -
                                    0.5 * fl1_fx * tez_z_xzzz_1[j] + 0.5 * fl1_fx * tez_xz_zzz_0[j] - 0.5 * fl1_fx * tez_xz_zzz_1[j];

                tex_xxz_yyyy_0[j] = pa_x[j] * tex_xz_yyyy_0[j] - pc_x[j] * tex_xz_yyyy_1[j] + 0.5 * fl1_fx * tex_z_yyyy_0[j] -
                                    0.5 * fl1_fx * tex_z_yyyy_1[j] + ta_xz_yyyy_1[j];

                tey_xxz_yyyy_0[j] =
                    pa_x[j] * tey_xz_yyyy_0[j] - pc_x[j] * tey_xz_yyyy_1[j] + 0.5 * fl1_fx * tey_z_yyyy_0[j] - 0.5 * fl1_fx * tey_z_yyyy_1[j];

                tez_xxz_yyyy_0[j] =
                    pa_x[j] * tez_xz_yyyy_0[j] - pc_x[j] * tez_xz_yyyy_1[j] + 0.5 * fl1_fx * tez_z_yyyy_0[j] - 0.5 * fl1_fx * tez_z_yyyy_1[j];

                tex_xxz_yyyz_0[j] = pa_x[j] * tex_xz_yyyz_0[j] - pc_x[j] * tex_xz_yyyz_1[j] + 0.5 * fl1_fx * tex_z_yyyz_0[j] -
                                    0.5 * fl1_fx * tex_z_yyyz_1[j] + ta_xz_yyyz_1[j];

                tey_xxz_yyyz_0[j] =
                    pa_x[j] * tey_xz_yyyz_0[j] - pc_x[j] * tey_xz_yyyz_1[j] + 0.5 * fl1_fx * tey_z_yyyz_0[j] - 0.5 * fl1_fx * tey_z_yyyz_1[j];

                tez_xxz_yyyz_0[j] =
                    pa_x[j] * tez_xz_yyyz_0[j] - pc_x[j] * tez_xz_yyyz_1[j] + 0.5 * fl1_fx * tez_z_yyyz_0[j] - 0.5 * fl1_fx * tez_z_yyyz_1[j];

                tex_xxz_yyzz_0[j] = pa_x[j] * tex_xz_yyzz_0[j] - pc_x[j] * tex_xz_yyzz_1[j] + 0.5 * fl1_fx * tex_z_yyzz_0[j] -
                                    0.5 * fl1_fx * tex_z_yyzz_1[j] + ta_xz_yyzz_1[j];

                tey_xxz_yyzz_0[j] =
                    pa_x[j] * tey_xz_yyzz_0[j] - pc_x[j] * tey_xz_yyzz_1[j] + 0.5 * fl1_fx * tey_z_yyzz_0[j] - 0.5 * fl1_fx * tey_z_yyzz_1[j];

                tez_xxz_yyzz_0[j] =
                    pa_x[j] * tez_xz_yyzz_0[j] - pc_x[j] * tez_xz_yyzz_1[j] + 0.5 * fl1_fx * tez_z_yyzz_0[j] - 0.5 * fl1_fx * tez_z_yyzz_1[j];

                tex_xxz_yzzz_0[j] = pa_x[j] * tex_xz_yzzz_0[j] - pc_x[j] * tex_xz_yzzz_1[j] + 0.5 * fl1_fx * tex_z_yzzz_0[j] -
                                    0.5 * fl1_fx * tex_z_yzzz_1[j] + ta_xz_yzzz_1[j];

                tey_xxz_yzzz_0[j] =
                    pa_x[j] * tey_xz_yzzz_0[j] - pc_x[j] * tey_xz_yzzz_1[j] + 0.5 * fl1_fx * tey_z_yzzz_0[j] - 0.5 * fl1_fx * tey_z_yzzz_1[j];

                tez_xxz_yzzz_0[j] =
                    pa_x[j] * tez_xz_yzzz_0[j] - pc_x[j] * tez_xz_yzzz_1[j] + 0.5 * fl1_fx * tez_z_yzzz_0[j] - 0.5 * fl1_fx * tez_z_yzzz_1[j];

                tex_xxz_zzzz_0[j] = pa_x[j] * tex_xz_zzzz_0[j] - pc_x[j] * tex_xz_zzzz_1[j] + 0.5 * fl1_fx * tex_z_zzzz_0[j] -
                                    0.5 * fl1_fx * tex_z_zzzz_1[j] + ta_xz_zzzz_1[j];

                tey_xxz_zzzz_0[j] =
                    pa_x[j] * tey_xz_zzzz_0[j] - pc_x[j] * tey_xz_zzzz_1[j] + 0.5 * fl1_fx * tey_z_zzzz_0[j] - 0.5 * fl1_fx * tey_z_zzzz_1[j];

                tez_xxz_zzzz_0[j] =
                    pa_x[j] * tez_xz_zzzz_0[j] - pc_x[j] * tez_xz_zzzz_1[j] + 0.5 * fl1_fx * tez_z_zzzz_0[j] - 0.5 * fl1_fx * tez_z_zzzz_1[j];

                tex_xyy_xxxx_0[j] = pa_x[j] * tex_yy_xxxx_0[j] - pc_x[j] * tex_yy_xxxx_1[j] + 2.0 * fl1_fx * tex_yy_xxx_0[j] -
                                    2.0 * fl1_fx * tex_yy_xxx_1[j] + ta_yy_xxxx_1[j];

                tey_xyy_xxxx_0[j] =
                    pa_x[j] * tey_yy_xxxx_0[j] - pc_x[j] * tey_yy_xxxx_1[j] + 2.0 * fl1_fx * tey_yy_xxx_0[j] - 2.0 * fl1_fx * tey_yy_xxx_1[j];

                tez_xyy_xxxx_0[j] =
                    pa_x[j] * tez_yy_xxxx_0[j] - pc_x[j] * tez_yy_xxxx_1[j] + 2.0 * fl1_fx * tez_yy_xxx_0[j] - 2.0 * fl1_fx * tez_yy_xxx_1[j];

                tex_xyy_xxxy_0[j] = pa_x[j] * tex_yy_xxxy_0[j] - pc_x[j] * tex_yy_xxxy_1[j] + 1.5 * fl1_fx * tex_yy_xxy_0[j] -
                                    1.5 * fl1_fx * tex_yy_xxy_1[j] + ta_yy_xxxy_1[j];

                tey_xyy_xxxy_0[j] =
                    pa_x[j] * tey_yy_xxxy_0[j] - pc_x[j] * tey_yy_xxxy_1[j] + 1.5 * fl1_fx * tey_yy_xxy_0[j] - 1.5 * fl1_fx * tey_yy_xxy_1[j];

                tez_xyy_xxxy_0[j] =
                    pa_x[j] * tez_yy_xxxy_0[j] - pc_x[j] * tez_yy_xxxy_1[j] + 1.5 * fl1_fx * tez_yy_xxy_0[j] - 1.5 * fl1_fx * tez_yy_xxy_1[j];

                tex_xyy_xxxz_0[j] = pa_x[j] * tex_yy_xxxz_0[j] - pc_x[j] * tex_yy_xxxz_1[j] + 1.5 * fl1_fx * tex_yy_xxz_0[j] -
                                    1.5 * fl1_fx * tex_yy_xxz_1[j] + ta_yy_xxxz_1[j];

                tey_xyy_xxxz_0[j] =
                    pa_x[j] * tey_yy_xxxz_0[j] - pc_x[j] * tey_yy_xxxz_1[j] + 1.5 * fl1_fx * tey_yy_xxz_0[j] - 1.5 * fl1_fx * tey_yy_xxz_1[j];

                tez_xyy_xxxz_0[j] =
                    pa_x[j] * tez_yy_xxxz_0[j] - pc_x[j] * tez_yy_xxxz_1[j] + 1.5 * fl1_fx * tez_yy_xxz_0[j] - 1.5 * fl1_fx * tez_yy_xxz_1[j];

                tex_xyy_xxyy_0[j] =
                    pa_x[j] * tex_yy_xxyy_0[j] - pc_x[j] * tex_yy_xxyy_1[j] + fl1_fx * tex_yy_xyy_0[j] - fl1_fx * tex_yy_xyy_1[j] + ta_yy_xxyy_1[j];
                ...
                tex_xyy_xxyz_0[j] =
                    pa_x[j] * tex_yy_xxyz_0[j] - pc_x[j] * tex_yy_xxyz_1[j] + fl1_fx * tex_yy_xyz_0[j] - fl1_fx * tex_yy_xyz_1[j] + ta_yy_xxyz_1[j];
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tex_xyy_xxzz_0[j] =
                    pa_x[j] * tex_yy_xxzz_0[j] - pc_x[j] * tex_yy_xxzz_1[j] + fl1_fx * tex_yy_xzz_0[j] - fl1_fx * tex_yy_xzz_1[j] + ta_yy_xxzz_1[j];
                ...
                tex_xyy_xyyy_0[j] = pa_x[j] * tex_yy_xyyy_0[j] - pc_x[j] * tex_yy_xyyy_1[j] + 0.5 * fl1_fx * tex_yy_yyy_0[j] -
                                    0.5 * fl1_fx * tex_yy_yyy_1[j] + ta_yy_xyyy_1[j];

                tey_xyy_xyyy_0[j] =
                    pa_x[j] * tey_yy_xyyy_0[j] - pc_x[j] * tey_yy_xyyy_1[j] + 0.5 * fl1_fx * tey_yy_yyy_0[j] - 0.5 * fl1_fx * tey_yy_yyy_1[j];

                tez_xyy_xyyy_0[j] =
                    pa_x[j] * tez_yy_xyyy_0[j] - pc_x[j] * tez_yy_xyyy_1[j] + 0.5 * fl1_fx * tez_yy_yyy_0[j] - 0.5 * fl1_fx * tez_yy_yyy_1[j];

                tex_xyy_xyyz_0[j] = pa_x[j] * tex_yy_xyyz_0[j] - pc_x[j] * tex_yy_xyyz_1[j] + 0.5 * fl1_fx * tex_yy_yyz_0[j] -
                                    0.5 * fl1_fx * tex_yy_yyz_1[j] + ta_yy_xyyz_1[j];

                tey_xyy_xyyz_0[j] =
                    pa_x[j] * tey_yy_xyyz_0[j] - pc_x[j] * tey_yy_xyyz_1[j] + 0.5 * fl1_fx * tey_yy_yyz_0[j] - 0.5 * fl1_fx * tey_yy_yyz_1[j];

                tez_xyy_xyyz_0[j] =
                    pa_x[j] * tez_yy_xyyz_0[j] - pc_x[j] * tez_yy_xyyz_1[j] + 0.5 * fl1_fx * tez_yy_yyz_0[j] - 0.5 * fl1_fx * tez_yy_yyz_1[j];

                tex_xyy_xyzz_0[j] = pa_x[j] * tex_yy_xyzz_0[j] - pc_x[j] * tex_yy_xyzz_1[j] + 0.5 * fl1_fx * tex_yy_yzz_0[j] -
                                    0.5 * fl1_fx * tex_yy_yzz_1[j] + ta_yy_xyzz_1[j];

                tey_xyy_xyzz_0[j] =
                    pa_x[j] * tey_yy_xyzz_0[j] - pc_x[j] * tey_yy_xyzz_1[j] + 0.5 * fl1_fx * tey_yy_yzz_0[j] - 0.5 * fl1_fx * tey_yy_yzz_1[j];

                tez_xyy_xyzz_0[j] =
                    pa_x[j] * tez_yy_xyzz_0[j] - pc_x[j] * tez_yy_xyzz_1[j] + 0.5 * fl1_fx * tez_yy_yzz_0[j] - 0.5 * fl1_fx * tez_yy_yzz_1[j];

                tex_xyy_xzzz_0[j] = pa_x[j] * tex_yy_xzzz_0[j] - pc_x[j] * tex_yy_xzzz_1[j] + 0.5 * fl1_fx * tex_yy_zzz_0[j] -
                                    0.5 * fl1_fx * tex_yy_zzz_1[j] + ta_yy_xzzz_1[j];

                tey_xyy_xzzz_0[j] =
                    pa_x[j] * tey_yy_xzzz_0[j] - pc_x[j] * tey_yy_xzzz_1[j] + 0.5 * fl1_fx * tey_yy_zzz_0[j] - 0.5 * fl1_fx * tey_yy_zzz_1[j];

                tez_xyy_xzzz_0[j] =
                    pa_x[j] * tez_yy_xzzz_0[j] - pc_x[j] * tez_yy_xzzz_1[j] + 0.5 * fl1_fx * tez_yy_zzz_0[j] - 0.5 * fl1_fx * tez_yy_zzz_1[j];
                ...
                tex_xyz_xxxx_0[j] = pa_x[j] * tex_yz_xxxx_0[j] - pc_x[j] * tex_yz_xxxx_1[j] + 2.0 * fl1_fx * tex_yz_xxx_0[j] -
                                    2.0 * fl1_fx * tex_yz_xxx_1[j] + ta_yz_xxxx_1[j];

                tey_xyz_xxxx_0[j] =
                    pa_x[j] * tey_yz_xxxx_0[j] - pc_x[j] * tey_yz_xxxx_1[j] + 2.0 * fl1_fx * tey_yz_xxx_0[j] - 2.0 * fl1_fx * tey_yz_xxx_1[j];

                tez_xyz_xxxx_0[j] =
                    pa_x[j] * tez_yz_xxxx_0[j] - pc_x[j] * tez_yz_xxxx_1[j] + 2.0 * fl1_fx * tez_yz_xxx_0[j] - 2.0 * fl1_fx * tez_yz_xxx_1[j];

                tex_xyz_xxxy_0[j] = pa_x[j] * tex_yz_xxxy_0[j] - pc_x[j] * tex_yz_xxxy_1[j] + 1.5 * fl1_fx * tex_yz_xxy_0[j] -
                                    1.5 * fl1_fx * tex_yz_xxy_1[j] + ta_yz_xxxy_1[j];

                tey_xyz_xxxy_0[j] =
                    pa_x[j] * tey_yz_xxxy_0[j] - pc_x[j] * tey_yz_xxxy_1[j] + 1.5 * fl1_fx * tey_yz_xxy_0[j] - 1.5 * fl1_fx * tey_yz_xxy_1[j];

                tez_xyz_xxxy_0[j] =
                    pa_x[j] * tez_yz_xxxy_0[j] - pc_x[j] * tez_yz_xxxy_1[j] + 1.5 * fl1_fx * tez_yz_xxy_0[j] - 1.5 * fl1_fx * tez_yz_xxy_1[j];

                tex_xyz_xxxz_0[j] = pa_x[j] * tex_yz_xxxz_0[j] - pc_x[j] * tex_yz_xxxz_1[j] + 1.5 * fl1_fx * tex_yz_xxz_0[j] -
                                    1.5 * fl1_fx * tex_yz_xxz_1[j] + ta_yz_xxxz_1[j];

                tey_xyz_xxxz_0[j] =
                    pa_x[j] * tey_yz_xxxz_0[j] - pc_x[j] * tey_yz_xxxz_1[j] + 1.5 * fl1_fx * tey_yz_xxz_0[j] - 1.5 * fl1_fx * tey_yz_xxz_1[j];

                tez_xyz_xxxz_0[j] =
                    pa_x[j] * tez_yz_xxxz_0[j] - pc_x[j] * tez_yz_xxxz_1[j] + 1.5 * fl1_fx * tez_yz_xxz_0[j] - 1.5 * fl1_fx * tez_yz_xxz_1[j];

                tex_xyz_xxyy_0[j] =
                    pa_x[j] * tex_yz_xxyy_0[j] - pc_x[j] * tex_yz_xxyy_1[j] + fl1_fx * tex_yz_xyy_0[j] - fl1_fx * tex_yz_xyy_1[j] + ta_yz_xxyy_1[j];
                ...
                tex_xyz_xxyz_0[j] =
                    pa_x[j] * tex_yz_xxyz_0[j] - pc_x[j] * tex_yz_xxyz_1[j] + fl1_fx * tex_yz_xyz_0[j] - fl1_fx * tex_yz_xyz_1[j] + ta_yz_xxyz_1[j];
                ...
                tex_xyz_xxzz_0[j] =
                    pa_x[j] * tex_yz_xxzz_0[j] - pc_x[j] * tex_yz_xxzz_1[j] + fl1_fx * tex_yz_xzz_0[j] - fl1_fx * tex_yz_xzz_1[j] + ta_yz_xxzz_1[j];
                ...
                tex_xyz_xyyy_0[j] = pa_x[j] * tex_yz_xyyy_0[j] - pc_x[j] * tex_yz_xyyy_1[j] + 0.5 * fl1_fx * tex_yz_yyy_0[j] -
                                    0.5 * fl1_fx * tex_yz_yyy_1[j] + ta_yz_xyyy_1[j];

                tey_xyz_xyyy_0[j] =
                    pa_x[j] * tey_yz_xyyy_0[j] - pc_x[j] * tey_yz_xyyy_1[j] + 0.5 * fl1_fx * tey_yz_yyy_0[j] - 0.5 * fl1_fx * tey_yz_yyy_1[j];
            }
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tez_xyz_xyyy_0[j] =
                    pa_x[j] * tez_yz_xyyy_0[j] - pc_x[j] * tez_yz_xyyy_1[j] + 0.5 * fl1_fx * tez_yz_yyy_0[j] - 0.5 * fl1_fx * tez_yz_yyy_1[j];

                tex_xyz_xyyz_0[j] = pa_x[j] * tex_yz_xyyz_0[j] - pc_x[j] * tex_yz_xyyz_1[j] + 0.5 * fl1_fx * tex_yz_yyz_0[j] -
                                    0.5 * fl1_fx * tex_yz_yyz_1[j] + ta_yz_xyyz_1[j];

                tey_xyz_xyyz_0[j] =
                    pa_x[j] * tey_yz_xyyz_0[j] - pc_x[j] * tey_yz_xyyz_1[j] + 0.5 * fl1_fx * tey_yz_yyz_0[j] - 0.5 * fl1_fx * tey_yz_yyz_1[j];

                tez_xyz_xyyz_0[j] =
                    pa_x[j] * tez_yz_xyyz_0[j] - pc_x[j] * tez_yz_xyyz_1[j] + 0.5 * fl1_fx * tez_yz_yyz_0[j] - 0.5 * fl1_fx * tez_yz_yyz_1[j];

                tex_xyz_xyzz_0[j] = pa_x[j] * tex_yz_xyzz_0[j] - pc_x[j] * tex_yz_xyzz_1[j] + 0.5 * fl1_fx * tex_yz_yzz_0[j] -
                                    0.5 * fl1_fx * tex_yz_yzz_1[j] + ta_yz_xyzz_1[j];

                tey_xyz_xyzz_0[j] =
                    pa_x[j] * tey_yz_xyzz_0[j] - pc_x[j] * tey_yz_xyzz_1[j] + 0.5 * fl1_fx * tey_yz_yzz_0[j] - 0.5 * fl1_fx * tey_yz_yzz_1[j];

                tez_xyz_xyzz_0[j] =
                    pa_x[j] * tez_yz_xyzz_0[j] - pc_x[j] * tez_yz_xyzz_1[j] + 0.5 * fl1_fx * tez_yz_yzz_0[j] - 0.5 * fl1_fx * tez_yz_yzz_1[j];

                tex_xyz_xzzz_0[j] = pa_x[j] * tex_yz_xzzz_0[j] - pc_x[j] * tex_yz_xzzz_1[j] + 0.5 * fl1_fx * tex_yz_zzz_0[j] -
                                    0.5 * fl1_fx * tex_yz_zzz_1[j] + ta_yz_xzzz_1[j];

                tey_xyz_xzzz_0[j] =
                    pa_x[j] * tey_yz_xzzz_0[j] - pc_x[j] * tey_yz_xzzz_1[j] + 0.5 * fl1_fx * tey_yz_zzz_0[j] - 0.5 * fl1_fx * tey_yz_zzz_1[j];

                tez_xyz_xzzz_0[j] =
                    pa_x[j] * tez_yz_xzzz_0[j] - pc_x[j] * tez_yz_xzzz_1[j] + 0.5 * fl1_fx * tez_yz_zzz_0[j] - 0.5 * fl1_fx * tez_yz_zzz_1[j];
                ...
                tex_xzz_xxxx_0[j] = pa_x[j] * tex_zz_xxxx_0[j] - pc_x[j] * tex_zz_xxxx_1[j] + 2.0 * fl1_fx * tex_zz_xxx_0[j] -
                                    2.0 * fl1_fx * tex_zz_xxx_1[j] + ta_zz_xxxx_1[j];

                tey_xzz_xxxx_0[j] =
                    pa_x[j] * tey_zz_xxxx_0[j] - pc_x[j] * tey_zz_xxxx_1[j] + 2.0 * fl1_fx * tey_zz_xxx_0[j] - 2.0 * fl1_fx * tey_zz_xxx_1[j];

                tez_xzz_xxxx_0[j] =
                    pa_x[j] * tez_zz_xxxx_0[j] - pc_x[j] * tez_zz_xxxx_1[j] + 2.0 * fl1_fx * tez_zz_xxx_0[j] - 2.0 * fl1_fx * tez_zz_xxx_1[j];

                tex_xzz_xxxy_0[j] = pa_x[j] * tex_zz_xxxy_0[j] - pc_x[j] * tex_zz_xxxy_1[j] + 1.5 * fl1_fx * tex_zz_xxy_0[j] -
                                    1.5 * fl1_fx * tex_zz_xxy_1[j] + ta_zz_xxxy_1[j];

                tey_xzz_xxxy_0[j] =
                    pa_x[j] * tey_zz_xxxy_0[j] - pc_x[j] * tey_zz_xxxy_1[j] + 1.5 * fl1_fx * tey_zz_xxy_0[j] - 1.5 * fl1_fx * tey_zz_xxy_1[j];

                tez_xzz_xxxy_0[j] =
                    pa_x[j] * tez_zz_xxxy_0[j] - pc_x[j] * tez_zz_xxxy_1[j] + 1.5 * fl1_fx * tez_zz_xxy_0[j] - 1.5 * fl1_fx * tez_zz_xxy_1[j];

                tex_xzz_xxxz_0[j] = pa_x[j] * tex_zz_xxxz_0[j] - pc_x[j] * tex_zz_xxxz_1[j] + 1.5 * fl1_fx * tex_zz_xxz_0[j] -
                                    1.5 * fl1_fx * tex_zz_xxz_1[j] + ta_zz_xxxz_1[j];

                tey_xzz_xxxz_0[j] =
                    pa_x[j] * tey_zz_xxxz_0[j] - pc_x[j] * tey_zz_xxxz_1[j] + 1.5 * fl1_fx * tey_zz_xxz_0[j] - 1.5 * fl1_fx * tey_zz_xxz_1[j];

                tez_xzz_xxxz_0[j] =
                    pa_x[j] * tez_zz_xxxz_0[j] - pc_x[j] * tez_zz_xxxz_1[j] + 1.5 * fl1_fx * tez_zz_xxz_0[j] - 1.5 * fl1_fx * tez_zz_xxz_1[j];

                tex_xzz_xxyy_0[j] =
                    pa_x[j] * tex_zz_xxyy_0[j] - pc_x[j] * tex_zz_xxyy_1[j] + fl1_fx * tex_zz_xyy_0[j] - fl1_fx * tex_zz_xyy_1[j] + ta_zz_xxyy_1[j];
                ...
                tex_xzz_xxyz_0[j] =
                    pa_x[j] * tex_zz_xxyz_0[j] - pc_x[j] * tex_zz_xxyz_1[j] + fl1_fx * tex_zz_xyz_0[j] - fl1_fx * tex_zz_xyz_1[j] + ta_zz_xxyz_1[j];
                ...
                tex_xzz_xxzz_0[j] =
                    pa_x[j] * tex_zz_xxzz_0[j] - pc_x[j] * tex_zz_xxzz_1[j] + fl1_fx * tex_zz_xzz_0[j] - fl1_fx * tex_zz_xzz_1[j] + ta_zz_xxzz_1[j];
                ...
                tex_xzz_xyyy_0[j] = pa_x[j] * tex_zz_xyyy_0[j] - pc_x[j] * tex_zz_xyyy_1[j] + 0.5 * fl1_fx * tex_zz_yyy_0[j] -
                                    0.5 * fl1_fx * tex_zz_yyy_1[j] + ta_zz_xyyy_1[j];

                tey_xzz_xyyy_0[j] =
                    pa_x[j] * tey_zz_xyyy_0[j] - pc_x[j] * tey_zz_xyyy_1[j] + 0.5 * fl1_fx * tey_zz_yyy_0[j] - 0.5 * fl1_fx * tey_zz_yyy_1[j];

                tez_xzz_xyyy_0[j] =
                    pa_x[j] * tez_zz_xyyy_0[j] - pc_x[j] * tez_zz_xyyy_1[j] + 0.5 * fl1_fx * tez_zz_yyy_0[j] - 0.5 * fl1_fx * tez_zz_yyy_1[j];

                tex_xzz_xyyz_0[j] = pa_x[j] * tex_zz_xyyz_0[j] - pc_x[j] * tex_zz_xyyz_1[j] + 0.5 * fl1_fx * tex_zz_yyz_0[j] -
                                    0.5 * fl1_fx * tex_zz_yyz_1[j] + ta_zz_xyyz_1[j];

                tey_xzz_xyyz_0[j] =
                    pa_x[j] * tey_zz_xyyz_0[j] - pc_x[j] * tey_zz_xyyz_1[j] + 0.5 * fl1_fx * tey_zz_yyz_0[j] - 0.5 * fl1_fx * tey_zz_yyz_1[j];

                tez_xzz_xyyz_0[j] =
                    pa_x[j] * tez_zz_xyyz_0[j] - pc_x[j] * tez_zz_xyyz_1[j] + 0.5 * fl1_fx * tez_zz_yyz_0[j] - 0.5 * fl1_fx * tez_zz_yyz_1[j];

                tex_xzz_xyzz_0[j] = pa_x[j] * tex_zz_xyzz_0[j] - pc_x[j] * tex_zz_xyzz_1[j] + 0.5 * fl1_fx * tex_zz_yzz_0[j] -
                                    0.5 * fl1_fx * tex_zz_yzz_1[j] + ta_zz_xyzz_1[j];
            }
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tey_xzz_xyzz_0[j] =
                    pa_x[j] * tey_zz_xyzz_0[j] - pc_x[j] * tey_zz_xyzz_1[j] + 0.5 * fl1_fx * tey_zz_yzz_0[j] - 0.5 * fl1_fx * tey_zz_yzz_1[j];

                tez_xzz_xyzz_0[j] =
                    pa_x[j] * tez_zz_xyzz_0[j] - pc_x[j] * tez_zz_xyzz_1[j] + 0.5 * fl1_fx * tez_zz_yzz_0[j] - 0.5 * fl1_fx * tez_zz_yzz_1[j];

                tex_xzz_xzzz_0[j] = pa_x[j] * tex_zz_xzzz_0[j] - pc_x[j] * tex_zz_xzzz_1[j] + 0.5 * fl1_fx * tex_zz_zzz_0[j] -
                                    0.5 * fl1_fx * tex_zz_zzz_1[j] + ta_zz_xzzz_1[j];

                tey_xzz_xzzz_0[j] =
                    pa_x[j] * tey_zz_xzzz_0[j] - pc_x[j] * tey_zz_xzzz_1[j] + 0.5 * fl1_fx * tey_zz_zzz_0[j] - 0.5 * fl1_fx * tey_zz_zzz_1[j];

                tez_xzz_xzzz_0[j] =
                    pa_x[j] * tez_zz_xzzz_0[j] - pc_x[j] * tez_zz_xzzz_1[j] + 0.5 * fl1_fx * tez_zz_zzz_0[j] - 0.5 * fl1_fx * tez_zz_zzz_1[j];
                ...
                tey_yyy_xxxx_0[j] =
                    pa_y[j] * tey_yy_xxxx_0[j] - pc_y[j] * tey_yy_xxxx_1[j] + fl1_fx * tey_y_xxxx_0[j] - fl1_fx * tey_y_xxxx_1[j] + ta_yy_xxxx_1[j];

                tez_yyy_xxxx_0[j] = pa_y[j] * tez_yy_xxxx_0[j] - pc_y[j] * tez_yy_xxxx_1[j] + fl1_fx * tez_y_xxxx_0[j] - fl1_fx * tez_y_xxxx_1[j];

                tex_yyy_xxxy_0[j] = pa_y[j] * tex_yy_xxxy_0[j] - pc_y[j] * tex_yy_xxxy_1[j] + fl1_fx * tex_y_xxxy_0[j] - fl1_fx * tex_y_xxxy_1[j] +
                                    0.5 * fl1_fx * tex_yy_xxx_0[j] - 0.5 * fl1_fx * tex_yy_xxx_1[j];

                tey_yyy_xxxy_0[j] = pa_y[j] * tey_yy_xxxy_0[j] - pc_y[j] * tey_yy_xxxy_1[j] + fl1_fx * tey_y_xxxy_0[j] - fl1_fx * tey_y_xxxy_1[j] +
                                    0.5 * fl1_fx * tey_yy_xxx_0[j] - 0.5 * fl1_fx * tey_yy_xxx_1[j] + ta_yy_xxxy_1[j];

                tez_yyy_xxxy_0[j] = pa_y[j] * tez_yy_xxxy_0[j] - pc_y[j] * tez_yy_xxxy_1[j] + fl1_fx * tez_y_xxxy_0[j] - fl1_fx * tez_y_xxxy_1[j] +
                                    0.5 * fl1_fx * tez_yy_xxx_0[j] - 0.5 * fl1_fx * tez_yy_xxx_1[j];

                tex_yyy_xxxz_0[j] = pa_y[j] * tex_yy_xxxz_0[j] - pc_y[j] * tex_yy_xxxz_1[j] + fl1_fx * tex_y_xxxz_0[j] - fl1_fx * tex_y_xxxz_1[j];

                tey_yyy_xxxz_0[j] =
                    pa_y[j] * tey_yy_xxxz_0[j] - pc_y[j] * tey_yy_xxxz_1[j] + fl1_fx * tey_y_xxxz_0[j] - fl1_fx * tey_y_xxxz_1[j] + ta_yy_xxxz_1[j];

                tez_yyy_xxxz_0[j] = pa_y[j] * tez_yy_xxxz_0[j] - pc_y[j] * tez_yy_xxxz_1[j] + fl1_fx * tez_y_xxxz_0[j] - fl1_fx * tez_y_xxxz_1[j];

                tex_yyy_xxyy_0[j] = pa_y[j] * tex_yy_xxyy_0[j] - pc_y[j] * tex_yy_xxyy_1[j] + fl1_fx * tex_y_xxyy_0[j] - fl1_fx * tex_y_xxyy_1[j] +
                                    fl1_fx * tex_yy_xxy_0[j] - fl1_fx * tex_yy_xxy_1[j];

                tey_yyy_xxyy_0[j] = pa_y[j] * tey_yy_xxyy_0[j] - pc_y[j] * tey_yy_xxyy_1[j] + fl1_fx * tey_y_xxyy_0[j] - fl1_fx * tey_y_xxyy_1[j] +
                                    fl1_fx * tey_yy_xxy_0[j] - fl1_fx * tey_yy_xxy_1[j] + ta_yy_xxyy_1[j];

                tez_yyy_xxyy_0[j] = pa_y[j] * tez_yy_xxyy_0[j] - pc_y[j] * tez_yy_xxyy_1[j] + fl1_fx * tez_y_xxyy_0[j] - fl1_fx * tez_y_xxyy_1[j] +
                                    fl1_fx * tez_yy_xxy_0[j] - fl1_fx * tez_yy_xxy_1[j];

                tex_yyy_xxyz_0[j] = pa_y[j] * tex_yy_xxyz_0[j] - pc_y[j] * tex_yy_xxyz_1[j] + fl1_fx * tex_y_xxyz_0[j] - fl1_fx * tex_y_xxyz_1[j] +
                                    0.5 * fl1_fx * tex_yy_xxz_0[j] - 0.5 * fl1_fx * tex_yy_xxz_1[j];

                tey_yyy_xxyz_0[j] = pa_y[j] * tey_yy_xxyz_0[j] - pc_y[j] * tey_yy_xxyz_1[j] + fl1_fx * tey_y_xxyz_0[j] - fl1_fx * tey_y_xxyz_1[j] +
                                    0.5 * fl1_fx * tey_yy_xxz_0[j] - 0.5 * fl1_fx * tey_yy_xxz_1[j] + ta_yy_xxyz_1[j];

                tez_yyy_xxyz_0[j] = pa_y[j] * tez_yy_xxyz_0[j] - pc_y[j] * tez_yy_xxyz_1[j] + fl1_fx * tez_y_xxyz_0[j] - fl1_fx * tez_y_xxyz_1[j] +
                                    0.5 * fl1_fx * tez_yy_xxz_0[j] - 0.5 * fl1_fx * tez_yy_xxz_1[j];

                tex_yyy_xxzz_0[j] = pa_y[j] * tex_yy_xxzz_0[j] - pc_y[j] * tex_yy_xxzz_1[j] + fl1_fx * tex_y_xxzz_0[j] - fl1_fx * tex_y_xxzz_1[j];

                tey_yyy_xxzz_0[j] =
                    pa_y[j] * tey_yy_xxzz_0[j] - pc_y[j] * tey_yy_xxzz_1[j] + fl1_fx * tey_y_xxzz_0[j] - fl1_fx * tey_y_xxzz_1[j] + ta_yy_xxzz_1[j];

                tez_yyy_xxzz_0[j] = pa_y[j] * tez_yy_xxzz_0[j] - pc_y[j] * tez_yy_xxzz_1[j] + fl1_fx * tez_y_xxzz_0[j] - fl1_fx * tez_y_xxzz_1[j];

                tex_yyy_xyyy_0[j] = pa_y[j] * tex_yy_xyyy_0[j] - pc_y[j] * tex_yy_xyyy_1[j] + fl1_fx * tex_y_xyyy_0[j] - fl1_fx * tex_y_xyyy_1[j] +
                                    1.5 * fl1_fx * tex_yy_xyy_0[j] - 1.5 * fl1_fx * tex_yy_xyy_1[j];

                tey_yyy_xyyy_0[j] = pa_y[j] * tey_yy_xyyy_0[j] - pc_y[j] * tey_yy_xyyy_1[j] + fl1_fx * tey_y_xyyy_0[j] - fl1_fx * tey_y_xyyy_1[j] +
                                    1.5 * fl1_fx * tey_yy_xyy_0[j] - 1.5 * fl1_fx * tey_yy_xyy_1[j] + ta_yy_xyyy_1[j];

                tez_yyy_xyyy_0[j] = pa_y[j] * tez_yy_xyyy_0[j] - pc_y[j] * tez_yy_xyyy_1[j] + fl1_fx * tez_y_xyyy_0[j] - fl1_fx * tez_y_xyyy_1[j] +
                                    1.5 * fl1_fx * tez_yy_xyy_0[j] - 1.5 * fl1_fx * tez_yy_xyy_1[j];

                tex_yyy_xyyz_0[j] = pa_y[j] * tex_yy_xyyz_0[j] - pc_y[j] * tex_yy_xyyz_1[j] + fl1_fx * tex_y_xyyz_0[j] - fl1_fx * tex_y_xyyz_1[j] +
                                    fl1_fx * tex_yy_xyz_0[j] - fl1_fx * tex_yy_xyz_1[j];

                tey_yyy_xyyz_0[j] = pa_y[j] * tey_yy_xyyz_0[j] - pc_y[j] * tey_yy_xyyz_1[j] + fl1_fx * tey_y_xyyz_0[j] - fl1_fx * tey_y_xyyz_1[j] +
                                    fl1_fx * tey_yy_xyz_0[j] - fl1_fx * tey_yy_xyz_1[j] + ta_yy_xyyz_1[j];

                tez_yyy_xyyz_0[j] = pa_y[j] * tez_yy_xyyz_0[j] - pc_y[j] * tez_yy_xyyz_1[j] + fl1_fx * tez_y_xyyz_0[j] - fl1_fx * tez_y_xyyz_1[j] +
                                    fl1_fx * tez_yy_xyz_0[j] - fl1_fx * tez_yy_xyz_1[j];

                tex_yyy_xyzz_0[j] = pa_y[j] * tex_yy_xyzz_0[j] - pc_y[j] * tex_yy_xyzz_1[j] + fl1_fx * tex_y_xyzz_0[j] - fl1_fx * tex_y_xyzz_1[j] +
                                    0.5 * fl1_fx * tex_yy_xzz_0[j] - 0.5 * fl1_fx * tex_yy_xzz_1[j];

                tey_yyy_xyzz_0[j] = pa_y[j] * tey_yy_xyzz_0[j] - pc_y[j] * tey_yy_xyzz_1[j] + fl1_fx * tey_y_xyzz_0[j] - fl1_fx * tey_y_xyzz_1[j] +
                                    0.5 * fl1_fx * tey_yy_xzz_0[j] - 0.5 * fl1_fx * tey_yy_xzz_1[j] + ta_yy_xyzz_1[j];

                tez_yyy_xyzz_0[j] = pa_y[j] * tez_yy_xyzz_0[j] - pc_y[j] * tez_yy_xyzz_1[j] + fl1_fx * tez_y_xyzz_0[j] - fl1_fx * tez_y_xyzz_1[j] +
                                    0.5 * fl1_fx * tez_yy_xzz_0[j] - 0.5 * fl1_fx * tez_yy_xzz_1[j];

                tex_yyy_xzzz_0[j] = pa_y[j] * tex_yy_xzzz_0[j] - pc_y[j] * tex_yy_xzzz_1[j] + fl1_fx * tex_y_xzzz_0[j] - fl1_fx * tex_y_xzzz_1[j];

                tey_yyy_xzzz_0[j] =
                    pa_y[j] * tey_yy_xzzz_0[j] - pc_y[j] * tey_yy_xzzz_1[j] + fl1_fx * tey_y_xzzz_0[j] - fl1_fx * tey_y_xzzz_1[j] + ta_yy_xzzz_1[j];
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tex_yyy_yyyy_0[j] = pa_y[j] * tex_yy_yyyy_0[j] - pc_y[j] * tex_yy_yyyy_1[j] + fl1_fx * tex_y_yyyy_0[j] - fl1_fx * tex_y_yyyy_1[j] +
                                    2.0 * fl1_fx * tex_yy_yyy_0[j] - 2.0 * fl1_fx * tex_yy_yyy_1[j];

                tey_yyy_yyyy_0[j] = pa_y[j] * tey_yy_yyyy_0[j] - pc_y[j] * tey_yy_yyyy_1[j] + fl1_fx * tey_y_yyyy_0[j] - fl1_fx * tey_y_yyyy_1[j] +
                                    2.0 * fl1_fx * tey_yy_yyy_0[j] - 2.0 * fl1_fx * tey_yy_yyy_1[j] + ta_yy_yyyy_1[j];

                tez_yyy_yyyy_0[j] = pa_y[j] * tez_yy_yyyy_0[j] - pc_y[j] * tez_yy_yyyy_1[j] + fl1_fx * tez_y_yyyy_0[j] - fl1_fx * tez_y_yyyy_1[j] +
                                    2.0 * fl1_fx * tez_yy_yyy_0[j] - 2.0 * fl1_fx * tez_yy_yyy_1[j];

                tex_yyy_yyyz_0[j] = pa_y[j] * tex_yy_yyyz_0[j] - pc_y[j] * tex_yy_yyyz_1[j] + fl1_fx * tex_y_yyyz_0[j] - fl1_fx * tex_y_yyyz_1[j] +
                                    1.5 * fl1_fx * tex_yy_yyz_0[j] - 1.5 * fl1_fx * tex_yy_yyz_1[j];

                tey_yyy_yyyz_0[j] = pa_y[j] * tey_yy_yyyz_0[j] - pc_y[j] * tey_yy_yyyz_1[j] + fl1_fx * tey_y_yyyz_0[j] - fl1_fx * tey_y_yyyz_1[j] +
                                    1.5 * fl1_fx * tey_yy_yyz_0[j] - 1.5 * fl1_fx * tey_yy_yyz_1[j] + ta_yy_yyyz_1[j];

                tez_yyy_yyyz_0[j] = pa_y[j] * tez_yy_yyyz_0[j] - pc_y[j] * tez_yy_yyyz_1[j] + fl1_fx * tez_y_yyyz_0[j] - fl1_fx * tez_y_yyyz_1[j] +
                                    1.5 * fl1_fx * tez_yy_yyz_0[j] - 1.5 * fl1_fx * tez_yy_yyz_1[j];

                tex_yyy_yyzz_0[j] = pa_y[j] * tex_yy_yyzz_0[j] - pc_y[j] * tex_yy_yyzz_1[j] + fl1_fx * tex_y_yyzz_0[j] - fl1_fx * tex_y_yyzz_1[j] +
                                    fl1_fx * tex_yy_yzz_0[j] - fl1_fx * tex_yy_yzz_1[j];

                tey_yyy_yyzz_0[j] = pa_y[j] * tey_yy_yyzz_0[j] - pc_y[j] * tey_yy_yyzz_1[j] + fl1_fx * tey_y_yyzz_0[j] - fl1_fx * tey_y_yyzz_1[j] +
                                    fl1_fx * tey_yy_yzz_0[j] - fl1_fx * tey_yy_yzz_1[j] + ta_yy_yyzz_1[j];

                tez_yyy_yyzz_0[j] = pa_y[j] * tez_yy_yyzz_0[j] - pc_y[j] * tez_yy_yyzz_1[j] + fl1_fx * tez_y_yyzz_0[j] - fl1_fx * tez_y_yyzz_1[j] +
                                    fl1_fx * tez_yy_yzz_0[j] - fl1_fx * tez_yy_yzz_1[j];

                tex_yyy_yzzz_0[j] = pa_y[j] * tex_yy_yzzz_0[j] - pc_y[j] * tex_yy_yzzz_1[j] + fl1_fx * tex_y_yzzz_0[j] - fl1_fx * tex_y_yzzz_1[j] +
                                    0.5 * fl1_fx * tex_yy_zzz_0[j] - 0.5 * fl1_fx * tex_yy_zzz_1[j];

                tey_yyy_yzzz_0[j] = pa_y[j] * tey_yy_yzzz_0[j] - pc_y[j] * tey_yy_yzzz_1[j] + fl1_fx * tey_y_yzzz_0[j] - fl1_fx * tey_y_yzzz_1[j] +
                                    0.5 * fl1_fx * tey_yy_zzz_0[j] - 0.5 * fl1_fx * tey_yy_zzz_1[j] + ta_yy_yzzz_1[j];

                tez_yyy_yzzz_0[j] = pa_y[j] * tez_yy_yzzz_0[j] - pc_y[j] * tez_yy_yzzz_1[j] + fl1_fx * tez_y_yzzz_0[j] - fl1_fx * tez_y_yzzz_1[j] +
                                    0.5 * fl1_fx * tez_yy_zzz_0[j] - 0.5 * fl1_fx * tez_yy_zzz_1[j];

                tex_yyy_zzzz_0[j] = pa_y[j] * tex_yy_zzzz_0[j] - pc_y[j] * tex_yy_zzzz_1[j] + fl1_fx * tex_y_zzzz_0[j] - fl1_fx * tex_y_zzzz_1[j];

                tey_yyy_zzzz_0[j] =
                    pa_y[j] * tey_yy_zzzz_0[j] - pc_y[j] * tey_yy_zzzz_1[j] + fl1_fx * tey_y_zzzz_0[j] - fl1_fx * tey_y_zzzz_1[j] + ta_yy_zzzz_1[j];

                tez_yyy_zzzz_0[j] = pa_y[j] * tez_yy_zzzz_0[j] - pc_y[j] * tez_yy_zzzz_1[j] + fl1_fx * tez_y_zzzz_0[j] - fl1_fx * tez_y_zzzz_1[j];

                tex_yyz_xxxx_0[j] =
                    pa_y[j] * tex_yz_xxxx_0[j] - pc_y[j] * tex_yz_xxxx_1[j] + 0.5 * fl1_fx * tex_z_xxxx_0[j] - 0.5 * fl1_fx * tex_z_xxxx_1[j];

                tey_yyz_xxxx_0[j] = pa_y[j] * tey_yz_xxxx_0[j] - pc_y[j] * tey_yz_xxxx_1[j] + 0.5 * fl1_fx * tey_z_xxxx_0[j] -
                                    0.5 * fl1_fx * tey_z_xxxx_1[j] + ta_yz_xxxx_1[j];

                tez_yyz_xxxx_0[j] =
                    pa_y[j] * tez_yz_xxxx_0[j] - pc_y[j] * tez_yz_xxxx_1[j] + 0.5 * fl1_fx * tez_z_xxxx_0[j] - 0.5 * fl1_fx * tez_z_xxxx_1[j];

                tex_yyz_xxxy_0[j] = pa_y[j] * tex_yz_xxxy_0[j] - pc_y[j] * tex_yz_xxxy_1[j] + 0.5 * fl1_fx * tex_z_xxxy_0[j] -
                                    0.5 * fl1_fx * tex_z_xxxy_1[j] + 0.5 * fl1_fx * tex_yz_xxx_0[j] - 0.5 * fl1_fx * tex_yz_xxx_1[j];

                tey_yyz_xxxy_0[j] = pa_y[j] * tey_yz_xxxy_0[j] - pc_y[j] * tey_yz_xxxy_1[j] + 0.5 * fl1_fx * tey_z_xxxy_0[j] -
                                    0.5 * fl1_fx * tey_z_xxxy_1[j] + 0.5 * fl1_fx * tey_yz_xxx_0[j] - 0.5 * fl1_fx * tey_yz_xxx_1[j] +
                                    ta_yz_xxxy_1[j];

                tez_yyz_xxxy_0[j] = pa_y[j] * tez_yz_xxxy_0[j] - pc_y[j] * tez_yz_xxxy_1[j] + 0.5 * fl1_fx * tez_z_xxxy_0[j] -
                                    0.5 * fl1_fx * tez_z_xxxy_1[j] + 0.5 * fl1_fx * tez_yz_xxx_0[j] - 0.5 * fl1_fx * tez_yz_xxx_1[j];

                tex_yyz_xxxz_0[j] =
                    pa_y[j] * tex_yz_xxxz_0[j] - pc_y[j] * tex_yz_xxxz_1[j] + 0.5 * fl1_fx * tex_z_xxxz_0[j] - 0.5 * fl1_fx * tex_z_xxxz_1[j];

                tey_yyz_xxxz_0[j] = pa_y[j] * tey_yz_xxxz_0[j] - pc_y[j] * tey_yz_xxxz_1[j] + 0.5 * fl1_fx * tey_z_xxxz_0[j] -
                                    0.5 * fl1_fx * tey_z_xxxz_1[j] + ta_yz_xxxz_1[j];

                tez_yyz_xxxz_0[j] =
                    pa_y[j] * tez_yz_xxxz_0[j] - pc_y[j] * tez_yz_xxxz_1[j] + 0.5 * fl1_fx * tez_z_xxxz_0[j] - 0.5 * fl1_fx * tez_z_xxxz_1[j];

                tex_yyz_xxyy_0[j] = pa_y[j] * tex_yz_xxyy_0[j] - pc_y[j] * tex_yz_xxyy_1[j] + 0.5 * fl1_fx * tex_z_xxyy_0[j] -
                                    0.5 * fl1_fx * tex_z_xxyy_1[j] + fl1_fx * tex_yz_xxy_0[j] - fl1_fx * tex_yz_xxy_1[j];

                tey_yyz_xxyy_0[j] = pa_y[j] * tey_yz_xxyy_0[j] - pc_y[j] * tey_yz_xxyy_1[j] + 0.5 * fl1_fx * tey_z_xxyy_0[j] -
                                    0.5 * fl1_fx * tey_z_xxyy_1[j] + fl1_fx * tey_yz_xxy_0[j] - fl1_fx * tey_yz_xxy_1[j] + ta_yz_xxyy_1[j];

                tez_yyz_xxyy_0[j] = pa_y[j] * tez_yz_xxyy_0[j] - pc_y[j] * tez_yz_xxyy_1[j] + 0.5 * fl1_fx * tez_z_xxyy_0[j] -
                                    0.5 * fl1_fx * tez_z_xxyy_1[j] + fl1_fx * tez_yz_xxy_0[j] - fl1_fx * tez_yz_xxy_1[j];

                tex_yyz_xxyz_0[j] = pa_y[j] * tex_yz_xxyz_0[j] - pc_y[j] * tex_yz_xxyz_1[j] + 0.5 * fl1_fx * tex_z_xxyz_0[j] -
                                    0.5 * fl1_fx * tex_z_xxyz_1[j] + 0.5 * fl1_fx * tex_yz_xxz_0[j] - 0.5 * fl1_fx * tex_yz_xxz_1[j];

                tey_yyz_xxyz_0[j] = pa_y[j] * tey_yz_xxyz_0[j] - pc_y[j] * tey_yz_xxyz_1[j] + 0.5 * fl1_fx * tey_z_xxyz_0[j] -
                                    0.5 * fl1_fx * tey_z_xxyz_1[j] + 0.5 * fl1_fx * tey_yz_xxz_0[j] - 0.5 * fl1_fx * tey_yz_xxz_1[j] +
                                    ta_yz_xxyz_1[j];

                tez_yyz_xxyz_0[j] = pa_y[j] * tez_yz_xxyz_0[j] - pc_y[j] * tez_yz_xxyz_1[j] + 0.5 * fl1_fx * tez_z_xxyz_0[j] -
                                    0.5 * fl1_fx * tez_z_xxyz_1[j] + 0.5 * fl1_fx * tez_yz_xxz_0[j] - 0.5 * fl1_fx * tez_yz_xxz_1[j];

                tex_yyz_xxzz_0[j] =
                    pa_y[j] * tex_yz_xxzz_0[j] - pc_y[j] * tex_yz_xxzz_1[j] + 0.5 * fl1_fx * tex_z_xxzz_0[j] - 0.5 * fl1_fx * tex_z_xxzz_1[j];

                tey_yyz_xxzz_0[j] = pa_y[j] * tey_yz_xxzz_0[j] - pc_y[j] * tey_yz_xxzz_1[j] + 0.5 * fl1_fx * tey_z_xxzz_0[j] -
                                    0.5 * fl1_fx * tey_z_xxzz_1[j] + ta_yz_xxzz_1[j];

                tez_yyz_xxzz_0[j] =
                    pa_y[j] * tez_yz_xxzz_0[j] - pc_y[j] * tez_yz_xxzz_1[j] + 0.5 * fl1_fx * tez_z_xxzz_0[j] - 0.5 * fl1_fx * tez_z_xxzz_1[j];

                tex_yyz_xyyy_0[j] = pa_y[j] * tex_yz_xyyy_0[j] - pc_y[j] * tex_yz_xyyy_1[j] + 0.5 * fl1_fx * tex_z_xyyy_0[j] -
                                    0.5 * fl1_fx * tex_z_xyyy_1[j] + 1.5 * fl1_fx * tex_yz_xyy_0[j] - 1.5 * fl1_fx * tex_yz_xyy_1[j];

                tey_yyz_xyyy_0[j] = pa_y[j] * tey_yz_xyyy_0[j] - pc_y[j] * tey_yz_xyyy_1[j] + 0.5 * fl1_fx * tey_z_xyyy_0[j] -
                                    0.5 * fl1_fx * tey_z_xyyy_1[j] + 1.5 * fl1_fx * tey_yz_xyy_0[j] - 1.5 * fl1_fx * tey_yz_xyy_1[j] +
                                    ta_yz_xyyy_1[j];

                tez_yyz_xyyy_0[j] = pa_y[j] * tez_yz_xyyy_0[j] - pc_y[j] * tez_yz_xyyy_1[j] + 0.5 * fl1_fx * tez_z_xyyy_0[j] -
                                    0.5 * fl1_fx * tez_z_xyyy_1[j] + 1.5 * fl1_fx * tez_yz_xyy_0[j] - 1.5 * fl1_fx * tez_yz_xyy_1[j];

                tex_yyz_xyyz_0[j] = pa_y[j] * tex_yz_xyyz_0[j] - pc_y[j] * tex_yz_xyyz_1[j] + 0.5 * fl1_fx * tex_z_xyyz_0[j] -
                                    0.5 * fl1_fx * tex_z_xyyz_1[j] + fl1_fx * tex_yz_xyz_0[j] - fl1_fx * tex_yz_xyz_1[j];

                tey_yyz_xyyz_0[j] = pa_y[j] * tey_yz_xyyz_0[j] - pc_y[j] * tey_yz_xyyz_1[j] + 0.5 * fl1_fx * tey_z_xyyz_0[j] -
                                    0.5 * fl1_fx * tey_z_xyyz_1[j] + fl1_fx * tey_yz_xyz_0[j] - fl1_fx * tey_yz_xyz_1[j] + ta_yz_xyyz_1[j];

                tez_yyz_xyyz_0[j] = pa_y[j] * tez_yz_xyyz_0[j] - pc_y[j] * tez_yz_xyyz_1[j] + 0.5 * fl1_fx * tez_z_xyyz_0[j] -
                                    0.5 * fl1_fx * tez_z_xyyz_1[j] + fl1_fx * tez_yz_xyz_0[j] - fl1_fx * tez_yz_xyz_1[j];

                tex_yyz_xyzz_0[j] = pa_y[j] * tex_yz_xyzz_0[j] - pc_y[j] * tex_yz_xyzz_1[j] + 0.5 * fl1_fx * tex_z_xyzz_0[j] -
                                    0.5 * fl1_fx * tex_z_xyzz_1[j] + 0.5 * fl1_fx * tex_yz_xzz_0[j] - 0.5 * fl1_fx * tex_yz_xzz_1[j];

                tey_yyz_xyzz_0[j] = pa_y[j] * tey_yz_xyzz_0[j] - pc_y[j] * tey_yz_xyzz_1[j] + 0.5 * fl1_fx * tey_z_xyzz_0[j] -
                                    0.5 * fl1_fx * tey_z_xyzz_1[j] + 0.5 * fl1_fx * tey_yz_xzz_0[j] - 0.5 * fl1_fx * tey_yz_xzz_1[j] +
                                    ta_yz_xyzz_1[j];

                tez_yyz_xyzz_0[j] = pa_y[j] * tez_yz_xyzz_0[j] - pc_y[j] * tez_yz_xyzz_1[j] + 0.5 * fl1_fx * tez_z_xyzz_0[j] -
                                    0.5 * fl1_fx * tez_z_xyzz_1[j] + 0.5 * fl1_fx * tez_yz_xzz_0[j] - 0.5 * fl1_fx * tez_yz_xzz_1[j];

                tex_yyz_xzzz_0[j] =
                    pa_y[j] * tex_yz_xzzz_0[j] - pc_y[j] * tex_yz_xzzz_1[j] + 0.5 * fl1_fx * tex_z_xzzz_0[j] - 0.5 * fl1_fx * tex_z_xzzz_1[j];

                tey_yyz_xzzz_0[j] = pa_y[j] * tey_yz_xzzz_0[j] - pc_y[j] * tey_yz_xzzz_1[j] + 0.5 * fl1_fx * tey_z_xzzz_0[j] -
                                    0.5 * fl1_fx * tey_z_xzzz_1[j] + ta_yz_xzzz_1[j];

                tez_yyz_xzzz_0[j] =
                    pa_y[j] * tez_yz_xzzz_0[j] - pc_y[j] * tez_yz_xzzz_1[j] + 0.5 * fl1_fx * tez_z_xzzz_0[j] - 0.5 * fl1_fx * tez_z_xzzz_1[j];

                tex_yyz_yyyy_0[j] = pa_y[j] * tex_yz_yyyy_0[j] - pc_y[j] * tex_yz_yyyy_1[j] + 0.5 * fl1_fx * tex_z_yyyy_0[j] -
                                    0.5 * fl1_fx * tex_z_yyyy_1[j] + 2.0 * fl1_fx * tex_yz_yyy_0[j] - 2.0 * fl1_fx * tex_yz_yyy_1[j];

                tey_yyz_yyyy_0[j] = pa_y[j] * tey_yz_yyyy_0[j] - pc_y[j] * tey_yz_yyyy_1[j] + 0.5 * fl1_fx * tey_z_yyyy_0[j] -
                                    0.5 * fl1_fx * tey_z_yyyy_1[j] + 2.0 * fl1_fx * tey_yz_yyy_0[j] - 2.0 * fl1_fx * tey_yz_yyy_1[j] +
                                    ta_yz_yyyy_1[j];

                tez_yyz_yyyy_0[j] = pa_y[j] * tez_yz_yyyy_0[j] - pc_y[j] * tez_yz_yyyy_1[j] + 0.5 * fl1_fx * tez_z_yyyy_0[j] -
                                    0.5 * fl1_fx * tez_z_yyyy_1[j] + 2.0 * fl1_fx * tez_yz_yyy_0[j] - 2.0 * fl1_fx * tez_yz_yyy_1[j];

                tex_yyz_yyyz_0[j] = pa_y[j] * tex_yz_yyyz_0[j] - pc_y[j] * tex_yz_yyyz_1[j] + 0.5 * fl1_fx * tex_z_yyyz_0[j] -
                                    0.5 * fl1_fx * tex_z_yyyz_1[j] + 1.5 * fl1_fx * tex_yz_yyz_0[j] - 1.5 * fl1_fx * tex_yz_yyz_1[j];

                tey_yyz_yyyz_0[j] = pa_y[j] * tey_yz_yyyz_0[j] - pc_y[j] * tey_yz_yyyz_1[j] + 0.5 * fl1_fx * tey_z_yyyz_0[j] -
                                    0.5 * fl1_fx * tey_z_yyyz_1[j] + 1.5 * fl1_fx * tey_yz_yyz_0[j] - 1.5 * fl1_fx * tey_yz_yyz_1[j] +
                                    ta_yz_yyyz_1[j];
            }
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tez_yyz_yyyz_0[j] = pa_y[j] * tez_yz_yyyz_0[j] - pc_y[j] * tez_yz_yyyz_1[j] + 0.5 * fl1_fx * tez_z_yyyz_0[j] -
                                    0.5 * fl1_fx * tez_z_yyyz_1[j] + 1.5 * fl1_fx * tez_yz_yyz_0[j] - 1.5 * fl1_fx * tez_yz_yyz_1[j];

                tex_yyz_yyzz_0[j] = pa_y[j] * tex_yz_yyzz_0[j] - pc_y[j] * tex_yz_yyzz_1[j] + 0.5 * fl1_fx * tex_z_yyzz_0[j] -
                                    0.5 * fl1_fx * tex_z_yyzz_1[j] + fl1_fx * tex_yz_yzz_0[j] - fl1_fx * tex_yz_yzz_1[j];

                tey_yyz_yyzz_0[j] = pa_y[j] * tey_yz_yyzz_0[j] - pc_y[j] * tey_yz_yyzz_1[j] + 0.5 * fl1_fx * tey_z_yyzz_0[j] -
                                    0.5 * fl1_fx * tey_z_yyzz_1[j] + fl1_fx * tey_yz_yzz_0[j] - fl1_fx * tey_yz_yzz_1[j] + ta_yz_yyzz_1[j];

                tez_yyz_yyzz_0[j] = pa_y[j] * tez_yz_yyzz_0[j] - pc_y[j] * tez_yz_yyzz_1[j] + 0.5 * fl1_fx * tez_z_yyzz_0[j] -
                                    0.5 * fl1_fx * tez_z_yyzz_1[j] + fl1_fx * tez_yz_yzz_0[j] - fl1_fx * tez_yz_yzz_1[j];

                tex_yyz_yzzz_0[j] = pa_y[j] * tex_yz_yzzz_0[j] - pc_y[j] * tex_yz_yzzz_1[j] + 0.5 * fl1_fx * tex_z_yzzz_0[j] -
                                    0.5 * fl1_fx * tex_z_yzzz_1[j] + 0.5 * fl1_fx * tex_yz_zzz_0[j] - 0.5 * fl1_fx * tex_yz_zzz_1[j];

                tey_yyz_yzzz_0[j] = pa_y[j] * tey_yz_yzzz_0[j] - pc_y[j] * tey_yz_yzzz_1[j] + 0.5 * fl1_fx * tey_z_yzzz_0[j] -
                                    0.5 * fl1_fx * tey_z_yzzz_1[j] + 0.5 * fl1_fx * tey_yz_zzz_0[j] - 0.5 * fl1_fx * tey_yz_zzz_1[j] +
                                    ta_yz_yzzz_1[j];

                tez_yyz_yzzz_0[j] = pa_y[j] * tez_yz_yzzz_0[j] - pc_y[j] * tez_yz_yzzz_1[j] + 0.5 * fl1_fx * tez_z_yzzz_0[j] -
                                    0.5 * fl1_fx * tez_z_yzzz_1[j] + 0.5 * fl1_fx * tez_yz_zzz_0[j] - 0.5 * fl1_fx * tez_yz_zzz_1[j];

                tex_yyz_zzzz_0[j] =
                    pa_y[j] * tex_yz_zzzz_0[j] - pc_y[j] * tex_yz_zzzz_1[j] + 0.5 * fl1_fx * tex_z_zzzz_0[j] - 0.5 * fl1_fx * tex_z_zzzz_1[j];

                tey_yyz_zzzz_0[j] = pa_y[j] * tey_yz_zzzz_0[j] - pc_y[j] * tey_yz_zzzz_1[j] + 0.5 * fl1_fx * tey_z_zzzz_0[j] -
                                    0.5 * fl1_fx * tey_z_zzzz_1[j] + ta_yz_zzzz_1[j];

                tez_yyz_zzzz_0[j] =
                    pa_y[j] * tez_yz_zzzz_0[j] - pc_y[j] * tez_yz_zzzz_1[j] + 0.5 * fl1_fx * tez_z_zzzz_0[j] - 0.5 * fl1_fx * tez_z_zzzz_1[j];
                ...
                tex_yzz_xxxy_0[j] =
                    pa_y[j] * tex_zz_xxxy_0[j] - pc_y[j] * tex_zz_xxxy_1[j] + 0.5 * fl1_fx * tex_zz_xxx_0[j] - 0.5 * fl1_fx * tex_zz_xxx_1[j];

                tey_yzz_xxxy_0[j] = pa_y[j] * tey_zz_xxxy_0[j] - pc_y[j] * tey_zz_xxxy_1[j] + 0.5 * fl1_fx * tey_zz_xxx_0[j] -
                                    0.5 * fl1_fx * tey_zz_xxx_1[j] + ta_zz_xxxy_1[j];

                tez_yzz_xxxy_0[j] =
                    pa_y[j] * tez_zz_xxxy_0[j] - pc_y[j] * tez_zz_xxxy_1[j] + 0.5 * fl1_fx * tez_zz_xxx_0[j] - 0.5 * fl1_fx * tez_zz_xxx_1[j];
                ...
                tey_yzz_xxyy_0[j] =
                    pa_y[j] * tey_zz_xxyy_0[j] - pc_y[j] * tey_zz_xxyy_1[j] + fl1_fx * tey_zz_xxy_0[j] - fl1_fx * tey_zz_xxy_1[j] + ta_zz_xxyy_1[j];

                tez_yzz_xxyy_0[j] = pa_y[j] * tez_zz_xxyy_0[j] - pc_y[j] * tez_zz_xxyy_1[j] + fl1_fx * tez_zz_xxy_0[j] - fl1_fx * tez_zz_xxy_1[j];

                tex_yzz_xxyz_0[j] =
                    pa_y[j] * tex_zz_xxyz_0[j] - pc_y[j] * tex_zz_xxyz_1[j] + 0.5 * fl1_fx * tex_zz_xxz_0[j] - 0.5 * fl1_fx * tex_zz_xxz_1[j];

                tey_yzz_xxyz_0[j] = pa_y[j] * tey_zz_xxyz_0[j] - pc_y[j] * tey_zz_xxyz_1[j] + 0.5 * fl1_fx * tey_zz_xxz_0[j] -
                                    0.5 * fl1_fx * tey_zz_xxz_1[j] + ta_zz_xxyz_1[j];

                tez_yzz_xxyz_0[j] =
                    pa_y[j] * tez_zz_xxyz_0[j] - pc_y[j] * tez_zz_xxyz_1[j] + 0.5 * fl1_fx * tez_zz_xxz_0[j] - 0.5 * fl1_fx * tez_zz_xxz_1[j];
                ...
                tex_yzz_xyyy_0[j] =
                    pa_y[j] * tex_zz_xyyy_0[j] - pc_y[j] * tex_zz_xyyy_1[j] + 1.5 * fl1_fx * tex_zz_xyy_0[j] - 1.5 * fl1_fx * tex_zz_xyy_1[j];

                tey_yzz_xyyy_0[j] = pa_y[j] * tey_zz_xyyy_0[j] - pc_y[j] * tey_zz_xyyy_1[j] + 1.5 * fl1_fx * tey_zz_xyy_0[j] -
                                    1.5 * fl1_fx * tey_zz_xyy_1[j] + ta_zz_xyyy_1[j];

                tez_yzz_xyyy_0[j] =
                    pa_y[j] * tez_zz_xyyy_0[j] - pc_y[j] * tez_zz_xyyy_1[j] + 1.5 * fl1_fx * tez_zz_xyy_0[j] - 1.5 * fl1_fx * tez_zz_xyy_1[j];

                tex_yzz_xyyz_0[j] = pa_y[j] * tex_zz_xyyz_0[j] - pc_y[j] * tex_zz_xyyz_1[j] + fl1_fx * tex_zz_xyz_0[j] - fl1_fx * tex_zz_xyz_1[j];

                tey_yzz_xyyz_0[j] =
                    pa_y[j] * tey_zz_xyyz_0[j] - pc_y[j] * tey_zz_xyyz_1[j] + fl1_fx * tey_zz_xyz_0[j] - fl1_fx * tey_zz_xyz_1[j] + ta_zz_xyyz_1[j];

                tez_yzz_xyyz_0[j] = pa_y[j] * tez_zz_xyyz_0[j] - pc_y[j] * tez_zz_xyyz_1[j] + fl1_fx * tez_zz_xyz_0[j] - fl1_fx * tez_zz_xyz_1[j];

                tex_yzz_xyzz_0[j] =
                    pa_y[j] * tex_zz_xyzz_0[j] - pc_y[j] * tex_zz_xyzz_1[j] + 0.5 * fl1_fx * tex_zz_xzz_0[j] - 0.5 * fl1_fx * tex_zz_xzz_1[j];

                tey_yzz_xyzz_0[j] = pa_y[j] * tey_zz_xyzz_0[j] - pc_y[j] * tey_zz_xyzz_1[j] + 0.5 * fl1_fx * tey_zz_xzz_0[j] -
                                    0.5 * fl1_fx * tey_zz_xzz_1[j] + ta_zz_xyzz_1[j];

                tez_yzz_xyzz_0[j] =
                    pa_y[j] * tez_zz_xyzz_0[j] - pc_y[j] * tez_zz_xyzz_1[j] + 0.5 * fl1_fx * tez_zz_xzz_0[j] - 0.5 * fl1_fx * tez_zz_xzz_1[j];
                ...
                tex_yzz_yyyy_0[j] =
                    pa_y[j] * tex_zz_yyyy_0[j] - pc_y[j] * tex_zz_yyyy_1[j] + 2.0 * fl1_fx * tex_zz_yyy_0[j] - 2.0 * fl1_fx * tex_zz_yyy_1[j];

                tey_yzz_yyyy_0[j] = pa_y[j] * tey_zz_yyyy_0[j] - pc_y[j] * tey_zz_yyyy_1[j] + 2.0 * fl1_fx * tey_zz_yyy_0[j] -
                                    2.0 * fl1_fx * tey_zz_yyy_1[j] + ta_zz_yyyy_1[j];

                tez_yzz_yyyy_0[j] =
                    pa_y[j] * tez_zz_yyyy_0[j] - pc_y[j] * tez_zz_yyyy_1[j] + 2.0 * fl1_fx * tez_zz_yyy_0[j] - 2.0 * fl1_fx * tez_zz_yyy_1[j];

                tex_yzz_yyyz_0[j] =
                    pa_y[j] * tex_zz_yyyz_0[j] - pc_y[j] * tex_zz_yyyz_1[j] + 1.5 * fl1_fx * tex_zz_yyz_0[j] - 1.5 * fl1_fx * tex_zz_yyz_1[j];

                tey_yzz_yyyz_0[j] = pa_y[j] * tey_zz_yyyz_0[j] - pc_y[j] * tey_zz_yyyz_1[j] + 1.5 * fl1_fx * tey_zz_yyz_0[j] -
                                    1.5 * fl1_fx * tey_zz_yyz_1[j] + ta_zz_yyyz_1[j];

                tez_yzz_yyyz_0[j] =
                    pa_y[j] * tez_zz_yyyz_0[j] - pc_y[j] * tez_zz_yyyz_1[j] + 1.5 * fl1_fx * tez_zz_yyz_0[j] - 1.5 * fl1_fx * tez_zz_yyz_1[j];

                tex_yzz_yyzz_0[j] = pa_y[j] * tex_zz_yyzz_0[j] - pc_y[j] * tex_zz_yyzz_1[j] + fl1_fx * tex_zz_yzz_0[j] - fl1_fx * tex_zz_yzz_1[j];

                tey_yzz_yyzz_0[j] =
                    pa_y[j] * tey_zz_yyzz_0[j] - pc_y[j] * tey_zz_yyzz_1[j] + fl1_fx * tey_zz_yzz_0[j] - fl1_fx * tey_zz_yzz_1[j] + ta_zz_yyzz_1[j];

                tez_yzz_yyzz_0[j] = pa_y[j] * tez_zz_yyzz_0[j] - pc_y[j] * tez_zz_yyzz_1[j] + fl1_fx * tez_zz_yzz_0[j] - fl1_fx * tez_zz_yzz_1[j];

                tex_yzz_yzzz_0[j] =
                    pa_y[j] * tex_zz_yzzz_0[j] - pc_y[j] * tex_zz_yzzz_1[j] + 0.5 * fl1_fx * tex_zz_zzz_0[j] - 0.5 * fl1_fx * tex_zz_zzz_1[j];
            }
    ...
    for (int32_t iord = 0; iord <= mord; iord++)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tey_yzz_yzzz_0[j] = pa_y[j] * tey_zz_yzzz_0[j] - pc_y[j] * tey_zz_yzzz_1[j] + 0.5 * fl1_fx * tey_zz_zzz_0[j] -
                                    0.5 * fl1_fx * tey_zz_zzz_1[j] + ta_zz_yzzz_1[j];

                tez_yzz_yzzz_0[j] =
                    pa_y[j] * tez_zz_yzzz_0[j] - pc_y[j] * tez_zz_yzzz_1[j] + 0.5 * fl1_fx * tez_zz_zzz_0[j] - 0.5 * fl1_fx * tez_zz_zzz_1[j];
                ...
                tez_zzz_xxxx_0[j] =
                    pa_z[j] * tez_zz_xxxx_0[j] - pc_z[j] * tez_zz_xxxx_1[j] + fl1_fx * tez_z_xxxx_0[j] - fl1_fx * tez_z_xxxx_1[j] + ta_zz_xxxx_1[j];
                ...
                tez_zzz_xxxy_0[j] =
                    pa_z[j] * tez_zz_xxxy_0[j] - pc_z[j] * tez_zz_xxxy_1[j] + fl1_fx * tez_z_xxxy_0[j] - fl1_fx * tez_z_xxxy_1[j] + ta_zz_xxxy_1[j];

                tex_zzz_xxxz_0[j] = pa_z[j] * tex_zz_xxxz_0[j] - pc_z[j] * tex_zz_xxxz_1[j] + fl1_fx * tex_z_xxxz_0[j] - fl1_fx * tex_z_xxxz_1[j] +
                                    0.5 * fl1_fx * tex_zz_xxx_0[j] - 0.5 * fl1_fx * tex_zz_xxx_1[j];

                tey_zzz_xxxz_0[j] = pa_z[j] * tey_zz_xxxz_0[j] - pc_z[j] * tey_zz_xxxz_1[j] + fl1_fx * tey_z_xxxz_0[j] - fl1_fx * tey_z_xxxz_1[j] +
                                    0.5 * fl1_fx * tey_zz_xxx_0[j] - 0.5 * fl1_fx * tey_zz_xxx_1[j];

                tez_zzz_xxxz_0[j] = pa_z[j] * tez_zz_xxxz_0[j] - pc_z[j] * tez_zz_xxxz_1[j] + fl1_fx * tez_z_xxxz_0[j] - fl1_fx * tez_z_xxxz_1[j] +
                                    0.5 * fl1_fx * tez_zz_xxx_0[j] - 0.5 * fl1_fx * tez_zz_xxx_1[j] + ta_zz_xxxz_1[j];
                ...
                tez_zzz_xxyy_0[j] =
                    pa_z[j] * tez_zz_xxyy_0[j] - pc_z[j] * tez_zz_xxyy_1[j] + fl1_fx * tez_z_xxyy_0[j] - fl1_fx * tez_z_xxyy_1[j] + ta_zz_xxyy_1[j];

                tex_zzz_xxyz_0[j] = pa_z[j] * tex_zz_xxyz_0[j] - pc_z[j] * tex_zz_xxyz_1[j] + fl1_fx * tex_z_xxyz_0[j] - fl1_fx * tex_z_xxyz_1[j] +
                                    0.5 * fl1_fx * tex_zz_xxy_0[j] - 0.5 * fl1_fx * tex_zz_xxy_1[j];

                tey_zzz_xxyz_0[j] = pa_z[j] * tey_zz_xxyz_0[j] - pc_z[j] * tey_zz_xxyz_1[j] + fl1_fx * tey_z_xxyz_0[j] - fl1_fx * tey_z_xxyz_1[j] +
                                    0.5 * fl1_fx * tey_zz_xxy_0[j] - 0.5 * fl1_fx * tey_zz_xxy_1[j];

                tez_zzz_xxyz_0[j] = pa_z[j] * tez_zz_xxyz_0[j] - pc_z[j] * tez_zz_xxyz_1[j] + fl1_fx * tez_z_xxyz_0[j] - fl1_fx * tez_z_xxyz_1[j] +
                                    0.5 * fl1_fx * tez_zz_xxy_0[j] - 0.5 * fl1_fx * tez_zz_xxy_1[j] + ta_zz_xxyz_1[j];

                tex_zzz_xxzz_0[j] = pa_z[j] * tex_zz_xxzz_0[j] - pc_z[j] * tex_zz_xxzz_1[j] + fl1_fx * tex_z_xxzz_0[j] - fl1_fx * tex_z_xxzz_1[j] +
                                    fl1_fx * tex_zz_xxz_0[j] - fl1_fx * tex_zz_xxz_1[j];

                tey_zzz_xxzz_0[j] = pa_z[j] * tey_zz_xxzz_0[j] - pc_z[j] * tey_zz_xxzz_1[j] + fl1_fx * tey_z_xxzz_0[j] - fl1_fx * tey_z_xxzz_1[j] +
                                    fl1_fx * tey_zz_xxz_0[j] - fl1_fx * tey_zz_xxz_1[j];

                tez_zzz_xxzz_0[j] = pa_z[j] * tez_zz_xxzz_0[j] - pc_z[j] * tez_zz_xxzz_1[j] + fl1_fx * tez_z_xxzz_0[j] - fl1_fx * tez_z_xxzz_1[j] +
                                    fl1_fx * tez_zz_xxz_0[j] - fl1_fx * tez_zz_xxz_1[j] + ta_zz_xxzz_1[j];
                ...
                tez_zzz_xyyy_0[j] =
                    pa_z[j] * tez_zz_xyyy_0[j] - pc_z[j] * tez_zz_xyyy_1[j] + fl1_fx * tez_z_xyyy_0[j] - fl1_fx * tez_z_xyyy_1[j] + ta_zz_xyyy_1[j];

                tex_zzz_xyyz_0[j] = pa_z[j] * tex_zz_xyyz_0[j] - pc_z[j] * tex_zz_xyyz_1[j] + fl1_fx * tex_z_xyyz_0[j] - fl1_fx * tex_z_xyyz_1[j] +
                                    0.5 * fl1_fx * tex_zz_xyy_0[j] - 0.5 * fl1_fx * tex_zz_xyy_1[j];

                tey_zzz_xyyz_0[j] = pa_z[j] * tey_zz_xyyz_0[j] - pc_z[j] * tey_zz_xyyz_1[j] + fl1_fx * tey_z_xyyz_0[j] - fl1_fx * tey_z_xyyz_1[j] +
                                    0.5 * fl1_fx * tey_zz_xyy_0[j] - 0.5 * fl1_fx * tey_zz_xyy_1[j];

                tez_zzz_xyyz_0[j] = pa_z[j] * tez_zz_xyyz_0[j] - pc_z[j] * tez_zz_xyyz_1[j] + fl1_fx * tez_z_xyyz_0[j] - fl1_fx * tez_z_xyyz_1[j] +
                                    0.5 * fl1_fx * tez_zz_xyy_0[j] - 0.5 * fl1_fx * tez_zz_xyy_1[j] + ta_zz_xyyz_1[j];

                tex_zzz_xyzz_0[j] = pa_z[j] * tex_zz_xyzz_0[j] - pc_z[j] * tex_zz_xyzz_1[j] + fl1_fx * tex_z_xyzz_0[j] - fl1_fx * tex_z_xyzz_1[j] +
                                    fl1_fx * tex_zz_xyz_0[j] - fl1_fx * tex_zz_xyz_1[j];

                tey_zzz_xyzz_0[j] = pa_z[j] * tey_zz_xyzz_0[j] - pc_z[j] * tey_zz_xyzz_1[j] + fl1_fx * tey_z_xyzz_0[j] - fl1_fx * tey_z_xyzz_1[j] +
                                    fl1_fx * tey_zz_xyz_0[j] - fl1_fx * tey_zz_xyz_1[j];

                tez_zzz_xyzz_0[j] = pa_z[j] * tez_zz_xyzz_0[j] - pc_z[j] * tez_zz_xyzz_1[j] + fl1_fx * tez_z_xyzz_0[j] - fl1_fx * tez_z_xyzz_1[j] +
                                    fl1_fx * tez_zz_xyz_0[j] - fl1_fx * tez_zz_xyz_1[j] + ta_zz_xyzz_1[j];

                tex_zzz_xzzz_0[j] = pa_z[j] * tex_zz_xzzz_0[j] - pc_z[j] * tex_zz_xzzz_1[j] + fl1_fx * tex_z_xzzz_0[j] - fl1_fx * tex_z_xzzz_1[j] +
                                    1.5 * fl1_fx * tex_zz_xzz_0[j] - 1.5 * fl1_fx * tex_zz_xzz_1[j];

                tey_zzz_xzzz_0[j] = pa_z[j] * tey_zz_xzzz_0[j] - pc_z[j] * tey_zz_xzzz_1[j] + fl1_fx * tey_z_xzzz_0[j] - fl1_fx * tey_z_xzzz_1[j] +
                                    1.5 * fl1_fx * tey_zz_xzz_0[j] - 1.5 * fl1_fx * tey_zz_xzz_1[j];

                tez_zzz_xzzz_0[j] = pa_z[j] * tez_zz_xzzz_0[j] - pc_z[j] * tez_zz_xzzz_1[j] + fl1_fx * tez_z_xzzz_0[j] - fl1_fx * tez_z_xzzz_1[j] +
                                    1.5 * fl1_fx * tez_zz_xzz_0[j] - 1.5 * fl1_fx * tez_zz_xzz_1[j] + ta_zz_xzzz_1[j];
                ...
                tez_zzz_yyyy_0[j] =
                    pa_z[j] * tez_zz_yyyy_0[j] - pc_z[j] * tez_zz_yyyy_1[j] + fl1_fx * tez_z_yyyy_0[j] - fl1_fx * tez_z_yyyy_1[j] + ta_zz_yyyy_1[j];

                tex_zzz_yyyz_0[j] = pa_z[j] * tex_zz_yyyz_0[j] - pc_z[j] * tex_zz_yyyz_1[j] + fl1_fx * tex_z_yyyz_0[j] - fl1_fx * tex_z_yyyz_1[j] +
                                    0.5 * fl1_fx * tex_zz_yyy_0[j] - 0.5 * fl1_fx * tex_zz_yyy_1[j];

                tey_zzz_yyyz_0[j] = pa_z[j] * tey_zz_yyyz_0[j] - pc_z[j] * tey_zz_yyyz_1[j] + fl1_fx * tey_z_yyyz_0[j] - fl1_fx * tey_z_yyyz_1[j] +
                                    0.5 * fl1_fx * tey_zz_yyy_0[j] - 0.5 * fl1_fx * tey_zz_yyy_1[j];

                tez_zzz_yyyz_0[j] = pa_z[j] * tez_zz_yyyz_0[j] - pc_z[j] * tez_zz_yyyz_1[j] + fl1_fx * tez_z_yyyz_0[j] - fl1_fx * tez_z_yyyz_1[j] +
                                    0.5 * fl1_fx * tez_zz_yyy_0[j] - 0.5 * fl1_fx * tez_zz_yyy_1[j] + ta_zz_yyyz_1[j];

                tex_zzz_yyzz_0[j] = pa_z[j] * tex_zz_yyzz_0[j] - pc_z[j] * tex_zz_yyzz_1[j] + fl1_fx * tex_z_yyzz_0[j] - fl1_fx * tex_z_yyzz_1[j] +
                                    fl1_fx * tex_zz_yyz_0[j] - fl1_fx * tex_zz_yyz_1[j];

                tey_zzz_yyzz_0[j] = pa_z[j] * tey_zz_yyzz_0[j] - pc_z[j] * tey_zz_yyzz_1[j] + fl1_fx * tey_z_yyzz_0[j] - fl1_fx * tey_z_yyzz_1[j] +
                                    fl1_fx * tey_zz_yyz_0[j] - fl1_fx * tey_zz_yyz_1[j];

                tez_zzz_yyzz_0[j] = pa_z[j] * tez_zz_yyzz_0[j] - pc_z[j] * tez_zz_yyzz_1[j] + fl1_fx * tez_z_yyzz_0[j] - fl1_fx * tez_z_yyzz_1[j] +
                                    fl1_fx * tez_zz_yyz_0[j] - fl1_fx * tez_zz_yyz_1[j] + ta_zz_yyzz_1[j];

                tex_zzz_yzzz_0[j] = pa_z[j] * tex_zz_yzzz_0[j] - pc_z[j] * tex_zz_yzzz_1[j] + fl1_fx * tex_z_yzzz_0[j] - fl1_fx * tex_z_yzzz_1[j] +
                                    1.5 * fl1_fx * tex_zz_yzz_0[j] - 1.5 * fl1_fx * tex_zz_yzz_1[j];

                tey_zzz_yzzz_0[j] = pa_z[j] * tey_zz_yzzz_0[j] - pc_z[j] * tey_zz_yzzz_1[j] + fl1_fx * tey_z_yzzz_0[j] - fl1_fx * tey_z_yzzz_1[j] +
                                    1.5 * fl1_fx * tey_zz_yzz_0[j] - 1.5 * fl1_fx * tey_zz_yzz_1[j];

                tez_zzz_yzzz_0[j] = pa_z[j] * tez_zz_yzzz_0[j] - pc_z[j] * tez_zz_yzzz_1[j] + fl1_fx * tez_z_yzzz_0[j] - fl1_fx * tez_z_yzzz_1[j] +
                                    1.5 * fl1_fx * tez_zz_yzz_0[j] - 1.5 * fl1_fx * tez_zz_yzz_1[j] + ta_zz_yzzz_1[j];

                tex_zzz_zzzz_0[j] = pa_z[j] * tex_zz_zzzz_0[j] - pc_z[j] * tex_zz_zzzz_1[j] + fl1_fx * tex_z_zzzz_0[j] - fl1_fx * tex_z_zzzz_1[j] +
                                    2.0 * fl1_fx * tex_zz_zzz_0[j] - 2.0 * fl1_fx * tex_zz_zzz_1[j];

                tey_zzz_zzzz_0[j] = pa_z[j] * tey_zz_zzzz_0[j] - pc_z[j] * tey_zz_zzzz_1[j] + fl1_fx * tey_z_zzzz_0[j] - fl1_fx * tey_z_zzzz_1[j] +
                                    2.0 * fl1_fx * tey_zz_zzz_0[j] - 2.0 * fl1_fx * tey_zz_zzz_1[j];

                tez_zzz_zzzz_0[j] = pa_z[j] * tez_zz_zzzz_0[j] - pc_z[j] * tez_zz_zzzz_1[j] + fl1_fx * tez_z_zzzz_0[j] - fl1_fx * tez_z_zzzz_1[j] +
                                    2.0 * fl1_fx * tez_zz_zzz_0[j] - 2.0 * fl1_fx * tez_zz_zzz_1[j] + ta_zz_zzzz_1[j];
            }
