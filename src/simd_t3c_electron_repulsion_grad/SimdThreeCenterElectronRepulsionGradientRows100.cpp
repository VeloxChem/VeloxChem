...
#include "SimdThreeCenterElectronRepulsionGeom100BufferRows.hpp"
...
auto
geom_100_buffer_rows(const int a_angular_momentum, const int b_angular_momentum, const int c_angular_momentum) -> size_t
{
    return simdt3ceri::number_of_geom_100_buffer_rows(a_angular_momentum, b_angular_momentum, c_angular_momentum);
}
