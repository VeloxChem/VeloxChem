#ifndef PrimitiveOverlapGeom301PD_Y_YY
#define PrimitiveOverlapGeom301PD_Y_YY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Y|1|d^(1)/dB^(1)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom301PD_Y_YY(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301PD_Y_YY */
