#ifndef PrimitiveOverlapGeom301SF_0_YYY
#define PrimitiveOverlapGeom301SF_0_YYY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)S_0|1|d^(1)/dB^(1)F_YYY> integrals.
...
*/
auto compPrimitiveOverlapGeom301SF_0_YYY(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301SF_0_YYY */
