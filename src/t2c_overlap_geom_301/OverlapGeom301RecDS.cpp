#include "OverlapGeom301RecDS.hpp"
...
#include "PrimitiveOverlapGeom301DS_XZ_0.hpp"
#include "PrimitiveOverlapGeom301DS_YY_0.hpp"
#include "PrimitiveOverlapGeom301DS_YZ_0.hpp"
#include "PrimitiveOverlapGeom301DS_ZZ_0.hpp"
#include "T2CDistributor.hpp"

namespace ovlrec {  // ovlrec namespace

auto
compOverlapGeom301DS(CSubMatrix*      matrix_xxx_x,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom301DS_XX_0(buffer_xxx_x,
                                                               buffer_xxx_y,
                                                               buffer_xxx_z,
                                                               buffer_xxy_x,
                                                               buffer_xxy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom301DS_XY_0(buffer_xxx_x,
                                                               buffer_xxx_y,
                                                               buffer_xxx_z,
                                                               buffer_xxy_x,
                                                               buffer_xxy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom301DS_XZ_0(buffer_xxx_x,
                                                               buffer_xxx_y,
                                                               buffer_xxx_z,
                                                               buffer_xxy_x,
                                                               buffer_xxy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom301DS_YY_0(buffer_xxx_x,
                                                               buffer_xxx_y,
                                                               buffer_xxx_z,
                                                               buffer_xxy_x,
                                                               buffer_xxy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom301DS_YZ_0(buffer_xxx_x,
                                                               buffer_xxx_y,
                                                               buffer_xxx_z,
                                                               buffer_xxy_x,
                                                               buffer_xxy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom301DS_ZZ_0(buffer_xxx_x,
                                                               buffer_xxx_y,
                                                               buffer_xxx_z,
                                                               buffer_xxy_x,
                                                               buffer_xxy_y,
