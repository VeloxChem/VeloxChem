#ifndef PrimitiveOverlapGeom301FF_XYY_XXZ
#define PrimitiveOverlapGeom301FF_XYY_XXZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XYY|1|d^(1)/dB^(1)F_XXZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301FF_XYY_XXZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FF_XYY_XXZ */
