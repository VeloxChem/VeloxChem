#ifndef PrimitiveOverlapGeom301FF_XZZ_XYZ
#define PrimitiveOverlapGeom301FF_XZZ_XYZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XZZ|1|d^(1)/dB^(1)F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301FF_XZZ_XYZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FF_XZZ_XYZ */
