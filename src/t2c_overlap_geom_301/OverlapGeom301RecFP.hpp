#ifndef OverlapGeom301RecFP_hpp
#define OverlapGeom301RecFP_hpp
...
/**
 Evaluates <d^(3)/dA^(3)F|1|d^(1)/dB^(1)P>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom301FP(CSubMatrix*      matrix_xxx_x,
