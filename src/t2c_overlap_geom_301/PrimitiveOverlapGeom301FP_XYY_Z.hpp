#ifndef PrimitiveOverlapGeom301FP_XYY_Z
#define PrimitiveOverlapGeom301FP_XYY_Z
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XYY|1|d^(1)/dB^(1)P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom301FP_XYY_Z(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FP_XYY_Z */
