#ifndef PrimitiveOverlapGeom301DF_XX_XXX
#define PrimitiveOverlapGeom301DF_XX_XXX
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XX|1|d^(1)/dB^(1)F_XXX> integrals.
...
*/
auto compPrimitiveOverlapGeom301DF_XX_XXX(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DF_XX_XXX */
