#ifndef PrimitiveOverlapGeom301FF_XXZ_XXX
#define PrimitiveOverlapGeom301FF_XXZ_XXX
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XXZ|1|d^(1)/dB^(1)F_XXX> integrals.
...
*/
auto compPrimitiveOverlapGeom301FF_XXZ_XXX(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FF_XXZ_XXX */
