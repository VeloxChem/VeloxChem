#ifndef PrimitiveOverlapGeom301FF_ZZZ_XXY
#define PrimitiveOverlapGeom301FF_ZZZ_XXY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_ZZZ|1|d^(1)/dB^(1)F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom301FF_ZZZ_XXY(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FF_ZZZ_XXY */
