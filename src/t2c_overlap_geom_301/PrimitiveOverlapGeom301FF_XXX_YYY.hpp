#ifndef PrimitiveOverlapGeom301FF_XXX_YYY
#define PrimitiveOverlapGeom301FF_XXX_YYY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XXX|1|d^(1)/dB^(1)F_YYY> integrals.
...
*/
auto compPrimitiveOverlapGeom301FF_XXX_YYY(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FF_XXX_YYY */
