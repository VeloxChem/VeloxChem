#ifndef PrimitiveOverlapGeom301SD_0_ZZ
#define PrimitiveOverlapGeom301SD_0_ZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)S_0|1|d^(1)/dB^(1)D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301SD_0_ZZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301SD_0_ZZ */
