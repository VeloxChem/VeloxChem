#ifndef PrimitiveOverlapGeom301DF_XY_XXX
#define PrimitiveOverlapGeom301DF_XY_XXX
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XY|1|d^(1)/dB^(1)F_XXX> integrals.
...
*/
auto compPrimitiveOverlapGeom301DF_XY_XXX(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DF_XY_XXX */
