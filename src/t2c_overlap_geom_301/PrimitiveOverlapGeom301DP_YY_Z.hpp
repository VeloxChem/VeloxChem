#ifndef PrimitiveOverlapGeom301DP_YY_Z
#define PrimitiveOverlapGeom301DP_YY_Z
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YY|1|d^(1)/dB^(1)P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom301DP_YY_Z(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DP_YY_Z */
