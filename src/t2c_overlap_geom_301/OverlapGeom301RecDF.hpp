#ifndef OverlapGeom301RecDF_hpp
#define OverlapGeom301RecDF_hpp
...
/**
 Evaluates <d^(3)/dA^(3)D|1|d^(1)/dB^(1)F>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom301DF(CSubMatrix*      matrix_xxx_x,
