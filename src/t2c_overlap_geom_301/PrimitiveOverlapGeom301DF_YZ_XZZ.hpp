#ifndef PrimitiveOverlapGeom301DF_YZ_XZZ
#define PrimitiveOverlapGeom301DF_YZ_XZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YZ|1|d^(1)/dB^(1)F_XZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301DF_YZ_XZZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DF_YZ_XZZ */
