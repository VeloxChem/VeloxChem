#ifndef PrimitiveOverlapGeom301DD_XZ_ZZ
#define PrimitiveOverlapGeom301DD_XZ_ZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XZ|1|d^(1)/dB^(1)D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301DD_XZ_ZZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DD_XZ_ZZ */
