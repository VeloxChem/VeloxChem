#ifndef PrimitiveOverlapGeom301PD_X_YZ
#define PrimitiveOverlapGeom301PD_X_YZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_X|1|d^(1)/dB^(1)D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301PD_X_YZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301PD_X_YZ */
