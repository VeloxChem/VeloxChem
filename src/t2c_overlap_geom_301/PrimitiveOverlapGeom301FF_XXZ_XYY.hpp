#ifndef PrimitiveOverlapGeom301FF_XXZ_XYY
#define PrimitiveOverlapGeom301FF_XXZ_XYY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XXZ|1|d^(1)/dB^(1)F_XYY> integrals.
...
*/
auto compPrimitiveOverlapGeom301FF_XXZ_XYY(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FF_XXZ_XYY */
