#ifndef PrimitiveOverlapGeom301FD_XYZ_YZ
#define PrimitiveOverlapGeom301FD_XYZ_YZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XYZ|1|d^(1)/dB^(1)D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301FD_XYZ_YZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FD_XYZ_YZ */
