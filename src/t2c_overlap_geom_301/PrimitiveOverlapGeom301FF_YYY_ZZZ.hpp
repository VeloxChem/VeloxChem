#ifndef PrimitiveOverlapGeom301FF_YYY_ZZZ
#define PrimitiveOverlapGeom301FF_YYY_ZZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_YYY|1|d^(1)/dB^(1)F_ZZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301FF_YYY_ZZZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FF_YYY_ZZZ */
