#ifndef OverlapGeom301RecPD_hpp
#define OverlapGeom301RecPD_hpp
...
/**
 Evaluates <d^(3)/dA^(3)P|1|d^(1)/dB^(1)D>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom301PD(CSubMatrix*      matrix_xxx_x,
