#ifndef PrimitiveOverlapGeom301PP_Z_X
#define PrimitiveOverlapGeom301PP_Z_X
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Z|1|d^(1)/dB^(1)P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom301PP_Z_X(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301PP_Z_X */
