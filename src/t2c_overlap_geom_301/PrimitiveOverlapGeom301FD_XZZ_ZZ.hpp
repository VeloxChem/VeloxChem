#ifndef PrimitiveOverlapGeom301FD_XZZ_ZZ
#define PrimitiveOverlapGeom301FD_XZZ_ZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XZZ|1|d^(1)/dB^(1)D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301FD_XZZ_ZZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FD_XZZ_ZZ */
