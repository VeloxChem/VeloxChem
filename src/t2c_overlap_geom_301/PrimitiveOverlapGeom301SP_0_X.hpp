#ifndef PrimitiveOverlapGeom301SP_0_X
#define PrimitiveOverlapGeom301SP_0_X
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)S_0|1|d^(1)/dB^(1)P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom301SP_0_X(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301SP_0_X */
