#ifndef PrimitiveOverlapGeom301DP_XY_Y
#define PrimitiveOverlapGeom301DP_XY_Y
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XY|1|d^(1)/dB^(1)P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom301DP_XY_Y(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DP_XY_Y */
