#ifndef OverlapGeom301RecPP_hpp
#define OverlapGeom301RecPP_hpp
...
/**
 Evaluates <d^(3)/dA^(3)P|1|d^(1)/dB^(1)P>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom301PP(CSubMatrix*      matrix_xxx_x,
