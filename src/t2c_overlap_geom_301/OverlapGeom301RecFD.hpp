#ifndef OverlapGeom301RecFD_hpp
#define OverlapGeom301RecFD_hpp
...
/**
 Evaluates <d^(3)/dA^(3)F|1|d^(1)/dB^(1)D>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom301FD(CSubMatrix*      matrix_xxx_x,
