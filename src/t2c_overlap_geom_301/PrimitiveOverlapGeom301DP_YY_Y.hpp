#ifndef PrimitiveOverlapGeom301DP_YY_Y
#define PrimitiveOverlapGeom301DP_YY_Y
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YY|1|d^(1)/dB^(1)P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom301DP_YY_Y(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DP_YY_Y */
