#ifndef PrimitiveOverlapGeom301DF_XY_YZZ
#define PrimitiveOverlapGeom301DF_XY_YZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XY|1|d^(1)/dB^(1)F_YZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301DF_XY_YZZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DF_XY_YZZ */
