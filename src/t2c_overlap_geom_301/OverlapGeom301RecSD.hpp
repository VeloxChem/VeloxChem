#ifndef OverlapGeom301RecSD_hpp
#define OverlapGeom301RecSD_hpp
...
/**
 Evaluates <d^(3)/dA^(3)S|1|d^(1)/dB^(1)D>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom301SD(CSubMatrix*      matrix_xxx_x,
