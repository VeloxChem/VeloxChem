#ifndef OverlapGeom301RecPF_hpp
#define OverlapGeom301RecPF_hpp
...
/**
 Evaluates <d^(3)/dA^(3)P|1|d^(1)/dB^(1)F>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom301PF(CSubMatrix*      matrix_xxx_x,
