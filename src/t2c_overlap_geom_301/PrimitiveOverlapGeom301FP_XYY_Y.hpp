#ifndef PrimitiveOverlapGeom301FP_XYY_Y
#define PrimitiveOverlapGeom301FP_XYY_Y
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XYY|1|d^(1)/dB^(1)P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom301FP_XYY_Y(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FP_XYY_Y */
