#ifndef PrimitiveOverlapGeom301DF_ZZ_XZZ
#define PrimitiveOverlapGeom301DF_ZZ_XZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_ZZ|1|d^(1)/dB^(1)F_XZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301DF_ZZ_XZZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DF_ZZ_XZZ */
