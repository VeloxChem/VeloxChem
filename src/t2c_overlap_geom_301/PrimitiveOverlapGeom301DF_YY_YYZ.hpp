#ifndef PrimitiveOverlapGeom301DF_YY_YYZ
#define PrimitiveOverlapGeom301DF_YY_YYZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YY|1|d^(1)/dB^(1)F_YYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301DF_YY_YYZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DF_YY_YYZ */
