#ifndef PrimitiveOverlapGeom301PD_Y_ZZ
#define PrimitiveOverlapGeom301PD_Y_ZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Y|1|d^(1)/dB^(1)D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301PD_Y_ZZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301PD_Y_ZZ */
