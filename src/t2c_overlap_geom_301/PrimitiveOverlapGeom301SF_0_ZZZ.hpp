#ifndef PrimitiveOverlapGeom301SF_0_ZZZ
#define PrimitiveOverlapGeom301SF_0_ZZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)S_0|1|d^(1)/dB^(1)F_ZZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301SF_0_ZZZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301SF_0_ZZZ */
