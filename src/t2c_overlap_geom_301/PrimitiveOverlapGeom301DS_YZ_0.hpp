#ifndef PrimitiveOverlapGeom301DS_YZ_0
#define PrimitiveOverlapGeom301DS_YZ_0
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YZ|1|d^(1)/dB^(1)S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom301DS_YZ_0(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DS_YZ_0 */
