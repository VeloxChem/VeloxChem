#ifndef PrimitiveOverlapGeom301DF_YY_XXX
#define PrimitiveOverlapGeom301DF_YY_XXX
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YY|1|d^(1)/dB^(1)F_XXX> integrals.
...
*/
auto compPrimitiveOverlapGeom301DF_YY_XXX(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DF_YY_XXX */
