#ifndef PrimitiveOverlapGeom301FP_XXX_Y
#define PrimitiveOverlapGeom301FP_XXX_Y
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XXX|1|d^(1)/dB^(1)P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom301FP_XXX_Y(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FP_XXX_Y */
