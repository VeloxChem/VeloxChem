#ifndef PrimitiveOverlapGeom301DD_YY_ZZ
#define PrimitiveOverlapGeom301DD_YY_ZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YY|1|d^(1)/dB^(1)D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301DD_YY_ZZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DD_YY_ZZ */
