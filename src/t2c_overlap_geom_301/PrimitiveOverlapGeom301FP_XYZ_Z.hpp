#ifndef PrimitiveOverlapGeom301FP_XYZ_Z
#define PrimitiveOverlapGeom301FP_XYZ_Z
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XYZ|1|d^(1)/dB^(1)P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom301FP_XYZ_Z(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FP_XYZ_Z */
