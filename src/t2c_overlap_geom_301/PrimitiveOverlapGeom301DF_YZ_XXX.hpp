#ifndef PrimitiveOverlapGeom301DF_YZ_XXX
#define PrimitiveOverlapGeom301DF_YZ_XXX
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YZ|1|d^(1)/dB^(1)F_XXX> integrals.
...
*/
auto compPrimitiveOverlapGeom301DF_YZ_XXX(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DF_YZ_XXX */
