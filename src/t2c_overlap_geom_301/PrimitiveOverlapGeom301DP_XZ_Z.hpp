#ifndef PrimitiveOverlapGeom301DP_XZ_Z
#define PrimitiveOverlapGeom301DP_XZ_Z
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XZ|1|d^(1)/dB^(1)P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom301DP_XZ_Z(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DP_XZ_Z */
