#ifndef PrimitiveOverlapGeom301DD_ZZ_XZ
#define PrimitiveOverlapGeom301DD_ZZ_XZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_ZZ|1|d^(1)/dB^(1)D_XZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301DD_ZZ_XZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DD_ZZ_XZ */
