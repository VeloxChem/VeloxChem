#ifndef PrimitiveOverlapGeom301PF_Z_YZZ
#define PrimitiveOverlapGeom301PF_Z_YZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Z|1|d^(1)/dB^(1)F_YZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301PF_Z_YZZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301PF_Z_YZZ */
