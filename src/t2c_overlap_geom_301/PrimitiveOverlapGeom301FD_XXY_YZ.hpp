#ifndef PrimitiveOverlapGeom301FD_XXY_YZ
#define PrimitiveOverlapGeom301FD_XXY_YZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XXY|1|d^(1)/dB^(1)D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301FD_XXY_YZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FD_XXY_YZ */
