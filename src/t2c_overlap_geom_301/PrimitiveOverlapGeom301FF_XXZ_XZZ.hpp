#ifndef PrimitiveOverlapGeom301FF_XXZ_XZZ
#define PrimitiveOverlapGeom301FF_XXZ_XZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XXZ|1|d^(1)/dB^(1)F_XZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301FF_XXZ_XZZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FF_XXZ_XZZ */
