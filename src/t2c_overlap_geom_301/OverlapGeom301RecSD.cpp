#include "OverlapGeom301RecSD.hpp"
...
#include "PrimitiveOverlapGeom301SD_0_XZ.hpp"
#include "PrimitiveOverlapGeom301SD_0_YY.hpp"
#include "PrimitiveOverlapGeom301SD_0_YZ.hpp"
#include "PrimitiveOverlapGeom301SD_0_ZZ.hpp"
#include "T2CDistributor.hpp"

namespace ovlrec {  // ovlrec namespace

auto
compOverlapGeom301SD(CSubMatrix*      matrix_xxx_x,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom301SD_0_XX(buffer_xxx_x,
                                                               buffer_xxx_y,
                                                               buffer_xxx_z,
                                                               buffer_xxy_x,
                                                               buffer_xxy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom301SD_0_XY(buffer_xxx_x,
                                                               buffer_xxx_y,
                                                               buffer_xxx_z,
                                                               buffer_xxy_x,
                                                               buffer_xxy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom301SD_0_XZ(buffer_xxx_x,
                                                               buffer_xxx_y,
                                                               buffer_xxx_z,
                                                               buffer_xxy_x,
                                                               buffer_xxy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom301SD_0_YY(buffer_xxx_x,
                                                               buffer_xxx_y,
                                                               buffer_xxx_z,
                                                               buffer_xxy_x,
                                                               buffer_xxy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom301SD_0_YZ(buffer_xxx_x,
                                                               buffer_xxx_y,
                                                               buffer_xxx_z,
                                                               buffer_xxy_x,
                                                               buffer_xxy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom301SD_0_ZZ(buffer_xxx_x,
                                                               buffer_xxx_y,
                                                               buffer_xxx_z,
                                                               buffer_xxy_x,
                                                               buffer_xxy_y,
