#ifndef PrimitiveOverlapGeom301DD_XZ_YZ
#define PrimitiveOverlapGeom301DD_XZ_YZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XZ|1|d^(1)/dB^(1)D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301DD_XZ_YZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DD_XZ_YZ */
