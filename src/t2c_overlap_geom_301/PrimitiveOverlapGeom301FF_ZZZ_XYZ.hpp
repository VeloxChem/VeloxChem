#ifndef PrimitiveOverlapGeom301FF_ZZZ_XYZ
#define PrimitiveOverlapGeom301FF_ZZZ_XYZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_ZZZ|1|d^(1)/dB^(1)F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301FF_ZZZ_XYZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FF_ZZZ_XYZ */
