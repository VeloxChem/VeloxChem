#ifndef PrimitiveOverlapGeom301DP_YY_X
#define PrimitiveOverlapGeom301DP_YY_X
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YY|1|d^(1)/dB^(1)P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom301DP_YY_X(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DP_YY_X */
