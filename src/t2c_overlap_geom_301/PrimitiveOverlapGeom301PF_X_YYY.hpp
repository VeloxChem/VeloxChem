#ifndef PrimitiveOverlapGeom301PF_X_YYY
#define PrimitiveOverlapGeom301PF_X_YYY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_X|1|d^(1)/dB^(1)F_YYY> integrals.
...
*/
auto compPrimitiveOverlapGeom301PF_X_YYY(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301PF_X_YYY */
