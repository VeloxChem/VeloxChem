#ifndef PrimitiveOverlapGeom301DF_ZZ_ZZZ
#define PrimitiveOverlapGeom301DF_ZZ_ZZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_ZZ|1|d^(1)/dB^(1)F_ZZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301DF_ZZ_ZZZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DF_ZZ_ZZZ */
