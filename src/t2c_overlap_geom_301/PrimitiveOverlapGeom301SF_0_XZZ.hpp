#ifndef PrimitiveOverlapGeom301SF_0_XZZ
#define PrimitiveOverlapGeom301SF_0_XZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)S_0|1|d^(1)/dB^(1)F_XZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301SF_0_XZZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301SF_0_XZZ */
