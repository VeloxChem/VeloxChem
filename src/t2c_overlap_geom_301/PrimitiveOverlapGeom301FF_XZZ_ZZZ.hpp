#ifndef PrimitiveOverlapGeom301FF_XZZ_ZZZ
#define PrimitiveOverlapGeom301FF_XZZ_ZZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XZZ|1|d^(1)/dB^(1)F_ZZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301FF_XZZ_ZZZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FF_XZZ_ZZZ */
