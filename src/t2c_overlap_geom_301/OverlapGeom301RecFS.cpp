#include "OverlapGeom301RecFS.hpp"
...
auto
compOverlapGeom301FS(CSubMatrix*      matrix_xxx_x,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom301FS_XXX_0(buffer_xxx_x,
                                                                buffer_xxx_y,
                                                                buffer_xxx_z,
                                                                buffer_xxy_x,
                                                                buffer_xxy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom301FS_XXY_0(buffer_xxx_x,
                                                                buffer_xxx_y,
                                                                buffer_xxx_z,
                                                                buffer_xxy_x,
                                                                buffer_xxy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom301FS_XXZ_0(buffer_xxx_x,
                                                                buffer_xxx_y,
                                                                buffer_xxx_z,
                                                                buffer_xxy_x,
                                                                buffer_xxy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom301FS_XYY_0(buffer_xxx_x,
                                                                buffer_xxx_y,
                                                                buffer_xxx_z,
                                                                buffer_xxy_x,
                                                                buffer_xxy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom301FS_XYZ_0(buffer_xxx_x,
                                                                buffer_xxx_y,
                                                                buffer_xxx_z,
                                                                buffer_xxy_x,
                                                                buffer_xxy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom301FS_XZZ_0(buffer_xxx_x,
                                                                buffer_xxx_y,
                                                                buffer_xxx_z,
                                                                buffer_xxy_x,
                                                                buffer_xxy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom301FS_YYY_0(buffer_xxx_x,
                                                                buffer_xxx_y,
                                                                buffer_xxx_z,
                                                                buffer_xxy_x,
                                                                buffer_xxy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom301FS_YYZ_0(buffer_xxx_x,
                                                                buffer_xxx_y,
                                                                buffer_xxx_z,
                                                                buffer_xxy_x,
                                                                buffer_xxy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom301FS_YZZ_0(buffer_xxx_x,
                                                                buffer_xxx_y,
                                                                buffer_xxx_z,
                                                                buffer_xxy_x,
                                                                buffer_xxy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom301FS_ZZZ_0(buffer_xxx_x,
                                                                buffer_xxx_y,
                                                                buffer_xxx_z,
                                                                buffer_xxy_x,
                                                                buffer_xxy_y,
