#ifndef PrimitiveOverlapGeom301FP_YYY_Z
#define PrimitiveOverlapGeom301FP_YYY_Z
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_YYY|1|d^(1)/dB^(1)P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom301FP_YYY_Z(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FP_YYY_Z */
