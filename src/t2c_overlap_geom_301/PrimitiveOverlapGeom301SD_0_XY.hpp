#ifndef PrimitiveOverlapGeom301SD_0_XY
#define PrimitiveOverlapGeom301SD_0_XY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)S_0|1|d^(1)/dB^(1)D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom301SD_0_XY(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301SD_0_XY */
