#ifndef PrimitiveOverlapGeom301SP_0_Z
#define PrimitiveOverlapGeom301SP_0_Z
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)S_0|1|d^(1)/dB^(1)P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom301SP_0_Z(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301SP_0_Z */
