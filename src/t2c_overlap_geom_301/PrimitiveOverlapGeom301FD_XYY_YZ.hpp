#ifndef PrimitiveOverlapGeom301FD_XYY_YZ
#define PrimitiveOverlapGeom301FD_XYY_YZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XYY|1|d^(1)/dB^(1)D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301FD_XYY_YZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FD_XYY_YZ */
