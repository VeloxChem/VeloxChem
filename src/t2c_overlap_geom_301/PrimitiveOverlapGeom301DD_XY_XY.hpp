#ifndef PrimitiveOverlapGeom301DD_XY_XY
#define PrimitiveOverlapGeom301DD_XY_XY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XY|1|d^(1)/dB^(1)D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom301DD_XY_XY(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DD_XY_XY */
