#ifndef PrimitiveOverlapGeom301FF_YYY_XXX
#define PrimitiveOverlapGeom301FF_YYY_XXX
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_YYY|1|d^(1)/dB^(1)F_XXX> integrals.
...
*/
auto compPrimitiveOverlapGeom301FF_YYY_XXX(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FF_YYY_XXX */
