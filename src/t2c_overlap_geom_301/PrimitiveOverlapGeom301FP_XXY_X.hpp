#ifndef PrimitiveOverlapGeom301FP_XXY_X
#define PrimitiveOverlapGeom301FP_XXY_X
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XXY|1|d^(1)/dB^(1)P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom301FP_XXY_X(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FP_XXY_X */
