#ifndef PrimitiveOverlapGeom301PF_X_YYZ
#define PrimitiveOverlapGeom301PF_X_YYZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_X|1|d^(1)/dB^(1)F_YYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301PF_X_YYZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301PF_X_YYZ */
