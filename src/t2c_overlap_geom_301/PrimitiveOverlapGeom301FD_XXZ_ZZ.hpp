#ifndef PrimitiveOverlapGeom301FD_XXZ_ZZ
#define PrimitiveOverlapGeom301FD_XXZ_ZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XXZ|1|d^(1)/dB^(1)D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301FD_XXZ_ZZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FD_XXZ_ZZ */
