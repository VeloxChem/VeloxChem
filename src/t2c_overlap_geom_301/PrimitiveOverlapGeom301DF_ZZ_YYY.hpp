#ifndef PrimitiveOverlapGeom301DF_ZZ_YYY
#define PrimitiveOverlapGeom301DF_ZZ_YYY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_ZZ|1|d^(1)/dB^(1)F_YYY> integrals.
...
*/
auto compPrimitiveOverlapGeom301DF_ZZ_YYY(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DF_ZZ_YYY */
