#ifndef PrimitiveOverlapGeom301PF_X_YZZ
#define PrimitiveOverlapGeom301PF_X_YZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_X|1|d^(1)/dB^(1)F_YZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301PF_X_YZZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301PF_X_YZZ */
