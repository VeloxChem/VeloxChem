#ifndef PrimitiveOverlapGeom301FF_XXZ_XXZ
#define PrimitiveOverlapGeom301FF_XXZ_XXZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XXZ|1|d^(1)/dB^(1)F_XXZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301FF_XXZ_XXZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FF_XXZ_XXZ */
