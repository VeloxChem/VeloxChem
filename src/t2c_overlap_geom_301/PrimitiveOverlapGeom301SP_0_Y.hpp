#ifndef PrimitiveOverlapGeom301SP_0_Y
#define PrimitiveOverlapGeom301SP_0_Y
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)S_0|1|d^(1)/dB^(1)P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom301SP_0_Y(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301SP_0_Y */
