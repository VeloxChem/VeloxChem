#ifndef PrimitiveOverlapGeom301FF_XXZ_YYZ
#define PrimitiveOverlapGeom301FF_XXZ_YYZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XXZ|1|d^(1)/dB^(1)F_YYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301FF_XXZ_YYZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FF_XXZ_YYZ */
