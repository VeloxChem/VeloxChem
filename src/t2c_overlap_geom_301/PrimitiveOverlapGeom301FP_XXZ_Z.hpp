#ifndef PrimitiveOverlapGeom301FP_XXZ_Z
#define PrimitiveOverlapGeom301FP_XXZ_Z
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XXZ|1|d^(1)/dB^(1)P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom301FP_XXZ_Z(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FP_XXZ_Z */
