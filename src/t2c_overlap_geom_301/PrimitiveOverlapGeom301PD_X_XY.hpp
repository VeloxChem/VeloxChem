#ifndef PrimitiveOverlapGeom301PD_X_XY
#define PrimitiveOverlapGeom301PD_X_XY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_X|1|d^(1)/dB^(1)D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom301PD_X_XY(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301PD_X_XY */
