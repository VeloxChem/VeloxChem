#ifndef PrimitiveOverlapGeom301DD_YZ_XY
#define PrimitiveOverlapGeom301DD_YZ_XY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YZ|1|d^(1)/dB^(1)D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom301DD_YZ_XY(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DD_YZ_XY */
