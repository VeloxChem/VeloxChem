#ifndef PrimitiveOverlapGeom301DP_YZ_Y
#define PrimitiveOverlapGeom301DP_YZ_Y
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YZ|1|d^(1)/dB^(1)P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom301DP_YZ_Y(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DP_YZ_Y */
