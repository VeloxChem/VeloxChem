#ifndef OverlapGeom301RecDD_hpp
#define OverlapGeom301RecDD_hpp
...
/**
 Evaluates <d^(3)/dA^(3)D|1|d^(1)/dB^(1)D>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom301DD(CSubMatrix*      matrix_xxx_x,
