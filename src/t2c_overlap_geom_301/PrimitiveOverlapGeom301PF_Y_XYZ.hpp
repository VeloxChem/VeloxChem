#ifndef PrimitiveOverlapGeom301PF_Y_XYZ
#define PrimitiveOverlapGeom301PF_Y_XYZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Y|1|d^(1)/dB^(1)F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301PF_Y_XYZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301PF_Y_XYZ */
