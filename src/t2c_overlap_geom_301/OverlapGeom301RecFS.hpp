#ifndef OverlapGeom301RecFS_hpp
#define OverlapGeom301RecFS_hpp
...
/**
 Evaluates <d^(3)/dA^(3)F|1|d^(1)/dB^(1)S>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom301FS(CSubMatrix*      matrix_xxx_x,
