#ifndef OverlapGeom301RecDS_hpp
#define OverlapGeom301RecDS_hpp
...
/**
 Evaluates <d^(3)/dA^(3)D|1|d^(1)/dB^(1)S>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom301DS(CSubMatrix*      matrix_xxx_x,
