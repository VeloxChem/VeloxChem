#ifndef PrimitiveOverlapGeom301FD_XXZ_XY
#define PrimitiveOverlapGeom301FD_XXZ_XY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XXZ|1|d^(1)/dB^(1)D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom301FD_XXZ_XY(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FD_XXZ_XY */
