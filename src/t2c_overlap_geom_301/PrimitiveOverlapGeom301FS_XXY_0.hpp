#ifndef PrimitiveOverlapGeom301FS_XXY_0
#define PrimitiveOverlapGeom301FS_XXY_0
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XXY|1|d^(1)/dB^(1)S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom301FS_XXY_0(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FS_XXY_0 */
