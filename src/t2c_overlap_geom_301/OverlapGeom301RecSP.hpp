#ifndef OverlapGeom301RecSP_hpp
#define OverlapGeom301RecSP_hpp
...
/**
 Evaluates <d^(3)/dA^(3)S|1|d^(1)/dB^(1)P>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom301SP(CSubMatrix*      matrix_xxx_x,
