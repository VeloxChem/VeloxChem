#ifndef PrimitiveOverlapGeom301DP_ZZ_Y
#define PrimitiveOverlapGeom301DP_ZZ_Y
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_ZZ|1|d^(1)/dB^(1)P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom301DP_ZZ_Y(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DP_ZZ_Y */
