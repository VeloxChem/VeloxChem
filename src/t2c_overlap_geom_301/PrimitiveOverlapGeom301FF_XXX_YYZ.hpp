#ifndef PrimitiveOverlapGeom301FF_XXX_YYZ
#define PrimitiveOverlapGeom301FF_XXX_YYZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XXX|1|d^(1)/dB^(1)F_YYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301FF_XXX_YYZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FF_XXX_YYZ */
