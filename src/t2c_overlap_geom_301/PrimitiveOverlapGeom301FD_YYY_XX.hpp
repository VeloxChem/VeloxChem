#ifndef PrimitiveOverlapGeom301FD_YYY_XX
#define PrimitiveOverlapGeom301FD_YYY_XX
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_YYY|1|d^(1)/dB^(1)D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom301FD_YYY_XX(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FD_YYY_XX */
