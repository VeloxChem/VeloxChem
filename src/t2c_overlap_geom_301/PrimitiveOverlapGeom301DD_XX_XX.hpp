#ifndef PrimitiveOverlapGeom301DD_XX_XX
#define PrimitiveOverlapGeom301DD_XX_XX
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XX|1|d^(1)/dB^(1)D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom301DD_XX_XX(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DD_XX_XX */
