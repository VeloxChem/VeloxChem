#ifndef PrimitiveOverlapGeom301FP_XYZ_X
#define PrimitiveOverlapGeom301FP_XYZ_X
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XYZ|1|d^(1)/dB^(1)P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom301FP_XYZ_X(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FP_XYZ_X */
