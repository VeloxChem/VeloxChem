#ifndef PrimitiveOverlapGeom301FD_XXZ_YY
#define PrimitiveOverlapGeom301FD_XXZ_YY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XXZ|1|d^(1)/dB^(1)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom301FD_XXZ_YY(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FD_XXZ_YY */
