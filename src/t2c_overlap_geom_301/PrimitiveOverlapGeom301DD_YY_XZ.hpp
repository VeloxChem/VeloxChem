#ifndef PrimitiveOverlapGeom301DD_YY_XZ
#define PrimitiveOverlapGeom301DD_YY_XZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YY|1|d^(1)/dB^(1)D_XZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301DD_YY_XZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DD_YY_XZ */
