#ifndef PrimitiveOverlapGeom301PD_Z_ZZ
#define PrimitiveOverlapGeom301PD_Z_ZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Z|1|d^(1)/dB^(1)D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301PD_Z_ZZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301PD_Z_ZZ */
