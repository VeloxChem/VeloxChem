#ifndef PrimitiveOverlapGeom301DP_XZ_X
#define PrimitiveOverlapGeom301DP_XZ_X
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XZ|1|d^(1)/dB^(1)P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom301DP_XZ_X(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DP_XZ_X */
