#ifndef PrimitiveOverlapGeom301FD_XXZ_XX
#define PrimitiveOverlapGeom301FD_XXZ_XX
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XXZ|1|d^(1)/dB^(1)D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom301FD_XXZ_XX(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FD_XXZ_XX */
