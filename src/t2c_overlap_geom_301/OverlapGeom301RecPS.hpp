#ifndef OverlapGeom301RecPS_hpp
#define OverlapGeom301RecPS_hpp
...
/**
 Evaluates <d^(3)/dA^(3)P|1|d^(1)/dB^(1)S>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom301PS(CSubMatrix*      matrix_xxx_x,
