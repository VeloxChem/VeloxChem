#ifndef PrimitiveOverlapGeom301DF_XX_ZZZ
#define PrimitiveOverlapGeom301DF_XX_ZZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XX|1|d^(1)/dB^(1)F_ZZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301DF_XX_ZZZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DF_XX_ZZZ */
