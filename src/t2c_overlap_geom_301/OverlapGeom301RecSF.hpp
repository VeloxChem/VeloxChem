#ifndef OverlapGeom301RecSF_hpp
#define OverlapGeom301RecSF_hpp
...
/**
 Evaluates <d^(3)/dA^(3)S|1|d^(1)/dB^(1)F>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom301SF(CSubMatrix*      matrix_xxx_x,
