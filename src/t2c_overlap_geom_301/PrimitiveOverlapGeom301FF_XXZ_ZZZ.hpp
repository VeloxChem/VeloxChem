#ifndef PrimitiveOverlapGeom301FF_XXZ_ZZZ
#define PrimitiveOverlapGeom301FF_XXZ_ZZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XXZ|1|d^(1)/dB^(1)F_ZZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301FF_XXZ_ZZZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FF_XXZ_ZZZ */
