#ifndef PrimitiveOverlapGeom301PF_Y_ZZZ
#define PrimitiveOverlapGeom301PF_Y_ZZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Y|1|d^(1)/dB^(1)F_ZZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301PF_Y_ZZZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301PF_Y_ZZZ */
