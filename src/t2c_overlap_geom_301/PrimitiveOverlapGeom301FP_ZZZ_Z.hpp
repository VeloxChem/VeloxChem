#ifndef PrimitiveOverlapGeom301FP_ZZZ_Z
#define PrimitiveOverlapGeom301FP_ZZZ_Z
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_ZZZ|1|d^(1)/dB^(1)P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom301FP_ZZZ_Z(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FP_ZZZ_Z */
