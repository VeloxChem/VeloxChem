#ifndef OverlapGeom301RecFF_hpp
#define OverlapGeom301RecFF_hpp
...
/**
 Evaluates <d^(3)/dA^(3)F|1|d^(1)/dB^(1)F>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom301FF(CSubMatrix*      matrix_xxx_x,
