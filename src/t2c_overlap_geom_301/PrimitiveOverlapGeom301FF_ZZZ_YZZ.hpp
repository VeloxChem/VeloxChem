#ifndef PrimitiveOverlapGeom301FF_ZZZ_YZZ
#define PrimitiveOverlapGeom301FF_ZZZ_YZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_ZZZ|1|d^(1)/dB^(1)F_YZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301FF_ZZZ_YZZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FF_ZZZ_YZZ */
