#ifndef PrimitiveOverlapGeom301FF_XXY_XYZ
#define PrimitiveOverlapGeom301FF_XXY_XYZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XXY|1|d^(1)/dB^(1)F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301FF_XXY_XYZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FF_XXY_XYZ */
