#ifndef PrimitiveOverlapGeom301PD_Z_YY
#define PrimitiveOverlapGeom301PD_Z_YY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Z|1|d^(1)/dB^(1)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom301PD_Z_YY(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301PD_Z_YY */
