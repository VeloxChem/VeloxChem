#ifndef OverlapGeom301RecSS_hpp
#define OverlapGeom301RecSS_hpp
...
/**
 Evaluates <d^(3)/dA^(3)S|1|d^(1)/dB^(1)S>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom301SS(CSubMatrix*      matrix_xxx_x,
