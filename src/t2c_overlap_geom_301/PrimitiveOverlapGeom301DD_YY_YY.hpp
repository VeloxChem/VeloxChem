#ifndef PrimitiveOverlapGeom301DD_YY_YY
#define PrimitiveOverlapGeom301DD_YY_YY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YY|1|d^(1)/dB^(1)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom301DD_YY_YY(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DD_YY_YY */
