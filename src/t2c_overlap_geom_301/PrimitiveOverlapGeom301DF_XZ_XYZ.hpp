#ifndef PrimitiveOverlapGeom301DF_XZ_XYZ
#define PrimitiveOverlapGeom301DF_XZ_XYZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XZ|1|d^(1)/dB^(1)F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301DF_XZ_XYZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DF_XZ_XYZ */
