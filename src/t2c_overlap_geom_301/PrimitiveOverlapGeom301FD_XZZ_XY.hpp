#ifndef PrimitiveOverlapGeom301FD_XZZ_XY
#define PrimitiveOverlapGeom301FD_XZZ_XY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XZZ|1|d^(1)/dB^(1)D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom301FD_XZZ_XY(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FD_XZZ_XY */
