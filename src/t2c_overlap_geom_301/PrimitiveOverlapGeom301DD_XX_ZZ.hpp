#ifndef PrimitiveOverlapGeom301DD_XX_ZZ
#define PrimitiveOverlapGeom301DD_XX_ZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XX|1|d^(1)/dB^(1)D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301DD_XX_ZZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DD_XX_ZZ */
