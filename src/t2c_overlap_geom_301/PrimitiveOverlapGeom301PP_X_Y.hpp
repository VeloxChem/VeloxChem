#ifndef PrimitiveOverlapGeom301PP_X_Y
#define PrimitiveOverlapGeom301PP_X_Y
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_X|1|d^(1)/dB^(1)P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom301PP_X_Y(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301PP_X_Y */
