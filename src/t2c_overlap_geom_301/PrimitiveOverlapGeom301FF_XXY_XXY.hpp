#ifndef PrimitiveOverlapGeom301FF_XXY_XXY
#define PrimitiveOverlapGeom301FF_XXY_XXY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XXY|1|d^(1)/dB^(1)F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom301FF_XXY_XXY(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FF_XXY_XXY */
