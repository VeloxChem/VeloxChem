#ifndef PrimitiveOverlapGeom301FD_XZZ_XX
#define PrimitiveOverlapGeom301FD_XZZ_XX
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XZZ|1|d^(1)/dB^(1)D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom301FD_XZZ_XX(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FD_XZZ_XX */
