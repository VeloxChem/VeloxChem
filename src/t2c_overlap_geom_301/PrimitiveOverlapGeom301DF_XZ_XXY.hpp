#ifndef PrimitiveOverlapGeom301DF_XZ_XXY
#define PrimitiveOverlapGeom301DF_XZ_XXY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XZ|1|d^(1)/dB^(1)F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom301DF_XZ_XXY(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DF_XZ_XXY */
