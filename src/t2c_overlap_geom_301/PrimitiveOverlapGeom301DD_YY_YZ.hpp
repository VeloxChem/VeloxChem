#ifndef PrimitiveOverlapGeom301DD_YY_YZ
#define PrimitiveOverlapGeom301DD_YY_YZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YY|1|d^(1)/dB^(1)D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301DD_YY_YZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DD_YY_YZ */
