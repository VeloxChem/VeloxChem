#ifndef PrimitiveOverlapGeom301PD_Y_XY
#define PrimitiveOverlapGeom301PD_Y_XY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Y|1|d^(1)/dB^(1)D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom301PD_Y_XY(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301PD_Y_XY */
