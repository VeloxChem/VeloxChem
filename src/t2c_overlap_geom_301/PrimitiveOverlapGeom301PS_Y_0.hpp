#ifndef PrimitiveOverlapGeom301PS_Y_0
#define PrimitiveOverlapGeom301PS_Y_0
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Y|1|d^(1)/dB^(1)S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom301PS_Y_0(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301PS_Y_0 */
