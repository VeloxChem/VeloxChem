#ifndef PrimitiveOverlapGeom301SF_0_XYZ
#define PrimitiveOverlapGeom301SF_0_XYZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)S_0|1|d^(1)/dB^(1)F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom301SF_0_XYZ(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301SF_0_XYZ */
