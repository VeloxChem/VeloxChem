#ifndef PrimitiveOverlapGeom301DF_YY_XXY
#define PrimitiveOverlapGeom301DF_YY_XXY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YY|1|d^(1)/dB^(1)F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom301DF_YY_XXY(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DF_YY_XXY */
