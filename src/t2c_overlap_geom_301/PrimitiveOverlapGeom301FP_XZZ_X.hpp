#ifndef PrimitiveOverlapGeom301FP_XZZ_X
#define PrimitiveOverlapGeom301FP_XZZ_X
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XZZ|1|d^(1)/dB^(1)P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom301FP_XZZ_X(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301FP_XZZ_X */
