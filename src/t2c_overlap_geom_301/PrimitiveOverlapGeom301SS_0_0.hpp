#ifndef PrimitiveOverlapGeom301SS_0_0
#define PrimitiveOverlapGeom301SS_0_0
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)S_0|1|d^(1)/dB^(1)S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom301SS_0_0(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301SS_0_0 */
