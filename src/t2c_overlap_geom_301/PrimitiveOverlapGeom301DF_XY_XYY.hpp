#ifndef PrimitiveOverlapGeom301DF_XY_XYY
#define PrimitiveOverlapGeom301DF_XY_XYY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XY|1|d^(1)/dB^(1)F_XYY> integrals.
...
*/
auto compPrimitiveOverlapGeom301DF_XY_XYY(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DF_XY_XYY */
