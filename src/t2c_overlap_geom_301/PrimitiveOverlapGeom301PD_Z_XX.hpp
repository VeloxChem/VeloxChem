#ifndef PrimitiveOverlapGeom301PD_Z_XX
#define PrimitiveOverlapGeom301PD_Z_XX
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Z|1|d^(1)/dB^(1)D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom301PD_Z_XX(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301PD_Z_XX */
