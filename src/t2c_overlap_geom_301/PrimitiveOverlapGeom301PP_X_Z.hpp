#ifndef PrimitiveOverlapGeom301PP_X_Z
#define PrimitiveOverlapGeom301PP_X_Z
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_X|1|d^(1)/dB^(1)P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom301PP_X_Z(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301PP_X_Z */
