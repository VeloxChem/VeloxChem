#ifndef PrimitiveOverlapGeom301DD_YY_XY
#define PrimitiveOverlapGeom301DD_YY_XY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YY|1|d^(1)/dB^(1)D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom301DD_YY_XY(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DD_YY_XY */
