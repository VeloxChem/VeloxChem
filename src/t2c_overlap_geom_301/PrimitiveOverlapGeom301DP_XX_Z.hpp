#ifndef PrimitiveOverlapGeom301DP_XX_Z
#define PrimitiveOverlapGeom301DP_XX_Z
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XX|1|d^(1)/dB^(1)P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom301DP_XX_Z(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DP_XX_Z */
