#ifndef PrimitiveOverlapGeom301DD_XY_YY
#define PrimitiveOverlapGeom301DD_XY_YY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XY|1|d^(1)/dB^(1)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom301DD_XY_YY(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DD_XY_YY */
