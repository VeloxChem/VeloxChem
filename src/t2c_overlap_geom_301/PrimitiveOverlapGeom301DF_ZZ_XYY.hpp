#ifndef PrimitiveOverlapGeom301DF_ZZ_XYY
#define PrimitiveOverlapGeom301DF_ZZ_XYY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_ZZ|1|d^(1)/dB^(1)F_XYY> integrals.
...
*/
auto compPrimitiveOverlapGeom301DF_ZZ_XYY(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301DF_ZZ_XYY */
