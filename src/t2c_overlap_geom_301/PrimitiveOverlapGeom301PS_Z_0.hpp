#ifndef PrimitiveOverlapGeom301PS_Z_0
#define PrimitiveOverlapGeom301PS_Z_0
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Z|1|d^(1)/dB^(1)S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom301PS_Z_0(TDoubleArray&       buffer_xxx_x,
...
#endif /* PrimitiveOverlapGeom301PS_Z_0 */
