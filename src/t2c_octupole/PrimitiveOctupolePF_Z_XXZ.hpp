#ifndef PrimitiveOctupolePF_Z_XXZ
#define PrimitiveOctupolePF_Z_XXZ
...
/**
 Evaluates block of primitive <P_Z|r^3|F_XXZ> integrals.
...
*/
auto compPrimitiveOctupolePF_Z_XXZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_Z_XXZ */
