#ifndef PrimitiveOctupoleDD_XX_YZ
#define PrimitiveOctupoleDD_XX_YZ
...
/**
 Evaluates block of primitive <D_XX|r^3|D_YZ> integrals.
...
*/
auto compPrimitiveOctupoleDD_XX_YZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_XX_YZ */
