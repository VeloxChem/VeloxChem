#ifndef PrimitiveOctupoleFP_XYY_Z
#define PrimitiveOctupoleFP_XYY_Z
...
/**
 Evaluates block of primitive <F_XYY|r^3|P_Z> integrals.
...
*/
auto compPrimitiveOctupoleFP_XYY_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_XYY_Z */
