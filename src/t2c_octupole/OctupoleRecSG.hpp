#ifndef OctupoleRecSG_hpp
#define OctupoleRecSG_hpp
...
/**
 Evaluates <S|r^3|G>  integrals for given pair of GTOs blocks.
...
*/
auto compOctupoleSG(CSubMatrix*      matrix_xxx,
