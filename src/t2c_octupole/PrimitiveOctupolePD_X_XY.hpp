#ifndef PrimitiveOctupolePD_X_XY
#define PrimitiveOctupolePD_X_XY
...
/**
 Evaluates block of primitive <P_X|r^3|D_XY> integrals.
...
*/
auto compPrimitiveOctupolePD_X_XY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePD_X_XY */
