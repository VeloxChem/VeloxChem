#ifndef PrimitiveOctupoleFP_YYZ_Z
#define PrimitiveOctupoleFP_YYZ_Z
...
/**
 Evaluates block of primitive <F_YYZ|r^3|P_Z> integrals.
...
*/
auto compPrimitiveOctupoleFP_YYZ_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_YYZ_Z */
