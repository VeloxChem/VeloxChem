#ifndef PrimitiveOctupoleFP_XYY_X
#define PrimitiveOctupoleFP_XYY_X
...
/**
 Evaluates block of primitive <F_XYY|r^3|P_X> integrals.
...
*/
auto compPrimitiveOctupoleFP_XYY_X(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_XYY_X */
