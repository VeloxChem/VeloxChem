#ifndef PrimitiveOctupolePF_X_YZZ
#define PrimitiveOctupolePF_X_YZZ
...
/**
 Evaluates block of primitive <P_X|r^3|F_YZZ> integrals.
...
*/
auto compPrimitiveOctupolePF_X_YZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_X_YZZ */
