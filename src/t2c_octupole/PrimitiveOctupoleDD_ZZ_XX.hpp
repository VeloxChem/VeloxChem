#ifndef PrimitiveOctupoleDD_ZZ_XX
#define PrimitiveOctupoleDD_ZZ_XX
...
/**
 Evaluates block of primitive <D_ZZ|r^3|D_XX> integrals.
...
*/
auto compPrimitiveOctupoleDD_ZZ_XX(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_ZZ_XX */
