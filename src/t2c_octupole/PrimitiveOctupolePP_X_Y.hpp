#ifndef PrimitiveOctupolePP_X_Y
#define PrimitiveOctupolePP_X_Y
...
/**
 Evaluates block of primitive <P_X|r^3|P_Y> integrals.
...
*/
auto compPrimitiveOctupolePP_X_Y(TDoubleArray&       buffer_xxx,
