#ifndef PrimitiveOctupolePD_Y_YZ
#define PrimitiveOctupolePD_Y_YZ
...
/**
 Evaluates block of primitive <P_Y|r^3|D_YZ> integrals.
...
*/
auto compPrimitiveOctupolePD_Y_YZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePD_Y_YZ */
