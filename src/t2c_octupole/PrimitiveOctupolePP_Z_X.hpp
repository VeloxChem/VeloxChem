#ifndef PrimitiveOctupolePP_Z_X
#define PrimitiveOctupolePP_Z_X
...
/**
 Evaluates block of primitive <P_Z|r^3|P_X> integrals.
...
*/
auto compPrimitiveOctupolePP_Z_X(TDoubleArray&       buffer_xxx,
