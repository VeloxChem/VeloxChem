#ifndef PrimitiveOctupoleDD_XY_XZ
#define PrimitiveOctupoleDD_XY_XZ
...
/**
 Evaluates block of primitive <D_XY|r^3|D_XZ> integrals.
...
*/
auto compPrimitiveOctupoleDD_XY_XZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_XY_XZ */
