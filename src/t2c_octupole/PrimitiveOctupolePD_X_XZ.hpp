#ifndef PrimitiveOctupolePD_X_XZ
#define PrimitiveOctupolePD_X_XZ
...
/**
 Evaluates block of primitive <P_X|r^3|D_XZ> integrals.
...
*/
auto compPrimitiveOctupolePD_X_XZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePD_X_XZ */
