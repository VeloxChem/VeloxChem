#ifndef PrimitiveOctupolePD_Z_XZ
#define PrimitiveOctupolePD_Z_XZ
...
/**
 Evaluates block of primitive <P_Z|r^3|D_XZ> integrals.
...
*/
auto compPrimitiveOctupolePD_Z_XZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePD_Z_XZ */
