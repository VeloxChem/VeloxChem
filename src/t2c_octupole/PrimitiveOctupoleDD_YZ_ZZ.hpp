#ifndef PrimitiveOctupoleDD_YZ_ZZ
#define PrimitiveOctupoleDD_YZ_ZZ
...
/**
 Evaluates block of primitive <D_YZ|r^3|D_ZZ> integrals.
...
*/
auto compPrimitiveOctupoleDD_YZ_ZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_YZ_ZZ */
