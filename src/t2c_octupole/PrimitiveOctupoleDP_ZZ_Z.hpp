#ifndef PrimitiveOctupoleDP_ZZ_Z
#define PrimitiveOctupoleDP_ZZ_Z
...
/**
 Evaluates block of primitive <D_ZZ|r^3|P_Z> integrals.
...
*/
auto compPrimitiveOctupoleDP_ZZ_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDP_ZZ_Z */
