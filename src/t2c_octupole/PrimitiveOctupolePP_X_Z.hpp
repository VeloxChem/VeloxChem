#ifndef PrimitiveOctupolePP_X_Z
#define PrimitiveOctupolePP_X_Z
...
/**
 Evaluates block of primitive <P_X|r^3|P_Z> integrals.
...
*/
auto compPrimitiveOctupolePP_X_Z(TDoubleArray&       buffer_xxx,
