#ifndef PrimitiveOctupolePF_Z_ZZZ
#define PrimitiveOctupolePF_Z_ZZZ
...
/**
 Evaluates block of primitive <P_Z|r^3|F_ZZZ> integrals.
...
*/
auto compPrimitiveOctupolePF_Z_ZZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_Z_ZZZ */
