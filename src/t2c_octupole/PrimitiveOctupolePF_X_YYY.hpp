#ifndef PrimitiveOctupolePF_X_YYY
#define PrimitiveOctupolePF_X_YYY
...
/**
 Evaluates block of primitive <P_X|r^3|F_YYY> integrals.
...
*/
auto compPrimitiveOctupolePF_X_YYY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_X_YYY */
