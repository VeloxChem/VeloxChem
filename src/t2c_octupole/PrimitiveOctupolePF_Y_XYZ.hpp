#ifndef PrimitiveOctupolePF_Y_XYZ
#define PrimitiveOctupolePF_Y_XYZ
...
/**
 Evaluates block of primitive <P_Y|r^3|F_XYZ> integrals.
...
*/
auto compPrimitiveOctupolePF_Y_XYZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_Y_XYZ */
