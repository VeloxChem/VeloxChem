#ifndef PrimitiveOctupoleSF_0_XXZ
#define PrimitiveOctupoleSF_0_XXZ
...
/**
 Evaluates block of primitive <S_0|r^3|F_XXZ> integrals.
...
*/
auto compPrimitiveOctupoleSF_0_XXZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleSF_0_XXZ */
