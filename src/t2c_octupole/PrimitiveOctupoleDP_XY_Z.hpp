#ifndef PrimitiveOctupoleDP_XY_Z
#define PrimitiveOctupoleDP_XY_Z
...
/**
 Evaluates block of primitive <D_XY|r^3|P_Z> integrals.
...
*/
auto compPrimitiveOctupoleDP_XY_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDP_XY_Z */
