#ifndef PrimitiveOctupoleFP_YYY_X
#define PrimitiveOctupoleFP_YYY_X
...
/**
 Evaluates block of primitive <F_YYY|r^3|P_X> integrals.
...
*/
auto compPrimitiveOctupoleFP_YYY_X(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_YYY_X */
