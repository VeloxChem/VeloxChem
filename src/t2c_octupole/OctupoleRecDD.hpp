#ifndef OctupoleRecDD_hpp
#define OctupoleRecDD_hpp
...
/**
 Evaluates <D|r^3|D>  integrals for given GTOs block.
...
*/
auto compOctupoleDD(CSubMatrix*      matrix_xxx,
...
/**
 Evaluates <D|r^3|D>  integrals for given pair of GTOs blocks.
