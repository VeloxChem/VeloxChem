#ifndef PrimitiveOctupoleDP_XX_Y
#define PrimitiveOctupoleDP_XX_Y
...
/**
 Evaluates block of primitive <D_XX|r^3|P_Y> integrals.
...
*/
auto compPrimitiveOctupoleDP_XX_Y(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDP_XX_Y */
