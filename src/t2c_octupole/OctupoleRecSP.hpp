#ifndef OctupoleRecSP_hpp
#define OctupoleRecSP_hpp
...
/**
 Evaluates <S|r^3|P>  integrals for given pair of GTOs blocks.
...
*/
auto compOctupoleSP(CSubMatrix*      matrix_xxx,
