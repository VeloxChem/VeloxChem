#ifndef PrimitiveOctupoleDP_YY_X
#define PrimitiveOctupoleDP_YY_X
...
/**
 Evaluates block of primitive <D_YY|r^3|P_X> integrals.
...
*/
auto compPrimitiveOctupoleDP_YY_X(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDP_YY_X */
