#ifndef PrimitiveOctupolePF_X_XYY
#define PrimitiveOctupolePF_X_XYY
...
/**
 Evaluates block of primitive <P_X|r^3|F_XYY> integrals.
...
*/
auto compPrimitiveOctupolePF_X_XYY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_X_XYY */
