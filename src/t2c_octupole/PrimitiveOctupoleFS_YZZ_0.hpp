#ifndef PrimitiveOctupoleFS_YZZ_0
#define PrimitiveOctupoleFS_YZZ_0
...
/**
 Evaluates block of primitive <F_YZZ|r^3|S_0> integrals.
...
*/
auto compPrimitiveOctupoleFS_YZZ_0(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFS_YZZ_0 */
