#ifndef PrimitiveOctupoleFP_ZZZ_Y
#define PrimitiveOctupoleFP_ZZZ_Y
...
/**
 Evaluates block of primitive <F_ZZZ|r^3|P_Y> integrals.
...
*/
auto compPrimitiveOctupoleFP_ZZZ_Y(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_ZZZ_Y */
