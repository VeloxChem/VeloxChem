#ifndef PrimitiveOctupoleDD_YY_XZ
#define PrimitiveOctupoleDD_YY_XZ
...
/**
 Evaluates block of primitive <D_YY|r^3|D_XZ> integrals.
...
*/
auto compPrimitiveOctupoleDD_YY_XZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_YY_XZ */
