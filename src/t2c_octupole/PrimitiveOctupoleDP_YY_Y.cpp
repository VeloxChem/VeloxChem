...
auto
compPrimitiveOctupoleDP_YY_Y(      TDoubleArray& buffer_xxx,
                             ...
                             const int64_t       ket_dim) -> void
{
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xxx[i] += faa_xxx * (fe_0 * rpa_y + (1.0 / 2.0) * fe_0 * rpb_y + rpa_y * rpa_y * rpb_y);

        fints_xxy[i] += faa_xx * (fe_0 * rpa_y * rpb_y + (1.0 / 2.0) * fe_0 * rpa_y * rpa_y + (3.0 / 4.0) * fe_0 * fe_0);

        fints_xxy[i] += faa_xxy * (fe_0 * rpa_y + (1.0 / 2.0) * fe_0 * rpb_y + rpa_y * rpa_y * rpb_y);

        fints_xxz[i] += faa_xxz * (fe_0 * rpa_y + (1.0 / 2.0) * fe_0 * rpb_y + rpa_y * rpa_y * rpb_y);

        fints_xyy[i] += faa_x * (fe_0 * fe_0 * rpa_y + (1.0 / 2.0) * fe_0 * fe_0 * rpb_y);

        fints_xyy[i] += faa_xy * (2.0 * fe_0 * rpa_y * rpb_y + fe_0 * rpa_y * rpa_y + (3.0 / 2.0) * fe_0 * fe_0);

        fints_xyy[i] += faa_xyy * (fe_0 * rpa_y + (1.0 / 2.0) * fe_0 * rpb_y + rpa_y * rpa_y * rpb_y);

        fints_xyz[i] += faa_xz * (fe_0 * rpa_y * rpb_y + (1.0 / 2.0) * fe_0 * rpa_y * rpa_y + (3.0 / 4.0) * fe_0 * fe_0);

        fints_xyz[i] += faa_xyz * (fe_0 * rpa_y + (1.0 / 2.0) * fe_0 * rpb_y + rpa_y * rpa_y * rpb_y);

        fints_xzz[i] += faa_xzz * (fe_0 * rpa_y + (1.0 / 2.0) * fe_0 * rpb_y + rpa_y * rpa_y * rpb_y);

        fints_yyy[i] += fss * (3.0 / 4.0) * fe_0 * fe_0 * fe_0;

        fints_yyy[i] += faa_y * (3.0 * fe_0 * fe_0 * rpa_y + (3.0 / 2.0) * fe_0 * fe_0 * rpb_y);

        fints_yyy[i] += faa_yy * (3.0 * fe_0 * rpa_y * rpb_y + (3.0 / 2.0) * fe_0 * rpa_y * rpa_y + (9.0 / 4.0) * fe_0 * fe_0);

        fints_yyy[i] += faa_yyy * (fe_0 * rpa_y + (1.0 / 2.0) * fe_0 * rpb_y + rpa_y * rpa_y * rpb_y);

        fints_yyz[i] += faa_z * (fe_0 * fe_0 * rpa_y + (1.0 / 2.0) * fe_0 * fe_0 * rpb_y);

        fints_yyz[i] += faa_yz * (2.0 * fe_0 * rpa_y * rpb_y + fe_0 * rpa_y * rpa_y + (3.0 / 2.0) * fe_0 * fe_0);

        fints_yyz[i] += faa_yyz * (fe_0 * rpa_y + (1.0 / 2.0) * fe_0 * rpb_y + rpa_y * rpa_y * rpb_y);

        fints_yzz[i] += faa_zz * (fe_0 * rpa_y * rpb_y + (1.0 / 2.0) * fe_0 * rpa_y * rpa_y + (3.0 / 4.0) * fe_0 * fe_0);

        fints_yzz[i] += faa_yzz * (fe_0 * rpa_y + (1.0 / 2.0) * fe_0 * rpb_y + rpa_y * rpa_y * rpb_y);

        fints_zzz[i] += faa_zzz * (fe_0 * rpa_y + (1.0 / 2.0) * fe_0 * rpb_y + rpa_y * rpa_y * rpb_y);
