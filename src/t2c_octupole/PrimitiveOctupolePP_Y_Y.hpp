#ifndef PrimitiveOctupolePP_Y_Y
#define PrimitiveOctupolePP_Y_Y
...
/**
 Evaluates block of primitive <P_Y|r^3|P_Y> integrals.
...
*/
auto compPrimitiveOctupolePP_Y_Y(TDoubleArray&       buffer_xxx,
