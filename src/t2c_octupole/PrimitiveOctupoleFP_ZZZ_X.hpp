#ifndef PrimitiveOctupoleFP_ZZZ_X
#define PrimitiveOctupoleFP_ZZZ_X
...
/**
 Evaluates block of primitive <F_ZZZ|r^3|P_X> integrals.
...
*/
auto compPrimitiveOctupoleFP_ZZZ_X(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_ZZZ_X */
