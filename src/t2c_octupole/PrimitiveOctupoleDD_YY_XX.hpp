#ifndef PrimitiveOctupoleDD_YY_XX
#define PrimitiveOctupoleDD_YY_XX
...
/**
 Evaluates block of primitive <D_YY|r^3|D_XX> integrals.
...
*/
auto compPrimitiveOctupoleDD_YY_XX(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_YY_XX */
