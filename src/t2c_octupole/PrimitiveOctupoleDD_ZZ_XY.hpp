#ifndef PrimitiveOctupoleDD_ZZ_XY
#define PrimitiveOctupoleDD_ZZ_XY
...
/**
 Evaluates block of primitive <D_ZZ|r^3|D_XY> integrals.
...
*/
auto compPrimitiveOctupoleDD_ZZ_XY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_ZZ_XY */
