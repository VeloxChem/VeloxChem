#ifndef PrimitiveOctupoleSP_0_X
#define PrimitiveOctupoleSP_0_X
...
/**
 Evaluates block of primitive <S_0|r^3|P_X> integrals.
...
*/
auto compPrimitiveOctupoleSP_0_X(TDoubleArray&       buffer_xxx,
