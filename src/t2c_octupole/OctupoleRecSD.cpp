...
#include "PrimitiveOctupoleSD_0_XX.hpp"
#include "PrimitiveOctupoleSD_0_XY.hpp"
#include "PrimitiveOctupoleSD_0_XZ.hpp"
#include "PrimitiveOctupoleSD_0_YY.hpp"
#include "PrimitiveOctupoleSD_0_YZ.hpp"
#include "PrimitiveOctupoleSD_0_ZZ.hpp"

namespace octurec { // octurec namespace

auto
compOctupoleSD(      CSubMatrix* matrix_xxx,
        ...
        for (int64_t j = bra_first; j < bra_last; j++) 
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    octurec::compPrimitiveOctupoleSD_0_XX(buffer_xxx,
                                                          buffer_xxy,
                                                          buffer_xxz,
                                                          buffer_xyy,
                                                          buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    octurec::compPrimitiveOctupoleSD_0_XY(buffer_xxx,
                                                          buffer_xxy,
                                                          buffer_xxz,
                                                          buffer_xyy,
                                                          buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    octurec::compPrimitiveOctupoleSD_0_XZ(buffer_xxx,
                                                          buffer_xxy,
                                                          buffer_xxz,
                                                          buffer_xyy,
                                                          buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    octurec::compPrimitiveOctupoleSD_0_YY(buffer_xxx,
                                                          buffer_xxy,
                                                          buffer_xxz,
                                                          buffer_xyy,
                                                          buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    octurec::compPrimitiveOctupoleSD_0_YZ(buffer_xxx,
                                                          buffer_xxy,
                                                          buffer_xxz,
                                                          buffer_xyy,
                                                          buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    octurec::compPrimitiveOctupoleSD_0_ZZ(buffer_xxx,
                                                          buffer_xxy,
                                                          buffer_xxz,
                                                          buffer_xyy,
                                                          buffer_xyz,
