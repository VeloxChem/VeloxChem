        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveOctupoleSD_0_XX(buffer_xxx,
                                                       buffer_xxy,
                                                       buffer_xxz,
                                                       buffer_xyy,
                                                       buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveOctupoleSD_0_XY(buffer_xxx,
                                                       buffer_xxy,
                                                       buffer_xxz,
                                                       buffer_xyy,
                                                       buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveOctupoleSD_0_XZ(buffer_xxx,
                                                       buffer_xxy,
                                                       buffer_xxz,
                                                       buffer_xyy,
                                                       buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveOctupoleSD_0_YY(buffer_xxx,
                                                       buffer_xxy,
                                                       buffer_xxz,
                                                       buffer_xyy,
                                                       buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveOctupoleSD_0_YZ(buffer_xxx,
                                                       buffer_xxy,
                                                       buffer_xxz,
                                                       buffer_xyy,
                                                       buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    mpol::compPrimitiveOctupoleSD_0_ZZ(buffer_xxx,
                                                       buffer_xxy,
                                                       buffer_xxz,
                                                       buffer_xyy,
                                                       buffer_xyz,
