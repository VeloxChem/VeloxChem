#ifndef PrimitiveOctupoleDD_ZZ_YZ
#define PrimitiveOctupoleDD_ZZ_YZ
...
/**
 Evaluates block of primitive <D_ZZ|r^3|D_YZ> integrals.
...
*/
auto compPrimitiveOctupoleDD_ZZ_YZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_ZZ_YZ */
