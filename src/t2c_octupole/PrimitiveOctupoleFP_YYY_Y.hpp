#ifndef PrimitiveOctupoleFP_YYY_Y
#define PrimitiveOctupoleFP_YYY_Y
...
/**
 Evaluates block of primitive <F_YYY|r^3|P_Y> integrals.
...
*/
auto compPrimitiveOctupoleFP_YYY_Y(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_YYY_Y */
