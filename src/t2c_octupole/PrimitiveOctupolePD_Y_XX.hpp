#ifndef PrimitiveOctupolePD_Y_XX
#define PrimitiveOctupolePD_Y_XX
...
/**
 Evaluates block of primitive <P_Y|r^3|D_XX> integrals.
...
*/
auto compPrimitiveOctupolePD_Y_XX(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePD_Y_XX */
