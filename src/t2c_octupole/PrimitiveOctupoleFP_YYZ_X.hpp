#ifndef PrimitiveOctupoleFP_YYZ_X
#define PrimitiveOctupoleFP_YYZ_X
...
/**
 Evaluates block of primitive <F_YYZ|r^3|P_X> integrals.
...
*/
auto compPrimitiveOctupoleFP_YYZ_X(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_YYZ_X */
