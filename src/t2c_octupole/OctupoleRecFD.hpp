#ifndef OctupoleRecFD_hpp
#define OctupoleRecFD_hpp
...
/**
 Evaluates <F|r^3|D>  integrals for given pair of GTOs blocks.
...
*/
auto compOctupoleFD(CSubMatrix*      matrix_xxx,
