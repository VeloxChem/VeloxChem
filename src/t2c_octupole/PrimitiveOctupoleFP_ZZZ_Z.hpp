#ifndef PrimitiveOctupoleFP_ZZZ_Z
#define PrimitiveOctupoleFP_ZZZ_Z
...
/**
 Evaluates block of primitive <F_ZZZ|r^3|P_Z> integrals.
...
*/
auto compPrimitiveOctupoleFP_ZZZ_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_ZZZ_Z */
