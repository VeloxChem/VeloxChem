#ifndef PrimitiveOctupoleDP_XY_X
#define PrimitiveOctupoleDP_XY_X
...
/**
 Evaluates block of primitive <D_XY|r^3|P_X> integrals.
...
*/
auto compPrimitiveOctupoleDP_XY_X(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDP_XY_X */
