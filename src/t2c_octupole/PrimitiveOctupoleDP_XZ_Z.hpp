#ifndef PrimitiveOctupoleDP_XZ_Z
#define PrimitiveOctupoleDP_XZ_Z
...
/**
 Evaluates block of primitive <D_XZ|r^3|P_Z> integrals.
...
*/
auto compPrimitiveOctupoleDP_XZ_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDP_XZ_Z */
