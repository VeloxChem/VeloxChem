#ifndef PrimitiveOctupolePD_Z_XX
#define PrimitiveOctupolePD_Z_XX
...
/**
 Evaluates block of primitive <P_Z|r^3|D_XX> integrals.
...
*/
auto compPrimitiveOctupolePD_Z_XX(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePD_Z_XX */
