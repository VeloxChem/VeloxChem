#ifndef PrimitiveOctupolePF_Z_YYZ
#define PrimitiveOctupolePF_Z_YYZ
...
/**
 Evaluates block of primitive <P_Z|r^3|F_YYZ> integrals.
...
*/
auto compPrimitiveOctupolePF_Z_YYZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_Z_YYZ */
