#ifndef PrimitiveOctupolePF_Y_ZZZ
#define PrimitiveOctupolePF_Y_ZZZ
...
/**
 Evaluates block of primitive <P_Y|r^3|F_ZZZ> integrals.
...
*/
auto compPrimitiveOctupolePF_Y_ZZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_Y_ZZZ */
