#ifndef OctupoleRecPG_hpp
#define OctupoleRecPG_hpp
...
/**
 Evaluates <P|r^3|G>  integrals for given pair of GTOs blocks.
...
*/
auto compOctupolePG(CSubMatrix*      matrix_xxx,
