...
#pragma omp simd aligned(fints_xxx,     \
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xxx[i] += faa_xxx * rpa_z * rpa_y * rpb_x;
        ...
        fints_xxy[i] += faa_xxy * rpa_z * rpa_y * rpb_x;
        ...
        fints_xxz[i] += faa_xxz * rpa_z * rpa_y * rpb_x;
        ...
        fints_xyy[i] += faa_xyy * rpa_z * rpa_y * rpb_x;
        ...
        fints_xyz[i] += faa_xyz * rpa_z * rpa_y * rpb_x;
        ...
        fints_xzz[i] += faa_xzz * rpa_z * rpa_y * rpb_x;

        fints_yyy[i] += faa_yy * (3.0 / 2.0) * fe_0 * rpa_z * rpb_x;

        fints_yyy[i] += faa_yyy * rpa_z * rpa_y * rpb_x;
        ...
        fints_yyz[i] += faa_yyz * rpa_z * rpa_y * rpb_x;
        ...
        fints_yzz[i] += faa_yzz * rpa_z * rpa_y * rpb_x;

        fints_zzz[i] += faa_zz * (3.0 / 2.0) * fe_0 * rpa_y * rpb_x;

        fints_zzz[i] += faa_zzz * rpa_z * rpa_y * rpb_x;
    }
}
