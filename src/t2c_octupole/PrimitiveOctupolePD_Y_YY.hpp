#ifndef PrimitiveOctupolePD_Y_YY
#define PrimitiveOctupolePD_Y_YY
...
/**
 Evaluates block of primitive <P_Y|r^3|D_YY> integrals.
...
*/
auto compPrimitiveOctupolePD_Y_YY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePD_Y_YY */
