#ifndef PrimitiveOctupolePF_X_ZZZ
#define PrimitiveOctupolePF_X_ZZZ
...
/**
 Evaluates block of primitive <P_X|r^3|F_ZZZ> integrals.
...
*/
auto compPrimitiveOctupolePF_X_ZZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_X_ZZZ */
