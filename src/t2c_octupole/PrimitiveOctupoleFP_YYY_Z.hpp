#ifndef PrimitiveOctupoleFP_YYY_Z
#define PrimitiveOctupoleFP_YYY_Z
...
/**
 Evaluates block of primitive <F_YYY|r^3|P_Z> integrals.
...
*/
auto compPrimitiveOctupoleFP_YYY_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_YYY_Z */
