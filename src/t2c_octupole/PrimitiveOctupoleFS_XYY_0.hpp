#ifndef PrimitiveOctupoleFS_XYY_0
#define PrimitiveOctupoleFS_XYY_0
...
/**
 Evaluates block of primitive <F_XYY|r^3|S_0> integrals.
...
*/
auto compPrimitiveOctupoleFS_XYY_0(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFS_XYY_0 */
