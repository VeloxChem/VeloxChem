#ifndef PrimitiveOctupolePD_X_XX
#define PrimitiveOctupolePD_X_XX
...
/**
 Evaluates block of primitive <P_X|r^3|D_XX> integrals.
...
*/
auto compPrimitiveOctupolePD_X_XX(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePD_X_XX */
