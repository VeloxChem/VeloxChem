#ifndef PrimitiveOctupolePF_Y_YYY
#define PrimitiveOctupolePF_Y_YYY
...
/**
 Evaluates block of primitive <P_Y|r^3|F_YYY> integrals.
...
*/
auto compPrimitiveOctupolePF_Y_YYY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_Y_YYY */
