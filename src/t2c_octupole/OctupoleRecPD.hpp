#ifndef OctupoleRecPD_hpp
#define OctupoleRecPD_hpp
...
/**
 Evaluates <P|r^3|D>  integrals for given pair of GTOs blocks.
...
*/
auto compOctupolePD(CSubMatrix*      matrix_xxx,
