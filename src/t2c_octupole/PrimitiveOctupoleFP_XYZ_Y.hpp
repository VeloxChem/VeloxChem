#ifndef PrimitiveOctupoleFP_XYZ_Y
#define PrimitiveOctupoleFP_XYZ_Y
...
/**
 Evaluates block of primitive <F_XYZ|r^3|P_Y> integrals.
...
*/
auto compPrimitiveOctupoleFP_XYZ_Y(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_XYZ_Y */
