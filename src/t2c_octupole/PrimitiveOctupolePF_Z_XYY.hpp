#ifndef PrimitiveOctupolePF_Z_XYY
#define PrimitiveOctupolePF_Z_XYY
...
/**
 Evaluates block of primitive <P_Z|r^3|F_XYY> integrals.
...
*/
auto compPrimitiveOctupolePF_Z_XYY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_Z_XYY */
