#ifndef PrimitiveOctupoleSF_0_XXX
#define PrimitiveOctupoleSF_0_XXX
...
/**
 Evaluates block of primitive <S_0|r^3|F_XXX> integrals.
...
*/
auto compPrimitiveOctupoleSF_0_XXX(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleSF_0_XXX */
