#ifndef PrimitiveOctupolePF_X_XXZ
#define PrimitiveOctupolePF_X_XXZ
...
/**
 Evaluates block of primitive <P_X|r^3|F_XXZ> integrals.
...
*/
auto compPrimitiveOctupolePF_X_XXZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_X_XXZ */
