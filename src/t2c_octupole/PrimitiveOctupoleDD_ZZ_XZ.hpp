#ifndef PrimitiveOctupoleDD_ZZ_XZ
#define PrimitiveOctupoleDD_ZZ_XZ
...
/**
 Evaluates block of primitive <D_ZZ|r^3|D_XZ> integrals.
...
*/
auto compPrimitiveOctupoleDD_ZZ_XZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_ZZ_XZ */
