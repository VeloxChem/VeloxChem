#ifndef PrimitiveOctupoleDD_YZ_XZ
#define PrimitiveOctupoleDD_YZ_XZ
...
/**
 Evaluates block of primitive <D_YZ|r^3|D_XZ> integrals.
...
*/
auto compPrimitiveOctupoleDD_YZ_XZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_YZ_XZ */
