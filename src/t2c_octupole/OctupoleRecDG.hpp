#ifndef OctupoleRecDG_hpp
#define OctupoleRecDG_hpp
...
/**
 Evaluates <D|r^3|G>  integrals for given pair of GTOs blocks.
...
*/
auto compOctupoleDG(CSubMatrix*      matrix_xxx,
