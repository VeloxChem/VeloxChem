#ifndef PrimitiveOctupoleSF_0_XXY
#define PrimitiveOctupoleSF_0_XXY
...
/**
 Evaluates block of primitive <S_0|r^3|F_XXY> integrals.
...
*/
auto compPrimitiveOctupoleSF_0_XXY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleSF_0_XXY */
