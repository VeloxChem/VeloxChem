#ifndef PrimitiveOctupoleDS_ZZ_0
#define PrimitiveOctupoleDS_ZZ_0
...
/**
 Evaluates block of primitive <D_ZZ|r^3|S_0> integrals.
...
*/
auto compPrimitiveOctupoleDS_ZZ_0(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDS_ZZ_0 */
