#ifndef PrimitiveOctupoleFP_YYZ_Y
#define PrimitiveOctupoleFP_YYZ_Y
...
/**
 Evaluates block of primitive <F_YYZ|r^3|P_Y> integrals.
...
*/
auto compPrimitiveOctupoleFP_YYZ_Y(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_YYZ_Y */
