#ifndef PrimitiveOctupolePF_Y_XXX
#define PrimitiveOctupolePF_Y_XXX
...
/**
 Evaluates block of primitive <P_Y|r^3|F_XXX> integrals.
...
*/
auto compPrimitiveOctupolePF_Y_XXX(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_Y_XXX */
