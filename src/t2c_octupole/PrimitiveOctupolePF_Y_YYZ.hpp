#ifndef PrimitiveOctupolePF_Y_YYZ
#define PrimitiveOctupolePF_Y_YYZ
...
/**
 Evaluates block of primitive <P_Y|r^3|F_YYZ> integrals.
...
*/
auto compPrimitiveOctupolePF_Y_YYZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_Y_YYZ */
