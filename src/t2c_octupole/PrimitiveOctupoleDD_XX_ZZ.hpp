#ifndef PrimitiveOctupoleDD_XX_ZZ
#define PrimitiveOctupoleDD_XX_ZZ
...
/**
 Evaluates block of primitive <D_XX|r^3|D_ZZ> integrals.
...
*/
auto compPrimitiveOctupoleDD_XX_ZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_XX_ZZ */
