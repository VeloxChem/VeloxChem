#ifndef PrimitiveOctupoleFP_XZZ_X
#define PrimitiveOctupoleFP_XZZ_X
...
/**
 Evaluates block of primitive <F_XZZ|r^3|P_X> integrals.
...
*/
auto compPrimitiveOctupoleFP_XZZ_X(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_XZZ_X */
