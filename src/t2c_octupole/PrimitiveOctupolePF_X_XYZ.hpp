#ifndef PrimitiveOctupolePF_X_XYZ
#define PrimitiveOctupolePF_X_XYZ
...
/**
 Evaluates block of primitive <P_X|r^3|F_XYZ> integrals.
...
*/
auto compPrimitiveOctupolePF_X_XYZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_X_XYZ */
