#ifndef PrimitiveOctupolePF_Y_XYY
#define PrimitiveOctupolePF_Y_XYY
...
/**
 Evaluates block of primitive <P_Y|r^3|F_XYY> integrals.
...
*/
auto compPrimitiveOctupolePF_Y_XYY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_Y_XYY */
