#ifndef PrimitiveOctupoleDD_ZZ_YY
#define PrimitiveOctupoleDD_ZZ_YY
...
/**
 Evaluates block of primitive <D_ZZ|r^3|D_YY> integrals.
...
*/
auto compPrimitiveOctupoleDD_ZZ_YY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_ZZ_YY */
