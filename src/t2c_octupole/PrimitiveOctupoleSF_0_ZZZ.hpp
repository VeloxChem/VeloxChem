#ifndef PrimitiveOctupoleSF_0_ZZZ
#define PrimitiveOctupoleSF_0_ZZZ
...
/**
 Evaluates block of primitive <S_0|r^3|F_ZZZ> integrals.
...
*/
auto compPrimitiveOctupoleSF_0_ZZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleSF_0_ZZZ */
