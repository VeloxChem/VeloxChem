#ifndef PrimitiveOctupoleFP_XXZ_Y
#define PrimitiveOctupoleFP_XXZ_Y
...
/**
 Evaluates block of primitive <F_XXZ|r^3|P_Y> integrals.
...
*/
auto compPrimitiveOctupoleFP_XXZ_Y(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_XXZ_Y */
