#ifndef PrimitiveOctupoleDD_YZ_XX
#define PrimitiveOctupoleDD_YZ_XX
...
/**
 Evaluates block of primitive <D_YZ|r^3|D_XX> integrals.
...
*/
auto compPrimitiveOctupoleDD_YZ_XX(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_YZ_XX */
