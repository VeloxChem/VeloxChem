#ifndef PrimitiveOctupoleDD_YY_ZZ
#define PrimitiveOctupoleDD_YY_ZZ
...
/**
 Evaluates block of primitive <D_YY|r^3|D_ZZ> integrals.
...
*/
auto compPrimitiveOctupoleDD_YY_ZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_YY_ZZ */
