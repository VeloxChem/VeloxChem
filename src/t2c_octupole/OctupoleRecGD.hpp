#ifndef OctupoleRecGD_hpp
#define OctupoleRecGD_hpp
...
/**
 Evaluates <G|r^3|D>  integrals for given pair of GTOs blocks.
...
*/
auto compOctupoleGD(CSubMatrix*      matrix_xxx,
