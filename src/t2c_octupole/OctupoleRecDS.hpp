#ifndef OctupoleRecDS_hpp
#define OctupoleRecDS_hpp
...
/**
 Evaluates <D|r^3|S>  integrals for given pair of GTOs blocks.
...
*/
auto compOctupoleDS(CSubMatrix*      matrix_xxx,
