#ifndef PrimitiveOctupolePP_Y_Z
#define PrimitiveOctupolePP_Y_Z
...
/**
 Evaluates block of primitive <P_Y|r^3|P_Z> integrals.
...
*/
auto compPrimitiveOctupolePP_Y_Z(TDoubleArray&       buffer_xxx,
