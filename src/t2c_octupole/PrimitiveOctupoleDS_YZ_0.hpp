#ifndef PrimitiveOctupoleDS_YZ_0
#define PrimitiveOctupoleDS_YZ_0
...
/**
 Evaluates block of primitive <D_YZ|r^3|S_0> integrals.
...
*/
auto compPrimitiveOctupoleDS_YZ_0(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDS_YZ_0 */
