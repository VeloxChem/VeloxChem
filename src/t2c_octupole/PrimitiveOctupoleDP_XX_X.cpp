...
auto
compPrimitiveOctupoleDP_XX_X(      TDoubleArray& buffer_xxx,
                             ...
                             const int64_t       ket_dim) -> void
{
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xxx[i] += fss * (3.0 / 4.0) * fe_0 * fe_0 * fe_0;

        fints_xxx[i] += faa_x * (3.0 * fe_0 * fe_0 * rpa_x + (3.0 / 2.0) * fe_0 * fe_0 * rpb_x);

        fints_xxx[i] += faa_xx * (3.0 * fe_0 * rpa_x * rpb_x + (3.0 / 2.0) * fe_0 * rpa_x * rpa_x + (9.0 / 4.0) * fe_0 * fe_0);

        fints_xxx[i] += faa_xxx * (fe_0 * rpa_x + (1.0 / 2.0) * fe_0 * rpb_x + rpa_x * rpa_x * rpb_x);

        fints_xxy[i] += faa_y * (fe_0 * fe_0 * rpa_x + (1.0 / 2.0) * fe_0 * fe_0 * rpb_x);

        fints_xxy[i] += faa_xy * (2.0 * fe_0 * rpa_x * rpb_x + fe_0 * rpa_x * rpa_x + (3.0 / 2.0) * fe_0 * fe_0);

        fints_xxy[i] += faa_xxy * (fe_0 * rpa_x + (1.0 / 2.0) * fe_0 * rpb_x + rpa_x * rpa_x * rpb_x);

        fints_xxz[i] += faa_z * (fe_0 * fe_0 * rpa_x + (1.0 / 2.0) * fe_0 * fe_0 * rpb_x);

        fints_xxz[i] += faa_xz * (2.0 * fe_0 * rpa_x * rpb_x + fe_0 * rpa_x * rpa_x + (3.0 / 2.0) * fe_0 * fe_0);

        fints_xxz[i] += faa_xxz * (fe_0 * rpa_x + (1.0 / 2.0) * fe_0 * rpb_x + rpa_x * rpa_x * rpb_x);

        fints_xyy[i] += faa_yy * (fe_0 * rpa_x * rpb_x + (1.0 / 2.0) * fe_0 * rpa_x * rpa_x + (3.0 / 4.0) * fe_0 * fe_0);

        fints_xyy[i] += faa_xyy * (fe_0 * rpa_x + (1.0 / 2.0) * fe_0 * rpb_x + rpa_x * rpa_x * rpb_x);

        fints_xyz[i] += faa_yz * (fe_0 * rpa_x * rpb_x + (1.0 / 2.0) * fe_0 * rpa_x * rpa_x + (3.0 / 4.0) * fe_0 * fe_0);

        fints_xyz[i] += faa_xyz * (fe_0 * rpa_x + (1.0 / 2.0) * fe_0 * rpb_x + rpa_x * rpa_x * rpb_x);

        fints_xzz[i] += faa_zz * (fe_0 * rpa_x * rpb_x + (1.0 / 2.0) * fe_0 * rpa_x * rpa_x + (3.0 / 4.0) * fe_0 * fe_0);

        fints_xzz[i] += faa_xzz * (fe_0 * rpa_x + (1.0 / 2.0) * fe_0 * rpb_x + rpa_x * rpa_x * rpb_x);

        fints_yyy[i] += faa_yyy * (fe_0 * rpa_x + (1.0 / 2.0) * fe_0 * rpb_x + rpa_x * rpa_x * rpb_x);

        fints_yyz[i] += faa_yyz * (fe_0 * rpa_x + (1.0 / 2.0) * fe_0 * rpb_x + rpa_x * rpa_x * rpb_x);

        fints_yzz[i] += faa_yzz * (fe_0 * rpa_x + (1.0 / 2.0) * fe_0 * rpb_x + rpa_x * rpa_x * rpb_x);

        fints_zzz[i] += faa_zzz * (fe_0 * rpa_x + (1.0 / 2.0) * fe_0 * rpb_x + rpa_x * rpa_x * rpb_x);
