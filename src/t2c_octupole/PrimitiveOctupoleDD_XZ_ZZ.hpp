#ifndef PrimitiveOctupoleDD_XZ_ZZ
#define PrimitiveOctupoleDD_XZ_ZZ
...
/**
 Evaluates block of primitive <D_XZ|r^3|D_ZZ> integrals.
...
*/
auto compPrimitiveOctupoleDD_XZ_ZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_XZ_ZZ */
