#ifndef PrimitiveOctupoleDD_YZ_YY
#define PrimitiveOctupoleDD_YZ_YY
...
/**
 Evaluates block of primitive <D_YZ|r^3|D_YY> integrals.
...
*/
auto compPrimitiveOctupoleDD_YZ_YY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_YZ_YY */
