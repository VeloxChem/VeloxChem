#ifndef PrimitiveOctupoleDD_ZZ_ZZ
#define PrimitiveOctupoleDD_ZZ_ZZ
...
/**
 Evaluates block of primitive <D_ZZ|r^3|D_ZZ> integrals.
...
*/
auto compPrimitiveOctupoleDD_ZZ_ZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_ZZ_ZZ */
