#ifndef PrimitiveOctupoleDP_YZ_X
#define PrimitiveOctupoleDP_YZ_X
...
/**
 Evaluates block of primitive <D_YZ|r^3|P_X> integrals.
...
*/
auto compPrimitiveOctupoleDP_YZ_X(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDP_YZ_X */
