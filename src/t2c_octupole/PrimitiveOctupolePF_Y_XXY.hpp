#ifndef PrimitiveOctupolePF_Y_XXY
#define PrimitiveOctupolePF_Y_XXY
...
/**
 Evaluates block of primitive <P_Y|r^3|F_XXY> integrals.
...
*/
auto compPrimitiveOctupolePF_Y_XXY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_Y_XXY */
