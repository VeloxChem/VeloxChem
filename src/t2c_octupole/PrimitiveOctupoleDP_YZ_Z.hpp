#ifndef PrimitiveOctupoleDP_YZ_Z
#define PrimitiveOctupoleDP_YZ_Z
...
/**
 Evaluates block of primitive <D_YZ|r^3|P_Z> integrals.
...
*/
auto compPrimitiveOctupoleDP_YZ_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDP_YZ_Z */
