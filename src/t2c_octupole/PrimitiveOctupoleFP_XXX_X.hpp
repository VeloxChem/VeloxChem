#ifndef PrimitiveOctupoleFP_XXX_X
#define PrimitiveOctupoleFP_XXX_X
...
/**
 Evaluates block of primitive <F_XXX|r^3|P_X> integrals.
...
*/
auto compPrimitiveOctupoleFP_XXX_X(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_XXX_X */
