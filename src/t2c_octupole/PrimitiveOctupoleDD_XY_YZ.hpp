#ifndef PrimitiveOctupoleDD_XY_YZ
#define PrimitiveOctupoleDD_XY_YZ
...
/**
 Evaluates block of primitive <D_XY|r^3|D_YZ> integrals.
...
*/
auto compPrimitiveOctupoleDD_XY_YZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_XY_YZ */
