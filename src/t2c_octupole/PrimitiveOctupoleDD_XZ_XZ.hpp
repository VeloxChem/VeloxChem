#ifndef PrimitiveOctupoleDD_XZ_XZ
#define PrimitiveOctupoleDD_XZ_XZ
...
/**
 Evaluates block of primitive <D_XZ|r^3|D_XZ> integrals.
...
*/
auto compPrimitiveOctupoleDD_XZ_XZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_XZ_XZ */
