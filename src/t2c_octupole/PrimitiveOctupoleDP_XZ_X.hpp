#ifndef PrimitiveOctupoleDP_XZ_X
#define PrimitiveOctupoleDP_XZ_X
...
/**
 Evaluates block of primitive <D_XZ|r^3|P_X> integrals.
...
*/
auto compPrimitiveOctupoleDP_XZ_X(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDP_XZ_X */
