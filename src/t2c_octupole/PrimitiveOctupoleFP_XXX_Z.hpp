#ifndef PrimitiveOctupoleFP_XXX_Z
#define PrimitiveOctupoleFP_XXX_Z
...
/**
 Evaluates block of primitive <F_XXX|r^3|P_Z> integrals.
...
*/
auto compPrimitiveOctupoleFP_XXX_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_XXX_Z */
