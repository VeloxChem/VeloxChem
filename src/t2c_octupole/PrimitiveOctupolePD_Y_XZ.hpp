#ifndef PrimitiveOctupolePD_Y_XZ
#define PrimitiveOctupolePD_Y_XZ
...
/**
 Evaluates block of primitive <P_Y|r^3|D_XZ> integrals.
...
*/
auto compPrimitiveOctupolePD_Y_XZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePD_Y_XZ */
