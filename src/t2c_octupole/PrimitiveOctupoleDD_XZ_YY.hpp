#ifndef PrimitiveOctupoleDD_XZ_YY
#define PrimitiveOctupoleDD_XZ_YY
...
/**
 Evaluates block of primitive <D_XZ|r^3|D_YY> integrals.
...
*/
auto compPrimitiveOctupoleDD_XZ_YY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_XZ_YY */
