#ifndef PrimitiveOctupoleDD_XY_ZZ
#define PrimitiveOctupoleDD_XY_ZZ
...
/**
 Evaluates block of primitive <D_XY|r^3|D_ZZ> integrals.
...
*/
auto compPrimitiveOctupoleDD_XY_ZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_XY_ZZ */
