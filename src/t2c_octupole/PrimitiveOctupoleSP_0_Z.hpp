#ifndef PrimitiveOctupoleSP_0_Z
#define PrimitiveOctupoleSP_0_Z
...
/**
 Evaluates block of primitive <S_0|r^3|P_Z> integrals.
...
*/
auto compPrimitiveOctupoleSP_0_Z(TDoubleArray&       buffer_xxx,
