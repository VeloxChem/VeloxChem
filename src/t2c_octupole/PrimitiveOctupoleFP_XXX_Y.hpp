#ifndef PrimitiveOctupoleFP_XXX_Y
#define PrimitiveOctupoleFP_XXX_Y
...
/**
 Evaluates block of primitive <F_XXX|r^3|P_Y> integrals.
...
*/
auto compPrimitiveOctupoleFP_XXX_Y(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_XXX_Y */
