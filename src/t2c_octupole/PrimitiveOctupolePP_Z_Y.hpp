#ifndef PrimitiveOctupolePP_Z_Y
#define PrimitiveOctupolePP_Z_Y
...
/**
 Evaluates block of primitive <P_Z|r^3|P_Y> integrals.
...
*/
auto compPrimitiveOctupolePP_Z_Y(TDoubleArray&       buffer_xxx,
