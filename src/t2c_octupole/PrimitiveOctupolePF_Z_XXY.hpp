#ifndef PrimitiveOctupolePF_Z_XXY
#define PrimitiveOctupolePF_Z_XXY
...
/**
 Evaluates block of primitive <P_Z|r^3|F_XXY> integrals.
...
*/
auto compPrimitiveOctupolePF_Z_XXY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_Z_XXY */
