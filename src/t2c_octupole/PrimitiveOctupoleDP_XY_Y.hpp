#ifndef PrimitiveOctupoleDP_XY_Y
#define PrimitiveOctupoleDP_XY_Y
...
/**
 Evaluates block of primitive <D_XY|r^3|P_Y> integrals.
...
*/
auto compPrimitiveOctupoleDP_XY_Y(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDP_XY_Y */
