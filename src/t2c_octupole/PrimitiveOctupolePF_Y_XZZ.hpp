#ifndef PrimitiveOctupolePF_Y_XZZ
#define PrimitiveOctupolePF_Y_XZZ
...
/**
 Evaluates block of primitive <P_Y|r^3|F_XZZ> integrals.
...
*/
auto compPrimitiveOctupolePF_Y_XZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_Y_XZZ */
