#ifndef PrimitiveOctupoleDD_XZ_YZ
#define PrimitiveOctupoleDD_XZ_YZ
...
/**
 Evaluates block of primitive <D_XZ|r^3|D_YZ> integrals.
...
*/
auto compPrimitiveOctupoleDD_XZ_YZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_XZ_YZ */
