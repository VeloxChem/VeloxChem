#ifndef PrimitiveOctupoleDD_YY_YY
#define PrimitiveOctupoleDD_YY_YY
...
/**
 Evaluates block of primitive <D_YY|r^3|D_YY> integrals.
...
*/
auto compPrimitiveOctupoleDD_YY_YY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_YY_YY */
