#ifndef PrimitiveOctupoleDD_XY_XY
#define PrimitiveOctupoleDD_XY_XY
...
/**
 Evaluates block of primitive <D_XY|r^3|D_XY> integrals.
...
*/
auto compPrimitiveOctupoleDD_XY_XY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_XY_XY */
