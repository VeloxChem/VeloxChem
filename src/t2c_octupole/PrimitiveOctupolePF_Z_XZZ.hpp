#ifndef PrimitiveOctupolePF_Z_XZZ
#define PrimitiveOctupolePF_Z_XZZ
...
/**
 Evaluates block of primitive <P_Z|r^3|F_XZZ> integrals.
...
*/
auto compPrimitiveOctupolePF_Z_XZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_Z_XZZ */
