#ifndef OctupoleRecPS_hpp
#define OctupoleRecPS_hpp
...
/**
 Evaluates <P|r^3|S>  integrals for given pair of GTOs blocks.
...
*/
auto compOctupolePS(CSubMatrix*      matrix_xxx,
