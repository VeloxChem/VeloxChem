#ifndef PrimitiveOctupoleDD_XX_XX
#define PrimitiveOctupoleDD_XX_XX
...
/**
 Evaluates block of primitive <D_XX|r^3|D_XX> integrals.
...
*/
auto compPrimitiveOctupoleDD_XX_XX(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_XX_XX */
