#ifndef PrimitiveOctupoleFP_XXY_Z
#define PrimitiveOctupoleFP_XXY_Z
...
/**
 Evaluates block of primitive <F_XXY|r^3|P_Z> integrals.
...
*/
auto compPrimitiveOctupoleFP_XXY_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_XXY_Z */
