#ifndef PrimitiveOctupoleDP_ZZ_X
#define PrimitiveOctupoleDP_ZZ_X
...
/**
 Evaluates block of primitive <D_ZZ|r^3|P_X> integrals.
...
*/
auto compPrimitiveOctupoleDP_ZZ_X(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDP_ZZ_X */
