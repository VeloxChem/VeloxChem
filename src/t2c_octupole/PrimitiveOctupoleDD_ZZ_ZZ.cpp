...
#pragma omp simd aligned(fints_xxx,     \
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xxx[i] += faa_xxx * (2.0 * fe_0 * rpa_z * rpb_z + (1.0 / 2.0) * fe_0 * rpa_z * rpa_z + (1.0 / 2.0) * fe_0 * rpb_z * rpb_z +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_z * rpa_z * rpb_z * rpb_z);

        fints_xxy[i] += faa_xxy * (2.0 * fe_0 * rpa_z * rpb_z + (1.0 / 2.0) * fe_0 * rpa_z * rpa_z + (1.0 / 2.0) * fe_0 * rpb_z * rpb_z +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_z * rpa_z * rpb_z * rpb_z);

        fints_xxz[i] += faa_xx * (fe_0 * rpa_z * rpb_z * rpb_z + fe_0 * rpa_z * rpa_z * rpb_z + (3.0 / 2.0) * fe_0 * fe_0 * rpa_z +
                                  (3.0 / 2.0) * fe_0 * fe_0 * rpb_z);

        fints_xxz[i] += faa_xxz * (2.0 * fe_0 * rpa_z * rpb_z + (1.0 / 2.0) * fe_0 * rpa_z * rpa_z + (1.0 / 2.0) * fe_0 * rpb_z * rpb_z +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_z * rpa_z * rpb_z * rpb_z);

        fints_xyy[i] += faa_xyy * (2.0 * fe_0 * rpa_z * rpb_z + (1.0 / 2.0) * fe_0 * rpa_z * rpa_z + (1.0 / 2.0) * fe_0 * rpb_z * rpb_z +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_z * rpa_z * rpb_z * rpb_z);

        fints_xyz[i] += faa_xy * (fe_0 * rpa_z * rpb_z * rpb_z + fe_0 * rpa_z * rpa_z * rpb_z + (3.0 / 2.0) * fe_0 * fe_0 * rpa_z +
                                  (3.0 / 2.0) * fe_0 * fe_0 * rpb_z);

        fints_xyz[i] += faa_xyz * (2.0 * fe_0 * rpa_z * rpb_z + (1.0 / 2.0) * fe_0 * rpa_z * rpa_z + (1.0 / 2.0) * fe_0 * rpb_z * rpb_z +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_z * rpa_z * rpb_z * rpb_z);

        fints_xzz[i] += faa_x * (2.0 * fe_0 * fe_0 * rpa_z * rpb_z + (1.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_z +
                                 (1.0 / 2.0) * fe_0 * fe_0 * rpb_z * rpb_z + (3.0 / 2.0) * fe_0 * fe_0 * fe_0);

        fints_xzz[i] += faa_xz * (2.0 * fe_0 * rpa_z * rpb_z * rpb_z + 2.0 * fe_0 * rpa_z * rpa_z * rpb_z + 3.0 * fe_0 * fe_0 * rpa_z +
                                  3.0 * fe_0 * fe_0 * rpb_z);

        fints_xzz[i] += faa_xzz * (2.0 * fe_0 * rpa_z * rpb_z + (1.0 / 2.0) * fe_0 * rpa_z * rpa_z + (1.0 / 2.0) * fe_0 * rpb_z * rpb_z +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_z * rpa_z * rpb_z * rpb_z);

        fints_yyy[i] += faa_yyy * (2.0 * fe_0 * rpa_z * rpb_z + (1.0 / 2.0) * fe_0 * rpa_z * rpa_z + (1.0 / 2.0) * fe_0 * rpb_z * rpb_z +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_z * rpa_z * rpb_z * rpb_z);

        fints_yyz[i] += faa_yy * (fe_0 * rpa_z * rpb_z * rpb_z + fe_0 * rpa_z * rpa_z * rpb_z + (3.0 / 2.0) * fe_0 * fe_0 * rpa_z +
                                  (3.0 / 2.0) * fe_0 * fe_0 * rpb_z);

        fints_yyz[i] += faa_yyz * (2.0 * fe_0 * rpa_z * rpb_z + (1.0 / 2.0) * fe_0 * rpa_z * rpa_z + (1.0 / 2.0) * fe_0 * rpb_z * rpb_z +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_z * rpa_z * rpb_z * rpb_z);

        fints_yzz[i] += faa_y * (2.0 * fe_0 * fe_0 * rpa_z * rpb_z + (1.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_z +
                                 (1.0 / 2.0) * fe_0 * fe_0 * rpb_z * rpb_z + (3.0 / 2.0) * fe_0 * fe_0 * fe_0);

        fints_yzz[i] += faa_yz * (2.0 * fe_0 * rpa_z * rpb_z * rpb_z + 2.0 * fe_0 * rpa_z * rpa_z * rpb_z + 3.0 * fe_0 * fe_0 * rpa_z +
                                  3.0 * fe_0 * fe_0 * rpb_z);

        fints_yzz[i] += faa_yzz * (2.0 * fe_0 * rpa_z * rpb_z + (1.0 / 2.0) * fe_0 * rpa_z * rpa_z + (1.0 / 2.0) * fe_0 * rpb_z * rpb_z +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_z * rpa_z * rpb_z * rpb_z);

        fints_zzz[i] += fss * ((3.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_z + (3.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpb_z);

        fints_zzz[i] += faa_z * (6.0 * fe_0 * fe_0 * rpa_z * rpb_z + (3.0 / 2.0) * fe_0 * fe_0 * rpa_z * rpa_z +
                                 (3.0 / 2.0) * fe_0 * fe_0 * rpb_z * rpb_z + (9.0 / 2.0) * fe_0 * fe_0 * fe_0);

        fints_zzz[i] += faa_zz * (3.0 * fe_0 * rpa_z * rpb_z * rpb_z + 3.0 * fe_0 * rpa_z * rpa_z * rpb_z + (9.0 / 2.0) * fe_0 * fe_0 * rpa_z +
                                  (9.0 / 2.0) * fe_0 * fe_0 * rpb_z);

        fints_zzz[i] += faa_zzz * (2.0 * fe_0 * rpa_z * rpb_z + (1.0 / 2.0) * fe_0 * rpa_z * rpa_z + (1.0 / 2.0) * fe_0 * rpb_z * rpb_z +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_z * rpa_z * rpb_z * rpb_z);
    }
}
