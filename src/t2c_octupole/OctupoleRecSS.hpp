#ifndef OctupoleRecSS_hpp
#define OctupoleRecSS_hpp
...
/**
 Evaluates <S|r^3|S>  integrals for given GTOs block.
...
*/
auto compOctupoleSS(CSubMatrix*      matrix_xxx,
...
/**
 Evaluates <S|r^3|S>  integrals for given pair of GTOs blocks.
