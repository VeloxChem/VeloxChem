#ifndef PrimitiveOctupolePF_Z_XYZ
#define PrimitiveOctupolePF_Z_XYZ
...
/**
 Evaluates block of primitive <P_Z|r^3|F_XYZ> integrals.
...
*/
auto compPrimitiveOctupolePF_Z_XYZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_Z_XYZ */
