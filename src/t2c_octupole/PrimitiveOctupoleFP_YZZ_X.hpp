#ifndef PrimitiveOctupoleFP_YZZ_X
#define PrimitiveOctupoleFP_YZZ_X
...
/**
 Evaluates block of primitive <F_YZZ|r^3|P_X> integrals.
...
*/
auto compPrimitiveOctupoleFP_YZZ_X(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_YZZ_X */
