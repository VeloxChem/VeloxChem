#ifndef PrimitiveOctupoleDP_YY_Y
#define PrimitiveOctupoleDP_YY_Y
...
/**
 Evaluates block of primitive <D_YY|r^3|P_Y> integrals.
...
*/
auto compPrimitiveOctupoleDP_YY_Y(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDP_YY_Y */
