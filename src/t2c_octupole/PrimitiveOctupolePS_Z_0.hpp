#ifndef PrimitiveOctupolePS_Z_0
#define PrimitiveOctupolePS_Z_0
...
/**
 Evaluates block of primitive <P_Z|r^3|S_0> integrals.
...
*/
auto compPrimitiveOctupolePS_Z_0(TDoubleArray&       buffer_xxx,
