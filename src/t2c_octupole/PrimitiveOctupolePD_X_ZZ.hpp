#ifndef PrimitiveOctupolePD_X_ZZ
#define PrimitiveOctupolePD_X_ZZ
...
/**
 Evaluates block of primitive <P_X|r^3|D_ZZ> integrals.
...
*/
auto compPrimitiveOctupolePD_X_ZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePD_X_ZZ */
