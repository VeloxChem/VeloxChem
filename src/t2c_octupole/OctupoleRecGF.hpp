#ifndef OctupoleRecGF_hpp
#define OctupoleRecGF_hpp
...
/**
 Evaluates <G|r^3|F>  integrals for given pair of GTOs blocks.
...
*/
auto compOctupoleGF(CSubMatrix*      matrix_xxx,
