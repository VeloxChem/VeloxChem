#ifndef PrimitiveOctupolePP_X_X
#define PrimitiveOctupolePP_X_X
...
/**
 Evaluates block of primitive <P_X|r^3|P_X> integrals.
...
*/
auto compPrimitiveOctupolePP_X_X(TDoubleArray&       buffer_xxx,
