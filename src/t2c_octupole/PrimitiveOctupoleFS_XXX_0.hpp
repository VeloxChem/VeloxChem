#ifndef PrimitiveOctupoleFS_XXX_0
#define PrimitiveOctupoleFS_XXX_0
...
/**
 Evaluates block of primitive <F_XXX|r^3|S_0> integrals.
...
*/
auto compPrimitiveOctupoleFS_XXX_0(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFS_XXX_0 */
