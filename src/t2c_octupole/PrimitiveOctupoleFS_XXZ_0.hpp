#ifndef PrimitiveOctupoleFS_XXZ_0
#define PrimitiveOctupoleFS_XXZ_0
...
/**
 Evaluates block of primitive <F_XXZ|r^3|S_0> integrals.
...
*/
auto compPrimitiveOctupoleFS_XXZ_0(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFS_XXZ_0 */
