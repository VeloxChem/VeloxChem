#ifndef PrimitiveOctupolePD_Y_ZZ
#define PrimitiveOctupolePD_Y_ZZ
...
/**
 Evaluates block of primitive <P_Y|r^3|D_ZZ> integrals.
...
*/
auto compPrimitiveOctupolePD_Y_ZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePD_Y_ZZ */
