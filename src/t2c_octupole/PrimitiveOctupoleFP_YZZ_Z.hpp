#ifndef PrimitiveOctupoleFP_YZZ_Z
#define PrimitiveOctupoleFP_YZZ_Z
...
/**
 Evaluates block of primitive <F_YZZ|r^3|P_Z> integrals.
...
*/
auto compPrimitiveOctupoleFP_YZZ_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_YZZ_Z */
