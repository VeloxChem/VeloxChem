#ifndef PrimitiveOctupoleFP_XYZ_X
#define PrimitiveOctupoleFP_XYZ_X
...
/**
 Evaluates block of primitive <F_XYZ|r^3|P_X> integrals.
...
*/
auto compPrimitiveOctupoleFP_XYZ_X(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_XYZ_X */
