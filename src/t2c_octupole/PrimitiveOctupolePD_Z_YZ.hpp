#ifndef PrimitiveOctupolePD_Z_YZ
#define PrimitiveOctupolePD_Z_YZ
...
/**
 Evaluates block of primitive <P_Z|r^3|D_YZ> integrals.
...
*/
auto compPrimitiveOctupolePD_Z_YZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePD_Z_YZ */
