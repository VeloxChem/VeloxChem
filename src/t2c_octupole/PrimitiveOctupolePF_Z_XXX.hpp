#ifndef PrimitiveOctupolePF_Z_XXX
#define PrimitiveOctupolePF_Z_XXX
...
/**
 Evaluates block of primitive <P_Z|r^3|F_XXX> integrals.
...
*/
auto compPrimitiveOctupolePF_Z_XXX(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_Z_XXX */
