#ifndef PrimitiveOctupolePF_X_YYZ
#define PrimitiveOctupolePF_X_YYZ
...
/**
 Evaluates block of primitive <P_X|r^3|F_YYZ> integrals.
...
*/
auto compPrimitiveOctupolePF_X_YYZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_X_YYZ */
