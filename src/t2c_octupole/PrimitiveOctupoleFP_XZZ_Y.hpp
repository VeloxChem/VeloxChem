#ifndef PrimitiveOctupoleFP_XZZ_Y
#define PrimitiveOctupoleFP_XZZ_Y
...
/**
 Evaluates block of primitive <F_XZZ|r^3|P_Y> integrals.
...
*/
auto compPrimitiveOctupoleFP_XZZ_Y(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_XZZ_Y */
