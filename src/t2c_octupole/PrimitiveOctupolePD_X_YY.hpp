#ifndef PrimitiveOctupolePD_X_YY
#define PrimitiveOctupolePD_X_YY
...
/**
 Evaluates block of primitive <P_X|r^3|D_YY> integrals.
...
*/
auto compPrimitiveOctupolePD_X_YY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePD_X_YY */
