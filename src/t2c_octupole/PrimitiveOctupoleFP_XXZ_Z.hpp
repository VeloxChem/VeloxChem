#ifndef PrimitiveOctupoleFP_XXZ_Z
#define PrimitiveOctupoleFP_XXZ_Z
...
/**
 Evaluates block of primitive <F_XXZ|r^3|P_Z> integrals.
...
*/
auto compPrimitiveOctupoleFP_XXZ_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_XXZ_Z */
