#ifndef PrimitiveOctupoleDP_XZ_Y
#define PrimitiveOctupoleDP_XZ_Y
...
/**
 Evaluates block of primitive <D_XZ|r^3|P_Y> integrals.
...
*/
auto compPrimitiveOctupoleDP_XZ_Y(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDP_XZ_Y */
