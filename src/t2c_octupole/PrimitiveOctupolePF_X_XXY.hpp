#ifndef PrimitiveOctupolePF_X_XXY
#define PrimitiveOctupolePF_X_XXY
...
/**
 Evaluates block of primitive <P_X|r^3|F_XXY> integrals.
...
*/
auto compPrimitiveOctupolePF_X_XXY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_X_XXY */
