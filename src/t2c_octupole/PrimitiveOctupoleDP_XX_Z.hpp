#ifndef PrimitiveOctupoleDP_XX_Z
#define PrimitiveOctupoleDP_XX_Z
...
/**
 Evaluates block of primitive <D_XX|r^3|P_Z> integrals.
...
*/
auto compPrimitiveOctupoleDP_XX_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDP_XX_Z */
