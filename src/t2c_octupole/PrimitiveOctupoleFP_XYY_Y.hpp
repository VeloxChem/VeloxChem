#ifndef PrimitiveOctupoleFP_XYY_Y
#define PrimitiveOctupoleFP_XYY_Y
...
/**
 Evaluates block of primitive <F_XYY|r^3|P_Y> integrals.
...
*/
auto compPrimitiveOctupoleFP_XYY_Y(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_XYY_Y */
