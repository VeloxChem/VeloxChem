#ifndef PrimitiveOctupolePD_Z_XY
#define PrimitiveOctupolePD_Z_XY
...
/**
 Evaluates block of primitive <P_Z|r^3|D_XY> integrals.
...
*/
auto compPrimitiveOctupolePD_Z_XY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePD_Z_XY */
