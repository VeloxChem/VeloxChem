#ifndef PrimitiveOctupolePF_Y_YZZ
#define PrimitiveOctupolePF_Y_YZZ
...
/**
 Evaluates block of primitive <P_Y|r^3|F_YZZ> integrals.
...
*/
auto compPrimitiveOctupolePF_Y_YZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_Y_YZZ */
