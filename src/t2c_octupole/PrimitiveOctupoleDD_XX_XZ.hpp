#ifndef PrimitiveOctupoleDD_XX_XZ
#define PrimitiveOctupoleDD_XX_XZ
...
/**
 Evaluates block of primitive <D_XX|r^3|D_XZ> integrals.
...
*/
auto compPrimitiveOctupoleDD_XX_XZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_XX_XZ */
