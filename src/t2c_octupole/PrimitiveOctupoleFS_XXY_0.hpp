#ifndef PrimitiveOctupoleFS_XXY_0
#define PrimitiveOctupoleFS_XXY_0
...
/**
 Evaluates block of primitive <F_XXY|r^3|S_0> integrals.
...
*/
auto compPrimitiveOctupoleFS_XXY_0(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFS_XXY_0 */
