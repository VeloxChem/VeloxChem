        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    octurec::compPrimitiveOctupolePP_X_X(buffer_xxx,
                                                         buffer_xxy,
                                                         buffer_xxz,
                                                         buffer_xyy,
                                                         buffer_xyz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    octurec::compPrimitiveOctupolePP_X_Y(buffer_xxx,
                                                         buffer_xxy,
                                                         buffer_xxz,
                                                         buffer_xyy,
                                                         buffer_xyz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    octurec::compPrimitiveOctupolePP_X_Z(buffer_xxx,
                                                         buffer_xxy,
                                                         buffer_xxz,
                                                         buffer_xyy,
                                                         buffer_xyz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    octurec::compPrimitiveOctupolePP_Y_X(buffer_xxx,
                                                         buffer_xxy,
                                                         buffer_xxz,
                                                         buffer_xyy,
                                                         buffer_xyz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    octurec::compPrimitiveOctupolePP_Y_Y(buffer_xxx,
                                                         buffer_xxy,
                                                         buffer_xxz,
                                                         buffer_xyy,
                                                         buffer_xyz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    octurec::compPrimitiveOctupolePP_Y_Z(buffer_xxx,
                                                         buffer_xxy,
                                                         buffer_xxz,
                                                         buffer_xyy,
                                                         buffer_xyz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    octurec::compPrimitiveOctupolePP_Z_X(buffer_xxx,
                                                         buffer_xxy,
                                                         buffer_xxz,
                                                         buffer_xyy,
                                                         buffer_xyz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    octurec::compPrimitiveOctupolePP_Z_Y(buffer_xxx,
                                                         buffer_xxy,
                                                         buffer_xxz,
                                                         buffer_xyy,
                                                         buffer_xyz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    octurec::compPrimitiveOctupolePP_Z_Z(buffer_xxx,
                                                         buffer_xxy,
                                                         buffer_xxz,
                                                         buffer_xyy,
                                                         buffer_xyz,
