#ifndef OctupoleRecSD_hpp
#define OctupoleRecSD_hpp
...
/**
 Evaluates <S|r^3|D>  integrals for given pair of GTOs blocks.
...
*/
auto compOctupoleSD(CSubMatrix*      matrix_xxx,
