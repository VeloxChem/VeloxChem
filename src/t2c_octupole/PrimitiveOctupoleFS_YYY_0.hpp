#ifndef PrimitiveOctupoleFS_YYY_0
#define PrimitiveOctupoleFS_YYY_0
...
/**
 Evaluates block of primitive <F_YYY|r^3|S_0> integrals.
...
*/
auto compPrimitiveOctupoleFS_YYY_0(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFS_YYY_0 */
