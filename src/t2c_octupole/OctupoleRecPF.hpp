#ifndef OctupoleRecPF_hpp
#define OctupoleRecPF_hpp
...
/**
 Evaluates <P|r^3|F>  integrals for given pair of GTOs blocks.
...
*/
auto compOctupolePF(CSubMatrix*      matrix_xxx,
