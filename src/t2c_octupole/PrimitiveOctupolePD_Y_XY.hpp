#ifndef PrimitiveOctupolePD_Y_XY
#define PrimitiveOctupolePD_Y_XY
...
/**
 Evaluates block of primitive <P_Y|r^3|D_XY> integrals.
...
*/
auto compPrimitiveOctupolePD_Y_XY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePD_Y_XY */
