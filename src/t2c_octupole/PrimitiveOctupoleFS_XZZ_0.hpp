#ifndef PrimitiveOctupoleFS_XZZ_0
#define PrimitiveOctupoleFS_XZZ_0
...
/**
 Evaluates block of primitive <F_XZZ|r^3|S_0> integrals.
...
*/
auto compPrimitiveOctupoleFS_XZZ_0(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFS_XZZ_0 */
