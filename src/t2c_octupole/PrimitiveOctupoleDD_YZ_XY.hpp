#ifndef PrimitiveOctupoleDD_YZ_XY
#define PrimitiveOctupoleDD_YZ_XY
...
/**
 Evaluates block of primitive <D_YZ|r^3|D_XY> integrals.
...
*/
auto compPrimitiveOctupoleDD_YZ_XY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_YZ_XY */
