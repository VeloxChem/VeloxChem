#ifndef PrimitiveOctupoleDS_XZ_0
#define PrimitiveOctupoleDS_XZ_0
...
/**
 Evaluates block of primitive <D_XZ|r^3|S_0> integrals.
...
*/
auto compPrimitiveOctupoleDS_XZ_0(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDS_XZ_0 */
