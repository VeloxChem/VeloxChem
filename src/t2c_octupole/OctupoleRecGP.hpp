#ifndef OctupoleRecGP_hpp
#define OctupoleRecGP_hpp
...
/**
 Evaluates <G|r^3|P>  integrals for given pair of GTOs blocks.
...
*/
auto compOctupoleGP(CSubMatrix*      matrix_xxx,
