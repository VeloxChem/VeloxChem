#ifndef PrimitiveOctupoleFP_XYZ_Z
#define PrimitiveOctupoleFP_XYZ_Z
...
/**
 Evaluates block of primitive <F_XYZ|r^3|P_Z> integrals.
...
*/
auto compPrimitiveOctupoleFP_XYZ_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_XYZ_Z */
