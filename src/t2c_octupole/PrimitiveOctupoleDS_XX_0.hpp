#ifndef PrimitiveOctupoleDS_XX_0
#define PrimitiveOctupoleDS_XX_0
...
/**
 Evaluates block of primitive <D_XX|r^3|S_0> integrals.
...
*/
auto compPrimitiveOctupoleDS_XX_0(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDS_XX_0 */
