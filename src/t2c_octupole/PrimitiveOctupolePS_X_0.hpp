#ifndef PrimitiveOctupolePS_X_0
#define PrimitiveOctupolePS_X_0
...
/**
 Evaluates block of primitive <P_X|r^3|S_0> integrals.
...
*/
auto compPrimitiveOctupolePS_X_0(TDoubleArray&       buffer_xxx,
