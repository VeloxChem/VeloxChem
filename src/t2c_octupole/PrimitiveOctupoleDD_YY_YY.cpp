...
#pragma omp simd aligned(fints_xxx,     \
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xxx[i] += faa_xxx * (2.0 * fe_0 * rpa_y * rpb_y + (1.0 / 2.0) * fe_0 * rpa_y * rpa_y + (1.0 / 2.0) * fe_0 * rpb_y * rpb_y +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_y * rpa_y * rpb_y * rpb_y);

        fints_xxy[i] += faa_xx * (fe_0 * rpa_y * rpb_y * rpb_y + fe_0 * rpa_y * rpa_y * rpb_y + (3.0 / 2.0) * fe_0 * fe_0 * rpa_y +
                                  (3.0 / 2.0) * fe_0 * fe_0 * rpb_y);

        fints_xxy[i] += faa_xxy * (2.0 * fe_0 * rpa_y * rpb_y + (1.0 / 2.0) * fe_0 * rpa_y * rpa_y + (1.0 / 2.0) * fe_0 * rpb_y * rpb_y +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_y * rpa_y * rpb_y * rpb_y);

        fints_xxz[i] += faa_xxz * (2.0 * fe_0 * rpa_y * rpb_y + (1.0 / 2.0) * fe_0 * rpa_y * rpa_y + (1.0 / 2.0) * fe_0 * rpb_y * rpb_y +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_y * rpa_y * rpb_y * rpb_y);

        fints_xyy[i] += faa_x * (2.0 * fe_0 * fe_0 * rpa_y * rpb_y + (1.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_y +
                                 (1.0 / 2.0) * fe_0 * fe_0 * rpb_y * rpb_y + (3.0 / 2.0) * fe_0 * fe_0 * fe_0);

        fints_xyy[i] += faa_xy * (2.0 * fe_0 * rpa_y * rpb_y * rpb_y + 2.0 * fe_0 * rpa_y * rpa_y * rpb_y + 3.0 * fe_0 * fe_0 * rpa_y +
                                  3.0 * fe_0 * fe_0 * rpb_y);

        fints_xyy[i] += faa_xyy * (2.0 * fe_0 * rpa_y * rpb_y + (1.0 / 2.0) * fe_0 * rpa_y * rpa_y + (1.0 / 2.0) * fe_0 * rpb_y * rpb_y +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_y * rpa_y * rpb_y * rpb_y);

        fints_xyz[i] += faa_xz * (fe_0 * rpa_y * rpb_y * rpb_y + fe_0 * rpa_y * rpa_y * rpb_y + (3.0 / 2.0) * fe_0 * fe_0 * rpa_y +
                                  (3.0 / 2.0) * fe_0 * fe_0 * rpb_y);

        fints_xyz[i] += faa_xyz * (2.0 * fe_0 * rpa_y * rpb_y + (1.0 / 2.0) * fe_0 * rpa_y * rpa_y + (1.0 / 2.0) * fe_0 * rpb_y * rpb_y +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_y * rpa_y * rpb_y * rpb_y);

        fints_xzz[i] += faa_xzz * (2.0 * fe_0 * rpa_y * rpb_y + (1.0 / 2.0) * fe_0 * rpa_y * rpa_y + (1.0 / 2.0) * fe_0 * rpb_y * rpb_y +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_y * rpa_y * rpb_y * rpb_y);

        fints_yyy[i] += fss * ((3.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpa_y + (3.0 / 2.0) * fe_0 * fe_0 * fe_0 * rpb_y);

        fints_yyy[i] += faa_y * (6.0 * fe_0 * fe_0 * rpa_y * rpb_y + (3.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_y +
                                 (3.0 / 2.0) * fe_0 * fe_0 * rpb_y * rpb_y + (9.0 / 2.0) * fe_0 * fe_0 * fe_0);

        fints_yyy[i] += faa_yy * (3.0 * fe_0 * rpa_y * rpb_y * rpb_y + 3.0 * fe_0 * rpa_y * rpa_y * rpb_y + (9.0 / 2.0) * fe_0 * fe_0 * rpa_y +
                                  (9.0 / 2.0) * fe_0 * fe_0 * rpb_y);

        fints_yyy[i] += faa_yyy * (2.0 * fe_0 * rpa_y * rpb_y + (1.0 / 2.0) * fe_0 * rpa_y * rpa_y + (1.0 / 2.0) * fe_0 * rpb_y * rpb_y +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_y * rpa_y * rpb_y * rpb_y);

        fints_yyz[i] += faa_z * (2.0 * fe_0 * fe_0 * rpa_y * rpb_y + (1.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpa_y +
                                 (1.0 / 2.0) * fe_0 * fe_0 * rpb_y * rpb_y + (3.0 / 2.0) * fe_0 * fe_0 * fe_0);

        fints_yyz[i] += faa_yz * (2.0 * fe_0 * rpa_y * rpb_y * rpb_y + 2.0 * fe_0 * rpa_y * rpa_y * rpb_y + 3.0 * fe_0 * fe_0 * rpa_y +
                                  3.0 * fe_0 * fe_0 * rpb_y);

        fints_yyz[i] += faa_yyz * (2.0 * fe_0 * rpa_y * rpb_y + (1.0 / 2.0) * fe_0 * rpa_y * rpa_y + (1.0 / 2.0) * fe_0 * rpb_y * rpb_y +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_y * rpa_y * rpb_y * rpb_y);

        fints_yzz[i] += faa_zz * (fe_0 * rpa_y * rpb_y * rpb_y + fe_0 * rpa_y * rpa_y * rpb_y + (3.0 / 2.0) * fe_0 * fe_0 * rpa_y +
                                  (3.0 / 2.0) * fe_0 * fe_0 * rpb_y);

        fints_yzz[i] += faa_yzz * (2.0 * fe_0 * rpa_y * rpb_y + (1.0 / 2.0) * fe_0 * rpa_y * rpa_y + (1.0 / 2.0) * fe_0 * rpb_y * rpb_y +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_y * rpa_y * rpb_y * rpb_y);

        fints_zzz[i] += faa_zzz * (2.0 * fe_0 * rpa_y * rpb_y + (1.0 / 2.0) * fe_0 * rpa_y * rpa_y + (1.0 / 2.0) * fe_0 * rpb_y * rpb_y +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_y * rpa_y * rpb_y * rpb_y);
    }
}
