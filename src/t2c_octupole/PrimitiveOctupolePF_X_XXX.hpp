#ifndef PrimitiveOctupolePF_X_XXX
#define PrimitiveOctupolePF_X_XXX
...
/**
 Evaluates block of primitive <P_X|r^3|F_XXX> integrals.
...
*/
auto compPrimitiveOctupolePF_X_XXX(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_X_XXX */
