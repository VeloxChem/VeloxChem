#ifndef PrimitiveOctupoleDD_YY_YZ
#define PrimitiveOctupoleDD_YY_YZ
...
/**
 Evaluates block of primitive <D_YY|r^3|D_YZ> integrals.
...
*/
auto compPrimitiveOctupoleDD_YY_YZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_YY_YZ */
