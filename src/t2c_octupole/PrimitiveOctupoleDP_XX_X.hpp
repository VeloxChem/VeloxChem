#ifndef PrimitiveOctupoleDP_XX_X
#define PrimitiveOctupoleDP_XX_X
...
/**
 Evaluates block of primitive <D_XX|r^3|P_X> integrals.
...
*/
auto compPrimitiveOctupoleDP_XX_X(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDP_XX_X */
