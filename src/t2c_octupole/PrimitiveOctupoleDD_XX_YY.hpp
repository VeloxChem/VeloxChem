#ifndef PrimitiveOctupoleDD_XX_YY
#define PrimitiveOctupoleDD_XX_YY
...
/**
 Evaluates block of primitive <D_XX|r^3|D_YY> integrals.
...
*/
auto compPrimitiveOctupoleDD_XX_YY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_XX_YY */
