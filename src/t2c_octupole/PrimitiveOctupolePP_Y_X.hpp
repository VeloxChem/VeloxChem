#ifndef PrimitiveOctupolePP_Y_X
#define PrimitiveOctupolePP_Y_X
...
/**
 Evaluates block of primitive <P_Y|r^3|P_X> integrals.
...
*/
auto compPrimitiveOctupolePP_Y_X(TDoubleArray&       buffer_xxx,
