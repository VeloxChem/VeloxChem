#ifndef PrimitiveOctupoleDD_XY_YY
#define PrimitiveOctupoleDD_XY_YY
...
/**
 Evaluates block of primitive <D_XY|r^3|D_YY> integrals.
...
*/
auto compPrimitiveOctupoleDD_XY_YY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_XY_YY */
