#ifndef PrimitiveOctupoleDS_XY_0
#define PrimitiveOctupoleDS_XY_0
...
/**
 Evaluates block of primitive <D_XY|r^3|S_0> integrals.
...
*/
auto compPrimitiveOctupoleDS_XY_0(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDS_XY_0 */
