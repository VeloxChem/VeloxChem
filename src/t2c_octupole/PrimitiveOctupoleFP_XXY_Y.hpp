#ifndef PrimitiveOctupoleFP_XXY_Y
#define PrimitiveOctupoleFP_XXY_Y
...
/**
 Evaluates block of primitive <F_XXY|r^3|P_Y> integrals.
...
*/
auto compPrimitiveOctupoleFP_XXY_Y(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_XXY_Y */
