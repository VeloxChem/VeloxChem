                             ...
                             const int64_t       ket_dim) -> void
{
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xxx[i] += faa_xxx * rpb_y * rpb_x;
        ...
        fints_xxy[i] += faa_xxy * rpb_y * rpb_x;

        fints_xxz[i] += faa_xz * fe_0 * rpb_y;

        fints_xxz[i] += faa_xxz * rpb_y * rpb_x;
        ...
        fints_xyy[i] += faa_xyy * rpb_y * rpb_x;
        ...
        fints_xyz[i] += faa_xyz * rpb_y * rpb_x;

        fints_xzz[i] += faa_zz * (1.0 / 2.0) * fe_0 * rpb_y;

        fints_xzz[i] += faa_xzz * rpb_y * rpb_x;

        fints_yyy[i] += faa_yy * (3.0 / 2.0) * fe_0 * rpb_x;

        fints_yyy[i] += faa_yyy * rpb_y * rpb_x;

        fints_yyz[i] += faa_yz * fe_0 * rpb_x;

        fints_yyz[i] += faa_yyz * rpb_y * rpb_x;

        fints_yzz[i] += faa_zz * (1.0 / 2.0) * fe_0 * rpb_x;

        fints_yzz[i] += faa_yzz * rpb_y * rpb_x;

        fints_zzz[i] += faa_zzz * rpb_y * rpb_x;
