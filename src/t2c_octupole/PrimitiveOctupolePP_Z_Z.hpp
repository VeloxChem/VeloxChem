#ifndef PrimitiveOctupolePP_Z_Z
#define PrimitiveOctupolePP_Z_Z
...
/**
 Evaluates block of primitive <P_Z|r^3|P_Z> integrals.
...
*/
auto compPrimitiveOctupolePP_Z_Z(TDoubleArray&       buffer_xxx,
