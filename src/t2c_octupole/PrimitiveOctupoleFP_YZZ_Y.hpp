#ifndef PrimitiveOctupoleFP_YZZ_Y
#define PrimitiveOctupoleFP_YZZ_Y
...
/**
 Evaluates block of primitive <F_YZZ|r^3|P_Y> integrals.
...
*/
auto compPrimitiveOctupoleFP_YZZ_Y(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_YZZ_Y */
