#ifndef PrimitiveOctupoleDD_XY_XX
#define PrimitiveOctupoleDD_XY_XX
...
/**
 Evaluates block of primitive <D_XY|r^3|D_XX> integrals.
...
*/
auto compPrimitiveOctupoleDD_XY_XX(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_XY_XX */
