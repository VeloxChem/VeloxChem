                             ...
                             const int64_t       ket_dim) -> void
{
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xxx[i] += faa_xxx * rpa_z * rpa_x * rpb_y;
        ...
        fints_xxy[i] += faa_xxy * rpa_z * rpa_x * rpb_y;
        ...
        fints_xxz[i] += faa_xxz * rpa_z * rpa_x * rpb_y;
        ...
        fints_xyy[i] += faa_xyy * rpa_z * rpa_x * rpb_y;
        ...
        fints_xyz[i] += faa_xyz * rpa_z * rpa_x * rpb_y;
        ...
        fints_xzz[i] += faa_xzz * rpa_z * rpa_x * rpb_y;

        fints_yyy[i] += faa_yy * (3.0 / 2.0) * fe_0 * rpa_z * rpa_x;

        fints_yyy[i] += faa_yyy * rpa_z * rpa_x * rpb_y;
        ...
        fints_yyz[i] += faa_yyz * rpa_z * rpa_x * rpb_y;
        ...
        fints_yzz[i] += faa_yzz * rpa_z * rpa_x * rpb_y;

        fints_zzz[i] += faa_zz * (3.0 / 2.0) * fe_0 * rpa_x * rpb_y;

        fints_zzz[i] += faa_zzz * rpa_z * rpa_x * rpb_y;
