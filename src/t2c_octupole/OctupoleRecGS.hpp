#ifndef OctupoleRecGS_hpp
#define OctupoleRecGS_hpp
...
/**
 Evaluates <G|r^3|S>  integrals for given pair of GTOs blocks.
...
*/
auto compOctupoleGS(CSubMatrix*      matrix_xxx,
