#ifndef PrimitiveOctupoleDD_YZ_YZ
#define PrimitiveOctupoleDD_YZ_YZ
...
/**
 Evaluates block of primitive <D_YZ|r^3|D_YZ> integrals.
...
*/
auto compPrimitiveOctupoleDD_YZ_YZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_YZ_YZ */
