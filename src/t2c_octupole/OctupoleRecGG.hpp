#ifndef OctupoleRecGG_hpp
#define OctupoleRecGG_hpp
...
/**
 Evaluates <G|r^3|G>  integrals for given GTOs block.
...
*/
auto compOctupoleGG(CSubMatrix*      matrix_xxx,
...
/**
 Evaluates <G|r^3|G>  integrals for given pair of GTOs blocks.
