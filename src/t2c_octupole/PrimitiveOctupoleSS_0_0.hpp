#ifndef PrimitiveOctupoleSS_0_0
#define PrimitiveOctupoleSS_0_0
...
/**
 Evaluates block of primitive <S_0|r^3|S_0> integrals.
...
*/
auto compPrimitiveOctupoleSS_0_0(TDoubleArray&       buffer_xxx,
