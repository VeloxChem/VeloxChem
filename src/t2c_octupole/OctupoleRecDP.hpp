#ifndef OctupoleRecDP_hpp
#define OctupoleRecDP_hpp
...
/**
 Evaluates <D|r^3|P>  integrals for given pair of GTOs blocks.
...
*/
auto compOctupoleDP(CSubMatrix*      matrix_xxx,
