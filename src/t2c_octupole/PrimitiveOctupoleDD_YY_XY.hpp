#ifndef PrimitiveOctupoleDD_YY_XY
#define PrimitiveOctupoleDD_YY_XY
...
/**
 Evaluates block of primitive <D_YY|r^3|D_XY> integrals.
...
*/
auto compPrimitiveOctupoleDD_YY_XY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_YY_XY */
