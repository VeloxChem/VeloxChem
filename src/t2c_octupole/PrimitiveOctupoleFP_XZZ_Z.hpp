#ifndef PrimitiveOctupoleFP_XZZ_Z
#define PrimitiveOctupoleFP_XZZ_Z
...
/**
 Evaluates block of primitive <F_XZZ|r^3|P_Z> integrals.
...
*/
auto compPrimitiveOctupoleFP_XZZ_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_XZZ_Z */
