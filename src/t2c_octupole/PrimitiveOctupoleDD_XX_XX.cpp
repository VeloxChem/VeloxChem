...
#pragma omp simd aligned(fints_xxx,     \
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xxx[i] += faa_x * (6.0 * fe_0 * fe_0 * rpa_x * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpa_x +
                                 (3.0 / 2.0) * fe_0 * fe_0 * rpb_x * rpb_x + (9.0 / 2.0) * fe_0 * fe_0 * fe_0);

        fints_xxx[i] += faa_xx * (3.0 * fe_0 * rpa_x * rpb_x * rpb_x + 3.0 * fe_0 * rpa_x * rpa_x * rpb_x + (9.0 / 2.0) * fe_0 * fe_0 * rpa_x +
                                  (9.0 / 2.0) * fe_0 * fe_0 * rpb_x);

        fints_xxx[i] += faa_xxx * (2.0 * fe_0 * rpa_x * rpb_x + (1.0 / 2.0) * fe_0 * rpa_x * rpa_x + (1.0 / 2.0) * fe_0 * rpb_x * rpb_x +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_x * rpa_x * rpb_x * rpb_x);

        fints_xxy[i] += faa_y * (2.0 * fe_0 * fe_0 * rpa_x * rpb_x + (1.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpa_x +
                                 (1.0 / 2.0) * fe_0 * fe_0 * rpb_x * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * fe_0);

        fints_xxy[i] += faa_xy * (2.0 * fe_0 * rpa_x * rpb_x * rpb_x + 2.0 * fe_0 * rpa_x * rpa_x * rpb_x + 3.0 * fe_0 * fe_0 * rpa_x +
                                  3.0 * fe_0 * fe_0 * rpb_x);

        fints_xxy[i] += faa_xxy * (2.0 * fe_0 * rpa_x * rpb_x + (1.0 / 2.0) * fe_0 * rpa_x * rpa_x + (1.0 / 2.0) * fe_0 * rpb_x * rpb_x +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_x * rpa_x * rpb_x * rpb_x);

        fints_xxz[i] += faa_z * (2.0 * fe_0 * fe_0 * rpa_x * rpb_x + (1.0 / 2.0) * fe_0 * fe_0 * rpa_x * rpa_x +
                                 (1.0 / 2.0) * fe_0 * fe_0 * rpb_x * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * fe_0);

        fints_xxz[i] += faa_xz * (2.0 * fe_0 * rpa_x * rpb_x * rpb_x + 2.0 * fe_0 * rpa_x * rpa_x * rpb_x + 3.0 * fe_0 * fe_0 * rpa_x +
                                  3.0 * fe_0 * fe_0 * rpb_x);

        fints_xxz[i] += faa_xxz * (2.0 * fe_0 * rpa_x * rpb_x + (1.0 / 2.0) * fe_0 * rpa_x * rpa_x + (1.0 / 2.0) * fe_0 * rpb_x * rpb_x +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_x * rpa_x * rpb_x * rpb_x);

        fints_xyy[i] += faa_yy * (fe_0 * rpa_x * rpb_x * rpb_x + fe_0 * rpa_x * rpa_x * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_x +
                                  (3.0 / 2.0) * fe_0 * fe_0 * rpb_x);

        fints_xyy[i] += faa_xyy * (2.0 * fe_0 * rpa_x * rpb_x + (1.0 / 2.0) * fe_0 * rpa_x * rpa_x + (1.0 / 2.0) * fe_0 * rpb_x * rpb_x +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_x * rpa_x * rpb_x * rpb_x);

        fints_xyz[i] += faa_yz * (fe_0 * rpa_x * rpb_x * rpb_x + fe_0 * rpa_x * rpa_x * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_x +
                                  (3.0 / 2.0) * fe_0 * fe_0 * rpb_x);

        fints_xyz[i] += faa_xyz * (2.0 * fe_0 * rpa_x * rpb_x + (1.0 / 2.0) * fe_0 * rpa_x * rpa_x + (1.0 / 2.0) * fe_0 * rpb_x * rpb_x +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_x * rpa_x * rpb_x * rpb_x);

        fints_xzz[i] += faa_zz * (fe_0 * rpa_x * rpb_x * rpb_x + fe_0 * rpa_x * rpa_x * rpb_x + (3.0 / 2.0) * fe_0 * fe_0 * rpa_x +
                                  (3.0 / 2.0) * fe_0 * fe_0 * rpb_x);

        fints_xzz[i] += faa_xzz * (2.0 * fe_0 * rpa_x * rpb_x + (1.0 / 2.0) * fe_0 * rpa_x * rpa_x + (1.0 / 2.0) * fe_0 * rpb_x * rpb_x +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_x * rpa_x * rpb_x * rpb_x);

        fints_yyy[i] += faa_yyy * (2.0 * fe_0 * rpa_x * rpb_x + (1.0 / 2.0) * fe_0 * rpa_x * rpa_x + (1.0 / 2.0) * fe_0 * rpb_x * rpb_x +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_x * rpa_x * rpb_x * rpb_x);

        fints_yyz[i] += faa_yyz * (2.0 * fe_0 * rpa_x * rpb_x + (1.0 / 2.0) * fe_0 * rpa_x * rpa_x + (1.0 / 2.0) * fe_0 * rpb_x * rpb_x +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_x * rpa_x * rpb_x * rpb_x);

        fints_yzz[i] += faa_yzz * (2.0 * fe_0 * rpa_x * rpb_x + (1.0 / 2.0) * fe_0 * rpa_x * rpa_x + (1.0 / 2.0) * fe_0 * rpb_x * rpb_x +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_x * rpa_x * rpb_x * rpb_x);

        fints_zzz[i] += faa_zzz * (2.0 * fe_0 * rpa_x * rpb_x + (1.0 / 2.0) * fe_0 * rpa_x * rpa_x + (1.0 / 2.0) * fe_0 * rpb_x * rpb_x +
                                   (3.0 / 4.0) * fe_0 * fe_0 + rpa_x * rpa_x * rpb_x * rpb_x);
    }
}
