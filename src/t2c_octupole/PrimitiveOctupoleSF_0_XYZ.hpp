#ifndef PrimitiveOctupoleSF_0_XYZ
#define PrimitiveOctupoleSF_0_XYZ
...
/**
 Evaluates block of primitive <S_0|r^3|F_XYZ> integrals.
...
*/
auto compPrimitiveOctupoleSF_0_XYZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleSF_0_XYZ */
