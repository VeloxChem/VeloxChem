#ifndef PrimitiveOctupoleFS_ZZZ_0
#define PrimitiveOctupoleFS_ZZZ_0
...
/**
 Evaluates block of primitive <F_ZZZ|r^3|S_0> integrals.
...
*/
auto compPrimitiveOctupoleFS_ZZZ_0(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFS_ZZZ_0 */
