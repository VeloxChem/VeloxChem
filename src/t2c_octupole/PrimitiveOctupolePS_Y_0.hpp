#ifndef PrimitiveOctupolePS_Y_0
#define PrimitiveOctupolePS_Y_0
...
/**
 Evaluates block of primitive <P_Y|r^3|S_0> integrals.
...
*/
auto compPrimitiveOctupolePS_Y_0(TDoubleArray&       buffer_xxx,
