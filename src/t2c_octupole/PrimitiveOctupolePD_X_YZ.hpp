#ifndef PrimitiveOctupolePD_X_YZ
#define PrimitiveOctupolePD_X_YZ
...
/**
 Evaluates block of primitive <P_X|r^3|D_YZ> integrals.
...
*/
auto compPrimitiveOctupolePD_X_YZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePD_X_YZ */
