#ifndef PrimitiveOctupoleFP_XXZ_X
#define PrimitiveOctupoleFP_XXZ_X
...
/**
 Evaluates block of primitive <F_XXZ|r^3|P_X> integrals.
...
*/
auto compPrimitiveOctupoleFP_XXZ_X(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_XXZ_X */
