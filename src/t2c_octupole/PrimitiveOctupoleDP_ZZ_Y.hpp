#ifndef PrimitiveOctupoleDP_ZZ_Y
#define PrimitiveOctupoleDP_ZZ_Y
...
/**
 Evaluates block of primitive <D_ZZ|r^3|P_Y> integrals.
...
*/
auto compPrimitiveOctupoleDP_ZZ_Y(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDP_ZZ_Y */
