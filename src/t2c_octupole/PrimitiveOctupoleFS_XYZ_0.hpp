#ifndef PrimitiveOctupoleFS_XYZ_0
#define PrimitiveOctupoleFS_XYZ_0
...
/**
 Evaluates block of primitive <F_XYZ|r^3|S_0> integrals.
...
*/
auto compPrimitiveOctupoleFS_XYZ_0(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFS_XYZ_0 */
