#ifndef PrimitiveOctupoleDD_XZ_XX
#define PrimitiveOctupoleDD_XZ_XX
...
/**
 Evaluates block of primitive <D_XZ|r^3|D_XX> integrals.
...
*/
auto compPrimitiveOctupoleDD_XZ_XX(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_XZ_XX */
