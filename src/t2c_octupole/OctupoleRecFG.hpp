#ifndef OctupoleRecFG_hpp
#define OctupoleRecFG_hpp
...
/**
 Evaluates <F|r^3|G>  integrals for given pair of GTOs blocks.
...
*/
auto compOctupoleFG(CSubMatrix*      matrix_xxx,
