...
#pragma omp simd aligned(fints_xxx,     \
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xxx[i] += faa_xxx * ((3.0 / 2.0) * fe_0 * rpa_y * rpb_y + (3.0 / 2.0) * fe_0 * rpb_y * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 +
                                   rpa_y * rpb_y * rpb_y * rpb_y);

        fints_xxy[i] += faa_xx * ((3.0 / 2.0) * fe_0 * rpa_y * rpb_y * rpb_y + (1.0 / 2.0) * fe_0 * rpb_y * rpb_y * rpb_y +
                                  (3.0 / 4.0) * fe_0 * fe_0 * rpa_y + (9.0 / 4.0) * fe_0 * fe_0 * rpb_y);

        fints_xxy[i] += faa_xxy * ((3.0 / 2.0) * fe_0 * rpa_y * rpb_y + (3.0 / 2.0) * fe_0 * rpb_y * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 +
                                   rpa_y * rpb_y * rpb_y * rpb_y);

        fints_xxz[i] += faa_xxz * ((3.0 / 2.0) * fe_0 * rpa_y * rpb_y + (3.0 / 2.0) * fe_0 * rpb_y * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 +
                                   rpa_y * rpb_y * rpb_y * rpb_y);

        fints_xyy[i] +=
            faa_x * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpb_y + (3.0 / 2.0) * fe_0 * fe_0 * rpb_y * rpb_y + (3.0 / 2.0) * fe_0 * fe_0 * fe_0);

        fints_xyy[i] += faa_xy * (3.0 * fe_0 * rpa_y * rpb_y * rpb_y + fe_0 * rpb_y * rpb_y * rpb_y + (3.0 / 2.0) * fe_0 * fe_0 * rpa_y +
                                  (9.0 / 2.0) * fe_0 * fe_0 * rpb_y);

        fints_xyy[i] += faa_xyy * ((3.0 / 2.0) * fe_0 * rpa_y * rpb_y + (3.0 / 2.0) * fe_0 * rpb_y * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 +
                                   rpa_y * rpb_y * rpb_y * rpb_y);

        fints_xyz[i] += faa_xz * ((3.0 / 2.0) * fe_0 * rpa_y * rpb_y * rpb_y + (1.0 / 2.0) * fe_0 * rpb_y * rpb_y * rpb_y +
                                  (3.0 / 4.0) * fe_0 * fe_0 * rpa_y + (9.0 / 4.0) * fe_0 * fe_0 * rpb_y);

        fints_xyz[i] += faa_xyz * ((3.0 / 2.0) * fe_0 * rpa_y * rpb_y + (3.0 / 2.0) * fe_0 * rpb_y * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 +
                                   rpa_y * rpb_y * rpb_y * rpb_y);

        fints_xzz[i] += faa_xzz * ((3.0 / 2.0) * fe_0 * rpa_y * rpb_y + (3.0 / 2.0) * fe_0 * rpb_y * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 +
                                   rpa_y * rpb_y * rpb_y * rpb_y);

        fints_yyy[i] += fss * ((3.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpa_y + (9.0 / 4.0) * fe_0 * fe_0 * fe_0 * rpb_y);

        fints_yyy[i] +=
            faa_y * ((9.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpb_y + (9.0 / 2.0) * fe_0 * fe_0 * rpb_y * rpb_y + (9.0 / 2.0) * fe_0 * fe_0 * fe_0);

        fints_yyy[i] += faa_yy * ((9.0 / 2.0) * fe_0 * rpa_y * rpb_y * rpb_y + (3.0 / 2.0) * fe_0 * rpb_y * rpb_y * rpb_y +
                                  (9.0 / 4.0) * fe_0 * fe_0 * rpa_y + (27.0 / 4.0) * fe_0 * fe_0 * rpb_y);

        fints_yyy[i] += faa_yyy * ((3.0 / 2.0) * fe_0 * rpa_y * rpb_y + (3.0 / 2.0) * fe_0 * rpb_y * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 +
                                   rpa_y * rpb_y * rpb_y * rpb_y);

        fints_yyz[i] +=
            faa_z * ((3.0 / 2.0) * fe_0 * fe_0 * rpa_y * rpb_y + (3.0 / 2.0) * fe_0 * fe_0 * rpb_y * rpb_y + (3.0 / 2.0) * fe_0 * fe_0 * fe_0);

        fints_yyz[i] += faa_yz * (3.0 * fe_0 * rpa_y * rpb_y * rpb_y + fe_0 * rpb_y * rpb_y * rpb_y + (3.0 / 2.0) * fe_0 * fe_0 * rpa_y +
                                  (9.0 / 2.0) * fe_0 * fe_0 * rpb_y);

        fints_yyz[i] += faa_yyz * ((3.0 / 2.0) * fe_0 * rpa_y * rpb_y + (3.0 / 2.0) * fe_0 * rpb_y * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 +
                                   rpa_y * rpb_y * rpb_y * rpb_y);

        fints_yzz[i] += faa_zz * ((3.0 / 2.0) * fe_0 * rpa_y * rpb_y * rpb_y + (1.0 / 2.0) * fe_0 * rpb_y * rpb_y * rpb_y +
                                  (3.0 / 4.0) * fe_0 * fe_0 * rpa_y + (9.0 / 4.0) * fe_0 * fe_0 * rpb_y);

        fints_yzz[i] += faa_yzz * ((3.0 / 2.0) * fe_0 * rpa_y * rpb_y + (3.0 / 2.0) * fe_0 * rpb_y * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 +
                                   rpa_y * rpb_y * rpb_y * rpb_y);

        fints_zzz[i] += faa_zzz * ((3.0 / 2.0) * fe_0 * rpa_y * rpb_y + (3.0 / 2.0) * fe_0 * rpb_y * rpb_y + (3.0 / 4.0) * fe_0 * fe_0 +
                                   rpa_y * rpb_y * rpb_y * rpb_y);
    }
}
