#ifndef PrimitiveOctupolePF_Y_XXZ
#define PrimitiveOctupolePF_Y_XXZ
...
/**
 Evaluates block of primitive <P_Y|r^3|F_XXZ> integrals.
...
*/
auto compPrimitiveOctupolePF_Y_XXZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_Y_XXZ */
