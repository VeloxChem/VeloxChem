#ifndef PrimitiveOctupoleSP_0_Y
#define PrimitiveOctupoleSP_0_Y
...
/**
 Evaluates block of primitive <S_0|r^3|P_Y> integrals.
...
*/
auto compPrimitiveOctupoleSP_0_Y(TDoubleArray&       buffer_xxx,
