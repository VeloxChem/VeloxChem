#ifndef OctupoleRecDF_hpp
#define OctupoleRecDF_hpp
...
/**
 Evaluates <D|r^3|F>  integrals for given pair of GTOs blocks.
...
*/
auto compOctupoleDF(CSubMatrix*      matrix_xxx,
