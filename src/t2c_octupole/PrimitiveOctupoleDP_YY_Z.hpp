#ifndef PrimitiveOctupoleDP_YY_Z
#define PrimitiveOctupoleDP_YY_Z
...
/**
 Evaluates block of primitive <D_YY|r^3|P_Z> integrals.
...
*/
auto compPrimitiveOctupoleDP_YY_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDP_YY_Z */
