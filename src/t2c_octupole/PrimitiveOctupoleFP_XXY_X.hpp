#ifndef PrimitiveOctupoleFP_XXY_X
#define PrimitiveOctupoleFP_XXY_X
...
/**
 Evaluates block of primitive <F_XXY|r^3|P_X> integrals.
...
*/
auto compPrimitiveOctupoleFP_XXY_X(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFP_XXY_X */
