#ifndef PrimitiveOctupolePF_X_XZZ
#define PrimitiveOctupolePF_X_XZZ
...
/**
 Evaluates block of primitive <P_X|r^3|F_XZZ> integrals.
...
*/
auto compPrimitiveOctupolePF_X_XZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_X_XZZ */
