#ifndef OctupoleRecFS_hpp
#define OctupoleRecFS_hpp
...
/**
 Evaluates <F|r^3|S>  integrals for given pair of GTOs blocks.
...
*/
auto compOctupoleFS(CSubMatrix*      matrix_xxx,
