#ifndef PrimitiveOctupolePF_Z_YZZ
#define PrimitiveOctupolePF_Z_YZZ
...
/**
 Evaluates block of primitive <P_Z|r^3|F_YZZ> integrals.
...
*/
auto compPrimitiveOctupolePF_Z_YZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_Z_YZZ */
