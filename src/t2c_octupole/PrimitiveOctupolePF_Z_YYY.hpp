#ifndef PrimitiveOctupolePF_Z_YYY
#define PrimitiveOctupolePF_Z_YYY
...
/**
 Evaluates block of primitive <P_Z|r^3|F_YYY> integrals.
...
*/
auto compPrimitiveOctupolePF_Z_YYY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePF_Z_YYY */
