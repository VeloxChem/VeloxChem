#ifndef PrimitiveOctupolePD_Z_ZZ
#define PrimitiveOctupolePD_Z_ZZ
...
/**
 Evaluates block of primitive <P_Z|r^3|D_ZZ> integrals.
...
*/
auto compPrimitiveOctupolePD_Z_ZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePD_Z_ZZ */
