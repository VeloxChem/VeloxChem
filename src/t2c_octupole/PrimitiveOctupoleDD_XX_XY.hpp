#ifndef PrimitiveOctupoleDD_XX_XY
#define PrimitiveOctupoleDD_XX_XY
...
/**
 Evaluates block of primitive <D_XX|r^3|D_XY> integrals.
...
*/
auto compPrimitiveOctupoleDD_XX_XY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDD_XX_XY */
