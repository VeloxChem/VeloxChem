#ifndef PrimitiveOctupoleFS_YYZ_0
#define PrimitiveOctupoleFS_YYZ_0
...
/**
 Evaluates block of primitive <F_YYZ|r^3|S_0> integrals.
...
*/
auto compPrimitiveOctupoleFS_YYZ_0(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleFS_YYZ_0 */
