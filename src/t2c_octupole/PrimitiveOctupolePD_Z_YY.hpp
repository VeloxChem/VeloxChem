#ifndef PrimitiveOctupolePD_Z_YY
#define PrimitiveOctupolePD_Z_YY
...
/**
 Evaluates block of primitive <P_Z|r^3|D_YY> integrals.
...
*/
auto compPrimitiveOctupolePD_Z_YY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupolePD_Z_YY */
