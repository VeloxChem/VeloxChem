#ifndef PrimitiveOctupoleDS_YY_0
#define PrimitiveOctupoleDS_YY_0
...
/**
 Evaluates block of primitive <D_YY|r^3|S_0> integrals.
...
*/
auto compPrimitiveOctupoleDS_YY_0(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOctupoleDS_YY_0 */
