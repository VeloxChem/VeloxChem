#ifndef PrimitiveNuclearPotentialDG_T_XXXY
#define PrimitiveNuclearPotentialDG_T_XXXY
...
*/
auto compPrimitiveNuclearPotentialDG_T_XXXY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDG_T_XXXY */
