#ifndef PrimitiveNuclearPotentialDG_T_XXXX
#define PrimitiveNuclearPotentialDG_T_XXXX
...
*/
auto compPrimitiveNuclearPotentialDG_T_XXXX(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDG_T_XXXX */
