#ifndef PrimitiveNuclearPotentialGD_ZZZZ_T
#define PrimitiveNuclearPotentialGD_ZZZZ_T
...
*/
auto compPrimitiveNuclearPotentialGD_ZZZZ_T(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialGD_ZZZZ_T */
