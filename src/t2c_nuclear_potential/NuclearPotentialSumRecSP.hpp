#ifndef NuclearPotentialSumRecSP_hpp
#define NuclearPotentialSumRecSP_hpp
...
/// @brief Computes (S|A|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_sp(T&                               distributor,
...
#endif /* NuclearPotentialSumRecSP_hpp */
