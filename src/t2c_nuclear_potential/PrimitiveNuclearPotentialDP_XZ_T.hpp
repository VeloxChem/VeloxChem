#ifndef PrimitiveNuclearPotentialDP_XZ_T
#define PrimitiveNuclearPotentialDP_XZ_T
...
*/
auto compPrimitiveNuclearPotentialDP_XZ_T(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveNuclearPotentialDP_XZ_T */
