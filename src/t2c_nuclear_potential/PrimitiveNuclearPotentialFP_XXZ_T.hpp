#ifndef PrimitiveNuclearPotentialFP_XXZ_T
#define PrimitiveNuclearPotentialFP_XXZ_T
...
*/
auto compPrimitiveNuclearPotentialFP_XXZ_T(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveNuclearPotentialFP_XXZ_T */
