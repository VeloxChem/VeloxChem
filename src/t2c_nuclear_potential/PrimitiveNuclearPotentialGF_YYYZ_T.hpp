#ifndef PrimitiveNuclearPotentialGF_YYYZ_T
#define PrimitiveNuclearPotentialGF_YYYZ_T
...
*/
auto compPrimitiveNuclearPotentialGF_YYYZ_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialGF_YYYZ_T */
