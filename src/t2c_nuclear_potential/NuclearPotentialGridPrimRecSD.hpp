#ifndef NuclearPotentialGridPrimRecSD
#define NuclearPotentialGridPrimRecSD

#include "SubMatrix.hpp"

namespace npotrec { // npotrec namespace

/// @brief Computes primitive [S|A|D]  integrals for set of data buffers on given grid.
...
#endif /* NuclearPotentialGridPrimRecSD */
