#ifndef PrimitiveNuclearPotentialGF_XYZZ_T
#define PrimitiveNuclearPotentialGF_XYZZ_T
...
*/
auto compPrimitiveNuclearPotentialGF_XYZZ_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialGF_XYZZ_T */
