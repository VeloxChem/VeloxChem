#ifndef PrimitiveNuclearPotentialGF_XYYY_T
#define PrimitiveNuclearPotentialGF_XYYY_T
...
*/
auto compPrimitiveNuclearPotentialGF_XYYY_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialGF_XYYY_T */
