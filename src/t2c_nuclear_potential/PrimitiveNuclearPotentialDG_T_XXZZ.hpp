#ifndef PrimitiveNuclearPotentialDG_T_XXZZ
#define PrimitiveNuclearPotentialDG_T_XXZZ
...
*/
auto compPrimitiveNuclearPotentialDG_T_XXZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDG_T_XXZZ */
