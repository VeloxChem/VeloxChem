#ifndef PrimitiveNuclearPotentialGD_XYYY_T
#define PrimitiveNuclearPotentialGD_XYYY_T
...
*/
auto compPrimitiveNuclearPotentialGD_XYYY_T(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialGD_XYYY_T */
