#ifndef PrimitiveNuclearPotentialGD_XXYZ_T
#define PrimitiveNuclearPotentialGD_XXYZ_T
...
*/
auto compPrimitiveNuclearPotentialGD_XXYZ_T(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialGD_XXYZ_T */
