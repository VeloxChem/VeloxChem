#ifndef PrimitiveNuclearPotentialFF_YYY_T
#define PrimitiveNuclearPotentialFF_YYY_T
...
*/
auto compPrimitiveNuclearPotentialFF_YYY_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialFF_YYY_T */
