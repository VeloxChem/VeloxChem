#ifndef NuclearPotentialSumRecDG_hpp
#define NuclearPotentialSumRecDG_hpp
...
/// @brief Computes (D|A|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_dg(T&                               distributor,
                              ...
                              const bool                       bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(381, ket_npgtos);
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < coords.size(); l++)
                {
                    ...
                    npotrec::comp_prim_nuclear_potential_dg(
                        pbuffer, 291, 96, 111, 141, 171, 201, 246, factors, 11, 17, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 291, charges[l], ket_width, ket_npgtos);
                }
            }
...
#endif /* NuclearPotentialSumRecDG_hpp */
