#ifndef PrimitiveNuclearPotentialFG_T_XXXZ
#define PrimitiveNuclearPotentialFG_T_XXXZ
...
*/
auto compPrimitiveNuclearPotentialFG_T_XXXZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialFG_T_XXXZ */
