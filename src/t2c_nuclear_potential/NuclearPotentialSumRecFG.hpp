#ifndef NuclearPotentialSumRecFG_hpp
#define NuclearPotentialSumRecFG_hpp
...
/// @brief Computes (F|A|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_fg(T&                               distributor,
...
#endif /* NuclearPotentialSumRecFG_hpp */
