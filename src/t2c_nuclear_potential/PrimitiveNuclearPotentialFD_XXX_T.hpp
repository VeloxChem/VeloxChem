#ifndef PrimitiveNuclearPotentialFD_XXX_T
#define PrimitiveNuclearPotentialFD_XXX_T
...
*/
auto compPrimitiveNuclearPotentialFD_XXX_T(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialFD_XXX_T */
