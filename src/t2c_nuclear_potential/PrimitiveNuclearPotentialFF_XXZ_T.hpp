#ifndef PrimitiveNuclearPotentialFF_XXZ_T
#define PrimitiveNuclearPotentialFF_XXZ_T
...
*/
auto compPrimitiveNuclearPotentialFF_XXZ_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialFF_XXZ_T */
