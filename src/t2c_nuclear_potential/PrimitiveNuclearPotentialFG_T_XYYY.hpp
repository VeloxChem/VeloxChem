#ifndef PrimitiveNuclearPotentialFG_T_XYYY
#define PrimitiveNuclearPotentialFG_T_XYYY
...
*/
auto compPrimitiveNuclearPotentialFG_T_XYYY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialFG_T_XYYY */
