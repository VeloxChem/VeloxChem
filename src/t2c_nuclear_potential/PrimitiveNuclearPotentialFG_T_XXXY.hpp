#ifndef PrimitiveNuclearPotentialFG_T_XXXY
#define PrimitiveNuclearPotentialFG_T_XXXY
...
*/
auto compPrimitiveNuclearPotentialFG_T_XXXY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialFG_T_XXXY */
