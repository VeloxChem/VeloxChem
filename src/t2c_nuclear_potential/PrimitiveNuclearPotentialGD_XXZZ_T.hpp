#ifndef PrimitiveNuclearPotentialGD_XXZZ_T
#define PrimitiveNuclearPotentialGD_XXZZ_T
...
*/
auto compPrimitiveNuclearPotentialGD_XXZZ_T(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialGD_XXZZ_T */
