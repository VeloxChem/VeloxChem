#ifndef NuclearPotentialSumErfRecFG_hpp
#define NuclearPotentialSumErfRecFG_hpp
...
/// @brief Computes (F|Erf(A)|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_fg(T& distributor,
                                  ...
                                  const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(905, ket_npgtos);
...
#endif /* NuclearPotentialSumErfRecFG_hpp */
