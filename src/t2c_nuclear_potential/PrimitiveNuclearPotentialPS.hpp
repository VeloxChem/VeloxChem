#ifndef PrimitiveNuclearPotentialPS
#define PrimitiveNuclearPotentialPS
...
/**
 Evaluates block of primitive <P|A|S> integrals.
...
*/
auto compPrimitiveNuclearPotentialPS(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveNuclearPotentialPS */
