#ifndef NuclearPotentialSumErfRecSG_hpp
#define NuclearPotentialSumErfRecSG_hpp
...
/// @brief Computes (S|Erf(A)|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_sg(T& distributor,
...
#endif /* NuclearPotentialSumErfRecSG_hpp */
