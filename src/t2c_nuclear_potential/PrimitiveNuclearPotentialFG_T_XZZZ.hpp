#ifndef PrimitiveNuclearPotentialFG_T_XZZZ
#define PrimitiveNuclearPotentialFG_T_XZZZ
...
*/
auto compPrimitiveNuclearPotentialFG_T_XZZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialFG_T_XZZZ */
