#ifndef PrimitiveNuclearPotentialFG_T_YYYY
#define PrimitiveNuclearPotentialFG_T_YYYY
...
*/
auto compPrimitiveNuclearPotentialFG_T_YYYY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialFG_T_YYYY */
