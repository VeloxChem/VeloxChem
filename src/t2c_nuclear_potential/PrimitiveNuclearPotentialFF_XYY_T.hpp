#ifndef PrimitiveNuclearPotentialFF_XYY_T
#define PrimitiveNuclearPotentialFF_XYY_T
...
*/
auto compPrimitiveNuclearPotentialFF_XYY_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialFF_XYY_T */
