                                ...
                                const int64_t       ket_dim) -> void
{
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xxxx[i] += fss * b1_vals[i] * (-6.0 * fe_0 * rpa_x * rpc_x - 3.0 * fe_0 * rpa_x * rpa_x - (3.0 / 2.0) * fe_0 * fe_0 - 4.0 * rpa_x * rpa_x * rpa_x * rpc_x);

        fints_xxxx[i] += fss * b2_vals[i] * (6.0 * fe_0 * rpa_x * rpc_x + 3.0 * fe_0 * rpc_x * rpc_x + (3.0 / 4.0) * fe_0 * fe_0 + 6.0 * rpa_x * rpa_x * rpc_x * rpc_x);
        ...
        fints_xxxy[i] += fss * b1_vals[i] * (-(3.0 / 2.0) * fe_0 * rpa_y * rpa_x - (3.0 / 2.0) * fe_0 * rpa_y * rpc_x - (3.0 / 2.0) * fe_0 * rpa_x * rpc_y - 3.0 * rpa_y * rpa_x * rpa_x * rpc_x - rpa_x * rpa_x * rpa_x * rpc_y);

        fints_xxxy[i] += fss * b2_vals[i] * ((3.0 / 2.0) * fe_0 * rpa_y * rpc_x + (3.0 / 2.0) * fe_0 * rpa_x * rpc_y + (3.0 / 2.0) * fe_0 * rpc_y * rpc_x + 3.0 * rpa_y * rpa_x * rpc_x * rpc_x + 3.0 * rpa_x * rpa_x * rpc_y * rpc_x);

        fints_xxxy[i] += fss * b3_vals[i] * (-(3.0 / 2.0) * fe_0 * rpc_y * rpc_x - rpa_y * rpc_x * rpc_x * rpc_x - 3.0 * rpa_x * rpc_y * rpc_x * rpc_x);
        ...
        fints_xxxz[i] += fss * b1_vals[i] * (-(3.0 / 2.0) * fe_0 * rpa_z * rpa_x - (3.0 / 2.0) * fe_0 * rpa_z * rpc_x - (3.0 / 2.0) * fe_0 * rpa_x * rpc_z - 3.0 * rpa_z * rpa_x * rpa_x * rpc_x - rpa_x * rpa_x * rpa_x * rpc_z);

        fints_xxxz[i] += fss * b2_vals[i] * ((3.0 / 2.0) * fe_0 * rpa_z * rpc_x + (3.0 / 2.0) * fe_0 * rpa_x * rpc_z + (3.0 / 2.0) * fe_0 * rpc_z * rpc_x + 3.0 * rpa_z * rpa_x * rpc_x * rpc_x + 3.0 * rpa_x * rpa_x * rpc_z * rpc_x);

        fints_xxxz[i] += fss * b3_vals[i] * (-(3.0 / 2.0) * fe_0 * rpc_z * rpc_x - rpa_z * rpc_x * rpc_x * rpc_x - 3.0 * rpa_x * rpc_z * rpc_x * rpc_x);

        fints_xxxz[i] += fss * b4_vals[i] * rpc_z * rpc_x * rpc_x * rpc_x;

        fints_xxyy[i] += fss * b0_vals[i] * ((1.0 / 2.0) * fe_0 * rpa_y * rpa_y + (1.0 / 2.0) * fe_0 * rpa_x * rpa_x + (1.0 / 4.0) * fe_0 * fe_0 + rpa_y * rpa_y * rpa_x * rpa_x);

        fints_xxyy[i] += fss * b1_vals[i] * (-fe_0 * rpa_y * rpc_y - (1.0 / 2.0) * fe_0 * rpa_y * rpa_y - fe_0 * rpa_x * rpc_x - (1.0 / 2.0) * fe_0 * rpa_x * rpa_x - (1.0 / 2.0) * fe_0 * fe_0);

        fints_xxyy[i] += fss * b1_vals[i] * (-2.0 * rpa_y * rpa_x * rpa_x * rpc_y - 2.0 * rpa_y * rpa_y * rpa_x * rpc_x);

        fints_xxyy[i] += fss * b2_vals[i] * (fe_0 * rpa_y * rpc_y + fe_0 * rpa_x * rpc_x + (1.0 / 2.0) * fe_0 * rpc_y * rpc_y + (1.0 / 2.0) * fe_0 * rpc_x * rpc_x + (1.0 / 4.0) * fe_0 * fe_0);

        fints_xxyy[i] += fss * b2_vals[i] * (4.0 * rpa_y * rpa_x * rpc_y * rpc_x + rpa_y * rpa_y * rpc_x * rpc_x + rpa_x * rpa_x * rpc_y * rpc_y);

        fints_xxyy[i] += fss * b3_vals[i] * (-(1.0 / 2.0) * fe_0 * rpc_y * rpc_y - (1.0 / 2.0) * fe_0 * rpc_x * rpc_x - 2.0 * rpa_y * rpc_y * rpc_x * rpc_x - 2.0 * rpa_x * rpc_y * rpc_y * rpc_x);
        ...
        fints_xxyz[i] += fss * b1_vals[i] * (-(1.0 / 2.0) * fe_0 * rpa_z * rpa_y - (1.0 / 2.0) * fe_0 * rpa_z * rpc_y - (1.0 / 2.0) * fe_0 * rpa_y * rpc_z - 2.0 * rpa_z * rpa_y * rpa_x * rpc_x - rpa_z * rpa_x * rpa_x * rpc_y);

        fints_xxyz[i] += fss * b1_vals[i] * (-rpa_y * rpa_x * rpa_x * rpc_z);

        fints_xxyz[i] += fss * b2_vals[i] * ((1.0 / 2.0) * fe_0 * rpa_z * rpc_y + (1.0 / 2.0) * fe_0 * rpa_y * rpc_z + (1.0 / 2.0) * fe_0 * rpc_z * rpc_y + rpa_z * rpa_y * rpc_x * rpc_x + 2.0 * rpa_z * rpa_x * rpc_y * rpc_x);

        fints_xxyz[i] += fss * b2_vals[i] * (2.0 * rpa_y * rpa_x * rpc_z * rpc_x + rpa_x * rpa_x * rpc_z * rpc_y);

        fints_xxyz[i] += fss * b3_vals[i] * (-(1.0 / 2.0) * fe_0 * rpc_z * rpc_y - rpa_z * rpc_y * rpc_x * rpc_x - rpa_y * rpc_z * rpc_x * rpc_x - 2.0 * rpa_x * rpc_z * rpc_y * rpc_x);

        fints_xxyz[i] += fss * b4_vals[i] * rpc_z * rpc_y * rpc_x * rpc_x;

        fints_xxzz[i] += fss * b0_vals[i] * ((1.0 / 2.0) * fe_0 * rpa_z * rpa_z + (1.0 / 2.0) * fe_0 * rpa_x * rpa_x + (1.0 / 4.0) * fe_0 * fe_0 + rpa_z * rpa_z * rpa_x * rpa_x);

        fints_xxzz[i] += fss * b1_vals[i] * (-fe_0 * rpa_z * rpc_z - (1.0 / 2.0) * fe_0 * rpa_z * rpa_z - fe_0 * rpa_x * rpc_x - (1.0 / 2.0) * fe_0 * rpa_x * rpa_x - (1.0 / 2.0) * fe_0 * fe_0);

        fints_xxzz[i] += fss * b1_vals[i] * (-2.0 * rpa_z * rpa_x * rpa_x * rpc_z - 2.0 * rpa_z * rpa_z * rpa_x * rpc_x);

        fints_xxzz[i] += fss * b2_vals[i] * (fe_0 * rpa_z * rpc_z + fe_0 * rpa_x * rpc_x + (1.0 / 2.0) * fe_0 * rpc_z * rpc_z + (1.0 / 2.0) * fe_0 * rpc_x * rpc_x + (1.0 / 4.0) * fe_0 * fe_0);

        fints_xxzz[i] += fss * b2_vals[i] * (4.0 * rpa_z * rpa_x * rpc_z * rpc_x + rpa_z * rpa_z * rpc_x * rpc_x + rpa_x * rpa_x * rpc_z * rpc_z);

        fints_xxzz[i] += fss * b3_vals[i] * (-(1.0 / 2.0) * fe_0 * rpc_z * rpc_z - (1.0 / 2.0) * fe_0 * rpc_x * rpc_x - 2.0 * rpa_z * rpc_z * rpc_x * rpc_x - 2.0 * rpa_x * rpc_z * rpc_z * rpc_x);
        ...
        fints_xyyy[i] += fss * b1_vals[i] * (-(3.0 / 2.0) * fe_0 * rpa_y * rpa_x - (3.0 / 2.0) * fe_0 * rpa_y * rpc_x - (3.0 / 2.0) * fe_0 * rpa_x * rpc_y - 3.0 * rpa_y * rpa_y * rpa_x * rpc_y - rpa_y * rpa_y * rpa_y * rpc_x);

        fints_xyyy[i] += fss * b2_vals[i] * ((3.0 / 2.0) * fe_0 * rpa_y * rpc_x + (3.0 / 2.0) * fe_0 * rpa_x * rpc_y + (3.0 / 2.0) * fe_0 * rpc_y * rpc_x + 3.0 * rpa_y * rpa_x * rpc_y * rpc_y + 3.0 * rpa_y * rpa_y * rpc_y * rpc_x);

        fints_xyyy[i] += fss * b3_vals[i] * (-(3.0 / 2.0) * fe_0 * rpc_y * rpc_x - 3.0 * rpa_y * rpc_y * rpc_y * rpc_x - rpa_x * rpc_y * rpc_y * rpc_y);
        ...
        fints_xyyz[i] += fss * b1_vals[i] * (-(1.0 / 2.0) * fe_0 * rpa_z * rpa_x - (1.0 / 2.0) * fe_0 * rpa_z * rpc_x - (1.0 / 2.0) * fe_0 * rpa_x * rpc_z - 2.0 * rpa_z * rpa_y * rpa_x * rpc_y - rpa_z * rpa_y * rpa_y * rpc_x);

        fints_xyyz[i] += fss * b1_vals[i] * (-rpa_y * rpa_y * rpa_x * rpc_z);

        fints_xyyz[i] += fss * b2_vals[i] * ((1.0 / 2.0) * fe_0 * rpa_z * rpc_x + (1.0 / 2.0) * fe_0 * rpa_x * rpc_z + (1.0 / 2.0) * fe_0 * rpc_z * rpc_x + 2.0 * rpa_z * rpa_y * rpc_y * rpc_x + rpa_z * rpa_x * rpc_y * rpc_y);

        fints_xyyz[i] += fss * b2_vals[i] * (2.0 * rpa_y * rpa_x * rpc_z * rpc_y + rpa_y * rpa_y * rpc_z * rpc_x);

        fints_xyyz[i] += fss * b3_vals[i] * (-(1.0 / 2.0) * fe_0 * rpc_z * rpc_x - rpa_z * rpc_y * rpc_y * rpc_x - 2.0 * rpa_y * rpc_z * rpc_y * rpc_x - rpa_x * rpc_z * rpc_y * rpc_y);
        ...
        fints_xyzz[i] += fss * b1_vals[i] * (-(1.0 / 2.0) * fe_0 * rpa_y * rpa_x - (1.0 / 2.0) * fe_0 * rpa_y * rpc_x - (1.0 / 2.0) * fe_0 * rpa_x * rpc_y - 2.0 * rpa_z * rpa_y * rpa_x * rpc_z - rpa_z * rpa_z * rpa_y * rpc_x);

        fints_xyzz[i] += fss * b1_vals[i] * (-rpa_z * rpa_z * rpa_x * rpc_y);

        fints_xyzz[i] += fss * b2_vals[i] * ((1.0 / 2.0) * fe_0 * rpa_y * rpc_x + (1.0 / 2.0) * fe_0 * rpa_x * rpc_y + (1.0 / 2.0) * fe_0 * rpc_y * rpc_x + 2.0 * rpa_z * rpa_y * rpc_z * rpc_x + 2.0 * rpa_z * rpa_x * rpc_z * rpc_y);

        fints_xyzz[i] += fss * b2_vals[i] * (rpa_z * rpa_z * rpc_y * rpc_x + rpa_y * rpa_x * rpc_z * rpc_z);

        fints_xyzz[i] += fss * b3_vals[i] * (-(1.0 / 2.0) * fe_0 * rpc_y * rpc_x - 2.0 * rpa_z * rpc_z * rpc_y * rpc_x - rpa_y * rpc_z * rpc_z * rpc_x - rpa_x * rpc_z * rpc_z * rpc_y);
        ...
        fints_xzzz[i] += fss * b1_vals[i] * (-(3.0 / 2.0) * fe_0 * rpa_z * rpa_x - (3.0 / 2.0) * fe_0 * rpa_z * rpc_x - (3.0 / 2.0) * fe_0 * rpa_x * rpc_z - 3.0 * rpa_z * rpa_z * rpa_x * rpc_z - rpa_z * rpa_z * rpa_z * rpc_x);

        fints_xzzz[i] += fss * b2_vals[i] * ((3.0 / 2.0) * fe_0 * rpa_z * rpc_x + (3.0 / 2.0) * fe_0 * rpa_x * rpc_z + (3.0 / 2.0) * fe_0 * rpc_z * rpc_x + 3.0 * rpa_z * rpa_x * rpc_z * rpc_z + 3.0 * rpa_z * rpa_z * rpc_z * rpc_x);

        fints_xzzz[i] += fss * b3_vals[i] * (-(3.0 / 2.0) * fe_0 * rpc_z * rpc_x - 3.0 * rpa_z * rpc_z * rpc_z * rpc_x - rpa_x * rpc_z * rpc_z * rpc_z);
        ...
        fints_yyyy[i] += fss * b1_vals[i] * (-6.0 * fe_0 * rpa_y * rpc_y - 3.0 * fe_0 * rpa_y * rpa_y - (3.0 / 2.0) * fe_0 * fe_0 - 4.0 * rpa_y * rpa_y * rpa_y * rpc_y);

        fints_yyyy[i] += fss * b2_vals[i] * (6.0 * fe_0 * rpa_y * rpc_y + 3.0 * fe_0 * rpc_y * rpc_y + (3.0 / 4.0) * fe_0 * fe_0 + 6.0 * rpa_y * rpa_y * rpc_y * rpc_y);
        ...
        fints_yyyz[i] += fss * b1_vals[i] * (-(3.0 / 2.0) * fe_0 * rpa_z * rpa_y - (3.0 / 2.0) * fe_0 * rpa_z * rpc_y - (3.0 / 2.0) * fe_0 * rpa_y * rpc_z - 3.0 * rpa_z * rpa_y * rpa_y * rpc_y - rpa_y * rpa_y * rpa_y * rpc_z);

        fints_yyyz[i] += fss * b2_vals[i] * ((3.0 / 2.0) * fe_0 * rpa_z * rpc_y + (3.0 / 2.0) * fe_0 * rpa_y * rpc_z + (3.0 / 2.0) * fe_0 * rpc_z * rpc_y + 3.0 * rpa_z * rpa_y * rpc_y * rpc_y + 3.0 * rpa_y * rpa_y * rpc_z * rpc_y);

        fints_yyyz[i] += fss * b3_vals[i] * (-(3.0 / 2.0) * fe_0 * rpc_z * rpc_y - rpa_z * rpc_y * rpc_y * rpc_y - 3.0 * rpa_y * rpc_z * rpc_y * rpc_y);

        fints_yyyz[i] += fss * b4_vals[i] * rpc_z * rpc_y * rpc_y * rpc_y;

        fints_yyzz[i] += fss * b0_vals[i] * ((1.0 / 2.0) * fe_0 * rpa_z * rpa_z + (1.0 / 2.0) * fe_0 * rpa_y * rpa_y + (1.0 / 4.0) * fe_0 * fe_0 + rpa_z * rpa_z * rpa_y * rpa_y);

        fints_yyzz[i] += fss * b1_vals[i] * (-fe_0 * rpa_z * rpc_z - (1.0 / 2.0) * fe_0 * rpa_z * rpa_z - fe_0 * rpa_y * rpc_y - (1.0 / 2.0) * fe_0 * rpa_y * rpa_y - (1.0 / 2.0) * fe_0 * fe_0);

        fints_yyzz[i] += fss * b1_vals[i] * (-2.0 * rpa_z * rpa_y * rpa_y * rpc_z - 2.0 * rpa_z * rpa_z * rpa_y * rpc_y);

        fints_yyzz[i] += fss * b2_vals[i] * (fe_0 * rpa_z * rpc_z + fe_0 * rpa_y * rpc_y + (1.0 / 2.0) * fe_0 * rpc_z * rpc_z + (1.0 / 2.0) * fe_0 * rpc_y * rpc_y + (1.0 / 4.0) * fe_0 * fe_0);

        fints_yyzz[i] += fss * b2_vals[i] * (4.0 * rpa_z * rpa_y * rpc_z * rpc_y + rpa_z * rpa_z * rpc_y * rpc_y + rpa_y * rpa_y * rpc_z * rpc_z);

        fints_yyzz[i] += fss * b3_vals[i] * (-(1.0 / 2.0) * fe_0 * rpc_z * rpc_z - (1.0 / 2.0) * fe_0 * rpc_y * rpc_y - 2.0 * rpa_z * rpc_z * rpc_y * rpc_y - 2.0 * rpa_y * rpc_z * rpc_z * rpc_y);
        ...
        fints_yzzz[i] += fss * b1_vals[i] * (-(3.0 / 2.0) * fe_0 * rpa_z * rpa_y - (3.0 / 2.0) * fe_0 * rpa_z * rpc_y - (3.0 / 2.0) * fe_0 * rpa_y * rpc_z - 3.0 * rpa_z * rpa_z * rpa_y * rpc_z - rpa_z * rpa_z * rpa_z * rpc_y);

        fints_yzzz[i] += fss * b2_vals[i] * ((3.0 / 2.0) * fe_0 * rpa_z * rpc_y + (3.0 / 2.0) * fe_0 * rpa_y * rpc_z + (3.0 / 2.0) * fe_0 * rpc_z * rpc_y + 3.0 * rpa_z * rpa_y * rpc_z * rpc_z + 3.0 * rpa_z * rpa_z * rpc_z * rpc_y);

        fints_yzzz[i] += fss * b3_vals[i] * (-(3.0 / 2.0) * fe_0 * rpc_z * rpc_y - 3.0 * rpa_z * rpc_z * rpc_z * rpc_y - rpa_y * rpc_z * rpc_z * rpc_z);
        ...
        fints_zzzz[i] += fss * b1_vals[i] * (-6.0 * fe_0 * rpa_z * rpc_z - 3.0 * fe_0 * rpa_z * rpa_z - (3.0 / 2.0) * fe_0 * fe_0 - 4.0 * rpa_z * rpa_z * rpa_z * rpc_z);

        fints_zzzz[i] += fss * b2_vals[i] * (6.0 * fe_0 * rpa_z * rpc_z + 3.0 * fe_0 * rpc_z * rpc_z + (3.0 / 4.0) * fe_0 * fe_0 + 6.0 * rpa_z * rpa_z * rpc_z * rpc_z);
