#ifndef NuclearPotentialSumRecFP_hpp
#define NuclearPotentialSumRecFP_hpp
...
/// @brief Computes (F|A|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_fp(T&                               distributor,
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < coords.size(); l++)
                {
                    ...
                    npotrec::comp_prim_nuclear_potential_fp(
                        pbuffer, 102, 27, 36, 54, 60, 66, 84, factors, 11, 17, a_exp);
...
#endif /* NuclearPotentialSumRecFP_hpp */
