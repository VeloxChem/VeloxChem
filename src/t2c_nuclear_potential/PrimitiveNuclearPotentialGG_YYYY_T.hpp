#ifndef PrimitiveNuclearPotentialGG_YYYY_T
#define PrimitiveNuclearPotentialGG_YYYY_T
...
*/
auto compPrimitiveNuclearPotentialGG_YYYY_T(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveNuclearPotentialGG_YYYY_T */
