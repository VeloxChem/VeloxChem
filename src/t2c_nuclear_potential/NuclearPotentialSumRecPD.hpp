#ifndef NuclearPotentialSumRecPD_hpp
#define NuclearPotentialSumRecPD_hpp
...
/// @brief Computes (P|A|D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_pd(T&                               distributor,
...
#endif /* NuclearPotentialSumRecPD_hpp */
