#ifndef PrimitiveNuclearPotentialDG_T_XYYY
#define PrimitiveNuclearPotentialDG_T_XYYY
...
*/
auto compPrimitiveNuclearPotentialDG_T_XYYY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDG_T_XYYY */
