#ifndef PrimitiveNuclearPotentialGG_YYZZ_T
#define PrimitiveNuclearPotentialGG_YYZZ_T
...
*/
auto compPrimitiveNuclearPotentialGG_YYZZ_T(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveNuclearPotentialGG_YYZZ_T */
