#ifndef PrimitiveNuclearPotentialGF_XYYZ_T
#define PrimitiveNuclearPotentialGF_XYYZ_T
...
*/
auto compPrimitiveNuclearPotentialGF_XYYZ_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialGF_XYYZ_T */
