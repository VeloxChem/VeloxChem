#ifndef PrimitiveNuclearPotentialPP_Z_T
#define PrimitiveNuclearPotentialPP_Z_T
...
*/
auto compPrimitiveNuclearPotentialPP_Z_T(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveNuclearPotentialPP_Z_T */
