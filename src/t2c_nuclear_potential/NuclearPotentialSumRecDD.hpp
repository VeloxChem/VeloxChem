#ifndef NuclearPotentialSumRecDD_hpp
#define NuclearPotentialSumRecDD_hpp
...
/// @brief Computes (D|A|D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_dd(T&                               distributor,
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < coords.size(); l++)
                {
                    ...
                    npotrec::comp_prim_nuclear_potential_dd(
                        pbuffer, 90, 18, 24, 36, 45, 54, 72, factors, 11, 17, a_exp);
...
#endif /* NuclearPotentialSumRecDD_hpp */
