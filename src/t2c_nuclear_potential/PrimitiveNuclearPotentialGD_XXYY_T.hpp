#ifndef PrimitiveNuclearPotentialGD_XXYY_T
#define PrimitiveNuclearPotentialGD_XXYY_T
...
*/
auto compPrimitiveNuclearPotentialGD_XXYY_T(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialGD_XXYY_T */
