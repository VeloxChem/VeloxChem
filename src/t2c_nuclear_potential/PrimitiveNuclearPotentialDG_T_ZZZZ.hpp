#ifndef PrimitiveNuclearPotentialDG_T_ZZZZ
#define PrimitiveNuclearPotentialDG_T_ZZZZ
...
*/
auto compPrimitiveNuclearPotentialDG_T_ZZZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDG_T_ZZZZ */
