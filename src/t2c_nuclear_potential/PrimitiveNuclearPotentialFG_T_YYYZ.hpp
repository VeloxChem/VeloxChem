#ifndef PrimitiveNuclearPotentialFG_T_YYYZ
#define PrimitiveNuclearPotentialFG_T_YYYZ
...
*/
auto compPrimitiveNuclearPotentialFG_T_YYYZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialFG_T_YYYZ */
