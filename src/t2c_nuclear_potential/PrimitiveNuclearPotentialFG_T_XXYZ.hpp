#ifndef PrimitiveNuclearPotentialFG_T_XXYZ
#define PrimitiveNuclearPotentialFG_T_XXYZ
...
*/
auto compPrimitiveNuclearPotentialFG_T_XXYZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialFG_T_XXYZ */
