#ifndef PrimitiveNuclearPotentialDG_T_XZZZ
#define PrimitiveNuclearPotentialDG_T_XZZZ
...
*/
auto compPrimitiveNuclearPotentialDG_T_XZZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDG_T_XZZZ */
