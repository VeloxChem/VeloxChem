#ifndef PrimitiveNuclearPotentialDG_T_XYZZ
#define PrimitiveNuclearPotentialDG_T_XYZZ
...
*/
auto compPrimitiveNuclearPotentialDG_T_XYZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDG_T_XYZZ */
