#ifndef PrimitiveNuclearPotentialFF_ZZZ_T
#define PrimitiveNuclearPotentialFF_ZZZ_T
...
*/
auto compPrimitiveNuclearPotentialFF_ZZZ_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialFF_ZZZ_T */
