#ifndef PrimitiveNuclearPotentialGF_XXXX_T
#define PrimitiveNuclearPotentialGF_XXXX_T
...
*/
auto compPrimitiveNuclearPotentialGF_XXXX_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialGF_XXXX_T */
