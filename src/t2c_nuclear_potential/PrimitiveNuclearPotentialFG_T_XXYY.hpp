#ifndef PrimitiveNuclearPotentialFG_T_XXYY
#define PrimitiveNuclearPotentialFG_T_XXYY
...
*/
auto compPrimitiveNuclearPotentialFG_T_XXYY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialFG_T_XXYY */
