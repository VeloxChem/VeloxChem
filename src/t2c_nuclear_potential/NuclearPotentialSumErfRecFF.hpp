#ifndef NuclearPotentialSumErfRecFF_hpp
#define NuclearPotentialSumErfRecFF_hpp
...
/// @brief Computes (F|Erf(A)|F)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_ff(T& distributor,
...
#endif /* NuclearPotentialSumErfRecFF_hpp */
