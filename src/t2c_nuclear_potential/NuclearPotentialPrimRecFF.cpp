...
#pragma omp simd aligned(pa_x,             \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        ta_xxx_xxx_0[i] = 2.0 * ta_x_xxx_0[i] * fe_0 - 2.0 * ta_x_xxx_1[i] * fe_0 + 3.0 * ta_xx_xx_0[i] * fe_0 -
                          3.0 * ta_xx_xx_1[i] * fe_0 + ta_xx_xxx_0[i] * pa_x[i] - ta_xx_xxx_1[i] * pc_x[i];

        ta_xxx_xxy_0[i] = 2.0 * ta_x_xxy_0[i] * fe_0 - 2.0 * ta_x_xxy_1[i] * fe_0 + 2.0 * ta_xx_xy_0[i] * fe_0 -
                          2.0 * ta_xx_xy_1[i] * fe_0 + ta_xx_xxy_0[i] * pa_x[i] - ta_xx_xxy_1[i] * pc_x[i];

        ta_xxx_xxz_0[i] = 2.0 * ta_x_xxz_0[i] * fe_0 - 2.0 * ta_x_xxz_1[i] * fe_0 + 2.0 * ta_xx_xz_0[i] * fe_0 -
                          2.0 * ta_xx_xz_1[i] * fe_0 + ta_xx_xxz_0[i] * pa_x[i] - ta_xx_xxz_1[i] * pc_x[i];

        ta_xxx_xyy_0[i] = 2.0 * ta_x_xyy_0[i] * fe_0 - 2.0 * ta_x_xyy_1[i] * fe_0 + ta_xx_yy_0[i] * fe_0 -
                          ta_xx_yy_1[i] * fe_0 + ta_xx_xyy_0[i] * pa_x[i] - ta_xx_xyy_1[i] * pc_x[i];

        ta_xxx_xyz_0[i] = 2.0 * ta_x_xyz_0[i] * fe_0 - 2.0 * ta_x_xyz_1[i] * fe_0 + ta_xx_yz_0[i] * fe_0 -
                          ta_xx_yz_1[i] * fe_0 + ta_xx_xyz_0[i] * pa_x[i] - ta_xx_xyz_1[i] * pc_x[i];

        ta_xxx_xzz_0[i] = 2.0 * ta_x_xzz_0[i] * fe_0 - 2.0 * ta_x_xzz_1[i] * fe_0 + ta_xx_zz_0[i] * fe_0 -
                          ta_xx_zz_1[i] * fe_0 + ta_xx_xzz_0[i] * pa_x[i] - ta_xx_xzz_1[i] * pc_x[i];

        ta_xxx_yyy_0[i] = 2.0 * ta_x_yyy_0[i] * fe_0 - 2.0 * ta_x_yyy_1[i] * fe_0 + ta_xx_yyy_0[i] * pa_x[i] -
                          ta_xx_yyy_1[i] * pc_x[i];

        ta_xxx_yyz_0[i] = 2.0 * ta_x_yyz_0[i] * fe_0 - 2.0 * ta_x_yyz_1[i] * fe_0 + ta_xx_yyz_0[i] * pa_x[i] -
                          ta_xx_yyz_1[i] * pc_x[i];

        ta_xxx_yzz_0[i] = 2.0 * ta_x_yzz_0[i] * fe_0 - 2.0 * ta_x_yzz_1[i] * fe_0 + ta_xx_yzz_0[i] * pa_x[i] -
                          ta_xx_yzz_1[i] * pc_x[i];

        ta_xxx_zzz_0[i] = 2.0 * ta_x_zzz_0[i] * fe_0 - 2.0 * ta_x_zzz_1[i] * fe_0 + ta_xx_zzz_0[i] * pa_x[i] -
                          ta_xx_zzz_1[i] * pc_x[i];
    }
...
#pragma omp simd aligned(pa_x,             \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        ta_xxy_xxy_0[i] =
            ta_xx_xx_0[i] * fe_0 - ta_xx_xx_1[i] * fe_0 + ta_xx_xxy_0[i] * pa_y[i] - ta_xx_xxy_1[i] * pc_y[i];

        ta_xxy_xxz_0[i] = ta_xx_xxz_0[i] * pa_y[i] - ta_xx_xxz_1[i] * pc_y[i];

        ta_xxy_xyy_0[i] = 2.0 * ta_xx_xy_0[i] * fe_0 - 2.0 * ta_xx_xy_1[i] * fe_0 + ta_xx_xyy_0[i] * pa_y[i] -
                          ta_xx_xyy_1[i] * pc_y[i];

        ta_xxy_xyz_0[i] =
            ta_xx_xz_0[i] * fe_0 - ta_xx_xz_1[i] * fe_0 + ta_xx_xyz_0[i] * pa_y[i] - ta_xx_xyz_1[i] * pc_y[i];

        ta_xxy_xzz_0[i] = ta_xx_xzz_0[i] * pa_y[i] - ta_xx_xzz_1[i] * pc_y[i];

        ta_xxy_yyy_0[i] =
            ta_y_yyy_0[i] * fe_0 - ta_y_yyy_1[i] * fe_0 + ta_xy_yyy_0[i] * pa_x[i] - ta_xy_yyy_1[i] * pc_x[i];

        ta_xxy_yyz_0[i] =
            ta_y_yyz_0[i] * fe_0 - ta_y_yyz_1[i] * fe_0 + ta_xy_yyz_0[i] * pa_x[i] - ta_xy_yyz_1[i] * pc_x[i];

        ta_xxy_yzz_0[i] =
            ta_y_yzz_0[i] * fe_0 - ta_y_yzz_1[i] * fe_0 + ta_xy_yzz_0[i] * pa_x[i] - ta_xy_yzz_1[i] * pc_x[i];
...
#pragma omp simd aligned(pa_x,             \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        ta_xxz_xxz_0[i] =
            ta_xx_xx_0[i] * fe_0 - ta_xx_xx_1[i] * fe_0 + ta_xx_xxz_0[i] * pa_z[i] - ta_xx_xxz_1[i] * pc_z[i];

        ta_xxz_xyy_0[i] = ta_xx_xyy_0[i] * pa_z[i] - ta_xx_xyy_1[i] * pc_z[i];

        ta_xxz_xyz_0[i] =
            ta_xx_xy_0[i] * fe_0 - ta_xx_xy_1[i] * fe_0 + ta_xx_xyz_0[i] * pa_z[i] - ta_xx_xyz_1[i] * pc_z[i];

        ta_xxz_xzz_0[i] = 2.0 * ta_xx_xz_0[i] * fe_0 - 2.0 * ta_xx_xz_1[i] * fe_0 + ta_xx_xzz_0[i] * pa_z[i] -
                          ta_xx_xzz_1[i] * pc_z[i];

        ta_xxz_yyy_0[i] = ta_xx_yyy_0[i] * pa_z[i] - ta_xx_yyy_1[i] * pc_z[i];

        ta_xxz_yyz_0[i] =
            ta_z_yyz_0[i] * fe_0 - ta_z_yyz_1[i] * fe_0 + ta_xz_yyz_0[i] * pa_x[i] - ta_xz_yyz_1[i] * pc_x[i];

        ta_xxz_yzz_0[i] =
            ta_z_yzz_0[i] * fe_0 - ta_z_yzz_1[i] * fe_0 + ta_xz_yzz_0[i] * pa_x[i] - ta_xz_yzz_1[i] * pc_x[i];

        ta_xxz_zzz_0[i] =
            ta_z_zzz_0[i] * fe_0 - ta_z_zzz_1[i] * fe_0 + ta_xz_zzz_0[i] * pa_x[i] - ta_xz_zzz_1[i] * pc_x[i];
    }
...
#pragma omp simd aligned(pa_x,             \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        ta_xyy_xxx_0[i] = 3.0 * ta_yy_xx_0[i] * fe_0 - 3.0 * ta_yy_xx_1[i] * fe_0 + ta_yy_xxx_0[i] * pa_x[i] -
                          ta_yy_xxx_1[i] * pc_x[i];

        ta_xyy_xxy_0[i] = 2.0 * ta_yy_xy_0[i] * fe_0 - 2.0 * ta_yy_xy_1[i] * fe_0 + ta_yy_xxy_0[i] * pa_x[i] -
                          ta_yy_xxy_1[i] * pc_x[i];

        ta_xyy_xxz_0[i] = 2.0 * ta_yy_xz_0[i] * fe_0 - 2.0 * ta_yy_xz_1[i] * fe_0 + ta_yy_xxz_0[i] * pa_x[i] -
                          ta_yy_xxz_1[i] * pc_x[i];

        ta_xyy_xyy_0[i] =
            ta_yy_yy_0[i] * fe_0 - ta_yy_yy_1[i] * fe_0 + ta_yy_xyy_0[i] * pa_x[i] - ta_yy_xyy_1[i] * pc_x[i];

        ta_xyy_xyz_0[i] =
            ta_yy_yz_0[i] * fe_0 - ta_yy_yz_1[i] * fe_0 + ta_yy_xyz_0[i] * pa_x[i] - ta_yy_xyz_1[i] * pc_x[i];

        ta_xyy_xzz_0[i] =
            ta_yy_zz_0[i] * fe_0 - ta_yy_zz_1[i] * fe_0 + ta_yy_xzz_0[i] * pa_x[i] - ta_yy_xzz_1[i] * pc_x[i];
...
#pragma omp simd aligned(pa_x,             \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        ta_xyz_xyz_0[i] =
            ta_yz_yz_0[i] * fe_0 - ta_yz_yz_1[i] * fe_0 + ta_yz_xyz_0[i] * pa_x[i] - ta_yz_xyz_1[i] * pc_x[i];
...
#pragma omp simd aligned(pa_x,             \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        ta_xzz_xxx_0[i] = 3.0 * ta_zz_xx_0[i] * fe_0 - 3.0 * ta_zz_xx_1[i] * fe_0 + ta_zz_xxx_0[i] * pa_x[i] -
                          ta_zz_xxx_1[i] * pc_x[i];

        ta_xzz_xxy_0[i] = 2.0 * ta_zz_xy_0[i] * fe_0 - 2.0 * ta_zz_xy_1[i] * fe_0 + ta_zz_xxy_0[i] * pa_x[i] -
                          ta_zz_xxy_1[i] * pc_x[i];

        ta_xzz_xxz_0[i] = 2.0 * ta_zz_xz_0[i] * fe_0 - 2.0 * ta_zz_xz_1[i] * fe_0 + ta_zz_xxz_0[i] * pa_x[i] -
                          ta_zz_xxz_1[i] * pc_x[i];

        ta_xzz_xyy_0[i] =
            ta_zz_yy_0[i] * fe_0 - ta_zz_yy_1[i] * fe_0 + ta_zz_xyy_0[i] * pa_x[i] - ta_zz_xyy_1[i] * pc_x[i];

        ta_xzz_xyz_0[i] =
            ta_zz_yz_0[i] * fe_0 - ta_zz_yz_1[i] * fe_0 + ta_zz_xyz_0[i] * pa_x[i] - ta_zz_xyz_1[i] * pc_x[i];

        ta_xzz_xzz_0[i] =
            ta_zz_zz_0[i] * fe_0 - ta_zz_zz_1[i] * fe_0 + ta_zz_xzz_0[i] * pa_x[i] - ta_zz_xzz_1[i] * pc_x[i];
...
#pragma omp simd aligned(pa_y,             \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        ta_yyy_xxx_0[i] = 2.0 * ta_y_xxx_0[i] * fe_0 - 2.0 * ta_y_xxx_1[i] * fe_0 + ta_yy_xxx_0[i] * pa_y[i] -
                          ta_yy_xxx_1[i] * pc_y[i];

        ta_yyy_xxy_0[i] = 2.0 * ta_y_xxy_0[i] * fe_0 - 2.0 * ta_y_xxy_1[i] * fe_0 + ta_yy_xx_0[i] * fe_0 -
                          ta_yy_xx_1[i] * fe_0 + ta_yy_xxy_0[i] * pa_y[i] - ta_yy_xxy_1[i] * pc_y[i];

        ta_yyy_xxz_0[i] = 2.0 * ta_y_xxz_0[i] * fe_0 - 2.0 * ta_y_xxz_1[i] * fe_0 + ta_yy_xxz_0[i] * pa_y[i] -
                          ta_yy_xxz_1[i] * pc_y[i];

        ta_yyy_xyy_0[i] = 2.0 * ta_y_xyy_0[i] * fe_0 - 2.0 * ta_y_xyy_1[i] * fe_0 + 2.0 * ta_yy_xy_0[i] * fe_0 -
                          2.0 * ta_yy_xy_1[i] * fe_0 + ta_yy_xyy_0[i] * pa_y[i] - ta_yy_xyy_1[i] * pc_y[i];

        ta_yyy_xyz_0[i] = 2.0 * ta_y_xyz_0[i] * fe_0 - 2.0 * ta_y_xyz_1[i] * fe_0 + ta_yy_xz_0[i] * fe_0 -
                          ta_yy_xz_1[i] * fe_0 + ta_yy_xyz_0[i] * pa_y[i] - ta_yy_xyz_1[i] * pc_y[i];

        ta_yyy_xzz_0[i] = 2.0 * ta_y_xzz_0[i] * fe_0 - 2.0 * ta_y_xzz_1[i] * fe_0 + ta_yy_xzz_0[i] * pa_y[i] -
                          ta_yy_xzz_1[i] * pc_y[i];

        ta_yyy_yyy_0[i] = 2.0 * ta_y_yyy_0[i] * fe_0 - 2.0 * ta_y_yyy_1[i] * fe_0 + 3.0 * ta_yy_yy_0[i] * fe_0 -
                          3.0 * ta_yy_yy_1[i] * fe_0 + ta_yy_yyy_0[i] * pa_y[i] - ta_yy_yyy_1[i] * pc_y[i];

        ta_yyy_yyz_0[i] = 2.0 * ta_y_yyz_0[i] * fe_0 - 2.0 * ta_y_yyz_1[i] * fe_0 + 2.0 * ta_yy_yz_0[i] * fe_0 -
                          2.0 * ta_yy_yz_1[i] * fe_0 + ta_yy_yyz_0[i] * pa_y[i] - ta_yy_yyz_1[i] * pc_y[i];

        ta_yyy_yzz_0[i] = 2.0 * ta_y_yzz_0[i] * fe_0 - 2.0 * ta_y_yzz_1[i] * fe_0 + ta_yy_zz_0[i] * fe_0 -
                          ta_yy_zz_1[i] * fe_0 + ta_yy_yzz_0[i] * pa_y[i] - ta_yy_yzz_1[i] * pc_y[i];

        ta_yyy_zzz_0[i] = 2.0 * ta_y_zzz_0[i] * fe_0 - 2.0 * ta_y_zzz_1[i] * fe_0 + ta_yy_zzz_0[i] * pa_y[i] -
                          ta_yy_zzz_1[i] * pc_y[i];
    }
...
#pragma omp simd aligned(pa_y,             \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        ta_yyz_xxz_0[i] =
            ta_z_xxz_0[i] * fe_0 - ta_z_xxz_1[i] * fe_0 + ta_yz_xxz_0[i] * pa_y[i] - ta_yz_xxz_1[i] * pc_y[i];

        ta_yyz_xyy_0[i] = ta_yy_xyy_0[i] * pa_z[i] - ta_yy_xyy_1[i] * pc_z[i];

        ta_yyz_xyz_0[i] =
            ta_yy_xy_0[i] * fe_0 - ta_yy_xy_1[i] * fe_0 + ta_yy_xyz_0[i] * pa_z[i] - ta_yy_xyz_1[i] * pc_z[i];

        ta_yyz_xzz_0[i] =
            ta_z_xzz_0[i] * fe_0 - ta_z_xzz_1[i] * fe_0 + ta_yz_xzz_0[i] * pa_y[i] - ta_yz_xzz_1[i] * pc_y[i];

        ta_yyz_yyy_0[i] = ta_yy_yyy_0[i] * pa_z[i] - ta_yy_yyy_1[i] * pc_z[i];

        ta_yyz_yyz_0[i] =
            ta_yy_yy_0[i] * fe_0 - ta_yy_yy_1[i] * fe_0 + ta_yy_yyz_0[i] * pa_z[i] - ta_yy_yyz_1[i] * pc_z[i];

        ta_yyz_yzz_0[i] = 2.0 * ta_yy_yz_0[i] * fe_0 - 2.0 * ta_yy_yz_1[i] * fe_0 + ta_yy_yzz_0[i] * pa_z[i] -
                          ta_yy_yzz_1[i] * pc_z[i];

        ta_yyz_zzz_0[i] =
            ta_z_zzz_0[i] * fe_0 - ta_z_zzz_1[i] * fe_0 + ta_yz_zzz_0[i] * pa_y[i] - ta_yz_zzz_1[i] * pc_y[i];
    }
...
#pragma omp simd aligned(pa_y,             \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        ta_yzz_xxy_0[i] =
            ta_zz_xx_0[i] * fe_0 - ta_zz_xx_1[i] * fe_0 + ta_zz_xxy_0[i] * pa_y[i] - ta_zz_xxy_1[i] * pc_y[i];

        ta_yzz_xxz_0[i] = ta_zz_xxz_0[i] * pa_y[i] - ta_zz_xxz_1[i] * pc_y[i];

        ta_yzz_xyy_0[i] = 2.0 * ta_zz_xy_0[i] * fe_0 - 2.0 * ta_zz_xy_1[i] * fe_0 + ta_zz_xyy_0[i] * pa_y[i] -
                          ta_zz_xyy_1[i] * pc_y[i];

        ta_yzz_xyz_0[i] =
            ta_zz_xz_0[i] * fe_0 - ta_zz_xz_1[i] * fe_0 + ta_zz_xyz_0[i] * pa_y[i] - ta_zz_xyz_1[i] * pc_y[i];

        ta_yzz_xzz_0[i] = ta_zz_xzz_0[i] * pa_y[i] - ta_zz_xzz_1[i] * pc_y[i];

        ta_yzz_yyy_0[i] = 3.0 * ta_zz_yy_0[i] * fe_0 - 3.0 * ta_zz_yy_1[i] * fe_0 + ta_zz_yyy_0[i] * pa_y[i] -
                          ta_zz_yyy_1[i] * pc_y[i];

        ta_yzz_yyz_0[i] = 2.0 * ta_zz_yz_0[i] * fe_0 - 2.0 * ta_zz_yz_1[i] * fe_0 + ta_zz_yyz_0[i] * pa_y[i] -
                          ta_zz_yyz_1[i] * pc_y[i];

        ta_yzz_yzz_0[i] =
            ta_zz_zz_0[i] * fe_0 - ta_zz_zz_1[i] * fe_0 + ta_zz_yzz_0[i] * pa_y[i] - ta_zz_yzz_1[i] * pc_y[i];
...
#pragma omp simd aligned(pa_z,             \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        ta_zzz_xxx_0[i] = 2.0 * ta_z_xxx_0[i] * fe_0 - 2.0 * ta_z_xxx_1[i] * fe_0 + ta_zz_xxx_0[i] * pa_z[i] -
                          ta_zz_xxx_1[i] * pc_z[i];

        ta_zzz_xxy_0[i] = 2.0 * ta_z_xxy_0[i] * fe_0 - 2.0 * ta_z_xxy_1[i] * fe_0 + ta_zz_xxy_0[i] * pa_z[i] -
                          ta_zz_xxy_1[i] * pc_z[i];

        ta_zzz_xxz_0[i] = 2.0 * ta_z_xxz_0[i] * fe_0 - 2.0 * ta_z_xxz_1[i] * fe_0 + ta_zz_xx_0[i] * fe_0 -
                          ta_zz_xx_1[i] * fe_0 + ta_zz_xxz_0[i] * pa_z[i] - ta_zz_xxz_1[i] * pc_z[i];

        ta_zzz_xyy_0[i] = 2.0 * ta_z_xyy_0[i] * fe_0 - 2.0 * ta_z_xyy_1[i] * fe_0 + ta_zz_xyy_0[i] * pa_z[i] -
                          ta_zz_xyy_1[i] * pc_z[i];

        ta_zzz_xyz_0[i] = 2.0 * ta_z_xyz_0[i] * fe_0 - 2.0 * ta_z_xyz_1[i] * fe_0 + ta_zz_xy_0[i] * fe_0 -
                          ta_zz_xy_1[i] * fe_0 + ta_zz_xyz_0[i] * pa_z[i] - ta_zz_xyz_1[i] * pc_z[i];

        ta_zzz_xzz_0[i] = 2.0 * ta_z_xzz_0[i] * fe_0 - 2.0 * ta_z_xzz_1[i] * fe_0 + 2.0 * ta_zz_xz_0[i] * fe_0 -
                          2.0 * ta_zz_xz_1[i] * fe_0 + ta_zz_xzz_0[i] * pa_z[i] - ta_zz_xzz_1[i] * pc_z[i];

        ta_zzz_yyy_0[i] = 2.0 * ta_z_yyy_0[i] * fe_0 - 2.0 * ta_z_yyy_1[i] * fe_0 + ta_zz_yyy_0[i] * pa_z[i] -
                          ta_zz_yyy_1[i] * pc_z[i];

        ta_zzz_yyz_0[i] = 2.0 * ta_z_yyz_0[i] * fe_0 - 2.0 * ta_z_yyz_1[i] * fe_0 + ta_zz_yy_0[i] * fe_0 -
                          ta_zz_yy_1[i] * fe_0 + ta_zz_yyz_0[i] * pa_z[i] - ta_zz_yyz_1[i] * pc_z[i];

        ta_zzz_yzz_0[i] = 2.0 * ta_z_yzz_0[i] * fe_0 - 2.0 * ta_z_yzz_1[i] * fe_0 + 2.0 * ta_zz_yz_0[i] * fe_0 -
                          2.0 * ta_zz_yz_1[i] * fe_0 + ta_zz_yzz_0[i] * pa_z[i] - ta_zz_yzz_1[i] * pc_z[i];

        ta_zzz_zzz_0[i] = 2.0 * ta_z_zzz_0[i] * fe_0 - 2.0 * ta_z_zzz_1[i] * fe_0 + 3.0 * ta_zz_zz_0[i] * fe_0 -
                          3.0 * ta_zz_zz_1[i] * fe_0 + ta_zz_zzz_0[i] * pa_z[i] - ta_zz_zzz_1[i] * pc_z[i];
    }
}
