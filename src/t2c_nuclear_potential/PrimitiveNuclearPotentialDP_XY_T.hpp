#ifndef PrimitiveNuclearPotentialDP_XY_T
#define PrimitiveNuclearPotentialDP_XY_T
...
*/
auto compPrimitiveNuclearPotentialDP_XY_T(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveNuclearPotentialDP_XY_T */
