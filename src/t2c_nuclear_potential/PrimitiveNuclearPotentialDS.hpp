#ifndef PrimitiveNuclearPotentialDS
#define PrimitiveNuclearPotentialDS
...
*/
auto compPrimitiveNuclearPotentialDS(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDS */
