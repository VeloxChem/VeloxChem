#ifndef PrimitiveNuclearPotentialGD_XZZZ_T
#define PrimitiveNuclearPotentialGD_XZZZ_T
...
*/
auto compPrimitiveNuclearPotentialGD_XZZZ_T(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialGD_XZZZ_T */
