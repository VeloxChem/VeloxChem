#ifndef PrimitiveNuclearPotentialGD_YYZZ_T
#define PrimitiveNuclearPotentialGD_YYZZ_T
...
*/
auto compPrimitiveNuclearPotentialGD_YYZZ_T(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialGD_YYZZ_T */
