#ifndef PrimitiveNuclearPotentialFP_YZZ_T
#define PrimitiveNuclearPotentialFP_YZZ_T
...
*/
auto compPrimitiveNuclearPotentialFP_YZZ_T(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveNuclearPotentialFP_YZZ_T */
