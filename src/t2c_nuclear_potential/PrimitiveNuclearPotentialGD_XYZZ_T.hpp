#ifndef PrimitiveNuclearPotentialGD_XYZZ_T
#define PrimitiveNuclearPotentialGD_XYZZ_T
...
*/
auto compPrimitiveNuclearPotentialGD_XYZZ_T(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialGD_XYZZ_T */
