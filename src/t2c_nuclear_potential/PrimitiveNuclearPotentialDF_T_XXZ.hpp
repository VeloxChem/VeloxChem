#ifndef PrimitiveNuclearPotentialDF_T_XXZ
#define PrimitiveNuclearPotentialDF_T_XXZ
...
*/
auto compPrimitiveNuclearPotentialDF_T_XXZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDF_T_XXZ */
