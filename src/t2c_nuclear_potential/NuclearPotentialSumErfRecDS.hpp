#ifndef NuclearPotentialSumErfRecDS_hpp
#define NuclearPotentialSumErfRecDS_hpp
...
/// @brief Computes (D|Erf(A)|S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_ds(T&                               distributor,
...
#endif /* NuclearPotentialSumErfRecDS_hpp */
