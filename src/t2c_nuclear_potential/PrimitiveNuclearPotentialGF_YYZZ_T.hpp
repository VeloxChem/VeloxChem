#ifndef PrimitiveNuclearPotentialGF_YYZZ_T
#define PrimitiveNuclearPotentialGF_YYZZ_T
...
*/
auto compPrimitiveNuclearPotentialGF_YYZZ_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialGF_YYZZ_T */
