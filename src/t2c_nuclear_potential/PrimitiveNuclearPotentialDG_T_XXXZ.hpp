#ifndef PrimitiveNuclearPotentialDG_T_XXXZ
#define PrimitiveNuclearPotentialDG_T_XXXZ
...
*/
auto compPrimitiveNuclearPotentialDG_T_XXXZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDG_T_XXXZ */
