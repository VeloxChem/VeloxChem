#ifndef PrimitiveNuclearPotentialDP_YY_T
#define PrimitiveNuclearPotentialDP_YY_T
...
*/
auto compPrimitiveNuclearPotentialDP_YY_T(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveNuclearPotentialDP_YY_T */
