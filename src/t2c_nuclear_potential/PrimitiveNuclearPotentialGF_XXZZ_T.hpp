#ifndef PrimitiveNuclearPotentialGF_XXZZ_T
#define PrimitiveNuclearPotentialGF_XXZZ_T
...
*/
auto compPrimitiveNuclearPotentialGF_XXZZ_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialGF_XXZZ_T */
