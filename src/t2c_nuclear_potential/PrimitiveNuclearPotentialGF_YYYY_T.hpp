#ifndef PrimitiveNuclearPotentialGF_YYYY_T
#define PrimitiveNuclearPotentialGF_YYYY_T
...
*/
auto compPrimitiveNuclearPotentialGF_YYYY_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialGF_YYYY_T */
