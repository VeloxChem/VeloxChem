#ifndef PrimitiveNuclearPotentialDP_ZZ_T
#define PrimitiveNuclearPotentialDP_ZZ_T
...
*/
auto compPrimitiveNuclearPotentialDP_ZZ_T(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveNuclearPotentialDP_ZZ_T */
