#ifndef PrimitiveNuclearPotentialFF_YZZ_T
#define PrimitiveNuclearPotentialFF_YZZ_T
...
*/
auto compPrimitiveNuclearPotentialFF_YZZ_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialFF_YZZ_T */
