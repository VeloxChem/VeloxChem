#ifndef NuclearPotentialPrimRecFS
#define NuclearPotentialPrimRecFS

#include "SimdArray.hpp"

namespace npotrec {  // npotrec namespace

/// @brief Computes primitive [F|A|S]  integrals for set of data buffers.
...
auto comp_prim_nuclear_potential_fs(CSimdArray<double>&       pbuffer,
...
#endif /* NuclearPotentialPrimRecFS */
