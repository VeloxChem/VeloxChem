#ifndef PrimitiveNuclearPotentialGG_XXYZ_T
#define PrimitiveNuclearPotentialGG_XXYZ_T
...
*/
auto compPrimitiveNuclearPotentialGG_XXYZ_T(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveNuclearPotentialGG_XXYZ_T */
