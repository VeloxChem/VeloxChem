#ifndef PrimitiveNuclearPotentialSD
#define PrimitiveNuclearPotentialSD
...
*/
auto compPrimitiveNuclearPotentialSD(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialSD */
