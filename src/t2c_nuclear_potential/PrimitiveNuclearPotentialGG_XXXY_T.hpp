#ifndef PrimitiveNuclearPotentialGG_XXXY_T
#define PrimitiveNuclearPotentialGG_XXXY_T
...
*/
auto compPrimitiveNuclearPotentialGG_XXXY_T(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveNuclearPotentialGG_XXXY_T */
