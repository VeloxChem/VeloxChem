#ifndef PrimitiveNuclearPotentialDG_T_YYYY
#define PrimitiveNuclearPotentialDG_T_YYYY
...
*/
auto compPrimitiveNuclearPotentialDG_T_YYYY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDG_T_YYYY */
