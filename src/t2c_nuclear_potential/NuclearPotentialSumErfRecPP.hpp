#ifndef NuclearPotentialSumErfRecPP_hpp
#define NuclearPotentialSumErfRecPP_hpp
...
/// @brief Computes (P|Erf(A)|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_pp(T&                               distributor,
                                  ...
                                  const bool                       bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(19, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < coords.size(); l++)
                {
                    ...
                    t2cfunc::comp_boys_args(bf_data, 3, factors, 17, a_exp, omegas[l]);
                    ...
                    npotrec::comp_prim_nuclear_potential_sp(pbuffer, 4, 1, 2, factors, 14, 17);

                    npotrec::comp_prim_nuclear_potential_sp(pbuffer, 7, 2, 3, factors, 14, 17);

                    npotrec::comp_prim_nuclear_potential_pp(pbuffer, 10, 1, 2, 4, 7, factors, 11, 17, a_exp);
...
#endif /* NuclearPotentialSumErfRecPP_hpp */
