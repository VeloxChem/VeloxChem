#ifndef NuclearPotentialSumRecDF_hpp
#define NuclearPotentialSumRecDF_hpp
...
/// @brief Computes (D|A|F)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_df(T&                               distributor,
                              ...
                              const bool                       bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(232, ket_npgtos);
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < coords.size(); l++)
                {
                    ...
                    npotrec::comp_prim_nuclear_potential_df(
                        pbuffer, 172, 46, 56, 76, 94, 112, 142, factors, 11, 17, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 172, charges[l], ket_width, ket_npgtos);
                }
            }
...
#endif /* NuclearPotentialSumRecDF_hpp */
