#ifndef PrimitiveNuclearPotentialDF_T_XYY
#define PrimitiveNuclearPotentialDF_T_XYY
...
*/
auto compPrimitiveNuclearPotentialDF_T_XYY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDF_T_XYY */
