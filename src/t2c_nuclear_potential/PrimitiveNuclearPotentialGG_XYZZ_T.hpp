#ifndef PrimitiveNuclearPotentialGG_XYZZ_T
#define PrimitiveNuclearPotentialGG_XYZZ_T
...
*/
auto compPrimitiveNuclearPotentialGG_XYZZ_T(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveNuclearPotentialGG_XYZZ_T */
