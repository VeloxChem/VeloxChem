#ifndef NuclearPotentialSumErfRecPG_hpp
#define NuclearPotentialSumErfRecPG_hpp
...
/// @brief Computes (P|Erf(A)|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_pg(T&                               distributor,
...
#endif /* NuclearPotentialSumErfRecPG_hpp */
