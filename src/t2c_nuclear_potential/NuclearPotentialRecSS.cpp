        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    npotrec::compPrimitiveNuclearPotentialSS(
                        buffer, charge, point, bra_exp, bra_norm, bra_coord, ket_exps, ket_norms, ket_coords_x, ket_coords_y, ket_coords_z, ket_dim);
                }
            }
