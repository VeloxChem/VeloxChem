#ifndef PrimitiveNuclearPotentialGG_YYYZ_T
#define PrimitiveNuclearPotentialGG_YYYZ_T
...
*/
auto compPrimitiveNuclearPotentialGG_YYYZ_T(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveNuclearPotentialGG_YYYZ_T */
