#ifndef PrimitiveNuclearPotentialFF_XXX_T
#define PrimitiveNuclearPotentialFF_XXX_T
...
*/
auto compPrimitiveNuclearPotentialFF_XXX_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialFF_XXX_T */
