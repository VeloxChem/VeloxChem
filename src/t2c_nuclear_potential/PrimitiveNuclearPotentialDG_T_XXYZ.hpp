#ifndef PrimitiveNuclearPotentialDG_T_XXYZ
#define PrimitiveNuclearPotentialDG_T_XXYZ
...
*/
auto compPrimitiveNuclearPotentialDG_T_XXYZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDG_T_XXYZ */
