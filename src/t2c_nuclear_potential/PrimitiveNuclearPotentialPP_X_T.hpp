#ifndef PrimitiveNuclearPotentialPP_X_T
#define PrimitiveNuclearPotentialPP_X_T
...
*/
auto compPrimitiveNuclearPotentialPP_X_T(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveNuclearPotentialPP_X_T */
