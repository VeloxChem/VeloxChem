#ifndef PrimitiveNuclearPotentialGG_YZZZ_T
#define PrimitiveNuclearPotentialGG_YZZZ_T
...
*/
auto compPrimitiveNuclearPotentialGG_YZZZ_T(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveNuclearPotentialGG_YZZZ_T */
