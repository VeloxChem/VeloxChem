#ifndef PrimitiveNuclearPotentialFG_T_XXZZ
#define PrimitiveNuclearPotentialFG_T_XXZZ
...
*/
auto compPrimitiveNuclearPotentialFG_T_XXZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialFG_T_XXZZ */
