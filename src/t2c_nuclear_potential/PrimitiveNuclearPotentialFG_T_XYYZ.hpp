#ifndef PrimitiveNuclearPotentialFG_T_XYYZ
#define PrimitiveNuclearPotentialFG_T_XYYZ
...
*/
auto compPrimitiveNuclearPotentialFG_T_XYYZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialFG_T_XYYZ */
