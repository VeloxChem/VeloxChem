#ifndef PrimitiveNuclearPotentialFG_T_ZZZZ
#define PrimitiveNuclearPotentialFG_T_ZZZZ
...
*/
auto compPrimitiveNuclearPotentialFG_T_ZZZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialFG_T_ZZZZ */
