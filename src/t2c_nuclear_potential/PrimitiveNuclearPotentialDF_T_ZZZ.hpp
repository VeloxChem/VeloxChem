#ifndef PrimitiveNuclearPotentialDF_T_ZZZ
#define PrimitiveNuclearPotentialDF_T_ZZZ
...
*/
auto compPrimitiveNuclearPotentialDF_T_ZZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDF_T_ZZZ */
