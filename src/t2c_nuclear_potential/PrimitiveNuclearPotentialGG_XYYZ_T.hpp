#ifndef PrimitiveNuclearPotentialGG_XYYZ_T
#define PrimitiveNuclearPotentialGG_XYYZ_T
...
*/
auto compPrimitiveNuclearPotentialGG_XYYZ_T(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveNuclearPotentialGG_XYYZ_T */
