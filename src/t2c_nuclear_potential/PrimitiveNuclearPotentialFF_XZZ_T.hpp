#ifndef PrimitiveNuclearPotentialFF_XZZ_T
#define PrimitiveNuclearPotentialFF_XZZ_T
...
*/
auto compPrimitiveNuclearPotentialFF_XZZ_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialFF_XZZ_T */
