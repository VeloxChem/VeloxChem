#ifndef PrimitiveNuclearPotentialDD_XZ_T
#define PrimitiveNuclearPotentialDD_XZ_T
...
*/
auto compPrimitiveNuclearPotentialDD_XZ_T(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDD_XZ_T */
