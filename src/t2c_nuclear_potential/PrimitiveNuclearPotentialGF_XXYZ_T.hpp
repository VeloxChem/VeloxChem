#ifndef PrimitiveNuclearPotentialGF_XXYZ_T
#define PrimitiveNuclearPotentialGF_XXYZ_T
...
*/
auto compPrimitiveNuclearPotentialGF_XXYZ_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialGF_XXYZ_T */
