#ifndef PrimitiveNuclearPotentialDF_T_YYZ
#define PrimitiveNuclearPotentialDF_T_YYZ
...
*/
auto compPrimitiveNuclearPotentialDF_T_YYZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDF_T_YYZ */
