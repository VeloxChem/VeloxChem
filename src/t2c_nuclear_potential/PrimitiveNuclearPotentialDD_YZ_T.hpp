#ifndef PrimitiveNuclearPotentialDD_YZ_T
#define PrimitiveNuclearPotentialDD_YZ_T
...
*/
auto compPrimitiveNuclearPotentialDD_YZ_T(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDD_YZ_T */
