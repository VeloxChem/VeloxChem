#ifndef PrimitiveNuclearPotentialGF_ZZZZ_T
#define PrimitiveNuclearPotentialGF_ZZZZ_T
...
*/
auto compPrimitiveNuclearPotentialGF_ZZZZ_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialGF_ZZZZ_T */
