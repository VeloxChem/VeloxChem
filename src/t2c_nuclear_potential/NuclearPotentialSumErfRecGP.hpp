#ifndef NuclearPotentialSumErfRecGP_hpp
#define NuclearPotentialSumErfRecGP_hpp
...
/// @brief Computes (G|Erf(A)|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_gp(T&                               distributor,
...
#endif /* NuclearPotentialSumErfRecGP_hpp */
