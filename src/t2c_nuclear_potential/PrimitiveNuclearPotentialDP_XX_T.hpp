#ifndef PrimitiveNuclearPotentialDP_XX_T
#define PrimitiveNuclearPotentialDP_XX_T
...
*/
auto compPrimitiveNuclearPotentialDP_XX_T(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveNuclearPotentialDP_XX_T */
