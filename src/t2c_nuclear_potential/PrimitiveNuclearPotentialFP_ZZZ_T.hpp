#ifndef PrimitiveNuclearPotentialFP_ZZZ_T
#define PrimitiveNuclearPotentialFP_ZZZ_T
...
*/
auto compPrimitiveNuclearPotentialFP_ZZZ_T(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveNuclearPotentialFP_ZZZ_T */
