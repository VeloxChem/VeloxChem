#ifndef NuclearPotentialSumErfRecPD_hpp
#define NuclearPotentialSumErfRecPD_hpp
...
/// @brief Computes (P|Erf(A)|D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_pd(T& distributor,
...
#endif /* NuclearPotentialSumErfRecPD_hpp */
