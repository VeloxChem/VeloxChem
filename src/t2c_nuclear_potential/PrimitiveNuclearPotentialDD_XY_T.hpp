#ifndef PrimitiveNuclearPotentialDD_XY_T
#define PrimitiveNuclearPotentialDD_XY_T
...
*/
auto compPrimitiveNuclearPotentialDD_XY_T(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDD_XY_T */
