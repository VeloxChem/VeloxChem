#ifndef PrimitiveNuclearPotentialDG_T_YZZZ
#define PrimitiveNuclearPotentialDG_T_YZZZ
...
*/
auto compPrimitiveNuclearPotentialDG_T_YZZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDG_T_YZZZ */
