#ifndef PrimitiveNuclearPotentialFP_XZZ_T
#define PrimitiveNuclearPotentialFP_XZZ_T
...
*/
auto compPrimitiveNuclearPotentialFP_XZZ_T(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveNuclearPotentialFP_XZZ_T */
