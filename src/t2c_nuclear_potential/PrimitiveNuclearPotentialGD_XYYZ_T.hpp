#ifndef PrimitiveNuclearPotentialGD_XYYZ_T
#define PrimitiveNuclearPotentialGD_XYYZ_T
...
*/
auto compPrimitiveNuclearPotentialGD_XYYZ_T(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialGD_XYYZ_T */
