#ifndef PrimitiveNuclearPotentialGG_XZZZ_T
#define PrimitiveNuclearPotentialGG_XZZZ_T
...
*/
auto compPrimitiveNuclearPotentialGG_XZZZ_T(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveNuclearPotentialGG_XZZZ_T */
