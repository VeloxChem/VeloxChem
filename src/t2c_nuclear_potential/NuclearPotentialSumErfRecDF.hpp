#ifndef NuclearPotentialSumErfRecDF_hpp
#define NuclearPotentialSumErfRecDF_hpp
...
/// @brief Computes (D|Erf(A)|F)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_df(T& distributor,
...
#endif /* NuclearPotentialSumErfRecDF_hpp */
