#ifndef PrimitiveNuclearPotentialDF_T_XZZ
#define PrimitiveNuclearPotentialDF_T_XZZ
...
*/
auto compPrimitiveNuclearPotentialDF_T_XZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDF_T_XZZ */
