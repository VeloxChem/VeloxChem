#ifndef PrimitiveNuclearPotentialDF_T_XXY
#define PrimitiveNuclearPotentialDF_T_XXY
...
*/
auto compPrimitiveNuclearPotentialDF_T_XXY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDF_T_XXY */
