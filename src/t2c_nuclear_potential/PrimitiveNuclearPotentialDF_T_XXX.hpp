#ifndef PrimitiveNuclearPotentialDF_T_XXX
#define PrimitiveNuclearPotentialDF_T_XXX
...
*/
auto compPrimitiveNuclearPotentialDF_T_XXX(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDF_T_XXX */
