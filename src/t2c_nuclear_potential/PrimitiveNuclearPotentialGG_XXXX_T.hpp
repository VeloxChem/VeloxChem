#ifndef PrimitiveNuclearPotentialGG_XXXX_T
#define PrimitiveNuclearPotentialGG_XXXX_T
...
*/
auto compPrimitiveNuclearPotentialGG_XXXX_T(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveNuclearPotentialGG_XXXX_T */
