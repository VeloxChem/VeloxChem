#ifndef PrimitiveNuclearPotentialFF_YYZ_T
#define PrimitiveNuclearPotentialFF_YYZ_T
...
*/
auto compPrimitiveNuclearPotentialFF_YYZ_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialFF_YYZ_T */
