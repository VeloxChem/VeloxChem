#ifndef PrimitiveNuclearPotentialFG_T_XYZZ
#define PrimitiveNuclearPotentialFG_T_XYZZ
...
*/
auto compPrimitiveNuclearPotentialFG_T_XYZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialFG_T_XYZZ */
