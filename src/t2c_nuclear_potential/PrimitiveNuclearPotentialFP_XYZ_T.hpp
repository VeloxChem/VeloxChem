#ifndef PrimitiveNuclearPotentialFP_XYZ_T
#define PrimitiveNuclearPotentialFP_XYZ_T
...
*/
auto compPrimitiveNuclearPotentialFP_XYZ_T(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveNuclearPotentialFP_XYZ_T */
