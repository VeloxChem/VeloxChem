#ifndef NuclearPotentialSumErfRecGS_hpp
#define NuclearPotentialSumErfRecGS_hpp
...
/// @brief Computes (G|Erf(A)|S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_gs(T& distributor,
...
#endif /* NuclearPotentialSumErfRecGS_hpp */
