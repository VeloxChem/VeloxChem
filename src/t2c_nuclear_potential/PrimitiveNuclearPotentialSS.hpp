#ifndef PrimitiveNuclearPotentialSS
#define PrimitiveNuclearPotentialSS
...
*/
auto compPrimitiveNuclearPotentialSS(TDoubleArray&       buffer,
                                     const double        charge,
...
#endif /* PrimitiveNuclearPotentialSS */
