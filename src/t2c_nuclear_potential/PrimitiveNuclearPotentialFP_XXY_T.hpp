#ifndef PrimitiveNuclearPotentialFP_XXY_T
#define PrimitiveNuclearPotentialFP_XXY_T
...
*/
auto compPrimitiveNuclearPotentialFP_XXY_T(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveNuclearPotentialFP_XXY_T */
