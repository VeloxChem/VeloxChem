#ifndef PrimitiveNuclearPotentialGG_XXYY_T
#define PrimitiveNuclearPotentialGG_XXYY_T
...
*/
auto compPrimitiveNuclearPotentialGG_XXYY_T(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveNuclearPotentialGG_XXYY_T */
