#ifndef PrimitiveNuclearPotentialFS
#define PrimitiveNuclearPotentialFS
...
/**
 Evaluates block of primitive <F|A|S> integrals.
...
*/
auto compPrimitiveNuclearPotentialFS(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialFS */
