#ifndef PrimitiveNuclearPotentialFF_XYZ_T
#define PrimitiveNuclearPotentialFF_XYZ_T
...
*/
auto compPrimitiveNuclearPotentialFF_XYZ_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialFF_XYZ_T */
