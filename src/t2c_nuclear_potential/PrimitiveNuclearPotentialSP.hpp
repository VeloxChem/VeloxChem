#ifndef PrimitiveNuclearPotentialSP
#define PrimitiveNuclearPotentialSP
...
/**
 Evaluates block of primitive <S|A|P> integrals.
...
*/
auto compPrimitiveNuclearPotentialSP(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveNuclearPotentialSP */
