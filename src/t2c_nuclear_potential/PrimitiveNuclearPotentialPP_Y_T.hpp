#ifndef PrimitiveNuclearPotentialPP_Y_T
#define PrimitiveNuclearPotentialPP_Y_T
...
*/
auto compPrimitiveNuclearPotentialPP_Y_T(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveNuclearPotentialPP_Y_T */
