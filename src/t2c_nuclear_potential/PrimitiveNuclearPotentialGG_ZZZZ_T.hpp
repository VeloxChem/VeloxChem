#ifndef PrimitiveNuclearPotentialGG_ZZZZ_T
#define PrimitiveNuclearPotentialGG_ZZZZ_T
...
*/
auto compPrimitiveNuclearPotentialGG_ZZZZ_T(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveNuclearPotentialGG_ZZZZ_T */
