#ifndef PrimitiveNuclearPotentialDF_T_XYZ
#define PrimitiveNuclearPotentialDF_T_XYZ
...
*/
auto compPrimitiveNuclearPotentialDF_T_XYZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDF_T_XYZ */
