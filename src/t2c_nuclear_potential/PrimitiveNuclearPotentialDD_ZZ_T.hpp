#ifndef PrimitiveNuclearPotentialDD_ZZ_T
#define PrimitiveNuclearPotentialDD_ZZ_T
...
*/
auto compPrimitiveNuclearPotentialDD_ZZ_T(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDD_ZZ_T */
