#ifndef PrimitiveNuclearPotentialGD_XXXX_T
#define PrimitiveNuclearPotentialGD_XXXX_T
...
*/
auto compPrimitiveNuclearPotentialGD_XXXX_T(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialGD_XXXX_T */
