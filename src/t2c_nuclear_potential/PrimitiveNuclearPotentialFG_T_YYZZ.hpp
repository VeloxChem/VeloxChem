#ifndef PrimitiveNuclearPotentialFG_T_YYZZ
#define PrimitiveNuclearPotentialFG_T_YYZZ
...
*/
auto compPrimitiveNuclearPotentialFG_T_YYZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialFG_T_YYZZ */
