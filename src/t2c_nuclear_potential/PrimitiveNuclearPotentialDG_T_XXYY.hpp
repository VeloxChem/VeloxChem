#ifndef PrimitiveNuclearPotentialDG_T_XXYY
#define PrimitiveNuclearPotentialDG_T_XXYY
...
*/
auto compPrimitiveNuclearPotentialDG_T_XXYY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDG_T_XXYY */
