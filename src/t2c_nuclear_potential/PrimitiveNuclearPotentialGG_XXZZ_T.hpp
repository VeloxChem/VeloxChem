#ifndef PrimitiveNuclearPotentialGG_XXZZ_T
#define PrimitiveNuclearPotentialGG_XXZZ_T
...
*/
auto compPrimitiveNuclearPotentialGG_XXZZ_T(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveNuclearPotentialGG_XXZZ_T */
