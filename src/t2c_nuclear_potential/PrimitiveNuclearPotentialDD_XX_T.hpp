#ifndef PrimitiveNuclearPotentialDD_XX_T
#define PrimitiveNuclearPotentialDD_XX_T
...
*/
auto compPrimitiveNuclearPotentialDD_XX_T(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDD_XX_T */
