...
#pragma omp simd aligned(fints_xxxx,     \
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xxxy[i] +=
            fss * b3_vals[i] * (-(3.0 / 2.0) * fe_0 * rpc_y * rpc_x - rpb_y * rpc_x * rpc_x * rpc_x - 3.0 * rpb_x * rpc_y * rpc_x * rpc_x);
        ...
        fints_xxxz[i] +=
            fss * b3_vals[i] * (-(3.0 / 2.0) * fe_0 * rpc_z * rpc_x - rpb_z * rpc_x * rpc_x * rpc_x - 3.0 * rpb_x * rpc_z * rpc_x * rpc_x);
        ...
        fints_xyyy[i] +=
            fss * b3_vals[i] * (-(3.0 / 2.0) * fe_0 * rpc_y * rpc_x - 3.0 * rpb_y * rpc_y * rpc_y * rpc_x - rpb_x * rpc_y * rpc_y * rpc_y);
        ...
        fints_xyyz[i] += fss * b1_vals[i] *
                         (-(1.0 / 2.0) * fe_0 * rpb_z * rpb_x - (1.0 / 2.0) * fe_0 * rpb_z * rpc_x - (1.0 / 2.0) * fe_0 * rpb_x * rpc_z -
                          2.0 * rpb_z * rpb_y * rpb_x * rpc_y - rpb_z * rpb_y * rpb_y * rpc_x);
        ...
        fints_xyyz[i] += fss * b2_vals[i] *
                         ((1.0 / 2.0) * fe_0 * rpb_z * rpc_x + (1.0 / 2.0) * fe_0 * rpb_x * rpc_z + (1.0 / 2.0) * fe_0 * rpc_z * rpc_x +
                          2.0 * rpb_z * rpb_y * rpc_y * rpc_x + rpb_z * rpb_x * rpc_y * rpc_y);

        fints_xyyz[i] += fss * b2_vals[i] * (2.0 * rpb_y * rpb_x * rpc_z * rpc_y + rpb_y * rpb_y * rpc_z * rpc_x);

        fints_xyyz[i] += fss * b3_vals[i] *
                         (-(1.0 / 2.0) * fe_0 * rpc_z * rpc_x - rpb_z * rpc_y * rpc_y * rpc_x - 2.0 * rpb_y * rpc_z * rpc_y * rpc_x -
        ...
        fints_xzzz[i] +=
            fss * b3_vals[i] * (-(3.0 / 2.0) * fe_0 * rpc_z * rpc_x - 3.0 * rpb_z * rpc_z * rpc_z * rpc_x - rpb_x * rpc_z * rpc_z * rpc_z);
        ...
        fints_yyyz[i] +=
            fss * b3_vals[i] * (-(3.0 / 2.0) * fe_0 * rpc_z * rpc_y - rpb_z * rpc_y * rpc_y * rpc_y - 3.0 * rpb_y * rpc_z * rpc_y * rpc_y);
        ...
        fints_yzzz[i] +=
            fss * b3_vals[i] * (-(3.0 / 2.0) * fe_0 * rpc_z * rpc_y - 3.0 * rpb_z * rpc_z * rpc_z * rpc_y - rpb_y * rpc_z * rpc_z * rpc_z);
