#ifndef PrimitiveNuclearPotentialFG_T_XXXX
#define PrimitiveNuclearPotentialFG_T_XXXX
...
*/
auto compPrimitiveNuclearPotentialFG_T_XXXX(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialFG_T_XXXX */
