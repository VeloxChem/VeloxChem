#ifndef PrimitiveNuclearPotentialDD_YY_T
#define PrimitiveNuclearPotentialDD_YY_T
...
*/
auto compPrimitiveNuclearPotentialDD_YY_T(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDD_YY_T */
