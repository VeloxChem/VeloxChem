#ifndef PrimitiveNuclearPotentialDG_T_YYZZ
#define PrimitiveNuclearPotentialDG_T_YYZZ
...
*/
auto compPrimitiveNuclearPotentialDG_T_YYZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDG_T_YYZZ */
