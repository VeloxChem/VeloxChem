#ifndef PrimitiveNuclearPotentialGF_YZZZ_T
#define PrimitiveNuclearPotentialGF_YZZZ_T
...
*/
auto compPrimitiveNuclearPotentialGF_YZZZ_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialGF_YZZZ_T */
