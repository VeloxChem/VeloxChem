#ifndef PrimitiveNuclearPotentialFD_YYZ_T
#define PrimitiveNuclearPotentialFD_YYZ_T
...
*/
auto compPrimitiveNuclearPotentialFD_YYZ_T(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialFD_YYZ_T */
