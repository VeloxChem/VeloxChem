#ifndef NuclearPotentialSumErfRecFS_hpp
#define NuclearPotentialSumErfRecFS_hpp
...
/// @brief Computes (F|Erf(A)|S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_fs(T&                               distributor,
...
#endif /* NuclearPotentialSumErfRecFS_hpp */
