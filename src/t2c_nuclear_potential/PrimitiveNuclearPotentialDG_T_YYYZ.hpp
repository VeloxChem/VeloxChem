#ifndef PrimitiveNuclearPotentialDG_T_YYYZ
#define PrimitiveNuclearPotentialDG_T_YYYZ
...
*/
auto compPrimitiveNuclearPotentialDG_T_YYYZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDG_T_YYYZ */
