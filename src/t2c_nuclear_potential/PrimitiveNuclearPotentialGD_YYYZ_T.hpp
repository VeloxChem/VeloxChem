#ifndef PrimitiveNuclearPotentialGD_YYYZ_T
#define PrimitiveNuclearPotentialGD_YYYZ_T
...
*/
auto compPrimitiveNuclearPotentialGD_YYYZ_T(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialGD_YYYZ_T */
