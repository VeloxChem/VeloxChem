#ifndef NuclearPotentialSumRecSD_hpp
#define NuclearPotentialSumRecSD_hpp
...
/// @brief Computes (S|A|D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_sd(T&                               distributor,
...
#endif /* NuclearPotentialSumRecSD_hpp */
