#ifndef PrimitiveNuclearPotentialDG_T_XYYZ
#define PrimitiveNuclearPotentialDG_T_XYYZ
...
*/
auto compPrimitiveNuclearPotentialDG_T_XYYZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDG_T_XYYZ */
