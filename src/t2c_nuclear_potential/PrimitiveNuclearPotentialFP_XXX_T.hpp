#ifndef PrimitiveNuclearPotentialFP_XXX_T
#define PrimitiveNuclearPotentialFP_XXX_T
...
*/
auto compPrimitiveNuclearPotentialFP_XXX_T(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveNuclearPotentialFP_XXX_T */
