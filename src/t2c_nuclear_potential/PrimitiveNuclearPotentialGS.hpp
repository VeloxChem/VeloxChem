#ifndef PrimitiveNuclearPotentialGS
#define PrimitiveNuclearPotentialGS
...
/**
 Evaluates block of primitive <G|A|S> integrals.
...
*/
auto compPrimitiveNuclearPotentialGS(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveNuclearPotentialGS */
