#ifndef PrimitiveNuclearPotentialFF_XXY_T
#define PrimitiveNuclearPotentialFF_XXY_T
...
*/
auto compPrimitiveNuclearPotentialFF_XXY_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialFF_XXY_T */
