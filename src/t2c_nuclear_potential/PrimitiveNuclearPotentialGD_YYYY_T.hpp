#ifndef PrimitiveNuclearPotentialGD_YYYY_T
#define PrimitiveNuclearPotentialGD_YYYY_T
...
*/
auto compPrimitiveNuclearPotentialGD_YYYY_T(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialGD_YYYY_T */
