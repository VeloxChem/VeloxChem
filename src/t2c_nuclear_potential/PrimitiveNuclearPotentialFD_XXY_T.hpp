#ifndef PrimitiveNuclearPotentialFD_XXY_T
#define PrimitiveNuclearPotentialFD_XXY_T
...
*/
auto compPrimitiveNuclearPotentialFD_XXY_T(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialFD_XXY_T */
