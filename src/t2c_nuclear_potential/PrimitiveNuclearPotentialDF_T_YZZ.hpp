#ifndef PrimitiveNuclearPotentialDF_T_YZZ
#define PrimitiveNuclearPotentialDF_T_YZZ
...
*/
auto compPrimitiveNuclearPotentialDF_T_YZZ(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDF_T_YZZ */
