#ifndef NuclearPotentialSumErfRecPF_hpp
#define NuclearPotentialSumErfRecPF_hpp
...
/// @brief Computes (P|Erf(A)|F)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_pf(T&                               distributor,
...
#endif /* NuclearPotentialSumErfRecPF_hpp */
