#ifndef PrimitiveNuclearPotentialGF_XXXY_T
#define PrimitiveNuclearPotentialGF_XXXY_T
...
*/
auto compPrimitiveNuclearPotentialGF_XXXY_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialGF_XXXY_T */
