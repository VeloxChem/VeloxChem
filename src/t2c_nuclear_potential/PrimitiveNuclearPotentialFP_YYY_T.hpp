#ifndef PrimitiveNuclearPotentialFP_YYY_T
#define PrimitiveNuclearPotentialFP_YYY_T
...
*/
auto compPrimitiveNuclearPotentialFP_YYY_T(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveNuclearPotentialFP_YYY_T */
