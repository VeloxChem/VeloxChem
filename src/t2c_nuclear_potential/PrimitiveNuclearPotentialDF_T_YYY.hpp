#ifndef PrimitiveNuclearPotentialDF_T_YYY
#define PrimitiveNuclearPotentialDF_T_YYY
...
*/
auto compPrimitiveNuclearPotentialDF_T_YYY(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialDF_T_YYY */
