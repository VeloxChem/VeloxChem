#ifndef PrimitiveNuclearPotentialFD_YZZ_T
#define PrimitiveNuclearPotentialFD_YZZ_T
...
*/
auto compPrimitiveNuclearPotentialFD_YZZ_T(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialFD_YZZ_T */
