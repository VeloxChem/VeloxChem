    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_y[i] += fss * b1_vals[i] *
                      (-(1.0 / 2.0) * fe_0 * rpa_x * rpb_y - (1.0 / 2.0) * fe_0 * rpa_x * rpc_y - (1.0 / 2.0) * fe_0 * rpb_y * rpc_x -
                       2.0 * rpa_z * rpa_x * rpb_y * rpc_z - rpa_z * rpa_z * rpa_x * rpc_y);
        ...
        fints_y[i] += fss * b2_vals[i] *
                      ((1.0 / 2.0) * fe_0 * rpa_x * rpc_y + (1.0 / 2.0) * fe_0 * rpb_y * rpc_x + (1.0 / 2.0) * fe_0 * rpc_y * rpc_x +
                       2.0 * rpa_z * rpa_x * rpc_z * rpc_y + 2.0 * rpa_z * rpb_y * rpc_z * rpc_x);

        fints_y[i] += fss * b2_vals[i] * (rpa_z * rpa_z * rpc_y * rpc_x + rpa_x * rpb_y * rpc_z * rpc_z);

        fints_y[i] += fss * b3_vals[i] *
                      (-(1.0 / 2.0) * fe_0 * rpc_y * rpc_x - 2.0 * rpa_z * rpc_z * rpc_y * rpc_x - rpa_x * rpc_z * rpc_z * rpc_y -
                       rpb_y * rpc_z * rpc_z * rpc_x);
