#ifndef NuclearPotentialPrimRecHD
#define NuclearPotentialPrimRecHD

#include "SimdArray.hpp"

namespace npotrec {  // npotrec namespace

/// @brief Computes primitive [H|A|D]  integrals for set of data buffers.
...
auto comp_prim_nuclear_potential_hd(CSimdArray<double>&       pbuffer,
...
#endif /* NuclearPotentialPrimRecHD */
