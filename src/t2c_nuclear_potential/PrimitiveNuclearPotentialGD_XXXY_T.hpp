#ifndef PrimitiveNuclearPotentialGD_XXXY_T
#define PrimitiveNuclearPotentialGD_XXXY_T
...
*/
auto compPrimitiveNuclearPotentialGD_XXXY_T(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialGD_XXXY_T */
