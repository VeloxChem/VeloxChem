#ifndef PrimitiveNuclearPotentialGF_XZZZ_T
#define PrimitiveNuclearPotentialGF_XZZZ_T
...
*/
auto compPrimitiveNuclearPotentialGF_XZZZ_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialGF_XZZZ_T */
