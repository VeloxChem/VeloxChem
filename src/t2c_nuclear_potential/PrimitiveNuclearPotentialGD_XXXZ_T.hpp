#ifndef PrimitiveNuclearPotentialGD_XXXZ_T
#define PrimitiveNuclearPotentialGD_XXXZ_T
...
*/
auto compPrimitiveNuclearPotentialGD_XXXZ_T(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialGD_XXXZ_T */
