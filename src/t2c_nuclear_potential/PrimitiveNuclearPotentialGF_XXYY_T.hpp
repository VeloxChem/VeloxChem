#ifndef PrimitiveNuclearPotentialGF_XXYY_T
#define PrimitiveNuclearPotentialGF_XXYY_T
...
*/
auto compPrimitiveNuclearPotentialGF_XXYY_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialGF_XXYY_T */
