#ifndef PrimitiveNuclearPotentialFP_XYY_T
#define PrimitiveNuclearPotentialFP_XYY_T
...
*/
auto compPrimitiveNuclearPotentialFP_XYY_T(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveNuclearPotentialFP_XYY_T */
