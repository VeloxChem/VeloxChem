#ifndef PrimitiveNuclearPotentialGD_YZZZ_T
#define PrimitiveNuclearPotentialGD_YZZZ_T
...
*/
auto compPrimitiveNuclearPotentialGD_YZZZ_T(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialGD_YZZZ_T */
