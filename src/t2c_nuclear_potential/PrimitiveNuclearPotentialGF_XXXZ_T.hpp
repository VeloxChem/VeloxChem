#ifndef PrimitiveNuclearPotentialGF_XXXZ_T
#define PrimitiveNuclearPotentialGF_XXXZ_T
...
*/
auto compPrimitiveNuclearPotentialGF_XXXZ_T(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialGF_XXXZ_T */
