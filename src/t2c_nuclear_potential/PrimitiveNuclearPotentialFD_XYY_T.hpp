#ifndef PrimitiveNuclearPotentialFD_XYY_T
#define PrimitiveNuclearPotentialFD_XYY_T
...
*/
auto compPrimitiveNuclearPotentialFD_XYY_T(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveNuclearPotentialFD_XYY_T */
