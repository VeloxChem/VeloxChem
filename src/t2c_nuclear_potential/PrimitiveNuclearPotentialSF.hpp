#ifndef PrimitiveNuclearPotentialSF
#define PrimitiveNuclearPotentialSF
...
*/
auto compPrimitiveNuclearPotentialSF(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialSF */
