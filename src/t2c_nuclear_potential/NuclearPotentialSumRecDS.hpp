#ifndef NuclearPotentialSumRecDS_hpp
#define NuclearPotentialSumRecDS_hpp
...
/// @brief Computes (D|A|S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_ds(T&                               distributor,
...
#endif /* NuclearPotentialSumRecDS_hpp */
