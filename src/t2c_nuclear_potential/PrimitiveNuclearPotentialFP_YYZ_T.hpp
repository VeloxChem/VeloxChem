#ifndef PrimitiveNuclearPotentialFP_YYZ_T
#define PrimitiveNuclearPotentialFP_YYZ_T
...
*/
auto compPrimitiveNuclearPotentialFP_YYZ_T(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveNuclearPotentialFP_YYZ_T */
