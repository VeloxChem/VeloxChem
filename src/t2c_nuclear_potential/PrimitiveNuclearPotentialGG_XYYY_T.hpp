#ifndef PrimitiveNuclearPotentialGG_XYYY_T
#define PrimitiveNuclearPotentialGG_XYYY_T
...
*/
auto compPrimitiveNuclearPotentialGG_XYYY_T(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveNuclearPotentialGG_XYYY_T */
