#ifndef PrimitiveNuclearPotentialGG_XXXZ_T
#define PrimitiveNuclearPotentialGG_XXXZ_T
...
*/
auto compPrimitiveNuclearPotentialGG_XXXZ_T(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveNuclearPotentialGG_XXXZ_T */
