#ifndef PrimitiveNuclearPotentialFG_T_YZZZ
#define PrimitiveNuclearPotentialFG_T_YZZZ
...
*/
auto compPrimitiveNuclearPotentialFG_T_YZZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveNuclearPotentialFG_T_YZZZ */
