#ifndef PrimitiveNuclearPotentialDP_YZ_T
#define PrimitiveNuclearPotentialDP_YZ_T
...
*/
auto compPrimitiveNuclearPotentialDP_YZ_T(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveNuclearPotentialDP_YZ_T */
