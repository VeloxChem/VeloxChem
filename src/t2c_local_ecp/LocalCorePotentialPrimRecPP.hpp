#ifndef LocalCorePotentialPrimRecPP
#define LocalCorePotentialPrimRecPP

#include "SimdArray.hpp"

namespace t2lecp { // t2lecp namespace

/// @brief Computes primitive [P|U_L|P] integrals for set of data buffers.
...
#endif /* LocalCorePotentialPrimRecPP */
