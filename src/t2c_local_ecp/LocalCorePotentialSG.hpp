#ifndef LocalCorePotentialSG_hpp
#define LocalCorePotentialSG_hpp
...
template <class T>
auto
comp_local_core_potential_sg(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_sg(pbuffer, 20, 4, 10, pfactors, 8, 11);
...
#endif /* LocalCorePotentialSG_hpp */
