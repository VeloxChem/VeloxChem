#ifndef LocalCorePotentialPrimRecPF
#define LocalCorePotentialPrimRecPF

#include "SimdArray.hpp"

namespace t2lecp { // t2lecp namespace

/// @brief Computes primitive [P|U_L|F] integrals for set of data buffers.
...
#endif /* LocalCorePotentialPrimRecPF */
