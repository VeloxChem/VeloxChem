#ifndef LocalCorePotentialPrimRecDH
#define LocalCorePotentialPrimRecDH

#include "SimdArray.hpp"

namespace t2lecp { // t2lecp namespace

/// @brief Computes primitive [D|U_L|H] integrals for set of data buffers.
...
#endif /* LocalCorePotentialPrimRecDH */
