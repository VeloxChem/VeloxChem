#ifndef LocalCorePotentialPrimRecFH
#define LocalCorePotentialPrimRecFH

#include "SimdArray.hpp"

namespace t2lecp { // t2lecp namespace

/// @brief Computes primitive [F|U_L|H] integrals for set of data buffers.
...
#endif /* LocalCorePotentialPrimRecFH */
