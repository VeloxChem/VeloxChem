#ifndef LocalCorePotentialPrimRecPI
#define LocalCorePotentialPrimRecPI

#include "SimdArray.hpp"

namespace t2lecp { // t2lecp namespace

/// @brief Computes primitive [P|U_L|I] integrals for set of data buffers.
...
#endif /* LocalCorePotentialPrimRecPI */
