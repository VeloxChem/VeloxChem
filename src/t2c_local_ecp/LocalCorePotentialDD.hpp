#ifndef LocalCorePotentialDD_hpp
#define LocalCorePotentialDD_hpp
...
template <class T>
auto
comp_local_core_potential_dd(T& distributor,
                             ...
                             const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> cbuffer(115, 1);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cfunc::reduce(cbuffer, 16, pbuffer, 20, 15, ket_width, ket_npgtos);

                }
            }

            t2chrr::comp_hrr_pd(cbuffer, 31, 0, 6, cfactors);

            t2chrr::comp_hrr_pf(cbuffer, 49, 6, 16, cfactors);

            t2chrr::comp_hrr_dd(cbuffer, 79, 31, 49, cfactors);

            t2cfunc::transform<2, 2>(sbuffer, cbuffer, 79);
...
#endif /* LocalCorePotentialDD_hpp */
