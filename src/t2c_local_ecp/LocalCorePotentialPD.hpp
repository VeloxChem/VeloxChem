#ifndef LocalCorePotentialPD_hpp
#define LocalCorePotentialPD_hpp
...
template <class T>
auto
comp_local_core_potential_pd(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cfunc::reduce(cbuffer, 6, pbuffer, 10, 10, ket_width, ket_npgtos);

                }
            }

            t2chrr::comp_hrr_pd(cbuffer, 16, 0, 6, cfactors);

            t2cfunc::transform<1, 2>(sbuffer, cbuffer, 16);
...
#endif /* LocalCorePotentialPD_hpp */
