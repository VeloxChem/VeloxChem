#ifndef LocalCorePotentialPG_hpp
#define LocalCorePotentialPG_hpp
...
template <class T>
auto
comp_local_core_potential_pg(T& distributor,
                             ...
                             const bool bra_eq_ket) -> void
{
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            t2chrr::comp_hrr_pg(cbuffer, 36, 0, 15, cfactors);

            t2cfunc::transform<1, 4>(sbuffer, cbuffer, 36);
...
#endif /* LocalCorePotentialPG_hpp */
