#ifndef LocalCorePotentialDP_hpp
#define LocalCorePotentialDP_hpp
...
template <class T>
auto
comp_local_core_potential_dp(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cfunc::reduce(cbuffer, 24, pbuffer, 10, 10, ket_width, ket_npgtos);

                }
            }

            t2chrr::comp_hrr_dp(cbuffer, 6, 0, 24, cfactors);

            t2cfunc::transform<2, 1>(sbuffer, cbuffer, 6);
...
#endif /* LocalCorePotentialDP_hpp */
