#ifndef LocalCorePotentialSF_hpp
#define LocalCorePotentialSF_hpp
...
template <class T>
auto
comp_local_core_potential_sf(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_sp(pbuffer, 1, 0, pfactors, 8, 11);

                    t2lecp::comp_prim_local_core_potential_sd(pbuffer, 4, 0, 1, pfactors, 8, 11);

                    t2lecp::comp_prim_local_core_potential_sf(pbuffer, 10, 1, 4, pfactors, 8, 11);
...
#endif /* LocalCorePotentialSF_hpp */
