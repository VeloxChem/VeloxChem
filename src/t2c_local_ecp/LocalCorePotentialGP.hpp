#ifndef LocalCorePotentialGP_hpp
#define LocalCorePotentialGP_hpp
...
template <class T>
auto
comp_local_core_potential_gp(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cfunc::reduce(cbuffer, 60, pbuffer, 35, 21, ket_width, ket_npgtos);

                }
            }

            t2chrr::comp_hrr_gp(cbuffer, 15, 0, 60, cfactors);

            t2cfunc::transform<4, 1>(sbuffer, cbuffer, 15);
...
#endif /* LocalCorePotentialGP_hpp */
