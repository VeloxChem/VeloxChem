#ifndef LocalCorePotentialPF_hpp
#define LocalCorePotentialPF_hpp
...
template <class T>
auto
comp_local_core_potential_pf(T& distributor,
                             ...
                             const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> cbuffer(55, 1);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cfunc::reduce(cbuffer, 10, pbuffer, 20, 15, ket_width, ket_npgtos);

                }
            }

            t2chrr::comp_hrr_pf(cbuffer, 25, 0, 10, cfactors);

            t2cfunc::transform<1, 3>(sbuffer, cbuffer, 25);
...
#endif /* LocalCorePotentialPF_hpp */
