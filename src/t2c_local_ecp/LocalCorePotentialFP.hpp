#ifndef LocalCorePotentialFP_hpp
#define LocalCorePotentialFP_hpp
...
template <class T>
auto
comp_local_core_potential_fp(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cfunc::reduce(cbuffer, 40, pbuffer, 20, 15, ket_width, ket_npgtos);

                }
            }

            t2chrr::comp_hrr_fp(cbuffer, 10, 0, 40, cfactors);

            t2cfunc::transform<3, 1>(sbuffer, cbuffer, 10);
...
#endif /* LocalCorePotentialFP_hpp */
