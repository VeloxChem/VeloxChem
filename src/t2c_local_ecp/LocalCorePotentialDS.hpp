#ifndef LocalCorePotentialDS_hpp
#define LocalCorePotentialDS_hpp
...
template <class T>
auto
comp_local_core_potential_ds(T& distributor,
                             ...
                             const bool bra_eq_ket) -> void
{
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            t2cfunc::transform<2, 0>(sbuffer, cbuffer, 0);
...
#endif /* LocalCorePotentialDS_hpp */
