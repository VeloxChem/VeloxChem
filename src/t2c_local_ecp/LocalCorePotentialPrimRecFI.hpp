#ifndef LocalCorePotentialPrimRecFI
#define LocalCorePotentialPrimRecFI

#include "SimdArray.hpp"

namespace t2lecp { // t2lecp namespace

/// @brief Computes primitive [F|U_L|I] integrals for set of data buffers.
...
#endif /* LocalCorePotentialPrimRecFI */
