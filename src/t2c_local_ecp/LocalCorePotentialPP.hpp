#ifndef LocalCorePotentialPP_hpp
#define LocalCorePotentialPP_hpp
...
template <class T>
auto
comp_local_core_potential_pp(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cfunc::reduce(cbuffer, 3, pbuffer, 4, 6, ket_width, ket_npgtos);

                }
            }

            t2chrr::comp_hrr_pp(cbuffer, 9, 0, 3, cfactors);

            t2cfunc::transform<1, 1>(sbuffer, cbuffer, 9);
...
#endif /* LocalCorePotentialPP_hpp */
