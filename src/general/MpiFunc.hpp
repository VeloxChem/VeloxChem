 ...
 */
auto bcastScalar(const int val, MPI_Comm comm) -> int;
 ...
 */
auto scatterStdVector(const std::vector<int>& vec, MPI_Comm comm) -> std::vector<int>;
