...
#pragma omp simd aligned(fints_xx, fints_xy, fints_xz, fints_yy, fints_yz, fints_zz, ket_fe, ket_fn, ket_rx, ket_ry, ket_rz : 64)
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xx[i] += (faa_xx * b3_vals[i] + faa * b2_vals[i]) * (-(1.0 / 2.0) * fe_0 * rpb_z - (1.0 / 2.0) * fe_0 * rpc_z - rpa_y * rpb_z * rpc_y -
                                                                   rpa_y * rpb_y * rpc_z - rpb_z * rpb_y * rpc_y);

        fints_xx[i] += (faa_xx * b4_vals[i] + faa * b3_vals[i]) *
                       ((1.0 / 2.0) * fe_0 * rpc_z + rpa_y * rpc_z * rpc_y + rpb_z * rpc_y * rpc_y + rpb_y * rpc_z * rpc_y);
        ...
        fints_yy[i] += (faa_yy * b3_vals[i] + faa * b2_vals[i]) * (-(1.0 / 2.0) * fe_0 * rpb_z - (1.0 / 2.0) * fe_0 * rpc_z - rpa_y * rpb_z * rpc_y -
                                                                   rpa_y * rpb_y * rpc_z - rpb_z * rpb_y * rpc_y);
        ...
        fints_zz[i] += (faa_zz * b3_vals[i] + faa * b2_vals[i]) * (-(1.0 / 2.0) * fe_0 * rpb_z - (1.0 / 2.0) * fe_0 * rpc_z - rpa_y * rpb_z * rpc_y -
                                                                   rpa_y * rpb_y * rpc_z - rpb_z * rpb_y * rpc_y);
