#include "PrimitiveNuclearPotentialGeom020SS_0_0.hpp"
                                           ...
                                           const int64_t       ket_dim) -> void
{
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xx[i] += qpol_xx * fss * (4.0 * fxi_0 * fxi_0 * rpc_x * rpc_x * b2_vals[i] - 2.0 * fxi_0 * b1_vals[i]);

        fints_xy[i] += qpol_xy * fss * 4.0 * fxi_0 * fxi_0 * rpc_x * rpc_y * b2_vals[i];

        fints_xz[i] += qpol_xz * fss * 4.0 * fxi_0 * fxi_0 * rpc_x * rpc_z * b2_vals[i];

        fints_yy[i] += qpol_yy * fss * (4.0 * fxi_0 * fxi_0 * rpc_y * rpc_y * b2_vals[i] - 2.0 * fxi_0 * b1_vals[i]);

        fints_yz[i] += qpol_yz * fss * 4.0 * fxi_0 * fxi_0 * rpc_y * rpc_z * b2_vals[i];

        fints_zz[i] += qpol_zz * fss * (4.0 * fxi_0 * fxi_0 * rpc_z * rpc_z * b2_vals[i] - 2.0 * fxi_0 * b1_vals[i]);
