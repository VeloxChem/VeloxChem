#include "NuclearPotentialGeom020RecDS.hpp"
...
auto
compNuclearPotentialGeom020DS(      CSubMatrix* matrix_xx,
        ...
        for (int64_t j = bra_first; j < bra_last; j++) 
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020DS_XX_0(buffer_xx,
                                                                              buffer_xy,
                                                                              buffer_xz,
                                                                              buffer_yy,
                                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020DS_XY_0(buffer_xx,
                                                                              buffer_xy,
                                                                              buffer_xz,
                                                                              buffer_yy,
                                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020DS_XZ_0(buffer_xx,
                                                                              buffer_xy,
                                                                              buffer_xz,
                                                                              buffer_yy,
                                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020DS_YY_0(buffer_xx,
                                                                              buffer_xy,
                                                                              buffer_xz,
                                                                              buffer_yy,
                                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020DS_YZ_0(buffer_xx,
                                                                              buffer_xy,
                                                                              buffer_xz,
                                                                              buffer_yy,
                                                                              buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020DS_ZZ_0(buffer_xx,
                                                                              buffer_xy,
                                                                              buffer_xz,
                                                                              buffer_yy,
                                                                              buffer_yz,
