#include "NuclearPotentialGeom020RecPG.hpp"
...
auto
compNuclearPotentialGeom020PG(      CSubMatrix* matrix_xx,
        ...
        for (int64_t j = bra_first; j < bra_last; j++) 
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_X_XXXX(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_X_XXXY(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_X_XXXZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_X_XXYY(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_X_XXYZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_X_XXZZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_X_XYYY(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_X_XYYZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_X_XYZZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_X_XZZZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_X_YYYY(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_X_YYYZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_X_YYZZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_X_YZZZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_X_ZZZZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Y_XXXX(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Y_XXXY(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Y_XXXZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Y_XXYY(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Y_XXYZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Y_XXZZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Y_XYYY(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Y_XYYZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Y_XYZZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Y_XZZZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Y_YYYY(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Y_YYYZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Y_YYZZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Y_YZZZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Y_ZZZZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Z_XXXX(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Z_XXXY(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Z_XXXZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Z_XXYY(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Z_XXYZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Z_XXZZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Z_XYYY(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Z_XYYZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Z_XYZZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Z_XZZZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Z_YYYY(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Z_YYYZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Z_YYZZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Z_YZZZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PG_Z_ZZZZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
