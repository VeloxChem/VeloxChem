#include "NuclearPotentialGeom020RecSG.hpp"
...
#include "PrimitiveNuclearPotentialGeom020SG_0_XXXY.hpp"
...
#include "PrimitiveNuclearPotentialGeom020SG_0_XXZZ.hpp"
#include "PrimitiveNuclearPotentialGeom020SG_0_XYYY.hpp"
#include "PrimitiveNuclearPotentialGeom020SG_0_XYYZ.hpp"
#include "PrimitiveNuclearPotentialGeom020SG_0_XYZZ.hpp"
#include "PrimitiveNuclearPotentialGeom020SG_0_XZZZ.hpp"
#include "PrimitiveNuclearPotentialGeom020SG_0_YYYY.hpp"
#include "PrimitiveNuclearPotentialGeom020SG_0_YYYZ.hpp"
#include "PrimitiveNuclearPotentialGeom020SG_0_YYZZ.hpp"
#include "PrimitiveNuclearPotentialGeom020SG_0_YZZZ.hpp"
#include "PrimitiveNuclearPotentialGeom020SG_0_ZZZZ.hpp"

namespace geom_npotrec { // geom_npotrec namespace

auto
compNuclearPotentialGeom020SG(      CSubMatrix* matrix_xx,
        ...
        for (int64_t j = bra_first; j < bra_last; j++) 
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020SG_0_XXXX(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020SG_0_XXXY(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020SG_0_XXXZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020SG_0_XXYY(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020SG_0_XXYZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020SG_0_XXZZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020SG_0_XYYY(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020SG_0_XYYZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020SG_0_XYZZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020SG_0_XZZZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020SG_0_YYYY(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020SG_0_YYYZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020SG_0_YYZZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020SG_0_YZZZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020SG_0_ZZZZ(buffer_xx,
                                                                                buffer_xy,
                                                                                buffer_xz,
                                                                                buffer_yy,
                                                                                buffer_yz,
