        ...
        for (int64_t j = bra_first; j < bra_last; j++) 
        {
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PP_X_X(buffer_xx,
                                                                             buffer_xy,
                                                                             buffer_xz,
                                                                             buffer_yy,
                                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PP_X_Y(buffer_xx,
                                                                             buffer_xy,
                                                                             buffer_xz,
                                                                             buffer_yy,
                                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PP_X_Z(buffer_xx,
                                                                             buffer_xy,
                                                                             buffer_xz,
                                                                             buffer_yy,
                                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PP_Y_X(buffer_xx,
                                                                             buffer_xy,
                                                                             buffer_xz,
                                                                             buffer_yy,
                                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PP_Y_Y(buffer_xx,
                                                                             buffer_xy,
                                                                             buffer_xz,
                                                                             buffer_yy,
                                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PP_Y_Z(buffer_xx,
                                                                             buffer_xy,
                                                                             buffer_xz,
                                                                             buffer_yy,
                                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PP_Z_X(buffer_xx,
                                                                             buffer_xy,
                                                                             buffer_xz,
                                                                             buffer_yy,
                                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PP_Z_Y(buffer_xx,
                                                                             buffer_xy,
                                                                             buffer_xz,
                                                                             buffer_yy,
                                                                             buffer_yz,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    geom_npotrec::compPrimitiveNuclearPotentialGeom020PP_Z_Z(buffer_xx,
                                                                             buffer_xy,
                                                                             buffer_xz,
                                                                             buffer_yy,
                                                                             buffer_yz,
