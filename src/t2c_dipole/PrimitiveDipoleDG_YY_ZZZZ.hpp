#ifndef PrimitiveDipoleDG_YY_ZZZZ
#define PrimitiveDipoleDG_YY_ZZZZ
...
/**
 Evaluates block of primitive <D_YY|r|G_ZZZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_YY_ZZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YY_ZZZZ */
