#ifndef PrimitiveDipoleGS_XXYZ_0
#define PrimitiveDipoleGS_XXYZ_0
...
/**
 Evaluates block of primitive <G_XXYZ|r|S_0> integrals.
...
*/
auto compPrimitiveDipoleGS_XXYZ_0(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGS_XXYZ_0 */
