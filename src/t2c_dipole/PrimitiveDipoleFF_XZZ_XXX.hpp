#ifndef PrimitiveDipoleFF_XZZ_XXX
#define PrimitiveDipoleFF_XZZ_XXX
...
/**
 Evaluates block of primitive <F_XZZ|r|F_XXX> integrals.
...
*/
auto compPrimitiveDipoleFF_XZZ_XXX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XZZ_XXX */
