#ifndef PrimitiveDipoleGP_XXYY_Y
#define PrimitiveDipoleGP_XXYY_Y
...
/**
 Evaluates block of primitive <G_XXYY|r|P_Y> integrals.
...
*/
auto compPrimitiveDipoleGP_XXYY_Y(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XXYY_Y */
