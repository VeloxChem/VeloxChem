#ifndef PrimitiveDipoleDG_XZ_XZZZ
#define PrimitiveDipoleDG_XZ_XZZZ
...
/**
 Evaluates block of primitive <D_XZ|r|G_XZZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XZ_XZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XZ_XZZZ */
