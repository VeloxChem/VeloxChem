#ifndef PrimitiveDipoleDG_ZZ_XXXX
#define PrimitiveDipoleDG_ZZ_XXXX
...
/**
 Evaluates block of primitive <D_ZZ|r|G_XXXX> integrals.
...
*/
auto compPrimitiveDipoleDG_ZZ_XXXX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_ZZ_XXXX */
