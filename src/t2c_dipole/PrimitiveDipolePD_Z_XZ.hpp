#ifndef PrimitiveDipolePD_Z_XZ
#define PrimitiveDipolePD_Z_XZ
...
/**
 Evaluates block of primitive <P_Z|r|D_XZ> integrals.
...
*/
auto compPrimitiveDipolePD_Z_XZ(TDoubleArray&       buffer_x,
