#ifndef PrimitiveDipoleFD_XZZ_YZ
#define PrimitiveDipoleFD_XZZ_YZ
...
/**
 Evaluates block of primitive <F_XZZ|r|D_YZ> integrals.
...
*/
auto compPrimitiveDipoleFD_XZZ_YZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_XZZ_YZ */
