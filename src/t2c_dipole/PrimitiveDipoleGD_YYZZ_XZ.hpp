#ifndef PrimitiveDipoleGD_YYZZ_XZ
#define PrimitiveDipoleGD_YYZZ_XZ
...
/**
 Evaluates block of primitive <G_YYZZ|r|D_XZ> integrals.
...
*/
auto compPrimitiveDipoleGD_YYZZ_XZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_YYZZ_XZ */
