#ifndef PrimitiveDipoleGS_XXXX_0
#define PrimitiveDipoleGS_XXXX_0
...
/**
 Evaluates block of primitive <G_XXXX|r|S_0> integrals.
...
*/
auto compPrimitiveDipoleGS_XXXX_0(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGS_XXXX_0 */
