#ifndef DipoleRecDS_hpp
#define DipoleRecDS_hpp
...
/**
 Evaluates <D|r|S>  integrals for given pair of GTOs blocks.
...
*/
auto compDipoleDS(CSubMatrix*      matrix_x,
                  CSubMatrix*      matrix_y,
                  CSubMatrix*      matrix_z,
