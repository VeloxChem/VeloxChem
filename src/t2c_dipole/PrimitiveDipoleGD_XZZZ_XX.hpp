#ifndef PrimitiveDipoleGD_XZZZ_XX
#define PrimitiveDipoleGD_XZZZ_XX
...
/**
 Evaluates block of primitive <G_XZZZ|r|D_XX> integrals.
...
*/
auto compPrimitiveDipoleGD_XZZZ_XX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XZZZ_XX */
