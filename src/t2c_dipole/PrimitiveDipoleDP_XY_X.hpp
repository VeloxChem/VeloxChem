#ifndef PrimitiveDipoleDP_XY_X
#define PrimitiveDipoleDP_XY_X
...
/**
 Evaluates block of primitive <D_XY|r|P_X> integrals.
...
*/
auto compPrimitiveDipoleDP_XY_X(TDoubleArray&       buffer_x,
