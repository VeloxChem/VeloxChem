#ifndef PrimitiveDipoleDG_YY_XXZZ
#define PrimitiveDipoleDG_YY_XXZZ
...
/**
 Evaluates block of primitive <D_YY|r|G_XXZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_YY_XXZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YY_XXZZ */
