#ifndef PrimitiveDipoleGD_XXZZ_YY
#define PrimitiveDipoleGD_XXZZ_YY
...
/**
 Evaluates block of primitive <G_XXZZ|r|D_YY> integrals.
...
*/
auto compPrimitiveDipoleGD_XXZZ_YY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXZZ_YY */
