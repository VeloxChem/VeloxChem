#ifndef PrimitiveDipoleDD_XX_XY
#define PrimitiveDipoleDD_XX_XY
...
/**
 Evaluates block of primitive <D_XX|r|D_XY> integrals.
...
*/
auto compPrimitiveDipoleDD_XX_XY(TDoubleArray&       buffer_x,
