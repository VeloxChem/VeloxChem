#ifndef PrimitiveDipoleGD_XXZZ_XZ
#define PrimitiveDipoleGD_XXZZ_XZ
...
/**
 Evaluates block of primitive <G_XXZZ|r|D_XZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XXZZ_XZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXZZ_XZ */
