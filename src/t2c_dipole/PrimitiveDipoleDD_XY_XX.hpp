#ifndef PrimitiveDipoleDD_XY_XX
#define PrimitiveDipoleDD_XY_XX
...
/**
 Evaluates block of primitive <D_XY|r|D_XX> integrals.
...
*/
auto compPrimitiveDipoleDD_XY_XX(TDoubleArray&       buffer_x,
