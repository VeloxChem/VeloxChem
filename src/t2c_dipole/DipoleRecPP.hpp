#ifndef DipoleRecPP_hpp
#define DipoleRecPP_hpp
...
/**
 Evaluates <P|r|P>  integrals for given GTOs block.
...
*/
auto compDipolePP(CSubMatrix*      matrix_x,
                  CSubMatrix*      matrix_y,
                  CSubMatrix*      matrix_z,
...
/**
 Evaluates <P|r|P>  integrals for given pair of GTOs blocks.
