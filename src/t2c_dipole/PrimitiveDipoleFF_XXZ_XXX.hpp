#ifndef PrimitiveDipoleFF_XXZ_XXX
#define PrimitiveDipoleFF_XXZ_XXX
...
/**
 Evaluates block of primitive <F_XXZ|r|F_XXX> integrals.
...
*/
auto compPrimitiveDipoleFF_XXZ_XXX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XXZ_XXX */
