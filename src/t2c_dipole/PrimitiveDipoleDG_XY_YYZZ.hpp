#ifndef PrimitiveDipoleDG_XY_YYZZ
#define PrimitiveDipoleDG_XY_YYZZ
...
/**
 Evaluates block of primitive <D_XY|r|G_YYZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XY_YYZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XY_YYZZ */
