#ifndef PrimitiveDipoleFP_YZZ_Z
#define PrimitiveDipoleFP_YZZ_Z
...
/**
 Evaluates block of primitive <F_YZZ|r|P_Z> integrals.
...
*/
auto compPrimitiveDipoleFP_YZZ_Z(TDoubleArray&       buffer_x,
