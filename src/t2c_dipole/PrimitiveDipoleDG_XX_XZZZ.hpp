#ifndef PrimitiveDipoleDG_XX_XZZZ
#define PrimitiveDipoleDG_XX_XZZZ
...
/**
 Evaluates block of primitive <D_XX|r|G_XZZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XX_XZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XX_XZZZ */
