#ifndef PrimitiveDipoleDG_YZ_XXXX
#define PrimitiveDipoleDG_YZ_XXXX
...
/**
 Evaluates block of primitive <D_YZ|r|G_XXXX> integrals.
...
*/
auto compPrimitiveDipoleDG_YZ_XXXX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YZ_XXXX */
