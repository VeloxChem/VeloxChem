#ifndef PrimitiveDipoleDG_ZZ_YZZZ
#define PrimitiveDipoleDG_ZZ_YZZZ
...
/**
 Evaluates block of primitive <D_ZZ|r|G_YZZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_ZZ_YZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_ZZ_YZZZ */
