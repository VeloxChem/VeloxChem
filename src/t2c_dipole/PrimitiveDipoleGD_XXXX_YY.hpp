#ifndef PrimitiveDipoleGD_XXXX_YY
#define PrimitiveDipoleGD_XXXX_YY
...
/**
 Evaluates block of primitive <G_XXXX|r|D_YY> integrals.
...
*/
auto compPrimitiveDipoleGD_XXXX_YY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXXX_YY */
