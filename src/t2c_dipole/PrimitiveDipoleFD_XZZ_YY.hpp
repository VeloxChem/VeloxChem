#ifndef PrimitiveDipoleFD_XZZ_YY
#define PrimitiveDipoleFD_XZZ_YY
...
/**
 Evaluates block of primitive <F_XZZ|r|D_YY> integrals.
...
*/
auto compPrimitiveDipoleFD_XZZ_YY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_XZZ_YY */
