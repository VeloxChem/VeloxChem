#ifndef PrimitiveDipoleGD_YYYZ_YY
#define PrimitiveDipoleGD_YYYZ_YY
...
/**
 Evaluates block of primitive <G_YYYZ|r|D_YY> integrals.
...
*/
auto compPrimitiveDipoleGD_YYYZ_YY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_YYYZ_YY */
