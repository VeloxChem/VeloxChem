#ifndef PrimitiveDipoleGD_XYYY_ZZ
#define PrimitiveDipoleGD_XYYY_ZZ
...
/**
 Evaluates block of primitive <G_XYYY|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XYYY_ZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XYYY_ZZ */
