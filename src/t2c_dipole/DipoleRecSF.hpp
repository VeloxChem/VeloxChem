#ifndef DipoleRecSF_hpp
#define DipoleRecSF_hpp
...
/**
 Evaluates <S|r|F>  integrals for given pair of GTOs blocks.
...
*/
auto compDipoleSF(CSubMatrix*      matrix_x,
                  CSubMatrix*      matrix_y,
                  CSubMatrix*      matrix_z,
