#ifndef PrimitiveDipolePD_Y_XY
#define PrimitiveDipolePD_Y_XY
...
/**
 Evaluates block of primitive <P_Y|r|D_XY> integrals.
...
*/
auto compPrimitiveDipolePD_Y_XY(TDoubleArray&       buffer_x,
