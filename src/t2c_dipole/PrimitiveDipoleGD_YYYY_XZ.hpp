#ifndef PrimitiveDipoleGD_YYYY_XZ
#define PrimitiveDipoleGD_YYYY_XZ
...
/**
 Evaluates block of primitive <G_YYYY|r|D_XZ> integrals.
...
*/
auto compPrimitiveDipoleGD_YYYY_XZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_YYYY_XZ */
