#ifndef PrimitiveDipolePG_X_YYYY
#define PrimitiveDipolePG_X_YYYY
...
/**
 Evaluates block of primitive <P_X|r|G_YYYY> integrals.
...
*/
auto compPrimitiveDipolePG_X_YYYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_X_YYYY */
