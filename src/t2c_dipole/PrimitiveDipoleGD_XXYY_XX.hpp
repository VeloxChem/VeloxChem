#ifndef PrimitiveDipoleGD_XXYY_XX
#define PrimitiveDipoleGD_XXYY_XX
...
/**
 Evaluates block of primitive <G_XXYY|r|D_XX> integrals.
...
*/
auto compPrimitiveDipoleGD_XXYY_XX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXYY_XX */
