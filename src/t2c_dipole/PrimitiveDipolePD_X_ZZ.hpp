#ifndef PrimitiveDipolePD_X_ZZ
#define PrimitiveDipolePD_X_ZZ
...
/**
 Evaluates block of primitive <P_X|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipolePD_X_ZZ(TDoubleArray&       buffer_x,
