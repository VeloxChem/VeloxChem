#ifndef PrimitiveDipoleFP_ZZZ_Z
#define PrimitiveDipoleFP_ZZZ_Z
...
/**
 Evaluates block of primitive <F_ZZZ|r|P_Z> integrals.
...
*/
auto compPrimitiveDipoleFP_ZZZ_Z(TDoubleArray&       buffer_x,
