#ifndef PrimitiveDipolePG_X_XXYY
#define PrimitiveDipolePG_X_XXYY
...
/**
 Evaluates block of primitive <P_X|r|G_XXYY> integrals.
...
*/
auto compPrimitiveDipolePG_X_XXYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_X_XXYY */
