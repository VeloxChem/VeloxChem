#ifndef PrimitiveDipoleGP_XXXY_Y
#define PrimitiveDipoleGP_XXXY_Y
...
/**
 Evaluates block of primitive <G_XXXY|r|P_Y> integrals.
...
*/
auto compPrimitiveDipoleGP_XXXY_Y(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XXXY_Y */
