#ifndef PrimitiveDipoleGD_XXXY_XZ
#define PrimitiveDipoleGD_XXXY_XZ
...
/**
 Evaluates block of primitive <G_XXXY|r|D_XZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XXXY_XZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXXY_XZ */
