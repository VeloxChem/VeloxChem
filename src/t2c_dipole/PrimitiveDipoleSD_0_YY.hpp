#ifndef PrimitiveDipoleSD_0_YY
#define PrimitiveDipoleSD_0_YY
...
/**
 Evaluates block of primitive <S_0|r|D_YY> integrals.
...
*/
auto compPrimitiveDipoleSD_0_YY(TDoubleArray&       buffer_x,
