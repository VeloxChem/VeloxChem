#ifndef PrimitiveDipolePG_X_XXXX
#define PrimitiveDipolePG_X_XXXX
...
/**
 Evaluates block of primitive <P_X|r|G_XXXX> integrals.
...
*/
auto compPrimitiveDipolePG_X_XXXX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_X_XXXX */
