#ifndef PrimitiveDipoleDG_YY_XXYY
#define PrimitiveDipoleDG_YY_XXYY
...
/**
 Evaluates block of primitive <D_YY|r|G_XXYY> integrals.
...
*/
auto compPrimitiveDipoleDG_YY_XXYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YY_XXYY */
