#ifndef PrimitiveDipolePG_Y_YZZZ
#define PrimitiveDipolePG_Y_YZZZ
...
/**
 Evaluates block of primitive <P_Y|r|G_YZZZ> integrals.
...
*/
auto compPrimitiveDipolePG_Y_YZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Y_YZZZ */
