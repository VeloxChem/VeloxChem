#ifndef PrimitiveDipoleGP_XYYY_X
#define PrimitiveDipoleGP_XYYY_X
...
/**
 Evaluates block of primitive <G_XYYY|r|P_X> integrals.
...
*/
auto compPrimitiveDipoleGP_XYYY_X(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XYYY_X */
