#ifndef PrimitiveDipoleFD_XXY_YY
#define PrimitiveDipoleFD_XXY_YY
...
/**
 Evaluates block of primitive <F_XXY|r|D_YY> integrals.
...
*/
auto compPrimitiveDipoleFD_XXY_YY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_XXY_YY */
