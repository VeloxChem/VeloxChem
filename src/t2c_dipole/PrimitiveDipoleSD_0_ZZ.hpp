#ifndef PrimitiveDipoleSD_0_ZZ
#define PrimitiveDipoleSD_0_ZZ
...
/**
 Evaluates block of primitive <S_0|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipoleSD_0_ZZ(TDoubleArray&       buffer_x,
