#ifndef PrimitiveDipoleFD_YYZ_ZZ
#define PrimitiveDipoleFD_YYZ_ZZ
...
/**
 Evaluates block of primitive <F_YYZ|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipoleFD_YYZ_ZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_YYZ_ZZ */
