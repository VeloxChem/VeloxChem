#ifndef PrimitiveDipolePG_Z_XYZZ
#define PrimitiveDipolePG_Z_XYZZ
...
/**
 Evaluates block of primitive <P_Z|r|G_XYZZ> integrals.
...
*/
auto compPrimitiveDipolePG_Z_XYZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Z_XYZZ */
