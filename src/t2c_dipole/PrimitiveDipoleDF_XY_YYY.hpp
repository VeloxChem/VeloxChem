#ifndef PrimitiveDipoleDF_XY_YYY
#define PrimitiveDipoleDF_XY_YYY
...
/**
 Evaluates block of primitive <D_XY|r|F_YYY> integrals.
...
*/
auto compPrimitiveDipoleDF_XY_YYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_XY_YYY */
