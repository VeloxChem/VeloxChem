#ifndef PrimitiveDipoleGD_XXXY_YZ
#define PrimitiveDipoleGD_XXXY_YZ
...
/**
 Evaluates block of primitive <G_XXXY|r|D_YZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XXXY_YZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXXY_YZ */
