#ifndef PrimitiveDipoleGD_ZZZZ_ZZ
#define PrimitiveDipoleGD_ZZZZ_ZZ
...
/**
 Evaluates block of primitive <G_ZZZZ|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipoleGD_ZZZZ_ZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_ZZZZ_ZZ */
