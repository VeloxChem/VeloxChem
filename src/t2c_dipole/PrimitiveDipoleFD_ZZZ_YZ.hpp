#ifndef PrimitiveDipoleFD_ZZZ_YZ
#define PrimitiveDipoleFD_ZZZ_YZ
...
/**
 Evaluates block of primitive <F_ZZZ|r|D_YZ> integrals.
...
*/
auto compPrimitiveDipoleFD_ZZZ_YZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_ZZZ_YZ */
