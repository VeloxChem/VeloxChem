#ifndef PrimitiveDipoleDG_XY_XXXX
#define PrimitiveDipoleDG_XY_XXXX
...
/**
 Evaluates block of primitive <D_XY|r|G_XXXX> integrals.
...
*/
auto compPrimitiveDipoleDG_XY_XXXX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XY_XXXX */
