#ifndef PrimitiveDipoleDG_XY_XYZZ
#define PrimitiveDipoleDG_XY_XYZZ
...
/**
 Evaluates block of primitive <D_XY|r|G_XYZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XY_XYZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XY_XYZZ */
