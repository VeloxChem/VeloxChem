#ifndef PrimitiveDipolePG_Z_XYYZ
#define PrimitiveDipolePG_Z_XYYZ
...
/**
 Evaluates block of primitive <P_Z|r|G_XYYZ> integrals.
...
*/
auto compPrimitiveDipolePG_Z_XYYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Z_XYYZ */
