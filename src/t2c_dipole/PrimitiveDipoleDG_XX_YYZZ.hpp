#ifndef PrimitiveDipoleDG_XX_YYZZ
#define PrimitiveDipoleDG_XX_YYZZ
...
/**
 Evaluates block of primitive <D_XX|r|G_YYZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XX_YYZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XX_YYZZ */
