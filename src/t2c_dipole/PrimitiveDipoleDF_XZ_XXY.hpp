#ifndef PrimitiveDipoleDF_XZ_XXY
#define PrimitiveDipoleDF_XZ_XXY
...
/**
 Evaluates block of primitive <D_XZ|r|F_XXY> integrals.
...
*/
auto compPrimitiveDipoleDF_XZ_XXY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_XZ_XXY */
