#ifndef PrimitiveDipoleDP_XZ_Z
#define PrimitiveDipoleDP_XZ_Z
...
/**
 Evaluates block of primitive <D_XZ|r|P_Z> integrals.
...
*/
auto compPrimitiveDipoleDP_XZ_Z(TDoubleArray&       buffer_x,
