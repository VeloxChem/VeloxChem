#ifndef PrimitiveDipolePF_Y_YYY
#define PrimitiveDipolePF_Y_YYY
...
/**
 Evaluates block of primitive <P_Y|r|F_YYY> integrals.
...
*/
auto compPrimitiveDipolePF_Y_YYY(TDoubleArray&       buffer_x,
