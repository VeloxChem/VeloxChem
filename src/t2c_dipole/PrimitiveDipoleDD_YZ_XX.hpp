#ifndef PrimitiveDipoleDD_YZ_XX
#define PrimitiveDipoleDD_YZ_XX
...
/**
 Evaluates block of primitive <D_YZ|r|D_XX> integrals.
...
*/
auto compPrimitiveDipoleDD_YZ_XX(TDoubleArray&       buffer_x,
