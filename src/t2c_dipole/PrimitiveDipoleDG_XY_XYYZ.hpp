#ifndef PrimitiveDipoleDG_XY_XYYZ
#define PrimitiveDipoleDG_XY_XYYZ
...
/**
 Evaluates block of primitive <D_XY|r|G_XYYZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XY_XYYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XY_XYYZ */
