#ifndef PrimitiveDipoleSP_0_Y
#define PrimitiveDipoleSP_0_Y
...
/**
 Evaluates block of primitive <S_0|r|P_Y> integrals.
...
*/
auto compPrimitiveDipoleSP_0_Y(TDoubleArray&       buffer_x,
