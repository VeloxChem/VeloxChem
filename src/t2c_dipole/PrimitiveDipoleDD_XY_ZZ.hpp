#ifndef PrimitiveDipoleDD_XY_ZZ
#define PrimitiveDipoleDD_XY_ZZ
...
/**
 Evaluates block of primitive <D_XY|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipoleDD_XY_ZZ(TDoubleArray&       buffer_x,
