#ifndef PrimitiveDipoleGS_YYYZ_0
#define PrimitiveDipoleGS_YYYZ_0
...
/**
 Evaluates block of primitive <G_YYYZ|r|S_0> integrals.
...
*/
auto compPrimitiveDipoleGS_YYYZ_0(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGS_YYYZ_0 */
