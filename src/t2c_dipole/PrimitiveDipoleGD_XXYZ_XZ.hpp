#ifndef PrimitiveDipoleGD_XXYZ_XZ
#define PrimitiveDipoleGD_XXYZ_XZ
...
/**
 Evaluates block of primitive <G_XXYZ|r|D_XZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XXYZ_XZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXYZ_XZ */
