#ifndef PrimitiveDipolePG_Y_YYZZ
#define PrimitiveDipolePG_Y_YYZZ
...
/**
 Evaluates block of primitive <P_Y|r|G_YYZZ> integrals.
...
*/
auto compPrimitiveDipolePG_Y_YYZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Y_YYZZ */
