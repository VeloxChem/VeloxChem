#ifndef PrimitiveDipoleFF_XXZ_XZZ
#define PrimitiveDipoleFF_XXZ_XZZ
...
/**
 Evaluates block of primitive <F_XXZ|r|F_XZZ> integrals.
...
*/
auto compPrimitiveDipoleFF_XXZ_XZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XXZ_XZZ */
