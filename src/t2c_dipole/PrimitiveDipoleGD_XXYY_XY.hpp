#ifndef PrimitiveDipoleGD_XXYY_XY
#define PrimitiveDipoleGD_XXYY_XY
...
/**
 Evaluates block of primitive <G_XXYY|r|D_XY> integrals.
...
*/
auto compPrimitiveDipoleGD_XXYY_XY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXYY_XY */
