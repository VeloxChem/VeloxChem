#ifndef PrimitiveDipoleGD_XXXX_YZ
#define PrimitiveDipoleGD_XXXX_YZ
...
/**
 Evaluates block of primitive <G_XXXX|r|D_YZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XXXX_YZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXXX_YZ */
