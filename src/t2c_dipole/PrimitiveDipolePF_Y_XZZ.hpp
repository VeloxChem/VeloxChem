#ifndef PrimitiveDipolePF_Y_XZZ
#define PrimitiveDipolePF_Y_XZZ
...
/**
 Evaluates block of primitive <P_Y|r|F_XZZ> integrals.
...
*/
auto compPrimitiveDipolePF_Y_XZZ(TDoubleArray&       buffer_x,
