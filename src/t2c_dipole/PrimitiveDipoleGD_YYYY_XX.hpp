#ifndef PrimitiveDipoleGD_YYYY_XX
#define PrimitiveDipoleGD_YYYY_XX
...
/**
 Evaluates block of primitive <G_YYYY|r|D_XX> integrals.
...
*/
auto compPrimitiveDipoleGD_YYYY_XX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_YYYY_XX */
