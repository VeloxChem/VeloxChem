#ifndef PrimitiveDipoleGP_YYYZ_X
#define PrimitiveDipoleGP_YYYZ_X
...
/**
 Evaluates block of primitive <G_YYYZ|r|P_X> integrals.
...
*/
auto compPrimitiveDipoleGP_YYYZ_X(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_YYYZ_X */
