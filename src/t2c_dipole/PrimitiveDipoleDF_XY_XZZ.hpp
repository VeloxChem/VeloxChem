#ifndef PrimitiveDipoleDF_XY_XZZ
#define PrimitiveDipoleDF_XY_XZZ
...
/**
 Evaluates block of primitive <D_XY|r|F_XZZ> integrals.
...
*/
auto compPrimitiveDipoleDF_XY_XZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_XY_XZZ */
