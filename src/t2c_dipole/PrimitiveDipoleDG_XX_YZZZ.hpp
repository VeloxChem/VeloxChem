#ifndef PrimitiveDipoleDG_XX_YZZZ
#define PrimitiveDipoleDG_XX_YZZZ
...
/**
 Evaluates block of primitive <D_XX|r|G_YZZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XX_YZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XX_YZZZ */
