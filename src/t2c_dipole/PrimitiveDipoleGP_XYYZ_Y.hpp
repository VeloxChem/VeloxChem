#ifndef PrimitiveDipoleGP_XYYZ_Y
#define PrimitiveDipoleGP_XYYZ_Y
...
/**
 Evaluates block of primitive <G_XYYZ|r|P_Y> integrals.
...
*/
auto compPrimitiveDipoleGP_XYYZ_Y(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XYYZ_Y */
