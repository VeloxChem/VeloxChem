#ifndef PrimitiveDipoleFF_XXX_YZZ
#define PrimitiveDipoleFF_XXX_YZZ
...
/**
 Evaluates block of primitive <F_XXX|r|F_YZZ> integrals.
...
*/
auto compPrimitiveDipoleFF_XXX_YZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XXX_YZZ */
