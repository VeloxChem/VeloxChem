#ifndef PrimitiveDipoleDD_XZ_XY
#define PrimitiveDipoleDD_XZ_XY
...
/**
 Evaluates block of primitive <D_XZ|r|D_XY> integrals.
...
*/
auto compPrimitiveDipoleDD_XZ_XY(TDoubleArray&       buffer_x,
