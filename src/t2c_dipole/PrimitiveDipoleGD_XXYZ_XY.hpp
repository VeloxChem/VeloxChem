#ifndef PrimitiveDipoleGD_XXYZ_XY
#define PrimitiveDipoleGD_XXYZ_XY
...
/**
 Evaluates block of primitive <G_XXYZ|r|D_XY> integrals.
...
*/
auto compPrimitiveDipoleGD_XXYZ_XY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXYZ_XY */
