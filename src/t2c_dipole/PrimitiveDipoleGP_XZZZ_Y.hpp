#ifndef PrimitiveDipoleGP_XZZZ_Y
#define PrimitiveDipoleGP_XZZZ_Y
...
/**
 Evaluates block of primitive <G_XZZZ|r|P_Y> integrals.
...
*/
auto compPrimitiveDipoleGP_XZZZ_Y(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XZZZ_Y */
