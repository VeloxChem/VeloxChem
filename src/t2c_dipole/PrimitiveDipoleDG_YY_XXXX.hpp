#ifndef PrimitiveDipoleDG_YY_XXXX
#define PrimitiveDipoleDG_YY_XXXX
...
/**
 Evaluates block of primitive <D_YY|r|G_XXXX> integrals.
...
*/
auto compPrimitiveDipoleDG_YY_XXXX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YY_XXXX */
