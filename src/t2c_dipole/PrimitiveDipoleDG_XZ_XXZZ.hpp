#ifndef PrimitiveDipoleDG_XZ_XXZZ
#define PrimitiveDipoleDG_XZ_XXZZ
...
/**
 Evaluates block of primitive <D_XZ|r|G_XXZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XZ_XXZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XZ_XXZZ */
