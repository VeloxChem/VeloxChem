#ifndef PrimitiveDipoleGP_XXXZ_Z
#define PrimitiveDipoleGP_XXXZ_Z
...
/**
 Evaluates block of primitive <G_XXXZ|r|P_Z> integrals.
...
*/
auto compPrimitiveDipoleGP_XXXZ_Z(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XXXZ_Z */
