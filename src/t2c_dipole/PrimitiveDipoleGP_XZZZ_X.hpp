#ifndef PrimitiveDipoleGP_XZZZ_X
#define PrimitiveDipoleGP_XZZZ_X
...
/**
 Evaluates block of primitive <G_XZZZ|r|P_X> integrals.
...
*/
auto compPrimitiveDipoleGP_XZZZ_X(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XZZZ_X */
