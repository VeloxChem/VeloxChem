#ifndef PrimitiveDipoleFF_XXX_XYY
#define PrimitiveDipoleFF_XXX_XYY
...
/**
 Evaluates block of primitive <F_XXX|r|F_XYY> integrals.
...
*/
auto compPrimitiveDipoleFF_XXX_XYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XXX_XYY */
