#ifndef PrimitiveDipoleGP_XYYZ_Z
#define PrimitiveDipoleGP_XYYZ_Z
...
/**
 Evaluates block of primitive <G_XYYZ|r|P_Z> integrals.
...
*/
auto compPrimitiveDipoleGP_XYYZ_Z(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XYYZ_Z */
