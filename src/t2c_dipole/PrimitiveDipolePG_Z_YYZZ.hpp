#ifndef PrimitiveDipolePG_Z_YYZZ
#define PrimitiveDipolePG_Z_YYZZ
...
/**
 Evaluates block of primitive <P_Z|r|G_YYZZ> integrals.
...
*/
auto compPrimitiveDipolePG_Z_YYZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Z_YYZZ */
