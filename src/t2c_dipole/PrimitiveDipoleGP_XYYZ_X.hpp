#ifndef PrimitiveDipoleGP_XYYZ_X
#define PrimitiveDipoleGP_XYYZ_X
...
/**
 Evaluates block of primitive <G_XYYZ|r|P_X> integrals.
...
*/
auto compPrimitiveDipoleGP_XYYZ_X(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XYYZ_X */
