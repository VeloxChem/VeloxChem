#ifndef PrimitiveDipolePD_Z_XY
#define PrimitiveDipolePD_Z_XY
...
/**
 Evaluates block of primitive <P_Z|r|D_XY> integrals.
...
*/
auto compPrimitiveDipolePD_Z_XY(TDoubleArray&       buffer_x,
