#ifndef PrimitiveDipolePF_Y_XYZ
#define PrimitiveDipolePF_Y_XYZ
...
/**
 Evaluates block of primitive <P_Y|r|F_XYZ> integrals.
...
*/
auto compPrimitiveDipolePF_Y_XYZ(TDoubleArray&       buffer_x,
