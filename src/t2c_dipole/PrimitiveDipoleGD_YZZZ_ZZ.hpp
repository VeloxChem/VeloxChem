#ifndef PrimitiveDipoleGD_YZZZ_ZZ
#define PrimitiveDipoleGD_YZZZ_ZZ
...
/**
 Evaluates block of primitive <G_YZZZ|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipoleGD_YZZZ_ZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_YZZZ_ZZ */
