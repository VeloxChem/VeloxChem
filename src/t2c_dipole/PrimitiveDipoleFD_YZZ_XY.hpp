#ifndef PrimitiveDipoleFD_YZZ_XY
#define PrimitiveDipoleFD_YZZ_XY
...
/**
 Evaluates block of primitive <F_YZZ|r|D_XY> integrals.
...
*/
auto compPrimitiveDipoleFD_YZZ_XY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_YZZ_XY */
