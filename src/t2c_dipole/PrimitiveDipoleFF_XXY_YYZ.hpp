#ifndef PrimitiveDipoleFF_XXY_YYZ
#define PrimitiveDipoleFF_XXY_YYZ
...
/**
 Evaluates block of primitive <F_XXY|r|F_YYZ> integrals.
...
*/
auto compPrimitiveDipoleFF_XXY_YYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XXY_YYZ */
