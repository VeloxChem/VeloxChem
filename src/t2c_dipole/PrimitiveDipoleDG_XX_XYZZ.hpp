#ifndef PrimitiveDipoleDG_XX_XYZZ
#define PrimitiveDipoleDG_XX_XYZZ
...
/**
 Evaluates block of primitive <D_XX|r|G_XYZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XX_XYZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XX_XYZZ */
