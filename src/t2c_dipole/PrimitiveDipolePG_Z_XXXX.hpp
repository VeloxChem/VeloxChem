#ifndef PrimitiveDipolePG_Z_XXXX
#define PrimitiveDipolePG_Z_XXXX
...
/**
 Evaluates block of primitive <P_Z|r|G_XXXX> integrals.
...
*/
auto compPrimitiveDipolePG_Z_XXXX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Z_XXXX */
