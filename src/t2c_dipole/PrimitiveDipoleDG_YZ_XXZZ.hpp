#ifndef PrimitiveDipoleDG_YZ_XXZZ
#define PrimitiveDipoleDG_YZ_XXZZ
...
/**
 Evaluates block of primitive <D_YZ|r|G_XXZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_YZ_XXZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YZ_XXZZ */
