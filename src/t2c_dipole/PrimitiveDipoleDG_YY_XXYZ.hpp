#ifndef PrimitiveDipoleDG_YY_XXYZ
#define PrimitiveDipoleDG_YY_XXYZ
...
/**
 Evaluates block of primitive <D_YY|r|G_XXYZ> integrals.
...
*/
auto compPrimitiveDipoleDG_YY_XXYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YY_XXYZ */
