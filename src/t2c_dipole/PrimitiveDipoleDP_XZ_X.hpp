#ifndef PrimitiveDipoleDP_XZ_X
#define PrimitiveDipoleDP_XZ_X
...
/**
 Evaluates block of primitive <D_XZ|r|P_X> integrals.
...
*/
auto compPrimitiveDipoleDP_XZ_X(TDoubleArray&       buffer_x,
