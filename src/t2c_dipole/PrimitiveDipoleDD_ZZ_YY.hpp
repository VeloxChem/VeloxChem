#ifndef PrimitiveDipoleDD_ZZ_YY
#define PrimitiveDipoleDD_ZZ_YY
...
/**
 Evaluates block of primitive <D_ZZ|r|D_YY> integrals.
...
*/
auto compPrimitiveDipoleDD_ZZ_YY(TDoubleArray&       buffer_x,
