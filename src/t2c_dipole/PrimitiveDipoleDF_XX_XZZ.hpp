#ifndef PrimitiveDipoleDF_XX_XZZ
#define PrimitiveDipoleDF_XX_XZZ
...
/**
 Evaluates block of primitive <D_XX|r|F_XZZ> integrals.
...
*/
auto compPrimitiveDipoleDF_XX_XZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_XX_XZZ */
