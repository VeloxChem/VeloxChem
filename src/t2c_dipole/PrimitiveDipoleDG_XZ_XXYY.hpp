#ifndef PrimitiveDipoleDG_XZ_XXYY
#define PrimitiveDipoleDG_XZ_XXYY
...
/**
 Evaluates block of primitive <D_XZ|r|G_XXYY> integrals.
...
*/
auto compPrimitiveDipoleDG_XZ_XXYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XZ_XXYY */
