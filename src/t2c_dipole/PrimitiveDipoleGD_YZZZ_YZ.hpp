#ifndef PrimitiveDipoleGD_YZZZ_YZ
#define PrimitiveDipoleGD_YZZZ_YZ
...
/**
 Evaluates block of primitive <G_YZZZ|r|D_YZ> integrals.
...
*/
auto compPrimitiveDipoleGD_YZZZ_YZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_YZZZ_YZ */
