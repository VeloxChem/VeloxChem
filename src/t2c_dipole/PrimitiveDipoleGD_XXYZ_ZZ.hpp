#ifndef PrimitiveDipoleGD_XXYZ_ZZ
#define PrimitiveDipoleGD_XXYZ_ZZ
...
/**
 Evaluates block of primitive <G_XXYZ|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XXYZ_ZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXYZ_ZZ */
