#ifndef PrimitiveDipolePG_Z_ZZZZ
#define PrimitiveDipolePG_Z_ZZZZ
...
/**
 Evaluates block of primitive <P_Z|r|G_ZZZZ> integrals.
...
*/
auto compPrimitiveDipolePG_Z_ZZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Z_ZZZZ */
