#ifndef DipoleRecPF_hpp
#define DipoleRecPF_hpp
...
/**
 Evaluates <P|r|F>  integrals for given pair of GTOs blocks.
...
*/
auto compDipolePF(CSubMatrix*      matrix_x,
                  CSubMatrix*      matrix_y,
                  CSubMatrix*      matrix_z,
