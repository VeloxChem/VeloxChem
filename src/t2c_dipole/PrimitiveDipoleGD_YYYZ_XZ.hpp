#ifndef PrimitiveDipoleGD_YYYZ_XZ
#define PrimitiveDipoleGD_YYYZ_XZ
...
/**
 Evaluates block of primitive <G_YYYZ|r|D_XZ> integrals.
...
*/
auto compPrimitiveDipoleGD_YYYZ_XZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_YYYZ_XZ */
