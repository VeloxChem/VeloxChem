#ifndef PrimitiveDipoleGP_XXYZ_Z
#define PrimitiveDipoleGP_XXYZ_Z
...
/**
 Evaluates block of primitive <G_XXYZ|r|P_Z> integrals.
...
*/
auto compPrimitiveDipoleGP_XXYZ_Z(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XXYZ_Z */
