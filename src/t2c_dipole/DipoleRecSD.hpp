#ifndef DipoleRecSD_hpp
#define DipoleRecSD_hpp
...
/**
 Evaluates <S|r|D>  integrals for given pair of GTOs blocks.
...
*/
auto compDipoleSD(CSubMatrix*      matrix_x,
                  CSubMatrix*      matrix_y,
                  CSubMatrix*      matrix_z,
