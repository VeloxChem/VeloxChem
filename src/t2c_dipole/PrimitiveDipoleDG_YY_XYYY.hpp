#ifndef PrimitiveDipoleDG_YY_XYYY
#define PrimitiveDipoleDG_YY_XYYY
...
/**
 Evaluates block of primitive <D_YY|r|G_XYYY> integrals.
...
*/
auto compPrimitiveDipoleDG_YY_XYYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YY_XYYY */
