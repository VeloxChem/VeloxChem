#ifndef PrimitiveDipoleDG_ZZ_XXYY
#define PrimitiveDipoleDG_ZZ_XXYY
...
/**
 Evaluates block of primitive <D_ZZ|r|G_XXYY> integrals.
...
*/
auto compPrimitiveDipoleDG_ZZ_XXYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_ZZ_XXYY */
