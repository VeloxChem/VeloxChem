#ifndef PrimitiveDipoleGS_XXYY_0
#define PrimitiveDipoleGS_XXYY_0
...
/**
 Evaluates block of primitive <G_XXYY|r|S_0> integrals.
...
*/
auto compPrimitiveDipoleGS_XXYY_0(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGS_XXYY_0 */
