#ifndef PrimitiveDipoleDG_YZ_XZZZ
#define PrimitiveDipoleDG_YZ_XZZZ
...
/**
 Evaluates block of primitive <D_YZ|r|G_XZZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_YZ_XZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YZ_XZZZ */
