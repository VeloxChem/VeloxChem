#ifndef PrimitiveDipoleFF_XXZ_XYZ
#define PrimitiveDipoleFF_XXZ_XYZ
...
/**
 Evaluates block of primitive <F_XXZ|r|F_XYZ> integrals.
...
*/
auto compPrimitiveDipoleFF_XXZ_XYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XXZ_XYZ */
