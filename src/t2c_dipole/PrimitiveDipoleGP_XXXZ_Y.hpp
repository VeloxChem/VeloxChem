#ifndef PrimitiveDipoleGP_XXXZ_Y
#define PrimitiveDipoleGP_XXXZ_Y
...
/**
 Evaluates block of primitive <G_XXXZ|r|P_Y> integrals.
...
*/
auto compPrimitiveDipoleGP_XXXZ_Y(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XXXZ_Y */
