#ifndef PrimitiveDipoleGD_YZZZ_XX
#define PrimitiveDipoleGD_YZZZ_XX
...
/**
 Evaluates block of primitive <G_YZZZ|r|D_XX> integrals.
...
*/
auto compPrimitiveDipoleGD_YZZZ_XX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_YZZZ_XX */
