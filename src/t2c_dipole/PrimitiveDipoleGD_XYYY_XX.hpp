#ifndef PrimitiveDipoleGD_XYYY_XX
#define PrimitiveDipoleGD_XYYY_XX
...
/**
 Evaluates block of primitive <G_XYYY|r|D_XX> integrals.
...
*/
auto compPrimitiveDipoleGD_XYYY_XX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XYYY_XX */
