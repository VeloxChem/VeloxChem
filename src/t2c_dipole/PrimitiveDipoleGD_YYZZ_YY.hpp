#ifndef PrimitiveDipoleGD_YYZZ_YY
#define PrimitiveDipoleGD_YYZZ_YY
...
/**
 Evaluates block of primitive <G_YYZZ|r|D_YY> integrals.
...
*/
auto compPrimitiveDipoleGD_YYZZ_YY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_YYZZ_YY */
