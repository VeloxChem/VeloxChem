#ifndef PrimitiveDipoleGP_YZZZ_Y
#define PrimitiveDipoleGP_YZZZ_Y
...
/**
 Evaluates block of primitive <G_YZZZ|r|P_Y> integrals.
...
*/
auto compPrimitiveDipoleGP_YZZZ_Y(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_YZZZ_Y */
