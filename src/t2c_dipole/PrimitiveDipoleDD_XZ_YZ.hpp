#ifndef PrimitiveDipoleDD_XZ_YZ
#define PrimitiveDipoleDD_XZ_YZ
...
/**
 Evaluates block of primitive <D_XZ|r|D_YZ> integrals.
...
*/
auto compPrimitiveDipoleDD_XZ_YZ(TDoubleArray&       buffer_x,
