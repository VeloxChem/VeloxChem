#ifndef PrimitiveDipoleGP_YYYY_Z
#define PrimitiveDipoleGP_YYYY_Z
...
/**
 Evaluates block of primitive <G_YYYY|r|P_Z> integrals.
...
*/
auto compPrimitiveDipoleGP_YYYY_Z(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_YYYY_Z */
