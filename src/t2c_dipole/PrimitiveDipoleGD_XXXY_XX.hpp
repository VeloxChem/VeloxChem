#ifndef PrimitiveDipoleGD_XXXY_XX
#define PrimitiveDipoleGD_XXXY_XX
...
/**
 Evaluates block of primitive <G_XXXY|r|D_XX> integrals.
...
*/
auto compPrimitiveDipoleGD_XXXY_XX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXXY_XX */
