#ifndef PrimitiveDipoleDG_XZ_XYYZ
#define PrimitiveDipoleDG_XZ_XYYZ
...
/**
 Evaluates block of primitive <D_XZ|r|G_XYYZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XZ_XYYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XZ_XYYZ */
