#ifndef PrimitiveDipoleGD_YZZZ_XY
#define PrimitiveDipoleGD_YZZZ_XY
...
/**
 Evaluates block of primitive <G_YZZZ|r|D_XY> integrals.
...
*/
auto compPrimitiveDipoleGD_YZZZ_XY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_YZZZ_XY */
