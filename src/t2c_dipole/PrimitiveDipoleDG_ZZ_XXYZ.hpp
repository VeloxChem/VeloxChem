#ifndef PrimitiveDipoleDG_ZZ_XXYZ
#define PrimitiveDipoleDG_ZZ_XXYZ
...
/**
 Evaluates block of primitive <D_ZZ|r|G_XXYZ> integrals.
...
*/
auto compPrimitiveDipoleDG_ZZ_XXYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_ZZ_XXYZ */
