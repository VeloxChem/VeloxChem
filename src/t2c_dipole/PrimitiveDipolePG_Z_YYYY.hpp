#ifndef PrimitiveDipolePG_Z_YYYY
#define PrimitiveDipolePG_Z_YYYY
...
/**
 Evaluates block of primitive <P_Z|r|G_YYYY> integrals.
...
*/
auto compPrimitiveDipolePG_Z_YYYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Z_YYYY */
