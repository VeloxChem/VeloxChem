#ifndef PrimitiveDipoleDP_ZZ_X
#define PrimitiveDipoleDP_ZZ_X
...
/**
 Evaluates block of primitive <D_ZZ|r|P_X> integrals.
...
*/
auto compPrimitiveDipoleDP_ZZ_X(TDoubleArray&       buffer_x,
