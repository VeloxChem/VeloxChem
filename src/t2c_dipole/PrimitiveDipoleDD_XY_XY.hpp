#ifndef PrimitiveDipoleDD_XY_XY
#define PrimitiveDipoleDD_XY_XY
...
/**
 Evaluates block of primitive <D_XY|r|D_XY> integrals.
...
*/
auto compPrimitiveDipoleDD_XY_XY(TDoubleArray&       buffer_x,
