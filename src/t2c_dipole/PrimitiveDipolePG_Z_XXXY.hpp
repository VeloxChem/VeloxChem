#ifndef PrimitiveDipolePG_Z_XXXY
#define PrimitiveDipolePG_Z_XXXY
...
/**
 Evaluates block of primitive <P_Z|r|G_XXXY> integrals.
...
*/
auto compPrimitiveDipolePG_Z_XXXY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Z_XXXY */
