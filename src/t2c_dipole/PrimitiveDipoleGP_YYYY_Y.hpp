#ifndef PrimitiveDipoleGP_YYYY_Y
#define PrimitiveDipoleGP_YYYY_Y
...
/**
 Evaluates block of primitive <G_YYYY|r|P_Y> integrals.
...
*/
auto compPrimitiveDipoleGP_YYYY_Y(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_YYYY_Y */
