#ifndef PrimitiveDipoleDF_YY_XYZ
#define PrimitiveDipoleDF_YY_XYZ
...
/**
 Evaluates block of primitive <D_YY|r|F_XYZ> integrals.
...
*/
auto compPrimitiveDipoleDF_YY_XYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_YY_XYZ */
