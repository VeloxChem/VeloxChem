#ifndef PrimitiveDipoleFD_XYZ_XZ
#define PrimitiveDipoleFD_XYZ_XZ
...
/**
 Evaluates block of primitive <F_XYZ|r|D_XZ> integrals.
...
*/
auto compPrimitiveDipoleFD_XYZ_XZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_XYZ_XZ */
