#ifndef DipoleRecFG_hpp
#define DipoleRecFG_hpp
...
/**
 Evaluates <F|r|G>  integrals for given pair of GTOs blocks.
...
*/
auto compDipoleFG(CSubMatrix*      matrix_x,
                  CSubMatrix*      matrix_y,
                  CSubMatrix*      matrix_z,
