#ifndef PrimitiveDipoleGD_XXXY_YY
#define PrimitiveDipoleGD_XXXY_YY
...
/**
 Evaluates block of primitive <G_XXXY|r|D_YY> integrals.
...
*/
auto compPrimitiveDipoleGD_XXXY_YY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXXY_YY */
