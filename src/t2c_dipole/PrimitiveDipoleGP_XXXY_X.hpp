#ifndef PrimitiveDipoleGP_XXXY_X
#define PrimitiveDipoleGP_XXXY_X
...
/**
 Evaluates block of primitive <G_XXXY|r|P_X> integrals.
...
*/
auto compPrimitiveDipoleGP_XXXY_X(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XXXY_X */
