#ifndef PrimitiveDipoleDG_YY_XXXZ
#define PrimitiveDipoleDG_YY_XXXZ
...
/**
 Evaluates block of primitive <D_YY|r|G_XXXZ> integrals.
...
*/
auto compPrimitiveDipoleDG_YY_XXXZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YY_XXXZ */
