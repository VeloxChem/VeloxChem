#ifndef PrimitiveDipoleFF_YYY_XYY
#define PrimitiveDipoleFF_YYY_XYY
...
/**
 Evaluates block of primitive <F_YYY|r|F_XYY> integrals.
...
*/
auto compPrimitiveDipoleFF_YYY_XYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_YYY_XYY */
