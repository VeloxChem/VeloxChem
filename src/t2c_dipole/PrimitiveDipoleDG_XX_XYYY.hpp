#ifndef PrimitiveDipoleDG_XX_XYYY
#define PrimitiveDipoleDG_XX_XYYY
...
/**
 Evaluates block of primitive <D_XX|r|G_XYYY> integrals.
...
*/
auto compPrimitiveDipoleDG_XX_XYYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XX_XYYY */
