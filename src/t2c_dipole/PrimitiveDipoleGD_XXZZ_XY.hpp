#ifndef PrimitiveDipoleGD_XXZZ_XY
#define PrimitiveDipoleGD_XXZZ_XY
...
/**
 Evaluates block of primitive <G_XXZZ|r|D_XY> integrals.
...
*/
auto compPrimitiveDipoleGD_XXZZ_XY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXZZ_XY */
