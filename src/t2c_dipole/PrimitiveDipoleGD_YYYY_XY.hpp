#ifndef PrimitiveDipoleGD_YYYY_XY
#define PrimitiveDipoleGD_YYYY_XY
...
/**
 Evaluates block of primitive <G_YYYY|r|D_XY> integrals.
...
*/
auto compPrimitiveDipoleGD_YYYY_XY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_YYYY_XY */
