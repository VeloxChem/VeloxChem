#ifndef PrimitiveDipoleDF_XY_ZZZ
#define PrimitiveDipoleDF_XY_ZZZ
...
/**
 Evaluates block of primitive <D_XY|r|F_ZZZ> integrals.
...
*/
auto compPrimitiveDipoleDF_XY_ZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_XY_ZZZ */
