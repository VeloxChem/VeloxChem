#ifndef PrimitiveDipoleGD_XZZZ_YZ
#define PrimitiveDipoleGD_XZZZ_YZ
...
/**
 Evaluates block of primitive <G_XZZZ|r|D_YZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XZZZ_YZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XZZZ_YZ */
