#ifndef PrimitiveDipoleDG_YY_XYZZ
#define PrimitiveDipoleDG_YY_XYZZ
...
/**
 Evaluates block of primitive <D_YY|r|G_XYZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_YY_XYZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YY_XYZZ */
