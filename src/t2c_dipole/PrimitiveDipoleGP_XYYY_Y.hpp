#ifndef PrimitiveDipoleGP_XYYY_Y
#define PrimitiveDipoleGP_XYYY_Y
...
/**
 Evaluates block of primitive <G_XYYY|r|P_Y> integrals.
...
*/
auto compPrimitiveDipoleGP_XYYY_Y(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XYYY_Y */
