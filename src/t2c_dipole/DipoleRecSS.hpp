#ifndef DipoleRecSS_hpp
#define DipoleRecSS_hpp
...
/**
 Evaluates <S|r|S>  integrals for given GTOs block.
...
*/
auto compDipoleSS(CSubMatrix*      matrix_x,
                  CSubMatrix*      matrix_y,
                  CSubMatrix*      matrix_z,
...
/**
 Evaluates <S|r|S>  integrals for given pair of GTOs blocks.
