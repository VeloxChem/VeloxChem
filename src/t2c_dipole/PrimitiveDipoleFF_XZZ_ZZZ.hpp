#ifndef PrimitiveDipoleFF_XZZ_ZZZ
#define PrimitiveDipoleFF_XZZ_ZZZ
...
/**
 Evaluates block of primitive <F_XZZ|r|F_ZZZ> integrals.
...
*/
auto compPrimitiveDipoleFF_XZZ_ZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XZZ_ZZZ */
