#ifndef PrimitiveDipolePF_Y_ZZZ
#define PrimitiveDipolePF_Y_ZZZ
...
/**
 Evaluates block of primitive <P_Y|r|F_ZZZ> integrals.
...
*/
auto compPrimitiveDipolePF_Y_ZZZ(TDoubleArray&       buffer_x,
