#ifndef PrimitiveDipoleGD_XYYZ_YY
#define PrimitiveDipoleGD_XYYZ_YY
...
/**
 Evaluates block of primitive <G_XYYZ|r|D_YY> integrals.
...
*/
auto compPrimitiveDipoleGD_XYYZ_YY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XYYZ_YY */
