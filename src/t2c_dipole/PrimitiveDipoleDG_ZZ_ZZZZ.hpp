#ifndef PrimitiveDipoleDG_ZZ_ZZZZ
#define PrimitiveDipoleDG_ZZ_ZZZZ
...
/**
 Evaluates block of primitive <D_ZZ|r|G_ZZZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_ZZ_ZZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_ZZ_ZZZZ */
