#ifndef PrimitiveDipoleFP_XYY_Y
#define PrimitiveDipoleFP_XYY_Y
...
/**
 Evaluates block of primitive <F_XYY|r|P_Y> integrals.
...
*/
auto compPrimitiveDipoleFP_XYY_Y(TDoubleArray&       buffer_x,
