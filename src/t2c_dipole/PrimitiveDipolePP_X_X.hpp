#ifndef PrimitiveDipolePP_X_X
#define PrimitiveDipolePP_X_X
...
/**
 Evaluates block of primitive <P_X|r|P_X> integrals.
...
*/
auto compPrimitiveDipolePP_X_X(TDoubleArray&       buffer_x,
