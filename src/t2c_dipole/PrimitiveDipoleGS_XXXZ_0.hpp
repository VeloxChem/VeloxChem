#ifndef PrimitiveDipoleGS_XXXZ_0
#define PrimitiveDipoleGS_XXXZ_0
...
/**
 Evaluates block of primitive <G_XXXZ|r|S_0> integrals.
...
*/
auto compPrimitiveDipoleGS_XXXZ_0(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGS_XXXZ_0 */
