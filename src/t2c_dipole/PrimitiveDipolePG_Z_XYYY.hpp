#ifndef PrimitiveDipolePG_Z_XYYY
#define PrimitiveDipolePG_Z_XYYY
...
/**
 Evaluates block of primitive <P_Z|r|G_XYYY> integrals.
...
*/
auto compPrimitiveDipolePG_Z_XYYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Z_XYYY */
