#ifndef PrimitiveDipoleGD_XYYY_XZ
#define PrimitiveDipoleGD_XYYY_XZ
...
/**
 Evaluates block of primitive <G_XYYY|r|D_XZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XYYY_XZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XYYY_XZ */
