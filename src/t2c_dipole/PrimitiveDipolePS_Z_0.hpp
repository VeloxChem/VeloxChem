#ifndef PrimitiveDipolePS_Z_0
#define PrimitiveDipolePS_Z_0
...
/**
 Evaluates block of primitive <P_Z|r|S_0> integrals.
...
*/
auto compPrimitiveDipolePS_Z_0(TDoubleArray&       buffer_x,
