#ifndef DipoleRecGS_hpp
#define DipoleRecGS_hpp
...
/**
 Evaluates <G|r|S>  integrals for given pair of GTOs blocks.
...
*/
auto compDipoleGS(CSubMatrix*      matrix_x,
                  CSubMatrix*      matrix_y,
                  CSubMatrix*      matrix_z,
