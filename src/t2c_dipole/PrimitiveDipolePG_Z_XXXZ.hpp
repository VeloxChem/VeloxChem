#ifndef PrimitiveDipolePG_Z_XXXZ
#define PrimitiveDipolePG_Z_XXXZ
...
/**
 Evaluates block of primitive <P_Z|r|G_XXXZ> integrals.
...
*/
auto compPrimitiveDipolePG_Z_XXXZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Z_XXXZ */
