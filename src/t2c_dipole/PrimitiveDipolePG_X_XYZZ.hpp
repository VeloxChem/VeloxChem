#ifndef PrimitiveDipolePG_X_XYZZ
#define PrimitiveDipolePG_X_XYZZ
...
/**
 Evaluates block of primitive <P_X|r|G_XYZZ> integrals.
...
*/
auto compPrimitiveDipolePG_X_XYZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_X_XYZZ */
