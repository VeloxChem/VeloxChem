#ifndef DipoleRecPD_hpp
#define DipoleRecPD_hpp
...
/**
 Evaluates <P|r|D>  integrals for given pair of GTOs blocks.
...
*/
auto compDipolePD(CSubMatrix*      matrix_x,
                  CSubMatrix*      matrix_y,
                  CSubMatrix*      matrix_z,
