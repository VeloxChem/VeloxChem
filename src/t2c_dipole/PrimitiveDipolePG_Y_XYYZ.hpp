#ifndef PrimitiveDipolePG_Y_XYYZ
#define PrimitiveDipolePG_Y_XYYZ
...
/**
 Evaluates block of primitive <P_Y|r|G_XYYZ> integrals.
...
*/
auto compPrimitiveDipolePG_Y_XYYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Y_XYYZ */
