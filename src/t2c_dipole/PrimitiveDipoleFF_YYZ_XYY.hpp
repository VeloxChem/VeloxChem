#ifndef PrimitiveDipoleFF_YYZ_XYY
#define PrimitiveDipoleFF_YYZ_XYY
...
/**
 Evaluates block of primitive <F_YYZ|r|F_XYY> integrals.
...
*/
auto compPrimitiveDipoleFF_YYZ_XYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_YYZ_XYY */
