#ifndef PrimitiveDipoleFD_XZZ_XZ
#define PrimitiveDipoleFD_XZZ_XZ
...
/**
 Evaluates block of primitive <F_XZZ|r|D_XZ> integrals.
...
*/
auto compPrimitiveDipoleFD_XZZ_XZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_XZZ_XZ */
