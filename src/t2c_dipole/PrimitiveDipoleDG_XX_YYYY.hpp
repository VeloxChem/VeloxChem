#ifndef PrimitiveDipoleDG_XX_YYYY
#define PrimitiveDipoleDG_XX_YYYY
...
/**
 Evaluates block of primitive <D_XX|r|G_YYYY> integrals.
...
*/
auto compPrimitiveDipoleDG_XX_YYYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XX_YYYY */
