#ifndef PrimitiveDipoleDG_XY_XXYZ
#define PrimitiveDipoleDG_XY_XXYZ
...
/**
 Evaluates block of primitive <D_XY|r|G_XXYZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XY_XXYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XY_XXYZ */
