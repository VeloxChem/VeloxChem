#ifndef PrimitiveDipoleDF_XZ_XYZ
#define PrimitiveDipoleDF_XZ_XYZ
...
/**
 Evaluates block of primitive <D_XZ|r|F_XYZ> integrals.
...
*/
auto compPrimitiveDipoleDF_XZ_XYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_XZ_XYZ */
