#ifndef PrimitiveDipoleDG_YZ_YZZZ
#define PrimitiveDipoleDG_YZ_YZZZ
...
/**
 Evaluates block of primitive <D_YZ|r|G_YZZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_YZ_YZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YZ_YZZZ */
