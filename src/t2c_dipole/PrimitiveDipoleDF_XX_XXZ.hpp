#ifndef PrimitiveDipoleDF_XX_XXZ
#define PrimitiveDipoleDF_XX_XXZ
...
/**
 Evaluates block of primitive <D_XX|r|F_XXZ> integrals.
...
*/
auto compPrimitiveDipoleDF_XX_XXZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_XX_XXZ */
