#ifndef PrimitiveDipoleDF_YZ_XXX
#define PrimitiveDipoleDF_YZ_XXX
...
/**
 Evaluates block of primitive <D_YZ|r|F_XXX> integrals.
...
*/
auto compPrimitiveDipoleDF_YZ_XXX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_YZ_XXX */
