#ifndef PrimitiveDipoleGD_XYYZ_ZZ
#define PrimitiveDipoleGD_XYYZ_ZZ
...
/**
 Evaluates block of primitive <G_XYYZ|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XYYZ_ZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XYYZ_ZZ */
