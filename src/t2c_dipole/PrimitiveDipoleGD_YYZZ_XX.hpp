#ifndef PrimitiveDipoleGD_YYZZ_XX
#define PrimitiveDipoleGD_YYZZ_XX
...
/**
 Evaluates block of primitive <G_YYZZ|r|D_XX> integrals.
...
*/
auto compPrimitiveDipoleGD_YYZZ_XX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_YYZZ_XX */
