#ifndef PrimitiveDipoleGS_YZZZ_0
#define PrimitiveDipoleGS_YZZZ_0
...
/**
 Evaluates block of primitive <G_YZZZ|r|S_0> integrals.
...
*/
auto compPrimitiveDipoleGS_YZZZ_0(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGS_YZZZ_0 */
