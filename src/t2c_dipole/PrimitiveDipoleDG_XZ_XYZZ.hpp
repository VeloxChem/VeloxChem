#ifndef PrimitiveDipoleDG_XZ_XYZZ
#define PrimitiveDipoleDG_XZ_XYZZ
...
/**
 Evaluates block of primitive <D_XZ|r|G_XYZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XZ_XYZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XZ_XYZZ */
