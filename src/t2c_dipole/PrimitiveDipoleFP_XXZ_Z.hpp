#ifndef PrimitiveDipoleFP_XXZ_Z
#define PrimitiveDipoleFP_XXZ_Z
...
/**
 Evaluates block of primitive <F_XXZ|r|P_Z> integrals.
...
*/
auto compPrimitiveDipoleFP_XXZ_Z(TDoubleArray&       buffer_x,
