#ifndef PrimitiveDipoleDG_ZZ_YYZZ
#define PrimitiveDipoleDG_ZZ_YYZZ
...
/**
 Evaluates block of primitive <D_ZZ|r|G_YYZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_ZZ_YYZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_ZZ_YYZZ */
