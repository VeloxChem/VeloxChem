#ifndef PrimitiveDipoleDG_YZ_XXXZ
#define PrimitiveDipoleDG_YZ_XXXZ
...
/**
 Evaluates block of primitive <D_YZ|r|G_XXXZ> integrals.
...
*/
auto compPrimitiveDipoleDG_YZ_XXXZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YZ_XXXZ */
