#ifndef PrimitiveDipoleDG_XX_XXXY
#define PrimitiveDipoleDG_XX_XXXY
...
/**
 Evaluates block of primitive <D_XX|r|G_XXXY> integrals.
...
*/
auto compPrimitiveDipoleDG_XX_XXXY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XX_XXXY */
