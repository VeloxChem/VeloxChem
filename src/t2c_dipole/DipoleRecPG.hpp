#ifndef DipoleRecPG_hpp
#define DipoleRecPG_hpp
...
/**
 Evaluates <P|r|G>  integrals for given pair of GTOs blocks.
...
*/
auto compDipolePG(CSubMatrix*      matrix_x,
                  CSubMatrix*      matrix_y,
                  CSubMatrix*      matrix_z,
