#ifndef PrimitiveDipolePG_X_YZZZ
#define PrimitiveDipolePG_X_YZZZ
...
/**
 Evaluates block of primitive <P_X|r|G_YZZZ> integrals.
...
*/
auto compPrimitiveDipolePG_X_YZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_X_YZZZ */
