#ifndef PrimitiveDipoleDG_XZ_YYYZ
#define PrimitiveDipoleDG_XZ_YYYZ
...
/**
 Evaluates block of primitive <D_XZ|r|G_YYYZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XZ_YYYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XZ_YYYZ */
