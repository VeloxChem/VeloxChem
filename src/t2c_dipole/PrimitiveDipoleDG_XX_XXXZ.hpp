#ifndef PrimitiveDipoleDG_XX_XXXZ
#define PrimitiveDipoleDG_XX_XXXZ
...
/**
 Evaluates block of primitive <D_XX|r|G_XXXZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XX_XXXZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XX_XXXZ */
