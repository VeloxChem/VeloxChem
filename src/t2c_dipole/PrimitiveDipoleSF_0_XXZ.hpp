#ifndef PrimitiveDipoleSF_0_XXZ
#define PrimitiveDipoleSF_0_XXZ
...
/**
 Evaluates block of primitive <S_0|r|F_XXZ> integrals.
...
*/
auto compPrimitiveDipoleSF_0_XXZ(TDoubleArray&       buffer_x,
