#ifndef PrimitiveDipoleDG_XY_XYYY
#define PrimitiveDipoleDG_XY_XYYY
...
/**
 Evaluates block of primitive <D_XY|r|G_XYYY> integrals.
...
*/
auto compPrimitiveDipoleDG_XY_XYYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XY_XYYY */
