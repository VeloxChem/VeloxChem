#ifndef PrimitiveDipoleGD_YYYY_ZZ
#define PrimitiveDipoleGD_YYYY_ZZ
...
/**
 Evaluates block of primitive <G_YYYY|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipoleGD_YYYY_ZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_YYYY_ZZ */
