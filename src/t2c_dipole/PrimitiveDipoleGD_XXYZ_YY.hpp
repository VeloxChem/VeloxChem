#ifndef PrimitiveDipoleGD_XXYZ_YY
#define PrimitiveDipoleGD_XXYZ_YY
...
/**
 Evaluates block of primitive <G_XXYZ|r|D_YY> integrals.
...
*/
auto compPrimitiveDipoleGD_XXYZ_YY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXYZ_YY */
