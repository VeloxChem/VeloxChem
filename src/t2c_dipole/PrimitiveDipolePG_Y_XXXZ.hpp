#ifndef PrimitiveDipolePG_Y_XXXZ
#define PrimitiveDipolePG_Y_XXXZ
...
/**
 Evaluates block of primitive <P_Y|r|G_XXXZ> integrals.
...
*/
auto compPrimitiveDipolePG_Y_XXXZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Y_XXXZ */
