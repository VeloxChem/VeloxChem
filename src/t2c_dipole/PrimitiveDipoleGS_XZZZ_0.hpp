#ifndef PrimitiveDipoleGS_XZZZ_0
#define PrimitiveDipoleGS_XZZZ_0
...
/**
 Evaluates block of primitive <G_XZZZ|r|S_0> integrals.
...
*/
auto compPrimitiveDipoleGS_XZZZ_0(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGS_XZZZ_0 */
