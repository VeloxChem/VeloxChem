#ifndef PrimitiveDipoleDG_YZ_YYZZ
#define PrimitiveDipoleDG_YZ_YYZZ
...
/**
 Evaluates block of primitive <D_YZ|r|G_YYZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_YZ_YYZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YZ_YYZZ */
