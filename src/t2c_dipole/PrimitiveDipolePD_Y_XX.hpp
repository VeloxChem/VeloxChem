#ifndef PrimitiveDipolePD_Y_XX
#define PrimitiveDipolePD_Y_XX
...
/**
 Evaluates block of primitive <P_Y|r|D_XX> integrals.
...
*/
auto compPrimitiveDipolePD_Y_XX(TDoubleArray&       buffer_x,
