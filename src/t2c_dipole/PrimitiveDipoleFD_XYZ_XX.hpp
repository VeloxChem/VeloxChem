#ifndef PrimitiveDipoleFD_XYZ_XX
#define PrimitiveDipoleFD_XYZ_XX
...
/**
 Evaluates block of primitive <F_XYZ|r|D_XX> integrals.
...
*/
auto compPrimitiveDipoleFD_XYZ_XX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_XYZ_XX */
