#ifndef PrimitiveDipoleGP_YYZZ_Z
#define PrimitiveDipoleGP_YYZZ_Z
...
/**
 Evaluates block of primitive <G_YYZZ|r|P_Z> integrals.
...
*/
auto compPrimitiveDipoleGP_YYZZ_Z(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_YYZZ_Z */
