#ifndef PrimitiveDipoleGD_ZZZZ_YZ
#define PrimitiveDipoleGD_ZZZZ_YZ
...
/**
 Evaluates block of primitive <G_ZZZZ|r|D_YZ> integrals.
...
*/
auto compPrimitiveDipoleGD_ZZZZ_YZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_ZZZZ_YZ */
