#ifndef PrimitiveDipolePG_X_XYYY
#define PrimitiveDipolePG_X_XYYY
...
/**
 Evaluates block of primitive <P_X|r|G_XYYY> integrals.
...
*/
auto compPrimitiveDipolePG_X_XYYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_X_XYYY */
