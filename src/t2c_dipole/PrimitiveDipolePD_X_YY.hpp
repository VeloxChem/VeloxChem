#ifndef PrimitiveDipolePD_X_YY
#define PrimitiveDipolePD_X_YY
...
/**
 Evaluates block of primitive <P_X|r|D_YY> integrals.
...
*/
auto compPrimitiveDipolePD_X_YY(TDoubleArray&       buffer_x,
