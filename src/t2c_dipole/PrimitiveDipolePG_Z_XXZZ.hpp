#ifndef PrimitiveDipolePG_Z_XXZZ
#define PrimitiveDipolePG_Z_XXZZ
...
/**
 Evaluates block of primitive <P_Z|r|G_XXZZ> integrals.
...
*/
auto compPrimitiveDipolePG_Z_XXZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Z_XXZZ */
