#ifndef PrimitiveDipoleGD_YYYY_YZ
#define PrimitiveDipoleGD_YYYY_YZ
...
/**
 Evaluates block of primitive <G_YYYY|r|D_YZ> integrals.
...
*/
auto compPrimitiveDipoleGD_YYYY_YZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_YYYY_YZ */
