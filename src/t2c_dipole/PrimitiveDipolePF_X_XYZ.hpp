#ifndef PrimitiveDipolePF_X_XYZ
#define PrimitiveDipolePF_X_XYZ
...
/**
 Evaluates block of primitive <P_X|r|F_XYZ> integrals.
...
*/
auto compPrimitiveDipolePF_X_XYZ(TDoubleArray&       buffer_x,
