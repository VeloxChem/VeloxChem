#ifndef PrimitiveDipoleFD_YZZ_YY
#define PrimitiveDipoleFD_YZZ_YY
...
/**
 Evaluates block of primitive <F_YZZ|r|D_YY> integrals.
...
*/
auto compPrimitiveDipoleFD_YZZ_YY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_YZZ_YY */
