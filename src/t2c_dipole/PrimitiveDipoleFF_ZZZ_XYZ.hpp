#ifndef PrimitiveDipoleFF_ZZZ_XYZ
#define PrimitiveDipoleFF_ZZZ_XYZ
...
/**
 Evaluates block of primitive <F_ZZZ|r|F_XYZ> integrals.
...
*/
auto compPrimitiveDipoleFF_ZZZ_XYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_ZZZ_XYZ */
