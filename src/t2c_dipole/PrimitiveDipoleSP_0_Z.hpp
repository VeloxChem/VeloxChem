#ifndef PrimitiveDipoleSP_0_Z
#define PrimitiveDipoleSP_0_Z
...
/**
 Evaluates block of primitive <S_0|r|P_Z> integrals.
...
*/
auto compPrimitiveDipoleSP_0_Z(TDoubleArray&       buffer_x,
