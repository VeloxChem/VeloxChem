#ifndef PrimitiveDipoleSF_0_XXY
#define PrimitiveDipoleSF_0_XXY
...
/**
 Evaluates block of primitive <S_0|r|F_XXY> integrals.
...
*/
auto compPrimitiveDipoleSF_0_XXY(TDoubleArray&       buffer_x,
