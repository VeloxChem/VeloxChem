#ifndef PrimitiveDipoleGD_XXXX_XY
#define PrimitiveDipoleGD_XXXX_XY
...
/**
 Evaluates block of primitive <G_XXXX|r|D_XY> integrals.
...
*/
auto compPrimitiveDipoleGD_XXXX_XY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXXX_XY */
