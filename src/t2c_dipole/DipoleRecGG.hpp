#ifndef DipoleRecGG_hpp
#define DipoleRecGG_hpp
...
/**
 Evaluates <G|r|G>  integrals for given GTOs block.
...
*/
auto compDipoleGG(CSubMatrix*      matrix_x,
                  CSubMatrix*      matrix_y,
                  CSubMatrix*      matrix_z,
...
/**
 Evaluates <G|r|G>  integrals for given pair of GTOs blocks.
