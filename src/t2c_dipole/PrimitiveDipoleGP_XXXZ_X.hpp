#ifndef PrimitiveDipoleGP_XXXZ_X
#define PrimitiveDipoleGP_XXXZ_X
...
/**
 Evaluates block of primitive <G_XXXZ|r|P_X> integrals.
...
*/
auto compPrimitiveDipoleGP_XXXZ_X(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XXXZ_X */
