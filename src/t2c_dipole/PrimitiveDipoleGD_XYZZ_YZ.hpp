#ifndef PrimitiveDipoleGD_XYZZ_YZ
#define PrimitiveDipoleGD_XYZZ_YZ
...
/**
 Evaluates block of primitive <G_XYZZ|r|D_YZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XYZZ_YZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XYZZ_YZ */
