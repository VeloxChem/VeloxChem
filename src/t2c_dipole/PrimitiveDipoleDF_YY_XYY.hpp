#ifndef PrimitiveDipoleDF_YY_XYY
#define PrimitiveDipoleDF_YY_XYY
...
/**
 Evaluates block of primitive <D_YY|r|F_XYY> integrals.
...
*/
auto compPrimitiveDipoleDF_YY_XYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_YY_XYY */
