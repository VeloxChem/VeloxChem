#ifndef PrimitiveDipoleGD_YYYZ_XX
#define PrimitiveDipoleGD_YYYZ_XX
...
/**
 Evaluates block of primitive <G_YYYZ|r|D_XX> integrals.
...
*/
auto compPrimitiveDipoleGD_YYYZ_XX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_YYYZ_XX */
