#ifndef PrimitiveDipoleDG_XZ_XXXZ
#define PrimitiveDipoleDG_XZ_XXXZ
...
/**
 Evaluates block of primitive <D_XZ|r|G_XXXZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XZ_XXXZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XZ_XXXZ */
