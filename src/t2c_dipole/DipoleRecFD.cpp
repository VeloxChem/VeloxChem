...
#include "PrimitiveDipoleFD_XXX_XX.hpp"
#include "PrimitiveDipoleFD_XXX_XY.hpp"
#include "PrimitiveDipoleFD_XXX_XZ.hpp"
#include "PrimitiveDipoleFD_XXX_YY.hpp"
#include "PrimitiveDipoleFD_XXX_YZ.hpp"
#include "PrimitiveDipoleFD_XXX_ZZ.hpp"
#include "PrimitiveDipoleFD_XXY_XX.hpp"
#include "PrimitiveDipoleFD_XXY_XY.hpp"
...
#include "PrimitiveDipoleFD_XXZ_XY.hpp"
...
#include "PrimitiveDipoleFD_XYY_XZ.hpp"
#include "PrimitiveDipoleFD_XYY_YY.hpp"
#include "PrimitiveDipoleFD_XYY_YZ.hpp"
#include "PrimitiveDipoleFD_XYY_ZZ.hpp"
#include "PrimitiveDipoleFD_XYZ_XX.hpp"
#include "PrimitiveDipoleFD_XYZ_XY.hpp"
#include "PrimitiveDipoleFD_XYZ_XZ.hpp"
#include "PrimitiveDipoleFD_XYZ_YY.hpp"
#include "PrimitiveDipoleFD_XYZ_YZ.hpp"
#include "PrimitiveDipoleFD_XYZ_ZZ.hpp"
#include "PrimitiveDipoleFD_XZZ_XX.hpp"
#include "PrimitiveDipoleFD_XZZ_XY.hpp"
#include "PrimitiveDipoleFD_XZZ_XZ.hpp"
#include "PrimitiveDipoleFD_XZZ_YY.hpp"
#include "PrimitiveDipoleFD_XZZ_YZ.hpp"
#include "PrimitiveDipoleFD_XZZ_ZZ.hpp"
#include "PrimitiveDipoleFD_YYY_XX.hpp"
#include "PrimitiveDipoleFD_YYY_XY.hpp"
#include "PrimitiveDipoleFD_YYY_XZ.hpp"
#include "PrimitiveDipoleFD_YYY_YY.hpp"
#include "PrimitiveDipoleFD_YYY_YZ.hpp"
#include "PrimitiveDipoleFD_YYY_ZZ.hpp"
#include "PrimitiveDipoleFD_YYZ_XX.hpp"
#include "PrimitiveDipoleFD_YYZ_XY.hpp"
#include "PrimitiveDipoleFD_YYZ_XZ.hpp"
#include "PrimitiveDipoleFD_YYZ_YY.hpp"
#include "PrimitiveDipoleFD_YYZ_YZ.hpp"
#include "PrimitiveDipoleFD_YYZ_ZZ.hpp"
#include "PrimitiveDipoleFD_YZZ_XX.hpp"
#include "PrimitiveDipoleFD_YZZ_XY.hpp"
#include "PrimitiveDipoleFD_YZZ_XZ.hpp"
#include "PrimitiveDipoleFD_YZZ_YY.hpp"
#include "PrimitiveDipoleFD_YZZ_YZ.hpp"
#include "PrimitiveDipoleFD_YZZ_ZZ.hpp"
#include "PrimitiveDipoleFD_ZZZ_XX.hpp"
#include "PrimitiveDipoleFD_ZZZ_XY.hpp"
#include "PrimitiveDipoleFD_ZZZ_XZ.hpp"
#include "PrimitiveDipoleFD_ZZZ_YY.hpp"
#include "PrimitiveDipoleFD_ZZZ_YZ.hpp"
#include "PrimitiveDipoleFD_ZZZ_ZZ.hpp"
#include "T2CDistributor.hpp"

namespace diprec {  // diprec namespace

auto
compDipoleFD(CSubMatrix*      matrix_x,
             CSubMatrix*      matrix_y,
             CSubMatrix*      matrix_z,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XXX_XX(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XXX_XY(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XXX_XZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XXX_YY(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XXX_YZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XXX_ZZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XXY_XX(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XXY_XY(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XXY_XZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XXY_YY(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XXY_YZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XXY_ZZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XXZ_XX(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XXZ_XY(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XXZ_XZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XXZ_YY(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XXZ_YZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XXZ_ZZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XYY_XX(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XYY_XY(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XYY_XZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XYY_YY(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XYY_YZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XYY_ZZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XYZ_XX(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XYZ_XY(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XYZ_XZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XYZ_YY(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XYZ_YZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XYZ_ZZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XZZ_XX(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XZZ_XY(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XZZ_XZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XZZ_YY(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XZZ_YZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_XZZ_ZZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_YYY_XX(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_YYY_XY(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_YYY_XZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_YYY_YY(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_YYY_YZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_YYY_ZZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_YYZ_XX(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_YYZ_XY(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_YYZ_XZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_YYZ_YY(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_YYZ_YZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_YYZ_ZZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_YZZ_XX(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_YZZ_XY(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_YZZ_XZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_YZZ_YY(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_YZZ_YZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_YZZ_ZZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_ZZZ_XX(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_ZZZ_XY(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_ZZZ_XZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_ZZZ_YY(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_ZZZ_YZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFD_ZZZ_ZZ(buffer_x,
                                                         buffer_y,
                                                         buffer_z,
                                                         point,
                                                         bra_exp,
