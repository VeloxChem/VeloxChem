#ifndef PrimitiveDipoleGD_YYZZ_YZ
#define PrimitiveDipoleGD_YYZZ_YZ
...
/**
 Evaluates block of primitive <G_YYZZ|r|D_YZ> integrals.
...
*/
auto compPrimitiveDipoleGD_YYZZ_YZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_YYZZ_YZ */
