#ifndef PrimitiveDipoleGD_ZZZZ_YY
#define PrimitiveDipoleGD_ZZZZ_YY
...
/**
 Evaluates block of primitive <G_ZZZZ|r|D_YY> integrals.
...
*/
auto compPrimitiveDipoleGD_ZZZZ_YY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_ZZZZ_YY */
