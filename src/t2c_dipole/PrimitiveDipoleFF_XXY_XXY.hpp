#ifndef PrimitiveDipoleFF_XXY_XXY
#define PrimitiveDipoleFF_XXY_XXY
...
/**
 Evaluates block of primitive <F_XXY|r|F_XXY> integrals.
...
*/
auto compPrimitiveDipoleFF_XXY_XXY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XXY_XXY */
