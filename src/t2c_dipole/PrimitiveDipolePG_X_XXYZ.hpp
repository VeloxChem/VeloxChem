#ifndef PrimitiveDipolePG_X_XXYZ
#define PrimitiveDipolePG_X_XXYZ
...
/**
 Evaluates block of primitive <P_X|r|G_XXYZ> integrals.
...
*/
auto compPrimitiveDipolePG_X_XXYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_X_XXYZ */
