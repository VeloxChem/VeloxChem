#ifndef PrimitiveDipoleFP_XZZ_Y
#define PrimitiveDipoleFP_XZZ_Y
...
/**
 Evaluates block of primitive <F_XZZ|r|P_Y> integrals.
...
*/
auto compPrimitiveDipoleFP_XZZ_Y(TDoubleArray&       buffer_x,
