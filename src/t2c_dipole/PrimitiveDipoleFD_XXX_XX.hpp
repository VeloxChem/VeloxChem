#ifndef PrimitiveDipoleFD_XXX_XX
#define PrimitiveDipoleFD_XXX_XX
...
/**
 Evaluates block of primitive <F_XXX|r|D_XX> integrals.
...
*/
auto compPrimitiveDipoleFD_XXX_XX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_XXX_XX */
