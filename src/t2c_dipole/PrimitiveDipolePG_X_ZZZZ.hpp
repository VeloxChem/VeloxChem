#ifndef PrimitiveDipolePG_X_ZZZZ
#define PrimitiveDipolePG_X_ZZZZ
...
/**
 Evaluates block of primitive <P_X|r|G_ZZZZ> integrals.
...
*/
auto compPrimitiveDipolePG_X_ZZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_X_ZZZZ */
