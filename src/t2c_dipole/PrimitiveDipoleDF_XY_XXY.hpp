#ifndef PrimitiveDipoleDF_XY_XXY
#define PrimitiveDipoleDF_XY_XXY
...
/**
 Evaluates block of primitive <D_XY|r|F_XXY> integrals.
...
*/
auto compPrimitiveDipoleDF_XY_XXY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_XY_XXY */
