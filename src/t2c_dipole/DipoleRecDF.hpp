#ifndef DipoleRecDF_hpp
#define DipoleRecDF_hpp
...
/**
 Evaluates <D|r|F>  integrals for given pair of GTOs blocks.
...
*/
auto compDipoleDF(CSubMatrix*      matrix_x,
                  CSubMatrix*      matrix_y,
                  CSubMatrix*      matrix_z,
