#ifndef PrimitiveDipoleDG_YZ_XYZZ
#define PrimitiveDipoleDG_YZ_XYZZ
...
/**
 Evaluates block of primitive <D_YZ|r|G_XYZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_YZ_XYZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YZ_XYZZ */
