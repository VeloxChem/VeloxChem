#ifndef PrimitiveDipoleFS_XZZ_0
#define PrimitiveDipoleFS_XZZ_0
...
/**
 Evaluates block of primitive <F_XZZ|r|S_0> integrals.
...
*/
auto compPrimitiveDipoleFS_XZZ_0(TDoubleArray&       buffer_x,
