#ifndef PrimitiveDipoleGD_YYZZ_ZZ
#define PrimitiveDipoleGD_YYZZ_ZZ
...
/**
 Evaluates block of primitive <G_YYZZ|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipoleGD_YYZZ_ZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_YYZZ_ZZ */
