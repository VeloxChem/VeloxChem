#ifndef PrimitiveDipoleGD_YYYZ_XY
#define PrimitiveDipoleGD_YYYZ_XY
...
/**
 Evaluates block of primitive <G_YYYZ|r|D_XY> integrals.
...
*/
auto compPrimitiveDipoleGD_YYYZ_XY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_YYYZ_XY */
