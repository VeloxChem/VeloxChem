#ifndef PrimitiveDipolePF_Z_XXZ
#define PrimitiveDipolePF_Z_XXZ
...
/**
 Evaluates block of primitive <P_Z|r|F_XXZ> integrals.
...
*/
auto compPrimitiveDipolePF_Z_XXZ(TDoubleArray&       buffer_x,
