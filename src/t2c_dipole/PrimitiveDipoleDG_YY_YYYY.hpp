#ifndef PrimitiveDipoleDG_YY_YYYY
#define PrimitiveDipoleDG_YY_YYYY
...
/**
 Evaluates block of primitive <D_YY|r|G_YYYY> integrals.
...
*/
auto compPrimitiveDipoleDG_YY_YYYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YY_YYYY */
