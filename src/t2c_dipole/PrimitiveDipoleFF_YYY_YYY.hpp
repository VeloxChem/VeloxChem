#ifndef PrimitiveDipoleFF_YYY_YYY
#define PrimitiveDipoleFF_YYY_YYY
...
/**
 Evaluates block of primitive <F_YYY|r|F_YYY> integrals.
...
*/
auto compPrimitiveDipoleFF_YYY_YYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_YYY_YYY */
