#ifndef PrimitiveDipoleGD_XYZZ_XY
#define PrimitiveDipoleGD_XYZZ_XY
...
/**
 Evaluates block of primitive <G_XYZZ|r|D_XY> integrals.
...
*/
auto compPrimitiveDipoleGD_XYZZ_XY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XYZZ_XY */
