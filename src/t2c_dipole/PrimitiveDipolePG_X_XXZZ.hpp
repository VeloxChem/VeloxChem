#ifndef PrimitiveDipolePG_X_XXZZ
#define PrimitiveDipolePG_X_XXZZ
...
/**
 Evaluates block of primitive <P_X|r|G_XXZZ> integrals.
...
*/
auto compPrimitiveDipolePG_X_XXZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_X_XXZZ */
