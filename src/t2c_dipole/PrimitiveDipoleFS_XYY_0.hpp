#ifndef PrimitiveDipoleFS_XYY_0
#define PrimitiveDipoleFS_XYY_0
...
/**
 Evaluates block of primitive <F_XYY|r|S_0> integrals.
...
*/
auto compPrimitiveDipoleFS_XYY_0(TDoubleArray&       buffer_x,
