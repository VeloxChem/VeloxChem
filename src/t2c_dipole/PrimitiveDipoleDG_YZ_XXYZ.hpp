#ifndef PrimitiveDipoleDG_YZ_XXYZ
#define PrimitiveDipoleDG_YZ_XXYZ
...
/**
 Evaluates block of primitive <D_YZ|r|G_XXYZ> integrals.
...
*/
auto compPrimitiveDipoleDG_YZ_XXYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YZ_XXYZ */
