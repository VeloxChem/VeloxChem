#ifndef PrimitiveDipolePG_Z_XZZZ
#define PrimitiveDipolePG_Z_XZZZ
...
/**
 Evaluates block of primitive <P_Z|r|G_XZZZ> integrals.
...
*/
auto compPrimitiveDipolePG_Z_XZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Z_XZZZ */
