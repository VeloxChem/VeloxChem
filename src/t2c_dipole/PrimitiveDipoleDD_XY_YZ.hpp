#ifndef PrimitiveDipoleDD_XY_YZ
#define PrimitiveDipoleDD_XY_YZ
...
/**
 Evaluates block of primitive <D_XY|r|D_YZ> integrals.
...
*/
auto compPrimitiveDipoleDD_XY_YZ(TDoubleArray&       buffer_x,
