#ifndef PrimitiveDipoleGD_XXXY_XY
#define PrimitiveDipoleGD_XXXY_XY
...
/**
 Evaluates block of primitive <G_XXXY|r|D_XY> integrals.
...
*/
auto compPrimitiveDipoleGD_XXXY_XY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXXY_XY */
