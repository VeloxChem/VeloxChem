#ifndef PrimitiveDipoleGP_XXZZ_Z
#define PrimitiveDipoleGP_XXZZ_Z
...
/**
 Evaluates block of primitive <G_XXZZ|r|P_Z> integrals.
...
*/
auto compPrimitiveDipoleGP_XXZZ_Z(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XXZZ_Z */
