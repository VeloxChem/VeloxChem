#ifndef PrimitiveDipolePG_Z_XXYY
#define PrimitiveDipolePG_Z_XXYY
...
/**
 Evaluates block of primitive <P_Z|r|G_XXYY> integrals.
...
*/
auto compPrimitiveDipolePG_Z_XXYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Z_XXYY */
