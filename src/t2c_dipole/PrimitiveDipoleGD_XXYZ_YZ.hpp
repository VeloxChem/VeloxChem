#ifndef PrimitiveDipoleGD_XXYZ_YZ
#define PrimitiveDipoleGD_XXYZ_YZ
...
/**
 Evaluates block of primitive <G_XXYZ|r|D_YZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XXYZ_YZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXYZ_YZ */
