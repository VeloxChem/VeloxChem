#ifndef PrimitiveDipoleSD_0_XZ
#define PrimitiveDipoleSD_0_XZ
...
/**
 Evaluates block of primitive <S_0|r|D_XZ> integrals.
...
*/
auto compPrimitiveDipoleSD_0_XZ(TDoubleArray&       buffer_x,
