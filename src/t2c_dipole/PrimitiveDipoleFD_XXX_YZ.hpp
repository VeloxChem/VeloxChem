#ifndef PrimitiveDipoleFD_XXX_YZ
#define PrimitiveDipoleFD_XXX_YZ
...
/**
 Evaluates block of primitive <F_XXX|r|D_YZ> integrals.
...
*/
auto compPrimitiveDipoleFD_XXX_YZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_XXX_YZ */
