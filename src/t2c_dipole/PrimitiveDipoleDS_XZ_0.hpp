#ifndef PrimitiveDipoleDS_XZ_0
#define PrimitiveDipoleDS_XZ_0
...
/**
 Evaluates block of primitive <D_XZ|r|S_0> integrals.
...
*/
auto compPrimitiveDipoleDS_XZ_0(TDoubleArray&       buffer_x,
