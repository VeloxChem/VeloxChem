#ifndef PrimitiveDipolePG_Z_YYYZ
#define PrimitiveDipolePG_Z_YYYZ
...
/**
 Evaluates block of primitive <P_Z|r|G_YYYZ> integrals.
...
*/
auto compPrimitiveDipolePG_Z_YYYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Z_YYYZ */
