#ifndef PrimitiveDipoleFS_ZZZ_0
#define PrimitiveDipoleFS_ZZZ_0
...
/**
 Evaluates block of primitive <F_ZZZ|r|S_0> integrals.
...
*/
auto compPrimitiveDipoleFS_ZZZ_0(TDoubleArray&       buffer_x,
