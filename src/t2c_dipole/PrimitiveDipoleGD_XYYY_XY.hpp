#ifndef PrimitiveDipoleGD_XYYY_XY
#define PrimitiveDipoleGD_XYYY_XY
...
/**
 Evaluates block of primitive <G_XYYY|r|D_XY> integrals.
...
*/
auto compPrimitiveDipoleGD_XYYY_XY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XYYY_XY */
