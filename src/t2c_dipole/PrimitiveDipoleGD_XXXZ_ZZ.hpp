#ifndef PrimitiveDipoleGD_XXXZ_ZZ
#define PrimitiveDipoleGD_XXXZ_ZZ
...
/**
 Evaluates block of primitive <G_XXXZ|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XXXZ_ZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXXZ_ZZ */
