#ifndef PrimitiveDipoleGD_XXZZ_XX
#define PrimitiveDipoleGD_XXZZ_XX
...
/**
 Evaluates block of primitive <G_XXZZ|r|D_XX> integrals.
...
*/
auto compPrimitiveDipoleGD_XXZZ_XX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXZZ_XX */
