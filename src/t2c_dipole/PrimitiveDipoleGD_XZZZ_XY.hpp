#ifndef PrimitiveDipoleGD_XZZZ_XY
#define PrimitiveDipoleGD_XZZZ_XY
...
/**
 Evaluates block of primitive <G_XZZZ|r|D_XY> integrals.
...
*/
auto compPrimitiveDipoleGD_XZZZ_XY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XZZZ_XY */
