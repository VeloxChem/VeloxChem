#ifndef PrimitiveDipoleFF_YYZ_XXZ
#define PrimitiveDipoleFF_YYZ_XXZ
...
/**
 Evaluates block of primitive <F_YYZ|r|F_XXZ> integrals.
...
*/
auto compPrimitiveDipoleFF_YYZ_XXZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_YYZ_XXZ */
