#ifndef PrimitiveDipoleGP_XYZZ_X
#define PrimitiveDipoleGP_XYZZ_X
...
/**
 Evaluates block of primitive <G_XYZZ|r|P_X> integrals.
...
*/
auto compPrimitiveDipoleGP_XYZZ_X(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XYZZ_X */
