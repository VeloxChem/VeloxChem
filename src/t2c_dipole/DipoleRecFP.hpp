#ifndef DipoleRecFP_hpp
#define DipoleRecFP_hpp
...
/**
 Evaluates <F|r|P>  integrals for given pair of GTOs blocks.
...
*/
auto compDipoleFP(CSubMatrix*      matrix_x,
                  CSubMatrix*      matrix_y,
                  CSubMatrix*      matrix_z,
