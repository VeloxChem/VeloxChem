#ifndef PrimitiveDipoleDG_ZZ_XXXY
#define PrimitiveDipoleDG_ZZ_XXXY
...
/**
 Evaluates block of primitive <D_ZZ|r|G_XXXY> integrals.
...
*/
auto compPrimitiveDipoleDG_ZZ_XXXY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_ZZ_XXXY */
