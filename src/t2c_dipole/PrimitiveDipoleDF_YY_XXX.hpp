#ifndef PrimitiveDipoleDF_YY_XXX
#define PrimitiveDipoleDF_YY_XXX
...
/**
 Evaluates block of primitive <D_YY|r|F_XXX> integrals.
...
*/
auto compPrimitiveDipoleDF_YY_XXX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_YY_XXX */
