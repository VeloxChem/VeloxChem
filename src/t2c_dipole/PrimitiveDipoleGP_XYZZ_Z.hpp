#ifndef PrimitiveDipoleGP_XYZZ_Z
#define PrimitiveDipoleGP_XYZZ_Z
...
/**
 Evaluates block of primitive <G_XYZZ|r|P_Z> integrals.
...
*/
auto compPrimitiveDipoleGP_XYZZ_Z(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XYZZ_Z */
