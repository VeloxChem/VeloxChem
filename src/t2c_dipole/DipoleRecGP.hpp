#ifndef DipoleRecGP_hpp
#define DipoleRecGP_hpp
...
/**
 Evaluates <G|r|P>  integrals for given pair of GTOs blocks.
...
*/
auto compDipoleGP(CSubMatrix*      matrix_x,
                  CSubMatrix*      matrix_y,
                  CSubMatrix*      matrix_z,
