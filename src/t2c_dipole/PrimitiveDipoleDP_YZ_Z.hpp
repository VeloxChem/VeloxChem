#ifndef PrimitiveDipoleDP_YZ_Z
#define PrimitiveDipoleDP_YZ_Z
...
/**
 Evaluates block of primitive <D_YZ|r|P_Z> integrals.
...
*/
auto compPrimitiveDipoleDP_YZ_Z(TDoubleArray&       buffer_x,
