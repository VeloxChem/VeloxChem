#ifndef PrimitiveDipoleGD_XYZZ_YY
#define PrimitiveDipoleGD_XYZZ_YY
...
/**
 Evaluates block of primitive <G_XYZZ|r|D_YY> integrals.
...
*/
auto compPrimitiveDipoleGD_XYZZ_YY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XYZZ_YY */
