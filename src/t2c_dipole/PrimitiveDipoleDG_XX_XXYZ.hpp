#ifndef PrimitiveDipoleDG_XX_XXYZ
#define PrimitiveDipoleDG_XX_XXYZ
...
/**
 Evaluates block of primitive <D_XX|r|G_XXYZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XX_XXYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XX_XXYZ */
