#ifndef PrimitiveDipoleDD_XX_XX
#define PrimitiveDipoleDD_XX_XX
...
/**
 Evaluates block of primitive <D_XX|r|D_XX> integrals.
...
*/
auto compPrimitiveDipoleDD_XX_XX(TDoubleArray&       buffer_x,
