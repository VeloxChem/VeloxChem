#ifndef PrimitiveDipoleFD_YYY_XY
#define PrimitiveDipoleFD_YYY_XY
...
/**
 Evaluates block of primitive <F_YYY|r|D_XY> integrals.
...
*/
auto compPrimitiveDipoleFD_YYY_XY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_YYY_XY */
