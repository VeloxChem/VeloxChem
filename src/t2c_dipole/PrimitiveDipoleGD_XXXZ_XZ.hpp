#ifndef PrimitiveDipoleGD_XXXZ_XZ
#define PrimitiveDipoleGD_XXXZ_XZ
...
/**
 Evaluates block of primitive <G_XXXZ|r|D_XZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XXXZ_XZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXXZ_XZ */
