#ifndef PrimitiveDipoleDD_XZ_XZ
#define PrimitiveDipoleDD_XZ_XZ
...
/**
 Evaluates block of primitive <D_XZ|r|D_XZ> integrals.
...
*/
auto compPrimitiveDipoleDD_XZ_XZ(TDoubleArray&       buffer_x,
