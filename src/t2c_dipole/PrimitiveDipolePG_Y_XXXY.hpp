#ifndef PrimitiveDipolePG_Y_XXXY
#define PrimitiveDipolePG_Y_XXXY
...
/**
 Evaluates block of primitive <P_Y|r|G_XXXY> integrals.
...
*/
auto compPrimitiveDipolePG_Y_XXXY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Y_XXXY */
