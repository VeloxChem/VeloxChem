#ifndef PrimitiveDipoleDF_YZ_ZZZ
#define PrimitiveDipoleDF_YZ_ZZZ
...
/**
 Evaluates block of primitive <D_YZ|r|F_ZZZ> integrals.
...
*/
auto compPrimitiveDipoleDF_YZ_ZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_YZ_ZZZ */
