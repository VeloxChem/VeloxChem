#ifndef PrimitiveDipolePF_Z_YYZ
#define PrimitiveDipolePF_Z_YYZ
...
/**
 Evaluates block of primitive <P_Z|r|F_YYZ> integrals.
...
*/
auto compPrimitiveDipolePF_Z_YYZ(TDoubleArray&       buffer_x,
