#ifndef PrimitiveDipoleFF_XYZ_XZZ
#define PrimitiveDipoleFF_XYZ_XZZ
...
/**
 Evaluates block of primitive <F_XYZ|r|F_XZZ> integrals.
...
*/
auto compPrimitiveDipoleFF_XYZ_XZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XYZ_XZZ */
