#ifndef PrimitiveDipoleGP_YYYZ_Y
#define PrimitiveDipoleGP_YYYZ_Y
...
/**
 Evaluates block of primitive <G_YYYZ|r|P_Y> integrals.
...
*/
auto compPrimitiveDipoleGP_YYYZ_Y(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_YYYZ_Y */
