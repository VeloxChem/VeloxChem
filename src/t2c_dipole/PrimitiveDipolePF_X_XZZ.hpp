#ifndef PrimitiveDipolePF_X_XZZ
#define PrimitiveDipolePF_X_XZZ
...
/**
 Evaluates block of primitive <P_X|r|F_XZZ> integrals.
...
*/
auto compPrimitiveDipolePF_X_XZZ(TDoubleArray&       buffer_x,
