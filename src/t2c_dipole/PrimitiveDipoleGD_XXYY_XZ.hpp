#ifndef PrimitiveDipoleGD_XXYY_XZ
#define PrimitiveDipoleGD_XXYY_XZ
...
/**
 Evaluates block of primitive <G_XXYY|r|D_XZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XXYY_XZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXYY_XZ */
