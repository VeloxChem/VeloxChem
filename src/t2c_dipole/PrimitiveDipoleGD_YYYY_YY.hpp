#ifndef PrimitiveDipoleGD_YYYY_YY
#define PrimitiveDipoleGD_YYYY_YY
...
/**
 Evaluates block of primitive <G_YYYY|r|D_YY> integrals.
...
*/
auto compPrimitiveDipoleGD_YYYY_YY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_YYYY_YY */
