#ifndef PrimitiveDipoleGP_YYZZ_Y
#define PrimitiveDipoleGP_YYZZ_Y
...
/**
 Evaluates block of primitive <G_YYZZ|r|P_Y> integrals.
...
*/
auto compPrimitiveDipoleGP_YYZZ_Y(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_YYZZ_Y */
