#ifndef PrimitiveDipoleDF_YY_XXZ
#define PrimitiveDipoleDF_YY_XXZ
...
/**
 Evaluates block of primitive <D_YY|r|F_XXZ> integrals.
...
*/
auto compPrimitiveDipoleDF_YY_XXZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_YY_XXZ */
