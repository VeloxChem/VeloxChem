#ifndef PrimitiveDipoleGD_XYYZ_XZ
#define PrimitiveDipoleGD_XYYZ_XZ
...
/**
 Evaluates block of primitive <G_XYYZ|r|D_XZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XYYZ_XZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XYYZ_XZ */
