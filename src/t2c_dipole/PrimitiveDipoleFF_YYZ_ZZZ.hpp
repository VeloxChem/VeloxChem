#ifndef PrimitiveDipoleFF_YYZ_ZZZ
#define PrimitiveDipoleFF_YYZ_ZZZ
...
/**
 Evaluates block of primitive <F_YYZ|r|F_ZZZ> integrals.
...
*/
auto compPrimitiveDipoleFF_YYZ_ZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_YYZ_ZZZ */
