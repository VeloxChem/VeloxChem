#ifndef PrimitiveDipoleGS_XYYY_0
#define PrimitiveDipoleGS_XYYY_0
...
/**
 Evaluates block of primitive <G_XYYY|r|S_0> integrals.
...
*/
auto compPrimitiveDipoleGS_XYYY_0(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGS_XYYY_0 */
