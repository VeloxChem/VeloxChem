#ifndef PrimitiveDipoleFF_XZZ_YZZ
#define PrimitiveDipoleFF_XZZ_YZZ
...
/**
 Evaluates block of primitive <F_XZZ|r|F_YZZ> integrals.
...
*/
auto compPrimitiveDipoleFF_XZZ_YZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XZZ_YZZ */
