#ifndef PrimitiveDipoleGD_XZZZ_XZ
#define PrimitiveDipoleGD_XZZZ_XZ
...
/**
 Evaluates block of primitive <G_XZZZ|r|D_XZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XZZZ_XZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XZZZ_XZ */
