#ifndef PrimitiveDipoleDG_YY_XYYZ
#define PrimitiveDipoleDG_YY_XYYZ
...
/**
 Evaluates block of primitive <D_YY|r|G_XYYZ> integrals.
...
*/
auto compPrimitiveDipoleDG_YY_XYYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YY_XYYZ */
