#ifndef PrimitiveDipoleGD_XXXX_ZZ
#define PrimitiveDipoleGD_XXXX_ZZ
...
/**
 Evaluates block of primitive <G_XXXX|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XXXX_ZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXXX_ZZ */
