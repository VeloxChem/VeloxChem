#ifndef PrimitiveDipoleDD_YY_YZ
#define PrimitiveDipoleDD_YY_YZ
...
/**
 Evaluates block of primitive <D_YY|r|D_YZ> integrals.
...
*/
auto compPrimitiveDipoleDD_YY_YZ(TDoubleArray&       buffer_x,
