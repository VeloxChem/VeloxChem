#ifndef PrimitiveDipolePP_X_Z
#define PrimitiveDipolePP_X_Z
...
/**
 Evaluates block of primitive <P_X|r|P_Z> integrals.
...
*/
auto compPrimitiveDipolePP_X_Z(TDoubleArray&       buffer_x,
