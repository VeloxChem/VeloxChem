#ifndef PrimitiveDipoleDG_ZZ_XYYZ
#define PrimitiveDipoleDG_ZZ_XYYZ
...
/**
 Evaluates block of primitive <D_ZZ|r|G_XYYZ> integrals.
...
*/
auto compPrimitiveDipoleDG_ZZ_XYYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_ZZ_XYYZ */
