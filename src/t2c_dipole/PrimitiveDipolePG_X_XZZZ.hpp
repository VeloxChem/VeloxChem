#ifndef PrimitiveDipolePG_X_XZZZ
#define PrimitiveDipolePG_X_XZZZ
...
/**
 Evaluates block of primitive <P_X|r|G_XZZZ> integrals.
...
*/
auto compPrimitiveDipolePG_X_XZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_X_XZZZ */
