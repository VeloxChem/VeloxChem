#ifndef PrimitiveDipoleGD_XYYY_YZ
#define PrimitiveDipoleGD_XYYY_YZ
...
/**
 Evaluates block of primitive <G_XYYY|r|D_YZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XYYY_YZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XYYY_YZ */
