#ifndef PrimitiveDipoleDG_ZZ_XYZZ
#define PrimitiveDipoleDG_ZZ_XYZZ
...
/**
 Evaluates block of primitive <D_ZZ|r|G_XYZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_ZZ_XYZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_ZZ_XYZZ */
