#ifndef PrimitiveDipoleDF_XZ_XXX
#define PrimitiveDipoleDF_XZ_XXX
...
/**
 Evaluates block of primitive <D_XZ|r|F_XXX> integrals.
...
*/
auto compPrimitiveDipoleDF_XZ_XXX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_XZ_XXX */
