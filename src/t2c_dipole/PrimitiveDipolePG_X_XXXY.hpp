#ifndef PrimitiveDipolePG_X_XXXY
#define PrimitiveDipolePG_X_XXXY
...
/**
 Evaluates block of primitive <P_X|r|G_XXXY> integrals.
...
*/
auto compPrimitiveDipolePG_X_XXXY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_X_XXXY */
