#ifndef PrimitiveDipoleFD_XXY_ZZ
#define PrimitiveDipoleFD_XXY_ZZ
...
/**
 Evaluates block of primitive <F_XXY|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipoleFD_XXY_ZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_XXY_ZZ */
