#ifndef PrimitiveDipoleGD_XXYZ_XX
#define PrimitiveDipoleGD_XXYZ_XX
...
/**
 Evaluates block of primitive <G_XXYZ|r|D_XX> integrals.
...
*/
auto compPrimitiveDipoleGD_XXYZ_XX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXYZ_XX */
