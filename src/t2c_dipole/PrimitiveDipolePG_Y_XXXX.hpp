#ifndef PrimitiveDipolePG_Y_XXXX
#define PrimitiveDipolePG_Y_XXXX
...
/**
 Evaluates block of primitive <P_Y|r|G_XXXX> integrals.
...
*/
auto compPrimitiveDipolePG_Y_XXXX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Y_XXXX */
