#ifndef PrimitiveDipoleDF_ZZ_XYY
#define PrimitiveDipoleDF_ZZ_XYY
...
/**
 Evaluates block of primitive <D_ZZ|r|F_XYY> integrals.
...
*/
auto compPrimitiveDipoleDF_ZZ_XYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_ZZ_XYY */
