#ifndef PrimitiveDipoleDG_XY_YZZZ
#define PrimitiveDipoleDG_XY_YZZZ
...
/**
 Evaluates block of primitive <D_XY|r|G_YZZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XY_YZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XY_YZZZ */
