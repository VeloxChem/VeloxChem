#ifndef PrimitiveDipoleSF_0_YYZ
#define PrimitiveDipoleSF_0_YYZ
...
/**
 Evaluates block of primitive <S_0|r|F_YYZ> integrals.
...
*/
auto compPrimitiveDipoleSF_0_YYZ(TDoubleArray&       buffer_x,
