#ifndef PrimitiveDipoleGD_XYZZ_XZ
#define PrimitiveDipoleGD_XYZZ_XZ
...
/**
 Evaluates block of primitive <G_XYZZ|r|D_XZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XYZZ_XZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XYZZ_XZ */
