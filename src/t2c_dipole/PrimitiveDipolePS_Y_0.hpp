#ifndef PrimitiveDipolePS_Y_0
#define PrimitiveDipolePS_Y_0
...
/**
 Evaluates block of primitive <P_Y|r|S_0> integrals.
...
*/
auto compPrimitiveDipolePS_Y_0(TDoubleArray&       buffer_x,
