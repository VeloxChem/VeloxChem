#ifndef PrimitiveDipoleGD_YZZZ_YY
#define PrimitiveDipoleGD_YZZZ_YY
...
/**
 Evaluates block of primitive <G_YZZZ|r|D_YY> integrals.
...
*/
auto compPrimitiveDipoleGD_YZZZ_YY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_YZZZ_YY */
