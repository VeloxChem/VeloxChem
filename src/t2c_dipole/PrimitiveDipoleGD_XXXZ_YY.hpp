#ifndef PrimitiveDipoleGD_XXXZ_YY
#define PrimitiveDipoleGD_XXXZ_YY
...
/**
 Evaluates block of primitive <G_XXXZ|r|D_YY> integrals.
...
*/
auto compPrimitiveDipoleGD_XXXZ_YY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXXZ_YY */
