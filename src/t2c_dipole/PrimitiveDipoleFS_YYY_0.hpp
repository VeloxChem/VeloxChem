#ifndef PrimitiveDipoleFS_YYY_0
#define PrimitiveDipoleFS_YYY_0
...
/**
 Evaluates block of primitive <F_YYY|r|S_0> integrals.
...
*/
auto compPrimitiveDipoleFS_YYY_0(TDoubleArray&       buffer_x,
