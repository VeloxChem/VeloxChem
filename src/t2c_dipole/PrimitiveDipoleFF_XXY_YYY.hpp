#ifndef PrimitiveDipoleFF_XXY_YYY
#define PrimitiveDipoleFF_XXY_YYY
...
/**
 Evaluates block of primitive <F_XXY|r|F_YYY> integrals.
...
*/
auto compPrimitiveDipoleFF_XXY_YYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XXY_YYY */
