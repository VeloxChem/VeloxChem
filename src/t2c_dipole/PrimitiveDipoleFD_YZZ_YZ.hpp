#ifndef PrimitiveDipoleFD_YZZ_YZ
#define PrimitiveDipoleFD_YZZ_YZ
...
/**
 Evaluates block of primitive <F_YZZ|r|D_YZ> integrals.
...
*/
auto compPrimitiveDipoleFD_YZZ_YZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_YZZ_YZ */
