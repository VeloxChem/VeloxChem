#ifndef PrimitiveDipoleDG_ZZ_YYYY
#define PrimitiveDipoleDG_ZZ_YYYY
...
/**
 Evaluates block of primitive <D_ZZ|r|G_YYYY> integrals.
...
*/
auto compPrimitiveDipoleDG_ZZ_YYYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_ZZ_YYYY */
