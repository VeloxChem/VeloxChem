#ifndef PrimitiveDipolePD_X_XY
#define PrimitiveDipolePD_X_XY
...
/**
 Evaluates block of primitive <P_X|r|D_XY> integrals.
...
*/
auto compPrimitiveDipolePD_X_XY(TDoubleArray&       buffer_x,
