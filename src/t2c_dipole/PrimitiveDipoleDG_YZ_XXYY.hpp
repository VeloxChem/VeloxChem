#ifndef PrimitiveDipoleDG_YZ_XXYY
#define PrimitiveDipoleDG_YZ_XXYY
...
/**
 Evaluates block of primitive <D_YZ|r|G_XXYY> integrals.
...
*/
auto compPrimitiveDipoleDG_YZ_XXYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YZ_XXYY */
