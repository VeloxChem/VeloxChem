#ifndef PrimitiveDipoleFS_XYZ_0
#define PrimitiveDipoleFS_XYZ_0
...
/**
 Evaluates block of primitive <F_XYZ|r|S_0> integrals.
...
*/
auto compPrimitiveDipoleFS_XYZ_0(TDoubleArray&       buffer_x,
