#ifndef PrimitiveDipoleFD_XYY_XX
#define PrimitiveDipoleFD_XYY_XX
...
/**
 Evaluates block of primitive <F_XYY|r|D_XX> integrals.
...
*/
auto compPrimitiveDipoleFD_XYY_XX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_XYY_XX */
