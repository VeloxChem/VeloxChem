#ifndef PrimitiveDipoleDG_XY_XXXY
#define PrimitiveDipoleDG_XY_XXXY
...
/**
 Evaluates block of primitive <D_XY|r|G_XXXY> integrals.
...
*/
auto compPrimitiveDipoleDG_XY_XXXY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XY_XXXY */
