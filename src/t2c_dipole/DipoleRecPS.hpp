#ifndef DipoleRecPS_hpp
#define DipoleRecPS_hpp
...
/**
 Evaluates <P|r|S>  integrals for given pair of GTOs blocks.
...
*/
auto compDipolePS(CSubMatrix*      matrix_x,
                  CSubMatrix*      matrix_y,
                  CSubMatrix*      matrix_z,
