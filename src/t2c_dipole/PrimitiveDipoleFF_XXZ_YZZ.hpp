#ifndef PrimitiveDipoleFF_XXZ_YZZ
#define PrimitiveDipoleFF_XXZ_YZZ
...
/**
 Evaluates block of primitive <F_XXZ|r|F_YZZ> integrals.
...
*/
auto compPrimitiveDipoleFF_XXZ_YZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XXZ_YZZ */
