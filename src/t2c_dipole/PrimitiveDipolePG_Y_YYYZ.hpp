#ifndef PrimitiveDipolePG_Y_YYYZ
#define PrimitiveDipolePG_Y_YYYZ
...
/**
 Evaluates block of primitive <P_Y|r|G_YYYZ> integrals.
...
*/
auto compPrimitiveDipolePG_Y_YYYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Y_YYYZ */
