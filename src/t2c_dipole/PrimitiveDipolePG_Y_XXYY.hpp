#ifndef PrimitiveDipolePG_Y_XXYY
#define PrimitiveDipolePG_Y_XXYY
...
/**
 Evaluates block of primitive <P_Y|r|G_XXYY> integrals.
...
*/
auto compPrimitiveDipolePG_Y_XXYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Y_XXYY */
