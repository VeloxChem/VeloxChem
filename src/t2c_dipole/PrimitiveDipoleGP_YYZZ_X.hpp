#ifndef PrimitiveDipoleGP_YYZZ_X
#define PrimitiveDipoleGP_YYZZ_X
...
/**
 Evaluates block of primitive <G_YYZZ|r|P_X> integrals.
...
*/
auto compPrimitiveDipoleGP_YYZZ_X(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_YYZZ_X */
