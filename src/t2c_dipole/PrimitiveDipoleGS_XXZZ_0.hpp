#ifndef PrimitiveDipoleGS_XXZZ_0
#define PrimitiveDipoleGS_XXZZ_0
...
/**
 Evaluates block of primitive <G_XXZZ|r|S_0> integrals.
...
*/
auto compPrimitiveDipoleGS_XXZZ_0(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGS_XXZZ_0 */
