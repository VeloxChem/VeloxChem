#ifndef PrimitiveDipoleGP_XXXX_Z
#define PrimitiveDipoleGP_XXXX_Z
...
/**
 Evaluates block of primitive <G_XXXX|r|P_Z> integrals.
...
*/
auto compPrimitiveDipoleGP_XXXX_Z(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XXXX_Z */
