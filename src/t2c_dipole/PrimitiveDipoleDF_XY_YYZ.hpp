#ifndef PrimitiveDipoleDF_XY_YYZ
#define PrimitiveDipoleDF_XY_YYZ
...
/**
 Evaluates block of primitive <D_XY|r|F_YYZ> integrals.
...
*/
auto compPrimitiveDipoleDF_XY_YYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_XY_YYZ */
