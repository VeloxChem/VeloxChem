#ifndef PrimitiveDipoleFD_XXX_XZ
#define PrimitiveDipoleFD_XXX_XZ
...
/**
 Evaluates block of primitive <F_XXX|r|D_XZ> integrals.
...
*/
auto compPrimitiveDipoleFD_XXX_XZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_XXX_XZ */
