#ifndef PrimitiveDipoleDG_XY_XXZZ
#define PrimitiveDipoleDG_XY_XXZZ
...
/**
 Evaluates block of primitive <D_XY|r|G_XXZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XY_XXZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XY_XXZZ */
