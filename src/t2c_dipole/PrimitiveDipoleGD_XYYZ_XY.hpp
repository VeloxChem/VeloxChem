#ifndef PrimitiveDipoleGD_XYYZ_XY
#define PrimitiveDipoleGD_XYYZ_XY
...
/**
 Evaluates block of primitive <G_XYYZ|r|D_XY> integrals.
...
*/
auto compPrimitiveDipoleGD_XYYZ_XY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XYYZ_XY */
