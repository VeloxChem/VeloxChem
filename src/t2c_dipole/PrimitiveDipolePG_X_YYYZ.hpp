#ifndef PrimitiveDipolePG_X_YYYZ
#define PrimitiveDipolePG_X_YYYZ
...
/**
 Evaluates block of primitive <P_X|r|G_YYYZ> integrals.
...
*/
auto compPrimitiveDipolePG_X_YYYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_X_YYYZ */
