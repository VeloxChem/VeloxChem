        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXX_XXX(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXX_XXY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXX_XXZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXX_XYY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXX_XYZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXX_XZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXX_YYY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXX_YYZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXX_YZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXX_ZZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXY_XXX(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXY_XXY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXY_XXZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXY_XYY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXY_XYZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXY_XZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXY_YYY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXY_YYZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXY_YZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXY_ZZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXZ_XXX(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXZ_XXY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXZ_XXZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXZ_XYY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXZ_XYZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXZ_XZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXZ_YYY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXZ_YYZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXZ_YZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XXZ_ZZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XYY_XXX(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XYY_XXY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XYY_XXZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XYY_XYY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XYY_XYZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XYY_XZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XYY_YYY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XYY_YYZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XYY_YZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XYY_ZZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XYZ_XXX(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XYZ_XXY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XYZ_XXZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XYZ_XYY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XYZ_XYZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XYZ_XZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XYZ_YYY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XYZ_YYZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XYZ_YZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XYZ_ZZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XZZ_XXX(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XZZ_XXY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XZZ_XXZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XZZ_XYY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XZZ_XYZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XZZ_XZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XZZ_YYY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XZZ_YYZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XZZ_YZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_XZZ_ZZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YYY_XXX(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YYY_XXY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YYY_XXZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YYY_XYY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YYY_XYZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YYY_XZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YYY_YYY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YYY_YYZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YYY_YZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YYY_ZZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YYZ_XXX(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YYZ_XXY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YYZ_XXZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YYZ_XYY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YYZ_XYZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YYZ_XZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YYZ_YYY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YYZ_YYZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YYZ_YZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YYZ_ZZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YZZ_XXX(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YZZ_XXY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YZZ_XXZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YZZ_XYY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YZZ_XYZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YZZ_XZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YZZ_YYY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YZZ_YYZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YZZ_YZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_YZZ_ZZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_ZZZ_XXX(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_ZZZ_XXY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_ZZZ_XXZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_ZZZ_XYY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_ZZZ_XYZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_ZZZ_XZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_ZZZ_YYY(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_ZZZ_YYZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_ZZZ_YZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFF_ZZZ_ZZZ(buffer_x,
                                                          buffer_y,
                                                          buffer_z,
                                                          point,
                                                          bra_exp,
