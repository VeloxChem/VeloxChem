#ifndef PrimitiveDipoleGP_XXYZ_Y
#define PrimitiveDipoleGP_XXYZ_Y
...
/**
 Evaluates block of primitive <G_XXYZ|r|P_Y> integrals.
...
*/
auto compPrimitiveDipoleGP_XXYZ_Y(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XXYZ_Y */
