#ifndef PrimitiveDipoleFF_XZZ_XYY
#define PrimitiveDipoleFF_XZZ_XYY
...
/**
 Evaluates block of primitive <F_XZZ|r|F_XYY> integrals.
...
*/
auto compPrimitiveDipoleFF_XZZ_XYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XZZ_XYY */
