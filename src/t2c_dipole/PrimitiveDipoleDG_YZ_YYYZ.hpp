#ifndef PrimitiveDipoleDG_YZ_YYYZ
#define PrimitiveDipoleDG_YZ_YYYZ
...
/**
 Evaluates block of primitive <D_YZ|r|G_YYYZ> integrals.
...
*/
auto compPrimitiveDipoleDG_YZ_YYYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YZ_YYYZ */
