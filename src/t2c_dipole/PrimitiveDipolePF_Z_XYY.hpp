#ifndef PrimitiveDipolePF_Z_XYY
#define PrimitiveDipolePF_Z_XYY
...
/**
 Evaluates block of primitive <P_Z|r|F_XYY> integrals.
...
*/
auto compPrimitiveDipolePF_Z_XYY(TDoubleArray&       buffer_x,
