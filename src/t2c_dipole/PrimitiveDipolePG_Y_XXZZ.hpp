#ifndef PrimitiveDipolePG_Y_XXZZ
#define PrimitiveDipolePG_Y_XXZZ
...
/**
 Evaluates block of primitive <P_Y|r|G_XXZZ> integrals.
...
*/
auto compPrimitiveDipolePG_Y_XXZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Y_XXZZ */
