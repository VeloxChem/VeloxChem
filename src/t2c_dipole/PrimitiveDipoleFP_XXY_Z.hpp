#ifndef PrimitiveDipoleFP_XXY_Z
#define PrimitiveDipoleFP_XXY_Z
...
/**
 Evaluates block of primitive <F_XXY|r|P_Z> integrals.
...
*/
auto compPrimitiveDipoleFP_XXY_Z(TDoubleArray&       buffer_x,
