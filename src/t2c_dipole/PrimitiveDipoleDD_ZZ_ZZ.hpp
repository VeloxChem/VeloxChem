#ifndef PrimitiveDipoleDD_ZZ_ZZ
#define PrimitiveDipoleDD_ZZ_ZZ
...
/**
 Evaluates block of primitive <D_ZZ|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipoleDD_ZZ_ZZ(TDoubleArray&       buffer_x,
