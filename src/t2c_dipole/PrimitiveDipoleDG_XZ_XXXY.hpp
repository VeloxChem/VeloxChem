#ifndef PrimitiveDipoleDG_XZ_XXXY
#define PrimitiveDipoleDG_XZ_XXXY
...
/**
 Evaluates block of primitive <D_XZ|r|G_XXXY> integrals.
...
*/
auto compPrimitiveDipoleDG_XZ_XXXY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XZ_XXXY */
