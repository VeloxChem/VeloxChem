#ifndef PrimitiveDipoleDP_XX_Z
#define PrimitiveDipoleDP_XX_Z
...
/**
 Evaluates block of primitive <D_XX|r|P_Z> integrals.
...
*/
auto compPrimitiveDipoleDP_XX_Z(TDoubleArray&       buffer_x,
