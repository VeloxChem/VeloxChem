#ifndef PrimitiveDipoleFF_ZZZ_YZZ
#define PrimitiveDipoleFF_ZZZ_YZZ
...
/**
 Evaluates block of primitive <F_ZZZ|r|F_YZZ> integrals.
...
*/
auto compPrimitiveDipoleFF_ZZZ_YZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_ZZZ_YZZ */
