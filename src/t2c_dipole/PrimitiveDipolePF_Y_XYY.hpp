#ifndef PrimitiveDipolePF_Y_XYY
#define PrimitiveDipolePF_Y_XYY
...
/**
 Evaluates block of primitive <P_Y|r|F_XYY> integrals.
...
*/
auto compPrimitiveDipolePF_Y_XYY(TDoubleArray&       buffer_x,
