#ifndef PrimitiveDipoleFF_XXY_YZZ
#define PrimitiveDipoleFF_XXY_YZZ
...
/**
 Evaluates block of primitive <F_XXY|r|F_YZZ> integrals.
...
*/
auto compPrimitiveDipoleFF_XXY_YZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XXY_YZZ */
