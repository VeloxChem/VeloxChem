#ifndef PrimitiveDipoleDG_YZ_XYYY
#define PrimitiveDipoleDG_YZ_XYYY
...
/**
 Evaluates block of primitive <D_YZ|r|G_XYYY> integrals.
...
*/
auto compPrimitiveDipoleDG_YZ_XYYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YZ_XYYY */
