#ifndef PrimitiveDipoleDG_YZ_XYYZ
#define PrimitiveDipoleDG_YZ_XYYZ
...
/**
 Evaluates block of primitive <D_YZ|r|G_XYYZ> integrals.
...
*/
auto compPrimitiveDipoleDG_YZ_XYYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YZ_XYYZ */
