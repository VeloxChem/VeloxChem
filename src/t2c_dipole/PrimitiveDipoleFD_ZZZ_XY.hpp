#ifndef PrimitiveDipoleFD_ZZZ_XY
#define PrimitiveDipoleFD_ZZZ_XY
...
/**
 Evaluates block of primitive <F_ZZZ|r|D_XY> integrals.
...
*/
auto compPrimitiveDipoleFD_ZZZ_XY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_ZZZ_XY */
