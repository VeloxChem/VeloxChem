#ifndef PrimitiveDipoleFD_ZZZ_ZZ
#define PrimitiveDipoleFD_ZZZ_ZZ
...
/**
 Evaluates block of primitive <F_ZZZ|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipoleFD_ZZZ_ZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_ZZZ_ZZ */
