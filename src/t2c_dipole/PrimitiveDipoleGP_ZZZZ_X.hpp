#ifndef PrimitiveDipoleGP_ZZZZ_X
#define PrimitiveDipoleGP_ZZZZ_X
...
/**
 Evaluates block of primitive <G_ZZZZ|r|P_X> integrals.
...
*/
auto compPrimitiveDipoleGP_ZZZZ_X(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_ZZZZ_X */
