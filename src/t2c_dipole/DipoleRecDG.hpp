#ifndef DipoleRecDG_hpp
#define DipoleRecDG_hpp
...
/**
 Evaluates <D|r|G>  integrals for given pair of GTOs blocks.
...
*/
auto compDipoleDG(CSubMatrix*      matrix_x,
                  CSubMatrix*      matrix_y,
                  CSubMatrix*      matrix_z,
