#ifndef PrimitiveDipoleFD_XYY_YY
#define PrimitiveDipoleFD_XYY_YY
...
/**
 Evaluates block of primitive <F_XYY|r|D_YY> integrals.
...
*/
auto compPrimitiveDipoleFD_XYY_YY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_XYY_YY */
