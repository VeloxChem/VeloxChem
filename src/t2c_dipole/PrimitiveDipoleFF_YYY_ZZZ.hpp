#ifndef PrimitiveDipoleFF_YYY_ZZZ
#define PrimitiveDipoleFF_YYY_ZZZ
...
/**
 Evaluates block of primitive <F_YYY|r|F_ZZZ> integrals.
...
*/
auto compPrimitiveDipoleFF_YYY_ZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_YYY_ZZZ */
