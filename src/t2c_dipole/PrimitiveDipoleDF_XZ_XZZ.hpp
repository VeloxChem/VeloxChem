#ifndef PrimitiveDipoleDF_XZ_XZZ
#define PrimitiveDipoleDF_XZ_XZZ
...
/**
 Evaluates block of primitive <D_XZ|r|F_XZZ> integrals.
...
*/
auto compPrimitiveDipoleDF_XZ_XZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_XZ_XZZ */
