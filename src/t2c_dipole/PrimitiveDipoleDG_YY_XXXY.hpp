#ifndef PrimitiveDipoleDG_YY_XXXY
#define PrimitiveDipoleDG_YY_XXXY
...
/**
 Evaluates block of primitive <D_YY|r|G_XXXY> integrals.
...
*/
auto compPrimitiveDipoleDG_YY_XXXY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YY_XXXY */
