#ifndef PrimitiveDipoleDD_XX_XZ
#define PrimitiveDipoleDD_XX_XZ
...
/**
 Evaluates block of primitive <D_XX|r|D_XZ> integrals.
...
*/
auto compPrimitiveDipoleDD_XX_XZ(TDoubleArray&       buffer_x,
