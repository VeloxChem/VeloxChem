#ifndef PrimitiveDipoleFF_XYY_XXY
#define PrimitiveDipoleFF_XYY_XXY
...
/**
 Evaluates block of primitive <F_XYY|r|F_XXY> integrals.
...
*/
auto compPrimitiveDipoleFF_XYY_XXY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XYY_XXY */
