#ifndef PrimitiveDipoleDP_ZZ_Z
#define PrimitiveDipoleDP_ZZ_Z
...
/**
 Evaluates block of primitive <D_ZZ|r|P_Z> integrals.
...
*/
auto compPrimitiveDipoleDP_ZZ_Z(TDoubleArray&       buffer_x,
