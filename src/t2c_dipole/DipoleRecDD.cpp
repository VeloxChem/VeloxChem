        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_XX_XX(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_XX_XY(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_XX_XZ(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_XX_YY(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_XX_YZ(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_XX_ZZ(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_XY_XX(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_XY_XY(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_XY_XZ(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_XY_YY(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_XY_YZ(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_XY_ZZ(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_XZ_XX(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_XZ_XY(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_XZ_XZ(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_XZ_YY(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_XZ_YZ(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_XZ_ZZ(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_YY_XX(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_YY_XY(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_YY_XZ(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_YY_YY(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_YY_YZ(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_YY_ZZ(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_YZ_XX(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_YZ_XY(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_YZ_XZ(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_YZ_YY(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_YZ_YZ(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_YZ_ZZ(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_ZZ_XX(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_ZZ_XY(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_ZZ_XZ(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_ZZ_YY(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_ZZ_YZ(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleDD_ZZ_ZZ(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
