#ifndef PrimitiveDipoleDD_XX_ZZ
#define PrimitiveDipoleDD_XX_ZZ
...
/**
 Evaluates block of primitive <D_XX|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipoleDD_XX_ZZ(TDoubleArray&       buffer_x,
