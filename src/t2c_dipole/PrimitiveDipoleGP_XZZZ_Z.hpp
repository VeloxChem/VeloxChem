#ifndef PrimitiveDipoleGP_XZZZ_Z
#define PrimitiveDipoleGP_XZZZ_Z
...
/**
 Evaluates block of primitive <G_XZZZ|r|P_Z> integrals.
...
*/
auto compPrimitiveDipoleGP_XZZZ_Z(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XZZZ_Z */
