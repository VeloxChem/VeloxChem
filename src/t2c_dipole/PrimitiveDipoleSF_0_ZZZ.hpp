#ifndef PrimitiveDipoleSF_0_ZZZ
#define PrimitiveDipoleSF_0_ZZZ
...
/**
 Evaluates block of primitive <S_0|r|F_ZZZ> integrals.
...
*/
auto compPrimitiveDipoleSF_0_ZZZ(TDoubleArray&       buffer_x,
