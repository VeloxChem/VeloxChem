#ifndef PrimitiveDipolePF_X_XXY
#define PrimitiveDipolePF_X_XXY
...
/**
 Evaluates block of primitive <P_X|r|F_XXY> integrals.
...
*/
auto compPrimitiveDipolePF_X_XXY(TDoubleArray&       buffer_x,
