#ifndef PrimitiveDipolePP_Y_Z
#define PrimitiveDipolePP_Y_Z
...
/**
 Evaluates block of primitive <P_Y|r|P_Z> integrals.
...
*/
auto compPrimitiveDipolePP_Y_Z(TDoubleArray&       buffer_x,
