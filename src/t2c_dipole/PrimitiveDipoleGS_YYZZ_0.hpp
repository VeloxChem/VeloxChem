#ifndef PrimitiveDipoleGS_YYZZ_0
#define PrimitiveDipoleGS_YYZZ_0
...
/**
 Evaluates block of primitive <G_YYZZ|r|S_0> integrals.
...
*/
auto compPrimitiveDipoleGS_YYZZ_0(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGS_YYZZ_0 */
