#ifndef PrimitiveDipoleDD_YY_XZ
#define PrimitiveDipoleDD_YY_XZ
...
/**
 Evaluates block of primitive <D_YY|r|D_XZ> integrals.
...
*/
auto compPrimitiveDipoleDD_YY_XZ(TDoubleArray&       buffer_x,
