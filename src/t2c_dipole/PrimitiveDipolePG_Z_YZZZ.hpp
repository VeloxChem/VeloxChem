#ifndef PrimitiveDipolePG_Z_YZZZ
#define PrimitiveDipolePG_Z_YZZZ
...
/**
 Evaluates block of primitive <P_Z|r|G_YZZZ> integrals.
...
*/
auto compPrimitiveDipolePG_Z_YZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Z_YZZZ */
