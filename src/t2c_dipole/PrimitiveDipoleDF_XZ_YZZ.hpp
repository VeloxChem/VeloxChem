#ifndef PrimitiveDipoleDF_XZ_YZZ
#define PrimitiveDipoleDF_XZ_YZZ
...
/**
 Evaluates block of primitive <D_XZ|r|F_YZZ> integrals.
...
*/
auto compPrimitiveDipoleDF_XZ_YZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_XZ_YZZ */
