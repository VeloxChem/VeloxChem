#ifndef PrimitiveDipoleDG_XZ_XXXX
#define PrimitiveDipoleDG_XZ_XXXX
...
/**
 Evaluates block of primitive <D_XZ|r|G_XXXX> integrals.
...
*/
auto compPrimitiveDipoleDG_XZ_XXXX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XZ_XXXX */
