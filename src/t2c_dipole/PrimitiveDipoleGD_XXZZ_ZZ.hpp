#ifndef PrimitiveDipoleGD_XXZZ_ZZ
#define PrimitiveDipoleGD_XXZZ_ZZ
...
/**
 Evaluates block of primitive <G_XXZZ|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XXZZ_ZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXZZ_ZZ */
