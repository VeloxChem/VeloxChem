#ifndef PrimitiveDipoleFP_XXY_Y
#define PrimitiveDipoleFP_XXY_Y
...
/**
 Evaluates block of primitive <F_XXY|r|P_Y> integrals.
...
*/
auto compPrimitiveDipoleFP_XXY_Y(TDoubleArray&       buffer_x,
