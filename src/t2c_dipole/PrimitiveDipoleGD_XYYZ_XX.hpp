#ifndef PrimitiveDipoleGD_XYYZ_XX
#define PrimitiveDipoleGD_XYYZ_XX
...
/**
 Evaluates block of primitive <G_XYYZ|r|D_XX> integrals.
...
*/
auto compPrimitiveDipoleGD_XYYZ_XX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XYYZ_XX */
