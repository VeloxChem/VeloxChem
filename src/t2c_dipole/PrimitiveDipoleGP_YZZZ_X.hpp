#ifndef PrimitiveDipoleGP_YZZZ_X
#define PrimitiveDipoleGP_YZZZ_X
...
/**
 Evaluates block of primitive <G_YZZZ|r|P_X> integrals.
...
*/
auto compPrimitiveDipoleGP_YZZZ_X(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_YZZZ_X */
