#ifndef PrimitiveDipoleGP_XXXX_X
#define PrimitiveDipoleGP_XXXX_X
...
/**
 Evaluates block of primitive <G_XXXX|r|P_X> integrals.
...
*/
auto compPrimitiveDipoleGP_XXXX_X(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XXXX_X */
