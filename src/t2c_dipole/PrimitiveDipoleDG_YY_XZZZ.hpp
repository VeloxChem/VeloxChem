#ifndef PrimitiveDipoleDG_YY_XZZZ
#define PrimitiveDipoleDG_YY_XZZZ
...
/**
 Evaluates block of primitive <D_YY|r|G_XZZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_YY_XZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YY_XZZZ */
