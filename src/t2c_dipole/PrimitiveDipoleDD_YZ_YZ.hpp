#ifndef PrimitiveDipoleDD_YZ_YZ
#define PrimitiveDipoleDD_YZ_YZ
...
/**
 Evaluates block of primitive <D_YZ|r|D_YZ> integrals.
...
*/
auto compPrimitiveDipoleDD_YZ_YZ(TDoubleArray&       buffer_x,
