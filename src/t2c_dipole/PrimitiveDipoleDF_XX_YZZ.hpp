#ifndef PrimitiveDipoleDF_XX_YZZ
#define PrimitiveDipoleDF_XX_YZZ
...
/**
 Evaluates block of primitive <D_XX|r|F_YZZ> integrals.
...
*/
auto compPrimitiveDipoleDF_XX_YZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_XX_YZZ */
