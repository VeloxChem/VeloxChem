#ifndef PrimitiveDipoleDS_YY_0
#define PrimitiveDipoleDS_YY_0
...
/**
 Evaluates block of primitive <D_YY|r|S_0> integrals.
...
*/
auto compPrimitiveDipoleDS_YY_0(TDoubleArray&       buffer_x,
