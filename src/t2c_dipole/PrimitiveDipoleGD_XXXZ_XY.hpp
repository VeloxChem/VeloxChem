#ifndef PrimitiveDipoleGD_XXXZ_XY
#define PrimitiveDipoleGD_XXXZ_XY
...
/**
 Evaluates block of primitive <G_XXXZ|r|D_XY> integrals.
...
*/
auto compPrimitiveDipoleGD_XXXZ_XY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXXZ_XY */
