#ifndef PrimitiveDipoleDG_XY_YYYY
#define PrimitiveDipoleDG_XY_YYYY
...
/**
 Evaluates block of primitive <D_XY|r|G_YYYY> integrals.
...
*/
auto compPrimitiveDipoleDG_XY_YYYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XY_YYYY */
