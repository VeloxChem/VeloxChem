#ifndef PrimitiveDipoleDG_YZ_XXXY
#define PrimitiveDipoleDG_YZ_XXXY
...
/**
 Evaluates block of primitive <D_YZ|r|G_XXXY> integrals.
...
*/
auto compPrimitiveDipoleDG_YZ_XXXY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YZ_XXXY */
