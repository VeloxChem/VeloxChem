#ifndef PrimitiveDipoleFF_ZZZ_XXX
#define PrimitiveDipoleFF_ZZZ_XXX
...
/**
 Evaluates block of primitive <F_ZZZ|r|F_XXX> integrals.
...
*/
auto compPrimitiveDipoleFF_ZZZ_XXX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_ZZZ_XXX */
