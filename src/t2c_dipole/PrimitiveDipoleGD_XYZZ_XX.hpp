#ifndef PrimitiveDipoleGD_XYZZ_XX
#define PrimitiveDipoleGD_XYZZ_XX
...
/**
 Evaluates block of primitive <G_XYZZ|r|D_XX> integrals.
...
*/
auto compPrimitiveDipoleGD_XYZZ_XX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XYZZ_XX */
