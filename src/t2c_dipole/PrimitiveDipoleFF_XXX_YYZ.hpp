#ifndef PrimitiveDipoleFF_XXX_YYZ
#define PrimitiveDipoleFF_XXX_YYZ
...
/**
 Evaluates block of primitive <F_XXX|r|F_YYZ> integrals.
...
*/
auto compPrimitiveDipoleFF_XXX_YYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XXX_YYZ */
