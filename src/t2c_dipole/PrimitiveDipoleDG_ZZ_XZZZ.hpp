#ifndef PrimitiveDipoleDG_ZZ_XZZZ
#define PrimitiveDipoleDG_ZZ_XZZZ
...
/**
 Evaluates block of primitive <D_ZZ|r|G_XZZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_ZZ_XZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_ZZ_XZZZ */
