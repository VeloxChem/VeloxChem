#ifndef PrimitiveDipoleDG_XX_YYYZ
#define PrimitiveDipoleDG_XX_YYYZ
...
/**
 Evaluates block of primitive <D_XX|r|G_YYYZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XX_YYYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XX_YYYZ */
