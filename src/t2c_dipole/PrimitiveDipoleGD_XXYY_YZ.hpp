#ifndef PrimitiveDipoleGD_XXYY_YZ
#define PrimitiveDipoleGD_XXYY_YZ
...
/**
 Evaluates block of primitive <G_XXYY|r|D_YZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XXYY_YZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXYY_YZ */
