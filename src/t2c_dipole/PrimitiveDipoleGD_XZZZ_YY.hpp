#ifndef PrimitiveDipoleGD_XZZZ_YY
#define PrimitiveDipoleGD_XZZZ_YY
...
/**
 Evaluates block of primitive <G_XZZZ|r|D_YY> integrals.
...
*/
auto compPrimitiveDipoleGD_XZZZ_YY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XZZZ_YY */
