#ifndef PrimitiveDipoleFS_XXX_0
#define PrimitiveDipoleFS_XXX_0
...
/**
 Evaluates block of primitive <F_XXX|r|S_0> integrals.
...
*/
auto compPrimitiveDipoleFS_XXX_0(TDoubleArray&       buffer_x,
