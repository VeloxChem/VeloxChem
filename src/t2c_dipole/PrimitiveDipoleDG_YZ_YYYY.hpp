#ifndef PrimitiveDipoleDG_YZ_YYYY
#define PrimitiveDipoleDG_YZ_YYYY
...
/**
 Evaluates block of primitive <D_YZ|r|G_YYYY> integrals.
...
*/
auto compPrimitiveDipoleDG_YZ_YYYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YZ_YYYY */
