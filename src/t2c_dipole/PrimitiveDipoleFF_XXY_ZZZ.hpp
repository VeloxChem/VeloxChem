#ifndef PrimitiveDipoleFF_XXY_ZZZ
#define PrimitiveDipoleFF_XXY_ZZZ
...
/**
 Evaluates block of primitive <F_XXY|r|F_ZZZ> integrals.
...
*/
auto compPrimitiveDipoleFF_XXY_ZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XXY_ZZZ */
