#ifndef PrimitiveDipoleSD_0_XX
#define PrimitiveDipoleSD_0_XX
...
/**
 Evaluates block of primitive <S_0|r|D_XX> integrals.
...
*/
auto compPrimitiveDipoleSD_0_XX(TDoubleArray&       buffer_x,
