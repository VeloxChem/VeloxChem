#ifndef PrimitiveDipoleGD_XXXY_ZZ
#define PrimitiveDipoleGD_XXXY_ZZ
...
/**
 Evaluates block of primitive <G_XXXY|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XXXY_ZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXXY_ZZ */
