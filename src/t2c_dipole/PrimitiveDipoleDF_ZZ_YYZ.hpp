#ifndef PrimitiveDipoleDF_ZZ_YYZ
#define PrimitiveDipoleDF_ZZ_YYZ
...
/**
 Evaluates block of primitive <D_ZZ|r|F_YYZ> integrals.
...
*/
auto compPrimitiveDipoleDF_ZZ_YYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_ZZ_YYZ */
