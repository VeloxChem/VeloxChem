#ifndef PrimitiveDipolePD_Z_YY
#define PrimitiveDipolePD_Z_YY
...
/**
 Evaluates block of primitive <P_Z|r|D_YY> integrals.
...
*/
auto compPrimitiveDipolePD_Z_YY(TDoubleArray&       buffer_x,
