#ifndef PrimitiveDipoleFF_XYZ_XYZ
#define PrimitiveDipoleFF_XYZ_XYZ
...
/**
 Evaluates block of primitive <F_XYZ|r|F_XYZ> integrals.
...
*/
auto compPrimitiveDipoleFF_XYZ_XYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XYZ_XYZ */
