#ifndef PrimitiveDipoleGP_YZZZ_Z
#define PrimitiveDipoleGP_YZZZ_Z
...
/**
 Evaluates block of primitive <G_YZZZ|r|P_Z> integrals.
...
*/
auto compPrimitiveDipoleGP_YZZZ_Z(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_YZZZ_Z */
