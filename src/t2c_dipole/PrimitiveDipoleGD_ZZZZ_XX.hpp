#ifndef PrimitiveDipoleGD_ZZZZ_XX
#define PrimitiveDipoleGD_ZZZZ_XX
...
/**
 Evaluates block of primitive <G_ZZZZ|r|D_XX> integrals.
...
*/
auto compPrimitiveDipoleGD_ZZZZ_XX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_ZZZZ_XX */
