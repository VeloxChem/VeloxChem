#ifndef PrimitiveDipoleSP_0_X
#define PrimitiveDipoleSP_0_X
...
/**
 Evaluates block of primitive <S_0|r|P_X> integrals.
...
*/
auto compPrimitiveDipoleSP_0_X(TDoubleArray&       buffer_x,
