#ifndef PrimitiveDipoleDG_XY_XZZZ
#define PrimitiveDipoleDG_XY_XZZZ
...
/**
 Evaluates block of primitive <D_XY|r|G_XZZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XY_XZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XY_XZZZ */
