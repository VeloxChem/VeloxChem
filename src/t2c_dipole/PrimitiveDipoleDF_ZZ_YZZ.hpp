#ifndef PrimitiveDipoleDF_ZZ_YZZ
#define PrimitiveDipoleDF_ZZ_YZZ
...
/**
 Evaluates block of primitive <D_ZZ|r|F_YZZ> integrals.
...
*/
auto compPrimitiveDipoleDF_ZZ_YZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_ZZ_YZZ */
