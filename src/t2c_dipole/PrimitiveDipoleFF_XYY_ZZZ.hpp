#ifndef PrimitiveDipoleFF_XYY_ZZZ
#define PrimitiveDipoleFF_XYY_ZZZ
...
/**
 Evaluates block of primitive <F_XYY|r|F_ZZZ> integrals.
...
*/
auto compPrimitiveDipoleFF_XYY_ZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XYY_ZZZ */
