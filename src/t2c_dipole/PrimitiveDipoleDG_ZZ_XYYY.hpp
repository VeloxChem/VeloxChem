#ifndef PrimitiveDipoleDG_ZZ_XYYY
#define PrimitiveDipoleDG_ZZ_XYYY
...
/**
 Evaluates block of primitive <D_ZZ|r|G_XYYY> integrals.
...
*/
auto compPrimitiveDipoleDG_ZZ_XYYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_ZZ_XYYY */
