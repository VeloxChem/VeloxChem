#ifndef PrimitiveDipoleDD_ZZ_YZ
#define PrimitiveDipoleDD_ZZ_YZ
...
/**
 Evaluates block of primitive <D_ZZ|r|D_YZ> integrals.
...
*/
auto compPrimitiveDipoleDD_ZZ_YZ(TDoubleArray&       buffer_x,
