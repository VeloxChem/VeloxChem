#ifndef PrimitiveDipoleFD_YYZ_YY
#define PrimitiveDipoleFD_YYZ_YY
...
/**
 Evaluates block of primitive <F_YYZ|r|D_YY> integrals.
...
*/
auto compPrimitiveDipoleFD_YYZ_YY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_YYZ_YY */
