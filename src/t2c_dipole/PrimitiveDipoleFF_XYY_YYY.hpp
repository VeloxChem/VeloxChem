#ifndef PrimitiveDipoleFF_XYY_YYY
#define PrimitiveDipoleFF_XYY_YYY
...
/**
 Evaluates block of primitive <F_XYY|r|F_YYY> integrals.
...
*/
auto compPrimitiveDipoleFF_XYY_YYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XYY_YYY */
