#ifndef PrimitiveDipoleDG_YY_YYZZ
#define PrimitiveDipoleDG_YY_YYZZ
...
/**
 Evaluates block of primitive <D_YY|r|G_YYZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_YY_YYZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YY_YYZZ */
