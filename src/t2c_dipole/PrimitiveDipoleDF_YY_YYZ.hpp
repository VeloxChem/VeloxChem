#ifndef PrimitiveDipoleDF_YY_YYZ
#define PrimitiveDipoleDF_YY_YYZ
...
/**
 Evaluates block of primitive <D_YY|r|F_YYZ> integrals.
...
*/
auto compPrimitiveDipoleDF_YY_YYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_YY_YYZ */
