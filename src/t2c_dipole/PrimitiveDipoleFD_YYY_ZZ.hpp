#ifndef PrimitiveDipoleFD_YYY_ZZ
#define PrimitiveDipoleFD_YYY_ZZ
...
/**
 Evaluates block of primitive <F_YYY|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipoleFD_YYY_ZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_YYY_ZZ */
