#ifndef PrimitiveDipoleFD_XXZ_YY
#define PrimitiveDipoleFD_XXZ_YY
...
/**
 Evaluates block of primitive <F_XXZ|r|D_YY> integrals.
...
*/
auto compPrimitiveDipoleFD_XXZ_YY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_XXZ_YY */
