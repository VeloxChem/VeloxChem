#ifndef DipoleRecGD_hpp
#define DipoleRecGD_hpp
...
/**
 Evaluates <G|r|D>  integrals for given pair of GTOs blocks.
...
*/
auto compDipoleGD(CSubMatrix*      matrix_x,
                  CSubMatrix*      matrix_y,
                  CSubMatrix*      matrix_z,
