#ifndef PrimitiveDipoleFP_YYY_Y
#define PrimitiveDipoleFP_YYY_Y
...
/**
 Evaluates block of primitive <F_YYY|r|P_Y> integrals.
...
*/
auto compPrimitiveDipoleFP_YYY_Y(TDoubleArray&       buffer_x,
