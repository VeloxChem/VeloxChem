#ifndef PrimitiveDipoleGP_XXYY_X
#define PrimitiveDipoleGP_XXYY_X
...
/**
 Evaluates block of primitive <G_XXYY|r|P_X> integrals.
...
*/
auto compPrimitiveDipoleGP_XXYY_X(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XXYY_X */
