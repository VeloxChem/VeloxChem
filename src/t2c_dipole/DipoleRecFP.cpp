...
#include "PrimitiveDipoleFP_XXZ_X.hpp"
#include "PrimitiveDipoleFP_XXZ_Y.hpp"
#include "PrimitiveDipoleFP_XXZ_Z.hpp"
#include "PrimitiveDipoleFP_XYY_X.hpp"
#include "PrimitiveDipoleFP_XYY_Y.hpp"
#include "PrimitiveDipoleFP_XYY_Z.hpp"
...
#include "PrimitiveDipoleFP_XZZ_Z.hpp"
...
#include "PrimitiveDipoleFP_YYZ_Y.hpp"
#include "PrimitiveDipoleFP_YYZ_Z.hpp"
#include "PrimitiveDipoleFP_YZZ_X.hpp"
#include "PrimitiveDipoleFP_YZZ_Y.hpp"
#include "PrimitiveDipoleFP_YZZ_Z.hpp"
#include "PrimitiveDipoleFP_ZZZ_X.hpp"
#include "PrimitiveDipoleFP_ZZZ_Y.hpp"
#include "PrimitiveDipoleFP_ZZZ_Z.hpp"
#include "T2CDistributor.hpp"

namespace diprec {  // diprec namespace

auto
compDipoleFP(CSubMatrix*      matrix_x,
             CSubMatrix*      matrix_y,
             CSubMatrix*      matrix_z,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_XXX_X(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_XXX_Y(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_XXX_Z(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_XXY_X(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_XXY_Y(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_XXY_Z(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_XXZ_X(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_XXZ_Y(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_XXZ_Z(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_XYY_X(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_XYY_Y(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_XYY_Z(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_XYZ_X(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_XYZ_Y(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_XYZ_Z(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_XZZ_X(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_XZZ_Y(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_XZZ_Z(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_YYY_X(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_YYY_Y(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_YYY_Z(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_YYZ_X(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_YYZ_Y(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_YYZ_Z(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_YZZ_X(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_YZZ_Y(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_YZZ_Z(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_ZZZ_X(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_ZZZ_Y(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleFP_ZZZ_Z(buffer_x,
                                                        buffer_y,
                                                        buffer_z,
                                                        point,
                                                        bra_exp,
