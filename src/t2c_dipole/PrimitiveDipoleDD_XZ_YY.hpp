#ifndef PrimitiveDipoleDD_XZ_YY
#define PrimitiveDipoleDD_XZ_YY
...
/**
 Evaluates block of primitive <D_XZ|r|D_YY> integrals.
...
*/
auto compPrimitiveDipoleDD_XZ_YY(TDoubleArray&       buffer_x,
