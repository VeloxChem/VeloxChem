#ifndef PrimitiveDipolePG_Y_XYYY
#define PrimitiveDipolePG_Y_XYYY
...
/**
 Evaluates block of primitive <P_Y|r|G_XYYY> integrals.
...
*/
auto compPrimitiveDipolePG_Y_XYYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Y_XYYY */
