#ifndef PrimitiveDipoleFD_YZZ_XZ
#define PrimitiveDipoleFD_YZZ_XZ
...
/**
 Evaluates block of primitive <F_YZZ|r|D_XZ> integrals.
...
*/
auto compPrimitiveDipoleFD_YZZ_XZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_YZZ_XZ */
