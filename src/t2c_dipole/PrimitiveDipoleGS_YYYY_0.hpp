#ifndef PrimitiveDipoleGS_YYYY_0
#define PrimitiveDipoleGS_YYYY_0
...
/**
 Evaluates block of primitive <G_YYYY|r|S_0> integrals.
...
*/
auto compPrimitiveDipoleGS_YYYY_0(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGS_YYYY_0 */
