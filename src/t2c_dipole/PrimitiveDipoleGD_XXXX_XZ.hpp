#ifndef PrimitiveDipoleGD_XXXX_XZ
#define PrimitiveDipoleGD_XXXX_XZ
...
/**
 Evaluates block of primitive <G_XXXX|r|D_XZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XXXX_XZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXXX_XZ */
