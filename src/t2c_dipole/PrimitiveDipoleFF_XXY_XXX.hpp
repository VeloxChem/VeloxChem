#ifndef PrimitiveDipoleFF_XXY_XXX
#define PrimitiveDipoleFF_XXY_XXX
...
/**
 Evaluates block of primitive <F_XXY|r|F_XXX> integrals.
...
*/
auto compPrimitiveDipoleFF_XXY_XXX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XXY_XXX */
