#ifndef PrimitiveDipoleFS_YYZ_0
#define PrimitiveDipoleFS_YYZ_0
...
/**
 Evaluates block of primitive <F_YYZ|r|S_0> integrals.
...
*/
auto compPrimitiveDipoleFS_YYZ_0(TDoubleArray&       buffer_x,
