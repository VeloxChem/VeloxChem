#ifndef PrimitiveDipoleDG_YZ_ZZZZ
#define PrimitiveDipoleDG_YZ_ZZZZ
...
/**
 Evaluates block of primitive <D_YZ|r|G_ZZZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_YZ_ZZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YZ_ZZZZ */
