#ifndef PrimitiveDipoleFF_XYZ_YYZ
#define PrimitiveDipoleFF_XYZ_YYZ
...
/**
 Evaluates block of primitive <F_XYZ|r|F_YYZ> integrals.
...
*/
auto compPrimitiveDipoleFF_XYZ_YYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XYZ_YYZ */
