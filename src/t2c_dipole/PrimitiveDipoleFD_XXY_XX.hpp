#ifndef PrimitiveDipoleFD_XXY_XX
#define PrimitiveDipoleFD_XXY_XX
...
/**
 Evaluates block of primitive <F_XXY|r|D_XX> integrals.
...
*/
auto compPrimitiveDipoleFD_XXY_XX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_XXY_XX */
