#ifndef PrimitiveDipolePF_Y_YYZ
#define PrimitiveDipolePF_Y_YYZ
...
/**
 Evaluates block of primitive <P_Y|r|F_YYZ> integrals.
...
*/
auto compPrimitiveDipolePF_Y_YYZ(TDoubleArray&       buffer_x,
