#ifndef PrimitiveDipoleDG_XZ_XYYY
#define PrimitiveDipoleDG_XZ_XYYY
...
/**
 Evaluates block of primitive <D_XZ|r|G_XYYY> integrals.
...
*/
auto compPrimitiveDipoleDG_XZ_XYYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XZ_XYYY */
