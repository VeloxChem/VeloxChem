...
#include "PrimitiveDipoleSD_0_XZ.hpp"
...
auto
compDipoleSD(CSubMatrix*      matrix_x,
             CSubMatrix*      matrix_y,
             CSubMatrix*      matrix_z,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleSD_0_XX(buffer_x,
                                                       buffer_y,
                                                       buffer_z,
                                                       point,
                                                       bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleSD_0_XY(buffer_x,
                                                       buffer_y,
                                                       buffer_z,
                                                       point,
                                                       bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleSD_0_XZ(buffer_x,
                                                       buffer_y,
                                                       buffer_z,
                                                       point,
                                                       bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleSD_0_YY(buffer_x,
                                                       buffer_y,
                                                       buffer_z,
                                                       point,
                                                       bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleSD_0_YZ(buffer_x,
                                                       buffer_y,
                                                       buffer_z,
                                                       point,
                                                       bra_exp,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    diprec::compPrimitiveDipoleSD_0_ZZ(buffer_x,
                                                       buffer_y,
                                                       buffer_z,
                                                       point,
                                                       bra_exp,
