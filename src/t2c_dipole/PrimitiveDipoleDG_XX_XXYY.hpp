#ifndef PrimitiveDipoleDG_XX_XXYY
#define PrimitiveDipoleDG_XX_XXYY
...
/**
 Evaluates block of primitive <D_XX|r|G_XXYY> integrals.
...
*/
auto compPrimitiveDipoleDG_XX_XXYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XX_XXYY */
