#ifndef PrimitiveDipolePG_Y_YYYY
#define PrimitiveDipolePG_Y_YYYY
...
/**
 Evaluates block of primitive <P_Y|r|G_YYYY> integrals.
...
*/
auto compPrimitiveDipolePG_Y_YYYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Y_YYYY */
