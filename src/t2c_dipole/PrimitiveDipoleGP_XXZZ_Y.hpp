#ifndef PrimitiveDipoleGP_XXZZ_Y
#define PrimitiveDipoleGP_XXZZ_Y
...
/**
 Evaluates block of primitive <G_XXZZ|r|P_Y> integrals.
...
*/
auto compPrimitiveDipoleGP_XXZZ_Y(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XXZZ_Y */
