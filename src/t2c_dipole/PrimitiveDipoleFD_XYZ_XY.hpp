#ifndef PrimitiveDipoleFD_XYZ_XY
#define PrimitiveDipoleFD_XYZ_XY
...
/**
 Evaluates block of primitive <F_XYZ|r|D_XY> integrals.
...
*/
auto compPrimitiveDipoleFD_XYZ_XY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_XYZ_XY */
