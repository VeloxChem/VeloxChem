#ifndef PrimitiveDipoleFP_XYY_Z
#define PrimitiveDipoleFP_XYY_Z
...
/**
 Evaluates block of primitive <F_XYY|r|P_Z> integrals.
...
*/
auto compPrimitiveDipoleFP_XYY_Z(TDoubleArray&       buffer_x,
