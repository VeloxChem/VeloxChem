#ifndef PrimitiveDipolePG_X_YYZZ
#define PrimitiveDipolePG_X_YYZZ
...
/**
 Evaluates block of primitive <P_X|r|G_YYZZ> integrals.
...
*/
auto compPrimitiveDipolePG_X_YYZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_X_YYZZ */
