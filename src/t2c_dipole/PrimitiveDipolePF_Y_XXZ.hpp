#ifndef PrimitiveDipolePF_Y_XXZ
#define PrimitiveDipolePF_Y_XXZ
...
/**
 Evaluates block of primitive <P_Y|r|F_XXZ> integrals.
...
*/
auto compPrimitiveDipolePF_Y_XXZ(TDoubleArray&       buffer_x,
