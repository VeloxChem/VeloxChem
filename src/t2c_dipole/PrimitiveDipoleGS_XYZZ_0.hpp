#ifndef PrimitiveDipoleGS_XYZZ_0
#define PrimitiveDipoleGS_XYZZ_0
...
/**
 Evaluates block of primitive <G_XYZZ|r|S_0> integrals.
...
*/
auto compPrimitiveDipoleGS_XYZZ_0(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGS_XYZZ_0 */
