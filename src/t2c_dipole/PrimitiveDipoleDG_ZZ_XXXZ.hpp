#ifndef PrimitiveDipoleDG_ZZ_XXXZ
#define PrimitiveDipoleDG_ZZ_XXXZ
...
/**
 Evaluates block of primitive <D_ZZ|r|G_XXXZ> integrals.
...
*/
auto compPrimitiveDipoleDG_ZZ_XXXZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_ZZ_XXXZ */
