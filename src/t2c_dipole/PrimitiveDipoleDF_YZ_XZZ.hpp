#ifndef PrimitiveDipoleDF_YZ_XZZ
#define PrimitiveDipoleDF_YZ_XZZ
...
/**
 Evaluates block of primitive <D_YZ|r|F_XZZ> integrals.
...
*/
auto compPrimitiveDipoleDF_YZ_XZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_YZ_XZZ */
