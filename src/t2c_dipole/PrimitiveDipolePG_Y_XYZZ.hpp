#ifndef PrimitiveDipolePG_Y_XYZZ
#define PrimitiveDipolePG_Y_XYZZ
...
/**
 Evaluates block of primitive <P_Y|r|G_XYZZ> integrals.
...
*/
auto compPrimitiveDipolePG_Y_XYZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Y_XYZZ */
