#ifndef PrimitiveDipoleGD_XXXZ_XX
#define PrimitiveDipoleGD_XXXZ_XX
...
/**
 Evaluates block of primitive <G_XXXZ|r|D_XX> integrals.
...
*/
auto compPrimitiveDipoleGD_XXXZ_XX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXXZ_XX */
