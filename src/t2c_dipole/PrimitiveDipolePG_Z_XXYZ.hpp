#ifndef PrimitiveDipolePG_Z_XXYZ
#define PrimitiveDipolePG_Z_XXYZ
...
/**
 Evaluates block of primitive <P_Z|r|G_XXYZ> integrals.
...
*/
auto compPrimitiveDipolePG_Z_XXYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Z_XXYZ */
