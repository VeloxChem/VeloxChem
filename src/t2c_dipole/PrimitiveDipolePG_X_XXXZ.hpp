#ifndef PrimitiveDipolePG_X_XXXZ
#define PrimitiveDipolePG_X_XXXZ
...
/**
 Evaluates block of primitive <P_X|r|G_XXXZ> integrals.
...
*/
auto compPrimitiveDipolePG_X_XXXZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_X_XXXZ */
