#ifndef PrimitiveDipoleFF_XYY_XZZ
#define PrimitiveDipoleFF_XYY_XZZ
...
/**
 Evaluates block of primitive <F_XYY|r|F_XZZ> integrals.
...
*/
auto compPrimitiveDipoleFF_XYY_XZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XYY_XZZ */
