#ifndef PrimitiveDipoleGP_XYYY_Z
#define PrimitiveDipoleGP_XYYY_Z
...
/**
 Evaluates block of primitive <G_XYYY|r|P_Z> integrals.
...
*/
auto compPrimitiveDipoleGP_XYYY_Z(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XYYY_Z */
