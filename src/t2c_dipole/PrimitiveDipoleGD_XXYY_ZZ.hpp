#ifndef PrimitiveDipoleGD_XXYY_ZZ
#define PrimitiveDipoleGD_XXYY_ZZ
...
/**
 Evaluates block of primitive <G_XXYY|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XXYY_ZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXYY_ZZ */
