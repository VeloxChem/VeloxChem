#ifndef PrimitiveDipoleGP_ZZZZ_Z
#define PrimitiveDipoleGP_ZZZZ_Z
...
/**
 Evaluates block of primitive <G_ZZZZ|r|P_Z> integrals.
...
*/
auto compPrimitiveDipoleGP_ZZZZ_Z(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_ZZZZ_Z */
