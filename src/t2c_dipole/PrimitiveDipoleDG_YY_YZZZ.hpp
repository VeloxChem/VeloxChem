#ifndef PrimitiveDipoleDG_YY_YZZZ
#define PrimitiveDipoleDG_YY_YZZZ
...
/**
 Evaluates block of primitive <D_YY|r|G_YZZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_YY_YZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_YY_YZZZ */
