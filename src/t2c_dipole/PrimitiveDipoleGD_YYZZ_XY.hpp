#ifndef PrimitiveDipoleGD_YYZZ_XY
#define PrimitiveDipoleGD_YYZZ_XY
...
/**
 Evaluates block of primitive <G_YYZZ|r|D_XY> integrals.
...
*/
auto compPrimitiveDipoleGD_YYZZ_XY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_YYZZ_XY */
