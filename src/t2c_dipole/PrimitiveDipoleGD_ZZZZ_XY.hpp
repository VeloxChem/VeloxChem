#ifndef PrimitiveDipoleGD_ZZZZ_XY
#define PrimitiveDipoleGD_ZZZZ_XY
...
/**
 Evaluates block of primitive <G_ZZZZ|r|D_XY> integrals.
...
*/
auto compPrimitiveDipoleGD_ZZZZ_XY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_ZZZZ_XY */
