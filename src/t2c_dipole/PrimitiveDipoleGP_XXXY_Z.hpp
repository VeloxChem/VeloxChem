#ifndef PrimitiveDipoleGP_XXXY_Z
#define PrimitiveDipoleGP_XXXY_Z
...
/**
 Evaluates block of primitive <G_XXXY|r|P_Z> integrals.
...
*/
auto compPrimitiveDipoleGP_XXXY_Z(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XXXY_Z */
