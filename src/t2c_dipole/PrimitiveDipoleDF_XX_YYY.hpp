#ifndef PrimitiveDipoleDF_XX_YYY
#define PrimitiveDipoleDF_XX_YYY
...
/**
 Evaluates block of primitive <D_XX|r|F_YYY> integrals.
...
*/
auto compPrimitiveDipoleDF_XX_YYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_XX_YYY */
