#ifndef PrimitiveDipolePP_Z_Z
#define PrimitiveDipolePP_Z_Z
...
/**
 Evaluates block of primitive <P_Z|r|P_Z> integrals.
...
*/
auto compPrimitiveDipolePP_Z_Z(TDoubleArray&       buffer_x,
