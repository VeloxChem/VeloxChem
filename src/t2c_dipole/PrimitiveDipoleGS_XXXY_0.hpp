#ifndef PrimitiveDipoleGS_XXXY_0
#define PrimitiveDipoleGS_XXXY_0
...
/**
 Evaluates block of primitive <G_XXXY|r|S_0> integrals.
...
*/
auto compPrimitiveDipoleGS_XXXY_0(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGS_XXXY_0 */
