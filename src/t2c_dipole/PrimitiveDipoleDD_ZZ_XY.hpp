#ifndef PrimitiveDipoleDD_ZZ_XY
#define PrimitiveDipoleDD_ZZ_XY
...
/**
 Evaluates block of primitive <D_ZZ|r|D_XY> integrals.
...
*/
auto compPrimitiveDipoleDD_ZZ_XY(TDoubleArray&       buffer_x,
