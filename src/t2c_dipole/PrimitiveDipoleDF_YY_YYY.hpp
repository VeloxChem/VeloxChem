#ifndef PrimitiveDipoleDF_YY_YYY
#define PrimitiveDipoleDF_YY_YYY
...
/**
 Evaluates block of primitive <D_YY|r|F_YYY> integrals.
...
*/
auto compPrimitiveDipoleDF_YY_YYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_YY_YYY */
