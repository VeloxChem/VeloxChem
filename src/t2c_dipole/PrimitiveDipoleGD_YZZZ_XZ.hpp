#ifndef PrimitiveDipoleGD_YZZZ_XZ
#define PrimitiveDipoleGD_YZZZ_XZ
...
/**
 Evaluates block of primitive <G_YZZZ|r|D_XZ> integrals.
...
*/
auto compPrimitiveDipoleGD_YZZZ_XZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_YZZZ_XZ */
