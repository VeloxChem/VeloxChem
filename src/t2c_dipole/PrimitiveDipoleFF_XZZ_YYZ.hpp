#ifndef PrimitiveDipoleFF_XZZ_YYZ
#define PrimitiveDipoleFF_XZZ_YYZ
...
/**
 Evaluates block of primitive <F_XZZ|r|F_YYZ> integrals.
...
*/
auto compPrimitiveDipoleFF_XZZ_YYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XZZ_YYZ */
