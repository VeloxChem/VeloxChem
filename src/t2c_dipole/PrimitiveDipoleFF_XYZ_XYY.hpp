#ifndef PrimitiveDipoleFF_XYZ_XYY
#define PrimitiveDipoleFF_XYZ_XYY
...
/**
 Evaluates block of primitive <F_XYZ|r|F_XYY> integrals.
...
*/
auto compPrimitiveDipoleFF_XYZ_XYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XYZ_XYY */
