#ifndef PrimitiveDipoleGD_YYYZ_YZ
#define PrimitiveDipoleGD_YYYZ_YZ
...
/**
 Evaluates block of primitive <G_YYYZ|r|D_YZ> integrals.
...
*/
auto compPrimitiveDipoleGD_YYYZ_YZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_YYYZ_YZ */
