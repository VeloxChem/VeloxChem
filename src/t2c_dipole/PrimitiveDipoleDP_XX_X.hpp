#ifndef PrimitiveDipoleDP_XX_X
#define PrimitiveDipoleDP_XX_X
...
/**
 Evaluates block of primitive <D_XX|r|P_X> integrals.
...
*/
auto compPrimitiveDipoleDP_XX_X(TDoubleArray&       buffer_x,
