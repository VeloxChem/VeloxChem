#ifndef PrimitiveDipoleGP_ZZZZ_Y
#define PrimitiveDipoleGP_ZZZZ_Y
...
/**
 Evaluates block of primitive <G_ZZZZ|r|P_Y> integrals.
...
*/
auto compPrimitiveDipoleGP_ZZZZ_Y(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_ZZZZ_Y */
