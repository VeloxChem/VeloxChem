#ifndef PrimitiveDipolePF_Y_YZZ
#define PrimitiveDipolePF_Y_YZZ
...
/**
 Evaluates block of primitive <P_Y|r|F_YZZ> integrals.
...
*/
auto compPrimitiveDipolePF_Y_YZZ(TDoubleArray&       buffer_x,
