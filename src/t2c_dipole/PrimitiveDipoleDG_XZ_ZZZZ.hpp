#ifndef PrimitiveDipoleDG_XZ_ZZZZ
#define PrimitiveDipoleDG_XZ_ZZZZ
...
/**
 Evaluates block of primitive <D_XZ|r|G_ZZZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XZ_ZZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XZ_ZZZZ */
