#ifndef PrimitiveDipoleGD_XXZZ_YZ
#define PrimitiveDipoleGD_XXZZ_YZ
...
/**
 Evaluates block of primitive <G_XXZZ|r|D_YZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XXZZ_YZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXZZ_YZ */
