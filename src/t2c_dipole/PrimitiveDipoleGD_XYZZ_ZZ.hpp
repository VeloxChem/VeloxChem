#ifndef PrimitiveDipoleGD_XYZZ_ZZ
#define PrimitiveDipoleGD_XYZZ_ZZ
...
/**
 Evaluates block of primitive <G_XYZZ|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XYZZ_ZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XYZZ_ZZ */
