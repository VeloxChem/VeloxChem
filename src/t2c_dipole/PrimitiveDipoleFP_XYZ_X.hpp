#ifndef PrimitiveDipoleFP_XYZ_X
#define PrimitiveDipoleFP_XYZ_X
...
/**
 Evaluates block of primitive <F_XYZ|r|P_X> integrals.
...
*/
auto compPrimitiveDipoleFP_XYZ_X(TDoubleArray&       buffer_x,
