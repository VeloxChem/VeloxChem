#ifndef PrimitiveDipoleDG_ZZ_YYYZ
#define PrimitiveDipoleDG_ZZ_YYYZ
...
/**
 Evaluates block of primitive <D_ZZ|r|G_YYYZ> integrals.
...
*/
auto compPrimitiveDipoleDG_ZZ_YYYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_ZZ_YYYZ */
