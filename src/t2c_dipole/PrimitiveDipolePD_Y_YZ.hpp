#ifndef PrimitiveDipolePD_Y_YZ
#define PrimitiveDipolePD_Y_YZ
...
/**
 Evaluates block of primitive <P_Y|r|D_YZ> integrals.
...
*/
auto compPrimitiveDipolePD_Y_YZ(TDoubleArray&       buffer_x,
