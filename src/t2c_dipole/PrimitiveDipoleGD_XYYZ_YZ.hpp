#ifndef PrimitiveDipoleGD_XYYZ_YZ
#define PrimitiveDipoleGD_XYYZ_YZ
...
/**
 Evaluates block of primitive <G_XYYZ|r|D_YZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XYYZ_YZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XYYZ_YZ */
