#ifndef PrimitiveDipoleFD_XXX_ZZ
#define PrimitiveDipoleFD_XXX_ZZ
...
/**
 Evaluates block of primitive <F_XXX|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipoleFD_XXX_ZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_XXX_ZZ */
