#ifndef PrimitiveDipoleGP_XXYY_Z
#define PrimitiveDipoleGP_XXYY_Z
...
/**
 Evaluates block of primitive <G_XXYY|r|P_Z> integrals.
...
*/
auto compPrimitiveDipoleGP_XXYY_Z(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XXYY_Z */
