#ifndef PrimitiveDipoleFF_XZZ_YYY
#define PrimitiveDipoleFF_XZZ_YYY
...
/**
 Evaluates block of primitive <F_XZZ|r|F_YYY> integrals.
...
*/
auto compPrimitiveDipoleFF_XZZ_YYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XZZ_YYY */
