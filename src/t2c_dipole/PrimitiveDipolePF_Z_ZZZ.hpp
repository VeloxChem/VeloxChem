#ifndef PrimitiveDipolePF_Z_ZZZ
#define PrimitiveDipolePF_Z_ZZZ
...
/**
 Evaluates block of primitive <P_Z|r|F_ZZZ> integrals.
...
*/
auto compPrimitiveDipolePF_Z_ZZZ(TDoubleArray&       buffer_x,
