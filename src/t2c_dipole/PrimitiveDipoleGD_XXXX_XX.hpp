#ifndef PrimitiveDipoleGD_XXXX_XX
#define PrimitiveDipoleGD_XXXX_XX
...
/**
 Evaluates block of primitive <G_XXXX|r|D_XX> integrals.
...
*/
auto compPrimitiveDipoleGD_XXXX_XX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXXX_XX */
