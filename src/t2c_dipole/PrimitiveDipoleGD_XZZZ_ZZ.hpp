#ifndef PrimitiveDipoleGD_XZZZ_ZZ
#define PrimitiveDipoleGD_XZZZ_ZZ
...
/**
 Evaluates block of primitive <G_XZZZ|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XZZZ_ZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XZZZ_ZZ */
