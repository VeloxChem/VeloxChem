#ifndef PrimitiveDipoleDG_XY_ZZZZ
#define PrimitiveDipoleDG_XY_ZZZZ
...
/**
 Evaluates block of primitive <D_XY|r|G_ZZZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XY_ZZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XY_ZZZZ */
