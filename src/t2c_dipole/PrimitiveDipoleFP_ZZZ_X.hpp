#ifndef PrimitiveDipoleFP_ZZZ_X
#define PrimitiveDipoleFP_ZZZ_X
...
/**
 Evaluates block of primitive <F_ZZZ|r|P_X> integrals.
...
*/
auto compPrimitiveDipoleFP_ZZZ_X(TDoubleArray&       buffer_x,
