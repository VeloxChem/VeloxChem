#ifndef PrimitiveDipoleDG_ZZ_XXZZ
#define PrimitiveDipoleDG_ZZ_XXZZ
...
/**
 Evaluates block of primitive <D_ZZ|r|G_XXZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_ZZ_XXZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_ZZ_XXZZ */
