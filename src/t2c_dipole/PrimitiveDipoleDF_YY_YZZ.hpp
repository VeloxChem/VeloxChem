#ifndef PrimitiveDipoleDF_YY_YZZ
#define PrimitiveDipoleDF_YY_YZZ
...
/**
 Evaluates block of primitive <D_YY|r|F_YZZ> integrals.
...
*/
auto compPrimitiveDipoleDF_YY_YZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_YY_YZZ */
