#ifndef PrimitiveDipoleGP_XXZZ_X
#define PrimitiveDipoleGP_XXZZ_X
...
/**
 Evaluates block of primitive <G_XXZZ|r|P_X> integrals.
...
*/
auto compPrimitiveDipoleGP_XXZZ_X(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XXZZ_X */
