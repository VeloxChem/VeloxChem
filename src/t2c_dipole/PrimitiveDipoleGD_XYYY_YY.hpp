#ifndef PrimitiveDipoleGD_XYYY_YY
#define PrimitiveDipoleGD_XYYY_YY
...
/**
 Evaluates block of primitive <G_XYYY|r|D_YY> integrals.
...
*/
auto compPrimitiveDipoleGD_XYYY_YY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XYYY_YY */
