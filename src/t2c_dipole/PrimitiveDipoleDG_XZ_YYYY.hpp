#ifndef PrimitiveDipoleDG_XZ_YYYY
#define PrimitiveDipoleDG_XZ_YYYY
...
/**
 Evaluates block of primitive <D_XZ|r|G_YYYY> integrals.
...
*/
auto compPrimitiveDipoleDG_XZ_YYYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XZ_YYYY */
