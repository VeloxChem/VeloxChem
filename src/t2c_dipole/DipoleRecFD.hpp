#ifndef DipoleRecFD_hpp
#define DipoleRecFD_hpp
...
/**
 Evaluates <F|r|D>  integrals for given pair of GTOs blocks.
...
*/
auto compDipoleFD(CSubMatrix*      matrix_x,
                  CSubMatrix*      matrix_y,
                  CSubMatrix*      matrix_z,
