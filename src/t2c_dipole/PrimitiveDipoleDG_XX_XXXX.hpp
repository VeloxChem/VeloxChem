#ifndef PrimitiveDipoleDG_XX_XXXX
#define PrimitiveDipoleDG_XX_XXXX
...
/**
 Evaluates block of primitive <D_XX|r|G_XXXX> integrals.
...
*/
auto compPrimitiveDipoleDG_XX_XXXX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XX_XXXX */
