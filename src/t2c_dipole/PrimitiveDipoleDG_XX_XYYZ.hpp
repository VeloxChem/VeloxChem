#ifndef PrimitiveDipoleDG_XX_XYYZ
#define PrimitiveDipoleDG_XX_XYYZ
...
/**
 Evaluates block of primitive <D_XX|r|G_XYYZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XX_XYYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XX_XYYZ */
