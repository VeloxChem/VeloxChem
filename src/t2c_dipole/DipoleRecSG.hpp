#ifndef DipoleRecSG_hpp
#define DipoleRecSG_hpp
...
/**
 Evaluates <S|r|G>  integrals for given pair of GTOs blocks.
...
*/
auto compDipoleSG(CSubMatrix*      matrix_x,
                  CSubMatrix*      matrix_y,
                  CSubMatrix*      matrix_z,
