#ifndef PrimitiveDipoleFF_XYZ_YZZ
#define PrimitiveDipoleFF_XYZ_YZZ
...
/**
 Evaluates block of primitive <F_XYZ|r|F_YZZ> integrals.
...
*/
auto compPrimitiveDipoleFF_XYZ_YZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XYZ_YZZ */
