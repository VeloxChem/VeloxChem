#ifndef PrimitiveDipoleFF_YZZ_XXZ
#define PrimitiveDipoleFF_YZZ_XXZ
...
/**
 Evaluates block of primitive <F_YZZ|r|F_XXZ> integrals.
...
*/
auto compPrimitiveDipoleFF_YZZ_XXZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_YZZ_XXZ */
