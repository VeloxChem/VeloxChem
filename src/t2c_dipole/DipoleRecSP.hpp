#ifndef DipoleRecSP_hpp
#define DipoleRecSP_hpp
...
/**
 Evaluates <S|r|P>  integrals for given pair of GTOs blocks.
...
*/
auto compDipoleSP(CSubMatrix*      matrix_x,
                  CSubMatrix*      matrix_y,
                  CSubMatrix*      matrix_z,
