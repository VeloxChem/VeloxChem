#ifndef PrimitiveDipoleFD_YYY_YY
#define PrimitiveDipoleFD_YYY_YY
...
/**
 Evaluates block of primitive <F_YYY|r|D_YY> integrals.
...
*/
auto compPrimitiveDipoleFD_YYY_YY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_YYY_YY */
