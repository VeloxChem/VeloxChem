#ifndef PrimitiveDipoleDG_XZ_YYZZ
#define PrimitiveDipoleDG_XZ_YYZZ
...
/**
 Evaluates block of primitive <D_XZ|r|G_YYZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XZ_YYZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XZ_YYZZ */
