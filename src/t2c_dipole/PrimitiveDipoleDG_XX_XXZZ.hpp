#ifndef PrimitiveDipoleDG_XX_XXZZ
#define PrimitiveDipoleDG_XX_XXZZ
...
/**
 Evaluates block of primitive <D_XX|r|G_XXZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XX_XXZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XX_XXZZ */
