#ifndef PrimitiveDipoleDG_XX_ZZZZ
#define PrimitiveDipoleDG_XX_ZZZZ
...
/**
 Evaluates block of primitive <D_XX|r|G_ZZZZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XX_ZZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XX_ZZZZ */
