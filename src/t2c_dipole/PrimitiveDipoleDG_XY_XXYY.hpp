#ifndef PrimitiveDipoleDG_XY_XXYY
#define PrimitiveDipoleDG_XY_XXYY
...
/**
 Evaluates block of primitive <D_XY|r|G_XXYY> integrals.
...
*/
auto compPrimitiveDipoleDG_XY_XXYY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XY_XXYY */
