#ifndef PrimitiveDipolePG_Y_XZZZ
#define PrimitiveDipolePG_Y_XZZZ
...
/**
 Evaluates block of primitive <P_Y|r|G_XZZZ> integrals.
...
*/
auto compPrimitiveDipolePG_Y_XZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Y_XZZZ */
