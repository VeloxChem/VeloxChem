#ifndef PrimitiveDipoleGP_XXYZ_X
#define PrimitiveDipoleGP_XXYZ_X
...
/**
 Evaluates block of primitive <G_XXYZ|r|P_X> integrals.
...
*/
auto compPrimitiveDipoleGP_XXYZ_X(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XXYZ_X */
