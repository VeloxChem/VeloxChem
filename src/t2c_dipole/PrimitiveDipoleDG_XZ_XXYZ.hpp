#ifndef PrimitiveDipoleDG_XZ_XXYZ
#define PrimitiveDipoleDG_XZ_XXYZ
...
/**
 Evaluates block of primitive <D_XZ|r|G_XXYZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XZ_XXYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XZ_XXYZ */
