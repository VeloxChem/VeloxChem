#ifndef PrimitiveDipoleFF_XYZ_ZZZ
#define PrimitiveDipoleFF_XYZ_ZZZ
...
/**
 Evaluates block of primitive <F_XYZ|r|F_ZZZ> integrals.
...
*/
auto compPrimitiveDipoleFF_XYZ_ZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XYZ_ZZZ */
