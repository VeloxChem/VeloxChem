#ifndef PrimitiveDipoleFD_XZZ_ZZ
#define PrimitiveDipoleFD_XZZ_ZZ
...
/**
 Evaluates block of primitive <F_XZZ|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipoleFD_XZZ_ZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_XZZ_ZZ */
