#ifndef PrimitiveDipoleFP_XZZ_X
#define PrimitiveDipoleFP_XZZ_X
...
/**
 Evaluates block of primitive <F_XZZ|r|P_X> integrals.
...
*/
auto compPrimitiveDipoleFP_XZZ_X(TDoubleArray&       buffer_x,
