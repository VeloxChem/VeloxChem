#ifndef DipoleRecGF_hpp
#define DipoleRecGF_hpp
...
/**
 Evaluates <G|r|F>  integrals for given pair of GTOs blocks.
...
*/
auto compDipoleGF(CSubMatrix*      matrix_x,
                  CSubMatrix*      matrix_y,
                  CSubMatrix*      matrix_z,
