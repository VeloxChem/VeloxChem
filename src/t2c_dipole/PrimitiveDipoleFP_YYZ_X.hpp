#ifndef PrimitiveDipoleFP_YYZ_X
#define PrimitiveDipoleFP_YYZ_X
...
/**
 Evaluates block of primitive <F_YYZ|r|P_X> integrals.
...
*/
auto compPrimitiveDipoleFP_YYZ_X(TDoubleArray&       buffer_x,
