#ifndef PrimitiveDipoleDD_YY_XY
#define PrimitiveDipoleDD_YY_XY
...
/**
 Evaluates block of primitive <D_YY|r|D_XY> integrals.
...
*/
auto compPrimitiveDipoleDD_YY_XY(TDoubleArray&       buffer_x,
