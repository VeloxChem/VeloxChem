#ifndef DipoleRecFS_hpp
#define DipoleRecFS_hpp
...
/**
 Evaluates <F|r|S>  integrals for given pair of GTOs blocks.
...
*/
auto compDipoleFS(CSubMatrix*      matrix_x,
                  CSubMatrix*      matrix_y,
                  CSubMatrix*      matrix_z,
