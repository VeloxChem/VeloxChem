#ifndef PrimitiveDipoleFF_XZZ_XXZ
#define PrimitiveDipoleFF_XZZ_XXZ
...
/**
 Evaluates block of primitive <F_XZZ|r|F_XXZ> integrals.
...
*/
auto compPrimitiveDipoleFF_XZZ_XXZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XZZ_XXZ */
