#ifndef PrimitiveDipoleGD_XXYY_YY
#define PrimitiveDipoleGD_XXYY_YY
...
/**
 Evaluates block of primitive <G_XXYY|r|D_YY> integrals.
...
*/
auto compPrimitiveDipoleGD_XXYY_YY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXYY_YY */
