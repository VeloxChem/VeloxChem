#ifndef PrimitiveDipoleGP_YYYY_X
#define PrimitiveDipoleGP_YYYY_X
...
/**
 Evaluates block of primitive <G_YYYY|r|P_X> integrals.
...
*/
auto compPrimitiveDipoleGP_YYYY_X(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_YYYY_X */
