#ifndef PrimitiveDipoleGD_YYYZ_ZZ
#define PrimitiveDipoleGD_YYYZ_ZZ
...
/**
 Evaluates block of primitive <G_YYYZ|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipoleGD_YYYZ_ZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_YYYZ_ZZ */
