#ifndef PrimitiveDipoleFF_XXZ_XXZ
#define PrimitiveDipoleFF_XXZ_XXZ
...
/**
 Evaluates block of primitive <F_XXZ|r|F_XXZ> integrals.
...
*/
auto compPrimitiveDipoleFF_XXZ_XXZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_XXZ_XXZ */
