#ifndef PrimitiveDipoleDF_ZZ_XYZ
#define PrimitiveDipoleDF_ZZ_XYZ
...
/**
 Evaluates block of primitive <D_ZZ|r|F_XYZ> integrals.
...
*/
auto compPrimitiveDipoleDF_ZZ_XYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDF_ZZ_XYZ */
