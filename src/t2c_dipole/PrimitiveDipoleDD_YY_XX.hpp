#ifndef PrimitiveDipoleDD_YY_XX
#define PrimitiveDipoleDD_YY_XX
...
/**
 Evaluates block of primitive <D_YY|r|D_XX> integrals.
...
*/
auto compPrimitiveDipoleDD_YY_XX(TDoubleArray&       buffer_x,
