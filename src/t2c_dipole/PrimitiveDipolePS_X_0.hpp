#ifndef PrimitiveDipolePS_X_0
#define PrimitiveDipolePS_X_0
...
/**
 Evaluates block of primitive <P_X|r|S_0> integrals.
...
*/
auto compPrimitiveDipolePS_X_0(TDoubleArray&       buffer_x,
