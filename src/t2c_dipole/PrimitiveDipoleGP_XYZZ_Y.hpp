#ifndef PrimitiveDipoleGP_XYZZ_Y
#define PrimitiveDipoleGP_XYZZ_Y
...
/**
 Evaluates block of primitive <G_XYZZ|r|P_Y> integrals.
...
*/
auto compPrimitiveDipoleGP_XYZZ_Y(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XYZZ_Y */
