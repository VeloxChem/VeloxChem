#ifndef PrimitiveDipoleFD_YYY_XX
#define PrimitiveDipoleFD_YYY_XX
...
/**
 Evaluates block of primitive <F_YYY|r|D_XX> integrals.
...
*/
auto compPrimitiveDipoleFD_YYY_XX(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_YYY_XX */
