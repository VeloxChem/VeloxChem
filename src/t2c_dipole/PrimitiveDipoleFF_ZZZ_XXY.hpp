#ifndef PrimitiveDipoleFF_ZZZ_XXY
#define PrimitiveDipoleFF_ZZZ_XXY
...
/**
 Evaluates block of primitive <F_ZZZ|r|F_XXY> integrals.
...
*/
auto compPrimitiveDipoleFF_ZZZ_XXY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_ZZZ_XXY */
