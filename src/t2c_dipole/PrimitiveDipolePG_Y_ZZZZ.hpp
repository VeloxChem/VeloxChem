#ifndef PrimitiveDipolePG_Y_ZZZZ
#define PrimitiveDipolePG_Y_ZZZZ
...
/**
 Evaluates block of primitive <P_Y|r|G_ZZZZ> integrals.
...
*/
auto compPrimitiveDipolePG_Y_ZZZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Y_ZZZZ */
