#ifndef PrimitiveDipolePG_X_XYYZ
#define PrimitiveDipolePG_X_XYYZ
...
/**
 Evaluates block of primitive <P_X|r|G_XYYZ> integrals.
...
*/
auto compPrimitiveDipolePG_X_XYYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_X_XYYZ */
