#ifndef PrimitiveDipoleGD_XXXZ_YZ
#define PrimitiveDipoleGD_XXXZ_YZ
...
/**
 Evaluates block of primitive <G_XXXZ|r|D_YZ> integrals.
...
*/
auto compPrimitiveDipoleGD_XXXZ_YZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGD_XXXZ_YZ */
