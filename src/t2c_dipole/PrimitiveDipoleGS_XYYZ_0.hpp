#ifndef PrimitiveDipoleGS_XYYZ_0
#define PrimitiveDipoleGS_XYYZ_0
...
/**
 Evaluates block of primitive <G_XYYZ|r|S_0> integrals.
...
*/
auto compPrimitiveDipoleGS_XYYZ_0(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGS_XYYZ_0 */
