#ifndef PrimitiveDipoleGS_ZZZZ_0
#define PrimitiveDipoleGS_ZZZZ_0
...
/**
 Evaluates block of primitive <G_ZZZZ|r|S_0> integrals.
...
*/
auto compPrimitiveDipoleGS_ZZZZ_0(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGS_ZZZZ_0 */
