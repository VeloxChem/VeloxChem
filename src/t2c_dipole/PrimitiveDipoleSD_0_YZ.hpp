#ifndef PrimitiveDipoleSD_0_YZ
#define PrimitiveDipoleSD_0_YZ
...
/**
 Evaluates block of primitive <S_0|r|D_YZ> integrals.
...
*/
auto compPrimitiveDipoleSD_0_YZ(TDoubleArray&       buffer_x,
