#ifndef PrimitiveDipoleGP_YYYZ_Z
#define PrimitiveDipoleGP_YYYZ_Z
...
/**
 Evaluates block of primitive <G_YYYZ|r|P_Z> integrals.
...
*/
auto compPrimitiveDipoleGP_YYYZ_Z(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_YYYZ_Z */
