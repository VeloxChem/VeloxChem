#ifndef PrimitiveDipoleDG_XY_YYYZ
#define PrimitiveDipoleDG_XY_YYYZ
...
/**
 Evaluates block of primitive <D_XY|r|G_YYYZ> integrals.
...
*/
auto compPrimitiveDipoleDG_XY_YYYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleDG_XY_YYYZ */
