#ifndef PrimitiveDipolePG_Y_XXYZ
#define PrimitiveDipolePG_Y_XXYZ
...
/**
 Evaluates block of primitive <P_Y|r|G_XXYZ> integrals.
...
*/
auto compPrimitiveDipolePG_Y_XXYZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipolePG_Y_XXYZ */
