#ifndef PrimitiveDipoleFD_XYY_ZZ
#define PrimitiveDipoleFD_XYY_ZZ
...
/**
 Evaluates block of primitive <F_XYY|r|D_ZZ> integrals.
...
*/
auto compPrimitiveDipoleFD_XYY_ZZ(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFD_XYY_ZZ */
