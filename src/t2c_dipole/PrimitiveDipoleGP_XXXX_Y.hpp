#ifndef PrimitiveDipoleGP_XXXX_Y
#define PrimitiveDipoleGP_XXXX_Y
...
/**
 Evaluates block of primitive <G_XXXX|r|P_Y> integrals.
...
*/
auto compPrimitiveDipoleGP_XXXX_Y(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleGP_XXXX_Y */
