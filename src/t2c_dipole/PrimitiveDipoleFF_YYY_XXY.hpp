#ifndef PrimitiveDipoleFF_YYY_XXY
#define PrimitiveDipoleFF_YYY_XXY
...
/**
 Evaluates block of primitive <F_YYY|r|F_XXY> integrals.
...
*/
auto compPrimitiveDipoleFF_YYY_XXY(TDoubleArray&       buffer_x,
...
#endif /* PrimitiveDipoleFF_YYY_XXY */
