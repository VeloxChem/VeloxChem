#ifndef OverlapGeom100RecFG_hpp
#define OverlapGeom100RecFG_hpp
...
/// @brief Computes (d^(1)/dA^(1)F|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_overlap_geom_10_fg(T& distributor,
