#ifndef OverlapGeom200RecSG_hpp
#define OverlapGeom200RecSG_hpp
...
/// @brief Computes (d^(2)/dA^(2)S|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_overlap_geom_20_sg(T& distributor,
