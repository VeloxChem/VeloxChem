#ifndef OverlapGeom100RecPP_hpp
#define OverlapGeom100RecPP_hpp
...
/// @brief Computes (d^(1)/dA^(1)P|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_overlap_geom_10_pp(T& distributor,
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                ovlrec::comp_prim_overlap_dp(pbuffer, 16, 1, 4, 7, factors, 8, a_exp);
