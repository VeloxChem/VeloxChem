#ifndef OverlapGeom100RecGD_hpp
#define OverlapGeom100RecGD_hpp
...
/// @brief Computes (d^(1)/dA^(1)G|D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_overlap_geom_10_gd(T& distributor,
                        ...
                        const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(731, ket_npgtos);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cgeom::comp_prim_op_geom_10_gx(pbuffer, 461, 140, 335, 1, 6, a_exp);
