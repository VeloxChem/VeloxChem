#ifndef OverlapGeom200RecGG_hpp
#define OverlapGeom200RecGG_hpp
...
/// @brief Computes (d^(2)/dA^(2)G|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_overlap_geom_20_gg(T& distributor,
