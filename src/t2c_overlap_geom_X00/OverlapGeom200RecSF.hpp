#ifndef OverlapGeom200RecSF_hpp
#define OverlapGeom200RecSF_hpp
...
/// @brief Computes (d^(2)/dA^(2)S|F)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_overlap_geom_20_sf(T& distributor,
                        ...
                        const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(188, ket_npgtos);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cgeom::comp_prim_op_geom_20_sx(pbuffer, 128, 10, 68, 1, 10, a_exp);
