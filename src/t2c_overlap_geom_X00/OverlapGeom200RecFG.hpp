#ifndef OverlapGeom200RecFG_hpp
#define OverlapGeom200RecFG_hpp
...
/// @brief Computes (d^(2)/dA^(2)F|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_overlap_geom_20_fg(T& distributor,
