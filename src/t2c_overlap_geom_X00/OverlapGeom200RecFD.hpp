#ifndef OverlapGeom200RecFD_hpp
#define OverlapGeom200RecFD_hpp
...
/// @brief Computes (d^(2)/dA^(2)F|D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_overlap_geom_20_fd(T& distributor,
                        ...
                        const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(821, ket_npgtos);
