 ...
 */
CDenseMatrix multDiagByA(const CMemBlock<double>& diagonal, const CDenseMatrix& matrix);
 ...
 */
CDenseMatrix multDiagByAt(const CMemBlock<double>& diagonal, const CDenseMatrix& matrix);
 ...
 */
double dot(const CMemBlock<double>& vectorA, const CMemBlock<double>& vectorB);
 ...
 */
double dot(const CMemBlock<double>& vectorA, const CDenseMatrix& matrixB);
 ...
 */
double trace(const CDenseMatrix& matrixA, const CDenseMatrix& matrixB);
