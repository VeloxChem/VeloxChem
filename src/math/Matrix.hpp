...
class CMatrix
{
     ...
     */
    auto
    _getRowAngularKeys() const -> std::set<int64_t>;
    
    /**
     Gets set of column angular keys.
     */
    auto
    _getColumnAngularKeys() const -> std::set<int64_t>;
   ...
   public:
     ...
     */
    CMatrix(const std::map<T2Pair, CSubMatrix>& sub_matrices,
     ...
     */
    auto
    add(const CSubMatrix& sub_matrix,
     ...
     */
    auto
    setType(const mat_t mat_type) -> void;
     ...
     */
    auto
    getAngularPairs() const -> std::vector<T2Pair>;
     ...
     */
    auto
    getSubMatrix(const T2Pair& angpair) -> CSubMatrix*;
     ...
     */
    auto
    getSubMatrix(const T2Pair& angpair) const -> const CSubMatrix*;
     ...
     */
    auto
    isAngularOrder(const T2Pair& angpair) const -> bool;
     ...
     */
    auto
    getFullMatrix() const -> CSubMatrix;
};
