                      ...
                      const int32_t               nBatchPairs) -> void
{
    ...
    t_0_yz_0_x_0 = intsBufferSDSP0.data(intsIndexesSDSP0(5));

    t_0_yy_0_z_0 = intsBufferSDSP0.data(intsIndexesSDSP0(6));

    t_0_yy_0_y_0 = intsBufferSDSP0.data(intsIndexesSDSP0(7));

    t_0_yy_0_x_0 = intsBufferSDSP0.data(intsIndexesSDSP0(8));

    t_0_xz_0_z_0 = intsBufferSDSP0.data(intsIndexesSDSP0(9));

    t_0_xz_0_y_0 = intsBufferSDSP0.data(intsIndexesSDSP0(10));

    t_0_xz_0_x_0 = intsBufferSDSP0.data(intsIndexesSDSP0(11));

    t_0_xy_0_z_0 = intsBufferSDSP0.data(intsIndexesSDSP0(12));

    t_0_xy_0_y_0 = intsBufferSDSP0.data(intsIndexesSDSP0(13));

    t_0_xy_0_x_0 = intsBufferSDSP0.data(intsIndexesSDSP0(14));

    t_0_xx_0_z_0 = intsBufferSDSP0.data(intsIndexesSDSP0(15));

    t_0_xx_0_y_0 = intsBufferSDSP0.data(intsIndexesSDSP0(16));

    t_0_xx_0_x_0 = intsBufferSDSP0.data(intsIndexesSDSP0(17));
    ...
    if (useSummation)
    {
        #pragma omp simd align(frz2_0, fz_0, fze_0, rpb_x, rpb_y, rpb_z, rwp_x, rwp_y,\
                               ...
                               t_0_xx_0_y_0, t_0_xx_0_z_0, t_0_xy_0_x_0, t_0_xy_0_y_0,\
                               t_0_xy_0_z_0, t_0_xz_0_x_0, t_0_xz_0_y_0, t_0_xz_0_z_0,\
                               t_0_y_0_0_1, t_0_y_0_x_0, t_0_y_0_x_1, t_0_y_0_y_0, t_0_y_0_y_1,\
                               t_0_y_0_z_0, t_0_y_0_z_1, t_0_yy_0_x_0, t_0_yy_0_y_0,\
                               t_0_yy_0_z_0, t_0_yz_0_x_0, t_0_yz_0_y_0, t_0_yz_0_z_0,\
                               t_0_z_0_0_1, t_0_z_0_x_0, t_0_z_0_x_1, t_0_z_0_y_0, t_0_z_0_y_1,\
                               t_0_z_0_z_0, t_0_z_0_z_1, t_0_zz_0_x_0, t_0_zz_0_y_0,\
        ...
        for (int32_t i = 0; i < nBatchPairs; i++)
        {
            ...
            t_0_yz_0_x_0[i] += rpb_y[i] * t_0_z_0_x_0[i] + rwp_y[i] * t_0_z_0_x_1[i];
            ...
            t_0_xz_0_y_0[i] += rpb_x[i] * t_0_z_0_y_0[i] + rwp_x[i] * t_0_z_0_y_1[i];

            t_0_xz_0_x_0[i] += rpb_z[i] * t_0_x_0_x_0[i] + rwp_z[i] * t_0_x_0_x_1[i];

            t_0_xy_0_z_0[i] += rpb_x[i] * t_0_y_0_z_0[i] + rwp_x[i] * t_0_y_0_z_1[i];
                      ...
                      const int32_t               nBatchPairs) -> void
{
    ...
    if (useSummation)
    {
        #pragma omp simd align(frz2_0, fz_0, fze_0, rpb_x, rpb_y, rpb_z, rwp_x, rwp_y,\
                               ...
                               t_0_0_0_z_0, t_0_0_0_z_1, t_0_x_0_0_1, t_0_x_0_x_0, t_0_x_0_x_1,\
                               t_0_x_0_y_0, t_0_x_0_y_1, t_0_x_0_z_0, t_0_x_0_z_1, t_0_xx_0_x_0,\
                               t_0_xx_0_y_0, t_0_xx_0_z_0, t_0_xz_0_x_0, t_0_y_0_0_1,\
                               t_0_y_0_x_0, t_0_y_0_x_1, t_0_y_0_y_0, t_0_y_0_y_1, t_0_y_0_z_0,\
                               t_0_y_0_z_1, t_0_yy_0_x_0, t_0_yy_0_y_0, t_0_yy_0_z_0,\
                               t_0_yz_0_y_0, t_0_yz_0_z_0, t_0_z_0_0_1, t_0_z_0_x_0,\
                               t_0_z_0_x_1, t_0_z_0_y_0, t_0_z_0_y_1, t_0_z_0_z_0, t_0_z_0_z_1,\
                               t_0_zz_0_x_0, t_0_zz_0_y_0, t_0_zz_0_z_0 : VLX_ALIGN)
        for (int32_t i = 0; i < nBatchPairs; i++)
        {
            t_0_zz_0_z_0[i] += rpb_z[i] * t_0_z_0_z_0[i] + rwp_z[i] * t_0_z_0_z_1[i] + fact_1_2 * fz_0[i] * t_0_0_0_z_0[i] - fact_1_2 * frz2_0[i] * t_0_0_0_z_1[i] + fact_1_2 * fze_0[i] * t_0_z_0_0_1[i];
