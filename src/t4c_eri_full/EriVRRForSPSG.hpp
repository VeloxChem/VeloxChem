                      ...
                      const int32_t               nBatchPairs) -> void
{
    ...
    if (useSummation)
    {
        #pragma omp simd align(fze_0, rpb_x, rpb_y, rpb_z, rwp_x, rwp_y, rwp_z, t_0_0_0_xxx_1,\
                               ...
                               t_0_0_0_zzz_1, t_0_0_0_zzzz_0, t_0_0_0_zzzz_1, t_0_x_0_xzzz_0,\
                               t_0_x_0_yyyy_0, t_0_x_0_yyyz_0, t_0_x_0_yyzz_0, t_0_x_0_yzzz_0,\
                               t_0_x_0_zzzz_0, t_0_y_0_xxxx_0, t_0_y_0_xxxy_0, t_0_y_0_xxxz_0,\
                               t_0_y_0_xxyy_0, t_0_y_0_xxyz_0, t_0_y_0_xxzz_0, t_0_y_0_xyyy_0,\
                               t_0_y_0_xyyz_0, t_0_y_0_xyzz_0, t_0_y_0_xzzz_0, t_0_y_0_yyyy_0,\
                               t_0_y_0_yyyz_0, t_0_y_0_yyzz_0, t_0_y_0_yzzz_0, t_0_y_0_zzzz_0,\
                               t_0_z_0_xxxx_0, t_0_z_0_xxxy_0, t_0_z_0_xxxz_0, t_0_z_0_xxyy_0,\
                               t_0_z_0_xxyz_0, t_0_z_0_xxzz_0, t_0_z_0_xyyy_0, t_0_z_0_xyyz_0,\
                               t_0_z_0_xyzz_0, t_0_z_0_xzzz_0, t_0_z_0_yyyy_0, t_0_z_0_yyyz_0,\
        ...
        for (int32_t i = 0; i < nBatchPairs; i++)
        {
            ...
            t_0_z_0_yyyy_0[i] += rpb_z[i] * t_0_0_0_yyyy_0[i] + rwp_z[i] * t_0_0_0_yyyy_1[i];
            ...
            t_0_z_0_xyyy_0[i] += rpb_z[i] * t_0_0_0_xyyy_0[i] + rwp_z[i] * t_0_0_0_xyyy_1[i];
            ...
            t_0_z_0_xxyy_0[i] += rpb_z[i] * t_0_0_0_xxyy_0[i] + rwp_z[i] * t_0_0_0_xxyy_1[i];

            t_0_z_0_xxxz_0[i] += rpb_z[i] * t_0_0_0_xxxz_0[i] + rwp_z[i] * t_0_0_0_xxxz_1[i] + fact_1_2 * fze_0[i] * t_0_0_0_xxx_1[i];

            t_0_z_0_xxxy_0[i] += rpb_z[i] * t_0_0_0_xxxy_0[i] + rwp_z[i] * t_0_0_0_xxxy_1[i];

            t_0_z_0_xxxx_0[i] += rpb_z[i] * t_0_0_0_xxxx_0[i] + rwp_z[i] * t_0_0_0_xxxx_1[i];

            t_0_y_0_zzzz_0[i] += rpb_y[i] * t_0_0_0_zzzz_0[i] + rwp_y[i] * t_0_0_0_zzzz_1[i];

            t_0_y_0_yzzz_0[i] += rpb_y[i] * t_0_0_0_yzzz_0[i] + rwp_y[i] * t_0_0_0_yzzz_1[i] + fact_1_2 * fze_0[i] * t_0_0_0_zzz_1[i];
            ...
            t_0_y_0_xzzz_0[i] += rpb_y[i] * t_0_0_0_xzzz_0[i] + rwp_y[i] * t_0_0_0_xzzz_1[i];
            ...
            t_0_y_0_xxzz_0[i] += rpb_y[i] * t_0_0_0_xxzz_0[i] + rwp_y[i] * t_0_0_0_xxzz_1[i];
            ...
            t_0_y_0_xxxz_0[i] += rpb_y[i] * t_0_0_0_xxxz_0[i] + rwp_y[i] * t_0_0_0_xxxz_1[i];

            t_0_y_0_xxxy_0[i] += rpb_y[i] * t_0_0_0_xxxy_0[i] + rwp_y[i] * t_0_0_0_xxxy_1[i] + fact_1_2 * fze_0[i] * t_0_0_0_xxx_1[i];

            t_0_y_0_xxxx_0[i] += rpb_y[i] * t_0_0_0_xxxx_0[i] + rwp_y[i] * t_0_0_0_xxxx_1[i];

            t_0_x_0_zzzz_0[i] += rpb_x[i] * t_0_0_0_zzzz_0[i] + rwp_x[i] * t_0_0_0_zzzz_1[i];

            t_0_x_0_yzzz_0[i] += rpb_x[i] * t_0_0_0_yzzz_0[i] + rwp_x[i] * t_0_0_0_yzzz_1[i];

            t_0_x_0_yyzz_0[i] += rpb_x[i] * t_0_0_0_yyzz_0[i] + rwp_x[i] * t_0_0_0_yyzz_1[i];

            t_0_x_0_yyyz_0[i] += rpb_x[i] * t_0_0_0_yyyz_0[i] + rwp_x[i] * t_0_0_0_yyyz_1[i];

            t_0_x_0_yyyy_0[i] += rpb_x[i] * t_0_0_0_yyyy_0[i] + rwp_x[i] * t_0_0_0_yyyy_1[i];

            t_0_x_0_xzzz_0[i] += rpb_x[i] * t_0_0_0_xzzz_0[i] + rwp_x[i] * t_0_0_0_xzzz_1[i] + fact_1_2 * fze_0[i] * t_0_0_0_zzz_1[i];
        }
        #pragma omp simd align(fze_0, rpb_x, rwp_x, t_0_0_0_xxx_1, t_0_0_0_xxxx_0, t_0_0_0_xxxx_1,\
                               t_0_0_0_xxxy_0, t_0_0_0_xxxy_1, t_0_0_0_xxxz_0, t_0_0_0_xxxz_1,\
                               t_0_0_0_xxy_1, t_0_0_0_xxyy_0, t_0_0_0_xxyy_1, t_0_0_0_xxyz_0,\
                               t_0_0_0_xxyz_1, t_0_0_0_xxz_1, t_0_0_0_xxzz_0, t_0_0_0_xxzz_1,\
                               t_0_0_0_xyy_1, t_0_0_0_xyyy_0, t_0_0_0_xyyy_1, t_0_0_0_xyyz_0,\
                               t_0_0_0_xyyz_1, t_0_0_0_xyz_1, t_0_0_0_xyzz_0, t_0_0_0_xyzz_1,\
                               t_0_0_0_xzz_1, t_0_0_0_yyy_1, t_0_0_0_yyz_1, t_0_0_0_yzz_1,\
                               t_0_x_0_xxxx_0, t_0_x_0_xxxy_0, t_0_x_0_xxxz_0, t_0_x_0_xxyy_0,\
                               t_0_x_0_xxyz_0, t_0_x_0_xxzz_0, t_0_x_0_xyyy_0, t_0_x_0_xyyz_0,\
                               t_0_x_0_xyzz_0 : VLX_ALIGN)
        for (int32_t i = 0; i < nBatchPairs; i++)
        {
            t_0_x_0_xyzz_0[i] += rpb_x[i] * t_0_0_0_xyzz_0[i] + rwp_x[i] * t_0_0_0_xyzz_1[i] + fact_1_2 * fze_0[i] * t_0_0_0_yzz_1[i];

            t_0_x_0_xyyz_0[i] += rpb_x[i] * t_0_0_0_xyyz_0[i] + rwp_x[i] * t_0_0_0_xyyz_1[i] + fact_1_2 * fze_0[i] * t_0_0_0_yyz_1[i];

            t_0_x_0_xyyy_0[i] += rpb_x[i] * t_0_0_0_xyyy_0[i] + rwp_x[i] * t_0_0_0_xyyy_1[i] + fact_1_2 * fze_0[i] * t_0_0_0_yyy_1[i];
