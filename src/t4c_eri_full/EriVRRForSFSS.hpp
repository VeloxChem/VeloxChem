...
template <typename T>
auto
compHostVRRForSFSS_V0(      BufferHostXY<T>&      intsBufferSFSS,
                      ...
                      const int32_t               nBatchPairs) -> void
{
    ...
    t_0_xyz_0_0_0 = intsBufferSFSS0.data(intsIndexesSFSS0(5));

    t_0_xyy_0_0_0 = intsBufferSFSS0.data(intsIndexesSFSS0(6));

    t_0_xxz_0_0_0 = intsBufferSFSS0.data(intsIndexesSFSS0(7));

    t_0_xxy_0_0_0 = intsBufferSFSS0.data(intsIndexesSFSS0(8));

    t_0_xxx_0_0_0 = intsBufferSFSS0.data(intsIndexesSFSS0(9));
    ...
    t_0_yz_0_0_1 = intsBufferSDSS1.data(intsIndexesSDSS1(1));

    t_0_yy_0_0_1 = intsBufferSDSS1.data(intsIndexesSDSS1(2));

    t_0_xx_0_0_1 = intsBufferSDSS1.data(intsIndexesSDSS1(3));

    if (useSummation)
    {
        #pragma omp simd align(frz2_0, fz_0, rpb_x, rpb_y, rpb_z, rwp_x, rwp_y, rwp_z,\
                               t_0_x_0_0_0, t_0_x_0_0_1, t_0_xx_0_0_0, t_0_xx_0_0_1,\
                               t_0_xxx_0_0_0, t_0_xxy_0_0_0, t_0_xxz_0_0_0, t_0_xyy_0_0_0,\
                               t_0_xyz_0_0_0, t_0_xzz_0_0_0, t_0_y_0_0_0, t_0_y_0_0_1,\
                               t_0_yy_0_0_0, t_0_yy_0_0_1, t_0_yyy_0_0_0, t_0_yyz_0_0_0,\
                               t_0_yz_0_0_0, t_0_yz_0_0_1, t_0_yzz_0_0_0, t_0_z_0_0_0,\
                               t_0_z_0_0_1, t_0_zz_0_0_0, t_0_zz_0_0_1, t_0_zzz_0_0_0 : VLX_ALIGN)
        for (int32_t i = 0; i < nBatchPairs; i++)
        {
            t_0_zzz_0_0_0[i] += rpb_z[i] * t_0_zz_0_0_0[i] + rwp_z[i] * t_0_zz_0_0_1[i] + fz_0[i] * t_0_z_0_0_0[i] - frz2_0[i] * t_0_z_0_0_1[i];

            t_0_yzz_0_0_0[i] += rpb_y[i] * t_0_zz_0_0_0[i] + rwp_y[i] * t_0_zz_0_0_1[i];

            t_0_yyz_0_0_0[i] += rpb_z[i] * t_0_yy_0_0_0[i] + rwp_z[i] * t_0_yy_0_0_1[i];

            t_0_yyy_0_0_0[i] += rpb_y[i] * t_0_yy_0_0_0[i] + rwp_y[i] * t_0_yy_0_0_1[i] + fz_0[i] * t_0_y_0_0_0[i] - frz2_0[i] * t_0_y_0_0_1[i];

            t_0_xzz_0_0_0[i] += rpb_x[i] * t_0_zz_0_0_0[i] + rwp_x[i] * t_0_zz_0_0_1[i];

            t_0_xyz_0_0_0[i] += rpb_x[i] * t_0_yz_0_0_0[i] + rwp_x[i] * t_0_yz_0_0_1[i];

            t_0_xyy_0_0_0[i] += rpb_x[i] * t_0_yy_0_0_0[i] + rwp_x[i] * t_0_yy_0_0_1[i];

            t_0_xxz_0_0_0[i] += rpb_z[i] * t_0_xx_0_0_0[i] + rwp_z[i] * t_0_xx_0_0_1[i];

            t_0_xxy_0_0_0[i] += rpb_y[i] * t_0_xx_0_0_0[i] + rwp_y[i] * t_0_xx_0_0_1[i];

            t_0_xxx_0_0_0[i] += rpb_x[i] * t_0_xx_0_0_0[i] + rwp_x[i] * t_0_xx_0_0_1[i] + fz_0[i] * t_0_x_0_0_0[i] - frz2_0[i] * t_0_x_0_0_1[i];
        }
    }
    else
    {
...
template <typename T>
auto
compHostVRRForSFSS_V1(      BufferHostXY<T>&      intsBufferSFSS,
                      const BufferHostX<int32_t>& intsIndexesSFSS0,
                      const BufferHostXY<T>&      intsBufferSPSS0,
                      const BufferHostX<int32_t>& intsIndexesSPSS0,
                      const BufferHostXY<T>&      intsBufferSPSS1,
                      ...
                      const int32_t               nBatchPairs) -> void
{
    ...
    if (useSummation)
    {
        #pragma omp simd align(frz2_0, fz_0, rpb_x, rpb_y, rpb_z, rwp_x, rwp_y, rwp_z,\
                               t_0_x_0_0_0, t_0_x_0_0_1, t_0_xx_0_0_0, t_0_xx_0_0_1,\
                               t_0_xxx_0_0_0, t_0_xxz_0_0_0, t_0_xyy_0_0_0, t_0_xzz_0_0_0,\
                               t_0_y_0_0_0, t_0_y_0_0_1, t_0_yy_0_0_0, t_0_yy_0_0_1,\
                               t_0_yyy_0_0_0, t_0_yyz_0_0_0, t_0_yzz_0_0_0, t_0_z_0_0_0,\
                               t_0_z_0_0_1, t_0_zz_0_0_0, t_0_zz_0_0_1, t_0_zzz_0_0_0 : VLX_ALIGN)
        for (int32_t i = 0; i < nBatchPairs; i++)
        {
            t_0_zzz_0_0_0[i] += rpb_z[i] * t_0_zz_0_0_0[i] + rwp_z[i] * t_0_zz_0_0_1[i] + fz_0[i] * t_0_z_0_0_0[i] - frz2_0[i] * t_0_z_0_0_1[i];
...
template <typename T>
auto
compHostVRRForSFSS_V2(      BufferHostXY<T>&      intsBufferSFSS,
                      const BufferHostX<int32_t>& intsIndexesSFSS0,
                      const BufferHostXY<T>&      intsBufferSPSS0,
                      const BufferHostX<int32_t>& intsIndexesSPSS0,
                      const BufferHostXY<T>&      intsBufferSPSS1,
                      ...
                      const int32_t               nBatchPairs) -> void
{
    ...
    t_0_yyy_0_0_0 = intsBufferSFSS0.data(intsIndexesSFSS0(1));

    t_0_xxx_0_0_0 = intsBufferSFSS0.data(intsIndexesSFSS0(2));
    ...
    if (useSummation)
    {
        #pragma omp simd align(frz2_0, fz_0, rpb_x, rpb_y, rpb_z, rwp_x, rwp_y, rwp_z,\
                               t_0_x_0_0_0, t_0_x_0_0_1, t_0_xx_0_0_0, t_0_xx_0_0_1,\
                               t_0_xxx_0_0_0, t_0_y_0_0_0, t_0_y_0_0_1, t_0_yy_0_0_0,\
                               t_0_yy_0_0_1, t_0_yyy_0_0_0, t_0_z_0_0_0, t_0_z_0_0_1,\
                               t_0_zz_0_0_0, t_0_zz_0_0_1, t_0_zzz_0_0_0 : VLX_ALIGN)
        for (int32_t i = 0; i < nBatchPairs; i++)
        {
            t_0_zzz_0_0_0[i] += rpb_z[i] * t_0_zz_0_0_0[i] + rwp_z[i] * t_0_zz_0_0_1[i] + fz_0[i] * t_0_z_0_0_0[i] - frz2_0[i] * t_0_z_0_0_1[i];
