#ifndef PrimitiveOverlapGeom300DF_XZ_XYY
#define PrimitiveOverlapGeom300DF_XZ_XYY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XZ|1|F_XYY> integrals.
...
*/
auto compPrimitiveOverlapGeom300DF_XZ_XYY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DF_XZ_XYY */
