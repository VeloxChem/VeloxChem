#ifndef PrimitiveOverlapGeom300PF_X_XXX
#define PrimitiveOverlapGeom300PF_X_XXX
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_X|1|F_XXX> integrals.
...
*/
auto compPrimitiveOverlapGeom300PF_X_XXX(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PF_X_XXX */
