#ifndef PrimitiveOverlapGeom300DD_XX_XZ
#define PrimitiveOverlapGeom300DD_XX_XZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XX|1|D_XZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300DD_XX_XZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DD_XX_XZ */
