#ifndef PrimitiveOverlapGeom300PD_X_YY
#define PrimitiveOverlapGeom300PD_X_YY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_X|1|D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom300PD_X_YY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PD_X_YY */
