#ifndef PrimitiveOverlapGeom300DP_YY_Y
#define PrimitiveOverlapGeom300DP_YY_Y
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YY|1|P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom300DP_YY_Y(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DP_YY_Y */
