#ifndef PrimitiveOverlapGeom300FD_XXX_XY
#define PrimitiveOverlapGeom300FD_XXX_XY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XXX|1|D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom300FD_XXX_XY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300FD_XXX_XY */
