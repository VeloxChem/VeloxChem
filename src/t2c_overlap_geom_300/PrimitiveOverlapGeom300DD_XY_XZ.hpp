#ifndef PrimitiveOverlapGeom300DD_XY_XZ
#define PrimitiveOverlapGeom300DD_XY_XZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XY|1|D_XZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300DD_XY_XZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DD_XY_XZ */
