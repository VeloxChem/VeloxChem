#ifndef PrimitiveOverlapGeom300PF_X_ZZZ
#define PrimitiveOverlapGeom300PF_X_ZZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_X|1|F_ZZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300PF_X_ZZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PF_X_ZZZ */
