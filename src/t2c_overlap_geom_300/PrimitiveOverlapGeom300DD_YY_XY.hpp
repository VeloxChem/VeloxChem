#ifndef PrimitiveOverlapGeom300DD_YY_XY
#define PrimitiveOverlapGeom300DD_YY_XY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YY|1|D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom300DD_YY_XY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DD_YY_XY */
