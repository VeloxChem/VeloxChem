#include "OverlapGeom300RecPD.hpp"
...
#include "PrimitiveOverlapGeom300PD_X_YZ.hpp"
#include "PrimitiveOverlapGeom300PD_X_ZZ.hpp"
#include "PrimitiveOverlapGeom300PD_Y_XX.hpp"
#include "PrimitiveOverlapGeom300PD_Y_XY.hpp"
#include "PrimitiveOverlapGeom300PD_Y_XZ.hpp"
#include "PrimitiveOverlapGeom300PD_Y_YY.hpp"
#include "PrimitiveOverlapGeom300PD_Y_YZ.hpp"
#include "PrimitiveOverlapGeom300PD_Y_ZZ.hpp"
#include "PrimitiveOverlapGeom300PD_Z_XX.hpp"
#include "PrimitiveOverlapGeom300PD_Z_XY.hpp"
#include "PrimitiveOverlapGeom300PD_Z_XZ.hpp"
#include "PrimitiveOverlapGeom300PD_Z_YY.hpp"
#include "PrimitiveOverlapGeom300PD_Z_YZ.hpp"
#include "PrimitiveOverlapGeom300PD_Z_ZZ.hpp"
#include "T2CDistributor.hpp"

namespace ovlrec {  // ovlrec namespace

auto
compOverlapGeom300PD(CSubMatrix*      matrix_xxx,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PD_X_XX(buffer_xxx,
                                                               buffer_xxy,
                                                               buffer_xxz,
                                                               buffer_xyy,
                                                               buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PD_X_XY(buffer_xxx,
                                                               buffer_xxy,
                                                               buffer_xxz,
                                                               buffer_xyy,
                                                               buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PD_X_XZ(buffer_xxx,
                                                               buffer_xxy,
                                                               buffer_xxz,
                                                               buffer_xyy,
                                                               buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PD_X_YY(buffer_xxx,
                                                               buffer_xxy,
                                                               buffer_xxz,
                                                               buffer_xyy,
                                                               buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PD_X_YZ(buffer_xxx,
                                                               buffer_xxy,
                                                               buffer_xxz,
                                                               buffer_xyy,
                                                               buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PD_X_ZZ(buffer_xxx,
                                                               buffer_xxy,
                                                               buffer_xxz,
                                                               buffer_xyy,
                                                               buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PD_Y_XX(buffer_xxx,
                                                               buffer_xxy,
                                                               buffer_xxz,
                                                               buffer_xyy,
                                                               buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PD_Y_XY(buffer_xxx,
                                                               buffer_xxy,
                                                               buffer_xxz,
                                                               buffer_xyy,
                                                               buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PD_Y_XZ(buffer_xxx,
                                                               buffer_xxy,
                                                               buffer_xxz,
                                                               buffer_xyy,
                                                               buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PD_Y_YY(buffer_xxx,
                                                               buffer_xxy,
                                                               buffer_xxz,
                                                               buffer_xyy,
                                                               buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PD_Y_YZ(buffer_xxx,
                                                               buffer_xxy,
                                                               buffer_xxz,
                                                               buffer_xyy,
                                                               buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PD_Y_ZZ(buffer_xxx,
                                                               buffer_xxy,
                                                               buffer_xxz,
                                                               buffer_xyy,
                                                               buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PD_Z_XX(buffer_xxx,
                                                               buffer_xxy,
                                                               buffer_xxz,
                                                               buffer_xyy,
                                                               buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PD_Z_XY(buffer_xxx,
                                                               buffer_xxy,
                                                               buffer_xxz,
                                                               buffer_xyy,
                                                               buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PD_Z_XZ(buffer_xxx,
                                                               buffer_xxy,
                                                               buffer_xxz,
                                                               buffer_xyy,
                                                               buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PD_Z_YY(buffer_xxx,
                                                               buffer_xxy,
                                                               buffer_xxz,
                                                               buffer_xyy,
                                                               buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PD_Z_YZ(buffer_xxx,
                                                               buffer_xxy,
                                                               buffer_xxz,
                                                               buffer_xyy,
                                                               buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PD_Z_ZZ(buffer_xxx,
                                                               buffer_xxy,
                                                               buffer_xxz,
                                                               buffer_xyy,
                                                               buffer_xyz,
