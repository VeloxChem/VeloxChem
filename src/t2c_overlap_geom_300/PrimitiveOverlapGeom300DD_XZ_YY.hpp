#ifndef PrimitiveOverlapGeom300DD_XZ_YY
#define PrimitiveOverlapGeom300DD_XZ_YY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XZ|1|D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom300DD_XZ_YY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DD_XZ_YY */
