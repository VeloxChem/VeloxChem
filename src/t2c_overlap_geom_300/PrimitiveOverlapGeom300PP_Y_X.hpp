#ifndef PrimitiveOverlapGeom300PP_Y_X
#define PrimitiveOverlapGeom300PP_Y_X
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Y|1|P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom300PP_Y_X(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PP_Y_X */
