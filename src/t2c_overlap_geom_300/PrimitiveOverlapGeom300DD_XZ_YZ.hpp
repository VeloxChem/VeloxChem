#ifndef PrimitiveOverlapGeom300DD_XZ_YZ
#define PrimitiveOverlapGeom300DD_XZ_YZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XZ|1|D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300DD_XZ_YZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DD_XZ_YZ */
