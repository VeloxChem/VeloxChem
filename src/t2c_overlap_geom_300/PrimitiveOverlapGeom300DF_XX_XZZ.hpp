#ifndef PrimitiveOverlapGeom300DF_XX_XZZ
#define PrimitiveOverlapGeom300DF_XX_XZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XX|1|F_XZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300DF_XX_XZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DF_XX_XZZ */
