#ifndef PrimitiveOverlapGeom300DF_YZ_XXZ
#define PrimitiveOverlapGeom300DF_YZ_XXZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YZ|1|F_XXZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300DF_YZ_XXZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DF_YZ_XXZ */
