#ifndef OverlapGeom300RecSP_hpp
#define OverlapGeom300RecSP_hpp
...
/**
 Evaluates <d^(3)/dA^(3)S|1|P>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom300SP(CSubMatrix*      matrix_xxx,
