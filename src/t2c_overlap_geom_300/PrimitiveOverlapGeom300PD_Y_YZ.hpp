#ifndef PrimitiveOverlapGeom300PD_Y_YZ
#define PrimitiveOverlapGeom300PD_Y_YZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Y|1|D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300PD_Y_YZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PD_Y_YZ */
