#ifndef PrimitiveOverlapGeom300PD_Y_XY
#define PrimitiveOverlapGeom300PD_Y_XY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Y|1|D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom300PD_Y_XY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PD_Y_XY */
