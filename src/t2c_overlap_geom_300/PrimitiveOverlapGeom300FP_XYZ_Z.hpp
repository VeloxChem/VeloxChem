#ifndef PrimitiveOverlapGeom300FP_XYZ_Z
#define PrimitiveOverlapGeom300FP_XYZ_Z
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XYZ|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom300FP_XYZ_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300FP_XYZ_Z */
