#ifndef PrimitiveOverlapGeom300DD_XY_ZZ
#define PrimitiveOverlapGeom300DD_XY_ZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XY|1|D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300DD_XY_ZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DD_XY_ZZ */
