#ifndef PrimitiveOverlapGeom300PF_X_XXY
#define PrimitiveOverlapGeom300PF_X_XXY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_X|1|F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom300PF_X_XXY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PF_X_XXY */
