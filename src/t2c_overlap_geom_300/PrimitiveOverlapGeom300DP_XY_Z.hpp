#ifndef PrimitiveOverlapGeom300DP_XY_Z
#define PrimitiveOverlapGeom300DP_XY_Z
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XY|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom300DP_XY_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DP_XY_Z */
