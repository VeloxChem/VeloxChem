#ifndef PrimitiveOverlapGeom300DS_XX_0
#define PrimitiveOverlapGeom300DS_XX_0
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XX|1|S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom300DS_XX_0(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DS_XX_0 */
