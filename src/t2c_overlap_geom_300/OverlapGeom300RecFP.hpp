#ifndef OverlapGeom300RecFP_hpp
#define OverlapGeom300RecFP_hpp
...
/**
 Evaluates <d^(3)/dA^(3)F|1|P>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom300FP(CSubMatrix*      matrix_xxx,
