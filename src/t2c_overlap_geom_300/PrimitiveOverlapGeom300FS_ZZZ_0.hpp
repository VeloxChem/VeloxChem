#ifndef PrimitiveOverlapGeom300FS_ZZZ_0
#define PrimitiveOverlapGeom300FS_ZZZ_0
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_ZZZ|1|S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom300FS_ZZZ_0(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300FS_ZZZ_0 */
