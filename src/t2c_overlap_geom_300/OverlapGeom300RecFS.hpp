#ifndef OverlapGeom300RecFS_hpp
#define OverlapGeom300RecFS_hpp
...
/**
 Evaluates <d^(3)/dA^(3)F|1|S>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom300FS(CSubMatrix*      matrix_xxx,
