#ifndef PrimitiveOverlapGeom300PS_Z_0
#define PrimitiveOverlapGeom300PS_Z_0
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Z|1|S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom300PS_Z_0(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PS_Z_0 */
