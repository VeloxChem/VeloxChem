#ifndef PrimitiveOverlapGeom300PF_X_YZZ
#define PrimitiveOverlapGeom300PF_X_YZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_X|1|F_YZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300PF_X_YZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PF_X_YZZ */
