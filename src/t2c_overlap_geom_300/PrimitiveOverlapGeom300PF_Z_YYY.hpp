#ifndef PrimitiveOverlapGeom300PF_Z_YYY
#define PrimitiveOverlapGeom300PF_Z_YYY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Z|1|F_YYY> integrals.
...
*/
auto compPrimitiveOverlapGeom300PF_Z_YYY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PF_Z_YYY */
