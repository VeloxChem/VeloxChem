#ifndef PrimitiveOverlapGeom300PF_Z_ZZZ
#define PrimitiveOverlapGeom300PF_Z_ZZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Z|1|F_ZZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300PF_Z_ZZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PF_Z_ZZZ */
