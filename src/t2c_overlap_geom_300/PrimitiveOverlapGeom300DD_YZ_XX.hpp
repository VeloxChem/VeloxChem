#ifndef PrimitiveOverlapGeom300DD_YZ_XX
#define PrimitiveOverlapGeom300DD_YZ_XX
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YZ|1|D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom300DD_YZ_XX(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DD_YZ_XX */
