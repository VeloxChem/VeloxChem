#ifndef PrimitiveOverlapGeom300PF_Y_XZZ
#define PrimitiveOverlapGeom300PF_Y_XZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Y|1|F_XZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300PF_Y_XZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PF_Y_XZZ */
