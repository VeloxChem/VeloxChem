#include "OverlapGeom300RecPP.hpp"

#include "BatchFunc.hpp"
#include "PrimitiveOverlapGeom300PP_X_X.hpp"
#include "PrimitiveOverlapGeom300PP_X_Y.hpp"
#include "PrimitiveOverlapGeom300PP_X_Z.hpp"
#include "PrimitiveOverlapGeom300PP_Y_X.hpp"
#include "PrimitiveOverlapGeom300PP_Y_Y.hpp"
#include "PrimitiveOverlapGeom300PP_Y_Z.hpp"
#include "PrimitiveOverlapGeom300PP_Z_X.hpp"
#include "PrimitiveOverlapGeom300PP_Z_Y.hpp"
...
auto
compOverlapGeom300PP(CSubMatrix*      matrix_xxx,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PP_X_X(buffer_xxx,
                                                              buffer_xxy,
                                                              buffer_xxz,
                                                              buffer_xyy,
                                                              buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PP_X_Y(buffer_xxx,
                                                              buffer_xxy,
                                                              buffer_xxz,
                                                              buffer_xyy,
                                                              buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PP_X_Z(buffer_xxx,
                                                              buffer_xxy,
                                                              buffer_xxz,
                                                              buffer_xyy,
                                                              buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PP_Y_X(buffer_xxx,
                                                              buffer_xxy,
                                                              buffer_xxz,
                                                              buffer_xyy,
                                                              buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PP_Y_Y(buffer_xxx,
                                                              buffer_xxy,
                                                              buffer_xxz,
                                                              buffer_xyy,
                                                              buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PP_Y_Z(buffer_xxx,
                                                              buffer_xxy,
                                                              buffer_xxz,
                                                              buffer_xyy,
                                                              buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PP_Z_X(buffer_xxx,
                                                              buffer_xxy,
                                                              buffer_xxz,
                                                              buffer_xyy,
                                                              buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PP_Z_Y(buffer_xxx,
                                                              buffer_xxy,
                                                              buffer_xxz,
                                                              buffer_xyy,
                                                              buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300PP_Z_Z(buffer_xxx,
                                                              buffer_xxy,
                                                              buffer_xxz,
                                                              buffer_xyy,
                                                              buffer_xyz,
