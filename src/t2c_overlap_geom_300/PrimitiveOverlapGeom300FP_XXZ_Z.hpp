#ifndef PrimitiveOverlapGeom300FP_XXZ_Z
#define PrimitiveOverlapGeom300FP_XXZ_Z
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XXZ|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom300FP_XXZ_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300FP_XXZ_Z */
