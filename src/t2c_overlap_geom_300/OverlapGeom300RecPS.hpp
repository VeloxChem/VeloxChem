#ifndef OverlapGeom300RecPS_hpp
#define OverlapGeom300RecPS_hpp
...
/**
 Evaluates <d^(3)/dA^(3)P|1|S>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom300PS(CSubMatrix*      matrix_xxx,
