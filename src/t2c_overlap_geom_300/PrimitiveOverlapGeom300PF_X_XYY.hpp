#ifndef PrimitiveOverlapGeom300PF_X_XYY
#define PrimitiveOverlapGeom300PF_X_XYY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_X|1|F_XYY> integrals.
...
*/
auto compPrimitiveOverlapGeom300PF_X_XYY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PF_X_XYY */
