#ifndef PrimitiveOverlapGeom300DP_YZ_Z
#define PrimitiveOverlapGeom300DP_YZ_Z
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YZ|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom300DP_YZ_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DP_YZ_Z */
