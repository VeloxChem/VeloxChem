#ifndef PrimitiveOverlapGeom300PD_Z_ZZ
#define PrimitiveOverlapGeom300PD_Z_ZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Z|1|D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300PD_Z_ZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PD_Z_ZZ */
