#ifndef PrimitiveOverlapGeom300DD_ZZ_YZ
#define PrimitiveOverlapGeom300DD_ZZ_YZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_ZZ|1|D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300DD_ZZ_YZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DD_ZZ_YZ */
