#ifndef PrimitiveOverlapGeom300DD_YY_XX
#define PrimitiveOverlapGeom300DD_YY_XX
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YY|1|D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom300DD_YY_XX(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DD_YY_XX */
