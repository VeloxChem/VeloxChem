#ifndef PrimitiveOverlapGeom300DF_XZ_XXZ
#define PrimitiveOverlapGeom300DF_XZ_XXZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XZ|1|F_XXZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300DF_XZ_XXZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DF_XZ_XXZ */
