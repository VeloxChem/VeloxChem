#ifndef PrimitiveOverlapGeom300DF_XY_XZZ
#define PrimitiveOverlapGeom300DF_XY_XZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XY|1|F_XZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300DF_XY_XZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DF_XY_XZZ */
