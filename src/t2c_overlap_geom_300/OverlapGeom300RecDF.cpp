#include "OverlapGeom300RecDF.hpp"

#include <cmath>

#include "BatchFunc.hpp"
#include "PrimitiveOverlapGeom300DF_XX_XXX.hpp"
#include "PrimitiveOverlapGeom300DF_XX_XXY.hpp"
#include "PrimitiveOverlapGeom300DF_XX_XXZ.hpp"
#include "PrimitiveOverlapGeom300DF_XX_XYY.hpp"
#include "PrimitiveOverlapGeom300DF_XX_XYZ.hpp"
#include "PrimitiveOverlapGeom300DF_XX_XZZ.hpp"
...
#include "PrimitiveOverlapGeom300DF_XY_XXY.hpp"
#include "PrimitiveOverlapGeom300DF_XY_XXZ.hpp"
#include "PrimitiveOverlapGeom300DF_XY_XYY.hpp"
#include "PrimitiveOverlapGeom300DF_XY_XYZ.hpp"
#include "PrimitiveOverlapGeom300DF_XY_XZZ.hpp"
#include "PrimitiveOverlapGeom300DF_XY_YYY.hpp"
#include "PrimitiveOverlapGeom300DF_XY_YYZ.hpp"
#include "PrimitiveOverlapGeom300DF_XY_YZZ.hpp"
#include "PrimitiveOverlapGeom300DF_XY_ZZZ.hpp"
#include "PrimitiveOverlapGeom300DF_XZ_XXX.hpp"
#include "PrimitiveOverlapGeom300DF_XZ_XXY.hpp"
#include "PrimitiveOverlapGeom300DF_XZ_XXZ.hpp"
...
#include "PrimitiveOverlapGeom300DF_XZ_YYZ.hpp"
#include "PrimitiveOverlapGeom300DF_XZ_YZZ.hpp"
#include "PrimitiveOverlapGeom300DF_XZ_ZZZ.hpp"
#include "PrimitiveOverlapGeom300DF_YY_XXX.hpp"
#include "PrimitiveOverlapGeom300DF_YY_XXY.hpp"
#include "PrimitiveOverlapGeom300DF_YY_XXZ.hpp"
#include "PrimitiveOverlapGeom300DF_YY_XYY.hpp"
#include "PrimitiveOverlapGeom300DF_YY_XYZ.hpp"
#include "PrimitiveOverlapGeom300DF_YY_XZZ.hpp"
#include "PrimitiveOverlapGeom300DF_YY_YYY.hpp"
#include "PrimitiveOverlapGeom300DF_YY_YYZ.hpp"
#include "PrimitiveOverlapGeom300DF_YY_YZZ.hpp"
#include "PrimitiveOverlapGeom300DF_YY_ZZZ.hpp"
...
#include "PrimitiveOverlapGeom300DF_YZ_XYY.hpp"
#include "PrimitiveOverlapGeom300DF_YZ_XYZ.hpp"
#include "PrimitiveOverlapGeom300DF_YZ_XZZ.hpp"
#include "PrimitiveOverlapGeom300DF_YZ_YYY.hpp"
#include "PrimitiveOverlapGeom300DF_YZ_YYZ.hpp"
#include "PrimitiveOverlapGeom300DF_YZ_YZZ.hpp"
#include "PrimitiveOverlapGeom300DF_YZ_ZZZ.hpp"
#include "PrimitiveOverlapGeom300DF_ZZ_XXX.hpp"
#include "PrimitiveOverlapGeom300DF_ZZ_XXY.hpp"
#include "PrimitiveOverlapGeom300DF_ZZ_XXZ.hpp"
#include "PrimitiveOverlapGeom300DF_ZZ_XYY.hpp"
#include "PrimitiveOverlapGeom300DF_ZZ_XYZ.hpp"
#include "PrimitiveOverlapGeom300DF_ZZ_XZZ.hpp"
#include "PrimitiveOverlapGeom300DF_ZZ_YYY.hpp"
#include "PrimitiveOverlapGeom300DF_ZZ_YYZ.hpp"
#include "PrimitiveOverlapGeom300DF_ZZ_YZZ.hpp"
#include "PrimitiveOverlapGeom300DF_ZZ_ZZZ.hpp"
#include "T2CDistributor.hpp"

namespace ovlrec {  // ovlrec namespace

auto
compOverlapGeom300DF(CSubMatrix*      matrix_xxx,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XX_XXX(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XX_XXY(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XX_XXZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XX_XYY(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XX_XYZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XX_XZZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XX_YYY(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XX_YYZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XX_YZZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XX_ZZZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XY_XXX(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XY_XXY(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XY_XXZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XY_XYY(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XY_XYZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XY_XZZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XY_YYY(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XY_YYZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XY_YZZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XY_ZZZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XZ_XXX(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XZ_XXY(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XZ_XXZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XZ_XYY(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XZ_XYZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XZ_XZZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XZ_YYY(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XZ_YYZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XZ_YZZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_XZ_ZZZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_YY_XXX(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_YY_XXY(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_YY_XXZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_YY_XYY(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_YY_XYZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_YY_XZZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_YY_YYY(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_YY_YYZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_YY_YZZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_YY_ZZZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_YZ_XXX(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_YZ_XXY(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_YZ_XXZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_YZ_XYY(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_YZ_XYZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_YZ_XZZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_YZ_YYY(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_YZ_YYZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_YZ_YZZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_YZ_ZZZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_ZZ_XXX(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_ZZ_XXY(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_ZZ_XXZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_ZZ_XYY(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_ZZ_XYZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_ZZ_XZZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_ZZ_YYY(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_ZZ_YYZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_ZZ_YZZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom300DF_ZZ_ZZZ(buffer_xxx,
                                                                 buffer_xxy,
                                                                 buffer_xxz,
                                                                 buffer_xyy,
                                                                 buffer_xyz,
