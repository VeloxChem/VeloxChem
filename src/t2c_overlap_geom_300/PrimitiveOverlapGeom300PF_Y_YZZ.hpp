#ifndef PrimitiveOverlapGeom300PF_Y_YZZ
#define PrimitiveOverlapGeom300PF_Y_YZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Y|1|F_YZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300PF_Y_YZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PF_Y_YZZ */
