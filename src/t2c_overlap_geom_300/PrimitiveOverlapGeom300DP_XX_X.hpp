#ifndef PrimitiveOverlapGeom300DP_XX_X
#define PrimitiveOverlapGeom300DP_XX_X
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XX|1|P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom300DP_XX_X(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DP_XX_X */
