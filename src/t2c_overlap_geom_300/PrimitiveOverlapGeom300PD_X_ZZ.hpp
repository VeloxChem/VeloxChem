#ifndef PrimitiveOverlapGeom300PD_X_ZZ
#define PrimitiveOverlapGeom300PD_X_ZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_X|1|D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300PD_X_ZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PD_X_ZZ */
