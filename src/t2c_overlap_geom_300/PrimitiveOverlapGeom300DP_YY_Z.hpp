#ifndef PrimitiveOverlapGeom300DP_YY_Z
#define PrimitiveOverlapGeom300DP_YY_Z
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YY|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom300DP_YY_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DP_YY_Z */
