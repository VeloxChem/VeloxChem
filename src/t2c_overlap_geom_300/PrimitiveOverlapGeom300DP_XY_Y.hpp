#ifndef PrimitiveOverlapGeom300DP_XY_Y
#define PrimitiveOverlapGeom300DP_XY_Y
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XY|1|P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom300DP_XY_Y(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DP_XY_Y */
