#ifndef PrimitiveOverlapGeom300PP_X_Y
#define PrimitiveOverlapGeom300PP_X_Y
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_X|1|P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom300PP_X_Y(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PP_X_Y */
