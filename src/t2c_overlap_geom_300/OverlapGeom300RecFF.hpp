#ifndef OverlapGeom300RecFF_hpp
#define OverlapGeom300RecFF_hpp
...
/**
 Evaluates <d^(3)/dA^(3)F|1|F>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom300FF(CSubMatrix*      matrix_xxx,
