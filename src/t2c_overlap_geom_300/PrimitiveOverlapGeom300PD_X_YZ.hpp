#ifndef PrimitiveOverlapGeom300PD_X_YZ
#define PrimitiveOverlapGeom300PD_X_YZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_X|1|D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300PD_X_YZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PD_X_YZ */
