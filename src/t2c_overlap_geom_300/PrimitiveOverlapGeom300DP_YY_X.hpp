#ifndef PrimitiveOverlapGeom300DP_YY_X
#define PrimitiveOverlapGeom300DP_YY_X
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YY|1|P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom300DP_YY_X(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DP_YY_X */
