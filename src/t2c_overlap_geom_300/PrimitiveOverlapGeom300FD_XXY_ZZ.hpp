#ifndef PrimitiveOverlapGeom300FD_XXY_ZZ
#define PrimitiveOverlapGeom300FD_XXY_ZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XXY|1|D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300FD_XXY_ZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300FD_XXY_ZZ */
