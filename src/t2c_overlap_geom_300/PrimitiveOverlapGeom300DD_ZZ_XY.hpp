#ifndef PrimitiveOverlapGeom300DD_ZZ_XY
#define PrimitiveOverlapGeom300DD_ZZ_XY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_ZZ|1|D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom300DD_ZZ_XY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DD_ZZ_XY */
