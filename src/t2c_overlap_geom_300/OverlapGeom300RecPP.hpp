#ifndef OverlapGeom300RecPP_hpp
#define OverlapGeom300RecPP_hpp
...
/**
 Evaluates <d^(3)/dA^(3)P|1|P>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom300PP(CSubMatrix*      matrix_xxx,
