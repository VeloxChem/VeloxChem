#ifndef OverlapGeom300RecSS_hpp
#define OverlapGeom300RecSS_hpp
...
/**
 Evaluates <d^(3)/dA^(3)S|1|S>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom300SS(CSubMatrix*      matrix_xxx,
