#ifndef OverlapGeom300RecDP_hpp
#define OverlapGeom300RecDP_hpp
...
/**
 Evaluates <d^(3)/dA^(3)D|1|P>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom300DP(CSubMatrix*      matrix_xxx,
