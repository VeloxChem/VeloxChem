#ifndef PrimitiveOverlapGeom300DD_XZ_XY
#define PrimitiveOverlapGeom300DD_XZ_XY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XZ|1|D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom300DD_XZ_XY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DD_XZ_XY */
