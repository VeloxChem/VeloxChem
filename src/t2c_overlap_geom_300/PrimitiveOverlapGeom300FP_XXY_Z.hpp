#ifndef PrimitiveOverlapGeom300FP_XXY_Z
#define PrimitiveOverlapGeom300FP_XXY_Z
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XXY|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom300FP_XXY_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300FP_XXY_Z */
