#ifndef PrimitiveOverlapGeom300PF_Y_ZZZ
#define PrimitiveOverlapGeom300PF_Y_ZZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Y|1|F_ZZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300PF_Y_ZZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PF_Y_ZZZ */
