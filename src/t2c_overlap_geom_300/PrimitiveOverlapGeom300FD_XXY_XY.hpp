#ifndef PrimitiveOverlapGeom300FD_XXY_XY
#define PrimitiveOverlapGeom300FD_XXY_XY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XXY|1|D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom300FD_XXY_XY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300FD_XXY_XY */
