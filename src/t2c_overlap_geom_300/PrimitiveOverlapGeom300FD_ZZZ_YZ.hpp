#ifndef PrimitiveOverlapGeom300FD_ZZZ_YZ
#define PrimitiveOverlapGeom300FD_ZZZ_YZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_ZZZ|1|D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300FD_ZZZ_YZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300FD_ZZZ_YZ */
