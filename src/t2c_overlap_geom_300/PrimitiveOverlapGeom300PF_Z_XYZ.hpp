#ifndef PrimitiveOverlapGeom300PF_Z_XYZ
#define PrimitiveOverlapGeom300PF_Z_XYZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Z|1|F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300PF_Z_XYZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PF_Z_XYZ */
