#ifndef PrimitiveOverlapGeom300FP_ZZZ_Z
#define PrimitiveOverlapGeom300FP_ZZZ_Z
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_ZZZ|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom300FP_ZZZ_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300FP_ZZZ_Z */
