#ifndef OverlapGeom300RecFD_hpp
#define OverlapGeom300RecFD_hpp
...
/**
 Evaluates <d^(3)/dA^(3)F|1|D>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom300FD(CSubMatrix*      matrix_xxx,
