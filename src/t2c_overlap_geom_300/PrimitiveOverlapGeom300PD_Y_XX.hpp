#ifndef PrimitiveOverlapGeom300PD_Y_XX
#define PrimitiveOverlapGeom300PD_Y_XX
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Y|1|D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom300PD_Y_XX(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PD_Y_XX */
