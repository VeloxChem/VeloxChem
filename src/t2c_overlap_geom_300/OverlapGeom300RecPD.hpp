#ifndef OverlapGeom300RecPD_hpp
#define OverlapGeom300RecPD_hpp
...
/**
 Evaluates <d^(3)/dA^(3)P|1|D>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom300PD(CSubMatrix*      matrix_xxx,
