#ifndef PrimitiveOverlapGeom300PD_Y_ZZ
#define PrimitiveOverlapGeom300PD_Y_ZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Y|1|D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300PD_Y_ZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PD_Y_ZZ */
