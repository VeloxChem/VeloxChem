#ifndef PrimitiveOverlapGeom300DS_XZ_0
#define PrimitiveOverlapGeom300DS_XZ_0
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XZ|1|S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom300DS_XZ_0(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DS_XZ_0 */
