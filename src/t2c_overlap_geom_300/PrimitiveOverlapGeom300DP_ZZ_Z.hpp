#ifndef PrimitiveOverlapGeom300DP_ZZ_Z
#define PrimitiveOverlapGeom300DP_ZZ_Z
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_ZZ|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom300DP_ZZ_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DP_ZZ_Z */
