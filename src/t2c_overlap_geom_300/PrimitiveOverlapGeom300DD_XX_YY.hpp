#ifndef PrimitiveOverlapGeom300DD_XX_YY
#define PrimitiveOverlapGeom300DD_XX_YY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XX|1|D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom300DD_XX_YY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DD_XX_YY */
