#ifndef PrimitiveOverlapGeom300PF_Z_XXZ
#define PrimitiveOverlapGeom300PF_Z_XXZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Z|1|F_XXZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300PF_Z_XXZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PF_Z_XXZ */
