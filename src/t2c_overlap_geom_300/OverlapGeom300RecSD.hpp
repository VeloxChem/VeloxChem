#ifndef OverlapGeom300RecSD_hpp
#define OverlapGeom300RecSD_hpp
...
/**
 Evaluates <d^(3)/dA^(3)S|1|D>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom300SD(CSubMatrix*      matrix_xxx,
