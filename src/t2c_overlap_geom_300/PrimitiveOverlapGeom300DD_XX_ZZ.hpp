#ifndef PrimitiveOverlapGeom300DD_XX_ZZ
#define PrimitiveOverlapGeom300DD_XX_ZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XX|1|D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300DD_XX_ZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DD_XX_ZZ */
