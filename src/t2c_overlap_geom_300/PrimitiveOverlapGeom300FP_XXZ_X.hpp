#ifndef PrimitiveOverlapGeom300FP_XXZ_X
#define PrimitiveOverlapGeom300FP_XXZ_X
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XXZ|1|P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom300FP_XXZ_X(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300FP_XXZ_X */
