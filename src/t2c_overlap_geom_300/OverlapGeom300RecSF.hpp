#ifndef OverlapGeom300RecSF_hpp
#define OverlapGeom300RecSF_hpp
...
/**
 Evaluates <d^(3)/dA^(3)S|1|F>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom300SF(CSubMatrix*      matrix_xxx,
