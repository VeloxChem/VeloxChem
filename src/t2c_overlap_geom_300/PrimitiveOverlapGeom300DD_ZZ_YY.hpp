#ifndef PrimitiveOverlapGeom300DD_ZZ_YY
#define PrimitiveOverlapGeom300DD_ZZ_YY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_ZZ|1|D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom300DD_ZZ_YY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DD_ZZ_YY */
