#ifndef PrimitiveOverlapGeom300FD_XYZ_XX
#define PrimitiveOverlapGeom300FD_XYZ_XX
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XYZ|1|D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom300FD_XYZ_XX(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300FD_XYZ_XX */
