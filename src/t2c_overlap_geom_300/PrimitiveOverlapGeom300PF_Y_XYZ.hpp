#ifndef PrimitiveOverlapGeom300PF_Y_XYZ
#define PrimitiveOverlapGeom300PF_Y_XYZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Y|1|F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300PF_Y_XYZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PF_Y_XYZ */
