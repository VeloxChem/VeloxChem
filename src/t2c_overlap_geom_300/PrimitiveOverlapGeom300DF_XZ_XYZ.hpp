#ifndef PrimitiveOverlapGeom300DF_XZ_XYZ
#define PrimitiveOverlapGeom300DF_XZ_XYZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XZ|1|F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300DF_XZ_XYZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DF_XZ_XYZ */
