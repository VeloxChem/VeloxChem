#ifndef PrimitiveOverlapGeom300PF_Z_XXX
#define PrimitiveOverlapGeom300PF_Z_XXX
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Z|1|F_XXX> integrals.
...
*/
auto compPrimitiveOverlapGeom300PF_Z_XXX(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PF_Z_XXX */
