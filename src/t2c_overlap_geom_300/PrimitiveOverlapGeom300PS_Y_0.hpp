#ifndef PrimitiveOverlapGeom300PS_Y_0
#define PrimitiveOverlapGeom300PS_Y_0
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Y|1|S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom300PS_Y_0(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PS_Y_0 */
