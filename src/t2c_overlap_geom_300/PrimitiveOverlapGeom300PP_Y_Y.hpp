#ifndef PrimitiveOverlapGeom300PP_Y_Y
#define PrimitiveOverlapGeom300PP_Y_Y
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Y|1|P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom300PP_Y_Y(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PP_Y_Y */
