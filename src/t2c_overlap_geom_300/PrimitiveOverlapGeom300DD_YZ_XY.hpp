#ifndef PrimitiveOverlapGeom300DD_YZ_XY
#define PrimitiveOverlapGeom300DD_YZ_XY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YZ|1|D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom300DD_YZ_XY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DD_YZ_XY */
