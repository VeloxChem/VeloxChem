#ifndef PrimitiveOverlapGeom300FP_XZZ_Z
#define PrimitiveOverlapGeom300FP_XZZ_Z
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XZZ|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom300FP_XZZ_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300FP_XZZ_Z */
