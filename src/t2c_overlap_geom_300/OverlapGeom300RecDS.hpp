#ifndef OverlapGeom300RecDS_hpp
#define OverlapGeom300RecDS_hpp
...
/**
 Evaluates <d^(3)/dA^(3)D|1|S>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom300DS(CSubMatrix*      matrix_xxx,
