#ifndef PrimitiveOverlapGeom300PD_Y_XZ
#define PrimitiveOverlapGeom300PD_Y_XZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Y|1|D_XZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300PD_Y_XZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PD_Y_XZ */
