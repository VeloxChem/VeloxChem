#ifndef PrimitiveOverlapGeom300DF_XX_XYZ
#define PrimitiveOverlapGeom300DF_XX_XYZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XX|1|F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300DF_XX_XYZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DF_XX_XYZ */
