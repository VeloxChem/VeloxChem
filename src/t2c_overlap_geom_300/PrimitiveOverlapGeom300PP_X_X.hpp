#ifndef PrimitiveOverlapGeom300PP_X_X
#define PrimitiveOverlapGeom300PP_X_X
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_X|1|P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom300PP_X_X(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PP_X_X */
