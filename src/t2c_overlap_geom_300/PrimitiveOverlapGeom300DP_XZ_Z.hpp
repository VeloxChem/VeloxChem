#ifndef PrimitiveOverlapGeom300DP_XZ_Z
#define PrimitiveOverlapGeom300DP_XZ_Z
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XZ|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom300DP_XZ_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DP_XZ_Z */
