#ifndef PrimitiveOverlapGeom300FD_ZZZ_XX
#define PrimitiveOverlapGeom300FD_ZZZ_XX
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_ZZZ|1|D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom300FD_ZZZ_XX(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300FD_ZZZ_XX */
