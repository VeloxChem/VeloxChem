#ifndef PrimitiveOverlapGeom300PF_Z_XZZ
#define PrimitiveOverlapGeom300PF_Z_XZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Z|1|F_XZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300PF_Z_XZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PF_Z_XZZ */
