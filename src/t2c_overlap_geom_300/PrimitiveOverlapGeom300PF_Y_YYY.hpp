#ifndef PrimitiveOverlapGeom300PF_Y_YYY
#define PrimitiveOverlapGeom300PF_Y_YYY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Y|1|F_YYY> integrals.
...
*/
auto compPrimitiveOverlapGeom300PF_Y_YYY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PF_Y_YYY */
