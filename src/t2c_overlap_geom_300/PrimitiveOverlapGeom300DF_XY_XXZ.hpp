#ifndef PrimitiveOverlapGeom300DF_XY_XXZ
#define PrimitiveOverlapGeom300DF_XY_XXZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XY|1|F_XXZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300DF_XY_XXZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DF_XY_XXZ */
