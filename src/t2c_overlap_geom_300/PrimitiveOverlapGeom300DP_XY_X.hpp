#ifndef PrimitiveOverlapGeom300DP_XY_X
#define PrimitiveOverlapGeom300DP_XY_X
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XY|1|P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom300DP_XY_X(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DP_XY_X */
