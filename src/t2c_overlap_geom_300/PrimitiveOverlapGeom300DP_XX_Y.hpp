#ifndef PrimitiveOverlapGeom300DP_XX_Y
#define PrimitiveOverlapGeom300DP_XX_Y
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XX|1|P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom300DP_XX_Y(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DP_XX_Y */
