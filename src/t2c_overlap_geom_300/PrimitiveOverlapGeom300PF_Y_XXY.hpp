#ifndef PrimitiveOverlapGeom300PF_Y_XXY
#define PrimitiveOverlapGeom300PF_Y_XXY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Y|1|F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom300PF_Y_XXY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PF_Y_XXY */
