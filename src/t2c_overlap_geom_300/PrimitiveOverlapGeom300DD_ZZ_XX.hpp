#ifndef PrimitiveOverlapGeom300DD_ZZ_XX
#define PrimitiveOverlapGeom300DD_ZZ_XX
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_ZZ|1|D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom300DD_ZZ_XX(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DD_ZZ_XX */
