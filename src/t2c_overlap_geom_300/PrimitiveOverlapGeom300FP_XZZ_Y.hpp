#ifndef PrimitiveOverlapGeom300FP_XZZ_Y
#define PrimitiveOverlapGeom300FP_XZZ_Y
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XZZ|1|P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom300FP_XZZ_Y(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300FP_XZZ_Y */
