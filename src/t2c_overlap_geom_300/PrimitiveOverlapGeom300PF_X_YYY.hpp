#ifndef PrimitiveOverlapGeom300PF_X_YYY
#define PrimitiveOverlapGeom300PF_X_YYY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_X|1|F_YYY> integrals.
...
*/
auto compPrimitiveOverlapGeom300PF_X_YYY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PF_X_YYY */
