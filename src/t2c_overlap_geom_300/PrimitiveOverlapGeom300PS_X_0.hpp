#ifndef PrimitiveOverlapGeom300PS_X_0
#define PrimitiveOverlapGeom300PS_X_0
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_X|1|S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom300PS_X_0(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PS_X_0 */
