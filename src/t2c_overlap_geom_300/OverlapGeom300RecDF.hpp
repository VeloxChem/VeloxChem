#ifndef OverlapGeom300RecDF_hpp
#define OverlapGeom300RecDF_hpp
...
/**
 Evaluates <d^(3)/dA^(3)D|1|F>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom300DF(CSubMatrix*      matrix_xxx,
