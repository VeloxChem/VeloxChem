#ifndef PrimitiveOverlapGeom300PF_Z_XYY
#define PrimitiveOverlapGeom300PF_Z_XYY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Z|1|F_XYY> integrals.
...
*/
auto compPrimitiveOverlapGeom300PF_Z_XYY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PF_Z_XYY */
