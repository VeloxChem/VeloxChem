#ifndef PrimitiveOverlapGeom300PD_Z_XY
#define PrimitiveOverlapGeom300PD_Z_XY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Z|1|D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom300PD_Z_XY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PD_Z_XY */
