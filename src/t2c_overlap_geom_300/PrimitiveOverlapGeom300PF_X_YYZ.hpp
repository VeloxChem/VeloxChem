#ifndef PrimitiveOverlapGeom300PF_X_YYZ
#define PrimitiveOverlapGeom300PF_X_YYZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_X|1|F_YYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300PF_X_YYZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PF_X_YYZ */
