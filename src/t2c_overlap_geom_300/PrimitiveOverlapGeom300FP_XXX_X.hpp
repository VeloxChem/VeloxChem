#ifndef PrimitiveOverlapGeom300FP_XXX_X
#define PrimitiveOverlapGeom300FP_XXX_X
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XXX|1|P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom300FP_XXX_X(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300FP_XXX_X */
