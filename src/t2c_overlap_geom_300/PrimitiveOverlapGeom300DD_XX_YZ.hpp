#ifndef PrimitiveOverlapGeom300DD_XX_YZ
#define PrimitiveOverlapGeom300DD_XX_YZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XX|1|D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300DD_XX_YZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DD_XX_YZ */
