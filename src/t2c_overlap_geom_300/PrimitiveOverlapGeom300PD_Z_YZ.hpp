#ifndef PrimitiveOverlapGeom300PD_Z_YZ
#define PrimitiveOverlapGeom300PD_Z_YZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Z|1|D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300PD_Z_YZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PD_Z_YZ */
