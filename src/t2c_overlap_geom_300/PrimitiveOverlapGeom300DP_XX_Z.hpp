#ifndef PrimitiveOverlapGeom300DP_XX_Z
#define PrimitiveOverlapGeom300DP_XX_Z
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XX|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom300DP_XX_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DP_XX_Z */
