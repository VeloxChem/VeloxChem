#ifndef PrimitiveOverlapGeom300FP_XZZ_X
#define PrimitiveOverlapGeom300FP_XZZ_X
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XZZ|1|P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom300FP_XZZ_X(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300FP_XZZ_X */
