#ifndef PrimitiveOverlapGeom300DP_YZ_Y
#define PrimitiveOverlapGeom300DP_YZ_Y
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YZ|1|P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom300DP_YZ_Y(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DP_YZ_Y */
