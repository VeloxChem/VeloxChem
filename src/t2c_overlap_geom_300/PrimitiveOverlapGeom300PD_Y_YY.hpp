#ifndef PrimitiveOverlapGeom300PD_Y_YY
#define PrimitiveOverlapGeom300PD_Y_YY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Y|1|D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom300PD_Y_YY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PD_Y_YY */
