#ifndef PrimitiveOverlapGeom300FD_ZZZ_XY
#define PrimitiveOverlapGeom300FD_ZZZ_XY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_ZZZ|1|D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom300FD_ZZZ_XY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300FD_ZZZ_XY */
