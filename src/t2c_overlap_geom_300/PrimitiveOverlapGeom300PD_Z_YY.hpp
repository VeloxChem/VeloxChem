#ifndef PrimitiveOverlapGeom300PD_Z_YY
#define PrimitiveOverlapGeom300PD_Z_YY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Z|1|D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom300PD_Z_YY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PD_Z_YY */
