#ifndef PrimitiveOverlapGeom300DF_XZ_XXY
#define PrimitiveOverlapGeom300DF_XZ_XXY
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_XZ|1|F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom300DF_XZ_XXY(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DF_XZ_XXY */
