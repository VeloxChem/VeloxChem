#ifndef PrimitiveOverlapGeom300PP_Z_Y
#define PrimitiveOverlapGeom300PP_Z_Y
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Z|1|P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom300PP_Z_Y(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PP_Z_Y */
