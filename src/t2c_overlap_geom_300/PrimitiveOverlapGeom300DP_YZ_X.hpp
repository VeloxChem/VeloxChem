#ifndef PrimitiveOverlapGeom300DP_YZ_X
#define PrimitiveOverlapGeom300DP_YZ_X
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YZ|1|P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom300DP_YZ_X(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DP_YZ_X */
