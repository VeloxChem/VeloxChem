#ifndef PrimitiveOverlapGeom300PF_Z_YZZ
#define PrimitiveOverlapGeom300PF_Z_YZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Z|1|F_YZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300PF_Z_YZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PF_Z_YZZ */
