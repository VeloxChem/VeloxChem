#ifndef PrimitiveOverlapGeom300PP_Y_Z
#define PrimitiveOverlapGeom300PP_Y_Z
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Y|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom300PP_Y_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PP_Y_Z */
