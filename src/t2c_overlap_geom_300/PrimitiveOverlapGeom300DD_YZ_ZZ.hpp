#ifndef PrimitiveOverlapGeom300DD_YZ_ZZ
#define PrimitiveOverlapGeom300DD_YZ_ZZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_YZ|1|D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300DD_YZ_ZZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DD_YZ_ZZ */
