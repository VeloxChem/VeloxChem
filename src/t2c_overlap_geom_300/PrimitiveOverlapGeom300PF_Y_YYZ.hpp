#ifndef PrimitiveOverlapGeom300PF_Y_YYZ
#define PrimitiveOverlapGeom300PF_Y_YYZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_Y|1|F_YYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300PF_Y_YYZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PF_Y_YYZ */
