#ifndef PrimitiveOverlapGeom300PD_X_XX
#define PrimitiveOverlapGeom300PD_X_XX
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_X|1|D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom300PD_X_XX(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PD_X_XX */
