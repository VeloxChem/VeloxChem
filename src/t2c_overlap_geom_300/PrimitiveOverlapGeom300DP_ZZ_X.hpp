#ifndef PrimitiveOverlapGeom300DP_ZZ_X
#define PrimitiveOverlapGeom300DP_ZZ_X
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)D_ZZ|1|P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom300DP_ZZ_X(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300DP_ZZ_X */
