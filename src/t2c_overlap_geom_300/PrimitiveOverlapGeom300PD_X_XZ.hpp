#ifndef PrimitiveOverlapGeom300PD_X_XZ
#define PrimitiveOverlapGeom300PD_X_XZ
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_X|1|D_XZ> integrals.
...
*/
auto compPrimitiveOverlapGeom300PD_X_XZ(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PD_X_XZ */
