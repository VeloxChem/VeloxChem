#ifndef PrimitiveOverlapGeom300PP_X_Z
#define PrimitiveOverlapGeom300PP_X_Z
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)P_X|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom300PP_X_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300PP_X_Z */
