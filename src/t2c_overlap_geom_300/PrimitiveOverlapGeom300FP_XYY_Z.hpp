#ifndef PrimitiveOverlapGeom300FP_XYY_Z
#define PrimitiveOverlapGeom300FP_XYY_Z
...
/**
 Evaluates block of primitive <d^(3)/dA^(3)F_XYY|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom300FP_XYY_Z(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveOverlapGeom300FP_XYY_Z */
