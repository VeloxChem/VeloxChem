                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom2000_pdsp(324, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom2000_pdsp(270, ket_dim);
    ...
    {
        cart_buffer_0_geom2000_pdsp.zero();

        spher_buffer_0_geom2000_pdsp.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom2000_pdsp_0(prim_buffer_0_geom2000_pdsp, prim_buffer_0_pdsp, prim_buffer_0_fdsp, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom2000_pdsp, prim_buffer_0_geom2000_pdsp, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 2, 0, 1>(spher_buffer_0_geom2000_pdsp, cart_spher_buffer_0_geom2000_pdsp);

        distributor->distribute(spher_buffer_0_geom2000_pdsp, a_indices, b_indices, c_indices, d_indices, 1, 2, 0, 1, 2, 0, 0, 0, i, ket_indices);
    }
}
