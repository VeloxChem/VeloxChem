#ifndef ElectronRepulsionGeom2000RecSSSD_hpp
#define ElectronRepulsionGeom2000RecSSSD_hpp
...
/// Computes (SS|1/|r-r'||SD)  integrals for two GTOs pair blocks.
...
template <class T>
auto
comp_electron_repulsion_geom2000_sssd(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom2000_sssd(36, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom2000_sssd(30, ket_dim);
    ...
    {
        cart_buffer_0_geom2000_sssd.zero();

        spher_buffer_0_geom2000_sssd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom2000_sssd_0(prim_buffer_0_geom2000_sssd, prim_buffer_0_sssd, prim_buffer_0_dssd, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom2000_sssd, prim_buffer_0_geom2000_sssd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 0, 0, 2>(spher_buffer_0_geom2000_sssd, cart_spher_buffer_0_geom2000_sssd);

        distributor->distribute(spher_buffer_0_geom2000_sssd, a_indices, b_indices, c_indices, d_indices, 0, 0, 0, 2, 2, 0, 0, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom2000RecSSSD_hpp */
