...
#include "ElectronRepulsionPrimRecGDSS.hpp"
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> prim_buffer_2_dsss(6, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_1_fpss(30, ket_pdim);

    CSimdArray<double> prim_buffer_0_fdss(60, ket_pdim);

    CSimdArray<double> prim_buffer_1_fdss(60, ket_pdim);

    CSimdArray<double> prim_buffer_0_gdss(90, ket_pdim);

    // allocate aligned Cartesian integrals

    CSimdArray<double> cart_buffer_0_geom2000_ddss(216, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom2000_ddss(150, ket_dim);
    ...
    {
        cart_buffer_0_geom2000_ddss.zero();

        spher_buffer_0_geom2000_ddss.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            erirec::comp_prim_electron_repulsion_dsss(prim_buffer_2_dsss, prim_buffer_2_ssss, prim_buffer_3_ssss, prim_buffer_2_psss, prim_buffer_3_psss, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_fpss(prim_buffer_1_fpss, prim_buffer_1_ppss, prim_buffer_2_ppss, prim_buffer_1_dsss, prim_buffer_2_dsss, prim_buffer_1_dpss, prim_buffer_2_dpss, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_gdss(prim_buffer_0_gdss, prim_buffer_0_ddss, prim_buffer_1_ddss, prim_buffer_0_fpss, prim_buffer_1_fpss, prim_buffer_0_fdss, prim_buffer_1_fdss, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);

            t4c_geom::comp_geom2000_ddss_0(prim_buffer_0_geom2000_ddss, prim_buffer_0_sdss, prim_buffer_0_ddss, prim_buffer_0_gdss, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom2000_ddss, prim_buffer_0_geom2000_ddss, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<2, 2, 0, 0>(spher_buffer_0_geom2000_ddss, cart_spher_buffer_0_geom2000_ddss);

        distributor->distribute(spher_buffer_0_geom2000_ddss, a_indices, b_indices, c_indices, d_indices, 2, 2, 0, 0, 2, 0, 0, 0, i, ket_indices);
    }
}
