#ifndef ElectronRepulsionGeom2000RecSSDD_hpp
#define ElectronRepulsionGeom2000RecSSDD_hpp
...
template <class T>
auto
comp_electron_repulsion_geom2000_ssdd(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom2000_ssdd(216, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom2000_ssdd(150, ket_dim);
    ...
    {
        cart_buffer_0_geom2000_ssdd.zero();

        spher_buffer_0_geom2000_ssdd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom2000_ssdd_0(prim_buffer_0_geom2000_ssdd, prim_buffer_0_ssdd, prim_buffer_0_dsdd, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom2000_ssdd, prim_buffer_0_geom2000_ssdd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 0, 2, 2>(spher_buffer_0_geom2000_ssdd, cart_spher_buffer_0_geom2000_ssdd);

        distributor->distribute(spher_buffer_0_geom2000_ssdd, a_indices, b_indices, c_indices, d_indices, 0, 0, 2, 2, 2, 0, 0, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom2000RecSSDD_hpp */
