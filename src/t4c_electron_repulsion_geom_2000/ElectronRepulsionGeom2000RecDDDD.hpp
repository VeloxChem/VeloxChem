...
#include "ElectronRepulsionPrimRecGDDD.hpp"
...
#include "GeomDeriv2000OfScalarForDDDD.hpp"
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> prim_buffer_3_psdp(54, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_3_psdd(108, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_3_ppdd(324, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_3_pdds(108, ket_pdim);

    CSimdArray<double> prim_buffer_1_pddp(324, ket_pdim);

    CSimdArray<double> prim_buffer_2_pddp(324, ket_pdim);

    CSimdArray<double> prim_buffer_3_pddp(324, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_3_pddd(648, ket_pdim);

    CSimdArray<double> prim_buffer_0_dsdd(216, ket_pdim);

    CSimdArray<double> prim_buffer_1_dsdd(216, ket_pdim);

    CSimdArray<double> prim_buffer_2_dsdd(216, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_2_dpdp(324, ket_pdim);

    CSimdArray<double> prim_buffer_0_dpdd(648, ket_pdim);

    CSimdArray<double> prim_buffer_1_dpdd(648, ket_pdim);

    CSimdArray<double> prim_buffer_2_dpdd(648, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_2_ddds(216, ket_pdim);

    CSimdArray<double> prim_buffer_1_dddp(648, ket_pdim);

    CSimdArray<double> prim_buffer_2_dddp(648, ket_pdim);

    CSimdArray<double> prim_buffer_0_dddd(1296, ket_pdim);

    CSimdArray<double> prim_buffer_1_dddd(1296, ket_pdim);

    CSimdArray<double> prim_buffer_2_dddd(1296, ket_pdim);

    CSimdArray<double> prim_buffer_0_fpdd(1080, ket_pdim);

    CSimdArray<double> prim_buffer_1_fpdd(1080, ket_pdim);

    CSimdArray<double> prim_buffer_1_fdpd(1080, ket_pdim);

    CSimdArray<double> prim_buffer_1_fddp(1080, ket_pdim);

    CSimdArray<double> prim_buffer_0_fddd(2160, ket_pdim);

    CSimdArray<double> prim_buffer_1_fddd(2160, ket_pdim);

    CSimdArray<double> prim_buffer_0_gddd(3240, ket_pdim);

    // allocate aligned Cartesian integrals

    CSimdArray<double> cart_buffer_0_geom2000_dddd(7776, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom2000_dddd(3750, ket_dim);
    ...
    {
        cart_buffer_0_geom2000_dddd.zero();

        spher_buffer_0_geom2000_dddd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            erirec::comp_prim_electron_repulsion_psdp(prim_buffer_3_psdp, prim_buffer_4_sspp, prim_buffer_4_ssds, prim_buffer_3_ssdp, prim_buffer_4_ssdp, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_psdd(prim_buffer_3_psdd, prim_buffer_4_sspd, prim_buffer_4_ssdp, prim_buffer_3_ssdd, prim_buffer_4_ssdd, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_ppds(prim_buffer_3_ppds, prim_buffer_3_ssds, prim_buffer_4_ssds, prim_buffer_4_spps, prim_buffer_3_spds, prim_buffer_4_spds, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_ppdp(prim_buffer_3_ppdp, prim_buffer_3_ssdp, prim_buffer_4_ssdp, prim_buffer_4_sppp, prim_buffer_4_spds, prim_buffer_3_spdp, prim_buffer_4_spdp, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_ppdd(prim_buffer_3_ppdd, prim_buffer_3_ssdd, prim_buffer_4_ssdd, prim_buffer_4_sppd, prim_buffer_4_spdp, prim_buffer_3_spdd, prim_buffer_4_spdd, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_pdds(prim_buffer_3_pdds, prim_buffer_3_spds, prim_buffer_4_spds, prim_buffer_4_sdps, prim_buffer_3_sdds, prim_buffer_4_sdds, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_pddp(prim_buffer_3_pddp, prim_buffer_3_spdp, prim_buffer_4_spdp, prim_buffer_4_sdpp, prim_buffer_4_sdds, prim_buffer_3_sddp, prim_buffer_4_sddp, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_pddd(prim_buffer_3_pddd, prim_buffer_3_spdd, prim_buffer_4_spdd, prim_buffer_4_sdpd, prim_buffer_4_sddp, prim_buffer_3_sddd, prim_buffer_4_sddd, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_dsdd(prim_buffer_2_dsdd, prim_buffer_2_ssdd, prim_buffer_3_ssdd, prim_buffer_3_pspd, prim_buffer_3_psdp, prim_buffer_2_psdd, prim_buffer_3_psdd, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_dpdp(prim_buffer_2_dpdp, prim_buffer_2_spdp, prim_buffer_3_spdp, prim_buffer_2_psdp, prim_buffer_3_psdp, prim_buffer_3_pppp, prim_buffer_3_ppds, prim_buffer_2_ppdp, prim_buffer_3_ppdp, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_dpdd(prim_buffer_2_dpdd, prim_buffer_2_spdd, prim_buffer_3_spdd, prim_buffer_2_psdd, prim_buffer_3_psdd, prim_buffer_3_pppd, prim_buffer_3_ppdp, prim_buffer_2_ppdd, prim_buffer_3_ppdd, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_ddds(prim_buffer_2_ddds, prim_buffer_2_sdds, prim_buffer_3_sdds, prim_buffer_2_ppds, prim_buffer_3_ppds, prim_buffer_3_pdps, prim_buffer_2_pdds, prim_buffer_3_pdds, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_dddp(prim_buffer_2_dddp, prim_buffer_2_sddp, prim_buffer_3_sddp, prim_buffer_2_ppdp, prim_buffer_3_ppdp, prim_buffer_3_pdpp, prim_buffer_3_pdds, prim_buffer_2_pddp, prim_buffer_3_pddp, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_dddd(prim_buffer_2_dddd, prim_buffer_2_sddd, prim_buffer_3_sddd, prim_buffer_2_ppdd, prim_buffer_3_ppdd, prim_buffer_3_pdpd, prim_buffer_3_pddp, prim_buffer_2_pddd, prim_buffer_3_pddd, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_fpdd(prim_buffer_1_fpdd, prim_buffer_1_ppdd, prim_buffer_2_ppdd, prim_buffer_1_dsdd, prim_buffer_2_dsdd, prim_buffer_2_dppd, prim_buffer_2_dpdp, prim_buffer_1_dpdd, prim_buffer_2_dpdd, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_fddp(prim_buffer_1_fddp, prim_buffer_1_pddp, prim_buffer_2_pddp, prim_buffer_1_dpdp, prim_buffer_2_dpdp, prim_buffer_2_ddpp, prim_buffer_2_ddds, prim_buffer_1_dddp, prim_buffer_2_dddp, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_fddd(prim_buffer_1_fddd, prim_buffer_1_pddd, prim_buffer_2_pddd, prim_buffer_1_dpdd, prim_buffer_2_dpdd, prim_buffer_2_ddpd, prim_buffer_2_dddp, prim_buffer_1_dddd, prim_buffer_2_dddd, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);

            erirec::comp_prim_electron_repulsion_gddd(prim_buffer_0_gddd, prim_buffer_0_dddd, prim_buffer_1_dddd, prim_buffer_0_fpdd, prim_buffer_1_fpdd, prim_buffer_1_fdpd, prim_buffer_1_fddp, prim_buffer_0_fddd, prim_buffer_1_fddd, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);

            t4c_geom::comp_geom2000_dddd_0(prim_buffer_0_geom2000_dddd, prim_buffer_0_sddd, prim_buffer_0_dddd, prim_buffer_0_gddd, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom2000_dddd, prim_buffer_0_geom2000_dddd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<2, 2, 2, 2>(spher_buffer_0_geom2000_dddd, cart_spher_buffer_0_geom2000_dddd);

        distributor->distribute(spher_buffer_0_geom2000_dddd, a_indices, b_indices, c_indices, d_indices, 2, 2, 2, 2, 2, 0, 0, 0, i, ket_indices);
    }
}
