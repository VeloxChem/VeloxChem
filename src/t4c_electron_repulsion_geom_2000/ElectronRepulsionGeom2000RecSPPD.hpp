#ifndef ElectronRepulsionGeom2000RecSPPD_hpp
#define ElectronRepulsionGeom2000RecSPPD_hpp
...
template <class T>
auto
comp_electron_repulsion_geom2000_sppd(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom2000_sppd(324, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom2000_sppd(270, ket_dim);
    ...
    {
        cart_buffer_0_geom2000_sppd.zero();

        spher_buffer_0_geom2000_sppd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom2000_sppd_0(prim_buffer_0_geom2000_sppd, prim_buffer_0_sppd, prim_buffer_0_dppd, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom2000_sppd, prim_buffer_0_geom2000_sppd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 1, 1, 2>(spher_buffer_0_geom2000_sppd, cart_spher_buffer_0_geom2000_sppd);

        distributor->distribute(spher_buffer_0_geom2000_sppd, a_indices, b_indices, c_indices, d_indices, 0, 1, 1, 2, 2, 0, 0, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom2000RecSPPD_hpp */
