...
#include "ElectronRepulsionPrimRecDSSD.hpp"
#include "ElectronRepulsionPrimRecFDSD.hpp"
#include "ElectronRepulsionPrimRecFDSP.hpp"
#include "ElectronRepulsionPrimRecFPSD.hpp"
#include "ElectronRepulsionPrimRecGDSD.hpp"
...
/// Computes (DD|1/|r-r'||SD)  integrals for two GTOs pair blocks.
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> prim_buffer_0_dssd(36, ket_pdim);

    CSimdArray<double> prim_buffer_1_dssd(36, ket_pdim);

    CSimdArray<double> prim_buffer_2_dssd(36, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_0_ddsd(216, ket_pdim);

    CSimdArray<double> prim_buffer_1_ddsd(216, ket_pdim);

    CSimdArray<double> prim_buffer_2_ddsd(216, ket_pdim);

    CSimdArray<double> prim_buffer_0_fpsd(180, ket_pdim);

    CSimdArray<double> prim_buffer_1_fpsd(180, ket_pdim);

    CSimdArray<double> prim_buffer_1_fdsp(180, ket_pdim);

    CSimdArray<double> prim_buffer_0_fdsd(360, ket_pdim);

    CSimdArray<double> prim_buffer_1_fdsd(360, ket_pdim);

    CSimdArray<double> prim_buffer_0_gdsd(540, ket_pdim);

    // allocate aligned Cartesian integrals

    CSimdArray<double> cart_buffer_0_geom2000_ddsd(1296, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom2000_ddsd(750, ket_dim);
    ...
    {
        cart_buffer_0_geom2000_ddsd.zero();

        spher_buffer_0_geom2000_ddsd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            erirec::comp_prim_electron_repulsion_dssd(prim_buffer_0_dssd, prim_buffer_0_sssd, prim_buffer_1_sssd, prim_buffer_1_pssp, prim_buffer_0_pssd, prim_buffer_1_pssd, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);

            erirec::comp_prim_electron_repulsion_dssd(prim_buffer_1_dssd, prim_buffer_1_sssd, prim_buffer_2_sssd, prim_buffer_2_pssp, prim_buffer_1_pssd, prim_buffer_2_pssd, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);

            erirec::comp_prim_electron_repulsion_dssd(prim_buffer_2_dssd, prim_buffer_2_sssd, prim_buffer_3_sssd, prim_buffer_3_pssp, prim_buffer_2_pssd, prim_buffer_3_pssd, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_ddsd(prim_buffer_0_ddsd, prim_buffer_0_sdsd, prim_buffer_1_sdsd, prim_buffer_0_ppsd, prim_buffer_1_ppsd, prim_buffer_1_pdsp, prim_buffer_0_pdsd, prim_buffer_1_pdsd, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_fpsd(prim_buffer_0_fpsd, prim_buffer_0_ppsd, prim_buffer_1_ppsd, prim_buffer_0_dssd, prim_buffer_1_dssd, prim_buffer_1_dpsp, prim_buffer_0_dpsd, prim_buffer_1_dpsd, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);

            erirec::comp_prim_electron_repulsion_fpsd(prim_buffer_1_fpsd, prim_buffer_1_ppsd, prim_buffer_2_ppsd, prim_buffer_1_dssd, prim_buffer_2_dssd, prim_buffer_2_dpsp, prim_buffer_1_dpsd, prim_buffer_2_dpsd, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_fdsd(prim_buffer_0_fdsd, prim_buffer_0_pdsd, prim_buffer_1_pdsd, prim_buffer_0_dpsd, prim_buffer_1_dpsd, prim_buffer_1_ddsp, prim_buffer_0_ddsd, prim_buffer_1_ddsd, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_gdsd(prim_buffer_0_gdsd, prim_buffer_0_ddsd, prim_buffer_1_ddsd, prim_buffer_0_fpsd, prim_buffer_1_fpsd, prim_buffer_1_fdsp, prim_buffer_0_fdsd, prim_buffer_1_fdsd, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);

            t4c_geom::comp_geom2000_ddsd_0(prim_buffer_0_geom2000_ddsd, prim_buffer_0_sdsd, prim_buffer_0_ddsd, prim_buffer_0_gdsd, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom2000_ddsd, prim_buffer_0_geom2000_ddsd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<2, 2, 0, 2>(spher_buffer_0_geom2000_ddsd, cart_spher_buffer_0_geom2000_ddsd);

        distributor->distribute(spher_buffer_0_geom2000_ddsd, a_indices, b_indices, c_indices, d_indices, 2, 2, 0, 2, 2, 0, 0, 0, i, ket_indices);
    }
}
