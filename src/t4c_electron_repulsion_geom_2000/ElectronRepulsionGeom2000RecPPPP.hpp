                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom2000_pppp(486, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom2000_pppp(486, ket_dim);
    ...
    {
        cart_buffer_0_geom2000_pppp.zero();

        spher_buffer_0_geom2000_pppp.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom2000_pppp_0(prim_buffer_0_geom2000_pppp, prim_buffer_0_pppp, prim_buffer_0_fppp, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom2000_pppp, prim_buffer_0_geom2000_pppp, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 1, 1, 1>(spher_buffer_0_geom2000_pppp, cart_spher_buffer_0_geom2000_pppp);

        distributor->distribute(spher_buffer_0_geom2000_pppp, a_indices, b_indices, c_indices, d_indices, 1, 1, 1, 1, 2, 0, 0, 0, i, ket_indices);
    }
}
