#ifndef ElectronRepulsionGeom2000RecDDPP_hpp
#define ElectronRepulsionGeom2000RecDDPP_hpp
...
#include "ElectronRepulsionPrimRecFDPS.hpp"
#include "ElectronRepulsionPrimRecFDSP.hpp"
#include "ElectronRepulsionPrimRecFPPP.hpp"
#include "ElectronRepulsionPrimRecGDPP.hpp"
...
template <class T>
auto
comp_electron_repulsion_geom2000_ddpp(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> prim_buffer_3_pssp(9, ket_pdim);

    CSimdArray<double> prim_buffer_1_psps(9, ket_pdim);

    CSimdArray<double> prim_buffer_2_psps(9, ket_pdim);

    CSimdArray<double> prim_buffer_3_psps(9, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_3_ppss(9, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_2_dspp(54, ket_pdim);

    CSimdArray<double> prim_buffer_1_dpsp(54, ket_pdim);

    CSimdArray<double> prim_buffer_2_dpsp(54, ket_pdim);

    CSimdArray<double> prim_buffer_1_dpps(54, ket_pdim);

    CSimdArray<double> prim_buffer_2_dpps(54, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_1_fppp(270, ket_pdim);

    CSimdArray<double> prim_buffer_1_fdsp(180, ket_pdim);

    CSimdArray<double> prim_buffer_1_fdps(180, ket_pdim);

    CSimdArray<double> prim_buffer_0_fdpp(540, ket_pdim);

    CSimdArray<double> prim_buffer_1_fdpp(540, ket_pdim);

    CSimdArray<double> prim_buffer_0_gdpp(810, ket_pdim);

    // allocate aligned Cartesian integrals

    CSimdArray<double> cart_buffer_0_geom2000_ddpp(1944, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom2000_ddpp(1350, ket_dim);
    ...
    {
        cart_buffer_0_geom2000_ddpp.zero();

        spher_buffer_0_geom2000_ddpp.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            erirec::comp_prim_electron_repulsion_pssp(prim_buffer_3_pssp, prim_buffer_4_ssss, prim_buffer_3_sssp, prim_buffer_4_sssp, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_psps(prim_buffer_3_psps, prim_buffer_4_ssss, prim_buffer_3_ssps, prim_buffer_4_ssps, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_ppss(prim_buffer_3_ppss, prim_buffer_3_ssss, prim_buffer_4_ssss, prim_buffer_3_spss, prim_buffer_4_spss, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_dspp(prim_buffer_2_dspp, prim_buffer_2_sspp, prim_buffer_3_sspp, prim_buffer_3_pssp, prim_buffer_3_psps, prim_buffer_2_pspp, prim_buffer_3_pspp, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_dpsp(prim_buffer_2_dpsp, prim_buffer_2_spsp, prim_buffer_3_spsp, prim_buffer_2_pssp, prim_buffer_3_pssp, prim_buffer_3_ppss, prim_buffer_2_ppsp, prim_buffer_3_ppsp, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_dpps(prim_buffer_2_dpps, prim_buffer_2_spps, prim_buffer_3_spps, prim_buffer_2_psps, prim_buffer_3_psps, prim_buffer_3_ppss, prim_buffer_2_ppps, prim_buffer_3_ppps, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_ddss(prim_buffer_2_ddss, prim_buffer_2_sdss, prim_buffer_3_sdss, prim_buffer_2_ppss, prim_buffer_3_ppss, prim_buffer_2_pdss, prim_buffer_3_pdss, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_ddps(prim_buffer_1_ddps, prim_buffer_1_sdps, prim_buffer_2_sdps, prim_buffer_1_ppps, prim_buffer_2_ppps, prim_buffer_2_pdss, prim_buffer_1_pdps, prim_buffer_2_pdps, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_fppp(prim_buffer_1_fppp, prim_buffer_1_pppp, prim_buffer_2_pppp, prim_buffer_1_dspp, prim_buffer_2_dspp, prim_buffer_2_dpsp, prim_buffer_2_dpps, prim_buffer_1_dppp, prim_buffer_2_dppp, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);

            erirec::comp_prim_electron_repulsion_fdsp(prim_buffer_1_fdsp, prim_buffer_1_pdsp, prim_buffer_2_pdsp, prim_buffer_1_dpsp, prim_buffer_2_dpsp, prim_buffer_2_ddss, prim_buffer_1_ddsp, prim_buffer_2_ddsp, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);

            erirec::comp_prim_electron_repulsion_fdps(prim_buffer_1_fdps, prim_buffer_1_pdps, prim_buffer_2_pdps, prim_buffer_1_dpps, prim_buffer_2_dpps, prim_buffer_2_ddss, prim_buffer_1_ddps, prim_buffer_2_ddps, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);

            erirec::comp_prim_electron_repulsion_fdpp(prim_buffer_0_fdpp, prim_buffer_0_pdpp, prim_buffer_1_pdpp, prim_buffer_0_dppp, prim_buffer_1_dppp, prim_buffer_1_ddsp, prim_buffer_1_ddps, prim_buffer_0_ddpp, prim_buffer_1_ddpp, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_gdpp(prim_buffer_0_gdpp, prim_buffer_0_ddpp, prim_buffer_1_ddpp, prim_buffer_0_fppp, prim_buffer_1_fppp, prim_buffer_1_fdsp, prim_buffer_1_fdps, prim_buffer_0_fdpp, prim_buffer_1_fdpp, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);

            t4c_geom::comp_geom2000_ddpp_0(prim_buffer_0_geom2000_ddpp, prim_buffer_0_sdpp, prim_buffer_0_ddpp, prim_buffer_0_gdpp, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom2000_ddpp, prim_buffer_0_geom2000_ddpp, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<2, 2, 1, 1>(spher_buffer_0_geom2000_ddpp, cart_spher_buffer_0_geom2000_ddpp);

        distributor->distribute(spher_buffer_0_geom2000_ddpp, a_indices, b_indices, c_indices, d_indices, 2, 2, 1, 1, 2, 0, 0, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom2000RecDDPP_hpp */
