                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom2000_sdpd(648, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom2000_sdpd(450, ket_dim);
    ...
    {
        cart_buffer_0_geom2000_sdpd.zero();

        spher_buffer_0_geom2000_sdpd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom2000_sdpd_0(prim_buffer_0_geom2000_sdpd, prim_buffer_0_sdpd, prim_buffer_0_ddpd, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom2000_sdpd, prim_buffer_0_geom2000_sdpd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 2, 1, 2>(spher_buffer_0_geom2000_sdpd, cart_spher_buffer_0_geom2000_sdpd);

        distributor->distribute(spher_buffer_0_geom2000_sdpd, a_indices, b_indices, c_indices, d_indices, 0, 2, 1, 2, 2, 0, 0, 0, i, ket_indices);
    }
}
