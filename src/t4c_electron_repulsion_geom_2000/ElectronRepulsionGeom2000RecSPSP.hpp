#ifndef ElectronRepulsionGeom2000RecSPSP_hpp
#define ElectronRepulsionGeom2000RecSPSP_hpp
...
/// Computes (SP|1/|r-r'||SP)  integrals for two GTOs pair blocks.
...
template <class T>
auto
comp_electron_repulsion_geom2000_spsp(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom2000_spsp(54, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom2000_spsp(54, ket_dim);
    ...
    {
        cart_buffer_0_geom2000_spsp.zero();

        spher_buffer_0_geom2000_spsp.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom2000_spsp_0(prim_buffer_0_geom2000_spsp, prim_buffer_0_spsp, prim_buffer_0_dpsp, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom2000_spsp, prim_buffer_0_geom2000_spsp, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 1, 0, 1>(spher_buffer_0_geom2000_spsp, cart_spher_buffer_0_geom2000_spsp);

        distributor->distribute(spher_buffer_0_geom2000_spsp, a_indices, b_indices, c_indices, d_indices, 0, 1, 0, 1, 2, 0, 0, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom2000RecSPSP_hpp */
