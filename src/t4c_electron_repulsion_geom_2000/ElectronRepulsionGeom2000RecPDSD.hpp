                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom2000_pdsd(648, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom2000_pdsd(450, ket_dim);
    ...
    {
        cart_buffer_0_geom2000_pdsd.zero();

        spher_buffer_0_geom2000_pdsd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom2000_pdsd_0(prim_buffer_0_geom2000_pdsd, prim_buffer_0_pdsd, prim_buffer_0_fdsd, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom2000_pdsd, prim_buffer_0_geom2000_pdsd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 2, 0, 2>(spher_buffer_0_geom2000_pdsd, cart_spher_buffer_0_geom2000_pdsd);

        distributor->distribute(spher_buffer_0_geom2000_pdsd, a_indices, b_indices, c_indices, d_indices, 1, 2, 0, 2, 2, 0, 0, 0, i, ket_indices);
    }
}
