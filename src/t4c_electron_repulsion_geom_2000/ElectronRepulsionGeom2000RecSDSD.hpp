#ifndef ElectronRepulsionGeom2000RecSDSD_hpp
#define ElectronRepulsionGeom2000RecSDSD_hpp
...
/// Computes (SD|1/|r-r'||SD)  integrals for two GTOs pair blocks.
...
template <class T>
auto
comp_electron_repulsion_geom2000_sdsd(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom2000_sdsd(216, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom2000_sdsd(150, ket_dim);
    ...
    {
        cart_buffer_0_geom2000_sdsd.zero();

        spher_buffer_0_geom2000_sdsd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom2000_sdsd_0(prim_buffer_0_geom2000_sdsd, prim_buffer_0_sdsd, prim_buffer_0_ddsd, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom2000_sdsd, prim_buffer_0_geom2000_sdsd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 2, 0, 2>(spher_buffer_0_geom2000_sdsd, cart_spher_buffer_0_geom2000_sdsd);

        distributor->distribute(spher_buffer_0_geom2000_sdsd, a_indices, b_indices, c_indices, d_indices, 0, 2, 0, 2, 2, 0, 0, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom2000RecSDSD_hpp */
