                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom2000_pdss(108, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom2000_pdss(90, ket_dim);
    ...
    {
        cart_buffer_0_geom2000_pdss.zero();

        spher_buffer_0_geom2000_pdss.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom2000_pdss_0(prim_buffer_0_geom2000_pdss, prim_buffer_0_pdss, prim_buffer_0_fdss, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom2000_pdss, prim_buffer_0_geom2000_pdss, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 2, 0, 0>(spher_buffer_0_geom2000_pdss, cart_spher_buffer_0_geom2000_pdss);

        distributor->distribute(spher_buffer_0_geom2000_pdss, a_indices, b_indices, c_indices, d_indices, 1, 2, 0, 0, 2, 0, 0, 0, i, ket_indices);
    }
}
