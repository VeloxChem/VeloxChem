                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom2000_sdss(36, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom2000_sdss(30, ket_dim);
    ...
    {
        cart_buffer_0_geom2000_sdss.zero();

        spher_buffer_0_geom2000_sdss.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom2000_sdss_0(prim_buffer_0_geom2000_sdss, prim_buffer_0_sdss, prim_buffer_0_ddss, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom2000_sdss, prim_buffer_0_geom2000_sdss, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 2, 0, 0>(spher_buffer_0_geom2000_sdss, cart_spher_buffer_0_geom2000_sdss);

        distributor->distribute(spher_buffer_0_geom2000_sdss, a_indices, b_indices, c_indices, d_indices, 0, 2, 0, 0, 2, 0, 0, 0, i, ket_indices);
    }
}
