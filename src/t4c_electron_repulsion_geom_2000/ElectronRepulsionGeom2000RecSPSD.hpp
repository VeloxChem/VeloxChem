                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom2000_spsd(108, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom2000_spsd(90, ket_dim);
    ...
    {
        cart_buffer_0_geom2000_spsd.zero();

        spher_buffer_0_geom2000_spsd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom2000_spsd_0(prim_buffer_0_geom2000_spsd, prim_buffer_0_spsd, prim_buffer_0_dpsd, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom2000_spsd, prim_buffer_0_geom2000_spsd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 1, 0, 2>(spher_buffer_0_geom2000_spsd, cart_spher_buffer_0_geom2000_spsd);

        distributor->distribute(spher_buffer_0_geom2000_spsd, a_indices, b_indices, c_indices, d_indices, 0, 1, 0, 2, 2, 0, 0, 0, i, ket_indices);
    }
}
