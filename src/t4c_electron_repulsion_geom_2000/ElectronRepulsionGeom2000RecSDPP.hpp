                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom2000_sdpp(324, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom2000_sdpp(270, ket_dim);
    ...
    {
        cart_buffer_0_geom2000_sdpp.zero();

        spher_buffer_0_geom2000_sdpp.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom2000_sdpp_0(prim_buffer_0_geom2000_sdpp, prim_buffer_0_sdpp, prim_buffer_0_ddpp, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom2000_sdpp, prim_buffer_0_geom2000_sdpp, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 2, 1, 1>(spher_buffer_0_geom2000_sdpp, cart_spher_buffer_0_geom2000_sdpp);

        distributor->distribute(spher_buffer_0_geom2000_sdpp, a_indices, b_indices, c_indices, d_indices, 0, 2, 1, 1, 2, 0, 0, 0, i, ket_indices);
    }
}
