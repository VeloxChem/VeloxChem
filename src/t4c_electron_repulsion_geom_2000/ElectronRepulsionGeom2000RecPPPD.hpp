                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom2000_pppd(972, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom2000_pppd(810, ket_dim);
    ...
    {
        cart_buffer_0_geom2000_pppd.zero();

        spher_buffer_0_geom2000_pppd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom2000_pppd_0(prim_buffer_0_geom2000_pppd, prim_buffer_0_pppd, prim_buffer_0_fppd, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom2000_pppd, prim_buffer_0_geom2000_pppd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 1, 1, 2>(spher_buffer_0_geom2000_pppd, cart_spher_buffer_0_geom2000_pppd);

        distributor->distribute(spher_buffer_0_geom2000_pppd, a_indices, b_indices, c_indices, d_indices, 1, 1, 1, 2, 2, 0, 0, 0, i, ket_indices);
    }
}
