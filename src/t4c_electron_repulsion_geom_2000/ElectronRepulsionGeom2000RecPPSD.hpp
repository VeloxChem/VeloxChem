...
/// Computes (PP|1/|r-r'||SD)  integrals for two GTOs pair blocks.
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom2000_ppsd(324, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom2000_ppsd(270, ket_dim);
    ...
    {
        cart_buffer_0_geom2000_ppsd.zero();

        spher_buffer_0_geom2000_ppsd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom2000_ppsd_0(prim_buffer_0_geom2000_ppsd, prim_buffer_0_ppsd, prim_buffer_0_fpsd, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom2000_ppsd, prim_buffer_0_geom2000_ppsd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 1, 0, 2>(spher_buffer_0_geom2000_ppsd, cart_spher_buffer_0_geom2000_ppsd);

        distributor->distribute(spher_buffer_0_geom2000_ppsd, a_indices, b_indices, c_indices, d_indices, 1, 1, 0, 2, 2, 0, 0, 0, i, ket_indices);
    }
}
