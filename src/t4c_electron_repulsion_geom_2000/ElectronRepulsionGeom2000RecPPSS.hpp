#ifndef ElectronRepulsionGeom2000RecPPSS_hpp
#define ElectronRepulsionGeom2000RecPPSS_hpp

#include <array>

#include "ElectronRepulsionPrimRecDPSS.hpp"
#include "ElectronRepulsionPrimRecDSSS.hpp"
#include "ElectronRepulsionPrimRecFPSS.hpp"
...
/// Computes (PP|1/|r-r'||SS)  integrals for two GTOs pair blocks.
...
template <class T>
auto
comp_electron_repulsion_geom2000_ppss(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> prim_buffer_1_dsss(6, ket_pdim);

    CSimdArray<double> prim_buffer_0_dpss(18, ket_pdim);

    CSimdArray<double> prim_buffer_1_dpss(18, ket_pdim);

    CSimdArray<double> prim_buffer_0_fpss(30, ket_pdim);

    // allocate aligned Cartesian integrals

    CSimdArray<double> cart_buffer_0_geom2000_ppss(54, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom2000_ppss(54, ket_dim);
    ...
    {
        cart_buffer_0_geom2000_ppss.zero();

        spher_buffer_0_geom2000_ppss.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            erirec::comp_prim_electron_repulsion_dsss(prim_buffer_1_dsss, prim_buffer_1_ssss, prim_buffer_2_ssss, prim_buffer_1_psss, prim_buffer_2_psss, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_fpss(prim_buffer_0_fpss, prim_buffer_0_ppss, prim_buffer_1_ppss, prim_buffer_0_dsss, prim_buffer_1_dsss, prim_buffer_0_dpss, prim_buffer_1_dpss, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);

            t4c_geom::comp_geom2000_ppss_0(prim_buffer_0_geom2000_ppss, prim_buffer_0_ppss, prim_buffer_0_fpss, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom2000_ppss, prim_buffer_0_geom2000_ppss, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 1, 0, 0>(spher_buffer_0_geom2000_ppss, cart_spher_buffer_0_geom2000_ppss);

        distributor->distribute(spher_buffer_0_geom2000_ppss, a_indices, b_indices, c_indices, d_indices, 1, 1, 0, 0, 2, 0, 0, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom2000RecPPSS_hpp */
