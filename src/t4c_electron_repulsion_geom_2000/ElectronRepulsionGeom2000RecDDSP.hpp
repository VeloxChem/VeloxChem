...
#include "ElectronRepulsionPrimRecFPSP.hpp"
#include "ElectronRepulsionPrimRecGDSP.hpp"
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> prim_buffer_3_psss(3, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_1_dssp(18, ket_pdim);

    CSimdArray<double> prim_buffer_2_dssp(18, ket_pdim);

    CSimdArray<double> prim_buffer_1_dpss(18, ket_pdim);

    CSimdArray<double> prim_buffer_2_dpss(18, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_0_fpsp(90, ket_pdim);

    CSimdArray<double> prim_buffer_1_fpsp(90, ket_pdim);

    CSimdArray<double> prim_buffer_1_fdss(60, ket_pdim);

    CSimdArray<double> prim_buffer_0_fdsp(180, ket_pdim);

    CSimdArray<double> prim_buffer_1_fdsp(180, ket_pdim);

    CSimdArray<double> prim_buffer_0_gdsp(270, ket_pdim);

    // allocate aligned Cartesian integrals

    CSimdArray<double> cart_buffer_0_geom2000_ddsp(648, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom2000_ddsp(450, ket_dim);
    ...
    {
        cart_buffer_0_geom2000_ddsp.zero();

        spher_buffer_0_geom2000_ddsp.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            erirec::comp_prim_electron_repulsion_psss(prim_buffer_3_psss, prim_buffer_3_ssss, prim_buffer_4_ssss, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0]);
            ...
            erirec::comp_prim_electron_repulsion_dssp(prim_buffer_1_dssp, prim_buffer_1_sssp, prim_buffer_2_sssp, prim_buffer_2_psss, prim_buffer_1_pssp, prim_buffer_2_pssp, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);

            erirec::comp_prim_electron_repulsion_dssp(prim_buffer_2_dssp, prim_buffer_2_sssp, prim_buffer_3_sssp, prim_buffer_3_psss, prim_buffer_2_pssp, prim_buffer_3_pssp, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_dpss(prim_buffer_2_dpss, prim_buffer_2_spss, prim_buffer_3_spss, prim_buffer_2_psss, prim_buffer_3_psss, prim_buffer_2_ppss, prim_buffer_3_ppss, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_fpsp(prim_buffer_0_fpsp, prim_buffer_0_ppsp, prim_buffer_1_ppsp, prim_buffer_0_dssp, prim_buffer_1_dssp, prim_buffer_1_dpss, prim_buffer_0_dpsp, prim_buffer_1_dpsp, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);

            erirec::comp_prim_electron_repulsion_fpsp(prim_buffer_1_fpsp, prim_buffer_1_ppsp, prim_buffer_2_ppsp, prim_buffer_1_dssp, prim_buffer_2_dssp, prim_buffer_2_dpss, prim_buffer_1_dpsp, prim_buffer_2_dpsp, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);

            erirec::comp_prim_electron_repulsion_fdss(prim_buffer_1_fdss, prim_buffer_1_pdss, prim_buffer_2_pdss, prim_buffer_1_dpss, prim_buffer_2_dpss, prim_buffer_1_ddss, prim_buffer_2_ddss, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_gdsp(prim_buffer_0_gdsp, prim_buffer_0_ddsp, prim_buffer_1_ddsp, prim_buffer_0_fpsp, prim_buffer_1_fpsp, prim_buffer_1_fdss, prim_buffer_0_fdsp, prim_buffer_1_fdsp, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);

            t4c_geom::comp_geom2000_ddsp_0(prim_buffer_0_geom2000_ddsp, prim_buffer_0_sdsp, prim_buffer_0_ddsp, prim_buffer_0_gdsp, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom2000_ddsp, prim_buffer_0_geom2000_ddsp, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<2, 2, 0, 1>(spher_buffer_0_geom2000_ddsp, cart_spher_buffer_0_geom2000_ddsp);

        distributor->distribute(spher_buffer_0_geom2000_ddsp, a_indices, b_indices, c_indices, d_indices, 2, 2, 0, 1, 2, 0, 0, 0, i, ket_indices);
    }
}
