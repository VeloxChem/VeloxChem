...
compOverlapForDF(CMemBlock2D<double>&       primBuffer,
                 ...
                 const int32_t              iContrGto)
{
    ovlrecfunc::compOverlapForDF_0_30(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ovlrecfunc::compOverlapForDF_30_60(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
...
compOverlapForFD(CMemBlock2D<double>&       primBuffer,
                 ...
                 const int32_t              iContrGto)
{
    ovlrecfunc::compOverlapForFD_0_30(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ovlrecfunc::compOverlapForFD_30_60(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
...
compOverlapForDG(CMemBlock2D<double>&       primBuffer,
                 ...
                 const int32_t              iContrGto)
{
    ovlrecfunc::compOverlapForDG_0_45(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ovlrecfunc::compOverlapForDG_45_90(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
...
compOverlapForGD(CMemBlock2D<double>&       primBuffer,
                 ...
                 const int32_t              iContrGto)
{
    ovlrecfunc::compOverlapForGD_0_45(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    ovlrecfunc::compOverlapForGD_45_90(primBuffer, recursionMap, osFactors, nOSFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
