#ifndef ThreeCenterOverlapGradientGeom001SumRecFS_hpp
#define ThreeCenterOverlapGradientGeom001SumRecFS_hpp
...
/// @brief Computes (F|GX(r)|d^(1)/dB^(1)S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_gradient_geom_01_fs(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t2cgeom::comp_geom_deriv_0x1_fs(pbuffer, 171, 81, factors, 3);
...
#endif /* ThreeCenterOverlapGradientGeom001SumRecFS_hpp */
