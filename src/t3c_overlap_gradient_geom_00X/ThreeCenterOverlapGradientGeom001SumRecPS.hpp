#ifndef ThreeCenterOverlapGradientGeom001SumRecPS_hpp
#define ThreeCenterOverlapGradientGeom001SumRecPS_hpp
...
/// @brief Computes (P|GX(r)|d^(1)/dB^(1)S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_gradient_geom_01_ps(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t2cgeom::comp_geom_deriv_0x1_ps(pbuffer, 44, 17, factors, 3);
...
#endif /* ThreeCenterOverlapGradientGeom001SumRecPS_hpp */
