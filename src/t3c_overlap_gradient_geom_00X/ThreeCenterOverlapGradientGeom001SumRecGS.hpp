#ifndef ThreeCenterOverlapGradientGeom001SumRecGS_hpp
#define ThreeCenterOverlapGradientGeom001SumRecGS_hpp
...
/// @brief Computes (G|GX(r)|d^(1)/dB^(1)S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_gradient_geom_01_gs(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    g3ovlrec::comp_prim_overlap_gradient_gp(pbuffer, 141, 51, 81, 96, factors, 20, a_exp, exgtos[l]);

                    t2cgeom::comp_geom_deriv_0x1_gs(pbuffer, 276, 141, factors, 3);

                    t2cfunc::reduce(cbuffer, pbuffer, 276, ket_width, ket_npgtos);
                }
            }
...
#endif /* ThreeCenterOverlapGradientGeom001SumRecGS_hpp */
