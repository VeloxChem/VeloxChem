#ifndef ProjectedCorePotentialGeom100FPForG_hpp
#define ProjectedCorePotentialGeom100FPForG_hpp
...
template <class T>
auto
comp_projected_core_potential_geom_100_fp_for_g(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2pecp::comp_prim_projected_core_potential_fp_g(pbuffer, 31, 4, 13, 213, 219, 352, 361, 421, 445, 609, 615, 870, 894, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_gp_g(pbuffer, 151, 13, 31, 237, 247, 361, 379, 445, 481, 633, 643, 894, 930, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);

                    t2cgeom::comp_prim_op_geom_10_fx(pbuffer, 61, 13, 151, 1, 3, a_exp);

                    t2cfunc::reduce(cbuffer, 0, pbuffer, 61, 90, ket_width, ket_npgtos);
                }
            }
...
#endif /* ProjectedCorePotentialGeom100FPForG_hpp */
