#ifndef ProjectedCorePotentialGeom200PGForF_hpp
#define ProjectedCorePotentialGeom200PGForF_hpp
...
template <class T>
auto
comp_projected_core_potential_geom_200_pg_for_f(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2pecp::comp_prim_projected_core_potential_dg_f(pbuffer, 350, 20, 35, 645, 675, 1405, 1420, 1615, 1675, 2174, 2204, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_fg_f(pbuffer, 440, 35, 350, 720, 780, 1420, 1465, 1675, 1765, 2249, 2309, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
...
#endif /* ProjectedCorePotentialGeom200PGForF_hpp */
