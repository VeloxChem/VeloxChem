#ifndef ProjectedCorePotentialGeom100DDForF_hpp
#define ProjectedCorePotentialGeom100DDForF_hpp
...
template <class T>
auto
comp_projected_core_potential_geom_100_dd_for_f(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2pecp::comp_prim_projected_core_potential_dd_f(pbuffer, 28, 4, 10, 246, 255, 425, 431, 497, 518, 670, 679, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_fd_f(pbuffer, 172, 10, 28, 273, 291, 431, 449, 518, 554, 697, 715, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
...
#endif /* ProjectedCorePotentialGeom100DDForF_hpp */
