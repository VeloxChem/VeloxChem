#ifndef ProjectedCorePotentialGeom100PPForG_hpp
#define ProjectedCorePotentialGeom100PPForG_hpp
...
template <class T>
auto
comp_projected_core_potential_geom_100_pp_for_g(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2pecp::comp_prim_projected_core_potential_pp_g(pbuffer, 4, 1, 58, 60, 88, 103, 125, 128, 169, 0, -1, pfactors, 2, r_a, a_exp, c_exp);

                    t2pecp::comp_prim_projected_core_potential_pp_g(pbuffer, 91, 88, 101, 106, 152, 157, 167, 172, 189, 0, -1, pfactors, 2, r_a, a_exp, c_exp);

                    t2pecp::comp_prim_projected_core_potential_dp_g(pbuffer, 40, 1, 4, 63, 66, 88, 91, 103, 109, 131, 134, 169, 175, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
...
#endif /* ProjectedCorePotentialGeom100PPForG_hpp */
