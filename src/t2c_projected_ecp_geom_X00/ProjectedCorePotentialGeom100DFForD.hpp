#ifndef ProjectedCorePotentialGeom100DFForD_hpp
#define ProjectedCorePotentialGeom100DFForD_hpp
...
template <class T>
auto
comp_projected_core_potential_geom_100_df_for_d(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2pecp::comp_prim_projected_core_potential_df_d(pbuffer, 50, 10, 20, 420, 438, 758, 768, 888, 926, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_ff_d(pbuffer, 290, 20, 50, 468, 504, 768, 798, 926, 986, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
...
#endif /* ProjectedCorePotentialGeom100DFForD_hpp */
