#ifndef ProjectedCorePotentialGeom200PFForF_hpp
#define ProjectedCorePotentialGeom200PFForF_hpp
...
template <class T>
auto
comp_projected_core_potential_geom_200_pf_for_f(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2pecp::comp_prim_projected_core_potential_df_f(pbuffer, 230, 10, 20, 420, 438, 813, 823, 943, 981, 1273, 1291, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_ff_f(pbuffer, 290, 20, 230, 468, 504, 823, 853, 981, 1041, 1321, 1357, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
...
#endif /* ProjectedCorePotentialGeom200PFForF_hpp */
