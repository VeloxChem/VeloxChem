#ifndef ProjectedCorePotentialGeom200PFForG_hpp
#define ProjectedCorePotentialGeom200PFForG_hpp
...
template <class T>
auto
comp_projected_core_potential_geom_200_pf_for_g(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2pecp::comp_prim_projected_core_potential_df_g(pbuffer, 230, 10, 20, 420, 438, 849, 859, 979, 1017, 1333, 1351, 1957, 1995, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_ff_g(pbuffer, 290, 20, 230, 468, 504, 859, 889, 1017, 1077, 1381, 1417, 1995, 2055, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
...
#endif /* ProjectedCorePotentialGeom200PFForG_hpp */
