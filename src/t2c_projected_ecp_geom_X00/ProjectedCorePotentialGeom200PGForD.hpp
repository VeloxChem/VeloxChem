#ifndef ProjectedCorePotentialGeom200PGForD_hpp
#define ProjectedCorePotentialGeom200PGForD_hpp
...
template <class T>
auto
comp_projected_core_potential_geom_200_pg_for_d(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2pecp::comp_prim_projected_core_potential_dg_d(pbuffer, 350, 20, 35, 645, 675, 1284, 1299, 1494, 1554, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_fg_d(pbuffer, 440, 35, 350, 720, 780, 1299, 1344, 1554, 1644, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
...
#endif /* ProjectedCorePotentialGeom200PGForD_hpp */
