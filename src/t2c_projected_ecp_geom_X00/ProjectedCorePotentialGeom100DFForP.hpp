#ifndef ProjectedCorePotentialGeom100DFForP_hpp
#define ProjectedCorePotentialGeom100DFForP_hpp
...
template <class T>
auto
comp_projected_core_potential_geom_100_df_for_p(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2pecp::comp_prim_projected_core_potential_df_p(pbuffer, 50, 10, 20, 420, 438, 635, 645, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);

                    t2pecp::comp_prim_projected_core_potential_df_p(pbuffer, 675, 635, 645, 765, 783, 879, 889, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);

                    t2pecp::comp_prim_projected_core_potential_ff_p(pbuffer, 290, 20, 50, 468, 504, 645, 675, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
...
#endif /* ProjectedCorePotentialGeom100DFForP_hpp */
