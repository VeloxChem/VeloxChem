#ifndef ProjectedCorePotentialGeom200PGForG_hpp
#define ProjectedCorePotentialGeom200PGForG_hpp
...
template <class T>
auto
comp_projected_core_potential_geom_200_pg_for_g(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2pecp::comp_prim_projected_core_potential_dg_g(pbuffer, 350, 20, 35, 645, 675, 1495, 1510, 1705, 1765, 2310, 2340, 3479, 3539, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_fg_g(pbuffer, 440, 35, 350, 720, 780, 1510, 1555, 1765, 1855, 2385, 2445, 3539, 3629, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
...
#endif /* ProjectedCorePotentialGeom200PGForG_hpp */
