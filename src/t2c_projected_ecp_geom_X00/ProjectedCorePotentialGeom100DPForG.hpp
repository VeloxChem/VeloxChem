#ifndef ProjectedCorePotentialGeom100DPForG_hpp
#define ProjectedCorePotentialGeom100DPForG_hpp
...
template <class T>
auto
comp_projected_core_potential_geom_100_dp_for_g(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2pecp::comp_prim_projected_core_potential_dp_g(pbuffer, 13, 1, 4, 120, 123, 187, 190, 220, 229, 298, 301, 411, 420, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_fp_g(pbuffer, 85, 4, 13, 132, 138, 190, 199, 229, 247, 310, 316, 420, 438, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
...
#endif /* ProjectedCorePotentialGeom100DPForG_hpp */
