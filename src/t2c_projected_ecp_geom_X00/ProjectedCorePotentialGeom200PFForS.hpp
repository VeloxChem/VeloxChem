#ifndef ProjectedCorePotentialGeom200PFForS_hpp
#define ProjectedCorePotentialGeom200PFForS_hpp
...
template <class T>
auto
comp_projected_core_potential_geom_200_pf_for_s(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2pecp::comp_prim_projected_core_potential_df_s(pbuffer, 230, 10, 20, 436, 446, 0, -1, -1, pfactors, r_a, a_exp, c_exp);

                    t2pecp::comp_prim_projected_core_potential_df_s(pbuffer, 476, 436, 446, 581, 591, 0, -1, -1, pfactors, r_a, a_exp, c_exp);

                    t2pecp::comp_prim_projected_core_potential_ff_s(pbuffer, 290, 20, 230, 446, 476, 0, -1, -1, pfactors, r_a, a_exp, c_exp);
...
#endif /* ProjectedCorePotentialGeom200PFForS_hpp */
