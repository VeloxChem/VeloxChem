#ifndef ProjectedCorePotentialGeom200PDForG_hpp
#define ProjectedCorePotentialGeom200PDForG_hpp
...
template <class T>
auto
comp_projected_core_potential_geom_200_pd_for_g(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2pecp::comp_prim_projected_core_potential_dd_g(pbuffer, 136, 4, 10, 246, 255, 436, 442, 508, 529, 692, 701, 987, 1008, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_fd_g(pbuffer, 172, 10, 136, 273, 291, 442, 460, 529, 565, 719, 737, 1008, 1044, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
...
#endif /* ProjectedCorePotentialGeom200PDForG_hpp */
