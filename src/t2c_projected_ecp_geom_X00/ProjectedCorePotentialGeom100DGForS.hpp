#ifndef ProjectedCorePotentialGeom100DGForS_hpp
#define ProjectedCorePotentialGeom100DGForS_hpp
...
template <class T>
auto
comp_projected_core_potential_geom_100_dg_for_s(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2pecp::comp_prim_projected_core_potential_dg_s(pbuffer, 80, 20, 35, 700, 715, 0, -1, -1, pfactors, r_a, a_exp, c_exp);

                    t2pecp::comp_prim_projected_core_potential_dg_s(pbuffer, 760, 700, 715, 955, 970, 0, -1, -1, pfactors, r_a, a_exp, c_exp);

                    t2pecp::comp_prim_projected_core_potential_fg_s(pbuffer, 440, 35, 80, 715, 760, 0, -1, -1, pfactors, r_a, a_exp, c_exp);
...
#endif /* ProjectedCorePotentialGeom100DGForS_hpp */
