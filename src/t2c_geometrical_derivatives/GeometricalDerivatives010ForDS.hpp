#ifndef GeometricalDerivatives010ForDS_hpp
#define GeometricalDerivatives010ForDS_hpp

#include "SimdArray.hpp"

namespace t2cgeom { // t2cgeom namespace

/// @brief Computes [D|d^(1)R/dX^(1)|S]  integrals for arbitrary operator R.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_op_geom_010_ds The index of integral in primitive integrals buffer.
...
#endif /* GeometricalDerivatives010ForDS_hpp */
