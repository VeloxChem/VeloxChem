#ifndef GeometricalDerivatives020ForDG_hpp
#define GeometricalDerivatives020ForDG_hpp

#include "SimdArray.hpp"

namespace t2cgeom { // t2cgeom namespace

/// @brief Computes [D|d^(2)R/dX^(2)|G]  integrals for arbitrary operator R.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_op_geom_020_dg The index of integral in primitive integrals buffer.
...
/// @param idx_op_di The index of integral in primitive integrals buffer.
...
#endif /* GeometricalDerivatives020ForDG_hpp */
