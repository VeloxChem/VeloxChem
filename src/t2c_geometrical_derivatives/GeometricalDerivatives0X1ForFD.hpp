#ifndef GeometricalDerivatives0X1ForFD_hpp
#define GeometricalDerivatives0X1ForFD_hpp

#include "SimdArray.hpp"

namespace t2cgeom { // t2cgeom namespace

/// @brief Computes [F|R|d^(1)/dB^(1)D]  integrals for arbitrary operator R.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_op_geom_001_fd The index of integral in primitive integrals buffer.
...
#endif /* GeometricalDerivatives0X1ForFD_hpp */
