#ifndef GeometricalDerivatives110ForGP_hpp
#define GeometricalDerivatives110ForGP_hpp

#include "SimdArray.hpp"

namespace t2cgeom { // t2cgeom namespace

/// @brief Computes [d^(1)/dA^(1)G|d^(1)R/dX^(1)|P]  integrals for arbitrary operator R.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_op_geom_110_gp The index of integral in primitive integrals buffer.
...
/// @param idx_op_ip The index of integral in primitive integrals buffer.
...
#endif /* GeometricalDerivatives110ForGP_hpp */
