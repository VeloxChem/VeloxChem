...
/// @param idx_op_geom_101_gpThe index of integral in primitive integrals buffer.
/// @param idx_op_geom_001_fpThe index of integral in primitive integrals buffer.
/// @param idx_op_geom_001_hpThe index of integral in primitive integrals buffer.
