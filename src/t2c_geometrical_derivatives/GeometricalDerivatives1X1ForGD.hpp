...
/// @param idx_op_geom_101_gdThe index of integral in primitive integrals buffer.
/// @param idx_op_geom_001_fdThe index of integral in primitive integrals buffer.
/// @param idx_op_geom_001_hdThe index of integral in primitive integrals buffer.
