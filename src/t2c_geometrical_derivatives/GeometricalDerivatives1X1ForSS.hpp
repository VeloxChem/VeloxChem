...
/// @param idx_op_geom_101_ssThe index of integral in primitive integrals buffer.
/// @param idx_op_geom_001_psThe index of integral in primitive integrals buffer.
