#ifndef GeometricalDerivatives0X1ForSP_hpp
#define GeometricalDerivatives0X1ForSP_hpp

#include "SimdArray.hpp"

namespace t2cgeom { // t2cgeom namespace

/// @brief Computes [S|R|d^(1)/dB^(1)P]  integrals for arbitrary operator R.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_op_geom_001_sp The index of integral in primitive integrals buffer.
...
#endif /* GeometricalDerivatives0X1ForSP_hpp */
