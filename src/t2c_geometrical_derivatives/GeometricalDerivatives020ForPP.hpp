#ifndef GeometricalDerivatives020ForPP_hpp
#define GeometricalDerivatives020ForPP_hpp

#include "SimdArray.hpp"

namespace t2cgeom { // t2cgeom namespace

/// @brief Computes [P|d^(2)R/dX^(2)|P]  integrals for arbitrary operator R.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_op_geom_020_pp The index of integral in primitive integrals buffer.
...
#endif /* GeometricalDerivatives020ForPP_hpp */
