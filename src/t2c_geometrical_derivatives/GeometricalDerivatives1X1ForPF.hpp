...
/// @param idx_op_geom_101_pfThe index of integral in primitive integrals buffer.
/// @param idx_op_geom_001_sfThe index of integral in primitive integrals buffer.
