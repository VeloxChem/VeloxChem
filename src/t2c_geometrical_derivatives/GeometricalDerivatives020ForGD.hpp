#ifndef GeometricalDerivatives020ForGD_hpp
#define GeometricalDerivatives020ForGD_hpp

#include "SimdArray.hpp"

namespace t2cgeom { // t2cgeom namespace

/// @brief Computes [G|d^(2)R/dX^(2)|D]  integrals for arbitrary operator R.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_op_geom_020_gd The index of integral in primitive integrals buffer.
...
#endif /* GeometricalDerivatives020ForGD_hpp */
