...
/// @param idx_op_geom_101_pgThe index of integral in primitive integrals buffer.
/// @param idx_op_geom_001_sgThe index of integral in primitive integrals buffer.
