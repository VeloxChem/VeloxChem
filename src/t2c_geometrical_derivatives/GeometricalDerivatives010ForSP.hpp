#ifndef GeometricalDerivatives010ForSP_hpp
#define GeometricalDerivatives010ForSP_hpp

#include "SimdArray.hpp"

namespace t2cgeom { // t2cgeom namespace

/// @brief Computes [S|d^(1)R/dX^(1)|P]  integrals for arbitrary operator R.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_op_geom_010_sp The index of integral in primitive integrals buffer.
...
#endif /* GeometricalDerivatives010ForSP_hpp */
