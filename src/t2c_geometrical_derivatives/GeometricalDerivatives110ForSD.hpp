#ifndef GeometricalDerivatives110ForSD_hpp
#define GeometricalDerivatives110ForSD_hpp

#include "SimdArray.hpp"

namespace t2cgeom { // t2cgeom namespace

/// @brief Computes [d^(1)/dA^(1)S|d^(1)R/dX^(1)|D]  integrals for arbitrary operator R.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_op_geom_110_sd The index of integral in primitive integrals buffer.
...
#endif /* GeometricalDerivatives110ForSD_hpp */
