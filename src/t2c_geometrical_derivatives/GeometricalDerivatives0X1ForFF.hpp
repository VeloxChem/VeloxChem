#ifndef GeometricalDerivatives0X1ForFF_hpp
#define GeometricalDerivatives0X1ForFF_hpp

#include "SimdArray.hpp"

namespace t2cgeom { // t2cgeom namespace

/// @brief Computes [F|R|d^(1)/dB^(1)F]  integrals for arbitrary operator R.
...
#endif /* GeometricalDerivatives0X1ForFF_hpp */
