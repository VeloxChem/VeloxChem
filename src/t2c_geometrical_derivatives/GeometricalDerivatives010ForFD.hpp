#ifndef GeometricalDerivatives010ForFD_hpp
#define GeometricalDerivatives010ForFD_hpp

#include "SimdArray.hpp"

namespace t2cgeom { // t2cgeom namespace

/// @brief Computes [F|d^(1)R/dX^(1)|D]  integrals for arbitrary operator R.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_op_geom_010_fd The index of integral in primitive integrals buffer.
...
#endif /* GeometricalDerivatives010ForFD_hpp */
