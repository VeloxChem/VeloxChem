...
/// @param idx_op_geom_101_gfThe index of integral in primitive integrals buffer.
/// @param idx_op_geom_001_ffThe index of integral in primitive integrals buffer.
/// @param idx_op_geom_001_hfThe index of integral in primitive integrals buffer.
