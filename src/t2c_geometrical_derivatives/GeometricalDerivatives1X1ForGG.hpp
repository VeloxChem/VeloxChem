...
/// @param idx_op_geom_101_ggThe index of integral in primitive integrals buffer.
/// @param idx_op_geom_001_fgThe index of integral in primitive integrals buffer.
/// @param idx_op_geom_001_hgThe index of integral in primitive integrals buffer.
