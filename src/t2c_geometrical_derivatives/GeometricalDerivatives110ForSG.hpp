#ifndef GeometricalDerivatives110ForSG_hpp
#define GeometricalDerivatives110ForSG_hpp

#include "SimdArray.hpp"

namespace t2cgeom { // t2cgeom namespace

/// @brief Computes [d^(1)/dA^(1)S|d^(1)R/dX^(1)|G]  integrals for arbitrary operator R.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_op_geom_110_sg The index of integral in primitive integrals buffer.
...
#endif /* GeometricalDerivatives110ForSG_hpp */
