...
/// @param idx_op_geom_101_fsThe index of integral in primitive integrals buffer.
/// @param idx_op_geom_001_dsThe index of integral in primitive integrals buffer.
/// @param idx_op_geom_001_gsThe index of integral in primitive integrals buffer.
