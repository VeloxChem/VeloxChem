...
/// @param idx_op_geom_200_dsThe index of integral in primitive integrals buffer.
/// @param idx_op_geom_100_psThe index of integral in primitive integrals buffer.
