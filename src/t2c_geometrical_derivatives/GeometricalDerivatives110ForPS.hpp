#ifndef GeometricalDerivatives110ForPS_hpp
#define GeometricalDerivatives110ForPS_hpp

#include "SimdArray.hpp"

namespace t2cgeom { // t2cgeom namespace

/// @brief Computes [d^(1)/dA^(1)P|d^(1)R/dX^(1)|S]  integrals for arbitrary operator R.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_op_geom_110_ps The index of integral in primitive integrals buffer.
...
#endif /* GeometricalDerivatives110ForPS_hpp */
