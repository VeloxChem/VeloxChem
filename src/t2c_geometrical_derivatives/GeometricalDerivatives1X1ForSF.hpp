...
/// @param idx_op_geom_101_sfThe index of integral in primitive integrals buffer.
/// @param idx_op_geom_001_pfThe index of integral in primitive integrals buffer.
