...
/// @param idx_op_geom_101_fdThe index of integral in primitive integrals buffer.
/// @param idx_op_geom_001_ddThe index of integral in primitive integrals buffer.
/// @param idx_op_geom_001_gdThe index of integral in primitive integrals buffer.
