...
/// @param idx_op_geom_101_ppThe index of integral in primitive integrals buffer.
/// @param idx_op_geom_001_spThe index of integral in primitive integrals buffer.
