#ifndef ProjectedCorePotentialGeom110SGForD_hpp
#define ProjectedCorePotentialGeom110SGForD_hpp
...
template <class T>
auto
comp_projected_core_potential_geom_110_sg_for_d(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2pecp::comp_prim_projected_core_potential_sh_d(pbuffer, 170, 10, 20, 459, 675, 685, 730, 760, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_pf_d(pbuffer, 191, 10, 427, 439, 981, 1102, 0, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_pg_d(pbuffer, 221, 20, 439, 459, 991, 1132, 0, -1, pfactors, 2, r_a, a_exp, c_exp);

                    t2pecp::comp_prim_projected_core_potential_pg_d(pbuffer, 1027, 991, 1112, 1147, 1493, 1548, 0, -1, pfactors, 2, r_a, a_exp, c_exp);

                    t2pecp::comp_prim_projected_core_potential_ph_d(pbuffer, 266, 170, 459, 489, 1006, 1162, 0, -1, pfactors, 2, r_a, a_exp, c_exp);

                    t2pecp::comp_prim_projected_core_potential_dg_d(pbuffer, 329, 20, 221, 510, 540, 991, 1027, 1132, 1183, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
...
#endif /* ProjectedCorePotentialGeom110SGForD_hpp */
