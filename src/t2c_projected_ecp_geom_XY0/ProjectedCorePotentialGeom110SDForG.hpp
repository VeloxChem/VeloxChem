#ifndef ProjectedCorePotentialGeom110SDForG_hpp
#define ProjectedCorePotentialGeom110SDForG_hpp
...
template <class T>
auto
comp_projected_core_potential_geom_110_sd_for_g(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2pecp::comp_prim_projected_core_potential_sf_g(pbuffer, 64, 1, 4, 175, 246, 249, 258, 267, 460, 533, 542, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_pp_g(pbuffer, 74, 1, 167, 169, 328, 368, 447, 451, 620, 0, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_pd_g(pbuffer, 83, 4, 169, 175, 331, 377, 451, 460, 629, 0, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_pf_g(pbuffer, 101, 64, 175, 187, 337, 389, 460, 472, 641, 0, -1, pfactors, 2, r_a, a_exp, c_exp);

                    t2pecp::comp_prim_projected_core_potential_dd_g(pbuffer, 131, 4, 83, 197, 206, 331, 347, 377, 399, 482, 491, 629, 651, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
...
#endif /* ProjectedCorePotentialGeom110SDForG_hpp */
