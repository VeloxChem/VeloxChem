#ifndef ProjectedCorePotentialGeom110SFForG_hpp
#define ProjectedCorePotentialGeom110SFForG_hpp
...
template <class T>
auto
comp_projected_core_potential_geom_110_sf_for_g(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2pecp::comp_prim_projected_core_potential_sg_g(pbuffer, 110, 4, 10, 298, 439, 445, 467, 485, 912, 1062, 1080, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_pd_g(pbuffer, 125, 4, 280, 286, 652, 725, 882, 894, 1278, 0, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_pf_g(pbuffer, 143, 10, 286, 298, 658, 743, 894, 912, 1296, 0, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_pg_g(pbuffer, 173, 110, 298, 318, 668, 763, 912, 932, 1316, 0, -1, pfactors, 2, r_a, a_exp, c_exp);

                    t2pecp::comp_prim_projected_core_potential_df_g(pbuffer, 218, 10, 143, 333, 351, 658, 683, 743, 778, 947, 965, 1296, 1331, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
...
#endif /* ProjectedCorePotentialGeom110SFForG_hpp */
