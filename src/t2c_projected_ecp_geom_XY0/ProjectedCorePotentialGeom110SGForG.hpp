#ifndef ProjectedCorePotentialGeom110SGForG_hpp
#define ProjectedCorePotentialGeom110SGForG_hpp
...
template <class T>
auto
comp_projected_core_potential_geom_110_sg_for_g(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2pecp::comp_prim_projected_core_potential_sh_g(pbuffer, 170, 10, 20, 459, 710, 720, 765, 795, 1633, 1908, 1938, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_pf_g(pbuffer, 191, 10, 427, 439, 1177, 1298, 1579, 1603, 2366, 0, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_pg_g(pbuffer, 221, 20, 439, 459, 1187, 1328, 1603, 1633, 2396, 0, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_ph_g(pbuffer, 266, 170, 459, 489, 1202, 1358, 1633, 1663, 2426, 0, -1, pfactors, 2, r_a, a_exp, c_exp);

                    t2pecp::comp_prim_projected_core_potential_dg_g(pbuffer, 329, 20, 221, 510, 540, 1187, 1223, 1328, 1379, 1684, 1714, 2396, 2447, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
...
#endif /* ProjectedCorePotentialGeom110SGForG_hpp */
