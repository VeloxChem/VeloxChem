#ifndef ElectronRepulsionGeom1010RecSFPF_hpp
#define ElectronRepulsionGeom1010RecSFPF_hpp
...
/// @brief Computes d^(1)/dA^(1)d^(1)/dC^(1)(SF|1/|r-r'||PF)  integral derivatives.
...
template <class T>
inline auto
comp_electron_repulsion_geom1010_sfpf(T& distributor,
                                      ...
                                      const std::pair<size_t, size_t>& ket_indices) -> void
{
    ...
    CSimdArray<double> ckbuffer(4125, 1);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (int k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cfunc::reduce(cbuffer, 100, pbuffer, 2875, 150, ket_width, ket_npgtos);
                ...
                t2cfunc::reduce(cbuffer, 250, pbuffer, 1955, 100, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 350, pbuffer, 2155, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 500, pbuffer, 2455, 210, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 710, pbuffer, 2875, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 860, pbuffer, 3025, 225, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1085, pbuffer, 3250, 315, ket_width, ket_npgtos);
            ...
            t4cfunc::ket_transform<1, 3>(skbuffer, 1890, ckbuffer, 750, 0, 3);

            t4cfunc::ket_transform<1, 3>(skbuffer, 2100, ckbuffer, 1050, 0, 3);

            t4cfunc::ket_transform<1, 3>(skbuffer, 2310, ckbuffer, 1350, 0, 3);
            ...
            erirec::comp_bra_geom1010_hrr_electron_repulsion_sfxx(skbuffer, 0, 1890, 2520, r_ab, 1, 3);
...
#endif /* ElectronRepulsionGeom1010RecSFPF_hpp */
