#ifndef ElectronRepulsionGeom1010RecDDDF_hpp
#define ElectronRepulsionGeom1010RecDDDF_hpp
...
/// @brief Computes d^(1)/dA^(1)d^(1)/dC^(1)(DD|1/|r-r'||DF)  integral derivatives.
...
template <class T>
inline auto
comp_electron_repulsion_geom1010_dddf(T& distributor,
                                      ...
                                      const std::pair<size_t, size_t>& ket_indices) -> void
{
    ...
    CSimdArray<double> ckbuffer(38964, 1);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (int k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cfunc::reduce(cbuffer, 150, pbuffer, 3921, 100, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 250, pbuffer, 4221, 150, ket_width, ket_npgtos);
                ...
                t2cfunc::reduce(cbuffer, 1584, pbuffer, 1995, 60, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1644, pbuffer, 2235, 90, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1734, pbuffer, 3921, 100, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1834, pbuffer, 4221, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1984, pbuffer, 6231, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 2134, pbuffer, 6531, 225, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 2359, pbuffer, 8451, 210, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 2569, pbuffer, 8661, 315, ket_width, ket_npgtos);
                ...
                t2cfunc::reduce(cbuffer, 400, pbuffer, 1995, 60, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 460, pbuffer, 2235, 90, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 550, pbuffer, 2595, 126, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 676, pbuffer, 3099, 168, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 844, pbuffer, 3921, 100, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 944, pbuffer, 4221, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1094, pbuffer, 4671, 210, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1304, pbuffer, 5301, 280, ket_width, ket_npgtos);
                ...
                t2cfunc::reduce(cbuffer, 2884, pbuffer, 1995, 60, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 2944, pbuffer, 2235, 90, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 3034, pbuffer, 2595, 126, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 3160, pbuffer, 3099, 168, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 3328, pbuffer, 3921, 100, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 3428, pbuffer, 4221, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 3578, pbuffer, 4671, 210, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 3788, pbuffer, 5301, 280, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 4068, pbuffer, 6231, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 4218, pbuffer, 6531, 225, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 4443, pbuffer, 6981, 315, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 4758, pbuffer, 7611, 420, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 5178, pbuffer, 8451, 210, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 5388, pbuffer, 8661, 315, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 5703, pbuffer, 8976, 441, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 6144, pbuffer, 9417, 588, ket_width, ket_npgtos);
            ...
            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 9996, cbuffer, 1584, 1644, cfactors, 6, 0, 2);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 13986, cbuffer, 1734, 1834, cfactors, 6, 0, 3);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 20406, cbuffer, 1984, 2134, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 29829, cbuffer, 2359, 2569, cfactors, 6, 0, 5);
            ...
            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsf(ckbuffer, 9168, cbuffer, 2884, 2944, cfactors, 6, 0, 2);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsg(ckbuffer, 9348, cbuffer, 2944, 3034, cfactors, 6, 0, 2);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsh(ckbuffer, 9618, cbuffer, 3034, 3160, cfactors, 6, 0, 2);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxpf(ckbuffer, 10176, cbuffer, 1584, 9168, 9348, cfactors, 6, 0, 2);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxpg(ckbuffer, 10716, cbuffer, 1644, 9348, 9618, cfactors, 6, 0, 2);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxdf(ckbuffer, 11526, 9996, 10176, 10716, cfactors, 6, 0, 2);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsf(ckbuffer, 12606, cbuffer, 3328, 3428, cfactors, 6, 0, 3);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsg(ckbuffer, 12906, cbuffer, 3428, 3578, cfactors, 6, 0, 3);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsh(ckbuffer, 13356, cbuffer, 3578, 3788, cfactors, 6, 0, 3);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxpf(ckbuffer, 14286, cbuffer, 1734, 12606, 12906, cfactors, 6, 0, 3);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxpg(ckbuffer, 15186, cbuffer, 1834, 12906, 13356, cfactors, 6, 0, 3);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxdf(ckbuffer, 16536, 13986, 14286, 15186, cfactors, 6, 0, 3);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsf(ckbuffer, 18336, cbuffer, 4068, 4218, cfactors, 6, 0, 4);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsg(ckbuffer, 18786, cbuffer, 4218, 4443, cfactors, 6, 0, 4);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsh(ckbuffer, 19461, cbuffer, 4443, 4758, cfactors, 6, 0, 4);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxpf(ckbuffer, 20856, cbuffer, 1984, 18336, 18786, cfactors, 6, 0, 4);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxpg(ckbuffer, 22206, cbuffer, 2134, 18786, 19461, cfactors, 6, 0, 4);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxdf(ckbuffer, 24231, 20406, 20856, 22206, cfactors, 6, 0, 4);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsf(ckbuffer, 26931, cbuffer, 5178, 5388, cfactors, 6, 0, 5);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsg(ckbuffer, 27561, cbuffer, 5388, 5703, cfactors, 6, 0, 5);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsh(ckbuffer, 28506, cbuffer, 5703, 6144, cfactors, 6, 0, 5);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxpf(ckbuffer, 30459, cbuffer, 2359, 26931, 27561, cfactors, 6, 0, 5);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxpg(ckbuffer, 32349, cbuffer, 2569, 27561, 28506, cfactors, 6, 0, 5);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxdf(ckbuffer, 35184, 29829, 30459, 32349, cfactors, 6, 0, 5);
            ...
            t4cfunc::ket_transform<2, 3>(skbuffer, 39795, ckbuffer, 11526, 0, 2);

            t4cfunc::ket_transform<2, 3>(skbuffer, 40005, ckbuffer, 11886, 0, 2);

            t4cfunc::ket_transform<2, 3>(skbuffer, 40215, ckbuffer, 12246, 0, 2);

            t4cfunc::ket_transform<2, 3>(skbuffer, 40425, ckbuffer, 16536, 0, 3);

            t4cfunc::ket_transform<2, 3>(skbuffer, 40775, ckbuffer, 17136, 0, 3);

            t4cfunc::ket_transform<2, 3>(skbuffer, 41125, ckbuffer, 17736, 0, 3);

            t4cfunc::ket_transform<2, 3>(skbuffer, 41475, ckbuffer, 24231, 0, 4);

            t4cfunc::ket_transform<2, 3>(skbuffer, 42000, ckbuffer, 25131, 0, 4);

            t4cfunc::ket_transform<2, 3>(skbuffer, 42525, ckbuffer, 26031, 0, 4);

            t4cfunc::ket_transform<2, 3>(skbuffer, 43050, ckbuffer, 35184, 0, 5);

            t4cfunc::ket_transform<2, 3>(skbuffer, 43785, ckbuffer, 36444, 0, 5);

            t4cfunc::ket_transform<2, 3>(skbuffer, 44520, ckbuffer, 37704, 0, 5);

            erirec::comp_bra_hrr_electron_repulsion_pdxx(skbuffer, 11445, 0, 2520, r_ab, 2, 3);

            erirec::comp_bra_hrr_electron_repulsion_pdxx(skbuffer, 12075, 210, 2870, r_ab, 2, 3);

            erirec::comp_bra_hrr_electron_repulsion_pdxx(skbuffer, 12705, 420, 3220, r_ab, 2, 3);

            erirec::comp_bra_geom1010_hrr_electron_repulsion_sdxx(skbuffer, 630, 39795, 40425, r_ab, 2, 3);

            erirec::comp_bra_geom1010_hrr_electron_repulsion_sfxx(skbuffer, 3570, 40425, 41475, r_ab, 2, 3);

            erirec::comp_bra_geom1010_hrr_electron_repulsion_sgxx(skbuffer, 6720, 41475, 43050, r_ab, 2, 3);

            erirec::comp_bra_geom1010_hrr_electron_repulsion_pdxx(skbuffer, 13335, 0, 630, 3570, r_ab, 2, 3);

            erirec::comp_bra_geom1010_hrr_electron_repulsion_pfxx(skbuffer, 19005, 2520, 3570, 6720, r_ab, 2, 3);

            erirec::comp_bra_geom1010_hrr_electron_repulsion_ddxx(skbuffer, 28455, 11445, 13335, 19005, r_ab, 2, 3);

            t4cfunc::bra_transform<2, 2>(sbuffer, 0, skbuffer, 28455, 2, 3);

            t4cfunc::bra_transform<2, 2>(sbuffer, 875, skbuffer, 29715, 2, 3);

            t4cfunc::bra_transform<2, 2>(sbuffer, 1750, skbuffer, 30975, 2, 3);

            t4cfunc::bra_transform<2, 2>(sbuffer, 2625, skbuffer, 32235, 2, 3);

            t4cfunc::bra_transform<2, 2>(sbuffer, 3500, skbuffer, 33495, 2, 3);

            t4cfunc::bra_transform<2, 2>(sbuffer, 4375, skbuffer, 34755, 2, 3);

            t4cfunc::bra_transform<2, 2>(sbuffer, 5250, skbuffer, 36015, 2, 3);

            t4cfunc::bra_transform<2, 2>(sbuffer, 6125, skbuffer, 37275, 2, 3);

            t4cfunc::bra_transform<2, 2>(sbuffer, 7000, skbuffer, 38535, 2, 3);
...
#endif /* ElectronRepulsionGeom1010RecDDDF_hpp */
