#ifndef ElectronRepulsionGeom1010RecDPDF_hpp
#define ElectronRepulsionGeom1010RecDPDF_hpp
...
/// @brief Computes d^(1)/dA^(1)d^(1)/dC^(1)(DP|1/|r-r'||DF)  integral derivatives.
...
template <class T>
inline auto
comp_electron_repulsion_geom1010_dpdf(T& distributor,
                                      ...
                                      const std::pair<size_t, size_t>& ket_indices) -> void
{
    ...
    CSimdArray<double> ckbuffer(24639, 1);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (int k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cfunc::reduce(cbuffer, 75, pbuffer, 1599, 60, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 135, pbuffer, 1779, 90, ket_width, ket_npgtos);
                ...
                t2cfunc::reduce(cbuffer, 891, pbuffer, 621, 30, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 921, pbuffer, 741, 45, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 966, pbuffer, 1599, 60, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1026, pbuffer, 1779, 90, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1116, pbuffer, 2991, 100, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1216, pbuffer, 3191, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1366, pbuffer, 4471, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1516, pbuffer, 4621, 225, ket_width, ket_npgtos);
                ...
                t2cfunc::reduce(cbuffer, 225, pbuffer, 621, 30, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 255, pbuffer, 741, 45, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 300, pbuffer, 921, 63, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 363, pbuffer, 1173, 84, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 447, pbuffer, 1599, 60, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 507, pbuffer, 1779, 90, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 597, pbuffer, 2049, 126, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 723, pbuffer, 2427, 168, ket_width, ket_npgtos);
                ...
                t2cfunc::reduce(cbuffer, 1741, pbuffer, 621, 30, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1771, pbuffer, 741, 45, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1816, pbuffer, 921, 63, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1879, pbuffer, 1173, 84, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1963, pbuffer, 1599, 60, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 2023, pbuffer, 1779, 90, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 2113, pbuffer, 2049, 126, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 2239, pbuffer, 2427, 168, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 2407, pbuffer, 2991, 100, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 2507, pbuffer, 3191, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 2657, pbuffer, 3491, 210, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 2867, pbuffer, 3911, 280, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 3147, pbuffer, 4471, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 3297, pbuffer, 4621, 225, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 3522, pbuffer, 4846, 315, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 3837, pbuffer, 5161, 420, ket_width, ket_npgtos);
            ...
            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 5571, cbuffer, 891, 921, cfactors, 6, 0, 1);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 7704, cbuffer, 966, 1026, cfactors, 6, 0, 2);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 11694, cbuffer, 1116, 1216, cfactors, 6, 0, 3);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 18114, cbuffer, 1366, 1516, cfactors, 6, 0, 4);
            ...
            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsf(ckbuffer, 5157, cbuffer, 1741, 1771, cfactors, 6, 0, 1);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsg(ckbuffer, 5247, cbuffer, 1771, 1816, cfactors, 6, 0, 1);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsh(ckbuffer, 5382, cbuffer, 1816, 1879, cfactors, 6, 0, 1);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxpf(ckbuffer, 5661, cbuffer, 891, 5157, 5247, cfactors, 6, 0, 1);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxpg(ckbuffer, 5931, cbuffer, 921, 5247, 5382, cfactors, 6, 0, 1);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxdf(ckbuffer, 6336, 5571, 5661, 5931, cfactors, 6, 0, 1);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsf(ckbuffer, 6876, cbuffer, 1963, 2023, cfactors, 6, 0, 2);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsg(ckbuffer, 7056, cbuffer, 2023, 2113, cfactors, 6, 0, 2);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsh(ckbuffer, 7326, cbuffer, 2113, 2239, cfactors, 6, 0, 2);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxpf(ckbuffer, 7884, cbuffer, 966, 6876, 7056, cfactors, 6, 0, 2);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxpg(ckbuffer, 8424, cbuffer, 1026, 7056, 7326, cfactors, 6, 0, 2);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxdf(ckbuffer, 9234, 7704, 7884, 8424, cfactors, 6, 0, 2);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsf(ckbuffer, 10314, cbuffer, 2407, 2507, cfactors, 6, 0, 3);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsg(ckbuffer, 10614, cbuffer, 2507, 2657, cfactors, 6, 0, 3);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsh(ckbuffer, 11064, cbuffer, 2657, 2867, cfactors, 6, 0, 3);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxpf(ckbuffer, 11994, cbuffer, 1116, 10314, 10614, cfactors, 6, 0, 3);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxpg(ckbuffer, 12894, cbuffer, 1216, 10614, 11064, cfactors, 6, 0, 3);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxdf(ckbuffer, 14244, 11694, 11994, 12894, cfactors, 6, 0, 3);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsf(ckbuffer, 16044, cbuffer, 3147, 3297, cfactors, 6, 0, 4);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsg(ckbuffer, 16494, cbuffer, 3297, 3522, cfactors, 6, 0, 4);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsh(ckbuffer, 17169, cbuffer, 3522, 3837, cfactors, 6, 0, 4);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxpf(ckbuffer, 18564, cbuffer, 1366, 16044, 16494, cfactors, 6, 0, 4);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxpg(ckbuffer, 19914, cbuffer, 1516, 16494, 17169, cfactors, 6, 0, 4);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxdf(ckbuffer, 21939, 18114, 18564, 19914, cfactors, 6, 0, 4);
            ...
            t4cfunc::ket_transform<2, 3>(skbuffer, 22050, ckbuffer, 6336, 0, 1);

            t4cfunc::ket_transform<2, 3>(skbuffer, 22155, ckbuffer, 6516, 0, 1);

            t4cfunc::ket_transform<2, 3>(skbuffer, 22260, ckbuffer, 6696, 0, 1);

            t4cfunc::ket_transform<2, 3>(skbuffer, 22365, ckbuffer, 9234, 0, 2);

            t4cfunc::ket_transform<2, 3>(skbuffer, 22575, ckbuffer, 9594, 0, 2);

            t4cfunc::ket_transform<2, 3>(skbuffer, 22785, ckbuffer, 9954, 0, 2);

            t4cfunc::ket_transform<2, 3>(skbuffer, 22995, ckbuffer, 14244, 0, 3);

            t4cfunc::ket_transform<2, 3>(skbuffer, 23345, ckbuffer, 14844, 0, 3);

            t4cfunc::ket_transform<2, 3>(skbuffer, 23695, ckbuffer, 15444, 0, 3);

            t4cfunc::ket_transform<2, 3>(skbuffer, 24045, ckbuffer, 21939, 0, 4);

            t4cfunc::ket_transform<2, 3>(skbuffer, 24570, ckbuffer, 22839, 0, 4);

            t4cfunc::ket_transform<2, 3>(skbuffer, 25095, ckbuffer, 23739, 0, 4);

            erirec::comp_bra_hrr_electron_repulsion_ppxx(skbuffer, 6930, 0, 1260, r_ab, 2, 3);

            erirec::comp_bra_hrr_electron_repulsion_ppxx(skbuffer, 7245, 105, 1470, r_ab, 2, 3);

            erirec::comp_bra_hrr_electron_repulsion_ppxx(skbuffer, 7560, 210, 1680, r_ab, 2, 3);

            erirec::comp_bra_geom1010_hrr_electron_repulsion_spxx(skbuffer, 315, 22050, 22365, r_ab, 2, 3);

            erirec::comp_bra_geom1010_hrr_electron_repulsion_sdxx(skbuffer, 1890, 22365, 22995, r_ab, 2, 3);

            erirec::comp_bra_geom1010_hrr_electron_repulsion_sfxx(skbuffer, 3780, 22995, 24045, r_ab, 2, 3);

            erirec::comp_bra_geom1010_hrr_electron_repulsion_ppxx(skbuffer, 7875, 0, 315, 1890, r_ab, 2, 3);

            erirec::comp_bra_geom1010_hrr_electron_repulsion_pdxx(skbuffer, 10710, 1260, 1890, 3780, r_ab, 2, 3);

            erirec::comp_bra_geom1010_hrr_electron_repulsion_dpxx(skbuffer, 16380, 6930, 7875, 10710, r_ab, 2, 3);

            t4cfunc::bra_transform<2, 1>(sbuffer, 0, skbuffer, 16380, 2, 3);

            t4cfunc::bra_transform<2, 1>(sbuffer, 525, skbuffer, 17010, 2, 3);

            t4cfunc::bra_transform<2, 1>(sbuffer, 1050, skbuffer, 17640, 2, 3);

            t4cfunc::bra_transform<2, 1>(sbuffer, 1575, skbuffer, 18270, 2, 3);

            t4cfunc::bra_transform<2, 1>(sbuffer, 2100, skbuffer, 18900, 2, 3);

            t4cfunc::bra_transform<2, 1>(sbuffer, 2625, skbuffer, 19530, 2, 3);

            t4cfunc::bra_transform<2, 1>(sbuffer, 3150, skbuffer, 20160, 2, 3);

            t4cfunc::bra_transform<2, 1>(sbuffer, 3675, skbuffer, 20790, 2, 3);

            t4cfunc::bra_transform<2, 1>(sbuffer, 4200, skbuffer, 21420, 2, 3);
...
#endif /* ElectronRepulsionGeom1010RecDPDF_hpp */
