#ifndef ElectronRepulsionGeom1010RecSPSF_hpp
#define ElectronRepulsionGeom1010RecSPSF_hpp
...
/// @brief Computes d^(1)/dA^(1)d^(1)/dC^(1)(SP|1/|r-r'||SF)  integral derivatives.
...
template <class T>
inline auto
comp_electron_repulsion_geom1010_spsf(T& distributor,
                                      ...
                                      const std::pair<size_t, size_t>& ket_indices) -> void
{
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            t4cfunc::ket_transform<0, 3>(skbuffer, 189, ckbuffer, 0, 0, 1);

            t4cfunc::ket_transform<0, 3>(skbuffer, 210, ckbuffer, 30, 0, 1);

            t4cfunc::ket_transform<0, 3>(skbuffer, 231, ckbuffer, 60, 0, 1);
            ...
            erirec::comp_bra_geom1010_hrr_electron_repulsion_spxx(skbuffer, 0, 189, 252, r_ab, 0, 3);
...
#endif /* ElectronRepulsionGeom1010RecSPSF_hpp */
