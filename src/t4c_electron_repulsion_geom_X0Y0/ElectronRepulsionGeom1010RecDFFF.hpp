#ifndef ElectronRepulsionGeom1010RecDFFF_hpp
#define ElectronRepulsionGeom1010RecDFFF_hpp
...
/// @brief Computes d^(1)/dA^(1)d^(1)/dC^(1)(DF|1/|r-r'||FF)  integral derivatives.
...
template <class T>
inline auto
comp_electron_repulsion_geom1010_dfff(T& distributor,
                                      ...
                                      const std::pair<size_t, size_t>& ket_indices) -> void
{
    ...
    CSimdArray<double> ckbuffer(150579, 1);

    // allocate aligned half transformed integrals

    CSimdArray<double> skbuffer(98784, 1);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (int k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cfunc::reduce(cbuffer, 0, pbuffer, 6925, 100, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 100, pbuffer, 7325, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 250, pbuffer, 7925, 210, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 460, pbuffer, 11550, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 610, pbuffer, 12000, 225, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 835, pbuffer, 12675, 315, ket_width, ket_npgtos);
                ...
                t2cfunc::reduce(cbuffer, 3900, pbuffer, 6925, 100, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 4000, pbuffer, 7325, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 4150, pbuffer, 7925, 210, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 4360, pbuffer, 11550, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 4510, pbuffer, 12000, 225, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 4735, pbuffer, 12675, 315, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 5050, pbuffer, 16626, 210, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 5260, pbuffer, 17046, 315, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 5575, pbuffer, 17676, 441, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 6016, pbuffer, 21246, 280, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 6296, pbuffer, 21526, 420, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 6716, pbuffer, 21946, 588, ket_width, ket_npgtos);
                ...
                t2cfunc::reduce(cbuffer, 1150, pbuffer, 6925, 100, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1250, pbuffer, 7325, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1400, pbuffer, 7925, 210, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1610, pbuffer, 8765, 280, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 1890, pbuffer, 9885, 360, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 2250, pbuffer, 11550, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 2400, pbuffer, 12000, 225, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 2625, pbuffer, 12675, 315, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 2940, pbuffer, 13620, 420, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 3360, pbuffer, 14880, 540, ket_width, ket_npgtos);
                ...
                t2cfunc::reduce(cbuffer, 7304, pbuffer, 6925, 100, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 7404, pbuffer, 7325, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 7554, pbuffer, 7925, 210, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 7764, pbuffer, 8765, 280, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 8044, pbuffer, 9885, 360, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 8404, pbuffer, 11550, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 8554, pbuffer, 12000, 225, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 8779, pbuffer, 12675, 315, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 9094, pbuffer, 13620, 420, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 9514, pbuffer, 14880, 540, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 10054, pbuffer, 16626, 210, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 10264, pbuffer, 17046, 315, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 10579, pbuffer, 17676, 441, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 11020, pbuffer, 18558, 588, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 11608, pbuffer, 19734, 756, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 12364, pbuffer, 21246, 280, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 12644, pbuffer, 21526, 420, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 13064, pbuffer, 21946, 588, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 13652, pbuffer, 22534, 784, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 14436, pbuffer, 23318, 1008, ket_width, ket_npgtos);
            ...
            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 40245, cbuffer, 3900, 4000, cfactors, 6, 0, 3);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 41445, cbuffer, 4000, 4150, cfactors, 6, 0, 3);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 45135, 40245, 41445, cfactors, 6, 0, 3);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 56565, cbuffer, 4360, 4510, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 58365, cbuffer, 4510, 4735, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 63900, 56565, 58365, cfactors, 6, 0, 4);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 80712, cbuffer, 5050, 5260, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 83232, cbuffer, 5260, 5575, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 90981, 80712, 83232, cfactors, 6, 0, 5);

            erirec::comp_ket_hrr_electron_repulsion_xxpf(ckbuffer, 114207, cbuffer, 6016, 6296, cfactors, 6, 0, 6);

            erirec::comp_ket_hrr_electron_repulsion_xxpg(ckbuffer, 117567, cbuffer, 6296, 6716, cfactors, 6, 0, 6);

            erirec::comp_ket_hrr_electron_repulsion_xxdf(ckbuffer, 127899, 114207, 117567, cfactors, 6, 0, 6);
            ...
            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsf(ckbuffer, 38025, cbuffer, 7304, 7404, cfactors, 6, 0, 3);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsg(ckbuffer, 38325, cbuffer, 7404, 7554, cfactors, 6, 0, 3);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsh(ckbuffer, 38775, cbuffer, 7554, 7764, cfactors, 6, 0, 3);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsi(ckbuffer, 39405, cbuffer, 7764, 8044, cfactors, 6, 0, 3);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxpf(ckbuffer, 40545, cbuffer, 3900, 38025, 38325, cfactors, 6, 0, 3);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxpg(ckbuffer, 41895, cbuffer, 4000, 38325, 38775, cfactors, 6, 0, 3);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxph(ckbuffer, 43245, cbuffer, 4150, 38775, 39405, cfactors, 6, 0, 3);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxdf(ckbuffer, 45735, 40245, 40545, 41895, cfactors, 6, 0, 3);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxdg(ckbuffer, 47535, 41445, 41895, 43245, cfactors, 6, 0, 3);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxff(ckbuffer, 50235, 45135, 45735, 47535, cfactors, 6, 0, 3);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsf(ckbuffer, 53235, cbuffer, 8404, 8554, cfactors, 6, 0, 4);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsg(ckbuffer, 53685, cbuffer, 8554, 8779, cfactors, 6, 0, 4);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsh(ckbuffer, 54360, cbuffer, 8779, 9094, cfactors, 6, 0, 4);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsi(ckbuffer, 55305, cbuffer, 9094, 9514, cfactors, 6, 0, 4);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxpf(ckbuffer, 57015, cbuffer, 4360, 53235, 53685, cfactors, 6, 0, 4);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxpg(ckbuffer, 59040, cbuffer, 4510, 53685, 54360, cfactors, 6, 0, 4);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxph(ckbuffer, 61065, cbuffer, 4735, 54360, 55305, cfactors, 6, 0, 4);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxdf(ckbuffer, 64800, 56565, 57015, 59040, cfactors, 6, 0, 4);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxdg(ckbuffer, 67500, 58365, 59040, 61065, cfactors, 6, 0, 4);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxff(ckbuffer, 71550, 63900, 64800, 67500, cfactors, 6, 0, 4);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsf(ckbuffer, 76050, cbuffer, 10054, 10264, cfactors, 6, 0, 5);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsg(ckbuffer, 76680, cbuffer, 10264, 10579, cfactors, 6, 0, 5);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsh(ckbuffer, 77625, cbuffer, 10579, 11020, cfactors, 6, 0, 5);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsi(ckbuffer, 78948, cbuffer, 11020, 11608, cfactors, 6, 0, 5);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxpf(ckbuffer, 81342, cbuffer, 5050, 76050, 76680, cfactors, 6, 0, 5);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxpg(ckbuffer, 84177, cbuffer, 5260, 76680, 77625, cfactors, 6, 0, 5);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxph(ckbuffer, 87012, cbuffer, 5575, 77625, 78948, cfactors, 6, 0, 5);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxdf(ckbuffer, 92241, 80712, 81342, 84177, cfactors, 6, 0, 5);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxdg(ckbuffer, 96021, 83232, 84177, 87012, cfactors, 6, 0, 5);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxff(ckbuffer, 101691, 90981, 92241, 96021, cfactors, 6, 0, 5);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsf(ckbuffer, 107991, cbuffer, 12364, 12644, cfactors, 6, 0, 6);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsg(ckbuffer, 108831, cbuffer, 12644, 13064, cfactors, 6, 0, 6);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsh(ckbuffer, 110091, cbuffer, 13064, 13652, cfactors, 6, 0, 6);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxsi(ckbuffer, 111855, cbuffer, 13652, 14436, cfactors, 6, 0, 6);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxpf(ckbuffer, 115047, cbuffer, 6016, 107991, 108831, cfactors, 6, 0, 6);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxpg(ckbuffer, 118827, cbuffer, 6296, 108831, 110091, cfactors, 6, 0, 6);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxph(ckbuffer, 122607, cbuffer, 6716, 110091, 111855, cfactors, 6, 0, 6);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxdf(ckbuffer, 129579, 114207, 115047, 118827, cfactors, 6, 0, 6);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxdg(ckbuffer, 134619, 117567, 118827, 122607, cfactors, 6, 0, 6);

            erirec::comp_ket_geom10_hrr_electron_repulsion_xxff(ckbuffer, 142179, 127899, 129579, 134619, cfactors, 6, 0, 6);
            ...
            t4cfunc::ket_transform<3, 3>(skbuffer, 87906, ckbuffer, 50235, 0, 3);

            t4cfunc::ket_transform<3, 3>(skbuffer, 88396, ckbuffer, 51235, 0, 3);

            t4cfunc::ket_transform<3, 3>(skbuffer, 88886, ckbuffer, 52235, 0, 3);

            t4cfunc::ket_transform<3, 3>(skbuffer, 89376, ckbuffer, 71550, 0, 4);

            t4cfunc::ket_transform<3, 3>(skbuffer, 90111, ckbuffer, 73050, 0, 4);

            t4cfunc::ket_transform<3, 3>(skbuffer, 90846, ckbuffer, 74550, 0, 4);

            t4cfunc::ket_transform<3, 3>(skbuffer, 91581, ckbuffer, 101691, 0, 5);

            t4cfunc::ket_transform<3, 3>(skbuffer, 92610, ckbuffer, 103791, 0, 5);

            t4cfunc::ket_transform<3, 3>(skbuffer, 93639, ckbuffer, 105891, 0, 5);

            t4cfunc::ket_transform<3, 3>(skbuffer, 94668, ckbuffer, 142179, 0, 6);

            t4cfunc::ket_transform<3, 3>(skbuffer, 96040, ckbuffer, 144979, 0, 6);

            t4cfunc::ket_transform<3, 3>(skbuffer, 97412, ckbuffer, 147779, 0, 6);

            erirec::comp_bra_hrr_electron_repulsion_pfxx(skbuffer, 23961, 0, 5880, r_ab, 3, 3);

            erirec::comp_bra_hrr_electron_repulsion_pfxx(skbuffer, 25431, 490, 6615, r_ab, 3, 3);

            erirec::comp_bra_hrr_electron_repulsion_pfxx(skbuffer, 26901, 980, 7350, r_ab, 3, 3);

            erirec::comp_bra_geom1010_hrr_electron_repulsion_sfxx(skbuffer, 1470, 87906, 89376, r_ab, 3, 3);

            erirec::comp_bra_geom1010_hrr_electron_repulsion_sgxx(skbuffer, 8085, 89376, 91581, r_ab, 3, 3);

            erirec::comp_bra_geom1010_hrr_electron_repulsion_shxx(skbuffer, 14700, 91581, 94668, r_ab, 3, 3);

            erirec::comp_bra_geom1010_hrr_electron_repulsion_pfxx(skbuffer, 28371, 0, 1470, 8085, r_ab, 3, 3);

            erirec::comp_bra_geom1010_hrr_electron_repulsion_pgxx(skbuffer, 41601, 5880, 8085, 14700, r_ab, 3, 3);

            erirec::comp_bra_geom1010_hrr_electron_repulsion_dfxx(skbuffer, 61446, 23961, 28371, 41601, r_ab, 3, 3);

            t4cfunc::bra_transform<2, 3>(sbuffer, 0, skbuffer, 61446, 3, 3);

            t4cfunc::bra_transform<2, 3>(sbuffer, 1715, skbuffer, 64386, 3, 3);

            t4cfunc::bra_transform<2, 3>(sbuffer, 3430, skbuffer, 67326, 3, 3);

            t4cfunc::bra_transform<2, 3>(sbuffer, 5145, skbuffer, 70266, 3, 3);

            t4cfunc::bra_transform<2, 3>(sbuffer, 6860, skbuffer, 73206, 3, 3);

            t4cfunc::bra_transform<2, 3>(sbuffer, 8575, skbuffer, 76146, 3, 3);

            t4cfunc::bra_transform<2, 3>(sbuffer, 10290, skbuffer, 79086, 3, 3);

            t4cfunc::bra_transform<2, 3>(sbuffer, 12005, skbuffer, 82026, 3, 3);

            t4cfunc::bra_transform<2, 3>(sbuffer, 13720, skbuffer, 84966, 3, 3);
...
#endif /* ElectronRepulsionGeom1010RecDFFF_hpp */
