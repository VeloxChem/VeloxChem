#ifndef ElectronRepulsionGeom1010RecSDPF_hpp
#define ElectronRepulsionGeom1010RecSDPF_hpp
...
/// @brief Computes d^(1)/dA^(1)d^(1)/dC^(1)(SD|1/|r-r'||PF)  integral derivatives.
...
template <class T>
inline auto
comp_electron_repulsion_geom1010_sdpf(T& distributor,
                                      ...
                                      const std::pair<size_t, size_t>& ket_indices) -> void
{
    ...
    CSimdArray<double> ckbuffer(2640, 1);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (int k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cfunc::reduce(cbuffer, 60, pbuffer, 1341, 100, ket_width, ket_npgtos);
                ...
                t2cfunc::reduce(cbuffer, 160, pbuffer, 789, 60, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 220, pbuffer, 909, 90, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 310, pbuffer, 1089, 126, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 436, pbuffer, 1341, 100, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 536, pbuffer, 1441, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 686, pbuffer, 1591, 210, ket_width, ket_npgtos);
            ...
            t4cfunc::ket_transform<1, 3>(skbuffer, 1134, ckbuffer, 450, 0, 2);

            t4cfunc::ket_transform<1, 3>(skbuffer, 1260, ckbuffer, 630, 0, 2);

            t4cfunc::ket_transform<1, 3>(skbuffer, 1386, ckbuffer, 810, 0, 2);
            ...
            erirec::comp_bra_geom1010_hrr_electron_repulsion_sdxx(skbuffer, 0, 1134, 1512, r_ab, 1, 3);
...
#endif /* ElectronRepulsionGeom1010RecSDPF_hpp */
