#ifndef LocalCorePotentialGeom100PD_hpp
#define LocalCorePotentialGeom100PD_hpp
...
template <class T>
auto
comp_local_core_potential_geom_100_pd(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(127, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_10_px(pbuffer, 73, 4, 37, 1, 6, a_exp);
...
#endif /* LocalCorePotentialGeom100PD_hpp */
