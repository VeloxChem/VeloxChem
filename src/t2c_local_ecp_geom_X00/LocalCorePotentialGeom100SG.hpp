#ifndef LocalCorePotentialGeom100SG_hpp
#define LocalCorePotentialGeom100SG_hpp
...
template <class T>
auto
comp_local_core_potential_geom_100_sg(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_pg(pbuffer, 35, 10, 20, pfactors, 8, 14);
...
#endif /* LocalCorePotentialGeom100SG_hpp */
