#ifndef LocalCorePotentialGeom100FS_hpp
#define LocalCorePotentialGeom100FS_hpp
...
template <class T>
auto
comp_local_core_potential_geom_100_fs(T& distributor,
...
#endif /* LocalCorePotentialGeom100FS_hpp */
