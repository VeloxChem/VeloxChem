#ifndef LocalCorePotentialGeom200SF_hpp
#define LocalCorePotentialGeom200SF_hpp
...
template <class T>
auto
comp_local_core_potential_geom_200_sf(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_pd(pbuffer, 20, 1, 4, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_pf(pbuffer, 38, 4, 10, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_df(pbuffer, 68, 10, 20, 38, pfactors, 8, 14);
...
#endif /* LocalCorePotentialGeom200SF_hpp */
