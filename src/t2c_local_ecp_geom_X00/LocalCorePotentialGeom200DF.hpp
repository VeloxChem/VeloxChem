#ifndef LocalCorePotentialGeom200DF_hpp
#define LocalCorePotentialGeom200DF_hpp
...
template <class T>
auto
comp_local_core_potential_geom_200_df(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_ff(pbuffer, 254, 50, 98, 134, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_gf(pbuffer, 354, 134, 194, 254, pfactors, 8, 14);
...
#endif /* LocalCorePotentialGeom200DF_hpp */
