#ifndef LocalCorePotentialGeom200SG_hpp
#define LocalCorePotentialGeom200SG_hpp
...
template <class T>
auto
comp_local_core_potential_geom_200_sg(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_20_sx(pbuffer, 200, 20, 110, 1, 15, a_exp);
...
#endif /* LocalCorePotentialGeom200SG_hpp */
