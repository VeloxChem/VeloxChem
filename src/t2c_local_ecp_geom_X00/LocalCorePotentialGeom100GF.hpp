#ifndef LocalCorePotentialGeom100GF_hpp
#define LocalCorePotentialGeom100GF_hpp
...
template <class T>
auto
comp_local_core_potential_geom_100_gf(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_fp(pbuffer, 200, 23, 80, 86, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_fd(pbuffer, 230, 32, 86, 104, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_ff(pbuffer, 290, 50, 104, 140, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_gd(pbuffer, 390, 104, 200, 230, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_gf(pbuffer, 480, 140, 230, 290, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_hf(pbuffer, 630, 290, 390, 480, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_10_gx(pbuffer, 840, 290, 630, 1, 10, a_exp);
...
#endif /* LocalCorePotentialGeom100GF_hpp */
