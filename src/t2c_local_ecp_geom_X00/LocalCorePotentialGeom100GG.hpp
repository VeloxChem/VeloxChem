#ifndef LocalCorePotentialGeom100GG_hpp
#define LocalCorePotentialGeom100GG_hpp
...
template <class T>
auto
comp_local_core_potential_geom_100_gg(T& distributor,
...
#endif /* LocalCorePotentialGeom100GG_hpp */
