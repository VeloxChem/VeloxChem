#ifndef LocalCorePotentialGeom200DP_hpp
#define LocalCorePotentialGeom200DP_hpp
...
template <class T>
auto
comp_local_core_potential_geom_200_dp(T& distributor,
...
#endif /* LocalCorePotentialGeom200DP_hpp */
