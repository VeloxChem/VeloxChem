#ifndef LocalCorePotentialGeom200SP_hpp
#define LocalCorePotentialGeom200SP_hpp
...
template <class T>
auto
comp_local_core_potential_geom_200_sp(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_dp(pbuffer, 16, 1, 4, 7, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_20_sx(pbuffer, 34, 1, 16, 1, 3, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 34, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom200SP_hpp */
