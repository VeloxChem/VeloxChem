#ifndef LocalCorePotentialGeom200PD_hpp
#define LocalCorePotentialGeom200PD_hpp
...
template <class T>
auto
comp_local_core_potential_geom_200_pd(T& distributor,
...
#endif /* LocalCorePotentialGeom200PD_hpp */
