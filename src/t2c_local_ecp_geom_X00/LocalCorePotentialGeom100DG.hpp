#ifndef LocalCorePotentialGeom100DG_hpp
#define LocalCorePotentialGeom100DG_hpp
...
template <class T>
auto
comp_local_core_potential_geom_100_dg(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_10_dx(pbuffer, 428, 83, 278, 1, 15, a_exp);
...
#endif /* LocalCorePotentialGeom100DG_hpp */
