#ifndef LocalCorePotentialGeom100PP_hpp
#define LocalCorePotentialGeom100PP_hpp
...
template <class T>
auto
comp_local_core_potential_geom_100_pp(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_10_px(pbuffer, 34, 1, 16, 1, 3, a_exp);
...
#endif /* LocalCorePotentialGeom100PP_hpp */
