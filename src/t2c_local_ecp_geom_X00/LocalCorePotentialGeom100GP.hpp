#ifndef LocalCorePotentialGeom100GP_hpp
#define LocalCorePotentialGeom100GP_hpp
...
template <class T>
auto
comp_local_core_potential_geom_100_gp(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(338, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_hp(pbuffer, 140, 50, 80, 95, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_10_gx(pbuffer, 203, 50, 140, 1, 3, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 203, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom100GP_hpp */
