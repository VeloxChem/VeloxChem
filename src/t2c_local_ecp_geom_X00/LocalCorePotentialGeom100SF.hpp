#ifndef LocalCorePotentialGeom100SF_hpp
#define LocalCorePotentialGeom100SF_hpp
...
template <class T>
auto
comp_local_core_potential_geom_100_sf(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_pf(pbuffer, 20, 4, 10, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_10_sx(pbuffer, 50, 20, 1, 10, a_exp);
...
#endif /* LocalCorePotentialGeom100SF_hpp */
