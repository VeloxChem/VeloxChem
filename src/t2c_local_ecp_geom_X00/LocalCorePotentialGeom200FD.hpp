#ifndef LocalCorePotentialGeom200FD_hpp
#define LocalCorePotentialGeom200FD_hpp
...
template <class T>
auto
comp_local_core_potential_geom_200_fd(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_gp(pbuffer, 200, 46, 100, 110, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_gd(pbuffer, 245, 64, 110, 140, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_hd(pbuffer, 335, 140, 200, 245, pfactors, 8, 14);
...
#endif /* LocalCorePotentialGeom200FD_hpp */
