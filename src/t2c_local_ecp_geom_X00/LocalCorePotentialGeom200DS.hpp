#ifndef LocalCorePotentialGeom200DS_hpp
#define LocalCorePotentialGeom200DS_hpp
...
template <class T>
auto
comp_local_core_potential_geom_200_ds(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_20_dx(pbuffer, 35, 0, 4, 20, 1, 1, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 35, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom200DS_hpp */
