#ifndef LocalCorePotentialGeom200GD_hpp
#define LocalCorePotentialGeom200GD_hpp
...
template <class T>
auto
comp_local_core_potential_geom_200_gd(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2lecp::comp_prim_local_core_potential_hp(pbuffer, 350, 110, 200, 215, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_hd(pbuffer, 413, 140, 215, 260, pfactors, 8, 14);

                    t2lecp::comp_prim_local_core_potential_id(pbuffer, 539, 260, 350, 413, pfactors, 8, 14);

                    t2cgeom::comp_prim_op_geom_20_gx(pbuffer, 707, 64, 260, 539, 1, 6, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 707, ket_width, ket_npgtos);
                }
            }
...
#endif /* LocalCorePotentialGeom200GD_hpp */
