#ifndef ThreeCenterElectronRepulsionGeom010ContrRecXDI_hpp
#define ThreeCenterElectronRepulsionGeom010ContrRecXDI_hpp
...
/// @brief Computes d^(1)/dC^(1)(X|1/|r-r'||DI)  integral derivatives.
...
#endif /* ThreeCenterElectronRepulsionGeom010ContrRecXDI_hpp */
