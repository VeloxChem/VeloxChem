#ifndef ThreeCenterElectronRepulsionGeom010ContrRecXPI_hpp
#define ThreeCenterElectronRepulsionGeom010ContrRecXPI_hpp
...
/// @brief Computes d^(1)/dC^(1)(X|1/|r-r'||PI)  integral derivatives.
...
#endif /* ThreeCenterElectronRepulsionGeom010ContrRecXPI_hpp */
