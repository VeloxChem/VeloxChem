#ifndef ThreeCenterElectronRepulsionGeom010ContrRecXFP_hpp
#define ThreeCenterElectronRepulsionGeom010ContrRecXFP_hpp
...
/// @brief Computes d^(1)/dC^(1)(X|1/|r-r'||FP)  integral derivatives.
...
#endif /* ThreeCenterElectronRepulsionGeom010ContrRecXFP_hpp */
