#ifndef ThreeCenterElectronRepulsionGeom010ContrRecXSH_hpp
#define ThreeCenterElectronRepulsionGeom010ContrRecXSH_hpp
...
/// @brief Computes d^(1)/dC^(1)(X|1/|r-r'||SH)  integral derivatives.
...
#endif /* ThreeCenterElectronRepulsionGeom010ContrRecXSH_hpp */
