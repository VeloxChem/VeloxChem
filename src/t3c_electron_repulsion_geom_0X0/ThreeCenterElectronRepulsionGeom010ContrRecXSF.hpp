#ifndef ThreeCenterElectronRepulsionGeom010ContrRecXSF_hpp
#define ThreeCenterElectronRepulsionGeom010ContrRecXSF_hpp
...
/// @brief Computes d^(1)/dC^(1)(X|1/|r-r'||SF)  integral derivatives.
...
#endif /* ThreeCenterElectronRepulsionGeom010ContrRecXSF_hpp */
