#ifndef ThreeCenterElectronRepulsionGeom010ContrRecXSD_hpp
#define ThreeCenterElectronRepulsionGeom010ContrRecXSD_hpp
...
/// @brief Computes d^(1)/dC^(1)(X|1/|r-r'||SD)  integral derivatives.
...
#endif /* ThreeCenterElectronRepulsionGeom010ContrRecXSD_hpp */
