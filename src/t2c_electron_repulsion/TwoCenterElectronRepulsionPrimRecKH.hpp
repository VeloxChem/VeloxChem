#ifndef TwoCenterElectronRepulsionPrimRecKH
#define TwoCenterElectronRepulsionPrimRecKH

#include "SimdArray.hpp"

namespace t2ceri { // t2ceri namespace

/// @brief Computes primitive [K|1/|r-r'||H]  integrals for set of data buffers.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_eri_0_kh The index of integral in primitive integrals buffer.
...
#endif /* TwoCenterElectronRepulsionPrimRecKH */
