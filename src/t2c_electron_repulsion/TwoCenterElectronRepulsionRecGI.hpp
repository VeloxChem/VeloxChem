#ifndef TwoCenterElectronRepulsionRecGI_hpp
#define TwoCenterElectronRepulsionRecGI_hpp
...
/// @brief Computes (G|1/|r-r'||I)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electron_repulsion_gi(T& distributor,
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cfunc::reduce(cbuffer, pbuffer, 2238, ket_width, ket_npgtos);
            }
...
#endif /* TwoCenterElectronRepulsionRecGI_hpp */
