#ifndef TwoCenterElectronRepulsionRecGP_hpp
#define TwoCenterElectronRepulsionRecGP_hpp
...
/// @brief Computes (G|1/|r-r'||P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electron_repulsion_gp(T& distributor,
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cfunc::reduce(cbuffer, pbuffer, 156, ket_width, ket_npgtos);
            }
...
#endif /* TwoCenterElectronRepulsionRecGP_hpp */
