#ifndef TwoCenterElectronRepulsionRecPI_hpp
#define TwoCenterElectronRepulsionRecPI_hpp
...
/// @brief Computes (P|1/|r-r'||I)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electron_repulsion_pi(T& distributor,
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cfunc::reduce(cbuffer, pbuffer, 210, ket_width, ket_npgtos);
            }
...
#endif /* TwoCenterElectronRepulsionRecPI_hpp */
