#ifndef TwoCenterElectronRepulsionRecDI_hpp
#define TwoCenterElectronRepulsionRecDI_hpp
...
/// @brief Computes (D|1/|r-r'||I)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electron_repulsion_di(T& distributor,
                           ...
                           const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(659, ket_npgtos);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cfunc::reduce(cbuffer, pbuffer, 491, ket_width, ket_npgtos);
            }

            t2cfunc::transform<2, 6>(sbuffer, cbuffer);

            distributor.distribute(sbuffer, bra_gto_indices, ket_gto_indices, 2, 6, j, ket_range, bra_eq_ket);
        }
    }
}
...
#endif /* TwoCenterElectronRepulsionRecDI_hpp */
