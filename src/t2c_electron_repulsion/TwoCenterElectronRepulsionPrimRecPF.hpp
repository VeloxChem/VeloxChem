#ifndef TwoCenterElectronRepulsionPrimRecPF
#define TwoCenterElectronRepulsionPrimRecPF

#include "SimdArray.hpp"

namespace t2ceri { // t2ceri namespace

/// @brief Computes primitive [P|1/|r-r'||F]  integrals for set of data buffers.
...
#endif /* TwoCenterElectronRepulsionPrimRecPF */
