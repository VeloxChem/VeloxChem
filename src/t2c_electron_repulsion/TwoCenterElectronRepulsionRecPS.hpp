#ifndef TwoCenterElectronRepulsionRecPS_hpp
#define TwoCenterElectronRepulsionRecPS_hpp
...
/// @brief Computes (P|1/|r-r'||S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electron_repulsion_ps(T& distributor,
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cfunc::comp_boys_args_with_rho(bf_data, 2, factors, 5, a_exp);
...
#endif /* TwoCenterElectronRepulsionRecPS_hpp */
