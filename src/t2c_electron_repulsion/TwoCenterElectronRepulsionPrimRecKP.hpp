#ifndef TwoCenterElectronRepulsionPrimRecKP
#define TwoCenterElectronRepulsionPrimRecKP

#include "SimdArray.hpp"

namespace t2ceri { // t2ceri namespace

/// @brief Computes primitive [K|1/|r-r'||P]  integrals for set of data buffers.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_eri_0_kp The index of integral in primitive integrals buffer.
...
#endif /* TwoCenterElectronRepulsionPrimRecKP */
