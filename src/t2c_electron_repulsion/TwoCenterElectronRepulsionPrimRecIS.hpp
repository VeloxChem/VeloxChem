#ifndef TwoCenterElectronRepulsionPrimRecIS
#define TwoCenterElectronRepulsionPrimRecIS

#include "SimdArray.hpp"

namespace t2ceri { // t2ceri namespace

/// @brief Computes primitive [I|1/|r-r'||S]  integrals for set of data buffers.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_eri_0_is The index of integral in primitive integrals buffer.
...
#endif /* TwoCenterElectronRepulsionPrimRecIS */
