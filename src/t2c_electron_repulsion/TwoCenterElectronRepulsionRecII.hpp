#ifndef TwoCenterElectronRepulsionRecII_hpp
#define TwoCenterElectronRepulsionRecII_hpp
...
/// @brief Computes (I|1/|r-r'||I)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electron_repulsion_ii(T& distributor,
                           ...
                           const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(8584, ket_npgtos);

    // allocate aligned contracted integrals

    CSimdArray<double> cbuffer(784, 1);

    CSimdArray<double> sbuffer(169, 1);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cfunc::reduce(cbuffer, pbuffer, 7800, ket_width, ket_npgtos);
            }
...
#endif /* TwoCenterElectronRepulsionRecII_hpp */
