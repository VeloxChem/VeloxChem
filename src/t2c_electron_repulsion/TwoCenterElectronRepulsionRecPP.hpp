#ifndef TwoCenterElectronRepulsionRecPP_hpp
#define TwoCenterElectronRepulsionRecPP_hpp
...
/// @brief Computes (P|1/|r-r'||P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electron_repulsion_pp(T& distributor,
...
#endif /* TwoCenterElectronRepulsionRecPP_hpp */
