#ifndef TwoCenterElectronRepulsionRecFH_hpp
#define TwoCenterElectronRepulsionRecFH_hpp
...
/// @brief Computes (F|1/|r-r'||H)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_electron_repulsion_fh(T& distributor,
                           ...
                           const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(928, ket_npgtos);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cfunc::reduce(cbuffer, pbuffer, 718, ket_width, ket_npgtos);
            }
...
#endif /* TwoCenterElectronRepulsionRecFH_hpp */
