#ifndef NuclearPotentialGeom100SumErfRecDS_hpp
#define NuclearPotentialGeom100SumErfRecDS_hpp
...
/// @brief Computes (d^(1)/dA^(1)D|Erf(A)|S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_geom_10_ds(T& distributor,
                                          ...
                                          const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(54, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < coords.size(); l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_10_dx(pbuffer, 36, 5, 26, 1, 1, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 36, charges[l], ket_width, ket_npgtos);
                }
            }
...
#endif /* NuclearPotentialGeom100SumErfRecDS_hpp */
