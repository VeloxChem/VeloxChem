#ifndef NuclearPotentialGeom100SumErfRecGD_hpp
#define NuclearPotentialGeom100SumErfRecGD_hpp
...
/// @brief Computes (d^(1)/dA^(1)G|Erf(A)|D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_geom_10_gd(T& distributor,
...
#endif /* NuclearPotentialGeom100SumErfRecGD_hpp */
