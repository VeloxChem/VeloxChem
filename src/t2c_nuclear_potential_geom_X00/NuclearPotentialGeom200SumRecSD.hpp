#ifndef NuclearPotentialGeom200SumRecSD_hpp
#define NuclearPotentialGeom200SumRecSD_hpp
...
/// @brief Computes (d^(2)/dA^(2)S|A|D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_geom_20_sd(T&                               distributor,
                                      ...
                                      const bool                       bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(162, ket_npgtos);
...
#endif /* NuclearPotentialGeom200SumRecSD_hpp */
