#ifndef NuclearPotentialGeom100SumRecSG_hpp
#define NuclearPotentialGeom100SumRecSG_hpp
...
/// @brief Computes (d^(1)/dA^(1)S|A|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_geom_10_sg(T&                               distributor,
...
#endif /* NuclearPotentialGeom100SumRecSG_hpp */
