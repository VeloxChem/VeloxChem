#ifndef NuclearPotentialGeom100SumErfRecSP_hpp
#define NuclearPotentialGeom100SumErfRecSP_hpp
...
/// @brief Computes (d^(1)/dA^(1)S|Erf(A)|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_geom_10_sp(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < coords.size(); l++)
                {
                    ...
                    t2cfunc::comp_boys_args(bf_data, 2, factors, 17, a_exp, omegas[l]);
...
#endif /* NuclearPotentialGeom100SumErfRecSP_hpp */
