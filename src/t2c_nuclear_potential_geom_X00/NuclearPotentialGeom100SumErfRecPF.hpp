#ifndef NuclearPotentialGeom100SumErfRecPF_hpp
#define NuclearPotentialGeom100SumErfRecPF_hpp
...
/// @brief Computes (d^(1)/dA^(1)P|Erf(A)|F)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_geom_10_pf(T& distributor,
...
#endif /* NuclearPotentialGeom100SumErfRecPF_hpp */
