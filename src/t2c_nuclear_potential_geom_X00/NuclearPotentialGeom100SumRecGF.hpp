#ifndef NuclearPotentialGeom100SumRecGF_hpp
#define NuclearPotentialGeom100SumRecGF_hpp
...
/// @brief Computes (d^(1)/dA^(1)G|A|F)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_geom_10_gf(T&                               distributor,
...
#endif /* NuclearPotentialGeom100SumRecGF_hpp */
