#ifndef NuclearPotentialGeom100SumErfRecDP_hpp
#define NuclearPotentialGeom100SumErfRecDP_hpp
...
/// @brief Computes (d^(1)/dA^(1)D|Erf(A)|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_geom_10_dp(T& distributor,
...
#endif /* NuclearPotentialGeom100SumErfRecDP_hpp */
