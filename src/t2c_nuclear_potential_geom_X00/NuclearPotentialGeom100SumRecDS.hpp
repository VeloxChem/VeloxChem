#ifndef NuclearPotentialGeom100SumRecDS_hpp
#define NuclearPotentialGeom100SumRecDS_hpp
...
/// @brief Computes (d^(1)/dA^(1)D|A|S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_geom_10_ds(T&                               distributor,
...
#endif /* NuclearPotentialGeom100SumRecDS_hpp */
