#ifndef NuclearPotentialGeom100SumRecGG_hpp
#define NuclearPotentialGeom100SumRecGG_hpp
...
/// @brief Computes (d^(1)/dA^(1)G|A|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_geom_10_gg(T& distributor,
...
#endif /* NuclearPotentialGeom100SumRecGG_hpp */
