#ifndef NuclearPotentialGeom100SumErfRecSG_hpp
#define NuclearPotentialGeom100SumErfRecSG_hpp
...
/// @brief Computes (d^(1)/dA^(1)S|Erf(A)|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_geom_10_sg(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < coords.size(); l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_10_sx(pbuffer, 151, 106, 1, 15, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 151, charges[l], ket_width, ket_npgtos);
                }
            }
...
#endif /* NuclearPotentialGeom100SumErfRecSG_hpp */
