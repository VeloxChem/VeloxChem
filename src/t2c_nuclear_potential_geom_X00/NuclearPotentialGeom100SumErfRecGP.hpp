#ifndef NuclearPotentialGeom100SumErfRecGP_hpp
#define NuclearPotentialGeom100SumErfRecGP_hpp
...
/// @brief Computes (d^(1)/dA^(1)G|Erf(A)|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_geom_10_gp(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < coords.size(); l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_10_gx(pbuffer, 485, 212, 422, 1, 3, a_exp);
...
#endif /* NuclearPotentialGeom100SumErfRecGP_hpp */
