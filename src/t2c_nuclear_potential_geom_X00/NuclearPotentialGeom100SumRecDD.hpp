#ifndef NuclearPotentialGeom100SumRecDD_hpp
#define NuclearPotentialGeom100SumRecDD_hpp
...
/// @brief Computes (d^(1)/dA^(1)D|A|D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_geom_10_dd(T& distributor,
...
#endif /* NuclearPotentialGeom100SumRecDD_hpp */
