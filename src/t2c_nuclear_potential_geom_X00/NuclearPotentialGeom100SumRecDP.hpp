#ifndef NuclearPotentialGeom100SumRecDP_hpp
#define NuclearPotentialGeom100SumRecDP_hpp
...
/// @brief Computes (d^(1)/dA^(1)D|A|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_geom_10_dp(T&                               distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < coords.size(); l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_10_dx(pbuffer, 132, 27, 102, 1, 3, a_exp);

                    t2cfunc::reduce(cbuffer, pbuffer, 132, charges[l], ket_width, ket_npgtos);
                }
            }
...
#endif /* NuclearPotentialGeom100SumRecDP_hpp */
