#ifndef NuclearPotentialGeom100SumRecFF_hpp
#define NuclearPotentialGeom100SumRecFF_hpp
...
/// @brief Computes (d^(1)/dA^(1)F|A|F)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_geom_10_ff(T&                               distributor,
...
#endif /* NuclearPotentialGeom100SumRecFF_hpp */
