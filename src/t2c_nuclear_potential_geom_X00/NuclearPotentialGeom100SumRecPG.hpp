#ifndef NuclearPotentialGeom100SumRecPG_hpp
#define NuclearPotentialGeom100SumRecPG_hpp
...
/// @brief Computes (d^(1)/dA^(1)P|A|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_geom_10_pg(T&                               distributor,
...
#endif /* NuclearPotentialGeom100SumRecPG_hpp */
