#ifndef NuclearPotentialGeom200SumRecFG_hpp
#define NuclearPotentialGeom200SumRecFG_hpp
...
/// @brief Computes (d^(2)/dA^(2)F|A|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_geom_20_fg(T&                               distributor,
                                      ...
                                      const bool                       bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(4482, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < coords.size(); l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_20_fx(pbuffer, 3582, 546, 2067, 3267, 1, 15, a_exp);
...
#endif /* NuclearPotentialGeom200SumRecFG_hpp */
