#ifndef NuclearPotentialGeom200SumRecFF_hpp
#define NuclearPotentialGeom200SumRecFF_hpp
...
/// @brief Computes (d^(2)/dA^(2)F|A|F)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_geom_20_ff(T&                               distributor,
                                      ...
                                      const bool                       bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(2776, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < coords.size(); l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_20_fx(pbuffer, 2176, 286, 1186, 1966, 1, 10, a_exp);
...
#endif /* NuclearPotentialGeom200SumRecFF_hpp */
