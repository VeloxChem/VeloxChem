#ifndef NuclearPotentialGeom100SumRecPF_hpp
#define NuclearPotentialGeom100SumRecPF_hpp
...
/// @brief Computes (d^(1)/dA^(1)P|A|F)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_geom_10_pf(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(322, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < coords.size(); l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_10_px(pbuffer, 232, 46, 172, 1, 10, a_exp);
...
#endif /* NuclearPotentialGeom100SumRecPF_hpp */
