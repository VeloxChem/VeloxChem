#ifndef NuclearPotentialGeom100SumErfRecPS_hpp
#define NuclearPotentialGeom100SumErfRecPS_hpp
...
/// @brief Computes (d^(1)/dA^(1)P|Erf(A)|S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_geom_10_ps(T& distributor,
...
#endif /* NuclearPotentialGeom100SumErfRecPS_hpp */
