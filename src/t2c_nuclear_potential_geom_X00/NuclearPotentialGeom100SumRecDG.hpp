#ifndef NuclearPotentialGeom100SumRecDG_hpp
#define NuclearPotentialGeom100SumRecDG_hpp
...
/// @brief Computes (d^(1)/dA^(1)D|A|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_geom_10_dg(T&                               distributor,
...
#endif /* NuclearPotentialGeom100SumRecDG_hpp */
