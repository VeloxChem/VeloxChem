#ifndef NuclearPotentialGeom100SumErfRecDD_hpp
#define NuclearPotentialGeom100SumErfRecDD_hpp
...
/// @brief Computes (d^(1)/dA^(1)D|Erf(A)|D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_erf_nuclear_potential_geom_10_dd(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < coords.size(); l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_10_dx(pbuffer, 304, 82, 244, 1, 6, a_exp);
...
#endif /* NuclearPotentialGeom100SumErfRecDD_hpp */
