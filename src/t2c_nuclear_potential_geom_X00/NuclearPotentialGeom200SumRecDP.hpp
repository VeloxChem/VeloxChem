#ifndef NuclearPotentialGeom200SumRecDP_hpp
#define NuclearPotentialGeom200SumRecDP_hpp
...
/// @brief Computes (d^(2)/dA^(2)D|A|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_nuclear_potential_geom_20_dp(T& distributor,
                                      ...
                                      const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(375, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < coords.size(); l++)
                {
                    ...
                    t2cgeom::comp_prim_op_geom_20_dx(pbuffer, 267, 7, 88, 222, 1, 3, a_exp);
...
#endif /* NuclearPotentialGeom200SumRecDP_hpp */
