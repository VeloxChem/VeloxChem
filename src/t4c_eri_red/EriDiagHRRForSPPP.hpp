                      ...
                      const int32_t               nBatchPairs) -> void
{
    ...
    t_0_y_0_y = intsBufferSPSP.data(intsIndexesSPSP(1));

    t_0_x_0_x = intsBufferSPSP.data(intsIndexesSPSP(2));
    ...
    t_0_z_0_xz = intsBufferSPSD.data(intsIndexesSPSD(2));

    t_0_y_0_yz = intsBufferSPSD.data(intsIndexesSPSD(3));

    t_0_y_0_yy = intsBufferSPSD.data(intsIndexesSPSD(4));

    t_0_y_0_xy = intsBufferSPSD.data(intsIndexesSPSD(5));

    t_0_x_0_xz = intsBufferSPSD.data(intsIndexesSPSD(6));

    t_0_x_0_xy = intsBufferSPSD.data(intsIndexesSPSD(7));

    t_0_x_0_xx = intsBufferSPSD.data(intsIndexesSPSD(8));

    #pragma omp simd align(rcd_x, rcd_y, rcd_z, t_0_x_0_x, t_0_x_0_xx, t_0_x_0_xy, t_0_x_0_xz,\
                           t_0_x_x_x, t_0_x_y_x, t_0_x_z_x, t_0_y_0_xy, t_0_y_0_y, t_0_y_0_yy,\
                           t_0_y_0_yz, t_0_y_x_y, t_0_y_y_y, t_0_y_z_y, t_0_z_0_xz,\
                           t_0_z_0_yz, t_0_z_0_z, t_0_z_0_zz, t_0_z_x_z, t_0_z_y_z,\
                           t_0_z_z_z : VLX_ALIGN)
