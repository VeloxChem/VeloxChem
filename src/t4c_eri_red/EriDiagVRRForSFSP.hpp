                      ...
                      const int32_t               nBatchPairs) -> void
{
    ...
    t_0_yzz_0_z_0 = intsBufferSFSP0.data(intsIndexesSFSP0(1));

    t_0_yzz_0_y_0 = intsBufferSFSP0.data(intsIndexesSFSP0(2));

    t_0_yyz_0_z_0 = intsBufferSFSP0.data(intsIndexesSFSP0(3));

    t_0_yyy_0_y_0 = intsBufferSFSP0.data(intsIndexesSFSP0(4));

    t_0_xzz_0_z_0 = intsBufferSFSP0.data(intsIndexesSFSP0(5));

    t_0_xyy_0_y_0 = intsBufferSFSP0.data(intsIndexesSFSP0(6));

    t_0_xxz_0_z_0 = intsBufferSFSP0.data(intsIndexesSFSP0(7));

    t_0_xxx_0_x_0 = intsBufferSFSP0.data(intsIndexesSFSP0(8));
    ...
    t_0_yy_0_z_0 = intsBufferSDSP0.data(intsIndexesSDSP0(2));

    t_0_yy_0_y_0 = intsBufferSDSP0.data(intsIndexesSDSP0(3));

    t_0_xx_0_z_0 = intsBufferSDSP0.data(intsIndexesSDSP0(4));

    t_0_xx_0_x_0 = intsBufferSDSP0.data(intsIndexesSDSP0(5));
    ...
    t_0_yy_0_z_1 = intsBufferSDSP1.data(intsIndexesSDSP1(2));

    t_0_yy_0_y_1 = intsBufferSDSP1.data(intsIndexesSDSP1(3));

    t_0_xx_0_z_1 = intsBufferSDSP1.data(intsIndexesSDSP1(4));

    t_0_xx_0_x_1 = intsBufferSDSP1.data(intsIndexesSDSP1(5));
    ...
    if (useSummation)
    {
        #pragma omp simd align(frz2_0, fz_0, fze_0, rpb_x, rpb_y, rpb_z, rwp_x, rwp_y,\
                               rwp_z, t_0_x_0_x_0, t_0_x_0_x_1, t_0_xx_0_0_1, t_0_xx_0_x_0,\
                               t_0_xx_0_x_1, t_0_xx_0_z_0, t_0_xx_0_z_1, t_0_xxx_0_x_0,\
                               t_0_xxz_0_z_0, t_0_xyy_0_y_0, t_0_xzz_0_z_0, t_0_y_0_y_0,\
                               t_0_y_0_y_1, t_0_yy_0_0_1, t_0_yy_0_y_0, t_0_yy_0_y_1,\
                               t_0_yy_0_z_0, t_0_yy_0_z_1, t_0_yyy_0_y_0, t_0_yyz_0_z_0,\
                               t_0_yzz_0_y_0, t_0_yzz_0_z_0, t_0_z_0_z_0, t_0_z_0_z_1,\
                               t_0_zz_0_0_1, t_0_zz_0_y_0, t_0_zz_0_y_1, t_0_zz_0_z_0,\
                               t_0_zz_0_z_1, t_0_zzz_0_z_0 : VLX_ALIGN)
