...
auto
compKineticEnergySF(CSubMatrix*      matrix,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    kinrec::compPrimitiveKineticEnergySF(buffer_xxx,
                                                         buffer_xxy,
                                                         buffer_xxz,
                                                         buffer_xyy,
                                                         buffer_xyz,
...
auto
compPrimitiveKineticEnergySF(TDoubleArray&       buffer_xxx,
...
#pragma omp simd aligned(fints_xxx,     \
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_xxx[i] += fss * (6.0 * fe_0 * rpb_x * fz_0 - 3.0 * fke_0 * rpb_x * fz_0 + 6.0 * rpb_x * rpb_x * rpb_x * fz_0);

        fints_xxx[i] += ftt * ((3.0 / 2.0) * fe_0 * rpb_x + rpb_x * rpb_x * rpb_x);

        fints_xxy[i] += fss * (2.0 * fe_0 * rpb_y * fz_0 - fke_0 * rpb_y * fz_0 + 6.0 * rpb_y * rpb_x * rpb_x * fz_0);

        fints_xxy[i] += ftt * ((1.0 / 2.0) * fe_0 * rpb_y + rpb_y * rpb_x * rpb_x);

        fints_xxz[i] += fss * (2.0 * fe_0 * rpb_z * fz_0 - fke_0 * rpb_z * fz_0 + 6.0 * rpb_z * rpb_x * rpb_x * fz_0);

        fints_xxz[i] += ftt * ((1.0 / 2.0) * fe_0 * rpb_z + rpb_z * rpb_x * rpb_x);

        fints_xyy[i] += fss * (2.0 * fe_0 * rpb_x * fz_0 - fke_0 * rpb_x * fz_0 + 6.0 * rpb_y * rpb_y * rpb_x * fz_0);

        fints_xyy[i] += ftt * ((1.0 / 2.0) * fe_0 * rpb_x + rpb_y * rpb_y * rpb_x);

        fints_xyz[i] += fss * 6.0 * rpb_z * rpb_y * rpb_x * fz_0;

        fints_xyz[i] += ftt * rpb_z * rpb_y * rpb_x;

        fints_xzz[i] += fss * (2.0 * fe_0 * rpb_x * fz_0 - fke_0 * rpb_x * fz_0 + 6.0 * rpb_z * rpb_z * rpb_x * fz_0);

        fints_xzz[i] += ftt * ((1.0 / 2.0) * fe_0 * rpb_x + rpb_z * rpb_z * rpb_x);

        fints_yyy[i] += fss * (6.0 * fe_0 * rpb_y * fz_0 - 3.0 * fke_0 * rpb_y * fz_0 + 6.0 * rpb_y * rpb_y * rpb_y * fz_0);

        fints_yyy[i] += ftt * ((3.0 / 2.0) * fe_0 * rpb_y + rpb_y * rpb_y * rpb_y);

        fints_yyz[i] += fss * (2.0 * fe_0 * rpb_z * fz_0 - fke_0 * rpb_z * fz_0 + 6.0 * rpb_z * rpb_y * rpb_y * fz_0);

        fints_yyz[i] += ftt * ((1.0 / 2.0) * fe_0 * rpb_z + rpb_z * rpb_y * rpb_y);

        fints_yzz[i] += fss * (2.0 * fe_0 * rpb_y * fz_0 - fke_0 * rpb_y * fz_0 + 6.0 * rpb_z * rpb_z * rpb_y * fz_0);

        fints_yzz[i] += ftt * ((1.0 / 2.0) * fe_0 * rpb_y + rpb_z * rpb_z * rpb_y);

        fints_zzz[i] += fss * (6.0 * fe_0 * rpb_z * fz_0 - 3.0 * fke_0 * rpb_z * fz_0 + 6.0 * rpb_z * rpb_z * rpb_z * fz_0);

        fints_zzz[i] += ftt * ((3.0 / 2.0) * fe_0 * rpb_z + rpb_z * rpb_z * rpb_z);
    }
}
