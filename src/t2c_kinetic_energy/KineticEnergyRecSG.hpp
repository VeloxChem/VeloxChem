...
/**
 Evaluates <S|T|G>  integrals for given pair of GTOs blocks.
...
*/
auto compKineticEnergySG(CSubMatrix*      matrix,
...
/**
 Evaluates block of primitive <S|T|G> integrals.
...
*/
auto compPrimitiveKineticEnergySG(TDoubleArray&       buffer_xxxx,
