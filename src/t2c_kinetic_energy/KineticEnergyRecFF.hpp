...
/// @brief Computes (F|T|F)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_kinetic_energy_ff(T&                               distributor,
                       ...
                       const bool                       bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(546, ket_npgtos);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cfunc::reduce(cbuffer, pbuffer, 446, ket_width, ket_npgtos);
            }
