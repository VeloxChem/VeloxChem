#ifndef PrimitiveKineticEnergyFS
#define PrimitiveKineticEnergyFS
...
/**
 Evaluates block of primitive <F|T|S> integrals.
...
*/
auto compPrimitiveKineticEnergyFS(TDoubleArray&       buffer_xxx,
...
#endif /* PrimitiveKineticEnergyFS */
