...
#pragma omp simd aligned(pa_x,                \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        tk_xxxxxx_xxxxx[i] = -10.0 * ts_xxxx_xxxxx[i] * fbe_0 * fz_0 + 5.0 * tk_xxxx_xxxxx[i] * fe_0 + 5.0 * tk_xxxxx_xxxx[i] * fe_0 +
                             tk_xxxxx_xxxxx[i] * pa_x[i] + 2.0 * ts_xxxxxx_xxxxx[i] * fz_0;

        tk_xxxxxx_xxxxy[i] = -10.0 * ts_xxxx_xxxxy[i] * fbe_0 * fz_0 + 5.0 * tk_xxxx_xxxxy[i] * fe_0 + 4.0 * tk_xxxxx_xxxy[i] * fe_0 +
                             tk_xxxxx_xxxxy[i] * pa_x[i] + 2.0 * ts_xxxxxx_xxxxy[i] * fz_0;

        tk_xxxxxx_xxxxz[i] = -10.0 * ts_xxxx_xxxxz[i] * fbe_0 * fz_0 + 5.0 * tk_xxxx_xxxxz[i] * fe_0 + 4.0 * tk_xxxxx_xxxz[i] * fe_0 +
                             tk_xxxxx_xxxxz[i] * pa_x[i] + 2.0 * ts_xxxxxx_xxxxz[i] * fz_0;

        tk_xxxxxx_xxxyy[i] = -10.0 * ts_xxxx_xxxyy[i] * fbe_0 * fz_0 + 5.0 * tk_xxxx_xxxyy[i] * fe_0 + 3.0 * tk_xxxxx_xxyy[i] * fe_0 +
                             tk_xxxxx_xxxyy[i] * pa_x[i] + 2.0 * ts_xxxxxx_xxxyy[i] * fz_0;

        tk_xxxxxx_xxxyz[i] = -10.0 * ts_xxxx_xxxyz[i] * fbe_0 * fz_0 + 5.0 * tk_xxxx_xxxyz[i] * fe_0 + 3.0 * tk_xxxxx_xxyz[i] * fe_0 +
                             tk_xxxxx_xxxyz[i] * pa_x[i] + 2.0 * ts_xxxxxx_xxxyz[i] * fz_0;

        tk_xxxxxx_xxxzz[i] = -10.0 * ts_xxxx_xxxzz[i] * fbe_0 * fz_0 + 5.0 * tk_xxxx_xxxzz[i] * fe_0 + 3.0 * tk_xxxxx_xxzz[i] * fe_0 +
                             tk_xxxxx_xxxzz[i] * pa_x[i] + 2.0 * ts_xxxxxx_xxxzz[i] * fz_0;

        tk_xxxxxx_xxyyy[i] = -10.0 * ts_xxxx_xxyyy[i] * fbe_0 * fz_0 + 5.0 * tk_xxxx_xxyyy[i] * fe_0 + 2.0 * tk_xxxxx_xyyy[i] * fe_0 +
                             tk_xxxxx_xxyyy[i] * pa_x[i] + 2.0 * ts_xxxxxx_xxyyy[i] * fz_0;

        tk_xxxxxx_xxyyz[i] = -10.0 * ts_xxxx_xxyyz[i] * fbe_0 * fz_0 + 5.0 * tk_xxxx_xxyyz[i] * fe_0 + 2.0 * tk_xxxxx_xyyz[i] * fe_0 +
                             tk_xxxxx_xxyyz[i] * pa_x[i] + 2.0 * ts_xxxxxx_xxyyz[i] * fz_0;

        tk_xxxxxx_xxyzz[i] = -10.0 * ts_xxxx_xxyzz[i] * fbe_0 * fz_0 + 5.0 * tk_xxxx_xxyzz[i] * fe_0 + 2.0 * tk_xxxxx_xyzz[i] * fe_0 +
                             tk_xxxxx_xxyzz[i] * pa_x[i] + 2.0 * ts_xxxxxx_xxyzz[i] * fz_0;

        tk_xxxxxx_xxzzz[i] = -10.0 * ts_xxxx_xxzzz[i] * fbe_0 * fz_0 + 5.0 * tk_xxxx_xxzzz[i] * fe_0 + 2.0 * tk_xxxxx_xzzz[i] * fe_0 +
                             tk_xxxxx_xxzzz[i] * pa_x[i] + 2.0 * ts_xxxxxx_xxzzz[i] * fz_0;

        tk_xxxxxx_xyyyy[i] = -10.0 * ts_xxxx_xyyyy[i] * fbe_0 * fz_0 + 5.0 * tk_xxxx_xyyyy[i] * fe_0 + tk_xxxxx_yyyy[i] * fe_0 +
                             tk_xxxxx_xyyyy[i] * pa_x[i] + 2.0 * ts_xxxxxx_xyyyy[i] * fz_0;

        tk_xxxxxx_xyyyz[i] = -10.0 * ts_xxxx_xyyyz[i] * fbe_0 * fz_0 + 5.0 * tk_xxxx_xyyyz[i] * fe_0 + tk_xxxxx_yyyz[i] * fe_0 +
                             tk_xxxxx_xyyyz[i] * pa_x[i] + 2.0 * ts_xxxxxx_xyyyz[i] * fz_0;

        tk_xxxxxx_xyyzz[i] = -10.0 * ts_xxxx_xyyzz[i] * fbe_0 * fz_0 + 5.0 * tk_xxxx_xyyzz[i] * fe_0 + tk_xxxxx_yyzz[i] * fe_0 +
                             tk_xxxxx_xyyzz[i] * pa_x[i] + 2.0 * ts_xxxxxx_xyyzz[i] * fz_0;

        tk_xxxxxx_xyzzz[i] = -10.0 * ts_xxxx_xyzzz[i] * fbe_0 * fz_0 + 5.0 * tk_xxxx_xyzzz[i] * fe_0 + tk_xxxxx_yzzz[i] * fe_0 +
                             tk_xxxxx_xyzzz[i] * pa_x[i] + 2.0 * ts_xxxxxx_xyzzz[i] * fz_0;

        tk_xxxxxx_xzzzz[i] = -10.0 * ts_xxxx_xzzzz[i] * fbe_0 * fz_0 + 5.0 * tk_xxxx_xzzzz[i] * fe_0 + tk_xxxxx_zzzz[i] * fe_0 +
                             tk_xxxxx_xzzzz[i] * pa_x[i] + 2.0 * ts_xxxxxx_xzzzz[i] * fz_0;

        tk_xxxxxx_yyyyy[i] =
            -10.0 * ts_xxxx_yyyyy[i] * fbe_0 * fz_0 + 5.0 * tk_xxxx_yyyyy[i] * fe_0 + tk_xxxxx_yyyyy[i] * pa_x[i] + 2.0 * ts_xxxxxx_yyyyy[i] * fz_0;

        tk_xxxxxx_yyyyz[i] =
            -10.0 * ts_xxxx_yyyyz[i] * fbe_0 * fz_0 + 5.0 * tk_xxxx_yyyyz[i] * fe_0 + tk_xxxxx_yyyyz[i] * pa_x[i] + 2.0 * ts_xxxxxx_yyyyz[i] * fz_0;

        tk_xxxxxx_yyyzz[i] =
            -10.0 * ts_xxxx_yyyzz[i] * fbe_0 * fz_0 + 5.0 * tk_xxxx_yyyzz[i] * fe_0 + tk_xxxxx_yyyzz[i] * pa_x[i] + 2.0 * ts_xxxxxx_yyyzz[i] * fz_0;

        tk_xxxxxx_yyzzz[i] =
            -10.0 * ts_xxxx_yyzzz[i] * fbe_0 * fz_0 + 5.0 * tk_xxxx_yyzzz[i] * fe_0 + tk_xxxxx_yyzzz[i] * pa_x[i] + 2.0 * ts_xxxxxx_yyzzz[i] * fz_0;

        tk_xxxxxx_yzzzz[i] =
            -10.0 * ts_xxxx_yzzzz[i] * fbe_0 * fz_0 + 5.0 * tk_xxxx_yzzzz[i] * fe_0 + tk_xxxxx_yzzzz[i] * pa_x[i] + 2.0 * ts_xxxxxx_yzzzz[i] * fz_0;

        tk_xxxxxx_zzzzz[i] =
            -10.0 * ts_xxxx_zzzzz[i] * fbe_0 * fz_0 + 5.0 * tk_xxxx_zzzzz[i] * fe_0 + tk_xxxxx_zzzzz[i] * pa_x[i] + 2.0 * ts_xxxxxx_zzzzz[i] * fz_0;
    }
...
#pragma omp simd aligned(pa_x,                \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        tk_xxxxyy_xxxxx[i] =
            -2.0 * ts_xxxx_xxxxx[i] * fbe_0 * fz_0 + tk_xxxx_xxxxx[i] * fe_0 + tk_xxxxy_xxxxx[i] * pa_y[i] + 2.0 * ts_xxxxyy_xxxxx[i] * fz_0;

        tk_xxxxyy_xxxxy[i] = -6.0 * ts_xxyy_xxxxy[i] * fbe_0 * fz_0 + 3.0 * tk_xxyy_xxxxy[i] * fe_0 + 4.0 * tk_xxxyy_xxxy[i] * fe_0 +
                             tk_xxxyy_xxxxy[i] * pa_x[i] + 2.0 * ts_xxxxyy_xxxxy[i] * fz_0;

        tk_xxxxyy_xxxxz[i] =
            -2.0 * ts_xxxx_xxxxz[i] * fbe_0 * fz_0 + tk_xxxx_xxxxz[i] * fe_0 + tk_xxxxy_xxxxz[i] * pa_y[i] + 2.0 * ts_xxxxyy_xxxxz[i] * fz_0;

        tk_xxxxyy_xxxyy[i] = -6.0 * ts_xxyy_xxxyy[i] * fbe_0 * fz_0 + 3.0 * tk_xxyy_xxxyy[i] * fe_0 + 3.0 * tk_xxxyy_xxyy[i] * fe_0 +
                             tk_xxxyy_xxxyy[i] * pa_x[i] + 2.0 * ts_xxxxyy_xxxyy[i] * fz_0;

        tk_xxxxyy_xxxyz[i] = -6.0 * ts_xxyy_xxxyz[i] * fbe_0 * fz_0 + 3.0 * tk_xxyy_xxxyz[i] * fe_0 + 3.0 * tk_xxxyy_xxyz[i] * fe_0 +
                             tk_xxxyy_xxxyz[i] * pa_x[i] + 2.0 * ts_xxxxyy_xxxyz[i] * fz_0;

        tk_xxxxyy_xxxzz[i] =
            -2.0 * ts_xxxx_xxxzz[i] * fbe_0 * fz_0 + tk_xxxx_xxxzz[i] * fe_0 + tk_xxxxy_xxxzz[i] * pa_y[i] + 2.0 * ts_xxxxyy_xxxzz[i] * fz_0;

        tk_xxxxyy_xxyyy[i] = -6.0 * ts_xxyy_xxyyy[i] * fbe_0 * fz_0 + 3.0 * tk_xxyy_xxyyy[i] * fe_0 + 2.0 * tk_xxxyy_xyyy[i] * fe_0 +
                             tk_xxxyy_xxyyy[i] * pa_x[i] + 2.0 * ts_xxxxyy_xxyyy[i] * fz_0;

        tk_xxxxyy_xxyyz[i] = -6.0 * ts_xxyy_xxyyz[i] * fbe_0 * fz_0 + 3.0 * tk_xxyy_xxyyz[i] * fe_0 + 2.0 * tk_xxxyy_xyyz[i] * fe_0 +
                             tk_xxxyy_xxyyz[i] * pa_x[i] + 2.0 * ts_xxxxyy_xxyyz[i] * fz_0;

        tk_xxxxyy_xxyzz[i] = -6.0 * ts_xxyy_xxyzz[i] * fbe_0 * fz_0 + 3.0 * tk_xxyy_xxyzz[i] * fe_0 + 2.0 * tk_xxxyy_xyzz[i] * fe_0 +
                             tk_xxxyy_xxyzz[i] * pa_x[i] + 2.0 * ts_xxxxyy_xxyzz[i] * fz_0;

        tk_xxxxyy_xxzzz[i] =
            -2.0 * ts_xxxx_xxzzz[i] * fbe_0 * fz_0 + tk_xxxx_xxzzz[i] * fe_0 + tk_xxxxy_xxzzz[i] * pa_y[i] + 2.0 * ts_xxxxyy_xxzzz[i] * fz_0;

        tk_xxxxyy_xyyyy[i] = -6.0 * ts_xxyy_xyyyy[i] * fbe_0 * fz_0 + 3.0 * tk_xxyy_xyyyy[i] * fe_0 + tk_xxxyy_yyyy[i] * fe_0 +
                             tk_xxxyy_xyyyy[i] * pa_x[i] + 2.0 * ts_xxxxyy_xyyyy[i] * fz_0;

        tk_xxxxyy_xyyyz[i] = -6.0 * ts_xxyy_xyyyz[i] * fbe_0 * fz_0 + 3.0 * tk_xxyy_xyyyz[i] * fe_0 + tk_xxxyy_yyyz[i] * fe_0 +
                             tk_xxxyy_xyyyz[i] * pa_x[i] + 2.0 * ts_xxxxyy_xyyyz[i] * fz_0;

        tk_xxxxyy_xyyzz[i] = -6.0 * ts_xxyy_xyyzz[i] * fbe_0 * fz_0 + 3.0 * tk_xxyy_xyyzz[i] * fe_0 + tk_xxxyy_yyzz[i] * fe_0 +
                             tk_xxxyy_xyyzz[i] * pa_x[i] + 2.0 * ts_xxxxyy_xyyzz[i] * fz_0;

        tk_xxxxyy_xyzzz[i] = -6.0 * ts_xxyy_xyzzz[i] * fbe_0 * fz_0 + 3.0 * tk_xxyy_xyzzz[i] * fe_0 + tk_xxxyy_yzzz[i] * fe_0 +
                             tk_xxxyy_xyzzz[i] * pa_x[i] + 2.0 * ts_xxxxyy_xyzzz[i] * fz_0;

        tk_xxxxyy_xzzzz[i] =
            -2.0 * ts_xxxx_xzzzz[i] * fbe_0 * fz_0 + tk_xxxx_xzzzz[i] * fe_0 + tk_xxxxy_xzzzz[i] * pa_y[i] + 2.0 * ts_xxxxyy_xzzzz[i] * fz_0;

        tk_xxxxyy_yyyyy[i] =
            -6.0 * ts_xxyy_yyyyy[i] * fbe_0 * fz_0 + 3.0 * tk_xxyy_yyyyy[i] * fe_0 + tk_xxxyy_yyyyy[i] * pa_x[i] + 2.0 * ts_xxxxyy_yyyyy[i] * fz_0;

        tk_xxxxyy_yyyyz[i] =
            -6.0 * ts_xxyy_yyyyz[i] * fbe_0 * fz_0 + 3.0 * tk_xxyy_yyyyz[i] * fe_0 + tk_xxxyy_yyyyz[i] * pa_x[i] + 2.0 * ts_xxxxyy_yyyyz[i] * fz_0;

        tk_xxxxyy_yyyzz[i] =
            -6.0 * ts_xxyy_yyyzz[i] * fbe_0 * fz_0 + 3.0 * tk_xxyy_yyyzz[i] * fe_0 + tk_xxxyy_yyyzz[i] * pa_x[i] + 2.0 * ts_xxxxyy_yyyzz[i] * fz_0;

        tk_xxxxyy_yyzzz[i] =
            -6.0 * ts_xxyy_yyzzz[i] * fbe_0 * fz_0 + 3.0 * tk_xxyy_yyzzz[i] * fe_0 + tk_xxxyy_yyzzz[i] * pa_x[i] + 2.0 * ts_xxxxyy_yyzzz[i] * fz_0;

        tk_xxxxyy_yzzzz[i] =
            -6.0 * ts_xxyy_yzzzz[i] * fbe_0 * fz_0 + 3.0 * tk_xxyy_yzzzz[i] * fe_0 + tk_xxxyy_yzzzz[i] * pa_x[i] + 2.0 * ts_xxxxyy_yzzzz[i] * fz_0;

        tk_xxxxyy_zzzzz[i] =
            -6.0 * ts_xxyy_zzzzz[i] * fbe_0 * fz_0 + 3.0 * tk_xxyy_zzzzz[i] * fe_0 + tk_xxxyy_zzzzz[i] * pa_x[i] + 2.0 * ts_xxxxyy_zzzzz[i] * fz_0;
    }
...
#pragma omp simd aligned(pa_x,                \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        tk_xxxxzz_xxxxx[i] =
            -2.0 * ts_xxxx_xxxxx[i] * fbe_0 * fz_0 + tk_xxxx_xxxxx[i] * fe_0 + tk_xxxxz_xxxxx[i] * pa_z[i] + 2.0 * ts_xxxxzz_xxxxx[i] * fz_0;

        tk_xxxxzz_xxxxy[i] =
            -2.0 * ts_xxxx_xxxxy[i] * fbe_0 * fz_0 + tk_xxxx_xxxxy[i] * fe_0 + tk_xxxxz_xxxxy[i] * pa_z[i] + 2.0 * ts_xxxxzz_xxxxy[i] * fz_0;

        tk_xxxxzz_xxxxz[i] = -6.0 * ts_xxzz_xxxxz[i] * fbe_0 * fz_0 + 3.0 * tk_xxzz_xxxxz[i] * fe_0 + 4.0 * tk_xxxzz_xxxz[i] * fe_0 +
                             tk_xxxzz_xxxxz[i] * pa_x[i] + 2.0 * ts_xxxxzz_xxxxz[i] * fz_0;

        tk_xxxxzz_xxxyy[i] =
            -2.0 * ts_xxxx_xxxyy[i] * fbe_0 * fz_0 + tk_xxxx_xxxyy[i] * fe_0 + tk_xxxxz_xxxyy[i] * pa_z[i] + 2.0 * ts_xxxxzz_xxxyy[i] * fz_0;

        tk_xxxxzz_xxxyz[i] = -6.0 * ts_xxzz_xxxyz[i] * fbe_0 * fz_0 + 3.0 * tk_xxzz_xxxyz[i] * fe_0 + 3.0 * tk_xxxzz_xxyz[i] * fe_0 +
                             tk_xxxzz_xxxyz[i] * pa_x[i] + 2.0 * ts_xxxxzz_xxxyz[i] * fz_0;

        tk_xxxxzz_xxxzz[i] = -6.0 * ts_xxzz_xxxzz[i] * fbe_0 * fz_0 + 3.0 * tk_xxzz_xxxzz[i] * fe_0 + 3.0 * tk_xxxzz_xxzz[i] * fe_0 +
                             tk_xxxzz_xxxzz[i] * pa_x[i] + 2.0 * ts_xxxxzz_xxxzz[i] * fz_0;

        tk_xxxxzz_xxyyy[i] =
            -2.0 * ts_xxxx_xxyyy[i] * fbe_0 * fz_0 + tk_xxxx_xxyyy[i] * fe_0 + tk_xxxxz_xxyyy[i] * pa_z[i] + 2.0 * ts_xxxxzz_xxyyy[i] * fz_0;

        tk_xxxxzz_xxyyz[i] = -6.0 * ts_xxzz_xxyyz[i] * fbe_0 * fz_0 + 3.0 * tk_xxzz_xxyyz[i] * fe_0 + 2.0 * tk_xxxzz_xyyz[i] * fe_0 +
                             tk_xxxzz_xxyyz[i] * pa_x[i] + 2.0 * ts_xxxxzz_xxyyz[i] * fz_0;

        tk_xxxxzz_xxyzz[i] = -6.0 * ts_xxzz_xxyzz[i] * fbe_0 * fz_0 + 3.0 * tk_xxzz_xxyzz[i] * fe_0 + 2.0 * tk_xxxzz_xyzz[i] * fe_0 +
                             tk_xxxzz_xxyzz[i] * pa_x[i] + 2.0 * ts_xxxxzz_xxyzz[i] * fz_0;

        tk_xxxxzz_xxzzz[i] = -6.0 * ts_xxzz_xxzzz[i] * fbe_0 * fz_0 + 3.0 * tk_xxzz_xxzzz[i] * fe_0 + 2.0 * tk_xxxzz_xzzz[i] * fe_0 +
                             tk_xxxzz_xxzzz[i] * pa_x[i] + 2.0 * ts_xxxxzz_xxzzz[i] * fz_0;

        tk_xxxxzz_xyyyy[i] =
            -2.0 * ts_xxxx_xyyyy[i] * fbe_0 * fz_0 + tk_xxxx_xyyyy[i] * fe_0 + tk_xxxxz_xyyyy[i] * pa_z[i] + 2.0 * ts_xxxxzz_xyyyy[i] * fz_0;

        tk_xxxxzz_xyyyz[i] = -6.0 * ts_xxzz_xyyyz[i] * fbe_0 * fz_0 + 3.0 * tk_xxzz_xyyyz[i] * fe_0 + tk_xxxzz_yyyz[i] * fe_0 +
                             tk_xxxzz_xyyyz[i] * pa_x[i] + 2.0 * ts_xxxxzz_xyyyz[i] * fz_0;

        tk_xxxxzz_xyyzz[i] = -6.0 * ts_xxzz_xyyzz[i] * fbe_0 * fz_0 + 3.0 * tk_xxzz_xyyzz[i] * fe_0 + tk_xxxzz_yyzz[i] * fe_0 +
                             tk_xxxzz_xyyzz[i] * pa_x[i] + 2.0 * ts_xxxxzz_xyyzz[i] * fz_0;

        tk_xxxxzz_xyzzz[i] = -6.0 * ts_xxzz_xyzzz[i] * fbe_0 * fz_0 + 3.0 * tk_xxzz_xyzzz[i] * fe_0 + tk_xxxzz_yzzz[i] * fe_0 +
                             tk_xxxzz_xyzzz[i] * pa_x[i] + 2.0 * ts_xxxxzz_xyzzz[i] * fz_0;

        tk_xxxxzz_xzzzz[i] = -6.0 * ts_xxzz_xzzzz[i] * fbe_0 * fz_0 + 3.0 * tk_xxzz_xzzzz[i] * fe_0 + tk_xxxzz_zzzz[i] * fe_0 +
                             tk_xxxzz_xzzzz[i] * pa_x[i] + 2.0 * ts_xxxxzz_xzzzz[i] * fz_0;

        tk_xxxxzz_yyyyy[i] =
            -6.0 * ts_xxzz_yyyyy[i] * fbe_0 * fz_0 + 3.0 * tk_xxzz_yyyyy[i] * fe_0 + tk_xxxzz_yyyyy[i] * pa_x[i] + 2.0 * ts_xxxxzz_yyyyy[i] * fz_0;

        tk_xxxxzz_yyyyz[i] =
            -6.0 * ts_xxzz_yyyyz[i] * fbe_0 * fz_0 + 3.0 * tk_xxzz_yyyyz[i] * fe_0 + tk_xxxzz_yyyyz[i] * pa_x[i] + 2.0 * ts_xxxxzz_yyyyz[i] * fz_0;

        tk_xxxxzz_yyyzz[i] =
            -6.0 * ts_xxzz_yyyzz[i] * fbe_0 * fz_0 + 3.0 * tk_xxzz_yyyzz[i] * fe_0 + tk_xxxzz_yyyzz[i] * pa_x[i] + 2.0 * ts_xxxxzz_yyyzz[i] * fz_0;

        tk_xxxxzz_yyzzz[i] =
            -6.0 * ts_xxzz_yyzzz[i] * fbe_0 * fz_0 + 3.0 * tk_xxzz_yyzzz[i] * fe_0 + tk_xxxzz_yyzzz[i] * pa_x[i] + 2.0 * ts_xxxxzz_yyzzz[i] * fz_0;

        tk_xxxxzz_yzzzz[i] =
            -6.0 * ts_xxzz_yzzzz[i] * fbe_0 * fz_0 + 3.0 * tk_xxzz_yzzzz[i] * fe_0 + tk_xxxzz_yzzzz[i] * pa_x[i] + 2.0 * ts_xxxxzz_yzzzz[i] * fz_0;

        tk_xxxxzz_zzzzz[i] =
            -6.0 * ts_xxzz_zzzzz[i] * fbe_0 * fz_0 + 3.0 * tk_xxzz_zzzzz[i] * fe_0 + tk_xxxzz_zzzzz[i] * pa_x[i] + 2.0 * ts_xxxxzz_zzzzz[i] * fz_0;
    }
...
#pragma omp simd aligned(pa_x,                \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        tk_xxxyyy_xxxxx[i] =
            -4.0 * ts_xxxy_xxxxx[i] * fbe_0 * fz_0 + 2.0 * tk_xxxy_xxxxx[i] * fe_0 + tk_xxxyy_xxxxx[i] * pa_y[i] + 2.0 * ts_xxxyyy_xxxxx[i] * fz_0;

        tk_xxxyyy_xxxxy[i] = -4.0 * ts_xyyy_xxxxy[i] * fbe_0 * fz_0 + 2.0 * tk_xyyy_xxxxy[i] * fe_0 + 4.0 * tk_xxyyy_xxxy[i] * fe_0 +
                             tk_xxyyy_xxxxy[i] * pa_x[i] + 2.0 * ts_xxxyyy_xxxxy[i] * fz_0;

        tk_xxxyyy_xxxxz[i] =
            -4.0 * ts_xxxy_xxxxz[i] * fbe_0 * fz_0 + 2.0 * tk_xxxy_xxxxz[i] * fe_0 + tk_xxxyy_xxxxz[i] * pa_y[i] + 2.0 * ts_xxxyyy_xxxxz[i] * fz_0;

        tk_xxxyyy_xxxyy[i] = -4.0 * ts_xyyy_xxxyy[i] * fbe_0 * fz_0 + 2.0 * tk_xyyy_xxxyy[i] * fe_0 + 3.0 * tk_xxyyy_xxyy[i] * fe_0 +
                             tk_xxyyy_xxxyy[i] * pa_x[i] + 2.0 * ts_xxxyyy_xxxyy[i] * fz_0;

        tk_xxxyyy_xxxyz[i] = -4.0 * ts_xyyy_xxxyz[i] * fbe_0 * fz_0 + 2.0 * tk_xyyy_xxxyz[i] * fe_0 + 3.0 * tk_xxyyy_xxyz[i] * fe_0 +
                             tk_xxyyy_xxxyz[i] * pa_x[i] + 2.0 * ts_xxxyyy_xxxyz[i] * fz_0;

        tk_xxxyyy_xxxzz[i] =
            -4.0 * ts_xxxy_xxxzz[i] * fbe_0 * fz_0 + 2.0 * tk_xxxy_xxxzz[i] * fe_0 + tk_xxxyy_xxxzz[i] * pa_y[i] + 2.0 * ts_xxxyyy_xxxzz[i] * fz_0;

        tk_xxxyyy_xxyyy[i] = -4.0 * ts_xyyy_xxyyy[i] * fbe_0 * fz_0 + 2.0 * tk_xyyy_xxyyy[i] * fe_0 + 2.0 * tk_xxyyy_xyyy[i] * fe_0 +
                             tk_xxyyy_xxyyy[i] * pa_x[i] + 2.0 * ts_xxxyyy_xxyyy[i] * fz_0;

        tk_xxxyyy_xxyyz[i] = -4.0 * ts_xyyy_xxyyz[i] * fbe_0 * fz_0 + 2.0 * tk_xyyy_xxyyz[i] * fe_0 + 2.0 * tk_xxyyy_xyyz[i] * fe_0 +
                             tk_xxyyy_xxyyz[i] * pa_x[i] + 2.0 * ts_xxxyyy_xxyyz[i] * fz_0;

        tk_xxxyyy_xxyzz[i] = -4.0 * ts_xyyy_xxyzz[i] * fbe_0 * fz_0 + 2.0 * tk_xyyy_xxyzz[i] * fe_0 + 2.0 * tk_xxyyy_xyzz[i] * fe_0 +
                             tk_xxyyy_xxyzz[i] * pa_x[i] + 2.0 * ts_xxxyyy_xxyzz[i] * fz_0;

        tk_xxxyyy_xxzzz[i] =
            -4.0 * ts_xxxy_xxzzz[i] * fbe_0 * fz_0 + 2.0 * tk_xxxy_xxzzz[i] * fe_0 + tk_xxxyy_xxzzz[i] * pa_y[i] + 2.0 * ts_xxxyyy_xxzzz[i] * fz_0;

        tk_xxxyyy_xyyyy[i] = -4.0 * ts_xyyy_xyyyy[i] * fbe_0 * fz_0 + 2.0 * tk_xyyy_xyyyy[i] * fe_0 + tk_xxyyy_yyyy[i] * fe_0 +
                             tk_xxyyy_xyyyy[i] * pa_x[i] + 2.0 * ts_xxxyyy_xyyyy[i] * fz_0;

        tk_xxxyyy_xyyyz[i] = -4.0 * ts_xyyy_xyyyz[i] * fbe_0 * fz_0 + 2.0 * tk_xyyy_xyyyz[i] * fe_0 + tk_xxyyy_yyyz[i] * fe_0 +
                             tk_xxyyy_xyyyz[i] * pa_x[i] + 2.0 * ts_xxxyyy_xyyyz[i] * fz_0;

        tk_xxxyyy_xyyzz[i] = -4.0 * ts_xyyy_xyyzz[i] * fbe_0 * fz_0 + 2.0 * tk_xyyy_xyyzz[i] * fe_0 + tk_xxyyy_yyzz[i] * fe_0 +
                             tk_xxyyy_xyyzz[i] * pa_x[i] + 2.0 * ts_xxxyyy_xyyzz[i] * fz_0;

        tk_xxxyyy_xyzzz[i] = -4.0 * ts_xyyy_xyzzz[i] * fbe_0 * fz_0 + 2.0 * tk_xyyy_xyzzz[i] * fe_0 + tk_xxyyy_yzzz[i] * fe_0 +
                             tk_xxyyy_xyzzz[i] * pa_x[i] + 2.0 * ts_xxxyyy_xyzzz[i] * fz_0;

        tk_xxxyyy_xzzzz[i] =
            -4.0 * ts_xxxy_xzzzz[i] * fbe_0 * fz_0 + 2.0 * tk_xxxy_xzzzz[i] * fe_0 + tk_xxxyy_xzzzz[i] * pa_y[i] + 2.0 * ts_xxxyyy_xzzzz[i] * fz_0;

        tk_xxxyyy_yyyyy[i] =
            -4.0 * ts_xyyy_yyyyy[i] * fbe_0 * fz_0 + 2.0 * tk_xyyy_yyyyy[i] * fe_0 + tk_xxyyy_yyyyy[i] * pa_x[i] + 2.0 * ts_xxxyyy_yyyyy[i] * fz_0;

        tk_xxxyyy_yyyyz[i] =
            -4.0 * ts_xyyy_yyyyz[i] * fbe_0 * fz_0 + 2.0 * tk_xyyy_yyyyz[i] * fe_0 + tk_xxyyy_yyyyz[i] * pa_x[i] + 2.0 * ts_xxxyyy_yyyyz[i] * fz_0;

        tk_xxxyyy_yyyzz[i] =
            -4.0 * ts_xyyy_yyyzz[i] * fbe_0 * fz_0 + 2.0 * tk_xyyy_yyyzz[i] * fe_0 + tk_xxyyy_yyyzz[i] * pa_x[i] + 2.0 * ts_xxxyyy_yyyzz[i] * fz_0;

        tk_xxxyyy_yyzzz[i] =
            -4.0 * ts_xyyy_yyzzz[i] * fbe_0 * fz_0 + 2.0 * tk_xyyy_yyzzz[i] * fe_0 + tk_xxyyy_yyzzz[i] * pa_x[i] + 2.0 * ts_xxxyyy_yyzzz[i] * fz_0;

        tk_xxxyyy_yzzzz[i] =
            -4.0 * ts_xyyy_yzzzz[i] * fbe_0 * fz_0 + 2.0 * tk_xyyy_yzzzz[i] * fe_0 + tk_xxyyy_yzzzz[i] * pa_x[i] + 2.0 * ts_xxxyyy_yzzzz[i] * fz_0;

        tk_xxxyyy_zzzzz[i] =
            -4.0 * ts_xyyy_zzzzz[i] * fbe_0 * fz_0 + 2.0 * tk_xyyy_zzzzz[i] * fe_0 + tk_xxyyy_zzzzz[i] * pa_x[i] + 2.0 * ts_xxxyyy_zzzzz[i] * fz_0;
    }
...
#pragma omp simd aligned(pa_x,                \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        tk_xxxzzz_xxxxx[i] =
            -4.0 * ts_xxxz_xxxxx[i] * fbe_0 * fz_0 + 2.0 * tk_xxxz_xxxxx[i] * fe_0 + tk_xxxzz_xxxxx[i] * pa_z[i] + 2.0 * ts_xxxzzz_xxxxx[i] * fz_0;

        tk_xxxzzz_xxxxy[i] =
            -4.0 * ts_xxxz_xxxxy[i] * fbe_0 * fz_0 + 2.0 * tk_xxxz_xxxxy[i] * fe_0 + tk_xxxzz_xxxxy[i] * pa_z[i] + 2.0 * ts_xxxzzz_xxxxy[i] * fz_0;

        tk_xxxzzz_xxxxz[i] = -4.0 * ts_xzzz_xxxxz[i] * fbe_0 * fz_0 + 2.0 * tk_xzzz_xxxxz[i] * fe_0 + 4.0 * tk_xxzzz_xxxz[i] * fe_0 +
                             tk_xxzzz_xxxxz[i] * pa_x[i] + 2.0 * ts_xxxzzz_xxxxz[i] * fz_0;

        tk_xxxzzz_xxxyy[i] =
            -4.0 * ts_xxxz_xxxyy[i] * fbe_0 * fz_0 + 2.0 * tk_xxxz_xxxyy[i] * fe_0 + tk_xxxzz_xxxyy[i] * pa_z[i] + 2.0 * ts_xxxzzz_xxxyy[i] * fz_0;

        tk_xxxzzz_xxxyz[i] = -4.0 * ts_xzzz_xxxyz[i] * fbe_0 * fz_0 + 2.0 * tk_xzzz_xxxyz[i] * fe_0 + 3.0 * tk_xxzzz_xxyz[i] * fe_0 +
                             tk_xxzzz_xxxyz[i] * pa_x[i] + 2.0 * ts_xxxzzz_xxxyz[i] * fz_0;

        tk_xxxzzz_xxxzz[i] = -4.0 * ts_xzzz_xxxzz[i] * fbe_0 * fz_0 + 2.0 * tk_xzzz_xxxzz[i] * fe_0 + 3.0 * tk_xxzzz_xxzz[i] * fe_0 +
                             tk_xxzzz_xxxzz[i] * pa_x[i] + 2.0 * ts_xxxzzz_xxxzz[i] * fz_0;

        tk_xxxzzz_xxyyy[i] =
            -4.0 * ts_xxxz_xxyyy[i] * fbe_0 * fz_0 + 2.0 * tk_xxxz_xxyyy[i] * fe_0 + tk_xxxzz_xxyyy[i] * pa_z[i] + 2.0 * ts_xxxzzz_xxyyy[i] * fz_0;

        tk_xxxzzz_xxyyz[i] = -4.0 * ts_xzzz_xxyyz[i] * fbe_0 * fz_0 + 2.0 * tk_xzzz_xxyyz[i] * fe_0 + 2.0 * tk_xxzzz_xyyz[i] * fe_0 +
                             tk_xxzzz_xxyyz[i] * pa_x[i] + 2.0 * ts_xxxzzz_xxyyz[i] * fz_0;

        tk_xxxzzz_xxyzz[i] = -4.0 * ts_xzzz_xxyzz[i] * fbe_0 * fz_0 + 2.0 * tk_xzzz_xxyzz[i] * fe_0 + 2.0 * tk_xxzzz_xyzz[i] * fe_0 +
                             tk_xxzzz_xxyzz[i] * pa_x[i] + 2.0 * ts_xxxzzz_xxyzz[i] * fz_0;

        tk_xxxzzz_xxzzz[i] = -4.0 * ts_xzzz_xxzzz[i] * fbe_0 * fz_0 + 2.0 * tk_xzzz_xxzzz[i] * fe_0 + 2.0 * tk_xxzzz_xzzz[i] * fe_0 +
                             tk_xxzzz_xxzzz[i] * pa_x[i] + 2.0 * ts_xxxzzz_xxzzz[i] * fz_0;

        tk_xxxzzz_xyyyy[i] =
            -4.0 * ts_xxxz_xyyyy[i] * fbe_0 * fz_0 + 2.0 * tk_xxxz_xyyyy[i] * fe_0 + tk_xxxzz_xyyyy[i] * pa_z[i] + 2.0 * ts_xxxzzz_xyyyy[i] * fz_0;

        tk_xxxzzz_xyyyz[i] = -4.0 * ts_xzzz_xyyyz[i] * fbe_0 * fz_0 + 2.0 * tk_xzzz_xyyyz[i] * fe_0 + tk_xxzzz_yyyz[i] * fe_0 +
                             tk_xxzzz_xyyyz[i] * pa_x[i] + 2.0 * ts_xxxzzz_xyyyz[i] * fz_0;

        tk_xxxzzz_xyyzz[i] = -4.0 * ts_xzzz_xyyzz[i] * fbe_0 * fz_0 + 2.0 * tk_xzzz_xyyzz[i] * fe_0 + tk_xxzzz_yyzz[i] * fe_0 +
                             tk_xxzzz_xyyzz[i] * pa_x[i] + 2.0 * ts_xxxzzz_xyyzz[i] * fz_0;

        tk_xxxzzz_xyzzz[i] = -4.0 * ts_xzzz_xyzzz[i] * fbe_0 * fz_0 + 2.0 * tk_xzzz_xyzzz[i] * fe_0 + tk_xxzzz_yzzz[i] * fe_0 +
                             tk_xxzzz_xyzzz[i] * pa_x[i] + 2.0 * ts_xxxzzz_xyzzz[i] * fz_0;

        tk_xxxzzz_xzzzz[i] = -4.0 * ts_xzzz_xzzzz[i] * fbe_0 * fz_0 + 2.0 * tk_xzzz_xzzzz[i] * fe_0 + tk_xxzzz_zzzz[i] * fe_0 +
                             tk_xxzzz_xzzzz[i] * pa_x[i] + 2.0 * ts_xxxzzz_xzzzz[i] * fz_0;

        tk_xxxzzz_yyyyy[i] =
            -4.0 * ts_xzzz_yyyyy[i] * fbe_0 * fz_0 + 2.0 * tk_xzzz_yyyyy[i] * fe_0 + tk_xxzzz_yyyyy[i] * pa_x[i] + 2.0 * ts_xxxzzz_yyyyy[i] * fz_0;

        tk_xxxzzz_yyyyz[i] =
            -4.0 * ts_xzzz_yyyyz[i] * fbe_0 * fz_0 + 2.0 * tk_xzzz_yyyyz[i] * fe_0 + tk_xxzzz_yyyyz[i] * pa_x[i] + 2.0 * ts_xxxzzz_yyyyz[i] * fz_0;

        tk_xxxzzz_yyyzz[i] =
            -4.0 * ts_xzzz_yyyzz[i] * fbe_0 * fz_0 + 2.0 * tk_xzzz_yyyzz[i] * fe_0 + tk_xxzzz_yyyzz[i] * pa_x[i] + 2.0 * ts_xxxzzz_yyyzz[i] * fz_0;

        tk_xxxzzz_yyzzz[i] =
            -4.0 * ts_xzzz_yyzzz[i] * fbe_0 * fz_0 + 2.0 * tk_xzzz_yyzzz[i] * fe_0 + tk_xxzzz_yyzzz[i] * pa_x[i] + 2.0 * ts_xxxzzz_yyzzz[i] * fz_0;

        tk_xxxzzz_yzzzz[i] =
            -4.0 * ts_xzzz_yzzzz[i] * fbe_0 * fz_0 + 2.0 * tk_xzzz_yzzzz[i] * fe_0 + tk_xxzzz_yzzzz[i] * pa_x[i] + 2.0 * ts_xxxzzz_yzzzz[i] * fz_0;

        tk_xxxzzz_zzzzz[i] =
            -4.0 * ts_xzzz_zzzzz[i] * fbe_0 * fz_0 + 2.0 * tk_xzzz_zzzzz[i] * fe_0 + tk_xxzzz_zzzzz[i] * pa_x[i] + 2.0 * ts_xxxzzz_zzzzz[i] * fz_0;
    }
...
#pragma omp simd aligned(pa_x,                \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        tk_xxyyyy_xxxxx[i] =
            -6.0 * ts_xxyy_xxxxx[i] * fbe_0 * fz_0 + 3.0 * tk_xxyy_xxxxx[i] * fe_0 + tk_xxyyy_xxxxx[i] * pa_y[i] + 2.0 * ts_xxyyyy_xxxxx[i] * fz_0;

        tk_xxyyyy_xxxxy[i] = -2.0 * ts_yyyy_xxxxy[i] * fbe_0 * fz_0 + tk_yyyy_xxxxy[i] * fe_0 + 4.0 * tk_xyyyy_xxxy[i] * fe_0 +
                             tk_xyyyy_xxxxy[i] * pa_x[i] + 2.0 * ts_xxyyyy_xxxxy[i] * fz_0;

        tk_xxyyyy_xxxxz[i] =
            -6.0 * ts_xxyy_xxxxz[i] * fbe_0 * fz_0 + 3.0 * tk_xxyy_xxxxz[i] * fe_0 + tk_xxyyy_xxxxz[i] * pa_y[i] + 2.0 * ts_xxyyyy_xxxxz[i] * fz_0;

        tk_xxyyyy_xxxyy[i] = -2.0 * ts_yyyy_xxxyy[i] * fbe_0 * fz_0 + tk_yyyy_xxxyy[i] * fe_0 + 3.0 * tk_xyyyy_xxyy[i] * fe_0 +
                             tk_xyyyy_xxxyy[i] * pa_x[i] + 2.0 * ts_xxyyyy_xxxyy[i] * fz_0;

        tk_xxyyyy_xxxyz[i] = -2.0 * ts_yyyy_xxxyz[i] * fbe_0 * fz_0 + tk_yyyy_xxxyz[i] * fe_0 + 3.0 * tk_xyyyy_xxyz[i] * fe_0 +
                             tk_xyyyy_xxxyz[i] * pa_x[i] + 2.0 * ts_xxyyyy_xxxyz[i] * fz_0;

        tk_xxyyyy_xxxzz[i] =
            -6.0 * ts_xxyy_xxxzz[i] * fbe_0 * fz_0 + 3.0 * tk_xxyy_xxxzz[i] * fe_0 + tk_xxyyy_xxxzz[i] * pa_y[i] + 2.0 * ts_xxyyyy_xxxzz[i] * fz_0;

        tk_xxyyyy_xxyyy[i] = -2.0 * ts_yyyy_xxyyy[i] * fbe_0 * fz_0 + tk_yyyy_xxyyy[i] * fe_0 + 2.0 * tk_xyyyy_xyyy[i] * fe_0 +
                             tk_xyyyy_xxyyy[i] * pa_x[i] + 2.0 * ts_xxyyyy_xxyyy[i] * fz_0;

        tk_xxyyyy_xxyyz[i] = -2.0 * ts_yyyy_xxyyz[i] * fbe_0 * fz_0 + tk_yyyy_xxyyz[i] * fe_0 + 2.0 * tk_xyyyy_xyyz[i] * fe_0 +
                             tk_xyyyy_xxyyz[i] * pa_x[i] + 2.0 * ts_xxyyyy_xxyyz[i] * fz_0;

        tk_xxyyyy_xxyzz[i] = -2.0 * ts_yyyy_xxyzz[i] * fbe_0 * fz_0 + tk_yyyy_xxyzz[i] * fe_0 + 2.0 * tk_xyyyy_xyzz[i] * fe_0 +
                             tk_xyyyy_xxyzz[i] * pa_x[i] + 2.0 * ts_xxyyyy_xxyzz[i] * fz_0;

        tk_xxyyyy_xxzzz[i] =
            -6.0 * ts_xxyy_xxzzz[i] * fbe_0 * fz_0 + 3.0 * tk_xxyy_xxzzz[i] * fe_0 + tk_xxyyy_xxzzz[i] * pa_y[i] + 2.0 * ts_xxyyyy_xxzzz[i] * fz_0;

        tk_xxyyyy_xyyyy[i] = -2.0 * ts_yyyy_xyyyy[i] * fbe_0 * fz_0 + tk_yyyy_xyyyy[i] * fe_0 + tk_xyyyy_yyyy[i] * fe_0 +
                             tk_xyyyy_xyyyy[i] * pa_x[i] + 2.0 * ts_xxyyyy_xyyyy[i] * fz_0;

        tk_xxyyyy_xyyyz[i] = -2.0 * ts_yyyy_xyyyz[i] * fbe_0 * fz_0 + tk_yyyy_xyyyz[i] * fe_0 + tk_xyyyy_yyyz[i] * fe_0 +
                             tk_xyyyy_xyyyz[i] * pa_x[i] + 2.0 * ts_xxyyyy_xyyyz[i] * fz_0;

        tk_xxyyyy_xyyzz[i] = -2.0 * ts_yyyy_xyyzz[i] * fbe_0 * fz_0 + tk_yyyy_xyyzz[i] * fe_0 + tk_xyyyy_yyzz[i] * fe_0 +
                             tk_xyyyy_xyyzz[i] * pa_x[i] + 2.0 * ts_xxyyyy_xyyzz[i] * fz_0;

        tk_xxyyyy_xyzzz[i] = -2.0 * ts_yyyy_xyzzz[i] * fbe_0 * fz_0 + tk_yyyy_xyzzz[i] * fe_0 + tk_xyyyy_yzzz[i] * fe_0 +
                             tk_xyyyy_xyzzz[i] * pa_x[i] + 2.0 * ts_xxyyyy_xyzzz[i] * fz_0;

        tk_xxyyyy_xzzzz[i] =
            -6.0 * ts_xxyy_xzzzz[i] * fbe_0 * fz_0 + 3.0 * tk_xxyy_xzzzz[i] * fe_0 + tk_xxyyy_xzzzz[i] * pa_y[i] + 2.0 * ts_xxyyyy_xzzzz[i] * fz_0;

        tk_xxyyyy_yyyyy[i] =
            -2.0 * ts_yyyy_yyyyy[i] * fbe_0 * fz_0 + tk_yyyy_yyyyy[i] * fe_0 + tk_xyyyy_yyyyy[i] * pa_x[i] + 2.0 * ts_xxyyyy_yyyyy[i] * fz_0;

        tk_xxyyyy_yyyyz[i] =
            -2.0 * ts_yyyy_yyyyz[i] * fbe_0 * fz_0 + tk_yyyy_yyyyz[i] * fe_0 + tk_xyyyy_yyyyz[i] * pa_x[i] + 2.0 * ts_xxyyyy_yyyyz[i] * fz_0;

        tk_xxyyyy_yyyzz[i] =
            -2.0 * ts_yyyy_yyyzz[i] * fbe_0 * fz_0 + tk_yyyy_yyyzz[i] * fe_0 + tk_xyyyy_yyyzz[i] * pa_x[i] + 2.0 * ts_xxyyyy_yyyzz[i] * fz_0;

        tk_xxyyyy_yyzzz[i] =
            -2.0 * ts_yyyy_yyzzz[i] * fbe_0 * fz_0 + tk_yyyy_yyzzz[i] * fe_0 + tk_xyyyy_yyzzz[i] * pa_x[i] + 2.0 * ts_xxyyyy_yyzzz[i] * fz_0;

        tk_xxyyyy_yzzzz[i] =
            -2.0 * ts_yyyy_yzzzz[i] * fbe_0 * fz_0 + tk_yyyy_yzzzz[i] * fe_0 + tk_xyyyy_yzzzz[i] * pa_x[i] + 2.0 * ts_xxyyyy_yzzzz[i] * fz_0;

        tk_xxyyyy_zzzzz[i] =
            -2.0 * ts_yyyy_zzzzz[i] * fbe_0 * fz_0 + tk_yyyy_zzzzz[i] * fe_0 + tk_xyyyy_zzzzz[i] * pa_x[i] + 2.0 * ts_xxyyyy_zzzzz[i] * fz_0;
    }
...
#pragma omp simd aligned(pa_x,                \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        tk_xxyyzz_xxxxx[i] =
            -2.0 * ts_xxzz_xxxxx[i] * fbe_0 * fz_0 + tk_xxzz_xxxxx[i] * fe_0 + tk_xxyzz_xxxxx[i] * pa_y[i] + 2.0 * ts_xxyyzz_xxxxx[i] * fz_0;

        tk_xxyyzz_xxxxy[i] =
            -2.0 * ts_xxyy_xxxxy[i] * fbe_0 * fz_0 + tk_xxyy_xxxxy[i] * fe_0 + tk_xxyyz_xxxxy[i] * pa_z[i] + 2.0 * ts_xxyyzz_xxxxy[i] * fz_0;

        tk_xxyyzz_xxxxz[i] =
            -2.0 * ts_xxzz_xxxxz[i] * fbe_0 * fz_0 + tk_xxzz_xxxxz[i] * fe_0 + tk_xxyzz_xxxxz[i] * pa_y[i] + 2.0 * ts_xxyyzz_xxxxz[i] * fz_0;

        tk_xxyyzz_xxxyy[i] =
            -2.0 * ts_xxyy_xxxyy[i] * fbe_0 * fz_0 + tk_xxyy_xxxyy[i] * fe_0 + tk_xxyyz_xxxyy[i] * pa_z[i] + 2.0 * ts_xxyyzz_xxxyy[i] * fz_0;

        tk_xxyyzz_xxxyz[i] = -2.0 * ts_yyzz_xxxyz[i] * fbe_0 * fz_0 + tk_yyzz_xxxyz[i] * fe_0 + 3.0 * tk_xyyzz_xxyz[i] * fe_0 +
                             tk_xyyzz_xxxyz[i] * pa_x[i] + 2.0 * ts_xxyyzz_xxxyz[i] * fz_0;

        tk_xxyyzz_xxxzz[i] =
            -2.0 * ts_xxzz_xxxzz[i] * fbe_0 * fz_0 + tk_xxzz_xxxzz[i] * fe_0 + tk_xxyzz_xxxzz[i] * pa_y[i] + 2.0 * ts_xxyyzz_xxxzz[i] * fz_0;

        tk_xxyyzz_xxyyy[i] =
            -2.0 * ts_xxyy_xxyyy[i] * fbe_0 * fz_0 + tk_xxyy_xxyyy[i] * fe_0 + tk_xxyyz_xxyyy[i] * pa_z[i] + 2.0 * ts_xxyyzz_xxyyy[i] * fz_0;

        tk_xxyyzz_xxyyz[i] = -2.0 * ts_yyzz_xxyyz[i] * fbe_0 * fz_0 + tk_yyzz_xxyyz[i] * fe_0 + 2.0 * tk_xyyzz_xyyz[i] * fe_0 +
                             tk_xyyzz_xxyyz[i] * pa_x[i] + 2.0 * ts_xxyyzz_xxyyz[i] * fz_0;

        tk_xxyyzz_xxyzz[i] = -2.0 * ts_yyzz_xxyzz[i] * fbe_0 * fz_0 + tk_yyzz_xxyzz[i] * fe_0 + 2.0 * tk_xyyzz_xyzz[i] * fe_0 +
                             tk_xyyzz_xxyzz[i] * pa_x[i] + 2.0 * ts_xxyyzz_xxyzz[i] * fz_0;

        tk_xxyyzz_xxzzz[i] =
            -2.0 * ts_xxzz_xxzzz[i] * fbe_0 * fz_0 + tk_xxzz_xxzzz[i] * fe_0 + tk_xxyzz_xxzzz[i] * pa_y[i] + 2.0 * ts_xxyyzz_xxzzz[i] * fz_0;

        tk_xxyyzz_xyyyy[i] =
            -2.0 * ts_xxyy_xyyyy[i] * fbe_0 * fz_0 + tk_xxyy_xyyyy[i] * fe_0 + tk_xxyyz_xyyyy[i] * pa_z[i] + 2.0 * ts_xxyyzz_xyyyy[i] * fz_0;

        tk_xxyyzz_xyyyz[i] = -2.0 * ts_yyzz_xyyyz[i] * fbe_0 * fz_0 + tk_yyzz_xyyyz[i] * fe_0 + tk_xyyzz_yyyz[i] * fe_0 +
                             tk_xyyzz_xyyyz[i] * pa_x[i] + 2.0 * ts_xxyyzz_xyyyz[i] * fz_0;

        tk_xxyyzz_xyyzz[i] = -2.0 * ts_yyzz_xyyzz[i] * fbe_0 * fz_0 + tk_yyzz_xyyzz[i] * fe_0 + tk_xyyzz_yyzz[i] * fe_0 +
                             tk_xyyzz_xyyzz[i] * pa_x[i] + 2.0 * ts_xxyyzz_xyyzz[i] * fz_0;

        tk_xxyyzz_xyzzz[i] = -2.0 * ts_yyzz_xyzzz[i] * fbe_0 * fz_0 + tk_yyzz_xyzzz[i] * fe_0 + tk_xyyzz_yzzz[i] * fe_0 +
                             tk_xyyzz_xyzzz[i] * pa_x[i] + 2.0 * ts_xxyyzz_xyzzz[i] * fz_0;

        tk_xxyyzz_xzzzz[i] =
            -2.0 * ts_xxzz_xzzzz[i] * fbe_0 * fz_0 + tk_xxzz_xzzzz[i] * fe_0 + tk_xxyzz_xzzzz[i] * pa_y[i] + 2.0 * ts_xxyyzz_xzzzz[i] * fz_0;

        tk_xxyyzz_yyyyy[i] =
            -2.0 * ts_yyzz_yyyyy[i] * fbe_0 * fz_0 + tk_yyzz_yyyyy[i] * fe_0 + tk_xyyzz_yyyyy[i] * pa_x[i] + 2.0 * ts_xxyyzz_yyyyy[i] * fz_0;

        tk_xxyyzz_yyyyz[i] =
            -2.0 * ts_yyzz_yyyyz[i] * fbe_0 * fz_0 + tk_yyzz_yyyyz[i] * fe_0 + tk_xyyzz_yyyyz[i] * pa_x[i] + 2.0 * ts_xxyyzz_yyyyz[i] * fz_0;

        tk_xxyyzz_yyyzz[i] =
            -2.0 * ts_yyzz_yyyzz[i] * fbe_0 * fz_0 + tk_yyzz_yyyzz[i] * fe_0 + tk_xyyzz_yyyzz[i] * pa_x[i] + 2.0 * ts_xxyyzz_yyyzz[i] * fz_0;

        tk_xxyyzz_yyzzz[i] =
            -2.0 * ts_yyzz_yyzzz[i] * fbe_0 * fz_0 + tk_yyzz_yyzzz[i] * fe_0 + tk_xyyzz_yyzzz[i] * pa_x[i] + 2.0 * ts_xxyyzz_yyzzz[i] * fz_0;

        tk_xxyyzz_yzzzz[i] =
            -2.0 * ts_yyzz_yzzzz[i] * fbe_0 * fz_0 + tk_yyzz_yzzzz[i] * fe_0 + tk_xyyzz_yzzzz[i] * pa_x[i] + 2.0 * ts_xxyyzz_yzzzz[i] * fz_0;

        tk_xxyyzz_zzzzz[i] =
            -2.0 * ts_yyzz_zzzzz[i] * fbe_0 * fz_0 + tk_yyzz_zzzzz[i] * fe_0 + tk_xyyzz_zzzzz[i] * pa_x[i] + 2.0 * ts_xxyyzz_zzzzz[i] * fz_0;
    }
...
#pragma omp simd aligned(pa_x,                \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        tk_xxzzzz_xxxxx[i] =
            -6.0 * ts_xxzz_xxxxx[i] * fbe_0 * fz_0 + 3.0 * tk_xxzz_xxxxx[i] * fe_0 + tk_xxzzz_xxxxx[i] * pa_z[i] + 2.0 * ts_xxzzzz_xxxxx[i] * fz_0;

        tk_xxzzzz_xxxxy[i] =
            -6.0 * ts_xxzz_xxxxy[i] * fbe_0 * fz_0 + 3.0 * tk_xxzz_xxxxy[i] * fe_0 + tk_xxzzz_xxxxy[i] * pa_z[i] + 2.0 * ts_xxzzzz_xxxxy[i] * fz_0;

        tk_xxzzzz_xxxxz[i] = -2.0 * ts_zzzz_xxxxz[i] * fbe_0 * fz_0 + tk_zzzz_xxxxz[i] * fe_0 + 4.0 * tk_xzzzz_xxxz[i] * fe_0 +
                             tk_xzzzz_xxxxz[i] * pa_x[i] + 2.0 * ts_xxzzzz_xxxxz[i] * fz_0;

        tk_xxzzzz_xxxyy[i] =
            -6.0 * ts_xxzz_xxxyy[i] * fbe_0 * fz_0 + 3.0 * tk_xxzz_xxxyy[i] * fe_0 + tk_xxzzz_xxxyy[i] * pa_z[i] + 2.0 * ts_xxzzzz_xxxyy[i] * fz_0;

        tk_xxzzzz_xxxyz[i] = -2.0 * ts_zzzz_xxxyz[i] * fbe_0 * fz_0 + tk_zzzz_xxxyz[i] * fe_0 + 3.0 * tk_xzzzz_xxyz[i] * fe_0 +
                             tk_xzzzz_xxxyz[i] * pa_x[i] + 2.0 * ts_xxzzzz_xxxyz[i] * fz_0;

        tk_xxzzzz_xxxzz[i] = -2.0 * ts_zzzz_xxxzz[i] * fbe_0 * fz_0 + tk_zzzz_xxxzz[i] * fe_0 + 3.0 * tk_xzzzz_xxzz[i] * fe_0 +
                             tk_xzzzz_xxxzz[i] * pa_x[i] + 2.0 * ts_xxzzzz_xxxzz[i] * fz_0;

        tk_xxzzzz_xxyyy[i] =
            -6.0 * ts_xxzz_xxyyy[i] * fbe_0 * fz_0 + 3.0 * tk_xxzz_xxyyy[i] * fe_0 + tk_xxzzz_xxyyy[i] * pa_z[i] + 2.0 * ts_xxzzzz_xxyyy[i] * fz_0;

        tk_xxzzzz_xxyyz[i] = -2.0 * ts_zzzz_xxyyz[i] * fbe_0 * fz_0 + tk_zzzz_xxyyz[i] * fe_0 + 2.0 * tk_xzzzz_xyyz[i] * fe_0 +
                             tk_xzzzz_xxyyz[i] * pa_x[i] + 2.0 * ts_xxzzzz_xxyyz[i] * fz_0;

        tk_xxzzzz_xxyzz[i] = -2.0 * ts_zzzz_xxyzz[i] * fbe_0 * fz_0 + tk_zzzz_xxyzz[i] * fe_0 + 2.0 * tk_xzzzz_xyzz[i] * fe_0 +
                             tk_xzzzz_xxyzz[i] * pa_x[i] + 2.0 * ts_xxzzzz_xxyzz[i] * fz_0;

        tk_xxzzzz_xxzzz[i] = -2.0 * ts_zzzz_xxzzz[i] * fbe_0 * fz_0 + tk_zzzz_xxzzz[i] * fe_0 + 2.0 * tk_xzzzz_xzzz[i] * fe_0 +
                             tk_xzzzz_xxzzz[i] * pa_x[i] + 2.0 * ts_xxzzzz_xxzzz[i] * fz_0;

        tk_xxzzzz_xyyyy[i] =
            -6.0 * ts_xxzz_xyyyy[i] * fbe_0 * fz_0 + 3.0 * tk_xxzz_xyyyy[i] * fe_0 + tk_xxzzz_xyyyy[i] * pa_z[i] + 2.0 * ts_xxzzzz_xyyyy[i] * fz_0;

        tk_xxzzzz_xyyyz[i] = -2.0 * ts_zzzz_xyyyz[i] * fbe_0 * fz_0 + tk_zzzz_xyyyz[i] * fe_0 + tk_xzzzz_yyyz[i] * fe_0 +
                             tk_xzzzz_xyyyz[i] * pa_x[i] + 2.0 * ts_xxzzzz_xyyyz[i] * fz_0;

        tk_xxzzzz_xyyzz[i] = -2.0 * ts_zzzz_xyyzz[i] * fbe_0 * fz_0 + tk_zzzz_xyyzz[i] * fe_0 + tk_xzzzz_yyzz[i] * fe_0 +
                             tk_xzzzz_xyyzz[i] * pa_x[i] + 2.0 * ts_xxzzzz_xyyzz[i] * fz_0;

        tk_xxzzzz_xyzzz[i] = -2.0 * ts_zzzz_xyzzz[i] * fbe_0 * fz_0 + tk_zzzz_xyzzz[i] * fe_0 + tk_xzzzz_yzzz[i] * fe_0 +
                             tk_xzzzz_xyzzz[i] * pa_x[i] + 2.0 * ts_xxzzzz_xyzzz[i] * fz_0;

        tk_xxzzzz_xzzzz[i] = -2.0 * ts_zzzz_xzzzz[i] * fbe_0 * fz_0 + tk_zzzz_xzzzz[i] * fe_0 + tk_xzzzz_zzzz[i] * fe_0 +
                             tk_xzzzz_xzzzz[i] * pa_x[i] + 2.0 * ts_xxzzzz_xzzzz[i] * fz_0;

        tk_xxzzzz_yyyyy[i] =
            -2.0 * ts_zzzz_yyyyy[i] * fbe_0 * fz_0 + tk_zzzz_yyyyy[i] * fe_0 + tk_xzzzz_yyyyy[i] * pa_x[i] + 2.0 * ts_xxzzzz_yyyyy[i] * fz_0;

        tk_xxzzzz_yyyyz[i] =
            -2.0 * ts_zzzz_yyyyz[i] * fbe_0 * fz_0 + tk_zzzz_yyyyz[i] * fe_0 + tk_xzzzz_yyyyz[i] * pa_x[i] + 2.0 * ts_xxzzzz_yyyyz[i] * fz_0;

        tk_xxzzzz_yyyzz[i] =
            -2.0 * ts_zzzz_yyyzz[i] * fbe_0 * fz_0 + tk_zzzz_yyyzz[i] * fe_0 + tk_xzzzz_yyyzz[i] * pa_x[i] + 2.0 * ts_xxzzzz_yyyzz[i] * fz_0;

        tk_xxzzzz_yyzzz[i] =
            -2.0 * ts_zzzz_yyzzz[i] * fbe_0 * fz_0 + tk_zzzz_yyzzz[i] * fe_0 + tk_xzzzz_yyzzz[i] * pa_x[i] + 2.0 * ts_xxzzzz_yyzzz[i] * fz_0;

        tk_xxzzzz_yzzzz[i] =
            -2.0 * ts_zzzz_yzzzz[i] * fbe_0 * fz_0 + tk_zzzz_yzzzz[i] * fe_0 + tk_xzzzz_yzzzz[i] * pa_x[i] + 2.0 * ts_xxzzzz_yzzzz[i] * fz_0;

        tk_xxzzzz_zzzzz[i] =
            -2.0 * ts_zzzz_zzzzz[i] * fbe_0 * fz_0 + tk_zzzz_zzzzz[i] * fe_0 + tk_xzzzz_zzzzz[i] * pa_x[i] + 2.0 * ts_xxzzzz_zzzzz[i] * fz_0;
    }
...
#pragma omp simd aligned(pa_y,                \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        tk_yyyyyy_xxxxx[i] =
            -10.0 * ts_yyyy_xxxxx[i] * fbe_0 * fz_0 + 5.0 * tk_yyyy_xxxxx[i] * fe_0 + tk_yyyyy_xxxxx[i] * pa_y[i] + 2.0 * ts_yyyyyy_xxxxx[i] * fz_0;

        tk_yyyyyy_xxxxy[i] = -10.0 * ts_yyyy_xxxxy[i] * fbe_0 * fz_0 + 5.0 * tk_yyyy_xxxxy[i] * fe_0 + tk_yyyyy_xxxx[i] * fe_0 +
                             tk_yyyyy_xxxxy[i] * pa_y[i] + 2.0 * ts_yyyyyy_xxxxy[i] * fz_0;

        tk_yyyyyy_xxxxz[i] =
            -10.0 * ts_yyyy_xxxxz[i] * fbe_0 * fz_0 + 5.0 * tk_yyyy_xxxxz[i] * fe_0 + tk_yyyyy_xxxxz[i] * pa_y[i] + 2.0 * ts_yyyyyy_xxxxz[i] * fz_0;

        tk_yyyyyy_xxxyy[i] = -10.0 * ts_yyyy_xxxyy[i] * fbe_0 * fz_0 + 5.0 * tk_yyyy_xxxyy[i] * fe_0 + 2.0 * tk_yyyyy_xxxy[i] * fe_0 +
                             tk_yyyyy_xxxyy[i] * pa_y[i] + 2.0 * ts_yyyyyy_xxxyy[i] * fz_0;

        tk_yyyyyy_xxxyz[i] = -10.0 * ts_yyyy_xxxyz[i] * fbe_0 * fz_0 + 5.0 * tk_yyyy_xxxyz[i] * fe_0 + tk_yyyyy_xxxz[i] * fe_0 +
                             tk_yyyyy_xxxyz[i] * pa_y[i] + 2.0 * ts_yyyyyy_xxxyz[i] * fz_0;

        tk_yyyyyy_xxxzz[i] =
            -10.0 * ts_yyyy_xxxzz[i] * fbe_0 * fz_0 + 5.0 * tk_yyyy_xxxzz[i] * fe_0 + tk_yyyyy_xxxzz[i] * pa_y[i] + 2.0 * ts_yyyyyy_xxxzz[i] * fz_0;

        tk_yyyyyy_xxyyy[i] = -10.0 * ts_yyyy_xxyyy[i] * fbe_0 * fz_0 + 5.0 * tk_yyyy_xxyyy[i] * fe_0 + 3.0 * tk_yyyyy_xxyy[i] * fe_0 +
                             tk_yyyyy_xxyyy[i] * pa_y[i] + 2.0 * ts_yyyyyy_xxyyy[i] * fz_0;

        tk_yyyyyy_xxyyz[i] = -10.0 * ts_yyyy_xxyyz[i] * fbe_0 * fz_0 + 5.0 * tk_yyyy_xxyyz[i] * fe_0 + 2.0 * tk_yyyyy_xxyz[i] * fe_0 +
                             tk_yyyyy_xxyyz[i] * pa_y[i] + 2.0 * ts_yyyyyy_xxyyz[i] * fz_0;

        tk_yyyyyy_xxyzz[i] = -10.0 * ts_yyyy_xxyzz[i] * fbe_0 * fz_0 + 5.0 * tk_yyyy_xxyzz[i] * fe_0 + tk_yyyyy_xxzz[i] * fe_0 +
                             tk_yyyyy_xxyzz[i] * pa_y[i] + 2.0 * ts_yyyyyy_xxyzz[i] * fz_0;

        tk_yyyyyy_xxzzz[i] =
            -10.0 * ts_yyyy_xxzzz[i] * fbe_0 * fz_0 + 5.0 * tk_yyyy_xxzzz[i] * fe_0 + tk_yyyyy_xxzzz[i] * pa_y[i] + 2.0 * ts_yyyyyy_xxzzz[i] * fz_0;

        tk_yyyyyy_xyyyy[i] = -10.0 * ts_yyyy_xyyyy[i] * fbe_0 * fz_0 + 5.0 * tk_yyyy_xyyyy[i] * fe_0 + 4.0 * tk_yyyyy_xyyy[i] * fe_0 +
                             tk_yyyyy_xyyyy[i] * pa_y[i] + 2.0 * ts_yyyyyy_xyyyy[i] * fz_0;

        tk_yyyyyy_xyyyz[i] = -10.0 * ts_yyyy_xyyyz[i] * fbe_0 * fz_0 + 5.0 * tk_yyyy_xyyyz[i] * fe_0 + 3.0 * tk_yyyyy_xyyz[i] * fe_0 +
                             tk_yyyyy_xyyyz[i] * pa_y[i] + 2.0 * ts_yyyyyy_xyyyz[i] * fz_0;

        tk_yyyyyy_xyyzz[i] = -10.0 * ts_yyyy_xyyzz[i] * fbe_0 * fz_0 + 5.0 * tk_yyyy_xyyzz[i] * fe_0 + 2.0 * tk_yyyyy_xyzz[i] * fe_0 +
                             tk_yyyyy_xyyzz[i] * pa_y[i] + 2.0 * ts_yyyyyy_xyyzz[i] * fz_0;

        tk_yyyyyy_xyzzz[i] = -10.0 * ts_yyyy_xyzzz[i] * fbe_0 * fz_0 + 5.0 * tk_yyyy_xyzzz[i] * fe_0 + tk_yyyyy_xzzz[i] * fe_0 +
                             tk_yyyyy_xyzzz[i] * pa_y[i] + 2.0 * ts_yyyyyy_xyzzz[i] * fz_0;

        tk_yyyyyy_xzzzz[i] =
            -10.0 * ts_yyyy_xzzzz[i] * fbe_0 * fz_0 + 5.0 * tk_yyyy_xzzzz[i] * fe_0 + tk_yyyyy_xzzzz[i] * pa_y[i] + 2.0 * ts_yyyyyy_xzzzz[i] * fz_0;

        tk_yyyyyy_yyyyy[i] = -10.0 * ts_yyyy_yyyyy[i] * fbe_0 * fz_0 + 5.0 * tk_yyyy_yyyyy[i] * fe_0 + 5.0 * tk_yyyyy_yyyy[i] * fe_0 +
                             tk_yyyyy_yyyyy[i] * pa_y[i] + 2.0 * ts_yyyyyy_yyyyy[i] * fz_0;

        tk_yyyyyy_yyyyz[i] = -10.0 * ts_yyyy_yyyyz[i] * fbe_0 * fz_0 + 5.0 * tk_yyyy_yyyyz[i] * fe_0 + 4.0 * tk_yyyyy_yyyz[i] * fe_0 +
                             tk_yyyyy_yyyyz[i] * pa_y[i] + 2.0 * ts_yyyyyy_yyyyz[i] * fz_0;

        tk_yyyyyy_yyyzz[i] = -10.0 * ts_yyyy_yyyzz[i] * fbe_0 * fz_0 + 5.0 * tk_yyyy_yyyzz[i] * fe_0 + 3.0 * tk_yyyyy_yyzz[i] * fe_0 +
                             tk_yyyyy_yyyzz[i] * pa_y[i] + 2.0 * ts_yyyyyy_yyyzz[i] * fz_0;

        tk_yyyyyy_yyzzz[i] = -10.0 * ts_yyyy_yyzzz[i] * fbe_0 * fz_0 + 5.0 * tk_yyyy_yyzzz[i] * fe_0 + 2.0 * tk_yyyyy_yzzz[i] * fe_0 +
                             tk_yyyyy_yyzzz[i] * pa_y[i] + 2.0 * ts_yyyyyy_yyzzz[i] * fz_0;

        tk_yyyyyy_yzzzz[i] = -10.0 * ts_yyyy_yzzzz[i] * fbe_0 * fz_0 + 5.0 * tk_yyyy_yzzzz[i] * fe_0 + tk_yyyyy_zzzz[i] * fe_0 +
                             tk_yyyyy_yzzzz[i] * pa_y[i] + 2.0 * ts_yyyyyy_yzzzz[i] * fz_0;

        tk_yyyyyy_zzzzz[i] =
            -10.0 * ts_yyyy_zzzzz[i] * fbe_0 * fz_0 + 5.0 * tk_yyyy_zzzzz[i] * fe_0 + tk_yyyyy_zzzzz[i] * pa_y[i] + 2.0 * ts_yyyyyy_zzzzz[i] * fz_0;
    }
...
#pragma omp simd aligned(pa_y,                \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        tk_yyyyzz_xxxxx[i] =
            -6.0 * ts_yyzz_xxxxx[i] * fbe_0 * fz_0 + 3.0 * tk_yyzz_xxxxx[i] * fe_0 + tk_yyyzz_xxxxx[i] * pa_y[i] + 2.0 * ts_yyyyzz_xxxxx[i] * fz_0;

        tk_yyyyzz_xxxxy[i] =
            -2.0 * ts_yyyy_xxxxy[i] * fbe_0 * fz_0 + tk_yyyy_xxxxy[i] * fe_0 + tk_yyyyz_xxxxy[i] * pa_z[i] + 2.0 * ts_yyyyzz_xxxxy[i] * fz_0;

        tk_yyyyzz_xxxxz[i] =
            -6.0 * ts_yyzz_xxxxz[i] * fbe_0 * fz_0 + 3.0 * tk_yyzz_xxxxz[i] * fe_0 + tk_yyyzz_xxxxz[i] * pa_y[i] + 2.0 * ts_yyyyzz_xxxxz[i] * fz_0;

        tk_yyyyzz_xxxyy[i] =
            -2.0 * ts_yyyy_xxxyy[i] * fbe_0 * fz_0 + tk_yyyy_xxxyy[i] * fe_0 + tk_yyyyz_xxxyy[i] * pa_z[i] + 2.0 * ts_yyyyzz_xxxyy[i] * fz_0;

        tk_yyyyzz_xxxyz[i] = -6.0 * ts_yyzz_xxxyz[i] * fbe_0 * fz_0 + 3.0 * tk_yyzz_xxxyz[i] * fe_0 + tk_yyyzz_xxxz[i] * fe_0 +
                             tk_yyyzz_xxxyz[i] * pa_y[i] + 2.0 * ts_yyyyzz_xxxyz[i] * fz_0;

        tk_yyyyzz_xxxzz[i] =
            -6.0 * ts_yyzz_xxxzz[i] * fbe_0 * fz_0 + 3.0 * tk_yyzz_xxxzz[i] * fe_0 + tk_yyyzz_xxxzz[i] * pa_y[i] + 2.0 * ts_yyyyzz_xxxzz[i] * fz_0;

        tk_yyyyzz_xxyyy[i] =
            -2.0 * ts_yyyy_xxyyy[i] * fbe_0 * fz_0 + tk_yyyy_xxyyy[i] * fe_0 + tk_yyyyz_xxyyy[i] * pa_z[i] + 2.0 * ts_yyyyzz_xxyyy[i] * fz_0;

        tk_yyyyzz_xxyyz[i] = -6.0 * ts_yyzz_xxyyz[i] * fbe_0 * fz_0 + 3.0 * tk_yyzz_xxyyz[i] * fe_0 + 2.0 * tk_yyyzz_xxyz[i] * fe_0 +
                             tk_yyyzz_xxyyz[i] * pa_y[i] + 2.0 * ts_yyyyzz_xxyyz[i] * fz_0;

        tk_yyyyzz_xxyzz[i] = -6.0 * ts_yyzz_xxyzz[i] * fbe_0 * fz_0 + 3.0 * tk_yyzz_xxyzz[i] * fe_0 + tk_yyyzz_xxzz[i] * fe_0 +
                             tk_yyyzz_xxyzz[i] * pa_y[i] + 2.0 * ts_yyyyzz_xxyzz[i] * fz_0;

        tk_yyyyzz_xxzzz[i] =
            -6.0 * ts_yyzz_xxzzz[i] * fbe_0 * fz_0 + 3.0 * tk_yyzz_xxzzz[i] * fe_0 + tk_yyyzz_xxzzz[i] * pa_y[i] + 2.0 * ts_yyyyzz_xxzzz[i] * fz_0;

        tk_yyyyzz_xyyyy[i] =
            -2.0 * ts_yyyy_xyyyy[i] * fbe_0 * fz_0 + tk_yyyy_xyyyy[i] * fe_0 + tk_yyyyz_xyyyy[i] * pa_z[i] + 2.0 * ts_yyyyzz_xyyyy[i] * fz_0;

        tk_yyyyzz_xyyyz[i] = -6.0 * ts_yyzz_xyyyz[i] * fbe_0 * fz_0 + 3.0 * tk_yyzz_xyyyz[i] * fe_0 + 3.0 * tk_yyyzz_xyyz[i] * fe_0 +
                             tk_yyyzz_xyyyz[i] * pa_y[i] + 2.0 * ts_yyyyzz_xyyyz[i] * fz_0;

        tk_yyyyzz_xyyzz[i] = -6.0 * ts_yyzz_xyyzz[i] * fbe_0 * fz_0 + 3.0 * tk_yyzz_xyyzz[i] * fe_0 + 2.0 * tk_yyyzz_xyzz[i] * fe_0 +
                             tk_yyyzz_xyyzz[i] * pa_y[i] + 2.0 * ts_yyyyzz_xyyzz[i] * fz_0;

        tk_yyyyzz_xyzzz[i] = -6.0 * ts_yyzz_xyzzz[i] * fbe_0 * fz_0 + 3.0 * tk_yyzz_xyzzz[i] * fe_0 + tk_yyyzz_xzzz[i] * fe_0 +
                             tk_yyyzz_xyzzz[i] * pa_y[i] + 2.0 * ts_yyyyzz_xyzzz[i] * fz_0;

        tk_yyyyzz_xzzzz[i] =
            -6.0 * ts_yyzz_xzzzz[i] * fbe_0 * fz_0 + 3.0 * tk_yyzz_xzzzz[i] * fe_0 + tk_yyyzz_xzzzz[i] * pa_y[i] + 2.0 * ts_yyyyzz_xzzzz[i] * fz_0;

        tk_yyyyzz_yyyyy[i] =
            -2.0 * ts_yyyy_yyyyy[i] * fbe_0 * fz_0 + tk_yyyy_yyyyy[i] * fe_0 + tk_yyyyz_yyyyy[i] * pa_z[i] + 2.0 * ts_yyyyzz_yyyyy[i] * fz_0;

        tk_yyyyzz_yyyyz[i] = -6.0 * ts_yyzz_yyyyz[i] * fbe_0 * fz_0 + 3.0 * tk_yyzz_yyyyz[i] * fe_0 + 4.0 * tk_yyyzz_yyyz[i] * fe_0 +
                             tk_yyyzz_yyyyz[i] * pa_y[i] + 2.0 * ts_yyyyzz_yyyyz[i] * fz_0;

        tk_yyyyzz_yyyzz[i] = -6.0 * ts_yyzz_yyyzz[i] * fbe_0 * fz_0 + 3.0 * tk_yyzz_yyyzz[i] * fe_0 + 3.0 * tk_yyyzz_yyzz[i] * fe_0 +
                             tk_yyyzz_yyyzz[i] * pa_y[i] + 2.0 * ts_yyyyzz_yyyzz[i] * fz_0;

        tk_yyyyzz_yyzzz[i] = -6.0 * ts_yyzz_yyzzz[i] * fbe_0 * fz_0 + 3.0 * tk_yyzz_yyzzz[i] * fe_0 + 2.0 * tk_yyyzz_yzzz[i] * fe_0 +
                             tk_yyyzz_yyzzz[i] * pa_y[i] + 2.0 * ts_yyyyzz_yyzzz[i] * fz_0;

        tk_yyyyzz_yzzzz[i] = -6.0 * ts_yyzz_yzzzz[i] * fbe_0 * fz_0 + 3.0 * tk_yyzz_yzzzz[i] * fe_0 + tk_yyyzz_zzzz[i] * fe_0 +
                             tk_yyyzz_yzzzz[i] * pa_y[i] + 2.0 * ts_yyyyzz_yzzzz[i] * fz_0;

        tk_yyyyzz_zzzzz[i] =
            -6.0 * ts_yyzz_zzzzz[i] * fbe_0 * fz_0 + 3.0 * tk_yyzz_zzzzz[i] * fe_0 + tk_yyyzz_zzzzz[i] * pa_y[i] + 2.0 * ts_yyyyzz_zzzzz[i] * fz_0;
    }
...
#pragma omp simd aligned(pa_y,                \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        tk_yyyzzz_xxxxx[i] =
            -4.0 * ts_yzzz_xxxxx[i] * fbe_0 * fz_0 + 2.0 * tk_yzzz_xxxxx[i] * fe_0 + tk_yyzzz_xxxxx[i] * pa_y[i] + 2.0 * ts_yyyzzz_xxxxx[i] * fz_0;

        tk_yyyzzz_xxxxy[i] =
            -4.0 * ts_yyyz_xxxxy[i] * fbe_0 * fz_0 + 2.0 * tk_yyyz_xxxxy[i] * fe_0 + tk_yyyzz_xxxxy[i] * pa_z[i] + 2.0 * ts_yyyzzz_xxxxy[i] * fz_0;

        tk_yyyzzz_xxxxz[i] =
            -4.0 * ts_yzzz_xxxxz[i] * fbe_0 * fz_0 + 2.0 * tk_yzzz_xxxxz[i] * fe_0 + tk_yyzzz_xxxxz[i] * pa_y[i] + 2.0 * ts_yyyzzz_xxxxz[i] * fz_0;

        tk_yyyzzz_xxxyy[i] =
            -4.0 * ts_yyyz_xxxyy[i] * fbe_0 * fz_0 + 2.0 * tk_yyyz_xxxyy[i] * fe_0 + tk_yyyzz_xxxyy[i] * pa_z[i] + 2.0 * ts_yyyzzz_xxxyy[i] * fz_0;

        tk_yyyzzz_xxxyz[i] = -4.0 * ts_yzzz_xxxyz[i] * fbe_0 * fz_0 + 2.0 * tk_yzzz_xxxyz[i] * fe_0 + tk_yyzzz_xxxz[i] * fe_0 +
                             tk_yyzzz_xxxyz[i] * pa_y[i] + 2.0 * ts_yyyzzz_xxxyz[i] * fz_0;

        tk_yyyzzz_xxxzz[i] =
            -4.0 * ts_yzzz_xxxzz[i] * fbe_0 * fz_0 + 2.0 * tk_yzzz_xxxzz[i] * fe_0 + tk_yyzzz_xxxzz[i] * pa_y[i] + 2.0 * ts_yyyzzz_xxxzz[i] * fz_0;

        tk_yyyzzz_xxyyy[i] =
            -4.0 * ts_yyyz_xxyyy[i] * fbe_0 * fz_0 + 2.0 * tk_yyyz_xxyyy[i] * fe_0 + tk_yyyzz_xxyyy[i] * pa_z[i] + 2.0 * ts_yyyzzz_xxyyy[i] * fz_0;

        tk_yyyzzz_xxyyz[i] = -4.0 * ts_yzzz_xxyyz[i] * fbe_0 * fz_0 + 2.0 * tk_yzzz_xxyyz[i] * fe_0 + 2.0 * tk_yyzzz_xxyz[i] * fe_0 +
                             tk_yyzzz_xxyyz[i] * pa_y[i] + 2.0 * ts_yyyzzz_xxyyz[i] * fz_0;

        tk_yyyzzz_xxyzz[i] = -4.0 * ts_yzzz_xxyzz[i] * fbe_0 * fz_0 + 2.0 * tk_yzzz_xxyzz[i] * fe_0 + tk_yyzzz_xxzz[i] * fe_0 +
                             tk_yyzzz_xxyzz[i] * pa_y[i] + 2.0 * ts_yyyzzz_xxyzz[i] * fz_0;

        tk_yyyzzz_xxzzz[i] =
            -4.0 * ts_yzzz_xxzzz[i] * fbe_0 * fz_0 + 2.0 * tk_yzzz_xxzzz[i] * fe_0 + tk_yyzzz_xxzzz[i] * pa_y[i] + 2.0 * ts_yyyzzz_xxzzz[i] * fz_0;

        tk_yyyzzz_xyyyy[i] =
            -4.0 * ts_yyyz_xyyyy[i] * fbe_0 * fz_0 + 2.0 * tk_yyyz_xyyyy[i] * fe_0 + tk_yyyzz_xyyyy[i] * pa_z[i] + 2.0 * ts_yyyzzz_xyyyy[i] * fz_0;

        tk_yyyzzz_xyyyz[i] = -4.0 * ts_yzzz_xyyyz[i] * fbe_0 * fz_0 + 2.0 * tk_yzzz_xyyyz[i] * fe_0 + 3.0 * tk_yyzzz_xyyz[i] * fe_0 +
                             tk_yyzzz_xyyyz[i] * pa_y[i] + 2.0 * ts_yyyzzz_xyyyz[i] * fz_0;

        tk_yyyzzz_xyyzz[i] = -4.0 * ts_yzzz_xyyzz[i] * fbe_0 * fz_0 + 2.0 * tk_yzzz_xyyzz[i] * fe_0 + 2.0 * tk_yyzzz_xyzz[i] * fe_0 +
                             tk_yyzzz_xyyzz[i] * pa_y[i] + 2.0 * ts_yyyzzz_xyyzz[i] * fz_0;

        tk_yyyzzz_xyzzz[i] = -4.0 * ts_yzzz_xyzzz[i] * fbe_0 * fz_0 + 2.0 * tk_yzzz_xyzzz[i] * fe_0 + tk_yyzzz_xzzz[i] * fe_0 +
                             tk_yyzzz_xyzzz[i] * pa_y[i] + 2.0 * ts_yyyzzz_xyzzz[i] * fz_0;

        tk_yyyzzz_xzzzz[i] =
            -4.0 * ts_yzzz_xzzzz[i] * fbe_0 * fz_0 + 2.0 * tk_yzzz_xzzzz[i] * fe_0 + tk_yyzzz_xzzzz[i] * pa_y[i] + 2.0 * ts_yyyzzz_xzzzz[i] * fz_0;

        tk_yyyzzz_yyyyy[i] =
            -4.0 * ts_yyyz_yyyyy[i] * fbe_0 * fz_0 + 2.0 * tk_yyyz_yyyyy[i] * fe_0 + tk_yyyzz_yyyyy[i] * pa_z[i] + 2.0 * ts_yyyzzz_yyyyy[i] * fz_0;

        tk_yyyzzz_yyyyz[i] = -4.0 * ts_yzzz_yyyyz[i] * fbe_0 * fz_0 + 2.0 * tk_yzzz_yyyyz[i] * fe_0 + 4.0 * tk_yyzzz_yyyz[i] * fe_0 +
                             tk_yyzzz_yyyyz[i] * pa_y[i] + 2.0 * ts_yyyzzz_yyyyz[i] * fz_0;

        tk_yyyzzz_yyyzz[i] = -4.0 * ts_yzzz_yyyzz[i] * fbe_0 * fz_0 + 2.0 * tk_yzzz_yyyzz[i] * fe_0 + 3.0 * tk_yyzzz_yyzz[i] * fe_0 +
                             tk_yyzzz_yyyzz[i] * pa_y[i] + 2.0 * ts_yyyzzz_yyyzz[i] * fz_0;

        tk_yyyzzz_yyzzz[i] = -4.0 * ts_yzzz_yyzzz[i] * fbe_0 * fz_0 + 2.0 * tk_yzzz_yyzzz[i] * fe_0 + 2.0 * tk_yyzzz_yzzz[i] * fe_0 +
                             tk_yyzzz_yyzzz[i] * pa_y[i] + 2.0 * ts_yyyzzz_yyzzz[i] * fz_0;

        tk_yyyzzz_yzzzz[i] = -4.0 * ts_yzzz_yzzzz[i] * fbe_0 * fz_0 + 2.0 * tk_yzzz_yzzzz[i] * fe_0 + tk_yyzzz_zzzz[i] * fe_0 +
                             tk_yyzzz_yzzzz[i] * pa_y[i] + 2.0 * ts_yyyzzz_yzzzz[i] * fz_0;

        tk_yyyzzz_zzzzz[i] =
            -4.0 * ts_yzzz_zzzzz[i] * fbe_0 * fz_0 + 2.0 * tk_yzzz_zzzzz[i] * fe_0 + tk_yyzzz_zzzzz[i] * pa_y[i] + 2.0 * ts_yyyzzz_zzzzz[i] * fz_0;
    }
...
#pragma omp simd aligned(pa_y,                \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        tk_yyzzzz_xxxxx[i] =
            -2.0 * ts_zzzz_xxxxx[i] * fbe_0 * fz_0 + tk_zzzz_xxxxx[i] * fe_0 + tk_yzzzz_xxxxx[i] * pa_y[i] + 2.0 * ts_yyzzzz_xxxxx[i] * fz_0;

        tk_yyzzzz_xxxxy[i] =
            -6.0 * ts_yyzz_xxxxy[i] * fbe_0 * fz_0 + 3.0 * tk_yyzz_xxxxy[i] * fe_0 + tk_yyzzz_xxxxy[i] * pa_z[i] + 2.0 * ts_yyzzzz_xxxxy[i] * fz_0;

        tk_yyzzzz_xxxxz[i] =
            -2.0 * ts_zzzz_xxxxz[i] * fbe_0 * fz_0 + tk_zzzz_xxxxz[i] * fe_0 + tk_yzzzz_xxxxz[i] * pa_y[i] + 2.0 * ts_yyzzzz_xxxxz[i] * fz_0;

        tk_yyzzzz_xxxyy[i] =
            -6.0 * ts_yyzz_xxxyy[i] * fbe_0 * fz_0 + 3.0 * tk_yyzz_xxxyy[i] * fe_0 + tk_yyzzz_xxxyy[i] * pa_z[i] + 2.0 * ts_yyzzzz_xxxyy[i] * fz_0;

        tk_yyzzzz_xxxyz[i] = -2.0 * ts_zzzz_xxxyz[i] * fbe_0 * fz_0 + tk_zzzz_xxxyz[i] * fe_0 + tk_yzzzz_xxxz[i] * fe_0 +
                             tk_yzzzz_xxxyz[i] * pa_y[i] + 2.0 * ts_yyzzzz_xxxyz[i] * fz_0;

        tk_yyzzzz_xxxzz[i] =
            -2.0 * ts_zzzz_xxxzz[i] * fbe_0 * fz_0 + tk_zzzz_xxxzz[i] * fe_0 + tk_yzzzz_xxxzz[i] * pa_y[i] + 2.0 * ts_yyzzzz_xxxzz[i] * fz_0;

        tk_yyzzzz_xxyyy[i] =
            -6.0 * ts_yyzz_xxyyy[i] * fbe_0 * fz_0 + 3.0 * tk_yyzz_xxyyy[i] * fe_0 + tk_yyzzz_xxyyy[i] * pa_z[i] + 2.0 * ts_yyzzzz_xxyyy[i] * fz_0;

        tk_yyzzzz_xxyyz[i] = -2.0 * ts_zzzz_xxyyz[i] * fbe_0 * fz_0 + tk_zzzz_xxyyz[i] * fe_0 + 2.0 * tk_yzzzz_xxyz[i] * fe_0 +
                             tk_yzzzz_xxyyz[i] * pa_y[i] + 2.0 * ts_yyzzzz_xxyyz[i] * fz_0;

        tk_yyzzzz_xxyzz[i] = -2.0 * ts_zzzz_xxyzz[i] * fbe_0 * fz_0 + tk_zzzz_xxyzz[i] * fe_0 + tk_yzzzz_xxzz[i] * fe_0 +
                             tk_yzzzz_xxyzz[i] * pa_y[i] + 2.0 * ts_yyzzzz_xxyzz[i] * fz_0;

        tk_yyzzzz_xxzzz[i] =
            -2.0 * ts_zzzz_xxzzz[i] * fbe_0 * fz_0 + tk_zzzz_xxzzz[i] * fe_0 + tk_yzzzz_xxzzz[i] * pa_y[i] + 2.0 * ts_yyzzzz_xxzzz[i] * fz_0;

        tk_yyzzzz_xyyyy[i] =
            -6.0 * ts_yyzz_xyyyy[i] * fbe_0 * fz_0 + 3.0 * tk_yyzz_xyyyy[i] * fe_0 + tk_yyzzz_xyyyy[i] * pa_z[i] + 2.0 * ts_yyzzzz_xyyyy[i] * fz_0;

        tk_yyzzzz_xyyyz[i] = -2.0 * ts_zzzz_xyyyz[i] * fbe_0 * fz_0 + tk_zzzz_xyyyz[i] * fe_0 + 3.0 * tk_yzzzz_xyyz[i] * fe_0 +
                             tk_yzzzz_xyyyz[i] * pa_y[i] + 2.0 * ts_yyzzzz_xyyyz[i] * fz_0;

        tk_yyzzzz_xyyzz[i] = -2.0 * ts_zzzz_xyyzz[i] * fbe_0 * fz_0 + tk_zzzz_xyyzz[i] * fe_0 + 2.0 * tk_yzzzz_xyzz[i] * fe_0 +
                             tk_yzzzz_xyyzz[i] * pa_y[i] + 2.0 * ts_yyzzzz_xyyzz[i] * fz_0;

        tk_yyzzzz_xyzzz[i] = -2.0 * ts_zzzz_xyzzz[i] * fbe_0 * fz_0 + tk_zzzz_xyzzz[i] * fe_0 + tk_yzzzz_xzzz[i] * fe_0 +
                             tk_yzzzz_xyzzz[i] * pa_y[i] + 2.0 * ts_yyzzzz_xyzzz[i] * fz_0;

        tk_yyzzzz_xzzzz[i] =
            -2.0 * ts_zzzz_xzzzz[i] * fbe_0 * fz_0 + tk_zzzz_xzzzz[i] * fe_0 + tk_yzzzz_xzzzz[i] * pa_y[i] + 2.0 * ts_yyzzzz_xzzzz[i] * fz_0;

        tk_yyzzzz_yyyyy[i] =
            -6.0 * ts_yyzz_yyyyy[i] * fbe_0 * fz_0 + 3.0 * tk_yyzz_yyyyy[i] * fe_0 + tk_yyzzz_yyyyy[i] * pa_z[i] + 2.0 * ts_yyzzzz_yyyyy[i] * fz_0;

        tk_yyzzzz_yyyyz[i] = -2.0 * ts_zzzz_yyyyz[i] * fbe_0 * fz_0 + tk_zzzz_yyyyz[i] * fe_0 + 4.0 * tk_yzzzz_yyyz[i] * fe_0 +
                             tk_yzzzz_yyyyz[i] * pa_y[i] + 2.0 * ts_yyzzzz_yyyyz[i] * fz_0;

        tk_yyzzzz_yyyzz[i] = -2.0 * ts_zzzz_yyyzz[i] * fbe_0 * fz_0 + tk_zzzz_yyyzz[i] * fe_0 + 3.0 * tk_yzzzz_yyzz[i] * fe_0 +
                             tk_yzzzz_yyyzz[i] * pa_y[i] + 2.0 * ts_yyzzzz_yyyzz[i] * fz_0;

        tk_yyzzzz_yyzzz[i] = -2.0 * ts_zzzz_yyzzz[i] * fbe_0 * fz_0 + tk_zzzz_yyzzz[i] * fe_0 + 2.0 * tk_yzzzz_yzzz[i] * fe_0 +
                             tk_yzzzz_yyzzz[i] * pa_y[i] + 2.0 * ts_yyzzzz_yyzzz[i] * fz_0;

        tk_yyzzzz_yzzzz[i] = -2.0 * ts_zzzz_yzzzz[i] * fbe_0 * fz_0 + tk_zzzz_yzzzz[i] * fe_0 + tk_yzzzz_zzzz[i] * fe_0 +
                             tk_yzzzz_yzzzz[i] * pa_y[i] + 2.0 * ts_yyzzzz_yzzzz[i] * fz_0;

        tk_yyzzzz_zzzzz[i] =
            -2.0 * ts_zzzz_zzzzz[i] * fbe_0 * fz_0 + tk_zzzz_zzzzz[i] * fe_0 + tk_yzzzz_zzzzz[i] * pa_y[i] + 2.0 * ts_yyzzzz_zzzzz[i] * fz_0;
    }
...
#pragma omp simd aligned(pa_z,                \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        tk_zzzzzz_xxxxx[i] =
            -10.0 * ts_zzzz_xxxxx[i] * fbe_0 * fz_0 + 5.0 * tk_zzzz_xxxxx[i] * fe_0 + tk_zzzzz_xxxxx[i] * pa_z[i] + 2.0 * ts_zzzzzz_xxxxx[i] * fz_0;

        tk_zzzzzz_xxxxy[i] =
            -10.0 * ts_zzzz_xxxxy[i] * fbe_0 * fz_0 + 5.0 * tk_zzzz_xxxxy[i] * fe_0 + tk_zzzzz_xxxxy[i] * pa_z[i] + 2.0 * ts_zzzzzz_xxxxy[i] * fz_0;

        tk_zzzzzz_xxxxz[i] = -10.0 * ts_zzzz_xxxxz[i] * fbe_0 * fz_0 + 5.0 * tk_zzzz_xxxxz[i] * fe_0 + tk_zzzzz_xxxx[i] * fe_0 +
                             tk_zzzzz_xxxxz[i] * pa_z[i] + 2.0 * ts_zzzzzz_xxxxz[i] * fz_0;

        tk_zzzzzz_xxxyy[i] =
            -10.0 * ts_zzzz_xxxyy[i] * fbe_0 * fz_0 + 5.0 * tk_zzzz_xxxyy[i] * fe_0 + tk_zzzzz_xxxyy[i] * pa_z[i] + 2.0 * ts_zzzzzz_xxxyy[i] * fz_0;

        tk_zzzzzz_xxxyz[i] = -10.0 * ts_zzzz_xxxyz[i] * fbe_0 * fz_0 + 5.0 * tk_zzzz_xxxyz[i] * fe_0 + tk_zzzzz_xxxy[i] * fe_0 +
                             tk_zzzzz_xxxyz[i] * pa_z[i] + 2.0 * ts_zzzzzz_xxxyz[i] * fz_0;

        tk_zzzzzz_xxxzz[i] = -10.0 * ts_zzzz_xxxzz[i] * fbe_0 * fz_0 + 5.0 * tk_zzzz_xxxzz[i] * fe_0 + 2.0 * tk_zzzzz_xxxz[i] * fe_0 +
                             tk_zzzzz_xxxzz[i] * pa_z[i] + 2.0 * ts_zzzzzz_xxxzz[i] * fz_0;

        tk_zzzzzz_xxyyy[i] =
            -10.0 * ts_zzzz_xxyyy[i] * fbe_0 * fz_0 + 5.0 * tk_zzzz_xxyyy[i] * fe_0 + tk_zzzzz_xxyyy[i] * pa_z[i] + 2.0 * ts_zzzzzz_xxyyy[i] * fz_0;

        tk_zzzzzz_xxyyz[i] = -10.0 * ts_zzzz_xxyyz[i] * fbe_0 * fz_0 + 5.0 * tk_zzzz_xxyyz[i] * fe_0 + tk_zzzzz_xxyy[i] * fe_0 +
                             tk_zzzzz_xxyyz[i] * pa_z[i] + 2.0 * ts_zzzzzz_xxyyz[i] * fz_0;

        tk_zzzzzz_xxyzz[i] = -10.0 * ts_zzzz_xxyzz[i] * fbe_0 * fz_0 + 5.0 * tk_zzzz_xxyzz[i] * fe_0 + 2.0 * tk_zzzzz_xxyz[i] * fe_0 +
                             tk_zzzzz_xxyzz[i] * pa_z[i] + 2.0 * ts_zzzzzz_xxyzz[i] * fz_0;

        tk_zzzzzz_xxzzz[i] = -10.0 * ts_zzzz_xxzzz[i] * fbe_0 * fz_0 + 5.0 * tk_zzzz_xxzzz[i] * fe_0 + 3.0 * tk_zzzzz_xxzz[i] * fe_0 +
                             tk_zzzzz_xxzzz[i] * pa_z[i] + 2.0 * ts_zzzzzz_xxzzz[i] * fz_0;

        tk_zzzzzz_xyyyy[i] =
            -10.0 * ts_zzzz_xyyyy[i] * fbe_0 * fz_0 + 5.0 * tk_zzzz_xyyyy[i] * fe_0 + tk_zzzzz_xyyyy[i] * pa_z[i] + 2.0 * ts_zzzzzz_xyyyy[i] * fz_0;

        tk_zzzzzz_xyyyz[i] = -10.0 * ts_zzzz_xyyyz[i] * fbe_0 * fz_0 + 5.0 * tk_zzzz_xyyyz[i] * fe_0 + tk_zzzzz_xyyy[i] * fe_0 +
                             tk_zzzzz_xyyyz[i] * pa_z[i] + 2.0 * ts_zzzzzz_xyyyz[i] * fz_0;

        tk_zzzzzz_xyyzz[i] = -10.0 * ts_zzzz_xyyzz[i] * fbe_0 * fz_0 + 5.0 * tk_zzzz_xyyzz[i] * fe_0 + 2.0 * tk_zzzzz_xyyz[i] * fe_0 +
                             tk_zzzzz_xyyzz[i] * pa_z[i] + 2.0 * ts_zzzzzz_xyyzz[i] * fz_0;

        tk_zzzzzz_xyzzz[i] = -10.0 * ts_zzzz_xyzzz[i] * fbe_0 * fz_0 + 5.0 * tk_zzzz_xyzzz[i] * fe_0 + 3.0 * tk_zzzzz_xyzz[i] * fe_0 +
                             tk_zzzzz_xyzzz[i] * pa_z[i] + 2.0 * ts_zzzzzz_xyzzz[i] * fz_0;

        tk_zzzzzz_xzzzz[i] = -10.0 * ts_zzzz_xzzzz[i] * fbe_0 * fz_0 + 5.0 * tk_zzzz_xzzzz[i] * fe_0 + 4.0 * tk_zzzzz_xzzz[i] * fe_0 +
                             tk_zzzzz_xzzzz[i] * pa_z[i] + 2.0 * ts_zzzzzz_xzzzz[i] * fz_0;

        tk_zzzzzz_yyyyy[i] =
            -10.0 * ts_zzzz_yyyyy[i] * fbe_0 * fz_0 + 5.0 * tk_zzzz_yyyyy[i] * fe_0 + tk_zzzzz_yyyyy[i] * pa_z[i] + 2.0 * ts_zzzzzz_yyyyy[i] * fz_0;

        tk_zzzzzz_yyyyz[i] = -10.0 * ts_zzzz_yyyyz[i] * fbe_0 * fz_0 + 5.0 * tk_zzzz_yyyyz[i] * fe_0 + tk_zzzzz_yyyy[i] * fe_0 +
                             tk_zzzzz_yyyyz[i] * pa_z[i] + 2.0 * ts_zzzzzz_yyyyz[i] * fz_0;

        tk_zzzzzz_yyyzz[i] = -10.0 * ts_zzzz_yyyzz[i] * fbe_0 * fz_0 + 5.0 * tk_zzzz_yyyzz[i] * fe_0 + 2.0 * tk_zzzzz_yyyz[i] * fe_0 +
                             tk_zzzzz_yyyzz[i] * pa_z[i] + 2.0 * ts_zzzzzz_yyyzz[i] * fz_0;

        tk_zzzzzz_yyzzz[i] = -10.0 * ts_zzzz_yyzzz[i] * fbe_0 * fz_0 + 5.0 * tk_zzzz_yyzzz[i] * fe_0 + 3.0 * tk_zzzzz_yyzz[i] * fe_0 +
                             tk_zzzzz_yyzzz[i] * pa_z[i] + 2.0 * ts_zzzzzz_yyzzz[i] * fz_0;

        tk_zzzzzz_yzzzz[i] = -10.0 * ts_zzzz_yzzzz[i] * fbe_0 * fz_0 + 5.0 * tk_zzzz_yzzzz[i] * fe_0 + 4.0 * tk_zzzzz_yzzz[i] * fe_0 +
                             tk_zzzzz_yzzzz[i] * pa_z[i] + 2.0 * ts_zzzzzz_yzzzz[i] * fz_0;

        tk_zzzzzz_zzzzz[i] = -10.0 * ts_zzzz_zzzzz[i] * fbe_0 * fz_0 + 5.0 * tk_zzzz_zzzzz[i] * fe_0 + 5.0 * tk_zzzzz_zzzz[i] * fe_0 +
                             tk_zzzzz_zzzzz[i] * pa_z[i] + 2.0 * ts_zzzzzz_zzzzz[i] * fz_0;
    }
}
