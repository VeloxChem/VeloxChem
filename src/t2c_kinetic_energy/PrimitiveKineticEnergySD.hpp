#ifndef PrimitiveKineticEnergySD
#define PrimitiveKineticEnergySD
...
/**
 Evaluates block of primitive <S|T|D> integrals.
...
*/
auto compPrimitiveKineticEnergySD(TDoubleArray&       buffer_xx,
...
#endif /* PrimitiveKineticEnergySD */
