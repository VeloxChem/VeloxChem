...
/**
 Evaluates <G|T|S>  integrals for given pair of GTOs blocks.
...
*/
auto compKineticEnergyGS(CSubMatrix*      matrix,
...
/**
 Evaluates block of primitive <G|T|S> integrals.
...
*/
auto compPrimitiveKineticEnergyGS(TDoubleArray&       buffer_xxxx,
