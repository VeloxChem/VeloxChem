#ifndef KineticEnergyRecFS_hpp
#define KineticEnergyRecFS_hpp
...
/// @brief Computes (F|T|S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_kinetic_energy_fs(T&                               distributor,
