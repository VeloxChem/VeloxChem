#ifndef KineticEnergyPrimRecDG
#define KineticEnergyPrimRecDG

#include "SimdArray.hpp"

namespace kinrec {  // kinrec namespace

/// @brief Computes primitive [D|T|G]  integrals for set of data buffers.
...
auto comp_prim_kinetic_energy_dg(CSimdArray<double>&       pbuffer,
