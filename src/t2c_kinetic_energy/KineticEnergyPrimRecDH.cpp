...
#pragma omp simd aligned(pa_x,            \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        tk_xx_xxxxx[i] = -2.0 * ts_0_xxxxx[i] * fbe_0 * fz_0 + tk_0_xxxxx[i] * fe_0 + 5.0 * tk_x_xxxx[i] * fe_0 + tk_x_xxxxx[i] * pa_x[i] +
                         2.0 * ts_xx_xxxxx[i] * fz_0;

        tk_xx_xxxxy[i] = -2.0 * ts_0_xxxxy[i] * fbe_0 * fz_0 + tk_0_xxxxy[i] * fe_0 + 4.0 * tk_x_xxxy[i] * fe_0 + tk_x_xxxxy[i] * pa_x[i] +
                         2.0 * ts_xx_xxxxy[i] * fz_0;

        tk_xx_xxxxz[i] = -2.0 * ts_0_xxxxz[i] * fbe_0 * fz_0 + tk_0_xxxxz[i] * fe_0 + 4.0 * tk_x_xxxz[i] * fe_0 + tk_x_xxxxz[i] * pa_x[i] +
                         2.0 * ts_xx_xxxxz[i] * fz_0;

        tk_xx_xxxyy[i] = -2.0 * ts_0_xxxyy[i] * fbe_0 * fz_0 + tk_0_xxxyy[i] * fe_0 + 3.0 * tk_x_xxyy[i] * fe_0 + tk_x_xxxyy[i] * pa_x[i] +
                         2.0 * ts_xx_xxxyy[i] * fz_0;

        tk_xx_xxxyz[i] = -2.0 * ts_0_xxxyz[i] * fbe_0 * fz_0 + tk_0_xxxyz[i] * fe_0 + 3.0 * tk_x_xxyz[i] * fe_0 + tk_x_xxxyz[i] * pa_x[i] +
                         2.0 * ts_xx_xxxyz[i] * fz_0;

        tk_xx_xxxzz[i] = -2.0 * ts_0_xxxzz[i] * fbe_0 * fz_0 + tk_0_xxxzz[i] * fe_0 + 3.0 * tk_x_xxzz[i] * fe_0 + tk_x_xxxzz[i] * pa_x[i] +
                         2.0 * ts_xx_xxxzz[i] * fz_0;

        tk_xx_xxyyy[i] = -2.0 * ts_0_xxyyy[i] * fbe_0 * fz_0 + tk_0_xxyyy[i] * fe_0 + 2.0 * tk_x_xyyy[i] * fe_0 + tk_x_xxyyy[i] * pa_x[i] +
                         2.0 * ts_xx_xxyyy[i] * fz_0;

        tk_xx_xxyyz[i] = -2.0 * ts_0_xxyyz[i] * fbe_0 * fz_0 + tk_0_xxyyz[i] * fe_0 + 2.0 * tk_x_xyyz[i] * fe_0 + tk_x_xxyyz[i] * pa_x[i] +
                         2.0 * ts_xx_xxyyz[i] * fz_0;

        tk_xx_xxyzz[i] = -2.0 * ts_0_xxyzz[i] * fbe_0 * fz_0 + tk_0_xxyzz[i] * fe_0 + 2.0 * tk_x_xyzz[i] * fe_0 + tk_x_xxyzz[i] * pa_x[i] +
                         2.0 * ts_xx_xxyzz[i] * fz_0;

        tk_xx_xxzzz[i] = -2.0 * ts_0_xxzzz[i] * fbe_0 * fz_0 + tk_0_xxzzz[i] * fe_0 + 2.0 * tk_x_xzzz[i] * fe_0 + tk_x_xxzzz[i] * pa_x[i] +
                         2.0 * ts_xx_xxzzz[i] * fz_0;

        tk_xx_xyyyy[i] =
            -2.0 * ts_0_xyyyy[i] * fbe_0 * fz_0 + tk_0_xyyyy[i] * fe_0 + tk_x_yyyy[i] * fe_0 + tk_x_xyyyy[i] * pa_x[i] + 2.0 * ts_xx_xyyyy[i] * fz_0;

        tk_xx_xyyyz[i] =
            -2.0 * ts_0_xyyyz[i] * fbe_0 * fz_0 + tk_0_xyyyz[i] * fe_0 + tk_x_yyyz[i] * fe_0 + tk_x_xyyyz[i] * pa_x[i] + 2.0 * ts_xx_xyyyz[i] * fz_0;

        tk_xx_xyyzz[i] =
            -2.0 * ts_0_xyyzz[i] * fbe_0 * fz_0 + tk_0_xyyzz[i] * fe_0 + tk_x_yyzz[i] * fe_0 + tk_x_xyyzz[i] * pa_x[i] + 2.0 * ts_xx_xyyzz[i] * fz_0;

        tk_xx_xyzzz[i] =
            -2.0 * ts_0_xyzzz[i] * fbe_0 * fz_0 + tk_0_xyzzz[i] * fe_0 + tk_x_yzzz[i] * fe_0 + tk_x_xyzzz[i] * pa_x[i] + 2.0 * ts_xx_xyzzz[i] * fz_0;

        tk_xx_xzzzz[i] =
            -2.0 * ts_0_xzzzz[i] * fbe_0 * fz_0 + tk_0_xzzzz[i] * fe_0 + tk_x_zzzz[i] * fe_0 + tk_x_xzzzz[i] * pa_x[i] + 2.0 * ts_xx_xzzzz[i] * fz_0;
...
#pragma omp simd aligned(pa_y,            \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        tk_yy_xxxxy[i] =
            -2.0 * ts_0_xxxxy[i] * fbe_0 * fz_0 + tk_0_xxxxy[i] * fe_0 + tk_y_xxxx[i] * fe_0 + tk_y_xxxxy[i] * pa_y[i] + 2.0 * ts_yy_xxxxy[i] * fz_0;

        tk_yy_xxxxz[i] = -2.0 * ts_0_xxxxz[i] * fbe_0 * fz_0 + tk_0_xxxxz[i] * fe_0 + tk_y_xxxxz[i] * pa_y[i] + 2.0 * ts_yy_xxxxz[i] * fz_0;

        tk_yy_xxxyy[i] = -2.0 * ts_0_xxxyy[i] * fbe_0 * fz_0 + tk_0_xxxyy[i] * fe_0 + 2.0 * tk_y_xxxy[i] * fe_0 + tk_y_xxxyy[i] * pa_y[i] +
                         2.0 * ts_yy_xxxyy[i] * fz_0;

        tk_yy_xxxyz[i] =
            -2.0 * ts_0_xxxyz[i] * fbe_0 * fz_0 + tk_0_xxxyz[i] * fe_0 + tk_y_xxxz[i] * fe_0 + tk_y_xxxyz[i] * pa_y[i] + 2.0 * ts_yy_xxxyz[i] * fz_0;

        tk_yy_xxxzz[i] = -2.0 * ts_0_xxxzz[i] * fbe_0 * fz_0 + tk_0_xxxzz[i] * fe_0 + tk_y_xxxzz[i] * pa_y[i] + 2.0 * ts_yy_xxxzz[i] * fz_0;

        tk_yy_xxyyy[i] = -2.0 * ts_0_xxyyy[i] * fbe_0 * fz_0 + tk_0_xxyyy[i] * fe_0 + 3.0 * tk_y_xxyy[i] * fe_0 + tk_y_xxyyy[i] * pa_y[i] +
                         2.0 * ts_yy_xxyyy[i] * fz_0;

        tk_yy_xxyyz[i] = -2.0 * ts_0_xxyyz[i] * fbe_0 * fz_0 + tk_0_xxyyz[i] * fe_0 + 2.0 * tk_y_xxyz[i] * fe_0 + tk_y_xxyyz[i] * pa_y[i] +
                         2.0 * ts_yy_xxyyz[i] * fz_0;

        tk_yy_xxyzz[i] =
            -2.0 * ts_0_xxyzz[i] * fbe_0 * fz_0 + tk_0_xxyzz[i] * fe_0 + tk_y_xxzz[i] * fe_0 + tk_y_xxyzz[i] * pa_y[i] + 2.0 * ts_yy_xxyzz[i] * fz_0;

        tk_yy_xxzzz[i] = -2.0 * ts_0_xxzzz[i] * fbe_0 * fz_0 + tk_0_xxzzz[i] * fe_0 + tk_y_xxzzz[i] * pa_y[i] + 2.0 * ts_yy_xxzzz[i] * fz_0;

        tk_yy_xyyyy[i] = -2.0 * ts_0_xyyyy[i] * fbe_0 * fz_0 + tk_0_xyyyy[i] * fe_0 + 4.0 * tk_y_xyyy[i] * fe_0 + tk_y_xyyyy[i] * pa_y[i] +
                         2.0 * ts_yy_xyyyy[i] * fz_0;

        tk_yy_xyyyz[i] = -2.0 * ts_0_xyyyz[i] * fbe_0 * fz_0 + tk_0_xyyyz[i] * fe_0 + 3.0 * tk_y_xyyz[i] * fe_0 + tk_y_xyyyz[i] * pa_y[i] +
                         2.0 * ts_yy_xyyyz[i] * fz_0;

        tk_yy_xyyzz[i] = -2.0 * ts_0_xyyzz[i] * fbe_0 * fz_0 + tk_0_xyyzz[i] * fe_0 + 2.0 * tk_y_xyzz[i] * fe_0 + tk_y_xyyzz[i] * pa_y[i] +
                         2.0 * ts_yy_xyyzz[i] * fz_0;

        tk_yy_xyzzz[i] =
            -2.0 * ts_0_xyzzz[i] * fbe_0 * fz_0 + tk_0_xyzzz[i] * fe_0 + tk_y_xzzz[i] * fe_0 + tk_y_xyzzz[i] * pa_y[i] + 2.0 * ts_yy_xyzzz[i] * fz_0;

        tk_yy_xzzzz[i] = -2.0 * ts_0_xzzzz[i] * fbe_0 * fz_0 + tk_0_xzzzz[i] * fe_0 + tk_y_xzzzz[i] * pa_y[i] + 2.0 * ts_yy_xzzzz[i] * fz_0;

        tk_yy_yyyyy[i] = -2.0 * ts_0_yyyyy[i] * fbe_0 * fz_0 + tk_0_yyyyy[i] * fe_0 + 5.0 * tk_y_yyyy[i] * fe_0 + tk_y_yyyyy[i] * pa_y[i] +
                         2.0 * ts_yy_yyyyy[i] * fz_0;

        tk_yy_yyyyz[i] = -2.0 * ts_0_yyyyz[i] * fbe_0 * fz_0 + tk_0_yyyyz[i] * fe_0 + 4.0 * tk_y_yyyz[i] * fe_0 + tk_y_yyyyz[i] * pa_y[i] +
                         2.0 * ts_yy_yyyyz[i] * fz_0;

        tk_yy_yyyzz[i] = -2.0 * ts_0_yyyzz[i] * fbe_0 * fz_0 + tk_0_yyyzz[i] * fe_0 + 3.0 * tk_y_yyzz[i] * fe_0 + tk_y_yyyzz[i] * pa_y[i] +
                         2.0 * ts_yy_yyyzz[i] * fz_0;

        tk_yy_yyzzz[i] = -2.0 * ts_0_yyzzz[i] * fbe_0 * fz_0 + tk_0_yyzzz[i] * fe_0 + 2.0 * tk_y_yzzz[i] * fe_0 + tk_y_yyzzz[i] * pa_y[i] +
                         2.0 * ts_yy_yyzzz[i] * fz_0;

        tk_yy_yzzzz[i] =
            -2.0 * ts_0_yzzzz[i] * fbe_0 * fz_0 + tk_0_yzzzz[i] * fe_0 + tk_y_zzzz[i] * fe_0 + tk_y_yzzzz[i] * pa_y[i] + 2.0 * ts_yy_yzzzz[i] * fz_0;
...
#pragma omp simd aligned(pa_z,            \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        tk_zz_xxxxz[i] =
            -2.0 * ts_0_xxxxz[i] * fbe_0 * fz_0 + tk_0_xxxxz[i] * fe_0 + tk_z_xxxx[i] * fe_0 + tk_z_xxxxz[i] * pa_z[i] + 2.0 * ts_zz_xxxxz[i] * fz_0;

        tk_zz_xxxyy[i] = -2.0 * ts_0_xxxyy[i] * fbe_0 * fz_0 + tk_0_xxxyy[i] * fe_0 + tk_z_xxxyy[i] * pa_z[i] + 2.0 * ts_zz_xxxyy[i] * fz_0;

        tk_zz_xxxyz[i] =
            -2.0 * ts_0_xxxyz[i] * fbe_0 * fz_0 + tk_0_xxxyz[i] * fe_0 + tk_z_xxxy[i] * fe_0 + tk_z_xxxyz[i] * pa_z[i] + 2.0 * ts_zz_xxxyz[i] * fz_0;

        tk_zz_xxxzz[i] = -2.0 * ts_0_xxxzz[i] * fbe_0 * fz_0 + tk_0_xxxzz[i] * fe_0 + 2.0 * tk_z_xxxz[i] * fe_0 + tk_z_xxxzz[i] * pa_z[i] +
                         2.0 * ts_zz_xxxzz[i] * fz_0;

        tk_zz_xxyyy[i] = -2.0 * ts_0_xxyyy[i] * fbe_0 * fz_0 + tk_0_xxyyy[i] * fe_0 + tk_z_xxyyy[i] * pa_z[i] + 2.0 * ts_zz_xxyyy[i] * fz_0;

        tk_zz_xxyyz[i] =
            -2.0 * ts_0_xxyyz[i] * fbe_0 * fz_0 + tk_0_xxyyz[i] * fe_0 + tk_z_xxyy[i] * fe_0 + tk_z_xxyyz[i] * pa_z[i] + 2.0 * ts_zz_xxyyz[i] * fz_0;

        tk_zz_xxyzz[i] = -2.0 * ts_0_xxyzz[i] * fbe_0 * fz_0 + tk_0_xxyzz[i] * fe_0 + 2.0 * tk_z_xxyz[i] * fe_0 + tk_z_xxyzz[i] * pa_z[i] +
                         2.0 * ts_zz_xxyzz[i] * fz_0;

        tk_zz_xxzzz[i] = -2.0 * ts_0_xxzzz[i] * fbe_0 * fz_0 + tk_0_xxzzz[i] * fe_0 + 3.0 * tk_z_xxzz[i] * fe_0 + tk_z_xxzzz[i] * pa_z[i] +
                         2.0 * ts_zz_xxzzz[i] * fz_0;

        tk_zz_xyyyy[i] = -2.0 * ts_0_xyyyy[i] * fbe_0 * fz_0 + tk_0_xyyyy[i] * fe_0 + tk_z_xyyyy[i] * pa_z[i] + 2.0 * ts_zz_xyyyy[i] * fz_0;

        tk_zz_xyyyz[i] =
            -2.0 * ts_0_xyyyz[i] * fbe_0 * fz_0 + tk_0_xyyyz[i] * fe_0 + tk_z_xyyy[i] * fe_0 + tk_z_xyyyz[i] * pa_z[i] + 2.0 * ts_zz_xyyyz[i] * fz_0;

        tk_zz_xyyzz[i] = -2.0 * ts_0_xyyzz[i] * fbe_0 * fz_0 + tk_0_xyyzz[i] * fe_0 + 2.0 * tk_z_xyyz[i] * fe_0 + tk_z_xyyzz[i] * pa_z[i] +
                         2.0 * ts_zz_xyyzz[i] * fz_0;

        tk_zz_xyzzz[i] = -2.0 * ts_0_xyzzz[i] * fbe_0 * fz_0 + tk_0_xyzzz[i] * fe_0 + 3.0 * tk_z_xyzz[i] * fe_0 + tk_z_xyzzz[i] * pa_z[i] +
                         2.0 * ts_zz_xyzzz[i] * fz_0;

        tk_zz_xzzzz[i] = -2.0 * ts_0_xzzzz[i] * fbe_0 * fz_0 + tk_0_xzzzz[i] * fe_0 + 4.0 * tk_z_xzzz[i] * fe_0 + tk_z_xzzzz[i] * pa_z[i] +
                         2.0 * ts_zz_xzzzz[i] * fz_0;

        tk_zz_yyyyy[i] = -2.0 * ts_0_yyyyy[i] * fbe_0 * fz_0 + tk_0_yyyyy[i] * fe_0 + tk_z_yyyyy[i] * pa_z[i] + 2.0 * ts_zz_yyyyy[i] * fz_0;

        tk_zz_yyyyz[i] =
            -2.0 * ts_0_yyyyz[i] * fbe_0 * fz_0 + tk_0_yyyyz[i] * fe_0 + tk_z_yyyy[i] * fe_0 + tk_z_yyyyz[i] * pa_z[i] + 2.0 * ts_zz_yyyyz[i] * fz_0;

        tk_zz_yyyzz[i] = -2.0 * ts_0_yyyzz[i] * fbe_0 * fz_0 + tk_0_yyyzz[i] * fe_0 + 2.0 * tk_z_yyyz[i] * fe_0 + tk_z_yyyzz[i] * pa_z[i] +
                         2.0 * ts_zz_yyyzz[i] * fz_0;

        tk_zz_yyzzz[i] = -2.0 * ts_0_yyzzz[i] * fbe_0 * fz_0 + tk_0_yyzzz[i] * fe_0 + 3.0 * tk_z_yyzz[i] * fe_0 + tk_z_yyzzz[i] * pa_z[i] +
                         2.0 * ts_zz_yyzzz[i] * fz_0;

        tk_zz_yzzzz[i] = -2.0 * ts_0_yzzzz[i] * fbe_0 * fz_0 + tk_0_yzzzz[i] * fe_0 + 4.0 * tk_z_yzzz[i] * fe_0 + tk_z_yzzzz[i] * pa_z[i] +
                         2.0 * ts_zz_yzzzz[i] * fz_0;

        tk_zz_zzzzz[i] = -2.0 * ts_0_zzzzz[i] * fbe_0 * fz_0 + tk_0_zzzzz[i] * fe_0 + 5.0 * tk_z_zzzz[i] * fe_0 + tk_z_zzzzz[i] * pa_z[i] +
                         2.0 * ts_zz_zzzzz[i] * fz_0;
    }
}
