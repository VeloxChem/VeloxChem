yyz, ts_0_yyyyzz, ts_0_yyyzzz, ts_0_yyzzzz, ts_0_yzzzzz, ts_0_zzzzzz, ts_xx_xxxxxx, ts_xx_xxxxxy, ts_xx_xxxxxz, ts_xx_xxxxyy, ts_xx_xxxxyz, ts_xx_xxxxzz, ts_xx_xxxyyy, ts_xx_xxxyyz, ts_xx_xxxyzz, ts_xx_xxxzzz, ts_xx_xxyyyy, ts_xx_xxyyyz, ts_xx_xxyyzz, ts_xx_xxyzzz, ts_xx_xxzzzz, ts_xx_xyyyyy, ts_xx_xyyyyz, ts_xx_xyyyzz, ts_xx_xyyzzz, ts_xx_xyzzzz, ts_xx_xzzzzz, ts_xx_yyyyyy, ts_xx_yyyyyz, ts_xx_yyyyzz, ts_xx_yyyzzz, ts_xx_yyzzzz, ts_xx_yzzzzz, ts_xx_zzzzzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        tk_xx_xxxxxx[i] = -2.0 * ts_0_xxxxxx[i] * fbe_0 * fz_0 + tk_0_xxxxxx[i] * fe_0 + 6.0 * tk_x_xxxxx[i] * fe_0 + tk_x_xxxxxx[i] * pa_x[i] + 2.0 * ts_xx_xxxxxx[i] * fz_0;

        tk_xx_xxxxxy[i] = -2.0 * ts_0_xxxxxy[i] * fbe_0 * fz_0 + tk_0_xxxxxy[i] * fe_0 + 5.0 * tk_x_xxxxy[i] * fe_0 + tk_x_xxxxxy[i] * pa_x[i] + 2.0 * ts_xx_xxxxxy[i] * fz_0;

        tk_xx_xxxxxz[i] = -2.0 * ts_0_xxxxxz[i] * fbe_0 * fz_0 + tk_0_xxxxxz[i] * fe_0 + 5.0 * tk_x_xxxxz[i] * fe_0 + tk_x_xxxxxz[i] * pa_x[i] + 2.0 * ts_xx_xxxxxz[i] * fz_0;

        tk_xx_xxxxyy[i] = -2.0 * ts_0_xxxxyy[i] * fbe_0 * fz_0 + tk_0_xxxxyy[i] * fe_0 + 4.0 * tk_x_xxxyy[i] * fe_0 + tk_x_xxxxyy[i] * pa_x[i] + 2.0 * ts_xx_xxxxyy[i] * fz_0;

        tk_xx_xxxxyz[i] = -2.0 * ts_0_xxxxyz[i] * fbe_0 * fz_0 + tk_0_xxxxyz[i] * fe_0 + 4.0 * tk_x_xxxyz[i] * fe_0 + tk_x_xxxxyz[i] * pa_x[i] + 2.0 * ts_xx_xxxxyz[i] * fz_0;

        tk_xx_xxxxzz[i] = -2.0 * ts_0_xxxxzz[i] * fbe_0 * fz_0 + tk_0_xxxxzz[i] * fe_0 + 4.0 * tk_x_xxxzz[i] * fe_0 + tk_x_xxxxzz[i] * pa_x[i] + 2.0 * ts_xx_xxxxzz[i] * fz_0;

        tk_xx_xxxyyy[i] = -2.0 * ts_0_xxxyyy[i] * fbe_0 * fz_0 + tk_0_xxxyyy[i] * fe_0 + 3.0 * tk_x_xxyyy[i] * fe_0 + tk_x_xxxyyy[i] * pa_x[i] + 2.0 * ts_xx_xxxyyy[i] * fz_0;

        tk_xx_xxxyyz[i] = -2.0 * ts_0_xxxyyz[i] * fbe_0 * fz_0 + tk_0_xxxyyz[i] * fe_0 + 3.0 * tk_x_xxyyz[i] * fe_0 + tk_x_xxxyyz[i] * pa_x[i] + 2.0 * ts_xx_xxxyyz[i] * fz_0;

        tk_xx_xxxyzz[i] = -2.0 * ts_0_xxxyzz[i] * fbe_0 * fz_0 + tk_0_xxxyzz[i] * fe_0 + 3.0 * tk_x_xxyzz[i] * fe_0 + tk_x_xxxyzz[i] * pa_x[i] + 2.0 * ts_xx_xxxyzz[i] * fz_0;

        tk_xx_xxxzzz[i] = -2.0 * ts_0_xxxzzz[i] * fbe_0 * fz_0 + tk_0_xxxzzz[i] * fe_0 + 3.0 * tk_x_xxzzz[i] * fe_0 + tk_x_xxxzzz[i] * pa_x[i] + 2.0 * ts_xx_xxxzzz[i] * fz_0;

        tk_xx_xxyyyy[i] = -2.0 * ts_0_xxyyyy[i] * fbe_0 * fz_0 + tk_0_xxyyyy[i] * fe_0 + 2.0 * tk_x_xyyyy[i] * fe_0 + tk_x_xxyyyy[i] * pa_x[i] + 2.0 * ts_xx_xxyyyy[i] * fz_0;

        tk_xx_xxyyyz[i] = -2.0 * ts_0_xxyyyz[i] * fbe_0 * fz_0 + tk_0_xxyyyz[i] * fe_0 + 2.0 * tk_x_xyyyz[i] * fe_0 + tk_x_xxyyyz[i] * pa_x[i] + 2.0 * ts_xx_xxyyyz[i] * fz_0;

        tk_xx_xxyyzz[i] = -2.0 * ts_0_xxyyzz[i] * fbe_0 * fz_0 + tk_0_xxyyzz[i] * fe_0 + 2.0 * tk_x_xyyzz[i] * fe_0 + tk_x_xxyyzz[i] * pa_x[i] + 2.0 * ts_xx_xxyyzz[i] * fz_0;

        tk_xx_xxyzzz[i] = -2.0 * ts_0_xxyzzz[i] * fbe_0 * fz_0 + tk_0_xxyzzz[i] * fe_0 + 2.0 * tk_x_xyzzz[i] * fe_0 + tk_x_xxyzzz[i] * pa_x[i] + 2.0 * ts_xx_xxyzzz[i] * fz_0;

        tk_xx_xxzzzz[i] = -2.0 * ts_0_xxzzzz[i] * fbe_0 * fz_0 + tk_0_xxzzzz[i] * fe_0 + 2.0 * tk_x_xzzzz[i] * fe_0 + tk_x_xxzzzz[i] * pa_x[i] + 2.0 * ts_xx_xxzzzz[i] * fz_0;

        tk_xx_xyyyyy[i] = -2.0 * ts_0_xyyyyy[i] * fbe_0 * fz_0 + tk_0_xyyyyy[i] * fe_0 + tk_x_yyyyy[i] * fe_0 + tk_x_xyyyyy[i] * pa_x[i] + 2.0 * ts_xx_xyyyyy[i] * fz_0;

        tk_xx_xyyyyz[i] = -2.0 * ts_0_xyyyyz[i] * fbe_0 * fz_0 + tk_0_xyyyyz[i] * fe_0 + tk_x_yyyyz[i] * fe_0 + tk_x_xyyyyz[i] * pa_x[i] + 2.0 * ts_xx_xyyyyz[i] * fz_0;

        tk_xx_xyyyzz[i] = -2.0 * ts_0_xyyyzz[i] * fbe_0 * fz_0 + tk_0_xyyyzz[i] * fe_0 + tk_x_yyyzz[i] * fe_0 + tk_x_xyyyzz[i] * pa_x[i] + 2.0 * ts_xx_xyyyzz[i] * fz_0;

        tk_xx_xyyzzz[i] = -2.0 * ts_0_xyyzzz[i] * fbe_0 * fz_0 + tk_0_xyyzzz[i] * fe_0 + tk_x_yyzzz[i] * fe_0 + tk_x_xyyzzz[i] * pa_x[i] + 2.0 * ts_xx_xyyzzz[i] * fz_0;

        tk_xx_xyzzzz[i] = -2.0 * ts_0_xyzzzz[i] * fbe_0 * fz_0 + tk_0_xyzzzz[i] * fe_0 + tk_x_yzzzz[i] * fe_0 + tk_x_xyzzzz[i] * pa_x[i] + 2.0 * ts_xx_xyzzzz[i] * fz_0;

        tk_xx_xzzzzz[i] = -2.0 * ts_0_xzzzzz[i] * fbe_0 * fz_0 + tk_0_xzzzzz[i] * fe_0 + tk_x_zzzzz[i] * fe_0 + tk_x_xzzzzz[i] * pa_x[i] + 2.0 * ts_xx_xzzzzz[i] * fz_0;
    ...
    #pragma omp simd aligned(pa_x, pa_y, tk_x_xxxxxx, tk_x_xxxxxz, tk_x_xxxxzz, tk_x_xxxzzz, tk_x_xxzzzz, tk_x_xzzzzz, tk_xy_xxxxxx, tk_xy_xxxxxy, tk_xy_xxxxxz, tk_xy_xxxxyy, tk_xy_xxxxyz, tk_xy_xxxxzz, tk_xy_xxxyyy, tk_xy_xxxyyz, tk_xy_xxxyzz, tk_xy_xxxzzz, tk_xy_xxyyyy, tk_xy_xxyyyz, tk_xy_xxyyzz, tk_xy_xxyzzz, tk_xy_xxzzzz, tk_xy_xyyyyy, tk_xy_xyyyyz, tk_xy_xyyyzz, tk_xy_xyyzzz, tk_xy_xyzzzz, tk_xy_xzzzzz, tk_xy_yyyyyy, tk_xy_yyyyyz, tk_xy_yyyyzz, tk_xy_yyyzzz, tk_xy_yyzzzz, tk_xy_yzzzzz, tk_xy_zzzzzz, tk_y_xxxxxy, tk_y_xxxxy, tk_y_xxxxyy, tk_y_xxxxyz, tk_y_xxxyy, tk_y_xxxyyy, tk_y_xxxyyz, tk_y_xxxyz, tk_y_xxxyzz, tk_y_xxyyy, tk_y_xxyyyy, tk_y_xxyyyz, tk_y_xxyyz, tk_y_xxyyzz, tk_y_xxyzz, tk_y_xxyzzz, tk_y_xyyyy, tk_y_xyyyyy, tk_y_xyyyyz, tk_y_xyyyz, tk_y_xyyyzz, tk_y_xyyzz, tk_y_xyyzzz, tk_y_xyzzz, tk_y_xyzzzz, tk_y_yyyyy, tk_y_yyyyyy, tk_y_yyyyyz, tk_y_yyyyz, tk_y_yyyyzz, tk_y_yyyzz, tk_y_yyyzzz, tk_y_yyzzz, tk_y_yyzzzz, tk_y_yzzzz, tk_y_yzzzzz, tk_y_zzzzzz, ts_xy_xxxxxx, ts_xy_xxxxxy, ts_xy_xxxxxz, ts_xy_xxxxyy, ts_xy_xxxxyz, ts_xy_xxxxzz, ts_xy_xxxyyy, ts_xy_xxxyyz, ts_xy_xxxyzz, ts_xy_xxxzzz, ts_xy_xxyyyy, ts_xy_xxyyyz, ts_xy_xxyyzz, ts_xy_xxyzzz, ts_xy_xxzzzz, ts_xy_xyyyyy, ts_xy_xyyyyz, ts_xy_xyyyzz, ts_xy_xyyzzz, ts_xy_xyzzzz, ts_xy_xzzzzz, ts_xy_yyyyyy, ts_xy_yyyyyz, ts_xy_yyyyzz, ts_xy_yyyzzz, ts_xy_yyzzzz, ts_xy_yzzzzz, ts_xy_zzzzzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double fe_0 = 0.5 / (a_exp + b_exps[i]);
    ...
    #pragma omp simd aligned(pa_x, pa_z, tk
_yy_xxyyzz, ts_yy_xxyzzz, ts_yy_xxzzzz, ts_yy_xyyyyy, ts_yy_xyyyyz, ts_yy_xyyyzz, ts_yy_xyyzzz, ts_yy_xyzzzz, ts_yy_xzzzzz, ts_yy_yyyyyy, ts_yy_yyyyyz, ts_yy_yyyyzz, ts_yy_yyyzzz, ts_yy_yyzzzz, ts_yy_yzzzzz, ts_yy_zzzzzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double fe_0 = 0.5 / (a_exp + b_exps[i]);
        ...
        tk_yy_xxxxxy[i] = -2.0 * ts_0_xxxxxy[i] * fbe_0 * fz_0 + tk_0_xxxxxy[i] * fe_0 + tk_y_xxxxx[i] * fe_0 + tk_y_xxxxxy[i] * pa_y[i] + 2.0 * ts_yy_xxxxxy[i] * fz_0;

        tk_yy_xxxxxz[i] = -2.0 * ts_0_xxxxxz[i] * fbe_0 * fz_0 + tk_0_xxxxxz[i] * fe_0 + tk_y_xxxxxz[i] * pa_y[i] + 2.0 * ts_yy_xxxxxz[i] * fz_0;

        tk_yy_xxxxyy[i] = -2.0 * ts_0_xxxxyy[i] * fbe_0 * fz_0 + tk_0_xxxxyy[i] * fe_0 + 2.0 * tk_y_xxxxy[i] * fe_0 + tk_y_xxxxyy[i] * pa_y[i] + 2.0 * ts_yy_xxxxyy[i] * fz_0;

        tk_yy_xxxxyz[i] = -2.0 * ts_0_xxxxyz[i] * fbe_0 * fz_0 + tk_0_xxxxyz[i] * fe_0 + tk_y_xxxxz[i] * fe_0 + tk_y_xxxxyz[i] * pa_y[i] + 2.0 * ts_yy_xxxxyz[i] * fz_0;

        tk_yy_xxxxzz[i] = -2.0 * ts_0_xxxxzz[i] * fbe_0 * fz_0 + tk_0_xxxxzz[i] * fe_0 + tk_y_xxxxzz[i] * pa_y[i] + 2.0 * ts_yy_xxxxzz[i] * fz_0;

        tk_yy_xxxyyy[i] = -2.0 * ts_0_xxxyyy[i] * fbe_0 * fz_0 + tk_0_xxxyyy[i] * fe_0 + 3.0 * tk_y_xxxyy[i] * fe_0 + tk_y_xxxyyy[i] * pa_y[i] + 2.0 * ts_yy_xxxyyy[i] * fz_0;

        tk_yy_xxxyyz[i] = -2.0 * ts_0_xxxyyz[i] * fbe_0 * fz_0 + tk_0_xxxyyz[i] * fe_0 + 2.0 * tk_y_xxxyz[i] * fe_0 + tk_y_xxxyyz[i] * pa_y[i] + 2.0 * ts_yy_xxxyyz[i] * fz_0;

        tk_yy_xxxyzz[i] = -2.0 * ts_0_xxxyzz[i] * fbe_0 * fz_0 + tk_0_xxxyzz[i] * fe_0 + tk_y_xxxzz[i] * fe_0 + tk_y_xxxyzz[i] * pa_y[i] + 2.0 * ts_yy_xxxyzz[i] * fz_0;

        tk_yy_xxxzzz[i] = -2.0 * ts_0_xxxzzz[i] * fbe_0 * fz_0 + tk_0_xxxzzz[i] * fe_0 + tk_y_xxxzzz[i] * pa_y[i] + 2.0 * ts_yy_xxxzzz[i] * fz_0;

        tk_yy_xxyyyy[i] = -2.0 * ts_0_xxyyyy[i] * fbe_0 * fz_0 + tk_0_xxyyyy[i] * fe_0 + 4.0 * tk_y_xxyyy[i] * fe_0 + tk_y_xxyyyy[i] * pa_y[i] + 2.0 * ts_yy_xxyyyy[i] * fz_0;

        tk_yy_xxyyyz[i] = -2.0 * ts_0_xxyyyz[i] * fbe_0 * fz_0 + tk_0_xxyyyz[i] * fe_0 + 3.0 * tk_y_xxyyz[i] * fe_0 + tk_y_xxyyyz[i] * pa_y[i] + 2.0 * ts_yy_xxyyyz[i] * fz_0;

        tk_yy_xxyyzz[i] = -2.0 * ts_0_xxyyzz[i] * fbe_0 * fz_0 + tk_0_xxyyzz[i] * fe_0 + 2.0 * tk_y_xxyzz[i] * fe_0 + tk_y_xxyyzz[i] * pa_y[i] + 2.0 * ts_yy_xxyyzz[i] * fz_0;

        tk_yy_xxyzzz[i] = -2.0 * ts_0_xxyzzz[i] * fbe_0 * fz_0 + tk_0_xxyzzz[i] * fe_0 + tk_y_xxzzz[i] * fe_0 + tk_y_xxyzzz[i] * pa_y[i] + 2.0 * ts_yy_xxyzzz[i] * fz_0;

        tk_yy_xxzzzz[i] = -2.0 * ts_0_xxzzzz[i] * fbe_0 * fz_0 + tk_0_xxzzzz[i] * fe_0 + tk_y_xxzzzz[i] * pa_y[i] + 2.0 * ts_yy_xxzzzz[i] * fz_0;

        tk_yy_xyyyyy[i] = -2.0 * ts_0_xyyyyy[i] * fbe_0 * fz_0 + tk_0_xyyyyy[i] * fe_0 + 5.0 * tk_y_xyyyy[i] * fe_0 + tk_y_xyyyyy[i] * pa_y[i] + 2.0 * ts_yy_xyyyyy[i] * fz_0;

        tk_yy_xyyyyz[i] = -2.0 * ts_0_xyyyyz[i] * fbe_0 * fz_0 + tk_0_xyyyyz[i] * fe_0 + 4.0 * tk_y_xyyyz[i] * fe_0 + tk_y_xyyyyz[i] * pa_y[i] + 2.0 * ts_yy_xyyyyz[i] * fz_0;

        tk_yy_xyyyzz[i] = -2.0 * ts_0_xyyyzz[i] * fbe_0 * fz_0 + tk_0_xyyyzz[i] * fe_0 + 3.0 * tk_y_xyyzz[i] * fe_0 + tk_y_xyyyzz[i] * pa_y[i] + 2.0 * ts_yy_xyyyzz[i] * fz_0;

        tk_yy_xyyzzz[i] = -2.0 * ts_0_xyyzzz[i] * fbe_0 * fz_0 + tk_0_xyyzzz[i] * fe_0 + 2.0 * tk_y_xyzzz[i] * fe_0 + tk_y_xyyzzz[i] * pa_y[i] + 2.0 * ts_yy_xyyzzz[i] * fz_0;

        tk_yy_xyzzzz[i] = -2.0 * ts_0_xyzzzz[i] * fbe_0 * fz_0 + tk_0_xyzzzz[i] * fe_0 + tk_y_xzzzz[i] * fe_0 + tk_y_xyzzzz[i] * pa_y[i] + 2.0 * ts_yy_xyzzzz[i] * fz_0;

        tk_yy_xzzzzz[i] = -2.0 * ts_0_xzzzzz[i] * fbe_0 * fz_0 + tk_0_xzzzzz[i] * fe_0 + tk_y_xzzzzz[i] * pa_y[i] + 2.0 * ts_yy_xzzzzz[i] * fz_0;

        tk_yy_yyyyyy[i] = -2.0 * ts_0_yyyyyy[i] * fbe_0 * fz_0 + tk_0_yyyyyy[i] * fe_0 + 6.0 * tk_y_yyyyy[i] * fe_0 + tk_y_yyyyyy[i] * pa_y[i] + 2.0 * ts_yy_yyyyyy[i] * fz_0;

        tk_yy_yyyyyz[i] = -2.0 * ts_0_yyyyyz[i] * fbe_0 * fz_0 + tk_0_yyyyyz[i] * fe_0 + 5.0 * tk_y_yyyyz[i] * fe_0 + tk_y_yyyyyz[i] * pa_y[i] + 2.0 * ts_yy_yyyyyz[i] * fz_0;

        tk_yy_yyyyzz[i] = -2.0 * ts_0_yyyyzz[i] * fbe_0 * fz_0 + tk_0_yyyyzz[i] * fe_0 + 4.0 * tk_y_yyyzz[i] * fe_0 + tk_y_yyyyzz[i] * pa_y[i] + 2.0 * ts_yy_yyyyzz[i] * fz_0;

        tk_yy_yyyzzz[i] = -2.0 * ts_0_yyyzzz[i] * fbe_0 * fz_0 + tk_0_yyyzzz[i] * fe_0 + 3.0 * tk_y_yyzzz[i] * fe_0 + tk_y_yyyzzz[i] * pa_y[i] + 2.0 * ts_yy_yyyzzz[i] * fz_0;

        tk_yy_yyzzzz[i] = -2.0 * ts_0_yyzzzz[i] * fbe_0 * fz_0 + tk_0_yyzzzz[i] * fe_0 + 2.0 * tk_y_yzzzz[i] * fe_0 + tk_y_yyzzzz[i] * pa_y[i] + 2.0 * ts_yy_yyzzzz[i] * fz_0;

        tk_yy_yzzzzz[i] = -2.0 * ts_0_yzzzzz[i] * fbe_0 * fz_0 + tk_0_yzzzzz[i] * fe_0 + tk_y_zzzzz[i] * fe_0 + tk_y_yzzzzz[i] * pa_y[i] + 2.0 * ts_yy_yzzzzz[i] * fz_0;
    ...
    #pragma omp simd aligned(pa_y, pa_z, tk_y_xxxxxy, tk_y_xxxxyy, tk_y_xxxyyy, tk_y_xxyyyy, tk_y_xyyyyy, tk_y_yyyyyy, tk_yz_xxxxxx, tk_yz_xxxxxy, tk_yz_xxxxxz, tk_yz_xxxxyy, tk_yz_xxxxyz, tk_yz_xxxxzz, tk_yz_xxxyyy, tk_yz_xxxyyz, tk_yz_xxxyzz, tk_yz_xxxzzz, tk_yz_xxyyyy, tk_yz_xxyyyz, tk_yz_xxyyzz, tk_yz_xxyzzz, tk_yz_xxzzzz, tk_yz_xyyyyy, tk_yz_xyyyyz, tk_yz_xyyyzz, tk_yz_xyyzzz, tk_yz_xyzzzz, tk_yz_xzzzzz, tk_yz_yyyyyy, tk_yz_yyyyyz, tk_yz_yyyyzz, tk_yz_yyyzzz, tk_yz_yyzzzz, tk_yz_yzzzzz, tk_yz_zzzzzz, tk_z_xxxxxx, tk_z_xxxxxz, tk_z_xxxxyz, tk_z_xxxxz, tk_z_xxxxzz, tk_z_xxxyyz, tk_z_xxxyz, tk_z_xxxyzz, tk_z_xxxzz, tk_z_xxxzzz, tk_z_xxyyyz, tk_z_xxyyz, tk_z_xxyyzz, tk_z_xxyzz, tk_z_xxyzzz, tk_z_xxzzz, tk_z_xxzzzz, tk_z_xyyyyz, tk_z_xyyyz, tk_z_xyyyzz, tk_z_xyyzz, tk_z_xyyzzz, tk_z_xyzzz, tk_z_xyzzzz, tk_z_xzzzz, tk
_zz_xxyyyz, tk_zz_xxyyzz, tk_zz_xxyzzz, tk_zz_xxzzzz, tk_zz_xyyyyy, tk_zz_xyyyyz, tk_zz_xyyyzz, tk_zz_xyyzzz, tk_zz_xyzzzz, tk_zz_xzzzzz, tk_zz_yyyyyy, tk_zz_yyyyyz, tk_zz_yyyyzz, tk_zz_yyyzzz, tk_zz_yyzzzz, tk_zz_yzzzzz, tk_zz_zzzzzz, ts_0_xxxxxx, ts_0_xxxxxy, ts_0_xxxxxz, ts_0_xxxxyy, ts_0_xxxxyz, ts_0_xxxxzz, ts_0_xxxyyy, ts_0_xxxyyz, ts_0_xxxyzz, ts_0_xxxzzz, ts_0_xxyyyy, ts_0_xxyyyz, ts_0_xxyyzz, ts_0_xxyzzz, ts_0_xxzzzz, ts_0_xyyyyy, ts_0_xyyyyz, ts_0_xyyyzz, ts_0_xyyzzz, ts_0_xyzzzz, ts_0_xzzzzz, ts_0_yyyyyy, ts_0_yyyyyz, ts_0_yyyyzz, ts_0_yyyzzz, ts_0_yyzzzz, ts_0_yzzzzz, ts_0_zzzzzz, ts_zz_xxxxxx, ts_zz_xxxxxy, ts_zz_xxxxxz, ts_zz_xxxxyy, ts_zz_xxxxyz, ts_zz_xxxxzz, ts_zz_xxxyyy, ts_zz_xxxyyz, ts_zz_xxxyzz, ts_zz_xxxzzz, ts_zz_xxyyyy, ts_zz_xxyyyz, ts_zz_xxyyzz, ts_zz_xxyzzz, ts_zz_xxzzzz, ts_zz_xyyyyy, ts_zz_xyyyyz, ts_zz_xyyyzz, ts_zz_xyyzzz, ts_zz_xyzzzz, ts_zz_xzzzzz, ts_zz_yyyyyy, ts_zz_yyyyyz, ts_zz_yyyyzz, ts_zz_yyyzzz, ts_zz_yyzzzz, ts_zz_yzzzzz, ts_zz_zzzzzz, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        const double fe_0 = 0.5 / (a_exp + b_exps[i]);
        ...
        tk_zz_xxxxxz[i] = -2.0 * ts_0_xxxxxz[i] * fbe_0 * fz_0 + tk_0_xxxxxz[i] * fe_0 + tk_z_xxxxx[i] * fe_0 + tk_z_xxxxxz[i] * pa_z[i] + 2.0 * ts_zz_xxxxxz[i] * fz_0;

        tk_zz_xxxxyy[i] = -2.0 * ts_0_xxxxyy[i] * fbe_0 * fz_0 + tk_0_xxxxyy[i] * fe_0 + tk_z_xxxxyy[i] * pa_z[i] + 2.0 * ts_zz_xxxxyy[i] * fz_0;

        tk_zz_xxxxyz[i] = -2.0 * ts_0_xxxxyz[i] * fbe_0 * fz_0 + tk_0_xxxxyz[i] * fe_0 + tk_z_xxxxy[i] * fe_0 + tk_z_xxxxyz[i] * pa_z[i] + 2.0 * ts_zz_xxxxyz[i] * fz_0;

        tk_zz_xxxxzz[i] = -2.0 * ts_0_xxxxzz[i] * fbe_0 * fz_0 + tk_0_xxxxzz[i] * fe_0 + 2.0 * tk_z_xxxxz[i] * fe_0 + tk_z_xxxxzz[i] * pa_z[i] + 2.0 * ts_zz_xxxxzz[i] * fz_0;

        tk_zz_xxxyyy[i] = -2.0 * ts_0_xxxyyy[i] * fbe_0 * fz_0 + tk_0_xxxyyy[i] * fe_0 + tk_z_xxxyyy[i] * pa_z[i] + 2.0 * ts_zz_xxxyyy[i] * fz_0;

        tk_zz_xxxyyz[i] = -2.0 * ts_0_xxxyyz[i] * fbe_0 * fz_0 + tk_0_xxxyyz[i] * fe_0 + tk_z_xxxyy[i] * fe_0 + tk_z_xxxyyz[i] * pa_z[i] + 2.0 * ts_zz_xxxyyz[i] * fz_0;

        tk_zz_xxxyzz[i] = -2.0 * ts_0_xxxyzz[i] * fbe_0 * fz_0 + tk_0_xxxyzz[i] * fe_0 + 2.0 * tk_z_xxxyz[i] * fe_0 + tk_z_xxxyzz[i] * pa_z[i] + 2.0 * ts_zz_xxxyzz[i] * fz_0;

        tk_zz_xxxzzz[i] = -2.0 * ts_0_xxxzzz[i] * fbe_0 * fz_0 + tk_0_xxxzzz[i] * fe_0 + 3.0 * tk_z_xxxzz[i] * fe_0 + tk_z_xxxzzz[i] * pa_z[i] + 2.0 * ts_zz_xxxzzz[i] * fz_0;

        tk_zz_xxyyyy[i] = -2.0 * ts_0_xxyyyy[i] * fbe_0 * fz_0 + tk_0_xxyyyy[i] * fe_0 + tk_z_xxyyyy[i] * pa_z[i] + 2.0 * ts_zz_xxyyyy[i] * fz_0;

        tk_zz_xxyyyz[i] = -2.0 * ts_0_xxyyyz[i] * fbe_0 * fz_0 + tk_0_xxyyyz[i] * fe_0 + tk_z_xxyyy[i] * fe_0 + tk_z_xxyyyz[i] * pa_z[i] + 2.0 * ts_zz_xxyyyz[i] * fz_0;

        tk_zz_xxyyzz[i] = -2.0 * ts_0_xxyyzz[i] * fbe_0 * fz_0 + tk_0_xxyyzz[i] * fe_0 + 2.0 * tk_z_xxyyz[i] * fe_0 + tk_z_xxyyzz[i] * pa_z[i] + 2.0 * ts_zz_xxyyzz[i] * fz_0;

        tk_zz_xxyzzz[i] = -2.0 * ts_0_xxyzzz[i] * fbe_0 * fz_0 + tk_0_xxyzzz[i] * fe_0 + 3.0 * tk_z_xxyzz[i] * fe_0 + tk_z_xxyzzz[i] * pa_z[i] + 2.0 * ts_zz_xxyzzz[i] * fz_0;

        tk_zz_xxzzzz[i] = -2.0 * ts_0_xxzzzz[i] * fbe_0 * fz_0 + tk_0_xxzzzz[i] * fe_0 + 4.0 * tk_z_xxzzz[i] * fe_0 + tk_z_xxzzzz[i] * pa_z[i] + 2.0 * ts_zz_xxzzzz[i] * fz_0;

        tk_zz_xyyyyy[i] = -2.0 * ts_0_xyyyyy[i] * fbe_0 * fz_0 + tk_0_xyyyyy[i] * fe_0 + tk_z_xyyyyy[i] * pa_z[i] + 2.0 * ts_zz_xyyyyy[i] * fz_0;

        tk_zz_xyyyyz[i] = -2.0 * ts_0_xyyyyz[i] * fbe_0 * fz_0 + tk_0_xyyyyz[i] * fe_0 + tk_z_xyyyy[i] * fe_0 + tk_z_xyyyyz[i] * pa_z[i] + 2.0 * ts_zz_xyyyyz[i] * fz_0;

        tk_zz_xyyyzz[i] = -2.0 * ts_0_xyyyzz[i] * fbe_0 * fz_0 + tk_0_xyyyzz[i] * fe_0 + 2.0 * tk_z_xyyyz[i] * fe_0 + tk_z_xyyyzz[i] * pa_z[i] + 2.0 * ts_zz_xyyyzz[i] * fz_0;

        tk_zz_xyyzzz[i] = -2.0 * ts_0_xyyzzz[i] * fbe_0 * fz_0 + tk_0_xyyzzz[i] * fe_0 + 3.0 * tk_z_xyyzz[i] * fe_0 + tk_z_xyyzzz[i] * pa_z[i] + 2.0 * ts_zz_xyyzzz[i] * fz_0;

        tk_zz_xyzzzz[i] = -2.0 * ts_0_xyzzzz[i] * fbe_0 * fz_0 + tk_0_xyzzzz[i] * fe_0 + 4.0 * tk_z_xyzzz[i] * fe_0 + tk_z_xyzzzz[i] * pa_z[i] + 2.0 * ts_zz_xyzzzz[i] * fz_0;

        tk_zz_xzzzzz[i] = -2.0 * ts_0_xzzzzz[i] * fbe_0 * fz_0 + tk_0_xzzzzz[i] * fe_0 + 5.0 * tk_z_xzzzz[i] * fe_0 + tk_z_xzzzzz[i] * pa_z[i] + 2.0 * ts_zz_xzzzzz[i] * fz_0;

        tk_zz_yyyyyy[i] = -2.0 * ts_0_yyyyyy[i] * fbe_0 * fz_0 + tk_0_yyyyyy[i] * fe_0 + tk_z_yyyyyy[i] * pa_z[i] + 2.0 * ts_zz_yyyyyy[i] * fz_0;

        tk_zz_yyyyyz[i] = -2.0 * ts_0_yyyyyz[i] * fbe_0 * fz_0 + tk_0_yyyyyz[i] * fe_0 + tk_z_yyyyy[i] * fe_0 + tk_z_yyyyyz[i] * pa_z[i] + 2.0 * ts_zz_yyyyyz[i] * fz_0;

        tk_zz_yyyyzz[i] = -2.0 * ts_0_yyyyzz[i] * fbe_0 * fz_0 + tk_0_yyyyzz[i] * fe_0 + 2.0 * tk_z_yyyyz[i] * fe_0 + tk_z_yyyyzz[i] * pa_z[i] + 2.0 * ts_zz_yyyyzz[i] * fz_0;

        tk_zz_yyyzzz[i] = -2.0 * ts_0_yyyzzz[i] * fbe_0 * fz_0 + tk_0_yyyzzz[i] * fe_0 + 3.0 * tk_z_yyyzz[i] * fe_0 + tk_z_yyyzzz[i] * pa_z[i] + 2.0 * ts_zz_yyyzzz[i] * fz_0;

        tk_zz_yyzzzz[i] = -2.0 * ts_0_yyzzzz[i] * fbe_0 * fz_0 + tk_0_yyzzzz[i] * fe_0 + 4.0 * tk_z_yyzzz[i] * fe_0 + tk_z_yyzzzz[i] * pa_z[i] + 2.0 * ts_zz_yyzzzz[i] * fz_0;

        tk_zz_yzzzzz[i] = -2.0 * ts_0_yzzzzz[i] * fbe_0 * fz_0 + tk_0_yzzzzz[i] * fe_0 + 5.0 * tk_z_yzzzz[i] * fe_0 + tk_z_yzzzzz[i] * pa_z[i] + 2.0 * ts_zz_yzzzzz[i] * fz_0;

        tk_zz_zzzzzz[i] = -2.0 * ts_0_zzzzzz[i] * fbe_0 * fz_0 + tk_0_zzzzzz[i] * fe_0 + 6.0 * tk_z_zzzzz[i] * fe_0 + tk_z_zzzzzz[i] * pa_z[i] + 2.0 * ts_zz_zzzzzz[i] * fz_0;
    }
