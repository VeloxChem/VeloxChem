#ifndef ElectronRepulsionGeom1000RecSSSS_hpp
#define ElectronRepulsionGeom1000RecSSSS_hpp
...
template <class T>
auto
comp_electron_repulsion_geom1000_ssss(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1000_ssss(3, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1000_ssss(3, ket_dim);
    ...
    {
        cart_buffer_0_geom1000_ssss.zero();

        spher_buffer_0_geom1000_ssss.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1000_ssss_0(prim_buffer_0_geom1000_ssss, prim_buffer_0_psss, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom1000_ssss, prim_buffer_0_geom1000_ssss, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 0, 0, 0>(spher_buffer_0_geom1000_ssss, cart_spher_buffer_0_geom1000_ssss);

        distributor->distribute(spher_buffer_0_geom1000_ssss, a_indices, b_indices, c_indices, d_indices, 0, 0, 0, 0, 1, 0, 0, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom1000RecSSSS_hpp */
