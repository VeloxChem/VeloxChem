#ifndef ElectronRepulsionGeom1000RecPPPD_hpp
#define ElectronRepulsionGeom1000RecPPPD_hpp
...
template <class T>
auto
comp_electron_repulsion_geom1000_pppd(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1000_pppd(486, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1000_pppd(405, ket_dim);
    ...
    {
        cart_buffer_0_geom1000_pppd.zero();

        spher_buffer_0_geom1000_pppd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1000_pppd_0(prim_buffer_0_geom1000_pppd, prim_buffer_0_sppd, prim_buffer_0_dppd, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom1000_pppd, prim_buffer_0_geom1000_pppd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 1, 1, 2>(spher_buffer_0_geom1000_pppd, cart_spher_buffer_0_geom1000_pppd);

        distributor->distribute(spher_buffer_0_geom1000_pppd, a_indices, b_indices, c_indices, d_indices, 1, 1, 1, 2, 1, 0, 0, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom1000RecPPPD_hpp */
