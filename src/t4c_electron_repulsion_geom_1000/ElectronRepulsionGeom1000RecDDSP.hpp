#ifndef ElectronRepulsionGeom1000RecDDSP_hpp
#define ElectronRepulsionGeom1000RecDDSP_hpp
...
template <class T>
auto
comp_electron_repulsion_geom1000_ddsp(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1000_ddsp(324, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1000_ddsp(225, ket_dim);
    ...
    {
        cart_buffer_0_geom1000_ddsp.zero();

        spher_buffer_0_geom1000_ddsp.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1000_ddsp_0(prim_buffer_0_geom1000_ddsp, prim_buffer_0_pdsp, prim_buffer_0_fdsp, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom1000_ddsp, prim_buffer_0_geom1000_ddsp, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<2, 2, 0, 1>(spher_buffer_0_geom1000_ddsp, cart_spher_buffer_0_geom1000_ddsp);

        distributor->distribute(spher_buffer_0_geom1000_ddsp, a_indices, b_indices, c_indices, d_indices, 2, 2, 0, 1, 1, 0, 0, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom1000RecDDSP_hpp */
