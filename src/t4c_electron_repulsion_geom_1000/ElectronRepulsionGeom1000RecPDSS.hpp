#ifndef ElectronRepulsionGeom1000RecPDSS_hpp
#define ElectronRepulsionGeom1000RecPDSS_hpp
...
template <class T>
auto
comp_electron_repulsion_geom1000_pdss(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1000_pdss(54, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1000_pdss(45, ket_dim);
    ...
    {
        cart_buffer_0_geom1000_pdss.zero();

        spher_buffer_0_geom1000_pdss.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1000_pdss_0(prim_buffer_0_geom1000_pdss, prim_buffer_0_sdss, prim_buffer_0_ddss, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom1000_pdss, prim_buffer_0_geom1000_pdss, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 2, 0, 0>(spher_buffer_0_geom1000_pdss, cart_spher_buffer_0_geom1000_pdss);

        distributor->distribute(spher_buffer_0_geom1000_pdss, a_indices, b_indices, c_indices, d_indices, 1, 2, 0, 0, 1, 0, 0, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom1000RecPDSS_hpp */
