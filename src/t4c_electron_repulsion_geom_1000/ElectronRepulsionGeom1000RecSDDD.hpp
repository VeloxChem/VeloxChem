                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1000_sddd(648, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1000_sddd(375, ket_dim);
    ...
    {
        cart_buffer_0_geom1000_sddd.zero();

        spher_buffer_0_geom1000_sddd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1000_sddd_0(prim_buffer_0_geom1000_sddd, prim_buffer_0_pddd, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom1000_sddd, prim_buffer_0_geom1000_sddd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 2, 2, 2>(spher_buffer_0_geom1000_sddd, cart_spher_buffer_0_geom1000_sddd);

        distributor->distribute(spher_buffer_0_geom1000_sddd, a_indices, b_indices, c_indices, d_indices, 0, 2, 2, 2, 1, 0, 0, 0, i, ket_indices);
    }
}
