#ifndef ElectronRepulsionGeom1000RecPDPD_hpp
#define ElectronRepulsionGeom1000RecPDPD_hpp
...
template <class T>
auto
comp_electron_repulsion_geom1000_pdpd(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1000_pdpd(972, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1000_pdpd(675, ket_dim);
    ...
    {
        cart_buffer_0_geom1000_pdpd.zero();

        spher_buffer_0_geom1000_pdpd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1000_pdpd_0(prim_buffer_0_geom1000_pdpd, prim_buffer_0_sdpd, prim_buffer_0_ddpd, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom1000_pdpd, prim_buffer_0_geom1000_pdpd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 2, 1, 2>(spher_buffer_0_geom1000_pdpd, cart_spher_buffer_0_geom1000_pdpd);

        distributor->distribute(spher_buffer_0_geom1000_pdpd, a_indices, b_indices, c_indices, d_indices, 1, 2, 1, 2, 1, 0, 0, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom1000RecPDPD_hpp */
