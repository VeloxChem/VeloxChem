#ifndef ElectronRepulsionGeom1000RecPPDD_hpp
#define ElectronRepulsionGeom1000RecPPDD_hpp
...
template <class T>
auto
comp_electron_repulsion_geom1000_ppdd(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1000_ppdd(972, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1000_ppdd(675, ket_dim);
    ...
    {
        cart_buffer_0_geom1000_ppdd.zero();

        spher_buffer_0_geom1000_ppdd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1000_ppdd_0(prim_buffer_0_geom1000_ppdd, prim_buffer_0_spdd, prim_buffer_0_dpdd, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom1000_ppdd, prim_buffer_0_geom1000_ppdd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 1, 2, 2>(spher_buffer_0_geom1000_ppdd, cart_spher_buffer_0_geom1000_ppdd);

        distributor->distribute(spher_buffer_0_geom1000_ppdd, a_indices, b_indices, c_indices, d_indices, 1, 1, 2, 2, 1, 0, 0, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom1000RecPPDD_hpp */
