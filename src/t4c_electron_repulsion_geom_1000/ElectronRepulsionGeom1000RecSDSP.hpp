#ifndef ElectronRepulsionGeom1000RecSDSP_hpp
#define ElectronRepulsionGeom1000RecSDSP_hpp
...
template <class T>
auto
comp_electron_repulsion_geom1000_sdsp(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1000_sdsp(54, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1000_sdsp(45, ket_dim);
    ...
    {
        cart_buffer_0_geom1000_sdsp.zero();

        spher_buffer_0_geom1000_sdsp.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1000_sdsp_0(prim_buffer_0_geom1000_sdsp, prim_buffer_0_pdsp, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom1000_sdsp, prim_buffer_0_geom1000_sdsp, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 2, 0, 1>(spher_buffer_0_geom1000_sdsp, cart_spher_buffer_0_geom1000_sdsp);

        distributor->distribute(spher_buffer_0_geom1000_sdsp, a_indices, b_indices, c_indices, d_indices, 0, 2, 0, 1, 1, 0, 0, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom1000RecSDSP_hpp */
