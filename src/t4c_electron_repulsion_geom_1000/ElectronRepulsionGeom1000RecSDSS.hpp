...
template <class T>
auto
comp_electron_repulsion_geom1000_sdss(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1000_sdss(18, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1000_sdss(15, ket_dim);
    ...
    {
        cart_buffer_0_geom1000_sdss.zero();

        spher_buffer_0_geom1000_sdss.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1000_sdss_0(prim_buffer_0_geom1000_sdss, prim_buffer_0_pdss, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom1000_sdss, prim_buffer_0_geom1000_sdss, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 2, 0, 0>(spher_buffer_0_geom1000_sdss, cart_spher_buffer_0_geom1000_sdss);

        distributor->distribute(spher_buffer_0_geom1000_sdss, a_indices, b_indices, c_indices, d_indices, 0, 2, 0, 0, 1, 0, 0, 0, i, ket_indices);
    }
}
