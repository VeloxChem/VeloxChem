                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1000_ddpp(972, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1000_ddpp(675, ket_dim);
    ...
    {
        cart_buffer_0_geom1000_ddpp.zero();

        spher_buffer_0_geom1000_ddpp.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1000_ddpp_0(prim_buffer_0_geom1000_ddpp, prim_buffer_0_pdpp, prim_buffer_0_fdpp, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom1000_ddpp, prim_buffer_0_geom1000_ddpp, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<2, 2, 1, 1>(spher_buffer_0_geom1000_ddpp, cart_spher_buffer_0_geom1000_ddpp);

        distributor->distribute(spher_buffer_0_geom1000_ddpp, a_indices, b_indices, c_indices, d_indices, 2, 2, 1, 1, 1, 0, 0, 0, i, ket_indices);
    }
}
