#ifndef ElectronRepulsionGeom1000RecDDSS_hpp
#define ElectronRepulsionGeom1000RecDDSS_hpp

#include <array>

#include "ElectronRepulsionPrimRecDDSS.hpp"
#include "ElectronRepulsionPrimRecDPSS.hpp"
#include "ElectronRepulsionPrimRecFDSS.hpp"
...
template <class T>
auto
comp_electron_repulsion_geom1000_ddss(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> prim_buffer_2_psss(3, ket_pdim);

    CSimdArray<double> prim_buffer_0_ppss(9, ket_pdim);

    CSimdArray<double> prim_buffer_1_ppss(9, ket_pdim);

    CSimdArray<double> prim_buffer_2_ppss(9, ket_pdim);

    CSimdArray<double> prim_buffer_0_pdss(18, ket_pdim);

    CSimdArray<double> prim_buffer_1_pdss(18, ket_pdim);

    CSimdArray<double> prim_buffer_2_pdss(18, ket_pdim);

    CSimdArray<double> prim_buffer_0_dpss(18, ket_pdim);

    CSimdArray<double> prim_buffer_1_dpss(18, ket_pdim);

    CSimdArray<double> prim_buffer_0_ddss(36, ket_pdim);

    CSimdArray<double> prim_buffer_1_ddss(36, ket_pdim);

    CSimdArray<double> prim_buffer_0_fdss(60, ket_pdim);

    // allocate aligned Cartesian integrals

    CSimdArray<double> cart_buffer_0_geom1000_ddss(108, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1000_ddss(75, ket_dim);
    ...
    {
        cart_buffer_0_geom1000_ddss.zero();

        spher_buffer_0_geom1000_ddss.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            erirec::comp_prim_electron_repulsion_psss(prim_buffer_2_psss, prim_buffer_2_ssss, prim_buffer_3_ssss, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0]);

            erirec::comp_prim_electron_repulsion_ppss(prim_buffer_0_ppss, prim_buffer_0_ssss, prim_buffer_1_ssss, prim_buffer_0_spss, prim_buffer_1_spss, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_pdss(prim_buffer_0_pdss, prim_buffer_0_spss, prim_buffer_1_spss, prim_buffer_0_sdss, prim_buffer_1_sdss, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_dpss(prim_buffer_0_dpss, prim_buffer_0_spss, prim_buffer_1_spss, prim_buffer_0_psss, prim_buffer_1_psss, prim_buffer_0_ppss, prim_buffer_1_ppss, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);

            erirec::comp_prim_electron_repulsion_dpss(prim_buffer_1_dpss, prim_buffer_1_spss, prim_buffer_2_spss, prim_buffer_1_psss, prim_buffer_2_psss, prim_buffer_1_ppss, prim_buffer_2_ppss, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);

            erirec::comp_prim_electron_repulsion_ddss(prim_buffer_0_ddss, prim_buffer_0_sdss, prim_buffer_1_sdss, prim_buffer_0_ppss, prim_buffer_1_ppss, prim_buffer_0_pdss, prim_buffer_1_pdss, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            erirec::comp_prim_electron_repulsion_fdss(prim_buffer_0_fdss, prim_buffer_0_pdss, prim_buffer_1_pdss, prim_buffer_0_dpss, prim_buffer_1_dpss, prim_buffer_0_ddss, prim_buffer_1_ddss, pa_x, pa_y, pa_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);

            t4c_geom::comp_geom1000_ddss_0(prim_buffer_0_geom1000_ddss, prim_buffer_0_pdss, prim_buffer_0_fdss, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom1000_ddss, prim_buffer_0_geom1000_ddss, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<2, 2, 0, 0>(spher_buffer_0_geom1000_ddss, cart_spher_buffer_0_geom1000_ddss);

        distributor->distribute(spher_buffer_0_geom1000_ddss, a_indices, b_indices, c_indices, d_indices, 2, 2, 0, 0, 1, 0, 0, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom1000RecDDSS_hpp */
