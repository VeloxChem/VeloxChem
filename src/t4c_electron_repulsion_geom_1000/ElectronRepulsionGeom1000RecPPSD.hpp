                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1000_ppsd(162, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1000_ppsd(135, ket_dim);
    ...
    {
        cart_buffer_0_geom1000_ppsd.zero();

        spher_buffer_0_geom1000_ppsd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1000_ppsd_0(prim_buffer_0_geom1000_ppsd, prim_buffer_0_spsd, prim_buffer_0_dpsd, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom1000_ppsd, prim_buffer_0_geom1000_ppsd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 1, 0, 2>(spher_buffer_0_geom1000_ppsd, cart_spher_buffer_0_geom1000_ppsd);

        distributor->distribute(spher_buffer_0_geom1000_ppsd, a_indices, b_indices, c_indices, d_indices, 1, 1, 0, 2, 1, 0, 0, 0, i, ket_indices);
    }
}
