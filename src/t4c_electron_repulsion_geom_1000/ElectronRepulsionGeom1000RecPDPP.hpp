                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1000_pdpp(486, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1000_pdpp(405, ket_dim);
    ...
    {
        cart_buffer_0_geom1000_pdpp.zero();

        spher_buffer_0_geom1000_pdpp.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1000_pdpp_0(prim_buffer_0_geom1000_pdpp, prim_buffer_0_sdpp, prim_buffer_0_ddpp, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom1000_pdpp, prim_buffer_0_geom1000_pdpp, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 2, 1, 1>(spher_buffer_0_geom1000_pdpp, cart_spher_buffer_0_geom1000_pdpp);

        distributor->distribute(spher_buffer_0_geom1000_pdpp, a_indices, b_indices, c_indices, d_indices, 1, 2, 1, 1, 1, 0, 0, 0, i, ket_indices);
    }
}
