                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1000_pdsd(324, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1000_pdsd(225, ket_dim);
    ...
    {
        cart_buffer_0_geom1000_pdsd.zero();

        spher_buffer_0_geom1000_pdsd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1000_pdsd_0(prim_buffer_0_geom1000_pdsd, prim_buffer_0_sdsd, prim_buffer_0_ddsd, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom1000_pdsd, prim_buffer_0_geom1000_pdsd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 2, 0, 2>(spher_buffer_0_geom1000_pdsd, cart_spher_buffer_0_geom1000_pdsd);

        distributor->distribute(spher_buffer_0_geom1000_pdsd, a_indices, b_indices, c_indices, d_indices, 1, 2, 0, 2, 1, 0, 0, 0, i, ket_indices);
    }
}
