#ifndef ElectronRepulsionGeom1000RecSSSP_hpp
#define ElectronRepulsionGeom1000RecSSSP_hpp
...
template <class T>
auto
comp_electron_repulsion_geom1000_sssp(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1000_sssp(9, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1000_sssp(9, ket_dim);
    ...
    {
        cart_buffer_0_geom1000_sssp.zero();

        spher_buffer_0_geom1000_sssp.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1000_sssp_0(prim_buffer_0_geom1000_sssp, prim_buffer_0_pssp, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom1000_sssp, prim_buffer_0_geom1000_sssp, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 0, 0, 1>(spher_buffer_0_geom1000_sssp, cart_spher_buffer_0_geom1000_sssp);

        distributor->distribute(spher_buffer_0_geom1000_sssp, a_indices, b_indices, c_indices, d_indices, 0, 0, 0, 1, 1, 0, 0, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom1000RecSSSP_hpp */
