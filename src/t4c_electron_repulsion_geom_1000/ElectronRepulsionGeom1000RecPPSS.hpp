...
template <class T>
auto
comp_electron_repulsion_geom1000_ppss(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1000_ppss(27, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1000_ppss(27, ket_dim);
    ...
    {
        cart_buffer_0_geom1000_ppss.zero();

        spher_buffer_0_geom1000_ppss.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1000_ppss_0(prim_buffer_0_geom1000_ppss, prim_buffer_0_spss, prim_buffer_0_dpss, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom1000_ppss, prim_buffer_0_geom1000_ppss, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<1, 1, 0, 0>(spher_buffer_0_geom1000_ppss, cart_spher_buffer_0_geom1000_ppss);

        distributor->distribute(spher_buffer_0_geom1000_ppss, a_indices, b_indices, c_indices, d_indices, 1, 1, 0, 0, 1, 0, 0, 0, i, ket_indices);
    }
}
