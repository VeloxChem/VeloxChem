#ifndef ElectronRepulsionGeom1000RecSDPD_hpp
#define ElectronRepulsionGeom1000RecSDPD_hpp
...
template <class T>
auto
comp_electron_repulsion_geom1000_sdpd(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1000_sdpd(324, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1000_sdpd(225, ket_dim);
    ...
    {
        cart_buffer_0_geom1000_sdpd.zero();

        spher_buffer_0_geom1000_sdpd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1000_sdpd_0(prim_buffer_0_geom1000_sdpd, prim_buffer_0_pdpd, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom1000_sdpd, prim_buffer_0_geom1000_sdpd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 2, 1, 2>(spher_buffer_0_geom1000_sdpd, cart_spher_buffer_0_geom1000_sdpd);

        distributor->distribute(spher_buffer_0_geom1000_sdpd, a_indices, b_indices, c_indices, d_indices, 0, 2, 1, 2, 1, 0, 0, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom1000RecSDPD_hpp */
