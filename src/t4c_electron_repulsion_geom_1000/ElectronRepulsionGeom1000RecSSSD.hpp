                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1000_sssd(18, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1000_sssd(15, ket_dim);
    ...
    {
        cart_buffer_0_geom1000_sssd.zero();

        spher_buffer_0_geom1000_sssd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1000_sssd_0(prim_buffer_0_geom1000_sssd, prim_buffer_0_pssd, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom1000_sssd, prim_buffer_0_geom1000_sssd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 0, 0, 2>(spher_buffer_0_geom1000_sssd, cart_spher_buffer_0_geom1000_sssd);

        distributor->distribute(spher_buffer_0_geom1000_sssd, a_indices, b_indices, c_indices, d_indices, 0, 0, 0, 2, 1, 0, 0, 0, i, ket_indices);
    }
}
