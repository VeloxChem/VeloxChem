#ifndef ElectronRepulsionGeom1000RecSPDD_hpp
#define ElectronRepulsionGeom1000RecSPDD_hpp
...
template <class T>
auto
comp_electron_repulsion_geom1000_spdd(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1000_spdd(324, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1000_spdd(225, ket_dim);
    ...
    {
        cart_buffer_0_geom1000_spdd.zero();

        spher_buffer_0_geom1000_spdd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1000_spdd_0(prim_buffer_0_geom1000_spdd, prim_buffer_0_ppdd, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom1000_spdd, prim_buffer_0_geom1000_spdd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 1, 2, 2>(spher_buffer_0_geom1000_spdd, cart_spher_buffer_0_geom1000_spdd);

        distributor->distribute(spher_buffer_0_geom1000_spdd, a_indices, b_indices, c_indices, d_indices, 0, 1, 2, 2, 1, 0, 0, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom1000RecSPDD_hpp */
