                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1000_sspd(54, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1000_sspd(45, ket_dim);
    ...
    {
        cart_buffer_0_geom1000_sspd.zero();

        spher_buffer_0_geom1000_sspd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1000_sspd_0(prim_buffer_0_geom1000_sspd, prim_buffer_0_pspd, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom1000_sspd, prim_buffer_0_geom1000_sspd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 0, 1, 2>(spher_buffer_0_geom1000_sspd, cart_spher_buffer_0_geom1000_sspd);

        distributor->distribute(spher_buffer_0_geom1000_sspd, a_indices, b_indices, c_indices, d_indices, 0, 0, 1, 2, 1, 0, 0, 0, i, ket_indices);
    }
}
