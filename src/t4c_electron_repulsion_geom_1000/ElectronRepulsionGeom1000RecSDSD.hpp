#ifndef ElectronRepulsionGeom1000RecSDSD_hpp
#define ElectronRepulsionGeom1000RecSDSD_hpp
...
template <class T>
auto
comp_electron_repulsion_geom1000_sdsd(T* distributor,
                                      ...
                                      const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_geom1000_sdsd(108, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_geom1000_sdsd(75, ket_dim);
    ...
    {
        cart_buffer_0_geom1000_sdsd.zero();

        spher_buffer_0_geom1000_sdsd.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t4c_geom::comp_geom1000_sdsd_0(prim_buffer_0_geom1000_sdsd, prim_buffer_0_pdsd, a_exp );

            t2cfunc::reduce(cart_buffer_0_geom1000_sdsd, prim_buffer_0_geom1000_sdsd, ket_dim, ket_npgtos);
        }

        t4cfunc::full_transform<0, 2, 0, 2>(spher_buffer_0_geom1000_sdsd, cart_spher_buffer_0_geom1000_sdsd);

        distributor->distribute(spher_buffer_0_geom1000_sdsd, a_indices, b_indices, c_indices, d_indices, 0, 2, 0, 2, 1, 0, 0, 0, i, ket_indices);
    }
}

} // erirec namespace

#endif /* ElectronRepulsionGeom1000RecSDSD_hpp */
