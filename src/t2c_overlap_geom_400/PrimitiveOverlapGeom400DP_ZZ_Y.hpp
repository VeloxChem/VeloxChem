#ifndef PrimitiveOverlapGeom400DP_ZZ_Y
#define PrimitiveOverlapGeom400DP_ZZ_Y
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)D_ZZ|1|P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom400DP_ZZ_Y(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400DP_ZZ_Y */
