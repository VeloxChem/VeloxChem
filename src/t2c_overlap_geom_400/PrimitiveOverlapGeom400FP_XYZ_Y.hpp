#ifndef PrimitiveOverlapGeom400FP_XYZ_Y
#define PrimitiveOverlapGeom400FP_XYZ_Y
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)F_XYZ|1|P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom400FP_XYZ_Y(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400FP_XYZ_Y */
