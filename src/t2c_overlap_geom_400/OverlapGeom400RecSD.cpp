#include "OverlapGeom400RecSD.hpp"
...
auto
compOverlapGeom400SD(CSubMatrix*      matrix_xxxx,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom400SD_0_XX(buffer_xxxx,
                                                               buffer_xxxy,
                                                               buffer_xxxz,
                                                               buffer_xxyy,
                                                               buffer_xxyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom400SD_0_XY(buffer_xxxx,
                                                               buffer_xxxy,
                                                               buffer_xxxz,
                                                               buffer_xxyy,
                                                               buffer_xxyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom400SD_0_XZ(buffer_xxxx,
                                                               buffer_xxxy,
                                                               buffer_xxxz,
                                                               buffer_xxyy,
                                                               buffer_xxyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom400SD_0_YY(buffer_xxxx,
                                                               buffer_xxxy,
                                                               buffer_xxxz,
                                                               buffer_xxyy,
                                                               buffer_xxyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom400SD_0_YZ(buffer_xxxx,
                                                               buffer_xxxy,
                                                               buffer_xxxz,
                                                               buffer_xxyy,
                                                               buffer_xxyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom400SD_0_ZZ(buffer_xxxx,
                                                               buffer_xxxy,
                                                               buffer_xxxz,
                                                               buffer_xxyy,
                                                               buffer_xxyz,
