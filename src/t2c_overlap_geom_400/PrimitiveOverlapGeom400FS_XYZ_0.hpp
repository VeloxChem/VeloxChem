#ifndef PrimitiveOverlapGeom400FS_XYZ_0
#define PrimitiveOverlapGeom400FS_XYZ_0
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)F_XYZ|1|S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom400FS_XYZ_0(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400FS_XYZ_0 */
