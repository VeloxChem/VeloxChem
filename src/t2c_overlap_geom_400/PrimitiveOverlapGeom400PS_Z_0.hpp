#ifndef PrimitiveOverlapGeom400PS_Z_0
#define PrimitiveOverlapGeom400PS_Z_0
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_Z|1|S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom400PS_Z_0(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PS_Z_0 */
