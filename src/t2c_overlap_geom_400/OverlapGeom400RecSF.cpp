#include "OverlapGeom400RecSF.hpp"

#include <cmath>

#include "BatchFunc.hpp"
#include "PrimitiveOverlapGeom400SF_0_XXX.hpp"
#include "PrimitiveOverlapGeom400SF_0_XXY.hpp"
#include "PrimitiveOverlapGeom400SF_0_XXZ.hpp"
#include "PrimitiveOverlapGeom400SF_0_XYY.hpp"
#include "PrimitiveOverlapGeom400SF_0_XYZ.hpp"
#include "PrimitiveOverlapGeom400SF_0_XZZ.hpp"
#include "PrimitiveOverlapGeom400SF_0_YYY.hpp"
#include "PrimitiveOverlapGeom400SF_0_YYZ.hpp"
...
auto
compOverlapGeom400SF(CSubMatrix*      matrix_xxxx,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom400SF_0_XXX(buffer_xxxx,
                                                                buffer_xxxy,
                                                                buffer_xxxz,
                                                                buffer_xxyy,
                                                                buffer_xxyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom400SF_0_XXY(buffer_xxxx,
                                                                buffer_xxxy,
                                                                buffer_xxxz,
                                                                buffer_xxyy,
                                                                buffer_xxyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom400SF_0_XXZ(buffer_xxxx,
                                                                buffer_xxxy,
                                                                buffer_xxxz,
                                                                buffer_xxyy,
                                                                buffer_xxyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom400SF_0_XYY(buffer_xxxx,
                                                                buffer_xxxy,
                                                                buffer_xxxz,
                                                                buffer_xxyy,
                                                                buffer_xxyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom400SF_0_XYZ(buffer_xxxx,
                                                                buffer_xxxy,
                                                                buffer_xxxz,
                                                                buffer_xxyy,
                                                                buffer_xxyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom400SF_0_XZZ(buffer_xxxx,
                                                                buffer_xxxy,
                                                                buffer_xxxz,
                                                                buffer_xxyy,
                                                                buffer_xxyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom400SF_0_YYY(buffer_xxxx,
                                                                buffer_xxxy,
                                                                buffer_xxxz,
                                                                buffer_xxyy,
                                                                buffer_xxyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom400SF_0_YYZ(buffer_xxxx,
                                                                buffer_xxxy,
                                                                buffer_xxxz,
                                                                buffer_xxyy,
                                                                buffer_xxyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom400SF_0_YZZ(buffer_xxxx,
                                                                buffer_xxxy,
                                                                buffer_xxxz,
                                                                buffer_xxyy,
                                                                buffer_xxyz,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom400SF_0_ZZZ(buffer_xxxx,
                                                                buffer_xxxy,
                                                                buffer_xxxz,
                                                                buffer_xxyy,
                                                                buffer_xxyz,
