#ifndef PrimitiveOverlapGeom400DP_YY_Y
#define PrimitiveOverlapGeom400DP_YY_Y
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)D_YY|1|P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom400DP_YY_Y(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400DP_YY_Y */
