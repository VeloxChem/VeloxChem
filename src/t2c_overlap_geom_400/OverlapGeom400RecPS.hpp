#ifndef OverlapGeom400RecPS_hpp
#define OverlapGeom400RecPS_hpp
...
/**
 Evaluates <d^(4)/dA^(4)P|1|S>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom400PS(CSubMatrix*      matrix_xxxx,
