#ifndef OverlapGeom400RecSD_hpp
#define OverlapGeom400RecSD_hpp
...
/**
 Evaluates <d^(4)/dA^(4)S|1|D>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom400SD(CSubMatrix*      matrix_xxxx,
