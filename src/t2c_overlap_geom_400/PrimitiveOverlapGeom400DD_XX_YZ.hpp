#ifndef PrimitiveOverlapGeom400DD_XX_YZ
#define PrimitiveOverlapGeom400DD_XX_YZ
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)D_XX|1|D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom400DD_XX_YZ(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400DD_XX_YZ */
