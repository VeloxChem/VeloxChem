#ifndef PrimitiveOverlapGeom400DD_XX_YY
#define PrimitiveOverlapGeom400DD_XX_YY
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)D_XX|1|D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom400DD_XX_YY(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400DD_XX_YY */
