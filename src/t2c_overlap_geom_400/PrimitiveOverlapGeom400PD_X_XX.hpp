#ifndef PrimitiveOverlapGeom400PD_X_XX
#define PrimitiveOverlapGeom400PD_X_XX
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_X|1|D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom400PD_X_XX(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PD_X_XX */
