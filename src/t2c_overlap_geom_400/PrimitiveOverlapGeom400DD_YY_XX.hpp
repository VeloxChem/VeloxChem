#ifndef PrimitiveOverlapGeom400DD_YY_XX
#define PrimitiveOverlapGeom400DD_YY_XX
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)D_YY|1|D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom400DD_YY_XX(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400DD_YY_XX */
