#ifndef PrimitiveOverlapGeom400FP_XXX_Z
#define PrimitiveOverlapGeom400FP_XXX_Z
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)F_XXX|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom400FP_XXX_Z(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400FP_XXX_Z */
