#ifndef PrimitiveOverlapGeom400PF_Z_XXZ
#define PrimitiveOverlapGeom400PF_Z_XXZ
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_Z|1|F_XXZ> integrals.
...
*/
auto compPrimitiveOverlapGeom400PF_Z_XXZ(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PF_Z_XXZ */
