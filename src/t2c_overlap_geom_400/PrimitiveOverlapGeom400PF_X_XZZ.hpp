#ifndef PrimitiveOverlapGeom400PF_X_XZZ
#define PrimitiveOverlapGeom400PF_X_XZZ
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_X|1|F_XZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom400PF_X_XZZ(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PF_X_XZZ */
