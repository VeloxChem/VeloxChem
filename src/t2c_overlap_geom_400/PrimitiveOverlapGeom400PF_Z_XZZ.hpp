#ifndef PrimitiveOverlapGeom400PF_Z_XZZ
#define PrimitiveOverlapGeom400PF_Z_XZZ
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_Z|1|F_XZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom400PF_Z_XZZ(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PF_Z_XZZ */
