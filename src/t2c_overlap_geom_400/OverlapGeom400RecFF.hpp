#ifndef OverlapGeom400RecFF_hpp
#define OverlapGeom400RecFF_hpp
...
/**
 Evaluates <d^(4)/dA^(4)F|1|F>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom400FF(CSubMatrix*      matrix_xxxx,
