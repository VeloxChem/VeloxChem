#ifndef PrimitiveOverlapGeom400PD_Z_YZ
#define PrimitiveOverlapGeom400PD_Z_YZ
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_Z|1|D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom400PD_Z_YZ(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PD_Z_YZ */
