#ifndef OverlapGeom400RecPD_hpp
#define OverlapGeom400RecPD_hpp
...
/**
 Evaluates <d^(4)/dA^(4)P|1|D>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom400PD(CSubMatrix*      matrix_xxxx,
