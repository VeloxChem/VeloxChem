#ifndef PrimitiveOverlapGeom400PD_X_YY
#define PrimitiveOverlapGeom400PD_X_YY
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_X|1|D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom400PD_X_YY(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PD_X_YY */
