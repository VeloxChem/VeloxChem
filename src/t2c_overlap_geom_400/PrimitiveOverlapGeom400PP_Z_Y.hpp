#ifndef PrimitiveOverlapGeom400PP_Z_Y
#define PrimitiveOverlapGeom400PP_Z_Y
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_Z|1|P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom400PP_Z_Y(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PP_Z_Y */
