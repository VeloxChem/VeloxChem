#ifndef PrimitiveOverlapGeom400DP_XY_Z
#define PrimitiveOverlapGeom400DP_XY_Z
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)D_XY|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom400DP_XY_Z(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400DP_XY_Z */
