#ifndef PrimitiveOverlapGeom400PS_X_0
#define PrimitiveOverlapGeom400PS_X_0
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_X|1|S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom400PS_X_0(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PS_X_0 */
