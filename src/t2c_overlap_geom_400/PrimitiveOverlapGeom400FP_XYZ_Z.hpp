#ifndef PrimitiveOverlapGeom400FP_XYZ_Z
#define PrimitiveOverlapGeom400FP_XYZ_Z
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)F_XYZ|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom400FP_XYZ_Z(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400FP_XYZ_Z */
