#ifndef PrimitiveOverlapGeom400PF_Y_ZZZ
#define PrimitiveOverlapGeom400PF_Y_ZZZ
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_Y|1|F_ZZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom400PF_Y_ZZZ(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PF_Y_ZZZ */
