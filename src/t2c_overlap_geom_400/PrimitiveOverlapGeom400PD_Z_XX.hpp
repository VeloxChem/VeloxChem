#ifndef PrimitiveOverlapGeom400PD_Z_XX
#define PrimitiveOverlapGeom400PD_Z_XX
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_Z|1|D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom400PD_Z_XX(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PD_Z_XX */
