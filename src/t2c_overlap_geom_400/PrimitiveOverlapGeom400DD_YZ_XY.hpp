#ifndef PrimitiveOverlapGeom400DD_YZ_XY
#define PrimitiveOverlapGeom400DD_YZ_XY
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)D_YZ|1|D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom400DD_YZ_XY(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400DD_YZ_XY */
