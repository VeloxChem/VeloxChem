#ifndef PrimitiveOverlapGeom400PP_X_Z
#define PrimitiveOverlapGeom400PP_X_Z
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_X|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom400PP_X_Z(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PP_X_Z */
