#ifndef PrimitiveOverlapGeom400PD_Y_YY
#define PrimitiveOverlapGeom400PD_Y_YY
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_Y|1|D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom400PD_Y_YY(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PD_Y_YY */
