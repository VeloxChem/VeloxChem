#ifndef PrimitiveOverlapGeom400PP_Y_X
#define PrimitiveOverlapGeom400PP_Y_X
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_Y|1|P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom400PP_Y_X(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PP_Y_X */
