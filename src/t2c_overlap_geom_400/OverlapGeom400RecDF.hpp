#ifndef OverlapGeom400RecDF_hpp
#define OverlapGeom400RecDF_hpp
...
/**
 Evaluates <d^(4)/dA^(4)D|1|F>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom400DF(CSubMatrix*      matrix_xxxx,
