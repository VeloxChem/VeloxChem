#ifndef PrimitiveOverlapGeom400FP_XXX_Y
#define PrimitiveOverlapGeom400FP_XXX_Y
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)F_XXX|1|P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom400FP_XXX_Y(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400FP_XXX_Y */
