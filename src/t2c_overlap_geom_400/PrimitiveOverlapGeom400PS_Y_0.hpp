#ifndef PrimitiveOverlapGeom400PS_Y_0
#define PrimitiveOverlapGeom400PS_Y_0
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_Y|1|S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom400PS_Y_0(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PS_Y_0 */
