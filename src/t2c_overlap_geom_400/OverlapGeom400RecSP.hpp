#ifndef OverlapGeom400RecSP_hpp
#define OverlapGeom400RecSP_hpp
...
/**
 Evaluates <d^(4)/dA^(4)S|1|P>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom400SP(CSubMatrix*      matrix_xxxx,
