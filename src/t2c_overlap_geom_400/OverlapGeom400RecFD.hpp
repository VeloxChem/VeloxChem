#ifndef OverlapGeom400RecFD_hpp
#define OverlapGeom400RecFD_hpp
...
/**
 Evaluates <d^(4)/dA^(4)F|1|D>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom400FD(CSubMatrix*      matrix_xxxx,
