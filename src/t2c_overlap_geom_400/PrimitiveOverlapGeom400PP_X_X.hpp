#ifndef PrimitiveOverlapGeom400PP_X_X
#define PrimitiveOverlapGeom400PP_X_X
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_X|1|P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom400PP_X_X(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PP_X_X */
