#ifndef PrimitiveOverlapGeom400PF_X_XYY
#define PrimitiveOverlapGeom400PF_X_XYY
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_X|1|F_XYY> integrals.
...
*/
auto compPrimitiveOverlapGeom400PF_X_XYY(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PF_X_XYY */
