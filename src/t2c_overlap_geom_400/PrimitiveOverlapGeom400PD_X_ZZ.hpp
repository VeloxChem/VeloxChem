#ifndef PrimitiveOverlapGeom400PD_X_ZZ
#define PrimitiveOverlapGeom400PD_X_ZZ
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_X|1|D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom400PD_X_ZZ(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PD_X_ZZ */
