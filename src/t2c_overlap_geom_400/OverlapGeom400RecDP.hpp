#ifndef OverlapGeom400RecDP_hpp
#define OverlapGeom400RecDP_hpp
...
/**
 Evaluates <d^(4)/dA^(4)D|1|P>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom400DP(CSubMatrix*      matrix_xxxx,
