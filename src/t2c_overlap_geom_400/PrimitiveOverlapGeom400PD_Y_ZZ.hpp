#ifndef PrimitiveOverlapGeom400PD_Y_ZZ
#define PrimitiveOverlapGeom400PD_Y_ZZ
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_Y|1|D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom400PD_Y_ZZ(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PD_Y_ZZ */
