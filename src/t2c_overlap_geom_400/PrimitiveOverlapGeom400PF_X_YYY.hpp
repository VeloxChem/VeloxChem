#ifndef PrimitiveOverlapGeom400PF_X_YYY
#define PrimitiveOverlapGeom400PF_X_YYY
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_X|1|F_YYY> integrals.
...
*/
auto compPrimitiveOverlapGeom400PF_X_YYY(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PF_X_YYY */
