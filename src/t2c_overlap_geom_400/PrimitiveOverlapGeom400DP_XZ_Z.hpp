#ifndef PrimitiveOverlapGeom400DP_XZ_Z
#define PrimitiveOverlapGeom400DP_XZ_Z
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)D_XZ|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom400DP_XZ_Z(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400DP_XZ_Z */
