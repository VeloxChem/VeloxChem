#ifndef PrimitiveOverlapGeom400DD_XX_ZZ
#define PrimitiveOverlapGeom400DD_XX_ZZ
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)D_XX|1|D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom400DD_XX_ZZ(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400DD_XX_ZZ */
