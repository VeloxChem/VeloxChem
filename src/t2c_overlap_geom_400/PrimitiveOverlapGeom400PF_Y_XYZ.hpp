#ifndef PrimitiveOverlapGeom400PF_Y_XYZ
#define PrimitiveOverlapGeom400PF_Y_XYZ
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_Y|1|F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom400PF_Y_XYZ(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PF_Y_XYZ */
