#ifndef PrimitiveOverlapGeom400FP_XYY_X
#define PrimitiveOverlapGeom400FP_XYY_X
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)F_XYY|1|P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom400FP_XYY_X(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400FP_XYY_X */
