#ifndef PrimitiveOverlapGeom400FP_ZZZ_X
#define PrimitiveOverlapGeom400FP_ZZZ_X
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)F_ZZZ|1|P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom400FP_ZZZ_X(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400FP_ZZZ_X */
