#ifndef PrimitiveOverlapGeom400DP_ZZ_X
#define PrimitiveOverlapGeom400DP_ZZ_X
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)D_ZZ|1|P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom400DP_ZZ_X(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400DP_ZZ_X */
