#ifndef OverlapGeom400RecSF_hpp
#define OverlapGeom400RecSF_hpp
...
/**
 Evaluates <d^(4)/dA^(4)S|1|F>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom400SF(CSubMatrix*      matrix_xxxx,
