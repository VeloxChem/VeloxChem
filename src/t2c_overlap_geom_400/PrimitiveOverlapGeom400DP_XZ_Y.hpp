#ifndef PrimitiveOverlapGeom400DP_XZ_Y
#define PrimitiveOverlapGeom400DP_XZ_Y
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)D_XZ|1|P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom400DP_XZ_Y(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400DP_XZ_Y */
