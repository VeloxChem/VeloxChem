#ifndef PrimitiveOverlapGeom400FS_XZZ_0
#define PrimitiveOverlapGeom400FS_XZZ_0
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)F_XZZ|1|S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom400FS_XZZ_0(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400FS_XZZ_0 */
