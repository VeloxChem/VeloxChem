#ifndef PrimitiveOverlapGeom400PP_Y_Y
#define PrimitiveOverlapGeom400PP_Y_Y
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_Y|1|P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom400PP_Y_Y(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PP_Y_Y */
