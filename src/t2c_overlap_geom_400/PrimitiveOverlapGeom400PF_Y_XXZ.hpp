#ifndef PrimitiveOverlapGeom400PF_Y_XXZ
#define PrimitiveOverlapGeom400PF_Y_XXZ
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_Y|1|F_XXZ> integrals.
...
*/
auto compPrimitiveOverlapGeom400PF_Y_XXZ(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PF_Y_XXZ */
