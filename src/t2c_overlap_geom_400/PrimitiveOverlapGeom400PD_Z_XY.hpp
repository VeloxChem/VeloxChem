#ifndef PrimitiveOverlapGeom400PD_Z_XY
#define PrimitiveOverlapGeom400PD_Z_XY
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_Z|1|D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom400PD_Z_XY(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PD_Z_XY */
