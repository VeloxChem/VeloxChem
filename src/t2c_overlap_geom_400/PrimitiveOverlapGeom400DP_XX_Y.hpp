#ifndef PrimitiveOverlapGeom400DP_XX_Y
#define PrimitiveOverlapGeom400DP_XX_Y
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)D_XX|1|P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom400DP_XX_Y(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400DP_XX_Y */
