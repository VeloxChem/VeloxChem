#ifndef PrimitiveOverlapGeom400PF_Z_XXY
#define PrimitiveOverlapGeom400PF_Z_XXY
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_Z|1|F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom400PF_Z_XXY(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PF_Z_XXY */
