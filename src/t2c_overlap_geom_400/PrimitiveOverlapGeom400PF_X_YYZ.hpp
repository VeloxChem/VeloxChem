#ifndef PrimitiveOverlapGeom400PF_X_YYZ
#define PrimitiveOverlapGeom400PF_X_YYZ
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_X|1|F_YYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom400PF_X_YYZ(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PF_X_YYZ */
