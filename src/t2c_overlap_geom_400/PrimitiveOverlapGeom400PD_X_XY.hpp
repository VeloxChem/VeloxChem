#ifndef PrimitiveOverlapGeom400PD_X_XY
#define PrimitiveOverlapGeom400PD_X_XY
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_X|1|D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom400PD_X_XY(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PD_X_XY */
