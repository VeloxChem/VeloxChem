#ifndef PrimitiveOverlapGeom400DP_YZ_Z
#define PrimitiveOverlapGeom400DP_YZ_Z
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)D_YZ|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom400DP_YZ_Z(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400DP_YZ_Z */
