#ifndef PrimitiveOverlapGeom400DS_XZ_0
#define PrimitiveOverlapGeom400DS_XZ_0
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)D_XZ|1|S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom400DS_XZ_0(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400DS_XZ_0 */
