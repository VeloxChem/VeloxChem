#ifndef PrimitiveOverlapGeom400PF_Z_XYZ
#define PrimitiveOverlapGeom400PF_Z_XYZ
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_Z|1|F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom400PF_Z_XYZ(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PF_Z_XYZ */
