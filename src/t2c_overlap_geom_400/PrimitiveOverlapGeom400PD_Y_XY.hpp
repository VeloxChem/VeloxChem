#ifndef PrimitiveOverlapGeom400PD_Y_XY
#define PrimitiveOverlapGeom400PD_Y_XY
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_Y|1|D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom400PD_Y_XY(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PD_Y_XY */
