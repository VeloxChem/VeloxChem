#ifndef PrimitiveOverlapGeom400PD_X_XZ
#define PrimitiveOverlapGeom400PD_X_XZ
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_X|1|D_XZ> integrals.
...
*/
auto compPrimitiveOverlapGeom400PD_X_XZ(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PD_X_XZ */
