#ifndef PrimitiveOverlapGeom400DP_XX_Z
#define PrimitiveOverlapGeom400DP_XX_Z
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)D_XX|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom400DP_XX_Z(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400DP_XX_Z */
