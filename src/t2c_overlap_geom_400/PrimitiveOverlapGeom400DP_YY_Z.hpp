#ifndef PrimitiveOverlapGeom400DP_YY_Z
#define PrimitiveOverlapGeom400DP_YY_Z
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)D_YY|1|P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom400DP_YY_Z(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400DP_YY_Z */
