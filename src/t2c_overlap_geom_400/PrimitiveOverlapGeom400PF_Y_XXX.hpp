#ifndef PrimitiveOverlapGeom400PF_Y_XXX
#define PrimitiveOverlapGeom400PF_Y_XXX
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_Y|1|F_XXX> integrals.
...
*/
auto compPrimitiveOverlapGeom400PF_Y_XXX(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PF_Y_XXX */
