#ifndef PrimitiveOverlapGeom400PP_X_Y
#define PrimitiveOverlapGeom400PP_X_Y
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_X|1|P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom400PP_X_Y(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PP_X_Y */
