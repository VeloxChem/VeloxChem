#ifndef PrimitiveOverlapGeom400PD_X_YZ
#define PrimitiveOverlapGeom400PD_X_YZ
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_X|1|D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom400PD_X_YZ(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PD_X_YZ */
