#ifndef PrimitiveOverlapGeom400DP_XX_X
#define PrimitiveOverlapGeom400DP_XX_X
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)D_XX|1|P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom400DP_XX_X(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400DP_XX_X */
