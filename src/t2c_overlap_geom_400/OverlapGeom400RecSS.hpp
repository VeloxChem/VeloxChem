#ifndef OverlapGeom400RecSS_hpp
#define OverlapGeom400RecSS_hpp
...
/**
 Evaluates <d^(4)/dA^(4)S|1|S>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom400SS(CSubMatrix*      matrix_xxxx,
