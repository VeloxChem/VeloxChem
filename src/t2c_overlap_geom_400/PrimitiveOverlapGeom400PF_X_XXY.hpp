#ifndef PrimitiveOverlapGeom400PF_X_XXY
#define PrimitiveOverlapGeom400PF_X_XXY
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_X|1|F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom400PF_X_XXY(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PF_X_XXY */
