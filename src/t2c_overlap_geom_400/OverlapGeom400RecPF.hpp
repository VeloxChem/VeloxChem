#ifndef OverlapGeom400RecPF_hpp
#define OverlapGeom400RecPF_hpp
...
/**
 Evaluates <d^(4)/dA^(4)P|1|F>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom400PF(CSubMatrix*      matrix_xxxx,
