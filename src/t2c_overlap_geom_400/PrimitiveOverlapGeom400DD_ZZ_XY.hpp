#ifndef PrimitiveOverlapGeom400DD_ZZ_XY
#define PrimitiveOverlapGeom400DD_ZZ_XY
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)D_ZZ|1|D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom400DD_ZZ_XY(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400DD_ZZ_XY */
