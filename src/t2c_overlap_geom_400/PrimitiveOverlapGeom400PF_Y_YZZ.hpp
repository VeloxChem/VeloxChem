#ifndef PrimitiveOverlapGeom400PF_Y_YZZ
#define PrimitiveOverlapGeom400PF_Y_YZZ
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)P_Y|1|F_YZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom400PF_Y_YZZ(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400PF_Y_YZZ */
