#ifndef PrimitiveOverlapGeom400FS_YYZ_0
#define PrimitiveOverlapGeom400FS_YYZ_0
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)F_YYZ|1|S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom400FS_YYZ_0(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400FS_YYZ_0 */
