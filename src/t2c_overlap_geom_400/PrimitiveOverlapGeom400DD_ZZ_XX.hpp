#ifndef PrimitiveOverlapGeom400DD_ZZ_XX
#define PrimitiveOverlapGeom400DD_ZZ_XX
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)D_ZZ|1|D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom400DD_ZZ_XX(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400DD_ZZ_XX */
