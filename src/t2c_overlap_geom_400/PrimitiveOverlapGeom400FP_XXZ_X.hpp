#ifndef PrimitiveOverlapGeom400FP_XXZ_X
#define PrimitiveOverlapGeom400FP_XXZ_X
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)F_XXZ|1|P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom400FP_XXZ_X(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400FP_XXZ_X */
