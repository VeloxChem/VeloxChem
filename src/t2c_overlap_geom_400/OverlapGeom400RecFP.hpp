#ifndef OverlapGeom400RecFP_hpp
#define OverlapGeom400RecFP_hpp
...
/**
 Evaluates <d^(4)/dA^(4)F|1|P>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom400FP(CSubMatrix*      matrix_xxxx,
