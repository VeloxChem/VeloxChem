#ifndef OverlapGeom400RecDS_hpp
#define OverlapGeom400RecDS_hpp
...
/**
 Evaluates <d^(4)/dA^(4)D|1|S>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom400DS(CSubMatrix*      matrix_xxxx,
