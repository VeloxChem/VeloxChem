#ifndef PrimitiveOverlapGeom400DS_XY_0
#define PrimitiveOverlapGeom400DS_XY_0
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)D_XY|1|S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom400DS_XY_0(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400DS_XY_0 */
