#ifndef PrimitiveOverlapGeom400DP_YY_X
#define PrimitiveOverlapGeom400DP_YY_X
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)D_YY|1|P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom400DP_YY_X(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400DP_YY_X */
