#ifndef PrimitiveOverlapGeom400FP_XYY_Y
#define PrimitiveOverlapGeom400FP_XYY_Y
...
/**
 Evaluates block of primitive <d^(4)/dA^(4)F_XYY|1|P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom400FP_XYY_Y(TDoubleArray&       buffer_xxxx,
...
#endif /* PrimitiveOverlapGeom400FP_XYY_Y */
