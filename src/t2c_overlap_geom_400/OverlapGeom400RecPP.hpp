#ifndef OverlapGeom400RecPP_hpp
#define OverlapGeom400RecPP_hpp
...
/**
 Evaluates <d^(4)/dA^(4)P|1|P>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom400PP(CSubMatrix*      matrix_xxxx,
