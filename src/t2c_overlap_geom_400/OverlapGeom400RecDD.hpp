#ifndef OverlapGeom400RecDD_hpp
#define OverlapGeom400RecDD_hpp
...
/**
 Evaluates <d^(4)/dA^(4)D|1|D>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom400DD(CSubMatrix*      matrix_xxxx,
