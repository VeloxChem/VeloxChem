#ifndef ProjectedCorePotentialGeom010PGForF_hpp
#define ProjectedCorePotentialGeom010PGForF_hpp
...
template <class T>
auto
comp_projected_core_potential_geom_010_pg_for_f(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2pecp::comp_prim_projected_core_potential_sh_f(pbuffer, 35, 10, 20, 459, 699, 709, 754, 784, 1523, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_pf_f(pbuffer, 56, 10, 427, 439, 1091, 1212, 1469, 1493, 0, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_pg_f(pbuffer, 86, 20, 439, 459, 1101, 1242, 1493, 1523, 0, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_ph_f(pbuffer, 266, 35, 459, 489, 1116, 1272, 1523, 1553, 0, -1, pfactors, 2, r_a, a_exp, c_exp);

                    t2pecp::comp_prim_projected_core_potential_dg_f(pbuffer, 329, 20, 86, 510, 540, 1101, 1137, 1242, 1293, 1574, 1604, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
...
#endif /* ProjectedCorePotentialGeom010PGForF_hpp */
