#ifndef ProjectedCorePotentialGeom010PFForF_hpp
#define ProjectedCorePotentialGeom010PFForF_hpp
...
template <class T>
auto
comp_projected_core_potential_geom_010_pf_for_f(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2pecp::comp_prim_projected_core_potential_sg_f(pbuffer, 20, 4, 10, 298, 435, 441, 463, 481, 866, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_pd_f(pbuffer, 35, 4, 280, 286, 617, 690, 836, 848, 0, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_pf_f(pbuffer, 53, 10, 286, 298, 623, 708, 848, 866, 0, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_pg_f(pbuffer, 173, 20, 298, 318, 633, 728, 866, 886, 0, -1, pfactors, 2, r_a, a_exp, c_exp);

                    t2pecp::comp_prim_projected_core_potential_df_f(pbuffer, 218, 10, 53, 333, 351, 623, 648, 708, 743, 901, 919, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
...
#endif /* ProjectedCorePotentialGeom010PFForF_hpp */
