#ifndef ProjectedCorePotentialGeom010PFForD_hpp
#define ProjectedCorePotentialGeom010PFForD_hpp
...
template <class T>
auto
comp_projected_core_potential_geom_010_pf_for_d(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < ecp_nppt; l++)
                {
                    ...
                    t2pecp::comp_prim_projected_core_potential_sg_d(pbuffer, 20, 4, 10, 298, 424, 430, 452, 470, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_pd_d(pbuffer, 35, 4, 280, 286, 566, 639, 0, -1, pfactors, 2, r_a, a_exp, c_exp);
                    ...
                    t2pecp::comp_prim_projected_core_potential_pf_d(pbuffer, 53, 10, 286, 298, 572, 657, 0, -1, pfactors, 2, r_a, a_exp, c_exp);

                    t2pecp::comp_prim_projected_core_potential_pf_d(pbuffer, 597, 572, 645, 667, 843, 873, 0, -1, pfactors, 2, r_a, a_exp, c_exp);

                    t2pecp::comp_prim_projected_core_potential_pg_d(pbuffer, 173, 20, 298, 318, 582, 677, 0, -1, pfactors, 2, r_a, a_exp, c_exp);

                    t2pecp::comp_prim_projected_core_potential_df_d(pbuffer, 218, 10, 53, 333, 351, 572, 597, 657, 692, 0, -1, -1, pfactors, 2, r_a, a_exp, c_exp);
...
#endif /* ProjectedCorePotentialGeom010PFForD_hpp */
