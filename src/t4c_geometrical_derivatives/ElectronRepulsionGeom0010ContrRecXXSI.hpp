#ifndef ElectronRepulsionGeom0010ContrRecXXSI_hpp
#define ElectronRepulsionGeom0010ContrRecXXSI_hpp
...
/// Computes (XX|1/|r-r'||SI)  integrals for set of data buffers.
...
#endif /* ElectronRepulsionGeom0010ContrRecXXSI_hpp */
