#include "ElectronRepulsionGeom0100ContrRecFIXX.hpp"
...
auto
comp_bra_geom01_hrr_electron_repulsion_fixx(CSimdArray<double>& cbuffer,
                                            ...
                                            const int d_angmom) -> void
{
    ...
    for (int i = 0; i < ccomps; i++)
    {
        for (int j = 0; j < dcomps; j++)
        {
            ...
            #pragma omp simd aligned(g_0_x_xx_xxxxxx, g_0_x_xx_xxxxxxx, g_0_x_xx_xxxxxxy, g_0_x_xx_xxxxxxz, g_0_x_xx_xxxxxy, g_0_x_xx_xxxxxyy, g_0_x_xx_xxxxxyz, g_0_x_xx_xxxxxz, g_0_x_xx_xxxxxzz, g_0_x_xx_xxxxyy, g_0_x_xx_xxxxyyy, g_0_x_xx_xxxxyyz, g_0_x_xx_xxxxyz, g_0_x_xx_xxxxyzz, g_0_x_xx_xxxxzz, g_0_x_xx_xxxxzzz, g_0_x_xx_xxxyyy, g_0_x_xx_xxxyyyy, g_0_x_xx_xxxyyyz, g_0_x_xx_xxxyyz, g_0_x_xx_xxxyyzz, g_0_x_xx_xxxyzz, g_0_x_xx_xxxyzzz, g_0_x_xx_xxxzzz, g_0_x_xx_xxxzzzz, g_0_x_xx_xxyyyy, g_0_x_xx_xxyyyyy, g_0_x_xx_xxyyyyz, g_0_x_xx_xxyyyz, g_0_x_xx_xxyyyzz, g_0_x_xx_xxyyzz, g_0_x_xx_xxyyzzz, g_0_x_xx_xxyzzz, g_0_x_xx_xxyzzzz, g_0_x_xx_xxzzzz, g_0_x_xx_xxzzzzz, g_0_x_xx_xyyyyy, g_0_x_xx_xyyyyyy, g_0_x_xx_xyyyyyz, g_0_x_xx_xyyyyz, g_0_x_xx_xyyyyzz, g_0_x_xx_xyyyzz, g_0_x_xx_xyyyzzz, g_0_x_xx_xyyzzz, g_0_x_xx_xyyzzzz, g_0_x_xx_xyzzzz, g_0_x_xx_xyzzzzz, g_0_x_xx_xzzzzz, g_0_x_xx_xzzzzzz, g_0_x_xx_yyyyyy, g_0_x_xx_yyyyyz, g_0_x_xx_yyyyzz, g_0_x_xx_yyyzzz, g_0_x_xx_yyzzzz, g_0_x_xx_yzzzzz, g_0_x_xx_zzzzzz, g_0_x_xxx_xxxxxx, g_0_x_xxx_xxxxxy, g_0_x_xxx_xxxxxz, g_0_x_xxx_xxxxyy, g_0_x_xxx_xxxxyz, g_0_x_xxx_xxxxzz, g_0_x_xxx_xxxyyy, g_0_x_xxx_xxxyyz, g_0_x_xxx_xxxyzz, g_0_x_xxx_xxxzzz, g_0_x_xxx_xxyyyy, g_0_x_xxx_xxyyyz, g_0_x_xxx_xxyyzz, g_0_x_xxx_xxyzzz, g_0_x_xxx_xxzzzz, g_0_x_xxx_xyyyyy, g_0_x_xxx_xyyyyz, g_0_x_xxx_xyyyzz, g_0_x_xxx_xyyzzz, g_0_x_xxx_xyzzzz, g_0_x_xxx_xzzzzz, g_0_x_xxx_yyyyyy, g_0_x_xxx_yyyyyz, g_0_x_xxx_yyyyzz, g_0_x_xxx_yyyzzz, g_0_x_xxx_yyzzzz, g_0_x_xxx_yzzzzz, g_0_x_xxx_zzzzzz, g_xx_xxxxxx, g_xx_xxxxxy, g_xx_xxxxxz, g_xx_xxxxyy, g_xx_xxxxyz, g_xx_xxxxzz, g_xx_xxxyyy, g_xx_xxxyyz, g_xx_xxxyzz, g_xx_xxxzzz, g_xx_xxyyyy, g_xx_xxyyyz, g_xx_xxyyzz, g_xx_xxyzzz, g_xx_xxzzzz, g_xx_xyyyyy, g_xx_xyyyyz, g_xx_xyyyzz, g_xx_xyyzzz, g_xx_xyzzzz, g_xx_xzzzzz, g_xx_yyyyyy, g_xx_yyyyyz, g_xx_yyyyzz, g_xx_yyyzzz, g_xx_yyzzzz, g_xx_yzzzzz, g_xx_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_x_xxx_xxxxxx[k] = g_xx_xxxxxx[k] - g_0_x_xx_xxxxxx[k] * ab_x + g_0_x_xx_xxxxxxx[k];

                g_0_x_xxx_xxxxxy[k] = g_xx_xxxxxy[k] - g_0_x_xx_xxxxxy[k] * ab_x + g_0_x_xx_xxxxxxy[k];

                g_0_x_xxx_xxxxxz[k] = g_xx_xxxxxz[k] - g_0_x_xx_xxxxxz[k] * ab_x + g_0_x_xx_xxxxxxz[k];

                g_0_x_xxx_xxxxyy[k] = g_xx_xxxxyy[k] - g_0_x_xx_xxxxyy[k] * ab_x + g_0_x_xx_xxxxxyy[k];

                g_0_x_xxx_xxxxyz[k] = g_xx_xxxxyz[k] - g_0_x_xx_xxxxyz[k] * ab_x + g_0_x_xx_xxxxxyz[k];

                g_0_x_xxx_xxxxzz[k] = g_xx_xxxxzz[k] - g_0_x_xx_xxxxzz[k] * ab_x + g_0_x_xx_xxxxxzz[k];

                g_0_x_xxx_xxxyyy[k] = g_xx_xxxyyy[k] - g_0_x_xx_xxxyyy[k] * ab_x + g_0_x_xx_xxxxyyy[k];

                g_0_x_xxx_xxxyyz[k] = g_xx_xxxyyz[k] - g_0_x_xx_xxxyyz[k] * ab_x + g_0_x_xx_xxxxyyz[k];

                g_0_x_xxx_xxxyzz[k] = g_xx_xxxyzz[k] - g_0_x_xx_xxxyzz[k] * ab_x + g_0_x_xx_xxxxyzz[k];

                g_0_x_xxx_xxxzzz[k] = g_xx_xxxzzz[k] - g_0_x_xx_xxxzzz[k] * ab_x + g_0_x_xx_xxxxzzz[k];

                g_0_x_xxx_xxyyyy[k] = g_xx_xxyyyy[k] - g_0_x_xx_xxyyyy[k] * ab_x + g_0_x_xx_xxxyyyy[k];

                g_0_x_xxx_xxyyyz[k] = g_xx_xxyyyz[k] - g_0_x_xx_xxyyyz[k] * ab_x + g_0_x_xx_xxxyyyz[k];

                g_0_x_xxx_xxyyzz[k] = g_xx_xxyyzz[k] - g_0_x_xx_xxyyzz[k] * ab_x + g_0_x_xx_xxxyyzz[k];

                g_0_x_xxx_xxyzzz[k] = g_xx_xxyzzz[k] - g_0_x_xx_xxyzzz[k] * ab_x + g_0_x_xx_xxxyzzz[k];

                g_0_x_xxx_xxzzzz[k] = g_xx_xxzzzz[k] - g_0_x_xx_xxzzzz[k] * ab_x + g_0_x_xx_xxxzzzz[k];

                g_0_x_xxx_xyyyyy[k] = g_xx_xyyyyy[k] - g_0_x_xx_xyyyyy[k] * ab_x + g_0_x_xx_xxyyyyy[k];

                g_0_x_xxx_xyyyyz[k] = g_xx_xyyyyz[k] - g_0_x_xx_xyyyyz[k] * ab_x + g_0_x_xx_xxyyyyz[k];

                g_0_x_xxx_xyyyzz[k] = g_xx_xyyyzz[k] - g_0_x_xx_xyyyzz[k] * ab_x + g_0_x_xx_xxyyyzz[k];

                g_0_x_xxx_xyyzzz[k] = g_xx_xyyzzz[k] - g_0_x_xx_xyyzzz[k] * ab_x + g_0_x_xx_xxyyzzz[k];

                g_0_x_xxx_xyzzzz[k] = g_xx_xyzzzz[k] - g_0_x_xx_xyzzzz[k] * ab_x + g_0_x_xx_xxyzzzz[k];

                g_0_x_xxx_xzzzzz[k] = g_xx_xzzzzz[k] - g_0_x_xx_xzzzzz[k] * ab_x + g_0_x_xx_xxzzzzz[k];

                g_0_x_xxx_yyyyyy[k] = g_xx_yyyyyy[k] - g_0_x_xx_yyyyyy[k] * ab_x + g_0_x_xx_xyyyyyy[k];

                g_0_x_xxx_yyyyyz[k] = g_xx_yyyyyz[k] - g_0_x_xx_yyyyyz[k] * ab_x + g_0_x_xx_xyyyyyz[k];

                g_0_x_xxx_yyyyzz[k] = g_xx_yyyyzz[k] - g_0_x_xx_yyyyzz[k] * ab_x + g_0_x_xx_xyyyyzz[k];

                g_0_x_xxx_yyyzzz[k] = g_xx_yyyzzz[k] - g_0_x_xx_yyyzzz[k] * ab_x + g_0_x_xx_xyyyzzz[k];

                g_0_x_xxx_yyzzzz[k] = g_xx_yyzzzz[k] - g_0_x_xx_yyzzzz[k] * ab_x + g_0_x_xx_xyyzzzz[k];

                g_0_x_xxx_yzzzzz[k] = g_xx_yzzzzz[k] - g_0_x_xx_yzzzzz[k] * ab_x + g_0_x_xx_xyzzzzz[k];

                g_0_x_xxx_zzzzzz[k] = g_xx_zzzzzz[k] - g_0_x_xx_zzzzzz[k] * ab_x + g_0_x_xx_xzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_x_xx_xxxxxx, g_0_x_xx_xxxxxxy, g_0_x_xx_xxxxxy, g_0_x_xx_xxxxxyy, g_0_x_xx_xxxxxyz, g_0_x_xx_xxxxxz, g_0_x_xx_xxxxyy, g_0_x_xx_xxxxyyy, g_0_x_xx_xxxxyyz, g_0_x_xx_xxxxyz, g_0_x_xx_xxxxyzz, g_0_x_xx_xxxxzz, g_0_x_xx_xxxyyy, g_0_x_xx_xxxyyyy, g_0_x_xx_xxxyyyz, g_0_x_xx_xxxyyz, g_0_x_xx_xxxyyzz, g_0_x_xx_xxxyzz, g_0_x_xx_xxxyzzz, g_0_x_xx_xxxzzz, g_0_x_xx_xxyyyy, g_0_x_xx_xxyyyyy, g_0_x_xx_xxyyyyz, g_0_x_xx_xxyyyz, g_0_x_xx_xxyyyzz, g_0_x_xx_xxyyzz, g_0_x_xx_xxyyzzz, g_0_x_xx_xxyzzz, g_0_x_xx_xxyzzzz, g_0_x_xx_xxzzzz, g_0_x_xx_xyyyyy, g_0_x_xx_xyyyyyy, g_0_x_xx_xyyyyyz, g_0_x_xx_xyyyyz, g_0_x_xx_xyyyyzz, g_0_x_xx_xyyyzz, g_0_x_xx_xyyyzzz, g_0_x_xx_xyyzzz, g_0_x_xx_xyyzzzz, g_0_x_xx_xyzzzz, g_0_x_xx_xyzzzzz, g_0_x_xx_xzzzzz, g_0_x_xx_yyyyyy, g_0_x_xx_yyyyyyy, g_0_x_xx_yyyyyyz, g_0_x_xx_yyyyyz, g_0_x_xx_yyyyyzz, g_0_x_xx_yyyyzz, g_0_x_xx_yyyyzzz, g_0_x_xx_yyyzzz, g_0_x_xx_yyyzzzz, g_0_x_xx_yyzzzz, g_0_x_xx_yyzzzzz, g_0_x_xx_yzzzzz, g_0_x_xx_yzzzzzz, g_0_x_xx_zzzzzz, g_0_x_xxy_xxxxxx, g_0_x_xxy_xxxxxy, g_0_x_xxy_xxxxxz, g_0_x_xxy_xxxxyy, g_0_x_xxy_xxxxyz, g_0_x_xxy_xxxxzz, g_0_x_xxy_xxxyyy, g_0_x_xxy_xxxyyz, g_0_x_xxy_xxxyzz, g_0_x_xxy_xxxzzz, g_0_x_xxy_xxyyyy, g_0_x_xxy_xxyyyz, g_0_x_xxy_xxyyzz, g_0_x_xxy_xxyzzz, g_0_x_xxy_xxzzzz, g_0_x_xxy_xyyyyy, g_0_x_xxy_xyyyyz, g_0_x_xxy_xyyyzz, g_0_x_xxy_xyyzzz, g_0_x_xxy_xyzzzz, g_0_x_xxy_xzzzzz, g_0_x_xxy_yyyyyy, g_0_x_xxy_yyyyyz, g_0_x_xxy_yyyyzz, g_0_x_xxy_yyyzzz, g_0_x_xxy_yyzzzz, g_0_x_xxy_yzzzzz, g_0_x_xxy_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_x_xxy_xxxxxx[k] = -g_0_x_xx_xxxxxx[k] * ab_y + g_0_x_xx_xxxxxxy[k];

                g_0_x_xxy_xxxxxy[k] = -g_0_x_xx_xxxxxy[k] * ab_y + g_0_x_xx_xxxxxyy[k];

                g_0_x_xxy_xxxxxz[k] = -g_0_x_xx_xxxxxz[k] * ab_y + g_0_x_xx_xxxxxyz[k];

                g_0_x_xxy_xxxxyy[k] = -g_0_x_xx_xxxxyy[k] * ab_y + g_0_x_xx_xxxxyyy[k];

                g_0_x_xxy_xxxxyz[k] = -g_0_x_xx_xxxxyz[k] * ab_y + g_0_x_xx_xxxxyyz[k];

                g_0_x_xxy_xxxxzz[k] = -g_0_x_xx_xxxxzz[k] * ab_y + g_0_x_xx_xxxxyzz[k];

                g_0_x_xxy_xxxyyy[k] = -g_0_x_xx_xxxyyy[k] * ab_y + g_0_x_xx_xxxyyyy[k];

                g_0_x_xxy_xxxyyz[k] = -g_0_x_xx_xxxyyz[k] * ab_y + g_0_x_xx_xxxyyyz[k];

                g_0_x_xxy_xxxyzz[k] = -g_0_x_xx_xxxyzz[k] * ab_y + g_0_x_xx_xxxyyzz[k];

                g_0_x_xxy_xxxzzz[k] = -g_0_x_xx_xxxzzz[k] * ab_y + g_0_x_xx_xxxyzzz[k];

                g_0_x_xxy_xxyyyy[k] = -g_0_x_xx_xxyyyy[k] * ab_y + g_0_x_xx_xxyyyyy[k];

                g_0_x_xxy_xxyyyz[k] = -g_0_x_xx_xxyyyz[k] * ab_y + g_0_x_xx_xxyyyyz[k];

                g_0_x_xxy_xxyyzz[k] = -g_0_x_xx_xxyyzz[k] * ab_y + g_0_x_xx_xxyyyzz[k];

                g_0_x_xxy_xxyzzz[k] = -g_0_x_xx_xxyzzz[k] * ab_y + g_0_x_xx_xxyyzzz[k];

                g_0_x_xxy_xxzzzz[k] = -g_0_x_xx_xxzzzz[k] * ab_y + g_0_x_xx_xxyzzzz[k];

                g_0_x_xxy_xyyyyy[k] = -g_0_x_xx_xyyyyy[k] * ab_y + g_0_x_xx_xyyyyyy[k];

                g_0_x_xxy_xyyyyz[k] = -g_0_x_xx_xyyyyz[k] * ab_y + g_0_x_xx_xyyyyyz[k];

                g_0_x_xxy_xyyyzz[k] = -g_0_x_xx_xyyyzz[k] * ab_y + g_0_x_xx_xyyyyzz[k];

                g_0_x_xxy_xyyzzz[k] = -g_0_x_xx_xyyzzz[k] * ab_y + g_0_x_xx_xyyyzzz[k];

                g_0_x_xxy_xyzzzz[k] = -g_0_x_xx_xyzzzz[k] * ab_y + g_0_x_xx_xyyzzzz[k];

                g_0_x_xxy_xzzzzz[k] = -g_0_x_xx_xzzzzz[k] * ab_y + g_0_x_xx_xyzzzzz[k];

                g_0_x_xxy_yyyyyy[k] = -g_0_x_xx_yyyyyy[k] * ab_y + g_0_x_xx_yyyyyyy[k];

                g_0_x_xxy_yyyyyz[k] = -g_0_x_xx_yyyyyz[k] * ab_y + g_0_x_xx_yyyyyyz[k];

                g_0_x_xxy_yyyyzz[k] = -g_0_x_xx_yyyyzz[k] * ab_y + g_0_x_xx_yyyyyzz[k];

                g_0_x_xxy_yyyzzz[k] = -g_0_x_xx_yyyzzz[k] * ab_y + g_0_x_xx_yyyyzzz[k];

                g_0_x_xxy_yyzzzz[k] = -g_0_x_xx_yyzzzz[k] * ab_y + g_0_x_xx_yyyzzzz[k];

                g_0_x_xxy_yzzzzz[k] = -g_0_x_xx_yzzzzz[k] * ab_y + g_0_x_xx_yyzzzzz[k];

                g_0_x_xxy_zzzzzz[k] = -g_0_x_xx_zzzzzz[k] * ab_y + g_0_x_xx_yzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_x_xx_xxxxxx, g_0_x_xx_xxxxxxz, g_0_x_xx_xxxxxy, g_0_x_xx_xxxxxyz, g_0_x_xx_xxxxxz, g_0_x_xx_xxxxxzz, g_0_x_xx_xxxxyy, g_0_x_xx_xxxxyyz, g_0_x_xx_xxxxyz, g_0_x_xx_xxxxyzz, g_0_x_xx_xxxxzz, g_0_x_xx_xxxxzzz, g_0_x_xx_xxxyyy, g_0_x_xx_xxxyyyz, g_0_x_xx_xxxyyz, g_0_x_xx_xxxyyzz, g_0_x_xx_xxxyzz, g_0_x_xx_xxxyzzz, g_0_x_xx_xxxzzz, g_0_x_xx_xxxzzzz, g_0_x_xx_xxyyyy, g_0_x_xx_xxyyyyz, g_0_x_xx_xxyyyz, g_0_x_xx_xxyyyzz, g_0_x_xx_xxyyzz, g_0_x_xx_xxyyzzz, g_0_x_xx_xxyzzz, g_0_x_xx_xxyzzzz, g_0_x_xx_xxzzzz, g_0_x_xx_xxzzzzz, g_0_x_xx_xyyyyy, g_0_x_xx_xyyyyyz, g_0_x_xx_xyyyyz, g_0_x_xx_xyyyyzz, g_0_x_xx_xyyyzz, g_0_x_xx_xyyyzzz, g_0_x_xx_xyyzzz, g_0_x_xx_xyyzzzz, g_0_x_xx_xyzzzz, g_0_x_xx_xyzzzzz, g_0_x_xx_xzzzzz, g_0_x_xx_xzzzzzz, g_0_x_xx_yyyyyy, g_0_x_xx_yyyyyyz, g_0_x_xx_yyyyyz, g_0_x_xx_yyyyyzz, g_0_x_xx_yyyyzz, g_0_x_xx_yyyyzzz, g_0_x_xx_yyyzzz, g_0_x_xx_yyyzzzz, g_0_x_xx_yyzzzz, g_0_x_xx_yyzzzzz, g_0_x_xx_yzzzzz, g_0_x_xx_yzzzzzz, g_0_x_xx_zzzzzz, g_0_x_xx_zzzzzzz, g_0_x_xxz_xxxxxx, g_0_x_xxz_xxxxxy, g_0_x_xxz_xxxxxz, g_0_x_xxz_xxxxyy, g_0_x_xxz_xxxxyz, g_0_x_xxz_xxxxzz, g_0_x_xxz_xxxyyy, g_0_x_xxz_xxxyyz, g_0_x_xxz_xxxyzz, g_0_x_xxz_xxxzzz, g_0_x_xxz_xxyyyy, g_0_x_xxz_xxyyyz, g_0_x_xxz_xxyyzz, g_0_x_xxz_xxyzzz, g_0_x_xxz_xxzzzz, g_0_x_xxz_xyyyyy, g_0_x_xxz_xyyyyz, g_0_x_xxz_xyyyzz, g_0_x_xxz_xyyzzz, g_0_x_xxz_xyzzzz, g_0_x_xxz_xzzzzz, g_0_x_xxz_yyyyyy, g_0_x_xxz_yyyyyz, g_0_x_xxz_yyyyzz, g_0_x_xxz_yyyzzz, g_0_x_xxz_yyzzzz, g_0_x_xxz_yzzzzz, g_0_x_xxz_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_x_xxz_xxxxxx[k] = -g_0_x_xx_xxxxxx[k] * ab_z + g_0_x_xx_xxxxxxz[k];

                g_0_x_xxz_xxxxxy[k] = -g_0_x_xx_xxxxxy[k] * ab_z + g_0_x_xx_xxxxxyz[k];

                g_0_x_xxz_xxxxxz[k] = -g_0_x_xx_xxxxxz[k] * ab_z + g_0_x_xx_xxxxxzz[k];

                g_0_x_xxz_xxxxyy[k] = -g_0_x_xx_xxxxyy[k] * ab_z + g_0_x_xx_xxxxyyz[k];

                g_0_x_xxz_xxxxyz[k] = -g_0_x_xx_xxxxyz[k] * ab_z + g_0_x_xx_xxxxyzz[k];

                g_0_x_xxz_xxxxzz[k] = -g_0_x_xx_xxxxzz[k] * ab_z + g_0_x_xx_xxxxzzz[k];

                g_0_x_xxz_xxxyyy[k] = -g_0_x_xx_xxxyyy[k] * ab_z + g_0_x_xx_xxxyyyz[k];

                g_0_x_xxz_xxxyyz[k] = -g_0_x_xx_xxxyyz[k] * ab_z + g_0_x_xx_xxxyyzz[k];

                g_0_x_xxz_xxxyzz[k] = -g_0_x_xx_xxxyzz[k] * ab_z + g_0_x_xx_xxxyzzz[k];

                g_0_x_xxz_xxxzzz[k] = -g_0_x_xx_xxxzzz[k] * ab_z + g_0_x_xx_xxxzzzz[k];

                g_0_x_xxz_xxyyyy[k] = -g_0_x_xx_xxyyyy[k] * ab_z + g_0_x_xx_xxyyyyz[k];

                g_0_x_xxz_xxyyyz[k] = -g_0_x_xx_xxyyyz[k] * ab_z + g_0_x_xx_xxyyyzz[k];

                g_0_x_xxz_xxyyzz[k] = -g_0_x_xx_xxyyzz[k] * ab_z + g_0_x_xx_xxyyzzz[k];

                g_0_x_xxz_xxyzzz[k] = -g_0_x_xx_xxyzzz[k] * ab_z + g_0_x_xx_xxyzzzz[k];

                g_0_x_xxz_xxzzzz[k] = -g_0_x_xx_xxzzzz[k] * ab_z + g_0_x_xx_xxzzzzz[k];

                g_0_x_xxz_xyyyyy[k] = -g_0_x_xx_xyyyyy[k] * ab_z + g_0_x_xx_xyyyyyz[k];

                g_0_x_xxz_xyyyyz[k] = -g_0_x_xx_xyyyyz[k] * ab_z + g_0_x_xx_xyyyyzz[k];

                g_0_x_xxz_xyyyzz[k] = -g_0_x_xx_xyyyzz[k] * ab_z + g_0_x_xx_xyyyzzz[k];

                g_0_x_xxz_xyyzzz[k] = -g_0_x_xx_xyyzzz[k] * ab_z + g_0_x_xx_xyyzzzz[k];

                g_0_x_xxz_xyzzzz[k] = -g_0_x_xx_xyzzzz[k] * ab_z + g_0_x_xx_xyzzzzz[k];

                g_0_x_xxz_xzzzzz[k] = -g_0_x_xx_xzzzzz[k] * ab_z + g_0_x_xx_xzzzzzz[k];

                g_0_x_xxz_yyyyyy[k] = -g_0_x_xx_yyyyyy[k] * ab_z + g_0_x_xx_yyyyyyz[k];

                g_0_x_xxz_yyyyyz[k] = -g_0_x_xx_yyyyyz[k] * ab_z + g_0_x_xx_yyyyyzz[k];

                g_0_x_xxz_yyyyzz[k] = -g_0_x_xx_yyyyzz[k] * ab_z + g_0_x_xx_yyyyzzz[k];

                g_0_x_xxz_yyyzzz[k] = -g_0_x_xx_yyyzzz[k] * ab_z + g_0_x_xx_yyyzzzz[k];

                g_0_x_xxz_yyzzzz[k] = -g_0_x_xx_yyzzzz[k] * ab_z + g_0_x_xx_yyzzzzz[k];

                g_0_x_xxz_yzzzzz[k] = -g_0_x_xx_yzzzzz[k] * ab_z + g_0_x_xx_yzzzzzz[k];

                g_0_x_xxz_zzzzzz[k] = -g_0_x_xx_zzzzzz[k] * ab_z + g_0_x_xx_zzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_x_xy_xxxxxx, g_0_x_xy_xxxxxxy, g_0_x_xy_xxxxxy, g_0_x_xy_xxxxxyy, g_0_x_xy_xxxxxyz, g_0_x_xy_xxxxxz, g_0_x_xy_xxxxyy, g_0_x_xy_xxxxyyy, g_0_x_xy_xxxxyyz, g_0_x_xy_xxxxyz, g_0_x_xy_xxxxyzz, g_0_x_xy_xxxxzz, g_0_x_xy_xxxyyy, g_0_x_xy_xxxyyyy, g_0_x_xy_xxxyyyz, g_0_x_xy_xxxyyz, g_0_x_xy_xxxyyzz, g_0_x_xy_xxxyzz, g_0_x_xy_xxxyzzz, g_0_x_xy_xxxzzz, g_0_x_xy_xxyyyy, g_0_x_xy_xxyyyyy, g_0_x_xy_xxyyyyz, g_0_x_xy_xxyyyz, g_0_x_xy_xxyyyzz, g_0_x_xy_xxyyzz, g_0_x_xy_xxyyzzz, g_0_x_xy_xxyzzz, g_0_x_xy_xxyzzzz, g_0_x_xy_xxzzzz, g_0_x_xy_xyyyyy, g_0_x_xy_xyyyyyy, g_0_x_xy_xyyyyyz, g_0_x_xy_xyyyyz, g_0_x_xy_xyyyyzz, g_0_x_xy_xyyyzz, g_0_x_xy_xyyyzzz, g_0_x_xy_xyyzzz, g_0_x_xy_xyyzzzz, g_0_x_xy_xyzzzz, g_0_x_xy_xyzzzzz, g_0_x_xy_xzzzzz, g_0_x_xy_yyyyyy, g_0_x_xy_yyyyyyy, g_0_x_xy_yyyyyyz, g_0_x_xy_yyyyyz, g_0_x_xy_yyyyyzz, g_0_x_xy_yyyyzz, g_0_x_xy_yyyyzzz, g_0_x_xy_yyyzzz, g_0_x_xy_yyyzzzz, g_0_x_xy_yyzzzz, g_0_x_xy_yyzzzzz, g_0_x_xy_yzzzzz, g_0_x_xy_yzzzzzz, g_0_x_xy_zzzzzz, g_0_x_xyy_xxxxxx, g_0_x_xyy_xxxxxy, g_0_x_xyy_xxxxxz, g_0_x_xyy_xxxxyy, g_0_x_xyy_xxxxyz, g_0_x_xyy_xxxxzz, g_0_x_xyy_xxxyyy, g_0_x_xyy_xxxyyz, g_0_x_xyy_xxxyzz, g_0_x_xyy_xxxzzz, g_0_x_xyy_xxyyyy, g_0_x_xyy_xxyyyz, g_0_x_xyy_xxyyzz, g_0_x_xyy_xxyzzz, g_0_x_xyy_xxzzzz, g_0_x_xyy_xyyyyy, g_0_x_xyy_xyyyyz, g_0_x_xyy_xyyyzz, g_0_x_xyy_xyyzzz, g_0_x_xyy_xyzzzz, g_0_x_xyy_xzzzzz, g_0_x_xyy_yyyyyy, g_0_x_xyy_yyyyyz, g_0_x_xyy_yyyyzz, g_0_x_xyy_yyyzzz, g_0_x_xyy_yyzzzz, g_0_x_xyy_yzzzzz, g_0_x_xyy_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_x_xyy_xxxxxx[k] = -g_0_x_xy_xxxxxx[k] * ab_y + g_0_x_xy_xxxxxxy[k];

                g_0_x_xyy_xxxxxy[k] = -g_0_x_xy_xxxxxy[k] * ab_y + g_0_x_xy_xxxxxyy[k];

                g_0_x_xyy_xxxxxz[k] = -g_0_x_xy_xxxxxz[k] * ab_y + g_0_x_xy_xxxxxyz[k];

                g_0_x_xyy_xxxxyy[k] = -g_0_x_xy_xxxxyy[k] * ab_y + g_0_x_xy_xxxxyyy[k];

                g_0_x_xyy_xxxxyz[k] = -g_0_x_xy_xxxxyz[k] * ab_y + g_0_x_xy_xxxxyyz[k];

                g_0_x_xyy_xxxxzz[k] = -g_0_x_xy_xxxxzz[k] * ab_y + g_0_x_xy_xxxxyzz[k];

                g_0_x_xyy_xxxyyy[k] = -g_0_x_xy_xxxyyy[k] * ab_y + g_0_x_xy_xxxyyyy[k];

                g_0_x_xyy_xxxyyz[k] = -g_0_x_xy_xxxyyz[k] * ab_y + g_0_x_xy_xxxyyyz[k];

                g_0_x_xyy_xxxyzz[k] = -g_0_x_xy_xxxyzz[k] * ab_y + g_0_x_xy_xxxyyzz[k];

                g_0_x_xyy_xxxzzz[k] = -g_0_x_xy_xxxzzz[k] * ab_y + g_0_x_xy_xxxyzzz[k];

                g_0_x_xyy_xxyyyy[k] = -g_0_x_xy_xxyyyy[k] * ab_y + g_0_x_xy_xxyyyyy[k];

                g_0_x_xyy_xxyyyz[k] = -g_0_x_xy_xxyyyz[k] * ab_y + g_0_x_xy_xxyyyyz[k];

                g_0_x_xyy_xxyyzz[k] = -g_0_x_xy_xxyyzz[k] * ab_y + g_0_x_xy_xxyyyzz[k];

                g_0_x_xyy_xxyzzz[k] = -g_0_x_xy_xxyzzz[k] * ab_y + g_0_x_xy_xxyyzzz[k];

                g_0_x_xyy_xxzzzz[k] = -g_0_x_xy_xxzzzz[k] * ab_y + g_0_x_xy_xxyzzzz[k];

                g_0_x_xyy_xyyyyy[k] = -g_0_x_xy_xyyyyy[k] * ab_y + g_0_x_xy_xyyyyyy[k];

                g_0_x_xyy_xyyyyz[k] = -g_0_x_xy_xyyyyz[k] * ab_y + g_0_x_xy_xyyyyyz[k];

                g_0_x_xyy_xyyyzz[k] = -g_0_x_xy_xyyyzz[k] * ab_y + g_0_x_xy_xyyyyzz[k];

                g_0_x_xyy_xyyzzz[k] = -g_0_x_xy_xyyzzz[k] * ab_y + g_0_x_xy_xyyyzzz[k];

                g_0_x_xyy_xyzzzz[k] = -g_0_x_xy_xyzzzz[k] * ab_y + g_0_x_xy_xyyzzzz[k];

                g_0_x_xyy_xzzzzz[k] = -g_0_x_xy_xzzzzz[k] * ab_y + g_0_x_xy_xyzzzzz[k];

                g_0_x_xyy_yyyyyy[k] = -g_0_x_xy_yyyyyy[k] * ab_y + g_0_x_xy_yyyyyyy[k];

                g_0_x_xyy_yyyyyz[k] = -g_0_x_xy_yyyyyz[k] * ab_y + g_0_x_xy_yyyyyyz[k];

                g_0_x_xyy_yyyyzz[k] = -g_0_x_xy_yyyyzz[k] * ab_y + g_0_x_xy_yyyyyzz[k];

                g_0_x_xyy_yyyzzz[k] = -g_0_x_xy_yyyzzz[k] * ab_y + g_0_x_xy_yyyyzzz[k];

                g_0_x_xyy_yyzzzz[k] = -g_0_x_xy_yyzzzz[k] * ab_y + g_0_x_xy_yyyzzzz[k];

                g_0_x_xyy_yzzzzz[k] = -g_0_x_xy_yzzzzz[k] * ab_y + g_0_x_xy_yyzzzzz[k];

                g_0_x_xyy_zzzzzz[k] = -g_0_x_xy_zzzzzz[k] * ab_y + g_0_x_xy_yzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_x_xyz_xxxxxx, g_0_x_xyz_xxxxxy, g_0_x_xyz_xxxxxz, g_0_x_xyz_xxxxyy, g_0_x_xyz_xxxxyz, g_0_x_xyz_xxxxzz, g_0_x_xyz_xxxyyy, g_0_x_xyz_xxxyyz, g_0_x_xyz_xxxyzz, g_0_x_xyz_xxxzzz, g_0_x_xyz_xxyyyy, g_0_x_xyz_xxyyyz, g_0_x_xyz_xxyyzz, g_0_x_xyz_xxyzzz, g_0_x_xyz_xxzzzz, g_0_x_xyz_xyyyyy, g_0_x_xyz_xyyyyz, g_0_x_xyz_xyyyzz, g_0_x_xyz_xyyzzz, g_0_x_xyz_xyzzzz, g_0_x_xyz_xzzzzz, g_0_x_xyz_yyyyyy, g_0_x_xyz_yyyyyz, g_0_x_xyz_yyyyzz, g_0_x_xyz_yyyzzz, g_0_x_xyz_yyzzzz, g_0_x_xyz_yzzzzz, g_0_x_xyz_zzzzzz, g_0_x_xz_xxxxxx, g_0_x_xz_xxxxxxy, g_0_x_xz_xxxxxy, g_0_x_xz_xxxxxyy, g_0_x_xz_xxxxxyz, g_0_x_xz_xxxxxz, g_0_x_xz_xxxxyy, g_0_x_xz_xxxxyyy, g_0_x_xz_xxxxyyz, g_0_x_xz_xxxxyz, g_0_x_xz_xxxxyzz, g_0_x_xz_xxxxzz, g_0_x_xz_xxxyyy, g_0_x_xz_xxxyyyy, g_0_x_xz_xxxyyyz, g_0_x_xz_xxxyyz, g_0_x_xz_xxxyyzz, g_0_x_xz_xxxyzz, g_0_x_xz_xxxyzzz, g_0_x_xz_xxxzzz, g_0_x_xz_xxyyyy, g_0_x_xz_xxyyyyy, g_0_x_xz_xxyyyyz, g_0_x_xz_xxyyyz, g_0_x_xz_xxyyyzz, g_0_x_xz_xxyyzz, g_0_x_xz_xxyyzzz, g_0_x_xz_xxyzzz, g_0_x_xz_xxyzzzz, g_0_x_xz_xxzzzz, g_0_x_xz_xyyyyy, g_0_x_xz_xyyyyyy, g_0_x_xz_xyyyyyz, g_0_x_xz_xyyyyz, g_0_x_xz_xyyyyzz, g_0_x_xz_xyyyzz, g_0_x_xz_xyyyzzz, g_0_x_xz_xyyzzz, g_0_x_xz_xyyzzzz, g_0_x_xz_xyzzzz, g_0_x_xz_xyzzzzz, g_0_x_xz_xzzzzz, g_0_x_xz_yyyyyy, g_0_x_xz_yyyyyyy, g_0_x_xz_yyyyyyz, g_0_x_xz_yyyyyz, g_0_x_xz_yyyyyzz, g_0_x_xz_yyyyzz, g_0_x_xz_yyyyzzz, g_0_x_xz_yyyzzz, g_0_x_xz_yyyzzzz, g_0_x_xz_yyzzzz, g_0_x_xz_yyzzzzz, g_0_x_xz_yzzzzz, g_0_x_xz_yzzzzzz, g_0_x_xz_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_x_xyz_xxxxxx[k] = -g_0_x_xz_xxxxxx[k] * ab_y + g_0_x_xz_xxxxxxy[k];

                g_0_x_xyz_xxxxxy[k] = -g_0_x_xz_xxxxxy[k] * ab_y + g_0_x_xz_xxxxxyy[k];

                g_0_x_xyz_xxxxxz[k] = -g_0_x_xz_xxxxxz[k] * ab_y + g_0_x_xz_xxxxxyz[k];

                g_0_x_xyz_xxxxyy[k] = -g_0_x_xz_xxxxyy[k] * ab_y + g_0_x_xz_xxxxyyy[k];

                g_0_x_xyz_xxxxyz[k] = -g_0_x_xz_xxxxyz[k] * ab_y + g_0_x_xz_xxxxyyz[k];

                g_0_x_xyz_xxxxzz[k] = -g_0_x_xz_xxxxzz[k] * ab_y + g_0_x_xz_xxxxyzz[k];

                g_0_x_xyz_xxxyyy[k] = -g_0_x_xz_xxxyyy[k] * ab_y + g_0_x_xz_xxxyyyy[k];

                g_0_x_xyz_xxxyyz[k] = -g_0_x_xz_xxxyyz[k] * ab_y + g_0_x_xz_xxxyyyz[k];

                g_0_x_xyz_xxxyzz[k] = -g_0_x_xz_xxxyzz[k] * ab_y + g_0_x_xz_xxxyyzz[k];

                g_0_x_xyz_xxxzzz[k] = -g_0_x_xz_xxxzzz[k] * ab_y + g_0_x_xz_xxxyzzz[k];

                g_0_x_xyz_xxyyyy[k] = -g_0_x_xz_xxyyyy[k] * ab_y + g_0_x_xz_xxyyyyy[k];

                g_0_x_xyz_xxyyyz[k] = -g_0_x_xz_xxyyyz[k] * ab_y + g_0_x_xz_xxyyyyz[k];

                g_0_x_xyz_xxyyzz[k] = -g_0_x_xz_xxyyzz[k] * ab_y + g_0_x_xz_xxyyyzz[k];

                g_0_x_xyz_xxyzzz[k] = -g_0_x_xz_xxyzzz[k] * ab_y + g_0_x_xz_xxyyzzz[k];

                g_0_x_xyz_xxzzzz[k] = -g_0_x_xz_xxzzzz[k] * ab_y + g_0_x_xz_xxyzzzz[k];

                g_0_x_xyz_xyyyyy[k] = -g_0_x_xz_xyyyyy[k] * ab_y + g_0_x_xz_xyyyyyy[k];

                g_0_x_xyz_xyyyyz[k] = -g_0_x_xz_xyyyyz[k] * ab_y + g_0_x_xz_xyyyyyz[k];

                g_0_x_xyz_xyyyzz[k] = -g_0_x_xz_xyyyzz[k] * ab_y + g_0_x_xz_xyyyyzz[k];

                g_0_x_xyz_xyyzzz[k] = -g_0_x_xz_xyyzzz[k] * ab_y + g_0_x_xz_xyyyzzz[k];

                g_0_x_xyz_xyzzzz[k] = -g_0_x_xz_xyzzzz[k] * ab_y + g_0_x_xz_xyyzzzz[k];

                g_0_x_xyz_xzzzzz[k] = -g_0_x_xz_xzzzzz[k] * ab_y + g_0_x_xz_xyzzzzz[k];

                g_0_x_xyz_yyyyyy[k] = -g_0_x_xz_yyyyyy[k] * ab_y + g_0_x_xz_yyyyyyy[k];

                g_0_x_xyz_yyyyyz[k] = -g_0_x_xz_yyyyyz[k] * ab_y + g_0_x_xz_yyyyyyz[k];

                g_0_x_xyz_yyyyzz[k] = -g_0_x_xz_yyyyzz[k] * ab_y + g_0_x_xz_yyyyyzz[k];

                g_0_x_xyz_yyyzzz[k] = -g_0_x_xz_yyyzzz[k] * ab_y + g_0_x_xz_yyyyzzz[k];

                g_0_x_xyz_yyzzzz[k] = -g_0_x_xz_yyzzzz[k] * ab_y + g_0_x_xz_yyyzzzz[k];

                g_0_x_xyz_yzzzzz[k] = -g_0_x_xz_yzzzzz[k] * ab_y + g_0_x_xz_yyzzzzz[k];

                g_0_x_xyz_zzzzzz[k] = -g_0_x_xz_zzzzzz[k] * ab_y + g_0_x_xz_yzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_x_xz_xxxxxx, g_0_x_xz_xxxxxxz, g_0_x_xz_xxxxxy, g_0_x_xz_xxxxxyz, g_0_x_xz_xxxxxz, g_0_x_xz_xxxxxzz, g_0_x_xz_xxxxyy, g_0_x_xz_xxxxyyz, g_0_x_xz_xxxxyz, g_0_x_xz_xxxxyzz, g_0_x_xz_xxxxzz, g_0_x_xz_xxxxzzz, g_0_x_xz_xxxyyy, g_0_x_xz_xxxyyyz, g_0_x_xz_xxxyyz, g_0_x_xz_xxxyyzz, g_0_x_xz_xxxyzz, g_0_x_xz_xxxyzzz, g_0_x_xz_xxxzzz, g_0_x_xz_xxxzzzz, g_0_x_xz_xxyyyy, g_0_x_xz_xxyyyyz, g_0_x_xz_xxyyyz, g_0_x_xz_xxyyyzz, g_0_x_xz_xxyyzz, g_0_x_xz_xxyyzzz, g_0_x_xz_xxyzzz, g_0_x_xz_xxyzzzz, g_0_x_xz_xxzzzz, g_0_x_xz_xxzzzzz, g_0_x_xz_xyyyyy, g_0_x_xz_xyyyyyz, g_0_x_xz_xyyyyz, g_0_x_xz_xyyyyzz, g_0_x_xz_xyyyzz, g_0_x_xz_xyyyzzz, g_0_x_xz_xyyzzz, g_0_x_xz_xyyzzzz, g_0_x_xz_xyzzzz, g_0_x_xz_xyzzzzz, g_0_x_xz_xzzzzz, g_0_x_xz_xzzzzzz, g_0_x_xz_yyyyyy, g_0_x_xz_yyyyyyz, g_0_x_xz_yyyyyz, g_0_x_xz_yyyyyzz, g_0_x_xz_yyyyzz, g_0_x_xz_yyyyzzz, g_0_x_xz_yyyzzz, g_0_x_xz_yyyzzzz, g_0_x_xz_yyzzzz, g_0_x_xz_yyzzzzz, g_0_x_xz_yzzzzz, g_0_x_xz_yzzzzzz, g_0_x_xz_zzzzzz, g_0_x_xz_zzzzzzz, g_0_x_xzz_xxxxxx, g_0_x_xzz_xxxxxy, g_0_x_xzz_xxxxxz, g_0_x_xzz_xxxxyy, g_0_x_xzz_xxxxyz, g_0_x_xzz_xxxxzz, g_0_x_xzz_xxxyyy, g_0_x_xzz_xxxyyz, g_0_x_xzz_xxxyzz, g_0_x_xzz_xxxzzz, g_0_x_xzz_xxyyyy, g_0_x_xzz_xxyyyz, g_0_x_xzz_xxyyzz, g_0_x_xzz_xxyzzz, g_0_x_xzz_xxzzzz, g_0_x_xzz_xyyyyy, g_0_x_xzz_xyyyyz, g_0_x_xzz_xyyyzz, g_0_x_xzz_xyyzzz, g_0_x_xzz_xyzzzz, g_0_x_xzz_xzzzzz, g_0_x_xzz_yyyyyy, g_0_x_xzz_yyyyyz, g_0_x_xzz_yyyyzz, g_0_x_xzz_yyyzzz, g_0_x_xzz_yyzzzz, g_0_x_xzz_yzzzzz, g_0_x_xzz_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_x_xzz_xxxxxx[k] = -g_0_x_xz_xxxxxx[k] * ab_z + g_0_x_xz_xxxxxxz[k];

                g_0_x_xzz_xxxxxy[k] = -g_0_x_xz_xxxxxy[k] * ab_z + g_0_x_xz_xxxxxyz[k];

                g_0_x_xzz_xxxxxz[k] = -g_0_x_xz_xxxxxz[k] * ab_z + g_0_x_xz_xxxxxzz[k];

                g_0_x_xzz_xxxxyy[k] = -g_0_x_xz_xxxxyy[k] * ab_z + g_0_x_xz_xxxxyyz[k];

                g_0_x_xzz_xxxxyz[k] = -g_0_x_xz_xxxxyz[k] * ab_z + g_0_x_xz_xxxxyzz[k];

                g_0_x_xzz_xxxxzz[k] = -g_0_x_xz_xxxxzz[k] * ab_z + g_0_x_xz_xxxxzzz[k];

                g_0_x_xzz_xxxyyy[k] = -g_0_x_xz_xxxyyy[k] * ab_z + g_0_x_xz_xxxyyyz[k];

                g_0_x_xzz_xxxyyz[k] = -g_0_x_xz_xxxyyz[k] * ab_z + g_0_x_xz_xxxyyzz[k];

                g_0_x_xzz_xxxyzz[k] = -g_0_x_xz_xxxyzz[k] * ab_z + g_0_x_xz_xxxyzzz[k];

                g_0_x_xzz_xxxzzz[k] = -g_0_x_xz_xxxzzz[k] * ab_z + g_0_x_xz_xxxzzzz[k];

                g_0_x_xzz_xxyyyy[k] = -g_0_x_xz_xxyyyy[k] * ab_z + g_0_x_xz_xxyyyyz[k];

                g_0_x_xzz_xxyyyz[k] = -g_0_x_xz_xxyyyz[k] * ab_z + g_0_x_xz_xxyyyzz[k];

                g_0_x_xzz_xxyyzz[k] = -g_0_x_xz_xxyyzz[k] * ab_z + g_0_x_xz_xxyyzzz[k];

                g_0_x_xzz_xxyzzz[k] = -g_0_x_xz_xxyzzz[k] * ab_z + g_0_x_xz_xxyzzzz[k];

                g_0_x_xzz_xxzzzz[k] = -g_0_x_xz_xxzzzz[k] * ab_z + g_0_x_xz_xxzzzzz[k];

                g_0_x_xzz_xyyyyy[k] = -g_0_x_xz_xyyyyy[k] * ab_z + g_0_x_xz_xyyyyyz[k];

                g_0_x_xzz_xyyyyz[k] = -g_0_x_xz_xyyyyz[k] * ab_z + g_0_x_xz_xyyyyzz[k];

                g_0_x_xzz_xyyyzz[k] = -g_0_x_xz_xyyyzz[k] * ab_z + g_0_x_xz_xyyyzzz[k];

                g_0_x_xzz_xyyzzz[k] = -g_0_x_xz_xyyzzz[k] * ab_z + g_0_x_xz_xyyzzzz[k];

                g_0_x_xzz_xyzzzz[k] = -g_0_x_xz_xyzzzz[k] * ab_z + g_0_x_xz_xyzzzzz[k];

                g_0_x_xzz_xzzzzz[k] = -g_0_x_xz_xzzzzz[k] * ab_z + g_0_x_xz_xzzzzzz[k];

                g_0_x_xzz_yyyyyy[k] = -g_0_x_xz_yyyyyy[k] * ab_z + g_0_x_xz_yyyyyyz[k];

                g_0_x_xzz_yyyyyz[k] = -g_0_x_xz_yyyyyz[k] * ab_z + g_0_x_xz_yyyyyzz[k];

                g_0_x_xzz_yyyyzz[k] = -g_0_x_xz_yyyyzz[k] * ab_z + g_0_x_xz_yyyyzzz[k];

                g_0_x_xzz_yyyzzz[k] = -g_0_x_xz_yyyzzz[k] * ab_z + g_0_x_xz_yyyzzzz[k];

                g_0_x_xzz_yyzzzz[k] = -g_0_x_xz_yyzzzz[k] * ab_z + g_0_x_xz_yyzzzzz[k];

                g_0_x_xzz_yzzzzz[k] = -g_0_x_xz_yzzzzz[k] * ab_z + g_0_x_xz_yzzzzzz[k];

                g_0_x_xzz_zzzzzz[k] = -g_0_x_xz_zzzzzz[k] * ab_z + g_0_x_xz_zzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_x_yy_xxxxxx, g_0_x_yy_xxxxxxy, g_0_x_yy_xxxxxy, g_0_x_yy_xxxxxyy, g_0_x_yy_xxxxxyz, g_0_x_yy_xxxxxz, g_0_x_yy_xxxxyy, g_0_x_yy_xxxxyyy, g_0_x_yy_xxxxyyz, g_0_x_yy_xxxxyz, g_0_x_yy_xxxxyzz, g_0_x_yy_xxxxzz, g_0_x_yy_xxxyyy, g_0_x_yy_xxxyyyy, g_0_x_yy_xxxyyyz, g_0_x_yy_xxxyyz, g_0_x_yy_xxxyyzz, g_0_x_yy_xxxyzz, g_0_x_yy_xxxyzzz, g_0_x_yy_xxxzzz, g_0_x_yy_xxyyyy, g_0_x_yy_xxyyyyy, g_0_x_yy_xxyyyyz, g_0_x_yy_xxyyyz, g_0_x_yy_xxyyyzz, g_0_x_yy_xxyyzz, g_0_x_yy_xxyyzzz, g_0_x_yy_xxyzzz, g_0_x_yy_xxyzzzz, g_0_x_yy_xxzzzz, g_0_x_yy_xyyyyy, g_0_x_yy_xyyyyyy, g_0_x_yy_xyyyyyz, g_0_x_yy_xyyyyz, g_0_x_yy_xyyyyzz, g_0_x_yy_xyyyzz, g_0_x_yy_xyyyzzz, g_0_x_yy_xyyzzz, g_0_x_yy_xyyzzzz, g_0_x_yy_xyzzzz, g_0_x_yy_xyzzzzz, g_0_x_yy_xzzzzz, g_0_x_yy_yyyyyy, g_0_x_yy_yyyyyyy, g_0_x_yy_yyyyyyz, g_0_x_yy_yyyyyz, g_0_x_yy_yyyyyzz, g_0_x_yy_yyyyzz, g_0_x_yy_yyyyzzz, g_0_x_yy_yyyzzz, g_0_x_yy_yyyzzzz, g_0_x_yy_yyzzzz, g_0_x_yy_yyzzzzz, g_0_x_yy_yzzzzz, g_0_x_yy_yzzzzzz, g_0_x_yy_zzzzzz, g_0_x_yyy_xxxxxx, g_0_x_yyy_xxxxxy, g_0_x_yyy_xxxxxz, g_0_x_yyy_xxxxyy, g_0_x_yyy_xxxxyz, g_0_x_yyy_xxxxzz, g_0_x_yyy_xxxyyy, g_0_x_yyy_xxxyyz, g_0_x_yyy_xxxyzz, g_0_x_yyy_xxxzzz, g_0_x_yyy_xxyyyy, g_0_x_yyy_xxyyyz, g_0_x_yyy_xxyyzz, g_0_x_yyy_xxyzzz, g_0_x_yyy_xxzzzz, g_0_x_yyy_xyyyyy, g_0_x_yyy_xyyyyz, g_0_x_yyy_xyyyzz, g_0_x_yyy_xyyzzz, g_0_x_yyy_xyzzzz, g_0_x_yyy_xzzzzz, g_0_x_yyy_yyyyyy, g_0_x_yyy_yyyyyz, g_0_x_yyy_yyyyzz, g_0_x_yyy_yyyzzz, g_0_x_yyy_yyzzzz, g_0_x_yyy_yzzzzz, g_0_x_yyy_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_x_yyy_xxxxxx[k] = -g_0_x_yy_xxxxxx[k] * ab_y + g_0_x_yy_xxxxxxy[k];

                g_0_x_yyy_xxxxxy[k] = -g_0_x_yy_xxxxxy[k] * ab_y + g_0_x_yy_xxxxxyy[k];

                g_0_x_yyy_xxxxxz[k] = -g_0_x_yy_xxxxxz[k] * ab_y + g_0_x_yy_xxxxxyz[k];

                g_0_x_yyy_xxxxyy[k] = -g_0_x_yy_xxxxyy[k] * ab_y + g_0_x_yy_xxxxyyy[k];

                g_0_x_yyy_xxxxyz[k] = -g_0_x_yy_xxxxyz[k] * ab_y + g_0_x_yy_xxxxyyz[k];

                g_0_x_yyy_xxxxzz[k] = -g_0_x_yy_xxxxzz[k] * ab_y + g_0_x_yy_xxxxyzz[k];

                g_0_x_yyy_xxxyyy[k] = -g_0_x_yy_xxxyyy[k] * ab_y + g_0_x_yy_xxxyyyy[k];

                g_0_x_yyy_xxxyyz[k] = -g_0_x_yy_xxxyyz[k] * ab_y + g_0_x_yy_xxxyyyz[k];

                g_0_x_yyy_xxxyzz[k] = -g_0_x_yy_xxxyzz[k] * ab_y + g_0_x_yy_xxxyyzz[k];

                g_0_x_yyy_xxxzzz[k] = -g_0_x_yy_xxxzzz[k] * ab_y + g_0_x_yy_xxxyzzz[k];

                g_0_x_yyy_xxyyyy[k] = -g_0_x_yy_xxyyyy[k] * ab_y + g_0_x_yy_xxyyyyy[k];

                g_0_x_yyy_xxyyyz[k] = -g_0_x_yy_xxyyyz[k] * ab_y + g_0_x_yy_xxyyyyz[k];

                g_0_x_yyy_xxyyzz[k] = -g_0_x_yy_xxyyzz[k] * ab_y + g_0_x_yy_xxyyyzz[k];

                g_0_x_yyy_xxyzzz[k] = -g_0_x_yy_xxyzzz[k] * ab_y + g_0_x_yy_xxyyzzz[k];

                g_0_x_yyy_xxzzzz[k] = -g_0_x_yy_xxzzzz[k] * ab_y + g_0_x_yy_xxyzzzz[k];

                g_0_x_yyy_xyyyyy[k] = -g_0_x_yy_xyyyyy[k] * ab_y + g_0_x_yy_xyyyyyy[k];

                g_0_x_yyy_xyyyyz[k] = -g_0_x_yy_xyyyyz[k] * ab_y + g_0_x_yy_xyyyyyz[k];

                g_0_x_yyy_xyyyzz[k] = -g_0_x_yy_xyyyzz[k] * ab_y + g_0_x_yy_xyyyyzz[k];

                g_0_x_yyy_xyyzzz[k] = -g_0_x_yy_xyyzzz[k] * ab_y + g_0_x_yy_xyyyzzz[k];

                g_0_x_yyy_xyzzzz[k] = -g_0_x_yy_xyzzzz[k] * ab_y + g_0_x_yy_xyyzzzz[k];

                g_0_x_yyy_xzzzzz[k] = -g_0_x_yy_xzzzzz[k] * ab_y + g_0_x_yy_xyzzzzz[k];

                g_0_x_yyy_yyyyyy[k] = -g_0_x_yy_yyyyyy[k] * ab_y + g_0_x_yy_yyyyyyy[k];

                g_0_x_yyy_yyyyyz[k] = -g_0_x_yy_yyyyyz[k] * ab_y + g_0_x_yy_yyyyyyz[k];

                g_0_x_yyy_yyyyzz[k] = -g_0_x_yy_yyyyzz[k] * ab_y + g_0_x_yy_yyyyyzz[k];

                g_0_x_yyy_yyyzzz[k] = -g_0_x_yy_yyyzzz[k] * ab_y + g_0_x_yy_yyyyzzz[k];

                g_0_x_yyy_yyzzzz[k] = -g_0_x_yy_yyzzzz[k] * ab_y + g_0_x_yy_yyyzzzz[k];

                g_0_x_yyy_yzzzzz[k] = -g_0_x_yy_yzzzzz[k] * ab_y + g_0_x_yy_yyzzzzz[k];

                g_0_x_yyy_zzzzzz[k] = -g_0_x_yy_zzzzzz[k] * ab_y + g_0_x_yy_yzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_x_yyz_xxxxxx, g_0_x_yyz_xxxxxy, g_0_x_yyz_xxxxxz, g_0_x_yyz_xxxxyy, g_0_x_yyz_xxxxyz, g_0_x_yyz_xxxxzz, g_0_x_yyz_xxxyyy, g_0_x_yyz_xxxyyz, g_0_x_yyz_xxxyzz, g_0_x_yyz_xxxzzz, g_0_x_yyz_xxyyyy, g_0_x_yyz_xxyyyz, g_0_x_yyz_xxyyzz, g_0_x_yyz_xxyzzz, g_0_x_yyz_xxzzzz, g_0_x_yyz_xyyyyy, g_0_x_yyz_xyyyyz, g_0_x_yyz_xyyyzz, g_0_x_yyz_xyyzzz, g_0_x_yyz_xyzzzz, g_0_x_yyz_xzzzzz, g_0_x_yyz_yyyyyy, g_0_x_yyz_yyyyyz, g_0_x_yyz_yyyyzz, g_0_x_yyz_yyyzzz, g_0_x_yyz_yyzzzz, g_0_x_yyz_yzzzzz, g_0_x_yyz_zzzzzz, g_0_x_yz_xxxxxx, g_0_x_yz_xxxxxxy, g_0_x_yz_xxxxxy, g_0_x_yz_xxxxxyy, g_0_x_yz_xxxxxyz, g_0_x_yz_xxxxxz, g_0_x_yz_xxxxyy, g_0_x_yz_xxxxyyy, g_0_x_yz_xxxxyyz, g_0_x_yz_xxxxyz, g_0_x_yz_xxxxyzz, g_0_x_yz_xxxxzz, g_0_x_yz_xxxyyy, g_0_x_yz_xxxyyyy, g_0_x_yz_xxxyyyz, g_0_x_yz_xxxyyz, g_0_x_yz_xxxyyzz, g_0_x_yz_xxxyzz, g_0_x_yz_xxxyzzz, g_0_x_yz_xxxzzz, g_0_x_yz_xxyyyy, g_0_x_yz_xxyyyyy, g_0_x_yz_xxyyyyz, g_0_x_yz_xxyyyz, g_0_x_yz_xxyyyzz, g_0_x_yz_xxyyzz, g_0_x_yz_xxyyzzz, g_0_x_yz_xxyzzz, g_0_x_yz_xxyzzzz, g_0_x_yz_xxzzzz, g_0_x_yz_xyyyyy, g_0_x_yz_xyyyyyy, g_0_x_yz_xyyyyyz, g_0_x_yz_xyyyyz, g_0_x_yz_xyyyyzz, g_0_x_yz_xyyyzz, g_0_x_yz_xyyyzzz, g_0_x_yz_xyyzzz, g_0_x_yz_xyyzzzz, g_0_x_yz_xyzzzz, g_0_x_yz_xyzzzzz, g_0_x_yz_xzzzzz, g_0_x_yz_yyyyyy, g_0_x_yz_yyyyyyy, g_0_x_yz_yyyyyyz, g_0_x_yz_yyyyyz, g_0_x_yz_yyyyyzz, g_0_x_yz_yyyyzz, g_0_x_yz_yyyyzzz, g_0_x_yz_yyyzzz, g_0_x_yz_yyyzzzz, g_0_x_yz_yyzzzz, g_0_x_yz_yyzzzzz, g_0_x_yz_yzzzzz, g_0_x_yz_yzzzzzz, g_0_x_yz_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_x_yyz_xxxxxx[k] = -g_0_x_yz_xxxxxx[k] * ab_y + g_0_x_yz_xxxxxxy[k];

                g_0_x_yyz_xxxxxy[k] = -g_0_x_yz_xxxxxy[k] * ab_y + g_0_x_yz_xxxxxyy[k];

                g_0_x_yyz_xxxxxz[k] = -g_0_x_yz_xxxxxz[k] * ab_y + g_0_x_yz_xxxxxyz[k];

                g_0_x_yyz_xxxxyy[k] = -g_0_x_yz_xxxxyy[k] * ab_y + g_0_x_yz_xxxxyyy[k];

                g_0_x_yyz_xxxxyz[k] = -g_0_x_yz_xxxxyz[k] * ab_y + g_0_x_yz_xxxxyyz[k];

                g_0_x_yyz_xxxxzz[k] = -g_0_x_yz_xxxxzz[k] * ab_y + g_0_x_yz_xxxxyzz[k];

                g_0_x_yyz_xxxyyy[k] = -g_0_x_yz_xxxyyy[k] * ab_y + g_0_x_yz_xxxyyyy[k];

                g_0_x_yyz_xxxyyz[k] = -g_0_x_yz_xxxyyz[k] * ab_y + g_0_x_yz_xxxyyyz[k];

                g_0_x_yyz_xxxyzz[k] = -g_0_x_yz_xxxyzz[k] * ab_y + g_0_x_yz_xxxyyzz[k];

                g_0_x_yyz_xxxzzz[k] = -g_0_x_yz_xxxzzz[k] * ab_y + g_0_x_yz_xxxyzzz[k];

                g_0_x_yyz_xxyyyy[k] = -g_0_x_yz_xxyyyy[k] * ab_y + g_0_x_yz_xxyyyyy[k];

                g_0_x_yyz_xxyyyz[k] = -g_0_x_yz_xxyyyz[k] * ab_y + g_0_x_yz_xxyyyyz[k];

                g_0_x_yyz_xxyyzz[k] = -g_0_x_yz_xxyyzz[k] * ab_y + g_0_x_yz_xxyyyzz[k];

                g_0_x_yyz_xxyzzz[k] = -g_0_x_yz_xxyzzz[k] * ab_y + g_0_x_yz_xxyyzzz[k];

                g_0_x_yyz_xxzzzz[k] = -g_0_x_yz_xxzzzz[k] * ab_y + g_0_x_yz_xxyzzzz[k];

                g_0_x_yyz_xyyyyy[k] = -g_0_x_yz_xyyyyy[k] * ab_y + g_0_x_yz_xyyyyyy[k];

                g_0_x_yyz_xyyyyz[k] = -g_0_x_yz_xyyyyz[k] * ab_y + g_0_x_yz_xyyyyyz[k];

                g_0_x_yyz_xyyyzz[k] = -g_0_x_yz_xyyyzz[k] * ab_y + g_0_x_yz_xyyyyzz[k];

                g_0_x_yyz_xyyzzz[k] = -g_0_x_yz_xyyzzz[k] * ab_y + g_0_x_yz_xyyyzzz[k];

                g_0_x_yyz_xyzzzz[k] = -g_0_x_yz_xyzzzz[k] * ab_y + g_0_x_yz_xyyzzzz[k];

                g_0_x_yyz_xzzzzz[k] = -g_0_x_yz_xzzzzz[k] * ab_y + g_0_x_yz_xyzzzzz[k];

                g_0_x_yyz_yyyyyy[k] = -g_0_x_yz_yyyyyy[k] * ab_y + g_0_x_yz_yyyyyyy[k];

                g_0_x_yyz_yyyyyz[k] = -g_0_x_yz_yyyyyz[k] * ab_y + g_0_x_yz_yyyyyyz[k];

                g_0_x_yyz_yyyyzz[k] = -g_0_x_yz_yyyyzz[k] * ab_y + g_0_x_yz_yyyyyzz[k];

                g_0_x_yyz_yyyzzz[k] = -g_0_x_yz_yyyzzz[k] * ab_y + g_0_x_yz_yyyyzzz[k];

                g_0_x_yyz_yyzzzz[k] = -g_0_x_yz_yyzzzz[k] * ab_y + g_0_x_yz_yyyzzzz[k];

                g_0_x_yyz_yzzzzz[k] = -g_0_x_yz_yzzzzz[k] * ab_y + g_0_x_yz_yyzzzzz[k];

                g_0_x_yyz_zzzzzz[k] = -g_0_x_yz_zzzzzz[k] * ab_y + g_0_x_yz_yzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_x_yzz_xxxxxx, g_0_x_yzz_xxxxxy, g_0_x_yzz_xxxxxz, g_0_x_yzz_xxxxyy, g_0_x_yzz_xxxxyz, g_0_x_yzz_xxxxzz, g_0_x_yzz_xxxyyy, g_0_x_yzz_xxxyyz, g_0_x_yzz_xxxyzz, g_0_x_yzz_xxxzzz, g_0_x_yzz_xxyyyy, g_0_x_yzz_xxyyyz, g_0_x_yzz_xxyyzz, g_0_x_yzz_xxyzzz, g_0_x_yzz_xxzzzz, g_0_x_yzz_xyyyyy, g_0_x_yzz_xyyyyz, g_0_x_yzz_xyyyzz, g_0_x_yzz_xyyzzz, g_0_x_yzz_xyzzzz, g_0_x_yzz_xzzzzz, g_0_x_yzz_yyyyyy, g_0_x_yzz_yyyyyz, g_0_x_yzz_yyyyzz, g_0_x_yzz_yyyzzz, g_0_x_yzz_yyzzzz, g_0_x_yzz_yzzzzz, g_0_x_yzz_zzzzzz, g_0_x_zz_xxxxxx, g_0_x_zz_xxxxxxy, g_0_x_zz_xxxxxy, g_0_x_zz_xxxxxyy, g_0_x_zz_xxxxxyz, g_0_x_zz_xxxxxz, g_0_x_zz_xxxxyy, g_0_x_zz_xxxxyyy, g_0_x_zz_xxxxyyz, g_0_x_zz_xxxxyz, g_0_x_zz_xxxxyzz, g_0_x_zz_xxxxzz, g_0_x_zz_xxxyyy, g_0_x_zz_xxxyyyy, g_0_x_zz_xxxyyyz, g_0_x_zz_xxxyyz, g_0_x_zz_xxxyyzz, g_0_x_zz_xxxyzz, g_0_x_zz_xxxyzzz, g_0_x_zz_xxxzzz, g_0_x_zz_xxyyyy, g_0_x_zz_xxyyyyy, g_0_x_zz_xxyyyyz, g_0_x_zz_xxyyyz, g_0_x_zz_xxyyyzz, g_0_x_zz_xxyyzz, g_0_x_zz_xxyyzzz, g_0_x_zz_xxyzzz, g_0_x_zz_xxyzzzz, g_0_x_zz_xxzzzz, g_0_x_zz_xyyyyy, g_0_x_zz_xyyyyyy, g_0_x_zz_xyyyyyz, g_0_x_zz_xyyyyz, g_0_x_zz_xyyyyzz, g_0_x_zz_xyyyzz, g_0_x_zz_xyyyzzz, g_0_x_zz_xyyzzz, g_0_x_zz_xyyzzzz, g_0_x_zz_xyzzzz, g_0_x_zz_xyzzzzz, g_0_x_zz_xzzzzz, g_0_x_zz_yyyyyy, g_0_x_zz_yyyyyyy, g_0_x_zz_yyyyyyz, g_0_x_zz_yyyyyz, g_0_x_zz_yyyyyzz, g_0_x_zz_yyyyzz, g_0_x_zz_yyyyzzz, g_0_x_zz_yyyzzz, g_0_x_zz_yyyzzzz, g_0_x_zz_yyzzzz, g_0_x_zz_yyzzzzz, g_0_x_zz_yzzzzz, g_0_x_zz_yzzzzzz, g_0_x_zz_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_x_yzz_xxxxxx[k] = -g_0_x_zz_xxxxxx[k] * ab_y + g_0_x_zz_xxxxxxy[k];

                g_0_x_yzz_xxxxxy[k] = -g_0_x_zz_xxxxxy[k] * ab_y + g_0_x_zz_xxxxxyy[k];

                g_0_x_yzz_xxxxxz[k] = -g_0_x_zz_xxxxxz[k] * ab_y + g_0_x_zz_xxxxxyz[k];

                g_0_x_yzz_xxxxyy[k] = -g_0_x_zz_xxxxyy[k] * ab_y + g_0_x_zz_xxxxyyy[k];

                g_0_x_yzz_xxxxyz[k] = -g_0_x_zz_xxxxyz[k] * ab_y + g_0_x_zz_xxxxyyz[k];

                g_0_x_yzz_xxxxzz[k] = -g_0_x_zz_xxxxzz[k] * ab_y + g_0_x_zz_xxxxyzz[k];

                g_0_x_yzz_xxxyyy[k] = -g_0_x_zz_xxxyyy[k] * ab_y + g_0_x_zz_xxxyyyy[k];

                g_0_x_yzz_xxxyyz[k] = -g_0_x_zz_xxxyyz[k] * ab_y + g_0_x_zz_xxxyyyz[k];

                g_0_x_yzz_xxxyzz[k] = -g_0_x_zz_xxxyzz[k] * ab_y + g_0_x_zz_xxxyyzz[k];

                g_0_x_yzz_xxxzzz[k] = -g_0_x_zz_xxxzzz[k] * ab_y + g_0_x_zz_xxxyzzz[k];

                g_0_x_yzz_xxyyyy[k] = -g_0_x_zz_xxyyyy[k] * ab_y + g_0_x_zz_xxyyyyy[k];

                g_0_x_yzz_xxyyyz[k] = -g_0_x_zz_xxyyyz[k] * ab_y + g_0_x_zz_xxyyyyz[k];

                g_0_x_yzz_xxyyzz[k] = -g_0_x_zz_xxyyzz[k] * ab_y + g_0_x_zz_xxyyyzz[k];

                g_0_x_yzz_xxyzzz[k] = -g_0_x_zz_xxyzzz[k] * ab_y + g_0_x_zz_xxyyzzz[k];

                g_0_x_yzz_xxzzzz[k] = -g_0_x_zz_xxzzzz[k] * ab_y + g_0_x_zz_xxyzzzz[k];

                g_0_x_yzz_xyyyyy[k] = -g_0_x_zz_xyyyyy[k] * ab_y + g_0_x_zz_xyyyyyy[k];

                g_0_x_yzz_xyyyyz[k] = -g_0_x_zz_xyyyyz[k] * ab_y + g_0_x_zz_xyyyyyz[k];

                g_0_x_yzz_xyyyzz[k] = -g_0_x_zz_xyyyzz[k] * ab_y + g_0_x_zz_xyyyyzz[k];

                g_0_x_yzz_xyyzzz[k] = -g_0_x_zz_xyyzzz[k] * ab_y + g_0_x_zz_xyyyzzz[k];

                g_0_x_yzz_xyzzzz[k] = -g_0_x_zz_xyzzzz[k] * ab_y + g_0_x_zz_xyyzzzz[k];

                g_0_x_yzz_xzzzzz[k] = -g_0_x_zz_xzzzzz[k] * ab_y + g_0_x_zz_xyzzzzz[k];

                g_0_x_yzz_yyyyyy[k] = -g_0_x_zz_yyyyyy[k] * ab_y + g_0_x_zz_yyyyyyy[k];

                g_0_x_yzz_yyyyyz[k] = -g_0_x_zz_yyyyyz[k] * ab_y + g_0_x_zz_yyyyyyz[k];

                g_0_x_yzz_yyyyzz[k] = -g_0_x_zz_yyyyzz[k] * ab_y + g_0_x_zz_yyyyyzz[k];

                g_0_x_yzz_yyyzzz[k] = -g_0_x_zz_yyyzzz[k] * ab_y + g_0_x_zz_yyyyzzz[k];

                g_0_x_yzz_yyzzzz[k] = -g_0_x_zz_yyzzzz[k] * ab_y + g_0_x_zz_yyyzzzz[k];

                g_0_x_yzz_yzzzzz[k] = -g_0_x_zz_yzzzzz[k] * ab_y + g_0_x_zz_yyzzzzz[k];

                g_0_x_yzz_zzzzzz[k] = -g_0_x_zz_zzzzzz[k] * ab_y + g_0_x_zz_yzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_x_zz_xxxxxx, g_0_x_zz_xxxxxxz, g_0_x_zz_xxxxxy, g_0_x_zz_xxxxxyz, g_0_x_zz_xxxxxz, g_0_x_zz_xxxxxzz, g_0_x_zz_xxxxyy, g_0_x_zz_xxxxyyz, g_0_x_zz_xxxxyz, g_0_x_zz_xxxxyzz, g_0_x_zz_xxxxzz, g_0_x_zz_xxxxzzz, g_0_x_zz_xxxyyy, g_0_x_zz_xxxyyyz, g_0_x_zz_xxxyyz, g_0_x_zz_xxxyyzz, g_0_x_zz_xxxyzz, g_0_x_zz_xxxyzzz, g_0_x_zz_xxxzzz, g_0_x_zz_xxxzzzz, g_0_x_zz_xxyyyy, g_0_x_zz_xxyyyyz, g_0_x_zz_xxyyyz, g_0_x_zz_xxyyyzz, g_0_x_zz_xxyyzz, g_0_x_zz_xxyyzzz, g_0_x_zz_xxyzzz, g_0_x_zz_xxyzzzz, g_0_x_zz_xxzzzz, g_0_x_zz_xxzzzzz, g_0_x_zz_xyyyyy, g_0_x_zz_xyyyyyz, g_0_x_zz_xyyyyz, g_0_x_zz_xyyyyzz, g_0_x_zz_xyyyzz, g_0_x_zz_xyyyzzz, g_0_x_zz_xyyzzz, g_0_x_zz_xyyzzzz, g_0_x_zz_xyzzzz, g_0_x_zz_xyzzzzz, g_0_x_zz_xzzzzz, g_0_x_zz_xzzzzzz, g_0_x_zz_yyyyyy, g_0_x_zz_yyyyyyz, g_0_x_zz_yyyyyz, g_0_x_zz_yyyyyzz, g_0_x_zz_yyyyzz, g_0_x_zz_yyyyzzz, g_0_x_zz_yyyzzz, g_0_x_zz_yyyzzzz, g_0_x_zz_yyzzzz, g_0_x_zz_yyzzzzz, g_0_x_zz_yzzzzz, g_0_x_zz_yzzzzzz, g_0_x_zz_zzzzzz, g_0_x_zz_zzzzzzz, g_0_x_zzz_xxxxxx, g_0_x_zzz_xxxxxy, g_0_x_zzz_xxxxxz, g_0_x_zzz_xxxxyy, g_0_x_zzz_xxxxyz, g_0_x_zzz_xxxxzz, g_0_x_zzz_xxxyyy, g_0_x_zzz_xxxyyz, g_0_x_zzz_xxxyzz, g_0_x_zzz_xxxzzz, g_0_x_zzz_xxyyyy, g_0_x_zzz_xxyyyz, g_0_x_zzz_xxyyzz, g_0_x_zzz_xxyzzz, g_0_x_zzz_xxzzzz, g_0_x_zzz_xyyyyy, g_0_x_zzz_xyyyyz, g_0_x_zzz_xyyyzz, g_0_x_zzz_xyyzzz, g_0_x_zzz_xyzzzz, g_0_x_zzz_xzzzzz, g_0_x_zzz_yyyyyy, g_0_x_zzz_yyyyyz, g_0_x_zzz_yyyyzz, g_0_x_zzz_yyyzzz, g_0_x_zzz_yyzzzz, g_0_x_zzz_yzzzzz, g_0_x_zzz_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_x_zzz_xxxxxx[k] = -g_0_x_zz_xxxxxx[k] * ab_z + g_0_x_zz_xxxxxxz[k];

                g_0_x_zzz_xxxxxy[k] = -g_0_x_zz_xxxxxy[k] * ab_z + g_0_x_zz_xxxxxyz[k];

                g_0_x_zzz_xxxxxz[k] = -g_0_x_zz_xxxxxz[k] * ab_z + g_0_x_zz_xxxxxzz[k];

                g_0_x_zzz_xxxxyy[k] = -g_0_x_zz_xxxxyy[k] * ab_z + g_0_x_zz_xxxxyyz[k];

                g_0_x_zzz_xxxxyz[k] = -g_0_x_zz_xxxxyz[k] * ab_z + g_0_x_zz_xxxxyzz[k];

                g_0_x_zzz_xxxxzz[k] = -g_0_x_zz_xxxxzz[k] * ab_z + g_0_x_zz_xxxxzzz[k];

                g_0_x_zzz_xxxyyy[k] = -g_0_x_zz_xxxyyy[k] * ab_z + g_0_x_zz_xxxyyyz[k];

                g_0_x_zzz_xxxyyz[k] = -g_0_x_zz_xxxyyz[k] * ab_z + g_0_x_zz_xxxyyzz[k];

                g_0_x_zzz_xxxyzz[k] = -g_0_x_zz_xxxyzz[k] * ab_z + g_0_x_zz_xxxyzzz[k];

                g_0_x_zzz_xxxzzz[k] = -g_0_x_zz_xxxzzz[k] * ab_z + g_0_x_zz_xxxzzzz[k];

                g_0_x_zzz_xxyyyy[k] = -g_0_x_zz_xxyyyy[k] * ab_z + g_0_x_zz_xxyyyyz[k];

                g_0_x_zzz_xxyyyz[k] = -g_0_x_zz_xxyyyz[k] * ab_z + g_0_x_zz_xxyyyzz[k];

                g_0_x_zzz_xxyyzz[k] = -g_0_x_zz_xxyyzz[k] * ab_z + g_0_x_zz_xxyyzzz[k];

                g_0_x_zzz_xxyzzz[k] = -g_0_x_zz_xxyzzz[k] * ab_z + g_0_x_zz_xxyzzzz[k];

                g_0_x_zzz_xxzzzz[k] = -g_0_x_zz_xxzzzz[k] * ab_z + g_0_x_zz_xxzzzzz[k];

                g_0_x_zzz_xyyyyy[k] = -g_0_x_zz_xyyyyy[k] * ab_z + g_0_x_zz_xyyyyyz[k];

                g_0_x_zzz_xyyyyz[k] = -g_0_x_zz_xyyyyz[k] * ab_z + g_0_x_zz_xyyyyzz[k];

                g_0_x_zzz_xyyyzz[k] = -g_0_x_zz_xyyyzz[k] * ab_z + g_0_x_zz_xyyyzzz[k];

                g_0_x_zzz_xyyzzz[k] = -g_0_x_zz_xyyzzz[k] * ab_z + g_0_x_zz_xyyzzzz[k];

                g_0_x_zzz_xyzzzz[k] = -g_0_x_zz_xyzzzz[k] * ab_z + g_0_x_zz_xyzzzzz[k];

                g_0_x_zzz_xzzzzz[k] = -g_0_x_zz_xzzzzz[k] * ab_z + g_0_x_zz_xzzzzzz[k];

                g_0_x_zzz_yyyyyy[k] = -g_0_x_zz_yyyyyy[k] * ab_z + g_0_x_zz_yyyyyyz[k];

                g_0_x_zzz_yyyyyz[k] = -g_0_x_zz_yyyyyz[k] * ab_z + g_0_x_zz_yyyyyzz[k];

                g_0_x_zzz_yyyyzz[k] = -g_0_x_zz_yyyyzz[k] * ab_z + g_0_x_zz_yyyyzzz[k];

                g_0_x_zzz_yyyzzz[k] = -g_0_x_zz_yyyzzz[k] * ab_z + g_0_x_zz_yyyzzzz[k];

                g_0_x_zzz_yyzzzz[k] = -g_0_x_zz_yyzzzz[k] * ab_z + g_0_x_zz_yyzzzzz[k];

                g_0_x_zzz_yzzzzz[k] = -g_0_x_zz_yzzzzz[k] * ab_z + g_0_x_zz_yzzzzzz[k];

                g_0_x_zzz_zzzzzz[k] = -g_0_x_zz_zzzzzz[k] * ab_z + g_0_x_zz_zzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_y_xx_xxxxxx, g_0_y_xx_xxxxxxx, g_0_y_xx_xxxxxxy, g_0_y_xx_xxxxxxz, g_0_y_xx_xxxxxy, g_0_y_xx_xxxxxyy, g_0_y_xx_xxxxxyz, g_0_y_xx_xxxxxz, g_0_y_xx_xxxxxzz, g_0_y_xx_xxxxyy, g_0_y_xx_xxxxyyy, g_0_y_xx_xxxxyyz, g_0_y_xx_xxxxyz, g_0_y_xx_xxxxyzz, g_0_y_xx_xxxxzz, g_0_y_xx_xxxxzzz, g_0_y_xx_xxxyyy, g_0_y_xx_xxxyyyy, g_0_y_xx_xxxyyyz, g_0_y_xx_xxxyyz, g_0_y_xx_xxxyyzz, g_0_y_xx_xxxyzz, g_0_y_xx_xxxyzzz, g_0_y_xx_xxxzzz, g_0_y_xx_xxxzzzz, g_0_y_xx_xxyyyy, g_0_y_xx_xxyyyyy, g_0_y_xx_xxyyyyz, g_0_y_xx_xxyyyz, g_0_y_xx_xxyyyzz, g_0_y_xx_xxyyzz, g_0_y_xx_xxyyzzz, g_0_y_xx_xxyzzz, g_0_y_xx_xxyzzzz, g_0_y_xx_xxzzzz, g_0_y_xx_xxzzzzz, g_0_y_xx_xyyyyy, g_0_y_xx_xyyyyyy, g_0_y_xx_xyyyyyz, g_0_y_xx_xyyyyz, g_0_y_xx_xyyyyzz, g_0_y_xx_xyyyzz, g_0_y_xx_xyyyzzz, g_0_y_xx_xyyzzz, g_0_y_xx_xyyzzzz, g_0_y_xx_xyzzzz, g_0_y_xx_xyzzzzz, g_0_y_xx_xzzzzz, g_0_y_xx_xzzzzzz, g_0_y_xx_yyyyyy, g_0_y_xx_yyyyyz, g_0_y_xx_yyyyzz, g_0_y_xx_yyyzzz, g_0_y_xx_yyzzzz, g_0_y_xx_yzzzzz, g_0_y_xx_zzzzzz, g_0_y_xxx_xxxxxx, g_0_y_xxx_xxxxxy, g_0_y_xxx_xxxxxz, g_0_y_xxx_xxxxyy, g_0_y_xxx_xxxxyz, g_0_y_xxx_xxxxzz, g_0_y_xxx_xxxyyy, g_0_y_xxx_xxxyyz, g_0_y_xxx_xxxyzz, g_0_y_xxx_xxxzzz, g_0_y_xxx_xxyyyy, g_0_y_xxx_xxyyyz, g_0_y_xxx_xxyyzz, g_0_y_xxx_xxyzzz, g_0_y_xxx_xxzzzz, g_0_y_xxx_xyyyyy, g_0_y_xxx_xyyyyz, g_0_y_xxx_xyyyzz, g_0_y_xxx_xyyzzz, g_0_y_xxx_xyzzzz, g_0_y_xxx_xzzzzz, g_0_y_xxx_yyyyyy, g_0_y_xxx_yyyyyz, g_0_y_xxx_yyyyzz, g_0_y_xxx_yyyzzz, g_0_y_xxx_yyzzzz, g_0_y_xxx_yzzzzz, g_0_y_xxx_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_y_xxx_xxxxxx[k] = -g_0_y_xx_xxxxxx[k] * ab_x + g_0_y_xx_xxxxxxx[k];

                g_0_y_xxx_xxxxxy[k] = -g_0_y_xx_xxxxxy[k] * ab_x + g_0_y_xx_xxxxxxy[k];

                g_0_y_xxx_xxxxxz[k] = -g_0_y_xx_xxxxxz[k] * ab_x + g_0_y_xx_xxxxxxz[k];

                g_0_y_xxx_xxxxyy[k] = -g_0_y_xx_xxxxyy[k] * ab_x + g_0_y_xx_xxxxxyy[k];

                g_0_y_xxx_xxxxyz[k] = -g_0_y_xx_xxxxyz[k] * ab_x + g_0_y_xx_xxxxxyz[k];

                g_0_y_xxx_xxxxzz[k] = -g_0_y_xx_xxxxzz[k] * ab_x + g_0_y_xx_xxxxxzz[k];

                g_0_y_xxx_xxxyyy[k] = -g_0_y_xx_xxxyyy[k] * ab_x + g_0_y_xx_xxxxyyy[k];

                g_0_y_xxx_xxxyyz[k] = -g_0_y_xx_xxxyyz[k] * ab_x + g_0_y_xx_xxxxyyz[k];

                g_0_y_xxx_xxxyzz[k] = -g_0_y_xx_xxxyzz[k] * ab_x + g_0_y_xx_xxxxyzz[k];

                g_0_y_xxx_xxxzzz[k] = -g_0_y_xx_xxxzzz[k] * ab_x + g_0_y_xx_xxxxzzz[k];

                g_0_y_xxx_xxyyyy[k] = -g_0_y_xx_xxyyyy[k] * ab_x + g_0_y_xx_xxxyyyy[k];

                g_0_y_xxx_xxyyyz[k] = -g_0_y_xx_xxyyyz[k] * ab_x + g_0_y_xx_xxxyyyz[k];

                g_0_y_xxx_xxyyzz[k] = -g_0_y_xx_xxyyzz[k] * ab_x + g_0_y_xx_xxxyyzz[k];

                g_0_y_xxx_xxyzzz[k] = -g_0_y_xx_xxyzzz[k] * ab_x + g_0_y_xx_xxxyzzz[k];

                g_0_y_xxx_xxzzzz[k] = -g_0_y_xx_xxzzzz[k] * ab_x + g_0_y_xx_xxxzzzz[k];

                g_0_y_xxx_xyyyyy[k] = -g_0_y_xx_xyyyyy[k] * ab_x + g_0_y_xx_xxyyyyy[k];

                g_0_y_xxx_xyyyyz[k] = -g_0_y_xx_xyyyyz[k] * ab_x + g_0_y_xx_xxyyyyz[k];

                g_0_y_xxx_xyyyzz[k] = -g_0_y_xx_xyyyzz[k] * ab_x + g_0_y_xx_xxyyyzz[k];

                g_0_y_xxx_xyyzzz[k] = -g_0_y_xx_xyyzzz[k] * ab_x + g_0_y_xx_xxyyzzz[k];

                g_0_y_xxx_xyzzzz[k] = -g_0_y_xx_xyzzzz[k] * ab_x + g_0_y_xx_xxyzzzz[k];

                g_0_y_xxx_xzzzzz[k] = -g_0_y_xx_xzzzzz[k] * ab_x + g_0_y_xx_xxzzzzz[k];

                g_0_y_xxx_yyyyyy[k] = -g_0_y_xx_yyyyyy[k] * ab_x + g_0_y_xx_xyyyyyy[k];

                g_0_y_xxx_yyyyyz[k] = -g_0_y_xx_yyyyyz[k] * ab_x + g_0_y_xx_xyyyyyz[k];

                g_0_y_xxx_yyyyzz[k] = -g_0_y_xx_yyyyzz[k] * ab_x + g_0_y_xx_xyyyyzz[k];

                g_0_y_xxx_yyyzzz[k] = -g_0_y_xx_yyyzzz[k] * ab_x + g_0_y_xx_xyyyzzz[k];

                g_0_y_xxx_yyzzzz[k] = -g_0_y_xx_yyzzzz[k] * ab_x + g_0_y_xx_xyyzzzz[k];

                g_0_y_xxx_yzzzzz[k] = -g_0_y_xx_yzzzzz[k] * ab_x + g_0_y_xx_xyzzzzz[k];

                g_0_y_xxx_zzzzzz[k] = -g_0_y_xx_zzzzzz[k] * ab_x + g_0_y_xx_xzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_y_xxy_xxxxxx, g_0_y_xxy_xxxxxy, g_0_y_xxy_xxxxxz, g_0_y_xxy_xxxxyy, g_0_y_xxy_xxxxyz, g_0_y_xxy_xxxxzz, g_0_y_xxy_xxxyyy, g_0_y_xxy_xxxyyz, g_0_y_xxy_xxxyzz, g_0_y_xxy_xxxzzz, g_0_y_xxy_xxyyyy, g_0_y_xxy_xxyyyz, g_0_y_xxy_xxyyzz, g_0_y_xxy_xxyzzz, g_0_y_xxy_xxzzzz, g_0_y_xxy_xyyyyy, g_0_y_xxy_xyyyyz, g_0_y_xxy_xyyyzz, g_0_y_xxy_xyyzzz, g_0_y_xxy_xyzzzz, g_0_y_xxy_xzzzzz, g_0_y_xxy_yyyyyy, g_0_y_xxy_yyyyyz, g_0_y_xxy_yyyyzz, g_0_y_xxy_yyyzzz, g_0_y_xxy_yyzzzz, g_0_y_xxy_yzzzzz, g_0_y_xxy_zzzzzz, g_0_y_xy_xxxxxx, g_0_y_xy_xxxxxxx, g_0_y_xy_xxxxxxy, g_0_y_xy_xxxxxxz, g_0_y_xy_xxxxxy, g_0_y_xy_xxxxxyy, g_0_y_xy_xxxxxyz, g_0_y_xy_xxxxxz, g_0_y_xy_xxxxxzz, g_0_y_xy_xxxxyy, g_0_y_xy_xxxxyyy, g_0_y_xy_xxxxyyz, g_0_y_xy_xxxxyz, g_0_y_xy_xxxxyzz, g_0_y_xy_xxxxzz, g_0_y_xy_xxxxzzz, g_0_y_xy_xxxyyy, g_0_y_xy_xxxyyyy, g_0_y_xy_xxxyyyz, g_0_y_xy_xxxyyz, g_0_y_xy_xxxyyzz, g_0_y_xy_xxxyzz, g_0_y_xy_xxxyzzz, g_0_y_xy_xxxzzz, g_0_y_xy_xxxzzzz, g_0_y_xy_xxyyyy, g_0_y_xy_xxyyyyy, g_0_y_xy_xxyyyyz, g_0_y_xy_xxyyyz, g_0_y_xy_xxyyyzz, g_0_y_xy_xxyyzz, g_0_y_xy_xxyyzzz, g_0_y_xy_xxyzzz, g_0_y_xy_xxyzzzz, g_0_y_xy_xxzzzz, g_0_y_xy_xxzzzzz, g_0_y_xy_xyyyyy, g_0_y_xy_xyyyyyy, g_0_y_xy_xyyyyyz, g_0_y_xy_xyyyyz, g_0_y_xy_xyyyyzz, g_0_y_xy_xyyyzz, g_0_y_xy_xyyyzzz, g_0_y_xy_xyyzzz, g_0_y_xy_xyyzzzz, g_0_y_xy_xyzzzz, g_0_y_xy_xyzzzzz, g_0_y_xy_xzzzzz, g_0_y_xy_xzzzzzz, g_0_y_xy_yyyyyy, g_0_y_xy_yyyyyz, g_0_y_xy_yyyyzz, g_0_y_xy_yyyzzz, g_0_y_xy_yyzzzz, g_0_y_xy_yzzzzz, g_0_y_xy_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_y_xxy_xxxxxx[k] = -g_0_y_xy_xxxxxx[k] * ab_x + g_0_y_xy_xxxxxxx[k];

                g_0_y_xxy_xxxxxy[k] = -g_0_y_xy_xxxxxy[k] * ab_x + g_0_y_xy_xxxxxxy[k];

                g_0_y_xxy_xxxxxz[k] = -g_0_y_xy_xxxxxz[k] * ab_x + g_0_y_xy_xxxxxxz[k];

                g_0_y_xxy_xxxxyy[k] = -g_0_y_xy_xxxxyy[k] * ab_x + g_0_y_xy_xxxxxyy[k];

                g_0_y_xxy_xxxxyz[k] = -g_0_y_xy_xxxxyz[k] * ab_x + g_0_y_xy_xxxxxyz[k];

                g_0_y_xxy_xxxxzz[k] = -g_0_y_xy_xxxxzz[k] * ab_x + g_0_y_xy_xxxxxzz[k];

                g_0_y_xxy_xxxyyy[k] = -g_0_y_xy_xxxyyy[k] * ab_x + g_0_y_xy_xxxxyyy[k];

                g_0_y_xxy_xxxyyz[k] = -g_0_y_xy_xxxyyz[k] * ab_x + g_0_y_xy_xxxxyyz[k];

                g_0_y_xxy_xxxyzz[k] = -g_0_y_xy_xxxyzz[k] * ab_x + g_0_y_xy_xxxxyzz[k];

                g_0_y_xxy_xxxzzz[k] = -g_0_y_xy_xxxzzz[k] * ab_x + g_0_y_xy_xxxxzzz[k];

                g_0_y_xxy_xxyyyy[k] = -g_0_y_xy_xxyyyy[k] * ab_x + g_0_y_xy_xxxyyyy[k];

                g_0_y_xxy_xxyyyz[k] = -g_0_y_xy_xxyyyz[k] * ab_x + g_0_y_xy_xxxyyyz[k];

                g_0_y_xxy_xxyyzz[k] = -g_0_y_xy_xxyyzz[k] * ab_x + g_0_y_xy_xxxyyzz[k];

                g_0_y_xxy_xxyzzz[k] = -g_0_y_xy_xxyzzz[k] * ab_x + g_0_y_xy_xxxyzzz[k];

                g_0_y_xxy_xxzzzz[k] = -g_0_y_xy_xxzzzz[k] * ab_x + g_0_y_xy_xxxzzzz[k];

                g_0_y_xxy_xyyyyy[k] = -g_0_y_xy_xyyyyy[k] * ab_x + g_0_y_xy_xxyyyyy[k];

                g_0_y_xxy_xyyyyz[k] = -g_0_y_xy_xyyyyz[k] * ab_x + g_0_y_xy_xxyyyyz[k];

                g_0_y_xxy_xyyyzz[k] = -g_0_y_xy_xyyyzz[k] * ab_x + g_0_y_xy_xxyyyzz[k];

                g_0_y_xxy_xyyzzz[k] = -g_0_y_xy_xyyzzz[k] * ab_x + g_0_y_xy_xxyyzzz[k];

                g_0_y_xxy_xyzzzz[k] = -g_0_y_xy_xyzzzz[k] * ab_x + g_0_y_xy_xxyzzzz[k];

                g_0_y_xxy_xzzzzz[k] = -g_0_y_xy_xzzzzz[k] * ab_x + g_0_y_xy_xxzzzzz[k];

                g_0_y_xxy_yyyyyy[k] = -g_0_y_xy_yyyyyy[k] * ab_x + g_0_y_xy_xyyyyyy[k];

                g_0_y_xxy_yyyyyz[k] = -g_0_y_xy_yyyyyz[k] * ab_x + g_0_y_xy_xyyyyyz[k];

                g_0_y_xxy_yyyyzz[k] = -g_0_y_xy_yyyyzz[k] * ab_x + g_0_y_xy_xyyyyzz[k];

                g_0_y_xxy_yyyzzz[k] = -g_0_y_xy_yyyzzz[k] * ab_x + g_0_y_xy_xyyyzzz[k];

                g_0_y_xxy_yyzzzz[k] = -g_0_y_xy_yyzzzz[k] * ab_x + g_0_y_xy_xyyzzzz[k];

                g_0_y_xxy_yzzzzz[k] = -g_0_y_xy_yzzzzz[k] * ab_x + g_0_y_xy_xyzzzzz[k];

                g_0_y_xxy_zzzzzz[k] = -g_0_y_xy_zzzzzz[k] * ab_x + g_0_y_xy_xzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_y_xxz_xxxxxx, g_0_y_xxz_xxxxxy, g_0_y_xxz_xxxxxz, g_0_y_xxz_xxxxyy, g_0_y_xxz_xxxxyz, g_0_y_xxz_xxxxzz, g_0_y_xxz_xxxyyy, g_0_y_xxz_xxxyyz, g_0_y_xxz_xxxyzz, g_0_y_xxz_xxxzzz, g_0_y_xxz_xxyyyy, g_0_y_xxz_xxyyyz, g_0_y_xxz_xxyyzz, g_0_y_xxz_xxyzzz, g_0_y_xxz_xxzzzz, g_0_y_xxz_xyyyyy, g_0_y_xxz_xyyyyz, g_0_y_xxz_xyyyzz, g_0_y_xxz_xyyzzz, g_0_y_xxz_xyzzzz, g_0_y_xxz_xzzzzz, g_0_y_xxz_yyyyyy, g_0_y_xxz_yyyyyz, g_0_y_xxz_yyyyzz, g_0_y_xxz_yyyzzz, g_0_y_xxz_yyzzzz, g_0_y_xxz_yzzzzz, g_0_y_xxz_zzzzzz, g_0_y_xz_xxxxxx, g_0_y_xz_xxxxxxx, g_0_y_xz_xxxxxxy, g_0_y_xz_xxxxxxz, g_0_y_xz_xxxxxy, g_0_y_xz_xxxxxyy, g_0_y_xz_xxxxxyz, g_0_y_xz_xxxxxz, g_0_y_xz_xxxxxzz, g_0_y_xz_xxxxyy, g_0_y_xz_xxxxyyy, g_0_y_xz_xxxxyyz, g_0_y_xz_xxxxyz, g_0_y_xz_xxxxyzz, g_0_y_xz_xxxxzz, g_0_y_xz_xxxxzzz, g_0_y_xz_xxxyyy, g_0_y_xz_xxxyyyy, g_0_y_xz_xxxyyyz, g_0_y_xz_xxxyyz, g_0_y_xz_xxxyyzz, g_0_y_xz_xxxyzz, g_0_y_xz_xxxyzzz, g_0_y_xz_xxxzzz, g_0_y_xz_xxxzzzz, g_0_y_xz_xxyyyy, g_0_y_xz_xxyyyyy, g_0_y_xz_xxyyyyz, g_0_y_xz_xxyyyz, g_0_y_xz_xxyyyzz, g_0_y_xz_xxyyzz, g_0_y_xz_xxyyzzz, g_0_y_xz_xxyzzz, g_0_y_xz_xxyzzzz, g_0_y_xz_xxzzzz, g_0_y_xz_xxzzzzz, g_0_y_xz_xyyyyy, g_0_y_xz_xyyyyyy, g_0_y_xz_xyyyyyz, g_0_y_xz_xyyyyz, g_0_y_xz_xyyyyzz, g_0_y_xz_xyyyzz, g_0_y_xz_xyyyzzz, g_0_y_xz_xyyzzz, g_0_y_xz_xyyzzzz, g_0_y_xz_xyzzzz, g_0_y_xz_xyzzzzz, g_0_y_xz_xzzzzz, g_0_y_xz_xzzzzzz, g_0_y_xz_yyyyyy, g_0_y_xz_yyyyyz, g_0_y_xz_yyyyzz, g_0_y_xz_yyyzzz, g_0_y_xz_yyzzzz, g_0_y_xz_yzzzzz, g_0_y_xz_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_y_xxz_xxxxxx[k] = -g_0_y_xz_xxxxxx[k] * ab_x + g_0_y_xz_xxxxxxx[k];

                g_0_y_xxz_xxxxxy[k] = -g_0_y_xz_xxxxxy[k] * ab_x + g_0_y_xz_xxxxxxy[k];

                g_0_y_xxz_xxxxxz[k] = -g_0_y_xz_xxxxxz[k] * ab_x + g_0_y_xz_xxxxxxz[k];

                g_0_y_xxz_xxxxyy[k] = -g_0_y_xz_xxxxyy[k] * ab_x + g_0_y_xz_xxxxxyy[k];

                g_0_y_xxz_xxxxyz[k] = -g_0_y_xz_xxxxyz[k] * ab_x + g_0_y_xz_xxxxxyz[k];

                g_0_y_xxz_xxxxzz[k] = -g_0_y_xz_xxxxzz[k] * ab_x + g_0_y_xz_xxxxxzz[k];

                g_0_y_xxz_xxxyyy[k] = -g_0_y_xz_xxxyyy[k] * ab_x + g_0_y_xz_xxxxyyy[k];

                g_0_y_xxz_xxxyyz[k] = -g_0_y_xz_xxxyyz[k] * ab_x + g_0_y_xz_xxxxyyz[k];

                g_0_y_xxz_xxxyzz[k] = -g_0_y_xz_xxxyzz[k] * ab_x + g_0_y_xz_xxxxyzz[k];

                g_0_y_xxz_xxxzzz[k] = -g_0_y_xz_xxxzzz[k] * ab_x + g_0_y_xz_xxxxzzz[k];

                g_0_y_xxz_xxyyyy[k] = -g_0_y_xz_xxyyyy[k] * ab_x + g_0_y_xz_xxxyyyy[k];

                g_0_y_xxz_xxyyyz[k] = -g_0_y_xz_xxyyyz[k] * ab_x + g_0_y_xz_xxxyyyz[k];

                g_0_y_xxz_xxyyzz[k] = -g_0_y_xz_xxyyzz[k] * ab_x + g_0_y_xz_xxxyyzz[k];

                g_0_y_xxz_xxyzzz[k] = -g_0_y_xz_xxyzzz[k] * ab_x + g_0_y_xz_xxxyzzz[k];

                g_0_y_xxz_xxzzzz[k] = -g_0_y_xz_xxzzzz[k] * ab_x + g_0_y_xz_xxxzzzz[k];

                g_0_y_xxz_xyyyyy[k] = -g_0_y_xz_xyyyyy[k] * ab_x + g_0_y_xz_xxyyyyy[k];

                g_0_y_xxz_xyyyyz[k] = -g_0_y_xz_xyyyyz[k] * ab_x + g_0_y_xz_xxyyyyz[k];

                g_0_y_xxz_xyyyzz[k] = -g_0_y_xz_xyyyzz[k] * ab_x + g_0_y_xz_xxyyyzz[k];

                g_0_y_xxz_xyyzzz[k] = -g_0_y_xz_xyyzzz[k] * ab_x + g_0_y_xz_xxyyzzz[k];

                g_0_y_xxz_xyzzzz[k] = -g_0_y_xz_xyzzzz[k] * ab_x + g_0_y_xz_xxyzzzz[k];

                g_0_y_xxz_xzzzzz[k] = -g_0_y_xz_xzzzzz[k] * ab_x + g_0_y_xz_xxzzzzz[k];

                g_0_y_xxz_yyyyyy[k] = -g_0_y_xz_yyyyyy[k] * ab_x + g_0_y_xz_xyyyyyy[k];

                g_0_y_xxz_yyyyyz[k] = -g_0_y_xz_yyyyyz[k] * ab_x + g_0_y_xz_xyyyyyz[k];

                g_0_y_xxz_yyyyzz[k] = -g_0_y_xz_yyyyzz[k] * ab_x + g_0_y_xz_xyyyyzz[k];

                g_0_y_xxz_yyyzzz[k] = -g_0_y_xz_yyyzzz[k] * ab_x + g_0_y_xz_xyyyzzz[k];

                g_0_y_xxz_yyzzzz[k] = -g_0_y_xz_yyzzzz[k] * ab_x + g_0_y_xz_xyyzzzz[k];

                g_0_y_xxz_yzzzzz[k] = -g_0_y_xz_yzzzzz[k] * ab_x + g_0_y_xz_xyzzzzz[k];

                g_0_y_xxz_zzzzzz[k] = -g_0_y_xz_zzzzzz[k] * ab_x + g_0_y_xz_xzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_y_xyy_xxxxxx, g_0_y_xyy_xxxxxy, g_0_y_xyy_xxxxxz, g_0_y_xyy_xxxxyy, g_0_y_xyy_xxxxyz, g_0_y_xyy_xxxxzz, g_0_y_xyy_xxxyyy, g_0_y_xyy_xxxyyz, g_0_y_xyy_xxxyzz, g_0_y_xyy_xxxzzz, g_0_y_xyy_xxyyyy, g_0_y_xyy_xxyyyz, g_0_y_xyy_xxyyzz, g_0_y_xyy_xxyzzz, g_0_y_xyy_xxzzzz, g_0_y_xyy_xyyyyy, g_0_y_xyy_xyyyyz, g_0_y_xyy_xyyyzz, g_0_y_xyy_xyyzzz, g_0_y_xyy_xyzzzz, g_0_y_xyy_xzzzzz, g_0_y_xyy_yyyyyy, g_0_y_xyy_yyyyyz, g_0_y_xyy_yyyyzz, g_0_y_xyy_yyyzzz, g_0_y_xyy_yyzzzz, g_0_y_xyy_yzzzzz, g_0_y_xyy_zzzzzz, g_0_y_yy_xxxxxx, g_0_y_yy_xxxxxxx, g_0_y_yy_xxxxxxy, g_0_y_yy_xxxxxxz, g_0_y_yy_xxxxxy, g_0_y_yy_xxxxxyy, g_0_y_yy_xxxxxyz, g_0_y_yy_xxxxxz, g_0_y_yy_xxxxxzz, g_0_y_yy_xxxxyy, g_0_y_yy_xxxxyyy, g_0_y_yy_xxxxyyz, g_0_y_yy_xxxxyz, g_0_y_yy_xxxxyzz, g_0_y_yy_xxxxzz, g_0_y_yy_xxxxzzz, g_0_y_yy_xxxyyy, g_0_y_yy_xxxyyyy, g_0_y_yy_xxxyyyz, g_0_y_yy_xxxyyz, g_0_y_yy_xxxyyzz, g_0_y_yy_xxxyzz, g_0_y_yy_xxxyzzz, g_0_y_yy_xxxzzz, g_0_y_yy_xxxzzzz, g_0_y_yy_xxyyyy, g_0_y_yy_xxyyyyy, g_0_y_yy_xxyyyyz, g_0_y_yy_xxyyyz, g_0_y_yy_xxyyyzz, g_0_y_yy_xxyyzz, g_0_y_yy_xxyyzzz, g_0_y_yy_xxyzzz, g_0_y_yy_xxyzzzz, g_0_y_yy_xxzzzz, g_0_y_yy_xxzzzzz, g_0_y_yy_xyyyyy, g_0_y_yy_xyyyyyy, g_0_y_yy_xyyyyyz, g_0_y_yy_xyyyyz, g_0_y_yy_xyyyyzz, g_0_y_yy_xyyyzz, g_0_y_yy_xyyyzzz, g_0_y_yy_xyyzzz, g_0_y_yy_xyyzzzz, g_0_y_yy_xyzzzz, g_0_y_yy_xyzzzzz, g_0_y_yy_xzzzzz, g_0_y_yy_xzzzzzz, g_0_y_yy_yyyyyy, g_0_y_yy_yyyyyz, g_0_y_yy_yyyyzz, g_0_y_yy_yyyzzz, g_0_y_yy_yyzzzz, g_0_y_yy_yzzzzz, g_0_y_yy_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_y_xyy_xxxxxx[k] = -g_0_y_yy_xxxxxx[k] * ab_x + g_0_y_yy_xxxxxxx[k];

                g_0_y_xyy_xxxxxy[k] = -g_0_y_yy_xxxxxy[k] * ab_x + g_0_y_yy_xxxxxxy[k];

                g_0_y_xyy_xxxxxz[k] = -g_0_y_yy_xxxxxz[k] * ab_x + g_0_y_yy_xxxxxxz[k];

                g_0_y_xyy_xxxxyy[k] = -g_0_y_yy_xxxxyy[k] * ab_x + g_0_y_yy_xxxxxyy[k];

                g_0_y_xyy_xxxxyz[k] = -g_0_y_yy_xxxxyz[k] * ab_x + g_0_y_yy_xxxxxyz[k];

                g_0_y_xyy_xxxxzz[k] = -g_0_y_yy_xxxxzz[k] * ab_x + g_0_y_yy_xxxxxzz[k];

                g_0_y_xyy_xxxyyy[k] = -g_0_y_yy_xxxyyy[k] * ab_x + g_0_y_yy_xxxxyyy[k];

                g_0_y_xyy_xxxyyz[k] = -g_0_y_yy_xxxyyz[k] * ab_x + g_0_y_yy_xxxxyyz[k];

                g_0_y_xyy_xxxyzz[k] = -g_0_y_yy_xxxyzz[k] * ab_x + g_0_y_yy_xxxxyzz[k];

                g_0_y_xyy_xxxzzz[k] = -g_0_y_yy_xxxzzz[k] * ab_x + g_0_y_yy_xxxxzzz[k];

                g_0_y_xyy_xxyyyy[k] = -g_0_y_yy_xxyyyy[k] * ab_x + g_0_y_yy_xxxyyyy[k];

                g_0_y_xyy_xxyyyz[k] = -g_0_y_yy_xxyyyz[k] * ab_x + g_0_y_yy_xxxyyyz[k];

                g_0_y_xyy_xxyyzz[k] = -g_0_y_yy_xxyyzz[k] * ab_x + g_0_y_yy_xxxyyzz[k];

                g_0_y_xyy_xxyzzz[k] = -g_0_y_yy_xxyzzz[k] * ab_x + g_0_y_yy_xxxyzzz[k];

                g_0_y_xyy_xxzzzz[k] = -g_0_y_yy_xxzzzz[k] * ab_x + g_0_y_yy_xxxzzzz[k];

                g_0_y_xyy_xyyyyy[k] = -g_0_y_yy_xyyyyy[k] * ab_x + g_0_y_yy_xxyyyyy[k];

                g_0_y_xyy_xyyyyz[k] = -g_0_y_yy_xyyyyz[k] * ab_x + g_0_y_yy_xxyyyyz[k];

                g_0_y_xyy_xyyyzz[k] = -g_0_y_yy_xyyyzz[k] * ab_x + g_0_y_yy_xxyyyzz[k];

                g_0_y_xyy_xyyzzz[k] = -g_0_y_yy_xyyzzz[k] * ab_x + g_0_y_yy_xxyyzzz[k];

                g_0_y_xyy_xyzzzz[k] = -g_0_y_yy_xyzzzz[k] * ab_x + g_0_y_yy_xxyzzzz[k];

                g_0_y_xyy_xzzzzz[k] = -g_0_y_yy_xzzzzz[k] * ab_x + g_0_y_yy_xxzzzzz[k];

                g_0_y_xyy_yyyyyy[k] = -g_0_y_yy_yyyyyy[k] * ab_x + g_0_y_yy_xyyyyyy[k];

                g_0_y_xyy_yyyyyz[k] = -g_0_y_yy_yyyyyz[k] * ab_x + g_0_y_yy_xyyyyyz[k];

                g_0_y_xyy_yyyyzz[k] = -g_0_y_yy_yyyyzz[k] * ab_x + g_0_y_yy_xyyyyzz[k];

                g_0_y_xyy_yyyzzz[k] = -g_0_y_yy_yyyzzz[k] * ab_x + g_0_y_yy_xyyyzzz[k];

                g_0_y_xyy_yyzzzz[k] = -g_0_y_yy_yyzzzz[k] * ab_x + g_0_y_yy_xyyzzzz[k];

                g_0_y_xyy_yzzzzz[k] = -g_0_y_yy_yzzzzz[k] * ab_x + g_0_y_yy_xyzzzzz[k];

                g_0_y_xyy_zzzzzz[k] = -g_0_y_yy_zzzzzz[k] * ab_x + g_0_y_yy_xzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_y_xyz_xxxxxx, g_0_y_xyz_xxxxxy, g_0_y_xyz_xxxxxz, g_0_y_xyz_xxxxyy, g_0_y_xyz_xxxxyz, g_0_y_xyz_xxxxzz, g_0_y_xyz_xxxyyy, g_0_y_xyz_xxxyyz, g_0_y_xyz_xxxyzz, g_0_y_xyz_xxxzzz, g_0_y_xyz_xxyyyy, g_0_y_xyz_xxyyyz, g_0_y_xyz_xxyyzz, g_0_y_xyz_xxyzzz, g_0_y_xyz_xxzzzz, g_0_y_xyz_xyyyyy, g_0_y_xyz_xyyyyz, g_0_y_xyz_xyyyzz, g_0_y_xyz_xyyzzz, g_0_y_xyz_xyzzzz, g_0_y_xyz_xzzzzz, g_0_y_xyz_yyyyyy, g_0_y_xyz_yyyyyz, g_0_y_xyz_yyyyzz, g_0_y_xyz_yyyzzz, g_0_y_xyz_yyzzzz, g_0_y_xyz_yzzzzz, g_0_y_xyz_zzzzzz, g_0_y_yz_xxxxxx, g_0_y_yz_xxxxxxx, g_0_y_yz_xxxxxxy, g_0_y_yz_xxxxxxz, g_0_y_yz_xxxxxy, g_0_y_yz_xxxxxyy, g_0_y_yz_xxxxxyz, g_0_y_yz_xxxxxz, g_0_y_yz_xxxxxzz, g_0_y_yz_xxxxyy, g_0_y_yz_xxxxyyy, g_0_y_yz_xxxxyyz, g_0_y_yz_xxxxyz, g_0_y_yz_xxxxyzz, g_0_y_yz_xxxxzz, g_0_y_yz_xxxxzzz, g_0_y_yz_xxxyyy, g_0_y_yz_xxxyyyy, g_0_y_yz_xxxyyyz, g_0_y_yz_xxxyyz, g_0_y_yz_xxxyyzz, g_0_y_yz_xxxyzz, g_0_y_yz_xxxyzzz, g_0_y_yz_xxxzzz, g_0_y_yz_xxxzzzz, g_0_y_yz_xxyyyy, g_0_y_yz_xxyyyyy, g_0_y_yz_xxyyyyz, g_0_y_yz_xxyyyz, g_0_y_yz_xxyyyzz, g_0_y_yz_xxyyzz, g_0_y_yz_xxyyzzz, g_0_y_yz_xxyzzz, g_0_y_yz_xxyzzzz, g_0_y_yz_xxzzzz, g_0_y_yz_xxzzzzz, g_0_y_yz_xyyyyy, g_0_y_yz_xyyyyyy, g_0_y_yz_xyyyyyz, g_0_y_yz_xyyyyz, g_0_y_yz_xyyyyzz, g_0_y_yz_xyyyzz, g_0_y_yz_xyyyzzz, g_0_y_yz_xyyzzz, g_0_y_yz_xyyzzzz, g_0_y_yz_xyzzzz, g_0_y_yz_xyzzzzz, g_0_y_yz_xzzzzz, g_0_y_yz_xzzzzzz, g_0_y_yz_yyyyyy, g_0_y_yz_yyyyyz, g_0_y_yz_yyyyzz, g_0_y_yz_yyyzzz, g_0_y_yz_yyzzzz, g_0_y_yz_yzzzzz, g_0_y_yz_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_y_xyz_xxxxxx[k] = -g_0_y_yz_xxxxxx[k] * ab_x + g_0_y_yz_xxxxxxx[k];

                g_0_y_xyz_xxxxxy[k] = -g_0_y_yz_xxxxxy[k] * ab_x + g_0_y_yz_xxxxxxy[k];

                g_0_y_xyz_xxxxxz[k] = -g_0_y_yz_xxxxxz[k] * ab_x + g_0_y_yz_xxxxxxz[k];

                g_0_y_xyz_xxxxyy[k] = -g_0_y_yz_xxxxyy[k] * ab_x + g_0_y_yz_xxxxxyy[k];

                g_0_y_xyz_xxxxyz[k] = -g_0_y_yz_xxxxyz[k] * ab_x + g_0_y_yz_xxxxxyz[k];

                g_0_y_xyz_xxxxzz[k] = -g_0_y_yz_xxxxzz[k] * ab_x + g_0_y_yz_xxxxxzz[k];

                g_0_y_xyz_xxxyyy[k] = -g_0_y_yz_xxxyyy[k] * ab_x + g_0_y_yz_xxxxyyy[k];

                g_0_y_xyz_xxxyyz[k] = -g_0_y_yz_xxxyyz[k] * ab_x + g_0_y_yz_xxxxyyz[k];

                g_0_y_xyz_xxxyzz[k] = -g_0_y_yz_xxxyzz[k] * ab_x + g_0_y_yz_xxxxyzz[k];

                g_0_y_xyz_xxxzzz[k] = -g_0_y_yz_xxxzzz[k] * ab_x + g_0_y_yz_xxxxzzz[k];

                g_0_y_xyz_xxyyyy[k] = -g_0_y_yz_xxyyyy[k] * ab_x + g_0_y_yz_xxxyyyy[k];

                g_0_y_xyz_xxyyyz[k] = -g_0_y_yz_xxyyyz[k] * ab_x + g_0_y_yz_xxxyyyz[k];

                g_0_y_xyz_xxyyzz[k] = -g_0_y_yz_xxyyzz[k] * ab_x + g_0_y_yz_xxxyyzz[k];

                g_0_y_xyz_xxyzzz[k] = -g_0_y_yz_xxyzzz[k] * ab_x + g_0_y_yz_xxxyzzz[k];

                g_0_y_xyz_xxzzzz[k] = -g_0_y_yz_xxzzzz[k] * ab_x + g_0_y_yz_xxxzzzz[k];

                g_0_y_xyz_xyyyyy[k] = -g_0_y_yz_xyyyyy[k] * ab_x + g_0_y_yz_xxyyyyy[k];

                g_0_y_xyz_xyyyyz[k] = -g_0_y_yz_xyyyyz[k] * ab_x + g_0_y_yz_xxyyyyz[k];

                g_0_y_xyz_xyyyzz[k] = -g_0_y_yz_xyyyzz[k] * ab_x + g_0_y_yz_xxyyyzz[k];

                g_0_y_xyz_xyyzzz[k] = -g_0_y_yz_xyyzzz[k] * ab_x + g_0_y_yz_xxyyzzz[k];

                g_0_y_xyz_xyzzzz[k] = -g_0_y_yz_xyzzzz[k] * ab_x + g_0_y_yz_xxyzzzz[k];

                g_0_y_xyz_xzzzzz[k] = -g_0_y_yz_xzzzzz[k] * ab_x + g_0_y_yz_xxzzzzz[k];

                g_0_y_xyz_yyyyyy[k] = -g_0_y_yz_yyyyyy[k] * ab_x + g_0_y_yz_xyyyyyy[k];

                g_0_y_xyz_yyyyyz[k] = -g_0_y_yz_yyyyyz[k] * ab_x + g_0_y_yz_xyyyyyz[k];

                g_0_y_xyz_yyyyzz[k] = -g_0_y_yz_yyyyzz[k] * ab_x + g_0_y_yz_xyyyyzz[k];

                g_0_y_xyz_yyyzzz[k] = -g_0_y_yz_yyyzzz[k] * ab_x + g_0_y_yz_xyyyzzz[k];

                g_0_y_xyz_yyzzzz[k] = -g_0_y_yz_yyzzzz[k] * ab_x + g_0_y_yz_xyyzzzz[k];

                g_0_y_xyz_yzzzzz[k] = -g_0_y_yz_yzzzzz[k] * ab_x + g_0_y_yz_xyzzzzz[k];

                g_0_y_xyz_zzzzzz[k] = -g_0_y_yz_zzzzzz[k] * ab_x + g_0_y_yz_xzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_y_xzz_xxxxxx, g_0_y_xzz_xxxxxy, g_0_y_xzz_xxxxxz, g_0_y_xzz_xxxxyy, g_0_y_xzz_xxxxyz, g_0_y_xzz_xxxxzz, g_0_y_xzz_xxxyyy, g_0_y_xzz_xxxyyz, g_0_y_xzz_xxxyzz, g_0_y_xzz_xxxzzz, g_0_y_xzz_xxyyyy, g_0_y_xzz_xxyyyz, g_0_y_xzz_xxyyzz, g_0_y_xzz_xxyzzz, g_0_y_xzz_xxzzzz, g_0_y_xzz_xyyyyy, g_0_y_xzz_xyyyyz, g_0_y_xzz_xyyyzz, g_0_y_xzz_xyyzzz, g_0_y_xzz_xyzzzz, g_0_y_xzz_xzzzzz, g_0_y_xzz_yyyyyy, g_0_y_xzz_yyyyyz, g_0_y_xzz_yyyyzz, g_0_y_xzz_yyyzzz, g_0_y_xzz_yyzzzz, g_0_y_xzz_yzzzzz, g_0_y_xzz_zzzzzz, g_0_y_zz_xxxxxx, g_0_y_zz_xxxxxxx, g_0_y_zz_xxxxxxy, g_0_y_zz_xxxxxxz, g_0_y_zz_xxxxxy, g_0_y_zz_xxxxxyy, g_0_y_zz_xxxxxyz, g_0_y_zz_xxxxxz, g_0_y_zz_xxxxxzz, g_0_y_zz_xxxxyy, g_0_y_zz_xxxxyyy, g_0_y_zz_xxxxyyz, g_0_y_zz_xxxxyz, g_0_y_zz_xxxxyzz, g_0_y_zz_xxxxzz, g_0_y_zz_xxxxzzz, g_0_y_zz_xxxyyy, g_0_y_zz_xxxyyyy, g_0_y_zz_xxxyyyz, g_0_y_zz_xxxyyz, g_0_y_zz_xxxyyzz, g_0_y_zz_xxxyzz, g_0_y_zz_xxxyzzz, g_0_y_zz_xxxzzz, g_0_y_zz_xxxzzzz, g_0_y_zz_xxyyyy, g_0_y_zz_xxyyyyy, g_0_y_zz_xxyyyyz, g_0_y_zz_xxyyyz, g_0_y_zz_xxyyyzz, g_0_y_zz_xxyyzz, g_0_y_zz_xxyyzzz, g_0_y_zz_xxyzzz, g_0_y_zz_xxyzzzz, g_0_y_zz_xxzzzz, g_0_y_zz_xxzzzzz, g_0_y_zz_xyyyyy, g_0_y_zz_xyyyyyy, g_0_y_zz_xyyyyyz, g_0_y_zz_xyyyyz, g_0_y_zz_xyyyyzz, g_0_y_zz_xyyyzz, g_0_y_zz_xyyyzzz, g_0_y_zz_xyyzzz, g_0_y_zz_xyyzzzz, g_0_y_zz_xyzzzz, g_0_y_zz_xyzzzzz, g_0_y_zz_xzzzzz, g_0_y_zz_xzzzzzz, g_0_y_zz_yyyyyy, g_0_y_zz_yyyyyz, g_0_y_zz_yyyyzz, g_0_y_zz_yyyzzz, g_0_y_zz_yyzzzz, g_0_y_zz_yzzzzz, g_0_y_zz_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_y_xzz_xxxxxx[k] = -g_0_y_zz_xxxxxx[k] * ab_x + g_0_y_zz_xxxxxxx[k];

                g_0_y_xzz_xxxxxy[k] = -g_0_y_zz_xxxxxy[k] * ab_x + g_0_y_zz_xxxxxxy[k];

                g_0_y_xzz_xxxxxz[k] = -g_0_y_zz_xxxxxz[k] * ab_x + g_0_y_zz_xxxxxxz[k];

                g_0_y_xzz_xxxxyy[k] = -g_0_y_zz_xxxxyy[k] * ab_x + g_0_y_zz_xxxxxyy[k];

                g_0_y_xzz_xxxxyz[k] = -g_0_y_zz_xxxxyz[k] * ab_x + g_0_y_zz_xxxxxyz[k];

                g_0_y_xzz_xxxxzz[k] = -g_0_y_zz_xxxxzz[k] * ab_x + g_0_y_zz_xxxxxzz[k];

                g_0_y_xzz_xxxyyy[k] = -g_0_y_zz_xxxyyy[k] * ab_x + g_0_y_zz_xxxxyyy[k];

                g_0_y_xzz_xxxyyz[k] = -g_0_y_zz_xxxyyz[k] * ab_x + g_0_y_zz_xxxxyyz[k];

                g_0_y_xzz_xxxyzz[k] = -g_0_y_zz_xxxyzz[k] * ab_x + g_0_y_zz_xxxxyzz[k];

                g_0_y_xzz_xxxzzz[k] = -g_0_y_zz_xxxzzz[k] * ab_x + g_0_y_zz_xxxxzzz[k];

                g_0_y_xzz_xxyyyy[k] = -g_0_y_zz_xxyyyy[k] * ab_x + g_0_y_zz_xxxyyyy[k];

                g_0_y_xzz_xxyyyz[k] = -g_0_y_zz_xxyyyz[k] * ab_x + g_0_y_zz_xxxyyyz[k];

                g_0_y_xzz_xxyyzz[k] = -g_0_y_zz_xxyyzz[k] * ab_x + g_0_y_zz_xxxyyzz[k];

                g_0_y_xzz_xxyzzz[k] = -g_0_y_zz_xxyzzz[k] * ab_x + g_0_y_zz_xxxyzzz[k];

                g_0_y_xzz_xxzzzz[k] = -g_0_y_zz_xxzzzz[k] * ab_x + g_0_y_zz_xxxzzzz[k];

                g_0_y_xzz_xyyyyy[k] = -g_0_y_zz_xyyyyy[k] * ab_x + g_0_y_zz_xxyyyyy[k];

                g_0_y_xzz_xyyyyz[k] = -g_0_y_zz_xyyyyz[k] * ab_x + g_0_y_zz_xxyyyyz[k];

                g_0_y_xzz_xyyyzz[k] = -g_0_y_zz_xyyyzz[k] * ab_x + g_0_y_zz_xxyyyzz[k];

                g_0_y_xzz_xyyzzz[k] = -g_0_y_zz_xyyzzz[k] * ab_x + g_0_y_zz_xxyyzzz[k];

                g_0_y_xzz_xyzzzz[k] = -g_0_y_zz_xyzzzz[k] * ab_x + g_0_y_zz_xxyzzzz[k];

                g_0_y_xzz_xzzzzz[k] = -g_0_y_zz_xzzzzz[k] * ab_x + g_0_y_zz_xxzzzzz[k];

                g_0_y_xzz_yyyyyy[k] = -g_0_y_zz_yyyyyy[k] * ab_x + g_0_y_zz_xyyyyyy[k];

                g_0_y_xzz_yyyyyz[k] = -g_0_y_zz_yyyyyz[k] * ab_x + g_0_y_zz_xyyyyyz[k];

                g_0_y_xzz_yyyyzz[k] = -g_0_y_zz_yyyyzz[k] * ab_x + g_0_y_zz_xyyyyzz[k];

                g_0_y_xzz_yyyzzz[k] = -g_0_y_zz_yyyzzz[k] * ab_x + g_0_y_zz_xyyyzzz[k];

                g_0_y_xzz_yyzzzz[k] = -g_0_y_zz_yyzzzz[k] * ab_x + g_0_y_zz_xyyzzzz[k];

                g_0_y_xzz_yzzzzz[k] = -g_0_y_zz_yzzzzz[k] * ab_x + g_0_y_zz_xyzzzzz[k];

                g_0_y_xzz_zzzzzz[k] = -g_0_y_zz_zzzzzz[k] * ab_x + g_0_y_zz_xzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_y_yy_xxxxxx, g_0_y_yy_xxxxxxy, g_0_y_yy_xxxxxy, g_0_y_yy_xxxxxyy, g_0_y_yy_xxxxxyz, g_0_y_yy_xxxxxz, g_0_y_yy_xxxxyy, g_0_y_yy_xxxxyyy, g_0_y_yy_xxxxyyz, g_0_y_yy_xxxxyz, g_0_y_yy_xxxxyzz, g_0_y_yy_xxxxzz, g_0_y_yy_xxxyyy, g_0_y_yy_xxxyyyy, g_0_y_yy_xxxyyyz, g_0_y_yy_xxxyyz, g_0_y_yy_xxxyyzz, g_0_y_yy_xxxyzz, g_0_y_yy_xxxyzzz, g_0_y_yy_xxxzzz, g_0_y_yy_xxyyyy, g_0_y_yy_xxyyyyy, g_0_y_yy_xxyyyyz, g_0_y_yy_xxyyyz, g_0_y_yy_xxyyyzz, g_0_y_yy_xxyyzz, g_0_y_yy_xxyyzzz, g_0_y_yy_xxyzzz, g_0_y_yy_xxyzzzz, g_0_y_yy_xxzzzz, g_0_y_yy_xyyyyy, g_0_y_yy_xyyyyyy, g_0_y_yy_xyyyyyz, g_0_y_yy_xyyyyz, g_0_y_yy_xyyyyzz, g_0_y_yy_xyyyzz, g_0_y_yy_xyyyzzz, g_0_y_yy_xyyzzz, g_0_y_yy_xyyzzzz, g_0_y_yy_xyzzzz, g_0_y_yy_xyzzzzz, g_0_y_yy_xzzzzz, g_0_y_yy_yyyyyy, g_0_y_yy_yyyyyyy, g_0_y_yy_yyyyyyz, g_0_y_yy_yyyyyz, g_0_y_yy_yyyyyzz, g_0_y_yy_yyyyzz, g_0_y_yy_yyyyzzz, g_0_y_yy_yyyzzz, g_0_y_yy_yyyzzzz, g_0_y_yy_yyzzzz, g_0_y_yy_yyzzzzz, g_0_y_yy_yzzzzz, g_0_y_yy_yzzzzzz, g_0_y_yy_zzzzzz, g_0_y_yyy_xxxxxx, g_0_y_yyy_xxxxxy, g_0_y_yyy_xxxxxz, g_0_y_yyy_xxxxyy, g_0_y_yyy_xxxxyz, g_0_y_yyy_xxxxzz, g_0_y_yyy_xxxyyy, g_0_y_yyy_xxxyyz, g_0_y_yyy_xxxyzz, g_0_y_yyy_xxxzzz, g_0_y_yyy_xxyyyy, g_0_y_yyy_xxyyyz, g_0_y_yyy_xxyyzz, g_0_y_yyy_xxyzzz, g_0_y_yyy_xxzzzz, g_0_y_yyy_xyyyyy, g_0_y_yyy_xyyyyz, g_0_y_yyy_xyyyzz, g_0_y_yyy_xyyzzz, g_0_y_yyy_xyzzzz, g_0_y_yyy_xzzzzz, g_0_y_yyy_yyyyyy, g_0_y_yyy_yyyyyz, g_0_y_yyy_yyyyzz, g_0_y_yyy_yyyzzz, g_0_y_yyy_yyzzzz, g_0_y_yyy_yzzzzz, g_0_y_yyy_zzzzzz, g_yy_xxxxxx, g_yy_xxxxxy, g_yy_xxxxxz, g_yy_xxxxyy, g_yy_xxxxyz, g_yy_xxxxzz, g_yy_xxxyyy, g_yy_xxxyyz, g_yy_xxxyzz, g_yy_xxxzzz, g_yy_xxyyyy, g_yy_xxyyyz, g_yy_xxyyzz, g_yy_xxyzzz, g_yy_xxzzzz, g_yy_xyyyyy, g_yy_xyyyyz, g_yy_xyyyzz, g_yy_xyyzzz, g_yy_xyzzzz, g_yy_xzzzzz, g_yy_yyyyyy, g_yy_yyyyyz, g_yy_yyyyzz, g_yy_yyyzzz, g_yy_yyzzzz, g_yy_yzzzzz, g_yy_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_y_yyy_xxxxxx[k] = g_yy_xxxxxx[k] - g_0_y_yy_xxxxxx[k] * ab_y + g_0_y_yy_xxxxxxy[k];

                g_0_y_yyy_xxxxxy[k] = g_yy_xxxxxy[k] - g_0_y_yy_xxxxxy[k] * ab_y + g_0_y_yy_xxxxxyy[k];

                g_0_y_yyy_xxxxxz[k] = g_yy_xxxxxz[k] - g_0_y_yy_xxxxxz[k] * ab_y + g_0_y_yy_xxxxxyz[k];

                g_0_y_yyy_xxxxyy[k] = g_yy_xxxxyy[k] - g_0_y_yy_xxxxyy[k] * ab_y + g_0_y_yy_xxxxyyy[k];

                g_0_y_yyy_xxxxyz[k] = g_yy_xxxxyz[k] - g_0_y_yy_xxxxyz[k] * ab_y + g_0_y_yy_xxxxyyz[k];

                g_0_y_yyy_xxxxzz[k] = g_yy_xxxxzz[k] - g_0_y_yy_xxxxzz[k] * ab_y + g_0_y_yy_xxxxyzz[k];

                g_0_y_yyy_xxxyyy[k] = g_yy_xxxyyy[k] - g_0_y_yy_xxxyyy[k] * ab_y + g_0_y_yy_xxxyyyy[k];

                g_0_y_yyy_xxxyyz[k] = g_yy_xxxyyz[k] - g_0_y_yy_xxxyyz[k] * ab_y + g_0_y_yy_xxxyyyz[k];

                g_0_y_yyy_xxxyzz[k] = g_yy_xxxyzz[k] - g_0_y_yy_xxxyzz[k] * ab_y + g_0_y_yy_xxxyyzz[k];

                g_0_y_yyy_xxxzzz[k] = g_yy_xxxzzz[k] - g_0_y_yy_xxxzzz[k] * ab_y + g_0_y_yy_xxxyzzz[k];

                g_0_y_yyy_xxyyyy[k] = g_yy_xxyyyy[k] - g_0_y_yy_xxyyyy[k] * ab_y + g_0_y_yy_xxyyyyy[k];

                g_0_y_yyy_xxyyyz[k] = g_yy_xxyyyz[k] - g_0_y_yy_xxyyyz[k] * ab_y + g_0_y_yy_xxyyyyz[k];

                g_0_y_yyy_xxyyzz[k] = g_yy_xxyyzz[k] - g_0_y_yy_xxyyzz[k] * ab_y + g_0_y_yy_xxyyyzz[k];

                g_0_y_yyy_xxyzzz[k] = g_yy_xxyzzz[k] - g_0_y_yy_xxyzzz[k] * ab_y + g_0_y_yy_xxyyzzz[k];

                g_0_y_yyy_xxzzzz[k] = g_yy_xxzzzz[k] - g_0_y_yy_xxzzzz[k] * ab_y + g_0_y_yy_xxyzzzz[k];

                g_0_y_yyy_xyyyyy[k] = g_yy_xyyyyy[k] - g_0_y_yy_xyyyyy[k] * ab_y + g_0_y_yy_xyyyyyy[k];

                g_0_y_yyy_xyyyyz[k] = g_yy_xyyyyz[k] - g_0_y_yy_xyyyyz[k] * ab_y + g_0_y_yy_xyyyyyz[k];

                g_0_y_yyy_xyyyzz[k] = g_yy_xyyyzz[k] - g_0_y_yy_xyyyzz[k] * ab_y + g_0_y_yy_xyyyyzz[k];

                g_0_y_yyy_xyyzzz[k] = g_yy_xyyzzz[k] - g_0_y_yy_xyyzzz[k] * ab_y + g_0_y_yy_xyyyzzz[k];

                g_0_y_yyy_xyzzzz[k] = g_yy_xyzzzz[k] - g_0_y_yy_xyzzzz[k] * ab_y + g_0_y_yy_xyyzzzz[k];

                g_0_y_yyy_xzzzzz[k] = g_yy_xzzzzz[k] - g_0_y_yy_xzzzzz[k] * ab_y + g_0_y_yy_xyzzzzz[k];

                g_0_y_yyy_yyyyyy[k] = g_yy_yyyyyy[k] - g_0_y_yy_yyyyyy[k] * ab_y + g_0_y_yy_yyyyyyy[k];

                g_0_y_yyy_yyyyyz[k] = g_yy_yyyyyz[k] - g_0_y_yy_yyyyyz[k] * ab_y + g_0_y_yy_yyyyyyz[k];

                g_0_y_yyy_yyyyzz[k] = g_yy_yyyyzz[k] - g_0_y_yy_yyyyzz[k] * ab_y + g_0_y_yy_yyyyyzz[k];

                g_0_y_yyy_yyyzzz[k] = g_yy_yyyzzz[k] - g_0_y_yy_yyyzzz[k] * ab_y + g_0_y_yy_yyyyzzz[k];

                g_0_y_yyy_yyzzzz[k] = g_yy_yyzzzz[k] - g_0_y_yy_yyzzzz[k] * ab_y + g_0_y_yy_yyyzzzz[k];

                g_0_y_yyy_yzzzzz[k] = g_yy_yzzzzz[k] - g_0_y_yy_yzzzzz[k] * ab_y + g_0_y_yy_yyzzzzz[k];

                g_0_y_yyy_zzzzzz[k] = g_yy_zzzzzz[k] - g_0_y_yy_zzzzzz[k] * ab_y + g_0_y_yy_yzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_y_yy_xxxxxx, g_0_y_yy_xxxxxxz, g_0_y_yy_xxxxxy, g_0_y_yy_xxxxxyz, g_0_y_yy_xxxxxz, g_0_y_yy_xxxxxzz, g_0_y_yy_xxxxyy, g_0_y_yy_xxxxyyz, g_0_y_yy_xxxxyz, g_0_y_yy_xxxxyzz, g_0_y_yy_xxxxzz, g_0_y_yy_xxxxzzz, g_0_y_yy_xxxyyy, g_0_y_yy_xxxyyyz, g_0_y_yy_xxxyyz, g_0_y_yy_xxxyyzz, g_0_y_yy_xxxyzz, g_0_y_yy_xxxyzzz, g_0_y_yy_xxxzzz, g_0_y_yy_xxxzzzz, g_0_y_yy_xxyyyy, g_0_y_yy_xxyyyyz, g_0_y_yy_xxyyyz, g_0_y_yy_xxyyyzz, g_0_y_yy_xxyyzz, g_0_y_yy_xxyyzzz, g_0_y_yy_xxyzzz, g_0_y_yy_xxyzzzz, g_0_y_yy_xxzzzz, g_0_y_yy_xxzzzzz, g_0_y_yy_xyyyyy, g_0_y_yy_xyyyyyz, g_0_y_yy_xyyyyz, g_0_y_yy_xyyyyzz, g_0_y_yy_xyyyzz, g_0_y_yy_xyyyzzz, g_0_y_yy_xyyzzz, g_0_y_yy_xyyzzzz, g_0_y_yy_xyzzzz, g_0_y_yy_xyzzzzz, g_0_y_yy_xzzzzz, g_0_y_yy_xzzzzzz, g_0_y_yy_yyyyyy, g_0_y_yy_yyyyyyz, g_0_y_yy_yyyyyz, g_0_y_yy_yyyyyzz, g_0_y_yy_yyyyzz, g_0_y_yy_yyyyzzz, g_0_y_yy_yyyzzz, g_0_y_yy_yyyzzzz, g_0_y_yy_yyzzzz, g_0_y_yy_yyzzzzz, g_0_y_yy_yzzzzz, g_0_y_yy_yzzzzzz, g_0_y_yy_zzzzzz, g_0_y_yy_zzzzzzz, g_0_y_yyz_xxxxxx, g_0_y_yyz_xxxxxy, g_0_y_yyz_xxxxxz, g_0_y_yyz_xxxxyy, g_0_y_yyz_xxxxyz, g_0_y_yyz_xxxxzz, g_0_y_yyz_xxxyyy, g_0_y_yyz_xxxyyz, g_0_y_yyz_xxxyzz, g_0_y_yyz_xxxzzz, g_0_y_yyz_xxyyyy, g_0_y_yyz_xxyyyz, g_0_y_yyz_xxyyzz, g_0_y_yyz_xxyzzz, g_0_y_yyz_xxzzzz, g_0_y_yyz_xyyyyy, g_0_y_yyz_xyyyyz, g_0_y_yyz_xyyyzz, g_0_y_yyz_xyyzzz, g_0_y_yyz_xyzzzz, g_0_y_yyz_xzzzzz, g_0_y_yyz_yyyyyy, g_0_y_yyz_yyyyyz, g_0_y_yyz_yyyyzz, g_0_y_yyz_yyyzzz, g_0_y_yyz_yyzzzz, g_0_y_yyz_yzzzzz, g_0_y_yyz_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_y_yyz_xxxxxx[k] = -g_0_y_yy_xxxxxx[k] * ab_z + g_0_y_yy_xxxxxxz[k];

                g_0_y_yyz_xxxxxy[k] = -g_0_y_yy_xxxxxy[k] * ab_z + g_0_y_yy_xxxxxyz[k];

                g_0_y_yyz_xxxxxz[k] = -g_0_y_yy_xxxxxz[k] * ab_z + g_0_y_yy_xxxxxzz[k];

                g_0_y_yyz_xxxxyy[k] = -g_0_y_yy_xxxxyy[k] * ab_z + g_0_y_yy_xxxxyyz[k];

                g_0_y_yyz_xxxxyz[k] = -g_0_y_yy_xxxxyz[k] * ab_z + g_0_y_yy_xxxxyzz[k];

                g_0_y_yyz_xxxxzz[k] = -g_0_y_yy_xxxxzz[k] * ab_z + g_0_y_yy_xxxxzzz[k];

                g_0_y_yyz_xxxyyy[k] = -g_0_y_yy_xxxyyy[k] * ab_z + g_0_y_yy_xxxyyyz[k];

                g_0_y_yyz_xxxyyz[k] = -g_0_y_yy_xxxyyz[k] * ab_z + g_0_y_yy_xxxyyzz[k];

                g_0_y_yyz_xxxyzz[k] = -g_0_y_yy_xxxyzz[k] * ab_z + g_0_y_yy_xxxyzzz[k];

                g_0_y_yyz_xxxzzz[k] = -g_0_y_yy_xxxzzz[k] * ab_z + g_0_y_yy_xxxzzzz[k];

                g_0_y_yyz_xxyyyy[k] = -g_0_y_yy_xxyyyy[k] * ab_z + g_0_y_yy_xxyyyyz[k];

                g_0_y_yyz_xxyyyz[k] = -g_0_y_yy_xxyyyz[k] * ab_z + g_0_y_yy_xxyyyzz[k];

                g_0_y_yyz_xxyyzz[k] = -g_0_y_yy_xxyyzz[k] * ab_z + g_0_y_yy_xxyyzzz[k];

                g_0_y_yyz_xxyzzz[k] = -g_0_y_yy_xxyzzz[k] * ab_z + g_0_y_yy_xxyzzzz[k];

                g_0_y_yyz_xxzzzz[k] = -g_0_y_yy_xxzzzz[k] * ab_z + g_0_y_yy_xxzzzzz[k];

                g_0_y_yyz_xyyyyy[k] = -g_0_y_yy_xyyyyy[k] * ab_z + g_0_y_yy_xyyyyyz[k];

                g_0_y_yyz_xyyyyz[k] = -g_0_y_yy_xyyyyz[k] * ab_z + g_0_y_yy_xyyyyzz[k];

                g_0_y_yyz_xyyyzz[k] = -g_0_y_yy_xyyyzz[k] * ab_z + g_0_y_yy_xyyyzzz[k];

                g_0_y_yyz_xyyzzz[k] = -g_0_y_yy_xyyzzz[k] * ab_z + g_0_y_yy_xyyzzzz[k];

                g_0_y_yyz_xyzzzz[k] = -g_0_y_yy_xyzzzz[k] * ab_z + g_0_y_yy_xyzzzzz[k];

                g_0_y_yyz_xzzzzz[k] = -g_0_y_yy_xzzzzz[k] * ab_z + g_0_y_yy_xzzzzzz[k];

                g_0_y_yyz_yyyyyy[k] = -g_0_y_yy_yyyyyy[k] * ab_z + g_0_y_yy_yyyyyyz[k];

                g_0_y_yyz_yyyyyz[k] = -g_0_y_yy_yyyyyz[k] * ab_z + g_0_y_yy_yyyyyzz[k];

                g_0_y_yyz_yyyyzz[k] = -g_0_y_yy_yyyyzz[k] * ab_z + g_0_y_yy_yyyyzzz[k];

                g_0_y_yyz_yyyzzz[k] = -g_0_y_yy_yyyzzz[k] * ab_z + g_0_y_yy_yyyzzzz[k];

                g_0_y_yyz_yyzzzz[k] = -g_0_y_yy_yyzzzz[k] * ab_z + g_0_y_yy_yyzzzzz[k];

                g_0_y_yyz_yzzzzz[k] = -g_0_y_yy_yzzzzz[k] * ab_z + g_0_y_yy_yzzzzzz[k];

                g_0_y_yyz_zzzzzz[k] = -g_0_y_yy_zzzzzz[k] * ab_z + g_0_y_yy_zzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_y_yz_xxxxxx, g_0_y_yz_xxxxxxz, g_0_y_yz_xxxxxy, g_0_y_yz_xxxxxyz, g_0_y_yz_xxxxxz, g_0_y_yz_xxxxxzz, g_0_y_yz_xxxxyy, g_0_y_yz_xxxxyyz, g_0_y_yz_xxxxyz, g_0_y_yz_xxxxyzz, g_0_y_yz_xxxxzz, g_0_y_yz_xxxxzzz, g_0_y_yz_xxxyyy, g_0_y_yz_xxxyyyz, g_0_y_yz_xxxyyz, g_0_y_yz_xxxyyzz, g_0_y_yz_xxxyzz, g_0_y_yz_xxxyzzz, g_0_y_yz_xxxzzz, g_0_y_yz_xxxzzzz, g_0_y_yz_xxyyyy, g_0_y_yz_xxyyyyz, g_0_y_yz_xxyyyz, g_0_y_yz_xxyyyzz, g_0_y_yz_xxyyzz, g_0_y_yz_xxyyzzz, g_0_y_yz_xxyzzz, g_0_y_yz_xxyzzzz, g_0_y_yz_xxzzzz, g_0_y_yz_xxzzzzz, g_0_y_yz_xyyyyy, g_0_y_yz_xyyyyyz, g_0_y_yz_xyyyyz, g_0_y_yz_xyyyyzz, g_0_y_yz_xyyyzz, g_0_y_yz_xyyyzzz, g_0_y_yz_xyyzzz, g_0_y_yz_xyyzzzz, g_0_y_yz_xyzzzz, g_0_y_yz_xyzzzzz, g_0_y_yz_xzzzzz, g_0_y_yz_xzzzzzz, g_0_y_yz_yyyyyy, g_0_y_yz_yyyyyyz, g_0_y_yz_yyyyyz, g_0_y_yz_yyyyyzz, g_0_y_yz_yyyyzz, g_0_y_yz_yyyyzzz, g_0_y_yz_yyyzzz, g_0_y_yz_yyyzzzz, g_0_y_yz_yyzzzz, g_0_y_yz_yyzzzzz, g_0_y_yz_yzzzzz, g_0_y_yz_yzzzzzz, g_0_y_yz_zzzzzz, g_0_y_yz_zzzzzzz, g_0_y_yzz_xxxxxx, g_0_y_yzz_xxxxxy, g_0_y_yzz_xxxxxz, g_0_y_yzz_xxxxyy, g_0_y_yzz_xxxxyz, g_0_y_yzz_xxxxzz, g_0_y_yzz_xxxyyy, g_0_y_yzz_xxxyyz, g_0_y_yzz_xxxyzz, g_0_y_yzz_xxxzzz, g_0_y_yzz_xxyyyy, g_0_y_yzz_xxyyyz, g_0_y_yzz_xxyyzz, g_0_y_yzz_xxyzzz, g_0_y_yzz_xxzzzz, g_0_y_yzz_xyyyyy, g_0_y_yzz_xyyyyz, g_0_y_yzz_xyyyzz, g_0_y_yzz_xyyzzz, g_0_y_yzz_xyzzzz, g_0_y_yzz_xzzzzz, g_0_y_yzz_yyyyyy, g_0_y_yzz_yyyyyz, g_0_y_yzz_yyyyzz, g_0_y_yzz_yyyzzz, g_0_y_yzz_yyzzzz, g_0_y_yzz_yzzzzz, g_0_y_yzz_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_y_yzz_xxxxxx[k] = -g_0_y_yz_xxxxxx[k] * ab_z + g_0_y_yz_xxxxxxz[k];

                g_0_y_yzz_xxxxxy[k] = -g_0_y_yz_xxxxxy[k] * ab_z + g_0_y_yz_xxxxxyz[k];

                g_0_y_yzz_xxxxxz[k] = -g_0_y_yz_xxxxxz[k] * ab_z + g_0_y_yz_xxxxxzz[k];

                g_0_y_yzz_xxxxyy[k] = -g_0_y_yz_xxxxyy[k] * ab_z + g_0_y_yz_xxxxyyz[k];

                g_0_y_yzz_xxxxyz[k] = -g_0_y_yz_xxxxyz[k] * ab_z + g_0_y_yz_xxxxyzz[k];

                g_0_y_yzz_xxxxzz[k] = -g_0_y_yz_xxxxzz[k] * ab_z + g_0_y_yz_xxxxzzz[k];

                g_0_y_yzz_xxxyyy[k] = -g_0_y_yz_xxxyyy[k] * ab_z + g_0_y_yz_xxxyyyz[k];

                g_0_y_yzz_xxxyyz[k] = -g_0_y_yz_xxxyyz[k] * ab_z + g_0_y_yz_xxxyyzz[k];

                g_0_y_yzz_xxxyzz[k] = -g_0_y_yz_xxxyzz[k] * ab_z + g_0_y_yz_xxxyzzz[k];

                g_0_y_yzz_xxxzzz[k] = -g_0_y_yz_xxxzzz[k] * ab_z + g_0_y_yz_xxxzzzz[k];

                g_0_y_yzz_xxyyyy[k] = -g_0_y_yz_xxyyyy[k] * ab_z + g_0_y_yz_xxyyyyz[k];

                g_0_y_yzz_xxyyyz[k] = -g_0_y_yz_xxyyyz[k] * ab_z + g_0_y_yz_xxyyyzz[k];

                g_0_y_yzz_xxyyzz[k] = -g_0_y_yz_xxyyzz[k] * ab_z + g_0_y_yz_xxyyzzz[k];

                g_0_y_yzz_xxyzzz[k] = -g_0_y_yz_xxyzzz[k] * ab_z + g_0_y_yz_xxyzzzz[k];

                g_0_y_yzz_xxzzzz[k] = -g_0_y_yz_xxzzzz[k] * ab_z + g_0_y_yz_xxzzzzz[k];

                g_0_y_yzz_xyyyyy[k] = -g_0_y_yz_xyyyyy[k] * ab_z + g_0_y_yz_xyyyyyz[k];

                g_0_y_yzz_xyyyyz[k] = -g_0_y_yz_xyyyyz[k] * ab_z + g_0_y_yz_xyyyyzz[k];

                g_0_y_yzz_xyyyzz[k] = -g_0_y_yz_xyyyzz[k] * ab_z + g_0_y_yz_xyyyzzz[k];

                g_0_y_yzz_xyyzzz[k] = -g_0_y_yz_xyyzzz[k] * ab_z + g_0_y_yz_xyyzzzz[k];

                g_0_y_yzz_xyzzzz[k] = -g_0_y_yz_xyzzzz[k] * ab_z + g_0_y_yz_xyzzzzz[k];

                g_0_y_yzz_xzzzzz[k] = -g_0_y_yz_xzzzzz[k] * ab_z + g_0_y_yz_xzzzzzz[k];

                g_0_y_yzz_yyyyyy[k] = -g_0_y_yz_yyyyyy[k] * ab_z + g_0_y_yz_yyyyyyz[k];

                g_0_y_yzz_yyyyyz[k] = -g_0_y_yz_yyyyyz[k] * ab_z + g_0_y_yz_yyyyyzz[k];

                g_0_y_yzz_yyyyzz[k] = -g_0_y_yz_yyyyzz[k] * ab_z + g_0_y_yz_yyyyzzz[k];

                g_0_y_yzz_yyyzzz[k] = -g_0_y_yz_yyyzzz[k] * ab_z + g_0_y_yz_yyyzzzz[k];

                g_0_y_yzz_yyzzzz[k] = -g_0_y_yz_yyzzzz[k] * ab_z + g_0_y_yz_yyzzzzz[k];

                g_0_y_yzz_yzzzzz[k] = -g_0_y_yz_yzzzzz[k] * ab_z + g_0_y_yz_yzzzzzz[k];

                g_0_y_yzz_zzzzzz[k] = -g_0_y_yz_zzzzzz[k] * ab_z + g_0_y_yz_zzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_y_zz_xxxxxx, g_0_y_zz_xxxxxxz, g_0_y_zz_xxxxxy, g_0_y_zz_xxxxxyz, g_0_y_zz_xxxxxz, g_0_y_zz_xxxxxzz, g_0_y_zz_xxxxyy, g_0_y_zz_xxxxyyz, g_0_y_zz_xxxxyz, g_0_y_zz_xxxxyzz, g_0_y_zz_xxxxzz, g_0_y_zz_xxxxzzz, g_0_y_zz_xxxyyy, g_0_y_zz_xxxyyyz, g_0_y_zz_xxxyyz, g_0_y_zz_xxxyyzz, g_0_y_zz_xxxyzz, g_0_y_zz_xxxyzzz, g_0_y_zz_xxxzzz, g_0_y_zz_xxxzzzz, g_0_y_zz_xxyyyy, g_0_y_zz_xxyyyyz, g_0_y_zz_xxyyyz, g_0_y_zz_xxyyyzz, g_0_y_zz_xxyyzz, g_0_y_zz_xxyyzzz, g_0_y_zz_xxyzzz, g_0_y_zz_xxyzzzz, g_0_y_zz_xxzzzz, g_0_y_zz_xxzzzzz, g_0_y_zz_xyyyyy, g_0_y_zz_xyyyyyz, g_0_y_zz_xyyyyz, g_0_y_zz_xyyyyzz, g_0_y_zz_xyyyzz, g_0_y_zz_xyyyzzz, g_0_y_zz_xyyzzz, g_0_y_zz_xyyzzzz, g_0_y_zz_xyzzzz, g_0_y_zz_xyzzzzz, g_0_y_zz_xzzzzz, g_0_y_zz_xzzzzzz, g_0_y_zz_yyyyyy, g_0_y_zz_yyyyyyz, g_0_y_zz_yyyyyz, g_0_y_zz_yyyyyzz, g_0_y_zz_yyyyzz, g_0_y_zz_yyyyzzz, g_0_y_zz_yyyzzz, g_0_y_zz_yyyzzzz, g_0_y_zz_yyzzzz, g_0_y_zz_yyzzzzz, g_0_y_zz_yzzzzz, g_0_y_zz_yzzzzzz, g_0_y_zz_zzzzzz, g_0_y_zz_zzzzzzz, g_0_y_zzz_xxxxxx, g_0_y_zzz_xxxxxy, g_0_y_zzz_xxxxxz, g_0_y_zzz_xxxxyy, g_0_y_zzz_xxxxyz, g_0_y_zzz_xxxxzz, g_0_y_zzz_xxxyyy, g_0_y_zzz_xxxyyz, g_0_y_zzz_xxxyzz, g_0_y_zzz_xxxzzz, g_0_y_zzz_xxyyyy, g_0_y_zzz_xxyyyz, g_0_y_zzz_xxyyzz, g_0_y_zzz_xxyzzz, g_0_y_zzz_xxzzzz, g_0_y_zzz_xyyyyy, g_0_y_zzz_xyyyyz, g_0_y_zzz_xyyyzz, g_0_y_zzz_xyyzzz, g_0_y_zzz_xyzzzz, g_0_y_zzz_xzzzzz, g_0_y_zzz_yyyyyy, g_0_y_zzz_yyyyyz, g_0_y_zzz_yyyyzz, g_0_y_zzz_yyyzzz, g_0_y_zzz_yyzzzz, g_0_y_zzz_yzzzzz, g_0_y_zzz_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_y_zzz_xxxxxx[k] = -g_0_y_zz_xxxxxx[k] * ab_z + g_0_y_zz_xxxxxxz[k];

                g_0_y_zzz_xxxxxy[k] = -g_0_y_zz_xxxxxy[k] * ab_z + g_0_y_zz_xxxxxyz[k];

                g_0_y_zzz_xxxxxz[k] = -g_0_y_zz_xxxxxz[k] * ab_z + g_0_y_zz_xxxxxzz[k];

                g_0_y_zzz_xxxxyy[k] = -g_0_y_zz_xxxxyy[k] * ab_z + g_0_y_zz_xxxxyyz[k];

                g_0_y_zzz_xxxxyz[k] = -g_0_y_zz_xxxxyz[k] * ab_z + g_0_y_zz_xxxxyzz[k];

                g_0_y_zzz_xxxxzz[k] = -g_0_y_zz_xxxxzz[k] * ab_z + g_0_y_zz_xxxxzzz[k];

                g_0_y_zzz_xxxyyy[k] = -g_0_y_zz_xxxyyy[k] * ab_z + g_0_y_zz_xxxyyyz[k];

                g_0_y_zzz_xxxyyz[k] = -g_0_y_zz_xxxyyz[k] * ab_z + g_0_y_zz_xxxyyzz[k];

                g_0_y_zzz_xxxyzz[k] = -g_0_y_zz_xxxyzz[k] * ab_z + g_0_y_zz_xxxyzzz[k];

                g_0_y_zzz_xxxzzz[k] = -g_0_y_zz_xxxzzz[k] * ab_z + g_0_y_zz_xxxzzzz[k];

                g_0_y_zzz_xxyyyy[k] = -g_0_y_zz_xxyyyy[k] * ab_z + g_0_y_zz_xxyyyyz[k];

                g_0_y_zzz_xxyyyz[k] = -g_0_y_zz_xxyyyz[k] * ab_z + g_0_y_zz_xxyyyzz[k];

                g_0_y_zzz_xxyyzz[k] = -g_0_y_zz_xxyyzz[k] * ab_z + g_0_y_zz_xxyyzzz[k];

                g_0_y_zzz_xxyzzz[k] = -g_0_y_zz_xxyzzz[k] * ab_z + g_0_y_zz_xxyzzzz[k];

                g_0_y_zzz_xxzzzz[k] = -g_0_y_zz_xxzzzz[k] * ab_z + g_0_y_zz_xxzzzzz[k];

                g_0_y_zzz_xyyyyy[k] = -g_0_y_zz_xyyyyy[k] * ab_z + g_0_y_zz_xyyyyyz[k];

                g_0_y_zzz_xyyyyz[k] = -g_0_y_zz_xyyyyz[k] * ab_z + g_0_y_zz_xyyyyzz[k];

                g_0_y_zzz_xyyyzz[k] = -g_0_y_zz_xyyyzz[k] * ab_z + g_0_y_zz_xyyyzzz[k];

                g_0_y_zzz_xyyzzz[k] = -g_0_y_zz_xyyzzz[k] * ab_z + g_0_y_zz_xyyzzzz[k];

                g_0_y_zzz_xyzzzz[k] = -g_0_y_zz_xyzzzz[k] * ab_z + g_0_y_zz_xyzzzzz[k];

                g_0_y_zzz_xzzzzz[k] = -g_0_y_zz_xzzzzz[k] * ab_z + g_0_y_zz_xzzzzzz[k];

                g_0_y_zzz_yyyyyy[k] = -g_0_y_zz_yyyyyy[k] * ab_z + g_0_y_zz_yyyyyyz[k];

                g_0_y_zzz_yyyyyz[k] = -g_0_y_zz_yyyyyz[k] * ab_z + g_0_y_zz_yyyyyzz[k];

                g_0_y_zzz_yyyyzz[k] = -g_0_y_zz_yyyyzz[k] * ab_z + g_0_y_zz_yyyyzzz[k];

                g_0_y_zzz_yyyzzz[k] = -g_0_y_zz_yyyzzz[k] * ab_z + g_0_y_zz_yyyzzzz[k];

                g_0_y_zzz_yyzzzz[k] = -g_0_y_zz_yyzzzz[k] * ab_z + g_0_y_zz_yyzzzzz[k];

                g_0_y_zzz_yzzzzz[k] = -g_0_y_zz_yzzzzz[k] * ab_z + g_0_y_zz_yzzzzzz[k];

                g_0_y_zzz_zzzzzz[k] = -g_0_y_zz_zzzzzz[k] * ab_z + g_0_y_zz_zzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_z_xx_xxxxxx, g_0_z_xx_xxxxxxx, g_0_z_xx_xxxxxxy, g_0_z_xx_xxxxxxz, g_0_z_xx_xxxxxy, g_0_z_xx_xxxxxyy, g_0_z_xx_xxxxxyz, g_0_z_xx_xxxxxz, g_0_z_xx_xxxxxzz, g_0_z_xx_xxxxyy, g_0_z_xx_xxxxyyy, g_0_z_xx_xxxxyyz, g_0_z_xx_xxxxyz, g_0_z_xx_xxxxyzz, g_0_z_xx_xxxxzz, g_0_z_xx_xxxxzzz, g_0_z_xx_xxxyyy, g_0_z_xx_xxxyyyy, g_0_z_xx_xxxyyyz, g_0_z_xx_xxxyyz, g_0_z_xx_xxxyyzz, g_0_z_xx_xxxyzz, g_0_z_xx_xxxyzzz, g_0_z_xx_xxxzzz, g_0_z_xx_xxxzzzz, g_0_z_xx_xxyyyy, g_0_z_xx_xxyyyyy, g_0_z_xx_xxyyyyz, g_0_z_xx_xxyyyz, g_0_z_xx_xxyyyzz, g_0_z_xx_xxyyzz, g_0_z_xx_xxyyzzz, g_0_z_xx_xxyzzz, g_0_z_xx_xxyzzzz, g_0_z_xx_xxzzzz, g_0_z_xx_xxzzzzz, g_0_z_xx_xyyyyy, g_0_z_xx_xyyyyyy, g_0_z_xx_xyyyyyz, g_0_z_xx_xyyyyz, g_0_z_xx_xyyyyzz, g_0_z_xx_xyyyzz, g_0_z_xx_xyyyzzz, g_0_z_xx_xyyzzz, g_0_z_xx_xyyzzzz, g_0_z_xx_xyzzzz, g_0_z_xx_xyzzzzz, g_0_z_xx_xzzzzz, g_0_z_xx_xzzzzzz, g_0_z_xx_yyyyyy, g_0_z_xx_yyyyyz, g_0_z_xx_yyyyzz, g_0_z_xx_yyyzzz, g_0_z_xx_yyzzzz, g_0_z_xx_yzzzzz, g_0_z_xx_zzzzzz, g_0_z_xxx_xxxxxx, g_0_z_xxx_xxxxxy, g_0_z_xxx_xxxxxz, g_0_z_xxx_xxxxyy, g_0_z_xxx_xxxxyz, g_0_z_xxx_xxxxzz, g_0_z_xxx_xxxyyy, g_0_z_xxx_xxxyyz, g_0_z_xxx_xxxyzz, g_0_z_xxx_xxxzzz, g_0_z_xxx_xxyyyy, g_0_z_xxx_xxyyyz, g_0_z_xxx_xxyyzz, g_0_z_xxx_xxyzzz, g_0_z_xxx_xxzzzz, g_0_z_xxx_xyyyyy, g_0_z_xxx_xyyyyz, g_0_z_xxx_xyyyzz, g_0_z_xxx_xyyzzz, g_0_z_xxx_xyzzzz, g_0_z_xxx_xzzzzz, g_0_z_xxx_yyyyyy, g_0_z_xxx_yyyyyz, g_0_z_xxx_yyyyzz, g_0_z_xxx_yyyzzz, g_0_z_xxx_yyzzzz, g_0_z_xxx_yzzzzz, g_0_z_xxx_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_z_xxx_xxxxxx[k] = -g_0_z_xx_xxxxxx[k] * ab_x + g_0_z_xx_xxxxxxx[k];

                g_0_z_xxx_xxxxxy[k] = -g_0_z_xx_xxxxxy[k] * ab_x + g_0_z_xx_xxxxxxy[k];

                g_0_z_xxx_xxxxxz[k] = -g_0_z_xx_xxxxxz[k] * ab_x + g_0_z_xx_xxxxxxz[k];

                g_0_z_xxx_xxxxyy[k] = -g_0_z_xx_xxxxyy[k] * ab_x + g_0_z_xx_xxxxxyy[k];

                g_0_z_xxx_xxxxyz[k] = -g_0_z_xx_xxxxyz[k] * ab_x + g_0_z_xx_xxxxxyz[k];

                g_0_z_xxx_xxxxzz[k] = -g_0_z_xx_xxxxzz[k] * ab_x + g_0_z_xx_xxxxxzz[k];

                g_0_z_xxx_xxxyyy[k] = -g_0_z_xx_xxxyyy[k] * ab_x + g_0_z_xx_xxxxyyy[k];

                g_0_z_xxx_xxxyyz[k] = -g_0_z_xx_xxxyyz[k] * ab_x + g_0_z_xx_xxxxyyz[k];

                g_0_z_xxx_xxxyzz[k] = -g_0_z_xx_xxxyzz[k] * ab_x + g_0_z_xx_xxxxyzz[k];

                g_0_z_xxx_xxxzzz[k] = -g_0_z_xx_xxxzzz[k] * ab_x + g_0_z_xx_xxxxzzz[k];

                g_0_z_xxx_xxyyyy[k] = -g_0_z_xx_xxyyyy[k] * ab_x + g_0_z_xx_xxxyyyy[k];

                g_0_z_xxx_xxyyyz[k] = -g_0_z_xx_xxyyyz[k] * ab_x + g_0_z_xx_xxxyyyz[k];

                g_0_z_xxx_xxyyzz[k] = -g_0_z_xx_xxyyzz[k] * ab_x + g_0_z_xx_xxxyyzz[k];

                g_0_z_xxx_xxyzzz[k] = -g_0_z_xx_xxyzzz[k] * ab_x + g_0_z_xx_xxxyzzz[k];

                g_0_z_xxx_xxzzzz[k] = -g_0_z_xx_xxzzzz[k] * ab_x + g_0_z_xx_xxxzzzz[k];

                g_0_z_xxx_xyyyyy[k] = -g_0_z_xx_xyyyyy[k] * ab_x + g_0_z_xx_xxyyyyy[k];

                g_0_z_xxx_xyyyyz[k] = -g_0_z_xx_xyyyyz[k] * ab_x + g_0_z_xx_xxyyyyz[k];

                g_0_z_xxx_xyyyzz[k] = -g_0_z_xx_xyyyzz[k] * ab_x + g_0_z_xx_xxyyyzz[k];

                g_0_z_xxx_xyyzzz[k] = -g_0_z_xx_xyyzzz[k] * ab_x + g_0_z_xx_xxyyzzz[k];

                g_0_z_xxx_xyzzzz[k] = -g_0_z_xx_xyzzzz[k] * ab_x + g_0_z_xx_xxyzzzz[k];

                g_0_z_xxx_xzzzzz[k] = -g_0_z_xx_xzzzzz[k] * ab_x + g_0_z_xx_xxzzzzz[k];

                g_0_z_xxx_yyyyyy[k] = -g_0_z_xx_yyyyyy[k] * ab_x + g_0_z_xx_xyyyyyy[k];

                g_0_z_xxx_yyyyyz[k] = -g_0_z_xx_yyyyyz[k] * ab_x + g_0_z_xx_xyyyyyz[k];

                g_0_z_xxx_yyyyzz[k] = -g_0_z_xx_yyyyzz[k] * ab_x + g_0_z_xx_xyyyyzz[k];

                g_0_z_xxx_yyyzzz[k] = -g_0_z_xx_yyyzzz[k] * ab_x + g_0_z_xx_xyyyzzz[k];

                g_0_z_xxx_yyzzzz[k] = -g_0_z_xx_yyzzzz[k] * ab_x + g_0_z_xx_xyyzzzz[k];

                g_0_z_xxx_yzzzzz[k] = -g_0_z_xx_yzzzzz[k] * ab_x + g_0_z_xx_xyzzzzz[k];

                g_0_z_xxx_zzzzzz[k] = -g_0_z_xx_zzzzzz[k] * ab_x + g_0_z_xx_xzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_z_xxy_xxxxxx, g_0_z_xxy_xxxxxy, g_0_z_xxy_xxxxxz, g_0_z_xxy_xxxxyy, g_0_z_xxy_xxxxyz, g_0_z_xxy_xxxxzz, g_0_z_xxy_xxxyyy, g_0_z_xxy_xxxyyz, g_0_z_xxy_xxxyzz, g_0_z_xxy_xxxzzz, g_0_z_xxy_xxyyyy, g_0_z_xxy_xxyyyz, g_0_z_xxy_xxyyzz, g_0_z_xxy_xxyzzz, g_0_z_xxy_xxzzzz, g_0_z_xxy_xyyyyy, g_0_z_xxy_xyyyyz, g_0_z_xxy_xyyyzz, g_0_z_xxy_xyyzzz, g_0_z_xxy_xyzzzz, g_0_z_xxy_xzzzzz, g_0_z_xxy_yyyyyy, g_0_z_xxy_yyyyyz, g_0_z_xxy_yyyyzz, g_0_z_xxy_yyyzzz, g_0_z_xxy_yyzzzz, g_0_z_xxy_yzzzzz, g_0_z_xxy_zzzzzz, g_0_z_xy_xxxxxx, g_0_z_xy_xxxxxxx, g_0_z_xy_xxxxxxy, g_0_z_xy_xxxxxxz, g_0_z_xy_xxxxxy, g_0_z_xy_xxxxxyy, g_0_z_xy_xxxxxyz, g_0_z_xy_xxxxxz, g_0_z_xy_xxxxxzz, g_0_z_xy_xxxxyy, g_0_z_xy_xxxxyyy, g_0_z_xy_xxxxyyz, g_0_z_xy_xxxxyz, g_0_z_xy_xxxxyzz, g_0_z_xy_xxxxzz, g_0_z_xy_xxxxzzz, g_0_z_xy_xxxyyy, g_0_z_xy_xxxyyyy, g_0_z_xy_xxxyyyz, g_0_z_xy_xxxyyz, g_0_z_xy_xxxyyzz, g_0_z_xy_xxxyzz, g_0_z_xy_xxxyzzz, g_0_z_xy_xxxzzz, g_0_z_xy_xxxzzzz, g_0_z_xy_xxyyyy, g_0_z_xy_xxyyyyy, g_0_z_xy_xxyyyyz, g_0_z_xy_xxyyyz, g_0_z_xy_xxyyyzz, g_0_z_xy_xxyyzz, g_0_z_xy_xxyyzzz, g_0_z_xy_xxyzzz, g_0_z_xy_xxyzzzz, g_0_z_xy_xxzzzz, g_0_z_xy_xxzzzzz, g_0_z_xy_xyyyyy, g_0_z_xy_xyyyyyy, g_0_z_xy_xyyyyyz, g_0_z_xy_xyyyyz, g_0_z_xy_xyyyyzz, g_0_z_xy_xyyyzz, g_0_z_xy_xyyyzzz, g_0_z_xy_xyyzzz, g_0_z_xy_xyyzzzz, g_0_z_xy_xyzzzz, g_0_z_xy_xyzzzzz, g_0_z_xy_xzzzzz, g_0_z_xy_xzzzzzz, g_0_z_xy_yyyyyy, g_0_z_xy_yyyyyz, g_0_z_xy_yyyyzz, g_0_z_xy_yyyzzz, g_0_z_xy_yyzzzz, g_0_z_xy_yzzzzz, g_0_z_xy_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_z_xxy_xxxxxx[k] = -g_0_z_xy_xxxxxx[k] * ab_x + g_0_z_xy_xxxxxxx[k];

                g_0_z_xxy_xxxxxy[k] = -g_0_z_xy_xxxxxy[k] * ab_x + g_0_z_xy_xxxxxxy[k];

                g_0_z_xxy_xxxxxz[k] = -g_0_z_xy_xxxxxz[k] * ab_x + g_0_z_xy_xxxxxxz[k];

                g_0_z_xxy_xxxxyy[k] = -g_0_z_xy_xxxxyy[k] * ab_x + g_0_z_xy_xxxxxyy[k];

                g_0_z_xxy_xxxxyz[k] = -g_0_z_xy_xxxxyz[k] * ab_x + g_0_z_xy_xxxxxyz[k];

                g_0_z_xxy_xxxxzz[k] = -g_0_z_xy_xxxxzz[k] * ab_x + g_0_z_xy_xxxxxzz[k];

                g_0_z_xxy_xxxyyy[k] = -g_0_z_xy_xxxyyy[k] * ab_x + g_0_z_xy_xxxxyyy[k];

                g_0_z_xxy_xxxyyz[k] = -g_0_z_xy_xxxyyz[k] * ab_x + g_0_z_xy_xxxxyyz[k];

                g_0_z_xxy_xxxyzz[k] = -g_0_z_xy_xxxyzz[k] * ab_x + g_0_z_xy_xxxxyzz[k];

                g_0_z_xxy_xxxzzz[k] = -g_0_z_xy_xxxzzz[k] * ab_x + g_0_z_xy_xxxxzzz[k];

                g_0_z_xxy_xxyyyy[k] = -g_0_z_xy_xxyyyy[k] * ab_x + g_0_z_xy_xxxyyyy[k];

                g_0_z_xxy_xxyyyz[k] = -g_0_z_xy_xxyyyz[k] * ab_x + g_0_z_xy_xxxyyyz[k];

                g_0_z_xxy_xxyyzz[k] = -g_0_z_xy_xxyyzz[k] * ab_x + g_0_z_xy_xxxyyzz[k];

                g_0_z_xxy_xxyzzz[k] = -g_0_z_xy_xxyzzz[k] * ab_x + g_0_z_xy_xxxyzzz[k];

                g_0_z_xxy_xxzzzz[k] = -g_0_z_xy_xxzzzz[k] * ab_x + g_0_z_xy_xxxzzzz[k];

                g_0_z_xxy_xyyyyy[k] = -g_0_z_xy_xyyyyy[k] * ab_x + g_0_z_xy_xxyyyyy[k];

                g_0_z_xxy_xyyyyz[k] = -g_0_z_xy_xyyyyz[k] * ab_x + g_0_z_xy_xxyyyyz[k];

                g_0_z_xxy_xyyyzz[k] = -g_0_z_xy_xyyyzz[k] * ab_x + g_0_z_xy_xxyyyzz[k];

                g_0_z_xxy_xyyzzz[k] = -g_0_z_xy_xyyzzz[k] * ab_x + g_0_z_xy_xxyyzzz[k];

                g_0_z_xxy_xyzzzz[k] = -g_0_z_xy_xyzzzz[k] * ab_x + g_0_z_xy_xxyzzzz[k];

                g_0_z_xxy_xzzzzz[k] = -g_0_z_xy_xzzzzz[k] * ab_x + g_0_z_xy_xxzzzzz[k];

                g_0_z_xxy_yyyyyy[k] = -g_0_z_xy_yyyyyy[k] * ab_x + g_0_z_xy_xyyyyyy[k];

                g_0_z_xxy_yyyyyz[k] = -g_0_z_xy_yyyyyz[k] * ab_x + g_0_z_xy_xyyyyyz[k];

                g_0_z_xxy_yyyyzz[k] = -g_0_z_xy_yyyyzz[k] * ab_x + g_0_z_xy_xyyyyzz[k];

                g_0_z_xxy_yyyzzz[k] = -g_0_z_xy_yyyzzz[k] * ab_x + g_0_z_xy_xyyyzzz[k];

                g_0_z_xxy_yyzzzz[k] = -g_0_z_xy_yyzzzz[k] * ab_x + g_0_z_xy_xyyzzzz[k];

                g_0_z_xxy_yzzzzz[k] = -g_0_z_xy_yzzzzz[k] * ab_x + g_0_z_xy_xyzzzzz[k];

                g_0_z_xxy_zzzzzz[k] = -g_0_z_xy_zzzzzz[k] * ab_x + g_0_z_xy_xzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_z_xxz_xxxxxx, g_0_z_xxz_xxxxxy, g_0_z_xxz_xxxxxz, g_0_z_xxz_xxxxyy, g_0_z_xxz_xxxxyz, g_0_z_xxz_xxxxzz, g_0_z_xxz_xxxyyy, g_0_z_xxz_xxxyyz, g_0_z_xxz_xxxyzz, g_0_z_xxz_xxxzzz, g_0_z_xxz_xxyyyy, g_0_z_xxz_xxyyyz, g_0_z_xxz_xxyyzz, g_0_z_xxz_xxyzzz, g_0_z_xxz_xxzzzz, g_0_z_xxz_xyyyyy, g_0_z_xxz_xyyyyz, g_0_z_xxz_xyyyzz, g_0_z_xxz_xyyzzz, g_0_z_xxz_xyzzzz, g_0_z_xxz_xzzzzz, g_0_z_xxz_yyyyyy, g_0_z_xxz_yyyyyz, g_0_z_xxz_yyyyzz, g_0_z_xxz_yyyzzz, g_0_z_xxz_yyzzzz, g_0_z_xxz_yzzzzz, g_0_z_xxz_zzzzzz, g_0_z_xz_xxxxxx, g_0_z_xz_xxxxxxx, g_0_z_xz_xxxxxxy, g_0_z_xz_xxxxxxz, g_0_z_xz_xxxxxy, g_0_z_xz_xxxxxyy, g_0_z_xz_xxxxxyz, g_0_z_xz_xxxxxz, g_0_z_xz_xxxxxzz, g_0_z_xz_xxxxyy, g_0_z_xz_xxxxyyy, g_0_z_xz_xxxxyyz, g_0_z_xz_xxxxyz, g_0_z_xz_xxxxyzz, g_0_z_xz_xxxxzz, g_0_z_xz_xxxxzzz, g_0_z_xz_xxxyyy, g_0_z_xz_xxxyyyy, g_0_z_xz_xxxyyyz, g_0_z_xz_xxxyyz, g_0_z_xz_xxxyyzz, g_0_z_xz_xxxyzz, g_0_z_xz_xxxyzzz, g_0_z_xz_xxxzzz, g_0_z_xz_xxxzzzz, g_0_z_xz_xxyyyy, g_0_z_xz_xxyyyyy, g_0_z_xz_xxyyyyz, g_0_z_xz_xxyyyz, g_0_z_xz_xxyyyzz, g_0_z_xz_xxyyzz, g_0_z_xz_xxyyzzz, g_0_z_xz_xxyzzz, g_0_z_xz_xxyzzzz, g_0_z_xz_xxzzzz, g_0_z_xz_xxzzzzz, g_0_z_xz_xyyyyy, g_0_z_xz_xyyyyyy, g_0_z_xz_xyyyyyz, g_0_z_xz_xyyyyz, g_0_z_xz_xyyyyzz, g_0_z_xz_xyyyzz, g_0_z_xz_xyyyzzz, g_0_z_xz_xyyzzz, g_0_z_xz_xyyzzzz, g_0_z_xz_xyzzzz, g_0_z_xz_xyzzzzz, g_0_z_xz_xzzzzz, g_0_z_xz_xzzzzzz, g_0_z_xz_yyyyyy, g_0_z_xz_yyyyyz, g_0_z_xz_yyyyzz, g_0_z_xz_yyyzzz, g_0_z_xz_yyzzzz, g_0_z_xz_yzzzzz, g_0_z_xz_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_z_xxz_xxxxxx[k] = -g_0_z_xz_xxxxxx[k] * ab_x + g_0_z_xz_xxxxxxx[k];

                g_0_z_xxz_xxxxxy[k] = -g_0_z_xz_xxxxxy[k] * ab_x + g_0_z_xz_xxxxxxy[k];

                g_0_z_xxz_xxxxxz[k] = -g_0_z_xz_xxxxxz[k] * ab_x + g_0_z_xz_xxxxxxz[k];

                g_0_z_xxz_xxxxyy[k] = -g_0_z_xz_xxxxyy[k] * ab_x + g_0_z_xz_xxxxxyy[k];

                g_0_z_xxz_xxxxyz[k] = -g_0_z_xz_xxxxyz[k] * ab_x + g_0_z_xz_xxxxxyz[k];

                g_0_z_xxz_xxxxzz[k] = -g_0_z_xz_xxxxzz[k] * ab_x + g_0_z_xz_xxxxxzz[k];

                g_0_z_xxz_xxxyyy[k] = -g_0_z_xz_xxxyyy[k] * ab_x + g_0_z_xz_xxxxyyy[k];

                g_0_z_xxz_xxxyyz[k] = -g_0_z_xz_xxxyyz[k] * ab_x + g_0_z_xz_xxxxyyz[k];

                g_0_z_xxz_xxxyzz[k] = -g_0_z_xz_xxxyzz[k] * ab_x + g_0_z_xz_xxxxyzz[k];

                g_0_z_xxz_xxxzzz[k] = -g_0_z_xz_xxxzzz[k] * ab_x + g_0_z_xz_xxxxzzz[k];

                g_0_z_xxz_xxyyyy[k] = -g_0_z_xz_xxyyyy[k] * ab_x + g_0_z_xz_xxxyyyy[k];

                g_0_z_xxz_xxyyyz[k] = -g_0_z_xz_xxyyyz[k] * ab_x + g_0_z_xz_xxxyyyz[k];

                g_0_z_xxz_xxyyzz[k] = -g_0_z_xz_xxyyzz[k] * ab_x + g_0_z_xz_xxxyyzz[k];

                g_0_z_xxz_xxyzzz[k] = -g_0_z_xz_xxyzzz[k] * ab_x + g_0_z_xz_xxxyzzz[k];

                g_0_z_xxz_xxzzzz[k] = -g_0_z_xz_xxzzzz[k] * ab_x + g_0_z_xz_xxxzzzz[k];

                g_0_z_xxz_xyyyyy[k] = -g_0_z_xz_xyyyyy[k] * ab_x + g_0_z_xz_xxyyyyy[k];

                g_0_z_xxz_xyyyyz[k] = -g_0_z_xz_xyyyyz[k] * ab_x + g_0_z_xz_xxyyyyz[k];

                g_0_z_xxz_xyyyzz[k] = -g_0_z_xz_xyyyzz[k] * ab_x + g_0_z_xz_xxyyyzz[k];

                g_0_z_xxz_xyyzzz[k] = -g_0_z_xz_xyyzzz[k] * ab_x + g_0_z_xz_xxyyzzz[k];

                g_0_z_xxz_xyzzzz[k] = -g_0_z_xz_xyzzzz[k] * ab_x + g_0_z_xz_xxyzzzz[k];

                g_0_z_xxz_xzzzzz[k] = -g_0_z_xz_xzzzzz[k] * ab_x + g_0_z_xz_xxzzzzz[k];

                g_0_z_xxz_yyyyyy[k] = -g_0_z_xz_yyyyyy[k] * ab_x + g_0_z_xz_xyyyyyy[k];

                g_0_z_xxz_yyyyyz[k] = -g_0_z_xz_yyyyyz[k] * ab_x + g_0_z_xz_xyyyyyz[k];

                g_0_z_xxz_yyyyzz[k] = -g_0_z_xz_yyyyzz[k] * ab_x + g_0_z_xz_xyyyyzz[k];

                g_0_z_xxz_yyyzzz[k] = -g_0_z_xz_yyyzzz[k] * ab_x + g_0_z_xz_xyyyzzz[k];

                g_0_z_xxz_yyzzzz[k] = -g_0_z_xz_yyzzzz[k] * ab_x + g_0_z_xz_xyyzzzz[k];

                g_0_z_xxz_yzzzzz[k] = -g_0_z_xz_yzzzzz[k] * ab_x + g_0_z_xz_xyzzzzz[k];

                g_0_z_xxz_zzzzzz[k] = -g_0_z_xz_zzzzzz[k] * ab_x + g_0_z_xz_xzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_z_xyy_xxxxxx, g_0_z_xyy_xxxxxy, g_0_z_xyy_xxxxxz, g_0_z_xyy_xxxxyy, g_0_z_xyy_xxxxyz, g_0_z_xyy_xxxxzz, g_0_z_xyy_xxxyyy, g_0_z_xyy_xxxyyz, g_0_z_xyy_xxxyzz, g_0_z_xyy_xxxzzz, g_0_z_xyy_xxyyyy, g_0_z_xyy_xxyyyz, g_0_z_xyy_xxyyzz, g_0_z_xyy_xxyzzz, g_0_z_xyy_xxzzzz, g_0_z_xyy_xyyyyy, g_0_z_xyy_xyyyyz, g_0_z_xyy_xyyyzz, g_0_z_xyy_xyyzzz, g_0_z_xyy_xyzzzz, g_0_z_xyy_xzzzzz, g_0_z_xyy_yyyyyy, g_0_z_xyy_yyyyyz, g_0_z_xyy_yyyyzz, g_0_z_xyy_yyyzzz, g_0_z_xyy_yyzzzz, g_0_z_xyy_yzzzzz, g_0_z_xyy_zzzzzz, g_0_z_yy_xxxxxx, g_0_z_yy_xxxxxxx, g_0_z_yy_xxxxxxy, g_0_z_yy_xxxxxxz, g_0_z_yy_xxxxxy, g_0_z_yy_xxxxxyy, g_0_z_yy_xxxxxyz, g_0_z_yy_xxxxxz, g_0_z_yy_xxxxxzz, g_0_z_yy_xxxxyy, g_0_z_yy_xxxxyyy, g_0_z_yy_xxxxyyz, g_0_z_yy_xxxxyz, g_0_z_yy_xxxxyzz, g_0_z_yy_xxxxzz, g_0_z_yy_xxxxzzz, g_0_z_yy_xxxyyy, g_0_z_yy_xxxyyyy, g_0_z_yy_xxxyyyz, g_0_z_yy_xxxyyz, g_0_z_yy_xxxyyzz, g_0_z_yy_xxxyzz, g_0_z_yy_xxxyzzz, g_0_z_yy_xxxzzz, g_0_z_yy_xxxzzzz, g_0_z_yy_xxyyyy, g_0_z_yy_xxyyyyy, g_0_z_yy_xxyyyyz, g_0_z_yy_xxyyyz, g_0_z_yy_xxyyyzz, g_0_z_yy_xxyyzz, g_0_z_yy_xxyyzzz, g_0_z_yy_xxyzzz, g_0_z_yy_xxyzzzz, g_0_z_yy_xxzzzz, g_0_z_yy_xxzzzzz, g_0_z_yy_xyyyyy, g_0_z_yy_xyyyyyy, g_0_z_yy_xyyyyyz, g_0_z_yy_xyyyyz, g_0_z_yy_xyyyyzz, g_0_z_yy_xyyyzz, g_0_z_yy_xyyyzzz, g_0_z_yy_xyyzzz, g_0_z_yy_xyyzzzz, g_0_z_yy_xyzzzz, g_0_z_yy_xyzzzzz, g_0_z_yy_xzzzzz, g_0_z_yy_xzzzzzz, g_0_z_yy_yyyyyy, g_0_z_yy_yyyyyz, g_0_z_yy_yyyyzz, g_0_z_yy_yyyzzz, g_0_z_yy_yyzzzz, g_0_z_yy_yzzzzz, g_0_z_yy_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_z_xyy_xxxxxx[k] = -g_0_z_yy_xxxxxx[k] * ab_x + g_0_z_yy_xxxxxxx[k];

                g_0_z_xyy_xxxxxy[k] = -g_0_z_yy_xxxxxy[k] * ab_x + g_0_z_yy_xxxxxxy[k];

                g_0_z_xyy_xxxxxz[k] = -g_0_z_yy_xxxxxz[k] * ab_x + g_0_z_yy_xxxxxxz[k];

                g_0_z_xyy_xxxxyy[k] = -g_0_z_yy_xxxxyy[k] * ab_x + g_0_z_yy_xxxxxyy[k];

                g_0_z_xyy_xxxxyz[k] = -g_0_z_yy_xxxxyz[k] * ab_x + g_0_z_yy_xxxxxyz[k];

                g_0_z_xyy_xxxxzz[k] = -g_0_z_yy_xxxxzz[k] * ab_x + g_0_z_yy_xxxxxzz[k];

                g_0_z_xyy_xxxyyy[k] = -g_0_z_yy_xxxyyy[k] * ab_x + g_0_z_yy_xxxxyyy[k];

                g_0_z_xyy_xxxyyz[k] = -g_0_z_yy_xxxyyz[k] * ab_x + g_0_z_yy_xxxxyyz[k];

                g_0_z_xyy_xxxyzz[k] = -g_0_z_yy_xxxyzz[k] * ab_x + g_0_z_yy_xxxxyzz[k];

                g_0_z_xyy_xxxzzz[k] = -g_0_z_yy_xxxzzz[k] * ab_x + g_0_z_yy_xxxxzzz[k];

                g_0_z_xyy_xxyyyy[k] = -g_0_z_yy_xxyyyy[k] * ab_x + g_0_z_yy_xxxyyyy[k];

                g_0_z_xyy_xxyyyz[k] = -g_0_z_yy_xxyyyz[k] * ab_x + g_0_z_yy_xxxyyyz[k];

                g_0_z_xyy_xxyyzz[k] = -g_0_z_yy_xxyyzz[k] * ab_x + g_0_z_yy_xxxyyzz[k];

                g_0_z_xyy_xxyzzz[k] = -g_0_z_yy_xxyzzz[k] * ab_x + g_0_z_yy_xxxyzzz[k];

                g_0_z_xyy_xxzzzz[k] = -g_0_z_yy_xxzzzz[k] * ab_x + g_0_z_yy_xxxzzzz[k];

                g_0_z_xyy_xyyyyy[k] = -g_0_z_yy_xyyyyy[k] * ab_x + g_0_z_yy_xxyyyyy[k];

                g_0_z_xyy_xyyyyz[k] = -g_0_z_yy_xyyyyz[k] * ab_x + g_0_z_yy_xxyyyyz[k];

                g_0_z_xyy_xyyyzz[k] = -g_0_z_yy_xyyyzz[k] * ab_x + g_0_z_yy_xxyyyzz[k];

                g_0_z_xyy_xyyzzz[k] = -g_0_z_yy_xyyzzz[k] * ab_x + g_0_z_yy_xxyyzzz[k];

                g_0_z_xyy_xyzzzz[k] = -g_0_z_yy_xyzzzz[k] * ab_x + g_0_z_yy_xxyzzzz[k];

                g_0_z_xyy_xzzzzz[k] = -g_0_z_yy_xzzzzz[k] * ab_x + g_0_z_yy_xxzzzzz[k];

                g_0_z_xyy_yyyyyy[k] = -g_0_z_yy_yyyyyy[k] * ab_x + g_0_z_yy_xyyyyyy[k];

                g_0_z_xyy_yyyyyz[k] = -g_0_z_yy_yyyyyz[k] * ab_x + g_0_z_yy_xyyyyyz[k];

                g_0_z_xyy_yyyyzz[k] = -g_0_z_yy_yyyyzz[k] * ab_x + g_0_z_yy_xyyyyzz[k];

                g_0_z_xyy_yyyzzz[k] = -g_0_z_yy_yyyzzz[k] * ab_x + g_0_z_yy_xyyyzzz[k];

                g_0_z_xyy_yyzzzz[k] = -g_0_z_yy_yyzzzz[k] * ab_x + g_0_z_yy_xyyzzzz[k];

                g_0_z_xyy_yzzzzz[k] = -g_0_z_yy_yzzzzz[k] * ab_x + g_0_z_yy_xyzzzzz[k];

                g_0_z_xyy_zzzzzz[k] = -g_0_z_yy_zzzzzz[k] * ab_x + g_0_z_yy_xzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_z_xyz_xxxxxx, g_0_z_xyz_xxxxxy, g_0_z_xyz_xxxxxz, g_0_z_xyz_xxxxyy, g_0_z_xyz_xxxxyz, g_0_z_xyz_xxxxzz, g_0_z_xyz_xxxyyy, g_0_z_xyz_xxxyyz, g_0_z_xyz_xxxyzz, g_0_z_xyz_xxxzzz, g_0_z_xyz_xxyyyy, g_0_z_xyz_xxyyyz, g_0_z_xyz_xxyyzz, g_0_z_xyz_xxyzzz, g_0_z_xyz_xxzzzz, g_0_z_xyz_xyyyyy, g_0_z_xyz_xyyyyz, g_0_z_xyz_xyyyzz, g_0_z_xyz_xyyzzz, g_0_z_xyz_xyzzzz, g_0_z_xyz_xzzzzz, g_0_z_xyz_yyyyyy, g_0_z_xyz_yyyyyz, g_0_z_xyz_yyyyzz, g_0_z_xyz_yyyzzz, g_0_z_xyz_yyzzzz, g_0_z_xyz_yzzzzz, g_0_z_xyz_zzzzzz, g_0_z_yz_xxxxxx, g_0_z_yz_xxxxxxx, g_0_z_yz_xxxxxxy, g_0_z_yz_xxxxxxz, g_0_z_yz_xxxxxy, g_0_z_yz_xxxxxyy, g_0_z_yz_xxxxxyz, g_0_z_yz_xxxxxz, g_0_z_yz_xxxxxzz, g_0_z_yz_xxxxyy, g_0_z_yz_xxxxyyy, g_0_z_yz_xxxxyyz, g_0_z_yz_xxxxyz, g_0_z_yz_xxxxyzz, g_0_z_yz_xxxxzz, g_0_z_yz_xxxxzzz, g_0_z_yz_xxxyyy, g_0_z_yz_xxxyyyy, g_0_z_yz_xxxyyyz, g_0_z_yz_xxxyyz, g_0_z_yz_xxxyyzz, g_0_z_yz_xxxyzz, g_0_z_yz_xxxyzzz, g_0_z_yz_xxxzzz, g_0_z_yz_xxxzzzz, g_0_z_yz_xxyyyy, g_0_z_yz_xxyyyyy, g_0_z_yz_xxyyyyz, g_0_z_yz_xxyyyz, g_0_z_yz_xxyyyzz, g_0_z_yz_xxyyzz, g_0_z_yz_xxyyzzz, g_0_z_yz_xxyzzz, g_0_z_yz_xxyzzzz, g_0_z_yz_xxzzzz, g_0_z_yz_xxzzzzz, g_0_z_yz_xyyyyy, g_0_z_yz_xyyyyyy, g_0_z_yz_xyyyyyz, g_0_z_yz_xyyyyz, g_0_z_yz_xyyyyzz, g_0_z_yz_xyyyzz, g_0_z_yz_xyyyzzz, g_0_z_yz_xyyzzz, g_0_z_yz_xyyzzzz, g_0_z_yz_xyzzzz, g_0_z_yz_xyzzzzz, g_0_z_yz_xzzzzz, g_0_z_yz_xzzzzzz, g_0_z_yz_yyyyyy, g_0_z_yz_yyyyyz, g_0_z_yz_yyyyzz, g_0_z_yz_yyyzzz, g_0_z_yz_yyzzzz, g_0_z_yz_yzzzzz, g_0_z_yz_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_z_xyz_xxxxxx[k] = -g_0_z_yz_xxxxxx[k] * ab_x + g_0_z_yz_xxxxxxx[k];

                g_0_z_xyz_xxxxxy[k] = -g_0_z_yz_xxxxxy[k] * ab_x + g_0_z_yz_xxxxxxy[k];

                g_0_z_xyz_xxxxxz[k] = -g_0_z_yz_xxxxxz[k] * ab_x + g_0_z_yz_xxxxxxz[k];

                g_0_z_xyz_xxxxyy[k] = -g_0_z_yz_xxxxyy[k] * ab_x + g_0_z_yz_xxxxxyy[k];

                g_0_z_xyz_xxxxyz[k] = -g_0_z_yz_xxxxyz[k] * ab_x + g_0_z_yz_xxxxxyz[k];

                g_0_z_xyz_xxxxzz[k] = -g_0_z_yz_xxxxzz[k] * ab_x + g_0_z_yz_xxxxxzz[k];

                g_0_z_xyz_xxxyyy[k] = -g_0_z_yz_xxxyyy[k] * ab_x + g_0_z_yz_xxxxyyy[k];

                g_0_z_xyz_xxxyyz[k] = -g_0_z_yz_xxxyyz[k] * ab_x + g_0_z_yz_xxxxyyz[k];

                g_0_z_xyz_xxxyzz[k] = -g_0_z_yz_xxxyzz[k] * ab_x + g_0_z_yz_xxxxyzz[k];

                g_0_z_xyz_xxxzzz[k] = -g_0_z_yz_xxxzzz[k] * ab_x + g_0_z_yz_xxxxzzz[k];

                g_0_z_xyz_xxyyyy[k] = -g_0_z_yz_xxyyyy[k] * ab_x + g_0_z_yz_xxxyyyy[k];

                g_0_z_xyz_xxyyyz[k] = -g_0_z_yz_xxyyyz[k] * ab_x + g_0_z_yz_xxxyyyz[k];

                g_0_z_xyz_xxyyzz[k] = -g_0_z_yz_xxyyzz[k] * ab_x + g_0_z_yz_xxxyyzz[k];

                g_0_z_xyz_xxyzzz[k] = -g_0_z_yz_xxyzzz[k] * ab_x + g_0_z_yz_xxxyzzz[k];

                g_0_z_xyz_xxzzzz[k] = -g_0_z_yz_xxzzzz[k] * ab_x + g_0_z_yz_xxxzzzz[k];

                g_0_z_xyz_xyyyyy[k] = -g_0_z_yz_xyyyyy[k] * ab_x + g_0_z_yz_xxyyyyy[k];

                g_0_z_xyz_xyyyyz[k] = -g_0_z_yz_xyyyyz[k] * ab_x + g_0_z_yz_xxyyyyz[k];

                g_0_z_xyz_xyyyzz[k] = -g_0_z_yz_xyyyzz[k] * ab_x + g_0_z_yz_xxyyyzz[k];

                g_0_z_xyz_xyyzzz[k] = -g_0_z_yz_xyyzzz[k] * ab_x + g_0_z_yz_xxyyzzz[k];

                g_0_z_xyz_xyzzzz[k] = -g_0_z_yz_xyzzzz[k] * ab_x + g_0_z_yz_xxyzzzz[k];

                g_0_z_xyz_xzzzzz[k] = -g_0_z_yz_xzzzzz[k] * ab_x + g_0_z_yz_xxzzzzz[k];

                g_0_z_xyz_yyyyyy[k] = -g_0_z_yz_yyyyyy[k] * ab_x + g_0_z_yz_xyyyyyy[k];

                g_0_z_xyz_yyyyyz[k] = -g_0_z_yz_yyyyyz[k] * ab_x + g_0_z_yz_xyyyyyz[k];

                g_0_z_xyz_yyyyzz[k] = -g_0_z_yz_yyyyzz[k] * ab_x + g_0_z_yz_xyyyyzz[k];

                g_0_z_xyz_yyyzzz[k] = -g_0_z_yz_yyyzzz[k] * ab_x + g_0_z_yz_xyyyzzz[k];

                g_0_z_xyz_yyzzzz[k] = -g_0_z_yz_yyzzzz[k] * ab_x + g_0_z_yz_xyyzzzz[k];

                g_0_z_xyz_yzzzzz[k] = -g_0_z_yz_yzzzzz[k] * ab_x + g_0_z_yz_xyzzzzz[k];

                g_0_z_xyz_zzzzzz[k] = -g_0_z_yz_zzzzzz[k] * ab_x + g_0_z_yz_xzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_z_xzz_xxxxxx, g_0_z_xzz_xxxxxy, g_0_z_xzz_xxxxxz, g_0_z_xzz_xxxxyy, g_0_z_xzz_xxxxyz, g_0_z_xzz_xxxxzz, g_0_z_xzz_xxxyyy, g_0_z_xzz_xxxyyz, g_0_z_xzz_xxxyzz, g_0_z_xzz_xxxzzz, g_0_z_xzz_xxyyyy, g_0_z_xzz_xxyyyz, g_0_z_xzz_xxyyzz, g_0_z_xzz_xxyzzz, g_0_z_xzz_xxzzzz, g_0_z_xzz_xyyyyy, g_0_z_xzz_xyyyyz, g_0_z_xzz_xyyyzz, g_0_z_xzz_xyyzzz, g_0_z_xzz_xyzzzz, g_0_z_xzz_xzzzzz, g_0_z_xzz_yyyyyy, g_0_z_xzz_yyyyyz, g_0_z_xzz_yyyyzz, g_0_z_xzz_yyyzzz, g_0_z_xzz_yyzzzz, g_0_z_xzz_yzzzzz, g_0_z_xzz_zzzzzz, g_0_z_zz_xxxxxx, g_0_z_zz_xxxxxxx, g_0_z_zz_xxxxxxy, g_0_z_zz_xxxxxxz, g_0_z_zz_xxxxxy, g_0_z_zz_xxxxxyy, g_0_z_zz_xxxxxyz, g_0_z_zz_xxxxxz, g_0_z_zz_xxxxxzz, g_0_z_zz_xxxxyy, g_0_z_zz_xxxxyyy, g_0_z_zz_xxxxyyz, g_0_z_zz_xxxxyz, g_0_z_zz_xxxxyzz, g_0_z_zz_xxxxzz, g_0_z_zz_xxxxzzz, g_0_z_zz_xxxyyy, g_0_z_zz_xxxyyyy, g_0_z_zz_xxxyyyz, g_0_z_zz_xxxyyz, g_0_z_zz_xxxyyzz, g_0_z_zz_xxxyzz, g_0_z_zz_xxxyzzz, g_0_z_zz_xxxzzz, g_0_z_zz_xxxzzzz, g_0_z_zz_xxyyyy, g_0_z_zz_xxyyyyy, g_0_z_zz_xxyyyyz, g_0_z_zz_xxyyyz, g_0_z_zz_xxyyyzz, g_0_z_zz_xxyyzz, g_0_z_zz_xxyyzzz, g_0_z_zz_xxyzzz, g_0_z_zz_xxyzzzz, g_0_z_zz_xxzzzz, g_0_z_zz_xxzzzzz, g_0_z_zz_xyyyyy, g_0_z_zz_xyyyyyy, g_0_z_zz_xyyyyyz, g_0_z_zz_xyyyyz, g_0_z_zz_xyyyyzz, g_0_z_zz_xyyyzz, g_0_z_zz_xyyyzzz, g_0_z_zz_xyyzzz, g_0_z_zz_xyyzzzz, g_0_z_zz_xyzzzz, g_0_z_zz_xyzzzzz, g_0_z_zz_xzzzzz, g_0_z_zz_xzzzzzz, g_0_z_zz_yyyyyy, g_0_z_zz_yyyyyz, g_0_z_zz_yyyyzz, g_0_z_zz_yyyzzz, g_0_z_zz_yyzzzz, g_0_z_zz_yzzzzz, g_0_z_zz_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_z_xzz_xxxxxx[k] = -g_0_z_zz_xxxxxx[k] * ab_x + g_0_z_zz_xxxxxxx[k];

                g_0_z_xzz_xxxxxy[k] = -g_0_z_zz_xxxxxy[k] * ab_x + g_0_z_zz_xxxxxxy[k];

                g_0_z_xzz_xxxxxz[k] = -g_0_z_zz_xxxxxz[k] * ab_x + g_0_z_zz_xxxxxxz[k];

                g_0_z_xzz_xxxxyy[k] = -g_0_z_zz_xxxxyy[k] * ab_x + g_0_z_zz_xxxxxyy[k];

                g_0_z_xzz_xxxxyz[k] = -g_0_z_zz_xxxxyz[k] * ab_x + g_0_z_zz_xxxxxyz[k];

                g_0_z_xzz_xxxxzz[k] = -g_0_z_zz_xxxxzz[k] * ab_x + g_0_z_zz_xxxxxzz[k];

                g_0_z_xzz_xxxyyy[k] = -g_0_z_zz_xxxyyy[k] * ab_x + g_0_z_zz_xxxxyyy[k];

                g_0_z_xzz_xxxyyz[k] = -g_0_z_zz_xxxyyz[k] * ab_x + g_0_z_zz_xxxxyyz[k];

                g_0_z_xzz_xxxyzz[k] = -g_0_z_zz_xxxyzz[k] * ab_x + g_0_z_zz_xxxxyzz[k];

                g_0_z_xzz_xxxzzz[k] = -g_0_z_zz_xxxzzz[k] * ab_x + g_0_z_zz_xxxxzzz[k];

                g_0_z_xzz_xxyyyy[k] = -g_0_z_zz_xxyyyy[k] * ab_x + g_0_z_zz_xxxyyyy[k];

                g_0_z_xzz_xxyyyz[k] = -g_0_z_zz_xxyyyz[k] * ab_x + g_0_z_zz_xxxyyyz[k];

                g_0_z_xzz_xxyyzz[k] = -g_0_z_zz_xxyyzz[k] * ab_x + g_0_z_zz_xxxyyzz[k];

                g_0_z_xzz_xxyzzz[k] = -g_0_z_zz_xxyzzz[k] * ab_x + g_0_z_zz_xxxyzzz[k];

                g_0_z_xzz_xxzzzz[k] = -g_0_z_zz_xxzzzz[k] * ab_x + g_0_z_zz_xxxzzzz[k];

                g_0_z_xzz_xyyyyy[k] = -g_0_z_zz_xyyyyy[k] * ab_x + g_0_z_zz_xxyyyyy[k];

                g_0_z_xzz_xyyyyz[k] = -g_0_z_zz_xyyyyz[k] * ab_x + g_0_z_zz_xxyyyyz[k];

                g_0_z_xzz_xyyyzz[k] = -g_0_z_zz_xyyyzz[k] * ab_x + g_0_z_zz_xxyyyzz[k];

                g_0_z_xzz_xyyzzz[k] = -g_0_z_zz_xyyzzz[k] * ab_x + g_0_z_zz_xxyyzzz[k];

                g_0_z_xzz_xyzzzz[k] = -g_0_z_zz_xyzzzz[k] * ab_x + g_0_z_zz_xxyzzzz[k];

                g_0_z_xzz_xzzzzz[k] = -g_0_z_zz_xzzzzz[k] * ab_x + g_0_z_zz_xxzzzzz[k];

                g_0_z_xzz_yyyyyy[k] = -g_0_z_zz_yyyyyy[k] * ab_x + g_0_z_zz_xyyyyyy[k];

                g_0_z_xzz_yyyyyz[k] = -g_0_z_zz_yyyyyz[k] * ab_x + g_0_z_zz_xyyyyyz[k];

                g_0_z_xzz_yyyyzz[k] = -g_0_z_zz_yyyyzz[k] * ab_x + g_0_z_zz_xyyyyzz[k];

                g_0_z_xzz_yyyzzz[k] = -g_0_z_zz_yyyzzz[k] * ab_x + g_0_z_zz_xyyyzzz[k];

                g_0_z_xzz_yyzzzz[k] = -g_0_z_zz_yyzzzz[k] * ab_x + g_0_z_zz_xyyzzzz[k];

                g_0_z_xzz_yzzzzz[k] = -g_0_z_zz_yzzzzz[k] * ab_x + g_0_z_zz_xyzzzzz[k];

                g_0_z_xzz_zzzzzz[k] = -g_0_z_zz_zzzzzz[k] * ab_x + g_0_z_zz_xzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_z_yy_xxxxxx, g_0_z_yy_xxxxxxy, g_0_z_yy_xxxxxy, g_0_z_yy_xxxxxyy, g_0_z_yy_xxxxxyz, g_0_z_yy_xxxxxz, g_0_z_yy_xxxxyy, g_0_z_yy_xxxxyyy, g_0_z_yy_xxxxyyz, g_0_z_yy_xxxxyz, g_0_z_yy_xxxxyzz, g_0_z_yy_xxxxzz, g_0_z_yy_xxxyyy, g_0_z_yy_xxxyyyy, g_0_z_yy_xxxyyyz, g_0_z_yy_xxxyyz, g_0_z_yy_xxxyyzz, g_0_z_yy_xxxyzz, g_0_z_yy_xxxyzzz, g_0_z_yy_xxxzzz, g_0_z_yy_xxyyyy, g_0_z_yy_xxyyyyy, g_0_z_yy_xxyyyyz, g_0_z_yy_xxyyyz, g_0_z_yy_xxyyyzz, g_0_z_yy_xxyyzz, g_0_z_yy_xxyyzzz, g_0_z_yy_xxyzzz, g_0_z_yy_xxyzzzz, g_0_z_yy_xxzzzz, g_0_z_yy_xyyyyy, g_0_z_yy_xyyyyyy, g_0_z_yy_xyyyyyz, g_0_z_yy_xyyyyz, g_0_z_yy_xyyyyzz, g_0_z_yy_xyyyzz, g_0_z_yy_xyyyzzz, g_0_z_yy_xyyzzz, g_0_z_yy_xyyzzzz, g_0_z_yy_xyzzzz, g_0_z_yy_xyzzzzz, g_0_z_yy_xzzzzz, g_0_z_yy_yyyyyy, g_0_z_yy_yyyyyyy, g_0_z_yy_yyyyyyz, g_0_z_yy_yyyyyz, g_0_z_yy_yyyyyzz, g_0_z_yy_yyyyzz, g_0_z_yy_yyyyzzz, g_0_z_yy_yyyzzz, g_0_z_yy_yyyzzzz, g_0_z_yy_yyzzzz, g_0_z_yy_yyzzzzz, g_0_z_yy_yzzzzz, g_0_z_yy_yzzzzzz, g_0_z_yy_zzzzzz, g_0_z_yyy_xxxxxx, g_0_z_yyy_xxxxxy, g_0_z_yyy_xxxxxz, g_0_z_yyy_xxxxyy, g_0_z_yyy_xxxxyz, g_0_z_yyy_xxxxzz, g_0_z_yyy_xxxyyy, g_0_z_yyy_xxxyyz, g_0_z_yyy_xxxyzz, g_0_z_yyy_xxxzzz, g_0_z_yyy_xxyyyy, g_0_z_yyy_xxyyyz, g_0_z_yyy_xxyyzz, g_0_z_yyy_xxyzzz, g_0_z_yyy_xxzzzz, g_0_z_yyy_xyyyyy, g_0_z_yyy_xyyyyz, g_0_z_yyy_xyyyzz, g_0_z_yyy_xyyzzz, g_0_z_yyy_xyzzzz, g_0_z_yyy_xzzzzz, g_0_z_yyy_yyyyyy, g_0_z_yyy_yyyyyz, g_0_z_yyy_yyyyzz, g_0_z_yyy_yyyzzz, g_0_z_yyy_yyzzzz, g_0_z_yyy_yzzzzz, g_0_z_yyy_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_z_yyy_xxxxxx[k] = -g_0_z_yy_xxxxxx[k] * ab_y + g_0_z_yy_xxxxxxy[k];

                g_0_z_yyy_xxxxxy[k] = -g_0_z_yy_xxxxxy[k] * ab_y + g_0_z_yy_xxxxxyy[k];

                g_0_z_yyy_xxxxxz[k] = -g_0_z_yy_xxxxxz[k] * ab_y + g_0_z_yy_xxxxxyz[k];

                g_0_z_yyy_xxxxyy[k] = -g_0_z_yy_xxxxyy[k] * ab_y + g_0_z_yy_xxxxyyy[k];

                g_0_z_yyy_xxxxyz[k] = -g_0_z_yy_xxxxyz[k] * ab_y + g_0_z_yy_xxxxyyz[k];

                g_0_z_yyy_xxxxzz[k] = -g_0_z_yy_xxxxzz[k] * ab_y + g_0_z_yy_xxxxyzz[k];

                g_0_z_yyy_xxxyyy[k] = -g_0_z_yy_xxxyyy[k] * ab_y + g_0_z_yy_xxxyyyy[k];

                g_0_z_yyy_xxxyyz[k] = -g_0_z_yy_xxxyyz[k] * ab_y + g_0_z_yy_xxxyyyz[k];

                g_0_z_yyy_xxxyzz[k] = -g_0_z_yy_xxxyzz[k] * ab_y + g_0_z_yy_xxxyyzz[k];

                g_0_z_yyy_xxxzzz[k] = -g_0_z_yy_xxxzzz[k] * ab_y + g_0_z_yy_xxxyzzz[k];

                g_0_z_yyy_xxyyyy[k] = -g_0_z_yy_xxyyyy[k] * ab_y + g_0_z_yy_xxyyyyy[k];

                g_0_z_yyy_xxyyyz[k] = -g_0_z_yy_xxyyyz[k] * ab_y + g_0_z_yy_xxyyyyz[k];

                g_0_z_yyy_xxyyzz[k] = -g_0_z_yy_xxyyzz[k] * ab_y + g_0_z_yy_xxyyyzz[k];

                g_0_z_yyy_xxyzzz[k] = -g_0_z_yy_xxyzzz[k] * ab_y + g_0_z_yy_xxyyzzz[k];

                g_0_z_yyy_xxzzzz[k] = -g_0_z_yy_xxzzzz[k] * ab_y + g_0_z_yy_xxyzzzz[k];

                g_0_z_yyy_xyyyyy[k] = -g_0_z_yy_xyyyyy[k] * ab_y + g_0_z_yy_xyyyyyy[k];

                g_0_z_yyy_xyyyyz[k] = -g_0_z_yy_xyyyyz[k] * ab_y + g_0_z_yy_xyyyyyz[k];

                g_0_z_yyy_xyyyzz[k] = -g_0_z_yy_xyyyzz[k] * ab_y + g_0_z_yy_xyyyyzz[k];

                g_0_z_yyy_xyyzzz[k] = -g_0_z_yy_xyyzzz[k] * ab_y + g_0_z_yy_xyyyzzz[k];

                g_0_z_yyy_xyzzzz[k] = -g_0_z_yy_xyzzzz[k] * ab_y + g_0_z_yy_xyyzzzz[k];

                g_0_z_yyy_xzzzzz[k] = -g_0_z_yy_xzzzzz[k] * ab_y + g_0_z_yy_xyzzzzz[k];

                g_0_z_yyy_yyyyyy[k] = -g_0_z_yy_yyyyyy[k] * ab_y + g_0_z_yy_yyyyyyy[k];

                g_0_z_yyy_yyyyyz[k] = -g_0_z_yy_yyyyyz[k] * ab_y + g_0_z_yy_yyyyyyz[k];

                g_0_z_yyy_yyyyzz[k] = -g_0_z_yy_yyyyzz[k] * ab_y + g_0_z_yy_yyyyyzz[k];

                g_0_z_yyy_yyyzzz[k] = -g_0_z_yy_yyyzzz[k] * ab_y + g_0_z_yy_yyyyzzz[k];

                g_0_z_yyy_yyzzzz[k] = -g_0_z_yy_yyzzzz[k] * ab_y + g_0_z_yy_yyyzzzz[k];

                g_0_z_yyy_yzzzzz[k] = -g_0_z_yy_yzzzzz[k] * ab_y + g_0_z_yy_yyzzzzz[k];

                g_0_z_yyy_zzzzzz[k] = -g_0_z_yy_zzzzzz[k] * ab_y + g_0_z_yy_yzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_z_yyz_xxxxxx, g_0_z_yyz_xxxxxy, g_0_z_yyz_xxxxxz, g_0_z_yyz_xxxxyy, g_0_z_yyz_xxxxyz, g_0_z_yyz_xxxxzz, g_0_z_yyz_xxxyyy, g_0_z_yyz_xxxyyz, g_0_z_yyz_xxxyzz, g_0_z_yyz_xxxzzz, g_0_z_yyz_xxyyyy, g_0_z_yyz_xxyyyz, g_0_z_yyz_xxyyzz, g_0_z_yyz_xxyzzz, g_0_z_yyz_xxzzzz, g_0_z_yyz_xyyyyy, g_0_z_yyz_xyyyyz, g_0_z_yyz_xyyyzz, g_0_z_yyz_xyyzzz, g_0_z_yyz_xyzzzz, g_0_z_yyz_xzzzzz, g_0_z_yyz_yyyyyy, g_0_z_yyz_yyyyyz, g_0_z_yyz_yyyyzz, g_0_z_yyz_yyyzzz, g_0_z_yyz_yyzzzz, g_0_z_yyz_yzzzzz, g_0_z_yyz_zzzzzz, g_0_z_yz_xxxxxx, g_0_z_yz_xxxxxxy, g_0_z_yz_xxxxxy, g_0_z_yz_xxxxxyy, g_0_z_yz_xxxxxyz, g_0_z_yz_xxxxxz, g_0_z_yz_xxxxyy, g_0_z_yz_xxxxyyy, g_0_z_yz_xxxxyyz, g_0_z_yz_xxxxyz, g_0_z_yz_xxxxyzz, g_0_z_yz_xxxxzz, g_0_z_yz_xxxyyy, g_0_z_yz_xxxyyyy, g_0_z_yz_xxxyyyz, g_0_z_yz_xxxyyz, g_0_z_yz_xxxyyzz, g_0_z_yz_xxxyzz, g_0_z_yz_xxxyzzz, g_0_z_yz_xxxzzz, g_0_z_yz_xxyyyy, g_0_z_yz_xxyyyyy, g_0_z_yz_xxyyyyz, g_0_z_yz_xxyyyz, g_0_z_yz_xxyyyzz, g_0_z_yz_xxyyzz, g_0_z_yz_xxyyzzz, g_0_z_yz_xxyzzz, g_0_z_yz_xxyzzzz, g_0_z_yz_xxzzzz, g_0_z_yz_xyyyyy, g_0_z_yz_xyyyyyy, g_0_z_yz_xyyyyyz, g_0_z_yz_xyyyyz, g_0_z_yz_xyyyyzz, g_0_z_yz_xyyyzz, g_0_z_yz_xyyyzzz, g_0_z_yz_xyyzzz, g_0_z_yz_xyyzzzz, g_0_z_yz_xyzzzz, g_0_z_yz_xyzzzzz, g_0_z_yz_xzzzzz, g_0_z_yz_yyyyyy, g_0_z_yz_yyyyyyy, g_0_z_yz_yyyyyyz, g_0_z_yz_yyyyyz, g_0_z_yz_yyyyyzz, g_0_z_yz_yyyyzz, g_0_z_yz_yyyyzzz, g_0_z_yz_yyyzzz, g_0_z_yz_yyyzzzz, g_0_z_yz_yyzzzz, g_0_z_yz_yyzzzzz, g_0_z_yz_yzzzzz, g_0_z_yz_yzzzzzz, g_0_z_yz_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_z_yyz_xxxxxx[k] = -g_0_z_yz_xxxxxx[k] * ab_y + g_0_z_yz_xxxxxxy[k];

                g_0_z_yyz_xxxxxy[k] = -g_0_z_yz_xxxxxy[k] * ab_y + g_0_z_yz_xxxxxyy[k];

                g_0_z_yyz_xxxxxz[k] = -g_0_z_yz_xxxxxz[k] * ab_y + g_0_z_yz_xxxxxyz[k];

                g_0_z_yyz_xxxxyy[k] = -g_0_z_yz_xxxxyy[k] * ab_y + g_0_z_yz_xxxxyyy[k];

                g_0_z_yyz_xxxxyz[k] = -g_0_z_yz_xxxxyz[k] * ab_y + g_0_z_yz_xxxxyyz[k];

                g_0_z_yyz_xxxxzz[k] = -g_0_z_yz_xxxxzz[k] * ab_y + g_0_z_yz_xxxxyzz[k];

                g_0_z_yyz_xxxyyy[k] = -g_0_z_yz_xxxyyy[k] * ab_y + g_0_z_yz_xxxyyyy[k];

                g_0_z_yyz_xxxyyz[k] = -g_0_z_yz_xxxyyz[k] * ab_y + g_0_z_yz_xxxyyyz[k];

                g_0_z_yyz_xxxyzz[k] = -g_0_z_yz_xxxyzz[k] * ab_y + g_0_z_yz_xxxyyzz[k];

                g_0_z_yyz_xxxzzz[k] = -g_0_z_yz_xxxzzz[k] * ab_y + g_0_z_yz_xxxyzzz[k];

                g_0_z_yyz_xxyyyy[k] = -g_0_z_yz_xxyyyy[k] * ab_y + g_0_z_yz_xxyyyyy[k];

                g_0_z_yyz_xxyyyz[k] = -g_0_z_yz_xxyyyz[k] * ab_y + g_0_z_yz_xxyyyyz[k];

                g_0_z_yyz_xxyyzz[k] = -g_0_z_yz_xxyyzz[k] * ab_y + g_0_z_yz_xxyyyzz[k];

                g_0_z_yyz_xxyzzz[k] = -g_0_z_yz_xxyzzz[k] * ab_y + g_0_z_yz_xxyyzzz[k];

                g_0_z_yyz_xxzzzz[k] = -g_0_z_yz_xxzzzz[k] * ab_y + g_0_z_yz_xxyzzzz[k];

                g_0_z_yyz_xyyyyy[k] = -g_0_z_yz_xyyyyy[k] * ab_y + g_0_z_yz_xyyyyyy[k];

                g_0_z_yyz_xyyyyz[k] = -g_0_z_yz_xyyyyz[k] * ab_y + g_0_z_yz_xyyyyyz[k];

                g_0_z_yyz_xyyyzz[k] = -g_0_z_yz_xyyyzz[k] * ab_y + g_0_z_yz_xyyyyzz[k];

                g_0_z_yyz_xyyzzz[k] = -g_0_z_yz_xyyzzz[k] * ab_y + g_0_z_yz_xyyyzzz[k];

                g_0_z_yyz_xyzzzz[k] = -g_0_z_yz_xyzzzz[k] * ab_y + g_0_z_yz_xyyzzzz[k];

                g_0_z_yyz_xzzzzz[k] = -g_0_z_yz_xzzzzz[k] * ab_y + g_0_z_yz_xyzzzzz[k];

                g_0_z_yyz_yyyyyy[k] = -g_0_z_yz_yyyyyy[k] * ab_y + g_0_z_yz_yyyyyyy[k];

                g_0_z_yyz_yyyyyz[k] = -g_0_z_yz_yyyyyz[k] * ab_y + g_0_z_yz_yyyyyyz[k];

                g_0_z_yyz_yyyyzz[k] = -g_0_z_yz_yyyyzz[k] * ab_y + g_0_z_yz_yyyyyzz[k];

                g_0_z_yyz_yyyzzz[k] = -g_0_z_yz_yyyzzz[k] * ab_y + g_0_z_yz_yyyyzzz[k];

                g_0_z_yyz_yyzzzz[k] = -g_0_z_yz_yyzzzz[k] * ab_y + g_0_z_yz_yyyzzzz[k];

                g_0_z_yyz_yzzzzz[k] = -g_0_z_yz_yzzzzz[k] * ab_y + g_0_z_yz_yyzzzzz[k];

                g_0_z_yyz_zzzzzz[k] = -g_0_z_yz_zzzzzz[k] * ab_y + g_0_z_yz_yzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_z_yzz_xxxxxx, g_0_z_yzz_xxxxxy, g_0_z_yzz_xxxxxz, g_0_z_yzz_xxxxyy, g_0_z_yzz_xxxxyz, g_0_z_yzz_xxxxzz, g_0_z_yzz_xxxyyy, g_0_z_yzz_xxxyyz, g_0_z_yzz_xxxyzz, g_0_z_yzz_xxxzzz, g_0_z_yzz_xxyyyy, g_0_z_yzz_xxyyyz, g_0_z_yzz_xxyyzz, g_0_z_yzz_xxyzzz, g_0_z_yzz_xxzzzz, g_0_z_yzz_xyyyyy, g_0_z_yzz_xyyyyz, g_0_z_yzz_xyyyzz, g_0_z_yzz_xyyzzz, g_0_z_yzz_xyzzzz, g_0_z_yzz_xzzzzz, g_0_z_yzz_yyyyyy, g_0_z_yzz_yyyyyz, g_0_z_yzz_yyyyzz, g_0_z_yzz_yyyzzz, g_0_z_yzz_yyzzzz, g_0_z_yzz_yzzzzz, g_0_z_yzz_zzzzzz, g_0_z_zz_xxxxxx, g_0_z_zz_xxxxxxy, g_0_z_zz_xxxxxy, g_0_z_zz_xxxxxyy, g_0_z_zz_xxxxxyz, g_0_z_zz_xxxxxz, g_0_z_zz_xxxxyy, g_0_z_zz_xxxxyyy, g_0_z_zz_xxxxyyz, g_0_z_zz_xxxxyz, g_0_z_zz_xxxxyzz, g_0_z_zz_xxxxzz, g_0_z_zz_xxxyyy, g_0_z_zz_xxxyyyy, g_0_z_zz_xxxyyyz, g_0_z_zz_xxxyyz, g_0_z_zz_xxxyyzz, g_0_z_zz_xxxyzz, g_0_z_zz_xxxyzzz, g_0_z_zz_xxxzzz, g_0_z_zz_xxyyyy, g_0_z_zz_xxyyyyy, g_0_z_zz_xxyyyyz, g_0_z_zz_xxyyyz, g_0_z_zz_xxyyyzz, g_0_z_zz_xxyyzz, g_0_z_zz_xxyyzzz, g_0_z_zz_xxyzzz, g_0_z_zz_xxyzzzz, g_0_z_zz_xxzzzz, g_0_z_zz_xyyyyy, g_0_z_zz_xyyyyyy, g_0_z_zz_xyyyyyz, g_0_z_zz_xyyyyz, g_0_z_zz_xyyyyzz, g_0_z_zz_xyyyzz, g_0_z_zz_xyyyzzz, g_0_z_zz_xyyzzz, g_0_z_zz_xyyzzzz, g_0_z_zz_xyzzzz, g_0_z_zz_xyzzzzz, g_0_z_zz_xzzzzz, g_0_z_zz_yyyyyy, g_0_z_zz_yyyyyyy, g_0_z_zz_yyyyyyz, g_0_z_zz_yyyyyz, g_0_z_zz_yyyyyzz, g_0_z_zz_yyyyzz, g_0_z_zz_yyyyzzz, g_0_z_zz_yyyzzz, g_0_z_zz_yyyzzzz, g_0_z_zz_yyzzzz, g_0_z_zz_yyzzzzz, g_0_z_zz_yzzzzz, g_0_z_zz_yzzzzzz, g_0_z_zz_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_z_yzz_xxxxxx[k] = -g_0_z_zz_xxxxxx[k] * ab_y + g_0_z_zz_xxxxxxy[k];

                g_0_z_yzz_xxxxxy[k] = -g_0_z_zz_xxxxxy[k] * ab_y + g_0_z_zz_xxxxxyy[k];

                g_0_z_yzz_xxxxxz[k] = -g_0_z_zz_xxxxxz[k] * ab_y + g_0_z_zz_xxxxxyz[k];

                g_0_z_yzz_xxxxyy[k] = -g_0_z_zz_xxxxyy[k] * ab_y + g_0_z_zz_xxxxyyy[k];

                g_0_z_yzz_xxxxyz[k] = -g_0_z_zz_xxxxyz[k] * ab_y + g_0_z_zz_xxxxyyz[k];

                g_0_z_yzz_xxxxzz[k] = -g_0_z_zz_xxxxzz[k] * ab_y + g_0_z_zz_xxxxyzz[k];

                g_0_z_yzz_xxxyyy[k] = -g_0_z_zz_xxxyyy[k] * ab_y + g_0_z_zz_xxxyyyy[k];

                g_0_z_yzz_xxxyyz[k] = -g_0_z_zz_xxxyyz[k] * ab_y + g_0_z_zz_xxxyyyz[k];

                g_0_z_yzz_xxxyzz[k] = -g_0_z_zz_xxxyzz[k] * ab_y + g_0_z_zz_xxxyyzz[k];

                g_0_z_yzz_xxxzzz[k] = -g_0_z_zz_xxxzzz[k] * ab_y + g_0_z_zz_xxxyzzz[k];

                g_0_z_yzz_xxyyyy[k] = -g_0_z_zz_xxyyyy[k] * ab_y + g_0_z_zz_xxyyyyy[k];

                g_0_z_yzz_xxyyyz[k] = -g_0_z_zz_xxyyyz[k] * ab_y + g_0_z_zz_xxyyyyz[k];

                g_0_z_yzz_xxyyzz[k] = -g_0_z_zz_xxyyzz[k] * ab_y + g_0_z_zz_xxyyyzz[k];

                g_0_z_yzz_xxyzzz[k] = -g_0_z_zz_xxyzzz[k] * ab_y + g_0_z_zz_xxyyzzz[k];

                g_0_z_yzz_xxzzzz[k] = -g_0_z_zz_xxzzzz[k] * ab_y + g_0_z_zz_xxyzzzz[k];

                g_0_z_yzz_xyyyyy[k] = -g_0_z_zz_xyyyyy[k] * ab_y + g_0_z_zz_xyyyyyy[k];

                g_0_z_yzz_xyyyyz[k] = -g_0_z_zz_xyyyyz[k] * ab_y + g_0_z_zz_xyyyyyz[k];

                g_0_z_yzz_xyyyzz[k] = -g_0_z_zz_xyyyzz[k] * ab_y + g_0_z_zz_xyyyyzz[k];

                g_0_z_yzz_xyyzzz[k] = -g_0_z_zz_xyyzzz[k] * ab_y + g_0_z_zz_xyyyzzz[k];

                g_0_z_yzz_xyzzzz[k] = -g_0_z_zz_xyzzzz[k] * ab_y + g_0_z_zz_xyyzzzz[k];

                g_0_z_yzz_xzzzzz[k] = -g_0_z_zz_xzzzzz[k] * ab_y + g_0_z_zz_xyzzzzz[k];

                g_0_z_yzz_yyyyyy[k] = -g_0_z_zz_yyyyyy[k] * ab_y + g_0_z_zz_yyyyyyy[k];

                g_0_z_yzz_yyyyyz[k] = -g_0_z_zz_yyyyyz[k] * ab_y + g_0_z_zz_yyyyyyz[k];

                g_0_z_yzz_yyyyzz[k] = -g_0_z_zz_yyyyzz[k] * ab_y + g_0_z_zz_yyyyyzz[k];

                g_0_z_yzz_yyyzzz[k] = -g_0_z_zz_yyyzzz[k] * ab_y + g_0_z_zz_yyyyzzz[k];

                g_0_z_yzz_yyzzzz[k] = -g_0_z_zz_yyzzzz[k] * ab_y + g_0_z_zz_yyyzzzz[k];

                g_0_z_yzz_yzzzzz[k] = -g_0_z_zz_yzzzzz[k] * ab_y + g_0_z_zz_yyzzzzz[k];

                g_0_z_yzz_zzzzzz[k] = -g_0_z_zz_zzzzzz[k] * ab_y + g_0_z_zz_yzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_z_zz_xxxxxx, g_0_z_zz_xxxxxxz, g_0_z_zz_xxxxxy, g_0_z_zz_xxxxxyz, g_0_z_zz_xxxxxz, g_0_z_zz_xxxxxzz, g_0_z_zz_xxxxyy, g_0_z_zz_xxxxyyz, g_0_z_zz_xxxxyz, g_0_z_zz_xxxxyzz, g_0_z_zz_xxxxzz, g_0_z_zz_xxxxzzz, g_0_z_zz_xxxyyy, g_0_z_zz_xxxyyyz, g_0_z_zz_xxxyyz, g_0_z_zz_xxxyyzz, g_0_z_zz_xxxyzz, g_0_z_zz_xxxyzzz, g_0_z_zz_xxxzzz, g_0_z_zz_xxxzzzz, g_0_z_zz_xxyyyy, g_0_z_zz_xxyyyyz, g_0_z_zz_xxyyyz, g_0_z_zz_xxyyyzz, g_0_z_zz_xxyyzz, g_0_z_zz_xxyyzzz, g_0_z_zz_xxyzzz, g_0_z_zz_xxyzzzz, g_0_z_zz_xxzzzz, g_0_z_zz_xxzzzzz, g_0_z_zz_xyyyyy, g_0_z_zz_xyyyyyz, g_0_z_zz_xyyyyz, g_0_z_zz_xyyyyzz, g_0_z_zz_xyyyzz, g_0_z_zz_xyyyzzz, g_0_z_zz_xyyzzz, g_0_z_zz_xyyzzzz, g_0_z_zz_xyzzzz, g_0_z_zz_xyzzzzz, g_0_z_zz_xzzzzz, g_0_z_zz_xzzzzzz, g_0_z_zz_yyyyyy, g_0_z_zz_yyyyyyz, g_0_z_zz_yyyyyz, g_0_z_zz_yyyyyzz, g_0_z_zz_yyyyzz, g_0_z_zz_yyyyzzz, g_0_z_zz_yyyzzz, g_0_z_zz_yyyzzzz, g_0_z_zz_yyzzzz, g_0_z_zz_yyzzzzz, g_0_z_zz_yzzzzz, g_0_z_zz_yzzzzzz, g_0_z_zz_zzzzzz, g_0_z_zz_zzzzzzz, g_0_z_zzz_xxxxxx, g_0_z_zzz_xxxxxy, g_0_z_zzz_xxxxxz, g_0_z_zzz_xxxxyy, g_0_z_zzz_xxxxyz, g_0_z_zzz_xxxxzz, g_0_z_zzz_xxxyyy, g_0_z_zzz_xxxyyz, g_0_z_zzz_xxxyzz, g_0_z_zzz_xxxzzz, g_0_z_zzz_xxyyyy, g_0_z_zzz_xxyyyz, g_0_z_zzz_xxyyzz, g_0_z_zzz_xxyzzz, g_0_z_zzz_xxzzzz, g_0_z_zzz_xyyyyy, g_0_z_zzz_xyyyyz, g_0_z_zzz_xyyyzz, g_0_z_zzz_xyyzzz, g_0_z_zzz_xyzzzz, g_0_z_zzz_xzzzzz, g_0_z_zzz_yyyyyy, g_0_z_zzz_yyyyyz, g_0_z_zzz_yyyyzz, g_0_z_zzz_yyyzzz, g_0_z_zzz_yyzzzz, g_0_z_zzz_yzzzzz, g_0_z_zzz_zzzzzz, g_zz_xxxxxx, g_zz_xxxxxy, g_zz_xxxxxz, g_zz_xxxxyy, g_zz_xxxxyz, g_zz_xxxxzz, g_zz_xxxyyy, g_zz_xxxyyz, g_zz_xxxyzz, g_zz_xxxzzz, g_zz_xxyyyy, g_zz_xxyyyz, g_zz_xxyyzz, g_zz_xxyzzz, g_zz_xxzzzz, g_zz_xyyyyy, g_zz_xyyyyz, g_zz_xyyyzz, g_zz_xyyzzz, g_zz_xyzzzz, g_zz_xzzzzz, g_zz_yyyyyy, g_zz_yyyyyz, g_zz_yyyyzz, g_zz_yyyzzz, g_zz_yyzzzz, g_zz_yzzzzz, g_zz_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_z_zzz_xxxxxx[k] = g_zz_xxxxxx[k] - g_0_z_zz_xxxxxx[k] * ab_z + g_0_z_zz_xxxxxxz[k];

                g_0_z_zzz_xxxxxy[k] = g_zz_xxxxxy[k] - g_0_z_zz_xxxxxy[k] * ab_z + g_0_z_zz_xxxxxyz[k];

                g_0_z_zzz_xxxxxz[k] = g_zz_xxxxxz[k] - g_0_z_zz_xxxxxz[k] * ab_z + g_0_z_zz_xxxxxzz[k];

                g_0_z_zzz_xxxxyy[k] = g_zz_xxxxyy[k] - g_0_z_zz_xxxxyy[k] * ab_z + g_0_z_zz_xxxxyyz[k];

                g_0_z_zzz_xxxxyz[k] = g_zz_xxxxyz[k] - g_0_z_zz_xxxxyz[k] * ab_z + g_0_z_zz_xxxxyzz[k];

                g_0_z_zzz_xxxxzz[k] = g_zz_xxxxzz[k] - g_0_z_zz_xxxxzz[k] * ab_z + g_0_z_zz_xxxxzzz[k];

                g_0_z_zzz_xxxyyy[k] = g_zz_xxxyyy[k] - g_0_z_zz_xxxyyy[k] * ab_z + g_0_z_zz_xxxyyyz[k];

                g_0_z_zzz_xxxyyz[k] = g_zz_xxxyyz[k] - g_0_z_zz_xxxyyz[k] * ab_z + g_0_z_zz_xxxyyzz[k];

                g_0_z_zzz_xxxyzz[k] = g_zz_xxxyzz[k] - g_0_z_zz_xxxyzz[k] * ab_z + g_0_z_zz_xxxyzzz[k];

                g_0_z_zzz_xxxzzz[k] = g_zz_xxxzzz[k] - g_0_z_zz_xxxzzz[k] * ab_z + g_0_z_zz_xxxzzzz[k];

                g_0_z_zzz_xxyyyy[k] = g_zz_xxyyyy[k] - g_0_z_zz_xxyyyy[k] * ab_z + g_0_z_zz_xxyyyyz[k];

                g_0_z_zzz_xxyyyz[k] = g_zz_xxyyyz[k] - g_0_z_zz_xxyyyz[k] * ab_z + g_0_z_zz_xxyyyzz[k];

                g_0_z_zzz_xxyyzz[k] = g_zz_xxyyzz[k] - g_0_z_zz_xxyyzz[k] * ab_z + g_0_z_zz_xxyyzzz[k];

                g_0_z_zzz_xxyzzz[k] = g_zz_xxyzzz[k] - g_0_z_zz_xxyzzz[k] * ab_z + g_0_z_zz_xxyzzzz[k];

                g_0_z_zzz_xxzzzz[k] = g_zz_xxzzzz[k] - g_0_z_zz_xxzzzz[k] * ab_z + g_0_z_zz_xxzzzzz[k];

                g_0_z_zzz_xyyyyy[k] = g_zz_xyyyyy[k] - g_0_z_zz_xyyyyy[k] * ab_z + g_0_z_zz_xyyyyyz[k];

                g_0_z_zzz_xyyyyz[k] = g_zz_xyyyyz[k] - g_0_z_zz_xyyyyz[k] * ab_z + g_0_z_zz_xyyyyzz[k];

                g_0_z_zzz_xyyyzz[k] = g_zz_xyyyzz[k] - g_0_z_zz_xyyyzz[k] * ab_z + g_0_z_zz_xyyyzzz[k];

                g_0_z_zzz_xyyzzz[k] = g_zz_xyyzzz[k] - g_0_z_zz_xyyzzz[k] * ab_z + g_0_z_zz_xyyzzzz[k];

                g_0_z_zzz_xyzzzz[k] = g_zz_xyzzzz[k] - g_0_z_zz_xyzzzz[k] * ab_z + g_0_z_zz_xyzzzzz[k];

                g_0_z_zzz_xzzzzz[k] = g_zz_xzzzzz[k] - g_0_z_zz_xzzzzz[k] * ab_z + g_0_z_zz_xzzzzzz[k];

                g_0_z_zzz_yyyyyy[k] = g_zz_yyyyyy[k] - g_0_z_zz_yyyyyy[k] * ab_z + g_0_z_zz_yyyyyyz[k];

                g_0_z_zzz_yyyyyz[k] = g_zz_yyyyyz[k] - g_0_z_zz_yyyyyz[k] * ab_z + g_0_z_zz_yyyyyzz[k];

                g_0_z_zzz_yyyyzz[k] = g_zz_yyyyzz[k] - g_0_z_zz_yyyyzz[k] * ab_z + g_0_z_zz_yyyyzzz[k];

                g_0_z_zzz_yyyzzz[k] = g_zz_yyyzzz[k] - g_0_z_zz_yyyzzz[k] * ab_z + g_0_z_zz_yyyzzzz[k];

                g_0_z_zzz_yyzzzz[k] = g_zz_yyzzzz[k] - g_0_z_zz_yyzzzz[k] * ab_z + g_0_z_zz_yyzzzzz[k];

                g_0_z_zzz_yzzzzz[k] = g_zz_yzzzzz[k] - g_0_z_zz_yzzzzz[k] * ab_z + g_0_z_zz_yzzzzzz[k];

                g_0_z_zzz_zzzzzz[k] = g_zz_zzzzzz[k] - g_0_z_zz_zzzzzz[k] * ab_z + g_0_z_zz_zzzzzzz[k];
            }
        }
    }
}
