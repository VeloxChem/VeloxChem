#include "ElectronRepulsionGeom1100ContrRecISXX.hpp"
                                            ...
                                            const int d_angmom) -> void
{
    ...
    for (int i = 0; i < ccomps; i++)
    {
        for (int j = 0; j < dcomps; j++)
        {
            ...
            const auto is_geom_11_off = idx_geom_11_isxx + i * dcomps + j;

            /// Set up 0-1 components of targeted buffer : cbuffer.data(

            auto g_x_x_xxxxxx_0 = cbuffer.data(is_geom_11_off + 0 * ccomps * dcomps);

            #pragma omp simd aligned(g_0_x_xxxxx_0, g_x_0_xxxxx_0, g_x_x_xxxxx_0, g_x_x_xxxxx_x, g_x_x_xxxxxx_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_xxxxxx_0[k] = -g_0_x_xxxxx_0[k] + g_x_0_xxxxx_0[k] - g_x_x_xxxxx_0[k] * ab_x + g_x_x_xxxxx_x[k];
            }

            /// Set up 1-2 components of targeted buffer : cbuffer.data(

            auto g_x_x_xxxxxy_0 = cbuffer.data(is_geom_11_off + 1 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_xxxxx_0, g_x_x_xxxxx_y, g_x_x_xxxxxy_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_xxxxxy_0[k] = -g_x_x_xxxxx_0[k] * ab_y + g_x_x_xxxxx_y[k];
            }

            /// Set up 2-3 components of targeted buffer : cbuffer.data(

            auto g_x_x_xxxxxz_0 = cbuffer.data(is_geom_11_off + 2 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_xxxxx_0, g_x_x_xxxxx_z, g_x_x_xxxxxz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_xxxxxz_0[k] = -g_x_x_xxxxx_0[k] * ab_z + g_x_x_xxxxx_z[k];
            }

            /// Set up 3-4 components of targeted buffer : cbuffer.data(

            auto g_x_x_xxxxyy_0 = cbuffer.data(is_geom_11_off + 3 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_xxxxy_0, g_x_x_xxxxy_y, g_x_x_xxxxyy_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_xxxxyy_0[k] = -g_x_x_xxxxy_0[k] * ab_y + g_x_x_xxxxy_y[k];
            }

            /// Set up 4-5 components of targeted buffer : cbuffer.data(

            auto g_x_x_xxxxyz_0 = cbuffer.data(is_geom_11_off + 4 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_xxxxyz_0, g_x_x_xxxxz_0, g_x_x_xxxxz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_xxxxyz_0[k] = -g_x_x_xxxxz_0[k] * ab_y + g_x_x_xxxxz_y[k];
            }

            /// Set up 5-6 components of targeted buffer : cbuffer.data(

            auto g_x_x_xxxxzz_0 = cbuffer.data(is_geom_11_off + 5 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_xxxxz_0, g_x_x_xxxxz_z, g_x_x_xxxxzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_xxxxzz_0[k] = -g_x_x_xxxxz_0[k] * ab_z + g_x_x_xxxxz_z[k];
            }

            /// Set up 6-7 components of targeted buffer : cbuffer.data(

            auto g_x_x_xxxyyy_0 = cbuffer.data(is_geom_11_off + 6 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_xxxyy_0, g_x_x_xxxyy_y, g_x_x_xxxyyy_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_xxxyyy_0[k] = -g_x_x_xxxyy_0[k] * ab_y + g_x_x_xxxyy_y[k];
            }

            /// Set up 7-8 components of targeted buffer : cbuffer.data(

            auto g_x_x_xxxyyz_0 = cbuffer.data(is_geom_11_off + 7 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_xxxyyz_0, g_x_x_xxxyz_0, g_x_x_xxxyz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_xxxyyz_0[k] = -g_x_x_xxxyz_0[k] * ab_y + g_x_x_xxxyz_y[k];
            }

            /// Set up 8-9 components of targeted buffer : cbuffer.data(

            auto g_x_x_xxxyzz_0 = cbuffer.data(is_geom_11_off + 8 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_xxxyzz_0, g_x_x_xxxzz_0, g_x_x_xxxzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_xxxyzz_0[k] = -g_x_x_xxxzz_0[k] * ab_y + g_x_x_xxxzz_y[k];
            }

            /// Set up 9-10 components of targeted buffer : cbuffer.data(

            auto g_x_x_xxxzzz_0 = cbuffer.data(is_geom_11_off + 9 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_xxxzz_0, g_x_x_xxxzz_z, g_x_x_xxxzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_xxxzzz_0[k] = -g_x_x_xxxzz_0[k] * ab_z + g_x_x_xxxzz_z[k];
            }

            /// Set up 10-11 components of targeted buffer : cbuffer.data(

            auto g_x_x_xxyyyy_0 = cbuffer.data(is_geom_11_off + 10 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_xxyyy_0, g_x_x_xxyyy_y, g_x_x_xxyyyy_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_xxyyyy_0[k] = -g_x_x_xxyyy_0[k] * ab_y + g_x_x_xxyyy_y[k];
            }

            /// Set up 11-12 components of targeted buffer : cbuffer.data(

            auto g_x_x_xxyyyz_0 = cbuffer.data(is_geom_11_off + 11 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_xxyyyz_0, g_x_x_xxyyz_0, g_x_x_xxyyz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_xxyyyz_0[k] = -g_x_x_xxyyz_0[k] * ab_y + g_x_x_xxyyz_y[k];
            }

            /// Set up 12-13 components of targeted buffer : cbuffer.data(

            auto g_x_x_xxyyzz_0 = cbuffer.data(is_geom_11_off + 12 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_xxyyzz_0, g_x_x_xxyzz_0, g_x_x_xxyzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_xxyyzz_0[k] = -g_x_x_xxyzz_0[k] * ab_y + g_x_x_xxyzz_y[k];
            }

            /// Set up 13-14 components of targeted buffer : cbuffer.data(

            auto g_x_x_xxyzzz_0 = cbuffer.data(is_geom_11_off + 13 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_xxyzzz_0, g_x_x_xxzzz_0, g_x_x_xxzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_xxyzzz_0[k] = -g_x_x_xxzzz_0[k] * ab_y + g_x_x_xxzzz_y[k];
            }

            /// Set up 14-15 components of targeted buffer : cbuffer.data(

            auto g_x_x_xxzzzz_0 = cbuffer.data(is_geom_11_off + 14 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_xxzzz_0, g_x_x_xxzzz_z, g_x_x_xxzzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_xxzzzz_0[k] = -g_x_x_xxzzz_0[k] * ab_z + g_x_x_xxzzz_z[k];
            }

            /// Set up 15-16 components of targeted buffer : cbuffer.data(

            auto g_x_x_xyyyyy_0 = cbuffer.data(is_geom_11_off + 15 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_xyyyy_0, g_x_x_xyyyy_y, g_x_x_xyyyyy_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_xyyyyy_0[k] = -g_x_x_xyyyy_0[k] * ab_y + g_x_x_xyyyy_y[k];
            }

            /// Set up 16-17 components of targeted buffer : cbuffer.data(

            auto g_x_x_xyyyyz_0 = cbuffer.data(is_geom_11_off + 16 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_xyyyyz_0, g_x_x_xyyyz_0, g_x_x_xyyyz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_xyyyyz_0[k] = -g_x_x_xyyyz_0[k] * ab_y + g_x_x_xyyyz_y[k];
            }

            /// Set up 17-18 components of targeted buffer : cbuffer.data(

            auto g_x_x_xyyyzz_0 = cbuffer.data(is_geom_11_off + 17 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_xyyyzz_0, g_x_x_xyyzz_0, g_x_x_xyyzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_xyyyzz_0[k] = -g_x_x_xyyzz_0[k] * ab_y + g_x_x_xyyzz_y[k];
            }

            /// Set up 18-19 components of targeted buffer : cbuffer.data(

            auto g_x_x_xyyzzz_0 = cbuffer.data(is_geom_11_off + 18 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_xyyzzz_0, g_x_x_xyzzz_0, g_x_x_xyzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_xyyzzz_0[k] = -g_x_x_xyzzz_0[k] * ab_y + g_x_x_xyzzz_y[k];
            }

            /// Set up 19-20 components of targeted buffer : cbuffer.data(

            auto g_x_x_xyzzzz_0 = cbuffer.data(is_geom_11_off + 19 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_xyzzzz_0, g_x_x_xzzzz_0, g_x_x_xzzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_xyzzzz_0[k] = -g_x_x_xzzzz_0[k] * ab_y + g_x_x_xzzzz_y[k];
            }

            /// Set up 20-21 components of targeted buffer : cbuffer.data(

            auto g_x_x_xzzzzz_0 = cbuffer.data(is_geom_11_off + 20 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_xzzzz_0, g_x_x_xzzzz_z, g_x_x_xzzzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_xzzzzz_0[k] = -g_x_x_xzzzz_0[k] * ab_z + g_x_x_xzzzz_z[k];
            }

            /// Set up 21-22 components of targeted buffer : cbuffer.data(

            auto g_x_x_yyyyyy_0 = cbuffer.data(is_geom_11_off + 21 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_yyyyy_0, g_x_x_yyyyy_y, g_x_x_yyyyyy_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_yyyyyy_0[k] = -g_x_x_yyyyy_0[k] * ab_y + g_x_x_yyyyy_y[k];
            }

            /// Set up 22-23 components of targeted buffer : cbuffer.data(

            auto g_x_x_yyyyyz_0 = cbuffer.data(is_geom_11_off + 22 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_yyyyyz_0, g_x_x_yyyyz_0, g_x_x_yyyyz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_yyyyyz_0[k] = -g_x_x_yyyyz_0[k] * ab_y + g_x_x_yyyyz_y[k];
            }

            /// Set up 23-24 components of targeted buffer : cbuffer.data(

            auto g_x_x_yyyyzz_0 = cbuffer.data(is_geom_11_off + 23 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_yyyyzz_0, g_x_x_yyyzz_0, g_x_x_yyyzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_yyyyzz_0[k] = -g_x_x_yyyzz_0[k] * ab_y + g_x_x_yyyzz_y[k];
            }

            /// Set up 24-25 components of targeted buffer : cbuffer.data(

            auto g_x_x_yyyzzz_0 = cbuffer.data(is_geom_11_off + 24 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_yyyzzz_0, g_x_x_yyzzz_0, g_x_x_yyzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_yyyzzz_0[k] = -g_x_x_yyzzz_0[k] * ab_y + g_x_x_yyzzz_y[k];
            }

            /// Set up 25-26 components of targeted buffer : cbuffer.data(

            auto g_x_x_yyzzzz_0 = cbuffer.data(is_geom_11_off + 25 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_yyzzzz_0, g_x_x_yzzzz_0, g_x_x_yzzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_yyzzzz_0[k] = -g_x_x_yzzzz_0[k] * ab_y + g_x_x_yzzzz_y[k];
            }

            /// Set up 26-27 components of targeted buffer : cbuffer.data(

            auto g_x_x_yzzzzz_0 = cbuffer.data(is_geom_11_off + 26 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_yzzzzz_0, g_x_x_zzzzz_0, g_x_x_zzzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_yzzzzz_0[k] = -g_x_x_zzzzz_0[k] * ab_y + g_x_x_zzzzz_y[k];
            }

            /// Set up 27-28 components of targeted buffer : cbuffer.data(

            auto g_x_x_zzzzzz_0 = cbuffer.data(is_geom_11_off + 27 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_x_zzzzz_0, g_x_x_zzzzz_z, g_x_x_zzzzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_zzzzzz_0[k] = -g_x_x_zzzzz_0[k] * ab_z + g_x_x_zzzzz_z[k];
            }

            /// Set up 28-29 components of targeted buffer : cbuffer.data(

            auto g_x_y_xxxxxx_0 = cbuffer.data(is_geom_11_off + 28 * ccomps * dcomps);

            #pragma omp simd aligned(g_0_y_xxxxx_0, g_x_y_xxxxx_0, g_x_y_xxxxx_x, g_x_y_xxxxxx_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_xxxxxx_0[k] = -g_0_y_xxxxx_0[k] - g_x_y_xxxxx_0[k] * ab_x + g_x_y_xxxxx_x[k];
            }

            /// Set up 29-30 components of targeted buffer : cbuffer.data(

            auto g_x_y_xxxxxy_0 = cbuffer.data(is_geom_11_off + 29 * ccomps * dcomps);

            #pragma omp simd aligned(g_0_y_xxxxy_0, g_x_y_xxxxxy_0, g_x_y_xxxxy_0, g_x_y_xxxxy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_xxxxxy_0[k] = -g_0_y_xxxxy_0[k] - g_x_y_xxxxy_0[k] * ab_x + g_x_y_xxxxy_x[k];
            }

            /// Set up 30-31 components of targeted buffer : cbuffer.data(

            auto g_x_y_xxxxxz_0 = cbuffer.data(is_geom_11_off + 30 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_y_xxxxx_0, g_x_y_xxxxx_z, g_x_y_xxxxxz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_xxxxxz_0[k] = -g_x_y_xxxxx_0[k] * ab_z + g_x_y_xxxxx_z[k];
            }

            /// Set up 31-32 components of targeted buffer : cbuffer.data(

            auto g_x_y_xxxxyy_0 = cbuffer.data(is_geom_11_off + 31 * ccomps * dcomps);

            #pragma omp simd aligned(g_0_y_xxxyy_0, g_x_y_xxxxyy_0, g_x_y_xxxyy_0, g_x_y_xxxyy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_xxxxyy_0[k] = -g_0_y_xxxyy_0[k] - g_x_y_xxxyy_0[k] * ab_x + g_x_y_xxxyy_x[k];
            }

            /// Set up 32-33 components of targeted buffer : cbuffer.data(

            auto g_x_y_xxxxyz_0 = cbuffer.data(is_geom_11_off + 32 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_y_xxxxy_0, g_x_y_xxxxy_z, g_x_y_xxxxyz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_xxxxyz_0[k] = -g_x_y_xxxxy_0[k] * ab_z + g_x_y_xxxxy_z[k];
            }

            /// Set up 33-34 components of targeted buffer : cbuffer.data(

            auto g_x_y_xxxxzz_0 = cbuffer.data(is_geom_11_off + 33 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_y_xxxxz_0, g_x_y_xxxxz_z, g_x_y_xxxxzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_xxxxzz_0[k] = -g_x_y_xxxxz_0[k] * ab_z + g_x_y_xxxxz_z[k];
            }

            /// Set up 34-35 components of targeted buffer : cbuffer.data(

            auto g_x_y_xxxyyy_0 = cbuffer.data(is_geom_11_off + 34 * ccomps * dcomps);

            #pragma omp simd aligned(g_0_y_xxyyy_0, g_x_y_xxxyyy_0, g_x_y_xxyyy_0, g_x_y_xxyyy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_xxxyyy_0[k] = -g_0_y_xxyyy_0[k] - g_x_y_xxyyy_0[k] * ab_x + g_x_y_xxyyy_x[k];
            }

            /// Set up 35-36 components of targeted buffer : cbuffer.data(

            auto g_x_y_xxxyyz_0 = cbuffer.data(is_geom_11_off + 35 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_y_xxxyy_0, g_x_y_xxxyy_z, g_x_y_xxxyyz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_xxxyyz_0[k] = -g_x_y_xxxyy_0[k] * ab_z + g_x_y_xxxyy_z[k];
            }

            /// Set up 36-37 components of targeted buffer : cbuffer.data(

            auto g_x_y_xxxyzz_0 = cbuffer.data(is_geom_11_off + 36 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_y_xxxyz_0, g_x_y_xxxyz_z, g_x_y_xxxyzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_xxxyzz_0[k] = -g_x_y_xxxyz_0[k] * ab_z + g_x_y_xxxyz_z[k];
            }

            /// Set up 37-38 components of targeted buffer : cbuffer.data(

            auto g_x_y_xxxzzz_0 = cbuffer.data(is_geom_11_off + 37 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_y_xxxzz_0, g_x_y_xxxzz_z, g_x_y_xxxzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_xxxzzz_0[k] = -g_x_y_xxxzz_0[k] * ab_z + g_x_y_xxxzz_z[k];
            }

            /// Set up 38-39 components of targeted buffer : cbuffer.data(

            auto g_x_y_xxyyyy_0 = cbuffer.data(is_geom_11_off + 38 * ccomps * dcomps);

            #pragma omp simd aligned(g_0_y_xyyyy_0, g_x_y_xxyyyy_0, g_x_y_xyyyy_0, g_x_y_xyyyy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_xxyyyy_0[k] = -g_0_y_xyyyy_0[k] - g_x_y_xyyyy_0[k] * ab_x + g_x_y_xyyyy_x[k];
            }

            /// Set up 39-40 components of targeted buffer : cbuffer.data(

            auto g_x_y_xxyyyz_0 = cbuffer.data(is_geom_11_off + 39 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_y_xxyyy_0, g_x_y_xxyyy_z, g_x_y_xxyyyz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_xxyyyz_0[k] = -g_x_y_xxyyy_0[k] * ab_z + g_x_y_xxyyy_z[k];
            }

            /// Set up 40-41 components of targeted buffer : cbuffer.data(

            auto g_x_y_xxyyzz_0 = cbuffer.data(is_geom_11_off + 40 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_y_xxyyz_0, g_x_y_xxyyz_z, g_x_y_xxyyzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_xxyyzz_0[k] = -g_x_y_xxyyz_0[k] * ab_z + g_x_y_xxyyz_z[k];
            }

            /// Set up 41-42 components of targeted buffer : cbuffer.data(

            auto g_x_y_xxyzzz_0 = cbuffer.data(is_geom_11_off + 41 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_y_xxyzz_0, g_x_y_xxyzz_z, g_x_y_xxyzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_xxyzzz_0[k] = -g_x_y_xxyzz_0[k] * ab_z + g_x_y_xxyzz_z[k];
            }

            /// Set up 42-43 components of targeted buffer : cbuffer.data(

            auto g_x_y_xxzzzz_0 = cbuffer.data(is_geom_11_off + 42 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_y_xxzzz_0, g_x_y_xxzzz_z, g_x_y_xxzzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_xxzzzz_0[k] = -g_x_y_xxzzz_0[k] * ab_z + g_x_y_xxzzz_z[k];
            }

            /// Set up 43-44 components of targeted buffer : cbuffer.data(

            auto g_x_y_xyyyyy_0 = cbuffer.data(is_geom_11_off + 43 * ccomps * dcomps);

            #pragma omp simd aligned(g_0_y_yyyyy_0, g_x_y_xyyyyy_0, g_x_y_yyyyy_0, g_x_y_yyyyy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_xyyyyy_0[k] = -g_0_y_yyyyy_0[k] - g_x_y_yyyyy_0[k] * ab_x + g_x_y_yyyyy_x[k];
            }

            /// Set up 44-45 components of targeted buffer : cbuffer.data(

            auto g_x_y_xyyyyz_0 = cbuffer.data(is_geom_11_off + 44 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_y_xyyyy_0, g_x_y_xyyyy_z, g_x_y_xyyyyz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_xyyyyz_0[k] = -g_x_y_xyyyy_0[k] * ab_z + g_x_y_xyyyy_z[k];
            }

            /// Set up 45-46 components of targeted buffer : cbuffer.data(

            auto g_x_y_xyyyzz_0 = cbuffer.data(is_geom_11_off + 45 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_y_xyyyz_0, g_x_y_xyyyz_z, g_x_y_xyyyzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_xyyyzz_0[k] = -g_x_y_xyyyz_0[k] * ab_z + g_x_y_xyyyz_z[k];
            }

            /// Set up 46-47 components of targeted buffer : cbuffer.data(

            auto g_x_y_xyyzzz_0 = cbuffer.data(is_geom_11_off + 46 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_y_xyyzz_0, g_x_y_xyyzz_z, g_x_y_xyyzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_xyyzzz_0[k] = -g_x_y_xyyzz_0[k] * ab_z + g_x_y_xyyzz_z[k];
            }

            /// Set up 47-48 components of targeted buffer : cbuffer.data(

            auto g_x_y_xyzzzz_0 = cbuffer.data(is_geom_11_off + 47 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_y_xyzzz_0, g_x_y_xyzzz_z, g_x_y_xyzzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_xyzzzz_0[k] = -g_x_y_xyzzz_0[k] * ab_z + g_x_y_xyzzz_z[k];
            }

            /// Set up 48-49 components of targeted buffer : cbuffer.data(

            auto g_x_y_xzzzzz_0 = cbuffer.data(is_geom_11_off + 48 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_y_xzzzz_0, g_x_y_xzzzz_z, g_x_y_xzzzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_xzzzzz_0[k] = -g_x_y_xzzzz_0[k] * ab_z + g_x_y_xzzzz_z[k];
            }

            /// Set up 49-50 components of targeted buffer : cbuffer.data(

            auto g_x_y_yyyyyy_0 = cbuffer.data(is_geom_11_off + 49 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_0_yyyyy_0, g_x_y_yyyyy_0, g_x_y_yyyyy_y, g_x_y_yyyyyy_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_yyyyyy_0[k] = g_x_0_yyyyy_0[k] - g_x_y_yyyyy_0[k] * ab_y + g_x_y_yyyyy_y[k];
            }

            /// Set up 50-51 components of targeted buffer : cbuffer.data(

            auto g_x_y_yyyyyz_0 = cbuffer.data(is_geom_11_off + 50 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_y_yyyyy_0, g_x_y_yyyyy_z, g_x_y_yyyyyz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_yyyyyz_0[k] = -g_x_y_yyyyy_0[k] * ab_z + g_x_y_yyyyy_z[k];
            }

            /// Set up 51-52 components of targeted buffer : cbuffer.data(

            auto g_x_y_yyyyzz_0 = cbuffer.data(is_geom_11_off + 51 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_y_yyyyz_0, g_x_y_yyyyz_z, g_x_y_yyyyzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_yyyyzz_0[k] = -g_x_y_yyyyz_0[k] * ab_z + g_x_y_yyyyz_z[k];
            }

            /// Set up 52-53 components of targeted buffer : cbuffer.data(

            auto g_x_y_yyyzzz_0 = cbuffer.data(is_geom_11_off + 52 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_y_yyyzz_0, g_x_y_yyyzz_z, g_x_y_yyyzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_yyyzzz_0[k] = -g_x_y_yyyzz_0[k] * ab_z + g_x_y_yyyzz_z[k];
            }

            /// Set up 53-54 components of targeted buffer : cbuffer.data(

            auto g_x_y_yyzzzz_0 = cbuffer.data(is_geom_11_off + 53 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_y_yyzzz_0, g_x_y_yyzzz_z, g_x_y_yyzzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_yyzzzz_0[k] = -g_x_y_yyzzz_0[k] * ab_z + g_x_y_yyzzz_z[k];
            }

            /// Set up 54-55 components of targeted buffer : cbuffer.data(

            auto g_x_y_yzzzzz_0 = cbuffer.data(is_geom_11_off + 54 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_y_yzzzz_0, g_x_y_yzzzz_z, g_x_y_yzzzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_yzzzzz_0[k] = -g_x_y_yzzzz_0[k] * ab_z + g_x_y_yzzzz_z[k];
            }

            /// Set up 55-56 components of targeted buffer : cbuffer.data(

            auto g_x_y_zzzzzz_0 = cbuffer.data(is_geom_11_off + 55 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_y_zzzzz_0, g_x_y_zzzzz_z, g_x_y_zzzzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_zzzzzz_0[k] = -g_x_y_zzzzz_0[k] * ab_z + g_x_y_zzzzz_z[k];
            }

            /// Set up 56-57 components of targeted buffer : cbuffer.data(

            auto g_x_z_xxxxxx_0 = cbuffer.data(is_geom_11_off + 56 * ccomps * dcomps);

            #pragma omp simd aligned(g_0_z_xxxxx_0, g_x_z_xxxxx_0, g_x_z_xxxxx_x, g_x_z_xxxxxx_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_xxxxxx_0[k] = -g_0_z_xxxxx_0[k] - g_x_z_xxxxx_0[k] * ab_x + g_x_z_xxxxx_x[k];
            }

            /// Set up 57-58 components of targeted buffer : cbuffer.data(

            auto g_x_z_xxxxxy_0 = cbuffer.data(is_geom_11_off + 57 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_z_xxxxx_0, g_x_z_xxxxx_y, g_x_z_xxxxxy_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_xxxxxy_0[k] = -g_x_z_xxxxx_0[k] * ab_y + g_x_z_xxxxx_y[k];
            }

            /// Set up 58-59 components of targeted buffer : cbuffer.data(

            auto g_x_z_xxxxxz_0 = cbuffer.data(is_geom_11_off + 58 * ccomps * dcomps);

            #pragma omp simd aligned(g_0_z_xxxxz_0, g_x_z_xxxxxz_0, g_x_z_xxxxz_0, g_x_z_xxxxz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_xxxxxz_0[k] = -g_0_z_xxxxz_0[k] - g_x_z_xxxxz_0[k] * ab_x + g_x_z_xxxxz_x[k];
            }

            /// Set up 59-60 components of targeted buffer : cbuffer.data(

            auto g_x_z_xxxxyy_0 = cbuffer.data(is_geom_11_off + 59 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_z_xxxxy_0, g_x_z_xxxxy_y, g_x_z_xxxxyy_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_xxxxyy_0[k] = -g_x_z_xxxxy_0[k] * ab_y + g_x_z_xxxxy_y[k];
            }

            /// Set up 60-61 components of targeted buffer : cbuffer.data(

            auto g_x_z_xxxxyz_0 = cbuffer.data(is_geom_11_off + 60 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_z_xxxxyz_0, g_x_z_xxxxz_0, g_x_z_xxxxz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_xxxxyz_0[k] = -g_x_z_xxxxz_0[k] * ab_y + g_x_z_xxxxz_y[k];
            }

            /// Set up 61-62 components of targeted buffer : cbuffer.data(

            auto g_x_z_xxxxzz_0 = cbuffer.data(is_geom_11_off + 61 * ccomps * dcomps);

            #pragma omp simd aligned(g_0_z_xxxzz_0, g_x_z_xxxxzz_0, g_x_z_xxxzz_0, g_x_z_xxxzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_xxxxzz_0[k] = -g_0_z_xxxzz_0[k] - g_x_z_xxxzz_0[k] * ab_x + g_x_z_xxxzz_x[k];
            }

            /// Set up 62-63 components of targeted buffer : cbuffer.data(

            auto g_x_z_xxxyyy_0 = cbuffer.data(is_geom_11_off + 62 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_z_xxxyy_0, g_x_z_xxxyy_y, g_x_z_xxxyyy_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_xxxyyy_0[k] = -g_x_z_xxxyy_0[k] * ab_y + g_x_z_xxxyy_y[k];
            }

            /// Set up 63-64 components of targeted buffer : cbuffer.data(

            auto g_x_z_xxxyyz_0 = cbuffer.data(is_geom_11_off + 63 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_z_xxxyyz_0, g_x_z_xxxyz_0, g_x_z_xxxyz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_xxxyyz_0[k] = -g_x_z_xxxyz_0[k] * ab_y + g_x_z_xxxyz_y[k];
            }

            /// Set up 64-65 components of targeted buffer : cbuffer.data(

            auto g_x_z_xxxyzz_0 = cbuffer.data(is_geom_11_off + 64 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_z_xxxyzz_0, g_x_z_xxxzz_0, g_x_z_xxxzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_xxxyzz_0[k] = -g_x_z_xxxzz_0[k] * ab_y + g_x_z_xxxzz_y[k];
            }

            /// Set up 65-66 components of targeted buffer : cbuffer.data(

            auto g_x_z_xxxzzz_0 = cbuffer.data(is_geom_11_off + 65 * ccomps * dcomps);

            #pragma omp simd aligned(g_0_z_xxzzz_0, g_x_z_xxxzzz_0, g_x_z_xxzzz_0, g_x_z_xxzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_xxxzzz_0[k] = -g_0_z_xxzzz_0[k] - g_x_z_xxzzz_0[k] * ab_x + g_x_z_xxzzz_x[k];
            }

            /// Set up 66-67 components of targeted buffer : cbuffer.data(

            auto g_x_z_xxyyyy_0 = cbuffer.data(is_geom_11_off + 66 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_z_xxyyy_0, g_x_z_xxyyy_y, g_x_z_xxyyyy_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_xxyyyy_0[k] = -g_x_z_xxyyy_0[k] * ab_y + g_x_z_xxyyy_y[k];
            }

            /// Set up 67-68 components of targeted buffer : cbuffer.data(

            auto g_x_z_xxyyyz_0 = cbuffer.data(is_geom_11_off + 67 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_z_xxyyyz_0, g_x_z_xxyyz_0, g_x_z_xxyyz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_xxyyyz_0[k] = -g_x_z_xxyyz_0[k] * ab_y + g_x_z_xxyyz_y[k];
            }

            /// Set up 68-69 components of targeted buffer : cbuffer.data(

            auto g_x_z_xxyyzz_0 = cbuffer.data(is_geom_11_off + 68 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_z_xxyyzz_0, g_x_z_xxyzz_0, g_x_z_xxyzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_xxyyzz_0[k] = -g_x_z_xxyzz_0[k] * ab_y + g_x_z_xxyzz_y[k];
            }

            /// Set up 69-70 components of targeted buffer : cbuffer.data(

            auto g_x_z_xxyzzz_0 = cbuffer.data(is_geom_11_off + 69 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_z_xxyzzz_0, g_x_z_xxzzz_0, g_x_z_xxzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_xxyzzz_0[k] = -g_x_z_xxzzz_0[k] * ab_y + g_x_z_xxzzz_y[k];
            }

            /// Set up 70-71 components of targeted buffer : cbuffer.data(

            auto g_x_z_xxzzzz_0 = cbuffer.data(is_geom_11_off + 70 * ccomps * dcomps);

            #pragma omp simd aligned(g_0_z_xzzzz_0, g_x_z_xxzzzz_0, g_x_z_xzzzz_0, g_x_z_xzzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_xxzzzz_0[k] = -g_0_z_xzzzz_0[k] - g_x_z_xzzzz_0[k] * ab_x + g_x_z_xzzzz_x[k];
            }

            /// Set up 71-72 components of targeted buffer : cbuffer.data(

            auto g_x_z_xyyyyy_0 = cbuffer.data(is_geom_11_off + 71 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_z_xyyyy_0, g_x_z_xyyyy_y, g_x_z_xyyyyy_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_xyyyyy_0[k] = -g_x_z_xyyyy_0[k] * ab_y + g_x_z_xyyyy_y[k];
            }

            /// Set up 72-73 components of targeted buffer : cbuffer.data(

            auto g_x_z_xyyyyz_0 = cbuffer.data(is_geom_11_off + 72 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_z_xyyyyz_0, g_x_z_xyyyz_0, g_x_z_xyyyz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_xyyyyz_0[k] = -g_x_z_xyyyz_0[k] * ab_y + g_x_z_xyyyz_y[k];
            }

            /// Set up 73-74 components of targeted buffer : cbuffer.data(

            auto g_x_z_xyyyzz_0 = cbuffer.data(is_geom_11_off + 73 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_z_xyyyzz_0, g_x_z_xyyzz_0, g_x_z_xyyzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_xyyyzz_0[k] = -g_x_z_xyyzz_0[k] * ab_y + g_x_z_xyyzz_y[k];
            }

            /// Set up 74-75 components of targeted buffer : cbuffer.data(

            auto g_x_z_xyyzzz_0 = cbuffer.data(is_geom_11_off + 74 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_z_xyyzzz_0, g_x_z_xyzzz_0, g_x_z_xyzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_xyyzzz_0[k] = -g_x_z_xyzzz_0[k] * ab_y + g_x_z_xyzzz_y[k];
            }

            /// Set up 75-76 components of targeted buffer : cbuffer.data(

            auto g_x_z_xyzzzz_0 = cbuffer.data(is_geom_11_off + 75 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_z_xyzzzz_0, g_x_z_xzzzz_0, g_x_z_xzzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_xyzzzz_0[k] = -g_x_z_xzzzz_0[k] * ab_y + g_x_z_xzzzz_y[k];
            }

            /// Set up 76-77 components of targeted buffer : cbuffer.data(

            auto g_x_z_xzzzzz_0 = cbuffer.data(is_geom_11_off + 76 * ccomps * dcomps);

            #pragma omp simd aligned(g_0_z_zzzzz_0, g_x_z_xzzzzz_0, g_x_z_zzzzz_0, g_x_z_zzzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_xzzzzz_0[k] = -g_0_z_zzzzz_0[k] - g_x_z_zzzzz_0[k] * ab_x + g_x_z_zzzzz_x[k];
            }

            /// Set up 77-78 components of targeted buffer : cbuffer.data(

            auto g_x_z_yyyyyy_0 = cbuffer.data(is_geom_11_off + 77 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_z_yyyyy_0, g_x_z_yyyyy_y, g_x_z_yyyyyy_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_yyyyyy_0[k] = -g_x_z_yyyyy_0[k] * ab_y + g_x_z_yyyyy_y[k];
            }

            /// Set up 78-79 components of targeted buffer : cbuffer.data(

            auto g_x_z_yyyyyz_0 = cbuffer.data(is_geom_11_off + 78 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_z_yyyyyz_0, g_x_z_yyyyz_0, g_x_z_yyyyz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_yyyyyz_0[k] = -g_x_z_yyyyz_0[k] * ab_y + g_x_z_yyyyz_y[k];
            }

            /// Set up 79-80 components of targeted buffer : cbuffer.data(

            auto g_x_z_yyyyzz_0 = cbuffer.data(is_geom_11_off + 79 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_z_yyyyzz_0, g_x_z_yyyzz_0, g_x_z_yyyzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_yyyyzz_0[k] = -g_x_z_yyyzz_0[k] * ab_y + g_x_z_yyyzz_y[k];
            }

            /// Set up 80-81 components of targeted buffer : cbuffer.data(

            auto g_x_z_yyyzzz_0 = cbuffer.data(is_geom_11_off + 80 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_z_yyyzzz_0, g_x_z_yyzzz_0, g_x_z_yyzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_yyyzzz_0[k] = -g_x_z_yyzzz_0[k] * ab_y + g_x_z_yyzzz_y[k];
            }

            /// Set up 81-82 components of targeted buffer : cbuffer.data(

            auto g_x_z_yyzzzz_0 = cbuffer.data(is_geom_11_off + 81 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_z_yyzzzz_0, g_x_z_yzzzz_0, g_x_z_yzzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_yyzzzz_0[k] = -g_x_z_yzzzz_0[k] * ab_y + g_x_z_yzzzz_y[k];
            }

            /// Set up 82-83 components of targeted buffer : cbuffer.data(

            auto g_x_z_yzzzzz_0 = cbuffer.data(is_geom_11_off + 82 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_z_yzzzzz_0, g_x_z_zzzzz_0, g_x_z_zzzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_yzzzzz_0[k] = -g_x_z_zzzzz_0[k] * ab_y + g_x_z_zzzzz_y[k];
            }

            /// Set up 83-84 components of targeted buffer : cbuffer.data(

            auto g_x_z_zzzzzz_0 = cbuffer.data(is_geom_11_off + 83 * ccomps * dcomps);

            #pragma omp simd aligned(g_x_0_zzzzz_0, g_x_z_zzzzz_0, g_x_z_zzzzz_z, g_x_z_zzzzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_zzzzzz_0[k] = g_x_0_zzzzz_0[k] - g_x_z_zzzzz_0[k] * ab_z + g_x_z_zzzzz_z[k];
            }

            /// Set up 84-85 components of targeted buffer : cbuffer.data(

            auto g_y_x_xxxxxx_0 = cbuffer.data(is_geom_11_off + 84 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_0_xxxxx_0, g_y_x_xxxxx_0, g_y_x_xxxxx_x, g_y_x_xxxxxx_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_xxxxxx_0[k] = g_y_0_xxxxx_0[k] - g_y_x_xxxxx_0[k] * ab_x + g_y_x_xxxxx_x[k];
            }

            /// Set up 85-86 components of targeted buffer : cbuffer.data(

            auto g_y_x_xxxxxy_0 = cbuffer.data(is_geom_11_off + 85 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_0_xxxxy_0, g_y_x_xxxxxy_0, g_y_x_xxxxy_0, g_y_x_xxxxy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_xxxxxy_0[k] = g_y_0_xxxxy_0[k] - g_y_x_xxxxy_0[k] * ab_x + g_y_x_xxxxy_x[k];
            }

            /// Set up 86-87 components of targeted buffer : cbuffer.data(

            auto g_y_x_xxxxxz_0 = cbuffer.data(is_geom_11_off + 86 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_x_xxxxx_0, g_y_x_xxxxx_z, g_y_x_xxxxxz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_xxxxxz_0[k] = -g_y_x_xxxxx_0[k] * ab_z + g_y_x_xxxxx_z[k];
            }

            /// Set up 87-88 components of targeted buffer : cbuffer.data(

            auto g_y_x_xxxxyy_0 = cbuffer.data(is_geom_11_off + 87 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_0_xxxyy_0, g_y_x_xxxxyy_0, g_y_x_xxxyy_0, g_y_x_xxxyy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_xxxxyy_0[k] = g_y_0_xxxyy_0[k] - g_y_x_xxxyy_0[k] * ab_x + g_y_x_xxxyy_x[k];
            }

            /// Set up 88-89 components of targeted buffer : cbuffer.data(

            auto g_y_x_xxxxyz_0 = cbuffer.data(is_geom_11_off + 88 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_x_xxxxy_0, g_y_x_xxxxy_z, g_y_x_xxxxyz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_xxxxyz_0[k] = -g_y_x_xxxxy_0[k] * ab_z + g_y_x_xxxxy_z[k];
            }

            /// Set up 89-90 components of targeted buffer : cbuffer.data(

            auto g_y_x_xxxxzz_0 = cbuffer.data(is_geom_11_off + 89 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_x_xxxxz_0, g_y_x_xxxxz_z, g_y_x_xxxxzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_xxxxzz_0[k] = -g_y_x_xxxxz_0[k] * ab_z + g_y_x_xxxxz_z[k];
            }

            /// Set up 90-91 components of targeted buffer : cbuffer.data(

            auto g_y_x_xxxyyy_0 = cbuffer.data(is_geom_11_off + 90 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_0_xxyyy_0, g_y_x_xxxyyy_0, g_y_x_xxyyy_0, g_y_x_xxyyy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_xxxyyy_0[k] = g_y_0_xxyyy_0[k] - g_y_x_xxyyy_0[k] * ab_x + g_y_x_xxyyy_x[k];
            }

            /// Set up 91-92 components of targeted buffer : cbuffer.data(

            auto g_y_x_xxxyyz_0 = cbuffer.data(is_geom_11_off + 91 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_x_xxxyy_0, g_y_x_xxxyy_z, g_y_x_xxxyyz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_xxxyyz_0[k] = -g_y_x_xxxyy_0[k] * ab_z + g_y_x_xxxyy_z[k];
            }

            /// Set up 92-93 components of targeted buffer : cbuffer.data(

            auto g_y_x_xxxyzz_0 = cbuffer.data(is_geom_11_off + 92 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_x_xxxyz_0, g_y_x_xxxyz_z, g_y_x_xxxyzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_xxxyzz_0[k] = -g_y_x_xxxyz_0[k] * ab_z + g_y_x_xxxyz_z[k];
            }

            /// Set up 93-94 components of targeted buffer : cbuffer.data(

            auto g_y_x_xxxzzz_0 = cbuffer.data(is_geom_11_off + 93 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_x_xxxzz_0, g_y_x_xxxzz_z, g_y_x_xxxzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_xxxzzz_0[k] = -g_y_x_xxxzz_0[k] * ab_z + g_y_x_xxxzz_z[k];
            }

            /// Set up 94-95 components of targeted buffer : cbuffer.data(

            auto g_y_x_xxyyyy_0 = cbuffer.data(is_geom_11_off + 94 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_0_xyyyy_0, g_y_x_xxyyyy_0, g_y_x_xyyyy_0, g_y_x_xyyyy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_xxyyyy_0[k] = g_y_0_xyyyy_0[k] - g_y_x_xyyyy_0[k] * ab_x + g_y_x_xyyyy_x[k];
            }

            /// Set up 95-96 components of targeted buffer : cbuffer.data(

            auto g_y_x_xxyyyz_0 = cbuffer.data(is_geom_11_off + 95 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_x_xxyyy_0, g_y_x_xxyyy_z, g_y_x_xxyyyz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_xxyyyz_0[k] = -g_y_x_xxyyy_0[k] * ab_z + g_y_x_xxyyy_z[k];
            }

            /// Set up 96-97 components of targeted buffer : cbuffer.data(

            auto g_y_x_xxyyzz_0 = cbuffer.data(is_geom_11_off + 96 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_x_xxyyz_0, g_y_x_xxyyz_z, g_y_x_xxyyzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_xxyyzz_0[k] = -g_y_x_xxyyz_0[k] * ab_z + g_y_x_xxyyz_z[k];
            }

            /// Set up 97-98 components of targeted buffer : cbuffer.data(

            auto g_y_x_xxyzzz_0 = cbuffer.data(is_geom_11_off + 97 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_x_xxyzz_0, g_y_x_xxyzz_z, g_y_x_xxyzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_xxyzzz_0[k] = -g_y_x_xxyzz_0[k] * ab_z + g_y_x_xxyzz_z[k];
            }

            /// Set up 98-99 components of targeted buffer : cbuffer.data(

            auto g_y_x_xxzzzz_0 = cbuffer.data(is_geom_11_off + 98 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_x_xxzzz_0, g_y_x_xxzzz_z, g_y_x_xxzzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_xxzzzz_0[k] = -g_y_x_xxzzz_0[k] * ab_z + g_y_x_xxzzz_z[k];
            }

            /// Set up 99-100 components of targeted buffer : cbuffer.data(

            auto g_y_x_xyyyyy_0 = cbuffer.data(is_geom_11_off + 99 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_0_yyyyy_0, g_y_x_xyyyyy_0, g_y_x_yyyyy_0, g_y_x_yyyyy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_xyyyyy_0[k] = g_y_0_yyyyy_0[k] - g_y_x_yyyyy_0[k] * ab_x + g_y_x_yyyyy_x[k];
            }

            /// Set up 100-101 components of targeted buffer : cbuffer.data(

            auto g_y_x_xyyyyz_0 = cbuffer.data(is_geom_11_off + 100 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_x_xyyyy_0, g_y_x_xyyyy_z, g_y_x_xyyyyz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_xyyyyz_0[k] = -g_y_x_xyyyy_0[k] * ab_z + g_y_x_xyyyy_z[k];
            }

            /// Set up 101-102 components of targeted buffer : cbuffer.data(

            auto g_y_x_xyyyzz_0 = cbuffer.data(is_geom_11_off + 101 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_x_xyyyz_0, g_y_x_xyyyz_z, g_y_x_xyyyzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_xyyyzz_0[k] = -g_y_x_xyyyz_0[k] * ab_z + g_y_x_xyyyz_z[k];
            }

            /// Set up 102-103 components of targeted buffer : cbuffer.data(

            auto g_y_x_xyyzzz_0 = cbuffer.data(is_geom_11_off + 102 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_x_xyyzz_0, g_y_x_xyyzz_z, g_y_x_xyyzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_xyyzzz_0[k] = -g_y_x_xyyzz_0[k] * ab_z + g_y_x_xyyzz_z[k];
            }

            /// Set up 103-104 components of targeted buffer : cbuffer.data(

            auto g_y_x_xyzzzz_0 = cbuffer.data(is_geom_11_off + 103 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_x_xyzzz_0, g_y_x_xyzzz_z, g_y_x_xyzzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_xyzzzz_0[k] = -g_y_x_xyzzz_0[k] * ab_z + g_y_x_xyzzz_z[k];
            }

            /// Set up 104-105 components of targeted buffer : cbuffer.data(

            auto g_y_x_xzzzzz_0 = cbuffer.data(is_geom_11_off + 104 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_x_xzzzz_0, g_y_x_xzzzz_z, g_y_x_xzzzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_xzzzzz_0[k] = -g_y_x_xzzzz_0[k] * ab_z + g_y_x_xzzzz_z[k];
            }

            /// Set up 105-106 components of targeted buffer : cbuffer.data(

            auto g_y_x_yyyyyy_0 = cbuffer.data(is_geom_11_off + 105 * ccomps * dcomps);

            #pragma omp simd aligned(g_0_x_yyyyy_0, g_y_x_yyyyy_0, g_y_x_yyyyy_y, g_y_x_yyyyyy_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_yyyyyy_0[k] = -g_0_x_yyyyy_0[k] - g_y_x_yyyyy_0[k] * ab_y + g_y_x_yyyyy_y[k];
            }

            /// Set up 106-107 components of targeted buffer : cbuffer.data(

            auto g_y_x_yyyyyz_0 = cbuffer.data(is_geom_11_off + 106 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_x_yyyyy_0, g_y_x_yyyyy_z, g_y_x_yyyyyz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_yyyyyz_0[k] = -g_y_x_yyyyy_0[k] * ab_z + g_y_x_yyyyy_z[k];
            }

            /// Set up 107-108 components of targeted buffer : cbuffer.data(

            auto g_y_x_yyyyzz_0 = cbuffer.data(is_geom_11_off + 107 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_x_yyyyz_0, g_y_x_yyyyz_z, g_y_x_yyyyzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_yyyyzz_0[k] = -g_y_x_yyyyz_0[k] * ab_z + g_y_x_yyyyz_z[k];
            }

            /// Set up 108-109 components of targeted buffer : cbuffer.data(

            auto g_y_x_yyyzzz_0 = cbuffer.data(is_geom_11_off + 108 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_x_yyyzz_0, g_y_x_yyyzz_z, g_y_x_yyyzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_yyyzzz_0[k] = -g_y_x_yyyzz_0[k] * ab_z + g_y_x_yyyzz_z[k];
            }

            /// Set up 109-110 components of targeted buffer : cbuffer.data(

            auto g_y_x_yyzzzz_0 = cbuffer.data(is_geom_11_off + 109 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_x_yyzzz_0, g_y_x_yyzzz_z, g_y_x_yyzzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_yyzzzz_0[k] = -g_y_x_yyzzz_0[k] * ab_z + g_y_x_yyzzz_z[k];
            }

            /// Set up 110-111 components of targeted buffer : cbuffer.data(

            auto g_y_x_yzzzzz_0 = cbuffer.data(is_geom_11_off + 110 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_x_yzzzz_0, g_y_x_yzzzz_z, g_y_x_yzzzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_yzzzzz_0[k] = -g_y_x_yzzzz_0[k] * ab_z + g_y_x_yzzzz_z[k];
            }

            /// Set up 111-112 components of targeted buffer : cbuffer.data(

            auto g_y_x_zzzzzz_0 = cbuffer.data(is_geom_11_off + 111 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_x_zzzzz_0, g_y_x_zzzzz_z, g_y_x_zzzzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_zzzzzz_0[k] = -g_y_x_zzzzz_0[k] * ab_z + g_y_x_zzzzz_z[k];
            }

            /// Set up 112-113 components of targeted buffer : cbuffer.data(

            auto g_y_y_xxxxxx_0 = cbuffer.data(is_geom_11_off + 112 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_xxxxx_0, g_y_y_xxxxx_x, g_y_y_xxxxxx_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_xxxxxx_0[k] = -g_y_y_xxxxx_0[k] * ab_x + g_y_y_xxxxx_x[k];
            }

            /// Set up 113-114 components of targeted buffer : cbuffer.data(

            auto g_y_y_xxxxxy_0 = cbuffer.data(is_geom_11_off + 113 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_xxxxxy_0, g_y_y_xxxxy_0, g_y_y_xxxxy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_xxxxxy_0[k] = -g_y_y_xxxxy_0[k] * ab_x + g_y_y_xxxxy_x[k];
            }

            /// Set up 114-115 components of targeted buffer : cbuffer.data(

            auto g_y_y_xxxxxz_0 = cbuffer.data(is_geom_11_off + 114 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_xxxxxz_0, g_y_y_xxxxz_0, g_y_y_xxxxz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_xxxxxz_0[k] = -g_y_y_xxxxz_0[k] * ab_x + g_y_y_xxxxz_x[k];
            }

            /// Set up 115-116 components of targeted buffer : cbuffer.data(

            auto g_y_y_xxxxyy_0 = cbuffer.data(is_geom_11_off + 115 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_xxxxyy_0, g_y_y_xxxyy_0, g_y_y_xxxyy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_xxxxyy_0[k] = -g_y_y_xxxyy_0[k] * ab_x + g_y_y_xxxyy_x[k];
            }

            /// Set up 116-117 components of targeted buffer : cbuffer.data(

            auto g_y_y_xxxxyz_0 = cbuffer.data(is_geom_11_off + 116 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_xxxxyz_0, g_y_y_xxxyz_0, g_y_y_xxxyz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_xxxxyz_0[k] = -g_y_y_xxxyz_0[k] * ab_x + g_y_y_xxxyz_x[k];
            }

            /// Set up 117-118 components of targeted buffer : cbuffer.data(

            auto g_y_y_xxxxzz_0 = cbuffer.data(is_geom_11_off + 117 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_xxxxzz_0, g_y_y_xxxzz_0, g_y_y_xxxzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_xxxxzz_0[k] = -g_y_y_xxxzz_0[k] * ab_x + g_y_y_xxxzz_x[k];
            }

            /// Set up 118-119 components of targeted buffer : cbuffer.data(

            auto g_y_y_xxxyyy_0 = cbuffer.data(is_geom_11_off + 118 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_xxxyyy_0, g_y_y_xxyyy_0, g_y_y_xxyyy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_xxxyyy_0[k] = -g_y_y_xxyyy_0[k] * ab_x + g_y_y_xxyyy_x[k];
            }

            /// Set up 119-120 components of targeted buffer : cbuffer.data(

            auto g_y_y_xxxyyz_0 = cbuffer.data(is_geom_11_off + 119 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_xxxyyz_0, g_y_y_xxyyz_0, g_y_y_xxyyz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_xxxyyz_0[k] = -g_y_y_xxyyz_0[k] * ab_x + g_y_y_xxyyz_x[k];
            }

            /// Set up 120-121 components of targeted buffer : cbuffer.data(

            auto g_y_y_xxxyzz_0 = cbuffer.data(is_geom_11_off + 120 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_xxxyzz_0, g_y_y_xxyzz_0, g_y_y_xxyzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_xxxyzz_0[k] = -g_y_y_xxyzz_0[k] * ab_x + g_y_y_xxyzz_x[k];
            }

            /// Set up 121-122 components of targeted buffer : cbuffer.data(

            auto g_y_y_xxxzzz_0 = cbuffer.data(is_geom_11_off + 121 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_xxxzzz_0, g_y_y_xxzzz_0, g_y_y_xxzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_xxxzzz_0[k] = -g_y_y_xxzzz_0[k] * ab_x + g_y_y_xxzzz_x[k];
            }

            /// Set up 122-123 components of targeted buffer : cbuffer.data(

            auto g_y_y_xxyyyy_0 = cbuffer.data(is_geom_11_off + 122 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_xxyyyy_0, g_y_y_xyyyy_0, g_y_y_xyyyy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_xxyyyy_0[k] = -g_y_y_xyyyy_0[k] * ab_x + g_y_y_xyyyy_x[k];
            }

            /// Set up 123-124 components of targeted buffer : cbuffer.data(

            auto g_y_y_xxyyyz_0 = cbuffer.data(is_geom_11_off + 123 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_xxyyyz_0, g_y_y_xyyyz_0, g_y_y_xyyyz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_xxyyyz_0[k] = -g_y_y_xyyyz_0[k] * ab_x + g_y_y_xyyyz_x[k];
            }

            /// Set up 124-125 components of targeted buffer : cbuffer.data(

            auto g_y_y_xxyyzz_0 = cbuffer.data(is_geom_11_off + 124 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_xxyyzz_0, g_y_y_xyyzz_0, g_y_y_xyyzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_xxyyzz_0[k] = -g_y_y_xyyzz_0[k] * ab_x + g_y_y_xyyzz_x[k];
            }

            /// Set up 125-126 components of targeted buffer : cbuffer.data(

            auto g_y_y_xxyzzz_0 = cbuffer.data(is_geom_11_off + 125 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_xxyzzz_0, g_y_y_xyzzz_0, g_y_y_xyzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_xxyzzz_0[k] = -g_y_y_xyzzz_0[k] * ab_x + g_y_y_xyzzz_x[k];
            }

            /// Set up 126-127 components of targeted buffer : cbuffer.data(

            auto g_y_y_xxzzzz_0 = cbuffer.data(is_geom_11_off + 126 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_xxzzzz_0, g_y_y_xzzzz_0, g_y_y_xzzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_xxzzzz_0[k] = -g_y_y_xzzzz_0[k] * ab_x + g_y_y_xzzzz_x[k];
            }

            /// Set up 127-128 components of targeted buffer : cbuffer.data(

            auto g_y_y_xyyyyy_0 = cbuffer.data(is_geom_11_off + 127 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_xyyyyy_0, g_y_y_yyyyy_0, g_y_y_yyyyy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_xyyyyy_0[k] = -g_y_y_yyyyy_0[k] * ab_x + g_y_y_yyyyy_x[k];
            }

            /// Set up 128-129 components of targeted buffer : cbuffer.data(

            auto g_y_y_xyyyyz_0 = cbuffer.data(is_geom_11_off + 128 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_xyyyyz_0, g_y_y_yyyyz_0, g_y_y_yyyyz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_xyyyyz_0[k] = -g_y_y_yyyyz_0[k] * ab_x + g_y_y_yyyyz_x[k];
            }

            /// Set up 129-130 components of targeted buffer : cbuffer.data(

            auto g_y_y_xyyyzz_0 = cbuffer.data(is_geom_11_off + 129 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_xyyyzz_0, g_y_y_yyyzz_0, g_y_y_yyyzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_xyyyzz_0[k] = -g_y_y_yyyzz_0[k] * ab_x + g_y_y_yyyzz_x[k];
            }

            /// Set up 130-131 components of targeted buffer : cbuffer.data(

            auto g_y_y_xyyzzz_0 = cbuffer.data(is_geom_11_off + 130 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_xyyzzz_0, g_y_y_yyzzz_0, g_y_y_yyzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_xyyzzz_0[k] = -g_y_y_yyzzz_0[k] * ab_x + g_y_y_yyzzz_x[k];
            }

            /// Set up 131-132 components of targeted buffer : cbuffer.data(

            auto g_y_y_xyzzzz_0 = cbuffer.data(is_geom_11_off + 131 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_xyzzzz_0, g_y_y_yzzzz_0, g_y_y_yzzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_xyzzzz_0[k] = -g_y_y_yzzzz_0[k] * ab_x + g_y_y_yzzzz_x[k];
            }

            /// Set up 132-133 components of targeted buffer : cbuffer.data(

            auto g_y_y_xzzzzz_0 = cbuffer.data(is_geom_11_off + 132 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_xzzzzz_0, g_y_y_zzzzz_0, g_y_y_zzzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_xzzzzz_0[k] = -g_y_y_zzzzz_0[k] * ab_x + g_y_y_zzzzz_x[k];
            }

            /// Set up 133-134 components of targeted buffer : cbuffer.data(

            auto g_y_y_yyyyyy_0 = cbuffer.data(is_geom_11_off + 133 * ccomps * dcomps);

            #pragma omp simd aligned(g_0_y_yyyyy_0, g_y_0_yyyyy_0, g_y_y_yyyyy_0, g_y_y_yyyyy_y, g_y_y_yyyyyy_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_yyyyyy_0[k] = -g_0_y_yyyyy_0[k] + g_y_0_yyyyy_0[k] - g_y_y_yyyyy_0[k] * ab_y + g_y_y_yyyyy_y[k];
            }

            /// Set up 134-135 components of targeted buffer : cbuffer.data(

            auto g_y_y_yyyyyz_0 = cbuffer.data(is_geom_11_off + 134 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_yyyyy_0, g_y_y_yyyyy_z, g_y_y_yyyyyz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_yyyyyz_0[k] = -g_y_y_yyyyy_0[k] * ab_z + g_y_y_yyyyy_z[k];
            }

            /// Set up 135-136 components of targeted buffer : cbuffer.data(

            auto g_y_y_yyyyzz_0 = cbuffer.data(is_geom_11_off + 135 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_yyyyz_0, g_y_y_yyyyz_z, g_y_y_yyyyzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_yyyyzz_0[k] = -g_y_y_yyyyz_0[k] * ab_z + g_y_y_yyyyz_z[k];
            }

            /// Set up 136-137 components of targeted buffer : cbuffer.data(

            auto g_y_y_yyyzzz_0 = cbuffer.data(is_geom_11_off + 136 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_yyyzz_0, g_y_y_yyyzz_z, g_y_y_yyyzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_yyyzzz_0[k] = -g_y_y_yyyzz_0[k] * ab_z + g_y_y_yyyzz_z[k];
            }

            /// Set up 137-138 components of targeted buffer : cbuffer.data(

            auto g_y_y_yyzzzz_0 = cbuffer.data(is_geom_11_off + 137 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_yyzzz_0, g_y_y_yyzzz_z, g_y_y_yyzzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_yyzzzz_0[k] = -g_y_y_yyzzz_0[k] * ab_z + g_y_y_yyzzz_z[k];
            }

            /// Set up 138-139 components of targeted buffer : cbuffer.data(

            auto g_y_y_yzzzzz_0 = cbuffer.data(is_geom_11_off + 138 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_yzzzz_0, g_y_y_yzzzz_z, g_y_y_yzzzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_yzzzzz_0[k] = -g_y_y_yzzzz_0[k] * ab_z + g_y_y_yzzzz_z[k];
            }

            /// Set up 139-140 components of targeted buffer : cbuffer.data(

            auto g_y_y_zzzzzz_0 = cbuffer.data(is_geom_11_off + 139 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_y_zzzzz_0, g_y_y_zzzzz_z, g_y_y_zzzzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_zzzzzz_0[k] = -g_y_y_zzzzz_0[k] * ab_z + g_y_y_zzzzz_z[k];
            }

            /// Set up 140-141 components of targeted buffer : cbuffer.data(

            auto g_y_z_xxxxxx_0 = cbuffer.data(is_geom_11_off + 140 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_z_xxxxx_0, g_y_z_xxxxx_x, g_y_z_xxxxxx_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_xxxxxx_0[k] = -g_y_z_xxxxx_0[k] * ab_x + g_y_z_xxxxx_x[k];
            }

            /// Set up 141-142 components of targeted buffer : cbuffer.data(

            auto g_y_z_xxxxxy_0 = cbuffer.data(is_geom_11_off + 141 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_z_xxxxxy_0, g_y_z_xxxxy_0, g_y_z_xxxxy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_xxxxxy_0[k] = -g_y_z_xxxxy_0[k] * ab_x + g_y_z_xxxxy_x[k];
            }

            /// Set up 142-143 components of targeted buffer : cbuffer.data(

            auto g_y_z_xxxxxz_0 = cbuffer.data(is_geom_11_off + 142 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_z_xxxxxz_0, g_y_z_xxxxz_0, g_y_z_xxxxz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_xxxxxz_0[k] = -g_y_z_xxxxz_0[k] * ab_x + g_y_z_xxxxz_x[k];
            }

            /// Set up 143-144 components of targeted buffer : cbuffer.data(

            auto g_y_z_xxxxyy_0 = cbuffer.data(is_geom_11_off + 143 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_z_xxxxyy_0, g_y_z_xxxyy_0, g_y_z_xxxyy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_xxxxyy_0[k] = -g_y_z_xxxyy_0[k] * ab_x + g_y_z_xxxyy_x[k];
            }

            /// Set up 144-145 components of targeted buffer : cbuffer.data(

            auto g_y_z_xxxxyz_0 = cbuffer.data(is_geom_11_off + 144 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_z_xxxxyz_0, g_y_z_xxxyz_0, g_y_z_xxxyz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_xxxxyz_0[k] = -g_y_z_xxxyz_0[k] * ab_x + g_y_z_xxxyz_x[k];
            }

            /// Set up 145-146 components of targeted buffer : cbuffer.data(

            auto g_y_z_xxxxzz_0 = cbuffer.data(is_geom_11_off + 145 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_z_xxxxzz_0, g_y_z_xxxzz_0, g_y_z_xxxzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_xxxxzz_0[k] = -g_y_z_xxxzz_0[k] * ab_x + g_y_z_xxxzz_x[k];
            }

            /// Set up 146-147 components of targeted buffer : cbuffer.data(

            auto g_y_z_xxxyyy_0 = cbuffer.data(is_geom_11_off + 146 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_z_xxxyyy_0, g_y_z_xxyyy_0, g_y_z_xxyyy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_xxxyyy_0[k] = -g_y_z_xxyyy_0[k] * ab_x + g_y_z_xxyyy_x[k];
            }

            /// Set up 147-148 components of targeted buffer : cbuffer.data(

            auto g_y_z_xxxyyz_0 = cbuffer.data(is_geom_11_off + 147 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_z_xxxyyz_0, g_y_z_xxyyz_0, g_y_z_xxyyz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_xxxyyz_0[k] = -g_y_z_xxyyz_0[k] * ab_x + g_y_z_xxyyz_x[k];
            }

            /// Set up 148-149 components of targeted buffer : cbuffer.data(

            auto g_y_z_xxxyzz_0 = cbuffer.data(is_geom_11_off + 148 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_z_xxxyzz_0, g_y_z_xxyzz_0, g_y_z_xxyzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_xxxyzz_0[k] = -g_y_z_xxyzz_0[k] * ab_x + g_y_z_xxyzz_x[k];
            }

            /// Set up 149-150 components of targeted buffer : cbuffer.data(

            auto g_y_z_xxxzzz_0 = cbuffer.data(is_geom_11_off + 149 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_z_xxxzzz_0, g_y_z_xxzzz_0, g_y_z_xxzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_xxxzzz_0[k] = -g_y_z_xxzzz_0[k] * ab_x + g_y_z_xxzzz_x[k];
            }

            /// Set up 150-151 components of targeted buffer : cbuffer.data(

            auto g_y_z_xxyyyy_0 = cbuffer.data(is_geom_11_off + 150 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_z_xxyyyy_0, g_y_z_xyyyy_0, g_y_z_xyyyy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_xxyyyy_0[k] = -g_y_z_xyyyy_0[k] * ab_x + g_y_z_xyyyy_x[k];
            }

            /// Set up 151-152 components of targeted buffer : cbuffer.data(

            auto g_y_z_xxyyyz_0 = cbuffer.data(is_geom_11_off + 151 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_z_xxyyyz_0, g_y_z_xyyyz_0, g_y_z_xyyyz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_xxyyyz_0[k] = -g_y_z_xyyyz_0[k] * ab_x + g_y_z_xyyyz_x[k];
            }

            /// Set up 152-153 components of targeted buffer : cbuffer.data(

            auto g_y_z_xxyyzz_0 = cbuffer.data(is_geom_11_off + 152 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_z_xxyyzz_0, g_y_z_xyyzz_0, g_y_z_xyyzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_xxyyzz_0[k] = -g_y_z_xyyzz_0[k] * ab_x + g_y_z_xyyzz_x[k];
            }

            /// Set up 153-154 components of targeted buffer : cbuffer.data(

            auto g_y_z_xxyzzz_0 = cbuffer.data(is_geom_11_off + 153 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_z_xxyzzz_0, g_y_z_xyzzz_0, g_y_z_xyzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_xxyzzz_0[k] = -g_y_z_xyzzz_0[k] * ab_x + g_y_z_xyzzz_x[k];
            }

            /// Set up 154-155 components of targeted buffer : cbuffer.data(

            auto g_y_z_xxzzzz_0 = cbuffer.data(is_geom_11_off + 154 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_z_xxzzzz_0, g_y_z_xzzzz_0, g_y_z_xzzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_xxzzzz_0[k] = -g_y_z_xzzzz_0[k] * ab_x + g_y_z_xzzzz_x[k];
            }

            /// Set up 155-156 components of targeted buffer : cbuffer.data(

            auto g_y_z_xyyyyy_0 = cbuffer.data(is_geom_11_off + 155 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_z_xyyyyy_0, g_y_z_yyyyy_0, g_y_z_yyyyy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_xyyyyy_0[k] = -g_y_z_yyyyy_0[k] * ab_x + g_y_z_yyyyy_x[k];
            }

            /// Set up 156-157 components of targeted buffer : cbuffer.data(

            auto g_y_z_xyyyyz_0 = cbuffer.data(is_geom_11_off + 156 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_z_xyyyyz_0, g_y_z_yyyyz_0, g_y_z_yyyyz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_xyyyyz_0[k] = -g_y_z_yyyyz_0[k] * ab_x + g_y_z_yyyyz_x[k];
            }

            /// Set up 157-158 components of targeted buffer : cbuffer.data(

            auto g_y_z_xyyyzz_0 = cbuffer.data(is_geom_11_off + 157 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_z_xyyyzz_0, g_y_z_yyyzz_0, g_y_z_yyyzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_xyyyzz_0[k] = -g_y_z_yyyzz_0[k] * ab_x + g_y_z_yyyzz_x[k];
            }

            /// Set up 158-159 components of targeted buffer : cbuffer.data(

            auto g_y_z_xyyzzz_0 = cbuffer.data(is_geom_11_off + 158 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_z_xyyzzz_0, g_y_z_yyzzz_0, g_y_z_yyzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_xyyzzz_0[k] = -g_y_z_yyzzz_0[k] * ab_x + g_y_z_yyzzz_x[k];
            }

            /// Set up 159-160 components of targeted buffer : cbuffer.data(

            auto g_y_z_xyzzzz_0 = cbuffer.data(is_geom_11_off + 159 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_z_xyzzzz_0, g_y_z_yzzzz_0, g_y_z_yzzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_xyzzzz_0[k] = -g_y_z_yzzzz_0[k] * ab_x + g_y_z_yzzzz_x[k];
            }

            /// Set up 160-161 components of targeted buffer : cbuffer.data(

            auto g_y_z_xzzzzz_0 = cbuffer.data(is_geom_11_off + 160 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_z_xzzzzz_0, g_y_z_zzzzz_0, g_y_z_zzzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_xzzzzz_0[k] = -g_y_z_zzzzz_0[k] * ab_x + g_y_z_zzzzz_x[k];
            }

            /// Set up 161-162 components of targeted buffer : cbuffer.data(

            auto g_y_z_yyyyyy_0 = cbuffer.data(is_geom_11_off + 161 * ccomps * dcomps);

            #pragma omp simd aligned(g_0_z_yyyyy_0, g_y_z_yyyyy_0, g_y_z_yyyyy_y, g_y_z_yyyyyy_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_yyyyyy_0[k] = -g_0_z_yyyyy_0[k] - g_y_z_yyyyy_0[k] * ab_y + g_y_z_yyyyy_y[k];
            }

            /// Set up 162-163 components of targeted buffer : cbuffer.data(

            auto g_y_z_yyyyyz_0 = cbuffer.data(is_geom_11_off + 162 * ccomps * dcomps);

            #pragma omp simd aligned(g_0_z_yyyyz_0, g_y_z_yyyyyz_0, g_y_z_yyyyz_0, g_y_z_yyyyz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_yyyyyz_0[k] = -g_0_z_yyyyz_0[k] - g_y_z_yyyyz_0[k] * ab_y + g_y_z_yyyyz_y[k];
            }

            /// Set up 163-164 components of targeted buffer : cbuffer.data(

            auto g_y_z_yyyyzz_0 = cbuffer.data(is_geom_11_off + 163 * ccomps * dcomps);

            #pragma omp simd aligned(g_0_z_yyyzz_0, g_y_z_yyyyzz_0, g_y_z_yyyzz_0, g_y_z_yyyzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_yyyyzz_0[k] = -g_0_z_yyyzz_0[k] - g_y_z_yyyzz_0[k] * ab_y + g_y_z_yyyzz_y[k];
            }

            /// Set up 164-165 components of targeted buffer : cbuffer.data(

            auto g_y_z_yyyzzz_0 = cbuffer.data(is_geom_11_off + 164 * ccomps * dcomps);

            #pragma omp simd aligned(g_0_z_yyzzz_0, g_y_z_yyyzzz_0, g_y_z_yyzzz_0, g_y_z_yyzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_yyyzzz_0[k] = -g_0_z_yyzzz_0[k] - g_y_z_yyzzz_0[k] * ab_y + g_y_z_yyzzz_y[k];
            }

            /// Set up 165-166 components of targeted buffer : cbuffer.data(

            auto g_y_z_yyzzzz_0 = cbuffer.data(is_geom_11_off + 165 * ccomps * dcomps);

            #pragma omp simd aligned(g_0_z_yzzzz_0, g_y_z_yyzzzz_0, g_y_z_yzzzz_0, g_y_z_yzzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_yyzzzz_0[k] = -g_0_z_yzzzz_0[k] - g_y_z_yzzzz_0[k] * ab_y + g_y_z_yzzzz_y[k];
            }

            /// Set up 166-167 components of targeted buffer : cbuffer.data(

            auto g_y_z_yzzzzz_0 = cbuffer.data(is_geom_11_off + 166 * ccomps * dcomps);

            #pragma omp simd aligned(g_0_z_zzzzz_0, g_y_z_yzzzzz_0, g_y_z_zzzzz_0, g_y_z_zzzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_yzzzzz_0[k] = -g_0_z_zzzzz_0[k] - g_y_z_zzzzz_0[k] * ab_y + g_y_z_zzzzz_y[k];
            }

            /// Set up 167-168 components of targeted buffer : cbuffer.data(

            auto g_y_z_zzzzzz_0 = cbuffer.data(is_geom_11_off + 167 * ccomps * dcomps);

            #pragma omp simd aligned(g_y_0_zzzzz_0, g_y_z_zzzzz_0, g_y_z_zzzzz_z, g_y_z_zzzzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_zzzzzz_0[k] = g_y_0_zzzzz_0[k] - g_y_z_zzzzz_0[k] * ab_z + g_y_z_zzzzz_z[k];
            }

            /// Set up 168-169 components of targeted buffer : cbuffer.data(

            auto g_z_x_xxxxxx_0 = cbuffer.data(is_geom_11_off + 168 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_0_xxxxx_0, g_z_x_xxxxx_0, g_z_x_xxxxx_x, g_z_x_xxxxxx_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_xxxxxx_0[k] = g_z_0_xxxxx_0[k] - g_z_x_xxxxx_0[k] * ab_x + g_z_x_xxxxx_x[k];
            }

            /// Set up 169-170 components of targeted buffer : cbuffer.data(

            auto g_z_x_xxxxxy_0 = cbuffer.data(is_geom_11_off + 169 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_x_xxxxx_0, g_z_x_xxxxx_y, g_z_x_xxxxxy_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_xxxxxy_0[k] = -g_z_x_xxxxx_0[k] * ab_y + g_z_x_xxxxx_y[k];
            }

            /// Set up 170-171 components of targeted buffer : cbuffer.data(

            auto g_z_x_xxxxxz_0 = cbuffer.data(is_geom_11_off + 170 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_0_xxxxz_0, g_z_x_xxxxxz_0, g_z_x_xxxxz_0, g_z_x_xxxxz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_xxxxxz_0[k] = g_z_0_xxxxz_0[k] - g_z_x_xxxxz_0[k] * ab_x + g_z_x_xxxxz_x[k];
            }

            /// Set up 171-172 components of targeted buffer : cbuffer.data(

            auto g_z_x_xxxxyy_0 = cbuffer.data(is_geom_11_off + 171 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_x_xxxxy_0, g_z_x_xxxxy_y, g_z_x_xxxxyy_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_xxxxyy_0[k] = -g_z_x_xxxxy_0[k] * ab_y + g_z_x_xxxxy_y[k];
            }

            /// Set up 172-173 components of targeted buffer : cbuffer.data(

            auto g_z_x_xxxxyz_0 = cbuffer.data(is_geom_11_off + 172 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_x_xxxxyz_0, g_z_x_xxxxz_0, g_z_x_xxxxz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_xxxxyz_0[k] = -g_z_x_xxxxz_0[k] * ab_y + g_z_x_xxxxz_y[k];
            }

            /// Set up 173-174 components of targeted buffer : cbuffer.data(

            auto g_z_x_xxxxzz_0 = cbuffer.data(is_geom_11_off + 173 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_0_xxxzz_0, g_z_x_xxxxzz_0, g_z_x_xxxzz_0, g_z_x_xxxzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_xxxxzz_0[k] = g_z_0_xxxzz_0[k] - g_z_x_xxxzz_0[k] * ab_x + g_z_x_xxxzz_x[k];
            }

            /// Set up 174-175 components of targeted buffer : cbuffer.data(

            auto g_z_x_xxxyyy_0 = cbuffer.data(is_geom_11_off + 174 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_x_xxxyy_0, g_z_x_xxxyy_y, g_z_x_xxxyyy_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_xxxyyy_0[k] = -g_z_x_xxxyy_0[k] * ab_y + g_z_x_xxxyy_y[k];
            }

            /// Set up 175-176 components of targeted buffer : cbuffer.data(

            auto g_z_x_xxxyyz_0 = cbuffer.data(is_geom_11_off + 175 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_x_xxxyyz_0, g_z_x_xxxyz_0, g_z_x_xxxyz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_xxxyyz_0[k] = -g_z_x_xxxyz_0[k] * ab_y + g_z_x_xxxyz_y[k];
            }

            /// Set up 176-177 components of targeted buffer : cbuffer.data(

            auto g_z_x_xxxyzz_0 = cbuffer.data(is_geom_11_off + 176 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_x_xxxyzz_0, g_z_x_xxxzz_0, g_z_x_xxxzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_xxxyzz_0[k] = -g_z_x_xxxzz_0[k] * ab_y + g_z_x_xxxzz_y[k];
            }

            /// Set up 177-178 components of targeted buffer : cbuffer.data(

            auto g_z_x_xxxzzz_0 = cbuffer.data(is_geom_11_off + 177 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_0_xxzzz_0, g_z_x_xxxzzz_0, g_z_x_xxzzz_0, g_z_x_xxzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_xxxzzz_0[k] = g_z_0_xxzzz_0[k] - g_z_x_xxzzz_0[k] * ab_x + g_z_x_xxzzz_x[k];
            }

            /// Set up 178-179 components of targeted buffer : cbuffer.data(

            auto g_z_x_xxyyyy_0 = cbuffer.data(is_geom_11_off + 178 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_x_xxyyy_0, g_z_x_xxyyy_y, g_z_x_xxyyyy_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_xxyyyy_0[k] = -g_z_x_xxyyy_0[k] * ab_y + g_z_x_xxyyy_y[k];
            }

            /// Set up 179-180 components of targeted buffer : cbuffer.data(

            auto g_z_x_xxyyyz_0 = cbuffer.data(is_geom_11_off + 179 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_x_xxyyyz_0, g_z_x_xxyyz_0, g_z_x_xxyyz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_xxyyyz_0[k] = -g_z_x_xxyyz_0[k] * ab_y + g_z_x_xxyyz_y[k];
            }

            /// Set up 180-181 components of targeted buffer : cbuffer.data(

            auto g_z_x_xxyyzz_0 = cbuffer.data(is_geom_11_off + 180 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_x_xxyyzz_0, g_z_x_xxyzz_0, g_z_x_xxyzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_xxyyzz_0[k] = -g_z_x_xxyzz_0[k] * ab_y + g_z_x_xxyzz_y[k];
            }

            /// Set up 181-182 components of targeted buffer : cbuffer.data(

            auto g_z_x_xxyzzz_0 = cbuffer.data(is_geom_11_off + 181 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_x_xxyzzz_0, g_z_x_xxzzz_0, g_z_x_xxzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_xxyzzz_0[k] = -g_z_x_xxzzz_0[k] * ab_y + g_z_x_xxzzz_y[k];
            }

            /// Set up 182-183 components of targeted buffer : cbuffer.data(

            auto g_z_x_xxzzzz_0 = cbuffer.data(is_geom_11_off + 182 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_0_xzzzz_0, g_z_x_xxzzzz_0, g_z_x_xzzzz_0, g_z_x_xzzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_xxzzzz_0[k] = g_z_0_xzzzz_0[k] - g_z_x_xzzzz_0[k] * ab_x + g_z_x_xzzzz_x[k];
            }

            /// Set up 183-184 components of targeted buffer : cbuffer.data(

            auto g_z_x_xyyyyy_0 = cbuffer.data(is_geom_11_off + 183 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_x_xyyyy_0, g_z_x_xyyyy_y, g_z_x_xyyyyy_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_xyyyyy_0[k] = -g_z_x_xyyyy_0[k] * ab_y + g_z_x_xyyyy_y[k];
            }

            /// Set up 184-185 components of targeted buffer : cbuffer.data(

            auto g_z_x_xyyyyz_0 = cbuffer.data(is_geom_11_off + 184 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_x_xyyyyz_0, g_z_x_xyyyz_0, g_z_x_xyyyz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_xyyyyz_0[k] = -g_z_x_xyyyz_0[k] * ab_y + g_z_x_xyyyz_y[k];
            }

            /// Set up 185-186 components of targeted buffer : cbuffer.data(

            auto g_z_x_xyyyzz_0 = cbuffer.data(is_geom_11_off + 185 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_x_xyyyzz_0, g_z_x_xyyzz_0, g_z_x_xyyzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_xyyyzz_0[k] = -g_z_x_xyyzz_0[k] * ab_y + g_z_x_xyyzz_y[k];
            }

            /// Set up 186-187 components of targeted buffer : cbuffer.data(

            auto g_z_x_xyyzzz_0 = cbuffer.data(is_geom_11_off + 186 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_x_xyyzzz_0, g_z_x_xyzzz_0, g_z_x_xyzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_xyyzzz_0[k] = -g_z_x_xyzzz_0[k] * ab_y + g_z_x_xyzzz_y[k];
            }

            /// Set up 187-188 components of targeted buffer : cbuffer.data(

            auto g_z_x_xyzzzz_0 = cbuffer.data(is_geom_11_off + 187 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_x_xyzzzz_0, g_z_x_xzzzz_0, g_z_x_xzzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_xyzzzz_0[k] = -g_z_x_xzzzz_0[k] * ab_y + g_z_x_xzzzz_y[k];
            }

            /// Set up 188-189 components of targeted buffer : cbuffer.data(

            auto g_z_x_xzzzzz_0 = cbuffer.data(is_geom_11_off + 188 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_0_zzzzz_0, g_z_x_xzzzzz_0, g_z_x_zzzzz_0, g_z_x_zzzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_xzzzzz_0[k] = g_z_0_zzzzz_0[k] - g_z_x_zzzzz_0[k] * ab_x + g_z_x_zzzzz_x[k];
            }

            /// Set up 189-190 components of targeted buffer : cbuffer.data(

            auto g_z_x_yyyyyy_0 = cbuffer.data(is_geom_11_off + 189 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_x_yyyyy_0, g_z_x_yyyyy_y, g_z_x_yyyyyy_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_yyyyyy_0[k] = -g_z_x_yyyyy_0[k] * ab_y + g_z_x_yyyyy_y[k];
            }

            /// Set up 190-191 components of targeted buffer : cbuffer.data(

            auto g_z_x_yyyyyz_0 = cbuffer.data(is_geom_11_off + 190 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_x_yyyyyz_0, g_z_x_yyyyz_0, g_z_x_yyyyz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_yyyyyz_0[k] = -g_z_x_yyyyz_0[k] * ab_y + g_z_x_yyyyz_y[k];
            }

            /// Set up 191-192 components of targeted buffer : cbuffer.data(

            auto g_z_x_yyyyzz_0 = cbuffer.data(is_geom_11_off + 191 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_x_yyyyzz_0, g_z_x_yyyzz_0, g_z_x_yyyzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_yyyyzz_0[k] = -g_z_x_yyyzz_0[k] * ab_y + g_z_x_yyyzz_y[k];
            }

            /// Set up 192-193 components of targeted buffer : cbuffer.data(

            auto g_z_x_yyyzzz_0 = cbuffer.data(is_geom_11_off + 192 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_x_yyyzzz_0, g_z_x_yyzzz_0, g_z_x_yyzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_yyyzzz_0[k] = -g_z_x_yyzzz_0[k] * ab_y + g_z_x_yyzzz_y[k];
            }

            /// Set up 193-194 components of targeted buffer : cbuffer.data(

            auto g_z_x_yyzzzz_0 = cbuffer.data(is_geom_11_off + 193 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_x_yyzzzz_0, g_z_x_yzzzz_0, g_z_x_yzzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_yyzzzz_0[k] = -g_z_x_yzzzz_0[k] * ab_y + g_z_x_yzzzz_y[k];
            }

            /// Set up 194-195 components of targeted buffer : cbuffer.data(

            auto g_z_x_yzzzzz_0 = cbuffer.data(is_geom_11_off + 194 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_x_yzzzzz_0, g_z_x_zzzzz_0, g_z_x_zzzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_yzzzzz_0[k] = -g_z_x_zzzzz_0[k] * ab_y + g_z_x_zzzzz_y[k];
            }

            /// Set up 195-196 components of targeted buffer : cbuffer.data(

            auto g_z_x_zzzzzz_0 = cbuffer.data(is_geom_11_off + 195 * ccomps * dcomps);

            #pragma omp simd aligned(g_0_x_zzzzz_0, g_z_x_zzzzz_0, g_z_x_zzzzz_z, g_z_x_zzzzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_zzzzzz_0[k] = -g_0_x_zzzzz_0[k] - g_z_x_zzzzz_0[k] * ab_z + g_z_x_zzzzz_z[k];
            }

            /// Set up 196-197 components of targeted buffer : cbuffer.data(

            auto g_z_y_xxxxxx_0 = cbuffer.data(is_geom_11_off + 196 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_y_xxxxx_0, g_z_y_xxxxx_x, g_z_y_xxxxxx_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_xxxxxx_0[k] = -g_z_y_xxxxx_0[k] * ab_x + g_z_y_xxxxx_x[k];
            }

            /// Set up 197-198 components of targeted buffer : cbuffer.data(

            auto g_z_y_xxxxxy_0 = cbuffer.data(is_geom_11_off + 197 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_y_xxxxxy_0, g_z_y_xxxxy_0, g_z_y_xxxxy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_xxxxxy_0[k] = -g_z_y_xxxxy_0[k] * ab_x + g_z_y_xxxxy_x[k];
            }

            /// Set up 198-199 components of targeted buffer : cbuffer.data(

            auto g_z_y_xxxxxz_0 = cbuffer.data(is_geom_11_off + 198 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_y_xxxxxz_0, g_z_y_xxxxz_0, g_z_y_xxxxz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_xxxxxz_0[k] = -g_z_y_xxxxz_0[k] * ab_x + g_z_y_xxxxz_x[k];
            }

            /// Set up 199-200 components of targeted buffer : cbuffer.data(

            auto g_z_y_xxxxyy_0 = cbuffer.data(is_geom_11_off + 199 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_y_xxxxyy_0, g_z_y_xxxyy_0, g_z_y_xxxyy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_xxxxyy_0[k] = -g_z_y_xxxyy_0[k] * ab_x + g_z_y_xxxyy_x[k];
            }

            /// Set up 200-201 components of targeted buffer : cbuffer.data(

            auto g_z_y_xxxxyz_0 = cbuffer.data(is_geom_11_off + 200 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_y_xxxxyz_0, g_z_y_xxxyz_0, g_z_y_xxxyz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_xxxxyz_0[k] = -g_z_y_xxxyz_0[k] * ab_x + g_z_y_xxxyz_x[k];
            }

            /// Set up 201-202 components of targeted buffer : cbuffer.data(

            auto g_z_y_xxxxzz_0 = cbuffer.data(is_geom_11_off + 201 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_y_xxxxzz_0, g_z_y_xxxzz_0, g_z_y_xxxzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_xxxxzz_0[k] = -g_z_y_xxxzz_0[k] * ab_x + g_z_y_xxxzz_x[k];
            }

            /// Set up 202-203 components of targeted buffer : cbuffer.data(

            auto g_z_y_xxxyyy_0 = cbuffer.data(is_geom_11_off + 202 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_y_xxxyyy_0, g_z_y_xxyyy_0, g_z_y_xxyyy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_xxxyyy_0[k] = -g_z_y_xxyyy_0[k] * ab_x + g_z_y_xxyyy_x[k];
            }

            /// Set up 203-204 components of targeted buffer : cbuffer.data(

            auto g_z_y_xxxyyz_0 = cbuffer.data(is_geom_11_off + 203 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_y_xxxyyz_0, g_z_y_xxyyz_0, g_z_y_xxyyz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_xxxyyz_0[k] = -g_z_y_xxyyz_0[k] * ab_x + g_z_y_xxyyz_x[k];
            }

            /// Set up 204-205 components of targeted buffer : cbuffer.data(

            auto g_z_y_xxxyzz_0 = cbuffer.data(is_geom_11_off + 204 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_y_xxxyzz_0, g_z_y_xxyzz_0, g_z_y_xxyzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_xxxyzz_0[k] = -g_z_y_xxyzz_0[k] * ab_x + g_z_y_xxyzz_x[k];
            }

            /// Set up 205-206 components of targeted buffer : cbuffer.data(

            auto g_z_y_xxxzzz_0 = cbuffer.data(is_geom_11_off + 205 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_y_xxxzzz_0, g_z_y_xxzzz_0, g_z_y_xxzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_xxxzzz_0[k] = -g_z_y_xxzzz_0[k] * ab_x + g_z_y_xxzzz_x[k];
            }

            /// Set up 206-207 components of targeted buffer : cbuffer.data(

            auto g_z_y_xxyyyy_0 = cbuffer.data(is_geom_11_off + 206 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_y_xxyyyy_0, g_z_y_xyyyy_0, g_z_y_xyyyy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_xxyyyy_0[k] = -g_z_y_xyyyy_0[k] * ab_x + g_z_y_xyyyy_x[k];
            }

            /// Set up 207-208 components of targeted buffer : cbuffer.data(

            auto g_z_y_xxyyyz_0 = cbuffer.data(is_geom_11_off + 207 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_y_xxyyyz_0, g_z_y_xyyyz_0, g_z_y_xyyyz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_xxyyyz_0[k] = -g_z_y_xyyyz_0[k] * ab_x + g_z_y_xyyyz_x[k];
            }

            /// Set up 208-209 components of targeted buffer : cbuffer.data(

            auto g_z_y_xxyyzz_0 = cbuffer.data(is_geom_11_off + 208 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_y_xxyyzz_0, g_z_y_xyyzz_0, g_z_y_xyyzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_xxyyzz_0[k] = -g_z_y_xyyzz_0[k] * ab_x + g_z_y_xyyzz_x[k];
            }

            /// Set up 209-210 components of targeted buffer : cbuffer.data(

            auto g_z_y_xxyzzz_0 = cbuffer.data(is_geom_11_off + 209 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_y_xxyzzz_0, g_z_y_xyzzz_0, g_z_y_xyzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_xxyzzz_0[k] = -g_z_y_xyzzz_0[k] * ab_x + g_z_y_xyzzz_x[k];
            }

            /// Set up 210-211 components of targeted buffer : cbuffer.data(

            auto g_z_y_xxzzzz_0 = cbuffer.data(is_geom_11_off + 210 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_y_xxzzzz_0, g_z_y_xzzzz_0, g_z_y_xzzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_xxzzzz_0[k] = -g_z_y_xzzzz_0[k] * ab_x + g_z_y_xzzzz_x[k];
            }

            /// Set up 211-212 components of targeted buffer : cbuffer.data(

            auto g_z_y_xyyyyy_0 = cbuffer.data(is_geom_11_off + 211 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_y_xyyyyy_0, g_z_y_yyyyy_0, g_z_y_yyyyy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_xyyyyy_0[k] = -g_z_y_yyyyy_0[k] * ab_x + g_z_y_yyyyy_x[k];
            }

            /// Set up 212-213 components of targeted buffer : cbuffer.data(

            auto g_z_y_xyyyyz_0 = cbuffer.data(is_geom_11_off + 212 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_y_xyyyyz_0, g_z_y_yyyyz_0, g_z_y_yyyyz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_xyyyyz_0[k] = -g_z_y_yyyyz_0[k] * ab_x + g_z_y_yyyyz_x[k];
            }

            /// Set up 213-214 components of targeted buffer : cbuffer.data(

            auto g_z_y_xyyyzz_0 = cbuffer.data(is_geom_11_off + 213 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_y_xyyyzz_0, g_z_y_yyyzz_0, g_z_y_yyyzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_xyyyzz_0[k] = -g_z_y_yyyzz_0[k] * ab_x + g_z_y_yyyzz_x[k];
            }

            /// Set up 214-215 components of targeted buffer : cbuffer.data(

            auto g_z_y_xyyzzz_0 = cbuffer.data(is_geom_11_off + 214 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_y_xyyzzz_0, g_z_y_yyzzz_0, g_z_y_yyzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_xyyzzz_0[k] = -g_z_y_yyzzz_0[k] * ab_x + g_z_y_yyzzz_x[k];
            }

            /// Set up 215-216 components of targeted buffer : cbuffer.data(

            auto g_z_y_xyzzzz_0 = cbuffer.data(is_geom_11_off + 215 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_y_xyzzzz_0, g_z_y_yzzzz_0, g_z_y_yzzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_xyzzzz_0[k] = -g_z_y_yzzzz_0[k] * ab_x + g_z_y_yzzzz_x[k];
            }

            /// Set up 216-217 components of targeted buffer : cbuffer.data(

            auto g_z_y_xzzzzz_0 = cbuffer.data(is_geom_11_off + 216 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_y_xzzzzz_0, g_z_y_zzzzz_0, g_z_y_zzzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_xzzzzz_0[k] = -g_z_y_zzzzz_0[k] * ab_x + g_z_y_zzzzz_x[k];
            }

            /// Set up 217-218 components of targeted buffer : cbuffer.data(

            auto g_z_y_yyyyyy_0 = cbuffer.data(is_geom_11_off + 217 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_0_yyyyy_0, g_z_y_yyyyy_0, g_z_y_yyyyy_y, g_z_y_yyyyyy_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_yyyyyy_0[k] = g_z_0_yyyyy_0[k] - g_z_y_yyyyy_0[k] * ab_y + g_z_y_yyyyy_y[k];
            }

            /// Set up 218-219 components of targeted buffer : cbuffer.data(

            auto g_z_y_yyyyyz_0 = cbuffer.data(is_geom_11_off + 218 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_0_yyyyz_0, g_z_y_yyyyyz_0, g_z_y_yyyyz_0, g_z_y_yyyyz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_yyyyyz_0[k] = g_z_0_yyyyz_0[k] - g_z_y_yyyyz_0[k] * ab_y + g_z_y_yyyyz_y[k];
            }

            /// Set up 219-220 components of targeted buffer : cbuffer.data(

            auto g_z_y_yyyyzz_0 = cbuffer.data(is_geom_11_off + 219 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_0_yyyzz_0, g_z_y_yyyyzz_0, g_z_y_yyyzz_0, g_z_y_yyyzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_yyyyzz_0[k] = g_z_0_yyyzz_0[k] - g_z_y_yyyzz_0[k] * ab_y + g_z_y_yyyzz_y[k];
            }

            /// Set up 220-221 components of targeted buffer : cbuffer.data(

            auto g_z_y_yyyzzz_0 = cbuffer.data(is_geom_11_off + 220 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_0_yyzzz_0, g_z_y_yyyzzz_0, g_z_y_yyzzz_0, g_z_y_yyzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_yyyzzz_0[k] = g_z_0_yyzzz_0[k] - g_z_y_yyzzz_0[k] * ab_y + g_z_y_yyzzz_y[k];
            }

            /// Set up 221-222 components of targeted buffer : cbuffer.data(

            auto g_z_y_yyzzzz_0 = cbuffer.data(is_geom_11_off + 221 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_0_yzzzz_0, g_z_y_yyzzzz_0, g_z_y_yzzzz_0, g_z_y_yzzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_yyzzzz_0[k] = g_z_0_yzzzz_0[k] - g_z_y_yzzzz_0[k] * ab_y + g_z_y_yzzzz_y[k];
            }

            /// Set up 222-223 components of targeted buffer : cbuffer.data(

            auto g_z_y_yzzzzz_0 = cbuffer.data(is_geom_11_off + 222 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_0_zzzzz_0, g_z_y_yzzzzz_0, g_z_y_zzzzz_0, g_z_y_zzzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_yzzzzz_0[k] = g_z_0_zzzzz_0[k] - g_z_y_zzzzz_0[k] * ab_y + g_z_y_zzzzz_y[k];
            }

            /// Set up 223-224 components of targeted buffer : cbuffer.data(

            auto g_z_y_zzzzzz_0 = cbuffer.data(is_geom_11_off + 223 * ccomps * dcomps);

            #pragma omp simd aligned(g_0_y_zzzzz_0, g_z_y_zzzzz_0, g_z_y_zzzzz_z, g_z_y_zzzzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_zzzzzz_0[k] = -g_0_y_zzzzz_0[k] - g_z_y_zzzzz_0[k] * ab_z + g_z_y_zzzzz_z[k];
            }

            /// Set up 224-225 components of targeted buffer : cbuffer.data(

            auto g_z_z_xxxxxx_0 = cbuffer.data(is_geom_11_off + 224 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_xxxxx_0, g_z_z_xxxxx_x, g_z_z_xxxxxx_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_xxxxxx_0[k] = -g_z_z_xxxxx_0[k] * ab_x + g_z_z_xxxxx_x[k];
            }

            /// Set up 225-226 components of targeted buffer : cbuffer.data(

            auto g_z_z_xxxxxy_0 = cbuffer.data(is_geom_11_off + 225 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_xxxxxy_0, g_z_z_xxxxy_0, g_z_z_xxxxy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_xxxxxy_0[k] = -g_z_z_xxxxy_0[k] * ab_x + g_z_z_xxxxy_x[k];
            }

            /// Set up 226-227 components of targeted buffer : cbuffer.data(

            auto g_z_z_xxxxxz_0 = cbuffer.data(is_geom_11_off + 226 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_xxxxxz_0, g_z_z_xxxxz_0, g_z_z_xxxxz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_xxxxxz_0[k] = -g_z_z_xxxxz_0[k] * ab_x + g_z_z_xxxxz_x[k];
            }

            /// Set up 227-228 components of targeted buffer : cbuffer.data(

            auto g_z_z_xxxxyy_0 = cbuffer.data(is_geom_11_off + 227 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_xxxxyy_0, g_z_z_xxxyy_0, g_z_z_xxxyy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_xxxxyy_0[k] = -g_z_z_xxxyy_0[k] * ab_x + g_z_z_xxxyy_x[k];
            }

            /// Set up 228-229 components of targeted buffer : cbuffer.data(

            auto g_z_z_xxxxyz_0 = cbuffer.data(is_geom_11_off + 228 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_xxxxyz_0, g_z_z_xxxyz_0, g_z_z_xxxyz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_xxxxyz_0[k] = -g_z_z_xxxyz_0[k] * ab_x + g_z_z_xxxyz_x[k];
            }

            /// Set up 229-230 components of targeted buffer : cbuffer.data(

            auto g_z_z_xxxxzz_0 = cbuffer.data(is_geom_11_off + 229 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_xxxxzz_0, g_z_z_xxxzz_0, g_z_z_xxxzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_xxxxzz_0[k] = -g_z_z_xxxzz_0[k] * ab_x + g_z_z_xxxzz_x[k];
            }

            /// Set up 230-231 components of targeted buffer : cbuffer.data(

            auto g_z_z_xxxyyy_0 = cbuffer.data(is_geom_11_off + 230 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_xxxyyy_0, g_z_z_xxyyy_0, g_z_z_xxyyy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_xxxyyy_0[k] = -g_z_z_xxyyy_0[k] * ab_x + g_z_z_xxyyy_x[k];
            }

            /// Set up 231-232 components of targeted buffer : cbuffer.data(

            auto g_z_z_xxxyyz_0 = cbuffer.data(is_geom_11_off + 231 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_xxxyyz_0, g_z_z_xxyyz_0, g_z_z_xxyyz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_xxxyyz_0[k] = -g_z_z_xxyyz_0[k] * ab_x + g_z_z_xxyyz_x[k];
            }

            /// Set up 232-233 components of targeted buffer : cbuffer.data(

            auto g_z_z_xxxyzz_0 = cbuffer.data(is_geom_11_off + 232 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_xxxyzz_0, g_z_z_xxyzz_0, g_z_z_xxyzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_xxxyzz_0[k] = -g_z_z_xxyzz_0[k] * ab_x + g_z_z_xxyzz_x[k];
            }

            /// Set up 233-234 components of targeted buffer : cbuffer.data(

            auto g_z_z_xxxzzz_0 = cbuffer.data(is_geom_11_off + 233 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_xxxzzz_0, g_z_z_xxzzz_0, g_z_z_xxzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_xxxzzz_0[k] = -g_z_z_xxzzz_0[k] * ab_x + g_z_z_xxzzz_x[k];
            }

            /// Set up 234-235 components of targeted buffer : cbuffer.data(

            auto g_z_z_xxyyyy_0 = cbuffer.data(is_geom_11_off + 234 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_xxyyyy_0, g_z_z_xyyyy_0, g_z_z_xyyyy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_xxyyyy_0[k] = -g_z_z_xyyyy_0[k] * ab_x + g_z_z_xyyyy_x[k];
            }

            /// Set up 235-236 components of targeted buffer : cbuffer.data(

            auto g_z_z_xxyyyz_0 = cbuffer.data(is_geom_11_off + 235 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_xxyyyz_0, g_z_z_xyyyz_0, g_z_z_xyyyz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_xxyyyz_0[k] = -g_z_z_xyyyz_0[k] * ab_x + g_z_z_xyyyz_x[k];
            }

            /// Set up 236-237 components of targeted buffer : cbuffer.data(

            auto g_z_z_xxyyzz_0 = cbuffer.data(is_geom_11_off + 236 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_xxyyzz_0, g_z_z_xyyzz_0, g_z_z_xyyzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_xxyyzz_0[k] = -g_z_z_xyyzz_0[k] * ab_x + g_z_z_xyyzz_x[k];
            }

            /// Set up 237-238 components of targeted buffer : cbuffer.data(

            auto g_z_z_xxyzzz_0 = cbuffer.data(is_geom_11_off + 237 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_xxyzzz_0, g_z_z_xyzzz_0, g_z_z_xyzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_xxyzzz_0[k] = -g_z_z_xyzzz_0[k] * ab_x + g_z_z_xyzzz_x[k];
            }

            /// Set up 238-239 components of targeted buffer : cbuffer.data(

            auto g_z_z_xxzzzz_0 = cbuffer.data(is_geom_11_off + 238 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_xxzzzz_0, g_z_z_xzzzz_0, g_z_z_xzzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_xxzzzz_0[k] = -g_z_z_xzzzz_0[k] * ab_x + g_z_z_xzzzz_x[k];
            }

            /// Set up 239-240 components of targeted buffer : cbuffer.data(

            auto g_z_z_xyyyyy_0 = cbuffer.data(is_geom_11_off + 239 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_xyyyyy_0, g_z_z_yyyyy_0, g_z_z_yyyyy_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_xyyyyy_0[k] = -g_z_z_yyyyy_0[k] * ab_x + g_z_z_yyyyy_x[k];
            }

            /// Set up 240-241 components of targeted buffer : cbuffer.data(

            auto g_z_z_xyyyyz_0 = cbuffer.data(is_geom_11_off + 240 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_xyyyyz_0, g_z_z_yyyyz_0, g_z_z_yyyyz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_xyyyyz_0[k] = -g_z_z_yyyyz_0[k] * ab_x + g_z_z_yyyyz_x[k];
            }

            /// Set up 241-242 components of targeted buffer : cbuffer.data(

            auto g_z_z_xyyyzz_0 = cbuffer.data(is_geom_11_off + 241 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_xyyyzz_0, g_z_z_yyyzz_0, g_z_z_yyyzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_xyyyzz_0[k] = -g_z_z_yyyzz_0[k] * ab_x + g_z_z_yyyzz_x[k];
            }

            /// Set up 242-243 components of targeted buffer : cbuffer.data(

            auto g_z_z_xyyzzz_0 = cbuffer.data(is_geom_11_off + 242 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_xyyzzz_0, g_z_z_yyzzz_0, g_z_z_yyzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_xyyzzz_0[k] = -g_z_z_yyzzz_0[k] * ab_x + g_z_z_yyzzz_x[k];
            }

            /// Set up 243-244 components of targeted buffer : cbuffer.data(

            auto g_z_z_xyzzzz_0 = cbuffer.data(is_geom_11_off + 243 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_xyzzzz_0, g_z_z_yzzzz_0, g_z_z_yzzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_xyzzzz_0[k] = -g_z_z_yzzzz_0[k] * ab_x + g_z_z_yzzzz_x[k];
            }

            /// Set up 244-245 components of targeted buffer : cbuffer.data(

            auto g_z_z_xzzzzz_0 = cbuffer.data(is_geom_11_off + 244 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_xzzzzz_0, g_z_z_zzzzz_0, g_z_z_zzzzz_x  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_xzzzzz_0[k] = -g_z_z_zzzzz_0[k] * ab_x + g_z_z_zzzzz_x[k];
            }

            /// Set up 245-246 components of targeted buffer : cbuffer.data(

            auto g_z_z_yyyyyy_0 = cbuffer.data(is_geom_11_off + 245 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_yyyyy_0, g_z_z_yyyyy_y, g_z_z_yyyyyy_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_yyyyyy_0[k] = -g_z_z_yyyyy_0[k] * ab_y + g_z_z_yyyyy_y[k];
            }

            /// Set up 246-247 components of targeted buffer : cbuffer.data(

            auto g_z_z_yyyyyz_0 = cbuffer.data(is_geom_11_off + 246 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_yyyyyz_0, g_z_z_yyyyz_0, g_z_z_yyyyz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_yyyyyz_0[k] = -g_z_z_yyyyz_0[k] * ab_y + g_z_z_yyyyz_y[k];
            }

            /// Set up 247-248 components of targeted buffer : cbuffer.data(

            auto g_z_z_yyyyzz_0 = cbuffer.data(is_geom_11_off + 247 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_yyyyzz_0, g_z_z_yyyzz_0, g_z_z_yyyzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_yyyyzz_0[k] = -g_z_z_yyyzz_0[k] * ab_y + g_z_z_yyyzz_y[k];
            }

            /// Set up 248-249 components of targeted buffer : cbuffer.data(

            auto g_z_z_yyyzzz_0 = cbuffer.data(is_geom_11_off + 248 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_yyyzzz_0, g_z_z_yyzzz_0, g_z_z_yyzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_yyyzzz_0[k] = -g_z_z_yyzzz_0[k] * ab_y + g_z_z_yyzzz_y[k];
            }

            /// Set up 249-250 components of targeted buffer : cbuffer.data(

            auto g_z_z_yyzzzz_0 = cbuffer.data(is_geom_11_off + 249 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_yyzzzz_0, g_z_z_yzzzz_0, g_z_z_yzzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_yyzzzz_0[k] = -g_z_z_yzzzz_0[k] * ab_y + g_z_z_yzzzz_y[k];
            }

            /// Set up 250-251 components of targeted buffer : cbuffer.data(

            auto g_z_z_yzzzzz_0 = cbuffer.data(is_geom_11_off + 250 * ccomps * dcomps);

            #pragma omp simd aligned(g_z_z_yzzzzz_0, g_z_z_zzzzz_0, g_z_z_zzzzz_y  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_yzzzzz_0[k] = -g_z_z_zzzzz_0[k] * ab_y + g_z_z_zzzzz_y[k];
            }

            /// Set up 251-252 components of targeted buffer : cbuffer.data(

            auto g_z_z_zzzzzz_0 = cbuffer.data(is_geom_11_off + 251 * ccomps * dcomps);

            #pragma omp simd aligned(g_0_z_zzzzz_0, g_z_0_zzzzz_0, g_z_z_zzzzz_0, g_z_z_zzzzz_z, g_z_z_zzzzzz_0  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_zzzzzz_0[k] = -g_0_z_zzzzz_0[k] + g_z_0_zzzzz_0[k] - g_z_z_zzzzz_0[k] * ab_z + g_z_z_zzzzz_z[k];
            }
        }
    }
}
