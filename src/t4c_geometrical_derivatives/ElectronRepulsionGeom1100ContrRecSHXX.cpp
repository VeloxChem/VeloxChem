...
auto
comp_bra_geom11_hrr_electron_repulsion_shxx(CSimdArray<double>& cbuffer,
                                            ...
                                            const int d_angmom) -> void
{
    ...
    for (int i = 0; i < ccomps; i++)
    {
        for (int j = 0; j < dcomps; j++)
        {
            ...
            #pragma omp simd aligned(g_0_x_0_xxxxx, g_0_x_0_xxxxxx, g_0_x_0_xxxxxy, g_0_x_0_xxxxxz, g_0_x_0_xxxxy, g_0_x_0_xxxxyy, g_0_x_0_xxxxyz, g_0_x_0_xxxxz, g_0_x_0_xxxxzz, g_0_x_0_xxxyy, g_0_x_0_xxxyyy, g_0_x_0_xxxyyz, g_0_x_0_xxxyz, g_0_x_0_xxxyzz, g_0_x_0_xxxzz, g_0_x_0_xxxzzz, g_0_x_0_xxyyy, g_0_x_0_xxyyyy, g_0_x_0_xxyyyz, g_0_x_0_xxyyz, g_0_x_0_xxyyzz, g_0_x_0_xxyzz, g_0_x_0_xxyzzz, g_0_x_0_xxzzz, g_0_x_0_xxzzzz, g_0_x_0_xyyyy, g_0_x_0_xyyyyy, g_0_x_0_xyyyyz, g_0_x_0_xyyyz, g_0_x_0_xyyyzz, g_0_x_0_xyyzz, g_0_x_0_xyyzzz, g_0_x_0_xyzzz, g_0_x_0_xyzzzz, g_0_x_0_xzzzz, g_0_x_0_xzzzzz, g_0_x_0_yyyyy, g_0_x_0_yyyyz, g_0_x_0_yyyzz, g_0_x_0_yyzzz, g_0_x_0_yzzzz, g_0_x_0_zzzzz, g_0_xxxxx, g_0_xxxxy, g_0_xxxxz, g_0_xxxyy, g_0_xxxyz, g_0_xxxzz, g_0_xxyyy, g_0_xxyyz, g_0_xxyzz, g_0_xxzzz, g_0_xyyyy, g_0_xyyyz, g_0_xyyzz, g_0_xyzzz, g_0_xzzzz, g_0_yyyyy, g_0_yyyyz, g_0_yyyzz, g_0_yyzzz, g_0_yzzzz, g_0_zzzzz, g_x_x_0_xxxxx, g_x_x_0_xxxxy, g_x_x_0_xxxxz, g_x_x_0_xxxyy, g_x_x_0_xxxyz, g_x_x_0_xxxzz, g_x_x_0_xxyyy, g_x_x_0_xxyyz, g_x_x_0_xxyzz, g_x_x_0_xxzzz, g_x_x_0_xyyyy, g_x_x_0_xyyyz, g_x_x_0_xyyzz, g_x_x_0_xyzzz, g_x_x_0_xzzzz, g_x_x_0_yyyyy, g_x_x_0_yyyyz, g_x_x_0_yyyzz, g_x_x_0_yyzzz, g_x_x_0_yzzzz, g_x_x_0_zzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_x_0_xxxxx[k] = g_0_xxxxx[k] - g_0_x_0_xxxxx[k] * ab_x + g_0_x_0_xxxxxx[k];

                g_x_x_0_xxxxy[k] = g_0_xxxxy[k] - g_0_x_0_xxxxy[k] * ab_x + g_0_x_0_xxxxxy[k];

                g_x_x_0_xxxxz[k] = g_0_xxxxz[k] - g_0_x_0_xxxxz[k] * ab_x + g_0_x_0_xxxxxz[k];

                g_x_x_0_xxxyy[k] = g_0_xxxyy[k] - g_0_x_0_xxxyy[k] * ab_x + g_0_x_0_xxxxyy[k];

                g_x_x_0_xxxyz[k] = g_0_xxxyz[k] - g_0_x_0_xxxyz[k] * ab_x + g_0_x_0_xxxxyz[k];

                g_x_x_0_xxxzz[k] = g_0_xxxzz[k] - g_0_x_0_xxxzz[k] * ab_x + g_0_x_0_xxxxzz[k];

                g_x_x_0_xxyyy[k] = g_0_xxyyy[k] - g_0_x_0_xxyyy[k] * ab_x + g_0_x_0_xxxyyy[k];

                g_x_x_0_xxyyz[k] = g_0_xxyyz[k] - g_0_x_0_xxyyz[k] * ab_x + g_0_x_0_xxxyyz[k];

                g_x_x_0_xxyzz[k] = g_0_xxyzz[k] - g_0_x_0_xxyzz[k] * ab_x + g_0_x_0_xxxyzz[k];

                g_x_x_0_xxzzz[k] = g_0_xxzzz[k] - g_0_x_0_xxzzz[k] * ab_x + g_0_x_0_xxxzzz[k];

                g_x_x_0_xyyyy[k] = g_0_xyyyy[k] - g_0_x_0_xyyyy[k] * ab_x + g_0_x_0_xxyyyy[k];

                g_x_x_0_xyyyz[k] = g_0_xyyyz[k] - g_0_x_0_xyyyz[k] * ab_x + g_0_x_0_xxyyyz[k];

                g_x_x_0_xyyzz[k] = g_0_xyyzz[k] - g_0_x_0_xyyzz[k] * ab_x + g_0_x_0_xxyyzz[k];

                g_x_x_0_xyzzz[k] = g_0_xyzzz[k] - g_0_x_0_xyzzz[k] * ab_x + g_0_x_0_xxyzzz[k];

                g_x_x_0_xzzzz[k] = g_0_xzzzz[k] - g_0_x_0_xzzzz[k] * ab_x + g_0_x_0_xxzzzz[k];

                g_x_x_0_yyyyy[k] = g_0_yyyyy[k] - g_0_x_0_yyyyy[k] * ab_x + g_0_x_0_xyyyyy[k];

                g_x_x_0_yyyyz[k] = g_0_yyyyz[k] - g_0_x_0_yyyyz[k] * ab_x + g_0_x_0_xyyyyz[k];

                g_x_x_0_yyyzz[k] = g_0_yyyzz[k] - g_0_x_0_yyyzz[k] * ab_x + g_0_x_0_xyyyzz[k];

                g_x_x_0_yyzzz[k] = g_0_yyzzz[k] - g_0_x_0_yyzzz[k] * ab_x + g_0_x_0_xyyzzz[k];

                g_x_x_0_yzzzz[k] = g_0_yzzzz[k] - g_0_x_0_yzzzz[k] * ab_x + g_0_x_0_xyzzzz[k];

                g_x_x_0_zzzzz[k] = g_0_zzzzz[k] - g_0_x_0_zzzzz[k] * ab_x + g_0_x_0_xzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_y_0_xxxxx, g_0_y_0_xxxxxx, g_0_y_0_xxxxxy, g_0_y_0_xxxxxz, g_0_y_0_xxxxy, g_0_y_0_xxxxyy, g_0_y_0_xxxxyz, g_0_y_0_xxxxz, g_0_y_0_xxxxzz, g_0_y_0_xxxyy, g_0_y_0_xxxyyy, g_0_y_0_xxxyyz, g_0_y_0_xxxyz, g_0_y_0_xxxyzz, g_0_y_0_xxxzz, g_0_y_0_xxxzzz, g_0_y_0_xxyyy, g_0_y_0_xxyyyy, g_0_y_0_xxyyyz, g_0_y_0_xxyyz, g_0_y_0_xxyyzz, g_0_y_0_xxyzz, g_0_y_0_xxyzzz, g_0_y_0_xxzzz, g_0_y_0_xxzzzz, g_0_y_0_xyyyy, g_0_y_0_xyyyyy, g_0_y_0_xyyyyz, g_0_y_0_xyyyz, g_0_y_0_xyyyzz, g_0_y_0_xyyzz, g_0_y_0_xyyzzz, g_0_y_0_xyzzz, g_0_y_0_xyzzzz, g_0_y_0_xzzzz, g_0_y_0_xzzzzz, g_0_y_0_yyyyy, g_0_y_0_yyyyz, g_0_y_0_yyyzz, g_0_y_0_yyzzz, g_0_y_0_yzzzz, g_0_y_0_zzzzz, g_x_y_0_xxxxx, g_x_y_0_xxxxy, g_x_y_0_xxxxz, g_x_y_0_xxxyy, g_x_y_0_xxxyz, g_x_y_0_xxxzz, g_x_y_0_xxyyy, g_x_y_0_xxyyz, g_x_y_0_xxyzz, g_x_y_0_xxzzz, g_x_y_0_xyyyy, g_x_y_0_xyyyz, g_x_y_0_xyyzz, g_x_y_0_xyzzz, g_x_y_0_xzzzz, g_x_y_0_yyyyy, g_x_y_0_yyyyz, g_x_y_0_yyyzz, g_x_y_0_yyzzz, g_x_y_0_yzzzz, g_x_y_0_zzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_y_0_xxxxx[k] = -g_0_y_0_xxxxx[k] * ab_x + g_0_y_0_xxxxxx[k];

                g_x_y_0_xxxxy[k] = -g_0_y_0_xxxxy[k] * ab_x + g_0_y_0_xxxxxy[k];

                g_x_y_0_xxxxz[k] = -g_0_y_0_xxxxz[k] * ab_x + g_0_y_0_xxxxxz[k];

                g_x_y_0_xxxyy[k] = -g_0_y_0_xxxyy[k] * ab_x + g_0_y_0_xxxxyy[k];

                g_x_y_0_xxxyz[k] = -g_0_y_0_xxxyz[k] * ab_x + g_0_y_0_xxxxyz[k];

                g_x_y_0_xxxzz[k] = -g_0_y_0_xxxzz[k] * ab_x + g_0_y_0_xxxxzz[k];

                g_x_y_0_xxyyy[k] = -g_0_y_0_xxyyy[k] * ab_x + g_0_y_0_xxxyyy[k];

                g_x_y_0_xxyyz[k] = -g_0_y_0_xxyyz[k] * ab_x + g_0_y_0_xxxyyz[k];

                g_x_y_0_xxyzz[k] = -g_0_y_0_xxyzz[k] * ab_x + g_0_y_0_xxxyzz[k];

                g_x_y_0_xxzzz[k] = -g_0_y_0_xxzzz[k] * ab_x + g_0_y_0_xxxzzz[k];

                g_x_y_0_xyyyy[k] = -g_0_y_0_xyyyy[k] * ab_x + g_0_y_0_xxyyyy[k];

                g_x_y_0_xyyyz[k] = -g_0_y_0_xyyyz[k] * ab_x + g_0_y_0_xxyyyz[k];

                g_x_y_0_xyyzz[k] = -g_0_y_0_xyyzz[k] * ab_x + g_0_y_0_xxyyzz[k];

                g_x_y_0_xyzzz[k] = -g_0_y_0_xyzzz[k] * ab_x + g_0_y_0_xxyzzz[k];

                g_x_y_0_xzzzz[k] = -g_0_y_0_xzzzz[k] * ab_x + g_0_y_0_xxzzzz[k];

                g_x_y_0_yyyyy[k] = -g_0_y_0_yyyyy[k] * ab_x + g_0_y_0_xyyyyy[k];

                g_x_y_0_yyyyz[k] = -g_0_y_0_yyyyz[k] * ab_x + g_0_y_0_xyyyyz[k];

                g_x_y_0_yyyzz[k] = -g_0_y_0_yyyzz[k] * ab_x + g_0_y_0_xyyyzz[k];

                g_x_y_0_yyzzz[k] = -g_0_y_0_yyzzz[k] * ab_x + g_0_y_0_xyyzzz[k];

                g_x_y_0_yzzzz[k] = -g_0_y_0_yzzzz[k] * ab_x + g_0_y_0_xyzzzz[k];

                g_x_y_0_zzzzz[k] = -g_0_y_0_zzzzz[k] * ab_x + g_0_y_0_xzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_z_0_xxxxx, g_0_z_0_xxxxxx, g_0_z_0_xxxxxy, g_0_z_0_xxxxxz, g_0_z_0_xxxxy, g_0_z_0_xxxxyy, g_0_z_0_xxxxyz, g_0_z_0_xxxxz, g_0_z_0_xxxxzz, g_0_z_0_xxxyy, g_0_z_0_xxxyyy, g_0_z_0_xxxyyz, g_0_z_0_xxxyz, g_0_z_0_xxxyzz, g_0_z_0_xxxzz, g_0_z_0_xxxzzz, g_0_z_0_xxyyy, g_0_z_0_xxyyyy, g_0_z_0_xxyyyz, g_0_z_0_xxyyz, g_0_z_0_xxyyzz, g_0_z_0_xxyzz, g_0_z_0_xxyzzz, g_0_z_0_xxzzz, g_0_z_0_xxzzzz, g_0_z_0_xyyyy, g_0_z_0_xyyyyy, g_0_z_0_xyyyyz, g_0_z_0_xyyyz, g_0_z_0_xyyyzz, g_0_z_0_xyyzz, g_0_z_0_xyyzzz, g_0_z_0_xyzzz, g_0_z_0_xyzzzz, g_0_z_0_xzzzz, g_0_z_0_xzzzzz, g_0_z_0_yyyyy, g_0_z_0_yyyyz, g_0_z_0_yyyzz, g_0_z_0_yyzzz, g_0_z_0_yzzzz, g_0_z_0_zzzzz, g_x_z_0_xxxxx, g_x_z_0_xxxxy, g_x_z_0_xxxxz, g_x_z_0_xxxyy, g_x_z_0_xxxyz, g_x_z_0_xxxzz, g_x_z_0_xxyyy, g_x_z_0_xxyyz, g_x_z_0_xxyzz, g_x_z_0_xxzzz, g_x_z_0_xyyyy, g_x_z_0_xyyyz, g_x_z_0_xyyzz, g_x_z_0_xyzzz, g_x_z_0_xzzzz, g_x_z_0_yyyyy, g_x_z_0_yyyyz, g_x_z_0_yyyzz, g_x_z_0_yyzzz, g_x_z_0_yzzzz, g_x_z_0_zzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_z_0_xxxxx[k] = -g_0_z_0_xxxxx[k] * ab_x + g_0_z_0_xxxxxx[k];

                g_x_z_0_xxxxy[k] = -g_0_z_0_xxxxy[k] * ab_x + g_0_z_0_xxxxxy[k];

                g_x_z_0_xxxxz[k] = -g_0_z_0_xxxxz[k] * ab_x + g_0_z_0_xxxxxz[k];

                g_x_z_0_xxxyy[k] = -g_0_z_0_xxxyy[k] * ab_x + g_0_z_0_xxxxyy[k];

                g_x_z_0_xxxyz[k] = -g_0_z_0_xxxyz[k] * ab_x + g_0_z_0_xxxxyz[k];

                g_x_z_0_xxxzz[k] = -g_0_z_0_xxxzz[k] * ab_x + g_0_z_0_xxxxzz[k];

                g_x_z_0_xxyyy[k] = -g_0_z_0_xxyyy[k] * ab_x + g_0_z_0_xxxyyy[k];

                g_x_z_0_xxyyz[k] = -g_0_z_0_xxyyz[k] * ab_x + g_0_z_0_xxxyyz[k];

                g_x_z_0_xxyzz[k] = -g_0_z_0_xxyzz[k] * ab_x + g_0_z_0_xxxyzz[k];

                g_x_z_0_xxzzz[k] = -g_0_z_0_xxzzz[k] * ab_x + g_0_z_0_xxxzzz[k];

                g_x_z_0_xyyyy[k] = -g_0_z_0_xyyyy[k] * ab_x + g_0_z_0_xxyyyy[k];

                g_x_z_0_xyyyz[k] = -g_0_z_0_xyyyz[k] * ab_x + g_0_z_0_xxyyyz[k];

                g_x_z_0_xyyzz[k] = -g_0_z_0_xyyzz[k] * ab_x + g_0_z_0_xxyyzz[k];

                g_x_z_0_xyzzz[k] = -g_0_z_0_xyzzz[k] * ab_x + g_0_z_0_xxyzzz[k];

                g_x_z_0_xzzzz[k] = -g_0_z_0_xzzzz[k] * ab_x + g_0_z_0_xxzzzz[k];

                g_x_z_0_yyyyy[k] = -g_0_z_0_yyyyy[k] * ab_x + g_0_z_0_xyyyyy[k];

                g_x_z_0_yyyyz[k] = -g_0_z_0_yyyyz[k] * ab_x + g_0_z_0_xyyyyz[k];

                g_x_z_0_yyyzz[k] = -g_0_z_0_yyyzz[k] * ab_x + g_0_z_0_xyyyzz[k];

                g_x_z_0_yyzzz[k] = -g_0_z_0_yyzzz[k] * ab_x + g_0_z_0_xyyzzz[k];

                g_x_z_0_yzzzz[k] = -g_0_z_0_yzzzz[k] * ab_x + g_0_z_0_xyzzzz[k];

                g_x_z_0_zzzzz[k] = -g_0_z_0_zzzzz[k] * ab_x + g_0_z_0_xzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_x_0_xxxxx, g_0_x_0_xxxxxy, g_0_x_0_xxxxy, g_0_x_0_xxxxyy, g_0_x_0_xxxxyz, g_0_x_0_xxxxz, g_0_x_0_xxxyy, g_0_x_0_xxxyyy, g_0_x_0_xxxyyz, g_0_x_0_xxxyz, g_0_x_0_xxxyzz, g_0_x_0_xxxzz, g_0_x_0_xxyyy, g_0_x_0_xxyyyy, g_0_x_0_xxyyyz, g_0_x_0_xxyyz, g_0_x_0_xxyyzz, g_0_x_0_xxyzz, g_0_x_0_xxyzzz, g_0_x_0_xxzzz, g_0_x_0_xyyyy, g_0_x_0_xyyyyy, g_0_x_0_xyyyyz, g_0_x_0_xyyyz, g_0_x_0_xyyyzz, g_0_x_0_xyyzz, g_0_x_0_xyyzzz, g_0_x_0_xyzzz, g_0_x_0_xyzzzz, g_0_x_0_xzzzz, g_0_x_0_yyyyy, g_0_x_0_yyyyyy, g_0_x_0_yyyyyz, g_0_x_0_yyyyz, g_0_x_0_yyyyzz, g_0_x_0_yyyzz, g_0_x_0_yyyzzz, g_0_x_0_yyzzz, g_0_x_0_yyzzzz, g_0_x_0_yzzzz, g_0_x_0_yzzzzz, g_0_x_0_zzzzz, g_y_x_0_xxxxx, g_y_x_0_xxxxy, g_y_x_0_xxxxz, g_y_x_0_xxxyy, g_y_x_0_xxxyz, g_y_x_0_xxxzz, g_y_x_0_xxyyy, g_y_x_0_xxyyz, g_y_x_0_xxyzz, g_y_x_0_xxzzz, g_y_x_0_xyyyy, g_y_x_0_xyyyz, g_y_x_0_xyyzz, g_y_x_0_xyzzz, g_y_x_0_xzzzz, g_y_x_0_yyyyy, g_y_x_0_yyyyz, g_y_x_0_yyyzz, g_y_x_0_yyzzz, g_y_x_0_yzzzz, g_y_x_0_zzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_x_0_xxxxx[k] = -g_0_x_0_xxxxx[k] * ab_y + g_0_x_0_xxxxxy[k];

                g_y_x_0_xxxxy[k] = -g_0_x_0_xxxxy[k] * ab_y + g_0_x_0_xxxxyy[k];

                g_y_x_0_xxxxz[k] = -g_0_x_0_xxxxz[k] * ab_y + g_0_x_0_xxxxyz[k];

                g_y_x_0_xxxyy[k] = -g_0_x_0_xxxyy[k] * ab_y + g_0_x_0_xxxyyy[k];

                g_y_x_0_xxxyz[k] = -g_0_x_0_xxxyz[k] * ab_y + g_0_x_0_xxxyyz[k];

                g_y_x_0_xxxzz[k] = -g_0_x_0_xxxzz[k] * ab_y + g_0_x_0_xxxyzz[k];

                g_y_x_0_xxyyy[k] = -g_0_x_0_xxyyy[k] * ab_y + g_0_x_0_xxyyyy[k];

                g_y_x_0_xxyyz[k] = -g_0_x_0_xxyyz[k] * ab_y + g_0_x_0_xxyyyz[k];

                g_y_x_0_xxyzz[k] = -g_0_x_0_xxyzz[k] * ab_y + g_0_x_0_xxyyzz[k];

                g_y_x_0_xxzzz[k] = -g_0_x_0_xxzzz[k] * ab_y + g_0_x_0_xxyzzz[k];

                g_y_x_0_xyyyy[k] = -g_0_x_0_xyyyy[k] * ab_y + g_0_x_0_xyyyyy[k];

                g_y_x_0_xyyyz[k] = -g_0_x_0_xyyyz[k] * ab_y + g_0_x_0_xyyyyz[k];

                g_y_x_0_xyyzz[k] = -g_0_x_0_xyyzz[k] * ab_y + g_0_x_0_xyyyzz[k];

                g_y_x_0_xyzzz[k] = -g_0_x_0_xyzzz[k] * ab_y + g_0_x_0_xyyzzz[k];

                g_y_x_0_xzzzz[k] = -g_0_x_0_xzzzz[k] * ab_y + g_0_x_0_xyzzzz[k];

                g_y_x_0_yyyyy[k] = -g_0_x_0_yyyyy[k] * ab_y + g_0_x_0_yyyyyy[k];

                g_y_x_0_yyyyz[k] = -g_0_x_0_yyyyz[k] * ab_y + g_0_x_0_yyyyyz[k];

                g_y_x_0_yyyzz[k] = -g_0_x_0_yyyzz[k] * ab_y + g_0_x_0_yyyyzz[k];

                g_y_x_0_yyzzz[k] = -g_0_x_0_yyzzz[k] * ab_y + g_0_x_0_yyyzzz[k];

                g_y_x_0_yzzzz[k] = -g_0_x_0_yzzzz[k] * ab_y + g_0_x_0_yyzzzz[k];

                g_y_x_0_zzzzz[k] = -g_0_x_0_zzzzz[k] * ab_y + g_0_x_0_yzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_xxxxx, g_0_xxxxy, g_0_xxxxz, g_0_xxxyy, g_0_xxxyz, g_0_xxxzz, g_0_xxyyy, g_0_xxyyz, g_0_xxyzz, g_0_xxzzz, g_0_xyyyy, g_0_xyyyz, g_0_xyyzz, g_0_xyzzz, g_0_xzzzz, g_0_y_0_xxxxx, g_0_y_0_xxxxxy, g_0_y_0_xxxxy, g_0_y_0_xxxxyy, g_0_y_0_xxxxyz, g_0_y_0_xxxxz, g_0_y_0_xxxyy, g_0_y_0_xxxyyy, g_0_y_0_xxxyyz, g_0_y_0_xxxyz, g_0_y_0_xxxyzz, g_0_y_0_xxxzz, g_0_y_0_xxyyy, g_0_y_0_xxyyyy, g_0_y_0_xxyyyz, g_0_y_0_xxyyz, g_0_y_0_xxyyzz, g_0_y_0_xxyzz, g_0_y_0_xxyzzz, g_0_y_0_xxzzz, g_0_y_0_xyyyy, g_0_y_0_xyyyyy, g_0_y_0_xyyyyz, g_0_y_0_xyyyz, g_0_y_0_xyyyzz, g_0_y_0_xyyzz, g_0_y_0_xyyzzz, g_0_y_0_xyzzz, g_0_y_0_xyzzzz, g_0_y_0_xzzzz, g_0_y_0_yyyyy, g_0_y_0_yyyyyy, g_0_y_0_yyyyyz, g_0_y_0_yyyyz, g_0_y_0_yyyyzz, g_0_y_0_yyyzz, g_0_y_0_yyyzzz, g_0_y_0_yyzzz, g_0_y_0_yyzzzz, g_0_y_0_yzzzz, g_0_y_0_yzzzzz, g_0_y_0_zzzzz, g_0_yyyyy, g_0_yyyyz, g_0_yyyzz, g_0_yyzzz, g_0_yzzzz, g_0_zzzzz, g_y_y_0_xxxxx, g_y_y_0_xxxxy, g_y_y_0_xxxxz, g_y_y_0_xxxyy, g_y_y_0_xxxyz, g_y_y_0_xxxzz, g_y_y_0_xxyyy, g_y_y_0_xxyyz, g_y_y_0_xxyzz, g_y_y_0_xxzzz, g_y_y_0_xyyyy, g_y_y_0_xyyyz, g_y_y_0_xyyzz, g_y_y_0_xyzzz, g_y_y_0_xzzzz, g_y_y_0_yyyyy, g_y_y_0_yyyyz, g_y_y_0_yyyzz, g_y_y_0_yyzzz, g_y_y_0_yzzzz, g_y_y_0_zzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_y_0_xxxxx[k] = g_0_xxxxx[k] - g_0_y_0_xxxxx[k] * ab_y + g_0_y_0_xxxxxy[k];

                g_y_y_0_xxxxy[k] = g_0_xxxxy[k] - g_0_y_0_xxxxy[k] * ab_y + g_0_y_0_xxxxyy[k];

                g_y_y_0_xxxxz[k] = g_0_xxxxz[k] - g_0_y_0_xxxxz[k] * ab_y + g_0_y_0_xxxxyz[k];

                g_y_y_0_xxxyy[k] = g_0_xxxyy[k] - g_0_y_0_xxxyy[k] * ab_y + g_0_y_0_xxxyyy[k];

                g_y_y_0_xxxyz[k] = g_0_xxxyz[k] - g_0_y_0_xxxyz[k] * ab_y + g_0_y_0_xxxyyz[k];

                g_y_y_0_xxxzz[k] = g_0_xxxzz[k] - g_0_y_0_xxxzz[k] * ab_y + g_0_y_0_xxxyzz[k];

                g_y_y_0_xxyyy[k] = g_0_xxyyy[k] - g_0_y_0_xxyyy[k] * ab_y + g_0_y_0_xxyyyy[k];

                g_y_y_0_xxyyz[k] = g_0_xxyyz[k] - g_0_y_0_xxyyz[k] * ab_y + g_0_y_0_xxyyyz[k];

                g_y_y_0_xxyzz[k] = g_0_xxyzz[k] - g_0_y_0_xxyzz[k] * ab_y + g_0_y_0_xxyyzz[k];

                g_y_y_0_xxzzz[k] = g_0_xxzzz[k] - g_0_y_0_xxzzz[k] * ab_y + g_0_y_0_xxyzzz[k];

                g_y_y_0_xyyyy[k] = g_0_xyyyy[k] - g_0_y_0_xyyyy[k] * ab_y + g_0_y_0_xyyyyy[k];

                g_y_y_0_xyyyz[k] = g_0_xyyyz[k] - g_0_y_0_xyyyz[k] * ab_y + g_0_y_0_xyyyyz[k];

                g_y_y_0_xyyzz[k] = g_0_xyyzz[k] - g_0_y_0_xyyzz[k] * ab_y + g_0_y_0_xyyyzz[k];

                g_y_y_0_xyzzz[k] = g_0_xyzzz[k] - g_0_y_0_xyzzz[k] * ab_y + g_0_y_0_xyyzzz[k];

                g_y_y_0_xzzzz[k] = g_0_xzzzz[k] - g_0_y_0_xzzzz[k] * ab_y + g_0_y_0_xyzzzz[k];

                g_y_y_0_yyyyy[k] = g_0_yyyyy[k] - g_0_y_0_yyyyy[k] * ab_y + g_0_y_0_yyyyyy[k];

                g_y_y_0_yyyyz[k] = g_0_yyyyz[k] - g_0_y_0_yyyyz[k] * ab_y + g_0_y_0_yyyyyz[k];

                g_y_y_0_yyyzz[k] = g_0_yyyzz[k] - g_0_y_0_yyyzz[k] * ab_y + g_0_y_0_yyyyzz[k];

                g_y_y_0_yyzzz[k] = g_0_yyzzz[k] - g_0_y_0_yyzzz[k] * ab_y + g_0_y_0_yyyzzz[k];

                g_y_y_0_yzzzz[k] = g_0_yzzzz[k] - g_0_y_0_yzzzz[k] * ab_y + g_0_y_0_yyzzzz[k];

                g_y_y_0_zzzzz[k] = g_0_zzzzz[k] - g_0_y_0_zzzzz[k] * ab_y + g_0_y_0_yzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_z_0_xxxxx, g_0_z_0_xxxxxy, g_0_z_0_xxxxy, g_0_z_0_xxxxyy, g_0_z_0_xxxxyz, g_0_z_0_xxxxz, g_0_z_0_xxxyy, g_0_z_0_xxxyyy, g_0_z_0_xxxyyz, g_0_z_0_xxxyz, g_0_z_0_xxxyzz, g_0_z_0_xxxzz, g_0_z_0_xxyyy, g_0_z_0_xxyyyy, g_0_z_0_xxyyyz, g_0_z_0_xxyyz, g_0_z_0_xxyyzz, g_0_z_0_xxyzz, g_0_z_0_xxyzzz, g_0_z_0_xxzzz, g_0_z_0_xyyyy, g_0_z_0_xyyyyy, g_0_z_0_xyyyyz, g_0_z_0_xyyyz, g_0_z_0_xyyyzz, g_0_z_0_xyyzz, g_0_z_0_xyyzzz, g_0_z_0_xyzzz, g_0_z_0_xyzzzz, g_0_z_0_xzzzz, g_0_z_0_yyyyy, g_0_z_0_yyyyyy, g_0_z_0_yyyyyz, g_0_z_0_yyyyz, g_0_z_0_yyyyzz, g_0_z_0_yyyzz, g_0_z_0_yyyzzz, g_0_z_0_yyzzz, g_0_z_0_yyzzzz, g_0_z_0_yzzzz, g_0_z_0_yzzzzz, g_0_z_0_zzzzz, g_y_z_0_xxxxx, g_y_z_0_xxxxy, g_y_z_0_xxxxz, g_y_z_0_xxxyy, g_y_z_0_xxxyz, g_y_z_0_xxxzz, g_y_z_0_xxyyy, g_y_z_0_xxyyz, g_y_z_0_xxyzz, g_y_z_0_xxzzz, g_y_z_0_xyyyy, g_y_z_0_xyyyz, g_y_z_0_xyyzz, g_y_z_0_xyzzz, g_y_z_0_xzzzz, g_y_z_0_yyyyy, g_y_z_0_yyyyz, g_y_z_0_yyyzz, g_y_z_0_yyzzz, g_y_z_0_yzzzz, g_y_z_0_zzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_z_0_xxxxx[k] = -g_0_z_0_xxxxx[k] * ab_y + g_0_z_0_xxxxxy[k];

                g_y_z_0_xxxxy[k] = -g_0_z_0_xxxxy[k] * ab_y + g_0_z_0_xxxxyy[k];

                g_y_z_0_xxxxz[k] = -g_0_z_0_xxxxz[k] * ab_y + g_0_z_0_xxxxyz[k];

                g_y_z_0_xxxyy[k] = -g_0_z_0_xxxyy[k] * ab_y + g_0_z_0_xxxyyy[k];

                g_y_z_0_xxxyz[k] = -g_0_z_0_xxxyz[k] * ab_y + g_0_z_0_xxxyyz[k];

                g_y_z_0_xxxzz[k] = -g_0_z_0_xxxzz[k] * ab_y + g_0_z_0_xxxyzz[k];

                g_y_z_0_xxyyy[k] = -g_0_z_0_xxyyy[k] * ab_y + g_0_z_0_xxyyyy[k];

                g_y_z_0_xxyyz[k] = -g_0_z_0_xxyyz[k] * ab_y + g_0_z_0_xxyyyz[k];

                g_y_z_0_xxyzz[k] = -g_0_z_0_xxyzz[k] * ab_y + g_0_z_0_xxyyzz[k];

                g_y_z_0_xxzzz[k] = -g_0_z_0_xxzzz[k] * ab_y + g_0_z_0_xxyzzz[k];

                g_y_z_0_xyyyy[k] = -g_0_z_0_xyyyy[k] * ab_y + g_0_z_0_xyyyyy[k];

                g_y_z_0_xyyyz[k] = -g_0_z_0_xyyyz[k] * ab_y + g_0_z_0_xyyyyz[k];

                g_y_z_0_xyyzz[k] = -g_0_z_0_xyyzz[k] * ab_y + g_0_z_0_xyyyzz[k];

                g_y_z_0_xyzzz[k] = -g_0_z_0_xyzzz[k] * ab_y + g_0_z_0_xyyzzz[k];

                g_y_z_0_xzzzz[k] = -g_0_z_0_xzzzz[k] * ab_y + g_0_z_0_xyzzzz[k];

                g_y_z_0_yyyyy[k] = -g_0_z_0_yyyyy[k] * ab_y + g_0_z_0_yyyyyy[k];

                g_y_z_0_yyyyz[k] = -g_0_z_0_yyyyz[k] * ab_y + g_0_z_0_yyyyyz[k];

                g_y_z_0_yyyzz[k] = -g_0_z_0_yyyzz[k] * ab_y + g_0_z_0_yyyyzz[k];

                g_y_z_0_yyzzz[k] = -g_0_z_0_yyzzz[k] * ab_y + g_0_z_0_yyyzzz[k];

                g_y_z_0_yzzzz[k] = -g_0_z_0_yzzzz[k] * ab_y + g_0_z_0_yyzzzz[k];

                g_y_z_0_zzzzz[k] = -g_0_z_0_zzzzz[k] * ab_y + g_0_z_0_yzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_x_0_xxxxx, g_0_x_0_xxxxxz, g_0_x_0_xxxxy, g_0_x_0_xxxxyz, g_0_x_0_xxxxz, g_0_x_0_xxxxzz, g_0_x_0_xxxyy, g_0_x_0_xxxyyz, g_0_x_0_xxxyz, g_0_x_0_xxxyzz, g_0_x_0_xxxzz, g_0_x_0_xxxzzz, g_0_x_0_xxyyy, g_0_x_0_xxyyyz, g_0_x_0_xxyyz, g_0_x_0_xxyyzz, g_0_x_0_xxyzz, g_0_x_0_xxyzzz, g_0_x_0_xxzzz, g_0_x_0_xxzzzz, g_0_x_0_xyyyy, g_0_x_0_xyyyyz, g_0_x_0_xyyyz, g_0_x_0_xyyyzz, g_0_x_0_xyyzz, g_0_x_0_xyyzzz, g_0_x_0_xyzzz, g_0_x_0_xyzzzz, g_0_x_0_xzzzz, g_0_x_0_xzzzzz, g_0_x_0_yyyyy, g_0_x_0_yyyyyz, g_0_x_0_yyyyz, g_0_x_0_yyyyzz, g_0_x_0_yyyzz, g_0_x_0_yyyzzz, g_0_x_0_yyzzz, g_0_x_0_yyzzzz, g_0_x_0_yzzzz, g_0_x_0_yzzzzz, g_0_x_0_zzzzz, g_0_x_0_zzzzzz, g_z_x_0_xxxxx, g_z_x_0_xxxxy, g_z_x_0_xxxxz, g_z_x_0_xxxyy, g_z_x_0_xxxyz, g_z_x_0_xxxzz, g_z_x_0_xxyyy, g_z_x_0_xxyyz, g_z_x_0_xxyzz, g_z_x_0_xxzzz, g_z_x_0_xyyyy, g_z_x_0_xyyyz, g_z_x_0_xyyzz, g_z_x_0_xyzzz, g_z_x_0_xzzzz, g_z_x_0_yyyyy, g_z_x_0_yyyyz, g_z_x_0_yyyzz, g_z_x_0_yyzzz, g_z_x_0_yzzzz, g_z_x_0_zzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_x_0_xxxxx[k] = -g_0_x_0_xxxxx[k] * ab_z + g_0_x_0_xxxxxz[k];

                g_z_x_0_xxxxy[k] = -g_0_x_0_xxxxy[k] * ab_z + g_0_x_0_xxxxyz[k];

                g_z_x_0_xxxxz[k] = -g_0_x_0_xxxxz[k] * ab_z + g_0_x_0_xxxxzz[k];

                g_z_x_0_xxxyy[k] = -g_0_x_0_xxxyy[k] * ab_z + g_0_x_0_xxxyyz[k];

                g_z_x_0_xxxyz[k] = -g_0_x_0_xxxyz[k] * ab_z + g_0_x_0_xxxyzz[k];

                g_z_x_0_xxxzz[k] = -g_0_x_0_xxxzz[k] * ab_z + g_0_x_0_xxxzzz[k];

                g_z_x_0_xxyyy[k] = -g_0_x_0_xxyyy[k] * ab_z + g_0_x_0_xxyyyz[k];

                g_z_x_0_xxyyz[k] = -g_0_x_0_xxyyz[k] * ab_z + g_0_x_0_xxyyzz[k];

                g_z_x_0_xxyzz[k] = -g_0_x_0_xxyzz[k] * ab_z + g_0_x_0_xxyzzz[k];

                g_z_x_0_xxzzz[k] = -g_0_x_0_xxzzz[k] * ab_z + g_0_x_0_xxzzzz[k];

                g_z_x_0_xyyyy[k] = -g_0_x_0_xyyyy[k] * ab_z + g_0_x_0_xyyyyz[k];

                g_z_x_0_xyyyz[k] = -g_0_x_0_xyyyz[k] * ab_z + g_0_x_0_xyyyzz[k];

                g_z_x_0_xyyzz[k] = -g_0_x_0_xyyzz[k] * ab_z + g_0_x_0_xyyzzz[k];

                g_z_x_0_xyzzz[k] = -g_0_x_0_xyzzz[k] * ab_z + g_0_x_0_xyzzzz[k];

                g_z_x_0_xzzzz[k] = -g_0_x_0_xzzzz[k] * ab_z + g_0_x_0_xzzzzz[k];

                g_z_x_0_yyyyy[k] = -g_0_x_0_yyyyy[k] * ab_z + g_0_x_0_yyyyyz[k];

                g_z_x_0_yyyyz[k] = -g_0_x_0_yyyyz[k] * ab_z + g_0_x_0_yyyyzz[k];

                g_z_x_0_yyyzz[k] = -g_0_x_0_yyyzz[k] * ab_z + g_0_x_0_yyyzzz[k];

                g_z_x_0_yyzzz[k] = -g_0_x_0_yyzzz[k] * ab_z + g_0_x_0_yyzzzz[k];

                g_z_x_0_yzzzz[k] = -g_0_x_0_yzzzz[k] * ab_z + g_0_x_0_yzzzzz[k];

                g_z_x_0_zzzzz[k] = -g_0_x_0_zzzzz[k] * ab_z + g_0_x_0_zzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_y_0_xxxxx, g_0_y_0_xxxxxz, g_0_y_0_xxxxy, g_0_y_0_xxxxyz, g_0_y_0_xxxxz, g_0_y_0_xxxxzz, g_0_y_0_xxxyy, g_0_y_0_xxxyyz, g_0_y_0_xxxyz, g_0_y_0_xxxyzz, g_0_y_0_xxxzz, g_0_y_0_xxxzzz, g_0_y_0_xxyyy, g_0_y_0_xxyyyz, g_0_y_0_xxyyz, g_0_y_0_xxyyzz, g_0_y_0_xxyzz, g_0_y_0_xxyzzz, g_0_y_0_xxzzz, g_0_y_0_xxzzzz, g_0_y_0_xyyyy, g_0_y_0_xyyyyz, g_0_y_0_xyyyz, g_0_y_0_xyyyzz, g_0_y_0_xyyzz, g_0_y_0_xyyzzz, g_0_y_0_xyzzz, g_0_y_0_xyzzzz, g_0_y_0_xzzzz, g_0_y_0_xzzzzz, g_0_y_0_yyyyy, g_0_y_0_yyyyyz, g_0_y_0_yyyyz, g_0_y_0_yyyyzz, g_0_y_0_yyyzz, g_0_y_0_yyyzzz, g_0_y_0_yyzzz, g_0_y_0_yyzzzz, g_0_y_0_yzzzz, g_0_y_0_yzzzzz, g_0_y_0_zzzzz, g_0_y_0_zzzzzz, g_z_y_0_xxxxx, g_z_y_0_xxxxy, g_z_y_0_xxxxz, g_z_y_0_xxxyy, g_z_y_0_xxxyz, g_z_y_0_xxxzz, g_z_y_0_xxyyy, g_z_y_0_xxyyz, g_z_y_0_xxyzz, g_z_y_0_xxzzz, g_z_y_0_xyyyy, g_z_y_0_xyyyz, g_z_y_0_xyyzz, g_z_y_0_xyzzz, g_z_y_0_xzzzz, g_z_y_0_yyyyy, g_z_y_0_yyyyz, g_z_y_0_yyyzz, g_z_y_0_yyzzz, g_z_y_0_yzzzz, g_z_y_0_zzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_y_0_xxxxx[k] = -g_0_y_0_xxxxx[k] * ab_z + g_0_y_0_xxxxxz[k];

                g_z_y_0_xxxxy[k] = -g_0_y_0_xxxxy[k] * ab_z + g_0_y_0_xxxxyz[k];

                g_z_y_0_xxxxz[k] = -g_0_y_0_xxxxz[k] * ab_z + g_0_y_0_xxxxzz[k];

                g_z_y_0_xxxyy[k] = -g_0_y_0_xxxyy[k] * ab_z + g_0_y_0_xxxyyz[k];

                g_z_y_0_xxxyz[k] = -g_0_y_0_xxxyz[k] * ab_z + g_0_y_0_xxxyzz[k];

                g_z_y_0_xxxzz[k] = -g_0_y_0_xxxzz[k] * ab_z + g_0_y_0_xxxzzz[k];

                g_z_y_0_xxyyy[k] = -g_0_y_0_xxyyy[k] * ab_z + g_0_y_0_xxyyyz[k];

                g_z_y_0_xxyyz[k] = -g_0_y_0_xxyyz[k] * ab_z + g_0_y_0_xxyyzz[k];

                g_z_y_0_xxyzz[k] = -g_0_y_0_xxyzz[k] * ab_z + g_0_y_0_xxyzzz[k];

                g_z_y_0_xxzzz[k] = -g_0_y_0_xxzzz[k] * ab_z + g_0_y_0_xxzzzz[k];

                g_z_y_0_xyyyy[k] = -g_0_y_0_xyyyy[k] * ab_z + g_0_y_0_xyyyyz[k];

                g_z_y_0_xyyyz[k] = -g_0_y_0_xyyyz[k] * ab_z + g_0_y_0_xyyyzz[k];

                g_z_y_0_xyyzz[k] = -g_0_y_0_xyyzz[k] * ab_z + g_0_y_0_xyyzzz[k];

                g_z_y_0_xyzzz[k] = -g_0_y_0_xyzzz[k] * ab_z + g_0_y_0_xyzzzz[k];

                g_z_y_0_xzzzz[k] = -g_0_y_0_xzzzz[k] * ab_z + g_0_y_0_xzzzzz[k];

                g_z_y_0_yyyyy[k] = -g_0_y_0_yyyyy[k] * ab_z + g_0_y_0_yyyyyz[k];

                g_z_y_0_yyyyz[k] = -g_0_y_0_yyyyz[k] * ab_z + g_0_y_0_yyyyzz[k];

                g_z_y_0_yyyzz[k] = -g_0_y_0_yyyzz[k] * ab_z + g_0_y_0_yyyzzz[k];

                g_z_y_0_yyzzz[k] = -g_0_y_0_yyzzz[k] * ab_z + g_0_y_0_yyzzzz[k];

                g_z_y_0_yzzzz[k] = -g_0_y_0_yzzzz[k] * ab_z + g_0_y_0_yzzzzz[k];

                g_z_y_0_zzzzz[k] = -g_0_y_0_zzzzz[k] * ab_z + g_0_y_0_zzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_xxxxx, g_0_xxxxy, g_0_xxxxz, g_0_xxxyy, g_0_xxxyz, g_0_xxxzz, g_0_xxyyy, g_0_xxyyz, g_0_xxyzz, g_0_xxzzz, g_0_xyyyy, g_0_xyyyz, g_0_xyyzz, g_0_xyzzz, g_0_xzzzz, g_0_yyyyy, g_0_yyyyz, g_0_yyyzz, g_0_yyzzz, g_0_yzzzz, g_0_z_0_xxxxx, g_0_z_0_xxxxxz, g_0_z_0_xxxxy, g_0_z_0_xxxxyz, g_0_z_0_xxxxz, g_0_z_0_xxxxzz, g_0_z_0_xxxyy, g_0_z_0_xxxyyz, g_0_z_0_xxxyz, g_0_z_0_xxxyzz, g_0_z_0_xxxzz, g_0_z_0_xxxzzz, g_0_z_0_xxyyy, g_0_z_0_xxyyyz, g_0_z_0_xxyyz, g_0_z_0_xxyyzz, g_0_z_0_xxyzz, g_0_z_0_xxyzzz, g_0_z_0_xxzzz, g_0_z_0_xxzzzz, g_0_z_0_xyyyy, g_0_z_0_xyyyyz, g_0_z_0_xyyyz, g_0_z_0_xyyyzz, g_0_z_0_xyyzz, g_0_z_0_xyyzzz, g_0_z_0_xyzzz, g_0_z_0_xyzzzz, g_0_z_0_xzzzz, g_0_z_0_xzzzzz, g_0_z_0_yyyyy, g_0_z_0_yyyyyz, g_0_z_0_yyyyz, g_0_z_0_yyyyzz, g_0_z_0_yyyzz, g_0_z_0_yyyzzz, g_0_z_0_yyzzz, g_0_z_0_yyzzzz, g_0_z_0_yzzzz, g_0_z_0_yzzzzz, g_0_z_0_zzzzz, g_0_z_0_zzzzzz, g_0_zzzzz, g_z_z_0_xxxxx, g_z_z_0_xxxxy, g_z_z_0_xxxxz, g_z_z_0_xxxyy, g_z_z_0_xxxyz, g_z_z_0_xxxzz, g_z_z_0_xxyyy, g_z_z_0_xxyyz, g_z_z_0_xxyzz, g_z_z_0_xxzzz, g_z_z_0_xyyyy, g_z_z_0_xyyyz, g_z_z_0_xyyzz, g_z_z_0_xyzzz, g_z_z_0_xzzzz, g_z_z_0_yyyyy, g_z_z_0_yyyyz, g_z_z_0_yyyzz, g_z_z_0_yyzzz, g_z_z_0_yzzzz, g_z_z_0_zzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_z_0_xxxxx[k] = g_0_xxxxx[k] - g_0_z_0_xxxxx[k] * ab_z + g_0_z_0_xxxxxz[k];

                g_z_z_0_xxxxy[k] = g_0_xxxxy[k] - g_0_z_0_xxxxy[k] * ab_z + g_0_z_0_xxxxyz[k];

                g_z_z_0_xxxxz[k] = g_0_xxxxz[k] - g_0_z_0_xxxxz[k] * ab_z + g_0_z_0_xxxxzz[k];

                g_z_z_0_xxxyy[k] = g_0_xxxyy[k] - g_0_z_0_xxxyy[k] * ab_z + g_0_z_0_xxxyyz[k];

                g_z_z_0_xxxyz[k] = g_0_xxxyz[k] - g_0_z_0_xxxyz[k] * ab_z + g_0_z_0_xxxyzz[k];

                g_z_z_0_xxxzz[k] = g_0_xxxzz[k] - g_0_z_0_xxxzz[k] * ab_z + g_0_z_0_xxxzzz[k];

                g_z_z_0_xxyyy[k] = g_0_xxyyy[k] - g_0_z_0_xxyyy[k] * ab_z + g_0_z_0_xxyyyz[k];

                g_z_z_0_xxyyz[k] = g_0_xxyyz[k] - g_0_z_0_xxyyz[k] * ab_z + g_0_z_0_xxyyzz[k];

                g_z_z_0_xxyzz[k] = g_0_xxyzz[k] - g_0_z_0_xxyzz[k] * ab_z + g_0_z_0_xxyzzz[k];

                g_z_z_0_xxzzz[k] = g_0_xxzzz[k] - g_0_z_0_xxzzz[k] * ab_z + g_0_z_0_xxzzzz[k];

                g_z_z_0_xyyyy[k] = g_0_xyyyy[k] - g_0_z_0_xyyyy[k] * ab_z + g_0_z_0_xyyyyz[k];

                g_z_z_0_xyyyz[k] = g_0_xyyyz[k] - g_0_z_0_xyyyz[k] * ab_z + g_0_z_0_xyyyzz[k];

                g_z_z_0_xyyzz[k] = g_0_xyyzz[k] - g_0_z_0_xyyzz[k] * ab_z + g_0_z_0_xyyzzz[k];

                g_z_z_0_xyzzz[k] = g_0_xyzzz[k] - g_0_z_0_xyzzz[k] * ab_z + g_0_z_0_xyzzzz[k];

                g_z_z_0_xzzzz[k] = g_0_xzzzz[k] - g_0_z_0_xzzzz[k] * ab_z + g_0_z_0_xzzzzz[k];

                g_z_z_0_yyyyy[k] = g_0_yyyyy[k] - g_0_z_0_yyyyy[k] * ab_z + g_0_z_0_yyyyyz[k];

                g_z_z_0_yyyyz[k] = g_0_yyyyz[k] - g_0_z_0_yyyyz[k] * ab_z + g_0_z_0_yyyyzz[k];

                g_z_z_0_yyyzz[k] = g_0_yyyzz[k] - g_0_z_0_yyyzz[k] * ab_z + g_0_z_0_yyyzzz[k];

                g_z_z_0_yyzzz[k] = g_0_yyzzz[k] - g_0_z_0_yyzzz[k] * ab_z + g_0_z_0_yyzzzz[k];

                g_z_z_0_yzzzz[k] = g_0_yzzzz[k] - g_0_z_0_yzzzz[k] * ab_z + g_0_z_0_yzzzzz[k];

                g_z_z_0_zzzzz[k] = g_0_zzzzz[k] - g_0_z_0_zzzzz[k] * ab_z + g_0_z_0_zzzzzz[k];
            }
        }
    }
}
