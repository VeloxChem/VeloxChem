#ifndef ElectronRepulsionGeom2000ContrRecIFXX_hpp
#define ElectronRepulsionGeom2000ContrRecIFXX_hpp
...
/// @param idx_geom_20_ifxx The contracted integrals buffer.
...
auto
comp_bra_geom20_hrr_electron_repulsion_ifxx(CSimdArray<double>& cbuffer,
                                            const size_t idx_geom_20_ifxx,
...
#endif /* ElectronRepulsionGeom2000ContrRecIFXX_hpp */
