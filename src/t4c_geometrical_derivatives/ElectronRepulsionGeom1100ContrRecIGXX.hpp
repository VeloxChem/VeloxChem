#ifndef ElectronRepulsionGeom1100ContrRecIGXX_hpp
#define ElectronRepulsionGeom1100ContrRecIGXX_hpp
...
/// @param idx_geom_11_igxx The contracted integrals buffer.
...
auto
comp_bra_geom11_hrr_electron_repulsion_igxx(CSimdArray<double>& cbuffer,
                                            const size_t idx_geom_11_igxx,
...
#endif /* ElectronRepulsionGeom1100ContrRecIGXX_hpp */
