                                            ...
                                            const int d_angmom) -> void
{
    ...
    for (int i = 0; i < ccomps; i++)
    {
        for (int j = 0; j < dcomps; j++)
        {
            ...
            #pragma omp simd aligned(g_0_x_0_xxxx, g_0_x_0_xxxxx, g_0_x_0_xxxxy, g_0_x_0_xxxxz, g_0_x_0_xxxy, g_0_x_0_xxxyy, g_0_x_0_xxxyz, g_0_x_0_xxxz, g_0_x_0_xxxzz, g_0_x_0_xxyy, g_0_x_0_xxyyy, g_0_x_0_xxyyz, g_0_x_0_xxyz, g_0_x_0_xxyzz, g_0_x_0_xxzz, g_0_x_0_xxzzz, g_0_x_0_xyyy, g_0_x_0_xyyyy, g_0_x_0_xyyyz, g_0_x_0_xyyz, g_0_x_0_xyyzz, g_0_x_0_xyzz, g_0_x_0_xyzzz, g_0_x_0_xzzz, g_0_x_0_xzzzz, g_0_x_0_yyyy, g_0_x_0_yyyz, g_0_x_0_yyzz, g_0_x_0_yzzz, g_0_x_0_zzzz, g_0_x_x_xxxx, g_0_x_x_xxxy, g_0_x_x_xxxz, g_0_x_x_xxyy, g_0_x_x_xxyz, g_0_x_x_xxzz, g_0_x_x_xyyy, g_0_x_x_xyyz, g_0_x_x_xyzz, g_0_x_x_xzzz, g_0_x_x_yyyy, g_0_x_x_yyyz, g_0_x_x_yyzz, g_0_x_x_yzzz, g_0_x_x_zzzz, g_0_xxxx, g_0_xxxy, g_0_xxxz, g_0_xxyy, g_0_xxyz, g_0_xxzz, g_0_xyyy, g_0_xyyz, g_0_xyzz, g_0_xzzz, g_0_yyyy, g_0_yyyz, g_0_yyzz, g_0_yzzz, g_0_zzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_x_x_xxxx[k] = g_0_xxxx[k] - g_0_x_0_xxxx[k] * ab_x + g_0_x_0_xxxxx[k];

                g_0_x_x_xxxy[k] = g_0_xxxy[k] - g_0_x_0_xxxy[k] * ab_x + g_0_x_0_xxxxy[k];

                g_0_x_x_xxxz[k] = g_0_xxxz[k] - g_0_x_0_xxxz[k] * ab_x + g_0_x_0_xxxxz[k];

                g_0_x_x_xxyy[k] = g_0_xxyy[k] - g_0_x_0_xxyy[k] * ab_x + g_0_x_0_xxxyy[k];

                g_0_x_x_xxyz[k] = g_0_xxyz[k] - g_0_x_0_xxyz[k] * ab_x + g_0_x_0_xxxyz[k];

                g_0_x_x_xxzz[k] = g_0_xxzz[k] - g_0_x_0_xxzz[k] * ab_x + g_0_x_0_xxxzz[k];

                g_0_x_x_xyyy[k] = g_0_xyyy[k] - g_0_x_0_xyyy[k] * ab_x + g_0_x_0_xxyyy[k];

                g_0_x_x_xyyz[k] = g_0_xyyz[k] - g_0_x_0_xyyz[k] * ab_x + g_0_x_0_xxyyz[k];

                g_0_x_x_xyzz[k] = g_0_xyzz[k] - g_0_x_0_xyzz[k] * ab_x + g_0_x_0_xxyzz[k];

                g_0_x_x_xzzz[k] = g_0_xzzz[k] - g_0_x_0_xzzz[k] * ab_x + g_0_x_0_xxzzz[k];

                g_0_x_x_yyyy[k] = g_0_yyyy[k] - g_0_x_0_yyyy[k] * ab_x + g_0_x_0_xyyyy[k];

                g_0_x_x_yyyz[k] = g_0_yyyz[k] - g_0_x_0_yyyz[k] * ab_x + g_0_x_0_xyyyz[k];

                g_0_x_x_yyzz[k] = g_0_yyzz[k] - g_0_x_0_yyzz[k] * ab_x + g_0_x_0_xyyzz[k];

                g_0_x_x_yzzz[k] = g_0_yzzz[k] - g_0_x_0_yzzz[k] * ab_x + g_0_x_0_xyzzz[k];

                g_0_x_x_zzzz[k] = g_0_zzzz[k] - g_0_x_0_zzzz[k] * ab_x + g_0_x_0_xzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_x_0_xxxx, g_0_x_0_xxxxy, g_0_x_0_xxxy, g_0_x_0_xxxyy, g_0_x_0_xxxyz, g_0_x_0_xxxz, g_0_x_0_xxyy, g_0_x_0_xxyyy, g_0_x_0_xxyyz, g_0_x_0_xxyz, g_0_x_0_xxyzz, g_0_x_0_xxzz, g_0_x_0_xyyy, g_0_x_0_xyyyy, g_0_x_0_xyyyz, g_0_x_0_xyyz, g_0_x_0_xyyzz, g_0_x_0_xyzz, g_0_x_0_xyzzz, g_0_x_0_xzzz, g_0_x_0_yyyy, g_0_x_0_yyyyy, g_0_x_0_yyyyz, g_0_x_0_yyyz, g_0_x_0_yyyzz, g_0_x_0_yyzz, g_0_x_0_yyzzz, g_0_x_0_yzzz, g_0_x_0_yzzzz, g_0_x_0_zzzz, g_0_x_y_xxxx, g_0_x_y_xxxy, g_0_x_y_xxxz, g_0_x_y_xxyy, g_0_x_y_xxyz, g_0_x_y_xxzz, g_0_x_y_xyyy, g_0_x_y_xyyz, g_0_x_y_xyzz, g_0_x_y_xzzz, g_0_x_y_yyyy, g_0_x_y_yyyz, g_0_x_y_yyzz, g_0_x_y_yzzz, g_0_x_y_zzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_x_y_xxxx[k] = -g_0_x_0_xxxx[k] * ab_y + g_0_x_0_xxxxy[k];

                g_0_x_y_xxxy[k] = -g_0_x_0_xxxy[k] * ab_y + g_0_x_0_xxxyy[k];

                g_0_x_y_xxxz[k] = -g_0_x_0_xxxz[k] * ab_y + g_0_x_0_xxxyz[k];

                g_0_x_y_xxyy[k] = -g_0_x_0_xxyy[k] * ab_y + g_0_x_0_xxyyy[k];

                g_0_x_y_xxyz[k] = -g_0_x_0_xxyz[k] * ab_y + g_0_x_0_xxyyz[k];

                g_0_x_y_xxzz[k] = -g_0_x_0_xxzz[k] * ab_y + g_0_x_0_xxyzz[k];

                g_0_x_y_xyyy[k] = -g_0_x_0_xyyy[k] * ab_y + g_0_x_0_xyyyy[k];

                g_0_x_y_xyyz[k] = -g_0_x_0_xyyz[k] * ab_y + g_0_x_0_xyyyz[k];

                g_0_x_y_xyzz[k] = -g_0_x_0_xyzz[k] * ab_y + g_0_x_0_xyyzz[k];

                g_0_x_y_xzzz[k] = -g_0_x_0_xzzz[k] * ab_y + g_0_x_0_xyzzz[k];

                g_0_x_y_yyyy[k] = -g_0_x_0_yyyy[k] * ab_y + g_0_x_0_yyyyy[k];

                g_0_x_y_yyyz[k] = -g_0_x_0_yyyz[k] * ab_y + g_0_x_0_yyyyz[k];

                g_0_x_y_yyzz[k] = -g_0_x_0_yyzz[k] * ab_y + g_0_x_0_yyyzz[k];

                g_0_x_y_yzzz[k] = -g_0_x_0_yzzz[k] * ab_y + g_0_x_0_yyzzz[k];

                g_0_x_y_zzzz[k] = -g_0_x_0_zzzz[k] * ab_y + g_0_x_0_yzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_x_0_xxxx, g_0_x_0_xxxxz, g_0_x_0_xxxy, g_0_x_0_xxxyz, g_0_x_0_xxxz, g_0_x_0_xxxzz, g_0_x_0_xxyy, g_0_x_0_xxyyz, g_0_x_0_xxyz, g_0_x_0_xxyzz, g_0_x_0_xxzz, g_0_x_0_xxzzz, g_0_x_0_xyyy, g_0_x_0_xyyyz, g_0_x_0_xyyz, g_0_x_0_xyyzz, g_0_x_0_xyzz, g_0_x_0_xyzzz, g_0_x_0_xzzz, g_0_x_0_xzzzz, g_0_x_0_yyyy, g_0_x_0_yyyyz, g_0_x_0_yyyz, g_0_x_0_yyyzz, g_0_x_0_yyzz, g_0_x_0_yyzzz, g_0_x_0_yzzz, g_0_x_0_yzzzz, g_0_x_0_zzzz, g_0_x_0_zzzzz, g_0_x_z_xxxx, g_0_x_z_xxxy, g_0_x_z_xxxz, g_0_x_z_xxyy, g_0_x_z_xxyz, g_0_x_z_xxzz, g_0_x_z_xyyy, g_0_x_z_xyyz, g_0_x_z_xyzz, g_0_x_z_xzzz, g_0_x_z_yyyy, g_0_x_z_yyyz, g_0_x_z_yyzz, g_0_x_z_yzzz, g_0_x_z_zzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_x_z_xxxx[k] = -g_0_x_0_xxxx[k] * ab_z + g_0_x_0_xxxxz[k];

                g_0_x_z_xxxy[k] = -g_0_x_0_xxxy[k] * ab_z + g_0_x_0_xxxyz[k];

                g_0_x_z_xxxz[k] = -g_0_x_0_xxxz[k] * ab_z + g_0_x_0_xxxzz[k];

                g_0_x_z_xxyy[k] = -g_0_x_0_xxyy[k] * ab_z + g_0_x_0_xxyyz[k];

                g_0_x_z_xxyz[k] = -g_0_x_0_xxyz[k] * ab_z + g_0_x_0_xxyzz[k];

                g_0_x_z_xxzz[k] = -g_0_x_0_xxzz[k] * ab_z + g_0_x_0_xxzzz[k];

                g_0_x_z_xyyy[k] = -g_0_x_0_xyyy[k] * ab_z + g_0_x_0_xyyyz[k];

                g_0_x_z_xyyz[k] = -g_0_x_0_xyyz[k] * ab_z + g_0_x_0_xyyzz[k];

                g_0_x_z_xyzz[k] = -g_0_x_0_xyzz[k] * ab_z + g_0_x_0_xyzzz[k];

                g_0_x_z_xzzz[k] = -g_0_x_0_xzzz[k] * ab_z + g_0_x_0_xzzzz[k];

                g_0_x_z_yyyy[k] = -g_0_x_0_yyyy[k] * ab_z + g_0_x_0_yyyyz[k];

                g_0_x_z_yyyz[k] = -g_0_x_0_yyyz[k] * ab_z + g_0_x_0_yyyzz[k];

                g_0_x_z_yyzz[k] = -g_0_x_0_yyzz[k] * ab_z + g_0_x_0_yyzzz[k];

                g_0_x_z_yzzz[k] = -g_0_x_0_yzzz[k] * ab_z + g_0_x_0_yzzzz[k];

                g_0_x_z_zzzz[k] = -g_0_x_0_zzzz[k] * ab_z + g_0_x_0_zzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_y_0_xxxx, g_0_y_0_xxxxx, g_0_y_0_xxxxy, g_0_y_0_xxxxz, g_0_y_0_xxxy, g_0_y_0_xxxyy, g_0_y_0_xxxyz, g_0_y_0_xxxz, g_0_y_0_xxxzz, g_0_y_0_xxyy, g_0_y_0_xxyyy, g_0_y_0_xxyyz, g_0_y_0_xxyz, g_0_y_0_xxyzz, g_0_y_0_xxzz, g_0_y_0_xxzzz, g_0_y_0_xyyy, g_0_y_0_xyyyy, g_0_y_0_xyyyz, g_0_y_0_xyyz, g_0_y_0_xyyzz, g_0_y_0_xyzz, g_0_y_0_xyzzz, g_0_y_0_xzzz, g_0_y_0_xzzzz, g_0_y_0_yyyy, g_0_y_0_yyyz, g_0_y_0_yyzz, g_0_y_0_yzzz, g_0_y_0_zzzz, g_0_y_x_xxxx, g_0_y_x_xxxy, g_0_y_x_xxxz, g_0_y_x_xxyy, g_0_y_x_xxyz, g_0_y_x_xxzz, g_0_y_x_xyyy, g_0_y_x_xyyz, g_0_y_x_xyzz, g_0_y_x_xzzz, g_0_y_x_yyyy, g_0_y_x_yyyz, g_0_y_x_yyzz, g_0_y_x_yzzz, g_0_y_x_zzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_y_x_xxxx[k] = -g_0_y_0_xxxx[k] * ab_x + g_0_y_0_xxxxx[k];

                g_0_y_x_xxxy[k] = -g_0_y_0_xxxy[k] * ab_x + g_0_y_0_xxxxy[k];

                g_0_y_x_xxxz[k] = -g_0_y_0_xxxz[k] * ab_x + g_0_y_0_xxxxz[k];

                g_0_y_x_xxyy[k] = -g_0_y_0_xxyy[k] * ab_x + g_0_y_0_xxxyy[k];

                g_0_y_x_xxyz[k] = -g_0_y_0_xxyz[k] * ab_x + g_0_y_0_xxxyz[k];

                g_0_y_x_xxzz[k] = -g_0_y_0_xxzz[k] * ab_x + g_0_y_0_xxxzz[k];

                g_0_y_x_xyyy[k] = -g_0_y_0_xyyy[k] * ab_x + g_0_y_0_xxyyy[k];

                g_0_y_x_xyyz[k] = -g_0_y_0_xyyz[k] * ab_x + g_0_y_0_xxyyz[k];

                g_0_y_x_xyzz[k] = -g_0_y_0_xyzz[k] * ab_x + g_0_y_0_xxyzz[k];

                g_0_y_x_xzzz[k] = -g_0_y_0_xzzz[k] * ab_x + g_0_y_0_xxzzz[k];

                g_0_y_x_yyyy[k] = -g_0_y_0_yyyy[k] * ab_x + g_0_y_0_xyyyy[k];

                g_0_y_x_yyyz[k] = -g_0_y_0_yyyz[k] * ab_x + g_0_y_0_xyyyz[k];

                g_0_y_x_yyzz[k] = -g_0_y_0_yyzz[k] * ab_x + g_0_y_0_xyyzz[k];

                g_0_y_x_yzzz[k] = -g_0_y_0_yzzz[k] * ab_x + g_0_y_0_xyzzz[k];

                g_0_y_x_zzzz[k] = -g_0_y_0_zzzz[k] * ab_x + g_0_y_0_xzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_xxxx, g_0_xxxy, g_0_xxxz, g_0_xxyy, g_0_xxyz, g_0_xxzz, g_0_xyyy, g_0_xyyz, g_0_xyzz, g_0_xzzz, g_0_y_0_xxxx, g_0_y_0_xxxxy, g_0_y_0_xxxy, g_0_y_0_xxxyy, g_0_y_0_xxxyz, g_0_y_0_xxxz, g_0_y_0_xxyy, g_0_y_0_xxyyy, g_0_y_0_xxyyz, g_0_y_0_xxyz, g_0_y_0_xxyzz, g_0_y_0_xxzz, g_0_y_0_xyyy, g_0_y_0_xyyyy, g_0_y_0_xyyyz, g_0_y_0_xyyz, g_0_y_0_xyyzz, g_0_y_0_xyzz, g_0_y_0_xyzzz, g_0_y_0_xzzz, g_0_y_0_yyyy, g_0_y_0_yyyyy, g_0_y_0_yyyyz, g_0_y_0_yyyz, g_0_y_0_yyyzz, g_0_y_0_yyzz, g_0_y_0_yyzzz, g_0_y_0_yzzz, g_0_y_0_yzzzz, g_0_y_0_zzzz, g_0_y_y_xxxx, g_0_y_y_xxxy, g_0_y_y_xxxz, g_0_y_y_xxyy, g_0_y_y_xxyz, g_0_y_y_xxzz, g_0_y_y_xyyy, g_0_y_y_xyyz, g_0_y_y_xyzz, g_0_y_y_xzzz, g_0_y_y_yyyy, g_0_y_y_yyyz, g_0_y_y_yyzz, g_0_y_y_yzzz, g_0_y_y_zzzz, g_0_yyyy, g_0_yyyz, g_0_yyzz, g_0_yzzz, g_0_zzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_y_y_xxxx[k] = g_0_xxxx[k] - g_0_y_0_xxxx[k] * ab_y + g_0_y_0_xxxxy[k];

                g_0_y_y_xxxy[k] = g_0_xxxy[k] - g_0_y_0_xxxy[k] * ab_y + g_0_y_0_xxxyy[k];

                g_0_y_y_xxxz[k] = g_0_xxxz[k] - g_0_y_0_xxxz[k] * ab_y + g_0_y_0_xxxyz[k];

                g_0_y_y_xxyy[k] = g_0_xxyy[k] - g_0_y_0_xxyy[k] * ab_y + g_0_y_0_xxyyy[k];

                g_0_y_y_xxyz[k] = g_0_xxyz[k] - g_0_y_0_xxyz[k] * ab_y + g_0_y_0_xxyyz[k];

                g_0_y_y_xxzz[k] = g_0_xxzz[k] - g_0_y_0_xxzz[k] * ab_y + g_0_y_0_xxyzz[k];

                g_0_y_y_xyyy[k] = g_0_xyyy[k] - g_0_y_0_xyyy[k] * ab_y + g_0_y_0_xyyyy[k];

                g_0_y_y_xyyz[k] = g_0_xyyz[k] - g_0_y_0_xyyz[k] * ab_y + g_0_y_0_xyyyz[k];

                g_0_y_y_xyzz[k] = g_0_xyzz[k] - g_0_y_0_xyzz[k] * ab_y + g_0_y_0_xyyzz[k];

                g_0_y_y_xzzz[k] = g_0_xzzz[k] - g_0_y_0_xzzz[k] * ab_y + g_0_y_0_xyzzz[k];

                g_0_y_y_yyyy[k] = g_0_yyyy[k] - g_0_y_0_yyyy[k] * ab_y + g_0_y_0_yyyyy[k];

                g_0_y_y_yyyz[k] = g_0_yyyz[k] - g_0_y_0_yyyz[k] * ab_y + g_0_y_0_yyyyz[k];

                g_0_y_y_yyzz[k] = g_0_yyzz[k] - g_0_y_0_yyzz[k] * ab_y + g_0_y_0_yyyzz[k];

                g_0_y_y_yzzz[k] = g_0_yzzz[k] - g_0_y_0_yzzz[k] * ab_y + g_0_y_0_yyzzz[k];

                g_0_y_y_zzzz[k] = g_0_zzzz[k] - g_0_y_0_zzzz[k] * ab_y + g_0_y_0_yzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_y_0_xxxx, g_0_y_0_xxxxz, g_0_y_0_xxxy, g_0_y_0_xxxyz, g_0_y_0_xxxz, g_0_y_0_xxxzz, g_0_y_0_xxyy, g_0_y_0_xxyyz, g_0_y_0_xxyz, g_0_y_0_xxyzz, g_0_y_0_xxzz, g_0_y_0_xxzzz, g_0_y_0_xyyy, g_0_y_0_xyyyz, g_0_y_0_xyyz, g_0_y_0_xyyzz, g_0_y_0_xyzz, g_0_y_0_xyzzz, g_0_y_0_xzzz, g_0_y_0_xzzzz, g_0_y_0_yyyy, g_0_y_0_yyyyz, g_0_y_0_yyyz, g_0_y_0_yyyzz, g_0_y_0_yyzz, g_0_y_0_yyzzz, g_0_y_0_yzzz, g_0_y_0_yzzzz, g_0_y_0_zzzz, g_0_y_0_zzzzz, g_0_y_z_xxxx, g_0_y_z_xxxy, g_0_y_z_xxxz, g_0_y_z_xxyy, g_0_y_z_xxyz, g_0_y_z_xxzz, g_0_y_z_xyyy, g_0_y_z_xyyz, g_0_y_z_xyzz, g_0_y_z_xzzz, g_0_y_z_yyyy, g_0_y_z_yyyz, g_0_y_z_yyzz, g_0_y_z_yzzz, g_0_y_z_zzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_y_z_xxxx[k] = -g_0_y_0_xxxx[k] * ab_z + g_0_y_0_xxxxz[k];

                g_0_y_z_xxxy[k] = -g_0_y_0_xxxy[k] * ab_z + g_0_y_0_xxxyz[k];

                g_0_y_z_xxxz[k] = -g_0_y_0_xxxz[k] * ab_z + g_0_y_0_xxxzz[k];

                g_0_y_z_xxyy[k] = -g_0_y_0_xxyy[k] * ab_z + g_0_y_0_xxyyz[k];

                g_0_y_z_xxyz[k] = -g_0_y_0_xxyz[k] * ab_z + g_0_y_0_xxyzz[k];

                g_0_y_z_xxzz[k] = -g_0_y_0_xxzz[k] * ab_z + g_0_y_0_xxzzz[k];

                g_0_y_z_xyyy[k] = -g_0_y_0_xyyy[k] * ab_z + g_0_y_0_xyyyz[k];

                g_0_y_z_xyyz[k] = -g_0_y_0_xyyz[k] * ab_z + g_0_y_0_xyyzz[k];

                g_0_y_z_xyzz[k] = -g_0_y_0_xyzz[k] * ab_z + g_0_y_0_xyzzz[k];

                g_0_y_z_xzzz[k] = -g_0_y_0_xzzz[k] * ab_z + g_0_y_0_xzzzz[k];

                g_0_y_z_yyyy[k] = -g_0_y_0_yyyy[k] * ab_z + g_0_y_0_yyyyz[k];

                g_0_y_z_yyyz[k] = -g_0_y_0_yyyz[k] * ab_z + g_0_y_0_yyyzz[k];

                g_0_y_z_yyzz[k] = -g_0_y_0_yyzz[k] * ab_z + g_0_y_0_yyzzz[k];

                g_0_y_z_yzzz[k] = -g_0_y_0_yzzz[k] * ab_z + g_0_y_0_yzzzz[k];

                g_0_y_z_zzzz[k] = -g_0_y_0_zzzz[k] * ab_z + g_0_y_0_zzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_z_0_xxxx, g_0_z_0_xxxxx, g_0_z_0_xxxxy, g_0_z_0_xxxxz, g_0_z_0_xxxy, g_0_z_0_xxxyy, g_0_z_0_xxxyz, g_0_z_0_xxxz, g_0_z_0_xxxzz, g_0_z_0_xxyy, g_0_z_0_xxyyy, g_0_z_0_xxyyz, g_0_z_0_xxyz, g_0_z_0_xxyzz, g_0_z_0_xxzz, g_0_z_0_xxzzz, g_0_z_0_xyyy, g_0_z_0_xyyyy, g_0_z_0_xyyyz, g_0_z_0_xyyz, g_0_z_0_xyyzz, g_0_z_0_xyzz, g_0_z_0_xyzzz, g_0_z_0_xzzz, g_0_z_0_xzzzz, g_0_z_0_yyyy, g_0_z_0_yyyz, g_0_z_0_yyzz, g_0_z_0_yzzz, g_0_z_0_zzzz, g_0_z_x_xxxx, g_0_z_x_xxxy, g_0_z_x_xxxz, g_0_z_x_xxyy, g_0_z_x_xxyz, g_0_z_x_xxzz, g_0_z_x_xyyy, g_0_z_x_xyyz, g_0_z_x_xyzz, g_0_z_x_xzzz, g_0_z_x_yyyy, g_0_z_x_yyyz, g_0_z_x_yyzz, g_0_z_x_yzzz, g_0_z_x_zzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_z_x_xxxx[k] = -g_0_z_0_xxxx[k] * ab_x + g_0_z_0_xxxxx[k];

                g_0_z_x_xxxy[k] = -g_0_z_0_xxxy[k] * ab_x + g_0_z_0_xxxxy[k];

                g_0_z_x_xxxz[k] = -g_0_z_0_xxxz[k] * ab_x + g_0_z_0_xxxxz[k];

                g_0_z_x_xxyy[k] = -g_0_z_0_xxyy[k] * ab_x + g_0_z_0_xxxyy[k];

                g_0_z_x_xxyz[k] = -g_0_z_0_xxyz[k] * ab_x + g_0_z_0_xxxyz[k];

                g_0_z_x_xxzz[k] = -g_0_z_0_xxzz[k] * ab_x + g_0_z_0_xxxzz[k];

                g_0_z_x_xyyy[k] = -g_0_z_0_xyyy[k] * ab_x + g_0_z_0_xxyyy[k];

                g_0_z_x_xyyz[k] = -g_0_z_0_xyyz[k] * ab_x + g_0_z_0_xxyyz[k];

                g_0_z_x_xyzz[k] = -g_0_z_0_xyzz[k] * ab_x + g_0_z_0_xxyzz[k];

                g_0_z_x_xzzz[k] = -g_0_z_0_xzzz[k] * ab_x + g_0_z_0_xxzzz[k];

                g_0_z_x_yyyy[k] = -g_0_z_0_yyyy[k] * ab_x + g_0_z_0_xyyyy[k];

                g_0_z_x_yyyz[k] = -g_0_z_0_yyyz[k] * ab_x + g_0_z_0_xyyyz[k];

                g_0_z_x_yyzz[k] = -g_0_z_0_yyzz[k] * ab_x + g_0_z_0_xyyzz[k];

                g_0_z_x_yzzz[k] = -g_0_z_0_yzzz[k] * ab_x + g_0_z_0_xyzzz[k];

                g_0_z_x_zzzz[k] = -g_0_z_0_zzzz[k] * ab_x + g_0_z_0_xzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_z_0_xxxx, g_0_z_0_xxxxy, g_0_z_0_xxxy, g_0_z_0_xxxyy, g_0_z_0_xxxyz, g_0_z_0_xxxz, g_0_z_0_xxyy, g_0_z_0_xxyyy, g_0_z_0_xxyyz, g_0_z_0_xxyz, g_0_z_0_xxyzz, g_0_z_0_xxzz, g_0_z_0_xyyy, g_0_z_0_xyyyy, g_0_z_0_xyyyz, g_0_z_0_xyyz, g_0_z_0_xyyzz, g_0_z_0_xyzz, g_0_z_0_xyzzz, g_0_z_0_xzzz, g_0_z_0_yyyy, g_0_z_0_yyyyy, g_0_z_0_yyyyz, g_0_z_0_yyyz, g_0_z_0_yyyzz, g_0_z_0_yyzz, g_0_z_0_yyzzz, g_0_z_0_yzzz, g_0_z_0_yzzzz, g_0_z_0_zzzz, g_0_z_y_xxxx, g_0_z_y_xxxy, g_0_z_y_xxxz, g_0_z_y_xxyy, g_0_z_y_xxyz, g_0_z_y_xxzz, g_0_z_y_xyyy, g_0_z_y_xyyz, g_0_z_y_xyzz, g_0_z_y_xzzz, g_0_z_y_yyyy, g_0_z_y_yyyz, g_0_z_y_yyzz, g_0_z_y_yzzz, g_0_z_y_zzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_z_y_xxxx[k] = -g_0_z_0_xxxx[k] * ab_y + g_0_z_0_xxxxy[k];

                g_0_z_y_xxxy[k] = -g_0_z_0_xxxy[k] * ab_y + g_0_z_0_xxxyy[k];

                g_0_z_y_xxxz[k] = -g_0_z_0_xxxz[k] * ab_y + g_0_z_0_xxxyz[k];

                g_0_z_y_xxyy[k] = -g_0_z_0_xxyy[k] * ab_y + g_0_z_0_xxyyy[k];

                g_0_z_y_xxyz[k] = -g_0_z_0_xxyz[k] * ab_y + g_0_z_0_xxyyz[k];

                g_0_z_y_xxzz[k] = -g_0_z_0_xxzz[k] * ab_y + g_0_z_0_xxyzz[k];

                g_0_z_y_xyyy[k] = -g_0_z_0_xyyy[k] * ab_y + g_0_z_0_xyyyy[k];

                g_0_z_y_xyyz[k] = -g_0_z_0_xyyz[k] * ab_y + g_0_z_0_xyyyz[k];

                g_0_z_y_xyzz[k] = -g_0_z_0_xyzz[k] * ab_y + g_0_z_0_xyyzz[k];

                g_0_z_y_xzzz[k] = -g_0_z_0_xzzz[k] * ab_y + g_0_z_0_xyzzz[k];

                g_0_z_y_yyyy[k] = -g_0_z_0_yyyy[k] * ab_y + g_0_z_0_yyyyy[k];

                g_0_z_y_yyyz[k] = -g_0_z_0_yyyz[k] * ab_y + g_0_z_0_yyyyz[k];

                g_0_z_y_yyzz[k] = -g_0_z_0_yyzz[k] * ab_y + g_0_z_0_yyyzz[k];

                g_0_z_y_yzzz[k] = -g_0_z_0_yzzz[k] * ab_y + g_0_z_0_yyzzz[k];

                g_0_z_y_zzzz[k] = -g_0_z_0_zzzz[k] * ab_y + g_0_z_0_yzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_xxxx, g_0_xxxy, g_0_xxxz, g_0_xxyy, g_0_xxyz, g_0_xxzz, g_0_xyyy, g_0_xyyz, g_0_xyzz, g_0_xzzz, g_0_yyyy, g_0_yyyz, g_0_yyzz, g_0_yzzz, g_0_z_0_xxxx, g_0_z_0_xxxxz, g_0_z_0_xxxy, g_0_z_0_xxxyz, g_0_z_0_xxxz, g_0_z_0_xxxzz, g_0_z_0_xxyy, g_0_z_0_xxyyz, g_0_z_0_xxyz, g_0_z_0_xxyzz, g_0_z_0_xxzz, g_0_z_0_xxzzz, g_0_z_0_xyyy, g_0_z_0_xyyyz, g_0_z_0_xyyz, g_0_z_0_xyyzz, g_0_z_0_xyzz, g_0_z_0_xyzzz, g_0_z_0_xzzz, g_0_z_0_xzzzz, g_0_z_0_yyyy, g_0_z_0_yyyyz, g_0_z_0_yyyz, g_0_z_0_yyyzz, g_0_z_0_yyzz, g_0_z_0_yyzzz, g_0_z_0_yzzz, g_0_z_0_yzzzz, g_0_z_0_zzzz, g_0_z_0_zzzzz, g_0_z_z_xxxx, g_0_z_z_xxxy, g_0_z_z_xxxz, g_0_z_z_xxyy, g_0_z_z_xxyz, g_0_z_z_xxzz, g_0_z_z_xyyy, g_0_z_z_xyyz, g_0_z_z_xyzz, g_0_z_z_xzzz, g_0_z_z_yyyy, g_0_z_z_yyyz, g_0_z_z_yyzz, g_0_z_z_yzzz, g_0_z_z_zzzz, g_0_zzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_z_z_xxxx[k] = g_0_xxxx[k] - g_0_z_0_xxxx[k] * ab_z + g_0_z_0_xxxxz[k];

                g_0_z_z_xxxy[k] = g_0_xxxy[k] - g_0_z_0_xxxy[k] * ab_z + g_0_z_0_xxxyz[k];

                g_0_z_z_xxxz[k] = g_0_xxxz[k] - g_0_z_0_xxxz[k] * ab_z + g_0_z_0_xxxzz[k];

                g_0_z_z_xxyy[k] = g_0_xxyy[k] - g_0_z_0_xxyy[k] * ab_z + g_0_z_0_xxyyz[k];

                g_0_z_z_xxyz[k] = g_0_xxyz[k] - g_0_z_0_xxyz[k] * ab_z + g_0_z_0_xxyzz[k];

                g_0_z_z_xxzz[k] = g_0_xxzz[k] - g_0_z_0_xxzz[k] * ab_z + g_0_z_0_xxzzz[k];

                g_0_z_z_xyyy[k] = g_0_xyyy[k] - g_0_z_0_xyyy[k] * ab_z + g_0_z_0_xyyyz[k];

                g_0_z_z_xyyz[k] = g_0_xyyz[k] - g_0_z_0_xyyz[k] * ab_z + g_0_z_0_xyyzz[k];

                g_0_z_z_xyzz[k] = g_0_xyzz[k] - g_0_z_0_xyzz[k] * ab_z + g_0_z_0_xyzzz[k];

                g_0_z_z_xzzz[k] = g_0_xzzz[k] - g_0_z_0_xzzz[k] * ab_z + g_0_z_0_xzzzz[k];

                g_0_z_z_yyyy[k] = g_0_yyyy[k] - g_0_z_0_yyyy[k] * ab_z + g_0_z_0_yyyyz[k];

                g_0_z_z_yyyz[k] = g_0_yyyz[k] - g_0_z_0_yyyz[k] * ab_z + g_0_z_0_yyyzz[k];

                g_0_z_z_yyzz[k] = g_0_yyzz[k] - g_0_z_0_yyzz[k] * ab_z + g_0_z_0_yyzzz[k];

                g_0_z_z_yzzz[k] = g_0_yzzz[k] - g_0_z_0_yzzz[k] * ab_z + g_0_z_0_yzzzz[k];

                g_0_z_z_zzzz[k] = g_0_zzzz[k] - g_0_z_0_zzzz[k] * ab_z + g_0_z_0_zzzzz[k];
            }
        }
    }
}
