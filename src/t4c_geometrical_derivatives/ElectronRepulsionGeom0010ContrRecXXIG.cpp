                                            ...
                                            const int b_angmom) -> void
{
    ...
    for (int i = 0; i < acomps; i++)
    {
        for (int j = 0; j < bcomps; j++)
        {
            ...
            auto g_xxxxy_xxxx = cbuffer.data(hg_off + 15);

            auto g_xxxxy_xxxy = cbuffer.data(hg_off + 16);

            auto g_xxxxy_xxxz = cbuffer.data(hg_off + 17);

            auto g_xxxxy_xxyy = cbuffer.data(hg_off + 18);

            auto g_xxxxy_xxyz = cbuffer.data(hg_off + 19);

            auto g_xxxxy_xxzz = cbuffer.data(hg_off + 20);

            auto g_xxxxy_xyyy = cbuffer.data(hg_off + 21);

            auto g_xxxxy_xyyz = cbuffer.data(hg_off + 22);

            auto g_xxxxy_xyzz = cbuffer.data(hg_off + 23);

            auto g_xxxxy_xzzz = cbuffer.data(hg_off + 24);

            auto g_xxxxy_yyyy = cbuffer.data(hg_off + 25);

            auto g_xxxxy_yyyz = cbuffer.data(hg_off + 26);

            auto g_xxxxy_yyzz = cbuffer.data(hg_off + 27);

            auto g_xxxxy_yzzz = cbuffer.data(hg_off + 28);

            auto g_xxxxy_zzzz = cbuffer.data(hg_off + 29);

            auto g_xxxxz_xxxx = cbuffer.data(hg_off + 30);

            auto g_xxxxz_xxxy = cbuffer.data(hg_off + 31);

            auto g_xxxxz_xxxz = cbuffer.data(hg_off + 32);

            auto g_xxxxz_xxyy = cbuffer.data(hg_off + 33);

            auto g_xxxxz_xxyz = cbuffer.data(hg_off + 34);

            auto g_xxxxz_xxzz = cbuffer.data(hg_off + 35);

            auto g_xxxxz_xyyy = cbuffer.data(hg_off + 36);

            auto g_xxxxz_xyyz = cbuffer.data(hg_off + 37);

            auto g_xxxxz_xyzz = cbuffer.data(hg_off + 38);

            auto g_xxxxz_xzzz = cbuffer.data(hg_off + 39);

            auto g_xxxxz_yyyy = cbuffer.data(hg_off + 40);

            auto g_xxxxz_yyyz = cbuffer.data(hg_off + 41);

            auto g_xxxxz_yyzz = cbuffer.data(hg_off + 42);

            auto g_xxxxz_yzzz = cbuffer.data(hg_off + 43);

            auto g_xxxxz_zzzz = cbuffer.data(hg_off + 44);

            auto g_xxxyy_xxxx = cbuffer.data(hg_off + 45);

            auto g_xxxyy_xxxy = cbuffer.data(hg_off + 46);

            auto g_xxxyy_xxxz = cbuffer.data(hg_off + 47);

            auto g_xxxyy_xxyy = cbuffer.data(hg_off + 48);

            auto g_xxxyy_xxyz = cbuffer.data(hg_off + 49);

            auto g_xxxyy_xxzz = cbuffer.data(hg_off + 50);

            auto g_xxxyy_xyyy = cbuffer.data(hg_off + 51);

            auto g_xxxyy_xyyz = cbuffer.data(hg_off + 52);

            auto g_xxxyy_xyzz = cbuffer.data(hg_off + 53);

            auto g_xxxyy_xzzz = cbuffer.data(hg_off + 54);

            auto g_xxxyy_yyyy = cbuffer.data(hg_off + 55);

            auto g_xxxyy_yyyz = cbuffer.data(hg_off + 56);

            auto g_xxxyy_yyzz = cbuffer.data(hg_off + 57);

            auto g_xxxyy_yzzz = cbuffer.data(hg_off + 58);

            auto g_xxxyy_zzzz = cbuffer.data(hg_off + 59);

            auto g_xxxyz_xxxx = cbuffer.data(hg_off + 60);

            auto g_xxxyz_xxxy = cbuffer.data(hg_off + 61);

            auto g_xxxyz_xxxz = cbuffer.data(hg_off + 62);

            auto g_xxxyz_xxyy = cbuffer.data(hg_off + 63);

            auto g_xxxyz_xxyz = cbuffer.data(hg_off + 64);

            auto g_xxxyz_xxzz = cbuffer.data(hg_off + 65);

            auto g_xxxyz_xyyy = cbuffer.data(hg_off + 66);

            auto g_xxxyz_xyyz = cbuffer.data(hg_off + 67);

            auto g_xxxyz_xyzz = cbuffer.data(hg_off + 68);

            auto g_xxxyz_xzzz = cbuffer.data(hg_off + 69);

            auto g_xxxyz_yyyy = cbuffer.data(hg_off + 70);

            auto g_xxxyz_yyyz = cbuffer.data(hg_off + 71);

            auto g_xxxyz_yyzz = cbuffer.data(hg_off + 72);

            auto g_xxxyz_yzzz = cbuffer.data(hg_off + 73);

            auto g_xxxyz_zzzz = cbuffer.data(hg_off + 74);

            auto g_xxxzz_xxxx = cbuffer.data(hg_off + 75);

            auto g_xxxzz_xxxy = cbuffer.data(hg_off + 76);

            auto g_xxxzz_xxxz = cbuffer.data(hg_off + 77);

            auto g_xxxzz_xxyy = cbuffer.data(hg_off + 78);

            auto g_xxxzz_xxyz = cbuffer.data(hg_off + 79);

            auto g_xxxzz_xxzz = cbuffer.data(hg_off + 80);

            auto g_xxxzz_xyyy = cbuffer.data(hg_off + 81);

            auto g_xxxzz_xyyz = cbuffer.data(hg_off + 82);

            auto g_xxxzz_xyzz = cbuffer.data(hg_off + 83);

            auto g_xxxzz_xzzz = cbuffer.data(hg_off + 84);

            auto g_xxxzz_yyyy = cbuffer.data(hg_off + 85);

            auto g_xxxzz_yyyz = cbuffer.data(hg_off + 86);

            auto g_xxxzz_yyzz = cbuffer.data(hg_off + 87);

            auto g_xxxzz_yzzz = cbuffer.data(hg_off + 88);

            auto g_xxxzz_zzzz = cbuffer.data(hg_off + 89);

            auto g_xxyyy_xxxx = cbuffer.data(hg_off + 90);

            auto g_xxyyy_xxxy = cbuffer.data(hg_off + 91);

            auto g_xxyyy_xxxz = cbuffer.data(hg_off + 92);

            auto g_xxyyy_xxyy = cbuffer.data(hg_off + 93);

            auto g_xxyyy_xxyz = cbuffer.data(hg_off + 94);

            auto g_xxyyy_xxzz = cbuffer.data(hg_off + 95);

            auto g_xxyyy_xyyy = cbuffer.data(hg_off + 96);

            auto g_xxyyy_xyyz = cbuffer.data(hg_off + 97);

            auto g_xxyyy_xyzz = cbuffer.data(hg_off + 98);

            auto g_xxyyy_xzzz = cbuffer.data(hg_off + 99);

            auto g_xxyyy_yyyy = cbuffer.data(hg_off + 100);

            auto g_xxyyy_yyyz = cbuffer.data(hg_off + 101);

            auto g_xxyyy_yyzz = cbuffer.data(hg_off + 102);

            auto g_xxyyy_yzzz = cbuffer.data(hg_off + 103);

            auto g_xxyyy_zzzz = cbuffer.data(hg_off + 104);

            auto g_xxyyz_xxxx = cbuffer.data(hg_off + 105);

            auto g_xxyyz_xxxy = cbuffer.data(hg_off + 106);

            auto g_xxyyz_xxxz = cbuffer.data(hg_off + 107);

            auto g_xxyyz_xxyy = cbuffer.data(hg_off + 108);

            auto g_xxyyz_xxyz = cbuffer.data(hg_off + 109);

            auto g_xxyyz_xxzz = cbuffer.data(hg_off + 110);

            auto g_xxyyz_xyyy = cbuffer.data(hg_off + 111);

            auto g_xxyyz_xyyz = cbuffer.data(hg_off + 112);

            auto g_xxyyz_xyzz = cbuffer.data(hg_off + 113);

            auto g_xxyyz_xzzz = cbuffer.data(hg_off + 114);

            auto g_xxyyz_yyyy = cbuffer.data(hg_off + 115);

            auto g_xxyyz_yyyz = cbuffer.data(hg_off + 116);

            auto g_xxyyz_yyzz = cbuffer.data(hg_off + 117);

            auto g_xxyyz_yzzz = cbuffer.data(hg_off + 118);

            auto g_xxyyz_zzzz = cbuffer.data(hg_off + 119);

            auto g_xxyzz_xxxx = cbuffer.data(hg_off + 120);

            auto g_xxyzz_xxxy = cbuffer.data(hg_off + 121);

            auto g_xxyzz_xxxz = cbuffer.data(hg_off + 122);

            auto g_xxyzz_xxyy = cbuffer.data(hg_off + 123);

            auto g_xxyzz_xxyz = cbuffer.data(hg_off + 124);

            auto g_xxyzz_xxzz = cbuffer.data(hg_off + 125);

            auto g_xxyzz_xyyy = cbuffer.data(hg_off + 126);

            auto g_xxyzz_xyyz = cbuffer.data(hg_off + 127);

            auto g_xxyzz_xyzz = cbuffer.data(hg_off + 128);

            auto g_xxyzz_xzzz = cbuffer.data(hg_off + 129);

            auto g_xxyzz_yyyy = cbuffer.data(hg_off + 130);

            auto g_xxyzz_yyyz = cbuffer.data(hg_off + 131);

            auto g_xxyzz_yyzz = cbuffer.data(hg_off + 132);

            auto g_xxyzz_yzzz = cbuffer.data(hg_off + 133);

            auto g_xxyzz_zzzz = cbuffer.data(hg_off + 134);

            auto g_xxzzz_xxxx = cbuffer.data(hg_off + 135);

            auto g_xxzzz_xxxy = cbuffer.data(hg_off + 136);

            auto g_xxzzz_xxxz = cbuffer.data(hg_off + 137);

            auto g_xxzzz_xxyy = cbuffer.data(hg_off + 138);

            auto g_xxzzz_xxyz = cbuffer.data(hg_off + 139);

            auto g_xxzzz_xxzz = cbuffer.data(hg_off + 140);

            auto g_xxzzz_xyyy = cbuffer.data(hg_off + 141);

            auto g_xxzzz_xyyz = cbuffer.data(hg_off + 142);

            auto g_xxzzz_xyzz = cbuffer.data(hg_off + 143);

            auto g_xxzzz_xzzz = cbuffer.data(hg_off + 144);

            auto g_xxzzz_yyyy = cbuffer.data(hg_off + 145);

            auto g_xxzzz_yyyz = cbuffer.data(hg_off + 146);

            auto g_xxzzz_yyzz = cbuffer.data(hg_off + 147);

            auto g_xxzzz_yzzz = cbuffer.data(hg_off + 148);

            auto g_xxzzz_zzzz = cbuffer.data(hg_off + 149);

            auto g_xyyyy_xxxx = cbuffer.data(hg_off + 150);

            auto g_xyyyy_xxxy = cbuffer.data(hg_off + 151);

            auto g_xyyyy_xxxz = cbuffer.data(hg_off + 152);

            auto g_xyyyy_xxyy = cbuffer.data(hg_off + 153);

            auto g_xyyyy_xxyz = cbuffer.data(hg_off + 154);

            auto g_xyyyy_xxzz = cbuffer.data(hg_off + 155);

            auto g_xyyyy_xyyy = cbuffer.data(hg_off + 156);

            auto g_xyyyy_xyyz = cbuffer.data(hg_off + 157);

            auto g_xyyyy_xyzz = cbuffer.data(hg_off + 158);

            auto g_xyyyy_xzzz = cbuffer.data(hg_off + 159);

            auto g_xyyyy_yyyy = cbuffer.data(hg_off + 160);

            auto g_xyyyy_yyyz = cbuffer.data(hg_off + 161);

            auto g_xyyyy_yyzz = cbuffer.data(hg_off + 162);

            auto g_xyyyy_yzzz = cbuffer.data(hg_off + 163);

            auto g_xyyyy_zzzz = cbuffer.data(hg_off + 164);

            auto g_xyyyz_xxxx = cbuffer.data(hg_off + 165);

            auto g_xyyyz_xxxy = cbuffer.data(hg_off + 166);

            auto g_xyyyz_xxxz = cbuffer.data(hg_off + 167);

            auto g_xyyyz_xxyy = cbuffer.data(hg_off + 168);

            auto g_xyyyz_xxyz = cbuffer.data(hg_off + 169);

            auto g_xyyyz_xxzz = cbuffer.data(hg_off + 170);

            auto g_xyyyz_xyyy = cbuffer.data(hg_off + 171);

            auto g_xyyyz_xyyz = cbuffer.data(hg_off + 172);

            auto g_xyyyz_xyzz = cbuffer.data(hg_off + 173);

            auto g_xyyyz_xzzz = cbuffer.data(hg_off + 174);

            auto g_xyyyz_yyyy = cbuffer.data(hg_off + 175);

            auto g_xyyyz_yyyz = cbuffer.data(hg_off + 176);

            auto g_xyyyz_yyzz = cbuffer.data(hg_off + 177);

            auto g_xyyyz_yzzz = cbuffer.data(hg_off + 178);

            auto g_xyyyz_zzzz = cbuffer.data(hg_off + 179);

            auto g_xyyzz_xxxx = cbuffer.data(hg_off + 180);

            auto g_xyyzz_xxxy = cbuffer.data(hg_off + 181);

            auto g_xyyzz_xxxz = cbuffer.data(hg_off + 182);

            auto g_xyyzz_xxyy = cbuffer.data(hg_off + 183);

            auto g_xyyzz_xxyz = cbuffer.data(hg_off + 184);

            auto g_xyyzz_xxzz = cbuffer.data(hg_off + 185);

            auto g_xyyzz_xyyy = cbuffer.data(hg_off + 186);

            auto g_xyyzz_xyyz = cbuffer.data(hg_off + 187);

            auto g_xyyzz_xyzz = cbuffer.data(hg_off + 188);

            auto g_xyyzz_xzzz = cbuffer.data(hg_off + 189);

            auto g_xyyzz_yyyy = cbuffer.data(hg_off + 190);

            auto g_xyyzz_yyyz = cbuffer.data(hg_off + 191);

            auto g_xyyzz_yyzz = cbuffer.data(hg_off + 192);

            auto g_xyyzz_yzzz = cbuffer.data(hg_off + 193);

            auto g_xyyzz_zzzz = cbuffer.data(hg_off + 194);

            auto g_xyzzz_xxxx = cbuffer.data(hg_off + 195);

            auto g_xyzzz_xxxy = cbuffer.data(hg_off + 196);

            auto g_xyzzz_xxxz = cbuffer.data(hg_off + 197);

            auto g_xyzzz_xxyy = cbuffer.data(hg_off + 198);

            auto g_xyzzz_xxyz = cbuffer.data(hg_off + 199);

            auto g_xyzzz_xxzz = cbuffer.data(hg_off + 200);

            auto g_xyzzz_xyyy = cbuffer.data(hg_off + 201);

            auto g_xyzzz_xyyz = cbuffer.data(hg_off + 202);

            auto g_xyzzz_xyzz = cbuffer.data(hg_off + 203);

            auto g_xyzzz_xzzz = cbuffer.data(hg_off + 204);

            auto g_xyzzz_yyyy = cbuffer.data(hg_off + 205);

            auto g_xyzzz_yyyz = cbuffer.data(hg_off + 206);

            auto g_xyzzz_yyzz = cbuffer.data(hg_off + 207);

            auto g_xyzzz_yzzz = cbuffer.data(hg_off + 208);

            auto g_xyzzz_zzzz = cbuffer.data(hg_off + 209);

            auto g_xzzzz_xxxx = cbuffer.data(hg_off + 210);

            auto g_xzzzz_xxxy = cbuffer.data(hg_off + 211);

            auto g_xzzzz_xxxz = cbuffer.data(hg_off + 212);

            auto g_xzzzz_xxyy = cbuffer.data(hg_off + 213);

            auto g_xzzzz_xxyz = cbuffer.data(hg_off + 214);

            auto g_xzzzz_xxzz = cbuffer.data(hg_off + 215);

            auto g_xzzzz_xyyy = cbuffer.data(hg_off + 216);

            auto g_xzzzz_xyyz = cbuffer.data(hg_off + 217);

            auto g_xzzzz_xyzz = cbuffer.data(hg_off + 218);

            auto g_xzzzz_xzzz = cbuffer.data(hg_off + 219);

            auto g_xzzzz_yyyy = cbuffer.data(hg_off + 220);

            auto g_xzzzz_yyyz = cbuffer.data(hg_off + 221);

            auto g_xzzzz_yyzz = cbuffer.data(hg_off + 222);

            auto g_xzzzz_yzzz = cbuffer.data(hg_off + 223);

            auto g_xzzzz_zzzz = cbuffer.data(hg_off + 224);
            ...
            auto g_yyyyz_xxxx = cbuffer.data(hg_off + 240);

            auto g_yyyyz_xxxy = cbuffer.data(hg_off + 241);

            auto g_yyyyz_xxxz = cbuffer.data(hg_off + 242);

            auto g_yyyyz_xxyy = cbuffer.data(hg_off + 243);

            auto g_yyyyz_xxyz = cbuffer.data(hg_off + 244);

            auto g_yyyyz_xxzz = cbuffer.data(hg_off + 245);

            auto g_yyyyz_xyyy = cbuffer.data(hg_off + 246);

            auto g_yyyyz_xyyz = cbuffer.data(hg_off + 247);

            auto g_yyyyz_xyzz = cbuffer.data(hg_off + 248);

            auto g_yyyyz_xzzz = cbuffer.data(hg_off + 249);

            auto g_yyyyz_yyyy = cbuffer.data(hg_off + 250);

            auto g_yyyyz_yyyz = cbuffer.data(hg_off + 251);

            auto g_yyyyz_yyzz = cbuffer.data(hg_off + 252);

            auto g_yyyyz_yzzz = cbuffer.data(hg_off + 253);

            auto g_yyyyz_zzzz = cbuffer.data(hg_off + 254);

            auto g_yyyzz_xxxx = cbuffer.data(hg_off + 255);

            auto g_yyyzz_xxxy = cbuffer.data(hg_off + 256);

            auto g_yyyzz_xxxz = cbuffer.data(hg_off + 257);

            auto g_yyyzz_xxyy = cbuffer.data(hg_off + 258);

            auto g_yyyzz_xxyz = cbuffer.data(hg_off + 259);

            auto g_yyyzz_xxzz = cbuffer.data(hg_off + 260);

            auto g_yyyzz_xyyy = cbuffer.data(hg_off + 261);

            auto g_yyyzz_xyyz = cbuffer.data(hg_off + 262);

            auto g_yyyzz_xyzz = cbuffer.data(hg_off + 263);

            auto g_yyyzz_xzzz = cbuffer.data(hg_off + 264);

            auto g_yyyzz_yyyy = cbuffer.data(hg_off + 265);

            auto g_yyyzz_yyyz = cbuffer.data(hg_off + 266);

            auto g_yyyzz_yyzz = cbuffer.data(hg_off + 267);

            auto g_yyyzz_yzzz = cbuffer.data(hg_off + 268);

            auto g_yyyzz_zzzz = cbuffer.data(hg_off + 269);

            auto g_yyzzz_xxxx = cbuffer.data(hg_off + 270);

            auto g_yyzzz_xxxy = cbuffer.data(hg_off + 271);

            auto g_yyzzz_xxxz = cbuffer.data(hg_off + 272);

            auto g_yyzzz_xxyy = cbuffer.data(hg_off + 273);

            auto g_yyzzz_xxyz = cbuffer.data(hg_off + 274);

            auto g_yyzzz_xxzz = cbuffer.data(hg_off + 275);

            auto g_yyzzz_xyyy = cbuffer.data(hg_off + 276);

            auto g_yyzzz_xyyz = cbuffer.data(hg_off + 277);

            auto g_yyzzz_xyzz = cbuffer.data(hg_off + 278);

            auto g_yyzzz_xzzz = cbuffer.data(hg_off + 279);

            auto g_yyzzz_yyyy = cbuffer.data(hg_off + 280);

            auto g_yyzzz_yyyz = cbuffer.data(hg_off + 281);

            auto g_yyzzz_yyzz = cbuffer.data(hg_off + 282);

            auto g_yyzzz_yzzz = cbuffer.data(hg_off + 283);

            auto g_yyzzz_zzzz = cbuffer.data(hg_off + 284);

            auto g_yzzzz_xxxx = cbuffer.data(hg_off + 285);

            auto g_yzzzz_xxxy = cbuffer.data(hg_off + 286);

            auto g_yzzzz_xxxz = cbuffer.data(hg_off + 287);

            auto g_yzzzz_xxyy = cbuffer.data(hg_off + 288);

            auto g_yzzzz_xxyz = cbuffer.data(hg_off + 289);

            auto g_yzzzz_xxzz = cbuffer.data(hg_off + 290);

            auto g_yzzzz_xyyy = cbuffer.data(hg_off + 291);

            auto g_yzzzz_xyyz = cbuffer.data(hg_off + 292);

            auto g_yzzzz_xyzz = cbuffer.data(hg_off + 293);

            auto g_yzzzz_xzzz = cbuffer.data(hg_off + 294);

            auto g_yzzzz_yyyy = cbuffer.data(hg_off + 295);

            auto g_yzzzz_yyyz = cbuffer.data(hg_off + 296);

            auto g_yzzzz_yyzz = cbuffer.data(hg_off + 297);

            auto g_yzzzz_yzzz = cbuffer.data(hg_off + 298);

            auto g_yzzzz_zzzz = cbuffer.data(hg_off + 299);
