#ifndef ElectronRepulsionGeomContrRecDDXX_hpp
#define ElectronRepulsionGeomContrRecDDXX_hpp
...
/// @param idx_geom_ddxx The contracted integrals buffer.
...
#endif /* ElectronRepulsionGeomContrRecDDXX_hpp */
