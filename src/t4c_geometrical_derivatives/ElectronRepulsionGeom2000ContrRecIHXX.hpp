#ifndef ElectronRepulsionGeom2000ContrRecIHXX_hpp
#define ElectronRepulsionGeom2000ContrRecIHXX_hpp
...
/// @param idx_geom_20_ihxx The contracted integrals buffer.
...
auto
comp_bra_geom20_hrr_electron_repulsion_ihxx(CSimdArray<double>& cbuffer,
                                            const size_t idx_geom_20_ihxx,
...
#endif /* ElectronRepulsionGeom2000ContrRecIHXX_hpp */
