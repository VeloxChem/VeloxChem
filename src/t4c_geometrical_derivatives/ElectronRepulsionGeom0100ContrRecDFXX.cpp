                                            ...
                                            const int d_angmom) -> void
{
    ...
    for (int i = 0; i < ccomps; i++)
    {
        for (int j = 0; j < dcomps; j++)
        {
            ...
            #pragma omp simd aligned(g_0_x_x_xxx, g_0_x_x_xxxx, g_0_x_x_xxxy, g_0_x_x_xxxz, g_0_x_x_xxy, g_0_x_x_xxyy, g_0_x_x_xxyz, g_0_x_x_xxz, g_0_x_x_xxzz, g_0_x_x_xyy, g_0_x_x_xyyy, g_0_x_x_xyyz, g_0_x_x_xyz, g_0_x_x_xyzz, g_0_x_x_xzz, g_0_x_x_xzzz, g_0_x_x_yyy, g_0_x_x_yyz, g_0_x_x_yzz, g_0_x_x_zzz, g_0_x_xx_xxx, g_0_x_xx_xxy, g_0_x_xx_xxz, g_0_x_xx_xyy, g_0_x_xx_xyz, g_0_x_xx_xzz, g_0_x_xx_yyy, g_0_x_xx_yyz, g_0_x_xx_yzz, g_0_x_xx_zzz, g_x_xxx, g_x_xxy, g_x_xxz, g_x_xyy, g_x_xyz, g_x_xzz, g_x_yyy, g_x_yyz, g_x_yzz, g_x_zzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_x_xx_xxx[k] = g_x_xxx[k] - g_0_x_x_xxx[k] * ab_x + g_0_x_x_xxxx[k];

                g_0_x_xx_xxy[k] = g_x_xxy[k] - g_0_x_x_xxy[k] * ab_x + g_0_x_x_xxxy[k];

                g_0_x_xx_xxz[k] = g_x_xxz[k] - g_0_x_x_xxz[k] * ab_x + g_0_x_x_xxxz[k];

                g_0_x_xx_xyy[k] = g_x_xyy[k] - g_0_x_x_xyy[k] * ab_x + g_0_x_x_xxyy[k];

                g_0_x_xx_xyz[k] = g_x_xyz[k] - g_0_x_x_xyz[k] * ab_x + g_0_x_x_xxyz[k];

                g_0_x_xx_xzz[k] = g_x_xzz[k] - g_0_x_x_xzz[k] * ab_x + g_0_x_x_xxzz[k];

                g_0_x_xx_yyy[k] = g_x_yyy[k] - g_0_x_x_yyy[k] * ab_x + g_0_x_x_xyyy[k];

                g_0_x_xx_yyz[k] = g_x_yyz[k] - g_0_x_x_yyz[k] * ab_x + g_0_x_x_xyyz[k];

                g_0_x_xx_yzz[k] = g_x_yzz[k] - g_0_x_x_yzz[k] * ab_x + g_0_x_x_xyzz[k];

                g_0_x_xx_zzz[k] = g_x_zzz[k] - g_0_x_x_zzz[k] * ab_x + g_0_x_x_xzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_x_x_xxx, g_0_x_x_xxxy, g_0_x_x_xxy, g_0_x_x_xxyy, g_0_x_x_xxyz, g_0_x_x_xxz, g_0_x_x_xyy, g_0_x_x_xyyy, g_0_x_x_xyyz, g_0_x_x_xyz, g_0_x_x_xyzz, g_0_x_x_xzz, g_0_x_x_yyy, g_0_x_x_yyyy, g_0_x_x_yyyz, g_0_x_x_yyz, g_0_x_x_yyzz, g_0_x_x_yzz, g_0_x_x_yzzz, g_0_x_x_zzz, g_0_x_xy_xxx, g_0_x_xy_xxy, g_0_x_xy_xxz, g_0_x_xy_xyy, g_0_x_xy_xyz, g_0_x_xy_xzz, g_0_x_xy_yyy, g_0_x_xy_yyz, g_0_x_xy_yzz, g_0_x_xy_zzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_x_xy_xxx[k] = -g_0_x_x_xxx[k] * ab_y + g_0_x_x_xxxy[k];

                g_0_x_xy_xxy[k] = -g_0_x_x_xxy[k] * ab_y + g_0_x_x_xxyy[k];

                g_0_x_xy_xxz[k] = -g_0_x_x_xxz[k] * ab_y + g_0_x_x_xxyz[k];

                g_0_x_xy_xyy[k] = -g_0_x_x_xyy[k] * ab_y + g_0_x_x_xyyy[k];

                g_0_x_xy_xyz[k] = -g_0_x_x_xyz[k] * ab_y + g_0_x_x_xyyz[k];

                g_0_x_xy_xzz[k] = -g_0_x_x_xzz[k] * ab_y + g_0_x_x_xyzz[k];

                g_0_x_xy_yyy[k] = -g_0_x_x_yyy[k] * ab_y + g_0_x_x_yyyy[k];

                g_0_x_xy_yyz[k] = -g_0_x_x_yyz[k] * ab_y + g_0_x_x_yyyz[k];

                g_0_x_xy_yzz[k] = -g_0_x_x_yzz[k] * ab_y + g_0_x_x_yyzz[k];

                g_0_x_xy_zzz[k] = -g_0_x_x_zzz[k] * ab_y + g_0_x_x_yzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_x_x_xxx, g_0_x_x_xxxz, g_0_x_x_xxy, g_0_x_x_xxyz, g_0_x_x_xxz, g_0_x_x_xxzz, g_0_x_x_xyy, g_0_x_x_xyyz, g_0_x_x_xyz, g_0_x_x_xyzz, g_0_x_x_xzz, g_0_x_x_xzzz, g_0_x_x_yyy, g_0_x_x_yyyz, g_0_x_x_yyz, g_0_x_x_yyzz, g_0_x_x_yzz, g_0_x_x_yzzz, g_0_x_x_zzz, g_0_x_x_zzzz, g_0_x_xz_xxx, g_0_x_xz_xxy, g_0_x_xz_xxz, g_0_x_xz_xyy, g_0_x_xz_xyz, g_0_x_xz_xzz, g_0_x_xz_yyy, g_0_x_xz_yyz, g_0_x_xz_yzz, g_0_x_xz_zzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_x_xz_xxx[k] = -g_0_x_x_xxx[k] * ab_z + g_0_x_x_xxxz[k];

                g_0_x_xz_xxy[k] = -g_0_x_x_xxy[k] * ab_z + g_0_x_x_xxyz[k];

                g_0_x_xz_xxz[k] = -g_0_x_x_xxz[k] * ab_z + g_0_x_x_xxzz[k];

                g_0_x_xz_xyy[k] = -g_0_x_x_xyy[k] * ab_z + g_0_x_x_xyyz[k];

                g_0_x_xz_xyz[k] = -g_0_x_x_xyz[k] * ab_z + g_0_x_x_xyzz[k];

                g_0_x_xz_xzz[k] = -g_0_x_x_xzz[k] * ab_z + g_0_x_x_xzzz[k];

                g_0_x_xz_yyy[k] = -g_0_x_x_yyy[k] * ab_z + g_0_x_x_yyyz[k];

                g_0_x_xz_yyz[k] = -g_0_x_x_yyz[k] * ab_z + g_0_x_x_yyzz[k];

                g_0_x_xz_yzz[k] = -g_0_x_x_yzz[k] * ab_z + g_0_x_x_yzzz[k];

                g_0_x_xz_zzz[k] = -g_0_x_x_zzz[k] * ab_z + g_0_x_x_zzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_x_y_xxx, g_0_x_y_xxxy, g_0_x_y_xxy, g_0_x_y_xxyy, g_0_x_y_xxyz, g_0_x_y_xxz, g_0_x_y_xyy, g_0_x_y_xyyy, g_0_x_y_xyyz, g_0_x_y_xyz, g_0_x_y_xyzz, g_0_x_y_xzz, g_0_x_y_yyy, g_0_x_y_yyyy, g_0_x_y_yyyz, g_0_x_y_yyz, g_0_x_y_yyzz, g_0_x_y_yzz, g_0_x_y_yzzz, g_0_x_y_zzz, g_0_x_yy_xxx, g_0_x_yy_xxy, g_0_x_yy_xxz, g_0_x_yy_xyy, g_0_x_yy_xyz, g_0_x_yy_xzz, g_0_x_yy_yyy, g_0_x_yy_yyz, g_0_x_yy_yzz, g_0_x_yy_zzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_x_yy_xxx[k] = -g_0_x_y_xxx[k] * ab_y + g_0_x_y_xxxy[k];

                g_0_x_yy_xxy[k] = -g_0_x_y_xxy[k] * ab_y + g_0_x_y_xxyy[k];

                g_0_x_yy_xxz[k] = -g_0_x_y_xxz[k] * ab_y + g_0_x_y_xxyz[k];

                g_0_x_yy_xyy[k] = -g_0_x_y_xyy[k] * ab_y + g_0_x_y_xyyy[k];

                g_0_x_yy_xyz[k] = -g_0_x_y_xyz[k] * ab_y + g_0_x_y_xyyz[k];

                g_0_x_yy_xzz[k] = -g_0_x_y_xzz[k] * ab_y + g_0_x_y_xyzz[k];

                g_0_x_yy_yyy[k] = -g_0_x_y_yyy[k] * ab_y + g_0_x_y_yyyy[k];

                g_0_x_yy_yyz[k] = -g_0_x_y_yyz[k] * ab_y + g_0_x_y_yyyz[k];

                g_0_x_yy_yzz[k] = -g_0_x_y_yzz[k] * ab_y + g_0_x_y_yyzz[k];

                g_0_x_yy_zzz[k] = -g_0_x_y_zzz[k] * ab_y + g_0_x_y_yzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_x_yz_xxx, g_0_x_yz_xxy, g_0_x_yz_xxz, g_0_x_yz_xyy, g_0_x_yz_xyz, g_0_x_yz_xzz, g_0_x_yz_yyy, g_0_x_yz_yyz, g_0_x_yz_yzz, g_0_x_yz_zzz, g_0_x_z_xxx, g_0_x_z_xxxy, g_0_x_z_xxy, g_0_x_z_xxyy, g_0_x_z_xxyz, g_0_x_z_xxz, g_0_x_z_xyy, g_0_x_z_xyyy, g_0_x_z_xyyz, g_0_x_z_xyz, g_0_x_z_xyzz, g_0_x_z_xzz, g_0_x_z_yyy, g_0_x_z_yyyy, g_0_x_z_yyyz, g_0_x_z_yyz, g_0_x_z_yyzz, g_0_x_z_yzz, g_0_x_z_yzzz, g_0_x_z_zzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_x_yz_xxx[k] = -g_0_x_z_xxx[k] * ab_y + g_0_x_z_xxxy[k];

                g_0_x_yz_xxy[k] = -g_0_x_z_xxy[k] * ab_y + g_0_x_z_xxyy[k];

                g_0_x_yz_xxz[k] = -g_0_x_z_xxz[k] * ab_y + g_0_x_z_xxyz[k];

                g_0_x_yz_xyy[k] = -g_0_x_z_xyy[k] * ab_y + g_0_x_z_xyyy[k];

                g_0_x_yz_xyz[k] = -g_0_x_z_xyz[k] * ab_y + g_0_x_z_xyyz[k];

                g_0_x_yz_xzz[k] = -g_0_x_z_xzz[k] * ab_y + g_0_x_z_xyzz[k];

                g_0_x_yz_yyy[k] = -g_0_x_z_yyy[k] * ab_y + g_0_x_z_yyyy[k];

                g_0_x_yz_yyz[k] = -g_0_x_z_yyz[k] * ab_y + g_0_x_z_yyyz[k];

                g_0_x_yz_yzz[k] = -g_0_x_z_yzz[k] * ab_y + g_0_x_z_yyzz[k];

                g_0_x_yz_zzz[k] = -g_0_x_z_zzz[k] * ab_y + g_0_x_z_yzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_x_z_xxx, g_0_x_z_xxxz, g_0_x_z_xxy, g_0_x_z_xxyz, g_0_x_z_xxz, g_0_x_z_xxzz, g_0_x_z_xyy, g_0_x_z_xyyz, g_0_x_z_xyz, g_0_x_z_xyzz, g_0_x_z_xzz, g_0_x_z_xzzz, g_0_x_z_yyy, g_0_x_z_yyyz, g_0_x_z_yyz, g_0_x_z_yyzz, g_0_x_z_yzz, g_0_x_z_yzzz, g_0_x_z_zzz, g_0_x_z_zzzz, g_0_x_zz_xxx, g_0_x_zz_xxy, g_0_x_zz_xxz, g_0_x_zz_xyy, g_0_x_zz_xyz, g_0_x_zz_xzz, g_0_x_zz_yyy, g_0_x_zz_yyz, g_0_x_zz_yzz, g_0_x_zz_zzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_x_zz_xxx[k] = -g_0_x_z_xxx[k] * ab_z + g_0_x_z_xxxz[k];

                g_0_x_zz_xxy[k] = -g_0_x_z_xxy[k] * ab_z + g_0_x_z_xxyz[k];

                g_0_x_zz_xxz[k] = -g_0_x_z_xxz[k] * ab_z + g_0_x_z_xxzz[k];

                g_0_x_zz_xyy[k] = -g_0_x_z_xyy[k] * ab_z + g_0_x_z_xyyz[k];

                g_0_x_zz_xyz[k] = -g_0_x_z_xyz[k] * ab_z + g_0_x_z_xyzz[k];

                g_0_x_zz_xzz[k] = -g_0_x_z_xzz[k] * ab_z + g_0_x_z_xzzz[k];

                g_0_x_zz_yyy[k] = -g_0_x_z_yyy[k] * ab_z + g_0_x_z_yyyz[k];

                g_0_x_zz_yyz[k] = -g_0_x_z_yyz[k] * ab_z + g_0_x_z_yyzz[k];

                g_0_x_zz_yzz[k] = -g_0_x_z_yzz[k] * ab_z + g_0_x_z_yzzz[k];

                g_0_x_zz_zzz[k] = -g_0_x_z_zzz[k] * ab_z + g_0_x_z_zzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_y_x_xxx, g_0_y_x_xxxx, g_0_y_x_xxxy, g_0_y_x_xxxz, g_0_y_x_xxy, g_0_y_x_xxyy, g_0_y_x_xxyz, g_0_y_x_xxz, g_0_y_x_xxzz, g_0_y_x_xyy, g_0_y_x_xyyy, g_0_y_x_xyyz, g_0_y_x_xyz, g_0_y_x_xyzz, g_0_y_x_xzz, g_0_y_x_xzzz, g_0_y_x_yyy, g_0_y_x_yyz, g_0_y_x_yzz, g_0_y_x_zzz, g_0_y_xx_xxx, g_0_y_xx_xxy, g_0_y_xx_xxz, g_0_y_xx_xyy, g_0_y_xx_xyz, g_0_y_xx_xzz, g_0_y_xx_yyy, g_0_y_xx_yyz, g_0_y_xx_yzz, g_0_y_xx_zzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_y_xx_xxx[k] = -g_0_y_x_xxx[k] * ab_x + g_0_y_x_xxxx[k];

                g_0_y_xx_xxy[k] = -g_0_y_x_xxy[k] * ab_x + g_0_y_x_xxxy[k];

                g_0_y_xx_xxz[k] = -g_0_y_x_xxz[k] * ab_x + g_0_y_x_xxxz[k];

                g_0_y_xx_xyy[k] = -g_0_y_x_xyy[k] * ab_x + g_0_y_x_xxyy[k];

                g_0_y_xx_xyz[k] = -g_0_y_x_xyz[k] * ab_x + g_0_y_x_xxyz[k];

                g_0_y_xx_xzz[k] = -g_0_y_x_xzz[k] * ab_x + g_0_y_x_xxzz[k];

                g_0_y_xx_yyy[k] = -g_0_y_x_yyy[k] * ab_x + g_0_y_x_xyyy[k];

                g_0_y_xx_yyz[k] = -g_0_y_x_yyz[k] * ab_x + g_0_y_x_xyyz[k];

                g_0_y_xx_yzz[k] = -g_0_y_x_yzz[k] * ab_x + g_0_y_x_xyzz[k];

                g_0_y_xx_zzz[k] = -g_0_y_x_zzz[k] * ab_x + g_0_y_x_xzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_y_xy_xxx, g_0_y_xy_xxy, g_0_y_xy_xxz, g_0_y_xy_xyy, g_0_y_xy_xyz, g_0_y_xy_xzz, g_0_y_xy_yyy, g_0_y_xy_yyz, g_0_y_xy_yzz, g_0_y_xy_zzz, g_0_y_y_xxx, g_0_y_y_xxxx, g_0_y_y_xxxy, g_0_y_y_xxxz, g_0_y_y_xxy, g_0_y_y_xxyy, g_0_y_y_xxyz, g_0_y_y_xxz, g_0_y_y_xxzz, g_0_y_y_xyy, g_0_y_y_xyyy, g_0_y_y_xyyz, g_0_y_y_xyz, g_0_y_y_xyzz, g_0_y_y_xzz, g_0_y_y_xzzz, g_0_y_y_yyy, g_0_y_y_yyz, g_0_y_y_yzz, g_0_y_y_zzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_y_xy_xxx[k] = -g_0_y_y_xxx[k] * ab_x + g_0_y_y_xxxx[k];

                g_0_y_xy_xxy[k] = -g_0_y_y_xxy[k] * ab_x + g_0_y_y_xxxy[k];

                g_0_y_xy_xxz[k] = -g_0_y_y_xxz[k] * ab_x + g_0_y_y_xxxz[k];

                g_0_y_xy_xyy[k] = -g_0_y_y_xyy[k] * ab_x + g_0_y_y_xxyy[k];

                g_0_y_xy_xyz[k] = -g_0_y_y_xyz[k] * ab_x + g_0_y_y_xxyz[k];

                g_0_y_xy_xzz[k] = -g_0_y_y_xzz[k] * ab_x + g_0_y_y_xxzz[k];

                g_0_y_xy_yyy[k] = -g_0_y_y_yyy[k] * ab_x + g_0_y_y_xyyy[k];

                g_0_y_xy_yyz[k] = -g_0_y_y_yyz[k] * ab_x + g_0_y_y_xyyz[k];

                g_0_y_xy_yzz[k] = -g_0_y_y_yzz[k] * ab_x + g_0_y_y_xyzz[k];

                g_0_y_xy_zzz[k] = -g_0_y_y_zzz[k] * ab_x + g_0_y_y_xzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_y_xz_xxx, g_0_y_xz_xxy, g_0_y_xz_xxz, g_0_y_xz_xyy, g_0_y_xz_xyz, g_0_y_xz_xzz, g_0_y_xz_yyy, g_0_y_xz_yyz, g_0_y_xz_yzz, g_0_y_xz_zzz, g_0_y_z_xxx, g_0_y_z_xxxx, g_0_y_z_xxxy, g_0_y_z_xxxz, g_0_y_z_xxy, g_0_y_z_xxyy, g_0_y_z_xxyz, g_0_y_z_xxz, g_0_y_z_xxzz, g_0_y_z_xyy, g_0_y_z_xyyy, g_0_y_z_xyyz, g_0_y_z_xyz, g_0_y_z_xyzz, g_0_y_z_xzz, g_0_y_z_xzzz, g_0_y_z_yyy, g_0_y_z_yyz, g_0_y_z_yzz, g_0_y_z_zzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_y_xz_xxx[k] = -g_0_y_z_xxx[k] * ab_x + g_0_y_z_xxxx[k];

                g_0_y_xz_xxy[k] = -g_0_y_z_xxy[k] * ab_x + g_0_y_z_xxxy[k];

                g_0_y_xz_xxz[k] = -g_0_y_z_xxz[k] * ab_x + g_0_y_z_xxxz[k];

                g_0_y_xz_xyy[k] = -g_0_y_z_xyy[k] * ab_x + g_0_y_z_xxyy[k];

                g_0_y_xz_xyz[k] = -g_0_y_z_xyz[k] * ab_x + g_0_y_z_xxyz[k];

                g_0_y_xz_xzz[k] = -g_0_y_z_xzz[k] * ab_x + g_0_y_z_xxzz[k];

                g_0_y_xz_yyy[k] = -g_0_y_z_yyy[k] * ab_x + g_0_y_z_xyyy[k];

                g_0_y_xz_yyz[k] = -g_0_y_z_yyz[k] * ab_x + g_0_y_z_xyyz[k];

                g_0_y_xz_yzz[k] = -g_0_y_z_yzz[k] * ab_x + g_0_y_z_xyzz[k];

                g_0_y_xz_zzz[k] = -g_0_y_z_zzz[k] * ab_x + g_0_y_z_xzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_y_y_xxx, g_0_y_y_xxxy, g_0_y_y_xxy, g_0_y_y_xxyy, g_0_y_y_xxyz, g_0_y_y_xxz, g_0_y_y_xyy, g_0_y_y_xyyy, g_0_y_y_xyyz, g_0_y_y_xyz, g_0_y_y_xyzz, g_0_y_y_xzz, g_0_y_y_yyy, g_0_y_y_yyyy, g_0_y_y_yyyz, g_0_y_y_yyz, g_0_y_y_yyzz, g_0_y_y_yzz, g_0_y_y_yzzz, g_0_y_y_zzz, g_0_y_yy_xxx, g_0_y_yy_xxy, g_0_y_yy_xxz, g_0_y_yy_xyy, g_0_y_yy_xyz, g_0_y_yy_xzz, g_0_y_yy_yyy, g_0_y_yy_yyz, g_0_y_yy_yzz, g_0_y_yy_zzz, g_y_xxx, g_y_xxy, g_y_xxz, g_y_xyy, g_y_xyz, g_y_xzz, g_y_yyy, g_y_yyz, g_y_yzz, g_y_zzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_y_yy_xxx[k] = g_y_xxx[k] - g_0_y_y_xxx[k] * ab_y + g_0_y_y_xxxy[k];

                g_0_y_yy_xxy[k] = g_y_xxy[k] - g_0_y_y_xxy[k] * ab_y + g_0_y_y_xxyy[k];

                g_0_y_yy_xxz[k] = g_y_xxz[k] - g_0_y_y_xxz[k] * ab_y + g_0_y_y_xxyz[k];

                g_0_y_yy_xyy[k] = g_y_xyy[k] - g_0_y_y_xyy[k] * ab_y + g_0_y_y_xyyy[k];

                g_0_y_yy_xyz[k] = g_y_xyz[k] - g_0_y_y_xyz[k] * ab_y + g_0_y_y_xyyz[k];

                g_0_y_yy_xzz[k] = g_y_xzz[k] - g_0_y_y_xzz[k] * ab_y + g_0_y_y_xyzz[k];

                g_0_y_yy_yyy[k] = g_y_yyy[k] - g_0_y_y_yyy[k] * ab_y + g_0_y_y_yyyy[k];

                g_0_y_yy_yyz[k] = g_y_yyz[k] - g_0_y_y_yyz[k] * ab_y + g_0_y_y_yyyz[k];

                g_0_y_yy_yzz[k] = g_y_yzz[k] - g_0_y_y_yzz[k] * ab_y + g_0_y_y_yyzz[k];

                g_0_y_yy_zzz[k] = g_y_zzz[k] - g_0_y_y_zzz[k] * ab_y + g_0_y_y_yzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_y_y_xxx, g_0_y_y_xxxz, g_0_y_y_xxy, g_0_y_y_xxyz, g_0_y_y_xxz, g_0_y_y_xxzz, g_0_y_y_xyy, g_0_y_y_xyyz, g_0_y_y_xyz, g_0_y_y_xyzz, g_0_y_y_xzz, g_0_y_y_xzzz, g_0_y_y_yyy, g_0_y_y_yyyz, g_0_y_y_yyz, g_0_y_y_yyzz, g_0_y_y_yzz, g_0_y_y_yzzz, g_0_y_y_zzz, g_0_y_y_zzzz, g_0_y_yz_xxx, g_0_y_yz_xxy, g_0_y_yz_xxz, g_0_y_yz_xyy, g_0_y_yz_xyz, g_0_y_yz_xzz, g_0_y_yz_yyy, g_0_y_yz_yyz, g_0_y_yz_yzz, g_0_y_yz_zzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_y_yz_xxx[k] = -g_0_y_y_xxx[k] * ab_z + g_0_y_y_xxxz[k];

                g_0_y_yz_xxy[k] = -g_0_y_y_xxy[k] * ab_z + g_0_y_y_xxyz[k];

                g_0_y_yz_xxz[k] = -g_0_y_y_xxz[k] * ab_z + g_0_y_y_xxzz[k];

                g_0_y_yz_xyy[k] = -g_0_y_y_xyy[k] * ab_z + g_0_y_y_xyyz[k];

                g_0_y_yz_xyz[k] = -g_0_y_y_xyz[k] * ab_z + g_0_y_y_xyzz[k];

                g_0_y_yz_xzz[k] = -g_0_y_y_xzz[k] * ab_z + g_0_y_y_xzzz[k];

                g_0_y_yz_yyy[k] = -g_0_y_y_yyy[k] * ab_z + g_0_y_y_yyyz[k];

                g_0_y_yz_yyz[k] = -g_0_y_y_yyz[k] * ab_z + g_0_y_y_yyzz[k];

                g_0_y_yz_yzz[k] = -g_0_y_y_yzz[k] * ab_z + g_0_y_y_yzzz[k];

                g_0_y_yz_zzz[k] = -g_0_y_y_zzz[k] * ab_z + g_0_y_y_zzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_y_z_xxx, g_0_y_z_xxxz, g_0_y_z_xxy, g_0_y_z_xxyz, g_0_y_z_xxz, g_0_y_z_xxzz, g_0_y_z_xyy, g_0_y_z_xyyz, g_0_y_z_xyz, g_0_y_z_xyzz, g_0_y_z_xzz, g_0_y_z_xzzz, g_0_y_z_yyy, g_0_y_z_yyyz, g_0_y_z_yyz, g_0_y_z_yyzz, g_0_y_z_yzz, g_0_y_z_yzzz, g_0_y_z_zzz, g_0_y_z_zzzz, g_0_y_zz_xxx, g_0_y_zz_xxy, g_0_y_zz_xxz, g_0_y_zz_xyy, g_0_y_zz_xyz, g_0_y_zz_xzz, g_0_y_zz_yyy, g_0_y_zz_yyz, g_0_y_zz_yzz, g_0_y_zz_zzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_y_zz_xxx[k] = -g_0_y_z_xxx[k] * ab_z + g_0_y_z_xxxz[k];

                g_0_y_zz_xxy[k] = -g_0_y_z_xxy[k] * ab_z + g_0_y_z_xxyz[k];

                g_0_y_zz_xxz[k] = -g_0_y_z_xxz[k] * ab_z + g_0_y_z_xxzz[k];

                g_0_y_zz_xyy[k] = -g_0_y_z_xyy[k] * ab_z + g_0_y_z_xyyz[k];

                g_0_y_zz_xyz[k] = -g_0_y_z_xyz[k] * ab_z + g_0_y_z_xyzz[k];

                g_0_y_zz_xzz[k] = -g_0_y_z_xzz[k] * ab_z + g_0_y_z_xzzz[k];

                g_0_y_zz_yyy[k] = -g_0_y_z_yyy[k] * ab_z + g_0_y_z_yyyz[k];

                g_0_y_zz_yyz[k] = -g_0_y_z_yyz[k] * ab_z + g_0_y_z_yyzz[k];

                g_0_y_zz_yzz[k] = -g_0_y_z_yzz[k] * ab_z + g_0_y_z_yzzz[k];

                g_0_y_zz_zzz[k] = -g_0_y_z_zzz[k] * ab_z + g_0_y_z_zzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_z_x_xxx, g_0_z_x_xxxx, g_0_z_x_xxxy, g_0_z_x_xxxz, g_0_z_x_xxy, g_0_z_x_xxyy, g_0_z_x_xxyz, g_0_z_x_xxz, g_0_z_x_xxzz, g_0_z_x_xyy, g_0_z_x_xyyy, g_0_z_x_xyyz, g_0_z_x_xyz, g_0_z_x_xyzz, g_0_z_x_xzz, g_0_z_x_xzzz, g_0_z_x_yyy, g_0_z_x_yyz, g_0_z_x_yzz, g_0_z_x_zzz, g_0_z_xx_xxx, g_0_z_xx_xxy, g_0_z_xx_xxz, g_0_z_xx_xyy, g_0_z_xx_xyz, g_0_z_xx_xzz, g_0_z_xx_yyy, g_0_z_xx_yyz, g_0_z_xx_yzz, g_0_z_xx_zzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_z_xx_xxx[k] = -g_0_z_x_xxx[k] * ab_x + g_0_z_x_xxxx[k];

                g_0_z_xx_xxy[k] = -g_0_z_x_xxy[k] * ab_x + g_0_z_x_xxxy[k];

                g_0_z_xx_xxz[k] = -g_0_z_x_xxz[k] * ab_x + g_0_z_x_xxxz[k];

                g_0_z_xx_xyy[k] = -g_0_z_x_xyy[k] * ab_x + g_0_z_x_xxyy[k];

                g_0_z_xx_xyz[k] = -g_0_z_x_xyz[k] * ab_x + g_0_z_x_xxyz[k];

                g_0_z_xx_xzz[k] = -g_0_z_x_xzz[k] * ab_x + g_0_z_x_xxzz[k];

                g_0_z_xx_yyy[k] = -g_0_z_x_yyy[k] * ab_x + g_0_z_x_xyyy[k];

                g_0_z_xx_yyz[k] = -g_0_z_x_yyz[k] * ab_x + g_0_z_x_xyyz[k];

                g_0_z_xx_yzz[k] = -g_0_z_x_yzz[k] * ab_x + g_0_z_x_xyzz[k];

                g_0_z_xx_zzz[k] = -g_0_z_x_zzz[k] * ab_x + g_0_z_x_xzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_z_xy_xxx, g_0_z_xy_xxy, g_0_z_xy_xxz, g_0_z_xy_xyy, g_0_z_xy_xyz, g_0_z_xy_xzz, g_0_z_xy_yyy, g_0_z_xy_yyz, g_0_z_xy_yzz, g_0_z_xy_zzz, g_0_z_y_xxx, g_0_z_y_xxxx, g_0_z_y_xxxy, g_0_z_y_xxxz, g_0_z_y_xxy, g_0_z_y_xxyy, g_0_z_y_xxyz, g_0_z_y_xxz, g_0_z_y_xxzz, g_0_z_y_xyy, g_0_z_y_xyyy, g_0_z_y_xyyz, g_0_z_y_xyz, g_0_z_y_xyzz, g_0_z_y_xzz, g_0_z_y_xzzz, g_0_z_y_yyy, g_0_z_y_yyz, g_0_z_y_yzz, g_0_z_y_zzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_z_xy_xxx[k] = -g_0_z_y_xxx[k] * ab_x + g_0_z_y_xxxx[k];

                g_0_z_xy_xxy[k] = -g_0_z_y_xxy[k] * ab_x + g_0_z_y_xxxy[k];

                g_0_z_xy_xxz[k] = -g_0_z_y_xxz[k] * ab_x + g_0_z_y_xxxz[k];

                g_0_z_xy_xyy[k] = -g_0_z_y_xyy[k] * ab_x + g_0_z_y_xxyy[k];

                g_0_z_xy_xyz[k] = -g_0_z_y_xyz[k] * ab_x + g_0_z_y_xxyz[k];

                g_0_z_xy_xzz[k] = -g_0_z_y_xzz[k] * ab_x + g_0_z_y_xxzz[k];

                g_0_z_xy_yyy[k] = -g_0_z_y_yyy[k] * ab_x + g_0_z_y_xyyy[k];

                g_0_z_xy_yyz[k] = -g_0_z_y_yyz[k] * ab_x + g_0_z_y_xyyz[k];

                g_0_z_xy_yzz[k] = -g_0_z_y_yzz[k] * ab_x + g_0_z_y_xyzz[k];

                g_0_z_xy_zzz[k] = -g_0_z_y_zzz[k] * ab_x + g_0_z_y_xzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_z_xz_xxx, g_0_z_xz_xxy, g_0_z_xz_xxz, g_0_z_xz_xyy, g_0_z_xz_xyz, g_0_z_xz_xzz, g_0_z_xz_yyy, g_0_z_xz_yyz, g_0_z_xz_yzz, g_0_z_xz_zzz, g_0_z_z_xxx, g_0_z_z_xxxx, g_0_z_z_xxxy, g_0_z_z_xxxz, g_0_z_z_xxy, g_0_z_z_xxyy, g_0_z_z_xxyz, g_0_z_z_xxz, g_0_z_z_xxzz, g_0_z_z_xyy, g_0_z_z_xyyy, g_0_z_z_xyyz, g_0_z_z_xyz, g_0_z_z_xyzz, g_0_z_z_xzz, g_0_z_z_xzzz, g_0_z_z_yyy, g_0_z_z_yyz, g_0_z_z_yzz, g_0_z_z_zzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_z_xz_xxx[k] = -g_0_z_z_xxx[k] * ab_x + g_0_z_z_xxxx[k];

                g_0_z_xz_xxy[k] = -g_0_z_z_xxy[k] * ab_x + g_0_z_z_xxxy[k];

                g_0_z_xz_xxz[k] = -g_0_z_z_xxz[k] * ab_x + g_0_z_z_xxxz[k];

                g_0_z_xz_xyy[k] = -g_0_z_z_xyy[k] * ab_x + g_0_z_z_xxyy[k];

                g_0_z_xz_xyz[k] = -g_0_z_z_xyz[k] * ab_x + g_0_z_z_xxyz[k];

                g_0_z_xz_xzz[k] = -g_0_z_z_xzz[k] * ab_x + g_0_z_z_xxzz[k];

                g_0_z_xz_yyy[k] = -g_0_z_z_yyy[k] * ab_x + g_0_z_z_xyyy[k];

                g_0_z_xz_yyz[k] = -g_0_z_z_yyz[k] * ab_x + g_0_z_z_xyyz[k];

                g_0_z_xz_yzz[k] = -g_0_z_z_yzz[k] * ab_x + g_0_z_z_xyzz[k];

                g_0_z_xz_zzz[k] = -g_0_z_z_zzz[k] * ab_x + g_0_z_z_xzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_z_y_xxx, g_0_z_y_xxxy, g_0_z_y_xxy, g_0_z_y_xxyy, g_0_z_y_xxyz, g_0_z_y_xxz, g_0_z_y_xyy, g_0_z_y_xyyy, g_0_z_y_xyyz, g_0_z_y_xyz, g_0_z_y_xyzz, g_0_z_y_xzz, g_0_z_y_yyy, g_0_z_y_yyyy, g_0_z_y_yyyz, g_0_z_y_yyz, g_0_z_y_yyzz, g_0_z_y_yzz, g_0_z_y_yzzz, g_0_z_y_zzz, g_0_z_yy_xxx, g_0_z_yy_xxy, g_0_z_yy_xxz, g_0_z_yy_xyy, g_0_z_yy_xyz, g_0_z_yy_xzz, g_0_z_yy_yyy, g_0_z_yy_yyz, g_0_z_yy_yzz, g_0_z_yy_zzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_z_yy_xxx[k] = -g_0_z_y_xxx[k] * ab_y + g_0_z_y_xxxy[k];

                g_0_z_yy_xxy[k] = -g_0_z_y_xxy[k] * ab_y + g_0_z_y_xxyy[k];

                g_0_z_yy_xxz[k] = -g_0_z_y_xxz[k] * ab_y + g_0_z_y_xxyz[k];

                g_0_z_yy_xyy[k] = -g_0_z_y_xyy[k] * ab_y + g_0_z_y_xyyy[k];

                g_0_z_yy_xyz[k] = -g_0_z_y_xyz[k] * ab_y + g_0_z_y_xyyz[k];

                g_0_z_yy_xzz[k] = -g_0_z_y_xzz[k] * ab_y + g_0_z_y_xyzz[k];

                g_0_z_yy_yyy[k] = -g_0_z_y_yyy[k] * ab_y + g_0_z_y_yyyy[k];

                g_0_z_yy_yyz[k] = -g_0_z_y_yyz[k] * ab_y + g_0_z_y_yyyz[k];

                g_0_z_yy_yzz[k] = -g_0_z_y_yzz[k] * ab_y + g_0_z_y_yyzz[k];

                g_0_z_yy_zzz[k] = -g_0_z_y_zzz[k] * ab_y + g_0_z_y_yzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_z_yz_xxx, g_0_z_yz_xxy, g_0_z_yz_xxz, g_0_z_yz_xyy, g_0_z_yz_xyz, g_0_z_yz_xzz, g_0_z_yz_yyy, g_0_z_yz_yyz, g_0_z_yz_yzz, g_0_z_yz_zzz, g_0_z_z_xxx, g_0_z_z_xxxy, g_0_z_z_xxy, g_0_z_z_xxyy, g_0_z_z_xxyz, g_0_z_z_xxz, g_0_z_z_xyy, g_0_z_z_xyyy, g_0_z_z_xyyz, g_0_z_z_xyz, g_0_z_z_xyzz, g_0_z_z_xzz, g_0_z_z_yyy, g_0_z_z_yyyy, g_0_z_z_yyyz, g_0_z_z_yyz, g_0_z_z_yyzz, g_0_z_z_yzz, g_0_z_z_yzzz, g_0_z_z_zzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_z_yz_xxx[k] = -g_0_z_z_xxx[k] * ab_y + g_0_z_z_xxxy[k];

                g_0_z_yz_xxy[k] = -g_0_z_z_xxy[k] * ab_y + g_0_z_z_xxyy[k];

                g_0_z_yz_xxz[k] = -g_0_z_z_xxz[k] * ab_y + g_0_z_z_xxyz[k];

                g_0_z_yz_xyy[k] = -g_0_z_z_xyy[k] * ab_y + g_0_z_z_xyyy[k];

                g_0_z_yz_xyz[k] = -g_0_z_z_xyz[k] * ab_y + g_0_z_z_xyyz[k];

                g_0_z_yz_xzz[k] = -g_0_z_z_xzz[k] * ab_y + g_0_z_z_xyzz[k];

                g_0_z_yz_yyy[k] = -g_0_z_z_yyy[k] * ab_y + g_0_z_z_yyyy[k];

                g_0_z_yz_yyz[k] = -g_0_z_z_yyz[k] * ab_y + g_0_z_z_yyyz[k];

                g_0_z_yz_yzz[k] = -g_0_z_z_yzz[k] * ab_y + g_0_z_z_yyzz[k];

                g_0_z_yz_zzz[k] = -g_0_z_z_zzz[k] * ab_y + g_0_z_z_yzzz[k];
            }
            ...
            #pragma omp simd aligned(g_0_z_z_xxx, g_0_z_z_xxxz, g_0_z_z_xxy, g_0_z_z_xxyz, g_0_z_z_xxz, g_0_z_z_xxzz, g_0_z_z_xyy, g_0_z_z_xyyz, g_0_z_z_xyz, g_0_z_z_xyzz, g_0_z_z_xzz, g_0_z_z_xzzz, g_0_z_z_yyy, g_0_z_z_yyyz, g_0_z_z_yyz, g_0_z_z_yyzz, g_0_z_z_yzz, g_0_z_z_yzzz, g_0_z_z_zzz, g_0_z_z_zzzz, g_0_z_zz_xxx, g_0_z_zz_xxy, g_0_z_zz_xxz, g_0_z_zz_xyy, g_0_z_zz_xyz, g_0_z_zz_xzz, g_0_z_zz_yyy, g_0_z_zz_yyz, g_0_z_zz_yzz, g_0_z_zz_zzz, g_z_xxx, g_z_xxy, g_z_xxz, g_z_xyy, g_z_xyz, g_z_xzz, g_z_yyy, g_z_yyz, g_z_yzz, g_z_zzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_0_z_zz_xxx[k] = g_z_xxx[k] - g_0_z_z_xxx[k] * ab_z + g_0_z_z_xxxz[k];

                g_0_z_zz_xxy[k] = g_z_xxy[k] - g_0_z_z_xxy[k] * ab_z + g_0_z_z_xxyz[k];

                g_0_z_zz_xxz[k] = g_z_xxz[k] - g_0_z_z_xxz[k] * ab_z + g_0_z_z_xxzz[k];

                g_0_z_zz_xyy[k] = g_z_xyy[k] - g_0_z_z_xyy[k] * ab_z + g_0_z_z_xyyz[k];

                g_0_z_zz_xyz[k] = g_z_xyz[k] - g_0_z_z_xyz[k] * ab_z + g_0_z_z_xyzz[k];

                g_0_z_zz_xzz[k] = g_z_xzz[k] - g_0_z_z_xzz[k] * ab_z + g_0_z_z_xzzz[k];

                g_0_z_zz_yyy[k] = g_z_yyy[k] - g_0_z_z_yyy[k] * ab_z + g_0_z_z_yyyz[k];

                g_0_z_zz_yyz[k] = g_z_yyz[k] - g_0_z_z_yyz[k] * ab_z + g_0_z_z_yyzz[k];

                g_0_z_zz_yzz[k] = g_z_yzz[k] - g_0_z_z_yzz[k] * ab_z + g_0_z_z_yzzz[k];

                g_0_z_zz_zzz[k] = g_z_zzz[k] - g_0_z_z_zzz[k] * ab_z + g_0_z_z_zzzz[k];
            }
        }
    }
}
