#include "ElectronRepulsionGeom1000ContrRecPIXX.hpp"
                                            ...
                                            const int d_angmom) -> void
{
    ...
    for (int i = 0; i < ccomps; i++)
    {
        for (int j = 0; j < dcomps; j++)
        {
            ...
            const auto sk_geom_10_off = idx_geom_10_skxx + i * dcomps + j;

            auto g_x_0_0_xxxxxxx = cbuffer.data(sk_geom_10_off + 0 * ccomps * dcomps);

            auto g_x_0_0_xxxxxxy = cbuffer.data(sk_geom_10_off + 1 * ccomps * dcomps);

            auto g_x_0_0_xxxxxxz = cbuffer.data(sk_geom_10_off + 2 * ccomps * dcomps);

            auto g_x_0_0_xxxxxyy = cbuffer.data(sk_geom_10_off + 3 * ccomps * dcomps);

            auto g_x_0_0_xxxxxyz = cbuffer.data(sk_geom_10_off + 4 * ccomps * dcomps);

            auto g_x_0_0_xxxxxzz = cbuffer.data(sk_geom_10_off + 5 * ccomps * dcomps);

            auto g_x_0_0_xxxxyyy = cbuffer.data(sk_geom_10_off + 6 * ccomps * dcomps);

            auto g_x_0_0_xxxxyyz = cbuffer.data(sk_geom_10_off + 7 * ccomps * dcomps);

            auto g_x_0_0_xxxxyzz = cbuffer.data(sk_geom_10_off + 8 * ccomps * dcomps);

            auto g_x_0_0_xxxxzzz = cbuffer.data(sk_geom_10_off + 9 * ccomps * dcomps);

            auto g_x_0_0_xxxyyyy = cbuffer.data(sk_geom_10_off + 10 * ccomps * dcomps);

            auto g_x_0_0_xxxyyyz = cbuffer.data(sk_geom_10_off + 11 * ccomps * dcomps);

            auto g_x_0_0_xxxyyzz = cbuffer.data(sk_geom_10_off + 12 * ccomps * dcomps);

            auto g_x_0_0_xxxyzzz = cbuffer.data(sk_geom_10_off + 13 * ccomps * dcomps);

            auto g_x_0_0_xxxzzzz = cbuffer.data(sk_geom_10_off + 14 * ccomps * dcomps);

            auto g_x_0_0_xxyyyyy = cbuffer.data(sk_geom_10_off + 15 * ccomps * dcomps);

            auto g_x_0_0_xxyyyyz = cbuffer.data(sk_geom_10_off + 16 * ccomps * dcomps);

            auto g_x_0_0_xxyyyzz = cbuffer.data(sk_geom_10_off + 17 * ccomps * dcomps);

            auto g_x_0_0_xxyyzzz = cbuffer.data(sk_geom_10_off + 18 * ccomps * dcomps);

            auto g_x_0_0_xxyzzzz = cbuffer.data(sk_geom_10_off + 19 * ccomps * dcomps);

            auto g_x_0_0_xxzzzzz = cbuffer.data(sk_geom_10_off + 20 * ccomps * dcomps);

            auto g_x_0_0_xyyyyyy = cbuffer.data(sk_geom_10_off + 21 * ccomps * dcomps);

            auto g_x_0_0_xyyyyyz = cbuffer.data(sk_geom_10_off + 22 * ccomps * dcomps);

            auto g_x_0_0_xyyyyzz = cbuffer.data(sk_geom_10_off + 23 * ccomps * dcomps);

            auto g_x_0_0_xyyyzzz = cbuffer.data(sk_geom_10_off + 24 * ccomps * dcomps);

            auto g_x_0_0_xyyzzzz = cbuffer.data(sk_geom_10_off + 25 * ccomps * dcomps);

            auto g_x_0_0_xyzzzzz = cbuffer.data(sk_geom_10_off + 26 * ccomps * dcomps);

            auto g_x_0_0_xzzzzzz = cbuffer.data(sk_geom_10_off + 27 * ccomps * dcomps);

            auto g_x_0_0_yyyyyyy = cbuffer.data(sk_geom_10_off + 28 * ccomps * dcomps);

            auto g_x_0_0_yyyyyyz = cbuffer.data(sk_geom_10_off + 29 * ccomps * dcomps);

            auto g_x_0_0_yyyyyzz = cbuffer.data(sk_geom_10_off + 30 * ccomps * dcomps);

            auto g_x_0_0_yyyyzzz = cbuffer.data(sk_geom_10_off + 31 * ccomps * dcomps);

            auto g_x_0_0_yyyzzzz = cbuffer.data(sk_geom_10_off + 32 * ccomps * dcomps);

            auto g_x_0_0_yyzzzzz = cbuffer.data(sk_geom_10_off + 33 * ccomps * dcomps);

            auto g_x_0_0_yzzzzzz = cbuffer.data(sk_geom_10_off + 34 * ccomps * dcomps);

            auto g_x_0_0_zzzzzzz = cbuffer.data(sk_geom_10_off + 35 * ccomps * dcomps);

            auto g_y_0_0_xxxxxxx = cbuffer.data(sk_geom_10_off + 36 * ccomps * dcomps);

            auto g_y_0_0_xxxxxxy = cbuffer.data(sk_geom_10_off + 37 * ccomps * dcomps);

            auto g_y_0_0_xxxxxxz = cbuffer.data(sk_geom_10_off + 38 * ccomps * dcomps);

            auto g_y_0_0_xxxxxyy = cbuffer.data(sk_geom_10_off + 39 * ccomps * dcomps);

            auto g_y_0_0_xxxxxyz = cbuffer.data(sk_geom_10_off + 40 * ccomps * dcomps);

            auto g_y_0_0_xxxxxzz = cbuffer.data(sk_geom_10_off + 41 * ccomps * dcomps);

            auto g_y_0_0_xxxxyyy = cbuffer.data(sk_geom_10_off + 42 * ccomps * dcomps);

            auto g_y_0_0_xxxxyyz = cbuffer.data(sk_geom_10_off + 43 * ccomps * dcomps);

            auto g_y_0_0_xxxxyzz = cbuffer.data(sk_geom_10_off + 44 * ccomps * dcomps);

            auto g_y_0_0_xxxxzzz = cbuffer.data(sk_geom_10_off + 45 * ccomps * dcomps);

            auto g_y_0_0_xxxyyyy = cbuffer.data(sk_geom_10_off + 46 * ccomps * dcomps);

            auto g_y_0_0_xxxyyyz = cbuffer.data(sk_geom_10_off + 47 * ccomps * dcomps);

            auto g_y_0_0_xxxyyzz = cbuffer.data(sk_geom_10_off + 48 * ccomps * dcomps);

            auto g_y_0_0_xxxyzzz = cbuffer.data(sk_geom_10_off + 49 * ccomps * dcomps);

            auto g_y_0_0_xxxzzzz = cbuffer.data(sk_geom_10_off + 50 * ccomps * dcomps);

            auto g_y_0_0_xxyyyyy = cbuffer.data(sk_geom_10_off + 51 * ccomps * dcomps);

            auto g_y_0_0_xxyyyyz = cbuffer.data(sk_geom_10_off + 52 * ccomps * dcomps);

            auto g_y_0_0_xxyyyzz = cbuffer.data(sk_geom_10_off + 53 * ccomps * dcomps);

            auto g_y_0_0_xxyyzzz = cbuffer.data(sk_geom_10_off + 54 * ccomps * dcomps);

            auto g_y_0_0_xxyzzzz = cbuffer.data(sk_geom_10_off + 55 * ccomps * dcomps);

            auto g_y_0_0_xxzzzzz = cbuffer.data(sk_geom_10_off + 56 * ccomps * dcomps);

            auto g_y_0_0_xyyyyyy = cbuffer.data(sk_geom_10_off + 57 * ccomps * dcomps);

            auto g_y_0_0_xyyyyyz = cbuffer.data(sk_geom_10_off + 58 * ccomps * dcomps);

            auto g_y_0_0_xyyyyzz = cbuffer.data(sk_geom_10_off + 59 * ccomps * dcomps);

            auto g_y_0_0_xyyyzzz = cbuffer.data(sk_geom_10_off + 60 * ccomps * dcomps);

            auto g_y_0_0_xyyzzzz = cbuffer.data(sk_geom_10_off + 61 * ccomps * dcomps);

            auto g_y_0_0_xyzzzzz = cbuffer.data(sk_geom_10_off + 62 * ccomps * dcomps);

            auto g_y_0_0_xzzzzzz = cbuffer.data(sk_geom_10_off + 63 * ccomps * dcomps);

            auto g_y_0_0_yyyyyyy = cbuffer.data(sk_geom_10_off + 64 * ccomps * dcomps);

            auto g_y_0_0_yyyyyyz = cbuffer.data(sk_geom_10_off + 65 * ccomps * dcomps);

            auto g_y_0_0_yyyyyzz = cbuffer.data(sk_geom_10_off + 66 * ccomps * dcomps);

            auto g_y_0_0_yyyyzzz = cbuffer.data(sk_geom_10_off + 67 * ccomps * dcomps);

            auto g_y_0_0_yyyzzzz = cbuffer.data(sk_geom_10_off + 68 * ccomps * dcomps);

            auto g_y_0_0_yyzzzzz = cbuffer.data(sk_geom_10_off + 69 * ccomps * dcomps);

            auto g_y_0_0_yzzzzzz = cbuffer.data(sk_geom_10_off + 70 * ccomps * dcomps);

            auto g_y_0_0_zzzzzzz = cbuffer.data(sk_geom_10_off + 71 * ccomps * dcomps);

            auto g_z_0_0_xxxxxxx = cbuffer.data(sk_geom_10_off + 72 * ccomps * dcomps);

            auto g_z_0_0_xxxxxxy = cbuffer.data(sk_geom_10_off + 73 * ccomps * dcomps);

            auto g_z_0_0_xxxxxxz = cbuffer.data(sk_geom_10_off + 74 * ccomps * dcomps);

            auto g_z_0_0_xxxxxyy = cbuffer.data(sk_geom_10_off + 75 * ccomps * dcomps);

            auto g_z_0_0_xxxxxyz = cbuffer.data(sk_geom_10_off + 76 * ccomps * dcomps);

            auto g_z_0_0_xxxxxzz = cbuffer.data(sk_geom_10_off + 77 * ccomps * dcomps);

            auto g_z_0_0_xxxxyyy = cbuffer.data(sk_geom_10_off + 78 * ccomps * dcomps);

            auto g_z_0_0_xxxxyyz = cbuffer.data(sk_geom_10_off + 79 * ccomps * dcomps);

            auto g_z_0_0_xxxxyzz = cbuffer.data(sk_geom_10_off + 80 * ccomps * dcomps);

            auto g_z_0_0_xxxxzzz = cbuffer.data(sk_geom_10_off + 81 * ccomps * dcomps);

            auto g_z_0_0_xxxyyyy = cbuffer.data(sk_geom_10_off + 82 * ccomps * dcomps);

            auto g_z_0_0_xxxyyyz = cbuffer.data(sk_geom_10_off + 83 * ccomps * dcomps);

            auto g_z_0_0_xxxyyzz = cbuffer.data(sk_geom_10_off + 84 * ccomps * dcomps);

            auto g_z_0_0_xxxyzzz = cbuffer.data(sk_geom_10_off + 85 * ccomps * dcomps);

            auto g_z_0_0_xxxzzzz = cbuffer.data(sk_geom_10_off + 86 * ccomps * dcomps);

            auto g_z_0_0_xxyyyyy = cbuffer.data(sk_geom_10_off + 87 * ccomps * dcomps);

            auto g_z_0_0_xxyyyyz = cbuffer.data(sk_geom_10_off + 88 * ccomps * dcomps);

            auto g_z_0_0_xxyyyzz = cbuffer.data(sk_geom_10_off + 89 * ccomps * dcomps);

            auto g_z_0_0_xxyyzzz = cbuffer.data(sk_geom_10_off + 90 * ccomps * dcomps);

            auto g_z_0_0_xxyzzzz = cbuffer.data(sk_geom_10_off + 91 * ccomps * dcomps);

            auto g_z_0_0_xxzzzzz = cbuffer.data(sk_geom_10_off + 92 * ccomps * dcomps);

            auto g_z_0_0_xyyyyyy = cbuffer.data(sk_geom_10_off + 93 * ccomps * dcomps);

            auto g_z_0_0_xyyyyyz = cbuffer.data(sk_geom_10_off + 94 * ccomps * dcomps);

            auto g_z_0_0_xyyyyzz = cbuffer.data(sk_geom_10_off + 95 * ccomps * dcomps);

            auto g_z_0_0_xyyyzzz = cbuffer.data(sk_geom_10_off + 96 * ccomps * dcomps);

            auto g_z_0_0_xyyzzzz = cbuffer.data(sk_geom_10_off + 97 * ccomps * dcomps);

            auto g_z_0_0_xyzzzzz = cbuffer.data(sk_geom_10_off + 98 * ccomps * dcomps);

            auto g_z_0_0_xzzzzzz = cbuffer.data(sk_geom_10_off + 99 * ccomps * dcomps);

            auto g_z_0_0_yyyyyyy = cbuffer.data(sk_geom_10_off + 100 * ccomps * dcomps);

            auto g_z_0_0_yyyyyyz = cbuffer.data(sk_geom_10_off + 101 * ccomps * dcomps);

            auto g_z_0_0_yyyyyzz = cbuffer.data(sk_geom_10_off + 102 * ccomps * dcomps);

            auto g_z_0_0_yyyyzzz = cbuffer.data(sk_geom_10_off + 103 * ccomps * dcomps);

            auto g_z_0_0_yyyzzzz = cbuffer.data(sk_geom_10_off + 104 * ccomps * dcomps);

            auto g_z_0_0_yyzzzzz = cbuffer.data(sk_geom_10_off + 105 * ccomps * dcomps);

            auto g_z_0_0_yzzzzzz = cbuffer.data(sk_geom_10_off + 106 * ccomps * dcomps);

            auto g_z_0_0_zzzzzzz = cbuffer.data(sk_geom_10_off + 107 * ccomps * dcomps);
            ...
            {
                g_x_0_x_xxxxxx[k] = -g_0_xxxxxx[k] - g_x_0_0_xxxxxx[k] * ab_x + g_x_0_0_xxxxxxx[k];

                g_x_0_x_xxxxxy[k] = -g_0_xxxxxy[k] - g_x_0_0_xxxxxy[k] * ab_x + g_x_0_0_xxxxxxy[k];

                g_x_0_x_xxxxxz[k] = -g_0_xxxxxz[k] - g_x_0_0_xxxxxz[k] * ab_x + g_x_0_0_xxxxxxz[k];

                g_x_0_x_xxxxyy[k] = -g_0_xxxxyy[k] - g_x_0_0_xxxxyy[k] * ab_x + g_x_0_0_xxxxxyy[k];

                g_x_0_x_xxxxyz[k] = -g_0_xxxxyz[k] - g_x_0_0_xxxxyz[k] * ab_x + g_x_0_0_xxxxxyz[k];

                g_x_0_x_xxxxzz[k] = -g_0_xxxxzz[k] - g_x_0_0_xxxxzz[k] * ab_x + g_x_0_0_xxxxxzz[k];

                g_x_0_x_xxxyyy[k] = -g_0_xxxyyy[k] - g_x_0_0_xxxyyy[k] * ab_x + g_x_0_0_xxxxyyy[k];

                g_x_0_x_xxxyyz[k] = -g_0_xxxyyz[k] - g_x_0_0_xxxyyz[k] * ab_x + g_x_0_0_xxxxyyz[k];

                g_x_0_x_xxxyzz[k] = -g_0_xxxyzz[k] - g_x_0_0_xxxyzz[k] * ab_x + g_x_0_0_xxxxyzz[k];

                g_x_0_x_xxxzzz[k] = -g_0_xxxzzz[k] - g_x_0_0_xxxzzz[k] * ab_x + g_x_0_0_xxxxzzz[k];

                g_x_0_x_xxyyyy[k] = -g_0_xxyyyy[k] - g_x_0_0_xxyyyy[k] * ab_x + g_x_0_0_xxxyyyy[k];

                g_x_0_x_xxyyyz[k] = -g_0_xxyyyz[k] - g_x_0_0_xxyyyz[k] * ab_x + g_x_0_0_xxxyyyz[k];

                g_x_0_x_xxyyzz[k] = -g_0_xxyyzz[k] - g_x_0_0_xxyyzz[k] * ab_x + g_x_0_0_xxxyyzz[k];

                g_x_0_x_xxyzzz[k] = -g_0_xxyzzz[k] - g_x_0_0_xxyzzz[k] * ab_x + g_x_0_0_xxxyzzz[k];

                g_x_0_x_xxzzzz[k] = -g_0_xxzzzz[k] - g_x_0_0_xxzzzz[k] * ab_x + g_x_0_0_xxxzzzz[k];

                g_x_0_x_xyyyyy[k] = -g_0_xyyyyy[k] - g_x_0_0_xyyyyy[k] * ab_x + g_x_0_0_xxyyyyy[k];

                g_x_0_x_xyyyyz[k] = -g_0_xyyyyz[k] - g_x_0_0_xyyyyz[k] * ab_x + g_x_0_0_xxyyyyz[k];

                g_x_0_x_xyyyzz[k] = -g_0_xyyyzz[k] - g_x_0_0_xyyyzz[k] * ab_x + g_x_0_0_xxyyyzz[k];

                g_x_0_x_xyyzzz[k] = -g_0_xyyzzz[k] - g_x_0_0_xyyzzz[k] * ab_x + g_x_0_0_xxyyzzz[k];

                g_x_0_x_xyzzzz[k] = -g_0_xyzzzz[k] - g_x_0_0_xyzzzz[k] * ab_x + g_x_0_0_xxyzzzz[k];

                g_x_0_x_xzzzzz[k] = -g_0_xzzzzz[k] - g_x_0_0_xzzzzz[k] * ab_x + g_x_0_0_xxzzzzz[k];

                g_x_0_x_yyyyyy[k] = -g_0_yyyyyy[k] - g_x_0_0_yyyyyy[k] * ab_x + g_x_0_0_xyyyyyy[k];

                g_x_0_x_yyyyyz[k] = -g_0_yyyyyz[k] - g_x_0_0_yyyyyz[k] * ab_x + g_x_0_0_xyyyyyz[k];

                g_x_0_x_yyyyzz[k] = -g_0_yyyyzz[k] - g_x_0_0_yyyyzz[k] * ab_x + g_x_0_0_xyyyyzz[k];

                g_x_0_x_yyyzzz[k] = -g_0_yyyzzz[k] - g_x_0_0_yyyzzz[k] * ab_x + g_x_0_0_xyyyzzz[k];

                g_x_0_x_yyzzzz[k] = -g_0_yyzzzz[k] - g_x_0_0_yyzzzz[k] * ab_x + g_x_0_0_xyyzzzz[k];

                g_x_0_x_yzzzzz[k] = -g_0_yzzzzz[k] - g_x_0_0_yzzzzz[k] * ab_x + g_x_0_0_xyzzzzz[k];

                g_x_0_x_zzzzzz[k] = -g_0_zzzzzz[k] - g_x_0_0_zzzzzz[k] * ab_x + g_x_0_0_xzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_x_0_0_xxxxxx, g_x_0_0_xxxxxxy, g_x_0_0_xxxxxy, g_x_0_0_xxxxxyy, g_x_0_0_xxxxxyz, g_x_0_0_xxxxxz, g_x_0_0_xxxxyy, g_x_0_0_xxxxyyy, g_x_0_0_xxxxyyz, g_x_0_0_xxxxyz, g_x_0_0_xxxxyzz, g_x_0_0_xxxxzz, g_x_0_0_xxxyyy, g_x_0_0_xxxyyyy, g_x_0_0_xxxyyyz, g_x_0_0_xxxyyz, g_x_0_0_xxxyyzz, g_x_0_0_xxxyzz, g_x_0_0_xxxyzzz, g_x_0_0_xxxzzz, g_x_0_0_xxyyyy, g_x_0_0_xxyyyyy, g_x_0_0_xxyyyyz, g_x_0_0_xxyyyz, g_x_0_0_xxyyyzz, g_x_0_0_xxyyzz, g_x_0_0_xxyyzzz, g_x_0_0_xxyzzz, g_x_0_0_xxyzzzz, g_x_0_0_xxzzzz, g_x_0_0_xyyyyy, g_x_0_0_xyyyyyy, g_x_0_0_xyyyyyz, g_x_0_0_xyyyyz, g_x_0_0_xyyyyzz, g_x_0_0_xyyyzz, g_x_0_0_xyyyzzz, g_x_0_0_xyyzzz, g_x_0_0_xyyzzzz, g_x_0_0_xyzzzz, g_x_0_0_xyzzzzz, g_x_0_0_xzzzzz, g_x_0_0_yyyyyy, g_x_0_0_yyyyyyy, g_x_0_0_yyyyyyz, g_x_0_0_yyyyyz, g_x_0_0_yyyyyzz, g_x_0_0_yyyyzz, g_x_0_0_yyyyzzz, g_x_0_0_yyyzzz, g_x_0_0_yyyzzzz, g_x_0_0_yyzzzz, g_x_0_0_yyzzzzz, g_x_0_0_yzzzzz, g_x_0_0_yzzzzzz, g_x_0_0_zzzzzz, g_x_0_y_xxxxxx, g_x_0_y_xxxxxy, g_x_0_y_xxxxxz, g_x_0_y_xxxxyy, g_x_0_y_xxxxyz, g_x_0_y_xxxxzz, g_x_0_y_xxxyyy, g_x_0_y_xxxyyz, g_x_0_y_xxxyzz, g_x_0_y_xxxzzz, g_x_0_y_xxyyyy, g_x_0_y_xxyyyz, g_x_0_y_xxyyzz, g_x_0_y_xxyzzz, g_x_0_y_xxzzzz, g_x_0_y_xyyyyy, g_x_0_y_xyyyyz, g_x_0_y_xyyyzz, g_x_0_y_xyyzzz, g_x_0_y_xyzzzz, g_x_0_y_xzzzzz, g_x_0_y_yyyyyy, g_x_0_y_yyyyyz, g_x_0_y_yyyyzz, g_x_0_y_yyyzzz, g_x_0_y_yyzzzz, g_x_0_y_yzzzzz, g_x_0_y_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_0_y_xxxxxx[k] = -g_x_0_0_xxxxxx[k] * ab_y + g_x_0_0_xxxxxxy[k];

                g_x_0_y_xxxxxy[k] = -g_x_0_0_xxxxxy[k] * ab_y + g_x_0_0_xxxxxyy[k];

                g_x_0_y_xxxxxz[k] = -g_x_0_0_xxxxxz[k] * ab_y + g_x_0_0_xxxxxyz[k];

                g_x_0_y_xxxxyy[k] = -g_x_0_0_xxxxyy[k] * ab_y + g_x_0_0_xxxxyyy[k];

                g_x_0_y_xxxxyz[k] = -g_x_0_0_xxxxyz[k] * ab_y + g_x_0_0_xxxxyyz[k];

                g_x_0_y_xxxxzz[k] = -g_x_0_0_xxxxzz[k] * ab_y + g_x_0_0_xxxxyzz[k];

                g_x_0_y_xxxyyy[k] = -g_x_0_0_xxxyyy[k] * ab_y + g_x_0_0_xxxyyyy[k];

                g_x_0_y_xxxyyz[k] = -g_x_0_0_xxxyyz[k] * ab_y + g_x_0_0_xxxyyyz[k];

                g_x_0_y_xxxyzz[k] = -g_x_0_0_xxxyzz[k] * ab_y + g_x_0_0_xxxyyzz[k];

                g_x_0_y_xxxzzz[k] = -g_x_0_0_xxxzzz[k] * ab_y + g_x_0_0_xxxyzzz[k];

                g_x_0_y_xxyyyy[k] = -g_x_0_0_xxyyyy[k] * ab_y + g_x_0_0_xxyyyyy[k];

                g_x_0_y_xxyyyz[k] = -g_x_0_0_xxyyyz[k] * ab_y + g_x_0_0_xxyyyyz[k];

                g_x_0_y_xxyyzz[k] = -g_x_0_0_xxyyzz[k] * ab_y + g_x_0_0_xxyyyzz[k];

                g_x_0_y_xxyzzz[k] = -g_x_0_0_xxyzzz[k] * ab_y + g_x_0_0_xxyyzzz[k];

                g_x_0_y_xxzzzz[k] = -g_x_0_0_xxzzzz[k] * ab_y + g_x_0_0_xxyzzzz[k];

                g_x_0_y_xyyyyy[k] = -g_x_0_0_xyyyyy[k] * ab_y + g_x_0_0_xyyyyyy[k];

                g_x_0_y_xyyyyz[k] = -g_x_0_0_xyyyyz[k] * ab_y + g_x_0_0_xyyyyyz[k];

                g_x_0_y_xyyyzz[k] = -g_x_0_0_xyyyzz[k] * ab_y + g_x_0_0_xyyyyzz[k];

                g_x_0_y_xyyzzz[k] = -g_x_0_0_xyyzzz[k] * ab_y + g_x_0_0_xyyyzzz[k];

                g_x_0_y_xyzzzz[k] = -g_x_0_0_xyzzzz[k] * ab_y + g_x_0_0_xyyzzzz[k];

                g_x_0_y_xzzzzz[k] = -g_x_0_0_xzzzzz[k] * ab_y + g_x_0_0_xyzzzzz[k];

                g_x_0_y_yyyyyy[k] = -g_x_0_0_yyyyyy[k] * ab_y + g_x_0_0_yyyyyyy[k];

                g_x_0_y_yyyyyz[k] = -g_x_0_0_yyyyyz[k] * ab_y + g_x_0_0_yyyyyyz[k];

                g_x_0_y_yyyyzz[k] = -g_x_0_0_yyyyzz[k] * ab_y + g_x_0_0_yyyyyzz[k];

                g_x_0_y_yyyzzz[k] = -g_x_0_0_yyyzzz[k] * ab_y + g_x_0_0_yyyyzzz[k];

                g_x_0_y_yyzzzz[k] = -g_x_0_0_yyzzzz[k] * ab_y + g_x_0_0_yyyzzzz[k];

                g_x_0_y_yzzzzz[k] = -g_x_0_0_yzzzzz[k] * ab_y + g_x_0_0_yyzzzzz[k];

                g_x_0_y_zzzzzz[k] = -g_x_0_0_zzzzzz[k] * ab_y + g_x_0_0_yzzzzzz[k];
            }
            ...
            for (size_t k = 0; k < nelems; k++)
            {
                g_x_0_z_xxxxxx[k] = -g_x_0_0_xxxxxx[k] * ab_z + g_x_0_0_xxxxxxz[k];

                g_x_0_z_xxxxxy[k] = -g_x_0_0_xxxxxy[k] * ab_z + g_x_0_0_xxxxxyz[k];

                g_x_0_z_xxxxxz[k] = -g_x_0_0_xxxxxz[k] * ab_z + g_x_0_0_xxxxxzz[k];

                g_x_0_z_xxxxyy[k] = -g_x_0_0_xxxxyy[k] * ab_z + g_x_0_0_xxxxyyz[k];

                g_x_0_z_xxxxyz[k] = -g_x_0_0_xxxxyz[k] * ab_z + g_x_0_0_xxxxyzz[k];

                g_x_0_z_xxxxzz[k] = -g_x_0_0_xxxxzz[k] * ab_z + g_x_0_0_xxxxzzz[k];

                g_x_0_z_xxxyyy[k] = -g_x_0_0_xxxyyy[k] * ab_z + g_x_0_0_xxxyyyz[k];

                g_x_0_z_xxxyyz[k] = -g_x_0_0_xxxyyz[k] * ab_z + g_x_0_0_xxxyyzz[k];

                g_x_0_z_xxxyzz[k] = -g_x_0_0_xxxyzz[k] * ab_z + g_x_0_0_xxxyzzz[k];

                g_x_0_z_xxxzzz[k] = -g_x_0_0_xxxzzz[k] * ab_z + g_x_0_0_xxxzzzz[k];

                g_x_0_z_xxyyyy[k] = -g_x_0_0_xxyyyy[k] * ab_z + g_x_0_0_xxyyyyz[k];

                g_x_0_z_xxyyyz[k] = -g_x_0_0_xxyyyz[k] * ab_z + g_x_0_0_xxyyyzz[k];

                g_x_0_z_xxyyzz[k] = -g_x_0_0_xxyyzz[k] * ab_z + g_x_0_0_xxyyzzz[k];

                g_x_0_z_xxyzzz[k] = -g_x_0_0_xxyzzz[k] * ab_z + g_x_0_0_xxyzzzz[k];

                g_x_0_z_xxzzzz[k] = -g_x_0_0_xxzzzz[k] * ab_z + g_x_0_0_xxzzzzz[k];

                g_x_0_z_xyyyyy[k] = -g_x_0_0_xyyyyy[k] * ab_z + g_x_0_0_xyyyyyz[k];

                g_x_0_z_xyyyyz[k] = -g_x_0_0_xyyyyz[k] * ab_z + g_x_0_0_xyyyyzz[k];

                g_x_0_z_xyyyzz[k] = -g_x_0_0_xyyyzz[k] * ab_z + g_x_0_0_xyyyzzz[k];

                g_x_0_z_xyyzzz[k] = -g_x_0_0_xyyzzz[k] * ab_z + g_x_0_0_xyyzzzz[k];

                g_x_0_z_xyzzzz[k] = -g_x_0_0_xyzzzz[k] * ab_z + g_x_0_0_xyzzzzz[k];

                g_x_0_z_xzzzzz[k] = -g_x_0_0_xzzzzz[k] * ab_z + g_x_0_0_xzzzzzz[k];

                g_x_0_z_yyyyyy[k] = -g_x_0_0_yyyyyy[k] * ab_z + g_x_0_0_yyyyyyz[k];

                g_x_0_z_yyyyyz[k] = -g_x_0_0_yyyyyz[k] * ab_z + g_x_0_0_yyyyyzz[k];

                g_x_0_z_yyyyzz[k] = -g_x_0_0_yyyyzz[k] * ab_z + g_x_0_0_yyyyzzz[k];

                g_x_0_z_yyyzzz[k] = -g_x_0_0_yyyzzz[k] * ab_z + g_x_0_0_yyyzzzz[k];

                g_x_0_z_yyzzzz[k] = -g_x_0_0_yyzzzz[k] * ab_z + g_x_0_0_yyzzzzz[k];

                g_x_0_z_yzzzzz[k] = -g_x_0_0_yzzzzz[k] * ab_z + g_x_0_0_yzzzzzz[k];

                g_x_0_z_zzzzzz[k] = -g_x_0_0_zzzzzz[k] * ab_z + g_x_0_0_zzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_y_0_0_xxxxxx, g_y_0_0_xxxxxxx, g_y_0_0_xxxxxxy, g_y_0_0_xxxxxxz, g_y_0_0_xxxxxy, g_y_0_0_xxxxxyy, g_y_0_0_xxxxxyz, g_y_0_0_xxxxxz, g_y_0_0_xxxxxzz, g_y_0_0_xxxxyy, g_y_0_0_xxxxyyy, g_y_0_0_xxxxyyz, g_y_0_0_xxxxyz, g_y_0_0_xxxxyzz, g_y_0_0_xxxxzz, g_y_0_0_xxxxzzz, g_y_0_0_xxxyyy, g_y_0_0_xxxyyyy, g_y_0_0_xxxyyyz, g_y_0_0_xxxyyz, g_y_0_0_xxxyyzz, g_y_0_0_xxxyzz, g_y_0_0_xxxyzzz, g_y_0_0_xxxzzz, g_y_0_0_xxxzzzz, g_y_0_0_xxyyyy, g_y_0_0_xxyyyyy, g_y_0_0_xxyyyyz, g_y_0_0_xxyyyz, g_y_0_0_xxyyyzz, g_y_0_0_xxyyzz, g_y_0_0_xxyyzzz, g_y_0_0_xxyzzz, g_y_0_0_xxyzzzz, g_y_0_0_xxzzzz, g_y_0_0_xxzzzzz, g_y_0_0_xyyyyy, g_y_0_0_xyyyyyy, g_y_0_0_xyyyyyz, g_y_0_0_xyyyyz, g_y_0_0_xyyyyzz, g_y_0_0_xyyyzz, g_y_0_0_xyyyzzz, g_y_0_0_xyyzzz, g_y_0_0_xyyzzzz, g_y_0_0_xyzzzz, g_y_0_0_xyzzzzz, g_y_0_0_xzzzzz, g_y_0_0_xzzzzzz, g_y_0_0_yyyyyy, g_y_0_0_yyyyyz, g_y_0_0_yyyyzz, g_y_0_0_yyyzzz, g_y_0_0_yyzzzz, g_y_0_0_yzzzzz, g_y_0_0_zzzzzz, g_y_0_x_xxxxxx, g_y_0_x_xxxxxy, g_y_0_x_xxxxxz, g_y_0_x_xxxxyy, g_y_0_x_xxxxyz, g_y_0_x_xxxxzz, g_y_0_x_xxxyyy, g_y_0_x_xxxyyz, g_y_0_x_xxxyzz, g_y_0_x_xxxzzz, g_y_0_x_xxyyyy, g_y_0_x_xxyyyz, g_y_0_x_xxyyzz, g_y_0_x_xxyzzz, g_y_0_x_xxzzzz, g_y_0_x_xyyyyy, g_y_0_x_xyyyyz, g_y_0_x_xyyyzz, g_y_0_x_xyyzzz, g_y_0_x_xyzzzz, g_y_0_x_xzzzzz, g_y_0_x_yyyyyy, g_y_0_x_yyyyyz, g_y_0_x_yyyyzz, g_y_0_x_yyyzzz, g_y_0_x_yyzzzz, g_y_0_x_yzzzzz, g_y_0_x_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_0_x_xxxxxx[k] = -g_y_0_0_xxxxxx[k] * ab_x + g_y_0_0_xxxxxxx[k];

                g_y_0_x_xxxxxy[k] = -g_y_0_0_xxxxxy[k] * ab_x + g_y_0_0_xxxxxxy[k];

                g_y_0_x_xxxxxz[k] = -g_y_0_0_xxxxxz[k] * ab_x + g_y_0_0_xxxxxxz[k];

                g_y_0_x_xxxxyy[k] = -g_y_0_0_xxxxyy[k] * ab_x + g_y_0_0_xxxxxyy[k];

                g_y_0_x_xxxxyz[k] = -g_y_0_0_xxxxyz[k] * ab_x + g_y_0_0_xxxxxyz[k];

                g_y_0_x_xxxxzz[k] = -g_y_0_0_xxxxzz[k] * ab_x + g_y_0_0_xxxxxzz[k];

                g_y_0_x_xxxyyy[k] = -g_y_0_0_xxxyyy[k] * ab_x + g_y_0_0_xxxxyyy[k];

                g_y_0_x_xxxyyz[k] = -g_y_0_0_xxxyyz[k] * ab_x + g_y_0_0_xxxxyyz[k];

                g_y_0_x_xxxyzz[k] = -g_y_0_0_xxxyzz[k] * ab_x + g_y_0_0_xxxxyzz[k];

                g_y_0_x_xxxzzz[k] = -g_y_0_0_xxxzzz[k] * ab_x + g_y_0_0_xxxxzzz[k];

                g_y_0_x_xxyyyy[k] = -g_y_0_0_xxyyyy[k] * ab_x + g_y_0_0_xxxyyyy[k];

                g_y_0_x_xxyyyz[k] = -g_y_0_0_xxyyyz[k] * ab_x + g_y_0_0_xxxyyyz[k];

                g_y_0_x_xxyyzz[k] = -g_y_0_0_xxyyzz[k] * ab_x + g_y_0_0_xxxyyzz[k];

                g_y_0_x_xxyzzz[k] = -g_y_0_0_xxyzzz[k] * ab_x + g_y_0_0_xxxyzzz[k];

                g_y_0_x_xxzzzz[k] = -g_y_0_0_xxzzzz[k] * ab_x + g_y_0_0_xxxzzzz[k];

                g_y_0_x_xyyyyy[k] = -g_y_0_0_xyyyyy[k] * ab_x + g_y_0_0_xxyyyyy[k];

                g_y_0_x_xyyyyz[k] = -g_y_0_0_xyyyyz[k] * ab_x + g_y_0_0_xxyyyyz[k];

                g_y_0_x_xyyyzz[k] = -g_y_0_0_xyyyzz[k] * ab_x + g_y_0_0_xxyyyzz[k];

                g_y_0_x_xyyzzz[k] = -g_y_0_0_xyyzzz[k] * ab_x + g_y_0_0_xxyyzzz[k];

                g_y_0_x_xyzzzz[k] = -g_y_0_0_xyzzzz[k] * ab_x + g_y_0_0_xxyzzzz[k];

                g_y_0_x_xzzzzz[k] = -g_y_0_0_xzzzzz[k] * ab_x + g_y_0_0_xxzzzzz[k];

                g_y_0_x_yyyyyy[k] = -g_y_0_0_yyyyyy[k] * ab_x + g_y_0_0_xyyyyyy[k];

                g_y_0_x_yyyyyz[k] = -g_y_0_0_yyyyyz[k] * ab_x + g_y_0_0_xyyyyyz[k];

                g_y_0_x_yyyyzz[k] = -g_y_0_0_yyyyzz[k] * ab_x + g_y_0_0_xyyyyzz[k];

                g_y_0_x_yyyzzz[k] = -g_y_0_0_yyyzzz[k] * ab_x + g_y_0_0_xyyyzzz[k];

                g_y_0_x_yyzzzz[k] = -g_y_0_0_yyzzzz[k] * ab_x + g_y_0_0_xyyzzzz[k];

                g_y_0_x_yzzzzz[k] = -g_y_0_0_yzzzzz[k] * ab_x + g_y_0_0_xyzzzzz[k];

                g_y_0_x_zzzzzz[k] = -g_y_0_0_zzzzzz[k] * ab_x + g_y_0_0_xzzzzzz[k];
            }
            ...
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_0_y_xxxxxx[k] = -g_0_xxxxxx[k] - g_y_0_0_xxxxxx[k] * ab_y + g_y_0_0_xxxxxxy[k];

                g_y_0_y_xxxxxy[k] = -g_0_xxxxxy[k] - g_y_0_0_xxxxxy[k] * ab_y + g_y_0_0_xxxxxyy[k];

                g_y_0_y_xxxxxz[k] = -g_0_xxxxxz[k] - g_y_0_0_xxxxxz[k] * ab_y + g_y_0_0_xxxxxyz[k];

                g_y_0_y_xxxxyy[k] = -g_0_xxxxyy[k] - g_y_0_0_xxxxyy[k] * ab_y + g_y_0_0_xxxxyyy[k];

                g_y_0_y_xxxxyz[k] = -g_0_xxxxyz[k] - g_y_0_0_xxxxyz[k] * ab_y + g_y_0_0_xxxxyyz[k];

                g_y_0_y_xxxxzz[k] = -g_0_xxxxzz[k] - g_y_0_0_xxxxzz[k] * ab_y + g_y_0_0_xxxxyzz[k];

                g_y_0_y_xxxyyy[k] = -g_0_xxxyyy[k] - g_y_0_0_xxxyyy[k] * ab_y + g_y_0_0_xxxyyyy[k];

                g_y_0_y_xxxyyz[k] = -g_0_xxxyyz[k] - g_y_0_0_xxxyyz[k] * ab_y + g_y_0_0_xxxyyyz[k];

                g_y_0_y_xxxyzz[k] = -g_0_xxxyzz[k] - g_y_0_0_xxxyzz[k] * ab_y + g_y_0_0_xxxyyzz[k];

                g_y_0_y_xxxzzz[k] = -g_0_xxxzzz[k] - g_y_0_0_xxxzzz[k] * ab_y + g_y_0_0_xxxyzzz[k];

                g_y_0_y_xxyyyy[k] = -g_0_xxyyyy[k] - g_y_0_0_xxyyyy[k] * ab_y + g_y_0_0_xxyyyyy[k];

                g_y_0_y_xxyyyz[k] = -g_0_xxyyyz[k] - g_y_0_0_xxyyyz[k] * ab_y + g_y_0_0_xxyyyyz[k];

                g_y_0_y_xxyyzz[k] = -g_0_xxyyzz[k] - g_y_0_0_xxyyzz[k] * ab_y + g_y_0_0_xxyyyzz[k];

                g_y_0_y_xxyzzz[k] = -g_0_xxyzzz[k] - g_y_0_0_xxyzzz[k] * ab_y + g_y_0_0_xxyyzzz[k];

                g_y_0_y_xxzzzz[k] = -g_0_xxzzzz[k] - g_y_0_0_xxzzzz[k] * ab_y + g_y_0_0_xxyzzzz[k];

                g_y_0_y_xyyyyy[k] = -g_0_xyyyyy[k] - g_y_0_0_xyyyyy[k] * ab_y + g_y_0_0_xyyyyyy[k];

                g_y_0_y_xyyyyz[k] = -g_0_xyyyyz[k] - g_y_0_0_xyyyyz[k] * ab_y + g_y_0_0_xyyyyyz[k];

                g_y_0_y_xyyyzz[k] = -g_0_xyyyzz[k] - g_y_0_0_xyyyzz[k] * ab_y + g_y_0_0_xyyyyzz[k];

                g_y_0_y_xyyzzz[k] = -g_0_xyyzzz[k] - g_y_0_0_xyyzzz[k] * ab_y + g_y_0_0_xyyyzzz[k];

                g_y_0_y_xyzzzz[k] = -g_0_xyzzzz[k] - g_y_0_0_xyzzzz[k] * ab_y + g_y_0_0_xyyzzzz[k];

                g_y_0_y_xzzzzz[k] = -g_0_xzzzzz[k] - g_y_0_0_xzzzzz[k] * ab_y + g_y_0_0_xyzzzzz[k];

                g_y_0_y_yyyyyy[k] = -g_0_yyyyyy[k] - g_y_0_0_yyyyyy[k] * ab_y + g_y_0_0_yyyyyyy[k];

                g_y_0_y_yyyyyz[k] = -g_0_yyyyyz[k] - g_y_0_0_yyyyyz[k] * ab_y + g_y_0_0_yyyyyyz[k];

                g_y_0_y_yyyyzz[k] = -g_0_yyyyzz[k] - g_y_0_0_yyyyzz[k] * ab_y + g_y_0_0_yyyyyzz[k];

                g_y_0_y_yyyzzz[k] = -g_0_yyyzzz[k] - g_y_0_0_yyyzzz[k] * ab_y + g_y_0_0_yyyyzzz[k];

                g_y_0_y_yyzzzz[k] = -g_0_yyzzzz[k] - g_y_0_0_yyzzzz[k] * ab_y + g_y_0_0_yyyzzzz[k];

                g_y_0_y_yzzzzz[k] = -g_0_yzzzzz[k] - g_y_0_0_yzzzzz[k] * ab_y + g_y_0_0_yyzzzzz[k];

                g_y_0_y_zzzzzz[k] = -g_0_zzzzzz[k] - g_y_0_0_zzzzzz[k] * ab_y + g_y_0_0_yzzzzzz[k];
            }
            ...
            #pragma omp simd aligned(g_y_0_0_xxxxxx, g_y_0_0_xxxxxxz, g_y_0_0_xxxxxy, g_y_0_0_xxxxxyz, g_y_0_0_xxxxxz, g_y_0_0_xxxxxzz, g_y_0_0_xxxxyy, g_y_0_0_xxxxyyz, g_y_0_0_xxxxyz, g_y_0_0_xxxxyzz, g_y_0_0_xxxxzz, g_y_0_0_xxxxzzz, g_y_0_0_xxxyyy, g_y_0_0_xxxyyyz, g_y_0_0_xxxyyz, g_y_0_0_xxxyyzz, g_y_0_0_xxxyzz, g_y_0_0_xxxyzzz, g_y_0_0_xxxzzz, g_y_0_0_xxxzzzz, g_y_0_0_xxyyyy, g_y_0_0_xxyyyyz, g_y_0_0_xxyyyz, g_y_0_0_xxyyyzz, g_y_0_0_xxyyzz, g_y_0_0_xxyyzzz, g_y_0_0_xxyzzz, g_y_0_0_xxyzzzz, g_y_0_0_xxzzzz, g_y_0_0_xxzzzzz, g_y_0_0_xyyyyy, g_y_0_0_xyyyyyz, g_y_0_0_xyyyyz, g_y_0_0_xyyyyzz, g_y_0_0_xyyyzz, g_y_0_0_xyyyzzz, g_y_0_0_xyyzzz, g_y_0_0_xyyzzzz, g_y_0_0_xyzzzz, g_y_0_0_xyzzzzz, g_y_0_0_xzzzzz, g_y_0_0_xzzzzzz, g_y_0_0_yyyyyy, g_y_0_0_yyyyyyz, g_y_0_0_yyyyyz, g_y_0_0_yyyyyzz, g_y_0_0_yyyyzz, g_y_0_0_yyyyzzz, g_y_0_0_yyyzzz, g_y_0_0_yyyzzzz, g_y_0_0_yyzzzz, g_y_0_0_yyzzzzz, g_y_0_0_yzzzzz, g_y_0_0_yzzzzzz, g_y_0_0_zzzzzz, g_y_0_0_zzzzzzz, g_y_0_z_xxxxxx, g_y_0_z_xxxxxy, g_y_0_z_xxxxxz, g_y_0_z_xxxxyy, g_y_0_z_xxxxyz, g_y_0_z_xxxxzz, g_y_0_z_xxxyyy, g_y_0_z_xxxyyz, g_y_0_z_xxxyzz, g_y_0_z_xxxzzz, g_y_0_z_xxyyyy, g_y_0_z_xxyyyz, g_y_0_z_xxyyzz, g_y_0_z_xxyzzz, g_y_0_z_xxzzzz, g_y_0_z_xyyyyy, g_y_0_z_xyyyyz, g_y_0_z_xyyyzz, g_y_0_z_xyyzzz, g_y_0_z_xyzzzz, g_y_0_z_xzzzzz, g_y_0_z_yyyyyy, g_y_0_z_yyyyyz, g_y_0_z_yyyyzz, g_y_0_z_yyyzzz, g_y_0_z_yyzzzz, g_y_0_z_yzzzzz, g_y_0_z_zzzzzz  : 64)
            for (size_t k = 0; k < nelems; k++)
            {
                g_y_0_z_xxxxxx[k] = -g_y_0_0_xxxxxx[k] * ab_z + g_y_0_0_xxxxxxz[k];

                g_y_0_z_xxxxxy[k] = -g_y_0_0_xxxxxy[k] * ab_z + g_y_0_0_xxxxxyz[k];

                g_y_0_z_xxxxxz[k] = -g_y_0_0_xxxxxz[k] * ab_z + g_y_0_0_xxxxxzz[k];

                g_y_0_z_xxxxyy[k] = -g_y_0_0_xxxxyy[k] * ab_z + g_y_0_0_xxxxyyz[k];

                g_y_0_z_xxxxyz[k] = -g_y_0_0_xxxxyz[k] * ab_z + g_y_0_0_xxxxyzz[k];

                g_y_0_z_xxxxzz[k] = -g_y_0_0_xxxxzz[k] * ab_z + g_y_0_0_xxxxzzz[k];

                g_y_0_z_xxxyyy[k] = -g_y_0_0_xxxyyy[k] * ab_z + g_y_0_0_xxxyyyz[k];

                g_y_0_z_xxxyyz[k] = -g_y_0_0_xxxyyz[k] * ab_z + g_y_0_0_xxxyyzz[k];

                g_y_0_z_xxxyzz[k] = -g_y_0_0_xxxyzz[k] * ab_z + g_y_0_0_xxxyzzz[k];

                g_y_0_z_xxxzzz[k] = -g_y_0_0_xxxzzz[k] * ab_z + g_y_0_0_xxxzzzz[k];

                g_y_0_z_xxyyyy[k] = -g_y_0_0_xxyyyy[k] * ab_z + g_y_0_0_xxyyyyz[k];

                g_y_0_z_xxyyyz[k] = -g_y_0_0_xxyyyz[k] * ab_z + g_y_0_0_xxyyyzz[k];

                g_y_0_z_xxyyzz[k] = -g_y_0_0_xxyyzz[k] * ab_z + g_y_0_0_xxyyzzz[k];

                g_y_0_z_xxyzzz[k] = -g_y_0_0_xxyzzz[k] * ab_z + g_y_0_0_xxyzzzz[k];

                g_y_0_z_xxzzzz[k] = -g_y_0_0_xxzzzz[k] * ab_z + g_y_0_0_xxzzzzz[k];

                g_y_0_z_xyyyyy[k] = -g_y_0_0_xyyyyy[k] * ab_z + g_y_0_0_xyyyyyz[k];

                g_y_0_z_xyyyyz[k] = -g_y_0_0_xyyyyz[k] * ab_z + g_y_0_0_xyyyyzz[k];

                g_y_0_z_xyyyzz[k] = -g_y_0_0_xyyyzz[k] * ab_z + g_y_0_0_xyyyzzz[k];

                g_y_0_z_xyyzzz[k] = -g_y_0_0_xyyzzz[k] * ab_z + g_y_0_0_xyyzzzz[k];

                g_y_0_z_xyzzzz[k] = -g_y_0_0_xyzzzz[k] * ab_z + g_y_0_0_xyzzzzz[k];

                g_y_0_z_xzzzzz[k] = -g_y_0_0_xzzzzz[k] * ab_z + g_y_0_0_xzzzzzz[k];

                g_y_0_z_yyyyyy[k] = -g_y_0_0_yyyyyy[k] * ab_z + g_y_0_0_yyyyyyz[k];

                g_y_0_z_yyyyyz[k] = -g_y_0_0_yyyyyz[k] * ab_z + g_y_0_0_yyyyyzz[k];

                g_y_0_z_yyyyzz[k] = -g_y_0_0_yyyyzz[k] * ab_z + g_y_0_0_yyyyzzz[k];

                g_y_0_z_yyyzzz[k] = -g_y_0_0_yyyzzz[k] * ab_z + g_y_0_0_yyyzzzz[k];

                g_y_0_z_yyzzzz[k] = -g_y_0_0_yyzzzz[k] * ab_z + g_y_0_0_yyzzzzz[k];

                g_y_0_z_yzzzzz[k] = -g_y_0_0_yzzzzz[k] * ab_z + g_y_0_0_yzzzzzz[k];

                g_y_0_z_zzzzzz[k] = -g_y_0_0_zzzzzz[k] * ab_z + g_y_0_0_zzzzzzz[k];
            }
            ...
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_0_x_xxxxxx[k] = -g_z_0_0_xxxxxx[k] * ab_x + g_z_0_0_xxxxxxx[k];

                g_z_0_x_xxxxxy[k] = -g_z_0_0_xxxxxy[k] * ab_x + g_z_0_0_xxxxxxy[k];

                g_z_0_x_xxxxxz[k] = -g_z_0_0_xxxxxz[k] * ab_x + g_z_0_0_xxxxxxz[k];

                g_z_0_x_xxxxyy[k] = -g_z_0_0_xxxxyy[k] * ab_x + g_z_0_0_xxxxxyy[k];

                g_z_0_x_xxxxyz[k] = -g_z_0_0_xxxxyz[k] * ab_x + g_z_0_0_xxxxxyz[k];

                g_z_0_x_xxxxzz[k] = -g_z_0_0_xxxxzz[k] * ab_x + g_z_0_0_xxxxxzz[k];

                g_z_0_x_xxxyyy[k] = -g_z_0_0_xxxyyy[k] * ab_x + g_z_0_0_xxxxyyy[k];

                g_z_0_x_xxxyyz[k] = -g_z_0_0_xxxyyz[k] * ab_x + g_z_0_0_xxxxyyz[k];

                g_z_0_x_xxxyzz[k] = -g_z_0_0_xxxyzz[k] * ab_x + g_z_0_0_xxxxyzz[k];

                g_z_0_x_xxxzzz[k] = -g_z_0_0_xxxzzz[k] * ab_x + g_z_0_0_xxxxzzz[k];

                g_z_0_x_xxyyyy[k] = -g_z_0_0_xxyyyy[k] * ab_x + g_z_0_0_xxxyyyy[k];

                g_z_0_x_xxyyyz[k] = -g_z_0_0_xxyyyz[k] * ab_x + g_z_0_0_xxxyyyz[k];

                g_z_0_x_xxyyzz[k] = -g_z_0_0_xxyyzz[k] * ab_x + g_z_0_0_xxxyyzz[k];

                g_z_0_x_xxyzzz[k] = -g_z_0_0_xxyzzz[k] * ab_x + g_z_0_0_xxxyzzz[k];

                g_z_0_x_xxzzzz[k] = -g_z_0_0_xxzzzz[k] * ab_x + g_z_0_0_xxxzzzz[k];

                g_z_0_x_xyyyyy[k] = -g_z_0_0_xyyyyy[k] * ab_x + g_z_0_0_xxyyyyy[k];

                g_z_0_x_xyyyyz[k] = -g_z_0_0_xyyyyz[k] * ab_x + g_z_0_0_xxyyyyz[k];

                g_z_0_x_xyyyzz[k] = -g_z_0_0_xyyyzz[k] * ab_x + g_z_0_0_xxyyyzz[k];

                g_z_0_x_xyyzzz[k] = -g_z_0_0_xyyzzz[k] * ab_x + g_z_0_0_xxyyzzz[k];

                g_z_0_x_xyzzzz[k] = -g_z_0_0_xyzzzz[k] * ab_x + g_z_0_0_xxyzzzz[k];

                g_z_0_x_xzzzzz[k] = -g_z_0_0_xzzzzz[k] * ab_x + g_z_0_0_xxzzzzz[k];

                g_z_0_x_yyyyyy[k] = -g_z_0_0_yyyyyy[k] * ab_x + g_z_0_0_xyyyyyy[k];

                g_z_0_x_yyyyyz[k] = -g_z_0_0_yyyyyz[k] * ab_x + g_z_0_0_xyyyyyz[k];

                g_z_0_x_yyyyzz[k] = -g_z_0_0_yyyyzz[k] * ab_x + g_z_0_0_xyyyyzz[k];

                g_z_0_x_yyyzzz[k] = -g_z_0_0_yyyzzz[k] * ab_x + g_z_0_0_xyyyzzz[k];

                g_z_0_x_yyzzzz[k] = -g_z_0_0_yyzzzz[k] * ab_x + g_z_0_0_xyyzzzz[k];

                g_z_0_x_yzzzzz[k] = -g_z_0_0_yzzzzz[k] * ab_x + g_z_0_0_xyzzzzz[k];

                g_z_0_x_zzzzzz[k] = -g_z_0_0_zzzzzz[k] * ab_x + g_z_0_0_xzzzzzz[k];
            }
            ...
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_0_y_xxxxxx[k] = -g_z_0_0_xxxxxx[k] * ab_y + g_z_0_0_xxxxxxy[k];

                g_z_0_y_xxxxxy[k] = -g_z_0_0_xxxxxy[k] * ab_y + g_z_0_0_xxxxxyy[k];

                g_z_0_y_xxxxxz[k] = -g_z_0_0_xxxxxz[k] * ab_y + g_z_0_0_xxxxxyz[k];

                g_z_0_y_xxxxyy[k] = -g_z_0_0_xxxxyy[k] * ab_y + g_z_0_0_xxxxyyy[k];

                g_z_0_y_xxxxyz[k] = -g_z_0_0_xxxxyz[k] * ab_y + g_z_0_0_xxxxyyz[k];

                g_z_0_y_xxxxzz[k] = -g_z_0_0_xxxxzz[k] * ab_y + g_z_0_0_xxxxyzz[k];

                g_z_0_y_xxxyyy[k] = -g_z_0_0_xxxyyy[k] * ab_y + g_z_0_0_xxxyyyy[k];

                g_z_0_y_xxxyyz[k] = -g_z_0_0_xxxyyz[k] * ab_y + g_z_0_0_xxxyyyz[k];

                g_z_0_y_xxxyzz[k] = -g_z_0_0_xxxyzz[k] * ab_y + g_z_0_0_xxxyyzz[k];

                g_z_0_y_xxxzzz[k] = -g_z_0_0_xxxzzz[k] * ab_y + g_z_0_0_xxxyzzz[k];

                g_z_0_y_xxyyyy[k] = -g_z_0_0_xxyyyy[k] * ab_y + g_z_0_0_xxyyyyy[k];

                g_z_0_y_xxyyyz[k] = -g_z_0_0_xxyyyz[k] * ab_y + g_z_0_0_xxyyyyz[k];

                g_z_0_y_xxyyzz[k] = -g_z_0_0_xxyyzz[k] * ab_y + g_z_0_0_xxyyyzz[k];

                g_z_0_y_xxyzzz[k] = -g_z_0_0_xxyzzz[k] * ab_y + g_z_0_0_xxyyzzz[k];

                g_z_0_y_xxzzzz[k] = -g_z_0_0_xxzzzz[k] * ab_y + g_z_0_0_xxyzzzz[k];

                g_z_0_y_xyyyyy[k] = -g_z_0_0_xyyyyy[k] * ab_y + g_z_0_0_xyyyyyy[k];

                g_z_0_y_xyyyyz[k] = -g_z_0_0_xyyyyz[k] * ab_y + g_z_0_0_xyyyyyz[k];

                g_z_0_y_xyyyzz[k] = -g_z_0_0_xyyyzz[k] * ab_y + g_z_0_0_xyyyyzz[k];

                g_z_0_y_xyyzzz[k] = -g_z_0_0_xyyzzz[k] * ab_y + g_z_0_0_xyyyzzz[k];

                g_z_0_y_xyzzzz[k] = -g_z_0_0_xyzzzz[k] * ab_y + g_z_0_0_xyyzzzz[k];

                g_z_0_y_xzzzzz[k] = -g_z_0_0_xzzzzz[k] * ab_y + g_z_0_0_xyzzzzz[k];

                g_z_0_y_yyyyyy[k] = -g_z_0_0_yyyyyy[k] * ab_y + g_z_0_0_yyyyyyy[k];

                g_z_0_y_yyyyyz[k] = -g_z_0_0_yyyyyz[k] * ab_y + g_z_0_0_yyyyyyz[k];

                g_z_0_y_yyyyzz[k] = -g_z_0_0_yyyyzz[k] * ab_y + g_z_0_0_yyyyyzz[k];

                g_z_0_y_yyyzzz[k] = -g_z_0_0_yyyzzz[k] * ab_y + g_z_0_0_yyyyzzz[k];

                g_z_0_y_yyzzzz[k] = -g_z_0_0_yyzzzz[k] * ab_y + g_z_0_0_yyyzzzz[k];

                g_z_0_y_yzzzzz[k] = -g_z_0_0_yzzzzz[k] * ab_y + g_z_0_0_yyzzzzz[k];

                g_z_0_y_zzzzzz[k] = -g_z_0_0_zzzzzz[k] * ab_y + g_z_0_0_yzzzzzz[k];
            }
            ...
            for (size_t k = 0; k < nelems; k++)
            {
                g_z_0_z_xxxxxx[k] = -g_0_xxxxxx[k] - g_z_0_0_xxxxxx[k] * ab_z + g_z_0_0_xxxxxxz[k];

                g_z_0_z_xxxxxy[k] = -g_0_xxxxxy[k] - g_z_0_0_xxxxxy[k] * ab_z + g_z_0_0_xxxxxyz[k];

                g_z_0_z_xxxxxz[k] = -g_0_xxxxxz[k] - g_z_0_0_xxxxxz[k] * ab_z + g_z_0_0_xxxxxzz[k];

                g_z_0_z_xxxxyy[k] = -g_0_xxxxyy[k] - g_z_0_0_xxxxyy[k] * ab_z + g_z_0_0_xxxxyyz[k];

                g_z_0_z_xxxxyz[k] = -g_0_xxxxyz[k] - g_z_0_0_xxxxyz[k] * ab_z + g_z_0_0_xxxxyzz[k];

                g_z_0_z_xxxxzz[k] = -g_0_xxxxzz[k] - g_z_0_0_xxxxzz[k] * ab_z + g_z_0_0_xxxxzzz[k];

                g_z_0_z_xxxyyy[k] = -g_0_xxxyyy[k] - g_z_0_0_xxxyyy[k] * ab_z + g_z_0_0_xxxyyyz[k];

                g_z_0_z_xxxyyz[k] = -g_0_xxxyyz[k] - g_z_0_0_xxxyyz[k] * ab_z + g_z_0_0_xxxyyzz[k];

                g_z_0_z_xxxyzz[k] = -g_0_xxxyzz[k] - g_z_0_0_xxxyzz[k] * ab_z + g_z_0_0_xxxyzzz[k];

                g_z_0_z_xxxzzz[k] = -g_0_xxxzzz[k] - g_z_0_0_xxxzzz[k] * ab_z + g_z_0_0_xxxzzzz[k];

                g_z_0_z_xxyyyy[k] = -g_0_xxyyyy[k] - g_z_0_0_xxyyyy[k] * ab_z + g_z_0_0_xxyyyyz[k];

                g_z_0_z_xxyyyz[k] = -g_0_xxyyyz[k] - g_z_0_0_xxyyyz[k] * ab_z + g_z_0_0_xxyyyzz[k];

                g_z_0_z_xxyyzz[k] = -g_0_xxyyzz[k] - g_z_0_0_xxyyzz[k] * ab_z + g_z_0_0_xxyyzzz[k];

                g_z_0_z_xxyzzz[k] = -g_0_xxyzzz[k] - g_z_0_0_xxyzzz[k] * ab_z + g_z_0_0_xxyzzzz[k];

                g_z_0_z_xxzzzz[k] = -g_0_xxzzzz[k] - g_z_0_0_xxzzzz[k] * ab_z + g_z_0_0_xxzzzzz[k];

                g_z_0_z_xyyyyy[k] = -g_0_xyyyyy[k] - g_z_0_0_xyyyyy[k] * ab_z + g_z_0_0_xyyyyyz[k];

                g_z_0_z_xyyyyz[k] = -g_0_xyyyyz[k] - g_z_0_0_xyyyyz[k] * ab_z + g_z_0_0_xyyyyzz[k];

                g_z_0_z_xyyyzz[k] = -g_0_xyyyzz[k] - g_z_0_0_xyyyzz[k] * ab_z + g_z_0_0_xyyyzzz[k];

                g_z_0_z_xyyzzz[k] = -g_0_xyyzzz[k] - g_z_0_0_xyyzzz[k] * ab_z + g_z_0_0_xyyzzzz[k];

                g_z_0_z_xyzzzz[k] = -g_0_xyzzzz[k] - g_z_0_0_xyzzzz[k] * ab_z + g_z_0_0_xyzzzzz[k];

                g_z_0_z_xzzzzz[k] = -g_0_xzzzzz[k] - g_z_0_0_xzzzzz[k] * ab_z + g_z_0_0_xzzzzzz[k];

                g_z_0_z_yyyyyy[k] = -g_0_yyyyyy[k] - g_z_0_0_yyyyyy[k] * ab_z + g_z_0_0_yyyyyyz[k];

                g_z_0_z_yyyyyz[k] = -g_0_yyyyyz[k] - g_z_0_0_yyyyyz[k] * ab_z + g_z_0_0_yyyyyzz[k];

                g_z_0_z_yyyyzz[k] = -g_0_yyyyzz[k] - g_z_0_0_yyyyzz[k] * ab_z + g_z_0_0_yyyyzzz[k];

                g_z_0_z_yyyzzz[k] = -g_0_yyyzzz[k] - g_z_0_0_yyyzzz[k] * ab_z + g_z_0_0_yyyzzzz[k];

                g_z_0_z_yyzzzz[k] = -g_0_yyzzzz[k] - g_z_0_0_yyzzzz[k] * ab_z + g_z_0_0_yyzzzzz[k];

                g_z_0_z_yzzzzz[k] = -g_0_yzzzzz[k] - g_z_0_0_yzzzzz[k] * ab_z + g_z_0_0_yzzzzzz[k];

                g_z_0_z_zzzzzz[k] = -g_0_zzzzzz[k] - g_z_0_0_zzzzzz[k] * ab_z + g_z_0_0_zzzzzzz[k];
            }
        }
    }
}
