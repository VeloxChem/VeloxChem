#ifndef ElectronRepulsionGeom2000ContrRecGIXX_hpp
#define ElectronRepulsionGeom2000ContrRecGIXX_hpp
...
/// @param idx_geom_20_fkxx The contracted integrals buffer.
/// @param r_ab The Cartesian distance R(AB) = A - B.
/// @param c_angmom The angular momentum on center C.
/// @param d_angmom The angular momentum on center D.
auto
comp_bra_geom20_hrr_electron_repulsion_gixx(CSimdArray<double>& cbuffer,
                                            const size_t idx_geom_20_gixx,
                                            const size_t idx_geom_10_fixx,
                                            const size_t idx_geom_20_fixx,
                                            const size_t idx_geom_20_fkxx,
                                            const TPoint<double>& r_ab,
                                            const int c_angmom,
                                            const int d_angmom) -> void;
} // erirec namespace

#endif /* ElectronRepulsionGeom2000ContrRecGIXX_hpp */
