#ifndef ElectronRepulsionGeom2000ContrRecIGXX_hpp
#define ElectronRepulsionGeom2000ContrRecIGXX_hpp
...
/// @param idx_geom_20_igxx The contracted integrals buffer.
...
auto
comp_bra_geom20_hrr_electron_repulsion_igxx(CSimdArray<double>& cbuffer,
                                            const size_t idx_geom_20_igxx,
...
#endif /* ElectronRepulsionGeom2000ContrRecIGXX_hpp */
