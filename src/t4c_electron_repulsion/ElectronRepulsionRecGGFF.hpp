...
/// Computes (GG|1/|r-r'||FF)  integrals for two GTOs pair blocks.
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> contr_buffer_0_slff(4500, ket_dim);
    ...
    CSimdArray<double> ket_spher_buffer_0_slff(2205, ket_dim);
    ...
    CSimdArray<double> ket_spher_buffer_0_pkff(5292, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dgff(4410, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dhff(6174, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_diff(8232, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fgff(7350, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fhff(10290, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_ggff(11025, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_ggff(3969, ket_dim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        ket_spher_buffer_0_pkff.zero();

        ket_spher_buffer_0_dgff.zero();

        ket_spher_buffer_0_dhff.zero();

        ket_spher_buffer_0_diff.zero();

        ket_spher_buffer_0_fgff.zero();

        ket_spher_buffer_0_fhff.zero();

        ket_spher_buffer_0_ggff.zero();

        spher_buffer_0_ggff.zero();
        ...
        erirec::comp_ket_hrr_electron_repulsion_xxff(contr_buffer_0_slff, contr_buffer_0_sldf, contr_buffer_0_sldg, cd_x[0], cd_y[0], cd_z[0], 0, 8);
        ...
        t4cfunc::ket_transform<3, 3>(ket_spher_buffer_0_slff, contr_buffer_0_slff, 0, 8);
        ...
        erirec::comp_bra_hrr_electron_repulsion_pkxx(ket_spher_buffer_0_pkff, ket_spher_buffer_0_skff, ket_spher_buffer_0_slff, ab_x, ab_y, ab_z, 3, 3);
        ...
        erirec::comp_bra_hrr_electron_repulsion_dixx(ket_spher_buffer_0_diff, ket_spher_buffer_0_piff, ket_spher_buffer_0_pkff, ab_x, ab_y, ab_z, 3, 3);
        ...
        erirec::comp_bra_hrr_electron_repulsion_fhxx(ket_spher_buffer_0_fhff, ket_spher_buffer_0_dhff, ket_spher_buffer_0_diff, ab_x, ab_y, ab_z, 3, 3);

        erirec::comp_bra_hrr_electron_repulsion_ggxx(ket_spher_buffer_0_ggff, ket_spher_buffer_0_fgff, ket_spher_buffer_0_fhff, ab_x, ab_y, ab_z, 3, 3);

        t4cfunc::bra_transform<4, 4>(spher_buffer_0_ggff, ket_spher_buffer_0_ggff, 3, 3);

        t4cfunc::store_values(buffer, spher_buffer_0_ggff, 3969 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 4, 4, 3, 3, bra_indices, ket_indices);
}
