...
/// Computes (GG|1/|r-r'||SG)  integrals for two GTOs pair blocks.
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> ket_spher_buffer_0_sisg(252, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_sksg(324, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_slsg(405, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pgsg(405, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_phsg(567, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pisg(756, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pksg(972, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dgsg(810, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dhsg(1134, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_disg(1512, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fgsg(1350, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fhsg(1890, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_ggsg(2025, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_ggsg(729, ket_dim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        ket_spher_buffer_0_sisg.zero();

        ket_spher_buffer_0_sksg.zero();

        ket_spher_buffer_0_slsg.zero();

        ket_spher_buffer_0_pgsg.zero();

        ket_spher_buffer_0_phsg.zero();

        ket_spher_buffer_0_pisg.zero();

        ket_spher_buffer_0_pksg.zero();

        ket_spher_buffer_0_dgsg.zero();

        ket_spher_buffer_0_dhsg.zero();

        ket_spher_buffer_0_disg.zero();

        ket_spher_buffer_0_fgsg.zero();

        ket_spher_buffer_0_fhsg.zero();

        ket_spher_buffer_0_ggsg.zero();

        spher_buffer_0_ggsg.zero();
        ...
        t4cfunc::ket_transform<0, 4>(ket_spher_buffer_0_sisg, cart_buffer_0_sisg, 0, 6);

        t4cfunc::ket_transform<0, 4>(ket_spher_buffer_0_sksg, cart_buffer_0_sksg, 0, 7);

        t4cfunc::ket_transform<0, 4>(ket_spher_buffer_0_slsg, cart_buffer_0_slsg, 0, 8);
        ...
        erirec::comp_bra_hrr_electron_repulsion_phxx(ket_spher_buffer_0_phsg, ket_spher_buffer_0_shsg, ket_spher_buffer_0_sisg, ab_x, ab_y, ab_z, 0, 4);

        erirec::comp_bra_hrr_electron_repulsion_pixx(ket_spher_buffer_0_pisg, ket_spher_buffer_0_sisg, ket_spher_buffer_0_sksg, ab_x, ab_y, ab_z, 0, 4);

        erirec::comp_bra_hrr_electron_repulsion_pkxx(ket_spher_buffer_0_pksg, ket_spher_buffer_0_sksg, ket_spher_buffer_0_slsg, ab_x, ab_y, ab_z, 0, 4);

        erirec::comp_bra_hrr_electron_repulsion_dgxx(ket_spher_buffer_0_dgsg, ket_spher_buffer_0_pgsg, ket_spher_buffer_0_phsg, ab_x, ab_y, ab_z, 0, 4);

        erirec::comp_bra_hrr_electron_repulsion_dhxx(ket_spher_buffer_0_dhsg, ket_spher_buffer_0_phsg, ket_spher_buffer_0_pisg, ab_x, ab_y, ab_z, 0, 4);

        erirec::comp_bra_hrr_electron_repulsion_dixx(ket_spher_buffer_0_disg, ket_spher_buffer_0_pisg, ket_spher_buffer_0_pksg, ab_x, ab_y, ab_z, 0, 4);

        erirec::comp_bra_hrr_electron_repulsion_fgxx(ket_spher_buffer_0_fgsg, ket_spher_buffer_0_dgsg, ket_spher_buffer_0_dhsg, ab_x, ab_y, ab_z, 0, 4);

        erirec::comp_bra_hrr_electron_repulsion_fhxx(ket_spher_buffer_0_fhsg, ket_spher_buffer_0_dhsg, ket_spher_buffer_0_disg, ab_x, ab_y, ab_z, 0, 4);

        erirec::comp_bra_hrr_electron_repulsion_ggxx(ket_spher_buffer_0_ggsg, ket_spher_buffer_0_fgsg, ket_spher_buffer_0_fhsg, ab_x, ab_y, ab_z, 0, 4);

        t4cfunc::bra_transform<4, 4>(spher_buffer_0_ggsg, ket_spher_buffer_0_ggsg, 0, 4);

        t4cfunc::store_values(buffer, spher_buffer_0_ggsg, 729 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 4, 4, 0, 4, bra_indices, ket_indices);
}
