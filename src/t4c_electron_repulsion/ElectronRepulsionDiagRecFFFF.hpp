...
/// Computes (FF|1/|r-r'||FF)  integrals for GTOs pair block.
...
template <class T>
auto
comp_diag_electron_repulsion_ffff(T* distributor,
                                  ...
                                  const std::array<int, 2>& gto_indices) -> void
{
    ...
    CSimdArray<double> prim_buffer_3_sdss(6, npgtos);
    ...
    CSimdArray<double> prim_buffer_3_sfss(10, npgtos);

    CSimdArray<double> prim_buffer_2_sfsp(30, npgtos);
    ...
    CSimdArray<double> prim_buffer_2_sgsp(45, npgtos);

    CSimdArray<double> prim_buffer_1_sgsd(90, npgtos);
    ...
    CSimdArray<double> prim_buffer_1_shsd(126, npgtos);

    CSimdArray<double> prim_buffer_0_shsf(210, npgtos);
    ...
    CSimdArray<double> prim_buffer_0_sisf(280, npgtos);
    ...
    CSimdArray<double> cart_buffer_0_sfsh(210, 1);

    CSimdArray<double> cart_buffer_0_sfsi(280, 1);
    ...
    CSimdArray<double> cart_buffer_0_shsf(210, 1);
    ...
    CSimdArray<double> cart_buffer_0_sisf(280, 1);
    ...
    CSimdArray<double> contr_buffer_0_sfpg(450, 1);

    CSimdArray<double> contr_buffer_0_sfph(630, 1);

    CSimdArray<double> contr_buffer_0_sfdf(600, 1);

    CSimdArray<double> contr_buffer_0_sfdg(900, 1);

    CSimdArray<double> contr_buffer_0_sfff(1000, 1);
    ...
    CSimdArray<double> contr_buffer_0_sgdf(900, 1);

    CSimdArray<double> contr_buffer_0_sgdg(1350, 1);

    CSimdArray<double> contr_buffer_0_sgff(1500, 1);

    CSimdArray<double> contr_buffer_0_shpf(630, 1);

    CSimdArray<double> contr_buffer_0_shpg(945, 1);

    CSimdArray<double> contr_buffer_0_shph(1323, 1);

    CSimdArray<double> contr_buffer_0_shdf(1260, 1);

    CSimdArray<double> contr_buffer_0_shdg(1890, 1);

    CSimdArray<double> contr_buffer_0_shff(2100, 1);

    CSimdArray<double> contr_buffer_0_sipf(840, 1);

    CSimdArray<double> contr_buffer_0_sipg(1260, 1);

    CSimdArray<double> contr_buffer_0_siph(1764, 1);

    CSimdArray<double> contr_buffer_0_sidf(1680, 1);

    CSimdArray<double> contr_buffer_0_sidg(2520, 1);

    CSimdArray<double> contr_buffer_0_siff(2800, 1);

    // allocate aligned half transformed integrals

    CSimdArray<double> ket_spher_buffer_0_sfff(490, 1);

    CSimdArray<double> ket_spher_buffer_0_sgff(735, 1);

    CSimdArray<double> ket_spher_buffer_0_shff(1029, 1);

    CSimdArray<double> ket_spher_buffer_0_siff(1372, 1);

    CSimdArray<double> ket_spher_buffer_0_pfff(1470, 1);

    CSimdArray<double> ket_spher_buffer_0_pgff(2205, 1);

    CSimdArray<double> ket_spher_buffer_0_phff(3087, 1);

    CSimdArray<double> ket_spher_buffer_0_dfff(2940, 1);

    CSimdArray<double> ket_spher_buffer_0_dgff(4410, 1);

    CSimdArray<double> ket_spher_buffer_0_ffff(4900, 1);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_ffff(2401, 1);
    ...
    for (auto i = gto_indices[0]; i < gto_indices[1]; i++)
    {
        ...
        ket_spher_buffer_0_sfff.zero();

        ket_spher_buffer_0_sgff.zero();

        ket_spher_buffer_0_shff.zero();

        ket_spher_buffer_0_siff.zero();

        ket_spher_buffer_0_pfff.zero();

        ket_spher_buffer_0_pgff.zero();

        ket_spher_buffer_0_phff.zero();

        ket_spher_buffer_0_dfff.zero();

        ket_spher_buffer_0_dgff.zero();

        ket_spher_buffer_0_ffff.zero();

        spher_buffer_0_ffff.zero();
        ...
        for (int j = 0; j < npgtos; j++)
        {
            ...
            t2cfunc::reduce(cart_buffer_0_sfsh, prim_buffer_0_sfsh, 1, npgtos);

            t2cfunc::reduce(cart_buffer_0_sfsi, prim_buffer_0_sfsi, 1, npgtos);
            ...
            t2cfunc::reduce(cart_buffer_0_shsf, prim_buffer_0_shsf, 1, npgtos);
            ...
            t2cfunc::reduce(cart_buffer_0_sisf, prim_buffer_0_sisf, 1, npgtos);
        ...
        erirec::comp_ket_hrr_electron_repulsion_xxff(contr_buffer_0_sfff, contr_buffer_0_sfdf, contr_buffer_0_sfdg, cd_x[0], cd_y[0], cd_z[0], 0, 3);
        ...
        erirec::comp_ket_hrr_electron_repulsion_xxff(contr_buffer_0_siff, contr_buffer_0_sidf, contr_buffer_0_sidg, cd_x[0], cd_y[0], cd_z[0], 0, 6);

        t4cfunc::ket_transform<3, 3>(ket_spher_buffer_0_sfff, contr_buffer_0_sfff, 0, 3);
        ...
        t4cfunc::ket_transform<3, 3>(ket_spher_buffer_0_siff, contr_buffer_0_siff, 0, 6);

        erirec::comp_bra_hrr_electron_repulsion_pfxx(ket_spher_buffer_0_pfff, ket_spher_buffer_0_sfff, ket_spher_buffer_0_sgff, ab_x, ab_y, ab_z, 3, 3);
        ...
        erirec::comp_bra_hrr_electron_repulsion_phxx(ket_spher_buffer_0_phff, ket_spher_buffer_0_shff, ket_spher_buffer_0_siff, ab_x, ab_y, ab_z, 3, 3);

        erirec::comp_bra_hrr_electron_repulsion_dfxx(ket_spher_buffer_0_dfff, ket_spher_buffer_0_pfff, ket_spher_buffer_0_pgff, ab_x, ab_y, ab_z, 3, 3);

        erirec::comp_bra_hrr_electron_repulsion_dgxx(ket_spher_buffer_0_dgff, ket_spher_buffer_0_pgff, ket_spher_buffer_0_phff, ab_x, ab_y, ab_z, 3, 3);

        erirec::comp_bra_hrr_electron_repulsion_ffxx(ket_spher_buffer_0_ffff, ket_spher_buffer_0_dfff, ket_spher_buffer_0_dgff, ab_x, ab_y, ab_z, 3, 3);

        t4cfunc::bra_transform<3, 3>(spher_buffer_0_ffff, ket_spher_buffer_0_ffff, 3, 3);

        t4cfunc::update_max_values(max_values, spher_buffer_0_ffff, i - gto_indices[0]); 
    }
