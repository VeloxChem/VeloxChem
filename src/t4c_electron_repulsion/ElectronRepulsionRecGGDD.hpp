...
/// Computes (GG|1/|r-r'||DD)  integrals for two GTOs pair blocks.
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> contr_buffer_0_slpd(810, ket_dim);

    CSimdArray<double> contr_buffer_0_slpf(1350, ket_dim);

    CSimdArray<double> contr_buffer_0_sldd(1620, ket_dim);
    ...
    CSimdArray<double> ket_spher_buffer_0_sldd(1125, ket_dim);
    ...
    CSimdArray<double> ket_spher_buffer_0_pkdd(2700, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dgdd(2250, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dhdd(3150, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_didd(4200, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fgdd(3750, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fhdd(5250, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_ggdd(5625, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_ggdd(2025, ket_dim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        ket_spher_buffer_0_pkdd.zero();

        ket_spher_buffer_0_dgdd.zero();

        ket_spher_buffer_0_dhdd.zero();

        ket_spher_buffer_0_didd.zero();

        ket_spher_buffer_0_fgdd.zero();

        ket_spher_buffer_0_fhdd.zero();

        ket_spher_buffer_0_ggdd.zero();

        spher_buffer_0_ggdd.zero();
        ...
        erirec::comp_ket_hrr_electron_repulsion_xxpd(contr_buffer_0_slpd, cart_buffer_0_slsd, cart_buffer_0_slsf, cd_x[0], cd_y[0], cd_z[0], 0, 8);
        ...
        erirec::comp_ket_hrr_electron_repulsion_xxdd(contr_buffer_0_sldd, contr_buffer_0_slpd, contr_buffer_0_slpf, cd_x[0], cd_y[0], cd_z[0], 0, 8);
        ...
        t4cfunc::ket_transform<2, 2>(ket_spher_buffer_0_sldd, contr_buffer_0_sldd, 0, 8);
        ...
        erirec::comp_bra_hrr_electron_repulsion_pkxx(ket_spher_buffer_0_pkdd, ket_spher_buffer_0_skdd, ket_spher_buffer_0_sldd, ab_x, ab_y, ab_z, 2, 2);
        ...
        erirec::comp_bra_hrr_electron_repulsion_dixx(ket_spher_buffer_0_didd, ket_spher_buffer_0_pidd, ket_spher_buffer_0_pkdd, ab_x, ab_y, ab_z, 2, 2);
        ...
        erirec::comp_bra_hrr_electron_repulsion_fhxx(ket_spher_buffer_0_fhdd, ket_spher_buffer_0_dhdd, ket_spher_buffer_0_didd, ab_x, ab_y, ab_z, 2, 2);

        erirec::comp_bra_hrr_electron_repulsion_ggxx(ket_spher_buffer_0_ggdd, ket_spher_buffer_0_fgdd, ket_spher_buffer_0_fhdd, ab_x, ab_y, ab_z, 2, 2);

        t4cfunc::bra_transform<4, 4>(spher_buffer_0_ggdd, ket_spher_buffer_0_ggdd, 2, 2);

        t4cfunc::store_values(buffer, spher_buffer_0_ggdd, 2025 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 4, 4, 2, 2, bra_indices, ket_indices);
}
