...
/// Computes (FG|1/|r-r'||PD)  integrals for two GTOs pair blocks.
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> ket_spher_buffer_0_sgpd(225, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_shpd(315, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_sipd(420, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_skpd(540, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pgpd(675, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_phpd(945, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pipd(1260, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dgpd(1350, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dhpd(1890, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fgpd(2250, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_fgpd(945, ket_dim);

    // allocate accumulation buffer for integrals

    CSimdArray<double> buffer(bra_dim * 945, ket_dim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        ket_spher_buffer_0_sgpd.zero();

        ket_spher_buffer_0_shpd.zero();

        ket_spher_buffer_0_sipd.zero();

        ket_spher_buffer_0_skpd.zero();

        ket_spher_buffer_0_pgpd.zero();

        ket_spher_buffer_0_phpd.zero();

        ket_spher_buffer_0_pipd.zero();

        ket_spher_buffer_0_dgpd.zero();

        ket_spher_buffer_0_dhpd.zero();

        ket_spher_buffer_0_fgpd.zero();

        spher_buffer_0_fgpd.zero();
        ...
        t4cfunc::ket_transform<1, 2>(ket_spher_buffer_0_sgpd, contr_buffer_0_sgpd, 0, 4);

        t4cfunc::ket_transform<1, 2>(ket_spher_buffer_0_shpd, contr_buffer_0_shpd, 0, 5);

        t4cfunc::ket_transform<1, 2>(ket_spher_buffer_0_sipd, contr_buffer_0_sipd, 0, 6);

        t4cfunc::ket_transform<1, 2>(ket_spher_buffer_0_skpd, contr_buffer_0_skpd, 0, 7);

        erirec::comp_bra_hrr_electron_repulsion_pgxx(ket_spher_buffer_0_pgpd, ket_spher_buffer_0_sgpd, ket_spher_buffer_0_shpd, ab_x, ab_y, ab_z, 1, 2);

        erirec::comp_bra_hrr_electron_repulsion_phxx(ket_spher_buffer_0_phpd, ket_spher_buffer_0_shpd, ket_spher_buffer_0_sipd, ab_x, ab_y, ab_z, 1, 2);

        erirec::comp_bra_hrr_electron_repulsion_pixx(ket_spher_buffer_0_pipd, ket_spher_buffer_0_sipd, ket_spher_buffer_0_skpd, ab_x, ab_y, ab_z, 1, 2);

        erirec::comp_bra_hrr_electron_repulsion_dgxx(ket_spher_buffer_0_dgpd, ket_spher_buffer_0_pgpd, ket_spher_buffer_0_phpd, ab_x, ab_y, ab_z, 1, 2);

        erirec::comp_bra_hrr_electron_repulsion_dhxx(ket_spher_buffer_0_dhpd, ket_spher_buffer_0_phpd, ket_spher_buffer_0_pipd, ab_x, ab_y, ab_z, 1, 2);

        erirec::comp_bra_hrr_electron_repulsion_fgxx(ket_spher_buffer_0_fgpd, ket_spher_buffer_0_dgpd, ket_spher_buffer_0_dhpd, ab_x, ab_y, ab_z, 1, 2);

        t4cfunc::bra_transform<3, 4>(spher_buffer_0_fgpd, ket_spher_buffer_0_fgpd, 1, 2);

        t4cfunc::store_values(buffer, spher_buffer_0_fgpd, 945 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 3, 4, 1, 2, bra_indices, ket_indices);
}
