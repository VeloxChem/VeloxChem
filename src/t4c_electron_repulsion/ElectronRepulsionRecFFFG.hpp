...
/// Computes (FF|1/|r-r'||FG)  integrals for two GTOs pair blocks.
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> ket_spher_buffer_0_sffg(630, ket_dim);
    ...
    CSimdArray<double> ket_spher_buffer_0_pffg(1890, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pgfg(2835, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_phfg(3969, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dffg(3780, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dgfg(5670, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fffg(6300, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_fffg(3087, ket_dim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        ket_spher_buffer_0_pffg.zero();

        ket_spher_buffer_0_pgfg.zero();

        ket_spher_buffer_0_phfg.zero();

        ket_spher_buffer_0_dffg.zero();

        ket_spher_buffer_0_dgfg.zero();

        ket_spher_buffer_0_fffg.zero();

        spher_buffer_0_fffg.zero();
        ...
        t4cfunc::ket_transform<3, 4>(ket_spher_buffer_0_sffg, contr_buffer_0_sffg, 0, 3);
        ...
        erirec::comp_bra_hrr_electron_repulsion_pfxx(ket_spher_buffer_0_pffg, ket_spher_buffer_0_sffg, ket_spher_buffer_0_sgfg, ab_x, ab_y, ab_z, 3, 4);
        ...
        erirec::comp_bra_hrr_electron_repulsion_dfxx(ket_spher_buffer_0_dffg, ket_spher_buffer_0_pffg, ket_spher_buffer_0_pgfg, ab_x, ab_y, ab_z, 3, 4);
        ...
        erirec::comp_bra_hrr_electron_repulsion_ffxx(ket_spher_buffer_0_fffg, ket_spher_buffer_0_dffg, ket_spher_buffer_0_dgfg, ab_x, ab_y, ab_z, 3, 4);

        t4cfunc::bra_transform<3, 3>(spher_buffer_0_fffg, ket_spher_buffer_0_fffg, 3, 4);

        t4cfunc::store_values(buffer, spher_buffer_0_fffg, 3087 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 3, 3, 3, 4, bra_indices, ket_indices);
}
