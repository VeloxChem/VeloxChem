...
/// Computes (FF|1/|r-r'||PG)  integrals for two GTOs pair blocks.
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> ket_spher_buffer_0_pfpg(810, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pgpg(1215, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_phpg(1701, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dfpg(1620, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dgpg(2430, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_ffpg(2700, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_ffpg(1323, ket_dim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        ket_spher_buffer_0_pfpg.zero();

        ket_spher_buffer_0_pgpg.zero();

        ket_spher_buffer_0_phpg.zero();

        ket_spher_buffer_0_dfpg.zero();

        ket_spher_buffer_0_dgpg.zero();

        ket_spher_buffer_0_ffpg.zero();

        spher_buffer_0_ffpg.zero();
        ...
        erirec::comp_bra_hrr_electron_repulsion_pfxx(ket_spher_buffer_0_pfpg, ket_spher_buffer_0_sfpg, ket_spher_buffer_0_sgpg, ab_x, ab_y, ab_z, 1, 4);
        ...
        erirec::comp_bra_hrr_electron_repulsion_dfxx(ket_spher_buffer_0_dfpg, ket_spher_buffer_0_pfpg, ket_spher_buffer_0_pgpg, ab_x, ab_y, ab_z, 1, 4);
        ...
        erirec::comp_bra_hrr_electron_repulsion_ffxx(ket_spher_buffer_0_ffpg, ket_spher_buffer_0_dfpg, ket_spher_buffer_0_dgpg, ab_x, ab_y, ab_z, 1, 4);

        t4cfunc::bra_transform<3, 3>(spher_buffer_0_ffpg, ket_spher_buffer_0_ffpg, 1, 4);

        t4cfunc::store_values(buffer, spher_buffer_0_ffpg, 1323 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 3, 3, 1, 4, bra_indices, ket_indices);
}
