#ifndef ElectronRepulsionDiagRecDDDD_hpp
#define ElectronRepulsionDiagRecDDDD_hpp
...
/// Computes (DD|1/|r-r'||DD)  integrals for GTOs pair block.
...
template <class T>
auto
comp_diag_electron_repulsion_dddd(T* distributor,
                                  ...
                                  const std::array<int, 2>& gto_indices) -> void
{
    ...
    CSimdArray<double> prim_buffer_2_sdss(6, npgtos);
    ...
    CSimdArray<double> prim_buffer_1_sfsp(30, npgtos);
    ...
    CSimdArray<double> prim_buffer_0_sgsd(90, npgtos);
    ...
    CSimdArray<double> cart_buffer_0_sdsg(90, 1);
    ...
    CSimdArray<double> cart_buffer_0_sgsd(90, 1);
    ...
    CSimdArray<double> contr_buffer_0_sdpf(180, 1);

    CSimdArray<double> contr_buffer_0_sddd(216, 1);

    CSimdArray<double> contr_buffer_0_sfpd(180, 1);

    CSimdArray<double> contr_buffer_0_sfpf(300, 1);

    CSimdArray<double> contr_buffer_0_sfdd(360, 1);

    CSimdArray<double> contr_buffer_0_sgpd(270, 1);

    CSimdArray<double> contr_buffer_0_sgpf(450, 1);

    CSimdArray<double> contr_buffer_0_sgdd(540, 1);

    // allocate aligned half transformed integrals

    CSimdArray<double> ket_spher_buffer_0_sddd(150, 1);

    CSimdArray<double> ket_spher_buffer_0_sfdd(250, 1);

    CSimdArray<double> ket_spher_buffer_0_sgdd(375, 1);

    CSimdArray<double> ket_spher_buffer_0_pddd(450, 1);

    CSimdArray<double> ket_spher_buffer_0_pfdd(750, 1);

    CSimdArray<double> ket_spher_buffer_0_dddd(900, 1);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_dddd(625, 1);
    ...
    for (auto i = gto_indices[0]; i < gto_indices[1]; i++)
    {
        ...
        ket_spher_buffer_0_pddd.zero();

        ket_spher_buffer_0_pfdd.zero();

        ket_spher_buffer_0_dddd.zero();

        spher_buffer_0_dddd.zero();
        ...
        for (int j = 0; j < npgtos; j++)
        {
            ...
            t2cfunc::reduce(cart_buffer_0_sdsg, prim_buffer_0_sdsg, 1, npgtos);
            ...
            t2cfunc::reduce(cart_buffer_0_sgsd, prim_buffer_0_sgsd, 1, npgtos);
        ...
        erirec::comp_bra_hrr_electron_repulsion_pdxx(ket_spher_buffer_0_pddd, ket_spher_buffer_0_sddd, ket_spher_buffer_0_sfdd, ab_x, ab_y, ab_z, 2, 2);
        ...
        erirec::comp_bra_hrr_electron_repulsion_ddxx(ket_spher_buffer_0_dddd, ket_spher_buffer_0_pddd, ket_spher_buffer_0_pfdd, ab_x, ab_y, ab_z, 2, 2);

        t4cfunc::bra_transform<2, 2>(spher_buffer_0_dddd, ket_spher_buffer_0_dddd, 2, 2);

        t4cfunc::update_max_values(max_values, spher_buffer_0_dddd, i - gto_indices[0]); 
    }
...
#endif /* ElectronRepulsionDiagRecDDDD_hpp */
