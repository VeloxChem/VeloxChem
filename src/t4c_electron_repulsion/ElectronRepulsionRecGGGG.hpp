                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> prim_buffer_16_ssss(1, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_15_sssp(3, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_14_sssd(6, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_13_sssf(10, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_12_sssg(15, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_11_sssh(21, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_10_sssi(28, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_9_sssk(36, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_8_sssl(45, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_7_spsl(135, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_6_sdsl(270, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_5_sfsl(450, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_4_sgsl(675, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_3_shsl(945, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_2_sisl(1260, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_1_sksl(1620, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_0_slsl(2025, ket_pdim);
    ...
    CSimdArray<double> cart_buffer_0_slsl(2025, ket_dim);
    ...
    CSimdArray<double> contr_buffer_0_slpk(4860, ket_dim);

    CSimdArray<double> contr_buffer_0_sldg(4050, ket_dim);

    CSimdArray<double> contr_buffer_0_sldh(5670, ket_dim);

    CSimdArray<double> contr_buffer_0_sldi(7560, ket_dim);

    CSimdArray<double> contr_buffer_0_slfg(6750, ket_dim);

    CSimdArray<double> contr_buffer_0_slfh(9450, ket_dim);

    CSimdArray<double> contr_buffer_0_slgg(10125, ket_dim);
    ...
    CSimdArray<double> ket_spher_buffer_0_slgg(3645, ket_dim);
    ...
    CSimdArray<double> ket_spher_buffer_0_pkgg(8748, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dggg(7290, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dhgg(10206, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_digg(13608, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fggg(12150, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fhgg(17010, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_gggg(18225, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_gggg(6561, ket_dim);

    // allocate accumulation buffer for integrals

    CSimdArray<double> buffer(bra_dim * 6561, ket_dim);
    ...
    CSimdArray<double> bf_values(17, ket_pdim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        for (int j = 0; j < npgtos; j++)
        {
            ...
            t2cfunc::reduce(cart_buffer_0_sgsl, prim_buffer_0_sgsl, ket_dim, npgtos);
            ...
            t2cfunc::reduce(cart_buffer_0_shsl, prim_buffer_0_shsl, ket_dim, npgtos);
            ...
            t2cfunc::reduce(cart_buffer_0_sisl, prim_buffer_0_sisl, ket_dim, npgtos);
            ...
            t2cfunc::reduce(cart_buffer_0_sksl, prim_buffer_0_sksl, ket_dim, npgtos);

            t2cfunc::reduce(cart_buffer_0_slsg, prim_buffer_0_slsg, ket_dim, npgtos);

            t2cfunc::reduce(cart_buffer_0_slsh, prim_buffer_0_slsh, ket_dim, npgtos);

            t2cfunc::reduce(cart_buffer_0_slsi, prim_buffer_0_slsi, ket_dim, npgtos);

            t2cfunc::reduce(cart_buffer_0_slsk, prim_buffer_0_slsk, ket_dim, npgtos);

            t2cfunc::reduce(cart_buffer_0_slsl, prim_buffer_0_slsl, ket_dim, npgtos);
        ...
        t4cfunc::store_values(buffer, spher_buffer_0_gggg, 6561 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, 4, 4, bra_indices, ket_indices);
}

/// Computes (GG|1/|r-r'||GG)  integrals for two GTOs pair blocks.
/// - Parameter distributor: the pointer to Fock matrix/matrices distributor.
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t2cfunc::reduce(cart_buffer_0_slsl, prim_buffer_0_slsl, ket_dim, ket_npgtos);
    ...
    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 4, 4, 4, 4, bra_indices, ket_indices);
}
