...
/// Computes (SF|1/|r-r'||SF)  integrals for GTOs pair block.
                                  ...
                                  const std::array<int, 2>& gto_indices) -> void
{
    ...
    CSimdArray<double> ket_spher_buffer_0_sfsf(70, 1);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_sfsf(49, 1);
    ...
    for (auto i = gto_indices[0]; i < gto_indices[1]; i++)
    {
        ...
        t4cfunc::bra_transform<0, 3>(spher_buffer_0_sfsf, ket_spher_buffer_0_sfsf, 0, 3);

        t4cfunc::update_max_values(max_values, spher_buffer_0_sfsf, i - gto_indices[0]); 
    }
