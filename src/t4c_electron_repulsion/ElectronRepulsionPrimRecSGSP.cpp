...
{
    const auto ndims = prim_buffer_0_sgsp.number_of_columns();
    ...
    /// Set up 0-3 components of targeted buffer : prim_buffer_0_sgsp
    ...
    /// Set up 3-6 components of targeted buffer : prim_buffer_0_sgsp

    auto g_0_xxxy_0_x_0 = prim_buffer_0_sgsp[3];

    auto g_0_xxxy_0_y_0 = prim_buffer_0_sgsp[4];

    auto g_0_xxxy_0_z_0 = prim_buffer_0_sgsp[5];
    ...
    /// Set up 6-9 components of targeted buffer : prim_buffer_0_sgsp

    auto g_0_xxxz_0_x_0 = prim_buffer_0_sgsp[6];

    auto g_0_xxxz_0_y_0 = prim_buffer_0_sgsp[7];
    ...
    /// Set up 9-12 components of targeted buffer : prim_buffer_0_sgsp
    ...
    /// Set up 12-15 components of targeted buffer : prim_buffer_0_sgsp

    auto g_0_xxyz_0_x_0 = prim_buffer_0_sgsp[12];

    auto g_0_xxyz_0_y_0 = prim_buffer_0_sgsp[13];

    auto g_0_xxyz_0_z_0 = prim_buffer_0_sgsp[14];
    ...
    /// Set up 15-18 components of targeted buffer : prim_buffer_0_sgsp
    ...
    /// Set up 18-21 components of targeted buffer : prim_buffer_0_sgsp
    ...
    /// Set up 21-24 components of targeted buffer : prim_buffer_0_sgsp

    auto g_0_xyyz_0_x_0 = prim_buffer_0_sgsp[21];

    auto g_0_xyyz_0_y_0 = prim_buffer_0_sgsp[22];

    auto g_0_xyyz_0_z_0 = prim_buffer_0_sgsp[23];
    ...
    /// Set up 24-27 components of targeted buffer : prim_buffer_0_sgsp

    auto g_0_xyzz_0_x_0 = prim_buffer_0_sgsp[24];

    auto g_0_xyzz_0_y_0 = prim_buffer_0_sgsp[25];

    auto g_0_xyzz_0_z_0 = prim_buffer_0_sgsp[26];
    ...
    /// Set up 27-30 components of targeted buffer : prim_buffer_0_sgsp
    ...
    /// Set up 30-33 components of targeted buffer : prim_buffer_0_sgsp
    ...
    /// Set up 33-36 components of targeted buffer : prim_buffer_0_sgsp

    auto g_0_yyyz_0_x_0 = prim_buffer_0_sgsp[33];
    ...
    /// Set up 36-39 components of targeted buffer : prim_buffer_0_sgsp
    ...
    /// Set up 39-42 components of targeted buffer : prim_buffer_0_sgsp
    ...
    /// Set up 42-45 components of targeted buffer : prim_buffer_0_sgsp
