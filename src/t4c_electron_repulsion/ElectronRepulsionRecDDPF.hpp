#ifndef ElectronRepulsionRecDDPF_hpp
#define ElectronRepulsionRecDDPF_hpp
...
/// Computes (DD|1/|r-r'||PF)  integrals for two GTOs pair blocks.
...
template <class T>
auto
comp_electron_repulsion_ddpf(T* distributor,
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> ket_spher_buffer_0_sdpf(126, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_sfpf(210, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_sgpf(315, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pdpf(378, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pfpf(630, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_ddpf(756, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_ddpf(525, ket_dim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        ket_spher_buffer_0_sdpf.zero();

        ket_spher_buffer_0_sfpf.zero();

        ket_spher_buffer_0_sgpf.zero();

        ket_spher_buffer_0_pdpf.zero();

        ket_spher_buffer_0_pfpf.zero();

        ket_spher_buffer_0_ddpf.zero();

        spher_buffer_0_ddpf.zero();
        ...
        t4cfunc::ket_transform<1, 3>(ket_spher_buffer_0_sdpf, contr_buffer_0_sdpf, 0, 2);
        ...
        erirec::comp_bra_hrr_electron_repulsion_pdxx(ket_spher_buffer_0_pdpf, ket_spher_buffer_0_sdpf, ket_spher_buffer_0_sfpf, ab_x, ab_y, ab_z, 1, 3);
        ...
        erirec::comp_bra_hrr_electron_repulsion_ddxx(ket_spher_buffer_0_ddpf, ket_spher_buffer_0_pdpf, ket_spher_buffer_0_pfpf, ab_x, ab_y, ab_z, 1, 3);

        t4cfunc::bra_transform<2, 2>(spher_buffer_0_ddpf, ket_spher_buffer_0_ddpf, 1, 3);

        t4cfunc::store_values(buffer, spher_buffer_0_ddpf, 525 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 2, 2, 1, 3, bra_indices, ket_indices);
}

} // erirec namespace

#endif /* ElectronRepulsionRecDDPF_hpp */
