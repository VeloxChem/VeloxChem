...
auto
comp_prim_electron_repulsion_sdsi(CSimdArray<double>& prim_buffer_0_sdsi,
                                  ...
                                  const CSimdArray<double>& prim_buffer_0_spsi,
...
{
    const auto ndims = prim_buffer_0_sdsi.number_of_columns();
    ...
    /// Set up components of auxilary buffer : prim_buffer_0_spsi
    ...
    /// Set up components of auxilary buffer : prim_buffer_1_spsi

    auto g_0_x_0_xxxxxx_1 = prim_buffer_1_spsi[0];

    auto g_0_x_0_xxxxxy_1 = prim_buffer_1_spsi[1];

    auto g_0_x_0_xxxxxz_1 = prim_buffer_1_spsi[2];

    auto g_0_x_0_xxxxyy_1 = prim_buffer_1_spsi[3];

    auto g_0_x_0_xxxxyz_1 = prim_buffer_1_spsi[4];

    auto g_0_x_0_xxxxzz_1 = prim_buffer_1_spsi[5];

    auto g_0_x_0_xxxyyy_1 = prim_buffer_1_spsi[6];

    auto g_0_x_0_xxxyyz_1 = prim_buffer_1_spsi[7];

    auto g_0_x_0_xxxyzz_1 = prim_buffer_1_spsi[8];

    auto g_0_x_0_xxxzzz_1 = prim_buffer_1_spsi[9];

    auto g_0_x_0_xxyyyy_1 = prim_buffer_1_spsi[10];

    auto g_0_x_0_xxyyyz_1 = prim_buffer_1_spsi[11];

    auto g_0_x_0_xxyyzz_1 = prim_buffer_1_spsi[12];

    auto g_0_x_0_xxyzzz_1 = prim_buffer_1_spsi[13];

    auto g_0_x_0_xxzzzz_1 = prim_buffer_1_spsi[14];

    auto g_0_x_0_xyyyyy_1 = prim_buffer_1_spsi[15];

    auto g_0_x_0_xyyyyz_1 = prim_buffer_1_spsi[16];

    auto g_0_x_0_xyyyzz_1 = prim_buffer_1_spsi[17];

    auto g_0_x_0_xyyzzz_1 = prim_buffer_1_spsi[18];

    auto g_0_x_0_xyzzzz_1 = prim_buffer_1_spsi[19];

    auto g_0_x_0_xzzzzz_1 = prim_buffer_1_spsi[20];

    auto g_0_x_0_yyyyyy_1 = prim_buffer_1_spsi[21];

    auto g_0_x_0_yyyyyz_1 = prim_buffer_1_spsi[22];

    auto g_0_x_0_yyyyzz_1 = prim_buffer_1_spsi[23];

    auto g_0_x_0_yyyzzz_1 = prim_buffer_1_spsi[24];

    auto g_0_x_0_yyzzzz_1 = prim_buffer_1_spsi[25];

    auto g_0_x_0_yzzzzz_1 = prim_buffer_1_spsi[26];

    auto g_0_x_0_zzzzzz_1 = prim_buffer_1_spsi[27];

    auto g_0_y_0_xxxxxx_1 = prim_buffer_1_spsi[28];

    auto g_0_y_0_xxxxxy_1 = prim_buffer_1_spsi[29];

    auto g_0_y_0_xxxxxz_1 = prim_buffer_1_spsi[30];

    auto g_0_y_0_xxxxyy_1 = prim_buffer_1_spsi[31];

    auto g_0_y_0_xxxxyz_1 = prim_buffer_1_spsi[32];

    auto g_0_y_0_xxxxzz_1 = prim_buffer_1_spsi[33];

    auto g_0_y_0_xxxyyy_1 = prim_buffer_1_spsi[34];

    auto g_0_y_0_xxxyyz_1 = prim_buffer_1_spsi[35];

    auto g_0_y_0_xxxyzz_1 = prim_buffer_1_spsi[36];

    auto g_0_y_0_xxxzzz_1 = prim_buffer_1_spsi[37];

    auto g_0_y_0_xxyyyy_1 = prim_buffer_1_spsi[38];

    auto g_0_y_0_xxyyyz_1 = prim_buffer_1_spsi[39];

    auto g_0_y_0_xxyyzz_1 = prim_buffer_1_spsi[40];

    auto g_0_y_0_xxyzzz_1 = prim_buffer_1_spsi[41];

    auto g_0_y_0_xxzzzz_1 = prim_buffer_1_spsi[42];

    auto g_0_y_0_xyyyyy_1 = prim_buffer_1_spsi[43];

    auto g_0_y_0_xyyyyz_1 = prim_buffer_1_spsi[44];

    auto g_0_y_0_xyyyzz_1 = prim_buffer_1_spsi[45];

    auto g_0_y_0_xyyzzz_1 = prim_buffer_1_spsi[46];

    auto g_0_y_0_xyzzzz_1 = prim_buffer_1_spsi[47];

    auto g_0_y_0_xzzzzz_1 = prim_buffer_1_spsi[48];

    auto g_0_y_0_yyyyyy_1 = prim_buffer_1_spsi[49];

    auto g_0_y_0_yyyyyz_1 = prim_buffer_1_spsi[50];

    auto g_0_y_0_yyyyzz_1 = prim_buffer_1_spsi[51];

    auto g_0_y_0_yyyzzz_1 = prim_buffer_1_spsi[52];

    auto g_0_y_0_yyzzzz_1 = prim_buffer_1_spsi[53];

    auto g_0_y_0_yzzzzz_1 = prim_buffer_1_spsi[54];

    auto g_0_y_0_zzzzzz_1 = prim_buffer_1_spsi[55];

    auto g_0_z_0_xxxxxx_1 = prim_buffer_1_spsi[56];

    auto g_0_z_0_xxxxxy_1 = prim_buffer_1_spsi[57];

    auto g_0_z_0_xxxxxz_1 = prim_buffer_1_spsi[58];

    auto g_0_z_0_xxxxyy_1 = prim_buffer_1_spsi[59];

    auto g_0_z_0_xxxxyz_1 = prim_buffer_1_spsi[60];

    auto g_0_z_0_xxxxzz_1 = prim_buffer_1_spsi[61];

    auto g_0_z_0_xxxyyy_1 = prim_buffer_1_spsi[62];

    auto g_0_z_0_xxxyyz_1 = prim_buffer_1_spsi[63];

    auto g_0_z_0_xxxyzz_1 = prim_buffer_1_spsi[64];

    auto g_0_z_0_xxxzzz_1 = prim_buffer_1_spsi[65];

    auto g_0_z_0_xxyyyy_1 = prim_buffer_1_spsi[66];

    auto g_0_z_0_xxyyyz_1 = prim_buffer_1_spsi[67];

    auto g_0_z_0_xxyyzz_1 = prim_buffer_1_spsi[68];

    auto g_0_z_0_xxyzzz_1 = prim_buffer_1_spsi[69];

    auto g_0_z_0_xxzzzz_1 = prim_buffer_1_spsi[70];

    auto g_0_z_0_xyyyyy_1 = prim_buffer_1_spsi[71];

    auto g_0_z_0_xyyyyz_1 = prim_buffer_1_spsi[72];

    auto g_0_z_0_xyyyzz_1 = prim_buffer_1_spsi[73];

    auto g_0_z_0_xyyzzz_1 = prim_buffer_1_spsi[74];

    auto g_0_z_0_xyzzzz_1 = prim_buffer_1_spsi[75];

    auto g_0_z_0_xzzzzz_1 = prim_buffer_1_spsi[76];

    auto g_0_z_0_yyyyyy_1 = prim_buffer_1_spsi[77];

    auto g_0_z_0_yyyyyz_1 = prim_buffer_1_spsi[78];

    auto g_0_z_0_yyyyzz_1 = prim_buffer_1_spsi[79];

    auto g_0_z_0_yyyzzz_1 = prim_buffer_1_spsi[80];

    auto g_0_z_0_yyzzzz_1 = prim_buffer_1_spsi[81];

    auto g_0_z_0_yzzzzz_1 = prim_buffer_1_spsi[82];

    auto g_0_z_0_zzzzzz_1 = prim_buffer_1_spsi[83];

    /// Set up 0-28 components of targeted buffer : prim_buffer_0_sdsi
    ...
    /// Set up 28-56 components of targeted buffer : prim_buffer_0_sdsi

    auto g_0_xy_0_xxxxxx_0 = prim_buffer_0_sdsi[28];

    auto g_0_xy_0_xxxxxy_0 = prim_buffer_0_sdsi[29];

    auto g_0_xy_0_xxxxxz_0 = prim_buffer_0_sdsi[30];

    auto g_0_xy_0_xxxxyy_0 = prim_buffer_0_sdsi[31];

    auto g_0_xy_0_xxxxyz_0 = prim_buffer_0_sdsi[32];

    auto g_0_xy_0_xxxxzz_0 = prim_buffer_0_sdsi[33];

    auto g_0_xy_0_xxxyyy_0 = prim_buffer_0_sdsi[34];

    auto g_0_xy_0_xxxyyz_0 = prim_buffer_0_sdsi[35];

    auto g_0_xy_0_xxxyzz_0 = prim_buffer_0_sdsi[36];

    auto g_0_xy_0_xxxzzz_0 = prim_buffer_0_sdsi[37];

    auto g_0_xy_0_xxyyyy_0 = prim_buffer_0_sdsi[38];

    auto g_0_xy_0_xxyyyz_0 = prim_buffer_0_sdsi[39];

    auto g_0_xy_0_xxyyzz_0 = prim_buffer_0_sdsi[40];

    auto g_0_xy_0_xxyzzz_0 = prim_buffer_0_sdsi[41];

    auto g_0_xy_0_xxzzzz_0 = prim_buffer_0_sdsi[42];

    auto g_0_xy_0_xyyyyy_0 = prim_buffer_0_sdsi[43];

    auto g_0_xy_0_xyyyyz_0 = prim_buffer_0_sdsi[44];

    auto g_0_xy_0_xyyyzz_0 = prim_buffer_0_sdsi[45];

    auto g_0_xy_0_xyyzzz_0 = prim_buffer_0_sdsi[46];

    auto g_0_xy_0_xyzzzz_0 = prim_buffer_0_sdsi[47];

    auto g_0_xy_0_xzzzzz_0 = prim_buffer_0_sdsi[48];

    auto g_0_xy_0_yyyyyy_0 = prim_buffer_0_sdsi[49];

    auto g_0_xy_0_yyyyyz_0 = prim_buffer_0_sdsi[50];

    auto g_0_xy_0_yyyyzz_0 = prim_buffer_0_sdsi[51];

    auto g_0_xy_0_yyyzzz_0 = prim_buffer_0_sdsi[52];

    auto g_0_xy_0_yyzzzz_0 = prim_buffer_0_sdsi[53];

    auto g_0_xy_0_yzzzzz_0 = prim_buffer_0_sdsi[54];

    auto g_0_xy_0_zzzzzz_0 = prim_buffer_0_sdsi[55];
    ...
    /// Set up 56-84 components of targeted buffer : prim_buffer_0_sdsi

    auto g_0_xz_0_xxxxxx_0 = prim_buffer_0_sdsi[56];

    auto g_0_xz_0_xxxxxy_0 = prim_buffer_0_sdsi[57];

    auto g_0_xz_0_xxxxxz_0 = prim_buffer_0_sdsi[58];

    auto g_0_xz_0_xxxxyy_0 = prim_buffer_0_sdsi[59];

    auto g_0_xz_0_xxxxyz_0 = prim_buffer_0_sdsi[60];

    auto g_0_xz_0_xxxxzz_0 = prim_buffer_0_sdsi[61];

    auto g_0_xz_0_xxxyyy_0 = prim_buffer_0_sdsi[62];

    auto g_0_xz_0_xxxyyz_0 = prim_buffer_0_sdsi[63];

    auto g_0_xz_0_xxxyzz_0 = prim_buffer_0_sdsi[64];

    auto g_0_xz_0_xxxzzz_0 = prim_buffer_0_sdsi[65];

    auto g_0_xz_0_xxyyyy_0 = prim_buffer_0_sdsi[66];

    auto g_0_xz_0_xxyyyz_0 = prim_buffer_0_sdsi[67];

    auto g_0_xz_0_xxyyzz_0 = prim_buffer_0_sdsi[68];

    auto g_0_xz_0_xxyzzz_0 = prim_buffer_0_sdsi[69];

    auto g_0_xz_0_xxzzzz_0 = prim_buffer_0_sdsi[70];

    auto g_0_xz_0_xyyyyy_0 = prim_buffer_0_sdsi[71];

    auto g_0_xz_0_xyyyyz_0 = prim_buffer_0_sdsi[72];

    auto g_0_xz_0_xyyyzz_0 = prim_buffer_0_sdsi[73];

    auto g_0_xz_0_xyyzzz_0 = prim_buffer_0_sdsi[74];

    auto g_0_xz_0_xyzzzz_0 = prim_buffer_0_sdsi[75];

    auto g_0_xz_0_xzzzzz_0 = prim_buffer_0_sdsi[76];

    auto g_0_xz_0_yyyyyy_0 = prim_buffer_0_sdsi[77];

    auto g_0_xz_0_yyyyyz_0 = prim_buffer_0_sdsi[78];

    auto g_0_xz_0_yyyyzz_0 = prim_buffer_0_sdsi[79];

    auto g_0_xz_0_yyyzzz_0 = prim_buffer_0_sdsi[80];

    auto g_0_xz_0_yyzzzz_0 = prim_buffer_0_sdsi[81];

    auto g_0_xz_0_yzzzzz_0 = prim_buffer_0_sdsi[82];

    auto g_0_xz_0_zzzzzz_0 = prim_buffer_0_sdsi[83];
    ...
    /// Set up 84-112 components of targeted buffer : prim_buffer_0_sdsi
    ...
    /// Set up 112-140 components of targeted buffer : prim_buffer_0_sdsi

    auto g_0_yz_0_xxxxxx_0 = prim_buffer_0_sdsi[112];

    auto g_0_yz_0_xxxxxy_0 = prim_buffer_0_sdsi[113];

    auto g_0_yz_0_xxxxxz_0 = prim_buffer_0_sdsi[114];

    auto g_0_yz_0_xxxxyy_0 = prim_buffer_0_sdsi[115];

    auto g_0_yz_0_xxxxyz_0 = prim_buffer_0_sdsi[116];

    auto g_0_yz_0_xxxxzz_0 = prim_buffer_0_sdsi[117];

    auto g_0_yz_0_xxxyyy_0 = prim_buffer_0_sdsi[118];

    auto g_0_yz_0_xxxyyz_0 = prim_buffer_0_sdsi[119];

    auto g_0_yz_0_xxxyzz_0 = prim_buffer_0_sdsi[120];

    auto g_0_yz_0_xxxzzz_0 = prim_buffer_0_sdsi[121];

    auto g_0_yz_0_xxyyyy_0 = prim_buffer_0_sdsi[122];

    auto g_0_yz_0_xxyyyz_0 = prim_buffer_0_sdsi[123];

    auto g_0_yz_0_xxyyzz_0 = prim_buffer_0_sdsi[124];

    auto g_0_yz_0_xxyzzz_0 = prim_buffer_0_sdsi[125];

    auto g_0_yz_0_xxzzzz_0 = prim_buffer_0_sdsi[126];

    auto g_0_yz_0_xyyyyy_0 = prim_buffer_0_sdsi[127];

    auto g_0_yz_0_xyyyyz_0 = prim_buffer_0_sdsi[128];

    auto g_0_yz_0_xyyyzz_0 = prim_buffer_0_sdsi[129];

    auto g_0_yz_0_xyyzzz_0 = prim_buffer_0_sdsi[130];

    auto g_0_yz_0_xyzzzz_0 = prim_buffer_0_sdsi[131];

    auto g_0_yz_0_xzzzzz_0 = prim_buffer_0_sdsi[132];

    auto g_0_yz_0_yyyyyy_0 = prim_buffer_0_sdsi[133];

    auto g_0_yz_0_yyyyyz_0 = prim_buffer_0_sdsi[134];

    auto g_0_yz_0_yyyyzz_0 = prim_buffer_0_sdsi[135];

    auto g_0_yz_0_yyyzzz_0 = prim_buffer_0_sdsi[136];

    auto g_0_yz_0_yyzzzz_0 = prim_buffer_0_sdsi[137];

    auto g_0_yz_0_yzzzzz_0 = prim_buffer_0_sdsi[138];

    auto g_0_yz_0_zzzzzz_0 = prim_buffer_0_sdsi[139];
    ...
    /// Set up 140-168 components of targeted buffer : prim_buffer_0_sdsi
