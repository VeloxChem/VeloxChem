...
{
    const auto ndims = prim_buffer_0_sfsk.number_of_columns();
    ...
    auto g_0_yz_0_xxxxyz_1 = prim_buffer_1_sdsi[116];

    auto g_0_yz_0_xxxyyz_1 = prim_buffer_1_sdsi[119];

    auto g_0_yz_0_xxxyzz_1 = prim_buffer_1_sdsi[120];

    auto g_0_yz_0_xxyyyz_1 = prim_buffer_1_sdsi[123];

    auto g_0_yz_0_xxyyzz_1 = prim_buffer_1_sdsi[124];

    auto g_0_yz_0_xxyzzz_1 = prim_buffer_1_sdsi[125];

    auto g_0_yz_0_xyyyyz_1 = prim_buffer_1_sdsi[128];

    auto g_0_yz_0_xyyyzz_1 = prim_buffer_1_sdsi[129];

    auto g_0_yz_0_xyyzzz_1 = prim_buffer_1_sdsi[130];

    auto g_0_yz_0_xyzzzz_1 = prim_buffer_1_sdsi[131];

    auto g_0_yz_0_yyyyyz_1 = prim_buffer_1_sdsi[134];

    auto g_0_yz_0_yyyyzz_1 = prim_buffer_1_sdsi[135];

    auto g_0_yz_0_yyyzzz_1 = prim_buffer_1_sdsi[136];

    auto g_0_yz_0_yyzzzz_1 = prim_buffer_1_sdsi[137];

    auto g_0_yz_0_yzzzzz_1 = prim_buffer_1_sdsi[138];
    ...
    auto g_0_xy_0_xxxxxxy_1 = prim_buffer_1_sdsk[37];

    auto g_0_xy_0_xxxxxyy_1 = prim_buffer_1_sdsk[39];

    auto g_0_xy_0_xxxxyyy_1 = prim_buffer_1_sdsk[42];

    auto g_0_xy_0_xxxyyyy_1 = prim_buffer_1_sdsk[46];

    auto g_0_xy_0_xxyyyyy_1 = prim_buffer_1_sdsk[51];

    auto g_0_xy_0_xyyyyyy_1 = prim_buffer_1_sdsk[57];

    auto g_0_xz_0_xxxxxxx_1 = prim_buffer_1_sdsk[72];

    auto g_0_xz_0_xxxxxxz_1 = prim_buffer_1_sdsk[74];

    auto g_0_xz_0_xxxxxzz_1 = prim_buffer_1_sdsk[77];

    auto g_0_xz_0_xxxxzzz_1 = prim_buffer_1_sdsk[81];

    auto g_0_xz_0_xxxzzzz_1 = prim_buffer_1_sdsk[86];

    auto g_0_xz_0_xxzzzzz_1 = prim_buffer_1_sdsk[92];

    auto g_0_xz_0_xzzzzzz_1 = prim_buffer_1_sdsk[99];
    ...
    auto g_0_yz_0_yyyyyyy_1 = prim_buffer_1_sdsk[172];
    ...
    auto g_0_yz_0_zzzzzzz_1 = prim_buffer_1_sdsk[179];
    ...
    /// Set up 0-36 components of targeted buffer : prim_buffer_0_sfsk
    ...
    /// Set up 36-72 components of targeted buffer : prim_buffer_0_sfsk
    ...
    auto g_0_xxy_0_xxxxxyz_0 = prim_buffer_0_sfsk[40];

    auto g_0_xxy_0_xxxxxzz_0 = prim_buffer_0_sfsk[41];

    auto g_0_xxy_0_xxxxyyy_0 = prim_buffer_0_sfsk[42];

    auto g_0_xxy_0_xxxxyyz_0 = prim_buffer_0_sfsk[43];

    auto g_0_xxy_0_xxxxyzz_0 = prim_buffer_0_sfsk[44];

    auto g_0_xxy_0_xxxxzzz_0 = prim_buffer_0_sfsk[45];

    auto g_0_xxy_0_xxxyyyy_0 = prim_buffer_0_sfsk[46];

    auto g_0_xxy_0_xxxyyyz_0 = prim_buffer_0_sfsk[47];

    auto g_0_xxy_0_xxxyyzz_0 = prim_buffer_0_sfsk[48];

    auto g_0_xxy_0_xxxyzzz_0 = prim_buffer_0_sfsk[49];

    auto g_0_xxy_0_xxxzzzz_0 = prim_buffer_0_sfsk[50];

    auto g_0_xxy_0_xxyyyyy_0 = prim_buffer_0_sfsk[51];

    auto g_0_xxy_0_xxyyyyz_0 = prim_buffer_0_sfsk[52];

    auto g_0_xxy_0_xxyyyzz_0 = prim_buffer_0_sfsk[53];

    auto g_0_xxy_0_xxyyzzz_0 = prim_buffer_0_sfsk[54];

    auto g_0_xxy_0_xxyzzzz_0 = prim_buffer_0_sfsk[55];

    auto g_0_xxy_0_xxzzzzz_0 = prim_buffer_0_sfsk[56];

    auto g_0_xxy_0_xyyyyyy_0 = prim_buffer_0_sfsk[57];

    auto g_0_xxy_0_xyyyyyz_0 = prim_buffer_0_sfsk[58];

    auto g_0_xxy_0_xyyyyzz_0 = prim_buffer_0_sfsk[59];

    auto g_0_xxy_0_xyyyzzz_0 = prim_buffer_0_sfsk[60];

    auto g_0_xxy_0_xyyzzzz_0 = prim_buffer_0_sfsk[61];

    auto g_0_xxy_0_xyzzzzz_0 = prim_buffer_0_sfsk[62];

    auto g_0_xxy_0_xzzzzzz_0 = prim_buffer_0_sfsk[63];

    auto g_0_xxy_0_yyyyyyy_0 = prim_buffer_0_sfsk[64];

    auto g_0_xxy_0_yyyyyyz_0 = prim_buffer_0_sfsk[65];

    auto g_0_xxy_0_yyyyyzz_0 = prim_buffer_0_sfsk[66];

    auto g_0_xxy_0_yyyyzzz_0 = prim_buffer_0_sfsk[67];

    auto g_0_xxy_0_yyyzzzz_0 = prim_buffer_0_sfsk[68];

    auto g_0_xxy_0_yyzzzzz_0 = prim_buffer_0_sfsk[69];

    auto g_0_xxy_0_yzzzzzz_0 = prim_buffer_0_sfsk[70];

    auto g_0_xxy_0_zzzzzzz_0 = prim_buffer_0_sfsk[71];
    ...
    /// Set up 72-108 components of targeted buffer : prim_buffer_0_sfsk
    ...
    auto g_0_xxz_0_yyyyyyy_0 = prim_buffer_0_sfsk[100];
    ...
    auto g_0_xyy_0_xxxxzzz_0 = prim_buffer_0_sfsk[117];
    ...
    auto g_0_xyy_0_xxxzzzz_0 = prim_buffer_0_sfsk[122];
    ...
    auto g_0_xyy_0_xxzzzzz_0 = prim_buffer_0_sfsk[128];
    ...
    auto g_0_xyy_0_xzzzzzz_0 = prim_buffer_0_sfsk[135];
    ...
    /// Set up 144-180 components of targeted buffer : prim_buffer_0_sfsk

    auto g_0_xyz_0_xxxxxxx_0 = prim_buffer_0_sfsk[144];

    auto g_0_xyz_0_xxxxxxy_0 = prim_buffer_0_sfsk[145];

    auto g_0_xyz_0_xxxxxxz_0 = prim_buffer_0_sfsk[146];

    auto g_0_xyz_0_xxxxxyy_0 = prim_buffer_0_sfsk[147];

    auto g_0_xyz_0_xxxxxyz_0 = prim_buffer_0_sfsk[148];

    auto g_0_xyz_0_xxxxxzz_0 = prim_buffer_0_sfsk[149];

    auto g_0_xyz_0_xxxxyyy_0 = prim_buffer_0_sfsk[150];

    auto g_0_xyz_0_xxxxyyz_0 = prim_buffer_0_sfsk[151];

    auto g_0_xyz_0_xxxxyzz_0 = prim_buffer_0_sfsk[152];

    auto g_0_xyz_0_xxxxzzz_0 = prim_buffer_0_sfsk[153];

    auto g_0_xyz_0_xxxyyyy_0 = prim_buffer_0_sfsk[154];

    auto g_0_xyz_0_xxxyyyz_0 = prim_buffer_0_sfsk[155];

    auto g_0_xyz_0_xxxyyzz_0 = prim_buffer_0_sfsk[156];

    auto g_0_xyz_0_xxxyzzz_0 = prim_buffer_0_sfsk[157];

    auto g_0_xyz_0_xxxzzzz_0 = prim_buffer_0_sfsk[158];

    auto g_0_xyz_0_xxyyyyy_0 = prim_buffer_0_sfsk[159];

    auto g_0_xyz_0_xxyyyyz_0 = prim_buffer_0_sfsk[160];

    auto g_0_xyz_0_xxyyyzz_0 = prim_buffer_0_sfsk[161];

    auto g_0_xyz_0_xxyyzzz_0 = prim_buffer_0_sfsk[162];

    auto g_0_xyz_0_xxyzzzz_0 = prim_buffer_0_sfsk[163];

    auto g_0_xyz_0_xxzzzzz_0 = prim_buffer_0_sfsk[164];

    auto g_0_xyz_0_xyyyyyy_0 = prim_buffer_0_sfsk[165];

    auto g_0_xyz_0_xyyyyyz_0 = prim_buffer_0_sfsk[166];

    auto g_0_xyz_0_xyyyyzz_0 = prim_buffer_0_sfsk[167];

    auto g_0_xyz_0_xyyyzzz_0 = prim_buffer_0_sfsk[168];

    auto g_0_xyz_0_xyyzzzz_0 = prim_buffer_0_sfsk[169];

    auto g_0_xyz_0_xyzzzzz_0 = prim_buffer_0_sfsk[170];

    auto g_0_xyz_0_xzzzzzz_0 = prim_buffer_0_sfsk[171];

    auto g_0_xyz_0_yyyyyyy_0 = prim_buffer_0_sfsk[172];

    auto g_0_xyz_0_yyyyyyz_0 = prim_buffer_0_sfsk[173];

    auto g_0_xyz_0_yyyyyzz_0 = prim_buffer_0_sfsk[174];

    auto g_0_xyz_0_yyyyzzz_0 = prim_buffer_0_sfsk[175];

    auto g_0_xyz_0_yyyzzzz_0 = prim_buffer_0_sfsk[176];

    auto g_0_xyz_0_yyzzzzz_0 = prim_buffer_0_sfsk[177];

    auto g_0_xyz_0_yzzzzzz_0 = prim_buffer_0_sfsk[178];

    auto g_0_xyz_0_zzzzzzz_0 = prim_buffer_0_sfsk[179];
    ...
    /// Set up 180-216 components of targeted buffer : prim_buffer_0_sfsk

    auto g_0_xzz_0_xxxxxxx_0 = prim_buffer_0_sfsk[180];

    auto g_0_xzz_0_xxxxxxy_0 = prim_buffer_0_sfsk[181];

    auto g_0_xzz_0_xxxxxxz_0 = prim_buffer_0_sfsk[182];

    auto g_0_xzz_0_xxxxxyy_0 = prim_buffer_0_sfsk[183];

    auto g_0_xzz_0_xxxxxyz_0 = prim_buffer_0_sfsk[184];

    auto g_0_xzz_0_xxxxxzz_0 = prim_buffer_0_sfsk[185];

    auto g_0_xzz_0_xxxxyyy_0 = prim_buffer_0_sfsk[186];
    ...
    auto g_0_xzz_0_xxxyyyy_0 = prim_buffer_0_sfsk[190];
    ...
    auto g_0_xzz_0_xxyyyyy_0 = prim_buffer_0_sfsk[195];
    ...
    auto g_0_xzz_0_xyyyyyy_0 = prim_buffer_0_sfsk[201];
    ...
    /// Set up 216-252 components of targeted buffer : prim_buffer_0_sfsk
    ...
    /// Set up 252-288 components of targeted buffer : prim_buffer_0_sfsk

    auto g_0_yyz_0_xxxxxxx_0 = prim_buffer_0_sfsk[252];
    ...
    /// Set up 288-324 components of targeted buffer : prim_buffer_0_sfsk
    ...
    /// Set up 324-360 components of targeted buffer : prim_buffer_0_sfsk
