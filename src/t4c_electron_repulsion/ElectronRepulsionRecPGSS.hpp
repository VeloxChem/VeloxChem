#ifndef ElectronRepulsionRecPGSS_hpp
#define ElectronRepulsionRecPGSS_hpp
...
/// @brief Computes (PG|1/|r-r'||SS)  integrals for two basis function pairs blocks.
...
template <class T>
inline auto
comp_electron_repulsion_pgss(T&                               distributor,
                             ...
                             const bool                       bra_eq_ket) -> void
{
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            erirec::comp_bra_hrr_electron_repulsion_pgxx(skbuffer, 36, 0, 15, r_ab, 0, 0);

            t4cfunc::bra_transform<1, 4>(sbuffer, 0, skbuffer, 36, 0, 0);

            distributor.distribute(sbuffer, 0, a_indices, b_indices, c_indices, d_indices, 1, 4, 0, 0, j, ket_range, bra_eq_ket);
        }
    }
}
...
#endif /* ElectronRepulsionRecPGSS_hpp */
