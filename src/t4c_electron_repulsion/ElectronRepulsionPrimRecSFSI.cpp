...
{
    const auto ndims = prim_buffer_0_sfsi.number_of_columns();
    ...
    auto g_0_xy_0_xxxxxy_1 = prim_buffer_1_sdsi[29];

    auto g_0_xy_0_xxxxyy_1 = prim_buffer_1_sdsi[31];

    auto g_0_xy_0_xxxyyy_1 = prim_buffer_1_sdsi[34];

    auto g_0_xy_0_xxyyyy_1 = prim_buffer_1_sdsi[38];

    auto g_0_xy_0_xyyyyy_1 = prim_buffer_1_sdsi[43];

    auto g_0_xz_0_xxxxxx_1 = prim_buffer_1_sdsi[56];

    auto g_0_xz_0_xxxxxz_1 = prim_buffer_1_sdsi[58];

    auto g_0_xz_0_xxxxzz_1 = prim_buffer_1_sdsi[61];

    auto g_0_xz_0_xxxzzz_1 = prim_buffer_1_sdsi[65];

    auto g_0_xz_0_xxzzzz_1 = prim_buffer_1_sdsi[70];

    auto g_0_xz_0_xzzzzz_1 = prim_buffer_1_sdsi[76];
    ...
    auto g_0_yz_0_yyyyyy_1 = prim_buffer_1_sdsi[133];
    ...
    auto g_0_yz_0_zzzzzz_1 = prim_buffer_1_sdsi[139];
    ...
    /// Set up 0-28 components of targeted buffer : prim_buffer_0_sfsi
    ...
    /// Set up 28-56 components of targeted buffer : prim_buffer_0_sfsi
    ...
    auto g_0_xxy_0_xxxxyz_0 = prim_buffer_0_sfsi[32];

    auto g_0_xxy_0_xxxxzz_0 = prim_buffer_0_sfsi[33];

    auto g_0_xxy_0_xxxyyy_0 = prim_buffer_0_sfsi[34];

    auto g_0_xxy_0_xxxyyz_0 = prim_buffer_0_sfsi[35];

    auto g_0_xxy_0_xxxyzz_0 = prim_buffer_0_sfsi[36];

    auto g_0_xxy_0_xxxzzz_0 = prim_buffer_0_sfsi[37];

    auto g_0_xxy_0_xxyyyy_0 = prim_buffer_0_sfsi[38];

    auto g_0_xxy_0_xxyyyz_0 = prim_buffer_0_sfsi[39];

    auto g_0_xxy_0_xxyyzz_0 = prim_buffer_0_sfsi[40];

    auto g_0_xxy_0_xxyzzz_0 = prim_buffer_0_sfsi[41];

    auto g_0_xxy_0_xxzzzz_0 = prim_buffer_0_sfsi[42];

    auto g_0_xxy_0_xyyyyy_0 = prim_buffer_0_sfsi[43];

    auto g_0_xxy_0_xyyyyz_0 = prim_buffer_0_sfsi[44];

    auto g_0_xxy_0_xyyyzz_0 = prim_buffer_0_sfsi[45];

    auto g_0_xxy_0_xyyzzz_0 = prim_buffer_0_sfsi[46];

    auto g_0_xxy_0_xyzzzz_0 = prim_buffer_0_sfsi[47];

    auto g_0_xxy_0_xzzzzz_0 = prim_buffer_0_sfsi[48];

    auto g_0_xxy_0_yyyyyy_0 = prim_buffer_0_sfsi[49];

    auto g_0_xxy_0_yyyyyz_0 = prim_buffer_0_sfsi[50];

    auto g_0_xxy_0_yyyyzz_0 = prim_buffer_0_sfsi[51];

    auto g_0_xxy_0_yyyzzz_0 = prim_buffer_0_sfsi[52];

    auto g_0_xxy_0_yyzzzz_0 = prim_buffer_0_sfsi[53];

    auto g_0_xxy_0_yzzzzz_0 = prim_buffer_0_sfsi[54];

    auto g_0_xxy_0_zzzzzz_0 = prim_buffer_0_sfsi[55];
    ...
    /// Set up 56-84 components of targeted buffer : prim_buffer_0_sfsi
    ...
    auto g_0_xxz_0_yyyyyy_0 = prim_buffer_0_sfsi[77];
    ...
    auto g_0_xyy_0_xxxzzz_0 = prim_buffer_0_sfsi[93];
    ...
    auto g_0_xyy_0_xxzzzz_0 = prim_buffer_0_sfsi[98];
    ...
    auto g_0_xyy_0_xzzzzz_0 = prim_buffer_0_sfsi[104];
    ...
    /// Set up 112-140 components of targeted buffer : prim_buffer_0_sfsi

    auto g_0_xyz_0_xxxxxx_0 = prim_buffer_0_sfsi[112];

    auto g_0_xyz_0_xxxxxy_0 = prim_buffer_0_sfsi[113];

    auto g_0_xyz_0_xxxxxz_0 = prim_buffer_0_sfsi[114];

    auto g_0_xyz_0_xxxxyy_0 = prim_buffer_0_sfsi[115];

    auto g_0_xyz_0_xxxxyz_0 = prim_buffer_0_sfsi[116];

    auto g_0_xyz_0_xxxxzz_0 = prim_buffer_0_sfsi[117];

    auto g_0_xyz_0_xxxyyy_0 = prim_buffer_0_sfsi[118];

    auto g_0_xyz_0_xxxyyz_0 = prim_buffer_0_sfsi[119];

    auto g_0_xyz_0_xxxyzz_0 = prim_buffer_0_sfsi[120];

    auto g_0_xyz_0_xxxzzz_0 = prim_buffer_0_sfsi[121];

    auto g_0_xyz_0_xxyyyy_0 = prim_buffer_0_sfsi[122];

    auto g_0_xyz_0_xxyyyz_0 = prim_buffer_0_sfsi[123];

    auto g_0_xyz_0_xxyyzz_0 = prim_buffer_0_sfsi[124];

    auto g_0_xyz_0_xxyzzz_0 = prim_buffer_0_sfsi[125];

    auto g_0_xyz_0_xxzzzz_0 = prim_buffer_0_sfsi[126];

    auto g_0_xyz_0_xyyyyy_0 = prim_buffer_0_sfsi[127];

    auto g_0_xyz_0_xyyyyz_0 = prim_buffer_0_sfsi[128];

    auto g_0_xyz_0_xyyyzz_0 = prim_buffer_0_sfsi[129];

    auto g_0_xyz_0_xyyzzz_0 = prim_buffer_0_sfsi[130];

    auto g_0_xyz_0_xyzzzz_0 = prim_buffer_0_sfsi[131];

    auto g_0_xyz_0_xzzzzz_0 = prim_buffer_0_sfsi[132];

    auto g_0_xyz_0_yyyyyy_0 = prim_buffer_0_sfsi[133];

    auto g_0_xyz_0_yyyyyz_0 = prim_buffer_0_sfsi[134];

    auto g_0_xyz_0_yyyyzz_0 = prim_buffer_0_sfsi[135];

    auto g_0_xyz_0_yyyzzz_0 = prim_buffer_0_sfsi[136];

    auto g_0_xyz_0_yyzzzz_0 = prim_buffer_0_sfsi[137];

    auto g_0_xyz_0_yzzzzz_0 = prim_buffer_0_sfsi[138];

    auto g_0_xyz_0_zzzzzz_0 = prim_buffer_0_sfsi[139];
    ...
    /// Set up 140-168 components of targeted buffer : prim_buffer_0_sfsi

    auto g_0_xzz_0_xxxxxx_0 = prim_buffer_0_sfsi[140];

    auto g_0_xzz_0_xxxxxy_0 = prim_buffer_0_sfsi[141];

    auto g_0_xzz_0_xxxxxz_0 = prim_buffer_0_sfsi[142];

    auto g_0_xzz_0_xxxxyy_0 = prim_buffer_0_sfsi[143];

    auto g_0_xzz_0_xxxxyz_0 = prim_buffer_0_sfsi[144];

    auto g_0_xzz_0_xxxxzz_0 = prim_buffer_0_sfsi[145];

    auto g_0_xzz_0_xxxyyy_0 = prim_buffer_0_sfsi[146];
    ...
    auto g_0_xzz_0_xxyyyy_0 = prim_buffer_0_sfsi[150];
    ...
    auto g_0_xzz_0_xyyyyy_0 = prim_buffer_0_sfsi[155];
    ...
    /// Set up 168-196 components of targeted buffer : prim_buffer_0_sfsi
    ...
    /// Set up 196-224 components of targeted buffer : prim_buffer_0_sfsi

    auto g_0_yyz_0_xxxxxx_0 = prim_buffer_0_sfsi[196];
    ...
    /// Set up 224-252 components of targeted buffer : prim_buffer_0_sfsi
    ...
    /// Set up 252-280 components of targeted buffer : prim_buffer_0_sfsi
