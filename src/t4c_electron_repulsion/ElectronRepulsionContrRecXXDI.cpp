...
{
    const auto ndims = contr_buffer_xxdi.number_of_columns();
    ...
    for (int i = 0; i < acomps; i++)
    {
        ...
        {
            /// Set up components of auxilary buffer : contr_buffer_xxpi
            ...
            /// Set up components of auxilary buffer : contr_buffer_xxpk
            ...
            /// Set up 0-28 components of targeted buffer : contr_buffer_xxdi
            ...
            auto g_xx_yyyyyy = contr_buffer_xxdi[di_off + 21];

            auto g_xx_yyyyyz = contr_buffer_xxdi[di_off + 22];

            auto g_xx_yyyyzz = contr_buffer_xxdi[di_off + 23];

            auto g_xx_yyyzzz = contr_buffer_xxdi[di_off + 24];

            auto g_xx_yyzzzz = contr_buffer_xxdi[di_off + 25];

            auto g_xx_yzzzzz = contr_buffer_xxdi[di_off + 26];

            auto g_xx_zzzzzz = contr_buffer_xxdi[di_off + 27];
            ...
            /// Set up 28-56 components of targeted buffer : contr_buffer_xxdi
            ...
            auto g_xy_yyyyyy = contr_buffer_xxdi[di_off + 49];

            auto g_xy_yyyyyz = contr_buffer_xxdi[di_off + 50];

            auto g_xy_yyyyzz = contr_buffer_xxdi[di_off + 51];

            auto g_xy_yyyzzz = contr_buffer_xxdi[di_off + 52];

            auto g_xy_yyzzzz = contr_buffer_xxdi[di_off + 53];

            auto g_xy_yzzzzz = contr_buffer_xxdi[di_off + 54];

            auto g_xy_zzzzzz = contr_buffer_xxdi[di_off + 55];
            ...
            /// Set up 56-84 components of targeted buffer : contr_buffer_xxdi
            ...
            auto g_xz_yyyyyy = contr_buffer_xxdi[di_off + 77];

            auto g_xz_yyyyyz = contr_buffer_xxdi[di_off + 78];

            auto g_xz_yyyyzz = contr_buffer_xxdi[di_off + 79];

            auto g_xz_yyyzzz = contr_buffer_xxdi[di_off + 80];

            auto g_xz_yyzzzz = contr_buffer_xxdi[di_off + 81];

            auto g_xz_yzzzzz = contr_buffer_xxdi[di_off + 82];

            auto g_xz_zzzzzz = contr_buffer_xxdi[di_off + 83];
            ...
            /// Set up 84-112 components of targeted buffer : contr_buffer_xxdi
            ...
            auto g_yy_zzzzzz = contr_buffer_xxdi[di_off + 111];
            ...
            /// Set up 112-140 components of targeted buffer : contr_buffer_xxdi
            ...
            auto g_yz_zzzzzz = contr_buffer_xxdi[di_off + 139];
            ...
            /// Set up 140-168 components of targeted buffer : contr_buffer_xxdi
