...
/// Computes (FG|1/|r-r'||SP)  integrals for two GTOs pair blocks.
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> ket_spher_buffer_0_sgsp(45, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_shsp(63, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_sisp(84, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_sksp(108, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pgsp(135, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_phsp(189, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pisp(252, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dgsp(270, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dhsp(378, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fgsp(450, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_fgsp(189, ket_dim);

    // allocate accumulation buffer for integrals

    CSimdArray<double> buffer(bra_dim * 189, ket_dim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        ket_spher_buffer_0_sgsp.zero();

        ket_spher_buffer_0_shsp.zero();

        ket_spher_buffer_0_sisp.zero();

        ket_spher_buffer_0_sksp.zero();

        ket_spher_buffer_0_pgsp.zero();

        ket_spher_buffer_0_phsp.zero();

        ket_spher_buffer_0_pisp.zero();

        ket_spher_buffer_0_dgsp.zero();

        ket_spher_buffer_0_dhsp.zero();

        ket_spher_buffer_0_fgsp.zero();

        spher_buffer_0_fgsp.zero();
        ...
        t4cfunc::ket_transform<0, 1>(ket_spher_buffer_0_sgsp, cart_buffer_0_sgsp, 0, 4);

        t4cfunc::ket_transform<0, 1>(ket_spher_buffer_0_shsp, cart_buffer_0_shsp, 0, 5);

        t4cfunc::ket_transform<0, 1>(ket_spher_buffer_0_sisp, cart_buffer_0_sisp, 0, 6);

        t4cfunc::ket_transform<0, 1>(ket_spher_buffer_0_sksp, cart_buffer_0_sksp, 0, 7);

        erirec::comp_bra_hrr_electron_repulsion_pgxx(ket_spher_buffer_0_pgsp, ket_spher_buffer_0_sgsp, ket_spher_buffer_0_shsp, ab_x, ab_y, ab_z, 0, 1);

        erirec::comp_bra_hrr_electron_repulsion_phxx(ket_spher_buffer_0_phsp, ket_spher_buffer_0_shsp, ket_spher_buffer_0_sisp, ab_x, ab_y, ab_z, 0, 1);

        erirec::comp_bra_hrr_electron_repulsion_pixx(ket_spher_buffer_0_pisp, ket_spher_buffer_0_sisp, ket_spher_buffer_0_sksp, ab_x, ab_y, ab_z, 0, 1);

        erirec::comp_bra_hrr_electron_repulsion_dgxx(ket_spher_buffer_0_dgsp, ket_spher_buffer_0_pgsp, ket_spher_buffer_0_phsp, ab_x, ab_y, ab_z, 0, 1);

        erirec::comp_bra_hrr_electron_repulsion_dhxx(ket_spher_buffer_0_dhsp, ket_spher_buffer_0_phsp, ket_spher_buffer_0_pisp, ab_x, ab_y, ab_z, 0, 1);

        erirec::comp_bra_hrr_electron_repulsion_fgxx(ket_spher_buffer_0_fgsp, ket_spher_buffer_0_dgsp, ket_spher_buffer_0_dhsp, ab_x, ab_y, ab_z, 0, 1);

        t4cfunc::bra_transform<3, 4>(spher_buffer_0_fgsp, ket_spher_buffer_0_fgsp, 0, 1);

        t4cfunc::store_values(buffer, spher_buffer_0_fgsp, 189 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 3, 4, 0, 1, bra_indices, ket_indices);
}
