...
template <class T>
auto
comp_diag_electron_repulsion_dfdf(T* distributor,
                                  ...
                                  const std::array<int, 2>& gto_indices) -> void
{
    ...
    CSimdArray<double> ket_spher_buffer_0_sfdf(350, 1);

    CSimdArray<double> ket_spher_buffer_0_sgdf(525, 1);

    CSimdArray<double> ket_spher_buffer_0_shdf(735, 1);

    CSimdArray<double> ket_spher_buffer_0_pfdf(1050, 1);

    CSimdArray<double> ket_spher_buffer_0_pgdf(1575, 1);

    CSimdArray<double> ket_spher_buffer_0_dfdf(2100, 1);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_dfdf(1225, 1);
    ...
    CSimdArray<double> bf_values(11, npgtos);
    ...
    for (auto i = gto_indices[0]; i < gto_indices[1]; i++)
    {
        ...
        t4cfunc::update_max_values(max_values, spher_buffer_0_dfdf, i - gto_indices[0]); 
    }
