#ifndef ElectronRepulsionRecSFPG_hpp
#define ElectronRepulsionRecSFPG_hpp
...
/// @brief Computes (SF|1/|r-r'||PG)  integrals for two basis function pairs blocks.
...
template <class T>
inline auto
comp_electron_repulsion_sfpg(T&                               distributor,
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (int k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cfunc::reduce(cbuffer, 0, pbuffer, 1188, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 150, pbuffer, 1338, 210, ket_width, ket_npgtos);
            }
            ...
            t4cfunc::bra_transform<0, 3>(sbuffer, 0, skbuffer, 0, 1, 4);

            distributor.distribute(sbuffer, 0, a_indices, b_indices, c_indices, d_indices, 0, 3, 1, 4, j, ket_range, bra_eq_ket);
        }
    }
}
...
#endif /* ElectronRepulsionRecSFPG_hpp */
