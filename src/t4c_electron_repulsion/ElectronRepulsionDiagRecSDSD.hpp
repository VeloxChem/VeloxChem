...
/// Computes (SD|1/|r-r'||SD)  integrals for GTOs pair block.
                                  ...
                                  const std::array<int, 2>& gto_indices) -> void
{
    ...
    CSimdArray<double> ket_spher_buffer_0_sdsd(30, 1);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_sdsd(25, 1);
    ...
    for (auto i = gto_indices[0]; i < gto_indices[1]; i++)
    {
        ...
        t4cfunc::bra_transform<0, 2>(spher_buffer_0_sdsd, ket_spher_buffer_0_sdsd, 0, 2);

        t4cfunc::update_max_values(max_values, spher_buffer_0_sdsd, i - gto_indices[0]); 
    }
