...
#pragma omp simd aligned(g_0_0_0_xxxx_0,       \
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        g_0_0_0_xxxxxx_0[i] =
            5.0 * g_0_0_0_xxxx_0[i] * fi_cd_0 - 5.0 * g_0_0_0_xxxx_1[i] * fti_cd_0 + g_0_0_0_xxxxx_0[i] * qd_x[i] + g_0_0_0_xxxxx_1[i] * wq_x[i];
        ...
        g_0_0_0_xxxxyy_0[i] =
            3.0 * g_0_0_0_xxyy_0[i] * fi_cd_0 - 3.0 * g_0_0_0_xxyy_1[i] * fti_cd_0 + g_0_0_0_xxxyy_0[i] * qd_x[i] + g_0_0_0_xxxyy_1[i] * wq_x[i];

        g_0_0_0_xxxxyz_0[i] = g_0_0_0_xxxxz_0[i] * qd_y[i] + g_0_0_0_xxxxz_1[i] * wq_y[i];

        g_0_0_0_xxxxzz_0[i] =
            3.0 * g_0_0_0_xxzz_0[i] * fi_cd_0 - 3.0 * g_0_0_0_xxzz_1[i] * fti_cd_0 + g_0_0_0_xxxzz_0[i] * qd_x[i] + g_0_0_0_xxxzz_1[i] * wq_x[i];

        g_0_0_0_xxxyyy_0[i] =
            2.0 * g_0_0_0_xyyy_0[i] * fi_cd_0 - 2.0 * g_0_0_0_xyyy_1[i] * fti_cd_0 + g_0_0_0_xxyyy_0[i] * qd_x[i] + g_0_0_0_xxyyy_1[i] * wq_x[i];
        ...
        g_0_0_0_xxxzzz_0[i] =
            2.0 * g_0_0_0_xzzz_0[i] * fi_cd_0 - 2.0 * g_0_0_0_xzzz_1[i] * fti_cd_0 + g_0_0_0_xxzzz_0[i] * qd_x[i] + g_0_0_0_xxzzz_1[i] * wq_x[i];

        g_0_0_0_xxyyyy_0[i] =
            g_0_0_0_yyyy_0[i] * fi_cd_0 - g_0_0_0_yyyy_1[i] * fti_cd_0 + g_0_0_0_xyyyy_0[i] * qd_x[i] + g_0_0_0_xyyyy_1[i] * wq_x[i];

        g_0_0_0_xxyyyz_0[i] = g_0_0_0_xxyyy_0[i] * qd_z[i] + g_0_0_0_xxyyy_1[i] * wq_z[i];

        g_0_0_0_xxyyzz_0[i] =
            g_0_0_0_yyzz_0[i] * fi_cd_0 - g_0_0_0_yyzz_1[i] * fti_cd_0 + g_0_0_0_xyyzz_0[i] * qd_x[i] + g_0_0_0_xyyzz_1[i] * wq_x[i];

        g_0_0_0_xxyzzz_0[i] = g_0_0_0_xxzzz_0[i] * qd_y[i] + g_0_0_0_xxzzz_1[i] * wq_y[i];

        g_0_0_0_xxzzzz_0[i] =
            g_0_0_0_zzzz_0[i] * fi_cd_0 - g_0_0_0_zzzz_1[i] * fti_cd_0 + g_0_0_0_xzzzz_0[i] * qd_x[i] + g_0_0_0_xzzzz_1[i] * wq_x[i];
        ...
        g_0_0_0_yyyyyy_0[i] =
            5.0 * g_0_0_0_yyyy_0[i] * fi_cd_0 - 5.0 * g_0_0_0_yyyy_1[i] * fti_cd_0 + g_0_0_0_yyyyy_0[i] * qd_y[i] + g_0_0_0_yyyyy_1[i] * wq_y[i];

        g_0_0_0_yyyyyz_0[i] = g_0_0_0_yyyyy_0[i] * qd_z[i] + g_0_0_0_yyyyy_1[i] * wq_z[i];

        g_0_0_0_yyyyzz_0[i] =
            3.0 * g_0_0_0_yyzz_0[i] * fi_cd_0 - 3.0 * g_0_0_0_yyzz_1[i] * fti_cd_0 + g_0_0_0_yyyzz_0[i] * qd_y[i] + g_0_0_0_yyyzz_1[i] * wq_y[i];

        g_0_0_0_yyyzzz_0[i] =
            2.0 * g_0_0_0_yzzz_0[i] * fi_cd_0 - 2.0 * g_0_0_0_yzzz_1[i] * fti_cd_0 + g_0_0_0_yyzzz_0[i] * qd_y[i] + g_0_0_0_yyzzz_1[i] * wq_y[i];

        g_0_0_0_yyzzzz_0[i] =
            g_0_0_0_zzzz_0[i] * fi_cd_0 - g_0_0_0_zzzz_1[i] * fti_cd_0 + g_0_0_0_yzzzz_0[i] * qd_y[i] + g_0_0_0_yzzzz_1[i] * wq_y[i];

        g_0_0_0_yzzzzz_0[i] = g_0_0_0_zzzzz_0[i] * qd_y[i] + g_0_0_0_zzzzz_1[i] * wq_y[i];

        g_0_0_0_zzzzzz_0[i] =
            5.0 * g_0_0_0_zzzz_0[i] * fi_cd_0 - 5.0 * g_0_0_0_zzzz_1[i] * fti_cd_0 + g_0_0_0_zzzzz_0[i] * qd_z[i] + g_0_0_0_zzzzz_1[i] * wq_z[i];
    }
}
