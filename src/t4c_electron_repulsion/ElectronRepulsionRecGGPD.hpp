...
/// Computes (GG|1/|r-r'||PD)  integrals for two GTOs pair blocks.
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> ket_spher_buffer_0_slpd(675, ket_dim);
    ...
    CSimdArray<double> ket_spher_buffer_0_pkpd(1620, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dgpd(1350, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dhpd(1890, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dipd(2520, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fgpd(2250, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fhpd(3150, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_ggpd(3375, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_ggpd(1215, ket_dim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        ket_spher_buffer_0_pkpd.zero();

        ket_spher_buffer_0_dgpd.zero();

        ket_spher_buffer_0_dhpd.zero();

        ket_spher_buffer_0_dipd.zero();

        ket_spher_buffer_0_fgpd.zero();

        ket_spher_buffer_0_fhpd.zero();

        ket_spher_buffer_0_ggpd.zero();

        spher_buffer_0_ggpd.zero();
        ...
        t4cfunc::ket_transform<1, 2>(ket_spher_buffer_0_slpd, contr_buffer_0_slpd, 0, 8);
        ...
        erirec::comp_bra_hrr_electron_repulsion_pkxx(ket_spher_buffer_0_pkpd, ket_spher_buffer_0_skpd, ket_spher_buffer_0_slpd, ab_x, ab_y, ab_z, 1, 2);
        ...
        erirec::comp_bra_hrr_electron_repulsion_dixx(ket_spher_buffer_0_dipd, ket_spher_buffer_0_pipd, ket_spher_buffer_0_pkpd, ab_x, ab_y, ab_z, 1, 2);
        ...
        erirec::comp_bra_hrr_electron_repulsion_fhxx(ket_spher_buffer_0_fhpd, ket_spher_buffer_0_dhpd, ket_spher_buffer_0_dipd, ab_x, ab_y, ab_z, 1, 2);

        erirec::comp_bra_hrr_electron_repulsion_ggxx(ket_spher_buffer_0_ggpd, ket_spher_buffer_0_fgpd, ket_spher_buffer_0_fhpd, ab_x, ab_y, ab_z, 1, 2);

        t4cfunc::bra_transform<4, 4>(spher_buffer_0_ggpd, ket_spher_buffer_0_ggpd, 1, 2);

        t4cfunc::store_values(buffer, spher_buffer_0_ggpd, 1215 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 4, 4, 1, 2, bra_indices, ket_indices);
}
