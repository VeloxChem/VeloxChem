...
/// Computes (DD|1/|r-r'||SG)  integrals for two GTOs pair blocks.
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> ket_spher_buffer_0_ddsg(324, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_ddsg(225, ket_dim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        ket_spher_buffer_0_ddsg.zero();

        spher_buffer_0_ddsg.zero();
        ...
        erirec::comp_bra_hrr_electron_repulsion_ddxx(ket_spher_buffer_0_ddsg, ket_spher_buffer_0_pdsg, ket_spher_buffer_0_pfsg, ab_x, ab_y, ab_z, 0, 4);

        t4cfunc::bra_transform<2, 2>(spher_buffer_0_ddsg, ket_spher_buffer_0_ddsg, 0, 4);

        t4cfunc::store_values(buffer, spher_buffer_0_ddsg, 225 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 2, 2, 0, 4, bra_indices, ket_indices);
}
