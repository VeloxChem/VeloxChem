...
/// Computes (FG|1/|r-r'||FF)  integrals for two GTOs pair blocks.
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> contr_buffer_0_siff(2800, ket_dim);
    ...
    CSimdArray<double> contr_buffer_0_skff(3600, ket_dim);
    ...
    CSimdArray<double> ket_spher_buffer_0_siff(1372, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_skff(1764, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pgff(2205, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_phff(3087, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_piff(4116, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dgff(4410, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dhff(6174, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fgff(7350, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_fgff(3087, ket_dim);

    // allocate accumulation buffer for integrals

    CSimdArray<double> buffer(bra_dim * 3087, ket_dim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        ket_spher_buffer_0_skff.zero();

        ket_spher_buffer_0_pgff.zero();

        ket_spher_buffer_0_phff.zero();

        ket_spher_buffer_0_piff.zero();

        ket_spher_buffer_0_dgff.zero();

        ket_spher_buffer_0_dhff.zero();

        ket_spher_buffer_0_fgff.zero();

        spher_buffer_0_fgff.zero();
        ...
        erirec::comp_ket_hrr_electron_repulsion_xxff(contr_buffer_0_skff, contr_buffer_0_skdf, contr_buffer_0_skdg, cd_x[0], cd_y[0], cd_z[0], 0, 7);
        ...
        t4cfunc::ket_transform<3, 3>(ket_spher_buffer_0_skff, contr_buffer_0_skff, 0, 7);
        ...
        erirec::comp_bra_hrr_electron_repulsion_pixx(ket_spher_buffer_0_piff, ket_spher_buffer_0_siff, ket_spher_buffer_0_skff, ab_x, ab_y, ab_z, 3, 3);
        ...
        erirec::comp_bra_hrr_electron_repulsion_dhxx(ket_spher_buffer_0_dhff, ket_spher_buffer_0_phff, ket_spher_buffer_0_piff, ab_x, ab_y, ab_z, 3, 3);

        erirec::comp_bra_hrr_electron_repulsion_fgxx(ket_spher_buffer_0_fgff, ket_spher_buffer_0_dgff, ket_spher_buffer_0_dhff, ab_x, ab_y, ab_z, 3, 3);

        t4cfunc::bra_transform<3, 4>(spher_buffer_0_fgff, ket_spher_buffer_0_fgff, 3, 3);

        t4cfunc::store_values(buffer, spher_buffer_0_fgff, 3087 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 3, 4, 3, 3, bra_indices, ket_indices);
}
