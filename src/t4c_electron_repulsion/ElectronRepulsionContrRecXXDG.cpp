...
{
    const auto ndims = contr_buffer_xxdg.number_of_columns();
    ...
    for (int i = 0; i < acomps; i++)
    {
        for (int j = 0; j < bcomps; j++)
        {
            ...
            /// Set up 0-15 components of targeted buffer : contr_buffer_xxdg
            ...
            /// Set up 15-30 components of targeted buffer : contr_buffer_xxdg
            ...
            /// Set up 30-45 components of targeted buffer : contr_buffer_xxdg
            ...
            /// Set up 45-60 components of targeted buffer : contr_buffer_xxdg
            ...
            /// Set up 60-75 components of targeted buffer : contr_buffer_xxdg
            ...
            /// Set up 75-90 components of targeted buffer : contr_buffer_xxdg
