#ifndef ElectronRepulsionPrimRecSPSP_hpp
#define ElectronRepulsionPrimRecSPSP_hpp
...
/// Computes [SP|1/|r-r'||SP]  integrals for set of data buffers.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_eri_0_spsp The index of integral in primitive integrals buffer.
...
auto comp_prim_electron_repulsion_spsp(CSimdArray<double>&   pbuffer,
...
#endif /* ElectronRepulsionPrimRecSPSP_hpp */
