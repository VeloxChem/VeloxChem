#ifndef ElectronRepulsionRecPDSD_hpp
#define ElectronRepulsionRecPDSD_hpp
...
/// @brief Computes (PD|1/|r-r'||SD)  integrals for two basis function pairs blocks.
...
template <class T>
inline auto
comp_electron_repulsion_pdsd(T& distributor,
                             ...
                             const bool bra_eq_ket) -> void
{
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            t4cfunc::bra_transform<1, 2>(sbuffer, 0, skbuffer, 80, 0, 2);

            distributor.distribute(sbuffer, 0, a_indices, b_indices, c_indices, d_indices, 1, 2, 0, 2, j, ket_range, bra_eq_ket);
        }
    }
...
#endif /* ElectronRepulsionRecPDSD_hpp */
