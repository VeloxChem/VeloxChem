...
/// Computes (FF|1/|r-r'||SS)  integrals for two GTOs pair blocks.
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> ket_spher_buffer_0_dfss(60, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dgss(90, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_ffss(100, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_ffss(49, ket_dim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        ket_spher_buffer_0_dfss.zero();

        ket_spher_buffer_0_dgss.zero();

        ket_spher_buffer_0_ffss.zero();

        spher_buffer_0_ffss.zero();
        ...
        erirec::comp_bra_hrr_electron_repulsion_dfxx(ket_spher_buffer_0_dfss, ket_spher_buffer_0_pfss, ket_spher_buffer_0_pgss, ab_x, ab_y, ab_z, 0, 0);
        ...
        erirec::comp_bra_hrr_electron_repulsion_ffxx(ket_spher_buffer_0_ffss, ket_spher_buffer_0_dfss, ket_spher_buffer_0_dgss, ab_x, ab_y, ab_z, 0, 0);

        t4cfunc::bra_transform<3, 3>(spher_buffer_0_ffss, ket_spher_buffer_0_ffss, 0, 0);

        t4cfunc::store_values(buffer, spher_buffer_0_ffss, 49 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 3, 3, 0, 0, bra_indices, ket_indices);
}
