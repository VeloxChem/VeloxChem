#ifndef ElectronRepulsionRecSDPD_hpp
#define ElectronRepulsionRecSDPD_hpp
...
/// @brief Computes (SD|1/|r-r'||PD)  integrals for two basis function pairs blocks.
...
template <class T>
inline auto
comp_electron_repulsion_sdpd(T&                               distributor,
                             ...
                             const bool                       bra_eq_ket) -> void
{
    ...
    CSimdArray<double> ckbuffer(108, 1);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (int k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cfunc::reduce(cbuffer, 0, pbuffer, 180, 36, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 36, pbuffer, 216, 60, ket_width, ket_npgtos);
            }
            ...
            distributor.distribute(sbuffer, 0, a_indices, b_indices, c_indices, d_indices, 0, 2, 1, 2, j, ket_range, bra_eq_ket);
        }
    }
}
...
#endif /* ElectronRepulsionRecSDPD_hpp */
