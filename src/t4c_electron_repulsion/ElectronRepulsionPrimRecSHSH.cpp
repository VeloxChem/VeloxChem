...
{
    const auto ndims = prim_buffer_0_shsh.number_of_columns();
    ...
    auto g_0_xxxy_0_xxxxy_1 = prim_buffer_1_sgsh[22];

    auto g_0_xxxy_0_xxxxz_1 = prim_buffer_1_sgsh[23];

    auto g_0_xxxy_0_xxxyy_1 = prim_buffer_1_sgsh[24];

    auto g_0_xxxy_0_xxxzz_1 = prim_buffer_1_sgsh[26];

    auto g_0_xxxy_0_xxyyy_1 = prim_buffer_1_sgsh[27];

    auto g_0_xxxy_0_xxzzz_1 = prim_buffer_1_sgsh[30];

    auto g_0_xxxy_0_xyyyy_1 = prim_buffer_1_sgsh[31];

    auto g_0_xxxy_0_xzzzz_1 = prim_buffer_1_sgsh[35];

    auto g_0_xxxy_0_yyyyy_1 = prim_buffer_1_sgsh[36];
    ...
    auto g_0_xyyy_0_xxxxx_1 = prim_buffer_1_sgsh[126];
    ...
    auto g_0_xzzz_0_xxxxx_1 = prim_buffer_1_sgsh[189];
    ...
    /// Set up 0-21 components of targeted buffer : prim_buffer_0_shsh
    ...
    /// Set up 21-42 components of targeted buffer : prim_buffer_0_shsh
    ...
    auto g_0_xxxxy_0_xxxyz_0 = prim_buffer_0_shsh[25];

    auto g_0_xxxxy_0_xxxzz_0 = prim_buffer_0_shsh[26];

    auto g_0_xxxxy_0_xxyyy_0 = prim_buffer_0_shsh[27];

    auto g_0_xxxxy_0_xxyyz_0 = prim_buffer_0_shsh[28];

    auto g_0_xxxxy_0_xxyzz_0 = prim_buffer_0_shsh[29];

    auto g_0_xxxxy_0_xxzzz_0 = prim_buffer_0_shsh[30];

    auto g_0_xxxxy_0_xyyyy_0 = prim_buffer_0_shsh[31];

    auto g_0_xxxxy_0_xyyyz_0 = prim_buffer_0_shsh[32];

    auto g_0_xxxxy_0_xyyzz_0 = prim_buffer_0_shsh[33];

    auto g_0_xxxxy_0_xyzzz_0 = prim_buffer_0_shsh[34];

    auto g_0_xxxxy_0_xzzzz_0 = prim_buffer_0_shsh[35];

    auto g_0_xxxxy_0_yyyyy_0 = prim_buffer_0_shsh[36];

    auto g_0_xxxxy_0_yyyyz_0 = prim_buffer_0_shsh[37];

    auto g_0_xxxxy_0_yyyzz_0 = prim_buffer_0_shsh[38];

    auto g_0_xxxxy_0_yyzzz_0 = prim_buffer_0_shsh[39];

    auto g_0_xxxxy_0_yzzzz_0 = prim_buffer_0_shsh[40];

    auto g_0_xxxxy_0_zzzzz_0 = prim_buffer_0_shsh[41];
    ...
    /// Set up 42-63 components of targeted buffer : prim_buffer_0_shsh
    ...
    auto g_0_xxxxz_0_yyyyy_0 = prim_buffer_0_shsh[57];
    ...
    /// Set up 63-84 components of targeted buffer : prim_buffer_0_shsh
    ...
    /// Set up 84-105 components of targeted buffer : prim_buffer_0_shsh

    auto g_0_xxxyz_0_xxxxx_0 = prim_buffer_0_shsh[84];

    auto g_0_xxxyz_0_xxxxy_0 = prim_buffer_0_shsh[85];

    auto g_0_xxxyz_0_xxxxz_0 = prim_buffer_0_shsh[86];

    auto g_0_xxxyz_0_xxxyy_0 = prim_buffer_0_shsh[87];

    auto g_0_xxxyz_0_xxxyz_0 = prim_buffer_0_shsh[88];

    auto g_0_xxxyz_0_xxxzz_0 = prim_buffer_0_shsh[89];

    auto g_0_xxxyz_0_xxyyy_0 = prim_buffer_0_shsh[90];

    auto g_0_xxxyz_0_xxyyz_0 = prim_buffer_0_shsh[91];

    auto g_0_xxxyz_0_xxyzz_0 = prim_buffer_0_shsh[92];

    auto g_0_xxxyz_0_xxzzz_0 = prim_buffer_0_shsh[93];

    auto g_0_xxxyz_0_xyyyy_0 = prim_buffer_0_shsh[94];

    auto g_0_xxxyz_0_xyyyz_0 = prim_buffer_0_shsh[95];

    auto g_0_xxxyz_0_xyyzz_0 = prim_buffer_0_shsh[96];

    auto g_0_xxxyz_0_xyzzz_0 = prim_buffer_0_shsh[97];

    auto g_0_xxxyz_0_xzzzz_0 = prim_buffer_0_shsh[98];

    auto g_0_xxxyz_0_yyyyy_0 = prim_buffer_0_shsh[99];

    auto g_0_xxxyz_0_yyyyz_0 = prim_buffer_0_shsh[100];

    auto g_0_xxxyz_0_yyyzz_0 = prim_buffer_0_shsh[101];

    auto g_0_xxxyz_0_yyzzz_0 = prim_buffer_0_shsh[102];

    auto g_0_xxxyz_0_yzzzz_0 = prim_buffer_0_shsh[103];

    auto g_0_xxxyz_0_zzzzz_0 = prim_buffer_0_shsh[104];
    ...
    /// Set up 105-126 components of targeted buffer : prim_buffer_0_shsh
    ...
    /// Set up 126-147 components of targeted buffer : prim_buffer_0_shsh
    ...
    /// Set up 147-168 components of targeted buffer : prim_buffer_0_shsh

    auto g_0_xxyyz_0_xxxxx_0 = prim_buffer_0_shsh[147];

    auto g_0_xxyyz_0_xxxxy_0 = prim_buffer_0_shsh[148];

    auto g_0_xxyyz_0_xxxxz_0 = prim_buffer_0_shsh[149];

    auto g_0_xxyyz_0_xxxyy_0 = prim_buffer_0_shsh[150];

    auto g_0_xxyyz_0_xxxyz_0 = prim_buffer_0_shsh[151];

    auto g_0_xxyyz_0_xxxzz_0 = prim_buffer_0_shsh[152];

    auto g_0_xxyyz_0_xxyyy_0 = prim_buffer_0_shsh[153];

    auto g_0_xxyyz_0_xxyyz_0 = prim_buffer_0_shsh[154];

    auto g_0_xxyyz_0_xxyzz_0 = prim_buffer_0_shsh[155];

    auto g_0_xxyyz_0_xxzzz_0 = prim_buffer_0_shsh[156];

    auto g_0_xxyyz_0_xyyyy_0 = prim_buffer_0_shsh[157];

    auto g_0_xxyyz_0_xyyyz_0 = prim_buffer_0_shsh[158];

    auto g_0_xxyyz_0_xyyzz_0 = prim_buffer_0_shsh[159];

    auto g_0_xxyyz_0_xyzzz_0 = prim_buffer_0_shsh[160];

    auto g_0_xxyyz_0_xzzzz_0 = prim_buffer_0_shsh[161];

    auto g_0_xxyyz_0_yyyyy_0 = prim_buffer_0_shsh[162];

    auto g_0_xxyyz_0_yyyyz_0 = prim_buffer_0_shsh[163];

    auto g_0_xxyyz_0_yyyzz_0 = prim_buffer_0_shsh[164];

    auto g_0_xxyyz_0_yyzzz_0 = prim_buffer_0_shsh[165];

    auto g_0_xxyyz_0_yzzzz_0 = prim_buffer_0_shsh[166];

    auto g_0_xxyyz_0_zzzzz_0 = prim_buffer_0_shsh[167];
    ...
    /// Set up 168-189 components of targeted buffer : prim_buffer_0_shsh

    auto g_0_xxyzz_0_xxxxx_0 = prim_buffer_0_shsh[168];

    auto g_0_xxyzz_0_xxxxy_0 = prim_buffer_0_shsh[169];

    auto g_0_xxyzz_0_xxxxz_0 = prim_buffer_0_shsh[170];

    auto g_0_xxyzz_0_xxxyy_0 = prim_buffer_0_shsh[171];

    auto g_0_xxyzz_0_xxxyz_0 = prim_buffer_0_shsh[172];

    auto g_0_xxyzz_0_xxxzz_0 = prim_buffer_0_shsh[173];

    auto g_0_xxyzz_0_xxyyy_0 = prim_buffer_0_shsh[174];

    auto g_0_xxyzz_0_xxyyz_0 = prim_buffer_0_shsh[175];

    auto g_0_xxyzz_0_xxyzz_0 = prim_buffer_0_shsh[176];

    auto g_0_xxyzz_0_xxzzz_0 = prim_buffer_0_shsh[177];

    auto g_0_xxyzz_0_xyyyy_0 = prim_buffer_0_shsh[178];

    auto g_0_xxyzz_0_xyyyz_0 = prim_buffer_0_shsh[179];

    auto g_0_xxyzz_0_xyyzz_0 = prim_buffer_0_shsh[180];

    auto g_0_xxyzz_0_xyzzz_0 = prim_buffer_0_shsh[181];

    auto g_0_xxyzz_0_xzzzz_0 = prim_buffer_0_shsh[182];

    auto g_0_xxyzz_0_yyyyy_0 = prim_buffer_0_shsh[183];

    auto g_0_xxyzz_0_yyyyz_0 = prim_buffer_0_shsh[184];

    auto g_0_xxyzz_0_yyyzz_0 = prim_buffer_0_shsh[185];

    auto g_0_xxyzz_0_yyzzz_0 = prim_buffer_0_shsh[186];

    auto g_0_xxyzz_0_yzzzz_0 = prim_buffer_0_shsh[187];

    auto g_0_xxyzz_0_zzzzz_0 = prim_buffer_0_shsh[188];
    ...
    /// Set up 189-210 components of targeted buffer : prim_buffer_0_shsh
    ...
    auto g_0_xyyyy_0_xxzzz_0 = prim_buffer_0_shsh[219];
    ...
    auto g_0_xyyyy_0_xzzzz_0 = prim_buffer_0_shsh[224];
    ...
    /// Set up 231-252 components of targeted buffer : prim_buffer_0_shsh

    auto g_0_xyyyz_0_xxxxx_0 = prim_buffer_0_shsh[231];

    auto g_0_xyyyz_0_xxxxy_0 = prim_buffer_0_shsh[232];

    auto g_0_xyyyz_0_xxxxz_0 = prim_buffer_0_shsh[233];

    auto g_0_xyyyz_0_xxxyy_0 = prim_buffer_0_shsh[234];

    auto g_0_xyyyz_0_xxxyz_0 = prim_buffer_0_shsh[235];

    auto g_0_xyyyz_0_xxxzz_0 = prim_buffer_0_shsh[236];

    auto g_0_xyyyz_0_xxyyy_0 = prim_buffer_0_shsh[237];

    auto g_0_xyyyz_0_xxyyz_0 = prim_buffer_0_shsh[238];

    auto g_0_xyyyz_0_xxyzz_0 = prim_buffer_0_shsh[239];

    auto g_0_xyyyz_0_xxzzz_0 = prim_buffer_0_shsh[240];

    auto g_0_xyyyz_0_xyyyy_0 = prim_buffer_0_shsh[241];

    auto g_0_xyyyz_0_xyyyz_0 = prim_buffer_0_shsh[242];

    auto g_0_xyyyz_0_xyyzz_0 = prim_buffer_0_shsh[243];

    auto g_0_xyyyz_0_xyzzz_0 = prim_buffer_0_shsh[244];

    auto g_0_xyyyz_0_xzzzz_0 = prim_buffer_0_shsh[245];

    auto g_0_xyyyz_0_yyyyy_0 = prim_buffer_0_shsh[246];

    auto g_0_xyyyz_0_yyyyz_0 = prim_buffer_0_shsh[247];

    auto g_0_xyyyz_0_yyyzz_0 = prim_buffer_0_shsh[248];

    auto g_0_xyyyz_0_yyzzz_0 = prim_buffer_0_shsh[249];

    auto g_0_xyyyz_0_yzzzz_0 = prim_buffer_0_shsh[250];

    auto g_0_xyyyz_0_zzzzz_0 = prim_buffer_0_shsh[251];
    ...
    /// Set up 252-273 components of targeted buffer : prim_buffer_0_shsh

    auto g_0_xyyzz_0_xxxxx_0 = prim_buffer_0_shsh[252];

    auto g_0_xyyzz_0_xxxxy_0 = prim_buffer_0_shsh[253];

    auto g_0_xyyzz_0_xxxxz_0 = prim_buffer_0_shsh[254];

    auto g_0_xyyzz_0_xxxyy_0 = prim_buffer_0_shsh[255];

    auto g_0_xyyzz_0_xxxyz_0 = prim_buffer_0_shsh[256];

    auto g_0_xyyzz_0_xxxzz_0 = prim_buffer_0_shsh[257];

    auto g_0_xyyzz_0_xxyyy_0 = prim_buffer_0_shsh[258];

    auto g_0_xyyzz_0_xxyyz_0 = prim_buffer_0_shsh[259];

    auto g_0_xyyzz_0_xxyzz_0 = prim_buffer_0_shsh[260];

    auto g_0_xyyzz_0_xxzzz_0 = prim_buffer_0_shsh[261];

    auto g_0_xyyzz_0_xyyyy_0 = prim_buffer_0_shsh[262];
    ...
    auto g_0_xyyzz_0_xzzzz_0 = prim_buffer_0_shsh[266];
    ...
    /// Set up 273-294 components of targeted buffer : prim_buffer_0_shsh

    auto g_0_xyzzz_0_xxxxx_0 = prim_buffer_0_shsh[273];

    auto g_0_xyzzz_0_xxxxy_0 = prim_buffer_0_shsh[274];

    auto g_0_xyzzz_0_xxxxz_0 = prim_buffer_0_shsh[275];

    auto g_0_xyzzz_0_xxxyy_0 = prim_buffer_0_shsh[276];

    auto g_0_xyzzz_0_xxxyz_0 = prim_buffer_0_shsh[277];

    auto g_0_xyzzz_0_xxxzz_0 = prim_buffer_0_shsh[278];

    auto g_0_xyzzz_0_xxyyy_0 = prim_buffer_0_shsh[279];

    auto g_0_xyzzz_0_xxyyz_0 = prim_buffer_0_shsh[280];

    auto g_0_xyzzz_0_xxyzz_0 = prim_buffer_0_shsh[281];

    auto g_0_xyzzz_0_xxzzz_0 = prim_buffer_0_shsh[282];

    auto g_0_xyzzz_0_xyyyy_0 = prim_buffer_0_shsh[283];

    auto g_0_xyzzz_0_xyyyz_0 = prim_buffer_0_shsh[284];

    auto g_0_xyzzz_0_xyyzz_0 = prim_buffer_0_shsh[285];

    auto g_0_xyzzz_0_xyzzz_0 = prim_buffer_0_shsh[286];

    auto g_0_xyzzz_0_xzzzz_0 = prim_buffer_0_shsh[287];

    auto g_0_xyzzz_0_yyyyy_0 = prim_buffer_0_shsh[288];

    auto g_0_xyzzz_0_yyyyz_0 = prim_buffer_0_shsh[289];

    auto g_0_xyzzz_0_yyyzz_0 = prim_buffer_0_shsh[290];

    auto g_0_xyzzz_0_yyzzz_0 = prim_buffer_0_shsh[291];

    auto g_0_xyzzz_0_yzzzz_0 = prim_buffer_0_shsh[292];

    auto g_0_xyzzz_0_zzzzz_0 = prim_buffer_0_shsh[293];
    ...
    /// Set up 294-315 components of targeted buffer : prim_buffer_0_shsh

    auto g_0_xzzzz_0_xxxxx_0 = prim_buffer_0_shsh[294];

    auto g_0_xzzzz_0_xxxxy_0 = prim_buffer_0_shsh[295];

    auto g_0_xzzzz_0_xxxxz_0 = prim_buffer_0_shsh[296];

    auto g_0_xzzzz_0_xxxyy_0 = prim_buffer_0_shsh[297];

    auto g_0_xzzzz_0_xxxyz_0 = prim_buffer_0_shsh[298];

    auto g_0_xzzzz_0_xxxzz_0 = prim_buffer_0_shsh[299];

    auto g_0_xzzzz_0_xxyyy_0 = prim_buffer_0_shsh[300];
    ...
    auto g_0_xzzzz_0_xyyyy_0 = prim_buffer_0_shsh[304];
    ...
    /// Set up 315-336 components of targeted buffer : prim_buffer_0_shsh
    ...
    /// Set up 336-357 components of targeted buffer : prim_buffer_0_shsh

    auto g_0_yyyyz_0_xxxxx_0 = prim_buffer_0_shsh[336];
    ...
    /// Set up 357-378 components of targeted buffer : prim_buffer_0_shsh
    ...
    /// Set up 378-399 components of targeted buffer : prim_buffer_0_shsh
    ...
    /// Set up 399-420 components of targeted buffer : prim_buffer_0_shsh
    ...
    /// Set up 420-441 components of targeted buffer : prim_buffer_0_shsh
