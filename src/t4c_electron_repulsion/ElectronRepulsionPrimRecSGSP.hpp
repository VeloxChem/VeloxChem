#ifndef ElectronRepulsionPrimRecSGSP_hpp
#define ElectronRepulsionPrimRecSGSP_hpp

#include "SimdArray.hpp"

namespace erirec { // erirec namespace

/// Computes [SG|1/|r-r'||SP]  integrals for set of data buffers.
/// - Parameter prim_buffer_0_sgsp: the primitive integrals buffer.
...
auto
comp_prim_electron_repulsion_sgsp(CSimdArray<double>& prim_buffer_0_sgsp,
...
#endif /* ElectronRepulsionPrimRecSGSP_hpp */
