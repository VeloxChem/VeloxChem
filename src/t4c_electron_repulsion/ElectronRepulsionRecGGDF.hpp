...
/// Computes (GG|1/|r-r'||DF)  integrals for two GTOs pair blocks.
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> contr_buffer_0_sldf(2700, ket_dim);
    ...
    CSimdArray<double> ket_spher_buffer_0_sldf(1575, ket_dim);
    ...
    CSimdArray<double> ket_spher_buffer_0_pkdf(3780, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dgdf(3150, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dhdf(4410, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_didf(5880, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fgdf(5250, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fhdf(7350, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_ggdf(7875, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_ggdf(2835, ket_dim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        ket_spher_buffer_0_pkdf.zero();

        ket_spher_buffer_0_dgdf.zero();

        ket_spher_buffer_0_dhdf.zero();

        ket_spher_buffer_0_didf.zero();

        ket_spher_buffer_0_fgdf.zero();

        ket_spher_buffer_0_fhdf.zero();

        ket_spher_buffer_0_ggdf.zero();

        spher_buffer_0_ggdf.zero();
        ...
        erirec::comp_ket_hrr_electron_repulsion_xxdf(contr_buffer_0_sldf, contr_buffer_0_slpf, contr_buffer_0_slpg, cd_x[0], cd_y[0], cd_z[0], 0, 8);
        ...
        t4cfunc::ket_transform<2, 3>(ket_spher_buffer_0_sldf, contr_buffer_0_sldf, 0, 8);
        ...
        erirec::comp_bra_hrr_electron_repulsion_pkxx(ket_spher_buffer_0_pkdf, ket_spher_buffer_0_skdf, ket_spher_buffer_0_sldf, ab_x, ab_y, ab_z, 2, 3);
        ...
        erirec::comp_bra_hrr_electron_repulsion_dixx(ket_spher_buffer_0_didf, ket_spher_buffer_0_pidf, ket_spher_buffer_0_pkdf, ab_x, ab_y, ab_z, 2, 3);
        ...
        erirec::comp_bra_hrr_electron_repulsion_fhxx(ket_spher_buffer_0_fhdf, ket_spher_buffer_0_dhdf, ket_spher_buffer_0_didf, ab_x, ab_y, ab_z, 2, 3);

        erirec::comp_bra_hrr_electron_repulsion_ggxx(ket_spher_buffer_0_ggdf, ket_spher_buffer_0_fgdf, ket_spher_buffer_0_fhdf, ab_x, ab_y, ab_z, 2, 3);

        t4cfunc::bra_transform<4, 4>(spher_buffer_0_ggdf, ket_spher_buffer_0_ggdf, 2, 3);

        t4cfunc::store_values(buffer, spher_buffer_0_ggdf, 2835 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 4, 4, 2, 3, bra_indices, ket_indices);
}
