...
/// Computes (PP|1/|r-r'||GG)  integrals for two GTOs pair blocks.
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_spsk(108, ket_dim);

    CSimdArray<double> cart_buffer_0_spsl(135, ket_dim);
    ...
    CSimdArray<double> contr_buffer_0_sppi(252, ket_dim);

    CSimdArray<double> contr_buffer_0_sppk(324, ket_dim);

    CSimdArray<double> contr_buffer_0_spdg(270, ket_dim);

    CSimdArray<double> contr_buffer_0_spdh(378, ket_dim);

    CSimdArray<double> contr_buffer_0_spdi(504, ket_dim);

    CSimdArray<double> contr_buffer_0_spfg(450, ket_dim);

    CSimdArray<double> contr_buffer_0_spfh(630, ket_dim);

    CSimdArray<double> contr_buffer_0_spgg(675, ket_dim);
    ...
    CSimdArray<double> ket_spher_buffer_0_spgg(243, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_sdgg(486, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_ppgg(729, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_ppgg(729, ket_dim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        cart_buffer_0_spsk.zero();

        cart_buffer_0_spsl.zero();
        ...
        ket_spher_buffer_0_spgg.zero();

        ket_spher_buffer_0_sdgg.zero();

        ket_spher_buffer_0_ppgg.zero();

        spher_buffer_0_ppgg.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t2cfunc::reduce(cart_buffer_0_spsk, prim_buffer_0_spsk, ket_dim, ket_npgtos);

            t2cfunc::reduce(cart_buffer_0_spsl, prim_buffer_0_spsl, ket_dim, ket_npgtos);
        ...
        erirec::comp_ket_hrr_electron_repulsion_xxpi(contr_buffer_0_sppi, cart_buffer_0_spsi, cart_buffer_0_spsk, cd_x[0], cd_y[0], cd_z[0], 0, 1);

        erirec::comp_ket_hrr_electron_repulsion_xxpk(contr_buffer_0_sppk, cart_buffer_0_spsk, cart_buffer_0_spsl, cd_x[0], cd_y[0], cd_z[0], 0, 1);
        ...
        erirec::comp_ket_hrr_electron_repulsion_xxdh(contr_buffer_0_spdh, contr_buffer_0_spph, contr_buffer_0_sppi, cd_x[0], cd_y[0], cd_z[0], 0, 1);

        erirec::comp_ket_hrr_electron_repulsion_xxdi(contr_buffer_0_spdi, contr_buffer_0_sppi, contr_buffer_0_sppk, cd_x[0], cd_y[0], cd_z[0], 0, 1);

        erirec::comp_ket_hrr_electron_repulsion_xxfg(contr_buffer_0_spfg, contr_buffer_0_spdg, contr_buffer_0_spdh, cd_x[0], cd_y[0], cd_z[0], 0, 1);

        erirec::comp_ket_hrr_electron_repulsion_xxfh(contr_buffer_0_spfh, contr_buffer_0_spdh, contr_buffer_0_spdi, cd_x[0], cd_y[0], cd_z[0], 0, 1);

        erirec::comp_ket_hrr_electron_repulsion_xxgg(contr_buffer_0_spgg, contr_buffer_0_spfg, contr_buffer_0_spfh, cd_x[0], cd_y[0], cd_z[0], 0, 1);
        ...
        t4cfunc::ket_transform<4, 4>(ket_spher_buffer_0_spgg, contr_buffer_0_spgg, 0, 1);

        t4cfunc::ket_transform<4, 4>(ket_spher_buffer_0_sdgg, contr_buffer_0_sdgg, 0, 2);

        erirec::comp_bra_hrr_electron_repulsion_ppxx(ket_spher_buffer_0_ppgg, ket_spher_buffer_0_spgg, ket_spher_buffer_0_sdgg, ab_x, ab_y, ab_z, 4, 4);

        t4cfunc::bra_transform<1, 1>(spher_buffer_0_ppgg, ket_spher_buffer_0_ppgg, 4, 4);

        t4cfunc::store_values(buffer, spher_buffer_0_ppgg, 729 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 1, 1, 4, 4, bra_indices, ket_indices);
}
