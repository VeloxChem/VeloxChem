#ifndef ElectronRepulsionRecSFDF_hpp
#define ElectronRepulsionRecSFDF_hpp
...
/// @brief Computes (SF|1/|r-r'||DF)  integrals for two basis function pairs blocks.
...
template <class T>
inline auto
comp_electron_repulsion_sfdf(T& distributor,
                             ...
                             const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> skbuffer(350, 1);
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (int k = 0; k < bra_npgtos; k++)
            {
                ...
                t2cfunc::reduce(cbuffer, 0, pbuffer, 1341, 100, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 100, pbuffer, 1441, 150, ket_width, ket_npgtos);

                t2cfunc::reduce(cbuffer, 250, pbuffer, 1591, 210, ket_width, ket_npgtos);
            ...
            distributor.distribute(sbuffer, 0, a_indices, b_indices, c_indices, d_indices, 0, 3, 2, 3, j, ket_range, diagonal);
        }
    }
...
#endif /* ElectronRepulsionRecSFDF_hpp */
