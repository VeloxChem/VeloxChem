...
/// Computes (GG|1/|r-r'||PG)  integrals for two GTOs pair blocks.
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> ket_spher_buffer_0_sgpg(405, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_shpg(567, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_sipg(756, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_skpg(972, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_slpg(1215, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pgpg(1215, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_phpg(1701, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pipg(2268, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pkpg(2916, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dgpg(2430, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dhpg(3402, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dipg(4536, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fgpg(4050, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fhpg(5670, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_ggpg(6075, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_ggpg(2187, ket_dim);

    // allocate accumulation buffer for integrals

    CSimdArray<double> buffer(bra_dim * 2187, ket_dim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        ket_spher_buffer_0_sgpg.zero();

        ket_spher_buffer_0_shpg.zero();

        ket_spher_buffer_0_sipg.zero();

        ket_spher_buffer_0_skpg.zero();

        ket_spher_buffer_0_slpg.zero();

        ket_spher_buffer_0_pgpg.zero();

        ket_spher_buffer_0_phpg.zero();

        ket_spher_buffer_0_pipg.zero();

        ket_spher_buffer_0_pkpg.zero();

        ket_spher_buffer_0_dgpg.zero();

        ket_spher_buffer_0_dhpg.zero();

        ket_spher_buffer_0_dipg.zero();

        ket_spher_buffer_0_fgpg.zero();

        ket_spher_buffer_0_fhpg.zero();

        ket_spher_buffer_0_ggpg.zero();

        spher_buffer_0_ggpg.zero();
        ...
        t4cfunc::ket_transform<1, 4>(ket_spher_buffer_0_sgpg, contr_buffer_0_sgpg, 0, 4);

        t4cfunc::ket_transform<1, 4>(ket_spher_buffer_0_shpg, contr_buffer_0_shpg, 0, 5);

        t4cfunc::ket_transform<1, 4>(ket_spher_buffer_0_sipg, contr_buffer_0_sipg, 0, 6);

        t4cfunc::ket_transform<1, 4>(ket_spher_buffer_0_skpg, contr_buffer_0_skpg, 0, 7);

        t4cfunc::ket_transform<1, 4>(ket_spher_buffer_0_slpg, contr_buffer_0_slpg, 0, 8);

        erirec::comp_bra_hrr_electron_repulsion_pgxx(ket_spher_buffer_0_pgpg, ket_spher_buffer_0_sgpg, ket_spher_buffer_0_shpg, ab_x, ab_y, ab_z, 1, 4);

        erirec::comp_bra_hrr_electron_repulsion_phxx(ket_spher_buffer_0_phpg, ket_spher_buffer_0_shpg, ket_spher_buffer_0_sipg, ab_x, ab_y, ab_z, 1, 4);

        erirec::comp_bra_hrr_electron_repulsion_pixx(ket_spher_buffer_0_pipg, ket_spher_buffer_0_sipg, ket_spher_buffer_0_skpg, ab_x, ab_y, ab_z, 1, 4);

        erirec::comp_bra_hrr_electron_repulsion_pkxx(ket_spher_buffer_0_pkpg, ket_spher_buffer_0_skpg, ket_spher_buffer_0_slpg, ab_x, ab_y, ab_z, 1, 4);

        erirec::comp_bra_hrr_electron_repulsion_dgxx(ket_spher_buffer_0_dgpg, ket_spher_buffer_0_pgpg, ket_spher_buffer_0_phpg, ab_x, ab_y, ab_z, 1, 4);

        erirec::comp_bra_hrr_electron_repulsion_dhxx(ket_spher_buffer_0_dhpg, ket_spher_buffer_0_phpg, ket_spher_buffer_0_pipg, ab_x, ab_y, ab_z, 1, 4);

        erirec::comp_bra_hrr_electron_repulsion_dixx(ket_spher_buffer_0_dipg, ket_spher_buffer_0_pipg, ket_spher_buffer_0_pkpg, ab_x, ab_y, ab_z, 1, 4);

        erirec::comp_bra_hrr_electron_repulsion_fgxx(ket_spher_buffer_0_fgpg, ket_spher_buffer_0_dgpg, ket_spher_buffer_0_dhpg, ab_x, ab_y, ab_z, 1, 4);

        erirec::comp_bra_hrr_electron_repulsion_fhxx(ket_spher_buffer_0_fhpg, ket_spher_buffer_0_dhpg, ket_spher_buffer_0_dipg, ab_x, ab_y, ab_z, 1, 4);

        erirec::comp_bra_hrr_electron_repulsion_ggxx(ket_spher_buffer_0_ggpg, ket_spher_buffer_0_fgpg, ket_spher_buffer_0_fhpg, ab_x, ab_y, ab_z, 1, 4);

        t4cfunc::bra_transform<4, 4>(spher_buffer_0_ggpg, ket_spher_buffer_0_ggpg, 1, 4);

        t4cfunc::store_values(buffer, spher_buffer_0_ggpg, 2187 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 4, 4, 1, 4, bra_indices, ket_indices);
}
