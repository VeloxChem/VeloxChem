...
/// Computes (GG|1/|r-r'||FG)  integrals for two GTOs pair blocks.
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> prim_buffer_7_spsh(63, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_7_spsi(84, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_7_spsk(108, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_6_sdsh(126, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_6_sdsi(168, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_6_sdsk(216, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_5_sfsh(210, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_5_sfsi(280, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_5_sfsk(360, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_4_sgsh(315, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_4_sgsi(420, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_4_sgsk(540, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_3_shsh(441, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_3_shsi(588, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_3_shsk(756, ket_pdim);
    ...
    CSimdArray<double> prim_buffer_1_sksh(756, ket_pdim);

    CSimdArray<double> prim_buffer_0_sksi(1008, ket_pdim);

    CSimdArray<double> prim_buffer_1_sksi(1008, ket_pdim);

    CSimdArray<double> prim_buffer_0_sksk(1296, ket_pdim);

    CSimdArray<double> prim_buffer_1_sksk(1296, ket_pdim);

    CSimdArray<double> prim_buffer_0_slsg(675, ket_pdim);

    CSimdArray<double> prim_buffer_0_slsh(945, ket_pdim);

    CSimdArray<double> prim_buffer_0_slsi(1260, ket_pdim);

    CSimdArray<double> prim_buffer_0_slsk(1620, ket_pdim);
    ...
    CSimdArray<double> cart_buffer_0_slsh(945, ket_dim);

    CSimdArray<double> cart_buffer_0_slsi(1260, ket_dim);

    CSimdArray<double> cart_buffer_0_slsk(1620, ket_dim);
    ...
    CSimdArray<double> contr_buffer_0_slpg(2025, ket_dim);

    CSimdArray<double> contr_buffer_0_slph(2835, ket_dim);

    CSimdArray<double> contr_buffer_0_slpi(3780, ket_dim);

    CSimdArray<double> contr_buffer_0_sldg(4050, ket_dim);

    CSimdArray<double> contr_buffer_0_sldh(5670, ket_dim);

    CSimdArray<double> contr_buffer_0_slfg(6750, ket_dim);
    ...
    CSimdArray<double> ket_spher_buffer_0_skfg(2268, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_slfg(2835, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pgfg(2835, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_phfg(3969, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pifg(5292, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pkfg(6804, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dgfg(5670, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dhfg(7938, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_difg(10584, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fgfg(9450, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fhfg(13230, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_ggfg(14175, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_ggfg(5103, ket_dim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        ket_spher_buffer_0_skfg.zero();

        ket_spher_buffer_0_slfg.zero();

        ket_spher_buffer_0_pgfg.zero();

        ket_spher_buffer_0_phfg.zero();

        ket_spher_buffer_0_pifg.zero();

        ket_spher_buffer_0_pkfg.zero();

        ket_spher_buffer_0_dgfg.zero();

        ket_spher_buffer_0_dhfg.zero();

        ket_spher_buffer_0_difg.zero();

        ket_spher_buffer_0_fgfg.zero();

        ket_spher_buffer_0_fhfg.zero();

        ket_spher_buffer_0_ggfg.zero();

        spher_buffer_0_ggfg.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t2cfunc::reduce(cart_buffer_0_slsh, prim_buffer_0_slsh, ket_dim, ket_npgtos);

            t2cfunc::reduce(cart_buffer_0_slsi, prim_buffer_0_slsi, ket_dim, ket_npgtos);

            t2cfunc::reduce(cart_buffer_0_slsk, prim_buffer_0_slsk, ket_dim, ket_npgtos);
        ...
        t4cfunc::ket_transform<3, 4>(ket_spher_buffer_0_skfg, contr_buffer_0_skfg, 0, 7);

        t4cfunc::ket_transform<3, 4>(ket_spher_buffer_0_slfg, contr_buffer_0_slfg, 0, 8);
        ...
        erirec::comp_bra_hrr_electron_repulsion_pixx(ket_spher_buffer_0_pifg, ket_spher_buffer_0_sifg, ket_spher_buffer_0_skfg, ab_x, ab_y, ab_z, 3, 4);

        erirec::comp_bra_hrr_electron_repulsion_pkxx(ket_spher_buffer_0_pkfg, ket_spher_buffer_0_skfg, ket_spher_buffer_0_slfg, ab_x, ab_y, ab_z, 3, 4);
        ...
        erirec::comp_bra_hrr_electron_repulsion_dhxx(ket_spher_buffer_0_dhfg, ket_spher_buffer_0_phfg, ket_spher_buffer_0_pifg, ab_x, ab_y, ab_z, 3, 4);

        erirec::comp_bra_hrr_electron_repulsion_dixx(ket_spher_buffer_0_difg, ket_spher_buffer_0_pifg, ket_spher_buffer_0_pkfg, ab_x, ab_y, ab_z, 3, 4);

        erirec::comp_bra_hrr_electron_repulsion_fgxx(ket_spher_buffer_0_fgfg, ket_spher_buffer_0_dgfg, ket_spher_buffer_0_dhfg, ab_x, ab_y, ab_z, 3, 4);

        erirec::comp_bra_hrr_electron_repulsion_fhxx(ket_spher_buffer_0_fhfg, ket_spher_buffer_0_dhfg, ket_spher_buffer_0_difg, ab_x, ab_y, ab_z, 3, 4);

        erirec::comp_bra_hrr_electron_repulsion_ggxx(ket_spher_buffer_0_ggfg, ket_spher_buffer_0_fgfg, ket_spher_buffer_0_fhfg, ab_x, ab_y, ab_z, 3, 4);

        t4cfunc::bra_transform<4, 4>(spher_buffer_0_ggfg, ket_spher_buffer_0_ggfg, 3, 4);

        t4cfunc::store_values(buffer, spher_buffer_0_ggfg, 5103 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 4, 4, 3, 4, bra_indices, ket_indices);
}
