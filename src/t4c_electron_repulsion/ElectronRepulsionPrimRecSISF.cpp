...
{
    const auto ndims = prim_buffer_0_sisf.number_of_columns();
    ...
    auto g_0_xxxxy_0_xxy_1 = prim_buffer_1_shsf[11];

    auto g_0_xxxxy_0_xxz_1 = prim_buffer_1_shsf[12];

    auto g_0_xxxxy_0_xyy_1 = prim_buffer_1_shsf[13];

    auto g_0_xxxxy_0_xzz_1 = prim_buffer_1_shsf[15];

    auto g_0_xxxxy_0_yyy_1 = prim_buffer_1_shsf[16];
    ...
    auto g_0_xyyyy_0_xxx_1 = prim_buffer_1_shsf[100];
    ...
    auto g_0_xzzzz_0_xxx_1 = prim_buffer_1_shsf[140];
    ...
    /// Set up 0-10 components of targeted buffer : prim_buffer_0_sisf
    ...
    /// Set up 10-20 components of targeted buffer : prim_buffer_0_sisf
    ...
    auto g_0_xxxxxy_0_xyz_0 = prim_buffer_0_sisf[14];

    auto g_0_xxxxxy_0_xzz_0 = prim_buffer_0_sisf[15];

    auto g_0_xxxxxy_0_yyy_0 = prim_buffer_0_sisf[16];

    auto g_0_xxxxxy_0_yyz_0 = prim_buffer_0_sisf[17];

    auto g_0_xxxxxy_0_yzz_0 = prim_buffer_0_sisf[18];

    auto g_0_xxxxxy_0_zzz_0 = prim_buffer_0_sisf[19];
    ...
    /// Set up 20-30 components of targeted buffer : prim_buffer_0_sisf
    ...
    auto g_0_xxxxxz_0_yyy_0 = prim_buffer_0_sisf[26];
    ...
    /// Set up 30-40 components of targeted buffer : prim_buffer_0_sisf
    ...
    /// Set up 40-50 components of targeted buffer : prim_buffer_0_sisf

    auto g_0_xxxxyz_0_xxx_0 = prim_buffer_0_sisf[40];

    auto g_0_xxxxyz_0_xxy_0 = prim_buffer_0_sisf[41];

    auto g_0_xxxxyz_0_xxz_0 = prim_buffer_0_sisf[42];

    auto g_0_xxxxyz_0_xyy_0 = prim_buffer_0_sisf[43];

    auto g_0_xxxxyz_0_xyz_0 = prim_buffer_0_sisf[44];

    auto g_0_xxxxyz_0_xzz_0 = prim_buffer_0_sisf[45];

    auto g_0_xxxxyz_0_yyy_0 = prim_buffer_0_sisf[46];

    auto g_0_xxxxyz_0_yyz_0 = prim_buffer_0_sisf[47];

    auto g_0_xxxxyz_0_yzz_0 = prim_buffer_0_sisf[48];

    auto g_0_xxxxyz_0_zzz_0 = prim_buffer_0_sisf[49];
    ...
    /// Set up 50-60 components of targeted buffer : prim_buffer_0_sisf
    ...
    /// Set up 60-70 components of targeted buffer : prim_buffer_0_sisf
    ...
    /// Set up 70-80 components of targeted buffer : prim_buffer_0_sisf

    auto g_0_xxxyyz_0_xxx_0 = prim_buffer_0_sisf[70];

    auto g_0_xxxyyz_0_xxy_0 = prim_buffer_0_sisf[71];

    auto g_0_xxxyyz_0_xxz_0 = prim_buffer_0_sisf[72];

    auto g_0_xxxyyz_0_xyy_0 = prim_buffer_0_sisf[73];

    auto g_0_xxxyyz_0_xyz_0 = prim_buffer_0_sisf[74];

    auto g_0_xxxyyz_0_xzz_0 = prim_buffer_0_sisf[75];

    auto g_0_xxxyyz_0_yyy_0 = prim_buffer_0_sisf[76];

    auto g_0_xxxyyz_0_yyz_0 = prim_buffer_0_sisf[77];

    auto g_0_xxxyyz_0_yzz_0 = prim_buffer_0_sisf[78];

    auto g_0_xxxyyz_0_zzz_0 = prim_buffer_0_sisf[79];
    ...
    /// Set up 80-90 components of targeted buffer : prim_buffer_0_sisf

    auto g_0_xxxyzz_0_xxx_0 = prim_buffer_0_sisf[80];

    auto g_0_xxxyzz_0_xxy_0 = prim_buffer_0_sisf[81];

    auto g_0_xxxyzz_0_xxz_0 = prim_buffer_0_sisf[82];

    auto g_0_xxxyzz_0_xyy_0 = prim_buffer_0_sisf[83];

    auto g_0_xxxyzz_0_xyz_0 = prim_buffer_0_sisf[84];

    auto g_0_xxxyzz_0_xzz_0 = prim_buffer_0_sisf[85];

    auto g_0_xxxyzz_0_yyy_0 = prim_buffer_0_sisf[86];

    auto g_0_xxxyzz_0_yyz_0 = prim_buffer_0_sisf[87];

    auto g_0_xxxyzz_0_yzz_0 = prim_buffer_0_sisf[88];

    auto g_0_xxxyzz_0_zzz_0 = prim_buffer_0_sisf[89];
    ...
    /// Set up 90-100 components of targeted buffer : prim_buffer_0_sisf
    ...
    /// Set up 100-110 components of targeted buffer : prim_buffer_0_sisf
    ...
    /// Set up 110-120 components of targeted buffer : prim_buffer_0_sisf

    auto g_0_xxyyyz_0_xxx_0 = prim_buffer_0_sisf[110];

    auto g_0_xxyyyz_0_xxy_0 = prim_buffer_0_sisf[111];

    auto g_0_xxyyyz_0_xxz_0 = prim_buffer_0_sisf[112];

    auto g_0_xxyyyz_0_xyy_0 = prim_buffer_0_sisf[113];

    auto g_0_xxyyyz_0_xyz_0 = prim_buffer_0_sisf[114];

    auto g_0_xxyyyz_0_xzz_0 = prim_buffer_0_sisf[115];

    auto g_0_xxyyyz_0_yyy_0 = prim_buffer_0_sisf[116];

    auto g_0_xxyyyz_0_yyz_0 = prim_buffer_0_sisf[117];

    auto g_0_xxyyyz_0_yzz_0 = prim_buffer_0_sisf[118];

    auto g_0_xxyyyz_0_zzz_0 = prim_buffer_0_sisf[119];
    ...
    /// Set up 120-130 components of targeted buffer : prim_buffer_0_sisf
    ...
    /// Set up 130-140 components of targeted buffer : prim_buffer_0_sisf

    auto g_0_xxyzzz_0_xxx_0 = prim_buffer_0_sisf[130];

    auto g_0_xxyzzz_0_xxy_0 = prim_buffer_0_sisf[131];

    auto g_0_xxyzzz_0_xxz_0 = prim_buffer_0_sisf[132];

    auto g_0_xxyzzz_0_xyy_0 = prim_buffer_0_sisf[133];

    auto g_0_xxyzzz_0_xyz_0 = prim_buffer_0_sisf[134];

    auto g_0_xxyzzz_0_xzz_0 = prim_buffer_0_sisf[135];

    auto g_0_xxyzzz_0_yyy_0 = prim_buffer_0_sisf[136];

    auto g_0_xxyzzz_0_yyz_0 = prim_buffer_0_sisf[137];

    auto g_0_xxyzzz_0_yzz_0 = prim_buffer_0_sisf[138];

    auto g_0_xxyzzz_0_zzz_0 = prim_buffer_0_sisf[139];
    ...
    /// Set up 140-150 components of targeted buffer : prim_buffer_0_sisf
    ...
    /// Set up 160-170 components of targeted buffer : prim_buffer_0_sisf

    auto g_0_xyyyyz_0_xxx_0 = prim_buffer_0_sisf[160];

    auto g_0_xyyyyz_0_xxy_0 = prim_buffer_0_sisf[161];

    auto g_0_xyyyyz_0_xxz_0 = prim_buffer_0_sisf[162];

    auto g_0_xyyyyz_0_xyy_0 = prim_buffer_0_sisf[163];

    auto g_0_xyyyyz_0_xyz_0 = prim_buffer_0_sisf[164];

    auto g_0_xyyyyz_0_xzz_0 = prim_buffer_0_sisf[165];

    auto g_0_xyyyyz_0_yyy_0 = prim_buffer_0_sisf[166];

    auto g_0_xyyyyz_0_yyz_0 = prim_buffer_0_sisf[167];

    auto g_0_xyyyyz_0_yzz_0 = prim_buffer_0_sisf[168];

    auto g_0_xyyyyz_0_zzz_0 = prim_buffer_0_sisf[169];
    ...
    /// Set up 170-180 components of targeted buffer : prim_buffer_0_sisf

    auto g_0_xyyyzz_0_xxx_0 = prim_buffer_0_sisf[170];

    auto g_0_xyyyzz_0_xxy_0 = prim_buffer_0_sisf[171];

    auto g_0_xyyyzz_0_xxz_0 = prim_buffer_0_sisf[172];

    auto g_0_xyyyzz_0_xyy_0 = prim_buffer_0_sisf[173];

    auto g_0_xyyyzz_0_xyz_0 = prim_buffer_0_sisf[174];

    auto g_0_xyyyzz_0_xzz_0 = prim_buffer_0_sisf[175];
    ...
    /// Set up 180-190 components of targeted buffer : prim_buffer_0_sisf

    auto g_0_xyyzzz_0_xxx_0 = prim_buffer_0_sisf[180];

    auto g_0_xyyzzz_0_xxy_0 = prim_buffer_0_sisf[181];

    auto g_0_xyyzzz_0_xxz_0 = prim_buffer_0_sisf[182];

    auto g_0_xyyzzz_0_xyy_0 = prim_buffer_0_sisf[183];

    auto g_0_xyyzzz_0_xyz_0 = prim_buffer_0_sisf[184];

    auto g_0_xyyzzz_0_xzz_0 = prim_buffer_0_sisf[185];
    ...
    /// Set up 190-200 components of targeted buffer : prim_buffer_0_sisf

    auto g_0_xyzzzz_0_xxx_0 = prim_buffer_0_sisf[190];

    auto g_0_xyzzzz_0_xxy_0 = prim_buffer_0_sisf[191];

    auto g_0_xyzzzz_0_xxz_0 = prim_buffer_0_sisf[192];

    auto g_0_xyzzzz_0_xyy_0 = prim_buffer_0_sisf[193];

    auto g_0_xyzzzz_0_xyz_0 = prim_buffer_0_sisf[194];

    auto g_0_xyzzzz_0_xzz_0 = prim_buffer_0_sisf[195];

    auto g_0_xyzzzz_0_yyy_0 = prim_buffer_0_sisf[196];

    auto g_0_xyzzzz_0_yyz_0 = prim_buffer_0_sisf[197];

    auto g_0_xyzzzz_0_yzz_0 = prim_buffer_0_sisf[198];

    auto g_0_xyzzzz_0_zzz_0 = prim_buffer_0_sisf[199];
    ...
    /// Set up 200-210 components of targeted buffer : prim_buffer_0_sisf

    auto g_0_xzzzzz_0_xxx_0 = prim_buffer_0_sisf[200];

    auto g_0_xzzzzz_0_xxy_0 = prim_buffer_0_sisf[201];

    auto g_0_xzzzzz_0_xxz_0 = prim_buffer_0_sisf[202];

    auto g_0_xzzzzz_0_xyy_0 = prim_buffer_0_sisf[203];
    ...
    /// Set up 210-220 components of targeted buffer : prim_buffer_0_sisf
    ...
    /// Set up 220-230 components of targeted buffer : prim_buffer_0_sisf

    auto g_0_yyyyyz_0_xxx_0 = prim_buffer_0_sisf[220];
    ...
    /// Set up 230-240 components of targeted buffer : prim_buffer_0_sisf
    ...
    /// Set up 240-250 components of targeted buffer : prim_buffer_0_sisf
    ...
    /// Set up 250-260 components of targeted buffer : prim_buffer_0_sisf
    ...
    /// Set up 260-270 components of targeted buffer : prim_buffer_0_sisf
    ...
    /// Set up 270-280 components of targeted buffer : prim_buffer_0_sisf
