#ifndef ElectronRepulsionRecPPFF_hpp
#define ElectronRepulsionRecPPFF_hpp
...
/// Computes (PP|1/|r-r'||FF)  integrals for two GTOs pair blocks.
...
template <class T>
auto
comp_electron_repulsion_ppff(T* distributor,
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> cart_buffer_0_spsf(30, ket_dim);

    CSimdArray<double> cart_buffer_0_spsg(45, ket_dim);

    CSimdArray<double> cart_buffer_0_spsh(63, ket_dim);

    CSimdArray<double> cart_buffer_0_spsi(84, ket_dim);

    CSimdArray<double> cart_buffer_0_sdsf(60, ket_dim);
    ...
    CSimdArray<double> contr_buffer_0_sppf(90, ket_dim);

    CSimdArray<double> contr_buffer_0_sppg(135, ket_dim);

    CSimdArray<double> contr_buffer_0_spph(189, ket_dim);

    CSimdArray<double> contr_buffer_0_spdf(180, ket_dim);

    CSimdArray<double> contr_buffer_0_spdg(270, ket_dim);

    CSimdArray<double> contr_buffer_0_spff(300, ket_dim);

    CSimdArray<double> contr_buffer_0_sdpf(180, ket_dim);

    CSimdArray<double> contr_buffer_0_sdpg(270, ket_dim);

    CSimdArray<double> contr_buffer_0_sdph(378, ket_dim);

    CSimdArray<double> contr_buffer_0_sddf(360, ket_dim);

    CSimdArray<double> contr_buffer_0_sddg(540, ket_dim);

    CSimdArray<double> contr_buffer_0_sdff(600, ket_dim);

    // allocate aligned half transformed integrals

    CSimdArray<double> ket_spher_buffer_0_spff(147, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_sdff(294, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_ppff(441, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_ppff(441, ket_dim);

    // allocate accumulation buffer for integrals

    CSimdArray<double> buffer(bra_dim * 441, ket_dim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        cart_buffer_0_spsf.zero();

        cart_buffer_0_spsg.zero();

        cart_buffer_0_spsh.zero();

        cart_buffer_0_spsi.zero();
        ...
        ket_spher_buffer_0_spff.zero();

        ket_spher_buffer_0_sdff.zero();

        ket_spher_buffer_0_ppff.zero();

        spher_buffer_0_ppff.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            t2cfunc::reduce(cart_buffer_0_spsf, prim_buffer_0_spsf, ket_dim, ket_npgtos);

            t2cfunc::reduce(cart_buffer_0_spsg, prim_buffer_0_spsg, ket_dim, ket_npgtos);

            t2cfunc::reduce(cart_buffer_0_spsh, prim_buffer_0_spsh, ket_dim, ket_npgtos);

            t2cfunc::reduce(cart_buffer_0_spsi, prim_buffer_0_spsi, ket_dim, ket_npgtos);

            t2cfunc::reduce(cart_buffer_0_sdsf, prim_buffer_0_sdsf, ket_dim, ket_npgtos);
        ...
        erirec::comp_ket_hrr_electron_repulsion_xxpf(contr_buffer_0_sppf, cart_buffer_0_spsf, cart_buffer_0_spsg, cd_x[0], cd_y[0], cd_z[0], 0, 1);

        erirec::comp_ket_hrr_electron_repulsion_xxpg(contr_buffer_0_sppg, cart_buffer_0_spsg, cart_buffer_0_spsh, cd_x[0], cd_y[0], cd_z[0], 0, 1);

        erirec::comp_ket_hrr_electron_repulsion_xxph(contr_buffer_0_spph, cart_buffer_0_spsh, cart_buffer_0_spsi, cd_x[0], cd_y[0], cd_z[0], 0, 1);

        erirec::comp_ket_hrr_electron_repulsion_xxdf(contr_buffer_0_spdf, contr_buffer_0_sppf, contr_buffer_0_sppg, cd_x[0], cd_y[0], cd_z[0], 0, 1);

        erirec::comp_ket_hrr_electron_repulsion_xxdg(contr_buffer_0_spdg, contr_buffer_0_sppg, contr_buffer_0_spph, cd_x[0], cd_y[0], cd_z[0], 0, 1);

        erirec::comp_ket_hrr_electron_repulsion_xxff(contr_buffer_0_spff, contr_buffer_0_spdf, contr_buffer_0_spdg, cd_x[0], cd_y[0], cd_z[0], 0, 1);

        erirec::comp_ket_hrr_electron_repulsion_xxpf(contr_buffer_0_sdpf, cart_buffer_0_sdsf, cart_buffer_0_sdsg, cd_x[0], cd_y[0], cd_z[0], 0, 2);
        ...
        erirec::comp_ket_hrr_electron_repulsion_xxdf(contr_buffer_0_sddf, contr_buffer_0_sdpf, contr_buffer_0_sdpg, cd_x[0], cd_y[0], cd_z[0], 0, 2);
        ...
        erirec::comp_ket_hrr_electron_repulsion_xxff(contr_buffer_0_sdff, contr_buffer_0_sddf, contr_buffer_0_sddg, cd_x[0], cd_y[0], cd_z[0], 0, 2);

        t4cfunc::ket_transform<3, 3>(ket_spher_buffer_0_spff, contr_buffer_0_spff, 0, 1);

        t4cfunc::ket_transform<3, 3>(ket_spher_buffer_0_sdff, contr_buffer_0_sdff, 0, 2);

        erirec::comp_bra_hrr_electron_repulsion_ppxx(ket_spher_buffer_0_ppff, ket_spher_buffer_0_spff, ket_spher_buffer_0_sdff, ab_x, ab_y, ab_z, 3, 3);

        t4cfunc::bra_transform<1, 1>(spher_buffer_0_ppff, ket_spher_buffer_0_ppff, 3, 3);

        t4cfunc::store_values(buffer, spher_buffer_0_ppff, 441 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 1, 1, 3, 3, bra_indices, ket_indices);
}

} // erirec namespace

#endif /* ElectronRepulsionRecPPFF_hpp */
