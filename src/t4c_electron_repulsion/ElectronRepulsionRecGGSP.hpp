...
/// Computes (GG|1/|r-r'||SP)  integrals for two GTOs pair blocks.
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> ket_spher_buffer_0_slsp(135, ket_dim);
    ...
    CSimdArray<double> ket_spher_buffer_0_pksp(324, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dgsp(270, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dhsp(378, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_disp(504, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fgsp(450, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fhsp(630, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_ggsp(675, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_ggsp(243, ket_dim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        ket_spher_buffer_0_pksp.zero();

        ket_spher_buffer_0_dgsp.zero();

        ket_spher_buffer_0_dhsp.zero();

        ket_spher_buffer_0_disp.zero();

        ket_spher_buffer_0_fgsp.zero();

        ket_spher_buffer_0_fhsp.zero();

        ket_spher_buffer_0_ggsp.zero();

        spher_buffer_0_ggsp.zero();
        ...
        t4cfunc::ket_transform<0, 1>(ket_spher_buffer_0_slsp, cart_buffer_0_slsp, 0, 8);
        ...
        erirec::comp_bra_hrr_electron_repulsion_pkxx(ket_spher_buffer_0_pksp, ket_spher_buffer_0_sksp, ket_spher_buffer_0_slsp, ab_x, ab_y, ab_z, 0, 1);
        ...
        erirec::comp_bra_hrr_electron_repulsion_dixx(ket_spher_buffer_0_disp, ket_spher_buffer_0_pisp, ket_spher_buffer_0_pksp, ab_x, ab_y, ab_z, 0, 1);
        ...
        erirec::comp_bra_hrr_electron_repulsion_fhxx(ket_spher_buffer_0_fhsp, ket_spher_buffer_0_dhsp, ket_spher_buffer_0_disp, ab_x, ab_y, ab_z, 0, 1);

        erirec::comp_bra_hrr_electron_repulsion_ggxx(ket_spher_buffer_0_ggsp, ket_spher_buffer_0_fgsp, ket_spher_buffer_0_fhsp, ab_x, ab_y, ab_z, 0, 1);

        t4cfunc::bra_transform<4, 4>(spher_buffer_0_ggsp, ket_spher_buffer_0_ggsp, 0, 1);

        t4cfunc::store_values(buffer, spher_buffer_0_ggsp, 243 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 4, 4, 0, 1, bra_indices, ket_indices);
}
