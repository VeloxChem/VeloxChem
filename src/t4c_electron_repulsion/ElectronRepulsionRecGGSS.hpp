...
/// Computes (GG|1/|r-r'||SS)  integrals for two GTOs pair blocks.
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> prim_buffer_0_slss(45, ket_pdim);
    ...
    CSimdArray<double> cart_buffer_0_slss(45, ket_dim);
    ...
    CSimdArray<double> ket_spher_buffer_0_slss(45, ket_dim);
    ...
    CSimdArray<double> ket_spher_buffer_0_pkss(108, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dgss(90, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dhss(126, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_diss(168, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fgss(150, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fhss(210, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_ggss(225, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_ggss(81, ket_dim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        ket_spher_buffer_0_pkss.zero();

        ket_spher_buffer_0_dgss.zero();

        ket_spher_buffer_0_dhss.zero();

        ket_spher_buffer_0_diss.zero();

        ket_spher_buffer_0_fgss.zero();

        ket_spher_buffer_0_fhss.zero();

        ket_spher_buffer_0_ggss.zero();

        spher_buffer_0_ggss.zero();
        ...
        for (int j = 0; j < bra_npgtos; j++)
        {
            ...
            erirec::comp_prim_electron_repulsion_slss(prim_buffer_0_slss, prim_buffer_0_siss, prim_buffer_1_siss, prim_buffer_0_skss, prim_buffer_1_skss, pb_x, pb_y, pb_z, wp_x[0], wp_y[0], wp_z[0], a_exp, b_exp, c_exps[0], d_exps[0]);
            ...
            t2cfunc::reduce(cart_buffer_0_slss, prim_buffer_0_slss, ket_dim, ket_npgtos);
        ...
        t4cfunc::ket_transform<0, 0>(ket_spher_buffer_0_slss, cart_buffer_0_slss, 0, 8);
        ...
        erirec::comp_bra_hrr_electron_repulsion_pkxx(ket_spher_buffer_0_pkss, ket_spher_buffer_0_skss, ket_spher_buffer_0_slss, ab_x, ab_y, ab_z, 0, 0);
        ...
        erirec::comp_bra_hrr_electron_repulsion_dixx(ket_spher_buffer_0_diss, ket_spher_buffer_0_piss, ket_spher_buffer_0_pkss, ab_x, ab_y, ab_z, 0, 0);
        ...
        erirec::comp_bra_hrr_electron_repulsion_fhxx(ket_spher_buffer_0_fhss, ket_spher_buffer_0_dhss, ket_spher_buffer_0_diss, ab_x, ab_y, ab_z, 0, 0);

        erirec::comp_bra_hrr_electron_repulsion_ggxx(ket_spher_buffer_0_ggss, ket_spher_buffer_0_fgss, ket_spher_buffer_0_fhss, ab_x, ab_y, ab_z, 0, 0);

        t4cfunc::bra_transform<4, 4>(spher_buffer_0_ggss, ket_spher_buffer_0_ggss, 0, 0);

        t4cfunc::store_values(buffer, spher_buffer_0_ggss, 81 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 4, 4, 0, 0, bra_indices, ket_indices);
}
