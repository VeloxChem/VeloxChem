#ifndef ElectronRepulsionRecPPSD_hpp
#define ElectronRepulsionRecPPSD_hpp
...
template <class T>
auto
comp_electron_repulsion_ppsd(T* distributor,
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> ket_spher_buffer_0_spsd(15, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_sdsd(30, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_ppsd(45, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_ppsd(45, ket_dim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        ket_spher_buffer_0_spsd.zero();

        ket_spher_buffer_0_sdsd.zero();

        ket_spher_buffer_0_ppsd.zero();

        spher_buffer_0_ppsd.zero();
        ...
        t4cfunc::ket_transform<0, 2>(ket_spher_buffer_0_spsd, cart_buffer_0_spsd, 0, 1);

        t4cfunc::ket_transform<0, 2>(ket_spher_buffer_0_sdsd, cart_buffer_0_sdsd, 0, 2);

        erirec::comp_bra_hrr_electron_repulsion_ppxx(ket_spher_buffer_0_ppsd, ket_spher_buffer_0_spsd, ket_spher_buffer_0_sdsd, ab_x, ab_y, ab_z, 0, 2);

        t4cfunc::bra_transform<1, 1>(spher_buffer_0_ppsd, ket_spher_buffer_0_ppsd, 0, 2);

        t4cfunc::store_values(buffer, spher_buffer_0_ppsd, 45 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 1, 1, 0, 2, bra_indices, ket_indices);
}

} // erirec namespace

#endif /* ElectronRepulsionRecPPSD_hpp */
