#ifndef ElectronRepulsionRecDDPD_hpp
#define ElectronRepulsionRecDDPD_hpp
...
template <class T>
auto
comp_electron_repulsion_ddpd(T* distributor,
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> ket_spher_buffer_0_sdpd(90, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_sfpd(150, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_sgpd(225, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pdpd(270, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pfpd(450, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_ddpd(540, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_ddpd(375, ket_dim);

    // allocate accumulation buffer for integrals

    CSimdArray<double> buffer(bra_dim * 375, ket_dim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        ket_spher_buffer_0_ddpd.zero();

        spher_buffer_0_ddpd.zero();
        ...
        erirec::comp_bra_hrr_electron_repulsion_ddxx(ket_spher_buffer_0_ddpd, ket_spher_buffer_0_pdpd, ket_spher_buffer_0_pfpd, ab_x, ab_y, ab_z, 1, 2);

        t4cfunc::bra_transform<2, 2>(spher_buffer_0_ddpd, ket_spher_buffer_0_ddpd, 1, 2);

        t4cfunc::store_values(buffer, spher_buffer_0_ddpd, 375 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 2, 2, 1, 2, bra_indices, ket_indices);
}

} // erirec namespace

#endif /* ElectronRepulsionRecDDPD_hpp */
