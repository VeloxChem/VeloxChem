...
/// - Parameter prim_buffer_0_sdsg: the primitive integrals buffer.
/// - Parameter prim_buffer_1_sdsg: the primitive integrals buffer.
/// - Parameter prim_buffer_1_sfsf: the primitive integrals buffer.
/// - Parameter prim_buffer_0_sfsg: the primitive integrals buffer.
/// - Parameter prim_buffer_1_sfsg: the primitive integrals buffer.
...
auto
comp_prim_electron_repulsion_sgsg(CSimdArray<double>& prim_buffer_0_sgsg,
                                  ...
                                  const CSimdArray<double>& prim_buffer_0_sfsg,
