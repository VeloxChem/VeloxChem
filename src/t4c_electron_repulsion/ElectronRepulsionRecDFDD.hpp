...
/// Computes (DF|1/|r-r'||DD)  integrals for two GTOs pair blocks.
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> ket_spher_buffer_0_pfdd(750, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pgdd(1125, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dfdd(1500, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_dfdd(875, ket_dim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        ket_spher_buffer_0_pfdd.zero();

        ket_spher_buffer_0_pgdd.zero();

        ket_spher_buffer_0_dfdd.zero();

        spher_buffer_0_dfdd.zero();
        ...
        erirec::comp_bra_hrr_electron_repulsion_pfxx(ket_spher_buffer_0_pfdd, ket_spher_buffer_0_sfdd, ket_spher_buffer_0_sgdd, ab_x, ab_y, ab_z, 2, 2);
        ...
        erirec::comp_bra_hrr_electron_repulsion_dfxx(ket_spher_buffer_0_dfdd, ket_spher_buffer_0_pfdd, ket_spher_buffer_0_pgdd, ab_x, ab_y, ab_z, 2, 2);

        t4cfunc::bra_transform<2, 3>(spher_buffer_0_dfdd, ket_spher_buffer_0_dfdd, 2, 2);

        t4cfunc::store_values(buffer, spher_buffer_0_dfdd, 875 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 2, 3, 2, 2, bra_indices, ket_indices);
}
