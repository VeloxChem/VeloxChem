...
/// Computes (FG|1/|r-r'||DD)  integrals for two GTOs pair blocks.
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> contr_buffer_0_sgpd(270, ket_dim);

    CSimdArray<double> contr_buffer_0_sgpf(450, ket_dim);

    CSimdArray<double> contr_buffer_0_sgdd(540, ket_dim);

    CSimdArray<double> contr_buffer_0_shpd(378, ket_dim);

    CSimdArray<double> contr_buffer_0_shpf(630, ket_dim);

    CSimdArray<double> contr_buffer_0_shdd(756, ket_dim);

    CSimdArray<double> contr_buffer_0_sipd(504, ket_dim);

    CSimdArray<double> contr_buffer_0_sipf(840, ket_dim);

    CSimdArray<double> contr_buffer_0_sidd(1008, ket_dim);

    CSimdArray<double> contr_buffer_0_skpd(648, ket_dim);

    CSimdArray<double> contr_buffer_0_skpf(1080, ket_dim);

    CSimdArray<double> contr_buffer_0_skdd(1296, ket_dim);

    // allocate aligned half transformed integrals

    CSimdArray<double> ket_spher_buffer_0_sgdd(375, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_shdd(525, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_sidd(700, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_skdd(900, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pgdd(1125, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_phdd(1575, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pidd(2100, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dgdd(2250, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dhdd(3150, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fgdd(3750, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_fgdd(1575, ket_dim);

    // allocate accumulation buffer for integrals

    CSimdArray<double> buffer(bra_dim * 1575, ket_dim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        ket_spher_buffer_0_sgdd.zero();

        ket_spher_buffer_0_shdd.zero();

        ket_spher_buffer_0_sidd.zero();

        ket_spher_buffer_0_skdd.zero();

        ket_spher_buffer_0_pgdd.zero();

        ket_spher_buffer_0_phdd.zero();

        ket_spher_buffer_0_pidd.zero();

        ket_spher_buffer_0_dgdd.zero();

        ket_spher_buffer_0_dhdd.zero();

        ket_spher_buffer_0_fgdd.zero();

        spher_buffer_0_fgdd.zero();
        ...
        erirec::comp_ket_hrr_electron_repulsion_xxpd(contr_buffer_0_sgpd, cart_buffer_0_sgsd, cart_buffer_0_sgsf, cd_x[0], cd_y[0], cd_z[0], 0, 4);
        ...
        erirec::comp_ket_hrr_electron_repulsion_xxdd(contr_buffer_0_sgdd, contr_buffer_0_sgpd, contr_buffer_0_sgpf, cd_x[0], cd_y[0], cd_z[0], 0, 4);

        erirec::comp_ket_hrr_electron_repulsion_xxpd(contr_buffer_0_shpd, cart_buffer_0_shsd, cart_buffer_0_shsf, cd_x[0], cd_y[0], cd_z[0], 0, 5);
        ...
        erirec::comp_ket_hrr_electron_repulsion_xxdd(contr_buffer_0_shdd, contr_buffer_0_shpd, contr_buffer_0_shpf, cd_x[0], cd_y[0], cd_z[0], 0, 5);

        erirec::comp_ket_hrr_electron_repulsion_xxpd(contr_buffer_0_sipd, cart_buffer_0_sisd, cart_buffer_0_sisf, cd_x[0], cd_y[0], cd_z[0], 0, 6);
        ...
        erirec::comp_ket_hrr_electron_repulsion_xxdd(contr_buffer_0_sidd, contr_buffer_0_sipd, contr_buffer_0_sipf, cd_x[0], cd_y[0], cd_z[0], 0, 6);

        erirec::comp_ket_hrr_electron_repulsion_xxpd(contr_buffer_0_skpd, cart_buffer_0_sksd, cart_buffer_0_sksf, cd_x[0], cd_y[0], cd_z[0], 0, 7);
        ...
        erirec::comp_ket_hrr_electron_repulsion_xxdd(contr_buffer_0_skdd, contr_buffer_0_skpd, contr_buffer_0_skpf, cd_x[0], cd_y[0], cd_z[0], 0, 7);

        t4cfunc::ket_transform<2, 2>(ket_spher_buffer_0_sgdd, contr_buffer_0_sgdd, 0, 4);

        t4cfunc::ket_transform<2, 2>(ket_spher_buffer_0_shdd, contr_buffer_0_shdd, 0, 5);

        t4cfunc::ket_transform<2, 2>(ket_spher_buffer_0_sidd, contr_buffer_0_sidd, 0, 6);

        t4cfunc::ket_transform<2, 2>(ket_spher_buffer_0_skdd, contr_buffer_0_skdd, 0, 7);

        erirec::comp_bra_hrr_electron_repulsion_pgxx(ket_spher_buffer_0_pgdd, ket_spher_buffer_0_sgdd, ket_spher_buffer_0_shdd, ab_x, ab_y, ab_z, 2, 2);

        erirec::comp_bra_hrr_electron_repulsion_phxx(ket_spher_buffer_0_phdd, ket_spher_buffer_0_shdd, ket_spher_buffer_0_sidd, ab_x, ab_y, ab_z, 2, 2);

        erirec::comp_bra_hrr_electron_repulsion_pixx(ket_spher_buffer_0_pidd, ket_spher_buffer_0_sidd, ket_spher_buffer_0_skdd, ab_x, ab_y, ab_z, 2, 2);

        erirec::comp_bra_hrr_electron_repulsion_dgxx(ket_spher_buffer_0_dgdd, ket_spher_buffer_0_pgdd, ket_spher_buffer_0_phdd, ab_x, ab_y, ab_z, 2, 2);

        erirec::comp_bra_hrr_electron_repulsion_dhxx(ket_spher_buffer_0_dhdd, ket_spher_buffer_0_phdd, ket_spher_buffer_0_pidd, ab_x, ab_y, ab_z, 2, 2);

        erirec::comp_bra_hrr_electron_repulsion_fgxx(ket_spher_buffer_0_fgdd, ket_spher_buffer_0_dgdd, ket_spher_buffer_0_dhdd, ab_x, ab_y, ab_z, 2, 2);

        t4cfunc::bra_transform<3, 4>(spher_buffer_0_fgdd, ket_spher_buffer_0_fgdd, 2, 2);

        t4cfunc::store_values(buffer, spher_buffer_0_fgdd, 1575 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 3, 4, 2, 2, bra_indices, ket_indices);
}
