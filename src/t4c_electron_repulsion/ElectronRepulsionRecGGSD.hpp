...
/// Computes (GG|1/|r-r'||SD)  integrals for two GTOs pair blocks.
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> ket_spher_buffer_0_slsd(225, ket_dim);
    ...
    CSimdArray<double> ket_spher_buffer_0_pksd(540, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dgsd(450, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dhsd(630, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_disd(840, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fgsd(750, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fhsd(1050, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_ggsd(1125, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_ggsd(405, ket_dim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        ket_spher_buffer_0_pksd.zero();

        ket_spher_buffer_0_dgsd.zero();

        ket_spher_buffer_0_dhsd.zero();

        ket_spher_buffer_0_disd.zero();

        ket_spher_buffer_0_fgsd.zero();

        ket_spher_buffer_0_fhsd.zero();

        ket_spher_buffer_0_ggsd.zero();

        spher_buffer_0_ggsd.zero();
        ...
        t4cfunc::ket_transform<0, 2>(ket_spher_buffer_0_slsd, cart_buffer_0_slsd, 0, 8);
        ...
        erirec::comp_bra_hrr_electron_repulsion_pkxx(ket_spher_buffer_0_pksd, ket_spher_buffer_0_sksd, ket_spher_buffer_0_slsd, ab_x, ab_y, ab_z, 0, 2);
        ...
        erirec::comp_bra_hrr_electron_repulsion_dixx(ket_spher_buffer_0_disd, ket_spher_buffer_0_pisd, ket_spher_buffer_0_pksd, ab_x, ab_y, ab_z, 0, 2);
        ...
        erirec::comp_bra_hrr_electron_repulsion_fhxx(ket_spher_buffer_0_fhsd, ket_spher_buffer_0_dhsd, ket_spher_buffer_0_disd, ab_x, ab_y, ab_z, 0, 2);

        erirec::comp_bra_hrr_electron_repulsion_ggxx(ket_spher_buffer_0_ggsd, ket_spher_buffer_0_fgsd, ket_spher_buffer_0_fhsd, ab_x, ab_y, ab_z, 0, 2);

        t4cfunc::bra_transform<4, 4>(spher_buffer_0_ggsd, ket_spher_buffer_0_ggsd, 0, 2);

        t4cfunc::store_values(buffer, spher_buffer_0_ggsd, 405 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 4, 4, 0, 2, bra_indices, ket_indices);
}
