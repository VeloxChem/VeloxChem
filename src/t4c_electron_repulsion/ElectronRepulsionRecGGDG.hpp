...
/// Computes (GG|1/|r-r'||DG)  integrals for two GTOs pair blocks.
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> ket_spher_buffer_0_shdg(945, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_sidg(1260, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_skdg(1620, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_sldg(2025, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pgdg(2025, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_phdg(2835, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pidg(3780, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pkdg(4860, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dgdg(4050, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_dhdg(5670, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_didg(7560, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fgdg(6750, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_fhdg(9450, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_ggdg(10125, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_ggdg(3645, ket_dim);

    // allocate accumulation buffer for integrals

    CSimdArray<double> buffer(bra_dim * 3645, ket_dim);
    ...
    CSimdArray<double> bf_values(15, ket_pdim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        ket_spher_buffer_0_skdg.zero();

        ket_spher_buffer_0_sldg.zero();

        ket_spher_buffer_0_pgdg.zero();

        ket_spher_buffer_0_phdg.zero();

        ket_spher_buffer_0_pidg.zero();

        ket_spher_buffer_0_pkdg.zero();

        ket_spher_buffer_0_dgdg.zero();

        ket_spher_buffer_0_dhdg.zero();

        ket_spher_buffer_0_didg.zero();

        ket_spher_buffer_0_fgdg.zero();

        ket_spher_buffer_0_fhdg.zero();

        ket_spher_buffer_0_ggdg.zero();

        spher_buffer_0_ggdg.zero();
        ...
        t4cfunc::ket_transform<2, 4>(ket_spher_buffer_0_skdg, contr_buffer_0_skdg, 0, 7);

        t4cfunc::ket_transform<2, 4>(ket_spher_buffer_0_sldg, contr_buffer_0_sldg, 0, 8);
        ...
        erirec::comp_bra_hrr_electron_repulsion_pixx(ket_spher_buffer_0_pidg, ket_spher_buffer_0_sidg, ket_spher_buffer_0_skdg, ab_x, ab_y, ab_z, 2, 4);

        erirec::comp_bra_hrr_electron_repulsion_pkxx(ket_spher_buffer_0_pkdg, ket_spher_buffer_0_skdg, ket_spher_buffer_0_sldg, ab_x, ab_y, ab_z, 2, 4);
        ...
        erirec::comp_bra_hrr_electron_repulsion_dhxx(ket_spher_buffer_0_dhdg, ket_spher_buffer_0_phdg, ket_spher_buffer_0_pidg, ab_x, ab_y, ab_z, 2, 4);

        erirec::comp_bra_hrr_electron_repulsion_dixx(ket_spher_buffer_0_didg, ket_spher_buffer_0_pidg, ket_spher_buffer_0_pkdg, ab_x, ab_y, ab_z, 2, 4);

        erirec::comp_bra_hrr_electron_repulsion_fgxx(ket_spher_buffer_0_fgdg, ket_spher_buffer_0_dgdg, ket_spher_buffer_0_dhdg, ab_x, ab_y, ab_z, 2, 4);

        erirec::comp_bra_hrr_electron_repulsion_fhxx(ket_spher_buffer_0_fhdg, ket_spher_buffer_0_dhdg, ket_spher_buffer_0_didg, ab_x, ab_y, ab_z, 2, 4);

        erirec::comp_bra_hrr_electron_repulsion_ggxx(ket_spher_buffer_0_ggdg, ket_spher_buffer_0_fgdg, ket_spher_buffer_0_fhdg, ab_x, ab_y, ab_z, 2, 4);

        t4cfunc::bra_transform<4, 4>(spher_buffer_0_ggdg, ket_spher_buffer_0_ggdg, 2, 4);

        t4cfunc::store_values(buffer, spher_buffer_0_ggdg, 3645 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 4, 4, 2, 4, bra_indices, ket_indices);
}
