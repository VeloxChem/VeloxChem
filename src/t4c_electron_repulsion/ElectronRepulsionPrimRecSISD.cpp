...
{
    const auto ndims = prim_buffer_0_sisd.number_of_columns();
    ...
    /// Set up components of auxilary buffer : prim_buffer_0_shsd
    ...
    /// Set up components of auxilary buffer : prim_buffer_1_shsd

    auto g_0_xxxxx_0_xx_1 = prim_buffer_1_shsd[0];

    auto g_0_xxxxx_0_xy_1 = prim_buffer_1_shsd[1];

    auto g_0_xxxxx_0_xz_1 = prim_buffer_1_shsd[2];

    auto g_0_xxxxx_0_yy_1 = prim_buffer_1_shsd[3];

    auto g_0_xxxxx_0_yz_1 = prim_buffer_1_shsd[4];

    auto g_0_xxxxx_0_zz_1 = prim_buffer_1_shsd[5];

    auto g_0_xxxxy_0_xx_1 = prim_buffer_1_shsd[6];

    auto g_0_xxxxy_0_xy_1 = prim_buffer_1_shsd[7];

    auto g_0_xxxxy_0_xz_1 = prim_buffer_1_shsd[8];

    auto g_0_xxxxy_0_yy_1 = prim_buffer_1_shsd[9];

    auto g_0_xxxxz_0_xx_1 = prim_buffer_1_shsd[12];

    auto g_0_xxxxz_0_xy_1 = prim_buffer_1_shsd[13];

    auto g_0_xxxxz_0_xz_1 = prim_buffer_1_shsd[14];

    auto g_0_xxxxz_0_yz_1 = prim_buffer_1_shsd[16];

    auto g_0_xxxxz_0_zz_1 = prim_buffer_1_shsd[17];

    auto g_0_xxxyy_0_xx_1 = prim_buffer_1_shsd[18];

    auto g_0_xxxyy_0_xy_1 = prim_buffer_1_shsd[19];

    auto g_0_xxxyy_0_xz_1 = prim_buffer_1_shsd[20];

    auto g_0_xxxyy_0_yy_1 = prim_buffer_1_shsd[21];

    auto g_0_xxxyy_0_yz_1 = prim_buffer_1_shsd[22];

    auto g_0_xxxyy_0_zz_1 = prim_buffer_1_shsd[23];

    auto g_0_xxxzz_0_xx_1 = prim_buffer_1_shsd[30];

    auto g_0_xxxzz_0_xy_1 = prim_buffer_1_shsd[31];

    auto g_0_xxxzz_0_xz_1 = prim_buffer_1_shsd[32];

    auto g_0_xxxzz_0_yy_1 = prim_buffer_1_shsd[33];

    auto g_0_xxxzz_0_yz_1 = prim_buffer_1_shsd[34];

    auto g_0_xxxzz_0_zz_1 = prim_buffer_1_shsd[35];

    auto g_0_xxyyy_0_xx_1 = prim_buffer_1_shsd[36];

    auto g_0_xxyyy_0_xy_1 = prim_buffer_1_shsd[37];

    auto g_0_xxyyy_0_xz_1 = prim_buffer_1_shsd[38];

    auto g_0_xxyyy_0_yy_1 = prim_buffer_1_shsd[39];

    auto g_0_xxyyy_0_yz_1 = prim_buffer_1_shsd[40];

    auto g_0_xxyyy_0_zz_1 = prim_buffer_1_shsd[41];

    auto g_0_xxyyz_0_xy_1 = prim_buffer_1_shsd[43];

    auto g_0_xxyzz_0_xx_1 = prim_buffer_1_shsd[48];

    auto g_0_xxyzz_0_xz_1 = prim_buffer_1_shsd[50];

    auto g_0_xxzzz_0_xx_1 = prim_buffer_1_shsd[54];

    auto g_0_xxzzz_0_xy_1 = prim_buffer_1_shsd[55];

    auto g_0_xxzzz_0_xz_1 = prim_buffer_1_shsd[56];

    auto g_0_xxzzz_0_yy_1 = prim_buffer_1_shsd[57];

    auto g_0_xxzzz_0_yz_1 = prim_buffer_1_shsd[58];

    auto g_0_xxzzz_0_zz_1 = prim_buffer_1_shsd[59];

    auto g_0_xyyyy_0_xx_1 = prim_buffer_1_shsd[60];

    auto g_0_xyyyy_0_xy_1 = prim_buffer_1_shsd[61];

    auto g_0_xyyyy_0_yy_1 = prim_buffer_1_shsd[63];

    auto g_0_xyyyy_0_yz_1 = prim_buffer_1_shsd[64];

    auto g_0_xyyyy_0_zz_1 = prim_buffer_1_shsd[65];

    auto g_0_xyyzz_0_yy_1 = prim_buffer_1_shsd[75];

    auto g_0_xyyzz_0_yz_1 = prim_buffer_1_shsd[76];

    auto g_0_xyyzz_0_zz_1 = prim_buffer_1_shsd[77];

    auto g_0_xzzzz_0_xx_1 = prim_buffer_1_shsd[84];

    auto g_0_xzzzz_0_xz_1 = prim_buffer_1_shsd[86];

    auto g_0_xzzzz_0_yy_1 = prim_buffer_1_shsd[87];

    auto g_0_xzzzz_0_yz_1 = prim_buffer_1_shsd[88];

    auto g_0_xzzzz_0_zz_1 = prim_buffer_1_shsd[89];

    auto g_0_yyyyy_0_xx_1 = prim_buffer_1_shsd[90];

    auto g_0_yyyyy_0_xy_1 = prim_buffer_1_shsd[91];

    auto g_0_yyyyy_0_xz_1 = prim_buffer_1_shsd[92];

    auto g_0_yyyyy_0_yy_1 = prim_buffer_1_shsd[93];

    auto g_0_yyyyy_0_yz_1 = prim_buffer_1_shsd[94];

    auto g_0_yyyyy_0_zz_1 = prim_buffer_1_shsd[95];

    auto g_0_yyyyz_0_xy_1 = prim_buffer_1_shsd[97];

    auto g_0_yyyyz_0_xz_1 = prim_buffer_1_shsd[98];

    auto g_0_yyyyz_0_yy_1 = prim_buffer_1_shsd[99];

    auto g_0_yyyyz_0_yz_1 = prim_buffer_1_shsd[100];

    auto g_0_yyyyz_0_zz_1 = prim_buffer_1_shsd[101];

    auto g_0_yyyzz_0_xx_1 = prim_buffer_1_shsd[102];

    auto g_0_yyyzz_0_xy_1 = prim_buffer_1_shsd[103];

    auto g_0_yyyzz_0_xz_1 = prim_buffer_1_shsd[104];

    auto g_0_yyyzz_0_yy_1 = prim_buffer_1_shsd[105];

    auto g_0_yyyzz_0_yz_1 = prim_buffer_1_shsd[106];

    auto g_0_yyyzz_0_zz_1 = prim_buffer_1_shsd[107];

    auto g_0_yyzzz_0_xx_1 = prim_buffer_1_shsd[108];

    auto g_0_yyzzz_0_xy_1 = prim_buffer_1_shsd[109];

    auto g_0_yyzzz_0_xz_1 = prim_buffer_1_shsd[110];

    auto g_0_yyzzz_0_yy_1 = prim_buffer_1_shsd[111];

    auto g_0_yyzzz_0_yz_1 = prim_buffer_1_shsd[112];

    auto g_0_yyzzz_0_zz_1 = prim_buffer_1_shsd[113];

    auto g_0_yzzzz_0_xx_1 = prim_buffer_1_shsd[114];

    auto g_0_yzzzz_0_xy_1 = prim_buffer_1_shsd[115];

    auto g_0_yzzzz_0_xz_1 = prim_buffer_1_shsd[116];

    auto g_0_yzzzz_0_yy_1 = prim_buffer_1_shsd[117];

    auto g_0_yzzzz_0_yz_1 = prim_buffer_1_shsd[118];

    auto g_0_yzzzz_0_zz_1 = prim_buffer_1_shsd[119];

    auto g_0_zzzzz_0_xx_1 = prim_buffer_1_shsd[120];

    auto g_0_zzzzz_0_xy_1 = prim_buffer_1_shsd[121];

    auto g_0_zzzzz_0_xz_1 = prim_buffer_1_shsd[122];

    auto g_0_zzzzz_0_yy_1 = prim_buffer_1_shsd[123];

    auto g_0_zzzzz_0_yz_1 = prim_buffer_1_shsd[124];

    auto g_0_zzzzz_0_zz_1 = prim_buffer_1_shsd[125];

    /// Set up 0-6 components of targeted buffer : prim_buffer_0_sisd
    ...
    /// Set up 6-12 components of targeted buffer : prim_buffer_0_sisd

    auto g_0_xxxxxy_0_xx_0 = prim_buffer_0_sisd[6];

    auto g_0_xxxxxy_0_xy_0 = prim_buffer_0_sisd[7];

    auto g_0_xxxxxy_0_xz_0 = prim_buffer_0_sisd[8];

    auto g_0_xxxxxy_0_yy_0 = prim_buffer_0_sisd[9];

    auto g_0_xxxxxy_0_yz_0 = prim_buffer_0_sisd[10];

    auto g_0_xxxxxy_0_zz_0 = prim_buffer_0_sisd[11];
    ...
    /// Set up 12-18 components of targeted buffer : prim_buffer_0_sisd

    auto g_0_xxxxxz_0_xx_0 = prim_buffer_0_sisd[12];

    auto g_0_xxxxxz_0_xy_0 = prim_buffer_0_sisd[13];

    auto g_0_xxxxxz_0_xz_0 = prim_buffer_0_sisd[14];

    auto g_0_xxxxxz_0_yy_0 = prim_buffer_0_sisd[15];

    auto g_0_xxxxxz_0_yz_0 = prim_buffer_0_sisd[16];

    auto g_0_xxxxxz_0_zz_0 = prim_buffer_0_sisd[17];
    ...
    /// Set up 18-24 components of targeted buffer : prim_buffer_0_sisd
    ...
    /// Set up 24-30 components of targeted buffer : prim_buffer_0_sisd

    auto g_0_xxxxyz_0_xx_0 = prim_buffer_0_sisd[24];

    auto g_0_xxxxyz_0_xy_0 = prim_buffer_0_sisd[25];

    auto g_0_xxxxyz_0_xz_0 = prim_buffer_0_sisd[26];

    auto g_0_xxxxyz_0_yy_0 = prim_buffer_0_sisd[27];

    auto g_0_xxxxyz_0_yz_0 = prim_buffer_0_sisd[28];

    auto g_0_xxxxyz_0_zz_0 = prim_buffer_0_sisd[29];
    ...
    /// Set up 30-36 components of targeted buffer : prim_buffer_0_sisd
    ...
    /// Set up 36-42 components of targeted buffer : prim_buffer_0_sisd
    ...
    /// Set up 42-48 components of targeted buffer : prim_buffer_0_sisd

    auto g_0_xxxyyz_0_xx_0 = prim_buffer_0_sisd[42];

    auto g_0_xxxyyz_0_xy_0 = prim_buffer_0_sisd[43];

    auto g_0_xxxyyz_0_xz_0 = prim_buffer_0_sisd[44];

    auto g_0_xxxyyz_0_yy_0 = prim_buffer_0_sisd[45];

    auto g_0_xxxyyz_0_yz_0 = prim_buffer_0_sisd[46];

    auto g_0_xxxyyz_0_zz_0 = prim_buffer_0_sisd[47];
    ...
    /// Set up 48-54 components of targeted buffer : prim_buffer_0_sisd

    auto g_0_xxxyzz_0_xx_0 = prim_buffer_0_sisd[48];

    auto g_0_xxxyzz_0_xy_0 = prim_buffer_0_sisd[49];

    auto g_0_xxxyzz_0_xz_0 = prim_buffer_0_sisd[50];

    auto g_0_xxxyzz_0_yy_0 = prim_buffer_0_sisd[51];

    auto g_0_xxxyzz_0_yz_0 = prim_buffer_0_sisd[52];

    auto g_0_xxxyzz_0_zz_0 = prim_buffer_0_sisd[53];
    ...
    /// Set up 54-60 components of targeted buffer : prim_buffer_0_sisd
    ...
    /// Set up 60-66 components of targeted buffer : prim_buffer_0_sisd
    ...
    /// Set up 66-72 components of targeted buffer : prim_buffer_0_sisd

    auto g_0_xxyyyz_0_xx_0 = prim_buffer_0_sisd[66];

    auto g_0_xxyyyz_0_xy_0 = prim_buffer_0_sisd[67];

    auto g_0_xxyyyz_0_xz_0 = prim_buffer_0_sisd[68];

    auto g_0_xxyyyz_0_yy_0 = prim_buffer_0_sisd[69];

    auto g_0_xxyyyz_0_yz_0 = prim_buffer_0_sisd[70];

    auto g_0_xxyyyz_0_zz_0 = prim_buffer_0_sisd[71];
    ...
    /// Set up 72-78 components of targeted buffer : prim_buffer_0_sisd
    ...
    /// Set up 78-84 components of targeted buffer : prim_buffer_0_sisd

    auto g_0_xxyzzz_0_xx_0 = prim_buffer_0_sisd[78];

    auto g_0_xxyzzz_0_xy_0 = prim_buffer_0_sisd[79];

    auto g_0_xxyzzz_0_xz_0 = prim_buffer_0_sisd[80];

    auto g_0_xxyzzz_0_yy_0 = prim_buffer_0_sisd[81];

    auto g_0_xxyzzz_0_yz_0 = prim_buffer_0_sisd[82];

    auto g_0_xxyzzz_0_zz_0 = prim_buffer_0_sisd[83];
    ...
    /// Set up 84-90 components of targeted buffer : prim_buffer_0_sisd
    ...
    /// Set up 90-96 components of targeted buffer : prim_buffer_0_sisd

    auto g_0_xyyyyy_0_xx_0 = prim_buffer_0_sisd[90];

    auto g_0_xyyyyy_0_xy_0 = prim_buffer_0_sisd[91];

    auto g_0_xyyyyy_0_xz_0 = prim_buffer_0_sisd[92];
    ...
    /// Set up 96-102 components of targeted buffer : prim_buffer_0_sisd

    auto g_0_xyyyyz_0_xx_0 = prim_buffer_0_sisd[96];

    auto g_0_xyyyyz_0_xy_0 = prim_buffer_0_sisd[97];

    auto g_0_xyyyyz_0_xz_0 = prim_buffer_0_sisd[98];

    auto g_0_xyyyyz_0_yy_0 = prim_buffer_0_sisd[99];

    auto g_0_xyyyyz_0_yz_0 = prim_buffer_0_sisd[100];

    auto g_0_xyyyyz_0_zz_0 = prim_buffer_0_sisd[101];
    ...
    /// Set up 102-108 components of targeted buffer : prim_buffer_0_sisd

    auto g_0_xyyyzz_0_xx_0 = prim_buffer_0_sisd[102];

    auto g_0_xyyyzz_0_xy_0 = prim_buffer_0_sisd[103];

    auto g_0_xyyyzz_0_xz_0 = prim_buffer_0_sisd[104];
    ...
    /// Set up 108-114 components of targeted buffer : prim_buffer_0_sisd

    auto g_0_xyyzzz_0_xx_0 = prim_buffer_0_sisd[108];

    auto g_0_xyyzzz_0_xy_0 = prim_buffer_0_sisd[109];

    auto g_0_xyyzzz_0_xz_0 = prim_buffer_0_sisd[110];
    ...
    /// Set up 114-120 components of targeted buffer : prim_buffer_0_sisd

    auto g_0_xyzzzz_0_xx_0 = prim_buffer_0_sisd[114];

    auto g_0_xyzzzz_0_xy_0 = prim_buffer_0_sisd[115];

    auto g_0_xyzzzz_0_xz_0 = prim_buffer_0_sisd[116];

    auto g_0_xyzzzz_0_yy_0 = prim_buffer_0_sisd[117];

    auto g_0_xyzzzz_0_yz_0 = prim_buffer_0_sisd[118];

    auto g_0_xyzzzz_0_zz_0 = prim_buffer_0_sisd[119];
    ...
    /// Set up 120-126 components of targeted buffer : prim_buffer_0_sisd

    auto g_0_xzzzzz_0_xx_0 = prim_buffer_0_sisd[120];

    auto g_0_xzzzzz_0_xy_0 = prim_buffer_0_sisd[121];
    ...
    /// Set up 126-132 components of targeted buffer : prim_buffer_0_sisd
    ...
    /// Set up 132-138 components of targeted buffer : prim_buffer_0_sisd

    auto g_0_yyyyyz_0_xx_0 = prim_buffer_0_sisd[132];

    auto g_0_yyyyyz_0_xy_0 = prim_buffer_0_sisd[133];

    auto g_0_yyyyyz_0_xz_0 = prim_buffer_0_sisd[134];

    auto g_0_yyyyyz_0_yy_0 = prim_buffer_0_sisd[135];

    auto g_0_yyyyyz_0_yz_0 = prim_buffer_0_sisd[136];

    auto g_0_yyyyyz_0_zz_0 = prim_buffer_0_sisd[137];
    ...
    /// Set up 138-144 components of targeted buffer : prim_buffer_0_sisd
    ...
    /// Set up 144-150 components of targeted buffer : prim_buffer_0_sisd
    ...
    /// Set up 150-156 components of targeted buffer : prim_buffer_0_sisd
    ...
    /// Set up 156-162 components of targeted buffer : prim_buffer_0_sisd

    auto g_0_yzzzzz_0_xx_0 = prim_buffer_0_sisd[156];

    auto g_0_yzzzzz_0_xy_0 = prim_buffer_0_sisd[157];

    auto g_0_yzzzzz_0_xz_0 = prim_buffer_0_sisd[158];

    auto g_0_yzzzzz_0_yy_0 = prim_buffer_0_sisd[159];
    ...
    /// Set up 162-168 components of targeted buffer : prim_buffer_0_sisd
