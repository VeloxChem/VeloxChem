...
/// Computes (DD|1/|r-r'||FG)  integrals for two GTOs pair blocks.
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> ket_spher_buffer_0_pdfg(1134, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_pffg(1890, ket_dim);

    CSimdArray<double> ket_spher_buffer_0_ddfg(2268, ket_dim);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_ddfg(1575, ket_dim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        ket_spher_buffer_0_pdfg.zero();

        ket_spher_buffer_0_pffg.zero();

        ket_spher_buffer_0_ddfg.zero();

        spher_buffer_0_ddfg.zero();
        ...
        erirec::comp_bra_hrr_electron_repulsion_pdxx(ket_spher_buffer_0_pdfg, ket_spher_buffer_0_sdfg, ket_spher_buffer_0_sffg, ab_x, ab_y, ab_z, 3, 4);
        ...
        erirec::comp_bra_hrr_electron_repulsion_ddxx(ket_spher_buffer_0_ddfg, ket_spher_buffer_0_pdfg, ket_spher_buffer_0_pffg, ab_x, ab_y, ab_z, 3, 4);

        t4cfunc::bra_transform<2, 2>(spher_buffer_0_ddfg, ket_spher_buffer_0_ddfg, 3, 4);

        t4cfunc::store_values(buffer, spher_buffer_0_ddfg, 1575 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 2, 2, 3, 4, bra_indices, ket_indices);
}
