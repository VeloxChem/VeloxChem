#ifndef ElectronRepulsionRecPFPD_hpp
#define ElectronRepulsionRecPFPD_hpp
...
/// @brief Computes (PF|1/|r-r'||PD)  integrals for two basis function pairs blocks.
...
template <class T>
inline auto
comp_electron_repulsion_pfpd(T&                               distributor,
                             ...
                             const bool                       bra_eq_ket) -> void
{
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            t4cfunc::bra_transform<1, 3>(sbuffer, 0, skbuffer, 375, 1, 2);

            distributor.distribute(sbuffer, 0, a_indices, b_indices, c_indices, d_indices, 1, 3, 1, 2, j, ket_range, bra_eq_ket);
        }
    }
}
...
#endif /* ElectronRepulsionRecPFPD_hpp */
