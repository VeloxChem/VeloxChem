#ifndef ElectronRepulsionRecSDSD_hpp
#define ElectronRepulsionRecSDSD_hpp
...
template <class T>
auto
comp_electron_repulsion_sdsd(T* distributor,
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    CSimdArray<double> spher_buffer_0_sdsd(25, ket_dim);
    ...
    for (auto i = bra_indices[0]; i < bra_indices[1]; i++)
    {
        ...
        t4cfunc::store_values(buffer, spher_buffer_0_sdsd, 25 * (i - bra_indices[0]));
    }

    distributor->distribute(buffer, a_indices, b_indices, 0, 2, bra_indices, ket_indices);
}
                             ...
                             const std::array<int, 2>& ket_indices) -> void
{
    ...
    distributor->distribute(buffer, a_indices, b_indices, c_indices, d_indices, 0, 2, 0, 2, bra_indices, ket_indices);
}

} // erirec namespace

#endif /* ElectronRepulsionRecSDSD_hpp */
