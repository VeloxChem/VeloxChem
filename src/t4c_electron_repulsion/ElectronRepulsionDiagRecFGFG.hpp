...
template <class T>
auto
comp_diag_electron_repulsion_fgfg(T* distributor,
                                  ...
                                  const std::array<int, 2>& gto_indices) -> void
{
    ...
    CSimdArray<double> ket_spher_buffer_0_sgfg(945, 1);

    CSimdArray<double> ket_spher_buffer_0_shfg(1323, 1);

    CSimdArray<double> ket_spher_buffer_0_sifg(1764, 1);

    CSimdArray<double> ket_spher_buffer_0_skfg(2268, 1);

    CSimdArray<double> ket_spher_buffer_0_pgfg(2835, 1);

    CSimdArray<double> ket_spher_buffer_0_phfg(3969, 1);

    CSimdArray<double> ket_spher_buffer_0_pifg(5292, 1);

    CSimdArray<double> ket_spher_buffer_0_dgfg(5670, 1);

    CSimdArray<double> ket_spher_buffer_0_dhfg(7938, 1);

    CSimdArray<double> ket_spher_buffer_0_fgfg(9450, 1);

    // allocate aligned spherical integrals

    CSimdArray<double> spher_buffer_0_fgfg(3969, 1);
    ...
    CSimdArray<double> bf_values(15, npgtos);
    ...
    for (auto i = gto_indices[0]; i < gto_indices[1]; i++)
    {
        ...
        t4cfunc::update_max_values(max_values, spher_buffer_0_fgfg, i - gto_indices[0]); 
    }
