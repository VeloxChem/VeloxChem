...
auto
comp_prim_electron_repulsion_slsp(CSimdArray<double>& prim_buffer_0_slsp,
                                  ...
                                  const CSimdArray<double>& prim_buffer_0_sksp,
...
{
    const auto ndims = prim_buffer_0_slsp.number_of_columns();
    ...
    /// Set up components of auxilary buffer : prim_buffer_0_sksp
    ...
    auto g_0_xxxxxxy_0_x_1 = prim_buffer_1_sksp[3];

    auto g_0_xxxxxxy_0_y_1 = prim_buffer_1_sksp[4];

    auto g_0_xxxxxxz_0_x_1 = prim_buffer_1_sksp[6];
    ...
    auto g_0_xxxxyzz_0_x_1 = prim_buffer_1_sksp[24];
    ...
    auto g_0_xxxyyzz_0_x_1 = prim_buffer_1_sksp[36];

    auto g_0_xxxyyzz_0_y_1 = prim_buffer_1_sksp[37];

    auto g_0_xxxyyzz_0_z_1 = prim_buffer_1_sksp[38];

    auto g_0_xxxyzzz_0_x_1 = prim_buffer_1_sksp[39];
    ...
    auto g_0_xxyyyzz_0_x_1 = prim_buffer_1_sksp[51];

    auto g_0_xxyyyzz_0_y_1 = prim_buffer_1_sksp[52];

    auto g_0_xxyyyzz_0_z_1 = prim_buffer_1_sksp[53];

    auto g_0_xxyyzzz_0_x_1 = prim_buffer_1_sksp[54];

    auto g_0_xxyyzzz_0_y_1 = prim_buffer_1_sksp[55];

    auto g_0_xxyyzzz_0_z_1 = prim_buffer_1_sksp[56];

    auto g_0_xxyzzzz_0_x_1 = prim_buffer_1_sksp[57];
    ...
    auto g_0_xyyyyyy_0_x_1 = prim_buffer_1_sksp[63];

    auto g_0_xyyyyyy_0_y_1 = prim_buffer_1_sksp[64];

    auto g_0_xyyyyyy_0_z_1 = prim_buffer_1_sksp[65];

    auto g_0_xyyyyzz_0_y_1 = prim_buffer_1_sksp[70];

    auto g_0_xyyyyzz_0_z_1 = prim_buffer_1_sksp[71];

    auto g_0_xyyyzzz_0_y_1 = prim_buffer_1_sksp[73];

    auto g_0_xyyyzzz_0_z_1 = prim_buffer_1_sksp[74];

    auto g_0_xyyzzzz_0_y_1 = prim_buffer_1_sksp[76];

    auto g_0_xyyzzzz_0_z_1 = prim_buffer_1_sksp[77];

    auto g_0_xzzzzzz_0_x_1 = prim_buffer_1_sksp[81];

    auto g_0_xzzzzzz_0_y_1 = prim_buffer_1_sksp[82];
    ...
    auto g_0_yyyyyyz_0_y_1 = prim_buffer_1_sksp[88];
    ...
    auto g_0_yzzzzzz_0_x_1 = prim_buffer_1_sksp[102];
    ...
    /// Set up 0-3 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxxxxxxx_0_x_0 = prim_buffer_0_slsp[0];

    auto g_0_xxxxxxxx_0_y_0 = prim_buffer_0_slsp[1];

    auto g_0_xxxxxxxx_0_z_0 = prim_buffer_0_slsp[2];
    ...
    /// Set up 3-6 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxxxxxxy_0_x_0 = prim_buffer_0_slsp[3];

    auto g_0_xxxxxxxy_0_y_0 = prim_buffer_0_slsp[4];

    auto g_0_xxxxxxxy_0_z_0 = prim_buffer_0_slsp[5];
    ...
    /// Set up 6-9 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxxxxxxz_0_x_0 = prim_buffer_0_slsp[6];

    auto g_0_xxxxxxxz_0_y_0 = prim_buffer_0_slsp[7];

    auto g_0_xxxxxxxz_0_z_0 = prim_buffer_0_slsp[8];
    ...
    /// Set up 9-12 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxxxxxyy_0_x_0 = prim_buffer_0_slsp[9];

    auto g_0_xxxxxxyy_0_y_0 = prim_buffer_0_slsp[10];

    auto g_0_xxxxxxyy_0_z_0 = prim_buffer_0_slsp[11];
    ...
    /// Set up 12-15 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxxxxxyz_0_x_0 = prim_buffer_0_slsp[12];

    auto g_0_xxxxxxyz_0_y_0 = prim_buffer_0_slsp[13];

    auto g_0_xxxxxxyz_0_z_0 = prim_buffer_0_slsp[14];
    ...
    /// Set up 15-18 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxxxxxzz_0_x_0 = prim_buffer_0_slsp[15];

    auto g_0_xxxxxxzz_0_y_0 = prim_buffer_0_slsp[16];

    auto g_0_xxxxxxzz_0_z_0 = prim_buffer_0_slsp[17];
    ...
    /// Set up 18-21 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxxxxyyy_0_x_0 = prim_buffer_0_slsp[18];

    auto g_0_xxxxxyyy_0_y_0 = prim_buffer_0_slsp[19];

    auto g_0_xxxxxyyy_0_z_0 = prim_buffer_0_slsp[20];
    ...
    /// Set up 21-24 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxxxxyyz_0_x_0 = prim_buffer_0_slsp[21];

    auto g_0_xxxxxyyz_0_y_0 = prim_buffer_0_slsp[22];

    auto g_0_xxxxxyyz_0_z_0 = prim_buffer_0_slsp[23];
    ...
    /// Set up 24-27 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxxxxyzz_0_x_0 = prim_buffer_0_slsp[24];

    auto g_0_xxxxxyzz_0_y_0 = prim_buffer_0_slsp[25];

    auto g_0_xxxxxyzz_0_z_0 = prim_buffer_0_slsp[26];
    ...
    /// Set up 27-30 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxxxxzzz_0_x_0 = prim_buffer_0_slsp[27];

    auto g_0_xxxxxzzz_0_y_0 = prim_buffer_0_slsp[28];

    auto g_0_xxxxxzzz_0_z_0 = prim_buffer_0_slsp[29];
    ...
    /// Set up 30-33 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxxxyyyy_0_x_0 = prim_buffer_0_slsp[30];

    auto g_0_xxxxyyyy_0_y_0 = prim_buffer_0_slsp[31];

    auto g_0_xxxxyyyy_0_z_0 = prim_buffer_0_slsp[32];
    ...
    /// Set up 33-36 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxxxyyyz_0_x_0 = prim_buffer_0_slsp[33];

    auto g_0_xxxxyyyz_0_y_0 = prim_buffer_0_slsp[34];

    auto g_0_xxxxyyyz_0_z_0 = prim_buffer_0_slsp[35];
    ...
    /// Set up 36-39 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxxxyyzz_0_x_0 = prim_buffer_0_slsp[36];

    auto g_0_xxxxyyzz_0_y_0 = prim_buffer_0_slsp[37];

    auto g_0_xxxxyyzz_0_z_0 = prim_buffer_0_slsp[38];
    ...
    /// Set up 39-42 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxxxyzzz_0_x_0 = prim_buffer_0_slsp[39];

    auto g_0_xxxxyzzz_0_y_0 = prim_buffer_0_slsp[40];

    auto g_0_xxxxyzzz_0_z_0 = prim_buffer_0_slsp[41];
    ...
    /// Set up 42-45 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxxxzzzz_0_x_0 = prim_buffer_0_slsp[42];

    auto g_0_xxxxzzzz_0_y_0 = prim_buffer_0_slsp[43];

    auto g_0_xxxxzzzz_0_z_0 = prim_buffer_0_slsp[44];
    ...
    /// Set up 45-48 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxxyyyyy_0_x_0 = prim_buffer_0_slsp[45];

    auto g_0_xxxyyyyy_0_y_0 = prim_buffer_0_slsp[46];

    auto g_0_xxxyyyyy_0_z_0 = prim_buffer_0_slsp[47];
    ...
    /// Set up 48-51 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxxyyyyz_0_x_0 = prim_buffer_0_slsp[48];

    auto g_0_xxxyyyyz_0_y_0 = prim_buffer_0_slsp[49];

    auto g_0_xxxyyyyz_0_z_0 = prim_buffer_0_slsp[50];
    ...
    /// Set up 51-54 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxxyyyzz_0_x_0 = prim_buffer_0_slsp[51];

    auto g_0_xxxyyyzz_0_y_0 = prim_buffer_0_slsp[52];

    auto g_0_xxxyyyzz_0_z_0 = prim_buffer_0_slsp[53];
    ...
    /// Set up 54-57 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxxyyzzz_0_x_0 = prim_buffer_0_slsp[54];

    auto g_0_xxxyyzzz_0_y_0 = prim_buffer_0_slsp[55];

    auto g_0_xxxyyzzz_0_z_0 = prim_buffer_0_slsp[56];
    ...
    /// Set up 57-60 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxxyzzzz_0_x_0 = prim_buffer_0_slsp[57];

    auto g_0_xxxyzzzz_0_y_0 = prim_buffer_0_slsp[58];

    auto g_0_xxxyzzzz_0_z_0 = prim_buffer_0_slsp[59];
    ...
    /// Set up 60-63 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxxzzzzz_0_x_0 = prim_buffer_0_slsp[60];

    auto g_0_xxxzzzzz_0_y_0 = prim_buffer_0_slsp[61];

    auto g_0_xxxzzzzz_0_z_0 = prim_buffer_0_slsp[62];
    ...
    /// Set up 63-66 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxyyyyyy_0_x_0 = prim_buffer_0_slsp[63];

    auto g_0_xxyyyyyy_0_y_0 = prim_buffer_0_slsp[64];

    auto g_0_xxyyyyyy_0_z_0 = prim_buffer_0_slsp[65];
    ...
    /// Set up 66-69 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxyyyyyz_0_x_0 = prim_buffer_0_slsp[66];

    auto g_0_xxyyyyyz_0_y_0 = prim_buffer_0_slsp[67];

    auto g_0_xxyyyyyz_0_z_0 = prim_buffer_0_slsp[68];
    ...
    /// Set up 69-72 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxyyyyzz_0_x_0 = prim_buffer_0_slsp[69];

    auto g_0_xxyyyyzz_0_y_0 = prim_buffer_0_slsp[70];

    auto g_0_xxyyyyzz_0_z_0 = prim_buffer_0_slsp[71];
    ...
    /// Set up 72-75 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxyyyzzz_0_x_0 = prim_buffer_0_slsp[72];

    auto g_0_xxyyyzzz_0_y_0 = prim_buffer_0_slsp[73];

    auto g_0_xxyyyzzz_0_z_0 = prim_buffer_0_slsp[74];
    ...
    /// Set up 75-78 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxyyzzzz_0_x_0 = prim_buffer_0_slsp[75];

    auto g_0_xxyyzzzz_0_y_0 = prim_buffer_0_slsp[76];

    auto g_0_xxyyzzzz_0_z_0 = prim_buffer_0_slsp[77];
    ...
    /// Set up 78-81 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxyzzzzz_0_x_0 = prim_buffer_0_slsp[78];

    auto g_0_xxyzzzzz_0_y_0 = prim_buffer_0_slsp[79];

    auto g_0_xxyzzzzz_0_z_0 = prim_buffer_0_slsp[80];
    ...
    /// Set up 81-84 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xxzzzzzz_0_x_0 = prim_buffer_0_slsp[81];

    auto g_0_xxzzzzzz_0_y_0 = prim_buffer_0_slsp[82];

    auto g_0_xxzzzzzz_0_z_0 = prim_buffer_0_slsp[83];
    ...
    /// Set up 84-87 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xyyyyyyy_0_x_0 = prim_buffer_0_slsp[84];

    auto g_0_xyyyyyyy_0_y_0 = prim_buffer_0_slsp[85];

    auto g_0_xyyyyyyy_0_z_0 = prim_buffer_0_slsp[86];
    ...
    /// Set up 87-90 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xyyyyyyz_0_x_0 = prim_buffer_0_slsp[87];

    auto g_0_xyyyyyyz_0_y_0 = prim_buffer_0_slsp[88];

    auto g_0_xyyyyyyz_0_z_0 = prim_buffer_0_slsp[89];
    ...
    /// Set up 90-93 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xyyyyyzz_0_x_0 = prim_buffer_0_slsp[90];

    auto g_0_xyyyyyzz_0_y_0 = prim_buffer_0_slsp[91];

    auto g_0_xyyyyyzz_0_z_0 = prim_buffer_0_slsp[92];
    ...
    /// Set up 93-96 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xyyyyzzz_0_x_0 = prim_buffer_0_slsp[93];

    auto g_0_xyyyyzzz_0_y_0 = prim_buffer_0_slsp[94];

    auto g_0_xyyyyzzz_0_z_0 = prim_buffer_0_slsp[95];
    ...
    /// Set up 96-99 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xyyyzzzz_0_x_0 = prim_buffer_0_slsp[96];

    auto g_0_xyyyzzzz_0_y_0 = prim_buffer_0_slsp[97];

    auto g_0_xyyyzzzz_0_z_0 = prim_buffer_0_slsp[98];
    ...
    /// Set up 99-102 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xyyzzzzz_0_x_0 = prim_buffer_0_slsp[99];

    auto g_0_xyyzzzzz_0_y_0 = prim_buffer_0_slsp[100];

    auto g_0_xyyzzzzz_0_z_0 = prim_buffer_0_slsp[101];
    ...
    /// Set up 102-105 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xyzzzzzz_0_x_0 = prim_buffer_0_slsp[102];

    auto g_0_xyzzzzzz_0_y_0 = prim_buffer_0_slsp[103];

    auto g_0_xyzzzzzz_0_z_0 = prim_buffer_0_slsp[104];
    ...
    /// Set up 105-108 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_xzzzzzzz_0_x_0 = prim_buffer_0_slsp[105];

    auto g_0_xzzzzzzz_0_y_0 = prim_buffer_0_slsp[106];

    auto g_0_xzzzzzzz_0_z_0 = prim_buffer_0_slsp[107];
    ...
    /// Set up 108-111 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_yyyyyyyy_0_x_0 = prim_buffer_0_slsp[108];

    auto g_0_yyyyyyyy_0_y_0 = prim_buffer_0_slsp[109];

    auto g_0_yyyyyyyy_0_z_0 = prim_buffer_0_slsp[110];
    ...
    /// Set up 111-114 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_yyyyyyyz_0_x_0 = prim_buffer_0_slsp[111];

    auto g_0_yyyyyyyz_0_y_0 = prim_buffer_0_slsp[112];

    auto g_0_yyyyyyyz_0_z_0 = prim_buffer_0_slsp[113];
    ...
    /// Set up 114-117 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_yyyyyyzz_0_x_0 = prim_buffer_0_slsp[114];

    auto g_0_yyyyyyzz_0_y_0 = prim_buffer_0_slsp[115];

    auto g_0_yyyyyyzz_0_z_0 = prim_buffer_0_slsp[116];
    ...
    /// Set up 117-120 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_yyyyyzzz_0_x_0 = prim_buffer_0_slsp[117];

    auto g_0_yyyyyzzz_0_y_0 = prim_buffer_0_slsp[118];

    auto g_0_yyyyyzzz_0_z_0 = prim_buffer_0_slsp[119];
    ...
    /// Set up 120-123 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_yyyyzzzz_0_x_0 = prim_buffer_0_slsp[120];

    auto g_0_yyyyzzzz_0_y_0 = prim_buffer_0_slsp[121];

    auto g_0_yyyyzzzz_0_z_0 = prim_buffer_0_slsp[122];
    ...
    /// Set up 123-126 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_yyyzzzzz_0_x_0 = prim_buffer_0_slsp[123];

    auto g_0_yyyzzzzz_0_y_0 = prim_buffer_0_slsp[124];

    auto g_0_yyyzzzzz_0_z_0 = prim_buffer_0_slsp[125];
    ...
    /// Set up 126-129 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_yyzzzzzz_0_x_0 = prim_buffer_0_slsp[126];

    auto g_0_yyzzzzzz_0_y_0 = prim_buffer_0_slsp[127];

    auto g_0_yyzzzzzz_0_z_0 = prim_buffer_0_slsp[128];
    ...
    /// Set up 129-132 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_yzzzzzzz_0_x_0 = prim_buffer_0_slsp[129];

    auto g_0_yzzzzzzz_0_y_0 = prim_buffer_0_slsp[130];

    auto g_0_yzzzzzzz_0_z_0 = prim_buffer_0_slsp[131];
    ...
    /// Set up 132-135 components of targeted buffer : prim_buffer_0_slsp

    auto g_0_zzzzzzzz_0_x_0 = prim_buffer_0_slsp[132];

    auto g_0_zzzzzzzz_0_y_0 = prim_buffer_0_slsp[133];

    auto g_0_zzzzzzzz_0_z_0 = prim_buffer_0_slsp[134];
