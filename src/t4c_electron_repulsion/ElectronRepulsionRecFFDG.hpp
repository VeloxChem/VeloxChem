                             ...
                             const bool bra_eq_ket) -> void
{
    ...
    for (size_t i = 0; i < ket_blocks; i++)
    {
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            erirec::comp_ket_hrr_electron_repulsion_xxdg(ckbuffer, 12132, 9108, 10368, cfactors, 6, 0, 6);
            ...
            t4cfunc::ket_transform<2, 4>(skbuffer, 2070, ckbuffer, 12132, 0, 6);
            ...
            distributor.distribute(sbuffer, 0, a_indices, b_indices, c_indices, d_indices, 3, 3, 2, 4, j, ket_range, bra_eq_ket);
        }
    }
