#ifndef ThreeCenterOverlapGeom001SumRecFP_hpp
#define ThreeCenterOverlapGeom001SumRecFP_hpp
...
/// @brief Computes (F|G(r)|d^(1)/dB^(1)P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_geom_01_fp(T& distributor,
                            ...
                            const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(261, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3ovlrec::comp_prim_overlap_fd(pbuffer, 111, 23, 47, 65, factors, 11, a_exp, exgtos[l]);

                    t2cgeom::comp_geom_deriv_0x1_fp(pbuffer, 171, 101, 111, factors, 1);

                    t2cfunc::reduce(cbuffer, pbuffer, 171, ket_width, ket_npgtos);
                }
            }
...
#endif /* ThreeCenterOverlapGeom001SumRecFP_hpp */
