#ifndef ThreeCenterOverlapGeom001SumRecPF_hpp
#define ThreeCenterOverlapGeom001SumRecPF_hpp
...
/// @brief Computes (P|G(r)|d^(1)/dB^(1)F)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_geom_01_pf(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3ovlrec::comp_prim_overlap_pg(pbuffer, 54, 11, 21, factors, 11, a_exp, exgtos[l]);

                    t2cgeom::comp_geom_deriv_0x1_pf(pbuffer, 99, 36, 54, factors, 1);
...
#endif /* ThreeCenterOverlapGeom001SumRecPF_hpp */
