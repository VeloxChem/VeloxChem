#ifndef ThreeCenterOverlapGeom001SumRecPD_hpp
#define ThreeCenterOverlapGeom001SumRecPD_hpp
...
/// @brief Computes (P|G(r)|d^(1)/dB^(1)D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_geom_01_pd(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3ovlrec::comp_prim_overlap_pf(pbuffer, 30, 5, 11, factors, 11, a_exp, exgtos[l]);

                    t2cgeom::comp_geom_deriv_0x1_pd(pbuffer, 60, 21, 30, factors, 1);
...
#endif /* ThreeCenterOverlapGeom001SumRecPD_hpp */
