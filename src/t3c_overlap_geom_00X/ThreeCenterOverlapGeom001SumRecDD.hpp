#ifndef ThreeCenterOverlapGeom001SumRecDD_hpp
#define ThreeCenterOverlapGeom001SumRecDD_hpp
...
/// @brief Computes (D|G(r)|d^(1)/dB^(1)D)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_geom_01_dd(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3ovlrec::comp_prim_overlap_df(pbuffer, 99, 11, 33, 51, factors, 11, a_exp, exgtos[l]);

                    t2cgeom::comp_geom_deriv_0x1_dd(pbuffer, 159, 81, 99, factors, 1);
...
#endif /* ThreeCenterOverlapGeom001SumRecDD_hpp */
