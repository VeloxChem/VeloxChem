#ifndef ThreeCenterOverlapGeom001SumRecGP_hpp
#define ThreeCenterOverlapGeom001SumRecGP_hpp
...
/// @brief Computes (G|G(r)|d^(1)/dB^(1)P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_geom_01_gp(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3ovlrec::comp_prim_overlap_gd(pbuffer, 216, 65, 111, 141, factors, 11, a_exp, exgtos[l]);

                    t2cgeom::comp_geom_deriv_0x1_gp(pbuffer, 306, 201, 216, factors, 1);

                    t2cfunc::reduce(cbuffer, pbuffer, 306, ket_width, ket_npgtos);
                }
            }
...
#endif /* ThreeCenterOverlapGeom001SumRecGP_hpp */
