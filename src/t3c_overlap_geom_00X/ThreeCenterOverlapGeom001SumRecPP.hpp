#ifndef ThreeCenterOverlapGeom001SumRecPP_hpp
#define ThreeCenterOverlapGeom001SumRecPP_hpp
...
/// @brief Computes (P|G(r)|d^(1)/dB^(1)P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_geom_01_pp(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3ovlrec::comp_prim_overlap_pd(pbuffer, 14, 2, 5, factors, 11, a_exp, exgtos[l]);

                    t2cgeom::comp_geom_deriv_0x1_pp(pbuffer, 32, 11, 14, factors, 1);
...
#endif /* ThreeCenterOverlapGeom001SumRecPP_hpp */
