#ifndef ThreeCenterOverlapGeom001SumRecPG_hpp
#define ThreeCenterOverlapGeom001SumRecPG_hpp
...
/// @brief Computes (P|G(r)|d^(1)/dB^(1)G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_geom_01_pg(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3ovlrec::comp_prim_overlap_pf(pbuffer, 57, 5, 11, factors, 11, a_exp, exgtos[l]);

                    t3ovlrec::comp_prim_overlap_ph(pbuffer, 87, 21, 36, factors, 11, a_exp, exgtos[l]);

                    t2cgeom::comp_geom_deriv_0x1_pg(pbuffer, 150, 57, 87, factors, 1);
...
#endif /* ThreeCenterOverlapGeom001SumRecPG_hpp */
