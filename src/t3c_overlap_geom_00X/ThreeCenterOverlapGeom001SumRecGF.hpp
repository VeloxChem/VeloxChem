#ifndef ThreeCenterOverlapGeom001SumRecGF_hpp
#define ThreeCenterOverlapGeom001SumRecGF_hpp
...
/// @brief Computes (G|G(r)|d^(1)/dB^(1)F)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_geom_01_gf(T& distributor,
                            ...
                            const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(1456, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3ovlrec::comp_prim_overlap_gg(pbuffer, 781, 261, 441, 541, factors, 11, a_exp, exgtos[l]);

                    t2cgeom::comp_geom_deriv_0x1_gf(pbuffer, 1006, 691, 781, factors, 1);

                    t2cfunc::reduce(cbuffer, pbuffer, 1006, ket_width, ket_npgtos);
                }
            }
...
#endif /* ThreeCenterOverlapGeom001SumRecGF_hpp */
