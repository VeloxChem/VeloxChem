#ifndef ThreeCenterOverlapGeom001SumRecDP_hpp
#define ThreeCenterOverlapGeom001SumRecDP_hpp
...
/// @brief Computes (D|G(r)|d^(1)/dB^(1)P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_geom_01_dp(T& distributor,
                            ...
                            const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(137, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3ovlrec::comp_prim_overlap_dd(pbuffer, 47, 5, 14, 23, factors, 11, a_exp, exgtos[l]);

                    t2cgeom::comp_geom_deriv_0x1_dp(pbuffer, 83, 41, 47, factors, 1);
...
#endif /* ThreeCenterOverlapGeom001SumRecDP_hpp */
