#ifndef ThreeCenterOverlapGeom001SumRecDS_hpp
#define ThreeCenterOverlapGeom001SumRecDS_hpp
...
/// @brief Computes (D|G(r)|d^(1)/dB^(1)S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_overlap_geom_01_ds(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t2cgeom::comp_geom_deriv_0x1_ds(pbuffer, 35, 17, factors, 1);
...
#endif /* ThreeCenterOverlapGeom001SumRecDS_hpp */
