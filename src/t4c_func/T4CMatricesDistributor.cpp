            ...
            for (size_t i = 0; i < keys.size(); i++)
            {
                ...
                if (density->get_type() == mat_t::symmetric)
                {
                    if (_labels[i] == "2jk")
                    {
                        ...
                        {
                            t4cfunc::distribute_rest_jk(fock,
                                                        density,
                                                        buffer,
                                                        offset,
                                                        a_indices,
                    ...
                    if (_labels[i] == "2jkx")
                    {
                        ...
                        for (int j = bra_range[0]; j < bra_range[1]; j++)
                        {
                            t4cfunc::distribute_rest_jkx(fock,
                                                         density,
                                                         buffer,
                                                         offset,
                                                         _exchange_factors[i],
                    ...
                    if (_labels[i] == "j")
                    {
                        ...
                        for (int j = bra_range[0]; j < bra_range[1]; j++)
                        {
                            t4cfunc::distribute_rest_j(fock,
                                                       density,
                                                       buffer,
                                                       offset,
                                                       a_indices,
                    ...
                    if (_labels[i] == "k")
                    {
                        ...
                        for (int j = bra_range[0]; j < bra_range[1]; j++)
                        {
                            t4cfunc::distribute_rest_k(fock,
                                                       density,
                                                       buffer,
                                                       offset,
                                                       a_indices,
                    ...
                    if (_labels[i] == "kx")
                    {
                        ...
                        for (int j = bra_range[0]; j < bra_range[1]; j++)
                        {
                            t4cfunc::distribute_rest_kx(fock,
                                                        density,
                                                        buffer,
                                                        offset,
                                                        _exchange_factors[i],
                ...
                if (density->get_type() == mat_t::general)
                {
                    if (_labels[i] == "2jk")
                    {
                        ...
                        for (int j = bra_range[0]; j < bra_range[1]; j++)
                        {
                            t4cfunc::distribute_rest_gen_jk(fock,
                                                            density,
                                                            buffer,
                                                            offset,
                                                            a_indices,
                    ...
                    if (_labels[i] == "2jkx")
                    {
                        ...
                        for (int j = bra_range[0]; j < bra_range[1]; j++)
                        {
                            t4cfunc::distribute_rest_gen_jkx(fock,
                                                             density,
                                                             buffer,
                                                             offset,
                                                             _exchange_factors[i],
                    ...
                    if (_labels[i] == "j")
                    {
                        ...
                        for (int j = bra_range[0]; j < bra_range[1]; j++)
                        {
                            t4cfunc::distribute_rest_gen_j(fock,
                                                           density,
                                                           buffer,
                                                           offset,
                                                           a_indices,
                    ...
                    if (_labels[i] == "k")
                    {
                        ...
                        for (int j = bra_range[0]; j < bra_range[1]; j++)
                        {
                            t4cfunc::distribute_rest_gen_k(fock,
                                                           density,
                                                           buffer,
                                                           offset,
                                                           a_indices,
                    ...
                    if (_labels[i] == "kx")
                    {
                        ...
                        for (int j = bra_range[0]; j < bra_range[1]; j++)
                        {
                            t4cfunc::distribute_rest_gen_kx(fock,
                                                            density,
                                                            buffer,
                                                            offset,
                                                            _exchange_factors[i],
