...
auto distribute_rest_jk(CMatrix*                  fock,
...
/// - Parameter ket_indices: the index of the range [ket_first, ket_last) of GTOs on ket side.
/// - Parameter diagonal: the flag indicating to use block diagonal distribution pattern of  integrals.
auto distribute_rest_jkx(CMatrix*                  fock,
                         const CMatrix*            density,
                         const CSimdArray<double>& buffer,
                         const int                 offset,
                         const double              factor,
...
/// - Parameter ket_indices: the index of the range [ket_first, ket_last) of GTOs on ket side.
/// - Parameter diagonal: the flag indicating to use block diagonal distribution pattern of  integrals.
auto distribute_rest_j(CMatrix*                  fock,
                       const CMatrix*            density,
                       const CSimdArray<double>& buffer,
                       const int                 offset,
                       const std::vector<int>&   a_indices,
...
/// - Parameter ket_indices: the index of the range [ket_first, ket_last) of GTOs on ket side.
/// - Parameter diagonal: the flag indicating to use block diagonal distribution pattern of  integrals.
auto distribute_rest_k(CMatrix*                  fock,
                       const CMatrix*            density,
                       const CSimdArray<double>& buffer,
                       const int                 offset,
                       const std::vector<int>&   a_indices,
...
/// - Parameter ket_indices: the index of the range [ket_first, ket_last) of GTOs on ket side.
/// - Parameter diagonal: the flag indicating to use block diagonal distribution pattern of  integrals.
auto distribute_rest_kx(CMatrix*                  fock,
                        const CMatrix*            density,
                        const CSimdArray<double>& buffer,
                        const int                 offset,
                        const double              factor,
...
/// - Parameter ket_indices: the index of the range [ket_first, ket_last) of GTOs on ket side.
/// - Parameter diagonal: the flag indicating to use block diagonal distribution pattern of  integrals.
auto distribute_rest_gen_j(CMatrix*                  fock,
                           const CMatrix*            density,
                           const CSimdArray<double>& buffer,
                           const int                 offset,
                           const std::vector<int>&   a_indices,
...
/// - Parameter ket_indices: the index of the range [ket_first, ket_last) of GTOs on ket side.
/// - Parameter diagonal: the flag indicating to use block diagonal distribution pattern of  integrals.
auto distribute_rest_gen_k(CMatrix*                  fock,
                           const CMatrix*            density,
                           const CSimdArray<double>& buffer,
                           const int                 offset,
                           const std::vector<int>&   a_indices,
...
/// - Parameter ket_indices: the index of the range [ket_first, ket_last) of GTOs on ket side.
/// - Parameter diagonal: the flag indicating to use block diagonal distribution pattern of  integrals.
auto distribute_rest_gen_kx(CMatrix*                  fock,
                            const CMatrix*            density,
                            const CSimdArray<double>& buffer,
                            const int                 offset,
                            const double              factor,
...
/// - Parameter ket_indices: the index of the range [ket_first, ket_last) of GTOs on ket side.
/// - Parameter diagonal: the flag indicating to use block diagonal distribution pattern of  integrals.
auto distribute_rest_gen_jk(CMatrix*                  fock,
                            const CMatrix*            density,
                            const CSimdArray<double>& buffer,
                            const int                 offset,
                            const std::vector<int>&   a_indices,
...
/// - Parameter ket_indices: the index of the range [ket_first, ket_last) of GTOs on ket side.
/// - Parameter diagonal: the flag indicating to use block diagonal distribution pattern of  integrals.
auto distribute_rest_gen_jkx(CMatrix*                  fock,
                             const CMatrix*            density,
                             const CSimdArray<double>& buffer,
                             const int                 offset,
                             const double              factor,
