...
/// - Parameter focks : the local Fock matrices.
...
/// - Parameter a_loc_indices: the compressed local contracted GTOs indexes on center A.
/// - Parameter b_loc_indices: the compressed local contracted GTOs indexes on center B.
/// - Parameter c_loc_indices: the compressed local contracted GTOs indexes on center C.
/// - Parameter d_loc_indices: the compressed local contracted GTOs indexes on center D.
