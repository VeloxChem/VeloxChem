#ifndef ExpGeom1110Driver_hpp
#define ExpGeom1110Driver_hpp
 ...
 */
class CExpGeom1110Driver
{
   public:
    /**
     Creates a Fock matrices  driver.
     */
    CExpGeom1110Driver() = default;
...
#pragma omp task firstprivate(i)
                            {
                                for (const auto& task : ptr_work_groups[i])
                                {
                                    ...
                                    eri_g1110::compute(distributor, bra_gto_pair_block, ket_gto_pair_block, {task[4], task[5]}, {task[6], task[7]});
                                }
                            }
                        }
                    }
