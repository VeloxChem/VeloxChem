#ifndef ExpGeom1010Driver_hpp
#define ExpGeom1010Driver_hpp

#include <vector>

#include "EriGeom1010Func.hpp"
...
/**
 Class CExpGeom1010Driver provides methods for computing Fock matrices
 using four center electron repulsion integrals..

 @author Z. Rinkevicius
 */
class CExpGeom1010Driver
{
   public:
    /**
     Creates a Fock matrices  driver.
     */
    CExpGeom1010Driver() = default;
...
#pragma omp task firstprivate(i)
                            {
                                for (const auto& task : ptr_work_groups[i])
                                {
                                    ...
                                    eri_g1010::compute(distributor, bra_gto_pair_block, ket_gto_pair_block, {task[4], task[5]}, {task[6], task[7]});
                                }
                            }
                        }
                    }
