...
#pragma omp task firstprivate(i)
                {
                        ...
                        for (int k = 0; k < bra_tasks; k++)
                        {
                            ...
                            for (int l = k; l < bra_tasks; l++)
                            {
                                if (l == k)
                                {
                                    ...
                                    //std::cout << "Diagonal term: " << bra_first << " , " << bra_last << " for " << gto_pair_block.angular_momentums()[0] << " , " <<  gto_pair_block.angular_momentums()[1] << " Index : " << wtask[0] << " , " << wtask[1] << " , " << wtask[2] << " , " << wtask[3]  << std::endl;
                                }
                                else
                                {
                                   ...
                                   // std::cout << "Diagonal off-term : " << bra_first << " , " << bra_last << " , " << ket_first << " , " << ket_last <<  " for " << gto_pair_block.angular_momentums()[0] << " , " <<  gto_pair_block.angular_momentums()[1] << " , "  << gto_pair_block.angular_momentums()[0] << " , " <<  gto_pair_block.angular_momentums()[1] << " Index : " << wtask[0] << " , " << wtask[1] << " , " << wtask[2] << " , " << wtask[3]  << std::endl;
                                    
                                    erifunc::compute<CT4COrderedMatrixDistributor>(&distributor, gto_pair_block, gto_pair_block,
                                                                                   {bra_first, bra_last}, {ket_first, ket_last});
                                }
                            }
                        }
                    ...
                    else
                    {
                        ...
                        auto distributor = CT4COrderedMatrixDistributor(ptr_fock, ptr_density, bra_gto_pair_block, ket_gto_pair_block, label, exchange_factor);
                        ...
                        for (int k = 0; k < bra_tasks; k++)
                        {
                            ...
                            for (int l = 0; l < ket_tasks; l++)
                            {
                                ...
                                // std::cout << "Off-Diagonal term : " << bra_first << " , " << bra_last << " , " << ket_first << " , " << ket_last << " for " << bra_gto_pair_block.angular_momentums()[0] << " , " <<  bra_gto_pair_block.angular_momentums()[1] << " , "  << ket_gto_pair_block.angular_momentums()[0] << " , " <<  ket_gto_pair_block.angular_momentums()[1] << " Index : " << wtask[0] << " , " << wtask[1]  << " , " << wtask[2] << " , " << wtask[3] <<  std::endl;
                                
                                erifunc::compute<CT4COrderedMatrixDistributor>(&distributor, bra_gto_pair_block, ket_gto_pair_block,
                                                                               {bra_first, bra_last}, {ket_first, ket_last});
                            }
                        }
