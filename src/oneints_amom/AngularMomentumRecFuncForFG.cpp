...
namespace amomrecfunc { // amomrecfunc namespace
    ...
    {
        amomrecfunc::compAngularMomentumForFG_0_50(primBuffer,
                                                   recursionMap,
                                                   osFactors,
                                                   paDistances, 
                                                   braGtoBlock,
        ...
        amomrecfunc::compAngularMomentumForFG_50_100(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
        ...
        amomrecfunc::compAngularMomentumForFG_100_150(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      paDistances, 
                                                      braGtoBlock,
        ...
        amomrecfunc::compAngularMomentumForFG_150_200(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      paDistances, 
                                                      braGtoBlock,
        ...
        amomrecfunc::compAngularMomentumForFG_200_250(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      paDistances, 
                                                      braGtoBlock,
        ...
        amomrecfunc::compAngularMomentumForFG_250_300(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      paDistances, 
                                                      braGtoBlock,
        ...
        amomrecfunc::compAngularMomentumForFG_300_350(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      paDistances, 
                                                      braGtoBlock,
        ...
        amomrecfunc::compAngularMomentumForFG_350_400(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      paDistances, 
                                                      braGtoBlock,
        ...
        amomrecfunc::compAngularMomentumForFG_400_450(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      paDistances, 
                                                      braGtoBlock,
                                  ...
                                  const int32_t              iContrGto)
    {
        ...
        auto pidx_p_2_4_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Linear Momentum"}, 1, true, 
                                                         {2, -1, -1, -1}, {4, -1, -1, -1}, 
                                                         1, 1, 0));
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tly_xxx_xxxx_0[j] = pa_x[j] * tly_xx_xxxx_0[j] + fl1_fx * tly_x_xxxx_0[j] + 2.0 * fl1_fx * tly_xx_xxx_0[j] + 0.5 * fl1_fx * tpz_xx_xxxx_0[j] + fl1_fx * fl1_fgb * tdz_xx_xxxx_0[j];

                tlz_xxx_xxxx_0[j] = pa_x[j] * tlz_xx_xxxx_0[j] + fl1_fx * tlz_x_xxxx_0[j] + 2.0 * fl1_fx * tlz_xx_xxx_0[j] - 0.5 * fl1_fx * tpy_xx_xxxx_0[j] - fl1_fx * fl1_fgb * tdy_xx_xxxx_0[j];

                tlx_xxx_xxxy_0[j] = pa_x[j] * tlx_xx_xxxy_0[j] + fl1_fx * tlx_x_xxxy_0[j] + 1.5 * fl1_fx * tlx_xx_xxy_0[j];

                tly_xxx_xxxy_0[j] = pa_x[j] * tly_xx_xxxy_0[j] + fl1_fx * tly_x_xxxy_0[j] + 1.5 * fl1_fx * tly_xx_xxy_0[j] + 0.5 * fl1_fx * tpz_xx_xxxy_0[j] + fl1_fx * fl1_fgb * tdz_xx_xxxy_0[j];

                tlz_xxx_xxxy_0[j] = pa_x[j] * tlz_xx_xxxy_0[j] + fl1_fx * tlz_x_xxxy_0[j] + 1.5 * fl1_fx * tlz_xx_xxy_0[j] - 0.5 * fl1_fx * tpy_xx_xxxy_0[j] - fl1_fx * fl1_fgb * tdy_xx_xxxy_0[j];

                tlx_xxx_xxxz_0[j] = pa_x[j] * tlx_xx_xxxz_0[j] + fl1_fx * tlx_x_xxxz_0[j] + 1.5 * fl1_fx * tlx_xx_xxz_0[j];

                tly_xxx_xxxz_0[j] = pa_x[j] * tly_xx_xxxz_0[j] + fl1_fx * tly_x_xxxz_0[j] + 1.5 * fl1_fx * tly_xx_xxz_0[j] + 0.5 * fl1_fx * tpz_xx_xxxz_0[j] + fl1_fx * fl1_fgb * tdz_xx_xxxz_0[j];

                tlz_xxx_xxxz_0[j] = pa_x[j] * tlz_xx_xxxz_0[j] + fl1_fx * tlz_x_xxxz_0[j] + 1.5 * fl1_fx * tlz_xx_xxz_0[j] - 0.5 * fl1_fx * tpy_xx_xxxz_0[j] - fl1_fx * fl1_fgb * tdy_xx_xxxz_0[j];

                tlx_xxx_xxyy_0[j] = pa_x[j] * tlx_xx_xxyy_0[j] + fl1_fx * tlx_x_xxyy_0[j] + fl1_fx * tlx_xx_xyy_0[j];

                tly_xxx_xxyy_0[j] = pa_x[j] * tly_xx_xxyy_0[j] + fl1_fx * tly_x_xxyy_0[j] + fl1_fx * tly_xx_xyy_0[j] + 0.5 * fl1_fx * tpz_xx_xxyy_0[j] + fl1_fx * fl1_fgb * tdz_xx_xxyy_0[j];

                tlz_xxx_xxyy_0[j] = pa_x[j] * tlz_xx_xxyy_0[j] + fl1_fx * tlz_x_xxyy_0[j] + fl1_fx * tlz_xx_xyy_0[j] - 0.5 * fl1_fx * tpy_xx_xxyy_0[j] - fl1_fx * fl1_fgb * tdy_xx_xxyy_0[j];

                tlx_xxx_xxyz_0[j] = pa_x[j] * tlx_xx_xxyz_0[j] + fl1_fx * tlx_x_xxyz_0[j] + fl1_fx * tlx_xx_xyz_0[j];

                tly_xxx_xxyz_0[j] = pa_x[j] * tly_xx_xxyz_0[j] + fl1_fx * tly_x_xxyz_0[j] + fl1_fx * tly_xx_xyz_0[j] + 0.5 * fl1_fx * tpz_xx_xxyz_0[j] + fl1_fx * fl1_fgb * tdz_xx_xxyz_0[j];

                tlz_xxx_xxyz_0[j] = pa_x[j] * tlz_xx_xxyz_0[j] + fl1_fx * tlz_x_xxyz_0[j] + fl1_fx * tlz_xx_xyz_0[j] - 0.5 * fl1_fx * tpy_xx_xxyz_0[j] - fl1_fx * fl1_fgb * tdy_xx_xxyz_0[j];

                tlx_xxx_xxzz_0[j] = pa_x[j] * tlx_xx_xxzz_0[j] + fl1_fx * tlx_x_xxzz_0[j] + fl1_fx * tlx_xx_xzz_0[j];

                tly_xxx_xxzz_0[j] = pa_x[j] * tly_xx_xxzz_0[j] + fl1_fx * tly_x_xxzz_0[j] + fl1_fx * tly_xx_xzz_0[j] + 0.5 * fl1_fx * tpz_xx_xxzz_0[j] + fl1_fx * fl1_fgb * tdz_xx_xxzz_0[j];

                tlz_xxx_xxzz_0[j] = pa_x[j] * tlz_xx_xxzz_0[j] + fl1_fx * tlz_x_xxzz_0[j] + fl1_fx * tlz_xx_xzz_0[j] - 0.5 * fl1_fx * tpy_xx_xxzz_0[j] - fl1_fx * fl1_fgb * tdy_xx_xxzz_0[j];

                tlx_xxx_xyyy_0[j] = pa_x[j] * tlx_xx_xyyy_0[j] + fl1_fx * tlx_x_xyyy_0[j] + 0.5 * fl1_fx * tlx_xx_yyy_0[j];

                tly_xxx_xyyy_0[j] = pa_x[j] * tly_xx_xyyy_0[j] + fl1_fx * tly_x_xyyy_0[j] + 0.5 * fl1_fx * tly_xx_yyy_0[j] + 0.5 * fl1_fx * tpz_xx_xyyy_0[j] + fl1_fx * fl1_fgb * tdz_xx_xyyy_0[j];

                tlz_xxx_xyyy_0[j] = pa_x[j] * tlz_xx_xyyy_0[j] + fl1_fx * tlz_x_xyyy_0[j] + 0.5 * fl1_fx * tlz_xx_yyy_0[j] - 0.5 * fl1_fx * tpy_xx_xyyy_0[j] - fl1_fx * fl1_fgb * tdy_xx_xyyy_0[j];

                tlx_xxx_xyyz_0[j] = pa_x[j] * tlx_xx_xyyz_0[j] + fl1_fx * tlx_x_xyyz_0[j] + 0.5 * fl1_fx * tlx_xx_yyz_0[j];

                tly_xxx_xyyz_0[j] = pa_x[j] * tly_xx_xyyz_0[j] + fl1_fx * tly_x_xyyz_0[j] + 0.5 * fl1_fx * tly_xx_yyz_0[j] + 0.5 * fl1_fx * tpz_xx_xyyz_0[j] + fl1_fx * fl1_fgb * tdz_xx_xyyz_0[j];

                tlz_xxx_xyyz_0[j] = pa_x[j] * tlz_xx_xyyz_0[j] + fl1_fx * tlz_x_xyyz_0[j] + 0.5 * fl1_fx * tlz_xx_yyz_0[j] - 0.5 * fl1_fx * tpy_xx_xyyz_0[j] - fl1_fx * fl1_fgb * tdy_xx_xyyz_0[j];

                tlx_xxx_xyzz_0[j] = pa_x[j] * tlx_xx_xyzz_0[j] + fl1_fx * tlx_x_xyzz_0[j] + 0.5 * fl1_fx * tlx_xx_yzz_0[j];

                tly_xxx_xyzz_0[j] = pa_x[j] * tly_xx_xyzz_0[j] + fl1_fx * tly_x_xyzz_0[j] + 0.5 * fl1_fx * tly_xx_yzz_0[j] + 0.5 * fl1_fx * tpz_xx_xyzz_0[j] + fl1_fx * fl1_fgb * tdz_xx_xyzz_0[j];

                tlz_xxx_xyzz_0[j] = pa_x[j] * tlz_xx_xyzz_0[j] + fl1_fx * tlz_x_xyzz_0[j] + 0.5 * fl1_fx * tlz_xx_yzz_0[j] - 0.5 * fl1_fx * tpy_xx_xyzz_0[j] - fl1_fx * fl1_fgb * tdy_xx_xyzz_0[j];

                tlx_xxx_xzzz_0[j] = pa_x[j] * tlx_xx_xzzz_0[j] + fl1_fx * tlx_x_xzzz_0[j] + 0.5 * fl1_fx * tlx_xx_zzz_0[j];

                tly_xxx_xzzz_0[j] = pa_x[j] * tly_xx_xzzz_0[j] + fl1_fx * tly_x_xzzz_0[j] + 0.5 * fl1_fx * tly_xx_zzz_0[j] + 0.5 * fl1_fx * tpz_xx_xzzz_0[j] + fl1_fx * fl1_fgb * tdz_xx_xzzz_0[j];

                tlz_xxx_xzzz_0[j] = pa_x[j] * tlz_xx_xzzz_0[j] + fl1_fx * tlz_x_xzzz_0[j] + 0.5 * fl1_fx * tlz_xx_zzz_0[j] - 0.5 * fl1_fx * tpy_xx_xzzz_0[j] - fl1_fx * fl1_fgb * tdy_xx_xzzz_0[j];

                tlx_xxx_yyyy_0[j] = pa_x[j] * tlx_xx_yyyy_0[j] + fl1_fx * tlx_x_yyyy_0[j];

                tly_xxx_yyyy_0[j] = pa_x[j] * tly_xx_yyyy_0[j] + fl1_fx * tly_x_yyyy_0[j] + 0.5 * fl1_fx * tpz_xx_yyyy_0[j] + fl1_fx * fl1_fgb * tdz_xx_yyyy_0[j];

                tlz_xxx_yyyy_0[j] = pa_x[j] * tlz_xx_yyyy_0[j] + fl1_fx * tlz_x_yyyy_0[j] - 0.5 * fl1_fx * tpy_xx_yyyy_0[j] - fl1_fx * fl1_fgb * tdy_xx_yyyy_0[j];

                tlx_xxx_yyyz_0[j] = pa_x[j] * tlx_xx_yyyz_0[j] + fl1_fx * tlx_x_yyyz_0[j];

                tly_xxx_yyyz_0[j] = pa_x[j] * tly_xx_yyyz_0[j] + fl1_fx * tly_x_yyyz_0[j] + 0.5 * fl1_fx * tpz_xx_yyyz_0[j] + fl1_fx * fl1_fgb * tdz_xx_yyyz_0[j];

                tlz_xxx_yyyz_0[j] = pa_x[j] * tlz_xx_yyyz_0[j] + fl1_fx * tlz_x_yyyz_0[j] - 0.5 * fl1_fx * tpy_xx_yyyz_0[j] - fl1_fx * fl1_fgb * tdy_xx_yyyz_0[j];

                tlx_xxx_yyzz_0[j] = pa_x[j] * tlx_xx_yyzz_0[j] + fl1_fx * tlx_x_yyzz_0[j];

                tly_xxx_yyzz_0[j] = pa_x[j] * tly_xx_yyzz_0[j] + fl1_fx * tly_x_yyzz_0[j] + 0.5 * fl1_fx * tpz_xx_yyzz_0[j] + fl1_fx * fl1_fgb * tdz_xx_yyzz_0[j];

                tlz_xxx_yyzz_0[j] = pa_x[j] * tlz_xx_yyzz_0[j] + fl1_fx * tlz_x_yyzz_0[j] - 0.5 * fl1_fx * tpy_xx_yyzz_0[j] - fl1_fx * fl1_fgb * tdy_xx_yyzz_0[j];

                tlx_xxx_yzzz_0[j] = pa_x[j] * tlx_xx_yzzz_0[j] + fl1_fx * tlx_x_yzzz_0[j];

                tly_xxx_yzzz_0[j] = pa_x[j] * tly_xx_yzzz_0[j] + fl1_fx * tly_x_yzzz_0[j] + 0.5 * fl1_fx * tpz_xx_yzzz_0[j] + fl1_fx * fl1_fgb * tdz_xx_yzzz_0[j];

                tlz_xxx_yzzz_0[j] = pa_x[j] * tlz_xx_yzzz_0[j] + fl1_fx * tlz_x_yzzz_0[j] - 0.5 * fl1_fx * tpy_xx_yzzz_0[j] - fl1_fx * fl1_fgb * tdy_xx_yzzz_0[j];

                tlx_xxx_zzzz_0[j] = pa_x[j] * tlx_xx_zzzz_0[j] + fl1_fx * tlx_x_zzzz_0[j];

                tly_xxx_zzzz_0[j] = pa_x[j] * tly_xx_zzzz_0[j] + fl1_fx * tly_x_zzzz_0[j] + 0.5 * fl1_fx * tpz_xx_zzzz_0[j] + fl1_fx * fl1_fgb * tdz_xx_zzzz_0[j];

                tlz_xxx_zzzz_0[j] = pa_x[j] * tlz_xx_zzzz_0[j] + fl1_fx * tlz_x_zzzz_0[j] - 0.5 * fl1_fx * tpy_xx_zzzz_0[j] - fl1_fx * fl1_fgb * tdy_xx_zzzz_0[j];

                tlx_xxy_xxxx_0[j] = pa_x[j] * tlx_xy_xxxx_0[j] + 0.5 * fl1_fx * tlx_y_xxxx_0[j] + 2.0 * fl1_fx * tlx_xy_xxx_0[j];

                tly_xxy_xxxx_0[j] = pa_x[j] * tly_xy_xxxx_0[j] + 0.5 * fl1_fx * tly_y_xxxx_0[j] + 2.0 * fl1_fx * tly_xy_xxx_0[j] + 0.5 * fl1_fx * tpz_xy_xxxx_0[j] + fl1_fx * fl1_fgb * tdz_xy_xxxx_0[j];

                tlz_xxy_xxxx_0[j] = pa_x[j] * tlz_xy_xxxx_0[j] + 0.5 * fl1_fx * tlz_y_xxxx_0[j] + 2.0 * fl1_fx * tlz_xy_xxx_0[j] - 0.5 * fl1_fx * tpy_xy_xxxx_0[j] - fl1_fx * fl1_fgb * tdy_xy_xxxx_0[j];

                tlx_xxy_xxxy_0[j] = pa_x[j] * tlx_xy_xxxy_0[j] + 0.5 * fl1_fx * tlx_y_xxxy_0[j] + 1.5 * fl1_fx * tlx_xy_xxy_0[j];

                tly_xxy_xxxy_0[j] = pa_x[j] * tly_xy_xxxy_0[j] + 0.5 * fl1_fx * tly_y_xxxy_0[j] + 1.5 * fl1_fx * tly_xy_xxy_0[j] + 0.5 * fl1_fx * tpz_xy_xxxy_0[j] + fl1_fx * fl1_fgb * tdz_xy_xxxy_0[j];
            }
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tlz_xxy_xxxy_0[j] = pa_x[j] * tlz_xy_xxxy_0[j] + 0.5 * fl1_fx * tlz_y_xxxy_0[j] + 1.5 * fl1_fx * tlz_xy_xxy_0[j] - 0.5 * fl1_fx * tpy_xy_xxxy_0[j] - fl1_fx * fl1_fgb * tdy_xy_xxxy_0[j];

                tlx_xxy_xxxz_0[j] = pa_x[j] * tlx_xy_xxxz_0[j] + 0.5 * fl1_fx * tlx_y_xxxz_0[j] + 1.5 * fl1_fx * tlx_xy_xxz_0[j];

                tly_xxy_xxxz_0[j] = pa_x[j] * tly_xy_xxxz_0[j] + 0.5 * fl1_fx * tly_y_xxxz_0[j] + 1.5 * fl1_fx * tly_xy_xxz_0[j] + 0.5 * fl1_fx * tpz_xy_xxxz_0[j] + fl1_fx * fl1_fgb * tdz_xy_xxxz_0[j];

                tlz_xxy_xxxz_0[j] = pa_x[j] * tlz_xy_xxxz_0[j] + 0.5 * fl1_fx * tlz_y_xxxz_0[j] + 1.5 * fl1_fx * tlz_xy_xxz_0[j] - 0.5 * fl1_fx * tpy_xy_xxxz_0[j] - fl1_fx * fl1_fgb * tdy_xy_xxxz_0[j];

                tlx_xxy_xxyy_0[j] = pa_x[j] * tlx_xy_xxyy_0[j] + 0.5 * fl1_fx * tlx_y_xxyy_0[j] + fl1_fx * tlx_xy_xyy_0[j];

                tly_xxy_xxyy_0[j] = pa_x[j] * tly_xy_xxyy_0[j] + 0.5 * fl1_fx * tly_y_xxyy_0[j] + fl1_fx * tly_xy_xyy_0[j] + 0.5 * fl1_fx * tpz_xy_xxyy_0[j] + fl1_fx * fl1_fgb * tdz_xy_xxyy_0[j];

                tlz_xxy_xxyy_0[j] = pa_x[j] * tlz_xy_xxyy_0[j] + 0.5 * fl1_fx * tlz_y_xxyy_0[j] + fl1_fx * tlz_xy_xyy_0[j] - 0.5 * fl1_fx * tpy_xy_xxyy_0[j] - fl1_fx * fl1_fgb * tdy_xy_xxyy_0[j];

                tlx_xxy_xxyz_0[j] = pa_x[j] * tlx_xy_xxyz_0[j] + 0.5 * fl1_fx * tlx_y_xxyz_0[j] + fl1_fx * tlx_xy_xyz_0[j];

                tly_xxy_xxyz_0[j] = pa_x[j] * tly_xy_xxyz_0[j] + 0.5 * fl1_fx * tly_y_xxyz_0[j] + fl1_fx * tly_xy_xyz_0[j] + 0.5 * fl1_fx * tpz_xy_xxyz_0[j] + fl1_fx * fl1_fgb * tdz_xy_xxyz_0[j];

                tlz_xxy_xxyz_0[j] = pa_x[j] * tlz_xy_xxyz_0[j] + 0.5 * fl1_fx * tlz_y_xxyz_0[j] + fl1_fx * tlz_xy_xyz_0[j] - 0.5 * fl1_fx * tpy_xy_xxyz_0[j] - fl1_fx * fl1_fgb * tdy_xy_xxyz_0[j];

                tlx_xxy_xxzz_0[j] = pa_x[j] * tlx_xy_xxzz_0[j] + 0.5 * fl1_fx * tlx_y_xxzz_0[j] + fl1_fx * tlx_xy_xzz_0[j];

                tly_xxy_xxzz_0[j] = pa_x[j] * tly_xy_xxzz_0[j] + 0.5 * fl1_fx * tly_y_xxzz_0[j] + fl1_fx * tly_xy_xzz_0[j] + 0.5 * fl1_fx * tpz_xy_xxzz_0[j] + fl1_fx * fl1_fgb * tdz_xy_xxzz_0[j];

                tlz_xxy_xxzz_0[j] = pa_x[j] * tlz_xy_xxzz_0[j] + 0.5 * fl1_fx * tlz_y_xxzz_0[j] + fl1_fx * tlz_xy_xzz_0[j] - 0.5 * fl1_fx * tpy_xy_xxzz_0[j] - fl1_fx * fl1_fgb * tdy_xy_xxzz_0[j];

                tlx_xxy_xyyy_0[j] = pa_x[j] * tlx_xy_xyyy_0[j] + 0.5 * fl1_fx * tlx_y_xyyy_0[j] + 0.5 * fl1_fx * tlx_xy_yyy_0[j];

                tly_xxy_xyyy_0[j] = pa_x[j] * tly_xy_xyyy_0[j] + 0.5 * fl1_fx * tly_y_xyyy_0[j] + 0.5 * fl1_fx * tly_xy_yyy_0[j] + 0.5 * fl1_fx * tpz_xy_xyyy_0[j] + fl1_fx * fl1_fgb * tdz_xy_xyyy_0[j];

                tlz_xxy_xyyy_0[j] = pa_x[j] * tlz_xy_xyyy_0[j] + 0.5 * fl1_fx * tlz_y_xyyy_0[j] + 0.5 * fl1_fx * tlz_xy_yyy_0[j] - 0.5 * fl1_fx * tpy_xy_xyyy_0[j] - fl1_fx * fl1_fgb * tdy_xy_xyyy_0[j];

                tlx_xxy_xyyz_0[j] = pa_x[j] * tlx_xy_xyyz_0[j] + 0.5 * fl1_fx * tlx_y_xyyz_0[j] + 0.5 * fl1_fx * tlx_xy_yyz_0[j];

                tly_xxy_xyyz_0[j] = pa_x[j] * tly_xy_xyyz_0[j] + 0.5 * fl1_fx * tly_y_xyyz_0[j] + 0.5 * fl1_fx * tly_xy_yyz_0[j] + 0.5 * fl1_fx * tpz_xy_xyyz_0[j] + fl1_fx * fl1_fgb * tdz_xy_xyyz_0[j];

                tlz_xxy_xyyz_0[j] = pa_x[j] * tlz_xy_xyyz_0[j] + 0.5 * fl1_fx * tlz_y_xyyz_0[j] + 0.5 * fl1_fx * tlz_xy_yyz_0[j] - 0.5 * fl1_fx * tpy_xy_xyyz_0[j] - fl1_fx * fl1_fgb * tdy_xy_xyyz_0[j];

                tlx_xxy_xyzz_0[j] = pa_x[j] * tlx_xy_xyzz_0[j] + 0.5 * fl1_fx * tlx_y_xyzz_0[j] + 0.5 * fl1_fx * tlx_xy_yzz_0[j];

                tly_xxy_xyzz_0[j] = pa_x[j] * tly_xy_xyzz_0[j] + 0.5 * fl1_fx * tly_y_xyzz_0[j] + 0.5 * fl1_fx * tly_xy_yzz_0[j] + 0.5 * fl1_fx * tpz_xy_xyzz_0[j] + fl1_fx * fl1_fgb * tdz_xy_xyzz_0[j];

                tlz_xxy_xyzz_0[j] = pa_x[j] * tlz_xy_xyzz_0[j] + 0.5 * fl1_fx * tlz_y_xyzz_0[j] + 0.5 * fl1_fx * tlz_xy_yzz_0[j] - 0.5 * fl1_fx * tpy_xy_xyzz_0[j] - fl1_fx * fl1_fgb * tdy_xy_xyzz_0[j];

                tlx_xxy_xzzz_0[j] = pa_x[j] * tlx_xy_xzzz_0[j] + 0.5 * fl1_fx * tlx_y_xzzz_0[j] + 0.5 * fl1_fx * tlx_xy_zzz_0[j];

                tly_xxy_xzzz_0[j] = pa_x[j] * tly_xy_xzzz_0[j] + 0.5 * fl1_fx * tly_y_xzzz_0[j] + 0.5 * fl1_fx * tly_xy_zzz_0[j] + 0.5 * fl1_fx * tpz_xy_xzzz_0[j] + fl1_fx * fl1_fgb * tdz_xy_xzzz_0[j];

                tlz_xxy_xzzz_0[j] = pa_x[j] * tlz_xy_xzzz_0[j] + 0.5 * fl1_fx * tlz_y_xzzz_0[j] + 0.5 * fl1_fx * tlz_xy_zzz_0[j] - 0.5 * fl1_fx * tpy_xy_xzzz_0[j] - fl1_fx * fl1_fgb * tdy_xy_xzzz_0[j];

                tlx_xxy_yyyy_0[j] = pa_x[j] * tlx_xy_yyyy_0[j] + 0.5 * fl1_fx * tlx_y_yyyy_0[j];

                tly_xxy_yyyy_0[j] = pa_x[j] * tly_xy_yyyy_0[j] + 0.5 * fl1_fx * tly_y_yyyy_0[j] + 0.5 * fl1_fx * tpz_xy_yyyy_0[j] + fl1_fx * fl1_fgb * tdz_xy_yyyy_0[j];

                tlz_xxy_yyyy_0[j] = pa_x[j] * tlz_xy_yyyy_0[j] + 0.5 * fl1_fx * tlz_y_yyyy_0[j] - 0.5 * fl1_fx * tpy_xy_yyyy_0[j] - fl1_fx * fl1_fgb * tdy_xy_yyyy_0[j];

                tlx_xxy_yyyz_0[j] = pa_x[j] * tlx_xy_yyyz_0[j] + 0.5 * fl1_fx * tlx_y_yyyz_0[j];

                tly_xxy_yyyz_0[j] = pa_x[j] * tly_xy_yyyz_0[j] + 0.5 * fl1_fx * tly_y_yyyz_0[j] + 0.5 * fl1_fx * tpz_xy_yyyz_0[j] + fl1_fx * fl1_fgb * tdz_xy_yyyz_0[j];

                tlz_xxy_yyyz_0[j] = pa_x[j] * tlz_xy_yyyz_0[j] + 0.5 * fl1_fx * tlz_y_yyyz_0[j] - 0.5 * fl1_fx * tpy_xy_yyyz_0[j] - fl1_fx * fl1_fgb * tdy_xy_yyyz_0[j];

                tlx_xxy_yyzz_0[j] = pa_x[j] * tlx_xy_yyzz_0[j] + 0.5 * fl1_fx * tlx_y_yyzz_0[j];

                tly_xxy_yyzz_0[j] = pa_x[j] * tly_xy_yyzz_0[j] + 0.5 * fl1_fx * tly_y_yyzz_0[j] + 0.5 * fl1_fx * tpz_xy_yyzz_0[j] + fl1_fx * fl1_fgb * tdz_xy_yyzz_0[j];

                tlz_xxy_yyzz_0[j] = pa_x[j] * tlz_xy_yyzz_0[j] + 0.5 * fl1_fx * tlz_y_yyzz_0[j] - 0.5 * fl1_fx * tpy_xy_yyzz_0[j] - fl1_fx * fl1_fgb * tdy_xy_yyzz_0[j];

                tlx_xxy_yzzz_0[j] = pa_x[j] * tlx_xy_yzzz_0[j] + 0.5 * fl1_fx * tlx_y_yzzz_0[j];

                tly_xxy_yzzz_0[j] = pa_x[j] * tly_xy_yzzz_0[j] + 0.5 * fl1_fx * tly_y_yzzz_0[j] + 0.5 * fl1_fx * tpz_xy_yzzz_0[j] + fl1_fx * fl1_fgb * tdz_xy_yzzz_0[j];

                tlz_xxy_yzzz_0[j] = pa_x[j] * tlz_xy_yzzz_0[j] + 0.5 * fl1_fx * tlz_y_yzzz_0[j] - 0.5 * fl1_fx * tpy_xy_yzzz_0[j] - fl1_fx * fl1_fgb * tdy_xy_yzzz_0[j];

                tlx_xxy_zzzz_0[j] = pa_x[j] * tlx_xy_zzzz_0[j] + 0.5 * fl1_fx * tlx_y_zzzz_0[j];

                tly_xxy_zzzz_0[j] = pa_x[j] * tly_xy_zzzz_0[j] + 0.5 * fl1_fx * tly_y_zzzz_0[j] + 0.5 * fl1_fx * tpz_xy_zzzz_0[j] + fl1_fx * fl1_fgb * tdz_xy_zzzz_0[j];

                tlz_xxy_zzzz_0[j] = pa_x[j] * tlz_xy_zzzz_0[j] + 0.5 * fl1_fx * tlz_y_zzzz_0[j] - 0.5 * fl1_fx * tpy_xy_zzzz_0[j] - fl1_fx * fl1_fgb * tdy_xy_zzzz_0[j];

                tlx_xxz_xxxx_0[j] = pa_x[j] * tlx_xz_xxxx_0[j] + 0.5 * fl1_fx * tlx_z_xxxx_0[j] + 2.0 * fl1_fx * tlx_xz_xxx_0[j];

                tly_xxz_xxxx_0[j] = pa_x[j] * tly_xz_xxxx_0[j] + 0.5 * fl1_fx * tly_z_xxxx_0[j] + 2.0 * fl1_fx * tly_xz_xxx_0[j] + 0.5 * fl1_fx * tpz_xz_xxxx_0[j] + fl1_fx * fl1_fgb * tdz_xz_xxxx_0[j];

                tlz_xxz_xxxx_0[j] = pa_x[j] * tlz_xz_xxxx_0[j] + 0.5 * fl1_fx * tlz_z_xxxx_0[j] + 2.0 * fl1_fx * tlz_xz_xxx_0[j] - 0.5 * fl1_fx * tpy_xz_xxxx_0[j] - fl1_fx * fl1_fgb * tdy_xz_xxxx_0[j];

                tlx_xxz_xxxy_0[j] = pa_x[j] * tlx_xz_xxxy_0[j] + 0.5 * fl1_fx * tlx_z_xxxy_0[j] + 1.5 * fl1_fx * tlx_xz_xxy_0[j];

                tly_xxz_xxxy_0[j] = pa_x[j] * tly_xz_xxxy_0[j] + 0.5 * fl1_fx * tly_z_xxxy_0[j] + 1.5 * fl1_fx * tly_xz_xxy_0[j] + 0.5 * fl1_fx * tpz_xz_xxxy_0[j] + fl1_fx * fl1_fgb * tdz_xz_xxxy_0[j];

                tlz_xxz_xxxy_0[j] = pa_x[j] * tlz_xz_xxxy_0[j] + 0.5 * fl1_fx * tlz_z_xxxy_0[j] + 1.5 * fl1_fx * tlz_xz_xxy_0[j] - 0.5 * fl1_fx * tpy_xz_xxxy_0[j] - fl1_fx * fl1_fgb * tdy_xz_xxxy_0[j];

                tlx_xxz_xxxz_0[j] = pa_x[j] * tlx_xz_xxxz_0[j] + 0.5 * fl1_fx * tlx_z_xxxz_0[j] + 1.5 * fl1_fx * tlx_xz_xxz_0[j];

                tly_xxz_xxxz_0[j] = pa_x[j] * tly_xz_xxxz_0[j] + 0.5 * fl1_fx * tly_z_xxxz_0[j] + 1.5 * fl1_fx * tly_xz_xxz_0[j] + 0.5 * fl1_fx * tpz_xz_xxxz_0[j] + fl1_fx * fl1_fgb * tdz_xz_xxxz_0[j];

                tlz_xxz_xxxz_0[j] = pa_x[j] * tlz_xz_xxxz_0[j] + 0.5 * fl1_fx * tlz_z_xxxz_0[j] + 1.5 * fl1_fx * tlz_xz_xxz_0[j] - 0.5 * fl1_fx * tpy_xz_xxxz_0[j] - fl1_fx * fl1_fgb * tdy_xz_xxxz_0[j];
                                     ...
                                     const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tly_xxz_xxyy_0[j] = pa_x[j] * tly_xz_xxyy_0[j] + 0.5 * fl1_fx * tly_z_xxyy_0[j] + fl1_fx * tly_xz_xyy_0[j] + 0.5 * fl1_fx * tpz_xz_xxyy_0[j] + fl1_fx * fl1_fgb * tdz_xz_xxyy_0[j];

                tlz_xxz_xxyy_0[j] = pa_x[j] * tlz_xz_xxyy_0[j] + 0.5 * fl1_fx * tlz_z_xxyy_0[j] + fl1_fx * tlz_xz_xyy_0[j] - 0.5 * fl1_fx * tpy_xz_xxyy_0[j] - fl1_fx * fl1_fgb * tdy_xz_xxyy_0[j];

                tlx_xxz_xxyz_0[j] = pa_x[j] * tlx_xz_xxyz_0[j] + 0.5 * fl1_fx * tlx_z_xxyz_0[j] + fl1_fx * tlx_xz_xyz_0[j];

                tly_xxz_xxyz_0[j] = pa_x[j] * tly_xz_xxyz_0[j] + 0.5 * fl1_fx * tly_z_xxyz_0[j] + fl1_fx * tly_xz_xyz_0[j] + 0.5 * fl1_fx * tpz_xz_xxyz_0[j] + fl1_fx * fl1_fgb * tdz_xz_xxyz_0[j];

                tlz_xxz_xxyz_0[j] = pa_x[j] * tlz_xz_xxyz_0[j] + 0.5 * fl1_fx * tlz_z_xxyz_0[j] + fl1_fx * tlz_xz_xyz_0[j] - 0.5 * fl1_fx * tpy_xz_xxyz_0[j] - fl1_fx * fl1_fgb * tdy_xz_xxyz_0[j];

                tlx_xxz_xxzz_0[j] = pa_x[j] * tlx_xz_xxzz_0[j] + 0.5 * fl1_fx * tlx_z_xxzz_0[j] + fl1_fx * tlx_xz_xzz_0[j];

                tly_xxz_xxzz_0[j] = pa_x[j] * tly_xz_xxzz_0[j] + 0.5 * fl1_fx * tly_z_xxzz_0[j] + fl1_fx * tly_xz_xzz_0[j] + 0.5 * fl1_fx * tpz_xz_xxzz_0[j] + fl1_fx * fl1_fgb * tdz_xz_xxzz_0[j];

                tlz_xxz_xxzz_0[j] = pa_x[j] * tlz_xz_xxzz_0[j] + 0.5 * fl1_fx * tlz_z_xxzz_0[j] + fl1_fx * tlz_xz_xzz_0[j] - 0.5 * fl1_fx * tpy_xz_xxzz_0[j] - fl1_fx * fl1_fgb * tdy_xz_xxzz_0[j];

                tlx_xxz_xyyy_0[j] = pa_x[j] * tlx_xz_xyyy_0[j] + 0.5 * fl1_fx * tlx_z_xyyy_0[j] + 0.5 * fl1_fx * tlx_xz_yyy_0[j];

                tly_xxz_xyyy_0[j] = pa_x[j] * tly_xz_xyyy_0[j] + 0.5 * fl1_fx * tly_z_xyyy_0[j] + 0.5 * fl1_fx * tly_xz_yyy_0[j] + 0.5 * fl1_fx * tpz_xz_xyyy_0[j] + fl1_fx * fl1_fgb * tdz_xz_xyyy_0[j];

                tlz_xxz_xyyy_0[j] = pa_x[j] * tlz_xz_xyyy_0[j] + 0.5 * fl1_fx * tlz_z_xyyy_0[j] + 0.5 * fl1_fx * tlz_xz_yyy_0[j] - 0.5 * fl1_fx * tpy_xz_xyyy_0[j] - fl1_fx * fl1_fgb * tdy_xz_xyyy_0[j];

                tlx_xxz_xyyz_0[j] = pa_x[j] * tlx_xz_xyyz_0[j] + 0.5 * fl1_fx * tlx_z_xyyz_0[j] + 0.5 * fl1_fx * tlx_xz_yyz_0[j];

                tly_xxz_xyyz_0[j] = pa_x[j] * tly_xz_xyyz_0[j] + 0.5 * fl1_fx * tly_z_xyyz_0[j] + 0.5 * fl1_fx * tly_xz_yyz_0[j] + 0.5 * fl1_fx * tpz_xz_xyyz_0[j] + fl1_fx * fl1_fgb * tdz_xz_xyyz_0[j];

                tlz_xxz_xyyz_0[j] = pa_x[j] * tlz_xz_xyyz_0[j] + 0.5 * fl1_fx * tlz_z_xyyz_0[j] + 0.5 * fl1_fx * tlz_xz_yyz_0[j] - 0.5 * fl1_fx * tpy_xz_xyyz_0[j] - fl1_fx * fl1_fgb * tdy_xz_xyyz_0[j];

                tlx_xxz_xyzz_0[j] = pa_x[j] * tlx_xz_xyzz_0[j] + 0.5 * fl1_fx * tlx_z_xyzz_0[j] + 0.5 * fl1_fx * tlx_xz_yzz_0[j];

                tly_xxz_xyzz_0[j] = pa_x[j] * tly_xz_xyzz_0[j] + 0.5 * fl1_fx * tly_z_xyzz_0[j] + 0.5 * fl1_fx * tly_xz_yzz_0[j] + 0.5 * fl1_fx * tpz_xz_xyzz_0[j] + fl1_fx * fl1_fgb * tdz_xz_xyzz_0[j];

                tlz_xxz_xyzz_0[j] = pa_x[j] * tlz_xz_xyzz_0[j] + 0.5 * fl1_fx * tlz_z_xyzz_0[j] + 0.5 * fl1_fx * tlz_xz_yzz_0[j] - 0.5 * fl1_fx * tpy_xz_xyzz_0[j] - fl1_fx * fl1_fgb * tdy_xz_xyzz_0[j];

                tlx_xxz_xzzz_0[j] = pa_x[j] * tlx_xz_xzzz_0[j] + 0.5 * fl1_fx * tlx_z_xzzz_0[j] + 0.5 * fl1_fx * tlx_xz_zzz_0[j];

                tly_xxz_xzzz_0[j] = pa_x[j] * tly_xz_xzzz_0[j] + 0.5 * fl1_fx * tly_z_xzzz_0[j] + 0.5 * fl1_fx * tly_xz_zzz_0[j] + 0.5 * fl1_fx * tpz_xz_xzzz_0[j] + fl1_fx * fl1_fgb * tdz_xz_xzzz_0[j];

                tlz_xxz_xzzz_0[j] = pa_x[j] * tlz_xz_xzzz_0[j] + 0.5 * fl1_fx * tlz_z_xzzz_0[j] + 0.5 * fl1_fx * tlz_xz_zzz_0[j] - 0.5 * fl1_fx * tpy_xz_xzzz_0[j] - fl1_fx * fl1_fgb * tdy_xz_xzzz_0[j];

                tlx_xxz_yyyy_0[j] = pa_x[j] * tlx_xz_yyyy_0[j] + 0.5 * fl1_fx * tlx_z_yyyy_0[j];

                tly_xxz_yyyy_0[j] = pa_x[j] * tly_xz_yyyy_0[j] + 0.5 * fl1_fx * tly_z_yyyy_0[j] + 0.5 * fl1_fx * tpz_xz_yyyy_0[j] + fl1_fx * fl1_fgb * tdz_xz_yyyy_0[j];

                tlz_xxz_yyyy_0[j] = pa_x[j] * tlz_xz_yyyy_0[j] + 0.5 * fl1_fx * tlz_z_yyyy_0[j] - 0.5 * fl1_fx * tpy_xz_yyyy_0[j] - fl1_fx * fl1_fgb * tdy_xz_yyyy_0[j];

                tlx_xxz_yyyz_0[j] = pa_x[j] * tlx_xz_yyyz_0[j] + 0.5 * fl1_fx * tlx_z_yyyz_0[j];

                tly_xxz_yyyz_0[j] = pa_x[j] * tly_xz_yyyz_0[j] + 0.5 * fl1_fx * tly_z_yyyz_0[j] + 0.5 * fl1_fx * tpz_xz_yyyz_0[j] + fl1_fx * fl1_fgb * tdz_xz_yyyz_0[j];

                tlz_xxz_yyyz_0[j] = pa_x[j] * tlz_xz_yyyz_0[j] + 0.5 * fl1_fx * tlz_z_yyyz_0[j] - 0.5 * fl1_fx * tpy_xz_yyyz_0[j] - fl1_fx * fl1_fgb * tdy_xz_yyyz_0[j];

                tlx_xxz_yyzz_0[j] = pa_x[j] * tlx_xz_yyzz_0[j] + 0.5 * fl1_fx * tlx_z_yyzz_0[j];

                tly_xxz_yyzz_0[j] = pa_x[j] * tly_xz_yyzz_0[j] + 0.5 * fl1_fx * tly_z_yyzz_0[j] + 0.5 * fl1_fx * tpz_xz_yyzz_0[j] + fl1_fx * fl1_fgb * tdz_xz_yyzz_0[j];

                tlz_xxz_yyzz_0[j] = pa_x[j] * tlz_xz_yyzz_0[j] + 0.5 * fl1_fx * tlz_z_yyzz_0[j] - 0.5 * fl1_fx * tpy_xz_yyzz_0[j] - fl1_fx * fl1_fgb * tdy_xz_yyzz_0[j];

                tlx_xxz_yzzz_0[j] = pa_x[j] * tlx_xz_yzzz_0[j] + 0.5 * fl1_fx * tlx_z_yzzz_0[j];

                tly_xxz_yzzz_0[j] = pa_x[j] * tly_xz_yzzz_0[j] + 0.5 * fl1_fx * tly_z_yzzz_0[j] + 0.5 * fl1_fx * tpz_xz_yzzz_0[j] + fl1_fx * fl1_fgb * tdz_xz_yzzz_0[j];

                tlz_xxz_yzzz_0[j] = pa_x[j] * tlz_xz_yzzz_0[j] + 0.5 * fl1_fx * tlz_z_yzzz_0[j] - 0.5 * fl1_fx * tpy_xz_yzzz_0[j] - fl1_fx * fl1_fgb * tdy_xz_yzzz_0[j];

                tlx_xxz_zzzz_0[j] = pa_x[j] * tlx_xz_zzzz_0[j] + 0.5 * fl1_fx * tlx_z_zzzz_0[j];

                tly_xxz_zzzz_0[j] = pa_x[j] * tly_xz_zzzz_0[j] + 0.5 * fl1_fx * tly_z_zzzz_0[j] + 0.5 * fl1_fx * tpz_xz_zzzz_0[j] + fl1_fx * fl1_fgb * tdz_xz_zzzz_0[j];

                tlz_xxz_zzzz_0[j] = pa_x[j] * tlz_xz_zzzz_0[j] + 0.5 * fl1_fx * tlz_z_zzzz_0[j] - 0.5 * fl1_fx * tpy_xz_zzzz_0[j] - fl1_fx * fl1_fgb * tdy_xz_zzzz_0[j];

                tlx_xyy_xxxx_0[j] = pa_x[j] * tlx_yy_xxxx_0[j] + 2.0 * fl1_fx * tlx_yy_xxx_0[j];

                tly_xyy_xxxx_0[j] = pa_x[j] * tly_yy_xxxx_0[j] + 2.0 * fl1_fx * tly_yy_xxx_0[j] + 0.5 * fl1_fx * tpz_yy_xxxx_0[j] + fl1_fx * fl1_fgb * tdz_yy_xxxx_0[j];

                tlz_xyy_xxxx_0[j] = pa_x[j] * tlz_yy_xxxx_0[j] + 2.0 * fl1_fx * tlz_yy_xxx_0[j] - 0.5 * fl1_fx * tpy_yy_xxxx_0[j] - fl1_fx * fl1_fgb * tdy_yy_xxxx_0[j];

                tlx_xyy_xxxy_0[j] = pa_x[j] * tlx_yy_xxxy_0[j] + 1.5 * fl1_fx * tlx_yy_xxy_0[j];

                tly_xyy_xxxy_0[j] = pa_x[j] * tly_yy_xxxy_0[j] + 1.5 * fl1_fx * tly_yy_xxy_0[j] + 0.5 * fl1_fx * tpz_yy_xxxy_0[j] + fl1_fx * fl1_fgb * tdz_yy_xxxy_0[j];

                tlz_xyy_xxxy_0[j] = pa_x[j] * tlz_yy_xxxy_0[j] + 1.5 * fl1_fx * tlz_yy_xxy_0[j] - 0.5 * fl1_fx * tpy_yy_xxxy_0[j] - fl1_fx * fl1_fgb * tdy_yy_xxxy_0[j];

                tlx_xyy_xxxz_0[j] = pa_x[j] * tlx_yy_xxxz_0[j] + 1.5 * fl1_fx * tlx_yy_xxz_0[j];

                tly_xyy_xxxz_0[j] = pa_x[j] * tly_yy_xxxz_0[j] + 1.5 * fl1_fx * tly_yy_xxz_0[j] + 0.5 * fl1_fx * tpz_yy_xxxz_0[j] + fl1_fx * fl1_fgb * tdz_yy_xxxz_0[j];

                tlz_xyy_xxxz_0[j] = pa_x[j] * tlz_yy_xxxz_0[j] + 1.5 * fl1_fx * tlz_yy_xxz_0[j] - 0.5 * fl1_fx * tpy_yy_xxxz_0[j] - fl1_fx * fl1_fgb * tdy_yy_xxxz_0[j];

                tlx_xyy_xxyy_0[j] = pa_x[j] * tlx_yy_xxyy_0[j] + fl1_fx * tlx_yy_xyy_0[j];

                tly_xyy_xxyy_0[j] = pa_x[j] * tly_yy_xxyy_0[j] + fl1_fx * tly_yy_xyy_0[j] + 0.5 * fl1_fx * tpz_yy_xxyy_0[j] + fl1_fx * fl1_fgb * tdz_yy_xxyy_0[j];

                tlz_xyy_xxyy_0[j] = pa_x[j] * tlz_yy_xxyy_0[j] + fl1_fx * tlz_yy_xyy_0[j] - 0.5 * fl1_fx * tpy_yy_xxyy_0[j] - fl1_fx * fl1_fgb * tdy_yy_xxyy_0[j];

                tlx_xyy_xxyz_0[j] = pa_x[j] * tlx_yy_xxyz_0[j] + fl1_fx * tlx_yy_xyz_0[j];

                tly_xyy_xxyz_0[j] = pa_x[j] * tly_yy_xxyz_0[j] + fl1_fx * tly_yy_xyz_0[j] + 0.5 * fl1_fx * tpz_yy_xxyz_0[j] + fl1_fx * fl1_fgb * tdz_yy_xxyz_0[j];

                tlz_xyy_xxyz_0[j] = pa_x[j] * tlz_yy_xxyz_0[j] + fl1_fx * tlz_yy_xyz_0[j] - 0.5 * fl1_fx * tpy_yy_xxyz_0[j] - fl1_fx * fl1_fgb * tdy_yy_xxyz_0[j];
            }
                                     ...
                                     const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tly_xyy_xxzz_0[j] = pa_x[j] * tly_yy_xxzz_0[j] + fl1_fx * tly_yy_xzz_0[j] + 0.5 * fl1_fx * tpz_yy_xxzz_0[j] + fl1_fx * fl1_fgb * tdz_yy_xxzz_0[j];

                tlz_xyy_xxzz_0[j] = pa_x[j] * tlz_yy_xxzz_0[j] + fl1_fx * tlz_yy_xzz_0[j] - 0.5 * fl1_fx * tpy_yy_xxzz_0[j] - fl1_fx * fl1_fgb * tdy_yy_xxzz_0[j];

                tlx_xyy_xyyy_0[j] = pa_x[j] * tlx_yy_xyyy_0[j] + 0.5 * fl1_fx * tlx_yy_yyy_0[j];

                tly_xyy_xyyy_0[j] = pa_x[j] * tly_yy_xyyy_0[j] + 0.5 * fl1_fx * tly_yy_yyy_0[j] + 0.5 * fl1_fx * tpz_yy_xyyy_0[j] + fl1_fx * fl1_fgb * tdz_yy_xyyy_0[j];

                tlz_xyy_xyyy_0[j] = pa_x[j] * tlz_yy_xyyy_0[j] + 0.5 * fl1_fx * tlz_yy_yyy_0[j] - 0.5 * fl1_fx * tpy_yy_xyyy_0[j] - fl1_fx * fl1_fgb * tdy_yy_xyyy_0[j];

                tlx_xyy_xyyz_0[j] = pa_x[j] * tlx_yy_xyyz_0[j] + 0.5 * fl1_fx * tlx_yy_yyz_0[j];

                tly_xyy_xyyz_0[j] = pa_x[j] * tly_yy_xyyz_0[j] + 0.5 * fl1_fx * tly_yy_yyz_0[j] + 0.5 * fl1_fx * tpz_yy_xyyz_0[j] + fl1_fx * fl1_fgb * tdz_yy_xyyz_0[j];

                tlz_xyy_xyyz_0[j] = pa_x[j] * tlz_yy_xyyz_0[j] + 0.5 * fl1_fx * tlz_yy_yyz_0[j] - 0.5 * fl1_fx * tpy_yy_xyyz_0[j] - fl1_fx * fl1_fgb * tdy_yy_xyyz_0[j];

                tlx_xyy_xyzz_0[j] = pa_x[j] * tlx_yy_xyzz_0[j] + 0.5 * fl1_fx * tlx_yy_yzz_0[j];

                tly_xyy_xyzz_0[j] = pa_x[j] * tly_yy_xyzz_0[j] + 0.5 * fl1_fx * tly_yy_yzz_0[j] + 0.5 * fl1_fx * tpz_yy_xyzz_0[j] + fl1_fx * fl1_fgb * tdz_yy_xyzz_0[j];

                tlz_xyy_xyzz_0[j] = pa_x[j] * tlz_yy_xyzz_0[j] + 0.5 * fl1_fx * tlz_yy_yzz_0[j] - 0.5 * fl1_fx * tpy_yy_xyzz_0[j] - fl1_fx * fl1_fgb * tdy_yy_xyzz_0[j];

                tlx_xyy_xzzz_0[j] = pa_x[j] * tlx_yy_xzzz_0[j] + 0.5 * fl1_fx * tlx_yy_zzz_0[j];

                tly_xyy_xzzz_0[j] = pa_x[j] * tly_yy_xzzz_0[j] + 0.5 * fl1_fx * tly_yy_zzz_0[j] + 0.5 * fl1_fx * tpz_yy_xzzz_0[j] + fl1_fx * fl1_fgb * tdz_yy_xzzz_0[j];

                tlz_xyy_xzzz_0[j] = pa_x[j] * tlz_yy_xzzz_0[j] + 0.5 * fl1_fx * tlz_yy_zzz_0[j] - 0.5 * fl1_fx * tpy_yy_xzzz_0[j] - fl1_fx * fl1_fgb * tdy_yy_xzzz_0[j];
                ...
                tly_xyz_xxxx_0[j] = pa_x[j] * tly_yz_xxxx_0[j] + 2.0 * fl1_fx * tly_yz_xxx_0[j] + 0.5 * fl1_fx * tpz_yz_xxxx_0[j] + fl1_fx * fl1_fgb * tdz_yz_xxxx_0[j];

                tlz_xyz_xxxx_0[j] = pa_x[j] * tlz_yz_xxxx_0[j] + 2.0 * fl1_fx * tlz_yz_xxx_0[j] - 0.5 * fl1_fx * tpy_yz_xxxx_0[j] - fl1_fx * fl1_fgb * tdy_yz_xxxx_0[j];

                tlx_xyz_xxxy_0[j] = pa_x[j] * tlx_yz_xxxy_0[j] + 1.5 * fl1_fx * tlx_yz_xxy_0[j];

                tly_xyz_xxxy_0[j] = pa_x[j] * tly_yz_xxxy_0[j] + 1.5 * fl1_fx * tly_yz_xxy_0[j] + 0.5 * fl1_fx * tpz_yz_xxxy_0[j] + fl1_fx * fl1_fgb * tdz_yz_xxxy_0[j];

                tlz_xyz_xxxy_0[j] = pa_x[j] * tlz_yz_xxxy_0[j] + 1.5 * fl1_fx * tlz_yz_xxy_0[j] - 0.5 * fl1_fx * tpy_yz_xxxy_0[j] - fl1_fx * fl1_fgb * tdy_yz_xxxy_0[j];

                tlx_xyz_xxxz_0[j] = pa_x[j] * tlx_yz_xxxz_0[j] + 1.5 * fl1_fx * tlx_yz_xxz_0[j];

                tly_xyz_xxxz_0[j] = pa_x[j] * tly_yz_xxxz_0[j] + 1.5 * fl1_fx * tly_yz_xxz_0[j] + 0.5 * fl1_fx * tpz_yz_xxxz_0[j] + fl1_fx * fl1_fgb * tdz_yz_xxxz_0[j];

                tlz_xyz_xxxz_0[j] = pa_x[j] * tlz_yz_xxxz_0[j] + 1.5 * fl1_fx * tlz_yz_xxz_0[j] - 0.5 * fl1_fx * tpy_yz_xxxz_0[j] - fl1_fx * fl1_fgb * tdy_yz_xxxz_0[j];

                tlx_xyz_xxyy_0[j] = pa_x[j] * tlx_yz_xxyy_0[j] + fl1_fx * tlx_yz_xyy_0[j];

                tly_xyz_xxyy_0[j] = pa_x[j] * tly_yz_xxyy_0[j] + fl1_fx * tly_yz_xyy_0[j] + 0.5 * fl1_fx * tpz_yz_xxyy_0[j] + fl1_fx * fl1_fgb * tdz_yz_xxyy_0[j];

                tlz_xyz_xxyy_0[j] = pa_x[j] * tlz_yz_xxyy_0[j] + fl1_fx * tlz_yz_xyy_0[j] - 0.5 * fl1_fx * tpy_yz_xxyy_0[j] - fl1_fx * fl1_fgb * tdy_yz_xxyy_0[j];

                tlx_xyz_xxyz_0[j] = pa_x[j] * tlx_yz_xxyz_0[j] + fl1_fx * tlx_yz_xyz_0[j];

                tly_xyz_xxyz_0[j] = pa_x[j] * tly_yz_xxyz_0[j] + fl1_fx * tly_yz_xyz_0[j] + 0.5 * fl1_fx * tpz_yz_xxyz_0[j] + fl1_fx * fl1_fgb * tdz_yz_xxyz_0[j];

                tlz_xyz_xxyz_0[j] = pa_x[j] * tlz_yz_xxyz_0[j] + fl1_fx * tlz_yz_xyz_0[j] - 0.5 * fl1_fx * tpy_yz_xxyz_0[j] - fl1_fx * fl1_fgb * tdy_yz_xxyz_0[j];

                tlx_xyz_xxzz_0[j] = pa_x[j] * tlx_yz_xxzz_0[j] + fl1_fx * tlx_yz_xzz_0[j];

                tly_xyz_xxzz_0[j] = pa_x[j] * tly_yz_xxzz_0[j] + fl1_fx * tly_yz_xzz_0[j] + 0.5 * fl1_fx * tpz_yz_xxzz_0[j] + fl1_fx * fl1_fgb * tdz_yz_xxzz_0[j];

                tlz_xyz_xxzz_0[j] = pa_x[j] * tlz_yz_xxzz_0[j] + fl1_fx * tlz_yz_xzz_0[j] - 0.5 * fl1_fx * tpy_yz_xxzz_0[j] - fl1_fx * fl1_fgb * tdy_yz_xxzz_0[j];

                tlx_xyz_xyyy_0[j] = pa_x[j] * tlx_yz_xyyy_0[j] + 0.5 * fl1_fx * tlx_yz_yyy_0[j];

                tly_xyz_xyyy_0[j] = pa_x[j] * tly_yz_xyyy_0[j] + 0.5 * fl1_fx * tly_yz_yyy_0[j] + 0.5 * fl1_fx * tpz_yz_xyyy_0[j] + fl1_fx * fl1_fgb * tdz_yz_xyyy_0[j];
            }
                                     ...
                                     const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tlz_xyz_xyyy_0[j] = pa_x[j] * tlz_yz_xyyy_0[j] + 0.5 * fl1_fx * tlz_yz_yyy_0[j] - 0.5 * fl1_fx * tpy_yz_xyyy_0[j] - fl1_fx * fl1_fgb * tdy_yz_xyyy_0[j];

                tlx_xyz_xyyz_0[j] = pa_x[j] * tlx_yz_xyyz_0[j] + 0.5 * fl1_fx * tlx_yz_yyz_0[j];

                tly_xyz_xyyz_0[j] = pa_x[j] * tly_yz_xyyz_0[j] + 0.5 * fl1_fx * tly_yz_yyz_0[j] + 0.5 * fl1_fx * tpz_yz_xyyz_0[j] + fl1_fx * fl1_fgb * tdz_yz_xyyz_0[j];

                tlz_xyz_xyyz_0[j] = pa_x[j] * tlz_yz_xyyz_0[j] + 0.5 * fl1_fx * tlz_yz_yyz_0[j] - 0.5 * fl1_fx * tpy_yz_xyyz_0[j] - fl1_fx * fl1_fgb * tdy_yz_xyyz_0[j];

                tlx_xyz_xyzz_0[j] = pa_x[j] * tlx_yz_xyzz_0[j] + 0.5 * fl1_fx * tlx_yz_yzz_0[j];

                tly_xyz_xyzz_0[j] = pa_x[j] * tly_yz_xyzz_0[j] + 0.5 * fl1_fx * tly_yz_yzz_0[j] + 0.5 * fl1_fx * tpz_yz_xyzz_0[j] + fl1_fx * fl1_fgb * tdz_yz_xyzz_0[j];

                tlz_xyz_xyzz_0[j] = pa_x[j] * tlz_yz_xyzz_0[j] + 0.5 * fl1_fx * tlz_yz_yzz_0[j] - 0.5 * fl1_fx * tpy_yz_xyzz_0[j] - fl1_fx * fl1_fgb * tdy_yz_xyzz_0[j];

                tlx_xyz_xzzz_0[j] = pa_x[j] * tlx_yz_xzzz_0[j] + 0.5 * fl1_fx * tlx_yz_zzz_0[j];

                tly_xyz_xzzz_0[j] = pa_x[j] * tly_yz_xzzz_0[j] + 0.5 * fl1_fx * tly_yz_zzz_0[j] + 0.5 * fl1_fx * tpz_yz_xzzz_0[j] + fl1_fx * fl1_fgb * tdz_yz_xzzz_0[j];

                tlz_xyz_xzzz_0[j] = pa_x[j] * tlz_yz_xzzz_0[j] + 0.5 * fl1_fx * tlz_yz_zzz_0[j] - 0.5 * fl1_fx * tpy_yz_xzzz_0[j] - fl1_fx * fl1_fgb * tdy_yz_xzzz_0[j];
                ...
                tly_xzz_xxxx_0[j] = pa_x[j] * tly_zz_xxxx_0[j] + 2.0 * fl1_fx * tly_zz_xxx_0[j] + 0.5 * fl1_fx * tpz_zz_xxxx_0[j] + fl1_fx * fl1_fgb * tdz_zz_xxxx_0[j];

                tlz_xzz_xxxx_0[j] = pa_x[j] * tlz_zz_xxxx_0[j] + 2.0 * fl1_fx * tlz_zz_xxx_0[j] - 0.5 * fl1_fx * tpy_zz_xxxx_0[j] - fl1_fx * fl1_fgb * tdy_zz_xxxx_0[j];

                tlx_xzz_xxxy_0[j] = pa_x[j] * tlx_zz_xxxy_0[j] + 1.5 * fl1_fx * tlx_zz_xxy_0[j];

                tly_xzz_xxxy_0[j] = pa_x[j] * tly_zz_xxxy_0[j] + 1.5 * fl1_fx * tly_zz_xxy_0[j] + 0.5 * fl1_fx * tpz_zz_xxxy_0[j] + fl1_fx * fl1_fgb * tdz_zz_xxxy_0[j];

                tlz_xzz_xxxy_0[j] = pa_x[j] * tlz_zz_xxxy_0[j] + 1.5 * fl1_fx * tlz_zz_xxy_0[j] - 0.5 * fl1_fx * tpy_zz_xxxy_0[j] - fl1_fx * fl1_fgb * tdy_zz_xxxy_0[j];

                tlx_xzz_xxxz_0[j] = pa_x[j] * tlx_zz_xxxz_0[j] + 1.5 * fl1_fx * tlx_zz_xxz_0[j];

                tly_xzz_xxxz_0[j] = pa_x[j] * tly_zz_xxxz_0[j] + 1.5 * fl1_fx * tly_zz_xxz_0[j] + 0.5 * fl1_fx * tpz_zz_xxxz_0[j] + fl1_fx * fl1_fgb * tdz_zz_xxxz_0[j];

                tlz_xzz_xxxz_0[j] = pa_x[j] * tlz_zz_xxxz_0[j] + 1.5 * fl1_fx * tlz_zz_xxz_0[j] - 0.5 * fl1_fx * tpy_zz_xxxz_0[j] - fl1_fx * fl1_fgb * tdy_zz_xxxz_0[j];

                tlx_xzz_xxyy_0[j] = pa_x[j] * tlx_zz_xxyy_0[j] + fl1_fx * tlx_zz_xyy_0[j];

                tly_xzz_xxyy_0[j] = pa_x[j] * tly_zz_xxyy_0[j] + fl1_fx * tly_zz_xyy_0[j] + 0.5 * fl1_fx * tpz_zz_xxyy_0[j] + fl1_fx * fl1_fgb * tdz_zz_xxyy_0[j];

                tlz_xzz_xxyy_0[j] = pa_x[j] * tlz_zz_xxyy_0[j] + fl1_fx * tlz_zz_xyy_0[j] - 0.5 * fl1_fx * tpy_zz_xxyy_0[j] - fl1_fx * fl1_fgb * tdy_zz_xxyy_0[j];

                tlx_xzz_xxyz_0[j] = pa_x[j] * tlx_zz_xxyz_0[j] + fl1_fx * tlx_zz_xyz_0[j];

                tly_xzz_xxyz_0[j] = pa_x[j] * tly_zz_xxyz_0[j] + fl1_fx * tly_zz_xyz_0[j] + 0.5 * fl1_fx * tpz_zz_xxyz_0[j] + fl1_fx * fl1_fgb * tdz_zz_xxyz_0[j];

                tlz_xzz_xxyz_0[j] = pa_x[j] * tlz_zz_xxyz_0[j] + fl1_fx * tlz_zz_xyz_0[j] - 0.5 * fl1_fx * tpy_zz_xxyz_0[j] - fl1_fx * fl1_fgb * tdy_zz_xxyz_0[j];

                tlx_xzz_xxzz_0[j] = pa_x[j] * tlx_zz_xxzz_0[j] + fl1_fx * tlx_zz_xzz_0[j];

                tly_xzz_xxzz_0[j] = pa_x[j] * tly_zz_xxzz_0[j] + fl1_fx * tly_zz_xzz_0[j] + 0.5 * fl1_fx * tpz_zz_xxzz_0[j] + fl1_fx * fl1_fgb * tdz_zz_xxzz_0[j];

                tlz_xzz_xxzz_0[j] = pa_x[j] * tlz_zz_xxzz_0[j] + fl1_fx * tlz_zz_xzz_0[j] - 0.5 * fl1_fx * tpy_zz_xxzz_0[j] - fl1_fx * fl1_fgb * tdy_zz_xxzz_0[j];

                tlx_xzz_xyyy_0[j] = pa_x[j] * tlx_zz_xyyy_0[j] + 0.5 * fl1_fx * tlx_zz_yyy_0[j];

                tly_xzz_xyyy_0[j] = pa_x[j] * tly_zz_xyyy_0[j] + 0.5 * fl1_fx * tly_zz_yyy_0[j] + 0.5 * fl1_fx * tpz_zz_xyyy_0[j] + fl1_fx * fl1_fgb * tdz_zz_xyyy_0[j];

                tlz_xzz_xyyy_0[j] = pa_x[j] * tlz_zz_xyyy_0[j] + 0.5 * fl1_fx * tlz_zz_yyy_0[j] - 0.5 * fl1_fx * tpy_zz_xyyy_0[j] - fl1_fx * fl1_fgb * tdy_zz_xyyy_0[j];

                tlx_xzz_xyyz_0[j] = pa_x[j] * tlx_zz_xyyz_0[j] + 0.5 * fl1_fx * tlx_zz_yyz_0[j];

                tly_xzz_xyyz_0[j] = pa_x[j] * tly_zz_xyyz_0[j] + 0.5 * fl1_fx * tly_zz_yyz_0[j] + 0.5 * fl1_fx * tpz_zz_xyyz_0[j] + fl1_fx * fl1_fgb * tdz_zz_xyyz_0[j];

                tlz_xzz_xyyz_0[j] = pa_x[j] * tlz_zz_xyyz_0[j] + 0.5 * fl1_fx * tlz_zz_yyz_0[j] - 0.5 * fl1_fx * tpy_zz_xyyz_0[j] - fl1_fx * fl1_fgb * tdy_zz_xyyz_0[j];
                                     ...
                                     const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tly_xzz_xyzz_0[j] = pa_x[j] * tly_zz_xyzz_0[j] + 0.5 * fl1_fx * tly_zz_yzz_0[j] + 0.5 * fl1_fx * tpz_zz_xyzz_0[j] + fl1_fx * fl1_fgb * tdz_zz_xyzz_0[j];

                tlz_xzz_xyzz_0[j] = pa_x[j] * tlz_zz_xyzz_0[j] + 0.5 * fl1_fx * tlz_zz_yzz_0[j] - 0.5 * fl1_fx * tpy_zz_xyzz_0[j] - fl1_fx * fl1_fgb * tdy_zz_xyzz_0[j];

                tlx_xzz_xzzz_0[j] = pa_x[j] * tlx_zz_xzzz_0[j] + 0.5 * fl1_fx * tlx_zz_zzz_0[j];

                tly_xzz_xzzz_0[j] = pa_x[j] * tly_zz_xzzz_0[j] + 0.5 * fl1_fx * tly_zz_zzz_0[j] + 0.5 * fl1_fx * tpz_zz_xzzz_0[j] + fl1_fx * fl1_fgb * tdz_zz_xzzz_0[j];

                tlz_xzz_xzzz_0[j] = pa_x[j] * tlz_zz_xzzz_0[j] + 0.5 * fl1_fx * tlz_zz_zzz_0[j] - 0.5 * fl1_fx * tpy_zz_xzzz_0[j] - fl1_fx * fl1_fgb * tdy_zz_xzzz_0[j];
                ...
                tlx_yyy_xxxx_0[j] = pa_y[j] * tlx_yy_xxxx_0[j] + fl1_fx * tlx_y_xxxx_0[j] - 0.5 * fl1_fx * tpz_yy_xxxx_0[j] - fl1_fx * fl1_fgb * tdz_yy_xxxx_0[j];

                tly_yyy_xxxx_0[j] = pa_y[j] * tly_yy_xxxx_0[j] + fl1_fx * tly_y_xxxx_0[j];

                tlz_yyy_xxxx_0[j] = pa_y[j] * tlz_yy_xxxx_0[j] + fl1_fx * tlz_y_xxxx_0[j] + 0.5 * fl1_fx * tpx_yy_xxxx_0[j] + fl1_fx * fl1_fgb * tdx_yy_xxxx_0[j];

                tlx_yyy_xxxy_0[j] = pa_y[j] * tlx_yy_xxxy_0[j] + fl1_fx * tlx_y_xxxy_0[j] + 0.5 * fl1_fx * tlx_yy_xxx_0[j] - 0.5 * fl1_fx * tpz_yy_xxxy_0[j] - fl1_fx * fl1_fgb * tdz_yy_xxxy_0[j];

                tly_yyy_xxxy_0[j] = pa_y[j] * tly_yy_xxxy_0[j] + fl1_fx * tly_y_xxxy_0[j] + 0.5 * fl1_fx * tly_yy_xxx_0[j];

                tlz_yyy_xxxy_0[j] = pa_y[j] * tlz_yy_xxxy_0[j] + fl1_fx * tlz_y_xxxy_0[j] + 0.5 * fl1_fx * tlz_yy_xxx_0[j] + 0.5 * fl1_fx * tpx_yy_xxxy_0[j] + fl1_fx * fl1_fgb * tdx_yy_xxxy_0[j];

                tlx_yyy_xxxz_0[j] = pa_y[j] * tlx_yy_xxxz_0[j] + fl1_fx * tlx_y_xxxz_0[j] - 0.5 * fl1_fx * tpz_yy_xxxz_0[j] - fl1_fx * fl1_fgb * tdz_yy_xxxz_0[j];

                tly_yyy_xxxz_0[j] = pa_y[j] * tly_yy_xxxz_0[j] + fl1_fx * tly_y_xxxz_0[j];

                tlz_yyy_xxxz_0[j] = pa_y[j] * tlz_yy_xxxz_0[j] + fl1_fx * tlz_y_xxxz_0[j] + 0.5 * fl1_fx * tpx_yy_xxxz_0[j] + fl1_fx * fl1_fgb * tdx_yy_xxxz_0[j];

                tlx_yyy_xxyy_0[j] = pa_y[j] * tlx_yy_xxyy_0[j] + fl1_fx * tlx_y_xxyy_0[j] + fl1_fx * tlx_yy_xxy_0[j] - 0.5 * fl1_fx * tpz_yy_xxyy_0[j] - fl1_fx * fl1_fgb * tdz_yy_xxyy_0[j];

                tly_yyy_xxyy_0[j] = pa_y[j] * tly_yy_xxyy_0[j] + fl1_fx * tly_y_xxyy_0[j] + fl1_fx * tly_yy_xxy_0[j];

                tlz_yyy_xxyy_0[j] = pa_y[j] * tlz_yy_xxyy_0[j] + fl1_fx * tlz_y_xxyy_0[j] + fl1_fx * tlz_yy_xxy_0[j] + 0.5 * fl1_fx * tpx_yy_xxyy_0[j] + fl1_fx * fl1_fgb * tdx_yy_xxyy_0[j];

                tlx_yyy_xxyz_0[j] = pa_y[j] * tlx_yy_xxyz_0[j] + fl1_fx * tlx_y_xxyz_0[j] + 0.5 * fl1_fx * tlx_yy_xxz_0[j] - 0.5 * fl1_fx * tpz_yy_xxyz_0[j] - fl1_fx * fl1_fgb * tdz_yy_xxyz_0[j];

                tly_yyy_xxyz_0[j] = pa_y[j] * tly_yy_xxyz_0[j] + fl1_fx * tly_y_xxyz_0[j] + 0.5 * fl1_fx * tly_yy_xxz_0[j];

                tlz_yyy_xxyz_0[j] = pa_y[j] * tlz_yy_xxyz_0[j] + fl1_fx * tlz_y_xxyz_0[j] + 0.5 * fl1_fx * tlz_yy_xxz_0[j] + 0.5 * fl1_fx * tpx_yy_xxyz_0[j] + fl1_fx * fl1_fgb * tdx_yy_xxyz_0[j];

                tlx_yyy_xxzz_0[j] = pa_y[j] * tlx_yy_xxzz_0[j] + fl1_fx * tlx_y_xxzz_0[j] - 0.5 * fl1_fx * tpz_yy_xxzz_0[j] - fl1_fx * fl1_fgb * tdz_yy_xxzz_0[j];

                tly_yyy_xxzz_0[j] = pa_y[j] * tly_yy_xxzz_0[j] + fl1_fx * tly_y_xxzz_0[j];

                tlz_yyy_xxzz_0[j] = pa_y[j] * tlz_yy_xxzz_0[j] + fl1_fx * tlz_y_xxzz_0[j] + 0.5 * fl1_fx * tpx_yy_xxzz_0[j] + fl1_fx * fl1_fgb * tdx_yy_xxzz_0[j];

                tlx_yyy_xyyy_0[j] = pa_y[j] * tlx_yy_xyyy_0[j] + fl1_fx * tlx_y_xyyy_0[j] + 1.5 * fl1_fx * tlx_yy_xyy_0[j] - 0.5 * fl1_fx * tpz_yy_xyyy_0[j] - fl1_fx * fl1_fgb * tdz_yy_xyyy_0[j];

                tly_yyy_xyyy_0[j] = pa_y[j] * tly_yy_xyyy_0[j] + fl1_fx * tly_y_xyyy_0[j] + 1.5 * fl1_fx * tly_yy_xyy_0[j];

                tlz_yyy_xyyy_0[j] = pa_y[j] * tlz_yy_xyyy_0[j] + fl1_fx * tlz_y_xyyy_0[j] + 1.5 * fl1_fx * tlz_yy_xyy_0[j] + 0.5 * fl1_fx * tpx_yy_xyyy_0[j] + fl1_fx * fl1_fgb * tdx_yy_xyyy_0[j];

                tlx_yyy_xyyz_0[j] = pa_y[j] * tlx_yy_xyyz_0[j] + fl1_fx * tlx_y_xyyz_0[j] + fl1_fx * tlx_yy_xyz_0[j] - 0.5 * fl1_fx * tpz_yy_xyyz_0[j] - fl1_fx * fl1_fgb * tdz_yy_xyyz_0[j];

                tly_yyy_xyyz_0[j] = pa_y[j] * tly_yy_xyyz_0[j] + fl1_fx * tly_y_xyyz_0[j] + fl1_fx * tly_yy_xyz_0[j];

                tlz_yyy_xyyz_0[j] = pa_y[j] * tlz_yy_xyyz_0[j] + fl1_fx * tlz_y_xyyz_0[j] + fl1_fx * tlz_yy_xyz_0[j] + 0.5 * fl1_fx * tpx_yy_xyyz_0[j] + fl1_fx * fl1_fgb * tdx_yy_xyyz_0[j];

                tlx_yyy_xyzz_0[j] = pa_y[j] * tlx_yy_xyzz_0[j] + fl1_fx * tlx_y_xyzz_0[j] + 0.5 * fl1_fx * tlx_yy_xzz_0[j] - 0.5 * fl1_fx * tpz_yy_xyzz_0[j] - fl1_fx * fl1_fgb * tdz_yy_xyzz_0[j];

                tly_yyy_xyzz_0[j] = pa_y[j] * tly_yy_xyzz_0[j] + fl1_fx * tly_y_xyzz_0[j] + 0.5 * fl1_fx * tly_yy_xzz_0[j];

                tlz_yyy_xyzz_0[j] = pa_y[j] * tlz_yy_xyzz_0[j] + fl1_fx * tlz_y_xyzz_0[j] + 0.5 * fl1_fx * tlz_yy_xzz_0[j] + 0.5 * fl1_fx * tpx_yy_xyzz_0[j] + fl1_fx * fl1_fgb * tdx_yy_xyzz_0[j];

                tlx_yyy_xzzz_0[j] = pa_y[j] * tlx_yy_xzzz_0[j] + fl1_fx * tlx_y_xzzz_0[j] - 0.5 * fl1_fx * tpz_yy_xzzz_0[j] - fl1_fx * fl1_fgb * tdz_yy_xzzz_0[j];

                tly_yyy_xzzz_0[j] = pa_y[j] * tly_yy_xzzz_0[j] + fl1_fx * tly_y_xzzz_0[j];

                tlz_yyy_xzzz_0[j] = pa_y[j] * tlz_yy_xzzz_0[j] + fl1_fx * tlz_y_xzzz_0[j] + 0.5 * fl1_fx * tpx_yy_xzzz_0[j] + fl1_fx * fl1_fgb * tdx_yy_xzzz_0[j];
            }
                                     ...
                                     const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tlx_yyy_yyyy_0[j] = pa_y[j] * tlx_yy_yyyy_0[j] + fl1_fx * tlx_y_yyyy_0[j] + 2.0 * fl1_fx * tlx_yy_yyy_0[j] - 0.5 * fl1_fx * tpz_yy_yyyy_0[j] - fl1_fx * fl1_fgb * tdz_yy_yyyy_0[j];

                tly_yyy_yyyy_0[j] = pa_y[j] * tly_yy_yyyy_0[j] + fl1_fx * tly_y_yyyy_0[j] + 2.0 * fl1_fx * tly_yy_yyy_0[j];

                tlz_yyy_yyyy_0[j] = pa_y[j] * tlz_yy_yyyy_0[j] + fl1_fx * tlz_y_yyyy_0[j] + 2.0 * fl1_fx * tlz_yy_yyy_0[j] + 0.5 * fl1_fx * tpx_yy_yyyy_0[j] + fl1_fx * fl1_fgb * tdx_yy_yyyy_0[j];

                tlx_yyy_yyyz_0[j] = pa_y[j] * tlx_yy_yyyz_0[j] + fl1_fx * tlx_y_yyyz_0[j] + 1.5 * fl1_fx * tlx_yy_yyz_0[j] - 0.5 * fl1_fx * tpz_yy_yyyz_0[j] - fl1_fx * fl1_fgb * tdz_yy_yyyz_0[j];

                tly_yyy_yyyz_0[j] = pa_y[j] * tly_yy_yyyz_0[j] + fl1_fx * tly_y_yyyz_0[j] + 1.5 * fl1_fx * tly_yy_yyz_0[j];

                tlz_yyy_yyyz_0[j] = pa_y[j] * tlz_yy_yyyz_0[j] + fl1_fx * tlz_y_yyyz_0[j] + 1.5 * fl1_fx * tlz_yy_yyz_0[j] + 0.5 * fl1_fx * tpx_yy_yyyz_0[j] + fl1_fx * fl1_fgb * tdx_yy_yyyz_0[j];

                tlx_yyy_yyzz_0[j] = pa_y[j] * tlx_yy_yyzz_0[j] + fl1_fx * tlx_y_yyzz_0[j] + fl1_fx * tlx_yy_yzz_0[j] - 0.5 * fl1_fx * tpz_yy_yyzz_0[j] - fl1_fx * fl1_fgb * tdz_yy_yyzz_0[j];

                tly_yyy_yyzz_0[j] = pa_y[j] * tly_yy_yyzz_0[j] + fl1_fx * tly_y_yyzz_0[j] + fl1_fx * tly_yy_yzz_0[j];

                tlz_yyy_yyzz_0[j] = pa_y[j] * tlz_yy_yyzz_0[j] + fl1_fx * tlz_y_yyzz_0[j] + fl1_fx * tlz_yy_yzz_0[j] + 0.5 * fl1_fx * tpx_yy_yyzz_0[j] + fl1_fx * fl1_fgb * tdx_yy_yyzz_0[j];

                tlx_yyy_yzzz_0[j] = pa_y[j] * tlx_yy_yzzz_0[j] + fl1_fx * tlx_y_yzzz_0[j] + 0.5 * fl1_fx * tlx_yy_zzz_0[j] - 0.5 * fl1_fx * tpz_yy_yzzz_0[j] - fl1_fx * fl1_fgb * tdz_yy_yzzz_0[j];

                tly_yyy_yzzz_0[j] = pa_y[j] * tly_yy_yzzz_0[j] + fl1_fx * tly_y_yzzz_0[j] + 0.5 * fl1_fx * tly_yy_zzz_0[j];

                tlz_yyy_yzzz_0[j] = pa_y[j] * tlz_yy_yzzz_0[j] + fl1_fx * tlz_y_yzzz_0[j] + 0.5 * fl1_fx * tlz_yy_zzz_0[j] + 0.5 * fl1_fx * tpx_yy_yzzz_0[j] + fl1_fx * fl1_fgb * tdx_yy_yzzz_0[j];

                tlx_yyy_zzzz_0[j] = pa_y[j] * tlx_yy_zzzz_0[j] + fl1_fx * tlx_y_zzzz_0[j] - 0.5 * fl1_fx * tpz_yy_zzzz_0[j] - fl1_fx * fl1_fgb * tdz_yy_zzzz_0[j];

                tly_yyy_zzzz_0[j] = pa_y[j] * tly_yy_zzzz_0[j] + fl1_fx * tly_y_zzzz_0[j];

                tlz_yyy_zzzz_0[j] = pa_y[j] * tlz_yy_zzzz_0[j] + fl1_fx * tlz_y_zzzz_0[j] + 0.5 * fl1_fx * tpx_yy_zzzz_0[j] + fl1_fx * fl1_fgb * tdx_yy_zzzz_0[j];

                tlx_yyz_xxxx_0[j] = pa_y[j] * tlx_yz_xxxx_0[j] + 0.5 * fl1_fx * tlx_z_xxxx_0[j] - 0.5 * fl1_fx * tpz_yz_xxxx_0[j] - fl1_fx * fl1_fgb * tdz_yz_xxxx_0[j];

                tly_yyz_xxxx_0[j] = pa_y[j] * tly_yz_xxxx_0[j] + 0.5 * fl1_fx * tly_z_xxxx_0[j];

                tlz_yyz_xxxx_0[j] = pa_y[j] * tlz_yz_xxxx_0[j] + 0.5 * fl1_fx * tlz_z_xxxx_0[j] + 0.5 * fl1_fx * tpx_yz_xxxx_0[j] + fl1_fx * fl1_fgb * tdx_yz_xxxx_0[j];

                tlx_yyz_xxxy_0[j] = pa_y[j] * tlx_yz_xxxy_0[j] + 0.5 * fl1_fx * tlx_z_xxxy_0[j] + 0.5 * fl1_fx * tlx_yz_xxx_0[j] - 0.5 * fl1_fx * tpz_yz_xxxy_0[j] - fl1_fx * fl1_fgb * tdz_yz_xxxy_0[j];

                tly_yyz_xxxy_0[j] = pa_y[j] * tly_yz_xxxy_0[j] + 0.5 * fl1_fx * tly_z_xxxy_0[j] + 0.5 * fl1_fx * tly_yz_xxx_0[j];

                tlz_yyz_xxxy_0[j] = pa_y[j] * tlz_yz_xxxy_0[j] + 0.5 * fl1_fx * tlz_z_xxxy_0[j] + 0.5 * fl1_fx * tlz_yz_xxx_0[j] + 0.5 * fl1_fx * tpx_yz_xxxy_0[j] + fl1_fx * fl1_fgb * tdx_yz_xxxy_0[j];

                tlx_yyz_xxxz_0[j] = pa_y[j] * tlx_yz_xxxz_0[j] + 0.5 * fl1_fx * tlx_z_xxxz_0[j] - 0.5 * fl1_fx * tpz_yz_xxxz_0[j] - fl1_fx * fl1_fgb * tdz_yz_xxxz_0[j];

                tly_yyz_xxxz_0[j] = pa_y[j] * tly_yz_xxxz_0[j] + 0.5 * fl1_fx * tly_z_xxxz_0[j];

                tlz_yyz_xxxz_0[j] = pa_y[j] * tlz_yz_xxxz_0[j] + 0.5 * fl1_fx * tlz_z_xxxz_0[j] + 0.5 * fl1_fx * tpx_yz_xxxz_0[j] + fl1_fx * fl1_fgb * tdx_yz_xxxz_0[j];

                tlx_yyz_xxyy_0[j] = pa_y[j] * tlx_yz_xxyy_0[j] + 0.5 * fl1_fx * tlx_z_xxyy_0[j] + fl1_fx * tlx_yz_xxy_0[j] - 0.5 * fl1_fx * tpz_yz_xxyy_0[j] - fl1_fx * fl1_fgb * tdz_yz_xxyy_0[j];

                tly_yyz_xxyy_0[j] = pa_y[j] * tly_yz_xxyy_0[j] + 0.5 * fl1_fx * tly_z_xxyy_0[j] + fl1_fx * tly_yz_xxy_0[j];

                tlz_yyz_xxyy_0[j] = pa_y[j] * tlz_yz_xxyy_0[j] + 0.5 * fl1_fx * tlz_z_xxyy_0[j] + fl1_fx * tlz_yz_xxy_0[j] + 0.5 * fl1_fx * tpx_yz_xxyy_0[j] + fl1_fx * fl1_fgb * tdx_yz_xxyy_0[j];

                tlx_yyz_xxyz_0[j] = pa_y[j] * tlx_yz_xxyz_0[j] + 0.5 * fl1_fx * tlx_z_xxyz_0[j] + 0.5 * fl1_fx * tlx_yz_xxz_0[j] - 0.5 * fl1_fx * tpz_yz_xxyz_0[j] - fl1_fx * fl1_fgb * tdz_yz_xxyz_0[j];

                tly_yyz_xxyz_0[j] = pa_y[j] * tly_yz_xxyz_0[j] + 0.5 * fl1_fx * tly_z_xxyz_0[j] + 0.5 * fl1_fx * tly_yz_xxz_0[j];

                tlz_yyz_xxyz_0[j] = pa_y[j] * tlz_yz_xxyz_0[j] + 0.5 * fl1_fx * tlz_z_xxyz_0[j] + 0.5 * fl1_fx * tlz_yz_xxz_0[j] + 0.5 * fl1_fx * tpx_yz_xxyz_0[j] + fl1_fx * fl1_fgb * tdx_yz_xxyz_0[j];

                tlx_yyz_xxzz_0[j] = pa_y[j] * tlx_yz_xxzz_0[j] + 0.5 * fl1_fx * tlx_z_xxzz_0[j] - 0.5 * fl1_fx * tpz_yz_xxzz_0[j] - fl1_fx * fl1_fgb * tdz_yz_xxzz_0[j];

                tly_yyz_xxzz_0[j] = pa_y[j] * tly_yz_xxzz_0[j] + 0.5 * fl1_fx * tly_z_xxzz_0[j];

                tlz_yyz_xxzz_0[j] = pa_y[j] * tlz_yz_xxzz_0[j] + 0.5 * fl1_fx * tlz_z_xxzz_0[j] + 0.5 * fl1_fx * tpx_yz_xxzz_0[j] + fl1_fx * fl1_fgb * tdx_yz_xxzz_0[j];

                tlx_yyz_xyyy_0[j] = pa_y[j] * tlx_yz_xyyy_0[j] + 0.5 * fl1_fx * tlx_z_xyyy_0[j] + 1.5 * fl1_fx * tlx_yz_xyy_0[j] - 0.5 * fl1_fx * tpz_yz_xyyy_0[j] - fl1_fx * fl1_fgb * tdz_yz_xyyy_0[j];

                tly_yyz_xyyy_0[j] = pa_y[j] * tly_yz_xyyy_0[j] + 0.5 * fl1_fx * tly_z_xyyy_0[j] + 1.5 * fl1_fx * tly_yz_xyy_0[j];

                tlz_yyz_xyyy_0[j] = pa_y[j] * tlz_yz_xyyy_0[j] + 0.5 * fl1_fx * tlz_z_xyyy_0[j] + 1.5 * fl1_fx * tlz_yz_xyy_0[j] + 0.5 * fl1_fx * tpx_yz_xyyy_0[j] + fl1_fx * fl1_fgb * tdx_yz_xyyy_0[j];

                tlx_yyz_xyyz_0[j] = pa_y[j] * tlx_yz_xyyz_0[j] + 0.5 * fl1_fx * tlx_z_xyyz_0[j] + fl1_fx * tlx_yz_xyz_0[j] - 0.5 * fl1_fx * tpz_yz_xyyz_0[j] - fl1_fx * fl1_fgb * tdz_yz_xyyz_0[j];

                tly_yyz_xyyz_0[j] = pa_y[j] * tly_yz_xyyz_0[j] + 0.5 * fl1_fx * tly_z_xyyz_0[j] + fl1_fx * tly_yz_xyz_0[j];

                tlz_yyz_xyyz_0[j] = pa_y[j] * tlz_yz_xyyz_0[j] + 0.5 * fl1_fx * tlz_z_xyyz_0[j] + fl1_fx * tlz_yz_xyz_0[j] + 0.5 * fl1_fx * tpx_yz_xyyz_0[j] + fl1_fx * fl1_fgb * tdx_yz_xyyz_0[j];

                tlx_yyz_xyzz_0[j] = pa_y[j] * tlx_yz_xyzz_0[j] + 0.5 * fl1_fx * tlx_z_xyzz_0[j] + 0.5 * fl1_fx * tlx_yz_xzz_0[j] - 0.5 * fl1_fx * tpz_yz_xyzz_0[j] - fl1_fx * fl1_fgb * tdz_yz_xyzz_0[j];

                tly_yyz_xyzz_0[j] = pa_y[j] * tly_yz_xyzz_0[j] + 0.5 * fl1_fx * tly_z_xyzz_0[j] + 0.5 * fl1_fx * tly_yz_xzz_0[j];

                tlz_yyz_xyzz_0[j] = pa_y[j] * tlz_yz_xyzz_0[j] + 0.5 * fl1_fx * tlz_z_xyzz_0[j] + 0.5 * fl1_fx * tlz_yz_xzz_0[j] + 0.5 * fl1_fx * tpx_yz_xyzz_0[j] + fl1_fx * fl1_fgb * tdx_yz_xyzz_0[j];

                tlx_yyz_xzzz_0[j] = pa_y[j] * tlx_yz_xzzz_0[j] + 0.5 * fl1_fx * tlx_z_xzzz_0[j] - 0.5 * fl1_fx * tpz_yz_xzzz_0[j] - fl1_fx * fl1_fgb * tdz_yz_xzzz_0[j];

                tly_yyz_xzzz_0[j] = pa_y[j] * tly_yz_xzzz_0[j] + 0.5 * fl1_fx * tly_z_xzzz_0[j];

                tlz_yyz_xzzz_0[j] = pa_y[j] * tlz_yz_xzzz_0[j] + 0.5 * fl1_fx * tlz_z_xzzz_0[j] + 0.5 * fl1_fx * tpx_yz_xzzz_0[j] + fl1_fx * fl1_fgb * tdx_yz_xzzz_0[j];

                tlx_yyz_yyyy_0[j] = pa_y[j] * tlx_yz_yyyy_0[j] + 0.5 * fl1_fx * tlx_z_yyyy_0[j] + 2.0 * fl1_fx * tlx_yz_yyy_0[j] - 0.5 * fl1_fx * tpz_yz_yyyy_0[j] - fl1_fx * fl1_fgb * tdz_yz_yyyy_0[j];

                tly_yyz_yyyy_0[j] = pa_y[j] * tly_yz_yyyy_0[j] + 0.5 * fl1_fx * tly_z_yyyy_0[j] + 2.0 * fl1_fx * tly_yz_yyy_0[j];

                tlz_yyz_yyyy_0[j] = pa_y[j] * tlz_yz_yyyy_0[j] + 0.5 * fl1_fx * tlz_z_yyyy_0[j] + 2.0 * fl1_fx * tlz_yz_yyy_0[j] + 0.5 * fl1_fx * tpx_yz_yyyy_0[j] + fl1_fx * fl1_fgb * tdx_yz_yyyy_0[j];

                tlx_yyz_yyyz_0[j] = pa_y[j] * tlx_yz_yyyz_0[j] + 0.5 * fl1_fx * tlx_z_yyyz_0[j] + 1.5 * fl1_fx * tlx_yz_yyz_0[j] - 0.5 * fl1_fx * tpz_yz_yyyz_0[j] - fl1_fx * fl1_fgb * tdz_yz_yyyz_0[j];
                                     ...
                                     const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tlz_yyz_yyyz_0[j] = pa_y[j] * tlz_yz_yyyz_0[j] + 0.5 * fl1_fx * tlz_z_yyyz_0[j] + 1.5 * fl1_fx * tlz_yz_yyz_0[j] + 0.5 * fl1_fx * tpx_yz_yyyz_0[j] + fl1_fx * fl1_fgb * tdx_yz_yyyz_0[j];

                tlx_yyz_yyzz_0[j] = pa_y[j] * tlx_yz_yyzz_0[j] + 0.5 * fl1_fx * tlx_z_yyzz_0[j] + fl1_fx * tlx_yz_yzz_0[j] - 0.5 * fl1_fx * tpz_yz_yyzz_0[j] - fl1_fx * fl1_fgb * tdz_yz_yyzz_0[j];

                tly_yyz_yyzz_0[j] = pa_y[j] * tly_yz_yyzz_0[j] + 0.5 * fl1_fx * tly_z_yyzz_0[j] + fl1_fx * tly_yz_yzz_0[j];

                tlz_yyz_yyzz_0[j] = pa_y[j] * tlz_yz_yyzz_0[j] + 0.5 * fl1_fx * tlz_z_yyzz_0[j] + fl1_fx * tlz_yz_yzz_0[j] + 0.5 * fl1_fx * tpx_yz_yyzz_0[j] + fl1_fx * fl1_fgb * tdx_yz_yyzz_0[j];

                tlx_yyz_yzzz_0[j] = pa_y[j] * tlx_yz_yzzz_0[j] + 0.5 * fl1_fx * tlx_z_yzzz_0[j] + 0.5 * fl1_fx * tlx_yz_zzz_0[j] - 0.5 * fl1_fx * tpz_yz_yzzz_0[j] - fl1_fx * fl1_fgb * tdz_yz_yzzz_0[j];

                tly_yyz_yzzz_0[j] = pa_y[j] * tly_yz_yzzz_0[j] + 0.5 * fl1_fx * tly_z_yzzz_0[j] + 0.5 * fl1_fx * tly_yz_zzz_0[j];

                tlz_yyz_yzzz_0[j] = pa_y[j] * tlz_yz_yzzz_0[j] + 0.5 * fl1_fx * tlz_z_yzzz_0[j] + 0.5 * fl1_fx * tlz_yz_zzz_0[j] + 0.5 * fl1_fx * tpx_yz_yzzz_0[j] + fl1_fx * fl1_fgb * tdx_yz_yzzz_0[j];

                tlx_yyz_zzzz_0[j] = pa_y[j] * tlx_yz_zzzz_0[j] + 0.5 * fl1_fx * tlx_z_zzzz_0[j] - 0.5 * fl1_fx * tpz_yz_zzzz_0[j] - fl1_fx * fl1_fgb * tdz_yz_zzzz_0[j];

                tly_yyz_zzzz_0[j] = pa_y[j] * tly_yz_zzzz_0[j] + 0.5 * fl1_fx * tly_z_zzzz_0[j];

                tlz_yyz_zzzz_0[j] = pa_y[j] * tlz_yz_zzzz_0[j] + 0.5 * fl1_fx * tlz_z_zzzz_0[j] + 0.5 * fl1_fx * tpx_yz_zzzz_0[j] + fl1_fx * fl1_fgb * tdx_yz_zzzz_0[j];
                ...
                tlx_yzz_xxxy_0[j] = pa_y[j] * tlx_zz_xxxy_0[j] + 0.5 * fl1_fx * tlx_zz_xxx_0[j] - 0.5 * fl1_fx * tpz_zz_xxxy_0[j] - fl1_fx * fl1_fgb * tdz_zz_xxxy_0[j];

                tly_yzz_xxxy_0[j] = pa_y[j] * tly_zz_xxxy_0[j] + 0.5 * fl1_fx * tly_zz_xxx_0[j];

                tlz_yzz_xxxy_0[j] = pa_y[j] * tlz_zz_xxxy_0[j] + 0.5 * fl1_fx * tlz_zz_xxx_0[j] + 0.5 * fl1_fx * tpx_zz_xxxy_0[j] + fl1_fx * fl1_fgb * tdx_zz_xxxy_0[j];
                ...
                tlx_yzz_xxyy_0[j] = pa_y[j] * tlx_zz_xxyy_0[j] + fl1_fx * tlx_zz_xxy_0[j] - 0.5 * fl1_fx * tpz_zz_xxyy_0[j] - fl1_fx * fl1_fgb * tdz_zz_xxyy_0[j];

                tly_yzz_xxyy_0[j] = pa_y[j] * tly_zz_xxyy_0[j] + fl1_fx * tly_zz_xxy_0[j];

                tlz_yzz_xxyy_0[j] = pa_y[j] * tlz_zz_xxyy_0[j] + fl1_fx * tlz_zz_xxy_0[j] + 0.5 * fl1_fx * tpx_zz_xxyy_0[j] + fl1_fx * fl1_fgb * tdx_zz_xxyy_0[j];

                tlx_yzz_xxyz_0[j] = pa_y[j] * tlx_zz_xxyz_0[j] + 0.5 * fl1_fx * tlx_zz_xxz_0[j] - 0.5 * fl1_fx * tpz_zz_xxyz_0[j] - fl1_fx * fl1_fgb * tdz_zz_xxyz_0[j];

                tly_yzz_xxyz_0[j] = pa_y[j] * tly_zz_xxyz_0[j] + 0.5 * fl1_fx * tly_zz_xxz_0[j];

                tlz_yzz_xxyz_0[j] = pa_y[j] * tlz_zz_xxyz_0[j] + 0.5 * fl1_fx * tlz_zz_xxz_0[j] + 0.5 * fl1_fx * tpx_zz_xxyz_0[j] + fl1_fx * fl1_fgb * tdx_zz_xxyz_0[j];
                ...
                tlx_yzz_xyyy_0[j] = pa_y[j] * tlx_zz_xyyy_0[j] + 1.5 * fl1_fx * tlx_zz_xyy_0[j] - 0.5 * fl1_fx * tpz_zz_xyyy_0[j] - fl1_fx * fl1_fgb * tdz_zz_xyyy_0[j];

                tly_yzz_xyyy_0[j] = pa_y[j] * tly_zz_xyyy_0[j] + 1.5 * fl1_fx * tly_zz_xyy_0[j];

                tlz_yzz_xyyy_0[j] = pa_y[j] * tlz_zz_xyyy_0[j] + 1.5 * fl1_fx * tlz_zz_xyy_0[j] + 0.5 * fl1_fx * tpx_zz_xyyy_0[j] + fl1_fx * fl1_fgb * tdx_zz_xyyy_0[j];

                tlx_yzz_xyyz_0[j] = pa_y[j] * tlx_zz_xyyz_0[j] + fl1_fx * tlx_zz_xyz_0[j] - 0.5 * fl1_fx * tpz_zz_xyyz_0[j] - fl1_fx * fl1_fgb * tdz_zz_xyyz_0[j];

                tly_yzz_xyyz_0[j] = pa_y[j] * tly_zz_xyyz_0[j] + fl1_fx * tly_zz_xyz_0[j];

                tlz_yzz_xyyz_0[j] = pa_y[j] * tlz_zz_xyyz_0[j] + fl1_fx * tlz_zz_xyz_0[j] + 0.5 * fl1_fx * tpx_zz_xyyz_0[j] + fl1_fx * fl1_fgb * tdx_zz_xyyz_0[j];

                tlx_yzz_xyzz_0[j] = pa_y[j] * tlx_zz_xyzz_0[j] + 0.5 * fl1_fx * tlx_zz_xzz_0[j] - 0.5 * fl1_fx * tpz_zz_xyzz_0[j] - fl1_fx * fl1_fgb * tdz_zz_xyzz_0[j];

                tly_yzz_xyzz_0[j] = pa_y[j] * tly_zz_xyzz_0[j] + 0.5 * fl1_fx * tly_zz_xzz_0[j];

                tlz_yzz_xyzz_0[j] = pa_y[j] * tlz_zz_xyzz_0[j] + 0.5 * fl1_fx * tlz_zz_xzz_0[j] + 0.5 * fl1_fx * tpx_zz_xyzz_0[j] + fl1_fx * fl1_fgb * tdx_zz_xyzz_0[j];
                ...
                tlx_yzz_yyyy_0[j] = pa_y[j] * tlx_zz_yyyy_0[j] + 2.0 * fl1_fx * tlx_zz_yyy_0[j] - 0.5 * fl1_fx * tpz_zz_yyyy_0[j] - fl1_fx * fl1_fgb * tdz_zz_yyyy_0[j];

                tly_yzz_yyyy_0[j] = pa_y[j] * tly_zz_yyyy_0[j] + 2.0 * fl1_fx * tly_zz_yyy_0[j];

                tlz_yzz_yyyy_0[j] = pa_y[j] * tlz_zz_yyyy_0[j] + 2.0 * fl1_fx * tlz_zz_yyy_0[j] + 0.5 * fl1_fx * tpx_zz_yyyy_0[j] + fl1_fx * fl1_fgb * tdx_zz_yyyy_0[j];

                tlx_yzz_yyyz_0[j] = pa_y[j] * tlx_zz_yyyz_0[j] + 1.5 * fl1_fx * tlx_zz_yyz_0[j] - 0.5 * fl1_fx * tpz_zz_yyyz_0[j] - fl1_fx * fl1_fgb * tdz_zz_yyyz_0[j];

                tly_yzz_yyyz_0[j] = pa_y[j] * tly_zz_yyyz_0[j] + 1.5 * fl1_fx * tly_zz_yyz_0[j];

                tlz_yzz_yyyz_0[j] = pa_y[j] * tlz_zz_yyyz_0[j] + 1.5 * fl1_fx * tlz_zz_yyz_0[j] + 0.5 * fl1_fx * tpx_zz_yyyz_0[j] + fl1_fx * fl1_fgb * tdx_zz_yyyz_0[j];

                tlx_yzz_yyzz_0[j] = pa_y[j] * tlx_zz_yyzz_0[j] + fl1_fx * tlx_zz_yzz_0[j] - 0.5 * fl1_fx * tpz_zz_yyzz_0[j] - fl1_fx * fl1_fgb * tdz_zz_yyzz_0[j];

                tly_yzz_yyzz_0[j] = pa_y[j] * tly_zz_yyzz_0[j] + fl1_fx * tly_zz_yzz_0[j];

                tlz_yzz_yyzz_0[j] = pa_y[j] * tlz_zz_yyzz_0[j] + fl1_fx * tlz_zz_yzz_0[j] + 0.5 * fl1_fx * tpx_zz_yyzz_0[j] + fl1_fx * fl1_fgb * tdx_zz_yyzz_0[j];

                tlx_yzz_yzzz_0[j] = pa_y[j] * tlx_zz_yzzz_0[j] + 0.5 * fl1_fx * tlx_zz_zzz_0[j] - 0.5 * fl1_fx * tpz_zz_yzzz_0[j] - fl1_fx * fl1_fgb * tdz_zz_yzzz_0[j];
            }
                                     ...
                                     const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tlz_yzz_yzzz_0[j] = pa_y[j] * tlz_zz_yzzz_0[j] + 0.5 * fl1_fx * tlz_zz_zzz_0[j] + 0.5 * fl1_fx * tpx_zz_yzzz_0[j] + fl1_fx * fl1_fgb * tdx_zz_yzzz_0[j];
                ...
                tlx_zzz_xxxx_0[j] = pa_z[j] * tlx_zz_xxxx_0[j] + fl1_fx * tlx_z_xxxx_0[j] + 0.5 * fl1_fx * tpy_zz_xxxx_0[j] + fl1_fx * fl1_fgb * tdy_zz_xxxx_0[j];

                tly_zzz_xxxx_0[j] = pa_z[j] * tly_zz_xxxx_0[j] + fl1_fx * tly_z_xxxx_0[j] - 0.5 * fl1_fx * tpx_zz_xxxx_0[j] - fl1_fx * fl1_fgb * tdx_zz_xxxx_0[j];

                tlz_zzz_xxxx_0[j] = pa_z[j] * tlz_zz_xxxx_0[j] + fl1_fx * tlz_z_xxxx_0[j];

                tlx_zzz_xxxy_0[j] = pa_z[j] * tlx_zz_xxxy_0[j] + fl1_fx * tlx_z_xxxy_0[j] + 0.5 * fl1_fx * tpy_zz_xxxy_0[j] + fl1_fx * fl1_fgb * tdy_zz_xxxy_0[j];

                tly_zzz_xxxy_0[j] = pa_z[j] * tly_zz_xxxy_0[j] + fl1_fx * tly_z_xxxy_0[j] - 0.5 * fl1_fx * tpx_zz_xxxy_0[j] - fl1_fx * fl1_fgb * tdx_zz_xxxy_0[j];

                tlz_zzz_xxxy_0[j] = pa_z[j] * tlz_zz_xxxy_0[j] + fl1_fx * tlz_z_xxxy_0[j];

                tlx_zzz_xxxz_0[j] = pa_z[j] * tlx_zz_xxxz_0[j] + fl1_fx * tlx_z_xxxz_0[j] + 0.5 * fl1_fx * tlx_zz_xxx_0[j] + 0.5 * fl1_fx * tpy_zz_xxxz_0[j] + fl1_fx * fl1_fgb * tdy_zz_xxxz_0[j];

                tly_zzz_xxxz_0[j] = pa_z[j] * tly_zz_xxxz_0[j] + fl1_fx * tly_z_xxxz_0[j] + 0.5 * fl1_fx * tly_zz_xxx_0[j] - 0.5 * fl1_fx * tpx_zz_xxxz_0[j] - fl1_fx * fl1_fgb * tdx_zz_xxxz_0[j];

                tlz_zzz_xxxz_0[j] = pa_z[j] * tlz_zz_xxxz_0[j] + fl1_fx * tlz_z_xxxz_0[j] + 0.5 * fl1_fx * tlz_zz_xxx_0[j];

                tlx_zzz_xxyy_0[j] = pa_z[j] * tlx_zz_xxyy_0[j] + fl1_fx * tlx_z_xxyy_0[j] + 0.5 * fl1_fx * tpy_zz_xxyy_0[j] + fl1_fx * fl1_fgb * tdy_zz_xxyy_0[j];

                tly_zzz_xxyy_0[j] = pa_z[j] * tly_zz_xxyy_0[j] + fl1_fx * tly_z_xxyy_0[j] - 0.5 * fl1_fx * tpx_zz_xxyy_0[j] - fl1_fx * fl1_fgb * tdx_zz_xxyy_0[j];

                tlz_zzz_xxyy_0[j] = pa_z[j] * tlz_zz_xxyy_0[j] + fl1_fx * tlz_z_xxyy_0[j];

                tlx_zzz_xxyz_0[j] = pa_z[j] * tlx_zz_xxyz_0[j] + fl1_fx * tlx_z_xxyz_0[j] + 0.5 * fl1_fx * tlx_zz_xxy_0[j] + 0.5 * fl1_fx * tpy_zz_xxyz_0[j] + fl1_fx * fl1_fgb * tdy_zz_xxyz_0[j];

                tly_zzz_xxyz_0[j] = pa_z[j] * tly_zz_xxyz_0[j] + fl1_fx * tly_z_xxyz_0[j] + 0.5 * fl1_fx * tly_zz_xxy_0[j] - 0.5 * fl1_fx * tpx_zz_xxyz_0[j] - fl1_fx * fl1_fgb * tdx_zz_xxyz_0[j];

                tlz_zzz_xxyz_0[j] = pa_z[j] * tlz_zz_xxyz_0[j] + fl1_fx * tlz_z_xxyz_0[j] + 0.5 * fl1_fx * tlz_zz_xxy_0[j];

                tlx_zzz_xxzz_0[j] = pa_z[j] * tlx_zz_xxzz_0[j] + fl1_fx * tlx_z_xxzz_0[j] + fl1_fx * tlx_zz_xxz_0[j] + 0.5 * fl1_fx * tpy_zz_xxzz_0[j] + fl1_fx * fl1_fgb * tdy_zz_xxzz_0[j];

                tly_zzz_xxzz_0[j] = pa_z[j] * tly_zz_xxzz_0[j] + fl1_fx * tly_z_xxzz_0[j] + fl1_fx * tly_zz_xxz_0[j] - 0.5 * fl1_fx * tpx_zz_xxzz_0[j] - fl1_fx * fl1_fgb * tdx_zz_xxzz_0[j];

                tlz_zzz_xxzz_0[j] = pa_z[j] * tlz_zz_xxzz_0[j] + fl1_fx * tlz_z_xxzz_0[j] + fl1_fx * tlz_zz_xxz_0[j];

                tlx_zzz_xyyy_0[j] = pa_z[j] * tlx_zz_xyyy_0[j] + fl1_fx * tlx_z_xyyy_0[j] + 0.5 * fl1_fx * tpy_zz_xyyy_0[j] + fl1_fx * fl1_fgb * tdy_zz_xyyy_0[j];

                tly_zzz_xyyy_0[j] = pa_z[j] * tly_zz_xyyy_0[j] + fl1_fx * tly_z_xyyy_0[j] - 0.5 * fl1_fx * tpx_zz_xyyy_0[j] - fl1_fx * fl1_fgb * tdx_zz_xyyy_0[j];

                tlz_zzz_xyyy_0[j] = pa_z[j] * tlz_zz_xyyy_0[j] + fl1_fx * tlz_z_xyyy_0[j];

                tlx_zzz_xyyz_0[j] = pa_z[j] * tlx_zz_xyyz_0[j] + fl1_fx * tlx_z_xyyz_0[j] + 0.5 * fl1_fx * tlx_zz_xyy_0[j] + 0.5 * fl1_fx * tpy_zz_xyyz_0[j] + fl1_fx * fl1_fgb * tdy_zz_xyyz_0[j];

                tly_zzz_xyyz_0[j] = pa_z[j] * tly_zz_xyyz_0[j] + fl1_fx * tly_z_xyyz_0[j] + 0.5 * fl1_fx * tly_zz_xyy_0[j] - 0.5 * fl1_fx * tpx_zz_xyyz_0[j] - fl1_fx * fl1_fgb * tdx_zz_xyyz_0[j];

                tlz_zzz_xyyz_0[j] = pa_z[j] * tlz_zz_xyyz_0[j] + fl1_fx * tlz_z_xyyz_0[j] + 0.5 * fl1_fx * tlz_zz_xyy_0[j];

                tlx_zzz_xyzz_0[j] = pa_z[j] * tlx_zz_xyzz_0[j] + fl1_fx * tlx_z_xyzz_0[j] + fl1_fx * tlx_zz_xyz_0[j] + 0.5 * fl1_fx * tpy_zz_xyzz_0[j] + fl1_fx * fl1_fgb * tdy_zz_xyzz_0[j];

                tly_zzz_xyzz_0[j] = pa_z[j] * tly_zz_xyzz_0[j] + fl1_fx * tly_z_xyzz_0[j] + fl1_fx * tly_zz_xyz_0[j] - 0.5 * fl1_fx * tpx_zz_xyzz_0[j] - fl1_fx * fl1_fgb * tdx_zz_xyzz_0[j];

                tlz_zzz_xyzz_0[j] = pa_z[j] * tlz_zz_xyzz_0[j] + fl1_fx * tlz_z_xyzz_0[j] + fl1_fx * tlz_zz_xyz_0[j];

                tlx_zzz_xzzz_0[j] = pa_z[j] * tlx_zz_xzzz_0[j] + fl1_fx * tlx_z_xzzz_0[j] + 1.5 * fl1_fx * tlx_zz_xzz_0[j] + 0.5 * fl1_fx * tpy_zz_xzzz_0[j] + fl1_fx * fl1_fgb * tdy_zz_xzzz_0[j];

                tly_zzz_xzzz_0[j] = pa_z[j] * tly_zz_xzzz_0[j] + fl1_fx * tly_z_xzzz_0[j] + 1.5 * fl1_fx * tly_zz_xzz_0[j] - 0.5 * fl1_fx * tpx_zz_xzzz_0[j] - fl1_fx * fl1_fgb * tdx_zz_xzzz_0[j];

                tlz_zzz_xzzz_0[j] = pa_z[j] * tlz_zz_xzzz_0[j] + fl1_fx * tlz_z_xzzz_0[j] + 1.5 * fl1_fx * tlz_zz_xzz_0[j];

                tlx_zzz_yyyy_0[j] = pa_z[j] * tlx_zz_yyyy_0[j] + fl1_fx * tlx_z_yyyy_0[j] + 0.5 * fl1_fx * tpy_zz_yyyy_0[j] + fl1_fx * fl1_fgb * tdy_zz_yyyy_0[j];

                tly_zzz_yyyy_0[j] = pa_z[j] * tly_zz_yyyy_0[j] + fl1_fx * tly_z_yyyy_0[j] - 0.5 * fl1_fx * tpx_zz_yyyy_0[j] - fl1_fx * fl1_fgb * tdx_zz_yyyy_0[j];

                tlz_zzz_yyyy_0[j] = pa_z[j] * tlz_zz_yyyy_0[j] + fl1_fx * tlz_z_yyyy_0[j];

                tlx_zzz_yyyz_0[j] = pa_z[j] * tlx_zz_yyyz_0[j] + fl1_fx * tlx_z_yyyz_0[j] + 0.5 * fl1_fx * tlx_zz_yyy_0[j] + 0.5 * fl1_fx * tpy_zz_yyyz_0[j] + fl1_fx * fl1_fgb * tdy_zz_yyyz_0[j];

                tly_zzz_yyyz_0[j] = pa_z[j] * tly_zz_yyyz_0[j] + fl1_fx * tly_z_yyyz_0[j] + 0.5 * fl1_fx * tly_zz_yyy_0[j] - 0.5 * fl1_fx * tpx_zz_yyyz_0[j] - fl1_fx * fl1_fgb * tdx_zz_yyyz_0[j];

                tlz_zzz_yyyz_0[j] = pa_z[j] * tlz_zz_yyyz_0[j] + fl1_fx * tlz_z_yyyz_0[j] + 0.5 * fl1_fx * tlz_zz_yyy_0[j];

                tlx_zzz_yyzz_0[j] = pa_z[j] * tlx_zz_yyzz_0[j] + fl1_fx * tlx_z_yyzz_0[j] + fl1_fx * tlx_zz_yyz_0[j] + 0.5 * fl1_fx * tpy_zz_yyzz_0[j] + fl1_fx * fl1_fgb * tdy_zz_yyzz_0[j];

                tly_zzz_yyzz_0[j] = pa_z[j] * tly_zz_yyzz_0[j] + fl1_fx * tly_z_yyzz_0[j] + fl1_fx * tly_zz_yyz_0[j] - 0.5 * fl1_fx * tpx_zz_yyzz_0[j] - fl1_fx * fl1_fgb * tdx_zz_yyzz_0[j];

                tlz_zzz_yyzz_0[j] = pa_z[j] * tlz_zz_yyzz_0[j] + fl1_fx * tlz_z_yyzz_0[j] + fl1_fx * tlz_zz_yyz_0[j];

                tlx_zzz_yzzz_0[j] = pa_z[j] * tlx_zz_yzzz_0[j] + fl1_fx * tlx_z_yzzz_0[j] + 1.5 * fl1_fx * tlx_zz_yzz_0[j] + 0.5 * fl1_fx * tpy_zz_yzzz_0[j] + fl1_fx * fl1_fgb * tdy_zz_yzzz_0[j];

                tly_zzz_yzzz_0[j] = pa_z[j] * tly_zz_yzzz_0[j] + fl1_fx * tly_z_yzzz_0[j] + 1.5 * fl1_fx * tly_zz_yzz_0[j] - 0.5 * fl1_fx * tpx_zz_yzzz_0[j] - fl1_fx * fl1_fgb * tdx_zz_yzzz_0[j];

                tlz_zzz_yzzz_0[j] = pa_z[j] * tlz_zz_yzzz_0[j] + fl1_fx * tlz_z_yzzz_0[j] + 1.5 * fl1_fx * tlz_zz_yzz_0[j];

                tlx_zzz_zzzz_0[j] = pa_z[j] * tlx_zz_zzzz_0[j] + fl1_fx * tlx_z_zzzz_0[j] + 2.0 * fl1_fx * tlx_zz_zzz_0[j] + 0.5 * fl1_fx * tpy_zz_zzzz_0[j] + fl1_fx * fl1_fgb * tdy_zz_zzzz_0[j];

                tly_zzz_zzzz_0[j] = pa_z[j] * tly_zz_zzzz_0[j] + fl1_fx * tly_z_zzzz_0[j] + 2.0 * fl1_fx * tly_zz_zzz_0[j] - 0.5 * fl1_fx * tpx_zz_zzzz_0[j] - fl1_fx * fl1_fgb * tdx_zz_zzzz_0[j];
