...
{
    amomrecfunc::compAngularMomentumForDD_0_36(primBuffer, recursionMap, osFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    amomrecfunc::compAngularMomentumForDD_36_72(primBuffer, recursionMap, osFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    amomrecfunc::compAngularMomentumForDD_72_108(primBuffer, recursionMap, osFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
                              ...
                              const int32_t              iContrGto)
{
    ...
    auto pidx_d_1_2_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Electric Dipole"}, 1, true, {1, -1, -1, -1}, {2, -1, -1, -1}, 1, 1, 0));
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tly_xx_xx_0[j] = pa_x[j] * tly_x_xx_0[j] + 0.5 * fl1_fx * tly_0_xx_0[j] + fl1_fx * tly_x_x_0[j] + 0.5 * fl1_fx * tpz_x_xx_0[j] +
                             fl1_fx * fl1_fgb * tdz_x_xx_0[j];

            tlz_xx_xx_0[j] = pa_x[j] * tlz_x_xx_0[j] + 0.5 * fl1_fx * tlz_0_xx_0[j] + fl1_fx * tlz_x_x_0[j] - 0.5 * fl1_fx * tpy_x_xx_0[j] -
                             fl1_fx * fl1_fgb * tdy_x_xx_0[j];

            tlx_xx_xy_0[j] = pa_x[j] * tlx_x_xy_0[j] + 0.5 * fl1_fx * tlx_0_xy_0[j] + 0.5 * fl1_fx * tlx_x_y_0[j];

            tly_xx_xy_0[j] = pa_x[j] * tly_x_xy_0[j] + 0.5 * fl1_fx * tly_0_xy_0[j] + 0.5 * fl1_fx * tly_x_y_0[j] + 0.5 * fl1_fx * tpz_x_xy_0[j] +
                             fl1_fx * fl1_fgb * tdz_x_xy_0[j];

            tlz_xx_xy_0[j] = pa_x[j] * tlz_x_xy_0[j] + 0.5 * fl1_fx * tlz_0_xy_0[j] + 0.5 * fl1_fx * tlz_x_y_0[j] - 0.5 * fl1_fx * tpy_x_xy_0[j] -
                             fl1_fx * fl1_fgb * tdy_x_xy_0[j];

            tlx_xx_xz_0[j] = pa_x[j] * tlx_x_xz_0[j] + 0.5 * fl1_fx * tlx_0_xz_0[j] + 0.5 * fl1_fx * tlx_x_z_0[j];

            tly_xx_xz_0[j] = pa_x[j] * tly_x_xz_0[j] + 0.5 * fl1_fx * tly_0_xz_0[j] + 0.5 * fl1_fx * tly_x_z_0[j] + 0.5 * fl1_fx * tpz_x_xz_0[j] +
                             fl1_fx * fl1_fgb * tdz_x_xz_0[j];

            tlz_xx_xz_0[j] = pa_x[j] * tlz_x_xz_0[j] + 0.5 * fl1_fx * tlz_0_xz_0[j] + 0.5 * fl1_fx * tlz_x_z_0[j] - 0.5 * fl1_fx * tpy_x_xz_0[j] -
                             fl1_fx * fl1_fgb * tdy_x_xz_0[j];
                               ...
                               const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tlx_yy_xy_0[j] = pa_y[j] * tlx_y_xy_0[j] + 0.5 * fl1_fx * tlx_0_xy_0[j] + 0.5 * fl1_fx * tlx_y_x_0[j] - 0.5 * fl1_fx * tpz_y_xy_0[j] -
                             fl1_fx * fl1_fgb * tdz_y_xy_0[j];

            tly_yy_xy_0[j] = pa_y[j] * tly_y_xy_0[j] + 0.5 * fl1_fx * tly_0_xy_0[j] + 0.5 * fl1_fx * tly_y_x_0[j];

            tlz_yy_xy_0[j] = pa_y[j] * tlz_y_xy_0[j] + 0.5 * fl1_fx * tlz_0_xy_0[j] + 0.5 * fl1_fx * tlz_y_x_0[j] + 0.5 * fl1_fx * tpx_y_xy_0[j] +
                             fl1_fx * fl1_fgb * tdx_y_xy_0[j];
            ...
            tlx_yy_yy_0[j] = pa_y[j] * tlx_y_yy_0[j] + 0.5 * fl1_fx * tlx_0_yy_0[j] + fl1_fx * tlx_y_y_0[j] - 0.5 * fl1_fx * tpz_y_yy_0[j] -
                             fl1_fx * fl1_fgb * tdz_y_yy_0[j];

            tly_yy_yy_0[j] = pa_y[j] * tly_y_yy_0[j] + 0.5 * fl1_fx * tly_0_yy_0[j] + fl1_fx * tly_y_y_0[j];

            tlz_yy_yy_0[j] = pa_y[j] * tlz_y_yy_0[j] + 0.5 * fl1_fx * tlz_0_yy_0[j] + fl1_fx * tlz_y_y_0[j] + 0.5 * fl1_fx * tpx_y_yy_0[j] +
                             fl1_fx * fl1_fgb * tdx_y_yy_0[j];

            tlx_yy_yz_0[j] = pa_y[j] * tlx_y_yz_0[j] + 0.5 * fl1_fx * tlx_0_yz_0[j] + 0.5 * fl1_fx * tlx_y_z_0[j] - 0.5 * fl1_fx * tpz_y_yz_0[j] -
                             fl1_fx * fl1_fgb * tdz_y_yz_0[j];

            tly_yy_yz_0[j] = pa_y[j] * tly_y_yz_0[j] + 0.5 * fl1_fx * tly_0_yz_0[j] + 0.5 * fl1_fx * tly_y_z_0[j];

            tlz_yy_yz_0[j] = pa_y[j] * tlz_y_yz_0[j] + 0.5 * fl1_fx * tlz_0_yz_0[j] + 0.5 * fl1_fx * tlz_y_z_0[j] + 0.5 * fl1_fx * tpx_y_yz_0[j] +
                             fl1_fx * fl1_fgb * tdx_y_yz_0[j];
                                ...
                                const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tlx_zz_xz_0[j] = pa_z[j] * tlx_z_xz_0[j] + 0.5 * fl1_fx * tlx_0_xz_0[j] + 0.5 * fl1_fx * tlx_z_x_0[j] + 0.5 * fl1_fx * tpy_z_xz_0[j] +
                             fl1_fx * fl1_fgb * tdy_z_xz_0[j];

            tly_zz_xz_0[j] = pa_z[j] * tly_z_xz_0[j] + 0.5 * fl1_fx * tly_0_xz_0[j] + 0.5 * fl1_fx * tly_z_x_0[j] - 0.5 * fl1_fx * tpx_z_xz_0[j] -
                             fl1_fx * fl1_fgb * tdx_z_xz_0[j];
            ...
            tlx_zz_yz_0[j] = pa_z[j] * tlx_z_yz_0[j] + 0.5 * fl1_fx * tlx_0_yz_0[j] + 0.5 * fl1_fx * tlx_z_y_0[j] + 0.5 * fl1_fx * tpy_z_yz_0[j] +
                             fl1_fx * fl1_fgb * tdy_z_yz_0[j];

            tly_zz_yz_0[j] = pa_z[j] * tly_z_yz_0[j] + 0.5 * fl1_fx * tly_0_yz_0[j] + 0.5 * fl1_fx * tly_z_y_0[j] - 0.5 * fl1_fx * tpx_z_yz_0[j] -
                             fl1_fx * fl1_fgb * tdx_z_yz_0[j];

            tlz_zz_yz_0[j] = pa_z[j] * tlz_z_yz_0[j] + 0.5 * fl1_fx * tlz_0_yz_0[j] + 0.5 * fl1_fx * tlz_z_y_0[j];

            tlx_zz_zz_0[j] = pa_z[j] * tlx_z_zz_0[j] + 0.5 * fl1_fx * tlx_0_zz_0[j] + fl1_fx * tlx_z_z_0[j] + 0.5 * fl1_fx * tpy_z_zz_0[j] +
                             fl1_fx * fl1_fgb * tdy_z_zz_0[j];

            tly_zz_zz_0[j] = pa_z[j] * tly_z_zz_0[j] + 0.5 * fl1_fx * tly_0_zz_0[j] + fl1_fx * tly_z_z_0[j] - 0.5 * fl1_fx * tpx_z_zz_0[j] -
                             fl1_fx * fl1_fgb * tdx_z_zz_0[j];
...
compAngularMomentumForDF(CMemBlock2D<double>&       primBuffer,
                         ...
                         const int32_t              iContrGto)
{
    amomrecfunc::compAngularMomentumForDF_0_45(primBuffer, recursionMap, osFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    amomrecfunc::compAngularMomentumForDF_45_90(primBuffer, recursionMap, osFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    amomrecfunc::compAngularMomentumForDF_90_135(primBuffer, recursionMap, osFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    amomrecfunc::compAngularMomentumForDF_135_180(primBuffer, recursionMap, osFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
                              ...
                              const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tly_xx_xxx_0[j] = pa_x[j] * tly_x_xxx_0[j] + 0.5 * fl1_fx * tly_0_xxx_0[j] + 1.5 * fl1_fx * tly_x_xx_0[j] +
                              0.5 * fl1_fx * tpz_x_xxx_0[j] + fl1_fx * fl1_fgb * tdz_x_xxx_0[j];

            tlz_xx_xxx_0[j] = pa_x[j] * tlz_x_xxx_0[j] + 0.5 * fl1_fx * tlz_0_xxx_0[j] + 1.5 * fl1_fx * tlz_x_xx_0[j] -
                              0.5 * fl1_fx * tpy_x_xxx_0[j] - fl1_fx * fl1_fgb * tdy_x_xxx_0[j];

            tlx_xx_xxy_0[j] = pa_x[j] * tlx_x_xxy_0[j] + 0.5 * fl1_fx * tlx_0_xxy_0[j] + fl1_fx * tlx_x_xy_0[j];

            tly_xx_xxy_0[j] = pa_x[j] * tly_x_xxy_0[j] + 0.5 * fl1_fx * tly_0_xxy_0[j] + fl1_fx * tly_x_xy_0[j] + 0.5 * fl1_fx * tpz_x_xxy_0[j] +
                              fl1_fx * fl1_fgb * tdz_x_xxy_0[j];

            tlz_xx_xxy_0[j] = pa_x[j] * tlz_x_xxy_0[j] + 0.5 * fl1_fx * tlz_0_xxy_0[j] + fl1_fx * tlz_x_xy_0[j] - 0.5 * fl1_fx * tpy_x_xxy_0[j] -
                              fl1_fx * fl1_fgb * tdy_x_xxy_0[j];

            tlx_xx_xxz_0[j] = pa_x[j] * tlx_x_xxz_0[j] + 0.5 * fl1_fx * tlx_0_xxz_0[j] + fl1_fx * tlx_x_xz_0[j];

            tly_xx_xxz_0[j] = pa_x[j] * tly_x_xxz_0[j] + 0.5 * fl1_fx * tly_0_xxz_0[j] + fl1_fx * tly_x_xz_0[j] + 0.5 * fl1_fx * tpz_x_xxz_0[j] +
                              fl1_fx * fl1_fgb * tdz_x_xxz_0[j];

            tlz_xx_xxz_0[j] = pa_x[j] * tlz_x_xxz_0[j] + 0.5 * fl1_fx * tlz_0_xxz_0[j] + fl1_fx * tlz_x_xz_0[j] - 0.5 * fl1_fx * tpy_x_xxz_0[j] -
                              fl1_fx * fl1_fgb * tdy_x_xxz_0[j];

            tlx_xx_xyy_0[j] = pa_x[j] * tlx_x_xyy_0[j] + 0.5 * fl1_fx * tlx_0_xyy_0[j] + 0.5 * fl1_fx * tlx_x_yy_0[j];

            tly_xx_xyy_0[j] = pa_x[j] * tly_x_xyy_0[j] + 0.5 * fl1_fx * tly_0_xyy_0[j] + 0.5 * fl1_fx * tly_x_yy_0[j] +
                              0.5 * fl1_fx * tpz_x_xyy_0[j] + fl1_fx * fl1_fgb * tdz_x_xyy_0[j];

            tlz_xx_xyy_0[j] = pa_x[j] * tlz_x_xyy_0[j] + 0.5 * fl1_fx * tlz_0_xyy_0[j] + 0.5 * fl1_fx * tlz_x_yy_0[j] -
                              0.5 * fl1_fx * tpy_x_xyy_0[j] - fl1_fx * fl1_fgb * tdy_x_xyy_0[j];

            tlx_xx_xyz_0[j] = pa_x[j] * tlx_x_xyz_0[j] + 0.5 * fl1_fx * tlx_0_xyz_0[j] + 0.5 * fl1_fx * tlx_x_yz_0[j];

            tly_xx_xyz_0[j] = pa_x[j] * tly_x_xyz_0[j] + 0.5 * fl1_fx * tly_0_xyz_0[j] + 0.5 * fl1_fx * tly_x_yz_0[j] +
                              0.5 * fl1_fx * tpz_x_xyz_0[j] + fl1_fx * fl1_fgb * tdz_x_xyz_0[j];

            tlz_xx_xyz_0[j] = pa_x[j] * tlz_x_xyz_0[j] + 0.5 * fl1_fx * tlz_0_xyz_0[j] + 0.5 * fl1_fx * tlz_x_yz_0[j] -
                              0.5 * fl1_fx * tpy_x_xyz_0[j] - fl1_fx * fl1_fgb * tdy_x_xyz_0[j];

            tlx_xx_xzz_0[j] = pa_x[j] * tlx_x_xzz_0[j] + 0.5 * fl1_fx * tlx_0_xzz_0[j] + 0.5 * fl1_fx * tlx_x_zz_0[j];

            tly_xx_xzz_0[j] = pa_x[j] * tly_x_xzz_0[j] + 0.5 * fl1_fx * tly_0_xzz_0[j] + 0.5 * fl1_fx * tly_x_zz_0[j] +
                              0.5 * fl1_fx * tpz_x_xzz_0[j] + fl1_fx * fl1_fgb * tdz_x_xzz_0[j];

            tlz_xx_xzz_0[j] = pa_x[j] * tlz_x_xzz_0[j] + 0.5 * fl1_fx * tlz_0_xzz_0[j] + 0.5 * fl1_fx * tlz_x_zz_0[j] -
                              0.5 * fl1_fx * tpy_x_xzz_0[j] - fl1_fx * fl1_fgb * tdy_x_xzz_0[j];

            tlx_xx_yyy_0[j] = pa_x[j] * tlx_x_yyy_0[j] + 0.5 * fl1_fx * tlx_0_yyy_0[j];

            tly_xx_yyy_0[j] =
                pa_x[j] * tly_x_yyy_0[j] + 0.5 * fl1_fx * tly_0_yyy_0[j] + 0.5 * fl1_fx * tpz_x_yyy_0[j] + fl1_fx * fl1_fgb * tdz_x_yyy_0[j];

            tlz_xx_yyy_0[j] =
                pa_x[j] * tlz_x_yyy_0[j] + 0.5 * fl1_fx * tlz_0_yyy_0[j] - 0.5 * fl1_fx * tpy_x_yyy_0[j] - fl1_fx * fl1_fgb * tdy_x_yyy_0[j];

            tlx_xx_yyz_0[j] = pa_x[j] * tlx_x_yyz_0[j] + 0.5 * fl1_fx * tlx_0_yyz_0[j];

            tly_xx_yyz_0[j] =
                pa_x[j] * tly_x_yyz_0[j] + 0.5 * fl1_fx * tly_0_yyz_0[j] + 0.5 * fl1_fx * tpz_x_yyz_0[j] + fl1_fx * fl1_fgb * tdz_x_yyz_0[j];

            tlz_xx_yyz_0[j] =
                pa_x[j] * tlz_x_yyz_0[j] + 0.5 * fl1_fx * tlz_0_yyz_0[j] - 0.5 * fl1_fx * tpy_x_yyz_0[j] - fl1_fx * fl1_fgb * tdy_x_yyz_0[j];

            tlx_xx_yzz_0[j] = pa_x[j] * tlx_x_yzz_0[j] + 0.5 * fl1_fx * tlx_0_yzz_0[j];

            tly_xx_yzz_0[j] =
                pa_x[j] * tly_x_yzz_0[j] + 0.5 * fl1_fx * tly_0_yzz_0[j] + 0.5 * fl1_fx * tpz_x_yzz_0[j] + fl1_fx * fl1_fgb * tdz_x_yzz_0[j];

            tlz_xx_yzz_0[j] =
                pa_x[j] * tlz_x_yzz_0[j] + 0.5 * fl1_fx * tlz_0_yzz_0[j] - 0.5 * fl1_fx * tpy_x_yzz_0[j] - fl1_fx * fl1_fgb * tdy_x_yzz_0[j];

            tlx_xx_zzz_0[j] = pa_x[j] * tlx_x_zzz_0[j] + 0.5 * fl1_fx * tlx_0_zzz_0[j];

            tly_xx_zzz_0[j] =
                pa_x[j] * tly_x_zzz_0[j] + 0.5 * fl1_fx * tly_0_zzz_0[j] + 0.5 * fl1_fx * tpz_x_zzz_0[j] + fl1_fx * fl1_fgb * tdz_x_zzz_0[j];

            tlz_xx_zzz_0[j] =
                pa_x[j] * tlz_x_zzz_0[j] + 0.5 * fl1_fx * tlz_0_zzz_0[j] - 0.5 * fl1_fx * tpy_x_zzz_0[j] - fl1_fx * fl1_fgb * tdy_x_zzz_0[j];

            tlx_xy_xxx_0[j] = pa_x[j] * tlx_y_xxx_0[j] + 1.5 * fl1_fx * tlx_y_xx_0[j];

            tly_xy_xxx_0[j] =
                pa_x[j] * tly_y_xxx_0[j] + 1.5 * fl1_fx * tly_y_xx_0[j] + 0.5 * fl1_fx * tpz_y_xxx_0[j] + fl1_fx * fl1_fgb * tdz_y_xxx_0[j];

            tlz_xy_xxx_0[j] =
                pa_x[j] * tlz_y_xxx_0[j] + 1.5 * fl1_fx * tlz_y_xx_0[j] - 0.5 * fl1_fx * tpy_y_xxx_0[j] - fl1_fx * fl1_fgb * tdy_y_xxx_0[j];
            ...
            tly_xy_xyy_0[j] =
                pa_x[j] * tly_y_xyy_0[j] + 0.5 * fl1_fx * tly_y_yy_0[j] + 0.5 * fl1_fx * tpz_y_xyy_0[j] + fl1_fx * fl1_fgb * tdz_y_xyy_0[j];

            tlz_xy_xyy_0[j] =
                pa_x[j] * tlz_y_xyy_0[j] + 0.5 * fl1_fx * tlz_y_yy_0[j] - 0.5 * fl1_fx * tpy_y_xyy_0[j] - fl1_fx * fl1_fgb * tdy_y_xyy_0[j];

            tlx_xy_xyz_0[j] = pa_x[j] * tlx_y_xyz_0[j] + 0.5 * fl1_fx * tlx_y_yz_0[j];

            tly_xy_xyz_0[j] =
                pa_x[j] * tly_y_xyz_0[j] + 0.5 * fl1_fx * tly_y_yz_0[j] + 0.5 * fl1_fx * tpz_y_xyz_0[j] + fl1_fx * fl1_fgb * tdz_y_xyz_0[j];

            tlz_xy_xyz_0[j] =
                pa_x[j] * tlz_y_xyz_0[j] + 0.5 * fl1_fx * tlz_y_yz_0[j] - 0.5 * fl1_fx * tpy_y_xyz_0[j] - fl1_fx * fl1_fgb * tdy_y_xyz_0[j];
        }
                               ...
                               const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tly_xy_xzz_0[j] =
                pa_x[j] * tly_y_xzz_0[j] + 0.5 * fl1_fx * tly_y_zz_0[j] + 0.5 * fl1_fx * tpz_y_xzz_0[j] + fl1_fx * fl1_fgb * tdz_y_xzz_0[j];

            tlz_xy_xzz_0[j] =
                pa_x[j] * tlz_y_xzz_0[j] + 0.5 * fl1_fx * tlz_y_zz_0[j] - 0.5 * fl1_fx * tpy_y_xzz_0[j] - fl1_fx * fl1_fgb * tdy_y_xzz_0[j];
            ...
            tly_xz_xxx_0[j] =
                pa_x[j] * tly_z_xxx_0[j] + 1.5 * fl1_fx * tly_z_xx_0[j] + 0.5 * fl1_fx * tpz_z_xxx_0[j] + fl1_fx * fl1_fgb * tdz_z_xxx_0[j];

            tlz_xz_xxx_0[j] =
                pa_x[j] * tlz_z_xxx_0[j] + 1.5 * fl1_fx * tlz_z_xx_0[j] - 0.5 * fl1_fx * tpy_z_xxx_0[j] - fl1_fx * fl1_fgb * tdy_z_xxx_0[j];
            ...
            tly_xz_xyy_0[j] =
                pa_x[j] * tly_z_xyy_0[j] + 0.5 * fl1_fx * tly_z_yy_0[j] + 0.5 * fl1_fx * tpz_z_xyy_0[j] + fl1_fx * fl1_fgb * tdz_z_xyy_0[j];

            tlz_xz_xyy_0[j] =
                pa_x[j] * tlz_z_xyy_0[j] + 0.5 * fl1_fx * tlz_z_yy_0[j] - 0.5 * fl1_fx * tpy_z_xyy_0[j] - fl1_fx * fl1_fgb * tdy_z_xyy_0[j];

            tlx_xz_xyz_0[j] = pa_x[j] * tlx_z_xyz_0[j] + 0.5 * fl1_fx * tlx_z_yz_0[j];

            tly_xz_xyz_0[j] =
                pa_x[j] * tly_z_xyz_0[j] + 0.5 * fl1_fx * tly_z_yz_0[j] + 0.5 * fl1_fx * tpz_z_xyz_0[j] + fl1_fx * fl1_fgb * tdz_z_xyz_0[j];

            tlz_xz_xyz_0[j] =
                pa_x[j] * tlz_z_xyz_0[j] + 0.5 * fl1_fx * tlz_z_yz_0[j] - 0.5 * fl1_fx * tpy_z_xyz_0[j] - fl1_fx * fl1_fgb * tdy_z_xyz_0[j];

            tlx_xz_xzz_0[j] = pa_x[j] * tlx_z_xzz_0[j] + 0.5 * fl1_fx * tlx_z_zz_0[j];

            tly_xz_xzz_0[j] =
                pa_x[j] * tly_z_xzz_0[j] + 0.5 * fl1_fx * tly_z_zz_0[j] + 0.5 * fl1_fx * tpz_z_xzz_0[j] + fl1_fx * fl1_fgb * tdz_z_xzz_0[j];

            tlz_xz_xzz_0[j] =
                pa_x[j] * tlz_z_xzz_0[j] + 0.5 * fl1_fx * tlz_z_zz_0[j] - 0.5 * fl1_fx * tpy_z_xzz_0[j] - fl1_fx * fl1_fgb * tdy_z_xzz_0[j];
                                ...
                                const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tlx_yy_xxx_0[j] =
                pa_y[j] * tlx_y_xxx_0[j] + 0.5 * fl1_fx * tlx_0_xxx_0[j] - 0.5 * fl1_fx * tpz_y_xxx_0[j] - fl1_fx * fl1_fgb * tdz_y_xxx_0[j];

            tly_yy_xxx_0[j] = pa_y[j] * tly_y_xxx_0[j] + 0.5 * fl1_fx * tly_0_xxx_0[j];

            tlz_yy_xxx_0[j] =
                pa_y[j] * tlz_y_xxx_0[j] + 0.5 * fl1_fx * tlz_0_xxx_0[j] + 0.5 * fl1_fx * tpx_y_xxx_0[j] + fl1_fx * fl1_fgb * tdx_y_xxx_0[j];

            tlx_yy_xxy_0[j] = pa_y[j] * tlx_y_xxy_0[j] + 0.5 * fl1_fx * tlx_0_xxy_0[j] + 0.5 * fl1_fx * tlx_y_xx_0[j] -
                              0.5 * fl1_fx * tpz_y_xxy_0[j] - fl1_fx * fl1_fgb * tdz_y_xxy_0[j];

            tly_yy_xxy_0[j] = pa_y[j] * tly_y_xxy_0[j] + 0.5 * fl1_fx * tly_0_xxy_0[j] + 0.5 * fl1_fx * tly_y_xx_0[j];

            tlz_yy_xxy_0[j] = pa_y[j] * tlz_y_xxy_0[j] + 0.5 * fl1_fx * tlz_0_xxy_0[j] + 0.5 * fl1_fx * tlz_y_xx_0[j] +
                              0.5 * fl1_fx * tpx_y_xxy_0[j] + fl1_fx * fl1_fgb * tdx_y_xxy_0[j];

            tlx_yy_xxz_0[j] =
                pa_y[j] * tlx_y_xxz_0[j] + 0.5 * fl1_fx * tlx_0_xxz_0[j] - 0.5 * fl1_fx * tpz_y_xxz_0[j] - fl1_fx * fl1_fgb * tdz_y_xxz_0[j];

            tly_yy_xxz_0[j] = pa_y[j] * tly_y_xxz_0[j] + 0.5 * fl1_fx * tly_0_xxz_0[j];

            tlz_yy_xxz_0[j] =
                pa_y[j] * tlz_y_xxz_0[j] + 0.5 * fl1_fx * tlz_0_xxz_0[j] + 0.5 * fl1_fx * tpx_y_xxz_0[j] + fl1_fx * fl1_fgb * tdx_y_xxz_0[j];

            tlx_yy_xyy_0[j] = pa_y[j] * tlx_y_xyy_0[j] + 0.5 * fl1_fx * tlx_0_xyy_0[j] + fl1_fx * tlx_y_xy_0[j] - 0.5 * fl1_fx * tpz_y_xyy_0[j] -
                              fl1_fx * fl1_fgb * tdz_y_xyy_0[j];

            tly_yy_xyy_0[j] = pa_y[j] * tly_y_xyy_0[j] + 0.5 * fl1_fx * tly_0_xyy_0[j] + fl1_fx * tly_y_xy_0[j];

            tlz_yy_xyy_0[j] = pa_y[j] * tlz_y_xyy_0[j] + 0.5 * fl1_fx * tlz_0_xyy_0[j] + fl1_fx * tlz_y_xy_0[j] + 0.5 * fl1_fx * tpx_y_xyy_0[j] +
                              fl1_fx * fl1_fgb * tdx_y_xyy_0[j];

            tlx_yy_xyz_0[j] = pa_y[j] * tlx_y_xyz_0[j] + 0.5 * fl1_fx * tlx_0_xyz_0[j] + 0.5 * fl1_fx * tlx_y_xz_0[j] -
                              0.5 * fl1_fx * tpz_y_xyz_0[j] - fl1_fx * fl1_fgb * tdz_y_xyz_0[j];

            tly_yy_xyz_0[j] = pa_y[j] * tly_y_xyz_0[j] + 0.5 * fl1_fx * tly_0_xyz_0[j] + 0.5 * fl1_fx * tly_y_xz_0[j];

            tlz_yy_xyz_0[j] = pa_y[j] * tlz_y_xyz_0[j] + 0.5 * fl1_fx * tlz_0_xyz_0[j] + 0.5 * fl1_fx * tlz_y_xz_0[j] +
                              0.5 * fl1_fx * tpx_y_xyz_0[j] + fl1_fx * fl1_fgb * tdx_y_xyz_0[j];

            tlx_yy_xzz_0[j] =
                pa_y[j] * tlx_y_xzz_0[j] + 0.5 * fl1_fx * tlx_0_xzz_0[j] - 0.5 * fl1_fx * tpz_y_xzz_0[j] - fl1_fx * fl1_fgb * tdz_y_xzz_0[j];

            tly_yy_xzz_0[j] = pa_y[j] * tly_y_xzz_0[j] + 0.5 * fl1_fx * tly_0_xzz_0[j];

            tlz_yy_xzz_0[j] =
                pa_y[j] * tlz_y_xzz_0[j] + 0.5 * fl1_fx * tlz_0_xzz_0[j] + 0.5 * fl1_fx * tpx_y_xzz_0[j] + fl1_fx * fl1_fgb * tdx_y_xzz_0[j];

            tlx_yy_yyy_0[j] = pa_y[j] * tlx_y_yyy_0[j] + 0.5 * fl1_fx * tlx_0_yyy_0[j] + 1.5 * fl1_fx * tlx_y_yy_0[j] -
                              0.5 * fl1_fx * tpz_y_yyy_0[j] - fl1_fx * fl1_fgb * tdz_y_yyy_0[j];

            tly_yy_yyy_0[j] = pa_y[j] * tly_y_yyy_0[j] + 0.5 * fl1_fx * tly_0_yyy_0[j] + 1.5 * fl1_fx * tly_y_yy_0[j];

            tlz_yy_yyy_0[j] = pa_y[j] * tlz_y_yyy_0[j] + 0.5 * fl1_fx * tlz_0_yyy_0[j] + 1.5 * fl1_fx * tlz_y_yy_0[j] +
                              0.5 * fl1_fx * tpx_y_yyy_0[j] + fl1_fx * fl1_fgb * tdx_y_yyy_0[j];

            tlx_yy_yyz_0[j] = pa_y[j] * tlx_y_yyz_0[j] + 0.5 * fl1_fx * tlx_0_yyz_0[j] + fl1_fx * tlx_y_yz_0[j] - 0.5 * fl1_fx * tpz_y_yyz_0[j] -
                              fl1_fx * fl1_fgb * tdz_y_yyz_0[j];

            tly_yy_yyz_0[j] = pa_y[j] * tly_y_yyz_0[j] + 0.5 * fl1_fx * tly_0_yyz_0[j] + fl1_fx * tly_y_yz_0[j];

            tlz_yy_yyz_0[j] = pa_y[j] * tlz_y_yyz_0[j] + 0.5 * fl1_fx * tlz_0_yyz_0[j] + fl1_fx * tlz_y_yz_0[j] + 0.5 * fl1_fx * tpx_y_yyz_0[j] +
                              fl1_fx * fl1_fgb * tdx_y_yyz_0[j];

            tlx_yy_yzz_0[j] = pa_y[j] * tlx_y_yzz_0[j] + 0.5 * fl1_fx * tlx_0_yzz_0[j] + 0.5 * fl1_fx * tlx_y_zz_0[j] -
                              0.5 * fl1_fx * tpz_y_yzz_0[j] - fl1_fx * fl1_fgb * tdz_y_yzz_0[j];

            tly_yy_yzz_0[j] = pa_y[j] * tly_y_yzz_0[j] + 0.5 * fl1_fx * tly_0_yzz_0[j] + 0.5 * fl1_fx * tly_y_zz_0[j];

            tlz_yy_yzz_0[j] = pa_y[j] * tlz_y_yzz_0[j] + 0.5 * fl1_fx * tlz_0_yzz_0[j] + 0.5 * fl1_fx * tlz_y_zz_0[j] +
                              0.5 * fl1_fx * tpx_y_yzz_0[j] + fl1_fx * fl1_fgb * tdx_y_yzz_0[j];

            tlx_yy_zzz_0[j] =
                pa_y[j] * tlx_y_zzz_0[j] + 0.5 * fl1_fx * tlx_0_zzz_0[j] - 0.5 * fl1_fx * tpz_y_zzz_0[j] - fl1_fx * fl1_fgb * tdz_y_zzz_0[j];

            tly_yy_zzz_0[j] = pa_y[j] * tly_y_zzz_0[j] + 0.5 * fl1_fx * tly_0_zzz_0[j];

            tlz_yy_zzz_0[j] =
                pa_y[j] * tlz_y_zzz_0[j] + 0.5 * fl1_fx * tlz_0_zzz_0[j] + 0.5 * fl1_fx * tpx_y_zzz_0[j] + fl1_fx * fl1_fgb * tdx_y_zzz_0[j];
            ...
            tlx_yz_xxy_0[j] =
                pa_y[j] * tlx_z_xxy_0[j] + 0.5 * fl1_fx * tlx_z_xx_0[j] - 0.5 * fl1_fx * tpz_z_xxy_0[j] - fl1_fx * fl1_fgb * tdz_z_xxy_0[j];

            tly_yz_xxy_0[j] = pa_y[j] * tly_z_xxy_0[j] + 0.5 * fl1_fx * tly_z_xx_0[j];

            tlz_yz_xxy_0[j] =
                pa_y[j] * tlz_z_xxy_0[j] + 0.5 * fl1_fx * tlz_z_xx_0[j] + 0.5 * fl1_fx * tpx_z_xxy_0[j] + fl1_fx * fl1_fgb * tdx_z_xxy_0[j];
            ...
            tlx_yz_xyz_0[j] =
                pa_y[j] * tlx_z_xyz_0[j] + 0.5 * fl1_fx * tlx_z_xz_0[j] - 0.5 * fl1_fx * tpz_z_xyz_0[j] - fl1_fx * fl1_fgb * tdz_z_xyz_0[j];

            tly_yz_xyz_0[j] = pa_y[j] * tly_z_xyz_0[j] + 0.5 * fl1_fx * tly_z_xz_0[j];

            tlz_yz_xyz_0[j] =
                pa_y[j] * tlz_z_xyz_0[j] + 0.5 * fl1_fx * tlz_z_xz_0[j] + 0.5 * fl1_fx * tpx_z_xyz_0[j] + fl1_fx * fl1_fgb * tdx_z_xyz_0[j];
        }
                                 ...
                                 const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tlx_yz_yyy_0[j] =
                pa_y[j] * tlx_z_yyy_0[j] + 1.5 * fl1_fx * tlx_z_yy_0[j] - 0.5 * fl1_fx * tpz_z_yyy_0[j] - fl1_fx * fl1_fgb * tdz_z_yyy_0[j];

            tly_yz_yyy_0[j] = pa_y[j] * tly_z_yyy_0[j] + 1.5 * fl1_fx * tly_z_yy_0[j];

            tlz_yz_yyy_0[j] =
                pa_y[j] * tlz_z_yyy_0[j] + 1.5 * fl1_fx * tlz_z_yy_0[j] + 0.5 * fl1_fx * tpx_z_yyy_0[j] + fl1_fx * fl1_fgb * tdx_z_yyy_0[j];
            ...
            tlx_yz_yzz_0[j] =
                pa_y[j] * tlx_z_yzz_0[j] + 0.5 * fl1_fx * tlx_z_zz_0[j] - 0.5 * fl1_fx * tpz_z_yzz_0[j] - fl1_fx * fl1_fgb * tdz_z_yzz_0[j];

            tly_yz_yzz_0[j] = pa_y[j] * tly_z_yzz_0[j] + 0.5 * fl1_fx * tly_z_zz_0[j];

            tlz_yz_yzz_0[j] =
                pa_y[j] * tlz_z_yzz_0[j] + 0.5 * fl1_fx * tlz_z_zz_0[j] + 0.5 * fl1_fx * tpx_z_yzz_0[j] + fl1_fx * fl1_fgb * tdx_z_yzz_0[j];
            ...
            tlx_zz_xxx_0[j] =
                pa_z[j] * tlx_z_xxx_0[j] + 0.5 * fl1_fx * tlx_0_xxx_0[j] + 0.5 * fl1_fx * tpy_z_xxx_0[j] + fl1_fx * fl1_fgb * tdy_z_xxx_0[j];

            tly_zz_xxx_0[j] =
                pa_z[j] * tly_z_xxx_0[j] + 0.5 * fl1_fx * tly_0_xxx_0[j] - 0.5 * fl1_fx * tpx_z_xxx_0[j] - fl1_fx * fl1_fgb * tdx_z_xxx_0[j];

            tlz_zz_xxx_0[j] = pa_z[j] * tlz_z_xxx_0[j] + 0.5 * fl1_fx * tlz_0_xxx_0[j];

            tlx_zz_xxy_0[j] =
                pa_z[j] * tlx_z_xxy_0[j] + 0.5 * fl1_fx * tlx_0_xxy_0[j] + 0.5 * fl1_fx * tpy_z_xxy_0[j] + fl1_fx * fl1_fgb * tdy_z_xxy_0[j];

            tly_zz_xxy_0[j] =
                pa_z[j] * tly_z_xxy_0[j] + 0.5 * fl1_fx * tly_0_xxy_0[j] - 0.5 * fl1_fx * tpx_z_xxy_0[j] - fl1_fx * fl1_fgb * tdx_z_xxy_0[j];

            tlz_zz_xxy_0[j] = pa_z[j] * tlz_z_xxy_0[j] + 0.5 * fl1_fx * tlz_0_xxy_0[j];

            tlx_zz_xxz_0[j] = pa_z[j] * tlx_z_xxz_0[j] + 0.5 * fl1_fx * tlx_0_xxz_0[j] + 0.5 * fl1_fx * tlx_z_xx_0[j] +
                              0.5 * fl1_fx * tpy_z_xxz_0[j] + fl1_fx * fl1_fgb * tdy_z_xxz_0[j];

            tly_zz_xxz_0[j] = pa_z[j] * tly_z_xxz_0[j] + 0.5 * fl1_fx * tly_0_xxz_0[j] + 0.5 * fl1_fx * tly_z_xx_0[j] -
                              0.5 * fl1_fx * tpx_z_xxz_0[j] - fl1_fx * fl1_fgb * tdx_z_xxz_0[j];

            tlz_zz_xxz_0[j] = pa_z[j] * tlz_z_xxz_0[j] + 0.5 * fl1_fx * tlz_0_xxz_0[j] + 0.5 * fl1_fx * tlz_z_xx_0[j];

            tlx_zz_xyy_0[j] =
                pa_z[j] * tlx_z_xyy_0[j] + 0.5 * fl1_fx * tlx_0_xyy_0[j] + 0.5 * fl1_fx * tpy_z_xyy_0[j] + fl1_fx * fl1_fgb * tdy_z_xyy_0[j];

            tly_zz_xyy_0[j] =
                pa_z[j] * tly_z_xyy_0[j] + 0.5 * fl1_fx * tly_0_xyy_0[j] - 0.5 * fl1_fx * tpx_z_xyy_0[j] - fl1_fx * fl1_fgb * tdx_z_xyy_0[j];

            tlz_zz_xyy_0[j] = pa_z[j] * tlz_z_xyy_0[j] + 0.5 * fl1_fx * tlz_0_xyy_0[j];

            tlx_zz_xyz_0[j] = pa_z[j] * tlx_z_xyz_0[j] + 0.5 * fl1_fx * tlx_0_xyz_0[j] + 0.5 * fl1_fx * tlx_z_xy_0[j] +
                              0.5 * fl1_fx * tpy_z_xyz_0[j] + fl1_fx * fl1_fgb * tdy_z_xyz_0[j];

            tly_zz_xyz_0[j] = pa_z[j] * tly_z_xyz_0[j] + 0.5 * fl1_fx * tly_0_xyz_0[j] + 0.5 * fl1_fx * tly_z_xy_0[j] -
                              0.5 * fl1_fx * tpx_z_xyz_0[j] - fl1_fx * fl1_fgb * tdx_z_xyz_0[j];

            tlz_zz_xyz_0[j] = pa_z[j] * tlz_z_xyz_0[j] + 0.5 * fl1_fx * tlz_0_xyz_0[j] + 0.5 * fl1_fx * tlz_z_xy_0[j];

            tlx_zz_xzz_0[j] = pa_z[j] * tlx_z_xzz_0[j] + 0.5 * fl1_fx * tlx_0_xzz_0[j] + fl1_fx * tlx_z_xz_0[j] + 0.5 * fl1_fx * tpy_z_xzz_0[j] +
                              fl1_fx * fl1_fgb * tdy_z_xzz_0[j];

            tly_zz_xzz_0[j] = pa_z[j] * tly_z_xzz_0[j] + 0.5 * fl1_fx * tly_0_xzz_0[j] + fl1_fx * tly_z_xz_0[j] - 0.5 * fl1_fx * tpx_z_xzz_0[j] -
                              fl1_fx * fl1_fgb * tdx_z_xzz_0[j];

            tlz_zz_xzz_0[j] = pa_z[j] * tlz_z_xzz_0[j] + 0.5 * fl1_fx * tlz_0_xzz_0[j] + fl1_fx * tlz_z_xz_0[j];

            tlx_zz_yyy_0[j] =
                pa_z[j] * tlx_z_yyy_0[j] + 0.5 * fl1_fx * tlx_0_yyy_0[j] + 0.5 * fl1_fx * tpy_z_yyy_0[j] + fl1_fx * fl1_fgb * tdy_z_yyy_0[j];

            tly_zz_yyy_0[j] =
                pa_z[j] * tly_z_yyy_0[j] + 0.5 * fl1_fx * tly_0_yyy_0[j] - 0.5 * fl1_fx * tpx_z_yyy_0[j] - fl1_fx * fl1_fgb * tdx_z_yyy_0[j];

            tlz_zz_yyy_0[j] = pa_z[j] * tlz_z_yyy_0[j] + 0.5 * fl1_fx * tlz_0_yyy_0[j];

            tlx_zz_yyz_0[j] = pa_z[j] * tlx_z_yyz_0[j] + 0.5 * fl1_fx * tlx_0_yyz_0[j] + 0.5 * fl1_fx * tlx_z_yy_0[j] +
                              0.5 * fl1_fx * tpy_z_yyz_0[j] + fl1_fx * fl1_fgb * tdy_z_yyz_0[j];

            tly_zz_yyz_0[j] = pa_z[j] * tly_z_yyz_0[j] + 0.5 * fl1_fx * tly_0_yyz_0[j] + 0.5 * fl1_fx * tly_z_yy_0[j] -
                              0.5 * fl1_fx * tpx_z_yyz_0[j] - fl1_fx * fl1_fgb * tdx_z_yyz_0[j];

            tlz_zz_yyz_0[j] = pa_z[j] * tlz_z_yyz_0[j] + 0.5 * fl1_fx * tlz_0_yyz_0[j] + 0.5 * fl1_fx * tlz_z_yy_0[j];

            tlx_zz_yzz_0[j] = pa_z[j] * tlx_z_yzz_0[j] + 0.5 * fl1_fx * tlx_0_yzz_0[j] + fl1_fx * tlx_z_yz_0[j] + 0.5 * fl1_fx * tpy_z_yzz_0[j] +
                              fl1_fx * fl1_fgb * tdy_z_yzz_0[j];

            tly_zz_yzz_0[j] = pa_z[j] * tly_z_yzz_0[j] + 0.5 * fl1_fx * tly_0_yzz_0[j] + fl1_fx * tly_z_yz_0[j] - 0.5 * fl1_fx * tpx_z_yzz_0[j] -
                              fl1_fx * fl1_fgb * tdx_z_yzz_0[j];

            tlz_zz_yzz_0[j] = pa_z[j] * tlz_z_yzz_0[j] + 0.5 * fl1_fx * tlz_0_yzz_0[j] + fl1_fx * tlz_z_yz_0[j];

            tlx_zz_zzz_0[j] = pa_z[j] * tlx_z_zzz_0[j] + 0.5 * fl1_fx * tlx_0_zzz_0[j] + 1.5 * fl1_fx * tlx_z_zz_0[j] +
                              0.5 * fl1_fx * tpy_z_zzz_0[j] + fl1_fx * fl1_fgb * tdy_z_zzz_0[j];

            tly_zz_zzz_0[j] = pa_z[j] * tly_z_zzz_0[j] + 0.5 * fl1_fx * tly_0_zzz_0[j] + 1.5 * fl1_fx * tly_z_zz_0[j] -
                              0.5 * fl1_fx * tpx_z_zzz_0[j] - fl1_fx * fl1_fgb * tdx_z_zzz_0[j];
...
compAngularMomentumForFD(CMemBlock2D<double>&       primBuffer,
                         ...
                         const int32_t              iContrGto)
{
    amomrecfunc::compAngularMomentumForFD_0_45(primBuffer, recursionMap, osFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    amomrecfunc::compAngularMomentumForFD_45_90(primBuffer, recursionMap, osFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    amomrecfunc::compAngularMomentumForFD_90_135(primBuffer, recursionMap, osFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    amomrecfunc::compAngularMomentumForFD_135_180(primBuffer, recursionMap, osFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
                              ...
                              const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tly_xxx_xx_0[j] = pa_x[j] * tly_xx_xx_0[j] + fl1_fx * tly_x_xx_0[j] + fl1_fx * tly_xx_x_0[j] + 0.5 * fl1_fx * tpz_xx_xx_0[j] +
                              fl1_fx * fl1_fgb * tdz_xx_xx_0[j];

            tlz_xxx_xx_0[j] = pa_x[j] * tlz_xx_xx_0[j] + fl1_fx * tlz_x_xx_0[j] + fl1_fx * tlz_xx_x_0[j] - 0.5 * fl1_fx * tpy_xx_xx_0[j] -
                              fl1_fx * fl1_fgb * tdy_xx_xx_0[j];

            tlx_xxx_xy_0[j] = pa_x[j] * tlx_xx_xy_0[j] + fl1_fx * tlx_x_xy_0[j] + 0.5 * fl1_fx * tlx_xx_y_0[j];

            tly_xxx_xy_0[j] = pa_x[j] * tly_xx_xy_0[j] + fl1_fx * tly_x_xy_0[j] + 0.5 * fl1_fx * tly_xx_y_0[j] + 0.5 * fl1_fx * tpz_xx_xy_0[j] +
                              fl1_fx * fl1_fgb * tdz_xx_xy_0[j];

            tlz_xxx_xy_0[j] = pa_x[j] * tlz_xx_xy_0[j] + fl1_fx * tlz_x_xy_0[j] + 0.5 * fl1_fx * tlz_xx_y_0[j] - 0.5 * fl1_fx * tpy_xx_xy_0[j] -
                              fl1_fx * fl1_fgb * tdy_xx_xy_0[j];

            tlx_xxx_xz_0[j] = pa_x[j] * tlx_xx_xz_0[j] + fl1_fx * tlx_x_xz_0[j] + 0.5 * fl1_fx * tlx_xx_z_0[j];

            tly_xxx_xz_0[j] = pa_x[j] * tly_xx_xz_0[j] + fl1_fx * tly_x_xz_0[j] + 0.5 * fl1_fx * tly_xx_z_0[j] + 0.5 * fl1_fx * tpz_xx_xz_0[j] +
                              fl1_fx * fl1_fgb * tdz_xx_xz_0[j];

            tlz_xxx_xz_0[j] = pa_x[j] * tlz_xx_xz_0[j] + fl1_fx * tlz_x_xz_0[j] + 0.5 * fl1_fx * tlz_xx_z_0[j] - 0.5 * fl1_fx * tpy_xx_xz_0[j] -
                              fl1_fx * fl1_fgb * tdy_xx_xz_0[j];
            ...
            tly_xxy_xx_0[j] = pa_x[j] * tly_xy_xx_0[j] + 0.5 * fl1_fx * tly_y_xx_0[j] + fl1_fx * tly_xy_x_0[j] + 0.5 * fl1_fx * tpz_xy_xx_0[j] +
                              fl1_fx * fl1_fgb * tdz_xy_xx_0[j];

            tlz_xxy_xx_0[j] = pa_x[j] * tlz_xy_xx_0[j] + 0.5 * fl1_fx * tlz_y_xx_0[j] + fl1_fx * tlz_xy_x_0[j] - 0.5 * fl1_fx * tpy_xy_xx_0[j] -
                              fl1_fx * fl1_fgb * tdy_xy_xx_0[j];

            tlx_xxy_xy_0[j] = pa_x[j] * tlx_xy_xy_0[j] + 0.5 * fl1_fx * tlx_y_xy_0[j] + 0.5 * fl1_fx * tlx_xy_y_0[j];

            tly_xxy_xy_0[j] = pa_x[j] * tly_xy_xy_0[j] + 0.5 * fl1_fx * tly_y_xy_0[j] + 0.5 * fl1_fx * tly_xy_y_0[j] + 0.5 * fl1_fx * tpz_xy_xy_0[j] +
                              fl1_fx * fl1_fgb * tdz_xy_xy_0[j];

            tlz_xxy_xy_0[j] = pa_x[j] * tlz_xy_xy_0[j] + 0.5 * fl1_fx * tlz_y_xy_0[j] + 0.5 * fl1_fx * tlz_xy_y_0[j] - 0.5 * fl1_fx * tpy_xy_xy_0[j] -
                              fl1_fx * fl1_fgb * tdy_xy_xy_0[j];

            tlx_xxy_xz_0[j] = pa_x[j] * tlx_xy_xz_0[j] + 0.5 * fl1_fx * tlx_y_xz_0[j] + 0.5 * fl1_fx * tlx_xy_z_0[j];

            tly_xxy_xz_0[j] = pa_x[j] * tly_xy_xz_0[j] + 0.5 * fl1_fx * tly_y_xz_0[j] + 0.5 * fl1_fx * tly_xy_z_0[j] + 0.5 * fl1_fx * tpz_xy_xz_0[j] +
                              fl1_fx * fl1_fgb * tdz_xy_xz_0[j];

            tlz_xxy_xz_0[j] = pa_x[j] * tlz_xy_xz_0[j] + 0.5 * fl1_fx * tlz_y_xz_0[j] + 0.5 * fl1_fx * tlz_xy_z_0[j] - 0.5 * fl1_fx * tpy_xy_xz_0[j] -
                              fl1_fx * fl1_fgb * tdy_xy_xz_0[j];

            tlx_xxy_yy_0[j] = pa_x[j] * tlx_xy_yy_0[j] + 0.5 * fl1_fx * tlx_y_yy_0[j];

            tly_xxy_yy_0[j] =
                pa_x[j] * tly_xy_yy_0[j] + 0.5 * fl1_fx * tly_y_yy_0[j] + 0.5 * fl1_fx * tpz_xy_yy_0[j] + fl1_fx * fl1_fgb * tdz_xy_yy_0[j];

            tlz_xxy_yy_0[j] =
                pa_x[j] * tlz_xy_yy_0[j] + 0.5 * fl1_fx * tlz_y_yy_0[j] - 0.5 * fl1_fx * tpy_xy_yy_0[j] - fl1_fx * fl1_fgb * tdy_xy_yy_0[j];

            tlx_xxy_yz_0[j] = pa_x[j] * tlx_xy_yz_0[j] + 0.5 * fl1_fx * tlx_y_yz_0[j];

            tly_xxy_yz_0[j] =
                pa_x[j] * tly_xy_yz_0[j] + 0.5 * fl1_fx * tly_y_yz_0[j] + 0.5 * fl1_fx * tpz_xy_yz_0[j] + fl1_fx * fl1_fgb * tdz_xy_yz_0[j];

            tlz_xxy_yz_0[j] =
                pa_x[j] * tlz_xy_yz_0[j] + 0.5 * fl1_fx * tlz_y_yz_0[j] - 0.5 * fl1_fx * tpy_xy_yz_0[j] - fl1_fx * fl1_fgb * tdy_xy_yz_0[j];

            tlx_xxy_zz_0[j] = pa_x[j] * tlx_xy_zz_0[j] + 0.5 * fl1_fx * tlx_y_zz_0[j];

            tly_xxy_zz_0[j] =
                pa_x[j] * tly_xy_zz_0[j] + 0.5 * fl1_fx * tly_y_zz_0[j] + 0.5 * fl1_fx * tpz_xy_zz_0[j] + fl1_fx * fl1_fgb * tdz_xy_zz_0[j];

            tlz_xxy_zz_0[j] =
                pa_x[j] * tlz_xy_zz_0[j] + 0.5 * fl1_fx * tlz_y_zz_0[j] - 0.5 * fl1_fx * tpy_xy_zz_0[j] - fl1_fx * fl1_fgb * tdy_xy_zz_0[j];

            tlx_xxz_xx_0[j] = pa_x[j] * tlx_xz_xx_0[j] + 0.5 * fl1_fx * tlx_z_xx_0[j] + fl1_fx * tlx_xz_x_0[j];

            tly_xxz_xx_0[j] = pa_x[j] * tly_xz_xx_0[j] + 0.5 * fl1_fx * tly_z_xx_0[j] + fl1_fx * tly_xz_x_0[j] + 0.5 * fl1_fx * tpz_xz_xx_0[j] +
                              fl1_fx * fl1_fgb * tdz_xz_xx_0[j];

            tlz_xxz_xx_0[j] = pa_x[j] * tlz_xz_xx_0[j] + 0.5 * fl1_fx * tlz_z_xx_0[j] + fl1_fx * tlz_xz_x_0[j] - 0.5 * fl1_fx * tpy_xz_xx_0[j] -
                              fl1_fx * fl1_fgb * tdy_xz_xx_0[j];

            tlx_xxz_xy_0[j] = pa_x[j] * tlx_xz_xy_0[j] + 0.5 * fl1_fx * tlx_z_xy_0[j] + 0.5 * fl1_fx * tlx_xz_y_0[j];

            tly_xxz_xy_0[j] = pa_x[j] * tly_xz_xy_0[j] + 0.5 * fl1_fx * tly_z_xy_0[j] + 0.5 * fl1_fx * tly_xz_y_0[j] + 0.5 * fl1_fx * tpz_xz_xy_0[j] +
                              fl1_fx * fl1_fgb * tdz_xz_xy_0[j];

            tlz_xxz_xy_0[j] = pa_x[j] * tlz_xz_xy_0[j] + 0.5 * fl1_fx * tlz_z_xy_0[j] + 0.5 * fl1_fx * tlz_xz_y_0[j] - 0.5 * fl1_fx * tpy_xz_xy_0[j] -
                              fl1_fx * fl1_fgb * tdy_xz_xy_0[j];

            tlx_xxz_xz_0[j] = pa_x[j] * tlx_xz_xz_0[j] + 0.5 * fl1_fx * tlx_z_xz_0[j] + 0.5 * fl1_fx * tlx_xz_z_0[j];

            tly_xxz_xz_0[j] = pa_x[j] * tly_xz_xz_0[j] + 0.5 * fl1_fx * tly_z_xz_0[j] + 0.5 * fl1_fx * tly_xz_z_0[j] + 0.5 * fl1_fx * tpz_xz_xz_0[j] +
                              fl1_fx * fl1_fgb * tdz_xz_xz_0[j];

            tlz_xxz_xz_0[j] = pa_x[j] * tlz_xz_xz_0[j] + 0.5 * fl1_fx * tlz_z_xz_0[j] + 0.5 * fl1_fx * tlz_xz_z_0[j] - 0.5 * fl1_fx * tpy_xz_xz_0[j] -
                              fl1_fx * fl1_fgb * tdy_xz_xz_0[j];
        }
                               ...
                               const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tly_xxz_yy_0[j] =
                pa_x[j] * tly_xz_yy_0[j] + 0.5 * fl1_fx * tly_z_yy_0[j] + 0.5 * fl1_fx * tpz_xz_yy_0[j] + fl1_fx * fl1_fgb * tdz_xz_yy_0[j];

            tlz_xxz_yy_0[j] =
                pa_x[j] * tlz_xz_yy_0[j] + 0.5 * fl1_fx * tlz_z_yy_0[j] - 0.5 * fl1_fx * tpy_xz_yy_0[j] - fl1_fx * fl1_fgb * tdy_xz_yy_0[j];

            tlx_xxz_yz_0[j] = pa_x[j] * tlx_xz_yz_0[j] + 0.5 * fl1_fx * tlx_z_yz_0[j];

            tly_xxz_yz_0[j] =
                pa_x[j] * tly_xz_yz_0[j] + 0.5 * fl1_fx * tly_z_yz_0[j] + 0.5 * fl1_fx * tpz_xz_yz_0[j] + fl1_fx * fl1_fgb * tdz_xz_yz_0[j];

            tlz_xxz_yz_0[j] =
                pa_x[j] * tlz_xz_yz_0[j] + 0.5 * fl1_fx * tlz_z_yz_0[j] - 0.5 * fl1_fx * tpy_xz_yz_0[j] - fl1_fx * fl1_fgb * tdy_xz_yz_0[j];

            tlx_xxz_zz_0[j] = pa_x[j] * tlx_xz_zz_0[j] + 0.5 * fl1_fx * tlx_z_zz_0[j];

            tly_xxz_zz_0[j] =
                pa_x[j] * tly_xz_zz_0[j] + 0.5 * fl1_fx * tly_z_zz_0[j] + 0.5 * fl1_fx * tpz_xz_zz_0[j] + fl1_fx * fl1_fgb * tdz_xz_zz_0[j];

            tlz_xxz_zz_0[j] =
                pa_x[j] * tlz_xz_zz_0[j] + 0.5 * fl1_fx * tlz_z_zz_0[j] - 0.5 * fl1_fx * tpy_xz_zz_0[j] - fl1_fx * fl1_fgb * tdy_xz_zz_0[j];
            ...
            tly_xyy_xy_0[j] =
                pa_x[j] * tly_yy_xy_0[j] + 0.5 * fl1_fx * tly_yy_y_0[j] + 0.5 * fl1_fx * tpz_yy_xy_0[j] + fl1_fx * fl1_fgb * tdz_yy_xy_0[j];

            tlz_xyy_xy_0[j] =
                pa_x[j] * tlz_yy_xy_0[j] + 0.5 * fl1_fx * tlz_yy_y_0[j] - 0.5 * fl1_fx * tpy_yy_xy_0[j] - fl1_fx * fl1_fgb * tdy_yy_xy_0[j];

            tlx_xyy_xz_0[j] = pa_x[j] * tlx_yy_xz_0[j] + 0.5 * fl1_fx * tlx_yy_z_0[j];

            tly_xyy_xz_0[j] =
                pa_x[j] * tly_yy_xz_0[j] + 0.5 * fl1_fx * tly_yy_z_0[j] + 0.5 * fl1_fx * tpz_yy_xz_0[j] + fl1_fx * fl1_fgb * tdz_yy_xz_0[j];

            tlz_xyy_xz_0[j] =
                pa_x[j] * tlz_yy_xz_0[j] + 0.5 * fl1_fx * tlz_yy_z_0[j] - 0.5 * fl1_fx * tpy_yy_xz_0[j] - fl1_fx * fl1_fgb * tdy_yy_xz_0[j];
            ...
            tly_xyz_xy_0[j] =
                pa_x[j] * tly_yz_xy_0[j] + 0.5 * fl1_fx * tly_yz_y_0[j] + 0.5 * fl1_fx * tpz_yz_xy_0[j] + fl1_fx * fl1_fgb * tdz_yz_xy_0[j];

            tlz_xyz_xy_0[j] =
                pa_x[j] * tlz_yz_xy_0[j] + 0.5 * fl1_fx * tlz_yz_y_0[j] - 0.5 * fl1_fx * tpy_yz_xy_0[j] - fl1_fx * fl1_fgb * tdy_yz_xy_0[j];

            tlx_xyz_xz_0[j] = pa_x[j] * tlx_yz_xz_0[j] + 0.5 * fl1_fx * tlx_yz_z_0[j];

            tly_xyz_xz_0[j] =
                pa_x[j] * tly_yz_xz_0[j] + 0.5 * fl1_fx * tly_yz_z_0[j] + 0.5 * fl1_fx * tpz_yz_xz_0[j] + fl1_fx * fl1_fgb * tdz_yz_xz_0[j];

            tlz_xyz_xz_0[j] =
                pa_x[j] * tlz_yz_xz_0[j] + 0.5 * fl1_fx * tlz_yz_z_0[j] - 0.5 * fl1_fx * tpy_yz_xz_0[j] - fl1_fx * fl1_fgb * tdy_yz_xz_0[j];
                                ...
                                const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tly_xzz_xy_0[j] =
                pa_x[j] * tly_zz_xy_0[j] + 0.5 * fl1_fx * tly_zz_y_0[j] + 0.5 * fl1_fx * tpz_zz_xy_0[j] + fl1_fx * fl1_fgb * tdz_zz_xy_0[j];

            tlz_xzz_xy_0[j] =
                pa_x[j] * tlz_zz_xy_0[j] + 0.5 * fl1_fx * tlz_zz_y_0[j] - 0.5 * fl1_fx * tpy_zz_xy_0[j] - fl1_fx * fl1_fgb * tdy_zz_xy_0[j];

            tlx_xzz_xz_0[j] = pa_x[j] * tlx_zz_xz_0[j] + 0.5 * fl1_fx * tlx_zz_z_0[j];

            tly_xzz_xz_0[j] =
                pa_x[j] * tly_zz_xz_0[j] + 0.5 * fl1_fx * tly_zz_z_0[j] + 0.5 * fl1_fx * tpz_zz_xz_0[j] + fl1_fx * fl1_fgb * tdz_zz_xz_0[j];

            tlz_xzz_xz_0[j] =
                pa_x[j] * tlz_zz_xz_0[j] + 0.5 * fl1_fx * tlz_zz_z_0[j] - 0.5 * fl1_fx * tpy_zz_xz_0[j] - fl1_fx * fl1_fgb * tdy_zz_xz_0[j];
            ...
            tlx_yyy_xy_0[j] = pa_y[j] * tlx_yy_xy_0[j] + fl1_fx * tlx_y_xy_0[j] + 0.5 * fl1_fx * tlx_yy_x_0[j] - 0.5 * fl1_fx * tpz_yy_xy_0[j] -
                              fl1_fx * fl1_fgb * tdz_yy_xy_0[j];

            tly_yyy_xy_0[j] = pa_y[j] * tly_yy_xy_0[j] + fl1_fx * tly_y_xy_0[j] + 0.5 * fl1_fx * tly_yy_x_0[j];

            tlz_yyy_xy_0[j] = pa_y[j] * tlz_yy_xy_0[j] + fl1_fx * tlz_y_xy_0[j] + 0.5 * fl1_fx * tlz_yy_x_0[j] + 0.5 * fl1_fx * tpx_yy_xy_0[j] +
                              fl1_fx * fl1_fgb * tdx_yy_xy_0[j];
            ...
            tlx_yyy_yy_0[j] = pa_y[j] * tlx_yy_yy_0[j] + fl1_fx * tlx_y_yy_0[j] + fl1_fx * tlx_yy_y_0[j] - 0.5 * fl1_fx * tpz_yy_yy_0[j] -
                              fl1_fx * fl1_fgb * tdz_yy_yy_0[j];

            tly_yyy_yy_0[j] = pa_y[j] * tly_yy_yy_0[j] + fl1_fx * tly_y_yy_0[j] + fl1_fx * tly_yy_y_0[j];

            tlz_yyy_yy_0[j] = pa_y[j] * tlz_yy_yy_0[j] + fl1_fx * tlz_y_yy_0[j] + fl1_fx * tlz_yy_y_0[j] + 0.5 * fl1_fx * tpx_yy_yy_0[j] +
                              fl1_fx * fl1_fgb * tdx_yy_yy_0[j];

            tlx_yyy_yz_0[j] = pa_y[j] * tlx_yy_yz_0[j] + fl1_fx * tlx_y_yz_0[j] + 0.5 * fl1_fx * tlx_yy_z_0[j] - 0.5 * fl1_fx * tpz_yy_yz_0[j] -
                              fl1_fx * fl1_fgb * tdz_yy_yz_0[j];

            tly_yyy_yz_0[j] = pa_y[j] * tly_yy_yz_0[j] + fl1_fx * tly_y_yz_0[j] + 0.5 * fl1_fx * tly_yy_z_0[j];

            tlz_yyy_yz_0[j] = pa_y[j] * tlz_yy_yz_0[j] + fl1_fx * tlz_y_yz_0[j] + 0.5 * fl1_fx * tlz_yy_z_0[j] + 0.5 * fl1_fx * tpx_yy_yz_0[j] +
                              fl1_fx * fl1_fgb * tdx_yy_yz_0[j];
            ...
            tlx_yyz_xx_0[j] =
                pa_y[j] * tlx_yz_xx_0[j] + 0.5 * fl1_fx * tlx_z_xx_0[j] - 0.5 * fl1_fx * tpz_yz_xx_0[j] - fl1_fx * fl1_fgb * tdz_yz_xx_0[j];

            tly_yyz_xx_0[j] = pa_y[j] * tly_yz_xx_0[j] + 0.5 * fl1_fx * tly_z_xx_0[j];

            tlz_yyz_xx_0[j] =
                pa_y[j] * tlz_yz_xx_0[j] + 0.5 * fl1_fx * tlz_z_xx_0[j] + 0.5 * fl1_fx * tpx_yz_xx_0[j] + fl1_fx * fl1_fgb * tdx_yz_xx_0[j];

            tlx_yyz_xy_0[j] = pa_y[j] * tlx_yz_xy_0[j] + 0.5 * fl1_fx * tlx_z_xy_0[j] + 0.5 * fl1_fx * tlx_yz_x_0[j] - 0.5 * fl1_fx * tpz_yz_xy_0[j] -
                              fl1_fx * fl1_fgb * tdz_yz_xy_0[j];

            tly_yyz_xy_0[j] = pa_y[j] * tly_yz_xy_0[j] + 0.5 * fl1_fx * tly_z_xy_0[j] + 0.5 * fl1_fx * tly_yz_x_0[j];

            tlz_yyz_xy_0[j] = pa_y[j] * tlz_yz_xy_0[j] + 0.5 * fl1_fx * tlz_z_xy_0[j] + 0.5 * fl1_fx * tlz_yz_x_0[j] + 0.5 * fl1_fx * tpx_yz_xy_0[j] +
                              fl1_fx * fl1_fgb * tdx_yz_xy_0[j];

            tlx_yyz_xz_0[j] =
                pa_y[j] * tlx_yz_xz_0[j] + 0.5 * fl1_fx * tlx_z_xz_0[j] - 0.5 * fl1_fx * tpz_yz_xz_0[j] - fl1_fx * fl1_fgb * tdz_yz_xz_0[j];

            tly_yyz_xz_0[j] = pa_y[j] * tly_yz_xz_0[j] + 0.5 * fl1_fx * tly_z_xz_0[j];

            tlz_yyz_xz_0[j] =
                pa_y[j] * tlz_yz_xz_0[j] + 0.5 * fl1_fx * tlz_z_xz_0[j] + 0.5 * fl1_fx * tpx_yz_xz_0[j] + fl1_fx * fl1_fgb * tdx_yz_xz_0[j];
        }
                                 ...
                                 const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tlx_yyz_yy_0[j] = pa_y[j] * tlx_yz_yy_0[j] + 0.5 * fl1_fx * tlx_z_yy_0[j] + fl1_fx * tlx_yz_y_0[j] - 0.5 * fl1_fx * tpz_yz_yy_0[j] -
                              fl1_fx * fl1_fgb * tdz_yz_yy_0[j];

            tly_yyz_yy_0[j] = pa_y[j] * tly_yz_yy_0[j] + 0.5 * fl1_fx * tly_z_yy_0[j] + fl1_fx * tly_yz_y_0[j];

            tlz_yyz_yy_0[j] = pa_y[j] * tlz_yz_yy_0[j] + 0.5 * fl1_fx * tlz_z_yy_0[j] + fl1_fx * tlz_yz_y_0[j] + 0.5 * fl1_fx * tpx_yz_yy_0[j] +
                              fl1_fx * fl1_fgb * tdx_yz_yy_0[j];

            tlx_yyz_yz_0[j] = pa_y[j] * tlx_yz_yz_0[j] + 0.5 * fl1_fx * tlx_z_yz_0[j] + 0.5 * fl1_fx * tlx_yz_z_0[j] - 0.5 * fl1_fx * tpz_yz_yz_0[j] -
                              fl1_fx * fl1_fgb * tdz_yz_yz_0[j];

            tly_yyz_yz_0[j] = pa_y[j] * tly_yz_yz_0[j] + 0.5 * fl1_fx * tly_z_yz_0[j] + 0.5 * fl1_fx * tly_yz_z_0[j];

            tlz_yyz_yz_0[j] = pa_y[j] * tlz_yz_yz_0[j] + 0.5 * fl1_fx * tlz_z_yz_0[j] + 0.5 * fl1_fx * tlz_yz_z_0[j] + 0.5 * fl1_fx * tpx_yz_yz_0[j] +
                              fl1_fx * fl1_fgb * tdx_yz_yz_0[j];

            tlx_yyz_zz_0[j] =
                pa_y[j] * tlx_yz_zz_0[j] + 0.5 * fl1_fx * tlx_z_zz_0[j] - 0.5 * fl1_fx * tpz_yz_zz_0[j] - fl1_fx * fl1_fgb * tdz_yz_zz_0[j];

            tly_yyz_zz_0[j] = pa_y[j] * tly_yz_zz_0[j] + 0.5 * fl1_fx * tly_z_zz_0[j];

            tlz_yyz_zz_0[j] =
                pa_y[j] * tlz_yz_zz_0[j] + 0.5 * fl1_fx * tlz_z_zz_0[j] + 0.5 * fl1_fx * tpx_yz_zz_0[j] + fl1_fx * fl1_fgb * tdx_yz_zz_0[j];
            ...
            tlx_yzz_xy_0[j] =
                pa_y[j] * tlx_zz_xy_0[j] + 0.5 * fl1_fx * tlx_zz_x_0[j] - 0.5 * fl1_fx * tpz_zz_xy_0[j] - fl1_fx * fl1_fgb * tdz_zz_xy_0[j];

            tly_yzz_xy_0[j] = pa_y[j] * tly_zz_xy_0[j] + 0.5 * fl1_fx * tly_zz_x_0[j];

            tlz_yzz_xy_0[j] =
                pa_y[j] * tlz_zz_xy_0[j] + 0.5 * fl1_fx * tlz_zz_x_0[j] + 0.5 * fl1_fx * tpx_zz_xy_0[j] + fl1_fx * fl1_fgb * tdx_zz_xy_0[j];
            ...
            tlx_yzz_yz_0[j] =
                pa_y[j] * tlx_zz_yz_0[j] + 0.5 * fl1_fx * tlx_zz_z_0[j] - 0.5 * fl1_fx * tpz_zz_yz_0[j] - fl1_fx * fl1_fgb * tdz_zz_yz_0[j];

            tly_yzz_yz_0[j] = pa_y[j] * tly_zz_yz_0[j] + 0.5 * fl1_fx * tly_zz_z_0[j];

            tlz_yzz_yz_0[j] =
                pa_y[j] * tlz_zz_yz_0[j] + 0.5 * fl1_fx * tlz_zz_z_0[j] + 0.5 * fl1_fx * tpx_zz_yz_0[j] + fl1_fx * fl1_fgb * tdx_zz_yz_0[j];
            ...
            tlx_zzz_xz_0[j] = pa_z[j] * tlx_zz_xz_0[j] + fl1_fx * tlx_z_xz_0[j] + 0.5 * fl1_fx * tlx_zz_x_0[j] + 0.5 * fl1_fx * tpy_zz_xz_0[j] +
                              fl1_fx * fl1_fgb * tdy_zz_xz_0[j];

            tly_zzz_xz_0[j] = pa_z[j] * tly_zz_xz_0[j] + fl1_fx * tly_z_xz_0[j] + 0.5 * fl1_fx * tly_zz_x_0[j] - 0.5 * fl1_fx * tpx_zz_xz_0[j] -
                              fl1_fx * fl1_fgb * tdx_zz_xz_0[j];
            ...
            tlx_zzz_yz_0[j] = pa_z[j] * tlx_zz_yz_0[j] + fl1_fx * tlx_z_yz_0[j] + 0.5 * fl1_fx * tlx_zz_y_0[j] + 0.5 * fl1_fx * tpy_zz_yz_0[j] +
                              fl1_fx * fl1_fgb * tdy_zz_yz_0[j];

            tly_zzz_yz_0[j] = pa_z[j] * tly_zz_yz_0[j] + fl1_fx * tly_z_yz_0[j] + 0.5 * fl1_fx * tly_zz_y_0[j] - 0.5 * fl1_fx * tpx_zz_yz_0[j] -
                              fl1_fx * fl1_fgb * tdx_zz_yz_0[j];

            tlz_zzz_yz_0[j] = pa_z[j] * tlz_zz_yz_0[j] + fl1_fx * tlz_z_yz_0[j] + 0.5 * fl1_fx * tlz_zz_y_0[j];

            tlx_zzz_zz_0[j] = pa_z[j] * tlx_zz_zz_0[j] + fl1_fx * tlx_z_zz_0[j] + fl1_fx * tlx_zz_z_0[j] + 0.5 * fl1_fx * tpy_zz_zz_0[j] +
                              fl1_fx * fl1_fgb * tdy_zz_zz_0[j];

            tly_zzz_zz_0[j] = pa_z[j] * tly_zz_zz_0[j] + fl1_fx * tly_z_zz_0[j] + fl1_fx * tly_zz_z_0[j] - 0.5 * fl1_fx * tpx_zz_zz_0[j] -
                              fl1_fx * fl1_fgb * tdx_zz_zz_0[j];
...
compAngularMomentumForDG(CMemBlock2D<double>&       primBuffer,
                         ...
                         const int32_t              iContrGto)
{
    amomrecfunc::compAngularMomentumForDG_0_45(primBuffer, recursionMap, osFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    amomrecfunc::compAngularMomentumForDG_45_90(primBuffer, recursionMap, osFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    amomrecfunc::compAngularMomentumForDG_90_135(primBuffer, recursionMap, osFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    amomrecfunc::compAngularMomentumForDG_135_180(primBuffer, recursionMap, osFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    amomrecfunc::compAngularMomentumForDG_180_225(primBuffer, recursionMap, osFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    amomrecfunc::compAngularMomentumForDG_225_270(primBuffer, recursionMap, osFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
                              ...
                              const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tly_xx_xxxx_0[j] = pa_x[j] * tly_x_xxxx_0[j] + 0.5 * fl1_fx * tly_0_xxxx_0[j] + 2.0 * fl1_fx * tly_x_xxx_0[j] +
                               0.5 * fl1_fx * tpz_x_xxxx_0[j] + fl1_fx * fl1_fgb * tdz_x_xxxx_0[j];

            tlz_xx_xxxx_0[j] = pa_x[j] * tlz_x_xxxx_0[j] + 0.5 * fl1_fx * tlz_0_xxxx_0[j] + 2.0 * fl1_fx * tlz_x_xxx_0[j] -
                               0.5 * fl1_fx * tpy_x_xxxx_0[j] - fl1_fx * fl1_fgb * tdy_x_xxxx_0[j];

            tlx_xx_xxxy_0[j] = pa_x[j] * tlx_x_xxxy_0[j] + 0.5 * fl1_fx * tlx_0_xxxy_0[j] + 1.5 * fl1_fx * tlx_x_xxy_0[j];

            tly_xx_xxxy_0[j] = pa_x[j] * tly_x_xxxy_0[j] + 0.5 * fl1_fx * tly_0_xxxy_0[j] + 1.5 * fl1_fx * tly_x_xxy_0[j] +
                               0.5 * fl1_fx * tpz_x_xxxy_0[j] + fl1_fx * fl1_fgb * tdz_x_xxxy_0[j];

            tlz_xx_xxxy_0[j] = pa_x[j] * tlz_x_xxxy_0[j] + 0.5 * fl1_fx * tlz_0_xxxy_0[j] + 1.5 * fl1_fx * tlz_x_xxy_0[j] -
                               0.5 * fl1_fx * tpy_x_xxxy_0[j] - fl1_fx * fl1_fgb * tdy_x_xxxy_0[j];

            tlx_xx_xxxz_0[j] = pa_x[j] * tlx_x_xxxz_0[j] + 0.5 * fl1_fx * tlx_0_xxxz_0[j] + 1.5 * fl1_fx * tlx_x_xxz_0[j];

            tly_xx_xxxz_0[j] = pa_x[j] * tly_x_xxxz_0[j] + 0.5 * fl1_fx * tly_0_xxxz_0[j] + 1.5 * fl1_fx * tly_x_xxz_0[j] +
                               0.5 * fl1_fx * tpz_x_xxxz_0[j] + fl1_fx * fl1_fgb * tdz_x_xxxz_0[j];

            tlz_xx_xxxz_0[j] = pa_x[j] * tlz_x_xxxz_0[j] + 0.5 * fl1_fx * tlz_0_xxxz_0[j] + 1.5 * fl1_fx * tlz_x_xxz_0[j] -
                               0.5 * fl1_fx * tpy_x_xxxz_0[j] - fl1_fx * fl1_fgb * tdy_x_xxxz_0[j];

            tlx_xx_xxyy_0[j] = pa_x[j] * tlx_x_xxyy_0[j] + 0.5 * fl1_fx * tlx_0_xxyy_0[j] + fl1_fx * tlx_x_xyy_0[j];

            tly_xx_xxyy_0[j] = pa_x[j] * tly_x_xxyy_0[j] + 0.5 * fl1_fx * tly_0_xxyy_0[j] + fl1_fx * tly_x_xyy_0[j] + 0.5 * fl1_fx * tpz_x_xxyy_0[j] +
                               fl1_fx * fl1_fgb * tdz_x_xxyy_0[j];

            tlz_xx_xxyy_0[j] = pa_x[j] * tlz_x_xxyy_0[j] + 0.5 * fl1_fx * tlz_0_xxyy_0[j] + fl1_fx * tlz_x_xyy_0[j] - 0.5 * fl1_fx * tpy_x_xxyy_0[j] -
                               fl1_fx * fl1_fgb * tdy_x_xxyy_0[j];

            tlx_xx_xxyz_0[j] = pa_x[j] * tlx_x_xxyz_0[j] + 0.5 * fl1_fx * tlx_0_xxyz_0[j] + fl1_fx * tlx_x_xyz_0[j];

            tly_xx_xxyz_0[j] = pa_x[j] * tly_x_xxyz_0[j] + 0.5 * fl1_fx * tly_0_xxyz_0[j] + fl1_fx * tly_x_xyz_0[j] + 0.5 * fl1_fx * tpz_x_xxyz_0[j] +
                               fl1_fx * fl1_fgb * tdz_x_xxyz_0[j];

            tlz_xx_xxyz_0[j] = pa_x[j] * tlz_x_xxyz_0[j] + 0.5 * fl1_fx * tlz_0_xxyz_0[j] + fl1_fx * tlz_x_xyz_0[j] - 0.5 * fl1_fx * tpy_x_xxyz_0[j] -
                               fl1_fx * fl1_fgb * tdy_x_xxyz_0[j];

            tlx_xx_xxzz_0[j] = pa_x[j] * tlx_x_xxzz_0[j] + 0.5 * fl1_fx * tlx_0_xxzz_0[j] + fl1_fx * tlx_x_xzz_0[j];

            tly_xx_xxzz_0[j] = pa_x[j] * tly_x_xxzz_0[j] + 0.5 * fl1_fx * tly_0_xxzz_0[j] + fl1_fx * tly_x_xzz_0[j] + 0.5 * fl1_fx * tpz_x_xxzz_0[j] +
                               fl1_fx * fl1_fgb * tdz_x_xxzz_0[j];

            tlz_xx_xxzz_0[j] = pa_x[j] * tlz_x_xxzz_0[j] + 0.5 * fl1_fx * tlz_0_xxzz_0[j] + fl1_fx * tlz_x_xzz_0[j] - 0.5 * fl1_fx * tpy_x_xxzz_0[j] -
                               fl1_fx * fl1_fgb * tdy_x_xxzz_0[j];

            tlx_xx_xyyy_0[j] = pa_x[j] * tlx_x_xyyy_0[j] + 0.5 * fl1_fx * tlx_0_xyyy_0[j] + 0.5 * fl1_fx * tlx_x_yyy_0[j];

            tly_xx_xyyy_0[j] = pa_x[j] * tly_x_xyyy_0[j] + 0.5 * fl1_fx * tly_0_xyyy_0[j] + 0.5 * fl1_fx * tly_x_yyy_0[j] +
                               0.5 * fl1_fx * tpz_x_xyyy_0[j] + fl1_fx * fl1_fgb * tdz_x_xyyy_0[j];

            tlz_xx_xyyy_0[j] = pa_x[j] * tlz_x_xyyy_0[j] + 0.5 * fl1_fx * tlz_0_xyyy_0[j] + 0.5 * fl1_fx * tlz_x_yyy_0[j] -
                               0.5 * fl1_fx * tpy_x_xyyy_0[j] - fl1_fx * fl1_fgb * tdy_x_xyyy_0[j];

            tlx_xx_xyyz_0[j] = pa_x[j] * tlx_x_xyyz_0[j] + 0.5 * fl1_fx * tlx_0_xyyz_0[j] + 0.5 * fl1_fx * tlx_x_yyz_0[j];

            tly_xx_xyyz_0[j] = pa_x[j] * tly_x_xyyz_0[j] + 0.5 * fl1_fx * tly_0_xyyz_0[j] + 0.5 * fl1_fx * tly_x_yyz_0[j] +
                               0.5 * fl1_fx * tpz_x_xyyz_0[j] + fl1_fx * fl1_fgb * tdz_x_xyyz_0[j];

            tlz_xx_xyyz_0[j] = pa_x[j] * tlz_x_xyyz_0[j] + 0.5 * fl1_fx * tlz_0_xyyz_0[j] + 0.5 * fl1_fx * tlz_x_yyz_0[j] -
                               0.5 * fl1_fx * tpy_x_xyyz_0[j] - fl1_fx * fl1_fgb * tdy_x_xyyz_0[j];

            tlx_xx_xyzz_0[j] = pa_x[j] * tlx_x_xyzz_0[j] + 0.5 * fl1_fx * tlx_0_xyzz_0[j] + 0.5 * fl1_fx * tlx_x_yzz_0[j];

            tly_xx_xyzz_0[j] = pa_x[j] * tly_x_xyzz_0[j] + 0.5 * fl1_fx * tly_0_xyzz_0[j] + 0.5 * fl1_fx * tly_x_yzz_0[j] +
                               0.5 * fl1_fx * tpz_x_xyzz_0[j] + fl1_fx * fl1_fgb * tdz_x_xyzz_0[j];

            tlz_xx_xyzz_0[j] = pa_x[j] * tlz_x_xyzz_0[j] + 0.5 * fl1_fx * tlz_0_xyzz_0[j] + 0.5 * fl1_fx * tlz_x_yzz_0[j] -
                               0.5 * fl1_fx * tpy_x_xyzz_0[j] - fl1_fx * fl1_fgb * tdy_x_xyzz_0[j];

            tlx_xx_xzzz_0[j] = pa_x[j] * tlx_x_xzzz_0[j] + 0.5 * fl1_fx * tlx_0_xzzz_0[j] + 0.5 * fl1_fx * tlx_x_zzz_0[j];

            tly_xx_xzzz_0[j] = pa_x[j] * tly_x_xzzz_0[j] + 0.5 * fl1_fx * tly_0_xzzz_0[j] + 0.5 * fl1_fx * tly_x_zzz_0[j] +
                               0.5 * fl1_fx * tpz_x_xzzz_0[j] + fl1_fx * fl1_fgb * tdz_x_xzzz_0[j];

            tlz_xx_xzzz_0[j] = pa_x[j] * tlz_x_xzzz_0[j] + 0.5 * fl1_fx * tlz_0_xzzz_0[j] + 0.5 * fl1_fx * tlz_x_zzz_0[j] -
                               0.5 * fl1_fx * tpy_x_xzzz_0[j] - fl1_fx * fl1_fgb * tdy_x_xzzz_0[j];

            tlx_xx_yyyy_0[j] = pa_x[j] * tlx_x_yyyy_0[j] + 0.5 * fl1_fx * tlx_0_yyyy_0[j];

            tly_xx_yyyy_0[j] =
                pa_x[j] * tly_x_yyyy_0[j] + 0.5 * fl1_fx * tly_0_yyyy_0[j] + 0.5 * fl1_fx * tpz_x_yyyy_0[j] + fl1_fx * fl1_fgb * tdz_x_yyyy_0[j];

            tlz_xx_yyyy_0[j] =
                pa_x[j] * tlz_x_yyyy_0[j] + 0.5 * fl1_fx * tlz_0_yyyy_0[j] - 0.5 * fl1_fx * tpy_x_yyyy_0[j] - fl1_fx * fl1_fgb * tdy_x_yyyy_0[j];

            tlx_xx_yyyz_0[j] = pa_x[j] * tlx_x_yyyz_0[j] + 0.5 * fl1_fx * tlx_0_yyyz_0[j];

            tly_xx_yyyz_0[j] =
                pa_x[j] * tly_x_yyyz_0[j] + 0.5 * fl1_fx * tly_0_yyyz_0[j] + 0.5 * fl1_fx * tpz_x_yyyz_0[j] + fl1_fx * fl1_fgb * tdz_x_yyyz_0[j];

            tlz_xx_yyyz_0[j] =
                pa_x[j] * tlz_x_yyyz_0[j] + 0.5 * fl1_fx * tlz_0_yyyz_0[j] - 0.5 * fl1_fx * tpy_x_yyyz_0[j] - fl1_fx * fl1_fgb * tdy_x_yyyz_0[j];

            tlx_xx_yyzz_0[j] = pa_x[j] * tlx_x_yyzz_0[j] + 0.5 * fl1_fx * tlx_0_yyzz_0[j];

            tly_xx_yyzz_0[j] =
                pa_x[j] * tly_x_yyzz_0[j] + 0.5 * fl1_fx * tly_0_yyzz_0[j] + 0.5 * fl1_fx * tpz_x_yyzz_0[j] + fl1_fx * fl1_fgb * tdz_x_yyzz_0[j];

            tlz_xx_yyzz_0[j] =
                pa_x[j] * tlz_x_yyzz_0[j] + 0.5 * fl1_fx * tlz_0_yyzz_0[j] - 0.5 * fl1_fx * tpy_x_yyzz_0[j] - fl1_fx * fl1_fgb * tdy_x_yyzz_0[j];

            tlx_xx_yzzz_0[j] = pa_x[j] * tlx_x_yzzz_0[j] + 0.5 * fl1_fx * tlx_0_yzzz_0[j];

            tly_xx_yzzz_0[j] =
                pa_x[j] * tly_x_yzzz_0[j] + 0.5 * fl1_fx * tly_0_yzzz_0[j] + 0.5 * fl1_fx * tpz_x_yzzz_0[j] + fl1_fx * fl1_fgb * tdz_x_yzzz_0[j];

            tlz_xx_yzzz_0[j] =
                pa_x[j] * tlz_x_yzzz_0[j] + 0.5 * fl1_fx * tlz_0_yzzz_0[j] - 0.5 * fl1_fx * tpy_x_yzzz_0[j] - fl1_fx * fl1_fgb * tdy_x_yzzz_0[j];

            tlx_xx_zzzz_0[j] = pa_x[j] * tlx_x_zzzz_0[j] + 0.5 * fl1_fx * tlx_0_zzzz_0[j];

            tly_xx_zzzz_0[j] =
                pa_x[j] * tly_x_zzzz_0[j] + 0.5 * fl1_fx * tly_0_zzzz_0[j] + 0.5 * fl1_fx * tpz_x_zzzz_0[j] + fl1_fx * fl1_fgb * tdz_x_zzzz_0[j];

            tlz_xx_zzzz_0[j] =
                pa_x[j] * tlz_x_zzzz_0[j] + 0.5 * fl1_fx * tlz_0_zzzz_0[j] - 0.5 * fl1_fx * tpy_x_zzzz_0[j] - fl1_fx * fl1_fgb * tdy_x_zzzz_0[j];
        }
                               ...
                               const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tly_xy_xxxx_0[j] =
                pa_x[j] * tly_y_xxxx_0[j] + 2.0 * fl1_fx * tly_y_xxx_0[j] + 0.5 * fl1_fx * tpz_y_xxxx_0[j] + fl1_fx * fl1_fgb * tdz_y_xxxx_0[j];

            tlz_xy_xxxx_0[j] =
                pa_x[j] * tlz_y_xxxx_0[j] + 2.0 * fl1_fx * tlz_y_xxx_0[j] - 0.5 * fl1_fx * tpy_y_xxxx_0[j] - fl1_fx * fl1_fgb * tdy_y_xxxx_0[j];

            tlx_xy_xxxy_0[j] = pa_x[j] * tlx_y_xxxy_0[j] + 1.5 * fl1_fx * tlx_y_xxy_0[j];

            tly_xy_xxxy_0[j] =
                pa_x[j] * tly_y_xxxy_0[j] + 1.5 * fl1_fx * tly_y_xxy_0[j] + 0.5 * fl1_fx * tpz_y_xxxy_0[j] + fl1_fx * fl1_fgb * tdz_y_xxxy_0[j];

            tlz_xy_xxxy_0[j] =
                pa_x[j] * tlz_y_xxxy_0[j] + 1.5 * fl1_fx * tlz_y_xxy_0[j] - 0.5 * fl1_fx * tpy_y_xxxy_0[j] - fl1_fx * fl1_fgb * tdy_y_xxxy_0[j];

            tlx_xy_xxxz_0[j] = pa_x[j] * tlx_y_xxxz_0[j] + 1.5 * fl1_fx * tlx_y_xxz_0[j];

            tly_xy_xxxz_0[j] =
                pa_x[j] * tly_y_xxxz_0[j] + 1.5 * fl1_fx * tly_y_xxz_0[j] + 0.5 * fl1_fx * tpz_y_xxxz_0[j] + fl1_fx * fl1_fgb * tdz_y_xxxz_0[j];

            tlz_xy_xxxz_0[j] =
                pa_x[j] * tlz_y_xxxz_0[j] + 1.5 * fl1_fx * tlz_y_xxz_0[j] - 0.5 * fl1_fx * tpy_y_xxxz_0[j] - fl1_fx * fl1_fgb * tdy_y_xxxz_0[j];

            tlx_xy_xxyy_0[j] = pa_x[j] * tlx_y_xxyy_0[j] + fl1_fx * tlx_y_xyy_0[j];

            tly_xy_xxyy_0[j] =
                pa_x[j] * tly_y_xxyy_0[j] + fl1_fx * tly_y_xyy_0[j] + 0.5 * fl1_fx * tpz_y_xxyy_0[j] + fl1_fx * fl1_fgb * tdz_y_xxyy_0[j];

            tlz_xy_xxyy_0[j] =
                pa_x[j] * tlz_y_xxyy_0[j] + fl1_fx * tlz_y_xyy_0[j] - 0.5 * fl1_fx * tpy_y_xxyy_0[j] - fl1_fx * fl1_fgb * tdy_y_xxyy_0[j];

            tlx_xy_xxyz_0[j] = pa_x[j] * tlx_y_xxyz_0[j] + fl1_fx * tlx_y_xyz_0[j];

            tly_xy_xxyz_0[j] =
                pa_x[j] * tly_y_xxyz_0[j] + fl1_fx * tly_y_xyz_0[j] + 0.5 * fl1_fx * tpz_y_xxyz_0[j] + fl1_fx * fl1_fgb * tdz_y_xxyz_0[j];

            tlz_xy_xxyz_0[j] =
                pa_x[j] * tlz_y_xxyz_0[j] + fl1_fx * tlz_y_xyz_0[j] - 0.5 * fl1_fx * tpy_y_xxyz_0[j] - fl1_fx * fl1_fgb * tdy_y_xxyz_0[j];

            tlx_xy_xxzz_0[j] = pa_x[j] * tlx_y_xxzz_0[j] + fl1_fx * tlx_y_xzz_0[j];

            tly_xy_xxzz_0[j] =
                pa_x[j] * tly_y_xxzz_0[j] + fl1_fx * tly_y_xzz_0[j] + 0.5 * fl1_fx * tpz_y_xxzz_0[j] + fl1_fx * fl1_fgb * tdz_y_xxzz_0[j];

            tlz_xy_xxzz_0[j] =
                pa_x[j] * tlz_y_xxzz_0[j] + fl1_fx * tlz_y_xzz_0[j] - 0.5 * fl1_fx * tpy_y_xxzz_0[j] - fl1_fx * fl1_fgb * tdy_y_xxzz_0[j];

            tlx_xy_xyyy_0[j] = pa_x[j] * tlx_y_xyyy_0[j] + 0.5 * fl1_fx * tlx_y_yyy_0[j];

            tly_xy_xyyy_0[j] =
                pa_x[j] * tly_y_xyyy_0[j] + 0.5 * fl1_fx * tly_y_yyy_0[j] + 0.5 * fl1_fx * tpz_y_xyyy_0[j] + fl1_fx * fl1_fgb * tdz_y_xyyy_0[j];

            tlz_xy_xyyy_0[j] =
                pa_x[j] * tlz_y_xyyy_0[j] + 0.5 * fl1_fx * tlz_y_yyy_0[j] - 0.5 * fl1_fx * tpy_y_xyyy_0[j] - fl1_fx * fl1_fgb * tdy_y_xyyy_0[j];

            tlx_xy_xyyz_0[j] = pa_x[j] * tlx_y_xyyz_0[j] + 0.5 * fl1_fx * tlx_y_yyz_0[j];

            tly_xy_xyyz_0[j] =
                pa_x[j] * tly_y_xyyz_0[j] + 0.5 * fl1_fx * tly_y_yyz_0[j] + 0.5 * fl1_fx * tpz_y_xyyz_0[j] + fl1_fx * fl1_fgb * tdz_y_xyyz_0[j];

            tlz_xy_xyyz_0[j] =
                pa_x[j] * tlz_y_xyyz_0[j] + 0.5 * fl1_fx * tlz_y_yyz_0[j] - 0.5 * fl1_fx * tpy_y_xyyz_0[j] - fl1_fx * fl1_fgb * tdy_y_xyyz_0[j];

            tlx_xy_xyzz_0[j] = pa_x[j] * tlx_y_xyzz_0[j] + 0.5 * fl1_fx * tlx_y_yzz_0[j];

            tly_xy_xyzz_0[j] =
                pa_x[j] * tly_y_xyzz_0[j] + 0.5 * fl1_fx * tly_y_yzz_0[j] + 0.5 * fl1_fx * tpz_y_xyzz_0[j] + fl1_fx * fl1_fgb * tdz_y_xyzz_0[j];

            tlz_xy_xyzz_0[j] =
                pa_x[j] * tlz_y_xyzz_0[j] + 0.5 * fl1_fx * tlz_y_yzz_0[j] - 0.5 * fl1_fx * tpy_y_xyzz_0[j] - fl1_fx * fl1_fgb * tdy_y_xyzz_0[j];

            tlx_xy_xzzz_0[j] = pa_x[j] * tlx_y_xzzz_0[j] + 0.5 * fl1_fx * tlx_y_zzz_0[j];

            tly_xy_xzzz_0[j] =
                pa_x[j] * tly_y_xzzz_0[j] + 0.5 * fl1_fx * tly_y_zzz_0[j] + 0.5 * fl1_fx * tpz_y_xzzz_0[j] + fl1_fx * fl1_fgb * tdz_y_xzzz_0[j];

            tlz_xy_xzzz_0[j] =
                pa_x[j] * tlz_y_xzzz_0[j] + 0.5 * fl1_fx * tlz_y_zzz_0[j] - 0.5 * fl1_fx * tpy_y_xzzz_0[j] - fl1_fx * fl1_fgb * tdy_y_xzzz_0[j];
                                ...
                                const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tly_xz_xxxx_0[j] =
                pa_x[j] * tly_z_xxxx_0[j] + 2.0 * fl1_fx * tly_z_xxx_0[j] + 0.5 * fl1_fx * tpz_z_xxxx_0[j] + fl1_fx * fl1_fgb * tdz_z_xxxx_0[j];

            tlz_xz_xxxx_0[j] =
                pa_x[j] * tlz_z_xxxx_0[j] + 2.0 * fl1_fx * tlz_z_xxx_0[j] - 0.5 * fl1_fx * tpy_z_xxxx_0[j] - fl1_fx * fl1_fgb * tdy_z_xxxx_0[j];

            tlx_xz_xxxy_0[j] = pa_x[j] * tlx_z_xxxy_0[j] + 1.5 * fl1_fx * tlx_z_xxy_0[j];

            tly_xz_xxxy_0[j] =
                pa_x[j] * tly_z_xxxy_0[j] + 1.5 * fl1_fx * tly_z_xxy_0[j] + 0.5 * fl1_fx * tpz_z_xxxy_0[j] + fl1_fx * fl1_fgb * tdz_z_xxxy_0[j];

            tlz_xz_xxxy_0[j] =
                pa_x[j] * tlz_z_xxxy_0[j] + 1.5 * fl1_fx * tlz_z_xxy_0[j] - 0.5 * fl1_fx * tpy_z_xxxy_0[j] - fl1_fx * fl1_fgb * tdy_z_xxxy_0[j];

            tlx_xz_xxxz_0[j] = pa_x[j] * tlx_z_xxxz_0[j] + 1.5 * fl1_fx * tlx_z_xxz_0[j];

            tly_xz_xxxz_0[j] =
                pa_x[j] * tly_z_xxxz_0[j] + 1.5 * fl1_fx * tly_z_xxz_0[j] + 0.5 * fl1_fx * tpz_z_xxxz_0[j] + fl1_fx * fl1_fgb * tdz_z_xxxz_0[j];

            tlz_xz_xxxz_0[j] =
                pa_x[j] * tlz_z_xxxz_0[j] + 1.5 * fl1_fx * tlz_z_xxz_0[j] - 0.5 * fl1_fx * tpy_z_xxxz_0[j] - fl1_fx * fl1_fgb * tdy_z_xxxz_0[j];

            tlx_xz_xxyy_0[j] = pa_x[j] * tlx_z_xxyy_0[j] + fl1_fx * tlx_z_xyy_0[j];

            tly_xz_xxyy_0[j] =
                pa_x[j] * tly_z_xxyy_0[j] + fl1_fx * tly_z_xyy_0[j] + 0.5 * fl1_fx * tpz_z_xxyy_0[j] + fl1_fx * fl1_fgb * tdz_z_xxyy_0[j];

            tlz_xz_xxyy_0[j] =
                pa_x[j] * tlz_z_xxyy_0[j] + fl1_fx * tlz_z_xyy_0[j] - 0.5 * fl1_fx * tpy_z_xxyy_0[j] - fl1_fx * fl1_fgb * tdy_z_xxyy_0[j];

            tlx_xz_xxyz_0[j] = pa_x[j] * tlx_z_xxyz_0[j] + fl1_fx * tlx_z_xyz_0[j];

            tly_xz_xxyz_0[j] =
                pa_x[j] * tly_z_xxyz_0[j] + fl1_fx * tly_z_xyz_0[j] + 0.5 * fl1_fx * tpz_z_xxyz_0[j] + fl1_fx * fl1_fgb * tdz_z_xxyz_0[j];

            tlz_xz_xxyz_0[j] =
                pa_x[j] * tlz_z_xxyz_0[j] + fl1_fx * tlz_z_xyz_0[j] - 0.5 * fl1_fx * tpy_z_xxyz_0[j] - fl1_fx * fl1_fgb * tdy_z_xxyz_0[j];

            tlx_xz_xxzz_0[j] = pa_x[j] * tlx_z_xxzz_0[j] + fl1_fx * tlx_z_xzz_0[j];

            tly_xz_xxzz_0[j] =
                pa_x[j] * tly_z_xxzz_0[j] + fl1_fx * tly_z_xzz_0[j] + 0.5 * fl1_fx * tpz_z_xxzz_0[j] + fl1_fx * fl1_fgb * tdz_z_xxzz_0[j];

            tlz_xz_xxzz_0[j] =
                pa_x[j] * tlz_z_xxzz_0[j] + fl1_fx * tlz_z_xzz_0[j] - 0.5 * fl1_fx * tpy_z_xxzz_0[j] - fl1_fx * fl1_fgb * tdy_z_xxzz_0[j];

            tlx_xz_xyyy_0[j] = pa_x[j] * tlx_z_xyyy_0[j] + 0.5 * fl1_fx * tlx_z_yyy_0[j];

            tly_xz_xyyy_0[j] =
                pa_x[j] * tly_z_xyyy_0[j] + 0.5 * fl1_fx * tly_z_yyy_0[j] + 0.5 * fl1_fx * tpz_z_xyyy_0[j] + fl1_fx * fl1_fgb * tdz_z_xyyy_0[j];

            tlz_xz_xyyy_0[j] =
                pa_x[j] * tlz_z_xyyy_0[j] + 0.5 * fl1_fx * tlz_z_yyy_0[j] - 0.5 * fl1_fx * tpy_z_xyyy_0[j] - fl1_fx * fl1_fgb * tdy_z_xyyy_0[j];

            tlx_xz_xyyz_0[j] = pa_x[j] * tlx_z_xyyz_0[j] + 0.5 * fl1_fx * tlx_z_yyz_0[j];

            tly_xz_xyyz_0[j] =
                pa_x[j] * tly_z_xyyz_0[j] + 0.5 * fl1_fx * tly_z_yyz_0[j] + 0.5 * fl1_fx * tpz_z_xyyz_0[j] + fl1_fx * fl1_fgb * tdz_z_xyyz_0[j];

            tlz_xz_xyyz_0[j] =
                pa_x[j] * tlz_z_xyyz_0[j] + 0.5 * fl1_fx * tlz_z_yyz_0[j] - 0.5 * fl1_fx * tpy_z_xyyz_0[j] - fl1_fx * fl1_fgb * tdy_z_xyyz_0[j];

            tlx_xz_xyzz_0[j] = pa_x[j] * tlx_z_xyzz_0[j] + 0.5 * fl1_fx * tlx_z_yzz_0[j];

            tly_xz_xyzz_0[j] =
                pa_x[j] * tly_z_xyzz_0[j] + 0.5 * fl1_fx * tly_z_yzz_0[j] + 0.5 * fl1_fx * tpz_z_xyzz_0[j] + fl1_fx * fl1_fgb * tdz_z_xyzz_0[j];

            tlz_xz_xyzz_0[j] =
                pa_x[j] * tlz_z_xyzz_0[j] + 0.5 * fl1_fx * tlz_z_yzz_0[j] - 0.5 * fl1_fx * tpy_z_xyzz_0[j] - fl1_fx * fl1_fgb * tdy_z_xyzz_0[j];

            tlx_xz_xzzz_0[j] = pa_x[j] * tlx_z_xzzz_0[j] + 0.5 * fl1_fx * tlx_z_zzz_0[j];

            tly_xz_xzzz_0[j] =
                pa_x[j] * tly_z_xzzz_0[j] + 0.5 * fl1_fx * tly_z_zzz_0[j] + 0.5 * fl1_fx * tpz_z_xzzz_0[j] + fl1_fx * fl1_fgb * tdz_z_xzzz_0[j];

            tlz_xz_xzzz_0[j] =
                pa_x[j] * tlz_z_xzzz_0[j] + 0.5 * fl1_fx * tlz_z_zzz_0[j] - 0.5 * fl1_fx * tpy_z_xzzz_0[j] - fl1_fx * fl1_fgb * tdy_z_xzzz_0[j];
                                 ...
                                 const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tlx_yy_xxxx_0[j] =
                pa_y[j] * tlx_y_xxxx_0[j] + 0.5 * fl1_fx * tlx_0_xxxx_0[j] - 0.5 * fl1_fx * tpz_y_xxxx_0[j] - fl1_fx * fl1_fgb * tdz_y_xxxx_0[j];

            tly_yy_xxxx_0[j] = pa_y[j] * tly_y_xxxx_0[j] + 0.5 * fl1_fx * tly_0_xxxx_0[j];

            tlz_yy_xxxx_0[j] =
                pa_y[j] * tlz_y_xxxx_0[j] + 0.5 * fl1_fx * tlz_0_xxxx_0[j] + 0.5 * fl1_fx * tpx_y_xxxx_0[j] + fl1_fx * fl1_fgb * tdx_y_xxxx_0[j];

            tlx_yy_xxxy_0[j] = pa_y[j] * tlx_y_xxxy_0[j] + 0.5 * fl1_fx * tlx_0_xxxy_0[j] + 0.5 * fl1_fx * tlx_y_xxx_0[j] -
                               0.5 * fl1_fx * tpz_y_xxxy_0[j] - fl1_fx * fl1_fgb * tdz_y_xxxy_0[j];

            tly_yy_xxxy_0[j] = pa_y[j] * tly_y_xxxy_0[j] + 0.5 * fl1_fx * tly_0_xxxy_0[j] + 0.5 * fl1_fx * tly_y_xxx_0[j];

            tlz_yy_xxxy_0[j] = pa_y[j] * tlz_y_xxxy_0[j] + 0.5 * fl1_fx * tlz_0_xxxy_0[j] + 0.5 * fl1_fx * tlz_y_xxx_0[j] +
                               0.5 * fl1_fx * tpx_y_xxxy_0[j] + fl1_fx * fl1_fgb * tdx_y_xxxy_0[j];

            tlx_yy_xxxz_0[j] =
                pa_y[j] * tlx_y_xxxz_0[j] + 0.5 * fl1_fx * tlx_0_xxxz_0[j] - 0.5 * fl1_fx * tpz_y_xxxz_0[j] - fl1_fx * fl1_fgb * tdz_y_xxxz_0[j];

            tly_yy_xxxz_0[j] = pa_y[j] * tly_y_xxxz_0[j] + 0.5 * fl1_fx * tly_0_xxxz_0[j];

            tlz_yy_xxxz_0[j] =
                pa_y[j] * tlz_y_xxxz_0[j] + 0.5 * fl1_fx * tlz_0_xxxz_0[j] + 0.5 * fl1_fx * tpx_y_xxxz_0[j] + fl1_fx * fl1_fgb * tdx_y_xxxz_0[j];

            tlx_yy_xxyy_0[j] = pa_y[j] * tlx_y_xxyy_0[j] + 0.5 * fl1_fx * tlx_0_xxyy_0[j] + fl1_fx * tlx_y_xxy_0[j] - 0.5 * fl1_fx * tpz_y_xxyy_0[j] -
                               fl1_fx * fl1_fgb * tdz_y_xxyy_0[j];

            tly_yy_xxyy_0[j] = pa_y[j] * tly_y_xxyy_0[j] + 0.5 * fl1_fx * tly_0_xxyy_0[j] + fl1_fx * tly_y_xxy_0[j];

            tlz_yy_xxyy_0[j] = pa_y[j] * tlz_y_xxyy_0[j] + 0.5 * fl1_fx * tlz_0_xxyy_0[j] + fl1_fx * tlz_y_xxy_0[j] + 0.5 * fl1_fx * tpx_y_xxyy_0[j] +
                               fl1_fx * fl1_fgb * tdx_y_xxyy_0[j];

            tlx_yy_xxyz_0[j] = pa_y[j] * tlx_y_xxyz_0[j] + 0.5 * fl1_fx * tlx_0_xxyz_0[j] + 0.5 * fl1_fx * tlx_y_xxz_0[j] -
                               0.5 * fl1_fx * tpz_y_xxyz_0[j] - fl1_fx * fl1_fgb * tdz_y_xxyz_0[j];

            tly_yy_xxyz_0[j] = pa_y[j] * tly_y_xxyz_0[j] + 0.5 * fl1_fx * tly_0_xxyz_0[j] + 0.5 * fl1_fx * tly_y_xxz_0[j];

            tlz_yy_xxyz_0[j] = pa_y[j] * tlz_y_xxyz_0[j] + 0.5 * fl1_fx * tlz_0_xxyz_0[j] + 0.5 * fl1_fx * tlz_y_xxz_0[j] +
                               0.5 * fl1_fx * tpx_y_xxyz_0[j] + fl1_fx * fl1_fgb * tdx_y_xxyz_0[j];

            tlx_yy_xxzz_0[j] =
                pa_y[j] * tlx_y_xxzz_0[j] + 0.5 * fl1_fx * tlx_0_xxzz_0[j] - 0.5 * fl1_fx * tpz_y_xxzz_0[j] - fl1_fx * fl1_fgb * tdz_y_xxzz_0[j];

            tly_yy_xxzz_0[j] = pa_y[j] * tly_y_xxzz_0[j] + 0.5 * fl1_fx * tly_0_xxzz_0[j];

            tlz_yy_xxzz_0[j] =
                pa_y[j] * tlz_y_xxzz_0[j] + 0.5 * fl1_fx * tlz_0_xxzz_0[j] + 0.5 * fl1_fx * tpx_y_xxzz_0[j] + fl1_fx * fl1_fgb * tdx_y_xxzz_0[j];

            tlx_yy_xyyy_0[j] = pa_y[j] * tlx_y_xyyy_0[j] + 0.5 * fl1_fx * tlx_0_xyyy_0[j] + 1.5 * fl1_fx * tlx_y_xyy_0[j] -
                               0.5 * fl1_fx * tpz_y_xyyy_0[j] - fl1_fx * fl1_fgb * tdz_y_xyyy_0[j];

            tly_yy_xyyy_0[j] = pa_y[j] * tly_y_xyyy_0[j] + 0.5 * fl1_fx * tly_0_xyyy_0[j] + 1.5 * fl1_fx * tly_y_xyy_0[j];

            tlz_yy_xyyy_0[j] = pa_y[j] * tlz_y_xyyy_0[j] + 0.5 * fl1_fx * tlz_0_xyyy_0[j] + 1.5 * fl1_fx * tlz_y_xyy_0[j] +
                               0.5 * fl1_fx * tpx_y_xyyy_0[j] + fl1_fx * fl1_fgb * tdx_y_xyyy_0[j];

            tlx_yy_xyyz_0[j] = pa_y[j] * tlx_y_xyyz_0[j] + 0.5 * fl1_fx * tlx_0_xyyz_0[j] + fl1_fx * tlx_y_xyz_0[j] - 0.5 * fl1_fx * tpz_y_xyyz_0[j] -
                               fl1_fx * fl1_fgb * tdz_y_xyyz_0[j];

            tly_yy_xyyz_0[j] = pa_y[j] * tly_y_xyyz_0[j] + 0.5 * fl1_fx * tly_0_xyyz_0[j] + fl1_fx * tly_y_xyz_0[j];

            tlz_yy_xyyz_0[j] = pa_y[j] * tlz_y_xyyz_0[j] + 0.5 * fl1_fx * tlz_0_xyyz_0[j] + fl1_fx * tlz_y_xyz_0[j] + 0.5 * fl1_fx * tpx_y_xyyz_0[j] +
                               fl1_fx * fl1_fgb * tdx_y_xyyz_0[j];

            tlx_yy_xyzz_0[j] = pa_y[j] * tlx_y_xyzz_0[j] + 0.5 * fl1_fx * tlx_0_xyzz_0[j] + 0.5 * fl1_fx * tlx_y_xzz_0[j] -
                               0.5 * fl1_fx * tpz_y_xyzz_0[j] - fl1_fx * fl1_fgb * tdz_y_xyzz_0[j];

            tly_yy_xyzz_0[j] = pa_y[j] * tly_y_xyzz_0[j] + 0.5 * fl1_fx * tly_0_xyzz_0[j] + 0.5 * fl1_fx * tly_y_xzz_0[j];

            tlz_yy_xyzz_0[j] = pa_y[j] * tlz_y_xyzz_0[j] + 0.5 * fl1_fx * tlz_0_xyzz_0[j] + 0.5 * fl1_fx * tlz_y_xzz_0[j] +
                               0.5 * fl1_fx * tpx_y_xyzz_0[j] + fl1_fx * fl1_fgb * tdx_y_xyzz_0[j];

            tlx_yy_xzzz_0[j] =
                pa_y[j] * tlx_y_xzzz_0[j] + 0.5 * fl1_fx * tlx_0_xzzz_0[j] - 0.5 * fl1_fx * tpz_y_xzzz_0[j] - fl1_fx * fl1_fgb * tdz_y_xzzz_0[j];

            tly_yy_xzzz_0[j] = pa_y[j] * tly_y_xzzz_0[j] + 0.5 * fl1_fx * tly_0_xzzz_0[j];

            tlz_yy_xzzz_0[j] =
                pa_y[j] * tlz_y_xzzz_0[j] + 0.5 * fl1_fx * tlz_0_xzzz_0[j] + 0.5 * fl1_fx * tpx_y_xzzz_0[j] + fl1_fx * fl1_fgb * tdx_y_xzzz_0[j];

            tlx_yy_yyyy_0[j] = pa_y[j] * tlx_y_yyyy_0[j] + 0.5 * fl1_fx * tlx_0_yyyy_0[j] + 2.0 * fl1_fx * tlx_y_yyy_0[j] -
                               0.5 * fl1_fx * tpz_y_yyyy_0[j] - fl1_fx * fl1_fgb * tdz_y_yyyy_0[j];

            tly_yy_yyyy_0[j] = pa_y[j] * tly_y_yyyy_0[j] + 0.5 * fl1_fx * tly_0_yyyy_0[j] + 2.0 * fl1_fx * tly_y_yyy_0[j];

            tlz_yy_yyyy_0[j] = pa_y[j] * tlz_y_yyyy_0[j] + 0.5 * fl1_fx * tlz_0_yyyy_0[j] + 2.0 * fl1_fx * tlz_y_yyy_0[j] +
                               0.5 * fl1_fx * tpx_y_yyyy_0[j] + fl1_fx * fl1_fgb * tdx_y_yyyy_0[j];

            tlx_yy_yyyz_0[j] = pa_y[j] * tlx_y_yyyz_0[j] + 0.5 * fl1_fx * tlx_0_yyyz_0[j] + 1.5 * fl1_fx * tlx_y_yyz_0[j] -
                               0.5 * fl1_fx * tpz_y_yyyz_0[j] - fl1_fx * fl1_fgb * tdz_y_yyyz_0[j];

            tly_yy_yyyz_0[j] = pa_y[j] * tly_y_yyyz_0[j] + 0.5 * fl1_fx * tly_0_yyyz_0[j] + 1.5 * fl1_fx * tly_y_yyz_0[j];

            tlz_yy_yyyz_0[j] = pa_y[j] * tlz_y_yyyz_0[j] + 0.5 * fl1_fx * tlz_0_yyyz_0[j] + 1.5 * fl1_fx * tlz_y_yyz_0[j] +
                               0.5 * fl1_fx * tpx_y_yyyz_0[j] + fl1_fx * fl1_fgb * tdx_y_yyyz_0[j];

            tlx_yy_yyzz_0[j] = pa_y[j] * tlx_y_yyzz_0[j] + 0.5 * fl1_fx * tlx_0_yyzz_0[j] + fl1_fx * tlx_y_yzz_0[j] - 0.5 * fl1_fx * tpz_y_yyzz_0[j] -
                               fl1_fx * fl1_fgb * tdz_y_yyzz_0[j];

            tly_yy_yyzz_0[j] = pa_y[j] * tly_y_yyzz_0[j] + 0.5 * fl1_fx * tly_0_yyzz_0[j] + fl1_fx * tly_y_yzz_0[j];

            tlz_yy_yyzz_0[j] = pa_y[j] * tlz_y_yyzz_0[j] + 0.5 * fl1_fx * tlz_0_yyzz_0[j] + fl1_fx * tlz_y_yzz_0[j] + 0.5 * fl1_fx * tpx_y_yyzz_0[j] +
                               fl1_fx * fl1_fgb * tdx_y_yyzz_0[j];

            tlx_yy_yzzz_0[j] = pa_y[j] * tlx_y_yzzz_0[j] + 0.5 * fl1_fx * tlx_0_yzzz_0[j] + 0.5 * fl1_fx * tlx_y_zzz_0[j] -
                               0.5 * fl1_fx * tpz_y_yzzz_0[j] - fl1_fx * fl1_fgb * tdz_y_yzzz_0[j];

            tly_yy_yzzz_0[j] = pa_y[j] * tly_y_yzzz_0[j] + 0.5 * fl1_fx * tly_0_yzzz_0[j] + 0.5 * fl1_fx * tly_y_zzz_0[j];

            tlz_yy_yzzz_0[j] = pa_y[j] * tlz_y_yzzz_0[j] + 0.5 * fl1_fx * tlz_0_yzzz_0[j] + 0.5 * fl1_fx * tlz_y_zzz_0[j] +
                               0.5 * fl1_fx * tpx_y_yzzz_0[j] + fl1_fx * fl1_fgb * tdx_y_yzzz_0[j];

            tlx_yy_zzzz_0[j] =
                pa_y[j] * tlx_y_zzzz_0[j] + 0.5 * fl1_fx * tlx_0_zzzz_0[j] - 0.5 * fl1_fx * tpz_y_zzzz_0[j] - fl1_fx * fl1_fgb * tdz_y_zzzz_0[j];

            tly_yy_zzzz_0[j] = pa_y[j] * tly_y_zzzz_0[j] + 0.5 * fl1_fx * tly_0_zzzz_0[j];

            tlz_yy_zzzz_0[j] =
                pa_y[j] * tlz_y_zzzz_0[j] + 0.5 * fl1_fx * tlz_0_zzzz_0[j] + 0.5 * fl1_fx * tpx_y_zzzz_0[j] + fl1_fx * fl1_fgb * tdx_y_zzzz_0[j];
        }
                                 ...
                                 const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tlx_yz_xxxy_0[j] =
                pa_y[j] * tlx_z_xxxy_0[j] + 0.5 * fl1_fx * tlx_z_xxx_0[j] - 0.5 * fl1_fx * tpz_z_xxxy_0[j] - fl1_fx * fl1_fgb * tdz_z_xxxy_0[j];

            tly_yz_xxxy_0[j] = pa_y[j] * tly_z_xxxy_0[j] + 0.5 * fl1_fx * tly_z_xxx_0[j];

            tlz_yz_xxxy_0[j] =
                pa_y[j] * tlz_z_xxxy_0[j] + 0.5 * fl1_fx * tlz_z_xxx_0[j] + 0.5 * fl1_fx * tpx_z_xxxy_0[j] + fl1_fx * fl1_fgb * tdx_z_xxxy_0[j];
            ...
            tlx_yz_xxyy_0[j] =
                pa_y[j] * tlx_z_xxyy_0[j] + fl1_fx * tlx_z_xxy_0[j] - 0.5 * fl1_fx * tpz_z_xxyy_0[j] - fl1_fx * fl1_fgb * tdz_z_xxyy_0[j];

            tly_yz_xxyy_0[j] = pa_y[j] * tly_z_xxyy_0[j] + fl1_fx * tly_z_xxy_0[j];

            tlz_yz_xxyy_0[j] =
                pa_y[j] * tlz_z_xxyy_0[j] + fl1_fx * tlz_z_xxy_0[j] + 0.5 * fl1_fx * tpx_z_xxyy_0[j] + fl1_fx * fl1_fgb * tdx_z_xxyy_0[j];

            tlx_yz_xxyz_0[j] =
                pa_y[j] * tlx_z_xxyz_0[j] + 0.5 * fl1_fx * tlx_z_xxz_0[j] - 0.5 * fl1_fx * tpz_z_xxyz_0[j] - fl1_fx * fl1_fgb * tdz_z_xxyz_0[j];

            tly_yz_xxyz_0[j] = pa_y[j] * tly_z_xxyz_0[j] + 0.5 * fl1_fx * tly_z_xxz_0[j];

            tlz_yz_xxyz_0[j] =
                pa_y[j] * tlz_z_xxyz_0[j] + 0.5 * fl1_fx * tlz_z_xxz_0[j] + 0.5 * fl1_fx * tpx_z_xxyz_0[j] + fl1_fx * fl1_fgb * tdx_z_xxyz_0[j];
            ...
            tlx_yz_xyyy_0[j] =
                pa_y[j] * tlx_z_xyyy_0[j] + 1.5 * fl1_fx * tlx_z_xyy_0[j] - 0.5 * fl1_fx * tpz_z_xyyy_0[j] - fl1_fx * fl1_fgb * tdz_z_xyyy_0[j];

            tly_yz_xyyy_0[j] = pa_y[j] * tly_z_xyyy_0[j] + 1.5 * fl1_fx * tly_z_xyy_0[j];

            tlz_yz_xyyy_0[j] =
                pa_y[j] * tlz_z_xyyy_0[j] + 1.5 * fl1_fx * tlz_z_xyy_0[j] + 0.5 * fl1_fx * tpx_z_xyyy_0[j] + fl1_fx * fl1_fgb * tdx_z_xyyy_0[j];

            tlx_yz_xyyz_0[j] =
                pa_y[j] * tlx_z_xyyz_0[j] + fl1_fx * tlx_z_xyz_0[j] - 0.5 * fl1_fx * tpz_z_xyyz_0[j] - fl1_fx * fl1_fgb * tdz_z_xyyz_0[j];

            tly_yz_xyyz_0[j] = pa_y[j] * tly_z_xyyz_0[j] + fl1_fx * tly_z_xyz_0[j];

            tlz_yz_xyyz_0[j] =
                pa_y[j] * tlz_z_xyyz_0[j] + fl1_fx * tlz_z_xyz_0[j] + 0.5 * fl1_fx * tpx_z_xyyz_0[j] + fl1_fx * fl1_fgb * tdx_z_xyyz_0[j];

            tlx_yz_xyzz_0[j] =
                pa_y[j] * tlx_z_xyzz_0[j] + 0.5 * fl1_fx * tlx_z_xzz_0[j] - 0.5 * fl1_fx * tpz_z_xyzz_0[j] - fl1_fx * fl1_fgb * tdz_z_xyzz_0[j];

            tly_yz_xyzz_0[j] = pa_y[j] * tly_z_xyzz_0[j] + 0.5 * fl1_fx * tly_z_xzz_0[j];

            tlz_yz_xyzz_0[j] =
                pa_y[j] * tlz_z_xyzz_0[j] + 0.5 * fl1_fx * tlz_z_xzz_0[j] + 0.5 * fl1_fx * tpx_z_xyzz_0[j] + fl1_fx * fl1_fgb * tdx_z_xyzz_0[j];
            ...
            tlx_yz_yyyy_0[j] =
                pa_y[j] * tlx_z_yyyy_0[j] + 2.0 * fl1_fx * tlx_z_yyy_0[j] - 0.5 * fl1_fx * tpz_z_yyyy_0[j] - fl1_fx * fl1_fgb * tdz_z_yyyy_0[j];

            tly_yz_yyyy_0[j] = pa_y[j] * tly_z_yyyy_0[j] + 2.0 * fl1_fx * tly_z_yyy_0[j];

            tlz_yz_yyyy_0[j] =
                pa_y[j] * tlz_z_yyyy_0[j] + 2.0 * fl1_fx * tlz_z_yyy_0[j] + 0.5 * fl1_fx * tpx_z_yyyy_0[j] + fl1_fx * fl1_fgb * tdx_z_yyyy_0[j];

            tlx_yz_yyyz_0[j] =
                pa_y[j] * tlx_z_yyyz_0[j] + 1.5 * fl1_fx * tlx_z_yyz_0[j] - 0.5 * fl1_fx * tpz_z_yyyz_0[j] - fl1_fx * fl1_fgb * tdz_z_yyyz_0[j];

            tly_yz_yyyz_0[j] = pa_y[j] * tly_z_yyyz_0[j] + 1.5 * fl1_fx * tly_z_yyz_0[j];

            tlz_yz_yyyz_0[j] =
                pa_y[j] * tlz_z_yyyz_0[j] + 1.5 * fl1_fx * tlz_z_yyz_0[j] + 0.5 * fl1_fx * tpx_z_yyyz_0[j] + fl1_fx * fl1_fgb * tdx_z_yyyz_0[j];

            tlx_yz_yyzz_0[j] =
                pa_y[j] * tlx_z_yyzz_0[j] + fl1_fx * tlx_z_yzz_0[j] - 0.5 * fl1_fx * tpz_z_yyzz_0[j] - fl1_fx * fl1_fgb * tdz_z_yyzz_0[j];

            tly_yz_yyzz_0[j] = pa_y[j] * tly_z_yyzz_0[j] + fl1_fx * tly_z_yzz_0[j];

            tlz_yz_yyzz_0[j] =
                pa_y[j] * tlz_z_yyzz_0[j] + fl1_fx * tlz_z_yzz_0[j] + 0.5 * fl1_fx * tpx_z_yyzz_0[j] + fl1_fx * fl1_fgb * tdx_z_yyzz_0[j];

            tlx_yz_yzzz_0[j] =
                pa_y[j] * tlx_z_yzzz_0[j] + 0.5 * fl1_fx * tlx_z_zzz_0[j] - 0.5 * fl1_fx * tpz_z_yzzz_0[j] - fl1_fx * fl1_fgb * tdz_z_yzzz_0[j];

            tly_yz_yzzz_0[j] = pa_y[j] * tly_z_yzzz_0[j] + 0.5 * fl1_fx * tly_z_zzz_0[j];

            tlz_yz_yzzz_0[j] =
                pa_y[j] * tlz_z_yzzz_0[j] + 0.5 * fl1_fx * tlz_z_zzz_0[j] + 0.5 * fl1_fx * tpx_z_yzzz_0[j] + fl1_fx * fl1_fgb * tdx_z_yzzz_0[j];
                                 ...
                                 const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tlx_zz_xxxx_0[j] =
                pa_z[j] * tlx_z_xxxx_0[j] + 0.5 * fl1_fx * tlx_0_xxxx_0[j] + 0.5 * fl1_fx * tpy_z_xxxx_0[j] + fl1_fx * fl1_fgb * tdy_z_xxxx_0[j];

            tly_zz_xxxx_0[j] =
                pa_z[j] * tly_z_xxxx_0[j] + 0.5 * fl1_fx * tly_0_xxxx_0[j] - 0.5 * fl1_fx * tpx_z_xxxx_0[j] - fl1_fx * fl1_fgb * tdx_z_xxxx_0[j];

            tlz_zz_xxxx_0[j] = pa_z[j] * tlz_z_xxxx_0[j] + 0.5 * fl1_fx * tlz_0_xxxx_0[j];

            tlx_zz_xxxy_0[j] =
                pa_z[j] * tlx_z_xxxy_0[j] + 0.5 * fl1_fx * tlx_0_xxxy_0[j] + 0.5 * fl1_fx * tpy_z_xxxy_0[j] + fl1_fx * fl1_fgb * tdy_z_xxxy_0[j];

            tly_zz_xxxy_0[j] =
                pa_z[j] * tly_z_xxxy_0[j] + 0.5 * fl1_fx * tly_0_xxxy_0[j] - 0.5 * fl1_fx * tpx_z_xxxy_0[j] - fl1_fx * fl1_fgb * tdx_z_xxxy_0[j];

            tlz_zz_xxxy_0[j] = pa_z[j] * tlz_z_xxxy_0[j] + 0.5 * fl1_fx * tlz_0_xxxy_0[j];

            tlx_zz_xxxz_0[j] = pa_z[j] * tlx_z_xxxz_0[j] + 0.5 * fl1_fx * tlx_0_xxxz_0[j] + 0.5 * fl1_fx * tlx_z_xxx_0[j] +
                               0.5 * fl1_fx * tpy_z_xxxz_0[j] + fl1_fx * fl1_fgb * tdy_z_xxxz_0[j];

            tly_zz_xxxz_0[j] = pa_z[j] * tly_z_xxxz_0[j] + 0.5 * fl1_fx * tly_0_xxxz_0[j] + 0.5 * fl1_fx * tly_z_xxx_0[j] -
                               0.5 * fl1_fx * tpx_z_xxxz_0[j] - fl1_fx * fl1_fgb * tdx_z_xxxz_0[j];

            tlz_zz_xxxz_0[j] = pa_z[j] * tlz_z_xxxz_0[j] + 0.5 * fl1_fx * tlz_0_xxxz_0[j] + 0.5 * fl1_fx * tlz_z_xxx_0[j];

            tlx_zz_xxyy_0[j] =
                pa_z[j] * tlx_z_xxyy_0[j] + 0.5 * fl1_fx * tlx_0_xxyy_0[j] + 0.5 * fl1_fx * tpy_z_xxyy_0[j] + fl1_fx * fl1_fgb * tdy_z_xxyy_0[j];

            tly_zz_xxyy_0[j] =
                pa_z[j] * tly_z_xxyy_0[j] + 0.5 * fl1_fx * tly_0_xxyy_0[j] - 0.5 * fl1_fx * tpx_z_xxyy_0[j] - fl1_fx * fl1_fgb * tdx_z_xxyy_0[j];

            tlz_zz_xxyy_0[j] = pa_z[j] * tlz_z_xxyy_0[j] + 0.5 * fl1_fx * tlz_0_xxyy_0[j];

            tlx_zz_xxyz_0[j] = pa_z[j] * tlx_z_xxyz_0[j] + 0.5 * fl1_fx * tlx_0_xxyz_0[j] + 0.5 * fl1_fx * tlx_z_xxy_0[j] +
                               0.5 * fl1_fx * tpy_z_xxyz_0[j] + fl1_fx * fl1_fgb * tdy_z_xxyz_0[j];

            tly_zz_xxyz_0[j] = pa_z[j] * tly_z_xxyz_0[j] + 0.5 * fl1_fx * tly_0_xxyz_0[j] + 0.5 * fl1_fx * tly_z_xxy_0[j] -
                               0.5 * fl1_fx * tpx_z_xxyz_0[j] - fl1_fx * fl1_fgb * tdx_z_xxyz_0[j];

            tlz_zz_xxyz_0[j] = pa_z[j] * tlz_z_xxyz_0[j] + 0.5 * fl1_fx * tlz_0_xxyz_0[j] + 0.5 * fl1_fx * tlz_z_xxy_0[j];

            tlx_zz_xxzz_0[j] = pa_z[j] * tlx_z_xxzz_0[j] + 0.5 * fl1_fx * tlx_0_xxzz_0[j] + fl1_fx * tlx_z_xxz_0[j] + 0.5 * fl1_fx * tpy_z_xxzz_0[j] +
                               fl1_fx * fl1_fgb * tdy_z_xxzz_0[j];

            tly_zz_xxzz_0[j] = pa_z[j] * tly_z_xxzz_0[j] + 0.5 * fl1_fx * tly_0_xxzz_0[j] + fl1_fx * tly_z_xxz_0[j] - 0.5 * fl1_fx * tpx_z_xxzz_0[j] -
                               fl1_fx * fl1_fgb * tdx_z_xxzz_0[j];

            tlz_zz_xxzz_0[j] = pa_z[j] * tlz_z_xxzz_0[j] + 0.5 * fl1_fx * tlz_0_xxzz_0[j] + fl1_fx * tlz_z_xxz_0[j];

            tlx_zz_xyyy_0[j] =
                pa_z[j] * tlx_z_xyyy_0[j] + 0.5 * fl1_fx * tlx_0_xyyy_0[j] + 0.5 * fl1_fx * tpy_z_xyyy_0[j] + fl1_fx * fl1_fgb * tdy_z_xyyy_0[j];

            tly_zz_xyyy_0[j] =
                pa_z[j] * tly_z_xyyy_0[j] + 0.5 * fl1_fx * tly_0_xyyy_0[j] - 0.5 * fl1_fx * tpx_z_xyyy_0[j] - fl1_fx * fl1_fgb * tdx_z_xyyy_0[j];

            tlz_zz_xyyy_0[j] = pa_z[j] * tlz_z_xyyy_0[j] + 0.5 * fl1_fx * tlz_0_xyyy_0[j];

            tlx_zz_xyyz_0[j] = pa_z[j] * tlx_z_xyyz_0[j] + 0.5 * fl1_fx * tlx_0_xyyz_0[j] + 0.5 * fl1_fx * tlx_z_xyy_0[j] +
                               0.5 * fl1_fx * tpy_z_xyyz_0[j] + fl1_fx * fl1_fgb * tdy_z_xyyz_0[j];

            tly_zz_xyyz_0[j] = pa_z[j] * tly_z_xyyz_0[j] + 0.5 * fl1_fx * tly_0_xyyz_0[j] + 0.5 * fl1_fx * tly_z_xyy_0[j] -
                               0.5 * fl1_fx * tpx_z_xyyz_0[j] - fl1_fx * fl1_fgb * tdx_z_xyyz_0[j];

            tlz_zz_xyyz_0[j] = pa_z[j] * tlz_z_xyyz_0[j] + 0.5 * fl1_fx * tlz_0_xyyz_0[j] + 0.5 * fl1_fx * tlz_z_xyy_0[j];

            tlx_zz_xyzz_0[j] = pa_z[j] * tlx_z_xyzz_0[j] + 0.5 * fl1_fx * tlx_0_xyzz_0[j] + fl1_fx * tlx_z_xyz_0[j] + 0.5 * fl1_fx * tpy_z_xyzz_0[j] +
                               fl1_fx * fl1_fgb * tdy_z_xyzz_0[j];

            tly_zz_xyzz_0[j] = pa_z[j] * tly_z_xyzz_0[j] + 0.5 * fl1_fx * tly_0_xyzz_0[j] + fl1_fx * tly_z_xyz_0[j] - 0.5 * fl1_fx * tpx_z_xyzz_0[j] -
                               fl1_fx * fl1_fgb * tdx_z_xyzz_0[j];

            tlz_zz_xyzz_0[j] = pa_z[j] * tlz_z_xyzz_0[j] + 0.5 * fl1_fx * tlz_0_xyzz_0[j] + fl1_fx * tlz_z_xyz_0[j];

            tlx_zz_xzzz_0[j] = pa_z[j] * tlx_z_xzzz_0[j] + 0.5 * fl1_fx * tlx_0_xzzz_0[j] + 1.5 * fl1_fx * tlx_z_xzz_0[j] +
                               0.5 * fl1_fx * tpy_z_xzzz_0[j] + fl1_fx * fl1_fgb * tdy_z_xzzz_0[j];

            tly_zz_xzzz_0[j] = pa_z[j] * tly_z_xzzz_0[j] + 0.5 * fl1_fx * tly_0_xzzz_0[j] + 1.5 * fl1_fx * tly_z_xzz_0[j] -
                               0.5 * fl1_fx * tpx_z_xzzz_0[j] - fl1_fx * fl1_fgb * tdx_z_xzzz_0[j];

            tlz_zz_xzzz_0[j] = pa_z[j] * tlz_z_xzzz_0[j] + 0.5 * fl1_fx * tlz_0_xzzz_0[j] + 1.5 * fl1_fx * tlz_z_xzz_0[j];

            tlx_zz_yyyy_0[j] =
                pa_z[j] * tlx_z_yyyy_0[j] + 0.5 * fl1_fx * tlx_0_yyyy_0[j] + 0.5 * fl1_fx * tpy_z_yyyy_0[j] + fl1_fx * fl1_fgb * tdy_z_yyyy_0[j];

            tly_zz_yyyy_0[j] =
                pa_z[j] * tly_z_yyyy_0[j] + 0.5 * fl1_fx * tly_0_yyyy_0[j] - 0.5 * fl1_fx * tpx_z_yyyy_0[j] - fl1_fx * fl1_fgb * tdx_z_yyyy_0[j];

            tlz_zz_yyyy_0[j] = pa_z[j] * tlz_z_yyyy_0[j] + 0.5 * fl1_fx * tlz_0_yyyy_0[j];

            tlx_zz_yyyz_0[j] = pa_z[j] * tlx_z_yyyz_0[j] + 0.5 * fl1_fx * tlx_0_yyyz_0[j] + 0.5 * fl1_fx * tlx_z_yyy_0[j] +
                               0.5 * fl1_fx * tpy_z_yyyz_0[j] + fl1_fx * fl1_fgb * tdy_z_yyyz_0[j];

            tly_zz_yyyz_0[j] = pa_z[j] * tly_z_yyyz_0[j] + 0.5 * fl1_fx * tly_0_yyyz_0[j] + 0.5 * fl1_fx * tly_z_yyy_0[j] -
                               0.5 * fl1_fx * tpx_z_yyyz_0[j] - fl1_fx * fl1_fgb * tdx_z_yyyz_0[j];

            tlz_zz_yyyz_0[j] = pa_z[j] * tlz_z_yyyz_0[j] + 0.5 * fl1_fx * tlz_0_yyyz_0[j] + 0.5 * fl1_fx * tlz_z_yyy_0[j];

            tlx_zz_yyzz_0[j] = pa_z[j] * tlx_z_yyzz_0[j] + 0.5 * fl1_fx * tlx_0_yyzz_0[j] + fl1_fx * tlx_z_yyz_0[j] + 0.5 * fl1_fx * tpy_z_yyzz_0[j] +
                               fl1_fx * fl1_fgb * tdy_z_yyzz_0[j];

            tly_zz_yyzz_0[j] = pa_z[j] * tly_z_yyzz_0[j] + 0.5 * fl1_fx * tly_0_yyzz_0[j] + fl1_fx * tly_z_yyz_0[j] - 0.5 * fl1_fx * tpx_z_yyzz_0[j] -
                               fl1_fx * fl1_fgb * tdx_z_yyzz_0[j];

            tlz_zz_yyzz_0[j] = pa_z[j] * tlz_z_yyzz_0[j] + 0.5 * fl1_fx * tlz_0_yyzz_0[j] + fl1_fx * tlz_z_yyz_0[j];

            tlx_zz_yzzz_0[j] = pa_z[j] * tlx_z_yzzz_0[j] + 0.5 * fl1_fx * tlx_0_yzzz_0[j] + 1.5 * fl1_fx * tlx_z_yzz_0[j] +
                               0.5 * fl1_fx * tpy_z_yzzz_0[j] + fl1_fx * fl1_fgb * tdy_z_yzzz_0[j];

            tly_zz_yzzz_0[j] = pa_z[j] * tly_z_yzzz_0[j] + 0.5 * fl1_fx * tly_0_yzzz_0[j] + 1.5 * fl1_fx * tly_z_yzz_0[j] -
                               0.5 * fl1_fx * tpx_z_yzzz_0[j] - fl1_fx * fl1_fgb * tdx_z_yzzz_0[j];

            tlz_zz_yzzz_0[j] = pa_z[j] * tlz_z_yzzz_0[j] + 0.5 * fl1_fx * tlz_0_yzzz_0[j] + 1.5 * fl1_fx * tlz_z_yzz_0[j];

            tlx_zz_zzzz_0[j] = pa_z[j] * tlx_z_zzzz_0[j] + 0.5 * fl1_fx * tlx_0_zzzz_0[j] + 2.0 * fl1_fx * tlx_z_zzz_0[j] +
                               0.5 * fl1_fx * tpy_z_zzzz_0[j] + fl1_fx * fl1_fgb * tdy_z_zzzz_0[j];

            tly_zz_zzzz_0[j] = pa_z[j] * tly_z_zzzz_0[j] + 0.5 * fl1_fx * tly_0_zzzz_0[j] + 2.0 * fl1_fx * tly_z_zzz_0[j] -
                               0.5 * fl1_fx * tpx_z_zzzz_0[j] - fl1_fx * fl1_fgb * tdx_z_zzzz_0[j];
...
compAngularMomentumForGD(CMemBlock2D<double>&       primBuffer,
                         ...
                         const int32_t              iContrGto)
{
    amomrecfunc::compAngularMomentumForGD_0_45(primBuffer, recursionMap, osFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    amomrecfunc::compAngularMomentumForGD_45_90(primBuffer, recursionMap, osFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    amomrecfunc::compAngularMomentumForGD_90_135(primBuffer, recursionMap, osFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    amomrecfunc::compAngularMomentumForGD_135_180(primBuffer, recursionMap, osFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    amomrecfunc::compAngularMomentumForGD_180_225(primBuffer, recursionMap, osFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);

    amomrecfunc::compAngularMomentumForGD_225_270(primBuffer, recursionMap, osFactors, paDistances, braGtoBlock, ketGtoBlock, iContrGto);
}
                              ...
                              const int32_t              iContrGto)
{
    ...
    auto pidx_l_4_2_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Angular Momentum"}, 1, true, {4, -1, -1, -1}, {2, -1, -1, -1}, 1, 1, 0));
    ...
    auto pidx_d_3_2_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Electric Dipole"}, 1, true, {3, -1, -1, -1}, {2, -1, -1, -1}, 1, 1, 0));
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tly_xxxx_xx_0[j] = pa_x[j] * tly_xxx_xx_0[j] + 1.5 * fl1_fx * tly_xx_xx_0[j] + fl1_fx * tly_xxx_x_0[j] + 0.5 * fl1_fx * tpz_xxx_xx_0[j] +
                               fl1_fx * fl1_fgb * tdz_xxx_xx_0[j];

            tlz_xxxx_xx_0[j] = pa_x[j] * tlz_xxx_xx_0[j] + 1.5 * fl1_fx * tlz_xx_xx_0[j] + fl1_fx * tlz_xxx_x_0[j] - 0.5 * fl1_fx * tpy_xxx_xx_0[j] -
                               fl1_fx * fl1_fgb * tdy_xxx_xx_0[j];

            tlx_xxxx_xy_0[j] = pa_x[j] * tlx_xxx_xy_0[j] + 1.5 * fl1_fx * tlx_xx_xy_0[j] + 0.5 * fl1_fx * tlx_xxx_y_0[j];

            tly_xxxx_xy_0[j] = pa_x[j] * tly_xxx_xy_0[j] + 1.5 * fl1_fx * tly_xx_xy_0[j] + 0.5 * fl1_fx * tly_xxx_y_0[j] +
                               0.5 * fl1_fx * tpz_xxx_xy_0[j] + fl1_fx * fl1_fgb * tdz_xxx_xy_0[j];

            tlz_xxxx_xy_0[j] = pa_x[j] * tlz_xxx_xy_0[j] + 1.5 * fl1_fx * tlz_xx_xy_0[j] + 0.5 * fl1_fx * tlz_xxx_y_0[j] -
                               0.5 * fl1_fx * tpy_xxx_xy_0[j] - fl1_fx * fl1_fgb * tdy_xxx_xy_0[j];

            tlx_xxxx_xz_0[j] = pa_x[j] * tlx_xxx_xz_0[j] + 1.5 * fl1_fx * tlx_xx_xz_0[j] + 0.5 * fl1_fx * tlx_xxx_z_0[j];

            tly_xxxx_xz_0[j] = pa_x[j] * tly_xxx_xz_0[j] + 1.5 * fl1_fx * tly_xx_xz_0[j] + 0.5 * fl1_fx * tly_xxx_z_0[j] +
                               0.5 * fl1_fx * tpz_xxx_xz_0[j] + fl1_fx * fl1_fgb * tdz_xxx_xz_0[j];

            tlz_xxxx_xz_0[j] = pa_x[j] * tlz_xxx_xz_0[j] + 1.5 * fl1_fx * tlz_xx_xz_0[j] + 0.5 * fl1_fx * tlz_xxx_z_0[j] -
                               0.5 * fl1_fx * tpy_xxx_xz_0[j] - fl1_fx * fl1_fgb * tdy_xxx_xz_0[j];

            tlx_xxxx_yy_0[j] = pa_x[j] * tlx_xxx_yy_0[j] + 1.5 * fl1_fx * tlx_xx_yy_0[j];

            tly_xxxx_yy_0[j] =
                pa_x[j] * tly_xxx_yy_0[j] + 1.5 * fl1_fx * tly_xx_yy_0[j] + 0.5 * fl1_fx * tpz_xxx_yy_0[j] + fl1_fx * fl1_fgb * tdz_xxx_yy_0[j];

            tlz_xxxx_yy_0[j] =
                pa_x[j] * tlz_xxx_yy_0[j] + 1.5 * fl1_fx * tlz_xx_yy_0[j] - 0.5 * fl1_fx * tpy_xxx_yy_0[j] - fl1_fx * fl1_fgb * tdy_xxx_yy_0[j];

            tlx_xxxx_yz_0[j] = pa_x[j] * tlx_xxx_yz_0[j] + 1.5 * fl1_fx * tlx_xx_yz_0[j];

            tly_xxxx_yz_0[j] =
                pa_x[j] * tly_xxx_yz_0[j] + 1.5 * fl1_fx * tly_xx_yz_0[j] + 0.5 * fl1_fx * tpz_xxx_yz_0[j] + fl1_fx * fl1_fgb * tdz_xxx_yz_0[j];

            tlz_xxxx_yz_0[j] =
                pa_x[j] * tlz_xxx_yz_0[j] + 1.5 * fl1_fx * tlz_xx_yz_0[j] - 0.5 * fl1_fx * tpy_xxx_yz_0[j] - fl1_fx * fl1_fgb * tdy_xxx_yz_0[j];

            tlx_xxxx_zz_0[j] = pa_x[j] * tlx_xxx_zz_0[j] + 1.5 * fl1_fx * tlx_xx_zz_0[j];

            tly_xxxx_zz_0[j] =
                pa_x[j] * tly_xxx_zz_0[j] + 1.5 * fl1_fx * tly_xx_zz_0[j] + 0.5 * fl1_fx * tpz_xxx_zz_0[j] + fl1_fx * fl1_fgb * tdz_xxx_zz_0[j];

            tlz_xxxx_zz_0[j] =
                pa_x[j] * tlz_xxx_zz_0[j] + 1.5 * fl1_fx * tlz_xx_zz_0[j] - 0.5 * fl1_fx * tpy_xxx_zz_0[j] - fl1_fx * fl1_fgb * tdy_xxx_zz_0[j];

            tlx_xxxy_xx_0[j] = pa_x[j] * tlx_xxy_xx_0[j] + fl1_fx * tlx_xy_xx_0[j] + fl1_fx * tlx_xxy_x_0[j];

            tly_xxxy_xx_0[j] = pa_x[j] * tly_xxy_xx_0[j] + fl1_fx * tly_xy_xx_0[j] + fl1_fx * tly_xxy_x_0[j] + 0.5 * fl1_fx * tpz_xxy_xx_0[j] +
                               fl1_fx * fl1_fgb * tdz_xxy_xx_0[j];

            tlz_xxxy_xx_0[j] = pa_x[j] * tlz_xxy_xx_0[j] + fl1_fx * tlz_xy_xx_0[j] + fl1_fx * tlz_xxy_x_0[j] - 0.5 * fl1_fx * tpy_xxy_xx_0[j] -
                               fl1_fx * fl1_fgb * tdy_xxy_xx_0[j];

            tlx_xxxy_xy_0[j] = pa_x[j] * tlx_xxy_xy_0[j] + fl1_fx * tlx_xy_xy_0[j] + 0.5 * fl1_fx * tlx_xxy_y_0[j];

            tly_xxxy_xy_0[j] = pa_x[j] * tly_xxy_xy_0[j] + fl1_fx * tly_xy_xy_0[j] + 0.5 * fl1_fx * tly_xxy_y_0[j] + 0.5 * fl1_fx * tpz_xxy_xy_0[j] +
                               fl1_fx * fl1_fgb * tdz_xxy_xy_0[j];

            tlz_xxxy_xy_0[j] = pa_x[j] * tlz_xxy_xy_0[j] + fl1_fx * tlz_xy_xy_0[j] + 0.5 * fl1_fx * tlz_xxy_y_0[j] - 0.5 * fl1_fx * tpy_xxy_xy_0[j] -
                               fl1_fx * fl1_fgb * tdy_xxy_xy_0[j];

            tlx_xxxy_xz_0[j] = pa_x[j] * tlx_xxy_xz_0[j] + fl1_fx * tlx_xy_xz_0[j] + 0.5 * fl1_fx * tlx_xxy_z_0[j];

            tly_xxxy_xz_0[j] = pa_x[j] * tly_xxy_xz_0[j] + fl1_fx * tly_xy_xz_0[j] + 0.5 * fl1_fx * tly_xxy_z_0[j] + 0.5 * fl1_fx * tpz_xxy_xz_0[j] +
                               fl1_fx * fl1_fgb * tdz_xxy_xz_0[j];

            tlz_xxxy_xz_0[j] = pa_x[j] * tlz_xxy_xz_0[j] + fl1_fx * tlz_xy_xz_0[j] + 0.5 * fl1_fx * tlz_xxy_z_0[j] - 0.5 * fl1_fx * tpy_xxy_xz_0[j] -
                               fl1_fx * fl1_fgb * tdy_xxy_xz_0[j];

            tlx_xxxy_yy_0[j] = pa_x[j] * tlx_xxy_yy_0[j] + fl1_fx * tlx_xy_yy_0[j];

            tly_xxxy_yy_0[j] =
                pa_x[j] * tly_xxy_yy_0[j] + fl1_fx * tly_xy_yy_0[j] + 0.5 * fl1_fx * tpz_xxy_yy_0[j] + fl1_fx * fl1_fgb * tdz_xxy_yy_0[j];

            tlz_xxxy_yy_0[j] =
                pa_x[j] * tlz_xxy_yy_0[j] + fl1_fx * tlz_xy_yy_0[j] - 0.5 * fl1_fx * tpy_xxy_yy_0[j] - fl1_fx * fl1_fgb * tdy_xxy_yy_0[j];

            tlx_xxxy_yz_0[j] = pa_x[j] * tlx_xxy_yz_0[j] + fl1_fx * tlx_xy_yz_0[j];

            tly_xxxy_yz_0[j] =
                pa_x[j] * tly_xxy_yz_0[j] + fl1_fx * tly_xy_yz_0[j] + 0.5 * fl1_fx * tpz_xxy_yz_0[j] + fl1_fx * fl1_fgb * tdz_xxy_yz_0[j];

            tlz_xxxy_yz_0[j] =
                pa_x[j] * tlz_xxy_yz_0[j] + fl1_fx * tlz_xy_yz_0[j] - 0.5 * fl1_fx * tpy_xxy_yz_0[j] - fl1_fx * fl1_fgb * tdy_xxy_yz_0[j];

            tlx_xxxy_zz_0[j] = pa_x[j] * tlx_xxy_zz_0[j] + fl1_fx * tlx_xy_zz_0[j];

            tly_xxxy_zz_0[j] =
                pa_x[j] * tly_xxy_zz_0[j] + fl1_fx * tly_xy_zz_0[j] + 0.5 * fl1_fx * tpz_xxy_zz_0[j] + fl1_fx * fl1_fgb * tdz_xxy_zz_0[j];

            tlz_xxxy_zz_0[j] =
                pa_x[j] * tlz_xxy_zz_0[j] + fl1_fx * tlz_xy_zz_0[j] - 0.5 * fl1_fx * tpy_xxy_zz_0[j] - fl1_fx * fl1_fgb * tdy_xxy_zz_0[j];

            tlx_xxxz_xx_0[j] = pa_x[j] * tlx_xxz_xx_0[j] + fl1_fx * tlx_xz_xx_0[j] + fl1_fx * tlx_xxz_x_0[j];

            tly_xxxz_xx_0[j] = pa_x[j] * tly_xxz_xx_0[j] + fl1_fx * tly_xz_xx_0[j] + fl1_fx * tly_xxz_x_0[j] + 0.5 * fl1_fx * tpz_xxz_xx_0[j] +
                               fl1_fx * fl1_fgb * tdz_xxz_xx_0[j];

            tlz_xxxz_xx_0[j] = pa_x[j] * tlz_xxz_xx_0[j] + fl1_fx * tlz_xz_xx_0[j] + fl1_fx * tlz_xxz_x_0[j] - 0.5 * fl1_fx * tpy_xxz_xx_0[j] -
                               fl1_fx * fl1_fgb * tdy_xxz_xx_0[j];

            tlx_xxxz_xy_0[j] = pa_x[j] * tlx_xxz_xy_0[j] + fl1_fx * tlx_xz_xy_0[j] + 0.5 * fl1_fx * tlx_xxz_y_0[j];

            tly_xxxz_xy_0[j] = pa_x[j] * tly_xxz_xy_0[j] + fl1_fx * tly_xz_xy_0[j] + 0.5 * fl1_fx * tly_xxz_y_0[j] + 0.5 * fl1_fx * tpz_xxz_xy_0[j] +
                               fl1_fx * fl1_fgb * tdz_xxz_xy_0[j];

            tlz_xxxz_xy_0[j] = pa_x[j] * tlz_xxz_xy_0[j] + fl1_fx * tlz_xz_xy_0[j] + 0.5 * fl1_fx * tlz_xxz_y_0[j] - 0.5 * fl1_fx * tpy_xxz_xy_0[j] -
                               fl1_fx * fl1_fgb * tdy_xxz_xy_0[j];

            tlx_xxxz_xz_0[j] = pa_x[j] * tlx_xxz_xz_0[j] + fl1_fx * tlx_xz_xz_0[j] + 0.5 * fl1_fx * tlx_xxz_z_0[j];

            tly_xxxz_xz_0[j] = pa_x[j] * tly_xxz_xz_0[j] + fl1_fx * tly_xz_xz_0[j] + 0.5 * fl1_fx * tly_xxz_z_0[j] + 0.5 * fl1_fx * tpz_xxz_xz_0[j] +
                               fl1_fx * fl1_fgb * tdz_xxz_xz_0[j];

            tlz_xxxz_xz_0[j] = pa_x[j] * tlz_xxz_xz_0[j] + fl1_fx * tlz_xz_xz_0[j] + 0.5 * fl1_fx * tlz_xxz_z_0[j] - 0.5 * fl1_fx * tpy_xxz_xz_0[j] -
                               fl1_fx * fl1_fgb * tdy_xxz_xz_0[j];
        }
                               ...
                               const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tly_xxxz_yy_0[j] =
                pa_x[j] * tly_xxz_yy_0[j] + fl1_fx * tly_xz_yy_0[j] + 0.5 * fl1_fx * tpz_xxz_yy_0[j] + fl1_fx * fl1_fgb * tdz_xxz_yy_0[j];

            tlz_xxxz_yy_0[j] =
                pa_x[j] * tlz_xxz_yy_0[j] + fl1_fx * tlz_xz_yy_0[j] - 0.5 * fl1_fx * tpy_xxz_yy_0[j] - fl1_fx * fl1_fgb * tdy_xxz_yy_0[j];

            tlx_xxxz_yz_0[j] = pa_x[j] * tlx_xxz_yz_0[j] + fl1_fx * tlx_xz_yz_0[j];

            tly_xxxz_yz_0[j] =
                pa_x[j] * tly_xxz_yz_0[j] + fl1_fx * tly_xz_yz_0[j] + 0.5 * fl1_fx * tpz_xxz_yz_0[j] + fl1_fx * fl1_fgb * tdz_xxz_yz_0[j];

            tlz_xxxz_yz_0[j] =
                pa_x[j] * tlz_xxz_yz_0[j] + fl1_fx * tlz_xz_yz_0[j] - 0.5 * fl1_fx * tpy_xxz_yz_0[j] - fl1_fx * fl1_fgb * tdy_xxz_yz_0[j];

            tlx_xxxz_zz_0[j] = pa_x[j] * tlx_xxz_zz_0[j] + fl1_fx * tlx_xz_zz_0[j];

            tly_xxxz_zz_0[j] =
                pa_x[j] * tly_xxz_zz_0[j] + fl1_fx * tly_xz_zz_0[j] + 0.5 * fl1_fx * tpz_xxz_zz_0[j] + fl1_fx * fl1_fgb * tdz_xxz_zz_0[j];

            tlz_xxxz_zz_0[j] =
                pa_x[j] * tlz_xxz_zz_0[j] + fl1_fx * tlz_xz_zz_0[j] - 0.5 * fl1_fx * tpy_xxz_zz_0[j] - fl1_fx * fl1_fgb * tdy_xxz_zz_0[j];

            tlx_xxyy_xx_0[j] = pa_x[j] * tlx_xyy_xx_0[j] + 0.5 * fl1_fx * tlx_yy_xx_0[j] + fl1_fx * tlx_xyy_x_0[j];

            tly_xxyy_xx_0[j] = pa_x[j] * tly_xyy_xx_0[j] + 0.5 * fl1_fx * tly_yy_xx_0[j] + fl1_fx * tly_xyy_x_0[j] + 0.5 * fl1_fx * tpz_xyy_xx_0[j] +
                               fl1_fx * fl1_fgb * tdz_xyy_xx_0[j];

            tlz_xxyy_xx_0[j] = pa_x[j] * tlz_xyy_xx_0[j] + 0.5 * fl1_fx * tlz_yy_xx_0[j] + fl1_fx * tlz_xyy_x_0[j] - 0.5 * fl1_fx * tpy_xyy_xx_0[j] -
                               fl1_fx * fl1_fgb * tdy_xyy_xx_0[j];

            tlx_xxyy_xy_0[j] = pa_x[j] * tlx_xyy_xy_0[j] + 0.5 * fl1_fx * tlx_yy_xy_0[j] + 0.5 * fl1_fx * tlx_xyy_y_0[j];

            tly_xxyy_xy_0[j] = pa_x[j] * tly_xyy_xy_0[j] + 0.5 * fl1_fx * tly_yy_xy_0[j] + 0.5 * fl1_fx * tly_xyy_y_0[j] +
                               0.5 * fl1_fx * tpz_xyy_xy_0[j] + fl1_fx * fl1_fgb * tdz_xyy_xy_0[j];

            tlz_xxyy_xy_0[j] = pa_x[j] * tlz_xyy_xy_0[j] + 0.5 * fl1_fx * tlz_yy_xy_0[j] + 0.5 * fl1_fx * tlz_xyy_y_0[j] -
                               0.5 * fl1_fx * tpy_xyy_xy_0[j] - fl1_fx * fl1_fgb * tdy_xyy_xy_0[j];

            tlx_xxyy_xz_0[j] = pa_x[j] * tlx_xyy_xz_0[j] + 0.5 * fl1_fx * tlx_yy_xz_0[j] + 0.5 * fl1_fx * tlx_xyy_z_0[j];

            tly_xxyy_xz_0[j] = pa_x[j] * tly_xyy_xz_0[j] + 0.5 * fl1_fx * tly_yy_xz_0[j] + 0.5 * fl1_fx * tly_xyy_z_0[j] +
                               0.5 * fl1_fx * tpz_xyy_xz_0[j] + fl1_fx * fl1_fgb * tdz_xyy_xz_0[j];

            tlz_xxyy_xz_0[j] = pa_x[j] * tlz_xyy_xz_0[j] + 0.5 * fl1_fx * tlz_yy_xz_0[j] + 0.5 * fl1_fx * tlz_xyy_z_0[j] -
                               0.5 * fl1_fx * tpy_xyy_xz_0[j] - fl1_fx * fl1_fgb * tdy_xyy_xz_0[j];

            tlx_xxyy_yy_0[j] = pa_x[j] * tlx_xyy_yy_0[j] + 0.5 * fl1_fx * tlx_yy_yy_0[j];

            tly_xxyy_yy_0[j] =
                pa_x[j] * tly_xyy_yy_0[j] + 0.5 * fl1_fx * tly_yy_yy_0[j] + 0.5 * fl1_fx * tpz_xyy_yy_0[j] + fl1_fx * fl1_fgb * tdz_xyy_yy_0[j];

            tlz_xxyy_yy_0[j] =
                pa_x[j] * tlz_xyy_yy_0[j] + 0.5 * fl1_fx * tlz_yy_yy_0[j] - 0.5 * fl1_fx * tpy_xyy_yy_0[j] - fl1_fx * fl1_fgb * tdy_xyy_yy_0[j];

            tlx_xxyy_yz_0[j] = pa_x[j] * tlx_xyy_yz_0[j] + 0.5 * fl1_fx * tlx_yy_yz_0[j];

            tly_xxyy_yz_0[j] =
                pa_x[j] * tly_xyy_yz_0[j] + 0.5 * fl1_fx * tly_yy_yz_0[j] + 0.5 * fl1_fx * tpz_xyy_yz_0[j] + fl1_fx * fl1_fgb * tdz_xyy_yz_0[j];

            tlz_xxyy_yz_0[j] =
                pa_x[j] * tlz_xyy_yz_0[j] + 0.5 * fl1_fx * tlz_yy_yz_0[j] - 0.5 * fl1_fx * tpy_xyy_yz_0[j] - fl1_fx * fl1_fgb * tdy_xyy_yz_0[j];

            tlx_xxyy_zz_0[j] = pa_x[j] * tlx_xyy_zz_0[j] + 0.5 * fl1_fx * tlx_yy_zz_0[j];

            tly_xxyy_zz_0[j] =
                pa_x[j] * tly_xyy_zz_0[j] + 0.5 * fl1_fx * tly_yy_zz_0[j] + 0.5 * fl1_fx * tpz_xyy_zz_0[j] + fl1_fx * fl1_fgb * tdz_xyy_zz_0[j];

            tlz_xxyy_zz_0[j] =
                pa_x[j] * tlz_xyy_zz_0[j] + 0.5 * fl1_fx * tlz_yy_zz_0[j] - 0.5 * fl1_fx * tpy_xyy_zz_0[j] - fl1_fx * fl1_fgb * tdy_xyy_zz_0[j];

            tlx_xxyz_xx_0[j] = pa_x[j] * tlx_xyz_xx_0[j] + 0.5 * fl1_fx * tlx_yz_xx_0[j] + fl1_fx * tlx_xyz_x_0[j];

            tly_xxyz_xx_0[j] = pa_x[j] * tly_xyz_xx_0[j] + 0.5 * fl1_fx * tly_yz_xx_0[j] + fl1_fx * tly_xyz_x_0[j] + 0.5 * fl1_fx * tpz_xyz_xx_0[j] +
                               fl1_fx * fl1_fgb * tdz_xyz_xx_0[j];

            tlz_xxyz_xx_0[j] = pa_x[j] * tlz_xyz_xx_0[j] + 0.5 * fl1_fx * tlz_yz_xx_0[j] + fl1_fx * tlz_xyz_x_0[j] - 0.5 * fl1_fx * tpy_xyz_xx_0[j] -
                               fl1_fx * fl1_fgb * tdy_xyz_xx_0[j];

            tlx_xxyz_xy_0[j] = pa_x[j] * tlx_xyz_xy_0[j] + 0.5 * fl1_fx * tlx_yz_xy_0[j] + 0.5 * fl1_fx * tlx_xyz_y_0[j];

            tly_xxyz_xy_0[j] = pa_x[j] * tly_xyz_xy_0[j] + 0.5 * fl1_fx * tly_yz_xy_0[j] + 0.5 * fl1_fx * tly_xyz_y_0[j] +
                               0.5 * fl1_fx * tpz_xyz_xy_0[j] + fl1_fx * fl1_fgb * tdz_xyz_xy_0[j];

            tlz_xxyz_xy_0[j] = pa_x[j] * tlz_xyz_xy_0[j] + 0.5 * fl1_fx * tlz_yz_xy_0[j] + 0.5 * fl1_fx * tlz_xyz_y_0[j] -
                               0.5 * fl1_fx * tpy_xyz_xy_0[j] - fl1_fx * fl1_fgb * tdy_xyz_xy_0[j];

            tlx_xxyz_xz_0[j] = pa_x[j] * tlx_xyz_xz_0[j] + 0.5 * fl1_fx * tlx_yz_xz_0[j] + 0.5 * fl1_fx * tlx_xyz_z_0[j];

            tly_xxyz_xz_0[j] = pa_x[j] * tly_xyz_xz_0[j] + 0.5 * fl1_fx * tly_yz_xz_0[j] + 0.5 * fl1_fx * tly_xyz_z_0[j] +
                               0.5 * fl1_fx * tpz_xyz_xz_0[j] + fl1_fx * fl1_fgb * tdz_xyz_xz_0[j];

            tlz_xxyz_xz_0[j] = pa_x[j] * tlz_xyz_xz_0[j] + 0.5 * fl1_fx * tlz_yz_xz_0[j] + 0.5 * fl1_fx * tlz_xyz_z_0[j] -
                               0.5 * fl1_fx * tpy_xyz_xz_0[j] - fl1_fx * fl1_fgb * tdy_xyz_xz_0[j];

            tlx_xxyz_yy_0[j] = pa_x[j] * tlx_xyz_yy_0[j] + 0.5 * fl1_fx * tlx_yz_yy_0[j];

            tly_xxyz_yy_0[j] =
                pa_x[j] * tly_xyz_yy_0[j] + 0.5 * fl1_fx * tly_yz_yy_0[j] + 0.5 * fl1_fx * tpz_xyz_yy_0[j] + fl1_fx * fl1_fgb * tdz_xyz_yy_0[j];

            tlz_xxyz_yy_0[j] =
                pa_x[j] * tlz_xyz_yy_0[j] + 0.5 * fl1_fx * tlz_yz_yy_0[j] - 0.5 * fl1_fx * tpy_xyz_yy_0[j] - fl1_fx * fl1_fgb * tdy_xyz_yy_0[j];

            tlx_xxyz_yz_0[j] = pa_x[j] * tlx_xyz_yz_0[j] + 0.5 * fl1_fx * tlx_yz_yz_0[j];

            tly_xxyz_yz_0[j] =
                pa_x[j] * tly_xyz_yz_0[j] + 0.5 * fl1_fx * tly_yz_yz_0[j] + 0.5 * fl1_fx * tpz_xyz_yz_0[j] + fl1_fx * fl1_fgb * tdz_xyz_yz_0[j];

            tlz_xxyz_yz_0[j] =
                pa_x[j] * tlz_xyz_yz_0[j] + 0.5 * fl1_fx * tlz_yz_yz_0[j] - 0.5 * fl1_fx * tpy_xyz_yz_0[j] - fl1_fx * fl1_fgb * tdy_xyz_yz_0[j];

            tlx_xxyz_zz_0[j] = pa_x[j] * tlx_xyz_zz_0[j] + 0.5 * fl1_fx * tlx_yz_zz_0[j];

            tly_xxyz_zz_0[j] =
                pa_x[j] * tly_xyz_zz_0[j] + 0.5 * fl1_fx * tly_yz_zz_0[j] + 0.5 * fl1_fx * tpz_xyz_zz_0[j] + fl1_fx * fl1_fgb * tdz_xyz_zz_0[j];

            tlz_xxyz_zz_0[j] =
                pa_x[j] * tlz_xyz_zz_0[j] + 0.5 * fl1_fx * tlz_yz_zz_0[j] - 0.5 * fl1_fx * tpy_xyz_zz_0[j] - fl1_fx * fl1_fgb * tdy_xyz_zz_0[j];
        }
                                ...
                                const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tly_xxzz_xx_0[j] = pa_x[j] * tly_xzz_xx_0[j] + 0.5 * fl1_fx * tly_zz_xx_0[j] + fl1_fx * tly_xzz_x_0[j] + 0.5 * fl1_fx * tpz_xzz_xx_0[j] +
                               fl1_fx * fl1_fgb * tdz_xzz_xx_0[j];

            tlz_xxzz_xx_0[j] = pa_x[j] * tlz_xzz_xx_0[j] + 0.5 * fl1_fx * tlz_zz_xx_0[j] + fl1_fx * tlz_xzz_x_0[j] - 0.5 * fl1_fx * tpy_xzz_xx_0[j] -
                               fl1_fx * fl1_fgb * tdy_xzz_xx_0[j];

            tlx_xxzz_xy_0[j] = pa_x[j] * tlx_xzz_xy_0[j] + 0.5 * fl1_fx * tlx_zz_xy_0[j] + 0.5 * fl1_fx * tlx_xzz_y_0[j];

            tly_xxzz_xy_0[j] = pa_x[j] * tly_xzz_xy_0[j] + 0.5 * fl1_fx * tly_zz_xy_0[j] + 0.5 * fl1_fx * tly_xzz_y_0[j] +
                               0.5 * fl1_fx * tpz_xzz_xy_0[j] + fl1_fx * fl1_fgb * tdz_xzz_xy_0[j];

            tlz_xxzz_xy_0[j] = pa_x[j] * tlz_xzz_xy_0[j] + 0.5 * fl1_fx * tlz_zz_xy_0[j] + 0.5 * fl1_fx * tlz_xzz_y_0[j] -
                               0.5 * fl1_fx * tpy_xzz_xy_0[j] - fl1_fx * fl1_fgb * tdy_xzz_xy_0[j];

            tlx_xxzz_xz_0[j] = pa_x[j] * tlx_xzz_xz_0[j] + 0.5 * fl1_fx * tlx_zz_xz_0[j] + 0.5 * fl1_fx * tlx_xzz_z_0[j];

            tly_xxzz_xz_0[j] = pa_x[j] * tly_xzz_xz_0[j] + 0.5 * fl1_fx * tly_zz_xz_0[j] + 0.5 * fl1_fx * tly_xzz_z_0[j] +
                               0.5 * fl1_fx * tpz_xzz_xz_0[j] + fl1_fx * fl1_fgb * tdz_xzz_xz_0[j];

            tlz_xxzz_xz_0[j] = pa_x[j] * tlz_xzz_xz_0[j] + 0.5 * fl1_fx * tlz_zz_xz_0[j] + 0.5 * fl1_fx * tlz_xzz_z_0[j] -
                               0.5 * fl1_fx * tpy_xzz_xz_0[j] - fl1_fx * fl1_fgb * tdy_xzz_xz_0[j];

            tlx_xxzz_yy_0[j] = pa_x[j] * tlx_xzz_yy_0[j] + 0.5 * fl1_fx * tlx_zz_yy_0[j];

            tly_xxzz_yy_0[j] =
                pa_x[j] * tly_xzz_yy_0[j] + 0.5 * fl1_fx * tly_zz_yy_0[j] + 0.5 * fl1_fx * tpz_xzz_yy_0[j] + fl1_fx * fl1_fgb * tdz_xzz_yy_0[j];

            tlz_xxzz_yy_0[j] =
                pa_x[j] * tlz_xzz_yy_0[j] + 0.5 * fl1_fx * tlz_zz_yy_0[j] - 0.5 * fl1_fx * tpy_xzz_yy_0[j] - fl1_fx * fl1_fgb * tdy_xzz_yy_0[j];

            tlx_xxzz_yz_0[j] = pa_x[j] * tlx_xzz_yz_0[j] + 0.5 * fl1_fx * tlx_zz_yz_0[j];

            tly_xxzz_yz_0[j] =
                pa_x[j] * tly_xzz_yz_0[j] + 0.5 * fl1_fx * tly_zz_yz_0[j] + 0.5 * fl1_fx * tpz_xzz_yz_0[j] + fl1_fx * fl1_fgb * tdz_xzz_yz_0[j];

            tlz_xxzz_yz_0[j] =
                pa_x[j] * tlz_xzz_yz_0[j] + 0.5 * fl1_fx * tlz_zz_yz_0[j] - 0.5 * fl1_fx * tpy_xzz_yz_0[j] - fl1_fx * fl1_fgb * tdy_xzz_yz_0[j];

            tlx_xxzz_zz_0[j] = pa_x[j] * tlx_xzz_zz_0[j] + 0.5 * fl1_fx * tlx_zz_zz_0[j];

            tly_xxzz_zz_0[j] =
                pa_x[j] * tly_xzz_zz_0[j] + 0.5 * fl1_fx * tly_zz_zz_0[j] + 0.5 * fl1_fx * tpz_xzz_zz_0[j] + fl1_fx * fl1_fgb * tdz_xzz_zz_0[j];

            tlz_xxzz_zz_0[j] =
                pa_x[j] * tlz_xzz_zz_0[j] + 0.5 * fl1_fx * tlz_zz_zz_0[j] - 0.5 * fl1_fx * tpy_xzz_zz_0[j] - fl1_fx * fl1_fgb * tdy_xzz_zz_0[j];

            tlx_xyyy_xx_0[j] = pa_x[j] * tlx_yyy_xx_0[j] + fl1_fx * tlx_yyy_x_0[j];

            tly_xyyy_xx_0[j] =
                pa_x[j] * tly_yyy_xx_0[j] + fl1_fx * tly_yyy_x_0[j] + 0.5 * fl1_fx * tpz_yyy_xx_0[j] + fl1_fx * fl1_fgb * tdz_yyy_xx_0[j];

            tlz_xyyy_xx_0[j] =
                pa_x[j] * tlz_yyy_xx_0[j] + fl1_fx * tlz_yyy_x_0[j] - 0.5 * fl1_fx * tpy_yyy_xx_0[j] - fl1_fx * fl1_fgb * tdy_yyy_xx_0[j];

            tlx_xyyy_xy_0[j] = pa_x[j] * tlx_yyy_xy_0[j] + 0.5 * fl1_fx * tlx_yyy_y_0[j];

            tly_xyyy_xy_0[j] =
                pa_x[j] * tly_yyy_xy_0[j] + 0.5 * fl1_fx * tly_yyy_y_0[j] + 0.5 * fl1_fx * tpz_yyy_xy_0[j] + fl1_fx * fl1_fgb * tdz_yyy_xy_0[j];

            tlz_xyyy_xy_0[j] =
                pa_x[j] * tlz_yyy_xy_0[j] + 0.5 * fl1_fx * tlz_yyy_y_0[j] - 0.5 * fl1_fx * tpy_yyy_xy_0[j] - fl1_fx * fl1_fgb * tdy_yyy_xy_0[j];

            tlx_xyyy_xz_0[j] = pa_x[j] * tlx_yyy_xz_0[j] + 0.5 * fl1_fx * tlx_yyy_z_0[j];

            tly_xyyy_xz_0[j] =
                pa_x[j] * tly_yyy_xz_0[j] + 0.5 * fl1_fx * tly_yyy_z_0[j] + 0.5 * fl1_fx * tpz_yyy_xz_0[j] + fl1_fx * fl1_fgb * tdz_yyy_xz_0[j];

            tlz_xyyy_xz_0[j] =
                pa_x[j] * tlz_yyy_xz_0[j] + 0.5 * fl1_fx * tlz_yyy_z_0[j] - 0.5 * fl1_fx * tpy_yyy_xz_0[j] - fl1_fx * fl1_fgb * tdy_yyy_xz_0[j];
            ...
            tly_xyyz_xx_0[j] =
                pa_x[j] * tly_yyz_xx_0[j] + fl1_fx * tly_yyz_x_0[j] + 0.5 * fl1_fx * tpz_yyz_xx_0[j] + fl1_fx * fl1_fgb * tdz_yyz_xx_0[j];

            tlz_xyyz_xx_0[j] =
                pa_x[j] * tlz_yyz_xx_0[j] + fl1_fx * tlz_yyz_x_0[j] - 0.5 * fl1_fx * tpy_yyz_xx_0[j] - fl1_fx * fl1_fgb * tdy_yyz_xx_0[j];

            tlx_xyyz_xy_0[j] = pa_x[j] * tlx_yyz_xy_0[j] + 0.5 * fl1_fx * tlx_yyz_y_0[j];

            tly_xyyz_xy_0[j] =
                pa_x[j] * tly_yyz_xy_0[j] + 0.5 * fl1_fx * tly_yyz_y_0[j] + 0.5 * fl1_fx * tpz_yyz_xy_0[j] + fl1_fx * fl1_fgb * tdz_yyz_xy_0[j];

            tlz_xyyz_xy_0[j] =
                pa_x[j] * tlz_yyz_xy_0[j] + 0.5 * fl1_fx * tlz_yyz_y_0[j] - 0.5 * fl1_fx * tpy_yyz_xy_0[j] - fl1_fx * fl1_fgb * tdy_yyz_xy_0[j];

            tlx_xyyz_xz_0[j] = pa_x[j] * tlx_yyz_xz_0[j] + 0.5 * fl1_fx * tlx_yyz_z_0[j];

            tly_xyyz_xz_0[j] =
                pa_x[j] * tly_yyz_xz_0[j] + 0.5 * fl1_fx * tly_yyz_z_0[j] + 0.5 * fl1_fx * tpz_yyz_xz_0[j] + fl1_fx * fl1_fgb * tdz_yyz_xz_0[j];

            tlz_xyyz_xz_0[j] =
                pa_x[j] * tlz_yyz_xz_0[j] + 0.5 * fl1_fx * tlz_yyz_z_0[j] - 0.5 * fl1_fx * tpy_yyz_xz_0[j] - fl1_fx * fl1_fgb * tdy_yyz_xz_0[j];
        }
                                 ...
                                 const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tly_xyzz_xx_0[j] =
                pa_x[j] * tly_yzz_xx_0[j] + fl1_fx * tly_yzz_x_0[j] + 0.5 * fl1_fx * tpz_yzz_xx_0[j] + fl1_fx * fl1_fgb * tdz_yzz_xx_0[j];

            tlz_xyzz_xx_0[j] =
                pa_x[j] * tlz_yzz_xx_0[j] + fl1_fx * tlz_yzz_x_0[j] - 0.5 * fl1_fx * tpy_yzz_xx_0[j] - fl1_fx * fl1_fgb * tdy_yzz_xx_0[j];

            tlx_xyzz_xy_0[j] = pa_x[j] * tlx_yzz_xy_0[j] + 0.5 * fl1_fx * tlx_yzz_y_0[j];

            tly_xyzz_xy_0[j] =
                pa_x[j] * tly_yzz_xy_0[j] + 0.5 * fl1_fx * tly_yzz_y_0[j] + 0.5 * fl1_fx * tpz_yzz_xy_0[j] + fl1_fx * fl1_fgb * tdz_yzz_xy_0[j];

            tlz_xyzz_xy_0[j] =
                pa_x[j] * tlz_yzz_xy_0[j] + 0.5 * fl1_fx * tlz_yzz_y_0[j] - 0.5 * fl1_fx * tpy_yzz_xy_0[j] - fl1_fx * fl1_fgb * tdy_yzz_xy_0[j];

            tlx_xyzz_xz_0[j] = pa_x[j] * tlx_yzz_xz_0[j] + 0.5 * fl1_fx * tlx_yzz_z_0[j];

            tly_xyzz_xz_0[j] =
                pa_x[j] * tly_yzz_xz_0[j] + 0.5 * fl1_fx * tly_yzz_z_0[j] + 0.5 * fl1_fx * tpz_yzz_xz_0[j] + fl1_fx * fl1_fgb * tdz_yzz_xz_0[j];

            tlz_xyzz_xz_0[j] =
                pa_x[j] * tlz_yzz_xz_0[j] + 0.5 * fl1_fx * tlz_yzz_z_0[j] - 0.5 * fl1_fx * tpy_yzz_xz_0[j] - fl1_fx * fl1_fgb * tdy_yzz_xz_0[j];
            ...
            tly_xzzz_xx_0[j] =
                pa_x[j] * tly_zzz_xx_0[j] + fl1_fx * tly_zzz_x_0[j] + 0.5 * fl1_fx * tpz_zzz_xx_0[j] + fl1_fx * fl1_fgb * tdz_zzz_xx_0[j];

            tlz_xzzz_xx_0[j] =
                pa_x[j] * tlz_zzz_xx_0[j] + fl1_fx * tlz_zzz_x_0[j] - 0.5 * fl1_fx * tpy_zzz_xx_0[j] - fl1_fx * fl1_fgb * tdy_zzz_xx_0[j];

            tlx_xzzz_xy_0[j] = pa_x[j] * tlx_zzz_xy_0[j] + 0.5 * fl1_fx * tlx_zzz_y_0[j];

            tly_xzzz_xy_0[j] =
                pa_x[j] * tly_zzz_xy_0[j] + 0.5 * fl1_fx * tly_zzz_y_0[j] + 0.5 * fl1_fx * tpz_zzz_xy_0[j] + fl1_fx * fl1_fgb * tdz_zzz_xy_0[j];

            tlz_xzzz_xy_0[j] =
                pa_x[j] * tlz_zzz_xy_0[j] + 0.5 * fl1_fx * tlz_zzz_y_0[j] - 0.5 * fl1_fx * tpy_zzz_xy_0[j] - fl1_fx * fl1_fgb * tdy_zzz_xy_0[j];

            tlx_xzzz_xz_0[j] = pa_x[j] * tlx_zzz_xz_0[j] + 0.5 * fl1_fx * tlx_zzz_z_0[j];

            tly_xzzz_xz_0[j] =
                pa_x[j] * tly_zzz_xz_0[j] + 0.5 * fl1_fx * tly_zzz_z_0[j] + 0.5 * fl1_fx * tpz_zzz_xz_0[j] + fl1_fx * fl1_fgb * tdz_zzz_xz_0[j];

            tlz_xzzz_xz_0[j] =
                pa_x[j] * tlz_zzz_xz_0[j] + 0.5 * fl1_fx * tlz_zzz_z_0[j] - 0.5 * fl1_fx * tpy_zzz_xz_0[j] - fl1_fx * fl1_fgb * tdy_zzz_xz_0[j];
                                 ...
                                 const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tlx_yyyy_xx_0[j] =
                pa_y[j] * tlx_yyy_xx_0[j] + 1.5 * fl1_fx * tlx_yy_xx_0[j] - 0.5 * fl1_fx * tpz_yyy_xx_0[j] - fl1_fx * fl1_fgb * tdz_yyy_xx_0[j];

            tly_yyyy_xx_0[j] = pa_y[j] * tly_yyy_xx_0[j] + 1.5 * fl1_fx * tly_yy_xx_0[j];

            tlz_yyyy_xx_0[j] =
                pa_y[j] * tlz_yyy_xx_0[j] + 1.5 * fl1_fx * tlz_yy_xx_0[j] + 0.5 * fl1_fx * tpx_yyy_xx_0[j] + fl1_fx * fl1_fgb * tdx_yyy_xx_0[j];

            tlx_yyyy_xy_0[j] = pa_y[j] * tlx_yyy_xy_0[j] + 1.5 * fl1_fx * tlx_yy_xy_0[j] + 0.5 * fl1_fx * tlx_yyy_x_0[j] -
                               0.5 * fl1_fx * tpz_yyy_xy_0[j] - fl1_fx * fl1_fgb * tdz_yyy_xy_0[j];

            tly_yyyy_xy_0[j] = pa_y[j] * tly_yyy_xy_0[j] + 1.5 * fl1_fx * tly_yy_xy_0[j] + 0.5 * fl1_fx * tly_yyy_x_0[j];

            tlz_yyyy_xy_0[j] = pa_y[j] * tlz_yyy_xy_0[j] + 1.5 * fl1_fx * tlz_yy_xy_0[j] + 0.5 * fl1_fx * tlz_yyy_x_0[j] +
                               0.5 * fl1_fx * tpx_yyy_xy_0[j] + fl1_fx * fl1_fgb * tdx_yyy_xy_0[j];

            tlx_yyyy_xz_0[j] =
                pa_y[j] * tlx_yyy_xz_0[j] + 1.5 * fl1_fx * tlx_yy_xz_0[j] - 0.5 * fl1_fx * tpz_yyy_xz_0[j] - fl1_fx * fl1_fgb * tdz_yyy_xz_0[j];

            tly_yyyy_xz_0[j] = pa_y[j] * tly_yyy_xz_0[j] + 1.5 * fl1_fx * tly_yy_xz_0[j];

            tlz_yyyy_xz_0[j] =
                pa_y[j] * tlz_yyy_xz_0[j] + 1.5 * fl1_fx * tlz_yy_xz_0[j] + 0.5 * fl1_fx * tpx_yyy_xz_0[j] + fl1_fx * fl1_fgb * tdx_yyy_xz_0[j];

            tlx_yyyy_yy_0[j] = pa_y[j] * tlx_yyy_yy_0[j] + 1.5 * fl1_fx * tlx_yy_yy_0[j] + fl1_fx * tlx_yyy_y_0[j] - 0.5 * fl1_fx * tpz_yyy_yy_0[j] -
                               fl1_fx * fl1_fgb * tdz_yyy_yy_0[j];

            tly_yyyy_yy_0[j] = pa_y[j] * tly_yyy_yy_0[j] + 1.5 * fl1_fx * tly_yy_yy_0[j] + fl1_fx * tly_yyy_y_0[j];

            tlz_yyyy_yy_0[j] = pa_y[j] * tlz_yyy_yy_0[j] + 1.5 * fl1_fx * tlz_yy_yy_0[j] + fl1_fx * tlz_yyy_y_0[j] + 0.5 * fl1_fx * tpx_yyy_yy_0[j] +
                               fl1_fx * fl1_fgb * tdx_yyy_yy_0[j];

            tlx_yyyy_yz_0[j] = pa_y[j] * tlx_yyy_yz_0[j] + 1.5 * fl1_fx * tlx_yy_yz_0[j] + 0.5 * fl1_fx * tlx_yyy_z_0[j] -
                               0.5 * fl1_fx * tpz_yyy_yz_0[j] - fl1_fx * fl1_fgb * tdz_yyy_yz_0[j];

            tly_yyyy_yz_0[j] = pa_y[j] * tly_yyy_yz_0[j] + 1.5 * fl1_fx * tly_yy_yz_0[j] + 0.5 * fl1_fx * tly_yyy_z_0[j];

            tlz_yyyy_yz_0[j] = pa_y[j] * tlz_yyy_yz_0[j] + 1.5 * fl1_fx * tlz_yy_yz_0[j] + 0.5 * fl1_fx * tlz_yyy_z_0[j] +
                               0.5 * fl1_fx * tpx_yyy_yz_0[j] + fl1_fx * fl1_fgb * tdx_yyy_yz_0[j];

            tlx_yyyy_zz_0[j] =
                pa_y[j] * tlx_yyy_zz_0[j] + 1.5 * fl1_fx * tlx_yy_zz_0[j] - 0.5 * fl1_fx * tpz_yyy_zz_0[j] - fl1_fx * fl1_fgb * tdz_yyy_zz_0[j];

            tly_yyyy_zz_0[j] = pa_y[j] * tly_yyy_zz_0[j] + 1.5 * fl1_fx * tly_yy_zz_0[j];

            tlz_yyyy_zz_0[j] =
                pa_y[j] * tlz_yyy_zz_0[j] + 1.5 * fl1_fx * tlz_yy_zz_0[j] + 0.5 * fl1_fx * tpx_yyy_zz_0[j] + fl1_fx * fl1_fgb * tdx_yyy_zz_0[j];

            tlx_yyyz_xx_0[j] =
                pa_y[j] * tlx_yyz_xx_0[j] + fl1_fx * tlx_yz_xx_0[j] - 0.5 * fl1_fx * tpz_yyz_xx_0[j] - fl1_fx * fl1_fgb * tdz_yyz_xx_0[j];

            tly_yyyz_xx_0[j] = pa_y[j] * tly_yyz_xx_0[j] + fl1_fx * tly_yz_xx_0[j];

            tlz_yyyz_xx_0[j] =
                pa_y[j] * tlz_yyz_xx_0[j] + fl1_fx * tlz_yz_xx_0[j] + 0.5 * fl1_fx * tpx_yyz_xx_0[j] + fl1_fx * fl1_fgb * tdx_yyz_xx_0[j];

            tlx_yyyz_xy_0[j] = pa_y[j] * tlx_yyz_xy_0[j] + fl1_fx * tlx_yz_xy_0[j] + 0.5 * fl1_fx * tlx_yyz_x_0[j] - 0.5 * fl1_fx * tpz_yyz_xy_0[j] -
                               fl1_fx * fl1_fgb * tdz_yyz_xy_0[j];

            tly_yyyz_xy_0[j] = pa_y[j] * tly_yyz_xy_0[j] + fl1_fx * tly_yz_xy_0[j] + 0.5 * fl1_fx * tly_yyz_x_0[j];

            tlz_yyyz_xy_0[j] = pa_y[j] * tlz_yyz_xy_0[j] + fl1_fx * tlz_yz_xy_0[j] + 0.5 * fl1_fx * tlz_yyz_x_0[j] + 0.5 * fl1_fx * tpx_yyz_xy_0[j] +
                               fl1_fx * fl1_fgb * tdx_yyz_xy_0[j];

            tlx_yyyz_xz_0[j] =
                pa_y[j] * tlx_yyz_xz_0[j] + fl1_fx * tlx_yz_xz_0[j] - 0.5 * fl1_fx * tpz_yyz_xz_0[j] - fl1_fx * fl1_fgb * tdz_yyz_xz_0[j];

            tly_yyyz_xz_0[j] = pa_y[j] * tly_yyz_xz_0[j] + fl1_fx * tly_yz_xz_0[j];

            tlz_yyyz_xz_0[j] =
                pa_y[j] * tlz_yyz_xz_0[j] + fl1_fx * tlz_yz_xz_0[j] + 0.5 * fl1_fx * tpx_yyz_xz_0[j] + fl1_fx * fl1_fgb * tdx_yyz_xz_0[j];

            tlx_yyyz_yy_0[j] = pa_y[j] * tlx_yyz_yy_0[j] + fl1_fx * tlx_yz_yy_0[j] + fl1_fx * tlx_yyz_y_0[j] - 0.5 * fl1_fx * tpz_yyz_yy_0[j] -
                               fl1_fx * fl1_fgb * tdz_yyz_yy_0[j];

            tly_yyyz_yy_0[j] = pa_y[j] * tly_yyz_yy_0[j] + fl1_fx * tly_yz_yy_0[j] + fl1_fx * tly_yyz_y_0[j];

            tlz_yyyz_yy_0[j] = pa_y[j] * tlz_yyz_yy_0[j] + fl1_fx * tlz_yz_yy_0[j] + fl1_fx * tlz_yyz_y_0[j] + 0.5 * fl1_fx * tpx_yyz_yy_0[j] +
                               fl1_fx * fl1_fgb * tdx_yyz_yy_0[j];

            tlx_yyyz_yz_0[j] = pa_y[j] * tlx_yyz_yz_0[j] + fl1_fx * tlx_yz_yz_0[j] + 0.5 * fl1_fx * tlx_yyz_z_0[j] - 0.5 * fl1_fx * tpz_yyz_yz_0[j] -
                               fl1_fx * fl1_fgb * tdz_yyz_yz_0[j];

            tly_yyyz_yz_0[j] = pa_y[j] * tly_yyz_yz_0[j] + fl1_fx * tly_yz_yz_0[j] + 0.5 * fl1_fx * tly_yyz_z_0[j];

            tlz_yyyz_yz_0[j] = pa_y[j] * tlz_yyz_yz_0[j] + fl1_fx * tlz_yz_yz_0[j] + 0.5 * fl1_fx * tlz_yyz_z_0[j] + 0.5 * fl1_fx * tpx_yyz_yz_0[j] +
                               fl1_fx * fl1_fgb * tdx_yyz_yz_0[j];

            tlx_yyyz_zz_0[j] =
                pa_y[j] * tlx_yyz_zz_0[j] + fl1_fx * tlx_yz_zz_0[j] - 0.5 * fl1_fx * tpz_yyz_zz_0[j] - fl1_fx * fl1_fgb * tdz_yyz_zz_0[j];

            tly_yyyz_zz_0[j] = pa_y[j] * tly_yyz_zz_0[j] + fl1_fx * tly_yz_zz_0[j];

            tlz_yyyz_zz_0[j] =
                pa_y[j] * tlz_yyz_zz_0[j] + fl1_fx * tlz_yz_zz_0[j] + 0.5 * fl1_fx * tpx_yyz_zz_0[j] + fl1_fx * fl1_fgb * tdx_yyz_zz_0[j];

            tlx_yyzz_xx_0[j] =
                pa_y[j] * tlx_yzz_xx_0[j] + 0.5 * fl1_fx * tlx_zz_xx_0[j] - 0.5 * fl1_fx * tpz_yzz_xx_0[j] - fl1_fx * fl1_fgb * tdz_yzz_xx_0[j];

            tly_yyzz_xx_0[j] = pa_y[j] * tly_yzz_xx_0[j] + 0.5 * fl1_fx * tly_zz_xx_0[j];

            tlz_yyzz_xx_0[j] =
                pa_y[j] * tlz_yzz_xx_0[j] + 0.5 * fl1_fx * tlz_zz_xx_0[j] + 0.5 * fl1_fx * tpx_yzz_xx_0[j] + fl1_fx * fl1_fgb * tdx_yzz_xx_0[j];

            tlx_yyzz_xy_0[j] = pa_y[j] * tlx_yzz_xy_0[j] + 0.5 * fl1_fx * tlx_zz_xy_0[j] + 0.5 * fl1_fx * tlx_yzz_x_0[j] -
                               0.5 * fl1_fx * tpz_yzz_xy_0[j] - fl1_fx * fl1_fgb * tdz_yzz_xy_0[j];

            tly_yyzz_xy_0[j] = pa_y[j] * tly_yzz_xy_0[j] + 0.5 * fl1_fx * tly_zz_xy_0[j] + 0.5 * fl1_fx * tly_yzz_x_0[j];

            tlz_yyzz_xy_0[j] = pa_y[j] * tlz_yzz_xy_0[j] + 0.5 * fl1_fx * tlz_zz_xy_0[j] + 0.5 * fl1_fx * tlz_yzz_x_0[j] +
                               0.5 * fl1_fx * tpx_yzz_xy_0[j] + fl1_fx * fl1_fgb * tdx_yzz_xy_0[j];

            tlx_yyzz_xz_0[j] =
                pa_y[j] * tlx_yzz_xz_0[j] + 0.5 * fl1_fx * tlx_zz_xz_0[j] - 0.5 * fl1_fx * tpz_yzz_xz_0[j] - fl1_fx * fl1_fgb * tdz_yzz_xz_0[j];

            tly_yyzz_xz_0[j] = pa_y[j] * tly_yzz_xz_0[j] + 0.5 * fl1_fx * tly_zz_xz_0[j];

            tlz_yyzz_xz_0[j] =
                pa_y[j] * tlz_yzz_xz_0[j] + 0.5 * fl1_fx * tlz_zz_xz_0[j] + 0.5 * fl1_fx * tpx_yzz_xz_0[j] + fl1_fx * fl1_fgb * tdx_yzz_xz_0[j];
        }
                                 ...
                                 const int32_t              iContrGto)
{
    ...
    for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
    {
        ...
        for (int32_t j = 0; j < nprim; j++)
        {
            ...
            tlx_yyzz_yy_0[j] = pa_y[j] * tlx_yzz_yy_0[j] + 0.5 * fl1_fx * tlx_zz_yy_0[j] + fl1_fx * tlx_yzz_y_0[j] - 0.5 * fl1_fx * tpz_yzz_yy_0[j] -
                               fl1_fx * fl1_fgb * tdz_yzz_yy_0[j];

            tly_yyzz_yy_0[j] = pa_y[j] * tly_yzz_yy_0[j] + 0.5 * fl1_fx * tly_zz_yy_0[j] + fl1_fx * tly_yzz_y_0[j];

            tlz_yyzz_yy_0[j] = pa_y[j] * tlz_yzz_yy_0[j] + 0.5 * fl1_fx * tlz_zz_yy_0[j] + fl1_fx * tlz_yzz_y_0[j] + 0.5 * fl1_fx * tpx_yzz_yy_0[j] +
                               fl1_fx * fl1_fgb * tdx_yzz_yy_0[j];

            tlx_yyzz_yz_0[j] = pa_y[j] * tlx_yzz_yz_0[j] + 0.5 * fl1_fx * tlx_zz_yz_0[j] + 0.5 * fl1_fx * tlx_yzz_z_0[j] -
                               0.5 * fl1_fx * tpz_yzz_yz_0[j] - fl1_fx * fl1_fgb * tdz_yzz_yz_0[j];

            tly_yyzz_yz_0[j] = pa_y[j] * tly_yzz_yz_0[j] + 0.5 * fl1_fx * tly_zz_yz_0[j] + 0.5 * fl1_fx * tly_yzz_z_0[j];

            tlz_yyzz_yz_0[j] = pa_y[j] * tlz_yzz_yz_0[j] + 0.5 * fl1_fx * tlz_zz_yz_0[j] + 0.5 * fl1_fx * tlz_yzz_z_0[j] +
                               0.5 * fl1_fx * tpx_yzz_yz_0[j] + fl1_fx * fl1_fgb * tdx_yzz_yz_0[j];

            tlx_yyzz_zz_0[j] =
                pa_y[j] * tlx_yzz_zz_0[j] + 0.5 * fl1_fx * tlx_zz_zz_0[j] - 0.5 * fl1_fx * tpz_yzz_zz_0[j] - fl1_fx * fl1_fgb * tdz_yzz_zz_0[j];

            tly_yyzz_zz_0[j] = pa_y[j] * tly_yzz_zz_0[j] + 0.5 * fl1_fx * tly_zz_zz_0[j];

            tlz_yyzz_zz_0[j] =
                pa_y[j] * tlz_yzz_zz_0[j] + 0.5 * fl1_fx * tlz_zz_zz_0[j] + 0.5 * fl1_fx * tpx_yzz_zz_0[j] + fl1_fx * fl1_fgb * tdx_yzz_zz_0[j];
            ...
            tlx_yzzz_xy_0[j] =
                pa_y[j] * tlx_zzz_xy_0[j] + 0.5 * fl1_fx * tlx_zzz_x_0[j] - 0.5 * fl1_fx * tpz_zzz_xy_0[j] - fl1_fx * fl1_fgb * tdz_zzz_xy_0[j];

            tly_yzzz_xy_0[j] = pa_y[j] * tly_zzz_xy_0[j] + 0.5 * fl1_fx * tly_zzz_x_0[j];

            tlz_yzzz_xy_0[j] =
                pa_y[j] * tlz_zzz_xy_0[j] + 0.5 * fl1_fx * tlz_zzz_x_0[j] + 0.5 * fl1_fx * tpx_zzz_xy_0[j] + fl1_fx * fl1_fgb * tdx_zzz_xy_0[j];
            ...
            tlx_yzzz_yy_0[j] =
                pa_y[j] * tlx_zzz_yy_0[j] + fl1_fx * tlx_zzz_y_0[j] - 0.5 * fl1_fx * tpz_zzz_yy_0[j] - fl1_fx * fl1_fgb * tdz_zzz_yy_0[j];

            tly_yzzz_yy_0[j] = pa_y[j] * tly_zzz_yy_0[j] + fl1_fx * tly_zzz_y_0[j];

            tlz_yzzz_yy_0[j] =
                pa_y[j] * tlz_zzz_yy_0[j] + fl1_fx * tlz_zzz_y_0[j] + 0.5 * fl1_fx * tpx_zzz_yy_0[j] + fl1_fx * fl1_fgb * tdx_zzz_yy_0[j];

            tlx_yzzz_yz_0[j] =
                pa_y[j] * tlx_zzz_yz_0[j] + 0.5 * fl1_fx * tlx_zzz_z_0[j] - 0.5 * fl1_fx * tpz_zzz_yz_0[j] - fl1_fx * fl1_fgb * tdz_zzz_yz_0[j];

            tly_yzzz_yz_0[j] = pa_y[j] * tly_zzz_yz_0[j] + 0.5 * fl1_fx * tly_zzz_z_0[j];

            tlz_yzzz_yz_0[j] =
                pa_y[j] * tlz_zzz_yz_0[j] + 0.5 * fl1_fx * tlz_zzz_z_0[j] + 0.5 * fl1_fx * tpx_zzz_yz_0[j] + fl1_fx * fl1_fgb * tdx_zzz_yz_0[j];
            ...
            tlx_zzzz_xx_0[j] =
                pa_z[j] * tlx_zzz_xx_0[j] + 1.5 * fl1_fx * tlx_zz_xx_0[j] + 0.5 * fl1_fx * tpy_zzz_xx_0[j] + fl1_fx * fl1_fgb * tdy_zzz_xx_0[j];

            tly_zzzz_xx_0[j] =
                pa_z[j] * tly_zzz_xx_0[j] + 1.5 * fl1_fx * tly_zz_xx_0[j] - 0.5 * fl1_fx * tpx_zzz_xx_0[j] - fl1_fx * fl1_fgb * tdx_zzz_xx_0[j];

            tlz_zzzz_xx_0[j] = pa_z[j] * tlz_zzz_xx_0[j] + 1.5 * fl1_fx * tlz_zz_xx_0[j];

            tlx_zzzz_xy_0[j] =
                pa_z[j] * tlx_zzz_xy_0[j] + 1.5 * fl1_fx * tlx_zz_xy_0[j] + 0.5 * fl1_fx * tpy_zzz_xy_0[j] + fl1_fx * fl1_fgb * tdy_zzz_xy_0[j];

            tly_zzzz_xy_0[j] =
                pa_z[j] * tly_zzz_xy_0[j] + 1.5 * fl1_fx * tly_zz_xy_0[j] - 0.5 * fl1_fx * tpx_zzz_xy_0[j] - fl1_fx * fl1_fgb * tdx_zzz_xy_0[j];

            tlz_zzzz_xy_0[j] = pa_z[j] * tlz_zzz_xy_0[j] + 1.5 * fl1_fx * tlz_zz_xy_0[j];

            tlx_zzzz_xz_0[j] = pa_z[j] * tlx_zzz_xz_0[j] + 1.5 * fl1_fx * tlx_zz_xz_0[j] + 0.5 * fl1_fx * tlx_zzz_x_0[j] +
                               0.5 * fl1_fx * tpy_zzz_xz_0[j] + fl1_fx * fl1_fgb * tdy_zzz_xz_0[j];

            tly_zzzz_xz_0[j] = pa_z[j] * tly_zzz_xz_0[j] + 1.5 * fl1_fx * tly_zz_xz_0[j] + 0.5 * fl1_fx * tly_zzz_x_0[j] -
                               0.5 * fl1_fx * tpx_zzz_xz_0[j] - fl1_fx * fl1_fgb * tdx_zzz_xz_0[j];

            tlz_zzzz_xz_0[j] = pa_z[j] * tlz_zzz_xz_0[j] + 1.5 * fl1_fx * tlz_zz_xz_0[j] + 0.5 * fl1_fx * tlz_zzz_x_0[j];

            tlx_zzzz_yy_0[j] =
                pa_z[j] * tlx_zzz_yy_0[j] + 1.5 * fl1_fx * tlx_zz_yy_0[j] + 0.5 * fl1_fx * tpy_zzz_yy_0[j] + fl1_fx * fl1_fgb * tdy_zzz_yy_0[j];

            tly_zzzz_yy_0[j] =
                pa_z[j] * tly_zzz_yy_0[j] + 1.5 * fl1_fx * tly_zz_yy_0[j] - 0.5 * fl1_fx * tpx_zzz_yy_0[j] - fl1_fx * fl1_fgb * tdx_zzz_yy_0[j];

            tlz_zzzz_yy_0[j] = pa_z[j] * tlz_zzz_yy_0[j] + 1.5 * fl1_fx * tlz_zz_yy_0[j];

            tlx_zzzz_yz_0[j] = pa_z[j] * tlx_zzz_yz_0[j] + 1.5 * fl1_fx * tlx_zz_yz_0[j] + 0.5 * fl1_fx * tlx_zzz_y_0[j] +
                               0.5 * fl1_fx * tpy_zzz_yz_0[j] + fl1_fx * fl1_fgb * tdy_zzz_yz_0[j];

            tly_zzzz_yz_0[j] = pa_z[j] * tly_zzz_yz_0[j] + 1.5 * fl1_fx * tly_zz_yz_0[j] + 0.5 * fl1_fx * tly_zzz_y_0[j] -
                               0.5 * fl1_fx * tpx_zzz_yz_0[j] - fl1_fx * fl1_fgb * tdx_zzz_yz_0[j];

            tlz_zzzz_yz_0[j] = pa_z[j] * tlz_zzz_yz_0[j] + 1.5 * fl1_fx * tlz_zz_yz_0[j] + 0.5 * fl1_fx * tlz_zzz_y_0[j];

            tlx_zzzz_zz_0[j] = pa_z[j] * tlx_zzz_zz_0[j] + 1.5 * fl1_fx * tlx_zz_zz_0[j] + fl1_fx * tlx_zzz_z_0[j] + 0.5 * fl1_fx * tpy_zzz_zz_0[j] +
                               fl1_fx * fl1_fgb * tdy_zzz_zz_0[j];

            tly_zzzz_zz_0[j] = pa_z[j] * tly_zzz_zz_0[j] + 1.5 * fl1_fx * tly_zz_zz_0[j] + fl1_fx * tly_zzz_z_0[j] - 0.5 * fl1_fx * tpx_zzz_zz_0[j] -
                               fl1_fx * fl1_fgb * tdx_zzz_zz_0[j];
