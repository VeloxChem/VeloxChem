    ...
    PyClass<CXtbDriver>(m, "_XtbDriver")
        ...
        .def(
            ...
            [](const CXtbDriver& self) -> py::array_t<double> {
                ...
                return vlx_general::pointer_to_numpy(grad.data(), {static_cast<int>(grad.size()) / 3, 3});
            },
        ...
        .def(
            ...
            [](const CXtbDriver& self) -> py::array_t<double> {
                ...
                return vlx_general::pointer_to_numpy(dipole.data(), {static_cast<int>(dipole.size())});
            },
        ...
        .def(
            ...
            [](const CXtbDriver& self) -> py::array_t<double> {
                ...
                return vlx_general::pointer_to_numpy(partial_charges.data(), {static_cast<int>(partial_charges.size())});
            },
