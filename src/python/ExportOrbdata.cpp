...
export_orbdata(py::module &m)
{
    ...
    m.def("make_gto_blocks",
          ...
          "molecule.");
    m.def("make_gto_blocks",
          py::overload_cast<const CMolecularBasis &, const CMolecule &, const std::vector<int> &>(
              &gtofunc::make_gto_blocks),
    ...
    PyClass<CBasisFunction>(m, "BasisFunction")
        ...
        .def(py::pickle(
            [](const CBasisFunction &bf) {
                return py::make_tuple(bf.get_exponents(), bf.get_normalization_factors(), bf.get_angular_momentum());
            },
            [](py::tuple t) {
                return CBasisFunction(
                    t[0].cast<std::vector<double>>(), t[1].cast<std::vector<double>>(), t[2].cast<int>());
            }))
        ...
        .def("get_normalization_factors",
             &CBasisFunction::get_normalization_factors,
        ...
        .def("number_of_primitives",
             &CBasisFunction::number_of_primitive_functions,
    ...
    PyClass<CAtomBasis>(m, "AtomBasis")
        ...
        .def(py::pickle(
            [](const CAtomBasis &abas) {
                return py::make_tuple(
                    abas.basis_functions(), abas.get_name(), abas.get_ecp_label(), abas.get_identifier());
            },
            [](py::tuple t) {
        ...
        .def("reduce_to_valence_basis",
             &CAtomBasis::reduce_to_valence_basis,
    ...
    PyClass<CMolecularBasis>(m, "MolecularBasis")
        ...
        .def(py::pickle(
            [](const CMolecularBasis &mbas) { return py::make_tuple(mbas.basis_sets(), mbas.basis_sets_indices()); },
            [](py::tuple t) {
                return CMolecularBasis(t[0].cast<std::vector<CAtomBasis>>(), t[1].cast<std::vector<int>>());
            }))
        ...
        .def("reduce_to_valence_basis",
             &CMolecularBasis::reduce_to_valence_basis,
        ...
        .def("max_angular_momentum",
             ...
             "specific atoms.")
        .def("basis_functions",
             py::overload_cast<>(&CMolecularBasis::basis_functions, py::const_),
        ...
        .def("basis_functions",
             py::overload_cast<const std::vector<int> &, const int, const size_t>(&CMolecularBasis::basis_functions,
                                                                                  py::const_),
             "Gets vector of GTOs with specific angular momentum and number of "
        ...
        .def("atomic_indices",
             py::overload_cast<const std::vector<int> &, const int, const size_t>(&CMolecularBasis::atomic_indices,
                                                                                  py::const_),
             "Gets vector of atomic indices for GTOs with specific angular "
        ...
        .def("number_of_basis_functions",
             py::overload_cast<const std::vector<int> &, const int>(&CMolecularBasis::number_of_basis_functions,
                                                                    py::const_),
             "Gets number of GTOs with specific angular momentum from molecular "
             "basis for list of specific atoms.")
        .def("number_of_basis_functions",
             py::overload_cast<const std::vector<int> &, const int, const size_t>(
                 &CMolecularBasis::number_of_basis_functions, py::const_),
             "Gets number of GTOs with specific angular momentum and number of "
             "primitive GTOs from molecular basis for list of specific atoms.")
        .def("number_of_primitive_basis_functions",
             ...
             "molecular basis.")
        .def("number_of_primitive_basis_functions",
             py::overload_cast<const std::vector<int> &, const int>(&CMolecularBasis::number_of_primitive_functions,
                                                                    py::const_),
             "Gets number of primitive GTOs with specific angular momentum from "
        ...
        .def("get_index_map",
             ...
             "momentum and number of primitive GTOs from molecular basis.")
        .def("get_index_map",
             py::overload_cast<const std::vector<int> &, const int, const size_t>(&CMolecularBasis::index_map,
                                                                                  py::const_),
             "Gets compressed global index map for basis sets of specific "
             "angular "
             "momentum and number of primitive GTOs from molecular basis for "
        ...
        .def(
            "get_main_basis_label", &CMolecularBasis::main_basis_label, "Gets main basis set label in molecular basis.")
    ...
    PyClass<CGtoBlock>(m, "GtoBlock")
        ...
        .def("normalization_factors",
             &CGtoBlock::normalization_factors,
        ...
        .def("number_of_primitives",
             &CGtoBlock::number_of_primitives,
             "Gets number of primitive GTOs in basis function.")
        .def("number_of_basis_functions",
             &CGtoBlock::number_of_basis_functions,
