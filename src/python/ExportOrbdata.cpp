...
export_orbdata(py::module& m)
{
    ...
    m.def("make_gto_blocks",
          py::overload_cast<const CMolecularBasis&,
                            const CMolecule&>(&gtofunc::makeGtoBlocks),
          "Creates vector of GtoBlocks for given basis and molecule.");
    m.def("make_gto_blocks",
          py::overload_cast<const CMolecularBasis&, const CMolecule&,
                            const std::vector<int64_t>&>(&gtofunc::makeGtoBlocks),
    ...
    PyClass<CBasisFunction>(m, "BasisFunction")
        ...
        .def("normalize",
             ...
             "Normalizes primitive GTOs in basis function.")
        .def("normalize",
             &CBasisFunction::normalize,
             "Normalizes primitive GTOs in basis function.")
        .def("get_exponents",
    ...
    PyClass<CAtomBasis>(m, "AtomBasis")
        ...
        .def(py::init<const std::vector<CBasisFunction>&,
                      const int64_t,
                      const std::string&,
                      const std::string&>())
        .def(py::pickle(
        ...
        .def("get_basis_functions",
             py::overload_cast<const int64_t,
                               const int64_t>(&CAtomBasis::getBasisFunctions, py::const_),
        ...
        .def("number_of_basis_functions",
             py::overload_cast<const int64_t,
                               const int64_t>(&CAtomBasis::getNumberOfBasisFunctions, py::const_),
        ...
        .def("primitives_str",
             ...
             "Gets primitive GTOs string of atom basis.");
    ...
    PyClass<CMolecularBasis>(m, "MolecularBasis")
        ...
        .def(py::init<const std::vector<CAtomBasis>&,
        ...
        .def("get_basis_functions",
             ...
             "Gets vector of GTOs from molecular basis.")
        .def("get_basis_functions",
        ...
        .def("get_basis_functions",
             py::overload_cast<const int64_t,
                               const int64_t>(&CMolecularBasis::getBasisFunctions, py::const_),
        ...
        .def("get_atomic_indexes",
             py::overload_cast<const int64_t,
                               const int64_t>(&CMolecularBasis::getAtomicIndexes, py::const_),
        ...
        .def("get_atomic_indexes",
             py::overload_cast<const std::vector<int64_t>&,
                               const int64_t,
                               const int64_t>(&CMolecularBasis::getAtomicIndexes, py::const_),
             "Gets vector of atomic indexes for GTOs with specific angular momentum and number of primitive GTOs from molecular basis for list of specific atoms.")
        .def("number_of_basis_functions",
        ...
        .def("number_of_basis_functions",
             py::overload_cast<const int64_t,
                               const int64_t>(&CMolecularBasis::getNumberOfBasisFunctions, py::const_),
        ...
        .def("number_of_primitive_basis_functions",
             py::overload_cast<const std::vector<int64_t>&,
                               const int64_t>(&CMolecularBasis::getNumberOfPrimitiveFunctions, py::const_),
        ...
        .def("contraction_depths",
             py::overload_cast<const std::vector<int64_t>&,
                               const int64_t>(&CMolecularBasis::getContractionDepths, py::const_),
        ...
        .def("get_index_map",
             py::overload_cast<const int64_t,
                               const int64_t>(&CMolecularBasis::getIndexMap, py::const_),
        ...
        .def("get_index_map",
             py::overload_cast<const std::vector<int64_t>&,
                               const int64_t,
                               const int64_t>(&CMolecularBasis::getIndexMap, py::const_),
             "Gets compressed global index map for basis sets of specific angular momentum and number of primitive GTOs from molecular basis for list of specific atoms.")
        .def("info_str",
    ...
    PyClass<CGtoBlock>(m, "GtoBlock")
        ...
        .def(py::init<const CMolecularBasis&,
                      ...
                      const int64_t>())
        .def("get_coordinates",
             &CGtoBlock::getCoordinates,
             "Gets vector of basis function coordinates.")
        .def("get_exponents",
             &CGtoBlock::getExponents,
             "Gets vector of basis function exponents.")
        .def("get_normalization_factors",
             &CGtoBlock::getNormalizationFactors,
             "Gets vector of basis function normalization factors.")
        .def("get_orbital_indexes",
             &CGtoBlock::getOrbitalIndexes,
             "Gets vector of orbital indexes of GTOs.")
        .def("get_atomic_indexes",
             &CGtoBlock::getAtomicIndexes,
             "Gets vector of atomic indexes of GTOs.")
        .def("get_angular_momentum",
             &CGtoBlock::getAngularMomentum,
             "Gets angular momentum of GTOs block.")
        .def("number_of_primitives",
             &CGtoBlock::getNumberOfPrimitives,
             "Gets number of primitive GTOs in basis function.")
        .def("number_of_basis_functions",
             &CGtoBlock::getNumberOfBasisFunctions,
             "Gets number of GTOs in basis function block.");
