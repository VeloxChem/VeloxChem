#ifndef ThreeCenterR2SumRecDP_hpp
#define ThreeCenterR2SumRecDP_hpp
...
/// @brief Computes (D|GR2(r)|P)  integrals for pair of basis functions blocks.
...
#endif /* ThreeCenterR2SumRecDP_hpp */
