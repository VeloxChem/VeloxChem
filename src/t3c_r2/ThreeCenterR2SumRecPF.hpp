#ifndef ThreeCenterR2SumRecPF_hpp
#define ThreeCenterR2SumRecPF_hpp
...
/// @brief Computes (P|GR2(r)|F)  integrals for pair of basis functions blocks.
               ...
               const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(108, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3r2rec::comp_prim_r2_pf(pbuffer, 78, 5, 11, 21, 30, 48, factors, 20, a_exp, exgtos[l]);

                    t2cfunc::reduce(cbuffer, pbuffer, 78, ket_width, ket_npgtos);
                }
            }
...
#endif /* ThreeCenterR2SumRecPF_hpp */
