#ifndef ThreeCenterR2PrimRecSG
#define ThreeCenterR2PrimRecSG

#include "SimdArray.hpp"

namespace t3r2rec { // t3r2rec namespace

/// @brief Computes primitive [S|GR2(r)|G]  integrals for set of data buffers.
