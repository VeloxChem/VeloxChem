#ifndef ThreeCenterR2PrimRecFF
#define ThreeCenterR2PrimRecFF

#include "SimdArray.hpp"

namespace t3r2rec { // t3r2rec namespace

/// @brief Computes primitive [F|GR2(r)|F]  integrals for set of data buffers.
