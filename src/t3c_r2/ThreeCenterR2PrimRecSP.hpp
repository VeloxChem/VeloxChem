#ifndef ThreeCenterR2PrimRecSP
#define ThreeCenterR2PrimRecSP

#include "SimdArray.hpp"

namespace t3r2rec { // t3r2rec namespace

/// @brief Computes primitive [S|GR2(r)|P]  integrals for set of data buffers.
