#ifndef ThreeCenterR2SumRecFG_hpp
#define ThreeCenterR2SumRecFG_hpp
...
/// @brief Computes (F|GR2(r)|G)  integrals for pair of basis functions blocks.
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3r2rec::comp_prim_r2_fg(pbuffer, 655, 96, 195, 255, 345, 405, 505, factors, 20, a_exp, exgtos[l]);

                    t2cfunc::reduce(cbuffer, pbuffer, 655, ket_width, ket_npgtos);
                }
            }
...
#endif /* ThreeCenterR2SumRecFG_hpp */
