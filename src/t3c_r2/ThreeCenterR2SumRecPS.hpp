#ifndef ThreeCenterR2SumRecPS_hpp
#define ThreeCenterR2SumRecPS_hpp
...
/// @brief Computes (P|GR2(r)|S)  integrals for pair of basis functions blocks.
...
#endif /* ThreeCenterR2SumRecPS_hpp */
