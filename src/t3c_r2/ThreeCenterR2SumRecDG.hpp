#ifndef ThreeCenterR2SumRecDG_hpp
#define ThreeCenterR2SumRecDG_hpp
...
/// @brief Computes (D|GR2(r)|G)  integrals for pair of basis functions blocks.
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3r2rec::comp_prim_r2_dg(pbuffer, 324, 21, 63, 93, 138, 174, 234, factors, 20, a_exp, exgtos[l]);
...
#endif /* ThreeCenterR2SumRecDG_hpp */
