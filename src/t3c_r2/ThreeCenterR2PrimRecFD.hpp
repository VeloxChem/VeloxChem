#ifndef ThreeCenterR2PrimRecFD
#define ThreeCenterR2PrimRecFD

#include "SimdArray.hpp"

namespace t3r2rec { // t3r2rec namespace

/// @brief Computes primitive [F|GR2(r)|D]  integrals for set of data buffers.
