#ifndef ThreeCenterR2SumRecSS_hpp
#define ThreeCenterR2SumRecSS_hpp
...
/// @brief Computes (S|GR2(r)|S)  integrals for pair of basis functions blocks.
               ...
               const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(3, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3r2rec::comp_prim_r2_ss(pbuffer, 2, 1, factors, 14, a_exp, exgtos[l]);
...
#endif /* ThreeCenterR2SumRecSS_hpp */
