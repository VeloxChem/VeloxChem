#ifndef ThreeCenterR2SumRecDF_hpp
#define ThreeCenterR2SumRecDF_hpp
...
/// @brief Computes (D|GR2(r)|F)  integrals for pair of basis functions blocks.
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3r2rec::comp_prim_r2_df(pbuffer, 195, 11, 33, 51, 81, 99, 135, factors, 20, a_exp, exgtos[l]);

                    t2cfunc::reduce(cbuffer, pbuffer, 195, ket_width, ket_npgtos);
                }
            }
...
#endif /* ThreeCenterR2SumRecDF_hpp */
