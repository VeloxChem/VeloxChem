#ifndef ThreeCenterR2SumRecDD_hpp
#define ThreeCenterR2SumRecDD_hpp
...
/// @brief Computes (D|GR2(r)|D)  integrals for pair of basis functions blocks.
...
#endif /* ThreeCenterR2SumRecDD_hpp */
