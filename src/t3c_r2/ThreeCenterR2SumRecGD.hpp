#ifndef ThreeCenterR2SumRecGD_hpp
#define ThreeCenterR2SumRecGD_hpp
...
/// @brief Computes (G|GR2(r)|D)  integrals for pair of basis functions blocks.
               ...
               const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(441, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3ovlrec::comp_prim_overlap_gp(pbuffer, 216, 47, 101, 111, factors, 11, a_exp, exgtos[l]);

                    t3ovlrec::comp_prim_overlap_gd(pbuffer, 261, 65, 111, 141, factors, 11, a_exp, exgtos[l]);

                    t3r2rec::comp_prim_r2_gd(pbuffer, 351, 65, 111, 141, 201, 216, 261, factors, 20, a_exp, exgtos[l]);

                    t2cfunc::reduce(cbuffer, pbuffer, 351, ket_width, ket_npgtos);
                }
            }
...
#endif /* ThreeCenterR2SumRecGD_hpp */
