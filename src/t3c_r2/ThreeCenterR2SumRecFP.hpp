#ifndef ThreeCenterR2SumRecFP_hpp
#define ThreeCenterR2SumRecFP_hpp
...
/// @brief Computes (F|GR2(r)|P)  integrals for pair of basis functions blocks.
               ...
               const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(111, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3r2rec::comp_prim_r2_fp(pbuffer, 81, 8, 17, 23, 41, 51, factors, 20, a_exp, exgtos[l]);
...
#endif /* ThreeCenterR2SumRecFP_hpp */
