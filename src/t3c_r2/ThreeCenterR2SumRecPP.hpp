#ifndef ThreeCenterR2SumRecPP_hpp
#define ThreeCenterR2SumRecPP_hpp
...
/// @brief Computes (P|GR2(r)|P)  integrals for pair of basis functions blocks.
...
#endif /* ThreeCenterR2SumRecPP_hpp */
