#include "ThreeCenterR2PrimRecSP.hpp"

namespace t3r2rec { // t3r2rec namespace

auto
comp_prim_r2_sp(CSimdArray<double>& pbuffer, 
                ...
                const double c_exp) -> void
{
    ...
    #pragma omp simd aligned(gc_x, gc_y, gc_z, gr_0_x, gr_0_y, gr_0_z, ts_0_0, ts_0_x, ts_0_y, ts_0_z, b_exps : 64)
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        gr_0_x[i] = 2.0 * ts_0_0[i] * gfe_0 * gc_x[i] + 3.0 * ts_0_x[i] * gfe_0 + ts_0_x[i] * rgc2_0;

        gr_0_y[i] = 2.0 * ts_0_0[i] * gfe_0 * gc_y[i] + 3.0 * ts_0_y[i] * gfe_0 + ts_0_y[i] * rgc2_0;

        gr_0_z[i] = 2.0 * ts_0_0[i] * gfe_0 * gc_z[i] + 3.0 * ts_0_z[i] * gfe_0 + ts_0_z[i] * rgc2_0;
    }
}
