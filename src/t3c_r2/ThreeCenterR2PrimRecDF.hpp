#ifndef ThreeCenterR2PrimRecDF
#define ThreeCenterR2PrimRecDF

#include "SimdArray.hpp"

namespace t3r2rec { // t3r2rec namespace

/// @brief Computes primitive [D|GR2(r)|F]  integrals for set of data buffers.
