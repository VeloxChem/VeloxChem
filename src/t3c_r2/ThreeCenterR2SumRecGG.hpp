#ifndef ThreeCenterR2SumRecGG_hpp
#define ThreeCenterR2SumRecGG_hpp
...
/// @brief Computes (G|GR2(r)|G)  integrals for pair of basis functions blocks.
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3ovlrec::comp_prim_overlap_gd(pbuffer, 691, 165, 351, 381, factors, 11, a_exp, exgtos[l]);

                    t3ovlrec::comp_prim_overlap_gf(pbuffer, 781, 201, 381, 441, factors, 11, a_exp, exgtos[l]);

                    t3ovlrec::comp_prim_overlap_gg(pbuffer, 931, 261, 441, 541, factors, 11, a_exp, exgtos[l]);

                    t3r2rec::comp_prim_r2_gg(pbuffer, 1156, 261, 441, 541, 691, 781, 931, factors, 20, a_exp, exgtos[l]);

                    t2cfunc::reduce(cbuffer, pbuffer, 1156, ket_width, ket_npgtos);
                }
            }
...
#endif /* ThreeCenterR2SumRecGG_hpp */
