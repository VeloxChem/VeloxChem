#ifndef ThreeCenterR2SumRecPG_hpp
#define ThreeCenterR2SumRecPG_hpp
...
/// @brief Computes (P|GR2(r)|G)  integrals for pair of basis functions blocks.
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3r2rec::comp_prim_r2_pg(pbuffer, 129, 11, 21, 36, 54, 84, factors, 20, a_exp, exgtos[l]);
...
#endif /* ThreeCenterR2SumRecPG_hpp */
