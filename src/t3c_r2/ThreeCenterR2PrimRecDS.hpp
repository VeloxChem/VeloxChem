#ifndef ThreeCenterR2PrimRecDS
#define ThreeCenterR2PrimRecDS

#include "SimdArray.hpp"

namespace t3r2rec { // t3r2rec namespace

/// @brief Computes primitive [D|GR2(r)|S]  integrals for set of data buffers.
