#ifndef ThreeCenterR2PrimRecGP
#define ThreeCenterR2PrimRecGP

#include "SimdArray.hpp"

namespace t3r2rec { // t3r2rec namespace

/// @brief Computes primitive [G|GR2(r)|P]  integrals for set of data buffers.
