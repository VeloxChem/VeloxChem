#ifndef ThreeCenterR2PrimRecPP
#define ThreeCenterR2PrimRecPP

#include "SimdArray.hpp"

namespace t3r2rec { // t3r2rec namespace

/// @brief Computes primitive [P|GR2(r)|P]  integrals for set of data buffers.
