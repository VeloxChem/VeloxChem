#ifndef ThreeCenterR2SumRecFD_hpp
#define ThreeCenterR2SumRecFD_hpp
...
/// @brief Computes (F|GR2(r)|D)  integrals for pair of basis functions blocks.
...
#endif /* ThreeCenterR2SumRecFD_hpp */
