                ...
                const double c_exp) -> void
{
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        gr_xxxx_xxxx[i] = 12.0 * ts_xx_xxxx[i] * gfe_0 + 32.0 * ts_xxx_xxx[i] * gfe_0 + 8.0 * ts_xxx_xxxx[i] * gfe_0 * gc_x[i] + 12.0 * ts_xxxx_xx[i] * gfe_0 + 8.0 * ts_xxxx_xxx[i] * gfe_0 * gc_x[i] + 3.0 * ts_xxxx_xxxx[i] * gfe_0 + ts_xxxx_xxxx[i] * rgc2_0;

        gr_xxxx_xxxy[i] = 12.0 * ts_xx_xxxy[i] * gfe_0 + 24.0 * ts_xxx_xxy[i] * gfe_0 + 8.0 * ts_xxx_xxxy[i] * gfe_0 * gc_x[i] + 6.0 * ts_xxxx_xy[i] * gfe_0 + 6.0 * ts_xxxx_xxy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxx_xxx[i] * gfe_0 * gc_y[i] + 3.0 * ts_xxxx_xxxy[i] * gfe_0 + ts_xxxx_xxxy[i] * rgc2_0;

        gr_xxxx_xxxz[i] = 12.0 * ts_xx_xxxz[i] * gfe_0 + 24.0 * ts_xxx_xxz[i] * gfe_0 + 8.0 * ts_xxx_xxxz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xxxx_xz[i] * gfe_0 + 6.0 * ts_xxxx_xxz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxx_xxx[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxx_xxxz[i] * gfe_0 + ts_xxxx_xxxz[i] * rgc2_0;

        gr_xxxx_xxyy[i] = 12.0 * ts_xx_xxyy[i] * gfe_0 + 16.0 * ts_xxx_xyy[i] * gfe_0 + 8.0 * ts_xxx_xxyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxx_yy[i] * gfe_0 + 4.0 * ts_xxxx_xyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxx_xx[i] * gfe_0 + 4.0 * ts_xxxx_xxy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xxxx_xxyy[i] * gfe_0 + ts_xxxx_xxyy[i] * rgc2_0;

        gr_xxxx_xxyz[i] = 12.0 * ts_xx_xxyz[i] * gfe_0 + 16.0 * ts_xxx_xyz[i] * gfe_0 + 8.0 * ts_xxx_xxyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxx_yz[i] * gfe_0 + 4.0 * ts_xxxx_xyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxx_xxz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxxx_xxy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxx_xxyz[i] * gfe_0 + ts_xxxx_xxyz[i] * rgc2_0;

        gr_xxxx_xxzz[i] = 12.0 * ts_xx_xxzz[i] * gfe_0 + 16.0 * ts_xxx_xzz[i] * gfe_0 + 8.0 * ts_xxx_xxzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxx_zz[i] * gfe_0 + 4.0 * ts_xxxx_xzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxx_xx[i] * gfe_0 + 4.0 * ts_xxxx_xxz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxx_xxzz[i] * gfe_0 + ts_xxxx_xxzz[i] * rgc2_0;

        gr_xxxx_xyyy[i] = 12.0 * ts_xx_xyyy[i] * gfe_0 + 8.0 * ts_xxx_yyy[i] * gfe_0 + 8.0 * ts_xxx_xyyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxx_yyy[i] * gfe_0 * gc_x[i] + 6.0 * ts_xxxx_xy[i] * gfe_0 + 6.0 * ts_xxxx_xyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xxxx_xyyy[i] * gfe_0 + ts_xxxx_xyyy[i] * rgc2_0;

        gr_xxxx_xyyz[i] = 12.0 * ts_xx_xyyz[i] * gfe_0 + 8.0 * ts_xxx_yyz[i] * gfe_0 + 8.0 * ts_xxx_xyyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxx_yyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxx_xz[i] * gfe_0 + 4.0 * ts_xxxx_xyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxxx_xyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxx_xyyz[i] * gfe_0 + ts_xxxx_xyyz[i] * rgc2_0;

        gr_xxxx_xyzz[i] = 12.0 * ts_xx_xyzz[i] * gfe_0 + 8.0 * ts_xxx_yzz[i] * gfe_0 + 8.0 * ts_xxx_xyzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxx_yzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxx_xzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxxx_xy[i] * gfe_0 + 4.0 * ts_xxxx_xyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxx_xyzz[i] * gfe_0 + ts_xxxx_xyzz[i] * rgc2_0;

        gr_xxxx_xzzz[i] = 12.0 * ts_xx_xzzz[i] * gfe_0 + 8.0 * ts_xxx_zzz[i] * gfe_0 + 8.0 * ts_xxx_xzzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxx_zzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xxxx_xz[i] * gfe_0 + 6.0 * ts_xxxx_xzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxx_xzzz[i] * gfe_0 + ts_xxxx_xzzz[i] * rgc2_0;

        gr_xxxx_yyyy[i] = 12.0 * ts_xx_yyyy[i] * gfe_0 + 8.0 * ts_xxx_yyyy[i] * gfe_0 * gc_x[i] + 12.0 * ts_xxxx_yy[i] * gfe_0 + 8.0 * ts_xxxx_yyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xxxx_yyyy[i] * gfe_0 + ts_xxxx_yyyy[i] * rgc2_0;

        gr_xxxx_yyyz[i] = 12.0 * ts_xx_yyyz[i] * gfe_0 + 8.0 * ts_xxx_yyyz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xxxx_yz[i] * gfe_0 + 6.0 * ts_xxxx_yyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxxx_yyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxx_yyyz[i] * gfe_0 + ts_xxxx_yyyz[i] * rgc2_0;

        gr_xxxx_yyzz[i] = 12.0 * ts_xx_yyzz[i] * gfe_0 + 8.0 * ts_xxx_yyzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxx_zz[i] * gfe_0 + 4.0 * ts_xxxx_yzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxxx_yy[i] * gfe_0 + 4.0 * ts_xxxx_yyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxx_yyzz[i] * gfe_0 + ts_xxxx_yyzz[i] * rgc2_0;

        gr_xxxx_yzzz[i] = 12.0 * ts_xx_yzzz[i] * gfe_0 + 8.0 * ts_xxx_yzzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxx_zzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_xxxx_yz[i] * gfe_0 + 6.0 * ts_xxxx_yzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxx_yzzz[i] * gfe_0 + ts_xxxx_yzzz[i] * rgc2_0;

        gr_xxxx_zzzz[i] = 12.0 * ts_xx_zzzz[i] * gfe_0 + 8.0 * ts_xxx_zzzz[i] * gfe_0 * gc_x[i] + 12.0 * ts_xxxx_zz[i] * gfe_0 + 8.0 * ts_xxxx_zzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxx_zzzz[i] * gfe_0 + ts_xxxx_zzzz[i] * rgc2_0;
    }
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        gr_xxxy_xxxx[i] = 6.0 * ts_xy_xxxx[i] * gfe_0 + 24.0 * ts_xxy_xxx[i] * gfe_0 + 6.0 * ts_xxy_xxxx[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxx_xxxx[i] * gfe_0 * gc_y[i] + 12.0 * ts_xxxy_xx[i] * gfe_0 + 8.0 * ts_xxxy_xxx[i] * gfe_0 * gc_x[i] + 3.0 * ts_xxxy_xxxx[i] * gfe_0 + ts_xxxy_xxxx[i] * rgc2_0;

        gr_xxxy_xxxy[i] = 6.0 * ts_xy_xxxy[i] * gfe_0 + 18.0 * ts_xxy_xxy[i] * gfe_0 + 6.0 * ts_xxy_xxxy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxx_xxx[i] * gfe_0 + 2.0 * ts_xxx_xxxy[i] * gfe_0 * gc_y[i] + 6.0 * ts_xxxy_xy[i] * gfe_0 + 6.0 * ts_xxxy_xxy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxy_xxx[i] * gfe_0 * gc_y[i] + 3.0 * ts_xxxy_xxxy[i] * gfe_0 + ts_xxxy_xxxy[i] * rgc2_0;

        gr_xxxy_xxxz[i] = 6.0 * ts_xy_xxxz[i] * gfe_0 + 18.0 * ts_xxy_xxz[i] * gfe_0 + 6.0 * ts_xxy_xxxz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxx_xxxz[i] * gfe_0 * gc_y[i] + 6.0 * ts_xxxy_xz[i] * gfe_0 + 6.0 * ts_xxxy_xxz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxy_xxx[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxy_xxxz[i] * gfe_0 + ts_xxxy_xxxz[i] * rgc2_0;

        gr_xxxy_xxyy[i] = 6.0 * ts_xy_xxyy[i] * gfe_0 + 12.0 * ts_xxy_xyy[i] * gfe_0 + 6.0 * ts_xxy_xxyy[i] * gfe_0 * gc_x[i] + 4.0 * ts_xxx_xxy[i] * gfe_0 + 2.0 * ts_xxx_xxyy[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxxy_yy[i] * gfe_0 + 4.0 * ts_xxxy_xyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxy_xx[i] * gfe_0 + 4.0 * ts_xxxy_xxy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xxxy_xxyy[i] * gfe_0 + ts_xxxy_xxyy[i] * rgc2_0;

        gr_xxxy_xxyz[i] = 6.0 * ts_xy_xxyz[i] * gfe_0 + 12.0 * ts_xxy_xyz[i] * gfe_0 + 6.0 * ts_xxy_xxyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxx_xxz[i] * gfe_0 + 2.0 * ts_xxx_xxyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxxy_yz[i] * gfe_0 + 4.0 * ts_xxxy_xyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxy_xxz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxxy_xxy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxy_xxyz[i] * gfe_0 + ts_xxxy_xxyz[i] * rgc2_0;

        gr_xxxy_xxzz[i] = 6.0 * ts_xy_xxzz[i] * gfe_0 + 12.0 * ts_xxy_xzz[i] * gfe_0 + 6.0 * ts_xxy_xxzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxx_xxzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxxy_zz[i] * gfe_0 + 4.0 * ts_xxxy_xzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxy_xx[i] * gfe_0 + 4.0 * ts_xxxy_xxz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxy_xxzz[i] * gfe_0 + ts_xxxy_xxzz[i] * rgc2_0;

        gr_xxxy_xyyy[i] = 6.0 * ts_xy_xyyy[i] * gfe_0 + 6.0 * ts_xxy_yyy[i] * gfe_0 + 6.0 * ts_xxy_xyyy[i] * gfe_0 * gc_x[i] + 6.0 * ts_xxx_xyy[i] * gfe_0 + 2.0 * ts_xxx_xyyy[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxxy_yyy[i] * gfe_0 * gc_x[i] + 6.0 * ts_xxxy_xy[i] * gfe_0 + 6.0 * ts_xxxy_xyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xxxy_xyyy[i] * gfe_0 + ts_xxxy_xyyy[i] * rgc2_0;

        gr_xxxy_xyyz[i] = 6.0 * ts_xy_xyyz[i] * gfe_0 + 6.0 * ts_xxy_yyz[i] * gfe_0 + 6.0 * ts_xxy_xyyz[i] * gfe_0 * gc_x[i] + 4.0 * ts_xxx_xyz[i] * gfe_0 + 2.0 * ts_xxx_xyyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxxy_yyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxy_xz[i] * gfe_0 + 4.0 * ts_xxxy_xyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxxy_xyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxy_xyyz[i] * gfe_0 + ts_xxxy_xyyz[i] * rgc2_0;

        gr_xxxy_xyzz[i] = 6.0 * ts_xy_xyzz[i] * gfe_0 + 6.0 * ts_xxy_yzz[i] * gfe_0 + 6.0 * ts_xxy_xyzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxx_xzz[i] * gfe_0 + 2.0 * ts_xxx_xyzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxxy_yzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxy_xzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxxy_xy[i] * gfe_0 + 4.0 * ts_xxxy_xyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxy_xyzz[i] * gfe_0 + ts_xxxy_xyzz[i] * rgc2_0;

        gr_xxxy_xzzz[i] = 6.0 * ts_xy_xzzz[i] * gfe_0 + 6.0 * ts_xxy_zzz[i] * gfe_0 + 6.0 * ts_xxy_xzzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxx_xzzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxxy_zzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xxxy_xz[i] * gfe_0 + 6.0 * ts_xxxy_xzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxy_xzzz[i] * gfe_0 + ts_xxxy_xzzz[i] * rgc2_0;

        gr_xxxy_yyyy[i] = 6.0 * ts_xy_yyyy[i] * gfe_0 + 6.0 * ts_xxy_yyyy[i] * gfe_0 * gc_x[i] + 8.0 * ts_xxx_yyy[i] * gfe_0 + 2.0 * ts_xxx_yyyy[i] * gfe_0 * gc_y[i] + 12.0 * ts_xxxy_yy[i] * gfe_0 + 8.0 * ts_xxxy_yyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xxxy_yyyy[i] * gfe_0 + ts_xxxy_yyyy[i] * rgc2_0;

        gr_xxxy_yyyz[i] = 6.0 * ts_xy_yyyz[i] * gfe_0 + 6.0 * ts_xxy_yyyz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xxx_yyz[i] * gfe_0 + 2.0 * ts_xxx_yyyz[i] * gfe_0 * gc_y[i] + 6.0 * ts_xxxy_yz[i] * gfe_0 + 6.0 * ts_xxxy_yyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxxy_yyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxy_yyyz[i] * gfe_0 + ts_xxxy_yyyz[i] * rgc2_0;

        gr_xxxy_yyzz[i] = 6.0 * ts_xy_yyzz[i] * gfe_0 + 6.0 * ts_xxy_yyzz[i] * gfe_0 * gc_x[i] + 4.0 * ts_xxx_yzz[i] * gfe_0 + 2.0 * ts_xxx_yyzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxxy_zz[i] * gfe_0 + 4.0 * ts_xxxy_yzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxxy_yy[i] * gfe_0 + 4.0 * ts_xxxy_yyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxy_yyzz[i] * gfe_0 + ts_xxxy_yyzz[i] * rgc2_0;

        gr_xxxy_yzzz[i] = 6.0 * ts_xy_yzzz[i] * gfe_0 + 6.0 * ts_xxy_yzzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxx_zzz[i] * gfe_0 + 2.0 * ts_xxx_yzzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxxy_zzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_xxxy_yz[i] * gfe_0 + 6.0 * ts_xxxy_yzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxy_yzzz[i] * gfe_0 + ts_xxxy_yzzz[i] * rgc2_0;

        gr_xxxy_zzzz[i] = 6.0 * ts_xy_zzzz[i] * gfe_0 + 6.0 * ts_xxy_zzzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxx_zzzz[i] * gfe_0 * gc_y[i] + 12.0 * ts_xxxy_zz[i] * gfe_0 + 8.0 * ts_xxxy_zzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxy_zzzz[i] * gfe_0 + ts_xxxy_zzzz[i] * rgc2_0;
    }
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        gr_xxxz_xxxx[i] = 6.0 * ts_xz_xxxx[i] * gfe_0 + 24.0 * ts_xxz_xxx[i] * gfe_0 + 6.0 * ts_xxz_xxxx[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxx_xxxx[i] * gfe_0 * gc_z[i] + 12.0 * ts_xxxz_xx[i] * gfe_0 + 8.0 * ts_xxxz_xxx[i] * gfe_0 * gc_x[i] + 3.0 * ts_xxxz_xxxx[i] * gfe_0 + ts_xxxz_xxxx[i] * rgc2_0;

        gr_xxxz_xxxy[i] = 6.0 * ts_xz_xxxy[i] * gfe_0 + 18.0 * ts_xxz_xxy[i] * gfe_0 + 6.0 * ts_xxz_xxxy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxx_xxxy[i] * gfe_0 * gc_z[i] + 6.0 * ts_xxxz_xy[i] * gfe_0 + 6.0 * ts_xxxz_xxy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxz_xxx[i] * gfe_0 * gc_y[i] + 3.0 * ts_xxxz_xxxy[i] * gfe_0 + ts_xxxz_xxxy[i] * rgc2_0;

        gr_xxxz_xxxz[i] = 6.0 * ts_xz_xxxz[i] * gfe_0 + 18.0 * ts_xxz_xxz[i] * gfe_0 + 6.0 * ts_xxz_xxxz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxx_xxx[i] * gfe_0 + 2.0 * ts_xxx_xxxz[i] * gfe_0 * gc_z[i] + 6.0 * ts_xxxz_xz[i] * gfe_0 + 6.0 * ts_xxxz_xxz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxz_xxx[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxz_xxxz[i] * gfe_0 + ts_xxxz_xxxz[i] * rgc2_0;

        gr_xxxz_xxyy[i] = 6.0 * ts_xz_xxyy[i] * gfe_0 + 12.0 * ts_xxz_xyy[i] * gfe_0 + 6.0 * ts_xxz_xxyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxx_xxyy[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxxz_yy[i] * gfe_0 + 4.0 * ts_xxxz_xyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxz_xx[i] * gfe_0 + 4.0 * ts_xxxz_xxy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xxxz_xxyy[i] * gfe_0 + ts_xxxz_xxyy[i] * rgc2_0;

        gr_xxxz_xxyz[i] = 6.0 * ts_xz_xxyz[i] * gfe_0 + 12.0 * ts_xxz_xyz[i] * gfe_0 + 6.0 * ts_xxz_xxyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxx_xxy[i] * gfe_0 + 2.0 * ts_xxx_xxyz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxxz_yz[i] * gfe_0 + 4.0 * ts_xxxz_xyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxz_xxz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxxz_xxy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxz_xxyz[i] * gfe_0 + ts_xxxz_xxyz[i] * rgc2_0;

        gr_xxxz_xxzz[i] = 6.0 * ts_xz_xxzz[i] * gfe_0 + 12.0 * ts_xxz_xzz[i] * gfe_0 + 6.0 * ts_xxz_xxzz[i] * gfe_0 * gc_x[i] + 4.0 * ts_xxx_xxz[i] * gfe_0 + 2.0 * ts_xxx_xxzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxxz_zz[i] * gfe_0 + 4.0 * ts_xxxz_xzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxz_xx[i] * gfe_0 + 4.0 * ts_xxxz_xxz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxz_xxzz[i] * gfe_0 + ts_xxxz_xxzz[i] * rgc2_0;

        gr_xxxz_xyyy[i] = 6.0 * ts_xz_xyyy[i] * gfe_0 + 6.0 * ts_xxz_yyy[i] * gfe_0 + 6.0 * ts_xxz_xyyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxx_xyyy[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxxz_yyy[i] * gfe_0 * gc_x[i] + 6.0 * ts_xxxz_xy[i] * gfe_0 + 6.0 * ts_xxxz_xyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xxxz_xyyy[i] * gfe_0 + ts_xxxz_xyyy[i] * rgc2_0;

        gr_xxxz_xyyz[i] = 6.0 * ts_xz_xyyz[i] * gfe_0 + 6.0 * ts_xxz_yyz[i] * gfe_0 + 6.0 * ts_xxz_xyyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxx_xyy[i] * gfe_0 + 2.0 * ts_xxx_xyyz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxxz_yyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxz_xz[i] * gfe_0 + 4.0 * ts_xxxz_xyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxxz_xyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxz_xyyz[i] * gfe_0 + ts_xxxz_xyyz[i] * rgc2_0;

        gr_xxxz_xyzz[i] = 6.0 * ts_xz_xyzz[i] * gfe_0 + 6.0 * ts_xxz_yzz[i] * gfe_0 + 6.0 * ts_xxz_xyzz[i] * gfe_0 * gc_x[i] + 4.0 * ts_xxx_xyz[i] * gfe_0 + 2.0 * ts_xxx_xyzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxxz_yzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxxz_xzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxxz_xy[i] * gfe_0 + 4.0 * ts_xxxz_xyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxz_xyzz[i] * gfe_0 + ts_xxxz_xyzz[i] * rgc2_0;

        gr_xxxz_xzzz[i] = 6.0 * ts_xz_xzzz[i] * gfe_0 + 6.0 * ts_xxz_zzz[i] * gfe_0 + 6.0 * ts_xxz_xzzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xxx_xzz[i] * gfe_0 + 2.0 * ts_xxx_xzzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxxz_zzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xxxz_xz[i] * gfe_0 + 6.0 * ts_xxxz_xzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxz_xzzz[i] * gfe_0 + ts_xxxz_xzzz[i] * rgc2_0;

        gr_xxxz_yyyy[i] = 6.0 * ts_xz_yyyy[i] * gfe_0 + 6.0 * ts_xxz_yyyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxx_yyyy[i] * gfe_0 * gc_z[i] + 12.0 * ts_xxxz_yy[i] * gfe_0 + 8.0 * ts_xxxz_yyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xxxz_yyyy[i] * gfe_0 + ts_xxxz_yyyy[i] * rgc2_0;

        gr_xxxz_yyyz[i] = 6.0 * ts_xz_yyyz[i] * gfe_0 + 6.0 * ts_xxz_yyyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxx_yyy[i] * gfe_0 + 2.0 * ts_xxx_yyyz[i] * gfe_0 * gc_z[i] + 6.0 * ts_xxxz_yz[i] * gfe_0 + 6.0 * ts_xxxz_yyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxxz_yyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxz_yyyz[i] * gfe_0 + ts_xxxz_yyyz[i] * rgc2_0;

        gr_xxxz_yyzz[i] = 6.0 * ts_xz_yyzz[i] * gfe_0 + 6.0 * ts_xxz_yyzz[i] * gfe_0 * gc_x[i] + 4.0 * ts_xxx_yyz[i] * gfe_0 + 2.0 * ts_xxx_yyzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxxz_zz[i] * gfe_0 + 4.0 * ts_xxxz_yzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxxz_yy[i] * gfe_0 + 4.0 * ts_xxxz_yyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxz_yyzz[i] * gfe_0 + ts_xxxz_yyzz[i] * rgc2_0;

        gr_xxxz_yzzz[i] = 6.0 * ts_xz_yzzz[i] * gfe_0 + 6.0 * ts_xxz_yzzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xxx_yzz[i] * gfe_0 + 2.0 * ts_xxx_yzzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxxz_zzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_xxxz_yz[i] * gfe_0 + 6.0 * ts_xxxz_yzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxz_yzzz[i] * gfe_0 + ts_xxxz_yzzz[i] * rgc2_0;

        gr_xxxz_zzzz[i] = 6.0 * ts_xz_zzzz[i] * gfe_0 + 6.0 * ts_xxz_zzzz[i] * gfe_0 * gc_x[i] + 8.0 * ts_xxx_zzz[i] * gfe_0 + 2.0 * ts_xxx_zzzz[i] * gfe_0 * gc_z[i] + 12.0 * ts_xxxz_zz[i] * gfe_0 + 8.0 * ts_xxxz_zzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxxz_zzzz[i] * gfe_0 + ts_xxxz_zzzz[i] * rgc2_0;
    }
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        gr_xxyy_xxxx[i] = 2.0 * ts_yy_xxxx[i] * gfe_0 + 16.0 * ts_xyy_xxx[i] * gfe_0 + 4.0 * ts_xyy_xxxx[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_xxxx[i] * gfe_0 + 4.0 * ts_xxy_xxxx[i] * gfe_0 * gc_y[i] + 12.0 * ts_xxyy_xx[i] * gfe_0 + 8.0 * ts_xxyy_xxx[i] * gfe_0 * gc_x[i] + 3.0 * ts_xxyy_xxxx[i] * gfe_0 + ts_xxyy_xxxx[i] * rgc2_0;

        gr_xxyy_xxxy[i] = 2.0 * ts_yy_xxxy[i] * gfe_0 + 12.0 * ts_xyy_xxy[i] * gfe_0 + 4.0 * ts_xyy_xxxy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_xxxy[i] * gfe_0 + 4.0 * ts_xxy_xxx[i] * gfe_0 + 4.0 * ts_xxy_xxxy[i] * gfe_0 * gc_y[i] + 6.0 * ts_xxyy_xy[i] * gfe_0 + 6.0 * ts_xxyy_xxy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxyy_xxx[i] * gfe_0 * gc_y[i] + 3.0 * ts_xxyy_xxxy[i] * gfe_0 + ts_xxyy_xxxy[i] * rgc2_0;

        gr_xxyy_xxxz[i] = 2.0 * ts_yy_xxxz[i] * gfe_0 + 12.0 * ts_xyy_xxz[i] * gfe_0 + 4.0 * ts_xyy_xxxz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_xxxz[i] * gfe_0 + 4.0 * ts_xxy_xxxz[i] * gfe_0 * gc_y[i] + 6.0 * ts_xxyy_xz[i] * gfe_0 + 6.0 * ts_xxyy_xxz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxyy_xxx[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxyy_xxxz[i] * gfe_0 + ts_xxyy_xxxz[i] * rgc2_0;

        gr_xxyy_xxyy[i] = 2.0 * ts_yy_xxyy[i] * gfe_0 + 8.0 * ts_xyy_xyy[i] * gfe_0 + 4.0 * ts_xyy_xxyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_xxyy[i] * gfe_0 + 8.0 * ts_xxy_xxy[i] * gfe_0 + 4.0 * ts_xxy_xxyy[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxyy_yy[i] * gfe_0 + 4.0 * ts_xxyy_xyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxyy_xx[i] * gfe_0 + 4.0 * ts_xxyy_xxy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xxyy_xxyy[i] * gfe_0 + ts_xxyy_xxyy[i] * rgc2_0;

        gr_xxyy_xxyz[i] = 2.0 * ts_yy_xxyz[i] * gfe_0 + 8.0 * ts_xyy_xyz[i] * gfe_0 + 4.0 * ts_xyy_xxyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_xxyz[i] * gfe_0 + 4.0 * ts_xxy_xxz[i] * gfe_0 + 4.0 * ts_xxy_xxyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxyy_yz[i] * gfe_0 + 4.0 * ts_xxyy_xyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxyy_xxz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxyy_xxy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxyy_xxyz[i] * gfe_0 + ts_xxyy_xxyz[i] * rgc2_0;

        gr_xxyy_xxzz[i] = 2.0 * ts_yy_xxzz[i] * gfe_0 + 8.0 * ts_xyy_xzz[i] * gfe_0 + 4.0 * ts_xyy_xxzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_xxzz[i] * gfe_0 + 4.0 * ts_xxy_xxzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxyy_zz[i] * gfe_0 + 4.0 * ts_xxyy_xzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxyy_xx[i] * gfe_0 + 4.0 * ts_xxyy_xxz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxyy_xxzz[i] * gfe_0 + ts_xxyy_xxzz[i] * rgc2_0;

        gr_xxyy_xyyy[i] = 2.0 * ts_yy_xyyy[i] * gfe_0 + 4.0 * ts_xyy_yyy[i] * gfe_0 + 4.0 * ts_xyy_xyyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_xyyy[i] * gfe_0 + 12.0 * ts_xxy_xyy[i] * gfe_0 + 4.0 * ts_xxy_xyyy[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxyy_yyy[i] * gfe_0 * gc_x[i] + 6.0 * ts_xxyy_xy[i] * gfe_0 + 6.0 * ts_xxyy_xyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xxyy_xyyy[i] * gfe_0 + ts_xxyy_xyyy[i] * rgc2_0;

        gr_xxyy_xyyz[i] = 2.0 * ts_yy_xyyz[i] * gfe_0 + 4.0 * ts_xyy_yyz[i] * gfe_0 + 4.0 * ts_xyy_xyyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_xyyz[i] * gfe_0 + 8.0 * ts_xxy_xyz[i] * gfe_0 + 4.0 * ts_xxy_xyyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxyy_yyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxyy_xz[i] * gfe_0 + 4.0 * ts_xxyy_xyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxyy_xyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxyy_xyyz[i] * gfe_0 + ts_xxyy_xyyz[i] * rgc2_0;

        gr_xxyy_xyzz[i] = 2.0 * ts_yy_xyzz[i] * gfe_0 + 4.0 * ts_xyy_yzz[i] * gfe_0 + 4.0 * ts_xyy_xyzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_xyzz[i] * gfe_0 + 4.0 * ts_xxy_xzz[i] * gfe_0 + 4.0 * ts_xxy_xyzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxyy_yzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxyy_xzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxyy_xy[i] * gfe_0 + 4.0 * ts_xxyy_xyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxyy_xyzz[i] * gfe_0 + ts_xxyy_xyzz[i] * rgc2_0;

        gr_xxyy_xzzz[i] = 2.0 * ts_yy_xzzz[i] * gfe_0 + 4.0 * ts_xyy_zzz[i] * gfe_0 + 4.0 * ts_xyy_xzzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_xzzz[i] * gfe_0 + 4.0 * ts_xxy_xzzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxyy_zzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xxyy_xz[i] * gfe_0 + 6.0 * ts_xxyy_xzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxyy_xzzz[i] * gfe_0 + ts_xxyy_xzzz[i] * rgc2_0;

        gr_xxyy_yyyy[i] = 2.0 * ts_yy_yyyy[i] * gfe_0 + 4.0 * ts_xyy_yyyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_yyyy[i] * gfe_0 + 16.0 * ts_xxy_yyy[i] * gfe_0 + 4.0 * ts_xxy_yyyy[i] * gfe_0 * gc_y[i] + 12.0 * ts_xxyy_yy[i] * gfe_0 + 8.0 * ts_xxyy_yyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xxyy_yyyy[i] * gfe_0 + ts_xxyy_yyyy[i] * rgc2_0;

        gr_xxyy_yyyz[i] = 2.0 * ts_yy_yyyz[i] * gfe_0 + 4.0 * ts_xyy_yyyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_yyyz[i] * gfe_0 + 12.0 * ts_xxy_yyz[i] * gfe_0 + 4.0 * ts_xxy_yyyz[i] * gfe_0 * gc_y[i] + 6.0 * ts_xxyy_yz[i] * gfe_0 + 6.0 * ts_xxyy_yyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxyy_yyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxyy_yyyz[i] * gfe_0 + ts_xxyy_yyyz[i] * rgc2_0;

        gr_xxyy_yyzz[i] = 2.0 * ts_yy_yyzz[i] * gfe_0 + 4.0 * ts_xyy_yyzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_yyzz[i] * gfe_0 + 8.0 * ts_xxy_yzz[i] * gfe_0 + 4.0 * ts_xxy_yyzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxyy_zz[i] * gfe_0 + 4.0 * ts_xxyy_yzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxyy_yy[i] * gfe_0 + 4.0 * ts_xxyy_yyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxyy_yyzz[i] * gfe_0 + ts_xxyy_yyzz[i] * rgc2_0;

        gr_xxyy_yzzz[i] = 2.0 * ts_yy_yzzz[i] * gfe_0 + 4.0 * ts_xyy_yzzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_yzzz[i] * gfe_0 + 4.0 * ts_xxy_zzz[i] * gfe_0 + 4.0 * ts_xxy_yzzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxyy_zzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_xxyy_yz[i] * gfe_0 + 6.0 * ts_xxyy_yzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxyy_yzzz[i] * gfe_0 + ts_xxyy_yzzz[i] * rgc2_0;

        gr_xxyy_zzzz[i] = 2.0 * ts_yy_zzzz[i] * gfe_0 + 4.0 * ts_xyy_zzzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_zzzz[i] * gfe_0 + 4.0 * ts_xxy_zzzz[i] * gfe_0 * gc_y[i] + 12.0 * ts_xxyy_zz[i] * gfe_0 + 8.0 * ts_xxyy_zzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxyy_zzzz[i] * gfe_0 + ts_xxyy_zzzz[i] * rgc2_0;
    }
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        gr_xxyz_xxxx[i] = 2.0 * ts_yz_xxxx[i] * gfe_0 + 16.0 * ts_xyz_xxx[i] * gfe_0 + 4.0 * ts_xyz_xxxx[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxz_xxxx[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxy_xxxx[i] * gfe_0 * gc_z[i] + 12.0 * ts_xxyz_xx[i] * gfe_0 + 8.0 * ts_xxyz_xxx[i] * gfe_0 * gc_x[i] + 3.0 * ts_xxyz_xxxx[i] * gfe_0 + ts_xxyz_xxxx[i] * rgc2_0;

        gr_xxyz_xxxy[i] = 2.0 * ts_yz_xxxy[i] * gfe_0 + 12.0 * ts_xyz_xxy[i] * gfe_0 + 4.0 * ts_xyz_xxxy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxz_xxx[i] * gfe_0 + 2.0 * ts_xxz_xxxy[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxy_xxxy[i] * gfe_0 * gc_z[i] + 6.0 * ts_xxyz_xy[i] * gfe_0 + 6.0 * ts_xxyz_xxy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxyz_xxx[i] * gfe_0 * gc_y[i] + 3.0 * ts_xxyz_xxxy[i] * gfe_0 + ts_xxyz_xxxy[i] * rgc2_0;

        gr_xxyz_xxxz[i] = 2.0 * ts_yz_xxxz[i] * gfe_0 + 12.0 * ts_xyz_xxz[i] * gfe_0 + 4.0 * ts_xyz_xxxz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxz_xxxz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxy_xxx[i] * gfe_0 + 2.0 * ts_xxy_xxxz[i] * gfe_0 * gc_z[i] + 6.0 * ts_xxyz_xz[i] * gfe_0 + 6.0 * ts_xxyz_xxz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxyz_xxx[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxyz_xxxz[i] * gfe_0 + ts_xxyz_xxxz[i] * rgc2_0;

        gr_xxyz_xxyy[i] = 2.0 * ts_yz_xxyy[i] * gfe_0 + 8.0 * ts_xyz_xyy[i] * gfe_0 + 4.0 * ts_xyz_xxyy[i] * gfe_0 * gc_x[i] + 4.0 * ts_xxz_xxy[i] * gfe_0 + 2.0 * ts_xxz_xxyy[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxy_xxyy[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxyz_yy[i] * gfe_0 + 4.0 * ts_xxyz_xyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxyz_xx[i] * gfe_0 + 4.0 * ts_xxyz_xxy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xxyz_xxyy[i] * gfe_0 + ts_xxyz_xxyy[i] * rgc2_0;

        gr_xxyz_xxyz[i] = 2.0 * ts_yz_xxyz[i] * gfe_0 + 8.0 * ts_xyz_xyz[i] * gfe_0 + 4.0 * ts_xyz_xxyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxz_xxz[i] * gfe_0 + 2.0 * ts_xxz_xxyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxy_xxy[i] * gfe_0 + 2.0 * ts_xxy_xxyz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxyz_yz[i] * gfe_0 + 4.0 * ts_xxyz_xyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxyz_xxz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxyz_xxy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxyz_xxyz[i] * gfe_0 + ts_xxyz_xxyz[i] * rgc2_0;

        gr_xxyz_xxzz[i] = 2.0 * ts_yz_xxzz[i] * gfe_0 + 8.0 * ts_xyz_xzz[i] * gfe_0 + 4.0 * ts_xyz_xxzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxz_xxzz[i] * gfe_0 * gc_y[i] + 4.0 * ts_xxy_xxz[i] * gfe_0 + 2.0 * ts_xxy_xxzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxyz_zz[i] * gfe_0 + 4.0 * ts_xxyz_xzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxyz_xx[i] * gfe_0 + 4.0 * ts_xxyz_xxz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxyz_xxzz[i] * gfe_0 + ts_xxyz_xxzz[i] * rgc2_0;

        gr_xxyz_xyyy[i] = 2.0 * ts_yz_xyyy[i] * gfe_0 + 4.0 * ts_xyz_yyy[i] * gfe_0 + 4.0 * ts_xyz_xyyy[i] * gfe_0 * gc_x[i] + 6.0 * ts_xxz_xyy[i] * gfe_0 + 2.0 * ts_xxz_xyyy[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxy_xyyy[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxyz_yyy[i] * gfe_0 * gc_x[i] + 6.0 * ts_xxyz_xy[i] * gfe_0 + 6.0 * ts_xxyz_xyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xxyz_xyyy[i] * gfe_0 + ts_xxyz_xyyy[i] * rgc2_0;

        gr_xxyz_xyyz[i] = 2.0 * ts_yz_xyyz[i] * gfe_0 + 4.0 * ts_xyz_yyz[i] * gfe_0 + 4.0 * ts_xyz_xyyz[i] * gfe_0 * gc_x[i] + 4.0 * ts_xxz_xyz[i] * gfe_0 + 2.0 * ts_xxz_xyyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxy_xyy[i] * gfe_0 + 2.0 * ts_xxy_xyyz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxyz_yyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxyz_xz[i] * gfe_0 + 4.0 * ts_xxyz_xyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxyz_xyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxyz_xyyz[i] * gfe_0 + ts_xxyz_xyyz[i] * rgc2_0;

        gr_xxyz_xyzz[i] = 2.0 * ts_yz_xyzz[i] * gfe_0 + 4.0 * ts_xyz_yzz[i] * gfe_0 + 4.0 * ts_xyz_xyzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxz_xzz[i] * gfe_0 + 2.0 * ts_xxz_xyzz[i] * gfe_0 * gc_y[i] + 4.0 * ts_xxy_xyz[i] * gfe_0 + 2.0 * ts_xxy_xyzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxyz_yzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxyz_xzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxyz_xy[i] * gfe_0 + 4.0 * ts_xxyz_xyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxyz_xyzz[i] * gfe_0 + ts_xxyz_xyzz[i] * rgc2_0;

        gr_xxyz_xzzz[i] = 2.0 * ts_yz_xzzz[i] * gfe_0 + 4.0 * ts_xyz_zzz[i] * gfe_0 + 4.0 * ts_xyz_xzzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxz_xzzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_xxy_xzz[i] * gfe_0 + 2.0 * ts_xxy_xzzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxyz_zzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xxyz_xz[i] * gfe_0 + 6.0 * ts_xxyz_xzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxyz_xzzz[i] * gfe_0 + ts_xxyz_xzzz[i] * rgc2_0;

        gr_xxyz_yyyy[i] = 2.0 * ts_yz_yyyy[i] * gfe_0 + 4.0 * ts_xyz_yyyy[i] * gfe_0 * gc_x[i] + 8.0 * ts_xxz_yyy[i] * gfe_0 + 2.0 * ts_xxz_yyyy[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxy_yyyy[i] * gfe_0 * gc_z[i] + 12.0 * ts_xxyz_yy[i] * gfe_0 + 8.0 * ts_xxyz_yyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xxyz_yyyy[i] * gfe_0 + ts_xxyz_yyyy[i] * rgc2_0;

        gr_xxyz_yyyz[i] = 2.0 * ts_yz_yyyz[i] * gfe_0 + 4.0 * ts_xyz_yyyz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xxz_yyz[i] * gfe_0 + 2.0 * ts_xxz_yyyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxy_yyy[i] * gfe_0 + 2.0 * ts_xxy_yyyz[i] * gfe_0 * gc_z[i] + 6.0 * ts_xxyz_yz[i] * gfe_0 + 6.0 * ts_xxyz_yyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxyz_yyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxyz_yyyz[i] * gfe_0 + ts_xxyz_yyyz[i] * rgc2_0;

        gr_xxyz_yyzz[i] = 2.0 * ts_yz_yyzz[i] * gfe_0 + 4.0 * ts_xyz_yyzz[i] * gfe_0 * gc_x[i] + 4.0 * ts_xxz_yzz[i] * gfe_0 + 2.0 * ts_xxz_yyzz[i] * gfe_0 * gc_y[i] + 4.0 * ts_xxy_yyz[i] * gfe_0 + 2.0 * ts_xxy_yyzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxyz_zz[i] * gfe_0 + 4.0 * ts_xxyz_yzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxyz_yy[i] * gfe_0 + 4.0 * ts_xxyz_yyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxyz_yyzz[i] * gfe_0 + ts_xxyz_yyzz[i] * rgc2_0;

        gr_xxyz_yzzz[i] = 2.0 * ts_yz_yzzz[i] * gfe_0 + 4.0 * ts_xyz_yzzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxz_zzz[i] * gfe_0 + 2.0 * ts_xxz_yzzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_xxy_yzz[i] * gfe_0 + 2.0 * ts_xxy_yzzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxyz_zzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_xxyz_yz[i] * gfe_0 + 6.0 * ts_xxyz_yzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxyz_yzzz[i] * gfe_0 + ts_xxyz_yzzz[i] * rgc2_0;

        gr_xxyz_zzzz[i] = 2.0 * ts_yz_zzzz[i] * gfe_0 + 4.0 * ts_xyz_zzzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxz_zzzz[i] * gfe_0 * gc_y[i] + 8.0 * ts_xxy_zzz[i] * gfe_0 + 2.0 * ts_xxy_zzzz[i] * gfe_0 * gc_z[i] + 12.0 * ts_xxyz_zz[i] * gfe_0 + 8.0 * ts_xxyz_zzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxyz_zzzz[i] * gfe_0 + ts_xxyz_zzzz[i] * rgc2_0;
    }
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        gr_xxzz_xxxx[i] = 2.0 * ts_zz_xxxx[i] * gfe_0 + 16.0 * ts_xzz_xxx[i] * gfe_0 + 4.0 * ts_xzz_xxxx[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_xxxx[i] * gfe_0 + 4.0 * ts_xxz_xxxx[i] * gfe_0 * gc_z[i] + 12.0 * ts_xxzz_xx[i] * gfe_0 + 8.0 * ts_xxzz_xxx[i] * gfe_0 * gc_x[i] + 3.0 * ts_xxzz_xxxx[i] * gfe_0 + ts_xxzz_xxxx[i] * rgc2_0;

        gr_xxzz_xxxy[i] = 2.0 * ts_zz_xxxy[i] * gfe_0 + 12.0 * ts_xzz_xxy[i] * gfe_0 + 4.0 * ts_xzz_xxxy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_xxxy[i] * gfe_0 + 4.0 * ts_xxz_xxxy[i] * gfe_0 * gc_z[i] + 6.0 * ts_xxzz_xy[i] * gfe_0 + 6.0 * ts_xxzz_xxy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxzz_xxx[i] * gfe_0 * gc_y[i] + 3.0 * ts_xxzz_xxxy[i] * gfe_0 + ts_xxzz_xxxy[i] * rgc2_0;

        gr_xxzz_xxxz[i] = 2.0 * ts_zz_xxxz[i] * gfe_0 + 12.0 * ts_xzz_xxz[i] * gfe_0 + 4.0 * ts_xzz_xxxz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_xxxz[i] * gfe_0 + 4.0 * ts_xxz_xxx[i] * gfe_0 + 4.0 * ts_xxz_xxxz[i] * gfe_0 * gc_z[i] + 6.0 * ts_xxzz_xz[i] * gfe_0 + 6.0 * ts_xxzz_xxz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxzz_xxx[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxzz_xxxz[i] * gfe_0 + ts_xxzz_xxxz[i] * rgc2_0;

        gr_xxzz_xxyy[i] = 2.0 * ts_zz_xxyy[i] * gfe_0 + 8.0 * ts_xzz_xyy[i] * gfe_0 + 4.0 * ts_xzz_xxyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_xxyy[i] * gfe_0 + 4.0 * ts_xxz_xxyy[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxzz_yy[i] * gfe_0 + 4.0 * ts_xxzz_xyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxzz_xx[i] * gfe_0 + 4.0 * ts_xxzz_xxy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xxzz_xxyy[i] * gfe_0 + ts_xxzz_xxyy[i] * rgc2_0;

        gr_xxzz_xxyz[i] = 2.0 * ts_zz_xxyz[i] * gfe_0 + 8.0 * ts_xzz_xyz[i] * gfe_0 + 4.0 * ts_xzz_xxyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_xxyz[i] * gfe_0 + 4.0 * ts_xxz_xxy[i] * gfe_0 + 4.0 * ts_xxz_xxyz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxzz_yz[i] * gfe_0 + 4.0 * ts_xxzz_xyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxzz_xxz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxzz_xxy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxzz_xxyz[i] * gfe_0 + ts_xxzz_xxyz[i] * rgc2_0;

        gr_xxzz_xxzz[i] = 2.0 * ts_zz_xxzz[i] * gfe_0 + 8.0 * ts_xzz_xzz[i] * gfe_0 + 4.0 * ts_xzz_xxzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_xxzz[i] * gfe_0 + 8.0 * ts_xxz_xxz[i] * gfe_0 + 4.0 * ts_xxz_xxzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxzz_zz[i] * gfe_0 + 4.0 * ts_xxzz_xzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxzz_xx[i] * gfe_0 + 4.0 * ts_xxzz_xxz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxzz_xxzz[i] * gfe_0 + ts_xxzz_xxzz[i] * rgc2_0;

        gr_xxzz_xyyy[i] = 2.0 * ts_zz_xyyy[i] * gfe_0 + 4.0 * ts_xzz_yyy[i] * gfe_0 + 4.0 * ts_xzz_xyyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_xyyy[i] * gfe_0 + 4.0 * ts_xxz_xyyy[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxzz_yyy[i] * gfe_0 * gc_x[i] + 6.0 * ts_xxzz_xy[i] * gfe_0 + 6.0 * ts_xxzz_xyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xxzz_xyyy[i] * gfe_0 + ts_xxzz_xyyy[i] * rgc2_0;

        gr_xxzz_xyyz[i] = 2.0 * ts_zz_xyyz[i] * gfe_0 + 4.0 * ts_xzz_yyz[i] * gfe_0 + 4.0 * ts_xzz_xyyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_xyyz[i] * gfe_0 + 4.0 * ts_xxz_xyy[i] * gfe_0 + 4.0 * ts_xxz_xyyz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxzz_yyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxzz_xz[i] * gfe_0 + 4.0 * ts_xxzz_xyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxzz_xyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxzz_xyyz[i] * gfe_0 + ts_xxzz_xyyz[i] * rgc2_0;

        gr_xxzz_xyzz[i] = 2.0 * ts_zz_xyzz[i] * gfe_0 + 4.0 * ts_xzz_yzz[i] * gfe_0 + 4.0 * ts_xzz_xyzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_xyzz[i] * gfe_0 + 8.0 * ts_xxz_xyz[i] * gfe_0 + 4.0 * ts_xxz_xyzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxzz_yzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xxzz_xzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxzz_xy[i] * gfe_0 + 4.0 * ts_xxzz_xyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxzz_xyzz[i] * gfe_0 + ts_xxzz_xyzz[i] * rgc2_0;

        gr_xxzz_xzzz[i] = 2.0 * ts_zz_xzzz[i] * gfe_0 + 4.0 * ts_xzz_zzz[i] * gfe_0 + 4.0 * ts_xzz_xzzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_xzzz[i] * gfe_0 + 12.0 * ts_xxz_xzz[i] * gfe_0 + 4.0 * ts_xxz_xzzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxzz_zzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xxzz_xz[i] * gfe_0 + 6.0 * ts_xxzz_xzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxzz_xzzz[i] * gfe_0 + ts_xxzz_xzzz[i] * rgc2_0;

        gr_xxzz_yyyy[i] = 2.0 * ts_zz_yyyy[i] * gfe_0 + 4.0 * ts_xzz_yyyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_yyyy[i] * gfe_0 + 4.0 * ts_xxz_yyyy[i] * gfe_0 * gc_z[i] + 12.0 * ts_xxzz_yy[i] * gfe_0 + 8.0 * ts_xxzz_yyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xxzz_yyyy[i] * gfe_0 + ts_xxzz_yyyy[i] * rgc2_0;

        gr_xxzz_yyyz[i] = 2.0 * ts_zz_yyyz[i] * gfe_0 + 4.0 * ts_xzz_yyyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_yyyz[i] * gfe_0 + 4.0 * ts_xxz_yyy[i] * gfe_0 + 4.0 * ts_xxz_yyyz[i] * gfe_0 * gc_z[i] + 6.0 * ts_xxzz_yz[i] * gfe_0 + 6.0 * ts_xxzz_yyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxzz_yyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxzz_yyyz[i] * gfe_0 + ts_xxzz_yyyz[i] * rgc2_0;

        gr_xxzz_yyzz[i] = 2.0 * ts_zz_yyzz[i] * gfe_0 + 4.0 * ts_xzz_yyzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_yyzz[i] * gfe_0 + 8.0 * ts_xxz_yyz[i] * gfe_0 + 4.0 * ts_xxz_yyzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxzz_zz[i] * gfe_0 + 4.0 * ts_xxzz_yzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xxzz_yy[i] * gfe_0 + 4.0 * ts_xxzz_yyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxzz_yyzz[i] * gfe_0 + ts_xxzz_yyzz[i] * rgc2_0;

        gr_xxzz_yzzz[i] = 2.0 * ts_zz_yzzz[i] * gfe_0 + 4.0 * ts_xzz_yzzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_yzzz[i] * gfe_0 + 12.0 * ts_xxz_yzz[i] * gfe_0 + 4.0 * ts_xxz_yzzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xxzz_zzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_xxzz_yz[i] * gfe_0 + 6.0 * ts_xxzz_yzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxzz_yzzz[i] * gfe_0 + ts_xxzz_yzzz[i] * rgc2_0;

        gr_xxzz_zzzz[i] = 2.0 * ts_zz_zzzz[i] * gfe_0 + 4.0 * ts_xzz_zzzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xx_zzzz[i] * gfe_0 + 16.0 * ts_xxz_zzz[i] * gfe_0 + 4.0 * ts_xxz_zzzz[i] * gfe_0 * gc_z[i] + 12.0 * ts_xxzz_zz[i] * gfe_0 + 8.0 * ts_xxzz_zzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xxzz_zzzz[i] * gfe_0 + ts_xxzz_zzzz[i] * rgc2_0;
    }
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        gr_xyyy_xxxx[i] = 8.0 * ts_yyy_xxx[i] * gfe_0 + 2.0 * ts_yyy_xxxx[i] * gfe_0 * gc_x[i] + 6.0 * ts_xy_xxxx[i] * gfe_0 + 6.0 * ts_xyy_xxxx[i] * gfe_0 * gc_y[i] + 12.0 * ts_xyyy_xx[i] * gfe_0 + 8.0 * ts_xyyy_xxx[i] * gfe_0 * gc_x[i] + 3.0 * ts_xyyy_xxxx[i] * gfe_0 + ts_xyyy_xxxx[i] * rgc2_0;

        gr_xyyy_xxxy[i] = 6.0 * ts_yyy_xxy[i] * gfe_0 + 2.0 * ts_yyy_xxxy[i] * gfe_0 * gc_x[i] + 6.0 * ts_xy_xxxy[i] * gfe_0 + 6.0 * ts_xyy_xxx[i] * gfe_0 + 6.0 * ts_xyy_xxxy[i] * gfe_0 * gc_y[i] + 6.0 * ts_xyyy_xy[i] * gfe_0 + 6.0 * ts_xyyy_xxy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xyyy_xxx[i] * gfe_0 * gc_y[i] + 3.0 * ts_xyyy_xxxy[i] * gfe_0 + ts_xyyy_xxxy[i] * rgc2_0;

        gr_xyyy_xxxz[i] = 6.0 * ts_yyy_xxz[i] * gfe_0 + 2.0 * ts_yyy_xxxz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xy_xxxz[i] * gfe_0 + 6.0 * ts_xyy_xxxz[i] * gfe_0 * gc_y[i] + 6.0 * ts_xyyy_xz[i] * gfe_0 + 6.0 * ts_xyyy_xxz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xyyy_xxx[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyyy_xxxz[i] * gfe_0 + ts_xyyy_xxxz[i] * rgc2_0;

        gr_xyyy_xxyy[i] = 4.0 * ts_yyy_xyy[i] * gfe_0 + 2.0 * ts_yyy_xxyy[i] * gfe_0 * gc_x[i] + 6.0 * ts_xy_xxyy[i] * gfe_0 + 12.0 * ts_xyy_xxy[i] * gfe_0 + 6.0 * ts_xyy_xxyy[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyyy_yy[i] * gfe_0 + 4.0 * ts_xyyy_xyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xyyy_xx[i] * gfe_0 + 4.0 * ts_xyyy_xxy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xyyy_xxyy[i] * gfe_0 + ts_xyyy_xxyy[i] * rgc2_0;

        gr_xyyy_xxyz[i] = 4.0 * ts_yyy_xyz[i] * gfe_0 + 2.0 * ts_yyy_xxyz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xy_xxyz[i] * gfe_0 + 6.0 * ts_xyy_xxz[i] * gfe_0 + 6.0 * ts_xyy_xxyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyyy_yz[i] * gfe_0 + 4.0 * ts_xyyy_xyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xyyy_xxz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyyy_xxy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyyy_xxyz[i] * gfe_0 + ts_xyyy_xxyz[i] * rgc2_0;

        gr_xyyy_xxzz[i] = 4.0 * ts_yyy_xzz[i] * gfe_0 + 2.0 * ts_yyy_xxzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xy_xxzz[i] * gfe_0 + 6.0 * ts_xyy_xxzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyyy_zz[i] * gfe_0 + 4.0 * ts_xyyy_xzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xyyy_xx[i] * gfe_0 + 4.0 * ts_xyyy_xxz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyyy_xxzz[i] * gfe_0 + ts_xyyy_xxzz[i] * rgc2_0;

        gr_xyyy_xyyy[i] = 2.0 * ts_yyy_yyy[i] * gfe_0 + 2.0 * ts_yyy_xyyy[i] * gfe_0 * gc_x[i] + 6.0 * ts_xy_xyyy[i] * gfe_0 + 18.0 * ts_xyy_xyy[i] * gfe_0 + 6.0 * ts_xyy_xyyy[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyyy_yyy[i] * gfe_0 * gc_x[i] + 6.0 * ts_xyyy_xy[i] * gfe_0 + 6.0 * ts_xyyy_xyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xyyy_xyyy[i] * gfe_0 + ts_xyyy_xyyy[i] * rgc2_0;

        gr_xyyy_xyyz[i] = 2.0 * ts_yyy_yyz[i] * gfe_0 + 2.0 * ts_yyy_xyyz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xy_xyyz[i] * gfe_0 + 12.0 * ts_xyy_xyz[i] * gfe_0 + 6.0 * ts_xyy_xyyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyyy_yyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xyyy_xz[i] * gfe_0 + 4.0 * ts_xyyy_xyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyyy_xyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyyy_xyyz[i] * gfe_0 + ts_xyyy_xyyz[i] * rgc2_0;

        gr_xyyy_xyzz[i] = 2.0 * ts_yyy_yzz[i] * gfe_0 + 2.0 * ts_yyy_xyzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xy_xyzz[i] * gfe_0 + 6.0 * ts_xyy_xzz[i] * gfe_0 + 6.0 * ts_xyy_xyzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyyy_yzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xyyy_xzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyyy_xy[i] * gfe_0 + 4.0 * ts_xyyy_xyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyyy_xyzz[i] * gfe_0 + ts_xyyy_xyzz[i] * rgc2_0;

        gr_xyyy_xzzz[i] = 2.0 * ts_yyy_zzz[i] * gfe_0 + 2.0 * ts_yyy_xzzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xy_xzzz[i] * gfe_0 + 6.0 * ts_xyy_xzzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyyy_zzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xyyy_xz[i] * gfe_0 + 6.0 * ts_xyyy_xzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyyy_xzzz[i] * gfe_0 + ts_xyyy_xzzz[i] * rgc2_0;

        gr_xyyy_yyyy[i] = 2.0 * ts_yyy_yyyy[i] * gfe_0 * gc_x[i] + 6.0 * ts_xy_yyyy[i] * gfe_0 + 24.0 * ts_xyy_yyy[i] * gfe_0 + 6.0 * ts_xyy_yyyy[i] * gfe_0 * gc_y[i] + 12.0 * ts_xyyy_yy[i] * gfe_0 + 8.0 * ts_xyyy_yyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xyyy_yyyy[i] * gfe_0 + ts_xyyy_yyyy[i] * rgc2_0;

        gr_xyyy_yyyz[i] = 2.0 * ts_yyy_yyyz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xy_yyyz[i] * gfe_0 + 18.0 * ts_xyy_yyz[i] * gfe_0 + 6.0 * ts_xyy_yyyz[i] * gfe_0 * gc_y[i] + 6.0 * ts_xyyy_yz[i] * gfe_0 + 6.0 * ts_xyyy_yyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyyy_yyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyyy_yyyz[i] * gfe_0 + ts_xyyy_yyyz[i] * rgc2_0;

        gr_xyyy_yyzz[i] = 2.0 * ts_yyy_yyzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xy_yyzz[i] * gfe_0 + 12.0 * ts_xyy_yzz[i] * gfe_0 + 6.0 * ts_xyy_yyzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyyy_zz[i] * gfe_0 + 4.0 * ts_xyyy_yzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyyy_yy[i] * gfe_0 + 4.0 * ts_xyyy_yyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyyy_yyzz[i] * gfe_0 + ts_xyyy_yyzz[i] * rgc2_0;

        gr_xyyy_yzzz[i] = 2.0 * ts_yyy_yzzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xy_yzzz[i] * gfe_0 + 6.0 * ts_xyy_zzz[i] * gfe_0 + 6.0 * ts_xyy_yzzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyyy_zzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_xyyy_yz[i] * gfe_0 + 6.0 * ts_xyyy_yzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyyy_yzzz[i] * gfe_0 + ts_xyyy_yzzz[i] * rgc2_0;

        gr_xyyy_zzzz[i] = 2.0 * ts_yyy_zzzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xy_zzzz[i] * gfe_0 + 6.0 * ts_xyy_zzzz[i] * gfe_0 * gc_y[i] + 12.0 * ts_xyyy_zz[i] * gfe_0 + 8.0 * ts_xyyy_zzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyyy_zzzz[i] * gfe_0 + ts_xyyy_zzzz[i] * rgc2_0;
    }
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        gr_xyyz_xxxx[i] = 8.0 * ts_yyz_xxx[i] * gfe_0 + 2.0 * ts_yyz_xxxx[i] * gfe_0 * gc_x[i] + 2.0 * ts_xz_xxxx[i] * gfe_0 + 4.0 * ts_xyz_xxxx[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyy_xxxx[i] * gfe_0 * gc_z[i] + 12.0 * ts_xyyz_xx[i] * gfe_0 + 8.0 * ts_xyyz_xxx[i] * gfe_0 * gc_x[i] + 3.0 * ts_xyyz_xxxx[i] * gfe_0 + ts_xyyz_xxxx[i] * rgc2_0;

        gr_xyyz_xxxy[i] = 6.0 * ts_yyz_xxy[i] * gfe_0 + 2.0 * ts_yyz_xxxy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xz_xxxy[i] * gfe_0 + 4.0 * ts_xyz_xxx[i] * gfe_0 + 4.0 * ts_xyz_xxxy[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyy_xxxy[i] * gfe_0 * gc_z[i] + 6.0 * ts_xyyz_xy[i] * gfe_0 + 6.0 * ts_xyyz_xxy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xyyz_xxx[i] * gfe_0 * gc_y[i] + 3.0 * ts_xyyz_xxxy[i] * gfe_0 + ts_xyyz_xxxy[i] * rgc2_0;

        gr_xyyz_xxxz[i] = 6.0 * ts_yyz_xxz[i] * gfe_0 + 2.0 * ts_yyz_xxxz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xz_xxxz[i] * gfe_0 + 4.0 * ts_xyz_xxxz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyy_xxx[i] * gfe_0 + 2.0 * ts_xyy_xxxz[i] * gfe_0 * gc_z[i] + 6.0 * ts_xyyz_xz[i] * gfe_0 + 6.0 * ts_xyyz_xxz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xyyz_xxx[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyyz_xxxz[i] * gfe_0 + ts_xyyz_xxxz[i] * rgc2_0;

        gr_xyyz_xxyy[i] = 4.0 * ts_yyz_xyy[i] * gfe_0 + 2.0 * ts_yyz_xxyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xz_xxyy[i] * gfe_0 + 8.0 * ts_xyz_xxy[i] * gfe_0 + 4.0 * ts_xyz_xxyy[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyy_xxyy[i] * gfe_0 * gc_z[i] + 2.0 * ts_xyyz_yy[i] * gfe_0 + 4.0 * ts_xyyz_xyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xyyz_xx[i] * gfe_0 + 4.0 * ts_xyyz_xxy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xyyz_xxyy[i] * gfe_0 + ts_xyyz_xxyy[i] * rgc2_0;

        gr_xyyz_xxyz[i] = 4.0 * ts_yyz_xyz[i] * gfe_0 + 2.0 * ts_yyz_xxyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xz_xxyz[i] * gfe_0 + 4.0 * ts_xyz_xxz[i] * gfe_0 + 4.0 * ts_xyz_xxyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyy_xxy[i] * gfe_0 + 2.0 * ts_xyy_xxyz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xyyz_yz[i] * gfe_0 + 4.0 * ts_xyyz_xyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xyyz_xxz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyyz_xxy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyyz_xxyz[i] * gfe_0 + ts_xyyz_xxyz[i] * rgc2_0;

        gr_xyyz_xxzz[i] = 4.0 * ts_yyz_xzz[i] * gfe_0 + 2.0 * ts_yyz_xxzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xz_xxzz[i] * gfe_0 + 4.0 * ts_xyz_xxzz[i] * gfe_0 * gc_y[i] + 4.0 * ts_xyy_xxz[i] * gfe_0 + 2.0 * ts_xyy_xxzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xyyz_zz[i] * gfe_0 + 4.0 * ts_xyyz_xzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xyyz_xx[i] * gfe_0 + 4.0 * ts_xyyz_xxz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyyz_xxzz[i] * gfe_0 + ts_xyyz_xxzz[i] * rgc2_0;

        gr_xyyz_xyyy[i] = 2.0 * ts_yyz_yyy[i] * gfe_0 + 2.0 * ts_yyz_xyyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xz_xyyy[i] * gfe_0 + 12.0 * ts_xyz_xyy[i] * gfe_0 + 4.0 * ts_xyz_xyyy[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyy_xyyy[i] * gfe_0 * gc_z[i] + 2.0 * ts_xyyz_yyy[i] * gfe_0 * gc_x[i] + 6.0 * ts_xyyz_xy[i] * gfe_0 + 6.0 * ts_xyyz_xyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xyyz_xyyy[i] * gfe_0 + ts_xyyz_xyyy[i] * rgc2_0;

        gr_xyyz_xyyz[i] = 2.0 * ts_yyz_yyz[i] * gfe_0 + 2.0 * ts_yyz_xyyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xz_xyyz[i] * gfe_0 + 8.0 * ts_xyz_xyz[i] * gfe_0 + 4.0 * ts_xyz_xyyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyy_xyy[i] * gfe_0 + 2.0 * ts_xyy_xyyz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xyyz_yyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xyyz_xz[i] * gfe_0 + 4.0 * ts_xyyz_xyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyyz_xyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyyz_xyyz[i] * gfe_0 + ts_xyyz_xyyz[i] * rgc2_0;

        gr_xyyz_xyzz[i] = 2.0 * ts_yyz_yzz[i] * gfe_0 + 2.0 * ts_yyz_xyzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xz_xyzz[i] * gfe_0 + 4.0 * ts_xyz_xzz[i] * gfe_0 + 4.0 * ts_xyz_xyzz[i] * gfe_0 * gc_y[i] + 4.0 * ts_xyy_xyz[i] * gfe_0 + 2.0 * ts_xyy_xyzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xyyz_yzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xyyz_xzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyyz_xy[i] * gfe_0 + 4.0 * ts_xyyz_xyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyyz_xyzz[i] * gfe_0 + ts_xyyz_xyzz[i] * rgc2_0;

        gr_xyyz_xzzz[i] = 2.0 * ts_yyz_zzz[i] * gfe_0 + 2.0 * ts_yyz_xzzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xz_xzzz[i] * gfe_0 + 4.0 * ts_xyz_xzzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_xyy_xzz[i] * gfe_0 + 2.0 * ts_xyy_xzzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xyyz_zzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xyyz_xz[i] * gfe_0 + 6.0 * ts_xyyz_xzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyyz_xzzz[i] * gfe_0 + ts_xyyz_xzzz[i] * rgc2_0;

        gr_xyyz_yyyy[i] = 2.0 * ts_yyz_yyyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xz_yyyy[i] * gfe_0 + 16.0 * ts_xyz_yyy[i] * gfe_0 + 4.0 * ts_xyz_yyyy[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyy_yyyy[i] * gfe_0 * gc_z[i] + 12.0 * ts_xyyz_yy[i] * gfe_0 + 8.0 * ts_xyyz_yyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xyyz_yyyy[i] * gfe_0 + ts_xyyz_yyyy[i] * rgc2_0;

        gr_xyyz_yyyz[i] = 2.0 * ts_yyz_yyyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xz_yyyz[i] * gfe_0 + 12.0 * ts_xyz_yyz[i] * gfe_0 + 4.0 * ts_xyz_yyyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyy_yyy[i] * gfe_0 + 2.0 * ts_xyy_yyyz[i] * gfe_0 * gc_z[i] + 6.0 * ts_xyyz_yz[i] * gfe_0 + 6.0 * ts_xyyz_yyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyyz_yyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyyz_yyyz[i] * gfe_0 + ts_xyyz_yyyz[i] * rgc2_0;

        gr_xyyz_yyzz[i] = 2.0 * ts_yyz_yyzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xz_yyzz[i] * gfe_0 + 8.0 * ts_xyz_yzz[i] * gfe_0 + 4.0 * ts_xyz_yyzz[i] * gfe_0 * gc_y[i] + 4.0 * ts_xyy_yyz[i] * gfe_0 + 2.0 * ts_xyy_yyzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xyyz_zz[i] * gfe_0 + 4.0 * ts_xyyz_yzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyyz_yy[i] * gfe_0 + 4.0 * ts_xyyz_yyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyyz_yyzz[i] * gfe_0 + ts_xyyz_yyzz[i] * rgc2_0;

        gr_xyyz_yzzz[i] = 2.0 * ts_yyz_yzzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xz_yzzz[i] * gfe_0 + 4.0 * ts_xyz_zzz[i] * gfe_0 + 4.0 * ts_xyz_yzzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_xyy_yzz[i] * gfe_0 + 2.0 * ts_xyy_yzzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xyyz_zzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_xyyz_yz[i] * gfe_0 + 6.0 * ts_xyyz_yzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyyz_yzzz[i] * gfe_0 + ts_xyyz_yzzz[i] * rgc2_0;

        gr_xyyz_zzzz[i] = 2.0 * ts_yyz_zzzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xz_zzzz[i] * gfe_0 + 4.0 * ts_xyz_zzzz[i] * gfe_0 * gc_y[i] + 8.0 * ts_xyy_zzz[i] * gfe_0 + 2.0 * ts_xyy_zzzz[i] * gfe_0 * gc_z[i] + 12.0 * ts_xyyz_zz[i] * gfe_0 + 8.0 * ts_xyyz_zzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyyz_zzzz[i] * gfe_0 + ts_xyyz_zzzz[i] * rgc2_0;
    }
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        gr_xyzz_xxxx[i] = 8.0 * ts_yzz_xxx[i] * gfe_0 + 2.0 * ts_yzz_xxxx[i] * gfe_0 * gc_x[i] + 2.0 * ts_xzz_xxxx[i] * gfe_0 * gc_y[i] + 2.0 * ts_xy_xxxx[i] * gfe_0 + 4.0 * ts_xyz_xxxx[i] * gfe_0 * gc_z[i] + 12.0 * ts_xyzz_xx[i] * gfe_0 + 8.0 * ts_xyzz_xxx[i] * gfe_0 * gc_x[i] + 3.0 * ts_xyzz_xxxx[i] * gfe_0 + ts_xyzz_xxxx[i] * rgc2_0;

        gr_xyzz_xxxy[i] = 6.0 * ts_yzz_xxy[i] * gfe_0 + 2.0 * ts_yzz_xxxy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xzz_xxx[i] * gfe_0 + 2.0 * ts_xzz_xxxy[i] * gfe_0 * gc_y[i] + 2.0 * ts_xy_xxxy[i] * gfe_0 + 4.0 * ts_xyz_xxxy[i] * gfe_0 * gc_z[i] + 6.0 * ts_xyzz_xy[i] * gfe_0 + 6.0 * ts_xyzz_xxy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xyzz_xxx[i] * gfe_0 * gc_y[i] + 3.0 * ts_xyzz_xxxy[i] * gfe_0 + ts_xyzz_xxxy[i] * rgc2_0;

        gr_xyzz_xxxz[i] = 6.0 * ts_yzz_xxz[i] * gfe_0 + 2.0 * ts_yzz_xxxz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xzz_xxxz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xy_xxxz[i] * gfe_0 + 4.0 * ts_xyz_xxx[i] * gfe_0 + 4.0 * ts_xyz_xxxz[i] * gfe_0 * gc_z[i] + 6.0 * ts_xyzz_xz[i] * gfe_0 + 6.0 * ts_xyzz_xxz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xyzz_xxx[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyzz_xxxz[i] * gfe_0 + ts_xyzz_xxxz[i] * rgc2_0;

        gr_xyzz_xxyy[i] = 4.0 * ts_yzz_xyy[i] * gfe_0 + 2.0 * ts_yzz_xxyy[i] * gfe_0 * gc_x[i] + 4.0 * ts_xzz_xxy[i] * gfe_0 + 2.0 * ts_xzz_xxyy[i] * gfe_0 * gc_y[i] + 2.0 * ts_xy_xxyy[i] * gfe_0 + 4.0 * ts_xyz_xxyy[i] * gfe_0 * gc_z[i] + 2.0 * ts_xyzz_yy[i] * gfe_0 + 4.0 * ts_xyzz_xyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xyzz_xx[i] * gfe_0 + 4.0 * ts_xyzz_xxy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xyzz_xxyy[i] * gfe_0 + ts_xyzz_xxyy[i] * rgc2_0;

        gr_xyzz_xxyz[i] = 4.0 * ts_yzz_xyz[i] * gfe_0 + 2.0 * ts_yzz_xxyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xzz_xxz[i] * gfe_0 + 2.0 * ts_xzz_xxyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xy_xxyz[i] * gfe_0 + 4.0 * ts_xyz_xxy[i] * gfe_0 + 4.0 * ts_xyz_xxyz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xyzz_yz[i] * gfe_0 + 4.0 * ts_xyzz_xyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xyzz_xxz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyzz_xxy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyzz_xxyz[i] * gfe_0 + ts_xyzz_xxyz[i] * rgc2_0;

        gr_xyzz_xxzz[i] = 4.0 * ts_yzz_xzz[i] * gfe_0 + 2.0 * ts_yzz_xxzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xzz_xxzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xy_xxzz[i] * gfe_0 + 8.0 * ts_xyz_xxz[i] * gfe_0 + 4.0 * ts_xyz_xxzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xyzz_zz[i] * gfe_0 + 4.0 * ts_xyzz_xzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xyzz_xx[i] * gfe_0 + 4.0 * ts_xyzz_xxz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyzz_xxzz[i] * gfe_0 + ts_xyzz_xxzz[i] * rgc2_0;

        gr_xyzz_xyyy[i] = 2.0 * ts_yzz_yyy[i] * gfe_0 + 2.0 * ts_yzz_xyyy[i] * gfe_0 * gc_x[i] + 6.0 * ts_xzz_xyy[i] * gfe_0 + 2.0 * ts_xzz_xyyy[i] * gfe_0 * gc_y[i] + 2.0 * ts_xy_xyyy[i] * gfe_0 + 4.0 * ts_xyz_xyyy[i] * gfe_0 * gc_z[i] + 2.0 * ts_xyzz_yyy[i] * gfe_0 * gc_x[i] + 6.0 * ts_xyzz_xy[i] * gfe_0 + 6.0 * ts_xyzz_xyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xyzz_xyyy[i] * gfe_0 + ts_xyzz_xyyy[i] * rgc2_0;

        gr_xyzz_xyyz[i] = 2.0 * ts_yzz_yyz[i] * gfe_0 + 2.0 * ts_yzz_xyyz[i] * gfe_0 * gc_x[i] + 4.0 * ts_xzz_xyz[i] * gfe_0 + 2.0 * ts_xzz_xyyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xy_xyyz[i] * gfe_0 + 4.0 * ts_xyz_xyy[i] * gfe_0 + 4.0 * ts_xyz_xyyz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xyzz_yyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xyzz_xz[i] * gfe_0 + 4.0 * ts_xyzz_xyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyzz_xyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyzz_xyyz[i] * gfe_0 + ts_xyzz_xyyz[i] * rgc2_0;

        gr_xyzz_xyzz[i] = 2.0 * ts_yzz_yzz[i] * gfe_0 + 2.0 * ts_yzz_xyzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xzz_xzz[i] * gfe_0 + 2.0 * ts_xzz_xyzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xy_xyzz[i] * gfe_0 + 8.0 * ts_xyz_xyz[i] * gfe_0 + 4.0 * ts_xyz_xyzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xyzz_yzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xyzz_xzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyzz_xy[i] * gfe_0 + 4.0 * ts_xyzz_xyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyzz_xyzz[i] * gfe_0 + ts_xyzz_xyzz[i] * rgc2_0;

        gr_xyzz_xzzz[i] = 2.0 * ts_yzz_zzz[i] * gfe_0 + 2.0 * ts_yzz_xzzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xzz_xzzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xy_xzzz[i] * gfe_0 + 12.0 * ts_xyz_xzz[i] * gfe_0 + 4.0 * ts_xyz_xzzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xyzz_zzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xyzz_xz[i] * gfe_0 + 6.0 * ts_xyzz_xzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyzz_xzzz[i] * gfe_0 + ts_xyzz_xzzz[i] * rgc2_0;

        gr_xyzz_yyyy[i] = 2.0 * ts_yzz_yyyy[i] * gfe_0 * gc_x[i] + 8.0 * ts_xzz_yyy[i] * gfe_0 + 2.0 * ts_xzz_yyyy[i] * gfe_0 * gc_y[i] + 2.0 * ts_xy_yyyy[i] * gfe_0 + 4.0 * ts_xyz_yyyy[i] * gfe_0 * gc_z[i] + 12.0 * ts_xyzz_yy[i] * gfe_0 + 8.0 * ts_xyzz_yyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xyzz_yyyy[i] * gfe_0 + ts_xyzz_yyyy[i] * rgc2_0;

        gr_xyzz_yyyz[i] = 2.0 * ts_yzz_yyyz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xzz_yyz[i] * gfe_0 + 2.0 * ts_xzz_yyyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xy_yyyz[i] * gfe_0 + 4.0 * ts_xyz_yyy[i] * gfe_0 + 4.0 * ts_xyz_yyyz[i] * gfe_0 * gc_z[i] + 6.0 * ts_xyzz_yz[i] * gfe_0 + 6.0 * ts_xyzz_yyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyzz_yyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyzz_yyyz[i] * gfe_0 + ts_xyzz_yyyz[i] * rgc2_0;

        gr_xyzz_yyzz[i] = 2.0 * ts_yzz_yyzz[i] * gfe_0 * gc_x[i] + 4.0 * ts_xzz_yzz[i] * gfe_0 + 2.0 * ts_xzz_yyzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xy_yyzz[i] * gfe_0 + 8.0 * ts_xyz_yyz[i] * gfe_0 + 4.0 * ts_xyz_yyzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xyzz_zz[i] * gfe_0 + 4.0 * ts_xyzz_yzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xyzz_yy[i] * gfe_0 + 4.0 * ts_xyzz_yyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyzz_yyzz[i] * gfe_0 + ts_xyzz_yyzz[i] * rgc2_0;

        gr_xyzz_yzzz[i] = 2.0 * ts_yzz_yzzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xzz_zzz[i] * gfe_0 + 2.0 * ts_xzz_yzzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xy_yzzz[i] * gfe_0 + 12.0 * ts_xyz_yzz[i] * gfe_0 + 4.0 * ts_xyz_yzzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xyzz_zzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_xyzz_yz[i] * gfe_0 + 6.0 * ts_xyzz_yzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyzz_yzzz[i] * gfe_0 + ts_xyzz_yzzz[i] * rgc2_0;

        gr_xyzz_zzzz[i] = 2.0 * ts_yzz_zzzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xzz_zzzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xy_zzzz[i] * gfe_0 + 16.0 * ts_xyz_zzz[i] * gfe_0 + 4.0 * ts_xyz_zzzz[i] * gfe_0 * gc_z[i] + 12.0 * ts_xyzz_zz[i] * gfe_0 + 8.0 * ts_xyzz_zzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xyzz_zzzz[i] * gfe_0 + ts_xyzz_zzzz[i] * rgc2_0;
    }
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        gr_xzzz_xxxx[i] = 8.0 * ts_zzz_xxx[i] * gfe_0 + 2.0 * ts_zzz_xxxx[i] * gfe_0 * gc_x[i] + 6.0 * ts_xz_xxxx[i] * gfe_0 + 6.0 * ts_xzz_xxxx[i] * gfe_0 * gc_z[i] + 12.0 * ts_xzzz_xx[i] * gfe_0 + 8.0 * ts_xzzz_xxx[i] * gfe_0 * gc_x[i] + 3.0 * ts_xzzz_xxxx[i] * gfe_0 + ts_xzzz_xxxx[i] * rgc2_0;

        gr_xzzz_xxxy[i] = 6.0 * ts_zzz_xxy[i] * gfe_0 + 2.0 * ts_zzz_xxxy[i] * gfe_0 * gc_x[i] + 6.0 * ts_xz_xxxy[i] * gfe_0 + 6.0 * ts_xzz_xxxy[i] * gfe_0 * gc_z[i] + 6.0 * ts_xzzz_xy[i] * gfe_0 + 6.0 * ts_xzzz_xxy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xzzz_xxx[i] * gfe_0 * gc_y[i] + 3.0 * ts_xzzz_xxxy[i] * gfe_0 + ts_xzzz_xxxy[i] * rgc2_0;

        gr_xzzz_xxxz[i] = 6.0 * ts_zzz_xxz[i] * gfe_0 + 2.0 * ts_zzz_xxxz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xz_xxxz[i] * gfe_0 + 6.0 * ts_xzz_xxx[i] * gfe_0 + 6.0 * ts_xzz_xxxz[i] * gfe_0 * gc_z[i] + 6.0 * ts_xzzz_xz[i] * gfe_0 + 6.0 * ts_xzzz_xxz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xzzz_xxx[i] * gfe_0 * gc_z[i] + 3.0 * ts_xzzz_xxxz[i] * gfe_0 + ts_xzzz_xxxz[i] * rgc2_0;

        gr_xzzz_xxyy[i] = 4.0 * ts_zzz_xyy[i] * gfe_0 + 2.0 * ts_zzz_xxyy[i] * gfe_0 * gc_x[i] + 6.0 * ts_xz_xxyy[i] * gfe_0 + 6.0 * ts_xzz_xxyy[i] * gfe_0 * gc_z[i] + 2.0 * ts_xzzz_yy[i] * gfe_0 + 4.0 * ts_xzzz_xyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_xzzz_xx[i] * gfe_0 + 4.0 * ts_xzzz_xxy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xzzz_xxyy[i] * gfe_0 + ts_xzzz_xxyy[i] * rgc2_0;

        gr_xzzz_xxyz[i] = 4.0 * ts_zzz_xyz[i] * gfe_0 + 2.0 * ts_zzz_xxyz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xz_xxyz[i] * gfe_0 + 6.0 * ts_xzz_xxy[i] * gfe_0 + 6.0 * ts_xzz_xxyz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xzzz_yz[i] * gfe_0 + 4.0 * ts_xzzz_xyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xzzz_xxz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xzzz_xxy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xzzz_xxyz[i] * gfe_0 + ts_xzzz_xxyz[i] * rgc2_0;

        gr_xzzz_xxzz[i] = 4.0 * ts_zzz_xzz[i] * gfe_0 + 2.0 * ts_zzz_xxzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xz_xxzz[i] * gfe_0 + 12.0 * ts_xzz_xxz[i] * gfe_0 + 6.0 * ts_xzz_xxzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xzzz_zz[i] * gfe_0 + 4.0 * ts_xzzz_xzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xzzz_xx[i] * gfe_0 + 4.0 * ts_xzzz_xxz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xzzz_xxzz[i] * gfe_0 + ts_xzzz_xxzz[i] * rgc2_0;

        gr_xzzz_xyyy[i] = 2.0 * ts_zzz_yyy[i] * gfe_0 + 2.0 * ts_zzz_xyyy[i] * gfe_0 * gc_x[i] + 6.0 * ts_xz_xyyy[i] * gfe_0 + 6.0 * ts_xzz_xyyy[i] * gfe_0 * gc_z[i] + 2.0 * ts_xzzz_yyy[i] * gfe_0 * gc_x[i] + 6.0 * ts_xzzz_xy[i] * gfe_0 + 6.0 * ts_xzzz_xyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xzzz_xyyy[i] * gfe_0 + ts_xzzz_xyyy[i] * rgc2_0;

        gr_xzzz_xyyz[i] = 2.0 * ts_zzz_yyz[i] * gfe_0 + 2.0 * ts_zzz_xyyz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xz_xyyz[i] * gfe_0 + 6.0 * ts_xzz_xyy[i] * gfe_0 + 6.0 * ts_xzz_xyyz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xzzz_yyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xzzz_xz[i] * gfe_0 + 4.0 * ts_xzzz_xyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xzzz_xyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xzzz_xyyz[i] * gfe_0 + ts_xzzz_xyyz[i] * rgc2_0;

        gr_xzzz_xyzz[i] = 2.0 * ts_zzz_yzz[i] * gfe_0 + 2.0 * ts_zzz_xyzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xz_xyzz[i] * gfe_0 + 12.0 * ts_xzz_xyz[i] * gfe_0 + 6.0 * ts_xzz_xyzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xzzz_yzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_xzzz_xzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xzzz_xy[i] * gfe_0 + 4.0 * ts_xzzz_xyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xzzz_xyzz[i] * gfe_0 + ts_xzzz_xyzz[i] * rgc2_0;

        gr_xzzz_xzzz[i] = 2.0 * ts_zzz_zzz[i] * gfe_0 + 2.0 * ts_zzz_xzzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xz_xzzz[i] * gfe_0 + 18.0 * ts_xzz_xzz[i] * gfe_0 + 6.0 * ts_xzz_xzzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xzzz_zzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xzzz_xz[i] * gfe_0 + 6.0 * ts_xzzz_xzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xzzz_xzzz[i] * gfe_0 + ts_xzzz_xzzz[i] * rgc2_0;

        gr_xzzz_yyyy[i] = 2.0 * ts_zzz_yyyy[i] * gfe_0 * gc_x[i] + 6.0 * ts_xz_yyyy[i] * gfe_0 + 6.0 * ts_xzz_yyyy[i] * gfe_0 * gc_z[i] + 12.0 * ts_xzzz_yy[i] * gfe_0 + 8.0 * ts_xzzz_yyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_xzzz_yyyy[i] * gfe_0 + ts_xzzz_yyyy[i] * rgc2_0;

        gr_xzzz_yyyz[i] = 2.0 * ts_zzz_yyyz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xz_yyyz[i] * gfe_0 + 6.0 * ts_xzz_yyy[i] * gfe_0 + 6.0 * ts_xzz_yyyz[i] * gfe_0 * gc_z[i] + 6.0 * ts_xzzz_yz[i] * gfe_0 + 6.0 * ts_xzzz_yyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xzzz_yyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_xzzz_yyyz[i] * gfe_0 + ts_xzzz_yyyz[i] * rgc2_0;

        gr_xzzz_yyzz[i] = 2.0 * ts_zzz_yyzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xz_yyzz[i] * gfe_0 + 12.0 * ts_xzz_yyz[i] * gfe_0 + 6.0 * ts_xzz_yyzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xzzz_zz[i] * gfe_0 + 4.0 * ts_xzzz_yzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_xzzz_yy[i] * gfe_0 + 4.0 * ts_xzzz_yyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xzzz_yyzz[i] * gfe_0 + ts_xzzz_yyzz[i] * rgc2_0;

        gr_xzzz_yzzz[i] = 2.0 * ts_zzz_yzzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xz_yzzz[i] * gfe_0 + 18.0 * ts_xzz_yzz[i] * gfe_0 + 6.0 * ts_xzz_yzzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_xzzz_zzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_xzzz_yz[i] * gfe_0 + 6.0 * ts_xzzz_yzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xzzz_yzzz[i] * gfe_0 + ts_xzzz_yzzz[i] * rgc2_0;

        gr_xzzz_zzzz[i] = 2.0 * ts_zzz_zzzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_xz_zzzz[i] * gfe_0 + 24.0 * ts_xzz_zzz[i] * gfe_0 + 6.0 * ts_xzz_zzzz[i] * gfe_0 * gc_z[i] + 12.0 * ts_xzzz_zz[i] * gfe_0 + 8.0 * ts_xzzz_zzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_xzzz_zzzz[i] * gfe_0 + ts_xzzz_zzzz[i] * rgc2_0;
    }
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        gr_yyyy_xxxx[i] = 12.0 * ts_yy_xxxx[i] * gfe_0 + 8.0 * ts_yyy_xxxx[i] * gfe_0 * gc_y[i] + 12.0 * ts_yyyy_xx[i] * gfe_0 + 8.0 * ts_yyyy_xxx[i] * gfe_0 * gc_x[i] + 3.0 * ts_yyyy_xxxx[i] * gfe_0 + ts_yyyy_xxxx[i] * rgc2_0;

        gr_yyyy_xxxy[i] = 12.0 * ts_yy_xxxy[i] * gfe_0 + 8.0 * ts_yyy_xxx[i] * gfe_0 + 8.0 * ts_yyy_xxxy[i] * gfe_0 * gc_y[i] + 6.0 * ts_yyyy_xy[i] * gfe_0 + 6.0 * ts_yyyy_xxy[i] * gfe_0 * gc_x[i] + 2.0 * ts_yyyy_xxx[i] * gfe_0 * gc_y[i] + 3.0 * ts_yyyy_xxxy[i] * gfe_0 + ts_yyyy_xxxy[i] * rgc2_0;

        gr_yyyy_xxxz[i] = 12.0 * ts_yy_xxxz[i] * gfe_0 + 8.0 * ts_yyy_xxxz[i] * gfe_0 * gc_y[i] + 6.0 * ts_yyyy_xz[i] * gfe_0 + 6.0 * ts_yyyy_xxz[i] * gfe_0 * gc_x[i] + 2.0 * ts_yyyy_xxx[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyyy_xxxz[i] * gfe_0 + ts_yyyy_xxxz[i] * rgc2_0;

        gr_yyyy_xxyy[i] = 12.0 * ts_yy_xxyy[i] * gfe_0 + 16.0 * ts_yyy_xxy[i] * gfe_0 + 8.0 * ts_yyy_xxyy[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyyy_yy[i] * gfe_0 + 4.0 * ts_yyyy_xyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_yyyy_xx[i] * gfe_0 + 4.0 * ts_yyyy_xxy[i] * gfe_0 * gc_y[i] + 3.0 * ts_yyyy_xxyy[i] * gfe_0 + ts_yyyy_xxyy[i] * rgc2_0;

        gr_yyyy_xxyz[i] = 12.0 * ts_yy_xxyz[i] * gfe_0 + 8.0 * ts_yyy_xxz[i] * gfe_0 + 8.0 * ts_yyy_xxyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyyy_yz[i] * gfe_0 + 4.0 * ts_yyyy_xyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_yyyy_xxz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyyy_xxy[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyyy_xxyz[i] * gfe_0 + ts_yyyy_xxyz[i] * rgc2_0;

        gr_yyyy_xxzz[i] = 12.0 * ts_yy_xxzz[i] * gfe_0 + 8.0 * ts_yyy_xxzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyyy_zz[i] * gfe_0 + 4.0 * ts_yyyy_xzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_yyyy_xx[i] * gfe_0 + 4.0 * ts_yyyy_xxz[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyyy_xxzz[i] * gfe_0 + ts_yyyy_xxzz[i] * rgc2_0;

        gr_yyyy_xyyy[i] = 12.0 * ts_yy_xyyy[i] * gfe_0 + 24.0 * ts_yyy_xyy[i] * gfe_0 + 8.0 * ts_yyy_xyyy[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyyy_yyy[i] * gfe_0 * gc_x[i] + 6.0 * ts_yyyy_xy[i] * gfe_0 + 6.0 * ts_yyyy_xyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_yyyy_xyyy[i] * gfe_0 + ts_yyyy_xyyy[i] * rgc2_0;

        gr_yyyy_xyyz[i] = 12.0 * ts_yy_xyyz[i] * gfe_0 + 16.0 * ts_yyy_xyz[i] * gfe_0 + 8.0 * ts_yyy_xyyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyyy_yyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_yyyy_xz[i] * gfe_0 + 4.0 * ts_yyyy_xyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyyy_xyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyyy_xyyz[i] * gfe_0 + ts_yyyy_xyyz[i] * rgc2_0;

        gr_yyyy_xyzz[i] = 12.0 * ts_yy_xyzz[i] * gfe_0 + 8.0 * ts_yyy_xzz[i] * gfe_0 + 8.0 * ts_yyy_xyzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyyy_yzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_yyyy_xzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyyy_xy[i] * gfe_0 + 4.0 * ts_yyyy_xyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyyy_xyzz[i] * gfe_0 + ts_yyyy_xyzz[i] * rgc2_0;

        gr_yyyy_xzzz[i] = 12.0 * ts_yy_xzzz[i] * gfe_0 + 8.0 * ts_yyy_xzzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyyy_zzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_yyyy_xz[i] * gfe_0 + 6.0 * ts_yyyy_xzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyyy_xzzz[i] * gfe_0 + ts_yyyy_xzzz[i] * rgc2_0;

        gr_yyyy_yyyy[i] = 12.0 * ts_yy_yyyy[i] * gfe_0 + 32.0 * ts_yyy_yyy[i] * gfe_0 + 8.0 * ts_yyy_yyyy[i] * gfe_0 * gc_y[i] + 12.0 * ts_yyyy_yy[i] * gfe_0 + 8.0 * ts_yyyy_yyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_yyyy_yyyy[i] * gfe_0 + ts_yyyy_yyyy[i] * rgc2_0;

        gr_yyyy_yyyz[i] = 12.0 * ts_yy_yyyz[i] * gfe_0 + 24.0 * ts_yyy_yyz[i] * gfe_0 + 8.0 * ts_yyy_yyyz[i] * gfe_0 * gc_y[i] + 6.0 * ts_yyyy_yz[i] * gfe_0 + 6.0 * ts_yyyy_yyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyyy_yyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyyy_yyyz[i] * gfe_0 + ts_yyyy_yyyz[i] * rgc2_0;

        gr_yyyy_yyzz[i] = 12.0 * ts_yy_yyzz[i] * gfe_0 + 16.0 * ts_yyy_yzz[i] * gfe_0 + 8.0 * ts_yyy_yyzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyyy_zz[i] * gfe_0 + 4.0 * ts_yyyy_yzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyyy_yy[i] * gfe_0 + 4.0 * ts_yyyy_yyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyyy_yyzz[i] * gfe_0 + ts_yyyy_yyzz[i] * rgc2_0;

        gr_yyyy_yzzz[i] = 12.0 * ts_yy_yzzz[i] * gfe_0 + 8.0 * ts_yyy_zzz[i] * gfe_0 + 8.0 * ts_yyy_yzzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyyy_zzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_yyyy_yz[i] * gfe_0 + 6.0 * ts_yyyy_yzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyyy_yzzz[i] * gfe_0 + ts_yyyy_yzzz[i] * rgc2_0;

        gr_yyyy_zzzz[i] = 12.0 * ts_yy_zzzz[i] * gfe_0 + 8.0 * ts_yyy_zzzz[i] * gfe_0 * gc_y[i] + 12.0 * ts_yyyy_zz[i] * gfe_0 + 8.0 * ts_yyyy_zzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyyy_zzzz[i] * gfe_0 + ts_yyyy_zzzz[i] * rgc2_0;
    }
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        gr_yyyz_xxxx[i] = 6.0 * ts_yz_xxxx[i] * gfe_0 + 6.0 * ts_yyz_xxxx[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyy_xxxx[i] * gfe_0 * gc_z[i] + 12.0 * ts_yyyz_xx[i] * gfe_0 + 8.0 * ts_yyyz_xxx[i] * gfe_0 * gc_x[i] + 3.0 * ts_yyyz_xxxx[i] * gfe_0 + ts_yyyz_xxxx[i] * rgc2_0;

        gr_yyyz_xxxy[i] = 6.0 * ts_yz_xxxy[i] * gfe_0 + 6.0 * ts_yyz_xxx[i] * gfe_0 + 6.0 * ts_yyz_xxxy[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyy_xxxy[i] * gfe_0 * gc_z[i] + 6.0 * ts_yyyz_xy[i] * gfe_0 + 6.0 * ts_yyyz_xxy[i] * gfe_0 * gc_x[i] + 2.0 * ts_yyyz_xxx[i] * gfe_0 * gc_y[i] + 3.0 * ts_yyyz_xxxy[i] * gfe_0 + ts_yyyz_xxxy[i] * rgc2_0;

        gr_yyyz_xxxz[i] = 6.0 * ts_yz_xxxz[i] * gfe_0 + 6.0 * ts_yyz_xxxz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyy_xxx[i] * gfe_0 + 2.0 * ts_yyy_xxxz[i] * gfe_0 * gc_z[i] + 6.0 * ts_yyyz_xz[i] * gfe_0 + 6.0 * ts_yyyz_xxz[i] * gfe_0 * gc_x[i] + 2.0 * ts_yyyz_xxx[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyyz_xxxz[i] * gfe_0 + ts_yyyz_xxxz[i] * rgc2_0;

        gr_yyyz_xxyy[i] = 6.0 * ts_yz_xxyy[i] * gfe_0 + 12.0 * ts_yyz_xxy[i] * gfe_0 + 6.0 * ts_yyz_xxyy[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyy_xxyy[i] * gfe_0 * gc_z[i] + 2.0 * ts_yyyz_yy[i] * gfe_0 + 4.0 * ts_yyyz_xyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_yyyz_xx[i] * gfe_0 + 4.0 * ts_yyyz_xxy[i] * gfe_0 * gc_y[i] + 3.0 * ts_yyyz_xxyy[i] * gfe_0 + ts_yyyz_xxyy[i] * rgc2_0;

        gr_yyyz_xxyz[i] = 6.0 * ts_yz_xxyz[i] * gfe_0 + 6.0 * ts_yyz_xxz[i] * gfe_0 + 6.0 * ts_yyz_xxyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyy_xxy[i] * gfe_0 + 2.0 * ts_yyy_xxyz[i] * gfe_0 * gc_z[i] + 2.0 * ts_yyyz_yz[i] * gfe_0 + 4.0 * ts_yyyz_xyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_yyyz_xxz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyyz_xxy[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyyz_xxyz[i] * gfe_0 + ts_yyyz_xxyz[i] * rgc2_0;

        gr_yyyz_xxzz[i] = 6.0 * ts_yz_xxzz[i] * gfe_0 + 6.0 * ts_yyz_xxzz[i] * gfe_0 * gc_y[i] + 4.0 * ts_yyy_xxz[i] * gfe_0 + 2.0 * ts_yyy_xxzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_yyyz_zz[i] * gfe_0 + 4.0 * ts_yyyz_xzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_yyyz_xx[i] * gfe_0 + 4.0 * ts_yyyz_xxz[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyyz_xxzz[i] * gfe_0 + ts_yyyz_xxzz[i] * rgc2_0;

        gr_yyyz_xyyy[i] = 6.0 * ts_yz_xyyy[i] * gfe_0 + 18.0 * ts_yyz_xyy[i] * gfe_0 + 6.0 * ts_yyz_xyyy[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyy_xyyy[i] * gfe_0 * gc_z[i] + 2.0 * ts_yyyz_yyy[i] * gfe_0 * gc_x[i] + 6.0 * ts_yyyz_xy[i] * gfe_0 + 6.0 * ts_yyyz_xyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_yyyz_xyyy[i] * gfe_0 + ts_yyyz_xyyy[i] * rgc2_0;

        gr_yyyz_xyyz[i] = 6.0 * ts_yz_xyyz[i] * gfe_0 + 12.0 * ts_yyz_xyz[i] * gfe_0 + 6.0 * ts_yyz_xyyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyy_xyy[i] * gfe_0 + 2.0 * ts_yyy_xyyz[i] * gfe_0 * gc_z[i] + 2.0 * ts_yyyz_yyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_yyyz_xz[i] * gfe_0 + 4.0 * ts_yyyz_xyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyyz_xyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyyz_xyyz[i] * gfe_0 + ts_yyyz_xyyz[i] * rgc2_0;

        gr_yyyz_xyzz[i] = 6.0 * ts_yz_xyzz[i] * gfe_0 + 6.0 * ts_yyz_xzz[i] * gfe_0 + 6.0 * ts_yyz_xyzz[i] * gfe_0 * gc_y[i] + 4.0 * ts_yyy_xyz[i] * gfe_0 + 2.0 * ts_yyy_xyzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_yyyz_yzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_yyyz_xzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyyz_xy[i] * gfe_0 + 4.0 * ts_yyyz_xyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyyz_xyzz[i] * gfe_0 + ts_yyyz_xyzz[i] * rgc2_0;

        gr_yyyz_xzzz[i] = 6.0 * ts_yz_xzzz[i] * gfe_0 + 6.0 * ts_yyz_xzzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_yyy_xzz[i] * gfe_0 + 2.0 * ts_yyy_xzzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_yyyz_zzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_yyyz_xz[i] * gfe_0 + 6.0 * ts_yyyz_xzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyyz_xzzz[i] * gfe_0 + ts_yyyz_xzzz[i] * rgc2_0;

        gr_yyyz_yyyy[i] = 6.0 * ts_yz_yyyy[i] * gfe_0 + 24.0 * ts_yyz_yyy[i] * gfe_0 + 6.0 * ts_yyz_yyyy[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyy_yyyy[i] * gfe_0 * gc_z[i] + 12.0 * ts_yyyz_yy[i] * gfe_0 + 8.0 * ts_yyyz_yyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_yyyz_yyyy[i] * gfe_0 + ts_yyyz_yyyy[i] * rgc2_0;

        gr_yyyz_yyyz[i] = 6.0 * ts_yz_yyyz[i] * gfe_0 + 18.0 * ts_yyz_yyz[i] * gfe_0 + 6.0 * ts_yyz_yyyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyy_yyy[i] * gfe_0 + 2.0 * ts_yyy_yyyz[i] * gfe_0 * gc_z[i] + 6.0 * ts_yyyz_yz[i] * gfe_0 + 6.0 * ts_yyyz_yyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyyz_yyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyyz_yyyz[i] * gfe_0 + ts_yyyz_yyyz[i] * rgc2_0;

        gr_yyyz_yyzz[i] = 6.0 * ts_yz_yyzz[i] * gfe_0 + 12.0 * ts_yyz_yzz[i] * gfe_0 + 6.0 * ts_yyz_yyzz[i] * gfe_0 * gc_y[i] + 4.0 * ts_yyy_yyz[i] * gfe_0 + 2.0 * ts_yyy_yyzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_yyyz_zz[i] * gfe_0 + 4.0 * ts_yyyz_yzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyyz_yy[i] * gfe_0 + 4.0 * ts_yyyz_yyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyyz_yyzz[i] * gfe_0 + ts_yyyz_yyzz[i] * rgc2_0;

        gr_yyyz_yzzz[i] = 6.0 * ts_yz_yzzz[i] * gfe_0 + 6.0 * ts_yyz_zzz[i] * gfe_0 + 6.0 * ts_yyz_yzzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_yyy_yzz[i] * gfe_0 + 2.0 * ts_yyy_yzzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_yyyz_zzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_yyyz_yz[i] * gfe_0 + 6.0 * ts_yyyz_yzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyyz_yzzz[i] * gfe_0 + ts_yyyz_yzzz[i] * rgc2_0;

        gr_yyyz_zzzz[i] = 6.0 * ts_yz_zzzz[i] * gfe_0 + 6.0 * ts_yyz_zzzz[i] * gfe_0 * gc_y[i] + 8.0 * ts_yyy_zzz[i] * gfe_0 + 2.0 * ts_yyy_zzzz[i] * gfe_0 * gc_z[i] + 12.0 * ts_yyyz_zz[i] * gfe_0 + 8.0 * ts_yyyz_zzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyyz_zzzz[i] * gfe_0 + ts_yyyz_zzzz[i] * rgc2_0;
    }
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        gr_yyzz_xxxx[i] = 2.0 * ts_zz_xxxx[i] * gfe_0 + 4.0 * ts_yzz_xxxx[i] * gfe_0 * gc_y[i] + 2.0 * ts_yy_xxxx[i] * gfe_0 + 4.0 * ts_yyz_xxxx[i] * gfe_0 * gc_z[i] + 12.0 * ts_yyzz_xx[i] * gfe_0 + 8.0 * ts_yyzz_xxx[i] * gfe_0 * gc_x[i] + 3.0 * ts_yyzz_xxxx[i] * gfe_0 + ts_yyzz_xxxx[i] * rgc2_0;

        gr_yyzz_xxxy[i] = 2.0 * ts_zz_xxxy[i] * gfe_0 + 4.0 * ts_yzz_xxx[i] * gfe_0 + 4.0 * ts_yzz_xxxy[i] * gfe_0 * gc_y[i] + 2.0 * ts_yy_xxxy[i] * gfe_0 + 4.0 * ts_yyz_xxxy[i] * gfe_0 * gc_z[i] + 6.0 * ts_yyzz_xy[i] * gfe_0 + 6.0 * ts_yyzz_xxy[i] * gfe_0 * gc_x[i] + 2.0 * ts_yyzz_xxx[i] * gfe_0 * gc_y[i] + 3.0 * ts_yyzz_xxxy[i] * gfe_0 + ts_yyzz_xxxy[i] * rgc2_0;

        gr_yyzz_xxxz[i] = 2.0 * ts_zz_xxxz[i] * gfe_0 + 4.0 * ts_yzz_xxxz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yy_xxxz[i] * gfe_0 + 4.0 * ts_yyz_xxx[i] * gfe_0 + 4.0 * ts_yyz_xxxz[i] * gfe_0 * gc_z[i] + 6.0 * ts_yyzz_xz[i] * gfe_0 + 6.0 * ts_yyzz_xxz[i] * gfe_0 * gc_x[i] + 2.0 * ts_yyzz_xxx[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyzz_xxxz[i] * gfe_0 + ts_yyzz_xxxz[i] * rgc2_0;

        gr_yyzz_xxyy[i] = 2.0 * ts_zz_xxyy[i] * gfe_0 + 8.0 * ts_yzz_xxy[i] * gfe_0 + 4.0 * ts_yzz_xxyy[i] * gfe_0 * gc_y[i] + 2.0 * ts_yy_xxyy[i] * gfe_0 + 4.0 * ts_yyz_xxyy[i] * gfe_0 * gc_z[i] + 2.0 * ts_yyzz_yy[i] * gfe_0 + 4.0 * ts_yyzz_xyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_yyzz_xx[i] * gfe_0 + 4.0 * ts_yyzz_xxy[i] * gfe_0 * gc_y[i] + 3.0 * ts_yyzz_xxyy[i] * gfe_0 + ts_yyzz_xxyy[i] * rgc2_0;

        gr_yyzz_xxyz[i] = 2.0 * ts_zz_xxyz[i] * gfe_0 + 4.0 * ts_yzz_xxz[i] * gfe_0 + 4.0 * ts_yzz_xxyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yy_xxyz[i] * gfe_0 + 4.0 * ts_yyz_xxy[i] * gfe_0 + 4.0 * ts_yyz_xxyz[i] * gfe_0 * gc_z[i] + 2.0 * ts_yyzz_yz[i] * gfe_0 + 4.0 * ts_yyzz_xyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_yyzz_xxz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyzz_xxy[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyzz_xxyz[i] * gfe_0 + ts_yyzz_xxyz[i] * rgc2_0;

        gr_yyzz_xxzz[i] = 2.0 * ts_zz_xxzz[i] * gfe_0 + 4.0 * ts_yzz_xxzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yy_xxzz[i] * gfe_0 + 8.0 * ts_yyz_xxz[i] * gfe_0 + 4.0 * ts_yyz_xxzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_yyzz_zz[i] * gfe_0 + 4.0 * ts_yyzz_xzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_yyzz_xx[i] * gfe_0 + 4.0 * ts_yyzz_xxz[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyzz_xxzz[i] * gfe_0 + ts_yyzz_xxzz[i] * rgc2_0;

        gr_yyzz_xyyy[i] = 2.0 * ts_zz_xyyy[i] * gfe_0 + 12.0 * ts_yzz_xyy[i] * gfe_0 + 4.0 * ts_yzz_xyyy[i] * gfe_0 * gc_y[i] + 2.0 * ts_yy_xyyy[i] * gfe_0 + 4.0 * ts_yyz_xyyy[i] * gfe_0 * gc_z[i] + 2.0 * ts_yyzz_yyy[i] * gfe_0 * gc_x[i] + 6.0 * ts_yyzz_xy[i] * gfe_0 + 6.0 * ts_yyzz_xyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_yyzz_xyyy[i] * gfe_0 + ts_yyzz_xyyy[i] * rgc2_0;

        gr_yyzz_xyyz[i] = 2.0 * ts_zz_xyyz[i] * gfe_0 + 8.0 * ts_yzz_xyz[i] * gfe_0 + 4.0 * ts_yzz_xyyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yy_xyyz[i] * gfe_0 + 4.0 * ts_yyz_xyy[i] * gfe_0 + 4.0 * ts_yyz_xyyz[i] * gfe_0 * gc_z[i] + 2.0 * ts_yyzz_yyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_yyzz_xz[i] * gfe_0 + 4.0 * ts_yyzz_xyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyzz_xyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyzz_xyyz[i] * gfe_0 + ts_yyzz_xyyz[i] * rgc2_0;

        gr_yyzz_xyzz[i] = 2.0 * ts_zz_xyzz[i] * gfe_0 + 4.0 * ts_yzz_xzz[i] * gfe_0 + 4.0 * ts_yzz_xyzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yy_xyzz[i] * gfe_0 + 8.0 * ts_yyz_xyz[i] * gfe_0 + 4.0 * ts_yyz_xyzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_yyzz_yzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_yyzz_xzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyzz_xy[i] * gfe_0 + 4.0 * ts_yyzz_xyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyzz_xyzz[i] * gfe_0 + ts_yyzz_xyzz[i] * rgc2_0;

        gr_yyzz_xzzz[i] = 2.0 * ts_zz_xzzz[i] * gfe_0 + 4.0 * ts_yzz_xzzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yy_xzzz[i] * gfe_0 + 12.0 * ts_yyz_xzz[i] * gfe_0 + 4.0 * ts_yyz_xzzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_yyzz_zzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_yyzz_xz[i] * gfe_0 + 6.0 * ts_yyzz_xzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyzz_xzzz[i] * gfe_0 + ts_yyzz_xzzz[i] * rgc2_0;

        gr_yyzz_yyyy[i] = 2.0 * ts_zz_yyyy[i] * gfe_0 + 16.0 * ts_yzz_yyy[i] * gfe_0 + 4.0 * ts_yzz_yyyy[i] * gfe_0 * gc_y[i] + 2.0 * ts_yy_yyyy[i] * gfe_0 + 4.0 * ts_yyz_yyyy[i] * gfe_0 * gc_z[i] + 12.0 * ts_yyzz_yy[i] * gfe_0 + 8.0 * ts_yyzz_yyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_yyzz_yyyy[i] * gfe_0 + ts_yyzz_yyyy[i] * rgc2_0;

        gr_yyzz_yyyz[i] = 2.0 * ts_zz_yyyz[i] * gfe_0 + 12.0 * ts_yzz_yyz[i] * gfe_0 + 4.0 * ts_yzz_yyyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yy_yyyz[i] * gfe_0 + 4.0 * ts_yyz_yyy[i] * gfe_0 + 4.0 * ts_yyz_yyyz[i] * gfe_0 * gc_z[i] + 6.0 * ts_yyzz_yz[i] * gfe_0 + 6.0 * ts_yyzz_yyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyzz_yyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyzz_yyyz[i] * gfe_0 + ts_yyzz_yyyz[i] * rgc2_0;

        gr_yyzz_yyzz[i] = 2.0 * ts_zz_yyzz[i] * gfe_0 + 8.0 * ts_yzz_yzz[i] * gfe_0 + 4.0 * ts_yzz_yyzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yy_yyzz[i] * gfe_0 + 8.0 * ts_yyz_yyz[i] * gfe_0 + 4.0 * ts_yyz_yyzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_yyzz_zz[i] * gfe_0 + 4.0 * ts_yyzz_yzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yyzz_yy[i] * gfe_0 + 4.0 * ts_yyzz_yyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyzz_yyzz[i] * gfe_0 + ts_yyzz_yyzz[i] * rgc2_0;

        gr_yyzz_yzzz[i] = 2.0 * ts_zz_yzzz[i] * gfe_0 + 4.0 * ts_yzz_zzz[i] * gfe_0 + 4.0 * ts_yzz_yzzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yy_yzzz[i] * gfe_0 + 12.0 * ts_yyz_yzz[i] * gfe_0 + 4.0 * ts_yyz_yzzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_yyzz_zzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_yyzz_yz[i] * gfe_0 + 6.0 * ts_yyzz_yzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyzz_yzzz[i] * gfe_0 + ts_yyzz_yzzz[i] * rgc2_0;

        gr_yyzz_zzzz[i] = 2.0 * ts_zz_zzzz[i] * gfe_0 + 4.0 * ts_yzz_zzzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yy_zzzz[i] * gfe_0 + 16.0 * ts_yyz_zzz[i] * gfe_0 + 4.0 * ts_yyz_zzzz[i] * gfe_0 * gc_z[i] + 12.0 * ts_yyzz_zz[i] * gfe_0 + 8.0 * ts_yyzz_zzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_yyzz_zzzz[i] * gfe_0 + ts_yyzz_zzzz[i] * rgc2_0;
    }
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        gr_yzzz_xxxx[i] = 2.0 * ts_zzz_xxxx[i] * gfe_0 * gc_y[i] + 6.0 * ts_yz_xxxx[i] * gfe_0 + 6.0 * ts_yzz_xxxx[i] * gfe_0 * gc_z[i] + 12.0 * ts_yzzz_xx[i] * gfe_0 + 8.0 * ts_yzzz_xxx[i] * gfe_0 * gc_x[i] + 3.0 * ts_yzzz_xxxx[i] * gfe_0 + ts_yzzz_xxxx[i] * rgc2_0;

        gr_yzzz_xxxy[i] = 2.0 * ts_zzz_xxx[i] * gfe_0 + 2.0 * ts_zzz_xxxy[i] * gfe_0 * gc_y[i] + 6.0 * ts_yz_xxxy[i] * gfe_0 + 6.0 * ts_yzz_xxxy[i] * gfe_0 * gc_z[i] + 6.0 * ts_yzzz_xy[i] * gfe_0 + 6.0 * ts_yzzz_xxy[i] * gfe_0 * gc_x[i] + 2.0 * ts_yzzz_xxx[i] * gfe_0 * gc_y[i] + 3.0 * ts_yzzz_xxxy[i] * gfe_0 + ts_yzzz_xxxy[i] * rgc2_0;

        gr_yzzz_xxxz[i] = 2.0 * ts_zzz_xxxz[i] * gfe_0 * gc_y[i] + 6.0 * ts_yz_xxxz[i] * gfe_0 + 6.0 * ts_yzz_xxx[i] * gfe_0 + 6.0 * ts_yzz_xxxz[i] * gfe_0 * gc_z[i] + 6.0 * ts_yzzz_xz[i] * gfe_0 + 6.0 * ts_yzzz_xxz[i] * gfe_0 * gc_x[i] + 2.0 * ts_yzzz_xxx[i] * gfe_0 * gc_z[i] + 3.0 * ts_yzzz_xxxz[i] * gfe_0 + ts_yzzz_xxxz[i] * rgc2_0;

        gr_yzzz_xxyy[i] = 4.0 * ts_zzz_xxy[i] * gfe_0 + 2.0 * ts_zzz_xxyy[i] * gfe_0 * gc_y[i] + 6.0 * ts_yz_xxyy[i] * gfe_0 + 6.0 * ts_yzz_xxyy[i] * gfe_0 * gc_z[i] + 2.0 * ts_yzzz_yy[i] * gfe_0 + 4.0 * ts_yzzz_xyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_yzzz_xx[i] * gfe_0 + 4.0 * ts_yzzz_xxy[i] * gfe_0 * gc_y[i] + 3.0 * ts_yzzz_xxyy[i] * gfe_0 + ts_yzzz_xxyy[i] * rgc2_0;

        gr_yzzz_xxyz[i] = 2.0 * ts_zzz_xxz[i] * gfe_0 + 2.0 * ts_zzz_xxyz[i] * gfe_0 * gc_y[i] + 6.0 * ts_yz_xxyz[i] * gfe_0 + 6.0 * ts_yzz_xxy[i] * gfe_0 + 6.0 * ts_yzz_xxyz[i] * gfe_0 * gc_z[i] + 2.0 * ts_yzzz_yz[i] * gfe_0 + 4.0 * ts_yzzz_xyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_yzzz_xxz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yzzz_xxy[i] * gfe_0 * gc_z[i] + 3.0 * ts_yzzz_xxyz[i] * gfe_0 + ts_yzzz_xxyz[i] * rgc2_0;

        gr_yzzz_xxzz[i] = 2.0 * ts_zzz_xxzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_yz_xxzz[i] * gfe_0 + 12.0 * ts_yzz_xxz[i] * gfe_0 + 6.0 * ts_yzz_xxzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_yzzz_zz[i] * gfe_0 + 4.0 * ts_yzzz_xzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_yzzz_xx[i] * gfe_0 + 4.0 * ts_yzzz_xxz[i] * gfe_0 * gc_z[i] + 3.0 * ts_yzzz_xxzz[i] * gfe_0 + ts_yzzz_xxzz[i] * rgc2_0;

        gr_yzzz_xyyy[i] = 6.0 * ts_zzz_xyy[i] * gfe_0 + 2.0 * ts_zzz_xyyy[i] * gfe_0 * gc_y[i] + 6.0 * ts_yz_xyyy[i] * gfe_0 + 6.0 * ts_yzz_xyyy[i] * gfe_0 * gc_z[i] + 2.0 * ts_yzzz_yyy[i] * gfe_0 * gc_x[i] + 6.0 * ts_yzzz_xy[i] * gfe_0 + 6.0 * ts_yzzz_xyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_yzzz_xyyy[i] * gfe_0 + ts_yzzz_xyyy[i] * rgc2_0;

        gr_yzzz_xyyz[i] = 4.0 * ts_zzz_xyz[i] * gfe_0 + 2.0 * ts_zzz_xyyz[i] * gfe_0 * gc_y[i] + 6.0 * ts_yz_xyyz[i] * gfe_0 + 6.0 * ts_yzz_xyy[i] * gfe_0 + 6.0 * ts_yzz_xyyz[i] * gfe_0 * gc_z[i] + 2.0 * ts_yzzz_yyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_yzzz_xz[i] * gfe_0 + 4.0 * ts_yzzz_xyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yzzz_xyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_yzzz_xyyz[i] * gfe_0 + ts_yzzz_xyyz[i] * rgc2_0;

        gr_yzzz_xyzz[i] = 2.0 * ts_zzz_xzz[i] * gfe_0 + 2.0 * ts_zzz_xyzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_yz_xyzz[i] * gfe_0 + 12.0 * ts_yzz_xyz[i] * gfe_0 + 6.0 * ts_yzz_xyzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_yzzz_yzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_yzzz_xzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yzzz_xy[i] * gfe_0 + 4.0 * ts_yzzz_xyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_yzzz_xyzz[i] * gfe_0 + ts_yzzz_xyzz[i] * rgc2_0;

        gr_yzzz_xzzz[i] = 2.0 * ts_zzz_xzzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_yz_xzzz[i] * gfe_0 + 18.0 * ts_yzz_xzz[i] * gfe_0 + 6.0 * ts_yzz_xzzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_yzzz_zzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_yzzz_xz[i] * gfe_0 + 6.0 * ts_yzzz_xzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_yzzz_xzzz[i] * gfe_0 + ts_yzzz_xzzz[i] * rgc2_0;

        gr_yzzz_yyyy[i] = 8.0 * ts_zzz_yyy[i] * gfe_0 + 2.0 * ts_zzz_yyyy[i] * gfe_0 * gc_y[i] + 6.0 * ts_yz_yyyy[i] * gfe_0 + 6.0 * ts_yzz_yyyy[i] * gfe_0 * gc_z[i] + 12.0 * ts_yzzz_yy[i] * gfe_0 + 8.0 * ts_yzzz_yyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_yzzz_yyyy[i] * gfe_0 + ts_yzzz_yyyy[i] * rgc2_0;

        gr_yzzz_yyyz[i] = 6.0 * ts_zzz_yyz[i] * gfe_0 + 2.0 * ts_zzz_yyyz[i] * gfe_0 * gc_y[i] + 6.0 * ts_yz_yyyz[i] * gfe_0 + 6.0 * ts_yzz_yyy[i] * gfe_0 + 6.0 * ts_yzz_yyyz[i] * gfe_0 * gc_z[i] + 6.0 * ts_yzzz_yz[i] * gfe_0 + 6.0 * ts_yzzz_yyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yzzz_yyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_yzzz_yyyz[i] * gfe_0 + ts_yzzz_yyyz[i] * rgc2_0;

        gr_yzzz_yyzz[i] = 4.0 * ts_zzz_yzz[i] * gfe_0 + 2.0 * ts_zzz_yyzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_yz_yyzz[i] * gfe_0 + 12.0 * ts_yzz_yyz[i] * gfe_0 + 6.0 * ts_yzz_yyzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_yzzz_zz[i] * gfe_0 + 4.0 * ts_yzzz_yzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_yzzz_yy[i] * gfe_0 + 4.0 * ts_yzzz_yyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_yzzz_yyzz[i] * gfe_0 + ts_yzzz_yyzz[i] * rgc2_0;

        gr_yzzz_yzzz[i] = 2.0 * ts_zzz_zzz[i] * gfe_0 + 2.0 * ts_zzz_yzzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_yz_yzzz[i] * gfe_0 + 18.0 * ts_yzz_yzz[i] * gfe_0 + 6.0 * ts_yzz_yzzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_yzzz_zzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_yzzz_yz[i] * gfe_0 + 6.0 * ts_yzzz_yzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_yzzz_yzzz[i] * gfe_0 + ts_yzzz_yzzz[i] * rgc2_0;

        gr_yzzz_zzzz[i] = 2.0 * ts_zzz_zzzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_yz_zzzz[i] * gfe_0 + 24.0 * ts_yzz_zzz[i] * gfe_0 + 6.0 * ts_yzz_zzzz[i] * gfe_0 * gc_z[i] + 12.0 * ts_yzzz_zz[i] * gfe_0 + 8.0 * ts_yzzz_zzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_yzzz_zzzz[i] * gfe_0 + ts_yzzz_zzzz[i] * rgc2_0;
    }
    ...
    for (size_t i = 0; i < nelems; i++)
    {
        ...
        gr_zzzz_xxxx[i] = 12.0 * ts_zz_xxxx[i] * gfe_0 + 8.0 * ts_zzz_xxxx[i] * gfe_0 * gc_z[i] + 12.0 * ts_zzzz_xx[i] * gfe_0 + 8.0 * ts_zzzz_xxx[i] * gfe_0 * gc_x[i] + 3.0 * ts_zzzz_xxxx[i] * gfe_0 + ts_zzzz_xxxx[i] * rgc2_0;

        gr_zzzz_xxxy[i] = 12.0 * ts_zz_xxxy[i] * gfe_0 + 8.0 * ts_zzz_xxxy[i] * gfe_0 * gc_z[i] + 6.0 * ts_zzzz_xy[i] * gfe_0 + 6.0 * ts_zzzz_xxy[i] * gfe_0 * gc_x[i] + 2.0 * ts_zzzz_xxx[i] * gfe_0 * gc_y[i] + 3.0 * ts_zzzz_xxxy[i] * gfe_0 + ts_zzzz_xxxy[i] * rgc2_0;

        gr_zzzz_xxxz[i] = 12.0 * ts_zz_xxxz[i] * gfe_0 + 8.0 * ts_zzz_xxx[i] * gfe_0 + 8.0 * ts_zzz_xxxz[i] * gfe_0 * gc_z[i] + 6.0 * ts_zzzz_xz[i] * gfe_0 + 6.0 * ts_zzzz_xxz[i] * gfe_0 * gc_x[i] + 2.0 * ts_zzzz_xxx[i] * gfe_0 * gc_z[i] + 3.0 * ts_zzzz_xxxz[i] * gfe_0 + ts_zzzz_xxxz[i] * rgc2_0;

        gr_zzzz_xxyy[i] = 12.0 * ts_zz_xxyy[i] * gfe_0 + 8.0 * ts_zzz_xxyy[i] * gfe_0 * gc_z[i] + 2.0 * ts_zzzz_yy[i] * gfe_0 + 4.0 * ts_zzzz_xyy[i] * gfe_0 * gc_x[i] + 2.0 * ts_zzzz_xx[i] * gfe_0 + 4.0 * ts_zzzz_xxy[i] * gfe_0 * gc_y[i] + 3.0 * ts_zzzz_xxyy[i] * gfe_0 + ts_zzzz_xxyy[i] * rgc2_0;

        gr_zzzz_xxyz[i] = 12.0 * ts_zz_xxyz[i] * gfe_0 + 8.0 * ts_zzz_xxy[i] * gfe_0 + 8.0 * ts_zzz_xxyz[i] * gfe_0 * gc_z[i] + 2.0 * ts_zzzz_yz[i] * gfe_0 + 4.0 * ts_zzzz_xyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_zzzz_xxz[i] * gfe_0 * gc_y[i] + 2.0 * ts_zzzz_xxy[i] * gfe_0 * gc_z[i] + 3.0 * ts_zzzz_xxyz[i] * gfe_0 + ts_zzzz_xxyz[i] * rgc2_0;

        gr_zzzz_xxzz[i] = 12.0 * ts_zz_xxzz[i] * gfe_0 + 16.0 * ts_zzz_xxz[i] * gfe_0 + 8.0 * ts_zzz_xxzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_zzzz_zz[i] * gfe_0 + 4.0 * ts_zzzz_xzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_zzzz_xx[i] * gfe_0 + 4.0 * ts_zzzz_xxz[i] * gfe_0 * gc_z[i] + 3.0 * ts_zzzz_xxzz[i] * gfe_0 + ts_zzzz_xxzz[i] * rgc2_0;

        gr_zzzz_xyyy[i] = 12.0 * ts_zz_xyyy[i] * gfe_0 + 8.0 * ts_zzz_xyyy[i] * gfe_0 * gc_z[i] + 2.0 * ts_zzzz_yyy[i] * gfe_0 * gc_x[i] + 6.0 * ts_zzzz_xy[i] * gfe_0 + 6.0 * ts_zzzz_xyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_zzzz_xyyy[i] * gfe_0 + ts_zzzz_xyyy[i] * rgc2_0;

        gr_zzzz_xyyz[i] = 12.0 * ts_zz_xyyz[i] * gfe_0 + 8.0 * ts_zzz_xyy[i] * gfe_0 + 8.0 * ts_zzz_xyyz[i] * gfe_0 * gc_z[i] + 2.0 * ts_zzzz_yyz[i] * gfe_0 * gc_x[i] + 2.0 * ts_zzzz_xz[i] * gfe_0 + 4.0 * ts_zzzz_xyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_zzzz_xyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_zzzz_xyyz[i] * gfe_0 + ts_zzzz_xyyz[i] * rgc2_0;

        gr_zzzz_xyzz[i] = 12.0 * ts_zz_xyzz[i] * gfe_0 + 16.0 * ts_zzz_xyz[i] * gfe_0 + 8.0 * ts_zzz_xyzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_zzzz_yzz[i] * gfe_0 * gc_x[i] + 2.0 * ts_zzzz_xzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_zzzz_xy[i] * gfe_0 + 4.0 * ts_zzzz_xyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_zzzz_xyzz[i] * gfe_0 + ts_zzzz_xyzz[i] * rgc2_0;

        gr_zzzz_xzzz[i] = 12.0 * ts_zz_xzzz[i] * gfe_0 + 24.0 * ts_zzz_xzz[i] * gfe_0 + 8.0 * ts_zzz_xzzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_zzzz_zzz[i] * gfe_0 * gc_x[i] + 6.0 * ts_zzzz_xz[i] * gfe_0 + 6.0 * ts_zzzz_xzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_zzzz_xzzz[i] * gfe_0 + ts_zzzz_xzzz[i] * rgc2_0;

        gr_zzzz_yyyy[i] = 12.0 * ts_zz_yyyy[i] * gfe_0 + 8.0 * ts_zzz_yyyy[i] * gfe_0 * gc_z[i] + 12.0 * ts_zzzz_yy[i] * gfe_0 + 8.0 * ts_zzzz_yyy[i] * gfe_0 * gc_y[i] + 3.0 * ts_zzzz_yyyy[i] * gfe_0 + ts_zzzz_yyyy[i] * rgc2_0;

        gr_zzzz_yyyz[i] = 12.0 * ts_zz_yyyz[i] * gfe_0 + 8.0 * ts_zzz_yyy[i] * gfe_0 + 8.0 * ts_zzz_yyyz[i] * gfe_0 * gc_z[i] + 6.0 * ts_zzzz_yz[i] * gfe_0 + 6.0 * ts_zzzz_yyz[i] * gfe_0 * gc_y[i] + 2.0 * ts_zzzz_yyy[i] * gfe_0 * gc_z[i] + 3.0 * ts_zzzz_yyyz[i] * gfe_0 + ts_zzzz_yyyz[i] * rgc2_0;

        gr_zzzz_yyzz[i] = 12.0 * ts_zz_yyzz[i] * gfe_0 + 16.0 * ts_zzz_yyz[i] * gfe_0 + 8.0 * ts_zzz_yyzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_zzzz_zz[i] * gfe_0 + 4.0 * ts_zzzz_yzz[i] * gfe_0 * gc_y[i] + 2.0 * ts_zzzz_yy[i] * gfe_0 + 4.0 * ts_zzzz_yyz[i] * gfe_0 * gc_z[i] + 3.0 * ts_zzzz_yyzz[i] * gfe_0 + ts_zzzz_yyzz[i] * rgc2_0;

        gr_zzzz_yzzz[i] = 12.0 * ts_zz_yzzz[i] * gfe_0 + 24.0 * ts_zzz_yzz[i] * gfe_0 + 8.0 * ts_zzz_yzzz[i] * gfe_0 * gc_z[i] + 2.0 * ts_zzzz_zzz[i] * gfe_0 * gc_y[i] + 6.0 * ts_zzzz_yz[i] * gfe_0 + 6.0 * ts_zzzz_yzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_zzzz_yzzz[i] * gfe_0 + ts_zzzz_yzzz[i] * rgc2_0;

        gr_zzzz_zzzz[i] = 12.0 * ts_zz_zzzz[i] * gfe_0 + 32.0 * ts_zzz_zzz[i] * gfe_0 + 8.0 * ts_zzz_zzzz[i] * gfe_0 * gc_z[i] + 12.0 * ts_zzzz_zz[i] * gfe_0 + 8.0 * ts_zzzz_zzz[i] * gfe_0 * gc_z[i] + 3.0 * ts_zzzz_zzzz[i] * gfe_0 + ts_zzzz_zzzz[i] * rgc2_0;
    }
