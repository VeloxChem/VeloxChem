#ifndef ThreeCenterR2PrimRecFS
#define ThreeCenterR2PrimRecFS

#include "SimdArray.hpp"

namespace t3r2rec { // t3r2rec namespace

/// @brief Computes primitive [F|GR2(r)|S]  integrals for set of data buffers.
