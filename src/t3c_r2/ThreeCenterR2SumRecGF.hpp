#ifndef ThreeCenterR2SumRecGF_hpp
#define ThreeCenterR2SumRecGF_hpp
...
/// @brief Computes (G|GR2(r)|F)  integrals for pair of basis functions blocks.
               ...
               const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(836, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3ovlrec::comp_prim_overlap_gp(pbuffer, 401, 87, 201, 211, factors, 11, a_exp, exgtos[l]);

                    t3ovlrec::comp_prim_overlap_gd(pbuffer, 446, 105, 211, 241, factors, 11, a_exp, exgtos[l]);

                    t3ovlrec::comp_prim_overlap_gf(pbuffer, 536, 141, 241, 301, factors, 11, a_exp, exgtos[l]);

                    t3r2rec::comp_prim_r2_gf(pbuffer, 686, 141, 241, 301, 401, 446, 536, factors, 20, a_exp, exgtos[l]);

                    t2cfunc::reduce(cbuffer, pbuffer, 686, ket_width, ket_npgtos);
                }
            }
...
#endif /* ThreeCenterR2SumRecGF_hpp */
