#ifndef ThreeCenterR2PrimRecSS
#define ThreeCenterR2PrimRecSS

#include "SimdArray.hpp"

namespace t3r2rec { // t3r2rec namespace

/// @brief Computes primitive [S|GR2(r)|S]  integrals for set of data buffers.
