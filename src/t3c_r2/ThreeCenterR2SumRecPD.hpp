#ifndef ThreeCenterR2SumRecPD_hpp
#define ThreeCenterR2SumRecPD_hpp
...
/// @brief Computes (P|GR2(r)|D)  integrals for pair of basis functions blocks.
...
#endif /* ThreeCenterR2SumRecPD_hpp */
