...
namespace vxcfuncs {  // vxcfuncs namespace
    ...
    */
   void PkzbFuncGradientAB(      CXCGradientGrid& xcGradientGrid,
                             const double           factor,
    ...
    /**
     ...
     @param densityGrid the density grid.
     */
    void PkzbFuncGradientA(      CXCGradientGrid& xcGradientGrid,
                             const double           factor,
                             const CDensityGrid&    densityGrid);
    ...
    /**
     ...
     @param densityGrid the density grid.
    */
    void PkzbFuncGradientB(        CXCGradientGrid& xcGradientGrid,
                             const double           factor,
                             const CDensityGrid&    densityGrid);
    
    void PkzbFuncHessianAB(      CXCHessianGrid& xcHessianGrid,
                           const double         factor,
                           const CDensityGrid&  densityGrid);
    ...
    /**
     ...
     @param densityGrid the density grid.
     */
    void PkzbFuncHessianA(      CXCHessianGrid& xcHessianGrid,
                          const double          factor,
                          const CDensityGrid&   densityGrid);
    ...
    /**
     ...
     @param densityGrid the density grid.
     */
    void PkzbFuncHessianB(      CXCHessianGrid& xcHessianGrid,
                          const double          factor,
                          const CDensityGrid&   densityGrid);
    ...
    @param densityGrid the density grid.
    */
   void PkzbFuncCubicHessianAB(      CXCCubicHessianGrid& xcCubicHessianGrid,
                                 const double         factor,
                                 const CDensityGrid&  densityGrid);
    ...
    @param densityGrid the density grid.
    */
   void PkzbFuncCubicHessianA(      CXCCubicHessianGrid& xcCubicHessianGrid,
                                 const double         factor,
                                 const CDensityGrid&  densityGrid);
    ...
    @param densityGrid the density grid.
    */
   void PkzbFuncCubicHessianB(      CXCCubicHessianGrid& xcCubicHessianGrid,
                                 const double         factor,
                                 const CDensityGrid&  densityGrid);
