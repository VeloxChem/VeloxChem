#ifndef ThreeCenterRR2SumRecSS_hpp
#define ThreeCenterRR2SumRecSS_hpp
...
/// @brief Computes (S|GR.R2(r)|S)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_r_r2_ss(T& distributor,
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t2cfunc::comp_distances_gc(factors, 14, 8, coords[l], a_exp, exgtos[l]);

                    t3ovlrec::comp_prim_overlap_ss(pbuffer, 1, 0, factors, 11, a_exp, exgtos[l], exgtos[npoints + l]);

                    t3r2rec::comp_prim_r2_ss(pbuffer, 5, 1, factors, 14, a_exp, exgtos[l]);

                    t3rr2rec::comp_prim_r_r2_ss(pbuffer, 2, 1, 5, factors, 14, a_exp, exgtos[l]);
...
#endif /* ThreeCenterRR2SumRecSS_hpp */
