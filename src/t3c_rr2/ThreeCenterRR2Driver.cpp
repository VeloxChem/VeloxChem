...
#include "ThreeCenterRR2Func.hpp"
#include "T2CDistributor.hpp"

auto
CThreeCenterRR2Driver::compute(const std::vector<double>         &exponents,
...
#pragma omp task firstprivate(bra_gtos, ket_gtos, bra_indices, ket_indices, bkequal)
                {
                    ...
                    t3rr2func::compute(distributor, bra_gtos, ket_gtos, bra_indices, ket_indices, bkequal);
                }
            });
        }
    }
