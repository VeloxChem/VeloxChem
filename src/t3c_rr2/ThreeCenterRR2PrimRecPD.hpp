#ifndef ThreeCenterRR2PrimRecPD
#define ThreeCenterRR2PrimRecPD

#include "SimdArray.hpp"

namespace t3rr2rec { // t3rr2rec namespace

/// @brief Computes primitive [P|GR.R2(r)|D]  integrals for set of data buffers.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_gr_pd The index of integral in primitive integrals buffer.
