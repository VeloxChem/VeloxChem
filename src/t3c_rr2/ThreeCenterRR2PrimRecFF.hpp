#ifndef ThreeCenterRR2PrimRecFF
#define ThreeCenterRR2PrimRecFF

#include "SimdArray.hpp"

namespace t3rr2rec { // t3rr2rec namespace

/// @brief Computes primitive [F|GR.R2(r)|F]  integrals for set of data buffers.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_gr_ff The index of integral in primitive integrals buffer.
