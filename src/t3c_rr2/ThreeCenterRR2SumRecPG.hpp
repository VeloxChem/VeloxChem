#ifndef ThreeCenterRR2SumRecPG_hpp
#define ThreeCenterRR2SumRecPG_hpp
...
/// @brief Computes (P|GR.R2(r)|G)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_r_r2_pg(T& distributor,
                 ...
                 const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(363, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3r2rec::comp_prim_r2_sg(pbuffer, 36, 5, 11, 21, factors, 20, a_exp, exgtos[l]);
                    ...
                    t3r2rec::comp_prim_r2_pf(pbuffer, 108, 5, 11, 51, 60, 78, factors, 20, a_exp, exgtos[l]);

                    t3ovlrec::comp_prim_overlap_pg(pbuffer, 138, 11, 21, factors, 11, a_exp, exgtos[l]);

                    t3r2rec::comp_prim_r2_pg(pbuffer, 318, 11, 21, 60, 78, 138, factors, 20, a_exp, exgtos[l]);

                    t3rr2rec::comp_prim_r_r2_pg(pbuffer, 183, 21, 36, 78, 108, 138, 318, factors, 20, a_exp, exgtos[l]);

                    t2cfunc::reduce(cbuffer, pbuffer, 183, ket_width, ket_npgtos);
                }
            }
...
#endif /* ThreeCenterRR2SumRecPG_hpp */
