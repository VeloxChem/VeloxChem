#ifndef ThreeCenterRR2PrimRecGD
#define ThreeCenterRR2PrimRecGD

#include "SimdArray.hpp"

namespace t3rr2rec { // t3rr2rec namespace

/// @brief Computes primitive [G|GR.R2(r)|D]  integrals for set of data buffers.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_gr_gd The index of integral in primitive integrals buffer.
