#ifndef ThreeCenterRR2PrimRecDF
#define ThreeCenterRR2PrimRecDF

#include "SimdArray.hpp"

namespace t3rr2rec { // t3rr2rec namespace

/// @brief Computes primitive [D|GR.R2(r)|F]  integrals for set of data buffers.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_gr_df The index of integral in primitive integrals buffer.
