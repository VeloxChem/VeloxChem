#ifndef ThreeCenterRR2PrimRecDP
#define ThreeCenterRR2PrimRecDP

#include "SimdArray.hpp"

namespace t3rr2rec { // t3rr2rec namespace

/// @brief Computes primitive [D|GR.R2(r)|P]  integrals for set of data buffers.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_gr_dp The index of integral in primitive integrals buffer.
