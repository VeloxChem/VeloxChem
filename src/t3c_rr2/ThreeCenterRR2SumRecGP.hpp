#ifndef ThreeCenterRR2SumRecGP_hpp
#define ThreeCenterRR2SumRecGP_hpp
...
/// @brief Computes (G|GR.R2(r)|P)  integrals for pair of basis functions blocks.
...
template <class T>
auto
comp_sum_r_r2_gp(T& distributor,
                 ...
                 const bool bra_eq_ket) -> void
{
    ...
    CSimdArray<double> pbuffer(366, ket_npgtos);
        ...
        for (auto j = bra_indices.first; j < bra_indices.second; j++)
        {
            ...
            for (size_t k = 0; k < bra_npgtos; k++)
            {
                ...
                for (size_t l = 0; l < npoints; l++)
                {
                    ...
                    t3ovlrec::comp_prim_overlap_gs(pbuffer, 111, 17, 41, factors, 11, a_exp, exgtos[l]);

                    t3r2rec::comp_prim_r2_gs(pbuffer, 126, 17, 41, 111, factors, 20, a_exp, exgtos[l]);

                    t3ovlrec::comp_prim_overlap_gp(pbuffer, 141, 23, 41, 51, factors, 11, a_exp, exgtos[l]);

                    t3r2rec::comp_prim_r2_gp(pbuffer, 321, 23, 41, 51, 111, 141, factors, 20, a_exp, exgtos[l]);

                    t3rr2rec::comp_prim_r_r2_gp(pbuffer, 186, 51, 81, 111, 126, 141, 321, factors, 20, a_exp, exgtos[l]);

                    t2cfunc::reduce(cbuffer, pbuffer, 186, ket_width, ket_npgtos);
                }
            }
...
#endif /* ThreeCenterRR2SumRecGP_hpp */
