#ifndef ThreeCenterRR2PrimRecGF
#define ThreeCenterRR2PrimRecGF

#include "SimdArray.hpp"

namespace t3rr2rec { // t3rr2rec namespace

/// @brief Computes primitive [G|GR.R2(r)|F]  integrals for set of data buffers.
/// @param pbuffer The primitive integrals buffer.
/// @param idx_gr_gf The index of integral in primitive integrals buffer.
