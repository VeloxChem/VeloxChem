#ifndef PrimitiveOverlapGeom201SD_0_XY
#define PrimitiveOverlapGeom201SD_0_XY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)S_0|1|d^(1)/dB^(1)D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom201SD_0_XY(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201SD_0_XY */
