#ifndef PrimitiveOverlapGeom201FD_ZZZ_XZ
#define PrimitiveOverlapGeom201FD_ZZZ_XZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_ZZZ|1|d^(1)/dB^(1)D_XZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201FD_ZZZ_XZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FD_ZZZ_XZ */
