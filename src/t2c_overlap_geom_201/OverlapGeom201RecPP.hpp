#ifndef OverlapGeom201RecPP_hpp
#define OverlapGeom201RecPP_hpp
...
/**
 Evaluates <d^(2)/dA^(2)P|1|d^(1)/dB^(1)P>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom201PP(CSubMatrix*      matrix_xx_x,
