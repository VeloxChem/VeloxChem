#ifndef PrimitiveOverlapGeom201DD_ZZ_YZ
#define PrimitiveOverlapGeom201DD_ZZ_YZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_ZZ|1|d^(1)/dB^(1)D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201DD_ZZ_YZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DD_ZZ_YZ */
