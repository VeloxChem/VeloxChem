#ifndef PrimitiveOverlapGeom201FP_XYZ_X
#define PrimitiveOverlapGeom201FP_XYZ_X
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XYZ|1|d^(1)/dB^(1)P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom201FP_XYZ_X(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FP_XYZ_X */
