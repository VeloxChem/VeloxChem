#ifndef OverlapGeom201RecSS_hpp
#define OverlapGeom201RecSS_hpp
...
/**
 Evaluates <d^(2)/dA^(2)S|1|d^(1)/dB^(1)S>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom201SS(CSubMatrix*      matrix_xx_x,
