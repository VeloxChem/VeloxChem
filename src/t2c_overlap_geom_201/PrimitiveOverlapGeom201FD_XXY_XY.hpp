#ifndef PrimitiveOverlapGeom201FD_XXY_XY
#define PrimitiveOverlapGeom201FD_XXY_XY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XXY|1|d^(1)/dB^(1)D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom201FD_XXY_XY(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FD_XXY_XY */
