#ifndef PrimitiveOverlapGeom201DP_XY_X
#define PrimitiveOverlapGeom201DP_XY_X
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XY|1|d^(1)/dB^(1)P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom201DP_XY_X(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DP_XY_X */
