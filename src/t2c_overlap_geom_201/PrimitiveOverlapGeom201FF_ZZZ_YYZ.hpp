#ifndef PrimitiveOverlapGeom201FF_ZZZ_YYZ
#define PrimitiveOverlapGeom201FF_ZZZ_YYZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_ZZZ|1|d^(1)/dB^(1)F_YYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201FF_ZZZ_YYZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FF_ZZZ_YYZ */
