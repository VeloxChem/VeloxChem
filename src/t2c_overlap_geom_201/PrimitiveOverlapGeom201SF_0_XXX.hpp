#ifndef PrimitiveOverlapGeom201SF_0_XXX
#define PrimitiveOverlapGeom201SF_0_XXX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)S_0|1|d^(1)/dB^(1)F_XXX> integrals.
...
*/
auto compPrimitiveOverlapGeom201SF_0_XXX(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201SF_0_XXX */
