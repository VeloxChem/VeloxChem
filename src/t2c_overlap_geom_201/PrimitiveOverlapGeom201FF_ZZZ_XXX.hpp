#ifndef PrimitiveOverlapGeom201FF_ZZZ_XXX
#define PrimitiveOverlapGeom201FF_ZZZ_XXX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_ZZZ|1|d^(1)/dB^(1)F_XXX> integrals.
...
*/
auto compPrimitiveOverlapGeom201FF_ZZZ_XXX(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FF_ZZZ_XXX */
