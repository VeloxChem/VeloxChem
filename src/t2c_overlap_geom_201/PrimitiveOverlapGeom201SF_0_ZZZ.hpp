#ifndef PrimitiveOverlapGeom201SF_0_ZZZ
#define PrimitiveOverlapGeom201SF_0_ZZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)S_0|1|d^(1)/dB^(1)F_ZZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201SF_0_ZZZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201SF_0_ZZZ */
