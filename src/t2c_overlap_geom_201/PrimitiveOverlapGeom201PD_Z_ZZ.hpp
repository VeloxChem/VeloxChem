#ifndef PrimitiveOverlapGeom201PD_Z_ZZ
#define PrimitiveOverlapGeom201PD_Z_ZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|d^(1)/dB^(1)D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201PD_Z_ZZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201PD_Z_ZZ */
