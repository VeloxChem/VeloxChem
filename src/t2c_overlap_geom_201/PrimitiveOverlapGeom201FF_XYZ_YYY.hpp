#ifndef PrimitiveOverlapGeom201FF_XYZ_YYY
#define PrimitiveOverlapGeom201FF_XYZ_YYY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XYZ|1|d^(1)/dB^(1)F_YYY> integrals.
...
*/
auto compPrimitiveOverlapGeom201FF_XYZ_YYY(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FF_XYZ_YYY */
