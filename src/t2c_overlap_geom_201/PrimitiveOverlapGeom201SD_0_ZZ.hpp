#ifndef PrimitiveOverlapGeom201SD_0_ZZ
#define PrimitiveOverlapGeom201SD_0_ZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)S_0|1|d^(1)/dB^(1)D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201SD_0_ZZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201SD_0_ZZ */
