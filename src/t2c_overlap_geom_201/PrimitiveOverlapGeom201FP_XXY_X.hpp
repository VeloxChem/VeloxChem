#ifndef PrimitiveOverlapGeom201FP_XXY_X
#define PrimitiveOverlapGeom201FP_XXY_X
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XXY|1|d^(1)/dB^(1)P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom201FP_XXY_X(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FP_XXY_X */
