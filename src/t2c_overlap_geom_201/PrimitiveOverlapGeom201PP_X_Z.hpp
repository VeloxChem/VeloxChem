#ifndef PrimitiveOverlapGeom201PP_X_Z
#define PrimitiveOverlapGeom201PP_X_Z
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|d^(1)/dB^(1)P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom201PP_X_Z(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201PP_X_Z */
