#ifndef PrimitiveOverlapGeom201PP_Z_Y
#define PrimitiveOverlapGeom201PP_Z_Y
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|d^(1)/dB^(1)P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom201PP_Z_Y(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201PP_Z_Y */
