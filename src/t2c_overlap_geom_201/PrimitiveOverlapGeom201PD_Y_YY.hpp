#ifndef PrimitiveOverlapGeom201PD_Y_YY
#define PrimitiveOverlapGeom201PD_Y_YY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Y|1|d^(1)/dB^(1)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom201PD_Y_YY(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201PD_Y_YY */
