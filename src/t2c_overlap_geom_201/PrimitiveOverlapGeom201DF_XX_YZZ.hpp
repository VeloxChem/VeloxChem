#ifndef PrimitiveOverlapGeom201DF_XX_YZZ
#define PrimitiveOverlapGeom201DF_XX_YZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XX|1|d^(1)/dB^(1)F_YZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201DF_XX_YZZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DF_XX_YZZ */
