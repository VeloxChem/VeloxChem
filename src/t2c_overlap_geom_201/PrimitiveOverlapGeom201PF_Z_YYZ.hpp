#ifndef PrimitiveOverlapGeom201PF_Z_YYZ
#define PrimitiveOverlapGeom201PF_Z_YYZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|d^(1)/dB^(1)F_YYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201PF_Z_YYZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201PF_Z_YYZ */
