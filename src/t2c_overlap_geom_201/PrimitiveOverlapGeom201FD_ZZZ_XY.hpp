#ifndef PrimitiveOverlapGeom201FD_ZZZ_XY
#define PrimitiveOverlapGeom201FD_ZZZ_XY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_ZZZ|1|d^(1)/dB^(1)D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom201FD_ZZZ_XY(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FD_ZZZ_XY */
