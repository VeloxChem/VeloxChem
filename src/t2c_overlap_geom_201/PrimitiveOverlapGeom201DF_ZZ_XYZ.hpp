#ifndef PrimitiveOverlapGeom201DF_ZZ_XYZ
#define PrimitiveOverlapGeom201DF_ZZ_XYZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_ZZ|1|d^(1)/dB^(1)F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201DF_ZZ_XYZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DF_ZZ_XYZ */
