#ifndef OverlapGeom201RecDP_hpp
#define OverlapGeom201RecDP_hpp
...
/**
 Evaluates <d^(2)/dA^(2)D|1|d^(1)/dB^(1)P>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom201DP(CSubMatrix*      matrix_xx_x,
