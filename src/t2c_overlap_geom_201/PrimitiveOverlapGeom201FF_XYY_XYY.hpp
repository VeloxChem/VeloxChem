#ifndef PrimitiveOverlapGeom201FF_XYY_XYY
#define PrimitiveOverlapGeom201FF_XYY_XYY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XYY|1|d^(1)/dB^(1)F_XYY> integrals.
...
*/
auto compPrimitiveOverlapGeom201FF_XYY_XYY(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FF_XYY_XYY */
