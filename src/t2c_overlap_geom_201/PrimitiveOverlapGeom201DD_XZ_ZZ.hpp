#ifndef PrimitiveOverlapGeom201DD_XZ_ZZ
#define PrimitiveOverlapGeom201DD_XZ_ZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XZ|1|d^(1)/dB^(1)D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201DD_XZ_ZZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DD_XZ_ZZ */
