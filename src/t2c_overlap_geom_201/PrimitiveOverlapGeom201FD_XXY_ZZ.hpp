#ifndef PrimitiveOverlapGeom201FD_XXY_ZZ
#define PrimitiveOverlapGeom201FD_XXY_ZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XXY|1|d^(1)/dB^(1)D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201FD_XXY_ZZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FD_XXY_ZZ */
