#ifndef PrimitiveOverlapGeom201FS_XXY_0
#define PrimitiveOverlapGeom201FS_XXY_0
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XXY|1|d^(1)/dB^(1)S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom201FS_XXY_0(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FS_XXY_0 */
