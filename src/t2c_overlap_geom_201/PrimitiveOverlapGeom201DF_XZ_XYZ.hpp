#ifndef PrimitiveOverlapGeom201DF_XZ_XYZ
#define PrimitiveOverlapGeom201DF_XZ_XYZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XZ|1|d^(1)/dB^(1)F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201DF_XZ_XYZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DF_XZ_XYZ */
