#ifndef OverlapGeom201RecFD_hpp
#define OverlapGeom201RecFD_hpp
...
/**
 Evaluates <d^(2)/dA^(2)F|1|d^(1)/dB^(1)D>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom201FD(CSubMatrix*      matrix_xx_x,
