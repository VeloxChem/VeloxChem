#ifndef PrimitiveOverlapGeom201FD_XXX_XZ
#define PrimitiveOverlapGeom201FD_XXX_XZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XXX|1|d^(1)/dB^(1)D_XZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201FD_XXX_XZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FD_XXX_XZ */
