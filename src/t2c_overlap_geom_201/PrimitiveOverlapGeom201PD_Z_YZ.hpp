#ifndef PrimitiveOverlapGeom201PD_Z_YZ
#define PrimitiveOverlapGeom201PD_Z_YZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|d^(1)/dB^(1)D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201PD_Z_YZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201PD_Z_YZ */
