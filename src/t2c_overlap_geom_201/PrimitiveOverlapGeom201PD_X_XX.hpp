#ifndef PrimitiveOverlapGeom201PD_X_XX
#define PrimitiveOverlapGeom201PD_X_XX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|d^(1)/dB^(1)D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom201PD_X_XX(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201PD_X_XX */
