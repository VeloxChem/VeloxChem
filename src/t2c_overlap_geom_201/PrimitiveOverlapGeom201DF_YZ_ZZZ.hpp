#ifndef PrimitiveOverlapGeom201DF_YZ_ZZZ
#define PrimitiveOverlapGeom201DF_YZ_ZZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YZ|1|d^(1)/dB^(1)F_ZZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201DF_YZ_ZZZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DF_YZ_ZZZ */
