#ifndef PrimitiveOverlapGeom201PD_Y_XX
#define PrimitiveOverlapGeom201PD_Y_XX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Y|1|d^(1)/dB^(1)D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom201PD_Y_XX(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201PD_Y_XX */
