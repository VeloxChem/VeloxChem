#ifndef PrimitiveOverlapGeom201DP_YY_Y
#define PrimitiveOverlapGeom201DP_YY_Y
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YY|1|d^(1)/dB^(1)P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom201DP_YY_Y(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DP_YY_Y */
