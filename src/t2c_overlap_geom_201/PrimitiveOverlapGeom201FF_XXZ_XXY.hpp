#ifndef PrimitiveOverlapGeom201FF_XXZ_XXY
#define PrimitiveOverlapGeom201FF_XXZ_XXY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XXZ|1|d^(1)/dB^(1)F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom201FF_XXZ_XXY(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FF_XXZ_XXY */
