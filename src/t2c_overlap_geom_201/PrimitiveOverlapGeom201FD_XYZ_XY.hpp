#ifndef PrimitiveOverlapGeom201FD_XYZ_XY
#define PrimitiveOverlapGeom201FD_XYZ_XY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XYZ|1|d^(1)/dB^(1)D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom201FD_XYZ_XY(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FD_XYZ_XY */
