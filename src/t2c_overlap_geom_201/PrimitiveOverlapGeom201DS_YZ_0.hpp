#ifndef PrimitiveOverlapGeom201DS_YZ_0
#define PrimitiveOverlapGeom201DS_YZ_0
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YZ|1|d^(1)/dB^(1)S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom201DS_YZ_0(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DS_YZ_0 */
