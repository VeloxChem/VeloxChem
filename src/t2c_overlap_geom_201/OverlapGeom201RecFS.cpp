#include "OverlapGeom201RecFS.hpp"

#include <cmath>

#include "BatchFunc.hpp"
#include "PrimitiveOverlapGeom201FS_XXX_0.hpp"
#include "PrimitiveOverlapGeom201FS_XXY_0.hpp"
...
#include "PrimitiveOverlapGeom201FS_YYY_0.hpp"
#include "PrimitiveOverlapGeom201FS_YYZ_0.hpp"
...
auto
compOverlapGeom201FS(CSubMatrix*      matrix_xx_x,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom201FS_XXX_0(buffer_xx_x,
                                                                buffer_xx_y,
                                                                buffer_xx_z,
                                                                buffer_xy_x,
                                                                buffer_xy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom201FS_XXY_0(buffer_xx_x,
                                                                buffer_xx_y,
                                                                buffer_xx_z,
                                                                buffer_xy_x,
                                                                buffer_xy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom201FS_XXZ_0(buffer_xx_x,
                                                                buffer_xx_y,
                                                                buffer_xx_z,
                                                                buffer_xy_x,
                                                                buffer_xy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom201FS_XYY_0(buffer_xx_x,
                                                                buffer_xx_y,
                                                                buffer_xx_z,
                                                                buffer_xy_x,
                                                                buffer_xy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom201FS_XYZ_0(buffer_xx_x,
                                                                buffer_xx_y,
                                                                buffer_xx_z,
                                                                buffer_xy_x,
                                                                buffer_xy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom201FS_XZZ_0(buffer_xx_x,
                                                                buffer_xx_y,
                                                                buffer_xx_z,
                                                                buffer_xy_x,
                                                                buffer_xy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom201FS_YYY_0(buffer_xx_x,
                                                                buffer_xx_y,
                                                                buffer_xx_z,
                                                                buffer_xy_x,
                                                                buffer_xy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom201FS_YYZ_0(buffer_xx_x,
                                                                buffer_xx_y,
                                                                buffer_xx_z,
                                                                buffer_xy_x,
                                                                buffer_xy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom201FS_YZZ_0(buffer_xx_x,
                                                                buffer_xx_y,
                                                                buffer_xx_z,
                                                                buffer_xy_x,
                                                                buffer_xy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom201FS_ZZZ_0(buffer_xx_x,
                                                                buffer_xx_y,
                                                                buffer_xx_z,
                                                                buffer_xy_x,
                                                                buffer_xy_y,
