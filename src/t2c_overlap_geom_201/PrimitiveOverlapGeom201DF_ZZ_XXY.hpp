#ifndef PrimitiveOverlapGeom201DF_ZZ_XXY
#define PrimitiveOverlapGeom201DF_ZZ_XXY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_ZZ|1|d^(1)/dB^(1)F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom201DF_ZZ_XXY(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DF_ZZ_XXY */
