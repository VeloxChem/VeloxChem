#ifndef PrimitiveOverlapGeom201PF_Y_XXY
#define PrimitiveOverlapGeom201PF_Y_XXY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Y|1|d^(1)/dB^(1)F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom201PF_Y_XXY(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201PF_Y_XXY */
