#ifndef PrimitiveOverlapGeom201DP_XZ_Y
#define PrimitiveOverlapGeom201DP_XZ_Y
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XZ|1|d^(1)/dB^(1)P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom201DP_XZ_Y(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DP_XZ_Y */
