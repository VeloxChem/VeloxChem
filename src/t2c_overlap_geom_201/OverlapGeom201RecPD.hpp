#ifndef OverlapGeom201RecPD_hpp
#define OverlapGeom201RecPD_hpp
...
/**
 Evaluates <d^(2)/dA^(2)P|1|d^(1)/dB^(1)D>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom201PD(CSubMatrix*      matrix_xx_x,
