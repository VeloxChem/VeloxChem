#ifndef PrimitiveOverlapGeom201PF_X_XXZ
#define PrimitiveOverlapGeom201PF_X_XXZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|d^(1)/dB^(1)F_XXZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201PF_X_XXZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201PF_X_XXZ */
