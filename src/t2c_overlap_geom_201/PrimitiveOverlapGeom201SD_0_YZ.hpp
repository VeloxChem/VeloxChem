#ifndef PrimitiveOverlapGeom201SD_0_YZ
#define PrimitiveOverlapGeom201SD_0_YZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)S_0|1|d^(1)/dB^(1)D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201SD_0_YZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201SD_0_YZ */
