#ifndef PrimitiveOverlapGeom201FD_XXY_YY
#define PrimitiveOverlapGeom201FD_XXY_YY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XXY|1|d^(1)/dB^(1)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom201FD_XXY_YY(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FD_XXY_YY */
