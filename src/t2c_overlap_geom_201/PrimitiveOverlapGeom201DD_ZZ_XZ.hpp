#ifndef PrimitiveOverlapGeom201DD_ZZ_XZ
#define PrimitiveOverlapGeom201DD_ZZ_XZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_ZZ|1|d^(1)/dB^(1)D_XZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201DD_ZZ_XZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DD_ZZ_XZ */
