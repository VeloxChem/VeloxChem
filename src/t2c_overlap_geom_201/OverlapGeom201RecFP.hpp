#ifndef OverlapGeom201RecFP_hpp
#define OverlapGeom201RecFP_hpp
...
/**
 Evaluates <d^(2)/dA^(2)F|1|d^(1)/dB^(1)P>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom201FP(CSubMatrix*      matrix_xx_x,
