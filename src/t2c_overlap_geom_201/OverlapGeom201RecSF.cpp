#include "OverlapGeom201RecSF.hpp"
...
auto
compOverlapGeom201SF(CSubMatrix*      matrix_xx_x,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom201SF_0_XXX(buffer_xx_x,
                                                                buffer_xx_y,
                                                                buffer_xx_z,
                                                                buffer_xy_x,
                                                                buffer_xy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom201SF_0_XXY(buffer_xx_x,
                                                                buffer_xx_y,
                                                                buffer_xx_z,
                                                                buffer_xy_x,
                                                                buffer_xy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom201SF_0_XXZ(buffer_xx_x,
                                                                buffer_xx_y,
                                                                buffer_xx_z,
                                                                buffer_xy_x,
                                                                buffer_xy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom201SF_0_XYY(buffer_xx_x,
                                                                buffer_xx_y,
                                                                buffer_xx_z,
                                                                buffer_xy_x,
                                                                buffer_xy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom201SF_0_XYZ(buffer_xx_x,
                                                                buffer_xx_y,
                                                                buffer_xx_z,
                                                                buffer_xy_x,
                                                                buffer_xy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom201SF_0_XZZ(buffer_xx_x,
                                                                buffer_xx_y,
                                                                buffer_xx_z,
                                                                buffer_xy_x,
                                                                buffer_xy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom201SF_0_YYY(buffer_xx_x,
                                                                buffer_xx_y,
                                                                buffer_xx_z,
                                                                buffer_xy_x,
                                                                buffer_xy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom201SF_0_YYZ(buffer_xx_x,
                                                                buffer_xx_y,
                                                                buffer_xx_z,
                                                                buffer_xy_x,
                                                                buffer_xy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom201SF_0_YZZ(buffer_xx_x,
                                                                buffer_xx_y,
                                                                buffer_xx_z,
                                                                buffer_xy_x,
                                                                buffer_xy_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom201SF_0_ZZZ(buffer_xx_x,
                                                                buffer_xx_y,
                                                                buffer_xx_z,
                                                                buffer_xy_x,
                                                                buffer_xy_y,
