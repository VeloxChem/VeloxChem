#ifndef PrimitiveOverlapGeom201SD_0_YY
#define PrimitiveOverlapGeom201SD_0_YY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)S_0|1|d^(1)/dB^(1)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom201SD_0_YY(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201SD_0_YY */
