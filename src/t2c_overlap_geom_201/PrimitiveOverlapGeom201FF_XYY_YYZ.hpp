#ifndef PrimitiveOverlapGeom201FF_XYY_YYZ
#define PrimitiveOverlapGeom201FF_XYY_YYZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XYY|1|d^(1)/dB^(1)F_YYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201FF_XYY_YYZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FF_XYY_YYZ */
