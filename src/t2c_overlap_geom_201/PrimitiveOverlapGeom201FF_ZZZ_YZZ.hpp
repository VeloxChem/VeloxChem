#ifndef PrimitiveOverlapGeom201FF_ZZZ_YZZ
#define PrimitiveOverlapGeom201FF_ZZZ_YZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_ZZZ|1|d^(1)/dB^(1)F_YZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201FF_ZZZ_YZZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FF_ZZZ_YZZ */
