#ifndef PrimitiveOverlapGeom201FP_XYZ_Z
#define PrimitiveOverlapGeom201FP_XYZ_Z
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XYZ|1|d^(1)/dB^(1)P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom201FP_XYZ_Z(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FP_XYZ_Z */
