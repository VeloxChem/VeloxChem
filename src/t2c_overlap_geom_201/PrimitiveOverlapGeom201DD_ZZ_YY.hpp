#ifndef PrimitiveOverlapGeom201DD_ZZ_YY
#define PrimitiveOverlapGeom201DD_ZZ_YY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_ZZ|1|d^(1)/dB^(1)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom201DD_ZZ_YY(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DD_ZZ_YY */
