#ifndef PrimitiveOverlapGeom201FF_XXX_XYZ
#define PrimitiveOverlapGeom201FF_XXX_XYZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XXX|1|d^(1)/dB^(1)F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201FF_XXX_XYZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FF_XXX_XYZ */
