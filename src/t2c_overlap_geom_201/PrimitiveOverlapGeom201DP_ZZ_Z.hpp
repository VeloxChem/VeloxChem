#ifndef PrimitiveOverlapGeom201DP_ZZ_Z
#define PrimitiveOverlapGeom201DP_ZZ_Z
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_ZZ|1|d^(1)/dB^(1)P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom201DP_ZZ_Z(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DP_ZZ_Z */
