#ifndef PrimitiveOverlapGeom201PP_Y_Z
#define PrimitiveOverlapGeom201PP_Y_Z
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Y|1|d^(1)/dB^(1)P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom201PP_Y_Z(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201PP_Y_Z */
