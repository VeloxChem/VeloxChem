#ifndef OverlapGeom201RecDD_hpp
#define OverlapGeom201RecDD_hpp
...
/**
 Evaluates <d^(2)/dA^(2)D|1|d^(1)/dB^(1)D>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom201DD(CSubMatrix*      matrix_xx_x,
