#ifndef PrimitiveOverlapGeom201DS_YY_0
#define PrimitiveOverlapGeom201DS_YY_0
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YY|1|d^(1)/dB^(1)S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom201DS_YY_0(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DS_YY_0 */
