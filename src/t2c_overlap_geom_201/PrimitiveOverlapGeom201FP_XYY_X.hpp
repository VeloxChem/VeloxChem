#ifndef PrimitiveOverlapGeom201FP_XYY_X
#define PrimitiveOverlapGeom201FP_XYY_X
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XYY|1|d^(1)/dB^(1)P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom201FP_XYY_X(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FP_XYY_X */
