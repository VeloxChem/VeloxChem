#ifndef PrimitiveOverlapGeom201FF_YYY_XZZ
#define PrimitiveOverlapGeom201FF_YYY_XZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_YYY|1|d^(1)/dB^(1)F_XZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201FF_YYY_XZZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FF_YYY_XZZ */
