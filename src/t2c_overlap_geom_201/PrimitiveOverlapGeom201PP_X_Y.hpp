#ifndef PrimitiveOverlapGeom201PP_X_Y
#define PrimitiveOverlapGeom201PP_X_Y
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|d^(1)/dB^(1)P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom201PP_X_Y(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201PP_X_Y */
