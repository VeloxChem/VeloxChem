#ifndef OverlapGeom201RecPF_hpp
#define OverlapGeom201RecPF_hpp
...
/**
 Evaluates <d^(2)/dA^(2)P|1|d^(1)/dB^(1)F>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom201PF(CSubMatrix*      matrix_xx_x,
