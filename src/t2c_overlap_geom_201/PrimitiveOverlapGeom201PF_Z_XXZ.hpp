#ifndef PrimitiveOverlapGeom201PF_Z_XXZ
#define PrimitiveOverlapGeom201PF_Z_XXZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|d^(1)/dB^(1)F_XXZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201PF_Z_XXZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201PF_Z_XXZ */
