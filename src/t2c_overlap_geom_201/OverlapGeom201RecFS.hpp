#ifndef OverlapGeom201RecFS_hpp
#define OverlapGeom201RecFS_hpp
...
/**
 Evaluates <d^(2)/dA^(2)F|1|d^(1)/dB^(1)S>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom201FS(CSubMatrix*      matrix_xx_x,
