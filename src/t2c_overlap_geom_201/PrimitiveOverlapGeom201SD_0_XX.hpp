#ifndef PrimitiveOverlapGeom201SD_0_XX
#define PrimitiveOverlapGeom201SD_0_XX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)S_0|1|d^(1)/dB^(1)D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom201SD_0_XX(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201SD_0_XX */
