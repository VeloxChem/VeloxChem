#ifndef PrimitiveOverlapGeom201DF_XX_XZZ
#define PrimitiveOverlapGeom201DF_XX_XZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XX|1|d^(1)/dB^(1)F_XZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201DF_XX_XZZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DF_XX_XZZ */
