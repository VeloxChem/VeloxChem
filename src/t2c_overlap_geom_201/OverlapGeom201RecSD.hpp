#ifndef OverlapGeom201RecSD_hpp
#define OverlapGeom201RecSD_hpp
...
/**
 Evaluates <d^(2)/dA^(2)S|1|d^(1)/dB^(1)D>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom201SD(CSubMatrix*      matrix_xx_x,
