#ifndef PrimitiveOverlapGeom201SP_0_Z
#define PrimitiveOverlapGeom201SP_0_Z
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)S_0|1|d^(1)/dB^(1)P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom201SP_0_Z(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201SP_0_Z */
