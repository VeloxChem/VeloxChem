#ifndef PrimitiveOverlapGeom201FF_XXY_XYZ
#define PrimitiveOverlapGeom201FF_XXY_XYZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XXY|1|d^(1)/dB^(1)F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201FF_XXY_XYZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FF_XXY_XYZ */
