#ifndef PrimitiveOverlapGeom201PS_Z_0
#define PrimitiveOverlapGeom201PS_Z_0
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|d^(1)/dB^(1)S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom201PS_Z_0(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201PS_Z_0 */
