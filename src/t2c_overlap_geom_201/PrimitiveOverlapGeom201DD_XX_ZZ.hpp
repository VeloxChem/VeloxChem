#ifndef PrimitiveOverlapGeom201DD_XX_ZZ
#define PrimitiveOverlapGeom201DD_XX_ZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XX|1|d^(1)/dB^(1)D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201DD_XX_ZZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DD_XX_ZZ */
