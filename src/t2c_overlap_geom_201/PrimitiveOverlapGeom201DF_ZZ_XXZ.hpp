#ifndef PrimitiveOverlapGeom201DF_ZZ_XXZ
#define PrimitiveOverlapGeom201DF_ZZ_XXZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_ZZ|1|d^(1)/dB^(1)F_XXZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201DF_ZZ_XXZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DF_ZZ_XXZ */
