#ifndef PrimitiveOverlapGeom201DF_XY_XYY
#define PrimitiveOverlapGeom201DF_XY_XYY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XY|1|d^(1)/dB^(1)F_XYY> integrals.
...
*/
auto compPrimitiveOverlapGeom201DF_XY_XYY(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DF_XY_XYY */
