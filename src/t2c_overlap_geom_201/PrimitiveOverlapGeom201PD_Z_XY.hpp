#ifndef PrimitiveOverlapGeom201PD_Z_XY
#define PrimitiveOverlapGeom201PD_Z_XY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|d^(1)/dB^(1)D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom201PD_Z_XY(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201PD_Z_XY */
