#ifndef PrimitiveOverlapGeom201DD_XX_XX
#define PrimitiveOverlapGeom201DD_XX_XX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XX|1|d^(1)/dB^(1)D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom201DD_XX_XX(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DD_XX_XX */
