#ifndef OverlapGeom201RecSF_hpp
#define OverlapGeom201RecSF_hpp
...
/**
 Evaluates <d^(2)/dA^(2)S|1|d^(1)/dB^(1)F>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom201SF(CSubMatrix*      matrix_xx_x,
