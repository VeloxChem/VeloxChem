#ifndef PrimitiveOverlapGeom201FP_YYY_Y
#define PrimitiveOverlapGeom201FP_YYY_Y
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_YYY|1|d^(1)/dB^(1)P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom201FP_YYY_Y(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FP_YYY_Y */
