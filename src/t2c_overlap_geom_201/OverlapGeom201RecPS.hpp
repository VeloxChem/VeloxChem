#ifndef OverlapGeom201RecPS_hpp
#define OverlapGeom201RecPS_hpp
...
/**
 Evaluates <d^(2)/dA^(2)P|1|d^(1)/dB^(1)S>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom201PS(CSubMatrix*      matrix_xx_x,
