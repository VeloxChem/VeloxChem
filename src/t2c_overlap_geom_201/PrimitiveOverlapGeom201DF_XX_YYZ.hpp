#ifndef PrimitiveOverlapGeom201DF_XX_YYZ
#define PrimitiveOverlapGeom201DF_XX_YYZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XX|1|d^(1)/dB^(1)F_YYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201DF_XX_YYZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DF_XX_YYZ */
