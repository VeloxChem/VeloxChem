#ifndef PrimitiveOverlapGeom201FD_YYY_YY
#define PrimitiveOverlapGeom201FD_YYY_YY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_YYY|1|d^(1)/dB^(1)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom201FD_YYY_YY(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FD_YYY_YY */
