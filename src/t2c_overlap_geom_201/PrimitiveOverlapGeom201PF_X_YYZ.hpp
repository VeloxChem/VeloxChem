#ifndef PrimitiveOverlapGeom201PF_X_YYZ
#define PrimitiveOverlapGeom201PF_X_YYZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|d^(1)/dB^(1)F_YYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201PF_X_YYZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201PF_X_YYZ */
