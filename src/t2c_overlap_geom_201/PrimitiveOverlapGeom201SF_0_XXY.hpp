#ifndef PrimitiveOverlapGeom201SF_0_XXY
#define PrimitiveOverlapGeom201SF_0_XXY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)S_0|1|d^(1)/dB^(1)F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom201SF_0_XXY(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201SF_0_XXY */
