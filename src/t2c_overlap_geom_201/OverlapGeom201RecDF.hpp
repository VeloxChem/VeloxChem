#ifndef OverlapGeom201RecDF_hpp
#define OverlapGeom201RecDF_hpp
...
/**
 Evaluates <d^(2)/dA^(2)D|1|d^(1)/dB^(1)F>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom201DF(CSubMatrix*      matrix_xx_x,
