#ifndef OverlapGeom201RecSP_hpp
#define OverlapGeom201RecSP_hpp
...
/**
 Evaluates <d^(2)/dA^(2)S|1|d^(1)/dB^(1)P>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom201SP(CSubMatrix*      matrix_xx_x,
