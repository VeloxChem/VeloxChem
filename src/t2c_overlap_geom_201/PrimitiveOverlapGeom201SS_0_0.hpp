#ifndef PrimitiveOverlapGeom201SS_0_0
#define PrimitiveOverlapGeom201SS_0_0
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)S_0|1|d^(1)/dB^(1)S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom201SS_0_0(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201SS_0_0 */
