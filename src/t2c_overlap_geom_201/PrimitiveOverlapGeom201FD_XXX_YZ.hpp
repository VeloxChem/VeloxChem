#ifndef PrimitiveOverlapGeom201FD_XXX_YZ
#define PrimitiveOverlapGeom201FD_XXX_YZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XXX|1|d^(1)/dB^(1)D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201FD_XXX_YZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FD_XXX_YZ */
