#ifndef PrimitiveOverlapGeom201PF_Y_XYZ
#define PrimitiveOverlapGeom201PF_Y_XYZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Y|1|d^(1)/dB^(1)F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201PF_Y_XYZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201PF_Y_XYZ */
