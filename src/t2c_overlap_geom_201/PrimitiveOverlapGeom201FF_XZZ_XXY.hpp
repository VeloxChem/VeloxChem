#ifndef PrimitiveOverlapGeom201FF_XZZ_XXY
#define PrimitiveOverlapGeom201FF_XZZ_XXY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XZZ|1|d^(1)/dB^(1)F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom201FF_XZZ_XXY(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FF_XZZ_XXY */
