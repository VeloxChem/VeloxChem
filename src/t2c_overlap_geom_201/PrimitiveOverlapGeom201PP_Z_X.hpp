#ifndef PrimitiveOverlapGeom201PP_Z_X
#define PrimitiveOverlapGeom201PP_Z_X
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|d^(1)/dB^(1)P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom201PP_Z_X(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201PP_Z_X */
