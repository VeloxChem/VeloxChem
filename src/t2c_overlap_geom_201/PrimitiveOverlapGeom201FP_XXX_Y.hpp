#ifndef PrimitiveOverlapGeom201FP_XXX_Y
#define PrimitiveOverlapGeom201FP_XXX_Y
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XXX|1|d^(1)/dB^(1)P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom201FP_XXX_Y(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FP_XXX_Y */
