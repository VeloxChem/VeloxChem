#ifndef PrimitiveOverlapGeom201DF_ZZ_XXX
#define PrimitiveOverlapGeom201DF_ZZ_XXX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_ZZ|1|d^(1)/dB^(1)F_XXX> integrals.
...
*/
auto compPrimitiveOverlapGeom201DF_ZZ_XXX(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DF_ZZ_XXX */
