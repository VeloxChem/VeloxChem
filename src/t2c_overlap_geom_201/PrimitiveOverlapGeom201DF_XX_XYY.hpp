#ifndef PrimitiveOverlapGeom201DF_XX_XYY
#define PrimitiveOverlapGeom201DF_XX_XYY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XX|1|d^(1)/dB^(1)F_XYY> integrals.
...
*/
auto compPrimitiveOverlapGeom201DF_XX_XYY(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DF_XX_XYY */
