#ifndef PrimitiveOverlapGeom201FP_XXZ_Z
#define PrimitiveOverlapGeom201FP_XXZ_Z
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XXZ|1|d^(1)/dB^(1)P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom201FP_XXZ_Z(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FP_XXZ_Z */
