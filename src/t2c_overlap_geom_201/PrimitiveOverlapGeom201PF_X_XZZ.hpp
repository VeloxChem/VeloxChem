#ifndef PrimitiveOverlapGeom201PF_X_XZZ
#define PrimitiveOverlapGeom201PF_X_XZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|d^(1)/dB^(1)F_XZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201PF_X_XZZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201PF_X_XZZ */
