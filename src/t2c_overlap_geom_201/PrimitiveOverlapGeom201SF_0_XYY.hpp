#ifndef PrimitiveOverlapGeom201SF_0_XYY
#define PrimitiveOverlapGeom201SF_0_XYY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)S_0|1|d^(1)/dB^(1)F_XYY> integrals.
...
*/
auto compPrimitiveOverlapGeom201SF_0_XYY(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201SF_0_XYY */
