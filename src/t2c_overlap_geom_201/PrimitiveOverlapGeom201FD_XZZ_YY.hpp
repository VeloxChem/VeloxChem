#ifndef PrimitiveOverlapGeom201FD_XZZ_YY
#define PrimitiveOverlapGeom201FD_XZZ_YY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)F_XZZ|1|d^(1)/dB^(1)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom201FD_XZZ_YY(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201FD_XZZ_YY */
