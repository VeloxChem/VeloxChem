#ifndef PrimitiveOverlapGeom201DF_YY_XZZ
#define PrimitiveOverlapGeom201DF_YY_XZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YY|1|d^(1)/dB^(1)F_XZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201DF_YY_XZZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DF_YY_XZZ */
