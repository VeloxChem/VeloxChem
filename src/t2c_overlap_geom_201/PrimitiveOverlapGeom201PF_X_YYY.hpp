#ifndef PrimitiveOverlapGeom201PF_X_YYY
#define PrimitiveOverlapGeom201PF_X_YYY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_X|1|d^(1)/dB^(1)F_YYY> integrals.
...
*/
auto compPrimitiveOverlapGeom201PF_X_YYY(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201PF_X_YYY */
