#ifndef PrimitiveOverlapGeom201DD_XY_XY
#define PrimitiveOverlapGeom201DD_XY_XY
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XY|1|d^(1)/dB^(1)D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom201DD_XY_XY(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DD_XY_XY */
