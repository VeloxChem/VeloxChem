#ifndef PrimitiveOverlapGeom201DP_YY_X
#define PrimitiveOverlapGeom201DP_YY_X
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YY|1|d^(1)/dB^(1)P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom201DP_YY_X(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DP_YY_X */
