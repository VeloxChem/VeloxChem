#ifndef PrimitiveOverlapGeom201SD_0_XZ
#define PrimitiveOverlapGeom201SD_0_XZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)S_0|1|d^(1)/dB^(1)D_XZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201SD_0_XZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201SD_0_XZ */
