#ifndef PrimitiveOverlapGeom201PF_Z_YZZ
#define PrimitiveOverlapGeom201PF_Z_YZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)P_Z|1|d^(1)/dB^(1)F_YZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201PF_Z_YZZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201PF_Z_YZZ */
