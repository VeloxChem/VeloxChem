#ifndef PrimitiveOverlapGeom201DF_YY_XXX
#define PrimitiveOverlapGeom201DF_YY_XXX
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_YY|1|d^(1)/dB^(1)F_XXX> integrals.
...
*/
auto compPrimitiveOverlapGeom201DF_YY_XXX(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DF_YY_XXX */
