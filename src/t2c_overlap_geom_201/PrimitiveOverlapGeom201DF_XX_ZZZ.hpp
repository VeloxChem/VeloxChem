#ifndef PrimitiveOverlapGeom201DF_XX_ZZZ
#define PrimitiveOverlapGeom201DF_XX_ZZZ
...
/**
 Evaluates block of primitive <d^(2)/dA^(2)D_XX|1|d^(1)/dB^(1)F_ZZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom201DF_XX_ZZZ(TDoubleArray&       buffer_xx_x,
...
#endif /* PrimitiveOverlapGeom201DF_XX_ZZZ */
