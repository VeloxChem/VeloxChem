#ifndef OverlapGeom201RecFF_hpp
#define OverlapGeom201RecFF_hpp
...
/**
 Evaluates <d^(2)/dA^(2)F|1|d^(1)/dB^(1)F>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom201FF(CSubMatrix*      matrix_xx_x,
