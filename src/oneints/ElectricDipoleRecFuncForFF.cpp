...
namespace ediprecfunc { // ediprecfunc namespace
    ...
    {
        ediprecfunc::compElectricDipoleForFF_0_50(primBuffer,
                                                  recursionMap,
                                                  osFactors,
                                                  paDistances, 
                                                  braGtoBlock,
        ...
        ediprecfunc::compElectricDipoleForFF_50_100(primBuffer,
                                                    recursionMap,
                                                    osFactors,
                                                    paDistances, 
                                                    braGtoBlock,
        ...
        ediprecfunc::compElectricDipoleForFF_100_150(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
        ...
        ediprecfunc::compElectricDipoleForFF_150_200(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
        ...
        ediprecfunc::compElectricDipoleForFF_200_250(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
        ...
        ediprecfunc::compElectricDipoleForFF_250_300(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
                                 ...
                                 const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tdx_xxy_xxx_0[j] = pa_x[j] * tdx_xy_xxx_0[j] + 0.5 * fl1_fx * tdx_y_xxx_0[j] + 1.5 * fl1_fx * tdx_xy_xx_0[j] + 0.5 * fl1_fx * ts_xy_xxx_0[j];
                ...
                tdx_xxy_xyy_0[j] = pa_x[j] * tdx_xy_xyy_0[j] + 0.5 * fl1_fx * tdx_y_xyy_0[j] + 0.5 * fl1_fx * tdx_xy_yy_0[j] + 0.5 * fl1_fx * ts_xy_xyy_0[j];
                ...
                tdx_xxy_xyz_0[j] = pa_x[j] * tdx_xy_xyz_0[j] + 0.5 * fl1_fx * tdx_y_xyz_0[j] + 0.5 * fl1_fx * tdx_xy_yz_0[j] + 0.5 * fl1_fx * ts_xy_xyz_0[j];
                ...
                tdx_xxy_xzz_0[j] = pa_x[j] * tdx_xy_xzz_0[j] + 0.5 * fl1_fx * tdx_y_xzz_0[j] + 0.5 * fl1_fx * tdx_xy_zz_0[j] + 0.5 * fl1_fx * ts_xy_xzz_0[j];
                                   ...
                                   const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tdx_xxz_xxx_0[j] = pa_x[j] * tdx_xz_xxx_0[j] + 0.5 * fl1_fx * tdx_z_xxx_0[j] + 1.5 * fl1_fx * tdx_xz_xx_0[j] + 0.5 * fl1_fx * ts_xz_xxx_0[j];
                ...
                tdx_xxz_xyy_0[j] = pa_x[j] * tdx_xz_xyy_0[j] + 0.5 * fl1_fx * tdx_z_xyy_0[j] + 0.5 * fl1_fx * tdx_xz_yy_0[j] + 0.5 * fl1_fx * ts_xz_xyy_0[j];
                ...
                tdx_xxz_xyz_0[j] = pa_x[j] * tdx_xz_xyz_0[j] + 0.5 * fl1_fx * tdx_z_xyz_0[j] + 0.5 * fl1_fx * tdx_xz_yz_0[j] + 0.5 * fl1_fx * ts_xz_xyz_0[j];
                ...
                tdx_xxz_xzz_0[j] = pa_x[j] * tdx_xz_xzz_0[j] + 0.5 * fl1_fx * tdx_z_xzz_0[j] + 0.5 * fl1_fx * tdx_xz_zz_0[j] + 0.5 * fl1_fx * ts_xz_xzz_0[j];
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tdy_yyz_xxy_0[j] = pa_y[j] * tdy_yz_xxy_0[j] + 0.5 * fl1_fx * tdy_z_xxy_0[j] + 0.5 * fl1_fx * tdy_yz_xx_0[j] + 0.5 * fl1_fx * ts_yz_xxy_0[j];
                ...
                tdy_yyz_xyz_0[j] = pa_y[j] * tdy_yz_xyz_0[j] + 0.5 * fl1_fx * tdy_z_xyz_0[j] + 0.5 * fl1_fx * tdy_yz_xz_0[j] + 0.5 * fl1_fx * ts_yz_xyz_0[j];
                ...
                tdy_yyz_yyy_0[j] = pa_y[j] * tdy_yz_yyy_0[j] + 0.5 * fl1_fx * tdy_z_yyy_0[j] + 1.5 * fl1_fx * tdy_yz_yy_0[j] + 0.5 * fl1_fx * ts_yz_yyy_0[j];
                ...
                tdy_yyz_yzz_0[j] = pa_y[j] * tdy_yz_yzz_0[j] + 0.5 * fl1_fx * tdy_z_yzz_0[j] + 0.5 * fl1_fx * tdy_yz_zz_0[j] + 0.5 * fl1_fx * ts_yz_yzz_0[j];
