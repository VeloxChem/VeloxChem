...
namespace amomrecfunc { // amomrecfunc namespace
                             ...
                             const int32_t              iContrGto)
    {
        ...
        auto tidx = recursionMap.getIndexOfTerm(CRecursionTerm({"Angular Momentum"}, 1, true,
                                                               {0, -1, -1, -1}, {0, -1, -1, -1}, 1, 1, 0));
                             ...
                             const int32_t              iContrGto)
    {
        ...
        auto pidx_l_4_0_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Angular Momentum"}, 1, true, 
                                                         {4, -1, -1, -1}, {0, -1, -1, -1}, 
                                                         1, 1, 0));
