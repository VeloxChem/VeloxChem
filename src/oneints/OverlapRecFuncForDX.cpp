...
namespace ovlrecfunc { // ovlrecfunc namespace
    ...
    {
        ovlrecfunc::compOverlapForDD_0_12(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                          braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForDD_12_24(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForDD_24_36(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 
    }
    ...
    compOverlapForDF(      CMemBlock2D<double>& primBuffer,
                     ...
                     const int32_t              iContrGto)
    {
        ovlrecfunc::compOverlapForDF_0_10(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                          braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForDF_10_20(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForDF_20_30(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForDF_30_40(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForDF_40_50(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForDF_50_60(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 
    }
    ...
    compOverlapForFD(      CMemBlock2D<double>& primBuffer,
                     ...
                     const int32_t              iContrGto)
    {
        ovlrecfunc::compOverlapForFD_0_10(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                          braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForFD_10_20(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForFD_20_30(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForFD_30_40(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForFD_40_50(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForFD_50_60(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 
    }
    ...
    compOverlapForDG(      CMemBlock2D<double>& primBuffer,
                     ...
                     const int32_t              iContrGto)
    {
        ovlrecfunc::compOverlapForDG_0_10(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                          braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForDG_10_20(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForDG_20_30(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForDG_30_40(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForDG_40_50(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForDG_50_60(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForDG_60_70(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForDG_70_80(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForDG_80_90(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 
    }
    ...
    compOverlapForGD(      CMemBlock2D<double>& primBuffer,
                     ...
                     const int32_t              iContrGto)
    {
        ovlrecfunc::compOverlapForGD_0_10(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                          braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForGD_10_20(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForGD_20_30(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForGD_30_40(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForGD_40_50(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForGD_50_60(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForGD_60_70(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForGD_70_80(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 

        ovlrecfunc::compOverlapForGD_80_90(primBuffer, auxBuffer, osFactors, paDistances, pbDistances, 
                                           braGtoBlock, ketGtoBlock, iContrGto); 
    }
