...
namespace kinrecfunc { // kinrecfunc namespace
    ...
    {
        kinrecfunc::compKineticEnergyForFF_0_50(primBuffer,
                                                recursionMap,
                                                osFactors,
                                                paDistances, 
                                                braGtoBlock,
        ...
        kinrecfunc::compKineticEnergyForFF_50_100(primBuffer,
                                                  recursionMap,
                                                  osFactors,
                                                  paDistances, 
                                                  braGtoBlock,
                                ...
                                const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tt_xxx_xxx_0[j] = pa_x[j] * tt_xx_xxx_0[j] + fl1_fx * tt_x_xxx_0[j] + 1.5 * fl1_fx * tt_xx_xx_0[j] + 2.0 * fl1_fz * ts_xxx_xxx_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_xxx_0[j];

                tt_xxx_xxy_0[j] = pa_x[j] * tt_xx_xxy_0[j] + fl1_fx * tt_x_xxy_0[j] + fl1_fx * tt_xx_xy_0[j] + 2.0 * fl1_fz * ts_xxx_xxy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_xxy_0[j];

                tt_xxx_xxz_0[j] = pa_x[j] * tt_xx_xxz_0[j] + fl1_fx * tt_x_xxz_0[j] + fl1_fx * tt_xx_xz_0[j] + 2.0 * fl1_fz * ts_xxx_xxz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_xxz_0[j];

                tt_xxx_xyy_0[j] = pa_x[j] * tt_xx_xyy_0[j] + fl1_fx * tt_x_xyy_0[j] + 0.5 * fl1_fx * tt_xx_yy_0[j] + 2.0 * fl1_fz * ts_xxx_xyy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_xyy_0[j];

                tt_xxx_xyz_0[j] = pa_x[j] * tt_xx_xyz_0[j] + fl1_fx * tt_x_xyz_0[j] + 0.5 * fl1_fx * tt_xx_yz_0[j] + 2.0 * fl1_fz * ts_xxx_xyz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_xyz_0[j];

                tt_xxx_xzz_0[j] = pa_x[j] * tt_xx_xzz_0[j] + fl1_fx * tt_x_xzz_0[j] + 0.5 * fl1_fx * tt_xx_zz_0[j] + 2.0 * fl1_fz * ts_xxx_xzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_xzz_0[j];

                tt_xxx_yyy_0[j] = pa_x[j] * tt_xx_yyy_0[j] + fl1_fx * tt_x_yyy_0[j] + 2.0 * fl1_fz * ts_xxx_yyy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_yyy_0[j];

                tt_xxx_yyz_0[j] = pa_x[j] * tt_xx_yyz_0[j] + fl1_fx * tt_x_yyz_0[j] + 2.0 * fl1_fz * ts_xxx_yyz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_yyz_0[j];

                tt_xxx_yzz_0[j] = pa_x[j] * tt_xx_yzz_0[j] + fl1_fx * tt_x_yzz_0[j] + 2.0 * fl1_fz * ts_xxx_yzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_yzz_0[j];

                tt_xxx_zzz_0[j] = pa_x[j] * tt_xx_zzz_0[j] + fl1_fx * tt_x_zzz_0[j] + 2.0 * fl1_fz * ts_xxx_zzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_zzz_0[j];

                tt_xxy_xxx_0[j] = pa_x[j] * tt_xy_xxx_0[j] + 0.5 * fl1_fx * tt_y_xxx_0[j] + 1.5 * fl1_fx * tt_xy_xx_0[j] + 2.0 * fl1_fz * ts_xxy_xxx_0[j] - fl1_fz * fl1_fga * ts_y_xxx_0[j];

                tt_xxy_xxy_0[j] = pa_x[j] * tt_xy_xxy_0[j] + 0.5 * fl1_fx * tt_y_xxy_0[j] + fl1_fx * tt_xy_xy_0[j] + 2.0 * fl1_fz * ts_xxy_xxy_0[j] - fl1_fz * fl1_fga * ts_y_xxy_0[j];

                tt_xxy_xxz_0[j] = pa_x[j] * tt_xy_xxz_0[j] + 0.5 * fl1_fx * tt_y_xxz_0[j] + fl1_fx * tt_xy_xz_0[j] + 2.0 * fl1_fz * ts_xxy_xxz_0[j] - fl1_fz * fl1_fga * ts_y_xxz_0[j];

                tt_xxy_xyy_0[j] = pa_x[j] * tt_xy_xyy_0[j] + 0.5 * fl1_fx * tt_y_xyy_0[j] + 0.5 * fl1_fx * tt_xy_yy_0[j] + 2.0 * fl1_fz * ts_xxy_xyy_0[j] - fl1_fz * fl1_fga * ts_y_xyy_0[j];

                tt_xxy_xyz_0[j] = pa_x[j] * tt_xy_xyz_0[j] + 0.5 * fl1_fx * tt_y_xyz_0[j] + 0.5 * fl1_fx * tt_xy_yz_0[j] + 2.0 * fl1_fz * ts_xxy_xyz_0[j] - fl1_fz * fl1_fga * ts_y_xyz_0[j];

                tt_xxy_xzz_0[j] = pa_x[j] * tt_xy_xzz_0[j] + 0.5 * fl1_fx * tt_y_xzz_0[j] + 0.5 * fl1_fx * tt_xy_zz_0[j] + 2.0 * fl1_fz * ts_xxy_xzz_0[j] - fl1_fz * fl1_fga * ts_y_xzz_0[j];

                tt_xxy_yyy_0[j] = pa_x[j] * tt_xy_yyy_0[j] + 0.5 * fl1_fx * tt_y_yyy_0[j] + 2.0 * fl1_fz * ts_xxy_yyy_0[j] - fl1_fz * fl1_fga * ts_y_yyy_0[j];

                tt_xxy_yyz_0[j] = pa_x[j] * tt_xy_yyz_0[j] + 0.5 * fl1_fx * tt_y_yyz_0[j] + 2.0 * fl1_fz * ts_xxy_yyz_0[j] - fl1_fz * fl1_fga * ts_y_yyz_0[j];

                tt_xxy_yzz_0[j] = pa_x[j] * tt_xy_yzz_0[j] + 0.5 * fl1_fx * tt_y_yzz_0[j] + 2.0 * fl1_fz * ts_xxy_yzz_0[j] - fl1_fz * fl1_fga * ts_y_yzz_0[j];

                tt_xxy_zzz_0[j] = pa_x[j] * tt_xy_zzz_0[j] + 0.5 * fl1_fx * tt_y_zzz_0[j] + 2.0 * fl1_fz * ts_xxy_zzz_0[j] - fl1_fz * fl1_fga * ts_y_zzz_0[j];

                tt_xxz_xxx_0[j] = pa_x[j] * tt_xz_xxx_0[j] + 0.5 * fl1_fx * tt_z_xxx_0[j] + 1.5 * fl1_fx * tt_xz_xx_0[j] + 2.0 * fl1_fz * ts_xxz_xxx_0[j] - fl1_fz * fl1_fga * ts_z_xxx_0[j];

                tt_xxz_xxy_0[j] = pa_x[j] * tt_xz_xxy_0[j] + 0.5 * fl1_fx * tt_z_xxy_0[j] + fl1_fx * tt_xz_xy_0[j] + 2.0 * fl1_fz * ts_xxz_xxy_0[j] - fl1_fz * fl1_fga * ts_z_xxy_0[j];

                tt_xxz_xxz_0[j] = pa_x[j] * tt_xz_xxz_0[j] + 0.5 * fl1_fx * tt_z_xxz_0[j] + fl1_fx * tt_xz_xz_0[j] + 2.0 * fl1_fz * ts_xxz_xxz_0[j] - fl1_fz * fl1_fga * ts_z_xxz_0[j];

                tt_xxz_xyy_0[j] = pa_x[j] * tt_xz_xyy_0[j] + 0.5 * fl1_fx * tt_z_xyy_0[j] + 0.5 * fl1_fx * tt_xz_yy_0[j] + 2.0 * fl1_fz * ts_xxz_xyy_0[j] - fl1_fz * fl1_fga * ts_z_xyy_0[j];

                tt_xxz_xyz_0[j] = pa_x[j] * tt_xz_xyz_0[j] + 0.5 * fl1_fx * tt_z_xyz_0[j] + 0.5 * fl1_fx * tt_xz_yz_0[j] + 2.0 * fl1_fz * ts_xxz_xyz_0[j] - fl1_fz * fl1_fga * ts_z_xyz_0[j];

                tt_xxz_xzz_0[j] = pa_x[j] * tt_xz_xzz_0[j] + 0.5 * fl1_fx * tt_z_xzz_0[j] + 0.5 * fl1_fx * tt_xz_zz_0[j] + 2.0 * fl1_fz * ts_xxz_xzz_0[j] - fl1_fz * fl1_fga * ts_z_xzz_0[j];

                tt_xxz_yyy_0[j] = pa_x[j] * tt_xz_yyy_0[j] + 0.5 * fl1_fx * tt_z_yyy_0[j] + 2.0 * fl1_fz * ts_xxz_yyy_0[j] - fl1_fz * fl1_fga * ts_z_yyy_0[j];

                tt_xxz_yyz_0[j] = pa_x[j] * tt_xz_yyz_0[j] + 0.5 * fl1_fx * tt_z_yyz_0[j] + 2.0 * fl1_fz * ts_xxz_yyz_0[j] - fl1_fz * fl1_fga * ts_z_yyz_0[j];

                tt_xxz_yzz_0[j] = pa_x[j] * tt_xz_yzz_0[j] + 0.5 * fl1_fx * tt_z_yzz_0[j] + 2.0 * fl1_fz * ts_xxz_yzz_0[j] - fl1_fz * fl1_fga * ts_z_yzz_0[j];

                tt_xxz_zzz_0[j] = pa_x[j] * tt_xz_zzz_0[j] + 0.5 * fl1_fx * tt_z_zzz_0[j] + 2.0 * fl1_fz * ts_xxz_zzz_0[j] - fl1_fz * fl1_fga * ts_z_zzz_0[j];
                                  ...
                                  const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tt_yyy_xxx_0[j] = pa_y[j] * tt_yy_xxx_0[j] + fl1_fx * tt_y_xxx_0[j] + 2.0 * fl1_fz * ts_yyy_xxx_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_xxx_0[j];

                tt_yyy_xxy_0[j] = pa_y[j] * tt_yy_xxy_0[j] + fl1_fx * tt_y_xxy_0[j] + 0.5 * fl1_fx * tt_yy_xx_0[j] + 2.0 * fl1_fz * ts_yyy_xxy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_xxy_0[j];

                tt_yyy_xxz_0[j] = pa_y[j] * tt_yy_xxz_0[j] + fl1_fx * tt_y_xxz_0[j] + 2.0 * fl1_fz * ts_yyy_xxz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_xxz_0[j];

                tt_yyy_xyy_0[j] = pa_y[j] * tt_yy_xyy_0[j] + fl1_fx * tt_y_xyy_0[j] + fl1_fx * tt_yy_xy_0[j] + 2.0 * fl1_fz * ts_yyy_xyy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_xyy_0[j];

                tt_yyy_xyz_0[j] = pa_y[j] * tt_yy_xyz_0[j] + fl1_fx * tt_y_xyz_0[j] + 0.5 * fl1_fx * tt_yy_xz_0[j] + 2.0 * fl1_fz * ts_yyy_xyz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_xyz_0[j];

                tt_yyy_xzz_0[j] = pa_y[j] * tt_yy_xzz_0[j] + fl1_fx * tt_y_xzz_0[j] + 2.0 * fl1_fz * ts_yyy_xzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_xzz_0[j];

                tt_yyy_yyy_0[j] = pa_y[j] * tt_yy_yyy_0[j] + fl1_fx * tt_y_yyy_0[j] + 1.5 * fl1_fx * tt_yy_yy_0[j] + 2.0 * fl1_fz * ts_yyy_yyy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_yyy_0[j];

                tt_yyy_yyz_0[j] = pa_y[j] * tt_yy_yyz_0[j] + fl1_fx * tt_y_yyz_0[j] + fl1_fx * tt_yy_yz_0[j] + 2.0 * fl1_fz * ts_yyy_yyz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_yyz_0[j];

                tt_yyy_yzz_0[j] = pa_y[j] * tt_yy_yzz_0[j] + fl1_fx * tt_y_yzz_0[j] + 0.5 * fl1_fx * tt_yy_zz_0[j] + 2.0 * fl1_fz * ts_yyy_yzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_yzz_0[j];

                tt_yyy_zzz_0[j] = pa_y[j] * tt_yy_zzz_0[j] + fl1_fx * tt_y_zzz_0[j] + 2.0 * fl1_fz * ts_yyy_zzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_zzz_0[j];

                tt_yyz_xxx_0[j] = pa_y[j] * tt_yz_xxx_0[j] + 0.5 * fl1_fx * tt_z_xxx_0[j] + 2.0 * fl1_fz * ts_yyz_xxx_0[j] - fl1_fz * fl1_fga * ts_z_xxx_0[j];

                tt_yyz_xxy_0[j] = pa_y[j] * tt_yz_xxy_0[j] + 0.5 * fl1_fx * tt_z_xxy_0[j] + 0.5 * fl1_fx * tt_yz_xx_0[j] + 2.0 * fl1_fz * ts_yyz_xxy_0[j] - fl1_fz * fl1_fga * ts_z_xxy_0[j];

                tt_yyz_xxz_0[j] = pa_y[j] * tt_yz_xxz_0[j] + 0.5 * fl1_fx * tt_z_xxz_0[j] + 2.0 * fl1_fz * ts_yyz_xxz_0[j] - fl1_fz * fl1_fga * ts_z_xxz_0[j];

                tt_yyz_xyy_0[j] = pa_y[j] * tt_yz_xyy_0[j] + 0.5 * fl1_fx * tt_z_xyy_0[j] + fl1_fx * tt_yz_xy_0[j] + 2.0 * fl1_fz * ts_yyz_xyy_0[j] - fl1_fz * fl1_fga * ts_z_xyy_0[j];

                tt_yyz_xyz_0[j] = pa_y[j] * tt_yz_xyz_0[j] + 0.5 * fl1_fx * tt_z_xyz_0[j] + 0.5 * fl1_fx * tt_yz_xz_0[j] + 2.0 * fl1_fz * ts_yyz_xyz_0[j] - fl1_fz * fl1_fga * ts_z_xyz_0[j];

                tt_yyz_xzz_0[j] = pa_y[j] * tt_yz_xzz_0[j] + 0.5 * fl1_fx * tt_z_xzz_0[j] + 2.0 * fl1_fz * ts_yyz_xzz_0[j] - fl1_fz * fl1_fga * ts_z_xzz_0[j];

                tt_yyz_yyy_0[j] = pa_y[j] * tt_yz_yyy_0[j] + 0.5 * fl1_fx * tt_z_yyy_0[j] + 1.5 * fl1_fx * tt_yz_yy_0[j] + 2.0 * fl1_fz * ts_yyz_yyy_0[j] - fl1_fz * fl1_fga * ts_z_yyy_0[j];

                tt_yyz_yyz_0[j] = pa_y[j] * tt_yz_yyz_0[j] + 0.5 * fl1_fx * tt_z_yyz_0[j] + fl1_fx * tt_yz_yz_0[j] + 2.0 * fl1_fz * ts_yyz_yyz_0[j] - fl1_fz * fl1_fga * ts_z_yyz_0[j];

                tt_yyz_yzz_0[j] = pa_y[j] * tt_yz_yzz_0[j] + 0.5 * fl1_fx * tt_z_yzz_0[j] + 0.5 * fl1_fx * tt_yz_zz_0[j] + 2.0 * fl1_fz * ts_yyz_yzz_0[j] - fl1_fz * fl1_fga * ts_z_yzz_0[j];

                tt_yyz_zzz_0[j] = pa_y[j] * tt_yz_zzz_0[j] + 0.5 * fl1_fx * tt_z_zzz_0[j] + 2.0 * fl1_fz * ts_yyz_zzz_0[j] - fl1_fz * fl1_fga * ts_z_zzz_0[j];
                ...
                tt_zzz_xxx_0[j] = pa_z[j] * tt_zz_xxx_0[j] + fl1_fx * tt_z_xxx_0[j] + 2.0 * fl1_fz * ts_zzz_xxx_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_xxx_0[j];

                tt_zzz_xxy_0[j] = pa_z[j] * tt_zz_xxy_0[j] + fl1_fx * tt_z_xxy_0[j] + 2.0 * fl1_fz * ts_zzz_xxy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_xxy_0[j];

                tt_zzz_xxz_0[j] = pa_z[j] * tt_zz_xxz_0[j] + fl1_fx * tt_z_xxz_0[j] + 0.5 * fl1_fx * tt_zz_xx_0[j] + 2.0 * fl1_fz * ts_zzz_xxz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_xxz_0[j];

                tt_zzz_xyy_0[j] = pa_z[j] * tt_zz_xyy_0[j] + fl1_fx * tt_z_xyy_0[j] + 2.0 * fl1_fz * ts_zzz_xyy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_xyy_0[j];

                tt_zzz_xyz_0[j] = pa_z[j] * tt_zz_xyz_0[j] + fl1_fx * tt_z_xyz_0[j] + 0.5 * fl1_fx * tt_zz_xy_0[j] + 2.0 * fl1_fz * ts_zzz_xyz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_xyz_0[j];

                tt_zzz_xzz_0[j] = pa_z[j] * tt_zz_xzz_0[j] + fl1_fx * tt_z_xzz_0[j] + fl1_fx * tt_zz_xz_0[j] + 2.0 * fl1_fz * ts_zzz_xzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_xzz_0[j];

                tt_zzz_yyy_0[j] = pa_z[j] * tt_zz_yyy_0[j] + fl1_fx * tt_z_yyy_0[j] + 2.0 * fl1_fz * ts_zzz_yyy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_yyy_0[j];

                tt_zzz_yyz_0[j] = pa_z[j] * tt_zz_yyz_0[j] + fl1_fx * tt_z_yyz_0[j] + 0.5 * fl1_fx * tt_zz_yy_0[j] + 2.0 * fl1_fz * ts_zzz_yyz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_yyz_0[j];

                tt_zzz_yzz_0[j] = pa_z[j] * tt_zz_yzz_0[j] + fl1_fx * tt_z_yzz_0[j] + fl1_fx * tt_zz_yz_0[j] + 2.0 * fl1_fz * ts_zzz_yzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_yzz_0[j];

                tt_zzz_zzz_0[j] = pa_z[j] * tt_zz_zzz_0[j] + fl1_fx * tt_z_zzz_0[j] + 1.5 * fl1_fx * tt_zz_zz_0[j] + 2.0 * fl1_fz * ts_zzz_zzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_zzz_0[j];
            }
