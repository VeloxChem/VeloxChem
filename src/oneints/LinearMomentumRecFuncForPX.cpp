...
namespace lmomrecfunc { // lmomrecfunc namespace
    ...
    compLinearMomentumForPD(      CMemBlock2D<double>& primBuffer,
                            ...
                            const int32_t              iContrGto)
    {
        lmomrecfunc::compLinearMomentumForPD_0_27(primBuffer,
                                                  recursionMap,
                                                  osFactors,
                                                  paDistances, 
                                                  braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForPD_27_54(primBuffer,
                                                   recursionMap,
                                                   osFactors,
                                                   paDistances, 
                                                   braGtoBlock,
    ...
    compLinearMomentumForDP(      CMemBlock2D<double>& primBuffer,
                            ...
                            const int32_t              iContrGto)
    {
        lmomrecfunc::compLinearMomentumForDP_0_27(primBuffer,
                                                  recursionMap,
                                                  osFactors,
                                                  paDistances, 
                                                  braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForDP_27_54(primBuffer,
                                                   recursionMap,
                                                   osFactors,
                                                   paDistances, 
                                                   braGtoBlock,
    ...
    compLinearMomentumForPF(      CMemBlock2D<double>& primBuffer,
                            ...
                            const int32_t              iContrGto)
    {
        lmomrecfunc::compLinearMomentumForPF_0_45(primBuffer,
                                                  recursionMap,
                                                  osFactors,
                                                  paDistances, 
                                                  braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForPF_45_90(primBuffer,
                                                   recursionMap,
                                                   osFactors,
                                                   paDistances, 
                                                   braGtoBlock,
    ...
    compLinearMomentumForFP(      CMemBlock2D<double>& primBuffer,
                            ...
                            const int32_t              iContrGto)
    {
        lmomrecfunc::compLinearMomentumForFP_0_45(primBuffer,
                                                  recursionMap,
                                                  osFactors,
                                                  paDistances, 
                                                  braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForFP_45_90(primBuffer,
                                                   recursionMap,
                                                   osFactors,
                                                   paDistances, 
                                                   braGtoBlock,
    ...
    compLinearMomentumForPG(      CMemBlock2D<double>& primBuffer,
                            ...
                            const int32_t              iContrGto)
    {
        lmomrecfunc::compLinearMomentumForPG_0_45(primBuffer,
                                                  recursionMap,
                                                  osFactors,
                                                  paDistances, 
                                                  braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForPG_45_90(primBuffer,
                                                   recursionMap,
                                                   osFactors,
                                                   paDistances, 
                                                   braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForPG_90_135(primBuffer,
                                                    recursionMap,
                                                    osFactors,
                                                    paDistances, 
                                                    braGtoBlock,
    ...
    compLinearMomentumForGP(      CMemBlock2D<double>& primBuffer,
                            ...
                            const int32_t              iContrGto)
    {
        lmomrecfunc::compLinearMomentumForGP_0_45(primBuffer,
                                                  recursionMap,
                                                  osFactors,
                                                  paDistances, 
                                                  braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForGP_45_90(primBuffer,
                                                   recursionMap,
                                                   osFactors,
                                                   paDistances, 
                                                   braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForGP_90_135(primBuffer,
                                                    recursionMap,
                                                    osFactors,
                                                    paDistances, 
                                                    braGtoBlock,
                                 ...
                                 const int32_t              iContrGto)
    {
        ...
        auto pidx_p_4_1_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Linear Momentum"}, 1, true, 
                                                         {4, -1, -1, -1}, {1, -1, -1, -1}, 
                                                         1, 1, 0));
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpx_xxxx_x_0[j] = pa_x[j] * tpx_xxx_x_0[j] + 1.5 * fl1_fx * tpx_xx_x_0[j] + 0.5 * fl1_fx * tpx_xxx_0_0[j] - fl1_fgb * fl1_fx * ts_xxx_x_0[j];
                ...
                tpx_xxyy_x_0[j] = pa_x[j] * tpx_xyy_x_0[j] + 0.5 * fl1_fx * tpx_yy_x_0[j] + 0.5 * fl1_fx * tpx_xyy_0_0[j] - fl1_fgb * fl1_fx * ts_xyy_x_0[j];
                ...
                tpx_xxyz_x_0[j] = pa_x[j] * tpx_xyz_x_0[j] + 0.5 * fl1_fx * tpx_yz_x_0[j] + 0.5 * fl1_fx * tpx_xyz_0_0[j] - fl1_fgb * fl1_fx * ts_xyz_x_0[j];
                                  ...
                                  const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpx_xxzz_x_0[j] = pa_x[j] * tpx_xzz_x_0[j] + 0.5 * fl1_fx * tpx_zz_x_0[j] + 0.5 * fl1_fx * tpx_xzz_0_0[j] - fl1_fgb * fl1_fx * ts_xzz_x_0[j];
                                   ...
                                   const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpy_yyyy_y_0[j] = pa_y[j] * tpy_yyy_y_0[j] + 1.5 * fl1_fx * tpy_yy_y_0[j] + 0.5 * fl1_fx * tpy_yyy_0_0[j] - fl1_fgb * fl1_fx * ts_yyy_y_0[j];
                ...
                tpy_yyzz_y_0[j] = pa_y[j] * tpy_yzz_y_0[j] + 0.5 * fl1_fx * tpy_zz_y_0[j] + 0.5 * fl1_fx * tpy_yzz_0_0[j] - fl1_fgb * fl1_fx * ts_yzz_y_0[j];
                ...
                tpz_zzzz_z_0[j] = pa_z[j] * tpz_zzz_z_0[j] + 1.5 * fl1_fx * tpz_zz_z_0[j] + 0.5 * fl1_fx * tpz_zzz_0_0[j] - fl1_fgb * fl1_fx * ts_zzz_z_0[j];
            }
