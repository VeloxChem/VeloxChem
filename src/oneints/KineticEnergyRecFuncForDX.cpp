...
namespace kinrecfunc { // kinrecfunc namespace
                           ...
                           const int32_t              iContrGto)
    {
        ...
        auto pidx_t_2_2_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Kinetic Energy"}, 0, true, 
                                                         {2, -1, -1, -1}, {2, -1, -1, -1}, 
                                                         1, 1, 0));
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tt_xx_xx_0[j] = pa_x[j] * tt_x_xx_0[j] + 0.5 * fl1_fx * tt_0_xx_0[j] + fl1_fx * tt_x_x_0[j] + 2.0 * fl1_fz * ts_xx_xx_0[j] - fl1_fz * fl1_fga * ts_0_xx_0[j];

                tt_xx_xy_0[j] = pa_x[j] * tt_x_xy_0[j] + 0.5 * fl1_fx * tt_0_xy_0[j] + 0.5 * fl1_fx * tt_x_y_0[j] + 2.0 * fl1_fz * ts_xx_xy_0[j] - fl1_fz * fl1_fga * ts_0_xy_0[j];

                tt_xx_xz_0[j] = pa_x[j] * tt_x_xz_0[j] + 0.5 * fl1_fx * tt_0_xz_0[j] + 0.5 * fl1_fx * tt_x_z_0[j] + 2.0 * fl1_fz * ts_xx_xz_0[j] - fl1_fz * fl1_fga * ts_0_xz_0[j];
                ...
                tt_yy_xy_0[j] = pa_y[j] * tt_y_xy_0[j] + 0.5 * fl1_fx * tt_0_xy_0[j] + 0.5 * fl1_fx * tt_y_x_0[j] + 2.0 * fl1_fz * ts_yy_xy_0[j] - fl1_fz * fl1_fga * ts_0_xy_0[j];

                tt_yy_xz_0[j] = pa_y[j] * tt_y_xz_0[j] + 0.5 * fl1_fx * tt_0_xz_0[j] + 2.0 * fl1_fz * ts_yy_xz_0[j] - fl1_fz * fl1_fga * ts_0_xz_0[j];

                tt_yy_yy_0[j] = pa_y[j] * tt_y_yy_0[j] + 0.5 * fl1_fx * tt_0_yy_0[j] + fl1_fx * tt_y_y_0[j] + 2.0 * fl1_fz * ts_yy_yy_0[j] - fl1_fz * fl1_fga * ts_0_yy_0[j];

                tt_yy_yz_0[j] = pa_y[j] * tt_y_yz_0[j] + 0.5 * fl1_fx * tt_0_yz_0[j] + 0.5 * fl1_fx * tt_y_z_0[j] + 2.0 * fl1_fz * ts_yy_yz_0[j] - fl1_fz * fl1_fga * ts_0_yz_0[j];
                ...
                tt_zz_xz_0[j] = pa_z[j] * tt_z_xz_0[j] + 0.5 * fl1_fx * tt_0_xz_0[j] + 0.5 * fl1_fx * tt_z_x_0[j] + 2.0 * fl1_fz * ts_zz_xz_0[j] - fl1_fz * fl1_fga * ts_0_xz_0[j];

                tt_zz_yy_0[j] = pa_z[j] * tt_z_yy_0[j] + 0.5 * fl1_fx * tt_0_yy_0[j] + 2.0 * fl1_fz * ts_zz_yy_0[j] - fl1_fz * fl1_fga * ts_0_yy_0[j];

                tt_zz_yz_0[j] = pa_z[j] * tt_z_yz_0[j] + 0.5 * fl1_fx * tt_0_yz_0[j] + 0.5 * fl1_fx * tt_z_y_0[j] + 2.0 * fl1_fz * ts_zz_yz_0[j] - fl1_fz * fl1_fga * ts_0_yz_0[j];

                tt_zz_zz_0[j] = pa_z[j] * tt_z_zz_0[j] + 0.5 * fl1_fx * tt_0_zz_0[j] + fl1_fx * tt_z_z_0[j] + 2.0 * fl1_fz * ts_zz_zz_0[j] - fl1_fz * fl1_fga * ts_0_zz_0[j];
            }
    ...
    compKineticEnergyForDF(      CMemBlock2D<double>& primBuffer,
                           ...
                           const int32_t              iContrGto)
    {
        kinrecfunc::compKineticEnergyForDF_0_30(primBuffer,
                                                recursionMap,
                                                osFactors,
                                                paDistances, 
                                                braGtoBlock,
        ...
        kinrecfunc::compKineticEnergyForDF_30_60(primBuffer,
                                                 recursionMap,
                                                 osFactors,
                                                 paDistances, 
                                                 braGtoBlock,
                                ...
                                const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tt_xx_xxx_0[j] = pa_x[j] * tt_x_xxx_0[j] + 0.5 * fl1_fx * tt_0_xxx_0[j] + 1.5 * fl1_fx * tt_x_xx_0[j] + 2.0 * fl1_fz * ts_xx_xxx_0[j] - fl1_fz * fl1_fga * ts_0_xxx_0[j];

                tt_xx_xxy_0[j] = pa_x[j] * tt_x_xxy_0[j] + 0.5 * fl1_fx * tt_0_xxy_0[j] + fl1_fx * tt_x_xy_0[j] + 2.0 * fl1_fz * ts_xx_xxy_0[j] - fl1_fz * fl1_fga * ts_0_xxy_0[j];

                tt_xx_xxz_0[j] = pa_x[j] * tt_x_xxz_0[j] + 0.5 * fl1_fx * tt_0_xxz_0[j] + fl1_fx * tt_x_xz_0[j] + 2.0 * fl1_fz * ts_xx_xxz_0[j] - fl1_fz * fl1_fga * ts_0_xxz_0[j];

                tt_xx_xyy_0[j] = pa_x[j] * tt_x_xyy_0[j] + 0.5 * fl1_fx * tt_0_xyy_0[j] + 0.5 * fl1_fx * tt_x_yy_0[j] + 2.0 * fl1_fz * ts_xx_xyy_0[j] - fl1_fz * fl1_fga * ts_0_xyy_0[j];

                tt_xx_xyz_0[j] = pa_x[j] * tt_x_xyz_0[j] + 0.5 * fl1_fx * tt_0_xyz_0[j] + 0.5 * fl1_fx * tt_x_yz_0[j] + 2.0 * fl1_fz * ts_xx_xyz_0[j] - fl1_fz * fl1_fga * ts_0_xyz_0[j];

                tt_xx_xzz_0[j] = pa_x[j] * tt_x_xzz_0[j] + 0.5 * fl1_fx * tt_0_xzz_0[j] + 0.5 * fl1_fx * tt_x_zz_0[j] + 2.0 * fl1_fz * ts_xx_xzz_0[j] - fl1_fz * fl1_fga * ts_0_xzz_0[j];

                tt_xx_yyy_0[j] = pa_x[j] * tt_x_yyy_0[j] + 0.5 * fl1_fx * tt_0_yyy_0[j] + 2.0 * fl1_fz * ts_xx_yyy_0[j] - fl1_fz * fl1_fga * ts_0_yyy_0[j];

                tt_xx_yyz_0[j] = pa_x[j] * tt_x_yyz_0[j] + 0.5 * fl1_fx * tt_0_yyz_0[j] + 2.0 * fl1_fz * ts_xx_yyz_0[j] - fl1_fz * fl1_fga * ts_0_yyz_0[j];

                tt_xx_yzz_0[j] = pa_x[j] * tt_x_yzz_0[j] + 0.5 * fl1_fx * tt_0_yzz_0[j] + 2.0 * fl1_fz * ts_xx_yzz_0[j] - fl1_fz * fl1_fga * ts_0_yzz_0[j];

                tt_xx_zzz_0[j] = pa_x[j] * tt_x_zzz_0[j] + 0.5 * fl1_fx * tt_0_zzz_0[j] + 2.0 * fl1_fz * ts_xx_zzz_0[j] - fl1_fz * fl1_fga * ts_0_zzz_0[j];
                                 ...
                                 const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tt_yy_xxx_0[j] = pa_y[j] * tt_y_xxx_0[j] + 0.5 * fl1_fx * tt_0_xxx_0[j] + 2.0 * fl1_fz * ts_yy_xxx_0[j] - fl1_fz * fl1_fga * ts_0_xxx_0[j];

                tt_yy_xxy_0[j] = pa_y[j] * tt_y_xxy_0[j] + 0.5 * fl1_fx * tt_0_xxy_0[j] + 0.5 * fl1_fx * tt_y_xx_0[j] + 2.0 * fl1_fz * ts_yy_xxy_0[j] - fl1_fz * fl1_fga * ts_0_xxy_0[j];

                tt_yy_xxz_0[j] = pa_y[j] * tt_y_xxz_0[j] + 0.5 * fl1_fx * tt_0_xxz_0[j] + 2.0 * fl1_fz * ts_yy_xxz_0[j] - fl1_fz * fl1_fga * ts_0_xxz_0[j];

                tt_yy_xyy_0[j] = pa_y[j] * tt_y_xyy_0[j] + 0.5 * fl1_fx * tt_0_xyy_0[j] + fl1_fx * tt_y_xy_0[j] + 2.0 * fl1_fz * ts_yy_xyy_0[j] - fl1_fz * fl1_fga * ts_0_xyy_0[j];

                tt_yy_xyz_0[j] = pa_y[j] * tt_y_xyz_0[j] + 0.5 * fl1_fx * tt_0_xyz_0[j] + 0.5 * fl1_fx * tt_y_xz_0[j] + 2.0 * fl1_fz * ts_yy_xyz_0[j] - fl1_fz * fl1_fga * ts_0_xyz_0[j];

                tt_yy_xzz_0[j] = pa_y[j] * tt_y_xzz_0[j] + 0.5 * fl1_fx * tt_0_xzz_0[j] + 2.0 * fl1_fz * ts_yy_xzz_0[j] - fl1_fz * fl1_fga * ts_0_xzz_0[j];

                tt_yy_yyy_0[j] = pa_y[j] * tt_y_yyy_0[j] + 0.5 * fl1_fx * tt_0_yyy_0[j] + 1.5 * fl1_fx * tt_y_yy_0[j] + 2.0 * fl1_fz * ts_yy_yyy_0[j] - fl1_fz * fl1_fga * ts_0_yyy_0[j];

                tt_yy_yyz_0[j] = pa_y[j] * tt_y_yyz_0[j] + 0.5 * fl1_fx * tt_0_yyz_0[j] + fl1_fx * tt_y_yz_0[j] + 2.0 * fl1_fz * ts_yy_yyz_0[j] - fl1_fz * fl1_fga * ts_0_yyz_0[j];

                tt_yy_yzz_0[j] = pa_y[j] * tt_y_yzz_0[j] + 0.5 * fl1_fx * tt_0_yzz_0[j] + 0.5 * fl1_fx * tt_y_zz_0[j] + 2.0 * fl1_fz * ts_yy_yzz_0[j] - fl1_fz * fl1_fga * ts_0_yzz_0[j];

                tt_yy_zzz_0[j] = pa_y[j] * tt_y_zzz_0[j] + 0.5 * fl1_fx * tt_0_zzz_0[j] + 2.0 * fl1_fz * ts_yy_zzz_0[j] - fl1_fz * fl1_fga * ts_0_zzz_0[j];
                ...
                tt_zz_xxx_0[j] = pa_z[j] * tt_z_xxx_0[j] + 0.5 * fl1_fx * tt_0_xxx_0[j] + 2.0 * fl1_fz * ts_zz_xxx_0[j] - fl1_fz * fl1_fga * ts_0_xxx_0[j];

                tt_zz_xxy_0[j] = pa_z[j] * tt_z_xxy_0[j] + 0.5 * fl1_fx * tt_0_xxy_0[j] + 2.0 * fl1_fz * ts_zz_xxy_0[j] - fl1_fz * fl1_fga * ts_0_xxy_0[j];

                tt_zz_xxz_0[j] = pa_z[j] * tt_z_xxz_0[j] + 0.5 * fl1_fx * tt_0_xxz_0[j] + 0.5 * fl1_fx * tt_z_xx_0[j] + 2.0 * fl1_fz * ts_zz_xxz_0[j] - fl1_fz * fl1_fga * ts_0_xxz_0[j];

                tt_zz_xyy_0[j] = pa_z[j] * tt_z_xyy_0[j] + 0.5 * fl1_fx * tt_0_xyy_0[j] + 2.0 * fl1_fz * ts_zz_xyy_0[j] - fl1_fz * fl1_fga * ts_0_xyy_0[j];

                tt_zz_xyz_0[j] = pa_z[j] * tt_z_xyz_0[j] + 0.5 * fl1_fx * tt_0_xyz_0[j] + 0.5 * fl1_fx * tt_z_xy_0[j] + 2.0 * fl1_fz * ts_zz_xyz_0[j] - fl1_fz * fl1_fga * ts_0_xyz_0[j];

                tt_zz_xzz_0[j] = pa_z[j] * tt_z_xzz_0[j] + 0.5 * fl1_fx * tt_0_xzz_0[j] + fl1_fx * tt_z_xz_0[j] + 2.0 * fl1_fz * ts_zz_xzz_0[j] - fl1_fz * fl1_fga * ts_0_xzz_0[j];

                tt_zz_yyy_0[j] = pa_z[j] * tt_z_yyy_0[j] + 0.5 * fl1_fx * tt_0_yyy_0[j] + 2.0 * fl1_fz * ts_zz_yyy_0[j] - fl1_fz * fl1_fga * ts_0_yyy_0[j];

                tt_zz_yyz_0[j] = pa_z[j] * tt_z_yyz_0[j] + 0.5 * fl1_fx * tt_0_yyz_0[j] + 0.5 * fl1_fx * tt_z_yy_0[j] + 2.0 * fl1_fz * ts_zz_yyz_0[j] - fl1_fz * fl1_fga * ts_0_yyz_0[j];

                tt_zz_yzz_0[j] = pa_z[j] * tt_z_yzz_0[j] + 0.5 * fl1_fx * tt_0_yzz_0[j] + fl1_fx * tt_z_yz_0[j] + 2.0 * fl1_fz * ts_zz_yzz_0[j] - fl1_fz * fl1_fga * ts_0_yzz_0[j];

                tt_zz_zzz_0[j] = pa_z[j] * tt_z_zzz_0[j] + 0.5 * fl1_fx * tt_0_zzz_0[j] + 1.5 * fl1_fx * tt_z_zz_0[j] + 2.0 * fl1_fz * ts_zz_zzz_0[j] - fl1_fz * fl1_fga * ts_0_zzz_0[j];
            }
    ...
    compKineticEnergyForFD(      CMemBlock2D<double>& primBuffer,
                           ...
                           const int32_t              iContrGto)
    {
        kinrecfunc::compKineticEnergyForFD_0_30(primBuffer,
                                                recursionMap,
                                                osFactors,
                                                paDistances, 
                                                braGtoBlock,
        ...
        kinrecfunc::compKineticEnergyForFD_30_60(primBuffer,
                                                 recursionMap,
                                                 osFactors,
                                                 paDistances, 
                                                 braGtoBlock,
                                ...
                                const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tt_xxx_xx_0[j] = pa_x[j] * tt_xx_xx_0[j] + fl1_fx * tt_x_xx_0[j] + fl1_fx * tt_xx_x_0[j] + 2.0 * fl1_fz * ts_xxx_xx_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_xx_0[j];

                tt_xxx_xy_0[j] = pa_x[j] * tt_xx_xy_0[j] + fl1_fx * tt_x_xy_0[j] + 0.5 * fl1_fx * tt_xx_y_0[j] + 2.0 * fl1_fz * ts_xxx_xy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_xy_0[j];

                tt_xxx_xz_0[j] = pa_x[j] * tt_xx_xz_0[j] + fl1_fx * tt_x_xz_0[j] + 0.5 * fl1_fx * tt_xx_z_0[j] + 2.0 * fl1_fz * ts_xxx_xz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_xz_0[j];
                ...
                tt_xxy_xx_0[j] = pa_x[j] * tt_xy_xx_0[j] + 0.5 * fl1_fx * tt_y_xx_0[j] + fl1_fx * tt_xy_x_0[j] + 2.0 * fl1_fz * ts_xxy_xx_0[j] - fl1_fz * fl1_fga * ts_y_xx_0[j];

                tt_xxy_xy_0[j] = pa_x[j] * tt_xy_xy_0[j] + 0.5 * fl1_fx * tt_y_xy_0[j] + 0.5 * fl1_fx * tt_xy_y_0[j] + 2.0 * fl1_fz * ts_xxy_xy_0[j] - fl1_fz * fl1_fga * ts_y_xy_0[j];

                tt_xxy_xz_0[j] = pa_x[j] * tt_xy_xz_0[j] + 0.5 * fl1_fx * tt_y_xz_0[j] + 0.5 * fl1_fx * tt_xy_z_0[j] + 2.0 * fl1_fz * ts_xxy_xz_0[j] - fl1_fz * fl1_fga * ts_y_xz_0[j];
                ...
                tt_xxz_xx_0[j] = pa_x[j] * tt_xz_xx_0[j] + 0.5 * fl1_fx * tt_z_xx_0[j] + fl1_fx * tt_xz_x_0[j] + 2.0 * fl1_fz * ts_xxz_xx_0[j] - fl1_fz * fl1_fga * ts_z_xx_0[j];

                tt_xxz_xy_0[j] = pa_x[j] * tt_xz_xy_0[j] + 0.5 * fl1_fx * tt_z_xy_0[j] + 0.5 * fl1_fx * tt_xz_y_0[j] + 2.0 * fl1_fz * ts_xxz_xy_0[j] - fl1_fz * fl1_fga * ts_z_xy_0[j];

                tt_xxz_xz_0[j] = pa_x[j] * tt_xz_xz_0[j] + 0.5 * fl1_fx * tt_z_xz_0[j] + 0.5 * fl1_fx * tt_xz_z_0[j] + 2.0 * fl1_fz * ts_xxz_xz_0[j] - fl1_fz * fl1_fga * ts_z_xz_0[j];
                                 ...
                                 const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tt_yyy_xy_0[j] = pa_y[j] * tt_yy_xy_0[j] + fl1_fx * tt_y_xy_0[j] + 0.5 * fl1_fx * tt_yy_x_0[j] + 2.0 * fl1_fz * ts_yyy_xy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_xy_0[j];

                tt_yyy_xz_0[j] = pa_y[j] * tt_yy_xz_0[j] + fl1_fx * tt_y_xz_0[j] + 2.0 * fl1_fz * ts_yyy_xz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_xz_0[j];

                tt_yyy_yy_0[j] = pa_y[j] * tt_yy_yy_0[j] + fl1_fx * tt_y_yy_0[j] + fl1_fx * tt_yy_y_0[j] + 2.0 * fl1_fz * ts_yyy_yy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_yy_0[j];

                tt_yyy_yz_0[j] = pa_y[j] * tt_yy_yz_0[j] + fl1_fx * tt_y_yz_0[j] + 0.5 * fl1_fx * tt_yy_z_0[j] + 2.0 * fl1_fz * ts_yyy_yz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_yz_0[j];
                ...
                tt_yyz_xy_0[j] = pa_y[j] * tt_yz_xy_0[j] + 0.5 * fl1_fx * tt_z_xy_0[j] + 0.5 * fl1_fx * tt_yz_x_0[j] + 2.0 * fl1_fz * ts_yyz_xy_0[j] - fl1_fz * fl1_fga * ts_z_xy_0[j];

                tt_yyz_xz_0[j] = pa_y[j] * tt_yz_xz_0[j] + 0.5 * fl1_fx * tt_z_xz_0[j] + 2.0 * fl1_fz * ts_yyz_xz_0[j] - fl1_fz * fl1_fga * ts_z_xz_0[j];

                tt_yyz_yy_0[j] = pa_y[j] * tt_yz_yy_0[j] + 0.5 * fl1_fx * tt_z_yy_0[j] + fl1_fx * tt_yz_y_0[j] + 2.0 * fl1_fz * ts_yyz_yy_0[j] - fl1_fz * fl1_fga * ts_z_yy_0[j];

                tt_yyz_yz_0[j] = pa_y[j] * tt_yz_yz_0[j] + 0.5 * fl1_fx * tt_z_yz_0[j] + 0.5 * fl1_fx * tt_yz_z_0[j] + 2.0 * fl1_fz * ts_yyz_yz_0[j] - fl1_fz * fl1_fga * ts_z_yz_0[j];
                ...
                tt_zzz_xz_0[j] = pa_z[j] * tt_zz_xz_0[j] + fl1_fx * tt_z_xz_0[j] + 0.5 * fl1_fx * tt_zz_x_0[j] + 2.0 * fl1_fz * ts_zzz_xz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_xz_0[j];

                tt_zzz_yy_0[j] = pa_z[j] * tt_zz_yy_0[j] + fl1_fx * tt_z_yy_0[j] + 2.0 * fl1_fz * ts_zzz_yy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_yy_0[j];

                tt_zzz_yz_0[j] = pa_z[j] * tt_zz_yz_0[j] + fl1_fx * tt_z_yz_0[j] + 0.5 * fl1_fx * tt_zz_y_0[j] + 2.0 * fl1_fz * ts_zzz_yz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_yz_0[j];

                tt_zzz_zz_0[j] = pa_z[j] * tt_zz_zz_0[j] + fl1_fx * tt_z_zz_0[j] + fl1_fx * tt_zz_z_0[j] + 2.0 * fl1_fz * ts_zzz_zz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_zz_0[j];
            }
    ...
    compKineticEnergyForDG(      CMemBlock2D<double>& primBuffer,
                           ...
                           const int32_t              iContrGto)
    {
        kinrecfunc::compKineticEnergyForDG_0_45(primBuffer,
                                                recursionMap,
                                                osFactors,
                                                paDistances, 
                                                braGtoBlock,
        ...
        kinrecfunc::compKineticEnergyForDG_45_90(primBuffer,
                                                 recursionMap,
                                                 osFactors,
                                                 paDistances, 
                                                 braGtoBlock,
                                ...
                                const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tt_xx_xxxx_0[j] = pa_x[j] * tt_x_xxxx_0[j] + 0.5 * fl1_fx * tt_0_xxxx_0[j] + 2.0 * fl1_fx * tt_x_xxx_0[j] + 2.0 * fl1_fz * ts_xx_xxxx_0[j] - fl1_fz * fl1_fga * ts_0_xxxx_0[j];

                tt_xx_xxxy_0[j] = pa_x[j] * tt_x_xxxy_0[j] + 0.5 * fl1_fx * tt_0_xxxy_0[j] + 1.5 * fl1_fx * tt_x_xxy_0[j] + 2.0 * fl1_fz * ts_xx_xxxy_0[j] - fl1_fz * fl1_fga * ts_0_xxxy_0[j];

                tt_xx_xxxz_0[j] = pa_x[j] * tt_x_xxxz_0[j] + 0.5 * fl1_fx * tt_0_xxxz_0[j] + 1.5 * fl1_fx * tt_x_xxz_0[j] + 2.0 * fl1_fz * ts_xx_xxxz_0[j] - fl1_fz * fl1_fga * ts_0_xxxz_0[j];

                tt_xx_xxyy_0[j] = pa_x[j] * tt_x_xxyy_0[j] + 0.5 * fl1_fx * tt_0_xxyy_0[j] + fl1_fx * tt_x_xyy_0[j] + 2.0 * fl1_fz * ts_xx_xxyy_0[j] - fl1_fz * fl1_fga * ts_0_xxyy_0[j];

                tt_xx_xxyz_0[j] = pa_x[j] * tt_x_xxyz_0[j] + 0.5 * fl1_fx * tt_0_xxyz_0[j] + fl1_fx * tt_x_xyz_0[j] + 2.0 * fl1_fz * ts_xx_xxyz_0[j] - fl1_fz * fl1_fga * ts_0_xxyz_0[j];

                tt_xx_xxzz_0[j] = pa_x[j] * tt_x_xxzz_0[j] + 0.5 * fl1_fx * tt_0_xxzz_0[j] + fl1_fx * tt_x_xzz_0[j] + 2.0 * fl1_fz * ts_xx_xxzz_0[j] - fl1_fz * fl1_fga * ts_0_xxzz_0[j];

                tt_xx_xyyy_0[j] = pa_x[j] * tt_x_xyyy_0[j] + 0.5 * fl1_fx * tt_0_xyyy_0[j] + 0.5 * fl1_fx * tt_x_yyy_0[j] + 2.0 * fl1_fz * ts_xx_xyyy_0[j] - fl1_fz * fl1_fga * ts_0_xyyy_0[j];

                tt_xx_xyyz_0[j] = pa_x[j] * tt_x_xyyz_0[j] + 0.5 * fl1_fx * tt_0_xyyz_0[j] + 0.5 * fl1_fx * tt_x_yyz_0[j] + 2.0 * fl1_fz * ts_xx_xyyz_0[j] - fl1_fz * fl1_fga * ts_0_xyyz_0[j];

                tt_xx_xyzz_0[j] = pa_x[j] * tt_x_xyzz_0[j] + 0.5 * fl1_fx * tt_0_xyzz_0[j] + 0.5 * fl1_fx * tt_x_yzz_0[j] + 2.0 * fl1_fz * ts_xx_xyzz_0[j] - fl1_fz * fl1_fga * ts_0_xyzz_0[j];

                tt_xx_xzzz_0[j] = pa_x[j] * tt_x_xzzz_0[j] + 0.5 * fl1_fx * tt_0_xzzz_0[j] + 0.5 * fl1_fx * tt_x_zzz_0[j] + 2.0 * fl1_fz * ts_xx_xzzz_0[j] - fl1_fz * fl1_fga * ts_0_xzzz_0[j];

                tt_xx_yyyy_0[j] = pa_x[j] * tt_x_yyyy_0[j] + 0.5 * fl1_fx * tt_0_yyyy_0[j] + 2.0 * fl1_fz * ts_xx_yyyy_0[j] - fl1_fz * fl1_fga * ts_0_yyyy_0[j];

                tt_xx_yyyz_0[j] = pa_x[j] * tt_x_yyyz_0[j] + 0.5 * fl1_fx * tt_0_yyyz_0[j] + 2.0 * fl1_fz * ts_xx_yyyz_0[j] - fl1_fz * fl1_fga * ts_0_yyyz_0[j];

                tt_xx_yyzz_0[j] = pa_x[j] * tt_x_yyzz_0[j] + 0.5 * fl1_fx * tt_0_yyzz_0[j] + 2.0 * fl1_fz * ts_xx_yyzz_0[j] - fl1_fz * fl1_fga * ts_0_yyzz_0[j];

                tt_xx_yzzz_0[j] = pa_x[j] * tt_x_yzzz_0[j] + 0.5 * fl1_fx * tt_0_yzzz_0[j] + 2.0 * fl1_fz * ts_xx_yzzz_0[j] - fl1_fz * fl1_fga * ts_0_yzzz_0[j];

                tt_xx_zzzz_0[j] = pa_x[j] * tt_x_zzzz_0[j] + 0.5 * fl1_fx * tt_0_zzzz_0[j] + 2.0 * fl1_fz * ts_xx_zzzz_0[j] - fl1_fz * fl1_fga * ts_0_zzzz_0[j];
                                 ...
                                 const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tt_yy_xxxx_0[j] = pa_y[j] * tt_y_xxxx_0[j] + 0.5 * fl1_fx * tt_0_xxxx_0[j] + 2.0 * fl1_fz * ts_yy_xxxx_0[j] - fl1_fz * fl1_fga * ts_0_xxxx_0[j];

                tt_yy_xxxy_0[j] = pa_y[j] * tt_y_xxxy_0[j] + 0.5 * fl1_fx * tt_0_xxxy_0[j] + 0.5 * fl1_fx * tt_y_xxx_0[j] + 2.0 * fl1_fz * ts_yy_xxxy_0[j] - fl1_fz * fl1_fga * ts_0_xxxy_0[j];

                tt_yy_xxxz_0[j] = pa_y[j] * tt_y_xxxz_0[j] + 0.5 * fl1_fx * tt_0_xxxz_0[j] + 2.0 * fl1_fz * ts_yy_xxxz_0[j] - fl1_fz * fl1_fga * ts_0_xxxz_0[j];

                tt_yy_xxyy_0[j] = pa_y[j] * tt_y_xxyy_0[j] + 0.5 * fl1_fx * tt_0_xxyy_0[j] + fl1_fx * tt_y_xxy_0[j] + 2.0 * fl1_fz * ts_yy_xxyy_0[j] - fl1_fz * fl1_fga * ts_0_xxyy_0[j];

                tt_yy_xxyz_0[j] = pa_y[j] * tt_y_xxyz_0[j] + 0.5 * fl1_fx * tt_0_xxyz_0[j] + 0.5 * fl1_fx * tt_y_xxz_0[j] + 2.0 * fl1_fz * ts_yy_xxyz_0[j] - fl1_fz * fl1_fga * ts_0_xxyz_0[j];

                tt_yy_xxzz_0[j] = pa_y[j] * tt_y_xxzz_0[j] + 0.5 * fl1_fx * tt_0_xxzz_0[j] + 2.0 * fl1_fz * ts_yy_xxzz_0[j] - fl1_fz * fl1_fga * ts_0_xxzz_0[j];

                tt_yy_xyyy_0[j] = pa_y[j] * tt_y_xyyy_0[j] + 0.5 * fl1_fx * tt_0_xyyy_0[j] + 1.5 * fl1_fx * tt_y_xyy_0[j] + 2.0 * fl1_fz * ts_yy_xyyy_0[j] - fl1_fz * fl1_fga * ts_0_xyyy_0[j];

                tt_yy_xyyz_0[j] = pa_y[j] * tt_y_xyyz_0[j] + 0.5 * fl1_fx * tt_0_xyyz_0[j] + fl1_fx * tt_y_xyz_0[j] + 2.0 * fl1_fz * ts_yy_xyyz_0[j] - fl1_fz * fl1_fga * ts_0_xyyz_0[j];

                tt_yy_xyzz_0[j] = pa_y[j] * tt_y_xyzz_0[j] + 0.5 * fl1_fx * tt_0_xyzz_0[j] + 0.5 * fl1_fx * tt_y_xzz_0[j] + 2.0 * fl1_fz * ts_yy_xyzz_0[j] - fl1_fz * fl1_fga * ts_0_xyzz_0[j];

                tt_yy_xzzz_0[j] = pa_y[j] * tt_y_xzzz_0[j] + 0.5 * fl1_fx * tt_0_xzzz_0[j] + 2.0 * fl1_fz * ts_yy_xzzz_0[j] - fl1_fz * fl1_fga * ts_0_xzzz_0[j];

                tt_yy_yyyy_0[j] = pa_y[j] * tt_y_yyyy_0[j] + 0.5 * fl1_fx * tt_0_yyyy_0[j] + 2.0 * fl1_fx * tt_y_yyy_0[j] + 2.0 * fl1_fz * ts_yy_yyyy_0[j] - fl1_fz * fl1_fga * ts_0_yyyy_0[j];

                tt_yy_yyyz_0[j] = pa_y[j] * tt_y_yyyz_0[j] + 0.5 * fl1_fx * tt_0_yyyz_0[j] + 1.5 * fl1_fx * tt_y_yyz_0[j] + 2.0 * fl1_fz * ts_yy_yyyz_0[j] - fl1_fz * fl1_fga * ts_0_yyyz_0[j];

                tt_yy_yyzz_0[j] = pa_y[j] * tt_y_yyzz_0[j] + 0.5 * fl1_fx * tt_0_yyzz_0[j] + fl1_fx * tt_y_yzz_0[j] + 2.0 * fl1_fz * ts_yy_yyzz_0[j] - fl1_fz * fl1_fga * ts_0_yyzz_0[j];

                tt_yy_yzzz_0[j] = pa_y[j] * tt_y_yzzz_0[j] + 0.5 * fl1_fx * tt_0_yzzz_0[j] + 0.5 * fl1_fx * tt_y_zzz_0[j] + 2.0 * fl1_fz * ts_yy_yzzz_0[j] - fl1_fz * fl1_fga * ts_0_yzzz_0[j];

                tt_yy_zzzz_0[j] = pa_y[j] * tt_y_zzzz_0[j] + 0.5 * fl1_fx * tt_0_zzzz_0[j] + 2.0 * fl1_fz * ts_yy_zzzz_0[j] - fl1_fz * fl1_fga * ts_0_zzzz_0[j];
                ...
                tt_zz_xxxx_0[j] = pa_z[j] * tt_z_xxxx_0[j] + 0.5 * fl1_fx * tt_0_xxxx_0[j] + 2.0 * fl1_fz * ts_zz_xxxx_0[j] - fl1_fz * fl1_fga * ts_0_xxxx_0[j];

                tt_zz_xxxy_0[j] = pa_z[j] * tt_z_xxxy_0[j] + 0.5 * fl1_fx * tt_0_xxxy_0[j] + 2.0 * fl1_fz * ts_zz_xxxy_0[j] - fl1_fz * fl1_fga * ts_0_xxxy_0[j];

                tt_zz_xxxz_0[j] = pa_z[j] * tt_z_xxxz_0[j] + 0.5 * fl1_fx * tt_0_xxxz_0[j] + 0.5 * fl1_fx * tt_z_xxx_0[j] + 2.0 * fl1_fz * ts_zz_xxxz_0[j] - fl1_fz * fl1_fga * ts_0_xxxz_0[j];

                tt_zz_xxyy_0[j] = pa_z[j] * tt_z_xxyy_0[j] + 0.5 * fl1_fx * tt_0_xxyy_0[j] + 2.0 * fl1_fz * ts_zz_xxyy_0[j] - fl1_fz * fl1_fga * ts_0_xxyy_0[j];

                tt_zz_xxyz_0[j] = pa_z[j] * tt_z_xxyz_0[j] + 0.5 * fl1_fx * tt_0_xxyz_0[j] + 0.5 * fl1_fx * tt_z_xxy_0[j] + 2.0 * fl1_fz * ts_zz_xxyz_0[j] - fl1_fz * fl1_fga * ts_0_xxyz_0[j];

                tt_zz_xxzz_0[j] = pa_z[j] * tt_z_xxzz_0[j] + 0.5 * fl1_fx * tt_0_xxzz_0[j] + fl1_fx * tt_z_xxz_0[j] + 2.0 * fl1_fz * ts_zz_xxzz_0[j] - fl1_fz * fl1_fga * ts_0_xxzz_0[j];

                tt_zz_xyyy_0[j] = pa_z[j] * tt_z_xyyy_0[j] + 0.5 * fl1_fx * tt_0_xyyy_0[j] + 2.0 * fl1_fz * ts_zz_xyyy_0[j] - fl1_fz * fl1_fga * ts_0_xyyy_0[j];

                tt_zz_xyyz_0[j] = pa_z[j] * tt_z_xyyz_0[j] + 0.5 * fl1_fx * tt_0_xyyz_0[j] + 0.5 * fl1_fx * tt_z_xyy_0[j] + 2.0 * fl1_fz * ts_zz_xyyz_0[j] - fl1_fz * fl1_fga * ts_0_xyyz_0[j];

                tt_zz_xyzz_0[j] = pa_z[j] * tt_z_xyzz_0[j] + 0.5 * fl1_fx * tt_0_xyzz_0[j] + fl1_fx * tt_z_xyz_0[j] + 2.0 * fl1_fz * ts_zz_xyzz_0[j] - fl1_fz * fl1_fga * ts_0_xyzz_0[j];

                tt_zz_xzzz_0[j] = pa_z[j] * tt_z_xzzz_0[j] + 0.5 * fl1_fx * tt_0_xzzz_0[j] + 1.5 * fl1_fx * tt_z_xzz_0[j] + 2.0 * fl1_fz * ts_zz_xzzz_0[j] - fl1_fz * fl1_fga * ts_0_xzzz_0[j];

                tt_zz_yyyy_0[j] = pa_z[j] * tt_z_yyyy_0[j] + 0.5 * fl1_fx * tt_0_yyyy_0[j] + 2.0 * fl1_fz * ts_zz_yyyy_0[j] - fl1_fz * fl1_fga * ts_0_yyyy_0[j];

                tt_zz_yyyz_0[j] = pa_z[j] * tt_z_yyyz_0[j] + 0.5 * fl1_fx * tt_0_yyyz_0[j] + 0.5 * fl1_fx * tt_z_yyy_0[j] + 2.0 * fl1_fz * ts_zz_yyyz_0[j] - fl1_fz * fl1_fga * ts_0_yyyz_0[j];

                tt_zz_yyzz_0[j] = pa_z[j] * tt_z_yyzz_0[j] + 0.5 * fl1_fx * tt_0_yyzz_0[j] + fl1_fx * tt_z_yyz_0[j] + 2.0 * fl1_fz * ts_zz_yyzz_0[j] - fl1_fz * fl1_fga * ts_0_yyzz_0[j];

                tt_zz_yzzz_0[j] = pa_z[j] * tt_z_yzzz_0[j] + 0.5 * fl1_fx * tt_0_yzzz_0[j] + 1.5 * fl1_fx * tt_z_yzz_0[j] + 2.0 * fl1_fz * ts_zz_yzzz_0[j] - fl1_fz * fl1_fga * ts_0_yzzz_0[j];

                tt_zz_zzzz_0[j] = pa_z[j] * tt_z_zzzz_0[j] + 0.5 * fl1_fx * tt_0_zzzz_0[j] + 2.0 * fl1_fx * tt_z_zzz_0[j] + 2.0 * fl1_fz * ts_zz_zzzz_0[j] - fl1_fz * fl1_fga * ts_0_zzzz_0[j];
            }
    ...
    compKineticEnergyForGD(      CMemBlock2D<double>& primBuffer,
                           ...
                           const int32_t              iContrGto)
    {
        kinrecfunc::compKineticEnergyForGD_0_45(primBuffer,
                                                recursionMap,
                                                osFactors,
                                                paDistances, 
                                                braGtoBlock,
        ...
        kinrecfunc::compKineticEnergyForGD_45_90(primBuffer,
                                                 recursionMap,
                                                 osFactors,
                                                 paDistances, 
                                                 braGtoBlock,
                                ...
                                const int32_t              iContrGto)
    {
        ...
        auto pidx_t_4_2_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Kinetic Energy"}, 0, true, 
                                                         {4, -1, -1, -1}, {2, -1, -1, -1}, 
                                                         1, 1, 0));
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tt_xxxx_xx_0[j] = pa_x[j] * tt_xxx_xx_0[j] + 1.5 * fl1_fx * tt_xx_xx_0[j] + fl1_fx * tt_xxx_x_0[j] + 2.0 * fl1_fz * ts_xxxx_xx_0[j] - 3.0 * fl1_fz * fl1_fga * ts_xx_xx_0[j];

                tt_xxxx_xy_0[j] = pa_x[j] * tt_xxx_xy_0[j] + 1.5 * fl1_fx * tt_xx_xy_0[j] + 0.5 * fl1_fx * tt_xxx_y_0[j] + 2.0 * fl1_fz * ts_xxxx_xy_0[j] - 3.0 * fl1_fz * fl1_fga * ts_xx_xy_0[j];

                tt_xxxx_xz_0[j] = pa_x[j] * tt_xxx_xz_0[j] + 1.5 * fl1_fx * tt_xx_xz_0[j] + 0.5 * fl1_fx * tt_xxx_z_0[j] + 2.0 * fl1_fz * ts_xxxx_xz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_xx_xz_0[j];

                tt_xxxx_yy_0[j] = pa_x[j] * tt_xxx_yy_0[j] + 1.5 * fl1_fx * tt_xx_yy_0[j] + 2.0 * fl1_fz * ts_xxxx_yy_0[j] - 3.0 * fl1_fz * fl1_fga * ts_xx_yy_0[j];

                tt_xxxx_yz_0[j] = pa_x[j] * tt_xxx_yz_0[j] + 1.5 * fl1_fx * tt_xx_yz_0[j] + 2.0 * fl1_fz * ts_xxxx_yz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_xx_yz_0[j];

                tt_xxxx_zz_0[j] = pa_x[j] * tt_xxx_zz_0[j] + 1.5 * fl1_fx * tt_xx_zz_0[j] + 2.0 * fl1_fz * ts_xxxx_zz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_xx_zz_0[j];

                tt_xxxy_xx_0[j] = pa_x[j] * tt_xxy_xx_0[j] + fl1_fx * tt_xy_xx_0[j] + fl1_fx * tt_xxy_x_0[j] + 2.0 * fl1_fz * ts_xxxy_xx_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xy_xx_0[j];

                tt_xxxy_xy_0[j] = pa_x[j] * tt_xxy_xy_0[j] + fl1_fx * tt_xy_xy_0[j] + 0.5 * fl1_fx * tt_xxy_y_0[j] + 2.0 * fl1_fz * ts_xxxy_xy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xy_xy_0[j];

                tt_xxxy_xz_0[j] = pa_x[j] * tt_xxy_xz_0[j] + fl1_fx * tt_xy_xz_0[j] + 0.5 * fl1_fx * tt_xxy_z_0[j] + 2.0 * fl1_fz * ts_xxxy_xz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xy_xz_0[j];

                tt_xxxy_yy_0[j] = pa_x[j] * tt_xxy_yy_0[j] + fl1_fx * tt_xy_yy_0[j] + 2.0 * fl1_fz * ts_xxxy_yy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xy_yy_0[j];

                tt_xxxy_yz_0[j] = pa_x[j] * tt_xxy_yz_0[j] + fl1_fx * tt_xy_yz_0[j] + 2.0 * fl1_fz * ts_xxxy_yz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xy_yz_0[j];

                tt_xxxy_zz_0[j] = pa_x[j] * tt_xxy_zz_0[j] + fl1_fx * tt_xy_zz_0[j] + 2.0 * fl1_fz * ts_xxxy_zz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xy_zz_0[j];

                tt_xxxz_xx_0[j] = pa_x[j] * tt_xxz_xx_0[j] + fl1_fx * tt_xz_xx_0[j] + fl1_fx * tt_xxz_x_0[j] + 2.0 * fl1_fz * ts_xxxz_xx_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xz_xx_0[j];

                tt_xxxz_xy_0[j] = pa_x[j] * tt_xxz_xy_0[j] + fl1_fx * tt_xz_xy_0[j] + 0.5 * fl1_fx * tt_xxz_y_0[j] + 2.0 * fl1_fz * ts_xxxz_xy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xz_xy_0[j];

                tt_xxxz_xz_0[j] = pa_x[j] * tt_xxz_xz_0[j] + fl1_fx * tt_xz_xz_0[j] + 0.5 * fl1_fx * tt_xxz_z_0[j] + 2.0 * fl1_fz * ts_xxxz_xz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xz_xz_0[j];

                tt_xxxz_yy_0[j] = pa_x[j] * tt_xxz_yy_0[j] + fl1_fx * tt_xz_yy_0[j] + 2.0 * fl1_fz * ts_xxxz_yy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xz_yy_0[j];

                tt_xxxz_yz_0[j] = pa_x[j] * tt_xxz_yz_0[j] + fl1_fx * tt_xz_yz_0[j] + 2.0 * fl1_fz * ts_xxxz_yz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xz_yz_0[j];

                tt_xxxz_zz_0[j] = pa_x[j] * tt_xxz_zz_0[j] + fl1_fx * tt_xz_zz_0[j] + 2.0 * fl1_fz * ts_xxxz_zz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xz_zz_0[j];

                tt_xxyy_xx_0[j] = pa_x[j] * tt_xyy_xx_0[j] + 0.5 * fl1_fx * tt_yy_xx_0[j] + fl1_fx * tt_xyy_x_0[j] + 2.0 * fl1_fz * ts_xxyy_xx_0[j] - fl1_fz * fl1_fga * ts_yy_xx_0[j];

                tt_xxyy_xy_0[j] = pa_x[j] * tt_xyy_xy_0[j] + 0.5 * fl1_fx * tt_yy_xy_0[j] + 0.5 * fl1_fx * tt_xyy_y_0[j] + 2.0 * fl1_fz * ts_xxyy_xy_0[j] - fl1_fz * fl1_fga * ts_yy_xy_0[j];

                tt_xxyy_xz_0[j] = pa_x[j] * tt_xyy_xz_0[j] + 0.5 * fl1_fx * tt_yy_xz_0[j] + 0.5 * fl1_fx * tt_xyy_z_0[j] + 2.0 * fl1_fz * ts_xxyy_xz_0[j] - fl1_fz * fl1_fga * ts_yy_xz_0[j];

                tt_xxyy_yy_0[j] = pa_x[j] * tt_xyy_yy_0[j] + 0.5 * fl1_fx * tt_yy_yy_0[j] + 2.0 * fl1_fz * ts_xxyy_yy_0[j] - fl1_fz * fl1_fga * ts_yy_yy_0[j];

                tt_xxyy_yz_0[j] = pa_x[j] * tt_xyy_yz_0[j] + 0.5 * fl1_fx * tt_yy_yz_0[j] + 2.0 * fl1_fz * ts_xxyy_yz_0[j] - fl1_fz * fl1_fga * ts_yy_yz_0[j];

                tt_xxyy_zz_0[j] = pa_x[j] * tt_xyy_zz_0[j] + 0.5 * fl1_fx * tt_yy_zz_0[j] + 2.0 * fl1_fz * ts_xxyy_zz_0[j] - fl1_fz * fl1_fga * ts_yy_zz_0[j];

                tt_xxyz_xx_0[j] = pa_x[j] * tt_xyz_xx_0[j] + 0.5 * fl1_fx * tt_yz_xx_0[j] + fl1_fx * tt_xyz_x_0[j] + 2.0 * fl1_fz * ts_xxyz_xx_0[j] - fl1_fz * fl1_fga * ts_yz_xx_0[j];

                tt_xxyz_xy_0[j] = pa_x[j] * tt_xyz_xy_0[j] + 0.5 * fl1_fx * tt_yz_xy_0[j] + 0.5 * fl1_fx * tt_xyz_y_0[j] + 2.0 * fl1_fz * ts_xxyz_xy_0[j] - fl1_fz * fl1_fga * ts_yz_xy_0[j];

                tt_xxyz_xz_0[j] = pa_x[j] * tt_xyz_xz_0[j] + 0.5 * fl1_fx * tt_yz_xz_0[j] + 0.5 * fl1_fx * tt_xyz_z_0[j] + 2.0 * fl1_fz * ts_xxyz_xz_0[j] - fl1_fz * fl1_fga * ts_yz_xz_0[j];

                tt_xxyz_yy_0[j] = pa_x[j] * tt_xyz_yy_0[j] + 0.5 * fl1_fx * tt_yz_yy_0[j] + 2.0 * fl1_fz * ts_xxyz_yy_0[j] - fl1_fz * fl1_fga * ts_yz_yy_0[j];

                tt_xxyz_yz_0[j] = pa_x[j] * tt_xyz_yz_0[j] + 0.5 * fl1_fx * tt_yz_yz_0[j] + 2.0 * fl1_fz * ts_xxyz_yz_0[j] - fl1_fz * fl1_fga * ts_yz_yz_0[j];

                tt_xxyz_zz_0[j] = pa_x[j] * tt_xyz_zz_0[j] + 0.5 * fl1_fx * tt_yz_zz_0[j] + 2.0 * fl1_fz * ts_xxyz_zz_0[j] - fl1_fz * fl1_fga * ts_yz_zz_0[j];

                tt_xxzz_xx_0[j] = pa_x[j] * tt_xzz_xx_0[j] + 0.5 * fl1_fx * tt_zz_xx_0[j] + fl1_fx * tt_xzz_x_0[j] + 2.0 * fl1_fz * ts_xxzz_xx_0[j] - fl1_fz * fl1_fga * ts_zz_xx_0[j];

                tt_xxzz_xy_0[j] = pa_x[j] * tt_xzz_xy_0[j] + 0.5 * fl1_fx * tt_zz_xy_0[j] + 0.5 * fl1_fx * tt_xzz_y_0[j] + 2.0 * fl1_fz * ts_xxzz_xy_0[j] - fl1_fz * fl1_fga * ts_zz_xy_0[j];

                tt_xxzz_xz_0[j] = pa_x[j] * tt_xzz_xz_0[j] + 0.5 * fl1_fx * tt_zz_xz_0[j] + 0.5 * fl1_fx * tt_xzz_z_0[j] + 2.0 * fl1_fz * ts_xxzz_xz_0[j] - fl1_fz * fl1_fga * ts_zz_xz_0[j];

                tt_xxzz_yy_0[j] = pa_x[j] * tt_xzz_yy_0[j] + 0.5 * fl1_fx * tt_zz_yy_0[j] + 2.0 * fl1_fz * ts_xxzz_yy_0[j] - fl1_fz * fl1_fga * ts_zz_yy_0[j];

                tt_xxzz_yz_0[j] = pa_x[j] * tt_xzz_yz_0[j] + 0.5 * fl1_fx * tt_zz_yz_0[j] + 2.0 * fl1_fz * ts_xxzz_yz_0[j] - fl1_fz * fl1_fga * ts_zz_yz_0[j];

                tt_xxzz_zz_0[j] = pa_x[j] * tt_xzz_zz_0[j] + 0.5 * fl1_fx * tt_zz_zz_0[j] + 2.0 * fl1_fz * ts_xxzz_zz_0[j] - fl1_fz * fl1_fga * ts_zz_zz_0[j];
                                 ...
                                 const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tt_yyyy_xx_0[j] = pa_y[j] * tt_yyy_xx_0[j] + 1.5 * fl1_fx * tt_yy_xx_0[j] + 2.0 * fl1_fz * ts_yyyy_xx_0[j] - 3.0 * fl1_fz * fl1_fga * ts_yy_xx_0[j];

                tt_yyyy_xy_0[j] = pa_y[j] * tt_yyy_xy_0[j] + 1.5 * fl1_fx * tt_yy_xy_0[j] + 0.5 * fl1_fx * tt_yyy_x_0[j] + 2.0 * fl1_fz * ts_yyyy_xy_0[j] - 3.0 * fl1_fz * fl1_fga * ts_yy_xy_0[j];

                tt_yyyy_xz_0[j] = pa_y[j] * tt_yyy_xz_0[j] + 1.5 * fl1_fx * tt_yy_xz_0[j] + 2.0 * fl1_fz * ts_yyyy_xz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_yy_xz_0[j];

                tt_yyyy_yy_0[j] = pa_y[j] * tt_yyy_yy_0[j] + 1.5 * fl1_fx * tt_yy_yy_0[j] + fl1_fx * tt_yyy_y_0[j] + 2.0 * fl1_fz * ts_yyyy_yy_0[j] - 3.0 * fl1_fz * fl1_fga * ts_yy_yy_0[j];

                tt_yyyy_yz_0[j] = pa_y[j] * tt_yyy_yz_0[j] + 1.5 * fl1_fx * tt_yy_yz_0[j] + 0.5 * fl1_fx * tt_yyy_z_0[j] + 2.0 * fl1_fz * ts_yyyy_yz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_yy_yz_0[j];

                tt_yyyy_zz_0[j] = pa_y[j] * tt_yyy_zz_0[j] + 1.5 * fl1_fx * tt_yy_zz_0[j] + 2.0 * fl1_fz * ts_yyyy_zz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_yy_zz_0[j];

                tt_yyyz_xx_0[j] = pa_y[j] * tt_yyz_xx_0[j] + fl1_fx * tt_yz_xx_0[j] + 2.0 * fl1_fz * ts_yyyz_xx_0[j] - 2.0 * fl1_fz * fl1_fga * ts_yz_xx_0[j];

                tt_yyyz_xy_0[j] = pa_y[j] * tt_yyz_xy_0[j] + fl1_fx * tt_yz_xy_0[j] + 0.5 * fl1_fx * tt_yyz_x_0[j] + 2.0 * fl1_fz * ts_yyyz_xy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_yz_xy_0[j];

                tt_yyyz_xz_0[j] = pa_y[j] * tt_yyz_xz_0[j] + fl1_fx * tt_yz_xz_0[j] + 2.0 * fl1_fz * ts_yyyz_xz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_yz_xz_0[j];

                tt_yyyz_yy_0[j] = pa_y[j] * tt_yyz_yy_0[j] + fl1_fx * tt_yz_yy_0[j] + fl1_fx * tt_yyz_y_0[j] + 2.0 * fl1_fz * ts_yyyz_yy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_yz_yy_0[j];

                tt_yyyz_yz_0[j] = pa_y[j] * tt_yyz_yz_0[j] + fl1_fx * tt_yz_yz_0[j] + 0.5 * fl1_fx * tt_yyz_z_0[j] + 2.0 * fl1_fz * ts_yyyz_yz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_yz_yz_0[j];

                tt_yyyz_zz_0[j] = pa_y[j] * tt_yyz_zz_0[j] + fl1_fx * tt_yz_zz_0[j] + 2.0 * fl1_fz * ts_yyyz_zz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_yz_zz_0[j];

                tt_yyzz_xx_0[j] = pa_y[j] * tt_yzz_xx_0[j] + 0.5 * fl1_fx * tt_zz_xx_0[j] + 2.0 * fl1_fz * ts_yyzz_xx_0[j] - fl1_fz * fl1_fga * ts_zz_xx_0[j];

                tt_yyzz_xy_0[j] = pa_y[j] * tt_yzz_xy_0[j] + 0.5 * fl1_fx * tt_zz_xy_0[j] + 0.5 * fl1_fx * tt_yzz_x_0[j] + 2.0 * fl1_fz * ts_yyzz_xy_0[j] - fl1_fz * fl1_fga * ts_zz_xy_0[j];

                tt_yyzz_xz_0[j] = pa_y[j] * tt_yzz_xz_0[j] + 0.5 * fl1_fx * tt_zz_xz_0[j] + 2.0 * fl1_fz * ts_yyzz_xz_0[j] - fl1_fz * fl1_fga * ts_zz_xz_0[j];

                tt_yyzz_yy_0[j] = pa_y[j] * tt_yzz_yy_0[j] + 0.5 * fl1_fx * tt_zz_yy_0[j] + fl1_fx * tt_yzz_y_0[j] + 2.0 * fl1_fz * ts_yyzz_yy_0[j] - fl1_fz * fl1_fga * ts_zz_yy_0[j];

                tt_yyzz_yz_0[j] = pa_y[j] * tt_yzz_yz_0[j] + 0.5 * fl1_fx * tt_zz_yz_0[j] + 0.5 * fl1_fx * tt_yzz_z_0[j] + 2.0 * fl1_fz * ts_yyzz_yz_0[j] - fl1_fz * fl1_fga * ts_zz_yz_0[j];

                tt_yyzz_zz_0[j] = pa_y[j] * tt_yzz_zz_0[j] + 0.5 * fl1_fx * tt_zz_zz_0[j] + 2.0 * fl1_fz * ts_yyzz_zz_0[j] - fl1_fz * fl1_fga * ts_zz_zz_0[j];
                ...
                tt_zzzz_xx_0[j] = pa_z[j] * tt_zzz_xx_0[j] + 1.5 * fl1_fx * tt_zz_xx_0[j] + 2.0 * fl1_fz * ts_zzzz_xx_0[j] - 3.0 * fl1_fz * fl1_fga * ts_zz_xx_0[j];

                tt_zzzz_xy_0[j] = pa_z[j] * tt_zzz_xy_0[j] + 1.5 * fl1_fx * tt_zz_xy_0[j] + 2.0 * fl1_fz * ts_zzzz_xy_0[j] - 3.0 * fl1_fz * fl1_fga * ts_zz_xy_0[j];

                tt_zzzz_xz_0[j] = pa_z[j] * tt_zzz_xz_0[j] + 1.5 * fl1_fx * tt_zz_xz_0[j] + 0.5 * fl1_fx * tt_zzz_x_0[j] + 2.0 * fl1_fz * ts_zzzz_xz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_zz_xz_0[j];

                tt_zzzz_yy_0[j] = pa_z[j] * tt_zzz_yy_0[j] + 1.5 * fl1_fx * tt_zz_yy_0[j] + 2.0 * fl1_fz * ts_zzzz_yy_0[j] - 3.0 * fl1_fz * fl1_fga * ts_zz_yy_0[j];

                tt_zzzz_yz_0[j] = pa_z[j] * tt_zzz_yz_0[j] + 1.5 * fl1_fx * tt_zz_yz_0[j] + 0.5 * fl1_fx * tt_zzz_y_0[j] + 2.0 * fl1_fz * ts_zzzz_yz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_zz_yz_0[j];

                tt_zzzz_zz_0[j] = pa_z[j] * tt_zzz_zz_0[j] + 1.5 * fl1_fx * tt_zz_zz_0[j] + fl1_fx * tt_zzz_z_0[j] + 2.0 * fl1_fz * ts_zzzz_zz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_zz_zz_0[j];
            }
