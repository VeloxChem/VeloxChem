...
#include "OverlapVecFuncForPX.hpp"
...
namespace ovlrecfunc { // ovlrecfunc namespace
                     ...
                     const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            {
                t_x_x[j] = ovlvecfunc::fvec_x_x_s_0(fx[j], pa_x[j], pb_x[j], s_0_0[j]);

                t_x_y[j] = ovlvecfunc::fvec_x_y_s_0(pa_x[j], pb_y[j], s_0_0[j]);

                t_x_z[j] = ovlvecfunc::fvec_x_z_s_0(pa_x[j], pb_z[j], s_0_0[j]);

                t_y_x[j] = ovlvecfunc::fvec_y_x_s_0(pa_y[j], pb_x[j], s_0_0[j]);

                t_y_y[j] = ovlvecfunc::fvec_y_y_s_0(fx[j], pa_y[j], pb_y[j], s_0_0[j]);

                t_y_z[j] = ovlvecfunc::fvec_y_z_s_0(pa_y[j], pb_z[j], s_0_0[j]);

                t_z_x[j] = ovlvecfunc::fvec_z_x_s_0(pa_z[j], pb_x[j], s_0_0[j]);

                t_z_y[j] = ovlvecfunc::fvec_z_y_s_0(pa_z[j], pb_y[j], s_0_0[j]);

                t_z_z[j] = ovlvecfunc::fvec_z_z_s_0(fx[j], pa_z[j], pb_z[j], s_0_0[j]);
            }
                     ...
                     const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                t_x_xx[j] = ovlvecfunc::fvec_x_xx_s_0(fx[j], pa_x[j], pb_x[j], pb_xx[j], s_0_0[j]);

                t_x_xy[j] = ovlvecfunc::fvec_x_xy_s_0(fx[j], pa_x[j], pb_xy[j], pb_y[j], s_0_0[j]);

                t_x_xz[j] = ovlvecfunc::fvec_x_xz_s_0(fx[j], pa_x[j], pb_xz[j], pb_z[j], s_0_0[j]);

                t_x_yy[j] = ovlvecfunc::fvec_x_yy_s_0(fx[j], pa_x[j], pb_yy[j], s_0_0[j]);

                t_x_yz[j] = ovlvecfunc::fvec_x_yz_s_0(pa_x[j], pb_yz[j], s_0_0[j]);

                t_x_zz[j] = ovlvecfunc::fvec_x_zz_s_0(fx[j], pa_x[j], pb_zz[j], s_0_0[j]);

                t_y_xx[j] = ovlvecfunc::fvec_y_xx_s_0(fx[j], pa_y[j], pb_xx[j], s_0_0[j]);

                t_y_xy[j] = ovlvecfunc::fvec_y_xy_s_0(fx[j], pa_y[j], pb_x[j], pb_xy[j], s_0_0[j]);

                t_y_xz[j] = ovlvecfunc::fvec_y_xz_s_0(pa_y[j], pb_xz[j], s_0_0[j]);
            }
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                t_y_yy[j] = ovlvecfunc::fvec_y_yy_s_0(fx[j], pa_y[j], pb_y[j], pb_yy[j], s_0_0[j]);

                t_y_yz[j] = ovlvecfunc::fvec_y_yz_s_0(fx[j], pa_y[j], pb_yz[j], pb_z[j], s_0_0[j]);

                t_y_zz[j] = ovlvecfunc::fvec_y_zz_s_0(fx[j], pa_y[j], pb_zz[j], s_0_0[j]);

                t_z_xx[j] = ovlvecfunc::fvec_z_xx_s_0(fx[j], pa_z[j], pb_xx[j], s_0_0[j]);

                t_z_xy[j] = ovlvecfunc::fvec_z_xy_s_0(pa_z[j], pb_xy[j], s_0_0[j]);

                t_z_xz[j] = ovlvecfunc::fvec_z_xz_s_0(fx[j], pa_z[j], pb_x[j], pb_xz[j], s_0_0[j]);

                t_z_yy[j] = ovlvecfunc::fvec_z_yy_s_0(fx[j], pa_z[j], pb_yy[j], s_0_0[j]);

                t_z_yz[j] = ovlvecfunc::fvec_z_yz_s_0(fx[j], pa_z[j], pb_y[j], pb_yz[j], s_0_0[j]);

                t_z_zz[j] = ovlvecfunc::fvec_z_zz_s_0(fx[j], pa_z[j], pb_z[j], pb_zz[j], s_0_0[j]);
            }
                     ...
                     const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                t_xx_x[j] = ovlvecfunc::fvec_xx_x_s_0(fx[j], pa_x[j], pa_xx[j], pb_x[j], s_0_0[j]);

                t_xx_y[j] = ovlvecfunc::fvec_xx_y_s_0(fx[j], pa_xx[j], pb_y[j], s_0_0[j]);

                t_xx_z[j] = ovlvecfunc::fvec_xx_z_s_0(fx[j], pa_xx[j], pb_z[j], s_0_0[j]);

                t_xy_x[j] = ovlvecfunc::fvec_xy_x_s_0(fx[j], pa_xy[j], pa_y[j], pb_x[j], s_0_0[j]);

                t_xy_y[j] = ovlvecfunc::fvec_xy_y_s_0(fx[j], pa_x[j], pa_xy[j], pb_y[j], s_0_0[j]);

                t_xy_z[j] = ovlvecfunc::fvec_xy_z_s_0(pa_xy[j], pb_z[j], s_0_0[j]);

                t_xz_x[j] = ovlvecfunc::fvec_xz_x_s_0(fx[j], pa_xz[j], pa_z[j], pb_x[j], s_0_0[j]);

                t_xz_y[j] = ovlvecfunc::fvec_xz_y_s_0(pa_xz[j], pb_y[j], s_0_0[j]);

                t_xz_z[j] = ovlvecfunc::fvec_xz_z_s_0(fx[j], pa_x[j], pa_xz[j], pb_z[j], s_0_0[j]);
            }
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                t_yy_x[j] = ovlvecfunc::fvec_yy_x_s_0(fx[j], pa_yy[j], pb_x[j], s_0_0[j]);

                t_yy_y[j] = ovlvecfunc::fvec_yy_y_s_0(fx[j], pa_y[j], pa_yy[j], pb_y[j], s_0_0[j]);

                t_yy_z[j] = ovlvecfunc::fvec_yy_z_s_0(fx[j], pa_yy[j], pb_z[j], s_0_0[j]);

                t_yz_x[j] = ovlvecfunc::fvec_yz_x_s_0(pa_yz[j], pb_x[j], s_0_0[j]);

                t_yz_y[j] = ovlvecfunc::fvec_yz_y_s_0(fx[j], pa_yz[j], pa_z[j], pb_y[j], s_0_0[j]);

                t_yz_z[j] = ovlvecfunc::fvec_yz_z_s_0(fx[j], pa_y[j], pa_yz[j], pb_z[j], s_0_0[j]);

                t_zz_x[j] = ovlvecfunc::fvec_zz_x_s_0(fx[j], pa_zz[j], pb_x[j], s_0_0[j]);

                t_zz_y[j] = ovlvecfunc::fvec_zz_y_s_0(fx[j], pa_zz[j], pb_y[j], s_0_0[j]);

                t_zz_z[j] = ovlvecfunc::fvec_zz_z_s_0(fx[j], pa_z[j], pa_zz[j], pb_z[j], s_0_0[j]);
            }
                     ...
                     const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                t_x_xxx[j] = ovlvecfunc::fvec_x_xxx_s_0(fx[j], pa_x[j], pb_x[j], pb_xx[j], pb_xxx[j], s_0_0[j]);

                t_x_xxy[j] = ovlvecfunc::fvec_x_xxy_s_0(fx[j], pa_x[j], pb_xxy[j], pb_xy[j], pb_y[j], s_0_0[j]);

                t_x_xxz[j] = ovlvecfunc::fvec_x_xxz_s_0(fx[j], pa_x[j], pb_xxz[j], pb_xz[j], pb_z[j], s_0_0[j]);

                t_x_xyy[j] = ovlvecfunc::fvec_x_xyy_s_0(fx[j], pa_x[j], pb_x[j], pb_xyy[j], pb_yy[j], s_0_0[j]);

                t_x_xyz[j] = ovlvecfunc::fvec_x_xyz_s_0(fx[j], pa_x[j], pb_xyz[j], pb_yz[j], s_0_0[j]);

                t_x_xzz[j] = ovlvecfunc::fvec_x_xzz_s_0(fx[j], pa_x[j], pb_x[j], pb_xzz[j], pb_zz[j], s_0_0[j]);

                t_x_yyy[j] = ovlvecfunc::fvec_x_yyy_s_0(fx[j], pa_x[j], pb_y[j], pb_yyy[j], s_0_0[j]);

                t_x_yyz[j] = ovlvecfunc::fvec_x_yyz_s_0(fx[j], pa_x[j], pb_yyz[j], pb_z[j], s_0_0[j]);

                t_x_yzz[j] = ovlvecfunc::fvec_x_yzz_s_0(fx[j], pa_x[j], pb_y[j], pb_yzz[j], s_0_0[j]);

                t_x_zzz[j] = ovlvecfunc::fvec_x_zzz_s_0(fx[j], pa_x[j], pb_z[j], pb_zzz[j], s_0_0[j]);

                t_y_xxx[j] = ovlvecfunc::fvec_y_xxx_s_0(fx[j], pa_y[j], pb_x[j], pb_xxx[j], s_0_0[j]);

                t_y_xxy[j] = ovlvecfunc::fvec_y_xxy_s_0(fx[j], pa_y[j], pb_xx[j], pb_xxy[j], pb_y[j], s_0_0[j]);

                t_y_xxz[j] = ovlvecfunc::fvec_y_xxz_s_0(fx[j], pa_y[j], pb_xxz[j], pb_z[j], s_0_0[j]);

                t_y_xyy[j] = ovlvecfunc::fvec_y_xyy_s_0(fx[j], pa_y[j], pb_x[j], pb_xy[j], pb_xyy[j], s_0_0[j]);

                t_y_xyz[j] = ovlvecfunc::fvec_y_xyz_s_0(fx[j], pa_y[j], pb_xyz[j], pb_xz[j], s_0_0[j]);
            }
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                t_y_xzz[j] = ovlvecfunc::fvec_y_xzz_s_0(fx[j], pa_y[j], pb_x[j], pb_xzz[j], s_0_0[j]);

                t_y_yyy[j] = ovlvecfunc::fvec_y_yyy_s_0(fx[j], pa_y[j], pb_y[j], pb_yy[j], pb_yyy[j], s_0_0[j]);

                t_y_yyz[j] = ovlvecfunc::fvec_y_yyz_s_0(fx[j], pa_y[j], pb_yyz[j], pb_yz[j], pb_z[j], s_0_0[j]);

                t_y_yzz[j] = ovlvecfunc::fvec_y_yzz_s_0(fx[j], pa_y[j], pb_y[j], pb_yzz[j], pb_zz[j], s_0_0[j]);

                t_y_zzz[j] = ovlvecfunc::fvec_y_zzz_s_0(fx[j], pa_y[j], pb_z[j], pb_zzz[j], s_0_0[j]);

                t_z_xxx[j] = ovlvecfunc::fvec_z_xxx_s_0(fx[j], pa_z[j], pb_x[j], pb_xxx[j], s_0_0[j]);

                t_z_xxy[j] = ovlvecfunc::fvec_z_xxy_s_0(fx[j], pa_z[j], pb_xxy[j], pb_y[j], s_0_0[j]);

                t_z_xxz[j] = ovlvecfunc::fvec_z_xxz_s_0(fx[j], pa_z[j], pb_xx[j], pb_xxz[j], pb_z[j], s_0_0[j]);

                t_z_xyy[j] = ovlvecfunc::fvec_z_xyy_s_0(fx[j], pa_z[j], pb_x[j], pb_xyy[j], s_0_0[j]);

                t_z_xyz[j] = ovlvecfunc::fvec_z_xyz_s_0(fx[j], pa_z[j], pb_xy[j], pb_xyz[j], s_0_0[j]);

                t_z_xzz[j] = ovlvecfunc::fvec_z_xzz_s_0(fx[j], pa_z[j], pb_x[j], pb_xz[j], pb_xzz[j], s_0_0[j]);

                t_z_yyy[j] = ovlvecfunc::fvec_z_yyy_s_0(fx[j], pa_z[j], pb_y[j], pb_yyy[j], s_0_0[j]);

                t_z_yyz[j] = ovlvecfunc::fvec_z_yyz_s_0(fx[j], pa_z[j], pb_yy[j], pb_yyz[j], pb_z[j], s_0_0[j]);

                t_z_yzz[j] = ovlvecfunc::fvec_z_yzz_s_0(fx[j], pa_z[j], pb_y[j], pb_yz[j], pb_yzz[j], s_0_0[j]);

                t_z_zzz[j] = ovlvecfunc::fvec_z_zzz_s_0(fx[j], pa_z[j], pb_z[j], pb_zz[j], pb_zzz[j], s_0_0[j]);
            }
                     ...
                     const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                t_xxx_x[j] = ovlvecfunc::fvec_xxx_x_s_0(fx[j], pa_x[j], pa_xx[j], pa_xxx[j], pb_x[j], s_0_0[j]);

                t_xxx_y[j] = ovlvecfunc::fvec_xxx_y_s_0(fx[j], pa_x[j], pa_xxx[j], pb_y[j], s_0_0[j]);

                t_xxx_z[j] = ovlvecfunc::fvec_xxx_z_s_0(fx[j], pa_x[j], pa_xxx[j], pb_z[j], s_0_0[j]);

                t_xxy_x[j] = ovlvecfunc::fvec_xxy_x_s_0(fx[j], pa_xxy[j], pa_xy[j], pa_y[j], pb_x[j], s_0_0[j]);

                t_xxy_y[j] = ovlvecfunc::fvec_xxy_y_s_0(fx[j], pa_xx[j], pa_xxy[j], pa_y[j], pb_y[j], s_0_0[j]);

                t_xxy_z[j] = ovlvecfunc::fvec_xxy_z_s_0(fx[j], pa_xxy[j], pa_y[j], pb_z[j], s_0_0[j]);

                t_xxz_x[j] = ovlvecfunc::fvec_xxz_x_s_0(fx[j], pa_xxz[j], pa_xz[j], pa_z[j], pb_x[j], s_0_0[j]);

                t_xxz_y[j] = ovlvecfunc::fvec_xxz_y_s_0(fx[j], pa_xxz[j], pa_z[j], pb_y[j], s_0_0[j]);

                t_xxz_z[j] = ovlvecfunc::fvec_xxz_z_s_0(fx[j], pa_xx[j], pa_xxz[j], pa_z[j], pb_z[j], s_0_0[j]);

                t_xyy_x[j] = ovlvecfunc::fvec_xyy_x_s_0(fx[j], pa_x[j], pa_xyy[j], pa_yy[j], pb_x[j], s_0_0[j]);

                t_xyy_y[j] = ovlvecfunc::fvec_xyy_y_s_0(fx[j], pa_x[j], pa_xy[j], pa_xyy[j], pb_y[j], s_0_0[j]);

                t_xyy_z[j] = ovlvecfunc::fvec_xyy_z_s_0(fx[j], pa_x[j], pa_xyy[j], pb_z[j], s_0_0[j]);

                t_xyz_x[j] = ovlvecfunc::fvec_xyz_x_s_0(fx[j], pa_xyz[j], pa_yz[j], pb_x[j], s_0_0[j]);

                t_xyz_y[j] = ovlvecfunc::fvec_xyz_y_s_0(fx[j], pa_xyz[j], pa_xz[j], pb_y[j], s_0_0[j]);

                t_xyz_z[j] = ovlvecfunc::fvec_xyz_z_s_0(fx[j], pa_xy[j], pa_xyz[j], pb_z[j], s_0_0[j]);
            }
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                t_xzz_x[j] = ovlvecfunc::fvec_xzz_x_s_0(fx[j], pa_x[j], pa_xzz[j], pa_zz[j], pb_x[j], s_0_0[j]);

                t_xzz_y[j] = ovlvecfunc::fvec_xzz_y_s_0(fx[j], pa_x[j], pa_xzz[j], pb_y[j], s_0_0[j]);

                t_xzz_z[j] = ovlvecfunc::fvec_xzz_z_s_0(fx[j], pa_x[j], pa_xz[j], pa_xzz[j], pb_z[j], s_0_0[j]);

                t_yyy_x[j] = ovlvecfunc::fvec_yyy_x_s_0(fx[j], pa_y[j], pa_yyy[j], pb_x[j], s_0_0[j]);

                t_yyy_y[j] = ovlvecfunc::fvec_yyy_y_s_0(fx[j], pa_y[j], pa_yy[j], pa_yyy[j], pb_y[j], s_0_0[j]);

                t_yyy_z[j] = ovlvecfunc::fvec_yyy_z_s_0(fx[j], pa_y[j], pa_yyy[j], pb_z[j], s_0_0[j]);

                t_yyz_x[j] = ovlvecfunc::fvec_yyz_x_s_0(fx[j], pa_yyz[j], pa_z[j], pb_x[j], s_0_0[j]);

                t_yyz_y[j] = ovlvecfunc::fvec_yyz_y_s_0(fx[j], pa_yyz[j], pa_yz[j], pa_z[j], pb_y[j], s_0_0[j]);

                t_yyz_z[j] = ovlvecfunc::fvec_yyz_z_s_0(fx[j], pa_yy[j], pa_yyz[j], pa_z[j], pb_z[j], s_0_0[j]);

                t_yzz_x[j] = ovlvecfunc::fvec_yzz_x_s_0(fx[j], pa_y[j], pa_yzz[j], pb_x[j], s_0_0[j]);

                t_yzz_y[j] = ovlvecfunc::fvec_yzz_y_s_0(fx[j], pa_y[j], pa_yzz[j], pa_zz[j], pb_y[j], s_0_0[j]);

                t_yzz_z[j] = ovlvecfunc::fvec_yzz_z_s_0(fx[j], pa_y[j], pa_yz[j], pa_yzz[j], pb_z[j], s_0_0[j]);

                t_zzz_x[j] = ovlvecfunc::fvec_zzz_x_s_0(fx[j], pa_z[j], pa_zzz[j], pb_x[j], s_0_0[j]);

                t_zzz_y[j] = ovlvecfunc::fvec_zzz_y_s_0(fx[j], pa_z[j], pa_zzz[j], pb_y[j], s_0_0[j]);

                t_zzz_z[j] = ovlvecfunc::fvec_zzz_z_s_0(fx[j], pa_z[j], pa_zz[j], pa_zzz[j], pb_z[j], s_0_0[j]);
            }
                     ...
                     const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                t_x_xxxx[j] = ovlvecfunc::fvec_x_xxxx_s_0(fx[j], pa_x[j], pb_x[j], pb_xx[j], pb_xxx[j], pb_xxxx[j], s_0_0[j]);

                t_x_xxxy[j] = ovlvecfunc::fvec_x_xxxy_s_0(fx[j], pa_x[j], pb_xxxy[j], pb_xxy[j], pb_xy[j], pb_y[j], s_0_0[j]);

                t_x_xxxz[j] = ovlvecfunc::fvec_x_xxxz_s_0(fx[j], pa_x[j], pb_xxxz[j], pb_xxz[j], pb_xz[j], pb_z[j], s_0_0[j]);

                t_x_xxyy[j] = ovlvecfunc::fvec_x_xxyy_s_0(fx[j], pa_x[j], pb_x[j], pb_xx[j], pb_xxyy[j], pb_xyy[j], pb_yy[j], s_0_0[j]);

                t_x_xxyz[j] = ovlvecfunc::fvec_x_xxyz_s_0(fx[j], pa_x[j], pb_xxyz[j], pb_xyz[j], pb_yz[j], s_0_0[j]);

                t_x_xxzz[j] = ovlvecfunc::fvec_x_xxzz_s_0(fx[j], pa_x[j], pb_x[j], pb_xx[j], pb_xxzz[j], pb_xzz[j], pb_zz[j], s_0_0[j]);

                t_x_xyyy[j] = ovlvecfunc::fvec_x_xyyy_s_0(fx[j], pa_x[j], pb_xy[j], pb_xyyy[j], pb_y[j], pb_yyy[j], s_0_0[j]);

                t_x_xyyz[j] = ovlvecfunc::fvec_x_xyyz_s_0(fx[j], pa_x[j], pb_xyyz[j], pb_xz[j], pb_yyz[j], pb_z[j], s_0_0[j]);

                t_x_xyzz[j] = ovlvecfunc::fvec_x_xyzz_s_0(fx[j], pa_x[j], pb_xy[j], pb_xyzz[j], pb_y[j], pb_yzz[j], s_0_0[j]);
            }
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                t_x_xzzz[j] = ovlvecfunc::fvec_x_xzzz_s_0(fx[j], pa_x[j], pb_xz[j], pb_xzzz[j], pb_z[j], pb_zzz[j], s_0_0[j]);

                t_x_yyyy[j] = ovlvecfunc::fvec_x_yyyy_s_0(fx[j], pa_x[j], pb_yy[j], pb_yyyy[j], s_0_0[j]);

                t_x_yyyz[j] = ovlvecfunc::fvec_x_yyyz_s_0(fx[j], pa_x[j], pb_yyyz[j], pb_yz[j], s_0_0[j]);

                t_x_yyzz[j] = ovlvecfunc::fvec_x_yyzz_s_0(fx[j], pa_x[j], pb_yy[j], pb_yyzz[j], pb_zz[j], s_0_0[j]);

                t_x_yzzz[j] = ovlvecfunc::fvec_x_yzzz_s_0(fx[j], pa_x[j], pb_yz[j], pb_yzzz[j], s_0_0[j]);

                t_x_zzzz[j] = ovlvecfunc::fvec_x_zzzz_s_0(fx[j], pa_x[j], pb_zz[j], pb_zzzz[j], s_0_0[j]);

                t_y_xxxx[j] = ovlvecfunc::fvec_y_xxxx_s_0(fx[j], pa_y[j], pb_xx[j], pb_xxxx[j], s_0_0[j]);

                t_y_xxxy[j] = ovlvecfunc::fvec_y_xxxy_s_0(fx[j], pa_y[j], pb_x[j], pb_xxx[j], pb_xxxy[j], pb_xy[j], s_0_0[j]);

                t_y_xxxz[j] = ovlvecfunc::fvec_y_xxxz_s_0(fx[j], pa_y[j], pb_xxxz[j], pb_xz[j], s_0_0[j]);
            }
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                t_y_xxyy[j] = ovlvecfunc::fvec_y_xxyy_s_0(fx[j], pa_y[j], pb_xx[j], pb_xxy[j], pb_xxyy[j], pb_y[j], pb_yy[j], s_0_0[j]);

                t_y_xxyz[j] = ovlvecfunc::fvec_y_xxyz_s_0(fx[j], pa_y[j], pb_xxyz[j], pb_xxz[j], pb_yz[j], pb_z[j], s_0_0[j]);

                t_y_xxzz[j] = ovlvecfunc::fvec_y_xxzz_s_0(fx[j], pa_y[j], pb_xx[j], pb_xxzz[j], pb_zz[j], s_0_0[j]);

                t_y_xyyy[j] = ovlvecfunc::fvec_y_xyyy_s_0(fx[j], pa_y[j], pb_x[j], pb_xy[j], pb_xyy[j], pb_xyyy[j], s_0_0[j]);

                t_y_xyyz[j] = ovlvecfunc::fvec_y_xyyz_s_0(fx[j], pa_y[j], pb_xyyz[j], pb_xyz[j], pb_xz[j], s_0_0[j]);

                t_y_xyzz[j] = ovlvecfunc::fvec_y_xyzz_s_0(fx[j], pa_y[j], pb_x[j], pb_xy[j], pb_xyzz[j], pb_xzz[j], s_0_0[j]);

                t_y_xzzz[j] = ovlvecfunc::fvec_y_xzzz_s_0(fx[j], pa_y[j], pb_xz[j], pb_xzzz[j], s_0_0[j]);

                t_y_yyyy[j] = ovlvecfunc::fvec_y_yyyy_s_0(fx[j], pa_y[j], pb_y[j], pb_yy[j], pb_yyy[j], pb_yyyy[j], s_0_0[j]);

                t_y_yyyz[j] = ovlvecfunc::fvec_y_yyyz_s_0(fx[j], pa_y[j], pb_yyyz[j], pb_yyz[j], pb_yz[j], pb_z[j], s_0_0[j]);
            }
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                t_y_yyzz[j] = ovlvecfunc::fvec_y_yyzz_s_0(fx[j], pa_y[j], pb_y[j], pb_yy[j], pb_yyzz[j], pb_yzz[j], pb_zz[j], s_0_0[j]);

                t_y_yzzz[j] = ovlvecfunc::fvec_y_yzzz_s_0(fx[j], pa_y[j], pb_yz[j], pb_yzzz[j], pb_z[j], pb_zzz[j], s_0_0[j]);

                t_y_zzzz[j] = ovlvecfunc::fvec_y_zzzz_s_0(fx[j], pa_y[j], pb_zz[j], pb_zzzz[j], s_0_0[j]);

                t_z_xxxx[j] = ovlvecfunc::fvec_z_xxxx_s_0(fx[j], pa_z[j], pb_xx[j], pb_xxxx[j], s_0_0[j]);

                t_z_xxxy[j] = ovlvecfunc::fvec_z_xxxy_s_0(fx[j], pa_z[j], pb_xxxy[j], pb_xy[j], s_0_0[j]);

                t_z_xxxz[j] = ovlvecfunc::fvec_z_xxxz_s_0(fx[j], pa_z[j], pb_x[j], pb_xxx[j], pb_xxxz[j], pb_xz[j], s_0_0[j]);

                t_z_xxyy[j] = ovlvecfunc::fvec_z_xxyy_s_0(fx[j], pa_z[j], pb_xx[j], pb_xxyy[j], pb_yy[j], s_0_0[j]);

                t_z_xxyz[j] = ovlvecfunc::fvec_z_xxyz_s_0(fx[j], pa_z[j], pb_xxy[j], pb_xxyz[j], pb_y[j], pb_yz[j], s_0_0[j]);

                t_z_xxzz[j] = ovlvecfunc::fvec_z_xxzz_s_0(fx[j], pa_z[j], pb_xx[j], pb_xxz[j], pb_xxzz[j], pb_z[j], pb_zz[j], s_0_0[j]);
            }
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                t_z_xyyy[j] = ovlvecfunc::fvec_z_xyyy_s_0(fx[j], pa_z[j], pb_xy[j], pb_xyyy[j], s_0_0[j]);

                t_z_xyyz[j] = ovlvecfunc::fvec_z_xyyz_s_0(fx[j], pa_z[j], pb_x[j], pb_xyy[j], pb_xyyz[j], pb_xz[j], s_0_0[j]);

                t_z_xyzz[j] = ovlvecfunc::fvec_z_xyzz_s_0(fx[j], pa_z[j], pb_xy[j], pb_xyz[j], pb_xyzz[j], s_0_0[j]);

                t_z_xzzz[j] = ovlvecfunc::fvec_z_xzzz_s_0(fx[j], pa_z[j], pb_x[j], pb_xz[j], pb_xzz[j], pb_xzzz[j], s_0_0[j]);

                t_z_yyyy[j] = ovlvecfunc::fvec_z_yyyy_s_0(fx[j], pa_z[j], pb_yy[j], pb_yyyy[j], s_0_0[j]);

                t_z_yyyz[j] = ovlvecfunc::fvec_z_yyyz_s_0(fx[j], pa_z[j], pb_y[j], pb_yyy[j], pb_yyyz[j], pb_yz[j], s_0_0[j]);

                t_z_yyzz[j] = ovlvecfunc::fvec_z_yyzz_s_0(fx[j], pa_z[j], pb_yy[j], pb_yyz[j], pb_yyzz[j], pb_z[j], pb_zz[j], s_0_0[j]);

                t_z_yzzz[j] = ovlvecfunc::fvec_z_yzzz_s_0(fx[j], pa_z[j], pb_y[j], pb_yz[j], pb_yzz[j], pb_yzzz[j], s_0_0[j]);

                t_z_zzzz[j] = ovlvecfunc::fvec_z_zzzz_s_0(fx[j], pa_z[j], pb_z[j], pb_zz[j], pb_zzz[j], pb_zzzz[j], s_0_0[j]);
            }
                     ...
                     const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                t_xxxx_x[j] = ovlvecfunc::fvec_xxxx_x_s_0(fx[j], pa_x[j], pa_xx[j], pa_xxx[j], pa_xxxx[j], pb_x[j], s_0_0[j]);

                t_xxxx_y[j] = ovlvecfunc::fvec_xxxx_y_s_0(fx[j], pa_xx[j], pa_xxxx[j], pb_y[j], s_0_0[j]);

                t_xxxx_z[j] = ovlvecfunc::fvec_xxxx_z_s_0(fx[j], pa_xx[j], pa_xxxx[j], pb_z[j], s_0_0[j]);

                t_xxxy_x[j] = ovlvecfunc::fvec_xxxy_x_s_0(fx[j], pa_xxxy[j], pa_xxy[j], pa_xy[j], pa_y[j], pb_x[j], s_0_0[j]);

                t_xxxy_y[j] = ovlvecfunc::fvec_xxxy_y_s_0(fx[j], pa_x[j], pa_xxx[j], pa_xxxy[j], pa_xy[j], pb_y[j], s_0_0[j]);

                t_xxxy_z[j] = ovlvecfunc::fvec_xxxy_z_s_0(fx[j], pa_xxxy[j], pa_xy[j], pb_z[j], s_0_0[j]);

                t_xxxz_x[j] = ovlvecfunc::fvec_xxxz_x_s_0(fx[j], pa_xxxz[j], pa_xxz[j], pa_xz[j], pa_z[j], pb_x[j], s_0_0[j]);

                t_xxxz_y[j] = ovlvecfunc::fvec_xxxz_y_s_0(fx[j], pa_xxxz[j], pa_xz[j], pb_y[j], s_0_0[j]);

                t_xxxz_z[j] = ovlvecfunc::fvec_xxxz_z_s_0(fx[j], pa_x[j], pa_xxx[j], pa_xxxz[j], pa_xz[j], pb_z[j], s_0_0[j]);
            }
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                t_xxyy_x[j] = ovlvecfunc::fvec_xxyy_x_s_0(fx[j], pa_x[j], pa_xx[j], pa_xxyy[j], pa_xyy[j], pa_yy[j], pb_x[j], s_0_0[j]);

                t_xxyy_y[j] = ovlvecfunc::fvec_xxyy_y_s_0(fx[j], pa_xx[j], pa_xxy[j], pa_xxyy[j], pa_y[j], pa_yy[j], pb_y[j], s_0_0[j]);

                t_xxyy_z[j] = ovlvecfunc::fvec_xxyy_z_s_0(fx[j], pa_xx[j], pa_xxyy[j], pa_yy[j], pb_z[j], s_0_0[j]);

                t_xxyz_x[j] = ovlvecfunc::fvec_xxyz_x_s_0(fx[j], pa_xxyz[j], pa_xyz[j], pa_yz[j], pb_x[j], s_0_0[j]);

                t_xxyz_y[j] = ovlvecfunc::fvec_xxyz_y_s_0(fx[j], pa_xxyz[j], pa_xxz[j], pa_yz[j], pa_z[j], pb_y[j], s_0_0[j]);

                t_xxyz_z[j] = ovlvecfunc::fvec_xxyz_z_s_0(fx[j], pa_xxy[j], pa_xxyz[j], pa_y[j], pa_yz[j], pb_z[j], s_0_0[j]);

                t_xxzz_x[j] = ovlvecfunc::fvec_xxzz_x_s_0(fx[j], pa_x[j], pa_xx[j], pa_xxzz[j], pa_xzz[j], pa_zz[j], pb_x[j], s_0_0[j]);

                t_xxzz_y[j] = ovlvecfunc::fvec_xxzz_y_s_0(fx[j], pa_xx[j], pa_xxzz[j], pa_zz[j], pb_y[j], s_0_0[j]);

                t_xxzz_z[j] = ovlvecfunc::fvec_xxzz_z_s_0(fx[j], pa_xx[j], pa_xxz[j], pa_xxzz[j], pa_z[j], pa_zz[j], pb_z[j], s_0_0[j]);
            }
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                t_xyyy_x[j] = ovlvecfunc::fvec_xyyy_x_s_0(fx[j], pa_xy[j], pa_xyyy[j], pa_y[j], pa_yyy[j], pb_x[j], s_0_0[j]);

                t_xyyy_y[j] = ovlvecfunc::fvec_xyyy_y_s_0(fx[j], pa_x[j], pa_xy[j], pa_xyy[j], pa_xyyy[j], pb_y[j], s_0_0[j]);

                t_xyyy_z[j] = ovlvecfunc::fvec_xyyy_z_s_0(fx[j], pa_xy[j], pa_xyyy[j], pb_z[j], s_0_0[j]);

                t_xyyz_x[j] = ovlvecfunc::fvec_xyyz_x_s_0(fx[j], pa_xyyz[j], pa_xz[j], pa_yyz[j], pa_z[j], pb_x[j], s_0_0[j]);

                t_xyyz_y[j] = ovlvecfunc::fvec_xyyz_y_s_0(fx[j], pa_xyyz[j], pa_xyz[j], pa_xz[j], pb_y[j], s_0_0[j]);

                t_xyyz_z[j] = ovlvecfunc::fvec_xyyz_z_s_0(fx[j], pa_x[j], pa_xyy[j], pa_xyyz[j], pa_xz[j], pb_z[j], s_0_0[j]);

                t_xyzz_x[j] = ovlvecfunc::fvec_xyzz_x_s_0(fx[j], pa_xy[j], pa_xyzz[j], pa_y[j], pa_yzz[j], pb_x[j], s_0_0[j]);

                t_xyzz_y[j] = ovlvecfunc::fvec_xyzz_y_s_0(fx[j], pa_x[j], pa_xy[j], pa_xyzz[j], pa_xzz[j], pb_y[j], s_0_0[j]);

                t_xyzz_z[j] = ovlvecfunc::fvec_xyzz_z_s_0(fx[j], pa_xy[j], pa_xyz[j], pa_xyzz[j], pb_z[j], s_0_0[j]);
            }
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                t_xzzz_x[j] = ovlvecfunc::fvec_xzzz_x_s_0(fx[j], pa_xz[j], pa_xzzz[j], pa_z[j], pa_zzz[j], pb_x[j], s_0_0[j]);

                t_xzzz_y[j] = ovlvecfunc::fvec_xzzz_y_s_0(fx[j], pa_xz[j], pa_xzzz[j], pb_y[j], s_0_0[j]);

                t_xzzz_z[j] = ovlvecfunc::fvec_xzzz_z_s_0(fx[j], pa_x[j], pa_xz[j], pa_xzz[j], pa_xzzz[j], pb_z[j], s_0_0[j]);

                t_yyyy_x[j] = ovlvecfunc::fvec_yyyy_x_s_0(fx[j], pa_yy[j], pa_yyyy[j], pb_x[j], s_0_0[j]);

                t_yyyy_y[j] = ovlvecfunc::fvec_yyyy_y_s_0(fx[j], pa_y[j], pa_yy[j], pa_yyy[j], pa_yyyy[j], pb_y[j], s_0_0[j]);

                t_yyyy_z[j] = ovlvecfunc::fvec_yyyy_z_s_0(fx[j], pa_yy[j], pa_yyyy[j], pb_z[j], s_0_0[j]);

                t_yyyz_x[j] = ovlvecfunc::fvec_yyyz_x_s_0(fx[j], pa_yyyz[j], pa_yz[j], pb_x[j], s_0_0[j]);

                t_yyyz_y[j] = ovlvecfunc::fvec_yyyz_y_s_0(fx[j], pa_yyyz[j], pa_yyz[j], pa_yz[j], pa_z[j], pb_y[j], s_0_0[j]);

                t_yyyz_z[j] = ovlvecfunc::fvec_yyyz_z_s_0(fx[j], pa_y[j], pa_yyy[j], pa_yyyz[j], pa_yz[j], pb_z[j], s_0_0[j]);
            }
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                t_yyzz_x[j] = ovlvecfunc::fvec_yyzz_x_s_0(fx[j], pa_yy[j], pa_yyzz[j], pa_zz[j], pb_x[j], s_0_0[j]);

                t_yyzz_y[j] = ovlvecfunc::fvec_yyzz_y_s_0(fx[j], pa_y[j], pa_yy[j], pa_yyzz[j], pa_yzz[j], pa_zz[j], pb_y[j], s_0_0[j]);

                t_yyzz_z[j] = ovlvecfunc::fvec_yyzz_z_s_0(fx[j], pa_yy[j], pa_yyz[j], pa_yyzz[j], pa_z[j], pa_zz[j], pb_z[j], s_0_0[j]);

                t_yzzz_x[j] = ovlvecfunc::fvec_yzzz_x_s_0(fx[j], pa_yz[j], pa_yzzz[j], pb_x[j], s_0_0[j]);

                t_yzzz_y[j] = ovlvecfunc::fvec_yzzz_y_s_0(fx[j], pa_yz[j], pa_yzzz[j], pa_z[j], pa_zzz[j], pb_y[j], s_0_0[j]);

                t_yzzz_z[j] = ovlvecfunc::fvec_yzzz_z_s_0(fx[j], pa_y[j], pa_yz[j], pa_yzz[j], pa_yzzz[j], pb_z[j], s_0_0[j]);

                t_zzzz_x[j] = ovlvecfunc::fvec_zzzz_x_s_0(fx[j], pa_zz[j], pa_zzzz[j], pb_x[j], s_0_0[j]);

                t_zzzz_y[j] = ovlvecfunc::fvec_zzzz_y_s_0(fx[j], pa_zz[j], pa_zzzz[j], pb_y[j], s_0_0[j]);

                t_zzzz_z[j] = ovlvecfunc::fvec_zzzz_z_s_0(fx[j], pa_z[j], pa_zz[j], pa_zzz[j], pa_zzzz[j], pb_z[j], s_0_0[j]);
            }
