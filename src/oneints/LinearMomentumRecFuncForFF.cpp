...
namespace lmomrecfunc { // lmomrecfunc namespace
    ...
    {
        lmomrecfunc::compLinearMomentumForFF_0_50(primBuffer,
                                                  recursionMap,
                                                  osFactors,
                                                  paDistances, 
                                                  braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForFF_50_100(primBuffer,
                                                    recursionMap,
                                                    osFactors,
                                                    paDistances, 
                                                    braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForFF_100_150(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForFF_150_200(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForFF_200_250(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForFF_250_300(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
                                 ...
                                 const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpx_xxx_xxx_0[j] = pa_x[j] * tpx_xx_xxx_0[j] + fl1_fx * tpx_x_xxx_0[j] + 1.5 * fl1_fx * tpx_xx_xx_0[j] - fl1_fgb * fl1_fx * ts_xx_xxx_0[j];
                ...
                tpx_xxx_xyy_0[j] = pa_x[j] * tpx_xx_xyy_0[j] + fl1_fx * tpx_x_xyy_0[j] + 0.5 * fl1_fx * tpx_xx_yy_0[j] - fl1_fgb * fl1_fx * ts_xx_xyy_0[j];
                ...
                tpx_xxx_xyz_0[j] = pa_x[j] * tpx_xx_xyz_0[j] + fl1_fx * tpx_x_xyz_0[j] + 0.5 * fl1_fx * tpx_xx_yz_0[j] - fl1_fgb * fl1_fx * ts_xx_xyz_0[j];
                ...
                tpx_xxx_xzz_0[j] = pa_x[j] * tpx_xx_xzz_0[j] + fl1_fx * tpx_x_xzz_0[j] + 0.5 * fl1_fx * tpx_xx_zz_0[j] - fl1_fgb * fl1_fx * ts_xx_xzz_0[j];
                ...
                tpx_xxy_xxx_0[j] = pa_x[j] * tpx_xy_xxx_0[j] + 0.5 * fl1_fx * tpx_y_xxx_0[j] + 1.5 * fl1_fx * tpx_xy_xx_0[j] - fl1_fgb * fl1_fx * ts_xy_xxx_0[j];
                ...
                tpx_xxy_xxy_0[j] = pa_x[j] * tpx_xy_xxy_0[j] + 0.5 * fl1_fx * tpx_y_xxy_0[j] + fl1_fx * tpx_xy_xy_0[j] - fl1_fgb * fl1_fx * ts_xy_xxy_0[j];
                ...
                tpx_xxy_xxz_0[j] = pa_x[j] * tpx_xy_xxz_0[j] + 0.5 * fl1_fx * tpx_y_xxz_0[j] + fl1_fx * tpx_xy_xz_0[j] - fl1_fgb * fl1_fx * ts_xy_xxz_0[j];
                ...
                tpx_xxy_xyy_0[j] = pa_x[j] * tpx_xy_xyy_0[j] + 0.5 * fl1_fx * tpx_y_xyy_0[j] + 0.5 * fl1_fx * tpx_xy_yy_0[j] - fl1_fgb * fl1_fx * ts_xy_xyy_0[j];
                ...
                tpx_xxy_xyz_0[j] = pa_x[j] * tpx_xy_xyz_0[j] + 0.5 * fl1_fx * tpx_y_xyz_0[j] + 0.5 * fl1_fx * tpx_xy_yz_0[j] - fl1_fgb * fl1_fx * ts_xy_xyz_0[j];
                ...
                tpx_xxy_xzz_0[j] = pa_x[j] * tpx_xy_xzz_0[j] + 0.5 * fl1_fx * tpx_y_xzz_0[j] + 0.5 * fl1_fx * tpx_xy_zz_0[j] - fl1_fgb * fl1_fx * ts_xy_xzz_0[j];
                                   ...
                                   const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpx_xxz_xxx_0[j] = pa_x[j] * tpx_xz_xxx_0[j] + 0.5 * fl1_fx * tpx_z_xxx_0[j] + 1.5 * fl1_fx * tpx_xz_xx_0[j] - fl1_fgb * fl1_fx * ts_xz_xxx_0[j];
                ...
                tpx_xxz_xxy_0[j] = pa_x[j] * tpx_xz_xxy_0[j] + 0.5 * fl1_fx * tpx_z_xxy_0[j] + fl1_fx * tpx_xz_xy_0[j] - fl1_fgb * fl1_fx * ts_xz_xxy_0[j];
                ...
                tpx_xxz_xxz_0[j] = pa_x[j] * tpx_xz_xxz_0[j] + 0.5 * fl1_fx * tpx_z_xxz_0[j] + fl1_fx * tpx_xz_xz_0[j] - fl1_fgb * fl1_fx * ts_xz_xxz_0[j];
                ...
                tpx_xxz_xyy_0[j] = pa_x[j] * tpx_xz_xyy_0[j] + 0.5 * fl1_fx * tpx_z_xyy_0[j] + 0.5 * fl1_fx * tpx_xz_yy_0[j] - fl1_fgb * fl1_fx * ts_xz_xyy_0[j];
                ...
                tpx_xxz_xyz_0[j] = pa_x[j] * tpx_xz_xyz_0[j] + 0.5 * fl1_fx * tpx_z_xyz_0[j] + 0.5 * fl1_fx * tpx_xz_yz_0[j] - fl1_fgb * fl1_fx * ts_xz_xyz_0[j];
                ...
                tpx_xxz_xzz_0[j] = pa_x[j] * tpx_xz_xzz_0[j] + 0.5 * fl1_fx * tpx_z_xzz_0[j] + 0.5 * fl1_fx * tpx_xz_zz_0[j] - fl1_fgb * fl1_fx * ts_xz_xzz_0[j];
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpy_yyy_xxy_0[j] = pa_y[j] * tpy_yy_xxy_0[j] + fl1_fx * tpy_y_xxy_0[j] + 0.5 * fl1_fx * tpy_yy_xx_0[j] - fl1_fgb * fl1_fx * ts_yy_xxy_0[j];
                ...
                tpy_yyy_xyz_0[j] = pa_y[j] * tpy_yy_xyz_0[j] + fl1_fx * tpy_y_xyz_0[j] + 0.5 * fl1_fx * tpy_yy_xz_0[j] - fl1_fgb * fl1_fx * ts_yy_xyz_0[j];
                ...
                tpy_yyy_yyy_0[j] = pa_y[j] * tpy_yy_yyy_0[j] + fl1_fx * tpy_y_yyy_0[j] + 1.5 * fl1_fx * tpy_yy_yy_0[j] - fl1_fgb * fl1_fx * ts_yy_yyy_0[j];
            }
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpy_yyy_yzz_0[j] = pa_y[j] * tpy_yy_yzz_0[j] + fl1_fx * tpy_y_yzz_0[j] + 0.5 * fl1_fx * tpy_yy_zz_0[j] - fl1_fgb * fl1_fx * ts_yy_yzz_0[j];
                ...
                tpy_yyz_xxy_0[j] = pa_y[j] * tpy_yz_xxy_0[j] + 0.5 * fl1_fx * tpy_z_xxy_0[j] + 0.5 * fl1_fx * tpy_yz_xx_0[j] - fl1_fgb * fl1_fx * ts_yz_xxy_0[j];
                ...
                tpy_yyz_xyy_0[j] = pa_y[j] * tpy_yz_xyy_0[j] + 0.5 * fl1_fx * tpy_z_xyy_0[j] + fl1_fx * tpy_yz_xy_0[j] - fl1_fgb * fl1_fx * ts_yz_xyy_0[j];
                ...
                tpy_yyz_xyz_0[j] = pa_y[j] * tpy_yz_xyz_0[j] + 0.5 * fl1_fx * tpy_z_xyz_0[j] + 0.5 * fl1_fx * tpy_yz_xz_0[j] - fl1_fgb * fl1_fx * ts_yz_xyz_0[j];
                ...
                tpy_yyz_yyy_0[j] = pa_y[j] * tpy_yz_yyy_0[j] + 0.5 * fl1_fx * tpy_z_yyy_0[j] + 1.5 * fl1_fx * tpy_yz_yy_0[j] - fl1_fgb * fl1_fx * ts_yz_yyy_0[j];
                ...
                tpy_yyz_yyz_0[j] = pa_y[j] * tpy_yz_yyz_0[j] + 0.5 * fl1_fx * tpy_z_yyz_0[j] + fl1_fx * tpy_yz_yz_0[j] - fl1_fgb * fl1_fx * ts_yz_yyz_0[j];
                ...
                tpy_yyz_yzz_0[j] = pa_y[j] * tpy_yz_yzz_0[j] + 0.5 * fl1_fx * tpy_z_yzz_0[j] + 0.5 * fl1_fx * tpy_yz_zz_0[j] - fl1_fgb * fl1_fx * ts_yz_yzz_0[j];
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpz_zzz_xxz_0[j] = pa_z[j] * tpz_zz_xxz_0[j] + fl1_fx * tpz_z_xxz_0[j] + 0.5 * fl1_fx * tpz_zz_xx_0[j] - fl1_fgb * fl1_fx * ts_zz_xxz_0[j];
                ...
                tpz_zzz_xyz_0[j] = pa_z[j] * tpz_zz_xyz_0[j] + fl1_fx * tpz_z_xyz_0[j] + 0.5 * fl1_fx * tpz_zz_xy_0[j] - fl1_fgb * fl1_fx * ts_zz_xyz_0[j];
                ...
                tpz_zzz_yyz_0[j] = pa_z[j] * tpz_zz_yyz_0[j] + fl1_fx * tpz_z_yyz_0[j] + 0.5 * fl1_fx * tpz_zz_yy_0[j] - fl1_fgb * fl1_fx * ts_zz_yyz_0[j];
                ...
                tpz_zzz_zzz_0[j] = pa_z[j] * tpz_zz_zzz_0[j] + fl1_fx * tpz_z_zzz_0[j] + 1.5 * fl1_fx * tpz_zz_zz_0[j] - fl1_fgb * fl1_fx * ts_zz_zzz_0[j];
            }
