...
namespace kinrecfunc { // kinrecfunc namespace
    ...
    {
        kinrecfunc::compKineticEnergyForGG_0_45(primBuffer,
                                                recursionMap,
                                                osFactors,
                                                paDistances, 
                                                braGtoBlock,
        ...
        kinrecfunc::compKineticEnergyForGG_45_90(primBuffer,
                                                 recursionMap,
                                                 osFactors,
                                                 paDistances, 
                                                 braGtoBlock,
        ...
        kinrecfunc::compKineticEnergyForGG_90_135(primBuffer,
                                                  recursionMap,
                                                  osFactors,
                                                  paDistances, 
                                                  braGtoBlock,
        ...
        kinrecfunc::compKineticEnergyForGG_135_180(primBuffer,
                                                   recursionMap,
                                                   osFactors,
                                                   paDistances, 
                                                   braGtoBlock,
        ...
        kinrecfunc::compKineticEnergyForGG_180_225(primBuffer,
                                                   recursionMap,
                                                   osFactors,
                                                   paDistances, 
                                                   braGtoBlock,
                                ...
                                const int32_t              iContrGto)
    {
        ...
        auto pidx_t_4_4_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Kinetic Energy"}, 0, true, 
                                                         {4, -1, -1, -1}, {4, -1, -1, -1}, 
                                                         1, 1, 0));
        ...
        auto pidx_t_3_4_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Kinetic Energy"}, 0, true, 
                                                         {3, -1, -1, -1}, {4, -1, -1, -1}, 
                                                         1, 1, 0));

        auto pidx_t_2_4_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Kinetic Energy"}, 0, true, 
                                                         {2, -1, -1, -1}, {4, -1, -1, -1}, 
                                                         1, 1, 0));
        ...
        auto pidx_s_4_4_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Overlap"}, 0, true, 
                                                         {4, -1, -1, -1}, {4, -1, -1, -1}, 
                                                         1, 1, 0));
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tt_xxxx_xxxx_0[j] = pa_x[j] * tt_xxx_xxxx_0[j] + 1.5 * fl1_fx * tt_xx_xxxx_0[j] + 2.0 * fl1_fx * tt_xxx_xxx_0[j] + 2.0 * fl1_fz * ts_xxxx_xxxx_0[j] - 3.0 * fl1_fz * fl1_fga * ts_xx_xxxx_0[j];

                tt_xxxx_xxxy_0[j] = pa_x[j] * tt_xxx_xxxy_0[j] + 1.5 * fl1_fx * tt_xx_xxxy_0[j] + 1.5 * fl1_fx * tt_xxx_xxy_0[j] + 2.0 * fl1_fz * ts_xxxx_xxxy_0[j] - 3.0 * fl1_fz * fl1_fga * ts_xx_xxxy_0[j];

                tt_xxxx_xxxz_0[j] = pa_x[j] * tt_xxx_xxxz_0[j] + 1.5 * fl1_fx * tt_xx_xxxz_0[j] + 1.5 * fl1_fx * tt_xxx_xxz_0[j] + 2.0 * fl1_fz * ts_xxxx_xxxz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_xx_xxxz_0[j];

                tt_xxxx_xxyy_0[j] = pa_x[j] * tt_xxx_xxyy_0[j] + 1.5 * fl1_fx * tt_xx_xxyy_0[j] + fl1_fx * tt_xxx_xyy_0[j] + 2.0 * fl1_fz * ts_xxxx_xxyy_0[j] - 3.0 * fl1_fz * fl1_fga * ts_xx_xxyy_0[j];

                tt_xxxx_xxyz_0[j] = pa_x[j] * tt_xxx_xxyz_0[j] + 1.5 * fl1_fx * tt_xx_xxyz_0[j] + fl1_fx * tt_xxx_xyz_0[j] + 2.0 * fl1_fz * ts_xxxx_xxyz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_xx_xxyz_0[j];

                tt_xxxx_xxzz_0[j] = pa_x[j] * tt_xxx_xxzz_0[j] + 1.5 * fl1_fx * tt_xx_xxzz_0[j] + fl1_fx * tt_xxx_xzz_0[j] + 2.0 * fl1_fz * ts_xxxx_xxzz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_xx_xxzz_0[j];

                tt_xxxx_xyyy_0[j] = pa_x[j] * tt_xxx_xyyy_0[j] + 1.5 * fl1_fx * tt_xx_xyyy_0[j] + 0.5 * fl1_fx * tt_xxx_yyy_0[j] + 2.0 * fl1_fz * ts_xxxx_xyyy_0[j] - 3.0 * fl1_fz * fl1_fga * ts_xx_xyyy_0[j];

                tt_xxxx_xyyz_0[j] = pa_x[j] * tt_xxx_xyyz_0[j] + 1.5 * fl1_fx * tt_xx_xyyz_0[j] + 0.5 * fl1_fx * tt_xxx_yyz_0[j] + 2.0 * fl1_fz * ts_xxxx_xyyz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_xx_xyyz_0[j];

                tt_xxxx_xyzz_0[j] = pa_x[j] * tt_xxx_xyzz_0[j] + 1.5 * fl1_fx * tt_xx_xyzz_0[j] + 0.5 * fl1_fx * tt_xxx_yzz_0[j] + 2.0 * fl1_fz * ts_xxxx_xyzz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_xx_xyzz_0[j];

                tt_xxxx_xzzz_0[j] = pa_x[j] * tt_xxx_xzzz_0[j] + 1.5 * fl1_fx * tt_xx_xzzz_0[j] + 0.5 * fl1_fx * tt_xxx_zzz_0[j] + 2.0 * fl1_fz * ts_xxxx_xzzz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_xx_xzzz_0[j];

                tt_xxxx_yyyy_0[j] = pa_x[j] * tt_xxx_yyyy_0[j] + 1.5 * fl1_fx * tt_xx_yyyy_0[j] + 2.0 * fl1_fz * ts_xxxx_yyyy_0[j] - 3.0 * fl1_fz * fl1_fga * ts_xx_yyyy_0[j];

                tt_xxxx_yyyz_0[j] = pa_x[j] * tt_xxx_yyyz_0[j] + 1.5 * fl1_fx * tt_xx_yyyz_0[j] + 2.0 * fl1_fz * ts_xxxx_yyyz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_xx_yyyz_0[j];

                tt_xxxx_yyzz_0[j] = pa_x[j] * tt_xxx_yyzz_0[j] + 1.5 * fl1_fx * tt_xx_yyzz_0[j] + 2.0 * fl1_fz * ts_xxxx_yyzz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_xx_yyzz_0[j];

                tt_xxxx_yzzz_0[j] = pa_x[j] * tt_xxx_yzzz_0[j] + 1.5 * fl1_fx * tt_xx_yzzz_0[j] + 2.0 * fl1_fz * ts_xxxx_yzzz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_xx_yzzz_0[j];

                tt_xxxx_zzzz_0[j] = pa_x[j] * tt_xxx_zzzz_0[j] + 1.5 * fl1_fx * tt_xx_zzzz_0[j] + 2.0 * fl1_fz * ts_xxxx_zzzz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_xx_zzzz_0[j];

                tt_xxxy_xxxx_0[j] = pa_x[j] * tt_xxy_xxxx_0[j] + fl1_fx * tt_xy_xxxx_0[j] + 2.0 * fl1_fx * tt_xxy_xxx_0[j] + 2.0 * fl1_fz * ts_xxxy_xxxx_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xy_xxxx_0[j];

                tt_xxxy_xxxy_0[j] = pa_x[j] * tt_xxy_xxxy_0[j] + fl1_fx * tt_xy_xxxy_0[j] + 1.5 * fl1_fx * tt_xxy_xxy_0[j] + 2.0 * fl1_fz * ts_xxxy_xxxy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xy_xxxy_0[j];

                tt_xxxy_xxxz_0[j] = pa_x[j] * tt_xxy_xxxz_0[j] + fl1_fx * tt_xy_xxxz_0[j] + 1.5 * fl1_fx * tt_xxy_xxz_0[j] + 2.0 * fl1_fz * ts_xxxy_xxxz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xy_xxxz_0[j];

                tt_xxxy_xxyy_0[j] = pa_x[j] * tt_xxy_xxyy_0[j] + fl1_fx * tt_xy_xxyy_0[j] + fl1_fx * tt_xxy_xyy_0[j] + 2.0 * fl1_fz * ts_xxxy_xxyy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xy_xxyy_0[j];

                tt_xxxy_xxyz_0[j] = pa_x[j] * tt_xxy_xxyz_0[j] + fl1_fx * tt_xy_xxyz_0[j] + fl1_fx * tt_xxy_xyz_0[j] + 2.0 * fl1_fz * ts_xxxy_xxyz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xy_xxyz_0[j];

                tt_xxxy_xxzz_0[j] = pa_x[j] * tt_xxy_xxzz_0[j] + fl1_fx * tt_xy_xxzz_0[j] + fl1_fx * tt_xxy_xzz_0[j] + 2.0 * fl1_fz * ts_xxxy_xxzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xy_xxzz_0[j];

                tt_xxxy_xyyy_0[j] = pa_x[j] * tt_xxy_xyyy_0[j] + fl1_fx * tt_xy_xyyy_0[j] + 0.5 * fl1_fx * tt_xxy_yyy_0[j] + 2.0 * fl1_fz * ts_xxxy_xyyy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xy_xyyy_0[j];

                tt_xxxy_xyyz_0[j] = pa_x[j] * tt_xxy_xyyz_0[j] + fl1_fx * tt_xy_xyyz_0[j] + 0.5 * fl1_fx * tt_xxy_yyz_0[j] + 2.0 * fl1_fz * ts_xxxy_xyyz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xy_xyyz_0[j];

                tt_xxxy_xyzz_0[j] = pa_x[j] * tt_xxy_xyzz_0[j] + fl1_fx * tt_xy_xyzz_0[j] + 0.5 * fl1_fx * tt_xxy_yzz_0[j] + 2.0 * fl1_fz * ts_xxxy_xyzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xy_xyzz_0[j];

                tt_xxxy_xzzz_0[j] = pa_x[j] * tt_xxy_xzzz_0[j] + fl1_fx * tt_xy_xzzz_0[j] + 0.5 * fl1_fx * tt_xxy_zzz_0[j] + 2.0 * fl1_fz * ts_xxxy_xzzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xy_xzzz_0[j];

                tt_xxxy_yyyy_0[j] = pa_x[j] * tt_xxy_yyyy_0[j] + fl1_fx * tt_xy_yyyy_0[j] + 2.0 * fl1_fz * ts_xxxy_yyyy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xy_yyyy_0[j];

                tt_xxxy_yyyz_0[j] = pa_x[j] * tt_xxy_yyyz_0[j] + fl1_fx * tt_xy_yyyz_0[j] + 2.0 * fl1_fz * ts_xxxy_yyyz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xy_yyyz_0[j];

                tt_xxxy_yyzz_0[j] = pa_x[j] * tt_xxy_yyzz_0[j] + fl1_fx * tt_xy_yyzz_0[j] + 2.0 * fl1_fz * ts_xxxy_yyzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xy_yyzz_0[j];

                tt_xxxy_yzzz_0[j] = pa_x[j] * tt_xxy_yzzz_0[j] + fl1_fx * tt_xy_yzzz_0[j] + 2.0 * fl1_fz * ts_xxxy_yzzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xy_yzzz_0[j];

                tt_xxxy_zzzz_0[j] = pa_x[j] * tt_xxy_zzzz_0[j] + fl1_fx * tt_xy_zzzz_0[j] + 2.0 * fl1_fz * ts_xxxy_zzzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xy_zzzz_0[j];

                tt_xxxz_xxxx_0[j] = pa_x[j] * tt_xxz_xxxx_0[j] + fl1_fx * tt_xz_xxxx_0[j] + 2.0 * fl1_fx * tt_xxz_xxx_0[j] + 2.0 * fl1_fz * ts_xxxz_xxxx_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xz_xxxx_0[j];

                tt_xxxz_xxxy_0[j] = pa_x[j] * tt_xxz_xxxy_0[j] + fl1_fx * tt_xz_xxxy_0[j] + 1.5 * fl1_fx * tt_xxz_xxy_0[j] + 2.0 * fl1_fz * ts_xxxz_xxxy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xz_xxxy_0[j];

                tt_xxxz_xxxz_0[j] = pa_x[j] * tt_xxz_xxxz_0[j] + fl1_fx * tt_xz_xxxz_0[j] + 1.5 * fl1_fx * tt_xxz_xxz_0[j] + 2.0 * fl1_fz * ts_xxxz_xxxz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xz_xxxz_0[j];

                tt_xxxz_xxyy_0[j] = pa_x[j] * tt_xxz_xxyy_0[j] + fl1_fx * tt_xz_xxyy_0[j] + fl1_fx * tt_xxz_xyy_0[j] + 2.0 * fl1_fz * ts_xxxz_xxyy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xz_xxyy_0[j];

                tt_xxxz_xxyz_0[j] = pa_x[j] * tt_xxz_xxyz_0[j] + fl1_fx * tt_xz_xxyz_0[j] + fl1_fx * tt_xxz_xyz_0[j] + 2.0 * fl1_fz * ts_xxxz_xxyz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xz_xxyz_0[j];

                tt_xxxz_xxzz_0[j] = pa_x[j] * tt_xxz_xxzz_0[j] + fl1_fx * tt_xz_xxzz_0[j] + fl1_fx * tt_xxz_xzz_0[j] + 2.0 * fl1_fz * ts_xxxz_xxzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xz_xxzz_0[j];

                tt_xxxz_xyyy_0[j] = pa_x[j] * tt_xxz_xyyy_0[j] + fl1_fx * tt_xz_xyyy_0[j] + 0.5 * fl1_fx * tt_xxz_yyy_0[j] + 2.0 * fl1_fz * ts_xxxz_xyyy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xz_xyyy_0[j];

                tt_xxxz_xyyz_0[j] = pa_x[j] * tt_xxz_xyyz_0[j] + fl1_fx * tt_xz_xyyz_0[j] + 0.5 * fl1_fx * tt_xxz_yyz_0[j] + 2.0 * fl1_fz * ts_xxxz_xyyz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xz_xyyz_0[j];

                tt_xxxz_xyzz_0[j] = pa_x[j] * tt_xxz_xyzz_0[j] + fl1_fx * tt_xz_xyzz_0[j] + 0.5 * fl1_fx * tt_xxz_yzz_0[j] + 2.0 * fl1_fz * ts_xxxz_xyzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xz_xyzz_0[j];

                tt_xxxz_xzzz_0[j] = pa_x[j] * tt_xxz_xzzz_0[j] + fl1_fx * tt_xz_xzzz_0[j] + 0.5 * fl1_fx * tt_xxz_zzz_0[j] + 2.0 * fl1_fz * ts_xxxz_xzzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xz_xzzz_0[j];

                tt_xxxz_yyyy_0[j] = pa_x[j] * tt_xxz_yyyy_0[j] + fl1_fx * tt_xz_yyyy_0[j] + 2.0 * fl1_fz * ts_xxxz_yyyy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xz_yyyy_0[j];

                tt_xxxz_yyyz_0[j] = pa_x[j] * tt_xxz_yyyz_0[j] + fl1_fx * tt_xz_yyyz_0[j] + 2.0 * fl1_fz * ts_xxxz_yyyz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xz_yyyz_0[j];

                tt_xxxz_yyzz_0[j] = pa_x[j] * tt_xxz_yyzz_0[j] + fl1_fx * tt_xz_yyzz_0[j] + 2.0 * fl1_fz * ts_xxxz_yyzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xz_yyzz_0[j];

                tt_xxxz_yzzz_0[j] = pa_x[j] * tt_xxz_yzzz_0[j] + fl1_fx * tt_xz_yzzz_0[j] + 2.0 * fl1_fz * ts_xxxz_yzzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xz_yzzz_0[j];

                tt_xxxz_zzzz_0[j] = pa_x[j] * tt_xxz_zzzz_0[j] + fl1_fx * tt_xz_zzzz_0[j] + 2.0 * fl1_fz * ts_xxxz_zzzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_xz_zzzz_0[j];
            }
                                 ...
                                 const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tt_xxyy_xxxx_0[j] = pa_x[j] * tt_xyy_xxxx_0[j] + 0.5 * fl1_fx * tt_yy_xxxx_0[j] + 2.0 * fl1_fx * tt_xyy_xxx_0[j] + 2.0 * fl1_fz * ts_xxyy_xxxx_0[j] - fl1_fz * fl1_fga * ts_yy_xxxx_0[j];

                tt_xxyy_xxxy_0[j] = pa_x[j] * tt_xyy_xxxy_0[j] + 0.5 * fl1_fx * tt_yy_xxxy_0[j] + 1.5 * fl1_fx * tt_xyy_xxy_0[j] + 2.0 * fl1_fz * ts_xxyy_xxxy_0[j] - fl1_fz * fl1_fga * ts_yy_xxxy_0[j];

                tt_xxyy_xxxz_0[j] = pa_x[j] * tt_xyy_xxxz_0[j] + 0.5 * fl1_fx * tt_yy_xxxz_0[j] + 1.5 * fl1_fx * tt_xyy_xxz_0[j] + 2.0 * fl1_fz * ts_xxyy_xxxz_0[j] - fl1_fz * fl1_fga * ts_yy_xxxz_0[j];

                tt_xxyy_xxyy_0[j] = pa_x[j] * tt_xyy_xxyy_0[j] + 0.5 * fl1_fx * tt_yy_xxyy_0[j] + fl1_fx * tt_xyy_xyy_0[j] + 2.0 * fl1_fz * ts_xxyy_xxyy_0[j] - fl1_fz * fl1_fga * ts_yy_xxyy_0[j];

                tt_xxyy_xxyz_0[j] = pa_x[j] * tt_xyy_xxyz_0[j] + 0.5 * fl1_fx * tt_yy_xxyz_0[j] + fl1_fx * tt_xyy_xyz_0[j] + 2.0 * fl1_fz * ts_xxyy_xxyz_0[j] - fl1_fz * fl1_fga * ts_yy_xxyz_0[j];

                tt_xxyy_xxzz_0[j] = pa_x[j] * tt_xyy_xxzz_0[j] + 0.5 * fl1_fx * tt_yy_xxzz_0[j] + fl1_fx * tt_xyy_xzz_0[j] + 2.0 * fl1_fz * ts_xxyy_xxzz_0[j] - fl1_fz * fl1_fga * ts_yy_xxzz_0[j];

                tt_xxyy_xyyy_0[j] = pa_x[j] * tt_xyy_xyyy_0[j] + 0.5 * fl1_fx * tt_yy_xyyy_0[j] + 0.5 * fl1_fx * tt_xyy_yyy_0[j] + 2.0 * fl1_fz * ts_xxyy_xyyy_0[j] - fl1_fz * fl1_fga * ts_yy_xyyy_0[j];

                tt_xxyy_xyyz_0[j] = pa_x[j] * tt_xyy_xyyz_0[j] + 0.5 * fl1_fx * tt_yy_xyyz_0[j] + 0.5 * fl1_fx * tt_xyy_yyz_0[j] + 2.0 * fl1_fz * ts_xxyy_xyyz_0[j] - fl1_fz * fl1_fga * ts_yy_xyyz_0[j];

                tt_xxyy_xyzz_0[j] = pa_x[j] * tt_xyy_xyzz_0[j] + 0.5 * fl1_fx * tt_yy_xyzz_0[j] + 0.5 * fl1_fx * tt_xyy_yzz_0[j] + 2.0 * fl1_fz * ts_xxyy_xyzz_0[j] - fl1_fz * fl1_fga * ts_yy_xyzz_0[j];

                tt_xxyy_xzzz_0[j] = pa_x[j] * tt_xyy_xzzz_0[j] + 0.5 * fl1_fx * tt_yy_xzzz_0[j] + 0.5 * fl1_fx * tt_xyy_zzz_0[j] + 2.0 * fl1_fz * ts_xxyy_xzzz_0[j] - fl1_fz * fl1_fga * ts_yy_xzzz_0[j];

                tt_xxyy_yyyy_0[j] = pa_x[j] * tt_xyy_yyyy_0[j] + 0.5 * fl1_fx * tt_yy_yyyy_0[j] + 2.0 * fl1_fz * ts_xxyy_yyyy_0[j] - fl1_fz * fl1_fga * ts_yy_yyyy_0[j];

                tt_xxyy_yyyz_0[j] = pa_x[j] * tt_xyy_yyyz_0[j] + 0.5 * fl1_fx * tt_yy_yyyz_0[j] + 2.0 * fl1_fz * ts_xxyy_yyyz_0[j] - fl1_fz * fl1_fga * ts_yy_yyyz_0[j];

                tt_xxyy_yyzz_0[j] = pa_x[j] * tt_xyy_yyzz_0[j] + 0.5 * fl1_fx * tt_yy_yyzz_0[j] + 2.0 * fl1_fz * ts_xxyy_yyzz_0[j] - fl1_fz * fl1_fga * ts_yy_yyzz_0[j];

                tt_xxyy_yzzz_0[j] = pa_x[j] * tt_xyy_yzzz_0[j] + 0.5 * fl1_fx * tt_yy_yzzz_0[j] + 2.0 * fl1_fz * ts_xxyy_yzzz_0[j] - fl1_fz * fl1_fga * ts_yy_yzzz_0[j];

                tt_xxyy_zzzz_0[j] = pa_x[j] * tt_xyy_zzzz_0[j] + 0.5 * fl1_fx * tt_yy_zzzz_0[j] + 2.0 * fl1_fz * ts_xxyy_zzzz_0[j] - fl1_fz * fl1_fga * ts_yy_zzzz_0[j];

                tt_xxyz_xxxx_0[j] = pa_x[j] * tt_xyz_xxxx_0[j] + 0.5 * fl1_fx * tt_yz_xxxx_0[j] + 2.0 * fl1_fx * tt_xyz_xxx_0[j] + 2.0 * fl1_fz * ts_xxyz_xxxx_0[j] - fl1_fz * fl1_fga * ts_yz_xxxx_0[j];

                tt_xxyz_xxxy_0[j] = pa_x[j] * tt_xyz_xxxy_0[j] + 0.5 * fl1_fx * tt_yz_xxxy_0[j] + 1.5 * fl1_fx * tt_xyz_xxy_0[j] + 2.0 * fl1_fz * ts_xxyz_xxxy_0[j] - fl1_fz * fl1_fga * ts_yz_xxxy_0[j];

                tt_xxyz_xxxz_0[j] = pa_x[j] * tt_xyz_xxxz_0[j] + 0.5 * fl1_fx * tt_yz_xxxz_0[j] + 1.5 * fl1_fx * tt_xyz_xxz_0[j] + 2.0 * fl1_fz * ts_xxyz_xxxz_0[j] - fl1_fz * fl1_fga * ts_yz_xxxz_0[j];

                tt_xxyz_xxyy_0[j] = pa_x[j] * tt_xyz_xxyy_0[j] + 0.5 * fl1_fx * tt_yz_xxyy_0[j] + fl1_fx * tt_xyz_xyy_0[j] + 2.0 * fl1_fz * ts_xxyz_xxyy_0[j] - fl1_fz * fl1_fga * ts_yz_xxyy_0[j];

                tt_xxyz_xxyz_0[j] = pa_x[j] * tt_xyz_xxyz_0[j] + 0.5 * fl1_fx * tt_yz_xxyz_0[j] + fl1_fx * tt_xyz_xyz_0[j] + 2.0 * fl1_fz * ts_xxyz_xxyz_0[j] - fl1_fz * fl1_fga * ts_yz_xxyz_0[j];

                tt_xxyz_xxzz_0[j] = pa_x[j] * tt_xyz_xxzz_0[j] + 0.5 * fl1_fx * tt_yz_xxzz_0[j] + fl1_fx * tt_xyz_xzz_0[j] + 2.0 * fl1_fz * ts_xxyz_xxzz_0[j] - fl1_fz * fl1_fga * ts_yz_xxzz_0[j];

                tt_xxyz_xyyy_0[j] = pa_x[j] * tt_xyz_xyyy_0[j] + 0.5 * fl1_fx * tt_yz_xyyy_0[j] + 0.5 * fl1_fx * tt_xyz_yyy_0[j] + 2.0 * fl1_fz * ts_xxyz_xyyy_0[j] - fl1_fz * fl1_fga * ts_yz_xyyy_0[j];

                tt_xxyz_xyyz_0[j] = pa_x[j] * tt_xyz_xyyz_0[j] + 0.5 * fl1_fx * tt_yz_xyyz_0[j] + 0.5 * fl1_fx * tt_xyz_yyz_0[j] + 2.0 * fl1_fz * ts_xxyz_xyyz_0[j] - fl1_fz * fl1_fga * ts_yz_xyyz_0[j];

                tt_xxyz_xyzz_0[j] = pa_x[j] * tt_xyz_xyzz_0[j] + 0.5 * fl1_fx * tt_yz_xyzz_0[j] + 0.5 * fl1_fx * tt_xyz_yzz_0[j] + 2.0 * fl1_fz * ts_xxyz_xyzz_0[j] - fl1_fz * fl1_fga * ts_yz_xyzz_0[j];

                tt_xxyz_xzzz_0[j] = pa_x[j] * tt_xyz_xzzz_0[j] + 0.5 * fl1_fx * tt_yz_xzzz_0[j] + 0.5 * fl1_fx * tt_xyz_zzz_0[j] + 2.0 * fl1_fz * ts_xxyz_xzzz_0[j] - fl1_fz * fl1_fga * ts_yz_xzzz_0[j];

                tt_xxyz_yyyy_0[j] = pa_x[j] * tt_xyz_yyyy_0[j] + 0.5 * fl1_fx * tt_yz_yyyy_0[j] + 2.0 * fl1_fz * ts_xxyz_yyyy_0[j] - fl1_fz * fl1_fga * ts_yz_yyyy_0[j];

                tt_xxyz_yyyz_0[j] = pa_x[j] * tt_xyz_yyyz_0[j] + 0.5 * fl1_fx * tt_yz_yyyz_0[j] + 2.0 * fl1_fz * ts_xxyz_yyyz_0[j] - fl1_fz * fl1_fga * ts_yz_yyyz_0[j];

                tt_xxyz_yyzz_0[j] = pa_x[j] * tt_xyz_yyzz_0[j] + 0.5 * fl1_fx * tt_yz_yyzz_0[j] + 2.0 * fl1_fz * ts_xxyz_yyzz_0[j] - fl1_fz * fl1_fga * ts_yz_yyzz_0[j];

                tt_xxyz_yzzz_0[j] = pa_x[j] * tt_xyz_yzzz_0[j] + 0.5 * fl1_fx * tt_yz_yzzz_0[j] + 2.0 * fl1_fz * ts_xxyz_yzzz_0[j] - fl1_fz * fl1_fga * ts_yz_yzzz_0[j];

                tt_xxyz_zzzz_0[j] = pa_x[j] * tt_xyz_zzzz_0[j] + 0.5 * fl1_fx * tt_yz_zzzz_0[j] + 2.0 * fl1_fz * ts_xxyz_zzzz_0[j] - fl1_fz * fl1_fga * ts_yz_zzzz_0[j];

                tt_xxzz_xxxx_0[j] = pa_x[j] * tt_xzz_xxxx_0[j] + 0.5 * fl1_fx * tt_zz_xxxx_0[j] + 2.0 * fl1_fx * tt_xzz_xxx_0[j] + 2.0 * fl1_fz * ts_xxzz_xxxx_0[j] - fl1_fz * fl1_fga * ts_zz_xxxx_0[j];

                tt_xxzz_xxxy_0[j] = pa_x[j] * tt_xzz_xxxy_0[j] + 0.5 * fl1_fx * tt_zz_xxxy_0[j] + 1.5 * fl1_fx * tt_xzz_xxy_0[j] + 2.0 * fl1_fz * ts_xxzz_xxxy_0[j] - fl1_fz * fl1_fga * ts_zz_xxxy_0[j];

                tt_xxzz_xxxz_0[j] = pa_x[j] * tt_xzz_xxxz_0[j] + 0.5 * fl1_fx * tt_zz_xxxz_0[j] + 1.5 * fl1_fx * tt_xzz_xxz_0[j] + 2.0 * fl1_fz * ts_xxzz_xxxz_0[j] - fl1_fz * fl1_fga * ts_zz_xxxz_0[j];

                tt_xxzz_xxyy_0[j] = pa_x[j] * tt_xzz_xxyy_0[j] + 0.5 * fl1_fx * tt_zz_xxyy_0[j] + fl1_fx * tt_xzz_xyy_0[j] + 2.0 * fl1_fz * ts_xxzz_xxyy_0[j] - fl1_fz * fl1_fga * ts_zz_xxyy_0[j];

                tt_xxzz_xxyz_0[j] = pa_x[j] * tt_xzz_xxyz_0[j] + 0.5 * fl1_fx * tt_zz_xxyz_0[j] + fl1_fx * tt_xzz_xyz_0[j] + 2.0 * fl1_fz * ts_xxzz_xxyz_0[j] - fl1_fz * fl1_fga * ts_zz_xxyz_0[j];

                tt_xxzz_xxzz_0[j] = pa_x[j] * tt_xzz_xxzz_0[j] + 0.5 * fl1_fx * tt_zz_xxzz_0[j] + fl1_fx * tt_xzz_xzz_0[j] + 2.0 * fl1_fz * ts_xxzz_xxzz_0[j] - fl1_fz * fl1_fga * ts_zz_xxzz_0[j];

                tt_xxzz_xyyy_0[j] = pa_x[j] * tt_xzz_xyyy_0[j] + 0.5 * fl1_fx * tt_zz_xyyy_0[j] + 0.5 * fl1_fx * tt_xzz_yyy_0[j] + 2.0 * fl1_fz * ts_xxzz_xyyy_0[j] - fl1_fz * fl1_fga * ts_zz_xyyy_0[j];

                tt_xxzz_xyyz_0[j] = pa_x[j] * tt_xzz_xyyz_0[j] + 0.5 * fl1_fx * tt_zz_xyyz_0[j] + 0.5 * fl1_fx * tt_xzz_yyz_0[j] + 2.0 * fl1_fz * ts_xxzz_xyyz_0[j] - fl1_fz * fl1_fga * ts_zz_xyyz_0[j];

                tt_xxzz_xyzz_0[j] = pa_x[j] * tt_xzz_xyzz_0[j] + 0.5 * fl1_fx * tt_zz_xyzz_0[j] + 0.5 * fl1_fx * tt_xzz_yzz_0[j] + 2.0 * fl1_fz * ts_xxzz_xyzz_0[j] - fl1_fz * fl1_fga * ts_zz_xyzz_0[j];

                tt_xxzz_xzzz_0[j] = pa_x[j] * tt_xzz_xzzz_0[j] + 0.5 * fl1_fx * tt_zz_xzzz_0[j] + 0.5 * fl1_fx * tt_xzz_zzz_0[j] + 2.0 * fl1_fz * ts_xxzz_xzzz_0[j] - fl1_fz * fl1_fga * ts_zz_xzzz_0[j];

                tt_xxzz_yyyy_0[j] = pa_x[j] * tt_xzz_yyyy_0[j] + 0.5 * fl1_fx * tt_zz_yyyy_0[j] + 2.0 * fl1_fz * ts_xxzz_yyyy_0[j] - fl1_fz * fl1_fga * ts_zz_yyyy_0[j];

                tt_xxzz_yyyz_0[j] = pa_x[j] * tt_xzz_yyyz_0[j] + 0.5 * fl1_fx * tt_zz_yyyz_0[j] + 2.0 * fl1_fz * ts_xxzz_yyyz_0[j] - fl1_fz * fl1_fga * ts_zz_yyyz_0[j];

                tt_xxzz_yyzz_0[j] = pa_x[j] * tt_xzz_yyzz_0[j] + 0.5 * fl1_fx * tt_zz_yyzz_0[j] + 2.0 * fl1_fz * ts_xxzz_yyzz_0[j] - fl1_fz * fl1_fga * ts_zz_yyzz_0[j];

                tt_xxzz_yzzz_0[j] = pa_x[j] * tt_xzz_yzzz_0[j] + 0.5 * fl1_fx * tt_zz_yzzz_0[j] + 2.0 * fl1_fz * ts_xxzz_yzzz_0[j] - fl1_fz * fl1_fga * ts_zz_yzzz_0[j];

                tt_xxzz_zzzz_0[j] = pa_x[j] * tt_xzz_zzzz_0[j] + 0.5 * fl1_fx * tt_zz_zzzz_0[j] + 2.0 * fl1_fz * ts_xxzz_zzzz_0[j] - fl1_fz * fl1_fga * ts_zz_zzzz_0[j];
            }
                                   ...
                                   const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tt_yyyy_xxxx_0[j] = pa_y[j] * tt_yyy_xxxx_0[j] + 1.5 * fl1_fx * tt_yy_xxxx_0[j] + 2.0 * fl1_fz * ts_yyyy_xxxx_0[j] - 3.0 * fl1_fz * fl1_fga * ts_yy_xxxx_0[j];

                tt_yyyy_xxxy_0[j] = pa_y[j] * tt_yyy_xxxy_0[j] + 1.5 * fl1_fx * tt_yy_xxxy_0[j] + 0.5 * fl1_fx * tt_yyy_xxx_0[j] + 2.0 * fl1_fz * ts_yyyy_xxxy_0[j] - 3.0 * fl1_fz * fl1_fga * ts_yy_xxxy_0[j];

                tt_yyyy_xxxz_0[j] = pa_y[j] * tt_yyy_xxxz_0[j] + 1.5 * fl1_fx * tt_yy_xxxz_0[j] + 2.0 * fl1_fz * ts_yyyy_xxxz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_yy_xxxz_0[j];

                tt_yyyy_xxyy_0[j] = pa_y[j] * tt_yyy_xxyy_0[j] + 1.5 * fl1_fx * tt_yy_xxyy_0[j] + fl1_fx * tt_yyy_xxy_0[j] + 2.0 * fl1_fz * ts_yyyy_xxyy_0[j] - 3.0 * fl1_fz * fl1_fga * ts_yy_xxyy_0[j];

                tt_yyyy_xxyz_0[j] = pa_y[j] * tt_yyy_xxyz_0[j] + 1.5 * fl1_fx * tt_yy_xxyz_0[j] + 0.5 * fl1_fx * tt_yyy_xxz_0[j] + 2.0 * fl1_fz * ts_yyyy_xxyz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_yy_xxyz_0[j];

                tt_yyyy_xxzz_0[j] = pa_y[j] * tt_yyy_xxzz_0[j] + 1.5 * fl1_fx * tt_yy_xxzz_0[j] + 2.0 * fl1_fz * ts_yyyy_xxzz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_yy_xxzz_0[j];

                tt_yyyy_xyyy_0[j] = pa_y[j] * tt_yyy_xyyy_0[j] + 1.5 * fl1_fx * tt_yy_xyyy_0[j] + 1.5 * fl1_fx * tt_yyy_xyy_0[j] + 2.0 * fl1_fz * ts_yyyy_xyyy_0[j] - 3.0 * fl1_fz * fl1_fga * ts_yy_xyyy_0[j];

                tt_yyyy_xyyz_0[j] = pa_y[j] * tt_yyy_xyyz_0[j] + 1.5 * fl1_fx * tt_yy_xyyz_0[j] + fl1_fx * tt_yyy_xyz_0[j] + 2.0 * fl1_fz * ts_yyyy_xyyz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_yy_xyyz_0[j];

                tt_yyyy_xyzz_0[j] = pa_y[j] * tt_yyy_xyzz_0[j] + 1.5 * fl1_fx * tt_yy_xyzz_0[j] + 0.5 * fl1_fx * tt_yyy_xzz_0[j] + 2.0 * fl1_fz * ts_yyyy_xyzz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_yy_xyzz_0[j];

                tt_yyyy_xzzz_0[j] = pa_y[j] * tt_yyy_xzzz_0[j] + 1.5 * fl1_fx * tt_yy_xzzz_0[j] + 2.0 * fl1_fz * ts_yyyy_xzzz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_yy_xzzz_0[j];

                tt_yyyy_yyyy_0[j] = pa_y[j] * tt_yyy_yyyy_0[j] + 1.5 * fl1_fx * tt_yy_yyyy_0[j] + 2.0 * fl1_fx * tt_yyy_yyy_0[j] + 2.0 * fl1_fz * ts_yyyy_yyyy_0[j] - 3.0 * fl1_fz * fl1_fga * ts_yy_yyyy_0[j];

                tt_yyyy_yyyz_0[j] = pa_y[j] * tt_yyy_yyyz_0[j] + 1.5 * fl1_fx * tt_yy_yyyz_0[j] + 1.5 * fl1_fx * tt_yyy_yyz_0[j] + 2.0 * fl1_fz * ts_yyyy_yyyz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_yy_yyyz_0[j];

                tt_yyyy_yyzz_0[j] = pa_y[j] * tt_yyy_yyzz_0[j] + 1.5 * fl1_fx * tt_yy_yyzz_0[j] + fl1_fx * tt_yyy_yzz_0[j] + 2.0 * fl1_fz * ts_yyyy_yyzz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_yy_yyzz_0[j];

                tt_yyyy_yzzz_0[j] = pa_y[j] * tt_yyy_yzzz_0[j] + 1.5 * fl1_fx * tt_yy_yzzz_0[j] + 0.5 * fl1_fx * tt_yyy_zzz_0[j] + 2.0 * fl1_fz * ts_yyyy_yzzz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_yy_yzzz_0[j];

                tt_yyyy_zzzz_0[j] = pa_y[j] * tt_yyy_zzzz_0[j] + 1.5 * fl1_fx * tt_yy_zzzz_0[j] + 2.0 * fl1_fz * ts_yyyy_zzzz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_yy_zzzz_0[j];

                tt_yyyz_xxxx_0[j] = pa_y[j] * tt_yyz_xxxx_0[j] + fl1_fx * tt_yz_xxxx_0[j] + 2.0 * fl1_fz * ts_yyyz_xxxx_0[j] - 2.0 * fl1_fz * fl1_fga * ts_yz_xxxx_0[j];

                tt_yyyz_xxxy_0[j] = pa_y[j] * tt_yyz_xxxy_0[j] + fl1_fx * tt_yz_xxxy_0[j] + 0.5 * fl1_fx * tt_yyz_xxx_0[j] + 2.0 * fl1_fz * ts_yyyz_xxxy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_yz_xxxy_0[j];

                tt_yyyz_xxxz_0[j] = pa_y[j] * tt_yyz_xxxz_0[j] + fl1_fx * tt_yz_xxxz_0[j] + 2.0 * fl1_fz * ts_yyyz_xxxz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_yz_xxxz_0[j];

                tt_yyyz_xxyy_0[j] = pa_y[j] * tt_yyz_xxyy_0[j] + fl1_fx * tt_yz_xxyy_0[j] + fl1_fx * tt_yyz_xxy_0[j] + 2.0 * fl1_fz * ts_yyyz_xxyy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_yz_xxyy_0[j];

                tt_yyyz_xxyz_0[j] = pa_y[j] * tt_yyz_xxyz_0[j] + fl1_fx * tt_yz_xxyz_0[j] + 0.5 * fl1_fx * tt_yyz_xxz_0[j] + 2.0 * fl1_fz * ts_yyyz_xxyz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_yz_xxyz_0[j];

                tt_yyyz_xxzz_0[j] = pa_y[j] * tt_yyz_xxzz_0[j] + fl1_fx * tt_yz_xxzz_0[j] + 2.0 * fl1_fz * ts_yyyz_xxzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_yz_xxzz_0[j];

                tt_yyyz_xyyy_0[j] = pa_y[j] * tt_yyz_xyyy_0[j] + fl1_fx * tt_yz_xyyy_0[j] + 1.5 * fl1_fx * tt_yyz_xyy_0[j] + 2.0 * fl1_fz * ts_yyyz_xyyy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_yz_xyyy_0[j];

                tt_yyyz_xyyz_0[j] = pa_y[j] * tt_yyz_xyyz_0[j] + fl1_fx * tt_yz_xyyz_0[j] + fl1_fx * tt_yyz_xyz_0[j] + 2.0 * fl1_fz * ts_yyyz_xyyz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_yz_xyyz_0[j];

                tt_yyyz_xyzz_0[j] = pa_y[j] * tt_yyz_xyzz_0[j] + fl1_fx * tt_yz_xyzz_0[j] + 0.5 * fl1_fx * tt_yyz_xzz_0[j] + 2.0 * fl1_fz * ts_yyyz_xyzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_yz_xyzz_0[j];

                tt_yyyz_xzzz_0[j] = pa_y[j] * tt_yyz_xzzz_0[j] + fl1_fx * tt_yz_xzzz_0[j] + 2.0 * fl1_fz * ts_yyyz_xzzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_yz_xzzz_0[j];

                tt_yyyz_yyyy_0[j] = pa_y[j] * tt_yyz_yyyy_0[j] + fl1_fx * tt_yz_yyyy_0[j] + 2.0 * fl1_fx * tt_yyz_yyy_0[j] + 2.0 * fl1_fz * ts_yyyz_yyyy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_yz_yyyy_0[j];

                tt_yyyz_yyyz_0[j] = pa_y[j] * tt_yyz_yyyz_0[j] + fl1_fx * tt_yz_yyyz_0[j] + 1.5 * fl1_fx * tt_yyz_yyz_0[j] + 2.0 * fl1_fz * ts_yyyz_yyyz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_yz_yyyz_0[j];

                tt_yyyz_yyzz_0[j] = pa_y[j] * tt_yyz_yyzz_0[j] + fl1_fx * tt_yz_yyzz_0[j] + fl1_fx * tt_yyz_yzz_0[j] + 2.0 * fl1_fz * ts_yyyz_yyzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_yz_yyzz_0[j];

                tt_yyyz_yzzz_0[j] = pa_y[j] * tt_yyz_yzzz_0[j] + fl1_fx * tt_yz_yzzz_0[j] + 0.5 * fl1_fx * tt_yyz_zzz_0[j] + 2.0 * fl1_fz * ts_yyyz_yzzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_yz_yzzz_0[j];

                tt_yyyz_zzzz_0[j] = pa_y[j] * tt_yyz_zzzz_0[j] + fl1_fx * tt_yz_zzzz_0[j] + 2.0 * fl1_fz * ts_yyyz_zzzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_yz_zzzz_0[j];
            }
                                   ...
                                   const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tt_yyzz_xxxx_0[j] = pa_y[j] * tt_yzz_xxxx_0[j] + 0.5 * fl1_fx * tt_zz_xxxx_0[j] + 2.0 * fl1_fz * ts_yyzz_xxxx_0[j] - fl1_fz * fl1_fga * ts_zz_xxxx_0[j];

                tt_yyzz_xxxy_0[j] = pa_y[j] * tt_yzz_xxxy_0[j] + 0.5 * fl1_fx * tt_zz_xxxy_0[j] + 0.5 * fl1_fx * tt_yzz_xxx_0[j] + 2.0 * fl1_fz * ts_yyzz_xxxy_0[j] - fl1_fz * fl1_fga * ts_zz_xxxy_0[j];

                tt_yyzz_xxxz_0[j] = pa_y[j] * tt_yzz_xxxz_0[j] + 0.5 * fl1_fx * tt_zz_xxxz_0[j] + 2.0 * fl1_fz * ts_yyzz_xxxz_0[j] - fl1_fz * fl1_fga * ts_zz_xxxz_0[j];

                tt_yyzz_xxyy_0[j] = pa_y[j] * tt_yzz_xxyy_0[j] + 0.5 * fl1_fx * tt_zz_xxyy_0[j] + fl1_fx * tt_yzz_xxy_0[j] + 2.0 * fl1_fz * ts_yyzz_xxyy_0[j] - fl1_fz * fl1_fga * ts_zz_xxyy_0[j];

                tt_yyzz_xxyz_0[j] = pa_y[j] * tt_yzz_xxyz_0[j] + 0.5 * fl1_fx * tt_zz_xxyz_0[j] + 0.5 * fl1_fx * tt_yzz_xxz_0[j] + 2.0 * fl1_fz * ts_yyzz_xxyz_0[j] - fl1_fz * fl1_fga * ts_zz_xxyz_0[j];

                tt_yyzz_xxzz_0[j] = pa_y[j] * tt_yzz_xxzz_0[j] + 0.5 * fl1_fx * tt_zz_xxzz_0[j] + 2.0 * fl1_fz * ts_yyzz_xxzz_0[j] - fl1_fz * fl1_fga * ts_zz_xxzz_0[j];

                tt_yyzz_xyyy_0[j] = pa_y[j] * tt_yzz_xyyy_0[j] + 0.5 * fl1_fx * tt_zz_xyyy_0[j] + 1.5 * fl1_fx * tt_yzz_xyy_0[j] + 2.0 * fl1_fz * ts_yyzz_xyyy_0[j] - fl1_fz * fl1_fga * ts_zz_xyyy_0[j];

                tt_yyzz_xyyz_0[j] = pa_y[j] * tt_yzz_xyyz_0[j] + 0.5 * fl1_fx * tt_zz_xyyz_0[j] + fl1_fx * tt_yzz_xyz_0[j] + 2.0 * fl1_fz * ts_yyzz_xyyz_0[j] - fl1_fz * fl1_fga * ts_zz_xyyz_0[j];

                tt_yyzz_xyzz_0[j] = pa_y[j] * tt_yzz_xyzz_0[j] + 0.5 * fl1_fx * tt_zz_xyzz_0[j] + 0.5 * fl1_fx * tt_yzz_xzz_0[j] + 2.0 * fl1_fz * ts_yyzz_xyzz_0[j] - fl1_fz * fl1_fga * ts_zz_xyzz_0[j];

                tt_yyzz_xzzz_0[j] = pa_y[j] * tt_yzz_xzzz_0[j] + 0.5 * fl1_fx * tt_zz_xzzz_0[j] + 2.0 * fl1_fz * ts_yyzz_xzzz_0[j] - fl1_fz * fl1_fga * ts_zz_xzzz_0[j];

                tt_yyzz_yyyy_0[j] = pa_y[j] * tt_yzz_yyyy_0[j] + 0.5 * fl1_fx * tt_zz_yyyy_0[j] + 2.0 * fl1_fx * tt_yzz_yyy_0[j] + 2.0 * fl1_fz * ts_yyzz_yyyy_0[j] - fl1_fz * fl1_fga * ts_zz_yyyy_0[j];

                tt_yyzz_yyyz_0[j] = pa_y[j] * tt_yzz_yyyz_0[j] + 0.5 * fl1_fx * tt_zz_yyyz_0[j] + 1.5 * fl1_fx * tt_yzz_yyz_0[j] + 2.0 * fl1_fz * ts_yyzz_yyyz_0[j] - fl1_fz * fl1_fga * ts_zz_yyyz_0[j];

                tt_yyzz_yyzz_0[j] = pa_y[j] * tt_yzz_yyzz_0[j] + 0.5 * fl1_fx * tt_zz_yyzz_0[j] + fl1_fx * tt_yzz_yzz_0[j] + 2.0 * fl1_fz * ts_yyzz_yyzz_0[j] - fl1_fz * fl1_fga * ts_zz_yyzz_0[j];

                tt_yyzz_yzzz_0[j] = pa_y[j] * tt_yzz_yzzz_0[j] + 0.5 * fl1_fx * tt_zz_yzzz_0[j] + 0.5 * fl1_fx * tt_yzz_zzz_0[j] + 2.0 * fl1_fz * ts_yyzz_yzzz_0[j] - fl1_fz * fl1_fga * ts_zz_yzzz_0[j];

                tt_yyzz_zzzz_0[j] = pa_y[j] * tt_yzz_zzzz_0[j] + 0.5 * fl1_fx * tt_zz_zzzz_0[j] + 2.0 * fl1_fz * ts_yyzz_zzzz_0[j] - fl1_fz * fl1_fga * ts_zz_zzzz_0[j];
                ...
                tt_zzzz_xxxx_0[j] = pa_z[j] * tt_zzz_xxxx_0[j] + 1.5 * fl1_fx * tt_zz_xxxx_0[j] + 2.0 * fl1_fz * ts_zzzz_xxxx_0[j] - 3.0 * fl1_fz * fl1_fga * ts_zz_xxxx_0[j];

                tt_zzzz_xxxy_0[j] = pa_z[j] * tt_zzz_xxxy_0[j] + 1.5 * fl1_fx * tt_zz_xxxy_0[j] + 2.0 * fl1_fz * ts_zzzz_xxxy_0[j] - 3.0 * fl1_fz * fl1_fga * ts_zz_xxxy_0[j];

                tt_zzzz_xxxz_0[j] = pa_z[j] * tt_zzz_xxxz_0[j] + 1.5 * fl1_fx * tt_zz_xxxz_0[j] + 0.5 * fl1_fx * tt_zzz_xxx_0[j] + 2.0 * fl1_fz * ts_zzzz_xxxz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_zz_xxxz_0[j];

                tt_zzzz_xxyy_0[j] = pa_z[j] * tt_zzz_xxyy_0[j] + 1.5 * fl1_fx * tt_zz_xxyy_0[j] + 2.0 * fl1_fz * ts_zzzz_xxyy_0[j] - 3.0 * fl1_fz * fl1_fga * ts_zz_xxyy_0[j];

                tt_zzzz_xxyz_0[j] = pa_z[j] * tt_zzz_xxyz_0[j] + 1.5 * fl1_fx * tt_zz_xxyz_0[j] + 0.5 * fl1_fx * tt_zzz_xxy_0[j] + 2.0 * fl1_fz * ts_zzzz_xxyz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_zz_xxyz_0[j];

                tt_zzzz_xxzz_0[j] = pa_z[j] * tt_zzz_xxzz_0[j] + 1.5 * fl1_fx * tt_zz_xxzz_0[j] + fl1_fx * tt_zzz_xxz_0[j] + 2.0 * fl1_fz * ts_zzzz_xxzz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_zz_xxzz_0[j];

                tt_zzzz_xyyy_0[j] = pa_z[j] * tt_zzz_xyyy_0[j] + 1.5 * fl1_fx * tt_zz_xyyy_0[j] + 2.0 * fl1_fz * ts_zzzz_xyyy_0[j] - 3.0 * fl1_fz * fl1_fga * ts_zz_xyyy_0[j];

                tt_zzzz_xyyz_0[j] = pa_z[j] * tt_zzz_xyyz_0[j] + 1.5 * fl1_fx * tt_zz_xyyz_0[j] + 0.5 * fl1_fx * tt_zzz_xyy_0[j] + 2.0 * fl1_fz * ts_zzzz_xyyz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_zz_xyyz_0[j];

                tt_zzzz_xyzz_0[j] = pa_z[j] * tt_zzz_xyzz_0[j] + 1.5 * fl1_fx * tt_zz_xyzz_0[j] + fl1_fx * tt_zzz_xyz_0[j] + 2.0 * fl1_fz * ts_zzzz_xyzz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_zz_xyzz_0[j];

                tt_zzzz_xzzz_0[j] = pa_z[j] * tt_zzz_xzzz_0[j] + 1.5 * fl1_fx * tt_zz_xzzz_0[j] + 1.5 * fl1_fx * tt_zzz_xzz_0[j] + 2.0 * fl1_fz * ts_zzzz_xzzz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_zz_xzzz_0[j];

                tt_zzzz_yyyy_0[j] = pa_z[j] * tt_zzz_yyyy_0[j] + 1.5 * fl1_fx * tt_zz_yyyy_0[j] + 2.0 * fl1_fz * ts_zzzz_yyyy_0[j] - 3.0 * fl1_fz * fl1_fga * ts_zz_yyyy_0[j];

                tt_zzzz_yyyz_0[j] = pa_z[j] * tt_zzz_yyyz_0[j] + 1.5 * fl1_fx * tt_zz_yyyz_0[j] + 0.5 * fl1_fx * tt_zzz_yyy_0[j] + 2.0 * fl1_fz * ts_zzzz_yyyz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_zz_yyyz_0[j];

                tt_zzzz_yyzz_0[j] = pa_z[j] * tt_zzz_yyzz_0[j] + 1.5 * fl1_fx * tt_zz_yyzz_0[j] + fl1_fx * tt_zzz_yyz_0[j] + 2.0 * fl1_fz * ts_zzzz_yyzz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_zz_yyzz_0[j];

                tt_zzzz_yzzz_0[j] = pa_z[j] * tt_zzz_yzzz_0[j] + 1.5 * fl1_fx * tt_zz_yzzz_0[j] + 1.5 * fl1_fx * tt_zzz_yzz_0[j] + 2.0 * fl1_fz * ts_zzzz_yzzz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_zz_yzzz_0[j];

                tt_zzzz_zzzz_0[j] = pa_z[j] * tt_zzz_zzzz_0[j] + 1.5 * fl1_fx * tt_zz_zzzz_0[j] + 2.0 * fl1_fx * tt_zzz_zzz_0[j] + 2.0 * fl1_fz * ts_zzzz_zzzz_0[j] - 3.0 * fl1_fz * fl1_fga * ts_zz_zzzz_0[j];
            }
