...
namespace ediprecfunc { // ediprecfunc namespace
    ...
    {
        ediprecfunc::compElectricDipoleForGG_0_49(primBuffer,
                                                  recursionMap,
                                                  osFactors,
                                                  nOSFactors,
                                                  paDistances, 
        ...
        ediprecfunc::compElectricDipoleForGG_49_98(primBuffer,
                                                   recursionMap,
                                                   osFactors,
                                                   nOSFactors,
                                                   paDistances, 
        ...
        ediprecfunc::compElectricDipoleForGG_98_147(primBuffer,
                                                    recursionMap,
                                                    osFactors,
                                                    nOSFactors,
                                                    paDistances, 
        ...
        ediprecfunc::compElectricDipoleForGG_147_195(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     nOSFactors,
                                                     paDistances, 
        ...
        ediprecfunc::compElectricDipoleForGG_195_243(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     nOSFactors,
                                                     paDistances, 
        ...
        ediprecfunc::compElectricDipoleForGG_243_291(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     nOSFactors,
                                                     paDistances, 
        ...
        ediprecfunc::compElectricDipoleForGG_291_339(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     nOSFactors,
                                                     paDistances, 
        ...
        ediprecfunc::compElectricDipoleForGG_339_387(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     nOSFactors,
                                                     paDistances, 
        ...
        ediprecfunc::compElectricDipoleForGG_387_435(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     nOSFactors,
                                                     paDistances, 
        ...
        ediprecfunc::compElectricDipoleForGG_435_483(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     nOSFactors,
                                                     paDistances, 
        ...
        ediprecfunc::compElectricDipoleForGG_483_531(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     nOSFactors,
                                                     paDistances, 
        ...
        ediprecfunc::compElectricDipoleForGG_531_579(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     nOSFactors,
                                                     paDistances, 
        ...
        ediprecfunc::compElectricDipoleForGG_579_627(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     nOSFactors,
                                                     paDistances, 
        ...
        ediprecfunc::compElectricDipoleForGG_627_675(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     nOSFactors,
                                                     paDistances, 
                                 ...
                                 const int32_t              iContrGto)
    {
        ...
        auto pidx_d_4_4_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Electric Dipole"}, 1, true, 
                                                         {4, -1, -1, -1}, {4, -1, -1, -1}, 
                                                         1, 1, 0));
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tdx_xxxx_xxxx_0[j] = pa_x[j] * tdx_xxx_xxxx_0[j] + 1.5 * fl1_fx * tdx_xx_xxxx_0[j] + 2.0 * fl1_fx * tdx_xxx_xxx_0[j] + 0.5 * fl1_fx * ts_xxx_xxxx_0[j];
                ...
                tdx_xxxx_xxxy_0[j] = pa_x[j] * tdx_xxx_xxxy_0[j] + 1.5 * fl1_fx * tdx_xx_xxxy_0[j] + 1.5 * fl1_fx * tdx_xxx_xxy_0[j] + 0.5 * fl1_fx * ts_xxx_xxxy_0[j];
                ...
                tdx_xxxx_xxxz_0[j] = pa_x[j] * tdx_xxx_xxxz_0[j] + 1.5 * fl1_fx * tdx_xx_xxxz_0[j] + 1.5 * fl1_fx * tdx_xxx_xxz_0[j] + 0.5 * fl1_fx * ts_xxx_xxxz_0[j];
                ...
                tdx_xxxx_xxyy_0[j] = pa_x[j] * tdx_xxx_xxyy_0[j] + 1.5 * fl1_fx * tdx_xx_xxyy_0[j] + fl1_fx * tdx_xxx_xyy_0[j] + 0.5 * fl1_fx * ts_xxx_xxyy_0[j];
                ...
                tdx_xxxx_xxyz_0[j] = pa_x[j] * tdx_xxx_xxyz_0[j] + 1.5 * fl1_fx * tdx_xx_xxyz_0[j] + fl1_fx * tdx_xxx_xyz_0[j] + 0.5 * fl1_fx * ts_xxx_xxyz_0[j];
                ...
                tdx_xxxx_xxzz_0[j] = pa_x[j] * tdx_xxx_xxzz_0[j] + 1.5 * fl1_fx * tdx_xx_xxzz_0[j] + fl1_fx * tdx_xxx_xzz_0[j] + 0.5 * fl1_fx * ts_xxx_xxzz_0[j];
                ...
                tdx_xxxx_xyyy_0[j] = pa_x[j] * tdx_xxx_xyyy_0[j] + 1.5 * fl1_fx * tdx_xx_xyyy_0[j] + 0.5 * fl1_fx * tdx_xxx_yyy_0[j] + 0.5 * fl1_fx * ts_xxx_xyyy_0[j];
                ...
                tdx_xxxx_xyyz_0[j] = pa_x[j] * tdx_xxx_xyyz_0[j] + 1.5 * fl1_fx * tdx_xx_xyyz_0[j] + 0.5 * fl1_fx * tdx_xxx_yyz_0[j] + 0.5 * fl1_fx * ts_xxx_xyyz_0[j];
                ...
                tdx_xxxx_xyzz_0[j] = pa_x[j] * tdx_xxx_xyzz_0[j] + 1.5 * fl1_fx * tdx_xx_xyzz_0[j] + 0.5 * fl1_fx * tdx_xxx_yzz_0[j] + 0.5 * fl1_fx * ts_xxx_xyzz_0[j];
                ...
                tdx_xxxx_xzzz_0[j] = pa_x[j] * tdx_xxx_xzzz_0[j] + 1.5 * fl1_fx * tdx_xx_xzzz_0[j] + 0.5 * fl1_fx * tdx_xxx_zzz_0[j] + 0.5 * fl1_fx * ts_xxx_xzzz_0[j];
                ...
                tdx_xxxy_xxxx_0[j] = pa_x[j] * tdx_xxy_xxxx_0[j] + fl1_fx * tdx_xy_xxxx_0[j] + 2.0 * fl1_fx * tdx_xxy_xxx_0[j] + 0.5 * fl1_fx * ts_xxy_xxxx_0[j];
                ...
                tdx_xxxy_xxxy_0[j] = pa_x[j] * tdx_xxy_xxxy_0[j] + fl1_fx * tdx_xy_xxxy_0[j] + 1.5 * fl1_fx * tdx_xxy_xxy_0[j] + 0.5 * fl1_fx * ts_xxy_xxxy_0[j];
            }
                                  ...
                                  const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tdx_xxxy_xxxz_0[j] = pa_x[j] * tdx_xxy_xxxz_0[j] + fl1_fx * tdx_xy_xxxz_0[j] + 1.5 * fl1_fx * tdx_xxy_xxz_0[j] + 0.5 * fl1_fx * ts_xxy_xxxz_0[j];
                ...
                tdx_xxxy_xxyy_0[j] = pa_x[j] * tdx_xxy_xxyy_0[j] + fl1_fx * tdx_xy_xxyy_0[j] + fl1_fx * tdx_xxy_xyy_0[j] + 0.5 * fl1_fx * ts_xxy_xxyy_0[j];
                ...
                tdx_xxxy_xxyz_0[j] = pa_x[j] * tdx_xxy_xxyz_0[j] + fl1_fx * tdx_xy_xxyz_0[j] + fl1_fx * tdx_xxy_xyz_0[j] + 0.5 * fl1_fx * ts_xxy_xxyz_0[j];
                ...
                tdx_xxxy_xxzz_0[j] = pa_x[j] * tdx_xxy_xxzz_0[j] + fl1_fx * tdx_xy_xxzz_0[j] + fl1_fx * tdx_xxy_xzz_0[j] + 0.5 * fl1_fx * ts_xxy_xxzz_0[j];
                ...
                tdx_xxxy_xyyy_0[j] = pa_x[j] * tdx_xxy_xyyy_0[j] + fl1_fx * tdx_xy_xyyy_0[j] + 0.5 * fl1_fx * tdx_xxy_yyy_0[j] + 0.5 * fl1_fx * ts_xxy_xyyy_0[j];
                ...
                tdx_xxxy_xyyz_0[j] = pa_x[j] * tdx_xxy_xyyz_0[j] + fl1_fx * tdx_xy_xyyz_0[j] + 0.5 * fl1_fx * tdx_xxy_yyz_0[j] + 0.5 * fl1_fx * ts_xxy_xyyz_0[j];
                ...
                tdx_xxxy_xyzz_0[j] = pa_x[j] * tdx_xxy_xyzz_0[j] + fl1_fx * tdx_xy_xyzz_0[j] + 0.5 * fl1_fx * tdx_xxy_yzz_0[j] + 0.5 * fl1_fx * ts_xxy_xyzz_0[j];
                ...
                tdx_xxxy_xzzz_0[j] = pa_x[j] * tdx_xxy_xzzz_0[j] + fl1_fx * tdx_xy_xzzz_0[j] + 0.5 * fl1_fx * tdx_xxy_zzz_0[j] + 0.5 * fl1_fx * ts_xxy_xzzz_0[j];
                ...
                tdx_xxxz_xxxx_0[j] = pa_x[j] * tdx_xxz_xxxx_0[j] + fl1_fx * tdx_xz_xxxx_0[j] + 2.0 * fl1_fx * tdx_xxz_xxx_0[j] + 0.5 * fl1_fx * ts_xxz_xxxx_0[j];
                ...
                tdx_xxxz_xxxy_0[j] = pa_x[j] * tdx_xxz_xxxy_0[j] + fl1_fx * tdx_xz_xxxy_0[j] + 1.5 * fl1_fx * tdx_xxz_xxy_0[j] + 0.5 * fl1_fx * ts_xxz_xxxy_0[j];
                ...
                tdx_xxxz_xxxz_0[j] = pa_x[j] * tdx_xxz_xxxz_0[j] + fl1_fx * tdx_xz_xxxz_0[j] + 1.5 * fl1_fx * tdx_xxz_xxz_0[j] + 0.5 * fl1_fx * ts_xxz_xxxz_0[j];
                                   ...
                                   const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tdx_xxxz_xxyy_0[j] = pa_x[j] * tdx_xxz_xxyy_0[j] + fl1_fx * tdx_xz_xxyy_0[j] + fl1_fx * tdx_xxz_xyy_0[j] + 0.5 * fl1_fx * ts_xxz_xxyy_0[j];
                ...
                tdx_xxxz_xxyz_0[j] = pa_x[j] * tdx_xxz_xxyz_0[j] + fl1_fx * tdx_xz_xxyz_0[j] + fl1_fx * tdx_xxz_xyz_0[j] + 0.5 * fl1_fx * ts_xxz_xxyz_0[j];
                ...
                tdx_xxxz_xxzz_0[j] = pa_x[j] * tdx_xxz_xxzz_0[j] + fl1_fx * tdx_xz_xxzz_0[j] + fl1_fx * tdx_xxz_xzz_0[j] + 0.5 * fl1_fx * ts_xxz_xxzz_0[j];
                ...
                tdx_xxxz_xyyy_0[j] = pa_x[j] * tdx_xxz_xyyy_0[j] + fl1_fx * tdx_xz_xyyy_0[j] + 0.5 * fl1_fx * tdx_xxz_yyy_0[j] + 0.5 * fl1_fx * ts_xxz_xyyy_0[j];
                ...
                tdx_xxxz_xyyz_0[j] = pa_x[j] * tdx_xxz_xyyz_0[j] + fl1_fx * tdx_xz_xyyz_0[j] + 0.5 * fl1_fx * tdx_xxz_yyz_0[j] + 0.5 * fl1_fx * ts_xxz_xyyz_0[j];
                ...
                tdx_xxxz_xyzz_0[j] = pa_x[j] * tdx_xxz_xyzz_0[j] + fl1_fx * tdx_xz_xyzz_0[j] + 0.5 * fl1_fx * tdx_xxz_yzz_0[j] + 0.5 * fl1_fx * ts_xxz_xyzz_0[j];
                ...
                tdx_xxxz_xzzz_0[j] = pa_x[j] * tdx_xxz_xzzz_0[j] + fl1_fx * tdx_xz_xzzz_0[j] + 0.5 * fl1_fx * tdx_xxz_zzz_0[j] + 0.5 * fl1_fx * ts_xxz_xzzz_0[j];
                ...
                tdx_xxyy_xxxx_0[j] = pa_x[j] * tdx_xyy_xxxx_0[j] + 0.5 * fl1_fx * tdx_yy_xxxx_0[j] + 2.0 * fl1_fx * tdx_xyy_xxx_0[j] + 0.5 * fl1_fx * ts_xyy_xxxx_0[j];
                ...
                tdx_xxyy_xxxy_0[j] = pa_x[j] * tdx_xyy_xxxy_0[j] + 0.5 * fl1_fx * tdx_yy_xxxy_0[j] + 1.5 * fl1_fx * tdx_xyy_xxy_0[j] + 0.5 * fl1_fx * ts_xyy_xxxy_0[j];
                ...
                tdx_xxyy_xxxz_0[j] = pa_x[j] * tdx_xyy_xxxz_0[j] + 0.5 * fl1_fx * tdx_yy_xxxz_0[j] + 1.5 * fl1_fx * tdx_xyy_xxz_0[j] + 0.5 * fl1_fx * ts_xyy_xxxz_0[j];
                ...
                tdx_xxyy_xxyy_0[j] = pa_x[j] * tdx_xyy_xxyy_0[j] + 0.5 * fl1_fx * tdx_yy_xxyy_0[j] + fl1_fx * tdx_xyy_xyy_0[j] + 0.5 * fl1_fx * ts_xyy_xxyy_0[j];
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tdx_xxyy_xxyz_0[j] = pa_x[j] * tdx_xyy_xxyz_0[j] + 0.5 * fl1_fx * tdx_yy_xxyz_0[j] + fl1_fx * tdx_xyy_xyz_0[j] + 0.5 * fl1_fx * ts_xyy_xxyz_0[j];
                ...
                tdx_xxyy_xxzz_0[j] = pa_x[j] * tdx_xyy_xxzz_0[j] + 0.5 * fl1_fx * tdx_yy_xxzz_0[j] + fl1_fx * tdx_xyy_xzz_0[j] + 0.5 * fl1_fx * ts_xyy_xxzz_0[j];
                ...
                tdx_xxyy_xyyy_0[j] = pa_x[j] * tdx_xyy_xyyy_0[j] + 0.5 * fl1_fx * tdx_yy_xyyy_0[j] + 0.5 * fl1_fx * tdx_xyy_yyy_0[j] + 0.5 * fl1_fx * ts_xyy_xyyy_0[j];
                ...
                tdx_xxyy_xyyz_0[j] = pa_x[j] * tdx_xyy_xyyz_0[j] + 0.5 * fl1_fx * tdx_yy_xyyz_0[j] + 0.5 * fl1_fx * tdx_xyy_yyz_0[j] + 0.5 * fl1_fx * ts_xyy_xyyz_0[j];
                ...
                tdx_xxyy_xyzz_0[j] = pa_x[j] * tdx_xyy_xyzz_0[j] + 0.5 * fl1_fx * tdx_yy_xyzz_0[j] + 0.5 * fl1_fx * tdx_xyy_yzz_0[j] + 0.5 * fl1_fx * ts_xyy_xyzz_0[j];
                ...
                tdx_xxyy_xzzz_0[j] = pa_x[j] * tdx_xyy_xzzz_0[j] + 0.5 * fl1_fx * tdx_yy_xzzz_0[j] + 0.5 * fl1_fx * tdx_xyy_zzz_0[j] + 0.5 * fl1_fx * ts_xyy_xzzz_0[j];
                ...
                tdx_xxyz_xxxx_0[j] = pa_x[j] * tdx_xyz_xxxx_0[j] + 0.5 * fl1_fx * tdx_yz_xxxx_0[j] + 2.0 * fl1_fx * tdx_xyz_xxx_0[j] + 0.5 * fl1_fx * ts_xyz_xxxx_0[j];
                ...
                tdx_xxyz_xxxy_0[j] = pa_x[j] * tdx_xyz_xxxy_0[j] + 0.5 * fl1_fx * tdx_yz_xxxy_0[j] + 1.5 * fl1_fx * tdx_xyz_xxy_0[j] + 0.5 * fl1_fx * ts_xyz_xxxy_0[j];
                ...
                tdx_xxyz_xxxz_0[j] = pa_x[j] * tdx_xyz_xxxz_0[j] + 0.5 * fl1_fx * tdx_yz_xxxz_0[j] + 1.5 * fl1_fx * tdx_xyz_xxz_0[j] + 0.5 * fl1_fx * ts_xyz_xxxz_0[j];
                ...
                tdx_xxyz_xxyy_0[j] = pa_x[j] * tdx_xyz_xxyy_0[j] + 0.5 * fl1_fx * tdx_yz_xxyy_0[j] + fl1_fx * tdx_xyz_xyy_0[j] + 0.5 * fl1_fx * ts_xyz_xxyy_0[j];
                ...
                tdx_xxyz_xxyz_0[j] = pa_x[j] * tdx_xyz_xxyz_0[j] + 0.5 * fl1_fx * tdx_yz_xxyz_0[j] + fl1_fx * tdx_xyz_xyz_0[j] + 0.5 * fl1_fx * ts_xyz_xxyz_0[j];
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tdx_xxyz_xxzz_0[j] = pa_x[j] * tdx_xyz_xxzz_0[j] + 0.5 * fl1_fx * tdx_yz_xxzz_0[j] + fl1_fx * tdx_xyz_xzz_0[j] + 0.5 * fl1_fx * ts_xyz_xxzz_0[j];
                ...
                tdx_xxyz_xyyy_0[j] = pa_x[j] * tdx_xyz_xyyy_0[j] + 0.5 * fl1_fx * tdx_yz_xyyy_0[j] + 0.5 * fl1_fx * tdx_xyz_yyy_0[j] + 0.5 * fl1_fx * ts_xyz_xyyy_0[j];
                ...
                tdx_xxyz_xyyz_0[j] = pa_x[j] * tdx_xyz_xyyz_0[j] + 0.5 * fl1_fx * tdx_yz_xyyz_0[j] + 0.5 * fl1_fx * tdx_xyz_yyz_0[j] + 0.5 * fl1_fx * ts_xyz_xyyz_0[j];
                ...
                tdx_xxyz_xyzz_0[j] = pa_x[j] * tdx_xyz_xyzz_0[j] + 0.5 * fl1_fx * tdx_yz_xyzz_0[j] + 0.5 * fl1_fx * tdx_xyz_yzz_0[j] + 0.5 * fl1_fx * ts_xyz_xyzz_0[j];
                ...
                tdx_xxyz_xzzz_0[j] = pa_x[j] * tdx_xyz_xzzz_0[j] + 0.5 * fl1_fx * tdx_yz_xzzz_0[j] + 0.5 * fl1_fx * tdx_xyz_zzz_0[j] + 0.5 * fl1_fx * ts_xyz_xzzz_0[j];
                ...
                tdx_xxzz_xxxx_0[j] = pa_x[j] * tdx_xzz_xxxx_0[j] + 0.5 * fl1_fx * tdx_zz_xxxx_0[j] + 2.0 * fl1_fx * tdx_xzz_xxx_0[j] + 0.5 * fl1_fx * ts_xzz_xxxx_0[j];
                ...
                tdx_xxzz_xxxy_0[j] = pa_x[j] * tdx_xzz_xxxy_0[j] + 0.5 * fl1_fx * tdx_zz_xxxy_0[j] + 1.5 * fl1_fx * tdx_xzz_xxy_0[j] + 0.5 * fl1_fx * ts_xzz_xxxy_0[j];
                ...
                tdx_xxzz_xxxz_0[j] = pa_x[j] * tdx_xzz_xxxz_0[j] + 0.5 * fl1_fx * tdx_zz_xxxz_0[j] + 1.5 * fl1_fx * tdx_xzz_xxz_0[j] + 0.5 * fl1_fx * ts_xzz_xxxz_0[j];
                ...
                tdx_xxzz_xxyy_0[j] = pa_x[j] * tdx_xzz_xxyy_0[j] + 0.5 * fl1_fx * tdx_zz_xxyy_0[j] + fl1_fx * tdx_xzz_xyy_0[j] + 0.5 * fl1_fx * ts_xzz_xxyy_0[j];
                ...
                tdx_xxzz_xxyz_0[j] = pa_x[j] * tdx_xzz_xxyz_0[j] + 0.5 * fl1_fx * tdx_zz_xxyz_0[j] + fl1_fx * tdx_xzz_xyz_0[j] + 0.5 * fl1_fx * ts_xzz_xxyz_0[j];
                ...
                tdx_xxzz_xxzz_0[j] = pa_x[j] * tdx_xzz_xxzz_0[j] + 0.5 * fl1_fx * tdx_zz_xxzz_0[j] + fl1_fx * tdx_xzz_xzz_0[j] + 0.5 * fl1_fx * ts_xzz_xxzz_0[j];
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tdx_xxzz_xyyy_0[j] = pa_x[j] * tdx_xzz_xyyy_0[j] + 0.5 * fl1_fx * tdx_zz_xyyy_0[j] + 0.5 * fl1_fx * tdx_xzz_yyy_0[j] + 0.5 * fl1_fx * ts_xzz_xyyy_0[j];
                ...
                tdx_xxzz_xyyz_0[j] = pa_x[j] * tdx_xzz_xyyz_0[j] + 0.5 * fl1_fx * tdx_zz_xyyz_0[j] + 0.5 * fl1_fx * tdx_xzz_yyz_0[j] + 0.5 * fl1_fx * ts_xzz_xyyz_0[j];
                ...
                tdx_xxzz_xyzz_0[j] = pa_x[j] * tdx_xzz_xyzz_0[j] + 0.5 * fl1_fx * tdx_zz_xyzz_0[j] + 0.5 * fl1_fx * tdx_xzz_yzz_0[j] + 0.5 * fl1_fx * ts_xzz_xyzz_0[j];
                ...
                tdx_xxzz_xzzz_0[j] = pa_x[j] * tdx_xzz_xzzz_0[j] + 0.5 * fl1_fx * tdx_zz_xzzz_0[j] + 0.5 * fl1_fx * tdx_xzz_zzz_0[j] + 0.5 * fl1_fx * ts_xzz_xzzz_0[j];
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tdy_yyyy_xxxy_0[j] = pa_y[j] * tdy_yyy_xxxy_0[j] + 1.5 * fl1_fx * tdy_yy_xxxy_0[j] + 0.5 * fl1_fx * tdy_yyy_xxx_0[j] + 0.5 * fl1_fx * ts_yyy_xxxy_0[j];
                ...
                tdy_yyyy_xxyy_0[j] = pa_y[j] * tdy_yyy_xxyy_0[j] + 1.5 * fl1_fx * tdy_yy_xxyy_0[j] + fl1_fx * tdy_yyy_xxy_0[j] + 0.5 * fl1_fx * ts_yyy_xxyy_0[j];
                ...
                tdy_yyyy_xxyz_0[j] = pa_y[j] * tdy_yyy_xxyz_0[j] + 1.5 * fl1_fx * tdy_yy_xxyz_0[j] + 0.5 * fl1_fx * tdy_yyy_xxz_0[j] + 0.5 * fl1_fx * ts_yyy_xxyz_0[j];
                ...
                tdy_yyyy_xyyy_0[j] = pa_y[j] * tdy_yyy_xyyy_0[j] + 1.5 * fl1_fx * tdy_yy_xyyy_0[j] + 1.5 * fl1_fx * tdy_yyy_xyy_0[j] + 0.5 * fl1_fx * ts_yyy_xyyy_0[j];
                ...
                tdy_yyyy_xyyz_0[j] = pa_y[j] * tdy_yyy_xyyz_0[j] + 1.5 * fl1_fx * tdy_yy_xyyz_0[j] + fl1_fx * tdy_yyy_xyz_0[j] + 0.5 * fl1_fx * ts_yyy_xyyz_0[j];
                ...
                tdy_yyyy_xyzz_0[j] = pa_y[j] * tdy_yyy_xyzz_0[j] + 1.5 * fl1_fx * tdy_yy_xyzz_0[j] + 0.5 * fl1_fx * tdy_yyy_xzz_0[j] + 0.5 * fl1_fx * ts_yyy_xyzz_0[j];
                ...
                tdy_yyyy_yyyy_0[j] = pa_y[j] * tdy_yyy_yyyy_0[j] + 1.5 * fl1_fx * tdy_yy_yyyy_0[j] + 2.0 * fl1_fx * tdy_yyy_yyy_0[j] + 0.5 * fl1_fx * ts_yyy_yyyy_0[j];
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tdy_yyyy_yyyz_0[j] = pa_y[j] * tdy_yyy_yyyz_0[j] + 1.5 * fl1_fx * tdy_yy_yyyz_0[j] + 1.5 * fl1_fx * tdy_yyy_yyz_0[j] + 0.5 * fl1_fx * ts_yyy_yyyz_0[j];
                ...
                tdy_yyyy_yyzz_0[j] = pa_y[j] * tdy_yyy_yyzz_0[j] + 1.5 * fl1_fx * tdy_yy_yyzz_0[j] + fl1_fx * tdy_yyy_yzz_0[j] + 0.5 * fl1_fx * ts_yyy_yyzz_0[j];
                ...
                tdy_yyyy_yzzz_0[j] = pa_y[j] * tdy_yyy_yzzz_0[j] + 1.5 * fl1_fx * tdy_yy_yzzz_0[j] + 0.5 * fl1_fx * tdy_yyy_zzz_0[j] + 0.5 * fl1_fx * ts_yyy_yzzz_0[j];
                ...
                tdy_yyyz_xxxy_0[j] = pa_y[j] * tdy_yyz_xxxy_0[j] + fl1_fx * tdy_yz_xxxy_0[j] + 0.5 * fl1_fx * tdy_yyz_xxx_0[j] + 0.5 * fl1_fx * ts_yyz_xxxy_0[j];
                ...
                tdy_yyyz_xxyy_0[j] = pa_y[j] * tdy_yyz_xxyy_0[j] + fl1_fx * tdy_yz_xxyy_0[j] + fl1_fx * tdy_yyz_xxy_0[j] + 0.5 * fl1_fx * ts_yyz_xxyy_0[j];
                ...
                tdy_yyyz_xxyz_0[j] = pa_y[j] * tdy_yyz_xxyz_0[j] + fl1_fx * tdy_yz_xxyz_0[j] + 0.5 * fl1_fx * tdy_yyz_xxz_0[j] + 0.5 * fl1_fx * ts_yyz_xxyz_0[j];
                ...
                tdy_yyyz_xyyy_0[j] = pa_y[j] * tdy_yyz_xyyy_0[j] + fl1_fx * tdy_yz_xyyy_0[j] + 1.5 * fl1_fx * tdy_yyz_xyy_0[j] + 0.5 * fl1_fx * ts_yyz_xyyy_0[j];
                ...
                tdy_yyyz_xyyz_0[j] = pa_y[j] * tdy_yyz_xyyz_0[j] + fl1_fx * tdy_yz_xyyz_0[j] + fl1_fx * tdy_yyz_xyz_0[j] + 0.5 * fl1_fx * ts_yyz_xyyz_0[j];
                ...
                tdy_yyyz_xyzz_0[j] = pa_y[j] * tdy_yyz_xyzz_0[j] + fl1_fx * tdy_yz_xyzz_0[j] + 0.5 * fl1_fx * tdy_yyz_xzz_0[j] + 0.5 * fl1_fx * ts_yyz_xyzz_0[j];
                ...
                tdy_yyyz_yyyy_0[j] = pa_y[j] * tdy_yyz_yyyy_0[j] + fl1_fx * tdy_yz_yyyy_0[j] + 2.0 * fl1_fx * tdy_yyz_yyy_0[j] + 0.5 * fl1_fx * ts_yyz_yyyy_0[j];
                ...
                tdy_yyyz_yyyz_0[j] = pa_y[j] * tdy_yyz_yyyz_0[j] + fl1_fx * tdy_yz_yyyz_0[j] + 1.5 * fl1_fx * tdy_yyz_yyz_0[j] + 0.5 * fl1_fx * ts_yyz_yyyz_0[j];
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tdy_yyyz_yyzz_0[j] = pa_y[j] * tdy_yyz_yyzz_0[j] + fl1_fx * tdy_yz_yyzz_0[j] + fl1_fx * tdy_yyz_yzz_0[j] + 0.5 * fl1_fx * ts_yyz_yyzz_0[j];
                ...
                tdy_yyyz_yzzz_0[j] = pa_y[j] * tdy_yyz_yzzz_0[j] + fl1_fx * tdy_yz_yzzz_0[j] + 0.5 * fl1_fx * tdy_yyz_zzz_0[j] + 0.5 * fl1_fx * ts_yyz_yzzz_0[j];
                ...
                tdy_yyzz_xxxy_0[j] = pa_y[j] * tdy_yzz_xxxy_0[j] + 0.5 * fl1_fx * tdy_zz_xxxy_0[j] + 0.5 * fl1_fx * tdy_yzz_xxx_0[j] + 0.5 * fl1_fx * ts_yzz_xxxy_0[j];
                ...
                tdy_yyzz_xxyy_0[j] = pa_y[j] * tdy_yzz_xxyy_0[j] + 0.5 * fl1_fx * tdy_zz_xxyy_0[j] + fl1_fx * tdy_yzz_xxy_0[j] + 0.5 * fl1_fx * ts_yzz_xxyy_0[j];
                ...
                tdy_yyzz_xxyz_0[j] = pa_y[j] * tdy_yzz_xxyz_0[j] + 0.5 * fl1_fx * tdy_zz_xxyz_0[j] + 0.5 * fl1_fx * tdy_yzz_xxz_0[j] + 0.5 * fl1_fx * ts_yzz_xxyz_0[j];
                ...
                tdy_yyzz_xyyy_0[j] = pa_y[j] * tdy_yzz_xyyy_0[j] + 0.5 * fl1_fx * tdy_zz_xyyy_0[j] + 1.5 * fl1_fx * tdy_yzz_xyy_0[j] + 0.5 * fl1_fx * ts_yzz_xyyy_0[j];
                ...
                tdy_yyzz_xyyz_0[j] = pa_y[j] * tdy_yzz_xyyz_0[j] + 0.5 * fl1_fx * tdy_zz_xyyz_0[j] + fl1_fx * tdy_yzz_xyz_0[j] + 0.5 * fl1_fx * ts_yzz_xyyz_0[j];
                ...
                tdy_yyzz_xyzz_0[j] = pa_y[j] * tdy_yzz_xyzz_0[j] + 0.5 * fl1_fx * tdy_zz_xyzz_0[j] + 0.5 * fl1_fx * tdy_yzz_xzz_0[j] + 0.5 * fl1_fx * ts_yzz_xyzz_0[j];
                ...
                tdy_yyzz_yyyy_0[j] = pa_y[j] * tdy_yzz_yyyy_0[j] + 0.5 * fl1_fx * tdy_zz_yyyy_0[j] + 2.0 * fl1_fx * tdy_yzz_yyy_0[j] + 0.5 * fl1_fx * ts_yzz_yyyy_0[j];
                ...
                tdy_yyzz_yyyz_0[j] = pa_y[j] * tdy_yzz_yyyz_0[j] + 0.5 * fl1_fx * tdy_zz_yyyz_0[j] + 1.5 * fl1_fx * tdy_yzz_yyz_0[j] + 0.5 * fl1_fx * ts_yzz_yyyz_0[j];
                ...
                tdy_yyzz_yyzz_0[j] = pa_y[j] * tdy_yzz_yyzz_0[j] + 0.5 * fl1_fx * tdy_zz_yyzz_0[j] + fl1_fx * tdy_yzz_yzz_0[j] + 0.5 * fl1_fx * ts_yzz_yyzz_0[j];
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tdy_yyzz_yzzz_0[j] = pa_y[j] * tdy_yzz_yzzz_0[j] + 0.5 * fl1_fx * tdy_zz_yzzz_0[j] + 0.5 * fl1_fx * tdy_yzz_zzz_0[j] + 0.5 * fl1_fx * ts_yzz_yzzz_0[j];
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tdz_zzzz_xxxz_0[j] = pa_z[j] * tdz_zzz_xxxz_0[j] + 1.5 * fl1_fx * tdz_zz_xxxz_0[j] + 0.5 * fl1_fx * tdz_zzz_xxx_0[j] + 0.5 * fl1_fx * ts_zzz_xxxz_0[j];
                ...
                tdz_zzzz_xxyz_0[j] = pa_z[j] * tdz_zzz_xxyz_0[j] + 1.5 * fl1_fx * tdz_zz_xxyz_0[j] + 0.5 * fl1_fx * tdz_zzz_xxy_0[j] + 0.5 * fl1_fx * ts_zzz_xxyz_0[j];
                ...
                tdz_zzzz_xxzz_0[j] = pa_z[j] * tdz_zzz_xxzz_0[j] + 1.5 * fl1_fx * tdz_zz_xxzz_0[j] + fl1_fx * tdz_zzz_xxz_0[j] + 0.5 * fl1_fx * ts_zzz_xxzz_0[j];
                ...
                tdz_zzzz_xyyz_0[j] = pa_z[j] * tdz_zzz_xyyz_0[j] + 1.5 * fl1_fx * tdz_zz_xyyz_0[j] + 0.5 * fl1_fx * tdz_zzz_xyy_0[j] + 0.5 * fl1_fx * ts_zzz_xyyz_0[j];
                ...
                tdz_zzzz_xyzz_0[j] = pa_z[j] * tdz_zzz_xyzz_0[j] + 1.5 * fl1_fx * tdz_zz_xyzz_0[j] + fl1_fx * tdz_zzz_xyz_0[j] + 0.5 * fl1_fx * ts_zzz_xyzz_0[j];
                ...
                tdz_zzzz_xzzz_0[j] = pa_z[j] * tdz_zzz_xzzz_0[j] + 1.5 * fl1_fx * tdz_zz_xzzz_0[j] + 1.5 * fl1_fx * tdz_zzz_xzz_0[j] + 0.5 * fl1_fx * ts_zzz_xzzz_0[j];
                ...
                tdz_zzzz_yyyz_0[j] = pa_z[j] * tdz_zzz_yyyz_0[j] + 1.5 * fl1_fx * tdz_zz_yyyz_0[j] + 0.5 * fl1_fx * tdz_zzz_yyy_0[j] + 0.5 * fl1_fx * ts_zzz_yyyz_0[j];
                ...
                tdz_zzzz_yyzz_0[j] = pa_z[j] * tdz_zzz_yyzz_0[j] + 1.5 * fl1_fx * tdz_zz_yyzz_0[j] + fl1_fx * tdz_zzz_yyz_0[j] + 0.5 * fl1_fx * ts_zzz_yyzz_0[j];
                ...
                tdz_zzzz_yzzz_0[j] = pa_z[j] * tdz_zzz_yzzz_0[j] + 1.5 * fl1_fx * tdz_zz_yzzz_0[j] + 1.5 * fl1_fx * tdz_zzz_yzz_0[j] + 0.5 * fl1_fx * ts_zzz_yzzz_0[j];
                ...
                tdz_zzzz_zzzz_0[j] = pa_z[j] * tdz_zzz_zzzz_0[j] + 1.5 * fl1_fx * tdz_zz_zzzz_0[j] + 2.0 * fl1_fx * tdz_zzz_zzz_0[j] + 0.5 * fl1_fx * ts_zzz_zzzz_0[j];
            }
