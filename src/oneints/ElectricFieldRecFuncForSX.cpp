...
namespace efieldrecfunc { // efieldrecfunc namespace
                           ...
                           const int32_t              iContrGto)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            auto pidx = recursionMap.getIndexOfTerm(CRecursionTerm({"Electric Field"}, 1, true,
                                                                   {0, -1, -1, -1}, {0, -1, -1, -1},
                                                                    1, 1, iord));
            ...
            auto sidx = recursionMap.getIndexOfTerm(CRecursionTerm({"Nuclear Potential"}, 0, true,
                                                                   {0, -1, -1, -1}, {0, -1, -1, -1},
                                                                   1, 1, iord + 1));
                           ...
                           const int32_t              iContrGto)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            auto pidx_a_0_0_m1 = recursionMap.getIndexOfTerm(CRecursionTerm({"Nuclear Potential"}, 0, true, 
                                                             {0, -1, -1, -1}, {0, -1, -1, -1}, 
                                                             1, 1, iord + 1));
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
            {
                ...
                for (int32_t j = 0; j < nprim; j++)
                {
                    ...
                    tex_0_xx_0[j] = pb_x[j] * tex_0_x_0[j] - pc_x[j] * tex_0_x_1[j] + 0.5 * fl1_fx * tex_0_0_0[j] - 0.5 * fl1_fx * tex_0_0_1[j] + ta_0_x_1[j];
                    ...
                    tey_0_yy_0[j] = pb_y[j] * tey_0_y_0[j] - pc_y[j] * tey_0_y_1[j] + 0.5 * fl1_fx * tey_0_0_0[j] - 0.5 * fl1_fx * tey_0_0_1[j] + ta_0_y_1[j];
                    ...
                    tez_0_zz_0[j] = pb_z[j] * tez_0_z_0[j] - pc_z[j] * tez_0_z_1[j] + 0.5 * fl1_fx * tez_0_0_0[j] - 0.5 * fl1_fx * tez_0_0_1[j] + ta_0_z_1[j];
                }
                           ...
                           const int32_t              iContrGto)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            auto pidx_a_1_0_m1 = recursionMap.getIndexOfTerm(CRecursionTerm({"Nuclear Potential"}, 0, true, 
                                                             {1, -1, -1, -1}, {0, -1, -1, -1}, 
                                                             1, 1, iord + 1));
            ...
            for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
            {
                ...
                for (int32_t j = 0; j < nprim; j++)
                {
                    ...
                    tex_xx_0_0[j] = pa_x[j] * tex_x_0_0[j] - pc_x[j] * tex_x_0_1[j] + 0.5 * fl1_fx * tex_0_0_0[j] - 0.5 * fl1_fx * tex_0_0_1[j] + ta_x_0_1[j];
                    ...
                    tey_yy_0_0[j] = pa_y[j] * tey_y_0_0[j] - pc_y[j] * tey_y_0_1[j] + 0.5 * fl1_fx * tey_0_0_0[j] - 0.5 * fl1_fx * tey_0_0_1[j] + ta_y_0_1[j];
                    ...
                    tez_zz_0_0[j] = pa_z[j] * tez_z_0_0[j] - pc_z[j] * tez_z_0_1[j] + 0.5 * fl1_fx * tez_0_0_0[j] - 0.5 * fl1_fx * tez_0_0_1[j] + ta_z_0_1[j];
                }
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
            {
                ...
                for (int32_t j = 0; j < nprim; j++)
                {
                    ...
                    tex_0_xxy_0[j] = pb_x[j] * tex_0_xy_0[j] - pc_x[j] * tex_0_xy_1[j] + 0.5 * fl1_fx * tex_0_y_0[j] - 0.5 * fl1_fx * tex_0_y_1[j] + ta_0_xy_1[j];
                    ...
                    tex_0_xxz_0[j] = pb_x[j] * tex_0_xz_0[j] - pc_x[j] * tex_0_xz_1[j] + 0.5 * fl1_fx * tex_0_z_0[j] - 0.5 * fl1_fx * tex_0_z_1[j] + ta_0_xz_1[j];
                    ...
                    tey_0_yyz_0[j] = pb_y[j] * tey_0_yz_0[j] - pc_y[j] * tey_0_yz_1[j] + 0.5 * fl1_fx * tey_0_z_0[j] - 0.5 * fl1_fx * tey_0_z_1[j] + ta_0_yz_1[j];
                           ...
                           const int32_t              iContrGto)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            auto pidx_a_2_0_m1 = recursionMap.getIndexOfTerm(CRecursionTerm({"Nuclear Potential"}, 0, true, 
                                                             {2, -1, -1, -1}, {0, -1, -1, -1}, 
                                                             1, 1, iord + 1));
            ...
            for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
            {
                ...
                for (int32_t j = 0; j < nprim; j++)
                {
                    ...
                    tex_xxy_0_0[j] = pa_x[j] * tex_xy_0_0[j] - pc_x[j] * tex_xy_0_1[j] + 0.5 * fl1_fx * tex_y_0_0[j] - 0.5 * fl1_fx * tex_y_0_1[j] + ta_xy_0_1[j];
                    ...
                    tex_xxz_0_0[j] = pa_x[j] * tex_xz_0_0[j] - pc_x[j] * tex_xz_0_1[j] + 0.5 * fl1_fx * tex_z_0_0[j] - 0.5 * fl1_fx * tex_z_0_1[j] + ta_xz_0_1[j];
                    ...
                    tey_yyz_0_0[j] = pa_y[j] * tey_yz_0_0[j] - pc_y[j] * tey_yz_0_1[j] + 0.5 * fl1_fx * tey_z_0_0[j] - 0.5 * fl1_fx * tey_z_0_1[j] + ta_yz_0_1[j];
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
            {
                ...
                for (int32_t j = 0; j < nprim; j++)
                {
                    ...
                    tex_0_xxxx_0[j] = pb_x[j] * tex_0_xxx_0[j] - pc_x[j] * tex_0_xxx_1[j] + 1.5 * fl1_fx * tex_0_xx_0[j] - 1.5 * fl1_fx * tex_0_xx_1[j] + ta_0_xxx_1[j];
                    ...
                    tex_0_xxxy_0[j] = pb_x[j] * tex_0_xxy_0[j] - pc_x[j] * tex_0_xxy_1[j] + fl1_fx * tex_0_xy_0[j] - fl1_fx * tex_0_xy_1[j] + ta_0_xxy_1[j];
                    ...
                    tex_0_xxxz_0[j] = pb_x[j] * tex_0_xxz_0[j] - pc_x[j] * tex_0_xxz_1[j] + fl1_fx * tex_0_xz_0[j] - fl1_fx * tex_0_xz_1[j] + ta_0_xxz_1[j];
                    ...
                    tex_0_xxyy_0[j] = pb_x[j] * tex_0_xyy_0[j] - pc_x[j] * tex_0_xyy_1[j] + 0.5 * fl1_fx * tex_0_yy_0[j] - 0.5 * fl1_fx * tex_0_yy_1[j] + ta_0_xyy_1[j];
                    ...
                    tex_0_xxyz_0[j] = pb_x[j] * tex_0_xyz_0[j] - pc_x[j] * tex_0_xyz_1[j] + 0.5 * fl1_fx * tex_0_yz_0[j] - 0.5 * fl1_fx * tex_0_yz_1[j] + ta_0_xyz_1[j];
                    ...
                    tex_0_xxzz_0[j] = pb_x[j] * tex_0_xzz_0[j] - pc_x[j] * tex_0_xzz_1[j] + 0.5 * fl1_fx * tex_0_zz_0[j] - 0.5 * fl1_fx * tex_0_zz_1[j] + ta_0_xzz_1[j];
                    ...
                    tey_0_yyyy_0[j] = pb_y[j] * tey_0_yyy_0[j] - pc_y[j] * tey_0_yyy_1[j] + 1.5 * fl1_fx * tey_0_yy_0[j] - 1.5 * fl1_fx * tey_0_yy_1[j] + ta_0_yyy_1[j];
                    ...
                    tey_0_yyyz_0[j] = pb_y[j] * tey_0_yyz_0[j] - pc_y[j] * tey_0_yyz_1[j] + fl1_fx * tey_0_yz_0[j] - fl1_fx * tey_0_yz_1[j] + ta_0_yyz_1[j];
                    ...
                    tey_0_yyzz_0[j] = pb_y[j] * tey_0_yzz_0[j] - pc_y[j] * tey_0_yzz_1[j] + 0.5 * fl1_fx * tey_0_zz_0[j] - 0.5 * fl1_fx * tey_0_zz_1[j] + ta_0_yzz_1[j];
                    ...
                    tez_0_zzzz_0[j] = pb_z[j] * tez_0_zzz_0[j] - pc_z[j] * tez_0_zzz_1[j] + 1.5 * fl1_fx * tez_0_zz_0[j] - 1.5 * fl1_fx * tez_0_zz_1[j] + ta_0_zzz_1[j];
                }
                           ...
                           const int32_t              iContrGto)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            auto pidx_e_4_0_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Electric Field"}, 1, true, 
                                                             {4, -1, -1, -1}, {0, -1, -1, -1}, 
                                                             1, 1, iord));
            ...
            auto pidx_a_3_0_m1 = recursionMap.getIndexOfTerm(CRecursionTerm({"Nuclear Potential"}, 0, true, 
                                                             {3, -1, -1, -1}, {0, -1, -1, -1}, 
                                                             1, 1, iord + 1));
            ...
            for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
            {
                ...
                for (int32_t j = 0; j < nprim; j++)
                {
                    ...
                    tex_xxxx_0_0[j] = pa_x[j] * tex_xxx_0_0[j] - pc_x[j] * tex_xxx_0_1[j] + 1.5 * fl1_fx * tex_xx_0_0[j] - 1.5 * fl1_fx * tex_xx_0_1[j] + ta_xxx_0_1[j];
                    ...
                    tex_xxxy_0_0[j] = pa_x[j] * tex_xxy_0_0[j] - pc_x[j] * tex_xxy_0_1[j] + fl1_fx * tex_xy_0_0[j] - fl1_fx * tex_xy_0_1[j] + ta_xxy_0_1[j];
                    ...
                    tex_xxxz_0_0[j] = pa_x[j] * tex_xxz_0_0[j] - pc_x[j] * tex_xxz_0_1[j] + fl1_fx * tex_xz_0_0[j] - fl1_fx * tex_xz_0_1[j] + ta_xxz_0_1[j];
                    ...
                    tex_xxyy_0_0[j] = pa_x[j] * tex_xyy_0_0[j] - pc_x[j] * tex_xyy_0_1[j] + 0.5 * fl1_fx * tex_yy_0_0[j] - 0.5 * fl1_fx * tex_yy_0_1[j] + ta_xyy_0_1[j];
                    ...
                    tex_xxyz_0_0[j] = pa_x[j] * tex_xyz_0_0[j] - pc_x[j] * tex_xyz_0_1[j] + 0.5 * fl1_fx * tex_yz_0_0[j] - 0.5 * fl1_fx * tex_yz_0_1[j] + ta_xyz_0_1[j];
                    ...
                    tex_xxzz_0_0[j] = pa_x[j] * tex_xzz_0_0[j] - pc_x[j] * tex_xzz_0_1[j] + 0.5 * fl1_fx * tex_zz_0_0[j] - 0.5 * fl1_fx * tex_zz_0_1[j] + ta_xzz_0_1[j];
                    ...
                    tey_yyyy_0_0[j] = pa_y[j] * tey_yyy_0_0[j] - pc_y[j] * tey_yyy_0_1[j] + 1.5 * fl1_fx * tey_yy_0_0[j] - 1.5 * fl1_fx * tey_yy_0_1[j] + ta_yyy_0_1[j];
                    ...
                    tey_yyyz_0_0[j] = pa_y[j] * tey_yyz_0_0[j] - pc_y[j] * tey_yyz_0_1[j] + fl1_fx * tey_yz_0_0[j] - fl1_fx * tey_yz_0_1[j] + ta_yyz_0_1[j];
                    ...
                    tey_yyzz_0_0[j] = pa_y[j] * tey_yzz_0_0[j] - pc_y[j] * tey_yzz_0_1[j] + 0.5 * fl1_fx * tey_zz_0_0[j] - 0.5 * fl1_fx * tey_zz_0_1[j] + ta_yzz_0_1[j];
                    ...
                    tez_zzzz_0_0[j] = pa_z[j] * tez_zzz_0_0[j] - pc_z[j] * tez_zzz_0_1[j] + 1.5 * fl1_fx * tez_zz_0_0[j] - 1.5 * fl1_fx * tez_zz_0_1[j] + ta_zzz_0_1[j];
                }
