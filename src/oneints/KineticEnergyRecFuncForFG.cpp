...
namespace kinrecfunc { // kinrecfunc namespace
    ...
    {
        kinrecfunc::compKineticEnergyForFG_0_50(primBuffer,
                                                recursionMap,
                                                osFactors,
                                                paDistances, 
                                                braGtoBlock,
        ...
        kinrecfunc::compKineticEnergyForFG_50_100(primBuffer,
                                                  recursionMap,
                                                  osFactors,
                                                  paDistances, 
                                                  braGtoBlock,
        ...
        kinrecfunc::compKineticEnergyForFG_100_150(primBuffer,
                                                   recursionMap,
                                                   osFactors,
                                                   paDistances, 
                                                   braGtoBlock,
                                ...
                                const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tt_xxx_xxxx_0[j] = pa_x[j] * tt_xx_xxxx_0[j] + fl1_fx * tt_x_xxxx_0[j] + 2.0 * fl1_fx * tt_xx_xxx_0[j] + 2.0 * fl1_fz * ts_xxx_xxxx_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_xxxx_0[j];

                tt_xxx_xxxy_0[j] = pa_x[j] * tt_xx_xxxy_0[j] + fl1_fx * tt_x_xxxy_0[j] + 1.5 * fl1_fx * tt_xx_xxy_0[j] + 2.0 * fl1_fz * ts_xxx_xxxy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_xxxy_0[j];

                tt_xxx_xxxz_0[j] = pa_x[j] * tt_xx_xxxz_0[j] + fl1_fx * tt_x_xxxz_0[j] + 1.5 * fl1_fx * tt_xx_xxz_0[j] + 2.0 * fl1_fz * ts_xxx_xxxz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_xxxz_0[j];

                tt_xxx_xxyy_0[j] = pa_x[j] * tt_xx_xxyy_0[j] + fl1_fx * tt_x_xxyy_0[j] + fl1_fx * tt_xx_xyy_0[j] + 2.0 * fl1_fz * ts_xxx_xxyy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_xxyy_0[j];

                tt_xxx_xxyz_0[j] = pa_x[j] * tt_xx_xxyz_0[j] + fl1_fx * tt_x_xxyz_0[j] + fl1_fx * tt_xx_xyz_0[j] + 2.0 * fl1_fz * ts_xxx_xxyz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_xxyz_0[j];

                tt_xxx_xxzz_0[j] = pa_x[j] * tt_xx_xxzz_0[j] + fl1_fx * tt_x_xxzz_0[j] + fl1_fx * tt_xx_xzz_0[j] + 2.0 * fl1_fz * ts_xxx_xxzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_xxzz_0[j];

                tt_xxx_xyyy_0[j] = pa_x[j] * tt_xx_xyyy_0[j] + fl1_fx * tt_x_xyyy_0[j] + 0.5 * fl1_fx * tt_xx_yyy_0[j] + 2.0 * fl1_fz * ts_xxx_xyyy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_xyyy_0[j];

                tt_xxx_xyyz_0[j] = pa_x[j] * tt_xx_xyyz_0[j] + fl1_fx * tt_x_xyyz_0[j] + 0.5 * fl1_fx * tt_xx_yyz_0[j] + 2.0 * fl1_fz * ts_xxx_xyyz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_xyyz_0[j];

                tt_xxx_xyzz_0[j] = pa_x[j] * tt_xx_xyzz_0[j] + fl1_fx * tt_x_xyzz_0[j] + 0.5 * fl1_fx * tt_xx_yzz_0[j] + 2.0 * fl1_fz * ts_xxx_xyzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_xyzz_0[j];

                tt_xxx_xzzz_0[j] = pa_x[j] * tt_xx_xzzz_0[j] + fl1_fx * tt_x_xzzz_0[j] + 0.5 * fl1_fx * tt_xx_zzz_0[j] + 2.0 * fl1_fz * ts_xxx_xzzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_xzzz_0[j];

                tt_xxx_yyyy_0[j] = pa_x[j] * tt_xx_yyyy_0[j] + fl1_fx * tt_x_yyyy_0[j] + 2.0 * fl1_fz * ts_xxx_yyyy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_yyyy_0[j];

                tt_xxx_yyyz_0[j] = pa_x[j] * tt_xx_yyyz_0[j] + fl1_fx * tt_x_yyyz_0[j] + 2.0 * fl1_fz * ts_xxx_yyyz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_yyyz_0[j];

                tt_xxx_yyzz_0[j] = pa_x[j] * tt_xx_yyzz_0[j] + fl1_fx * tt_x_yyzz_0[j] + 2.0 * fl1_fz * ts_xxx_yyzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_yyzz_0[j];

                tt_xxx_yzzz_0[j] = pa_x[j] * tt_xx_yzzz_0[j] + fl1_fx * tt_x_yzzz_0[j] + 2.0 * fl1_fz * ts_xxx_yzzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_yzzz_0[j];

                tt_xxx_zzzz_0[j] = pa_x[j] * tt_xx_zzzz_0[j] + fl1_fx * tt_x_zzzz_0[j] + 2.0 * fl1_fz * ts_xxx_zzzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_x_zzzz_0[j];

                tt_xxy_xxxx_0[j] = pa_x[j] * tt_xy_xxxx_0[j] + 0.5 * fl1_fx * tt_y_xxxx_0[j] + 2.0 * fl1_fx * tt_xy_xxx_0[j] + 2.0 * fl1_fz * ts_xxy_xxxx_0[j] - fl1_fz * fl1_fga * ts_y_xxxx_0[j];

                tt_xxy_xxxy_0[j] = pa_x[j] * tt_xy_xxxy_0[j] + 0.5 * fl1_fx * tt_y_xxxy_0[j] + 1.5 * fl1_fx * tt_xy_xxy_0[j] + 2.0 * fl1_fz * ts_xxy_xxxy_0[j] - fl1_fz * fl1_fga * ts_y_xxxy_0[j];

                tt_xxy_xxxz_0[j] = pa_x[j] * tt_xy_xxxz_0[j] + 0.5 * fl1_fx * tt_y_xxxz_0[j] + 1.5 * fl1_fx * tt_xy_xxz_0[j] + 2.0 * fl1_fz * ts_xxy_xxxz_0[j] - fl1_fz * fl1_fga * ts_y_xxxz_0[j];

                tt_xxy_xxyy_0[j] = pa_x[j] * tt_xy_xxyy_0[j] + 0.5 * fl1_fx * tt_y_xxyy_0[j] + fl1_fx * tt_xy_xyy_0[j] + 2.0 * fl1_fz * ts_xxy_xxyy_0[j] - fl1_fz * fl1_fga * ts_y_xxyy_0[j];

                tt_xxy_xxyz_0[j] = pa_x[j] * tt_xy_xxyz_0[j] + 0.5 * fl1_fx * tt_y_xxyz_0[j] + fl1_fx * tt_xy_xyz_0[j] + 2.0 * fl1_fz * ts_xxy_xxyz_0[j] - fl1_fz * fl1_fga * ts_y_xxyz_0[j];

                tt_xxy_xxzz_0[j] = pa_x[j] * tt_xy_xxzz_0[j] + 0.5 * fl1_fx * tt_y_xxzz_0[j] + fl1_fx * tt_xy_xzz_0[j] + 2.0 * fl1_fz * ts_xxy_xxzz_0[j] - fl1_fz * fl1_fga * ts_y_xxzz_0[j];

                tt_xxy_xyyy_0[j] = pa_x[j] * tt_xy_xyyy_0[j] + 0.5 * fl1_fx * tt_y_xyyy_0[j] + 0.5 * fl1_fx * tt_xy_yyy_0[j] + 2.0 * fl1_fz * ts_xxy_xyyy_0[j] - fl1_fz * fl1_fga * ts_y_xyyy_0[j];

                tt_xxy_xyyz_0[j] = pa_x[j] * tt_xy_xyyz_0[j] + 0.5 * fl1_fx * tt_y_xyyz_0[j] + 0.5 * fl1_fx * tt_xy_yyz_0[j] + 2.0 * fl1_fz * ts_xxy_xyyz_0[j] - fl1_fz * fl1_fga * ts_y_xyyz_0[j];

                tt_xxy_xyzz_0[j] = pa_x[j] * tt_xy_xyzz_0[j] + 0.5 * fl1_fx * tt_y_xyzz_0[j] + 0.5 * fl1_fx * tt_xy_yzz_0[j] + 2.0 * fl1_fz * ts_xxy_xyzz_0[j] - fl1_fz * fl1_fga * ts_y_xyzz_0[j];

                tt_xxy_xzzz_0[j] = pa_x[j] * tt_xy_xzzz_0[j] + 0.5 * fl1_fx * tt_y_xzzz_0[j] + 0.5 * fl1_fx * tt_xy_zzz_0[j] + 2.0 * fl1_fz * ts_xxy_xzzz_0[j] - fl1_fz * fl1_fga * ts_y_xzzz_0[j];

                tt_xxy_yyyy_0[j] = pa_x[j] * tt_xy_yyyy_0[j] + 0.5 * fl1_fx * tt_y_yyyy_0[j] + 2.0 * fl1_fz * ts_xxy_yyyy_0[j] - fl1_fz * fl1_fga * ts_y_yyyy_0[j];

                tt_xxy_yyyz_0[j] = pa_x[j] * tt_xy_yyyz_0[j] + 0.5 * fl1_fx * tt_y_yyyz_0[j] + 2.0 * fl1_fz * ts_xxy_yyyz_0[j] - fl1_fz * fl1_fga * ts_y_yyyz_0[j];

                tt_xxy_yyzz_0[j] = pa_x[j] * tt_xy_yyzz_0[j] + 0.5 * fl1_fx * tt_y_yyzz_0[j] + 2.0 * fl1_fz * ts_xxy_yyzz_0[j] - fl1_fz * fl1_fga * ts_y_yyzz_0[j];

                tt_xxy_yzzz_0[j] = pa_x[j] * tt_xy_yzzz_0[j] + 0.5 * fl1_fx * tt_y_yzzz_0[j] + 2.0 * fl1_fz * ts_xxy_yzzz_0[j] - fl1_fz * fl1_fga * ts_y_yzzz_0[j];

                tt_xxy_zzzz_0[j] = pa_x[j] * tt_xy_zzzz_0[j] + 0.5 * fl1_fx * tt_y_zzzz_0[j] + 2.0 * fl1_fz * ts_xxy_zzzz_0[j] - fl1_fz * fl1_fga * ts_y_zzzz_0[j];

                tt_xxz_xxxx_0[j] = pa_x[j] * tt_xz_xxxx_0[j] + 0.5 * fl1_fx * tt_z_xxxx_0[j] + 2.0 * fl1_fx * tt_xz_xxx_0[j] + 2.0 * fl1_fz * ts_xxz_xxxx_0[j] - fl1_fz * fl1_fga * ts_z_xxxx_0[j];

                tt_xxz_xxxy_0[j] = pa_x[j] * tt_xz_xxxy_0[j] + 0.5 * fl1_fx * tt_z_xxxy_0[j] + 1.5 * fl1_fx * tt_xz_xxy_0[j] + 2.0 * fl1_fz * ts_xxz_xxxy_0[j] - fl1_fz * fl1_fga * ts_z_xxxy_0[j];

                tt_xxz_xxxz_0[j] = pa_x[j] * tt_xz_xxxz_0[j] + 0.5 * fl1_fx * tt_z_xxxz_0[j] + 1.5 * fl1_fx * tt_xz_xxz_0[j] + 2.0 * fl1_fz * ts_xxz_xxxz_0[j] - fl1_fz * fl1_fga * ts_z_xxxz_0[j];

                tt_xxz_xxyy_0[j] = pa_x[j] * tt_xz_xxyy_0[j] + 0.5 * fl1_fx * tt_z_xxyy_0[j] + fl1_fx * tt_xz_xyy_0[j] + 2.0 * fl1_fz * ts_xxz_xxyy_0[j] - fl1_fz * fl1_fga * ts_z_xxyy_0[j];

                tt_xxz_xxyz_0[j] = pa_x[j] * tt_xz_xxyz_0[j] + 0.5 * fl1_fx * tt_z_xxyz_0[j] + fl1_fx * tt_xz_xyz_0[j] + 2.0 * fl1_fz * ts_xxz_xxyz_0[j] - fl1_fz * fl1_fga * ts_z_xxyz_0[j];

                tt_xxz_xxzz_0[j] = pa_x[j] * tt_xz_xxzz_0[j] + 0.5 * fl1_fx * tt_z_xxzz_0[j] + fl1_fx * tt_xz_xzz_0[j] + 2.0 * fl1_fz * ts_xxz_xxzz_0[j] - fl1_fz * fl1_fga * ts_z_xxzz_0[j];

                tt_xxz_xyyy_0[j] = pa_x[j] * tt_xz_xyyy_0[j] + 0.5 * fl1_fx * tt_z_xyyy_0[j] + 0.5 * fl1_fx * tt_xz_yyy_0[j] + 2.0 * fl1_fz * ts_xxz_xyyy_0[j] - fl1_fz * fl1_fga * ts_z_xyyy_0[j];

                tt_xxz_xyyz_0[j] = pa_x[j] * tt_xz_xyyz_0[j] + 0.5 * fl1_fx * tt_z_xyyz_0[j] + 0.5 * fl1_fx * tt_xz_yyz_0[j] + 2.0 * fl1_fz * ts_xxz_xyyz_0[j] - fl1_fz * fl1_fga * ts_z_xyyz_0[j];

                tt_xxz_xyzz_0[j] = pa_x[j] * tt_xz_xyzz_0[j] + 0.5 * fl1_fx * tt_z_xyzz_0[j] + 0.5 * fl1_fx * tt_xz_yzz_0[j] + 2.0 * fl1_fz * ts_xxz_xyzz_0[j] - fl1_fz * fl1_fga * ts_z_xyzz_0[j];

                tt_xxz_xzzz_0[j] = pa_x[j] * tt_xz_xzzz_0[j] + 0.5 * fl1_fx * tt_z_xzzz_0[j] + 0.5 * fl1_fx * tt_xz_zzz_0[j] + 2.0 * fl1_fz * ts_xxz_xzzz_0[j] - fl1_fz * fl1_fga * ts_z_xzzz_0[j];

                tt_xxz_yyyy_0[j] = pa_x[j] * tt_xz_yyyy_0[j] + 0.5 * fl1_fx * tt_z_yyyy_0[j] + 2.0 * fl1_fz * ts_xxz_yyyy_0[j] - fl1_fz * fl1_fga * ts_z_yyyy_0[j];

                tt_xxz_yyyz_0[j] = pa_x[j] * tt_xz_yyyz_0[j] + 0.5 * fl1_fx * tt_z_yyyz_0[j] + 2.0 * fl1_fz * ts_xxz_yyyz_0[j] - fl1_fz * fl1_fga * ts_z_yyyz_0[j];

                tt_xxz_yyzz_0[j] = pa_x[j] * tt_xz_yyzz_0[j] + 0.5 * fl1_fx * tt_z_yyzz_0[j] + 2.0 * fl1_fz * ts_xxz_yyzz_0[j] - fl1_fz * fl1_fga * ts_z_yyzz_0[j];

                tt_xxz_yzzz_0[j] = pa_x[j] * tt_xz_yzzz_0[j] + 0.5 * fl1_fx * tt_z_yzzz_0[j] + 2.0 * fl1_fz * ts_xxz_yzzz_0[j] - fl1_fz * fl1_fga * ts_z_yzzz_0[j];

                tt_xxz_zzzz_0[j] = pa_x[j] * tt_xz_zzzz_0[j] + 0.5 * fl1_fx * tt_z_zzzz_0[j] + 2.0 * fl1_fz * ts_xxz_zzzz_0[j] - fl1_fz * fl1_fga * ts_z_zzzz_0[j];
                                  ...
                                  const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tt_yyy_xxxx_0[j] = pa_y[j] * tt_yy_xxxx_0[j] + fl1_fx * tt_y_xxxx_0[j] + 2.0 * fl1_fz * ts_yyy_xxxx_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_xxxx_0[j];

                tt_yyy_xxxy_0[j] = pa_y[j] * tt_yy_xxxy_0[j] + fl1_fx * tt_y_xxxy_0[j] + 0.5 * fl1_fx * tt_yy_xxx_0[j] + 2.0 * fl1_fz * ts_yyy_xxxy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_xxxy_0[j];

                tt_yyy_xxxz_0[j] = pa_y[j] * tt_yy_xxxz_0[j] + fl1_fx * tt_y_xxxz_0[j] + 2.0 * fl1_fz * ts_yyy_xxxz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_xxxz_0[j];

                tt_yyy_xxyy_0[j] = pa_y[j] * tt_yy_xxyy_0[j] + fl1_fx * tt_y_xxyy_0[j] + fl1_fx * tt_yy_xxy_0[j] + 2.0 * fl1_fz * ts_yyy_xxyy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_xxyy_0[j];

                tt_yyy_xxyz_0[j] = pa_y[j] * tt_yy_xxyz_0[j] + fl1_fx * tt_y_xxyz_0[j] + 0.5 * fl1_fx * tt_yy_xxz_0[j] + 2.0 * fl1_fz * ts_yyy_xxyz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_xxyz_0[j];

                tt_yyy_xxzz_0[j] = pa_y[j] * tt_yy_xxzz_0[j] + fl1_fx * tt_y_xxzz_0[j] + 2.0 * fl1_fz * ts_yyy_xxzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_xxzz_0[j];

                tt_yyy_xyyy_0[j] = pa_y[j] * tt_yy_xyyy_0[j] + fl1_fx * tt_y_xyyy_0[j] + 1.5 * fl1_fx * tt_yy_xyy_0[j] + 2.0 * fl1_fz * ts_yyy_xyyy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_xyyy_0[j];

                tt_yyy_xyyz_0[j] = pa_y[j] * tt_yy_xyyz_0[j] + fl1_fx * tt_y_xyyz_0[j] + fl1_fx * tt_yy_xyz_0[j] + 2.0 * fl1_fz * ts_yyy_xyyz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_xyyz_0[j];

                tt_yyy_xyzz_0[j] = pa_y[j] * tt_yy_xyzz_0[j] + fl1_fx * tt_y_xyzz_0[j] + 0.5 * fl1_fx * tt_yy_xzz_0[j] + 2.0 * fl1_fz * ts_yyy_xyzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_xyzz_0[j];

                tt_yyy_xzzz_0[j] = pa_y[j] * tt_yy_xzzz_0[j] + fl1_fx * tt_y_xzzz_0[j] + 2.0 * fl1_fz * ts_yyy_xzzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_xzzz_0[j];
            }
                                   ...
                                   const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tt_yyy_yyyy_0[j] = pa_y[j] * tt_yy_yyyy_0[j] + fl1_fx * tt_y_yyyy_0[j] + 2.0 * fl1_fx * tt_yy_yyy_0[j] + 2.0 * fl1_fz * ts_yyy_yyyy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_yyyy_0[j];

                tt_yyy_yyyz_0[j] = pa_y[j] * tt_yy_yyyz_0[j] + fl1_fx * tt_y_yyyz_0[j] + 1.5 * fl1_fx * tt_yy_yyz_0[j] + 2.0 * fl1_fz * ts_yyy_yyyz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_yyyz_0[j];

                tt_yyy_yyzz_0[j] = pa_y[j] * tt_yy_yyzz_0[j] + fl1_fx * tt_y_yyzz_0[j] + fl1_fx * tt_yy_yzz_0[j] + 2.0 * fl1_fz * ts_yyy_yyzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_yyzz_0[j];

                tt_yyy_yzzz_0[j] = pa_y[j] * tt_yy_yzzz_0[j] + fl1_fx * tt_y_yzzz_0[j] + 0.5 * fl1_fx * tt_yy_zzz_0[j] + 2.0 * fl1_fz * ts_yyy_yzzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_yzzz_0[j];

                tt_yyy_zzzz_0[j] = pa_y[j] * tt_yy_zzzz_0[j] + fl1_fx * tt_y_zzzz_0[j] + 2.0 * fl1_fz * ts_yyy_zzzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_y_zzzz_0[j];

                tt_yyz_xxxx_0[j] = pa_y[j] * tt_yz_xxxx_0[j] + 0.5 * fl1_fx * tt_z_xxxx_0[j] + 2.0 * fl1_fz * ts_yyz_xxxx_0[j] - fl1_fz * fl1_fga * ts_z_xxxx_0[j];

                tt_yyz_xxxy_0[j] = pa_y[j] * tt_yz_xxxy_0[j] + 0.5 * fl1_fx * tt_z_xxxy_0[j] + 0.5 * fl1_fx * tt_yz_xxx_0[j] + 2.0 * fl1_fz * ts_yyz_xxxy_0[j] - fl1_fz * fl1_fga * ts_z_xxxy_0[j];

                tt_yyz_xxxz_0[j] = pa_y[j] * tt_yz_xxxz_0[j] + 0.5 * fl1_fx * tt_z_xxxz_0[j] + 2.0 * fl1_fz * ts_yyz_xxxz_0[j] - fl1_fz * fl1_fga * ts_z_xxxz_0[j];

                tt_yyz_xxyy_0[j] = pa_y[j] * tt_yz_xxyy_0[j] + 0.5 * fl1_fx * tt_z_xxyy_0[j] + fl1_fx * tt_yz_xxy_0[j] + 2.0 * fl1_fz * ts_yyz_xxyy_0[j] - fl1_fz * fl1_fga * ts_z_xxyy_0[j];

                tt_yyz_xxyz_0[j] = pa_y[j] * tt_yz_xxyz_0[j] + 0.5 * fl1_fx * tt_z_xxyz_0[j] + 0.5 * fl1_fx * tt_yz_xxz_0[j] + 2.0 * fl1_fz * ts_yyz_xxyz_0[j] - fl1_fz * fl1_fga * ts_z_xxyz_0[j];

                tt_yyz_xxzz_0[j] = pa_y[j] * tt_yz_xxzz_0[j] + 0.5 * fl1_fx * tt_z_xxzz_0[j] + 2.0 * fl1_fz * ts_yyz_xxzz_0[j] - fl1_fz * fl1_fga * ts_z_xxzz_0[j];

                tt_yyz_xyyy_0[j] = pa_y[j] * tt_yz_xyyy_0[j] + 0.5 * fl1_fx * tt_z_xyyy_0[j] + 1.5 * fl1_fx * tt_yz_xyy_0[j] + 2.0 * fl1_fz * ts_yyz_xyyy_0[j] - fl1_fz * fl1_fga * ts_z_xyyy_0[j];

                tt_yyz_xyyz_0[j] = pa_y[j] * tt_yz_xyyz_0[j] + 0.5 * fl1_fx * tt_z_xyyz_0[j] + fl1_fx * tt_yz_xyz_0[j] + 2.0 * fl1_fz * ts_yyz_xyyz_0[j] - fl1_fz * fl1_fga * ts_z_xyyz_0[j];

                tt_yyz_xyzz_0[j] = pa_y[j] * tt_yz_xyzz_0[j] + 0.5 * fl1_fx * tt_z_xyzz_0[j] + 0.5 * fl1_fx * tt_yz_xzz_0[j] + 2.0 * fl1_fz * ts_yyz_xyzz_0[j] - fl1_fz * fl1_fga * ts_z_xyzz_0[j];

                tt_yyz_xzzz_0[j] = pa_y[j] * tt_yz_xzzz_0[j] + 0.5 * fl1_fx * tt_z_xzzz_0[j] + 2.0 * fl1_fz * ts_yyz_xzzz_0[j] - fl1_fz * fl1_fga * ts_z_xzzz_0[j];

                tt_yyz_yyyy_0[j] = pa_y[j] * tt_yz_yyyy_0[j] + 0.5 * fl1_fx * tt_z_yyyy_0[j] + 2.0 * fl1_fx * tt_yz_yyy_0[j] + 2.0 * fl1_fz * ts_yyz_yyyy_0[j] - fl1_fz * fl1_fga * ts_z_yyyy_0[j];

                tt_yyz_yyyz_0[j] = pa_y[j] * tt_yz_yyyz_0[j] + 0.5 * fl1_fx * tt_z_yyyz_0[j] + 1.5 * fl1_fx * tt_yz_yyz_0[j] + 2.0 * fl1_fz * ts_yyz_yyyz_0[j] - fl1_fz * fl1_fga * ts_z_yyyz_0[j];

                tt_yyz_yyzz_0[j] = pa_y[j] * tt_yz_yyzz_0[j] + 0.5 * fl1_fx * tt_z_yyzz_0[j] + fl1_fx * tt_yz_yzz_0[j] + 2.0 * fl1_fz * ts_yyz_yyzz_0[j] - fl1_fz * fl1_fga * ts_z_yyzz_0[j];

                tt_yyz_yzzz_0[j] = pa_y[j] * tt_yz_yzzz_0[j] + 0.5 * fl1_fx * tt_z_yzzz_0[j] + 0.5 * fl1_fx * tt_yz_zzz_0[j] + 2.0 * fl1_fz * ts_yyz_yzzz_0[j] - fl1_fz * fl1_fga * ts_z_yzzz_0[j];

                tt_yyz_zzzz_0[j] = pa_y[j] * tt_yz_zzzz_0[j] + 0.5 * fl1_fx * tt_z_zzzz_0[j] + 2.0 * fl1_fz * ts_yyz_zzzz_0[j] - fl1_fz * fl1_fga * ts_z_zzzz_0[j];
                ...
                tt_zzz_xxxx_0[j] = pa_z[j] * tt_zz_xxxx_0[j] + fl1_fx * tt_z_xxxx_0[j] + 2.0 * fl1_fz * ts_zzz_xxxx_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_xxxx_0[j];

                tt_zzz_xxxy_0[j] = pa_z[j] * tt_zz_xxxy_0[j] + fl1_fx * tt_z_xxxy_0[j] + 2.0 * fl1_fz * ts_zzz_xxxy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_xxxy_0[j];

                tt_zzz_xxxz_0[j] = pa_z[j] * tt_zz_xxxz_0[j] + fl1_fx * tt_z_xxxz_0[j] + 0.5 * fl1_fx * tt_zz_xxx_0[j] + 2.0 * fl1_fz * ts_zzz_xxxz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_xxxz_0[j];

                tt_zzz_xxyy_0[j] = pa_z[j] * tt_zz_xxyy_0[j] + fl1_fx * tt_z_xxyy_0[j] + 2.0 * fl1_fz * ts_zzz_xxyy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_xxyy_0[j];

                tt_zzz_xxyz_0[j] = pa_z[j] * tt_zz_xxyz_0[j] + fl1_fx * tt_z_xxyz_0[j] + 0.5 * fl1_fx * tt_zz_xxy_0[j] + 2.0 * fl1_fz * ts_zzz_xxyz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_xxyz_0[j];

                tt_zzz_xxzz_0[j] = pa_z[j] * tt_zz_xxzz_0[j] + fl1_fx * tt_z_xxzz_0[j] + fl1_fx * tt_zz_xxz_0[j] + 2.0 * fl1_fz * ts_zzz_xxzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_xxzz_0[j];

                tt_zzz_xyyy_0[j] = pa_z[j] * tt_zz_xyyy_0[j] + fl1_fx * tt_z_xyyy_0[j] + 2.0 * fl1_fz * ts_zzz_xyyy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_xyyy_0[j];

                tt_zzz_xyyz_0[j] = pa_z[j] * tt_zz_xyyz_0[j] + fl1_fx * tt_z_xyyz_0[j] + 0.5 * fl1_fx * tt_zz_xyy_0[j] + 2.0 * fl1_fz * ts_zzz_xyyz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_xyyz_0[j];

                tt_zzz_xyzz_0[j] = pa_z[j] * tt_zz_xyzz_0[j] + fl1_fx * tt_z_xyzz_0[j] + fl1_fx * tt_zz_xyz_0[j] + 2.0 * fl1_fz * ts_zzz_xyzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_xyzz_0[j];

                tt_zzz_xzzz_0[j] = pa_z[j] * tt_zz_xzzz_0[j] + fl1_fx * tt_z_xzzz_0[j] + 1.5 * fl1_fx * tt_zz_xzz_0[j] + 2.0 * fl1_fz * ts_zzz_xzzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_xzzz_0[j];

                tt_zzz_yyyy_0[j] = pa_z[j] * tt_zz_yyyy_0[j] + fl1_fx * tt_z_yyyy_0[j] + 2.0 * fl1_fz * ts_zzz_yyyy_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_yyyy_0[j];

                tt_zzz_yyyz_0[j] = pa_z[j] * tt_zz_yyyz_0[j] + fl1_fx * tt_z_yyyz_0[j] + 0.5 * fl1_fx * tt_zz_yyy_0[j] + 2.0 * fl1_fz * ts_zzz_yyyz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_yyyz_0[j];

                tt_zzz_yyzz_0[j] = pa_z[j] * tt_zz_yyzz_0[j] + fl1_fx * tt_z_yyzz_0[j] + fl1_fx * tt_zz_yyz_0[j] + 2.0 * fl1_fz * ts_zzz_yyzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_yyzz_0[j];

                tt_zzz_yzzz_0[j] = pa_z[j] * tt_zz_yzzz_0[j] + fl1_fx * tt_z_yzzz_0[j] + 1.5 * fl1_fx * tt_zz_yzz_0[j] + 2.0 * fl1_fz * ts_zzz_yzzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_yzzz_0[j];

                tt_zzz_zzzz_0[j] = pa_z[j] * tt_zz_zzzz_0[j] + fl1_fx * tt_z_zzzz_0[j] + 2.0 * fl1_fx * tt_zz_zzz_0[j] + 2.0 * fl1_fz * ts_zzz_zzzz_0[j] - 2.0 * fl1_fz * fl1_fga * ts_z_zzzz_0[j];
            }
