...
namespace efieldrecfunc { // efieldrecfunc namespace
    ...
    {
        efieldrecfunc::compElectricFieldForGF_0_50(primBuffer,
                                                   recursionMap,
                                                   osFactors,
                                                   paDistances, 
                                                   pcDistances, 
        ...
        efieldrecfunc::compElectricFieldForGF_50_100(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     pcDistances, 
        ...
        efieldrecfunc::compElectricFieldForGF_100_150(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      paDistances, 
                                                      pcDistances, 
        ...
        efieldrecfunc::compElectricFieldForGF_150_200(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      paDistances, 
                                                      pcDistances, 
        ...
        efieldrecfunc::compElectricFieldForGF_200_250(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      paDistances, 
                                                      pcDistances, 
        ...
        efieldrecfunc::compElectricFieldForGF_250_300(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      paDistances, 
                                                      pcDistances, 
        ...
        efieldrecfunc::compElectricFieldForGF_300_350(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      paDistances, 
                                                      pcDistances, 
        ...
        efieldrecfunc::compElectricFieldForGF_350_400(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      paDistances, 
                                                      pcDistances, 
        ...
        efieldrecfunc::compElectricFieldForGF_400_450(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      paDistances, 
                                                      pcDistances, 
                                ...
                                const int32_t              iContrGto)
    {
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            auto pidx_e_4_3_m0 = recursionMap.getIndexOfTerm(CRecursionTerm({"Electric Field"}, 1, true, 
                                                             {4, -1, -1, -1}, {3, -1, -1, -1}, 
                                                             1, 1, iord));
            ...
            for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
            {
                ...
                for (int32_t j = 0; j < nprim; j++)
                {
                    ...
                    tex_xxxx_xxx_0[j] = pa_x[j] * tex_xxx_xxx_0[j] - pc_x[j] * tex_xxx_xxx_1[j] + 1.5 * fl1_fx * tex_xx_xxx_0[j] - 1.5 * fl1_fx * tex_xx_xxx_1[j] + 1.5 * fl1_fx * tex_xxx_xx_0[j] - 1.5 * fl1_fx * tex_xxx_xx_1[j] + ta_xxx_xxx_1[j];

                    tey_xxxx_xxx_0[j] = pa_x[j] * tey_xxx_xxx_0[j] - pc_x[j] * tey_xxx_xxx_1[j] + 1.5 * fl1_fx * tey_xx_xxx_0[j] - 1.5 * fl1_fx * tey_xx_xxx_1[j] + 1.5 * fl1_fx * tey_xxx_xx_0[j] - 1.5 * fl1_fx * tey_xxx_xx_1[j];

                    tez_xxxx_xxx_0[j] = pa_x[j] * tez_xxx_xxx_0[j] - pc_x[j] * tez_xxx_xxx_1[j] + 1.5 * fl1_fx * tez_xx_xxx_0[j] - 1.5 * fl1_fx * tez_xx_xxx_1[j] + 1.5 * fl1_fx * tez_xxx_xx_0[j] - 1.5 * fl1_fx * tez_xxx_xx_1[j];

                    tex_xxxx_xxy_0[j] = pa_x[j] * tex_xxx_xxy_0[j] - pc_x[j] * tex_xxx_xxy_1[j] + 1.5 * fl1_fx * tex_xx_xxy_0[j] - 1.5 * fl1_fx * tex_xx_xxy_1[j] + fl1_fx * tex_xxx_xy_0[j] - fl1_fx * tex_xxx_xy_1[j] + ta_xxx_xxy_1[j];

                    tey_xxxx_xxy_0[j] = pa_x[j] * tey_xxx_xxy_0[j] - pc_x[j] * tey_xxx_xxy_1[j] + 1.5 * fl1_fx * tey_xx_xxy_0[j] - 1.5 * fl1_fx * tey_xx_xxy_1[j] + fl1_fx * tey_xxx_xy_0[j] - fl1_fx * tey_xxx_xy_1[j];

                    tez_xxxx_xxy_0[j] = pa_x[j] * tez_xxx_xxy_0[j] - pc_x[j] * tez_xxx_xxy_1[j] + 1.5 * fl1_fx * tez_xx_xxy_0[j] - 1.5 * fl1_fx * tez_xx_xxy_1[j] + fl1_fx * tez_xxx_xy_0[j] - fl1_fx * tez_xxx_xy_1[j];

                    tex_xxxx_xxz_0[j] = pa_x[j] * tex_xxx_xxz_0[j] - pc_x[j] * tex_xxx_xxz_1[j] + 1.5 * fl1_fx * tex_xx_xxz_0[j] - 1.5 * fl1_fx * tex_xx_xxz_1[j] + fl1_fx * tex_xxx_xz_0[j] - fl1_fx * tex_xxx_xz_1[j] + ta_xxx_xxz_1[j];

                    tey_xxxx_xxz_0[j] = pa_x[j] * tey_xxx_xxz_0[j] - pc_x[j] * tey_xxx_xxz_1[j] + 1.5 * fl1_fx * tey_xx_xxz_0[j] - 1.5 * fl1_fx * tey_xx_xxz_1[j] + fl1_fx * tey_xxx_xz_0[j] - fl1_fx * tey_xxx_xz_1[j];

                    tez_xxxx_xxz_0[j] = pa_x[j] * tez_xxx_xxz_0[j] - pc_x[j] * tez_xxx_xxz_1[j] + 1.5 * fl1_fx * tez_xx_xxz_0[j] - 1.5 * fl1_fx * tez_xx_xxz_1[j] + fl1_fx * tez_xxx_xz_0[j] - fl1_fx * tez_xxx_xz_1[j];

                    tex_xxxx_xyy_0[j] = pa_x[j] * tex_xxx_xyy_0[j] - pc_x[j] * tex_xxx_xyy_1[j] + 1.5 * fl1_fx * tex_xx_xyy_0[j] - 1.5 * fl1_fx * tex_xx_xyy_1[j] + 0.5 * fl1_fx * tex_xxx_yy_0[j] - 0.5 * fl1_fx * tex_xxx_yy_1[j] + ta_xxx_xyy_1[j];

                    tey_xxxx_xyy_0[j] = pa_x[j] * tey_xxx_xyy_0[j] - pc_x[j] * tey_xxx_xyy_1[j] + 1.5 * fl1_fx * tey_xx_xyy_0[j] - 1.5 * fl1_fx * tey_xx_xyy_1[j] + 0.5 * fl1_fx * tey_xxx_yy_0[j] - 0.5 * fl1_fx * tey_xxx_yy_1[j];

                    tez_xxxx_xyy_0[j] = pa_x[j] * tez_xxx_xyy_0[j] - pc_x[j] * tez_xxx_xyy_1[j] + 1.5 * fl1_fx * tez_xx_xyy_0[j] - 1.5 * fl1_fx * tez_xx_xyy_1[j] + 0.5 * fl1_fx * tez_xxx_yy_0[j] - 0.5 * fl1_fx * tez_xxx_yy_1[j];

                    tex_xxxx_xyz_0[j] = pa_x[j] * tex_xxx_xyz_0[j] - pc_x[j] * tex_xxx_xyz_1[j] + 1.5 * fl1_fx * tex_xx_xyz_0[j] - 1.5 * fl1_fx * tex_xx_xyz_1[j] + 0.5 * fl1_fx * tex_xxx_yz_0[j] - 0.5 * fl1_fx * tex_xxx_yz_1[j] + ta_xxx_xyz_1[j];

                    tey_xxxx_xyz_0[j] = pa_x[j] * tey_xxx_xyz_0[j] - pc_x[j] * tey_xxx_xyz_1[j] + 1.5 * fl1_fx * tey_xx_xyz_0[j] - 1.5 * fl1_fx * tey_xx_xyz_1[j] + 0.5 * fl1_fx * tey_xxx_yz_0[j] - 0.5 * fl1_fx * tey_xxx_yz_1[j];

                    tez_xxxx_xyz_0[j] = pa_x[j] * tez_xxx_xyz_0[j] - pc_x[j] * tez_xxx_xyz_1[j] + 1.5 * fl1_fx * tez_xx_xyz_0[j] - 1.5 * fl1_fx * tez_xx_xyz_1[j] + 0.5 * fl1_fx * tez_xxx_yz_0[j] - 0.5 * fl1_fx * tez_xxx_yz_1[j];

                    tex_xxxx_xzz_0[j] = pa_x[j] * tex_xxx_xzz_0[j] - pc_x[j] * tex_xxx_xzz_1[j] + 1.5 * fl1_fx * tex_xx_xzz_0[j] - 1.5 * fl1_fx * tex_xx_xzz_1[j] + 0.5 * fl1_fx * tex_xxx_zz_0[j] - 0.5 * fl1_fx * tex_xxx_zz_1[j] + ta_xxx_xzz_1[j];

                    tey_xxxx_xzz_0[j] = pa_x[j] * tey_xxx_xzz_0[j] - pc_x[j] * tey_xxx_xzz_1[j] + 1.5 * fl1_fx * tey_xx_xzz_0[j] - 1.5 * fl1_fx * tey_xx_xzz_1[j] + 0.5 * fl1_fx * tey_xxx_zz_0[j] - 0.5 * fl1_fx * tey_xxx_zz_1[j];

                    tez_xxxx_xzz_0[j] = pa_x[j] * tez_xxx_xzz_0[j] - pc_x[j] * tez_xxx_xzz_1[j] + 1.5 * fl1_fx * tez_xx_xzz_0[j] - 1.5 * fl1_fx * tez_xx_xzz_1[j] + 0.5 * fl1_fx * tez_xxx_zz_0[j] - 0.5 * fl1_fx * tez_xxx_zz_1[j];

                    tex_xxxx_yyy_0[j] = pa_x[j] * tex_xxx_yyy_0[j] - pc_x[j] * tex_xxx_yyy_1[j] + 1.5 * fl1_fx * tex_xx_yyy_0[j] - 1.5 * fl1_fx * tex_xx_yyy_1[j] + ta_xxx_yyy_1[j];

                    tey_xxxx_yyy_0[j] = pa_x[j] * tey_xxx_yyy_0[j] - pc_x[j] * tey_xxx_yyy_1[j] + 1.5 * fl1_fx * tey_xx_yyy_0[j] - 1.5 * fl1_fx * tey_xx_yyy_1[j];

                    tez_xxxx_yyy_0[j] = pa_x[j] * tez_xxx_yyy_0[j] - pc_x[j] * tez_xxx_yyy_1[j] + 1.5 * fl1_fx * tez_xx_yyy_0[j] - 1.5 * fl1_fx * tez_xx_yyy_1[j];

                    tex_xxxx_yyz_0[j] = pa_x[j] * tex_xxx_yyz_0[j] - pc_x[j] * tex_xxx_yyz_1[j] + 1.5 * fl1_fx * tex_xx_yyz_0[j] - 1.5 * fl1_fx * tex_xx_yyz_1[j] + ta_xxx_yyz_1[j];

                    tey_xxxx_yyz_0[j] = pa_x[j] * tey_xxx_yyz_0[j] - pc_x[j] * tey_xxx_yyz_1[j] + 1.5 * fl1_fx * tey_xx_yyz_0[j] - 1.5 * fl1_fx * tey_xx_yyz_1[j];

                    tez_xxxx_yyz_0[j] = pa_x[j] * tez_xxx_yyz_0[j] - pc_x[j] * tez_xxx_yyz_1[j] + 1.5 * fl1_fx * tez_xx_yyz_0[j] - 1.5 * fl1_fx * tez_xx_yyz_1[j];

                    tex_xxxx_yzz_0[j] = pa_x[j] * tex_xxx_yzz_0[j] - pc_x[j] * tex_xxx_yzz_1[j] + 1.5 * fl1_fx * tex_xx_yzz_0[j] - 1.5 * fl1_fx * tex_xx_yzz_1[j] + ta_xxx_yzz_1[j];

                    tey_xxxx_yzz_0[j] = pa_x[j] * tey_xxx_yzz_0[j] - pc_x[j] * tey_xxx_yzz_1[j] + 1.5 * fl1_fx * tey_xx_yzz_0[j] - 1.5 * fl1_fx * tey_xx_yzz_1[j];

                    tez_xxxx_yzz_0[j] = pa_x[j] * tez_xxx_yzz_0[j] - pc_x[j] * tez_xxx_yzz_1[j] + 1.5 * fl1_fx * tez_xx_yzz_0[j] - 1.5 * fl1_fx * tez_xx_yzz_1[j];

                    tex_xxxx_zzz_0[j] = pa_x[j] * tex_xxx_zzz_0[j] - pc_x[j] * tex_xxx_zzz_1[j] + 1.5 * fl1_fx * tex_xx_zzz_0[j] - 1.5 * fl1_fx * tex_xx_zzz_1[j] + ta_xxx_zzz_1[j];

                    tey_xxxx_zzz_0[j] = pa_x[j] * tey_xxx_zzz_0[j] - pc_x[j] * tey_xxx_zzz_1[j] + 1.5 * fl1_fx * tey_xx_zzz_0[j] - 1.5 * fl1_fx * tey_xx_zzz_1[j];

                    tez_xxxx_zzz_0[j] = pa_x[j] * tez_xxx_zzz_0[j] - pc_x[j] * tez_xxx_zzz_1[j] + 1.5 * fl1_fx * tez_xx_zzz_0[j] - 1.5 * fl1_fx * tez_xx_zzz_1[j];

                    tex_xxxy_xxx_0[j] = pa_x[j] * tex_xxy_xxx_0[j] - pc_x[j] * tex_xxy_xxx_1[j] + fl1_fx * tex_xy_xxx_0[j] - fl1_fx * tex_xy_xxx_1[j] + 1.5 * fl1_fx * tex_xxy_xx_0[j] - 1.5 * fl1_fx * tex_xxy_xx_1[j] + ta_xxy_xxx_1[j];

                    tey_xxxy_xxx_0[j] = pa_x[j] * tey_xxy_xxx_0[j] - pc_x[j] * tey_xxy_xxx_1[j] + fl1_fx * tey_xy_xxx_0[j] - fl1_fx * tey_xy_xxx_1[j] + 1.5 * fl1_fx * tey_xxy_xx_0[j] - 1.5 * fl1_fx * tey_xxy_xx_1[j];

                    tez_xxxy_xxx_0[j] = pa_x[j] * tez_xxy_xxx_0[j] - pc_x[j] * tez_xxy_xxx_1[j] + fl1_fx * tez_xy_xxx_0[j] - fl1_fx * tez_xy_xxx_1[j] + 1.5 * fl1_fx * tez_xxy_xx_0[j] - 1.5 * fl1_fx * tez_xxy_xx_1[j];

                    tex_xxxy_xxy_0[j] = pa_x[j] * tex_xxy_xxy_0[j] - pc_x[j] * tex_xxy_xxy_1[j] + fl1_fx * tex_xy_xxy_0[j] - fl1_fx * tex_xy_xxy_1[j] + fl1_fx * tex_xxy_xy_0[j] - fl1_fx * tex_xxy_xy_1[j] + ta_xxy_xxy_1[j];

                    tey_xxxy_xxy_0[j] = pa_x[j] * tey_xxy_xxy_0[j] - pc_x[j] * tey_xxy_xxy_1[j] + fl1_fx * tey_xy_xxy_0[j] - fl1_fx * tey_xy_xxy_1[j] + fl1_fx * tey_xxy_xy_0[j] - fl1_fx * tey_xxy_xy_1[j];

                    tez_xxxy_xxy_0[j] = pa_x[j] * tez_xxy_xxy_0[j] - pc_x[j] * tez_xxy_xxy_1[j] + fl1_fx * tez_xy_xxy_0[j] - fl1_fx * tez_xy_xxy_1[j] + fl1_fx * tez_xxy_xy_0[j] - fl1_fx * tez_xxy_xy_1[j];

                    tex_xxxy_xxz_0[j] = pa_x[j] * tex_xxy_xxz_0[j] - pc_x[j] * tex_xxy_xxz_1[j] + fl1_fx * tex_xy_xxz_0[j] - fl1_fx * tex_xy_xxz_1[j] + fl1_fx * tex_xxy_xz_0[j] - fl1_fx * tex_xxy_xz_1[j] + ta_xxy_xxz_1[j];

                    tey_xxxy_xxz_0[j] = pa_x[j] * tey_xxy_xxz_0[j] - pc_x[j] * tey_xxy_xxz_1[j] + fl1_fx * tey_xy_xxz_0[j] - fl1_fx * tey_xy_xxz_1[j] + fl1_fx * tey_xxy_xz_0[j] - fl1_fx * tey_xxy_xz_1[j];

                    tez_xxxy_xxz_0[j] = pa_x[j] * tez_xxy_xxz_0[j] - pc_x[j] * tez_xxy_xxz_1[j] + fl1_fx * tez_xy_xxz_0[j] - fl1_fx * tez_xy_xxz_1[j] + fl1_fx * tez_xxy_xz_0[j] - fl1_fx * tez_xxy_xz_1[j];

                    tex_xxxy_xyy_0[j] = pa_x[j] * tex_xxy_xyy_0[j] - pc_x[j] * tex_xxy_xyy_1[j] + fl1_fx * tex_xy_xyy_0[j] - fl1_fx * tex_xy_xyy_1[j] + 0.5 * fl1_fx * tex_xxy_yy_0[j] - 0.5 * fl1_fx * tex_xxy_yy_1[j] + ta_xxy_xyy_1[j];

                    tey_xxxy_xyy_0[j] = pa_x[j] * tey_xxy_xyy_0[j] - pc_x[j] * tey_xxy_xyy_1[j] + fl1_fx * tey_xy_xyy_0[j] - fl1_fx * tey_xy_xyy_1[j] + 0.5 * fl1_fx * tey_xxy_yy_0[j] - 0.5 * fl1_fx * tey_xxy_yy_1[j];

                    tez_xxxy_xyy_0[j] = pa_x[j] * tez_xxy_xyy_0[j] - pc_x[j] * tez_xxy_xyy_1[j] + fl1_fx * tez_xy_xyy_0[j] - fl1_fx * tez_xy_xyy_1[j] + 0.5 * fl1_fx * tez_xxy_yy_0[j] - 0.5 * fl1_fx * tez_xxy_yy_1[j];

                    tex_xxxy_xyz_0[j] = pa_x[j] * tex_xxy_xyz_0[j] - pc_x[j] * tex_xxy_xyz_1[j] + fl1_fx * tex_xy_xyz_0[j] - fl1_fx * tex_xy_xyz_1[j] + 0.5 * fl1_fx * tex_xxy_yz_0[j] - 0.5 * fl1_fx * tex_xxy_yz_1[j] + ta_xxy_xyz_1[j];

                    tey_xxxy_xyz_0[j] = pa_x[j] * tey_xxy_xyz_0[j] - pc_x[j] * tey_xxy_xyz_1[j] + fl1_fx * tey_xy_xyz_0[j] - fl1_fx * tey_xy_xyz_1[j] + 0.5 * fl1_fx * tey_xxy_yz_0[j] - 0.5 * fl1_fx * tey_xxy_yz_1[j];

                    tez_xxxy_xyz_0[j] = pa_x[j] * tez_xxy_xyz_0[j] - pc_x[j] * tez_xxy_xyz_1[j] + fl1_fx * tez_xy_xyz_0[j] - fl1_fx * tez_xy_xyz_1[j] + 0.5 * fl1_fx * tez_xxy_yz_0[j] - 0.5 * fl1_fx * tez_xxy_yz_1[j];

                    tex_xxxy_xzz_0[j] = pa_x[j] * tex_xxy_xzz_0[j] - pc_x[j] * tex_xxy_xzz_1[j] + fl1_fx * tex_xy_xzz_0[j] - fl1_fx * tex_xy_xzz_1[j] + 0.5 * fl1_fx * tex_xxy_zz_0[j] - 0.5 * fl1_fx * tex_xxy_zz_1[j] + ta_xxy_xzz_1[j];

                    tey_xxxy_xzz_0[j] = pa_x[j] * tey_xxy_xzz_0[j] - pc_x[j] * tey_xxy_xzz_1[j] + fl1_fx * tey_xy_xzz_0[j] - fl1_fx * tey_xy_xzz_1[j] + 0.5 * fl1_fx * tey_xxy_zz_0[j] - 0.5 * fl1_fx * tey_xxy_zz_1[j];

                    tez_xxxy_xzz_0[j] = pa_x[j] * tez_xxy_xzz_0[j] - pc_x[j] * tez_xxy_xzz_1[j] + fl1_fx * tez_xy_xzz_0[j] - fl1_fx * tez_xy_xzz_1[j] + 0.5 * fl1_fx * tez_xxy_zz_0[j] - 0.5 * fl1_fx * tez_xxy_zz_1[j];

                    tex_xxxy_yyy_0[j] = pa_x[j] * tex_xxy_yyy_0[j] - pc_x[j] * tex_xxy_yyy_1[j] + fl1_fx * tex_xy_yyy_0[j] - fl1_fx * tex_xy_yyy_1[j] + ta_xxy_yyy_1[j];
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
            {
                ...
                for (int32_t j = 0; j < nprim; j++)
                {
                    ...
                    tex_xxxy_yyz_0[j] = pa_x[j] * tex_xxy_yyz_0[j] - pc_x[j] * tex_xxy_yyz_1[j] + fl1_fx * tex_xy_yyz_0[j] - fl1_fx * tex_xy_yyz_1[j] + ta_xxy_yyz_1[j];
                    ...
                    tex_xxxy_yzz_0[j] = pa_x[j] * tex_xxy_yzz_0[j] - pc_x[j] * tex_xxy_yzz_1[j] + fl1_fx * tex_xy_yzz_0[j] - fl1_fx * tex_xy_yzz_1[j] + ta_xxy_yzz_1[j];
                    ...
                    tex_xxxy_zzz_0[j] = pa_x[j] * tex_xxy_zzz_0[j] - pc_x[j] * tex_xxy_zzz_1[j] + fl1_fx * tex_xy_zzz_0[j] - fl1_fx * tex_xy_zzz_1[j] + ta_xxy_zzz_1[j];
                    ...
                    tex_xxxz_xxx_0[j] = pa_x[j] * tex_xxz_xxx_0[j] - pc_x[j] * tex_xxz_xxx_1[j] + fl1_fx * tex_xz_xxx_0[j] - fl1_fx * tex_xz_xxx_1[j] + 1.5 * fl1_fx * tex_xxz_xx_0[j] - 1.5 * fl1_fx * tex_xxz_xx_1[j] + ta_xxz_xxx_1[j];

                    tey_xxxz_xxx_0[j] = pa_x[j] * tey_xxz_xxx_0[j] - pc_x[j] * tey_xxz_xxx_1[j] + fl1_fx * tey_xz_xxx_0[j] - fl1_fx * tey_xz_xxx_1[j] + 1.5 * fl1_fx * tey_xxz_xx_0[j] - 1.5 * fl1_fx * tey_xxz_xx_1[j];

                    tez_xxxz_xxx_0[j] = pa_x[j] * tez_xxz_xxx_0[j] - pc_x[j] * tez_xxz_xxx_1[j] + fl1_fx * tez_xz_xxx_0[j] - fl1_fx * tez_xz_xxx_1[j] + 1.5 * fl1_fx * tez_xxz_xx_0[j] - 1.5 * fl1_fx * tez_xxz_xx_1[j];

                    tex_xxxz_xxy_0[j] = pa_x[j] * tex_xxz_xxy_0[j] - pc_x[j] * tex_xxz_xxy_1[j] + fl1_fx * tex_xz_xxy_0[j] - fl1_fx * tex_xz_xxy_1[j] + fl1_fx * tex_xxz_xy_0[j] - fl1_fx * tex_xxz_xy_1[j] + ta_xxz_xxy_1[j];

                    tey_xxxz_xxy_0[j] = pa_x[j] * tey_xxz_xxy_0[j] - pc_x[j] * tey_xxz_xxy_1[j] + fl1_fx * tey_xz_xxy_0[j] - fl1_fx * tey_xz_xxy_1[j] + fl1_fx * tey_xxz_xy_0[j] - fl1_fx * tey_xxz_xy_1[j];

                    tez_xxxz_xxy_0[j] = pa_x[j] * tez_xxz_xxy_0[j] - pc_x[j] * tez_xxz_xxy_1[j] + fl1_fx * tez_xz_xxy_0[j] - fl1_fx * tez_xz_xxy_1[j] + fl1_fx * tez_xxz_xy_0[j] - fl1_fx * tez_xxz_xy_1[j];

                    tex_xxxz_xxz_0[j] = pa_x[j] * tex_xxz_xxz_0[j] - pc_x[j] * tex_xxz_xxz_1[j] + fl1_fx * tex_xz_xxz_0[j] - fl1_fx * tex_xz_xxz_1[j] + fl1_fx * tex_xxz_xz_0[j] - fl1_fx * tex_xxz_xz_1[j] + ta_xxz_xxz_1[j];

                    tey_xxxz_xxz_0[j] = pa_x[j] * tey_xxz_xxz_0[j] - pc_x[j] * tey_xxz_xxz_1[j] + fl1_fx * tey_xz_xxz_0[j] - fl1_fx * tey_xz_xxz_1[j] + fl1_fx * tey_xxz_xz_0[j] - fl1_fx * tey_xxz_xz_1[j];

                    tez_xxxz_xxz_0[j] = pa_x[j] * tez_xxz_xxz_0[j] - pc_x[j] * tez_xxz_xxz_1[j] + fl1_fx * tez_xz_xxz_0[j] - fl1_fx * tez_xz_xxz_1[j] + fl1_fx * tez_xxz_xz_0[j] - fl1_fx * tez_xxz_xz_1[j];

                    tex_xxxz_xyy_0[j] = pa_x[j] * tex_xxz_xyy_0[j] - pc_x[j] * tex_xxz_xyy_1[j] + fl1_fx * tex_xz_xyy_0[j] - fl1_fx * tex_xz_xyy_1[j] + 0.5 * fl1_fx * tex_xxz_yy_0[j] - 0.5 * fl1_fx * tex_xxz_yy_1[j] + ta_xxz_xyy_1[j];

                    tey_xxxz_xyy_0[j] = pa_x[j] * tey_xxz_xyy_0[j] - pc_x[j] * tey_xxz_xyy_1[j] + fl1_fx * tey_xz_xyy_0[j] - fl1_fx * tey_xz_xyy_1[j] + 0.5 * fl1_fx * tey_xxz_yy_0[j] - 0.5 * fl1_fx * tey_xxz_yy_1[j];

                    tez_xxxz_xyy_0[j] = pa_x[j] * tez_xxz_xyy_0[j] - pc_x[j] * tez_xxz_xyy_1[j] + fl1_fx * tez_xz_xyy_0[j] - fl1_fx * tez_xz_xyy_1[j] + 0.5 * fl1_fx * tez_xxz_yy_0[j] - 0.5 * fl1_fx * tez_xxz_yy_1[j];

                    tex_xxxz_xyz_0[j] = pa_x[j] * tex_xxz_xyz_0[j] - pc_x[j] * tex_xxz_xyz_1[j] + fl1_fx * tex_xz_xyz_0[j] - fl1_fx * tex_xz_xyz_1[j] + 0.5 * fl1_fx * tex_xxz_yz_0[j] - 0.5 * fl1_fx * tex_xxz_yz_1[j] + ta_xxz_xyz_1[j];

                    tey_xxxz_xyz_0[j] = pa_x[j] * tey_xxz_xyz_0[j] - pc_x[j] * tey_xxz_xyz_1[j] + fl1_fx * tey_xz_xyz_0[j] - fl1_fx * tey_xz_xyz_1[j] + 0.5 * fl1_fx * tey_xxz_yz_0[j] - 0.5 * fl1_fx * tey_xxz_yz_1[j];

                    tez_xxxz_xyz_0[j] = pa_x[j] * tez_xxz_xyz_0[j] - pc_x[j] * tez_xxz_xyz_1[j] + fl1_fx * tez_xz_xyz_0[j] - fl1_fx * tez_xz_xyz_1[j] + 0.5 * fl1_fx * tez_xxz_yz_0[j] - 0.5 * fl1_fx * tez_xxz_yz_1[j];

                    tex_xxxz_xzz_0[j] = pa_x[j] * tex_xxz_xzz_0[j] - pc_x[j] * tex_xxz_xzz_1[j] + fl1_fx * tex_xz_xzz_0[j] - fl1_fx * tex_xz_xzz_1[j] + 0.5 * fl1_fx * tex_xxz_zz_0[j] - 0.5 * fl1_fx * tex_xxz_zz_1[j] + ta_xxz_xzz_1[j];

                    tey_xxxz_xzz_0[j] = pa_x[j] * tey_xxz_xzz_0[j] - pc_x[j] * tey_xxz_xzz_1[j] + fl1_fx * tey_xz_xzz_0[j] - fl1_fx * tey_xz_xzz_1[j] + 0.5 * fl1_fx * tey_xxz_zz_0[j] - 0.5 * fl1_fx * tey_xxz_zz_1[j];

                    tez_xxxz_xzz_0[j] = pa_x[j] * tez_xxz_xzz_0[j] - pc_x[j] * tez_xxz_xzz_1[j] + fl1_fx * tez_xz_xzz_0[j] - fl1_fx * tez_xz_xzz_1[j] + 0.5 * fl1_fx * tez_xxz_zz_0[j] - 0.5 * fl1_fx * tez_xxz_zz_1[j];

                    tex_xxxz_yyy_0[j] = pa_x[j] * tex_xxz_yyy_0[j] - pc_x[j] * tex_xxz_yyy_1[j] + fl1_fx * tex_xz_yyy_0[j] - fl1_fx * tex_xz_yyy_1[j] + ta_xxz_yyy_1[j];
                    ...
                    tex_xxxz_yyz_0[j] = pa_x[j] * tex_xxz_yyz_0[j] - pc_x[j] * tex_xxz_yyz_1[j] + fl1_fx * tex_xz_yyz_0[j] - fl1_fx * tex_xz_yyz_1[j] + ta_xxz_yyz_1[j];
                    ...
                    tex_xxxz_yzz_0[j] = pa_x[j] * tex_xxz_yzz_0[j] - pc_x[j] * tex_xxz_yzz_1[j] + fl1_fx * tex_xz_yzz_0[j] - fl1_fx * tex_xz_yzz_1[j] + ta_xxz_yzz_1[j];
                    ...
                    tex_xxxz_zzz_0[j] = pa_x[j] * tex_xxz_zzz_0[j] - pc_x[j] * tex_xxz_zzz_1[j] + fl1_fx * tex_xz_zzz_0[j] - fl1_fx * tex_xz_zzz_1[j] + ta_xxz_zzz_1[j];
                    ...
                    tex_xxyy_xxx_0[j] = pa_x[j] * tex_xyy_xxx_0[j] - pc_x[j] * tex_xyy_xxx_1[j] + 0.5 * fl1_fx * tex_yy_xxx_0[j] - 0.5 * fl1_fx * tex_yy_xxx_1[j] + 1.5 * fl1_fx * tex_xyy_xx_0[j] - 1.5 * fl1_fx * tex_xyy_xx_1[j] + ta_xyy_xxx_1[j];

                    tey_xxyy_xxx_0[j] = pa_x[j] * tey_xyy_xxx_0[j] - pc_x[j] * tey_xyy_xxx_1[j] + 0.5 * fl1_fx * tey_yy_xxx_0[j] - 0.5 * fl1_fx * tey_yy_xxx_1[j] + 1.5 * fl1_fx * tey_xyy_xx_0[j] - 1.5 * fl1_fx * tey_xyy_xx_1[j];

                    tez_xxyy_xxx_0[j] = pa_x[j] * tez_xyy_xxx_0[j] - pc_x[j] * tez_xyy_xxx_1[j] + 0.5 * fl1_fx * tez_yy_xxx_0[j] - 0.5 * fl1_fx * tez_yy_xxx_1[j] + 1.5 * fl1_fx * tez_xyy_xx_0[j] - 1.5 * fl1_fx * tez_xyy_xx_1[j];

                    tex_xxyy_xxy_0[j] = pa_x[j] * tex_xyy_xxy_0[j] - pc_x[j] * tex_xyy_xxy_1[j] + 0.5 * fl1_fx * tex_yy_xxy_0[j] - 0.5 * fl1_fx * tex_yy_xxy_1[j] + fl1_fx * tex_xyy_xy_0[j] - fl1_fx * tex_xyy_xy_1[j] + ta_xyy_xxy_1[j];

                    tey_xxyy_xxy_0[j] = pa_x[j] * tey_xyy_xxy_0[j] - pc_x[j] * tey_xyy_xxy_1[j] + 0.5 * fl1_fx * tey_yy_xxy_0[j] - 0.5 * fl1_fx * tey_yy_xxy_1[j] + fl1_fx * tey_xyy_xy_0[j] - fl1_fx * tey_xyy_xy_1[j];

                    tez_xxyy_xxy_0[j] = pa_x[j] * tez_xyy_xxy_0[j] - pc_x[j] * tez_xyy_xxy_1[j] + 0.5 * fl1_fx * tez_yy_xxy_0[j] - 0.5 * fl1_fx * tez_yy_xxy_1[j] + fl1_fx * tez_xyy_xy_0[j] - fl1_fx * tez_xyy_xy_1[j];

                    tex_xxyy_xxz_0[j] = pa_x[j] * tex_xyy_xxz_0[j] - pc_x[j] * tex_xyy_xxz_1[j] + 0.5 * fl1_fx * tex_yy_xxz_0[j] - 0.5 * fl1_fx * tex_yy_xxz_1[j] + fl1_fx * tex_xyy_xz_0[j] - fl1_fx * tex_xyy_xz_1[j] + ta_xyy_xxz_1[j];

                    tey_xxyy_xxz_0[j] = pa_x[j] * tey_xyy_xxz_0[j] - pc_x[j] * tey_xyy_xxz_1[j] + 0.5 * fl1_fx * tey_yy_xxz_0[j] - 0.5 * fl1_fx * tey_yy_xxz_1[j] + fl1_fx * tey_xyy_xz_0[j] - fl1_fx * tey_xyy_xz_1[j];

                    tez_xxyy_xxz_0[j] = pa_x[j] * tez_xyy_xxz_0[j] - pc_x[j] * tez_xyy_xxz_1[j] + 0.5 * fl1_fx * tez_yy_xxz_0[j] - 0.5 * fl1_fx * tez_yy_xxz_1[j] + fl1_fx * tez_xyy_xz_0[j] - fl1_fx * tez_xyy_xz_1[j];

                    tex_xxyy_xyy_0[j] = pa_x[j] * tex_xyy_xyy_0[j] - pc_x[j] * tex_xyy_xyy_1[j] + 0.5 * fl1_fx * tex_yy_xyy_0[j] - 0.5 * fl1_fx * tex_yy_xyy_1[j] + 0.5 * fl1_fx * tex_xyy_yy_0[j] - 0.5 * fl1_fx * tex_xyy_yy_1[j] + ta_xyy_xyy_1[j];
                }
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
            {
                ...
                for (int32_t j = 0; j < nprim; j++)
                {
                    ...
                    tey_xxyy_xyy_0[j] = pa_x[j] * tey_xyy_xyy_0[j] - pc_x[j] * tey_xyy_xyy_1[j] + 0.5 * fl1_fx * tey_yy_xyy_0[j] - 0.5 * fl1_fx * tey_yy_xyy_1[j] + 0.5 * fl1_fx * tey_xyy_yy_0[j] - 0.5 * fl1_fx * tey_xyy_yy_1[j];

                    tez_xxyy_xyy_0[j] = pa_x[j] * tez_xyy_xyy_0[j] - pc_x[j] * tez_xyy_xyy_1[j] + 0.5 * fl1_fx * tez_yy_xyy_0[j] - 0.5 * fl1_fx * tez_yy_xyy_1[j] + 0.5 * fl1_fx * tez_xyy_yy_0[j] - 0.5 * fl1_fx * tez_xyy_yy_1[j];

                    tex_xxyy_xyz_0[j] = pa_x[j] * tex_xyy_xyz_0[j] - pc_x[j] * tex_xyy_xyz_1[j] + 0.5 * fl1_fx * tex_yy_xyz_0[j] - 0.5 * fl1_fx * tex_yy_xyz_1[j] + 0.5 * fl1_fx * tex_xyy_yz_0[j] - 0.5 * fl1_fx * tex_xyy_yz_1[j] + ta_xyy_xyz_1[j];

                    tey_xxyy_xyz_0[j] = pa_x[j] * tey_xyy_xyz_0[j] - pc_x[j] * tey_xyy_xyz_1[j] + 0.5 * fl1_fx * tey_yy_xyz_0[j] - 0.5 * fl1_fx * tey_yy_xyz_1[j] + 0.5 * fl1_fx * tey_xyy_yz_0[j] - 0.5 * fl1_fx * tey_xyy_yz_1[j];

                    tez_xxyy_xyz_0[j] = pa_x[j] * tez_xyy_xyz_0[j] - pc_x[j] * tez_xyy_xyz_1[j] + 0.5 * fl1_fx * tez_yy_xyz_0[j] - 0.5 * fl1_fx * tez_yy_xyz_1[j] + 0.5 * fl1_fx * tez_xyy_yz_0[j] - 0.5 * fl1_fx * tez_xyy_yz_1[j];

                    tex_xxyy_xzz_0[j] = pa_x[j] * tex_xyy_xzz_0[j] - pc_x[j] * tex_xyy_xzz_1[j] + 0.5 * fl1_fx * tex_yy_xzz_0[j] - 0.5 * fl1_fx * tex_yy_xzz_1[j] + 0.5 * fl1_fx * tex_xyy_zz_0[j] - 0.5 * fl1_fx * tex_xyy_zz_1[j] + ta_xyy_xzz_1[j];

                    tey_xxyy_xzz_0[j] = pa_x[j] * tey_xyy_xzz_0[j] - pc_x[j] * tey_xyy_xzz_1[j] + 0.5 * fl1_fx * tey_yy_xzz_0[j] - 0.5 * fl1_fx * tey_yy_xzz_1[j] + 0.5 * fl1_fx * tey_xyy_zz_0[j] - 0.5 * fl1_fx * tey_xyy_zz_1[j];

                    tez_xxyy_xzz_0[j] = pa_x[j] * tez_xyy_xzz_0[j] - pc_x[j] * tez_xyy_xzz_1[j] + 0.5 * fl1_fx * tez_yy_xzz_0[j] - 0.5 * fl1_fx * tez_yy_xzz_1[j] + 0.5 * fl1_fx * tez_xyy_zz_0[j] - 0.5 * fl1_fx * tez_xyy_zz_1[j];

                    tex_xxyy_yyy_0[j] = pa_x[j] * tex_xyy_yyy_0[j] - pc_x[j] * tex_xyy_yyy_1[j] + 0.5 * fl1_fx * tex_yy_yyy_0[j] - 0.5 * fl1_fx * tex_yy_yyy_1[j] + ta_xyy_yyy_1[j];

                    tey_xxyy_yyy_0[j] = pa_x[j] * tey_xyy_yyy_0[j] - pc_x[j] * tey_xyy_yyy_1[j] + 0.5 * fl1_fx * tey_yy_yyy_0[j] - 0.5 * fl1_fx * tey_yy_yyy_1[j];

                    tez_xxyy_yyy_0[j] = pa_x[j] * tez_xyy_yyy_0[j] - pc_x[j] * tez_xyy_yyy_1[j] + 0.5 * fl1_fx * tez_yy_yyy_0[j] - 0.5 * fl1_fx * tez_yy_yyy_1[j];

                    tex_xxyy_yyz_0[j] = pa_x[j] * tex_xyy_yyz_0[j] - pc_x[j] * tex_xyy_yyz_1[j] + 0.5 * fl1_fx * tex_yy_yyz_0[j] - 0.5 * fl1_fx * tex_yy_yyz_1[j] + ta_xyy_yyz_1[j];

                    tey_xxyy_yyz_0[j] = pa_x[j] * tey_xyy_yyz_0[j] - pc_x[j] * tey_xyy_yyz_1[j] + 0.5 * fl1_fx * tey_yy_yyz_0[j] - 0.5 * fl1_fx * tey_yy_yyz_1[j];

                    tez_xxyy_yyz_0[j] = pa_x[j] * tez_xyy_yyz_0[j] - pc_x[j] * tez_xyy_yyz_1[j] + 0.5 * fl1_fx * tez_yy_yyz_0[j] - 0.5 * fl1_fx * tez_yy_yyz_1[j];

                    tex_xxyy_yzz_0[j] = pa_x[j] * tex_xyy_yzz_0[j] - pc_x[j] * tex_xyy_yzz_1[j] + 0.5 * fl1_fx * tex_yy_yzz_0[j] - 0.5 * fl1_fx * tex_yy_yzz_1[j] + ta_xyy_yzz_1[j];

                    tey_xxyy_yzz_0[j] = pa_x[j] * tey_xyy_yzz_0[j] - pc_x[j] * tey_xyy_yzz_1[j] + 0.5 * fl1_fx * tey_yy_yzz_0[j] - 0.5 * fl1_fx * tey_yy_yzz_1[j];

                    tez_xxyy_yzz_0[j] = pa_x[j] * tez_xyy_yzz_0[j] - pc_x[j] * tez_xyy_yzz_1[j] + 0.5 * fl1_fx * tez_yy_yzz_0[j] - 0.5 * fl1_fx * tez_yy_yzz_1[j];

                    tex_xxyy_zzz_0[j] = pa_x[j] * tex_xyy_zzz_0[j] - pc_x[j] * tex_xyy_zzz_1[j] + 0.5 * fl1_fx * tex_yy_zzz_0[j] - 0.5 * fl1_fx * tex_yy_zzz_1[j] + ta_xyy_zzz_1[j];

                    tey_xxyy_zzz_0[j] = pa_x[j] * tey_xyy_zzz_0[j] - pc_x[j] * tey_xyy_zzz_1[j] + 0.5 * fl1_fx * tey_yy_zzz_0[j] - 0.5 * fl1_fx * tey_yy_zzz_1[j];

                    tez_xxyy_zzz_0[j] = pa_x[j] * tez_xyy_zzz_0[j] - pc_x[j] * tez_xyy_zzz_1[j] + 0.5 * fl1_fx * tez_yy_zzz_0[j] - 0.5 * fl1_fx * tez_yy_zzz_1[j];

                    tex_xxyz_xxx_0[j] = pa_x[j] * tex_xyz_xxx_0[j] - pc_x[j] * tex_xyz_xxx_1[j] + 0.5 * fl1_fx * tex_yz_xxx_0[j] - 0.5 * fl1_fx * tex_yz_xxx_1[j] + 1.5 * fl1_fx * tex_xyz_xx_0[j] - 1.5 * fl1_fx * tex_xyz_xx_1[j] + ta_xyz_xxx_1[j];

                    tey_xxyz_xxx_0[j] = pa_x[j] * tey_xyz_xxx_0[j] - pc_x[j] * tey_xyz_xxx_1[j] + 0.5 * fl1_fx * tey_yz_xxx_0[j] - 0.5 * fl1_fx * tey_yz_xxx_1[j] + 1.5 * fl1_fx * tey_xyz_xx_0[j] - 1.5 * fl1_fx * tey_xyz_xx_1[j];

                    tez_xxyz_xxx_0[j] = pa_x[j] * tez_xyz_xxx_0[j] - pc_x[j] * tez_xyz_xxx_1[j] + 0.5 * fl1_fx * tez_yz_xxx_0[j] - 0.5 * fl1_fx * tez_yz_xxx_1[j] + 1.5 * fl1_fx * tez_xyz_xx_0[j] - 1.5 * fl1_fx * tez_xyz_xx_1[j];

                    tex_xxyz_xxy_0[j] = pa_x[j] * tex_xyz_xxy_0[j] - pc_x[j] * tex_xyz_xxy_1[j] + 0.5 * fl1_fx * tex_yz_xxy_0[j] - 0.5 * fl1_fx * tex_yz_xxy_1[j] + fl1_fx * tex_xyz_xy_0[j] - fl1_fx * tex_xyz_xy_1[j] + ta_xyz_xxy_1[j];

                    tey_xxyz_xxy_0[j] = pa_x[j] * tey_xyz_xxy_0[j] - pc_x[j] * tey_xyz_xxy_1[j] + 0.5 * fl1_fx * tey_yz_xxy_0[j] - 0.5 * fl1_fx * tey_yz_xxy_1[j] + fl1_fx * tey_xyz_xy_0[j] - fl1_fx * tey_xyz_xy_1[j];

                    tez_xxyz_xxy_0[j] = pa_x[j] * tez_xyz_xxy_0[j] - pc_x[j] * tez_xyz_xxy_1[j] + 0.5 * fl1_fx * tez_yz_xxy_0[j] - 0.5 * fl1_fx * tez_yz_xxy_1[j] + fl1_fx * tez_xyz_xy_0[j] - fl1_fx * tez_xyz_xy_1[j];

                    tex_xxyz_xxz_0[j] = pa_x[j] * tex_xyz_xxz_0[j] - pc_x[j] * tex_xyz_xxz_1[j] + 0.5 * fl1_fx * tex_yz_xxz_0[j] - 0.5 * fl1_fx * tex_yz_xxz_1[j] + fl1_fx * tex_xyz_xz_0[j] - fl1_fx * tex_xyz_xz_1[j] + ta_xyz_xxz_1[j];

                    tey_xxyz_xxz_0[j] = pa_x[j] * tey_xyz_xxz_0[j] - pc_x[j] * tey_xyz_xxz_1[j] + 0.5 * fl1_fx * tey_yz_xxz_0[j] - 0.5 * fl1_fx * tey_yz_xxz_1[j] + fl1_fx * tey_xyz_xz_0[j] - fl1_fx * tey_xyz_xz_1[j];

                    tez_xxyz_xxz_0[j] = pa_x[j] * tez_xyz_xxz_0[j] - pc_x[j] * tez_xyz_xxz_1[j] + 0.5 * fl1_fx * tez_yz_xxz_0[j] - 0.5 * fl1_fx * tez_yz_xxz_1[j] + fl1_fx * tez_xyz_xz_0[j] - fl1_fx * tez_xyz_xz_1[j];

                    tex_xxyz_xyy_0[j] = pa_x[j] * tex_xyz_xyy_0[j] - pc_x[j] * tex_xyz_xyy_1[j] + 0.5 * fl1_fx * tex_yz_xyy_0[j] - 0.5 * fl1_fx * tex_yz_xyy_1[j] + 0.5 * fl1_fx * tex_xyz_yy_0[j] - 0.5 * fl1_fx * tex_xyz_yy_1[j] + ta_xyz_xyy_1[j];

                    tey_xxyz_xyy_0[j] = pa_x[j] * tey_xyz_xyy_0[j] - pc_x[j] * tey_xyz_xyy_1[j] + 0.5 * fl1_fx * tey_yz_xyy_0[j] - 0.5 * fl1_fx * tey_yz_xyy_1[j] + 0.5 * fl1_fx * tey_xyz_yy_0[j] - 0.5 * fl1_fx * tey_xyz_yy_1[j];

                    tez_xxyz_xyy_0[j] = pa_x[j] * tez_xyz_xyy_0[j] - pc_x[j] * tez_xyz_xyy_1[j] + 0.5 * fl1_fx * tez_yz_xyy_0[j] - 0.5 * fl1_fx * tez_yz_xyy_1[j] + 0.5 * fl1_fx * tez_xyz_yy_0[j] - 0.5 * fl1_fx * tez_xyz_yy_1[j];

                    tex_xxyz_xyz_0[j] = pa_x[j] * tex_xyz_xyz_0[j] - pc_x[j] * tex_xyz_xyz_1[j] + 0.5 * fl1_fx * tex_yz_xyz_0[j] - 0.5 * fl1_fx * tex_yz_xyz_1[j] + 0.5 * fl1_fx * tex_xyz_yz_0[j] - 0.5 * fl1_fx * tex_xyz_yz_1[j] + ta_xyz_xyz_1[j];

                    tey_xxyz_xyz_0[j] = pa_x[j] * tey_xyz_xyz_0[j] - pc_x[j] * tey_xyz_xyz_1[j] + 0.5 * fl1_fx * tey_yz_xyz_0[j] - 0.5 * fl1_fx * tey_yz_xyz_1[j] + 0.5 * fl1_fx * tey_xyz_yz_0[j] - 0.5 * fl1_fx * tey_xyz_yz_1[j];

                    tez_xxyz_xyz_0[j] = pa_x[j] * tez_xyz_xyz_0[j] - pc_x[j] * tez_xyz_xyz_1[j] + 0.5 * fl1_fx * tez_yz_xyz_0[j] - 0.5 * fl1_fx * tez_yz_xyz_1[j] + 0.5 * fl1_fx * tez_xyz_yz_0[j] - 0.5 * fl1_fx * tez_xyz_yz_1[j];

                    tex_xxyz_xzz_0[j] = pa_x[j] * tex_xyz_xzz_0[j] - pc_x[j] * tex_xyz_xzz_1[j] + 0.5 * fl1_fx * tex_yz_xzz_0[j] - 0.5 * fl1_fx * tex_yz_xzz_1[j] + 0.5 * fl1_fx * tex_xyz_zz_0[j] - 0.5 * fl1_fx * tex_xyz_zz_1[j] + ta_xyz_xzz_1[j];

                    tey_xxyz_xzz_0[j] = pa_x[j] * tey_xyz_xzz_0[j] - pc_x[j] * tey_xyz_xzz_1[j] + 0.5 * fl1_fx * tey_yz_xzz_0[j] - 0.5 * fl1_fx * tey_yz_xzz_1[j] + 0.5 * fl1_fx * tey_xyz_zz_0[j] - 0.5 * fl1_fx * tey_xyz_zz_1[j];

                    tez_xxyz_xzz_0[j] = pa_x[j] * tez_xyz_xzz_0[j] - pc_x[j] * tez_xyz_xzz_1[j] + 0.5 * fl1_fx * tez_yz_xzz_0[j] - 0.5 * fl1_fx * tez_yz_xzz_1[j] + 0.5 * fl1_fx * tez_xyz_zz_0[j] - 0.5 * fl1_fx * tez_xyz_zz_1[j];

                    tex_xxyz_yyy_0[j] = pa_x[j] * tex_xyz_yyy_0[j] - pc_x[j] * tex_xyz_yyy_1[j] + 0.5 * fl1_fx * tex_yz_yyy_0[j] - 0.5 * fl1_fx * tex_yz_yyy_1[j] + ta_xyz_yyy_1[j];

                    tey_xxyz_yyy_0[j] = pa_x[j] * tey_xyz_yyy_0[j] - pc_x[j] * tey_xyz_yyy_1[j] + 0.5 * fl1_fx * tey_yz_yyy_0[j] - 0.5 * fl1_fx * tey_yz_yyy_1[j];

                    tez_xxyz_yyy_0[j] = pa_x[j] * tez_xyz_yyy_0[j] - pc_x[j] * tez_xyz_yyy_1[j] + 0.5 * fl1_fx * tez_yz_yyy_0[j] - 0.5 * fl1_fx * tez_yz_yyy_1[j];

                    tex_xxyz_yyz_0[j] = pa_x[j] * tex_xyz_yyz_0[j] - pc_x[j] * tex_xyz_yyz_1[j] + 0.5 * fl1_fx * tex_yz_yyz_0[j] - 0.5 * fl1_fx * tex_yz_yyz_1[j] + ta_xyz_yyz_1[j];

                    tey_xxyz_yyz_0[j] = pa_x[j] * tey_xyz_yyz_0[j] - pc_x[j] * tey_xyz_yyz_1[j] + 0.5 * fl1_fx * tey_yz_yyz_0[j] - 0.5 * fl1_fx * tey_yz_yyz_1[j];

                    tez_xxyz_yyz_0[j] = pa_x[j] * tez_xyz_yyz_0[j] - pc_x[j] * tez_xyz_yyz_1[j] + 0.5 * fl1_fx * tez_yz_yyz_0[j] - 0.5 * fl1_fx * tez_yz_yyz_1[j];

                    tex_xxyz_yzz_0[j] = pa_x[j] * tex_xyz_yzz_0[j] - pc_x[j] * tex_xyz_yzz_1[j] + 0.5 * fl1_fx * tex_yz_yzz_0[j] - 0.5 * fl1_fx * tex_yz_yzz_1[j] + ta_xyz_yzz_1[j];

                    tey_xxyz_yzz_0[j] = pa_x[j] * tey_xyz_yzz_0[j] - pc_x[j] * tey_xyz_yzz_1[j] + 0.5 * fl1_fx * tey_yz_yzz_0[j] - 0.5 * fl1_fx * tey_yz_yzz_1[j];

                    tez_xxyz_yzz_0[j] = pa_x[j] * tez_xyz_yzz_0[j] - pc_x[j] * tez_xyz_yzz_1[j] + 0.5 * fl1_fx * tez_yz_yzz_0[j] - 0.5 * fl1_fx * tez_yz_yzz_1[j];

                    tex_xxyz_zzz_0[j] = pa_x[j] * tex_xyz_zzz_0[j] - pc_x[j] * tex_xyz_zzz_1[j] + 0.5 * fl1_fx * tex_yz_zzz_0[j] - 0.5 * fl1_fx * tex_yz_zzz_1[j] + ta_xyz_zzz_1[j];

                    tey_xxyz_zzz_0[j] = pa_x[j] * tey_xyz_zzz_0[j] - pc_x[j] * tey_xyz_zzz_1[j] + 0.5 * fl1_fx * tey_yz_zzz_0[j] - 0.5 * fl1_fx * tey_yz_zzz_1[j];

                    tez_xxyz_zzz_0[j] = pa_x[j] * tez_xyz_zzz_0[j] - pc_x[j] * tez_xyz_zzz_1[j] + 0.5 * fl1_fx * tez_yz_zzz_0[j] - 0.5 * fl1_fx * tez_yz_zzz_1[j];
                }
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
            {
                ...
                for (int32_t j = 0; j < nprim; j++)
                {
                    ...
                    tex_xxzz_xxx_0[j] = pa_x[j] * tex_xzz_xxx_0[j] - pc_x[j] * tex_xzz_xxx_1[j] + 0.5 * fl1_fx * tex_zz_xxx_0[j] - 0.5 * fl1_fx * tex_zz_xxx_1[j] + 1.5 * fl1_fx * tex_xzz_xx_0[j] - 1.5 * fl1_fx * tex_xzz_xx_1[j] + ta_xzz_xxx_1[j];

                    tey_xxzz_xxx_0[j] = pa_x[j] * tey_xzz_xxx_0[j] - pc_x[j] * tey_xzz_xxx_1[j] + 0.5 * fl1_fx * tey_zz_xxx_0[j] - 0.5 * fl1_fx * tey_zz_xxx_1[j] + 1.5 * fl1_fx * tey_xzz_xx_0[j] - 1.5 * fl1_fx * tey_xzz_xx_1[j];

                    tez_xxzz_xxx_0[j] = pa_x[j] * tez_xzz_xxx_0[j] - pc_x[j] * tez_xzz_xxx_1[j] + 0.5 * fl1_fx * tez_zz_xxx_0[j] - 0.5 * fl1_fx * tez_zz_xxx_1[j] + 1.5 * fl1_fx * tez_xzz_xx_0[j] - 1.5 * fl1_fx * tez_xzz_xx_1[j];

                    tex_xxzz_xxy_0[j] = pa_x[j] * tex_xzz_xxy_0[j] - pc_x[j] * tex_xzz_xxy_1[j] + 0.5 * fl1_fx * tex_zz_xxy_0[j] - 0.5 * fl1_fx * tex_zz_xxy_1[j] + fl1_fx * tex_xzz_xy_0[j] - fl1_fx * tex_xzz_xy_1[j] + ta_xzz_xxy_1[j];

                    tey_xxzz_xxy_0[j] = pa_x[j] * tey_xzz_xxy_0[j] - pc_x[j] * tey_xzz_xxy_1[j] + 0.5 * fl1_fx * tey_zz_xxy_0[j] - 0.5 * fl1_fx * tey_zz_xxy_1[j] + fl1_fx * tey_xzz_xy_0[j] - fl1_fx * tey_xzz_xy_1[j];

                    tez_xxzz_xxy_0[j] = pa_x[j] * tez_xzz_xxy_0[j] - pc_x[j] * tez_xzz_xxy_1[j] + 0.5 * fl1_fx * tez_zz_xxy_0[j] - 0.5 * fl1_fx * tez_zz_xxy_1[j] + fl1_fx * tez_xzz_xy_0[j] - fl1_fx * tez_xzz_xy_1[j];

                    tex_xxzz_xxz_0[j] = pa_x[j] * tex_xzz_xxz_0[j] - pc_x[j] * tex_xzz_xxz_1[j] + 0.5 * fl1_fx * tex_zz_xxz_0[j] - 0.5 * fl1_fx * tex_zz_xxz_1[j] + fl1_fx * tex_xzz_xz_0[j] - fl1_fx * tex_xzz_xz_1[j] + ta_xzz_xxz_1[j];

                    tey_xxzz_xxz_0[j] = pa_x[j] * tey_xzz_xxz_0[j] - pc_x[j] * tey_xzz_xxz_1[j] + 0.5 * fl1_fx * tey_zz_xxz_0[j] - 0.5 * fl1_fx * tey_zz_xxz_1[j] + fl1_fx * tey_xzz_xz_0[j] - fl1_fx * tey_xzz_xz_1[j];

                    tez_xxzz_xxz_0[j] = pa_x[j] * tez_xzz_xxz_0[j] - pc_x[j] * tez_xzz_xxz_1[j] + 0.5 * fl1_fx * tez_zz_xxz_0[j] - 0.5 * fl1_fx * tez_zz_xxz_1[j] + fl1_fx * tez_xzz_xz_0[j] - fl1_fx * tez_xzz_xz_1[j];

                    tex_xxzz_xyy_0[j] = pa_x[j] * tex_xzz_xyy_0[j] - pc_x[j] * tex_xzz_xyy_1[j] + 0.5 * fl1_fx * tex_zz_xyy_0[j] - 0.5 * fl1_fx * tex_zz_xyy_1[j] + 0.5 * fl1_fx * tex_xzz_yy_0[j] - 0.5 * fl1_fx * tex_xzz_yy_1[j] + ta_xzz_xyy_1[j];

                    tey_xxzz_xyy_0[j] = pa_x[j] * tey_xzz_xyy_0[j] - pc_x[j] * tey_xzz_xyy_1[j] + 0.5 * fl1_fx * tey_zz_xyy_0[j] - 0.5 * fl1_fx * tey_zz_xyy_1[j] + 0.5 * fl1_fx * tey_xzz_yy_0[j] - 0.5 * fl1_fx * tey_xzz_yy_1[j];

                    tez_xxzz_xyy_0[j] = pa_x[j] * tez_xzz_xyy_0[j] - pc_x[j] * tez_xzz_xyy_1[j] + 0.5 * fl1_fx * tez_zz_xyy_0[j] - 0.5 * fl1_fx * tez_zz_xyy_1[j] + 0.5 * fl1_fx * tez_xzz_yy_0[j] - 0.5 * fl1_fx * tez_xzz_yy_1[j];

                    tex_xxzz_xyz_0[j] = pa_x[j] * tex_xzz_xyz_0[j] - pc_x[j] * tex_xzz_xyz_1[j] + 0.5 * fl1_fx * tex_zz_xyz_0[j] - 0.5 * fl1_fx * tex_zz_xyz_1[j] + 0.5 * fl1_fx * tex_xzz_yz_0[j] - 0.5 * fl1_fx * tex_xzz_yz_1[j] + ta_xzz_xyz_1[j];

                    tey_xxzz_xyz_0[j] = pa_x[j] * tey_xzz_xyz_0[j] - pc_x[j] * tey_xzz_xyz_1[j] + 0.5 * fl1_fx * tey_zz_xyz_0[j] - 0.5 * fl1_fx * tey_zz_xyz_1[j] + 0.5 * fl1_fx * tey_xzz_yz_0[j] - 0.5 * fl1_fx * tey_xzz_yz_1[j];

                    tez_xxzz_xyz_0[j] = pa_x[j] * tez_xzz_xyz_0[j] - pc_x[j] * tez_xzz_xyz_1[j] + 0.5 * fl1_fx * tez_zz_xyz_0[j] - 0.5 * fl1_fx * tez_zz_xyz_1[j] + 0.5 * fl1_fx * tez_xzz_yz_0[j] - 0.5 * fl1_fx * tez_xzz_yz_1[j];

                    tex_xxzz_xzz_0[j] = pa_x[j] * tex_xzz_xzz_0[j] - pc_x[j] * tex_xzz_xzz_1[j] + 0.5 * fl1_fx * tex_zz_xzz_0[j] - 0.5 * fl1_fx * tex_zz_xzz_1[j] + 0.5 * fl1_fx * tex_xzz_zz_0[j] - 0.5 * fl1_fx * tex_xzz_zz_1[j] + ta_xzz_xzz_1[j];

                    tey_xxzz_xzz_0[j] = pa_x[j] * tey_xzz_xzz_0[j] - pc_x[j] * tey_xzz_xzz_1[j] + 0.5 * fl1_fx * tey_zz_xzz_0[j] - 0.5 * fl1_fx * tey_zz_xzz_1[j] + 0.5 * fl1_fx * tey_xzz_zz_0[j] - 0.5 * fl1_fx * tey_xzz_zz_1[j];

                    tez_xxzz_xzz_0[j] = pa_x[j] * tez_xzz_xzz_0[j] - pc_x[j] * tez_xzz_xzz_1[j] + 0.5 * fl1_fx * tez_zz_xzz_0[j] - 0.5 * fl1_fx * tez_zz_xzz_1[j] + 0.5 * fl1_fx * tez_xzz_zz_0[j] - 0.5 * fl1_fx * tez_xzz_zz_1[j];

                    tex_xxzz_yyy_0[j] = pa_x[j] * tex_xzz_yyy_0[j] - pc_x[j] * tex_xzz_yyy_1[j] + 0.5 * fl1_fx * tex_zz_yyy_0[j] - 0.5 * fl1_fx * tex_zz_yyy_1[j] + ta_xzz_yyy_1[j];

                    tey_xxzz_yyy_0[j] = pa_x[j] * tey_xzz_yyy_0[j] - pc_x[j] * tey_xzz_yyy_1[j] + 0.5 * fl1_fx * tey_zz_yyy_0[j] - 0.5 * fl1_fx * tey_zz_yyy_1[j];

                    tez_xxzz_yyy_0[j] = pa_x[j] * tez_xzz_yyy_0[j] - pc_x[j] * tez_xzz_yyy_1[j] + 0.5 * fl1_fx * tez_zz_yyy_0[j] - 0.5 * fl1_fx * tez_zz_yyy_1[j];

                    tex_xxzz_yyz_0[j] = pa_x[j] * tex_xzz_yyz_0[j] - pc_x[j] * tex_xzz_yyz_1[j] + 0.5 * fl1_fx * tex_zz_yyz_0[j] - 0.5 * fl1_fx * tex_zz_yyz_1[j] + ta_xzz_yyz_1[j];

                    tey_xxzz_yyz_0[j] = pa_x[j] * tey_xzz_yyz_0[j] - pc_x[j] * tey_xzz_yyz_1[j] + 0.5 * fl1_fx * tey_zz_yyz_0[j] - 0.5 * fl1_fx * tey_zz_yyz_1[j];

                    tez_xxzz_yyz_0[j] = pa_x[j] * tez_xzz_yyz_0[j] - pc_x[j] * tez_xzz_yyz_1[j] + 0.5 * fl1_fx * tez_zz_yyz_0[j] - 0.5 * fl1_fx * tez_zz_yyz_1[j];

                    tex_xxzz_yzz_0[j] = pa_x[j] * tex_xzz_yzz_0[j] - pc_x[j] * tex_xzz_yzz_1[j] + 0.5 * fl1_fx * tex_zz_yzz_0[j] - 0.5 * fl1_fx * tex_zz_yzz_1[j] + ta_xzz_yzz_1[j];

                    tey_xxzz_yzz_0[j] = pa_x[j] * tey_xzz_yzz_0[j] - pc_x[j] * tey_xzz_yzz_1[j] + 0.5 * fl1_fx * tey_zz_yzz_0[j] - 0.5 * fl1_fx * tey_zz_yzz_1[j];

                    tez_xxzz_yzz_0[j] = pa_x[j] * tez_xzz_yzz_0[j] - pc_x[j] * tez_xzz_yzz_1[j] + 0.5 * fl1_fx * tez_zz_yzz_0[j] - 0.5 * fl1_fx * tez_zz_yzz_1[j];

                    tex_xxzz_zzz_0[j] = pa_x[j] * tex_xzz_zzz_0[j] - pc_x[j] * tex_xzz_zzz_1[j] + 0.5 * fl1_fx * tex_zz_zzz_0[j] - 0.5 * fl1_fx * tex_zz_zzz_1[j] + ta_xzz_zzz_1[j];

                    tey_xxzz_zzz_0[j] = pa_x[j] * tey_xzz_zzz_0[j] - pc_x[j] * tey_xzz_zzz_1[j] + 0.5 * fl1_fx * tey_zz_zzz_0[j] - 0.5 * fl1_fx * tey_zz_zzz_1[j];

                    tez_xxzz_zzz_0[j] = pa_x[j] * tez_xzz_zzz_0[j] - pc_x[j] * tez_xzz_zzz_1[j] + 0.5 * fl1_fx * tez_zz_zzz_0[j] - 0.5 * fl1_fx * tez_zz_zzz_1[j];

                    tex_xyyy_xxx_0[j] = pa_x[j] * tex_yyy_xxx_0[j] - pc_x[j] * tex_yyy_xxx_1[j] + 1.5 * fl1_fx * tex_yyy_xx_0[j] - 1.5 * fl1_fx * tex_yyy_xx_1[j] + ta_yyy_xxx_1[j];

                    tey_xyyy_xxx_0[j] = pa_x[j] * tey_yyy_xxx_0[j] - pc_x[j] * tey_yyy_xxx_1[j] + 1.5 * fl1_fx * tey_yyy_xx_0[j] - 1.5 * fl1_fx * tey_yyy_xx_1[j];

                    tez_xyyy_xxx_0[j] = pa_x[j] * tez_yyy_xxx_0[j] - pc_x[j] * tez_yyy_xxx_1[j] + 1.5 * fl1_fx * tez_yyy_xx_0[j] - 1.5 * fl1_fx * tez_yyy_xx_1[j];

                    tex_xyyy_xxy_0[j] = pa_x[j] * tex_yyy_xxy_0[j] - pc_x[j] * tex_yyy_xxy_1[j] + fl1_fx * tex_yyy_xy_0[j] - fl1_fx * tex_yyy_xy_1[j] + ta_yyy_xxy_1[j];
                    ...
                    tex_xyyy_xxz_0[j] = pa_x[j] * tex_yyy_xxz_0[j] - pc_x[j] * tex_yyy_xxz_1[j] + fl1_fx * tex_yyy_xz_0[j] - fl1_fx * tex_yyy_xz_1[j] + ta_yyy_xxz_1[j];
                    ...
                    tex_xyyy_xyy_0[j] = pa_x[j] * tex_yyy_xyy_0[j] - pc_x[j] * tex_yyy_xyy_1[j] + 0.5 * fl1_fx * tex_yyy_yy_0[j] - 0.5 * fl1_fx * tex_yyy_yy_1[j] + ta_yyy_xyy_1[j];

                    tey_xyyy_xyy_0[j] = pa_x[j] * tey_yyy_xyy_0[j] - pc_x[j] * tey_yyy_xyy_1[j] + 0.5 * fl1_fx * tey_yyy_yy_0[j] - 0.5 * fl1_fx * tey_yyy_yy_1[j];

                    tez_xyyy_xyy_0[j] = pa_x[j] * tez_yyy_xyy_0[j] - pc_x[j] * tez_yyy_xyy_1[j] + 0.5 * fl1_fx * tez_yyy_yy_0[j] - 0.5 * fl1_fx * tez_yyy_yy_1[j];

                    tex_xyyy_xyz_0[j] = pa_x[j] * tex_yyy_xyz_0[j] - pc_x[j] * tex_yyy_xyz_1[j] + 0.5 * fl1_fx * tex_yyy_yz_0[j] - 0.5 * fl1_fx * tex_yyy_yz_1[j] + ta_yyy_xyz_1[j];

                    tey_xyyy_xyz_0[j] = pa_x[j] * tey_yyy_xyz_0[j] - pc_x[j] * tey_yyy_xyz_1[j] + 0.5 * fl1_fx * tey_yyy_yz_0[j] - 0.5 * fl1_fx * tey_yyy_yz_1[j];

                    tez_xyyy_xyz_0[j] = pa_x[j] * tez_yyy_xyz_0[j] - pc_x[j] * tez_yyy_xyz_1[j] + 0.5 * fl1_fx * tez_yyy_yz_0[j] - 0.5 * fl1_fx * tez_yyy_yz_1[j];

                    tex_xyyy_xzz_0[j] = pa_x[j] * tex_yyy_xzz_0[j] - pc_x[j] * tex_yyy_xzz_1[j] + 0.5 * fl1_fx * tex_yyy_zz_0[j] - 0.5 * fl1_fx * tex_yyy_zz_1[j] + ta_yyy_xzz_1[j];

                    tey_xyyy_xzz_0[j] = pa_x[j] * tey_yyy_xzz_0[j] - pc_x[j] * tey_yyy_xzz_1[j] + 0.5 * fl1_fx * tey_yyy_zz_0[j] - 0.5 * fl1_fx * tey_yyy_zz_1[j];

                    tez_xyyy_xzz_0[j] = pa_x[j] * tez_yyy_xzz_0[j] - pc_x[j] * tez_yyy_xzz_1[j] + 0.5 * fl1_fx * tez_yyy_zz_0[j] - 0.5 * fl1_fx * tez_yyy_zz_1[j];
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
            {
                ...
                for (int32_t j = 0; j < nprim; j++)
                {
                    ...
                    tex_xyyz_xxx_0[j] = pa_x[j] * tex_yyz_xxx_0[j] - pc_x[j] * tex_yyz_xxx_1[j] + 1.5 * fl1_fx * tex_yyz_xx_0[j] - 1.5 * fl1_fx * tex_yyz_xx_1[j] + ta_yyz_xxx_1[j];

                    tey_xyyz_xxx_0[j] = pa_x[j] * tey_yyz_xxx_0[j] - pc_x[j] * tey_yyz_xxx_1[j] + 1.5 * fl1_fx * tey_yyz_xx_0[j] - 1.5 * fl1_fx * tey_yyz_xx_1[j];

                    tez_xyyz_xxx_0[j] = pa_x[j] * tez_yyz_xxx_0[j] - pc_x[j] * tez_yyz_xxx_1[j] + 1.5 * fl1_fx * tez_yyz_xx_0[j] - 1.5 * fl1_fx * tez_yyz_xx_1[j];

                    tex_xyyz_xxy_0[j] = pa_x[j] * tex_yyz_xxy_0[j] - pc_x[j] * tex_yyz_xxy_1[j] + fl1_fx * tex_yyz_xy_0[j] - fl1_fx * tex_yyz_xy_1[j] + ta_yyz_xxy_1[j];
                    ...
                    tex_xyyz_xxz_0[j] = pa_x[j] * tex_yyz_xxz_0[j] - pc_x[j] * tex_yyz_xxz_1[j] + fl1_fx * tex_yyz_xz_0[j] - fl1_fx * tex_yyz_xz_1[j] + ta_yyz_xxz_1[j];
                    ...
                    tex_xyyz_xyy_0[j] = pa_x[j] * tex_yyz_xyy_0[j] - pc_x[j] * tex_yyz_xyy_1[j] + 0.5 * fl1_fx * tex_yyz_yy_0[j] - 0.5 * fl1_fx * tex_yyz_yy_1[j] + ta_yyz_xyy_1[j];

                    tey_xyyz_xyy_0[j] = pa_x[j] * tey_yyz_xyy_0[j] - pc_x[j] * tey_yyz_xyy_1[j] + 0.5 * fl1_fx * tey_yyz_yy_0[j] - 0.5 * fl1_fx * tey_yyz_yy_1[j];

                    tez_xyyz_xyy_0[j] = pa_x[j] * tez_yyz_xyy_0[j] - pc_x[j] * tez_yyz_xyy_1[j] + 0.5 * fl1_fx * tez_yyz_yy_0[j] - 0.5 * fl1_fx * tez_yyz_yy_1[j];

                    tex_xyyz_xyz_0[j] = pa_x[j] * tex_yyz_xyz_0[j] - pc_x[j] * tex_yyz_xyz_1[j] + 0.5 * fl1_fx * tex_yyz_yz_0[j] - 0.5 * fl1_fx * tex_yyz_yz_1[j] + ta_yyz_xyz_1[j];

                    tey_xyyz_xyz_0[j] = pa_x[j] * tey_yyz_xyz_0[j] - pc_x[j] * tey_yyz_xyz_1[j] + 0.5 * fl1_fx * tey_yyz_yz_0[j] - 0.5 * fl1_fx * tey_yyz_yz_1[j];

                    tez_xyyz_xyz_0[j] = pa_x[j] * tez_yyz_xyz_0[j] - pc_x[j] * tez_yyz_xyz_1[j] + 0.5 * fl1_fx * tez_yyz_yz_0[j] - 0.5 * fl1_fx * tez_yyz_yz_1[j];

                    tex_xyyz_xzz_0[j] = pa_x[j] * tex_yyz_xzz_0[j] - pc_x[j] * tex_yyz_xzz_1[j] + 0.5 * fl1_fx * tex_yyz_zz_0[j] - 0.5 * fl1_fx * tex_yyz_zz_1[j] + ta_yyz_xzz_1[j];

                    tey_xyyz_xzz_0[j] = pa_x[j] * tey_yyz_xzz_0[j] - pc_x[j] * tey_yyz_xzz_1[j] + 0.5 * fl1_fx * tey_yyz_zz_0[j] - 0.5 * fl1_fx * tey_yyz_zz_1[j];

                    tez_xyyz_xzz_0[j] = pa_x[j] * tez_yyz_xzz_0[j] - pc_x[j] * tez_yyz_xzz_1[j] + 0.5 * fl1_fx * tez_yyz_zz_0[j] - 0.5 * fl1_fx * tez_yyz_zz_1[j];
                    ...
                    tex_xyzz_xxx_0[j] = pa_x[j] * tex_yzz_xxx_0[j] - pc_x[j] * tex_yzz_xxx_1[j] + 1.5 * fl1_fx * tex_yzz_xx_0[j] - 1.5 * fl1_fx * tex_yzz_xx_1[j] + ta_yzz_xxx_1[j];

                    tey_xyzz_xxx_0[j] = pa_x[j] * tey_yzz_xxx_0[j] - pc_x[j] * tey_yzz_xxx_1[j] + 1.5 * fl1_fx * tey_yzz_xx_0[j] - 1.5 * fl1_fx * tey_yzz_xx_1[j];

                    tez_xyzz_xxx_0[j] = pa_x[j] * tez_yzz_xxx_0[j] - pc_x[j] * tez_yzz_xxx_1[j] + 1.5 * fl1_fx * tez_yzz_xx_0[j] - 1.5 * fl1_fx * tez_yzz_xx_1[j];

                    tex_xyzz_xxy_0[j] = pa_x[j] * tex_yzz_xxy_0[j] - pc_x[j] * tex_yzz_xxy_1[j] + fl1_fx * tex_yzz_xy_0[j] - fl1_fx * tex_yzz_xy_1[j] + ta_yzz_xxy_1[j];
                    ...
                    tex_xyzz_xxz_0[j] = pa_x[j] * tex_yzz_xxz_0[j] - pc_x[j] * tex_yzz_xxz_1[j] + fl1_fx * tex_yzz_xz_0[j] - fl1_fx * tex_yzz_xz_1[j] + ta_yzz_xxz_1[j];
                    ...
                    tex_xyzz_xyy_0[j] = pa_x[j] * tex_yzz_xyy_0[j] - pc_x[j] * tex_yzz_xyy_1[j] + 0.5 * fl1_fx * tex_yzz_yy_0[j] - 0.5 * fl1_fx * tex_yzz_yy_1[j] + ta_yzz_xyy_1[j];
                }
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
            {
                ...
                for (int32_t j = 0; j < nprim; j++)
                {
                    ...
                    tey_xyzz_xyy_0[j] = pa_x[j] * tey_yzz_xyy_0[j] - pc_x[j] * tey_yzz_xyy_1[j] + 0.5 * fl1_fx * tey_yzz_yy_0[j] - 0.5 * fl1_fx * tey_yzz_yy_1[j];

                    tez_xyzz_xyy_0[j] = pa_x[j] * tez_yzz_xyy_0[j] - pc_x[j] * tez_yzz_xyy_1[j] + 0.5 * fl1_fx * tez_yzz_yy_0[j] - 0.5 * fl1_fx * tez_yzz_yy_1[j];

                    tex_xyzz_xyz_0[j] = pa_x[j] * tex_yzz_xyz_0[j] - pc_x[j] * tex_yzz_xyz_1[j] + 0.5 * fl1_fx * tex_yzz_yz_0[j] - 0.5 * fl1_fx * tex_yzz_yz_1[j] + ta_yzz_xyz_1[j];

                    tey_xyzz_xyz_0[j] = pa_x[j] * tey_yzz_xyz_0[j] - pc_x[j] * tey_yzz_xyz_1[j] + 0.5 * fl1_fx * tey_yzz_yz_0[j] - 0.5 * fl1_fx * tey_yzz_yz_1[j];

                    tez_xyzz_xyz_0[j] = pa_x[j] * tez_yzz_xyz_0[j] - pc_x[j] * tez_yzz_xyz_1[j] + 0.5 * fl1_fx * tez_yzz_yz_0[j] - 0.5 * fl1_fx * tez_yzz_yz_1[j];

                    tex_xyzz_xzz_0[j] = pa_x[j] * tex_yzz_xzz_0[j] - pc_x[j] * tex_yzz_xzz_1[j] + 0.5 * fl1_fx * tex_yzz_zz_0[j] - 0.5 * fl1_fx * tex_yzz_zz_1[j] + ta_yzz_xzz_1[j];

                    tey_xyzz_xzz_0[j] = pa_x[j] * tey_yzz_xzz_0[j] - pc_x[j] * tey_yzz_xzz_1[j] + 0.5 * fl1_fx * tey_yzz_zz_0[j] - 0.5 * fl1_fx * tey_yzz_zz_1[j];

                    tez_xyzz_xzz_0[j] = pa_x[j] * tez_yzz_xzz_0[j] - pc_x[j] * tez_yzz_xzz_1[j] + 0.5 * fl1_fx * tez_yzz_zz_0[j] - 0.5 * fl1_fx * tez_yzz_zz_1[j];
                    ...
                    tex_xzzz_xxx_0[j] = pa_x[j] * tex_zzz_xxx_0[j] - pc_x[j] * tex_zzz_xxx_1[j] + 1.5 * fl1_fx * tex_zzz_xx_0[j] - 1.5 * fl1_fx * tex_zzz_xx_1[j] + ta_zzz_xxx_1[j];

                    tey_xzzz_xxx_0[j] = pa_x[j] * tey_zzz_xxx_0[j] - pc_x[j] * tey_zzz_xxx_1[j] + 1.5 * fl1_fx * tey_zzz_xx_0[j] - 1.5 * fl1_fx * tey_zzz_xx_1[j];

                    tez_xzzz_xxx_0[j] = pa_x[j] * tez_zzz_xxx_0[j] - pc_x[j] * tez_zzz_xxx_1[j] + 1.5 * fl1_fx * tez_zzz_xx_0[j] - 1.5 * fl1_fx * tez_zzz_xx_1[j];

                    tex_xzzz_xxy_0[j] = pa_x[j] * tex_zzz_xxy_0[j] - pc_x[j] * tex_zzz_xxy_1[j] + fl1_fx * tex_zzz_xy_0[j] - fl1_fx * tex_zzz_xy_1[j] + ta_zzz_xxy_1[j];
                    ...
                    tex_xzzz_xxz_0[j] = pa_x[j] * tex_zzz_xxz_0[j] - pc_x[j] * tex_zzz_xxz_1[j] + fl1_fx * tex_zzz_xz_0[j] - fl1_fx * tex_zzz_xz_1[j] + ta_zzz_xxz_1[j];
                    ...
                    tex_xzzz_xyy_0[j] = pa_x[j] * tex_zzz_xyy_0[j] - pc_x[j] * tex_zzz_xyy_1[j] + 0.5 * fl1_fx * tex_zzz_yy_0[j] - 0.5 * fl1_fx * tex_zzz_yy_1[j] + ta_zzz_xyy_1[j];

                    tey_xzzz_xyy_0[j] = pa_x[j] * tey_zzz_xyy_0[j] - pc_x[j] * tey_zzz_xyy_1[j] + 0.5 * fl1_fx * tey_zzz_yy_0[j] - 0.5 * fl1_fx * tey_zzz_yy_1[j];

                    tez_xzzz_xyy_0[j] = pa_x[j] * tez_zzz_xyy_0[j] - pc_x[j] * tez_zzz_xyy_1[j] + 0.5 * fl1_fx * tez_zzz_yy_0[j] - 0.5 * fl1_fx * tez_zzz_yy_1[j];

                    tex_xzzz_xyz_0[j] = pa_x[j] * tex_zzz_xyz_0[j] - pc_x[j] * tex_zzz_xyz_1[j] + 0.5 * fl1_fx * tex_zzz_yz_0[j] - 0.5 * fl1_fx * tex_zzz_yz_1[j] + ta_zzz_xyz_1[j];

                    tey_xzzz_xyz_0[j] = pa_x[j] * tey_zzz_xyz_0[j] - pc_x[j] * tey_zzz_xyz_1[j] + 0.5 * fl1_fx * tey_zzz_yz_0[j] - 0.5 * fl1_fx * tey_zzz_yz_1[j];

                    tez_xzzz_xyz_0[j] = pa_x[j] * tez_zzz_xyz_0[j] - pc_x[j] * tez_zzz_xyz_1[j] + 0.5 * fl1_fx * tez_zzz_yz_0[j] - 0.5 * fl1_fx * tez_zzz_yz_1[j];

                    tex_xzzz_xzz_0[j] = pa_x[j] * tex_zzz_xzz_0[j] - pc_x[j] * tex_zzz_xzz_1[j] + 0.5 * fl1_fx * tex_zzz_zz_0[j] - 0.5 * fl1_fx * tex_zzz_zz_1[j] + ta_zzz_xzz_1[j];

                    tey_xzzz_xzz_0[j] = pa_x[j] * tey_zzz_xzz_0[j] - pc_x[j] * tey_zzz_xzz_1[j] + 0.5 * fl1_fx * tey_zzz_zz_0[j] - 0.5 * fl1_fx * tey_zzz_zz_1[j];

                    tez_xzzz_xzz_0[j] = pa_x[j] * tez_zzz_xzz_0[j] - pc_x[j] * tez_zzz_xzz_1[j] + 0.5 * fl1_fx * tez_zzz_zz_0[j] - 0.5 * fl1_fx * tez_zzz_zz_1[j];
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
            {
                ...
                for (int32_t j = 0; j < nprim; j++)
                {
                    ...
                    tex_yyyy_xxx_0[j] = pa_y[j] * tex_yyy_xxx_0[j] - pc_y[j] * tex_yyy_xxx_1[j] + 1.5 * fl1_fx * tex_yy_xxx_0[j] - 1.5 * fl1_fx * tex_yy_xxx_1[j];

                    tey_yyyy_xxx_0[j] = pa_y[j] * tey_yyy_xxx_0[j] - pc_y[j] * tey_yyy_xxx_1[j] + 1.5 * fl1_fx * tey_yy_xxx_0[j] - 1.5 * fl1_fx * tey_yy_xxx_1[j] + ta_yyy_xxx_1[j];

                    tez_yyyy_xxx_0[j] = pa_y[j] * tez_yyy_xxx_0[j] - pc_y[j] * tez_yyy_xxx_1[j] + 1.5 * fl1_fx * tez_yy_xxx_0[j] - 1.5 * fl1_fx * tez_yy_xxx_1[j];

                    tex_yyyy_xxy_0[j] = pa_y[j] * tex_yyy_xxy_0[j] - pc_y[j] * tex_yyy_xxy_1[j] + 1.5 * fl1_fx * tex_yy_xxy_0[j] - 1.5 * fl1_fx * tex_yy_xxy_1[j] + 0.5 * fl1_fx * tex_yyy_xx_0[j] - 0.5 * fl1_fx * tex_yyy_xx_1[j];

                    tey_yyyy_xxy_0[j] = pa_y[j] * tey_yyy_xxy_0[j] - pc_y[j] * tey_yyy_xxy_1[j] + 1.5 * fl1_fx * tey_yy_xxy_0[j] - 1.5 * fl1_fx * tey_yy_xxy_1[j] + 0.5 * fl1_fx * tey_yyy_xx_0[j] - 0.5 * fl1_fx * tey_yyy_xx_1[j] + ta_yyy_xxy_1[j];

                    tez_yyyy_xxy_0[j] = pa_y[j] * tez_yyy_xxy_0[j] - pc_y[j] * tez_yyy_xxy_1[j] + 1.5 * fl1_fx * tez_yy_xxy_0[j] - 1.5 * fl1_fx * tez_yy_xxy_1[j] + 0.5 * fl1_fx * tez_yyy_xx_0[j] - 0.5 * fl1_fx * tez_yyy_xx_1[j];

                    tex_yyyy_xxz_0[j] = pa_y[j] * tex_yyy_xxz_0[j] - pc_y[j] * tex_yyy_xxz_1[j] + 1.5 * fl1_fx * tex_yy_xxz_0[j] - 1.5 * fl1_fx * tex_yy_xxz_1[j];

                    tey_yyyy_xxz_0[j] = pa_y[j] * tey_yyy_xxz_0[j] - pc_y[j] * tey_yyy_xxz_1[j] + 1.5 * fl1_fx * tey_yy_xxz_0[j] - 1.5 * fl1_fx * tey_yy_xxz_1[j] + ta_yyy_xxz_1[j];

                    tez_yyyy_xxz_0[j] = pa_y[j] * tez_yyy_xxz_0[j] - pc_y[j] * tez_yyy_xxz_1[j] + 1.5 * fl1_fx * tez_yy_xxz_0[j] - 1.5 * fl1_fx * tez_yy_xxz_1[j];

                    tex_yyyy_xyy_0[j] = pa_y[j] * tex_yyy_xyy_0[j] - pc_y[j] * tex_yyy_xyy_1[j] + 1.5 * fl1_fx * tex_yy_xyy_0[j] - 1.5 * fl1_fx * tex_yy_xyy_1[j] + fl1_fx * tex_yyy_xy_0[j] - fl1_fx * tex_yyy_xy_1[j];

                    tey_yyyy_xyy_0[j] = pa_y[j] * tey_yyy_xyy_0[j] - pc_y[j] * tey_yyy_xyy_1[j] + 1.5 * fl1_fx * tey_yy_xyy_0[j] - 1.5 * fl1_fx * tey_yy_xyy_1[j] + fl1_fx * tey_yyy_xy_0[j] - fl1_fx * tey_yyy_xy_1[j] + ta_yyy_xyy_1[j];

                    tez_yyyy_xyy_0[j] = pa_y[j] * tez_yyy_xyy_0[j] - pc_y[j] * tez_yyy_xyy_1[j] + 1.5 * fl1_fx * tez_yy_xyy_0[j] - 1.5 * fl1_fx * tez_yy_xyy_1[j] + fl1_fx * tez_yyy_xy_0[j] - fl1_fx * tez_yyy_xy_1[j];

                    tex_yyyy_xyz_0[j] = pa_y[j] * tex_yyy_xyz_0[j] - pc_y[j] * tex_yyy_xyz_1[j] + 1.5 * fl1_fx * tex_yy_xyz_0[j] - 1.5 * fl1_fx * tex_yy_xyz_1[j] + 0.5 * fl1_fx * tex_yyy_xz_0[j] - 0.5 * fl1_fx * tex_yyy_xz_1[j];

                    tey_yyyy_xyz_0[j] = pa_y[j] * tey_yyy_xyz_0[j] - pc_y[j] * tey_yyy_xyz_1[j] + 1.5 * fl1_fx * tey_yy_xyz_0[j] - 1.5 * fl1_fx * tey_yy_xyz_1[j] + 0.5 * fl1_fx * tey_yyy_xz_0[j] - 0.5 * fl1_fx * tey_yyy_xz_1[j] + ta_yyy_xyz_1[j];

                    tez_yyyy_xyz_0[j] = pa_y[j] * tez_yyy_xyz_0[j] - pc_y[j] * tez_yyy_xyz_1[j] + 1.5 * fl1_fx * tez_yy_xyz_0[j] - 1.5 * fl1_fx * tez_yy_xyz_1[j] + 0.5 * fl1_fx * tez_yyy_xz_0[j] - 0.5 * fl1_fx * tez_yyy_xz_1[j];

                    tex_yyyy_xzz_0[j] = pa_y[j] * tex_yyy_xzz_0[j] - pc_y[j] * tex_yyy_xzz_1[j] + 1.5 * fl1_fx * tex_yy_xzz_0[j] - 1.5 * fl1_fx * tex_yy_xzz_1[j];

                    tey_yyyy_xzz_0[j] = pa_y[j] * tey_yyy_xzz_0[j] - pc_y[j] * tey_yyy_xzz_1[j] + 1.5 * fl1_fx * tey_yy_xzz_0[j] - 1.5 * fl1_fx * tey_yy_xzz_1[j] + ta_yyy_xzz_1[j];

                    tez_yyyy_xzz_0[j] = pa_y[j] * tez_yyy_xzz_0[j] - pc_y[j] * tez_yyy_xzz_1[j] + 1.5 * fl1_fx * tez_yy_xzz_0[j] - 1.5 * fl1_fx * tez_yy_xzz_1[j];

                    tex_yyyy_yyy_0[j] = pa_y[j] * tex_yyy_yyy_0[j] - pc_y[j] * tex_yyy_yyy_1[j] + 1.5 * fl1_fx * tex_yy_yyy_0[j] - 1.5 * fl1_fx * tex_yy_yyy_1[j] + 1.5 * fl1_fx * tex_yyy_yy_0[j] - 1.5 * fl1_fx * tex_yyy_yy_1[j];

                    tey_yyyy_yyy_0[j] = pa_y[j] * tey_yyy_yyy_0[j] - pc_y[j] * tey_yyy_yyy_1[j] + 1.5 * fl1_fx * tey_yy_yyy_0[j] - 1.5 * fl1_fx * tey_yy_yyy_1[j] + 1.5 * fl1_fx * tey_yyy_yy_0[j] - 1.5 * fl1_fx * tey_yyy_yy_1[j] + ta_yyy_yyy_1[j];

                    tez_yyyy_yyy_0[j] = pa_y[j] * tez_yyy_yyy_0[j] - pc_y[j] * tez_yyy_yyy_1[j] + 1.5 * fl1_fx * tez_yy_yyy_0[j] - 1.5 * fl1_fx * tez_yy_yyy_1[j] + 1.5 * fl1_fx * tez_yyy_yy_0[j] - 1.5 * fl1_fx * tez_yyy_yy_1[j];

                    tex_yyyy_yyz_0[j] = pa_y[j] * tex_yyy_yyz_0[j] - pc_y[j] * tex_yyy_yyz_1[j] + 1.5 * fl1_fx * tex_yy_yyz_0[j] - 1.5 * fl1_fx * tex_yy_yyz_1[j] + fl1_fx * tex_yyy_yz_0[j] - fl1_fx * tex_yyy_yz_1[j];

                    tey_yyyy_yyz_0[j] = pa_y[j] * tey_yyy_yyz_0[j] - pc_y[j] * tey_yyy_yyz_1[j] + 1.5 * fl1_fx * tey_yy_yyz_0[j] - 1.5 * fl1_fx * tey_yy_yyz_1[j] + fl1_fx * tey_yyy_yz_0[j] - fl1_fx * tey_yyy_yz_1[j] + ta_yyy_yyz_1[j];

                    tez_yyyy_yyz_0[j] = pa_y[j] * tez_yyy_yyz_0[j] - pc_y[j] * tez_yyy_yyz_1[j] + 1.5 * fl1_fx * tez_yy_yyz_0[j] - 1.5 * fl1_fx * tez_yy_yyz_1[j] + fl1_fx * tez_yyy_yz_0[j] - fl1_fx * tez_yyy_yz_1[j];

                    tex_yyyy_yzz_0[j] = pa_y[j] * tex_yyy_yzz_0[j] - pc_y[j] * tex_yyy_yzz_1[j] + 1.5 * fl1_fx * tex_yy_yzz_0[j] - 1.5 * fl1_fx * tex_yy_yzz_1[j] + 0.5 * fl1_fx * tex_yyy_zz_0[j] - 0.5 * fl1_fx * tex_yyy_zz_1[j];

                    tey_yyyy_yzz_0[j] = pa_y[j] * tey_yyy_yzz_0[j] - pc_y[j] * tey_yyy_yzz_1[j] + 1.5 * fl1_fx * tey_yy_yzz_0[j] - 1.5 * fl1_fx * tey_yy_yzz_1[j] + 0.5 * fl1_fx * tey_yyy_zz_0[j] - 0.5 * fl1_fx * tey_yyy_zz_1[j] + ta_yyy_yzz_1[j];

                    tez_yyyy_yzz_0[j] = pa_y[j] * tez_yyy_yzz_0[j] - pc_y[j] * tez_yyy_yzz_1[j] + 1.5 * fl1_fx * tez_yy_yzz_0[j] - 1.5 * fl1_fx * tez_yy_yzz_1[j] + 0.5 * fl1_fx * tez_yyy_zz_0[j] - 0.5 * fl1_fx * tez_yyy_zz_1[j];

                    tex_yyyy_zzz_0[j] = pa_y[j] * tex_yyy_zzz_0[j] - pc_y[j] * tex_yyy_zzz_1[j] + 1.5 * fl1_fx * tex_yy_zzz_0[j] - 1.5 * fl1_fx * tex_yy_zzz_1[j];

                    tey_yyyy_zzz_0[j] = pa_y[j] * tey_yyy_zzz_0[j] - pc_y[j] * tey_yyy_zzz_1[j] + 1.5 * fl1_fx * tey_yy_zzz_0[j] - 1.5 * fl1_fx * tey_yy_zzz_1[j] + ta_yyy_zzz_1[j];

                    tez_yyyy_zzz_0[j] = pa_y[j] * tez_yyy_zzz_0[j] - pc_y[j] * tez_yyy_zzz_1[j] + 1.5 * fl1_fx * tez_yy_zzz_0[j] - 1.5 * fl1_fx * tez_yy_zzz_1[j];

                    tex_yyyz_xxx_0[j] = pa_y[j] * tex_yyz_xxx_0[j] - pc_y[j] * tex_yyz_xxx_1[j] + fl1_fx * tex_yz_xxx_0[j] - fl1_fx * tex_yz_xxx_1[j];

                    tey_yyyz_xxx_0[j] = pa_y[j] * tey_yyz_xxx_0[j] - pc_y[j] * tey_yyz_xxx_1[j] + fl1_fx * tey_yz_xxx_0[j] - fl1_fx * tey_yz_xxx_1[j] + ta_yyz_xxx_1[j];

                    tez_yyyz_xxx_0[j] = pa_y[j] * tez_yyz_xxx_0[j] - pc_y[j] * tez_yyz_xxx_1[j] + fl1_fx * tez_yz_xxx_0[j] - fl1_fx * tez_yz_xxx_1[j];

                    tex_yyyz_xxy_0[j] = pa_y[j] * tex_yyz_xxy_0[j] - pc_y[j] * tex_yyz_xxy_1[j] + fl1_fx * tex_yz_xxy_0[j] - fl1_fx * tex_yz_xxy_1[j] + 0.5 * fl1_fx * tex_yyz_xx_0[j] - 0.5 * fl1_fx * tex_yyz_xx_1[j];

                    tey_yyyz_xxy_0[j] = pa_y[j] * tey_yyz_xxy_0[j] - pc_y[j] * tey_yyz_xxy_1[j] + fl1_fx * tey_yz_xxy_0[j] - fl1_fx * tey_yz_xxy_1[j] + 0.5 * fl1_fx * tey_yyz_xx_0[j] - 0.5 * fl1_fx * tey_yyz_xx_1[j] + ta_yyz_xxy_1[j];

                    tez_yyyz_xxy_0[j] = pa_y[j] * tez_yyz_xxy_0[j] - pc_y[j] * tez_yyz_xxy_1[j] + fl1_fx * tez_yz_xxy_0[j] - fl1_fx * tez_yz_xxy_1[j] + 0.5 * fl1_fx * tez_yyz_xx_0[j] - 0.5 * fl1_fx * tez_yyz_xx_1[j];

                    tex_yyyz_xxz_0[j] = pa_y[j] * tex_yyz_xxz_0[j] - pc_y[j] * tex_yyz_xxz_1[j] + fl1_fx * tex_yz_xxz_0[j] - fl1_fx * tex_yz_xxz_1[j];

                    tey_yyyz_xxz_0[j] = pa_y[j] * tey_yyz_xxz_0[j] - pc_y[j] * tey_yyz_xxz_1[j] + fl1_fx * tey_yz_xxz_0[j] - fl1_fx * tey_yz_xxz_1[j] + ta_yyz_xxz_1[j];

                    tez_yyyz_xxz_0[j] = pa_y[j] * tez_yyz_xxz_0[j] - pc_y[j] * tez_yyz_xxz_1[j] + fl1_fx * tez_yz_xxz_0[j] - fl1_fx * tez_yz_xxz_1[j];

                    tex_yyyz_xyy_0[j] = pa_y[j] * tex_yyz_xyy_0[j] - pc_y[j] * tex_yyz_xyy_1[j] + fl1_fx * tex_yz_xyy_0[j] - fl1_fx * tex_yz_xyy_1[j] + fl1_fx * tex_yyz_xy_0[j] - fl1_fx * tex_yyz_xy_1[j];

                    tey_yyyz_xyy_0[j] = pa_y[j] * tey_yyz_xyy_0[j] - pc_y[j] * tey_yyz_xyy_1[j] + fl1_fx * tey_yz_xyy_0[j] - fl1_fx * tey_yz_xyy_1[j] + fl1_fx * tey_yyz_xy_0[j] - fl1_fx * tey_yyz_xy_1[j] + ta_yyz_xyy_1[j];

                    tez_yyyz_xyy_0[j] = pa_y[j] * tez_yyz_xyy_0[j] - pc_y[j] * tez_yyz_xyy_1[j] + fl1_fx * tez_yz_xyy_0[j] - fl1_fx * tez_yz_xyy_1[j] + fl1_fx * tez_yyz_xy_0[j] - fl1_fx * tez_yyz_xy_1[j];

                    tex_yyyz_xyz_0[j] = pa_y[j] * tex_yyz_xyz_0[j] - pc_y[j] * tex_yyz_xyz_1[j] + fl1_fx * tex_yz_xyz_0[j] - fl1_fx * tex_yz_xyz_1[j] + 0.5 * fl1_fx * tex_yyz_xz_0[j] - 0.5 * fl1_fx * tex_yyz_xz_1[j];

                    tey_yyyz_xyz_0[j] = pa_y[j] * tey_yyz_xyz_0[j] - pc_y[j] * tey_yyz_xyz_1[j] + fl1_fx * tey_yz_xyz_0[j] - fl1_fx * tey_yz_xyz_1[j] + 0.5 * fl1_fx * tey_yyz_xz_0[j] - 0.5 * fl1_fx * tey_yyz_xz_1[j] + ta_yyz_xyz_1[j];

                    tez_yyyz_xyz_0[j] = pa_y[j] * tez_yyz_xyz_0[j] - pc_y[j] * tez_yyz_xyz_1[j] + fl1_fx * tez_yz_xyz_0[j] - fl1_fx * tez_yz_xyz_1[j] + 0.5 * fl1_fx * tez_yyz_xz_0[j] - 0.5 * fl1_fx * tez_yyz_xz_1[j];

                    tex_yyyz_xzz_0[j] = pa_y[j] * tex_yyz_xzz_0[j] - pc_y[j] * tex_yyz_xzz_1[j] + fl1_fx * tex_yz_xzz_0[j] - fl1_fx * tex_yz_xzz_1[j];

                    tey_yyyz_xzz_0[j] = pa_y[j] * tey_yyz_xzz_0[j] - pc_y[j] * tey_yyz_xzz_1[j] + fl1_fx * tey_yz_xzz_0[j] - fl1_fx * tey_yz_xzz_1[j] + ta_yyz_xzz_1[j];

                    tez_yyyz_xzz_0[j] = pa_y[j] * tez_yyz_xzz_0[j] - pc_y[j] * tez_yyz_xzz_1[j] + fl1_fx * tez_yz_xzz_0[j] - fl1_fx * tez_yz_xzz_1[j];

                    tex_yyyz_yyy_0[j] = pa_y[j] * tex_yyz_yyy_0[j] - pc_y[j] * tex_yyz_yyy_1[j] + fl1_fx * tex_yz_yyy_0[j] - fl1_fx * tex_yz_yyy_1[j] + 1.5 * fl1_fx * tex_yyz_yy_0[j] - 1.5 * fl1_fx * tex_yyz_yy_1[j];

                    tey_yyyz_yyy_0[j] = pa_y[j] * tey_yyz_yyy_0[j] - pc_y[j] * tey_yyz_yyy_1[j] + fl1_fx * tey_yz_yyy_0[j] - fl1_fx * tey_yz_yyy_1[j] + 1.5 * fl1_fx * tey_yyz_yy_0[j] - 1.5 * fl1_fx * tey_yyz_yy_1[j] + ta_yyz_yyy_1[j];
                }
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
            {
                ...
                for (int32_t j = 0; j < nprim; j++)
                {
                    ...
                    tez_yyyz_yyy_0[j] = pa_y[j] * tez_yyz_yyy_0[j] - pc_y[j] * tez_yyz_yyy_1[j] + fl1_fx * tez_yz_yyy_0[j] - fl1_fx * tez_yz_yyy_1[j] + 1.5 * fl1_fx * tez_yyz_yy_0[j] - 1.5 * fl1_fx * tez_yyz_yy_1[j];

                    tex_yyyz_yyz_0[j] = pa_y[j] * tex_yyz_yyz_0[j] - pc_y[j] * tex_yyz_yyz_1[j] + fl1_fx * tex_yz_yyz_0[j] - fl1_fx * tex_yz_yyz_1[j] + fl1_fx * tex_yyz_yz_0[j] - fl1_fx * tex_yyz_yz_1[j];

                    tey_yyyz_yyz_0[j] = pa_y[j] * tey_yyz_yyz_0[j] - pc_y[j] * tey_yyz_yyz_1[j] + fl1_fx * tey_yz_yyz_0[j] - fl1_fx * tey_yz_yyz_1[j] + fl1_fx * tey_yyz_yz_0[j] - fl1_fx * tey_yyz_yz_1[j] + ta_yyz_yyz_1[j];

                    tez_yyyz_yyz_0[j] = pa_y[j] * tez_yyz_yyz_0[j] - pc_y[j] * tez_yyz_yyz_1[j] + fl1_fx * tez_yz_yyz_0[j] - fl1_fx * tez_yz_yyz_1[j] + fl1_fx * tez_yyz_yz_0[j] - fl1_fx * tez_yyz_yz_1[j];

                    tex_yyyz_yzz_0[j] = pa_y[j] * tex_yyz_yzz_0[j] - pc_y[j] * tex_yyz_yzz_1[j] + fl1_fx * tex_yz_yzz_0[j] - fl1_fx * tex_yz_yzz_1[j] + 0.5 * fl1_fx * tex_yyz_zz_0[j] - 0.5 * fl1_fx * tex_yyz_zz_1[j];

                    tey_yyyz_yzz_0[j] = pa_y[j] * tey_yyz_yzz_0[j] - pc_y[j] * tey_yyz_yzz_1[j] + fl1_fx * tey_yz_yzz_0[j] - fl1_fx * tey_yz_yzz_1[j] + 0.5 * fl1_fx * tey_yyz_zz_0[j] - 0.5 * fl1_fx * tey_yyz_zz_1[j] + ta_yyz_yzz_1[j];

                    tez_yyyz_yzz_0[j] = pa_y[j] * tez_yyz_yzz_0[j] - pc_y[j] * tez_yyz_yzz_1[j] + fl1_fx * tez_yz_yzz_0[j] - fl1_fx * tez_yz_yzz_1[j] + 0.5 * fl1_fx * tez_yyz_zz_0[j] - 0.5 * fl1_fx * tez_yyz_zz_1[j];

                    tex_yyyz_zzz_0[j] = pa_y[j] * tex_yyz_zzz_0[j] - pc_y[j] * tex_yyz_zzz_1[j] + fl1_fx * tex_yz_zzz_0[j] - fl1_fx * tex_yz_zzz_1[j];

                    tey_yyyz_zzz_0[j] = pa_y[j] * tey_yyz_zzz_0[j] - pc_y[j] * tey_yyz_zzz_1[j] + fl1_fx * tey_yz_zzz_0[j] - fl1_fx * tey_yz_zzz_1[j] + ta_yyz_zzz_1[j];

                    tez_yyyz_zzz_0[j] = pa_y[j] * tez_yyz_zzz_0[j] - pc_y[j] * tez_yyz_zzz_1[j] + fl1_fx * tez_yz_zzz_0[j] - fl1_fx * tez_yz_zzz_1[j];

                    tex_yyzz_xxx_0[j] = pa_y[j] * tex_yzz_xxx_0[j] - pc_y[j] * tex_yzz_xxx_1[j] + 0.5 * fl1_fx * tex_zz_xxx_0[j] - 0.5 * fl1_fx * tex_zz_xxx_1[j];

                    tey_yyzz_xxx_0[j] = pa_y[j] * tey_yzz_xxx_0[j] - pc_y[j] * tey_yzz_xxx_1[j] + 0.5 * fl1_fx * tey_zz_xxx_0[j] - 0.5 * fl1_fx * tey_zz_xxx_1[j] + ta_yzz_xxx_1[j];

                    tez_yyzz_xxx_0[j] = pa_y[j] * tez_yzz_xxx_0[j] - pc_y[j] * tez_yzz_xxx_1[j] + 0.5 * fl1_fx * tez_zz_xxx_0[j] - 0.5 * fl1_fx * tez_zz_xxx_1[j];

                    tex_yyzz_xxy_0[j] = pa_y[j] * tex_yzz_xxy_0[j] - pc_y[j] * tex_yzz_xxy_1[j] + 0.5 * fl1_fx * tex_zz_xxy_0[j] - 0.5 * fl1_fx * tex_zz_xxy_1[j] + 0.5 * fl1_fx * tex_yzz_xx_0[j] - 0.5 * fl1_fx * tex_yzz_xx_1[j];

                    tey_yyzz_xxy_0[j] = pa_y[j] * tey_yzz_xxy_0[j] - pc_y[j] * tey_yzz_xxy_1[j] + 0.5 * fl1_fx * tey_zz_xxy_0[j] - 0.5 * fl1_fx * tey_zz_xxy_1[j] + 0.5 * fl1_fx * tey_yzz_xx_0[j] - 0.5 * fl1_fx * tey_yzz_xx_1[j] + ta_yzz_xxy_1[j];

                    tez_yyzz_xxy_0[j] = pa_y[j] * tez_yzz_xxy_0[j] - pc_y[j] * tez_yzz_xxy_1[j] + 0.5 * fl1_fx * tez_zz_xxy_0[j] - 0.5 * fl1_fx * tez_zz_xxy_1[j] + 0.5 * fl1_fx * tez_yzz_xx_0[j] - 0.5 * fl1_fx * tez_yzz_xx_1[j];

                    tex_yyzz_xxz_0[j] = pa_y[j] * tex_yzz_xxz_0[j] - pc_y[j] * tex_yzz_xxz_1[j] + 0.5 * fl1_fx * tex_zz_xxz_0[j] - 0.5 * fl1_fx * tex_zz_xxz_1[j];

                    tey_yyzz_xxz_0[j] = pa_y[j] * tey_yzz_xxz_0[j] - pc_y[j] * tey_yzz_xxz_1[j] + 0.5 * fl1_fx * tey_zz_xxz_0[j] - 0.5 * fl1_fx * tey_zz_xxz_1[j] + ta_yzz_xxz_1[j];

                    tez_yyzz_xxz_0[j] = pa_y[j] * tez_yzz_xxz_0[j] - pc_y[j] * tez_yzz_xxz_1[j] + 0.5 * fl1_fx * tez_zz_xxz_0[j] - 0.5 * fl1_fx * tez_zz_xxz_1[j];

                    tex_yyzz_xyy_0[j] = pa_y[j] * tex_yzz_xyy_0[j] - pc_y[j] * tex_yzz_xyy_1[j] + 0.5 * fl1_fx * tex_zz_xyy_0[j] - 0.5 * fl1_fx * tex_zz_xyy_1[j] + fl1_fx * tex_yzz_xy_0[j] - fl1_fx * tex_yzz_xy_1[j];

                    tey_yyzz_xyy_0[j] = pa_y[j] * tey_yzz_xyy_0[j] - pc_y[j] * tey_yzz_xyy_1[j] + 0.5 * fl1_fx * tey_zz_xyy_0[j] - 0.5 * fl1_fx * tey_zz_xyy_1[j] + fl1_fx * tey_yzz_xy_0[j] - fl1_fx * tey_yzz_xy_1[j] + ta_yzz_xyy_1[j];

                    tez_yyzz_xyy_0[j] = pa_y[j] * tez_yzz_xyy_0[j] - pc_y[j] * tez_yzz_xyy_1[j] + 0.5 * fl1_fx * tez_zz_xyy_0[j] - 0.5 * fl1_fx * tez_zz_xyy_1[j] + fl1_fx * tez_yzz_xy_0[j] - fl1_fx * tez_yzz_xy_1[j];

                    tex_yyzz_xyz_0[j] = pa_y[j] * tex_yzz_xyz_0[j] - pc_y[j] * tex_yzz_xyz_1[j] + 0.5 * fl1_fx * tex_zz_xyz_0[j] - 0.5 * fl1_fx * tex_zz_xyz_1[j] + 0.5 * fl1_fx * tex_yzz_xz_0[j] - 0.5 * fl1_fx * tex_yzz_xz_1[j];

                    tey_yyzz_xyz_0[j] = pa_y[j] * tey_yzz_xyz_0[j] - pc_y[j] * tey_yzz_xyz_1[j] + 0.5 * fl1_fx * tey_zz_xyz_0[j] - 0.5 * fl1_fx * tey_zz_xyz_1[j] + 0.5 * fl1_fx * tey_yzz_xz_0[j] - 0.5 * fl1_fx * tey_yzz_xz_1[j] + ta_yzz_xyz_1[j];

                    tez_yyzz_xyz_0[j] = pa_y[j] * tez_yzz_xyz_0[j] - pc_y[j] * tez_yzz_xyz_1[j] + 0.5 * fl1_fx * tez_zz_xyz_0[j] - 0.5 * fl1_fx * tez_zz_xyz_1[j] + 0.5 * fl1_fx * tez_yzz_xz_0[j] - 0.5 * fl1_fx * tez_yzz_xz_1[j];

                    tex_yyzz_xzz_0[j] = pa_y[j] * tex_yzz_xzz_0[j] - pc_y[j] * tex_yzz_xzz_1[j] + 0.5 * fl1_fx * tex_zz_xzz_0[j] - 0.5 * fl1_fx * tex_zz_xzz_1[j];

                    tey_yyzz_xzz_0[j] = pa_y[j] * tey_yzz_xzz_0[j] - pc_y[j] * tey_yzz_xzz_1[j] + 0.5 * fl1_fx * tey_zz_xzz_0[j] - 0.5 * fl1_fx * tey_zz_xzz_1[j] + ta_yzz_xzz_1[j];

                    tez_yyzz_xzz_0[j] = pa_y[j] * tez_yzz_xzz_0[j] - pc_y[j] * tez_yzz_xzz_1[j] + 0.5 * fl1_fx * tez_zz_xzz_0[j] - 0.5 * fl1_fx * tez_zz_xzz_1[j];

                    tex_yyzz_yyy_0[j] = pa_y[j] * tex_yzz_yyy_0[j] - pc_y[j] * tex_yzz_yyy_1[j] + 0.5 * fl1_fx * tex_zz_yyy_0[j] - 0.5 * fl1_fx * tex_zz_yyy_1[j] + 1.5 * fl1_fx * tex_yzz_yy_0[j] - 1.5 * fl1_fx * tex_yzz_yy_1[j];

                    tey_yyzz_yyy_0[j] = pa_y[j] * tey_yzz_yyy_0[j] - pc_y[j] * tey_yzz_yyy_1[j] + 0.5 * fl1_fx * tey_zz_yyy_0[j] - 0.5 * fl1_fx * tey_zz_yyy_1[j] + 1.5 * fl1_fx * tey_yzz_yy_0[j] - 1.5 * fl1_fx * tey_yzz_yy_1[j] + ta_yzz_yyy_1[j];

                    tez_yyzz_yyy_0[j] = pa_y[j] * tez_yzz_yyy_0[j] - pc_y[j] * tez_yzz_yyy_1[j] + 0.5 * fl1_fx * tez_zz_yyy_0[j] - 0.5 * fl1_fx * tez_zz_yyy_1[j] + 1.5 * fl1_fx * tez_yzz_yy_0[j] - 1.5 * fl1_fx * tez_yzz_yy_1[j];

                    tex_yyzz_yyz_0[j] = pa_y[j] * tex_yzz_yyz_0[j] - pc_y[j] * tex_yzz_yyz_1[j] + 0.5 * fl1_fx * tex_zz_yyz_0[j] - 0.5 * fl1_fx * tex_zz_yyz_1[j] + fl1_fx * tex_yzz_yz_0[j] - fl1_fx * tex_yzz_yz_1[j];

                    tey_yyzz_yyz_0[j] = pa_y[j] * tey_yzz_yyz_0[j] - pc_y[j] * tey_yzz_yyz_1[j] + 0.5 * fl1_fx * tey_zz_yyz_0[j] - 0.5 * fl1_fx * tey_zz_yyz_1[j] + fl1_fx * tey_yzz_yz_0[j] - fl1_fx * tey_yzz_yz_1[j] + ta_yzz_yyz_1[j];

                    tez_yyzz_yyz_0[j] = pa_y[j] * tez_yzz_yyz_0[j] - pc_y[j] * tez_yzz_yyz_1[j] + 0.5 * fl1_fx * tez_zz_yyz_0[j] - 0.5 * fl1_fx * tez_zz_yyz_1[j] + fl1_fx * tez_yzz_yz_0[j] - fl1_fx * tez_yzz_yz_1[j];

                    tex_yyzz_yzz_0[j] = pa_y[j] * tex_yzz_yzz_0[j] - pc_y[j] * tex_yzz_yzz_1[j] + 0.5 * fl1_fx * tex_zz_yzz_0[j] - 0.5 * fl1_fx * tex_zz_yzz_1[j] + 0.5 * fl1_fx * tex_yzz_zz_0[j] - 0.5 * fl1_fx * tex_yzz_zz_1[j];

                    tey_yyzz_yzz_0[j] = pa_y[j] * tey_yzz_yzz_0[j] - pc_y[j] * tey_yzz_yzz_1[j] + 0.5 * fl1_fx * tey_zz_yzz_0[j] - 0.5 * fl1_fx * tey_zz_yzz_1[j] + 0.5 * fl1_fx * tey_yzz_zz_0[j] - 0.5 * fl1_fx * tey_yzz_zz_1[j] + ta_yzz_yzz_1[j];

                    tez_yyzz_yzz_0[j] = pa_y[j] * tez_yzz_yzz_0[j] - pc_y[j] * tez_yzz_yzz_1[j] + 0.5 * fl1_fx * tez_zz_yzz_0[j] - 0.5 * fl1_fx * tez_zz_yzz_1[j] + 0.5 * fl1_fx * tez_yzz_zz_0[j] - 0.5 * fl1_fx * tez_yzz_zz_1[j];

                    tex_yyzz_zzz_0[j] = pa_y[j] * tex_yzz_zzz_0[j] - pc_y[j] * tex_yzz_zzz_1[j] + 0.5 * fl1_fx * tex_zz_zzz_0[j] - 0.5 * fl1_fx * tex_zz_zzz_1[j];

                    tey_yyzz_zzz_0[j] = pa_y[j] * tey_yzz_zzz_0[j] - pc_y[j] * tey_yzz_zzz_1[j] + 0.5 * fl1_fx * tey_zz_zzz_0[j] - 0.5 * fl1_fx * tey_zz_zzz_1[j] + ta_yzz_zzz_1[j];

                    tez_yyzz_zzz_0[j] = pa_y[j] * tez_yzz_zzz_0[j] - pc_y[j] * tez_yzz_zzz_1[j] + 0.5 * fl1_fx * tez_zz_zzz_0[j] - 0.5 * fl1_fx * tez_zz_zzz_1[j];
                    ...
                    tex_yzzz_xxy_0[j] = pa_y[j] * tex_zzz_xxy_0[j] - pc_y[j] * tex_zzz_xxy_1[j] + 0.5 * fl1_fx * tex_zzz_xx_0[j] - 0.5 * fl1_fx * tex_zzz_xx_1[j];

                    tey_yzzz_xxy_0[j] = pa_y[j] * tey_zzz_xxy_0[j] - pc_y[j] * tey_zzz_xxy_1[j] + 0.5 * fl1_fx * tey_zzz_xx_0[j] - 0.5 * fl1_fx * tey_zzz_xx_1[j] + ta_zzz_xxy_1[j];

                    tez_yzzz_xxy_0[j] = pa_y[j] * tez_zzz_xxy_0[j] - pc_y[j] * tez_zzz_xxy_1[j] + 0.5 * fl1_fx * tez_zzz_xx_0[j] - 0.5 * fl1_fx * tez_zzz_xx_1[j];
        ...
        for (int32_t iord = 0; iord <= mord; iord++)
        {
            ...
            for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
            {
                ...
                for (int32_t j = 0; j < nprim; j++)
                {
                    ...
                    tey_yzzz_xyy_0[j] = pa_y[j] * tey_zzz_xyy_0[j] - pc_y[j] * tey_zzz_xyy_1[j] + fl1_fx * tey_zzz_xy_0[j] - fl1_fx * tey_zzz_xy_1[j] + ta_zzz_xyy_1[j];

                    tez_yzzz_xyy_0[j] = pa_y[j] * tez_zzz_xyy_0[j] - pc_y[j] * tez_zzz_xyy_1[j] + fl1_fx * tez_zzz_xy_0[j] - fl1_fx * tez_zzz_xy_1[j];

                    tex_yzzz_xyz_0[j] = pa_y[j] * tex_zzz_xyz_0[j] - pc_y[j] * tex_zzz_xyz_1[j] + 0.5 * fl1_fx * tex_zzz_xz_0[j] - 0.5 * fl1_fx * tex_zzz_xz_1[j];

                    tey_yzzz_xyz_0[j] = pa_y[j] * tey_zzz_xyz_0[j] - pc_y[j] * tey_zzz_xyz_1[j] + 0.5 * fl1_fx * tey_zzz_xz_0[j] - 0.5 * fl1_fx * tey_zzz_xz_1[j] + ta_zzz_xyz_1[j];

                    tez_yzzz_xyz_0[j] = pa_y[j] * tez_zzz_xyz_0[j] - pc_y[j] * tez_zzz_xyz_1[j] + 0.5 * fl1_fx * tez_zzz_xz_0[j] - 0.5 * fl1_fx * tez_zzz_xz_1[j];
                    ...
                    tex_yzzz_yyy_0[j] = pa_y[j] * tex_zzz_yyy_0[j] - pc_y[j] * tex_zzz_yyy_1[j] + 1.5 * fl1_fx * tex_zzz_yy_0[j] - 1.5 * fl1_fx * tex_zzz_yy_1[j];

                    tey_yzzz_yyy_0[j] = pa_y[j] * tey_zzz_yyy_0[j] - pc_y[j] * tey_zzz_yyy_1[j] + 1.5 * fl1_fx * tey_zzz_yy_0[j] - 1.5 * fl1_fx * tey_zzz_yy_1[j] + ta_zzz_yyy_1[j];

                    tez_yzzz_yyy_0[j] = pa_y[j] * tez_zzz_yyy_0[j] - pc_y[j] * tez_zzz_yyy_1[j] + 1.5 * fl1_fx * tez_zzz_yy_0[j] - 1.5 * fl1_fx * tez_zzz_yy_1[j];

                    tex_yzzz_yyz_0[j] = pa_y[j] * tex_zzz_yyz_0[j] - pc_y[j] * tex_zzz_yyz_1[j] + fl1_fx * tex_zzz_yz_0[j] - fl1_fx * tex_zzz_yz_1[j];

                    tey_yzzz_yyz_0[j] = pa_y[j] * tey_zzz_yyz_0[j] - pc_y[j] * tey_zzz_yyz_1[j] + fl1_fx * tey_zzz_yz_0[j] - fl1_fx * tey_zzz_yz_1[j] + ta_zzz_yyz_1[j];

                    tez_yzzz_yyz_0[j] = pa_y[j] * tez_zzz_yyz_0[j] - pc_y[j] * tez_zzz_yyz_1[j] + fl1_fx * tez_zzz_yz_0[j] - fl1_fx * tez_zzz_yz_1[j];

                    tex_yzzz_yzz_0[j] = pa_y[j] * tex_zzz_yzz_0[j] - pc_y[j] * tex_zzz_yzz_1[j] + 0.5 * fl1_fx * tex_zzz_zz_0[j] - 0.5 * fl1_fx * tex_zzz_zz_1[j];

                    tey_yzzz_yzz_0[j] = pa_y[j] * tey_zzz_yzz_0[j] - pc_y[j] * tey_zzz_yzz_1[j] + 0.5 * fl1_fx * tey_zzz_zz_0[j] - 0.5 * fl1_fx * tey_zzz_zz_1[j] + ta_zzz_yzz_1[j];

                    tez_yzzz_yzz_0[j] = pa_y[j] * tez_zzz_yzz_0[j] - pc_y[j] * tez_zzz_yzz_1[j] + 0.5 * fl1_fx * tez_zzz_zz_0[j] - 0.5 * fl1_fx * tez_zzz_zz_1[j];
                    ...
                    tex_zzzz_xxx_0[j] = pa_z[j] * tex_zzz_xxx_0[j] - pc_z[j] * tex_zzz_xxx_1[j] + 1.5 * fl1_fx * tex_zz_xxx_0[j] - 1.5 * fl1_fx * tex_zz_xxx_1[j];

                    tey_zzzz_xxx_0[j] = pa_z[j] * tey_zzz_xxx_0[j] - pc_z[j] * tey_zzz_xxx_1[j] + 1.5 * fl1_fx * tey_zz_xxx_0[j] - 1.5 * fl1_fx * tey_zz_xxx_1[j];

                    tez_zzzz_xxx_0[j] = pa_z[j] * tez_zzz_xxx_0[j] - pc_z[j] * tez_zzz_xxx_1[j] + 1.5 * fl1_fx * tez_zz_xxx_0[j] - 1.5 * fl1_fx * tez_zz_xxx_1[j] + ta_zzz_xxx_1[j];

                    tex_zzzz_xxy_0[j] = pa_z[j] * tex_zzz_xxy_0[j] - pc_z[j] * tex_zzz_xxy_1[j] + 1.5 * fl1_fx * tex_zz_xxy_0[j] - 1.5 * fl1_fx * tex_zz_xxy_1[j];

                    tey_zzzz_xxy_0[j] = pa_z[j] * tey_zzz_xxy_0[j] - pc_z[j] * tey_zzz_xxy_1[j] + 1.5 * fl1_fx * tey_zz_xxy_0[j] - 1.5 * fl1_fx * tey_zz_xxy_1[j];

                    tez_zzzz_xxy_0[j] = pa_z[j] * tez_zzz_xxy_0[j] - pc_z[j] * tez_zzz_xxy_1[j] + 1.5 * fl1_fx * tez_zz_xxy_0[j] - 1.5 * fl1_fx * tez_zz_xxy_1[j] + ta_zzz_xxy_1[j];

                    tex_zzzz_xxz_0[j] = pa_z[j] * tex_zzz_xxz_0[j] - pc_z[j] * tex_zzz_xxz_1[j] + 1.5 * fl1_fx * tex_zz_xxz_0[j] - 1.5 * fl1_fx * tex_zz_xxz_1[j] + 0.5 * fl1_fx * tex_zzz_xx_0[j] - 0.5 * fl1_fx * tex_zzz_xx_1[j];

                    tey_zzzz_xxz_0[j] = pa_z[j] * tey_zzz_xxz_0[j] - pc_z[j] * tey_zzz_xxz_1[j] + 1.5 * fl1_fx * tey_zz_xxz_0[j] - 1.5 * fl1_fx * tey_zz_xxz_1[j] + 0.5 * fl1_fx * tey_zzz_xx_0[j] - 0.5 * fl1_fx * tey_zzz_xx_1[j];

                    tez_zzzz_xxz_0[j] = pa_z[j] * tez_zzz_xxz_0[j] - pc_z[j] * tez_zzz_xxz_1[j] + 1.5 * fl1_fx * tez_zz_xxz_0[j] - 1.5 * fl1_fx * tez_zz_xxz_1[j] + 0.5 * fl1_fx * tez_zzz_xx_0[j] - 0.5 * fl1_fx * tez_zzz_xx_1[j] + ta_zzz_xxz_1[j];

                    tex_zzzz_xyy_0[j] = pa_z[j] * tex_zzz_xyy_0[j] - pc_z[j] * tex_zzz_xyy_1[j] + 1.5 * fl1_fx * tex_zz_xyy_0[j] - 1.5 * fl1_fx * tex_zz_xyy_1[j];

                    tey_zzzz_xyy_0[j] = pa_z[j] * tey_zzz_xyy_0[j] - pc_z[j] * tey_zzz_xyy_1[j] + 1.5 * fl1_fx * tey_zz_xyy_0[j] - 1.5 * fl1_fx * tey_zz_xyy_1[j];

                    tez_zzzz_xyy_0[j] = pa_z[j] * tez_zzz_xyy_0[j] - pc_z[j] * tez_zzz_xyy_1[j] + 1.5 * fl1_fx * tez_zz_xyy_0[j] - 1.5 * fl1_fx * tez_zz_xyy_1[j] + ta_zzz_xyy_1[j];

                    tex_zzzz_xyz_0[j] = pa_z[j] * tex_zzz_xyz_0[j] - pc_z[j] * tex_zzz_xyz_1[j] + 1.5 * fl1_fx * tex_zz_xyz_0[j] - 1.5 * fl1_fx * tex_zz_xyz_1[j] + 0.5 * fl1_fx * tex_zzz_xy_0[j] - 0.5 * fl1_fx * tex_zzz_xy_1[j];

                    tey_zzzz_xyz_0[j] = pa_z[j] * tey_zzz_xyz_0[j] - pc_z[j] * tey_zzz_xyz_1[j] + 1.5 * fl1_fx * tey_zz_xyz_0[j] - 1.5 * fl1_fx * tey_zz_xyz_1[j] + 0.5 * fl1_fx * tey_zzz_xy_0[j] - 0.5 * fl1_fx * tey_zzz_xy_1[j];

                    tez_zzzz_xyz_0[j] = pa_z[j] * tez_zzz_xyz_0[j] - pc_z[j] * tez_zzz_xyz_1[j] + 1.5 * fl1_fx * tez_zz_xyz_0[j] - 1.5 * fl1_fx * tez_zz_xyz_1[j] + 0.5 * fl1_fx * tez_zzz_xy_0[j] - 0.5 * fl1_fx * tez_zzz_xy_1[j] + ta_zzz_xyz_1[j];

                    tex_zzzz_xzz_0[j] = pa_z[j] * tex_zzz_xzz_0[j] - pc_z[j] * tex_zzz_xzz_1[j] + 1.5 * fl1_fx * tex_zz_xzz_0[j] - 1.5 * fl1_fx * tex_zz_xzz_1[j] + fl1_fx * tex_zzz_xz_0[j] - fl1_fx * tex_zzz_xz_1[j];

                    tey_zzzz_xzz_0[j] = pa_z[j] * tey_zzz_xzz_0[j] - pc_z[j] * tey_zzz_xzz_1[j] + 1.5 * fl1_fx * tey_zz_xzz_0[j] - 1.5 * fl1_fx * tey_zz_xzz_1[j] + fl1_fx * tey_zzz_xz_0[j] - fl1_fx * tey_zzz_xz_1[j];

                    tez_zzzz_xzz_0[j] = pa_z[j] * tez_zzz_xzz_0[j] - pc_z[j] * tez_zzz_xzz_1[j] + 1.5 * fl1_fx * tez_zz_xzz_0[j] - 1.5 * fl1_fx * tez_zz_xzz_1[j] + fl1_fx * tez_zzz_xz_0[j] - fl1_fx * tez_zzz_xz_1[j] + ta_zzz_xzz_1[j];

                    tex_zzzz_yyy_0[j] = pa_z[j] * tex_zzz_yyy_0[j] - pc_z[j] * tex_zzz_yyy_1[j] + 1.5 * fl1_fx * tex_zz_yyy_0[j] - 1.5 * fl1_fx * tex_zz_yyy_1[j];

                    tey_zzzz_yyy_0[j] = pa_z[j] * tey_zzz_yyy_0[j] - pc_z[j] * tey_zzz_yyy_1[j] + 1.5 * fl1_fx * tey_zz_yyy_0[j] - 1.5 * fl1_fx * tey_zz_yyy_1[j];

                    tez_zzzz_yyy_0[j] = pa_z[j] * tez_zzz_yyy_0[j] - pc_z[j] * tez_zzz_yyy_1[j] + 1.5 * fl1_fx * tez_zz_yyy_0[j] - 1.5 * fl1_fx * tez_zz_yyy_1[j] + ta_zzz_yyy_1[j];

                    tex_zzzz_yyz_0[j] = pa_z[j] * tex_zzz_yyz_0[j] - pc_z[j] * tex_zzz_yyz_1[j] + 1.5 * fl1_fx * tex_zz_yyz_0[j] - 1.5 * fl1_fx * tex_zz_yyz_1[j] + 0.5 * fl1_fx * tex_zzz_yy_0[j] - 0.5 * fl1_fx * tex_zzz_yy_1[j];

                    tey_zzzz_yyz_0[j] = pa_z[j] * tey_zzz_yyz_0[j] - pc_z[j] * tey_zzz_yyz_1[j] + 1.5 * fl1_fx * tey_zz_yyz_0[j] - 1.5 * fl1_fx * tey_zz_yyz_1[j] + 0.5 * fl1_fx * tey_zzz_yy_0[j] - 0.5 * fl1_fx * tey_zzz_yy_1[j];

                    tez_zzzz_yyz_0[j] = pa_z[j] * tez_zzz_yyz_0[j] - pc_z[j] * tez_zzz_yyz_1[j] + 1.5 * fl1_fx * tez_zz_yyz_0[j] - 1.5 * fl1_fx * tez_zz_yyz_1[j] + 0.5 * fl1_fx * tez_zzz_yy_0[j] - 0.5 * fl1_fx * tez_zzz_yy_1[j] + ta_zzz_yyz_1[j];

                    tex_zzzz_yzz_0[j] = pa_z[j] * tex_zzz_yzz_0[j] - pc_z[j] * tex_zzz_yzz_1[j] + 1.5 * fl1_fx * tex_zz_yzz_0[j] - 1.5 * fl1_fx * tex_zz_yzz_1[j] + fl1_fx * tex_zzz_yz_0[j] - fl1_fx * tex_zzz_yz_1[j];

                    tey_zzzz_yzz_0[j] = pa_z[j] * tey_zzz_yzz_0[j] - pc_z[j] * tey_zzz_yzz_1[j] + 1.5 * fl1_fx * tey_zz_yzz_0[j] - 1.5 * fl1_fx * tey_zz_yzz_1[j] + fl1_fx * tey_zzz_yz_0[j] - fl1_fx * tey_zzz_yz_1[j];

                    tez_zzzz_yzz_0[j] = pa_z[j] * tez_zzz_yzz_0[j] - pc_z[j] * tez_zzz_yzz_1[j] + 1.5 * fl1_fx * tez_zz_yzz_0[j] - 1.5 * fl1_fx * tez_zz_yzz_1[j] + fl1_fx * tez_zzz_yz_0[j] - fl1_fx * tez_zzz_yz_1[j] + ta_zzz_yzz_1[j];

                    tex_zzzz_zzz_0[j] = pa_z[j] * tex_zzz_zzz_0[j] - pc_z[j] * tex_zzz_zzz_1[j] + 1.5 * fl1_fx * tex_zz_zzz_0[j] - 1.5 * fl1_fx * tex_zz_zzz_1[j] + 1.5 * fl1_fx * tex_zzz_zz_0[j] - 1.5 * fl1_fx * tex_zzz_zz_1[j];

                    tey_zzzz_zzz_0[j] = pa_z[j] * tey_zzz_zzz_0[j] - pc_z[j] * tey_zzz_zzz_1[j] + 1.5 * fl1_fx * tey_zz_zzz_0[j] - 1.5 * fl1_fx * tey_zz_zzz_1[j] + 1.5 * fl1_fx * tey_zzz_zz_0[j] - 1.5 * fl1_fx * tey_zzz_zz_1[j];

                    tez_zzzz_zzz_0[j] = pa_z[j] * tez_zzz_zzz_0[j] - pc_z[j] * tez_zzz_zzz_1[j] + 1.5 * fl1_fx * tez_zz_zzz_0[j] - 1.5 * fl1_fx * tez_zz_zzz_1[j] + 1.5 * fl1_fx * tez_zzz_zz_0[j] - 1.5 * fl1_fx * tez_zzz_zz_1[j] + ta_zzz_zzz_1[j];
                }
