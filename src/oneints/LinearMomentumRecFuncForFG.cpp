...
namespace lmomrecfunc { // lmomrecfunc namespace
    ...
    {
        lmomrecfunc::compLinearMomentumForFG_0_50(primBuffer,
                                                  recursionMap,
                                                  osFactors,
                                                  paDistances, 
                                                  braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForFG_50_100(primBuffer,
                                                    recursionMap,
                                                    osFactors,
                                                    paDistances, 
                                                    braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForFG_100_150(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForFG_150_200(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForFG_200_250(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForFG_250_300(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForFG_300_350(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForFG_350_400(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
        ...
        lmomrecfunc::compLinearMomentumForFG_400_450(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
                                 ...
                                 const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpx_xxx_xxxx_0[j] = pa_x[j] * tpx_xx_xxxx_0[j] + fl1_fx * tpx_x_xxxx_0[j] + 2.0 * fl1_fx * tpx_xx_xxx_0[j] - fl1_fgb * fl1_fx * ts_xx_xxxx_0[j];
                ...
                tpx_xxx_xxxy_0[j] = pa_x[j] * tpx_xx_xxxy_0[j] + fl1_fx * tpx_x_xxxy_0[j] + 1.5 * fl1_fx * tpx_xx_xxy_0[j] - fl1_fgb * fl1_fx * ts_xx_xxxy_0[j];
                ...
                tpx_xxx_xxxz_0[j] = pa_x[j] * tpx_xx_xxxz_0[j] + fl1_fx * tpx_x_xxxz_0[j] + 1.5 * fl1_fx * tpx_xx_xxz_0[j] - fl1_fgb * fl1_fx * ts_xx_xxxz_0[j];
                ...
                tpx_xxx_xyyy_0[j] = pa_x[j] * tpx_xx_xyyy_0[j] + fl1_fx * tpx_x_xyyy_0[j] + 0.5 * fl1_fx * tpx_xx_yyy_0[j] - fl1_fgb * fl1_fx * ts_xx_xyyy_0[j];
                ...
                tpx_xxx_xyyz_0[j] = pa_x[j] * tpx_xx_xyyz_0[j] + fl1_fx * tpx_x_xyyz_0[j] + 0.5 * fl1_fx * tpx_xx_yyz_0[j] - fl1_fgb * fl1_fx * ts_xx_xyyz_0[j];
                ...
                tpx_xxx_xyzz_0[j] = pa_x[j] * tpx_xx_xyzz_0[j] + fl1_fx * tpx_x_xyzz_0[j] + 0.5 * fl1_fx * tpx_xx_yzz_0[j] - fl1_fgb * fl1_fx * ts_xx_xyzz_0[j];
                ...
                tpx_xxx_xzzz_0[j] = pa_x[j] * tpx_xx_xzzz_0[j] + fl1_fx * tpx_x_xzzz_0[j] + 0.5 * fl1_fx * tpx_xx_zzz_0[j] - fl1_fgb * fl1_fx * ts_xx_xzzz_0[j];
                ...
                tpx_xxy_xxxx_0[j] = pa_x[j] * tpx_xy_xxxx_0[j] + 0.5 * fl1_fx * tpx_y_xxxx_0[j] + 2.0 * fl1_fx * tpx_xy_xxx_0[j] - fl1_fgb * fl1_fx * ts_xy_xxxx_0[j];
                ...
                tpx_xxy_xxxy_0[j] = pa_x[j] * tpx_xy_xxxy_0[j] + 0.5 * fl1_fx * tpx_y_xxxy_0[j] + 1.5 * fl1_fx * tpx_xy_xxy_0[j] - fl1_fgb * fl1_fx * ts_xy_xxxy_0[j];
                                   ...
                                   const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpx_xxy_xxxz_0[j] = pa_x[j] * tpx_xy_xxxz_0[j] + 0.5 * fl1_fx * tpx_y_xxxz_0[j] + 1.5 * fl1_fx * tpx_xy_xxz_0[j] - fl1_fgb * fl1_fx * ts_xy_xxxz_0[j];
                ...
                tpx_xxy_xxyy_0[j] = pa_x[j] * tpx_xy_xxyy_0[j] + 0.5 * fl1_fx * tpx_y_xxyy_0[j] + fl1_fx * tpx_xy_xyy_0[j] - fl1_fgb * fl1_fx * ts_xy_xxyy_0[j];
                ...
                tpx_xxy_xxyz_0[j] = pa_x[j] * tpx_xy_xxyz_0[j] + 0.5 * fl1_fx * tpx_y_xxyz_0[j] + fl1_fx * tpx_xy_xyz_0[j] - fl1_fgb * fl1_fx * ts_xy_xxyz_0[j];
                ...
                tpx_xxy_xxzz_0[j] = pa_x[j] * tpx_xy_xxzz_0[j] + 0.5 * fl1_fx * tpx_y_xxzz_0[j] + fl1_fx * tpx_xy_xzz_0[j] - fl1_fgb * fl1_fx * ts_xy_xxzz_0[j];
                ...
                tpx_xxy_xyyy_0[j] = pa_x[j] * tpx_xy_xyyy_0[j] + 0.5 * fl1_fx * tpx_y_xyyy_0[j] + 0.5 * fl1_fx * tpx_xy_yyy_0[j] - fl1_fgb * fl1_fx * ts_xy_xyyy_0[j];
                ...
                tpx_xxy_xyyz_0[j] = pa_x[j] * tpx_xy_xyyz_0[j] + 0.5 * fl1_fx * tpx_y_xyyz_0[j] + 0.5 * fl1_fx * tpx_xy_yyz_0[j] - fl1_fgb * fl1_fx * ts_xy_xyyz_0[j];
                ...
                tpx_xxy_xyzz_0[j] = pa_x[j] * tpx_xy_xyzz_0[j] + 0.5 * fl1_fx * tpx_y_xyzz_0[j] + 0.5 * fl1_fx * tpx_xy_yzz_0[j] - fl1_fgb * fl1_fx * ts_xy_xyzz_0[j];
                ...
                tpx_xxy_xzzz_0[j] = pa_x[j] * tpx_xy_xzzz_0[j] + 0.5 * fl1_fx * tpx_y_xzzz_0[j] + 0.5 * fl1_fx * tpx_xy_zzz_0[j] - fl1_fgb * fl1_fx * ts_xy_xzzz_0[j];
                ...
                tpx_xxz_xxxx_0[j] = pa_x[j] * tpx_xz_xxxx_0[j] + 0.5 * fl1_fx * tpx_z_xxxx_0[j] + 2.0 * fl1_fx * tpx_xz_xxx_0[j] - fl1_fgb * fl1_fx * ts_xz_xxxx_0[j];
                ...
                tpx_xxz_xxxy_0[j] = pa_x[j] * tpx_xz_xxxy_0[j] + 0.5 * fl1_fx * tpx_z_xxxy_0[j] + 1.5 * fl1_fx * tpx_xz_xxy_0[j] - fl1_fgb * fl1_fx * ts_xz_xxxy_0[j];
                ...
                tpx_xxz_xxxz_0[j] = pa_x[j] * tpx_xz_xxxz_0[j] + 0.5 * fl1_fx * tpx_z_xxxz_0[j] + 1.5 * fl1_fx * tpx_xz_xxz_0[j] - fl1_fgb * fl1_fx * ts_xz_xxxz_0[j];
                ...
                tpx_xxz_xxyy_0[j] = pa_x[j] * tpx_xz_xxyy_0[j] + 0.5 * fl1_fx * tpx_z_xxyy_0[j] + fl1_fx * tpx_xz_xyy_0[j] - fl1_fgb * fl1_fx * ts_xz_xxyy_0[j];
            }
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpx_xxz_xxyz_0[j] = pa_x[j] * tpx_xz_xxyz_0[j] + 0.5 * fl1_fx * tpx_z_xxyz_0[j] + fl1_fx * tpx_xz_xyz_0[j] - fl1_fgb * fl1_fx * ts_xz_xxyz_0[j];
                ...
                tpx_xxz_xxzz_0[j] = pa_x[j] * tpx_xz_xxzz_0[j] + 0.5 * fl1_fx * tpx_z_xxzz_0[j] + fl1_fx * tpx_xz_xzz_0[j] - fl1_fgb * fl1_fx * ts_xz_xxzz_0[j];
                ...
                tpx_xxz_xyyy_0[j] = pa_x[j] * tpx_xz_xyyy_0[j] + 0.5 * fl1_fx * tpx_z_xyyy_0[j] + 0.5 * fl1_fx * tpx_xz_yyy_0[j] - fl1_fgb * fl1_fx * ts_xz_xyyy_0[j];
                ...
                tpx_xxz_xyyz_0[j] = pa_x[j] * tpx_xz_xyyz_0[j] + 0.5 * fl1_fx * tpx_z_xyyz_0[j] + 0.5 * fl1_fx * tpx_xz_yyz_0[j] - fl1_fgb * fl1_fx * ts_xz_xyyz_0[j];
                ...
                tpx_xxz_xyzz_0[j] = pa_x[j] * tpx_xz_xyzz_0[j] + 0.5 * fl1_fx * tpx_z_xyzz_0[j] + 0.5 * fl1_fx * tpx_xz_yzz_0[j] - fl1_fgb * fl1_fx * ts_xz_xyzz_0[j];
                ...
                tpx_xxz_xzzz_0[j] = pa_x[j] * tpx_xz_xzzz_0[j] + 0.5 * fl1_fx * tpx_z_xzzz_0[j] + 0.5 * fl1_fx * tpx_xz_zzz_0[j] - fl1_fgb * fl1_fx * ts_xz_xzzz_0[j];
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpy_yyy_xxxy_0[j] = pa_y[j] * tpy_yy_xxxy_0[j] + fl1_fx * tpy_y_xxxy_0[j] + 0.5 * fl1_fx * tpy_yy_xxx_0[j] - fl1_fgb * fl1_fx * ts_yy_xxxy_0[j];
                ...
                tpy_yyy_xxyz_0[j] = pa_y[j] * tpy_yy_xxyz_0[j] + fl1_fx * tpy_y_xxyz_0[j] + 0.5 * fl1_fx * tpy_yy_xxz_0[j] - fl1_fgb * fl1_fx * ts_yy_xxyz_0[j];
                ...
                tpy_yyy_xyyy_0[j] = pa_y[j] * tpy_yy_xyyy_0[j] + fl1_fx * tpy_y_xyyy_0[j] + 1.5 * fl1_fx * tpy_yy_xyy_0[j] - fl1_fgb * fl1_fx * ts_yy_xyyy_0[j];
                ...
                tpy_yyy_xyzz_0[j] = pa_y[j] * tpy_yy_xyzz_0[j] + fl1_fx * tpy_y_xyzz_0[j] + 0.5 * fl1_fx * tpy_yy_xzz_0[j] - fl1_fgb * fl1_fx * ts_yy_xyzz_0[j];
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpy_yyy_yyyy_0[j] = pa_y[j] * tpy_yy_yyyy_0[j] + fl1_fx * tpy_y_yyyy_0[j] + 2.0 * fl1_fx * tpy_yy_yyy_0[j] - fl1_fgb * fl1_fx * ts_yy_yyyy_0[j];
                ...
                tpy_yyy_yyyz_0[j] = pa_y[j] * tpy_yy_yyyz_0[j] + fl1_fx * tpy_y_yyyz_0[j] + 1.5 * fl1_fx * tpy_yy_yyz_0[j] - fl1_fgb * fl1_fx * ts_yy_yyyz_0[j];
                ...
                tpy_yyy_yzzz_0[j] = pa_y[j] * tpy_yy_yzzz_0[j] + fl1_fx * tpy_y_yzzz_0[j] + 0.5 * fl1_fx * tpy_yy_zzz_0[j] - fl1_fgb * fl1_fx * ts_yy_yzzz_0[j];
                ...
                tpy_yyz_xxxy_0[j] = pa_y[j] * tpy_yz_xxxy_0[j] + 0.5 * fl1_fx * tpy_z_xxxy_0[j] + 0.5 * fl1_fx * tpy_yz_xxx_0[j] - fl1_fgb * fl1_fx * ts_yz_xxxy_0[j];
                ...
                tpy_yyz_xxyy_0[j] = pa_y[j] * tpy_yz_xxyy_0[j] + 0.5 * fl1_fx * tpy_z_xxyy_0[j] + fl1_fx * tpy_yz_xxy_0[j] - fl1_fgb * fl1_fx * ts_yz_xxyy_0[j];
                ...
                tpy_yyz_xxyz_0[j] = pa_y[j] * tpy_yz_xxyz_0[j] + 0.5 * fl1_fx * tpy_z_xxyz_0[j] + 0.5 * fl1_fx * tpy_yz_xxz_0[j] - fl1_fgb * fl1_fx * ts_yz_xxyz_0[j];
                ...
                tpy_yyz_xyyy_0[j] = pa_y[j] * tpy_yz_xyyy_0[j] + 0.5 * fl1_fx * tpy_z_xyyy_0[j] + 1.5 * fl1_fx * tpy_yz_xyy_0[j] - fl1_fgb * fl1_fx * ts_yz_xyyy_0[j];
                ...
                tpy_yyz_xyyz_0[j] = pa_y[j] * tpy_yz_xyyz_0[j] + 0.5 * fl1_fx * tpy_z_xyyz_0[j] + fl1_fx * tpy_yz_xyz_0[j] - fl1_fgb * fl1_fx * ts_yz_xyyz_0[j];
                ...
                tpy_yyz_xyzz_0[j] = pa_y[j] * tpy_yz_xyzz_0[j] + 0.5 * fl1_fx * tpy_z_xyzz_0[j] + 0.5 * fl1_fx * tpy_yz_xzz_0[j] - fl1_fgb * fl1_fx * ts_yz_xyzz_0[j];
                ...
                tpy_yyz_yyyy_0[j] = pa_y[j] * tpy_yz_yyyy_0[j] + 0.5 * fl1_fx * tpy_z_yyyy_0[j] + 2.0 * fl1_fx * tpy_yz_yyy_0[j] - fl1_fgb * fl1_fx * ts_yz_yyyy_0[j];
                ...
                tpy_yyz_yyyz_0[j] = pa_y[j] * tpy_yz_yyyz_0[j] + 0.5 * fl1_fx * tpy_z_yyyz_0[j] + 1.5 * fl1_fx * tpy_yz_yyz_0[j] - fl1_fgb * fl1_fx * ts_yz_yyyz_0[j];
            }
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpy_yyz_yyzz_0[j] = pa_y[j] * tpy_yz_yyzz_0[j] + 0.5 * fl1_fx * tpy_z_yyzz_0[j] + fl1_fx * tpy_yz_yzz_0[j] - fl1_fgb * fl1_fx * ts_yz_yyzz_0[j];
                ...
                tpy_yyz_yzzz_0[j] = pa_y[j] * tpy_yz_yzzz_0[j] + 0.5 * fl1_fx * tpy_z_yzzz_0[j] + 0.5 * fl1_fx * tpy_yz_zzz_0[j] - fl1_fgb * fl1_fx * ts_yz_yzzz_0[j];
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tpz_zzz_xxxz_0[j] = pa_z[j] * tpz_zz_xxxz_0[j] + fl1_fx * tpz_z_xxxz_0[j] + 0.5 * fl1_fx * tpz_zz_xxx_0[j] - fl1_fgb * fl1_fx * ts_zz_xxxz_0[j];
                ...
                tpz_zzz_xxyz_0[j] = pa_z[j] * tpz_zz_xxyz_0[j] + fl1_fx * tpz_z_xxyz_0[j] + 0.5 * fl1_fx * tpz_zz_xxy_0[j] - fl1_fgb * fl1_fx * ts_zz_xxyz_0[j];
                ...
                tpz_zzz_xyyz_0[j] = pa_z[j] * tpz_zz_xyyz_0[j] + fl1_fx * tpz_z_xyyz_0[j] + 0.5 * fl1_fx * tpz_zz_xyy_0[j] - fl1_fgb * fl1_fx * ts_zz_xyyz_0[j];
                ...
                tpz_zzz_xzzz_0[j] = pa_z[j] * tpz_zz_xzzz_0[j] + fl1_fx * tpz_z_xzzz_0[j] + 1.5 * fl1_fx * tpz_zz_xzz_0[j] - fl1_fgb * fl1_fx * ts_zz_xzzz_0[j];
                ...
                tpz_zzz_yyyz_0[j] = pa_z[j] * tpz_zz_yyyz_0[j] + fl1_fx * tpz_z_yyyz_0[j] + 0.5 * fl1_fx * tpz_zz_yyy_0[j] - fl1_fgb * fl1_fx * ts_zz_yyyz_0[j];
                ...
                tpz_zzz_yzzz_0[j] = pa_z[j] * tpz_zz_yzzz_0[j] + fl1_fx * tpz_z_yzzz_0[j] + 1.5 * fl1_fx * tpz_zz_yzz_0[j] - fl1_fgb * fl1_fx * ts_zz_yzzz_0[j];
                ...
                tpz_zzz_zzzz_0[j] = pa_z[j] * tpz_zz_zzzz_0[j] + fl1_fx * tpz_z_zzzz_0[j] + 2.0 * fl1_fx * tpz_zz_zzz_0[j] - fl1_fgb * fl1_fx * ts_zz_zzzz_0[j];
            }
