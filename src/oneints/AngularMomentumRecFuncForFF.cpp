...
namespace amomrecfunc { // amomrecfunc namespace
    ...
    {
        amomrecfunc::compAngularMomentumForFF_0_50(primBuffer,
                                                   recursionMap,
                                                   osFactors,
                                                   paDistances, 
                                                   braGtoBlock,
        ...
        amomrecfunc::compAngularMomentumForFF_50_100(primBuffer,
                                                     recursionMap,
                                                     osFactors,
                                                     paDistances, 
                                                     braGtoBlock,
        ...
        amomrecfunc::compAngularMomentumForFF_100_150(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      paDistances, 
                                                      braGtoBlock,
        ...
        amomrecfunc::compAngularMomentumForFF_150_200(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      paDistances, 
                                                      braGtoBlock,
        ...
        amomrecfunc::compAngularMomentumForFF_200_250(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      paDistances, 
                                                      braGtoBlock,
        ...
        amomrecfunc::compAngularMomentumForFF_250_300(primBuffer,
                                                      recursionMap,
                                                      osFactors,
                                                      paDistances, 
                                                      braGtoBlock,
                                  ...
                                  const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tly_xxx_xxx_0[j] = pa_x[j] * tly_xx_xxx_0[j] + fl1_fx * tly_x_xxx_0[j] + 1.5 * fl1_fx * tly_xx_xx_0[j] + 0.5 * fl1_fx * tpz_xx_xxx_0[j] + fl1_fx * fl1_fgb * tdz_xx_xxx_0[j];

                tlz_xxx_xxx_0[j] = pa_x[j] * tlz_xx_xxx_0[j] + fl1_fx * tlz_x_xxx_0[j] + 1.5 * fl1_fx * tlz_xx_xx_0[j] - 0.5 * fl1_fx * tpy_xx_xxx_0[j] - fl1_fx * fl1_fgb * tdy_xx_xxx_0[j];

                tlx_xxx_xxy_0[j] = pa_x[j] * tlx_xx_xxy_0[j] + fl1_fx * tlx_x_xxy_0[j] + fl1_fx * tlx_xx_xy_0[j];

                tly_xxx_xxy_0[j] = pa_x[j] * tly_xx_xxy_0[j] + fl1_fx * tly_x_xxy_0[j] + fl1_fx * tly_xx_xy_0[j] + 0.5 * fl1_fx * tpz_xx_xxy_0[j] + fl1_fx * fl1_fgb * tdz_xx_xxy_0[j];

                tlz_xxx_xxy_0[j] = pa_x[j] * tlz_xx_xxy_0[j] + fl1_fx * tlz_x_xxy_0[j] + fl1_fx * tlz_xx_xy_0[j] - 0.5 * fl1_fx * tpy_xx_xxy_0[j] - fl1_fx * fl1_fgb * tdy_xx_xxy_0[j];

                tlx_xxx_xxz_0[j] = pa_x[j] * tlx_xx_xxz_0[j] + fl1_fx * tlx_x_xxz_0[j] + fl1_fx * tlx_xx_xz_0[j];

                tly_xxx_xxz_0[j] = pa_x[j] * tly_xx_xxz_0[j] + fl1_fx * tly_x_xxz_0[j] + fl1_fx * tly_xx_xz_0[j] + 0.5 * fl1_fx * tpz_xx_xxz_0[j] + fl1_fx * fl1_fgb * tdz_xx_xxz_0[j];

                tlz_xxx_xxz_0[j] = pa_x[j] * tlz_xx_xxz_0[j] + fl1_fx * tlz_x_xxz_0[j] + fl1_fx * tlz_xx_xz_0[j] - 0.5 * fl1_fx * tpy_xx_xxz_0[j] - fl1_fx * fl1_fgb * tdy_xx_xxz_0[j];

                tlx_xxx_xyy_0[j] = pa_x[j] * tlx_xx_xyy_0[j] + fl1_fx * tlx_x_xyy_0[j] + 0.5 * fl1_fx * tlx_xx_yy_0[j];

                tly_xxx_xyy_0[j] = pa_x[j] * tly_xx_xyy_0[j] + fl1_fx * tly_x_xyy_0[j] + 0.5 * fl1_fx * tly_xx_yy_0[j] + 0.5 * fl1_fx * tpz_xx_xyy_0[j] + fl1_fx * fl1_fgb * tdz_xx_xyy_0[j];

                tlz_xxx_xyy_0[j] = pa_x[j] * tlz_xx_xyy_0[j] + fl1_fx * tlz_x_xyy_0[j] + 0.5 * fl1_fx * tlz_xx_yy_0[j] - 0.5 * fl1_fx * tpy_xx_xyy_0[j] - fl1_fx * fl1_fgb * tdy_xx_xyy_0[j];

                tlx_xxx_xyz_0[j] = pa_x[j] * tlx_xx_xyz_0[j] + fl1_fx * tlx_x_xyz_0[j] + 0.5 * fl1_fx * tlx_xx_yz_0[j];

                tly_xxx_xyz_0[j] = pa_x[j] * tly_xx_xyz_0[j] + fl1_fx * tly_x_xyz_0[j] + 0.5 * fl1_fx * tly_xx_yz_0[j] + 0.5 * fl1_fx * tpz_xx_xyz_0[j] + fl1_fx * fl1_fgb * tdz_xx_xyz_0[j];

                tlz_xxx_xyz_0[j] = pa_x[j] * tlz_xx_xyz_0[j] + fl1_fx * tlz_x_xyz_0[j] + 0.5 * fl1_fx * tlz_xx_yz_0[j] - 0.5 * fl1_fx * tpy_xx_xyz_0[j] - fl1_fx * fl1_fgb * tdy_xx_xyz_0[j];

                tlx_xxx_xzz_0[j] = pa_x[j] * tlx_xx_xzz_0[j] + fl1_fx * tlx_x_xzz_0[j] + 0.5 * fl1_fx * tlx_xx_zz_0[j];

                tly_xxx_xzz_0[j] = pa_x[j] * tly_xx_xzz_0[j] + fl1_fx * tly_x_xzz_0[j] + 0.5 * fl1_fx * tly_xx_zz_0[j] + 0.5 * fl1_fx * tpz_xx_xzz_0[j] + fl1_fx * fl1_fgb * tdz_xx_xzz_0[j];

                tlz_xxx_xzz_0[j] = pa_x[j] * tlz_xx_xzz_0[j] + fl1_fx * tlz_x_xzz_0[j] + 0.5 * fl1_fx * tlz_xx_zz_0[j] - 0.5 * fl1_fx * tpy_xx_xzz_0[j] - fl1_fx * fl1_fgb * tdy_xx_xzz_0[j];

                tlx_xxx_yyy_0[j] = pa_x[j] * tlx_xx_yyy_0[j] + fl1_fx * tlx_x_yyy_0[j];

                tly_xxx_yyy_0[j] = pa_x[j] * tly_xx_yyy_0[j] + fl1_fx * tly_x_yyy_0[j] + 0.5 * fl1_fx * tpz_xx_yyy_0[j] + fl1_fx * fl1_fgb * tdz_xx_yyy_0[j];

                tlz_xxx_yyy_0[j] = pa_x[j] * tlz_xx_yyy_0[j] + fl1_fx * tlz_x_yyy_0[j] - 0.5 * fl1_fx * tpy_xx_yyy_0[j] - fl1_fx * fl1_fgb * tdy_xx_yyy_0[j];

                tlx_xxx_yyz_0[j] = pa_x[j] * tlx_xx_yyz_0[j] + fl1_fx * tlx_x_yyz_0[j];

                tly_xxx_yyz_0[j] = pa_x[j] * tly_xx_yyz_0[j] + fl1_fx * tly_x_yyz_0[j] + 0.5 * fl1_fx * tpz_xx_yyz_0[j] + fl1_fx * fl1_fgb * tdz_xx_yyz_0[j];

                tlz_xxx_yyz_0[j] = pa_x[j] * tlz_xx_yyz_0[j] + fl1_fx * tlz_x_yyz_0[j] - 0.5 * fl1_fx * tpy_xx_yyz_0[j] - fl1_fx * fl1_fgb * tdy_xx_yyz_0[j];

                tlx_xxx_yzz_0[j] = pa_x[j] * tlx_xx_yzz_0[j] + fl1_fx * tlx_x_yzz_0[j];

                tly_xxx_yzz_0[j] = pa_x[j] * tly_xx_yzz_0[j] + fl1_fx * tly_x_yzz_0[j] + 0.5 * fl1_fx * tpz_xx_yzz_0[j] + fl1_fx * fl1_fgb * tdz_xx_yzz_0[j];

                tlz_xxx_yzz_0[j] = pa_x[j] * tlz_xx_yzz_0[j] + fl1_fx * tlz_x_yzz_0[j] - 0.5 * fl1_fx * tpy_xx_yzz_0[j] - fl1_fx * fl1_fgb * tdy_xx_yzz_0[j];

                tlx_xxx_zzz_0[j] = pa_x[j] * tlx_xx_zzz_0[j] + fl1_fx * tlx_x_zzz_0[j];

                tly_xxx_zzz_0[j] = pa_x[j] * tly_xx_zzz_0[j] + fl1_fx * tly_x_zzz_0[j] + 0.5 * fl1_fx * tpz_xx_zzz_0[j] + fl1_fx * fl1_fgb * tdz_xx_zzz_0[j];

                tlz_xxx_zzz_0[j] = pa_x[j] * tlz_xx_zzz_0[j] + fl1_fx * tlz_x_zzz_0[j] - 0.5 * fl1_fx * tpy_xx_zzz_0[j] - fl1_fx * fl1_fgb * tdy_xx_zzz_0[j];

                tlx_xxy_xxx_0[j] = pa_x[j] * tlx_xy_xxx_0[j] + 0.5 * fl1_fx * tlx_y_xxx_0[j] + 1.5 * fl1_fx * tlx_xy_xx_0[j];

                tly_xxy_xxx_0[j] = pa_x[j] * tly_xy_xxx_0[j] + 0.5 * fl1_fx * tly_y_xxx_0[j] + 1.5 * fl1_fx * tly_xy_xx_0[j] + 0.5 * fl1_fx * tpz_xy_xxx_0[j] + fl1_fx * fl1_fgb * tdz_xy_xxx_0[j];

                tlz_xxy_xxx_0[j] = pa_x[j] * tlz_xy_xxx_0[j] + 0.5 * fl1_fx * tlz_y_xxx_0[j] + 1.5 * fl1_fx * tlz_xy_xx_0[j] - 0.5 * fl1_fx * tpy_xy_xxx_0[j] - fl1_fx * fl1_fgb * tdy_xy_xxx_0[j];

                tlx_xxy_xxy_0[j] = pa_x[j] * tlx_xy_xxy_0[j] + 0.5 * fl1_fx * tlx_y_xxy_0[j] + fl1_fx * tlx_xy_xy_0[j];

                tly_xxy_xxy_0[j] = pa_x[j] * tly_xy_xxy_0[j] + 0.5 * fl1_fx * tly_y_xxy_0[j] + fl1_fx * tly_xy_xy_0[j] + 0.5 * fl1_fx * tpz_xy_xxy_0[j] + fl1_fx * fl1_fgb * tdz_xy_xxy_0[j];

                tlz_xxy_xxy_0[j] = pa_x[j] * tlz_xy_xxy_0[j] + 0.5 * fl1_fx * tlz_y_xxy_0[j] + fl1_fx * tlz_xy_xy_0[j] - 0.5 * fl1_fx * tpy_xy_xxy_0[j] - fl1_fx * fl1_fgb * tdy_xy_xxy_0[j];

                tlx_xxy_xxz_0[j] = pa_x[j] * tlx_xy_xxz_0[j] + 0.5 * fl1_fx * tlx_y_xxz_0[j] + fl1_fx * tlx_xy_xz_0[j];

                tly_xxy_xxz_0[j] = pa_x[j] * tly_xy_xxz_0[j] + 0.5 * fl1_fx * tly_y_xxz_0[j] + fl1_fx * tly_xy_xz_0[j] + 0.5 * fl1_fx * tpz_xy_xxz_0[j] + fl1_fx * fl1_fgb * tdz_xy_xxz_0[j];

                tlz_xxy_xxz_0[j] = pa_x[j] * tlz_xy_xxz_0[j] + 0.5 * fl1_fx * tlz_y_xxz_0[j] + fl1_fx * tlz_xy_xz_0[j] - 0.5 * fl1_fx * tpy_xy_xxz_0[j] - fl1_fx * fl1_fgb * tdy_xy_xxz_0[j];

                tlx_xxy_xyy_0[j] = pa_x[j] * tlx_xy_xyy_0[j] + 0.5 * fl1_fx * tlx_y_xyy_0[j] + 0.5 * fl1_fx * tlx_xy_yy_0[j];

                tly_xxy_xyy_0[j] = pa_x[j] * tly_xy_xyy_0[j] + 0.5 * fl1_fx * tly_y_xyy_0[j] + 0.5 * fl1_fx * tly_xy_yy_0[j] + 0.5 * fl1_fx * tpz_xy_xyy_0[j] + fl1_fx * fl1_fgb * tdz_xy_xyy_0[j];

                tlz_xxy_xyy_0[j] = pa_x[j] * tlz_xy_xyy_0[j] + 0.5 * fl1_fx * tlz_y_xyy_0[j] + 0.5 * fl1_fx * tlz_xy_yy_0[j] - 0.5 * fl1_fx * tpy_xy_xyy_0[j] - fl1_fx * fl1_fgb * tdy_xy_xyy_0[j];

                tlx_xxy_xyz_0[j] = pa_x[j] * tlx_xy_xyz_0[j] + 0.5 * fl1_fx * tlx_y_xyz_0[j] + 0.5 * fl1_fx * tlx_xy_yz_0[j];

                tly_xxy_xyz_0[j] = pa_x[j] * tly_xy_xyz_0[j] + 0.5 * fl1_fx * tly_y_xyz_0[j] + 0.5 * fl1_fx * tly_xy_yz_0[j] + 0.5 * fl1_fx * tpz_xy_xyz_0[j] + fl1_fx * fl1_fgb * tdz_xy_xyz_0[j];

                tlz_xxy_xyz_0[j] = pa_x[j] * tlz_xy_xyz_0[j] + 0.5 * fl1_fx * tlz_y_xyz_0[j] + 0.5 * fl1_fx * tlz_xy_yz_0[j] - 0.5 * fl1_fx * tpy_xy_xyz_0[j] - fl1_fx * fl1_fgb * tdy_xy_xyz_0[j];

                tlx_xxy_xzz_0[j] = pa_x[j] * tlx_xy_xzz_0[j] + 0.5 * fl1_fx * tlx_y_xzz_0[j] + 0.5 * fl1_fx * tlx_xy_zz_0[j];

                tly_xxy_xzz_0[j] = pa_x[j] * tly_xy_xzz_0[j] + 0.5 * fl1_fx * tly_y_xzz_0[j] + 0.5 * fl1_fx * tly_xy_zz_0[j] + 0.5 * fl1_fx * tpz_xy_xzz_0[j] + fl1_fx * fl1_fgb * tdz_xy_xzz_0[j];

                tlz_xxy_xzz_0[j] = pa_x[j] * tlz_xy_xzz_0[j] + 0.5 * fl1_fx * tlz_y_xzz_0[j] + 0.5 * fl1_fx * tlz_xy_zz_0[j] - 0.5 * fl1_fx * tpy_xy_xzz_0[j] - fl1_fx * fl1_fgb * tdy_xy_xzz_0[j];

                tlx_xxy_yyy_0[j] = pa_x[j] * tlx_xy_yyy_0[j] + 0.5 * fl1_fx * tlx_y_yyy_0[j];

                tly_xxy_yyy_0[j] = pa_x[j] * tly_xy_yyy_0[j] + 0.5 * fl1_fx * tly_y_yyy_0[j] + 0.5 * fl1_fx * tpz_xy_yyy_0[j] + fl1_fx * fl1_fgb * tdz_xy_yyy_0[j];
            }
                                    ...
                                    const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tlz_xxy_yyy_0[j] = pa_x[j] * tlz_xy_yyy_0[j] + 0.5 * fl1_fx * tlz_y_yyy_0[j] - 0.5 * fl1_fx * tpy_xy_yyy_0[j] - fl1_fx * fl1_fgb * tdy_xy_yyy_0[j];

                tlx_xxy_yyz_0[j] = pa_x[j] * tlx_xy_yyz_0[j] + 0.5 * fl1_fx * tlx_y_yyz_0[j];

                tly_xxy_yyz_0[j] = pa_x[j] * tly_xy_yyz_0[j] + 0.5 * fl1_fx * tly_y_yyz_0[j] + 0.5 * fl1_fx * tpz_xy_yyz_0[j] + fl1_fx * fl1_fgb * tdz_xy_yyz_0[j];

                tlz_xxy_yyz_0[j] = pa_x[j] * tlz_xy_yyz_0[j] + 0.5 * fl1_fx * tlz_y_yyz_0[j] - 0.5 * fl1_fx * tpy_xy_yyz_0[j] - fl1_fx * fl1_fgb * tdy_xy_yyz_0[j];

                tlx_xxy_yzz_0[j] = pa_x[j] * tlx_xy_yzz_0[j] + 0.5 * fl1_fx * tlx_y_yzz_0[j];

                tly_xxy_yzz_0[j] = pa_x[j] * tly_xy_yzz_0[j] + 0.5 * fl1_fx * tly_y_yzz_0[j] + 0.5 * fl1_fx * tpz_xy_yzz_0[j] + fl1_fx * fl1_fgb * tdz_xy_yzz_0[j];

                tlz_xxy_yzz_0[j] = pa_x[j] * tlz_xy_yzz_0[j] + 0.5 * fl1_fx * tlz_y_yzz_0[j] - 0.5 * fl1_fx * tpy_xy_yzz_0[j] - fl1_fx * fl1_fgb * tdy_xy_yzz_0[j];

                tlx_xxy_zzz_0[j] = pa_x[j] * tlx_xy_zzz_0[j] + 0.5 * fl1_fx * tlx_y_zzz_0[j];

                tly_xxy_zzz_0[j] = pa_x[j] * tly_xy_zzz_0[j] + 0.5 * fl1_fx * tly_y_zzz_0[j] + 0.5 * fl1_fx * tpz_xy_zzz_0[j] + fl1_fx * fl1_fgb * tdz_xy_zzz_0[j];

                tlz_xxy_zzz_0[j] = pa_x[j] * tlz_xy_zzz_0[j] + 0.5 * fl1_fx * tlz_y_zzz_0[j] - 0.5 * fl1_fx * tpy_xy_zzz_0[j] - fl1_fx * fl1_fgb * tdy_xy_zzz_0[j];

                tlx_xxz_xxx_0[j] = pa_x[j] * tlx_xz_xxx_0[j] + 0.5 * fl1_fx * tlx_z_xxx_0[j] + 1.5 * fl1_fx * tlx_xz_xx_0[j];

                tly_xxz_xxx_0[j] = pa_x[j] * tly_xz_xxx_0[j] + 0.5 * fl1_fx * tly_z_xxx_0[j] + 1.5 * fl1_fx * tly_xz_xx_0[j] + 0.5 * fl1_fx * tpz_xz_xxx_0[j] + fl1_fx * fl1_fgb * tdz_xz_xxx_0[j];

                tlz_xxz_xxx_0[j] = pa_x[j] * tlz_xz_xxx_0[j] + 0.5 * fl1_fx * tlz_z_xxx_0[j] + 1.5 * fl1_fx * tlz_xz_xx_0[j] - 0.5 * fl1_fx * tpy_xz_xxx_0[j] - fl1_fx * fl1_fgb * tdy_xz_xxx_0[j];

                tlx_xxz_xxy_0[j] = pa_x[j] * tlx_xz_xxy_0[j] + 0.5 * fl1_fx * tlx_z_xxy_0[j] + fl1_fx * tlx_xz_xy_0[j];

                tly_xxz_xxy_0[j] = pa_x[j] * tly_xz_xxy_0[j] + 0.5 * fl1_fx * tly_z_xxy_0[j] + fl1_fx * tly_xz_xy_0[j] + 0.5 * fl1_fx * tpz_xz_xxy_0[j] + fl1_fx * fl1_fgb * tdz_xz_xxy_0[j];

                tlz_xxz_xxy_0[j] = pa_x[j] * tlz_xz_xxy_0[j] + 0.5 * fl1_fx * tlz_z_xxy_0[j] + fl1_fx * tlz_xz_xy_0[j] - 0.5 * fl1_fx * tpy_xz_xxy_0[j] - fl1_fx * fl1_fgb * tdy_xz_xxy_0[j];

                tlx_xxz_xxz_0[j] = pa_x[j] * tlx_xz_xxz_0[j] + 0.5 * fl1_fx * tlx_z_xxz_0[j] + fl1_fx * tlx_xz_xz_0[j];

                tly_xxz_xxz_0[j] = pa_x[j] * tly_xz_xxz_0[j] + 0.5 * fl1_fx * tly_z_xxz_0[j] + fl1_fx * tly_xz_xz_0[j] + 0.5 * fl1_fx * tpz_xz_xxz_0[j] + fl1_fx * fl1_fgb * tdz_xz_xxz_0[j];

                tlz_xxz_xxz_0[j] = pa_x[j] * tlz_xz_xxz_0[j] + 0.5 * fl1_fx * tlz_z_xxz_0[j] + fl1_fx * tlz_xz_xz_0[j] - 0.5 * fl1_fx * tpy_xz_xxz_0[j] - fl1_fx * fl1_fgb * tdy_xz_xxz_0[j];

                tlx_xxz_xyy_0[j] = pa_x[j] * tlx_xz_xyy_0[j] + 0.5 * fl1_fx * tlx_z_xyy_0[j] + 0.5 * fl1_fx * tlx_xz_yy_0[j];

                tly_xxz_xyy_0[j] = pa_x[j] * tly_xz_xyy_0[j] + 0.5 * fl1_fx * tly_z_xyy_0[j] + 0.5 * fl1_fx * tly_xz_yy_0[j] + 0.5 * fl1_fx * tpz_xz_xyy_0[j] + fl1_fx * fl1_fgb * tdz_xz_xyy_0[j];

                tlz_xxz_xyy_0[j] = pa_x[j] * tlz_xz_xyy_0[j] + 0.5 * fl1_fx * tlz_z_xyy_0[j] + 0.5 * fl1_fx * tlz_xz_yy_0[j] - 0.5 * fl1_fx * tpy_xz_xyy_0[j] - fl1_fx * fl1_fgb * tdy_xz_xyy_0[j];

                tlx_xxz_xyz_0[j] = pa_x[j] * tlx_xz_xyz_0[j] + 0.5 * fl1_fx * tlx_z_xyz_0[j] + 0.5 * fl1_fx * tlx_xz_yz_0[j];

                tly_xxz_xyz_0[j] = pa_x[j] * tly_xz_xyz_0[j] + 0.5 * fl1_fx * tly_z_xyz_0[j] + 0.5 * fl1_fx * tly_xz_yz_0[j] + 0.5 * fl1_fx * tpz_xz_xyz_0[j] + fl1_fx * fl1_fgb * tdz_xz_xyz_0[j];

                tlz_xxz_xyz_0[j] = pa_x[j] * tlz_xz_xyz_0[j] + 0.5 * fl1_fx * tlz_z_xyz_0[j] + 0.5 * fl1_fx * tlz_xz_yz_0[j] - 0.5 * fl1_fx * tpy_xz_xyz_0[j] - fl1_fx * fl1_fgb * tdy_xz_xyz_0[j];

                tlx_xxz_xzz_0[j] = pa_x[j] * tlx_xz_xzz_0[j] + 0.5 * fl1_fx * tlx_z_xzz_0[j] + 0.5 * fl1_fx * tlx_xz_zz_0[j];

                tly_xxz_xzz_0[j] = pa_x[j] * tly_xz_xzz_0[j] + 0.5 * fl1_fx * tly_z_xzz_0[j] + 0.5 * fl1_fx * tly_xz_zz_0[j] + 0.5 * fl1_fx * tpz_xz_xzz_0[j] + fl1_fx * fl1_fgb * tdz_xz_xzz_0[j];

                tlz_xxz_xzz_0[j] = pa_x[j] * tlz_xz_xzz_0[j] + 0.5 * fl1_fx * tlz_z_xzz_0[j] + 0.5 * fl1_fx * tlz_xz_zz_0[j] - 0.5 * fl1_fx * tpy_xz_xzz_0[j] - fl1_fx * fl1_fgb * tdy_xz_xzz_0[j];

                tlx_xxz_yyy_0[j] = pa_x[j] * tlx_xz_yyy_0[j] + 0.5 * fl1_fx * tlx_z_yyy_0[j];

                tly_xxz_yyy_0[j] = pa_x[j] * tly_xz_yyy_0[j] + 0.5 * fl1_fx * tly_z_yyy_0[j] + 0.5 * fl1_fx * tpz_xz_yyy_0[j] + fl1_fx * fl1_fgb * tdz_xz_yyy_0[j];

                tlz_xxz_yyy_0[j] = pa_x[j] * tlz_xz_yyy_0[j] + 0.5 * fl1_fx * tlz_z_yyy_0[j] - 0.5 * fl1_fx * tpy_xz_yyy_0[j] - fl1_fx * fl1_fgb * tdy_xz_yyy_0[j];

                tlx_xxz_yyz_0[j] = pa_x[j] * tlx_xz_yyz_0[j] + 0.5 * fl1_fx * tlx_z_yyz_0[j];

                tly_xxz_yyz_0[j] = pa_x[j] * tly_xz_yyz_0[j] + 0.5 * fl1_fx * tly_z_yyz_0[j] + 0.5 * fl1_fx * tpz_xz_yyz_0[j] + fl1_fx * fl1_fgb * tdz_xz_yyz_0[j];

                tlz_xxz_yyz_0[j] = pa_x[j] * tlz_xz_yyz_0[j] + 0.5 * fl1_fx * tlz_z_yyz_0[j] - 0.5 * fl1_fx * tpy_xz_yyz_0[j] - fl1_fx * fl1_fgb * tdy_xz_yyz_0[j];

                tlx_xxz_yzz_0[j] = pa_x[j] * tlx_xz_yzz_0[j] + 0.5 * fl1_fx * tlx_z_yzz_0[j];

                tly_xxz_yzz_0[j] = pa_x[j] * tly_xz_yzz_0[j] + 0.5 * fl1_fx * tly_z_yzz_0[j] + 0.5 * fl1_fx * tpz_xz_yzz_0[j] + fl1_fx * fl1_fgb * tdz_xz_yzz_0[j];

                tlz_xxz_yzz_0[j] = pa_x[j] * tlz_xz_yzz_0[j] + 0.5 * fl1_fx * tlz_z_yzz_0[j] - 0.5 * fl1_fx * tpy_xz_yzz_0[j] - fl1_fx * fl1_fgb * tdy_xz_yzz_0[j];

                tlx_xxz_zzz_0[j] = pa_x[j] * tlx_xz_zzz_0[j] + 0.5 * fl1_fx * tlx_z_zzz_0[j];

                tly_xxz_zzz_0[j] = pa_x[j] * tly_xz_zzz_0[j] + 0.5 * fl1_fx * tly_z_zzz_0[j] + 0.5 * fl1_fx * tpz_xz_zzz_0[j] + fl1_fx * fl1_fgb * tdz_xz_zzz_0[j];

                tlz_xxz_zzz_0[j] = pa_x[j] * tlz_xz_zzz_0[j] + 0.5 * fl1_fx * tlz_z_zzz_0[j] - 0.5 * fl1_fx * tpy_xz_zzz_0[j] - fl1_fx * fl1_fgb * tdy_xz_zzz_0[j];

                tlx_xyy_xxx_0[j] = pa_x[j] * tlx_yy_xxx_0[j] + 1.5 * fl1_fx * tlx_yy_xx_0[j];

                tly_xyy_xxx_0[j] = pa_x[j] * tly_yy_xxx_0[j] + 1.5 * fl1_fx * tly_yy_xx_0[j] + 0.5 * fl1_fx * tpz_yy_xxx_0[j] + fl1_fx * fl1_fgb * tdz_yy_xxx_0[j];

                tlz_xyy_xxx_0[j] = pa_x[j] * tlz_yy_xxx_0[j] + 1.5 * fl1_fx * tlz_yy_xx_0[j] - 0.5 * fl1_fx * tpy_yy_xxx_0[j] - fl1_fx * fl1_fgb * tdy_yy_xxx_0[j];

                tlx_xyy_xxy_0[j] = pa_x[j] * tlx_yy_xxy_0[j] + fl1_fx * tlx_yy_xy_0[j];

                tly_xyy_xxy_0[j] = pa_x[j] * tly_yy_xxy_0[j] + fl1_fx * tly_yy_xy_0[j] + 0.5 * fl1_fx * tpz_yy_xxy_0[j] + fl1_fx * fl1_fgb * tdz_yy_xxy_0[j];

                tlz_xyy_xxy_0[j] = pa_x[j] * tlz_yy_xxy_0[j] + fl1_fx * tlz_yy_xy_0[j] - 0.5 * fl1_fx * tpy_yy_xxy_0[j] - fl1_fx * fl1_fgb * tdy_yy_xxy_0[j];

                tlx_xyy_xxz_0[j] = pa_x[j] * tlx_yy_xxz_0[j] + fl1_fx * tlx_yy_xz_0[j];

                tly_xyy_xxz_0[j] = pa_x[j] * tly_yy_xxz_0[j] + fl1_fx * tly_yy_xz_0[j] + 0.5 * fl1_fx * tpz_yy_xxz_0[j] + fl1_fx * fl1_fgb * tdz_yy_xxz_0[j];

                tlz_xyy_xxz_0[j] = pa_x[j] * tlz_yy_xxz_0[j] + fl1_fx * tlz_yy_xz_0[j] - 0.5 * fl1_fx * tpy_yy_xxz_0[j] - fl1_fx * fl1_fgb * tdy_yy_xxz_0[j];
                                     ...
                                     const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tly_xyy_xyy_0[j] = pa_x[j] * tly_yy_xyy_0[j] + 0.5 * fl1_fx * tly_yy_yy_0[j] + 0.5 * fl1_fx * tpz_yy_xyy_0[j] + fl1_fx * fl1_fgb * tdz_yy_xyy_0[j];

                tlz_xyy_xyy_0[j] = pa_x[j] * tlz_yy_xyy_0[j] + 0.5 * fl1_fx * tlz_yy_yy_0[j] - 0.5 * fl1_fx * tpy_yy_xyy_0[j] - fl1_fx * fl1_fgb * tdy_yy_xyy_0[j];

                tlx_xyy_xyz_0[j] = pa_x[j] * tlx_yy_xyz_0[j] + 0.5 * fl1_fx * tlx_yy_yz_0[j];

                tly_xyy_xyz_0[j] = pa_x[j] * tly_yy_xyz_0[j] + 0.5 * fl1_fx * tly_yy_yz_0[j] + 0.5 * fl1_fx * tpz_yy_xyz_0[j] + fl1_fx * fl1_fgb * tdz_yy_xyz_0[j];

                tlz_xyy_xyz_0[j] = pa_x[j] * tlz_yy_xyz_0[j] + 0.5 * fl1_fx * tlz_yy_yz_0[j] - 0.5 * fl1_fx * tpy_yy_xyz_0[j] - fl1_fx * fl1_fgb * tdy_yy_xyz_0[j];

                tlx_xyy_xzz_0[j] = pa_x[j] * tlx_yy_xzz_0[j] + 0.5 * fl1_fx * tlx_yy_zz_0[j];

                tly_xyy_xzz_0[j] = pa_x[j] * tly_yy_xzz_0[j] + 0.5 * fl1_fx * tly_yy_zz_0[j] + 0.5 * fl1_fx * tpz_yy_xzz_0[j] + fl1_fx * fl1_fgb * tdz_yy_xzz_0[j];

                tlz_xyy_xzz_0[j] = pa_x[j] * tlz_yy_xzz_0[j] + 0.5 * fl1_fx * tlz_yy_zz_0[j] - 0.5 * fl1_fx * tpy_yy_xzz_0[j] - fl1_fx * fl1_fgb * tdy_yy_xzz_0[j];
                ...
                tly_xyz_xxx_0[j] = pa_x[j] * tly_yz_xxx_0[j] + 1.5 * fl1_fx * tly_yz_xx_0[j] + 0.5 * fl1_fx * tpz_yz_xxx_0[j] + fl1_fx * fl1_fgb * tdz_yz_xxx_0[j];

                tlz_xyz_xxx_0[j] = pa_x[j] * tlz_yz_xxx_0[j] + 1.5 * fl1_fx * tlz_yz_xx_0[j] - 0.5 * fl1_fx * tpy_yz_xxx_0[j] - fl1_fx * fl1_fgb * tdy_yz_xxx_0[j];

                tlx_xyz_xxy_0[j] = pa_x[j] * tlx_yz_xxy_0[j] + fl1_fx * tlx_yz_xy_0[j];

                tly_xyz_xxy_0[j] = pa_x[j] * tly_yz_xxy_0[j] + fl1_fx * tly_yz_xy_0[j] + 0.5 * fl1_fx * tpz_yz_xxy_0[j] + fl1_fx * fl1_fgb * tdz_yz_xxy_0[j];

                tlz_xyz_xxy_0[j] = pa_x[j] * tlz_yz_xxy_0[j] + fl1_fx * tlz_yz_xy_0[j] - 0.5 * fl1_fx * tpy_yz_xxy_0[j] - fl1_fx * fl1_fgb * tdy_yz_xxy_0[j];

                tlx_xyz_xxz_0[j] = pa_x[j] * tlx_yz_xxz_0[j] + fl1_fx * tlx_yz_xz_0[j];

                tly_xyz_xxz_0[j] = pa_x[j] * tly_yz_xxz_0[j] + fl1_fx * tly_yz_xz_0[j] + 0.5 * fl1_fx * tpz_yz_xxz_0[j] + fl1_fx * fl1_fgb * tdz_yz_xxz_0[j];

                tlz_xyz_xxz_0[j] = pa_x[j] * tlz_yz_xxz_0[j] + fl1_fx * tlz_yz_xz_0[j] - 0.5 * fl1_fx * tpy_yz_xxz_0[j] - fl1_fx * fl1_fgb * tdy_yz_xxz_0[j];

                tlx_xyz_xyy_0[j] = pa_x[j] * tlx_yz_xyy_0[j] + 0.5 * fl1_fx * tlx_yz_yy_0[j];

                tly_xyz_xyy_0[j] = pa_x[j] * tly_yz_xyy_0[j] + 0.5 * fl1_fx * tly_yz_yy_0[j] + 0.5 * fl1_fx * tpz_yz_xyy_0[j] + fl1_fx * fl1_fgb * tdz_yz_xyy_0[j];

                tlz_xyz_xyy_0[j] = pa_x[j] * tlz_yz_xyy_0[j] + 0.5 * fl1_fx * tlz_yz_yy_0[j] - 0.5 * fl1_fx * tpy_yz_xyy_0[j] - fl1_fx * fl1_fgb * tdy_yz_xyy_0[j];

                tlx_xyz_xyz_0[j] = pa_x[j] * tlx_yz_xyz_0[j] + 0.5 * fl1_fx * tlx_yz_yz_0[j];

                tly_xyz_xyz_0[j] = pa_x[j] * tly_yz_xyz_0[j] + 0.5 * fl1_fx * tly_yz_yz_0[j] + 0.5 * fl1_fx * tpz_yz_xyz_0[j] + fl1_fx * fl1_fgb * tdz_yz_xyz_0[j];

                tlz_xyz_xyz_0[j] = pa_x[j] * tlz_yz_xyz_0[j] + 0.5 * fl1_fx * tlz_yz_yz_0[j] - 0.5 * fl1_fx * tpy_yz_xyz_0[j] - fl1_fx * fl1_fgb * tdy_yz_xyz_0[j];

                tlx_xyz_xzz_0[j] = pa_x[j] * tlx_yz_xzz_0[j] + 0.5 * fl1_fx * tlx_yz_zz_0[j];

                tly_xyz_xzz_0[j] = pa_x[j] * tly_yz_xzz_0[j] + 0.5 * fl1_fx * tly_yz_zz_0[j] + 0.5 * fl1_fx * tpz_yz_xzz_0[j] + fl1_fx * fl1_fgb * tdz_yz_xzz_0[j];

                tlz_xyz_xzz_0[j] = pa_x[j] * tlz_yz_xzz_0[j] + 0.5 * fl1_fx * tlz_yz_zz_0[j] - 0.5 * fl1_fx * tpy_yz_xzz_0[j] - fl1_fx * fl1_fgb * tdy_yz_xzz_0[j];
                                     ...
                                     const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tly_xzz_xxx_0[j] = pa_x[j] * tly_zz_xxx_0[j] + 1.5 * fl1_fx * tly_zz_xx_0[j] + 0.5 * fl1_fx * tpz_zz_xxx_0[j] + fl1_fx * fl1_fgb * tdz_zz_xxx_0[j];

                tlz_xzz_xxx_0[j] = pa_x[j] * tlz_zz_xxx_0[j] + 1.5 * fl1_fx * tlz_zz_xx_0[j] - 0.5 * fl1_fx * tpy_zz_xxx_0[j] - fl1_fx * fl1_fgb * tdy_zz_xxx_0[j];

                tlx_xzz_xxy_0[j] = pa_x[j] * tlx_zz_xxy_0[j] + fl1_fx * tlx_zz_xy_0[j];

                tly_xzz_xxy_0[j] = pa_x[j] * tly_zz_xxy_0[j] + fl1_fx * tly_zz_xy_0[j] + 0.5 * fl1_fx * tpz_zz_xxy_0[j] + fl1_fx * fl1_fgb * tdz_zz_xxy_0[j];

                tlz_xzz_xxy_0[j] = pa_x[j] * tlz_zz_xxy_0[j] + fl1_fx * tlz_zz_xy_0[j] - 0.5 * fl1_fx * tpy_zz_xxy_0[j] - fl1_fx * fl1_fgb * tdy_zz_xxy_0[j];

                tlx_xzz_xxz_0[j] = pa_x[j] * tlx_zz_xxz_0[j] + fl1_fx * tlx_zz_xz_0[j];

                tly_xzz_xxz_0[j] = pa_x[j] * tly_zz_xxz_0[j] + fl1_fx * tly_zz_xz_0[j] + 0.5 * fl1_fx * tpz_zz_xxz_0[j] + fl1_fx * fl1_fgb * tdz_zz_xxz_0[j];

                tlz_xzz_xxz_0[j] = pa_x[j] * tlz_zz_xxz_0[j] + fl1_fx * tlz_zz_xz_0[j] - 0.5 * fl1_fx * tpy_zz_xxz_0[j] - fl1_fx * fl1_fgb * tdy_zz_xxz_0[j];

                tlx_xzz_xyy_0[j] = pa_x[j] * tlx_zz_xyy_0[j] + 0.5 * fl1_fx * tlx_zz_yy_0[j];

                tly_xzz_xyy_0[j] = pa_x[j] * tly_zz_xyy_0[j] + 0.5 * fl1_fx * tly_zz_yy_0[j] + 0.5 * fl1_fx * tpz_zz_xyy_0[j] + fl1_fx * fl1_fgb * tdz_zz_xyy_0[j];

                tlz_xzz_xyy_0[j] = pa_x[j] * tlz_zz_xyy_0[j] + 0.5 * fl1_fx * tlz_zz_yy_0[j] - 0.5 * fl1_fx * tpy_zz_xyy_0[j] - fl1_fx * fl1_fgb * tdy_zz_xyy_0[j];

                tlx_xzz_xyz_0[j] = pa_x[j] * tlx_zz_xyz_0[j] + 0.5 * fl1_fx * tlx_zz_yz_0[j];

                tly_xzz_xyz_0[j] = pa_x[j] * tly_zz_xyz_0[j] + 0.5 * fl1_fx * tly_zz_yz_0[j] + 0.5 * fl1_fx * tpz_zz_xyz_0[j] + fl1_fx * fl1_fgb * tdz_zz_xyz_0[j];

                tlz_xzz_xyz_0[j] = pa_x[j] * tlz_zz_xyz_0[j] + 0.5 * fl1_fx * tlz_zz_yz_0[j] - 0.5 * fl1_fx * tpy_zz_xyz_0[j] - fl1_fx * fl1_fgb * tdy_zz_xyz_0[j];

                tlx_xzz_xzz_0[j] = pa_x[j] * tlx_zz_xzz_0[j] + 0.5 * fl1_fx * tlx_zz_zz_0[j];

                tly_xzz_xzz_0[j] = pa_x[j] * tly_zz_xzz_0[j] + 0.5 * fl1_fx * tly_zz_zz_0[j] + 0.5 * fl1_fx * tpz_zz_xzz_0[j] + fl1_fx * fl1_fgb * tdz_zz_xzz_0[j];

                tlz_xzz_xzz_0[j] = pa_x[j] * tlz_zz_xzz_0[j] + 0.5 * fl1_fx * tlz_zz_zz_0[j] - 0.5 * fl1_fx * tpy_zz_xzz_0[j] - fl1_fx * fl1_fgb * tdy_zz_xzz_0[j];
                ...
                tlx_yyy_xxx_0[j] = pa_y[j] * tlx_yy_xxx_0[j] + fl1_fx * tlx_y_xxx_0[j] - 0.5 * fl1_fx * tpz_yy_xxx_0[j] - fl1_fx * fl1_fgb * tdz_yy_xxx_0[j];

                tly_yyy_xxx_0[j] = pa_y[j] * tly_yy_xxx_0[j] + fl1_fx * tly_y_xxx_0[j];

                tlz_yyy_xxx_0[j] = pa_y[j] * tlz_yy_xxx_0[j] + fl1_fx * tlz_y_xxx_0[j] + 0.5 * fl1_fx * tpx_yy_xxx_0[j] + fl1_fx * fl1_fgb * tdx_yy_xxx_0[j];

                tlx_yyy_xxy_0[j] = pa_y[j] * tlx_yy_xxy_0[j] + fl1_fx * tlx_y_xxy_0[j] + 0.5 * fl1_fx * tlx_yy_xx_0[j] - 0.5 * fl1_fx * tpz_yy_xxy_0[j] - fl1_fx * fl1_fgb * tdz_yy_xxy_0[j];

                tly_yyy_xxy_0[j] = pa_y[j] * tly_yy_xxy_0[j] + fl1_fx * tly_y_xxy_0[j] + 0.5 * fl1_fx * tly_yy_xx_0[j];

                tlz_yyy_xxy_0[j] = pa_y[j] * tlz_yy_xxy_0[j] + fl1_fx * tlz_y_xxy_0[j] + 0.5 * fl1_fx * tlz_yy_xx_0[j] + 0.5 * fl1_fx * tpx_yy_xxy_0[j] + fl1_fx * fl1_fgb * tdx_yy_xxy_0[j];

                tlx_yyy_xxz_0[j] = pa_y[j] * tlx_yy_xxz_0[j] + fl1_fx * tlx_y_xxz_0[j] - 0.5 * fl1_fx * tpz_yy_xxz_0[j] - fl1_fx * fl1_fgb * tdz_yy_xxz_0[j];

                tly_yyy_xxz_0[j] = pa_y[j] * tly_yy_xxz_0[j] + fl1_fx * tly_y_xxz_0[j];

                tlz_yyy_xxz_0[j] = pa_y[j] * tlz_yy_xxz_0[j] + fl1_fx * tlz_y_xxz_0[j] + 0.5 * fl1_fx * tpx_yy_xxz_0[j] + fl1_fx * fl1_fgb * tdx_yy_xxz_0[j];

                tlx_yyy_xyy_0[j] = pa_y[j] * tlx_yy_xyy_0[j] + fl1_fx * tlx_y_xyy_0[j] + fl1_fx * tlx_yy_xy_0[j] - 0.5 * fl1_fx * tpz_yy_xyy_0[j] - fl1_fx * fl1_fgb * tdz_yy_xyy_0[j];

                tly_yyy_xyy_0[j] = pa_y[j] * tly_yy_xyy_0[j] + fl1_fx * tly_y_xyy_0[j] + fl1_fx * tly_yy_xy_0[j];

                tlz_yyy_xyy_0[j] = pa_y[j] * tlz_yy_xyy_0[j] + fl1_fx * tlz_y_xyy_0[j] + fl1_fx * tlz_yy_xy_0[j] + 0.5 * fl1_fx * tpx_yy_xyy_0[j] + fl1_fx * fl1_fgb * tdx_yy_xyy_0[j];

                tlx_yyy_xyz_0[j] = pa_y[j] * tlx_yy_xyz_0[j] + fl1_fx * tlx_y_xyz_0[j] + 0.5 * fl1_fx * tlx_yy_xz_0[j] - 0.5 * fl1_fx * tpz_yy_xyz_0[j] - fl1_fx * fl1_fgb * tdz_yy_xyz_0[j];

                tly_yyy_xyz_0[j] = pa_y[j] * tly_yy_xyz_0[j] + fl1_fx * tly_y_xyz_0[j] + 0.5 * fl1_fx * tly_yy_xz_0[j];

                tlz_yyy_xyz_0[j] = pa_y[j] * tlz_yy_xyz_0[j] + fl1_fx * tlz_y_xyz_0[j] + 0.5 * fl1_fx * tlz_yy_xz_0[j] + 0.5 * fl1_fx * tpx_yy_xyz_0[j] + fl1_fx * fl1_fgb * tdx_yy_xyz_0[j];

                tlx_yyy_xzz_0[j] = pa_y[j] * tlx_yy_xzz_0[j] + fl1_fx * tlx_y_xzz_0[j] - 0.5 * fl1_fx * tpz_yy_xzz_0[j] - fl1_fx * fl1_fgb * tdz_yy_xzz_0[j];

                tly_yyy_xzz_0[j] = pa_y[j] * tly_yy_xzz_0[j] + fl1_fx * tly_y_xzz_0[j];

                tlz_yyy_xzz_0[j] = pa_y[j] * tlz_yy_xzz_0[j] + fl1_fx * tlz_y_xzz_0[j] + 0.5 * fl1_fx * tpx_yy_xzz_0[j] + fl1_fx * fl1_fgb * tdx_yy_xzz_0[j];

                tlx_yyy_yyy_0[j] = pa_y[j] * tlx_yy_yyy_0[j] + fl1_fx * tlx_y_yyy_0[j] + 1.5 * fl1_fx * tlx_yy_yy_0[j] - 0.5 * fl1_fx * tpz_yy_yyy_0[j] - fl1_fx * fl1_fgb * tdz_yy_yyy_0[j];
                                     ...
                                     const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tlz_yyy_yyy_0[j] = pa_y[j] * tlz_yy_yyy_0[j] + fl1_fx * tlz_y_yyy_0[j] + 1.5 * fl1_fx * tlz_yy_yy_0[j] + 0.5 * fl1_fx * tpx_yy_yyy_0[j] + fl1_fx * fl1_fgb * tdx_yy_yyy_0[j];

                tlx_yyy_yyz_0[j] = pa_y[j] * tlx_yy_yyz_0[j] + fl1_fx * tlx_y_yyz_0[j] + fl1_fx * tlx_yy_yz_0[j] - 0.5 * fl1_fx * tpz_yy_yyz_0[j] - fl1_fx * fl1_fgb * tdz_yy_yyz_0[j];

                tly_yyy_yyz_0[j] = pa_y[j] * tly_yy_yyz_0[j] + fl1_fx * tly_y_yyz_0[j] + fl1_fx * tly_yy_yz_0[j];

                tlz_yyy_yyz_0[j] = pa_y[j] * tlz_yy_yyz_0[j] + fl1_fx * tlz_y_yyz_0[j] + fl1_fx * tlz_yy_yz_0[j] + 0.5 * fl1_fx * tpx_yy_yyz_0[j] + fl1_fx * fl1_fgb * tdx_yy_yyz_0[j];

                tlx_yyy_yzz_0[j] = pa_y[j] * tlx_yy_yzz_0[j] + fl1_fx * tlx_y_yzz_0[j] + 0.5 * fl1_fx * tlx_yy_zz_0[j] - 0.5 * fl1_fx * tpz_yy_yzz_0[j] - fl1_fx * fl1_fgb * tdz_yy_yzz_0[j];

                tly_yyy_yzz_0[j] = pa_y[j] * tly_yy_yzz_0[j] + fl1_fx * tly_y_yzz_0[j] + 0.5 * fl1_fx * tly_yy_zz_0[j];

                tlz_yyy_yzz_0[j] = pa_y[j] * tlz_yy_yzz_0[j] + fl1_fx * tlz_y_yzz_0[j] + 0.5 * fl1_fx * tlz_yy_zz_0[j] + 0.5 * fl1_fx * tpx_yy_yzz_0[j] + fl1_fx * fl1_fgb * tdx_yy_yzz_0[j];

                tlx_yyy_zzz_0[j] = pa_y[j] * tlx_yy_zzz_0[j] + fl1_fx * tlx_y_zzz_0[j] - 0.5 * fl1_fx * tpz_yy_zzz_0[j] - fl1_fx * fl1_fgb * tdz_yy_zzz_0[j];

                tly_yyy_zzz_0[j] = pa_y[j] * tly_yy_zzz_0[j] + fl1_fx * tly_y_zzz_0[j];

                tlz_yyy_zzz_0[j] = pa_y[j] * tlz_yy_zzz_0[j] + fl1_fx * tlz_y_zzz_0[j] + 0.5 * fl1_fx * tpx_yy_zzz_0[j] + fl1_fx * fl1_fgb * tdx_yy_zzz_0[j];

                tlx_yyz_xxx_0[j] = pa_y[j] * tlx_yz_xxx_0[j] + 0.5 * fl1_fx * tlx_z_xxx_0[j] - 0.5 * fl1_fx * tpz_yz_xxx_0[j] - fl1_fx * fl1_fgb * tdz_yz_xxx_0[j];

                tly_yyz_xxx_0[j] = pa_y[j] * tly_yz_xxx_0[j] + 0.5 * fl1_fx * tly_z_xxx_0[j];

                tlz_yyz_xxx_0[j] = pa_y[j] * tlz_yz_xxx_0[j] + 0.5 * fl1_fx * tlz_z_xxx_0[j] + 0.5 * fl1_fx * tpx_yz_xxx_0[j] + fl1_fx * fl1_fgb * tdx_yz_xxx_0[j];

                tlx_yyz_xxy_0[j] = pa_y[j] * tlx_yz_xxy_0[j] + 0.5 * fl1_fx * tlx_z_xxy_0[j] + 0.5 * fl1_fx * tlx_yz_xx_0[j] - 0.5 * fl1_fx * tpz_yz_xxy_0[j] - fl1_fx * fl1_fgb * tdz_yz_xxy_0[j];

                tly_yyz_xxy_0[j] = pa_y[j] * tly_yz_xxy_0[j] + 0.5 * fl1_fx * tly_z_xxy_0[j] + 0.5 * fl1_fx * tly_yz_xx_0[j];

                tlz_yyz_xxy_0[j] = pa_y[j] * tlz_yz_xxy_0[j] + 0.5 * fl1_fx * tlz_z_xxy_0[j] + 0.5 * fl1_fx * tlz_yz_xx_0[j] + 0.5 * fl1_fx * tpx_yz_xxy_0[j] + fl1_fx * fl1_fgb * tdx_yz_xxy_0[j];

                tlx_yyz_xxz_0[j] = pa_y[j] * tlx_yz_xxz_0[j] + 0.5 * fl1_fx * tlx_z_xxz_0[j] - 0.5 * fl1_fx * tpz_yz_xxz_0[j] - fl1_fx * fl1_fgb * tdz_yz_xxz_0[j];

                tly_yyz_xxz_0[j] = pa_y[j] * tly_yz_xxz_0[j] + 0.5 * fl1_fx * tly_z_xxz_0[j];

                tlz_yyz_xxz_0[j] = pa_y[j] * tlz_yz_xxz_0[j] + 0.5 * fl1_fx * tlz_z_xxz_0[j] + 0.5 * fl1_fx * tpx_yz_xxz_0[j] + fl1_fx * fl1_fgb * tdx_yz_xxz_0[j];

                tlx_yyz_xyy_0[j] = pa_y[j] * tlx_yz_xyy_0[j] + 0.5 * fl1_fx * tlx_z_xyy_0[j] + fl1_fx * tlx_yz_xy_0[j] - 0.5 * fl1_fx * tpz_yz_xyy_0[j] - fl1_fx * fl1_fgb * tdz_yz_xyy_0[j];

                tly_yyz_xyy_0[j] = pa_y[j] * tly_yz_xyy_0[j] + 0.5 * fl1_fx * tly_z_xyy_0[j] + fl1_fx * tly_yz_xy_0[j];

                tlz_yyz_xyy_0[j] = pa_y[j] * tlz_yz_xyy_0[j] + 0.5 * fl1_fx * tlz_z_xyy_0[j] + fl1_fx * tlz_yz_xy_0[j] + 0.5 * fl1_fx * tpx_yz_xyy_0[j] + fl1_fx * fl1_fgb * tdx_yz_xyy_0[j];

                tlx_yyz_xyz_0[j] = pa_y[j] * tlx_yz_xyz_0[j] + 0.5 * fl1_fx * tlx_z_xyz_0[j] + 0.5 * fl1_fx * tlx_yz_xz_0[j] - 0.5 * fl1_fx * tpz_yz_xyz_0[j] - fl1_fx * fl1_fgb * tdz_yz_xyz_0[j];

                tly_yyz_xyz_0[j] = pa_y[j] * tly_yz_xyz_0[j] + 0.5 * fl1_fx * tly_z_xyz_0[j] + 0.5 * fl1_fx * tly_yz_xz_0[j];

                tlz_yyz_xyz_0[j] = pa_y[j] * tlz_yz_xyz_0[j] + 0.5 * fl1_fx * tlz_z_xyz_0[j] + 0.5 * fl1_fx * tlz_yz_xz_0[j] + 0.5 * fl1_fx * tpx_yz_xyz_0[j] + fl1_fx * fl1_fgb * tdx_yz_xyz_0[j];

                tlx_yyz_xzz_0[j] = pa_y[j] * tlx_yz_xzz_0[j] + 0.5 * fl1_fx * tlx_z_xzz_0[j] - 0.5 * fl1_fx * tpz_yz_xzz_0[j] - fl1_fx * fl1_fgb * tdz_yz_xzz_0[j];

                tly_yyz_xzz_0[j] = pa_y[j] * tly_yz_xzz_0[j] + 0.5 * fl1_fx * tly_z_xzz_0[j];

                tlz_yyz_xzz_0[j] = pa_y[j] * tlz_yz_xzz_0[j] + 0.5 * fl1_fx * tlz_z_xzz_0[j] + 0.5 * fl1_fx * tpx_yz_xzz_0[j] + fl1_fx * fl1_fgb * tdx_yz_xzz_0[j];

                tlx_yyz_yyy_0[j] = pa_y[j] * tlx_yz_yyy_0[j] + 0.5 * fl1_fx * tlx_z_yyy_0[j] + 1.5 * fl1_fx * tlx_yz_yy_0[j] - 0.5 * fl1_fx * tpz_yz_yyy_0[j] - fl1_fx * fl1_fgb * tdz_yz_yyy_0[j];

                tly_yyz_yyy_0[j] = pa_y[j] * tly_yz_yyy_0[j] + 0.5 * fl1_fx * tly_z_yyy_0[j] + 1.5 * fl1_fx * tly_yz_yy_0[j];

                tlz_yyz_yyy_0[j] = pa_y[j] * tlz_yz_yyy_0[j] + 0.5 * fl1_fx * tlz_z_yyy_0[j] + 1.5 * fl1_fx * tlz_yz_yy_0[j] + 0.5 * fl1_fx * tpx_yz_yyy_0[j] + fl1_fx * fl1_fgb * tdx_yz_yyy_0[j];

                tlx_yyz_yyz_0[j] = pa_y[j] * tlx_yz_yyz_0[j] + 0.5 * fl1_fx * tlx_z_yyz_0[j] + fl1_fx * tlx_yz_yz_0[j] - 0.5 * fl1_fx * tpz_yz_yyz_0[j] - fl1_fx * fl1_fgb * tdz_yz_yyz_0[j];

                tly_yyz_yyz_0[j] = pa_y[j] * tly_yz_yyz_0[j] + 0.5 * fl1_fx * tly_z_yyz_0[j] + fl1_fx * tly_yz_yz_0[j];

                tlz_yyz_yyz_0[j] = pa_y[j] * tlz_yz_yyz_0[j] + 0.5 * fl1_fx * tlz_z_yyz_0[j] + fl1_fx * tlz_yz_yz_0[j] + 0.5 * fl1_fx * tpx_yz_yyz_0[j] + fl1_fx * fl1_fgb * tdx_yz_yyz_0[j];

                tlx_yyz_yzz_0[j] = pa_y[j] * tlx_yz_yzz_0[j] + 0.5 * fl1_fx * tlx_z_yzz_0[j] + 0.5 * fl1_fx * tlx_yz_zz_0[j] - 0.5 * fl1_fx * tpz_yz_yzz_0[j] - fl1_fx * fl1_fgb * tdz_yz_yzz_0[j];

                tly_yyz_yzz_0[j] = pa_y[j] * tly_yz_yzz_0[j] + 0.5 * fl1_fx * tly_z_yzz_0[j] + 0.5 * fl1_fx * tly_yz_zz_0[j];

                tlz_yyz_yzz_0[j] = pa_y[j] * tlz_yz_yzz_0[j] + 0.5 * fl1_fx * tlz_z_yzz_0[j] + 0.5 * fl1_fx * tlz_yz_zz_0[j] + 0.5 * fl1_fx * tpx_yz_yzz_0[j] + fl1_fx * fl1_fgb * tdx_yz_yzz_0[j];

                tlx_yyz_zzz_0[j] = pa_y[j] * tlx_yz_zzz_0[j] + 0.5 * fl1_fx * tlx_z_zzz_0[j] - 0.5 * fl1_fx * tpz_yz_zzz_0[j] - fl1_fx * fl1_fgb * tdz_yz_zzz_0[j];

                tly_yyz_zzz_0[j] = pa_y[j] * tly_yz_zzz_0[j] + 0.5 * fl1_fx * tly_z_zzz_0[j];

                tlz_yyz_zzz_0[j] = pa_y[j] * tlz_yz_zzz_0[j] + 0.5 * fl1_fx * tlz_z_zzz_0[j] + 0.5 * fl1_fx * tpx_yz_zzz_0[j] + fl1_fx * fl1_fgb * tdx_yz_zzz_0[j];
                ...
                tlx_yzz_xxy_0[j] = pa_y[j] * tlx_zz_xxy_0[j] + 0.5 * fl1_fx * tlx_zz_xx_0[j] - 0.5 * fl1_fx * tpz_zz_xxy_0[j] - fl1_fx * fl1_fgb * tdz_zz_xxy_0[j];

                tly_yzz_xxy_0[j] = pa_y[j] * tly_zz_xxy_0[j] + 0.5 * fl1_fx * tly_zz_xx_0[j];

                tlz_yzz_xxy_0[j] = pa_y[j] * tlz_zz_xxy_0[j] + 0.5 * fl1_fx * tlz_zz_xx_0[j] + 0.5 * fl1_fx * tpx_zz_xxy_0[j] + fl1_fx * fl1_fgb * tdx_zz_xxy_0[j];
                ...
                tlx_yzz_xyy_0[j] = pa_y[j] * tlx_zz_xyy_0[j] + fl1_fx * tlx_zz_xy_0[j] - 0.5 * fl1_fx * tpz_zz_xyy_0[j] - fl1_fx * fl1_fgb * tdz_zz_xyy_0[j];
            }
                                     ...
                                     const int32_t              iContrGto)
    {
        ...
        for (int32_t i = spos[iContrGto]; i < epos[iContrGto]; i++)
        {
            ...
            for (int32_t j = 0; j < nprim; j++)
            {
                ...
                tlz_yzz_xyy_0[j] = pa_y[j] * tlz_zz_xyy_0[j] + fl1_fx * tlz_zz_xy_0[j] + 0.5 * fl1_fx * tpx_zz_xyy_0[j] + fl1_fx * fl1_fgb * tdx_zz_xyy_0[j];

                tlx_yzz_xyz_0[j] = pa_y[j] * tlx_zz_xyz_0[j] + 0.5 * fl1_fx * tlx_zz_xz_0[j] - 0.5 * fl1_fx * tpz_zz_xyz_0[j] - fl1_fx * fl1_fgb * tdz_zz_xyz_0[j];

                tly_yzz_xyz_0[j] = pa_y[j] * tly_zz_xyz_0[j] + 0.5 * fl1_fx * tly_zz_xz_0[j];

                tlz_yzz_xyz_0[j] = pa_y[j] * tlz_zz_xyz_0[j] + 0.5 * fl1_fx * tlz_zz_xz_0[j] + 0.5 * fl1_fx * tpx_zz_xyz_0[j] + fl1_fx * fl1_fgb * tdx_zz_xyz_0[j];
                ...
                tlx_yzz_yyy_0[j] = pa_y[j] * tlx_zz_yyy_0[j] + 1.5 * fl1_fx * tlx_zz_yy_0[j] - 0.5 * fl1_fx * tpz_zz_yyy_0[j] - fl1_fx * fl1_fgb * tdz_zz_yyy_0[j];

                tly_yzz_yyy_0[j] = pa_y[j] * tly_zz_yyy_0[j] + 1.5 * fl1_fx * tly_zz_yy_0[j];

                tlz_yzz_yyy_0[j] = pa_y[j] * tlz_zz_yyy_0[j] + 1.5 * fl1_fx * tlz_zz_yy_0[j] + 0.5 * fl1_fx * tpx_zz_yyy_0[j] + fl1_fx * fl1_fgb * tdx_zz_yyy_0[j];

                tlx_yzz_yyz_0[j] = pa_y[j] * tlx_zz_yyz_0[j] + fl1_fx * tlx_zz_yz_0[j] - 0.5 * fl1_fx * tpz_zz_yyz_0[j] - fl1_fx * fl1_fgb * tdz_zz_yyz_0[j];

                tly_yzz_yyz_0[j] = pa_y[j] * tly_zz_yyz_0[j] + fl1_fx * tly_zz_yz_0[j];

                tlz_yzz_yyz_0[j] = pa_y[j] * tlz_zz_yyz_0[j] + fl1_fx * tlz_zz_yz_0[j] + 0.5 * fl1_fx * tpx_zz_yyz_0[j] + fl1_fx * fl1_fgb * tdx_zz_yyz_0[j];

                tlx_yzz_yzz_0[j] = pa_y[j] * tlx_zz_yzz_0[j] + 0.5 * fl1_fx * tlx_zz_zz_0[j] - 0.5 * fl1_fx * tpz_zz_yzz_0[j] - fl1_fx * fl1_fgb * tdz_zz_yzz_0[j];

                tly_yzz_yzz_0[j] = pa_y[j] * tly_zz_yzz_0[j] + 0.5 * fl1_fx * tly_zz_zz_0[j];

                tlz_yzz_yzz_0[j] = pa_y[j] * tlz_zz_yzz_0[j] + 0.5 * fl1_fx * tlz_zz_zz_0[j] + 0.5 * fl1_fx * tpx_zz_yzz_0[j] + fl1_fx * fl1_fgb * tdx_zz_yzz_0[j];
                ...
                tlx_zzz_xxx_0[j] = pa_z[j] * tlx_zz_xxx_0[j] + fl1_fx * tlx_z_xxx_0[j] + 0.5 * fl1_fx * tpy_zz_xxx_0[j] + fl1_fx * fl1_fgb * tdy_zz_xxx_0[j];

                tly_zzz_xxx_0[j] = pa_z[j] * tly_zz_xxx_0[j] + fl1_fx * tly_z_xxx_0[j] - 0.5 * fl1_fx * tpx_zz_xxx_0[j] - fl1_fx * fl1_fgb * tdx_zz_xxx_0[j];

                tlz_zzz_xxx_0[j] = pa_z[j] * tlz_zz_xxx_0[j] + fl1_fx * tlz_z_xxx_0[j];

                tlx_zzz_xxy_0[j] = pa_z[j] * tlx_zz_xxy_0[j] + fl1_fx * tlx_z_xxy_0[j] + 0.5 * fl1_fx * tpy_zz_xxy_0[j] + fl1_fx * fl1_fgb * tdy_zz_xxy_0[j];

                tly_zzz_xxy_0[j] = pa_z[j] * tly_zz_xxy_0[j] + fl1_fx * tly_z_xxy_0[j] - 0.5 * fl1_fx * tpx_zz_xxy_0[j] - fl1_fx * fl1_fgb * tdx_zz_xxy_0[j];

                tlz_zzz_xxy_0[j] = pa_z[j] * tlz_zz_xxy_0[j] + fl1_fx * tlz_z_xxy_0[j];

                tlx_zzz_xxz_0[j] = pa_z[j] * tlx_zz_xxz_0[j] + fl1_fx * tlx_z_xxz_0[j] + 0.5 * fl1_fx * tlx_zz_xx_0[j] + 0.5 * fl1_fx * tpy_zz_xxz_0[j] + fl1_fx * fl1_fgb * tdy_zz_xxz_0[j];

                tly_zzz_xxz_0[j] = pa_z[j] * tly_zz_xxz_0[j] + fl1_fx * tly_z_xxz_0[j] + 0.5 * fl1_fx * tly_zz_xx_0[j] - 0.5 * fl1_fx * tpx_zz_xxz_0[j] - fl1_fx * fl1_fgb * tdx_zz_xxz_0[j];

                tlz_zzz_xxz_0[j] = pa_z[j] * tlz_zz_xxz_0[j] + fl1_fx * tlz_z_xxz_0[j] + 0.5 * fl1_fx * tlz_zz_xx_0[j];

                tlx_zzz_xyy_0[j] = pa_z[j] * tlx_zz_xyy_0[j] + fl1_fx * tlx_z_xyy_0[j] + 0.5 * fl1_fx * tpy_zz_xyy_0[j] + fl1_fx * fl1_fgb * tdy_zz_xyy_0[j];

                tly_zzz_xyy_0[j] = pa_z[j] * tly_zz_xyy_0[j] + fl1_fx * tly_z_xyy_0[j] - 0.5 * fl1_fx * tpx_zz_xyy_0[j] - fl1_fx * fl1_fgb * tdx_zz_xyy_0[j];

                tlz_zzz_xyy_0[j] = pa_z[j] * tlz_zz_xyy_0[j] + fl1_fx * tlz_z_xyy_0[j];

                tlx_zzz_xyz_0[j] = pa_z[j] * tlx_zz_xyz_0[j] + fl1_fx * tlx_z_xyz_0[j] + 0.5 * fl1_fx * tlx_zz_xy_0[j] + 0.5 * fl1_fx * tpy_zz_xyz_0[j] + fl1_fx * fl1_fgb * tdy_zz_xyz_0[j];

                tly_zzz_xyz_0[j] = pa_z[j] * tly_zz_xyz_0[j] + fl1_fx * tly_z_xyz_0[j] + 0.5 * fl1_fx * tly_zz_xy_0[j] - 0.5 * fl1_fx * tpx_zz_xyz_0[j] - fl1_fx * fl1_fgb * tdx_zz_xyz_0[j];

                tlz_zzz_xyz_0[j] = pa_z[j] * tlz_zz_xyz_0[j] + fl1_fx * tlz_z_xyz_0[j] + 0.5 * fl1_fx * tlz_zz_xy_0[j];

                tlx_zzz_xzz_0[j] = pa_z[j] * tlx_zz_xzz_0[j] + fl1_fx * tlx_z_xzz_0[j] + fl1_fx * tlx_zz_xz_0[j] + 0.5 * fl1_fx * tpy_zz_xzz_0[j] + fl1_fx * fl1_fgb * tdy_zz_xzz_0[j];

                tly_zzz_xzz_0[j] = pa_z[j] * tly_zz_xzz_0[j] + fl1_fx * tly_z_xzz_0[j] + fl1_fx * tly_zz_xz_0[j] - 0.5 * fl1_fx * tpx_zz_xzz_0[j] - fl1_fx * fl1_fgb * tdx_zz_xzz_0[j];

                tlz_zzz_xzz_0[j] = pa_z[j] * tlz_zz_xzz_0[j] + fl1_fx * tlz_z_xzz_0[j] + fl1_fx * tlz_zz_xz_0[j];

                tlx_zzz_yyy_0[j] = pa_z[j] * tlx_zz_yyy_0[j] + fl1_fx * tlx_z_yyy_0[j] + 0.5 * fl1_fx * tpy_zz_yyy_0[j] + fl1_fx * fl1_fgb * tdy_zz_yyy_0[j];

                tly_zzz_yyy_0[j] = pa_z[j] * tly_zz_yyy_0[j] + fl1_fx * tly_z_yyy_0[j] - 0.5 * fl1_fx * tpx_zz_yyy_0[j] - fl1_fx * fl1_fgb * tdx_zz_yyy_0[j];

                tlz_zzz_yyy_0[j] = pa_z[j] * tlz_zz_yyy_0[j] + fl1_fx * tlz_z_yyy_0[j];

                tlx_zzz_yyz_0[j] = pa_z[j] * tlx_zz_yyz_0[j] + fl1_fx * tlx_z_yyz_0[j] + 0.5 * fl1_fx * tlx_zz_yy_0[j] + 0.5 * fl1_fx * tpy_zz_yyz_0[j] + fl1_fx * fl1_fgb * tdy_zz_yyz_0[j];

                tly_zzz_yyz_0[j] = pa_z[j] * tly_zz_yyz_0[j] + fl1_fx * tly_z_yyz_0[j] + 0.5 * fl1_fx * tly_zz_yy_0[j] - 0.5 * fl1_fx * tpx_zz_yyz_0[j] - fl1_fx * fl1_fgb * tdx_zz_yyz_0[j];

                tlz_zzz_yyz_0[j] = pa_z[j] * tlz_zz_yyz_0[j] + fl1_fx * tlz_z_yyz_0[j] + 0.5 * fl1_fx * tlz_zz_yy_0[j];

                tlx_zzz_yzz_0[j] = pa_z[j] * tlx_zz_yzz_0[j] + fl1_fx * tlx_z_yzz_0[j] + fl1_fx * tlx_zz_yz_0[j] + 0.5 * fl1_fx * tpy_zz_yzz_0[j] + fl1_fx * fl1_fgb * tdy_zz_yzz_0[j];

                tly_zzz_yzz_0[j] = pa_z[j] * tly_zz_yzz_0[j] + fl1_fx * tly_z_yzz_0[j] + fl1_fx * tly_zz_yz_0[j] - 0.5 * fl1_fx * tpx_zz_yzz_0[j] - fl1_fx * fl1_fgb * tdx_zz_yzz_0[j];

                tlz_zzz_yzz_0[j] = pa_z[j] * tlz_zz_yzz_0[j] + fl1_fx * tlz_z_yzz_0[j] + fl1_fx * tlz_zz_yz_0[j];

                tlx_zzz_zzz_0[j] = pa_z[j] * tlx_zz_zzz_0[j] + fl1_fx * tlx_z_zzz_0[j] + 1.5 * fl1_fx * tlx_zz_zz_0[j] + 0.5 * fl1_fx * tpy_zz_zzz_0[j] + fl1_fx * fl1_fgb * tdy_zz_zzz_0[j];

                tly_zzz_zzz_0[j] = pa_z[j] * tly_zz_zzz_0[j] + fl1_fx * tly_z_zzz_0[j] + 1.5 * fl1_fx * tly_zz_zz_0[j] - 0.5 * fl1_fx * tpx_zz_zzz_0[j] - fl1_fx * fl1_fgb * tdx_zz_zzz_0[j];
