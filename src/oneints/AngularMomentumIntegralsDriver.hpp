...
class CAngularMomentumIntegralsDriver
{
     ...
     */
    CAngularMomentumMatrix _compAngularMomentumIntegrals(const CGtoContainer* braGtoContainer,
...
public:
    ...
    /**
     ...
     @param zOrigin the Cartesian Z coordinate of angular momentum origin.
     */
    void setAngularMomentumOrigin(const double xOrigin,
                                  const double yOrigin,
                                  const double zOrigin);
    ...
    /**
     ...
     @return the angular momentum matrix object.
     */
    CAngularMomentumMatrix compute(const CMolecule&       molecule,
