#ifndef PrimitiveOverlapGeom101PF_Z_XXX
#define PrimitiveOverlapGeom101PF_Z_XXX
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)P_Z|1|d^(1)/dB^(1)F_XXX> integrals.
...
*/
auto compPrimitiveOverlapGeom101PF_Z_XXX(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101PF_Z_XXX */
