#ifndef PrimitiveOverlapGeom101DD_XX_XX
#define PrimitiveOverlapGeom101DD_XX_XX
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_XX|1|d^(1)/dB^(1)D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom101DD_XX_XX(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DD_XX_XX */
