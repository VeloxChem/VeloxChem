#ifndef PrimitiveOverlapGeom101PF_Z_YYY
#define PrimitiveOverlapGeom101PF_Z_YYY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)P_Z|1|d^(1)/dB^(1)F_YYY> integrals.
...
*/
auto compPrimitiveOverlapGeom101PF_Z_YYY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101PF_Z_YYY */
