#ifndef PrimitiveOverlapGeom101DF_XZ_YYY
#define PrimitiveOverlapGeom101DF_XZ_YYY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_XZ|1|d^(1)/dB^(1)F_YYY> integrals.
...
*/
auto compPrimitiveOverlapGeom101DF_XZ_YYY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DF_XZ_YYY */
