#ifndef PrimitiveOverlapGeom101FF_XZZ_XXZ
#define PrimitiveOverlapGeom101FF_XZZ_XXZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XZZ|1|d^(1)/dB^(1)F_XXZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101FF_XZZ_XXZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FF_XZZ_XXZ */
