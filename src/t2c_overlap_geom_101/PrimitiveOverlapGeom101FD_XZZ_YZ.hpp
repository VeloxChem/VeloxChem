#ifndef PrimitiveOverlapGeom101FD_XZZ_YZ
#define PrimitiveOverlapGeom101FD_XZZ_YZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XZZ|1|d^(1)/dB^(1)D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101FD_XZZ_YZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FD_XZZ_YZ */
