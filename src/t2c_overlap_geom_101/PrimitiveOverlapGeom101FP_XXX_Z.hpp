#ifndef PrimitiveOverlapGeom101FP_XXX_Z
#define PrimitiveOverlapGeom101FP_XXX_Z
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XXX|1|d^(1)/dB^(1)P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom101FP_XXX_Z(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FP_XXX_Z */
