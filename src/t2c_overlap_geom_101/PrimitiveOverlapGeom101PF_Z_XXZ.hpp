#ifndef PrimitiveOverlapGeom101PF_Z_XXZ
#define PrimitiveOverlapGeom101PF_Z_XXZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)P_Z|1|d^(1)/dB^(1)F_XXZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101PF_Z_XXZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101PF_Z_XXZ */
