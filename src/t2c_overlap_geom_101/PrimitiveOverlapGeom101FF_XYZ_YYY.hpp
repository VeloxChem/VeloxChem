#ifndef PrimitiveOverlapGeom101FF_XYZ_YYY
#define PrimitiveOverlapGeom101FF_XYZ_YYY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XYZ|1|d^(1)/dB^(1)F_YYY> integrals.
...
*/
auto compPrimitiveOverlapGeom101FF_XYZ_YYY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FF_XYZ_YYY */
