#ifndef PrimitiveOverlapGeom101FD_XXZ_YY
#define PrimitiveOverlapGeom101FD_XXZ_YY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XXZ|1|d^(1)/dB^(1)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom101FD_XXZ_YY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FD_XXZ_YY */
