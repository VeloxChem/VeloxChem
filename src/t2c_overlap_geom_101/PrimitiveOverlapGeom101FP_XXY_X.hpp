#ifndef PrimitiveOverlapGeom101FP_XXY_X
#define PrimitiveOverlapGeom101FP_XXY_X
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XXY|1|d^(1)/dB^(1)P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom101FP_XXY_X(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FP_XXY_X */
