#ifndef PrimitiveOverlapGeom101PF_Y_YYZ
#define PrimitiveOverlapGeom101PF_Y_YYZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)P_Y|1|d^(1)/dB^(1)F_YYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101PF_Y_YYZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101PF_Y_YYZ */
