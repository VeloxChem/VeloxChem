#ifndef PrimitiveOverlapGeom101DF_XY_ZZZ
#define PrimitiveOverlapGeom101DF_XY_ZZZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_XY|1|d^(1)/dB^(1)F_ZZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101DF_XY_ZZZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DF_XY_ZZZ */
