#ifndef PrimitiveOverlapGeom101DD_XY_XY
#define PrimitiveOverlapGeom101DD_XY_XY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_XY|1|d^(1)/dB^(1)D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom101DD_XY_XY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DD_XY_XY */
