#ifndef PrimitiveOverlapGeom101FD_XYZ_YY
#define PrimitiveOverlapGeom101FD_XYZ_YY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XYZ|1|d^(1)/dB^(1)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom101FD_XYZ_YY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FD_XYZ_YY */
