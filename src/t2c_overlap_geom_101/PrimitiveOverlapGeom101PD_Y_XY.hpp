#ifndef PrimitiveOverlapGeom101PD_Y_XY
#define PrimitiveOverlapGeom101PD_Y_XY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)P_Y|1|d^(1)/dB^(1)D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom101PD_Y_XY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101PD_Y_XY */
