#ifndef PrimitiveOverlapGeom101DF_XX_XYY
#define PrimitiveOverlapGeom101DF_XX_XYY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_XX|1|d^(1)/dB^(1)F_XYY> integrals.
...
*/
auto compPrimitiveOverlapGeom101DF_XX_XYY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DF_XX_XYY */
