#ifndef PrimitiveOverlapGeom101DS_YZ_0
#define PrimitiveOverlapGeom101DS_YZ_0
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_YZ|1|d^(1)/dB^(1)S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom101DS_YZ_0(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DS_YZ_0 */
