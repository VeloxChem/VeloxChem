#ifndef PrimitiveOverlapGeom101DP_XY_Z
#define PrimitiveOverlapGeom101DP_XY_Z
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_XY|1|d^(1)/dB^(1)P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom101DP_XY_Z(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DP_XY_Z */
