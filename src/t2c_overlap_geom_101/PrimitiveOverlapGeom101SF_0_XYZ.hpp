#ifndef PrimitiveOverlapGeom101SF_0_XYZ
#define PrimitiveOverlapGeom101SF_0_XYZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)S_0|1|d^(1)/dB^(1)F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101SF_0_XYZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101SF_0_XYZ */
