#ifndef PrimitiveOverlapGeom101PD_X_YY
#define PrimitiveOverlapGeom101PD_X_YY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)P_X|1|d^(1)/dB^(1)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom101PD_X_YY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101PD_X_YY */
