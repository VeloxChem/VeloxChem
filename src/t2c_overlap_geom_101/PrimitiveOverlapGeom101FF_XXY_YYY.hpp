#ifndef PrimitiveOverlapGeom101FF_XXY_YYY
#define PrimitiveOverlapGeom101FF_XXY_YYY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XXY|1|d^(1)/dB^(1)F_YYY> integrals.
...
*/
auto compPrimitiveOverlapGeom101FF_XXY_YYY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FF_XXY_YYY */
