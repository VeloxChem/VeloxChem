#ifndef PrimitiveOverlapGeom101SP_0_X
#define PrimitiveOverlapGeom101SP_0_X
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)S_0|1|d^(1)/dB^(1)P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom101SP_0_X(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101SP_0_X */
