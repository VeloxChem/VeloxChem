#ifndef PrimitiveOverlapGeom101FF_ZZZ_XXX
#define PrimitiveOverlapGeom101FF_ZZZ_XXX
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_ZZZ|1|d^(1)/dB^(1)F_XXX> integrals.
...
*/
auto compPrimitiveOverlapGeom101FF_ZZZ_XXX(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FF_ZZZ_XXX */
