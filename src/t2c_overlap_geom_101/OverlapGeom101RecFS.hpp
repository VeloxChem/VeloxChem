#ifndef OverlapGeom101RecFS_hpp
#define OverlapGeom101RecFS_hpp
...
/**
 Evaluates <d^(1)/dA^(1)F|1|d^(1)/dB^(1)S>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom101FS(CSubMatrix*      matrix_x_x,
