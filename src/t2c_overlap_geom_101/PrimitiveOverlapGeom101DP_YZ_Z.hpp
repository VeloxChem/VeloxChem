#ifndef PrimitiveOverlapGeom101DP_YZ_Z
#define PrimitiveOverlapGeom101DP_YZ_Z
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_YZ|1|d^(1)/dB^(1)P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom101DP_YZ_Z(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DP_YZ_Z */
