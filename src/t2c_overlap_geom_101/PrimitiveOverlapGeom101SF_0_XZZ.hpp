#ifndef PrimitiveOverlapGeom101SF_0_XZZ
#define PrimitiveOverlapGeom101SF_0_XZZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)S_0|1|d^(1)/dB^(1)F_XZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101SF_0_XZZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101SF_0_XZZ */
