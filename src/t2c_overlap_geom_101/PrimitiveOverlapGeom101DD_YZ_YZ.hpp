#ifndef PrimitiveOverlapGeom101DD_YZ_YZ
#define PrimitiveOverlapGeom101DD_YZ_YZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_YZ|1|d^(1)/dB^(1)D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101DD_YZ_YZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DD_YZ_YZ */
