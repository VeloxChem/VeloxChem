#ifndef PrimitiveOverlapGeom101DD_XX_XZ
#define PrimitiveOverlapGeom101DD_XX_XZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_XX|1|d^(1)/dB^(1)D_XZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101DD_XX_XZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DD_XX_XZ */
