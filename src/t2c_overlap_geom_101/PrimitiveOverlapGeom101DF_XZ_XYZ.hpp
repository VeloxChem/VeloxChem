#ifndef PrimitiveOverlapGeom101DF_XZ_XYZ
#define PrimitiveOverlapGeom101DF_XZ_XYZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_XZ|1|d^(1)/dB^(1)F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101DF_XZ_XYZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DF_XZ_XYZ */
