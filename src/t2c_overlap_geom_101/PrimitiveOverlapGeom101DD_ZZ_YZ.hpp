#ifndef PrimitiveOverlapGeom101DD_ZZ_YZ
#define PrimitiveOverlapGeom101DD_ZZ_YZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_ZZ|1|d^(1)/dB^(1)D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101DD_ZZ_YZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DD_ZZ_YZ */
