#ifndef PrimitiveOverlapGeom101DF_XY_XXY
#define PrimitiveOverlapGeom101DF_XY_XXY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_XY|1|d^(1)/dB^(1)F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom101DF_XY_XXY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DF_XY_XXY */
