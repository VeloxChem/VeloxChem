#ifndef PrimitiveOverlapGeom101SD_0_YY
#define PrimitiveOverlapGeom101SD_0_YY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)S_0|1|d^(1)/dB^(1)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom101SD_0_YY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101SD_0_YY */
