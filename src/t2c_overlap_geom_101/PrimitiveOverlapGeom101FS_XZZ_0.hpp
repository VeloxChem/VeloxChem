#ifndef PrimitiveOverlapGeom101FS_XZZ_0
#define PrimitiveOverlapGeom101FS_XZZ_0
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XZZ|1|d^(1)/dB^(1)S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom101FS_XZZ_0(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FS_XZZ_0 */
