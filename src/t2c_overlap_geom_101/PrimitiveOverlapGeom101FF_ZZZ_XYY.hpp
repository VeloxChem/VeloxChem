#ifndef PrimitiveOverlapGeom101FF_ZZZ_XYY
#define PrimitiveOverlapGeom101FF_ZZZ_XYY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_ZZZ|1|d^(1)/dB^(1)F_XYY> integrals.
...
*/
auto compPrimitiveOverlapGeom101FF_ZZZ_XYY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FF_ZZZ_XYY */
