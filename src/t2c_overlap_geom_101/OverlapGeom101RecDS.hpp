#ifndef OverlapGeom101RecDS_hpp
#define OverlapGeom101RecDS_hpp
...
/**
 Evaluates <d^(1)/dA^(1)D|1|d^(1)/dB^(1)S>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom101DS(CSubMatrix*      matrix_x_x,
