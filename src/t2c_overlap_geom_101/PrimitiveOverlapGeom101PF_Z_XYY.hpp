#ifndef PrimitiveOverlapGeom101PF_Z_XYY
#define PrimitiveOverlapGeom101PF_Z_XYY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)P_Z|1|d^(1)/dB^(1)F_XYY> integrals.
...
*/
auto compPrimitiveOverlapGeom101PF_Z_XYY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101PF_Z_XYY */
