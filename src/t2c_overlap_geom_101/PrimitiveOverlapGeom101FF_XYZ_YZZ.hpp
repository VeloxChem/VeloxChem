#ifndef PrimitiveOverlapGeom101FF_XYZ_YZZ
#define PrimitiveOverlapGeom101FF_XYZ_YZZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XYZ|1|d^(1)/dB^(1)F_YZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101FF_XYZ_YZZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FF_XYZ_YZZ */
