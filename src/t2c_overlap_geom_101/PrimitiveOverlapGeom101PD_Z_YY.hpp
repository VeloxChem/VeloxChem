#ifndef PrimitiveOverlapGeom101PD_Z_YY
#define PrimitiveOverlapGeom101PD_Z_YY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)P_Z|1|d^(1)/dB^(1)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom101PD_Z_YY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101PD_Z_YY */
