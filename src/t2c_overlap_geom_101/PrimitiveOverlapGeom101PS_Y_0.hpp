#ifndef PrimitiveOverlapGeom101PS_Y_0
#define PrimitiveOverlapGeom101PS_Y_0
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)P_Y|1|d^(1)/dB^(1)S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom101PS_Y_0(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101PS_Y_0 */
