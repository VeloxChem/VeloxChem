#ifndef PrimitiveOverlapGeom101SP_0_Z
#define PrimitiveOverlapGeom101SP_0_Z
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)S_0|1|d^(1)/dB^(1)P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom101SP_0_Z(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101SP_0_Z */
