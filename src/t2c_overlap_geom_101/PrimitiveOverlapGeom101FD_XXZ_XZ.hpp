#ifndef PrimitiveOverlapGeom101FD_XXZ_XZ
#define PrimitiveOverlapGeom101FD_XXZ_XZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XXZ|1|d^(1)/dB^(1)D_XZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101FD_XXZ_XZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FD_XXZ_XZ */
