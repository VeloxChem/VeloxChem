#ifndef PrimitiveOverlapGeom101FP_XXY_Y
#define PrimitiveOverlapGeom101FP_XXY_Y
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XXY|1|d^(1)/dB^(1)P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom101FP_XXY_Y(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FP_XXY_Y */
