#ifndef PrimitiveOverlapGeom101SP_0_Y
#define PrimitiveOverlapGeom101SP_0_Y
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)S_0|1|d^(1)/dB^(1)P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom101SP_0_Y(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101SP_0_Y */
