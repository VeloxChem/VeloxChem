#ifndef PrimitiveOverlapGeom101DF_ZZ_XYY
#define PrimitiveOverlapGeom101DF_ZZ_XYY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_ZZ|1|d^(1)/dB^(1)F_XYY> integrals.
...
*/
auto compPrimitiveOverlapGeom101DF_ZZ_XYY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DF_ZZ_XYY */
