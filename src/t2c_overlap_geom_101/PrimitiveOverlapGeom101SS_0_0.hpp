#ifndef PrimitiveOverlapGeom101SS_0_0
#define PrimitiveOverlapGeom101SS_0_0
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)S_0|1|d^(1)/dB^(1)S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom101SS_0_0(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101SS_0_0 */
