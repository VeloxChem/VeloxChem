#ifndef PrimitiveOverlapGeom101DF_ZZ_YYY
#define PrimitiveOverlapGeom101DF_ZZ_YYY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_ZZ|1|d^(1)/dB^(1)F_YYY> integrals.
...
*/
auto compPrimitiveOverlapGeom101DF_ZZ_YYY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DF_ZZ_YYY */
