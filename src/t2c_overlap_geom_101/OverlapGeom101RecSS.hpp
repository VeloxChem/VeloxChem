#ifndef OverlapGeom101RecSS_hpp
#define OverlapGeom101RecSS_hpp
...
/**
 Evaluates <d^(1)/dA^(1)S|1|d^(1)/dB^(1)S>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom101SS(CSubMatrix*      matrix_x_x,
