#ifndef PrimitiveOverlapGeom101DP_YY_Y
#define PrimitiveOverlapGeom101DP_YY_Y
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_YY|1|d^(1)/dB^(1)P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom101DP_YY_Y(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DP_YY_Y */
