#ifndef PrimitiveOverlapGeom101FP_XYZ_X
#define PrimitiveOverlapGeom101FP_XYZ_X
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XYZ|1|d^(1)/dB^(1)P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom101FP_XYZ_X(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FP_XYZ_X */
