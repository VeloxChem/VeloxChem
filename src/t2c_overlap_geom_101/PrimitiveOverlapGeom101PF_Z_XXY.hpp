#ifndef PrimitiveOverlapGeom101PF_Z_XXY
#define PrimitiveOverlapGeom101PF_Z_XXY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)P_Z|1|d^(1)/dB^(1)F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom101PF_Z_XXY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101PF_Z_XXY */
