#ifndef PrimitiveOverlapGeom101DS_ZZ_0
#define PrimitiveOverlapGeom101DS_ZZ_0
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_ZZ|1|d^(1)/dB^(1)S_0> integrals.
...
*/
auto compPrimitiveOverlapGeom101DS_ZZ_0(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DS_ZZ_0 */
