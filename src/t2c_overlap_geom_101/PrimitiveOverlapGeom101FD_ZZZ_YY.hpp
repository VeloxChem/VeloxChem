#ifndef PrimitiveOverlapGeom101FD_ZZZ_YY
#define PrimitiveOverlapGeom101FD_ZZZ_YY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_ZZZ|1|d^(1)/dB^(1)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom101FD_ZZZ_YY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FD_ZZZ_YY */
