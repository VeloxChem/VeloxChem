#ifndef PrimitiveOverlapGeom101FD_XYZ_XY
#define PrimitiveOverlapGeom101FD_XYZ_XY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XYZ|1|d^(1)/dB^(1)D_XY> integrals.
...
*/
auto compPrimitiveOverlapGeom101FD_XYZ_XY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FD_XYZ_XY */
