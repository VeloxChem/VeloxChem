#ifndef PrimitiveOverlapGeom101DD_ZZ_YY
#define PrimitiveOverlapGeom101DD_ZZ_YY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_ZZ|1|d^(1)/dB^(1)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom101DD_ZZ_YY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DD_ZZ_YY */
