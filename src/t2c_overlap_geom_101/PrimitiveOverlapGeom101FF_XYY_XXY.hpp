#ifndef PrimitiveOverlapGeom101FF_XYY_XXY
#define PrimitiveOverlapGeom101FF_XYY_XXY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XYY|1|d^(1)/dB^(1)F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom101FF_XYY_XXY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FF_XYY_XXY */
