#ifndef PrimitiveOverlapGeom101DD_YY_YY
#define PrimitiveOverlapGeom101DD_YY_YY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_YY|1|d^(1)/dB^(1)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom101DD_YY_YY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DD_YY_YY */
