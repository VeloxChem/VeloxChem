#ifndef PrimitiveOverlapGeom101PF_Y_XXY
#define PrimitiveOverlapGeom101PF_Y_XXY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)P_Y|1|d^(1)/dB^(1)F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom101PF_Y_XXY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101PF_Y_XXY */
