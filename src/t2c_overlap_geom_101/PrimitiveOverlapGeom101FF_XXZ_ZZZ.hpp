#ifndef PrimitiveOverlapGeom101FF_XXZ_ZZZ
#define PrimitiveOverlapGeom101FF_XXZ_ZZZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XXZ|1|d^(1)/dB^(1)F_ZZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101FF_XXZ_ZZZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FF_XXZ_ZZZ */
