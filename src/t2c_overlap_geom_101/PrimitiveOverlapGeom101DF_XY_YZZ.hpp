#ifndef PrimitiveOverlapGeom101DF_XY_YZZ
#define PrimitiveOverlapGeom101DF_XY_YZZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_XY|1|d^(1)/dB^(1)F_YZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101DF_XY_YZZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DF_XY_YZZ */
