#ifndef PrimitiveOverlapGeom101PD_Y_ZZ
#define PrimitiveOverlapGeom101PD_Y_ZZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)P_Y|1|d^(1)/dB^(1)D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101PD_Y_ZZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101PD_Y_ZZ */
