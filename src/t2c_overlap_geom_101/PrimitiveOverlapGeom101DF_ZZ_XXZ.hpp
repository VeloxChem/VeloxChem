#ifndef PrimitiveOverlapGeom101DF_ZZ_XXZ
#define PrimitiveOverlapGeom101DF_ZZ_XXZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_ZZ|1|d^(1)/dB^(1)F_XXZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101DF_ZZ_XXZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DF_ZZ_XXZ */
