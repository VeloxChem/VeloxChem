#ifndef PrimitiveOverlapGeom101FF_XXX_XYY
#define PrimitiveOverlapGeom101FF_XXX_XYY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XXX|1|d^(1)/dB^(1)F_XYY> integrals.
...
*/
auto compPrimitiveOverlapGeom101FF_XXX_XYY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FF_XXX_XYY */
