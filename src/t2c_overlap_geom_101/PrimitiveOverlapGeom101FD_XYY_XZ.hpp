#ifndef PrimitiveOverlapGeom101FD_XYY_XZ
#define PrimitiveOverlapGeom101FD_XYY_XZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XYY|1|d^(1)/dB^(1)D_XZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101FD_XYY_XZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FD_XYY_XZ */
