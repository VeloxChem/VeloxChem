#ifndef PrimitiveOverlapGeom101FD_XYZ_ZZ
#define PrimitiveOverlapGeom101FD_XYZ_ZZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XYZ|1|d^(1)/dB^(1)D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101FD_XYZ_ZZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FD_XYZ_ZZ */
