#ifndef PrimitiveOverlapGeom101PD_Z_XX
#define PrimitiveOverlapGeom101PD_Z_XX
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)P_Z|1|d^(1)/dB^(1)D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom101PD_Z_XX(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101PD_Z_XX */
