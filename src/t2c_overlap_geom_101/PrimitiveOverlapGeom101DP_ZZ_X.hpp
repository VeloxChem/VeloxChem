#ifndef PrimitiveOverlapGeom101DP_ZZ_X
#define PrimitiveOverlapGeom101DP_ZZ_X
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_ZZ|1|d^(1)/dB^(1)P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom101DP_ZZ_X(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DP_ZZ_X */
