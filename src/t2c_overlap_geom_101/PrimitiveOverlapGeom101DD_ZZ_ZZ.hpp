#ifndef PrimitiveOverlapGeom101DD_ZZ_ZZ
#define PrimitiveOverlapGeom101DD_ZZ_ZZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_ZZ|1|d^(1)/dB^(1)D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101DD_ZZ_ZZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DD_ZZ_ZZ */
