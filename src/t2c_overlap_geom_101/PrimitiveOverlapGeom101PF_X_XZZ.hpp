#ifndef PrimitiveOverlapGeom101PF_X_XZZ
#define PrimitiveOverlapGeom101PF_X_XZZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)P_X|1|d^(1)/dB^(1)F_XZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101PF_X_XZZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101PF_X_XZZ */
