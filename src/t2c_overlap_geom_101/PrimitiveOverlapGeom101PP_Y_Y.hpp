#ifndef PrimitiveOverlapGeom101PP_Y_Y
#define PrimitiveOverlapGeom101PP_Y_Y
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)P_Y|1|d^(1)/dB^(1)P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom101PP_Y_Y(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101PP_Y_Y */
