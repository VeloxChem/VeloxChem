#ifndef PrimitiveOverlapGeom101FF_XZZ_ZZZ
#define PrimitiveOverlapGeom101FF_XZZ_ZZZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XZZ|1|d^(1)/dB^(1)F_ZZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101FF_XZZ_ZZZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FF_XZZ_ZZZ */
