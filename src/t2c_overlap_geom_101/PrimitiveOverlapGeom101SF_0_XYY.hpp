#ifndef PrimitiveOverlapGeom101SF_0_XYY
#define PrimitiveOverlapGeom101SF_0_XYY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)S_0|1|d^(1)/dB^(1)F_XYY> integrals.
...
*/
auto compPrimitiveOverlapGeom101SF_0_XYY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101SF_0_XYY */
