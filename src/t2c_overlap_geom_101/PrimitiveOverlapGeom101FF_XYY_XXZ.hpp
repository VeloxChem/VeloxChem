#ifndef PrimitiveOverlapGeom101FF_XYY_XXZ
#define PrimitiveOverlapGeom101FF_XYY_XXZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XYY|1|d^(1)/dB^(1)F_XXZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101FF_XYY_XXZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FF_XYY_XXZ */
