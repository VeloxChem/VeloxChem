...
auto
compPrimitiveOverlapGeom101SP_0_Z(TDoubleArray&       buffer_x_x,
...
#pragma omp simd aligned(fints_x_x,     \
    ...
    for (int64_t i = 0; i < ket_dim; i++)
    {
        ...
        fints_x_x[i] += fss * (2.0 * fe_0 * rpb_z * tbe_0 * tke_0 + 4.0 * rpa_x * rpb_z * rpb_x * tbe_0 * tke_0);

        fints_x_y[i] += fss * 4.0 * rpa_x * rpb_z * rpb_y * tbe_0 * tke_0;

        fints_x_z[i] += fss * (-2.0 * rpa_x * tbe_0 + 2.0 * fe_0 * rpa_x * tbe_0 * tke_0 + 4.0 * rpa_x * rpb_z * rpb_z * tbe_0 * tke_0);

        fints_y_x[i] += fss * 4.0 * rpa_y * rpb_z * rpb_x * tbe_0 * tke_0;

        fints_y_y[i] += fss * (2.0 * fe_0 * rpb_z * tbe_0 * tke_0 + 4.0 * rpa_y * rpb_z * rpb_y * tbe_0 * tke_0);

        fints_y_z[i] += fss * (-2.0 * rpa_y * tbe_0 + 2.0 * fe_0 * rpa_y * tbe_0 * tke_0 + 4.0 * rpa_y * rpb_z * rpb_z * tbe_0 * tke_0);

        fints_z_x[i] += fss * (2.0 * fe_0 * rpb_x * tbe_0 * tke_0 + 4.0 * rpa_z * rpb_z * rpb_x * tbe_0 * tke_0);

        fints_z_y[i] += fss * (2.0 * fe_0 * rpb_y * tbe_0 * tke_0 + 4.0 * rpa_z * rpb_z * rpb_y * tbe_0 * tke_0);

        fints_z_z[i] += fss * (-2.0 * rpa_z * tbe_0 + 2.0 * fe_0 * rpa_z * tbe_0 * tke_0 + 4.0 * fe_0 * rpb_z * tbe_0 * tke_0 +
                               4.0 * rpa_z * rpb_z * rpb_z * tbe_0 * tke_0);
    }
}
