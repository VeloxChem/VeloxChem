#ifndef PrimitiveOverlapGeom101PP_Z_Y
#define PrimitiveOverlapGeom101PP_Z_Y
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)P_Z|1|d^(1)/dB^(1)P_Y> integrals.
...
*/
auto compPrimitiveOverlapGeom101PP_Z_Y(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101PP_Z_Y */
