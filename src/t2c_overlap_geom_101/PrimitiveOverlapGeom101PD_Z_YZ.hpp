#ifndef PrimitiveOverlapGeom101PD_Z_YZ
#define PrimitiveOverlapGeom101PD_Z_YZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)P_Z|1|d^(1)/dB^(1)D_YZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101PD_Z_YZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101PD_Z_YZ */
