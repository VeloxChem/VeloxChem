#ifndef PrimitiveOverlapGeom101FF_XXY_XYZ
#define PrimitiveOverlapGeom101FF_XXY_XYZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XXY|1|d^(1)/dB^(1)F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101FF_XXY_XYZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FF_XXY_XYZ */
