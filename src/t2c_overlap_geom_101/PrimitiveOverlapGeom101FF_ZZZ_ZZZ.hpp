#ifndef PrimitiveOverlapGeom101FF_ZZZ_ZZZ
#define PrimitiveOverlapGeom101FF_ZZZ_ZZZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_ZZZ|1|d^(1)/dB^(1)F_ZZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101FF_ZZZ_ZZZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FF_ZZZ_ZZZ */
