#ifndef PrimitiveOverlapGeom101FF_XYY_YZZ
#define PrimitiveOverlapGeom101FF_XYY_YZZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XYY|1|d^(1)/dB^(1)F_YZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101FF_XYY_YZZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FF_XYY_YZZ */
