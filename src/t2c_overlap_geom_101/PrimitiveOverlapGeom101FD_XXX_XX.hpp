#ifndef PrimitiveOverlapGeom101FD_XXX_XX
#define PrimitiveOverlapGeom101FD_XXX_XX
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XXX|1|d^(1)/dB^(1)D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom101FD_XXX_XX(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FD_XXX_XX */
