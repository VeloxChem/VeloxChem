#ifndef PrimitiveOverlapGeom101DD_YZ_XX
#define PrimitiveOverlapGeom101DD_YZ_XX
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_YZ|1|d^(1)/dB^(1)D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom101DD_YZ_XX(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DD_YZ_XX */
