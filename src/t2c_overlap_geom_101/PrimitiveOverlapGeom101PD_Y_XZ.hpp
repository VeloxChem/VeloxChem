#ifndef PrimitiveOverlapGeom101PD_Y_XZ
#define PrimitiveOverlapGeom101PD_Y_XZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)P_Y|1|d^(1)/dB^(1)D_XZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101PD_Y_XZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101PD_Y_XZ */
