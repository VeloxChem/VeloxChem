#ifndef PrimitiveOverlapGeom101FF_ZZZ_XYZ
#define PrimitiveOverlapGeom101FF_ZZZ_XYZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_ZZZ|1|d^(1)/dB^(1)F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101FF_ZZZ_XYZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FF_ZZZ_XYZ */
