#ifndef PrimitiveOverlapGeom101DF_XX_ZZZ
#define PrimitiveOverlapGeom101DF_XX_ZZZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_XX|1|d^(1)/dB^(1)F_ZZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101DF_XX_ZZZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DF_XX_ZZZ */
