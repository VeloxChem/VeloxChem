#ifndef PrimitiveOverlapGeom101PP_Y_X
#define PrimitiveOverlapGeom101PP_Y_X
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)P_Y|1|d^(1)/dB^(1)P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom101PP_Y_X(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101PP_Y_X */
