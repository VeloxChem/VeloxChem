#ifndef PrimitiveOverlapGeom101FF_XYY_XZZ
#define PrimitiveOverlapGeom101FF_XYY_XZZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XYY|1|d^(1)/dB^(1)F_XZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101FF_XYY_XZZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FF_XYY_XZZ */
