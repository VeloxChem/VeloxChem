#ifndef PrimitiveOverlapGeom101DD_YY_ZZ
#define PrimitiveOverlapGeom101DD_YY_ZZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_YY|1|d^(1)/dB^(1)D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101DD_YY_ZZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DD_YY_ZZ */
