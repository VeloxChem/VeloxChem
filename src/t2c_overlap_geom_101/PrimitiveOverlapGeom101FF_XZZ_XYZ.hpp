#ifndef PrimitiveOverlapGeom101FF_XZZ_XYZ
#define PrimitiveOverlapGeom101FF_XZZ_XYZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XZZ|1|d^(1)/dB^(1)F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101FF_XZZ_XYZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FF_XZZ_XYZ */
