#ifndef PrimitiveOverlapGeom101PP_Z_X
#define PrimitiveOverlapGeom101PP_Z_X
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)P_Z|1|d^(1)/dB^(1)P_X> integrals.
...
*/
auto compPrimitiveOverlapGeom101PP_Z_X(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101PP_Z_X */
