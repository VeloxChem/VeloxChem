#ifndef OverlapGeom101RecDF_hpp
#define OverlapGeom101RecDF_hpp
...
/**
 Evaluates <d^(1)/dA^(1)D|1|d^(1)/dB^(1)F>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom101DF(CSubMatrix*      matrix_x_x,
