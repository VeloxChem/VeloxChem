#ifndef PrimitiveOverlapGeom101DD_XY_XX
#define PrimitiveOverlapGeom101DD_XY_XX
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_XY|1|d^(1)/dB^(1)D_XX> integrals.
...
*/
auto compPrimitiveOverlapGeom101DD_XY_XX(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DD_XY_XX */
