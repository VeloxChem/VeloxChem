#ifndef PrimitiveOverlapGeom101PF_Z_ZZZ
#define PrimitiveOverlapGeom101PF_Z_ZZZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)P_Z|1|d^(1)/dB^(1)F_ZZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101PF_Z_ZZZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101PF_Z_ZZZ */
