#ifndef PrimitiveOverlapGeom101DF_ZZ_ZZZ
#define PrimitiveOverlapGeom101DF_ZZ_ZZZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_ZZ|1|d^(1)/dB^(1)F_ZZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101DF_ZZ_ZZZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DF_ZZ_ZZZ */
