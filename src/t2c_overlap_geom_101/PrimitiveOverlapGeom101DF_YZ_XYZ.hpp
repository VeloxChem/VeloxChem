#ifndef PrimitiveOverlapGeom101DF_YZ_XYZ
#define PrimitiveOverlapGeom101DF_YZ_XYZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_YZ|1|d^(1)/dB^(1)F_XYZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101DF_YZ_XYZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DF_YZ_XYZ */
