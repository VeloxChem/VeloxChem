#ifndef PrimitiveOverlapGeom101DF_XZ_XYY
#define PrimitiveOverlapGeom101DF_XZ_XYY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_XZ|1|d^(1)/dB^(1)F_XYY> integrals.
...
*/
auto compPrimitiveOverlapGeom101DF_XZ_XYY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DF_XZ_XYY */
