#ifndef OverlapGeom101RecSF_hpp
#define OverlapGeom101RecSF_hpp
...
/**
 Evaluates <d^(1)/dA^(1)S|1|d^(1)/dB^(1)F>  integrals for given pair of GTOs blocks.
...
*/
auto compOverlapGeom101SF(CSubMatrix*      matrix_x_x,
