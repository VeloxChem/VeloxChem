#ifndef PrimitiveOverlapGeom101FD_YYY_ZZ
#define PrimitiveOverlapGeom101FD_YYY_ZZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_YYY|1|d^(1)/dB^(1)D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101FD_YYY_ZZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FD_YYY_ZZ */
