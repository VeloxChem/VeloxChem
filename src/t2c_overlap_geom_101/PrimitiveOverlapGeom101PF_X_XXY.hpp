#ifndef PrimitiveOverlapGeom101PF_X_XXY
#define PrimitiveOverlapGeom101PF_X_XXY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)P_X|1|d^(1)/dB^(1)F_XXY> integrals.
...
*/
auto compPrimitiveOverlapGeom101PF_X_XXY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101PF_X_XXY */
