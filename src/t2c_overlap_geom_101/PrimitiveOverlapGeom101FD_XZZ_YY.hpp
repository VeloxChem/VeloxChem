#ifndef PrimitiveOverlapGeom101FD_XZZ_YY
#define PrimitiveOverlapGeom101FD_XZZ_YY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)F_XZZ|1|d^(1)/dB^(1)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom101FD_XZZ_YY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101FD_XZZ_YY */
