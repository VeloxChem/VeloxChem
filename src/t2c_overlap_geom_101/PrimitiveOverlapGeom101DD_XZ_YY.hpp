#ifndef PrimitiveOverlapGeom101DD_XZ_YY
#define PrimitiveOverlapGeom101DD_XZ_YY
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_XZ|1|d^(1)/dB^(1)D_YY> integrals.
...
*/
auto compPrimitiveOverlapGeom101DD_XZ_YY(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DD_XZ_YY */
