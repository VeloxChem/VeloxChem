#ifndef PrimitiveOverlapGeom101DP_ZZ_Z
#define PrimitiveOverlapGeom101DP_ZZ_Z
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_ZZ|1|d^(1)/dB^(1)P_Z> integrals.
...
*/
auto compPrimitiveOverlapGeom101DP_ZZ_Z(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DP_ZZ_Z */
