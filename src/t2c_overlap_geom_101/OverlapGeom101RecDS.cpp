...
auto
compOverlapGeom101DS(CSubMatrix*      matrix_x_x,
        ...
        for (int64_t j = bra_first; j < bra_last; j++)
        {
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom101DS_XX_0(buffer_x_x,
                                                               buffer_x_y,
                                                               buffer_x_z,
                                                               buffer_y_x,
                                                               buffer_y_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom101DS_XY_0(buffer_x_x,
                                                               buffer_x_y,
                                                               buffer_x_z,
                                                               buffer_y_x,
                                                               buffer_y_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom101DS_XZ_0(buffer_x_x,
                                                               buffer_x_y,
                                                               buffer_x_z,
                                                               buffer_y_x,
                                                               buffer_y_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom101DS_YY_0(buffer_x_x,
                                                               buffer_x_y,
                                                               buffer_x_z,
                                                               buffer_y_x,
                                                               buffer_y_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom101DS_YZ_0(buffer_x_x,
                                                               buffer_x_y,
                                                               buffer_x_z,
                                                               buffer_y_x,
                                                               buffer_y_y,
            ...
            for (int64_t k = 0; k < ket_npgtos; k++)
            {
                ...
                for (int64_t l = 0; l < bra_npgtos; l++)
                {
                    ...
                    ovlrec::compPrimitiveOverlapGeom101DS_ZZ_0(buffer_x_x,
                                                               buffer_x_y,
                                                               buffer_x_z,
                                                               buffer_y_x,
                                                               buffer_y_y,
