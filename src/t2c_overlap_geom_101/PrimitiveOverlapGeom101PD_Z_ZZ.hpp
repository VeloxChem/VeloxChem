#ifndef PrimitiveOverlapGeom101PD_Z_ZZ
#define PrimitiveOverlapGeom101PD_Z_ZZ
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)P_Z|1|d^(1)/dB^(1)D_ZZ> integrals.
...
*/
auto compPrimitiveOverlapGeom101PD_Z_ZZ(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101PD_Z_ZZ */
