#ifndef PrimitiveOverlapGeom101DF_YZ_XXX
#define PrimitiveOverlapGeom101DF_YZ_XXX
...
/**
 Evaluates block of primitive <d^(1)/dA^(1)D_YZ|1|d^(1)/dB^(1)F_XXX> integrals.
...
*/
auto compPrimitiveOverlapGeom101DF_YZ_XXX(TDoubleArray&       buffer_x_x,
...
#endif /* PrimitiveOverlapGeom101DF_YZ_XXX */
