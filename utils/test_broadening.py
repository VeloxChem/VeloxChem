...
from broaden_absorption_spectrum import lorentzian_absorption_ev
from broaden_absorption_spectrum import read_energies_and_oscillator_strengths
...
class TestBroadening:
    ...
    def test_absorption_broadening(self):
        ...
        exc_ene, osc_str = read_energies_and_oscillator_strengths(tddft_file)
        xplot, yplot = lorentzian_absorption_ev(exc_ene, osc_str, 0.0025, 0.5,
                                                0.0025)

        abs_file = Path(__file__).parent / 'test_data' / 'noradr_absorption.txt'
